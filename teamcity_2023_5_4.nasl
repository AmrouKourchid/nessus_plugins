...
if (description)
{
  ...
  script_cve_id("CVE-2023-42793", "CVE-2023-43566");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2023/10/25");
  script_xref(name:"IAVA", value:"2023-A-0506-S");

  script_name(english:"TeamCity Server < 2023.05.4 Multiple Vulnerabilities");
...
remote host is a version prior to 2023.05.4. It is, therefore, affected by
multiple vulnerabilities:
    
  - In JetBrains TeamCity before 2023.05.4 authentication bypass leading to RCE 
    on TeamCity Server was possible. (CVE-2023-42793)
...
"Upgrade to JetBrains TeamCity version 2023.05.4 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:H/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:H/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-42793");
