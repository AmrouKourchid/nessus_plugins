...
# extracted from Debian Security Advisory dla-3704. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3704 : libxerces-c-dev - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2018-1311");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-37536");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/xerces-c");
  script_set_attribute(attribute:"solution", value:
"Upgrade the libxerces-c-dev packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:libxerces-c3.2");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libxerces-c-dev', 'reference': '3.2.2+debian-1+deb10u2'},
    {'release': '10.0', 'prefix': 'libxerces-c-doc', 'reference': '3.2.2+debian-1+deb10u2'},
    {'release': '10.0', 'prefix': 'libxerces-c-samples', 'reference': '3.2.2+debian-1+deb10u2'},
    {'release': '10.0', 'prefix': 'libxerces-c3.2', 'reference': '3.2.2+debian-1+deb10u2'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libxerces-c-dev / libxerces-c-doc / libxerces-c-samples / etc');
}
