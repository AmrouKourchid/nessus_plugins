...
# extracted from Fedora Security Advisory FEDORA-2024-223428e702
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-223428e702");

  script_name(english:"Fedora 40 : bluez / iwd / libell (2024-223428e702)");
...
FEDORA-2024-223428e702 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-223428e702");
...
var pkgs = [
    {'reference':'bluez-5.78-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'iwd-2.21-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libell-0.69-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
