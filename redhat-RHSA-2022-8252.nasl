...
# extracted from Red Hat Security Advisory RHSA-2022:8252. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:8252");

  script_name(english:"RHEL 9 : yajl (RHSA-2022:8252)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8252.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e7f974ff");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8252");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2072912");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL yajl package based on the guidance in RHSA-2022:8252.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'yajl-2.1.0-21.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'yajl-devel-2.1.0-21.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
