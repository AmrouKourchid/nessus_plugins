...
# extracted from Red Hat Security Advisory RHSA-2024:9401. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:9401");

  script_name(english:"RHEL 9 : microcode_ctl (RHSA-2024:9401)");
...
referenced in the RHSA-2024:9401 advisory.
    ...
    * kernel: Local information disclosure on Intel(R) Xeon(R) D processors with Intel(R) SGX due to incorrect
    calculation in microcode (CVE-2023-43490)
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2270698");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2270700");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2270701");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2270703");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2270704");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2292296");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2292300");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_9401.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9c7c396d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:9401");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL microcode_ctl package based on the guidance in RHSA-2024:9401.");
  ...
  script_cwe_id(200, 400, 682, 693, 1303, 1342);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'microcode_ctl-20240910-1.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'}
    ]
  }
];
