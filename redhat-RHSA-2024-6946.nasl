...
# extracted from Red Hat Security Advisory RHSA-2024:6946. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:6946");

  script_name(english:"RHEL 9 : grafana-pcp (RHSA-2024:6946)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_6946.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?72a7f8ad");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:6946");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL grafana-pcp package based on the guidance in RHSA-2024:6946.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'grafana-pcp-5.1.1-3.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'grafana-pcp-5.1.1-3.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
