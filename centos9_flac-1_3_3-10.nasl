...
if (description)
{
  ...
  script_name(english:"CentOS 9 : flac-1.3.3-10.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update for flac.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 9 host has packages installed that are affected by a vulnerability as referenced in the
flac-1.3.3-10.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=18389");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream flac package.");
