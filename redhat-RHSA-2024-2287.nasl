...
# extracted from Red Hat Security Advisory RHSA-2024:2287. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2287");

  script_name(english:"RHEL 9 : gstreamer1-plugins-bad-free (RHSA-2024:2287)");
...
referenced in the RHSA-2024:2287 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2287.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?843713c1");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2287");
...
"Update the RHEL gstreamer1-plugins-bad-free package based on the guidance in RHSA-2024:2287.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gstreamer1-plugins-bad-free-1.22.1-4.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gstreamer1-plugins-bad-free-devel-1.22.1-4.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
