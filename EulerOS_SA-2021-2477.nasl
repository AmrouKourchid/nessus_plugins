...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : OpenEXR (EulerOS-SA-2021-2477)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2477
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?29287039");
...
var pkgs = [
  "OpenEXR-libs-2.2.0-15.h2.eulerosv2r8"
];
