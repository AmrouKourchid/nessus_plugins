...
# extracted from Red Hat Security Advisory RHSA-2023:2459. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:2459");

  script_name(english:"RHEL 9 : device-mapper-multipath (RHSA-2023:2459)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_2459.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?91078cc2");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2125357");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2141860");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2143125");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2145225");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2166467");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:2459");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL device-mapper-multipath package based on the guidance in RHSA-2023:2459.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'device-mapper-multipath-0.8.7-20.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'device-mapper-multipath-devel-0.8.7-20.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'device-mapper-multipath-libs-0.8.7-20.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'kpartx-0.8.7-20.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
