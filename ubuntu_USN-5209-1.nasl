...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 ESM / 18.04 LTS : Linux kernel vulnerabilities (USN-5209-1)");
...
var kernel_mappings = {
  ...
  '18.04': {
    '4.15.0': {
      'generic': '4.15.0-166',
      'generic-lpae': '4.15.0-166',
      'lowlatency': '4.15.0-166',
      'dell300x': '4.15.0-1033',
      'oracle': '4.15.0-1085',
      'raspi2': '4.15.0-1101',
      'kvm': '4.15.0-1105',
      'gcp': '4.15.0-1114',
      'snapdragon': '4.15.0-1118',
      'azure': '4.15.0-1129'
    }
  }
};
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-5209-1');
}
