...
# extracted from Fedora Security Advisory FEDORA-2024-7378be30dd
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-7378be30dd");

  script_name(english:"Fedora 41 : bind / bind-dyndb-ldap (2024-7378be30dd)");
...
FEDORA-2024-7378be30dd advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-7378be30dd");
...
var pkgs = [
    {'reference':'bind-9.18.24-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
    {'reference':'bind-dyndb-ldap-11.10-27.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
