...
if (description)
{
  ...
  script_cve_id("CVE-2013-0425");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2013-0425");
...
patch available.
  ...
  - Unspecified vulnerability in the Java Runtime Environment (JRE) component in Oracle Java SE 7 through
    ...
    to Libraries, a different vulnerability than CVE-2013-0428 and CVE-2013-0426. NOTE: the previous
    ...
    to bypass Java sandbox restrictions. (CVE-2013-0425)
