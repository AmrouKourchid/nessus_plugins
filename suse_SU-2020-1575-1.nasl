...
# extracted from SUSE update advisory SUSE-SU-2020:1575-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : nodejs10 (SUSE-SU-2020:1575-1)");
...
without introducing additional issues.");
  ...
  # https://www.suse.com/support/update/announcement/2020/suse-su-20201575-1/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5ce8451d");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"0", reference:"nodejs10-10.21.0-1.24.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"nodejs10-debuginfo-10.21.0-1.24.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"nodejs10-debugsource-10.21.0-1.24.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"nodejs10-devel-10.21.0-1.24.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"npm10-10.21.0-1.24.1")) flag++;
