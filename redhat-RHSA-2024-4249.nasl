...
# extracted from Red Hat Security Advisory RHSA-2024:4249. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:4249");

  script_name(english:"RHEL 8 : c-ares (RHSA-2024:4249)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for c-ares.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:4249 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_4249.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b688bcfb");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:4249");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL c-ares package based on the guidance in RHSA-2024:4249.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'c-ares-1.13.0-11.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'c-ares-devel-1.13.0-11.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
