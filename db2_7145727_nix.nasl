...
if (description)
{
  ...
  script_cve_id("CVE-2024-27254");
  script_xref(name:"IAVB", value:"2024-B-0069");

  script_name(english:"IBM DB2 DoS (7145727) (Unix)");

  script_set_attribute(attribute:"synopsis", value:
"The remote database server is affected by a denial of service vulnerability.");
  script_set_attribute(attribute:"description", value:
"According to it self-reported version number, IBM Db2 is affected by a denial of service vulnerability with a 
...
"Apply the appropriate IBM DB2 Fix Pack or Special Build based on the most recent fix pack level for your branch.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-27254");
