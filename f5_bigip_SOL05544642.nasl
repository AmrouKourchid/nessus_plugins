...
# extracted from F5 Networks BIG-IP Solution K05544642.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : BIND vulnerability (K05544642)");
...
An attacker can exploit this vulnerability to trigger an assertion
failure, resulting in a denial of service to clients.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K05544642");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K05544642.");
