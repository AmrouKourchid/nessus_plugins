...
The oldstable distribution (stretch) is not affected.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2019/dsa-4514");
...
flag = 0;
if (deb_check(release:"10.0", prefix:"libvarnishapi-dev", reference:"6.1.1-1+deb10u1")) flag++;
if (deb_check(release:"10.0", prefix:"libvarnishapi2", reference:"6.1.1-1+deb10u1")) flag++;
if (deb_check(release:"10.0", prefix:"varnish", reference:"6.1.1-1+deb10u1")) flag++;
if (deb_check(release:"10.0", prefix:"varnish-doc", reference:"6.1.1-1+deb10u1")) flag++;
