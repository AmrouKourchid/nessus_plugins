...
# extracted from openSUSE Security Update openSUSE-2018-603.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : qemu (openSUSE-2018-603) (Spectre)");
...
This non-security issue was fixed :
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1093169");
