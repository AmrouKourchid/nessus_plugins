...
# extracted from Red Hat Security Advisory RHSA-2018:1948. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:1948");

  script_name(english:"RHEL 7 : ansible (RHSA-2018:1948)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for ansible.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2018:1948 advisory.
...
number.");
  ...
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_1948.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3ddcee89");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:1948");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL ansible package based on the guidance in RHSA-2018:1948.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ansible-2.5.5-1.el7ae', 'release':'7', 'el_string':'el7ae', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2'},
      {'reference':'ansible-doc-2.5.5-1.el7ae', 'release':'7', 'el_string':'el7ae', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2'}
    ]
  }
];
