...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : gmp (EulerOS-SA-2022-1372)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the gmp package installed, the EulerOS Virtualization installation on the remote host is
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1372
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f958c194");
