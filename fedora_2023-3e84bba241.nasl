...
# extracted from Fedora Security Advisory FEDORA-2023-3e84bba241
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-3e84bba241");

  script_name(english:"Fedora 38 : tang (2023-3e84bba241)");
...
FEDORA-2023-3e84bba241 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-3e84bba241");
...
"Update the affected tang package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:tang");
...
var pkgs = [
    {'reference':'tang-14-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
