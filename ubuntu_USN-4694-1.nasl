...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 20.04 LTS : Linux kernel vulnerability (USN-4694-1)");
...
referenced in the USN-4694-1 advisory.
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.4.0-200-powerpc-e500mc");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.4.0-200-powerpc-smp");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.4.0-200-powerpc64-emb");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.4.0-200-powerpc64-smp");
...
var kernel_mappings = {
  '16.04': {
    '4.15.0': {
      'generic': '4.15.0-132',
      'generic-lpae': '4.15.0-132',
      'lowlatency': '4.15.0-132'
    },
    '4.4.0': {
      'generic': '4.4.0-200',
      'generic-lpae': '4.4.0-200',
      'lowlatency': '4.4.0-200',
      'powerpc-e500mc': '4.4.0-200',
      'powerpc-smp': '4.4.0-200',
      'powerpc64-emb': '4.4.0-200',
      'powerpc64-smp': '4.4.0-200'
    }
  },
  '18.04': {
    '4.15.0': {
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-4694-1');
}
