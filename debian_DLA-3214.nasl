...
# extracted from Debian Security Advisory dla-3214. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3214 : libraw-bin - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3214
advisory.

    -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3214-1                debian-lts@lists.debian.org
    https://www.debian.org/lts/security/                        Helmut Grohne
    November 30, 2022                             https://wiki.debian.org/LTS
    -------------------------------------------------------------------------

    Package        : libraw
    Version        : 0.19.2-2+deb10u2
    CVE ID         : CVE-2020-15503

    This update adds size checks to thumbnail extraction. Prior to these checks, it
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2020-15503");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libraw-bin', 'reference': '0.19.2-2+deb10u2'},
    {'release': '10.0', 'prefix': 'libraw-dev', 'reference': '0.19.2-2+deb10u2'},
    {'release': '10.0', 'prefix': 'libraw-doc', 'reference': '0.19.2-2+deb10u2'},
    {'release': '10.0', 'prefix': 'libraw19', 'reference': '0.19.2-2+deb10u2'}
];
