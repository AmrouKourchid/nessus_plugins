...
# SUSE update advisory SUSE-SU-2022:2833-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:2833-1");

  script_name(english:"SUSE SLES15 Security Update : ucode-intel (SUSE-SU-2022:2833-1)");
...
in the SUSE-SU-2022:2833-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-August/011929.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?11d3a34d");
...
var pkgs = [
    {'reference':'ucode-intel-20220809-150000.3.78.1', 'sp':'0', 'cpu':'x86_64', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15']},
    {'reference':'ucode-intel-20220809-150000.3.78.1', 'sp':'0', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-ESPOS-release-15', 'SLE_HPC-LTSS-release-15']},
    {'reference':'ucode-intel-20220809-150000.3.78.1', 'sp':'0', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-ESPOS-release-15', 'SLE_HPC-LTSS-release-15']}
];
