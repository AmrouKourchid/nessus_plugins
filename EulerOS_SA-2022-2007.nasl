...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : openssl (EulerOS-SA-2022-2007)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2007
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d83f761e");
...
var pkgs = [
  "openssl-1.1.1f-7.h24.eulerosv2r9",
  "openssl-libs-1.1.1f-7.h24.eulerosv2r9",
  "openssl-perl-1.1.1f-7.h24.eulerosv2r9"
];
