...
if (description)
{
  ...
  script_cve_id("CVE-2024-21419");
  script_xref(name:"MSKB", value:"5035697");
  script_xref(name:"MSFT", value:"MS24-5035697");
  script_xref(name:"IAVA", value:"2024-A-0152-S");

  script_name(english:"Security Updates for Microsoft Dynamics 365 (on-premises) (March 2024)");
...
a cross-site scripting vulnerability. An attacker can spoof a session to perform actions with the 
...
self-reported version number.");
  # https://support.microsoft.com/en-us/topic/service-update-1-26-for-microsoft-dynamics-crm-on-premises-9-1-60959c96-cdb2-479f-b78a-1c3b382a227d
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?533de7cc");
...
"Microsoft has released the following security updates to address this issue: 
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-21419");
...
var constraints = [
  { 'min_version' : '9.1', 'fixed_version' : '9.1.26.23', 'fixed_display' : 'Update v9.1 (on-premises) Update 1.26' }
];
