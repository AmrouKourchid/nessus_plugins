...
if (description)
{
  ...
  script_cve_id("CVE-2024-52963");
  script_xref(name:"IAVA", value:"2025-A-0022");

  script_name(english:"Fortinet Fortigate Out-of-bounds Write in IPSEC Daemon (FG-IR-24-373)");
...
vulnerability as referenced in the FG-IR-24-373 advisory.

  - A out-of-bounds write in Fortinet FortiOS versions 7.6.0, 7.4.0 through 7.4.6, 7.2.0 through 7.2.10, 7.0.0
    through 7.0.16, 6.4.0 through 6.4.15 allows attacker to trigger a denial of service via specially crafted
    packets. (CVE-2024-52963)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.fortiguard.com/psirt/FG-IR-24-373");
  script_set_attribute(attribute:"solution", value:
"For 6.4.x / 7.0.x, see vendor advisory. For 7.2.x, upgrade to Fortigate version 7.2.11 or later. For 7.4.x, upgrade to
Fortigate version 7.4.8 or later. For 7.6.x, upgrade to Fortigate version 7.6.1 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:H/Au:N/C:N/I:N/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:H/PR:N/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-52963");
...
var constraints = [
  ...
  { 'min_version' : '7.4.0', 'max_version' : '7.4.7', 'fixed_version' : '7.4.8' },
