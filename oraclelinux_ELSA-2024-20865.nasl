...
# extracted from Oracle Linux Security Advisory ELSA-2024-20865.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : edk2 (ELSA-2024-20865)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-20865.html");
...
var pkgs = [
    {'reference':'edk2-tools-20240227-5.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'edk2-tools-20240227-5.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
