...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP12 : busybox (EulerOS-SA-2024-2521)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2521
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c1e89723");
...
var pkgs = [
  "busybox-help-1.34.1-17.h9.eulerosv2r12"
];
