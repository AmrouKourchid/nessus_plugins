...
ELSA-2022-8267 advisory.
    ...
    - ath9k: fix use-after-free in ath9k_hif_usb_rx_cb (Jose Ignacio Tornos Martinez) [2084600]
    {CVE-2022-1679}
...
var pkgs = [
    ...
    {'reference':'kernel-abi-stablelists-5.14.0-162.6.1.el9_1', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-abi-stablelists-5.14.0'},
