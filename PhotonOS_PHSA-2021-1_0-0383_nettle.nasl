...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Nettle PHSA-2021-1.0-0383");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'nettle-3.7.2-1.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'nettle-devel-3.7.2-1.ph1')) flag++;
