...
# extracted from Fedora Security Advisory FEDORA-2024-e527e6fd08
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-e527e6fd08");
  script_xref(name:"IAVB", value:"2023-B-0090-S");

  script_name(english:"Fedora 39 : xen (2024-e527e6fd08)");
...
FEDORA-2024-e527e6fd08 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-e527e6fd08");
...
var pkgs = [
    {'reference':'xen-4.17.2-6.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
