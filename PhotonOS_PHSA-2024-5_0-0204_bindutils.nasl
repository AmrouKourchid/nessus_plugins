...
# extracted from VMware Security Advisory PHSA-2024-5.0-0204. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Bindutils PHSA-2024-5.0-0204");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the bindutils package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-5.0-204.md");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'bindutils-9.19.21-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'bindutils-devel-9.19.21-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'bindutils-libs-9.19.21-1.ph5')) flag++;
