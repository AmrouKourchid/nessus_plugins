...
# extracted from Red Hat Security Advisory RHSA-2025:0404. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:0404");

  script_name(english:"RHEL 8 : iperf3 (RHSA-2025:0404)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_0404.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ebd2e5e7");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:0404");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL iperf3 package based on the guidance in RHSA-2025:0404.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'iperf3-3.5-7.el8_8.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
