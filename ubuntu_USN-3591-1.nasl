...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS : Django vulnerabilities (USN-3591-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 14.04 LTS / 16.04 LTS host has packages installed that are affected by multiple vulnerabilities as
referenced in the USN-3591-1 advisory.

    James Davis discovered that Django incorrectly handled certain template filters. A remote attacker could
    possibly use this issue to cause Django to consume resources, resulting in a denial of service.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3591-1");
...
"Update the affected python-django, python-django-common and / or python3-django packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-7537");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'python-django', 'pkgver': '1.6.11-0ubuntu1.2'},
    {'osver': '16.04', 'pkgname': 'python-django', 'pkgver': '1.8.7-1ubuntu5.6'},
    {'osver': '16.04', 'pkgname': 'python-django-common', 'pkgver': '1.8.7-1ubuntu5.6'},
    {'osver': '16.04', 'pkgname': 'python3-django', 'pkgver': '1.8.7-1ubuntu5.6'}
];
