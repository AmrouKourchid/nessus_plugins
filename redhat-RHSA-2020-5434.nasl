...
# extracted from Red Hat Security Advisory RHSA-2020:5434. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:5434");

  script_name(english:"RHEL 7 : targetcli (RHSA-2020:5434)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_5434.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?38517e68");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:5434");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1848143");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL targetcli package based on the guidance in RHSA-2020:5434.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'targetcli-2.1.53-1.el7_9', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
