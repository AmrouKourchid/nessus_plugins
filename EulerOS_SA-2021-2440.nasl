...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : xorg-x11-server (EulerOS-SA-2021-2440)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2440
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3e2e7c03");
...
pkgs = ["xorg-x11-server-Xephyr-1.17.2-10.h8",
        "xorg-x11-server-Xorg-1.17.2-10.h8",
        "xorg-x11-server-common-1.17.2-10.h8"];
