...
Update to 2.12.0 :
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1159869");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1172171");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1174075");
  script_set_attribute(attribute:"see_also", value:"https://icinga.com/docs");
  # https://icinga.com/docs/icinga2/latest/doc/16-upgrading-icinga-2/#added-boost-166
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?523cf707");
  # https://icinga.com/docs/icinga2/latest/doc/16-upgrading-icinga-2/#agent-hosts-with-command-endpoint-require-a-zone
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a1dc9ab8");
  # https://icinga.com/docs/icinga2/latest/doc/16-upgrading-icinga-2/#config-sync-zones-in-zones
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a7574676");
  script_set_attribute(attribute:"solution", value:
"Update the affected icinga2 packages.");
