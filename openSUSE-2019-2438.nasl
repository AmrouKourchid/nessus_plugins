...
# extracted from openSUSE Security Update openSUSE-2019-2438.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : python3 (openSUSE-2019-2438)");
...
if ( rpm_check(release:"SUSE15.1", reference:"libpython3_6m1_0-3.6.9-lp151.6.4.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libpython3_6m1_0-debuginfo-3.6.9-lp151.6.4.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"python3-3.6.9-lp151.6.4.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"python3-base-3.6.9-lp151.6.4.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"python3-base-debuginfo-3.6.9-lp151.6.4.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"python3-base-debugsource-3.6.9-lp151.6.4.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"python3-curses-3.6.9-lp151.6.4.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"python3-curses-debuginfo-3.6.9-lp151.6.4.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"python3-dbm-3.6.9-lp151.6.4.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"python3-dbm-debuginfo-3.6.9-lp151.6.4.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"python3-debuginfo-3.6.9-lp151.6.4.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"python3-debugsource-3.6.9-lp151.6.4.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"python3-devel-3.6.9-lp151.6.4.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"python3-devel-debuginfo-3.6.9-lp151.6.4.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"python3-idle-3.6.9-lp151.6.4.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"python3-testsuite-3.6.9-lp151.6.4.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"python3-testsuite-debuginfo-3.6.9-lp151.6.4.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"python3-tk-3.6.9-lp151.6.4.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"python3-tk-debuginfo-3.6.9-lp151.6.4.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"python3-tools-3.6.9-lp151.6.4.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libpython3_6m1_0-32bit-3.6.9-lp151.6.4.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libpython3_6m1_0-32bit-debuginfo-3.6.9-lp151.6.4.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"python3-32bit-3.6.9-lp151.6.4.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"python3-32bit-debuginfo-3.6.9-lp151.6.4.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"python3-base-32bit-3.6.9-lp151.6.4.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"python3-base-32bit-debuginfo-3.6.9-lp151.6.4.1") ) flag++;
