...
# extracted from Oracle Linux Security Advisory ELSA-2015-1066.
##
...
if (description)
{
  ...
  script_xref(name:"IAVB", value:"2015-B-0064-S");
  script_xref(name:"IAVB", value:"2015-B-0078-S");

  script_name(english:"Oracle Linux 6 / 7 : php54 (ELSA-2015-1066)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 6 / 7 host has packages installed that are affected by multiple vulnerabilities as referenced in
the ELSA-2015-1066 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2015-1066.html");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:php54");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:php54-php-pecl-zendopcache");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:php54-runtime");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:php54-scldevel");
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'php54 / php54-php / php54-php-bcmath / etc');
}
