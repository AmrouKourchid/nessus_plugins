...
# AlmaLinux Security Advisory ALSA-2023:5184.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:5184");
  ...
  script_name(english:"AlmaLinux 8 : firefox (ALSA-2023:5184)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2023-5184.html");
...
var pkgs = [
    {'reference':'firefox-102.15.1-1.el8_8.alma', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-102.15.1-1.el8_8.alma', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
