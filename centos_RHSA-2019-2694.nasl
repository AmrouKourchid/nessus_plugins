...
# CentOS Errata and Security Advisory 2019:2694 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : firefox (CESA-2019:2694)");
...
the CVE page(s) listed in the References section.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a45c37c3");
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"firefox-60.9.0-1.el6.centos", allowmaj:TRUE)) flag++;
