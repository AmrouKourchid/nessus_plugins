...
# extracted from Fedora Security Advisory FEDORA-2024-ad738c922d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-ad738c922d");

  script_name(english:"Fedora 39 : thunderbird (2024-ad738c922d)");
...
FEDORA-2024-ad738c922d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-ad738c922d");
...
var pkgs = [
    {'reference':'thunderbird-115.16.1-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
