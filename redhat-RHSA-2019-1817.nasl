...
# extracted from Red Hat Security Advisory RHSA-2019:1817. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 8 : java-11-openjdk (RHSA-2019:1817)");
...
referenced in the RHSA-2019:1817 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_1817.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?23ef614a");
...
"Update the RHEL java-11-openjdk package based on the guidance in RHSA-2019:1817.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'java-11-openjdk-11.0.4.11-0.el8_0', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-11-openjdk-demo-11.0.4.11-0.el8_0', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-11-openjdk-devel-11.0.4.11-0.el8_0', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-11-openjdk-headless-11.0.4.11-0.el8_0', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-11-openjdk-javadoc-11.0.4.11-0.el8_0', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-11-openjdk-javadoc-zip-11.0.4.11-0.el8_0', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-11-openjdk-jmods-11.0.4.11-0.el8_0', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-11-openjdk-src-11.0.4.11-0.el8_0', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
