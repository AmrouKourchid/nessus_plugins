...
# extracted from Fedora Security Advisory FEDORA-2023-3dd938a14d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-3dd938a14d");

  script_name(english:"Fedora 39 : maradns (2023-3dd938a14d)");
...
FEDORA-2023-3dd938a14d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-3dd938a14d");
...
var pkgs = [
    {'reference':'maradns-3.5.0036-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
