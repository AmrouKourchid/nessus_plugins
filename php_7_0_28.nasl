...
if (description)
{
  ...
  script_name(english:"PHP 7.0.x < 7.0.28 Stack Buffer Overflow");
...
a stack buffer overflow vulnerability.");
  script_set_attribute(attribute:"see_also", value:"http://php.net/ChangeLog-7.php#7.0.28");
...
"Upgrade to PHP version 7.0.28 or later.");
