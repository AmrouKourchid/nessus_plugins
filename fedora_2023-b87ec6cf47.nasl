...
# extracted from Fedora Security Advisory FEDORA-2023-b87ec6cf47
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-b87ec6cf47");

  script_name(english:"Fedora 38 : proftpd (2023-b87ec6cf47)");
...
FEDORA-2023-b87ec6cf47 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-b87ec6cf47");
...
var pkgs = [
    {'reference':'proftpd-1.3.8b-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
