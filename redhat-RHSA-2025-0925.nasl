...
# extracted from Red Hat Security Advisory RHSA-2025:0925. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:0925");

  script_name(english:"RHEL 9 : bzip2 (RHSA-2025:0925)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_0925.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a04e289e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:0925");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL bzip2 package based on the guidance in RHSA-2025:0925.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'bzip2-1.0.8-10.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bzip2-devel-1.0.8-10.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bzip2-libs-1.0.8-10.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
