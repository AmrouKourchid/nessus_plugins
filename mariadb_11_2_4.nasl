...
if (description)
{
  ...
  script_name(english:"MariaDB 11.2.0 < 11.2.4");

  script_set_attribute(attribute:"synopsis", value:
"The remote database server is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of MariaDB installed on the remote host is prior to 11.2.4. It is, therefore, affected by a vulnerability as
referenced in the mdb-1124-rn advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://mariadb.com/kb/en/mdb-1124-rn");
  script_set_attribute(attribute:"solution", value:
"Upgrade to MariaDB version 11.2.4 or later.");
