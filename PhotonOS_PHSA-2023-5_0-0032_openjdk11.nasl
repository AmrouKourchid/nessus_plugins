...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Openjdk11 PHSA-2023-5.0-0032");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'openjdk11-11.0.20-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'openjdk11-doc-11.0.20-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'openjdk11-src-11.0.20-1.ph5')) flag++;
