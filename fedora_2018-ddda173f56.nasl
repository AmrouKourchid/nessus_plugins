...
# extracted from Fedora Security Advisory FEDORA-2018-ddda173f56.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : libmspack (2018-ddda173f56)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-ddda173f56");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"libmspack-0.7-0.1.alpha.fc28")) flag++;
