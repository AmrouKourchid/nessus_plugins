...
if (description)
{
  ...
  script_cve_id("CVE-2021-20232");

  script_name(english:"Photon OS 2.0: Gnutls PHSA-2021-2.0-0349");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'gnutls-3.6.15-3.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'gnutls-devel-3.6.15-3.ph2')) flag++;
