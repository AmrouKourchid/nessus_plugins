...
# extracted from Fedora Security Advisory FEDORA-2018-9a29edb638.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : poppler (2018-9a29edb638)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-9a29edb638");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"poppler-0.62.0-2.fc28")) flag++;
