...
if (description)
{
  ...
  script_cve_id("CVE-2024-52805");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-52805");
...
Note that Nessus relies on the presence of the package as reported by the vendor.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/CVE-2024-52805");
