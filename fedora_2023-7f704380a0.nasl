...
# extracted from Fedora Security Advisory FEDORA-2023-7f704380a0
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-7f704380a0");

  script_name(english:"Fedora 38 : java-1.8.0-openjdk (2023-7f704380a0)");
...
FEDORA-2023-7f704380a0 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-7f704380a0");
...
var pkgs = [
    {'reference':'java-1.8.0-openjdk-1.8.0.392.b08-4.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
