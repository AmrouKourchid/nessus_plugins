...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS : LibreOffice vulnerability (USN-3022-1)");
...
USN-3022-1 advisory.
    ...
    It was discovered that LibreOffice incorrectly handled RTF document files. If a user were tricked into
    opening a specially crafted RTF document, a remote attacker could cause LibreOffice to crash, and possibly
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3022-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'fonts-opensymbol', 'pkgver': '2:102.7+LibO5.1.4-0ubuntu1'},
    {'osver': '16.04', 'pkgname': 'gir1.2-lokdocview-0.1', 'pkgver': '1:5.1.4-0ubuntu1'},
    {'osver': '16.04', 'pkgname': 'libreoffice', 'pkgver': '1:5.1.4-0ubuntu1'},
    {'osver': '16.04', 'pkgname': 'libreoffice-avmedia-backend-gstreamer', 'pkgver': '1:5.1.4-0ubuntu1'},
    {'osver': '16.04', 'pkgname': 'libreoffice-base', 'pkgver': '1:5.1.4-0ubuntu1'},
    {'osver': '16.04', 'pkgname': 'libreoffice-base-core', 'pkgver': '1:5.1.4-0ubuntu1'},
    {'osver': '16.04', 'pkgname': 'libreoffice-base-drivers', 'pkgver': '1:5.1.4-0ubuntu1'},
    {'osver': '16.04', 'pkgname': 'libreoffice-calc', 'pkgver': '1:5.1.4-0ubuntu1'},
    {'osver': '16.04', 'pkgname': 'libreoffice-common', 'pkgver': '1:5.1.4-0ubuntu1'},
    {'osver': '16.04', 'pkgname': 'libreoffice-core', 'pkgver': '1:5.1.4-0ubuntu1'},
    {'osver': '16.04', 'pkgname': 'libreoffice-dev', 'pkgver': '1:5.1.4-0ubuntu1'},
    {'osver': '16.04', 'pkgname': 'libreoffice-draw', 'pkgver': '1:5.1.4-0ubuntu1'},
    {'osver': '16.04', 'pkgname': 'libreoffice-gnome', 'pkgver': '1:5.1.4-0ubuntu1'},
    {'osver': '16.04', 'pkgname': 'libreoffice-gtk', 'pkgver': '1:5.1.4-0ubuntu1'},
    {'osver': '16.04', 'pkgname': 'libreoffice-gtk3', 'pkgver': '1:5.1.4-0ubuntu1'},
    {'osver': '16.04', 'pkgname': 'libreoffice-impress', 'pkgver': '1:5.1.4-0ubuntu1'},
    {'osver': '16.04', 'pkgname': 'libreoffice-java-common', 'pkgver': '1:5.1.4-0ubuntu1'},
    {'osver': '16.04', 'pkgname': 'libreoffice-kde', 'pkgver': '1:5.1.4-0ubuntu1'},
    {'osver': '16.04', 'pkgname': 'libreoffice-l10n-in', 'pkgver': '1:5.1.4-0ubuntu1'},
    {'osver': '16.04', 'pkgname': 'libreoffice-l10n-za', 'pkgver': '1:5.1.4-0ubuntu1'},
    {'osver': '16.04', 'pkgname': 'libreoffice-librelogo', 'pkgver': '1:5.1.4-0ubuntu1'},
    {'osver': '16.04', 'pkgname': 'libreoffice-math', 'pkgver': '1:5.1.4-0ubuntu1'},
    {'osver': '16.04', 'pkgname': 'libreoffice-mysql-connector', 'pkgver': '1.0.2+LibO5.1.4-0ubuntu1'},
    {'osver': '16.04', 'pkgname': 'libreoffice-officebean', 'pkgver': '1:5.1.4-0ubuntu1'},
    {'osver': '16.04', 'pkgname': 'libreoffice-ogltrans', 'pkgver': '1:5.1.4-0ubuntu1'},
    {'osver': '16.04', 'pkgname': 'libreoffice-pdfimport', 'pkgver': '1:5.1.4-0ubuntu1'},
    {'osver': '16.04', 'pkgname': 'libreoffice-report-builder', 'pkgver': '1:5.1.4-0ubuntu1'},
    {'osver': '16.04', 'pkgname': 'libreoffice-report-builder-bin', 'pkgver': '1:5.1.4-0ubuntu1'},
    {'osver': '16.04', 'pkgname': 'libreoffice-script-provider-bsh', 'pkgver': '1:5.1.4-0ubuntu1'},
    {'osver': '16.04', 'pkgname': 'libreoffice-script-provider-js', 'pkgver': '1:5.1.4-0ubuntu1'},
    {'osver': '16.04', 'pkgname': 'libreoffice-script-provider-python', 'pkgver': '1:5.1.4-0ubuntu1'},
    {'osver': '16.04', 'pkgname': 'libreoffice-sdbc-firebird', 'pkgver': '1:5.1.4-0ubuntu1'},
    {'osver': '16.04', 'pkgname': 'libreoffice-sdbc-hsqldb', 'pkgver': '1:5.1.4-0ubuntu1'},
    {'osver': '16.04', 'pkgname': 'libreoffice-sdbc-postgresql', 'pkgver': '1:5.1.4-0ubuntu1'},
    {'osver': '16.04', 'pkgname': 'libreoffice-style-breeze', 'pkgver': '1:5.1.4-0ubuntu1'},
    {'osver': '16.04', 'pkgname': 'libreoffice-style-elementary', 'pkgver': '1:5.1.4-0ubuntu1'},
    {'osver': '16.04', 'pkgname': 'libreoffice-style-galaxy', 'pkgver': '1:5.1.4-0ubuntu1'},
    {'osver': '16.04', 'pkgname': 'libreoffice-style-hicontrast', 'pkgver': '1:5.1.4-0ubuntu1'},
    {'osver': '16.04', 'pkgname': 'libreoffice-style-human', 'pkgver': '1:5.1.4-0ubuntu1'},
    {'osver': '16.04', 'pkgname': 'libreoffice-style-oxygen', 'pkgver': '1:5.1.4-0ubuntu1'},
    {'osver': '16.04', 'pkgname': 'libreoffice-style-sifr', 'pkgver': '1:5.1.4-0ubuntu1'},
    {'osver': '16.04', 'pkgname': 'libreoffice-style-tango', 'pkgver': '1:5.1.4-0ubuntu1'},
    {'osver': '16.04', 'pkgname': 'libreoffice-subsequentcheckbase', 'pkgver': '1:5.1.4-0ubuntu1'},
    {'osver': '16.04', 'pkgname': 'libreoffice-wiki-publisher', 'pkgver': '1.2.0+LibO5.1.4-0ubuntu1'},
    {'osver': '16.04', 'pkgname': 'libreoffice-writer', 'pkgver': '1:5.1.4-0ubuntu1'},
    {'osver': '16.04', 'pkgname': 'libreofficekit-dev', 'pkgver': '1:5.1.4-0ubuntu1'},
    {'osver': '16.04', 'pkgname': 'python3-uno', 'pkgver': '1:5.1.4-0ubuntu1'},
    {'osver': '16.04', 'pkgname': 'uno-libs3', 'pkgver': '5.1.4-0ubuntu1'},
    {'osver': '16.04', 'pkgname': 'ure', 'pkgver': '5.1.4-0ubuntu1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'fonts-opensymbol / gir1.2-lokdocview-0.1 / libreoffice / etc');
}
