...
# extracted from Ubuntu Security Notice USN-7159-5. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"7159-5");

  script_name(english:"Ubuntu 18.04 LTS : Linux kernel (Raspberry Pi) vulnerabilities (USN-7159-5)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7159-5");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-7159-5');
}
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-7159-5');
  }
  else
  {
