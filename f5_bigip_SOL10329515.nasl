...
group, the BIG-IP system fails over to the peer device.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K10329515");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K10329515.");
...
var vmatrix = {
  'PEM': {
    'affected': [
      '13.0.0','12.0.0-12.1.3','11.6.0-11.6.2','11.5.1-11.5.5','11.2.1'
    ],
    'unaffected': [
