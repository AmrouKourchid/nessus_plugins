...
# extracted from Fedora Security Advisory FEDORA-2024-0ddda4c691
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-0ddda4c691");

  script_name(english:"Fedora 38 : python-aiohttp (2024-0ddda4c691)");
...
FEDORA-2024-0ddda4c691 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-0ddda4c691");
...
var pkgs = [
    {'reference':'python-aiohttp-3.9.3-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
