...
# extracted from HP patch PHSS_32140. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_32140 : s700_800 11.04 Virtualvault 4.7 IWS update");
...
"Install patch PHSS_32140 or subsequent.");
...
{
  exit(0, "The host is not affected since PHSS_32140 applies to a different OS release.");
}

patches = make_list("PHSS_32140", "PHSS_34169", "PHSS_35106", "PHSS_35308", "PHSS_35460", "PHSS_35555");
