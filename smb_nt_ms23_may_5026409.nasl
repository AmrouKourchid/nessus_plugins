...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5026409");
  script_xref(name:"MSKB", value:"5026415");
  script_xref(name:"MSFT", value:"MS23-5026409");
  script_xref(name:"MSFT", value:"MS23-5026415");
  ...
  script_name(english:"KB5026409: Windows 8.1 Embedded and Windows Server 2012 R2 Security Update (May 2023)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5026409. It is, therefore, affected by multiple vulnerabilities
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5026409");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5026415");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5026409 or Cumulative Update 5026415");
...
if (
  smb_check_rollup(os:'6.3',
                   ...
                   rollup_date:'05_2023',
                   bulletin:bulletin,
                   rollup_kb_list:[5026415, 5026409])
)
{
