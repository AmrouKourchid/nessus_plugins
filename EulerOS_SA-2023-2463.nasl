...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : kernel (EulerOS-SA-2023-2463)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2463
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?35f894d3");
...
"Update the affected kernel packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2023-1281");
...
var pkgs = [
  "kernel-4.19.90-vhulk2211.3.0.h1489.eulerosv2r10",
  "kernel-abi-stablelists-4.19.90-vhulk2211.3.0.h1489.eulerosv2r10",
  "kernel-tools-4.19.90-vhulk2211.3.0.h1489.eulerosv2r10",
  "kernel-tools-libs-4.19.90-vhulk2211.3.0.h1489.eulerosv2r10",
  "python3-perf-4.19.90-vhulk2211.3.0.h1489.eulerosv2r10"
];
