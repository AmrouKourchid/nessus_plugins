...
# extracted from Fedora Security Advisory FEDORA-2025-dbe19a2b1f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-dbe19a2b1f");

  script_name(english:"Fedora 41 : mingw-python-jinja2 (2025-dbe19a2b1f)");
...
FEDORA-2025-dbe19a2b1f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-dbe19a2b1f");
...
var pkgs = [
    {'reference':'mingw-python-jinja2-3.1.5-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
