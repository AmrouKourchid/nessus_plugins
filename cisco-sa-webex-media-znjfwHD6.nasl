...
if (description)
{
  ...
  script_name(english:"Cisco Webex Meetings for Windows Information Disclosure Vulnerability (cisco-sa-webex-media-znjfwHD6)");

  script_set_attribute(attribute:"synopsis", value:
"The remote device is missing a vendor-supplied security patch");
  script_set_attribute(attribute:"description", value:
"According to its self-reported version, Cisco Webex Meetings is affected by a vulnerability. Please see the included
...
constraints = [
  { 'min_version': '1.0',  'fixed_version' : '39.5.25' },
  { 'min_version': '40.0',  'fixed_version' : '40.6.6' },
];
