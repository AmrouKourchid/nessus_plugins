...
# extracted from Ubuntu Security Notice USN-6701-3. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6701-3");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2024/06/20");

  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS : Linux kernel vulnerabilities (USN-6701-3)");
...
referenced in the USN-6701-3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6701-3");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-6701-3');
}
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-6701-3');
  }
  else
  {
