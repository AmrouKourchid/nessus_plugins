...
# extracted from Fedora Security Advisory FEDORA-2022-ec66fe614d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-ec66fe614d");

  script_name(english:"Fedora 37 : fribidi (2022-ec66fe614d)");
...
FEDORA-2022-ec66fe614d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-ec66fe614d");
...
"Update the affected fribidi package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:fribidi");
...
var pkgs = [
    {'reference':'fribidi-1.0.11-3.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
