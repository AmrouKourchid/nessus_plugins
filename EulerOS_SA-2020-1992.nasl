...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.6.0 : libICE (EulerOS-SA-2020-1992)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization for ARM 64 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the version of the libICE package installed, the EulerOS
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1992
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a8031cf7");
  script_set_attribute(attribute:"solution", value:
"Update the affected libICE package.");
...
pkgs = ["libICE-1.0.9-14.eulerosv2r8"];
