...
# extracted from Red Hat Security Advisory RHSA-2023:1435. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_1435.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0feac0af");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:1435");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  var cve_list = make_list('CVE-2022-3564', 'CVE-2022-4378', 'CVE-2022-4379', 'CVE-2023-0179', 'CVE-2023-0266');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for RHSA-2023:1435');
  }
  else
  {
...
var kernel_live_checks = [
  {
    ...
    'kernels': {
      '5.14.0-70.22.1.el9_0.ppc64le': {
        'pkgs': [
          {'reference':'kpatch-patch-5_14_0-70_22_1-1-6.el9_0', 'sp':'0', 'cpu':'ppc64le', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        ]
      },
      '5.14.0-70.22.1.el9_0.x86_64': {
        'pkgs': [
          {'reference':'kpatch-patch-5_14_0-70_22_1-1-6.el9_0', 'sp':'0', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        ]
      },
      '5.14.0-70.26.1.el9_0.ppc64le': {
        'pkgs': [
          {'reference':'kpatch-patch-5_14_0-70_26_1-1-5.el9_0', 'sp':'0', 'cpu':'ppc64le', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        ]
      },
      '5.14.0-70.26.1.el9_0.x86_64': {
        'pkgs': [
          {'reference':'kpatch-patch-5_14_0-70_26_1-1-5.el9_0', 'sp':'0', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        ]
      },
      '5.14.0-70.30.1.el9_0.ppc64le': {
        'pkgs': [
          {'reference':'kpatch-patch-5_14_0-70_30_1-1-3.el9_0', 'sp':'0', 'cpu':'ppc64le', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        ]
      },
      '5.14.0-70.30.1.el9_0.x86_64': {
        'pkgs': [
          {'reference':'kpatch-patch-5_14_0-70_30_1-1-3.el9_0', 'sp':'0', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        ]
      },
      '5.14.0-70.36.1.el9_0.ppc64le': {
        'pkgs': [
          {'reference':'kpatch-patch-5_14_0-70_36_1-1-2.el9_0', 'sp':'0', 'cpu':'ppc64le', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        ]
      },
      '5.14.0-70.36.1.el9_0.x86_64': {
        'pkgs': [
          {'reference':'kpatch-patch-5_14_0-70_36_1-1-2.el9_0', 'sp':'0', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        ]
      },
      '5.14.0-70.43.1.el9_0.ppc64le': {
        'pkgs': [
          {'reference':'kpatch-patch-5_14_0-70_43_1-1-1.el9_0', 'sp':'0', 'cpu':'ppc64le', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        ]
      },
      '5.14.0-70.43.1.el9_0.x86_64': {
        'pkgs': [
          {'reference':'kpatch-patch-5_14_0-70_43_1-1-1.el9_0', 'sp':'0', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kpatch-patch-5_14_0-70_22_1 / kpatch-patch-5_14_0-70_26_1 / etc');
}
