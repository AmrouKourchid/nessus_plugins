...
# extracted from Debian Security Advisory DLA-1709-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1709-1 : waagent security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2019/03/msg00011.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/jessie/waagent");
  script_set_attribute(attribute:"solution", value:
"Upgrade the affected waagent package.");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"waagent", reference:"2.2.18-3~deb8u2")) flag++;
