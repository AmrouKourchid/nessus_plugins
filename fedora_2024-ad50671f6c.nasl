...
# extracted from Fedora Security Advisory FEDORA-2024-ad50671f6c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-ad50671f6c");

  script_name(english:"Fedora 38 : seamonkey (2024-ad50671f6c)");
...
FEDORA-2024-ad50671f6c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-ad50671f6c");
...
var pkgs = [
    {'reference':'seamonkey-2.53.18.2-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
