...
# extracted from Fedora Security Advisory FEDORA-2024-80e4603b92
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-80e4603b92");
  script_xref(name:"IAVB", value:"2024-B-0154-S");

  script_name(english:"Fedora 40 : libarchive (2024-80e4603b92)");
...
FEDORA-2024-80e4603b92 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-80e4603b92");
...
var pkgs = [
    {'reference':'libarchive-3.7.2-7.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
