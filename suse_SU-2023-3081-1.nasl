...
# SUSE update advisory SUSE-SU-2023:3081-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2023-2002", "CVE-2023-3159", "CVE-2023-35788");
  script_xref(name:"SuSE", value:"SUSE-SU-2023:3081-1");

  script_name(english:"SUSE SLES15 Security Update : kernel (Live Patch 36 for SLE 15 SP2) (SUSE-SU-2023:3081-1)");
...
the SUSE-SU-2023:3081-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1212347");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1212509");
  # https://lists.suse.com/pipermail/sle-security-updates/2023-August/015717.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d6ac2fd7");
...
"Update the affected kernel-livepatch-5_3_18-150200_24_151-default package.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '5.3.18-150200.24.151-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_3_18-150200_24_151-default-4-150200.2.1', 'sp':'2', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.2']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kernel-livepatch-5_3_18-150200_24_151-default');
}
