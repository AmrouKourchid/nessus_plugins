...
# extracted from Fedora Security Advisory FEDORA-2024-daa7df59d6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-daa7df59d6");

  script_name(english:"Fedora 38 : qpdf (2024-daa7df59d6)");
...
FEDORA-2024-daa7df59d6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-daa7df59d6");
...
var pkgs = [
    {'reference':'qpdf-11.6.4-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
