...
if (description)
{
  ...
  script_name(english:"Oracle Business Intelligence Enterprise Edition (OAS 7.6) (October 2024 CPU)");
...
host is affected by multiple vulnerabilities as referenced in the October 2024 CPU advisory, including the
following:

  - Vulnerability in the Oracle Business Intelligence Enterprise Edition product of Oracle Analytics 
    (component: Analytics Server (OpenSSL)). Supported versions that are affected are 7.0.0.0.0 and 
    7.6.0.0.0. Easily exploitable vulnerability allows unauthenticated attacker with network access via TLS 
    to compromise Oracle Business Intelligence Enterprise Edition. Successful attacks of this vulnerability 
    can result in unauthorized ability to cause a partial denial of service (partial DOS) of Oracle Business 
    Intelligence Enterprise Edition. (CVE-2023-5678)
...
var constraints = [
  {'min_version': '7.6.0.0.0', 'fixed_version': '7.6.0.0.241001', 'fixed_display': '7.6.0.0.241001 patch: 37123210'}
];
