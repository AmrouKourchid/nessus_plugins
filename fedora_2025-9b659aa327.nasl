...
# extracted from Fedora Security Advisory FEDORA-2025-9b659aa327
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-9b659aa327");

  script_name(english:"Fedora 41 : libtasn1 (2025-9b659aa327)");
...
FEDORA-2025-9b659aa327 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-9b659aa327");
...
var pkgs = [
    {'reference':'libtasn1-4.20.0-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
