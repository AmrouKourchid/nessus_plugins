...
# extracted from Fedora Security Advisory FEDORA-2024-fa7b758114
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-fa7b758114");

  script_name(english:"Fedora 39 : apache-commons-configuration (2024-fa7b758114)");
...
FEDORA-2024-fa7b758114 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-fa7b758114");
...
var pkgs = [
    {'reference':'apache-commons-configuration-2.10.1-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
