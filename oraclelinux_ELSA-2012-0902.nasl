...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2012-0902.html");
...
"Update the affected cifs-utils package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2012-1586");
...
var pkgs = [
    {'reference':'cifs-utils-4.8.1-10.el6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cifs-utils-4.8.1-10.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
];
