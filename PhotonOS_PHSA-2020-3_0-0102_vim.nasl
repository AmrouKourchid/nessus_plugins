...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Vim PHSA-2020-3.0-0102");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'vim-8.1.1365-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'vim-extra-8.1.1365-1.ph3')) flag++;
