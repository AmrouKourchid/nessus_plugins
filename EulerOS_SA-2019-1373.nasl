...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.4 : qemu-kvm (EulerOS-SA-2019-1373)");
...
the following vulnerability :
  ...
  - An integer overflow issue was found in the NE200 NIC
    ...
    scenario.(CVE-2018-10839)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1373
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?aa07103a");
...
"Update the affected qemu-kvm package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-10839");
...
pkgs = ["qemu-gpu-specs-2.8.1-25.198",
        "qemu-guest-agent-2.8.1-25.198",
        "qemu-img-2.8.1-25.198",
        "qemu-kvm-2.8.1-25.198",
        "qemu-kvm-common-2.8.1-25.198",
        "qemu-kvm-tools-2.8.1-25.198",
        "qemu-seabios-2.8.1-25.198"];
