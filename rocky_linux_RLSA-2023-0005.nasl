...
# Rocky Linux Security Advisory RLSA-2023:0005.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2023:0005");

  script_name(english:"Rocky Linux 9 : bcel (RLSA-2023:0005)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2023:0005");
...
"Update the affected bcel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:rocky:linux:bcel");
