...
# extracted from Fedora Security Advisory FEDORA-2024-c8290315df
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-c8290315df");

  script_name(english:"Fedora 39 : 389-ds-base (2024-c8290315df)");
...
FEDORA-2024-c8290315df advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-c8290315df");
...
var pkgs = [
    {'reference':'389-ds-base-2.4.6-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
