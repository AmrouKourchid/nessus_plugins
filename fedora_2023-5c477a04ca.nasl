...
# extracted from Fedora Security Advisory FEDORA-2023-5c477a04ca
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-5c477a04ca");
  script_xref(name:"IAVA", value:"2023-A-0265-S");

  script_name(english:"Fedora 38 : chromium (2023-5c477a04ca)");
...
FEDORA-2023-5c477a04ca advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-5c477a04ca");
...
var pkgs = [
    {'reference':'chromium-113.0.5672.126-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
