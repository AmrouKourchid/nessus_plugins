...
# extracted from Fedora Security Advisory FEDORA-2018-e6894349c9.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-e6894349c9");

  script_name(english:"Fedora 28 : bouncycastle (2018-e6894349c9)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"Security fix for CVE-2018-1000613

Note that Tenable Network Security has extracted the preceding
description block directly from the Fedora update system website.
Tenable has attempted to automatically clean and format it as much as
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-e6894349c9");
  script_set_attribute(attribute:"solution", value:
"Update the affected bouncycastle package.");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"bouncycastle-1.60-1.fc28")) flag++;
