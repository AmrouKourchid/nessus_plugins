...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : samba (EulerOS-SA-2019-1780)");
...
vulnerability :
  ...
  - A double-free was found when Samba's KDC is used as an
    Active Directory Domain Controller. An authenticated
    attacker could use this flaw to cause a denial of
    service (application crash).(CVE-2018-16841)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1780
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1eae2a23");
...
"Update the affected samba package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-16841");
...
pkgs = ["ctdb-4.9.1-2.h3.eulerosv2r8",
        "ctdb-tests-4.9.1-2.h3.eulerosv2r8",
        "libsmbclient-4.9.1-2.h3.eulerosv2r8",
        "libwbclient-4.9.1-2.h3.eulerosv2r8",
        "python2-samba-4.9.1-2.h3.eulerosv2r8",
        "python3-samba-4.9.1-2.h3.eulerosv2r8",
        "python3-samba-test-4.9.1-2.h3.eulerosv2r8",
        "samba-4.9.1-2.h3.eulerosv2r8",
        "samba-client-4.9.1-2.h3.eulerosv2r8",
        "samba-client-libs-4.9.1-2.h3.eulerosv2r8",
        "samba-common-4.9.1-2.h3.eulerosv2r8",
        "samba-common-libs-4.9.1-2.h3.eulerosv2r8",
        "samba-common-tools-4.9.1-2.h3.eulerosv2r8",
        "samba-dc-libs-4.9.1-2.h3.eulerosv2r8",
        "samba-krb5-printing-4.9.1-2.h3.eulerosv2r8",
        "samba-libs-4.9.1-2.h3.eulerosv2r8",
        "samba-pidl-4.9.1-2.h3.eulerosv2r8",
        "samba-test-4.9.1-2.h3.eulerosv2r8",
        "samba-test-libs-4.9.1-2.h3.eulerosv2r8",
        "samba-winbind-4.9.1-2.h3.eulerosv2r8",
        "samba-winbind-clients-4.9.1-2.h3.eulerosv2r8",
        "samba-winbind-krb5-locator-4.9.1-2.h3.eulerosv2r8",
        "samba-winbind-modules-4.9.1-2.h3.eulerosv2r8"];
