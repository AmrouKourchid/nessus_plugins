...
# extracted from Debian Security Advisory DLA-1868-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1868-1 : squirrelmail security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2019/08/msg00000.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/jessie/squirrelmail");
  script_set_attribute(attribute:"solution", value:
"Upgrade the affected squirrelmail package.");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"squirrelmail", reference:"2:1.4.23~svn20120406-2+deb8u4")) flag++;
