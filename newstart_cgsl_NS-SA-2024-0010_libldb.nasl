...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.04 / MAIN 5.04 : libldb Vulnerability (NS-SA-2024-0010)");

  script_set_attribute(attribute:"synopsis", value:
"The remote NewStart CGSL host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version CORE 5.04 / MAIN 5.04, has libldb packages installed that are affected by
a vulnerability:
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/info/CVE-2021-20277");
...
var pkgs = {
  'CGSL CORE 5.04': [
    'ldb-tools-1.5.4-2.el7_9',
    'libldb-1.5.4-2.el7_9',
    'libldb-debuginfo-1.5.4-2.el7_9',
    'libldb-devel-1.5.4-2.el7_9',
    'pyldb-1.5.4-2.el7_9',
    'pyldb-devel-1.5.4-2.el7_9'
  ],
  'CGSL MAIN 5.04': [
    'ldb-tools-1.5.4-2.el7_9',
    'libldb-1.5.4-2.el7_9',
