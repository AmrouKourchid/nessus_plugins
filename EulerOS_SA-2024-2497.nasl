...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP12 : busybox (EulerOS-SA-2024-2497)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2497
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dab9f4da");
...
var pkgs = [
  "busybox-1.34.1-17.h9.eulerosv2r12"
];
