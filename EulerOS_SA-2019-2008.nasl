...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : openssl (EulerOS-SA-2019-2008)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2008
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1d6b90de");
...
pkgs = ["openssl-1.0.2k-16.h7",
        "openssl-devel-1.0.2k-16.h7",
        "openssl-libs-1.0.2k-16.h7"];
