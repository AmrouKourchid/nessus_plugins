...
# extracted from Red Hat Security Advisory RHSA-2023:4634. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:4634");

  script_name(english:"RHEL 9 : rust (RHSA-2023:4634)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for rust.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_4634.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?66f97f25");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2228038");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:4634");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rust package based on the guidance in RHSA-2023:4634.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cargo-1.66.1-2.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'clippy-1.66.1-2.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rust-1.66.1-2.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rust-analysis-1.66.1-2.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rust-analyzer-1.66.1-2.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rust-debugger-common-1.66.1-2.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rust-doc-1.66.1-2.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rust-gdb-1.66.1-2.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rust-lldb-1.66.1-2.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rust-src-1.66.1-2.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rust-std-static-1.66.1-2.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rust-std-static-wasm32-unknown-unknown-1.66.1-2.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rust-std-static-wasm32-wasi-1.66.1-2.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rust-toolset-1.66.1-2.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rustfmt-1.66.1-2.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
