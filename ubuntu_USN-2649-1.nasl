...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : devscripts vulnerability (USN-2649-1)");
...
USN-2649-1 advisory.
    ...
    It was discovered that the uupdate tool incorrectly handled symlinks. If a user or automated system were
    tricked into processing specially crafted files, a remote attacker could possibly replace arbitrary files,
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2649-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'devscripts', 'pkgver': '2.14.1ubuntu0.1'}
];
