...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : exiv2 (EulerOS-SA-2022-1266)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1266
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3334d7dd");
...
var pkgs = [
  "exiv2-libs-0.26-3.h18.eulerosv2r7"
];
