...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : binutils (EulerOS-SA-2025-1348)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1348
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c73ef3e6");
...
var pkgs = [
  "binutils-2.37-6.h28.eulerosv2r11"
];
