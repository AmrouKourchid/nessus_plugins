...
without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://usn.ubuntu.com/1107-1/");
  script_set_attribute(attribute:"solution", value:
"Update the affected x11-xserver-utils package.");
  ...
  script_copyright(english:"Ubuntu Security Notice (C) 2011-2025 Canonical, Inc. / NASL script (C) 2011-2025 and is owned by Tenable, Inc. or an Affiliate thereof.");
