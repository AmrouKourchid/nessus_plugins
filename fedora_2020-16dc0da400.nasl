...
# extracted from Fedora Security Advisory FEDORA-2020-16dc0da400.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-16dc0da400");

  script_name(english:"Fedora 31 : python-twisted (2020-16dc0da400)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"Security fix for CVE-2020-10108 (#1813439, #1813441) Security fix for
CVE-2020-10109 (#1813447, #1813449)
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-16dc0da400");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"python-twisted-19.2.1-6.fc31")) flag++;
