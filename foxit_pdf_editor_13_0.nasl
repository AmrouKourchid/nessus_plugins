...
if (description)
{
  ...
  script_name(english:"Foxit PDF Editor < 13.0 Multiple Vulnerabilities");
...
Windows host is prior to 13.0. It is, therefore affected by multiple vulnerabilities:
...
"Upgrade to Foxit PDF Editor version 13.0 or later");
...
var constraints = [
  { 'max_version' : '10.1.12.37872', 'fixed_version' : '13.0' },
  { 'min_version' : '11.0', 'max_version' : '11.2.6.53790', 'fixed_version' : '13.0' },
  { 'min_version' : '12.0', 'max_version' : '12.1.3.15356', 'fixed_version' : '13.0' }
];
