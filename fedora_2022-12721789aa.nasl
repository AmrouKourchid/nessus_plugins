...
# extracted from Fedora Security Advisory FEDORA-2022-12721789aa
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-12721789aa");

  script_name(english:"Fedora 37 : nginx (2022-12721789aa)");
...
FEDORA-2022-12721789aa advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-12721789aa");
...
var pkgs = [
    {'reference':'nginx-1.22.1-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
