...
"The version of Thunderbird installed on the remote Windows host is prior to 138.0. It is, therefore, affected by
multiple vulnerabilities as referenced in the mfsa2025-31 advisory.
...
mozilla_check_version(installs:installs, product:'thunderbird', esr:FALSE, fix:'138.0', severity:SECURITY_WARNING);
