...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Sqlite PHSA-2017-0025");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'sqlite-autoconf-3.18.0-2.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'sqlite-autoconf-debuginfo-3.18.0-2.ph1')) flag++;
