...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : tomcat on SL7.x (x86_64) (20190318)");
...
"Security Fix(es) :
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?333fcb2a");
