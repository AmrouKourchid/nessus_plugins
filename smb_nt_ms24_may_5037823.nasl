...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5037823");
  script_xref(name:"MSFT", value:"MS24-5037823");
  script_xref(name:"IAVA", value:"2024-A-0282-S");

  script_name(english:"KB5037823: Windows Server 2012 R2 Security Update (May 2024)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5037823. It is, therefore, affected by multiple vulnerabilities
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5037823");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5037823");
