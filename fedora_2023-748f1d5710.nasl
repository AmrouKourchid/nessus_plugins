...
# extracted from Fedora Security Advisory FEDORA-2023-748f1d5710
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-748f1d5710");

  script_name(english:"Fedora 37 : freeimage / mingw-freeimage (2023-748f1d5710)");
...
FEDORA-2023-748f1d5710 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-748f1d5710");
...
"Update the affected freeimage and / or mingw-freeimage packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-33367");
...
var pkgs = [
    {'reference':'freeimage-3.19.0-0.16.svn1889.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'mingw-freeimage-3.19.0-0.14.svn1889.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
