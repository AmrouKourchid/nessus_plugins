...
# extracted from Ubuntu Security Notice USN-6309-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6309-1");

  script_name(english:"Ubuntu 16.04 ESM : Linux kernel vulnerabilities (USN-6309-1)");
...
the USN-6309-1 advisory.
    ...
    It was discovered that the virtual terminal driver in the Linux kernel contained a use-after-free
    vulnerability. A local attacker could use this to cause a denial of service (system crash) or possibly
    expose sensitive information (kernel memory). (CVE-2023-3567)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6309-1");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.4.0-1160-aws");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.4.0-244-generic");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.4.0-244-lowlatency");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-6309-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2023-2269', 'CVE-2023-2985', 'CVE-2023-3567', 'CVE-2023-3611', 'CVE-2023-3776', 'CVE-2023-31084');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-6309-1');
  }
  else
  {
