...
# extracted from Red Hat Security Advisory RHSA-2021:4910. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:4910");

  script_name(english:"RHEL 7 / 8 : OpenShift Virtualization 4.8.3 RPMs (RHSA-2021:4910)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for OpenShift Virtualization 4.8.3 RPMs.");
...
in the RHSA-2021:4910 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2007344");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_4910.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8b25dd21");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:4910");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Virtualization 4.8.3 RPMs package based on the guidance in RHSA-2021:4910.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'kubevirt-virtctl-4.8.3-251.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'kubevirt-virtctl-redistributable-4.8.3-251.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'kubevirt-virtctl-4.8.3-251.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'kubevirt-virtctl-redistributable-4.8.3-251.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
