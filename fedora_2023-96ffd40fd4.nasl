...
# extracted from Fedora Security Advisory FEDORA-2023-96ffd40fd4
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-96ffd40fd4");

  script_name(english:"Fedora 37 : tcpreplay (2023-96ffd40fd4)");
...
FEDORA-2023-96ffd40fd4 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-96ffd40fd4");
...
var pkgs = [
    {'reference':'tcpreplay-4.4.3-3.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
