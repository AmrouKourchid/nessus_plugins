...
# SUSE update advisory SUSE-SU-2024:0974-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2024:0974-1");

  script_name(english:"openSUSE 15 Security Update : jsch-agent-proxy (SUSE-SU-2024:0974-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1218198");
  # https://lists.suse.com/pipermail/sle-security-updates/2024-March/018187.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?45eb08bd");
...
var pkgs = [
    {'reference':'jsch-agent-proxy-connector-factory-0.0.9-150200.3.7.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.5']},
    {'reference':'jsch-agent-proxy-core-0.0.9-150200.3.7.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.5']},
    {'reference':'jsch-agent-proxy-javadoc-0.0.9-150200.3.7.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.5']},
    {'reference':'jsch-agent-proxy-jsch-0.0.9-150200.3.7.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.5']},
    {'reference':'jsch-agent-proxy-pageant-0.0.9-150200.3.7.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.5']},
    {'reference':'jsch-agent-proxy-sshagent-0.0.9-150200.3.7.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.5']},
    {'reference':'jsch-agent-proxy-usocket-jna-0.0.9-150200.3.7.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.5']},
    {'reference':'jsch-agent-proxy-usocket-nc-0.0.9-150200.3.7.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.5']}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'jsch-agent-proxy-connector-factory / jsch-agent-proxy-core / etc');
}
