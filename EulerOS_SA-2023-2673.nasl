...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : xorg-x11-server (EulerOS-SA-2023-2673)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2673
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e02aef2a");
...
var pkgs = [
  "xorg-x11-server-help-1.20.11-4.h9.eulerosv2r11"
];
