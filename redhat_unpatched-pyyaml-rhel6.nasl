...
# extracted from Red Hat Security Advisory pyyaml. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2017-18342", "CVE-2019-20477");

  script_name(english:"RHEL 6 : pyyaml (Unpatched Vulnerability) (deprecated)");
