...
referenced in the RHSA-2012:0422 advisory.
    ...
    Red Hat would like to thank Stephan Brwolf for reporting CVE-2012-0045,
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2012/rhsa-2012_0422.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?15343383");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=796913");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=796915");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=798183");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2012:0422");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rhev-hypervisor6 package based on the guidance in RHSA-2012:0422.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rhev-hypervisor6-6.2-20120320.0.el6_2', 'release':'6', 'el_string':'el6_2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'},
      {'reference':'rhev-hypervisor6-tools-6.2-20120320.0.el6_2', 'release':'6', 'el_string':'el6_2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'}
    ]
  }
];
