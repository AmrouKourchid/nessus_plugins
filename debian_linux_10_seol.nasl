...
if (description)
{
  ...
  script_name(english:"Debian Linux SEoL (10.x)");
...
contain security vulnerabilities.");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/News/2022/20220910");
...
"Upgrade to a version of Debian Linux that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2022/09/10");
...
var constraints = [
  { max_branch : '10', min_branch : '10', seol : 20220910 }
];
