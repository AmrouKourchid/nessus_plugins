...
"The version of Google Chrome installed on the remote Windows host is prior to 121.0.6167.85. It is, therefore, affected
by multiple vulnerabilities as referenced in the 2024_01_stable-channel-update-for-desktop_23 advisory.
...
google_chrome_check_version(installs:installs, fix:'121.0.6167.85', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
