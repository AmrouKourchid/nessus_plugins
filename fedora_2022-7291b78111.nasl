...
# extracted from Fedora Security Advisory FEDORA-2022-7291b78111
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-7291b78111");

  script_name(english:"Fedora 37 : js-jquery-ui (2022-7291b78111)");
...
FEDORA-2022-7291b78111 advisory.

    A flaw was found in the jquery-UI package. Affected versions of this package are vulnerable to Cross-site
    scripting (XSS)  attack via the initialization of a check-box-radio widget on an input tag enclosed within
    a label, leading to the parent label contents being considered as the input label.

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-7291b78111");
...
var pkgs = [
    {'reference':'js-jquery-ui-1.13.2-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
