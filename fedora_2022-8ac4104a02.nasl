...
# extracted from Fedora Security Advisory FEDORA-2022-8ac4104a02
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-8ac4104a02");

  script_name(english:"Fedora 35 : systemd (2022-8ac4104a02)");
...
FEDORA-2022-8ac4104a02 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-8ac4104a02");
...
var pkgs = [
    {'reference':'systemd-249.13-6.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
