...
# extracted from Debian Security Advisory dla-2968. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2968-1 : zlib - LTS security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 9 host has packages installed that are affected by a vulnerability as referenced in the dla-2968
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2022/dla-2968");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2018-25032");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/stretch/zlib");
...
var pkgs = [
    {'release': '9.0', 'prefix': 'lib32z1', 'reference': '1:1.2.8.dfsg-5+deb9u1'},
    {'release': '9.0', 'prefix': 'lib32z1-dev', 'reference': '1:1.2.8.dfsg-5+deb9u1'},
    {'release': '9.0', 'prefix': 'lib64z1', 'reference': '1:1.2.8.dfsg-5+deb9u1'},
    {'release': '9.0', 'prefix': 'lib64z1-dev', 'reference': '1:1.2.8.dfsg-5+deb9u1'},
    {'release': '9.0', 'prefix': 'zlib1g', 'reference': '1:1.2.8.dfsg-5+deb9u1'},
    {'release': '9.0', 'prefix': 'zlib1g-dbg', 'reference': '1:1.2.8.dfsg-5+deb9u1'},
    {'release': '9.0', 'prefix': 'zlib1g-dev', 'reference': '1:1.2.8.dfsg-5+deb9u1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'lib32z1 / lib32z1-dev / lib64z1 / lib64z1-dev / zlib1g / zlib1g-dbg / etc');
}
