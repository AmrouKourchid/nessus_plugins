...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : vim (EulerOS-SA-2019-2462)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2462
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c69e6c65");
...
pkgs = ["vim-X11-7.4.160-2.h7",
        "vim-common-7.4.160-2.h7",
        "vim-enhanced-7.4.160-2.h7",
        "vim-filesystem-7.4.160-2.h7",
        "vim-minimal-7.4.160-2.h7"];
