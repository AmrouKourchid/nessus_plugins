...
# extracted from Fedora Security Advisory FEDORA-2024-20393c122f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-20393c122f");

  script_name(english:"Fedora 40 : podman (2024-20393c122f)");
...
FEDORA-2024-20393c122f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-20393c122f");
...
var pkgs = [
    {'reference':'podman-5.0.3-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'epoch':'5'}
];
