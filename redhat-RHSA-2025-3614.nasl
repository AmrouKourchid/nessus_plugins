...
# extracted from Red Hat Security Advisory RHSA-2025:3614. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:3614");

  script_name(english:"RHEL 9 : libxslt (RHSA-2025:3614)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_3614.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3abf82ef");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:3614");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libxslt-1.1.34-11.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libxslt-devel-1.1.34-11.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
