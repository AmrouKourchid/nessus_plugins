...
# extracted from Fedora Security Advisory FEDORA-2024-04cb0f92bc
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-04cb0f92bc");

  script_name(english:"Fedora 40 : dotnet8.0 (2024-04cb0f92bc)");
...
FEDORA-2024-04cb0f92bc advisory.
    ...
    - Runtime: https://github.com/dotnet/core/blob/main/release-notes/8.0/8.0.7/8.0.7.md

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-04cb0f92bc");
...
var pkgs = [
    {'reference':'dotnet8.0-8.0.107-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
