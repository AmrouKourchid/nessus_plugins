...
# extracted from Fedora Security Advisory FEDORA-2025-6f77f6c77a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-6f77f6c77a");

  script_name(english:"Fedora 40 : cutter-re / rizin (2025-6f77f6c77a)");
...
FEDORA-2025-6f77f6c77a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-6f77f6c77a");
...
var pkgs = [
    {'reference':'cutter-re-2.3.4-6.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rizin-0.7.4-5.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
