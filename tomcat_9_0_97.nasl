...
if (description)
{
  ...
  script_name(english:"Apache Tomcat 9.0.96 < 9.0.97");

  script_set_attribute(attribute:"synopsis", value:
"The remote Apache Tomcat server is affected by a vulnerability");
  script_set_attribute(attribute:"description", value:
"The version of Tomcat installed on the remote host is prior to 9.0.97. It is, therefore, affected by a vulnerability as
referenced in the fixed_in_apache_tomcat_9.0.97_security-9 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c1d91431");
  # https://tomcat.apache.org/security-9.html#Fixed_in_Apache_Tomcat_9.0.97
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?70ca6efe");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Apache Tomcat version 9.0.97 or later.");
...
var constraints = [
  { 'equal' : '9.0.96', 'fixed_display' : '9.0.97' }
];
