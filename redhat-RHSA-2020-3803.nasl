...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_3803.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?37659217");
...
"Update the RHEL bash package based on the guidance in RHSA-2020:3803.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'bash-4.2.46-30.el7_4', 'sp':'4', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bash-4.2.46-30.el7_4', 'sp':'4', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bash-doc-4.2.46-30.el7_4', 'sp':'4', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bash-doc-4.2.46-30.el7_4', 'sp':'4', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
