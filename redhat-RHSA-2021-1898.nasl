...
# extracted from Red Hat Security Advisory RHSA-2021:1898. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:1898");

  script_name(english:"RHEL 8 : python-lxml (RHSA-2021:1898)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_1898.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?33d18aff");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/8.4_release_notes/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?862005a9");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:1898");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1901633");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-lxml package based on the guidance in RHSA-2021:1898.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-lxml-4.2.3-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
