...
if (description)
{
  ...
  script_name(english:"Adobe Photoshop 24.x < 24.7.4 / 25.x < 25.11 Vulnerability (macOS APSB24-49)");

  script_set_attribute(attribute:"synopsis", value:
"Adobe Photoshop installed on remote macOS or Mac OS X host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Photoshop installed on the remote macOS or Mac OS X host is prior to 24.7.4/25.11. It is,
therefore, affected by a vulnerability as referenced in the apsb24-49 advisory.
