...
# extracted from Fedora Security Advisory FEDORA-2022-6ec78b2586
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-6ec78b2586");

  script_name(english:"Fedora 36 : device-mapper-multipath (2022-6ec78b2586)");
...
FEDORA-2022-6ec78b2586 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-6ec78b2586");
...
"Update the affected device-mapper-multipath package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:device-mapper-multipath");
...
var pkgs = [
    {'reference':'device-mapper-multipath-0.8.7-9.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
