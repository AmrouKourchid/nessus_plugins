...
# extracted from Fedora Security Advisory FEDORA-2022-dc6dc2cfd3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-dc6dc2cfd3");

  script_name(english:"Fedora 37 : python-twisted (2022-dc6dc2cfd3)");
...
FEDORA-2022-dc6dc2cfd3 advisory.
    ...
    ```
    * Thu Jun 23 2022 Robert-Andr Mauchin <zebob.m@gmail.com> 22.4.0-1
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-dc6dc2cfd3");
...
var pkgs = [
    {'reference':'python-twisted-22.4.0-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
