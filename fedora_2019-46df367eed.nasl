...
# extracted from Fedora Security Advisory FEDORA-2019-46df367eed.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : gnutls (2019-46df367eed)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-46df367eed");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"gnutls-3.6.5-3.fc28")) flag++;
