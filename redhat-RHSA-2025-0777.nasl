...
# extracted from Red Hat Security Advisory RHSA-2025:0777. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:0777");

  script_name(english:"RHEL 8 / 9 : Red Hat Ansible Automation Platform 2.5 Product Security and Bug Fix Update (Important) (RHSA-2025:0777)");
...
referenced in the RHSA-2025:0777 advisory.
    ...
    * automation-controller: Jinja has a sandbox breakout through indirect reference to format method
    (CVE-2024-56326)
    * automation-controller: Jinja has a sandbox breakout through malicious filenames (CVE-2024-56201)
    * automation-controller: Django: potential denial-of-service vulnerability in IPv6 validation
    (CVE-2024-56374)
    ...
    * python3.11-jinja2: Jinja has a sandbox breakout through indirect reference to format method
    (CVE-2024-56326)
    ...
    * Fixed an issue where the order of source inventories was not respected by the ansible.controller
    collection (AAP-38524)
    * Fixed an issue where an actively running job on an execution node may have had its folder deleted by a
    system task (AAP-38137)
    ...
    * Users are now able to create a new Event-Driven Ansible credential by copying an existing one
    (AAP-39249)
    ...
    * Fixed an issue where activations were not properly updated in some scenarios with a high load of the
    system (AAP-38374)
    ...
    * Fixed an issue where setting automationedacontroller_max_running_activations could cause the installer
    to fail (AAP-38708)
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_0777.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e13296cf");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:0777");
...
"Update the affected automation-controller-venv-tower, python3.11-django and / or python3.11-jinja2 packages.");
  ...
  script_cwe_id(150, 693, 770, 1169);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3.11-jinja2-3.1.5-1.el8ap', 'release':'8', 'el_string':'el8ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.5', 'cves':['CVE-2024-56201', 'CVE-2024-56326']}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'automation-controller-venv-tower-4.6.7-1.el8ap', 'release':'8', 'el_string':'el8ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.5', 'cves':['CVE-2024-56201', 'CVE-2024-56326', 'CVE-2024-56374']},
      {'reference':'python3.11-django-4.2.18-1.el8ap', 'release':'8', 'el_string':'el8ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.5', 'cves':['CVE-2024-53907', 'CVE-2024-56374']}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'python3.11-jinja2-3.1.5-1.el9ap', 'release':'9', 'el_string':'el9ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.5', 'cves':['CVE-2024-56201', 'CVE-2024-56326']}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'automation-controller-venv-tower-4.6.7-1.el9ap', 'release':'9', 'el_string':'el9ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.5', 'cves':['CVE-2024-56201', 'CVE-2024-56326', 'CVE-2024-56374']},
      {'reference':'python3.11-django-4.2.18-1.el9ap', 'release':'9', 'el_string':'el9ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.5', 'cves':['CVE-2024-53907', 'CVE-2024-56374']}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'automation-controller-venv-tower / python3.11-django / etc');
}
