...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS : strongSwan vulnerability (USN-5250-1)");
...
in the USN-5250-1 advisory.

    Zhuowei Zhang discovered that stringSwan incorrectly handled EAP authentication. A remote attacker could
    use this issue to cause strongSwan to crash, resulting in a denial of service, or possibly bypass client
