...
# extracted from Debian Security Advisory dla-3318. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3318 : haproxy - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3318
advisory.

    -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3318-1                debian-lts@lists.debian.org
    https://www.debian.org/lts/security/                      Markus Koschany
    February 14, 2023                             https://wiki.debian.org/LTS
    -------------------------------------------------------------------------
    ...
    A security vulnerability was discovered in HAProxy, a fast and reliable
    load balancing reverse proxy, which may result in denial of service, or
    bypass of access controls and routing rules via specially crafted requests.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/haproxy");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'haproxy', 'reference': '1.8.19-1+deb10u4'},
    {'release': '10.0', 'prefix': 'haproxy-doc', 'reference': '1.8.19-1+deb10u4'},
    {'release': '10.0', 'prefix': 'vim-haproxy', 'reference': '1.8.19-1+deb10u4'}
];
