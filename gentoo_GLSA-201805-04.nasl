...
# extracted from Gentoo Linux Security Advisory GLSA 201805-04.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201805-04");

  script_name(english:"GLSA-201805-04 : rsync: Arbitrary command execution");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-201805-04
(rsync: Arbitrary command execution)

    A vulnerability was discovered in rsync&rsquo;s parse_arguments function in
      options.c.
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/201805-04");
...
"All rsync users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-5764");
...
if (qpkg_check(package:"net-misc/rsync", unaffected:make_list("ge 3.1.3"), vulnerable:make_list("lt 3.1.3"))) flag++;
