...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : unbound (EulerOS-SA-2024-2078)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2078
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?49c3643d");
...
var pkgs = [
  "unbound-1.6.6-1.h7.eulerosv2r7",
  "unbound-libs-1.6.6-1.h7.eulerosv2r7"
];
