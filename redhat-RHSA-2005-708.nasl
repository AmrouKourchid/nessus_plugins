...
"The remote Red Hat host is missing a security update for gpdf.");
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2005/rhsa-2005_708.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2db26537");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=163920");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2005:708");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL gpdf package based on the guidance in RHSA-2005:708.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gpdf-2.8.2-4.4', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gpdf-2.8.2-4.4', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gpdf-2.8.2-4.4', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gpdf-2.8.2-4.4', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gpdf-2.8.2-4.4', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
