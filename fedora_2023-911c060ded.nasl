...
# extracted from Fedora Security Advisory FEDORA-2023-911c060ded
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-911c060ded");

  script_name(english:"Fedora 38 : chromium (2023-911c060ded)");
...
FEDORA-2023-911c060ded advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-911c060ded");
...
var pkgs = [
    {'reference':'chromium-112.0.5615.165-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
