...
# extracted from Oracle Linux Security Advisory ELSA-2023-5790.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : python-reportlab (ELSA-2023-5790)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-5790.html");
...
var pkgs = [
    {'reference':'python3-reportlab-3.4.0-8.el8_8.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-reportlab-3.4.0-8.el8_8.1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
