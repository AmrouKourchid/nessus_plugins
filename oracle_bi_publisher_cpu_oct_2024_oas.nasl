...
if (description)
{
  ...
  script_name(english:"Oracle Business Intelligence Publisher 6.4 / 7.0 (OAS) (October 2024 CPU)");
...
a vulnerability as referenced in the October 2024 CPU advisory.
  ...
  - Vulnerability in the Oracle BI Publisher product of Oracle Analytics (component: Development Operations 
    (Apache CXF)). Supported versions that are affected are 7.0.0.0.0 and 7.6.0.0.0. Easily exploitable 
    ...
    access to critical data or complete access to all Oracle BI Publisher accessible data. (CVE-2024-29736)
...
var constraints = [
  ...
  {'min_version': '12.2.7.0.0', 'fixed_version': '12.2.7.0.241001', 'patch': '37124134', 'bundle': '37151095'},
  {'min_version': '12.2.7.6.0', 'fixed_version': '12.2.7.6.241001', 'patch': '37123210', 'bundle': '37151071'},
];
