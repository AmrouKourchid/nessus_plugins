...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.1.0 : rsync (EulerOS-SA-2019-1460)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1460
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?83d7d6f0");
...
pkgs = ["rsync-3.1.2-4.h2.eulerosv2r7"];
