...
"The remote Red Hat host is missing a security update for xdg-user-dirs.");
...
the RHSA-2018:0842 advisory.

    xdg-user-dirs is a tool to create and configure default desktop user directories such as the Music and the
    Desktop directories.

    Security Fix(es):

    * xdg-user-dirs, gnome-session: Xsession creation of XDG user directories does not honor system umask
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_0842.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5a6b58d9");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:0842");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1412762");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1455094");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL xdg-user-dirs package based on the guidance in RHSA-2018:0842.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'xdg-user-dirs-0.15-5.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
