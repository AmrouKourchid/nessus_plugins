...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : python3 (EulerOS-SA-2025-1042)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1042
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2821c9dd");
...
var pkgs = [
  "python3-3.7.4-7.h54.eulerosv2r9",
  "python3-unversioned-command-3.7.4-7.h54.eulerosv2r9"
];
