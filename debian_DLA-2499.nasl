...
# extracted from Debian Security Advisory DLA-2499-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2499-1 : sympa security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2020/12/msg00026.html");
...
flag = 0;
if (deb_check(release:"9.0", prefix:"sympa", reference:"6.2.16~dfsg-3+deb9u5")) flag++;
