...
# extracted from Debian Security Advisory dla-3147. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3147 : php-twig - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3147
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/twig");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/twig");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'php-twig', 'reference': '2.6.2-2+deb10u1'},
    {'release': '10.0', 'prefix': 'php-twig-doc', 'reference': '2.6.2-2+deb10u1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'php-twig / php-twig-doc');
}
