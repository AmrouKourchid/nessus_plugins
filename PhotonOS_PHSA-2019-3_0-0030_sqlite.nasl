...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Sqlite PHSA-2019-3.0-0030");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'sqlite-3.27.2-4.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'sqlite-debuginfo-3.27.2-4.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'sqlite-devel-3.27.2-4.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'sqlite-libs-3.27.2-4.ph3')) flag++;
