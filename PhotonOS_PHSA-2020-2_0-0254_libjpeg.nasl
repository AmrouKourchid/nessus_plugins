...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Libjpeg PHSA-2020-2.0-0254");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libjpeg-turbo-2.0.0-3.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libjpeg-turbo-devel-2.0.0-3.ph2')) flag++;
