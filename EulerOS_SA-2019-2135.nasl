...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : cups (EulerOS-SA-2019-2135)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2135
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?76d67d30");
...
"Update the affected cups package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-18248");
...
pkgs = ["cups-1.6.3-35.h4.eulerosv2r7",
        "cups-client-1.6.3-35.h4.eulerosv2r7",
        "cups-devel-1.6.3-35.h4.eulerosv2r7",
        "cups-filesystem-1.6.3-35.h4.eulerosv2r7",
        "cups-libs-1.6.3-35.h4.eulerosv2r7",
        "cups-lpd-1.6.3-35.h4.eulerosv2r7"];
