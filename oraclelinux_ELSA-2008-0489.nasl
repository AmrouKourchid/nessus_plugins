...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2008-0489.html");
...
"Update the affected gnutls, gnutls-devel and / or gnutls-utils packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2008-1948");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2008-1950");
...
var pkgs = [
    {'reference':'gnutls-1.4.1-3.el5_1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'gnutls-devel-1.4.1-3.el5_1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'gnutls-utils-1.4.1-3.el5_1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'gnutls-1.4.1-3.el5_1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'gnutls-devel-1.4.1-3.el5_1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'gnutls-utils-1.4.1-3.el5_1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
