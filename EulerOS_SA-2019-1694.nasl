...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.2.0 : util-linux (EulerOS-SA-2019-1694)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1694
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?202dbfdf");
...
pkgs = ["libblkid-2.23.2-52.1.h5",
        "libmount-2.23.2-52.1.h5",
        "libuuid-2.23.2-52.1.h5",
        "util-linux-2.23.2-52.1.h5"];
