...
# extracted from Fedora Security Advisory FEDORA-2023-698b47d488
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-698b47d488");

  script_name(english:"Fedora 37 : podman (2023-698b47d488)");
...
FEDORA-2023-698b47d488 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-698b47d488");
...
var pkgs = [
    {'reference':'podman-4.4.1-3.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'5'}
];
