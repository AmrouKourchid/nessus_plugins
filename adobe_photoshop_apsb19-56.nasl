...
if (description)
{
  ...
  script_name(english:"Adobe Photoshop CC 20.x < 20.0.8 / 21.x < 21.0.2 Multiple Vulnerabilities (APSB19-56)");

  script_set_attribute(attribute:"synopsis", value:
"Adobe Photoshop installed on remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Photoshop CC or Photoshop installed on the remote Windows host is prior to 20.0.8/21.0.2. It is,
therefore, affected by multiple vulnerabilities as referenced in the apsb19-56 advisory.
