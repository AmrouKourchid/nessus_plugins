...
# extracted from Red Hat Security Advisory RHSA-2020:1126. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2018-14355");
  script_xref(name:"RHSA", value:"2020:1126");

  script_name(english:"RHEL 7 : mutt (RHSA-2020:1126)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for mutt.");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_1126.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f391744d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:1126");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1602081");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL mutt package based on the guidance in RHSA-2020:1126.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:L/I:N/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-14355");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'mutt-1.5.21-29.el7', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'5'},
      {'reference':'mutt-1.5.21-29.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'5'},
      {'reference':'mutt-1.5.21-29.el7', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'5'},
      {'reference':'mutt-1.5.21-29.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'5'}
    ]
  }
];
