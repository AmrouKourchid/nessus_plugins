...
# extracted from Gentoo Linux Security Advisory GLSA 202009-04.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202009-04");

  script_name(english:"GLSA-202009-04 : Qt GUI: Buffer overflow");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202009-04
(Qt GUI: Buffer overflow)

    It was discovered that Qt GUI&rsquo;s XBM parser did not properly handle X
      BitMap files.
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202009-04");
...
if (qpkg_check(package:"dev-qt/qtgui", unaffected:make_list("ge 5.14.2-r1"), vulnerable:make_list("lt 5.14.2-r1"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "Qt GUI");
}
