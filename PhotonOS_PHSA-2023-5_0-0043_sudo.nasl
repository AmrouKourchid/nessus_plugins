...
# extracted from VMware Security Advisory PHSA-2023-5.0-0043. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2023-22809", "CVE-2023-27320");
  script_xref(name:"IAVA", value:"2023-A-0121-S");

  script_name(english:"Photon OS 5.0: Sudo PHSA-2023-5.0-0043");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the sudo package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-5.0-43.md");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'sudo-1.9.13p3-1.ph5')) flag++;
