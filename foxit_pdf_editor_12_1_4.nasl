...
if (description)
{
  ...
  script_name(english:"Foxit PDF Editor < 12.1.4 Multiple Vulnerabilities");
...
Windows host is prior to 12.1.4. It is, therefore affected by multiple vulnerabilities:
...
"Upgrade to Foxit PDF Editor version 12.1.4 or later");
...
var constraints = [
  { 'max_version' : '10.1.12.37872', 'fixed_version' : '12.1.4' },
  { 'min_version' : '11.0', 'max_version' : '11.2.7.53812', 'fixed_version' : '12.1.4' },
  { 'min_version' : '12.0', 'max_version' : '12.1.3.15356', 'fixed_version' : '12.1.4' }
];
