...
# extracted from Gentoo Linux Security Advisory GLSA 202310-23.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202310-23 : libxslt: Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202310-23 (libxslt: Multiple Vulnerabilities)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202310-23");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=820722");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=833508");
...
var packages = [
  {
    ...
    'unaffected' : make_list("ge 1.1.35"),
    'vulnerable' : make_list("lt 1.1.35")
  }
];
