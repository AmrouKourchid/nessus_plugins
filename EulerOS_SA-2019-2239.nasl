...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : python-urllib3 (EulerOS-SA-2019-2239)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the python-urllib3 package installed,
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2239
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?056cfb07");
