...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2012/rhsa-2012_0050.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b4082bee");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2012:0050");
  ...
  script_set_attribute(attribute:"see_also", value:"https://rhn.redhat.com/errata/RHBA-2012-0013.html");
  script_set_attribute(attribute:"see_also", value:"https://rhn.redhat.com/errata/RHSA-2011-1849.html");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'qemu-img-0.12.1.2-2.209.el6_2.4', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_2', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'qemu-kvm-0.12.1.2-2.209.el6_2.4', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_2', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'qemu-kvm-tools-0.12.1.2-2.209.el6_2.4', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_2', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
    ]
  }
];
