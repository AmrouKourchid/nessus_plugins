...
# Red Hat Security Advisory RHSA-2020:4654. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : python27:2.7 (CESA-2020:4654)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
CESA-2020:4654 advisory.
...
var appstreams = {
    'python27:2.7': [
      ...
      {'reference':'python2-2.7.17-2.module_el8.3.0+478+7570e00c', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python2-2.7.17-2.module_el8.3.0+478+7570e00c', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python2-debug-2.7.17-2.module_el8.3.0+478+7570e00c', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python2-debug-2.7.17-2.module_el8.3.0+478+7570e00c', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python2-devel-2.7.17-2.module_el8.3.0+478+7570e00c', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python2-devel-2.7.17-2.module_el8.3.0+478+7570e00c', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python2-libs-2.7.17-2.module_el8.3.0+478+7570e00c', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python2-libs-2.7.17-2.module_el8.3.0+478+7570e00c', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python2-pip-9.0.3-18.module_el8.3.0+478+7570e00c', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python2-pip-9.0.3-18.module_el8.3.0+478+7570e00c', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python2-pip-wheel-9.0.3-18.module_el8.3.0+478+7570e00c', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python2-pip-wheel-9.0.3-18.module_el8.3.0+478+7570e00c', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python2-setuptools-39.0.1-12.module_el8.3.0+478+7570e00c', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python2-setuptools-39.0.1-12.module_el8.3.0+478+7570e00c', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python2-setuptools-wheel-39.0.1-12.module_el8.3.0+478+7570e00c', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python2-setuptools-wheel-39.0.1-12.module_el8.3.0+478+7570e00c', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python2-test-2.7.17-2.module_el8.3.0+478+7570e00c', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python2-test-2.7.17-2.module_el8.3.0+478+7570e00c', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python2-tkinter-2.7.17-2.module_el8.3.0+478+7570e00c', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python2-tkinter-2.7.17-2.module_el8.3.0+478+7570e00c', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python2-tools-2.7.17-2.module_el8.3.0+478+7570e00c', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python2-tools-2.7.17-2.module_el8.3.0+478+7570e00c', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
