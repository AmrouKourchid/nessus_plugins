...
if (description)
{
  ...
  script_cve_id("CVE-2021-35516");
  script_xref(name:"IAVA", value:"2024-A-0412");

  script_name(english:"Atlassian Confluence < 7.19.25 / 8.5.x < 8.5.12 / 8.9.x < 8.9.4 (CONFSERVER-96101)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://jira.atlassian.com/browse/CONFSERVER-96101");
...
"Upgrade to Atlassian Confluence version 7.19.25, 8.5.12, 8.9.4 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-35516");
