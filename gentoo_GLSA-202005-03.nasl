...
# extracted from Gentoo Linux Security Advisory GLSA 202005-03.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202005-03");
  script_xref(name:"IAVA", value:"2020-A-0190-S");

  script_name(english:"GLSA-202005-03 : Mozilla Thunderbird: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202005-03
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202005-03");
...
if (qpkg_check(package:"mail-client/thunderbird", unaffected:make_list("ge 68.8.0"), vulnerable:make_list("lt 68.8.0"))) flag++;
if (qpkg_check(package:"mail-client/thunderbird-bin", unaffected:make_list("ge 68.8.0"), vulnerable:make_list("lt 68.8.0"))) flag++;
