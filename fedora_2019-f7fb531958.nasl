...
# extracted from Fedora Security Advisory FEDORA-2019-f7fb531958.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-f7fb531958");

  script_name(english:"Fedora 30 : libreswan (2019-f7fb531958)");
...
Updated to 3.28 (many imported bugfixes)

Note that Tenable Network Security has extracted the preceding
description block directly from the Fedora update system website.
Tenable has attempted to automatically clean and format it as much as
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-f7fb531958");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"libreswan-3.29-1.fc30")) flag++;
