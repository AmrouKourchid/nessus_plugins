...
# extracted from Fedora Security Advisory FEDORA-2023-1f851fa869
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-1f851fa869");

  script_name(english:"Fedora 37 : slurm (2023-1f851fa869)");
...
FEDORA-2023-1f851fa869 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-1f851fa869");
...
var pkgs = [
    {'reference':'slurm-22.05.10-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
