...
# extracted from Red Hat Security Advisory RHSA-2023:7873. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:7873");

  script_name(english:"RHEL 9 : gstreamer1-plugins-bad-free (RHSA-2023:7873)");
...
referenced in the RHSA-2023:7873 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_7873.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3d669113");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2250247");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2250249");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:7873");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL gstreamer1-plugins-bad-free package based on the guidance in RHSA-2023:7873.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gstreamer1-plugins-bad-free-1.18.4-6.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gstreamer1-plugins-bad-free-devel-1.18.4-6.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
