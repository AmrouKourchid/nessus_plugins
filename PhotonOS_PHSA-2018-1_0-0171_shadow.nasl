...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Shadow PHSA-2018-1.0-0171");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the shadow package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-1.0-171.md");
...
if (rpm_check(release:"PhotonOS-1.0", reference:"shadow-4.2.1-13.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"shadow-debuginfo-4.2.1-13.ph1")) flag++;
