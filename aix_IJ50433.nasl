...
if (description)
{
  ...
  script_name(english:"AIX (IJ50433)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AIX host is missing a security patch.");
  script_set_attribute(attribute:"description", value:
"The version of AIX installed on the remote host is prior to APAR IJ50433. It is, therefore, affected by a vulnerability
as referenced in the IJ50433 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/apar/IJ50433");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/node/7148150");
  script_set_attribute(attribute:"solution", value:
"Please apply the appropriate interim fix per APAR IJ50433.");
...
var constraints = [
    {'release': '7.3', 'ml': '00', 'sp': '02', 'patch': 'IJ50433s4a', 'package': 'bos.net.tcp.sendmail', 'minfilesetver': '7.3.0.0', 'maxfilesetver': '7.3.0.0'},
    {'release': '7.3', 'ml': '00', 'sp': '03', 'patch': 'IJ50433s4a', 'package': 'bos.net.tcp.sendmail', 'minfilesetver': '7.3.0.0', 'maxfilesetver': '7.3.0.0'},
    {'release': '7.3', 'ml': '00', 'sp': '04', 'patch': 'IJ50433s4a', 'package': 'bos.net.tcp.sendmail', 'minfilesetver': '7.3.0.0', 'maxfilesetver': '7.3.0.0'}
];
