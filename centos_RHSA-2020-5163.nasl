...
# extracted from Red Hat Security Advisory RHSA-2020:5163.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : thunderbird (RHSA-2020:5163)");
...
var pkgs = [
    {'reference':'thunderbird-78.4.3-1.el7_9', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'thunderbird-78.4.3-1.el7_9', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
