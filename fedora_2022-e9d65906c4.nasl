...
# extracted from Fedora Security Advisory FEDORA-2022-e9d65906c4
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-e9d65906c4");

  script_name(english:"Fedora 37 : curl (2022-e9d65906c4)");
...
FEDORA-2022-e9d65906c4 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-e9d65906c4");
...
var pkgs = [
    {'reference':'curl-7.85.0-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
