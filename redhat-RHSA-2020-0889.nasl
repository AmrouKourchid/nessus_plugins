...
# extracted from Red Hat Security Advisory RHSA-2020:0889. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:0889");

  script_name(english:"RHEL 7 : slirp4netns (RHSA-2020:0889)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for slirp4netns.");
...
referenced in the RHSA-2020:0889 advisory.

    The slirp4netns package contains user-mode networking for unprivileged network namespaces. It is required
    to enable networking for rootless containers.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_0889.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9fdc9a1d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:0889");
...
"Update the RHEL slirp4netns package based on the guidance in RHSA-2020:0889.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'slirp4netns-0.3.0-8.el7_7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'slirp4netns-0.3.0-8.el7_7', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'slirp4netns-0.3.0-8.el7_7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
