...
if (description)
{
  ...
  script_name(english:"Google Chrome < 116.0.5845.140 Vulnerability");

  script_set_attribute(attribute:"synopsis", value:
"A web browser installed on the remote Windows host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Google Chrome installed on the remote Windows host is prior to 116.0.5845.140. It is, therefore, affected
by a vulnerability as referenced in the 2023_08_stable-channel-update-for-desktop_29 advisory.

  - Use after free in MediaStream. (CVE-2023-4572)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://chromereleases.googleblog.com/2023/08/stable-channel-update-for-desktop_29.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?acaae7c8");
  script_set_attribute(attribute:"see_also", value:"https://crbug.com/1472492");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Google Chrome version 116.0.5845.140 or later.");
...
google_chrome_check_version(installs:installs, fix:'116.0.5845.140', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
