...
# extracted from Debian Security Advisory dla-3768. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2021-23437", "CVE-2022-22817", "CVE-2023-44271");

  script_name(english:"Debian dla-3768 : python-pil - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2021-23437");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'python-pil', 'reference': '5.4.1-2+deb10u5'},
    {'release': '10.0', 'prefix': 'python-pil-dbg', 'reference': '5.4.1-2+deb10u5'},
    {'release': '10.0', 'prefix': 'python-pil-doc', 'reference': '5.4.1-2+deb10u5'},
    {'release': '10.0', 'prefix': 'python-pil.imagetk', 'reference': '5.4.1-2+deb10u5'},
    {'release': '10.0', 'prefix': 'python-pil.imagetk-dbg', 'reference': '5.4.1-2+deb10u5'},
    {'release': '10.0', 'prefix': 'python3-pil', 'reference': '5.4.1-2+deb10u5'},
    {'release': '10.0', 'prefix': 'python3-pil-dbg', 'reference': '5.4.1-2+deb10u5'},
    {'release': '10.0', 'prefix': 'python3-pil.imagetk', 'reference': '5.4.1-2+deb10u5'},
    {'release': '10.0', 'prefix': 'python3-pil.imagetk-dbg', 'reference': '5.4.1-2+deb10u5'}
];
