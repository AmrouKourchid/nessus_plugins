...
# extracted from Fedora Security Advisory FEDORA-2024-56fbd2cbfa
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-56fbd2cbfa");

  script_name(english:"Fedora 39 : cpp-jwt (2024-56fbd2cbfa)");
...
FEDORA-2024-56fbd2cbfa advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-56fbd2cbfa");
...
var pkgs = [
    {'reference':'cpp-jwt-1.4-7.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
