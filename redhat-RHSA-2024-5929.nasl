...
# extracted from Red Hat Security Advisory RHSA-2024:5929. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:5929");

  script_name(english:"RHEL 9 : postgresql:16 (RHSA-2024:5929)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for postgresql:16.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:5929 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_5929.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3a65ea95");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:5929");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL postgresql:16 package based on the guidance in RHSA-2024:5929.");
  ...
  'postgresql:16': [
    {
      ...
      'pkgs': [
        {'reference':'pg_repack-1.4.8-1.module+el9.4.0+20427+07482b8c', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'pgaudit-16.0-1.module+el9.4.0+20427+07482b8c', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgres-decoderbufs-2.4.0-1.Final.module+el9.4.0+20427+07482b8c', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-16.4-1.module+el9.4.0+22207+8466e31f', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-contrib-16.4-1.module+el9.4.0+22207+8466e31f', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-docs-16.4-1.module+el9.4.0+22207+8466e31f', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plperl-16.4-1.module+el9.4.0+22207+8466e31f', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plpython3-16.4-1.module+el9.4.0+22207+8466e31f', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-pltcl-16.4-1.module+el9.4.0+22207+8466e31f', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-private-devel-16.4-1.module+el9.4.0+22207+8466e31f', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-private-libs-16.4-1.module+el9.4.0+22207+8466e31f', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-16.4-1.module+el9.4.0+22207+8466e31f', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-devel-16.4-1.module+el9.4.0+22207+8466e31f', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-static-16.4-1.module+el9.4.0+22207+8466e31f', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-16.4-1.module+el9.4.0+22207+8466e31f', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-rpm-macros-16.4-1.module+el9.4.0+22207+8466e31f', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-upgrade-16.4-1.module+el9.4.0+22207+8466e31f', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-upgrade-devel-16.4-1.module+el9.4.0+22207+8466e31f', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
      ]
    },
    {
      'repo_relative_urls': [
      ...
      'pkgs': [
        {'reference':'pg_repack-1.4.8-1.module+el9.4.0+20427+07482b8c', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'postgresql-16.4-1.module+el9.4.0+22207+8466e31f', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-contrib-16.4-1.module+el9.4.0+22207+8466e31f', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-docs-16.4-1.module+el9.4.0+22207+8466e31f', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plperl-16.4-1.module+el9.4.0+22207+8466e31f', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plpython3-16.4-1.module+el9.4.0+22207+8466e31f', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-pltcl-16.4-1.module+el9.4.0+22207+8466e31f', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-private-devel-16.4-1.module+el9.4.0+22207+8466e31f', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-private-libs-16.4-1.module+el9.4.0+22207+8466e31f', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-16.4-1.module+el9.4.0+22207+8466e31f', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-devel-16.4-1.module+el9.4.0+22207+8466e31f', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-static-16.4-1.module+el9.4.0+22207+8466e31f', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-16.4-1.module+el9.4.0+22207+8466e31f', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-rpm-macros-16.4-1.module+el9.4.0+22207+8466e31f', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-upgrade-16.4-1.module+el9.4.0+22207+8466e31f', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-upgrade-devel-16.4-1.module+el9.4.0+22207+8466e31f', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
