...
# extracted from Fedora Security Advisory FEDORA-2024-0c6db96fc3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-0c6db96fc3");

  script_name(english:"Fedora 41 : flatpak (2024-0c6db96fc3)");
...
FEDORA-2024-0c6db96fc3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-0c6db96fc3");
...
var pkgs = [
    {'reference':'flatpak-1.15.10-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
