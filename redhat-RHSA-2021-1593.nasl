...
# extracted from Red Hat Security Advisory RHSA-2021:1593. The text
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_1593.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ef0f8986");
...
"Update the RHEL krb5 package based on the guidance in RHSA-2021:1593.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'krb5-devel-1.18.2-8.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'krb5-libs-1.18.2-8.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'krb5-pkinit-1.18.2-8.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'krb5-server-1.18.2-8.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'krb5-server-ldap-1.18.2-8.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'krb5-workstation-1.18.2-8.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libkadm5-1.18.2-8.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
