...
# extracted from Fedora Security Advisory FEDORA-2023-7b5205184d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-7b5205184d");

  script_name(english:"Fedora 38 : mingw-freetype (2023-7b5205184d)");
...
FEDORA-2023-7b5205184d advisory.

    Backport fix for CVE-2023-2004.

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-7b5205184d");
  script_set_attribute(attribute:"solution", value:
"Update the affected mingw-freetype package.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:S/C:N/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:L/UI:N/S:U/C:N/I:L/A:L");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:mingw-freetype");
...
var pkgs = [
    {'reference':'mingw-freetype-2.12.1-4.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'mingw-freetype');
}
