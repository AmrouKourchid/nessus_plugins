...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.6.0 : trousers (EulerOS-SA-2021-1563)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization for ARM 64 host is missing multiple security
updates.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the trousers packages installed, the
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1563
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a0c90150");
...
"Update the affected trousers packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:trousers-lib");
...
pkgs = ["trousers-0.3.13-11.h3.eulerosv2r8",
        "trousers-lib-0.3.13-11.h3.eulerosv2r8"];
