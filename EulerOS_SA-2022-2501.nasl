...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : glibc (EulerOS-SA-2022-2501)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2501
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3f53d110");
...
var pkgs = [
  "glibc-2.17-222.h52.eulerosv2r7",
  "glibc-common-2.17-222.h52.eulerosv2r7",
  "glibc-devel-2.17-222.h52.eulerosv2r7",
  "glibc-headers-2.17-222.h52.eulerosv2r7",
  "glibc-static-2.17-222.h52.eulerosv2r7",
  "glibc-utils-2.17-222.h52.eulerosv2r7",
  "nscd-2.17-222.h52.eulerosv2r7"
];
