...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8492.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?10bf9943");
...
"Update the RHEL python39:3.9 package based on the guidance in RHSA-2022:8492.");
...
os_ver = os_ver[1];
if (!rhel_check_release_list(operator: 'ge', os_version: os_ver, rhel_versions: ['8','8.4','8.6'])) audit(AUDIT_OS_NOT, 'Red Hat 8.x / 8.x / 8.x', 'Red Hat ' + os_ver);
