...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : python on SL6.x i386/x86_64 (20190613)");
...
"Security Fix(es) :
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1906&L=SCIENTIFIC-LINUX-ERRATA&P=723
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e5724800");
...
flag = 0;
if (rpm_check(release:"SL6", reference:"python-2.6.6-68.el6_10")) flag++;
if (rpm_check(release:"SL6", reference:"python-debuginfo-2.6.6-68.el6_10")) flag++;
if (rpm_check(release:"SL6", reference:"python-devel-2.6.6-68.el6_10")) flag++;
if (rpm_check(release:"SL6", reference:"python-libs-2.6.6-68.el6_10")) flag++;
if (rpm_check(release:"SL6", reference:"python-test-2.6.6-68.el6_10")) flag++;
if (rpm_check(release:"SL6", reference:"python-tools-2.6.6-68.el6_10")) flag++;
if (rpm_check(release:"SL6", reference:"tkinter-2.6.6-68.el6_10")) flag++;
