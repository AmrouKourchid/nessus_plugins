...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Wpa_Supplicant PHSA-2019-3.0-0017");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'wpa_supplicant-2.7-3.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'wpa_supplicant-debuginfo-2.7-3.ph3')) flag++;
