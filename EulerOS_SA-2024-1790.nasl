...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : libuv (EulerOS-SA-2024-1790)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1790
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?93a39c6c");
...
var pkgs = [
  "libuv-1.42.0-1.h4.eulerosv2r11"
];
