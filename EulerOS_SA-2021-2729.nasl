...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.1 : edk2 (EulerOS-SA-2021-2729)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2729
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6f623bcb");
...
"Update the affected edk2 packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-28216");
...
var pkgs = [
  "edk2-aarch64-201903-2.9.1.2.46"
];
