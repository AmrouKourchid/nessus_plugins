...
# extracted from Fedora Security Advisory FEDORA-2025-e2287efebb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-e2287efebb");
  script_xref(name:"IAVB", value:"2025-B-0062");

  script_name(english:"Fedora 41 : ImageMagick (2025-e2287efebb)");
...
FEDORA-2025-e2287efebb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-e2287efebb");
...
var pkgs = [
    {'reference':'ImageMagick-7.1.1.47-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
