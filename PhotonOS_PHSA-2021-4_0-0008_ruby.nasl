...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Ruby PHSA-2021-4.0-0008");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-1655");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'ruby-2.7.3-1.ph4')) flag++;
