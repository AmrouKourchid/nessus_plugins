...
# extracted from Fedora Security Advisory FEDORA-2024-123f2b3666
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-123f2b3666");

  script_name(english:"Fedora 39 : cyrus-imapd (2024-123f2b3666)");
...
FEDORA-2024-123f2b3666 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-123f2b3666");
...
var pkgs = [
    {'reference':'cyrus-imapd-3.8.3-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
