...
# extracted from openSUSE Security Update openSUSE-2019-2282.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : jasper (openSUSE-2019-2282)");
...
Security issues fixed :
  ...
  - CVE-2018-19540: Fixed a heap based overflow in
    jas_icctxtdesc_input (bsc#1117508).

  - CVE-2018-19541: Fix heap based overread in
    jas_image_depalettize (bsc#1117507).

This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1117507");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1117508");
...
if ( rpm_check(release:"SUSE15.1", reference:"jasper-2.0.14-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"jasper-debuginfo-2.0.14-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"jasper-debugsource-2.0.14-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libjasper-devel-2.0.14-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libjasper4-2.0.14-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libjasper4-debuginfo-2.0.14-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libjasper4-32bit-2.0.14-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libjasper4-32bit-debuginfo-2.0.14-lp151.4.3.1") ) flag++;
