...
# extracted from Ubuntu Security Notice USN-5198-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5198-1");

  script_name(english:"Ubuntu 20.04 LTS : HTMLDOC vulnerability (USN-5198-1)");
...
USN-5198-1 advisory.
    ...
    It was discovered that HTMLDOC improperly handled malformed URIs from an input html file.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5198-1");
...
"Update the affected htmldoc and / or htmldoc-common packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-23180");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'htmldoc', 'pkgver': '1.9.7-1ubuntu0.2'},
    {'osver': '20.04', 'pkgname': 'htmldoc-common', 'pkgver': '1.9.7-1ubuntu0.2'}
];
