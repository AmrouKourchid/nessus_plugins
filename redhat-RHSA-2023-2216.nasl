...
# extracted from Red Hat Security Advisory RHSA-2023:2216. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:2216");

  script_name(english:"RHEL 9 : gdk-pixbuf2 (RHSA-2023:2216)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for gdk-pixbuf2.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2023:2216 advisory.

    The gdk-pixbuf2 packages provide an image loading library that can be extended by loadable modules for new
    image formats. It is used by toolkits such as GTK+ or clutter.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_2216.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8895c27d");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/9/html/9.2_release_notes/index
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ecefa061");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2043722");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2114940");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:2216");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL gdk-pixbuf2 package based on the guidance in RHSA-2023:2216.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gdk-pixbuf2-2.42.6-3.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gdk-pixbuf2-devel-2.42.6-3.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gdk-pixbuf2-modules-2.42.6-3.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
