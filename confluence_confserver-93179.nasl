...
if (description)
{
  ...
  script_cve_id("CVE-2022-41704");
  script_xref(name:"IAVA", value:"2024-A-0175-S");

  script_name(english:"Atlassian Confluence 7.13.x / 7.19.x < 7.19.16 (CONFSERVER-93179)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://jira.atlassian.com/browse/CONFSERVER-93179");
...
"Upgrade to Atlassian Confluence version 7.19.16 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-41704");
