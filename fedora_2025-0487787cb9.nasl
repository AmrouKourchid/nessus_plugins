...
# extracted from Fedora Security Advisory FEDORA-2025-0487787cb9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-0487787cb9");

  script_name(english:"Fedora 40 : dotnet9.0 (2025-0487787cb9)");
...
FEDORA-2025-0487787cb9 advisory.

    This is the January 2025 security and bugfix release for .NET 9.0. It updates the SDK to version 9.0.102
    and Runtime to version 9.0.1.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-0487787cb9");
...
var pkgs = [
    {'reference':'dotnet9.0-9.0.102-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
