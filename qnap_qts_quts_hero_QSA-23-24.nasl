...
if (description)
{
  ...
  script_name(english:"QNAP QTS / QuTS hero Command Injection (QSA-23-24)");
...
QSA-23-24 advisory.
  ...
  - An OS command injection vulnerability has been reported to affect several QNAP operating system versions.
    If exploited, the vulnerability could allow authenticated administrators to execute commands via a
    network. We have already fixed the vulnerability in the following versions: QTS 5.0.1.2376 build 20230421
    and later QuTS hero h5.0.1.2376 build 20230421 and later QuTScloud c5.1.0.2498 and later (CVE-2023-23367)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.qnap.com/en/security-advisory/QSA-23-24");
  script_set_attribute(attribute:"solution", value:
"Apply the solution referenced in the QSA-23-24 advisory");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:M/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:H/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-23367");
...
var constraints = [
  { 'min_version' : '5.0', 'max_version' : '5.0.1', 'product' : 'QTS', 'fixed_display' : 'QTS 5.0.1.2376 build 20230421', 'Number' : '2376', 'Build' : '20230421' },
  { 'min_version' : '5.0', 'max_version' : '5.0.1', 'product' : 'QuTS hero', 'fixed_display' : 'QuTS hero h5.0.1.2376 build 20230421', 'Number' : '2376', 'Build' : '20230421' }
];
