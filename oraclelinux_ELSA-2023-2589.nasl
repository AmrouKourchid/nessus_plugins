...
# extracted from Oracle Linux Security Advisory ELSA-2023-2589.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : autotrace (ELSA-2023-2589)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-2589.html");
  script_set_attribute(attribute:"solution", value:
"Update the affected autotrace package.");
...
var pkgs = [
    {'reference':'autotrace-0.31.1-65.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'autotrace-0.31.1-65.el9', 'cpu':'i686', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'autotrace-0.31.1-65.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
