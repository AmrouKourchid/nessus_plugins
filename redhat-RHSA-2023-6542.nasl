...
# extracted from Red Hat Security Advisory RHSA-2023:6542. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:6542");

  script_name(english:"RHEL 9 : perl-HTTP-Tiny (RHSA-2023:6542)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6542.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?74f33a0c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2228392");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6542");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL perl-HTTP-Tiny package based on the guidance in RHSA-2023:6542.");
