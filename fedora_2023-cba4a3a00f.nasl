...
# extracted from Fedora Security Advisory FEDORA-2023-cba4a3a00f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-cba4a3a00f");
  script_xref(name:"IAVB", value:"2023-B-0070-S");

  script_name(english:"Fedora 38 : ghostscript (2023-cba4a3a00f)");
...
FEDORA-2023-cba4a3a00f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-cba4a3a00f");
...
var pkgs = [
    {'reference':'ghostscript-10.01.2-3.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
