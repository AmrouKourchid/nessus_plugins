...
# extracted from Fedora Security Advisory FEDORA-2020-74b71e5873.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-74b71e5873");

  script_name(english:"Fedora 31 : pure-ftpd (2020-74b71e5873)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-74b71e5873");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"pure-ftpd-1.0.49-3.fc31")) flag++;
