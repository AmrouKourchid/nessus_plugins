...
# AlmaLinux Security Advisory ALSA-2024:4050.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:4050");
  script_xref(name:"IAVA", value:"2024-A-0255");

  script_name(english:"AlmaLinux 9 : libreswan (ALSA-2024:4050)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2024-4050.html");
