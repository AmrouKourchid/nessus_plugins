...
# extracted from Fedora Security Advisory FEDORA-2024-73644489ec
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-73644489ec");

  script_name(english:"Fedora 38 : python-idna (2024-73644489ec)");
...
FEDORA-2024-73644489ec advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-73644489ec");
  script_set_attribute(attribute:"solution", value:
"Update the affected python-idna package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:python-idna");
...
var pkgs = [
    {'reference':'python-idna-3.7-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
