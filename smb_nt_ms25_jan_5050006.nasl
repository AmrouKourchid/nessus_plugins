...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5050006");
  script_xref(name:"MSKB", value:"5050049");
  script_xref(name:"MSFT", value:"MS25-5050006");
  script_xref(name:"MSFT", value:"MS25-5050049");
  script_xref(name:"IAVA", value:"2025-A-0034-S");
  script_xref(name:"IAVA", value:"2025-A-0033-S");

  script_name(english:"KB5050006: Windows Server 2008 R2 Security Update (January 2025)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5050006");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5050049");
...
if (("windows server 2008 r2" >< tolower(os_name)) &&
  smb_check_rollup(os:'6.1',
                   ...
                   rollup_date:'01_2025',
                   bulletin:bulletin,
                   rollup_kb_list:[5050049, 5050006])
)
{
