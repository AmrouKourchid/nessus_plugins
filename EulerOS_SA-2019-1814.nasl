...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : sqlite (EulerOS-SA-2019-1814)");
...
vulnerability :
  ...
  - SQLite3 from 3.6.0 to and including 3.27.2 is
    vulnerable to heap out-of-bound read in the rtreenode()
    function when handling invalid rtree
    tables.(CVE-2019-8457)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1814
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f157eed0");
...
pkgs = ["sqlite-3.24.0-2.h3.eulerosv2r8",
        "sqlite-devel-3.24.0-2.h3.eulerosv2r8",
        "sqlite-doc-3.24.0-2.h3.eulerosv2r8",
        "sqlite-libs-3.24.0-2.h3.eulerosv2r8"];
