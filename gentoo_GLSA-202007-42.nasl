...
# extracted from Gentoo Linux Security Advisory GLSA 202007-42.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202007-42");

  script_name(english:"GLSA-202007-42 : LHa: Buffer overflow");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202007-42
(LHa: Buffer overflow)

    A buffer overflow in LHa&rsquo;s compression code was discovered which can
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202007-42");
...
"All LHa users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-1925");
...
if (qpkg_check(package:"app-arch/lha", unaffected:make_list("ge 114i_p20201004"), vulnerable:make_list("lt 114i_p20201004"))) flag++;
