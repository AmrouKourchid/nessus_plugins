...
# extracted from Debian Security Advisory dsa-5289. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-5289-1 : chromium - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has packages installed that are affected by a vulnerability as referenced in the dsa-5289
advisory.

    Multiple security issues were discovered in Chromium, which could result in the execution of arbitrary
    code. For the stable distribution (bullseye), this problem has been fixed in version
    107.0.5304.121-1~deb11u1. We recommend that you upgrade your chromium packages. For the detailed security
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2022/dsa-5289");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-4135");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'chromium', 'reference': '107.0.5304.121-1~deb11u1'},
    {'release': '11.0', 'prefix': 'chromium-common', 'reference': '107.0.5304.121-1~deb11u1'},
    {'release': '11.0', 'prefix': 'chromium-driver', 'reference': '107.0.5304.121-1~deb11u1'},
    {'release': '11.0', 'prefix': 'chromium-l10n', 'reference': '107.0.5304.121-1~deb11u1'},
    {'release': '11.0', 'prefix': 'chromium-sandbox', 'reference': '107.0.5304.121-1~deb11u1'},
    {'release': '11.0', 'prefix': 'chromium-shell', 'reference': '107.0.5304.121-1~deb11u1'}
];
