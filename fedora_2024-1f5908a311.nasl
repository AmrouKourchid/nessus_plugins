...
# extracted from Fedora Security Advisory FEDORA-2024-1f5908a311
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-1f5908a311");

  script_name(english:"Fedora 39 : rust-routinator (2024-1f5908a311)");
...
FEDORA-2024-1f5908a311 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-1f5908a311");
...
var pkgs = [
    {'reference':'rust-routinator-0.13.2-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
