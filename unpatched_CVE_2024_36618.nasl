...
if (description)
{
  ...
  script_cve_id("CVE-2024-36618");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-36618");
...
patch available.
  ...
  - FFmpeg n6.1.1 has a vulnerability in the AVI demuxer of the libavformat library which allows for an
    integer overflow, potentially resulting in a denial-of-service (DoS) condition. (CVE-2024-36618)
