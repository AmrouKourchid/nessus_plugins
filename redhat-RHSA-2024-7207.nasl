...
# extracted from Red Hat Security Advisory RHSA-2024:7207. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:7207");

  script_name(english:"RHEL 9 : osbuild-composer (RHSA-2024:7207)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_7207.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?881cfee6");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:7207");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL osbuild-composer package based on the guidance in RHSA-2024:7207.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'osbuild-composer-76-3.el9_2.2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'osbuild-composer-core-76-3.el9_2.2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'osbuild-composer-dnf-json-76-3.el9_2.2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'osbuild-composer-worker-76-3.el9_2.2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
