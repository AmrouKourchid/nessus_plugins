...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : libtasn1 (EulerOS-SA-2023-1362)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1362
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?261fe4d0");
...
var pkgs = [
  "libtasn1-4.16.0-1.h2.eulerosv2r10"
];
