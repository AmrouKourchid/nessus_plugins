...
# extracted from Fedora Security Advisory FEDORA-2023-2bd5892754
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-2bd5892754");
  script_xref(name:"IAVA", value:"2023-A-0654-S");

  script_name(english:"Fedora 39 : firefox (2023-2bd5892754)");
...
FEDORA-2023-2bd5892754 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-2bd5892754");
...
var pkgs = [
    {'reference':'firefox-120.0-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
