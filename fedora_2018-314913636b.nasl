...
# extracted from Fedora Security Advisory FEDORA-2018-314913636b.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-314913636b");

  script_name(english:"Fedora 29 : origin (2018-314913636b)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"- Rebase to upstream
    8de5c3442e56dbe05403990ce0821746673fd588, let's call it
    3.11.1
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-314913636b");
  script_set_attribute(attribute:"solution", value:
"Update the affected origin package.");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"origin-3.11.1-1.fc29")) flag++;
