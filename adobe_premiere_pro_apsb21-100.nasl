...
if (description)
{
  ...
  script_name(english:"Adobe Premiere Pro < 15.4.2 Multiple Vulnerabilities (APSB21-100)");

  script_set_attribute(attribute:"synopsis", value:
"The Adobe Premiere Pro instance installed on the remote host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Premiere Pro installed on the remote Windows host is prior to 15.4.2. It is, therefore, affected by
