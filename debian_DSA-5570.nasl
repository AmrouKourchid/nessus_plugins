...
# extracted from Debian Security Advisory dsa-5570. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-5570-1 : nghttp2 - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 / 12 host has packages installed that are affected by a vulnerability as referenced in the dsa-5570
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bullseye/nghttp2");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'libnghttp2-14', 'reference': '1.43.0-1+deb11u1'},
    {'release': '11.0', 'prefix': 'libnghttp2-dev', 'reference': '1.43.0-1+deb11u1'},
    {'release': '11.0', 'prefix': 'libnghttp2-doc', 'reference': '1.43.0-1+deb11u1'},
    {'release': '11.0', 'prefix': 'nghttp2', 'reference': '1.43.0-1+deb11u1'},
    {'release': '11.0', 'prefix': 'nghttp2-client', 'reference': '1.43.0-1+deb11u1'},
    {'release': '11.0', 'prefix': 'nghttp2-proxy', 'reference': '1.43.0-1+deb11u1'},
    {'release': '11.0', 'prefix': 'nghttp2-server', 'reference': '1.43.0-1+deb11u1'},
    {'release': '12.0', 'prefix': 'nghttp2', 'reference': '1.52.0-1+deb12u1'}
];
