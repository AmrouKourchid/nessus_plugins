...
# extracted from Debian Security Advisory DLA-1904-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1904-1 : libextractor security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"jianglin found an issue in libextractor, a library that extracts
meta-data from files of arbitrary type.
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2019/08/msg00038.html");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"extract", reference:"1:1.3-2+deb8u5")) flag++;
if (deb_check(release:"8.0", prefix:"libextractor-dbg", reference:"1:1.3-2+deb8u5")) flag++;
if (deb_check(release:"8.0", prefix:"libextractor-dev", reference:"1:1.3-2+deb8u5")) flag++;
if (deb_check(release:"8.0", prefix:"libextractor3", reference:"1:1.3-2+deb8u5")) flag++;
