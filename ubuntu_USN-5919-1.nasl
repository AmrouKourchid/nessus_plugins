...
# extracted from Ubuntu Security Notice USN-5919-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5919-1");

  script_name(english:"Ubuntu 16.04 ESM : Linux kernel vulnerabilities (USN-5919-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5919-1");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-5919-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2022-3521', 'CVE-2022-3545', 'CVE-2022-3628', 'CVE-2022-3640', 'CVE-2022-3646', 'CVE-2022-3649', 'CVE-2022-4378', 'CVE-2022-42328', 'CVE-2022-42329', 'CVE-2022-42895', 'CVE-2022-43750', 'CVE-2023-0461');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-5919-1');
  }
  else
  {
