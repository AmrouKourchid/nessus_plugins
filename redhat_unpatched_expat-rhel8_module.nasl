...
# extracted from Red Hat Security Advisory expat. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2022-25313", "CVE-2023-52426");

  script_name(english:"RHEL 8 : expat (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  # https://security.access.redhat.com/data/csaf/v2/vex/2024/cve-2024-45490.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?db3c884a");
