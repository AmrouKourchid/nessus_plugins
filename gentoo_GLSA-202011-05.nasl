...
# extracted from Gentoo Linux Security Advisory GLSA 202011-05.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202011-05");

  script_name(english:"GLSA-202011-05 : libssh: Denial of service");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202011-05
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202011-05");
...
if (qpkg_check(package:"net-libs/libssh", unaffected:make_list("ge 0.9.5"), vulnerable:make_list("lt 0.9.5"))) flag++;
