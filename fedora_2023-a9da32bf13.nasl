...
# extracted from Fedora Security Advisory FEDORA-2023-a9da32bf13
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-a9da32bf13");

  script_name(english:"Fedora 37 : golang (2023-a9da32bf13)");
...
FEDORA-2023-a9da32bf13 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-a9da32bf13");
...
var pkgs = [
    {'reference':'golang-1.19.13-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
