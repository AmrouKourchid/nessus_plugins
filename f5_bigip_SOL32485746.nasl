...
vulnerability as referenced in the K32485746 advisory.
    ...
    and packet.c.(CVE-2016-10708)ImpactThis vulnerability allows a remote attacker to disrupt service.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K32485746");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K32485746.");
...
var vmatrix = {
  'AFM': {
    'affected': [
      '14.0.0-14.0.1','13.1.0-13.1.3','12.1.0-12.1.5','11.2.1-11.6.5'
    ],
    'unaffected': [
      '14.1.0'
    ],
