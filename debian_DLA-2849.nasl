...
# extracted from Debian Security Advisory dla-2849. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2849-1 : wireshark - LTS security update");
...
dla-2849 advisory.
    ...
    Several vulnerabilities were fixed in the network traffic analyzer Wireshark. CVE-2021-22207 Excessive
    memory consumption in the MS-WSP dissector. CVE-2021-22235 Crash in the DNP dissector. CVE-2021-39921 NULL
    pointer exception in the Modbus dissector. CVE-2021-39922 Buffer overflow in the C12.22 dissector.
    CVE-2021-39923 Large loop in the PNRP dissector. CVE-2021-39924 Large loop in the Bluetooth DHT dissector.
    CVE-2021-39925 Buffer overflow in the Bluetooth SDP dissector. CVE-2021-39928 NULL pointer exception in
    the IEEE 802.11 dissector. CVE-2021-39929 Uncontrolled Recursion in the Bluetooth DHT dissector. For
    Debian 9 stretch, these problems have been fixed in version 2.6.20-0+deb9u2. We recommend that you upgrade
    your wireshark packages. For the detailed security status of wireshark please refer to its security
    tracker page at: https://security-tracker.debian.org/tracker/wireshark Further information about Debian
    LTS security advisories, how to apply these updates to your system and frequently asked questions can be
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=987853");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/wireshark");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2021/dla-2849");
...
var pkgs = [
    {'release': '9.0', 'prefix': 'libwireshark-data', 'reference': '2.6.20-0+deb9u2'},
    {'release': '9.0', 'prefix': 'libwireshark-dev', 'reference': '2.6.20-0+deb9u2'},
    {'release': '9.0', 'prefix': 'libwireshark11', 'reference': '2.6.20-0+deb9u2'},
    {'release': '9.0', 'prefix': 'libwireshark8', 'reference': '2.6.20-0+deb9u2'},
    {'release': '9.0', 'prefix': 'libwiretap-dev', 'reference': '2.6.20-0+deb9u2'},
    {'release': '9.0', 'prefix': 'libwiretap6', 'reference': '2.6.20-0+deb9u2'},
    {'release': '9.0', 'prefix': 'libwiretap8', 'reference': '2.6.20-0+deb9u2'},
    {'release': '9.0', 'prefix': 'libwscodecs1', 'reference': '2.6.20-0+deb9u2'},
    {'release': '9.0', 'prefix': 'libwscodecs2', 'reference': '2.6.20-0+deb9u2'},
    {'release': '9.0', 'prefix': 'libwsutil-dev', 'reference': '2.6.20-0+deb9u2'},
    {'release': '9.0', 'prefix': 'libwsutil7', 'reference': '2.6.20-0+deb9u2'},
    {'release': '9.0', 'prefix': 'libwsutil9', 'reference': '2.6.20-0+deb9u2'},
    {'release': '9.0', 'prefix': 'tshark', 'reference': '2.6.20-0+deb9u2'},
    {'release': '9.0', 'prefix': 'wireshark', 'reference': '2.6.20-0+deb9u2'},
    {'release': '9.0', 'prefix': 'wireshark-common', 'reference': '2.6.20-0+deb9u2'},
    {'release': '9.0', 'prefix': 'wireshark-dev', 'reference': '2.6.20-0+deb9u2'},
    {'release': '9.0', 'prefix': 'wireshark-doc', 'reference': '2.6.20-0+deb9u2'},
    {'release': '9.0', 'prefix': 'wireshark-gtk', 'reference': '2.6.20-0+deb9u2'},
    {'release': '9.0', 'prefix': 'wireshark-qt', 'reference': '2.6.20-0+deb9u2'}
];
