...
# extracted from Fedora Security Advisory FEDORA-2024-f781c993fe
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-f781c993fe");

  script_name(english:"Fedora 38 : chromium (2024-f781c993fe)");
...
FEDORA-2024-f781c993fe advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-f781c993fe");
...
var pkgs = [
    {'reference':'chromium-122.0.6261.111-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
