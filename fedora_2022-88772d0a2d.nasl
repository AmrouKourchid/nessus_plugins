...
# extracted from Fedora Security Advisory FEDORA-2022-88772d0a2d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-88772d0a2d");

  script_name(english:"Fedora 37 : libtar (2022-88772d0a2d)");
...
FEDORA-2022-88772d0a2d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-88772d0a2d");
...
"Update the affected libtar package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:libtar");
...
var pkgs = [
    {'reference':'libtar-1.2.20-26.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
