...
# extracted from SUSE update advisory SUSE-SU-2020:0260-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES15 Security Update : rmt-server (SUSE-SU-2020:0260-1)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a47cea34");
...
flag = 0;
if (rpm_check(release:"SLES15", sp:"0", reference:"rmt-server-2.5.2-3.26.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", reference:"rmt-server-config-2.5.2-3.26.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", reference:"rmt-server-debuginfo-2.5.2-3.26.1")) flag++;
