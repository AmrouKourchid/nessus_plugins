...
# extracted from Fedora Security Advisory FEDORA-2020-bd170e803f.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-bd170e803f");

  script_name(english:"Fedora 30 : webkit2gtk3 (2020-bd170e803f)");
...
"Update to 2.28.2 :
  ...
  - Fix playing of Youtube &lsquo;live stream&rsquo;/H264
    URLs.
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-bd170e803f");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"webkit2gtk3-2.28.2-1.fc30")) flag++;
