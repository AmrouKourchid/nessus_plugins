...
# extracted from Fedora Security Advisory FEDORA-2025-ebdcfc0f27
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-ebdcfc0f27");

  script_name(english:"Fedora 40 : mysql8.0 (2025-ebdcfc0f27)");
...
FEDORA-2025-ebdcfc0f27 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-ebdcfc0f27");
...
var pkgs = [
    {'reference':'mysql8.0-8.0.41-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
