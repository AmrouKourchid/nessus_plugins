...
"It is, therefore, affected by multiple vulnerabilities as referenced in the ALAS2023-2023-429 advisory.
    ...
    2023-12-06: CVE-2023-46728 was added to this advisory.
    ...
    This problem allows a remote client to perform Denial of Service when sending ftp:// URLs in HTTP Request
    messages or constructing ftp:// URLs from FTP Native input.

    This issue is triggered during access control security checks, meaning clients may not have been permitted
    to use the proxy yet.

    FTP support is always enabled and cannot be disabled completely. (CVE-2023-46848)
