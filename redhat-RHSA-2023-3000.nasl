...
# extracted from Red Hat Security Advisory RHSA-2023:3000. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:3000");

  script_name(english:"RHEL 8 : dhcp (RHSA-2023:3000)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for dhcp.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2023:3000 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_3000.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?39a77678");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/8.8_release_notes/index
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cfe2de5f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2132001");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2132002");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:3000");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL dhcp package based on the guidance in RHSA-2023:3000.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'dhcp-client-4.3.6-49.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'12'},
      {'reference':'dhcp-common-4.3.6-49.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'12'},
      {'reference':'dhcp-libs-4.3.6-49.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'12'},
      {'reference':'dhcp-relay-4.3.6-49.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'12'},
      {'reference':'dhcp-server-4.3.6-49.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'12'}
    ]
  }
];
