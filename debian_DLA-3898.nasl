...
# extracted from Debian Security Advisory dla-3898. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3898 : libnghttp2-14 - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has packages installed that are affected by a vulnerability as referenced in the dla-3898
advisory.
...
var pkgs = [
    {'release': '11.0', 'prefix': 'libnghttp2-14', 'reference': '1.43.0-1+deb11u2'},
    {'release': '11.0', 'prefix': 'libnghttp2-dev', 'reference': '1.43.0-1+deb11u2'},
    {'release': '11.0', 'prefix': 'libnghttp2-doc', 'reference': '1.43.0-1+deb11u2'},
    {'release': '11.0', 'prefix': 'nghttp2', 'reference': '1.43.0-1+deb11u2'},
    {'release': '11.0', 'prefix': 'nghttp2-client', 'reference': '1.43.0-1+deb11u2'},
    {'release': '11.0', 'prefix': 'nghttp2-proxy', 'reference': '1.43.0-1+deb11u2'},
    {'release': '11.0', 'prefix': 'nghttp2-server', 'reference': '1.43.0-1+deb11u2'}
];
