...
# extracted from Red Hat Security Advisory RHSA-2023:4494. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:4494");
  script_xref(name:"IAVA", value:"2023-A-0379-S");

  script_name(english:"RHEL 9 : thunderbird (RHSA-2023:4494)");
...
referenced in the RHSA-2023:4494 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_4494.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1bb471b0");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:4494");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL thunderbird package based on the guidance in RHSA-2023:4494.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'thunderbird-102.14.0-1.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
