...
if (description)
{
  ...
  script_bugtraq_id(66743);

  script_name(english:"EulerOS Virtualization 3.0.2.2 : cifs-utils (EulerOS-SA-2020-1495)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1495
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?77220062");
...
pkgs = ["cifs-utils-6.2-10.h1.eulerosv2r7"];
