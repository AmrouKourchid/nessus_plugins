...
# AlmaLinux Security Advisory ALSA-2020:4465.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2020:4465");

  script_name(english:"AlmaLinux 8 : binutils (ALSA-2020:4465)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2020-4465.html");
