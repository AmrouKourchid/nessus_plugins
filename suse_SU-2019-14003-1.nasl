...
# extracted from SUSE update advisory SUSE-SU-2019:14003-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES11 Security Update : sqlite3 (SUSE-SU-2019:14003-1)");
...
without introducing additional issues.");
  ...
  # https://www.suse.com/support/update/announcement/2019/suse-su-201914003-1.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d6452aba");
...
SUSE Studio Onsite 1.3:zypper in -t patch slestso13-sqlite3-14003=1

SUSE Linux Enterprise Software Development Kit 11-SP4:zypper in -t
patch sdksp4-sqlite3-14003=1

SUSE Linux Enterprise Server 11-SP4:zypper in -t patch
slessp4-sqlite3-14003=1

SUSE Linux Enterprise Point of Sale 11-SP3:zypper in -t patch
sleposp3-sqlite3-14003=1

SUSE Linux Enterprise Debuginfo 11-SP4:zypper in -t patch
dbgsp4-sqlite3-14003=1");
...
flag = 0;
if (rpm_check(release:"SLES11", sp:"4", cpu:"x86_64", reference:"libsqlite3-0-32bit-3.7.6.3-1.4.7.3.1")) flag++;
if (rpm_check(release:"SLES11", sp:"4", cpu:"s390x", reference:"libsqlite3-0-32bit-3.7.6.3-1.4.7.3.1")) flag++;
if (rpm_check(release:"SLES11", sp:"4", reference:"libsqlite3-0-3.7.6.3-1.4.7.3.1")) flag++;
if (rpm_check(release:"SLES11", sp:"4", reference:"sqlite3-3.7.6.3-1.4.7.3.1")) flag++;
