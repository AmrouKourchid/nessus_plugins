...
# extracted from Red Hat Security Advisory RHSA-2023:6539. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:6539");

  script_name(english:"RHEL 9 : perl-CPAN (RHSA-2023:6539)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6539.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?815f2ca6");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2218667");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6539");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL perl-CPAN package based on the guidance in RHSA-2023:6539.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'perl-CPAN-2.29-3.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
