...
# extracted from Red Hat Security Advisory RHSA-2023:6077. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:6077");
  script_xref(name:"CEA-ID", value:"CEA-2024-0004");

  script_name(english:"RHEL 9 : toolbox (RHSA-2023:6077)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for toolbox.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2023:6077 advisory.

    The rhel9/toolbox container image can be used with Toolbox to obtain RHEL based containerized command line
    environments to aid with development and software testing. Toolbox is built on top of Podman and other
    standard container technologies from OCI.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6077.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?424cb609");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6077");
  ...
  script_set_attribute(attribute:"see_also", value:"https://catalog.redhat.com/software/containers/search");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL toolbox package based on the guidance in RHSA-2023:6077.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'toolbox-0.0.99.3-10.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'toolbox-tests-0.0.99.3-10.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'toolbox-0.0.99.3-10.el9_2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'toolbox-tests-0.0.99.3-10.el9_2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
