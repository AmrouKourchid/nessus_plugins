...
# extracted from Red Hat Security Advisory RHSA-2024:6360. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:6360");

  script_name(english:"RHEL 9 : libtiff (RHSA-2024:6360)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_6360.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a2bf3953");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2302996");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:6360");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libtiff package based on the guidance in RHSA-2024:6360.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libtiff-4.4.0-8.el9_2.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libtiff-devel-4.4.0-8.el9_2.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libtiff-tools-4.4.0-8.el9_2.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
