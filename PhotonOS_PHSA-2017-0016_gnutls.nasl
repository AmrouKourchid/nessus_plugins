...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Gnutls PHSA-2017-0016");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'gnutls-3.4.11-4.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'gnutls-debuginfo-3.4.11-4.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'gnutls-devel-3.4.11-4.ph1')) flag++;
