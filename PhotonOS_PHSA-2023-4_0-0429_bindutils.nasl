...
if (description)
{
  ...
  script_cve_id("CVE-2023-2829");

  script_name(english:"Photon OS 4.0: Bindutils PHSA-2023-4.0-0429");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-2829");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'bindutils-9.16.42-1.ph4')) flag++;
