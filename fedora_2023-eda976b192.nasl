...
# extracted from Fedora Security Advisory FEDORA-2023-eda976b192
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-eda976b192");

  script_name(english:"Fedora 36 : dcmtk (2023-eda976b192)");
...
FEDORA-2023-eda976b192 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-eda976b192");
...
var pkgs = [
    {'reference':'dcmtk-3.6.7-3.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
