...
# extracted from Fedora Security Advisory FEDORA-2022-7936d4cf83
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-7936d4cf83");

  script_name(english:"Fedora 38 : pypy3.9 (2022-7936d4cf83)");
...
FEDORA-2022-7936d4cf83 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-7936d4cf83");
...
var pkgs = [
    {'reference':'pypy3.9-7.3.9-4.3.9.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
