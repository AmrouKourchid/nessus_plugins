...
# extracted from Red Hat Security Advisory RHSA-2019:4317. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:4317");
  script_xref(name:"CEA-ID", value:"CEA-2021-0025");
  script_xref(name:"CEA-ID", value:"CEA-2021-0004");

  script_name(english:"RHEL 7 : rh-maven35-apache-commons-beanutils (RHSA-2019:4317)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for rh-maven35-apache-commons-beanutils.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2019:4317 advisory.

    The rh-maven35-apache-commons-beanutils package provides Java utility methods for accessing and modifying
    properties of arbitrary JavaBeans.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_4317.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f9986b93");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:4317");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rh-maven35-apache-commons-beanutils package based on the guidance in RHSA-2019:4317.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rh-maven35-apache-commons-beanutils");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rh-maven35-apache-commons-beanutils-javadoc");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-maven35-apache-commons-beanutils-1.9.3-2.3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-maven35-apache-commons-beanutils-javadoc-1.9.3-2.3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'rh-maven35-apache-commons-beanutils / etc');
}
