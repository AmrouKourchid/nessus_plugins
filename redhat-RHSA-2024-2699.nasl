...
# extracted from Red Hat Security Advisory RHSA-2024:2699. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2699");

  script_name(english:"RHEL 8 : git-lfs (RHSA-2024:2699)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b96d8a44");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2699");
...
"Update the RHEL git-lfs package based on the guidance in RHSA-2024:2699.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'git-lfs-3.2.0-3.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
