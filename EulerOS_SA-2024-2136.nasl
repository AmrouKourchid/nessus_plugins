...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : expat (EulerOS-SA-2024-2136)");
...
Tenable has extracted the preceding description block directly from the EulerOS Virtualization expat security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2136
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3c5a5f0f");
...
var pkgs = [
  "expat-2.2.9-2.h10.eulerosv2r10"
];
