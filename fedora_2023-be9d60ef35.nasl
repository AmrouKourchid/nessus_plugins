...
# extracted from Fedora Security Advisory FEDORA-2023-be9d60ef35
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-be9d60ef35");

  script_name(english:"Fedora 37 : roundcubemail (2023-be9d60ef35)");
...
FEDORA-2023-be9d60ef35 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-be9d60ef35");
...
var pkgs = [
    {'reference':'roundcubemail-1.6.3-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
