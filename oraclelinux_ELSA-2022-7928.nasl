...
# extracted from Oracle Linux Security Advisory ELSA-2022-7928.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : device-mapper-multipath (ELSA-2022-7928)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
ELSA-2022-7928 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2022-7928.html");
...
var pkgs = [
    ...
    {'reference':'kpartx-0.8.4-28.el8_7.1', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
