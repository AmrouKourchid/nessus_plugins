...
# extracted from Fedora Security Advisory FEDORA-2022-1d9133bc8e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-1d9133bc8e");

  script_name(english:"Fedora 35 : jhead (2022-1d9133bc8e)");
...
FEDORA-2022-1d9133bc8e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-1d9133bc8e");
...
var pkgs = [
    {'reference':'jhead-3.06.0.1-5.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
