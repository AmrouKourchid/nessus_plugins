...
"The version of mod_http2 installed on the remote host is prior to 1.15.14-2. It is, therefore, affected by multiple
vulnerabilities as referenced in the ALAS2-2020-1493 advisory.
...
var pkgs = [
    {'reference':'mod_http2-1.15.14-2.amzn2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'mod_http2-1.15.14-2.amzn2', 'cpu':'i686', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'mod_http2-1.15.14-2.amzn2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'mod_http2-debuginfo-1.15.14-2.amzn2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'mod_http2-debuginfo-1.15.14-2.amzn2', 'cpu':'i686', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'mod_http2-debuginfo-1.15.14-2.amzn2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
