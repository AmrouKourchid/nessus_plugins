...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : OpenEXR (EulerOS-SA-2021-2514)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2514
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?58a939f9");
...
var pkgs = [
  "OpenEXR-libs-1.7.1-7.h4.eulerosv2r7"
];
