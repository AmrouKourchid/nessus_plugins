...
# SUSE update advisory SUSE-SU-2022:14882-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:14882-1");

  script_name(english:"SUSE SLES11 Security Update : clamav (SUSE-SU-2022:14882-1)");
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-January/010086.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c6b4cef1");
...
var pkgs = [
    {'reference':'clamav-openssl1-0.103.5-0.20.44.1', 'sp':'0', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.3-0']},
    {'reference':'clamav-0.103.5-0.20.44.1', 'sp':'4', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.4']}
];
