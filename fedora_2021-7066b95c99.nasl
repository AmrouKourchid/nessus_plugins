...
# extracted from Fedora Security Advisory FEDORA-2021-7066b95c99
#
...
if (description)
{
  ...
  script_name(english:"Fedora 33 : sddm (2021-7066b95c99)");
...
FEDORA-2021-7066b95c99 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-7066b95c99");
...
"Update the affected sddm package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:sddm");
...
pkgs = [
    {'reference':'sddm-0.19.0-3.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
