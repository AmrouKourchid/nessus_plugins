...
if (description)
{
  ...
  script_name(english:"Wireshark SEoL (0.0.x <= x <= 1.0.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Wireshark is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Wireshark is between 0.0.x and 1.0.x. It is, therefore, no longer maintained by its vendor or
provider.
...
var constraints = [
  { max_branch : '1.0', min_branch : '0.0', seol : 20100930 }
];
