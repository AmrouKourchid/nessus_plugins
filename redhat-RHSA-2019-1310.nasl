...
referenced in the RHSA-2019:1310 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_1310.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?badbf1ff");
...
"Update the RHEL thunderbird package based on the guidance in RHSA-2019:1310.");
  ...
  script_cwe_id(120, 400, 416, 567, 829);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'thunderbird-60.7.0-1.el6_10', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'thunderbird-60.7.0-1.el6_10', 'cpu':'ppc64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'thunderbird-60.7.0-1.el6_10', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'thunderbird-60.7.0-1.el6_10', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
