...
if (description)
{
  ...
  script_name(english:"Adobe Illustrator < 28.7.6 / 29.0 < 29.4 Arbitrary code execution (APSB25-43)");
...
"The version of Adobe Illustrator installed on the remote Windows host is prior to 28.7.6, 29.4. It is, therefore,
affected by a vulnerability as referenced in the APSB25-43 advisory.
