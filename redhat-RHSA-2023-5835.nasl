...
# extracted from Red Hat Security Advisory RHSA-2023:5835. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : rhc-worker-script (RHSA-2023:5835)");
...
referenced in the RHSA-2023:5835 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_5835.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d9d82ca5");
...
"Update the RHEL rhc-worker-script package based on the guidance in RHSA-2023:5835.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rhc-worker-script-0.5-1.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
