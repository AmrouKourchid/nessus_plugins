...
# extracted from VMware Security Advisory PHSA-2022-3.0-0381. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Zlib PHSA-2022-3.0-0381");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the zlib package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-3.0-381.md");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'zlib-1.2.11-2.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'zlib-devel-1.2.11-2.ph3')) flag++;
