...
# extracted from Red Hat Security Advisory RHSA-2024:7462. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:7462");

  script_name(english:"RHEL 8 : cups-filters (RHSA-2024:7462)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for cups-filters.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:7462 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_7462.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f228542e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:7462");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cups-filters-1.20.0-29.el8_8.3', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'cups-filters-devel-1.20.0-29.el8_8.3', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'cups-filters-libs-1.20.0-29.el8_8.3', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
