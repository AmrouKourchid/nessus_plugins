...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Nmap PHSA-2023-3.0-0601");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'nmap-7.91-2.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'nmap-ncat-7.91-2.ph3')) flag++;
