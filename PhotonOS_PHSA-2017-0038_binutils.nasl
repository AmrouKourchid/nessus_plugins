...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Binutils PHSA-2017-0038");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-15020");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'binutils-2.29.1-1.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'binutils-debuginfo-2.29.1-1.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'binutils-devel-2.29.1-1.ph1')) flag++;
