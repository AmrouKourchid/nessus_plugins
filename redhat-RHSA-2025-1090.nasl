...
# extracted from Red Hat Security Advisory RHSA-2025:1090. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:1090");

  script_name(english:"RHEL 9 : ovn22.06 (RHSA-2025:1090)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_1090.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?12ce7730");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:1090");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ovn22.06-22.06.0-273.el9fdp', 'release':'9', 'el_string':'el9fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openvswitch'},
      {'reference':'ovn22.06-central-22.06.0-273.el9fdp', 'release':'9', 'el_string':'el9fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openvswitch'},
      {'reference':'ovn22.06-host-22.06.0-273.el9fdp', 'release':'9', 'el_string':'el9fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openvswitch'},
      {'reference':'ovn22.06-vtep-22.06.0-273.el9fdp', 'release':'9', 'el_string':'el9fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openvswitch'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'ovn22.06 / ovn22.06-central / ovn22.06-host / ovn22.06-vtep');
}
