...
# extracted from Fedora Security Advisory FEDORA-2023-145f259a77
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-145f259a77");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2023/12/21");
  script_xref(name:"IAVA", value:"2023-A-0660-S");

  script_name(english:"Fedora 39 : chromium (2023-145f259a77)");
...
FEDORA-2023-145f259a77 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-145f259a77");
...
var pkgs = [
    {'reference':'chromium-119.0.6045.199-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
