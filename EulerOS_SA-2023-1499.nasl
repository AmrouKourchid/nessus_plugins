...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : dnsmasq (EulerOS-SA-2023-1499)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1499
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?91c2933c");
...
var pkgs = [
  "dnsmasq-2.76-5.h11.eulerosv2r7",
  "dnsmasq-utils-2.76-5.h11.eulerosv2r7"
];
