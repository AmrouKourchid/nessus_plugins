...
# extracted from Gentoo Linux Security Advisory GLSA 202105-29.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202105-29");

  script_name(english:"GLSA-202105-29 : Tar: Denial of service");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202105-29
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202105-29");
...
if (qpkg_check(package:"app-arch/tar", unaffected:make_list("ge 1.34"), vulnerable:make_list("lt 1.34"))) flag++;
