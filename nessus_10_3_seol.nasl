...
if (description)
{
  ...
  script_name(english:"Tenable Nessus SEoL (10.3.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Tenable Nessus is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Tenable Nessus is 10.3.x. It is, therefore, no longer maintained by its vendor or provider.
...
"Upgrade to a version of Tenable Nessus that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2024/02/29");
...
var constraints = [
  { max_branch : '10.3', min_branch : '10.3', seol : 20240229, eseol : 20240731 }
];
