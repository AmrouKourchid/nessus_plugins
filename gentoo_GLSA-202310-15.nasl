...
# extracted from Gentoo Linux Security Advisory GLSA 202310-15.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202310-15 : USBView: root privilege escalation via insecure polkit settings");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202310-15 (USBView: root privilege escalation via
insecure polkit settings)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202310-15");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=831756");
...
"All USBView users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:usbview");
...
var packages = [
  {
    ...
    'unaffected' : make_list("ge 2.2"),
    'vulnerable' : make_list("lt 2.2")
  }
];
