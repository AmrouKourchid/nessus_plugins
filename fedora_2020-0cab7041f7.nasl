...
# extracted from Fedora Security Advisory FEDORA-2020-0cab7041f7.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-0cab7041f7");

  script_name(english:"Fedora 30 : ansible (2020-0cab7041f7)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"Update to 2.9.6 bugfix release and 2 CVE fixes: CVE-2020-1737,
CVE-2020-1739
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-0cab7041f7");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"ansible-2.9.6-1.fc30")) flag++;
