...
# AlmaLinux Security Advisory ALSA-2022:0510.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2022:0510");
  script_xref(name:"IAVA", value:"2022-A-0079-S");

  script_name(english:"AlmaLinux 8 : firefox (ALSA-2022:0510)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2022-0510.html");
...
var pkgs = [
    {'reference':'firefox-91.6.0-1.el8_5.alma', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
