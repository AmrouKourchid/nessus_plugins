...
# extracted from Fedora Security Advisory FEDORA-2024-c49fc0b05f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-c49fc0b05f");

  script_name(english:"Fedora 40 : csmock (2024-c49fc0b05f)");
...
FEDORA-2024-c49fc0b05f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-c49fc0b05f");
...
var pkgs = [
    {'reference':'csmock-3.5.3-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
