...
if (description)
{
  ...
  script_cve_id("CVE-2023-4511", "CVE-2023-4512", "CVE-2023-4513");
  script_xref(name:"IAVB", value:"2023-B-0063-S");

  script_name(english:"Photon OS 4.0: Wireshark PHSA-2023-4.0-0467");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'wireshark-4.0.8-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'wireshark-devel-4.0.8-1.ph4')) flag++;
