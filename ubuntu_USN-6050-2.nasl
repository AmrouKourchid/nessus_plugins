...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 ESM : Git vulnerabilities (USN-6050-2)");
...
the USN-6050-2 advisory.
    ...
    USN-6050-1 fixed several vulnerabilities in Git. This update provides the corresponding updates for
    CVE-2023-25652 and CVE-2023-29007 on Ubuntu 16.04 LTS.
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'git', 'pkgver': '1:2.7.4-0ubuntu1.10+esm7', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'git-all', 'pkgver': '1:2.7.4-0ubuntu1.10+esm7', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'git-arch', 'pkgver': '1:2.7.4-0ubuntu1.10+esm7', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'git-core', 'pkgver': '1:2.7.4-0ubuntu1.10+esm7', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'git-cvs', 'pkgver': '1:2.7.4-0ubuntu1.10+esm7', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'git-daemon-run', 'pkgver': '1:2.7.4-0ubuntu1.10+esm7', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'git-daemon-sysvinit', 'pkgver': '1:2.7.4-0ubuntu1.10+esm7', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'git-el', 'pkgver': '1:2.7.4-0ubuntu1.10+esm7', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'git-email', 'pkgver': '1:2.7.4-0ubuntu1.10+esm7', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'git-gui', 'pkgver': '1:2.7.4-0ubuntu1.10+esm7', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'git-man', 'pkgver': '1:2.7.4-0ubuntu1.10+esm7', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'git-mediawiki', 'pkgver': '1:2.7.4-0ubuntu1.10+esm7', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'git-svn', 'pkgver': '1:2.7.4-0ubuntu1.10+esm7', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'gitk', 'pkgver': '1:2.7.4-0ubuntu1.10+esm7', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'gitweb', 'pkgver': '1:2.7.4-0ubuntu1.10+esm7', 'ubuntu_pro': TRUE}
];
