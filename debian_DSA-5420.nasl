...
# extracted from Debian Security Advisory dsa-5420. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-5420-1 : chromium - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has packages installed that are affected by a vulnerability as referenced in the dsa-5420
advisory.

    Multiple security issues were discovered in Chromium, which could result in the execution of arbitrary
    code, denial of service or information disclosure. For the stable distribution (bullseye), this problem
    has been fixed in version 114.0.5735.106-1~deb11u1. For the upcoming stable distribution (bookworm), these
    problems have been fixed in version 114.0.5735.106-1~deb12u1 We recommend that you upgrade your chromium
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2023/dsa-5420");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-3079");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'chromium', 'reference': '114.0.5735.106-1~deb11u1'},
    {'release': '11.0', 'prefix': 'chromium-common', 'reference': '114.0.5735.106-1~deb11u1'},
    {'release': '11.0', 'prefix': 'chromium-driver', 'reference': '114.0.5735.106-1~deb11u1'},
    {'release': '11.0', 'prefix': 'chromium-l10n', 'reference': '114.0.5735.106-1~deb11u1'},
    {'release': '11.0', 'prefix': 'chromium-sandbox', 'reference': '114.0.5735.106-1~deb11u1'},
    {'release': '11.0', 'prefix': 'chromium-shell', 'reference': '114.0.5735.106-1~deb11u1'}
];
