...
"The remote Red Hat host is missing a security update for devtoolset-8-gcc.");
...
in the RHSA-2020:0924 advisory.
    ...
    languages, including C, C++, and Fortran. The devtoolset-8-gcc packages provide the Red Hat Developer
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_0924.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ad689471");
...
"Update the RHEL devtoolset-8-gcc package based on the guidance in RHSA-2020:0924.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'devtoolset-8-gcc-8.3.1-3.2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'devtoolset-8-gcc-c++-8.3.1-3.2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'devtoolset-8-gcc-gdb-plugin-8.3.1-3.2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'devtoolset-8-gcc-gfortran-8.3.1-3.2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'devtoolset-8-gcc-plugin-devel-8.3.1-3.2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'devtoolset-8-libgccjit-docs-8.3.1-3.2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'devtoolset-8-libitm-devel-8.3.1-3.2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'devtoolset-8-liblsan-devel-8.3.1-3.2.el7', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'devtoolset-8-libstdc++-docs-8.3.1-3.2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'devtoolset-8-libtsan-devel-8.3.1-3.2.el7', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'liblsan-8.3.1-3.2.el7', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'libtsan-8.3.1-3.2.el7', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'devtoolset-8-gcc / devtoolset-8-gcc-c++ / etc');
}
