...
# extracted from Red Hat Security Advisory RHSA-2019:2663 and 
# Oracle Linux Security Advisory ELSA-2019-2663 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : firefox (ELSA-2019-2663)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2019-2663.html");
...
var pkgs = [
    {'reference':'firefox-68.1.0-1.0.1.el8_0', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-68.1.0-1.0.1.el8_0', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
