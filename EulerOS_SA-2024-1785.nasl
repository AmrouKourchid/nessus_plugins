...
if (description)
{
  ...
  script_cve_id("CVE-2022-41723", "CVE-2023-39325", "CVE-2024-24557");

  script_name(english:"EulerOS 2.0 SP11 : docker-engine (EulerOS-SA-2024-1785)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1785
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7cc7ad60");
...
var pkgs = [
  "docker-engine-18.09.0-300.h50.46.43.eulerosv2r11",
  "docker-engine-selinux-18.09.0-300.h50.46.43.eulerosv2r11"
];
