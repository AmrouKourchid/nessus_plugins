...
# extracted from Fedora Security Advisory FEDORA-2024-bd09057dd2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-bd09057dd2");

  script_name(english:"Fedora 40 : libsoup3 (2024-bd09057dd2)");
...
FEDORA-2024-bd09057dd2 advisory.

    Add patches to fix:

    * CVE-2024-52530 libsoup3: HTTP request smuggling via stripping null bytes from the ends of header names
    (bug #2325358)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-bd09057dd2");
  script_set_attribute(attribute:"solution", value:
"Update the affected libsoup3 package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:libsoup3");
...
var pkgs = [
    {'reference':'libsoup3-3.4.4-5.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libsoup3');
}
