...
# extracted from Fedora Security Advisory FEDORA-2023-5f3b4c0b97
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-5f3b4c0b97");

  script_name(english:"Fedora 37 : iperf3 (2023-5f3b4c0b97)");
...
FEDORA-2023-5f3b4c0b97 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-5f3b4c0b97");
...
var pkgs = [
    {'reference':'iperf3-3.14-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
