...
# extracted from Red Hat Security Advisory RHSA-2011:1741. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2011:1741");

  script_name(english:"RHEL 6 : php-pear (RHSA-2011:1741)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for php-pear.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2011/rhsa-2011_1741.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9709678d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=651897");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=681982");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=747361");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2011:1741");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL php-pear package based on the guidance in RHSA-2011:1741.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:M/Au:N/C:N/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:L/UI:N/S:U/C:N/I:H/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2011-1072");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'php-pear-1.9.4-4.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
