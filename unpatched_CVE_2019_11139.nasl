...
if (description)
{
  ...
  script_cve_id("CVE-2019-11139");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2019-11139");
...
patch available.
  ...
  - Improper conditions check in the voltage modulation interface for some Intel(R) Xeon(R) Scalable
    Processors may allow a privileged user to potentially enable denial of service via local access.
    (CVE-2019-11139)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-11139");
