...
# extracted from Red Hat Security Advisory RHSA-2019:2964 and 
# Oracle Linux Security Advisory ELSA-2019-2964 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : patch (ELSA-2019-2964)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2019-2964.html");
...
var pkgs = [
    {'reference':'patch-2.7.1-12.el7_7', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
