...
# extracted from Fedora Security Advisory FEDORA-2022-1fd94a54a1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-1fd94a54a1");

  script_name(english:"Fedora 36 : nheko (2022-1fd94a54a1)");
...
FEDORA-2022-1fd94a54a1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-1fd94a54a1");
  script_set_attribute(attribute:"solution", value:
"Update the affected nheko package.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:H/Au:N/C:N/I:C/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:H/PR:N/UI:N/S:U/C:N/I:H/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-39264");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:nheko");
...
var pkgs = [
    {'reference':'nheko-0.10.2-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'nheko');
}
