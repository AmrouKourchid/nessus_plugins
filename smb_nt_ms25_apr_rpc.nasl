...
if (description)
{
  ...
  script_name(english:"Remote Desktop client for Windows RCE (April 2025)");
...
therefore, affected by a vulnerability. 
  - Heap-based buffer overflow in Remote Desktop Client allows an authorized attacker to execute code over 
    a network. (CVE-2025-27487)
Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://msrc.microsoft.com/update-guide/en-US/advisory/CVE-2025-27487");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9bb6364b");
  script_set_attribute(attribute:"solution", value:
"Upgrade to client version 1.2.6081.");
