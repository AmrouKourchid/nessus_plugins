...
# extracted from Oracle Linux Security Advisory ELSA-2023-32790.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : edk2 (ELSA-2023-32790)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-32790.html");
...
var pkgs = [
    {'reference':'edk2-tools-20230821-1.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'30'},
    {'reference':'edk2-tools-20230821-1.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'30'}
];
