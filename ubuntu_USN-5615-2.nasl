...
# extracted from Ubuntu Security Notice USN-5615-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5615-2");

  script_name(english:"Ubuntu 16.04 ESM : SQLite vulnerability (USN-5615-2)");
...
USN-5615-2 advisory.
    ...
    USN-5615-1 fixed several vulnerabilities in SQLite. This update provides the corresponding fix for
    CVE-2020-35525 for Ubuntu 16.04 ESM.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5615-2");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-35525");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'lemon', 'pkgver': '3.11.0-1ubuntu1.5+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libsqlite3-0', 'pkgver': '3.11.0-1ubuntu1.5+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libsqlite3-dev', 'pkgver': '3.11.0-1ubuntu1.5+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libsqlite3-tcl', 'pkgver': '3.11.0-1ubuntu1.5+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'sqlite3', 'pkgver': '3.11.0-1ubuntu1.5+esm1', 'ubuntu_pro': TRUE}
];
