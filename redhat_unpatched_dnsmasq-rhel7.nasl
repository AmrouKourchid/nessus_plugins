...
# extracted from Red Hat Security Advisory dnsmasq. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2015-3294", "CVE-2020-14312");

  script_name(english:"RHEL 7 : dnsmasq (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2020-14312");
