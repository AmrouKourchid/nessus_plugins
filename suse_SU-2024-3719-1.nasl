...
# SUSE update advisory SUSE-SU-2024:3719-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2024:3719-1");

  script_name(english:"openSUSE 15 Security Update : python-starlette (SUSE-SU-2024:3719-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1231689");
  script_set_attribute(attribute:"see_also", value:"https://lists.suse.com/pipermail/sle-updates/2024-October/037313.html");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2024-47874");
  script_set_attribute(attribute:"solution", value:
"Update the affected python311-starlette package.");
...
var pkgs = [
    {'reference':'python311-starlette-0.35.1-150600.3.3.1', 'release':'SUSE15.6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.6']}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python311-starlette');
}
