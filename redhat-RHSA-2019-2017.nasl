...
# extracted from Red Hat Security Advisory RHSA-2019:2017. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:2017");

  script_name(english:"RHEL 7 : zsh (RHSA-2019:2017)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for zsh.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2019:2017 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_2017.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0fdf71f6");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:2017");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1626184");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL zsh package based on the guidance in RHSA-2019:2017.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'zsh-5.0.2-33.el7', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'zsh-5.0.2-33.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'zsh-5.0.2-33.el7', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'zsh-5.0.2-33.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'zsh-html-5.0.2-33.el7', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'zsh-html-5.0.2-33.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'zsh-html-5.0.2-33.el7', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'zsh-html-5.0.2-33.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
