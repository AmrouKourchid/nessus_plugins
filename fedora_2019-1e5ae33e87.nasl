...
# extracted from Fedora Security Advisory FEDORA-2019-1e5ae33e87.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-1e5ae33e87");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2022/05/03");

  script_name(english:"Fedora 31 : openslp (2019-1e5ae33e87)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-1e5ae33e87");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"openslp-2.0.0-23.fc31")) flag++;
