...
"The version of Firefox installed on the remote Windows host is prior to 118.0. It is, therefore, affected by multiple
vulnerabilities as referenced in the mfsa2023-41 advisory.
...
mozilla_check_version(installs:installs, product:'firefox', esr:FALSE, fix:'118.0', severity:SECURITY_HOLE);
