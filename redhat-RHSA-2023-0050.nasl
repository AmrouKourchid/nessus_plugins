...
# extracted from Red Hat Security Advisory RHSA-2023:0050. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 8 : nodejs:14 (RHSA-2023:0050)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2023:0050 advisory.

    Node.js is a software development platform for building fast and scalable network applications in the
    JavaScript programming language.

    The following packages have been upgraded to a later upstream version: nodejs (14.21.1), nodejs-nodemon
    (2.0.20).
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_0050.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2941b85a");
...
"Update the affected packages.");
  ...
  script_cwe_id(350, 601, 1321, 1333);
  ...
  'nodejs:14': [
    {
      ...
      'pkgs': [
        {'reference':'nodejs-14.21.1-2.module+el8.7.0+17528+a329cd47', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-devel-14.21.1-2.module+el8.7.0+17528+a329cd47', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-docs-14.21.1-2.module+el8.7.0+17528+a329cd47', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-full-i18n-14.21.1-2.module+el8.7.0+17528+a329cd47', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-nodemon-2.0.20-2.module+el8.7.0+17528+a329cd47', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'nodejs-packaging-23-3.module+el8.3.0+6519+9f98ed83', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
        {'reference':'npm-6.14.17-1.14.21.1.2.module+el8.7.0+17528+a329cd47', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
      ]
    }
  ]
};
