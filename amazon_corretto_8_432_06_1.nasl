...
if (description)
{
  ...
  script_name(english:"Amazon Corretto Java 8.x < 8.432.06.1 Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"Amazon Corretto is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Amazon Corretto installed on the remote host is prior to 8 < 8.432.06.1. It is, therefore, affected by
multiple vulnerabilities as referenced in the corretto-8-2024-Oct-15 advisory.
...
"Update to Amazon Corretto Java 8.432.06.1 or later");
...
var constraints = [
  { 'min_version' : '8.0', 'fixed_version' : '8.432.06.1' }
];
