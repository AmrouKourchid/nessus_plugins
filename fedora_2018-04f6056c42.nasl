...
# extracted from Fedora Security Advisory FEDORA-2018-04f6056c42.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-04f6056c42");

  script_name(english:"Fedora 27 : php (2018-04f6056c42)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-04f6056c42");
...
flag = 0;
if (rpm_check(release:"FC27", reference:"php-7.1.17-1.fc27")) flag++;
