...
# extracted from Fedora Security Advisory FEDORA-2024-8df4ac93d7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-8df4ac93d7");

  script_name(english:"Fedora 39 : mingw-python3 (2024-8df4ac93d7)");
...
FEDORA-2024-8df4ac93d7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-8df4ac93d7");
...
var pkgs = [
    {'reference':'mingw-python3-3.11.8-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
