...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.1 : mesa (EulerOS-SA-2021-1613)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the version of the mesa package installed, the EulerOS
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1613
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9a2d0e74");
...
pkgs = ["mesa-libgbm-18.2.2-6.h1.eulerosv2r9"];
