...
# Rocky Linux Security Advisory RLSA-2022:1764.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2022:1764");
  script_xref(name:"IAVA", value:"2021-A-0497-S");

  script_name(english:"Rocky Linux 8 : python38:3.8 and python38-devel:3.8 (RLSA-2022:1764)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Rocky Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Rocky Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
RLSA-2022:1764 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2022:1764");
...
var appstreams = {
    'python38-devel:3.8': [
      ...
      {'reference':'python38-3.8.12-1.module+el8.6.0+794+eba84017', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-3.8.12-1.module+el8.6.0+794+eba84017', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python38-debug-3.8.12-1.module+el8.6.0+794+eba84017', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-debug-3.8.12-1.module+el8.6.0+794+eba84017', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-debuginfo-3.8.12-1.module+el8.6.0+794+eba84017', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-debuginfo-3.8.12-1.module+el8.6.0+794+eba84017', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-debugsource-3.8.12-1.module+el8.6.0+794+eba84017', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-debugsource-3.8.12-1.module+el8.6.0+794+eba84017', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-devel-3.8.12-1.module+el8.6.0+794+eba84017', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-devel-3.8.12-1.module+el8.6.0+794+eba84017', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-idle-3.8.12-1.module+el8.6.0+794+eba84017', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-idle-3.8.12-1.module+el8.6.0+794+eba84017', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python38-libs-3.8.12-1.module+el8.6.0+794+eba84017', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-libs-3.8.12-1.module+el8.6.0+794+eba84017', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python38-pip-19.3.1-5.module+el8.6.0+794+eba84017', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-pip-wheel-19.3.1-5.module+el8.6.0+794+eba84017', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python38-rpm-macros-3.8.12-1.module+el8.6.0+794+eba84017', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python38-test-3.8.12-1.module+el8.6.0+794+eba84017', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-test-3.8.12-1.module+el8.6.0+794+eba84017', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-tkinter-3.8.12-1.module+el8.6.0+794+eba84017', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-tkinter-3.8.12-1.module+el8.6.0+794+eba84017', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
