...
"The remote Red Hat host is missing one or more security updates for zsh.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2018:3073 advisory.

    The zsh shell is a command interpreter usable as an interactive login shell and as a shell script command
    processor. Zsh resembles the ksh shell (the Korn shell), but includes many enhancements. Zsh supports
    command-line editing, built-in spelling correction, programmable command completion, shell functions (with
    ...
    * zsh: crash on copying empty hash table (CVE-2018-7549)
    ...
    The CVE-2018-1083, CVE-2018-1071, and CVE-2018-1100 issues were discovered by Richard Maciel Costa (Red
    Hat).
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2018/rhsa-2018_3073.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a4ae4a42");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:3073");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1549836");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1549855");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1549858");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1549861");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1549862");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1553531");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1557382");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1563395");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL zsh package based on the guidance in RHSA-2018:3073.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'zsh-5.0.2-31.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'zsh-html-5.0.2-31.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
