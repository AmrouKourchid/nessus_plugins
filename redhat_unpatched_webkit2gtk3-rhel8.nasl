...
# extracted from Red Hat Security Advisory webkit2gtk3. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2024-23254");

  script_name(english:"RHEL 8 : webkit2gtk3 (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-23254");
