...
# extracted from Red Hat Security Advisory lvm2. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 6 : lvm2 (Unpatched Vulnerability) (deprecated)");
...
"This plugin has been deprecated as it does not adhere to established standards for this style of check.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:lvm2");
