...
# extracted from Fedora Security Advisory FEDORA-2024-29a74ac2b0
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-29a74ac2b0");

  script_name(english:"Fedora 40 : krb5 (2024-29a74ac2b0)");
...
FEDORA-2024-29a74ac2b0 advisory.

    Security:

    * CVE-2024-3596: Fix for BlastRADIUS vulnerability in libkrad (support for Message-Authenticator
    attribute)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-29a74ac2b0");
...
var pkgs = [
    {'reference':'krb5-1.21.3-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
