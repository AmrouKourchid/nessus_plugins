...
# extracted from Gentoo Linux Security Advisory GLSA 202003-04.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202003-04");

  script_name(english:"GLSA-202003-04 : Vim, gVim: Remote execution of arbitrary code");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202003-04
(Vim, gVim: Remote execution of arbitrary code)

      It was found that the :source! command was not restricted by
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202003-04");
...
if (qpkg_check(package:"app-editors/gvim", unaffected:make_list("ge 8.1.1486"), vulnerable:make_list("lt 8.1.1486"))) flag++;
if (qpkg_check(package:"app-editors/vim", unaffected:make_list("ge 8.1.1486"), vulnerable:make_list("lt 8.1.1486"))) flag++;
