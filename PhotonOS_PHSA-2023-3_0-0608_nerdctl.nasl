...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Nerdctl PHSA-2023-3.0-0608");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:vmware:photonos:nerdctl");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'nerdctl-1.4.0-1.ph3')) flag++;
