...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : libldb (EulerOS-SA-2023-2692)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2692
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?025c36a2");
...
var pkgs = [
  "libldb-2.4.1-1.h2.eulerosv2r11"
];
