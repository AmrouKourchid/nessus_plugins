...
# extracted from Red Hat Security Advisory RHSA-2023:7150. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:7150");

  script_name(english:"RHEL 8 : librabbitmq (RHSA-2023:7150)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for librabbitmq.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2023:7150 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_7150.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?93dad6e8");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2215762");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:7150");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL librabbitmq package based on the guidance in RHSA-2023:7150.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'librabbitmq-0.9.0-4.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'librabbitmq-devel-0.9.0-4.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
