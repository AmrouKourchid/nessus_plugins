...
var kernel_mappings = {
  '20.04': {
    '5.13.0': {
      'generic': '5.13.0-30',
      'generic-64k': '5.13.0-30',
      'generic-lpae': '5.13.0-30',
      'lowlatency': '5.13.0-30'
    }
  }
};
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-5295-1');
}
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-5295-1');
  }
  else
  {
