...
# extracted from Debian Security Advisory DLA-2309-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2309-1 : evolution-data-server security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"In Evolution Data Server a vulnerability was discovered that allowed a
malicious server to crash the mail client.
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2020/08/msg00005.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/stretch/evolution-data-server");
...
flag = 0;
if (deb_check(release:"9.0", prefix:"evolution-data-server", reference:"3.22.7-1+deb9u2")) flag++;
if (deb_check(release:"9.0", prefix:"evolution-data-server-common", reference:"3.22.7-1+deb9u2")) flag++;
if (deb_check(release:"9.0", prefix:"evolution-data-server-dev", reference:"3.22.7-1+deb9u2")) flag++;
if (deb_check(release:"9.0", prefix:"evolution-data-server-doc", reference:"3.22.7-1+deb9u2")) flag++;
if (deb_check(release:"9.0", prefix:"gir1.2-ebook-1.2", reference:"3.22.7-1+deb9u2")) flag++;
if (deb_check(release:"9.0", prefix:"gir1.2-ebookcontacts-1.2", reference:"3.22.7-1+deb9u2")) flag++;
if (deb_check(release:"9.0", prefix:"gir1.2-edataserver-1.2", reference:"3.22.7-1+deb9u2")) flag++;
if (deb_check(release:"9.0", prefix:"libcamel-1.2-59", reference:"3.22.7-1+deb9u2")) flag++;
if (deb_check(release:"9.0", prefix:"libcamel1.2-dev", reference:"3.22.7-1+deb9u2")) flag++;
if (deb_check(release:"9.0", prefix:"libebackend-1.2-10", reference:"3.22.7-1+deb9u2")) flag++;
if (deb_check(release:"9.0", prefix:"libebackend1.2-dev", reference:"3.22.7-1+deb9u2")) flag++;
if (deb_check(release:"9.0", prefix:"libebook-1.2-16", reference:"3.22.7-1+deb9u2")) flag++;
if (deb_check(release:"9.0", prefix:"libebook-contacts-1.2-2", reference:"3.22.7-1+deb9u2")) flag++;
if (deb_check(release:"9.0", prefix:"libebook-contacts1.2-dev", reference:"3.22.7-1+deb9u2")) flag++;
if (deb_check(release:"9.0", prefix:"libebook1.2-dev", reference:"3.22.7-1+deb9u2")) flag++;
if (deb_check(release:"9.0", prefix:"libecal-1.2-19", reference:"3.22.7-1+deb9u2")) flag++;
if (deb_check(release:"9.0", prefix:"libecal1.2-dev", reference:"3.22.7-1+deb9u2")) flag++;
if (deb_check(release:"9.0", prefix:"libedata-book-1.2-25", reference:"3.22.7-1+deb9u2")) flag++;
if (deb_check(release:"9.0", prefix:"libedata-book1.2-dev", reference:"3.22.7-1+deb9u2")) flag++;
if (deb_check(release:"9.0", prefix:"libedata-cal-1.2-28", reference:"3.22.7-1+deb9u2")) flag++;
if (deb_check(release:"9.0", prefix:"libedata-cal1.2-dev", reference:"3.22.7-1+deb9u2")) flag++;
if (deb_check(release:"9.0", prefix:"libedataserver-1.2-22", reference:"3.22.7-1+deb9u2")) flag++;
if (deb_check(release:"9.0", prefix:"libedataserver1.2-dev", reference:"3.22.7-1+deb9u2")) flag++;
if (deb_check(release:"9.0", prefix:"libedataserverui-1.2-1", reference:"3.22.7-1+deb9u2")) flag++;
if (deb_check(release:"9.0", prefix:"libedataserverui1.2-dev", reference:"3.22.7-1+deb9u2")) flag++;
