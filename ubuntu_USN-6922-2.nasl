...
# extracted from Ubuntu Security Notice USN-6922-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6922-2");

  script_name(english:"Ubuntu 22.04 LTS : Linux kernel vulnerabilities (USN-6922-2)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6922-2");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-6.5.0-45-lowlatency");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-6.5.0-45-lowlatency-64k");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-6922-2');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2024-24857', 'CVE-2024-24858', 'CVE-2024-24859', 'CVE-2024-25739');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-6922-2');
  }
  else
  {
