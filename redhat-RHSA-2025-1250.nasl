...
# extracted from Red Hat Security Advisory RHSA-2025:1250. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:1250");

  script_name(english:"RHEL 7 : python-jinja2 (RHSA-2025:1250)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_1250.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7f549aab");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:1250");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-jinja2 package based on the guidance in RHSA-2025:1250.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python-jinja2-2.7.2-5.el7_9', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
