...
if (description)
{
  ...
  script_cve_id("CVE-2016-9836", "CVE-2016-9837", "CVE-2016-9838");
  script_bugtraq_id(94663, 94892, 94893);
...
"Upgrade to Joomla! version 3.6.5 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-9836");
