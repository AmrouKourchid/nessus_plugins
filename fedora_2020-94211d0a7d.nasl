...
# extracted from Fedora Security Advisory FEDORA-2020-94211d0a7d.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : libarchive (2020-94211d0a7d)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-94211d0a7d");
...
flag = 0;
if (rpm_check(release:"FC32", reference:"libarchive-3.4.3-1.fc32")) flag++;
