...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : perl-DBI (EulerOS-SA-2021-2343)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2343
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e0af9696");
...
pkgs = ["perl-DBI-1.627-4.h4.eulerosv2r7"];
