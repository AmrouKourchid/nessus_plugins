...
# extracted from Red Hat Security Advisory bash. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2019-9924", "CVE-2019-18276", "CVE-2022-3715");

  script_name(english:"RHEL 6 : bash (Unpatched Vulnerability) (deprecated)");
...
"This plugin has been deprecated as it does not adhere to established standards for this style of check.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2022-3715");
