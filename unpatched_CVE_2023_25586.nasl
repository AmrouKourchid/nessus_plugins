...
if (description)
{
  ...
  script_cve_id("CVE-2023-25586");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2023-25586");
...
patch available.
  ...
  - A flaw was found in Binutils. A logic fail in the bfd_init_section_decompress_status function may lead to
    the use of an uninitialized variable that can cause a crash and local denial of service. (CVE-2023-25586)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-25586");
