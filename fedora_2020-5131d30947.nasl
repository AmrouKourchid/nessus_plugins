...
# extracted from Fedora Security Advisory FEDORA-2020-5131d30947.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : 2:samba / libldb (2020-5131d30947)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-5131d30947");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"samba-4.11.11-0.fc31", epoch:"2")) flag++;
if (rpm_check(release:"FC31", reference:"libldb-2.0.12-1.fc31")) flag++;
