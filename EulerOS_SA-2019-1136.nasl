...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : gnutls (EulerOS-SA-2019-1136)");
...
vulnerability :
  ...
  - It was found that GnuTLS's implementation of
    ...
    crafted packets.(CVE-2018-10845)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1136
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?98baafb7");
...
pkgs = ["gnutls-3.3.26-9.h3.eulerosv2r7",
        "gnutls-c++-3.3.26-9.h3.eulerosv2r7",
        "gnutls-dane-3.3.26-9.h3.eulerosv2r7",
        "gnutls-devel-3.3.26-9.h3.eulerosv2r7",
        "gnutls-utils-3.3.26-9.h3.eulerosv2r7"];
