...
# extracted from Fedora Security Advisory FEDORA-2019-a01751837d.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : sqlite (2019-a01751837d)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-a01751837d");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"sqlite-3.26.0-3.fc29")) flag++;
