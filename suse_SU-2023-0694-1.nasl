...
# SUSE update advisory SUSE-SU-2023:0694-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:0694-1");

  script_name(english:"SUSE SLES15 / openSUSE 15 Security Update : redis (SUSE-SU-2023:0694-1)");
...
vulnerabilities as referenced in the SUSE-SU-2023:0694-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1208235");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-March/014020.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d121d85c");
...
var pkgs = [
    {'reference':'redis-6.2.6-150400.3.16.1', 'sp':'4', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.4']},
    {'reference':'redis-6.2.6-150400.3.16.1', 'sp':'4', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.4', 'sle-module-server-applications-release-15.4', 'sles-release-15.4']},
    {'reference':'redis-6.2.6-150400.3.16.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.4']}
];
