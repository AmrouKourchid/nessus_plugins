...
# extracted from openSUSE Security Update openSUSE-2019-534.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : cinnamon (openSUSE-2019-534)");
...
Security issue fixed :
  ...
  - CVE-2018-13054: Fix symlink attack vulnerability
    (boo#1083067).");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1083067");
  script_set_attribute(attribute:"solution", value:
"Update the affected cinnamon packages.");
...
if ( rpm_check(release:"SUSE15.0", reference:"cinnamon-3.6.7-lp150.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"cinnamon-debuginfo-3.6.7-lp150.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"cinnamon-debugsource-3.6.7-lp150.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"cinnamon-gschemas-3.6.7-lp150.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"cinnamon-gschemas-branding-upstream-3.6.7-lp150.3.3.1") ) flag++;
