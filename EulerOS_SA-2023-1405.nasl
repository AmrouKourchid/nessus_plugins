...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : binutils (EulerOS-SA-2023-1405)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1405
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f815cdc8");
...
var pkgs = [
  "binutils-2.37-6.h14.eulerosv2r11"
];
