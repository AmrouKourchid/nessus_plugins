...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : libjpeg-turbo (EulerOS-SA-2020-1664)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1664
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e0b2005a");
...
pkgs = ["libjpeg-turbo-1.2.90-5.h4",
        "libjpeg-turbo-devel-1.2.90-5.h4"];
