...
# extracted from Debian Security Advisory dsa-5559. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-5559-1 : wireshark - security update");
...
dsa-5559 advisory.
    ...
    A vulnerability was discovered in the SSH dissector of Wireshark, a network protocol analyzer, which could
    result in denial of service or potentially the execution of arbitrary code. For the stable distribution
    (bookworm), these problems have been fixed in version 4.0.11-1~deb12u1. We recommend that you upgrade your
    wireshark packages. For the detailed security status of wireshark please refer to its security tracker
    page at: https://security-tracker.debian.org/tracker/wireshark
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2023/dsa-5559");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-6174");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'libwireshark-data', 'reference': '4.0.11-1~deb12u1'},
    {'release': '12.0', 'prefix': 'libwireshark-dev', 'reference': '4.0.11-1~deb12u1'},
    {'release': '12.0', 'prefix': 'libwireshark16', 'reference': '4.0.11-1~deb12u1'},
    {'release': '12.0', 'prefix': 'libwiretap-dev', 'reference': '4.0.11-1~deb12u1'},
    {'release': '12.0', 'prefix': 'libwiretap13', 'reference': '4.0.11-1~deb12u1'},
    {'release': '12.0', 'prefix': 'libwsutil-dev', 'reference': '4.0.11-1~deb12u1'},
    {'release': '12.0', 'prefix': 'libwsutil14', 'reference': '4.0.11-1~deb12u1'},
    {'release': '12.0', 'prefix': 'tshark', 'reference': '4.0.11-1~deb12u1'},
    {'release': '12.0', 'prefix': 'wireshark', 'reference': '4.0.11-1~deb12u1'},
    {'release': '12.0', 'prefix': 'wireshark-common', 'reference': '4.0.11-1~deb12u1'},
    {'release': '12.0', 'prefix': 'wireshark-dev', 'reference': '4.0.11-1~deb12u1'},
    {'release': '12.0', 'prefix': 'wireshark-doc', 'reference': '4.0.11-1~deb12u1'},
    {'release': '12.0', 'prefix': 'wireshark-qt', 'reference': '4.0.11-1~deb12u1'}
];
