...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : cloud-init (EulerOS-SA-2023-2855)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2855
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d7baa70c");
...
var pkgs = [
  "cloud-init-21.4-2.h7.eulerosv2r11"
];
