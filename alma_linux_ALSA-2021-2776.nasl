...
# AlmaLinux Security Advisory ALSA-2021:2776.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2021:2776");
  script_xref(name:"IAVA", value:"2021-A-0327-S");

  script_name(english:"AlmaLinux 8 : java-1.8.0-openjdk (ALSA-2021:2776)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ALSA-2021:2776 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2021-2776.html");
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'java-1.8.0-openjdk-accessibility-fastdebug / etc');
}
