...
# extracted from Fedora Security Advisory FEDORA-2024-05dedb1a53
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-05dedb1a53");

  script_name(english:"Fedora 41 : python-fastapi / python-openapi-core / python-platformio / etc (2024-05dedb1a53)");
...
FEDORA-2024-05dedb1a53 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-05dedb1a53");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:python-fastapi");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:python-openapi-core");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:python-platformio");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:python-starlette");
...
var pkgs = [
    {'reference':'python-fastapi-0.115.2-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python-openapi-core-0.19.4-4.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python-platformio-6.1.14-7.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python-starlette-0.40.0-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python-fastapi / python-openapi-core / python-platformio / etc');
}
