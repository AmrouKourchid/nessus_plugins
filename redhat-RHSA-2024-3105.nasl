...
# extracted from Red Hat Security Advisory RHSA-2024:3105. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:3105");

  script_name(english:"RHEL 8 : python3.11-cryptography (RHSA-2024:3105)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for python3.11-cryptography.");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_3105.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b7a2e566");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2255331");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:3105");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python3.11-cryptography package based on the guidance in RHSA-2024:3105.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3.11-cryptography-37.0.2-6.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
