...
# extracted from Red Hat Security Advisory pcp. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2012-6708", "CVE-2020-7656");

  script_name(english:"RHEL 7 : pcp (Unpatched Vulnerability) (deprecated)");
