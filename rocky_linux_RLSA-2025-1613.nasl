...
# Rocky Linux Security Advisory RLSA-2025:1613.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2025:1613");

  script_name(english:"RockyLinux 9 : nodejs:22 (RLSA-2025:1613)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2025:1613");
