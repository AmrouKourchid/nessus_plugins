...
# extracted from Fedora Security Advisory FEDORA-2023-9e5a29a25d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-9e5a29a25d");

  script_name(english:"Fedora 38 : mingw-glib2 (2023-9e5a29a25d)");
...
FEDORA-2023-9e5a29a25d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-9e5a29a25d");
...
var pkgs = [
    {'reference':'mingw-glib2-2.74.7-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
