...
# extracted from F5 Networks BIG-IP Solution K000141380.
#
# @NOAGENT@
##
...
if (description)
{
  ...
  script_cve_id("CVE-2025-24312");
  script_xref(name:"IAVA", value:"2025-A-0086");

  script_name(english:"F5 Networks BIG-IP : BIG-IP AFM vulnerability (K000141380)");
...
referenced in the K000141380 advisory.

    When BIG-IP AFM is provisioned with IPS module enabled and protocol inspection profile is configured on a
    virtual server or firewall rule or policy, undisclosed traffic can cause an increase in CPU resource
    utilization.(CVE-2025-24312)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K000141380");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K000141380.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-24312");
