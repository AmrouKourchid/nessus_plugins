...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP12 : libtiff (EulerOS-SA-2024-2353)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2353
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f652d318");
...
var pkgs = [
  "libtiff-4.3.0-24.h16.eulerosv2r12"
];
