...
# extracted from Red Hat Security Advisory ansible. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2016-8647", "CVE-2016-9587", "CVE-2018-10855");

  script_name(english:"RHEL 7 : ansible (Unpatched Vulnerability) (deprecated)");
