...
# extracted from Red Hat Security Advisory RHSA-2020:5083. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : microcode_ctl (RHSA-2020:5083)");
...
referenced in the RHSA-2020:5083 advisory.
    ...
    * Add publicly-sourced codenames list to supply to gen_provides.sh; update the latter to handle the
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_5083.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?729e8963");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'microcode_ctl-2.1-73.2.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
    ]
  }
];
