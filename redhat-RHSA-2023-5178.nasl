...
# extracted from Red Hat Security Advisory RHSA-2023:5178. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:5178");

  script_name(english:"RHEL 6 : busybox (RHSA-2023:5178)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for busybox.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 6 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2023:5178 advisory.

    BusyBox is a binary file that combines a large number of common system utilities into a single executable
    file. BusyBox provides replacements for most GNU file utilities, shell utilities, and other command-line
    tools.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_5178.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ef65f8bd");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2237153");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:5178");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL busybox package based on the guidance in RHSA-2023:5178.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'busybox-1.15.1-21.el6_10.1', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'busybox-1.15.1-21.el6_10.1', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'busybox-1.15.1-21.el6_10.1', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'busybox-petitboot-1.15.1-21.el6_10.1', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'busybox-petitboot-1.15.1-21.el6_10.1', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'busybox-petitboot-1.15.1-21.el6_10.1', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
