...
# extracted from Debian Security Advisory dla-3570. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3570 : libwebp-dev - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3570
advisory.

    - -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3570-1                debian-lts@lists.debian.org
    https://www.debian.org/lts/security/               Emilio Pozuelo Monfort
    September 18, 2023                            https://wiki.debian.org/LTS
    - -------------------------------------------------------------------------
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/libwebp");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libwebp-dev', 'reference': '0.6.1-2+deb10u3'},
    {'release': '10.0', 'prefix': 'libwebp6', 'reference': '0.6.1-2+deb10u3'},
    {'release': '10.0', 'prefix': 'libwebpdemux2', 'reference': '0.6.1-2+deb10u3'},
    {'release': '10.0', 'prefix': 'libwebpmux3', 'reference': '0.6.1-2+deb10u3'},
    {'release': '10.0', 'prefix': 'webp', 'reference': '0.6.1-2+deb10u3'}
];
