...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.5.0 : jasper (EulerOS-SA-2020-1053)");
...
affected by the following vulnerabilities :
  ...
  - JasPer 2.0.13 allows remote attackers to cause a denial
    of service (heap-based buffer over-read and application
    crash) via a crafted image, related to the
    jas_image_ishomosamp function in
    libjasper/base/jas_image.c.(CVE-2017-14132)
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1053
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b2ec89fa");
...
"Update the affected jasper packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-13748");
...
pkgs = ["jasper-libs-2.0.14-7.h3.eulerosv2r8"];
