...
# extracted from Fedora Security Advisory FEDORA-2023-fe6fa5696e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-fe6fa5696e");

  script_name(english:"Fedora 37 : dcmtk (2023-fe6fa5696e)");
...
FEDORA-2023-fe6fa5696e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-fe6fa5696e");
  script_set_attribute(attribute:"solution", value:
"Update the affected dcmtk package.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:N/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-43272");
...
var pkgs = [
    {'reference':'dcmtk-3.6.7-3.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'dcmtk');
}
