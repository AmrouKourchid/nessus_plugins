...
if (description)
{
  ...
  script_name(english:"Remote Desktop client for Windows RCE (October 2024)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://msrc.microsoft.com/update-guide/en-US/advisory/CVE-2024-43533");
  # https://learn.microsoft.com/en-us/azure/virtual-desktop/whats-new-client-windows?pivots=remote-desktop-msi#updates-for-version-1257090
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f24208f3");
  script_set_attribute(attribute:"solution", value:
"Upgrade to client version 1.2.5709, 1.2.5709 (Insider) or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:R/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-43533");
