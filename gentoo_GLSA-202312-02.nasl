...
# extracted from Gentoo Linux Security Advisory GLSA 202312-02.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202312-02 : Minecraft Server: Remote Code Execution");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202312-02 (Minecraft Server: Remote Code Execution)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202312-02");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=828936");
...
"All Minecraft Server users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:minecraft-server");
...
var packages = [
  {
    ...
    'unaffected' : make_list("ge 1.18.1"),
    'vulnerable' : make_list("lt 1.18.1")
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'Minecraft Server');
}
