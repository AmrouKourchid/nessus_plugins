...
# extracted from Red Hat Security Advisory RHSA-2019:2548. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:2548");
  script_xref(name:"TRA", value:"TRA-2019-35");

  script_name(english:"RHEL 7 : OpenShift Container Platform 4.1 jenkins (RHSA-2019:2548)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for OpenShift Container Platform 4.1 jenkins.");
...
referenced in the RHSA-2019:2548 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_2548.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?31a38fb3");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:2548");
...
"Update the RHEL OpenShift Container Platform 4.1 jenkins package based on the guidance in RHSA-2019:2548.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jenkins-2.176.2.1563461785-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
