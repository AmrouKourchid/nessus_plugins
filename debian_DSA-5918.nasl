...
# extracted from Debian Security Advisory dsa-5918. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5918 : libvarnishapi-dev - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 12 host has packages installed that are affected by a vulnerability as referenced in the dsa-5918
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bookworm/varnish");
...
"Upgrade the libvarnishapi-dev packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:libvarnishapi3");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'libvarnishapi-dev', 'reference': '7.1.1-2+deb12u1'},
    {'release': '12.0', 'prefix': 'libvarnishapi3', 'reference': '7.1.1-2+deb12u1'},
    {'release': '12.0', 'prefix': 'varnish', 'reference': '7.1.1-2+deb12u1'},
    {'release': '12.0', 'prefix': 'varnish-doc', 'reference': '7.1.1-2+deb12u1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libvarnishapi-dev / libvarnishapi3 / varnish / varnish-doc');
}
