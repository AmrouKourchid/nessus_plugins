...
if (description)
{
  ...
  script_name(english:"Adobe Digital Editions < 4.5.11.187303 Information Disclosure (APSB20-23)");
...
"The version of Adobe Digital Editions installed on the remote Windows host is prior to 4.5.11.187303. It is, therefore,
affected by a vulnerability as referenced in the APSB20-23 advisory.

  - Adobe Digital Editions versions 4.5.11.187212 and below have a file enumeration (host or local network)
    vulnerability. Successful exploitation could lead to information disclosure. (CVE-2020-3798)
