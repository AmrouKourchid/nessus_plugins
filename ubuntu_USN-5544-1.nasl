...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS / 22.04 LTS : Linux kernel vulnerabilities (USN-5544-1)");
...
referenced in the USN-5544-1 advisory.
...
var kernel_mappings = {
  '20.04': {
    '5.15.0': {
      'generic': '5.15.0-43',
      'generic-64k': '5.15.0-43',
      'generic-lpae': '5.15.0-43',
      'lowlatency': '5.15.0-43',
      'lowlatency-64k': '5.15.0-43'
    }
  },
  '22.04': {
    '5.15.0': {
