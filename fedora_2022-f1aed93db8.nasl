...
# extracted from Fedora Security Advisory FEDORA-2022-f1aed93db8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-f1aed93db8");

  script_name(english:"Fedora 35 : ghc-cmark-gfm (2022-f1aed93db8)");
...
FEDORA-2022-f1aed93db8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-f1aed93db8");
...
var pkgs = [
    {'reference':'ghc-cmark-gfm-0.2.5-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
