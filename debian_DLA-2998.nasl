...
# extracted from Debian Security Advisory dla-2998. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2998-1 : kicad - LTS security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2022/dla-2998");
...
var pkgs = [
    {'release': '9.0', 'prefix': 'kicad', 'reference': '4.0.5+dfsg1-4+deb9u1'},
    {'release': '9.0', 'prefix': 'kicad-common', 'reference': '4.0.5+dfsg1-4+deb9u1'},
    {'release': '9.0', 'prefix': 'kicad-doc-ca', 'reference': '4.0.5+dfsg1-4+deb9u1'},
    {'release': '9.0', 'prefix': 'kicad-doc-de', 'reference': '4.0.5+dfsg1-4+deb9u1'},
    {'release': '9.0', 'prefix': 'kicad-doc-en', 'reference': '4.0.5+dfsg1-4+deb9u1'},
    {'release': '9.0', 'prefix': 'kicad-doc-es', 'reference': '4.0.5+dfsg1-4+deb9u1'},
    {'release': '9.0', 'prefix': 'kicad-doc-fr', 'reference': '4.0.5+dfsg1-4+deb9u1'},
    {'release': '9.0', 'prefix': 'kicad-doc-it', 'reference': '4.0.5+dfsg1-4+deb9u1'},
    {'release': '9.0', 'prefix': 'kicad-doc-ja', 'reference': '4.0.5+dfsg1-4+deb9u1'},
    {'release': '9.0', 'prefix': 'kicad-doc-nl', 'reference': '4.0.5+dfsg1-4+deb9u1'},
    {'release': '9.0', 'prefix': 'kicad-doc-pl', 'reference': '4.0.5+dfsg1-4+deb9u1'},
    {'release': '9.0', 'prefix': 'kicad-doc-ru', 'reference': '4.0.5+dfsg1-4+deb9u1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kicad / kicad-common / kicad-doc-ca / kicad-doc-de / kicad-doc-en / etc');
}
