...
# extracted from VMware Security Advisory PHSA-2022-4.0-0288. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2022-3725", "CVE-2023-1992");
  script_xref(name:"IAVB", value:"2022-B-0044-S");
  script_xref(name:"IAVB", value:"2023-B-0024-S");

  script_name(english:"Photon OS 4.0: Wireshark PHSA-2022-4.0-0288");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the wireshark package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-288.md");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-1992");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'wireshark-3.6.9-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'wireshark-devel-3.6.9-1.ph4')) flag++;
