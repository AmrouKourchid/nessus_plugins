...
# extracted from Fedora Security Advisory FEDORA-2022-3f28aa88cf
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-3f28aa88cf");

  script_name(english:"Fedora 37 : chromium (2022-3f28aa88cf)");
...
FEDORA-2022-3f28aa88cf advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-3f28aa88cf");
...
var pkgs = [
    {'reference':'chromium-105.0.5195.125-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
