...
"The version of Google Chrome installed on the remote Windows host is prior to 110.0.5481.77. It is, therefore, affected
by multiple vulnerabilities as referenced in the 2023_02_stable-channel-update-for-desktop advisory.
...
google_chrome_check_version(installs:installs, fix:'110.0.5481.77', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
