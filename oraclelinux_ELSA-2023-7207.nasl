...
# extracted from Oracle Linux Security Advisory ELSA-2023-7207.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : c-ares (ELSA-2023-7207)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ELSA-2023-7207 advisory.

    [1.13.0-9.1]
    - Resolves: RHEL-11931 - Buffer Underwrite in ares_inet_net_pton() [rhel-8.9.0.z]

    [1.13.0-9]
    - Resolves: rhbz#2238293 - CVE-2020-22217 c-ares: read-heap-buffer-overflow in ares_parse_soa_reply
    [rhel-8] [rhel-8.9.0.z]
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-7207.html");
