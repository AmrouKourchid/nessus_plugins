...
# extracted from Fedora Security Advisory FEDORA-2024-3798818c82
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-3798818c82");

  script_name(english:"Fedora 40 : sssd (2024-3798818c82)");
...
FEDORA-2024-3798818c82 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-3798818c82");
...
var pkgs = [
    {'reference':'sssd-2.9.4-7.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
