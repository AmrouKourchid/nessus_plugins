...
# extracted from Fedora Security Advisory FEDORA-2024-8b67e47e43
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-8b67e47e43");

  script_name(english:"Fedora 38 : libxls (2024-8b67e47e43)");
...
FEDORA-2024-8b67e47e43 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-8b67e47e43");
  script_set_attribute(attribute:"solution", value:
"Update the affected libxls package.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:N/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:R/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-38852");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:libxls");
...
var pkgs = [
    {'reference':'libxls-1.6.2-14.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
