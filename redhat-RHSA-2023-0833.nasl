...
# extracted from Red Hat Security Advisory RHSA-2023:0833. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:0833");

  script_name(english:"RHEL 8 : python3 (RHSA-2023:0833)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for python3.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2023:0833 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_0833.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9939e84d");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:0833");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'platform-python-3.6.8-48.el8_7.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'platform-python-debug-3.6.8-48.el8_7.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'platform-python-devel-3.6.8-48.el8_7.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-idle-3.6.8-48.el8_7.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-libs-3.6.8-48.el8_7.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-test-3.6.8-48.el8_7.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-tkinter-3.6.8-48.el8_7.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
