...
# extracted from Fedora Security Advisory FEDORA-2020-e99ef3282f.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 33 : libexif (2020-e99ef3282f)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-e99ef3282f");
...
flag = 0;
if (rpm_check(release:"FC33", reference:"libexif-0.6.22-3.fc33")) flag++;
