...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.6.0 : libldb (EulerOS-SA-2021-1559)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1559
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3fce1af7");
...
pkgs = ["libldb-1.4.2-1.h4.eulerosv2r8"];
