...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : python-oauthlib (EulerOS-SA-2023-1045)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the python-oauthlib package installed, the EulerOS installation on the remote host is
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1045
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3701b87b");
  script_set_attribute(attribute:"solution", value:
"Update the affected python-oauthlib packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:python3-oauthlib");
...
var pkgs = [
  "python3-oauthlib-3.1.1-1.h2.eulerosv2r11"
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "python-oauthlib");
}
