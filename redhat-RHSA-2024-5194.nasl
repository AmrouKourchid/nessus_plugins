...
# extracted from Red Hat Security Advisory RHSA-2024:5194. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2024-6104", "CVE-2024-37298");
  script_xref(name:"RHSA", value:"2024:5194");

  script_name(english:"RHEL 8 : container-tools:rhel8 (RHSA-2024:5194)");
...
referenced in the RHSA-2024:5194 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_5194.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5d82742c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:5194");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL container-tools:rhel8 package based on the guidance in RHSA-2024:5194.");
  ...
  'container-tools:rhel8': [
    {
      ...
      'pkgs': [
        {'reference':'aardvark-dns-1.5.0-2.module+el8.8.0+22142+4cbed6b3', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'buildah-1.29.3-1.module+el8.8.0+22142+4cbed6b3', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'buildah-tests-1.29.3-1.module+el8.8.0+22142+4cbed6b3', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'cockpit-podman-63.1-1.module+el8.8.0+22142+4cbed6b3', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
        {'reference':'conmon-2.1.6-1.module+el8.8.0+22142+4cbed6b3', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
        {'reference':'container-selinux-2.229.0-1.module+el8.8.0+22142+4cbed6b3', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'containernetworking-plugins-1.2.0-1.module+el8.8.0+22142+4cbed6b3', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'containers-common-1-66.module+el8.8.0+22142+4cbed6b3', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'allowmaj':TRUE},
        {'reference':'crit-3.15-4.module+el8.8.0+22142+4cbed6b3', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'criu-3.15-4.module+el8.8.0+22142+4cbed6b3', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'criu-devel-3.15-4.module+el8.8.0+22142+4cbed6b3', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'criu-libs-3.15-4.module+el8.8.0+22142+4cbed6b3', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'crun-1.8.4-2.module+el8.8.0+22142+4cbed6b3', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'fuse-overlayfs-1.11-1.module+el8.8.0+22142+4cbed6b3', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'libslirp-4.4.0-1.module+el8.8.0+22142+4cbed6b3', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'libslirp-devel-4.4.0-1.module+el8.8.0+22142+4cbed6b3', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'netavark-1.5.1-3.module+el8.8.0+22142+4cbed6b3', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'oci-seccomp-bpf-hook-1.2.8-1.module+el8.8.0+22142+4cbed6b3', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'podman-4.4.1-22.module+el8.8.0+22142+4cbed6b3', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
        {'reference':'podman-catatonit-4.4.1-22.module+el8.8.0+22142+4cbed6b3', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
        {'reference':'podman-docker-4.4.1-22.module+el8.8.0+22142+4cbed6b3', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
        {'reference':'podman-gvproxy-4.4.1-22.module+el8.8.0+22142+4cbed6b3', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
        {'reference':'podman-plugins-4.4.1-22.module+el8.8.0+22142+4cbed6b3', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
        {'reference':'podman-remote-4.4.1-22.module+el8.8.0+22142+4cbed6b3', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
        {'reference':'podman-tests-4.4.1-22.module+el8.8.0+22142+4cbed6b3', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
        {'reference':'python3-criu-3.15-4.module+el8.8.0+22142+4cbed6b3', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-podman-4.4.1-1.module+el8.8.0+22142+4cbed6b3', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'runc-1.1.12-1.module+el8.8.0+22142+4cbed6b3', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'skopeo-1.11.2-0.2.module+el8.8.0+22142+4cbed6b3', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'skopeo-tests-1.11.2-0.2.module+el8.8.0+22142+4cbed6b3', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'slirp4netns-1.2.0-3.module+el8.8.0+22142+4cbed6b3', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'toolbox-0.0.99.3-7.module+el8.8.0+22142+4cbed6b3', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'toolbox-tests-0.0.99.3-7.module+el8.8.0+22142+4cbed6b3', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'udica-0.2.6-20.module+el8.8.0+22142+4cbed6b3', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
