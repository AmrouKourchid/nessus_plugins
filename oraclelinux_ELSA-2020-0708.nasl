...
# extracted from Red Hat Security Advisory RHSA-2020:0708 and 
# Oracle Linux Security Advisory ELSA-2020-0708 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : http-parser (ELSA-2020-0708)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2020-0708.html");
...
var pkgs = [
    {'reference':'http-parser-2.8.0-5.el8_1.2', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'http-parser-2.8.0-5.el8_1.2', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'http-parser-2.8.0-5.el8_1.2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
