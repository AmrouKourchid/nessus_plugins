...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : evolution-data-server (EulerOS-SA-2020-2243)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2243
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?22bcdfa8");
...
pkgs = ["evolution-data-server-3.22.7-8.h2.eulerosv2r7",
        "evolution-data-server-devel-3.22.7-8.h2.eulerosv2r7"];
