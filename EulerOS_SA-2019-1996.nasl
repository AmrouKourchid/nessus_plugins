...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : openldap (EulerOS-SA-2019-1996)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1996
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e4fdf353");
...
pkgs = ["openldap-2.4.44-5.h3",
        "openldap-clients-2.4.44-5.h3",
        "openldap-devel-2.4.44-5.h3",
        "openldap-servers-2.4.44-5.h3"];
