...
# extracted from Fedora Security Advisory FEDORA-2024-9ed182a5d3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-9ed182a5d3");

  script_name(english:"Fedora 39 : python-setuptools (2024-9ed182a5d3)");
...
FEDORA-2024-9ed182a5d3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-9ed182a5d3");
...
var pkgs = [
    {'reference':'python-setuptools-67.7.2-8.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
