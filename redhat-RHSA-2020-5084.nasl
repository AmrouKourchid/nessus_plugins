...
# extracted from Red Hat Security Advisory RHSA-2020:5084. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:5084");

  script_name(english:"RHEL 6 : microcode_ctl (RHSA-2020:5084)");
...
referenced in the RHSA-2020:5084 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_5084.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b9516c1f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:5084");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'microcode_ctl-1.17-33.31.el6_10', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'microcode_ctl-1.17-33.31.el6_10', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
    ]
  }
];
