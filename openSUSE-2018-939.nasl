...
# extracted from openSUSE Security Update openSUSE-2018-939.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : phpMyAdmin (openSUSE-2018-939)");
...
Security issues fixed :
  ...
  - CVE-2018-15605: vulnerability in the file import feature
    allowed cross-site scripting via importing a specially
    crafted file (PMASA-2018-5, boo#1105726)

This update also contains a number of upstream bug fixes in the UI and
behavior.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1105726");
...
if ( rpm_check(release:"SUSE15.0", reference:"phpMyAdmin-4.8.3-lp150.2.9.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"phpMyAdmin-4.8.3-21.1") ) flag++;
