...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : squirrelmail (ELSA-2009-0010)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2009-0010.html");
...
var pkgs = [
    {'reference':'squirrelmail-1.4.8-5.0.1.el5_2.2', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
