...
# extracted from Red Hat Security Advisory RHSA-2020:5164.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : thunderbird (RHSA-2020:5164)");
...
var pkgs = [
    {'reference':'thunderbird-78.4.3-1.el6_10', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
