...
# SUSE update advisory SUSE-SU-2019:14236-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2019:14236-1");

  script_name(english:"SUSE SLES11 Security Update : clamav (SUSE-SU-2019:14236-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1157763");
  # https://lists.suse.com/pipermail/sle-security-updates/2019-December/006209.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6f356cb5");
...
"Update the affected clamav package.");
  ...
  script_set_attribute(attribute:"vuln_publication_date", value:"2019/11/24");
...
pkgs = [
    {'reference':'clamav-0.100.3-0.20.29', 'sp':'4', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'SLES_SAP-release-11.4'},
    {'reference':'clamav-0.100.3-0.20.29', 'sp':'4', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'sles-release-11.4'}
];
