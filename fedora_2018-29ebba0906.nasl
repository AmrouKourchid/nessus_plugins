...
# extracted from Fedora Security Advisory FEDORA-2018-29ebba0906.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : wget (2018-29ebba0906)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-29ebba0906");
...
flag = 0;
if (rpm_check(release:"FC27", reference:"wget-1.19.5-1.fc27")) flag++;
