...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5037788");
  script_xref(name:"MSFT", value:"MS24-5037788");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2024/06/04");
  script_xref(name:"IAVA", value:"2024-A-0281-S");

  script_name(english:"KB5037788: Windows 10 LTS 1507 Security Update (May 2024)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5037788. It is, therefore, affected by multiple vulnerabilities
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5037788");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5037788");
