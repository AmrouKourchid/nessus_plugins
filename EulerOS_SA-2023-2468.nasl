...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : shim (EulerOS-SA-2023-2468)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2468
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d8f42962");
...
var pkgs = [
  "shim-15-20.h9.eulerosv2r10",
  "shim-aa64-storage-15-20.h9.eulerosv2r10"
];
