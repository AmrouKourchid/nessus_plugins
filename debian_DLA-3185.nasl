...
# extracted from Debian Security Advisory dla-3185. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3185 : xdmx - security update");
...
dla-3185 advisory.
    ...
    - -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3185-1                debian-lts@lists.debian.org
...
var pkgs = [
    {'release': '10.0', 'prefix': 'xdmx', 'reference': '2:1.20.4-1+deb10u6'},
    {'release': '10.0', 'prefix': 'xdmx-tools', 'reference': '2:1.20.4-1+deb10u6'},
    {'release': '10.0', 'prefix': 'xnest', 'reference': '2:1.20.4-1+deb10u6'},
    {'release': '10.0', 'prefix': 'xorg-server-source', 'reference': '2:1.20.4-1+deb10u6'},
    {'release': '10.0', 'prefix': 'xserver-common', 'reference': '2:1.20.4-1+deb10u6'},
    {'release': '10.0', 'prefix': 'xserver-xephyr', 'reference': '2:1.20.4-1+deb10u6'},
    {'release': '10.0', 'prefix': 'xserver-xorg-core', 'reference': '2:1.20.4-1+deb10u6'},
    {'release': '10.0', 'prefix': 'xserver-xorg-dev', 'reference': '2:1.20.4-1+deb10u6'},
    {'release': '10.0', 'prefix': 'xserver-xorg-legacy', 'reference': '2:1.20.4-1+deb10u6'},
    {'release': '10.0', 'prefix': 'xvfb', 'reference': '2:1.20.4-1+deb10u6'},
    {'release': '10.0', 'prefix': 'xwayland', 'reference': '2:1.20.4-1+deb10u6'}
];
