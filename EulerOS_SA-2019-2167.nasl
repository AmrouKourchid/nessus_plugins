...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : libgxps (EulerOS-SA-2019-2167)");
...
vulnerability :
  ...
  - There is a NULL pointer dereference in the
    caseless_hash function in gxps-archive.c in libgxps
    0.2.5. A crafted input will lead to a remote denial of
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2167
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1a90c475");
...
"Update the affected libgxps package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-11590");
...
pkgs = ["libgxps-0.2.5-1.h2.eulerosv2r7"];
