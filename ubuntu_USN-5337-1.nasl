...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS : Linux kernel vulnerabilities (USN-5337-1)");
...
the USN-5337-1 advisory.
    ...
    It was discovered that a race condition existed in the poll implementation in the Linux kernel, resulting
    in a use-after-free vulnerability. A local attacker could use this to cause a denial of service (system
    crash) or possibly execute arbitrary code. (CVE-2021-39698)
    ...
    It was discovered that the eBPF verifier in the Linux kernel did not properly perform bounds checking on
    mov32 operations. A local attacker could use this to expose sensitive information (kernel pointer
    addresses). (CVE-2021-45402)
...
var kernel_mappings = {
  '20.04': {
    '5.13.0': {
      'generic': '5.13.0-37',
      'generic-64k': '5.13.0-37',
      'generic-lpae': '5.13.0-37',
      'lowlatency': '5.13.0-37',
      'aws': '5.13.0-1019',
      'gcp': '5.13.0-1021'
    }
  }
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-5337-1');
}
