...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : bind on SL6.x i386/x86_64 (20201012)");
...
"Security Fix(es) :
  ...
  - bind: truncated TSIG response can lead to an assertion
    failure (CVE-2020-8622)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind2010&L=SCIENTIFIC-LINUX-ERRATA&P=743
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?85975ea9");
...
flag = 0;
if (rpm_check(release:"SL6", reference:"bind-9.8.2-0.68.rc1.el6_10.8")) flag++;
if (rpm_check(release:"SL6", reference:"bind-chroot-9.8.2-0.68.rc1.el6_10.8")) flag++;
if (rpm_check(release:"SL6", reference:"bind-debuginfo-9.8.2-0.68.rc1.el6_10.8")) flag++;
if (rpm_check(release:"SL6", reference:"bind-devel-9.8.2-0.68.rc1.el6_10.8")) flag++;
if (rpm_check(release:"SL6", reference:"bind-libs-9.8.2-0.68.rc1.el6_10.8")) flag++;
if (rpm_check(release:"SL6", reference:"bind-sdb-9.8.2-0.68.rc1.el6_10.8")) flag++;
if (rpm_check(release:"SL6", reference:"bind-utils-9.8.2-0.68.rc1.el6_10.8")) flag++;
