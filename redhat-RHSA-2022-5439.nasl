...
# extracted from Red Hat Security Advisory RHSA-2022:5439. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:5439");
  script_xref(name:"IAVA", value:"2024-A-0327");

  script_name(english:"RHEL 7 : RHV-H security update (redhat-virtualization-host) 4.3.23 (Important) (RHSA-2022:5439)");
...
referenced in the RHSA-2022:5439 advisory.
    ...
    RHVH features a Cockpit user interface for monitoring the host's resources and performing administrative
    tasks.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2022/rhsa-2022_5439.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?801d3a82");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:5439");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2084444");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2092427");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL RHV-H package based on the guidance in RHSA-2022:5439.");
  ...
  script_cwe_id(119, 416, 787, 1173);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'redhat-virtualization-host-image-update-4.3.23-20220622.0.el7_9', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'}
    ]
  }
];
