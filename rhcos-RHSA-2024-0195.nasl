...
if (description)
{
  ...
  script_name(english:"RHCOS 4 : OpenShift Container Platform 4.13.29 (RHSA-2024:0195)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat CoreOS host is missing a security update for OpenShift Container Platform 4.13.29.");
...
referenced in the RHSA-2024:0195 advisory.
...
"Update the RHCOS OpenShift Container Platform 4.13.29 packages based on the guidance in RHSA-2024:0195.");
...
var pkgs = [
    {'reference':'cri-o-1.26.4-6.1.rhaos4.13.git9eb9cf3.el8', 'release':'4', 'el_string':'el8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
    {'reference':'cri-o-1.26.4-6.1.rhaos4.13.git9eb9cf3.el9', 'release':'4', 'el_string':'el9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
];
