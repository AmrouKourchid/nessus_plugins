...
# extracted from Oracle Linux Security Advisory ELSA-2022-4771.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : postgresql (ELSA-2022-4771)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2022-4771.html");
