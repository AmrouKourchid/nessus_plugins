...
if (description)
{
  ...
  script_name(english:"Oracle MySQL Server 5.7.x < 5.7.42 (Apr 2023 CPU)");
...
"Apply the appropriate patch according to the April 2023 Oracle Critical Patch Update advisory.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-37434");
...
var constraints = [{ 'min_version' : '5.7', 'fixed_version' : '5.7.42'}];
