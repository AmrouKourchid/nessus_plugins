...
# extracted from Fedora Security Advisory FEDORA-2023-50f9eb7aca
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-50f9eb7aca");

  script_name(english:"Fedora 36 : firefox (2023-50f9eb7aca)");
...
FEDORA-2023-50f9eb7aca advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-50f9eb7aca");
...
var pkgs = [
    {'reference':'firefox-112.0-3.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
