...
# SUSE update advisory SUSE-SU-2021:14792-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2021:14792-1");
  script_xref(name:"IAVA", value:"2021-A-0395-S");

  script_name(english:"SUSE SLES11 Security Update : openssl1 (SUSE-SU-2021:14792-1)");
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2021-August/009347.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?83ed6a07");
...
var pkgs = [
    {'reference':'libopenssl1-devel-1.0.1g-0.58.36.2', 'sp':'0', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.3-0']},
    {'reference':'libopenssl1_0_0-1.0.1g-0.58.36.2', 'sp':'0', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.3-0']},
    {'reference':'libopenssl1_0_0-32bit-1.0.1g-0.58.36.2', 'sp':'0', 'cpu':'s390x', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.3-0']},
    {'reference':'libopenssl1_0_0-32bit-1.0.1g-0.58.36.2', 'sp':'0', 'cpu':'x86_64', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.3-0']},
    {'reference':'openssl1-1.0.1g-0.58.36.2', 'sp':'0', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.3-0']},
    {'reference':'openssl1-doc-1.0.1g-0.58.36.2', 'sp':'0', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.3-0']}
];
