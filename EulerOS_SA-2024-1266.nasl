...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : gdb (EulerOS-SA-2024-1266)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1266
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f61a38d6");
...
var pkgs = [
  "gdb-8.2-3.h8.eulerosv2r8",
  "gdb-gdbserver-8.2-3.h8.eulerosv2r8",
  "gdb-headless-8.2-3.h8.eulerosv2r8"
];
