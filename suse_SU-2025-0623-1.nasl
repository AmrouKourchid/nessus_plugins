...
# SUSE update advisory SUSE-SU-2025:0623-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2025:0623-1");

  script_name(english:"SUSE SLES15 / openSUSE 15 Security Update : grafana (SUSE-SU-2025:0623-1)");
...
referenced in the SUSE-SU-2025:0623-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1235206");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1235574");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1236559");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1236734");
  # https://lists.suse.com/pipermail/sle-security-updates/2025-February/020388.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6f43709a");
...
var pkgs = [
    {'reference':'grafana-10.4.15-150200.3.64.1', 'release':'SUSE15.6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.6']},
    {'reference':'grafana-10.4.15-150200.3.64.1', 'sp':'6', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-packagehub-subpackages-release-15.6']}
];
