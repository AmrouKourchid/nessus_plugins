...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS : IBus vulnerability (USN-4134-1)");
...
in the USN-4134-1 advisory.

    Simon McVittie discovered that IBus did not enforce appropriate access controls on its private D-Bus
    socket. A local unprivileged user who discovers the IBus socket address of another user could exploit this
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4134-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'gir1.2-ibus-1.0', 'pkgver': '1.5.11-1ubuntu2.2'},
    {'osver': '16.04', 'pkgname': 'ibus', 'pkgver': '1.5.11-1ubuntu2.2'},
    {'osver': '16.04', 'pkgname': 'ibus-gtk', 'pkgver': '1.5.11-1ubuntu2.2'},
    {'osver': '16.04', 'pkgname': 'ibus-gtk3', 'pkgver': '1.5.11-1ubuntu2.2'},
    {'osver': '16.04', 'pkgname': 'ibus-wayland', 'pkgver': '1.5.11-1ubuntu2.2'},
    {'osver': '16.04', 'pkgname': 'libibus-1.0-5', 'pkgver': '1.5.11-1ubuntu2.2'},
    {'osver': '16.04', 'pkgname': 'libibus-1.0-dev', 'pkgver': '1.5.11-1ubuntu2.2'},
    {'osver': '18.04', 'pkgname': 'gir1.2-ibus-1.0', 'pkgver': '1.5.17-3ubuntu5.1'},
    {'osver': '18.04', 'pkgname': 'ibus', 'pkgver': '1.5.17-3ubuntu5.1'},
    {'osver': '18.04', 'pkgname': 'ibus-gtk', 'pkgver': '1.5.17-3ubuntu5.1'},
    {'osver': '18.04', 'pkgname': 'ibus-gtk3', 'pkgver': '1.5.17-3ubuntu5.1'},
    {'osver': '18.04', 'pkgname': 'ibus-wayland', 'pkgver': '1.5.17-3ubuntu5.1'},
    {'osver': '18.04', 'pkgname': 'libibus-1.0-5', 'pkgver': '1.5.17-3ubuntu5.1'},
    {'osver': '18.04', 'pkgname': 'libibus-1.0-dev', 'pkgver': '1.5.17-3ubuntu5.1'}
];
