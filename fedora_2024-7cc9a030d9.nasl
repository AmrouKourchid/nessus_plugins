...
# extracted from Fedora Security Advisory FEDORA-2024-7cc9a030d9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-7cc9a030d9");

  script_name(english:"Fedora 40 : python-authlib (2024-7cc9a030d9)");
...
FEDORA-2024-7cc9a030d9 advisory.

    Update to v1.3.1 (CVE-2024-37568)

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-7cc9a030d9");
  script_set_attribute(attribute:"solution", value:
"Update the affected python-authlib package.");
...
var pkgs = [
    {'reference':'python-authlib-1.3.1-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python-authlib');
}
