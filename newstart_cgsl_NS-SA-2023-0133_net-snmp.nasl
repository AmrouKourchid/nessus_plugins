...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 6.06 : net-snmp Multiple Vulnerabilities (NS-SA-2023-0133) (deprecated)");
...
"This plugin has been deprecated.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/info/CVE-2022-44792");
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/info/CVE-2022-44793");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:net-snmp-doc");
