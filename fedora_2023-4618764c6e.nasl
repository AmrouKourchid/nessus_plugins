...
# extracted from Fedora Security Advisory FEDORA-2023-4618764c6e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-4618764c6e");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2023/10/04");

  script_name(english:"Fedora 37 : thunderbird (2023-4618764c6e)");
...
FEDORA-2023-4618764c6e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-4618764c6e");
...
var pkgs = [
    {'reference':'thunderbird-102.13.0-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
