...
# extracted from Fedora Security Advisory FEDORA-2024-bb4b6da0b6
#
...
if (description)
{
  ...
  script_cve_id("CVE-2024-43374", "CVE-2024-43802");
  script_xref(name:"IAVA", value:"2024-A-0505-S");
  script_xref(name:"FEDORA", value:"2024-bb4b6da0b6");
  script_xref(name:"IAVA", value:"2024-A-0526-S");

  script_name(english:"Fedora 40 : vim (2024-bb4b6da0b6)");
...
FEDORA-2024-bb4b6da0b6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-bb4b6da0b6");
...
var pkgs = [
    {'reference':'vim-9.1.703-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
