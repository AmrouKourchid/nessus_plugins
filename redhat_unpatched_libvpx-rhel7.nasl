...
# extracted from Red Hat Security Advisory libvpx. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2015-1258", "CVE-2017-0641", "CVE-2017-13194");

  script_name(english:"RHEL 7 : libvpx (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2017-13194");
