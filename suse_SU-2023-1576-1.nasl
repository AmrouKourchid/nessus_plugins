...
# SUSE update advisory SUSE-SU-2023:1576-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:1576-1");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2023/04/20");

  script_name(english:"SUSE SLES15 Security Update : kernel RT (Live Patch 1 for SLE 15 SP4) (SUSE-SU-2023:1576-1)");
...
the SUSE-SU-2023:1576-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-March/014162.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bc4ebef4");
...
var kernel_live_checks = [
  {
    'kernels': {
      '5.14.21-150400.15.5-rt-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_14_21-150400_15_5-rt-4-150400.2.3', 'sp':'4', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.4']}
        ]
      }
    }
  }
