...
if (description)
{
  ...
  script_name(english:"Fortinet Fortigate Improper Inter-VDOM access control (FG-IR-21-147)");
...
vulnerability as referenced in the FG-IR-21-147 advisory.

  - An improper access control vulnerability [CWE-284] in FortiOS versions 6.4.8 and prior and 7.0.3 and prior
    may allow an authenticated attacker with a restricted user profile to gather sensitive information and
    modify the SSL-VPN tunnel status of other VDOMs using specific CLI commands. (CVE-2021-41032)
