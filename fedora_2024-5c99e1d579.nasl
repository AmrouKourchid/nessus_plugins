...
# extracted from Fedora Security Advisory FEDORA-2024-5c99e1d579
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-5c99e1d579");

  script_name(english:"Fedora 40 : p7zip (2024-5c99e1d579)");
...
FEDORA-2024-5c99e1d579 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-5c99e1d579");
...
var pkgs = [
    {'reference':'p7zip-16.02-31.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
