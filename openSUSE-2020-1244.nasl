...
# extracted from openSUSE Security Update openSUSE-2020-1244.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : postgresql12 (openSUSE-2020-1244)");
...
if ( rpm_check(release:"SUSE15.2", reference:"libecpg6-12.4-lp152.3.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libecpg6-debuginfo-12.4-lp152.3.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libpq5-12.4-lp152.3.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libpq5-debuginfo-12.4-lp152.3.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"postgresql12-12.4-lp152.3.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"postgresql12-contrib-12.4-lp152.3.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"postgresql12-contrib-debuginfo-12.4-lp152.3.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"postgresql12-debuginfo-12.4-lp152.3.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"postgresql12-debugsource-12.4-lp152.3.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"postgresql12-devel-12.4-lp152.3.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"postgresql12-devel-debuginfo-12.4-lp152.3.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"postgresql12-llvmjit-12.4-lp152.3.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"postgresql12-llvmjit-debuginfo-12.4-lp152.3.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"postgresql12-plperl-12.4-lp152.3.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"postgresql12-plperl-debuginfo-12.4-lp152.3.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"postgresql12-plpython-12.4-lp152.3.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"postgresql12-plpython-debuginfo-12.4-lp152.3.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"postgresql12-pltcl-12.4-lp152.3.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"postgresql12-pltcl-debuginfo-12.4-lp152.3.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"postgresql12-server-12.4-lp152.3.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"postgresql12-server-debuginfo-12.4-lp152.3.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"postgresql12-server-devel-12.4-lp152.3.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"postgresql12-server-devel-debuginfo-12.4-lp152.3.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"postgresql12-test-12.4-lp152.3.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"libecpg6-32bit-12.4-lp152.3.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"libecpg6-32bit-debuginfo-12.4-lp152.3.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"libpq5-32bit-12.4-lp152.3.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"libpq5-32bit-debuginfo-12.4-lp152.3.7.1") ) flag++;
