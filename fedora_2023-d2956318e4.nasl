...
# extracted from Fedora Security Advisory FEDORA-2023-d2956318e4
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-d2956318e4");

  script_name(english:"Fedora 39 : python-asyncssh (2023-d2956318e4)");
...
FEDORA-2023-d2956318e4 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-d2956318e4");
...
var pkgs = [
    {'reference':'python-asyncssh-2.14.1-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
