...
# extracted from VMware Security Advisory PHSA-2022-4.0-0236. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Zlib PHSA-2022-4.0-0236");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the zlib package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-236.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'zlib-1.2.11-4.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'zlib-devel-1.2.11-4.ph4')) flag++;
