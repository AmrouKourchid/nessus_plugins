...
# extracted from Fedora Security Advisory FEDORA-2022-59cb9da3d4
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-59cb9da3d4");

  script_name(english:"Fedora 38 : golang-github-docker-distribution (2022-59cb9da3d4)");
...
FEDORA-2022-59cb9da3d4 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-59cb9da3d4");
...
var pkgs = [
    {'reference':'golang-github-docker-distribution-2.8.1-2.20220821gitbc6b745.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
