...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2018/rhsa-2018_3347.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f656ac2e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:3347");
...
"Update the RHEL python-paramiko package based on the guidance in RHSA-2018:3347.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python-paramiko-2.1.1-9.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python-paramiko-doc-2.1.1-9.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
