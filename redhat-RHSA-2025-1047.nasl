...
# extracted from Red Hat Security Advisory RHSA-2025:1047. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:1047");

  script_name(english:"RHEL 7 : libsoup (RHSA-2025:1047)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for libsoup.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2025:1047 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_1047.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9b33116d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:1047");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libsoup package based on the guidance in RHSA-2025:1047.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libsoup-2.62.2-4.el7_9', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsoup-2.62.2-4.el7_9', 'cpu':'ppc', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsoup-2.62.2-4.el7_9', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsoup-2.62.2-4.el7_9', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsoup-2.62.2-4.el7_9', 'cpu':'s390', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsoup-2.62.2-4.el7_9', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsoup-2.62.2-4.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsoup-devel-2.62.2-4.el7_9', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsoup-devel-2.62.2-4.el7_9', 'cpu':'ppc', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsoup-devel-2.62.2-4.el7_9', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsoup-devel-2.62.2-4.el7_9', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsoup-devel-2.62.2-4.el7_9', 'cpu':'s390', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsoup-devel-2.62.2-4.el7_9', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsoup-devel-2.62.2-4.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
