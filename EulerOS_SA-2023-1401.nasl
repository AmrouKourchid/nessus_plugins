...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : sysstat (EulerOS-SA-2023-1401)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1401
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3a45a3d5");
...
var pkgs = [
  "sysstat-12.2.1-1.h2.eulerosv2r10"
];
