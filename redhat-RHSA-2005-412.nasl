...
if (description)
{
  ...
  script_name(english:"RHEL 4 : openmotif (RHSA-2005:412)");
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2005/rhsa-2005_412.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6dd63a02");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=151641");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2005:412");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL openmotif package based on the guidance in RHSA-2005:412.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openmotif-2.2.3-9.RHEL4.1', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openmotif-2.2.3-9.RHEL4.1', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openmotif-2.2.3-9.RHEL4.1', 'cpu':'ppc64', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openmotif-2.2.3-9.RHEL4.1', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openmotif-2.2.3-9.RHEL4.1', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openmotif-2.2.3-9.RHEL4.1', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openmotif-devel-2.2.3-9.RHEL4.1', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openmotif-devel-2.2.3-9.RHEL4.1', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openmotif-devel-2.2.3-9.RHEL4.1', 'cpu':'ppc64', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openmotif-devel-2.2.3-9.RHEL4.1', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openmotif-devel-2.2.3-9.RHEL4.1', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openmotif-devel-2.2.3-9.RHEL4.1', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openmotif21-2.1.30-11.RHEL4.4', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
