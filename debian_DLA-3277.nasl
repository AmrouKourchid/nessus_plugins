...
# extracted from Debian Security Advisory dla-3277. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3277 : powerline-gitstatus - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3277
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?356d7b2f");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-42906");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/powerline-gitstatus");
  script_set_attribute(attribute:"solution", value:
"Upgrade the powerline-gitstatus packages.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:N/UI:R/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-42906");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:powerline-gitstatus");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:python3-powerline-gitstatus");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'powerline-gitstatus', 'reference': '1.3.2-0+deb10u1'},
    {'release': '10.0', 'prefix': 'python3-powerline-gitstatus', 'reference': '1.3.2-0+deb10u1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'powerline-gitstatus / python3-powerline-gitstatus');
}
