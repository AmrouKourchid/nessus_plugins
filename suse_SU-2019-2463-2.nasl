...
# extracted from SUSE update advisory SUSE-SU-2019:2463-2.
...
if (description)
{
  ...
  script_name(english:"SUSE SLED15 / SLES15 Security Update : SDL2 (SUSE-SU-2019:2463-2)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=1142031");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2019-13616/");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2019-13626/");
  # https://www.suse.com/support/update/announcement/2019/suse-su-20192463-2
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e11fae51");
...
zypper in -t patch
SUSE-SLE-Module-Packagehub-Subpackages-15-SP1-2020-1866=1");
...
flag = 0;
if (rpm_check(release:"SLES15", sp:"1", cpu:"x86_64", reference:"SDL2-debugsource-2.0.8-3.15.1")) flag++;
...
if (rpm_check(release:"SLED15", sp:"1", cpu:"x86_64", reference:"SDL2-debugsource-2.0.8-3.15.1")) flag++;
