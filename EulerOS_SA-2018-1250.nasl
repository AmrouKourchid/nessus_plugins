...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.0 : dhcp (EulerOS-SA-2018-1250)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1250
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ce7dc039");
...
pkgs = ["dhcp-4.2.5-36.h5",
        "dhcp-common-4.2.5-36.h5",
        "dhcp-libs-4.2.5-36.h5"];
