...
"The remote Red Hat host is missing one or more security updates for logrotate.");
...
referenced in the RHSA-2011:0407 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2011/rhsa-2011_0407.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?566ca3ad");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=680796");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=680797");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=680798");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2011:0407");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL logrotate package based on the guidance in RHSA-2011:0407.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'logrotate-3.7.8-12.el6_0.1', 'cpu':'i686', 'release':'6', 'el_string':'el6_0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'logrotate-3.7.8-12.el6_0.1', 'cpu':'ppc64', 'release':'6', 'el_string':'el6_0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'logrotate-3.7.8-12.el6_0.1', 'cpu':'s390x', 'release':'6', 'el_string':'el6_0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'logrotate-3.7.8-12.el6_0.1', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_0', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
