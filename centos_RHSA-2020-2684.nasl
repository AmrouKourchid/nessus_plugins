...
# extracted from Red Hat Security Advisory RHSA-2020:2684.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : containernetworking-plugins (RHSA-2020:2684)");
...
var pkgs = [
    {'reference':'containernetworking-plugins-0.8.3-3.el7.centos', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'containernetworking-plugins-0.8.3-3.el7.centos', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE}
];
