...
# SUSE update advisory SUSE-SU-2022:0504-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:0504-1");

  script_name(english:"SUSE SLES12 Security Update : wpa_supplicant (SUSE-SU-2022:0504-1)");
...
referenced in the SUSE-SU-2022:0504-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-February/010266.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?27246bb3");
...
var pkgs = [
    {'reference':'wpa_supplicant-2.9-23.15.1', 'sp':'5', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5']},
    {'reference':'wpa_supplicant-2.9-23.15.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.5']}
];
