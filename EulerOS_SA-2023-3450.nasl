...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : python-pip (EulerOS-SA-2023-3450)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3450
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0cba60ae");
...
var pkgs = [
  "python-pip-wheel-18.0-4.h10.eulerosv2r8",
  "python2-pip-18.0-4.h10.eulerosv2r8",
  "python3-pip-18.0-4.h10.eulerosv2r8"
];
