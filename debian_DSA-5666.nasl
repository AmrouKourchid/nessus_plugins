...
# extracted from Debian Security Advisory dsa-5666. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5666 : flatpak - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 / 12 host has packages installed that are affected by a vulnerability as referenced in the dsa-5666
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-32462");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'flatpak', 'reference': '1.10.8-0+deb11u2'},
    {'release': '11.0', 'prefix': 'flatpak-tests', 'reference': '1.10.8-0+deb11u2'},
    {'release': '11.0', 'prefix': 'gir1.2-flatpak-1.0', 'reference': '1.10.8-0+deb11u2'},
    {'release': '11.0', 'prefix': 'libflatpak-dev', 'reference': '1.10.8-0+deb11u2'},
    {'release': '11.0', 'prefix': 'libflatpak-doc', 'reference': '1.10.8-0+deb11u2'},
    {'release': '11.0', 'prefix': 'libflatpak0', 'reference': '1.10.8-0+deb11u2'},
    {'release': '12.0', 'prefix': 'flatpak', 'reference': '1.14.4-1+deb12u1'},
    {'release': '12.0', 'prefix': 'flatpak-tests', 'reference': '1.14.4-1+deb12u1'},
    {'release': '12.0', 'prefix': 'gir1.2-flatpak-1.0', 'reference': '1.14.4-1+deb12u1'},
    {'release': '12.0', 'prefix': 'libflatpak-dev', 'reference': '1.14.4-1+deb12u1'},
    {'release': '12.0', 'prefix': 'libflatpak-doc', 'reference': '1.14.4-1+deb12u1'},
    {'release': '12.0', 'prefix': 'libflatpak0', 'reference': '1.14.4-1+deb12u1'}
];
