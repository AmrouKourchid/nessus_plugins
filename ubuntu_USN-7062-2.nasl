...
# extracted from Ubuntu Security Notice USN-7062-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"7062-2");

  script_name(english:"Ubuntu 24.10 : libgsf vulnerabilities (USN-7062-2)");
...
USN-7062-2 advisory.
    ...
    USN-7062-1 fixed vulnerabilities in libgsf. This update provides the corresponding updates for Ubuntu
    24.10.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7062-2");
...
var pkgs = [
    {'osver': '24.10', 'pkgname': 'gir1.2-gsf-1', 'pkgver': '1.14.52-1ubuntu0.1'},
    {'osver': '24.10', 'pkgname': 'libgsf-1-114', 'pkgver': '1.14.52-1ubuntu0.1'},
    {'osver': '24.10', 'pkgname': 'libgsf-1-common', 'pkgver': '1.14.52-1ubuntu0.1'},
    {'osver': '24.10', 'pkgname': 'libgsf-1-dev', 'pkgver': '1.14.52-1ubuntu0.1'},
    {'osver': '24.10', 'pkgname': 'libgsf-bin', 'pkgver': '1.14.52-1ubuntu0.1'}
];
