...
# extracted from Fedora Security Advisory FEDORA-2023-41f41fbb69
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-41f41fbb69");

  script_name(english:"Fedora 38 : unrealircd (2023-41f41fbb69)");
...
FEDORA-2023-41f41fbb69 advisory.
    ...
    [Websockets](https://www.unrealircd.org/docs/WebSocket_support) are in use (a listen block with
    `listen::options::websocket`). This was assigned CVE-2023-50784.
      * In 6.1.3, [Websockets](https://www.unrealircd.org/docs/WebSocket_support) were not working with Chrome
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-41f41fbb69");
...
"Update the affected unrealircd package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-50784");
...
var pkgs = [
    {'reference':'unrealircd-6.1.4-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
