...
# extracted from openSUSE Security Update openSUSE-2020-1320.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : opera (openSUSE-2020-1320)");
...
if ( rpm_check(release:"SUSE15.1", reference:"opera-70.0.3728.133-lp151.2.27.1") ) flag++;
