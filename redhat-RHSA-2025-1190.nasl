...
# extracted from Red Hat Security Advisory RHSA-2025:1190. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:1190");

  script_name(english:"RHEL 9 : Red Hat OpenStack Platform 17.1 (etcd) (RHSA-2025:1190)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for Red Hat OpenStack Platform 17.1 (etcd).");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_1190.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ba1f7773");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:1190");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat OpenStack Platform 17.1 (etcd) package based on the guidance in RHSA-2025:1190.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'etcd-3.4.26-9.1.el9ost', 'cpu':'x86_64', 'release':'9', 'el_string':'el9ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
