...
# extracted from Amazon Linux 2 Security Advisory ALASKERNEL-5.10-2024-076.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : kernel (ALASKERNEL-5.10-2024-076)");
...
vulnerabilities as referenced in the ALAS2KERNEL-5.10-2024-076 advisory.
    ...
    2025-01-21: CVE-2024-26736 was added to this advisory.

    2025-01-21: CVE-2024-26753 was added to this advisory.
    ...
    2025-01-21: CVE-2024-26848 was added to this advisory.

    2025-01-21: CVE-2024-26601 was added to this advisory.

    2025-01-21: CVE-2024-26752 was added to this advisory.
    ...
    2025-01-21: CVE-2024-26787 was added to this advisory.
    ...
    2025-01-21: CVE-2024-26833 was added to this advisory.

    2025-01-21: CVE-2024-26744 was added to this advisory.

    2025-01-21: CVE-2024-26751 was added to this advisory.

    2025-01-21: CVE-2024-26845 was added to this advisory.

    2025-01-21: CVE-2024-26743 was added to this advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALASKERNEL-5.10-2024-076.html");
...
if (get_one_kb_item("Host/kpatch/kernel-cves"))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, "kpatch hotfix for ALASKERNEL-5.10-2024-076");
  }
  else
  {
