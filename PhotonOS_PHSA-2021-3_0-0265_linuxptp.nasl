...
# extracted from VMware Security Advisory PHSA-2021-3.0-0265. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Linuxptp PHSA-2021-3.0-0265");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the linuxptp package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-3.0-265.md");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:vmware:photonos:linuxptp");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'linuxptp-3.1-3.ph3')) flag++;
