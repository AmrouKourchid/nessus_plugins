...
if (description)
{
  ...
  script_name(english:"PHP 7.4.x < 7.4.26");

  script_set_attribute(attribute:"synopsis", value:
"The version PHP running on the remote web server is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of PHP installed on the remote host is prior to 7.4.26. It is, therefore, affected by a vulnerability as
referenced in the Version 7.4.26 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://php.net/ChangeLog-7.php#7.4.26");
  script_set_attribute(attribute:"solution", value:
"Upgrade to PHP version 7.4.26 or later.");
...
var constraints = [
  { 'min_version' : '7.4.0alpha1', 'fixed_version' : '7.4.26' }
];
