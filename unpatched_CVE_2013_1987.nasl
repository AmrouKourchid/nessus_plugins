...
if (description)
{
  ...
  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2013-1987");
...
patch available.
  ...
  - Multiple integer overflows in X.org libXrender 0.9.7 and earlier allow X servers to trigger allocation of
    ...
    XRenderQueryFormats, and (3) XRenderQueryPictIndexValues functions. (CVE-2013-1987)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-1987");
