...
# extracted from Fedora Security Advisory FEDORA-2023-b245e992ea
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-b245e992ea");

  script_name(english:"Fedora 38 : python3.6 (2023-b245e992ea)");
...
FEDORA-2023-b245e992ea advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-b245e992ea");
...
var pkgs = [
    {'reference':'python3.6-3.6.15-22.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
