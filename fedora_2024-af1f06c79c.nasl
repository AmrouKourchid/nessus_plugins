...
# extracted from Fedora Security Advisory FEDORA-2024-af1f06c79c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-af1f06c79c");

  script_name(english:"Fedora 39 : glances (2024-af1f06c79c)");
...
FEDORA-2024-af1f06c79c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-af1f06c79c");
...
var pkgs = [
    {'reference':'glances-4.0.5-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
