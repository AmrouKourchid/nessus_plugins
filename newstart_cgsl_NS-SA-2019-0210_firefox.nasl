...
# extracted from ZTE advisory NS-SA-2019-0210. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 4.06 : firefox Multiple Vulnerabilities (NS-SA-2019-0210)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/notice/NS-SA-2019-0210");
...
pkgs = {
  "CGSL MAIN 4.06": [
    "firefox-60.9.0-1.el6.centos",
    "firefox-debuginfo-60.9.0-1.el6.centos"
  ]
};
