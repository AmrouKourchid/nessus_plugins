...
# extracted from F5 Networks BIG-IP Solution K93144355.
#
# @NOAGENT@
##
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : Vim/Neovim vulnerability (K93144355)");

  script_set_attribute(attribute:"synopsis", value:
"The remote device is missing a vendor-supplied security patch.");
  script_set_attribute(attribute:"description", value:
"The version of F5 Networks BIG-IP installed on the remote host is prior to tested version. It is, therefore, affected by
a vulnerability as referenced in the K93144355 advisory.
    ...
    nvim_input in Neovim.(CVE-2019-12735)ImpactThis vulnerability allows a remote attacker to run arbitrary
    commands.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K93144355");
...
var vmatrix = {
  'AFM': {
    'affected': [
      '17.0.0-17.1.1','16.0.0-16.1.4','15.1.0-15.1.10','14.0.0-14.1.5','13.1.0-13.1.5','12.1.0-12.1.6','11.5.2-11.6.5'
    ],
  },
  'AM': {
    'affected': [
