...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5049983");
  script_xref(name:"MSFT", value:"MS25-5049983");
  script_xref(name:"IAVA", value:"2025-A-0034-S");
  script_xref(name:"IAVA", value:"2025-A-0033-S");

  script_name(english:"KB5049983: Windows Server 2022 / Azure Stack HCI 22H2 Security Update (January 2025)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5049983. It is, therefore, affected by multiple vulnerabilities
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5049983");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5049983");
