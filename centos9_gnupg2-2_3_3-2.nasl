...
if (description)
{
  ...
  script_name(english:"CentOS 9 : gnupg2-2.3.3-2.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update for gnupg2.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 9 host has packages installed that are affected by a vulnerability as referenced in the
gnupg2-2.3.3-2.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=24191");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream gnupg2 package.");
...
var pkgs = [
    {'reference':'gnupg2-2.3.3-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'gnupg2-smime-2.3.3-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
