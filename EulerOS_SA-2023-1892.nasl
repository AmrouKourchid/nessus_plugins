...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : libX11 (EulerOS-SA-2023-1892)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the libX11 package installed, the EulerOS Virtualization installation on the remote host is
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1892
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?63e312e9");
...
var pkgs = [
  "libX11-1.6.9-4.h3.eulerosv2r10"
];
