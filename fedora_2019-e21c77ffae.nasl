...
# extracted from Fedora Security Advisory FEDORA-2019-e21c77ffae.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : libxslt (2019-e21c77ffae)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-e21c77ffae");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"libxslt-1.1.33-1.fc30")) flag++;
