...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Gzip PHSA-2022-3.0-0382");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the gzip package has been released.");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:vmware:photonos:gzip");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'gzip-1.12-1.ph3')) flag++;
