...
# extracted from openSUSE Security Update openSUSE-2018-667.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : redis (openSUSE-2018-667)");
...
- https://raw.githubusercontent.com/antirez/redis/4.0.7/00-RELEASENOTES");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1097430");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1097768");
  script_set_attribute(attribute:"see_also", value:"https://raw.githubusercontent.com/antirez/redis/4.0.7/00-RELEASENOTES");
  script_set_attribute(attribute:"see_also", value:"https://raw.githubusercontent.com/antirez/redis/4.0.8/00-RELEASENOTES");
  script_set_attribute(attribute:"see_also", value:"https://raw.githubusercontent.com/antirez/redis/4.0.9/00-RELEASENOTES");
...
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"redis-4.0.10-lp150.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"redis-debuginfo-4.0.10-lp150.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"redis-debugsource-4.0.10-lp150.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"redis-4.0.10-17.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"redis-debuginfo-4.0.10-17.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"redis-debugsource-4.0.10-17.1") ) flag++;
