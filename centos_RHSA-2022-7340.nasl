...
# extracted from Red Hat Security Advisory RHSA-2022:7340.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : php-pear (RHSA-2022:7340)");
...
var pkgs = [
    {'reference':'php-pear-1.9.4-23.el7_9', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE}
];
