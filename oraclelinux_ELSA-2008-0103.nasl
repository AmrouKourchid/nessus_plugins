...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : Critical: / firefox (ELSA-2008-0103)");
...
ELSA-2008-0103 advisory.
    ...
    [1.5.0.12-9.0.1]
     ...
     - Added a patch with backported fixes from 1.8.1.12

Tenable has extracted the preceding description block directly from the Oracle Linux security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2008-0103.html");
...
"Update the affected firefox and / or firefox-devel packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2008-0420");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2008-0416");
...
var pkgs = [
    {'reference':'firefox-1.5.0.12-9.el5.0.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-devel-1.5.0.12-9.el5.0.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-1.5.0.12-9.el5.0.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-devel-1.5.0.12-9.el5.0.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
