...
# extracted from Fedora Security Advisory FEDORA-2024-162a4dfe4f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-162a4dfe4f");

  script_name(english:"Fedora 40 : chromium (2024-162a4dfe4f)");
...
FEDORA-2024-162a4dfe4f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-162a4dfe4f");
...
var pkgs = [
    {'reference':'chromium-131.0.6778.139-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
