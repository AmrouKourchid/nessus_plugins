...
# extracted from Fedora Security Advisory FEDORA-2024-a94430d221
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-a94430d221");

  script_name(english:"Fedora 41 : curl (2024-a94430d221)");
...
FEDORA-2024-a94430d221 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-a94430d221");
...
var pkgs = [
    {'reference':'curl-8.9.1-3.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
