...
# extracted from Red Hat Security Advisory RHSA-2024:8352. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:8352");

  script_name(english:"RHEL 9 : NetworkManager-libreswan:1.2.14 (RHSA-2024:8352)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for NetworkManager-libreswan:1.2.14.");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_8352.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?460f17f7");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:8352");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL NetworkManager-libreswan:1.2.14 package based on the guidance in RHSA-2024:8352.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'NetworkManager-libreswan-1.2.14-6.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'NetworkManager-libreswan-gnome-1.2.14-6.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
