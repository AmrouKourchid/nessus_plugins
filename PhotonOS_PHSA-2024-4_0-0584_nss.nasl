...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Nss PHSA-2024-4.0-0584");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'nss-3.72-5.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'nss-devel-3.72-5.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'nss-libs-3.72-5.ph4')) flag++;
