...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : openldap (EulerOS-SA-2021-1337)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1337
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0440fac9");
...
pkgs = ["openldap-2.4.44-5.h6",
        "openldap-clients-2.4.44-5.h6",
        "openldap-devel-2.4.44-5.h6",
        "openldap-servers-2.4.44-5.h6"];
