...
# extracted from Red Hat Security Advisory RHSA-2024:4858. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:4858");

  script_name(english:"RHEL 8 / 9 : OpenShift Container Platform 4.16.5 (RHSA-2024:4858)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for OpenShift Container Platform 4.16.5.");
...
referenced in the RHSA-2024:4858 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.16.5. See the following
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_4858.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?831c6755");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:4858");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.16.5 packages based on the guidance in RHSA-2024:4858.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'podman-4.9.4-8.rhaos4.16.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4', 'exists_check':'openshift-hyperkube'},
      {'reference':'podman-catatonit-4.9.4-8.rhaos4.16.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4', 'exists_check':'openshift-hyperkube'},
      {'reference':'podman-docker-4.9.4-8.rhaos4.16.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4', 'exists_check':'openshift-hyperkube'},
      {'reference':'podman-gvproxy-4.9.4-8.rhaos4.16.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4', 'exists_check':'openshift-hyperkube'},
      {'reference':'podman-plugins-4.9.4-8.rhaos4.16.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4', 'exists_check':'openshift-hyperkube'},
      {'reference':'podman-remote-4.9.4-8.rhaos4.16.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4', 'exists_check':'openshift-hyperkube'},
      {'reference':'podman-tests-4.9.4-8.rhaos4.16.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4', 'exists_check':'openshift-hyperkube'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'podman-4.9.4-9.rhaos4.16.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4', 'exists_check':'openshift-hyperkube'},
      {'reference':'podman-docker-4.9.4-9.rhaos4.16.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4', 'exists_check':'openshift-hyperkube'},
      {'reference':'podman-plugins-4.9.4-9.rhaos4.16.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4', 'exists_check':'openshift-hyperkube'},
      {'reference':'podman-remote-4.9.4-9.rhaos4.16.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4', 'exists_check':'openshift-hyperkube'},
      {'reference':'podman-tests-4.9.4-9.rhaos4.16.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4', 'exists_check':'openshift-hyperkube'}
    ]
  }
];
