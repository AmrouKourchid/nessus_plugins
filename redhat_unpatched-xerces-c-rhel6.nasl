...
# extracted from Red Hat Security Advisory xerces-c. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2016-2099", "CVE-2016-4463", "CVE-2023-37536");

  script_name(english:"RHEL 6 : xerces-c (Unpatched Vulnerability) (deprecated)");
