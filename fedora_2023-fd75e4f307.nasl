...
# extracted from Fedora Security Advisory FEDORA-2023-fd75e4f307
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-fd75e4f307");

  script_name(english:"Fedora 39 : redis (2023-fd75e4f307)");
...
FEDORA-2023-fd75e4f307 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-fd75e4f307");
...
var pkgs = [
    {'reference':'redis-7.2.2-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
