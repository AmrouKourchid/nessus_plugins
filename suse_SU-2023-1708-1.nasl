...
# SUSE update advisory SUSE-SU-2023:1708-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:1708-1");

  script_name(english:"SUSE SLES15 Security Update : kernel (Live Patch 7 for SLE 15 SP4) (SUSE-SU-2023:1708-1)");
...
the SUSE-SU-2023:1708-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://lists.suse.com/pipermail/sle-updates/2023-March/028530.html");
...
"Update the affected kernel-livepatch-5_14_21-150400_24_41-default package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:suse_linux:kernel-livepatch-5_14_21-150400_24_41-default");
...
var kernel_live_checks = [
  {
    'kernels': {
      '5.14.21-150400.24.41-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_14_21-150400_24_41-default-3-150400.2.3', 'sp':'4', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.4']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kernel-livepatch-5_14_21-150400_24_41-default');
}
