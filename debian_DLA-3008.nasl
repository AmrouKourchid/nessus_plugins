...
# extracted from Debian Security Advisory dla-3008. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-3008-1 : openssl - LTS security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 9 host has packages installed that are affected by a vulnerability as referenced in the dla-3008
advisory.

    The c_rehash script does not properly sanitise shell metacharacters to prevent command injection. This
    script is executed by update-ca-certificates, from ca-certificates, to re-hash certificates in
    /etc/ssl/certs/. An attacker able to place files in this directory could execute arbitrary commands with
    the privileges of the script. For Debian 9 stretch, this problem has been fixed in version
    1.1.0l-1~deb9u6. We recommend that you upgrade your openssl packages. For the detailed security status of
    openssl please refer to its security tracker page at: https://security-tracker.debian.org/tracker/openssl
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2022/dla-3008");
...
For Debian 9 stretch, this problem has been fixed in version 1.1.0l-1~deb9u6.");
  ...
  script_set_attribute(attribute:"plugin_publication_date", value:"2022/05/15");
...
var pkgs = [
    {'release': '9.0', 'prefix': 'libssl-dev', 'reference': '1.1.0l-1~deb9u6'},
    {'release': '9.0', 'prefix': 'libssl-doc', 'reference': '1.1.0l-1~deb9u6'},
    {'release': '9.0', 'prefix': 'libssl1.1', 'reference': '1.1.0l-1~deb9u6'},
    {'release': '9.0', 'prefix': 'openssl', 'reference': '1.1.0l-1~deb9u6'}
];
