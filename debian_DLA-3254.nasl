...
# extracted from Debian Security Advisory dla-3254. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3254 : exuberant-ctags - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has a package installed that is affected by a vulnerability as referenced in the dla-3254
advisory.

    - -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3254-1                debian-lts@lists.debian.org
...
number.");
  # https://security-tracker.debian.org/tracker/source-package/exuberant-ctags
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d0463bba");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-4515");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/exuberant-ctags");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'exuberant-ctags', 'reference': '1:5.9~svn20110310-12+deb10u1'}
];
