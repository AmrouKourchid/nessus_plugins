...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Syslog PHSA-2023-4.0-0494");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'syslog-ng-4.3.1-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'syslog-ng-devel-4.3.1-1.ph4')) flag++;
