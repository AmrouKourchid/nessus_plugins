...
# extracted from Red Hat Security Advisory RHSA-2025:2997. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:2997");

  script_name(english:"RHEL 9 : webkit2gtk3 (RHSA-2025:2997)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_2997.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?274cb00a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:2997");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL webkit2gtk3 package based on the guidance in RHSA-2025:2997.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'webkit2gtk3-2.46.6-2.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'webkit2gtk3-devel-2.46.6-2.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'webkit2gtk3-jsc-2.46.6-2.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'webkit2gtk3-jsc-devel-2.46.6-2.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
