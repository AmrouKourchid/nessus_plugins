...
# extracted from Ubuntu Security Notice USN-3721-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : Apache Ant vulnerability (USN-3721-1)");
...
USN-3721-1 advisory.
    ...
    Danny Grander discovered that Apache Ant incorrectly handled certain compressed files. If a user or
    automated system were tricked into processing a specially crafted file, a remote attacker could use this
    issue to overwrite arbitrary files.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3721-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'ant', 'pkgver': '1.9.3-2ubuntu0.1'},
    {'osver': '14.04', 'pkgname': 'ant-gcj', 'pkgver': '1.9.3-2ubuntu0.1'},
    {'osver': '14.04', 'pkgname': 'ant-optional', 'pkgver': '1.9.3-2ubuntu0.1'},
    {'osver': '14.04', 'pkgname': 'ant-optional-gcj', 'pkgver': '1.9.3-2ubuntu0.1'}
];
