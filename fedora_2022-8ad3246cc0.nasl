...
# extracted from Fedora Security Advisory FEDORA-2022-8ad3246cc0
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-8ad3246cc0");

  script_name(english:"Fedora 36 : keylime (2022-8ad3246cc0)");
...
FEDORA-2022-8ad3246cc0 advisory.

    Security fix for CVE-2022-3500
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-8ad3246cc0");
  script_set_attribute(attribute:"solution", value:
"Update the affected keylime package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:keylime");
...
var pkgs = [
    {'reference':'keylime-6.4.3-2.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'keylime');
}
