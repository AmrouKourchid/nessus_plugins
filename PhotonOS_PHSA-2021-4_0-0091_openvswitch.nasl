...
# extracted from VMware Security Advisory PHSA-2021-4.0-0091. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Openvswitch PHSA-2021-4.0-0091");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the openvswitch package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-91.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'openvswitch-2.14.0-6.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'openvswitch-devel-2.14.0-6.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'openvswitch-devel-static-2.14.0-6.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'openvswitch-doc-2.14.0-6.ph4')) flag++;
