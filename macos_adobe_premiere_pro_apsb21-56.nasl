...
if (description)
{
  ...
  script_name(english:"Adobe Premiere Pro < 15.4 Arbitrary Code Execution (APSB21-56) (macOS)");
...
"The version of Adobe Premiere Pro installed on the remote macOS host is prior to 15.4. It is, therefore, affected by a
