...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5002643");
  script_xref(name:"MSFT", value:"MS24-5002643");
  script_xref(name:"IAVA", value:"2024-A-0633-S");

  script_name(english:"Security Updates for Microsoft Excel Products (October 2024)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002643");
...
var constraints = [
  { 'kb':'5002643', 'channel':'MSI', 'fixed_version': '16.0.5469.1000', 'sp' : 0}
];
