...
# extracted from Gentoo Linux Security Advisory GLSA 202401-20.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202401-20 : QPDF: Buffer Overflow");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202401-20 (QPDF: Buffer Overflow)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202401-20");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=803110");
...
"All QPDF users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:qpdf");
...
var packages = [
  {
    'name' : 'app-text/qpdf',
    'unaffected' : make_list("ge 10.1.0"),
    'vulnerable' : make_list("lt 10.1.0")
  }
];
