...
# extracted from Red Hat Security Advisory RHSA-2025:4609. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:4609");

  script_name(english:"RHEL 8 : libsoup (RHSA-2025:4609)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for libsoup.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2025:4609 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_4609.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9bb99bad");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:4609");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libsoup package based on the guidance in RHSA-2025:4609.");
  ...
  script_cwe_id(125, 401, 476, 497, 590);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libsoup-2.62.3-2.el8_4.4', 'sp':'4', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsoup-2.62.3-2.el8_4.4', 'sp':'4', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsoup-2.62.3-2.el8_4.4', 'sp':'4', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsoup-devel-2.62.3-2.el8_4.4', 'sp':'4', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsoup-devel-2.62.3-2.el8_4.4', 'sp':'4', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsoup-devel-2.62.3-2.el8_4.4', 'sp':'4', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
