...
# extracted from Ubuntu Security Notice USN-6534-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6534-2");

  script_name(english:"Ubuntu 23.04 : Linux kernel vulnerabilities (USN-6534-2)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6534-2");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-6.2.0-1018-kvm");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-6.2.0-1020-gcp");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-6534-2');
}
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-6534-2');
  }
  else
  {
