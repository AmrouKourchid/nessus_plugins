...
# extracted from Fedora Security Advisory FEDORA-2023-0ab503de3d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-0ab503de3d");

  script_name(english:"Fedora 38 : moodle (2023-0ab503de3d)");
...
FEDORA-2023-0ab503de3d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-0ab503de3d");
...
var pkgs = [
    {'reference':'moodle-4.1.3-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
