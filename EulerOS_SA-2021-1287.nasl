...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : curl (EulerOS-SA-2021-1287)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1287
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8b60e852");
...
pkgs = ["curl-7.29.0-35.h37",
        "libcurl-7.29.0-35.h37",
        "libcurl-devel-7.29.0-35.h37"];
