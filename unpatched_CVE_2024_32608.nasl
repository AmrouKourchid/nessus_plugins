...
if (description)
{
  ...
  script_cve_id("CVE-2024-32608");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-32608");
...
patch available.
  ...
  - HDF5 library through 1.14.3 has memory corruption in H5A__close resulting in the corruption of the
    instruction pointer and causing denial of service or potential code execution. (CVE-2024-32608)
