...
# SUSE update advisory SUSE-SU-2023:0451-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:0451-1");

  script_name(english:"SUSE SLES15 Security Update : postgresql-jdbc (SUSE-SU-2023:0451-1)");
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-February/013837.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?eab7b15a");
...
var pkgs = [
    {'reference':'postgresql-jdbc-42.2.25-150300.3.11.2', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_RT-release-15.3']}
];
