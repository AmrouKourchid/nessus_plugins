...
# extracted from Red Hat Security Advisory RHSA-2019:3706. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:3706");

  script_name(english:"RHEL 8 : lua (RHSA-2019:3706)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for lua.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2019:3706 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_3706.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cea74fd2");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:3706");
...
"Update the RHEL lua package based on the guidance in RHSA-2019:3706.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'lua-5.3.4-11.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'lua-devel-5.3.4-11.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'lua-libs-5.3.4-11.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
