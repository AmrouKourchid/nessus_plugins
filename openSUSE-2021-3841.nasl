...
# openSUSE Security Update openSUSE-SU-2021:3841-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : python-Pygments (openSUSE-SU-2021:3841-1)");
...
openSUSE-SU-2021:3841-1 advisory.
...
number.");
  ...
  # https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/Y2LPAJNM32W4DEWWWLTSSKXRXVTPDXJQ/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?19cd82e5");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2021-27291");
  script_set_attribute(attribute:"solution", value:
"Update the affected python2-Pygments package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:python2-Pygments");
...
var pkgs = [
    {'reference':'python2-Pygments-2.2.0-4.9.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python2-Pygments');
}
