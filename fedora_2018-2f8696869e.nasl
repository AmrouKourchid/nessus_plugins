...
# extracted from Fedora Security Advisory FEDORA-2018-2f8696869e.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-2f8696869e");

  script_name(english:"Fedora 29 : polkit (2018-2f8696869e)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-2f8696869e");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"polkit-0.115-4.1.fc29")) flag++;
