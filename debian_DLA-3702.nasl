...
# extracted from Debian Security Advisory dla-3702. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3702 : libspreadsheet-parseexcel-perl - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has a package installed that is affected by a vulnerability as referenced in the dla-3702
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a26289a7");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-7101");
  # https://packages.debian.org/source/buster/libspreadsheet-parseexcel-perl
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1c89e30c");
  script_set_attribute(attribute:"solution", value:
"Upgrade the libspreadsheet-parseexcel-perl packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:libspreadsheet-parseexcel-perl");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libspreadsheet-parseexcel-perl', 'reference': '0.6500-1+deb10u1'}
];
