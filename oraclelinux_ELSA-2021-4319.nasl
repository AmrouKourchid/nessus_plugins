...
# extracted from Oracle Linux Security Advisory ELSA-2021-4319.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : compat-exiv2-026 (ELSA-2021-4319)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2021-4319.html");
