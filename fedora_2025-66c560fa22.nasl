...
# extracted from Fedora Security Advisory FEDORA-2025-66c560fa22
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-66c560fa22");

  script_name(english:"Fedora 40 : python3.9 (2025-66c560fa22)");
...
FEDORA-2025-66c560fa22 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-66c560fa22");
...
var pkgs = [
    {'reference':'python3.9-3.9.21-4.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
