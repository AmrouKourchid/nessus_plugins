...
"Upgrade to a version of Microsoft Windows that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2016/01/12");
...
var os = ucf::get_os_cpe(vendor:'microsoft', product:'windows_8', type:'local');
