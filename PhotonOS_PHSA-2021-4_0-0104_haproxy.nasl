...
# extracted from VMware Security Advisory PHSA-2021-4.0-0104. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Haproxy PHSA-2021-4.0-0104");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the haproxy package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-104.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'haproxy-2.3.4-4.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'haproxy-doc-2.3.4-4.ph4')) flag++;
