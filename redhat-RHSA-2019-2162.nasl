...
# extracted from Red Hat Security Advisory RHSA-2019:2162. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:2162");

  script_name(english:"RHEL 7 : blktrace (RHSA-2019:2162)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for blktrace.");
...
the RHSA-2019:2162 advisory.

    The blktrace packages contain a number of utilities to record the I/O trace information for the kernel to
    user space, and utilities to analyze and view the trace information.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_2162.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bca76804");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/7/html/7.7_release_notes/index
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cc7115e8");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:2162");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1575119");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL blktrace package based on the guidance in RHSA-2019:2162.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:blktrace");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'blktrace-1.0.5-9.el7', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'blktrace-1.0.5-9.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'blktrace-1.0.5-9.el7', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'blktrace-1.0.5-9.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
