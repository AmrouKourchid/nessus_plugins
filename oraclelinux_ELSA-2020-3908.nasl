...
# extracted from Oracle Linux Security Advisory ELSA-2020-3908.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : cpio (ELSA-2020-3908)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2020-3908.html");
...
var pkgs = [
    {'reference':'cpio-2.11-28.el7', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
