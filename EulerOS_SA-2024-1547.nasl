...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : libssh (EulerOS-SA-2024-1547)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1547
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ea8d4caf");
