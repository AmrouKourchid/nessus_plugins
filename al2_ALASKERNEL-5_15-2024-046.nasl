...
# extracted from Amazon Linux 2 Security Advisory ALASKERNEL-5.15-2024-046.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : kernel (ALASKERNEL-5.15-2024-046)");
...
vulnerabilities as referenced in the ALAS2KERNEL-5.15-2024-046 advisory.

    2024-08-27: CVE-2024-42096 was added to this advisory.

    2024-08-27: CVE-2024-42070 was added to this advisory.

    2024-08-27: CVE-2024-42090 was added to this advisory.

    2024-08-27: CVE-2024-41092 was added to this advisory.

    2024-08-27: CVE-2024-42068 was added to this advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALASKERNEL-5.15-2024-046.html");
...
if (get_one_kb_item("Host/kpatch/kernel-cves"))
{
  ...
  var cve_list = make_list("CVE-2022-3566", "CVE-2022-3567", "CVE-2024-41092", "CVE-2024-42068", "CVE-2024-42070", "CVE-2024-42090", "CVE-2024-42096");
  if (hotfix_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, "kpatch hotfix for ALASKERNEL-5.15-2024-046");
  }
  else
  {
