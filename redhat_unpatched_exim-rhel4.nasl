...
# extracted from Red Hat Security Advisory exim. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2011-0017", "CVE-2016-1531");

  script_name(english:"RHEL 4 : exim (Unpatched Vulnerability) (deprecated)");
