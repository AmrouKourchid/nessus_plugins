...
# extracted from Fedora Security Advisory FEDORA-2023-7442702a7d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-7442702a7d");

  script_name(english:"Fedora 36 : golang (2023-7442702a7d)");
...
FEDORA-2023-7442702a7d advisory.

    go1.19.7 (released 2023-03-07) includes a security fix to the crypto/elliptic package, as well as bug
    fixes to the linker, the runtime, and the crypto/x509 and syscall packages. See the [Go 1.19.7 milestone
    on the upstream issue tracker](https://go.dev/doc/devel/release#go1.19.7) for details.

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-7442702a7d");
...
var pkgs = [
    {'reference':'golang-1.19.7-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
