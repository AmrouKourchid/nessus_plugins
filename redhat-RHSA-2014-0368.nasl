...
# extracted from Red Hat Security Advisory RHSA-2014:0368. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2014:0368");

  script_name(english:"RHEL 6 : openstack-keystone (RHSA-2014:0368)");
...
referenced in the RHSA-2014:0368 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1039164");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1071434");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2014/rhsa-2014_0368.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f70fb30e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2014:0368");
...
"Update the RHEL openstack-keystone package based on the guidance in RHSA-2014:0368.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-6391");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openstack-keystone-2013.1.5-2.el6ost', 'release':'6', 'el_string':'el6ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'openstack-keystone-doc-2013.1.5-2.el6ost', 'release':'6', 'el_string':'el6ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'python-keystone-2013.1.5-2.el6ost', 'release':'6', 'el_string':'el6ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
