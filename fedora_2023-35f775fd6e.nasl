...
# extracted from Fedora Security Advisory FEDORA-2023-35f775fd6e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-35f775fd6e");

  script_name(english:"Fedora 38 : apache-ivy (2023-35f775fd6e)");
...
FEDORA-2023-35f775fd6e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-35f775fd6e");
...
"Update the affected apache-ivy package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:apache-ivy");
...
var pkgs = [
    {'reference':'apache-ivy-2.5.1-3.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'apache-ivy');
}
