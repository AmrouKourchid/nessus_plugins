...
# extracted from Fedora Security Advisory FEDORA-2020-5b60029fe2.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : mbedtls (2020-5b60029fe2)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-5b60029fe2");
...
"Update the affected mbedtls package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-10941");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"mbedtls-2.16.7-1.fc31")) flag++;
