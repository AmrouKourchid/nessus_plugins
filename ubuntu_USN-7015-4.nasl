...
# extracted from Ubuntu Security Notice USN-7015-4. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"7015-4");

  script_name(english:"Ubuntu 14.04 LTS : Python vulnerability (USN-7015-4)");
...
USN-7015-4 advisory.
    ...
    CVE-2023-27043 for python2.7 and python3.5 in Ubuntu 14.04 LTS.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7015-4");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'idle-python2.7', 'pkgver': '2.7.6-8ubuntu0.6+esm20', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'idle-python3.5', 'pkgver': '3.5.2-2ubuntu0~16.04.4~14.04.1+esm3', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'libpython2.7', 'pkgver': '2.7.6-8ubuntu0.6+esm20', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'libpython2.7-dev', 'pkgver': '2.7.6-8ubuntu0.6+esm20', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'libpython2.7-minimal', 'pkgver': '2.7.6-8ubuntu0.6+esm20', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'libpython2.7-stdlib', 'pkgver': '2.7.6-8ubuntu0.6+esm20', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'libpython2.7-testsuite', 'pkgver': '2.7.6-8ubuntu0.6+esm20', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'libpython3.5', 'pkgver': '3.5.2-2ubuntu0~16.04.4~14.04.1+esm3', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'libpython3.5-dev', 'pkgver': '3.5.2-2ubuntu0~16.04.4~14.04.1+esm3', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'libpython3.5-minimal', 'pkgver': '3.5.2-2ubuntu0~16.04.4~14.04.1+esm3', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'libpython3.5-stdlib', 'pkgver': '3.5.2-2ubuntu0~16.04.4~14.04.1+esm3', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'libpython3.5-testsuite', 'pkgver': '3.5.2-2ubuntu0~16.04.4~14.04.1+esm3', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'python2.7', 'pkgver': '2.7.6-8ubuntu0.6+esm20', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'python2.7-dev', 'pkgver': '2.7.6-8ubuntu0.6+esm20', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'python2.7-examples', 'pkgver': '2.7.6-8ubuntu0.6+esm20', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'python2.7-minimal', 'pkgver': '2.7.6-8ubuntu0.6+esm20', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'python3.5', 'pkgver': '3.5.2-2ubuntu0~16.04.4~14.04.1+esm3', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'python3.5-dev', 'pkgver': '3.5.2-2ubuntu0~16.04.4~14.04.1+esm3', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'python3.5-examples', 'pkgver': '3.5.2-2ubuntu0~16.04.4~14.04.1+esm3', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'python3.5-minimal', 'pkgver': '3.5.2-2ubuntu0~16.04.4~14.04.1+esm3', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'python3.5-venv', 'pkgver': '3.5.2-2ubuntu0~16.04.4~14.04.1+esm3', 'ubuntu_pro': TRUE}
];
