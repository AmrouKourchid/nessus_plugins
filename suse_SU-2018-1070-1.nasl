...
# extracted from SUSE update advisory SUSE-SU-2018:1070-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES11 Security Update : rzsz (SUSE-SU-2018:1070-1)");
...
"This update for rzsz fixes the following issues :
  ...
  - VUL-0: CVE-2018-10195: rzsz: sz can leak data to
    receiving side (bsc#1090051)

  - rzsz-0.12.20-976.7: illegal use of freed variable
    (bsc#529899)
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=529899");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2018-10195/");
  # https://www.suse.com/support/update/announcement/2018/suse-su-20181070-1/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9f0a0a6b");
...
flag = 0;
if (rpm_check(release:"SLES11", sp:"4", reference:"rzsz-0.12.21~rc-936.3.1")) flag++;
if (rpm_check(release:"SLES11", sp:"4", reference:"rzsz-debuginfo-0.12.21~rc-936.3.1")) flag++;
if (rpm_check(release:"SLES11", sp:"4", reference:"rzsz-debugsource-0.12.21~rc-936.3.1")) flag++;
