...
# extracted from Red Hat Security Advisory RHSA-2021:3942. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:3942");

  script_name(english:"RHEL 7 : openvswitch2.11 (RHSA-2021:3942)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for openvswitch2.11.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2021:3942 advisory.
    ...
    * openvswitch2.11: openvswitch: use-after-free in decode_NXAST_RAW_ENCAP during the decoding of a
    RAW_ENCAP action (CVE-2021-36980)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_3942.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?36c97ea7");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:3942");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1984473");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL openvswitch2.11 package based on the guidance in RHSA-2021:3942.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openvswitch2.11-2.11.3-89.el7fdp', 'cpu':'ppc64le', 'release':'7', 'el_string':'el7fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'},
      {'reference':'openvswitch2.11-2.11.3-89.el7fdp', 'cpu':'x86_64', 'release':'7', 'el_string':'el7fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'},
      {'reference':'openvswitch2.11-devel-2.11.3-89.el7fdp', 'cpu':'ppc64le', 'release':'7', 'el_string':'el7fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'},
      {'reference':'openvswitch2.11-devel-2.11.3-89.el7fdp', 'cpu':'x86_64', 'release':'7', 'el_string':'el7fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'},
      {'reference':'python-openvswitch2.11-2.11.3-89.el7fdp', 'cpu':'ppc64le', 'release':'7', 'el_string':'el7fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'},
      {'reference':'python-openvswitch2.11-2.11.3-89.el7fdp', 'cpu':'x86_64', 'release':'7', 'el_string':'el7fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'openvswitch2.11 / openvswitch2.11-devel / python-openvswitch2.11');
}
