...
if (description)
{
  ...
  script_cve_id("CVE-2023-1436", "CVE-2019-10086");
  script_xref(name:"IAVA", value:"2023-A-0559");
  script_xref(name:"CEA-ID", value:"CEA-2021-0025");
  script_xref(name:"CEA-ID", value:"CEA-2021-0004");

  script_name(english:"Oracle Identity Manager (October 2023 CPU)");
...
therefore affected by multiple vulnerabilities as referenced in the October 2023 Critical Patch Update(CPU) advisory.
  ...
  - Vulnerability in the Oracle Identity Manager product of Oracle Fusion Middleware (component: Third Party
    ...
    repeatable crash (complete DOS) of Oracle Identity Manager. (CVE-2023-1436)

  - Vulnerability in the Oracle Identity Manager product of Oracle Fusion Middleware (component: Third Party 
    (Apache Commons BeanUtils)). The supported version that is affected is 12.2.1.4.0. Easily exploitable 
    ...
    access to some of Oracle Identity Manager accessible data as well as unauthorized read access to a subset 
    of Oracle Identity Manager accessible data and unauthorized ability to cause a partial denial of service 
    (partial DOS) of Oracle Identity Manager. (CVE-2019-10086)
...
var constraints = [
  { 'min_version' : '12.2.1.4.0', 'fixed_version' : '12.2.1.4.231009' }
];
