...
# extracted from Red Hat Security Advisory RHSA-2024:9325. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:9325");

  script_name(english:"RHEL 9 : cockpit (RHSA-2024:9325)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-34216");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-46354");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-55860");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_9325.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5483bc06");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:9325");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL cockpit package based on the guidance in RHSA-2024:9325.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cockpit-323.1-1.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'cockpit-bridge-323.1-1.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'cockpit-doc-323.1-1.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'cockpit-packagekit-323.1-1.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'cockpit-pcp-323.1-1.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'cockpit-storaged-323.1-1.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'cockpit-system-323.1-1.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'cockpit-ws-323.1-1.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
