...
# extracted from Fedora Security Advisory FEDORA-2025-3110d5f423
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-3110d5f423");

  script_name(english:"Fedora 40 : linux-firmware (2025-3110d5f423)");
...
FEDORA-2025-3110d5f423 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-3110d5f423");
...
"Update the affected linux-firmware package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-21978");
...
var pkgs = [
    {'reference':'linux-firmware-20250311-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
