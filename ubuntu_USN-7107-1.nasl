...
# extracted from Ubuntu Security Notice USN-7107-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"7107-1");

  script_name(english:"Ubuntu 14.04 LTS : zlib vulnerability (USN-7107-1)");
...
USN-7107-1 advisory.
    ...
    It was discovered that Minizip in zlib incorrectly handled certain zip header fields. An attacker could
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7107-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'lib32z1', 'pkgver': '1:1.2.8.dfsg-1ubuntu1.1+esm3', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'lib32z1-dev', 'pkgver': '1:1.2.8.dfsg-1ubuntu1.1+esm3', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'lib64z1', 'pkgver': '1:1.2.8.dfsg-1ubuntu1.1+esm3', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'lib64z1-dev', 'pkgver': '1:1.2.8.dfsg-1ubuntu1.1+esm3', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'libx32z1', 'pkgver': '1:1.2.8.dfsg-1ubuntu1.1+esm3', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'libx32z1-dev', 'pkgver': '1:1.2.8.dfsg-1ubuntu1.1+esm3', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'zlib-bin', 'pkgver': '1:1.2.8.dfsg-1ubuntu1.1+esm3', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'zlib1g', 'pkgver': '1:1.2.8.dfsg-1ubuntu1.1+esm3', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'zlib1g-dev', 'pkgver': '1:1.2.8.dfsg-1ubuntu1.1+esm3', 'ubuntu_pro': TRUE}
];
