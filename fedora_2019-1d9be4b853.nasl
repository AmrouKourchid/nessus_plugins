...
# extracted from Fedora Security Advisory FEDORA-2019-1d9be4b853.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-1d9be4b853");

  script_name(english:"Fedora 29 : drupal8 (2019-1d9be4b853)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-1d9be4b853");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"drupal8-8.6.13-1.fc29")) flag++;
