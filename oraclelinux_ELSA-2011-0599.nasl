...
# extracted from Oracle Linux Security Advisory ELSA-2011-0599.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : sudo (ELSA-2011-0599)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2011-0599.html");
...
var pkgs = [
    {'reference':'sudo-1.7.4p5-5.el6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sudo-1.7.4p5-5.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
];
