...
referenced in the RHSA-2005:066 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"http://www.kde.org/info/security/advisory-20041223-1.txt");
  script_set_attribute(attribute:"see_also", value:"http://www.kde.org/info/security/advisory-20050119-1.txt");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2005/rhsa-2005_066.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ba1d9aad");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=144231");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=147517");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2005:066");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL kdegraphics package based on the guidance in RHSA-2005:066.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:N/UI:R/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2004-0888");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'kdegraphics-3.3.1-3.3', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'kdegraphics-3.3.1-3.3', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'kdegraphics-3.3.1-3.3', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'kdegraphics-3.3.1-3.3', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'kdegraphics-3.3.1-3.3', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'kdegraphics-devel-3.3.1-3.3', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'kdegraphics-devel-3.3.1-3.3', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'kdegraphics-devel-3.3.1-3.3', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'kdegraphics-devel-3.3.1-3.3', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'kdegraphics-devel-3.3.1-3.3', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
    ]
  }
];
