...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5033422");
  script_xref(name:"MSKB", value:"5033427");
  script_xref(name:"MSFT", value:"MS23-5033422");
  script_xref(name:"MSFT", value:"MS23-5033427");
  script_xref(name:"IAVA", value:"2023-A-0689-S");
  script_xref(name:"IAVA", value:"2023-A-0690-S");

  script_name(english:"KB5033427: Windows Server 2008 Security Update (December 2023)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5033427. It is, therefore, affected by multiple vulnerabilities
  ...
  - DHCP Server Service Information Disclosure Vulnerability (CVE-2023-36012)

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5033422");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5033427");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5033427 or Cumulative Update 5033422");
...
if (
  smb_check_rollup(os:'6.0',
                   ...
                   rollup_date:'12_2023',
                   bulletin:bulletin,
                   rollup_kb_list:[5033427, 5033422])
)
{
