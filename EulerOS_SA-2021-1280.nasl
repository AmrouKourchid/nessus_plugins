...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : 389-ds-base (EulerOS-SA-2021-1280)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1280
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f746ec27");
...
pkgs = ["389-ds-base-1.3.5.10-20.h12",
        "389-ds-base-libs-1.3.5.10-20.h12"];
