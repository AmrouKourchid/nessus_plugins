...
if (description)
{
  ...
  script_name(english:"Oracle Siebel Server <= 19.8 (October 2019 CPU)");
...
the October 2019 CPU advisory.
  ...
  - Vulnerability in the Siebel Core - DB Deployment and Configuration product of Oracle Siebel CRM
    (component: Install - Configuration). Supported versions that are affected are 19.8 and prior. Easily
    exploitable vulnerability allows unauthenticated attacker with network access via HTTP to compromise
    Siebel Core - DB Deployment and Configuration. Successful attacks of this vulnerability can result in
    unauthorized access to critical data or complete access to all Siebel Core - DB Deployment and
    Configuration accessible data. (CVE-2019-2965)
...
var constraints = [
  { 'max_version' : '19.8', 'fixed_display' : 'See vendor advisory' }
];
