...
if (description)
{
  ...
  script_cve_id("CVE-2024-55593");

  script_name(english:"Fortinet FortiWeb sqli (FG-IR-24-465)");
...
vulnerability as referenced in the FG-IR-24-465 advisory.

  - A improper neutralization of special elements used in an sql command ('sql injection') in Fortinet
    FortiWeb versions 6.3.17 through 7.6.1 allows attacker to gain information disclosure via crafted SQL
    queries (CVE-2024-55593)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.fortiguard.com/psirt/FG-IR-24-465");
  script_set_attribute(attribute:"solution", value:
"Upgrade to FortiWeb version 6.3.999999 / 6.4.999999 / 7.0.999999 / 7.2.999999 / 7.4.999999 / 7.6.2 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-55593");
...
var constraints = [
  ...
  { 'min_version' : '7.6.0', 'max_version' : '7.6.1', 'fixed_version' : '7.6.2' }
];
