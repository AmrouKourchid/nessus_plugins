...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : openssh on SL7.x x86_64 (20190806)");
...
"Security Fix(es) :
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1908&L=SCIENTIFIC-LINUX-ERRATA&P=28987
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?df57e8aa");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"openssh-7.4p1-21.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"openssh-askpass-7.4p1-21.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"openssh-cavs-7.4p1-21.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"openssh-clients-7.4p1-21.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"openssh-debuginfo-7.4p1-21.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"openssh-keycat-7.4p1-21.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"openssh-ldap-7.4p1-21.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"openssh-server-7.4p1-21.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"openssh-server-sysvinit-7.4p1-21.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"pam_ssh_agent_auth-0.10.3-2.21.el7")) flag++;
