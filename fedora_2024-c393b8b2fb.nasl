...
# extracted from Fedora Security Advisory FEDORA-2024-c393b8b2fb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-c393b8b2fb");

  script_name(english:"Fedora 40 : rubygem-puma (2024-c393b8b2fb)");
...
FEDORA-2024-c393b8b2fb advisory.
    ...
    ```
    * Tue Jan  9 2024 Vt Ondruch <vondruch@redhat.com> - 6.4.2-1
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-c393b8b2fb");
  script_set_attribute(attribute:"solution", value:
"Update the affected rubygem-puma package.");
...
var pkgs = [
    {'reference':'rubygem-puma-6.4.2-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
