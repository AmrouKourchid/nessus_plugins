...
# extracted from Fedora Security Advisory FEDORA-2023-dfeb282345
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-dfeb282345");

  script_name(english:"Fedora 37 : seamonkey (2023-dfeb282345)");
...
FEDORA-2023-dfeb282345 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-dfeb282345");
...
var pkgs = [
    {'reference':'seamonkey-2.53.15-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
