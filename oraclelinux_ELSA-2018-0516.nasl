...
# Oracle Linux Security Advisory ELSA-2018-0516 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : qemu-kvm (ELSA-2018-0516)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2018-0516.html");
...
var pkgs = [
    ...
    {'reference':'qemu-img-0.12.1.2-2.503.el6_9.5', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'qemu-kvm-0.12.1.2-2.503.el6_9.5', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'qemu-kvm-tools-0.12.1.2-2.503.el6_9.5', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
