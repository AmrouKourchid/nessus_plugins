...
# extracted from Fedora Security Advisory FEDORA-2024-c990070fa4
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-c990070fa4");

  script_name(english:"Fedora 38 : gtkwave (2024-c990070fa4)");
...
FEDORA-2024-c990070fa4 advisory.

    Cumulative bug-fix update.

    This update includes fixes for multiple security issues found by Talos in which specially crafted input
    files could lead to arbitrary code execution. A victim would need to open a malicious file to trigger
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-c990070fa4");
...
var pkgs = [
    {'reference':'gtkwave-3.3.118-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
