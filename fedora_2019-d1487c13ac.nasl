...
# extracted from Fedora Security Advisory FEDORA-2019-d1487c13ac.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : rssh (2019-d1487c13ac)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-d1487c13ac");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"rssh-2.3.4-15.fc30")) flag++;
