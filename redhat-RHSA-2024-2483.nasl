...
# extracted from Red Hat Security Advisory RHSA-2024:2483. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2483");

  script_name(english:"RHEL 9 : traceroute (RHSA-2024:2483)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2483.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?048c3c31");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2483");
...
"Update the RHEL traceroute package based on the guidance in RHSA-2024:2483.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'traceroute-2.1.0-18.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'}
    ]
  }
];
