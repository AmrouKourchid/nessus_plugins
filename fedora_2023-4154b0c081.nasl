...
# extracted from Fedora Security Advisory FEDORA-2023-4154b0c081
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-4154b0c081");

  script_name(english:"Fedora 39 : dotnet6.0 (2023-4154b0c081)");
...
FEDORA-2023-4154b0c081 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-4154b0c081");
...
var pkgs = [
    {'reference':'dotnet6.0-6.0.122-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
