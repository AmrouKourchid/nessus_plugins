...
# extracted from Fedora Security Advisory FEDORA-2025-20e86a3c86
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-20e86a3c86");
  script_xref(name:"IAVA", value:"2025-A-0186");

  script_name(english:"Fedora 41 : expat (2025-20e86a3c86)");
...
FEDORA-2025-20e86a3c86 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-20e86a3c86");
...
var pkgs = [
    {'reference':'expat-2.7.0-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
