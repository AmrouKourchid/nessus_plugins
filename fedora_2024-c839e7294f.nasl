...
# extracted from Fedora Security Advisory FEDORA-2024-c839e7294f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-c839e7294f");

  script_name(english:"Fedora 39 : postfix (2024-c839e7294f)");
...
FEDORA-2024-c839e7294f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-c839e7294f");
  script_set_attribute(attribute:"solution", value:
"Update the affected 2:postfix package.");
...
var pkgs = [
    {'reference':'postfix-3.8.4-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
