...
# extracted from Red Hat Security Advisory RHSA-2024:4371. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:4371");

  script_name(english:"RHEL 9 : buildah (RHSA-2024:4371)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_4371.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d8bf36c7");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:4371");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL buildah package based on the guidance in RHSA-2024:4371.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'buildah-1.33.7-3.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'buildah-tests-1.33.7-3.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'buildah-1.33.7-3.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'buildah-tests-1.33.7-3.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
    ]
  }
];
