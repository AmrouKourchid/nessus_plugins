...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.2.0 : p11-kit (EulerOS-SA-2021-1397)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1397
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2a6c5f76");
...
pkgs = ["p11-kit-0.23.5-3.h1",
        "p11-kit-devel-0.23.5-3.h1",
        "p11-kit-trust-0.23.5-3.h1"];
