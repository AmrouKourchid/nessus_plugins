...
# AlmaLinux Security Advisory ALSA-2024:1063.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:1063");

  script_name(english:"AlmaLinux 8 : edk2 (ALSA-2024:1063)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ALSA-2024:1063 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2024-1063.html");
...
var pkgs = [
    {'reference':'edk2-aarch64-20220126gitbb1bba3d77-6.el8_9.6.alma', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'edk2-ovmf-20220126gitbb1bba3d77-6.el8_9.6.alma', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
