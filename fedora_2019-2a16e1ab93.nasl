...
# extracted from Fedora Security Advisory FEDORA-2019-2a16e1ab93.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : cutter-re / radare2 (2019-2a16e1ab93)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-2a16e1ab93");
...
"Update the affected cutter-re and / or radare2 packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-12802");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"cutter-re-1.8.3-1.fc30")) flag++;
if (rpm_check(release:"FC30", reference:"radare2-3.6.0-1.fc30")) flag++;
