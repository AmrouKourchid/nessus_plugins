...
# extracted from Debian Security Advisory dla-3608. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3608 : vinagre - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has a package installed that is affected by a vulnerability as referenced in the dla-3608
advisory.

    -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3608-1                debian-lts@lists.debian.org
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/vinagre");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/vinagre");
  script_set_attribute(attribute:"solution", value:
"Upgrade the vinagre packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:vinagre");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'vinagre', 'reference': '3.22.0-6+deb10u1'}
];
