...
# extracted from Oracle Linux Security Advisory ELSA-2023-3095.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : libreswan (ELSA-2023-3095)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-3095.html");
...
var pkgs = [
    {'reference':'libreswan-4.9-2.0.1.el8_8.2', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libreswan-4.9-2.0.1.el8_8.2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
