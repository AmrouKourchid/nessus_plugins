...
# extracted from Oracle Linux Security Advisory ELSA-2007-0542.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : mcstrans (ELSA-2007-0542)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2007-0542.html");
...
"Update the affected mcstrans package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:mcstrans");
