...
# extracted from Red Hat Security Advisory RHSA-2023:2373. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:2373");

  script_name(english:"RHEL 9 : wireshark (RHSA-2023:2373)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for wireshark.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_2373.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9d99636d");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/9/html/9.2_release_notes/index
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ecefa061");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2083581");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2152061");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2160648");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:2373");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL wireshark package based on the guidance in RHSA-2023:2373.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'wireshark-3.4.10-4.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'wireshark-cli-3.4.10-4.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'wireshark-devel-3.4.10-4.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
