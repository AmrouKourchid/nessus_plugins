...
# extracted from Red Hat Security Advisory RHSA-2024:10832. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 8 : postgresql:13 (RHSA-2024:10832)");
...
referenced in the RHSA-2024:10832 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_10832.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?af061803");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:10832");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL postgresql:13 package based on the guidance in RHSA-2024:10832.");
  ...
  'postgresql:13': [
    {
      ...
      'pkgs': [
        ...
        {'reference':'postgresql-13.18-1.module+el8.10.0+22549+cf2ec3d9', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-contrib-13.18-1.module+el8.10.0+22549+cf2ec3d9', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-docs-13.18-1.module+el8.10.0+22549+cf2ec3d9', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plperl-13.18-1.module+el8.10.0+22549+cf2ec3d9', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plpython3-13.18-1.module+el8.10.0+22549+cf2ec3d9', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-pltcl-13.18-1.module+el8.10.0+22549+cf2ec3d9', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-13.18-1.module+el8.10.0+22549+cf2ec3d9', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-devel-13.18-1.module+el8.10.0+22549+cf2ec3d9', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-static-13.18-1.module+el8.10.0+22549+cf2ec3d9', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-13.18-1.module+el8.10.0+22549+cf2ec3d9', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-rpm-macros-13.18-1.module+el8.10.0+22549+cf2ec3d9', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-upgrade-13.18-1.module+el8.10.0+22549+cf2ec3d9', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-upgrade-devel-13.18-1.module+el8.10.0+22549+cf2ec3d9', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
