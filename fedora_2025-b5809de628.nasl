...
# extracted from Fedora Security Advisory FEDORA-2025-b5809de628
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-b5809de628");

  script_name(english:"Fedora 40 : php-tcpdf (2025-b5809de628)");
...
FEDORA-2025-b5809de628 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-b5809de628");
...
var pkgs = [
    {'reference':'php-tcpdf-6.9.1-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
