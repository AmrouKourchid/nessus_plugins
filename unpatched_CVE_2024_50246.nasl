...
if (description)
{
  ...
  script_cve_id("CVE-2024-50246");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-50246");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: fs/ntfs3: Add rough attr alloc_size
    check (CVE-2024-50246)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-50246");
