...
# extracted from Fedora Security Advisory FEDORA-2023-65c95a087d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-65c95a087d");

  script_name(english:"Fedora 40 : python3.6 (2023-65c95a087d)");
...
FEDORA-2023-65c95a087d advisory.

    Automatic update for python3.6-3.6.15-22.fc40.

    ##### **Changelog**

    ```
    * Mon Dec 18 2023 Lumr Balhar <lbalhar@redhat.com> - 3.6.15-22
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-65c95a087d");
...
var pkgs = [
    {'reference':'python3.6-3.6.15-22.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
