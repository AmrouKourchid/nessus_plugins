...
# AlmaLinux Security Advisory ALSA-2021:1686.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2021:1686");

  script_name(english:"AlmaLinux 8 : wpa_supplicant (ALSA-2021:1686)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2021-1686.html");
...
"Update the affected wpa_supplicant package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:wpa_supplicant");
