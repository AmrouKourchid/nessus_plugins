...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2021/02/msg00006.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/stretch/open-build-service");
  # https://security-tracker.debian.org/tracker/source-package/open-build-service
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c8317018");
...
"Upgrade the affected packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2020-8020");
