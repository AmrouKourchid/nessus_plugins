...
if (description)
{
  ...
  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2013-2062");
...
patch available.
  ...
  - Multiple integer overflows in X.org libXp 1.0.1 and earlier allow X servers to trigger allocation of
    ...
    XpGetOneAttribute, (3) XpGetPrinterList, and (4) XpQueryScreens functions. (CVE-2013-2062)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-2062");
