...
"The remote Red Hat host is missing one or more security updates for libssh2.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2019:1943 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_1943.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5da3b32e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:1943");
...
"Update the RHEL libssh2 package based on the guidance in RHSA-2019:1943.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libssh2-1.4.3-11.el7_4.1', 'sp':'4', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libssh2-1.4.3-11.el7_4.1', 'sp':'4', 'cpu':'ppc', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libssh2-1.4.3-11.el7_4.1', 'sp':'4', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libssh2-1.4.3-11.el7_4.1', 'sp':'4', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libssh2-1.4.3-11.el7_4.1', 'sp':'4', 'cpu':'s390', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libssh2-1.4.3-11.el7_4.1', 'sp':'4', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libssh2-1.4.3-11.el7_4.1', 'sp':'4', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libssh2-devel-1.4.3-11.el7_4.1', 'sp':'4', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libssh2-devel-1.4.3-11.el7_4.1', 'sp':'4', 'cpu':'ppc', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libssh2-devel-1.4.3-11.el7_4.1', 'sp':'4', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libssh2-devel-1.4.3-11.el7_4.1', 'sp':'4', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libssh2-devel-1.4.3-11.el7_4.1', 'sp':'4', 'cpu':'s390', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libssh2-devel-1.4.3-11.el7_4.1', 'sp':'4', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libssh2-devel-1.4.3-11.el7_4.1', 'sp':'4', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libssh2-docs-1.4.3-11.el7_4.1', 'sp':'4', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
