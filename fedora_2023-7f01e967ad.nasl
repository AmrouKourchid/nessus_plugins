...
# extracted from Fedora Security Advisory FEDORA-2023-7f01e967ad
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-7f01e967ad");

  script_name(english:"Fedora 38 : libspf2 (2023-7f01e967ad)");
...
FEDORA-2023-7f01e967ad advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-7f01e967ad");
...
var pkgs = [
    {'reference':'libspf2-1.2.11-11.20210922git4915c308.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
