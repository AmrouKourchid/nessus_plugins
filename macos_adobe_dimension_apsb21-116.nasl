...
if (description)
{
  ...
  script_name(english:"Adobe Dimension < 3.4.4 Multiple Vulnerabilities (APSB21-116) (macOS)");

  script_set_attribute(attribute:"synopsis", value:
"The Adobe Dimension instance installed on the remote host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Dimension installed on the remote macOS host is prior to 3.4.4. It is, therefore, affected by
multiple vulnerabilities as referenced in the APSB21-116 advisory.
  ...
  - Adobe Dimension versions 3.4.3 (and earlier) are affected by an out-of-bounds read vulnerability that
    ...
    a malicious TIF file. (CVE-2021-43763, CVE-2021-44183)
  ...
  - Adobe Dimension versions 3.4.3 (and earlier) are affected by an out-of-bounds read vulnerability that
    could lead to disclosure of sensitive memory. An attacker could leverage this vulnerability to bypass
    mitigations such as ASLR. Exploitation of this issue requires user interaction in that a victim must open
    a malicious SVG file. (CVE-2021-44182)
...
"Upgrade to Adobe Dimension version 3.4.4 or later.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2021-44183");

  script_set_attribute(attribute:"exploitability_ease", value:"No known exploits are available");
  script_set_attribute(attribute:"exploit_available", value:"false");
  script_cwe_id(125, 787, 788);
