...
# extracted from Debian Security Advisory DLA-2012-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2012-1 : libvpx security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2019/11/msg00030.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/jessie/libvpx");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"libvpx-dev", reference:"1.3.0-3+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"libvpx-doc", reference:"1.3.0-3+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"libvpx1", reference:"1.3.0-3+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"libvpx1-dbg", reference:"1.3.0-3+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"vpx-tools", reference:"1.3.0-3+deb8u2")) flag++;
