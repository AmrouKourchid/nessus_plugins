...
if (description)
{
  ...
  script_cve_id("CVE-2025-1412");
  script_xref(name:"IAVB", value:"2025-A-0133-S");

  script_name(english:"Mattermost Server 9.11.x < 9.11.7 / 10.4.x < 10.4.2 (MMSA-2025-00414)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of Mattermost Server installed on the remote host is prior to 9.11.7 or 10.4.2. It is, therefore, affected
by a vulnerability as referenced in the MMSA-2025-00414 advisory.

  - Mattermost versions 9.11.x <= 9.11.6, 10.4.x <= 10.4.1 fail to invalidate all active sessions when
    converting a user to a bot, with allows the converted user to escalate their privileges depending on the
    permissions granted to the bot. (CVE-2025-1412)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://mattermost.com/security-updates/");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Mattermost Server version 9.11.7 / 10.4.2 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-1412");
...
var constraints = [
  { 'min_version' : '9.11', 'max_version' : '9.11.6', 'fixed_version' : '9.11.7' },
