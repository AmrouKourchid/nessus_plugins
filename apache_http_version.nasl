...
var source = get_kb_item("www/" + port + "/apache/error_page/source");
...
var apache_banner = parse_banner(banner:banner);
...
var backport_banner = get_backport_banner(banner:banner, app:appname);
