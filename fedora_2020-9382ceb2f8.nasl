...
# extracted from Fedora Security Advisory FEDORA-2020-9382ceb2f8.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-9382ceb2f8");

  script_name(english:"Fedora 31 : chromium (2020-9382ceb2f8)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-9382ceb2f8");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"chromium-79.0.3945.130-1.fc31", allowmaj:TRUE)) flag++;
