...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.0 : binutils (EulerOS-SA-2023-3097)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3097
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a8049871");
...
var pkgs = [
  "binutils-2.34-1.h35.eulerosv2r9"
];
