...
# Rocky Linux Security Advisory RLSA-2021:1791.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2021:1791");

  script_name(english:"Rocky Linux 8 : spice-vdagent (RLSA-2021:1791)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Rocky Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Rocky Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
RLSA-2021:1791 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2021:1791");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1790904");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1824610");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1886345");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1886359");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1886366");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1886372");
  script_set_attribute(attribute:"solution", value:
"Update the affected spice-vdagent, spice-vdagent-debuginfo and / or spice-vdagent-debugsource packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:rocky:linux:spice-vdagent");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:rocky:linux:spice-vdagent-debuginfo");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:rocky:linux:spice-vdagent-debugsource");
...
var pkgs = [
    ...
    {'reference':'spice-vdagent-debuginfo-0.20.0-3.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'spice-vdagent-debuginfo-0.20.0-3.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'spice-vdagent-debugsource-0.20.0-3.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'spice-vdagent-debugsource-0.20.0-3.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
