...
# extracted from Red Hat Security Advisory RHSA-2023:7189. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:7189");

  script_name(english:"RHEL 8 : fwupd (RHSA-2023:7189)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for fwupd.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2023:7189 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_7189.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6389f253");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:7189");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL fwupd package based on the guidance in RHSA-2023:7189.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'fwupd-1.7.8-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fwupd-devel-1.7.8-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
