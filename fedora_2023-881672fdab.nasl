...
# extracted from Fedora Security Advisory FEDORA-2023-881672fdab
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-881672fdab");
  script_xref(name:"IAVB", value:"2023-B-0081-S");

  script_name(english:"Fedora 37 : xen (2023-881672fdab)");
...
FEDORA-2023-881672fdab advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-881672fdab");
...
var pkgs = [
    {'reference':'xen-4.16.5-3.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
