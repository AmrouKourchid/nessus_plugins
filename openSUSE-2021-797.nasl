...
# extracted from openSUSE Security Update openSUSE-2021-797.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : rubygem-actionpack-5_1 (openSUSE-2021-797)");
...
"This update for rubygem-actionpack-5_1 fixes the following issues :
  ...
  - CVE-2021-22885: Fixed possible information disclosure /
    unintended method execution in Action Pack
    (bsc#1185715).

This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1185715");
  script_set_attribute(attribute:"solution", value:
"Update the affected rubygem-actionpack-5_1 packages.");
...
if ( rpm_check(release:"SUSE15.2", reference:"ruby2.5-rubygem-actionpack-5_1-5.1.4-lp152.5.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"ruby2.5-rubygem-actionpack-doc-5_1-5.1.4-lp152.5.6.1") ) flag++;
