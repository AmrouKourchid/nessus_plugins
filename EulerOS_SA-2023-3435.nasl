...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : libtiff (EulerOS-SA-2023-3435)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3435
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d4b9af54");
...
var pkgs = [
  "libtiff-4.0.9-11.h32.eulerosv2r8",
  "libtiff-devel-4.0.9-11.h32.eulerosv2r8"
];
