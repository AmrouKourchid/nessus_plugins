...
# Red Hat Security Advisory RHSA-2023:6917. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : xorg-x11-server-Xwayland (CESA-2023:6917)");
...
var pkgs = [
    {'reference':'xorg-x11-server-Xwayland-21.1.3-12.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xorg-x11-server-Xwayland-21.1.3-12.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
