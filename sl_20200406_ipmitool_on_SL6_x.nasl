...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : ipmitool on SL6.x i386/x86_64 (20200406)");
...
"Security Fix(es) :
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind2004&L=SCIENTIFIC-LINUX-ERRATA&P=392
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f64ded55");
...
flag = 0;
if (rpm_check(release:"SL6", reference:"ipmitool-1.8.15-3.el6_10")) flag++;
if (rpm_check(release:"SL6", reference:"ipmitool-debuginfo-1.8.15-3.el6_10")) flag++;
