...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : rsync (EulerOS-SA-2023-1135)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1135
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1564482a");
...
var pkgs = [
  "rsync-3.1.3-6.h1.r3.eulerosv2r9"
];
