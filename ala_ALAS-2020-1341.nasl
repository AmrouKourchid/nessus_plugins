...
# extracted from Amazon Linux AMI Security Advisory ALAS-2020-1341.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2020-1341");

  script_name(english:"Amazon Linux AMI : spamassassin (ALAS-2020-1341)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux AMI host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of spamassassin installed on the remote host is prior to 3.4.3-2.2. It is, therefore, affected by multiple
vulnerabilities as referenced in the ALAS-2020-1341 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2018-11805");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2019-12420");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/ALAS-2020-1341.html");
...
var pkgs = [
    {'reference':'spamassassin-3.4.3-2.2.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'spamassassin-3.4.3-2.2.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'spamassassin-debuginfo-3.4.3-2.2.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'spamassassin-debuginfo-3.4.3-2.2.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE}
];
