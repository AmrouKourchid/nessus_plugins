...
# extracted from Oracle Linux Security Advisory ELSA-2020-4158.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : thunderbird (ELSA-2020-4158)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2020-4158.html");
...
var pkgs = [
    {'reference':'thunderbird-78.3.1-1.0.1.el6_10', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'thunderbird-78.3.1-1.0.1.el6_10', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
