...
# extracted from Debian Security Advisory dsa-5871. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5871 : emacs - security update");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'emacs', 'reference': '1:28.2+1-15+deb12u4'},
    {'release': '12.0', 'prefix': 'emacs-bin-common', 'reference': '1:28.2+1-15+deb12u4'},
    {'release': '12.0', 'prefix': 'emacs-common', 'reference': '1:28.2+1-15+deb12u4'},
    {'release': '12.0', 'prefix': 'emacs-el', 'reference': '1:28.2+1-15+deb12u4'},
    {'release': '12.0', 'prefix': 'emacs-gtk', 'reference': '1:28.2+1-15+deb12u4'},
    {'release': '12.0', 'prefix': 'emacs-lucid', 'reference': '1:28.2+1-15+deb12u4'},
    {'release': '12.0', 'prefix': 'emacs-nox', 'reference': '1:28.2+1-15+deb12u4'}
];
