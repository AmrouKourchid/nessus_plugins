...
# extracted from Fedora Security Advisory FEDORA-2022-3ef41c3410
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-3ef41c3410");
  script_xref(name:"IAVA", value:"2023-A-0072");

  script_name(english:"Fedora 36 : libksba (2022-3ef41c3410)");
...
FEDORA-2022-3ef41c3410 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-3ef41c3410");
...
var pkgs = [
    {'reference':'libksba-1.6.2-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
