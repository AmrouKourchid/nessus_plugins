...
# extracted from Fedora Security Advisory FEDORA-2023-3003165311
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-3003165311");

  script_name(english:"Fedora 36 : chromium (2023-3003165311)");
...
FEDORA-2023-3003165311 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-3003165311");
...
var pkgs = [
    {'reference':'chromium-111.0.5563.110-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
