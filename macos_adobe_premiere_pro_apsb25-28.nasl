...
if (description)
{
  ...
  script_cve_id("CVE-2025-27196");
  script_xref(name:"IAVA", value:"2025-A-0236");

  script_name(english:"Adobe Premiere Pro < 24.6.5 / 25.0 < 25.2 Arbitrary code execution (APSB25-28) (macOS)");
...
"The version of Adobe Premiere Pro installed on the remote macOS host is prior to 24.6.5, 25.2. It is, therefore,
affected by a vulnerability as referenced in the APSB25-28 advisory.

  - Heap-based Buffer Overflow (CWE-122) potentially leading to Arbitrary code execution (CVE-2025-27196)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://helpx.adobe.com/security/products/premiere_pro/apsb25-28.html");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Adobe Premiere Pro version 24.6.5, 25.2 or later.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:N/UI:R/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-27196");
