...
# extracted from VMware Security Advisory PHSA-2022-3.0-0402. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Containerd PHSA-2022-3.0-0402");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the containerd package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-3.0-402.md");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'containerd-1.4.13-2.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'containerd-doc-1.4.13-2.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'containerd-extras-1.4.13-2.ph3')) flag++;
