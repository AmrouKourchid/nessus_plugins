...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.1 : xz (EulerOS-SA-2022-2370)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2370
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4771f04d");
...
var pkgs = [
  "xz-5.2.4-10.h2.eulerosv2r9",
  "xz-libs-5.2.4-10.h2.eulerosv2r9"
];
