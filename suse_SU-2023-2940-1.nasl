...
# SUSE update advisory SUSE-SU-2023:2940-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:2940-1");
  script_xref(name:"IAVA", value:"2023-A-0377-S");

  script_name(english:"SUSE SLES12 Security Update : openssh (SUSE-SU-2023:2940-1)");
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-July/015606.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3c3aef32");
...
"Update the affected openssh, openssh-askpass-gnome, openssh-fips and / or openssh-helpers packages.");
  ...
  script_set_attribute(attribute:"patch_publication_date", value:"2023/07/23");
...
var pkgs = [
    {'reference':'openssh-7.2p2-74.63.1', 'sp':'2', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE, 'exists_check':['sles-bcl-release-12.2']},
    {'reference':'openssh-askpass-gnome-7.2p2-74.63.1', 'sp':'2', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE, 'exists_check':['sles-bcl-release-12.2']},
    {'reference':'openssh-fips-7.2p2-74.63.1', 'sp':'2', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE, 'exists_check':['sles-bcl-release-12.2']},
    {'reference':'openssh-helpers-7.2p2-74.63.1', 'sp':'2', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE, 'exists_check':['sles-bcl-release-12.2']}
];
