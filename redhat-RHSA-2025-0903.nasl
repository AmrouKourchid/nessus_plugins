...
# extracted from Red Hat Security Advisory RHSA-2025:0903. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:0903");

  script_name(english:"RHEL 8 : libsoup (RHSA-2025:0903)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_0903.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bdda2b6a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:0903");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libsoup package based on the guidance in RHSA-2025:0903.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libsoup-2.62.3-1.el8_2.2', 'sp':'2', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsoup-2.62.3-1.el8_2.2', 'sp':'2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
