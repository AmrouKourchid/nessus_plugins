...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : dovecot (EulerOS-SA-2020-2152)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2152
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6552a096");
...
pkgs = ["dovecot-2.3.3-1.h10.eulerosv2r8",
        "dovecot-mysql-2.3.3-1.h10.eulerosv2r8",
        "dovecot-pigeonhole-2.3.3-1.h10.eulerosv2r8"];
