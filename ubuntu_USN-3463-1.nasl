...
# extracted from Ubuntu Security Notice USN-3463-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS : Werkzeug vulnerability (USN-3463-1)");
...
in the USN-3463-1 advisory.

    It was discovered that Werkzeug did not properly handle certain web scripts. A remote attacker could use
    this to inject arbitrary code via a field that contains an exception message.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3463-1");
...
"Update the affected python-werkzeug and / or python3-werkzeug packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-10516");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'python-werkzeug', 'pkgver': '0.9.4+dfsg-1.1ubuntu2.1'},
    {'osver': '14.04', 'pkgname': 'python3-werkzeug', 'pkgver': '0.9.4+dfsg-1.1ubuntu2.1'},
    {'osver': '16.04', 'pkgname': 'python-werkzeug', 'pkgver': '0.10.4+dfsg1-1ubuntu1.1'},
    {'osver': '16.04', 'pkgname': 'python3-werkzeug', 'pkgver': '0.10.4+dfsg1-1ubuntu1.1'}
];
