...
# extracted from Red Hat Security Advisory RHSA-2019:1734. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2019-10141");
  script_xref(name:"RHSA", value:"2019:1734");

  script_name(english:"RHEL 7 : openstack-ironic-inspector (RHSA-2019:1734)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for openstack-ironic-inspector.");
...
the RHSA-2019:1734 advisory.

    ironic-inspector is an auxiliary service for discovering hardware properties for a node managed by Ironic.
    Hardware introspection or hardware properties discovery is a process of getting hardware parameters
    required for scheduling from a bare metal node, given its power management credentials (e.g. IPMI address,
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_1734.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?385fb752");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1711722");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1717086");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:1734");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL openstack-ironic-inspector package based on the guidance in RHSA-2019:1734.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-10141");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openstack-ironic-inspector-7.2.3-3.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'openstack-ironic-inspector');
}
