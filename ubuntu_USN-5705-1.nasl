...
the USN-5705-1 advisory.
    ...
    Chintan Shah discovered that LibTIFF incorrectly handled memory in certain conditions. An attacker could
    trick a user into processing a specially crafted image file and potentially use this issue to allow for
    information disclosure or to cause the application to crash. (CVE-2022-3570)

    It was discovered that LibTIFF incorrectly handled memory in certain conditions. An attacker could trick a
    user into processing a specially crafted tiff file and potentially use this issue to cause a denial of
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libtiff-opengl', 'pkgver': '4.0.6-1ubuntu0.8+esm6', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libtiff-tools', 'pkgver': '4.0.6-1ubuntu0.8+esm6', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libtiff5', 'pkgver': '4.0.6-1ubuntu0.8+esm6', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libtiff5-dev', 'pkgver': '4.0.6-1ubuntu0.8+esm6', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libtiffxx5', 'pkgver': '4.0.6-1ubuntu0.8+esm6', 'ubuntu_pro': TRUE}
];
