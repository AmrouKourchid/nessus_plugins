...
# extracted from Fedora Security Advisory FEDORA-2023-904f92af98
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-904f92af98");

  script_name(english:"Fedora 37 : cups (2023-904f92af98)");
...
FEDORA-2023-904f92af98 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-904f92af98");
...
var pkgs = [
    {'reference':'cups-2.4.7-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
