...
if (description)
{
  ...
  script_cve_id("CVE-2024-41864");
  script_xref(name:"IAVB", value:"2024-B-0111-S");

  script_name(english:"Adobe Substance 3D Designer < 14.0 (apsb24-67)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Substance 3D Designer installed on the remote host is prior to 14.0. It is, therefore, affected by
a vulnerability as referenced in the apsb24-67 advisory.

  - Substance3D - Designer versions 13.1.2 and earlier are affected by an out-of-bounds write vulnerability
    that could result in arbitrary code execution in the context of the current user. Exploitation of this
    issue requires user interaction in that a victim must open a malicious file. (CVE-2024-41864)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://helpx.adobe.com/security/products/substance3d_designer/apsb24-67.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cf087db2");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Adobe Substance 3D Designer version 14.0 or later.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:N/UI:R/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-41864");
...
var constraints = [
  { 'max_version' : '13.1.2', 'fixed_version' : '14.0' }
];
