...
ELSA-2019-2591 advisory.

    - Resolves: #1744010 - CVE-2019-14811 ghostscript: Safer Mode Bypass by .forceput Exposure in
    .pdf_hook_DSC_Creator (701445)
    - Resolves: #1744014 - CVE-2019-14812 ghostscript: Safer Mode Bypass by .forceput Exposure in
    setuserparams (701444)
    - Resolves: #1744005 - CVE-2019-14813 ghostscript: Safer Mode Bypass by .forceput Exposure in
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2019-2591.html");
...
var pkgs = [
    ...
    {'reference':'libgs-9.25-2.el8_0.3', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libgs-devel-9.25-2.el8_0.3', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
