...
# extracted from Ubuntu Security Notice USN-7259-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"7259-2");

  script_name(english:"Ubuntu 16.04 LTS : GNU C Library vulnerability (USN-7259-2)");
...
USN-7259-2 advisory.
    ...
    USN-7259-1 fixed a vulnerability in GNU C Library. This update provides the corresponding update for
    Ubuntu 16.04 LTS.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7259-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'glibc-source', 'pkgver': '2.23-0ubuntu11.3+esm8', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libc-bin', 'pkgver': '2.23-0ubuntu11.3+esm8', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libc-dev-bin', 'pkgver': '2.23-0ubuntu11.3+esm8', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libc6', 'pkgver': '2.23-0ubuntu11.3+esm8', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libc6-amd64', 'pkgver': '2.23-0ubuntu11.3+esm8', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libc6-armel', 'pkgver': '2.23-0ubuntu11.3+esm8', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libc6-dev', 'pkgver': '2.23-0ubuntu11.3+esm8', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libc6-dev-amd64', 'pkgver': '2.23-0ubuntu11.3+esm8', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libc6-dev-armel', 'pkgver': '2.23-0ubuntu11.3+esm8', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libc6-dev-i386', 'pkgver': '2.23-0ubuntu11.3+esm8', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libc6-dev-s390', 'pkgver': '2.23-0ubuntu11.3+esm8', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libc6-dev-x32', 'pkgver': '2.23-0ubuntu11.3+esm8', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libc6-i386', 'pkgver': '2.23-0ubuntu11.3+esm8', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libc6-pic', 'pkgver': '2.23-0ubuntu11.3+esm8', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libc6-s390', 'pkgver': '2.23-0ubuntu11.3+esm8', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libc6-x32', 'pkgver': '2.23-0ubuntu11.3+esm8', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'locales', 'pkgver': '2.23-0ubuntu11.3+esm8', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'locales-all', 'pkgver': '2.23-0ubuntu11.3+esm8', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'multiarch-support', 'pkgver': '2.23-0ubuntu11.3+esm8', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'nscd', 'pkgver': '2.23-0ubuntu11.3+esm8', 'ubuntu_pro': TRUE}
];
