...
# extracted from Red Hat Security Advisory RHSA-2022:8263. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:8263");

  script_name(english:"RHEL 9 : dpdk (RHSA-2022:8263)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for dpdk.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2022:8263 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8263.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6fd6f416");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8263");
...
"Update the RHEL dpdk package based on the guidance in RHSA-2022:8263.");
...
var constraints = [
  {
    ...
    'pkgs': [
      ...
      {'reference':'dpdk-21.11.2-1.el9_1', 'cpu':'ppc64le', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      ...
      {'reference':'dpdk-devel-21.11.2-1.el9_1', 'cpu':'ppc64le', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      ...
      {'reference':'dpdk-tools-21.11.2-1.el9_1', 'cpu':'ppc64le', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
