...
# extracted from Fedora Security Advisory FEDORA-2023-00572178e1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-00572178e1");

  script_name(english:"Fedora 38 : yajl (2023-00572178e1)");
...
FEDORA-2023-00572178e1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-00572178e1");
  script_set_attribute(attribute:"solution", value:
"Update the affected yajl package.");
  ...
  script_set_attribute(attribute:"plugin_publication_date", value:"2023/07/16");

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"cpe:/o:fedoraproject:fedora:38");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:yajl");
...
var pkgs = [
    {'reference':'yajl-2.1.0-21.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
