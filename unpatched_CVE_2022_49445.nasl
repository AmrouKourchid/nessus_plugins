...
if (description)
{
  ...
  script_cve_id("CVE-2022-49445");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-49445");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: pinctrl: renesas: core: Fix possible
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-49445");
