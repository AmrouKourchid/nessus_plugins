...
if (description)
{
  ...
  script_name(english:"Adobe Digital Editions < 4.5.10.186048 Arbitrary Code Execution (APSB19-16)");
...
"The version of Adobe Digital Editions installed on the remote Windows host is prior to 4.5.10.186048. It is, therefore,
affected by a vulnerability as referenced in the APSB19-16 advisory.

  - Adobe Digital Editions versions 4.5.10.185749 and below have a heap overflow vulnerability. Successful
    exploitation could lead to arbitrary code execution. (CVE-2019-7095)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://helpx.adobe.com/security/products/Digital-Editions/apsb19-16.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?88a70056");
