...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_3976.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?75ddd6ea");
...
"Update the RHEL tcpdump package based on the guidance in RHSA-2019:3976.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'tcpdump-4.9.2-4.el7_7.1', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'14'},
      {'reference':'tcpdump-4.9.2-4.el7_7.1', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'14'},
      {'reference':'tcpdump-4.9.2-4.el7_7.1', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'14'},
      {'reference':'tcpdump-4.9.2-4.el7_7.1', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'14'}
    ]
  }
];
