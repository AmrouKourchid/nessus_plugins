...
if (description)
{
  ...
  script_cve_id("CVE-2025-21761");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2025-21761");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: openvswitch: use RCU protection in
    ovs_vport_cmd_fill_info() ovs_vport_cmd_fill_info() can be called without RTNL or RCU. Use RCU protection
    and dev_net_rcu() to avoid potential UAF. (CVE-2025-21761)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-21761");
