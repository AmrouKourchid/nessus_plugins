...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5022338");
  script_xref(name:"MSKB", value:"5022339");
  script_xref(name:"MSFT", value:"MS23-5022338");
  script_xref(name:"MSFT", value:"MS23-5022339");
  script_xref(name:"IAVA", value:"2023-A-0025-S");
  script_xref(name:"IAVA", value:"2023-A-0027-S");

  script_name(english:"KB5022339: Windows Server 2008 R2 Security Update (January 2023)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5022339");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5022338");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5022339");
...
if (
  smb_check_rollup(os:'6.1',
                   ...
                   rollup_date:'01_2023',
                   bulletin:bulletin,
                   rollup_kb_list:[5022339, 5022338])
)
{
