...
referenced in the RHSA-2019:2002 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_2002.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b72108bc");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:2002");
...
"Update the RHEL redis:5 package based on the guidance in RHSA-2019:2002.");
  ...
  'redis:5': [
    {
      ...
      'pkgs': [
        {'reference':'redis-5.0.3-2.module+el8.0.0.z+3657+acb471dc', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'redis-devel-5.0.3-2.module+el8.0.0.z+3657+acb471dc', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'redis-doc-5.0.3-2.module+el8.0.0.z+3657+acb471dc', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
