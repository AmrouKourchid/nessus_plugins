...
# extracted from Fedora Security Advisory FEDORA-2024-24fbd327e3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-24fbd327e3");
  script_xref(name:"IAVA", value:"2024-A-0695-S");

  script_name(english:"Fedora 41 : firefox (2024-24fbd327e3)");
...
FEDORA-2024-24fbd327e3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-24fbd327e3");
...
var pkgs = [
    {'reference':'firefox-132.0-2.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
