...
by triggering a race condition with the vulnerable component.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K51674118");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K51674118.");
...
var vmatrix = {
  'AFM': {
    'affected': [
      '16.0.0-16.0.1','15.0.0-15.1.3','14.0.0-14.1.4','13.1.0-13.1.4','12.1.0-12.1.6','11.5.2-11.6.5'
    ],
    'unaffected': [
