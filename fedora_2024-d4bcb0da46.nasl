...
# extracted from Fedora Security Advisory FEDORA-2024-d4bcb0da46
#
...
if (description)
{
  ...
  script_cve_id("CVE-2024-45157");
  script_xref(name:"FEDORA", value:"2024-d4bcb0da46");

  script_name(english:"Fedora 41 : mbedtls (2024-d4bcb0da46)");
...
FEDORA-2024-d4bcb0da46 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-d4bcb0da46");
...
"Update the affected mbedtls package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-45157");
...
var pkgs = [
    {'reference':'mbedtls-2.28.9-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
