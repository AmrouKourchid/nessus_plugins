...
# extracted from Red Hat Security Advisory kubernetes. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : kubernetes (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2017-1000056");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:kubernetes");
