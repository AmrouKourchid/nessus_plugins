...
# SUSE update advisory SUSE-SU-2022:4592-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:4592-1");

  script_name(english:"SUSE SLES15 Security Update : cni (SUSE-SU-2022:4592-1)");
...
in the SUSE-SU-2022:4592-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-December/013299.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?52fa6c31");
...
var pkgs = [
    {'reference':'cni-0.7.1-150100.3.8.1', 'sp':'2', 'cpu':'x86_64', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.2']},
    {'reference':'cni-0.7.1-150100.3.8.1', 'sp':'3', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.3']},
    {'reference':'cni-0.7.1-150100.3.8.1', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.3', 'sle-module-containers-release-15.3', 'sles-release-15.3']}
];
