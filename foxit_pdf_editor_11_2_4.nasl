...
if (description)
{
  ...
  script_name(english:"Foxit PDF Editor < 11.2.4 Multiple Vulnerabilities");
...
Windows host is prior to 11.2.4. It is, therefore affected by multiple vulnerabilities:
...
var constraints = [
  { 'max_version' : '10.1.9.37808', 'fixed_version' : '11.2.4' },
  { 'min_version' : '11.0', 'max_version' : '11.2.3.53593', 'fixed_version' : '11.2.4' }
];
