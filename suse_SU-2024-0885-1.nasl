...
# SUSE update advisory SUSE-SU-2024:0885-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2024:0885-1");

  script_name(english:"SUSE SLES12 Security Update : spectre-meltdown-checker (SUSE-SU-2024:0885-1)");
...
in the SUSE-SU-2024:0885-1 advisory.
...
number.");
  # https://lists.suse.com/pipermail/sle-security-updates/2024-March/018178.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?674522a7");
...
var pkgs = [
    {'reference':'spectre-meltdown-checker-0.46-3.9.1', 'sp':'5', 'cpu':'x86_64', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5']},
    {'reference':'spectre-meltdown-checker-0.46-3.9.1', 'sp':'5', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.5']}
];
