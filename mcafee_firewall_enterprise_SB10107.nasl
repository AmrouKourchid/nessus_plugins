...
advisory.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-1414");
...
var app_name = "McAfee Firewall Enterprise";
var version = get_kb_item_or_exit("Host/McAfeeFE/version");
var version_display = get_kb_item_or_exit("Host/McAfeeFE/version_display");
var installed_patches = get_kb_item_or_exit("Host/McAfeeFE/installed_patches");

var patchmap = make_array(
  "^8\.2\.1(\.|$)"                   , make_list("8.2.1E138"),
  "^8\.3\.[0-1](\.|$)"               , make_list("8.3.1E73"),
  "^8\.3\.2(\.[\d]$|\.1[0-2])"       , make_list("8.3.2E45","8.3.2P11")
);

var fix_displays = make_array(
  "^8\.2\.1(\.|$)"                 , "8.2.1 ePatch 138",
  "^8\.3\.[0-1](\.|$)"             , "8.3.1 ePatch 73",
  "^8\.3\.2(\.[\d]$|\.1[0-2])"     , "8.3.2 ePatch 45 or Patch 11"
);

var patches       = NULL;
var fix_display   = NULL;
var patch_missing = TRUE;
var vergx, patch, port, report;
