...
if (description)
{
  ...
  script_cve_id("CVE-2024-53008", "CVE-2025-32464");
  script_xref(name:"IAVB", value:"2024-B-0190");

  script_name(english:"Photon OS 4.0: Haproxy PHSA-2025-4.0-0781");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'haproxy-2.6.15-2.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'haproxy-doc-2.6.15-2.ph4')) flag++;
