...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : icu (EulerOS-SA-2022-1009)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1009
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f66b114c");
...
var pkgs = [
  "libicu-62.1-5.h1.r2.eulerosv2r9",
  "libicu-devel-62.1-5.h1.r2.eulerosv2r9"
];
