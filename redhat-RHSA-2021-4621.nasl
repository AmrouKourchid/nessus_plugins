...
# extracted from Red Hat Security Advisory RHSA-2021:4621. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:4621");

  script_name(english:"RHEL 8 : freerdp (RHSA-2021:4621)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for freerdp.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2021:4621 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_4621.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6a1ddc19");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:4621");
...
"Update the RHEL freerdp package based on the guidance in RHSA-2021:4621.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'freerdp-2.0.0-46.rc4.el8_2.5', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'freerdp-devel-2.0.0-46.rc4.el8_2.5', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'freerdp-libs-2.0.0-46.rc4.el8_2.5', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'libwinpr-2.0.0-46.rc4.el8_2.5', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'libwinpr-devel-2.0.0-46.rc4.el8_2.5', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
    ]
  }
];
