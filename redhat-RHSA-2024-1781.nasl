...
# extracted from Red Hat Security Advisory RHSA-2024:1781. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:1781");

  script_name(english:"RHEL 8 : bind9.16 (RHSA-2024:1781)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for bind9.16.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:1781 advisory.
    ...
    * bind9: Querying RFC 1918 reverse zones may cause an assertion failure when nxdomain-redirect is
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_1781.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8dcf7119");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:1781");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL bind9.16 package based on the guidance in RHSA-2024:1781.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'bind9.16-9.16.23-0.16.el8_9.2', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind9.16-chroot-9.16.23-0.16.el8_9.2', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind9.16-devel-9.16.23-0.16.el8_9.2', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind9.16-dnssec-utils-9.16.23-0.16.el8_9.2', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind9.16-doc-9.16.23-0.16.el8_9.2', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind9.16-libs-9.16.23-0.16.el8_9.2', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind9.16-license-9.16.23-0.16.el8_9.2', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind9.16-utils-9.16.23-0.16.el8_9.2', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
