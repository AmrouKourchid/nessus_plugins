...
if (description)
{
  ...
  script_cve_id("CVE-2022-49283");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-49283");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: firmware: sysfb: fix platform-device
    leak in error path Make sure to free the platform device also in the unlikely event that registration
    fails. (CVE-2022-49283)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-49283");
