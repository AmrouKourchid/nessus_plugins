...
# extracted from Debian Security Advisory dsa-5470. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-5470-1 : python-werkzeug - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2023/dsa-5470");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'python-werkzeug-doc', 'reference': '1.0.1+dfsg1-2+deb11u1'},
    {'release': '11.0', 'prefix': 'python3-werkzeug', 'reference': '1.0.1+dfsg1-2+deb11u1'}
];
