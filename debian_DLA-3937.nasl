...
# extracted from Debian Security Advisory dla-3937. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3937 : libnss3 - security update");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'libnss3', 'reference': '2:3.61-1+deb11u4'},
    {'release': '11.0', 'prefix': 'libnss3-dev', 'reference': '2:3.61-1+deb11u4'},
    {'release': '11.0', 'prefix': 'libnss3-tools', 'reference': '2:3.61-1+deb11u4'}
];
