...
# extracted from Red Hat Security Advisory gcc-toolset-10-binutils. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2021-20284");

  script_name(english:"RHEL 8 : gcc-toolset-10-binutils (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-20284");
