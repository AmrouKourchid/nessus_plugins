...
# extracted from Gentoo Linux Security Advisory GLSA 202007-48.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202007-48");

  script_name(english:"GLSA-202007-48 : OCaml: Arbitrary code execution");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202007-48
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202007-48");
...
if (qpkg_check(package:"dev-lang/ocaml", unaffected:make_list("ge 4.09.0"), vulnerable:make_list("lt 4.09.0"))) flag++;
