...
"The version of Firefox installed on the remote Windows host is prior to 118.0.1. It is, therefore, affected by a
...
mozilla_check_version(installs:installs, product:'firefox', esr:FALSE, fix:'118.0.1', severity:SECURITY_HOLE);
