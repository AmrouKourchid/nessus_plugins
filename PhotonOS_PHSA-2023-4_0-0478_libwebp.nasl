...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Libwebp PHSA-2023-4.0-0478");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libwebp-1.1.0-7.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libwebp-devel-1.1.0-7.ph4')) flag++;
