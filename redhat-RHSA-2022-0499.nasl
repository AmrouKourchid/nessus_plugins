...
# extracted from Red Hat Security Advisory RHSA-2022:0499. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:0499");
  script_xref(name:"IAVA", value:"2022-A-0078-S");
  script_xref(name:"IAVA", value:"2022-A-0101");

  script_name(english:"RHEL 7 : .NET 5.0 on RHEL 7 (RHSA-2022:0499)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2022:0499 advisory.
    ...
    .NET SDK 5.0.211 and .NET Runtime 5.0.14.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_0499.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c0341af0");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:0499");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-dotnet50-aspnetcore-runtime-5.0-5.0.14-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet50'},
      {'reference':'rh-dotnet50-aspnetcore-targeting-pack-5.0-5.0.14-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet50'},
      {'reference':'rh-dotnet50-dotnet-5.0.211-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet50'},
      {'reference':'rh-dotnet50-dotnet-apphost-pack-5.0-5.0.14-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet50'},
      {'reference':'rh-dotnet50-dotnet-host-5.0.14-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet50'},
      {'reference':'rh-dotnet50-dotnet-hostfxr-5.0-5.0.14-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet50'},
      {'reference':'rh-dotnet50-dotnet-runtime-5.0-5.0.14-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet50'},
      {'reference':'rh-dotnet50-dotnet-sdk-5.0-5.0.211-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet50'},
      {'reference':'rh-dotnet50-dotnet-sdk-5.0-source-built-artifacts-5.0.211-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet50'},
      {'reference':'rh-dotnet50-dotnet-targeting-pack-5.0-5.0.14-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet50'},
      {'reference':'rh-dotnet50-dotnet-templates-5.0-5.0.211-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet50'},
      {'reference':'rh-dotnet50-netstandard-targeting-pack-2.1-5.0.211-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet50'}
    ]
  }
];
