...
# extracted from VMware Security Advisory PHSA-2019-2.0-0145. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Cairo PHSA-2019-2.0-0145");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the cairo package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-2-145.md");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'cairo-1.16.0-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'cairo-debuginfo-1.16.0-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'cairo-devel-1.16.0-1.ph2')) flag++;
