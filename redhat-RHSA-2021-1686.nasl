...
# extracted from Red Hat Security Advisory RHSA-2021:1686. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:1686");

  script_name(english:"RHEL 8 : wpa_supplicant (RHSA-2021:1686)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_1686.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fe5389c8");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:1686");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'wpa_supplicant-2.9-5.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
