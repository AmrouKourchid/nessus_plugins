...
if (description)
{
  ...
  script_cve_id("CVE-2025-21354", "CVE-2025-21362", "CVE-2025-21364");

  script_name(english:"Security Updates for Microsoft Excel Products C2R (January 2025)");
...
"The Microsoft Excel Products are missing a security update. It is, therefore, affected by the following vulnerabilities:
  ...
  - Microsoft Office is affected by a remote code execution vulnerability. (CVE-2025-21354, CVE-2025-21362)
...
manually perform an update.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-21364");
