...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Polkit PHSA-2019-2.0-0161");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'polkit-0.113-4.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'polkit-debuginfo-0.113-4.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'polkit-devel-0.113-4.ph2')) flag++;
