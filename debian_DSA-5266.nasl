...
# extracted from Debian Security Advisory dsa-5266. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-5266-1 : expat - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has packages installed that are affected by a vulnerability as referenced in the dsa-5266
advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=1022743");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/expat");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2022/dsa-5266");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-43680");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'expat', 'reference': '2.2.10-2+deb11u5'},
    {'release': '11.0', 'prefix': 'libexpat1', 'reference': '2.2.10-2+deb11u5'},
    {'release': '11.0', 'prefix': 'libexpat1-dev', 'reference': '2.2.10-2+deb11u5'},
    {'release': '11.0', 'prefix': 'libexpat1-udeb', 'reference': '2.2.10-2+deb11u5'}
];
