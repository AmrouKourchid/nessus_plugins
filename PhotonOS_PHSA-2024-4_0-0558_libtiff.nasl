...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Libtiff PHSA-2024-4.0-0558");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libtiff-4.5.1-3.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libtiff-devel-4.5.1-3.ph4')) flag++;
