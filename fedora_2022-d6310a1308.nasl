...
# extracted from Fedora Security Advisory FEDORA-2022-d6310a1308
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-d6310a1308");

  script_name(english:"Fedora 37 : freerdp (2022-d6310a1308)");
...
FEDORA-2022-d6310a1308 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-d6310a1308");
...
var pkgs = [
    {'reference':'freerdp-2.8.1-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
