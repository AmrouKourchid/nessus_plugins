...
# extracted from Slackware Security Advisory SSA:2024-297-01. The text
...
if (description)
{
  ...
  script_name(english:"Slackware Linux 15.0 php81  Multiple Vulnerabilities (SSA:2024-297-01)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Slackware Linux host is missing a security update to php81.");
  script_set_attribute(attribute:"description", value:
"The version of php81 installed on the remote host is prior to 8.1.30. It is, therefore, affected by multiple
vulnerabilities as referenced in the SSA:2024-297-01 advisory.
...
number.");
  # http://www.slackware.com/security/viewer.php?l=slackware-security&y=2024&m=slackware-security.336900
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bec5ab70");
...
var flag = 0;
var constraints = [
    { 'fixed_version' : '8.1.30', 'product' : 'php81', 'os_name' : 'Slackware Linux', 'os_version' : '15.0', 'service_pack' : '1_slack15.0', 'arch' : 'i586' },
    { 'fixed_version' : '8.1.30', 'product' : 'php81', 'os_name' : 'Slackware Linux', 'os_version' : '15.0', 'service_pack' : '1_slack15.0', 'arch' : 'x86_64' }
];
