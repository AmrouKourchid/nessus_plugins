...
# <script src="/assets/jquery-2.0.0.min-8b725cb067669e0312f03874c5f05ff3e4193e02685a9876cea2c7a91d79225a.js"></script>
pattern = 'src=["\']([^ ]+jquery-?([0-9\\.]+)?(?:\\.min|\\.slim|\\.slim\\.min)*(?:-(?:[a-f]|[0-9])*)?\\.js[^"]*)["\']';
