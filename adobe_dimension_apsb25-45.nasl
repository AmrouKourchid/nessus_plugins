...
if (description)
{
  ...
  script_name(english:"Adobe Dimension < 4.1.2 Multiple Arbitrary code execution (APSB25-45)");

  script_set_attribute(attribute:"synopsis", value:
"The Adobe Dimension instance installed on the remote host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Dimension installed on the remote Windows host is prior to 4.1.2. It is, therefore, affected by
