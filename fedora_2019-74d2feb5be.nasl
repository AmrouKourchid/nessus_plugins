...
# extracted from Fedora Security Advisory FEDORA-2019-74d2feb5be.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : rabbitmq-server (2019-74d2feb5be)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-74d2feb5be");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"rabbitmq-server-3.7.22-1.fc30")) flag++;
