...
# extracted from Fedora Security Advisory FEDORA-2022-30ce1cbe6e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-30ce1cbe6e");

  script_name(english:"Fedora 37 : tomcat (2022-30ce1cbe6e)");
...
FEDORA-2022-30ce1cbe6e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-30ce1cbe6e");
...
var pkgs = [
    {'reference':'tomcat-9.0.59-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
