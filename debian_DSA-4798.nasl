...
# extracted from Debian Security Advisory DSA-4798. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"4798");

  script_name(english:"Debian DSA-4798-1 : spip - security update");
...
execute arbitrary code.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2020/dsa-4798");
...
flag = 0;
if (deb_check(release:"10.0", prefix:"spip", reference:"3.2.4-1+deb10u3")) flag++;
