...
# extracted from SUSE update advisory SUSE-SU-2018:2335-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES11 Security Update : Security update to ucode-intel (SUSE-SU-2018:2335-1) (Foreshadow) (Spectre)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=1104134");
  ...
  # https://www.suse.com/support/update/announcement/2018/suse-su-20182335-1/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9398cc22");
...
slessp4-microcode_ctl-13730=1

SUSE Linux Enterprise Server 11-SP3-LTSS:zypper in -t patch
slessp3-microcode_ctl-13730=1

SUSE Linux Enterprise Point of Sale 11-SP3:zypper in -t patch
sleposp3-microcode_ctl-13730=1");
...
flag = 0;
if (rpm_check(release:"SLES11", sp:"4", cpu:"x86_64", reference:"microcode_ctl-1.17-102.83.27.1")) flag++;
if (rpm_check(release:"SLES11", sp:"4", cpu:"i586", reference:"microcode_ctl-1.17-102.83.27.1")) flag++;
if (rpm_check(release:"SLES11", sp:"3", cpu:"x86_64", reference:"microcode_ctl-1.17-102.83.27.1")) flag++;
if (rpm_check(release:"SLES11", sp:"3", cpu:"i586", reference:"microcode_ctl-1.17-102.83.27.1")) flag++;
