...
# AlmaLinux Security Advisory ALSA-2023:5201.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:5201");
  ...
  script_name(english:"AlmaLinux 8 : thunderbird (ALSA-2023:5201)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2023-5201.html");
...
var pkgs = [
    {'reference':'thunderbird-102.15.1-1.el8_8.alma', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'thunderbird-102.15.1-1.el8_8.alma', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
