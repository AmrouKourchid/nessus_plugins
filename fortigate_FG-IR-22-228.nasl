...
if (description)
{
  ...
  script_name(english:"Fortinet Fortigate RSA SSH host key lost at shutdown (FG-IR-22-228)");
...
vulnerability as referenced in the FG-IR-22-228 advisory.

  - A key management error vulnerability [CWE-320] affecting the RSA SSH host key in FortiOS 7.2.0 and below,
    7.0.6 and below, 6.4.9 and below may allow an unauthenticated attacker to perform a man in the middle
    attack. (CVE-2022-30307)
...
"Please upgrade to FortiOS version 6.4.10/7.0.8/7.2.2 or later.");
...
var constraints = [
  ...
  { 'min_version' : '7.0.1', 'max_version' : '7.0.6', 'fixed_version' : '7.0.8' },
