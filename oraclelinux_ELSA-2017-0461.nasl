...
# Oracle Linux Security Advisory ELSA-2017-0461 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : firefox (ELSA-2017-0461)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2017-0461.html");
...
var pkgs = [
    {'reference':'firefox-52.0-4.0.1.el7_3', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-52.0-4.0.1.el7_3', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
