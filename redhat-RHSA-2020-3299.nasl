...
# extracted from Red Hat Security Advisory RHSA-2020:3299. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:3299");

  script_name(english:"RHEL 8 : python-pillow (RHSA-2020:3299)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_3299.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4913c39d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:3299");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1852814");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-pillow package based on the guidance in RHSA-2020:3299.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-pillow-5.1.1-11.el8_1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
