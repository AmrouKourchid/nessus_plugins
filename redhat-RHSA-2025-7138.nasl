...
# extracted from Red Hat Security Advisory RHSA-2025:7138. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:7138");

  script_name(english:"RHEL 9 : protobuf (RHSA-2025:7138)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for protobuf.");
...
the RHSA-2025:7138 advisory.

    The protobuf packages provide Protocol Buffers, Google's data interchange format. Protocol Buffers can
    encode structured data in an efficient yet extensible format, and provide a flexible, efficient, and
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2291470");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-40572");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_7138.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fb5800a7");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:7138");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL protobuf package based on the guidance in RHSA-2025:7138.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:protobuf");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:protobuf-compiler");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:protobuf-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:protobuf-lite");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:protobuf-lite-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:python3-protobuf");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'protobuf-3.14.0-16.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'protobuf-compiler-3.14.0-16.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'protobuf-devel-3.14.0-16.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'protobuf-lite-3.14.0-16.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'protobuf-lite-devel-3.14.0-16.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-protobuf-3.14.0-16.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'protobuf / protobuf-compiler / protobuf-devel / protobuf-lite / etc');
}
