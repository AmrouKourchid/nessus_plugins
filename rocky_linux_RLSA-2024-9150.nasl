...
# Rocky Linux Security Advisory RLSA-2024:9150.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2024:9150");

  script_name(english:"RockyLinux 9 : python-jinja2 (RLSA-2024:9150)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2024:9150");
...
var pkgs = [
    {'reference':'python3-jinja2-2.11.3-6.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'}
];
