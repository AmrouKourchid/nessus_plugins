...
# Oracle Linux Security Advisory ELSA-2011-0478 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : libvirt (ELSA-2011-0478)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2011-0478.html");
...
var pkgs = [
    {'reference':'libvirt-0.8.2-15.0.1.el5_6.4', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libvirt-devel-0.8.2-15.0.1.el5_6.4', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libvirt-python-0.8.2-15.0.1.el5_6.4', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libvirt-0.8.2-15.0.1.el5_6.4', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libvirt-devel-0.8.2-15.0.1.el5_6.4', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libvirt-python-0.8.2-15.0.1.el5_6.4', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
