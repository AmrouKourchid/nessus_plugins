...
# extracted from Fedora Security Advisory FEDORA-2023-e57f5a2301
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-e57f5a2301");

  script_name(english:"Fedora 39 : golang (2023-e57f5a2301)");
...
FEDORA-2023-e57f5a2301 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-e57f5a2301");
...
var pkgs = [
    {'reference':'golang-1.21.5-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
