...
# extracted from Fedora Security Advisory FEDORA-2024-04ba1ff731
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-04ba1ff731");

  script_name(english:"Fedora 40 : freeradius (2024-04ba1ff731)");
...
FEDORA-2024-04ba1ff731 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-04ba1ff731");
...
var pkgs = [
    {'reference':'freeradius-3.2.5-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
