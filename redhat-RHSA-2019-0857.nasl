...
# extracted from Red Hat Security Advisory RHSA-2019:0857. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:0857");

  script_name(english:"RHEL 6 : Red Hat Single Sign-On 7.2.7 security update on RHEL 6 (Moderate) (RHSA-2019:0857)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_0857.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?103d130d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:0857");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1679144");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/JBEAP-16661");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat Single Sign-On 7.2.7 package based on the guidance in RHSA-2019:0857.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-sso7-keycloak-3.4.17-1.Final_redhat_00001.1.jbcs.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-sso'},
      {'reference':'rh-sso7-keycloak-server-3.4.17-1.Final_redhat_00001.1.jbcs.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-sso'}
    ]
  }
];
