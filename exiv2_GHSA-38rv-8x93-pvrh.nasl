...
if (description)
{
  ...
  script_name(english:"Exiv2 0.28.x < 0.28.3 (GHSA-38rv-8x93-pvrh)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of Exiv2 installed on the remote host is prior to 0.28.3. It is, therefore, affected by a vulnerability as
referenced in the GHSA-38rv-8x93-pvrh advisory.
...
"Upgrade Exiv2 based upon the guidance specified in GHSA-38rv-8x93-pvrh.");
  ...
  script_set_attribute(attribute:"cpe", value:"cpe:/a:exiv2:exiv2");
  ...
  script_dependencies("exiv2_nix_installed.nbin");
  script_require_keys("installed_sw/Exiv2");
...
var app_info = vcf::get_app_info(app:'Exiv2');
