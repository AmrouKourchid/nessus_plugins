...
# extracted from Fedora Security Advisory FEDORA-2024-d20a106350
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-d20a106350");

  script_name(english:"Fedora 40 : microcode_ctl (2024-d20a106350)");
...
FEDORA-2024-d20a106350 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-d20a106350");
...
var pkgs = [
    {'reference':'microcode_ctl-2.1-61.5.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
