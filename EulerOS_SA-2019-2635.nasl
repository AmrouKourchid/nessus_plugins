...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : netpbm (EulerOS-SA-2019-2635)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2635
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?516299d8");
...
pkgs = ["netpbm-10.61.02-9.h2",
        "netpbm-devel-10.61.02-9.h2",
        "netpbm-progs-10.61.02-9.h2"];
