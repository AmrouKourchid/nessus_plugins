...
# extracted from Fedora Security Advisory FEDORA-2024-583e4098b9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-583e4098b9");

  script_name(english:"Fedora 38 : zbar (2024-583e4098b9)");
...
FEDORA-2024-583e4098b9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-583e4098b9");
...
var pkgs = [
    {'reference':'zbar-0.23.93-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
