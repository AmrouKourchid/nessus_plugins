...
# extracted from Red Hat Security Advisory RHSA-2025:1813. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:1813");

  script_name(english:"RHEL 9 : python3.11-urllib3 (RHSA-2025:1813)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_1813.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a2e73f3f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:1813");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python3.11-urllib3 package based on the guidance in RHSA-2025:1813.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3.11-urllib3-1.26.12-1.el9_2.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
