...
# extracted from Fedora Security Advisory FEDORA-2024-e74783429c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-e74783429c");

  script_name(english:"Fedora 39 : libxls (2024-e74783429c)");
...
FEDORA-2024-e74783429c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-e74783429c");
...
var pkgs = [
    {'reference':'libxls-1.6.2-14.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
