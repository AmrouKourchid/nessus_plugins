...
# extracted from Fedora Security Advisory FEDORA-2022-1e14f3ae45
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-1e14f3ae45");

  script_name(english:"Fedora 37 : vim (2022-1e14f3ae45)");
...
FEDORA-2022-1e14f3ae45 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-1e14f3ae45");
...
var pkgs = [
    {'reference':'vim-9.0.1006-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
