...
# extracted from Fedora Security Advisory FEDORA-2019-232f092db0.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-232f092db0");

  script_name(english:"Fedora 31 : python3 (2019-232f092db0)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-232f092db0");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"python3-3.7.5-1.fc31")) flag++;
