...
# extracted from Gentoo Linux Security Advisory GLSA 202409-23.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202409-23 : ZNC: Remote Code Execution");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202409-23 (ZNC: Remote Code Execution)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202409-23");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=935422");
...
var packages = [
  {
    'name' : 'net-irc/znc',
    'unaffected' : make_list("ge 1.9.1"),
    'vulnerable' : make_list("lt 1.9.1")
  }
];
