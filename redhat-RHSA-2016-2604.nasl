...
"The remote Red Hat host is missing a security update for resteasy-base.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2016:2604 advisory.

    RESTEasy contains a JBoss project that provides frameworks to help build RESTful Web Services and RESTful
    Java applications. It is a fully certified and portable implementation of the JAX-RS specification.

    Security Fix(es):

    * It was discovered that under certain conditions RESTEasy could be forced to parse a request with
    SerializableProvider, resulting in deserialization of potentially untrusted data. An attacker could
    possibly use this flaw to execute arbitrary code with the permissions of the application using RESTEasy.
    (CVE-2016-7050)
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?52421099");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2016:2604");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1280539");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1357624");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1378613");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL resteasy-base package based on the guidance in RHSA-2016:2604.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-7050");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'resteasy-base-3.0.6-4.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'resteasy-base-atom-provider-3.0.6-4.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'resteasy-base-client-3.0.6-4.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'resteasy-base-jackson-provider-3.0.6-4.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'resteasy-base-javadoc-3.0.6-4.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'resteasy-base-jaxb-provider-3.0.6-4.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'resteasy-base-jaxrs-3.0.6-4.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'resteasy-base-jaxrs-all-3.0.6-4.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'resteasy-base-jaxrs-api-3.0.6-4.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'resteasy-base-jettison-provider-3.0.6-4.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'resteasy-base-providers-pom-3.0.6-4.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'resteasy-base-resteasy-pom-3.0.6-4.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'resteasy-base-tjws-3.0.6-4.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
