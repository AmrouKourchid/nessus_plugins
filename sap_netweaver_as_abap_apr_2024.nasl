...
if (description)
{
  ...
  script_cve_id("CVE-2024-30218");
  script_xref(name:"IAVA", value:"2024-A-0209");

  script_name(english:"SAP NetWeaver AS ABAP DoS (April 2024)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SAP NetWeaver ABAP server may be affected by a denial of service vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote SAP NetWeaver ABAP server may be affected by a denial of service (DoS) vulnerability. The ABAP Application 
Server of SAP NetWeaver as well as ABAP Platform allows an attacker to prevent legitimate users from accessing a 
service, either by crashing or flooding the service. This leads to a considerable impact on availability.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://me.sap.com/notes/3359778");
...
"Apply the appropriate patch according to the vendor advisory.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-30218");
