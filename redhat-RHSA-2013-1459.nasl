...
"The remote Red Hat host is missing one or more security updates for gnupg2.");
...
referenced in the RHSA-2013:1459 advisory.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2013/rhsa-2013_1459.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?53a79a6f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2013:1459");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1010137");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1015685");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=891142");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL gnupg2 package based on the guidance in RHSA-2013:1459.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gnupg2-2.0.10-6.el5_10', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gnupg2-2.0.10-6.el5_10', 'cpu':'ppc', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gnupg2-2.0.10-6.el5_10', 'cpu':'s390x', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gnupg2-2.0.10-6.el5_10', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'gnupg2-2.0.14-6.el6_4', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gnupg2-2.0.14-6.el6_4', 'cpu':'ppc64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gnupg2-2.0.14-6.el6_4', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gnupg2-2.0.14-6.el6_4', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gnupg2-smime-2.0.14-6.el6_4', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gnupg2-smime-2.0.14-6.el6_4', 'cpu':'ppc64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gnupg2-smime-2.0.14-6.el6_4', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gnupg2-smime-2.0.14-6.el6_4', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
