...
# extracted from Red Hat Security Advisory RHSA-2021:3946. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:3946");

  script_name(english:"RHEL 8 : redis:5 (RHSA-2021:3946)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for redis:5.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2021:3946 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_3946.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4396e451");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:3946");
...
"Update the RHEL redis:5 package based on the guidance in RHSA-2021:3946.");
  ...
  'redis:5': [
    {
      ...
      'pkgs': [
        {'reference':'redis-5.0.3-5.module+el8.1.0+12925+6460abef', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'redis-devel-5.0.3-5.module+el8.1.0+12925+6460abef', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'redis-doc-5.0.3-5.module+el8.1.0+12925+6460abef', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
