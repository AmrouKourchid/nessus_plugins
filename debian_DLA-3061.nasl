...
# extracted from Debian Security Advisory dla-3061. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-3061-1 : firejail - LTS security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 9 host has packages installed that are affected by a vulnerability as referenced in the dla-3061
advisory.

    Matthias Gerstner discovered that the --join option of Firejail, a sandbox to restrict an application
    environment, was susceptible to local privilege escalation to root. For Debian 9 stretch, this problem has
    been fixed in version 0.9.58.2-2+deb9u1. We recommend that you upgrade your firejail packages. For the
    detailed security status of firejail please refer to its security tracker page at: https://security-
    tracker.debian.org/tracker/firejail Further information about Debian LTS security advisories, how to apply
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2022/dla-3061");
...
var pkgs = [
    {'release': '9.0', 'prefix': 'firejail', 'reference': '0.9.58.2-2+deb9u1'},
    {'release': '9.0', 'prefix': 'firejail-profiles', 'reference': '0.9.58.2-2+deb9u1'}
];
