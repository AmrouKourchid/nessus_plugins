...
# extracted from Red Hat Security Advisory RHSA-2020:1636. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:1636");

  script_name(english:"RHEL 8 : libsndfile (RHSA-2020:1636)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for libsndfile.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2020:1636 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_1636.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b2c6319a");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/8.2_release_notes/index
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dd7b3f20");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:1636");
...
"Update the RHEL libsndfile package based on the guidance in RHSA-2020:1636.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libsndfile-1.0.28-10.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsndfile-devel-1.0.28-10.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
