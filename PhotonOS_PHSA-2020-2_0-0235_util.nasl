...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Util PHSA-2020-2.0-0235");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'util-linux-2.32.1-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'util-linux-debuginfo-2.32.1-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'util-linux-devel-2.32.1-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'util-linux-lang-2.32.1-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'util-linux-libs-2.32.1-1.ph2')) flag++;
