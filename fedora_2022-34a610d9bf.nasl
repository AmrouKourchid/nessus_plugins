...
# extracted from Fedora Security Advisory FEDORA-2022-34a610d9bf
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-34a610d9bf");

  script_name(english:"Fedora 35 : dotnet6.0 (2022-34a610d9bf)");
...
FEDORA-2022-34a610d9bf advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-34a610d9bf");
...
var pkgs = [
    {'reference':'dotnet6.0-6.0.109-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
