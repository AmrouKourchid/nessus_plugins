...
if (description)
{
  ...
  script_cve_id("CVE-2022-0562", "CVE-2022-0891", "CVE-2022-1056");

  script_name(english:"Photon OS 3.0: Libtiff PHSA-2022-3.0-0376");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libtiff-4.3.0-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libtiff-devel-4.3.0-1.ph3')) flag++;
