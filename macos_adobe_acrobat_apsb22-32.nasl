...
if (description)
{
  ...
  script_name(english:"Adobe Acrobat < 17.012.30249 / 20.005.30362 / 22.001.20169 Multiple Vulnerabilities (APSB22-32) (macOS)");
...
"The version of Adobe Acrobat installed on the remote macOS host is a version prior to 17.012.30249, 20.005.30362, or
22.001.20169. It is, therefore, affected by multiple vulnerabilities.
  ...
  - Adobe Acrobat Reader versions 22.001.20142 (and earlier), 20.005.30334 (and earlier) and 17.012.30229 (and
    ...
    CVE-2022-34224, CVE-2022-34225, CVE-2022-34227, CVE-2022-34229, CVE-2022-34230)
  ...
  - Adobe Acrobat Reader versions 22.001.20142 (and earlier), 20.005.30334 (and earlier) and 17.012.30229 (and
    ...
    issue requires user interaction in that a victim must open a malicious file.. (CVE-2022-34237)
  ...
  - Acrobat Reader versions 22.001.20142 (and earlier), 20.005.30334 (and earlier) and 20.005.30334 (and
    ...
    this issue requires user interaction in that a victim must open a malicious file. (CVE-2022-34238,
    CVE-2022-35669)
...
"Upgrade to Adobe Acrobat version 17.012.30249 / 20.005.30362 / 22.001.20169 or later.");
...
var constraints = [
  { 'min_version' : '17.8', 'max_version' : '17.012.30229', 'fixed_version' : '17.012.30249', 'track' : 'DC Classic' },
  { 'min_version' : '20.1', 'max_version' : '20.005.30334', 'fixed_version' : '20.005.30362', 'track' : 'DC Classic' },
  { 'min_version' : '15.7', 'max_version' : '22.001.20142', 'fixed_version' : '22.001.20169', 'track' : 'DC Continuous' }
];
