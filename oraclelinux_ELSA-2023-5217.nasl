...
# extracted from Oracle Linux Security Advisory ELSA-2023-5217.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : open-vm-tools (ELSA-2023-5217)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 7 host has packages installed that are affected by a vulnerability as referenced in the
ELSA-2023-5217 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-5217.html");
...
var pkgs = [
    {'reference':'open-vm-tools-11.0.5-3.0.1.el7_9.7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'open-vm-tools-desktop-11.0.5-3.0.1.el7_9.7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'open-vm-tools-devel-11.0.5-3.0.1.el7_9.7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'open-vm-tools-test-11.0.5-3.0.1.el7_9.7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
];
