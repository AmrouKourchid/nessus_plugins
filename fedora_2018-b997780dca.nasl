...
# extracted from Fedora Security Advisory FEDORA-2018-b997780dca.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : kernel / kernel-tools (2018-b997780dca)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-b997780dca");
...
"Update the affected kernel and / or kernel-tools packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-12904");
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  cve_list = make_list("CVE-2018-12904");
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for FEDORA-2018-b997780dca");
  }
  else
  {
...
flag = 0;
if (rpm_check(release:"FC27", reference:"kernel-4.17.2-100.fc27")) flag++;
if (rpm_check(release:"FC27", reference:"kernel-tools-4.17.2-100.fc27")) flag++;
