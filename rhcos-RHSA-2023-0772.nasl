...
if (description)
{
  ...
  script_name(english:"RHCOS 4 : OpenShift Container Platform 4.12.4 (RHSA-2023:0772)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat CoreOS host is missing a security update for OpenShift Container Platform 4.12.4.");
...
referenced in the RHSA-2023:0772 advisory.
...
"Update the RHCOS OpenShift Container Platform 4.12.4 package based on the guidance in RHSA-2023:0772.");
...
var pkgs = [
    {'reference':'microshift-4.12.4-202302151633.p0.gb9fe8ac.assembly.4.12.4.el8', 'cpu':'x86_64', 'release':'4', 'el_string':'el8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
    {'reference':'microshift-networking-4.12.4-202302151633.p0.gb9fe8ac.assembly.4.12.4.el8', 'cpu':'x86_64', 'release':'4', 'el_string':'el8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
    {'reference':'microshift-release-info-4.12.4-202302151633.p0.gb9fe8ac.assembly.4.12.4.el8', 'release':'4', 'el_string':'el8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
    {'reference':'microshift-selinux-4.12.4-202302151633.p0.gb9fe8ac.assembly.4.12.4.el8', 'release':'4', 'el_string':'el8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
];
