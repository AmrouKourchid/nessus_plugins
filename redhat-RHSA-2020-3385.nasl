...
# extracted from Red Hat Security Advisory RHSA-2020:3385. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:3385");

  script_name(english:"RHEL 8 : libvncserver (RHSA-2020:3385)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for libvncserver.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2020:3385 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_3385.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1c00231c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:3385");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1852356");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libvncserver package based on the guidance in RHSA-2020:3385.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libvncserver-0.9.11-15.el8_2.1', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvncserver-devel-0.9.11-15.el8_2.1', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'libvncserver-0.9.11-15.el8_2.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvncserver-devel-0.9.11-15.el8_2.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
