...
if (description)
{
  ...
  script_name(english:"Adobe Creative Cloud < 2.2 / 5.0 < 5.3 Arbitrary Code Execution (APSB20-68)");
...
"The version of Adobe Creative Cloud installed on the remote Windows host is prior to 2.2, 5.3. It is, therefore,
affected by a vulnerability as referenced in the APSB20-68 advisory.

  - Adobe Creative Cloud Desktop Application version 5.2 (and earlier) and 2.1 (and earlier) for Windows is
    affected by an uncontrolled search path vulnerability that could result in arbitrary code execution in the
    context of the current user. Exploitation of this issue requires user interaction in that a victim must
    open a malicious file. (CVE-2020-24422)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://helpx.adobe.com/security/products/creative-cloud/apsb20-68.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f442d6c9");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Adobe Creative Cloud version 2.2, 5.3 or later.");
...
var constraints = [
  { 'fixed_version' : '2.2' },
  { 'min_version' : '5.0', 'fixed_version' : '5.3' }
];
