...
if (description)
{
  ...
  script_xref(name:"MSFT", value:"MS20-4484480");
  script_xref(name:"MSFT", value:"MS20-4484488");
  script_xref(name:"MSFT", value:"MS20-4484514");
  script_xref(name:"MSFT", value:"MS20-4484515");
  script_xref(name:"MSFT", value:"MS20-4484516");
  script_xref(name:"MSFT", value:"MS20-4484525");
  script_xref(name:"MSKB", value:"4484480");
  script_xref(name:"MSKB", value:"4484488");
  script_xref(name:"MSKB", value:"4484514");
  script_xref(name:"MSKB", value:"4484515");
  script_xref(name:"MSKB", value:"4484516");
  script_xref(name:"MSKB", value:"4484525");
  script_xref(name:"IAVA", value:"2020-A-0412-S");
  script_xref(name:"CEA-ID", value:"CEA-2020-0118");

  script_name(english:"Security Updates for Microsoft SharePoint Server 2013 (September 2020)");
...
by multiple vulnerabilities :
  ...
  - A cross-site-scripting (XSS) vulnerability exists when
    ...
    CVE-2020-1514, CVE-2020-1575)");
  # https://support.microsoft.com/en-us/help/4484525/security-update-for-sharepoint-foundation-2013-sept-8-2020
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fdec55ec");
  # https://support.microsoft.com/en-us/help/4484515/security-update-for-sharepoint-server-2013-sept-8-2020
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ff00535c");
  # https://support.microsoft.com/en-us/help/4484514/security-update-for-sharepoint-server-2013-september-8-2020
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9affb00b");
  # https://support.microsoft.com/en-us/help/4484516/security-update-for-sharepoint-server-2013-september-8-2020
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6d974dc8");
  # https://support.microsoft.com/en-us/help/4484480/security-update-for-sharepoint-server-2013-sept-8-2020
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?03ed386a");
  # https://support.microsoft.com/en-us/help/4484488/security-update-for-sharepoint-foundation-2013-sept-8-2020
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?649f3d62");
  ...
  { '1':
    {'Foundation':
      [{
         ...
         'append'       : 'microsoft shared\\web server extensions\\15\\bin\\1033',
         'file'         : 'microsoft.sharepoint.msg.dll',
...
foreach check (param_list)
{
  ...
  {
    # found the CU patch
    if ('KB4486662' >< display_name || 'KB4484519' >< display_name || 'KB4484521' >< display_name)
    {
      are_we_vuln = HCF_OK;
      break;
    }
