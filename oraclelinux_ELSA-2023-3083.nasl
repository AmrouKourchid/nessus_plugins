...
var appstreams = {
    'go-toolset:ol8': [
      ...
      {'reference':'golang-docs-1.19.6-1.module+el8.8.0+21053+7bf42711', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-misc-1.19.6-1.module+el8.8.0+21053+7bf42711', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-src-1.19.6-1.module+el8.8.0+21053+7bf42711', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-tests-1.19.6-1.module+el8.8.0+21053+7bf42711', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'golang-docs-1.19.6-1.module+el8.8.0+21053+7bf42711', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-misc-1.19.6-1.module+el8.8.0+21053+7bf42711', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-race-1.19.6-1.module+el8.8.0+21053+7bf42711', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-src-1.19.6-1.module+el8.8.0+21053+7bf42711', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-tests-1.19.6-1.module+el8.8.0+21053+7bf42711', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
};
