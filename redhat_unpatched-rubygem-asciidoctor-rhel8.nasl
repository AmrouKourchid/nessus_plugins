...
# extracted from Red Hat Security Advisory rubygem-asciidoctor. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2018-18385");

  script_name(english:"RHEL 8 : rubygem-asciidoctor (Unpatched Vulnerability) (deprecated)");
...
"This plugin has been deprecated as it does not adhere to established standards for this style of check.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-18385");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rubygem-asciidoctor");
