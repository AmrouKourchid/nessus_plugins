...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : python-requests (EulerOS-SA-2023-3451)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the python-requests packages installed, the EulerOS Virtualization installation on the
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3451
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1c0e6ceb");
...
var pkgs = [
  "python2-requests-2.19.1-3.h3.eulerosv2r8",
  "python3-requests-2.19.1-3.h3.eulerosv2r8"
];
