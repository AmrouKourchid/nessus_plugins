...
# extracted from Red Hat Security Advisory RHSA-2024:3127. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:3127");

  script_name(english:"RHEL 8 : zziplib (RHSA-2024:3127)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for zziplib.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:3127 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-22880");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-24429");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_3127.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?53994433");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:3127");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL zziplib package based on the guidance in RHSA-2024:3127.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'zziplib-0.13.68-13.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'zziplib-devel-0.13.68-13.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'zziplib-utils-0.13.68-13.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
