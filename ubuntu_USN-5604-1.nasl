...
the USN-5604-1 advisory.
    ...
    It was discovered that LibTIFF incorrectly handled certain files. An attacker could possibly use this
    issue to cause a denial of service, or possibly execute arbitrary code. (CVE-2022-2867, CVE-2022-2869)

    It was discovered that LibTIFF incorrectly handled certain files. An attacker could possibly use this
    issue to cause a denial of service. (CVE-2022-2868)
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libtiff-opengl', 'pkgver': '4.0.6-1ubuntu0.8+esm3', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libtiff-tools', 'pkgver': '4.0.6-1ubuntu0.8+esm3', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libtiff5', 'pkgver': '4.0.6-1ubuntu0.8+esm3', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libtiff5-dev', 'pkgver': '4.0.6-1ubuntu0.8+esm3', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libtiffxx5', 'pkgver': '4.0.6-1ubuntu0.8+esm3', 'ubuntu_pro': TRUE}
];
