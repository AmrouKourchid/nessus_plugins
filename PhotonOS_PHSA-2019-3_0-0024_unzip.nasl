...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Unzip PHSA-2019-3.0-0024");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'unzip-6.0-13.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'unzip-debuginfo-6.0-13.ph3')) flag++;
