...
# extracted from Ubuntu Security Notice USN-6499-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6499-2");

  script_name(english:"Ubuntu 18.04 ESM : GnuTLS vulnerability (USN-6499-2)");
...
USN-6499-2 advisory.
    ...
    USN-6499-1 fixed vulnerabilities in GnuTLS. This update provides the corresponding update for Ubuntu 18.04
    LTS.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6499-2");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'gnutls-bin', 'pkgver': '3.5.18-1ubuntu1.6+esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libgnutls-dane0', 'pkgver': '3.5.18-1ubuntu1.6+esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libgnutls-openssl27', 'pkgver': '3.5.18-1ubuntu1.6+esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libgnutls28-dev', 'pkgver': '3.5.18-1ubuntu1.6+esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libgnutls30', 'pkgver': '3.5.18-1ubuntu1.6+esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libgnutlsxx28', 'pkgver': '3.5.18-1ubuntu1.6+esm1', 'ubuntu_pro': TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'gnutls-bin / libgnutls-dane0 / libgnutls-openssl27 / etc');
}
