...
# extracted from Fedora Security Advisory FEDORA-2022-1695454935
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-1695454935");

  script_name(english:"Fedora 36 : php-twig (2022-1695454935)");
...
FEDORA-2022-1695454935 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-1695454935");
...
var pkgs = [
    {'reference':'php-twig-1.44.7-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
