...
# extracted from openSUSE Security Update openSUSE-2019-2281.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : dovecot23 (openSUSE-2019-2281)");
...
project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1133624");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1133625");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1145559");
...
if ( rpm_check(release:"SUSE15.1", reference:"dovecot23-2.3.3-lp151.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"dovecot23-backend-mysql-2.3.3-lp151.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"dovecot23-backend-mysql-debuginfo-2.3.3-lp151.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"dovecot23-backend-pgsql-2.3.3-lp151.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"dovecot23-backend-pgsql-debuginfo-2.3.3-lp151.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"dovecot23-backend-sqlite-2.3.3-lp151.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"dovecot23-backend-sqlite-debuginfo-2.3.3-lp151.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"dovecot23-debuginfo-2.3.3-lp151.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"dovecot23-debugsource-2.3.3-lp151.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"dovecot23-devel-2.3.3-lp151.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"dovecot23-fts-2.3.3-lp151.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"dovecot23-fts-debuginfo-2.3.3-lp151.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"dovecot23-fts-lucene-2.3.3-lp151.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"dovecot23-fts-lucene-debuginfo-2.3.3-lp151.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"dovecot23-fts-solr-2.3.3-lp151.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"dovecot23-fts-solr-debuginfo-2.3.3-lp151.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"dovecot23-fts-squat-2.3.3-lp151.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"dovecot23-fts-squat-debuginfo-2.3.3-lp151.2.6.1") ) flag++;
