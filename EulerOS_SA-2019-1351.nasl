...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.3 : fuse (EulerOS-SA-2019-1351)");
...
following vulnerability :
  ...
  - It was discovered that fusermount failed to properly
    ...
    system.i1/4^CVE-2015-3202i1/4%0

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1351
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c6d252f5");
...
pkgs = ["fuse-2.9.2-11.h7",
        "fuse-devel-2.9.2-11.h7",
        "fuse-libs-2.9.2-11.h7"];
