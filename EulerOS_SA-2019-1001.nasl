...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.1 : mariadb (EulerOS-SA-2019-1001)");
...
the following vulnerability :
  ...
  - Vulnerability in the MySQL Server component of Oracle
    ...
    access to some of MySQL Server accessible
    data.(CVE-2018-2562)
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1001
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?32123c97");
