...
number.");
  # https://supportportal.juniper.net/s/article/2021-10-Security-Bulletin-Junos-OS-EX2300-Series-EX3400-Series-and-ACX710-might-become-unresponsive-if-the-out-of-band-management-port-receives-a-flood-of-traffic-CVE-2021-31368
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b25b1b3f");
...
var vuln_ranges = [
  {'min_ver':'0.0', 'fixed_ver':'18.1R3-S13', 'model':'^(ACX710|EX23|EX34)'},
