...
# extracted from Fedora Security Advisory FEDORA-2024-55a5adeec4
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-55a5adeec4");

  script_name(english:"Fedora 41 : firefox (2024-55a5adeec4)");
...
FEDORA-2024-55a5adeec4 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-55a5adeec4");
...
var pkgs = [
    {'reference':'firefox-130.0-5.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
