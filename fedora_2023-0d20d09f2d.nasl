...
# extracted from Fedora Security Advisory FEDORA-2023-0d20d09f2d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-0d20d09f2d");

  script_name(english:"Fedora 38 : python-django3 (2023-0d20d09f2d)");
...
FEDORA-2023-0d20d09f2d advisory.

    - Update to latest 3.2 release
    - Security fix for CVE-2023-31047
    - Provide python3-django so it can be used by dependents that do not use the python3.Xdist(django) for
    requesting it
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-0d20d09f2d");
...
var pkgs = [
    {'reference':'python-django3-3.2.19-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
