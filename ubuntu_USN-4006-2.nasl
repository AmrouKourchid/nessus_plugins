...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS : Linux kernel (HWE) vulnerability (USN-4006-2)");
...
USN-4006-2 advisory.
    ...
    USN-4006-1 fixed a vulnerability in the Linux kernel for Ubuntu 18.10. This update provides the
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4006-2");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.18.0-21-generic");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.18.0-21-generic-lpae");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.18.0-21-lowlatency");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.18.0-21-snapdragon");
...
var kernel_mappings = {
  '18.04': {
    '4.18.0': {
      'generic': '4.18.0-21',
      'generic-lpae': '4.18.0-21',
      'lowlatency': '4.18.0-21',
      'snapdragon': '4.18.0-21'
    }
  }
};
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-4006-2');
}
