...
if (description)
{
  ...
  script_cve_id("CVE-2024-22201", "CVE-2024-29025");

  script_name(english:"Oracle Coherence (Jul 2024 CPU)");
...
vulnerabilities as referenced in the July 2024 CPU advisory.
  ...
  - Vulnerability in the Oracle Coherence product of Oracle Fusion Middleware (component: Third Party (Eclipse Jetty)).
    ...
    unauthenticated attacker with network access via HTTP/2 to compromise Oracle Coherence. Successful attacks of this 
    vulnerability can result in unauthorized ability to cause a hang or frequently repeatable crash (complete DOS) of 
    Oracle Coherence. (CVE-2024-22201)

  - Vulnerability in the Oracle Coherence product of Oracle Fusion Middleware (component: Third Party (Netty)). 
    Supported versions that are affected are 12.2.1.4.0 and 14.1.1.0.0. Easily exploitable vulnerability allows 
    unauthenticated attacker with network access via HTTP to compromise Oracle Coherence. Successful attacks of this 
    vulnerability can result in unauthorized ability to cause a partial denial of service (partial DOS) of Oracle 
...
var constraints = [
  { 'min_version' : '12.2.1.4.0', 'fixed_version' : '12.2.1.4.22' },
  { 'min_version' : '14.1.1.0.0', 'fixed_version' : '14.1.1.0.18' }
];
