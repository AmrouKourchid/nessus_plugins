...
# extracted from Red Hat Security Advisory RHSA-2023:4536. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:4536");

  script_name(english:"RHEL 8 : nodejs:18 (RHSA-2023:4536)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2023:4536 advisory.

    Node.js is a software development platform for building fast and scalable network applications in the
    JavaScript programming language.

    The package has been upgraded to a later upstream version: nodejs (18.16.1). (BZ#2223630, BZ#2223631,
    BZ#2223632, BZ#2223633, BZ#2223635, BZ#2223642)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_4536.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?72070a5a");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:4536");
  ...
  'nodejs:18': [
    {
      ...
      'pkgs': [
        {'reference':'nodejs-18.16.1-1.module+el8.8.0+19438+94e84959', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-devel-18.16.1-1.module+el8.8.0+19438+94e84959', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-docs-18.16.1-1.module+el8.8.0+19438+94e84959', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-full-i18n-18.16.1-1.module+el8.8.0+19438+94e84959', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-nodemon-2.0.20-2.module+el8.8.0+18432+27f188ac', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'nodejs-packaging-2021.06-4.module+el8.7.0+15582+19c314fa', 'release':'8', 'el_string':'el8.7.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'nodejs-packaging-bundler-2021.06-4.module+el8.7.0+15582+19c314fa', 'release':'8', 'el_string':'el8.7.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'npm-9.5.1-1.18.16.1.1.module+el8.8.0+19438+94e84959', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
      ]
    },
    {
      'repo_relative_urls': [
      ...
      'pkgs': [
        {'reference':'nodejs-18.16.1-1.module+el8.8.0+19438+94e84959', 'sp':'8', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-devel-18.16.1-1.module+el8.8.0+19438+94e84959', 'sp':'8', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-docs-18.16.1-1.module+el8.8.0+19438+94e84959', 'sp':'8', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-full-i18n-18.16.1-1.module+el8.8.0+19438+94e84959', 'sp':'8', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-nodemon-2.0.20-2.module+el8.8.0+18432+27f188ac', 'sp':'8', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'nodejs-packaging-2021.06-4.module+el8.7.0+15582+19c314fa', 'sp':'8', 'release':'8', 'el_string':'el8.7.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'nodejs-packaging-bundler-2021.06-4.module+el8.7.0+15582+19c314fa', 'sp':'8', 'release':'8', 'el_string':'el8.7.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'npm-9.5.1-1.18.16.1.1.module+el8.8.0+19438+94e84959', 'sp':'8', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
      ]
    }
  ]
};
