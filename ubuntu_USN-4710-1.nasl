...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS : Linux kernel vulnerability (USN-4710-1)");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.15.0-133-generic");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.15.0-133-generic-lpae");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.15.0-133-lowlatency");
...
var kernel_mappings = {
  '16.04': {
    '4.15.0': {
      'generic': '4.15.0-133',
      'generic-lpae': '4.15.0-133',
      'lowlatency': '4.15.0-133'
    }
  },
  '18.04': {
    '4.15.0': {
      'generic': '4.15.0-135',
      'generic-lpae': '4.15.0-135',
      'lowlatency': '4.15.0-135'
    }
  }
};
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-4710-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2020-25704');
