...
# extracted from Fedora Security Advisory FEDORA-2024-1c74fc369b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-1c74fc369b");

  script_name(english:"Fedora 41 : qbittorrent (2024-1c74fc369b)");
...
FEDORA-2024-1c74fc369b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-1c74fc369b");
...
var pkgs = [
    {'reference':'qbittorrent-5.0.2-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
