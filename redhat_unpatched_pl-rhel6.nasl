...
# extracted from Red Hat Security Advisory pl. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2011-2896", "CVE-2012-6089", "CVE-2012-6090");

  script_name(english:"RHEL 6 : pl (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2011-2896");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:pl");
