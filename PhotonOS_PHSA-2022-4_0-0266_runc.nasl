...
if (description)
{
  ...
  script_cve_id("CVE-2022-24769", "CVE-2022-29162");

  script_name(english:"Photon OS 4.0: Runc PHSA-2022-4.0-0266");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'runc-1.1.4-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'runc-doc-1.1.4-1.ph4')) flag++;
