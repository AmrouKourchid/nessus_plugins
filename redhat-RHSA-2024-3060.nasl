...
# extracted from Red Hat Security Advisory RHSA-2024:3060. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 8 : gstreamer1-plugins-bad-free (RHSA-2024:3060)");
...
referenced in the RHSA-2024:3060 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_3060.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ab27fce8");
...
"Update the RHEL gstreamer1-plugins-bad-free package based on the guidance in RHSA-2024:3060.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gstreamer1-plugins-bad-free-1.16.1-4.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gstreamer1-plugins-bad-free-devel-1.16.1-4.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
