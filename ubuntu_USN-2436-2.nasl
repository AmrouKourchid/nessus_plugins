...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : X.Org X server vulnerabilities (USN-2436-2)");
...
USN-2436-2 advisory.
    ...
    USN-2436-1 fixed vulnerabilities in the X.Org X server. Since publication, additional fixes have been made
    available for these issues. This update adds the additional fixes.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2436-2");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'xdmx', 'pkgver': '2:1.15.1-0ubuntu2.5'},
    {'osver': '14.04', 'pkgname': 'xdmx-tools', 'pkgver': '2:1.15.1-0ubuntu2.5'},
    {'osver': '14.04', 'pkgname': 'xnest', 'pkgver': '2:1.15.1-0ubuntu2.5'},
    {'osver': '14.04', 'pkgname': 'xorg-server-source', 'pkgver': '2:1.15.1-0ubuntu2.5'},
    {'osver': '14.04', 'pkgname': 'xserver-common', 'pkgver': '2:1.15.1-0ubuntu2.5'},
    {'osver': '14.04', 'pkgname': 'xserver-xephyr', 'pkgver': '2:1.15.1-0ubuntu2.5'},
    {'osver': '14.04', 'pkgname': 'xserver-xorg-core', 'pkgver': '2:1.15.1-0ubuntu2.5'},
    {'osver': '14.04', 'pkgname': 'xserver-xorg-core-udeb', 'pkgver': '2:1.15.1-0ubuntu2.5'},
    {'osver': '14.04', 'pkgname': 'xserver-xorg-dev', 'pkgver': '2:1.15.1-0ubuntu2.5'},
    {'osver': '14.04', 'pkgname': 'xserver-xorg-xmir', 'pkgver': '2:1.15.1-0ubuntu2.5'},
    {'osver': '14.04', 'pkgname': 'xvfb', 'pkgver': '2:1.15.1-0ubuntu2.5'}
];
