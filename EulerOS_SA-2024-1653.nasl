...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : httpd (EulerOS-SA-2024-1653)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1653
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d8a81d4f");
...
var pkgs = [
  "httpd-2.4.6-80.1.h21.eulerosv2r7",
  "httpd-devel-2.4.6-80.1.h21.eulerosv2r7",
  "httpd-manual-2.4.6-80.1.h21.eulerosv2r7",
  "httpd-tools-2.4.6-80.1.h21.eulerosv2r7",
  "mod_session-2.4.6-80.1.h21.eulerosv2r7",
  "mod_ssl-2.4.6-80.1.h21.eulerosv2r7"
];
