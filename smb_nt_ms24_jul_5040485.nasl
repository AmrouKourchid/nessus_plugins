...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5040485");
  script_xref(name:"MSFT", value:"MS24-5040485");
  script_xref(name:"IAVA", value:"2024-A-0408-S");
  script_xref(name:"IAVA", value:"2024-A-0407-S");

  script_name(english:"KB5040485: Windows Server 2012 Security Update (July 2024)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5040485. It is, therefore, affected by multiple vulnerabilities
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5040485");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5040485");
