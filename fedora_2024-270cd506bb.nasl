...
# extracted from Fedora Security Advisory FEDORA-2024-270cd506bb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-270cd506bb");

  script_name(english:"Fedora 39 : clojure (2024-270cd506bb)");
...
FEDORA-2024-270cd506bb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-270cd506bb");
...
var pkgs = [
    {'reference':'clojure-1.11.2-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
