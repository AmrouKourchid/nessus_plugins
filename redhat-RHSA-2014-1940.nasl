...
# extracted from Red Hat Security Advisory RHSA-2014:1940. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2014:1940");

  script_name(english:"RHEL 7 : mariadb-galera (RHSA-2014:1940)");
...
referenced in the RHSA-2014:1940 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2014/rhsa-2014_1940.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?72877786");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2014:1940");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL mariadb-galera package based on the guidance in RHSA-2014:1940.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'mariadb-galera-common-5.5.40-2.el7ost', 'cpu':'x86_64', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'},
      {'reference':'mariadb-galera-server-5.5.40-2.el7ost', 'cpu':'x86_64', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'}
    ]
  }
];
