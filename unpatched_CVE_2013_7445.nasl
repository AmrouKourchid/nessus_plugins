...
if (description)
{
  ...
  script_cve_id("CVE-2013-7445");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2013-7445");
...
patch available.
  ...
  - The Direct Rendering Manager (DRM) subsystem in the Linux kernel through 4.x mishandles requests for
    Graphics Execution Manager (GEM) objects, which allows context-dependent attackers to cause a denial of
    service (memory consumption) via an application that processes graphics data, as demonstrated by
    JavaScript code that creates many CANVAS elements for rendering by Chrome or Firefox. (CVE-2013-7445)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-7445");
