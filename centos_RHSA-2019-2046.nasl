...
# extracted from Red Hat Security Advisory RHSA-2019:2046 and 
# CentOS Errata and Security Advisory 2019:2046 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : polkit (CESA-2019:2046)");
...
Enterprise Linux 7.7 Release Notes linked from the References section.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2e4a2fe8");
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"polkit-0.112-22.el7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"polkit-devel-0.112-22.el7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"polkit-docs-0.112-22.el7")) flag++;
