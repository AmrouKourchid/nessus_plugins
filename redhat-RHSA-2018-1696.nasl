...
# extracted from Red Hat Security Advisory RHSA-2018:1696. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:1696");
  script_xref(name:"IAVA", value:"2018-A-0170");

  script_name(english:"RHEL 7 : redhat-virtualization-host (RHSA-2018:1696)");
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_1696.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d1f835bd");
...
"Update the RHEL redhat-virtualization-host package based on the guidance in RHSA-2018:1696.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'redhat-virtualization-host-image-update-4.2-20180518.2.el7_5', 'release':'7', 'el_string':'el7_5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'}
    ]
  }
];
