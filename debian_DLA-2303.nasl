...
# extracted from Debian Security Advisory DLA-2303-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2303-1 : libssh security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The code in src/sftpserver.c did not verify the validity of certain
pointers and expected them to be valid. A NULL pointer dereference
could have been occurred that typically causes a crash and thus a
denial of service.
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2020/07/msg00034.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/stretch/libssh");
...
flag = 0;
if (deb_check(release:"9.0", prefix:"libssh-4", reference:"0.7.3-2+deb9u3")) flag++;
if (deb_check(release:"9.0", prefix:"libssh-dev", reference:"0.7.3-2+deb9u3")) flag++;
if (deb_check(release:"9.0", prefix:"libssh-doc", reference:"0.7.3-2+deb9u3")) flag++;
if (deb_check(release:"9.0", prefix:"libssh-gcrypt-4", reference:"0.7.3-2+deb9u3")) flag++;
if (deb_check(release:"9.0", prefix:"libssh-gcrypt-dev", reference:"0.7.3-2+deb9u3")) flag++;
