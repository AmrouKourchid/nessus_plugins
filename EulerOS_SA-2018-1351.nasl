...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.2 : kernel (EulerOS-SA-2018-1351)");
...
the following vulnerability :
  ...
  - An integer overflow flaw was found in the Linux
    ...
    their privileges on the system.i1/4^CVE-2018-14634i1/4%0

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1351
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bf2e44d9");
...
pkgs = ["kernel-3.10.0-514.44.5.10_97",
        "kernel-devel-3.10.0-514.44.5.10_97",
        "kernel-headers-3.10.0-514.44.5.10_97",
        "kernel-tools-3.10.0-514.44.5.10_97",
        "kernel-tools-libs-3.10.0-514.44.5.10_97",
        "kernel-tools-libs-devel-3.10.0-514.44.5.10_97"];
