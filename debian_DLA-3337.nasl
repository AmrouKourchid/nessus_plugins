...
if (description)
{
  ...
  script_name(english:"Debian dla-3337 : libmariadb-dev - security update");
...
advisory.
    ...
    - -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3337-1                debian-lts@lists.debian.org
    ...
    A new MariaDB minor maintenance release 10.3.38 has been released. It
    includes fix for a major performance/memory consumption issue (MDEV-29988).
