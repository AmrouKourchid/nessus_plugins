...
# Rocky Linux Security Advisory RLSA-2023:5313.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2023:5313");
  script_xref(name:"IAVA", value:"2023-A-0450-S");

  script_name(english:"Rocky Linux 9 : open-vm-tools (RLSA-2023:5313)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2023:5313");
...
var pkgs = [
    ...
    {'reference':'open-vm-tools-debuginfo-12.1.5-1.el9_2.3', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'open-vm-tools-debugsource-12.1.5-1.el9_2.3', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'open-vm-tools-desktop-12.1.5-1.el9_2.3', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'open-vm-tools-desktop-debuginfo-12.1.5-1.el9_2.3', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'open-vm-tools-sdmp-debuginfo-12.1.5-1.el9_2.3', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'open-vm-tools-test-12.1.5-1.el9_2.3', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'open-vm-tools-test-debuginfo-12.1.5-1.el9_2.3', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
