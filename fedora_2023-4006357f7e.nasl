...
# extracted from Fedora Security Advisory FEDORA-2023-4006357f7e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-4006357f7e");

  script_name(english:"Fedora 37 : kernel (2023-4006357f7e)");
...
FEDORA-2023-4006357f7e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-4006357f7e");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for FEDORA-2023-4006357f7e');
  }
  else
  {
...
var pkgs = [
    {'reference':'kernel-6.1.9-200.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
