...
# extracted from Red Hat Security Advisory RHSA-2025:7309. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:7309");

  script_name(english:"RHEL 9 : openjpeg2 (RHSA-2025:7309)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for openjpeg2.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2025:7309 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2335172");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2335174");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_7309.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?50292c06");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:7309");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL openjpeg2 package based on the guidance in RHSA-2025:7309.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openjpeg2-2.4.0-8.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openjpeg2-devel-2.4.0-8.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openjpeg2-tools-2.4.0-8.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
