...
# extracted from Red Hat Security Advisory RHSA-2024:0602. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:0602");
  script_xref(name:"IAVA", value:"2024-A-0053-S");

  script_name(english:"RHEL 9 : thunderbird (RHSA-2024:0602)");
...
referenced in the RHSA-2024:0602 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0602.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?26fe69be");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0602");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL thunderbird package based on the guidance in RHSA-2024:0602.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'thunderbird-115.7.0-1.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
