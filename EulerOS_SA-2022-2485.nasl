...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : zlib (EulerOS-SA-2022-2485)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2485
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7a88419b");
...
var pkgs = [
  "zlib-1.2.11-14.h3.eulerosv2r8",
  "zlib-devel-1.2.11-14.h3.eulerosv2r8"
];
