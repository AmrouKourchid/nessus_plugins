...
# SUSE update advisory SUSE-SU-2021:3361-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2021-3573", "CVE-2021-3640");
  script_xref(name:"SuSE", value:"SUSE-SU-2021:3361-1");

  script_name(english:"SUSE SLES12 / SLES15 Security Update : kernel (Live Patch 18 for SLE 15 SP2) (SUSE-SU-2021:3361-1)");
...
referenced in the SUSE-SU-2021:3361-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2021-October/009574.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?534661bc");
  script_set_attribute(attribute:"solution", value:
"Update the affected kernel-livepatch-5_3_18-24_78-default, kernel-livepatch-5_3_18-59_19-default and / or kgraft-
patch-4_12_14-122_83-default packages.");
...
var pkgs = [
    {'reference':'kgraft-patch-4_12_14-122_83-default-3-2.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.5']},
    {'reference':'kernel-livepatch-5_3_18-24_78-default-3-2.1', 'sp':'2', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.2']},
    {'reference':'kernel-livepatch-5_3_18-59_19-default-3-2.1', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.3']}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kernel-livepatch-5_3_18-24_78-default / etc');
}
