...
# extracted from Red Hat Security Advisory RHSA-2024:2217. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2217");

  script_name(english:"RHEL 9 : motif (RHSA-2024:2217)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for motif.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:2217 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2217.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3ece1338");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2217");
...
"Update the RHEL motif package based on the guidance in RHSA-2024:2217.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'motif-2.3.4-28.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'motif-devel-2.3.4-28.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'motif / motif-devel');
}
