...
# extracted from Red Hat Security Advisory struts. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2015-0899", "CVE-2016-1181", "CVE-2016-1182");

  script_name(english:"RHEL 5 : struts (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-1181");
