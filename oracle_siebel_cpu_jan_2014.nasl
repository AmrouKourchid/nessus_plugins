...
if (description)
{
  ...
  script_cve_id("CVE-2014-0369", "CVE-2014-0370");

  script_name(english:"Oracle Siebel CRM (January 2014 CPU)");
...
the January 2014 CPU advisory.

  - Vulnerability in the Siebel Life Sciences component of Oracle Siebel CRM (subcomponent: Clinical Trip
    Report). Supported versions that are affected are 8.1.1 and 8.2.2. Difficult to exploit vulnerability
    allows successful network attacks via HTTP, requiring multiple authentications. Successful attack of this
    vulnerability can result in unauthorized ability to cause a partial denial of service (partial DOS) of
    Siebel Life Sciences. (CVE-2014-0370)

  - Vulnerability in the Siebel Core - EAI component of Oracle Siebel CRM (subcomponent: Java Integration).
    ...
    unauthorized read access to a subset of Siebel Core - EAI accessible data. (CVE-2014-0369)
...
"Apply the appropriate patch according to the January 2014 Oracle Critical Patch Update advisory.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-0369");
...
var constraints = [
  { 'min_version' : '8.1.1', 'fixed_version' : '8.1.1.11.3' },
  { 'min_version' : '8.2.2', 'fixed_version' : '8.2.2.4.3' }
];
