...
# extracted from Fedora Security Advisory FEDORA-2024-8761735ee2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-8761735ee2");

  script_name(english:"Fedora 41 : python3.6 (2024-8761735ee2)");
...
FEDORA-2024-8761735ee2 advisory.
    ...
    ```
    * Tue Jul  2 2024 Lumr Balhar <lbalhar@redhat.com> - 3.6.15-31
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-8761735ee2");
...
var pkgs = [
    {'reference':'python3.6-3.6.15-31.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
