...
if (description)
{
  ...
  script_cve_id("CVE-2024-50055");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-50055");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: driver core: bus: Fix double free in
    driver API bus_register() For bus_register(), any error which happens after kset_register() will cause
    that @priv are freed twice, fixed by setting @priv with NULL after the first free. (CVE-2024-50055)
