...
# extracted from Red Hat Security Advisory RHSA-2021:4594. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 8 : gcc-toolset-11-binutils (RHSA-2021:4594)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for gcc-toolset-11-binutils.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2021:4594 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_4594.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?56554c6c");
...
"Update the RHEL gcc-toolset-11-binutils package based on the guidance in RHSA-2021:4594.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:gcc-toolset-11-binutils-devel");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gcc-toolset-11-binutils-2.36.1-1.el8_5.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gcc-toolset-11-binutils-devel-2.36.1-1.el8_5.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
