...
# extracted from Fedora Security Advisory FEDORA-2022-3c933ffaca
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-3c933ffaca");

  script_name(english:"Fedora 36 : mingw-libtasn1 (2022-3c933ffaca)");
...
FEDORA-2022-3c933ffaca advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-3c933ffaca");
...
var pkgs = [
    {'reference':'mingw-libtasn1-4.19.0-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
