...
# extracted from Red Hat Security Advisory RHSA-2010:0961. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2010:0961");

  script_name(english:"RHEL 5 : JBoss Enterprise Web Platform 5.1.0 (RHSA-2010:0961)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for JBoss Enterprise Web Platform 5.1.0.");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c80fbd64");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=641389");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=645465");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2010/rhsa-2010_0961.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2a10c3ec");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2010:0961");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL JBoss Enterprise Web Platform 5.1.0 package based on the guidance in RHSA-2010:0961.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:H/Au:N/C:N/I:N/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2010-3862");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jboss-remoting-2.5.3-5.SP1.1.ep5.el5', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'jbossws-cxf-3.1.2-4.SP7.6.jdk6.ep5.el5', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'jopr-embedded-1.3.4-16.SP1.7.ep5.el5', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'jboss-remoting / jbossws-cxf / jopr-embedded');
}
