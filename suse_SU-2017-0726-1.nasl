...
# extracted from SUSE update advisory SUSE-SU-2017:0726-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : java-1_6_0-ibm (SUSE-SU-2017:0726-1)");
...
without introducing additional issues.");
  ...
  # https://www.suse.com/support/update/announcement/2017/suse-su-20170726-1/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?eac76ef0");
  script_set_attribute(attribute:"solution", value:
"To install this SUSE Security Update use YaST online_update.
Alternatively you can run the command listed for your product :

SUSE Linux Enterprise Module for Legacy Software 12:zypper in -t patch
SUSE-SLE-Module-Legacy-12-2017-407=1
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"0", cpu:"x86_64", reference:"java-1_6_0-ibm-plugin-1.6.0_sr16.41-46.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"java-1_6_0-ibm-1.6.0_sr16.41-46.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"java-1_6_0-ibm-fonts-1.6.0_sr16.41-46.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"java-1_6_0-ibm-jdbc-1.6.0_sr16.41-46.1")) flag++;
