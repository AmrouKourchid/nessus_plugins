...
# extracted from Fedora Security Advisory FEDORA-2024-a2f6e5ddb8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-a2f6e5ddb8");

  script_name(english:"Fedora 39 : rear (2024-a2f6e5ddb8)");
...
FEDORA-2024-a2f6e5ddb8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-a2f6e5ddb8");
...
var pkgs = [
    {'reference':'rear-2.7-8.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
