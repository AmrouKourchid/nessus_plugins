...
# CentOS Errata and Security Advisory 2018:3246 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : libcdio (CESA-2018:3246)");
...
Enterprise Linux 7.6 Release Notes linked from the References section.");
  # https://lists.centos.org/pipermail/centos-cr-announce/2018-November/005493.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3402ac5e");
...
"Update the affected libcdio packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:libcdio");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:libcdio-devel");
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"libcdio-0.92-3.el7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"libcdio-devel-0.92-3.el7")) flag++;
