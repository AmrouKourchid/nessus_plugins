...
# extracted from Red Hat Security Advisory RHSA-2024:0957.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : thunderbird (RHSA-2024:0957)");
...
var pkgs = [
    {'reference':'thunderbird-115.8.0-1.el7.centos', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'thunderbird-115.8.0-1.el7.centos', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
