...
# extracted from Fedora Security Advisory FEDORA-2023-29c8c2d740
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-29c8c2d740");

  script_name(english:"Fedora 39 : dcmtk (2023-29c8c2d740)");
...
FEDORA-2023-29c8c2d740 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-29c8c2d740");
...
var pkgs = [
    {'reference':'dcmtk-3.6.7-3.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
