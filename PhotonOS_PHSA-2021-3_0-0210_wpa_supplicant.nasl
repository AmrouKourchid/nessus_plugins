...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Wpa_Supplicant PHSA-2021-3.0-0210");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'wpa_supplicant-2.7-6.ph3')) flag++;
