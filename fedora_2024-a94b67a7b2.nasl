...
# extracted from Fedora Security Advisory FEDORA-2024-a94b67a7b2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-a94b67a7b2");

  script_name(english:"Fedora 39 : jose (2024-a94b67a7b2)");
...
FEDORA-2024-a94b67a7b2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-a94b67a7b2");
...
var pkgs = [
    {'reference':'jose-13-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
