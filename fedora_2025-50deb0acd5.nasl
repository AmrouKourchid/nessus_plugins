...
# extracted from Fedora Security Advisory FEDORA-2025-50deb0acd5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-50deb0acd5");

  script_name(english:"Fedora 40 : git-lfs (2025-50deb0acd5)");
...
FEDORA-2025-50deb0acd5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-50deb0acd5");
...
var pkgs = [
    {'reference':'git-lfs-3.6.1-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
