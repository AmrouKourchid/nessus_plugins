...
# extracted from Red Hat Security Advisory RHSA-2024:2580. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2580");

  script_name(english:"RHEL 8 : yajl (RHSA-2024:2580)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for yajl.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:2580 advisory.

    Yet Another JSON Library (YAJL) is a small event-driven (SAX-style) JSON parser written in ANSI C, and a
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2580.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ddf3584f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2580");
...
"Update the RHEL yajl package based on the guidance in RHSA-2024:2580.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:yajl");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:yajl-devel");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'yajl-2.1.0-12.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'yajl-devel-2.1.0-12.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
