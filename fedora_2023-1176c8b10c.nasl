...
# extracted from Fedora Security Advisory FEDORA-2023-1176c8b10c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-1176c8b10c");

  script_name(english:"Fedora 37 : openssh (2023-1176c8b10c)");
...
FEDORA-2023-1176c8b10c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-1176c8b10c");
...
var pkgs = [
    {'reference':'openssh-8.8p1-10.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
