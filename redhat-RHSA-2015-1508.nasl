...
# extracted from Red Hat Security Advisory RHSA-2015:1508. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2015:1508");

  script_name(english:"RHEL 7 : qemu-kvm-rhev (RHSA-2015:1508)");
...
referenced in the RHSA-2015:1508 advisory.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2015/rhsa-2015_1508.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?43526d53");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2015:1508");
...
"Update the RHEL qemu-kvm-rhev package based on the guidance in RHSA-2015:1508.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libcacard-devel-rhev-2.1.2-23.el7_1.6', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_1', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10', 'exists_check':'ovirt-'},
      {'reference':'libcacard-rhev-2.1.2-23.el7_1.6', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_1', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10', 'exists_check':'ovirt-'},
      {'reference':'libcacard-tools-rhev-2.1.2-23.el7_1.6', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_1', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10', 'exists_check':'ovirt-'},
      {'reference':'qemu-img-rhev-2.1.2-23.el7_1.6', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_1', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10', 'exists_check':'ovirt-'},
      {'reference':'qemu-kvm-common-rhev-2.1.2-23.el7_1.6', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_1', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10', 'exists_check':'ovirt-'},
      {'reference':'qemu-kvm-rhev-2.1.2-23.el7_1.6', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_1', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10', 'exists_check':'ovirt-'},
      {'reference':'qemu-kvm-tools-rhev-2.1.2-23.el7_1.6', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_1', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10', 'exists_check':'ovirt-'}
    ]
  }
];
