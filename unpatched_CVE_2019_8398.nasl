...
if (description)
{
  ...
  script_cve_id("CVE-2019-8398");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2019-8398");
...
patch available.
  ...
  - An issue was discovered in the HDF HDF5 1.10.4 library. There is an out of bounds read in the function
    H5T_get_size in H5T.c. (CVE-2019-8398)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-8398");
