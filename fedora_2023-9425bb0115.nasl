...
# extracted from Fedora Security Advisory FEDORA-2023-9425bb0115
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-9425bb0115");

  script_name(english:"Fedora 39 : chromium (2023-9425bb0115)");
...
FEDORA-2023-9425bb0115 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-9425bb0115");
...
var pkgs = [
    {'reference':'chromium-119.0.6045.159-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
