...
"The version of Google Chrome installed on the remote macOS host is prior to 92.0.4515.131. It is, therefore, affected by
multiple vulnerabilities as referenced in the 2021_08_the-stable-channel-has-been-updated-to advisory. Note that Nessus
...
google_chrome_check_version(fix:'92.0.4515.131', severity:SECURITY_WARNING, xss:FALSE, xsrf:FALSE);
