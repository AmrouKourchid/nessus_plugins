...
# extracted from Fedora Security Advisory FEDORA-2023-a48c162033
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-a48c162033");

  script_name(english:"Fedora 38 : bind9-next (2023-a48c162033)");
...
FEDORA-2023-a48c162033 advisory.

    - Upstream [release notes](https://downloads.isc.org/isc/bind9/9.19.17/RELEASE-NOTES-bind-9.19.17.html)

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-a48c162033");
...
var pkgs = [
    {'reference':'bind9-next-9.19.17-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'}
];
