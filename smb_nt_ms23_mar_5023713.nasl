...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5023713");
  script_xref(name:"MSFT", value:"MS23-5023713");
  script_xref(name:"IAVA", value:"2023-A-0135-S");
  script_xref(name:"IAVA", value:"2023-A-0139-S");

  script_name(english:"KB5023713: Windows 10 LTS 1507 Security Update (March 2023)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5023713. It is, therefore, affected by multiple vulnerabilities
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5023713");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5023713");
