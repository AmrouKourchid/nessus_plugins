...
# AlmaLinux Security Advisory ALSA-2024:0256.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:0256");

  script_name(english:"AlmaLinux 8 : python3 (ALSA-2024:0256)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 8 host has packages installed that are affected by a vulnerability as referenced in the
ALSA-2024:0256 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2024-0256.html");
...
var pkgs = [
    {'reference':'platform-python-3.6.8-56.el8_9.3.alma.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'platform-python-debug-3.6.8-56.el8_9.3.alma.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'platform-python-devel-3.6.8-56.el8_9.3.alma.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-idle-3.6.8-56.el8_9.3.alma.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-libs-3.6.8-56.el8_9.3.alma.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-test-3.6.8-56.el8_9.3.alma.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-tkinter-3.6.8-56.el8_9.3.alma.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
