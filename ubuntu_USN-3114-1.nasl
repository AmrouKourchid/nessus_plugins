...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS : nginx vulnerability (USN-3114-1)");
...
in the USN-3114-1 advisory.

    Dawid Golunski discovered that the nginx package incorrectly handled log file permissions. A remote
    attacker could possibly use this issue to obtain root privileges.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3114-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'nginx', 'pkgver': '1.4.6-1ubuntu3.6'},
    {'osver': '14.04', 'pkgname': 'nginx-common', 'pkgver': '1.4.6-1ubuntu3.6'},
    {'osver': '14.04', 'pkgname': 'nginx-core', 'pkgver': '1.4.6-1ubuntu3.6'},
    {'osver': '14.04', 'pkgname': 'nginx-extras', 'pkgver': '1.4.6-1ubuntu3.6'},
    {'osver': '14.04', 'pkgname': 'nginx-full', 'pkgver': '1.4.6-1ubuntu3.6'},
    {'osver': '14.04', 'pkgname': 'nginx-light', 'pkgver': '1.4.6-1ubuntu3.6'},
    {'osver': '14.04', 'pkgname': 'nginx-naxsi', 'pkgver': '1.4.6-1ubuntu3.6'},
    {'osver': '14.04', 'pkgname': 'nginx-naxsi-ui', 'pkgver': '1.4.6-1ubuntu3.6'},
    {'osver': '16.04', 'pkgname': 'nginx', 'pkgver': '1.10.0-0ubuntu0.16.04.3'},
    {'osver': '16.04', 'pkgname': 'nginx-common', 'pkgver': '1.10.0-0ubuntu0.16.04.3'},
    {'osver': '16.04', 'pkgname': 'nginx-core', 'pkgver': '1.10.0-0ubuntu0.16.04.3'},
    {'osver': '16.04', 'pkgname': 'nginx-extras', 'pkgver': '1.10.0-0ubuntu0.16.04.3'},
    {'osver': '16.04', 'pkgname': 'nginx-full', 'pkgver': '1.10.0-0ubuntu0.16.04.3'},
    {'osver': '16.04', 'pkgname': 'nginx-light', 'pkgver': '1.10.0-0ubuntu0.16.04.3'}
];
