...
# extracted from Amazon Linux 2 Security Advisory ALAS-2023-2229.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : cri-tools (ALAS-2023-2229)");
...
vulnerability as referenced in the ALAS2-2023-2229 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2023-2229.html");
...
var pkgs = [
    {'reference':'cri-tools-1.26.1-1.amzn2.0.2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cri-tools-1.26.1-1.amzn2.0.2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cri-tools-debuginfo-1.26.1-1.amzn2.0.2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cri-tools-debuginfo-1.26.1-1.amzn2.0.2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
