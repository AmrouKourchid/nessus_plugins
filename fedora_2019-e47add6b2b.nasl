...
# extracted from Fedora Security Advisory FEDORA-2019-e47add6b2b.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-e47add6b2b");

  script_name(english:"Fedora 31 : rssh (2019-e47add6b2b)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-e47add6b2b");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"rssh-2.3.4-15.fc31")) flag++;
