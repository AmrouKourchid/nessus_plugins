...
affected by a vulnerability as referenced in the K18484125 advisory.
    ...
    this temporary directory, this can lead to a local privilege escalation
    vulnerability.(CVE-2020-27216)ImpactA successful exploit could allow an authenticated user to cause a
...
var vmatrix = {
  'AFM': {
    'affected': [
      '17.0.0-17.1.0','16.0.0-16.1.3','15.1.0-15.1.8','14.1.0-14.1.5'
    ],
    'unaffected': [
