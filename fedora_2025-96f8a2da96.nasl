...
# extracted from Fedora Security Advisory FEDORA-2025-96f8a2da96
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-96f8a2da96");

  script_name(english:"Fedora 41 : tigervnc (2025-96f8a2da96)");
...
FEDORA-2025-96f8a2da96 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-96f8a2da96");
...
var pkgs = [
    {'reference':'tigervnc-1.15.0-2.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
