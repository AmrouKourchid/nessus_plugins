...
# extracted from Oracle Linux Security Advisory ELSA-2021-1898.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : python-lxml (ELSA-2021-1898)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2021-1898.html");
...
"Update the affected python3-lxml package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:python3-lxml");
