...
# extracted from Ubuntu Security Notice USN-6359-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6359-1");

  script_name(english:"Ubuntu 22.04 LTS : file vulnerability (USN-6359-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6359-1");
...
var pkgs = [
    {'osver': '22.04', 'pkgname': 'file', 'pkgver': '1:5.41-3ubuntu0.1'},
    {'osver': '22.04', 'pkgname': 'libmagic-dev', 'pkgver': '1:5.41-3ubuntu0.1'},
    {'osver': '22.04', 'pkgname': 'libmagic-mgc', 'pkgver': '1:5.41-3ubuntu0.1'},
    {'osver': '22.04', 'pkgname': 'libmagic1', 'pkgver': '1:5.41-3ubuntu0.1'}
];
