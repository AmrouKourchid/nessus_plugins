...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : compat-libtiff3 (EulerOS-SA-2021-1464)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1464
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f1d30b18");
...
"Update the affected compat-libtiff3 package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-5563");
...
pkgs = ["compat-libtiff3-3.9.4-11.h24.eulerosv2r7"];
