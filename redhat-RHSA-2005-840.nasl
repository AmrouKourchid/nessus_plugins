...
if (description)
{
  ...
  script_name(english:"RHEL 4 : xpdf (RHSA-2005:840)");
...
referenced in the RHSA-2005:840 advisory.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2005/rhsa-2005_840.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?126042e8");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=173888");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2005:840");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL xpdf package based on the guidance in RHSA-2005:840.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2005-3625");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'xpdf-3.00-11.10', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'xpdf-3.00-11.10', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'xpdf-3.00-11.10', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'xpdf-3.00-11.10', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'xpdf-3.00-11.10', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
