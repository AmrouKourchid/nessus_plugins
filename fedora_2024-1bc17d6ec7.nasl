...
# extracted from Fedora Security Advisory FEDORA-2024-1bc17d6ec7
#
...
if (description)
{
  ...
  script_cve_id("CVE-2024-4558", "CVE-2024-4671");
  script_xref(name:"FEDORA", value:"2024-1bc17d6ec7");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2024/06/03");
  script_xref(name:"IAVA", value:"2024-A-0278-S");

  script_name(english:"Fedora 39 : chromium (2024-1bc17d6ec7)");
...
FEDORA-2024-1bc17d6ec7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-1bc17d6ec7");
...
"Update the affected chromium package.");
  ...
  script_set_attribute(attribute:"patch_publication_date", value:"2024/05/11");
...
var pkgs = [
    {'reference':'chromium-124.0.6367.201-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
