...
if (description)
{
  ...
  script_cve_id("CVE-2022-40083");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-40083");
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-40083");
...
var vuln_data = {
 ...
 "checks": [
  {
   "product": {
    "name": "golang-github-labstack-echo-dev",
    "type": "dpkg_package"
   },
