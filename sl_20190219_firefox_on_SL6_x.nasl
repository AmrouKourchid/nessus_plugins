...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : firefox on SL6.x i386/x86_64 (20190219)");
...
Security Fix(es) :
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2bca94ba");
...
flag = 0;
if (rpm_check(release:"SL6", reference:"firefox-60.5.1-1.el6_10", allowmaj:TRUE)) flag++;
if (rpm_check(release:"SL6", reference:"firefox-debuginfo-60.5.1-1.el6_10", allowmaj:TRUE)) flag++;
