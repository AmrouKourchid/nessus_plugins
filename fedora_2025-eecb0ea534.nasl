...
# extracted from Fedora Security Advisory FEDORA-2025-eecb0ea534
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-eecb0ea534");

  script_name(english:"Fedora 41 : kappanhang (2025-eecb0ea534)");
...
FEDORA-2025-eecb0ea534 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-eecb0ea534");
  script_set_attribute(attribute:"solution", value:
"Update the affected kappanhang package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:kappanhang");
...
var pkgs = [
    {'reference':'kappanhang-0-0.3.20250427gitdffb773.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kappanhang');
}
