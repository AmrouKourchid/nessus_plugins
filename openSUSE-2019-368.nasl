...
# extracted from openSUSE Security Update openSUSE-2019-368.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : enigmail (openSUSE-2019-368) (EFAIL)");
...
Security issues fixed :
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1093151");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1093152");
...
"Update the affected enigmail package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-17689");
...
if ( rpm_check(release:"SUSE15.0", reference:"enigmail-2.0.4-lp150.2.3.1") ) flag++;
