...
# extracted from Red Hat Security Advisory RHSA-2024:9983. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:9983");

  script_name(english:"RHEL 9 : RHOSP 17.1.4 (python-webob) (RHSA-2024:9983)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_9983.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1db94cff");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:9983");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL RHOSP 17.1.4 (python-webob) package based on the guidance in RHSA-2024:9983.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-webob-1.8.7-2.1.el9ost', 'release':'9', 'el_string':'el9ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
