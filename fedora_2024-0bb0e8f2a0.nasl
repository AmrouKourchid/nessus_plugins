...
# extracted from Fedora Security Advisory FEDORA-2024-0bb0e8f2a0
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-0bb0e8f2a0");
  script_xref(name:"IAVA", value:"2024-A-0183-S");

  script_name(english:"Fedora 39 : chromium (2024-0bb0e8f2a0)");
...
FEDORA-2024-0bb0e8f2a0 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-0bb0e8f2a0");
...
var pkgs = [
    {'reference':'chromium-123.0.6312.86-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
