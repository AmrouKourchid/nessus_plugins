...
# extracted from Fedora Security Advisory FEDORA-2024-d198253c42
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-d198253c42");

  script_name(english:"Fedora 40 : stalld (2024-d198253c42)");
...
FEDORA-2024-d198253c42 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-d198253c42");
...
var pkgs = [
    {'reference':'stalld-1.19.2-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
