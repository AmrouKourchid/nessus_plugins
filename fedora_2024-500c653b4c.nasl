...
# extracted from Fedora Security Advisory FEDORA-2024-500c653b4c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-500c653b4c");

  script_name(english:"Fedora 40 : apptainer (2024-500c653b4c)");
...
FEDORA-2024-500c653b4c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-500c653b4c");
...
var pkgs = [
    {'reference':'apptainer-1.3.2-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
