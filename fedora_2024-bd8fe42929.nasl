...
# extracted from Fedora Security Advisory FEDORA-2024-bd8fe42929
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-bd8fe42929");

  script_name(english:"Fedora 41 : caddy (2024-bd8fe42929)");
...
FEDORA-2024-bd8fe42929 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-bd8fe42929");
...
var pkgs = [
    {'reference':'caddy-2.8.4-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
