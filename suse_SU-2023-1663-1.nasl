...
# SUSE update advisory SUSE-SU-2023:1663-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:1663-1");

  script_name(english:"openSUSE 15 Security Update : oracleasm (SUSE-SU-2023:1663-1)");
...
SU-2023:1663-1 advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1209188");
  script_set_attribute(attribute:"see_also", value:"https://lists.suse.com/pipermail/sle-updates/2023-March/028457.html");
...
var pkgs = [
    {'reference':'oracleasm-kmp-rt-2.0.8_k5.14.21_150400.15.14-150400.4.2.2', 'cpu':'x86_64', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.4']}
];
