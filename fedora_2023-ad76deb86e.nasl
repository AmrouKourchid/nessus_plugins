...
# extracted from Fedora Security Advisory FEDORA-2023-ad76deb86e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-ad76deb86e");

  script_name(english:"Fedora 39 : llhttp / python-aiohttp (2023-ad76deb86e)");
...
FEDORA-2023-ad76deb86e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-ad76deb86e");
...
var pkgs = [
    {'reference':'llhttp-8.1.1-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python-aiohttp-3.8.5-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
