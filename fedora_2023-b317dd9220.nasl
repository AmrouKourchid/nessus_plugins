...
# extracted from Fedora Security Advisory FEDORA-2023-b317dd9220
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-b317dd9220");

  script_name(english:"Fedora 39 : libspf2 (2023-b317dd9220)");
...
FEDORA-2023-b317dd9220 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-b317dd9220");
...
var pkgs = [
    {'reference':'libspf2-1.2.11-11.20210922git4915c308.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
