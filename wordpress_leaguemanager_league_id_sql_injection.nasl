...
injection vulnerabilities although Nessus has not tested for these.");
  # https://packetstormsecurity.com/files/120817/WordPress-LeagueManager-3.8-SQL-Injection.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?eaf0ae9c");
  script_set_attribute(attribute:"see_also", value:"https://plugins.trac.wordpress.org/changeset/682945/leaguemanager");
  script_set_attribute(attribute:"see_also", value:"https://wordpress.org/plugins/leaguemanager/#changelog");
  script_set_attribute(attribute:"solution", value:
"Upgrade to version 3.8.1 or later.");
