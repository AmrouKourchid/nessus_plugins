...
# extracted from Red Hat Security Advisory RHSA-2023:5198. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_5198.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?320ce3c6");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:5198");
...
"Update the RHEL firefox package based on the guidance in RHSA-2023:5198.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-102.15.1-1.el8_6', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
