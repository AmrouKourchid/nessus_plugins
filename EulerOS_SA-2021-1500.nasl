...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : netpbm (EulerOS-SA-2021-1500)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1500
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b77a9958");
...
pkgs = ["netpbm-10.79.00-7.h3.eulerosv2r7",
        "netpbm-devel-10.79.00-7.h3.eulerosv2r7",
        "netpbm-progs-10.79.00-7.h3.eulerosv2r7"];
