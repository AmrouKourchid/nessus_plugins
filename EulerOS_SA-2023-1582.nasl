...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : emacs (EulerOS-SA-2023-1582)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1582
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?381529a1");
...
var pkgs = [
  "emacs-filesystem-27.2-3.h3.eulerosv2r11"
];
