...
# extracted from Debian Security Advisory dsa-5785. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5785 : mediawiki - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 12 host has packages installed that are affected by a vulnerability as referenced in the dsa-5785
advisory.

    - -------------------------------------------------------------------------
    Debian Security Advisory DSA-5785-1                   security@debian.org
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-47913");
...
"Upgrade the mediawiki packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-47913");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'mediawiki', 'reference': '1:1.39.10-1~deb12u1'},
    {'release': '12.0', 'prefix': 'mediawiki-classes', 'reference': '1:1.39.10-1~deb12u1'}
];
