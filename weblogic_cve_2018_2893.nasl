...
server.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://nvd.nist.gov/vuln/detail/CVE-2018-2893");
...
var appname = "Oracle WebLogic Server";

var port = get_service(svc:'t3', default:7001, exit_on_fail:TRUE);

# Try to talk T3 to the server
var sock = open_sock_tcp(port);
if (!sock) audit(AUDIT_SOCK_FAIL, port);
# T3 handshake
var version = t3_connect(sock:sock, port:port);
