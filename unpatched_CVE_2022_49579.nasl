...
if (description)
{
  ...
  script_cve_id("CVE-2022-49579");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-49579");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: ipv4: Fix data-races around
    sysctl_fib_multipath_hash_policy. While reading sysctl_fib_multipath_hash_policy, it can be changed
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-49579");
