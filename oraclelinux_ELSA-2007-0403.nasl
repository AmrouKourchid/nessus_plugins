...
# Oracle Linux Security Advisory ELSA-2007-0403 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : Moderate: / freetype (ELSA-2007-0403)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2007-0403.html");
...
var pkgs = [
    {'reference':'freetype-2.2.1-19.el5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'freetype-demos-2.2.1-19.el5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'freetype-devel-2.2.1-19.el5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'freetype-2.2.1-19.el5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'freetype-demos-2.2.1-19.el5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'freetype-devel-2.2.1-19.el5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
