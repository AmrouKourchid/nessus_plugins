...
# extracted from Red Hat Security Advisory RHSA-2024:8849. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 8 : haproxy (RHSA-2024:8849)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_8849.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9b23dbb6");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:8849");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL haproxy package based on the guidance in RHSA-2024:8849.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'haproxy-1.8.27-5.el8_10.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
