...
# extracted from Fedora Security Advisory FEDORA-2024-1f1c0537d3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-1f1c0537d3");

  script_name(english:"Fedora 40 : webkit2gtk4.0 (2024-1f1c0537d3)");
...
FEDORA-2024-1f1c0537d3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-1f1c0537d3");
...
var pkgs = [
    {'reference':'webkit2gtk4.0-2.44.3-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
