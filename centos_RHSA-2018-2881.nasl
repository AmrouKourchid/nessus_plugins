...
# extracted from Red Hat Security Advisory RHSA-2018:2881 and 
# CentOS Errata and Security Advisory 2018:2881 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : firefox (CESA-2018:2881)");
...
SecuriTeam Secure Disclosure program.");
  # https://lists.centos.org/pipermail/centos-announce/2018-October/023049.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?94c63e83");
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"firefox-60.2.2-1.el6.centos", allowmaj:TRUE)) flag++;
