...
# extracted from Fedora Security Advisory FEDORA-2024-34474f346b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-34474f346b");

  script_name(english:"Fedora 40 : clamav (2024-34474f346b)");
...
FEDORA-2024-34474f346b advisory.

    ClamAV 1.0.6 is a critical patch release with the following fixes:

      *   Updated select Rust dependencies to the latest versions. This resolved Cargo audit complaints and
    included PNG parser bug fixes.
      ...
      *   Fixed a bug causing CVDs downloaded by the DatabaseCustomURL Freshclam config option to be pruned
    and then re-downloaded with every update.

         *   GitHub pull request<https://github.com/Cisco-Talos/clamav/pull/1240>
      *   Added the new 'valhalla' database name to the list of optional databases in preparation for future
    work.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-34474f346b");
...
var pkgs = [
    {'reference':'clamav-1.0.6-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
