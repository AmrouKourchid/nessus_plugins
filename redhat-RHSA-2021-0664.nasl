...
# extracted from Red Hat Security Advisory RHSA-2021:0664. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:0664");
  script_xref(name:"IAVB", value:"2021-B-0013-S");

  script_name(english:"RHEL 7 / 8 : Ansible security update (2.9.18) (Moderate) (RHSA-2021:0664)");
...
referenced in the RHSA-2021:0664 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_0664.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3208d708");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:0664");
...
"Update the RHEL Ansible package based on the guidance in RHSA-2021:0664.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ansible-2.9.18-1.el8ae', 'release':'8', 'el_string':'el8ae', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2.9'},
      {'reference':'ansible-test-2.9.18-1.el8ae', 'release':'8', 'el_string':'el8ae', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2.9'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'ansible-2.9.18-1.el7ae', 'release':'7', 'el_string':'el7ae', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2.9'},
      {'reference':'ansible-test-2.9.18-1.el7ae', 'release':'7', 'el_string':'el7ae', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2.9'}
    ]
  }
];
