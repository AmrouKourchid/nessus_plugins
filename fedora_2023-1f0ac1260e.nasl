...
# extracted from Fedora Security Advisory FEDORA-2023-1f0ac1260e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-1f0ac1260e");

  script_name(english:"Fedora 39 : perl-CryptX (2023-1f0ac1260e)");
...
FEDORA-2023-1f0ac1260e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-1f0ac1260e");
...
var pkgs = [
    {'reference':'perl-CryptX-0.080-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
