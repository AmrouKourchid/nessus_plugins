...
# extracted from Red Hat Security Advisory RHSA-2025:3262. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:3262");

  script_name(english:"RHEL 9 : nginx:1.24 (RHSA-2025:3262)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for nginx:1.24.");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_3262.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f057660e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:3262");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL nginx:1.24 package based on the guidance in RHSA-2025:3262.");
  ...
  'nginx:1.24': [
    {
      ...
      'pkgs': [
        {'reference':'nginx-1.24.0-4.module+el9.5.0+22954+e2d70a1c.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-all-modules-1.24.0-4.module+el9.5.0+22954+e2d70a1c.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-core-1.24.0-4.module+el9.5.0+22954+e2d70a1c.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-filesystem-1.24.0-4.module+el9.5.0+22954+e2d70a1c.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-mod-devel-1.24.0-4.module+el9.5.0+22954+e2d70a1c.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-mod-http-image-filter-1.24.0-4.module+el9.5.0+22954+e2d70a1c.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-mod-http-perl-1.24.0-4.module+el9.5.0+22954+e2d70a1c.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-mod-http-xslt-filter-1.24.0-4.module+el9.5.0+22954+e2d70a1c.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-mod-mail-1.24.0-4.module+el9.5.0+22954+e2d70a1c.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-mod-stream-1.24.0-4.module+el9.5.0+22954+e2d70a1c.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
      ]
    }
  ]
};
