...
# extracted from Fedora Security Advisory FEDORA-2024-0d7eb64d90
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-0d7eb64d90");

  script_name(english:"Fedora 41 : clamav (2024-0d7eb64d90)");
...
FEDORA-2024-0d7eb64d90 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-0d7eb64d90");
...
var pkgs = [
    {'reference':'clamav-1.0.7-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
