...
# extracted from VMware Security Advisory PHSA-2023-4.0-0307. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Libtiff PHSA-2023-4.0-0307");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the libtiff package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-307.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libtiff-4.5.0-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libtiff-devel-4.5.0-1.ph4')) flag++;
