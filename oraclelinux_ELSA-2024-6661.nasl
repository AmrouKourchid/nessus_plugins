...
# extracted from Oracle Linux Security Advisory ELSA-2024-6661.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : python3-setuptools (ELSA-2024-6661)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-6661.html");
...
var pkgs = [
    {'reference':'python3-setuptools-39.2.0-10.0.3.el7', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
];
