...
# extracted from Fedora Security Advisory FEDORA-2024-17e71fc540
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-17e71fc540");

  script_name(english:"Fedora 39 : booth (2024-17e71fc540)");
...
FEDORA-2024-17e71fc540 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-17e71fc540");
...
"Update the affected booth package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:booth");
...
var pkgs = [
    {'reference':'booth-1.0-283.5.9d4029a.git.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
