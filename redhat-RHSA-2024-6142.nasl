...
# extracted from Red Hat Security Advisory RHSA-2024:6142. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:6142");

  script_name(english:"RHEL 8 : postgresql:15 (RHSA-2024:6142)");
...
referenced in the RHSA-2024:6142 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_6142.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fd666f6d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:6142");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL postgresql:15 package based on the guidance in RHSA-2024:6142.");
  ...
  'postgresql:15': [
    {
      ...
      'pkgs': [
        ...
        {'reference':'postgresql-15.8-1.module+el8.8.0+22236+c63904f0', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-contrib-15.8-1.module+el8.8.0+22236+c63904f0', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-docs-15.8-1.module+el8.8.0+22236+c63904f0', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plperl-15.8-1.module+el8.8.0+22236+c63904f0', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plpython3-15.8-1.module+el8.8.0+22236+c63904f0', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-pltcl-15.8-1.module+el8.8.0+22236+c63904f0', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-private-devel-15.8-1.module+el8.8.0+22236+c63904f0', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-private-libs-15.8-1.module+el8.8.0+22236+c63904f0', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-15.8-1.module+el8.8.0+22236+c63904f0', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-devel-15.8-1.module+el8.8.0+22236+c63904f0', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-static-15.8-1.module+el8.8.0+22236+c63904f0', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-15.8-1.module+el8.8.0+22236+c63904f0', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-rpm-macros-15.8-1.module+el8.8.0+22236+c63904f0', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-upgrade-15.8-1.module+el8.8.0+22236+c63904f0', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-upgrade-devel-15.8-1.module+el8.8.0+22236+c63904f0', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
