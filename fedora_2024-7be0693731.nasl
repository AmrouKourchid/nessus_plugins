...
# extracted from Fedora Security Advisory FEDORA-2024-7be0693731
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-7be0693731");

  script_name(english:"Fedora 38 : matrix-synapse / rust-pythonize (2024-7be0693731)");
...
FEDORA-2024-7be0693731 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-7be0693731");
  script_set_attribute(attribute:"solution", value:
"Update the affected matrix-synapse and / or rust-pythonize packages.");
...
var pkgs = [
    {'reference':'matrix-synapse-1.105.1-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-pythonize-0.21.1-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'matrix-synapse / rust-pythonize');
}
