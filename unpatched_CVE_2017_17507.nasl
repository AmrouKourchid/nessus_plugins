...
if (description)
{
  ...
  script_cve_id("CVE-2017-17507");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2017-17507");
...
patch available.
  ...
  - In HDF5 1.10.1, there is an out of bounds read vulnerability in the function H5T_conv_struct_opt in
    H5Tconv.c in libhdf5.a. For example, h5dump would crash when someone opens a crafted hdf5 file.
    (CVE-2017-17507)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-17507");
