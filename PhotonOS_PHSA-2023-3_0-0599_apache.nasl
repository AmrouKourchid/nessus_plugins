...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Apache PHSA-2023-3.0-0599");
...
if (rpm_check(release:'PhotonOS-3.0', reference:'apache-tomcat-8.5.88-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', reference:'apache-tomcat-webapps-8.5.88-1.ph3')) flag++;
