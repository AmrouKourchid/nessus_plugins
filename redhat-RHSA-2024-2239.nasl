...
# extracted from Red Hat Security Advisory RHSA-2024:2239. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2239");

  script_name(english:"RHEL 9 : skopeo (RHSA-2024:2239)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c13f3e7e");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2239");
...
"Update the RHEL skopeo package based on the guidance in RHSA-2024:2239.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'skopeo-1.14.3-0.1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'skopeo-tests-1.14.3-0.1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
    ]
  }
];
