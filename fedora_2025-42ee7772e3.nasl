...
# extracted from Fedora Security Advisory FEDORA-2025-42ee7772e3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-42ee7772e3");

  script_name(english:"Fedora 41 : libsoup3 (2025-42ee7772e3)");
...
FEDORA-2025-42ee7772e3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-42ee7772e3");
...
var pkgs = [
    {'reference':'libsoup3-3.6.4-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
