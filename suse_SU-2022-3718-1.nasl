...
# SUSE update advisory SUSE-SU-2022:3718-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:3718-1");

  script_name(english:"SUSE SLED12 / SLES12 Security Update : bluez (SUSE-SU-2022:3718-1)");
...
multiple vulnerabilities as referenced in the SUSE-SU-2022:3718-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1013885");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1193237");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2016-9803");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a43b9a0c");
  script_set_attribute(attribute:"solution", value:
"Update the affected bluez, bluez-cups and / or libbluetooth3 packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-8921");
...
var pkgs = [
    {'reference':'bluez-5.13-5.31.1', 'sp':'4', 'cpu':'x86_64', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.4']},
    {'reference':'libbluetooth3-5.13-5.31.1', 'sp':'4', 'cpu':'x86_64', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.4']},
    {'reference':'bluez-cups-5.13-5.31.1', 'sp':'5', 'cpu':'x86_64', 'release':'SLED_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5']},
    {'reference':'bluez-cups-5.13-5.31.1', 'sp':'5', 'cpu':'x86_64', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5']},
    {'reference':'bluez-cups-5.13-5.31.1', 'sp':'5', 'cpu':'x86_64', 'release':'SLED12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-we-release-12.5', 'sled-release-12.5', 'sles-release-12.5']},
    {'reference':'bluez-cups-5.13-5.31.1', 'sp':'5', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-we-release-12.5', 'sled-release-12.5', 'sles-release-12.5']}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'bluez / bluez-cups / libbluetooth3');
}
