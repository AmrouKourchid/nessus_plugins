...
# extracted from Red Hat Security Advisory RHSA-2019:2798 and 
# Oracle Linux Security Advisory ELSA-2019-2798 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : patch (ELSA-2019-2798)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2019-2798.html");
...
var pkgs = [
    {'reference':'patch-2.7.6-9.el8_0', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'patch-2.7.6-9.el8_0', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
