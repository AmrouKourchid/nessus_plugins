...
"The remote Red Hat host is missing a security update for mariadb.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_1039.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?df91582e");
...
"Update the RHEL mariadb package based on the guidance in RHSA-2021:1039.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'mariadb-10.1.20-3.el7ost', 'cpu':'ppc64le', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openstack-'},
      {'reference':'mariadb-10.1.20-3.el7ost', 'cpu':'x86_64', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openstack-'},
      {'reference':'mariadb-common-10.1.20-3.el7ost', 'cpu':'ppc64le', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openstack-'},
      {'reference':'mariadb-common-10.1.20-3.el7ost', 'cpu':'x86_64', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openstack-'},
      {'reference':'mariadb-config-10.1.20-3.el7ost', 'cpu':'ppc64le', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openstack-'},
      {'reference':'mariadb-config-10.1.20-3.el7ost', 'cpu':'x86_64', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openstack-'},
      {'reference':'mariadb-connect-engine-10.1.20-3.el7ost', 'cpu':'ppc64le', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openstack-'},
      {'reference':'mariadb-connect-engine-10.1.20-3.el7ost', 'cpu':'x86_64', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openstack-'},
      {'reference':'mariadb-errmsg-10.1.20-3.el7ost', 'cpu':'ppc64le', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openstack-'},
      {'reference':'mariadb-errmsg-10.1.20-3.el7ost', 'cpu':'x86_64', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openstack-'},
      {'reference':'mariadb-libs-10.1.20-3.el7ost', 'cpu':'ppc64le', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openstack-'},
      {'reference':'mariadb-libs-10.1.20-3.el7ost', 'cpu':'x86_64', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openstack-'},
      {'reference':'mariadb-server-10.1.20-3.el7ost', 'cpu':'ppc64le', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openstack-'},
      {'reference':'mariadb-server-10.1.20-3.el7ost', 'cpu':'x86_64', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openstack-'},
      {'reference':'mariadb-server-galera-10.1.20-3.el7ost', 'cpu':'ppc64le', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openstack-'},
      {'reference':'mariadb-server-galera-10.1.20-3.el7ost', 'cpu':'x86_64', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openstack-'},
      {'reference':'mariadb-test-10.1.20-3.el7ost', 'cpu':'ppc64le', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openstack-'},
      {'reference':'mariadb-test-10.1.20-3.el7ost', 'cpu':'x86_64', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openstack-'}
    ]
  }
];
