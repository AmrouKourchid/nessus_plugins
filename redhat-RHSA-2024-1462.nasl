...
# extracted from Red Hat Security Advisory RHSA-2024:1462. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:1462");

  script_name(english:"RHEL 9 : golang (RHSA-2024:1462)");
...
the RHSA-2024:1462 advisory.

    The golang packages provide the Go programming language compiler.

    Security Fix(es):

     * golang: golang-fips/openssl: Memory leaks in code encrypting and decrypting RSA payloads
    (CVE-2024-1394)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_1462.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ca234fd2");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:1462");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL golang package based on the guidance in RHSA-2024:1462.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'go-toolset-1.20.12-2.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-1.20.12-2.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-bin-1.20.12-2.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-docs-1.20.12-2.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-misc-1.20.12-2.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-src-1.20.12-2.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-tests-1.20.12-2.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
