...
# extracted from Fedora Security Advisory FEDORA-2024-af55471f75
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-af55471f75");

  script_name(english:"Fedora 38 : gnutls (2024-af55471f75)");
...
FEDORA-2024-af55471f75 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-af55471f75");
...
var pkgs = [
    {'reference':'gnutls-3.8.4-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
