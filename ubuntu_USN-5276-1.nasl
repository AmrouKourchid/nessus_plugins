...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2022-A-0102-S");

  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS : NVIDIA graphics drivers vulnerabilities (USN-5276-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 18.04 LTS / 20.04 LTS host has packages installed that are affected by multiple vulnerabilities as
referenced in the USN-5276-1 advisory.

    It was discovered that the NVIDIA graphics drivers incorrectly handled permissions in the kernel mode
    layer. A local attacker could use this issue to write to protected memory and cause a denial of service.
