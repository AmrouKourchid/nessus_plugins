...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.2.0 : babel (EulerOS-SA-2021-2100) (deprecated)");
...
According to the version of the babel package installed, the EulerOS
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2100
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6749d453");
