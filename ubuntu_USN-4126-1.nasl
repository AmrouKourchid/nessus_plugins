...
# extracted from Ubuntu Security Notice USN-4126-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS : FreeType vulnerability (USN-4126-1)");
...
USN-4126-1 advisory.
    ...
    It was discovered that FreeType incorrectly handled certain font files. An attacker could possibly use
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4126-1");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-9383");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'freetype2-demos', 'pkgver': '2.6.1-0.1ubuntu2.4'},
    {'osver': '16.04', 'pkgname': 'libfreetype6', 'pkgver': '2.6.1-0.1ubuntu2.4'},
    {'osver': '16.04', 'pkgname': 'libfreetype6-dev', 'pkgver': '2.6.1-0.1ubuntu2.4'},
    {'osver': '16.04', 'pkgname': 'libfreetype6-udeb', 'pkgver': '2.6.1-0.1ubuntu2.4'}
];
