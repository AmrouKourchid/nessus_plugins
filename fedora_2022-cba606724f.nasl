...
# extracted from Fedora Security Advisory FEDORA-2022-cba606724f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-cba606724f");

  script_name(english:"Fedora 35 : firefox (2022-cba606724f)");
...
FEDORA-2022-cba606724f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-cba606724f");
...
var pkgs = [
    {'reference':'firefox-106.0.3-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
