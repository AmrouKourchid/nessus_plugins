...
# SUSE update advisory SUSE-SU-2022:14879-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:14879-1");

  script_name(english:"SUSE SLES11 Security Update : aide (SUSE-SU-2022:14879-1)");
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-January/010061.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d715f2e1");
...
var pkgs = [
    {'reference':'aide-0.13.1-40.16.6.1', 'sp':'4', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.4']}
];
