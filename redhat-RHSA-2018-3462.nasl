...
# extracted from Red Hat Security Advisory RHSA-2018:3462. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:3462");

  script_name(english:"RHEL 7 : [ansible] (RHSA-2018:3462)");
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_3462.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?700cc687");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:3462");
...
"Update the RHEL [ansible] package based on the guidance in RHSA-2018:3462.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ansible-2.7.1-1.el7ae', 'release':'7', 'el_string':'el7ae', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2'}
    ]
  }
];
