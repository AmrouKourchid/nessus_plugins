...
# extracted from Oracle Linux Security Advisory ELSA-2017-2840.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : dnsmasq (ELSA-2017-2840)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2017-2840.html");
...
var pkgs = [
    {'reference':'dnsmasq-2.45-1.1.0.1.el5_11', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'dnsmasq-2.45-1.1.0.1.el5_11', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
