...
# extracted from Ubuntu Security Notice USN-6033-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6033-1");

  script_name(english:"Ubuntu 22.04 LTS : Linux kernel (OEM) vulnerabilities (USN-6033-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6033-1");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-6.1.0-1009-oem");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-6033-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2022-4269', 'CVE-2023-1032', 'CVE-2023-1076', 'CVE-2023-1077', 'CVE-2023-1079', 'CVE-2023-1118', 'CVE-2023-1583', 'CVE-2023-1670', 'CVE-2023-1829', 'CVE-2023-1855', 'CVE-2023-1989', 'CVE-2023-1990', 'CVE-2023-1998', 'CVE-2023-25012', 'CVE-2023-28466', 'CVE-2023-28866', 'CVE-2023-30456');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-6033-1');
  }
  else
  {
