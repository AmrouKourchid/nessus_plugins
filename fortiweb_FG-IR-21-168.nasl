...
if (description)
{
  ...
  script_cve_id("CVE-2021-43064");

  script_name(english:"Fortinet FortiWeb Open redirect in redir handler due to direct input interpolation (FG-IR-21-168)");
...
vulnerability as referenced in the FG-IR-21-168 advisory.

  - A url redirection to untrusted site ('open redirect') in Fortinet FortiWeb version 6.4.1 and 6.4.0,
    version 6.3.15 and below, version 6.2.6 and below allows attacker to use the device as a proxy and reach
    external or protected hosts via redirection handlers. (CVE-2021-43064)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.fortiguard.com/psirt/FG-IR-21-168");
...
"Please upgrade to FortiWeb version 6.3.16/6.4.2/7.0.0 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-43064");
