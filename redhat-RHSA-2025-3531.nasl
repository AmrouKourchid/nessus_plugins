...
# extracted from Red Hat Security Advisory RHSA-2025:3531. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:3531");

  script_name(english:"RHEL 9 : expat (RHSA-2025:3531)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_3531.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7ae22599");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:3531");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL expat package based on the guidance in RHSA-2025:3531.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'expat-2.5.0-3.el9_5.3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'expat-devel-2.5.0-3.el9_5.3', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
