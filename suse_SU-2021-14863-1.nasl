...
# SUSE update advisory SUSE-SU-2021:14863-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2021:14863-1");

  script_name(english:"SUSE SLES11 Security Update : xorg-x11-server (SUSE-SU-2021:14863-1)");
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2021-December/009901.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?eca69aa9");
...
var pkgs = [
    {'reference':'xorg-x11-Xvnc-7.4-27.122.43.1', 'sp':'4', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.4']},
    {'reference':'xorg-x11-server-7.4-27.122.43.1', 'sp':'4', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.4']},
    {'reference':'xorg-x11-server-extra-7.4-27.122.43.1', 'sp':'4', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.4']}
];
