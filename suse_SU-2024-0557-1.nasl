...
# SUSE update advisory SUSE-SU-2024:0557-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2024:0557-1");

  script_name(english:"SUSE SLES15 / openSUSE 15 Security Update : python-pycryptodomex (SUSE-SU-2024:0557-1)");
...
referenced in the SUSE-SU-2024:0557-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2024-February/017961.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?266f4e08");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2023-52323");
  script_set_attribute(attribute:"solution", value:
"Update the affected python3-pycryptodomex package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:suse_linux:python3-pycryptodomex");
...
var pkgs = [
    {'reference':'python3-pycryptodomex-3.9.9-150300.3.3.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.5']},
    {'reference':'python3-pycryptodomex-3.9.9-150300.3.3.1', 'sp':'5', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-packagehub-subpackages-release-15.5']}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python3-pycryptodomex');
}
