...
# extracted from Red Hat Security Advisory RHSA-2024:1687. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:1687");

  script_name(english:"RHEL 8 : nodejs:20 (RHSA-2024:1687)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for nodejs:20.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:1687 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_1687.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c1b17248");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:1687");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL nodejs:20 package based on the guidance in RHSA-2024:1687.");
  ...
  'nodejs:20': [
    {
      ...
      'pkgs': [
        {'reference':'nodejs-20.11.1-1.module+el8.9.0+21380+12032667', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-devel-20.11.1-1.module+el8.9.0+21380+12032667', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-docs-20.11.1-1.module+el8.9.0+21380+12032667', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-full-i18n-20.11.1-1.module+el8.9.0+21380+12032667', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-nodemon-3.0.1-1.module+el8.9.0+20473+c4e3d824', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'nodejs-packaging-2021.06-4.module+el8.9.0+19519+e25b965a', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'nodejs-packaging-bundler-2021.06-4.module+el8.9.0+19519+e25b965a', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'npm-10.2.4-1.20.11.1.1.module+el8.9.0+21380+12032667', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
      ]
    }
  ]
};
