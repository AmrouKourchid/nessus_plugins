...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : git (EulerOS-SA-2022-1120)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1120
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6c834edf");
...
var pkgs = [
  "git-2.23.0-1.h8.eulerosv2r7",
  "git-core-2.23.0-1.h8.eulerosv2r7",
  "git-core-doc-2.23.0-1.h8.eulerosv2r7",
  "perl-Git-2.23.0-1.h8.eulerosv2r7"
];
