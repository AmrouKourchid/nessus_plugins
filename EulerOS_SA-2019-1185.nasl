...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.3 : openssl (EulerOS-SA-2019-1185)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1185
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?56320417");
...
pkgs = ["openssl-1.0.2k-16.h3",
        "openssl-devel-1.0.2k-12.h3",
        "openssl-libs-1.0.2k-12.h3",
