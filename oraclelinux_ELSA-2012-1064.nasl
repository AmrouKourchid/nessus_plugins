...
ELSA-2012-1064 advisory.
    ...
    - [net] ipv6/netfilter: fix null pointer dereference in nf_ct_frag6_reasm() (Petr Matousek) [833410
    833412] {CVE-2012-2744}
...
var pkgs = [
    ...
    {'reference':'kernel-firmware-2.6.32-279.1.1.el6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-firmware-2.6.32'},
    ...
    {'reference':'kernel-firmware-2.6.32-279.1.1.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-firmware-2.6.32'},
