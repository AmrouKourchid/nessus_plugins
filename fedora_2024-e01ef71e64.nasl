...
# extracted from Fedora Security Advisory FEDORA-2024-e01ef71e64
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-e01ef71e64");

  script_name(english:"Fedora 40 : fontforge (2024-e01ef71e64)");
...
FEDORA-2024-e01ef71e64 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-e01ef71e64");
...
var pkgs = [
    {'reference':'fontforge-20230101-11.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
