...
# extracted from Fedora Security Advisory FEDORA-2023-051e9ea171
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-051e9ea171");

  script_name(english:"Fedora 36 : stb (2023-051e9ea171)");
...
FEDORA-2023-051e9ea171 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-051e9ea171");
...
var pkgs = [
    {'reference':'stb-0^20230129git5736b15-0.2.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
