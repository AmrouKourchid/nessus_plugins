...
# SUSE update advisory SUSE-SU-2022:0149-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:0149-1");

  script_name(english:"SUSE SLED15 / SLES15 Security Update : rust1.56 (SUSE-SU-2022:0149-1)");
...
the SUSE-SU-2022:0149-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-January/010045.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dfd5b211");
  script_set_attribute(attribute:"solution", value:
"Update the affected cargo1.56 and / or rust1.56 packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:suse_linux:cargo1.56");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:suse_linux:rust1.56");
...
var pkgs = [
    {'reference':'cargo1.56-1.56.1-150300.7.6.1', 'sp':'3', 'release':'SLED15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-development-tools-release-15.3']},
    {'reference':'cargo1.56-1.56.1-150300.7.6.1', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-development-tools-release-15.3']},
    {'reference':'rust1.56-1.56.1-150300.7.6.1', 'sp':'3', 'release':'SLED15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-development-tools-release-15.3']},
    {'reference':'rust1.56-1.56.1-150300.7.6.1', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-development-tools-release-15.3']}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'cargo1.56 / rust1.56');
}
