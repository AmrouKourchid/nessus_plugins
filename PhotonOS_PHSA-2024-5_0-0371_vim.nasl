...
# extracted from VMware Security Advisory PHSA-2024-5.0-0371. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2024-43790", "CVE-2024-43802", "CVE-2024-45306");
  script_xref(name:"IAVA", value:"2024-A-0526-S");
  script_xref(name:"IAVA", value:"2024-A-0536-S");

  script_name(english:"Photon OS 5.0: Vim PHSA-2024-5.0-0371");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the vim package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-5.0-371.md");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'vim-9.1.0724-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'vim-extra-9.1.0724-1.ph5')) flag++;
