...
# extracted from Fedora Security Advisory FEDORA-2023-c91ab14186
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-c91ab14186");

  script_name(english:"Fedora 37 : suricata (2023-c91ab14186)");
...
FEDORA-2023-c91ab14186 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-c91ab14186");
...
var pkgs = [
    {'reference':'suricata-6.0.11-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
