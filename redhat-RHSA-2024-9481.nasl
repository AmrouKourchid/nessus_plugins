...
# extracted from Red Hat Security Advisory RHSA-2024:9481. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:9481");

  script_name(english:"RHEL 9 : Red Hat OpenStack Platform 18.0.3 (python-django) (RHSA-2024:9481)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for Red Hat OpenStack Platform 18.0.3 (python-django).");
...
referenced in the RHSA-2024:9481 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_9481.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cc17ee33");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:9481");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat OpenStack Platform 18.0.3 (python-django) package based on the guidance in RHSA-2024:9481.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:C/I:N/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:L/I:N/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-39330");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2024-39329");

  script_set_attribute(attribute:"exploitability_ease", value:"Exploits are available");
  script_set_attribute(attribute:"exploit_available", value:"true");
  script_cwe_id(22, 208, 1287);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-django-3.2.12-8.el9ost', 'release':'9', 'el_string':'el9ost', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
