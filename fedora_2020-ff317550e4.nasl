...
# extracted from Fedora Security Advisory FEDORA-2020-ff317550e4.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 33 : mingw-libxml2 (2020-ff317550e4)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"Add correct fix for CVE-2020-24977 (RHBZ#1877788), thanks: Jan de
Groot.
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-ff317550e4");
...
flag = 0;
if (rpm_check(release:"FC33", reference:"mingw-libxml2-2.9.10-8.fc33")) flag++;
