...
# extracted from Oracle Linux Security Advisory ELSA-2023-6167.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : libguestfs-winsupport (ELSA-2023-6167)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-6167.html");
