...
# extracted from Oracle Linux Security Advisory ELSA-2023-6402.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : containernetworking-plugins (ELSA-2023-6402)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-6402.html");
...
var pkgs = [
    {'reference':'containernetworking-plugins-1.3.0-4.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'containernetworking-plugins-1.3.0-4.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
