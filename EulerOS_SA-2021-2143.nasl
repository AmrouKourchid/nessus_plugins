...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.2 : libcroco (EulerOS-SA-2021-2143)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2143
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f4969b4d");
...
pkgs = ["libcroco-0.6.11-3.h2.eulerosv2r7"];
