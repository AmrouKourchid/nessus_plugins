...
# extracted from Fedora Security Advisory FEDORA-2024-939eac36ae
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-939eac36ae");
  script_xref(name:"IAVB", value:"2024-B-0074-S");

  script_name(english:"Fedora 40 : ghostscript (2024-939eac36ae)");
...
FEDORA-2024-939eac36ae advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-939eac36ae");
...
var pkgs = [
    {'reference':'ghostscript-10.02.1-9.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
