...
if (description)
{
  ...
  script_cve_id("CVE-2022-48837");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-48837");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: usb: gadget: rndis: prevent integer
    overflow in rndis_set_response() If BufOffset is very large the BufOffset + 8 operation can have an
    integer overflow. (CVE-2022-48837)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-48837");
