...
# SUSE update advisory SUSE-SU-2022:3713-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:3713-1");

  script_name(english:"SUSE SLES12 Security Update : multipath-tools (SUSE-SU-2022:3713-1)");
...
in the SUSE-SU-2022:3713-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-October/012642.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c9f16998");
...
var pkgs = [
    {'reference':'kpartx-0.7.3+177+suse.b16d5dc-2.23.1', 'sp':'4', 'cpu':'x86_64', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.4']},
    {'reference':'multipath-tools-0.7.3+177+suse.b16d5dc-2.23.1', 'sp':'4', 'cpu':'x86_64', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.4']},
    {'reference':'kpartx-0.7.3+177+suse.b16d5dc-2.23.1', 'sp':'4', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.4']},
    {'reference':'multipath-tools-0.7.3+177+suse.b16d5dc-2.23.1', 'sp':'4', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.4']}
];
