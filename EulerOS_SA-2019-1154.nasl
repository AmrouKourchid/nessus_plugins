...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : tar (EulerOS-SA-2019-1154)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1154
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?60e000f0");
...
pkgs = ["tar-1.26-34.h1.eulerosv2r7"];
