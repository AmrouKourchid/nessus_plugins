...
# extracted from Red Hat Security Advisory wavpack. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2019-11498", "CVE-2019-1010315", "CVE-2022-2476");

  script_name(english:"RHEL 8 : wavpack (Unpatched Vulnerability) (deprecated)");
