...
# extracted from Fedora Security Advisory FEDORA-2024-e0841c83bb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-e0841c83bb");
  script_xref(name:"IAVA", value:"2024-A-0002-S");

  script_name(english:"Fedora 38 : exim (2024-e0841c83bb)");
...
FEDORA-2024-e0841c83bb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-e0841c83bb");
...
var pkgs = [
    {'reference':'exim-4.97.1-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
