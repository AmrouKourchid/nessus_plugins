...
if (description)
{
  ...
  script_name(english:"RHEL 7 : OpenShift Container Platform 4.4.33 (RHSA-2021:0282)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for OpenShift Container Platform 4.4.33.");
...
referenced in the RHSA-2021:0282 advisory.
    ...
    * jenkins-2-plugins/mercurial: XML parser is not preventing XML external entity (XXE) attacks
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.4.33. See the following
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_0282.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?52b93f3b");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1921164");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.4.33 packages based on the guidance in RHSA-2021:0282.");
