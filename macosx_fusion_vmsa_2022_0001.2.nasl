...
if (description)
{
  ...
  script_name(english:"VMware Fusion 12.0.x < 12.2.0 Vulnerability (VMSA-2022-0001.2)");
...
"The version of VMware Fusion installed on the remote macOS or Mac OS X host is 12.0.x prior to 12.2.0. It is, therefore,
