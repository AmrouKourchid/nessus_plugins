...
# extracted from Oracle Linux Security Advisory ELSA-2024-11185.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : edk2:20220126gitbb1bba3d77 (ELSA-2024-11185)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
ELSA-2024-11185 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-11185.html");
...
if (isnull(module_ver)) audit(AUDIT_PACKAGE_NOT_INSTALLED, 'Module edk2:20220126gitbb1bba3d77');
if ('20220126gitbb1bba3d77' >!< module_ver) audit(AUDIT_PACKAGE_NOT_AFFECTED, 'Module edk2:' + module_ver);

var appstreams = {
    'edk2:20220126gitbb1bba3d77': [
      {'reference':'edk2-aarch64-20220126gitbb1bba3d77-13.el8_10.4', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'edk2-ovmf-20220126gitbb1bba3d77-13.el8_10.4', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
};
...
if (!appstreams_found) audit(AUDIT_PACKAGE_NOT_INSTALLED, 'Module edk2:20220126gitbb1bba3d77');
