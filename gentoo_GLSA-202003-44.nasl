...
# extracted from Gentoo Linux Security Advisory GLSA 202003-44.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202003-44");

  script_name(english:"GLSA-202003-44 : Binary diff: Heap-based buffer overflow");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202003-44
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202003-44");
...
"All Binary diff users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:bsdiff");
...
if (qpkg_check(package:"dev-util/bsdiff", unaffected:make_list("ge 4.3-r4"), vulnerable:make_list("lt 4.3-r4"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "Binary diff");
}
