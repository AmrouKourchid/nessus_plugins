...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Nodejs PHSA-2023-5.0-0011");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2022-43548");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'nodejs-18.16.0-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'nodejs-devel-18.16.0-1.ph5')) flag++;
