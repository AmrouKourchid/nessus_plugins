...
# extracted from Debian Security Advisory dla-2991. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2991-1 : twisted - LTS security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 9 host has packages installed that are affected by a vulnerability as referenced in the dla-2991
advisory.

    The Twisted Web HTTP 1.1 server, located in the twisted.web.http module, parsed several HTTP request
    constructs more leniently than permitted by RFC 7230. This non-conformant parsing can lead to desync if
    requests pass through multiple HTTP parsers, potentially resulting in HTTP request smuggling. For Debian 9
    stretch, this problem has been fixed in version 16.6.0-2+deb9u3. We recommend that you upgrade your
    twisted packages. For the detailed security status of twisted please refer to its security tracker page
    at: https://security-tracker.debian.org/tracker/twisted Further information about Debian LTS security
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=1009030");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/twisted");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2022/dla-2991");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-24801");
...
var pkgs = [
    {'release': '9.0', 'prefix': 'python-twisted', 'reference': '16.6.0-2+deb9u3'},
    {'release': '9.0', 'prefix': 'python-twisted-bin', 'reference': '16.6.0-2+deb9u3'},
    {'release': '9.0', 'prefix': 'python-twisted-bin-dbg', 'reference': '16.6.0-2+deb9u3'},
    {'release': '9.0', 'prefix': 'python-twisted-conch', 'reference': '16.6.0-2+deb9u3'},
    {'release': '9.0', 'prefix': 'python-twisted-core', 'reference': '16.6.0-2+deb9u3'},
    {'release': '9.0', 'prefix': 'python-twisted-mail', 'reference': '16.6.0-2+deb9u3'},
    {'release': '9.0', 'prefix': 'python-twisted-names', 'reference': '16.6.0-2+deb9u3'},
    {'release': '9.0', 'prefix': 'python-twisted-news', 'reference': '16.6.0-2+deb9u3'},
    {'release': '9.0', 'prefix': 'python-twisted-runner', 'reference': '16.6.0-2+deb9u3'},
    {'release': '9.0', 'prefix': 'python-twisted-runner-dbg', 'reference': '16.6.0-2+deb9u3'},
    {'release': '9.0', 'prefix': 'python-twisted-web', 'reference': '16.6.0-2+deb9u3'},
    {'release': '9.0', 'prefix': 'python-twisted-words', 'reference': '16.6.0-2+deb9u3'},
    {'release': '9.0', 'prefix': 'python3-twisted', 'reference': '16.6.0-2+deb9u3'},
    {'release': '9.0', 'prefix': 'python3-twisted-bin', 'reference': '16.6.0-2+deb9u3'},
    {'release': '9.0', 'prefix': 'python3-twisted-bin-dbg', 'reference': '16.6.0-2+deb9u3'},
    {'release': '9.0', 'prefix': 'twisted-doc', 'reference': '16.6.0-2+deb9u3'}
];
