...
# extracted from Fedora Security Advisory FEDORA-2024-f83b123d63
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-f83b123d63");

  script_name(english:"Fedora 39 : llhttp / python-aiohttp / uxplay (2024-f83b123d63)");
...
FEDORA-2024-f83b123d63 advisory.

    Update `llhttp` to 9.2.1, fixing
    [CVE-2024-27982](https://nodejs.org/en/blog/vulnerability/april-2024-security-releases/#http-request-
    smuggling-via-content-length-obfuscation---cve-2024-27982---medium).

    Additionally, `llhttp` 9.2.0 contained [a number of bug
    fixes](https://github.com/nodejs/llhttp/releases/tag/release%2Fv9.2.0).
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-f83b123d63");
...
var pkgs = [
    {'reference':'llhttp-9.2.1-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python-aiohttp-3.9.3-3.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'uxplay-1.68.2-3.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
