...
# extracted from Fedora Security Advisory FEDORA-2024-f9ca680ecd
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-f9ca680ecd");

  script_name(english:"Fedora 40 : micropython (2024-f9ca680ecd)");
...
FEDORA-2024-f9ca680ecd advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-f9ca680ecd");
...
var pkgs = [
    {'reference':'micropython-1.23.0-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
