...
# extracted from Fedora Security Advisory FEDORA-2021-df9ede6a02
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-df9ede6a02");

  script_name(english:"Fedora 33 : netpbm (2021-df9ede6a02)");
...
FEDORA-2021-df9ede6a02 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-df9ede6a02");
...
pkgs = [
    {'reference':'netpbm-10.93.00-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
