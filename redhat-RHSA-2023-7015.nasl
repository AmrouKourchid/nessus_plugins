...
# extracted from Red Hat Security Advisory RHSA-2023:7015. The text
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_7015.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8a9eb7ea");
...
"Update the RHEL wireshark package based on the guidance in RHSA-2023:7015.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'wireshark-2.6.2-17.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'wireshark-cli-2.6.2-17.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'wireshark-devel-2.6.2-17.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
