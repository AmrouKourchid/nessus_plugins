...
# extracted from Fedora Security Advisory FEDORA-2021-265a3c7cb9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-265a3c7cb9");

  script_name(english:"Fedora 32 : dotnet3.1 (2021-265a3c7cb9)");
...
FEDORA-2021-265a3c7cb9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-265a3c7cb9");
...
pkgs = [
    {'reference':'dotnet3.1-3.1.113-1.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE}
];
