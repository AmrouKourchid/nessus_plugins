...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2023-A-0243-S");
...
"The remote Citrix ADC or Citrix Gateway device is version 12.1 before 12.1-65.35, 12.1-FIPS before 12.1-55.296,
13.0 before 13.0-90.11 or 13.1 before 13.1-45.61. It is therefore affected by multiple vulnerabilities:
...
"Upgrade to version 12.1-65.35, 12.1-55.296-FIPS, 13.0-90.11, 13.1-45.61 or later.");
...
if (app_info['fips_status'] == 1)
{
  if (preg(pattern:"^12.1.*", string:app_info['version']))
    constraints = [ {'min_version': '12.1', 'fixed_version': '12.1.55.296', 'fixed_display': '12.1-55.296 and later releases of 12.1-FIPS.'} ];
}
else
{
  constraints = [
