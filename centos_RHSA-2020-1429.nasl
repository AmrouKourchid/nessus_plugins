...
# extracted from Red Hat Security Advisory RHSA-2020:1429 and 
# CentOS Errata and Security Advisory 2020:1429 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : firefox (RHSA-2020:1429)");
...
var pkgs = [
    {'reference':'firefox-68.7.0-2.el6.centos', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
