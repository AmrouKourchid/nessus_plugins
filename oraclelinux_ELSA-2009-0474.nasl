...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : acpid (ELSA-2009-0474)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2009-0474.html");
...
"Update the affected acpid package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2009-0798");
...
var pkgs = [
    {'reference':'acpid-1.0.4-7.el5_3.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'acpid-1.0.4-7.el5_3.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
