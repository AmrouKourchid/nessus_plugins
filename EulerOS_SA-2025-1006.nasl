...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : httpd (EulerOS-SA-2025-1006)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1006
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c7b6de08");
...
var pkgs = [
  "httpd-2.4.43-4.h31.eulerosv2r10",
  "httpd-filesystem-2.4.43-4.h31.eulerosv2r10",
  "httpd-tools-2.4.43-4.h31.eulerosv2r10",
  "mod_ssl-2.4.43-4.h31.eulerosv2r10"
];
