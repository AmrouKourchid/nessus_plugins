...
# extracted from VMware Security Advisory PHSA-2020-3.0-0166. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Elasticsearch PHSA-2020-3.0-0166");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the elasticsearch package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-3.0-166.md");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'elasticsearch-6.8.13-1.ph3')) flag++;
