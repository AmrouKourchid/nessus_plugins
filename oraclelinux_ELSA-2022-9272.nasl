...
# extracted from Oracle Linux Security Advisory ELSA-2022-9272.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : openssl (ELSA-2022-9272)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2022-9272.html");
...
var pkgs = [
    {'reference':'openssl-1.0.1e-59.0.3.ksplice1.el6_10', 'cpu':'i686', 'release':'6', 'el_string':'ksplice1.el6_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'openssl-devel-1.0.1e-59.0.3.ksplice1.el6_10', 'cpu':'i686', 'release':'6', 'el_string':'ksplice1.el6_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'openssl-perl-1.0.1e-59.0.3.ksplice1.el6_10', 'cpu':'i686', 'release':'6', 'el_string':'ksplice1.el6_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'openssl-static-1.0.1e-59.0.3.ksplice1.el6_10', 'cpu':'i686', 'release':'6', 'el_string':'ksplice1.el6_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'openssl-1.0.1e-59.0.3.ksplice1.el6_10', 'cpu':'x86_64', 'release':'6', 'el_string':'ksplice1.el6_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'openssl-devel-1.0.1e-59.0.3.ksplice1.el6_10', 'cpu':'x86_64', 'release':'6', 'el_string':'ksplice1.el6_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'openssl-perl-1.0.1e-59.0.3.ksplice1.el6_10', 'cpu':'x86_64', 'release':'6', 'el_string':'ksplice1.el6_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'openssl-static-1.0.1e-59.0.3.ksplice1.el6_10', 'cpu':'x86_64', 'release':'6', 'el_string':'ksplice1.el6_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
