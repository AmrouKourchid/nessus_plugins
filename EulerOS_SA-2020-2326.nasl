...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : xorg-x11-server (EulerOS-SA-2020-2326)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2326
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7d5a952d");
...
pkgs = ["xorg-x11-server-1.20.1-4.h6.eulerosv2r8",
        "xorg-x11-server-Xephyr-1.20.1-4.h6.eulerosv2r8",
        "xorg-x11-server-Xorg-1.20.1-4.h6.eulerosv2r8",
        "xorg-x11-server-Xvfb-1.20.1-4.h6.eulerosv2r8",
        "xorg-x11-server-Xwayland-1.20.1-4.h6.eulerosv2r8",
        "xorg-x11-server-common-1.20.1-4.h6.eulerosv2r8"];
