...
referenced in the RHSA-2018:0483 advisory.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_0483.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b52379d4");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:0483");
...
"Update the RHEL dhcp package based on the guidance in RHSA-2018:0483.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'dhclient-4.2.5-58.el7_4.3', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'12'},
      {'reference':'dhcp-4.2.5-58.el7_4.3', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'12'},
      {'reference':'dhcp-common-4.2.5-58.el7_4.3', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'12'},
      {'reference':'dhcp-devel-4.2.5-58.el7_4.3', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'12'},
      {'reference':'dhcp-libs-4.2.5-58.el7_4.3', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'12'}
    ]
  }
];
