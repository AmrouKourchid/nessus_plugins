...
# extracted from Fedora Security Advisory FEDORA-2023-203eff67e0
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-203eff67e0");

  script_name(english:"Fedora 36 : wireshark (2023-203eff67e0)");
...
FEDORA-2023-203eff67e0 advisory.

    New version 3.6.13.  Fix for CVE-2023-1992, CVE-2023-1993 and CVE-2023-1994.

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-203eff67e0");
...
var pkgs = [
    {'reference':'wireshark-3.6.13-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
