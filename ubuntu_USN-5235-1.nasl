...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 ESM / 18.04 LTS / 20.04 LTS : Ruby vulnerabilities (USN-5235-1)");
...
vulnerabilities as referenced in the USN-5235-1 advisory.

    It was discovered that Ruby incorrectly handled certain HTML files. An attacker could possibly use this
    issue to cause a crash. This issue only affected Ubuntu 20.04 LTS, Ubuntu 21.04, and Ubuntu 21.10.
    (CVE-2021-41816)

    It was discovered that Ruby incorrectly handled certain regular expressions. An attacker could possibly
    use this issue to cause a regular expression denial of service. (CVE-2021-41817)

    It was discovered that Ruby incorrectly handled certain cookie names. An attacker could possibly use this
    issue to access or expose sensitive information. (CVE-2021-41819)
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libruby2.3', 'pkgver': '2.3.1-2~ubuntu16.04.16+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'ruby2.3', 'pkgver': '2.3.1-2~ubuntu16.04.16+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'ruby2.3-dev', 'pkgver': '2.3.1-2~ubuntu16.04.16+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'ruby2.3-tcltk', 'pkgver': '2.3.1-2~ubuntu16.04.16+esm2', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libruby2.5', 'pkgver': '2.5.1-1ubuntu1.11', 'ubuntu_pro': FALSE},
    {'osver': '18.04', 'pkgname': 'ruby2.5', 'pkgver': '2.5.1-1ubuntu1.11', 'ubuntu_pro': FALSE},
    {'osver': '18.04', 'pkgname': 'ruby2.5-dev', 'pkgver': '2.5.1-1ubuntu1.11', 'ubuntu_pro': FALSE},
    {'osver': '20.04', 'pkgname': 'libruby2.7', 'pkgver': '2.7.0-5ubuntu1.6', 'ubuntu_pro': FALSE},
    {'osver': '20.04', 'pkgname': 'ruby2.7', 'pkgver': '2.7.0-5ubuntu1.6', 'ubuntu_pro': FALSE},
    {'osver': '20.04', 'pkgname': 'ruby2.7-dev', 'pkgver': '2.7.0-5ubuntu1.6', 'ubuntu_pro': FALSE}
];
