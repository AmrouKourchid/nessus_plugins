...
# Rocky Linux Security Advisory RLSA-2024:8935.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2024:8935");

  script_name(english:"RockyLinux 9 : edk2 (RLSA-2024:8935)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2024:8935");
...
var pkgs = [
    {'reference':'edk2-aarch64-20231122-6.el9_4.4', 'release':'9', 'el_string':'el9_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'edk2-ovmf-20231122-6.el9_4.4', 'release':'9', 'el_string':'el9_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'edk2-tools-20231122-6.el9_4.4', 'cpu':'aarch64', 'release':'9', 'el_string':'el9_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'edk2-tools-20231122-6.el9_4.4', 'cpu':'x86_64', 'release':'9', 'el_string':'el9_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'edk2-tools-debuginfo-20231122-6.el9_4.4', 'cpu':'aarch64', 'release':'9', 'el_string':'el9_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'edk2-tools-debuginfo-20231122-6.el9_4.4', 'cpu':'x86_64', 'release':'9', 'el_string':'el9_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'edk2-tools-doc-20231122-6.el9_4.4', 'release':'9', 'el_string':'el9_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'}
];
