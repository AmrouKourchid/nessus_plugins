...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.0 : openldap (EulerOS-SA-2023-2766)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2766
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cd6bcb5a");
...
var pkgs = [
  "openldap-2.6.0-2.h12.eulerosv2r11",
  "openldap-clients-2.6.0-2.h12.eulerosv2r11",
  "openldap-servers-2.6.0-2.h12.eulerosv2r11"
];
