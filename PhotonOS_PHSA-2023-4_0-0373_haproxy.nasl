...
# extracted from VMware Security Advisory PHSA-2023-4.0-0373. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2023-0056", "CVE-2023-0836");

  script_name(english:"Photon OS 4.0: Haproxy PHSA-2023-4.0-0373");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the haproxy package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-373.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'haproxy-2.6.0-3.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'haproxy-doc-2.6.0-3.ph4')) flag++;
