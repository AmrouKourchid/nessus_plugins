...
# extracted from Fedora Security Advisory FEDORA-2019-6497f51791.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : rabbitmq-server (2019-6497f51791)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-6497f51791");
...
"Update the affected rabbitmq-server package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:rabbitmq-server");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"rabbitmq-server-3.7.22-1.fc31")) flag++;
