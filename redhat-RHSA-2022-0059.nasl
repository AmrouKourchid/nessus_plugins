...
"The remote Red Hat host is missing a security update for webkitgtk4.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_0059.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d6bbd195");
...
"Update the RHEL webkitgtk4 package based on the guidance in RHSA-2022:0059.");
...
var constraints = [
  {
    ...
    'pkgs': [
      ...
      {'reference':'webkitgtk4-2.28.2-3.el7', 'cpu':'ppc', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'webkitgtk4-2.28.2-3.el7', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'webkitgtk4-2.28.2-3.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'webkitgtk4-2.28.2-3.el7', 'cpu':'s390', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'webkitgtk4-2.28.2-3.el7', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'webkitgtk4-devel-2.28.2-3.el7', 'cpu':'ppc', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'webkitgtk4-devel-2.28.2-3.el7', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'webkitgtk4-devel-2.28.2-3.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'webkitgtk4-devel-2.28.2-3.el7', 'cpu':'s390', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'webkitgtk4-devel-2.28.2-3.el7', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'webkitgtk4-jsc-2.28.2-3.el7', 'cpu':'ppc', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'webkitgtk4-jsc-2.28.2-3.el7', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'webkitgtk4-jsc-2.28.2-3.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'webkitgtk4-jsc-2.28.2-3.el7', 'cpu':'s390', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'webkitgtk4-jsc-2.28.2-3.el7', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'webkitgtk4-jsc-devel-2.28.2-3.el7', 'cpu':'ppc', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'webkitgtk4-jsc-devel-2.28.2-3.el7', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'webkitgtk4-jsc-devel-2.28.2-3.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'webkitgtk4-jsc-devel-2.28.2-3.el7', 'cpu':'s390', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'webkitgtk4-jsc-devel-2.28.2-3.el7', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
