...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : ipa (EulerOS-SA-2020-1918)");
...
vulnerability :
  ...
  - A flaw was found in all ipa versions 4.x.x through
    4.8.0. When sending a very long password (>= 1,000,000
    characters) to the server, the password hashing process
    could exhaust memory and CPU leading to a denial of
    service and the website becoming unresponsive. The
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1918
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ff603fac");
...
"Update the affected ipa package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-1722");
...
pkgs = ["ipa-client-4.5.4-10.3.h4.eulerosv2r7",
        "ipa-client-common-4.5.4-10.3.h4.eulerosv2r7",
        "ipa-common-4.5.4-10.3.h4.eulerosv2r7",
        "ipa-python-compat-4.5.4-10.3.h4.eulerosv2r7",
        "ipa-server-4.5.4-10.3.h4.eulerosv2r7",
        "ipa-server-common-4.5.4-10.3.h4.eulerosv2r7",
        "ipa-server-dns-4.5.4-10.3.h4.eulerosv2r7",
        "ipa-server-trust-ad-4.5.4-10.3.h4.eulerosv2r7",
        "python2-ipaclient-4.5.4-10.3.h4.eulerosv2r7",
        "python2-ipalib-4.5.4-10.3.h4.eulerosv2r7",
        "python2-ipaserver-4.5.4-10.3.h4.eulerosv2r7"];
