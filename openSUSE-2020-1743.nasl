...
# extracted from openSUSE Security Update openSUSE-2020-1743.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : gnutls (openSUSE-2020-1743)");
...
This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1176086");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1176181");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1176671");
...
if ( rpm_check(release:"SUSE15.2", reference:"gnutls-3.6.7-lp152.9.3.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"gnutls-debuginfo-3.6.7-lp152.9.3.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"gnutls-debugsource-3.6.7-lp152.9.3.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"gnutls-guile-3.6.7-lp152.9.3.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"gnutls-guile-debuginfo-3.6.7-lp152.9.3.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libgnutls-dane-devel-3.6.7-lp152.9.3.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libgnutls-dane0-3.6.7-lp152.9.3.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libgnutls-dane0-debuginfo-3.6.7-lp152.9.3.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libgnutls-devel-3.6.7-lp152.9.3.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libgnutls30-3.6.7-lp152.9.3.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libgnutls30-debuginfo-3.6.7-lp152.9.3.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libgnutls30-hmac-3.6.7-lp152.9.3.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libgnutlsxx-devel-3.6.7-lp152.9.3.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libgnutlsxx28-3.6.7-lp152.9.3.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libgnutlsxx28-debuginfo-3.6.7-lp152.9.3.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"libgnutls-devel-32bit-3.6.7-lp152.9.3.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"libgnutls30-32bit-3.6.7-lp152.9.3.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"libgnutls30-32bit-debuginfo-3.6.7-lp152.9.3.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"libgnutls30-hmac-32bit-3.6.7-lp152.9.3.2") ) flag++;
