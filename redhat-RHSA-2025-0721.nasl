...
# extracted from Red Hat Security Advisory RHSA-2025:0721. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2024-53908", "CVE-2024-56201", "CVE-2024-56326");
  script_xref(name:"RHSA", value:"2025:0721");

  script_name(english:"RHEL 8 / 9 : Red Hat Ansible Automation Platform 2.4 Product Security and Bug Fix Update (Important) (RHSA-2025:0721)");
...
referenced in the RHSA-2025:0721 advisory.
    ...
    * python3-jinja2/python39-jinja2: Jinja has a sandbox breakout through indirect reference to format method
    (CVE-2024-56326)
    * python3-jinja2/python39-jinja2: Jinja has a sandbox breakout through malicious filenames
    (CVE-2024-56201)
    ...
    * Fixed an issue where the traceback from host_metric_summary_monthly task caused a type comparison error
    (AAP-37486)
    * Fixed an issue where the order of source inventories was not respected by the ansible.controller
    collection (AAP-38511)
    * automation-controller has been updated to 4.5.17

    Updates and fixes for installer and setup:
    * Fixed an issue where setting the pg_host= without any other context would result in an empty HOST
    section of settings.py in controller (AAP-38030)
    * Fixed an issue where Automation Hub backup would fail when automationhub_pg_port= (AAP-31261)
    * Fixed an issue where providing the database installation a custom port would break the installation of
    postgres (AAP-31260)
    * Setup script now warns if provided log path does not have write permission and fails if default path
    does not have write permission (AAP-18204)
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_0721.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?755595f8");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:0721");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python39-jinja2-3.1.5-1.el8ap', 'release':'8', 'el_string':'el8ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.4', 'cves':['CVE-2024-56201', 'CVE-2024-56326']}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'automation-controller-venv-tower-4.5.17-1.el8ap', 'release':'8', 'el_string':'el8ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.4', 'cves':['CVE-2024-53908', 'CVE-2024-56201', 'CVE-2024-56326']}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'python3-jinja2-3.1.5-1.el9ap', 'release':'9', 'el_string':'el9ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.4', 'cves':['CVE-2024-56201', 'CVE-2024-56326']}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'automation-controller-venv-tower-4.5.17-1.el9ap', 'release':'9', 'el_string':'el9ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.4', 'cves':['CVE-2024-53908', 'CVE-2024-56201', 'CVE-2024-56326']}
    ]
  }
];
