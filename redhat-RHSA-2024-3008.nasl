...
# extracted from Red Hat Security Advisory RHSA-2024:3008. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:3008");

  script_name(english:"RHEL 8 : pmix (RHSA-2024:3008)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for pmix.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:3008 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_3008.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?687bbaf7");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:3008");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL pmix package based on the guidance in RHSA-2024:3008.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'pmix-2.2.5-3.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pmix-devel-2.2.5-3.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'pmix / pmix-devel');
}
