...
# extracted from Fedora Security Advisory FEDORA-2024-50ab089b1d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-50ab089b1d");

  script_name(english:"Fedora 39 : kernel (2024-50ab089b1d)");
...
FEDORA-2024-50ab089b1d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-50ab089b1d");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for FEDORA-2024-50ab089b1d');
  }
  else
  {
...
var pkgs = [
    {'reference':'kernel-6.6.14-200.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
