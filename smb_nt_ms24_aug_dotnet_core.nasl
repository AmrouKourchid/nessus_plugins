...
if (description)
{
  ...
  script_name(english:"Security Update for Microsoft .NET Core (August 2024)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://msrc.microsoft.com/update-guide/vulnerability/CVE-2024-38167");
  script_set_attribute(attribute:"see_also", value:"https://msrc.microsoft.com/update-guide/vulnerability/CVE-2024-38168");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5042132");
  # https://github.com/dotnet/core/blob/master/release-notes/8.0.0/8.0.8/8.0.8.md
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ef15f8e4");
...
var constraints = [
  { 'min_version' : '8.0.0', 'fixed_version' : '8.0.8' }
];
