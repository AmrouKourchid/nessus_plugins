...
# extracted from Fedora Security Advisory FEDORA-2024-3dbc3e8105
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-3dbc3e8105");

  script_name(english:"Fedora 40 : opensc (2024-3dbc3e8105)");
...
FEDORA-2024-3dbc3e8105 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-3dbc3e8105");
...
var pkgs = [
    {'reference':'opensc-0.25.0-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
