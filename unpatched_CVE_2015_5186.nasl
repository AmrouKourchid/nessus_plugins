...
if (description)
{
  ...
  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2015-5186");
...
patch available.
  ...
  - Audit before 2.4.4 in Linux does not sanitize escape characters in filenames. (CVE-2015-5186)
