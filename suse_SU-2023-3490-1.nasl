...
# SUSE update advisory SUSE-SU-2023:3490-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:3490-1");

  script_name(english:"SUSE SLES15 Security Update : haproxy (SUSE-SU-2023:3490-1)");
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-August/016047.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?474ce5da");
...
var pkgs = [
    {'reference':'haproxy-2.0.31-150200.11.23.1', 'sp':'2', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-ha-release-15.2']},
    {'reference':'haproxy-2.0.31-150200.11.23.1', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-ha-release-15.3']}
];
