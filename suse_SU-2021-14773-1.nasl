...
# SUSE update advisory SUSE-SU-2021:14773-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2021:14773-1");

  script_name(english:"SUSE SLES11 Security Update : djvulibre (SUSE-SU-2021:14773-1)");
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2021-August/009248.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?68929476");
...
var pkgs = [
    {'reference':'libdjvulibre21-3.5.21-3.18.1', 'sp':'4', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.4']}
];
