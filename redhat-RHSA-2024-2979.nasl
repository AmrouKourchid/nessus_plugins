...
# extracted from Red Hat Security Advisory RHSA-2024:2979. The text
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-4273");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2979.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?33ae3c87");
...
"Update the RHEL poppler package based on the guidance in RHSA-2024:2979.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:poppler-glib-doc");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'poppler-20.11.0-11.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'poppler-cpp-20.11.0-11.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'poppler-cpp-devel-20.11.0-11.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'poppler-devel-20.11.0-11.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'poppler-glib-20.11.0-11.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'poppler-glib-devel-20.11.0-11.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'poppler-glib-doc-20.11.0-11.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'poppler-qt5-20.11.0-11.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'poppler-qt5-devel-20.11.0-11.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'poppler-utils-20.11.0-11.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
