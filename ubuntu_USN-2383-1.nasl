...
# extracted from Ubuntu Security Notice USN-2383-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"2383-1");

  script_name(english:"Ubuntu 14.04 LTS : wpa_supplicant vulnerability (USN-2383-1)");
...
USN-2383-1 advisory.
    ...
    Jouni Malinen discovered that the wpa_cli tool incorrectly sanitized strings when being used with action
    scripts. A remote attacker could possibly use this issue to execute arbitrary commands.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2383-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'hostapd', 'pkgver': '1:2.1-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'wpagui', 'pkgver': '2.1-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'wpasupplicant', 'pkgver': '2.1-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'wpasupplicant-udeb', 'pkgver': '2.1-0ubuntu1.1'}
];
