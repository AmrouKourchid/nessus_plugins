...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : SDL (EulerOS-SA-2019-2368)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2368
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8fa1e274");
...
pkgs = ["SDL-1.2.15-14.h3",
        "SDL-devel-1.2.15-14.h3"];
