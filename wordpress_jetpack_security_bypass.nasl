...
only on the application's self-reported version number.");
  script_set_attribute(attribute:"see_also", value:"https://jetpack.com/2014/04/10/jetpack-security-update/");
  script_set_attribute(attribute:"see_also", value:"https://wordpress.org/plugins/jetpack/#changelog");
...
2.5.2 / 2.6.3 / 2.7.2 / 2.8.2 / 2.9.3 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-0173");
