...
# extracted from Fedora Security Advisory FEDORA-2019-18868e1715.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : expat (2019-18868e1715)");
...
> Fix extraction of namespace prefixes from XML names; XML names with
multiple colons could end up in the wrong namespace, and take a high
amount of RAM and CPU resources while processing, opening the door to
use for denial-of-service attacks

For more information on the changes in 2.2.7, see the upstream release
notes at:
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-18868e1715");
  script_set_attribute(attribute:"see_also", value:"https://github.com/libexpat/libexpat/blob/R_2_2_7/expat/Changes#L5");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"expat-2.2.7-1.fc30")) flag++;
