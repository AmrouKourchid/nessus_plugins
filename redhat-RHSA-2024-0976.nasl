...
# extracted from Red Hat Security Advisory RHSA-2024:0976. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:0976");
  script_xref(name:"IAVA", value:"2024-A-0108-S");

  script_name(english:"RHEL 7 : firefox (RHSA-2024:0976)");
...
referenced in the RHSA-2024:0976 advisory.
    ...
    * Mozilla: Memory safety bugs fixed in Firefox 123, Firefox ESR 115.8, and Thunderbird 115.8
    (CVE-2024-1553)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0976.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bdb5b0a8");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0976");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL firefox package based on the guidance in RHSA-2024:0976.");
  ...
  script_cwe_id(74, 120, 125, 449, 681, 1021);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-115.8.0-1.el7_9', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-115.8.0-1.el7_9', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-115.8.0-1.el7_9', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-115.8.0-1.el7_9', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-115.8.0-1.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
