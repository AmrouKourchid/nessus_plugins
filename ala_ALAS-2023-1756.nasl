...
# extracted from Amazon Linux AMI Security Advisory ALAS-2023-1756.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux AMI : libssh2 (ALAS-2023-1756)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux AMI host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of libssh2 installed on the remote host is prior to 1.4.2-3.13. It is, therefore, affected by multiple
vulnerabilities as referenced in the ALAS-2023-1756 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/ALAS-2023-1756.html");
...
var pkgs = [
    {'reference':'libssh2-1.4.2-3.13.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libssh2-1.4.2-3.13.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libssh2-debuginfo-1.4.2-3.13.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libssh2-debuginfo-1.4.2-3.13.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libssh2-devel-1.4.2-3.13.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libssh2-devel-1.4.2-3.13.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libssh2-docs-1.4.2-3.13.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libssh2-docs-1.4.2-3.13.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE}
];
