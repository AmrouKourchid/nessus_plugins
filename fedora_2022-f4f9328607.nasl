...
# extracted from Fedora Security Advisory FEDORA-2022-f4f9328607
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-f4f9328607");

  script_name(english:"Fedora 37 : pypy (2022-f4f9328607)");
...
FEDORA-2022-f4f9328607 advisory.

    Automatic update for pypy-7.3.9-2.fc37.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-f4f9328607");
...
var pkgs = [
    {'reference':'pypy-7.3.9-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
