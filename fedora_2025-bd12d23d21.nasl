...
# extracted from Fedora Security Advisory FEDORA-2025-bd12d23d21
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-bd12d23d21");

  script_name(english:"Fedora 41 : mingw-libsoup (2025-bd12d23d21)");
...
FEDORA-2025-bd12d23d21 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-bd12d23d21");
...
var pkgs = [
    {'reference':'mingw-libsoup-2.74.3-11.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
