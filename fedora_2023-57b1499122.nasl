...
# extracted from Fedora Security Advisory FEDORA-2023-57b1499122
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-57b1499122");

  script_name(english:"Fedora 40 : caddy (2023-57b1499122)");
...
FEDORA-2023-57b1499122 advisory.

    Automatic update for caddy-2.7.4-1.fc40.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-57b1499122");
...
var pkgs = [
    {'reference':'caddy-2.7.4-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
