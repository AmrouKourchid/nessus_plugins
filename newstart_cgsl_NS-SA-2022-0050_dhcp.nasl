...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 6.02 : dhcp Vulnerability (NS-SA-2022-0050)");

  script_set_attribute(attribute:"synopsis", value:
"The remote NewStart CGSL host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 6.02, has dhcp packages installed that are affected by a
vulnerability:
...
more information.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:dhcp-client-debuginfo");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:dhcp-debugsource");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:dhcp-libs-debuginfo");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:dhcp-relay");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:dhcp-relay-debuginfo");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:dhcp-server");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:dhcp-server-debuginfo");
...
var pkgs = {
  'CGSL MAIN 6.02': [
    ...
    'dhcp-client-debuginfo-4.3.6-44.0.1.el8',
    'dhcp-common-4.3.6-44.0.1.el8',
    'dhcp-debuginfo-4.3.6-44.0.1.el8',
    'dhcp-debugsource-4.3.6-44.0.1.el8',
    'dhcp-devel-4.3.6-44.0.1.el8',
    'dhcp-devel-doc-4.3.6-44.0.1.el8',
    'dhcp-libs-4.3.6-44.0.1.el8',
    'dhcp-libs-debuginfo-4.3.6-44.0.1.el8',
    'dhcp-relay-4.3.6-44.0.1.el8',
    'dhcp-relay-debuginfo-4.3.6-44.0.1.el8',
    'dhcp-server-4.3.6-44.0.1.el8',
    'dhcp-server-debuginfo-4.3.6-44.0.1.el8'
  ]
};
