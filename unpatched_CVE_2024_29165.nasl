...
if (description)
{
  ...
  script_cve_id("CVE-2024-29165");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-29165");
...
patch available.
  ...
  - HDF5 through 1.14.3 contains a buffer overflow in H5Z__filter_fletcher32, resulting in the corruption of
    the instruction pointer and causing denial of service or potential code execution. (CVE-2024-29165)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-29165");
