...
# extracted from Red Hat Security Advisory openstack-glance. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2016-8611", "CVE-2017-7200");

  script_name(english:"RHEL 6 : openstack-glance (Unpatched Vulnerability) (deprecated)");
