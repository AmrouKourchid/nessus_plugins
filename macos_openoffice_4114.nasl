...
if (description)
{
  ...
  script_cve_id("CVE-2022-38745", "CVE-2022-47502", "CVE-2022-40674");
  script_xref(name:"IAVA", value:"2023-A-0160-S");

  script_name(english:"Apache OpenOffice < 4.1.14 Multiple Vulnerabilities (macOS)");
...
var constraints = [{'fixed_version': '4.1.14'}];
