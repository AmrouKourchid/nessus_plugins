...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : unixODBC (EulerOS-SA-2019-2267)");
...
vulnerabilities :
  ...
  - The SQLWriteFileDSN function in
    odbcinst/SQLWriteFileDSN.c in unixODBC 2.3.5 has
    strncpy arguments in the wrong order, which allows
    attackers to cause a denial of service or possibly have
    unspecified other impact.(CVE-2018-7485)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2267
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0334f09b");
...
pkgs = ["unixODBC-2.3.1-11.h1",
        "unixODBC-devel-2.3.1-11.h1"];
