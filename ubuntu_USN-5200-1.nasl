...
the USN-5200-1 advisory.
    ...
    denial of service (ReDoS) condition for a client. (CVE-2020-8492)
    ...
    expression denial of service (ReDoS) condition for a client. (CVE-2021-3733)
    ...
    service (DoS) condition for a client. (CVE-2021-3737)
