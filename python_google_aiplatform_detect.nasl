...
if (description)
{
  ...
  script_name(english:"Google AI Platform (VertexAI SDK) Detection");

  script_set_attribute(attribute:"synopsis", value:
"A Google AI Platform Python library is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"A Google AI Platform Python library is installed on the remote host. 

Note that Nessus has relied upon on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://cloud.google.com/python/docs/reference/aiplatform/latest");
  script_set_attribute(attribute:"see_also", value:"https://github.com/googleapis/python-aiplatform");
  ...
  script_set_attribute(attribute:"cpe", value:"cpe:/a:google:python-aiplatform");
...
var app_name = 'google-cloud-aiplatform';
...
var lib_info = {
  ...
  register_install(
    ...
    cpe             : 'cpe:/a:google:python-aiplatform'
  );
