...
if (description)
{
  ...
  script_cve_id("CVE-2024-56550");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-56550");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: s390/stacktrace: Use break instead of
    return statement arch_stack_walk_user_common() contains a return statement instead of a break statement in
    case store_ip() fails while trying to store a callchain entry of a user space process. This may lead to a
    missing pagefault_enable() call. If this happens any subsequent page fault of the process won't be
    resolved by the page fault handler and this in turn will lead to the process being killed. Use a break
    instead of a return statement to fix this. (CVE-2024-56550)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-56550");
