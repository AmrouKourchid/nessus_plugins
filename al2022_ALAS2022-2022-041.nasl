...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2022 : openssl, openssl1.1, openssl1.1-devel (ALAS2022-2022-041)");
...
"It is, therefore, affected by a vulnerability as referenced in the ALAS2022-2022-041 advisory.
    ...
    affects OpenSSL versions 1.0.2, 1.1.1 and 3.0. OpenSSL versions 1.0.2, 1.1.1, and 3.0 have been updated.
    (CVE-2022-0778)
