...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.0 : sudo (EulerOS-SA-2023-2775)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2775
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0b44bf76");
...
var pkgs = [
  "sudo-1.9.8p2-2.h12.eulerosv2r11"
];
