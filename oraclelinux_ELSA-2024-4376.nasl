...
# extracted from Oracle Linux Security Advisory ELSA-2024-4376.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : libreswan (ELSA-2024-4376)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-4376.html");
...
var pkgs = [
    {'reference':'libreswan-4.12-2.0.1.el8_10.4', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libreswan-4.12-2.0.1.el8_10.4', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
