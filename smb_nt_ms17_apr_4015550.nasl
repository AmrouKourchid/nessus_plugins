...
if (description)
{
  ...
  script_xref(name:"MSFT", value:"MS17-4015547");
  ...
  script_name(english:"Windows 8.1 and Windows Server 2012 R2 April 2017 Security Updates");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 4015547
or cumulative update 4015550. It is, therefore, affected by
