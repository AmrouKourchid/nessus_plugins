...
# extracted from Fedora Security Advisory FEDORA-2024-8deaadd998
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-8deaadd998");

  script_name(english:"Fedora 41 : llhttp / python-aiohttp (2024-8deaadd998)");
...
FEDORA-2024-8deaadd998 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-8deaadd998");
...
var pkgs = [
    {'reference':'llhttp-9.2.1-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python-aiohttp-3.9.3-3.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
