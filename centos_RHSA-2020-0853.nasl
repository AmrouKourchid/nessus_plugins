...
# extracted from Red Hat Security Advisory RHSA-2020:0853 and 
# CentOS Errata and Security Advisory 2020:0853 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : zsh (RHSA-2020:0853)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 7 host has packages installed that are affected by a vulnerability as referenced in the
RHSA-2020:0853 advisory.
...
var pkgs = [
    {'reference':'zsh-5.0.2-34.el7_7.2', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'zsh-5.0.2-34.el7_7.2', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'zsh-html-5.0.2-34.el7_7.2', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'zsh-html-5.0.2-34.el7_7.2', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE}
];
