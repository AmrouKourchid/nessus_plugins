...
# extracted from Red Hat Security Advisory RHSA-2020:0946. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:0946");

  script_name(english:"RHEL 7 : Red Hat Single Sign-On 7.3.7 security update on RHEL 7 (Important) (RHSA-2020:0946)");
...
the RHSA-2020:0946 advisory.
    ...
    This release of Red Hat Single Sign-On 7.3.7 on RHEL 7 serves as a replacement for Red Hat Single Sign-On
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_0946.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?188a348e");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:0946");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1805792");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/KEYCLOAK-12380");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat Single Sign-On 7.3.7 package based on the guidance in RHSA-2020:0946.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-sso7-keycloak-4.8.18-1.Final_redhat_00001.1.el7sso', 'release':'7', 'el_string':'el7sso', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-sso'},
      {'reference':'rh-sso7-keycloak-server-4.8.18-1.Final_redhat_00001.1.el7sso', 'release':'7', 'el_string':'el7sso', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-sso'}
    ]
  }
];
