...
# extracted from Red Hat Security Advisory RHSA-2025:0711. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:0711");

  script_name(english:"RHEL 8 : python-jinja2 (RHSA-2025:0711)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_0711.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6c851ab7");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:0711");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-jinja2 package based on the guidance in RHSA-2025:0711.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-jinja2-2.10.1-6.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
