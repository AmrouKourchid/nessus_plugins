...
# extracted from Amazon Linux 2 Security Advisory ALAS-2024-2654.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : aws-cfn-bootstrap (ALAS-2024-2654)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of aws-cfn-bootstrap installed on the remote host is prior to 2.0-31. It is, therefore, affected by a
vulnerability as referenced in the ALAS2-2024-2654 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2024-2654.html");
...
var pkgs = [
    {'reference':'aws-cfn-bootstrap-2.0-31.amzn2', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
