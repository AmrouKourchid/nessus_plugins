...
# extracted from Red Hat Security Advisory RHSA-2023:2236. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2022-27664", "CVE-2022-32189", "CVE-2022-41717");
  script_xref(name:"RHSA", value:"2023:2236");

  script_name(english:"RHEL 9 : toolbox (RHSA-2023:2236)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for toolbox.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2023:2236 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_2236.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5aaed9b9");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/9/html/9.2_release_notes/index
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ecefa061");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2033282");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2163752");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:2236");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL toolbox package based on the guidance in RHSA-2023:2236.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'toolbox-0.0.99.3-9.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'toolbox-tests-0.0.99.3-9.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
