...
# extracted from Debian Security Advisory dla-2839. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2839-1 : gerbv - LTS security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 9 host has a package installed that is affected by a vulnerability as referenced in the dla-2839
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2021/dla-2839");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2021-40391");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/stretch/gerbv");
...
For Debian 9 stretch, this problem has been fixed in version 2.6.1-2+deb9u1.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-40391");
...
var pkgs = [
    {'release': '9.0', 'prefix': 'gerbv', 'reference': '2.6.1-2+deb9u1'}
];
