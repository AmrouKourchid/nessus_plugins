...
# extracted from Fedora Security Advisory FEDORA-2024-c2da7f4de7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-c2da7f4de7");

  script_name(english:"Fedora 39 : tor (2024-c2da7f4de7)");
...
FEDORA-2024-c2da7f4de7 advisory.

    Re-add systemd-devel as build dependency so the daemon knows how to notify systemd that it was started -
    fixes bz#2302910
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-c2da7f4de7");
...
var pkgs = [
    {'reference':'tor-0.4.8.12-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
