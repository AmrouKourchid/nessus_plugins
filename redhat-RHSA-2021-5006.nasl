...
if (description)
{
  ...
  script_name(english:"RHEL 8 : Red Hat Virtualization Host security update [ovirt-4.4.9] Async #1 (Critical) (RHSA-2021:5006)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_5006.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?81da6414");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2029406");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat Virtualization Host package based on the guidance in RHSA-2021:5006.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'redhat-virtualization-host-image-update-4.4.9-202112061811_8.5', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'}
    ]
  }
];
