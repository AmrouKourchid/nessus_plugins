...
referenced in the RHSA-2021:0765 advisory.
    ...
    * RHEL 8.1 - Call traces show I/O stuck for more than 120 sec when at least one path is available for
    NVMe/IB (BZ#1901525)
    ...
    * Host becomes unresponsive during stress-ng --cyclic test rcu: INFO: rcu_preempt detected stalls on
    CPUs/tasks: (BZ#1913965)
    ...
    * kvm-rhel8.3 [AMD] - system crash observed while powering on virtual machine with attached VF interfaces.
    (BZ#1919886)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_0765.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?183750c4");
