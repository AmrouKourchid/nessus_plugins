...
# extracted from Oracle Linux Security Advisory ELSA-2023-7176.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : python-pip (ELSA-2023-7176)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
ELSA-2023-7176 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-7176.html");
...
var pkgs = [
    {'reference':'platform-python-pip-9.0.3-23.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-pip-9.0.3-23.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-pip-wheel-9.0.3-23.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
