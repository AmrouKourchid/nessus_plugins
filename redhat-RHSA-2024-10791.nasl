...
# extracted from Red Hat Security Advisory RHSA-2024:10791. The text
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_10791.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?13ce0d92");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:10791");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL postgresql package based on the guidance in RHSA-2024:10791.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'postgresql-13.18-1.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-contrib-13.18-1.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-docs-13.18-1.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-plperl-13.18-1.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-plpython3-13.18-1.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-pltcl-13.18-1.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-private-devel-13.18-1.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-private-libs-13.18-1.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-server-13.18-1.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-server-devel-13.18-1.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-static-13.18-1.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-test-13.18-1.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-test-rpm-macros-13.18-1.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-upgrade-13.18-1.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-upgrade-devel-13.18-1.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
