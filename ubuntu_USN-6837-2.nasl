...
# extracted from Ubuntu Security Notice USN-6837-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6837-2");

  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 18.04 LTS / 20.04 LTS / 22.04 LTS : Rack vulnerabilities (USN-6837-2)");
...
affected by multiple vulnerabilities as referenced in the USN-6837-2 advisory.

    It was discovered that Rack incorrectly parsed certain media types. A remote attacker could possibly use
    this issue to cause Rack to consume resources, leading to a denial of service. This issue only affected
    ...
    use this issue to cause Rack to create
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6837-2");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'librack-ruby', 'pkgver': '1.5.2-3+deb8u3ubuntu1~esm8', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'librack-ruby1.8', 'pkgver': '1.5.2-3+deb8u3ubuntu1~esm8', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'librack-ruby1.9.1', 'pkgver': '1.5.2-3+deb8u3ubuntu1~esm8', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'ruby-rack', 'pkgver': '1.5.2-3+deb8u3ubuntu1~esm8', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'ruby-rack', 'pkgver': '1.6.4-3ubuntu0.2+esm6', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'ruby-rack', 'pkgver': '1.6.4-4ubuntu0.2+esm6', 'ubuntu_pro': TRUE},
    {'osver': '20.04', 'pkgname': 'ruby-rack', 'pkgver': '2.0.7-2ubuntu0.1+esm5', 'ubuntu_pro': TRUE},
    {'osver': '22.04', 'pkgname': 'ruby-rack', 'pkgver': '2.1.4-5ubuntu1+esm5', 'ubuntu_pro': TRUE}
];
