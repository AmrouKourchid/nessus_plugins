...
# extracted from Fedora Security Advisory FEDORA-2024-193547def8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-193547def8");
  script_xref(name:"IAVB", value:"2023-B-0096-S");

  script_name(english:"Fedora 39 : golang (2024-193547def8)");
...
FEDORA-2024-193547def8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-193547def8");
...
var pkgs = [
    {'reference':'golang-1.21.6-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
