...
# SUSE update advisory SUSE-SU-2025:0112-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2025:0112-1");

  script_name(english:"SUSE SLES15 Security Update : kernel (Live Patch 9 for SLE 15 SP5) (SUSE-SU-2025:0112-1)");
...
the SUSE-SU-2025:0112-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2025-January/020122.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?271b44dc");
...
var kernel_live_checks = [
  {
    'kernels': {
      '5.14.21-150500.55.44-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_14_21-150500_55_44-default-14-150500.2.1', 'sp':'5', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.5']}
        ]
      }
    }
  }
