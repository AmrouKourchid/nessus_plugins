...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Nodejs PHSA-2023-4.0-0417");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'nodejs-18.16.1-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'nodejs-devel-18.16.1-1.ph4')) flag++;
