...
# extracted from Fedora Security Advisory FEDORA-2023-0334c6000a
#
...
if (description)
{
  ...
  script_cve_id("CVE-2023-0241", "CVE-2023-22298");
  script_xref(name:"FEDORA", value:"2023-0334c6000a");
  script_xref(name:"IAVB", value:"2023-B-0026-S");

  script_name(english:"Fedora 36 : pgadmin4 (2023-0334c6000a)");
...
FEDORA-2023-0334c6000a advisory.

    Update to pgadmin4-6.19.

    ----

    Backport fix for CVE-2023-22298.

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-0334c6000a");
...
var pkgs = [
    {'reference':'pgadmin4-6.19-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
