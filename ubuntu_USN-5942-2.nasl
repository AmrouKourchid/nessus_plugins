...
# extracted from Ubuntu Security Notice USN-5942-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5942-2");
  script_xref(name:"IAVA", value:"2023-A-0124-S");

  script_name(english:"Ubuntu 16.04 ESM : Apache HTTP Server vulnerability (USN-5942-2)");
...
USN-5942-2 advisory.
    ...
    USN-5942-1 fixed vulnerabilities in Apache HTTP Server. This update provides the corresponding update for
    CVE-2023-25690 for Ubuntu 16.04 ESM.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5942-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'apache2', 'pkgver': '2.4.18-2ubuntu3.17+esm10', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'apache2-bin', 'pkgver': '2.4.18-2ubuntu3.17+esm10', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'apache2-data', 'pkgver': '2.4.18-2ubuntu3.17+esm10', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'apache2-dev', 'pkgver': '2.4.18-2ubuntu3.17+esm10', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'apache2-suexec-custom', 'pkgver': '2.4.18-2ubuntu3.17+esm10', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'apache2-suexec-pristine', 'pkgver': '2.4.18-2ubuntu3.17+esm10', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'apache2-utils', 'pkgver': '2.4.18-2ubuntu3.17+esm10', 'ubuntu_pro': TRUE}
];
