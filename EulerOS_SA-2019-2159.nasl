...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : icu (EulerOS-SA-2019-2159)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2159
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0baaebdf");
...
pkgs = ["libicu-50.1.2-15.h6.eulerosv2r7",
        "libicu-devel-50.1.2-15.h6.eulerosv2r7"];
