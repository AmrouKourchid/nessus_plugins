...
# SUSE update advisory SUSE-SU-2024:2268-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2024:2268-1");
  script_xref(name:"IAVB", value:"2024-B-0087-S");

  script_name(english:"SUSE SLES15 / openSUSE 15 Security Update : squid (SUSE-SU-2024:2268-1)");
...
as referenced in the SUSE-SU-2024:2268-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5265c7a1");
...
var pkgs = [
    {'reference':'squid-6.10-150600.3.6.1', 'sp':'6', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.6']},
    {'reference':'squid-6.10-150600.3.6.1', 'sp':'6', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.6', 'sle-module-server-applications-release-15.6', 'sles-release-15.6']},
    {'reference':'squid-6.10-150600.3.6.1', 'release':'SUSE15.6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.6']}
];
