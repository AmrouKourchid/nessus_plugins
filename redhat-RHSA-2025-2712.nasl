...
# extracted from Red Hat Security Advisory RHSA-2025:2712. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:2712");

  script_name(english:"RHEL 8 / 9 : OpenShift Container Platform 4.14.49 (RHSA-2025:2712)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for OpenShift Container Platform 4.14.49.");
...
in the RHSA-2025:2712 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.14.49. See the
    ...
    * podman: buildah: Container breakout by using --jobs=2 and a race
    ...
    https://docs.redhat.com/en/documentation/openshift_container_platform/4.14/html-
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_2712.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4aed73c5");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:2712");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.14.49 packages based on the guidance in RHSA-2025:2712.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'buildah-1.29.5-1.rhaos4.14.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openshift-hyperkube'},
      {'reference':'buildah-tests-1.29.5-1.rhaos4.14.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openshift-hyperkube'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'buildah-1.29.5-1.rhaos4.14.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openshift-hyperkube'},
      {'reference':'buildah-tests-1.29.5-1.rhaos4.14.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openshift-hyperkube'}
    ]
  }
];
