...
if (description)
{
  ...
  script_cve_id("CVE-2024-27282", "CVE-2024-35221");

  script_name(english:"EulerOS 2.0 SP10 : ruby (EulerOS-SA-2024-2452)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2452
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e499a38d");
...
var pkgs = [
  "ruby-2.5.8-112.h16.eulerosv2r10",
  "ruby-help-2.5.8-112.h16.eulerosv2r10",
  "ruby-irb-2.5.8-112.h16.eulerosv2r10"
];
