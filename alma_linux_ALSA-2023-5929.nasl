...
# AlmaLinux Security Advisory ALSA-2023:5929.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:5929");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2023/10/31");
  script_xref(name:"IAVA", value:"2023-A-0534-S");
  script_xref(name:"CEA-ID", value:"CEA-2024-0004");

  script_name(english:"AlmaLinux 9 : tomcat (ALSA-2023:5929)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2023-5929.html");
