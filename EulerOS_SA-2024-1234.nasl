...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : docker-runc (EulerOS-SA-2024-1234)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1234
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?93995079");
...
var pkgs = [
  "docker-runc-1.0.0.rc3-300.h27.eulerosv2r11"
];
