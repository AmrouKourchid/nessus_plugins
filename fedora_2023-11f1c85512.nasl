...
# extracted from Fedora Security Advisory FEDORA-2023-11f1c85512
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-11f1c85512");

  script_name(english:"Fedora 40 : python-cryptography / rust-asn1 / rust-asn1_derive (2023-11f1c85512)");
...
FEDORA-2023-11f1c85512 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-11f1c85512");
...
var pkgs = [
    {'reference':'python-cryptography-41.0.3-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-asn1-0.15.5-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-asn1_derive-0.15.5-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
