...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : keepalived (EulerOS-SA-2020-2445)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2445
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9c2db969");
...
"Update the affected keepalived package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-19046");
...
pkgs = ["keepalived-1.3.5-6.h129.eulerosv2r7"];
