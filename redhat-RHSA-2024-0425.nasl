...
# extracted from Red Hat Security Advisory RHSA-2024:0425. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2020-24736", "CVE-2022-35737");
  ...
  script_xref(name:"RHSA", value:"2024:0425");

  script_name(english:"RHEL 8 : sqlite (RHSA-2024:0425)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for sqlite.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:0425 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0425.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f69917f2");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0425");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'lemon-3.26.0-16.el8_6.1', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sqlite-3.26.0-16.el8_6.1', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sqlite-devel-3.26.0-16.el8_6.1', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sqlite-doc-3.26.0-16.el8_6.1', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sqlite-libs-3.26.0-16.el8_6.1', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
