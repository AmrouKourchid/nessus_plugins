...
if (description)
{
  ...
  script_name(english:"Tenable Nessus SEoL (7.2.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Tenable Nessus is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Tenable Nessus is 7.2.x. It is, therefore, no longer maintained by its vendor or provider.
...
"Upgrade to a version of Tenable Nessus that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2020/03/31");
...
var constraints = [
  { max_branch : '7.2', min_branch : '7.2', seol : 20200331, eseol : 20200930 }
];
