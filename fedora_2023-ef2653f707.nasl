...
# extracted from Fedora Security Advisory FEDORA-2023-ef2653f707
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-ef2653f707");

  script_name(english:"Fedora 37 : tacacs (2023-ef2653f707)");
...
FEDORA-2023-ef2653f707 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-ef2653f707");
...
var pkgs = [
    {'reference':'tacacs-F4.0.4.28.7fb~20231005g4fdf178-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
