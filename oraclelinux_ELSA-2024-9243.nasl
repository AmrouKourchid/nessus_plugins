...
# extracted from Oracle Linux Security Advisory ELSA-2024-9243.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : post (ELSA-2024-9243)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-9243.html");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:postfix-cdb");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:postfix-ldap");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:postfix-lmdb");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:postfix-mysql");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:postfix-pcre");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:postfix-perl-scripts");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:postfix-pgsql");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:postfix-sqlite");
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'postfix / postfix-cdb / postfix-ldap / etc');
}
