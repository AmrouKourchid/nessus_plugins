...
if (description)
{
  ...
  script_cve_id("CVE-2018-7549");

  script_name(english:"Photon OS 2.0: Zsh PHSA-2018-2.0-0037");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-7549");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'zsh-5.3.1-6.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'zsh-debuginfo-5.3.1-6.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'zsh-html-5.3.1-6.ph2')) flag++;
