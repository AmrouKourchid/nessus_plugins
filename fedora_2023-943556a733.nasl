...
# extracted from Fedora Security Advisory FEDORA-2023-943556a733
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-943556a733");

  script_name(english:"Fedora 37 : pypy3.8 (2023-943556a733)");
...
FEDORA-2023-943556a733 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-943556a733");
...
var pkgs = [
    {'reference':'pypy3.8-7.3.11-1.3.8.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
