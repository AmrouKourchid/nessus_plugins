...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : java-1.8.0-openjdk (EulerOS-SA-2019-1777)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1777
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?780bada2");
...
"Update the affected java-1.8.0-openjdk package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-3214");
...
pkgs = ["java-1.8.0-openjdk-1.8.0.181.b15-5.h4.eulerosv2r8",
        "java-1.8.0-openjdk-headless-1.8.0.181.b15-5.h4.eulerosv2r8"];
