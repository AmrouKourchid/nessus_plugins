...
# extracted from openSUSE Security Update openSUSE-2018-819.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : znc (openSUSE-2018-819)");
...
"This update for znc fixes the following issues :
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1101280");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1101281");
  script_set_attribute(attribute:"solution", value:
"Update the affected znc packages.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:L/UI:N/S:U/C:N/I:H/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-14056");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2018-14055");
...
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"znc-1.7.1-lp150.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"znc-debuginfo-1.7.1-lp150.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"znc-debugsource-1.7.1-lp150.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"znc-devel-1.7.1-lp150.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"znc-perl-1.7.1-lp150.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"znc-perl-debuginfo-1.7.1-lp150.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"znc-python3-1.7.1-lp150.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"znc-python3-debuginfo-1.7.1-lp150.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"znc-tcl-1.7.1-lp150.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"znc-tcl-debuginfo-1.7.1-lp150.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"znc-1.7.1-20.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"znc-debuginfo-1.7.1-20.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"znc-debugsource-1.7.1-20.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"znc-devel-1.7.1-20.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"znc-lang-1.7.1-20.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"znc-perl-1.7.1-20.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"znc-perl-debuginfo-1.7.1-20.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"znc-python3-1.7.1-20.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"znc-python3-debuginfo-1.7.1-20.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"znc-tcl-1.7.1-20.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"znc-tcl-debuginfo-1.7.1-20.3.1") ) flag++;
