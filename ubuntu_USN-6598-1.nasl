...
# extracted from Ubuntu Security Notice USN-6598-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6598-1");

  script_name(english:"Ubuntu 20.04 LTS / 22.04 LTS / 23.10 : Paramiko vulnerability (USN-6598-1)");
...
referenced in the USN-6598-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6598-1");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'python3-paramiko', 'pkgver': '2.6.0-2ubuntu0.3'},
    {'osver': '22.04', 'pkgname': 'python3-paramiko', 'pkgver': '2.9.3-0ubuntu1.2'},
    {'osver': '23.10', 'pkgname': 'python3-paramiko', 'pkgver': '2.12.0-2ubuntu1.23.10.2'}
];
