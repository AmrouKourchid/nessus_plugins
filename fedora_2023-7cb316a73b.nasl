...
# extracted from Fedora Security Advisory FEDORA-2023-7cb316a73b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-7cb316a73b");

  script_name(english:"Fedora 38 : rust-rustls-webpki (2023-7cb316a73b)");
...
FEDORA-2023-7cb316a73b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-7cb316a73b");
...
var pkgs = [
    {'reference':'rust-rustls-webpki-0.100.2-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
