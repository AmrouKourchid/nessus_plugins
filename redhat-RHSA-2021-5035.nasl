...
# extracted from Red Hat Security Advisory RHSA-2021:5035. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2020-36385", "CVE-2021-43527");
  script_xref(name:"RHSA", value:"2021:5035");

  script_name(english:"RHEL 7 : RHV-H security update (redhat-virtualization-host) 4.3.20 (Critical) (RHSA-2021:5035)");
...
referenced in the RHSA-2021:5035 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_5035.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?79e8d7eb");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:5035");
...
"Update the RHEL RHV-H package based on the guidance in RHSA-2021:5035.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'redhat-virtualization-host-image-update-4.3.20-20211202.1.el7_9', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'}
    ]
  }
];
