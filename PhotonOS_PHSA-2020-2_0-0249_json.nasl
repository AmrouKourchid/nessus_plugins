...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Json PHSA-2020-2.0-0249");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'json-c-0.13.1-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'json-c-devel-0.13.1-1.ph2')) flag++;
