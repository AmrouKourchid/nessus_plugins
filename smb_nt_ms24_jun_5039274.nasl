...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5039274");
  script_xref(name:"MSKB", value:"5039289");
  script_xref(name:"MSFT", value:"MS24-5039274");
  script_xref(name:"MSFT", value:"MS24-5039289");
  ...
  script_name(english:"KB5039274: Windows Server 2008 R2 Security Update (June 2024)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5039274");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5039289");
...
if (("windows server 2008 r2" >< tolower(os_name)) &&
  smb_check_rollup(os:'6.1',
                   ...
                   rollup_date:'06_2024',
                   bulletin:bulletin,
                   rollup_kb_list:[5039289, 5039274])
)
{
