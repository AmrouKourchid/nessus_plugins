...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : binutils (EulerOS-SA-2021-1895)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1895
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a9d027e1");
...
"Update the affected binutils packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-35507");
...
pkgs = ["binutils-2.27-28.base.1.h49.eulerosv2r7",
        "binutils-devel-2.27-28.base.1.h49.eulerosv2r7"];
