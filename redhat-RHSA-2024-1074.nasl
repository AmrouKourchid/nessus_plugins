...
# extracted from Red Hat Security Advisory RHSA-2024:1074. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:1074");

  script_name(english:"RHEL 8 : 389-ds:1.4 (RHSA-2024:1074)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for 389-ds:1.4.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:1074 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_1074.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?edd701af");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2261879");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-15025");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-15030");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:1074");
  ...
  '389-ds:1.4': [
    {
      ...
      'pkgs': [
        {'reference':'389-ds-base-1.4.3.34-6.module+el8.6.0+21315+7f417418', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'389-ds-base-devel-1.4.3.34-6.module+el8.6.0+21315+7f417418', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'389-ds-base-legacy-tools-1.4.3.34-6.module+el8.6.0+21315+7f417418', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'389-ds-base-libs-1.4.3.34-6.module+el8.6.0+21315+7f417418', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'389-ds-base-snmp-1.4.3.34-6.module+el8.6.0+21315+7f417418', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-lib389-1.4.3.34-6.module+el8.6.0+21315+7f417418', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
