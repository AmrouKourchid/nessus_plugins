...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : compat-openssl10 (EulerOS-SA-2023-3423)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3423
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ba8e5d6f");
...
var pkgs = [
  "compat-openssl10-1.0.2o-3.h21.eulerosv2r8"
];
