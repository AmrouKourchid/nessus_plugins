...
# extracted from Debian Security Advisory dla-3936. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3936 : activemq - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-41678");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-46604");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bullseye/activemq");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'activemq', 'reference': '5.16.1-1+deb11u1'},
    {'release': '11.0', 'prefix': 'libactivemq-java', 'reference': '5.16.1-1+deb11u1'}
];
