...
"The version of Firefox ESR installed on the remote macOS or Mac OS X host is prior to 60.9. It is, therefore, affected
by multiple vulnerabilities as referenced in the mfsa2019-27 advisory.
...
mozilla_check_version(version:version, path:path, product:'firefox', esr:TRUE, fix:'60.9', min:'60.0.0', severity:SECURITY_HOLE, xss:TRUE);
