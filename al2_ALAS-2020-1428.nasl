...
"The version of python-twisted-web installed on the remote host is prior to 12.1.0-7. It is, therefore, affected by
multiple vulnerabilities as referenced in the ALAS2-2020-1428 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2020-1428.html");
...
var pkgs = [
    {'reference':'python-twisted-web-12.1.0-7.amzn2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python-twisted-web-12.1.0-7.amzn2', 'cpu':'i686', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python-twisted-web-12.1.0-7.amzn2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
