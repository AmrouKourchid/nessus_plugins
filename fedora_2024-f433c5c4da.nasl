...
# extracted from Fedora Security Advisory FEDORA-2024-f433c5c4da
#
...
if (description)
{
  ...
  script_cve_id("CVE-2024-29510", "CVE-2024-33870");
  script_xref(name:"FEDORA", value:"2024-f433c5c4da");
  script_xref(name:"IAVB", value:"2024-B-0074-S");

  script_name(english:"Fedora 40 : ghostscript (2024-f433c5c4da)");
...
FEDORA-2024-f433c5c4da advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-f433c5c4da");
...
var pkgs = [
    {'reference':'ghostscript-10.02.1-10.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
