...
# extracted from Fedora Security Advisory FEDORA-2024-4645d0fdef
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-4645d0fdef");

  script_name(english:"Fedora 39 : libmodsecurity (2024-4645d0fdef)");
...
FEDORA-2024-4645d0fdef advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-4645d0fdef");
...
var pkgs = [
    {'reference':'libmodsecurity-3.0.12-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
