...
# extracted from Amazon Linux 2 Security Advisory ALAS-2021-1602.
##
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2021-1602");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2022/09/15");

  script_name(english:"Amazon Linux 2 : php-pear (ALAS-2021-1602)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of php-pear installed on the remote host is prior to 1.10.12-5. It is, therefore, affected by a
vulnerability as referenced in the ALAS2-2021-1602 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2021-1602.html");
...
var pkgs = [
    {'reference':'php-pear-1.10.12-5.amzn2', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
