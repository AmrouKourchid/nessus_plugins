...
# extracted from Fedora Security Advisory FEDORA-2024-03a1955920
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-03a1955920");

  script_name(english:"Fedora 40 : webkitgtk (2024-03a1955920)");
...
FEDORA-2024-03a1955920 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-03a1955920");
...
var pkgs = [
    {'reference':'webkitgtk-2.46.5-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
