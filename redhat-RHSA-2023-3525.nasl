...
# extracted from Red Hat Security Advisory RHSA-2023:3525. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:3525");

  script_name(english:"RHEL 7 : python-flask (RHSA-2023:3525)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_3525.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c2317247");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2196643");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:3525");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-flask package based on the guidance in RHSA-2023:3525.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python-flask-0.10.1-7.el7_9', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
