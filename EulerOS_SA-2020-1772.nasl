...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : libvorbis (EulerOS-SA-2020-1772)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1772
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0dc50799");
...
pkgs = ["libvorbis-1.3.3-8.h5.eulerosv2r7"];
