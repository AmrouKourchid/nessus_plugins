...
# extracted from Oracle Linux Security Advisory ELSA-2022-8222.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : xorg-x11-server-Xwayland (ELSA-2022-8222)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2022-8222.html");
