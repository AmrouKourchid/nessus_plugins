...
if (description)
{
  ...
  script_cve_id("CVE-2022-49243");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-49243");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: ASoC: atmel: Add missing of_node_put()
    in at91sam9g20ek_audio_probe This node pointer is returned by of_parse_phandle() with refcount incremented
    in this function. Calling of_node_put() to avoid the refcount leak. (CVE-2022-49243)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-49243");
