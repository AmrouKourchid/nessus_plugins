...
(GNU Wget: Password and metadata leak)
    ...
    A vulnerability was discovered in GNU Wget&rsquo;s file_metadata in xattr.c.
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/201903-08");
