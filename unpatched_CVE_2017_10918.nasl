...
if (description)
{
  ...
  script_cve_id("CVE-2017-10918");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2017-10918");
...
patch available.
  ...
  - Xen through 4.8.x does not validate memory allocations during certain P2M operations, which allows guest
    OS users to obtain privileged host OS access, aka XSA-222. (CVE-2017-10918)
