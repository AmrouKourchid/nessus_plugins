...
# extracted from Fedora Security Advisory FEDORA-2024-900dc7f6ff
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-900dc7f6ff");
  script_xref(name:"IAVA", value:"2024-A-0071");

  script_name(english:"Fedora 39 : runc (2024-900dc7f6ff)");
...
FEDORA-2024-900dc7f6ff advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-900dc7f6ff");
...
var pkgs = [
    {'reference':'runc-1.1.12-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
