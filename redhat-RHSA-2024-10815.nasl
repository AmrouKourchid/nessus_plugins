...
# extracted from Red Hat Security Advisory RHSA-2024:10815. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:10815");

  script_name(english:"RHEL 9 : OpenShift Container Platform 4.13.54 (RHSA-2024:10815)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for OpenShift Container Platform 4.13.54.");
...
referenced in the RHSA-2024:10815 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.13.54. See the
    ...
    * waitress: python-waitress: request processing race condition in HTTP pipelining with invalid first
    request (CVE-2024-49768)
    * waitress: Waitress has a denial of service leading to high CPU usage/resource exhaustion
    ...
    https://docs.openshift.com/container-platform/4.13/updating/updating_a_cluster/updating-cluster-cli.html
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_10815.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9dda5bfe");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:10815");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.13.54 packages based on the guidance in RHSA-2024:10815.");
