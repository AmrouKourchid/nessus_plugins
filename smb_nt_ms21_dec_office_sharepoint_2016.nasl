...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5002059");
  script_xref(name:"MSKB", value:"5002055");
  script_xref(name:"MSFT", value:"MS21-5002059");
  script_xref(name:"MSFT", value:"MS21-5002055");

  script_name(english:"Security Updates for Microsoft SharePoint Server 2016 (December 2021)");
...
affected by multiple vulnerabilities:
  ...
  - A remote code execution vulnerability. An attacker can
    ...
    CVE-2021-42309)");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002059");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002055");
