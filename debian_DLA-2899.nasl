...
advisory.
    ...
    The Qualys Research Labs discovered a local privilege escalation in PolicyKit's pkexec. Details can be
    found in the Qualys advisory at https://www.qualys.com/2022/01/25/cve-2021-4034/pwnkit.txt For Debian 9
    stretch, this problem has been fixed in version 0.105-18+deb9u2. We recommend that you upgrade your
    policykit-1 packages. For the detailed security status of policykit-1 please refer to its security tracker
    page at: https://security-tracker.debian.org/tracker/policykit-1 Further information about Debian LTS
