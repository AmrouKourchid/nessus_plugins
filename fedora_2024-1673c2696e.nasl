...
# extracted from Fedora Security Advisory FEDORA-2024-1673c2696e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-1673c2696e");

  script_name(english:"Fedora 39 : jupyterlab / python-notebook (2024-1673c2696e)");
...
FEDORA-2024-1673c2696e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-1673c2696e");
...
"Update the affected jupyterlab and / or python-notebook packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-22421");
...
var pkgs = [
    {'reference':'jupyterlab-4.0.11-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python-notebook-7.0.7-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
