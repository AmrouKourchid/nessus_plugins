...
# extracted from Red Hat Security Advisory RHSA-2024:2204. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2204");

  script_name(english:"RHEL 9 : libnbd (RHSA-2024:2204)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for libnbd.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:2204 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2204.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9d9a50ea");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2204");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2241041");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2247308");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-14476");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-16292");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-7099");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libnbd package based on the guidance in RHSA-2024:2204.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libnbd-1.18.1-3.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libnbd-bash-completion-1.18.1-3.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libnbd-devel-1.18.1-3.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nbdfuse-1.18.1-3.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ocaml-libnbd-1.18.1-3.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ocaml-libnbd-devel-1.18.1-3.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-libnbd-1.18.1-3.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
