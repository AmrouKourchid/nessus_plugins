...
# extracted from Fedora Security Advisory FEDORA-2024-0639ad0299
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-0639ad0299");
  script_xref(name:"IAVA", value:"2024-A-0386-S");

  script_name(english:"Fedora 39 : thunderbird (2024-0639ad0299)");
...
FEDORA-2024-0639ad0299 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-0639ad0299");
...
var pkgs = [
    {'reference':'thunderbird-115.13.0-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
