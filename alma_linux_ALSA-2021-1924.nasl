...
# AlmaLinux Security Advisory ALSA-2021:1924.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2021:1924");

  script_name(english:"AlmaLinux 8 : spice (ALSA-2021:1924)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 8 host has packages installed that are affected by a vulnerability as referenced in the
ALSA-2021:1924 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2021-1924.html");
...
"Update the affected spice-server and / or spice-server-devel packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:spice-server");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:spice-server-devel");
