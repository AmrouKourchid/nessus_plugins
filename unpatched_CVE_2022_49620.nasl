...
if (description)
{
  ...
  script_cve_id("CVE-2022-49620");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-49620");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: net: tipc: fix possible refcount leak
    in tipc_sk_create() Free sk in case tipc_sk_insert() fails. (CVE-2022-49620)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-49620");
