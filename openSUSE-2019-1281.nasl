...
# extracted from openSUSE Security Update openSUSE-2019-1281.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : wget (openSUSE-2019-1281)");
...
if ( rpm_check(release:"SUSE42.3", reference:"wget-1.14-18.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"wget-debuginfo-1.14-18.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"wget-debugsource-1.14-18.1") ) flag++;
