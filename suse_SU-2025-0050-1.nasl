...
# SUSE update advisory SUSE-SU-2025:0050-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2025:0050-1");

  script_name(english:"SUSE SLES15 Security Update : libmfx (SUSE-SU-2025:0050-1)");
...
referenced in the SUSE-SU-2025:0050-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2025-January/020084.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?55bfda6e");
...
"Update the affected libmfx1 package.");
...
var pkgs = [
    {'reference':'libmfx1-21.3.4-150400.3.5.1', 'sp':'4', 'cpu':'x86_64', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.4']},
    {'reference':'libmfx1-21.3.4-150400.3.5.1', 'sp':'4', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-ESPOS-release-4']},
    {'reference':'libmfx1-21.3.4-150400.3.5.1', 'sp':'4', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-LTSS-release-15.4', 'sles-ltss-release-15.4']}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libmfx1');
}
