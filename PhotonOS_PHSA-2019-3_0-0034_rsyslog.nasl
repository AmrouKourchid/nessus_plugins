...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'rsyslog-8.1907.0-2.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'rsyslog-debuginfo-8.1907.0-2.ph3')) flag++;
