...
# extracted from Fedora Security Advisory FEDORA-2024-aa6e72c713
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-aa6e72c713");

  script_name(english:"Fedora 41 : syncthing (2024-aa6e72c713)");
...
FEDORA-2024-aa6e72c713 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-aa6e72c713");
...
var pkgs = [
    {'reference':'syncthing-1.28.0-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
