...
# extracted from Red Hat Security Advisory RHSA-2025:7160. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:7160");

  script_name(english:"RHEL 9 : bootc (RHSA-2025:7160)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for bootc.");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-63018");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-66258");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-72862");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_7160.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?abbe9115");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:7160");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL bootc package based on the guidance in RHSA-2025:7160.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:bootc");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:system-reinstall-bootc");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'bootc-1.1.6-3.el9_6', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'system-reinstall-bootc-1.1.6-3.el9_6', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'bootc / system-reinstall-bootc');
}
