...
# extracted from Fedora Security Advisory FEDORA-2024-a7bec8b0bd
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-a7bec8b0bd");

  script_name(english:"Fedora 38 : zabbix (2024-a7bec8b0bd)");
...
FEDORA-2024-a7bec8b0bd advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-a7bec8b0bd");
...
"Update the affected 1:zabbix package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-32726");
...
var pkgs = [
    {'reference':'zabbix-6.0.25-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
