...
# extracted from SUSE update advisory SUSE-SU-2018:2584-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : spice (SUSE-SU-2018:2584-1)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8bb73e94");
...
SUSE-SLE-SERVER-12-2018-1816=1");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"0", cpu:"x86_64", reference:"libspice-server1-0.12.4-8.18.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", cpu:"x86_64", reference:"libspice-server1-debuginfo-0.12.4-8.18.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", cpu:"x86_64", reference:"spice-debugsource-0.12.4-8.18.1")) flag++;
