...
if (description)
{
  ...
  script_name(english:"Google Chrome < 120.0.6099.234 Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"A web browser installed on the remote macOS host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Google Chrome installed on the remote macOS host is prior to 120.0.6099.234. It is, therefore, affected
...
"Upgrade to Google Chrome version 120.0.6099.234 or later.");
...
google_chrome_check_version(fix:'120.0.6099.234', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
