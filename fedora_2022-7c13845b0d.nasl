...
# extracted from Fedora Security Advisory FEDORA-2022-7c13845b0d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-7c13845b0d");
  script_xref(name:"IAVA", value:"2023-A-0072");

  script_name(english:"Fedora 35 : libksba (2022-7c13845b0d)");
...
FEDORA-2022-7c13845b0d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-7c13845b0d");
...
var pkgs = [
    {'reference':'libksba-1.6.2-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
