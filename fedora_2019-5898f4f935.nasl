...
# extracted from Fedora Security Advisory FEDORA-2019-5898f4f935.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-5898f4f935");

  script_name(english:"Fedora 31 : 1:dovecot (2019-5898f4f935)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"Security fix for CVE-2019-19722: NULL pointer dereference in push
notification driver
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-5898f4f935");
...
"Update the affected 1:dovecot package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-19722");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"dovecot-2.3.9.2-1.fc31", epoch:"1")) flag++;
