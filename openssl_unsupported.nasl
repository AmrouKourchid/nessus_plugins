...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"0001-A-0572");

  script_name(english:"OpenSSL Unsupported (deprecated)");
...
search the plugin feed for OpenSSL SEoL.");
...
exit(0, 'This plugin has been deprecated. For plugins which identify unsupported instances of this product, search the plugin feed for OpenSSL SEoL.');