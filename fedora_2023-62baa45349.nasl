...
# extracted from Fedora Security Advisory FEDORA-2023-62baa45349
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-62baa45349");

  script_name(english:"Fedora 37 : python-configobj (2023-62baa45349)");
...
FEDORA-2023-62baa45349 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-62baa45349");
...
var pkgs = [
    {'reference':'python-configobj-5.0.8-6.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
