...
# extracted from Fedora Security Advisory FEDORA-2018-f2097d8937.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-f2097d8937");

  script_name(english:"Fedora 26 : php-simplesamlphp-saml2_3 (2018-f2097d8937)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-f2097d8937");
...
flag = 0;
if (rpm_check(release:"FC26", reference:"php-simplesamlphp-saml2_3-3.1.4-1.fc26")) flag++;
