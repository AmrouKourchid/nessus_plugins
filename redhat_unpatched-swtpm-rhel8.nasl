...
# extracted from Red Hat Security Advisory swtpm. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2020-28407", "CVE-2022-23645");

  script_name(english:"RHEL 8 : swtpm (Unpatched Vulnerability) (deprecated)");
...
"This plugin has been deprecated as it does not adhere to established standards for this style of check.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2020-28407");
