...
# extracted from Red Hat Security Advisory RHSA-2017:0834. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2017:0834");

  script_name(english:"RHEL 6 / 7 : JBoss EAP (RHSA-2017:0834)");
...
Refer to the JBoss Enterprise Application Platform 7.0.5 Release
...
applications.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2017:0834");
...
else
{
  ...
  if (rpm_check(release:"RHEL6", reference:"eap7-jboss-ec2-eap-7.0.5-1.GA_redhat_1.ep7.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"eap7-jboss-ec2-eap-samples-7.0.5-1.GA_redhat_1.ep7.el6")) flag++;

  if (rpm_check(release:"RHEL7", reference:"eap7-jboss-ec2-eap-7.0.5-1.GA_redhat_1.ep7.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"eap7-jboss-ec2-eap-samples-7.0.5-1.GA_redhat_1.ep7.el7")) flag++;
