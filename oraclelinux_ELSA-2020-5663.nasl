...
the ELSA-2020-5663 advisory.
    ...
    - slcan: Don't transmit uninitialized stack data in padding (Richard Palethorpe)  [Orabug: 31136750]
    {CVE-2020-11494}
    - blktrace: Protect q->blk_trace with RCU (Jan Kara)  [Orabug: 31123573]  {CVE-2019-19768}
    - floppy: check FDC index for errors before assigning it (Linus Torvalds)  [Orabug: 31067510]
    {CVE-2020-9383}
    - vhost: Check docket sk_family instead of call getname (Eugenio Perez)  [Orabug: 31085989]
    {CVE-2020-10942}
    - ext4: add cond_resched() to ext4_protect_reserved_inode (Shijie Luo)  [Orabug: 31067112]
    {CVE-2020-8992}
...
var pkgs = [
    ...
    {'reference':'kernel-uek-doc-5.4.17-2011.1.2.el7uek', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-doc-5.4.17'},
    ...
    {'reference':'perf-5.4.17-2011.1.2.el7uek', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'perf-5.4.17'},
    {'reference':'python-perf-5.4.17-2011.1.2.el7uek', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'python-perf-5.4.17'},
    ...
    {'reference':'kernel-uek-doc-5.4.17-2011.1.2.el7uek', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-doc-5.4.17'},
    ...
    {'reference':'kernel-uek-tools-libs-5.4.17-2011.1.2.el7uek', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-tools-libs-5.4.17'},
    {'reference':'perf-5.4.17-2011.1.2.el7uek', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'perf-5.4.17'},
    {'reference':'python-perf-5.4.17-2011.1.2.el7uek', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'python-perf-5.4.17'},
    ...
    {'reference':'kernel-uek-doc-5.4.17-2011.1.2.el8uek', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-doc-5.4.17'},
    ...
    {'reference':'kernel-uek-doc-5.4.17-2011.1.2.el8uek', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-doc-5.4.17'}
];
