...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.0 : gnutls (EulerOS-SA-2024-2192)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2192
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?393b9d3a");
...
var pkgs = [
  "gnutls-3.7.2-2.h30.eulerosv2r11",
  "gnutls-utils-3.7.2-2.h30.eulerosv2r11"
];
