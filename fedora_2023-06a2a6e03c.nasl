...
# extracted from Fedora Security Advisory FEDORA-2023-06a2a6e03c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-06a2a6e03c");

  script_name(english:"Fedora 37 : cacti / cacti-spine (2023-06a2a6e03c)");
...
FEDORA-2023-06a2a6e03c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-06a2a6e03c");
...
var pkgs = [
    {'reference':'cacti-1.2.25-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cacti-spine-1.2.25-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
