...
# extracted from Fedora Security Advisory FEDORA-2021-1b22f31541
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-1b22f31541");

  script_name(english:"Fedora 33 : dotnet5.0 (2021-1b22f31541)");
...
FEDORA-2021-1b22f31541 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-1b22f31541");
...
pkgs = [
    {'reference':'dotnet5.0-5.0.104-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
