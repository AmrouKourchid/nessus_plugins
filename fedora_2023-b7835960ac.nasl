...
# extracted from Fedora Security Advisory FEDORA-2023-b7835960ac
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-b7835960ac");

  script_name(english:"Fedora 38 : xorg-x11-server (2023-b7835960ac)");
...
FEDORA-2023-b7835960ac advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-b7835960ac");
...
var pkgs = [
    {'reference':'xorg-x11-server-1.20.14-21.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
