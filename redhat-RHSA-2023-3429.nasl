...
# extracted from Red Hat Security Advisory RHSA-2023:3429. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:3429");

  script_name(english:"RHEL 8 : cups-filters (RHSA-2023:3429)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for cups-filters.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2023:3429 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_3429.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?576be497");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2203051");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:3429");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL cups-filters package based on the guidance in RHSA-2023:3429.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cups-filters-1.20.0-18.el8_1.1', 'sp':'1', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'cups-filters-1.20.0-18.el8_1.1', 'sp':'1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'cups-filters-libs-1.20.0-18.el8_1.1', 'sp':'1', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'cups-filters-libs-1.20.0-18.el8_1.1', 'sp':'1', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'cups-filters-libs-1.20.0-18.el8_1.1', 'sp':'1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
