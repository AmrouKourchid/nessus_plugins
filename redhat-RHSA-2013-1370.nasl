...
if (description)
{
  ...
  script_name(english:"RHEL 6 : jboss-remoting (RHSA-2013:1370)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2013/rhsa-2013_1370.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f8955e42");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2013:1370");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=994321");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL jboss-remoting package based on the guidance in RHSA-2013:1370.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-4210");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jboss-remoting-2.5.4-11.SP4_patch01.ep5.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
