...
if (description)
{
  ...
  script_cve_id("CVE-2024-24401", "CVE-2024-24402", "CVE-2024-33775");
  script_xref(name:"IAVB", value:"2024-B-0017-S");
  script_xref(name:"IAVB", value:"2024-B-0050-S");

  script_name(english:"Nagios XI < 2024R1.0.2 Multiple Vulnerabilities");
...
the following:
  ...
  - Nagios XI is vulnerable to a SQL Injection when utilizing the Favorites component. Details forthcoming. (CVE-2024-24401)

  - Nagios XI is vulnerable to a privilege escalation to root when the user has access to the nagios shell account.
    (CVE-2024-24402)

  - An issue with the Autodiscover component in Nagios XI 2024R1.0.1 allows a remote attacker to escalate privileges 
    via a crafted Dashlet.(CVE-2024-33775)
...
"Upgrade to Nagios XI 2024R1.0.2 or later.");
  script_set_attribute(attribute:"agent", value:"unix");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-24402");
...
var constraints = [
    {'fixed_version': '2024R1.0.2'}
];

vcf::nagiosxi::check_version_and_report(app_info:app_info, constraints:constraints, severity:SECURITY_HOLE, default_fix:'2024R1.0.2', flags:{sqli:TRUE});
