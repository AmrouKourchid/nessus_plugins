...
# extracted from Fedora Security Advisory FEDORA-2023-d365f19e05
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-d365f19e05");

  script_name(english:"Fedora 37 : thunderbird (2023-d365f19e05)");
...
FEDORA-2023-d365f19e05 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-d365f19e05");
...
var pkgs = [
    {'reference':'thunderbird-102.10.0-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
