...
# extracted from Ubuntu Security Notice USN-6327-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6327-1");

  script_name(english:"Ubuntu 16.04 ESM : Linux kernel (KVM) vulnerabilities (USN-6327-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6327-1");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.4.0-1123-kvm");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-6327-1');
}
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-6327-1');
  }
  else
  {
