...
"The version of Adobe Digital Editions installed on the remote macOS host is prior to 4.5.4. It is, therefore, affected
by multiple vulnerabilities as referenced in the APSB17-05 advisory.

  - Adobe Digital Editions versions 4.5.3 and earlier have an exploitable heap overflow vulnerability.
    Successful exploitation could lead to arbitrary code execution. (CVE-2017-2973)

  - Adobe Digital Editions versions 4.5.3 and earlier have an exploitable buffer over-read vulnerability.
    Successful exploitation could lead to information disclosure. (CVE-2017-2974, CVE-2017-2975,
    CVE-2017-2976, CVE-2017-2977, CVE-2017-2978, CVE-2017-2979, CVE-2017-2980, CVE-2017-2981)
...
"Upgrade to Adobe Digital Editions version 4.5.4 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-2973");
