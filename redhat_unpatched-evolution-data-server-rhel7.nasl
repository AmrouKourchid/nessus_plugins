...
# extracted from Red Hat Security Advisory evolution-data-server. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2018-12422", "CVE-2021-3349");

  script_name(english:"RHEL 7 : evolution-data-server (Unpatched Vulnerability) (deprecated)");
