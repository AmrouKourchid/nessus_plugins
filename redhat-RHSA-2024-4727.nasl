...
# extracted from Red Hat Security Advisory RHSA-2024:4727. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:4727");

  script_name(english:"RHEL 8 : Advanced Virtualization 8.2.1z (RHSA-2024:4727)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for Advanced Virtualization 8.2.1z.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:4727 advisory.
    ...
    * A flaw was found in the QEMU disk image utility (qemu-img) 'info' command. A specially crafted image
    file containing a `json:{}` value describing block devices in QMP could cause the qemu-img process on the
    host to consume large amounts of memory or CPU time, leading to denial of service or read/write to an
    existing external file. (CVE-2024-4467)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_4727.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?46e2d6b2");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/vulnerabilities/mds");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:4727");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Advanced Virtualization 8.2.1z package based on the guidance in RHSA-2024:4727.");
  ...
  'virt:8.2': [
    {
      ...
      'pkgs': [
        ...
        {'reference':'qemu-guest-agent-4.2.0-29.module+el8.2.1+22029+a0dee618.13', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-img-4.2.0-29.module+el8.2.1+22029+a0dee618.13', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-4.2.0-29.module+el8.2.1+22029+a0dee618.13', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-block-curl-4.2.0-29.module+el8.2.1+22029+a0dee618.13', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-block-gluster-4.2.0-29.module+el8.2.1+22029+a0dee618.13', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-block-iscsi-4.2.0-29.module+el8.2.1+22029+a0dee618.13', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-block-rbd-4.2.0-29.module+el8.2.1+22029+a0dee618.13', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-block-ssh-4.2.0-29.module+el8.2.1+22029+a0dee618.13', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-common-4.2.0-29.module+el8.2.1+22029+a0dee618.13', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-core-4.2.0-29.module+el8.2.1+22029+a0dee618.13', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
...
if (isnull(module_ver)) audit(AUDIT_PACKAGE_NOT_INSTALLED, 'Module virt:8.2');
if ('8.2' >!< module_ver) audit(AUDIT_PACKAGE_NOT_AFFECTED, 'Module virt:' + module_ver);
...
if (!appstreams_found) audit(AUDIT_PACKAGE_NOT_INSTALLED, 'Module virt:8.2');
