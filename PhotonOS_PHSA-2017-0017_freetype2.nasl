...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Freetype2 PHSA-2017-0017");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the freetype2 package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-42.md");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'freetype2-2.7.1-3.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'freetype2-debuginfo-2.7.1-3.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'freetype2-devel-2.7.1-3.ph1')) flag++;
