...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_1503.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5bf576c7");
...
"Update the RHEL rh-git218-git package based on the guidance in RHSA-2020:1503.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-git218-git-2.18.2-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git218-git-all-2.18.2-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git218-git-core-2.18.2-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'rh-git218-git-daemon-2.18.2-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'rh-git218-git-instaweb-2.18.2-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git218-git-p4-2.18.2-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git218-git-subtree-2.18.2-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git218-git-svn-2.18.2-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
