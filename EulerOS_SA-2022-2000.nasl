...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : libsndfile (EulerOS-SA-2022-2000)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2000
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5d4fdadc");
...
var pkgs = [
  "libsndfile-utils-help-1.0.28-18.h1.r3.eulerosv2r9"
];
