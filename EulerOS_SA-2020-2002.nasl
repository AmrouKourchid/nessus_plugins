...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.6.0 : dnsmasq (EulerOS-SA-2020-2002)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2002
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b424ebcb");
...
pkgs = ["dnsmasq-2.79-7.h2.eulerosv2r8",
        "dnsmasq-utils-2.79-7.h2.eulerosv2r8"];
