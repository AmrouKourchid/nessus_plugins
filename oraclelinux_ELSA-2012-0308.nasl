...
# extracted from Red Hat Security Advisory RHSA-2012:0308 and 
# Oracle Linux Security Advisory ELSA-2012-0308 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : busybox (ELSA-2012-0308)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2012-0308.html");
