...
# extracted from openSUSE Security Update openSUSE-2020-1584.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : go1.14 (openSUSE-2020-1584)");
...
"This update for go1.14 fixes the following issues :
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1176031");
...
if ( rpm_check(release:"SUSE15.1", reference:"go1.14-1.14.9-lp151.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"go1.14-race-1.14.9-lp151.16.1") ) flag++;
