...
# extracted from Red Hat Security Advisory RHSA-2019:2745. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:2745");
  script_xref(name:"CEA-ID", value:"CEA-2019-0643");

  script_name(english:"RHEL 6 / 7 : rh-nginx110-nginx (RHSA-2019:2745)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for rh-nginx110-nginx.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 6 / 7 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2019:2745 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_2745.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f0213e1c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:2745");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rh-nginx110-nginx package based on the guidance in RHSA-2019:2745.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-nginx110-nginx-1.10.2-9.el6.1', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'rh-nginx110-nginx-mod-http-image-filter-1.10.2-9.el6.1', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'rh-nginx110-nginx-mod-http-perl-1.10.2-9.el6.1', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'rh-nginx110-nginx-mod-http-xslt-filter-1.10.2-9.el6.1', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'rh-nginx110-nginx-mod-mail-1.10.2-9.el6.1', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'rh-nginx110-nginx-mod-stream-1.10.2-9.el6.1', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'rh-nginx110-nginx-1.10.2-9.el7.1', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'rh-nginx110-nginx-mod-http-image-filter-1.10.2-9.el7.1', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'rh-nginx110-nginx-mod-http-perl-1.10.2-9.el7.1', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'rh-nginx110-nginx-mod-http-xslt-filter-1.10.2-9.el7.1', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'rh-nginx110-nginx-mod-mail-1.10.2-9.el7.1', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'rh-nginx110-nginx-mod-stream-1.10.2-9.el7.1', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
