...
# extracted from openSUSE Security Update openSUSE-2018-777.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : openssl-1_1 (openSUSE-2018-777)");
...
if ( rpm_check(release:"SUSE15.0", reference:"libopenssl-1_1-devel-1.1.0h-lp150.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libopenssl1_1-1.1.0h-lp150.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libopenssl1_1-debuginfo-1.1.0h-lp150.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libopenssl1_1-hmac-1.1.0h-lp150.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"openssl-1_1-1.1.0h-lp150.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"openssl-1_1-debuginfo-1.1.0h-lp150.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"openssl-1_1-debugsource-1.1.0h-lp150.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libopenssl-1_1-devel-32bit-1.1.0h-lp150.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libopenssl1_1-32bit-1.1.0h-lp150.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libopenssl1_1-32bit-debuginfo-1.1.0h-lp150.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libopenssl1_1-hmac-32bit-1.1.0h-lp150.3.3.1") ) flag++;
