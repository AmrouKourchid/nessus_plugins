...
# extracted from Fedora Security Advisory FEDORA-2023-2eb445d52b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-2eb445d52b");

  script_name(english:"Fedora 39 : xorg-x11-server-Xwayland (2023-2eb445d52b)");
...
FEDORA-2023-2eb445d52b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-2eb445d52b");
...
var pkgs = [
    {'reference':'xorg-x11-server-Xwayland-23.2.2-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
