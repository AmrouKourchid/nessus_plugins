...
# extracted from Fedora Security Advisory FEDORA-2024-f474f99541
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-f474f99541");

  script_name(english:"Fedora 41 : libdigidocpp (2024-f474f99541)");
...
FEDORA-2024-f474f99541 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-f474f99541");
...
var pkgs = [
    {'reference':'libdigidocpp-4.0.0-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
