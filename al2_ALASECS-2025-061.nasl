...
# extracted from Amazon Linux 2 Security Advisory ALASECS-2025-061.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : docker (ALASECS-2025-061)");
...
as referenced in the ALAS2ECS-2025-061 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALASECS-2025-061.html");
