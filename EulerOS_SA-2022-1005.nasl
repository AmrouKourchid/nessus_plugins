...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : git (EulerOS-SA-2022-1005)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1005
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5d4b46c4");
...
var pkgs = [
  "git-2.23.0-12.h6.eulerosv2r9",
  "git-help-2.23.0-12.h6.eulerosv2r9",
  "perl-Git-2.23.0-12.h6.eulerosv2r9"
];
