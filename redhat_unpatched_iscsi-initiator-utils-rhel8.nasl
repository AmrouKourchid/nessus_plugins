...
# extracted from Red Hat Security Advisory iscsi-initiator-utils. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2017-17840", "CVE-2020-13987");
  script_xref(name:"CEA-ID", value:"CEA-2020-0139");

  script_name(english:"RHEL 8 : iscsi-initiator-utils (Unpatched Vulnerability) (deprecated)");
