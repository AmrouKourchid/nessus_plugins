...
# extracted from Red Hat Security Advisory RHSA-2024:10787. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 9 : postgresql:15 (RHSA-2024:10787)");
...
referenced in the RHSA-2024:10787 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_10787.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7f1cd6c1");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:10787");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL postgresql:15 package based on the guidance in RHSA-2024:10787.");
  ...
  'postgresql:15': [
    {
      ...
      'pkgs': [
        ...
        {'reference':'postgresql-15.10-1.module+el9.5.0+22558+abb1a50b', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-contrib-15.10-1.module+el9.5.0+22558+abb1a50b', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-docs-15.10-1.module+el9.5.0+22558+abb1a50b', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plperl-15.10-1.module+el9.5.0+22558+abb1a50b', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plpython3-15.10-1.module+el9.5.0+22558+abb1a50b', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-pltcl-15.10-1.module+el9.5.0+22558+abb1a50b', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-private-devel-15.10-1.module+el9.5.0+22558+abb1a50b', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-private-libs-15.10-1.module+el9.5.0+22558+abb1a50b', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-15.10-1.module+el9.5.0+22558+abb1a50b', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-devel-15.10-1.module+el9.5.0+22558+abb1a50b', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-static-15.10-1.module+el9.5.0+22558+abb1a50b', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-15.10-1.module+el9.5.0+22558+abb1a50b', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-rpm-macros-15.10-1.module+el9.5.0+22558+abb1a50b', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-upgrade-15.10-1.module+el9.5.0+22558+abb1a50b', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-upgrade-devel-15.10-1.module+el9.5.0+22558+abb1a50b', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
