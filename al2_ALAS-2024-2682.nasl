...
# extracted from Amazon Linux 2 Security Advisory ALAS-2024-2682.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : microcode_ctl (ALAS-2024-2682)");
...
vulnerabilities as referenced in the ALAS2-2024-2682 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2024-2682.html");
...
var pkgs = [
    {'reference':'microcode_ctl-2.1-47.amzn2.4.22', 'cpu':'i686', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'microcode_ctl-2.1-47.amzn2.4.22', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'microcode_ctl-debuginfo-2.1-47.amzn2.4.22', 'cpu':'i686', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'microcode_ctl-debuginfo-2.1-47.amzn2.4.22', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
