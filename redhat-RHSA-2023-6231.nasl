...
# extracted from Red Hat Security Advisory RHSA-2023:6231. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2023-1633");
  script_xref(name:"RHSA", value:"2023:6231");

  script_name(english:"RHEL 8 : Red Hat OpenStack Platform 16.2 (openstack-barbican) (RHSA-2023:6231)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for Red Hat OpenStack Platform 16.2 (openstack-barbican).");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2181761");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6231.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a896f397");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6231");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat OpenStack Platform 16.2 (openstack-barbican) package based on the guidance in RHSA-2023:6231.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:S/C:C/I:N/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:L/UI:N/S:U/C:H/I:N/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-1633");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openstack-barbican-9.0.2-2.20230515185056.1cd585c.el8ost', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'openstack-barbican');
}
