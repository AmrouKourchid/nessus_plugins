...
# extracted from Fedora Security Advisory FEDORA-2024-04b568cd49
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-04b568cd49");

  script_name(english:"Fedora 38 : dotnet7.0 (2024-04b568cd49)");
...
FEDORA-2024-04b568cd49 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-04b568cd49");
...
var pkgs = [
    {'reference':'dotnet7.0-7.0.116-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
