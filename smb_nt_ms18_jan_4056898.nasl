...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"4056898");
  script_xref(name:"IAVA", value:"2018-A-0019");
  script_xref(name:"IAVA", value:"2018-A-0020");
  script_xref(name:"MSKB", value:"4056895");
  script_xref(name:"MSFT", value:"MS18-4056898");
  script_xref(name:"MSFT", value:"MS18-4056895");

  script_name(english:"KB4056898: Windows 8.1 and Windows Server 2012 R2 January 2018 Security Update (Meltdown)(Spectre)");
...
or cumulative update 4056895. It is, therefore, affected by
multiple vulnerabilities :
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?86127709");
  # https://support.microsoft.com/en-us/help/4056895/windows-81-update-kb4056895
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2641284e");
...
"Apply Security Only update KB4056898 or Cumulative Update KB4056895
...
if (
  smb_check_rollup(os:"6.3",
                   ...
                   rollup_date:"01_2018",
                   bulletin:bulletin,
                   rollup_kb_list:[4056898, 4056895])
)
{
