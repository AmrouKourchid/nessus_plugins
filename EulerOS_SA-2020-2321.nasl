...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : qt (EulerOS-SA-2020-2321)");
...
vulnerability :
  ...
  - Uncontrolled search path in the QT Library before
    5.14.0, 5.12.7 and 5.9.10 may allow an authenticated
    user to potentially enable elevation of privilege via
    local access.(CVE-2020-0570)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2321
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bd91c65b");
...
pkgs = ["qt-4.8.7-42.h10.eulerosv2r8",
        "qt-common-4.8.7-42.h10.eulerosv2r8",
        "qt-devel-4.8.7-42.h10.eulerosv2r8",
        "qt-mysql-4.8.7-42.h10.eulerosv2r8",
        "qt-odbc-4.8.7-42.h10.eulerosv2r8",
        "qt-x11-4.8.7-42.h10.eulerosv2r8"];
