...
if (description)
{
  ...
  script_name(english:"PHP 5.5.x < 5.5.19 'donote' DoS");
...
remote host is prior to 5.5.19. It is, therefore, affected by an
...
instead relied only on the application's self-reported version number.");
  script_set_attribute(attribute:"see_also", value:"http://php.net/ChangeLog-5.php#5.5.19");
...
"Upgrade to PHP version 5.5.19 or later.");
