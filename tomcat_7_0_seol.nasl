...
if (description)
{
  ...
  script_name(english:"Apache Tomcat SEoL (7.0.x)");
...
contain security vulnerabilities.");
  script_set_attribute(attribute:"see_also", value:"https://tomcat.apache.org/tomcat-70-eol.html");
...
var constraints = [
  { max_branch : '7.0', min_branch : '7.0', seol : 20210331 }
];
