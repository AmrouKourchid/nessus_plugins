...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : sssd (EulerOS-SA-2019-2190)");
...
vulnerability :
  ...
  - A flaw was found in sssd Group Policy Objects
    implementation. When the GPO is not readable by SSSD
    due to a too strict permission settings on the server
    side, SSSD will allow all authenticated users to login
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2190
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4ace230e");
...
pkgs = ["libipa_hbac-1.16.0-19.5.h7.eulerosv2r7",
        "libsss_autofs-1.16.0-19.5.h7.eulerosv2r7",
        "libsss_certmap-1.16.0-19.5.h7.eulerosv2r7",
        "libsss_idmap-1.16.0-19.5.h7.eulerosv2r7",
        "libsss_nss_idmap-1.16.0-19.5.h7.eulerosv2r7",
        "libsss_simpleifp-1.16.0-19.5.h7.eulerosv2r7",
        "libsss_sudo-1.16.0-19.5.h7.eulerosv2r7",
        "python-libipa_hbac-1.16.0-19.5.h7.eulerosv2r7",
        "python-libsss_nss_idmap-1.16.0-19.5.h7.eulerosv2r7",
        "python-sss-1.16.0-19.5.h7.eulerosv2r7",
        "python-sss-murmur-1.16.0-19.5.h7.eulerosv2r7",
        "python-sssdconfig-1.16.0-19.5.h7.eulerosv2r7",
        "sssd-1.16.0-19.5.h7.eulerosv2r7",
        "sssd-ad-1.16.0-19.5.h7.eulerosv2r7",
        "sssd-client-1.16.0-19.5.h7.eulerosv2r7",
        "sssd-common-1.16.0-19.5.h7.eulerosv2r7",
        "sssd-common-pac-1.16.0-19.5.h7.eulerosv2r7",
        "sssd-dbus-1.16.0-19.5.h7.eulerosv2r7",
        "sssd-ipa-1.16.0-19.5.h7.eulerosv2r7",
        "sssd-krb5-1.16.0-19.5.h7.eulerosv2r7",
        "sssd-krb5-common-1.16.0-19.5.h7.eulerosv2r7",
        "sssd-ldap-1.16.0-19.5.h7.eulerosv2r7",
        "sssd-libwbclient-1.16.0-19.5.h7.eulerosv2r7",
        "sssd-proxy-1.16.0-19.5.h7.eulerosv2r7",
        "sssd-tools-1.16.0-19.5.h7.eulerosv2r7"];
