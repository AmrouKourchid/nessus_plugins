...
# extracted from Fedora Security Advisory FEDORA-2023-064525b17b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-064525b17b");

  script_name(english:"Fedora 36 : python-cairosvg (2023-064525b17b)");
...
FEDORA-2023-064525b17b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-064525b17b");
...
var pkgs = [
    {'reference':'python-cairosvg-2.7.0-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
