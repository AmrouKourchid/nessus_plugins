...
# extracted from Fedora Security Advisory FEDORA-2022-674e299893
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-674e299893");

  script_name(english:"Fedora 38 : firejail (2022-674e299893)");
...
FEDORA-2022-674e299893 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-674e299893");
...
var pkgs = [
    {'reference':'firejail-0.9.70-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
