...
# extracted from Fedora Security Advisory FEDORA-2019-c692dd910d.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : guacamole-server (2019-c692dd910d)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-c692dd910d");
...
"Update the affected guacamole-server package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-1340");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"guacamole-server-1.0.0-1.fc29")) flag++;
