...
# Oracle Linux Security Advisory ELSA-2013-0189 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : ipa-client (ELSA-2013-0189)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2013-0189.html");
  script_set_attribute(attribute:"solution", value:
"Update the affected ipa-client package.");
