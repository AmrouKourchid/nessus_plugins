...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'ruby-2.5.3-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'ruby-apparmor-2.13-4.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'ruby-debuginfo-2.5.3-1.ph2')) flag++;
