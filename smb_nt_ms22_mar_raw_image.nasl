...
if (description)
{
  ...
  script_cve_id("CVE-2022-23295", "CVE-2022-23300");

  script_name(english:"Microsoft Windows Raw Image Extensions Library Multiple Vulnerabilities (March 2022)");
...
vulnerabilities:
  ...
  - A remote code execution vulnerability exists in the Microsoft Windows Codecs Library Raw Image. An
    ...
    vulnerability requires that a program process a specially crafted file. (CVE-2022-23295, CVE-2022-23300)");
  script_set_attribute(attribute:"see_also", value:"https://msrc.microsoft.com/update-guide/vulnerability/CVE-2022-23295");
  script_set_attribute(attribute:"see_also", value:"https://msrc.microsoft.com/update-guide/vulnerability/CVE-2022-23300");
  script_set_attribute(attribute:"solution", value:
"Upgrade to app version 2.0.30191.0 or later for Windows 10, or app version 2.1.30191.0 or later for Windows 11.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:N/UI:R/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-23300");
...
if (hotfix_check_sp_range(win10:'0') > 0)
  constraints = [{ 'fixed_version' : '2.0.30191.0'}];
else 
  constraints = [{ 'fixed_version' : '2.1.30191.0'}];
