...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : edk2 (EulerOS-SA-2022-1390)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1390
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1b39ea61");
...
var pkgs = [
  "edk2-aarch64-202011-2.10.0.3.12"
];
