...
# extracted from openSUSE Security Update openSUSE-2019-1433.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libxslt (openSUSE-2019-1433)");
...
if ( rpm_check(release:"SUSE15.1", reference:"libxslt-debugsource-1.1.32-lp151.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libxslt-devel-1.1.32-lp151.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libxslt-tools-1.1.32-lp151.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libxslt-tools-debuginfo-1.1.32-lp151.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libxslt1-1.1.32-lp151.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libxslt1-debuginfo-1.1.32-lp151.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libxslt-devel-32bit-1.1.32-lp151.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libxslt-python-1.1.32-lp151.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libxslt-python-debuginfo-1.1.32-lp151.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libxslt-python-debugsource-1.1.32-lp151.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libxslt1-32bit-1.1.32-lp151.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libxslt1-32bit-debuginfo-1.1.32-lp151.3.3.1") ) flag++;
