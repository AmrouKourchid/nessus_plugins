...
if (description)
{
  ...
  script_name(english:"Wireshark 2.4.x < 2.4.14 Multiple Vulnerabilities (macOS)");

  script_set_attribute(attribute:"synopsis", value:
"An application installed on the remote macOS / Mac OS X host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Wireshark installed on the remote macOS / Mac OS X host is 2.4.x prior to 2.4.14. It is, therefore,
affected by multiple vulnerabilities as referenced in the wireshark-2.4.14 advisory:
...
constraints = [
  { 'min_version' : '2.4.0', 'fixed_version' : '2.4.14' }
];
