...
# extracted from Ubuntu Security Notice USN-5051-3. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5051-3");
  script_xref(name:"IAVA", value:"2021-A-0395-S");

  script_name(english:"Ubuntu 18.04 LTS : OpenSSL vulnerability (USN-5051-3)");
...
USN-5051-3 advisory.
    ...
    USN-5051-1 fixed a vulnerability in OpenSSL. This update provides the corresponding update for the
    openssl1.0 package in Ubuntu 18.04 LTS.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5051-3");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'libssl1.0-dev', 'pkgver': '1.0.2n-1ubuntu5.7'},
    {'osver': '18.04', 'pkgname': 'libssl1.0.0', 'pkgver': '1.0.2n-1ubuntu5.7'},
    {'osver': '18.04', 'pkgname': 'openssl1.0', 'pkgver': '1.0.2n-1ubuntu5.7'}
];
