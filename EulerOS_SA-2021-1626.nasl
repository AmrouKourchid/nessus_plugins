...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.1 : sqlite (EulerOS-SA-2021-1626)");
...
the following vulnerabilities :
  ...
  - SQLite 3.32.2 has a use-after-free in resetAccumulator
    in select.c because the parse tree rewrite for window
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1626
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?21e528af");
...
pkgs = ["sqlite-3.31.1-1.h3.eulerosv2r9"];
