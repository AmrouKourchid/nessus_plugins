...
17.0.0. It is, therefore, affected by a vulnerability as referenced in the K24358905 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K24358905");
...
var vmatrix = {
  'AFM': {
    'affected': [
      '16.1.0-16.1.1','15.1.2.1-15.1.4','14.1.4','13.1.3.4-13.1.4'
    ],
    'unaffected': [
