...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.3 : gnupg2 (EulerOS-SA-2019-1157)");
...
following vulnerability :
  ...
  - A data validation flaw was found in the way gnupg
    ...
    based on parsed verbose gnupg
    output.i1/4^CVE-2018-12020i1/4%0

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1157
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ccd8aa81");
