...
if (description)
{
  ...
  script_xref(name:"APPLE-SA", value:"HT214105");
  script_xref(name:"IAVA", value:"2024-A-0275-S");

  script_name(english:"macOS 12.x < 12.7.5 Multiple Vulnerabilities (HT214105)");
...
version number.");
  script_set_attribute(attribute:"see_also", value:"https://support.apple.com/en-us/HT214105");
