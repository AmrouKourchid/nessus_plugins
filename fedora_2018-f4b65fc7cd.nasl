...
# extracted from Fedora Security Advisory FEDORA-2018-f4b65fc7cd.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-f4b65fc7cd");

  script_name(english:"Fedora 29 : mediawiki (2018-f4b65fc7cd)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-f4b65fc7cd");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"mediawiki-1.29.3-1.fc29")) flag++;
