...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5042880");
  script_xref(name:"MSKB", value:"5042881");
  script_xref(name:"MSFT", value:"MS24-5042880");
  script_xref(name:"MSFT", value:"MS24-5042881");
  ...
  script_name(english:"KB5042881: Windows Server 2022 / Azure Stack HCI 22H2 Security Update (September 2024)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5042881");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5042880");
...
if (
  smb_check_rollup(os:'10',
                   ...
                   rollup_date:'09_2024',
                   bulletin:bulletin,
                   rollup_kb_list:[5042880,5042881])
)
{
