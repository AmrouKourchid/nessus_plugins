...
# openSUSE Security Update openSUSE-SU-2024:0275-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : opera (openSUSE-SU-2024:0275-1)");
...
SU-2024:0275-1 advisory.
    ...
    - Changes in 113.0.5230.31
      ...
      * DNA-117857 [Sync][Lost password] After profile error cant add
        passwords and sync cant display synced passwords
...
number.");
  # https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/TJMLQH7THP267EBNFZ3ECENLIIFCBW5H/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8062b067");
...
"Update the affected opera package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-7971");
...
var pkgs = [
    {'reference':'opera-113.0.5230.32-lp156.2.17.1', 'cpu':'x86_64', 'release':'SUSE15.6', 'rpm_spec_vers_cmp':TRUE}
];
