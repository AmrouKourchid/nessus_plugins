...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : ghostscript (EulerOS-SA-2021-2372)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2372
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ecb66d51");
...
"Update the affected ghostscript packages.");
  ...
  script_set_attribute(attribute:"metasploit_name", value:'ImageMagick Delegate Arbitrary Command Execution');
...
pkgs = ["ghostscript-9.07-31.6.h22",
        "ghostscript-cups-9.07-31.6.h22"];
