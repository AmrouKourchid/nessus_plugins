...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP12 : libsoup (EulerOS-SA-2025-1193)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1193
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b4ae11ee");
...
var pkgs = [
  "libsoup-2.74.2-2.h3.eulerosv2r12",
  "libsoup-help-2.74.2-2.h3.eulerosv2r12"
];
