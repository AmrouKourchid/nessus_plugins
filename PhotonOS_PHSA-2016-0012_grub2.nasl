...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'grub2-2.02-5.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'grub2-efi-2.02-3.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'grub2-efi-lang-2.02-3.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'grub2-lang-2.02-5.ph1')) flag++;
