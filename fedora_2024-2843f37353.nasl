...
# extracted from Fedora Security Advisory FEDORA-2024-2843f37353
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-2843f37353");

  script_name(english:"Fedora 40 : perl-Clipboard (2024-2843f37353)");
...
FEDORA-2024-2843f37353 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-2843f37353");
...
var pkgs = [
    {'reference':'perl-Clipboard-0.29-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
