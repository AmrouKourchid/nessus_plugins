...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 18.04 LTS : libssh regression (USN-3795-3)");
...
referenced in the USN-3795-3 advisory.

    USN-3795-1 and USN-3795-2 fixed a vulnerability in libssh. The upstream fix introduced a regression. This
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3795-3");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'libssh-4', 'pkgver': '0.6.1-0ubuntu3.5'},
    {'osver': '14.04', 'pkgname': 'libssh-dev', 'pkgver': '0.6.1-0ubuntu3.5'},
    {'osver': '16.04', 'pkgname': 'libssh-4', 'pkgver': '0.6.3-4.3ubuntu0.2'},
    {'osver': '16.04', 'pkgname': 'libssh-dev', 'pkgver': '0.6.3-4.3ubuntu0.2'},
    {'osver': '16.04', 'pkgname': 'libssh-gcrypt-4', 'pkgver': '0.6.3-4.3ubuntu0.2'},
    {'osver': '16.04', 'pkgname': 'libssh-gcrypt-dev', 'pkgver': '0.6.3-4.3ubuntu0.2'},
    {'osver': '18.04', 'pkgname': 'libssh-4', 'pkgver': '0.8.0~20170825.94fa1e38-1ubuntu0.2'},
    {'osver': '18.04', 'pkgname': 'libssh-dev', 'pkgver': '0.8.0~20170825.94fa1e38-1ubuntu0.2'},
    {'osver': '18.04', 'pkgname': 'libssh-gcrypt-4', 'pkgver': '0.8.0~20170825.94fa1e38-1ubuntu0.2'},
    {'osver': '18.04', 'pkgname': 'libssh-gcrypt-dev', 'pkgver': '0.8.0~20170825.94fa1e38-1ubuntu0.2'}
];
