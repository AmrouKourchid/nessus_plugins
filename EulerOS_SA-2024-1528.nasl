...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.0 : libssh (EulerOS-SA-2024-1528)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1528
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c2bbe716");
...
var pkgs = [
  "libssh-0.9.4-3.h14.eulerosv2r10"
];
