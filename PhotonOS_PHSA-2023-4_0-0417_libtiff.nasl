...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Libtiff PHSA-2023-4.0-0417");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libtiff-4.5.1-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libtiff-devel-4.5.1-1.ph4')) flag++;
