...
# extracted from Red Hat Security Advisory RHSA-2023:3198. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:3198");

  script_name(english:"RHEL 8 : jenkins and jenkins-2-plugins (RHSA-2023:3198)");
...
referenced in the RHSA-2023:3198 advisory.
...
number.");
  ...
  # https://docs.openshift.com/container-platform/4.11/cicd/jenkins/important-changes-to-openshift-jenkins-images.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?80380ceb");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_3198.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?93c1c232");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:3198");
...
"Update the RHEL jenkins / jenkins-2-plugins packages based on the guidance in RHSA-2023:3198.");
  ...
  script_cwe_id(20, 77, 79, 200, 266, 352, 400, 502, 693, 838, 862, 1188);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jenkins-2-plugins-4.11.1683009941-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2021-26291', 'CVE-2022-1471', 'CVE-2022-25857', 'CVE-2022-29599', 'CVE-2022-30953', 'CVE-2022-30954', 'CVE-2022-42889', 'CVE-2022-43401', 'CVE-2022-43402', 'CVE-2022-43403', 'CVE-2022-43404', 'CVE-2022-43405', 'CVE-2022-43406', 'CVE-2022-43407', 'CVE-2022-43408', 'CVE-2022-43409', 'CVE-2022-45047', 'CVE-2023-24422', 'CVE-2023-25761', 'CVE-2023-25762']},
      {'reference':'jenkins-2.387.1.1683009763-3.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2023-27903', 'CVE-2023-27904']}
    ]
  }
];
