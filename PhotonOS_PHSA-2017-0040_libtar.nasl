...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'libtar-1.2.20-3.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'libtar-devel-1.2.20-3.ph1')) flag++;
