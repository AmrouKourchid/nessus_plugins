...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : spice (EulerOS-SA-2021-1518)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1518
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dc20b81c");
...
pkgs = ["spice-server-0.14.0-6.1.h1.eulerosv2r7"];
