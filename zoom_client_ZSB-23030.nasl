...
if (description)
{
  ...
  script_cve_id("CVE-2023-36534");

  script_name(english:"Zoom Client for Meetings < 5.14.7 Vulnerability (ZSB-23030)");
...
vulnerability as referenced in the ZSB-23030 advisory.

  - Path traversal in Zoom Desktop Client for Windows before 5.14.7 may allow an unauthenticated user to
    enable an escalation of privilege via network access. (CVE-2023-36534)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://explore.zoom.us/en/trust/security/security-bulletin/?filter-cve=&filter=&keywords=ZSB-23030
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e3c390e9");
...
"Upgrade to Zoom Client for Meetings 5.14.7 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-36534");
