...
# extracted from Fedora Security Advisory FEDORA-2022-e139408490
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-e139408490");

  script_name(english:"Fedora 37 : mod_auth_openidc (2022-e139408490)");
...
FEDORA-2022-e139408490 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-e139408490");
...
var pkgs = [
    {'reference':'mod_auth_openidc-2.4.12.2-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
