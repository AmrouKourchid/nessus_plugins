...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Bindutils PHSA-2020-1.0-0287");
...
if (rpm_check(release:"PhotonOS-1.0", cpu:"x86_64", reference:"bindutils-9.15.6-1.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", cpu:"x86_64", reference:"bindutils-debuginfo-9.15.6-1.ph1")) flag++;
