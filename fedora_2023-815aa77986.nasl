...
# extracted from Fedora Security Advisory FEDORA-2023-815aa77986
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-815aa77986");

  script_name(english:"Fedora 38 : stb (2023-815aa77986)");
...
FEDORA-2023-815aa77986 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-815aa77986");
...
var pkgs = [
    {'reference':'stb-0^20230129git5736b15-0.2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
