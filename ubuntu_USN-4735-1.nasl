...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS : PostgreSQL vulnerability (USN-4735-1)");
...
USN-4735-1 advisory.
    ...
    Heikki Linnakangas discovered that PostgreSQL incorrectly leaked values of denied columns when handling
    certain errors. A remote attacker could possibly use this issue to obtain sensitive information.
