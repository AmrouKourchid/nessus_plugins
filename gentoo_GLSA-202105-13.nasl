...
# extracted from Gentoo Linux Security Advisory GLSA 202105-13.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202105-13");

  script_name(english:"GLSA-202105-13 : Mumble: User-assisted execution of arbitrary code");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202105-13
...
Impact :
    ...
    A remote attacker could entice a user to open a specially crafted server
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202105-13"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"media-sound/mumble", unaffected:make_list("ge 1.3.4"), vulnerable:make_list("lt 1.3.4"))) flag++;
