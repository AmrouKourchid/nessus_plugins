...
# extracted from Fedora Security Advisory FEDORA-2022-e0e9a43546
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-e0e9a43546");

  script_name(english:"Fedora 37 : galera / mariadb (2022-e0e9a43546)");
...
FEDORA-2022-e0e9a43546 advisory.

    **MariaDB 10.5.18 & Galera 26.4.13**

    Release notes:

        https://mariadb.com/kb/en/mdb-10-5-18-rn/
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-e0e9a43546");
...
var pkgs = [
    {'reference':'galera-26.4.13-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'mariadb-10.5.18-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'}
];
