...
# extracted from Red Hat Security Advisory RHSA-2019:3928. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:3928");

  script_name(english:"RHEL 7 / 8 : ansible (RHSA-2019:3928)");
...
in the RHSA-2019:3928 advisory.
    ...
    See:
    https://github.com/ansible/ansible/blob/v2.9.1/changelogs/CHANGELOG-v2.9.rst for details on bug fixes in
    this release.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_3928.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c4b841a2");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:3928");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1764148");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL ansible package based on the guidance in RHSA-2019:3928.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ansible-2.9.1-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2'},
      {'reference':'ansible-test-2.9.1-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'ansible-2.9.1-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2'},
      {'reference':'ansible-test-2.9.1-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2'}
    ]
  }
];
