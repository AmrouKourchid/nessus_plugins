...
# extracted from Gentoo Linux Security Advisory GLSA 202011-02.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202011-02");

  script_name(english:"GLSA-202011-02 : OpenDMARC: Heap-based buffer overflow");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202011-02
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202011-02");
...
"All OpenDMARC users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:opendmarc");
...
if (qpkg_check(package:"mail-filter/opendmarc", unaffected:make_list("ge 1.3.3"), vulnerable:make_list("lt 1.3.3"))) flag++;
