...
if (description)
{
  ...
  script_name(english:"Adobe InDesign < 17.4.2 / 18.0 < 18.4.0 Multiple Vulnerabilities (APSB23-38)");

  script_set_attribute(attribute:"synopsis", value:
"The Adobe InDesign instance installed on the remote host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe InDesign installed on the remote Windows host is prior to 17.4.2, 18.4.0. It is, therefore,
affected by multiple vulnerabilities as referenced in the APSB23-38 advisory.
