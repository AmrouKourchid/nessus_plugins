...
if (description)
{
  ...
  script_name(english:"IBM WebSphere Application Server Liberty 20.0.0.12 < 24.0.0.11 DoS (7173097)");
...
referenced in the 7173097 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/node/7173097");
  script_set_attribute(attribute:"solution", value:
"Update to IBM WebSphere Application Server Liberty version 24.0.0.11 or later. Alternatively, upgrade to the minimal fix
pack levels required by the interim fix and then apply Interim Fix PH63533.");
...
if ('PH63533' >< app_info['Fixes'])
  audit(AUDIT_INST_VER_NOT_VULN, app);

var constraints = [
  { 'min_version' : '20.0.0.12', 'fixed_version' : '24.0.0.11', 'fixed_display' : '24.0.0.11 or Interim Fix PH63533' }
];
