...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_3477.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f103045d");
...
"Update the RHEL RHV-H package based on the guidance in RHSA-2021:3477.");
  ...
  script_cwe_id(77, 78, 362, 416, 787);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'redhat-virtualization-host-image-update-4.3.18-20210903.0.el7_9', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'}
    ]
  }
];
