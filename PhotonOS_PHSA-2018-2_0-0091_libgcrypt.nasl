...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Libgcrypt PHSA-2018-2.0-0091");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libgcrypt-1.8.1-2.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libgcrypt-debuginfo-1.8.1-2.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libgcrypt-devel-1.8.1-2.ph2')) flag++;
