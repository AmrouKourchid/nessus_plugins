...
if (description)
{
  ...
  script_cve_id("CVE-2022-37434", "CVE-2023-0286", "CVE-2023-0767");

  script_name(english:"Nutanix AOS : Multiple Vulnerabilities (NXSA-AOS-6.6.2.5)");

  script_set_attribute(attribute:"synopsis", value:
"The Nutanix AOS host is affected by multiple vulnerabilities .");
  script_set_attribute(attribute:"description", value:
"The version of AOS installed on the remote host is prior to 6.6.2.5. It is, therefore, affected by multiple
vulnerabilities as referenced in the NXSA-AOS-6.6.2.5 advisory.
...
number.");
  # https://portal.nutanix.com/page/documents/security-advisories/release-advisories/details?id=NXSA-AOS-6.6.2.5
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6f027028");
...
var constraints = [
  { 'fixed_version' : '6.6.2.5', 'product' : 'AOS', 'fixed_display' : 'Upgrade the AOS install to 6.6.2.5 or higher.', 'lts' : FALSE },
  { 'fixed_version' : '6.6.2.5', 'product' : 'NDFS', 'fixed_display' : 'Upgrade the AOS install to 6.6.2.5 or higher.', 'lts' : FALSE }
];
