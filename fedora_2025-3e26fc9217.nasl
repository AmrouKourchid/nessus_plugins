...
# extracted from Fedora Security Advisory FEDORA-2025-3e26fc9217
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-3e26fc9217");

  script_name(english:"Fedora 40 : chromium (2025-3e26fc9217)");
...
FEDORA-2025-3e26fc9217 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-3e26fc9217");
...
var pkgs = [
    {'reference':'chromium-135.0.7049.114-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
