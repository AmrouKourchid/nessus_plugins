...
# extracted from Gentoo Linux Security Advisory GLSA 202210-03.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202210-03 : libxml2: Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202210-03 (libxml2: Multiple Vulnerabilities)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202210-03");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=833809");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=842261");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=865727");
...
var packages = [
  {
    ...
    'unaffected' : make_list("ge 2.10.2", "lt 2.0.0"),
    'vulnerable' : make_list("lt 2.10.2")
  }
];
