...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP12 : libssh2 (EulerOS-SA-2024-1765)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the libssh2 package installed, the EulerOS installation on the remote host is affected by
...
Tenable has extracted the preceding description block directly from the EulerOS libssh2 security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1765
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?84d9f19d");
...
var pkgs = [
  "libssh2-1.10.0-3.h6.eulerosv2r12"
];
