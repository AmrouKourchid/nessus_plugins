...
# AlmaLinux Security Advisory ALSA-2025:0667.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2025:0667");
  script_xref(name:"RHSA", value:"2025:0667");

  script_name(english:"AlmaLinux 9 : python-jinja2 (ALSA-2025:0667)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2025-0667.html");
...
var pkgs = [
    {'reference':'python3-jinja2-2.11.3-7.el9_5', 'release':'9', 'el_string':'el9_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'}
];
