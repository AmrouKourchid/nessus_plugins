...
# extracted from Slackware Security Advisory SSA:2023-258-01. The text
...
if (description)
{
  ...
  script_name(english:"Slackware Linux 15.0 / current python3  Vulnerability (SSA:2023-258-01)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Slackware Linux host is missing a security update to python3.");
  script_set_attribute(attribute:"description", value:
"The version of python3 installed on the remote host is prior to 3.9.18. It is, therefore, affected by a vulnerability as
referenced in the SSA:2023-258-01 advisory.
...
number.");
  # http://www.slackware.com/security/viewer.php?l=slackware-security&y=2023&m=slackware-security.363395
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b75096b4");
...
var flag = 0;
var constraints = [
    { 'fixed_version' : '3.9.18', 'product' : 'python3', 'os_name' : 'Slackware Linux', 'os_version' : '15.0', 'service_pack' : '1_slack15.0', 'arch' : 'i586' },
    { 'fixed_version' : '3.9.18', 'product' : 'python3', 'os_name' : 'Slackware Linux', 'os_version' : '15.0', 'service_pack' : '1_slack15.0', 'arch' : 'x86_64' },
    { 'fixed_version' : '3.9.18', 'product' : 'python3', 'os_name' : 'Slackware Linux', 'os_version' : 'current', 'service_pack' : '1', 'arch' : 'i586' },
    { 'fixed_version' : '3.9.18', 'product' : 'python3', 'os_name' : 'Slackware Linux', 'os_version' : 'current', 'service_pack' : '1', 'arch' : 'x86_64' }
];
