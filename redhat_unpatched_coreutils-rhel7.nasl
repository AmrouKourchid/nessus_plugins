...
# extracted from Red Hat Security Advisory coreutils. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2014-9471", "CVE-2016-2781", "CVE-2017-18018");

  script_name(english:"RHEL 7 : coreutils (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2016-2781");
  script_set_attribute(attribute:"cvss4_score_source", value:"CVE-2017-18018");
