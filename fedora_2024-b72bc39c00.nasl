...
# extracted from Fedora Security Advisory FEDORA-2024-b72bc39c00
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-b72bc39c00");

  script_name(english:"Fedora 39 : python-pip (2024-b72bc39c00)");
...
FEDORA-2024-b72bc39c00 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-b72bc39c00");
...
var pkgs = [
    {'reference':'python-pip-23.2.1-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
