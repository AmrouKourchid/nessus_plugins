...
if (description)
{
  ...
  script_cve_id("CVE-2013-4392");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2013-4392");
...
patch available.
  ...
  - systemd, when updating file permissions, allows local users to change the permissions and SELinux security
    contexts for arbitrary files via a symlink attack on unspecified files. (CVE-2013-4392)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-4392");
