...
if (description)
{
  ...
  script_cve_id("CVE-2024-36480");
  script_xref(name:"IAVB", value:"2024-B-0081");

  script_name(english:"Streamline NX Client < 3.4.3.2 / 3.5.x < 3.5.1.202 / 3.6.x < 3.6.2.2 / 3.7.x < 3.7.2.1 Privilege Escalation (2024-000005)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of Streamline NX Client installed on the remote host is prior to 3.4.3.2, 3.5.1.202, 3.6.2.2, or 3.7.2.1. It
is, therefore, affected by a vulnerability as referenced in the 2024-000005 advisory.

  - Use of hard-coded credentials issue exists in Ricoh Streamline NX PC Client ver.3.7.2 and earlier. If this
    vulnerability is exploited, an attacker may obtain LocalSystem Account of the PC where the product is
    installed. As a result, unintended operations may be performed on the PC.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://www.ricoh.com/products/security/vulnerabilities/vul?id=ricoh-2024-000005
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?52ec9dfe");
  # https://www.ricoh.com/products/security/vulnerabilities/adv?id=ricoh-prod000077-2024-000005
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?360f166c");
...
"Upgrade to Streamline NX Client version 3.4.3.2 / 3.5.1.202 / 3.6.2.2 / 3.7.2.1 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-36480");
...
var constraints = [
  ...
  { 'min_version' : '3.7', 'fixed_version' : '3.7.2.1' }
];
