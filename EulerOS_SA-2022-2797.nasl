...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : libksba (EulerOS-SA-2022-2797)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the libksba package installed, the EulerOS installation on the remote host is affected by
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2797
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bdd54c44");
...
var pkgs = [
  "libksba-1.3.5-8.h1.eulerosv2r8"
];
