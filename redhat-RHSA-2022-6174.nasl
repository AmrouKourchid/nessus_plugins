...
# extracted from Red Hat Security Advisory RHSA-2022:6174. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:6174");
  script_xref(name:"IAVA", value:"2022-A-0339-S");

  script_name(english:"RHEL 9 : firefox (RHSA-2022:6174)");
...
referenced in the RHSA-2022:6174 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_6174.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?548aab4c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:6174");
...
"Update the RHEL firefox package based on the guidance in RHSA-2022:6174.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-91.13.0-1.el9_0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'firefox-91.13.0-1.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
