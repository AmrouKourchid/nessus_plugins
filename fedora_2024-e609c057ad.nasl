...
# extracted from Fedora Security Advisory FEDORA-2024-e609c057ad
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-e609c057ad");

  script_name(english:"Fedora 39 : mingw-python-jinja2 (2024-e609c057ad)");
...
FEDORA-2024-e609c057ad advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-e609c057ad");
...
var pkgs = [
    {'reference':'mingw-python-jinja2-3.1.4-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
