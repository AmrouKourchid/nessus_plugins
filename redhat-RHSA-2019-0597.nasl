...
# extracted from Red Hat Security Advisory RHSA-2019:0597. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : cloud-init (RHSA-2019:0597)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for cloud-init.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_0597.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4c61579f");
  # https://support.microsoft.com/en-us/help/4491476/extraneous-ssh-public-keys-added-to-authorized-keys-file-on-linux-vm
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ff38a6bb");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:0597");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1680165");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL cloud-init package based on the guidance in RHSA-2019:0597.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cloud-init-18.2-1.el7_6.2', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
