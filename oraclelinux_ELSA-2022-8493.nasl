...
# extracted from Oracle Linux Security Advisory ELSA-2022-8493.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : python3.9 (ELSA-2022-8493)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2022-8493.html");
...
var pkgs = [
    {'reference':'python-unversioned-command-3.9.14-1.el9_1.1', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
