...
"The version of Google Chrome installed on the remote macOS host is prior to 114.0.5735.133. It is, therefore, affected
...
google_chrome_check_version(fix:'114.0.5735.133', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
