...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Haproxy PHSA-2023-5.0-0009");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'haproxy-2.7.3-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'haproxy-dataplaneapi-2.7.1-4.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'haproxy-doc-2.7.3-1.ph5')) flag++;
