...
# SUSE update advisory SUSE-SU-2023:2368-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2023-0386", "CVE-2023-2162", "CVE-2023-23454");
  script_xref(name:"SuSE", value:"SUSE-SU-2023:2368-1");

  script_name(english:"SUSE SLES15 Security Update : kernel RT (Live Patch 6 for SLE 15 SP4) (SUSE-SU-2023:2368-1)");
...
the SUSE-SU-2023:2368-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://lists.suse.com/pipermail/sle-updates/2023-June/029712.html");
...
"Update the affected kernel-livepatch-5_14_21-150400_15_23-rt package.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '5.14.21-150400.15.23-rt-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_14_21-150400_15_23-rt-2-150400.2.2', 'sp':'4', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.4']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kernel-livepatch-5_14_21-150400_15_23-rt');
}
