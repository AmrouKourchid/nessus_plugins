...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Haproxy PHSA-2021-1.0-0435");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'haproxy-2.0.10-3.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'haproxy-doc-2.0.10-3.ph1')) flag++;
