...
the ELSA-2023-12017 advisory.
    ...
    - proc: proc_skip_spaces() shouldn't think it is working on C strings (Linus Torvalds)  [Orabug: 34882775]
    {CVE-2022-4378}
    - proc: avoid integer type confusion in get_proc_long (Linus Torvalds)  [Orabug: 34882775]
    {CVE-2022-4378}
...
var pkgs = [
    ...
    {'reference':'kernel-uek-doc-5.15.0-6.80.3.1.el8uek', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-doc-5.15.0'},
    ...
    {'reference':'kernel-uek-doc-5.15.0-6.80.3.1.el8uek', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-doc-5.15.0'},
    ...
    {'reference':'kernel-uek-doc-5.15.0-6.80.3.1.el9uek', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-doc-5.15.0'},
    ...
    {'reference':'kernel-uek-doc-5.15.0-6.80.3.1.el9uek', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-doc-5.15.0'},
