...
# extracted from Fedora Security Advisory FEDORA-2024-0d8d3b8dcc
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-0d8d3b8dcc");

  script_name(english:"Fedora 40 : golang-x-crypto (2024-0d8d3b8dcc)");
...
FEDORA-2024-0d8d3b8dcc advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-0d8d3b8dcc");
  script_set_attribute(attribute:"solution", value:
"Update the affected golang-x-crypto package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:golang-x-crypto");
...
var pkgs = [
    {'reference':'golang-x-crypto-0.18.0-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'golang-x-crypto');
}
