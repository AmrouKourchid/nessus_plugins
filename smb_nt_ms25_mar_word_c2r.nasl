...
if (description)
{
  ...
  script_name(english:"Security Updates for Microsoft Word Products C2R (March 2025)");
...
"The Microsoft Word Products are missing security updates. It is, therefore, affected by multiple vulnerabilities:
  ...
  - A remote code execution vulnerability. An attacker can exploit this to bypass authentication and execute
    unauthorized arbitrary commands. (CVE-2025-24078, CVE-2025-24079)
...
update.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-24077");
