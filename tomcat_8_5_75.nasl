...
if (description)
{
  ...
  script_name(english:"Apache Tomcat 8.5.55 < 8.5.75 multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Apache Tomcat server is affected by multiple vulnerabilities");
  script_set_attribute(attribute:"description", value:
"The version of Tomcat installed on the remote host is prior to 8.5.75. It is, therefore, affected by a vulnerability as
referenced in the fixed_in_apache_tomcat_8.5.75_security-8 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?95098df5");
  # https://tomcat.apache.org/security-8.html#Fixed_in_Apache_Tomcat_8.5.75
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3d595669");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Apache Tomcat version 8.5.75 or later.");
...
var constraints = [
  { 'min_version' : '8.5.55', 'max_version' : '8.5.73', 'fixed_version' : '8.5.75' }
];
