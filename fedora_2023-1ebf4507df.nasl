...
# extracted from Fedora Security Advisory FEDORA-2023-1ebf4507df
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-1ebf4507df");

  script_name(english:"Fedora 36 : xorg-x11-server-Xwayland (2023-1ebf4507df)");
...
FEDORA-2023-1ebf4507df advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-1ebf4507df");
...
var pkgs = [
    {'reference':'xorg-x11-server-Xwayland-22.1.8-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
