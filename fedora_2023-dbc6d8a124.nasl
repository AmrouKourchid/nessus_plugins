...
# extracted from Fedora Security Advisory FEDORA-2023-dbc6d8a124
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-dbc6d8a124");

  script_name(english:"Fedora 37 : libreswan (2023-dbc6d8a124)");
...
FEDORA-2023-dbc6d8a124 advisory.

    Update to 4.12 for CVE-2023-38710, CVE-2023-38711 and CVE-2023-38712
    addressing post-authentication denial of service attacks

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-dbc6d8a124");
...
var pkgs = [
    {'reference':'libreswan-4.12-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
