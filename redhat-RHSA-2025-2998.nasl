...
# extracted from Red Hat Security Advisory RHSA-2025:2998. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:2998");

  script_name(english:"RHEL 8 : webkit2gtk3 (RHSA-2025:2998)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for webkit2gtk3.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2025:2998 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_2998.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9ddd7609");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:2998");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL webkit2gtk3 package based on the guidance in RHSA-2025:2998.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'webkit2gtk3-2.46.6-2.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'webkit2gtk3-devel-2.46.6-2.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'webkit2gtk3-jsc-2.46.6-2.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'webkit2gtk3-jsc-devel-2.46.6-2.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
