...
# extracted from Fedora Security Advisory FEDORA-2023-f72d3caf36
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-f72d3caf36");

  script_name(english:"Fedora 38 : tar (2023-f72d3caf36)");
...
FEDORA-2023-f72d3caf36 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-f72d3caf36");
...
var pkgs = [
    {'reference':'tar-1.34-8.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
