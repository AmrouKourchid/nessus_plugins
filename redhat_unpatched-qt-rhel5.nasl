...
if (description)
{
  ...
  script_cve_id("CVE-2016-10040", "CVE-2020-17507");

  script_name(english:"RHEL 5 : qt (Unpatched Vulnerability) (deprecated)");
...
"This plugin has been deprecated as it does not adhere to established standards for this style of check.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2016-10040");
