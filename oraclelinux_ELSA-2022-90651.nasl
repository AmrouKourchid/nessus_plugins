...
# extracted from Oracle Linux Security Advisory ELSA-2022-90651.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : ELSA-2022-9065-1: / firefox (ELSA-2022-90651)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2022-9065-1.html");
...
var pkgs = [
    {'reference':'firefox-102.6.0-1.0.1.el9_1', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-102.6.0-1.0.1.el9_1', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
