...
if (description)
{
  ...
  script_cve_id("CVE-2024-7203");
  script_xref(name:"IAVA", value:"2024-A-0534");

  script_name(english:"Zyxel USG 4.60 < 5.39 / ATP 4.60 < 5.39 Command Injection");

  script_set_attribute(attribute:"synopsis", value:
"The remote security gateway is affected by a command injection vulnerability.");
  script_set_attribute(attribute:"description", value:
"The Firmware version of the Zyxel USG / ATP device is affected by a command injection vulnerability.
A post-authentication command injection vulnerability in some firewall versions could allow an authenticated 
attacker with administrator privileges to execute some operating system (OS) commands on an affected device 
by executing a crafted CLI command.
...
"Upgrade to Zyxel USG / ATP to version 5.39 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:M/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:H/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-7203");
...
if ('ATP' >< model || ((model != "USG FLEX [25]0W?[^0]") && ('USG FLEX' >< model) ))
  constraints = [{'min_version':'4.60', 'fixed_version' : '5.39'}];
else
