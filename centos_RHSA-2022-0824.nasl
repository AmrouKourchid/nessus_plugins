...
if (description)
{
  ...
  script_name(english:"CentOS 7 : firefox (RHSA-2022:0824)");
...
var pkgs = [
    {'reference':'firefox-91.7.0-3.el7.centos', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
