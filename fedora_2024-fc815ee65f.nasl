...
# extracted from Fedora Security Advisory FEDORA-2024-fc815ee65f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-fc815ee65f");
  script_xref(name:"IAVA", value:"2024-A-0386-S");

  script_name(english:"Fedora 39 : firefox (2024-fc815ee65f)");
...
FEDORA-2024-fc815ee65f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-fc815ee65f");
...
var pkgs = [
    {'reference':'firefox-128.0-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
