...
# extracted from Fedora Security Advisory FEDORA-2018-3ac43a1e15.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : feh (2018-3ac43a1e15)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-3ac43a1e15");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"feh-2.28-1.fc28")) flag++;
