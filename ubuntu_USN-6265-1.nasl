...
# extracted from Ubuntu Security Notice USN-6265-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6265-1");

  script_name(english:"Ubuntu 16.04 ESM : RabbitMQ vulnerability (USN-6265-1)");
...
USN-6265-1 advisory.
    ...
    It was discovered that RabbitMQ incorrectly handled certain signed-in user credentials. An attacker could
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6265-1");
...
"Update the affected rabbitmq-server package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-4966");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'rabbitmq-server', 'pkgver': '3.5.7-1ubuntu0.16.04.4+esm2', 'ubuntu_pro': TRUE}
];
