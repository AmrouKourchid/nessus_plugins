...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : dnsmasq (EulerOS-SA-2020-1776)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1776
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?644a2316");
...
pkgs = ["dnsmasq-2.76-5.h5.eulerosv2r7",
        "dnsmasq-utils-2.76-5.h5.eulerosv2r7"];
