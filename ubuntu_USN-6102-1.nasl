...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS / 22.04 LTS : xmldom vulnerabilities (USN-6102-1)");
...
referenced in the USN-6102-1 advisory.

    It was discovered that xmldom incorrectly handled certain inputs. If a user or an automated system were
    ...
    It was discovered that xmldom incorrectly handled certain inputs. If a user or an automated system were
    tricked into opening a specially crafted input file, a remote attacker could possibly use this issue to
    cause a denial of service. (CVE-2022-37616, CVE-2022-39353)
