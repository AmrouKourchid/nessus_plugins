...
if (description)
{
  ...
  script_name(english:"Autodesk Navisworks Simulate 25.0.x < 2026.0 Multiple Vulnerabilities (adsk-sa-2025-0002)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The version of Autodesk Navisworks Simulate installed on the remote host is 2025.0 prior to 2026.0. It is,
...
"Upgrade to Autodesk Navisworks Simulate version 2026.0 or later.");
  ...
  script_set_attribute(attribute:"cpe", value:"cpe:/a:autodesk:navisworks_simulate");
