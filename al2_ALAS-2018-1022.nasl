...
# extracted from Amazon Linux 2 Security Advisory ALAS-2018-1022.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2018-1022");

  script_name(english:"Amazon Linux 2 : ghostscript (ALAS-2018-1022)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The set_text_distance function in devices/vector/gdevpdts.c in the
pdfwrite component in Artifex Ghostscript through 9.22 does not
...
(CVE-2018-10194)");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2018-1022.html");
...
flag = 0;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"ghostscript-9.06-2.amzn2.0.2")) flag++;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"ghostscript-cups-9.06-2.amzn2.0.2")) flag++;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"ghostscript-debuginfo-9.06-2.amzn2.0.2")) flag++;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"ghostscript-devel-9.06-2.amzn2.0.2")) flag++;
if (rpm_check(release:"AL2", reference:"ghostscript-doc-9.06-2.amzn2.0.2")) flag++;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"ghostscript-gtk-9.06-2.amzn2.0.2")) flag++;
