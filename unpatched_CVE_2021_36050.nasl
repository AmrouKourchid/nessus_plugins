...
if (description)
{
  ...
  script_cve_id("CVE-2021-36050");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2021-36050");
...
patch available.
  ...
  - XMP Toolkit SDK version 2020.1 (and earlier) is affected by a buffer overflow vulnerability potentially
    ...
    interaction in that a victim must open a crafted file. (CVE-2021-36050)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-36050");
