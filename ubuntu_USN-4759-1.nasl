...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 20.04 LTS : GLib vulnerabilities (USN-4759-1)");
...
vulnerabilities as referenced in the USN-4759-1 advisory.
    ...
    Krzesimir Nowak discovered that GLib incorrectly handled certain large buffers. A remote attacker could
    use this issue to cause applications linked to GLib to crash, resulting in a denial of service, or
    possibly execute arbitrary code. (CVE-2021-27218)

    Kevin Backhouse discovered that GLib incorrectly handled certain memory allocations. A remote attacker
    could use this issue to cause applications linked to GLib to crash, resulting in a denial of service, or
    possibly execute arbitrary code. (CVE-2021-27219)
