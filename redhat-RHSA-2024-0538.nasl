...
# extracted from Red Hat Security Advisory RHSA-2024:0538. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0538.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?978f2ede");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0538");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libssh package based on the guidance in RHSA-2024:0538.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libssh-0.9.6-4.el8_6', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libssh-config-0.9.6-4.el8_6', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libssh-devel-0.9.6-4.el8_6', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
