...
if (description)
{
  ...
  script_cve_id("CVE-2024-41728");
  script_xref(name:"IAVA", value:"2024-A-0551");

  script_name(english:"SAP NetWeaver AS ABAP Missing Authorization (3496410)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SAP NetWeaver ABAP server may be affected by a missing authorization vulnerability.");
  script_set_attribute(attribute:"description", value:
"Due to missing authorization check, SAP NetWeaver Application Server for ABAP and ABAP Platform allows an attacker
logged in as a developer to read objects contained in a package. This causes an impact on confidentiality, as this
attacker would otherwise not have access to view these objects.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://me.sap.com/notes/3496410");
...
"Apply the appropriate patch according to the vendor advisory.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-41728");
