...
# extracted from Fedora Security Advisory FEDORA-2024-ef4911442d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-ef4911442d");

  script_name(english:"Fedora 39 : koji (2024-ef4911442d)");
...
FEDORA-2024-ef4911442d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-ef4911442d");
...
var pkgs = [
    {'reference':'koji-1.35.1-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
