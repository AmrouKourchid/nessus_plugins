...
# extracted from Fedora Security Advisory FEDORA-2024-f294ddb7fb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-f294ddb7fb");

  script_name(english:"Fedora 38 : freerdp (2024-f294ddb7fb)");
...
FEDORA-2024-f294ddb7fb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-f294ddb7fb");
...
var pkgs = [
    {'reference':'freerdp-2.11.5-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
