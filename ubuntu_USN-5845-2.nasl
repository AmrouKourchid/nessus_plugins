...
# extracted from Ubuntu Security Notice USN-5845-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5845-2");

  script_name(english:"Ubuntu 16.04 ESM : OpenSSL vulnerabilities (USN-5845-2)");
...
the USN-5845-2 advisory.

    USN-5845-1 fixed several vulnerabilities in OpenSSL. This update provides the corresponding update for
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5845-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libssl-dev', 'pkgver': '1.0.2g-1ubuntu4.20+esm6', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libssl1.0.0', 'pkgver': '1.0.2g-1ubuntu4.20+esm6', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'openssl', 'pkgver': '1.0.2g-1ubuntu4.20+esm6', 'ubuntu_pro': TRUE}
];
