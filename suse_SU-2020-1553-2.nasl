...
# extracted from SUSE update advisory SUSE-SU-2020:1553-2.
...
if (description)
{
  ...
  script_name(english:"SUSE SLED15 / SLES15 Security Update : libexif (SUSE-SU-2020:1553-2)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d731bb17");
...
zypper in -t patch
SUSE-SLE-Module-Packagehub-Subpackages-15-SP2-2020-1553=1

SUSE Linux Enterprise Module for Packagehub Subpackages 15-SP1 :

zypper in -t patch
SUSE-SLE-Module-Packagehub-Subpackages-15-SP1-2020-1553=1

SUSE Linux Enterprise Module for Desktop Applications 15-SP2 :

zypper in -t patch
SUSE-SLE-Module-Desktop-Applications-15-SP2-2020-1553=1");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:suse_linux:libexif12-32bit-debuginfo");
...
flag = 0;
if (rpm_check(release:"SLES15", sp:"1", cpu:"x86_64", reference:"libexif-debugsource-0.6.22-5.6.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", cpu:"x86_64", reference:"libexif12-32bit-0.6.22-5.6.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", cpu:"x86_64", reference:"libexif12-32bit-debuginfo-0.6.22-5.6.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", cpu:"x86_64", reference:"libexif12-32bit-0.6.22-5.6.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", cpu:"x86_64", reference:"libexif12-32bit-debuginfo-0.6.22-5.6.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"libexif-debugsource-0.6.22-5.6.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"libexif-devel-0.6.22-5.6.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"libexif12-0.6.22-5.6.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"libexif12-debuginfo-0.6.22-5.6.1")) flag++;
if (rpm_check(release:"SLED15", sp:"1", cpu:"x86_64", reference:"libexif-debugsource-0.6.22-5.6.1")) flag++;
if (rpm_check(release:"SLED15", sp:"1", cpu:"x86_64", reference:"libexif12-32bit-0.6.22-5.6.1")) flag++;
if (rpm_check(release:"SLED15", sp:"1", cpu:"x86_64", reference:"libexif12-32bit-debuginfo-0.6.22-5.6.1")) flag++;
if (rpm_check(release:"SLED15", sp:"2", cpu:"x86_64", reference:"libexif12-32bit-0.6.22-5.6.1")) flag++;
if (rpm_check(release:"SLED15", sp:"2", cpu:"x86_64", reference:"libexif12-32bit-debuginfo-0.6.22-5.6.1")) flag++;
if (rpm_check(release:"SLED15", sp:"2", reference:"libexif-debugsource-0.6.22-5.6.1")) flag++;
if (rpm_check(release:"SLED15", sp:"2", reference:"libexif-devel-0.6.22-5.6.1")) flag++;
if (rpm_check(release:"SLED15", sp:"2", reference:"libexif12-0.6.22-5.6.1")) flag++;
if (rpm_check(release:"SLED15", sp:"2", reference:"libexif12-debuginfo-0.6.22-5.6.1")) flag++;
