...
# extracted from Ubuntu Security Notice USN-7031-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"7031-2");

  script_name(english:"Ubuntu 20.04 LTS / 22.04 LTS : Puma vulnerability (USN-7031-2)");
...
in the USN-7031-2 advisory.

    USN-7031-1 fixed CVE-2024-45614 in Puma for Ubuntu 24.04 LTS. This update fixes the CVE for Ubuntu 22.04
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7031-2");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'puma', 'pkgver': '3.12.4-1ubuntu2+esm2', 'ubuntu_pro': TRUE},
    {'osver': '22.04', 'pkgname': 'puma', 'pkgver': '5.5.2-2ubuntu2+esm2', 'ubuntu_pro': TRUE}
];
