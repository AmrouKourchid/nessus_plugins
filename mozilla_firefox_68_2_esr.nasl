...
"The version of Firefox ESR installed on the remote Windows host is prior to 68.2. It is, therefore, affected by multiple
vulnerabilities as referenced in the mfsa2019-33 advisory, including the following:
...
mozilla_check_version(installs:installs, product:'firefox', esr:TRUE, fix:'68.2', min:'68.0.0', severity:SECURITY_WARNING, xss:TRUE);
