...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_3639.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cbd7f98a");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1993929");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL nodejs:12 package based on the guidance in RHSA-2021:3639.");
  ...
  script_cwe_id(20, 22, 79, 125, 400, 416, 770);
