...
# extracted from Fedora Security Advisory FEDORA-2023-828bf01834
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-828bf01834");

  script_name(english:"Fedora 37 : dnsmasq (2023-828bf01834)");
...
FEDORA-2023-828bf01834 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-828bf01834");
...
var pkgs = [
    {'reference':'dnsmasq-2.89-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
