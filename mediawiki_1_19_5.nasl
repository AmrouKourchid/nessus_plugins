...
relied only on the application's self-reported version number.");
  # https://lists.wikimedia.org/pipermail/mediawiki-announce/2013-April/000127.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4f84eeb1");
...
"Upgrade to MediaWiki version 1.19.5 / 1.20.4 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-1951");
