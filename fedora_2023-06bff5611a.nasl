...
# extracted from Fedora Security Advisory FEDORA-2023-06bff5611a
#
...
if (description)
{
  ...
  script_cve_id("CVE-2023-43785");
  script_xref(name:"FEDORA", value:"2023-06bff5611a");

  script_name(english:"Fedora 39 : libX11 (2023-06bff5611a)");
...
FEDORA-2023-06bff5611a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-06bff5611a");
...
"Update the affected libX11 package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-43785");
...
var pkgs = [
    {'reference':'libX11-1.8.7-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
