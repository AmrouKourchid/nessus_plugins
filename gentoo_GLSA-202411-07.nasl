...
# extracted from Gentoo Linux Security Advisory GLSA 202411-07.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202411-07 : Pillow: Arbitrary code execution");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202411-07 (Pillow: Arbitrary code execution)

    A vulnerability has been discovered in Pillow. Please review the CVE identifier referenced below for
    details.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202411-07");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=928391");
...
var packages = [
  {
    ...
    'unaffected' : make_list("ge 10.3.0"),
    'vulnerable' : make_list("lt 10.3.0")
  }
];
