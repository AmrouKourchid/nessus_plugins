...
if (description)
{
  ...
  script_name(english:"RHCOS 4 : OpenShift Container Platform 4.11.58 (RHSA-2024:0684)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat CoreOS host is missing a security update for OpenShift Container Platform 4.11.58.");
...
referenced in the RHSA-2024:0684 advisory.
...
"Update the RHCOS OpenShift Container Platform 4.11.58 packages based on the guidance in RHSA-2024:0684.");
...
var pkgs = [
    {'reference':'runc-1.1.2-3.1.rhaos4.11.el8', 'release':'4', 'el_string':'el8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube'}
];
