...
# extracted from SUSE update advisory SUSE-SU-2018:0976-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES11 Security Update : perl (SUSE-SU-2018:0976-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"This update for perl fixes the following issues: Security issue 
fixed :
...
without introducing additional issues.");
  ...
  # https://www.suse.com/support/update/announcement/2018/suse-su-20180976-1/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?48859e89");
...
patch sdksp4-perl-13564=1

SUSE Linux Enterprise Server 11-SP4:zypper in -t patch
slessp4-perl-13564=1
...
flag = 0;
if (rpm_check(release:"SLES11", sp:"4", cpu:"x86_64", reference:"perl-32bit-5.10.0-64.81.10.1")) flag++;
if (rpm_check(release:"SLES11", sp:"4", cpu:"s390x", reference:"perl-32bit-5.10.0-64.81.10.1")) flag++;
if (rpm_check(release:"SLES11", sp:"4", reference:"perl-5.10.0-64.81.10.1")) flag++;
if (rpm_check(release:"SLES11", sp:"4", reference:"perl-Module-Build-0.2808.01-0.81.10.1")) flag++;
if (rpm_check(release:"SLES11", sp:"4", reference:"perl-Test-Simple-0.72-0.81.10.1")) flag++;
if (rpm_check(release:"SLES11", sp:"4", reference:"perl-base-5.10.0-64.81.10.1")) flag++;
if (rpm_check(release:"SLES11", sp:"4", reference:"perl-doc-5.10.0-64.81.10.1")) flag++;
