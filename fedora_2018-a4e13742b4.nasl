...
# extracted from Fedora Security Advisory FEDORA-2018-a4e13742b4.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : gnupg (2018-a4e13742b4)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-a4e13742b4");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"gnupg-1.4.23-1.fc28")) flag++;
