...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Libxslt PHSA-2019-1.0-0224");
...
if (rpm_check(release:"PhotonOS-1.0", reference:"libxslt-1.1.29-5.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"libxslt-debuginfo-1.1.29-5.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"libxslt-devel-1.1.29-5.ph1")) flag++;
