...
# extracted from Red Hat Security Advisory RHSA-2024:6020. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:6020");

  script_name(english:"RHEL 9 : postgresql:15 (RHSA-2024:6020)");
...
referenced in the RHSA-2024:6020 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_6020.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1e991faf");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:6020");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL postgresql:15 package based on the guidance in RHSA-2024:6020.");
  ...
  'postgresql:15': [
    {
      ...
      'pkgs': [
        {'reference':'pg_repack-1.4.8-1.module+el9.2.0+17405+aeb9ec60', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'pgaudit-1.7.0-1.module+el9.2.0+17405+aeb9ec60', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgres-decoderbufs-1.9.7-1.Final.module+el9.2.0+17405+aeb9ec60', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-15.8-1.module+el9.4.0+22208+cd6b92ff', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-contrib-15.8-1.module+el9.4.0+22208+cd6b92ff', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-docs-15.8-1.module+el9.4.0+22208+cd6b92ff', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plperl-15.8-1.module+el9.4.0+22208+cd6b92ff', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plpython3-15.8-1.module+el9.4.0+22208+cd6b92ff', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-pltcl-15.8-1.module+el9.4.0+22208+cd6b92ff', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-private-devel-15.8-1.module+el9.4.0+22208+cd6b92ff', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-private-libs-15.8-1.module+el9.4.0+22208+cd6b92ff', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-15.8-1.module+el9.4.0+22208+cd6b92ff', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-devel-15.8-1.module+el9.4.0+22208+cd6b92ff', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-static-15.8-1.module+el9.4.0+22208+cd6b92ff', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-15.8-1.module+el9.4.0+22208+cd6b92ff', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-rpm-macros-15.8-1.module+el9.4.0+22208+cd6b92ff', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-upgrade-15.8-1.module+el9.4.0+22208+cd6b92ff', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-upgrade-devel-15.8-1.module+el9.4.0+22208+cd6b92ff', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
      ]
    },
    {
      'repo_relative_urls': [
      ...
      'pkgs': [
        ...
        {'reference':'postgresql-15.8-1.module+el9.4.0+22208+cd6b92ff', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-contrib-15.8-1.module+el9.4.0+22208+cd6b92ff', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-docs-15.8-1.module+el9.4.0+22208+cd6b92ff', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plperl-15.8-1.module+el9.4.0+22208+cd6b92ff', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plpython3-15.8-1.module+el9.4.0+22208+cd6b92ff', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-pltcl-15.8-1.module+el9.4.0+22208+cd6b92ff', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-private-devel-15.8-1.module+el9.4.0+22208+cd6b92ff', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-private-libs-15.8-1.module+el9.4.0+22208+cd6b92ff', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-15.8-1.module+el9.4.0+22208+cd6b92ff', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-devel-15.8-1.module+el9.4.0+22208+cd6b92ff', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-static-15.8-1.module+el9.4.0+22208+cd6b92ff', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-15.8-1.module+el9.4.0+22208+cd6b92ff', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-rpm-macros-15.8-1.module+el9.4.0+22208+cd6b92ff', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-upgrade-15.8-1.module+el9.4.0+22208+cd6b92ff', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-upgrade-devel-15.8-1.module+el9.4.0+22208+cd6b92ff', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
