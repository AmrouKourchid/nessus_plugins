...
# extracted from Fedora Security Advisory FEDORA-2024-45df72afc6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-45df72afc6");

  script_name(english:"Fedora 40 : edk2 (2024-45df72afc6)");
...
FEDORA-2024-45df72afc6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-45df72afc6");
...
var pkgs = [
    {'reference':'edk2-20240813-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
