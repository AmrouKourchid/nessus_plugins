...
# extracted from Amazon Linux 2023 Security Advisory ALAS2023-2023-315.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2023 : jsoup, jsoup-javadoc (ALAS2023-2023-315)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2023 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"It is, therefore, affected by a vulnerability as referenced in the ALAS2023-2023-315 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2023/ALAS-2023-315.html");
...
"Run 'dnf update jsoup --releasever 2023.1.20230823' to update your system.");
...
var pkgs = [
    {'reference':'jsoup-1.13.1-9.amzn2023.0.5', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'jsoup-javadoc-1.13.1-9.amzn2023.0.5', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE}
];
