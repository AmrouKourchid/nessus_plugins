...
# extracted from Fedora Security Advisory FEDORA-2018-aed26fc705.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : ppp (2018-aed26fc705)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"This is an fix for CVE-2018-11574.

Note that Tenable Network Security has extracted the preceding
description block directly from the Fedora update system website.
Tenable has attempted to automatically clean and format it as much as
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-aed26fc705");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"ppp-2.4.7-22.fc28")) flag++;
