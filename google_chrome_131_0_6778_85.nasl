...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2024-A-0760-S");

  script_name(english:"Google Chrome < 131.0.6778.85 Vulnerability");

  script_set_attribute(attribute:"synopsis", value:
"A web browser installed on the remote Windows host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Google Chrome installed on the remote Windows host is prior to 131.0.6778.85. It is, therefore, affected
by a vulnerability as referenced in the 2024_11_stable-channel-update-for-desktop_19 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6ad3b932");
  script_set_attribute(attribute:"see_also", value:"https://crbug.com/377384894");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Google Chrome version 131.0.6778.85 or later.");
...
google_chrome_check_version(installs:installs, fix:'131.0.6778.85', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
