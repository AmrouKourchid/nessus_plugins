...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : cups (EulerOS-SA-2023-2829)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2829
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f31df25a");
...
var pkgs = [
  "cups-libs-2.4.0-3.h2.eulerosv2r11"
];
