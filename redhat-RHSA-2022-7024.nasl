...
# extracted from Red Hat Security Advisory RHSA-2022:7024. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:7024");
  script_xref(name:"IAVA", value:"2022-A-0491-S");

  script_name(english:"RHEL 8 : firefox (RHSA-2022:7024)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_7024.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?89192f46");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2130769");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:7024");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL firefox package based on the guidance in RHSA-2022:7024.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-102.3.0-7.el8_6', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'firefox-102.3.0-7.el8_6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
