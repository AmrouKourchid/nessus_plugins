...
# extracted from Amazon Linux 2 Security Advisory ALAS-2023-2307.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : libsepol (ALAS-2023-2307)");
...
vulnerabilities as referenced in the ALAS2-2023-2307 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2023-2307.html");
