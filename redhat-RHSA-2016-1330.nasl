...
if (description)
{
  ...
  script_name(english:"RHEL 5 / 6 / 7 : Red Hat JBoss Enterprise Application Platform 6.4 (RHSA-2016:1330)");
...
referenced in the RHSA-2016:1330 advisory.

    Red Hat JBoss Enterprise Application Platform 6 is a platform for Java applications based on JBoss
    Application Server 7.

    This asynchronous patch is a security update for JGroups package in Red Hat JBoss Enterprise Application
    Platform 6.4 More information about this vulnerability is available at:
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2016/rhsa-2016_1330.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?531369c9");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/articles/2360521");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2016:1330");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#critical");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1313589");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1343598");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1343599");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1343600");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat JBoss Enterprise Application Platform 6.4 package based on the guidance in RHSA-2016:1330.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jgroups-3.2.16-1.Final_redhat_1.1.ep6.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'eap6'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'jgroups-3.2.16-1.Final_redhat_1.1.ep6.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'eap6'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'jgroups-3.2.16-1.Final_redhat_1.1.ep6.el5', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'eap6'}
    ]
  }
];
