...
var appstreams = {
    'python39:3.9': [
      ...
      {'reference':'python39-3.9.7-1.module_el8.6.0+2780+a40f65e1', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python39-devel-3.9.7-1.module_el8.6.0+2780+a40f65e1', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-idle-3.9.7-1.module_el8.6.0+2780+a40f65e1', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-libs-3.9.7-1.module_el8.6.0+2780+a40f65e1', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-lxml-4.6.5-1.module_el8.6.0+2780+a40f65e1', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-mod_wsgi-4.7.1-4.module_el8.6.0+2780+a40f65e1', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python39-test-3.9.7-1.module_el8.6.0+2780+a40f65e1', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-tkinter-3.9.7-1.module_el8.6.0+2780+a40f65e1', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
};
