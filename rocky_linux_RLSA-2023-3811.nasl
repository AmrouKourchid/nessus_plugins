...
# Rocky Linux Security Advisory RLSA-2023:3811.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2023:3811");

  script_name(english:"Rocky Linux 8 : python39:3.9 and python39-devel:3.9 (RLSA-2023:3811)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Rocky Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Rocky Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
RLSA-2023:3811 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2023:3811");
...
var appstreams = {
    'python39-devel:3.9': [
      ...
      {'reference':'python39-3.9.16-1.module+el8.8.0+1111+d03fad2b', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-3.9.16-1.module+el8.8.0+1111+d03fad2b', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python39-debug-3.9.16-1.module+el8.8.0+1111+d03fad2b', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-debug-3.9.16-1.module+el8.8.0+1111+d03fad2b', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-debuginfo-3.9.16-1.module+el8.8.0+1111+d03fad2b', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-debuginfo-3.9.16-1.module+el8.8.0+1111+d03fad2b', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-debugsource-3.9.16-1.module+el8.8.0+1111+d03fad2b', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-debugsource-3.9.16-1.module+el8.8.0+1111+d03fad2b', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-devel-3.9.16-1.module+el8.8.0+1111+d03fad2b', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-devel-3.9.16-1.module+el8.8.0+1111+d03fad2b', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-idle-3.9.16-1.module+el8.8.0+1111+d03fad2b', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-idle-3.9.16-1.module+el8.8.0+1111+d03fad2b', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python39-libs-3.9.16-1.module+el8.8.0+1111+d03fad2b', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-libs-3.9.16-1.module+el8.8.0+1111+d03fad2b', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python39-rpm-macros-3.9.16-1.module+el8.8.0+1111+d03fad2b', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python39-test-3.9.16-1.module+el8.8.0+1111+d03fad2b', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-test-3.9.16-1.module+el8.8.0+1111+d03fad2b', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-tkinter-3.9.16-1.module+el8.8.0+1111+d03fad2b', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-tkinter-3.9.16-1.module+el8.8.0+1111+d03fad2b', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
