...
# extracted from Fedora Security Advisory FEDORA-2025-e923d51676
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-e923d51676");

  script_name(english:"Fedora 40 : python-pydantic-core / rust-adblock / rust-cookie_store / etc (2025-e923d51676)");
...
FEDORA-2025-e923d51676 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-e923d51676");
...
var pkgs = [
    {'reference':'python-pydantic-core-2.20.1-3.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-adblock-0.9.6-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-cookie_store-0.21.1-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-gitui-0.26.3-6.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-gstreamer-0.23.5-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-icu_collections-1.5.0-3.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-icu_locid-1.5.0-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-icu_locid_transform-1.5.0-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-icu_locid_transform_data-1.5.1-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-icu_normalizer-1.5.0-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-icu_normalizer_data-1.5.1-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-icu_properties-1.5.1-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-icu_properties_data-1.5.1-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-icu_provider-1.5.0-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-icu_provider_macros-1.5.0-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-idna-1.0.3-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-idna_adapter-1.2.0-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-litemap-0.7.3-5.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-ron-0.9.0-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-sequoia-openpgp-2.0.0-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-sequoia-openpgp1-1.22.0-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-tinystr-0.7.6-4.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-url-2.5.4-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-utf16_iter-1.0.5-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-version-ranges-0.1.1-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-write16-1.0.0-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-writeable-0.5.5-3.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-zerovec-0.10.4-4.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-zip-2.6.1-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'uv-0.6.14-3.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
