...
if (description)
{
  ...
  script_cve_id("CVE-2016-4984");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2016-4984");
...
patch available.
  ...
  - /usr/libexec/openldap/generate-server-cert.sh in openldap-servers sets weak permissions for the TLS
    certificate, which allows local users to obtain the TLS certificate by leveraging a race condition between
    the creation of the certificate, and the chmod to protect it. (CVE-2016-4984)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-4984");
