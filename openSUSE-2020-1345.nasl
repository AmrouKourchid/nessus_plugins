...
# extracted from openSUSE Security Update openSUSE-2020-1345.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : curl (openSUSE-2020-1345)");
...
This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1175109");
...
if ( rpm_check(release:"SUSE15.1", reference:"curl-7.60.0-lp151.5.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"curl-debuginfo-7.60.0-lp151.5.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"curl-debugsource-7.60.0-lp151.5.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"curl-mini-7.60.0-lp151.5.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"curl-mini-debuginfo-7.60.0-lp151.5.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"curl-mini-debugsource-7.60.0-lp151.5.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libcurl-devel-7.60.0-lp151.5.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libcurl-mini-devel-7.60.0-lp151.5.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libcurl4-7.60.0-lp151.5.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libcurl4-debuginfo-7.60.0-lp151.5.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libcurl4-mini-7.60.0-lp151.5.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libcurl4-mini-debuginfo-7.60.0-lp151.5.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libcurl-devel-32bit-7.60.0-lp151.5.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libcurl4-32bit-7.60.0-lp151.5.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libcurl4-32bit-debuginfo-7.60.0-lp151.5.15.1") ) flag++;
