...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : numpy (EulerOS-SA-2022-1491)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1491
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?37b8fef5");
...
var pkgs = [
  "python3-numpy-1.16.5-3.h4.eulerosv2r10"
];
