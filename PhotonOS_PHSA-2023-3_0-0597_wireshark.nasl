...
if (description)
{
  ...
  script_cve_id("CVE-2023-2952");
  script_xref(name:"IAVB", value:"2023-B-0036-S");

  script_name(english:"Photon OS 3.0: Wireshark PHSA-2023-3.0-0597");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'wireshark-3.6.14-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'wireshark-devel-3.6.14-1.ph3')) flag++;
