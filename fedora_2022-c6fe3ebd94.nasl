...
# extracted from Fedora Security Advisory FEDORA-2022-c6fe3ebd94
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-c6fe3ebd94");

  script_name(english:"Fedora 37 : php-twig (2022-c6fe3ebd94)");
...
FEDORA-2022-c6fe3ebd94 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-c6fe3ebd94");
...
var pkgs = [
    {'reference':'php-twig-1.44.7-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
