...
# extracted from Fedora Security Advisory FEDORA-2019-3d3bb765ca.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-3d3bb765ca");

  script_name(english:"Fedora 30 : dino (2019-3d3bb765ca)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-3d3bb765ca");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"dino-0.0-0.12.20190912.git.a96c801.fc30")) flag++;
