...
# extracted from Gentoo Linux Security Advisory GLSA 202107-14.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202107-14");

  script_name(english:"GLSA-202107-14 : rclone: Weak random number generation");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202107-14
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202107-14"
  );
  script_set_attribute(
    attribute:"solution",
    value:
"All rclone users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:rclone");
...
if (qpkg_check(package:"net-misc/rclone", unaffected:make_list("ge 1.53.3"), vulnerable:make_list("lt 1.53.3"))) flag++;
