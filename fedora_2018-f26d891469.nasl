...
# extracted from Fedora Security Advisory FEDORA-2018-f26d891469.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-f26d891469");

  script_name(english:"Fedora 26 : 1:libvorbis (2018-f26d891469)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-f26d891469");
...
flag = 0;
if (rpm_check(release:"FC26", reference:"libvorbis-1.3.6-1.fc26", epoch:"1")) flag++;
