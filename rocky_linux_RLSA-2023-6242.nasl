...
# Rocky Linux Security Advisory RLSA-2023:6242.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2023:6242");

  script_name(english:"Rocky Linux 9 : .NET 6.0 (RLSA-2023:6242)");
...
RLSA-2023:6242 advisory.

  - .NET Core and Visual Studio Denial of Service Vulnerability (CVE-2023-36799)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2023:6242");
...
var pkgs = [
    ...
    {'reference':'dotnet-apphost-pack-6.0-debuginfo-6.0.24-1.el9_2', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'dotnet-hostfxr-6.0-6.0.24-1.el9_2', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'dotnet-hostfxr-6.0-debuginfo-6.0.24-1.el9_2', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'dotnet-runtime-6.0-6.0.24-1.el9_2', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'dotnet-runtime-6.0-debuginfo-6.0.24-1.el9_2', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'dotnet-sdk-6.0-6.0.124-1.el9_2', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'dotnet-sdk-6.0-debuginfo-6.0.124-1.el9_2', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
