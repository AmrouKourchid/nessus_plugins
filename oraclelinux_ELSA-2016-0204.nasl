...
ELSA-2016-0204 advisory.

    - Resolves: bug 1299757 - CVE-2016-0741 389-ds-base: Worker threads do not detect abnormally closed
    connections causing DoS

Tenable has extracted the preceding description block directly from the Oracle Linux security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2016-0204.html");
...
"Update the affected 389-ds-base, 389-ds-base-devel and / or 389-ds-base-libs packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-0741");
...
var pkgs = [
    {'reference':'389-ds-base-1.3.4.0-26.el7_2', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'389-ds-base-devel-1.3.4.0-26.el7_2', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'389-ds-base-libs-1.3.4.0-26.el7_2', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
];
