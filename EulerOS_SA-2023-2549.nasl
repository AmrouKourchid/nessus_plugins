...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : shadow (EulerOS-SA-2023-2549)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2549
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e7c95698");
...
var pkgs = [
  "shadow-4.8.1-1.h27.eulerosv2r10"
];
