...
ELSA-2020-1358 advisory.
    ...
    - Resolves: bz#1791565
      (CVE-2020-7039 virt:rhel/qemu-kvm: QEMU: slirp: OOB buffer access while emulating tcp protocols in
    tcp_emu() [rhel-8.1.0.z])
    - Resolves: bz#1794500
      (CVE-2020-1711 qemu-kvm: QEMU: block: iscsi: OOB heap access via an unexpected response of iSCSI Server
    [rhel-8.1.0.z])
...
var appstreams = {
    'virt-devel:ol': [
      ...
      {'reference':'qemu-kvm-tests-2.12.0-88.0.1.module+el8.1.0+5574+a95766b2.3', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
    ...
    'virt:ol': [
      ...
      {'reference':'libvirt-daemon-driver-qemu-4.5.0-35.3.0.1.module+el8.1.0+5574+a95766b2', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'libvirt-daemon-driver-storage-gluster-4.5.0-35.3.0.1.module+el8.1.0+5574+a95766b2', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'libvirt-daemon-kvm-4.5.0-35.3.0.1.module+el8.1.0+5574+a95766b2', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'libvirt-lock-sanlock-4.5.0-35.3.0.1.module+el8.1.0+5574+a95766b2', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'qemu-guest-agent-2.12.0-88.0.1.module+el8.1.0+5574+a95766b2.3', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
      {'reference':'qemu-img-2.12.0-88.0.1.module+el8.1.0+5574+a95766b2.3', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
      {'reference':'qemu-kvm-2.12.0-88.0.1.module+el8.1.0+5574+a95766b2.3', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
      {'reference':'qemu-kvm-block-curl-2.12.0-88.0.1.module+el8.1.0+5574+a95766b2.3', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
      {'reference':'qemu-kvm-block-iscsi-2.12.0-88.0.1.module+el8.1.0+5574+a95766b2.3', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
      {'reference':'qemu-kvm-block-rbd-2.12.0-88.0.1.module+el8.1.0+5574+a95766b2.3', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
      {'reference':'qemu-kvm-block-ssh-2.12.0-88.0.1.module+el8.1.0+5574+a95766b2.3', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
      {'reference':'qemu-kvm-common-2.12.0-88.0.1.module+el8.1.0+5574+a95766b2.3', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
      {'reference':'qemu-kvm-core-2.12.0-88.0.1.module+el8.1.0+5574+a95766b2.3', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
