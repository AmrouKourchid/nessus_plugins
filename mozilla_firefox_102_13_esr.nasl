...
"The version of Firefox ESR installed on the remote Windows host is prior to 102.13. It is, therefore, affected by
multiple vulnerabilities as referenced in the mfsa2023-23 advisory.
...
mozilla_check_version(installs:installs, product:'firefox', esr:TRUE, fix:'102.13', min:'102.0.0', severity:SECURITY_HOLE);
