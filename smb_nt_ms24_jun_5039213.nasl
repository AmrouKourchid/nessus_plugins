...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5039213");
  script_xref(name:"MSFT", value:"MS24-5039213");
  ...
  script_name(english:"KB5039213: Windows 11 version 21H2 Security Update (June 2024)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5039213");
