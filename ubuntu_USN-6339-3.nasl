...
# extracted from Ubuntu Security Notice USN-6339-3. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6339-3");

  script_name(english:"Ubuntu 20.04 LTS / 22.04 LTS : Linux kernel vulnerabilities (USN-6339-3)");
...
referenced in the USN-6339-3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6339-3");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.15.0-1037-raspi");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.15.0-1046-azure-fde");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-6339-3');
}
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-6339-3');
  }
  else
  {
