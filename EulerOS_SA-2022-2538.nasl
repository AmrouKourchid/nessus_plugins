...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : shim (EulerOS-SA-2022-2538)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2538
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6ebb7c6c");
...
var pkgs = [
  "shim-unsigned-x64-12-1.h4.eulerosv2r7"
];
