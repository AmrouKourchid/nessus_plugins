...
# extracted from Red Hat Security Advisory RHSA-2024:1690. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:1690");

  script_name(english:"RHEL 8 : varnish (RHSA-2024:1690)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for varnish.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:1690 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_1690.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a9aacd26");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2271486");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:1690");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL varnish package based on the guidance in RHSA-2024:1690.");
  ...
  'varnish:6': [
    {
      ...
      'pkgs': [
        {'reference':'varnish-6.0.13-1.module+el8.9.0+21617+7578fa11', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'varnish-devel-6.0.13-1.module+el8.9.0+21617+7578fa11', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'varnish-docs-6.0.13-1.module+el8.9.0+21617+7578fa11', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'varnish-modules-0.15.0-6.module+el8.9.0+21617+7578fa11', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
