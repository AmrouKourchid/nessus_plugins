...
if (description)
{
  ...
  script_cve_id("CVE-2023-1521");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2023-1521");
...
patch available.
  ...
  - On Linux the sccache client can execute arbitrary code with the privileges of a local sccache server, by
    ...
    default when installing the snap package https://snapcraft.io/sccache ), this means a user running the
    sccache client can get root privileges. (CVE-2023-1521)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-1521");
