...
# extracted from F5 Networks BIG-IP Solution K000134888.
#
# @NOAGENT@
##
...
if (description)
{
  ...
  script_cve_id("CVE-2025-21087");
  script_xref(name:"IAVA", value:"2025-A-0086");

  script_name(english:"F5 Networks BIG-IP : TMM vulnerability (K000134888)");
...
referenced in the K000134888 advisory.

    When Client SSL or Server SSL profiles are configured on a virtual server, or Domain Name System Security
    Extensions (DNSSEC) signing operations are in use, undisclosed traffic can cause an increase in memory and
    CPU resource utilization.(CVE-2025-21087)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K000134888");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K000134888.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-21087");
