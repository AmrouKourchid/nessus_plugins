...
# extracted from Oracle Linux Security Advisory ELSA-2023-6943.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : cloud-init (ELSA-2023-6943)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-6943.html");
...
var pkgs = [
    {'reference':'cloud-init-23.1.1-10.0.1.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
