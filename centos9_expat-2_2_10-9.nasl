...
if (description)
{
  ...
  script_name(english:"CentOS 9 : expat-2.2.10-9.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing one or more security updates for expat.");
...
expat-2.2.10-9.el9 build changelog.

  - Large number of prefixed XML attributes on a single tag can crash libexpat (CVE-2021-45960)

  - Integer overflow in doProlog in xmlparse.c (CVE-2021-46143)
  ...
  - integer overflow in function XML_GetBuffer (CVE-2022-23852)

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=16922");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream expat package.");
...
var pkgs = [
    {'reference':'expat-2.2.10-9.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'expat-devel-2.2.10-9.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'expat-static-2.2.10-9.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
