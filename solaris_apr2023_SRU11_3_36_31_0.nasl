...
if (description)
{
  ...
  script_name(english:"Oracle Solaris Critical Patch Update : apr2023_SRU11_3_36_31_0");
...
fix_release = "0.5.11-0.175.3.36.0.31.0";

flag = 0;

if (solaris_check_release(release:"0.5.11-0.175.3.36.0.31.0", sru:"11.3.36.31.0") > 0) flag++;
