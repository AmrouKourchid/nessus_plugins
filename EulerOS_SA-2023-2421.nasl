...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : dnsmasq (EulerOS-SA-2023-2421)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2421
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?910b0129");
...
var pkgs = [
  "dnsmasq-2.76-5.h12.eulerosv2r7",
  "dnsmasq-utils-2.76-5.h12.eulerosv2r7"
];
