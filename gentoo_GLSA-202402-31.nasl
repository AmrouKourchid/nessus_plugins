...
# extracted from Gentoo Linux Security Advisory GLSA 202402-31.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202402-31 : GNU Aspell: Heap Buffer Overflow");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202402-31");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=803113");
...
"All aspell users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:aspell");
...
var packages = [
  {
    ...
    'unaffected' : make_list("ge 0.60.8-r3"),
    'vulnerable' : make_list("lt 0.60.8-r3")
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'GNU Aspell');
}
