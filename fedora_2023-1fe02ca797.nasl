...
# extracted from Fedora Security Advisory FEDORA-2023-1fe02ca797
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-1fe02ca797");
  script_xref(name:"IAVA", value:"2023-A-0693-S");

  script_name(english:"Fedora 39 : chromium (2023-1fe02ca797)");
...
FEDORA-2023-1fe02ca797 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-1fe02ca797");
...
var pkgs = [
    {'reference':'chromium-120.0.6099.109-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
