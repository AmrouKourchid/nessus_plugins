...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5032248");
  script_xref(name:"MSKB", value:"5032254");
  script_xref(name:"MSFT", value:"MS23-5032248");
  script_xref(name:"MSFT", value:"MS23-5032254");
  ...
  script_name(english:"KB5032248: Windows Server 2008 Security Update (November 2023)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5032248. It is, therefore, affected by multiple vulnerabilities
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5032248");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5032254");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5032248 or Cumulative Update 5032254");
...
if (
  smb_check_rollup(os:'6.0',
                   ...
                   rollup_date:'11_2023',
                   bulletin:bulletin,
                   rollup_kb_list:[5032254, 5032248])
)
{
