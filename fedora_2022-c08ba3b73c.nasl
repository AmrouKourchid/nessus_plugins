...
# extracted from Fedora Security Advisory FEDORA-2022-c08ba3b73c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-c08ba3b73c");

  script_name(english:"Fedora 37 : graphviz (2022-c08ba3b73c)");
...
FEDORA-2022-c08ba3b73c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-c08ba3b73c");
...
var pkgs = [
    {'reference':'graphviz-5.0.0-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
