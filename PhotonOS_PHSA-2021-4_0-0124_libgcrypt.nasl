...
# extracted from VMware Security Advisory PHSA-2021-4.0-0124. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Libgcrypt PHSA-2021-4.0-0124");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the libgcrypt package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-124.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libgcrypt-1.9.4-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libgcrypt-devel-1.9.4-1.ph4')) flag++;
