...
# extracted from F5 Networks BIG-IP Solution K11315080.
#
# @NOAGENT@
##
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : OpenSSH vulnerability (K11315080)");
...
affected by a vulnerability as referenced in the K11315080 advisory.
    ...
    directory on the client side.(CVE-2018-20685)ImpactThe OpenSSH SCP client is vulnerable to a malicious SCP
    server performing unauthorized changes to the target directory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K11315080");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K11315080.");
