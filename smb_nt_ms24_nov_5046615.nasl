...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5046615");
  script_xref(name:"MSFT", value:"MS24-5046615");
  ...
  script_name(english:"KB5046615: Windows 10 version 1809 / Windows Server 2019 Security Update (November 2024)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5046615");
