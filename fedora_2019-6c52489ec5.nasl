...
# extracted from Fedora Security Advisory FEDORA-2019-6c52489ec5.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : guacamole-server (2019-6c52489ec5)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-6c52489ec5");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"guacamole-server-1.0.0-1.fc28")) flag++;
