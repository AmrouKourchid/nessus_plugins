...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2022-A-0373-S");

  script_name(english:"Adobe Animate 21.x < 21.0.12 / 22.x < 22.0.8 Multiple Vulnerabilities (APSB22-54)");

  script_set_attribute(attribute:"synopsis", value:
"Adobe Animate installed on remote macOS or Mac OS X host is affected by multiple vulnerabilities");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Animate installed on the remote macOS or Mac OS X host is prior to 21.0.12 or 22.0.8. It is,
therefore, affected by multiple vulnerabilities as referenced in the apsb22-54 advisory.

  - Adobe Animate version 21.0.11 (and earlier) and 22.0.7 (and earlier) are affected by an out-of-bounds read
  ...
  - Adobe Animate version 21.0.11 (and earlier) and 22.0.7 (and earlier) are affected by a Heap-based Buffer
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://helpx.adobe.com/security/products/animate/apsb22-54.html");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Adobe Animate version 21.0.12 or 22.0.8 or later.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:N/UI:R/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-38412");
...
var constraints = [
  { 'min_version' : '21.0.0', 'fixed_version' : '21.0.12' },
  { 'min_version' : '22.0.0', 'fixed_version' : '22.0.8' }
];
