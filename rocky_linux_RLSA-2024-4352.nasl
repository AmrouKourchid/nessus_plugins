...
# Rocky Linux Security Advisory RLSA-2024:4352.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2024:4352");

  script_name(english:"Rocky Linux 8 : kernel-rt (RLSA-2024:4352)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Rocky Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Rocky Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
RLSA-2024:4352 advisory.
    ...
    * [rhel8.9][cxgb4]BUG: using smp_processor_id() in preemptible [00000000] code: ethtool/54735 (JIRA:Rocky
    Linux-8779)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2024:4352");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for RLSA-2024:4352');
  }
  else
  {
...
var pkgs = [
    ...
    {'reference':'kernel-rt-debug-debuginfo-4.18.0-553.8.1.rt7.349.el8_10', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'kernel-rt-debuginfo-4.18.0-553.8.1.rt7.349.el8_10', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kernel-rt-debuginfo-common-x86_64-4.18.0-553.8.1.rt7.349.el8_10', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
