...
if (description)
{
  ...
  script_cve_id("CVE-2017-2937");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2017-2937");
...
patch available.
  ...
  - Adobe Flash Player versions 24.0.0.186 and earlier have an exploitable use after free vulnerability in the
    ActionScript FileReference class, when using class inheritance. Successful exploitation could lead to
    arbitrary code execution. (CVE-2017-2937)
