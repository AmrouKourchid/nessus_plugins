...
# extracted from Fedora Security Advisory FEDORA-2024-633dc7e183
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-633dc7e183");

  script_name(english:"Fedora 38 : grub2 (2024-633dc7e183)");
...
FEDORA-2024-633dc7e183 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-633dc7e183");
...
var pkgs = [
    {'reference':'grub2-2.06-114.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
