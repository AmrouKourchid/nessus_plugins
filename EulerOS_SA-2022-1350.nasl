...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : ImageMagick (EulerOS-SA-2022-1350)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1350
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?62120773");
...
"Update the affected ImageMagick packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2019-19949");
...
var pkgs = [
  "ImageMagick-6.9.9.38-3.h22.eulerosv2r8",
  "ImageMagick-c++-6.9.9.38-3.h22.eulerosv2r8",
  "ImageMagick-libs-6.9.9.38-3.h22.eulerosv2r8",
  "ImageMagick-perl-6.9.9.38-3.h22.eulerosv2r8"
];
