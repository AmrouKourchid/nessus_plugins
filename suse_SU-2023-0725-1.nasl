...
# SUSE update advisory SUSE-SU-2023:0725-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2023-27530");
  script_xref(name:"SuSE", value:"SUSE-SU-2023:0725-1");

  script_name(english:"SUSE SLES15 / openSUSE 15 Security Update : rubygem-rack (SUSE-SU-2023:0725-1)");
...
referenced in the SUSE-SU-2023:0725-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1209095");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ab264900");
...
var pkgs = [
    {'reference':'ruby2.5-rubygem-rack-2.0.8-150000.3.15.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.4']},
    {'reference':'ruby2.5-rubygem-rack-doc-2.0.8-150000.3.15.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.4']},
    {'reference':'ruby2.5-rubygem-rack-testsuite-2.0.8-150000.3.15.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.4']},
    {'reference':'ruby2.5-rubygem-rack-2.0.8-150000.3.15.1', 'sp':'1', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-ha-release-15.1']},
    {'reference':'ruby2.5-rubygem-rack-2.0.8-150000.3.15.1', 'sp':'2', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-ha-release-15.2']},
    {'reference':'ruby2.5-rubygem-rack-2.0.8-150000.3.15.1', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-ha-release-15.3']},
    {'reference':'ruby2.5-rubygem-rack-2.0.8-150000.3.15.1', 'sp':'4', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-ha-release-15.4']}
];
