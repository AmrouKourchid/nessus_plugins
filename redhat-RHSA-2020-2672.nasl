...
# extracted from Red Hat Security Advisory RHSA-2020:2672. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:2672");

  script_name(english:"RHEL 8 : libexif (RHSA-2020:2672)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for libexif.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2020:2672 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_2672.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?41e07841");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:2672");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1840344");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libexif package based on the guidance in RHSA-2020:2672.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libexif-0.6.21-17.el8_1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libexif-devel-0.6.21-17.el8_1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
