...
if (description)
{
  ...
  script_cve_id("CVE-2019-13990", "CVE-2023-35116");
  script_xref(name:"CEA-ID", value:"CEA-2021-0004");

  script_name(english:"Oracle Identity Manager (Apr 2024 CPU)");
...
referenced in the April 2024 CPU advisory.
  ...
  - Vulnerability in the Oracle Identity Manager product of Oracle Fusion Middleware (component: Third Party
    (Quartz)). The supported version that is affected is 12.2.1.4.0. Easily exploitable vulnerability allows
    unauthenticated attacker with network access via HTTP to compromise Oracle Identity Manager. Successful
    attacks of this vulnerability can result in takeover of Oracle Identity Manager. (CVE-2019-13990)

  - Vulnerability in the Oracle Identity Manager product of Oracle Fusion Middleware (component: Third Party 
    (jackson-databind)). The supported version that is affected is 12.2.1.4.0. Difficult to exploit 
    vulnerability allows low privileged attacker with logon to the infrastructure where Oracle Identity 
    Manager executes to compromise Oracle Identity Manager. Successful attacks of this vulnerability can 
    result in unauthorized ability to cause a hang or frequently repeatable crash (complete DOS) of Oracle 
    Identity Manager. (CVE-2023-35116)
...
var constraints = [
  { 'min_version' : '12.2.1.4.0', 'fixed_version' : '12.2.1.4.240415' }
];
