...
# extracted from Fedora Security Advisory FEDORA-2024-ac1eb810c5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-ac1eb810c5");

  script_name(english:"Fedora 38 : chromium (2024-ac1eb810c5)");
...
FEDORA-2024-ac1eb810c5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-ac1eb810c5");
...
var pkgs = [
    {'reference':'chromium-122.0.6261.128-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
