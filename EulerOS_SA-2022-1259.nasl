...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : SDL (EulerOS-SA-2022-1259)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the SDL package installed, the EulerOS installation on the remote host is affected by the
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1259
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f10f3155");
...
"Update the affected SDL packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-7575");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:SDL-help");
...
var pkgs = [
  "SDL-help-1.2.15-38.h1.eulerosv2r10"
];
