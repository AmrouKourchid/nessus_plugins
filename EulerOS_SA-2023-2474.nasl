...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.0 : c-ares (EulerOS-SA-2023-2474)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2474
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?df97abcf");
...
var pkgs = [
  "c-ares-1.16.1-1.h4.eulerosv2r10"
];
