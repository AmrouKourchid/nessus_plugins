...
if (description)
{
  ...
  script_name(english:"CentOS 9 : yajl-2.1.0-21.el9");
...
yajl-2.1.0-21.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=18238");
