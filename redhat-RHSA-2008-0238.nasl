...
"The remote Red Hat host is missing a security update for kdegraphics.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2008/rhsa-2008_0238.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4a30d4ea");
  script_set_attribute(attribute:"see_also", value:"http://www.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=441722");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2008:0238");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL kdegraphics package based on the guidance in RHSA-2008:0238.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:R/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2008-1693");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'kdegraphics-3.3.1-9.el4_6', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'kdegraphics-3.3.1-9.el4_6', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'kdegraphics-3.3.1-9.el4_6', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'kdegraphics-3.3.1-9.el4_6', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'kdegraphics-3.3.1-9.el4_6', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'kdegraphics-devel-3.3.1-9.el4_6', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'kdegraphics-devel-3.3.1-9.el4_6', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'kdegraphics-devel-3.3.1-9.el4_6', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'kdegraphics-devel-3.3.1-9.el4_6', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'kdegraphics-devel-3.3.1-9.el4_6', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
    ]
  }
];
