...
if (description)
{
  ...
  script_xref(name:"APPLE-SA", value:"HT213675");
  script_xref(name:"IAVA", value:"2023-A-0162-S");

  script_name(english:"macOS 11.x < 11.7.5 Multiple Vulnerabilities (HT213675)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host is missing a macOS update that fixes multiple vulnerabilities");
  script_set_attribute(attribute:"description", value:
"The remote host is running a version of macOS / Mac OS X that is 11.x prior to 11.7.5. It is, therefore, affected by
multiple vulnerabilities:

  - A use after free issue was addressed with improved memory management. This issue is fixed in watchOS 8.6,
    tvOS 15.5, iOS 15.5 and iPadOS 15.5. An application may be able to execute arbitrary code with kernel
    privileges. (CVE-2022-26702)
...
version number.");
  script_set_attribute(attribute:"see_also", value:"https://support.apple.com/en-us/HT213675");
  script_set_attribute(attribute:"solution", value:
"Upgrade to macOS 11.7.5 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-26702");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2023-27953");
...
var constraints = [
  { 'fixed_version' : '11.7.5', 'min_version' : '11.0', 'fixed_display' : 'macOS Big Sur 11.7.5' }
];
