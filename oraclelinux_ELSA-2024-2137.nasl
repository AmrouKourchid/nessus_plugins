...
# extracted from Oracle Linux Security Advisory ELSA-2024-2137.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : LibRaw (ELSA-2024-2137)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-2137.html");
...
var pkgs = [
    {'reference':'LibRaw-0.21.1-1.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'LibRaw-devel-0.21.1-1.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'LibRaw-0.21.1-1.el9', 'cpu':'i686', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'LibRaw-devel-0.21.1-1.el9', 'cpu':'i686', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'LibRaw-0.21.1-1.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
