...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : qt (EulerOS-SA-2020-2298)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2298
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8d23a09a");
...
pkgs = ["qt-4.8.7-2.h7.eulerosv2r7",
        "qt-devel-4.8.7-2.h7.eulerosv2r7",
        "qt-mysql-4.8.7-2.h7.eulerosv2r7",
        "qt-odbc-4.8.7-2.h7.eulerosv2r7",
        "qt-postgresql-4.8.7-2.h7.eulerosv2r7",
        "qt-x11-4.8.7-2.h7.eulerosv2r7"];
