...
# Red Hat Security Advisory RHSA-2024:1494. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:1494");
  script_xref(name:"IAVA", value:"2024-A-0174-S");

  script_name(english:"CentOS 8 : thunderbird (CESA-2024:1494)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:1494");
...
var pkgs = [
    {'reference':'thunderbird-115.9.0-1.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'thunderbird-115.9.0-1.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
