...
if (description)
{
  ...
  script_name(english:"AIX (IJ42234)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AIX host is missing a security patch.");
  script_set_attribute(attribute:"description", value:
"The version of AIX installed on the remote host is prior to APAR IJ42234. It is, therefore, affected by a vulnerability
as referenced in the IJ42234 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/apar/IJ42234");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/node/6847917");
  script_set_attribute(attribute:"solution", value:
"Please apply the appropriate interim fix per APAR IJ42234.");
...
var constraints = [
    {'release': '7.3', 'ml': '00', 'sp': '01', 'patch': 'IJ42234m2a', 'package': 'bos.rte.install', 'minfilesetver': '7.3.0.0', 'maxfilesetver': '7.3.0.3'},
    {'release': '7.3', 'ml': '00', 'sp': '02', 'patch': 'IJ42234m2a', 'package': 'bos.rte.install', 'minfilesetver': '7.3.0.0', 'maxfilesetver': '7.3.0.3'}
];
