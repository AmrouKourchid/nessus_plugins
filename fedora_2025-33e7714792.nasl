...
# extracted from Fedora Security Advisory FEDORA-2025-33e7714792
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-33e7714792");

  script_name(english:"Fedora 40 : python3.13 (2025-33e7714792)");
...
FEDORA-2025-33e7714792 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-33e7714792");
...
var pkgs = [
    {'reference':'python3.13-3.13.2-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
