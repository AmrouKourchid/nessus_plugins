...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : nss (EulerOS-SA-2020-2100)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2100
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9f2a02af");
...
pkgs = ["nss-3.36.0-8.h3",
        "nss-devel-3.36.0-8.h3",
        "nss-sysinit-3.36.0-8.h3",
        "nss-tools-3.36.0-8.h3"];
