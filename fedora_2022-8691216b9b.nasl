...
# extracted from Fedora Security Advisory FEDORA-2022-8691216b9b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-8691216b9b");

  script_name(english:"Fedora 37 : pypy3.8 (2022-8691216b9b)");
...
FEDORA-2022-8691216b9b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-8691216b9b");
...
var pkgs = [
    {'reference':'pypy3.8-7.3.9-2.3.8.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
