...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : wireshark (ELSA-2010-0625)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2010-0625.html");
...
"Update the affected wireshark and / or wireshark-gnome packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2010-2995");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2010-2283");
...
var pkgs = [
    {'reference':'wireshark-1.0.15-1.0.1.el5_5.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'wireshark-gnome-1.0.15-1.0.1.el5_5.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'wireshark-1.0.15-1.0.1.el5_5.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'wireshark-gnome-1.0.15-1.0.1.el5_5.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
