...
# SUSE update advisory SUSE-SU-2022:3412-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:3412-1");

  script_name(english:"SUSE SLES12 / SLES15 Security Update : kernel (Live Patch 1 for SLE 15 SP4) (SUSE-SU-2022:3412-1)");
...
vulnerabilities as referenced in the SUSE-SU-2022:3412-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-September/012387.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?794d18aa");
  script_set_attribute(attribute:"solution", value:
"Update the affected kernel-livepatch-5_14_21-150400_24_11-default and / or kgraft-patch-4_12_14-122_127-default
packages.");
...
var pkgs = [
    {'reference':'kernel-livepatch-5_14_21-150400_24_11-default-3-150400.2.2', 'sp':'4', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.4']},
    {'reference':'kernel-livepatch-5_14_21-150400_24_11-default-3-150400.2.2', 'sp':'4', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.4', 'sle-module-live-patching-release-15.4', 'sles-release-15.4']},
    {'reference':'kgraft-patch-4_12_14-122_127-default-3-2.2', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.5']}
];
