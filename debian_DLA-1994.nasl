...
# extracted from Debian Security Advisory DLA-1994-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1994-1 : postgresql-common security update");
...
For the oldoldstable distribution (jessie), this problem has been
fixed in version 165+deb8u4.
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2019/11/msg00014.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/jessie/postgresql-common");
  # https://security-tracker.debian.org/tracker/source-package/postgresql-common
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1fbac7f5");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"postgresql-9.4", reference:"165+deb8u4")) flag++;
if (deb_check(release:"8.0", prefix:"postgresql-9.4-dbg", reference:"165+deb8u4")) flag++;
if (deb_check(release:"8.0", prefix:"postgresql-client-9.4", reference:"165+deb8u4")) flag++;
if (deb_check(release:"8.0", prefix:"postgresql-client-common", reference:"165+deb8u4")) flag++;
if (deb_check(release:"8.0", prefix:"postgresql-common", reference:"165+deb8u4")) flag++;
if (deb_check(release:"8.0", prefix:"postgresql-contrib-9.4", reference:"165+deb8u4")) flag++;
if (deb_check(release:"8.0", prefix:"postgresql-doc-9.4", reference:"165+deb8u4")) flag++;
if (deb_check(release:"8.0", prefix:"postgresql-server-dev-9.4", reference:"165+deb8u4")) flag++;
if (deb_check(release:"8.0", prefix:"postgresql-server-dev-all", reference:"165+deb8u4")) flag++;
