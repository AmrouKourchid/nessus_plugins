...
# extracted from Fedora Security Advisory FEDORA-2024-340a4bdc5d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-340a4bdc5d");

  script_name(english:"Fedora 41 : python3.12 (2024-340a4bdc5d)");
...
FEDORA-2024-340a4bdc5d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-340a4bdc5d");
...
var pkgs = [
    {'reference':'python3.12-3.12.8-2.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
