...
# extracted from Red Hat Security Advisory RHSA-2023:7265. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:7265");

  script_name(english:"RHEL 8 : open-vm-tools (RHSA-2023:7265)");
...
referenced in the RHSA-2023:7265 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_7265.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?58cc7b70");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:7265");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL open-vm-tools package based on the guidance in RHSA-2023:7265.");
