...
# extracted from Ubuntu Security Notice USN-6673-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6673-1");

  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS / 22.04 LTS / 23.10 : python-cryptography vulnerabilities (USN-6673-1)");
...
vulnerabilities as referenced in the USN-6673-1 advisory.
    ...
    possibly use this issue to cause python-cryptography to crash, leading to a denial of service. This issue
    only affected Ubuntu 23.10. (CVE-2024-26130)

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6673-1");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'python-cryptography', 'pkgver': '2.1.4-1ubuntu1.4+esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'python3-cryptography', 'pkgver': '2.1.4-1ubuntu1.4+esm1', 'ubuntu_pro': TRUE},
    {'osver': '20.04', 'pkgname': 'python-cryptography', 'pkgver': '2.8-3ubuntu0.3', 'ubuntu_pro': FALSE},
    {'osver': '20.04', 'pkgname': 'python3-cryptography', 'pkgver': '2.8-3ubuntu0.3', 'ubuntu_pro': FALSE},
    {'osver': '22.04', 'pkgname': 'python3-cryptography', 'pkgver': '3.4.8-1ubuntu2.2', 'ubuntu_pro': FALSE},
    {'osver': '23.10', 'pkgname': 'python3-cryptography', 'pkgver': '38.0.4-4ubuntu0.23.10.2', 'ubuntu_pro': FALSE}
];
