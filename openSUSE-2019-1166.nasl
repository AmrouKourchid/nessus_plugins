...
Security issue fixed :
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1130360");
...
if ( rpm_check(release:"SUSE15.0", reference:"znc-1.7.2-lp150.25.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"znc-debuginfo-1.7.2-lp150.25.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"znc-debugsource-1.7.2-lp150.25.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"znc-devel-1.7.2-lp150.25.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"znc-lang-1.7.2-lp150.25.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"znc-perl-1.7.2-lp150.25.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"znc-perl-debuginfo-1.7.2-lp150.25.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"znc-python3-1.7.2-lp150.25.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"znc-python3-debuginfo-1.7.2-lp150.25.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"znc-tcl-1.7.2-lp150.25.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"znc-tcl-debuginfo-1.7.2-lp150.25.1") ) flag++;
