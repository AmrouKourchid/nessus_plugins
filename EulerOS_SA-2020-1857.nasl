...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : irssi (EulerOS-SA-2020-1857)");
...
vulnerability :
  ...
  - Irssi before 1.0.8, 1.1.x before 1.1.3, and 1.2.x
    before 1.2.1, when SASL is enabled, has a use after
    free when sending SASL login to the
    server.(CVE-2019-13045)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1857
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8700b44d");
...
pkgs = ["irssi-1.1.1-3.h2.eulerosv2r8"];
