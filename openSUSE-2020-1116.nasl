...
# extracted from openSUSE Security Update openSUSE-2020-1116.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : claws-mail (openSUSE-2020-1116)");
...
if ( rpm_check(release:"SUSE15.1", reference:"claws-mail-3.17.3-lp151.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"claws-mail-debuginfo-3.17.3-lp151.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"claws-mail-debugsource-3.17.3-lp151.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"claws-mail-devel-3.17.3-lp151.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"claws-mail-lang-3.17.3-lp151.2.3.1") ) flag++;
