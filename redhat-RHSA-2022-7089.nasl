...
# extracted from Red Hat Security Advisory RHSA-2022:7089. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_7089.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7a26c43b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:7089");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2135610");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libksba package based on the guidance in RHSA-2022:7089.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libksba-1.3.5-8.el8_6', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libksba-devel-1.3.5-8.el8_6', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'libksba-1.3.5-8.el8_6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libksba-devel-1.3.5-8.el8_6', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
