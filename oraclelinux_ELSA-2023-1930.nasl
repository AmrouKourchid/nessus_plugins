...
# extracted from Oracle Linux Security Advisory ELSA-2023-1930.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : emacs (ELSA-2023-1930)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
ELSA-2023-1930 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-1930.html");
...
var pkgs = [
    ...
    {'reference':'emacs-filesystem-26.1-7.el8_7.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    ...
    {'reference':'emacs-terminal-26.1-7.el8_7.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    ...
    {'reference':'emacs-filesystem-26.1-7.el8_7.1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    ...
    {'reference':'emacs-terminal-26.1-7.el8_7.1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
