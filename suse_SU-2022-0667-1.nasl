...
"The remote SUSE Linux SLES12 / SLES15 / SLES_SAP12 / SLES_SAP15 host has packages installed that are affected by a
vulnerability as referenced in the SUSE-SU-2022:0667-1 advisory.
...
"Update the affected kernel-livepatch-4_12_14-150_78-default, kgraft-patch-4_12_14-95_77-default and / or kgraft-
patch-4_4_180-94_150-default packages.");
...
var pkgs = [
    {'reference':'kgraft-patch-4_4_180-94_150-default-5-2.1', 'sp':'3', 'cpu':'x86_64', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.3']},
    {'reference':'kernel-livepatch-4_12_14-150_78-default-4-2.1', 'sp':'0', 'cpu':'x86_64', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15']},
    {'reference':'kernel-livepatch-4_12_14-150_78-default-4-2.1', 'sp':'0', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15', 'sle-module-live-patching-release-15', 'sles-release-15']},
