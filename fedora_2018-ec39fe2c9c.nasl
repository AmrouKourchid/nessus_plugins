...
# extracted from Fedora Security Advisory FEDORA-2018-ec39fe2c9c.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : jasper (2018-ec39fe2c9c)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-ec39fe2c9c");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"jasper-2.0.14-5.fc28")) flag++;
