...
# extracted from Gentoo Linux Security Advisory GLSA 201909-02.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201909-02");

  script_name(english:"GLSA-201909-02 : VLC: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-201909-02
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/201909-02");
...
if (qpkg_check(package:"media-video/vlc", unaffected:make_list("ge 3.0.8"), vulnerable:make_list("lt 3.0.8"))) flag++;
