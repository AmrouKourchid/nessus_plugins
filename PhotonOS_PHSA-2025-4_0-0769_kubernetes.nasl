...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Kubernetes PHSA-2025-4.0-0769");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'kubernetes-1.27.16-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'kubernetes-kubeadm-1.27.16-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'kubernetes-pause-1.27.16-1.ph4')) flag++;
