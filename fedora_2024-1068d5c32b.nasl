...
# extracted from Fedora Security Advisory FEDORA-2024-1068d5c32b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-1068d5c32b");

  script_name(english:"Fedora 39 : podman-tui (2024-1068d5c32b)");
...
FEDORA-2024-1068d5c32b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-1068d5c32b");
...
var pkgs = [
    {'reference':'podman-tui-1.2.3-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
