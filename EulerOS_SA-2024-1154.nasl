...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : nginx (EulerOS-SA-2024-1154)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1154
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f8837c0e");
...
var pkgs = [
  "nginx-1.16.1-1.h5.eulerosv2r7",
  "nginx-all-modules-1.16.1-1.h5.eulerosv2r7",
  "nginx-filesystem-1.16.1-1.h5.eulerosv2r7",
  "nginx-mod-http-image-filter-1.16.1-1.h5.eulerosv2r7",
  "nginx-mod-http-perl-1.16.1-1.h5.eulerosv2r7",
  "nginx-mod-http-xslt-filter-1.16.1-1.h5.eulerosv2r7",
  "nginx-mod-mail-1.16.1-1.h5.eulerosv2r7",
  "nginx-mod-stream-1.16.1-1.h5.eulerosv2r7"
];
