...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : firefox on SL7.x x86_64 (20191023)");
...
Security Fix(es) :
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1910&L=SCIENTIFIC-LINUX-ERRATA&P=9553
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9dde1c4a");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"firefox-68.2.0-1.el7_7", allowmaj:TRUE)) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"firefox-debuginfo-68.2.0-1.el7_7", allowmaj:TRUE)) flag++;
