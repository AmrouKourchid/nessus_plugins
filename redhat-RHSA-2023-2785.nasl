...
# extracted from Red Hat Security Advisory RHSA-2023:2785. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:2785");

  script_name(english:"RHEL 8 : grafana-pcp (RHSA-2023:2785)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?01b78b20");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:2785");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL grafana-pcp package based on the guidance in RHSA-2023:2785.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'grafana-pcp-3.2.0-3.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
