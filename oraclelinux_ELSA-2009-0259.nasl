...
# extracted from Red Hat Security Advisory RHSA-2009:0259 and 
# Oracle Linux Security Advisory ELSA-2009-0259 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : mod_auth_mysql (ELSA-2009-0259)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2009-0259.html");
...
"Update the affected mod_auth_mysql package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2008-2384");
...
var pkgs = [
    {'reference':'mod_auth_mysql-3.0.0-3.2.el5_3', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'mod_auth_mysql-3.0.0-3.2.el5_3', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
