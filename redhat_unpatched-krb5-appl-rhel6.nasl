...
# extracted from Red Hat Security Advisory krb5-appl. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2019-25017", "CVE-2019-25018", "CVE-2022-39028");

  script_name(english:"RHEL 6 : krb5-appl (Unpatched Vulnerability) (deprecated)");
