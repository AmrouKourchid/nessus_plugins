...
# extracted from Fedora Security Advisory FEDORA-2023-fb5022e741
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-fb5022e741");

  script_name(english:"Fedora 36 : xorg-x11-server (2023-fb5022e741)");
...
FEDORA-2023-fb5022e741 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-fb5022e741");
...
var pkgs = [
    {'reference':'xorg-x11-server-1.20.14-18.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
