...
# extracted from VMware Security Advisory PHSA-2025-4.0-0757. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Openssh PHSA-2025-4.0-0757");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the openssh package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-757.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'openssh-8.9p1-9.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'openssh-clients-8.9p1-9.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'openssh-server-8.9p1-9.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'openssh-socket-8.9p1-9.ph4')) flag++;
