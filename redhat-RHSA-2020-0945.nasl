...
# extracted from Red Hat Security Advisory RHSA-2020:0945. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2020-1744");
  script_xref(name:"RHSA", value:"2020:0945");

  script_name(english:"RHEL 6 : Red Hat Single Sign-On 7.3.7 security update on RHEL 6 (Important) (RHSA-2020:0945)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for Red Hat Single Sign-On 7.3.7.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 6 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2020:0945 advisory.
    ...
    This release of Red Hat Single Sign-On 7.3.7 on RHEL 6 serves as a replacement for Red Hat Single Sign-On
    7.3.6, and includes bug fixes and enhancements, which are documented in the Release Notes document linked
    to in the References.

    Security Fix(es):

    * keycloak: failedLogin Event not sent to BruteForceProtector when using Post Login Flow with Conditional-
    OTP (CVE-2020-1744)
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_0945.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9fc45f06");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:0945");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1805792");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/KEYCLOAK-12379");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat Single Sign-On 7.3.7 package based on the guidance in RHSA-2020:0945.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:H/PR:N/UI:N/S:U/C:L/I:L/A:L");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-1744");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-sso7-keycloak-4.8.18-1.Final_redhat_00001.1.el6sso', 'release':'6', 'el_string':'el6sso', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-sso'},
      {'reference':'rh-sso7-keycloak-server-4.8.18-1.Final_redhat_00001.1.el6sso', 'release':'6', 'el_string':'el6sso', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-sso'}
    ]
  }
];
