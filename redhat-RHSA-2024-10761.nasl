...
# extracted from Red Hat Security Advisory RHSA-2024:10761. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:10761");

  script_name(english:"RHEL 9 : rhc-worker-playbook (RHSA-2024:10761)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for rhc-worker-playbook.");
...
referenced in the RHSA-2024:10761 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2214463");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2214473");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2230890");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_10761.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?422f863d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:10761");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rhc-worker-playbook package based on the guidance in RHSA-2024:10761.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rhc-worker-playbook");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rhc-worker-playbook-0.1.10-1.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'rhc-worker-playbook');
}
