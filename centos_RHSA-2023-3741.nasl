...
# extracted from Red Hat Security Advisory RHSA-2023:3741 and
# CentOS Errata and Security Advisory 2023:3741 respectively.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : c-ares (RHSA-2023:3741)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 7 host has packages installed that are affected by a vulnerability as referenced in the
RHSA-2023:3741 advisory.
...
var pkgs = [
    {'reference':'c-ares-1.10.0-3.el7_9.1', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'c-ares-1.10.0-3.el7_9.1', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'c-ares-devel-1.10.0-3.el7_9.1', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'c-ares-devel-1.10.0-3.el7_9.1', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE}
];
