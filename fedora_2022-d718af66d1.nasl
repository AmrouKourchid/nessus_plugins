...
# extracted from Fedora Security Advisory FEDORA-2022-d718af66d1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-d718af66d1");

  script_name(english:"Fedora 36 : kitty (2022-d718af66d1)");
...
FEDORA-2022-d718af66d1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-d718af66d1");
...
var pkgs = [
    {'reference':'kitty-0.26.3-2.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
