...
if (description)
{
  ...
  script_cve_id("CVE-2024-45280");
  script_xref(name:"IAVA", value:"2024-A-0551");

  script_name(english:"SAP NetWeaver AS Java XSS (3505503)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SAP NetWeaver application server is affected by a cross-site scripting vulnerability.");
  script_set_attribute(attribute:"description", value:
"Due to insufficient encoding of user-controlled inputs, SAP NetWeaver AS Java allows malicious scripts to be executed
in the login application. This has a limited impact on confidentiality and integrity of the application. There is no
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://me.sap.com/notes/3505503");
...
"Apply the appropriate patch according to the vendor advisory.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-45280");
