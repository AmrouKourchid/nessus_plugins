...
# extracted from Fedora Security Advisory FEDORA-2018-23a1b5975a.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : patch (2018-23a1b5975a)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-23a1b5975a");
...
flag = 0;
if (rpm_check(release:"FC27", reference:"patch-2.7.6-4.fc27")) flag++;
