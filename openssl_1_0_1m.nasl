...
"The version of OpenSSL installed on the remote host is prior to 1.0.1m. It is, therefore, affected by multiple
vulnerabilities as referenced in the 1.0.1m advisory.
...
"Upgrade to OpenSSL version 1.0.1m or later.");
...
var constraints = [
  { 'min_version' : '1.0.1', 'fixed_version' : '1.0.1m' }
];
