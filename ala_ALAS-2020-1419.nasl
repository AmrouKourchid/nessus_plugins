...
"The version of lynis installed on the remote host is prior to 3.0.0-1.17. It is, therefore, affected by multiple
vulnerabilities as referenced in the ALAS-2020-1419 advisory.
    ...
    additional scans. (CVE-2019-13033)For additional
    information:https://nvd.nist.gov/vuln/detail/cve-2019-13033
    ...
    used for additional attacks. (CVE-2020-13882)For additional
    information:https://nvd.nist.gov/vuln/detail/cve-2020-13882
...
var pkgs = [
    {'reference':'lynis-3.0.0-1.17.amzn1', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE}
];
