...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.6 : python-pillow (EulerOS-SA-2021-1421)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1421
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7dcfce5d");
...
pkgs = ["python-pillow-2.0.0-19.h9.gitd1c6db8.eulerosv2r7"];
