...
# extracted from Fedora Security Advisory FEDORA-2023-1ed0ec0035
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-1ed0ec0035");

  script_name(english:"Fedora 37 : open-vm-tools (2023-1ed0ec0035)");
...
FEDORA-2023-1ed0ec0035 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-1ed0ec0035");
...
var pkgs = [
    {'reference':'open-vm-tools-12.3.0-3.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
