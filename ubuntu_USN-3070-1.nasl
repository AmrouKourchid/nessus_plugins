...
# extracted from Ubuntu Security Notice USN-3070-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS : Linux kernel vulnerabilities (USN-3070-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3070-1");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-3070-1');
}
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-3070-1');
  }
  else
  {
