...
# extracted from Fedora Security Advisory FEDORA-2023-a6c1ad5860
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-a6c1ad5860");

  script_name(english:"Fedora 38 : golang (2023-a6c1ad5860)");
...
FEDORA-2023-a6c1ad5860 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-a6c1ad5860");
...
var pkgs = [
    {'reference':'golang-1.20.7-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
