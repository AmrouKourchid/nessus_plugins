...
# extracted from Red Hat Security Advisory RHSA-2023:1333. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:1333");
  script_xref(name:"IAVA", value:"2023-A-0132-S");

  script_name(english:"RHEL 7 : firefox (RHSA-2023:1333)");
...
referenced in the RHSA-2023:1333 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_1333.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?733b2bf9");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:1333");
...
"Update the RHEL firefox package based on the guidance in RHSA-2023:1333.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-102.9.0-3.el7_9', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-102.9.0-3.el7_9', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-102.9.0-3.el7_9', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-102.9.0-3.el7_9', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-102.9.0-3.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
