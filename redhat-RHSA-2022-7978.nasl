...
# extracted from Red Hat Security Advisory RHSA-2022:7978. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:7978");

  script_name(english:"RHEL 9 : gimp (RHSA-2022:7978)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for gimp.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2022:7978 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_7978.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8c324257");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:7978");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL gimp package based on the guidance in RHSA-2022:7978.");
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'gimp / gimp-libs');
}
