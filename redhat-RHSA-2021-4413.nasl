...
# extracted from Red Hat Security Advisory RHSA-2021:4413. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:4413");

  script_name(english:"RHEL 8 : tpm2-tools (RHSA-2021:4413)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for tpm2-tools.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_4413.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?00eac53a");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/8.5_release_notes/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7240878e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:4413");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1964427");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL tpm2-tools package based on the guidance in RHSA-2021:4413.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'tpm2-tools-4.1.1-5.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
