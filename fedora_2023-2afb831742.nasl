...
# extracted from Fedora Security Advisory FEDORA-2023-2afb831742
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-2afb831742");

  script_name(english:"Fedora 37 : opensc (2023-2afb831742)");
...
FEDORA-2023-2afb831742 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-2afb831742");
...
var pkgs = [
    {'reference':'opensc-0.23.0-5.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
