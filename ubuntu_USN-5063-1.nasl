...
# extracted from Ubuntu Security Notice USN-5063-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5063-1");
  script_xref(name:"IAVB", value:"2021-B-0056");

  script_name(english:"Ubuntu 20.04 LTS : HAProxy vulnerabilities (USN-5063-1)");
...
USN-5063-1 advisory.
    ...
    Ori Hollander discovered that HAProxy incorrectly handled HTTP header name length encoding. A remote
    attacker could possibly use this issue to inject a duplicate content-length header and perform request
    smuggling attacks.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5063-1");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'haproxy', 'pkgver': '2.0.13-2ubuntu0.3'},
    {'osver': '20.04', 'pkgname': 'vim-haproxy', 'pkgver': '2.0.13-2ubuntu0.3'}
];
