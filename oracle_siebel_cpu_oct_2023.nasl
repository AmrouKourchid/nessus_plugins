...
if (description)
{
  ...
  script_cve_id("CVE-2021-37533", "CVE-2023-1370");

  script_name(english:"Oracle Siebel Server (October 2023 CPU)");
...
the October 2023 CPU advisory.
  ...
  - Vulnerability in the Siebel CRM product of Oracle Siebel CRM (component: EAI - Open UI (JSON-java)).
    Supported versions that are affected are 23.8 and prior. Easily exploitable vulnerability allows
    ...
    DOS) of Siebel CRM. (CVE-2023-1370)

  - Vulnerability in the Siebel Apps product of Oracle Siebel CRM (component: Marketing (Apache Commons Net)).
    Supported versions that are affected are 23.8 and prior. Easily exploitable vulnerability allows
    unauthenticated attacker with network access via HTTP to compromise Siebel Apps. Successful attacks
    require human interaction from a person other than the attacker. Successful attacks of this vulnerability
    can result in unauthorized access to critical data or complete access to all Siebel Apps accessible data.
    (CVE-2021-37533)

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.oracle.com/docs/tech/security-alerts/cpuoct2023csaf.json");
