...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : nss (EulerOS-SA-2019-2467)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2467
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c03894b0");
...
pkgs = ["nss-3.36.0-7.h2",
        "nss-devel-3.36.0-7.h2",
        "nss-sysinit-3.36.0-7.h2",
        "nss-tools-3.36.0-7.h2"];
