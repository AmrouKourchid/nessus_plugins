...
# SUSE update advisory SUSE-SU-2024:0698-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2024:0698-1");

  script_name(english:"SUSE SLES12 / SLES15 Security Update : kernel (Live Patch 3 for SLE 15 SP5) (SUSE-SU-2024:0698-1)");
...
referenced in the SUSE-SU-2024:0698-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2024-February/018070.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?04c4155d");
...
"Update the affected kernel-livepatch-5_14_21-150500_55_19-default, kernel-livepatch-5_3_18-150300_59_115-default and /
or kgraft-patch-4_12_14-122_147-default packages.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-122.147-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_12_14-122_147-default-12-2.2', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.5']}
        ]
      },
      '5.14.21-150500.55.19-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_14_21-150500_55_19-default-6-150500.2.1', 'sp':'5', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.5']}
        ]
      },
      '5.3.18-150300.59.115-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_3_18-150300_59_115-default-11-150300.2.1', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.3']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kernel-livepatch-5_14_21-150500_55_19-default / etc');
}
