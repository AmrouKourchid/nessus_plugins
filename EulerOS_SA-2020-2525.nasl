...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : perl-DBI (EulerOS-SA-2020-2525)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2525
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?33059c9a");
...
pkgs = ["perl-DBI-1.641-5.h2.eulerosv2r8"];
