...
# extracted from Red Hat Security Advisory RHSA-2022:1781. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:1781");

  script_name(english:"RHEL 8 : grafana (RHSA-2022:1781)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_1781.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2b87b042");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/8.6_release_notes/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9341665d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:1781");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'grafana-7.5.11-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
