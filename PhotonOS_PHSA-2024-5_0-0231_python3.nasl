...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Python3 PHSA-2024-5.0-0231");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'python3-cryptography-41.0.7-3.ph5')) flag++;
