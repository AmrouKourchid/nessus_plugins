...
if (description)
{
  ...
  script_name(english:"VMware Fusion 13.0.x < 13.5.2 Multiple Vulnerabilities (VMSA-2024-0010)");
...
"The version of VMware Fusion installed on the remote macOS or Mac OS X host is 13.0.x prior to 13.5.2. It is, therefore,
...
"Update to VMware Fusion version 13.5.2, or later.");
...
var constraints = [
  { 'min_version' : '13.0', 'fixed_version' : '13.5.2' }
];
