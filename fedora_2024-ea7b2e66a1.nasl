...
# extracted from Fedora Security Advisory FEDORA-2024-ea7b2e66a1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-ea7b2e66a1");
  script_xref(name:"IAVA", value:"2024-A-0769-S");
  script_xref(name:"IAVA", value:"2025-A-0079-S");

  script_name(english:"Fedora 40 : firefox / nss (2024-ea7b2e66a1)");
...
FEDORA-2024-ea7b2e66a1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-ea7b2e66a1");
...
var pkgs = [
    {'reference':'firefox-133.0-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'nss-3.106.0-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
