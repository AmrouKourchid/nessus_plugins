...
# extracted from Fedora Security Advisory FEDORA-2024-ee96e0c470
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-ee96e0c470");

  script_name(english:"Fedora 40 : libvirt (2024-ee96e0c470)");
...
FEDORA-2024-ee96e0c470 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-ee96e0c470");
...
var pkgs = [
    {'reference':'libvirt-10.1.0-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
