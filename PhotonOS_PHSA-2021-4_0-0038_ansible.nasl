...
if (description)
{
  ...
  script_cve_id("CVE-2020-20178");

  script_name(english:"Photon OS 4.0: Ansible PHSA-2021-4.0-0038");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-20178");
...
if (rpm_check(release:'PhotonOS-4.0', reference:'ansible-2.9.22-1.ph4')) flag++;
