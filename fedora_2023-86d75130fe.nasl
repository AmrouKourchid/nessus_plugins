...
# extracted from Fedora Security Advisory FEDORA-2023-86d75130fe
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-86d75130fe");

  script_name(english:"Fedora 37 : yarnpkg (2023-86d75130fe)");
...
FEDORA-2023-86d75130fe advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-86d75130fe");
...
var pkgs = [
    {'reference':'yarnpkg-1.22.19-5.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
