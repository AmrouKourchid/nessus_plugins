...
# extracted from Amazon Linux 2 Security Advisory ALAS-2024-2645.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : amazon-ssm-agent (ALAS-2024-2645)");
...
multiple vulnerabilities as referenced in the ALAS2-2024-2645 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2024-2645.html");
...
var pkgs = [
    {'reference':'amazon-ssm-agent-3.3.859.0-1.amzn2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'amazon-ssm-agent-3.3.859.0-1.amzn2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
