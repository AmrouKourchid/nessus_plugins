...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : libxml2 (EulerOS-SA-2020-1768)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1768
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5a72f31b");
...
pkgs = ["libxml2-2.9.1-6.3.h24.eulerosv2r7",
        "libxml2-devel-2.9.1-6.3.h24.eulerosv2r7",
        "libxml2-python-2.9.1-6.3.h24.eulerosv2r7"];
