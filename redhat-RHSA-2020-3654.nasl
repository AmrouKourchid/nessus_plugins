...
# extracted from Red Hat Security Advisory RHSA-2020:3654. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:3654");

  script_name(english:"RHEL 8 : libcroco (RHSA-2020:3654)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for libcroco.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2020:3654 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_3654.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cf584c84");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:3654");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1835377");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libcroco package based on the guidance in RHSA-2020:3654.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libcroco-0.6.12-4.el8_2.1', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libcroco-devel-0.6.12-4.el8_2.1', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'libcroco-0.6.12-4.el8_2.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libcroco-devel-0.6.12-4.el8_2.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
