...
# extracted from Fedora Security Advisory FEDORA-2024-8abde32a6e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-8abde32a6e");

  script_name(english:"Fedora 39 : nano (2024-8abde32a6e)");
...
FEDORA-2024-8abde32a6e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-8abde32a6e");
...
var pkgs = [
    {'reference':'nano-7.2-5.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
