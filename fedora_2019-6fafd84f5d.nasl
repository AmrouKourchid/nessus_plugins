...
# extracted from Fedora Security Advisory FEDORA-2019-6fafd84f5d.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : python3 (2019-6fafd84f5d)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-6fafd84f5d");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"python3-3.6.8-2.fc28")) flag++;
