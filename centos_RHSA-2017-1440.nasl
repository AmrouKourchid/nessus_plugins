...
# CentOS Errata and Security Advisory 2017:1440 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 / 7 : firefox (CESA-2017:1440)");
...
(revskills) as the original reporters."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f0a115e6"
  );
  # https://lists.centos.org/pipermail/centos-announce/2017-June/022460.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8a2ad535"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"firefox-52.2.0-1.el6.centos", allowmaj:TRUE)) flag++;

if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"firefox-52.2.0-1.el7.centos", allowmaj:TRUE)) flag++;
