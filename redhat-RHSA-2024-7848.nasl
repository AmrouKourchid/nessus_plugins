...
# extracted from Red Hat Security Advisory RHSA-2024:7848. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:7848");

  script_name(english:"RHEL 8 : openssl (RHSA-2024:7848)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for openssl.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:7848 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_7848.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?12ca23b3");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:7848");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL openssl package based on the guidance in RHSA-2024:7848.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openssl-1.1.1k-14.el8_6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'openssl-devel-1.1.1k-14.el8_6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'openssl-libs-1.1.1k-14.el8_6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'openssl-perl-1.1.1k-14.el8_6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
