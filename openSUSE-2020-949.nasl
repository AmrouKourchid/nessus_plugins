...
# extracted from openSUSE Security Update openSUSE-2020-949.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : opera (openSUSE-2020-949)");
...
"This update for opera fixes the following issues :
  ...
  script_set_attribute(attribute:"see_also", value:"https://blogs.opera.com/desktop/changelog-for-69/");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1173251");
...
if ( rpm_check(release:"SUSE15.1", reference:"opera-69.0.3686.49-lp151.2.21.1") ) flag++;
