...
# extracted from Fedora Security Advisory FEDORA-2024-deddae25dd
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-deddae25dd");

  script_name(english:"Fedora 39 : editorconfig (2024-deddae25dd)");
...
FEDORA-2024-deddae25dd advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-deddae25dd");
...
var pkgs = [
    {'reference':'editorconfig-0.12.7-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
