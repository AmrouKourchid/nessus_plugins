...
# extracted from Red Hat Security Advisory RHSA-2005:569. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 4 : zlib (RHSA-2005:569)");
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2005/rhsa-2005_569.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3b8e6e1e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=162391");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2005:569");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL zlib package based on the guidance in RHSA-2005:569.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:N/UI:R/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2005-2096");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'zlib-1.2.1.2-1.1', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'zlib-1.2.1.2-1.1', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'zlib-1.2.1.2-1.1', 'cpu':'ppc64', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'zlib-1.2.1.2-1.1', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'zlib-1.2.1.2-1.1', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'zlib-1.2.1.2-1.1', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'zlib-devel-1.2.1.2-1.1', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'zlib-devel-1.2.1.2-1.1', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'zlib-devel-1.2.1.2-1.1', 'cpu':'ppc64', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'zlib-devel-1.2.1.2-1.1', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'zlib-devel-1.2.1.2-1.1', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'zlib-devel-1.2.1.2-1.1', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
