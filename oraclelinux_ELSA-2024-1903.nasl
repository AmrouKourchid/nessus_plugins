...
# extracted from Oracle Linux Security Advisory ELSA-2024-1903.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : shim (ELSA-2024-1903)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 9 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ELSA-2024-1903 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-1903.html");
...
var pkgs = [
    {'reference':'shim-aa64-15.8-1.0.3.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'shim-x64-15.8-1.0.3.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
