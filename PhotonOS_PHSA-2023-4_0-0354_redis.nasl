...
# extracted from VMware Security Advisory PHSA-2023-4.0-0354. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Redis PHSA-2023-4.0-0354");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the redis package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-354.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'redis-7.0.0-7.ph4')) flag++;
