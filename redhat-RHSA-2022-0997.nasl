...
# extracted from Red Hat Security Advisory RHSA-2022:0997. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:0997");
  script_xref(name:"IAVB", value:"2021-B-0047-S");

  script_name(english:"RHEL 8 : Red Hat OpenStack Platform 16.2 (golang-qpid-apache) (RHSA-2022:0997)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for Red Hat OpenStack Platform 16.2 (golang-qpid-apache).");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_0997.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?25086fb9");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:0997");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1992006");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat OpenStack Platform 16.2 (golang-qpid-apache) package based on the guidance in RHSA-2022:0997.");
