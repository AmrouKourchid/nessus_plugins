...
number.");
  # https://supportportal.juniper.net/s/article/2022-01-Security-Bulletin-Junos-OS-vMX-and-MX150-Specific-packets-might-cause-a-memory-leak-and-eventually-an-FPC-reboot-CVE-2022-22168
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5d5fc953");
...
var vuln_ranges = [
  {'min_ver':'0.0', 'fixed_ver':'19.2R1-S8', 'model':'^(MX150|vMX)'},
  {'min_ver':'19.2R2', 'fixed_ver':'19.2R3-S4', 'model':'^(MX150|vMX)'},
