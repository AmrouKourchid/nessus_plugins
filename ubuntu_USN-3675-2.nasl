...
in the USN-3675-2 advisory.

    USN-3675-1 fixed a vulnerability in GnuPG 2 for Ubuntu 18.04 LTS and Ubuntu 17.10. This update provides
    the corresponding update for GnuPG 2 in Ubuntu 16.04 LTS and Ubuntu 14.04 LTS.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3675-2");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'gnupg-agent', 'pkgver': '2.0.22-3ubuntu1.4'},
    {'osver': '14.04', 'pkgname': 'gnupg2', 'pkgver': '2.0.22-3ubuntu1.4'},
    {'osver': '14.04', 'pkgname': 'gpgsm', 'pkgver': '2.0.22-3ubuntu1.4'},
    {'osver': '14.04', 'pkgname': 'gpgv2', 'pkgver': '2.0.22-3ubuntu1.4'},
    {'osver': '14.04', 'pkgname': 'scdaemon', 'pkgver': '2.0.22-3ubuntu1.4'},
    {'osver': '16.04', 'pkgname': 'dirmngr', 'pkgver': '2.1.11-6ubuntu2.1'},
    {'osver': '16.04', 'pkgname': 'gnupg-agent', 'pkgver': '2.1.11-6ubuntu2.1'},
    {'osver': '16.04', 'pkgname': 'gnupg2', 'pkgver': '2.1.11-6ubuntu2.1'},
    {'osver': '16.04', 'pkgname': 'gpgsm', 'pkgver': '2.1.11-6ubuntu2.1'},
    {'osver': '16.04', 'pkgname': 'gpgv-udeb', 'pkgver': '2.1.11-6ubuntu2.1'},
    {'osver': '16.04', 'pkgname': 'gpgv2', 'pkgver': '2.1.11-6ubuntu2.1'},
    {'osver': '16.04', 'pkgname': 'scdaemon', 'pkgver': '2.1.11-6ubuntu2.1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'dirmngr / gnupg-agent / gnupg2 / gpgsm / gpgv-udeb / gpgv2 / etc');
}
