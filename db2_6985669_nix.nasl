...
if (description)
{
  ...
  script_name(english:"IBM DB2 10.5 < 10.5 FP 11 41270 / 11.1 < 11.1.4 FP 7 41268 / 11.5.7 < 11.5.7 FP 0 29113 / 11.5.8 < 11.5.8 FP 0 29133 DoS (Unix)");
...
var constraints = [
  {'equal':'10.5', 'fixed_build':'41270'},
  {'min_version':'10.5', 'fixed_version':'10.5.0.11', 'fixed_display':'10.5.0.11 + Special Build 41270'},
  {'equal':'11.1', 'fixed_build':'41268'},
  {'min_version':'11.1', 'fixed_version':'11.1.4.7', 'fixed_display':'11.1.4.7 + Special Build 41268'},
  {'equal':'11.5.7', 'fixed_build':'29113'},
  {'min_version':'11.5.7', 'max_version':'11.5.7.99999', 'fixed_build':'29113', 'fixed_display':'11.5.7 + Special Build 29113'},
  {'equal':'11.5.8', 'fixed_build':'29133'},
  {'min_version':'11.5.8', 'max_version':'11.5.8.99999', 'fixed_build':'29133', 'fixed_display':'11.5.8 + Special Build 29133'}
];
