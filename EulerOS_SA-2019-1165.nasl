...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.3 : wget (EulerOS-SA-2019-1165)");
...
following vulnerability :
  ...
  - A cookie injection flaw was found in wget. An attacker
    ...
    domains.i1/4^CVE-2018-0494i1/4%0

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1165
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?791735e5");
