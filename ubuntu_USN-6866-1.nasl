...
# extracted from Ubuntu Security Notice USN-6866-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6866-1");

  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS : Linux kernel vulnerabilities (USN-6866-1)");
...
referenced in the USN-6866-1 advisory.

    It was discovered that the ext4 file system implementation in the Linux kernel did not properly validate
    data state on write operations. An attacker could use this to construct a malicious ext4 file system image
    that, when mounted, could cause a denial of service (system crash). (CVE-2021-33631)
    ...
    - Netfilter; (CVE-2024-26642, CVE-2024-26922, CVE-2024-26720, CVE-2024-26736, CVE-2024-26898,
    CVE-2021-47063, CVE-2023-52615)

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6866-1");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.15.0-1132-oracle");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.15.0-1153-kvm");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.15.0-1163-gcp");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.15.0-1169-aws");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.15.0-226-generic");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.15.0-226-lowlatency");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-6866-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2021-33631', 'CVE-2021-47063', 'CVE-2023-6270', 'CVE-2023-52615', 'CVE-2024-2201', 'CVE-2024-23307', 'CVE-2024-24861', 'CVE-2024-26642', 'CVE-2024-26720', 'CVE-2024-26736', 'CVE-2024-26898', 'CVE-2024-26922');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-6866-1');
  }
  else
  {
