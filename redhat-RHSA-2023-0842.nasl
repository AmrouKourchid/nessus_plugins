...
# extracted from Red Hat Security Advisory RHSA-2023:0842. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:0842");

  script_name(english:"RHEL 8 : tar (RHSA-2023:0842)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_0842.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7f4581ac");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2149722");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:0842");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL tar package based on the guidance in RHSA-2023:0842.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'tar-1.30-6.el8_7.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
    ]
  }
];
