...
# extracted from Fedora Security Advisory FEDORA-2023-4706cef256
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-4706cef256");

  script_name(english:"Fedora 37 : sysstat (2023-4706cef256)");
...
FEDORA-2023-4706cef256 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-4706cef256");
...
var pkgs = [
    {'reference':'sysstat-12.6.2-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
