...
if (description)
{
  ...
  script_name(english:"CentOS 6 : freerdp (RHSA-2020:2406)");
...
var pkgs = [
    {'reference':'freerdp-1.0.2-7.el6_10', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'freerdp-devel-1.0.2-7.el6_10', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'freerdp-libs-1.0.2-7.el6_10', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'freerdp-plugins-1.0.2-7.el6_10', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE}
];
