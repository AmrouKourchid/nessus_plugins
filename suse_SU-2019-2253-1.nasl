...
# extracted from SUSE update advisory SUSE-SU-2019:2253-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLED15 / SLES15 Security Update : python-SQLAlchemy (SUSE-SU-2019:2253-1)");
...
without introducing additional issues.");
  ...
  # https://www.suse.com/support/update/announcement/2019/suse-su-20192253-1/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ff13e987");
...
SUSE-SLE-Module-Development-Tools-OBS-15-SP1-2019-2253=1

SUSE Linux Enterprise Module for Basesystem 15-SP1:zypper in -t patch
SUSE-SLE-Module-Basesystem-15-SP1-2019-2253=1");
...
if (rpm_check(release:"SLES15", sp:"1", reference:"python3-SQLAlchemy-1.2.14-6.3.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"python3-SQLAlchemy-debuginfo-1.2.14-6.3.1")) flag++;
...
if (rpm_check(release:"SLED15", sp:"1", reference:"python3-SQLAlchemy-1.2.14-6.3.1")) flag++;
if (rpm_check(release:"SLED15", sp:"1", reference:"python3-SQLAlchemy-debuginfo-1.2.14-6.3.1")) flag++;
