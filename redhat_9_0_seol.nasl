...
if (description)
{
  ...
  script_name(english:"Red Hat Enterprise Linux SEoL (9.0.x, 9.1.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Red Hat Enterprise Linux is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Red Hat Enterprise Linux is 9.0.x or 9.1.x. It is, therefore, no longer maintained by its 
vendor or provider.
...
var constraints = [
  { min_branch : '9.0', max_branch : '9.1', seol : 20240531, eseol : 20260531 }
];
