...
if (description)
{
  ...
  script_cve_id("CVE-2019-1010220");

  script_name(english:"Photon OS 3.0: Tcpdump PHSA-2019-3.0-0028");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'tcpdump-4.9.2-3.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'tcpdump-debuginfo-4.9.2-3.ph3')) flag++;
