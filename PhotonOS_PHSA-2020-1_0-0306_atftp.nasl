...
# extracted from VMware Security Advisory PHSA-2020-1.0-0306. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Atftp PHSA-2020-1.0-0306");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the atftp package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-1.0-306.md");
...
if (rpm_check(release:"PhotonOS-1.0", cpu:"x86_64", reference:"atftp-0.7.1-9.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", cpu:"x86_64", reference:"atftp-client-0.7.1-9.ph1")) flag++;
