...
# extracted from Fedora Security Advisory FEDORA-2023-401e38c388
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-401e38c388");

  script_name(english:"Fedora 38 : dotnet6.0 (2023-401e38c388)");
...
FEDORA-2023-401e38c388 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-401e38c388");
...
var pkgs = [
    {'reference':'dotnet6.0-6.0.118-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
