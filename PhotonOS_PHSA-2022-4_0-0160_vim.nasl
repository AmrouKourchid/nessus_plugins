...
if (description)
{
  ...
  script_cve_id("CVE-2022-0629", "CVE-2022-0685");

  script_name(english:"Photon OS 4.0: Vim PHSA-2022-4.0-0160");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'vim-8.2.3428-11.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'vim-extra-8.2.3428-11.ph4')) flag++;
