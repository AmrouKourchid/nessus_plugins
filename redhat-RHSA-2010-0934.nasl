...
# extracted from Red Hat Security Advisory RHSA-2010:0934. The text 
...
if (description)
{
  ...
  script_bugtraq_id(44504, 44638);
  script_xref(name:"RHSA", value:"2010:0934");

  script_name(english:"RHEL 6 : acroread (RHSA-2010:0934)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for acroread.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 6 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2010:0934 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2010/rhsa-2010_0934.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6e70dcde");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#critical");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=647525");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=651133");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2010:0934");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL acroread package based on the guidance in RHSA-2010:0934.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:H/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:N/UI:R/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:H/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2010-4091");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2010-3654");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'acroread-9.4.1-1.el6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'acroread-plugin-9.4.1-1.el6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
