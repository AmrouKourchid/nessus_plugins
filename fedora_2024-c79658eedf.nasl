...
# extracted from Fedora Security Advisory FEDORA-2024-c79658eedf
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-c79658eedf");

  script_name(english:"Fedora 38 : systemd (2024-c79658eedf)");
...
FEDORA-2024-c79658eedf advisory.

    - A bunch of fixes for various components: systemd, systemctl, hostnamectl, bootctl, systemd-networkd,
    systemd-network-generator, systemd-analyze, systemd-dissect, man pages.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-c79658eedf");
...
var pkgs = [
    {'reference':'systemd-253.15-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
