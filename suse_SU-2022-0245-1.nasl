...
# SUSE update advisory SUSE-SU-2022:0245-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2018-25020", "CVE-2021-0935");
  script_xref(name:"SuSE", value:"SUSE-SU-2022:0245-1");

  script_name(english:"SUSE SLES12 / SLES15 Security Update : kernel (Live Patch 23 for SLE 12 SP4) (SUSE-SU-2022:0245-1)");
...
referenced in the SUSE-SU-2022:0245-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-January/010141.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?483a9ff3");
  script_set_attribute(attribute:"solution", value:
"Update the affected kernel-livepatch-4_12_14-150_78-default and / or kgraft-patch-4_12_14-95_83-default packages.");
...
var pkgs = [
    {'reference':'kgraft-patch-4_12_14-95_83-default-2-2.2', 'sp':'4', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.4']},
    {'reference':'kernel-livepatch-4_12_14-150_78-default-2-2.2', 'sp':'0', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15']}
];
