...
if (description)
{
  ...
  script_cve_id("CVE-2024-42497", "CVE-2024-43780");
  script_xref(name:"IAVA", value:"2024-A-0522-S");

  script_name(english:"Mattermost Server 9.5.x < 9.5.8 / 9.8.x < 9.8.3 / 9.9.x < 9.9.2 / 9.10.x < 9.10.1 Multiple Vulnerabilities (MMSA-2024-00353/MMSA-2024-00357)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The version of Mattermost Server installed on the remote host is prior to 9.10.1, 9.5.8, 9.8.3, or 9.9.2. It is,
therefore, affected by multiple vulnerabilities as referenced in the MMSA-2024-00353 and MMSA-2024-00357 advisories.

  - Mattermost versions 9.9.x <= 9.9.1, 9.5.x <= 9.5.7, 9.10.x <= 9.10.0, 9.8.x <= 9.8.2 fail to properly
    enforce permissions which allows a user with systems manager role with read-only access to teams to
    perform write operations on teams. (CVE-2024-42497)

  - Mattermost versions 9.9.x <= 9.9.1, 9.5.x <= 9.5.7, 9.10.0, 9.8.x <= 9.8.2 fail to enforce permissions
    which allows a guest user with read access to upload files to a channel. (CVE-2024-43780)
...
"Upgrade to Mattermost Server version 9.5.8 / 9.8.3 / 9.9.2 / 9.10.1 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-42497");
