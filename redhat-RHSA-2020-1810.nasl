...
referenced in the RHSA-2020:1810 advisory.
    ...
    * sqlite: incorrect sqlite3WindowRewrite() error handling leads to mishandling certain parser-tree
    rewriting (CVE-2019-19924)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_1810.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c8d8a275");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1716881");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1788842");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1789595");
