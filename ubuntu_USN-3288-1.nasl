...
# extracted from Ubuntu Security Notice USN-3288-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : libytnef vulnerabilities (USN-3288-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 14.04 LTS host has packages installed that are affected by multiple vulnerabilities as referenced in
the USN-3288-1 advisory.

    It was discovered that libytnef incorrectly handled malformed TNEF streams. If a user were tricked into
    opening a specially crafted TNEF attachment, an attacker could cause a denial of service or possibly
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3288-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'libytnef0', 'pkgver': '1.5-6ubuntu0.1'},
    {'osver': '14.04', 'pkgname': 'libytnef0-dev', 'pkgver': '1.5-6ubuntu0.1'}
];
