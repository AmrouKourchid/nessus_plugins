...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"RHSA-2022:5234");

  script_name(english:"Scientific Linux Security Update : python-virtualenv on SL7.x (noarch) (2022:5234)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Scientific Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Scientific Linux 7 host has a package installed that is affected by a vulnerability as referenced in the
SLSA-2022:5234-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.scientificlinux.org/category/sl-errata/slsa-20225234-1");
...
"Update the affected python-virtualenv package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fermilab:scientific_linux:python-virtualenv");
...
var pkgs = [
    {'reference':'python-virtualenv-15.1.0-7.el7_9', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE}
];
