...
# SUSE update advisory SUSE-SU-2023:1930-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:1930-1");

  script_name(english:"SUSE SLES15 Security Update : dnsmasq (SUSE-SU-2023:1930-1)");
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-April/014536.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1fa5f7da");
...
var pkgs = [
    {'reference':'dnsmasq-2.86-150100.7.23.1', 'sp':'3', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_RT-release-15.3']}
];
