...
# extracted from openSUSE Security Update openSUSE-2020-1787.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : virt-bootstrap (openSUSE-2020-1787)");
...
This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1140750");
  script_set_attribute(attribute:"solution", value:
"Update the affected virt-bootstrap packages.");
...
if ( rpm_check(release:"SUSE15.2", reference:"python2-virt-bootstrap-1.0.0-lp152.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"python3-virt-bootstrap-1.0.0-lp152.5.3.1") ) flag++;
