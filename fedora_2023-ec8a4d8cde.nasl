...
# extracted from Fedora Security Advisory FEDORA-2023-ec8a4d8cde
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-ec8a4d8cde");

  script_name(english:"Fedora 39 : open-vm-tools (2023-ec8a4d8cde)");
...
FEDORA-2023-ec8a4d8cde advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-ec8a4d8cde");
  script_set_attribute(attribute:"solution", value:
"Update the affected open-vm-tools package.");
...
var pkgs = [
    {'reference':'open-vm-tools-12.3.0-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
