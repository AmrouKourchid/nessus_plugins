...
# extracted from Fedora Security Advisory FEDORA-2024-e6b5e38ae6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-e6b5e38ae6");

  script_name(english:"Fedora 40 : microcode_ctl (2024-e6b5e38ae6)");
...
FEDORA-2024-e6b5e38ae6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-e6b5e38ae6");
...
var pkgs = [
    {'reference':'microcode_ctl-2.1-61.3.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
