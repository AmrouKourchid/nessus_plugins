...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Libarchive PHSA-2023-4.0-0417");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libarchive-3.4.3-10.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libarchive-devel-3.4.3-10.ph4')) flag++;
