...
# AlmaLinux Security Advisory ALSA-2021:4161.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2021:4161");

  script_name(english:"AlmaLinux 8 : python-jinja2 (ALSA-2021:4161)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2021-4161.html");
