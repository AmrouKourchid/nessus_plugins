...
if (description)
{
  ...
  script_cve_id("CVE-2021-42949");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2021-42949");
...
patch available.
  ...
  - The component controlla_login function in HotelDruid Hotel Management Software v3.0.3 generates a
    predictable session token, allowing attackers to bypass authentication via bruteforce attacks.
    (CVE-2021-42949)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-42949");
