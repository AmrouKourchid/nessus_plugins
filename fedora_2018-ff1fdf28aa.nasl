...
# extracted from Fedora Security Advisory FEDORA-2018-ff1fdf28aa.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-ff1fdf28aa");

  script_name(english:"Fedora 29 : mosquitto (2018-ff1fdf28aa)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-ff1fdf28aa");
...
"Update the affected mosquitto package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-12543");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"mosquitto-1.5.3-1.fc29")) flag++;
