...
# extracted from Fedora Security Advisory FEDORA-2023-60cf98b7e6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-60cf98b7e6");

  script_name(english:"Fedora 38 : gdb (2023-60cf98b7e6)");
...
FEDORA-2023-60cf98b7e6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-60cf98b7e6");
...
var pkgs = [
    {'reference':'gdb-13.2-6.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
