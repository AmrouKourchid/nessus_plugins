...
if (description)
{
  ...
  script_name(english:"Adobe Digital Editions < 4.5.8 Multiple Information Disclosure (APSB18-13)");
...
"The version of Adobe Digital Editions installed on the remote Windows host is prior to 4.5.8. It is, therefore, affected
