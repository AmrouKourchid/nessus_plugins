...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS / 22.04 LTS : Exempi vulnerabilities (USN-5483-1)");
...
vulnerabilities as referenced in the USN-5483-1 advisory.
    ...
    tricked into opening a specially crafted file, a remote attacker could cause Exempi to stop responding or
