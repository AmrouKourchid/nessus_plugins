...
# extracted from Fedora Security Advisory FEDORA-2024-bf1c613d5a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-bf1c613d5a");

  script_name(english:"Fedora 40 : thunderbird (2024-bf1c613d5a)");
...
FEDORA-2024-bf1c613d5a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-bf1c613d5a");
...
var pkgs = [
    {'reference':'thunderbird-115.12.1-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
