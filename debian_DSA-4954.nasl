...
# extracted from Debian Security Advisory dsa-4954. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-4954-1 : c-ares - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dsa-4954
advisory. Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported
version number.");
  script_set_attribute(attribute:"see_also", value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=992053");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/c-ares");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2021/dsa-4954");
...
pkgs = [
    {'release': '10.0', 'prefix': 'libc-ares-dev', 'reference': '1.14.0-1+deb10u1'},
    {'release': '10.0', 'prefix': 'libc-ares2', 'reference': '1.14.0-1+deb10u1'}
];
