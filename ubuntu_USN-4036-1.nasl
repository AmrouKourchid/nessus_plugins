...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS : OpenStack Neutron vulnerability (USN-4036-1)");
...
USN-4036-1 advisory.
    ...
    Erik Olof Gunnar Andersson discovered that OpenStack Neutron incorrectly handled certain security group
    rules in the iptables firewall module. An authenticated attacker could possibly use this issue to block
    further application of security group rules for other instances.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4036-1");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:neutron-bgp-dragent");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'neutron-bgp-dragent', 'pkgver': '2:8.4.0-0ubuntu7.4'},
    {'osver': '16.04', 'pkgname': 'neutron-common', 'pkgver': '2:8.4.0-0ubuntu7.4'},
    {'osver': '16.04', 'pkgname': 'neutron-dhcp-agent', 'pkgver': '2:8.4.0-0ubuntu7.4'},
    {'osver': '16.04', 'pkgname': 'neutron-l3-agent', 'pkgver': '2:8.4.0-0ubuntu7.4'},
    {'osver': '16.04', 'pkgname': 'neutron-linuxbridge-agent', 'pkgver': '2:8.4.0-0ubuntu7.4'},
    {'osver': '16.04', 'pkgname': 'neutron-macvtap-agent', 'pkgver': '2:8.4.0-0ubuntu7.4'},
    {'osver': '16.04', 'pkgname': 'neutron-metadata-agent', 'pkgver': '2:8.4.0-0ubuntu7.4'},
    {'osver': '16.04', 'pkgname': 'neutron-metering-agent', 'pkgver': '2:8.4.0-0ubuntu7.4'},
    {'osver': '16.04', 'pkgname': 'neutron-openvswitch-agent', 'pkgver': '2:8.4.0-0ubuntu7.4'},
    {'osver': '16.04', 'pkgname': 'neutron-plugin-linuxbridge-agent', 'pkgver': '2:8.4.0-0ubuntu7.4'},
    {'osver': '16.04', 'pkgname': 'neutron-plugin-ml2', 'pkgver': '2:8.4.0-0ubuntu7.4'},
    {'osver': '16.04', 'pkgname': 'neutron-plugin-openvswitch-agent', 'pkgver': '2:8.4.0-0ubuntu7.4'},
    {'osver': '16.04', 'pkgname': 'neutron-plugin-sriov-agent', 'pkgver': '2:8.4.0-0ubuntu7.4'},
    {'osver': '16.04', 'pkgname': 'neutron-server', 'pkgver': '2:8.4.0-0ubuntu7.4'},
    {'osver': '16.04', 'pkgname': 'neutron-sriov-agent', 'pkgver': '2:8.4.0-0ubuntu7.4'},
    {'osver': '16.04', 'pkgname': 'python-neutron', 'pkgver': '2:8.4.0-0ubuntu7.4'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'neutron-bgp-dragent / neutron-common / neutron-dhcp-agent / etc');
}
