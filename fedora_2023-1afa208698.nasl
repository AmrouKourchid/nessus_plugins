...
# extracted from Fedora Security Advisory FEDORA-2023-1afa208698
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-1afa208698");

  script_name(english:"Fedora 39 : thunderbird (2023-1afa208698)");
...
FEDORA-2023-1afa208698 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-1afa208698");
...
var pkgs = [
    {'reference':'thunderbird-115.3.1-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
