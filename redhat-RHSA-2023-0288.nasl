...
# extracted from Red Hat Security Advisory RHSA-2023:0288. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:0288");

  script_name(english:"RHEL 8 : firefox (RHSA-2023:0288)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for firefox.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has a package installed that is affected by multiple vulnerabilities as
referenced in the RHSA-2023:0288 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_0288.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?80830161");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:0288");
...
"Update the RHEL firefox package based on the guidance in RHSA-2023:0288.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-102.7.0-1.el8_7', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
