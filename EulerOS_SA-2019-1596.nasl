...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : python-urllib3 (EulerOS-SA-2019-1596)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1596
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?be4d2875");
...
pkgs = ["python-urllib3-1.10.2-2.h1.eulerosv2r7"];
