...
if (description)
{
  ...
  script_cve_id("CVE-2022-0561");

  script_name(english:"Photon OS 3.0: Libtiff PHSA-2022-3.0-0374");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libtiff-4.1.0-4.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libtiff-devel-4.1.0-4.ph3')) flag++;
