...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP13 : openjpeg2 (EulerOS-SA-2025-1337)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1337
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?60264ed8");
...
var pkgs = [
  "openjpeg2-2.5.0-2.h1.eulerosv2r13"
];
