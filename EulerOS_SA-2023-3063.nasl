...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.1 : scipy (EulerOS-SA-2023-3063)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3063
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c4c43a57");
...
var pkgs = [
  "python3-scipy-1.6.2-1.h7.eulerosv2r11"
];
