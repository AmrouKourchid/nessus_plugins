...
# extracted from Oracle Linux Security Advisory ELSA-2023-6492.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : tang (ELSA-2023-6492)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-6492.html");
...
"Update the affected tang package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:tang");
...
var pkgs = [
    {'reference':'tang-14-2.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tang-14-2.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
