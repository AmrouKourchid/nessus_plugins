...
# extracted from Red Hat Security Advisory RHSA-2020:4547. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:4547");

  script_name(english:"RHEL 8 : libpcap (RHSA-2020:4547)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2020:4547 advisory.

    The libpcap packages provide a portable framework for low-level network monitoring. The libpcap library
    provides network statistics collection, security monitoring, and network debugging.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_4547.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f8b8df3b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:4547");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1760618");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1806422");
  script_set_attribute(attribute:"solution", value:
"Update the affected libpcap and / or libpcap-devel packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:libpcap-devel");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libpcap-1.9.1-4.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'14'},
      {'reference':'libpcap-devel-1.9.1-4.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'14'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libpcap / libpcap-devel');
}
