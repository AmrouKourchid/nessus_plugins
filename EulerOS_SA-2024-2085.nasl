...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : libarchive (EulerOS-SA-2024-2085)");
...
Tenable has extracted the preceding description block directly from the EulerOS libarchive security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2085
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8ad9acff");
...
var pkgs = [
  "libarchive-3.5.2-1.h5.eulerosv2r11"
];
