...
# extracted from Debian Security Advisory DLA-2163-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2163-1 : tinyproxy security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2020/03/msg00037.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/jessie/tinyproxy");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"tinyproxy", reference:"1.8.3-3+deb8u1")) flag++;
