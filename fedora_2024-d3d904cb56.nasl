...
# extracted from Fedora Security Advisory FEDORA-2024-d3d904cb56
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-d3d904cb56");

  script_name(english:"Fedora 41 : python3.11 (2024-d3d904cb56)");
...
FEDORA-2024-d3d904cb56 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-d3d904cb56");
...
var pkgs = [
    {'reference':'python3.11-3.11.9-5.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
