...
# extracted from Fedora Security Advisory FEDORA-2023-ba53233477
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-ba53233477");

  script_name(english:"Fedora 37 : java-latest-openjdk (2023-ba53233477)");
...
FEDORA-2023-ba53233477 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-ba53233477");
...
var pkgs = [
    {'reference':'java-latest-openjdk-20.0.2.0.9-1.rolling.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
