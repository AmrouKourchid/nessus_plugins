...
# extracted from Fedora Security Advisory FEDORA-2024-f249b74f03
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-f249b74f03");

  script_name(english:"Fedora 39 : python-aiohttp (2024-f249b74f03)");
...
FEDORA-2024-f249b74f03 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-f249b74f03");
...
var pkgs = [
    {'reference':'python-aiohttp-3.9.3-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
