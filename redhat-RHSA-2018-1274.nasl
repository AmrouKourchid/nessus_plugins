...
# extracted from Red Hat Security Advisory RHSA-2018:1274. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:1274");

  script_name(english:"RHEL 7 : python-paramiko (RHSA-2018:1274)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2018:1274 advisory.

  - python-paramiko: Authentication bypass in transport.py (CVE-2018-7750)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_1274.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8f4b8974");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:1274");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1557130");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1562393");
  script_set_attribute(attribute:"solution", value:
"Update the affected python-paramiko and / or python-paramiko-doc packages.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python-paramiko-2.1.1-4.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'},
      {'reference':'python-paramiko-doc-2.1.1-4.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'}
    ]
  }
];
