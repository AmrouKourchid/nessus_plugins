...
# extracted from Fedora Security Advisory FEDORA-2024-f7d6b76677
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-f7d6b76677");

  script_name(english:"Fedora 39 : python-virtualenv (2024-f7d6b76677)");
...
FEDORA-2024-f7d6b76677 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-f7d6b76677");
...
var pkgs = [
    {'reference':'python-virtualenv-20.21.1-25.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
