...
# extracted from Debian Security Advisory dla-2988. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2988-1 : tinyxml - LTS security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 9 host has packages installed that are affected by a vulnerability as referenced in the dla-2988
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2022/dla-2988");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2021-42260");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/stretch/tinyxml");
  script_set_attribute(attribute:"solution", value:
"Upgrade the tinyxml packages.
...
var pkgs = [
    {'release': '9.0', 'prefix': 'libtinyxml-dev', 'reference': '2.6.2-4+deb9u1'},
    {'release': '9.0', 'prefix': 'libtinyxml-doc', 'reference': '2.6.2-4+deb9u1'},
    {'release': '9.0', 'prefix': 'libtinyxml2.6.2v5', 'reference': '2.6.2-4+deb9u1'},
    {'release': '9.0', 'prefix': 'libtinyxml2.6.2v5-dbg', 'reference': '2.6.2-4+deb9u1'}
];
