...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : python3 (EulerOS-SA-2025-1010)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1010
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?83813463");
...
var pkgs = [
  "python3-3.7.9-9.h35.eulerosv2r10",
  "python3-fgo-3.7.9-9.h35.eulerosv2r10",
  "python3-unversioned-command-3.7.9-9.h35.eulerosv2r10"
];
