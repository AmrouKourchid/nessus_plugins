...
# SUSE update advisory SUSE-SU-2022:14896-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:14896-1");
  script_xref(name:"IAVA", value:"2022-A-0079-S");

  script_name(english:"SUSE SLES11 Security Update : MozillaFirefox (SUSE-SU-2022:14896-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote SUSE Linux SLES11 host has packages installed that are affected by multiple vulnerabilities as referenced in
the SUSE-SU-2022:14896-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-February/010301.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8b793ad3");
...
var pkgs = [
    {'reference':'MozillaFirefox-91.6.0-78.162.2', 'sp':'4', 'cpu':'x86_64', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE, 'exists_check':['sles-release-11.4']},
    {'reference':'MozillaFirefox-translations-common-91.6.0-78.162.2', 'sp':'4', 'cpu':'x86_64', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE, 'exists_check':['sles-release-11.4']},
    {'reference':'MozillaFirefox-translations-other-91.6.0-78.162.2', 'sp':'4', 'cpu':'x86_64', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE, 'exists_check':['sles-release-11.4']}
];
