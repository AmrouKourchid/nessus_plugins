...
# extracted from Red Hat Security Advisory RHSA-2020:2784. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:2784");
  script_xref(name:"CEA-ID", value:"CEA-2021-0004");

  script_name(english:"RHEL 6 / 7 : httpd24-nghttp2 (RHSA-2020:2784)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for httpd24-nghttp2.");
...
in the RHSA-2020:2784 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_2784.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?53ed51ae");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:2784");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1844929");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL httpd24-nghttp2 package based on the guidance in RHSA-2020:2784.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'httpd24-libnghttp2-1.7.1-8.el6.1', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'httpd24-libnghttp2-devel-1.7.1-8.el6.1', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'httpd24-nghttp2-1.7.1-8.el6.1', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'httpd24-libnghttp2-1.7.1-8.el7.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'httpd24-libnghttp2-devel-1.7.1-8.el7.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'httpd24-nghttp2-1.7.1-8.el7.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'httpd24-libnghttp2 / httpd24-libnghttp2-devel / httpd24-nghttp2');
}
