...
# extracted from Red Hat Security Advisory RHSA-2023:0838. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_0838.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fc67b982");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2154362");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:0838");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL samba package based on the guidance in RHSA-2023:0838.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ctdb-4.16.4-4.el8_7', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsmbclient-4.16.4-4.el8_7', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsmbclient-devel-4.16.4-4.el8_7', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libwbclient-4.16.4-4.el8_7', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libwbclient-devel-4.16.4-4.el8_7', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-samba-4.16.4-4.el8_7', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-samba-test-4.16.4-4.el8_7', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-4.16.4-4.el8_7', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-client-4.16.4-4.el8_7', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-client-libs-4.16.4-4.el8_7', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-common-4.16.4-4.el8_7', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-common-libs-4.16.4-4.el8_7', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-common-tools-4.16.4-4.el8_7', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-devel-4.16.4-4.el8_7', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-krb5-printing-4.16.4-4.el8_7', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-libs-4.16.4-4.el8_7', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-pidl-4.16.4-4.el8_7', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-test-4.16.4-4.el8_7', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-test-libs-4.16.4-4.el8_7', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-vfs-iouring-4.16.4-4.el8_7', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-winbind-4.16.4-4.el8_7', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-winbind-clients-4.16.4-4.el8_7', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-winbind-krb5-locator-4.16.4-4.el8_7', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-winbind-modules-4.16.4-4.el8_7', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
