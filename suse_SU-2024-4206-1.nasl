...
# SUSE update advisory SUSE-SU-2024:4206-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2024:4206-1");

  script_name(english:"SUSE SLES15 Security Update : kernel (Live Patch 9 for SLE 15 SP5) (SUSE-SU-2024:4206-1)");
...
the SUSE-SU-2024:4206-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2024-December/019926.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2871d8ad");
...
"Update the affected kernel-livepatch-5_14_21-150500_55_44-default package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:suse_linux:kernel-livepatch-5_14_21-150500_55_44-default");
...
var kernel_live_checks = [
  {
    'kernels': {
      '5.14.21-150500.55.44-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_14_21-150500_55_44-default-13-150500.2.1', 'sp':'5', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.5']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kernel-livepatch-5_14_21-150500_55_44-default');
}
