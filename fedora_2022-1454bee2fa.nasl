...
# extracted from Fedora Security Advisory FEDORA-2022-1454bee2fa
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-1454bee2fa");

  script_name(english:"Fedora 35 : thunderbird (2022-1454bee2fa)");
...
FEDORA-2022-1454bee2fa advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-1454bee2fa");
...
var pkgs = [
    {'reference':'thunderbird-102.3.1-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
