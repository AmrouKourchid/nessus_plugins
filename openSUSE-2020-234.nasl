...
# extracted from openSUSE Security Update openSUSE-2020-234.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : inn (openSUSE-2020-234)");
...
"This update for inn fixes the following issues :
  ...
  - CVE-2019-3692: Fixed a local privilage escalation from
    user to 'news' (bsc#1154302).");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1154302");
...
"Update the affected inn packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-3692");
...
if ( rpm_check(release:"SUSE15.1", reference:"inn-2.5.4-lp151.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"inn-debuginfo-2.5.4-lp151.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"inn-debugsource-2.5.4-lp151.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"inn-devel-2.5.4-lp151.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"mininews-2.5.4-lp151.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"mininews-debuginfo-2.5.4-lp151.3.3.1") ) flag++;
