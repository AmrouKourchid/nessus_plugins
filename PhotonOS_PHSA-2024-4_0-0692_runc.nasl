...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Runc PHSA-2024-4.0-0692");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'runc-1.1.14-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'runc-doc-1.1.14-1.ph4')) flag++;
