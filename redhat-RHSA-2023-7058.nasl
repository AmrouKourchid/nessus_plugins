...
# extracted from Red Hat Security Advisory RHSA-2023:7058. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:7058");

  script_name(english:"RHEL 8 : rhc (RHSA-2023:7058)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7883deb2");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2222782");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2223405");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2227014");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2227019");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2227141");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:7058");
  script_set_attribute(attribute:"solution", value:
"Update the affected rhc package.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rhc-0.2.4-3.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'rhc');
}
