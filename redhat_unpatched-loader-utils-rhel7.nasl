...
# extracted from Red Hat Security Advisory loader-utils. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2022-37599", "CVE-2022-37601", "CVE-2022-37603");

  script_name(english:"RHEL 7 : loader-utils (Unpatched Vulnerability) (deprecated)");
