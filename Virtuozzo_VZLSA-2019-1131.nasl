...
if (description)
{
  ...
  script_name(english:"Virtuozzo 7 : freeradius / freeradius-devel / freeradius-doc / etc (VZLSA-2019-1131)");
...
it as much as possible without introducing additional issues.");
  # http://repo.virtuozzo.com/vzlinux/announcements/json/VZLSA-2019-1131.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ff1b781e");
...
pkgs = ["freeradius-3.0.13-10.vl7",
        "freeradius-devel-3.0.13-10.vl7",
        "freeradius-doc-3.0.13-10.vl7",
        "freeradius-krb5-3.0.13-10.vl7",
        "freeradius-ldap-3.0.13-10.vl7",
        "freeradius-mysql-3.0.13-10.vl7",
        "freeradius-perl-3.0.13-10.vl7",
        "freeradius-postgresql-3.0.13-10.vl7",
        "freeradius-python-3.0.13-10.vl7",
        "freeradius-sqlite-3.0.13-10.vl7",
        "freeradius-unixODBC-3.0.13-10.vl7",
        "freeradius-utils-3.0.13-10.vl7"];
