...
FEDORA-2021-6e581c051a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-6e581c051a");
...
pkgs = [
    {'reference':'glibc-2.31-5.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE}
];
