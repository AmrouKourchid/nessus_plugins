...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Squashfs PHSA-2022-4.0-0166");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the squashfs package has been released.");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:vmware:photonos:squashfs");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'squashfs-tools-4.5.1-1.ph4')) flag++;
