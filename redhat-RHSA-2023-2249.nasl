...
# extracted from Red Hat Security Advisory RHSA-2023:2249. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:2249");

  script_name(english:"RHEL 9 : xorg-x11-server-Xwayland (RHSA-2023:2249)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for xorg-x11-server-Xwayland.");
...
referenced in the RHSA-2023:2249 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_2249.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5f3cb927");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:2249");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL xorg-x11-server-Xwayland packages based on the guidance in RHSA-2023:2249.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'xorg-x11-server-Xwayland-21.1.3-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
