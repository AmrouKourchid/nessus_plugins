...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : nghttp2 (EulerOS-SA-2024-1968)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1968
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9a345e49");
...
var pkgs = [
  "libnghttp2-1.39.2-3.h4.eulerosv2r9"
];
