...
if (description)
{
  ...
  script_name(english:"Mozilla Firefox ESR < 115.5.0");

  script_set_attribute(attribute:"synopsis", value:
"A web browser installed on the remote macOS or Mac OS X host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Firefox ESR installed on the remote macOS or Mac OS X host is prior to 115.5.0. It is, therefore,
affected by multiple vulnerabilities as referenced in the mfsa2023-50 advisory.
...
"Upgrade to Mozilla Firefox ESR version 115.5.0 or later.");
...
mozilla_check_version(version:version, path:path, product:'firefox', esr:TRUE, fix:'115.5.0', min:'115.0.0', severity:SECURITY_HOLE);
