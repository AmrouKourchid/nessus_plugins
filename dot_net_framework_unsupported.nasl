...
var app, installs, winver, arch, count, net_fw_eol, info, net35, install, ver, port, s, report;
...
# We need this for POSReady 2009 and Windows 10 Enterprise 2015 LTSC
var productname;
if (winver == "5.1")
...
if(!empty_or_null(productname) && ("LTSB" >< productname || "LTSC" >< productname))
  audit(AUDIT_HOST_NOT, 'affected since NET Framework on Windows 10 Enterprise LTSC 2015 is built in and will be supported through the end of support of the OS');
...
foreach install (installs[1])
{
  ...
  if (!isnull(net_fw_eol[ver]))
  {
    ...
    if (ver == '3.0' && net35 && !(now > 1862658061)) # future proof 3.5 eol to Jan 9 2029
      continue;
    # Skip .NET Framework 2.0 if it is installed as part of 3.5
    if (ver == '2.0.50727' && net35 && !(now > 1862658061)) # future proof 3.5 eol to Jan 9 2029
      continue;
