...
# extracted from Ubuntu Security Notice USN-3185-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"3185-1");

  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS : libXpm vulnerability (USN-3185-1)");
...
in the USN-3185-1 advisory.

    It was discovered that libXpm incorrectly handled certain XPM files. If a user or automated system were
    tricked into opening a specially crafted XPM file, a remote attacker could use this issue to cause libXpm
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3185-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'libxpm-dev', 'pkgver': '1:3.5.10-1ubuntu0.1'},
    {'osver': '14.04', 'pkgname': 'libxpm4', 'pkgver': '1:3.5.10-1ubuntu0.1'},
    {'osver': '14.04', 'pkgname': 'xpmutils', 'pkgver': '1:3.5.10-1ubuntu0.1'},
    {'osver': '16.04', 'pkgname': 'libxpm-dev', 'pkgver': '1:3.5.11-1ubuntu0.16.04.1'},
    {'osver': '16.04', 'pkgname': 'libxpm4', 'pkgver': '1:3.5.11-1ubuntu0.16.04.1'},
    {'osver': '16.04', 'pkgname': 'xpmutils', 'pkgver': '1:3.5.11-1ubuntu0.16.04.1'}
];
