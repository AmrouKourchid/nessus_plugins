...
if (description)
{
  ...
  script_cve_id("CVE-2024-36372");
  script_xref(name:"IAVA", value:"2024-A-0323-S");

  script_name(english:"TeamCity Server < 2023.5.6 XSS Vulnerability");

  script_set_attribute(attribute:"synopsis", value:
"The remote web server is affected by a XSS vulnerability.");
...
version prior to 2023.5.6 It is, therefore, affected by a reflected XSS on the subscriptions page is possible 

Note that Nessus did not actually test for these issues, but instead has relied on the version found in the server's 
banner.");
...
"Upgrade to JetBrains TeamCity version 2023.5.6 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:P/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:R/S:C/C:L/I:L/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-36372");
