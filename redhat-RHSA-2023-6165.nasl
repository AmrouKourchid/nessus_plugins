...
# extracted from Red Hat Security Advisory RHSA-2023:6165. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:6165");
  script_xref(name:"CEA-ID", value:"CEA-2024-0004");

  script_name(english:"RHEL 8 / 9 : skupper-cli and skupper-router (RHSA-2023:6165)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for skupper-cli / skupper-router.");
...
referenced in the RHSA-2023:6165 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6165.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1f24d69a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  # https://access.redhat.com/documentation/en-us/red_hat_service_interconnect/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b4adad89");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/SKUPPER-1252");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6165");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL skupper-cli / skupper-router packages based on the guidance in RHSA-2023:6165.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'skupper-cli-1.4.3-4.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'skupper-router-2.4.3-1.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'skupper-router-common-2.4.3-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'skupper-router-docs-2.4.3-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'skupper-router-tools-2.4.3-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'skupper-cli-1.4.3-4.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'skupper-router-2.4.3-1.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'skupper-router-common-2.4.3-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'skupper-router-docs-2.4.3-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'skupper-router-tools-2.4.3-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
