...
# extracted from Fedora Security Advisory FEDORA-2020-d14280a6e8.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-d14280a6e8");

  script_name(english:"Fedora 31 : mingw-gnutls (2020-d14280a6e8)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-d14280a6e8");
  script_set_attribute(attribute:"see_also", value:"https://lists.gnupg.org/pipermail/gnutls-help/2020-March/004642.html");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"mingw-gnutls-3.6.13-1.fc31")) flag++;
