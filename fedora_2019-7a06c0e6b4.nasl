...
# extracted from Fedora Security Advisory FEDORA-2019-7a06c0e6b4.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : gd (2019-7a06c0e6b4)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-7a06c0e6b4");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"gd-2.2.5-10.fc31")) flag++;
