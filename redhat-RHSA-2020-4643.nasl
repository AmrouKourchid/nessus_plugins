...
# extracted from Red Hat Security Advisory RHSA-2020:4643. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_4643.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1346baeb");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'poppler-0.66.0-27.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'poppler-cpp-0.66.0-27.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'poppler-cpp-devel-0.66.0-27.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'poppler-devel-0.66.0-27.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'poppler-glib-0.66.0-27.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'poppler-glib-devel-0.66.0-27.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'poppler-qt5-0.66.0-27.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'poppler-qt5-devel-0.66.0-27.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'poppler-utils-0.66.0-27.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
