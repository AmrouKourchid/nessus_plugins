...
# extracted from Amazon Linux 2 Security Advisory ALAS-2018-1075.
#
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : openssh (ALAS-2018-1075)");
...
auth2-gss.c, auth2-hostbased.c, and auth2-pubkey.c.(CVE-2018-15473)");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2018-1075.html");
...
flag = 0;
if (rpm_check(release:"AL2", reference:"openssh-7.4p1-16.amzn2.0.5")) flag++;
if (rpm_check(release:"AL2", reference:"openssh-askpass-7.4p1-16.amzn2.0.5")) flag++;
if (rpm_check(release:"AL2", reference:"openssh-cavs-7.4p1-16.amzn2.0.5")) flag++;
if (rpm_check(release:"AL2", reference:"openssh-clients-7.4p1-16.amzn2.0.5")) flag++;
if (rpm_check(release:"AL2", reference:"openssh-debuginfo-7.4p1-16.amzn2.0.5")) flag++;
if (rpm_check(release:"AL2", reference:"openssh-keycat-7.4p1-16.amzn2.0.5")) flag++;
if (rpm_check(release:"AL2", reference:"openssh-ldap-7.4p1-16.amzn2.0.5")) flag++;
if (rpm_check(release:"AL2", reference:"openssh-server-7.4p1-16.amzn2.0.5")) flag++;
if (rpm_check(release:"AL2", reference:"openssh-server-sysvinit-7.4p1-16.amzn2.0.5")) flag++;
if (rpm_check(release:"AL2", reference:"pam_ssh_agent_auth-0.10.3-2.16.amzn2.0.5")) flag++;
