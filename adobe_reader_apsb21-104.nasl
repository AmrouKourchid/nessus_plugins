...
if (description)
{
  ...
  script_name(english:"Adobe Reader < 17.011.30204 / 20.004.30017 / 21.007.20099 Multiple Vulnerabilities (APSB21-104)");
...
"The version of Adobe Reader installed on the remote Windows host is a version prior to 17.011.30204, 20.004.30017, or
...
var constraints = [
  ...
  { 'min_version' : '15.7', 'max_version' : '21.007.20095', 'fixed_version' : '21.007.20099', 'track' : 'DC Continuous' }
];
