...
referenced in the RHSA-2005:103 advisory.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2005/rhsa-2005_103.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fbd881bb");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=146739");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=146774");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2005:103");
...
"Update the RHEL perl package based on the guidance in RHSA-2005:103.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2005-0155");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'perl-5.8.5-12.1', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      {'reference':'perl-5.8.5-12.1', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      {'reference':'perl-5.8.5-12.1', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      {'reference':'perl-5.8.5-12.1', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      {'reference':'perl-5.8.5-12.1', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      {'reference':'perl-suidperl-5.8.5-12.1.1', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      {'reference':'perl-suidperl-5.8.5-12.1.1', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      {'reference':'perl-suidperl-5.8.5-12.1.1', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      {'reference':'perl-suidperl-5.8.5-12.1.1', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      {'reference':'perl-suidperl-5.8.5-12.1.1', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'}
    ]
  }
];
