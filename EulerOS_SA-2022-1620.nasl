...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.0 : edk2 (EulerOS-SA-2022-1620)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1620
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a428aecc");
...
var pkgs = [
  "edk2-aarch64-201903-2.9.1.2.49"
];
