...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.6.0 : libxml2 (EulerOS-SA-2021-1553)");
...
affected by the following vulnerability :
  ...
  - GNOME project libxml2 v2.9.10 has a global buffer
    over-read vulnerability in xmlEncodeEntitiesInternal at
    libxml2/entities.c. The issue has been fixed in commit
    50f06b3e.(CVE-2020-24977)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1553
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4701e4f7");
...
pkgs = ["libxml2-2.9.8-4.h13.eulerosv2r8",
        "libxml2-devel-2.9.8-4.h13.eulerosv2r8",
        "python2-libxml2-2.9.8-4.h13.eulerosv2r8"];
