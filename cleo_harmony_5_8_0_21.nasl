...
if (description)
{
  ...
  script_name(english:"Cleo Harmony < 5.8.0.21 Unrestricted File Upload/Download (CVE-2024-50623)");
...
"The version of Cleo Harmony running on the remote host is prior to 5.8.0.21. It is, therefore, affected by an
...
"Upgrade to Cleo Harmony version 5.8.0.21 or later.");
  ...
  script_set_attribute(attribute:"cpe", value:"x-cpe:/a:cleo:harmony");
  ...
  script_dependencies("cleo_harmony_detect.nbin");
  script_require_keys("installed_sw/Cleo Harmony");
