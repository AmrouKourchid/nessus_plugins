...
# extracted from Fedora Security Advisory FEDORA-2023-735ee6d4e1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-735ee6d4e1");

  script_name(english:"Fedora 39 : roundcubemail (2023-735ee6d4e1)");
...
FEDORA-2023-735ee6d4e1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-735ee6d4e1");
...
var pkgs = [
    {'reference':'roundcubemail-1.6.4-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
