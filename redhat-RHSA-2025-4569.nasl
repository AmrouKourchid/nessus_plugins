...
# extracted from Red Hat Security Advisory RHSA-2025:4569. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:4569");

  script_name(english:"RHEL 9 : osbuild-composer (RHSA-2025:4569)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_4569.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2f9e6494");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:4569");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL osbuild-composer package based on the guidance in RHSA-2025:4569.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'osbuild-composer-76.1-1.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'osbuild-composer-core-76.1-1.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'osbuild-composer-dnf-json-76.1-1.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'osbuild-composer-worker-76.1-1.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
