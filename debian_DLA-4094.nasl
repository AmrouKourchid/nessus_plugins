...
# extracted from Debian Security Advisory dla-4094. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2023-27043", "CVE-2025-2361");

  script_name(english:"Debian dla-4094 : mercurial - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bullseye/mercurial");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'mercurial', 'reference': '5.6.1-4+deb11u1'},
    {'release': '11.0', 'prefix': 'mercurial-common', 'reference': '5.6.1-4+deb11u1'}
];
