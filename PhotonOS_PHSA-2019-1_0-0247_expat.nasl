...
# extracted from VMware Security Advisory PHSA-2019-1.0-0247. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Expat PHSA-2019-1.0-0247");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the expat package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-1.0-247.md");
...
if (rpm_check(release:"PhotonOS-1.0", reference:"expat-2.2.4-2.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"expat-debuginfo-2.2.4-2.ph1")) flag++;
