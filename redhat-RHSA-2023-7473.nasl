...
if (description)
{
  ...
  script_name(english:"RHEL 8 / 9 : OpenShift Container Platform 4.14.4 (RHSA-2023:7473)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for OpenShift Container Platform 4.14.4.");
...
referenced in the RHSA-2023:7473 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.14.4. See the following
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_7473.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6c157a1d");
...
"Update the RHEL OpenShift Container Platform 4.14.4 packages based on the guidance in RHSA-2023:7473.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'haproxy26-2.6.13-2.rhaos4.14.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2023-40225']}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'python3-werkzeug-2.2.3-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2023-25577', 'CVE-2023-46136']}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'haproxy26 / python3-werkzeug');
}
