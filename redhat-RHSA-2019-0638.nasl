...
# extracted from Red Hat Security Advisory RHSA-2019:0638. The text 
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_0638.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c6fa1415");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:0638");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1667070");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL openwsman package based on the guidance in RHSA-2019:0638.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libwsman-devel-2.6.3-6.git4391e5c.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libwsman1-2.6.3-6.git4391e5c.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openwsman-client-2.6.3-6.git4391e5c.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openwsman-perl-2.6.3-6.git4391e5c.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openwsman-python-2.6.3-6.git4391e5c.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openwsman-ruby-2.6.3-6.git4391e5c.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openwsman-server-2.6.3-6.git4391e5c.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
