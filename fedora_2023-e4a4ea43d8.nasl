...
# extracted from Fedora Security Advisory FEDORA-2023-e4a4ea43d8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-e4a4ea43d8");

  script_name(english:"Fedora 38 : python-cairosvg (2023-e4a4ea43d8)");
...
FEDORA-2023-e4a4ea43d8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-e4a4ea43d8");
...
var pkgs = [
    {'reference':'python-cairosvg-2.7.0-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
