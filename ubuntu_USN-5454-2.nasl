...
# extracted from Ubuntu Security Notice USN-5454-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5454-2");

  script_name(english:"Ubuntu 16.04 ESM : CUPS vulnerabilities (USN-5454-2)");
...
the USN-5454-2 advisory.

    USN-5454-1 fixed several vulnerabilities in CUPS. This update provides the corresponding update for Ubuntu
    16.04 ESM.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5454-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'cups', 'pkgver': '2.1.3-4ubuntu0.11+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'cups-bsd', 'pkgver': '2.1.3-4ubuntu0.11+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'cups-client', 'pkgver': '2.1.3-4ubuntu0.11+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'cups-common', 'pkgver': '2.1.3-4ubuntu0.11+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'cups-core-drivers', 'pkgver': '2.1.3-4ubuntu0.11+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'cups-daemon', 'pkgver': '2.1.3-4ubuntu0.11+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'cups-ipp-utils', 'pkgver': '2.1.3-4ubuntu0.11+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'cups-ppdc', 'pkgver': '2.1.3-4ubuntu0.11+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'cups-server-common', 'pkgver': '2.1.3-4ubuntu0.11+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libcups2', 'pkgver': '2.1.3-4ubuntu0.11+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libcups2-dev', 'pkgver': '2.1.3-4ubuntu0.11+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libcupscgi1', 'pkgver': '2.1.3-4ubuntu0.11+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libcupscgi1-dev', 'pkgver': '2.1.3-4ubuntu0.11+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libcupsimage2', 'pkgver': '2.1.3-4ubuntu0.11+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libcupsimage2-dev', 'pkgver': '2.1.3-4ubuntu0.11+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libcupsmime1', 'pkgver': '2.1.3-4ubuntu0.11+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libcupsmime1-dev', 'pkgver': '2.1.3-4ubuntu0.11+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libcupsppdc1', 'pkgver': '2.1.3-4ubuntu0.11+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libcupsppdc1-dev', 'pkgver': '2.1.3-4ubuntu0.11+esm1', 'ubuntu_pro': TRUE}
];
