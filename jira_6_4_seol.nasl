...
if (description)
{
  ...
  script_name(english:"Atlassian JIRA SEoL (6.4.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Atlassian JIRA is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Atlassian JIRA is 6.4.x. It is, therefore, no longer maintained by its vendor or provider.
...
contain security vulnerabilities.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.atlassian.com/blog/2017/03/end-of-support-for-jira-6-4");
...
"Upgrade to a version of Atlassian JIRA that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2017/03/17");
...
var constraints = [
  { max_branch : '6.4', min_branch : '6.4', seol : 20170317 }
];
