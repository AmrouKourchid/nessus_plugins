...
# extracted from Red Hat Security Advisory ibm_jdk. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2019-17639");

  script_name(english:"RHEL 6 : ibm_jdk (Unpatched Vulnerability) (deprecated)");
...
"This plugin has been deprecated as it does not adhere to established standards for this style of check.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-17639");
