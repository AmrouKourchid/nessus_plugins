...
# extracted from Debian Security Advisory dla-3143. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3143 : charon-cmd - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3143
advisory.

    - -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3143-1                debian-lts@lists.debian.org
...
var pkgs = [
    {'release': '10.0', 'prefix': 'charon-cmd', 'reference': '5.7.2-1+deb10u3'},
    {'release': '10.0', 'prefix': 'charon-systemd', 'reference': '5.7.2-1+deb10u3'},
    {'release': '10.0', 'prefix': 'libcharon-extra-plugins', 'reference': '5.7.2-1+deb10u3'},
    {'release': '10.0', 'prefix': 'libstrongswan', 'reference': '5.7.2-1+deb10u3'},
    {'release': '10.0', 'prefix': 'libstrongswan-extra-plugins', 'reference': '5.7.2-1+deb10u3'},
    {'release': '10.0', 'prefix': 'libstrongswan-standard-plugins', 'reference': '5.7.2-1+deb10u3'},
    {'release': '10.0', 'prefix': 'strongswan', 'reference': '5.7.2-1+deb10u3'},
    {'release': '10.0', 'prefix': 'strongswan-charon', 'reference': '5.7.2-1+deb10u3'},
    {'release': '10.0', 'prefix': 'strongswan-libcharon', 'reference': '5.7.2-1+deb10u3'},
    {'release': '10.0', 'prefix': 'strongswan-nm', 'reference': '5.7.2-1+deb10u3'},
    {'release': '10.0', 'prefix': 'strongswan-pki', 'reference': '5.7.2-1+deb10u3'},
    {'release': '10.0', 'prefix': 'strongswan-scepclient', 'reference': '5.7.2-1+deb10u3'},
    {'release': '10.0', 'prefix': 'strongswan-starter', 'reference': '5.7.2-1+deb10u3'},
    {'release': '10.0', 'prefix': 'strongswan-swanctl', 'reference': '5.7.2-1+deb10u3'}
];
