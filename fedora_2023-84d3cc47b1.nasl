...
# extracted from Fedora Security Advisory FEDORA-2023-84d3cc47b1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-84d3cc47b1");

  script_name(english:"Fedora 38 : perl-Spreadsheet-ParseExcel (2023-84d3cc47b1)");
...
FEDORA-2023-84d3cc47b1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-84d3cc47b1");
...
var pkgs = [
    {'reference':'perl-Spreadsheet-ParseExcel-0.6600-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
