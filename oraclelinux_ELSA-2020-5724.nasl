...
# extracted from Oracle Linux Security Advisory ELSA-2020-5724.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : pcs (ELSA-2020-5724)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2020-5724.html");
...
var pkgs = [
    {'reference':'pcs-0.10.4-6.0.1.el8_2.1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
