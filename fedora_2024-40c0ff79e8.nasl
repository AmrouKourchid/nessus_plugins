...
# extracted from Fedora Security Advisory FEDORA-2024-40c0ff79e8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-40c0ff79e8");

  script_name(english:"Fedora 41 : gopass-hibp (2024-40c0ff79e8)");
...
FEDORA-2024-40c0ff79e8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-40c0ff79e8");
  script_set_attribute(attribute:"solution", value:
"Update the affected gopass-hibp package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:gopass-hibp");
...
var pkgs = [
    {'reference':'gopass-hibp-1.15.13-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'gopass-hibp');
}
