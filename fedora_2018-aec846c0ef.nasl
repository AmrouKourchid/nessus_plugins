...
# extracted from Fedora Security Advisory FEDORA-2018-aec846c0ef.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : xen (2018-aec846c0ef) (Spectre)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-aec846c0ef");
...
flag = 0;
if (rpm_check(release:"FC27", reference:"xen-4.9.2-4.fc27")) flag++;
