...
if (description)
{
  ...
  script_name(english:"Pulse Connect Secure < 9.1R16 Client Side Desync (SA45476)");

  script_set_attribute(attribute:"synopsis", value:
"A VPN server installed on the remote host is affected by a client side desync vulnerability.");
  script_set_attribute(attribute:"description", value:
"The Pulse Connect Secure installed on the remote host is prior to 9.1R16. It is, therefore, affected by 
client-side http request smuggling. When the application receives a POST request, it ignores the request's 
