...
# extracted from Fedora Security Advisory FEDORA-2023-562e77957f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-562e77957f");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2023/11/16");

  script_name(english:"Fedora 37 : roundcubemail (2023-562e77957f)");
...
FEDORA-2023-562e77957f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-562e77957f");
...
var pkgs = [
    {'reference':'roundcubemail-1.6.4-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
