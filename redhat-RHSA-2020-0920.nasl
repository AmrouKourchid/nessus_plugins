...
# extracted from Red Hat Security Advisory RHSA-2020:0920. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_0920.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3f2c3449");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:0920");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1811948");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libvncserver package based on the guidance in RHSA-2020:0920.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libvncserver-0.9.11-9.el8_1.2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvncserver-devel-0.9.11-9.el8_1.2', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'libvncserver-0.9.11-9.el8_1.2', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvncserver-devel-0.9.11-9.el8_1.2', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
