...
# extracted from Fedora Security Advisory FEDORA-2023-15c6e4be28
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-15c6e4be28");

  script_name(english:"Fedora 38 : mingw-binutils (2023-15c6e4be28)");
...
FEDORA-2023-15c6e4be28 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-15c6e4be28");
...
var pkgs = [
    {'reference':'mingw-binutils-2.39-6.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
