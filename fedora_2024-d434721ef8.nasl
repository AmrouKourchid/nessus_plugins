...
# extracted from Fedora Security Advisory FEDORA-2024-d434721ef8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-d434721ef8");

  script_name(english:"Fedora 40 : python3.9 (2024-d434721ef8)");
...
FEDORA-2024-d434721ef8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-d434721ef8");
...
var pkgs = [
    {'reference':'python3.9-3.9.19-5.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
