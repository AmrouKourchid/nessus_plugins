...
the RHSA-2012:1235 advisory.

  - qemu: VT100 emulation vulnerability (CVE-2012-3515)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2012/rhsa-2012_1235.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f08f42bf");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2012:1235");
...
"Update the RHEL kvm package based on the guidance in RHSA-2012:1235.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'kmod-kvm-83-249.el5_8.5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'kmod-kvm-debug-83-249.el5_8.5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'kvm-83-249.el5_8.5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'kvm-qemu-img-83-249.el5_8.5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'kvm-tools-83-249.el5_8.5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
