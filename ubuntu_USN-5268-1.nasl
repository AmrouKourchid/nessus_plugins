...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 ESM / 18.04 LTS : Linux kernel vulnerabilities (USN-5268-1)");
...
referenced in the USN-5268-1 advisory.
    ...
    Keyu Man discovered that the ICMP implementation in the Linux kernel did not properly handle received ICMP
    error packets. A remote attacker could use this to facilitate attacks on UDP based services that depend on
    source port randomization. (CVE-2021-20322)
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.15.0-1119-aws");
...
var kernel_mappings = {
  ...
  '18.04': {
    '4.15.0': {
      'generic': '4.15.0-167',
      'generic-lpae': '4.15.0-167',
      'lowlatency': '4.15.0-167',
      'dell300x': '4.15.0-1034',
      'oracle': '4.15.0-1086',
      'raspi2': '4.15.0-1102',
      'kvm': '4.15.0-1106',
      'gcp': '4.15.0-1115',
      'snapdragon': '4.15.0-1119'
    }
  }
};
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-5268-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2021-3640', 'CVE-2021-3752', 'CVE-2021-20322', 'CVE-2021-42739');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-5268-1');
  }
  else
  {
