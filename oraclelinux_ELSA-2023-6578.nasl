...
# extracted from Oracle Linux Security Advisory ELSA-2023-6578.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : libqb (ELSA-2023-6578)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-6578.html");
...
var pkgs = [
    {'reference':'libqb-2.0.6-4.el9_3', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libqb-2.0.6-4.el9_3', 'cpu':'i686', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libqb-2.0.6-4.el9_3', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
