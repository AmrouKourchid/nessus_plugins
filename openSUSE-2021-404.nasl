...
# extracted from openSUSE Security Update openSUSE-2021-404.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : wpa_supplicant (openSUSE-2021-404)");
...
"This update for wpa_supplicant fixes the following issues :
  ...
  - CVE-2021-27803: Fixed a P2P provision discovery
    processing vulnerability (bsc#1182805).

This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1182805");
...
if ( rpm_check(release:"SUSE15.2", reference:"wpa_supplicant-2.9-lp152.8.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"wpa_supplicant-debuginfo-2.9-lp152.8.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"wpa_supplicant-debugsource-2.9-lp152.8.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"wpa_supplicant-gui-2.9-lp152.8.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"wpa_supplicant-gui-debuginfo-2.9-lp152.8.9.1") ) flag++;
