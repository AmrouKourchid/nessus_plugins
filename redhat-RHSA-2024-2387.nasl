...
# extracted from Red Hat Security Advisory RHSA-2024:2387. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2023-6710", "CVE-2023-41081");
  script_xref(name:"RHSA", value:"2024:2387");

  script_name(english:"RHEL 9 : mod_jk and mod_proxy_cluster (RHSA-2024:2387)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for mod_jk / mod_proxy_cluster.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:2387 advisory.

    The mod_jk module is a plugin for the Apache HTTP Server to connect it with the Apache Tomcat servlet
    engine.

    The mod_proxy_cluster module is a plugin for the Apache HTTP Server that provides load-balancer
    functionality.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2387.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9d440b13");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2387");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-27497");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-27511");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL mod_jk / mod_proxy_cluster packages based on the guidance in RHSA-2024:2387.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:mod_proxy_cluster");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'mod_jk-1.2.49-1.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2023-41081']},
      {'reference':'mod_proxy_cluster-1.3.20-1.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2023-6710']}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'mod_jk / mod_proxy_cluster');
}
