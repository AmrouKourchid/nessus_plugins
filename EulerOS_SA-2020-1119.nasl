...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : nginx (EulerOS-SA-2020-1119)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1119
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?18166a23");
...
pkgs = ["nginx-1.16.1-1.h2.eulerosv2r7",
        "nginx-all-modules-1.16.1-1.h2.eulerosv2r7",
        "nginx-filesystem-1.16.1-1.h2.eulerosv2r7",
        "nginx-mod-http-image-filter-1.16.1-1.h2.eulerosv2r7",
        "nginx-mod-http-perl-1.16.1-1.h2.eulerosv2r7",
        "nginx-mod-http-xslt-filter-1.16.1-1.h2.eulerosv2r7",
        "nginx-mod-mail-1.16.1-1.h2.eulerosv2r7",
        "nginx-mod-stream-1.16.1-1.h2.eulerosv2r7"];
