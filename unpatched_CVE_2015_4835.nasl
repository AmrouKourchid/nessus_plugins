...
if (description)
{
  ...
  script_cve_id("CVE-2015-4835");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2015-4835");
...
patch available.
  ...
  - Unspecified vulnerability in Oracle Java SE 6u101, 7u85, and 8u60, and Java SE Embedded 8u51, allows
    remote attackers to affect confidentiality, integrity, and availability via vectors related to CORBA, a
    different vulnerability than CVE-2015-4881. (CVE-2015-4835)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-4835");
