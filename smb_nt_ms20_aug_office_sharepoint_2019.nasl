...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"4484472");
  script_xref(name:"MSKB", value:"4484471");
  script_xref(name:"MSFT", value:"MS20-4484472");
  script_xref(name:"MSFT", value:"MS20-4484471");
  script_xref(name:"IAVA", value:"2020-A-0362-S");
  script_xref(name:"CEA-ID", value:"CEA-2020-0101");

  script_name(english:"Security Updates for Microsoft SharePoint Server 2019 (August 2020)");
...
by multiple vulnerabilities :
  ...
  # https://support.microsoft.com/en-us/help/4484471/security-update-for-sharepoint-2019-language-pack-august-11-2020
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?55eb4a06");
  ...
  # https://support.microsoft.com/en-us/help/4484487/security-update-for-sharepoint-foundation-2013-august-11-2020
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b6ff0da5");
  # https://support.microsoft.com/en-us/help/4484183/security-update-for-sharepoint-server-2013-august-11-2020
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8443c5e0");
  ...
  # https://support.microsoft.com/en-us/help/4484478/security-update-for-sharepoint-server-2013-august-11-2020
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f0f826c9");
  # https://support.microsoft.com/en-us/help/4484479/security-update-for-sharepoint-server-2013-august-11-2020
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4d30e628");
  ...
  # https://support.microsoft.com/en-us/help/4484472/security-update-for-sharepoint-server-2019-august-11-2020
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4904afa5");
  # https://support.microsoft.com/en-us/help/4484473/security-update-for-sharepoint-server-2016-august-11-2020
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ebf92078");
  # https://support.microsoft.com/en-us/help/4484471/security-update-for-sharepoint-2019-language-pack-august-11-2020
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?55eb4a06");
...
"Microsoft has released security updates for Microsoft SharePoint Server.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2020-1503");
...
foreach check (param_list)
{
  ...
  if (are_we_vuln != HCF_OK && check['kb'] == '4484471')
  {
    report = '\n';
    if (check['product_name'])
      report += '  Product : ' + check['product_name'] + '\n';
