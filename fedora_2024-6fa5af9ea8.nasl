...
# extracted from Fedora Security Advisory FEDORA-2024-6fa5af9ea8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-6fa5af9ea8");

  script_name(english:"Fedora 38 : sudo (2024-6fa5af9ea8)");
...
FEDORA-2024-6fa5af9ea8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-6fa5af9ea8");
...
var pkgs = [
    {'reference':'sudo-1.9.15-1.p5.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
