...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : spice-gtk (EulerOS-SA-2018-1355)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1355
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1d51fd9e");
...
pkgs = ["spice-glib-0.34-3.2.h1",
        "spice-gtk3-0.34-3.2.h1"];
