...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : java-1.8.0-openjdk (EulerOS-SA-2022-1733)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1733
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3d44885a");
...
var pkgs = [
  "java-1.8.0-openjdk-1.8.0.191.b12-0.h20",
  "java-1.8.0-openjdk-devel-1.8.0.191.b12-0.h20",
  "java-1.8.0-openjdk-headless-1.8.0.191.b12-0.h20"
];
