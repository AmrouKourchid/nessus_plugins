...
# extracted from Red Hat Security Advisory RHSA-2018:0505. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:0505");

  script_name(english:"RHEL 7 : mailman (RHSA-2018:0505)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2018/rhsa-2018_0505.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?554f336d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:0505");
...
"Update the RHEL mailman package based on the guidance in RHSA-2018:0505.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'mailman-2.1.15-26.el7_4.1', 'release':'7', 'el_string':'el7_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'}
    ]
  }
];
