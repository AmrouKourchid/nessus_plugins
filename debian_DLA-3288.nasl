...
if (description)
{
  ...
  script_name(english:"Debian dla-3288 : curl - security update");
...
dla-3288 advisory.
    ...
    -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3288-1                debian-lts@lists.debian.org
    ...
    CVE ID         : CVE-2022-27774 CVE-2022-32221 CVE-2022-35252 CVE-2022-43552
    Debian Bug     :
