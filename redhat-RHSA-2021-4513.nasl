...
"The remote Red Hat host is missing one or more security updates for libsepol.");
...
referenced in the RHSA-2021:4513 advisory.
    ...
    checkpolicy (the policy compiler) and similar tools, as well as by programs like load_policy that need to
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_4513.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0497e78f");
...
"Update the RHEL libsepol package based on the guidance in RHSA-2021:4513.");
