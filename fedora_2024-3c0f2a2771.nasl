...
# extracted from Fedora Security Advisory FEDORA-2024-3c0f2a2771
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-3c0f2a2771");
  script_xref(name:"IAVB", value:"2024-B-0075");

  script_name(english:"Fedora 39 : mod_auth_openidc (2024-3c0f2a2771)");
...
FEDORA-2024-3c0f2a2771 advisory.

    fix CVE-2024-24814: prevent DoS when OIDCSessionType client-cookie is set and a crafted Cookie header is
    supplied
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-3c0f2a2771");
...
"Update the affected mod_auth_openidc package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:mod_auth_openidc");
...
var pkgs = [
    {'reference':'mod_auth_openidc-2.4.15.3-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
