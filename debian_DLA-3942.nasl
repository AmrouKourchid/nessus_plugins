...
# extracted from Debian Security Advisory dla-3942. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3942 : libcrypto1.1-udeb - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-5678");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-0727");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-2511");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-4741");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-5535");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-9143");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bullseye/openssl");
  script_set_attribute(attribute:"solution", value:
"Upgrade the libcrypto1.1-udeb packages.");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'libcrypto1.1-udeb', 'reference': '1.1.1n-0+deb11u6'},
    {'release': '11.0', 'prefix': 'libssl-dev', 'reference': '1.1.1n-0+deb11u6'},
    {'release': '11.0', 'prefix': 'libssl-doc', 'reference': '1.1.1n-0+deb11u6'},
    {'release': '11.0', 'prefix': 'libssl1.1', 'reference': '1.1.1n-0+deb11u6'},
    {'release': '11.0', 'prefix': 'libssl1.1-udeb', 'reference': '1.1.1n-0+deb11u6'},
    {'release': '11.0', 'prefix': 'openssl', 'reference': '1.1.1n-0+deb11u6'}
];
