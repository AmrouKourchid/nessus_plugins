...
# extracted from Red Hat Security Advisory RHSA-2024:4352. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:4352");

  script_name(english:"RHEL 8 : kernel-rt (RHSA-2024:4352)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for kernel-rt.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:4352 advisory.
    ...
    * [rhel8.9][cxgb4]BUG: using smp_processor_id() in preemptible [00000000] code: ethtool/54735
    (JIRA:RHEL-8779)
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_4352.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c9852f9f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:4352");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL kernel-rt package based on the guidance in RHSA-2024:4352.");
  ...
  script_cwe_id(15, 20, 99, 125, 362, 369, 391, 393, 400, 401, 402, 415, 416, 476, 755, 805, 833);
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for RHSA-2024:4352');
  }
  else
  {
