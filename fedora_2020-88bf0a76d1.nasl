...
# extracted from Fedora Security Advisory FEDORA-2020-88bf0a76d1.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : chromium (2020-88bf0a76d1)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-88bf0a76d1");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"chromium-85.0.4183.83-1.fc31", allowmaj:TRUE)) flag++;
