...
advisory.
    ...
    https://www.postgresql.org/support/security/CVE-2022-1552// For the stable distribution (bullseye), this
    problem has been fixed in version 13.7-0+deb11u1. We recommend that you upgrade your postgresql-13
    packages. For the detailed security status of postgresql-13 please refer to its security tracker page at:
