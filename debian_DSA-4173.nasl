...
spreadsheet is processed.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?252fc870");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/stretch/r-cran-readxl");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2018/dsa-4173");
...
in version 0.1.1-1+deb9u1.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-2919");
