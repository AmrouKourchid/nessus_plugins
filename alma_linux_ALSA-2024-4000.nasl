...
# AlmaLinux Security Advisory ALSA-2024:4000.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:4000");
  script_xref(name:"IAVB", value:"2024-B-0074-S");

  script_name(english:"AlmaLinux 8 : ghostscript (ALSA-2024:4000)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 8 host has packages installed that are affected by a vulnerability as referenced in the
ALSA-2024:4000 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2024-4000.html");
