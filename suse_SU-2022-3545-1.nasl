...
# SUSE update advisory SUSE-SU-2022:3545-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:3545-1");

  script_name(english:"SUSE SLES15 Security Update : python-PyJWT (SUSE-SU-2022:3545-1)");
...
in the SUSE-SU-2022:3545-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-October/012512.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ebaa87e7");
...
var pkgs = [
    {'reference':'python3-PyJWT-1.5.3-150000.3.3.1', 'sp':'0', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15']},
    {'reference':'python3-PyJWT-1.5.3-150000.3.3.1', 'sp':'0', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15', 'sle-module-public-cloud-release-15', 'sles-release-15']}
];
