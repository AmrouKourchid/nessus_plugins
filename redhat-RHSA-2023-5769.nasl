...
# extracted from Red Hat Security Advisory RHSA-2023:5769. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_5769.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2f7d6d9a");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:5769");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL nghttp2 package based on the guidance in RHSA-2023:5769.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libnghttp2-1.33.0-4.el8_6.1', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libnghttp2-devel-1.33.0-4.el8_6.1', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nghttp2-1.33.0-4.el8_6.1', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
