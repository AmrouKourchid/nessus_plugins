...
# extracted from openSUSE Security Update openSUSE-2020-661.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : mailman (openSUSE-2020-661)");
...
Security issue fixed :
  ...
  - CVE-2020-12108: Fixed a content injection bug
    (boo#1171363).
...
Non-security issue fixed :
  ...
  - Don't default to invalid hosts for DEFAULT_EMAIL_HOST
    (boo#682920)");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1171363");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=682920");
...
if ( rpm_check(release:"SUSE15.1", reference:"mailman-2.1.29-lp151.3.11.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"mailman-debuginfo-2.1.29-lp151.3.11.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"mailman-debugsource-2.1.29-lp151.3.11.1") ) flag++;
