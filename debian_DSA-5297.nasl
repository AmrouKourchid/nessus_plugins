...
# extracted from Debian Security Advisory dsa-5297. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-5297-1 : vlc - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has packages installed that are affected by a vulnerability as referenced in the dsa-5297
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2022/dsa-5297");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'libvlc-bin', 'reference': '3.0.18-0+deb11u1'},
    {'release': '11.0', 'prefix': 'libvlc-dev', 'reference': '3.0.18-0+deb11u1'},
    {'release': '11.0', 'prefix': 'libvlc5', 'reference': '3.0.18-0+deb11u1'},
    {'release': '11.0', 'prefix': 'libvlccore-dev', 'reference': '3.0.18-0+deb11u1'},
    {'release': '11.0', 'prefix': 'libvlccore9', 'reference': '3.0.18-0+deb11u1'},
    {'release': '11.0', 'prefix': 'vlc', 'reference': '3.0.18-0+deb11u1'},
    {'release': '11.0', 'prefix': 'vlc-bin', 'reference': '3.0.18-0+deb11u1'},
    {'release': '11.0', 'prefix': 'vlc-data', 'reference': '3.0.18-0+deb11u1'},
    {'release': '11.0', 'prefix': 'vlc-l10n', 'reference': '3.0.18-0+deb11u1'},
    {'release': '11.0', 'prefix': 'vlc-plugin-access-extra', 'reference': '3.0.18-0+deb11u1'},
    {'release': '11.0', 'prefix': 'vlc-plugin-base', 'reference': '3.0.18-0+deb11u1'},
    {'release': '11.0', 'prefix': 'vlc-plugin-fluidsynth', 'reference': '3.0.18-0+deb11u1'},
    {'release': '11.0', 'prefix': 'vlc-plugin-jack', 'reference': '3.0.18-0+deb11u1'},
    {'release': '11.0', 'prefix': 'vlc-plugin-notify', 'reference': '3.0.18-0+deb11u1'},
    {'release': '11.0', 'prefix': 'vlc-plugin-qt', 'reference': '3.0.18-0+deb11u1'},
    {'release': '11.0', 'prefix': 'vlc-plugin-samba', 'reference': '3.0.18-0+deb11u1'},
    {'release': '11.0', 'prefix': 'vlc-plugin-skins2', 'reference': '3.0.18-0+deb11u1'},
    {'release': '11.0', 'prefix': 'vlc-plugin-svg', 'reference': '3.0.18-0+deb11u1'},
    {'release': '11.0', 'prefix': 'vlc-plugin-video-output', 'reference': '3.0.18-0+deb11u1'},
    {'release': '11.0', 'prefix': 'vlc-plugin-video-splitter', 'reference': '3.0.18-0+deb11u1'},
    {'release': '11.0', 'prefix': 'vlc-plugin-visualization', 'reference': '3.0.18-0+deb11u1'}
];
