...
# extracted from Fedora Security Advisory FEDORA-2024-67869f1cb3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-67869f1cb3");

  script_name(english:"Fedora 41 : mingw-glib2 (2024-67869f1cb3)");
...
FEDORA-2024-67869f1cb3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-67869f1cb3");
...
var pkgs = [
    {'reference':'mingw-glib2-2.82.2-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
