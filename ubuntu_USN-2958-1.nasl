...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : poppler vulnerabilities (USN-2958-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 14.04 LTS host has packages installed that are affected by multiple vulnerabilities as referenced in
the USN-2958-1 advisory.

    It was discovered that the poppler pdfseparate tool incorrectly handled certain filenames. A local
    attacker could use this issue to cause the tool to crash, resulting in a denial of service, or possibly
    execute arbitrary code. This issue only applied to Ubuntu 12.04 LTS. (CVE-2013-4473, CVE-2013-4474)

    It was discovered that poppler incorrectly parsed certain malformed PDF documents. If a user or automated
    system were tricked into opening a crafted PDF file, an attacker could cause a denial of service or
    possibly execute arbitrary code with privileges of the user invoking the program. (CVE-2015-8868)

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2958-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'gir1.2-poppler-0.18', 'pkgver': '0.24.5-2ubuntu4.4'},
    {'osver': '14.04', 'pkgname': 'libpoppler-cpp-dev', 'pkgver': '0.24.5-2ubuntu4.4'},
    {'osver': '14.04', 'pkgname': 'libpoppler-cpp0', 'pkgver': '0.24.5-2ubuntu4.4'},
    {'osver': '14.04', 'pkgname': 'libpoppler-dev', 'pkgver': '0.24.5-2ubuntu4.4'},
    {'osver': '14.04', 'pkgname': 'libpoppler-glib-dev', 'pkgver': '0.24.5-2ubuntu4.4'},
    {'osver': '14.04', 'pkgname': 'libpoppler-glib8', 'pkgver': '0.24.5-2ubuntu4.4'},
    {'osver': '14.04', 'pkgname': 'libpoppler-private-dev', 'pkgver': '0.24.5-2ubuntu4.4'},
    {'osver': '14.04', 'pkgname': 'libpoppler-qt4-4', 'pkgver': '0.24.5-2ubuntu4.4'},
    {'osver': '14.04', 'pkgname': 'libpoppler-qt4-dev', 'pkgver': '0.24.5-2ubuntu4.4'},
    {'osver': '14.04', 'pkgname': 'libpoppler-qt5-1', 'pkgver': '0.24.5-2ubuntu4.4'},
    {'osver': '14.04', 'pkgname': 'libpoppler-qt5-dev', 'pkgver': '0.24.5-2ubuntu4.4'},
    {'osver': '14.04', 'pkgname': 'libpoppler44', 'pkgver': '0.24.5-2ubuntu4.4'},
    {'osver': '14.04', 'pkgname': 'poppler-utils', 'pkgver': '0.24.5-2ubuntu4.4'}
];
