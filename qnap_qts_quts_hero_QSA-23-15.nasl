...
if (description)
{
  ...
  script_name(english:"QNAP QTS / QuTS hero Multiple Vulnerabilities in OpenSSL (QSA-23-15)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.qnap.com/en/security-advisory/QSA-23-15");
  script_set_attribute(attribute:"solution", value:
"Apply the solution referenced in the QSA-23-15 advisory");
