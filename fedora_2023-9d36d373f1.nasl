...
# extracted from Fedora Security Advisory FEDORA-2023-9d36d373f1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-9d36d373f1");

  script_name(english:"Fedora 37 : python-asgiref / python-django (2023-9d36d373f1)");
...
FEDORA-2023-9d36d373f1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-9d36d373f1");
...
var pkgs = [
    {'reference':'python-asgiref-3.5.2-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python-django-4.1.12-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
