...
if (description)
{
  ...
  script_cve_id("CVE-2023-1916", "CVE-2023-3164");

  script_name(english:"EulerOS 2.0 SP10 : libtiff (EulerOS-SA-2024-2423)");
...
the following vulnerabilities :
    ...
    denial of service and limited information disclosure. This issue affects libtiff versions
    4.x.(CVE-2023-1916)
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2423
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4c2b566a");
...
var pkgs = [
  "libtiff-4.1.0-1.h34.r2.eulerosv2r10"
];
