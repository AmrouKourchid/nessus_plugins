...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : mod_http2 (EulerOS-SA-2024-2143)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2143
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?432da221");
...
var pkgs = [
  "mod_http2-1.15.13-1.h2.eulerosv2r10"
];
