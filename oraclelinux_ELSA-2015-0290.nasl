...
ELSA-2015-0290 advisory.
    ...
    - [fs] proc/task_mmu: fix missing check during hugepage migration (Jacob Tanenbaum) [1105040]
    {CVE-2014-3940}
    - [kernel] trace: insufficient syscall number validation in perf and ftrace subsystems (Jacob Tanenbaum)
    [1161570] {CVE-2014-7825 CVE-2014-7826}
    ...
    [1154002] {CVE-2014-7841}
    - [mm] shmem: fix splicing from a hole while its punched (Denys Vlasenko) [1118245] {CVE-2014-4171}
    - [mm] shmem: fix faulting into a hole, not taking i_mutex (Denys Vlasenko) [1118245] {CVE-2014-4171}
    - [mm] shmem: fix faulting into a hole while its punched (Denys Vlasenko) [1118245] {CVE-2014-4171}
    - [fs] isofs: unbound recursion when processing relocated directories (Jacob Tanenbaum) [1142271]
...
var pkgs = [
    ...
    {'reference':'kernel-abi-whitelists-3.10.0-229.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-abi-whitelists-3.10.0'},
