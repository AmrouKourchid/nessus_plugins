...
"It is, therefore, affected by multiple vulnerabilities as referenced in the ALAS-2020-1340 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2019-11324");
...
var pkgs = [
    {'reference':'python26-pip-9.0.3-1.27.amzn1', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python27-pip-9.0.3-1.27.amzn1', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python34-pip-9.0.3-1.27.amzn1', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python35-pip-9.0.3-1.27.amzn1', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python36-pip-9.0.3-1.27.amzn1', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "python26-pip / python27-pip / python34-pip / etc");
}
