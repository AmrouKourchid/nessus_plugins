...
# AlmaLinux Security Advisory ALSA-2024:1438.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:1438");

  script_name(english:"AlmaLinux 9 : nodejs (ALSA-2024:1438)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2024-1438.html");
...
var pkgs = [
    ...
    {'reference':'npm-8.19.4-1.16.20.2.4.el9_3', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'npm-8.19.4-1.16.20.2.4.el9_3', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
