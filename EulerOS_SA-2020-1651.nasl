...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : nss-softokn (EulerOS-SA-2020-1651)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1651
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b3fbfdb9");
...
pkgs = ["nss-softokn-3.36.0-5.h3",
        "nss-softokn-devel-3.36.0-5.h3",
        "nss-softokn-freebl-3.36.0-5.h3",
        "nss-softokn-freebl-devel-3.36.0-5.h3"];
