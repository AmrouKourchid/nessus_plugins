...
# extracted from Fedora Security Advisory FEDORA-2024-3b4c7849ab
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-3b4c7849ab");

  script_name(english:"Fedora 39 : python-dns (2024-3b4c7849ab)");
...
FEDORA-2024-3b4c7849ab advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-3b4c7849ab");
...
var pkgs = [
    {'reference':'python-dns-2.6.1-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
