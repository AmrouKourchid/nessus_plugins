...
# extracted from Red Hat Security Advisory RHSA-2016:1840. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2016:1840");

  script_name(english:"RHEL 6 / 7 : eap7-jboss-ec2-eap (RHSA-2016:1840)");
...
Platform 7.0.2. Refer to the JBoss Enterprise Application Platform
7.0.2 Release Notes, linked to in the References section, for
...
discovered by Tomaz Cerar (Red Hat).");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2016:1840");
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", reference:"eap7-jboss-ec2-eap-7.0.2-2.GA_redhat_1.ep7.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"eap7-jboss-ec2-eap-samples-7.0.2-2.GA_redhat_1.ep7.el6")) flag++;

  if (rpm_check(release:"RHEL7", reference:"eap7-jboss-ec2-eap-7.0.2-2.GA_redhat_1.ep7.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"eap7-jboss-ec2-eap-samples-7.0.2-2.GA_redhat_1.ep7.el7")) flag++;
