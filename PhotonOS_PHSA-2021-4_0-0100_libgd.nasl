...
# extracted from VMware Security Advisory PHSA-2021-4.0-0100. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Libgd PHSA-2021-4.0-0100");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the libgd package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-100.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libgd-2.3.0-3.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libgd-devel-2.3.0-3.ph4')) flag++;
