...
# extracted from Gentoo Linux Security Advisory GLSA 202105-05.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202105-05");

  script_name(english:"GLSA-202105-05 : Mutt, NeoMutt: Denial of service");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202105-05
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202105-05"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"mail-client/mutt", unaffected:make_list("ge 2.0.7"), vulnerable:make_list("lt 2.0.7"))) flag++;
if (qpkg_check(package:"mail-client/neomutt", unaffected:make_list("ge 20210205-r1"), vulnerable:make_list("lt 20210205-r1"))) flag++;
