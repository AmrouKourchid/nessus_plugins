...
if (description)
{
  ...
  script_name(english:"RHEL 4 : wget (RHSA-2005:771)");
...
referenced in the RHSA-2005:771 advisory.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2005/rhsa-2005_771.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?551c31da");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=144214");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=157498");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=165782");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2005:771");
...
"Update the RHEL wget package based on the guidance in RHSA-2005:771.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2004-1488");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'wget-1.10.1-2.4E.1', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'wget-1.10.1-2.4E.1', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'wget-1.10.1-2.4E.1', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'wget-1.10.1-2.4E.1', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'wget-1.10.1-2.4E.1', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
