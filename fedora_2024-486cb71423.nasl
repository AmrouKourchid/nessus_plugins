...
# extracted from Fedora Security Advisory FEDORA-2024-486cb71423
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-486cb71423");

  script_name(english:"Fedora 40 : python3-docs / python3.12 (2024-486cb71423)");
...
FEDORA-2024-486cb71423 advisory.

    Update to 3.12.4, fix CVE-2024-4032

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-486cb71423");
...
var pkgs = [
    {'reference':'python3-docs-3.12.4-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3.12-3.12.4-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
