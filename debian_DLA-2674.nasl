...
# extracted from Debian Security Advisory DLA-2674-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2674-1 : isc-dhcp security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2021/06/msg00002.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"9.0", prefix:"isc-dhcp-client", reference:"4.3.5-3+deb9u2")) flag++;
if (deb_check(release:"9.0", prefix:"isc-dhcp-client-ddns", reference:"4.3.5-3+deb9u2")) flag++;
if (deb_check(release:"9.0", prefix:"isc-dhcp-client-udeb", reference:"4.3.5-3+deb9u2")) flag++;
if (deb_check(release:"9.0", prefix:"isc-dhcp-common", reference:"4.3.5-3+deb9u2")) flag++;
if (deb_check(release:"9.0", prefix:"isc-dhcp-dev", reference:"4.3.5-3+deb9u2")) flag++;
if (deb_check(release:"9.0", prefix:"isc-dhcp-relay", reference:"4.3.5-3+deb9u2")) flag++;
if (deb_check(release:"9.0", prefix:"isc-dhcp-server", reference:"4.3.5-3+deb9u2")) flag++;
if (deb_check(release:"9.0", prefix:"isc-dhcp-server-ldap", reference:"4.3.5-3+deb9u2")) flag++;
