...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Containerd PHSA-2021-3.0-0210");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'containerd-1.3.10-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'containerd-doc-1.3.10-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'containerd-extras-1.3.10-1.ph3')) flag++;
