...
# SUSE update advisory SUSE-SU-2023:3469-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:3469-1");

  script_name(english:"SUSE SLES15 / openSUSE 15 Security Update : haproxy (SUSE-SU-2023:3469-1)");
...
referenced in the SUSE-SU-2023:3469-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1214102");
  # https://lists.suse.com/pipermail/sle-security-updates/2023-August/016041.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b7e3faa4");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2023-40225");
...
var pkgs = [
    {'reference':'haproxy-2.4.22+git0.f8e3218e2-150400.3.16.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.4']},
    {'reference':'haproxy-2.4.22+git0.f8e3218e2-150400.3.16.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.5']},
    {'reference':'haproxy-2.4.22+git0.f8e3218e2-150400.3.16.1', 'sp':'4', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-ha-release-15.4']},
    {'reference':'haproxy-2.4.22+git0.f8e3218e2-150400.3.16.1', 'sp':'5', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-ha-release-15.5']}
];
