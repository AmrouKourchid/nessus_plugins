...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : binutils (EulerOS-SA-2023-2405)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2405
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3798ad0e");
...
var pkgs = [
  "binutils-2.27-28.base.1.h54.eulerosv2r7",
  "binutils-devel-2.27-28.base.1.h54.eulerosv2r7"
];
