...
# extracted from Oracle Linux Security Advisory ELSA-2024-11238.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : python3.11-urllib3 (ELSA-2024-11238)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-11238.html");
...
var pkgs = [
    {'reference':'python3.11-urllib3-1.26.12-2.el9_5.2', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3.11-urllib3-1.26.12-2.el9_5.2', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
