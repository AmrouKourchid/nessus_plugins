...
# extracted from Red Hat Security Advisory RHSA-2025:1096. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:1096");

  script_name(english:"RHEL 9 : ovn24.03 (RHSA-2025:1096)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_1096.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?88f5c682");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:1096");
...
"Update the RHEL ovn24.03 package based on the guidance in RHSA-2025:1096.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:ovn24.03");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:ovn24.03-central");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:ovn24.03-host");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:ovn24.03-vtep");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ovn24.03-24.03.4-53.el9fdp', 'release':'9', 'el_string':'el9fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openvswitch'},
      {'reference':'ovn24.03-central-24.03.4-53.el9fdp', 'release':'9', 'el_string':'el9fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openvswitch'},
      {'reference':'ovn24.03-host-24.03.4-53.el9fdp', 'release':'9', 'el_string':'el9fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openvswitch'},
      {'reference':'ovn24.03-vtep-24.03.4-53.el9fdp', 'release':'9', 'el_string':'el9fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openvswitch'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'ovn24.03 / ovn24.03-central / ovn24.03-host / ovn24.03-vtep');
}
