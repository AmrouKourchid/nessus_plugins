...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Libwebp PHSA-2023-5.0-0097");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'libwebp-1.3.2-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'libwebp-devel-1.3.2-1.ph5')) flag++;
