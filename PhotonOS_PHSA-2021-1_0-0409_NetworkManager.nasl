...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Networkmanager PHSA-2021-1.0-0409");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'NetworkManager-1.22.10-2.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'NetworkManager-devel-1.22.10-2.ph1')) flag++;
