...
"The version of OpenSSL installed on the remote host is prior to 1.1.1c. It is, therefore, affected by a vulnerability as
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?aad3ea8d");
...
var constraints = [
  { 'min_version' : '1.1.1', 'fixed_version' : '1.1.1c' }
];
