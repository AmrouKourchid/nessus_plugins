...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_3895.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b4a88d1f");
...
"Update the RHEL sudo package based on the guidance in RHSA-2019:3895.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'sudo-1.8.6p3-12.el6_5.2', 'sp':'5', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sudo-devel-1.8.6p3-12.el6_5.2', 'sp':'5', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sudo-devel-1.8.6p3-12.el6_5.2', 'sp':'5', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
