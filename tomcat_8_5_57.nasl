...
"The version of Tomcat installed on the remote host is prior to 8.5.57. It is, therefore, affected by multiple
vulnerabilities as referenced in the fixed_in_apache_tomcat_8.5.57_security-8 advisory.
...
var constraints = [
  { 'min_version' : '8.5.0', 'max_version' : '8.5.56', 'fixed_version' : '8.5.57' }
];
