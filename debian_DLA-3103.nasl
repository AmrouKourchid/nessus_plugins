...
# extracted from Debian Security Advisory dla-3103. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3103 : lib32z1 - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3103
advisory.

    - -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3103-1                debian-lts@lists.debian.org
...
var pkgs = [
    {'release': '10.0', 'prefix': 'lib32z1', 'reference': '1:1.2.11.dfsg-1+deb10u2'},
    {'release': '10.0', 'prefix': 'lib32z1-dev', 'reference': '1:1.2.11.dfsg-1+deb10u2'},
    {'release': '10.0', 'prefix': 'lib64z1', 'reference': '1:1.2.11.dfsg-1+deb10u2'},
    {'release': '10.0', 'prefix': 'lib64z1-dev', 'reference': '1:1.2.11.dfsg-1+deb10u2'},
    {'release': '10.0', 'prefix': 'zlib1g', 'reference': '1:1.2.11.dfsg-1+deb10u2'},
    {'release': '10.0', 'prefix': 'zlib1g-dbg', 'reference': '1:1.2.11.dfsg-1+deb10u2'},
    {'release': '10.0', 'prefix': 'zlib1g-dev', 'reference': '1:1.2.11.dfsg-1+deb10u2'}
];
