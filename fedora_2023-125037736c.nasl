...
# extracted from Fedora Security Advisory FEDORA-2023-125037736c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-125037736c");

  script_name(english:"Fedora 39 : optipng (2023-125037736c)");
...
FEDORA-2023-125037736c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-125037736c");
...
var pkgs = [
    {'reference':'optipng-0.7.8-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
