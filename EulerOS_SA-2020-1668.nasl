...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : vim (EulerOS-SA-2020-1668)");
...
vulnerability :
  ...
  - An integer overflow at a u_read_undo memory allocation
    site would occur for vim before patch 8.0.0377, if it
    does not properly validate values for tree length when
    reading a corrupted undo file, which may lead to
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1668
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8f12d90a");
