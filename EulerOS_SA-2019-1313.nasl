...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : libtiff (EulerOS-SA-2019-1313)");
...
vulnerabilities :
  ...
  - An Invalid Address dereference was discovered in
    ...
    denial-of-service via a crafted tiff
    file.(CVE-2019-7663)
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1313
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9c8c4867");
...
pkgs = ["libtiff-4.0.3-27.h8.eulerosv2r7",
        "libtiff-devel-4.0.3-27.h8.eulerosv2r7"];
