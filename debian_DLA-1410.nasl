...
# extracted from Debian Security Advisory DLA-1410-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1410-1 : python-pysaml2 security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2018/07/msg00000.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/jessie/python-pysaml2");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"python-pysaml2", reference:"2.0.0-1+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"python-pysaml2-doc", reference:"2.0.0-1+deb8u2")) flag++;
