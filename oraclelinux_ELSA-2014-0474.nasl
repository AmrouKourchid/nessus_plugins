...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2014-0474.html");
...
var pkgs = [
    {'reference':'struts-1.2.9-4jpp.8.el5_10', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'struts-javadoc-1.2.9-4jpp.8.el5_10', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'struts-manual-1.2.9-4jpp.8.el5_10', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'struts-webapps-tomcat5-1.2.9-4jpp.8.el5_10', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'struts-1.2.9-4jpp.8.el5_10', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'struts-javadoc-1.2.9-4jpp.8.el5_10', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'struts-manual-1.2.9-4jpp.8.el5_10', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'struts-webapps-tomcat5-1.2.9-4jpp.8.el5_10', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'struts / struts-javadoc / struts-manual / etc');
}
