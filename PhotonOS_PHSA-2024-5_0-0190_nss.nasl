...
# extracted from VMware Security Advisory PHSA-2024-5.0-0190. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Nss PHSA-2024-5.0-0190");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the nss package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-5.0-190.md");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'nss-3.78-6.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'nss-devel-3.78-6.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'nss-libs-3.78-6.ph5')) flag++;
