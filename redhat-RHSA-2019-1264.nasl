...
the RHSA-2019:1264 advisory.
    ...
    * libvirt terminates and core-dumps with SIGABRT as a result of a invalid pointer error trying to free
    memory in virNWFilterBindingDefFree() (BZ#1702173)

Tenable has extracted the preceding description block directly from the Red Hat Enterprise Linux security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_1264.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d9090ad1");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:1264");
...
"Update the RHEL libvirt package based on the guidance in RHSA-2019:1264.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libvirt-4.5.0-10.el7_6.10', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-admin-4.5.0-10.el7_6.10', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-bash-completion-4.5.0-10.el7_6.10', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-client-4.5.0-10.el7_6.10', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-daemon-4.5.0-10.el7_6.10', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-daemon-config-network-4.5.0-10.el7_6.10', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-daemon-config-nwfilter-4.5.0-10.el7_6.10', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-daemon-driver-interface-4.5.0-10.el7_6.10', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-daemon-driver-lxc-4.5.0-10.el7_6.10', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-daemon-driver-network-4.5.0-10.el7_6.10', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-daemon-driver-nodedev-4.5.0-10.el7_6.10', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-daemon-driver-nwfilter-4.5.0-10.el7_6.10', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-daemon-driver-qemu-4.5.0-10.el7_6.10', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-daemon-driver-secret-4.5.0-10.el7_6.10', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-daemon-driver-storage-4.5.0-10.el7_6.10', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-daemon-driver-storage-core-4.5.0-10.el7_6.10', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-daemon-driver-storage-disk-4.5.0-10.el7_6.10', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-daemon-driver-storage-gluster-4.5.0-10.el7_6.10', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-daemon-driver-storage-iscsi-4.5.0-10.el7_6.10', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-daemon-driver-storage-logical-4.5.0-10.el7_6.10', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-daemon-driver-storage-mpath-4.5.0-10.el7_6.10', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-daemon-driver-storage-rbd-4.5.0-10.el7_6.10', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-daemon-driver-storage-scsi-4.5.0-10.el7_6.10', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-daemon-kvm-4.5.0-10.el7_6.10', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-daemon-lxc-4.5.0-10.el7_6.10', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-devel-4.5.0-10.el7_6.10', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-docs-4.5.0-10.el7_6.10', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-libs-4.5.0-10.el7_6.10', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-lock-sanlock-4.5.0-10.el7_6.10', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-login-shell-4.5.0-10.el7_6.10', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-nss-4.5.0-10.el7_6.10', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
