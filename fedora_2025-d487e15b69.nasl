...
# extracted from Fedora Security Advisory FEDORA-2025-d487e15b69
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-d487e15b69");

  script_name(english:"Fedora 40 : expat (2025-d487e15b69)");
...
FEDORA-2025-d487e15b69 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-d487e15b69");
...
var pkgs = [
    {'reference':'expat-2.7.0-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
