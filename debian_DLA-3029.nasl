...
# extracted from Debian Security Advisory dla-3029. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-3029-1 : cups - LTS security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 9 host has packages installed that are affected by a vulnerability as referenced in the dla-3029
advisory.

    Joshua Mason discovered that a logic error in the validation of the secret key used in the local
    authorisation mode of the CUPS printing system may result in privilege escalation. For Debian 9 stretch,
    this problem has been fixed in version 2.2.1-8+deb9u8. We recommend that you upgrade your cups packages.
    For the detailed security status of cups please refer to its security tracker page at: https://security-
    tracker.debian.org/tracker/cups Further information about Debian LTS security advisories, how to apply
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=1011769");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/cups");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2022/dla-3029");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-26691");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/stretch/cups");
...
var pkgs = [
    {'release': '9.0', 'prefix': 'cups', 'reference': '2.2.1-8+deb9u8'},
    {'release': '9.0', 'prefix': 'cups-bsd', 'reference': '2.2.1-8+deb9u8'},
    {'release': '9.0', 'prefix': 'cups-client', 'reference': '2.2.1-8+deb9u8'},
    {'release': '9.0', 'prefix': 'cups-common', 'reference': '2.2.1-8+deb9u8'},
    {'release': '9.0', 'prefix': 'cups-core-drivers', 'reference': '2.2.1-8+deb9u8'},
    {'release': '9.0', 'prefix': 'cups-daemon', 'reference': '2.2.1-8+deb9u8'},
    {'release': '9.0', 'prefix': 'cups-ipp-utils', 'reference': '2.2.1-8+deb9u8'},
    {'release': '9.0', 'prefix': 'cups-ppdc', 'reference': '2.2.1-8+deb9u8'},
    {'release': '9.0', 'prefix': 'cups-server-common', 'reference': '2.2.1-8+deb9u8'},
    {'release': '9.0', 'prefix': 'libcups2', 'reference': '2.2.1-8+deb9u8'},
    {'release': '9.0', 'prefix': 'libcups2-dev', 'reference': '2.2.1-8+deb9u8'},
    {'release': '9.0', 'prefix': 'libcupscgi1', 'reference': '2.2.1-8+deb9u8'},
    {'release': '9.0', 'prefix': 'libcupsimage2', 'reference': '2.2.1-8+deb9u8'},
    {'release': '9.0', 'prefix': 'libcupsimage2-dev', 'reference': '2.2.1-8+deb9u8'},
    {'release': '9.0', 'prefix': 'libcupsmime1', 'reference': '2.2.1-8+deb9u8'},
    {'release': '9.0', 'prefix': 'libcupsppdc1', 'reference': '2.2.1-8+deb9u8'}
];
