...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.3 : python (EulerOS-SA-2019-1359)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1359
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8aea1b05");
...
pkgs = ["python-2.7.5-58.h12",
        "python-devel-2.7.5-58.h12",
        "python-libs-2.7.5-58.h12",
        "python-tools-2.7.5-58.h12",
        "tkinter-2.7.5-58.h12"];
