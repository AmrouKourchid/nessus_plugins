...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.0 : ncurses (EulerOS-SA-2024-1630)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1630
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e54f9cd5");
...
var pkgs = [
  "ncurses-6.3-2.h6.eulerosv2r11",
  "ncurses-base-6.3-2.h6.eulerosv2r11",
  "ncurses-libs-6.3-2.h6.eulerosv2r11"
];
