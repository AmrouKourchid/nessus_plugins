...
# extracted from Red Hat Security Advisory ppp. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2018-11574", "CVE-2022-4603");

  script_name(english:"RHEL 7 : ppp (Unpatched Vulnerability) (deprecated)");
