...
# extracted from Red Hat Security Advisory RHSA-2018:2037. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:2037");

  script_name(english:"RHEL 7 : podman (RHSA-2018:2037)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2018/rhsa-2018_2037.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6efba749");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:2037");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1592166");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL podman package based on the guidance in RHSA-2018:2037.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-10856");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'podman-0.6.1-3.git3e0ff12.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'podman-0.6.1-3.git3e0ff12.el7', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'podman-0.6.1-3.git3e0ff12.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
