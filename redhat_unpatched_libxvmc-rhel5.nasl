...
# extracted from Red Hat Security Advisory libxvmc. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2013-1990", "CVE-2013-1999", "CVE-2016-7953");

  script_name(english:"RHEL 5 : libxvmc (Unpatched Vulnerability) (deprecated)");
