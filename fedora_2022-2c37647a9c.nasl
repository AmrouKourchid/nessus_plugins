...
# extracted from Fedora Security Advisory FEDORA-2022-2c37647a9c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-2c37647a9c");

  script_name(english:"Fedora 37 : dotnet6.0 (2022-2c37647a9c)");
...
FEDORA-2022-2c37647a9c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-2c37647a9c");
...
var pkgs = [
    {'reference':'dotnet6.0-6.0.110-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
