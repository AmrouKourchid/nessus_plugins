...
# extracted from Ubuntu Security Notice USN-6994-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6994-1");
  script_xref(name:"CEA-ID", value:"CEA-2024-0004");

  script_name(english:"Ubuntu 22.04 LTS : Netty vulnerabilities (USN-6994-1)");
...
the USN-6994-1 advisory.

    It was discovered that Netty did not properly sanitize its input parameters. A remote attacker could
    possibly use this issue to cause a crash. (CVE-2023-34462)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6994-1");
...
var pkgs = [
    {'osver': '22.04', 'pkgname': 'libnetty-java', 'pkgver': '1:4.1.48-4+deb11u2build0.22.04.1'}
];
