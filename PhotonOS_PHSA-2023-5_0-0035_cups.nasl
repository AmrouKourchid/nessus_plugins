...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Cups PHSA-2023-5.0-0035");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'cups-2.4.2-5.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'cups-devel-2.4.2-5.ph5')) flag++;
