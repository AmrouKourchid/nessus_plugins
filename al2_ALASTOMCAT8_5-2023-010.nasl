...
# extracted from Amazon Linux 2 Security Advisory ALASTOMCAT8.5-2023-010.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : tomcat (ALASTOMCAT8.5-2023-010)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of tomcat installed on the remote host is prior to 8.5.60-1. It is, therefore, affected by multiple
vulnerabilities as referenced in the ALAS2TOMCAT8.5-2023-010 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALASTOMCAT8.5-2023-010.html");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/cve/html/CVE-2020-17527.html");
...
var pkgs = [
    {'reference':'tomcat-8.5.60-1.amzn2', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'tomcat8.5'},
    {'reference':'tomcat-admin-webapps-8.5.60-1.amzn2', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'tomcat8.5'},
    {'reference':'tomcat-docs-webapp-8.5.60-1.amzn2', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'tomcat8.5'},
    {'reference':'tomcat-el-3.0-api-8.5.60-1.amzn2', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'tomcat8.5'},
    {'reference':'tomcat-javadoc-8.5.60-1.amzn2', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'tomcat8.5'},
    {'reference':'tomcat-jsp-2.3-api-8.5.60-1.amzn2', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'tomcat8.5'},
    {'reference':'tomcat-jsvc-8.5.60-1.amzn2', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'tomcat8.5'},
    {'reference':'tomcat-lib-8.5.60-1.amzn2', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'tomcat8.5'},
    {'reference':'tomcat-servlet-3.1-api-8.5.60-1.amzn2', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'tomcat8.5'},
    {'reference':'tomcat-webapps-8.5.60-1.amzn2', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'tomcat8.5'}
];
