...
# extracted from Oracle Linux Security Advisory ELSA-2024-0130.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : frr (ELSA-2024-0130)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ELSA-2024-0130 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-0130.html");
...
var pkgs = [
    {'reference':'frr-7.5.1-13.el8_9.3', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'frr-selinux-7.5.1-13.el8_9.3', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'frr-7.5.1-13.el8_9.3', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'frr-selinux-7.5.1-13.el8_9.3', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
