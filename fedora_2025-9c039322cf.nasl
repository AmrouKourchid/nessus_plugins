...
# extracted from Fedora Security Advisory FEDORA-2025-9c039322cf
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-9c039322cf");

  script_name(english:"Fedora 40 : python-django (2025-9c039322cf)");
...
FEDORA-2025-9c039322cf advisory.

    Fix for CVE-2025-26699: Potential denial-of-service vulnerability in django.utils.text.wrap()

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-9c039322cf");
...
var pkgs = [
    {'reference':'python-django-4.2.20-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
