...
# extracted from Fedora Security Advisory FEDORA-2023-6f2c7aa713
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-6f2c7aa713");

  script_name(english:"Fedora 38 : rust (2023-6f2c7aa713)");
...
FEDORA-2023-6f2c7aa713 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-6f2c7aa713");
...
var pkgs = [
    {'reference':'rust-1.71.1-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
