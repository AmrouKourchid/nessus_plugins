...
# extracted from Fedora Security Advisory FEDORA-2024-318343049c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-318343049c");

  script_name(english:"Fedora 39 : apr (2024-318343049c)");
...
FEDORA-2024-318343049c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-318343049c");
...
var pkgs = [
    {'reference':'apr-1.7.5-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
