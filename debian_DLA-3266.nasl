...
if (description)
{
  ...
  script_name(english:"Debian dla-3266 : viewvc - security update");
...
dla-3266 advisory.
    ...
    - -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3266-1                debian-lts@lists.debian.org
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/viewvc");
