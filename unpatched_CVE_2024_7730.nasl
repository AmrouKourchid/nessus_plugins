...
if (description)
{
  ...
  script_cve_id("CVE-2024-7730");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-7730");
...
patch available.
  ...
  - A heap buffer overflow was found in the virtio-snd device in QEMU. When reading input audio in the virtio-
    ...
    virtio_snd_pcm_status, which makes the available space for audio data zero. (CVE-2024-7730)
