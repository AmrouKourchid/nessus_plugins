...
# extracted from Red Hat Security Advisory RHSA-2022:7323. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:7323");

  script_name(english:"RHEL 9 : python3.9 (RHSA-2022:7323)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_7323.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?75329e21");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1834423");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:7323");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python3.9 package based on the guidance in RHSA-2022:7323.");
...
var constraints = [
  {
    ...
    'pkgs': [
      ...
      {'reference':'python3-3.9.10-3.el9_0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-debug-3.9.10-3.el9_0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-devel-3.9.10-3.el9_0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-idle-3.9.10-3.el9_0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-libs-3.9.10-3.el9_0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-test-3.9.10-3.el9_0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-tkinter-3.9.10-3.el9_0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'python-unversioned-command-3.9.10-3.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-3.9.10-3.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-debug-3.9.10-3.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-devel-3.9.10-3.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-idle-3.9.10-3.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-libs-3.9.10-3.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-test-3.9.10-3.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-tkinter-3.9.10-3.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
