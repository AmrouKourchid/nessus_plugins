...
# extracted from Gentoo Linux Security Advisory GLSA 202312-09.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2019-8343", "CVE-2020-21528", "CVE-2022-44370");

  script_name(english:"GLSA-202312-09 : NASM: Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202312-09 (NASM: Multiple Vulnerabilities)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202312-09");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=686720");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=903755");
...
"All NASM users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2022-44370");
...
var packages = [
  {
    'name' : 'dev-lang/nasm',
    'unaffected' : make_list("ge 2.16.01"),
    'vulnerable' : make_list("lt 2.16.01")
  }
];
