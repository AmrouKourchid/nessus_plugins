...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.0 : libssh (EulerOS-SA-2024-1628)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1628
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9e42cc34");
