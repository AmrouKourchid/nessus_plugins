...
# Red Hat Security Advisory RHSA-2023:0446. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : go-toolset:rhel8 (CESA-2023:0446)");
...
var appstreams = {
    'go-toolset:rhel8': [
      {'reference':'delve-1.8.3-1.module_el8.7.0+1141+abb4f2cd', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
};
