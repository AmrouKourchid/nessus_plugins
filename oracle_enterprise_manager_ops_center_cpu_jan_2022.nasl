...
if (description)
{
  ...
  script_name(english:"Oracle Enterprise Manager Ops Center (Jan 2022 CPU)");
...
referenced in the January 2022 CPU advisory.
  ...
  - Vulnerability in the Enterprise Manager Ops Center product of Oracle Enterprise Manager (component:
    ...
    Successful attacks of this vulnerability can result in takeover of Enterprise Manager Ops Center. CVSS 3.1
    Base Score 9.8 (Confidentiality, Integrity and Availability impacts). CVSS Vector:
...
var constraints = [
  {'min_version': '12.4.0.0', 'max_version': '12.4.0.9999', 'uce_patch': '33701477'}
];

var install = vcf::oracle_em_ops_center::get_app_info();

vcf::oracle_em_ops_center::check_version_and_report(app_info:install, constraints:constraints, severity:SECURITY_HOLE);
