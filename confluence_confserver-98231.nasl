...
if (description)
{
  ...
  script_name(english:"Atlassian Confluence 7.19.x < 7.19.23 / 7.20.x < 8.5.11 / 8.6.x < 8.6.2 / 8.7.x < 8.7.2 / 8.8.x < 8.9.3 (CONFSERVER-98231)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://jira.atlassian.com/browse/CONFSERVER-98231");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Atlassian Confluence version 7.19.23, 8.5.11, 8.6.2, 8.7.2, 8.9.3 or later.");
