...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Cifs PHSA-2022-4.0-0194");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'cifs-utils-6.13-2.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'cifs-utils-devel-6.13-2.ph4')) flag++;
