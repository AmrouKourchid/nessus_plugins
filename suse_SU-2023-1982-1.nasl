...
# SUSE update advisory SUSE-SU-2023:1982-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:1982-1");

  script_name(english:"SUSE SLES12 / SLES15 Security Update : kernel (Live Patch 32 for SLE 12 SP4) (SUSE-SU-2023:1982-1)");
...
referenced in the SUSE-SU-2023:1982-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://lists.suse.com/pipermail/sle-updates/2023-April/028977.html");
...
"Update the affected kernel-livepatch-4_12_14-150100_197_126-default, kgraft-patch-4_12_14-122_133-default and / or
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-122.133-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_12_14-122_133-default-7-2.2', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.5']}
        ]
      },
      '4.12.14-150100.197.126-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-4_12_14-150100_197_126-default-6-150100.2.2', 'sp':'1', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.1']}
        ]
      },
      '4.12.14-95.114-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_12_14-95_114-default-4-2.2', 'sp':'4', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.4']}
        ]
      }
    }
  }
