...
# extracted from Fedora Security Advisory FEDORA-2023-c9bbaadcbf
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-c9bbaadcbf");

  script_name(english:"Fedora 37 : libmemcached-awesome (2023-c9bbaadcbf)");
...
FEDORA-2023-c9bbaadcbf advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-c9bbaadcbf");
...
var pkgs = [
    {'reference':'libmemcached-awesome-1.1.4-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
