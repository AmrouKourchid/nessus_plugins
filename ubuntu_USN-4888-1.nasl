...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 20.04 LTS : ldb vulnerabilities (USN-4888-1)");
...
vulnerabilities as referenced in the USN-4888-1 advisory.

    Douglas Bagnall discovered that ldb, when used with Samba, incorrectly handled certain LDAP attributes. A
    remote attacker could possibly use this issue to cause the LDAP server to crash, resulting in a denial of
    service. (CVE-2021-20277)

    Douglas Bagnall discovered that ldb, when used with Samba, incorrectly handled certain DN strings. A
    remote attacker could use this issue to cause the LDAP server to crash, resulting in a denial of service,
    or possibly execute arbitrary code. (CVE-2020-27840)
