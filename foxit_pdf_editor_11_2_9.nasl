...
if (description)
{
  ...
  script_name(english:"Foxit PDF Editor < 11.2.9 Multiple Vulnerabilities");
...
Windows host is prior to 11.2.9. It is, therefore affected by multiple vulnerabilities:
...
"Upgrade to Foxit PDF Editor version 11.2.9 or later");
...
var constraints = [
  { 'max_version' : '11.2.8.53842', 'fixed_version' : '11.2.9' }
];
