...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Dnsmasq PHSA-2024-4.0-0572");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'dnsmasq-2.90-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'dnsmasq-utils-2.90-1.ph4')) flag++;
