...
if (description)
{
  ...
  script_cve_id("CVE-2024-20537", "CVE-2024-20539");
  script_xref(name:"CISCO-BUG-ID", value:"CSCwj28643");
  script_xref(name:"CISCO-BUG-ID", value:"CSCwj29451");
  script_xref(name:"CISCO-SA", value:"cisco-sa-ise-auth-bypass-BBRf7mkE");
  script_xref(name:"IAVA", value:"2024-A-0710");

  script_name(english:"Cisco Identity Services Engine Multiple Vulnerabilities (cisco-sa-ise-auth-bypass-BBRf7mkE)");
...
"According to its self-reported version, Cisco Identity Services Engine is affected by multiple vulnerabilities:
  ...
  attacker to bypass the authorization mechanisms for specific administrative functions. (CVE-2024-20537)

  - A vulnerability in the web-based management interface of Cisco ISE could allow an authenticated, remote attacker to 
  conduct a stored XSS attack against a user of the interface. (CVE-2024-20539)
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b95f14ab");
  script_set_attribute(attribute:"solution", value:
"Upgrade to the relevant fixed version referenced in Cisco bug ID CSCwj28643 and CSCwj29451");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:S/C:N/I:C/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:L/UI:N/S:U/C:N/I:H/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-20537");
...
var vuln_ranges = [
  {'min_ver':'1.0', 'fix_ver':'3.1.0.518', required_patch:'9'},
