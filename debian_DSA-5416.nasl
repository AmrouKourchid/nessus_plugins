...
# extracted from Debian Security Advisory dsa-5416. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-5416-1 : connman - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has packages installed that are affected by a vulnerability as referenced in the dsa-5416
advisory.

    It was discovered that there was a potential buffer overflow and denial of service vulnerabilty in the
    gdhcp client implementation of connman, a command-line network manager designed for use on embedded
    devices. For the stable distribution (bullseye), this problem has been fixed in version 1.36-2.2+deb11u2.
    We recommend that you upgrade your connman packages. For the detailed security status of connman please
    refer to its security tracker page at: https://security-tracker.debian.org/tracker/connman

Tenable has extracted the preceding description block directly from the Debian security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=1034393");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/connman");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2023/dsa-5416");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'connman', 'reference': '1.36-2.2+deb11u2'},
    {'release': '11.0', 'prefix': 'connman-dev', 'reference': '1.36-2.2+deb11u2'},
    {'release': '11.0', 'prefix': 'connman-doc', 'reference': '1.36-2.2+deb11u2'},
    {'release': '11.0', 'prefix': 'connman-vpn', 'reference': '1.36-2.2+deb11u2'}
];
