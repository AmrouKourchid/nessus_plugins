...
if (description)
{
  ...
  script_cve_id("CVE-2014-1587");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2014-1587");
...
patch available.
  ...
  - Multiple unspecified vulnerabilities in the browser engine in Mozilla Firefox before 34.0, Firefox ESR
    31.x before 31.3, Thunderbird before 31.3, and SeaMonkey before 2.31 allow remote attackers to cause a
    denial of service (memory corruption and application crash) or possibly execute arbitrary code via unknown
    vectors. (CVE-2014-1587)
