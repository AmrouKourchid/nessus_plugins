...
"The remote Red Hat host is missing one or more security updates for Red Hat OpenStack Platform 16.2 (python-twisted).");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_0992.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e9621680");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:0992");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2051865");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2060960");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat OpenStack Platform 16.2 (python-twisted) package based on the guidance in RHSA-2022:0992.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-twisted-16.4.1-19.el8ost', 'cpu':'ppc64le', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
