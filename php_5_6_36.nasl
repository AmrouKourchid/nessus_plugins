...
if (description)
{
  ...
  script_name(english:"PHP 5.6.x < 5.6.36 Multiple Vulnerabilities");
...
server is 5.6.x prior to 5.6.36. It is, therefore, affected by
multiple vulnerabilities.");
  script_set_attribute(attribute:"see_also", value:"http://php.net/ChangeLog-5.php#5.6.36");
