...
# extracted from Fedora Security Advisory FEDORA-2022-e0a87993b8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-e0a87993b8");

  script_name(english:"Fedora 35 : booth (2022-e0a87993b8)");
...
FEDORA-2022-e0a87993b8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-e0a87993b8");
...
var pkgs = [
    {'reference':'booth-1.0-251.4.bfb2f92.git.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
