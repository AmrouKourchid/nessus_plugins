...
# extracted from Red Hat Security Advisory RHSA-2024:9188. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:9188");

  script_name(english:"RHEL 9 : bpftrace (RHSA-2024:9188)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for bpftrace.");
...
the RHSA-2024:9188 advisory.

    BPFtrace is a high-level tracing language for Linux enhanced Berkeley Packet Filter (eBPF) available in
    recent Linux kernels (4.x). BPFtrace uses LLVM as a backend to compile scripts to BPF-bytecode and makes
    use of BCC for interacting with the Linux BPF system, as well as existing Linux tracing capabilities:
    kernel dynamic tracing (kprobes), user-level dynamic tracing (uprobes), and tracepoints. The BPFtrace
    language is inspired by awk and C, and predecessor tracers such as DTrace and SystemTap
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2269014");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-30779");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_9188.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fe260028");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:9188");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL bpftrace package based on the guidance in RHSA-2024:9188.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:bpftrace");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'bpftrace-0.21.1-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'bpftrace');
}
