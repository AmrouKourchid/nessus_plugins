...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS : PHP vulnerabilities (USN-3211-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 16.04 LTS host has packages installed that are affected by multiple vulnerabilities as referenced in
the USN-3211-1 advisory.
    ...
    It was discovered that PHP incorrectly handled unserializing certain wddxPacket XML documents. A remote
    attacker could use this issue to cause PHP to crash, resulting in a denial of service. (CVE-2016-10162)

    It was discovered that PHP incorrectly handled certain invalid objects when unserializing data. A remote
    attacker could use this issue to cause PHP to crash, resulting in a denial of service, or possibly execute
    arbitrary code. (CVE-2017-5340)

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3211-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libapache2-mod-php7.0', 'pkgver': '7.0.15-0ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'libphp7.0-embed', 'pkgver': '7.0.15-0ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'php7.0', 'pkgver': '7.0.15-0ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'php7.0-bcmath', 'pkgver': '7.0.15-0ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'php7.0-bz2', 'pkgver': '7.0.15-0ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'php7.0-cgi', 'pkgver': '7.0.15-0ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'php7.0-cli', 'pkgver': '7.0.15-0ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'php7.0-common', 'pkgver': '7.0.15-0ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'php7.0-curl', 'pkgver': '7.0.15-0ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'php7.0-dba', 'pkgver': '7.0.15-0ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'php7.0-dev', 'pkgver': '7.0.15-0ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'php7.0-enchant', 'pkgver': '7.0.15-0ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'php7.0-fpm', 'pkgver': '7.0.15-0ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'php7.0-gd', 'pkgver': '7.0.15-0ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'php7.0-gmp', 'pkgver': '7.0.15-0ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'php7.0-imap', 'pkgver': '7.0.15-0ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'php7.0-interbase', 'pkgver': '7.0.15-0ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'php7.0-intl', 'pkgver': '7.0.15-0ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'php7.0-json', 'pkgver': '7.0.15-0ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'php7.0-ldap', 'pkgver': '7.0.15-0ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'php7.0-mbstring', 'pkgver': '7.0.15-0ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'php7.0-mcrypt', 'pkgver': '7.0.15-0ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'php7.0-mysql', 'pkgver': '7.0.15-0ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'php7.0-odbc', 'pkgver': '7.0.15-0ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'php7.0-opcache', 'pkgver': '7.0.15-0ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'php7.0-pgsql', 'pkgver': '7.0.15-0ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'php7.0-phpdbg', 'pkgver': '7.0.15-0ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'php7.0-pspell', 'pkgver': '7.0.15-0ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'php7.0-readline', 'pkgver': '7.0.15-0ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'php7.0-recode', 'pkgver': '7.0.15-0ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'php7.0-snmp', 'pkgver': '7.0.15-0ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'php7.0-soap', 'pkgver': '7.0.15-0ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'php7.0-sqlite3', 'pkgver': '7.0.15-0ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'php7.0-sybase', 'pkgver': '7.0.15-0ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'php7.0-tidy', 'pkgver': '7.0.15-0ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'php7.0-xml', 'pkgver': '7.0.15-0ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'php7.0-xmlrpc', 'pkgver': '7.0.15-0ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'php7.0-xsl', 'pkgver': '7.0.15-0ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'php7.0-zip', 'pkgver': '7.0.15-0ubuntu0.16.04.2'}
];
