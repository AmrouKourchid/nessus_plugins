...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2019-1279.html");
...
var pkgs = [
    ...
    {'reference':'pacemaker-cluster-libs-2.0.1-4.el8_0.3', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pacemaker-libs-2.0.1-4.el8_0.3', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pacemaker-schemas-2.0.1-4.el8_0.3', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
