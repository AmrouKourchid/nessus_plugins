...
if (description)
{
  ...
  script_name(english:"Adobe Photoshop 22.x < 22.5.2 Multiple Vulnerabilities (APSB21-109)");

  script_set_attribute(attribute:"synopsis", value:
"Adobe Photoshop installed on remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Photoshop installed on the remote Windows host is prior to 22.5.2. It is, therefore, affected by
multiple vulnerabilities as referenced in the apsb21-109 advisory.
  ...
  - Adobe Photoshop version 22.5.1 and earlier versions are affected by an out-of-bounds read vulnerability
    ...
    a malicious file. (CVE-2021-42734)

  - Buffer Overflow (CWE-120) potentially leading to Arbitrary code execution (CVE-2021-42736)
...
"Upgrade to Adobe Photoshop version 22.5.2 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-42735");
