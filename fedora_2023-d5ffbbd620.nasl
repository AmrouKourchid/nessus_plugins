...
# extracted from Fedora Security Advisory FEDORA-2023-d5ffbbd620
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-d5ffbbd620");

  script_name(english:"Fedora 39 : slurm (2023-d5ffbbd620)");
...
FEDORA-2023-d5ffbbd620 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-d5ffbbd620");
...
var pkgs = [
    {'reference':'slurm-22.05.10-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
