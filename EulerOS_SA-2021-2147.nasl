...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.2 : lldpad (EulerOS-SA-2021-2147)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2147
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8c5cf2b3");
...
pkgs = ["lldpad-1.0.1-3.h3.git036e314.eulerosv2r7"];
