...
# extracted from Fedora Security Advisory FEDORA-2023-5029b92850
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-5029b92850");

  script_name(english:"Fedora 37 : pack (2023-5029b92850)");
...
FEDORA-2023-5029b92850 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-5029b92850");
...
var pkgs = [
    {'reference':'pack-0.32.0-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
