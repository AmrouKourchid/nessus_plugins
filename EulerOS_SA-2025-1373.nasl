...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : python3 (EulerOS-SA-2025-1373)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1373
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5a5ef852");
...
var pkgs = [
  "python3-3.9.9-7.h32.eulerosv2r11",
  "python3-unversioned-command-3.9.9-7.h32.eulerosv2r11"
];
