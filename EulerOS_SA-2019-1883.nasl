...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : SDL (EulerOS-SA-2019-1883)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1883
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7056cb58");
...
pkgs = ["SDL-1.2.15-14.h3.eulerosv2r7",
        "SDL-devel-1.2.15-14.h3.eulerosv2r7"];
