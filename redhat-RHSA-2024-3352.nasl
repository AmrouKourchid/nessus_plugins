...
# extracted from Red Hat Security Advisory RHSA-2024:3352. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:3352");

  script_name(english:"RHEL 8 : Red Hat OpenStack Platform 16.2 (etcd) (RHSA-2024:3352)");
...
referenced in the RHSA-2024:3352 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_3352.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?db3221d8");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:3352");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat OpenStack Platform 16.2 (etcd) package based on the guidance in RHSA-2024:3352.");
