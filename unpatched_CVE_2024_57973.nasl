...
if (description)
{
  ...
  script_cve_id("CVE-2024-57973");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-57973");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: rdma/cxgb4: Prevent potential integer
    overflow on 32bit The gl->tot_len variable is controlled by the user. It comes from process_responses().
    On 32bit systems, the gl->tot_len + sizeof(struct cpl_pass_accept_req) + sizeof(struct rss_header)
    addition could have an integer wrapping bug. Use size_add() to prevent this. (CVE-2024-57973)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-57973");
