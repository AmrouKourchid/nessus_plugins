...
# Rocky Linux Security Advisory RLSA-2021:3918.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2021:3918");

  script_name(english:"Rocky Linux 8 : redis:5 (RLSA-2021:3918)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Rocky Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Rocky Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
RLSA-2021:3918 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2021:3918");
...
var appstreams = {
    'redis:5': [
      {'reference':'redis-5.0.3-5.module+el8.4.0+659+cf535ef1', 'cpu':'aarch64', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'redis-5.0.3-5.module+el8.4.0+659+cf535ef1', 'cpu':'x86_64', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'redis-5.0.3-5.module+el8.5.0+657+2674830e', 'cpu':'aarch64', 'release':'8', 'el_string':'el8.5.0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'redis-5.0.3-5.module+el8.5.0+657+2674830e', 'cpu':'x86_64', 'release':'8', 'el_string':'el8.5.0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'redis-debuginfo-5.0.3-5.module+el8.4.0+659+cf535ef1', 'cpu':'aarch64', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'redis-debuginfo-5.0.3-5.module+el8.4.0+659+cf535ef1', 'cpu':'x86_64', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'redis-debuginfo-5.0.3-5.module+el8.5.0+657+2674830e', 'cpu':'aarch64', 'release':'8', 'el_string':'el8.5.0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'redis-debuginfo-5.0.3-5.module+el8.5.0+657+2674830e', 'cpu':'x86_64', 'release':'8', 'el_string':'el8.5.0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'redis-debugsource-5.0.3-5.module+el8.4.0+659+cf535ef1', 'cpu':'aarch64', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'redis-debugsource-5.0.3-5.module+el8.4.0+659+cf535ef1', 'cpu':'x86_64', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'redis-debugsource-5.0.3-5.module+el8.5.0+657+2674830e', 'cpu':'aarch64', 'release':'8', 'el_string':'el8.5.0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'redis-debugsource-5.0.3-5.module+el8.5.0+657+2674830e', 'cpu':'x86_64', 'release':'8', 'el_string':'el8.5.0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'redis-devel-5.0.3-5.module+el8.4.0+659+cf535ef1', 'cpu':'aarch64', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'redis-devel-5.0.3-5.module+el8.4.0+659+cf535ef1', 'cpu':'x86_64', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'redis-devel-5.0.3-5.module+el8.5.0+657+2674830e', 'cpu':'aarch64', 'release':'8', 'el_string':'el8.5.0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'redis-devel-5.0.3-5.module+el8.5.0+657+2674830e', 'cpu':'x86_64', 'release':'8', 'el_string':'el8.5.0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'redis-doc-5.0.3-5.module+el8.4.0+659+cf535ef1', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'redis-doc-5.0.3-5.module+el8.5.0+657+2674830e', 'release':'8', 'el_string':'el8.5.0', 'rpm_spec_vers_cmp':TRUE}
    ]
};
