...
# extracted from Fedora Security Advisory FEDORA-2020-6af1dd2936.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : curl (2020-6af1dd2936)");
...
"- avoid overwriting a local file with -J (CVE-2020-8177)
  ...
  - fix partial password leak over DNS on HTTP redirect
    (CVE-2020-8169)
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-6af1dd2936");
...
flag = 0;
if (rpm_check(release:"FC32", reference:"curl-7.69.1-4.fc32")) flag++;
