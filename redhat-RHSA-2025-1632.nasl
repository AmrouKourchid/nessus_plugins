...
# extracted from Red Hat Security Advisory RHSA-2025:1632. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:1632");

  script_name(english:"RHEL 8 : redhat-ds:11 (RHSA-2025:1632)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for redhat-ds:11.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2025:1632 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_1632.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?eb5971fa");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:1632");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL redhat-ds:11 package based on the guidance in RHSA-2025:1632.");
...
var appstreams = {
  'redhat-ds:11': [
    {
      'repo_relative_urls': [
        'content/e4s/rhel8/8.6/x86_64/dirsrv/11/debug',
        'content/e4s/rhel8/8.6/x86_64/dirsrv/11/os',
        'content/e4s/rhel8/8.6/x86_64/dirsrv/11/source/SRPMS'
      ],
      'pkgs': [
        {'reference':'389-ds-base-1.4.3.34-4.module+el8dsrv+22781+5fe99dde', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'389-ds-base-devel-1.4.3.34-4.module+el8dsrv+22781+5fe99dde', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'389-ds-base-legacy-tools-1.4.3.34-4.module+el8dsrv+22781+5fe99dde', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'389-ds-base-libs-1.4.3.34-4.module+el8dsrv+22781+5fe99dde', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'389-ds-base-snmp-1.4.3.34-4.module+el8dsrv+22781+5fe99dde', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'cockpit-389-ds-1.4.3.34-4.module+el8dsrv+22781+5fe99dde', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
        {'reference':'python3-lib389-1.4.3.34-4.module+el8dsrv+22781+5fe99dde', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
