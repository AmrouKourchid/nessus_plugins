...
# extracted from Fedora Security Advisory FEDORA-2019-9a0f02c8c8.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-9a0f02c8c8");

  script_name(english:"Fedora 30 : upx (2019-9a0f02c8c8)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-9a0f02c8c8");
...
"Update the affected upx package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-14296");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"upx-3.95-4.fc30")) flag++;
