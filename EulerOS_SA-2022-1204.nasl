...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : git (EulerOS-SA-2022-1204)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1204
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?73675433");
...
var pkgs = [
  "git-2.27.0-2.h4.eulerosv2r10",
  "git-help-2.27.0-2.h4.eulerosv2r10",
  "perl-Git-2.27.0-2.h4.eulerosv2r10"
];
