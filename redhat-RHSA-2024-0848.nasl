...
# extracted from Red Hat Security Advisory RHSA-2024:0848. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:0848");

  script_name(english:"RHEL 9 : .NET 8.0 (RHSA-2024:0848)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for .NET 8.0.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:0848 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0848.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?76d20571");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-23938");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0848");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL .NET 8.0 package based on the guidance in RHSA-2024:0848.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'aspnetcore-runtime-8.0-8.0.2-2.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'aspnetcore-runtime-dbg-8.0-8.0.2-2.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'aspnetcore-targeting-pack-8.0-8.0.2-2.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-apphost-pack-8.0-8.0.2-2.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-host-8.0.2-2.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-hostfxr-8.0-8.0.2-2.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-runtime-8.0-8.0.2-2.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-runtime-dbg-8.0-8.0.2-2.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-sdk-8.0-8.0.102-2.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-sdk-8.0-source-built-artifacts-8.0.102-2.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-sdk-dbg-8.0-8.0.102-2.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-targeting-pack-8.0-8.0.2-2.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-templates-8.0-8.0.102-2.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'netstandard-targeting-pack-2.1-8.0.102-2.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
