...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Libssh2 PHSA-2024-5.0-0188");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'libssh2-1.11.0-2.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'libssh2-devel-1.11.0-2.ph5')) flag++;
