...
# extracted from Fedora Security Advisory FEDORA-2020-2684e0fadd.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : xen (2020-2684e0fadd)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-2684e0fadd");
...
flag = 0;
if (rpm_check(release:"FC32", reference:"xen-4.13.2-2.fc32")) flag++;
