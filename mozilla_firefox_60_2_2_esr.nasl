...
if (description)
{
  ...
  script_name(english:"Mozilla Firefox ESR < 60.2.2 Multiple Vulnerabilities");
...
host is prior to 60.2.2. It is, therefore, affected by multiple
...
mozilla_check_version(installs:installs, product:'firefox', esr:TRUE, fix:'60.2.2', min:'60.0', severity:SECURITY_WARNING);
