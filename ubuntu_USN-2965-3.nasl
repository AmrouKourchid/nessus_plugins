...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS : Linux kernel (Raspberry Pi 2) vulnerabilities (USN-2965-3)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2965-3");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-2965-3');
}
