...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : Linux kernel (Xenial HWE) regression (USN-3509-4)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3509-4");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.4.0-1006-aws");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-3509-4');
}
