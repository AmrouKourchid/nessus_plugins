...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : tar (EulerOS-SA-2021-2036)");
...
following vulnerability :
  ...
  - A flaw was found in the src/list.c of tar. This flaw
    allows an attacker who can submit a crafted input file
    to tar to cause uncontrolled consumption of memory. The
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2036
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?118b50f6");
...
pkgs = ["tar-1.26-34.h4.eulerosv2r7"];
