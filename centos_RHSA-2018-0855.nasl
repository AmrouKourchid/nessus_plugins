...
# CentOS Errata and Security Advisory 2018:0855 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : ntp (CESA-2018:0855)");
...
Enterprise Linux 7.5 Release Notes linked from the References section.");
  # https://lists.centos.org/pipermail/centos-cr-announce/2018-April/004998.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3cbc9e8e");
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"ntp-4.2.6p5-28.el7.centos")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"ntp-doc-4.2.6p5-28.el7.centos")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"ntp-perl-4.2.6p5-28.el7.centos")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"ntpdate-4.2.6p5-28.el7.centos")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"sntp-4.2.6p5-28.el7.centos")) flag++;
