...
# extracted from Fedora Security Advisory FEDORA-2024-19f696f0ca
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-19f696f0ca");

  script_name(english:"Fedora 39 : python2.7 (2024-19f696f0ca)");
...
FEDORA-2024-19f696f0ca advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-19f696f0ca");
...
var pkgs = [
    {'reference':'python2.7-2.7.18-43.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
