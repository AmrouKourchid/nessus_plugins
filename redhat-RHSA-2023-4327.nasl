...
# extracted from Red Hat Security Advisory RHSA-2023:4327. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:4327");
  script_xref(name:"IAVB", value:"2023-B-0034-S");

  script_name(english:"RHEL 9 : postgresql:15 (RHSA-2023:4327)");
...
referenced in the RHSA-2023:4327 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_4327.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4a6ef431");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:4327");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL postgresql:15 package based on the guidance in RHSA-2023:4327.");
  ...
  'postgresql:15': [
    {
      ...
      'pkgs': [
        ...
        {'reference':'postgresql-15.3-1.module+el9.2.0.z+19113+6f5d9d63', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-contrib-15.3-1.module+el9.2.0.z+19113+6f5d9d63', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-docs-15.3-1.module+el9.2.0.z+19113+6f5d9d63', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plperl-15.3-1.module+el9.2.0.z+19113+6f5d9d63', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plpython3-15.3-1.module+el9.2.0.z+19113+6f5d9d63', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-pltcl-15.3-1.module+el9.2.0.z+19113+6f5d9d63', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-private-devel-15.3-1.module+el9.2.0.z+19113+6f5d9d63', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-private-libs-15.3-1.module+el9.2.0.z+19113+6f5d9d63', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-15.3-1.module+el9.2.0.z+19113+6f5d9d63', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-devel-15.3-1.module+el9.2.0.z+19113+6f5d9d63', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-static-15.3-1.module+el9.2.0.z+19113+6f5d9d63', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-15.3-1.module+el9.2.0.z+19113+6f5d9d63', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-rpm-macros-15.3-1.module+el9.2.0.z+19113+6f5d9d63', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-upgrade-15.3-1.module+el9.2.0.z+19113+6f5d9d63', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-upgrade-devel-15.3-1.module+el9.2.0.z+19113+6f5d9d63', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
      ]
    },
    {
      'repo_relative_urls': [
      ...
      'pkgs': [
        ...
        {'reference':'postgresql-15.3-1.module+el9.2.0.z+19113+6f5d9d63', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-contrib-15.3-1.module+el9.2.0.z+19113+6f5d9d63', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-docs-15.3-1.module+el9.2.0.z+19113+6f5d9d63', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plperl-15.3-1.module+el9.2.0.z+19113+6f5d9d63', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plpython3-15.3-1.module+el9.2.0.z+19113+6f5d9d63', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-pltcl-15.3-1.module+el9.2.0.z+19113+6f5d9d63', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-private-devel-15.3-1.module+el9.2.0.z+19113+6f5d9d63', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-private-libs-15.3-1.module+el9.2.0.z+19113+6f5d9d63', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-15.3-1.module+el9.2.0.z+19113+6f5d9d63', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-devel-15.3-1.module+el9.2.0.z+19113+6f5d9d63', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-static-15.3-1.module+el9.2.0.z+19113+6f5d9d63', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-15.3-1.module+el9.2.0.z+19113+6f5d9d63', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-rpm-macros-15.3-1.module+el9.2.0.z+19113+6f5d9d63', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-upgrade-15.3-1.module+el9.2.0.z+19113+6f5d9d63', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-upgrade-devel-15.3-1.module+el9.2.0.z+19113+6f5d9d63', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
