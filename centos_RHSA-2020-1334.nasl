...
# extracted from Red Hat Security Advisory RHSA-2020:1334.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : telnet (RHSA-2020:1334)");
...
var pkgs = [
    {'reference':'telnet-server-0.17-65.el7_8', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'telnet-server-0.17-65.el7_8', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
