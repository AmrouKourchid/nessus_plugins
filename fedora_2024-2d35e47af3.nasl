...
# extracted from Fedora Security Advisory FEDORA-2024-2d35e47af3
#
...
if (description)
{
  ...
  script_cve_id("CVE-2023-2700", "CVE-2023-3750");
  script_xref(name:"FEDORA", value:"2024-2d35e47af3");

  script_name(english:"Fedora 38 : libvirt (2024-2d35e47af3)");
...
FEDORA-2024-2d35e47af3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-2d35e47af3");
...
var pkgs = [
    {'reference':'libvirt-9.0.0-4.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
