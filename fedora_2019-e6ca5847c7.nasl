...
# extracted from Fedora Security Advisory FEDORA-2019-e6ca5847c7.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-e6ca5847c7");

  script_name(english:"Fedora 28 : python-django (2019-e6ca5847c7)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-e6ca5847c7");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"python-django-2.0.10-1.fc28")) flag++;
