...
# extracted from Gentoo Linux Security Advisory GLSA 202107-47.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202107-47");

  script_name(english:"GLSA-202107-47 : libpano13: Format string vulnerability");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202107-47
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202107-47"
  );
  script_set_attribute(
    attribute:"solution",
    value:
"All libpano13 users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:libpano13");
...
if (qpkg_check(package:"media-libs/libpano13", unaffected:make_list("ge 2.9.20"), vulnerable:make_list("lt 2.9.20"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "libpano13");
}
