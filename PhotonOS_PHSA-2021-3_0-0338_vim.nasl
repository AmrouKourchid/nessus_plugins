...
# extracted from VMware Security Advisory PHSA-2021-3.0-0338. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Vim PHSA-2021-3.0-0338");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the vim package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-3.0-338.md");
