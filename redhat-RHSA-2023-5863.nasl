...
# extracted from Red Hat Security Advisory RHSA-2023:5863. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_5863.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c9fcc4b9");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:5863");
...
"Update the RHEL grafana package based on the guidance in RHSA-2023:5863.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'grafana-7.5.15-5.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'grafana-7.5.15-5.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
