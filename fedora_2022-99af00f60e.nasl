...
# extracted from Fedora Security Advisory FEDORA-2022-99af00f60e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-99af00f60e");
  script_xref(name:"IAVB", value:"2022-B-0048-S");

  script_name(english:"Fedora 35 : xen (2022-99af00f60e)");
...
FEDORA-2022-99af00f60e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-99af00f60e");
...
var pkgs = [
    {'reference':'xen-4.15.3-7.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
