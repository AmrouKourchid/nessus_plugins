...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS : OpenJDK 8 vulnerabilities (USN-3121-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 16.04 LTS host has packages installed that are affected by multiple vulnerabilities as referenced in
the USN-3121-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3121-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'openjdk-8-demo', 'pkgver': '8u111-b14-2ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'openjdk-8-jdk', 'pkgver': '8u111-b14-2ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'openjdk-8-jdk-headless', 'pkgver': '8u111-b14-2ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'openjdk-8-jre', 'pkgver': '8u111-b14-2ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'openjdk-8-jre-headless', 'pkgver': '8u111-b14-2ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'openjdk-8-jre-jamvm', 'pkgver': '8u111-b14-2ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'openjdk-8-jre-zero', 'pkgver': '8u111-b14-2ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'openjdk-8-source', 'pkgver': '8u111-b14-2ubuntu0.16.04.2'}
];
