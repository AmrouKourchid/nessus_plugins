...
# extracted from Red Hat Security Advisory RHSA-2019:0487. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:0487");

  script_name(english:"RHEL 7 : docker (RHSA-2019:0487)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for docker.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2019:0487 advisory.
    ...
    * Director deployed OCP 3.11 deployment fails with openshift-ansible getting stuck when restarting docker
    service on master nodes (BZ#1671861)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_0487.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f6564105");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:0487");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1645591");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1660876");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1661443");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1666565");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1668042");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1671861");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1678096");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL docker package based on the guidance in RHSA-2019:0487.");
...
var constraints = [
  {
    'repo_relative_urls': [
      'content/dist/rhel-alt/server/7/7Server/armv8-a/aarch64/extras/debug',
      'content/dist/rhel-alt/server/7/7Server/armv8-a/aarch64/extras/os',
      'content/dist/rhel-alt/server/7/7Server/armv8-a/aarch64/extras/source/SRPMS',
    ...
    'pkgs': [
      {'reference':'docker-1.13.1-94.gitb2f74b2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'docker-client-1.13.1-94.gitb2f74b2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'docker-common-1.13.1-94.gitb2f74b2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'docker-logrotate-1.13.1-94.gitb2f74b2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'docker-lvm-plugin-1.13.1-94.gitb2f74b2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'docker-novolume-plugin-1.13.1-94.gitb2f74b2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'docker-rhel-push-plugin-1.13.1-94.gitb2f74b2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'docker-v1.10-migrator-1.13.1-94.gitb2f74b2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
    ]
  }
];
