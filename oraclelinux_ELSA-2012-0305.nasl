...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2012-0305.html");
  script_set_attribute(attribute:"solution", value:
"Update the affected boost, boost-devel and / or boost-doc packages.");
