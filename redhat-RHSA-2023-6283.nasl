...
# extracted from Red Hat Security Advisory RHSA-2023:6283. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2023-3972");
  script_xref(name:"RHSA", value:"2023:6283");

  script_name(english:"RHEL 8 : insights-client (RHSA-2023:6283)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for insights-client.");
...
the RHSA-2023:6283 advisory.

    Red Hat Insights is a service that provides analysis of registered Red Hat-based systems. The insights-
    client package can gather the required data (such as installed packages, running services, or software
    configurations) to proactively identify threats to security, performance, and stability across your
    environment.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6283.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?18b098b3");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2227027");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6283");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL insights-client package based on the guidance in RHSA-2023:6283.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:S/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:L/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-3972");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:insights-client");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'insights-client-3.2.2-1.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'insights-client-3.2.2-1.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'insights-client');
}
