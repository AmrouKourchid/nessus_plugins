...
if (description)
{
  ...
  script_cve_id("CVE-2024-21069");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-21069");
...
patch available.
  ...
  - Vulnerability in the MySQL Server product of Oracle MySQL (component: Server: DDL). Supported versions
    ...
    crash (complete DOS) of MySQL Server. (CVE-2024-21069)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-21069");
