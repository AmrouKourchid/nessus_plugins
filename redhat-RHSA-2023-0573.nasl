...
# extracted from Red Hat Security Advisory RHSA-2023:0573. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:0573");

  script_name(english:"RHEL 8 : OpenShift Container Platform 4.9.55 (RHSA-2023:0573)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for OpenShift Container Platform 4.9.55.");
...
the RHSA-2023:0573 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.9.55. See the following
    ...
    * maven-shared-utils: Command injection via Commandline class
    ...
    when they are available in the appropriate release channel.

    To check for available updates, use the OpenShift CLI (oc) or web console. Instructions for upgrading a
    cluster are available at https://docs.openshift.com/container-platform/4.9/updating/updating-cluster-
    cli.html
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?70fd6f9c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:0573");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.9.55 package based on the guidance in RHSA-2023:0573.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jenkins-2-plugins-4.9.1674644684-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
