...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2013-1569.html");
...
"Update the affected wireshark, wireshark-devel and / or wireshark-gnome packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2013-5721");
...
var pkgs = [
    {'reference':'wireshark-1.8.10-4.0.1.el6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'wireshark-devel-1.8.10-4.0.1.el6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'wireshark-gnome-1.8.10-4.0.1.el6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'wireshark-1.8.10-4.0.1.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'wireshark-devel-1.8.10-4.0.1.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'wireshark-gnome-1.8.10-4.0.1.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
];
