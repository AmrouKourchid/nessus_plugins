...
if (description)
{
  ...
  script_cve_id("CVE-2024-38625");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-38625");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: fs/ntfs3: Check 'folio' pointer for
    NULL It can be NULL if bmap is called. (CVE-2024-38625)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-38625");
