...
if (description)
{
  ...
  script_cve_id("CVE-2024-46732");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-46732");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: drm/amd/display: Assign
    linear_pitch_alignment even for VM [Description] Assign linear_pitch_alignment so we don't cause a divide
    by 0 error in VM environments (CVE-2024-46732)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-46732");
