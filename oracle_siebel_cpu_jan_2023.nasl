...
if (description)
{
  ...
  script_cve_id("CVE-2021-44832", "CVE-2022-2274");

  script_name(english:"Oracle Siebel Server (January 2023 CPU)");
...
the January 2023 CPU advisory.
  ...
  - Vulnerability in the Siebel CRM product of Oracle Siebel CRM (component: Siebel Core - Server
    Infrastructure (OpenSSL)). Supported versions that are affected are 22.10 and prior. Easily exploitable
  ...
  - Vulnerability in the Siebel Apps - Marketing product of Oracle Siebel CRM (component: Marketing (Apache
    Log4j)). Supported versions that are affected are 22.10 and prior. Difficult to exploit vulnerability
    allows high privileged attacker with network access via HTTP to compromise Siebel Apps - Marketing.
    Successful attacks of this vulnerability can result in takeover of Siebel Apps - Marketing.
    (CVE-2021-44832)

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.oracle.com/docs/tech/security-alerts/cpujan2023csaf.json");
...
var constraints = [
  { 'max_version' : '22.10.999', 'fixed_version' : '22.12' }
];
