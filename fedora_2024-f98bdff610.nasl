...
# extracted from Fedora Security Advisory FEDORA-2024-f98bdff610
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-f98bdff610");

  script_name(english:"Fedora 38 : jose (2024-f98bdff610)");
...
FEDORA-2024-f98bdff610 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-f98bdff610");
...
var pkgs = [
    {'reference':'jose-13-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
