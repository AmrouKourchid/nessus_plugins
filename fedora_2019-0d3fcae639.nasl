...
# extracted from Fedora Security Advisory FEDORA-2019-0d3fcae639.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : python2 / python2-docs (2019-0d3fcae639)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-0d3fcae639");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"python2-2.7.17-1.fc31")) flag++;
if (rpm_check(release:"FC31", reference:"python2-docs-2.7.17-1.fc31")) flag++;
