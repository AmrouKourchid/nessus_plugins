...
# AlmaLinux Security Advisory ALSA-2023:4099.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:4099");
  script_xref(name:"IAVA", value:"2023-A-0320-S");

  script_name(english:"AlmaLinux 9 : bind (ALSA-2023:4099)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2023-4099.html");
