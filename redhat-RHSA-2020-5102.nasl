...
# extracted from Red Hat Security Advisory RHSA-2020:5102. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2020-2252", "CVE-2020-2254", "CVE-2020-2255");
  script_xref(name:"RHSA", value:"2020:5102");

  script_name(english:"RHEL 7 : OpenShift Container Platform 3.11.318 jenkins-2-plugins (RHSA-2020:5102)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for OpenShift Container Platform 3.11.318
jenkins-2-plugins.");
...
referenced in the RHSA-2020:5102 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_5102.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8b7b85cf");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:5102");
...
"Update the RHEL OpenShift Container Platform 3.11.318 jenkins-2-plugins package based on the guidance in RHSA-2020:5102.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:P/I:P/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:L/UI:N/S:U/C:H/I:N/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-2252");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2020-2254");

  script_set_attribute(attribute:"exploitability_ease", value:"No known exploits are available");
  script_set_attribute(attribute:"exploit_available", value:"false");
  script_cwe_id(22, 297, 862);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jenkins-2-plugins-3.11.1603460090-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-ansible'}
    ]
  }
];
