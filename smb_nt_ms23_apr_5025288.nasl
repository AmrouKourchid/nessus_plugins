...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5025285");
  script_xref(name:"MSKB", value:"5025288");
  script_xref(name:"MSFT", value:"MS23-5025285");
  script_xref(name:"MSFT", value:"MS23-5025288");
  ...
  script_name(english:"KB5025288: Windows 8.1 Embedded and Windows Server 2012 R2 Security Update (April 2023)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5025288. It is, therefore, affected by multiple vulnerabilities
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5025285");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5025288");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5025288 or Cumulative Update 5025285");
...
if (
  smb_check_rollup(os:'6.3',
                   ...
                   rollup_date:'04_2023',
                   bulletin:bulletin,
                   rollup_kb_list:[5025288, 5025285])
)
{
