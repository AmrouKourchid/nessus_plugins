...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : p11-kit (EulerOS-SA-2021-1507)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the version of the p11-kit packages installed, the
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1507
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?91c287c9");
  script_set_attribute(attribute:"solution", value:
"Update the affected p11-kit package.");
...
pkgs = ["p11-kit-0.23.5-3.h1.eulerosv2r7",
        "p11-kit-devel-0.23.5-3.h1.eulerosv2r7",
        "p11-kit-trust-0.23.5-3.h1.eulerosv2r7"];
