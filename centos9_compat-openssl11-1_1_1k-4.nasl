...
if (description)
{
  ...
  script_name(english:"CentOS 9 : compat-openssl11-1.1.1k-4.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update for compat-openssl11.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 9 host has a package installed that is affected by a vulnerability as referenced in the compat-
openssl11-1.1.1k-4.el9 build changelog.

  - Infinite loop in BN_mod_sqrt() reachable when parsing certificates (CVE-2022-0778)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=21529");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream compat-openssl11 package.");
...
var pkgs = [
    {'reference':'compat-openssl11-1.1.1k-4.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
