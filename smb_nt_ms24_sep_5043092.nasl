...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5043092");
  script_xref(name:"MSKB", value:"5043129");
  script_xref(name:"MSFT", value:"MS24-5043092");
  script_xref(name:"MSFT", value:"MS24-5043129");
  ...
  script_name(english:"KB5043092: Windows Server 2008 R2 Security Update (September 2024)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5043092");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5043129");
...
if (("windows server 2008 r2" >< tolower(os_name)) &&
  smb_check_rollup(os:'6.1',
                   ...
                   rollup_date:'09_2024',
                   bulletin:bulletin,
                   rollup_kb_list:[5043129, 5043092])
)
{
