...
# extracted from Fedora Security Advisory FEDORA-2025-e330d34ecc
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-e330d34ecc");

  script_name(english:"Fedora 41 : nodejs18 (2025-e330d34ecc)");
...
FEDORA-2025-e330d34ecc advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-e330d34ecc");
  script_set_attribute(attribute:"solution", value:
"Update the affected 1:nodejs18 package.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:S/C:C/I:P/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:L/UI:R/S:U/C:H/I:L/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-23084");
...
var pkgs = [
    {'reference':'nodejs18-18.20.6-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
