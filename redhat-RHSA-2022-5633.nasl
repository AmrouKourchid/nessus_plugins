...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_5633.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b9fac13f");
...
"Update the RHEL kernel-rt package based on the guidance in RHSA-2022:5633.");
  ...
  script_cwe_id(200, 287, 362, 366, 416);
