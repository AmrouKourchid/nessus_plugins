...
# extracted from Red Hat Security Advisory RHSA-2024:10949. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:10949");

  script_name(english:"RHEL 9 : php:8.2 (RHSA-2024:10949)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for php:8.2.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:10949 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-65837");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_10949.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a2d69d2b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:10949");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL php:8.2 package based on the guidance in RHSA-2024:10949.");
  ...
  'php:8.2': [
    {
      ...
      'pkgs': [
        {'reference':'apcu-panel-5.1.23-1.module+el9.4.0+20748+b46899d2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'php-8.2.25-1.module+el9.5.0+22477+5fdac06d', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'php-bcmath-8.2.25-1.module+el9.5.0+22477+5fdac06d', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'php-cli-8.2.25-1.module+el9.5.0+22477+5fdac06d', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'php-common-8.2.25-1.module+el9.5.0+22477+5fdac06d', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'php-dba-8.2.25-1.module+el9.5.0+22477+5fdac06d', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'php-dbg-8.2.25-1.module+el9.5.0+22477+5fdac06d', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'php-devel-8.2.25-1.module+el9.5.0+22477+5fdac06d', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'php-embedded-8.2.25-1.module+el9.5.0+22477+5fdac06d', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'php-enchant-8.2.25-1.module+el9.5.0+22477+5fdac06d', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'php-ffi-8.2.25-1.module+el9.5.0+22477+5fdac06d', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'php-fpm-8.2.25-1.module+el9.5.0+22477+5fdac06d', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'php-gd-8.2.25-1.module+el9.5.0+22477+5fdac06d', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'php-gmp-8.2.25-1.module+el9.5.0+22477+5fdac06d', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'php-intl-8.2.25-1.module+el9.5.0+22477+5fdac06d', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'php-ldap-8.2.25-1.module+el9.5.0+22477+5fdac06d', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'php-mbstring-8.2.25-1.module+el9.5.0+22477+5fdac06d', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'php-mysqlnd-8.2.25-1.module+el9.5.0+22477+5fdac06d', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'php-odbc-8.2.25-1.module+el9.5.0+22477+5fdac06d', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'php-opcache-8.2.25-1.module+el9.5.0+22477+5fdac06d', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'php-pdo-8.2.25-1.module+el9.5.0+22477+5fdac06d', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'php-pecl-apcu-5.1.23-1.module+el9.4.0+20748+b46899d2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'php-pecl-apcu-devel-5.1.23-1.module+el9.4.0+20748+b46899d2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'php-pecl-rrd-2.0.3-4.module+el9.4.0+20748+b46899d2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'php-pecl-xdebug3-3.2.2-2.module+el9.4.0+20796+bd4564df', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'php-pecl-zip-1.22.3-1.module+el9.4.0+20748+b46899d2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'php-pgsql-8.2.25-1.module+el9.5.0+22477+5fdac06d', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'php-process-8.2.25-1.module+el9.5.0+22477+5fdac06d', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'php-snmp-8.2.25-1.module+el9.5.0+22477+5fdac06d', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'php-soap-8.2.25-1.module+el9.5.0+22477+5fdac06d', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'php-xml-8.2.25-1.module+el9.5.0+22477+5fdac06d', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
