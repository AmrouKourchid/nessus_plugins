...
"The version of Firefox ESR installed on the remote Windows host is prior to 128.3. It is, therefore, affected by
multiple vulnerabilities as referenced in the mfsa2024-47 advisory.
...
mozilla_check_version(installs:installs, product:'firefox', esr:TRUE, fix:'128.3', min:'128.0.0', severity:SECURITY_HOLE);
