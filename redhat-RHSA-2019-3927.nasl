...
# extracted from Red Hat Security Advisory RHSA-2019:3927. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:3927");

  script_name(english:"RHEL 7 / 8 : ansible (RHSA-2019:3927)");
...
in the RHSA-2019:3927 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_3927.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9f16035f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:3927");
...
"Update the RHEL ansible package based on the guidance in RHSA-2019:3927.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ansible-2.9.1-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2.9'},
      {'reference':'ansible-test-2.9.1-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2.9'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'ansible-2.9.1-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2.9'},
      {'reference':'ansible-test-2.9.1-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2.9'}
    ]
  }
];
