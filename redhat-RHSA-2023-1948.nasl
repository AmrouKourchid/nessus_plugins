...
# extracted from Red Hat Security Advisory RHSA-2023:1948. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2022-37394");
  script_xref(name:"RHSA", value:"2023:1948");

  script_name(english:"RHEL 8 : Red Hat OpenStack Platform 16.2 (openstack-nova) (RHSA-2023:1948)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2051631");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2075467");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2084239");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2088676");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2117333");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2138381");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2140992");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2151410");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2158181");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2164970");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_1948.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?efe817f8");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:1948");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat OpenStack Platform 16.2 (openstack-nova) package based on the guidance in RHSA-2023:1948.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-37394");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openstack-nova-20.6.2-2.20230308185148.fc01371.el8ost', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'}
    ]
  }
];
