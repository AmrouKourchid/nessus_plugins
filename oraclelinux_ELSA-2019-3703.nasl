...
# extracted from Oracle Linux Security Advisory ELSA-2019-3703.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : libvorbis (ELSA-2019-3703)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ELSA-2019-3703 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2019-3703.html");
...
var pkgs = [
    ...
    {'reference':'libvorbis-devel-docs-1.3.6-2.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    ...
    {'reference':'libvorbis-devel-docs-1.3.6-2.el8', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    ...
    {'reference':'libvorbis-devel-docs-1.3.6-2.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
