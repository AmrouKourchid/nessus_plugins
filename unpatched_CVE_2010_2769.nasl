...
if (description)
{
  ...
  script_cve_id("CVE-2010-2769");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2010-2769");
...
patch available.
  ...
  - Cross-site scripting (XSS) vulnerability in Mozilla Firefox before 3.5.12 and 3.6.x before 3.6.9,
    ...
    designMode property is enabled. (CVE-2010-2769)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2010-2769");
