...
if (description)
{
  ...
  script_name(english:"Mozilla Thunderbird < 115.4");

  script_set_attribute(attribute:"synopsis", value:
"A mail client installed on the remote macOS or Mac OS X host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Thunderbird installed on the remote macOS or Mac OS X host is prior to 115.4. It is, therefore, affected
by multiple vulnerabilities as referenced in the mfsa2023-47 advisory.
...
"Upgrade to Mozilla Thunderbird version 115.4 or later.");
...
mozilla_check_version(version:version, path:path, product:'thunderbird', esr:FALSE, fix:'115.4', severity:SECURITY_HOLE);
