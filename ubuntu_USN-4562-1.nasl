...
# extracted from Ubuntu Security Notice USN-4562-1. The text
...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS : kramdown vulnerability (USN-4562-1)");
...
USN-4562-1 advisory.
    ...
    It was discovered that kramdown insecurely handled certain crafted input. An attacker could use this
    vulnerability to read restricted files or execute arbitrary code.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4562-1");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'kramdown', 'pkgver': '1.17.0-4ubuntu0.1'},
    {'osver': '20.04', 'pkgname': 'ruby-kramdown', 'pkgver': '1.17.0-4ubuntu0.1'}
];
