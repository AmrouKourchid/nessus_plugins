...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Libtirpc PHSA-2017-0017");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'libtirpc-1.0.1-4.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'libtirpc-debuginfo-1.0.1-4.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'libtirpc-devel-1.0.1-4.ph1')) flag++;
