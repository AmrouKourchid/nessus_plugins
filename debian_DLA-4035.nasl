...
# extracted from Debian Security Advisory dla-4035. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-4035 : flightgear - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has a package installed that is affected by a vulnerability as referenced in the dla-4035
advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/flightgear");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2025-0781");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bullseye/flightgear");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'flightgear', 'reference': '1:2020.3.6+dfsg-1+deb11u1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'flightgear');
}
