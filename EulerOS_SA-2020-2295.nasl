...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : poppler (EulerOS-SA-2020-2295)");
...
vulnerability :
  ...
  - freedesktop.org libpoppler 0.60.1 fails to validate
    boundaries in TextPool::addWord, leading to overflow in
    subsequent calculations.(CVE-2017-1000456)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2295
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ac31bfc4");
...
pkgs = ["poppler-0.26.5-17.h23.eulerosv2r7",
        "poppler-glib-0.26.5-17.h23.eulerosv2r7",
        "poppler-qt-0.26.5-17.h23.eulerosv2r7",
        "poppler-utils-0.26.5-17.h23.eulerosv2r7"];
