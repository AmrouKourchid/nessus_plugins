...
# extracted from Red Hat Security Advisory RHSA-2023:6631. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:6631");

  script_name(english:"RHEL 9 : glib2 (RHSA-2023:6631)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for glib2.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2023:6631 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6631.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c19c196b");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2217771");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6631");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL glib2 package based on the guidance in RHSA-2023:6631.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'glib2-2.68.4-11.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glib2-devel-2.68.4-11.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glib2-doc-2.68.4-11.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glib2-static-2.68.4-11.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glib2-tests-2.68.4-11.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
