...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5002472");
  script_xref(name:"MSFT", value:"MS23-5002472");
  script_xref(name:"IAVA", value:"2023-A-0479-S");

  script_name(english:"Security Updates for Microsoft SharePoint Server 2019 (September 2023)");
...
It is, therefore, affected by the following vulnerability:
  ...
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002472");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released KB5002472 to address this issue.");
