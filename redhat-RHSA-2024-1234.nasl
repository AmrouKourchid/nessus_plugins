...
# extracted from Red Hat Security Advisory RHSA-2024:1234. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:1234");

  script_name(english:"RHEL 8 : openvswitch2.17 (RHSA-2024:1234)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for openvswitch2.17.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:1234 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?19f53f7c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:1234");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2178363");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/FD-3267");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/FDP-308");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL openvswitch2.17 package based on the guidance in RHSA-2024:1234.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'network-scripts-openvswitch2.17-2.17.0-148.el8fdp', 'release':'8', 'el_string':'el8fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openvswitch'},
      {'reference':'openvswitch2.17-2.17.0-148.el8fdp', 'release':'8', 'el_string':'el8fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openvswitch'},
      {'reference':'openvswitch2.17-devel-2.17.0-148.el8fdp', 'release':'8', 'el_string':'el8fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openvswitch'},
      {'reference':'openvswitch2.17-ipsec-2.17.0-148.el8fdp', 'release':'8', 'el_string':'el8fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openvswitch'},
      {'reference':'openvswitch2.17-test-2.17.0-148.el8fdp', 'release':'8', 'el_string':'el8fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openvswitch'},
      {'reference':'python3-openvswitch2.17-2.17.0-148.el8fdp', 'release':'8', 'el_string':'el8fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openvswitch'}
    ]
  }
];
