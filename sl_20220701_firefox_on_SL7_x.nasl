...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"RHSA-2022:5479");

  script_name(english:"Scientific Linux Security Update : firefox on SL7.x i686/x86_64 (2022:5479)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.scientificlinux.org/category/sl-errata/slsa-20225479-1");
...
var pkgs = [
    {'reference':'firefox-91.11.0-2.el7_9', 'cpu':'i686', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-91.11.0-2.el7_9', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-debuginfo-91.11.0-2.el7_9', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
