...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS / 22.04 LTS : Dovecot vulnerability (USN-5509-1)");
...
referenced in the USN-5509-1 advisory.

    Julian Brook discovered that Dovecot incorrectly handled multiple passdb configuration entries. In certain
    configurations, a remote attacker could possibly use this issue to escalate privileges.
