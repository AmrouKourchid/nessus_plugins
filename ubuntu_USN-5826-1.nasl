...
# extracted from Ubuntu Security Notice USN-5826-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5826-1");

  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS : Privoxy vulnerabilities (USN-5826-1)");
...
referenced in the USN-5826-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5826-1");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'privoxy', 'pkgver': '3.0.26-5ubuntu0.3'},
    {'osver': '20.04', 'pkgname': 'privoxy', 'pkgver': '3.0.28-2ubuntu0.2'}
];
