...
if (description)
{
  ...
  script_name(english:"Adobe Audition < 23.6.9 / 24.0.0 < 24.6.0 Multiple Vulnerabilities (APSB24-54) (macOS)");

  script_set_attribute(attribute:"synopsis", value:
"The Adobe Audition instance installed on the remote host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Audition installed on the remote macOS host is prior to 23.6.9, 24.6.0. It is, therefore, affected
by multiple vulnerabilities as referenced in the APSB24-54 advisory.
