...
if (description)
{
  ...
  script_name(english:"Adobe Photoshop CC 19.x < 19.1.9 / CC 20.x < 20.0.6 Multiple Vulnerabilities (APSB19-44)");

  script_set_attribute(attribute:"synopsis", value:
"Adobe Photoshop installed on remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Photoshop CC installed on the remote Windows host is prior to 19.1.9/20.0.6. It is, therefore,
affected by multiple vulnerabilities as referenced in the apsb19-44 advisory.
