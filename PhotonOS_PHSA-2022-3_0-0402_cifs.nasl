...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Cifs PHSA-2022-3.0-0402");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'cifs-utils-6.8-4.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'cifs-utils-devel-6.8-4.ph3')) flag++;
