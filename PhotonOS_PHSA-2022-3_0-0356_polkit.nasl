...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Polkit PHSA-2022-3.0-0356");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'polkit-0.116-3.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'polkit-devel-0.116-3.ph3')) flag++;
