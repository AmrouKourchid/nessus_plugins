...
if (description)
{
  ...
  script_cve_id("CVE-2018-2632");

  script_name(english:"Oracle Siebel Server < 17.3 (January 2018 CPU)");
...
the January 2018 CPU advisory.
  ...
  - Vulnerability in the Siebel Engineering - Installer and Deployment component of Oracle Siebel CRM
    (subcomponent: Siebel Approval Manager). Supported versions that are affected are 17.3 and prior. Easily
    exploitable vulnerability allows low privileged attacker with network access via HTTP to compromise Siebel
    Engineering - Installer and Deployment. Successful attacks of this vulnerability can result in
    unauthorized read access to a subset of Siebel Engineering - Installer and Deployment accessible data.
    (CVE-2018-2632)
...
"Apply the appropriate patch according to the January 2018 Oracle Critical Patch Update advisory.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-2632");
