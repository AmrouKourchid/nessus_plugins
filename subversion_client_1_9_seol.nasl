...
if (description)
{
  ...
  script_name(english:"Apache Subversion Client SEoL (1.9.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Apache Subversion Client is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Apache Subversion Client is 1.9.x. It is, therefore, no longer maintained by its vendor or
provider.
