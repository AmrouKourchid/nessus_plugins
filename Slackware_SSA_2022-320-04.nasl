...
# extracted from Slackware Security Advisory SSA:2022-320-04. The text
...
if (description)
{
  ...
  script_name(english:"Slackware Linux 15.0 / current samba  Vulnerability (SSA:2022-320-04)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Slackware Linux host is missing a security update to samba.");
  script_set_attribute(attribute:"description", value:
"The version of samba installed on the remote host is prior to 4.15.12 / 4.17.3. It is, therefore, affected by a
vulnerability as referenced in the SSA:2022-320-04 advisory.
...
var flag = 0;
var constraints = [
    { 'fixed_version' : '4.15.12', 'product' : 'samba', 'os_name' : 'Slackware Linux', 'os_version' : '15.0', 'service_pack' : '1_slack15.0', 'arch' : 'i586' },
    { 'fixed_version' : '4.15.12', 'product' : 'samba', 'os_name' : 'Slackware Linux', 'os_version' : '15.0', 'service_pack' : '1_slack15.0', 'arch' : 'x86_64' },
    { 'fixed_version' : '4.17.3', 'product' : 'samba', 'os_name' : 'Slackware Linux', 'os_version' : 'current', 'service_pack' : '1', 'arch' : 'i586' },
    { 'fixed_version' : '4.17.3', 'product' : 'samba', 'os_name' : 'Slackware Linux', 'os_version' : 'current', 'service_pack' : '1', 'arch' : 'x86_64' }
];
