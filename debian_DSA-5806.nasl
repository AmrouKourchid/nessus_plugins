...
# extracted from Debian Security Advisory dsa-5806. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5806 : libarchive-dev - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 12 host has packages installed that are affected by a vulnerability as referenced in the dsa-5806
advisory.

    - -------------------------------------------------------------------------
    Debian Security Advisory DSA-5806-1                   security@debian.org
...
var pkgs = [
    {'release': '12.0', 'prefix': 'libarchive-dev', 'reference': '3.6.2-1+deb12u2'},
    {'release': '12.0', 'prefix': 'libarchive-tools', 'reference': '3.6.2-1+deb12u2'},
    {'release': '12.0', 'prefix': 'libarchive13', 'reference': '3.6.2-1+deb12u2'}
];
