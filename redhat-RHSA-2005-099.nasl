...
referenced in the RHSA-2005:099 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=145387");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=145967");
  script_set_attribute(attribute:"see_also", value:"http://www.squirrelmail.org/security/issue/2005-01-20");
  script_set_attribute(attribute:"see_also", value:"http://www.squirrelmail.org/security/issue/2005-01-19");
  script_set_attribute(attribute:"see_also", value:"http://www.squirrelmail.org/security/issue/2005-01-14");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2005/rhsa-2005_099.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b0ca0272");
  script_set_attribute(attribute:"see_also", value:"http://www.php.net/register_globals");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2005:099");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL squirrelmail package based on the guidance in RHSA-2005:099.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2005-0103");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'squirrelmail-1.4.3a-9.EL4', 'release':'4', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
