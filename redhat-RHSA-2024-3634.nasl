...
# extracted from Red Hat Security Advisory RHSA-2024:3634. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:3634");

  script_name(english:"RHEL 8 : Red Hat Product OCP Tools 4.14 OpenShift Jenkins (RHSA-2024:3634)");
...
referenced in the RHSA-2024:3634 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_3634.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9a1206a5");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:3634");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat Product OCP Tools 4.14 OpenShift Jenkins package based on the guidance in RHSA-2024:3634.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jenkins-2-plugins-4.14.1716388016-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'jenkins-2.440.3.1716387933-3.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
