...
if (description)
{
  ...
  script_cve_id("CVE-2024-58022");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-58022");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: mailbox: th1520: Fix a NULL vs
    IS_ERR() bug The devm_ioremap() function doesn't return error pointers, it returns NULL. Update the error
    checking to match. (CVE-2024-58022)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-58022");
