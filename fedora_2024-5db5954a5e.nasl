...
# extracted from Fedora Security Advisory FEDORA-2024-5db5954a5e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-5db5954a5e");

  script_name(english:"Fedora 38 : kernel (2024-5db5954a5e)");
...
FEDORA-2024-5db5954a5e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-5db5954a5e");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for FEDORA-2024-5db5954a5e');
  }
  else
  {
...
var pkgs = [
    {'reference':'kernel-6.7.9-100.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
