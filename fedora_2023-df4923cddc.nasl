...
# extracted from Fedora Security Advisory FEDORA-2023-df4923cddc
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-df4923cddc");

  script_name(english:"Fedora 38 : squid (2023-df4923cddc)");
...
FEDORA-2023-df4923cddc advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-df4923cddc");
...
var pkgs = [
    {'reference':'squid-6.4-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
];
