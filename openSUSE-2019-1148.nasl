...
# extracted from openSUSE Security Update openSUSE-2019-1148.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : gd (openSUSE-2019-1148)");
...
This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1123361");
...
if ( rpm_check(release:"SUSE15.0", reference:"gd-2.2.5-lp150.8.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"gd-debuginfo-2.2.5-lp150.8.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"gd-debugsource-2.2.5-lp150.8.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"gd-devel-2.2.5-lp150.8.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libgd3-2.2.5-lp150.8.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libgd3-debuginfo-2.2.5-lp150.8.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libgd3-32bit-2.2.5-lp150.8.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libgd3-32bit-debuginfo-2.2.5-lp150.8.1") ) flag++;
