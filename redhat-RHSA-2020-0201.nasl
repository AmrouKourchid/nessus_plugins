...
# extracted from Red Hat Security Advisory RHSA-2020:0201. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 8 : python-reportlab (RHSA-2020:0201)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_0201.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e4c35c06");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:0201");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1769661");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-reportlab package based on the guidance in RHSA-2020:0201.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:python3-reportlab");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-reportlab-3.4.0-6.el8_1.2', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-reportlab-3.4.0-6.el8_1.2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'python3-reportlab-3.4.0-6.el8_1.2', 'sp':'1', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-reportlab-3.4.0-6.el8_1.2', 'sp':'1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
