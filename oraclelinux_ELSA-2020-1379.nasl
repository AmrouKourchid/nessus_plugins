...
# extracted from Oracle Linux Security Advisory ELSA-2020-1379.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : container-tools:ol8 (ELSA-2020-1379)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
ELSA-2020-1379 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2020-1379.html");
...
var appstreams = {
    'container-tools:ol8': [
      {'reference':'buildah-1.11.6-6.0.1.module+el8.1.1+5573+1c3f6079', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'buildah-tests-1.11.6-6.0.1.module+el8.1.1+5573+1c3f6079', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'cockpit-podman-11-1.module+el8.1.1+5502+fbec5cc6', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'conmon-2.0.6-1.module+el8.1.1+5502+fbec5cc6', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'container-selinux-2.124.0-1.module+el8.1.1+5502+fbec5cc6', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      ...
      {'reference':'fuse-overlayfs-0.7.2-5.module+el8.1.1+5573+1c3f6079', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'podman-1.6.4-4.0.1.module+el8.1.1+5573+1c3f6079', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'podman-docker-1.6.4-4.0.1.module+el8.1.1+5573+1c3f6079', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'podman-manpages-1.6.4-4.0.1.module+el8.1.1+5573+1c3f6079', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'podman-remote-1.6.4-4.0.1.module+el8.1.1+5573+1c3f6079', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'podman-tests-1.6.4-4.0.1.module+el8.1.1+5573+1c3f6079', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python-podman-api-1.2.0-0.2.gitd0a45fe.module+el8.1.1+5502+fbec5cc6', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'runc-1.0.0-64.rc9.module+el8.1.1+5502+fbec5cc6', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'slirp4netns-0.4.2-3.git21fdece.module+el8.1.1+5573+1c3f6079', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'toolbox-0.0.4-1.module+el8.1.1+5502+fbec5cc6', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'udica-0.2.1-2.module+el8.1.1+5502+fbec5cc6', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'buildah-1.11.6-6.0.1.module+el8.1.1+5573+1c3f6079', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'buildah-tests-1.11.6-6.0.1.module+el8.1.1+5573+1c3f6079', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'cockpit-podman-11-1.module+el8.1.1+5502+fbec5cc6', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'conmon-2.0.6-1.module+el8.1.1+5502+fbec5cc6', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'container-selinux-2.124.0-1.module+el8.1.1+5502+fbec5cc6', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      ...
      {'reference':'fuse-overlayfs-0.7.2-5.module+el8.1.1+5573+1c3f6079', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'podman-1.6.4-4.0.1.module+el8.1.1+5573+1c3f6079', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'podman-docker-1.6.4-4.0.1.module+el8.1.1+5573+1c3f6079', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'podman-manpages-1.6.4-4.0.1.module+el8.1.1+5573+1c3f6079', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'podman-remote-1.6.4-4.0.1.module+el8.1.1+5573+1c3f6079', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'podman-tests-1.6.4-4.0.1.module+el8.1.1+5573+1c3f6079', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python-podman-api-1.2.0-0.2.gitd0a45fe.module+el8.1.1+5502+fbec5cc6', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'runc-1.0.0-64.rc9.module+el8.1.1+5502+fbec5cc6', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'slirp4netns-0.4.2-3.git21fdece.module+el8.1.1+5573+1c3f6079', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'toolbox-0.0.4-1.module+el8.1.1+5502+fbec5cc6', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'udica-0.2.1-2.module+el8.1.1+5502+fbec5cc6', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
};
