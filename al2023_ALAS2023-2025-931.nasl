...
# extracted from Amazon Linux 2023 Security Advisory ALAS2023-2025-931.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2023 : nerdctl (ALAS2023-2025-931)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2023 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"It is, therefore, affected by a vulnerability as referenced in the ALAS2023-2025-931 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2023/ALAS-2025-931.html");
...
"Run 'dnf update nerdctl --releasever 2023.7.20250414' to update your system.");
...
var pkgs = [
    {'reference':'nerdctl-2.0.4-1.amzn2023.0.1', 'cpu':'aarch64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'nerdctl-2.0.4-1.amzn2023.0.1', 'cpu':'x86_64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "nerdctl");
}
