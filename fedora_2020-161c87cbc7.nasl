...
# extracted from Fedora Security Advisory FEDORA-2020-161c87cbc7.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : chromium (2020-161c87cbc7)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-161c87cbc7");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"chromium-80.0.3987.163-1.fc31", allowmaj:TRUE)) flag++;
