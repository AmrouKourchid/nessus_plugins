...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : libgcrypt (EulerOS-SA-2022-1209)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the libgcrypt packages installed, the EulerOS installation on the remote host is affected
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1209
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?38c353ca");
...
"Update the affected libgcrypt packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:libgcrypt-help");
...
var pkgs = [
  "libgcrypt-1.8.6-2.h6.eulerosv2r10",
  "libgcrypt-devel-1.8.6-2.h6.eulerosv2r10",
  "libgcrypt-help-1.8.6-2.h6.eulerosv2r10"
];
