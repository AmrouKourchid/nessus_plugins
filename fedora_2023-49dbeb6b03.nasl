...
# extracted from Fedora Security Advisory FEDORA-2023-49dbeb6b03
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-49dbeb6b03");

  script_name(english:"Fedora 36 : libXpm (2023-49dbeb6b03)");
...
FEDORA-2023-49dbeb6b03 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-49dbeb6b03");
...
var pkgs = [
    {'reference':'libXpm-3.5.15-2.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
