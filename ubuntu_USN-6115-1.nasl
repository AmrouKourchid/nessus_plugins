...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS / 22.04 LTS / 23.04 : TeX Live vulnerability (USN-6115-1)");
...
vulnerability as referenced in the USN-6115-1 advisory.
    ...
    Max Chernoff discovered that LuaTeX (TeX Live) did not properly disable shell escape. An attacker could
