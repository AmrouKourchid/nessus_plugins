...
# extracted from Fedora Security Advisory FEDORA-2019-154930f99b.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-154930f99b");

  script_name(english:"Fedora 29 : znc (2019-154930f99b)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-154930f99b");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"znc-1.7.4-4.fc29")) flag++;
