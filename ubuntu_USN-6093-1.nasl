...
# extracted from Ubuntu Security Notice USN-6093-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6093-1");

  script_name(english:"Ubuntu 20.04 LTS : Linux kernel (BlueField) vulnerabilities (USN-6093-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6093-1");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.4.0-1062-bluefield");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-6093-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2022-3108', 'CVE-2022-3903', 'CVE-2022-4129', 'CVE-2023-0458', 'CVE-2023-1073', 'CVE-2023-1074', 'CVE-2023-1281', 'CVE-2023-1829', 'CVE-2023-26545');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-6093-1');
  }
  else
  {
