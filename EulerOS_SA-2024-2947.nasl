...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP12 : cups (EulerOS-SA-2024-2947)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2947
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9baeb12d");
...
var pkgs = [
  "cups-libs-2.4.0-4.h8.eulerosv2r12"
];
