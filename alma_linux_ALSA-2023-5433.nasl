...
# AlmaLinux Security Advisory ALSA-2023:5433.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:5433");
  ...
  script_name(english:"AlmaLinux 8 : firefox (ALSA-2023:5433)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2023-5433.html");
...
var pkgs = [
    {'reference':'firefox-115.3.1-1.el8_8.alma.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-115.3.1-1.el8_8.alma.1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
