...
# extracted from Amazon Linux 2 Security Advisory ALAS-2020-1470.
#
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : python-rsa (ALAS-2020-1470)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"It is, therefore, affected by a vulnerability as referenced in the ALAS2-2020-1470 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2020-1470.html");
...
var pkgs = [
    {'reference':'python2-rsa-3.4.1-1.amzn2.0.1', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "python2-rsa");
}
