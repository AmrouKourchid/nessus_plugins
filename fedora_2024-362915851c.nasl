...
# extracted from Fedora Security Advisory FEDORA-2024-362915851c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-362915851c");

  script_name(english:"Fedora 41 : yarnpkg (2024-362915851c)");
...
FEDORA-2024-362915851c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-362915851c");
...
var pkgs = [
    {'reference':'yarnpkg-1.22.22-5.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
