...
# extracted from Oracle Linux Security Advisory ELSA-2023-7010.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : sysstat (ELSA-2023-7010)");
...
ELSA-2023-7010 advisory.

    - fix the arithmetic overflow in allocate_structures() that is still possible on some 32 bit systems
    (CVE-2023-33204)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-7010.html");
...
var pkgs = [
    {'reference':'sysstat-11.7.3-11.0.1.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sysstat-11.7.3-11.0.1.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
