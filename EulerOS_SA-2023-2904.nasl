...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : perl (EulerOS-SA-2023-2904)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2904
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?04f094ec");
...
var pkgs = [
  "perl-5.28.0-434.h11.eulerosv2r9",
  "perl-libs-5.28.0-434.h11.eulerosv2r9"
];
