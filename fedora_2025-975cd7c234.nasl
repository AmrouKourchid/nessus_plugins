...
# extracted from Fedora Security Advisory FEDORA-2025-975cd7c234
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-975cd7c234");

  script_name(english:"Fedora 40 : chromium (2025-975cd7c234)");
...
FEDORA-2025-975cd7c234 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-975cd7c234");
...
var pkgs = [
    {'reference':'chromium-133.0.6943.53-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
