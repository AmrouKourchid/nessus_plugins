...
# extracted from Red Hat Security Advisory RHSA-2005:670. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 4 : xpdf (RHSA-2005:670)");
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2005/rhsa-2005_670.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?169f4ee9");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=163918");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2005:670");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL xpdf package based on the guidance in RHSA-2005:670.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'xpdf-3.00-11.8', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'xpdf-3.00-11.8', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'xpdf-3.00-11.8', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'xpdf-3.00-11.8', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'xpdf-3.00-11.8', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
