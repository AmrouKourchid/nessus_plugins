...
# extracted from Fedora Security Advisory FEDORA-2023-9d8fcaee88
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-9d8fcaee88");
  script_xref(name:"IAVA", value:"2023-A-0337-S");

  script_name(english:"Fedora 37 : firefox (2023-9d8fcaee88)");
...
FEDORA-2023-9d8fcaee88 advisory.

    - Updated to latest upstream (115.0.2)
    - Enabled LTO
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-9d8fcaee88");
...
var pkgs = [
    {'reference':'firefox-115.0.2-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
