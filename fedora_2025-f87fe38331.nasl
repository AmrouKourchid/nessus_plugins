...
# extracted from Fedora Security Advisory FEDORA-2025-f87fe38331
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-f87fe38331");

  script_name(english:"Fedora 40 : containernetworking-plugins (2025-f87fe38331)");
...
FEDORA-2025-f87fe38331 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-f87fe38331");
...
var pkgs = [
    {'reference':'containernetworking-plugins-1.5.1-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
