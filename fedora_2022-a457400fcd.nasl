...
# extracted from Fedora Security Advisory FEDORA-2022-a457400fcd
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-a457400fcd");

  script_name(english:"Fedora 38 : samba (2022-a457400fcd)");
...
FEDORA-2022-a457400fcd advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-a457400fcd");
...
var pkgs = [
    {'reference':'samba-4.17.0-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
