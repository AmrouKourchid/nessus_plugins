...
if (description)
{
  ...
  script_name(english:"Debian dla-3126 : libsndfile1 - security update");
...
advisory.
    ...
    - -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3126-1                debian-lts@lists.debian.org
...
"Upgrade the libsndfile1 packages.");
