...
# Rocky Linux Security Advisory RLSA-2023:5738.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2023:5738");
  script_xref(name:"IAVB", value:"2023-B-0080-S");
  script_xref(name:"CEA-ID", value:"CEA-2024-0004");

  script_name(english:"Rocky Linux 9 : go-toolset and golang (RLSA-2023:5738)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2023:5738");
...
var pkgs = [
    {'reference':'go-toolset-1.19.13-1.el9_2', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-1.19.13-1.el9_2', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-bin-1.19.13-1.el9_2', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
