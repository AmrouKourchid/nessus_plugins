...
if (description)
{
  ...
  script_cve_id("CVE-2024-2884");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-2884");
...
patch available.
  ...
  - Out of bounds read in V8 in Google Chrome prior to 121.0.6167.139 allowed a remote attacker to potentially
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-2884");
