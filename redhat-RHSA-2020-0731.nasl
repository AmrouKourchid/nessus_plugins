...
# extracted from Red Hat Security Advisory RHSA-2020:0731. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2020-1711");
  script_xref(name:"RHSA", value:"2020:0731");

  script_name(english:"RHEL 8 : virt:8.1 and virt-devel:8.1 (RHSA-2020:0731)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_0731.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d2363e2e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:0731");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1794290");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL virt:8.1 / virt-devel:8.1 packages based on the guidance in RHSA-2020:0731.");
  ...
  'virt:8.1': [
    {
      ...
      'pkgs': [
        ...
        {'reference':'qemu-guest-agent-4.1.0-23.module+el8.1.1+5748+5fcc84a8.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-img-4.1.0-23.module+el8.1.1+5748+5fcc84a8.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-4.1.0-23.module+el8.1.1+5748+5fcc84a8.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-block-curl-4.1.0-23.module+el8.1.1+5748+5fcc84a8.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-block-gluster-4.1.0-23.module+el8.1.1+5748+5fcc84a8.1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-block-iscsi-4.1.0-23.module+el8.1.1+5748+5fcc84a8.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-block-rbd-4.1.0-23.module+el8.1.1+5748+5fcc84a8.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-block-ssh-4.1.0-23.module+el8.1.1+5748+5fcc84a8.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-common-4.1.0-23.module+el8.1.1+5748+5fcc84a8.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-core-4.1.0-23.module+el8.1.1+5748+5fcc84a8.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
  ...
  'virt-devel:8.1': [
    {
      ...
      'pkgs': [
        ...
        {'reference':'qemu-kvm-tests-4.1.0-23.module+el8.1.1+5748+5fcc84a8.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
