...
# SUSE update advisory SUSE-SU-2021:4015-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2021:4015-1");
  script_xref(name:"IAVA", value:"2021-A-0263-S");
  script_xref(name:"IAVA", value:"2021-A-0497-S");

  script_name(english:"SUSE SLED15 / SLES15 Security Update : python3 (SUSE-SU-2021:4015-1)");
...
referenced in the SUSE-SU-2021:4015-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2021-December/009890.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?18ba0471");
  script_set_attribute(attribute:"solution", value:
"Update the affected python3-tools package.");
...
var pkgs = [
    {'reference':'python3-tools-3.6.15-3.91.3', 'sp':'2', 'release':'SLED15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-development-tools-release-15.2']},
    {'reference':'python3-tools-3.6.15-3.91.3', 'sp':'2', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-development-tools-release-15.2']}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python3-tools');
}
