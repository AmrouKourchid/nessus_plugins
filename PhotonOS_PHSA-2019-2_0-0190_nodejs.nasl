...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Nodejs PHSA-2019-2.0-0190");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'nodejs-8.11.4-2.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'nodejs-debuginfo-8.11.4-2.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'nodejs-devel-8.11.4-2.ph2')) flag++;
