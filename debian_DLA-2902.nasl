...
# extracted from Debian Security Advisory dla-2902. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2902-1 : graphicsmagick - LTS security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 9 host has packages installed that are affected by a vulnerability as referenced in the dla-2902
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2022/dla-2902");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2020-12672");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/stretch/graphicsmagick");
...
var pkgs = [
    {'release': '9.0', 'prefix': 'graphicsmagick', 'reference': '1.3.30+hg15796-1~deb9u5'},
    {'release': '9.0', 'prefix': 'graphicsmagick-dbg', 'reference': '1.3.30+hg15796-1~deb9u5'},
    {'release': '9.0', 'prefix': 'graphicsmagick-imagemagick-compat', 'reference': '1.3.30+hg15796-1~deb9u5'},
    {'release': '9.0', 'prefix': 'graphicsmagick-libmagick-dev-compat', 'reference': '1.3.30+hg15796-1~deb9u5'},
    {'release': '9.0', 'prefix': 'libgraphics-magick-perl', 'reference': '1.3.30+hg15796-1~deb9u5'},
    {'release': '9.0', 'prefix': 'libgraphicsmagick++-q16-12', 'reference': '1.3.30+hg15796-1~deb9u5'},
    {'release': '9.0', 'prefix': 'libgraphicsmagick++1-dev', 'reference': '1.3.30+hg15796-1~deb9u5'},
    {'release': '9.0', 'prefix': 'libgraphicsmagick-q16-3', 'reference': '1.3.30+hg15796-1~deb9u5'},
    {'release': '9.0', 'prefix': 'libgraphicsmagick1-dev', 'reference': '1.3.30+hg15796-1~deb9u5'}
];
