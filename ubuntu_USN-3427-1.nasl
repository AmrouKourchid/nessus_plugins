...
# extracted from Ubuntu Security Notice USN-3427-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS : Emacs vulnerability (USN-3427-1)");
...
in the USN-3427-1 advisory.

    Charles A. Roelli discovered that Emacs incorrectly handled certain files. If a user were tricked into
    opening a specially crafted file (e.g., email messages in gnus), an attacker could possibly use this to
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3427-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'emacs24', 'pkgver': '24.3+1-2ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'emacs24-bin-common', 'pkgver': '24.3+1-2ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'emacs24-common', 'pkgver': '24.3+1-2ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'emacs24-el', 'pkgver': '24.3+1-2ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'emacs24-lucid', 'pkgver': '24.3+1-2ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'emacs24-nox', 'pkgver': '24.3+1-2ubuntu1.1'},
    {'osver': '16.04', 'pkgname': 'emacs24', 'pkgver': '24.5+1-6ubuntu1.1'},
    {'osver': '16.04', 'pkgname': 'emacs24-bin-common', 'pkgver': '24.5+1-6ubuntu1.1'},
    {'osver': '16.04', 'pkgname': 'emacs24-common', 'pkgver': '24.5+1-6ubuntu1.1'},
    {'osver': '16.04', 'pkgname': 'emacs24-el', 'pkgver': '24.5+1-6ubuntu1.1'},
    {'osver': '16.04', 'pkgname': 'emacs24-lucid', 'pkgver': '24.5+1-6ubuntu1.1'},
    {'osver': '16.04', 'pkgname': 'emacs24-nox', 'pkgver': '24.5+1-6ubuntu1.1'}
];
