...
# extracted from Fedora Security Advisory FEDORA-2022-d5fc9dcdd7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-d5fc9dcdd7");

  script_name(english:"Fedora 37 : php-Smarty (2022-d5fc9dcdd7)");
...
FEDORA-2022-d5fc9dcdd7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-d5fc9dcdd7");
...
var pkgs = [
    {'reference':'php-Smarty-3.1.47-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
