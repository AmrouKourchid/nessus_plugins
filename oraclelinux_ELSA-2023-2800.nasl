...
# extracted from Oracle Linux Security Advisory ELSA-2023-2800.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : sysstat (ELSA-2023-2800)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-2800.html");
...
var pkgs = [
    {'reference':'sysstat-11.7.3-9.0.1.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sysstat-11.7.3-9.0.1.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
