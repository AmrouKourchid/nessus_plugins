...
# openSUSE Security Update openSUSE-SU-2022:0088-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : ghostscript (openSUSE-SU-2022:0088-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote SUSE Linux SUSE15 host has packages installed that are affected by multiple vulnerabilities as referenced in
the openSUSE-SU-2022:0088-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b4817289");
...
var pkgs = [
    {'reference':'ghostscript-9.52-161.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ghostscript-devel-9.52-161.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ghostscript-x11-9.52-161.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE}
];
