...
# extracted from Fedora Security Advisory FEDORA-2024-44602bead8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-44602bead8");

  script_name(english:"Fedora 38 : sssd (2024-44602bead8)");
...
FEDORA-2024-44602bead8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-44602bead8");
...
var pkgs = [
    {'reference':'sssd-2.9.4-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
