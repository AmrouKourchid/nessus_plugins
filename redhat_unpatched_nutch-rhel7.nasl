...
# extracted from Red Hat Security Advisory nutch. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2018-12545", "CVE-2019-10241", "CVE-2019-10247");
  script_xref(name:"CEA-ID", value:"CEA-2021-0004");

  script_name(english:"RHEL 7 : nutch (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2019-10241");
