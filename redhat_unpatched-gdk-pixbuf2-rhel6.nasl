...
# extracted from Red Hat Security Advisory gdk-pixbuf2. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2017-2862", "CVE-2017-2870");

  script_name(english:"RHEL 6 : gdk-pixbuf2 (Unpatched Vulnerability) (deprecated)");
