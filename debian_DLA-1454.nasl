...
# extracted from Debian Security Advisory DLA-1454-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1454-1 : network-manager-vpnc security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2018/07/msg00048.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/jessie/network-manager-vpnc");
...
"Upgrade the affected packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:network-manager-vpnc-gnome");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"network-manager-vpnc", reference:"0.9.10.0-1+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"network-manager-vpnc-gnome", reference:"0.9.10.0-1+deb8u1")) flag++;
