...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : OpenStack Swift vulnerabilities (USN-3451-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 14.04 LTS host has packages installed that are affected by multiple vulnerabilities as referenced in
the USN-3451-1 advisory.

    It was discovered that OpenStack Swift incorrectly handled tempurls. A remote authenticated user in
    possession of a tempurl key authorized for PUT could retrieve other objects in the same Swift account.
    (CVE-2015-5223)

    Romain Le Disez and rjan Persson discovered that OpenStack Swift incorrectly closed client connections.
    A remote attacker could possibly use this issue to consume resources, resulting in a denial of service.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3451-1");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2016-0738");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'python-swift', 'pkgver': '1.13.1-0ubuntu1.5'},
    {'osver': '14.04', 'pkgname': 'swift', 'pkgver': '1.13.1-0ubuntu1.5'},
    {'osver': '14.04', 'pkgname': 'swift-account', 'pkgver': '1.13.1-0ubuntu1.5'},
    {'osver': '14.04', 'pkgname': 'swift-container', 'pkgver': '1.13.1-0ubuntu1.5'},
    {'osver': '14.04', 'pkgname': 'swift-object', 'pkgver': '1.13.1-0ubuntu1.5'},
    {'osver': '14.04', 'pkgname': 'swift-object-expirer', 'pkgver': '1.13.1-0ubuntu1.5'},
    {'osver': '14.04', 'pkgname': 'swift-proxy', 'pkgver': '1.13.1-0ubuntu1.5'}
];
