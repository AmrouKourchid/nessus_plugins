...
# extracted from Fedora Security Advisory FEDORA-2024-8669c2a944
#
...
if (description)
{
  ...
  script_cve_id("CVE-2024-6104", "CVE-2024-6257", "CVE-2024-24789");
  script_xref(name:"FEDORA", value:"2024-8669c2a944");

  script_name(english:"Fedora 41 : opentofu (2024-8669c2a944)");
...
FEDORA-2024-8669c2a944 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-8669c2a944");
  script_set_attribute(attribute:"solution", value:
"Update the affected opentofu package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:opentofu");
...
var pkgs = [
    {'reference':'opentofu-1.7.3-3.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'opentofu');
}
