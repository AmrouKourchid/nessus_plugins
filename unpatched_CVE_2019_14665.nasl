...
if (description)
{
  ...
  script_cve_id("CVE-2019-14665");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2019-14665");
...
patch available.
  ...
  - Brandy 1.20.1 has a heap-based buffer overflow in define_array in variables.c via crafted BASIC source
    code. (CVE-2019-14665)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-14665");
