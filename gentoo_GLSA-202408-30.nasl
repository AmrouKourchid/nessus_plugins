...
# extracted from Gentoo Linux Security Advisory GLSA 202408-30.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202408-30 : dpkg: Directory Traversal");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202408-30 (dpkg: Directory Traversal)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202408-30");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=847976");
...
var packages = [
  {
    'name' : 'app-arch/dpkg',
    'unaffected' : make_list("ge 1.20.9-r1"),
    'vulnerable' : make_list("lt 1.20.9-r1")
  }
];
