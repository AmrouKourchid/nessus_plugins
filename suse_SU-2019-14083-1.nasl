...
# extracted from SUSE update advisory SUSE-SU-2019:14083-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES11 Security Update : sqlite3 (SUSE-SU-2019:14083-1)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?80294e5c");
...
slessp4-sqlite3-14083=1

SUSE Linux Enterprise Point of Sale 11-SP3:zypper in -t patch
sleposp3-sqlite3-14083=1

SUSE Linux Enterprise Debuginfo 11-SP4:zypper in -t patch
dbgsp4-sqlite3-14083=1");
...
flag = 0;
if (rpm_check(release:"SLES11", sp:"4", cpu:"x86_64", reference:"libsqlite3-0-32bit-3.7.6.3-1.4.7.9.1")) flag++;
if (rpm_check(release:"SLES11", sp:"4", cpu:"s390x", reference:"libsqlite3-0-32bit-3.7.6.3-1.4.7.9.1")) flag++;
if (rpm_check(release:"SLES11", sp:"4", reference:"libsqlite3-0-3.7.6.3-1.4.7.9.1")) flag++;
if (rpm_check(release:"SLES11", sp:"4", reference:"sqlite3-3.7.6.3-1.4.7.9.1")) flag++;
