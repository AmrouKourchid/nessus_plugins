...
# extracted from Oracle Linux Security Advisory ELSA-2022-9967.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : compat-expat1 (ELSA-2022-9967)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2022-9967.html");
  script_set_attribute(attribute:"solution", value:
"Update the affected compat-expat1 package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:compat-expat1");
...
var pkgs = [
    {'reference':'compat-expat1-1.95.8-8.0.1.el6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'compat-expat1-1.95.8-8.0.1.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
];
