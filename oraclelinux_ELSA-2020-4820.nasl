...
# extracted from Oracle Linux Security Advisory ELSA-2020-4820.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : file-roller (ELSA-2020-4820)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2020-4820.html");
