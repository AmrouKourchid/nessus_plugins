...
# extracted from Red Hat Security Advisory RHSA-2023:5965. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:5965");
  script_xref(name:"CEA-ID", value:"CEA-2024-0004");

  script_name(english:"RHEL 8 : Red Hat OpenStack Platform 16.2.5 (collectd-libpod-stats, etcd) (RHSA-2023:5965)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for Red Hat OpenStack Platform 16.2.5 (collectd-libpod-
stats / etcd).");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2023:5965 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_5965.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f206865b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:5965");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat OpenStack Platform 16.2.5 (collectd-libpod-stats / etcd) package based on the guidance in
RHSA-2023:5965.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'etcd-3.3.23-15.el8ost', 'cpu':'ppc64le', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-', 'cves':['CVE-2023-29406', 'CVE-2023-29409', 'CVE-2023-39325', 'CVE-2023-44487']},
      {'reference':'etcd-3.3.23-15.el8ost', 'cpu':'x86_64', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-', 'cves':['CVE-2023-29406', 'CVE-2023-29409', 'CVE-2023-39325', 'CVE-2023-44487']},
      {'reference':'python3-octavia-tests-tempest-1.4.1-2.20230111145026.f7718ef.el8ost', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-', 'cves':['CVE-2023-44487']},
      {'reference':'python3-octavia-tests-tempest-golang-1.4.1-2.20230111145026.f7718ef.el8ost', 'cpu':'ppc64le', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-', 'cves':['CVE-2023-44487']},
      {'reference':'python3-octavia-tests-tempest-golang-1.4.1-2.20230111145026.f7718ef.el8ost', 'cpu':'x86_64', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-', 'cves':['CVE-2023-44487']}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'etcd / python3-octavia-tests-tempest / etc');
}
