...
# extracted from Red Hat Security Advisory RHSA-2024:2525. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2525");

  script_name(english:"RHEL 9 : mingw-pixman (RHSA-2024:2525)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for mingw-pixman.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2525.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?426f0e01");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2525");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2139988");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL mingw-pixman package based on the guidance in RHSA-2024:2525.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:mingw-pixman");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:mingw32-pixman");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:mingw64-pixman");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'mingw32-pixman-0.42.2-3.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mingw64-pixman-0.42.2-3.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'mingw32-pixman / mingw64-pixman');
}
