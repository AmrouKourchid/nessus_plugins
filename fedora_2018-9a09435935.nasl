...
# extracted from Fedora Security Advisory FEDORA-2018-9a09435935.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : liblouis (2018-9a09435935)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-9a09435935");
...
flag = 0;
if (rpm_check(release:"FC27", reference:"liblouis-2.6.2-13.fc27")) flag++;
