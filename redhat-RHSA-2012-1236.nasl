...
the RHSA-2012:1236 advisory.

  - qemu: VT100 emulation vulnerability (CVE-2012-3515)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2012/rhsa-2012_1236.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2b888aae");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2012:1236");
...
"Update the RHEL xen package based on the guidance in RHSA-2012:1236.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'xen-3.0.3-135.el5_8.5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xen-3.0.3-135.el5_8.5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xen-devel-3.0.3-135.el5_8.5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xen-devel-3.0.3-135.el5_8.5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xen-libs-3.0.3-135.el5_8.5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xen-libs-3.0.3-135.el5_8.5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
