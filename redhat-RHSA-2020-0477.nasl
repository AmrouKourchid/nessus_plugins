...
# extracted from Red Hat Security Advisory RHSA-2020:0477. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2020-8595");
  script_xref(name:"RHSA", value:"2020:0477");

  script_name(english:"RHEL 8 : Red Hat OpenShift Service Mesh 1.0.7 servicemesh-proxy (RHSA-2020:0477)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for Red Hat OpenShift Service Mesh 1.0.7 servicemesh-proxy.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_0477.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7fcd8970");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:0477");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1798247");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat OpenShift Service Mesh 1.0.7 servicemesh-proxy package based on the guidance in RHSA-2020:0477.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:L/I:L/A:L");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-8595");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'servicemesh-proxy-1.0.7-1.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'servicemesh-'}
    ]
  }
];
