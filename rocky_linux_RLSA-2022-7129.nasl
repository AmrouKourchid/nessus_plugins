...
# Rocky Linux Security Advisory RLSA-2022:7129.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2022:7129");

  script_name(english:"Rocky Linux 8 : git-lfs (RLSA-2022:7129)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Rocky Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Rocky Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
RLSA-2022:7129 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2022:7129");
...
var pkgs = [
    ...
    {'reference':'git-lfs-debuginfo-2.13.3-3.el8_6', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'git-lfs-debuginfo-2.13.3-3.el8_6', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'git-lfs-debugsource-2.13.3-3.el8_6', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'git-lfs-debugsource-2.13.3-3.el8_6', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
