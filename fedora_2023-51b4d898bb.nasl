...
# extracted from Fedora Security Advisory FEDORA-2023-51b4d898bb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-51b4d898bb");

  script_name(english:"Fedora 38 : python-managesieve (2023-51b4d898bb)");
...
FEDORA-2023-51b4d898bb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-51b4d898bb");
...
var pkgs = [
    {'reference':'python-managesieve-0.7.1-6.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
