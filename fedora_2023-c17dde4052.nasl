...
# extracted from Fedora Security Advisory FEDORA-2023-c17dde4052
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-c17dde4052");

  script_name(english:"Fedora 38 : cloud-init (2023-c17dde4052)");
...
FEDORA-2023-c17dde4052 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-c17dde4052");
...
"Update the affected cloud-init package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:cloud-init");
...
var pkgs = [
    {'reference':'cloud-init-23.1.2-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
