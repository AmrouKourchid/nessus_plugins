...
# extracted from Red Hat Security Advisory RHSA-2024:9187. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:9187");

  script_name(english:"RHEL 9 : bcc (RHSA-2024:9187)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for bcc.");
...
the RHSA-2024:9187 advisory.

    BPF Compiler Collection (BCC) is a toolkit for easier creation of efficient kernel tracing and
    manipulation programs. BCC uses the extended Berkeley Packet Filter (eBPF) tool.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-28684");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-29031");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_9187.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?767103aa");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:9187");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL bcc package based on the guidance in RHSA-2024:9187.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:bcc");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:bcc-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:bcc-doc");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:bcc-tools");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:libbpf-tools");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:python3-bcc");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'bcc-0.30.0-6.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bcc-devel-0.30.0-6.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bcc-doc-0.30.0-6.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bcc-tools-0.30.0-6.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libbpf-tools-0.30.0-6.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-bcc-0.30.0-6.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'bcc / bcc-devel / bcc-doc / bcc-tools / libbpf-tools / python3-bcc');
}
