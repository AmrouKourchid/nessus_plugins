...
# extracted from Fedora Security Advisory FEDORA-2025-3a7a29de24
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-3a7a29de24");

  script_name(english:"Fedora 40 : ghostscript (2025-3a7a29de24)");
...
FEDORA-2025-3a7a29de24 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-3a7a29de24");
...
var pkgs = [
    {'reference':'ghostscript-10.02.1-14.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
