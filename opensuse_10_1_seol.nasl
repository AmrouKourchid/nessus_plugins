...
if (description)
{
  ...
  script_name(english:"openSUSE SEoL (10.1.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of openSUSE is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, openSUSE is 10.1.x. It is, therefore, no longer maintained by its vendor or provider.
...
"Upgrade to a version of openSUSE that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2008/05/31");
...
var constraints = [
  { max_branch : '10.1', min_branch : '10.1', seol : 20080531 }
];
