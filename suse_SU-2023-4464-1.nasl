...
# SUSE update advisory SUSE-SU-2023:4464-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:4464-1");

  script_name(english:"openSUSE 15 Security Update : libxml2 (SUSE-SU-2023:4464-1)");
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-November/017055.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a9ba6f9c");
...
var pkgs = [
    {'reference':'python3-libxml2-python-2.9.7-150000.3.63.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.4']},
    {'reference':'python3-libxml2-python-2.9.7-150000.3.63.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.5']}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python3-libxml2-python');
}
