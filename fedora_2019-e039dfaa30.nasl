...
# extracted from Fedora Security Advisory FEDORA-2019-e039dfaa30.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-e039dfaa30");

  script_name(english:"Fedora 30 : htmldoc (2019-e039dfaa30)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-e039dfaa30");
...
"Update the affected htmldoc package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:htmldoc");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"htmldoc-1.9.7-1.fc30")) flag++;
