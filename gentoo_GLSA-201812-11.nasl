...
# extracted from Gentoo Linux Security Advisory GLSA 201812-11.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2018-1000622", "CVE-2018-1000810");
  script_xref(name:"GLSA", value:"201812-11");

  script_name(english:"GLSA-201812-11 : Rust: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-201812-11
...
Impact :
    ...
    A remote attacker able to control the value passed to Rust&rsquo;s
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/201812-11");
...
"All Rust users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-1000810");
...
if (qpkg_check(package:"dev-lang/rust", unaffected:make_list("ge 1.29.1"), vulnerable:make_list("lt 1.29.1"))) flag++;
if (qpkg_check(package:"dev-lang/rust-bin", unaffected:make_list("ge 1.29.1"), vulnerable:make_list("lt 1.29.1"))) flag++;
