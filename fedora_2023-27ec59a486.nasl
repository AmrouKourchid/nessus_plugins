...
# extracted from Fedora Security Advisory FEDORA-2023-27ec59a486
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-27ec59a486");

  script_name(english:"Fedora 38 : picocli (2023-27ec59a486)");
...
FEDORA-2023-27ec59a486 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-27ec59a486");
  script_set_attribute(attribute:"solution", value:
"Update the affected picocli package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:picocli");
...
var pkgs = [
    {'reference':'picocli-4.7.4-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'picocli');
}
