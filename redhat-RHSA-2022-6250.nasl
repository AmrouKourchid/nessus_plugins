...
# extracted from Red Hat Security Advisory RHSA-2022:6250. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:6250");

  script_name(english:"RHEL 8 : booth (RHSA-2022:6250)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for booth.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2022:6250 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_6250.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2068f0ef");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:6250");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2109251");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL booth package based on the guidance in RHSA-2022:6250.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'booth-1.0-199.1.ac1d34c.git.el8_4.1', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'booth-arbitrator-1.0-199.1.ac1d34c.git.el8_4.1', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'booth-core-1.0-199.1.ac1d34c.git.el8_4.1', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'booth-site-1.0-199.1.ac1d34c.git.el8_4.1', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'booth-test-1.0-199.1.ac1d34c.git.el8_4.1', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
