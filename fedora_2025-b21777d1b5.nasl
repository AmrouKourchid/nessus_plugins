...
# extracted from Fedora Security Advisory FEDORA-2025-b21777d1b5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-b21777d1b5");

  script_name(english:"Fedora 41 : freeipa (2025-b21777d1b5)");
...
FEDORA-2025-b21777d1b5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-b21777d1b5");
...
var pkgs = [
    {'reference':'freeipa-4.12.2-7.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
