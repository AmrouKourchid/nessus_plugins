...
# extracted from Red Hat Security Advisory RHSA-2020:0942. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:0942");

  script_name(english:"RHEL 7 : runc (RHSA-2020:0942)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_0942.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f9d83fdc");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:0942");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1796107");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL runc package based on the guidance in RHSA-2020:0942.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'runc-1.0.0-66.rc8.el7_7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'runc-1.0.0-66.rc8.el7_7', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'runc-1.0.0-66.rc8.el7_7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
