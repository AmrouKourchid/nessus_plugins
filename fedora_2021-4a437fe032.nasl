...
# extracted from Fedora Security Advisory FEDORA-2021-4a437fe032
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-4a437fe032");

  script_name(english:"Fedora 32 : 1:xpdf (2021-4a437fe032)");
...
FEDORA-2021-4a437fe032 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-4a437fe032");
...
pkgs = [
    {'reference':'xpdf-4.03-1.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
