...
in the USN-5091-3 advisory.
    ...
    USN-5091-1 fixed vulnerabilities in Linux 5.4-based kernels. Unfortunately, for Linux kernels intended for
    use within Microsoft Azure environments, that update introduced a regression that could cause the kernel
    to fail to boot in large Azure instance types. This update fixes the problem.
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-5091-3');
}
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-5091-3');
  }
  else
  {
