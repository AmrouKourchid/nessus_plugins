...
if (description)
{
  ...
  script_name(english:"Oracle Essbase Multiple Vulnerabilities (October 2024 CPU)");

  script_set_attribute(attribute:"synopsis", value:
"A business analytics solution installed on the remote host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Oracle Essbase installed on the remote host is missing a security patch from the October 2024
Critical Patch Update (CPU). It is, therefore, affected by:

  - Vulnerability in Oracle Essbase (component: Essbase Web Platform (curl)). The supported version that is affected is
    21.6. Easily exploitable vulnerability allows unauthenticated attacker with network access via multiple protocols 
    to compromise Oracle Essbase. Successful attacks require human interaction from a person other than the attacker. 
    Successful attacks of this vulnerability can result in unauthorized ability to cause a hang or frequently 
    repeatable crash (complete DOS) of Oracle Essbase. (CVE-2024-7264)

  - Security-in-Depth issue in Oracle Essbase (component: Essbase Web Platform (Apache Xerces-C++)). (CVE-2024-23807)

  - Security-in-Depth issue in Oracle Essbase (component: Essbase Web Platform (OpenSSL)). (CVE-2024-2511)
...
var constraints = [
  { 'min_version' : '21.6.0.0.0', 'fixed_version' : '21.7.0.0.0', 'fixed_display' : '21.7.0.0.0 Patch 36675325 or later'}
];
