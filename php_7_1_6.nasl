...
if (description)
{
  ...
  script_name(english:"PHP 7.1.x < 7.1.6 Multiple Vulnerabilities");
...
server is 7.1.x prior to 7.1.6. It is, therefore, affected by the
following vulnerabilities :
  ...
  - A flaw exists that is related to processing of directory
    paths that contain Unicode characters. An attacker can
    exploit this to cause an incorrect value in the
    '__DIR__' variable, possibly resulting in a denial of
    service condition or the execution of arbitrary code.
    (bug #74589)");
  script_set_attribute(attribute:"see_also", value:"http://php.net/ChangeLog-7.php#7.1.6");
  script_set_attribute(attribute:"solution", value:
"Upgrade to PHP version 7.1.6 or later.");
