...
# extracted from Debian Security Advisory dla-2934. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2934-1 : freecad - LTS security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 9 host has a package installed that is affected by a vulnerability as referenced in the dla-2934
advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=1005747");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/freecad");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2022/dla-2934");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2021-45844");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/stretch/freecad");
...
var pkgs = [
    {'release': '9.0', 'prefix': 'freecad', 'reference': '0.16+dfsg2-3+deb9u1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'freecad');
}
