...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : c-ares (EulerOS-SA-2023-3394)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3394
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b120b767");
...
var pkgs = [
  "c-ares-1.10.0-3.h4.eulerosv2r7",
  "c-ares-devel-1.10.0-3.h4.eulerosv2r7"
];
