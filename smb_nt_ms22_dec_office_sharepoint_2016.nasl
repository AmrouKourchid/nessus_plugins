...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5002321");
  script_xref(name:"MSFT", value:"MS22-5002321");
  script_xref(name:"IAVA", value:"2022-A-0523-S");

  script_name(english:"Security Updates for Microsoft SharePoint Server 2016 (December 2022)");
...
these to bypass authentication and execute unauthorized arbitrary commands.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5002321");
