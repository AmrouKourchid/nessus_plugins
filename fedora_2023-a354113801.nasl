...
# extracted from Fedora Security Advisory FEDORA-2023-a354113801
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-a354113801");

  script_name(english:"Fedora 37 : kitty (2023-a354113801)");
...
FEDORA-2023-a354113801 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-a354113801");
...
var pkgs = [
    {'reference':'kitty-0.26.5-5.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
