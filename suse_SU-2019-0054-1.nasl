...
# extracted from SUSE update advisory SUSE-SU-2019:0054-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : systemd (SUSE-SU-2019:0054-1)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e7f91623");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"1", reference:"libgudev-1_0-0-210-116.19.1")) flag++;
if (rpm_check(release:"SLES12", sp:"1", reference:"libgudev-1_0-0-32bit-210-116.19.1")) flag++;
if (rpm_check(release:"SLES12", sp:"1", reference:"libgudev-1_0-0-debuginfo-210-116.19.1")) flag++;
if (rpm_check(release:"SLES12", sp:"1", reference:"libgudev-1_0-0-debuginfo-32bit-210-116.19.1")) flag++;
if (rpm_check(release:"SLES12", sp:"1", reference:"libgudev-1_0-devel-210-116.19.1")) flag++;
if (rpm_check(release:"SLES12", sp:"1", reference:"libudev-devel-210-116.19.1")) flag++;
if (rpm_check(release:"SLES12", sp:"1", reference:"libudev1-210-116.19.1")) flag++;
if (rpm_check(release:"SLES12", sp:"1", reference:"libudev1-32bit-210-116.19.1")) flag++;
if (rpm_check(release:"SLES12", sp:"1", reference:"libudev1-debuginfo-210-116.19.1")) flag++;
if (rpm_check(release:"SLES12", sp:"1", reference:"libudev1-debuginfo-32bit-210-116.19.1")) flag++;
if (rpm_check(release:"SLES12", sp:"1", reference:"systemd-210-116.19.1")) flag++;
if (rpm_check(release:"SLES12", sp:"1", reference:"systemd-32bit-210-116.19.1")) flag++;
if (rpm_check(release:"SLES12", sp:"1", reference:"systemd-debuginfo-210-116.19.1")) flag++;
if (rpm_check(release:"SLES12", sp:"1", reference:"systemd-debuginfo-32bit-210-116.19.1")) flag++;
if (rpm_check(release:"SLES12", sp:"1", reference:"systemd-debugsource-210-116.19.1")) flag++;
if (rpm_check(release:"SLES12", sp:"1", reference:"systemd-devel-210-116.19.1")) flag++;
if (rpm_check(release:"SLES12", sp:"1", reference:"systemd-sysvinit-210-116.19.1")) flag++;
if (rpm_check(release:"SLES12", sp:"1", reference:"typelib-1_0-GUdev-1_0-210-116.19.1")) flag++;
if (rpm_check(release:"SLES12", sp:"1", reference:"udev-210-116.19.1")) flag++;
if (rpm_check(release:"SLES12", sp:"1", reference:"udev-debuginfo-210-116.19.1")) flag++;
