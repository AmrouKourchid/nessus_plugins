...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Net PHSA-2018-2.0-0037");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'net-snmp-5.7.3-8.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'net-snmp-debuginfo-5.7.3-8.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'net-snmp-devel-5.7.3-8.ph2')) flag++;
