...
# extracted from Red Hat Security Advisory liblouis. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2018-11577", "CVE-2018-11685");

  script_name(english:"RHEL 7 : liblouis (Unpatched Vulnerability) (deprecated)");
