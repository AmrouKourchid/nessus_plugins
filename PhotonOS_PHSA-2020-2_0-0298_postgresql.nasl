...
# extracted from VMware Security Advisory PHSA-2020-2.0-0298. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Postgresql PHSA-2020-2.0-0298");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the postgresql package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-2-298.md");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'postgresql-9.6.20-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'postgresql-devel-9.6.20-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'postgresql-libs-9.6.20-1.ph2')) flag++;
