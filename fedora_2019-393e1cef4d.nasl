...
# extracted from Fedora Security Advisory FEDORA-2019-393e1cef4d.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-393e1cef4d");

  script_name(english:"Fedora 30 : cyrus-imapd (2019-393e1cef4d)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"Update to version 3.0.12 of cyrus-imapd, which includes (among other
fixes) a fix for CVE-2019-18928.
https://www.cyrusimap.org/imap/download/release-notes/3.0/x/3.0.12.htm
l
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-393e1cef4d");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"cyrus-imapd-3.0.12-1.fc30")) flag++;
