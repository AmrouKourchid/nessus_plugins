...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'subversion-1.10.2-5.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'subversion-debuginfo-1.10.2-5.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'subversion-devel-1.10.2-5.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'subversion-perl-1.10.2-5.ph3')) flag++;
