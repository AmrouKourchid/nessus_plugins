...
if (description)
{
  ...
  script_name(english:"Oracle Business Intelligence Enterprise Edition (OAS 7.0) (October 2023 CPU)");
...
var constraints = [
  {'min_version': '7.0.0.0.0', 'fixed_version': '7.0.0.0.230929', 'fixed_display': '7.0.0.0.230929 patch: 35860780'}
];
