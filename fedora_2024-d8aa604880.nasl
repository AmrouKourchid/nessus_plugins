...
# extracted from Fedora Security Advisory FEDORA-2024-d8aa604880
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-d8aa604880");

  script_name(english:"Fedora 40 : sos (2024-d8aa604880)");
...
FEDORA-2024-d8aa604880 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-d8aa604880");
...
"Update the affected sos package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:sos");
...
var pkgs = [
    {'reference':'sos-4.6.1-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
