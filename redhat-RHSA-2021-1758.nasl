...
# extracted from Red Hat Security Advisory RHSA-2021:1758. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:1758");

  script_name(english:"RHEL 8 : exiv2 (RHSA-2021:1758)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2021:1758 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_1758.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b4456115");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:1758");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'exiv2-0.27.3-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'exiv2-devel-0.27.3-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'exiv2-doc-0.27.3-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'exiv2-libs-0.27.3-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
