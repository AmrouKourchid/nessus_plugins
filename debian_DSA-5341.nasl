...
# extracted from Debian Security Advisory dsa-5341. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-5341-1 : wpewebkit - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2023/dsa-5341");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'libwpewebkit-1.0-3', 'reference': '2.38.4-1~deb11u1'},
    {'release': '11.0', 'prefix': 'libwpewebkit-1.0-dev', 'reference': '2.38.4-1~deb11u1'},
    {'release': '11.0', 'prefix': 'libwpewebkit-1.0-doc', 'reference': '2.38.4-1~deb11u1'},
    {'release': '11.0', 'prefix': 'wpewebkit-driver', 'reference': '2.38.4-1~deb11u1'}
];
