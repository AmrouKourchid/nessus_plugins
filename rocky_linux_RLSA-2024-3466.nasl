...
# Rocky Linux Security Advisory RLSA-2024:3466.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2024:3466");

  script_name(english:"Rocky Linux 8 : python39:3.9 and python39-devel:3.9 (RLSA-2024:3466)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Rocky Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Rocky Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
RLSA-2024:3466 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2024:3466");
...
var appstreams = {
    'python39-devel:3.9': [
      ...
      {'reference':'python39-3.9.19-1.module+el8.10.0+1809+41195054', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-3.9.19-1.module+el8.10.0+1809+41195054', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python39-debug-3.9.19-1.module+el8.10.0+1809+41195054', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-debug-3.9.19-1.module+el8.10.0+1809+41195054', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-debuginfo-3.9.19-1.module+el8.10.0+1809+41195054', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-debuginfo-3.9.19-1.module+el8.10.0+1809+41195054', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-debugsource-3.9.19-1.module+el8.10.0+1809+41195054', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-debugsource-3.9.19-1.module+el8.10.0+1809+41195054', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-devel-3.9.19-1.module+el8.10.0+1809+41195054', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-devel-3.9.19-1.module+el8.10.0+1809+41195054', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-idle-3.9.19-1.module+el8.10.0+1809+41195054', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-idle-3.9.19-1.module+el8.10.0+1809+41195054', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-idna-2.10-4.module+el8.10.0+1809+41195054', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-iniconfig-1.1.1-2.module+el8.9.0+1332+dd574197', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-libs-3.9.19-1.module+el8.10.0+1809+41195054', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-libs-3.9.19-1.module+el8.10.0+1809+41195054', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python39-rpm-macros-3.9.19-1.module+el8.10.0+1809+41195054', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python39-test-3.9.19-1.module+el8.10.0+1809+41195054', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-test-3.9.19-1.module+el8.10.0+1809+41195054', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-tkinter-3.9.19-1.module+el8.10.0+1809+41195054', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-tkinter-3.9.19-1.module+el8.10.0+1809+41195054', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
