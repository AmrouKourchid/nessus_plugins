...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : httpd (EulerOS-SA-2019-2080)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2080
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?406cff30");
...
pkgs = ["httpd-2.4.34-8.h8.eulerosv2r8",
        "httpd-devel-2.4.34-8.h8.eulerosv2r8",
        "httpd-filesystem-2.4.34-8.h8.eulerosv2r8",
        "httpd-manual-2.4.34-8.h8.eulerosv2r8",
        "httpd-tools-2.4.34-8.h8.eulerosv2r8",
        "mod_session-2.4.34-8.h8.eulerosv2r8",
