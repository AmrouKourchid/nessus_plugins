...
# extracted from Red Hat Security Advisory RHSA-2025:0012. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:0012");

  script_name(english:"RHEL 8 : python-requests (RHSA-2025:0012)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_0012.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?14089dec");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:0012");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-requests package based on the guidance in RHSA-2025:0012.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-requests-2.20.0-5.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
