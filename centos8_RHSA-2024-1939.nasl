...
# Red Hat Security Advisory RHSA-2024:1939. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : thunderbird (CESA-2024:1939)");
...
var pkgs = [
    {'reference':'thunderbird-115.10.0-2.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'thunderbird-115.10.0-2.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
