...
# extracted from Oracle Linux Security Advisory ELSA-2024-9457.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : python3.12-urllib3 (ELSA-2024-9457)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-9457.html");
...
"Update the affected python3.12-urllib3 package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:python3.12-urllib3");
...
var pkgs = [
    {'reference':'python3.12-urllib3-1.26.18-2.el9_5.1', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
