...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS : ICU vulnerabilities (USN-3227-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 14.04 LTS / 16.04 LTS host has packages installed that are affected by multiple vulnerabilities as
referenced in the USN-3227-1 advisory.
    ...
    potentially execute arbitrary code with the privileges of the user invoking the program.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3227-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'icu-devtools', 'pkgver': '52.1-3ubuntu0.5'},
    {'osver': '14.04', 'pkgname': 'libicu-dev', 'pkgver': '52.1-3ubuntu0.5'},
    {'osver': '14.04', 'pkgname': 'libicu52', 'pkgver': '52.1-3ubuntu0.5'},
    {'osver': '16.04', 'pkgname': 'icu-devtools', 'pkgver': '55.1-7ubuntu0.1'},
    {'osver': '16.04', 'pkgname': 'libicu-dev', 'pkgver': '55.1-7ubuntu0.1'},
    {'osver': '16.04', 'pkgname': 'libicu55', 'pkgver': '55.1-7ubuntu0.1'}
];
