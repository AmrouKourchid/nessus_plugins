...
# extracted from Fedora Security Advisory FEDORA-2024-3dbf10c949
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-3dbf10c949");

  script_name(english:"Fedora 39 : linux-firmware (2024-3dbf10c949)");
...
FEDORA-2024-3dbf10c949 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-3dbf10c949");
...
var pkgs = [
    {'reference':'linux-firmware-20240909-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
