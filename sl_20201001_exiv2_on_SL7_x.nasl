...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : exiv2 on SL7.x x86_64 (20201001)");
...
"Security Fix(es) :
  ...
  - exiv2: out-of-bounds read in
    ...
    (CVE-2019-17402)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind2010&L=SCIENTIFIC-LINUX-ERRATA&P=3055
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ef01233e");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"exiv2-0.27.0-3.el7_8")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"exiv2-debuginfo-0.27.0-3.el7_8")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"exiv2-devel-0.27.0-3.el7_8")) flag++;
if (rpm_check(release:"SL7", reference:"exiv2-doc-0.27.0-3.el7_8")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"exiv2-libs-0.27.0-3.el7_8")) flag++;
