...
if (description)
{
  ...
  script_cve_id("CVE-2021-37616");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2021-37616");
...
patch available.
  ...
  - Exiv2 is a command-line utility and C++ library for reading, writing, deleting, and modifying the metadata
    ...
    command line option (`-p t` or `-P t`). The bug is fixed in version v0.27.5. (CVE-2021-37616)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-37616");
