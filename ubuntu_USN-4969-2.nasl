...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 ESM : DHCP vulnerability (USN-4969-2)");
...
USN-4969-2 advisory.
    ...
    USN-4969-1 fixed a vulnerability in DHCP. This update provides the corresponding update for Ubuntu 14.04
    ESM and 16.04 ESM.
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'isc-dhcp-client', 'pkgver': '4.3.3-5ubuntu12.10+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'isc-dhcp-client-ddns', 'pkgver': '4.3.3-5ubuntu12.10+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'isc-dhcp-client-udeb', 'pkgver': '4.3.3-5ubuntu12.10+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'isc-dhcp-common', 'pkgver': '4.3.3-5ubuntu12.10+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'isc-dhcp-dev', 'pkgver': '4.3.3-5ubuntu12.10+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'isc-dhcp-relay', 'pkgver': '4.3.3-5ubuntu12.10+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'isc-dhcp-server', 'pkgver': '4.3.3-5ubuntu12.10+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'isc-dhcp-server-ldap', 'pkgver': '4.3.3-5ubuntu12.10+esm1', 'ubuntu_pro': TRUE}
];
