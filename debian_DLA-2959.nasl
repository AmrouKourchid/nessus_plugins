...
# extracted from Debian Security Advisory dla-2959. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2959-1 : paramiko - LTS security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 9 host has packages installed that are affected by a vulnerability as referenced in the dla-2959
advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2022/dla-2959");
...
var pkgs = [
    {'release': '9.0', 'prefix': 'paramiko-doc', 'reference': '2.0.0-1+deb9u2'},
    {'release': '9.0', 'prefix': 'python-paramiko', 'reference': '2.0.0-1+deb9u2'},
    {'release': '9.0', 'prefix': 'python3-paramiko', 'reference': '2.0.0-1+deb9u2'}
];
