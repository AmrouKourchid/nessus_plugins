...
in the USN-3425-1 advisory.

    Hanno Bck discovered that the Apache HTTP Server incorrectly handled Limit directives in .htaccess
    files. In certain configurations, a remote attacker could possibly use this issue to read arbitrary server
    memory, including sensitive information. This issue is known as Optionsbleed.
