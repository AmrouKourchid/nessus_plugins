...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : elfutils (EulerOS-SA-2025-1352)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1352
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c55c25f1");
...
var pkgs = [
  "elfutils-0.185-5.h10.eulerosv2r11"
];
