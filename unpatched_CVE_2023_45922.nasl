...
if (description)
{
  ...
  script_cve_id("CVE-2023-45922");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2023-45922");
...
patch available.
  ...
  - glx_pbuffer.c in Mesa 23.0.4 was discovered to contain a segmentation violation when calling
    __glXGetDrawableAttribute(). NOTE: this is disputed because there are no common situations in which users
    require uninterrupted operation with an attacker-controller server. (CVE-2023-45922)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-45922");
