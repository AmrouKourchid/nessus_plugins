...
OS Security Patch Assessment cannot be performed at this time.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://suggestions.tenable.com");
  script_set_attribute(attribute:"solution", value:
"If OS Security Patch Assessment is required for this host, please log a Research Request via the AHA! Suggestions Portal linked in the 'See Also' section below.");
