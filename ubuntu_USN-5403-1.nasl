...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS : SQLite vulnerability (USN-5403-1)");
...
in the USN-5403-1 advisory.

    It was discovered that SQLite command-line component incorrectly handled certain queries. An attacker
    could possibly use this issue to cause a crash or possibly execute arbitrary code.
