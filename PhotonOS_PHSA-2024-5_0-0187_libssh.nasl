...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Libssh PHSA-2024-5.0-0187");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'libssh-0.10.6-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', reference:'libssh-config-0.10.6-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'libssh-devel-0.10.6-1.ph5')) flag++;
