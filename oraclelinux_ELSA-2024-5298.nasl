...
# extracted from Oracle Linux Security Advisory ELSA-2024-5298.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : gnome-shell (ELSA-2024-5298)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-5298.html");
...
var pkgs = [
    {'reference':'gnome-shell-3.32.2-56.el8_10', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'gnome-shell-3.32.2-56.el8_10', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
