...
# extracted from Red Hat Security Advisory RHSA-2024:8922. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:8922");

  script_name(english:"RHEL 8 : bzip2 (RHSA-2024:8922)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for bzip2.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:8922 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_8922.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2dc892ef");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:8922");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL bzip2 package based on the guidance in RHSA-2024:8922.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'bzip2-1.0.6-27.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bzip2-devel-1.0.6-27.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bzip2-libs-1.0.6-27.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
