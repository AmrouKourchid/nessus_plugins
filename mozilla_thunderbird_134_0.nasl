...
"The version of Thunderbird installed on the remote Windows host is prior to 134.0. It is, therefore, affected by
multiple vulnerabilities as referenced in the mfsa2025-04 advisory.
...
mozilla_check_version(installs:installs, product:'thunderbird', esr:FALSE, fix:'134.0', severity:SECURITY_HOLE);
