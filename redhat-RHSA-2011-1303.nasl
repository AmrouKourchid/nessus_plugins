...
# extracted from Red Hat Security Advisory RHSA-2011:1303. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2011:1303");

  script_name(english:"RHEL 6 : jbossws-common (RHSA-2011:1303)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for jbossws-common.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2011/rhsa-2011_1303.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?46586578");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=692584");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2011:1303");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL jbossws-common package based on the guidance in RHSA-2011:1303.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2011-1483");

  script_set_attribute(attribute:"exploitability_ease", value:"No known exploits are available");
  script_set_attribute(attribute:"exploit_available", value:"false");
  script_set_attribute(attribute:"vendor_severity", value:"Important");

  script_set_attribute(attribute:"vuln_publication_date", value:"2011/09/15");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jbossws-common-1.1.0-4.SP7_patch_02.1.ep5.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
