...
# SUSE update advisory SUSE-SU-2022:4515-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:4515-1");

  script_name(english:"SUSE SLES15 Security Update : kernel (Live Patch 31 for SLE 15 SP2) (SUSE-SU-2022:4515-1)");
...
referenced in the SUSE-SU-2022:4515-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-December/013259.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?25b28658");
...
var kernel_live_checks = [
  {
    'kernels': {
      '5.3.18-150200.24.134-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_3_18-150200_24_134-default-3-150200.2.1', 'sp':'2', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.2']},
          {'reference':'kernel-livepatch-5_3_18-150200_24_134-default-3-150200.2.1', 'sp':'2', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.2', 'sle-module-live-patching-release-15.2', 'sles-release-15.2']}
        ]
      }
    }
  }
