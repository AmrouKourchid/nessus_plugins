...
# extracted from Fedora Security Advisory FEDORA-2023-a8afe852a3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-a8afe852a3");

  script_name(english:"Fedora 38 : kernel (2023-a8afe852a3)");
...
FEDORA-2023-a8afe852a3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-a8afe852a3");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for FEDORA-2023-a8afe852a3');
  }
  else
  {
...
var pkgs = [
    {'reference':'kernel-6.6.6-100.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
