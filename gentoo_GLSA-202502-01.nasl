...
# extracted from Gentoo Linux Security Advisory GLSA 202502-01.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202502-01 : OpenSSH: Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202502-01 (OpenSSH: Multiple Vulnerabilities)

    Multiple vulnerabilities have been discovered in OpenSSH. Please review the CVE identifiers referenced
    below for details.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202502-01");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=949904");
...
var packages = [
  {
    ...
    'unaffected' : make_list("ge 9.9_p2"),
    'vulnerable' : make_list("lt 9.9_p2")
  }
];
