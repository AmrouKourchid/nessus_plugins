...
# extracted from Fedora Security Advisory FEDORA-2024-1b11432d52
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-1b11432d52");

  script_name(english:"Fedora 39 : freerdp (2024-1b11432d52)");
...
FEDORA-2024-1b11432d52 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-1b11432d52");
...
var pkgs = [
    {'reference':'freerdp-2.11.7-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
