...
the RHSA-2018:2123 advisory.
    ...
    * A flaw was found in the way the DES/3DES cipher was used as part of the TLS/SSL protocol. A man-in-the-
    ...
    Red Hat would like to thank OpenVPN for reporting this issue. Upstream acknowledges Karthikeyan Bhargavan
    (Inria) and Gatan Leurent (Inria) as the original reporters.

Tenable has extracted the preceding description block directly from the Red Hat Enterprise Linux security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_2123.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7bdfebfd");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:2123");
...
"Update the RHEL python package based on the guidance in RHSA-2018:2123.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python-2.7.5-69.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python-debug-2.7.5-69.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python-devel-2.7.5-69.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python-libs-2.7.5-69.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python-test-2.7.5-69.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python-tools-2.7.5-69.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tkinter-2.7.5-69.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
