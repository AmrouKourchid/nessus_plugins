...
# extracted from Ubuntu Security Notice USN-4233-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"4233-1");

  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS : GnuTLS update (USN-4233-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4233-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'gnutls-bin', 'pkgver': '3.4.10-4ubuntu1.6'},
    {'osver': '16.04', 'pkgname': 'guile-gnutls', 'pkgver': '3.4.10-4ubuntu1.6'},
    {'osver': '16.04', 'pkgname': 'libgnutls-dev', 'pkgver': '3.4.10-4ubuntu1.6'},
    {'osver': '16.04', 'pkgname': 'libgnutls-openssl27', 'pkgver': '3.4.10-4ubuntu1.6'},
    {'osver': '16.04', 'pkgname': 'libgnutls28-dev', 'pkgver': '3.4.10-4ubuntu1.6'},
    {'osver': '16.04', 'pkgname': 'libgnutls30', 'pkgver': '3.4.10-4ubuntu1.6'},
    {'osver': '16.04', 'pkgname': 'libgnutlsxx28', 'pkgver': '3.4.10-4ubuntu1.6'},
    {'osver': '18.04', 'pkgname': 'gnutls-bin', 'pkgver': '3.5.18-1ubuntu1.2'},
    {'osver': '18.04', 'pkgname': 'libgnutls-dane0', 'pkgver': '3.5.18-1ubuntu1.2'},
    {'osver': '18.04', 'pkgname': 'libgnutls-openssl27', 'pkgver': '3.5.18-1ubuntu1.2'},
    {'osver': '18.04', 'pkgname': 'libgnutls28-dev', 'pkgver': '3.5.18-1ubuntu1.2'},
    {'osver': '18.04', 'pkgname': 'libgnutls30', 'pkgver': '3.5.18-1ubuntu1.2'},
    {'osver': '18.04', 'pkgname': 'libgnutlsxx28', 'pkgver': '3.5.18-1ubuntu1.2'}
];
