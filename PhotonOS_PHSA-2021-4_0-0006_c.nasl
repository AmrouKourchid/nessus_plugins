...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: C PHSA-2021-4.0-0006");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'c-ares-1.16.1-2.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'c-ares-devel-1.16.1-2.ph4')) flag++;
