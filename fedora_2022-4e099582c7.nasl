...
# extracted from Fedora Security Advisory FEDORA-2022-4e099582c7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-4e099582c7");

  script_name(english:"Fedora 36 : wordpress (2022-4e099582c7)");
...
FEDORA-2022-4e099582c7 advisory.

    **WordPress 6.0.3 Security Release**

    Security updates included in this release

    *    Stored XSS via wp-mail.php (post by email)  Toshitsugu Yoneyama of Mitsui Bussan Secure
    Directions, Inc. via JPCERT
    *    Open redirect in `wp_nonce_ays`  devrayn
    *    Senders email address is exposed in wp-mail.php  Toshitsugu Yoneyama of Mitsui Bussan Secure
    Directions, Inc. via JPCERT
    *    Media Library  Reflected XSS via SQLi  Ben Bidner from the WordPress security team and Marc
    Montpas from Automattic independently discovered this issue
    *    CSRF in wp-trackback.php  Simon Scannell
    *    Stored XSS via the Customizer  Alex Concha from the WordPress security team
    *    Revert shared user instances introduced in 50790  Alex Concha and Ben Bidner from the WordPress
    security team
    *    Stored XSS in WordPress Core via Comment Editing  Third-party security audit and Alex Concha from
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-4e099582c7");
...
var pkgs = [
    {'reference':'wordpress-6.0.3-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
