...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.6 : ghostscript (EulerOS-SA-2023-1088)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the ghostscript package installed, the EulerOS Virtualization installation on the remote
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1088
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3a265aff");
...
var pkgs = [
  "ghostscript-9.07-31.6.h21.eulerosv2r7"
];
