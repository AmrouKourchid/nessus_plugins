...
# extracted from Fedora Security Advisory FEDORA-2019-31015766d1.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-31015766d1");

  script_name(english:"Fedora 29 : mingw-nettle (2019-31015766d1)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-31015766d1");
  script_set_attribute(attribute:"solution", value:
"Update the affected mingw-nettle package.");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"mingw-nettle-3.4.1-1.fc29")) flag++;
