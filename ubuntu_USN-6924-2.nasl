...
# extracted from Ubuntu Security Notice USN-6924-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6924-2");

  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS : Linux kernel vulnerabilities (USN-6924-2)");
...
referenced in the USN-6924-2 advisory.
    ...
    - TLS protocol; (CVE-2022-48655, CVE-2024-36016, CVE-2024-26584, CVE-2021-47131, CVE-2024-26907,
    CVE-2024-26585, CVE-2024-26583)

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6924-2");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.4.0-1129-aws");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-6924-2');
}
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-6924-2');
  }
  else
  {
