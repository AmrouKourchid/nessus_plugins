...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Cifs PHSA-2020-2.0-0285");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'cifs-utils-6.7-2.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'cifs-utils-devel-6.7-2.ph2')) flag++;
