...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : perl-DBI (EulerOS-SA-2020-2180)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2180
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5ab6589e");
...
pkgs = ["perl-DBI-1.642-2.h2.eulerosv2r9"];
