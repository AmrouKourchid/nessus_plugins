...
# extracted from Red Hat Security Advisory RHSA-2024:1152. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:1152");

  script_name(english:"RHEL 9 : frr (RHSA-2024:1152)");
...
referenced in the RHSA-2024:1152 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_1152.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a6773233");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:1152");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL frr package based on the guidance in RHSA-2024:1152.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'frr-8.0-5.el9_0.3', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
