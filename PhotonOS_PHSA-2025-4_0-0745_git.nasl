...
# extracted from VMware Security Advisory PHSA-2025-4.0-0745. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Git PHSA-2025-4.0-0745");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the git package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-745.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'git-lfs-3.2.0-9.ph4')) flag++;
