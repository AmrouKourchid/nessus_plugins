...
# extracted from Fedora Security Advisory FEDORA-2025-f27fcf5da3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-f27fcf5da3");

  script_name(english:"Fedora 41 : java-latest-openjdk (2025-f27fcf5da3)");
...
FEDORA-2025-f27fcf5da3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-f27fcf5da3");
...
var pkgs = [
    {'reference':'java-latest-openjdk-23.0.2.0.7-1.rolling.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
