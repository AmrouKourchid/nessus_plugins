...
if (description)
{
  ...
  script_cve_id("CVE-2023-32029", "CVE-2023-33133", "CVE-2023-33146");
  
  script_xref(name:"IAVA", value:"2023-A-0294-S");
  script_xref(name:"IAVA", value:"2023-A-0292-S");

  script_name(english:"Security Updates for Microsoft Office Products (June 2023) (macOS)");
...
number.");
  ...
  # https://learn.microsoft.com/en-us/officeupdates/release-notes-office-for-mac#june-13-2023
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2cc2a63e");
...
"Microsoft has released a set of patches for Microsoft Office for Mac.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-33146");
...
var constraints = [
  {'min_version':'16.17.0', 'fixed_version':'16.74', 'fixed_display':'16.74 (23061100)'}
];
