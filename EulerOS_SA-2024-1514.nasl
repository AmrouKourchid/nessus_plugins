...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : python-configobj (EulerOS-SA-2024-1514)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1514
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7cf94e39");
...
var pkgs = [
  "python3-configobj-5.0.6-15.h1.r2.eulerosv2r9"
];
