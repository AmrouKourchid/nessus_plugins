...
# Security Advisory OVMSA-2019-0008.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2011-1485", "CVE-2013-4288", "CVE-2019-6133");
  script_bugtraq_id(47496, 62511);

  script_name(english:"OracleVM 3.3 / 3.4 : polkit (OVMSA-2019-0008)");
...
critical security updates :
  ...
  # https://oss.oracle.com/pipermail/oraclevm-errata/2019-March/000930.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7d12e094");
  # https://oss.oracle.com/pipermail/oraclevm-errata/2019-March/000929.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c078a59d");
...
flag = 0;
if (rpm_check(release:"OVS3.3", reference:"polkit-0.96-11.el6_10.1")) flag++;

if (rpm_check(release:"OVS3.4", reference:"polkit-0.96-11.el6_10.1")) flag++;
