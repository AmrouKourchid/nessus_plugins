...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.0 : python-pip (EulerOS-SA-2024-2186)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2186
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ed54613e");
...
var pkgs = [
  "python-pip-wheel-21.3.1-1.h7.eulerosv2r11",
  "python3-pip-21.3.1-1.h7.eulerosv2r11"
];
