...
if (description)
{
  ...
  script_bugtraq_id(74188);

  script_name(english:"EulerOS 2.0 SP3 : gnutls (EulerOS-SA-2019-2590)");
...
vulnerability :
  ...
  - Double free vulnerability in lib/x509/x509_ext.c in
    GnuTLS before 3.3.14 allows remote attackers to cause a
    denial of service or possibly have unspecified other
    impact via a crafted CRL distribution
    point.(CVE-2015-3308)
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2590
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7a9692de");
  script_set_attribute(attribute:"solution", value:
"Update the affected gnutls package.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-3308");
...
pkgs = ["gnutls-3.3.26-9.h4",
        "gnutls-c++-3.3.26-9.h4",
        "gnutls-dane-3.3.26-9.h4",
        "gnutls-devel-3.3.26-9.h4",
        "gnutls-utils-3.3.26-9.h4"];
