...
# extracted from Fedora Security Advisory FEDORA-2025-9a278a7768
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-9a278a7768");

  script_name(english:"Fedora 40 : nodejs-nodemon (2025-9a278a7768)");
...
FEDORA-2025-9a278a7768 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-9a278a7768");
...
var pkgs = [
    {'reference':'nodejs-nodemon-3.1.9-3.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
