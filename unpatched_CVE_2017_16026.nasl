...
if (description)
{
  ...
  script_cve_id("CVE-2017-16026");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2017-16026");
...
patch available.
  ...
  - Request is an http client. If a request is made using ```multipart```, and the body type is a
    ```number```, then the specified number of non-zero memory is passed in the body. This affects Request
    >=2.2.6 <2.47.0 || >2.51.0 <=2.67.0. (CVE-2017-16026)
