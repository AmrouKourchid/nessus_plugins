...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP12 : gnutls (EulerOS-SA-2025-1420)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1420
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?738409b7");
...
var pkgs = [
  "gnutls-3.7.2-6.h12.eulerosv2r12",
  "gnutls-utils-3.7.2-6.h12.eulerosv2r12"
];
