...
# extracted from SUSE update advisory SUSE-SU-2019:2346-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES15 Security Update : podman (SUSE-SU-2019:2346-1)");
...
without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=1144065");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2019-10214/");
  # https://www.suse.com/support/update/announcement/2019/suse-su-20192346-1/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b71ba7ec");
...
SUSE-SLE-Module-Containers-15-SP1-2019-2346=1");
...
flag = 0;
if (rpm_check(release:"SLES15", sp:"1", reference:"podman-1.4.4-4.11.1")) flag++;
