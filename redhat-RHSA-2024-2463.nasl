...
# extracted from Red Hat Security Advisory RHSA-2024:2463. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2463");

  script_name(english:"RHEL 9 : systemd (RHSA-2024:2463)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2463.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?45c6673e");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2463");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2222672");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-16182");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-16354");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-16810");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-16952");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-20757");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-22278");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-22427");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-22430");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-22443");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-23756");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-26133");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-26643");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-29441");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-5070");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-5988");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-6090");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-7026");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL systemd package based on the guidance in RHSA-2024:2463.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rhel-net-naming-sysattrs");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:systemd");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:systemd-boot-unsigned");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:systemd-oomd");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:systemd-rpm-macros");
...
var constraints = [
  {
    ...
    'pkgs': [
      ...
      {'reference':'systemd-252-32.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'systemd-container-252-32.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-devel-252-32.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-journal-remote-252-32.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-libs-252-32.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-oomd-252-32.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-pam-252-32.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-resolved-252-32.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-rpm-macros-252-32.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-udev-252-32.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
