...
# extracted from Fedora Security Advisory FEDORA-2019-9f04a701c0.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2019-10129", "CVE-2019-10164");
  script_xref(name:"FEDORA", value:"2019-9f04a701c0");

  script_name(english:"Fedora 30 : libpq / postgresql (2019-9f04a701c0)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-9f04a701c0");
  script_set_attribute(attribute:"see_also", value:"https://www.postgresql.org/docs/11/release-11-4.html");
  script_set_attribute(attribute:"solution", value:
"Update the affected libpq and / or postgresql packages.");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"libpq-11.4-1.fc30")) flag++;
if (rpm_check(release:"FC30", reference:"postgresql-11.4-1.fc30")) flag++;
