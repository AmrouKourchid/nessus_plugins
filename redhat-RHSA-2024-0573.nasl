...
# extracted from Red Hat Security Advisory RHSA-2024:0573. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:0573");

  script_name(english:"RHEL 8 : libfastjson (RHSA-2024:0573)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0573.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?565bb960");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1835253");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0573");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libfastjson package based on the guidance in RHSA-2024:0573.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libfastjson-0.99.9-1.el8_8.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
