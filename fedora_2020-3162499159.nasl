...
# extracted from Fedora Security Advisory FEDORA-2020-3162499159.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-3162499159");

  script_name(english:"Fedora 31 : PyYAML (2020-3162499159)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-3162499159");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"PyYAML-5.3-2.fc31")) flag++;
