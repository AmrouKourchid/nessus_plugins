...
if (description)
{
  ...
  script_name(english:"Notepad++ < 8.5.7 Multiple Buffer Overflow Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The text editor on the remote Windows host is affected by multiple vulnerabilties.");
  script_set_attribute(attribute:"description", value:
"The version of Notepad++ installed on the remote host is prior to 8.5.7. It is, therefore, affected by multiple 
...
"Upgrade to Notepad++ 8.5.7 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-40031");
...
var constraints = [{'fixed_version':'8.5.7'}];
