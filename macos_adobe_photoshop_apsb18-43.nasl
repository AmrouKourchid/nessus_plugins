...
if (description)
{
  ...
  script_name(english:"Adobe Photoshop CC 19.x < 19.1.7 Vulnerability (macOS APSB18-43)");

  script_set_attribute(attribute:"synopsis", value:
"Adobe Photoshop installed on remote macOS or Mac OS X host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Photoshop CC installed on the remote macOS or Mac OS X host is prior to 19.1.7. It is, therefore,
affected by a vulnerability as referenced in the apsb18-43 advisory.

  - Adobe Photoshop CC versions 19.1.6 and earlier have an out-of-bounds read vulnerability. Successful
    exploitation could lead to information disclosure. (CVE-2018-15980)
...
"Upgrade to Adobe Photoshop version 19.1.7 or later.");
...
var constraints = [
  { 'min_version' : '19.0.0', 'fixed_version' : '19.1.7' }
];
