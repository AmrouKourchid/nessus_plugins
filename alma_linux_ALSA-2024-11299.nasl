...
# AlmaLinux Security Advisory ALSA-2024:11299.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:11299");
  script_xref(name:"RHSA", value:"2024:11299");
  script_xref(name:"IAVA", value:"2024-A-0832-S");

  script_name(english:"AlmaLinux 8 : gstreamer1-plugins-good (ALSA-2024:11299)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ALSA-2024:11299 advisory.
    ...
    * gstreamer1-plugins-good: uninitialized stack memory in Matroska/WebM demuxer (CVE-2024-47540)
      ...
      * gstreamer1-plugins-good: integer overflows in MP4/MOV demuxer and memory allocator that can lead to
    out-of-bounds writes (CVE-2024-47606)

Tenable has extracted the preceding description block directly from the AlmaLinux security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2024-11299.html");
...
var pkgs = [
    {'reference':'gstreamer1-plugins-good-1.16.1-5.el8_10', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'gstreamer1-plugins-good-gtk-1.16.1-5.el8_10', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'}
];
