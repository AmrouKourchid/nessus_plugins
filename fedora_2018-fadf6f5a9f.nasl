...
# extracted from Fedora Security Advisory FEDORA-2018-fadf6f5a9f.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : soundtouch (2018-fadf6f5a9f)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-fadf6f5a9f");
...
flag = 0;
if (rpm_check(release:"FC27", reference:"soundtouch-2.0.0-6.fc27")) flag++;
