...
# extracted from VMware Security Advisory PHSA-2024-5.0-0280. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Curl PHSA-2024-5.0-0280");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the curl package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-5.0-280.md");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'curl-8.7.1-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'curl-devel-8.7.1-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'curl-libs-8.7.1-1.ph5')) flag++;
