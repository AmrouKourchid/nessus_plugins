...
# extracted from Red Hat Security Advisory RHSA-2010:0809. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2010:0809");

  script_name(english:"RHEL 5 : xulrunner (RHSA-2010:0809)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for xulrunner.");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8a7474ff");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#critical");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=646997");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2010/rhsa-2010_0809.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e17d7b09");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2010:0809");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL xulrunner package based on the guidance in RHSA-2010:0809.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:H/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:H/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2010-3765");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'xulrunner-1.9.2.11-4.el5_5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xulrunner-1.9.2.11-4.el5_5', 'cpu':'ppc', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xulrunner-1.9.2.11-4.el5_5', 'cpu':'ppc64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xulrunner-1.9.2.11-4.el5_5', 'cpu':'s390', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xulrunner-1.9.2.11-4.el5_5', 'cpu':'s390x', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xulrunner-1.9.2.11-4.el5_5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xulrunner-devel-1.9.2.11-4.el5_5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xulrunner-devel-1.9.2.11-4.el5_5', 'cpu':'ppc', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xulrunner-devel-1.9.2.11-4.el5_5', 'cpu':'ppc64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xulrunner-devel-1.9.2.11-4.el5_5', 'cpu':'s390', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xulrunner-devel-1.9.2.11-4.el5_5', 'cpu':'s390x', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xulrunner-devel-1.9.2.11-4.el5_5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
