...
# extracted from Fedora Security Advisory FEDORA-2025-b353a46e0c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-b353a46e0c");

  script_name(english:"Fedora 40 : python3.8 (2025-b353a46e0c)");
...
FEDORA-2025-b353a46e0c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-b353a46e0c");
...
"Update the affected python3.8 package.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2024-11168");
...
var pkgs = [
    {'reference':'python3.8-3.8.20-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
