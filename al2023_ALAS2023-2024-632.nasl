...
# extracted from Amazon Linux 2023 Security Advisory ALAS2023-2024-632.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2023 : oci-add-hooks (ALAS2023-2024-632)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2023 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"It is, therefore, affected by multiple vulnerabilities as referenced in the ALAS2023-2024-632 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2023/ALAS-2024-632.html");
...
"Run 'dnf update oci-add-hooks --releasever 2023.4.20240528' to update your system.");
...
var pkgs = [
    {'reference':'oci-add-hooks-0-0.1.20200504git268e3bb.amzn2023.0.3', 'cpu':'aarch64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'oci-add-hooks-0-0.1.20200504git268e3bb.amzn2023.0.3', 'cpu':'x86_64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'oci-add-hooks-debuginfo-0-0.1.20200504git268e3bb.amzn2023.0.3', 'cpu':'aarch64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'oci-add-hooks-debuginfo-0-0.1.20200504git268e3bb.amzn2023.0.3', 'cpu':'x86_64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'oci-add-hooks-debugsource-0-0.1.20200504git268e3bb.amzn2023.0.3', 'cpu':'aarch64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'oci-add-hooks-debugsource-0-0.1.20200504git268e3bb.amzn2023.0.3', 'cpu':'x86_64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE}
];
