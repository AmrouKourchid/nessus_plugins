...
# extracted from Fedora Security Advisory FEDORA-2024-a9dead34c5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-a9dead34c5");

  script_name(english:"Fedora 39 : edk2 (2024-a9dead34c5)");
...
FEDORA-2024-a9dead34c5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-a9dead34c5");
...
var pkgs = [
    {'reference':'edk2-20240214-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
