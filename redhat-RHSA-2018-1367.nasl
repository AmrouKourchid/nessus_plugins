...
# extracted from Red Hat Security Advisory RHSA-2018:1367. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:1367");

  script_name(english:"RHEL 6 : flash-plugin (RHSA-2018:1367)");
...
the RHSA-2018:1367 advisory.

  - flash-plugin: Arbitrary Code Execution vulnerability (APSB18-16) (CVE-2018-4944)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_1367.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b206251f");
  script_set_attribute(attribute:"see_also", value:"https://helpx.adobe.com/security/products/flash-player/apsb18-16.html");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:1367");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#critical");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1576040");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL flash-plugin package based on the guidance in RHSA-2018:1367.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'flash-plugin-29.0.0.171-1.el6_9', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
