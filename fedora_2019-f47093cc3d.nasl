...
# extracted from Fedora Security Advisory FEDORA-2019-f47093cc3d.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-f47093cc3d");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-f47093cc3d");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"ceph-14.2.3-1.fc30", epoch:"2")) flag++;
