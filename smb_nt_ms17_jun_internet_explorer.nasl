...
if (description)
{
  ...
  script_name(english:"Security Updates for Internet Explorer (June 2017)");
...
multiple vulnerabilities :
  ...
  - A remote code execution vulnerability exists when
    ...
    context of the current user.  (CVE-2017-8519,
    CVE-2017-8547)
  ...
  - A remote code execution vulnerability exists in the way
    ...
    current user.  (CVE-2017-8517, CVE-2017-8522,
    CVE-2017-8524)");
...
"Microsoft has released security updates for the affected versions of Internet Explorer.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-8517");
...
if (
  ...
  hotfix_is_vulnerable(os:"6.3", sp:0, file:"mshtml.dll", version:"11.0.9600.18698", min_version:"11.0.9600.16000", dir:"\system32", bulletin:bulletin, kb:"4021558") ||

  # Windows Server 2012
  # Internet Explorer 10
  hotfix_is_vulnerable(os:"6.2", sp:0, file:"mshtml.dll", version:"10.0.9200.22168", min_version:"10.0.9200.16000", dir:"\system32", bulletin:bulletin, kb:"4021558") ||

  # Windows 7 / Server 2008 R2
  # Internet Explorer 8/9/10/11
  hotfix_is_vulnerable(os:"6.1", sp:1, file:"mshtml.dll", version:"11.0.9600.18698", min_version:"11.0.9600.16000", dir:"\system32", bulletin:bulletin, kb:"4021558") ||
...
if(hotfix_vuln)
{
  ...
  report += '  - KB4021558 : Cumulative Security Update for Internet Explorer\n';
  if(os == "6.3")
  {
    report += '  - KB4022726 : Windows 8.1 / Server 2012 R2 Monthly Rollup\n';
    hotfix_add_report(bulletin:'MS17-06', kb:'4022726', report);
  }
  else if(os == "6.2")
  {
    report += '  - KB4022724 : Windows Server 2012 Monthly Rollup\n';
    hotfix_add_report(bulletin:'MS17-06', kb:'4022724', report);
  }
  else if(os == "6.1")
  {
    report += '  - KB4022719 : Windows 7 / Server 2008 R2 Monthly Rollup\n';
    hotfix_add_report(bulletin:'MS17-06', kb:'4022719', report);
  }
