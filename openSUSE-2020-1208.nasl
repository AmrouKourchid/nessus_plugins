...
# extracted from openSUSE Security Update openSUSE-2020-1208.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : firejail (openSUSE-2020-1208)");
...
"This update for firejail fixes the following issues :
  ...
  - CVE-2020-17367: The end-of-options separator -- was not
    handled correctly (boo#1174986).

  - CVE-2020-17368: An attacker who has control over the
    command line arguments could run arbitrary commands
    (boo#1174986).");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1174986");
...
if ( rpm_check(release:"SUSE15.2", reference:"firejail-0.9.62-lp152.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"firejail-debuginfo-0.9.62-lp152.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"firejail-debugsource-0.9.62-lp152.3.3.1") ) flag++;
