...
if (description)
{
  ...
  script_name(english:"IBM DB2 SEoL (9.8.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of IBM DB2 is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, IBM DB2 is 9.8.x. It is, therefore, no longer maintained by its vendor or provider.

Lack of support implies that no new security patches for the product will be released by the vendor. As a result, it may
contain security vulnerabilities.");
  # http://www-01.ibm.com/common/ssi/ShowDoc.wss?docURL=/common/ssi/rep_ca/7/897/ENUS915-117/index.html&lang=en&request_locale=en
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c46fcb5a");
...
"Upgrade to a version of IBM DB2 that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2016/04/30");
...
var constraints = [
  { max_branch : '9.8', min_branch : '9.8', eseol : 20250430, seol : 20160430 }
];
