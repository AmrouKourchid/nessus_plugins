...
# extracted from Fedora Security Advisory FEDORA-2024-93f31f5de6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-93f31f5de6");

  script_name(english:"Fedora 40 : nano (2024-93f31f5de6)");
...
FEDORA-2024-93f31f5de6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-93f31f5de6");
...
var pkgs = [
    {'reference':'nano-7.2-7.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
