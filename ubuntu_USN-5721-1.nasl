...
USN-5721-1 advisory.
    ...
    It was discovered that WavPack was not properly performing checks when dealing with memory. If a user were
    tricked into decompressing a specially crafted WavPack Audio File, an attacker could possibly use this
    issue to cause the WavPack decompressor to crash, resulting in a denial of service.
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libwavpack-dev', 'pkgver': '4.75.2-2ubuntu0.2+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libwavpack1', 'pkgver': '4.75.2-2ubuntu0.2+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'wavpack', 'pkgver': '4.75.2-2ubuntu0.2+esm1', 'ubuntu_pro': TRUE}
];
