...
if (description)
{
  ...
  script_cve_id("CVE-2014-10401");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2014-10401");
...
patch available.
  ...
  - An issue was discovered in the DBI module before 1.632 for Perl. DBD::File drivers can open files from
    folders other than those specifically passed via the f_dir attribute. (CVE-2014-10401)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-10401");
