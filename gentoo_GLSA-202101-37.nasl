...
# extracted from Gentoo Linux Security Advisory GLSA 202101-37.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202101-37");

  script_name(english:"GLSA-202101-37 : VLC: Buffer overflow");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202101-37
(VLC: Buffer overflow)
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202101-37");
...
if (qpkg_check(package:"media-video/vlc", unaffected:make_list("ge 3.0.12.1"), vulnerable:make_list("lt 3.0.12.1"))) flag++;
