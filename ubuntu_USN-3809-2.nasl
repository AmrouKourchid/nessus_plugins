...
# extracted from Ubuntu Security Notice USN-3809-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"3809-2");

  script_name(english:"Ubuntu 18.04 LTS : OpenSSH regression (USN-3809-2)");
...
USN-3809-2 advisory.
    ...
    USN-3809-1 fixed vulnerabilities in OpenSSH. The update for CVE-2018-15473 was incomplete and could
    introduce a regression in certain environments. This update fixes the problem.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3809-2");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'openssh-client', 'pkgver': '1:7.6p1-4ubuntu0.5'},
    {'osver': '18.04', 'pkgname': 'openssh-client-udeb', 'pkgver': '1:7.6p1-4ubuntu0.5'},
    {'osver': '18.04', 'pkgname': 'openssh-server', 'pkgver': '1:7.6p1-4ubuntu0.5'},
    {'osver': '18.04', 'pkgname': 'openssh-server-udeb', 'pkgver': '1:7.6p1-4ubuntu0.5'},
    {'osver': '18.04', 'pkgname': 'openssh-sftp-server', 'pkgver': '1:7.6p1-4ubuntu0.5'},
    {'osver': '18.04', 'pkgname': 'ssh', 'pkgver': '1:7.6p1-4ubuntu0.5'},
    {'osver': '18.04', 'pkgname': 'ssh-askpass-gnome', 'pkgver': '1:7.6p1-4ubuntu0.5'}
];
