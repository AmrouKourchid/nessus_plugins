...
# extracted from Ubuntu Security Notice USN-6422-2. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2021-37706", "CVE-2023-27585");
  script_xref(name:"USN", value:"6422-2");

  script_name(english:"Ubuntu 23.10 : Ring vulnerabilities (USN-6422-2)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6422-2");
  script_set_attribute(attribute:"solution", value:
"Update the affected jami and / or jami-daemon packages.");
...
var pkgs = [
    {'osver': '23.10', 'pkgname': 'jami', 'pkgver': '20230206.0~ds2-1.3ubuntu0.1'},
    {'osver': '23.10', 'pkgname': 'jami-daemon', 'pkgver': '20230206.0~ds2-1.3ubuntu0.1'}
];
