...
# extracted from Fedora Security Advisory FEDORA-2024-513cf04db3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-513cf04db3");

  script_name(english:"Fedora 41 : opendmarc (2024-513cf04db3)");
...
FEDORA-2024-513cf04db3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-513cf04db3");
...
var pkgs = [
    {'reference':'opendmarc-1.4.2-21.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
