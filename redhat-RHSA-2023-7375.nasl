...
# extracted from Red Hat Security Advisory RHSA-2023:7375. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:7375");

  script_name(english:"RHEL 9 : pixman (RHSA-2023:7375)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_7375.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ea60de8d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2139988");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:7375");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL pixman package based on the guidance in RHSA-2023:7375.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'pixman-0.40.0-6.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pixman-devel-0.40.0-6.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
