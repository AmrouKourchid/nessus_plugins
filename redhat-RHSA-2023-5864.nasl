...
# extracted from Red Hat Security Advisory RHSA-2023:5864. The text
...
referenced in the RHSA-2023:5864 advisory.
    ...
    * grafana: golang: net/http, x/net/http2: rapid stream resets can cause excessive work (CVE-2023-44487)
    (CVE-2023-39325)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_5864.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?06bafa05");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:5864");
...
"Update the RHEL grafana package based on the guidance in RHSA-2023:5864.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'grafana-7.5.11-4.el8_6', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
