...
# extracted from Fedora Security Advisory FEDORA-2024-abe1e34fdb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-abe1e34fdb");

  script_name(english:"Fedora 40 : onnx (2024-abe1e34fdb)");
...
FEDORA-2024-abe1e34fdb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-abe1e34fdb");
  script_set_attribute(attribute:"solution", value:
"Update the affected onnx package.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:C/I:N/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-27319");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:onnx");
...
var pkgs = [
    {'reference':'onnx-1.14.1-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'onnx');
}
