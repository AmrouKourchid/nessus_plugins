...
# extracted from Fedora Security Advisory FEDORA-2023-dcf1c398fb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-dcf1c398fb");

  script_name(english:"Fedora 37 : stb (2023-dcf1c398fb)");
...
FEDORA-2023-dcf1c398fb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-dcf1c398fb");
...
var pkgs = [
    {'reference':'stb-0^20230129git5736b15-0.2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
