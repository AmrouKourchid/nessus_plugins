...
# extracted from Red Hat Security Advisory RHSA-2020:4482. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:4482");

  script_name(english:"RHEL 8 : libgcrypt (RHSA-2020:4482)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2020:4482 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_4482.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a3327181");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/8.3_release_notes/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b7e37d18");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:4482");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libgcrypt-1.8.5-4.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libgcrypt-devel-1.8.5-4.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
