...
# extracted from Fedora Security Advisory FEDORA-2023-00d4509fa9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-00d4509fa9");

  script_name(english:"Fedora 38 : java-latest-openjdk (2023-00d4509fa9)");
...
FEDORA-2023-00d4509fa9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-00d4509fa9");
...
var pkgs = [
    {'reference':'java-latest-openjdk-21.0.1.0.12-1.rolling.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
