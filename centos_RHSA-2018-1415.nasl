...
# CentOS Errata and Security Advisory 2018:1415 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : firefox (CESA-2018:1415)");
...
Root Object as the original reporters.");
  # https://lists.centos.org/pipermail/centos-announce/2018-May/022859.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?283cf273");
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"firefox-52.8.0-1.el7.centos", allowmaj:TRUE)) flag++;
