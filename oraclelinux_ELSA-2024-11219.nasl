...
# extracted from Oracle Linux Security Advisory ELSA-2024-11219.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : edk2:20240524 (ELSA-2024-11219)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-11219.html");
...
var module_ver = get_kb_item('Host/RedHat/appstream/edk2');
...
var appstreams = {
    'edk2:20240524': [
      {'reference':'edk2-aarch64-20240524-6.0.1.el9_5.3', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'edk2-ovmf-20240524-6.0.1.el9_5.3', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'edk2-tools-20240524-6.0.1.el9_5.3', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'edk2-tools-doc-20240524-6.0.1.el9_5.3', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'edk2-aarch64-20240524-6.0.1.el9_5.3', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'edk2-ovmf-20240524-6.0.1.el9_5.3', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'edk2-tools-20240524-6.0.1.el9_5.3', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'edk2-tools-doc-20240524-6.0.1.el9_5.3', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
};
