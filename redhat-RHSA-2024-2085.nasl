...
# extracted from Red Hat Security Advisory RHSA-2024:2085. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2085");

  script_name(english:"RHEL 9 : libreswan (RHSA-2024:2085)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2085.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7a368575");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2085");
...
"Update the RHEL libreswan package based on the guidance in RHSA-2024:2085.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libreswan-4.9-5.el9_2.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
