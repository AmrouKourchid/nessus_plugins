...
# extracted from Fedora Security Advisory FEDORA-2025-80dfa228e7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-80dfa228e7");

  script_name(english:"Fedora 40 : lemonldap-ng (2025-80dfa228e7)");
...
FEDORA-2025-80dfa228e7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-80dfa228e7");
...
var pkgs = [
    {'reference':'lemonldap-ng-2.21.0-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
