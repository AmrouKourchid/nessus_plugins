...
# SUSE update advisory SUSE-SU-2025:0455-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2025:0455-1");

  script_name(english:"SUSE SLES15 Security Update : kernel (Live Patch 22 for SLE 15 SP4) (SUSE-SU-2025:0455-1)");
...
the SUSE-SU-2025:0455-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1229644");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1229663");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2025-February/020321.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c32b6944");
...
"Update the affected kernel-livepatch-5_14_21-150400_24_103-default package.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '5.14.21-150400.24.103-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_14_21-150400_24_103-default-15-150400.2.1', 'sp':'4', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.4']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kernel-livepatch-5_14_21-150400_24_103-default');
}
