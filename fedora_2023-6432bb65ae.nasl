...
# extracted from Fedora Security Advisory FEDORA-2023-6432bb65ae
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-6432bb65ae");

  script_name(english:"Fedora 38 : libeconf (2023-6432bb65ae)");
...
FEDORA-2023-6432bb65ae advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-6432bb65ae");
...
var pkgs = [
    {'reference':'libeconf-0.5.2-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
