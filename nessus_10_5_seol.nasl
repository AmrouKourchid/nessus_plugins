...
if (description)
{
  ...
  script_name(english:"Tenable Nessus SEoL (10.5.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Tenable Nessus is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Tenable Nessus is 10.5.x. It is, therefore, no longer maintained by its vendor or provider.
...
"Upgrade to a version of Tenable Nessus that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2024/09/30");
...
var constraints = [
  { max_branch : '10.5', min_branch : '10.5', seol : 20240930, eseol : 20250331 }
];
