...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.0 : libX11 (EulerOS-SA-2023-2938)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2938
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bf23f1a5");
...
var pkgs = [
  "libX11-1.6.9-4.h4.eulerosv2r10"
];
