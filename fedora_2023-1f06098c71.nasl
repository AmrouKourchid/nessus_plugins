...
# extracted from Fedora Security Advisory FEDORA-2023-1f06098c71
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-1f06098c71");

  script_name(english:"Fedora 38 : python-aiohttp / python-pysqueezebox / python-wled (2023-1f06098c71)");
...
FEDORA-2023-1f06098c71 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-1f06098c71");
...
var pkgs = [
    {'reference':'python-aiohttp-3.9.1-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python-pysqueezebox-0.5.5-11.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python-wled-0.4.4-11.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
