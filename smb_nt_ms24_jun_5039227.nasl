...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5039227");
  script_xref(name:"MSKB", value:"5039330");
  script_xref(name:"MSFT", value:"MS24-5039227");
  script_xref(name:"MSFT", value:"MS24-5039330");
  ...
  script_name(english:"KB5039227: Windows Server 2022 / Azure Stack HCI 22H2 Security Update (June 2024)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5039227. It is, therefore, affected by multiple vulnerabilities
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5039227");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5039227");
...
if (
  smb_check_rollup(os:'10',
                   ...
                   rollup_date:'06_2024',
                   bulletin:bulletin,
                   rollup_kb_list:[5039227,5039330])
)
{
