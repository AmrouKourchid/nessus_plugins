...
# extracted from Red Hat Security Advisory RHSA-2010:0362 and 
# Oracle Linux Security Advisory ELSA-2010-0362 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : scsi-target-utils (ELSA-2010-0362)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2010-0362.html");
...
var pkgs = [
    {'reference':'scsi-target-utils-0.0-6.20091205snap.el5_5.2', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'scsi-target-utils-0.0-6.20091205snap.el5_5.2', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
