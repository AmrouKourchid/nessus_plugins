...
# extracted from Fedora Security Advisory FEDORA-2024-c673517dce
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-c673517dce");

  script_name(english:"Fedora 40 : apache-commons-configuration (2024-c673517dce)");
...
FEDORA-2024-c673517dce advisory.

    This update contains security fixes for CVE-2024-29131 and CVE-2024-29133.

    See https://github.com/apache/commons-configuration/blob/master/RELEASE-NOTES.txt for changes in versions
    2.10.0 and 2.10.1.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-c673517dce");
  script_set_attribute(attribute:"solution", value:
"Update the affected apache-commons-configuration package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:apache-commons-configuration");
...
var pkgs = [
    {'reference':'apache-commons-configuration-2.10.1-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'apache-commons-configuration');
}
