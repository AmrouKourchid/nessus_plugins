...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS : GUPnP vulnerability (USN-4970-1)");
...
USN-4970-1 advisory.
    ...
    It was discovered that GUPnP incorrectly filtered local requests. If a user were tricked into visiting a
    malicious website, a remote attacker could possibly use this issue to perform actions against local UPnP
