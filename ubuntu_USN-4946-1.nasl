...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 ESM / 18.04 LTS : Linux kernel vulnerabilities (USN-4946-1)");
...
var kernel_mappings = {
  ...
  '18.04': {
    '4.15.0': {
      'generic': '4.15.0-143',
      'generic-lpae': '4.15.0-143',
      'lowlatency': '4.15.0-143',
      'dell300x': '4.15.0-1018',
      'oracle': '4.15.0-1071',
      'raspi2': '4.15.0-1085',
      'kvm': '4.15.0-1091',
      'gcp': '4.15.0-1099',
      'snapdragon': '4.15.0-1102',
      'azure': '4.15.0-1114'
    }
  }
};
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-4946-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2021-20292', 'CVE-2021-26930', 'CVE-2021-26931', 'CVE-2021-28038', 'CVE-2021-28688', 'CVE-2021-29264', 'CVE-2021-29265', 'CVE-2021-29650', 'CVE-2021-30002');
