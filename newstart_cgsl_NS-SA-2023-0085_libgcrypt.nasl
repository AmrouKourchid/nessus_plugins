...
# extracted from ZTE advisory NS-SA-2023-0085. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 6.06 : libgcrypt Vulnerability (NS-SA-2023-0085)");

  script_set_attribute(attribute:"synopsis", value:
"The remote NewStart CGSL host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 6.06, has libgcrypt packages installed that are affected by a
vulnerability:
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/notice/NS-SA-2023-0085");
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/info/CVE-2021-40528");
  script_set_attribute(attribute:"solution", value:
"Upgrade the vulnerable CGSL libgcrypt packages. Note that updated packages may not be available yet. Please contact ZTE
for more information.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:libgcrypt");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:libgcrypt-devel");
...
var pkgs = {
  'CGSL MAIN 6.06': [
    'libgcrypt-1.8.5-7.zncgsl6_6',
    'libgcrypt-devel-1.8.5-7.zncgsl6_6'
  ]
};
