...
# extracted from Gentoo Linux Security Advisory GLSA 202008-10.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202008-10");
  script_xref(name:"IAVA", value:"2020-A-0382-S");

  script_name(english:"GLSA-202008-10 : Chromium, Google Chrome: Heap buffer overflow");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202008-10
(Chromium, Google Chrome: Heap buffer overflow)

    A buffer overflow has been discovered in Chromium and Google Chrome&rsquo;s
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202008-10");
...
if (qpkg_check(package:"www-client/chromium", unaffected:make_list("ge 84.0.4147.135"), vulnerable:make_list("lt 84.0.4147.135"))) flag++;
if (qpkg_check(package:"www-client/google-chrome", unaffected:make_list("ge 84.0.4147.135"), vulnerable:make_list("lt 84.0.4147.135"))) flag++;
