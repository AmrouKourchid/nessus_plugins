...
if (description)
{
  ...
  script_name(english:"PHP 8.4.x < 8.4.5 Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The version PHP running on the remote web server is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of PHP installed on the remote host is prior to 8.4.5. It is, therefore, affected by multiple
vulnerabilities as referenced in the Version 8.4.5 advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"http://php.net/ChangeLog-8.php#8.4.5");
  ...
  script_set_attribute(attribute:"see_also", value:"https://github.com/php/php-src/security/advisories/GHSA-rwp7-7vc6-8477");
...
"Upgrade to PHP version 8.4.5 or later.");
...
var constraints = [
  { 'min_version' : '8.4.0alpha1', 'fixed_version' : '8.4.5' }
];
