...
vulnerabilities as referenced in the ALAS2-2022-1903 advisory.
    ...
    A use-after-free flaw was found in the Linux kernel's implementation of logical link control and
    adaptation protocol (L2CAP), part of the Bluetooth stack in the l2cap_connect and l2cap_le_connect_req
    functions. An attacker with physical access within the range of standard Bluetooth transmission could
    execute code leaking kernel memory via Bluetooth if within proximity of the victim. (CVE-2022-42896)
...
if (get_one_kb_item("Host/kpatch/kernel-cves"))
{
  ...
  var cve_list = make_list("CVE-2022-3524", "CVE-2022-42896", "CVE-2022-49002", "CVE-2022-49007", "CVE-2022-49015", "CVE-2022-49021", "CVE-2022-49033", "CVE-2023-26607");
