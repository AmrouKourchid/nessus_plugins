...
# extracted from Ubuntu Security Notice USN-5042-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5042-1");

  script_name(english:"Ubuntu 20.04 LTS : HAProxy vulnerabilities (USN-5042-1)");
...
USN-5042-1 advisory.
    ...
    It was discovered that HAProxy incorrectly handled the HTTP/2 protocol. A remote attacker could possibly
    use this issue to bypass restrictions.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5042-1");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'haproxy', 'pkgver': '2.0.13-2ubuntu0.2'},
    {'osver': '20.04', 'pkgname': 'vim-haproxy', 'pkgver': '2.0.13-2ubuntu0.2'}
];
