...
if (description)
{
  ...
  script_name(english:"Oracle Siebel Server (January 2024 CPU)");
...
the January 2024 CPU advisory.
  ...
  - Vulnerability in the Siebel CRM product of Oracle Siebel CRM (component: EAI, UI (Apache Tomcat)).
    Supported versions that are affected are Prior to 23.12. Easily exploitable vulnerability allows
    ...
    DOS) of Siebel CRM. (CVE-2023-42794, CVE-2023-42795, CVE-2023-44487, CVE-2023-45648)
