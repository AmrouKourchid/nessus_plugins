...
if (description)
{
  ...
  script_cve_id("CVE-2024-5847");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-5847");
...
patch available.
  ...
  - Use after free in PDFium in Google Chrome prior to 126.0.6478.54 allowed a remote attacker to potentially
    exploit heap corruption via a crafted PDF file. (Chromium security severity: Medium) (CVE-2024-5847)
