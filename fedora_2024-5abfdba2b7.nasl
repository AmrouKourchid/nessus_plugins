...
# extracted from Fedora Security Advisory FEDORA-2024-5abfdba2b7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-5abfdba2b7");

  script_name(english:"Fedora 40 : mingw-python-waitress (2024-5abfdba2b7)");
...
FEDORA-2024-5abfdba2b7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-5abfdba2b7");
  script_set_attribute(attribute:"solution", value:
"Update the affected mingw-python-waitress package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:mingw-python-waitress");
...
var pkgs = [
    {'reference':'mingw-python-waitress-2.1.2-7.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'mingw-python-waitress');
}
