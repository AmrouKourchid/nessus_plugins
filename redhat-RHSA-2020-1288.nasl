...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_1288.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?50946b5b");
...
"Update the RHEL haproxy package based on the guidance in RHSA-2020:1288.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'haproxy-1.8.15-6.el8_1.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'haproxy-1.8.15-6.el8_1.1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
