...
# extracted from Red Hat Security Advisory RHSA-2024:2952. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2952");

  script_name(english:"RHEL 8 : resource-agents (RHSA-2024:2952)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for resource-agents.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:2952 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2952.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4f4daa08");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-17416");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2952");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL resource-agents package based on the guidance in RHSA-2024:2952.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'resource-agents-4.9.0-54.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'resource-agents-aliyun-4.9.0-54.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'resource-agents-gcp-4.9.0-54.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'resource-agents-paf-4.9.0-54.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
