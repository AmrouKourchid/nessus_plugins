...
# extracted from Red Hat Security Advisory RHSA-2023:0285. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:0285");
  script_xref(name:"IAVA", value:"2023-A-0048-S");

  script_name(english:"RHEL 9 : firefox (RHSA-2023:0285)");
...
referenced in the RHSA-2023:0285 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_0285.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4262c505");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:0285");
...
"Update the RHEL firefox package based on the guidance in RHSA-2023:0285.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-102.7.0-1.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
