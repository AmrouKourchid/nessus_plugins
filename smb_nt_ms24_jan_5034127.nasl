...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5034127");
  script_xref(name:"MSFT", value:"MS24-5034127");
  script_xref(name:"IAVA", value:"2024-A-0015-S");
  script_xref(name:"IAVA", value:"2024-A-0016-S");

  script_name(english:"KB5034127: Windows 10 version 1809 / Windows Server 2019 Security Update (January 2024)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5034127");
