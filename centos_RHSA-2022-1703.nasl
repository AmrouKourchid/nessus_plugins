...
if (description)
{
  ...
  script_name(english:"CentOS 7 : firefox (RHSA-2022:1703)");
...
var pkgs = [
    {'reference':'firefox-91.9.0-1.el7.centos', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
