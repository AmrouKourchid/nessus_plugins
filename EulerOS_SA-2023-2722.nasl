...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.1 : freetype (EulerOS-SA-2023-2722)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the freetype package installed, the EulerOS Virtualization installation on the remote host
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2722
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?198d1845");
...
var pkgs = [
  "freetype-2.11.0-1.h2.eulerosv2r11"
];
