...
# extracted from Red Hat Security Advisory RHSA-2023:2800. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 8 : sysstat (RHSA-2023:2800)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_2800.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?70c1080f");
...
"Update the RHEL sysstat package based on the guidance in RHSA-2023:2800.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'sysstat-11.7.3-9.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
