...
if (description)
{
  ...
  script_cve_id("CVE-2024-56728");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-56728");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: octeontx2-pf: handle otx2_mbox_get_rsp
    errors in otx2_ethtool.c Add error pointer check after calling otx2_mbox_get_rsp(). (CVE-2024-56728)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-56728");
