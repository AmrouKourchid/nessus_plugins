...
if (description)
{
  ...
  script_name(english:"Foxit PhantomPDF < 8.3.10 Multiple Vulnerabilities");
...
"Upgrade to Foxit PhantomPDF version 8.3.10 or later");
...
var constraints = [
  { 'max_version' : '8.3.9.41099', 'fixed_version' : '8.3.10' }
];
