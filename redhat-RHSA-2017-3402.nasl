...
referenced in the RHSA-2017:3402 advisory.
    ...
    * Privilege escalation flaws were found in the initialization scripts of PostgreSQL. An attacker with
    ...
    Note: This patch drops the script privileges from root to the postgres user. Therefore, this update works
    properly only if the postgres user has write access to the postgres' home directory, such as the one in
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2017/rhsa-2017_3402.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?74f14904");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2017:3402");
...
"Update the RHEL postgresql package based on the guidance in RHSA-2017:3402.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'postgresql-9.2.23-3.el7_4', 'release':'7', 'el_string':'el7_4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-contrib-9.2.23-3.el7_4', 'release':'7', 'el_string':'el7_4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-devel-9.2.23-3.el7_4', 'release':'7', 'el_string':'el7_4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-docs-9.2.23-3.el7_4', 'release':'7', 'el_string':'el7_4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-libs-9.2.23-3.el7_4', 'release':'7', 'el_string':'el7_4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-plperl-9.2.23-3.el7_4', 'release':'7', 'el_string':'el7_4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-plpython-9.2.23-3.el7_4', 'release':'7', 'el_string':'el7_4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-pltcl-9.2.23-3.el7_4', 'release':'7', 'el_string':'el7_4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-server-9.2.23-3.el7_4', 'release':'7', 'el_string':'el7_4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-static-9.2.23-3.el7_4', 'release':'7', 'el_string':'el7_4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-test-9.2.23-3.el7_4', 'release':'7', 'el_string':'el7_4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-upgrade-9.2.23-3.el7_4', 'release':'7', 'el_string':'el7_4', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
