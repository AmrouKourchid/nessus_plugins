...
# extracted from Fedora Security Advisory FEDORA-2024-bfd98be425
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-bfd98be425");

  script_name(english:"Fedora 39 : mbedtls (2024-bfd98be425)");
...
FEDORA-2024-bfd98be425 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-bfd98be425");
...
var pkgs = [
    {'reference':'mbedtls-2.28.7-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
