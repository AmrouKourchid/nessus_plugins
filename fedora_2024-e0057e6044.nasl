...
# extracted from Fedora Security Advisory FEDORA-2024-e0057e6044
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-e0057e6044");

  script_name(english:"Fedora 39 : python-aiohttp (2024-e0057e6044)");
...
FEDORA-2024-e0057e6044 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-e0057e6044");
...
var pkgs = [
    {'reference':'python-aiohttp-3.9.5-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
