...
# extracted from Fedora Security Advisory FEDORA-2023-18cb340b28
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-18cb340b28");

  script_name(english:"Fedora 37 : xorg-x11-server-Xwayland (2023-18cb340b28)");
...
FEDORA-2023-18cb340b28 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-18cb340b28");
...
var pkgs = [
    {'reference':'xorg-x11-server-Xwayland-22.1.9-3.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
