...
if (description)
{
  ...
  script_name(english:"NuGet Paemgu'emgu.cv' Detection");

  script_set_attribute(attribute:"synopsis", value:
"The remote host has an artificial intelligence NuGet package installed on the remote host.");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.nuget.org/paemgu/emgu.cv/");
  script_set_attribute(attribute:"solution", value: "emgu.cv package is installed on the remote host.");
  ...
  script_set_attribute(attribute:"cpe", value:"cpe:/a:emgu:emgu.cv");
...
var app_info = vcf::nuget_package::get_app_info(pkg_name:"emgu.cv");
app_info.vendor = "emgu";
app_info.cpe = "cpe:/a:emgu:emgu.cv";
