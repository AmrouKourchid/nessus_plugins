...
# extracted from Fedora Security Advisory FEDORA-2024-5a61a2fa45
#
...
if (description)
{
  ...
  script_cve_id("CVE-2024-9341", "CVE-2024-9675", "CVE-2024-9676");
  script_xref(name:"FEDORA", value:"2024-5a61a2fa45");
  script_xref(name:"IAVA", value:"2024-A-0672-S");

  script_name(english:"Fedora 41 : buildah / containers-common / podman (2024-5a61a2fa45)");
...
FEDORA-2024-5a61a2fa45 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-5a61a2fa45");
  script_set_attribute(attribute:"solution", value:
"Update the affected 2:buildah, 5:containers-common and / or 5:podman packages.");
...
var pkgs = [
    {'reference':'buildah-1.37.5-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'containers-common-0.60.4-4.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'epoch':'5'},
    {'reference':'podman-5.2.5-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'epoch':'5'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'buildah / containers-common / podman');
}
