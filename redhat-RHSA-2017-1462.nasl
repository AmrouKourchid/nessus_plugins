...
# extracted from Red Hat Security Advisory RHSA-2017:1462. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2017:1462");

  script_name(english:"RHEL 7 : python-django (RHSA-2017:1462)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for python-django.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2017:1462 advisory.
...
number.");
  ...
  # https://access.redhat.com/security/data/csaf/v2/advisories/2017/rhsa-2017_1462.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c6968f35");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2017:1462");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-django package based on the guidance in RHSA-2017:1462.");
