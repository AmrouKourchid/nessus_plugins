...
if (description)
{
  ...
  script_xref(name:"APPLE-SA", value:"HT213844");
  ...
  script_name(english:"macOS 12.x < 12.6.8 Multiple Vulnerabilities (HT213844)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host is missing a macOS update that fixes multiple vulnerabilities");
  script_set_attribute(attribute:"description", value:
"The remote host is running a version of macOS / Mac OS X that is 12.x prior to 12.6.8. It is, therefore, affected by
...
version number.");
  script_set_attribute(attribute:"see_also", value:"https://support.apple.com/en-us/HT213844");
  script_set_attribute(attribute:"solution", value:
"Upgrade to macOS 12.6.8 or later.");
...
var constraints = [
  { 'fixed_version' : '12.6.8', 'min_version' : '12.0', 'fixed_display' : 'macOS Monterey 12.6.8' }
];
