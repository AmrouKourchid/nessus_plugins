...
# SUSE update advisory SUSE-SU-2025:0090-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2025:0090-1");

  script_name(english:"SUSE SLES12 Security Update : kernel (Live Patch 59 for SLE 12 SP5) (SUSE-SU-2025:0090-1)");
...
the SUSE-SU-2025:0090-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2025-January/020101.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d53a689e");
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-122.225-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_12_14-122_225-default-3-8.6.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.5']}
        ]
      }
    }
  }
