...
# extracted from Ubuntu Security Notice USN-2509-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"2509-1");

  script_name(english:"Ubuntu 14.04 LTS : ca-certificates update (USN-2509-1)");
...
USN-2509-1 advisory.
    ...
    certificates to those contained in the 20141019 package.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2509-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'ca-certificates', 'pkgver': '20141019ubuntu0.14.04.1'}
];
