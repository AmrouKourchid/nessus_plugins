...
# extracted from Red Hat Security Advisory RHSA-2023:0103. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:0103");

  script_name(english:"RHEL 8 : expat (RHSA-2023:0103)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for expat.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2023:0103 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_0103.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d882074c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2140059");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:0103");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL expat package based on the guidance in RHSA-2023:0103.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'expat-2.2.5-10.el8_7.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'expat-devel-2.2.5-10.el8_7.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
