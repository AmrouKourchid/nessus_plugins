...
if (description)
{
  ...
  script_cve_id("CVE-2023-21264");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2023-21264");
...
patch available.
  ...
  - In multiple functions of mem_protect.c, there is a possible way to access hypervisor memory due to a
    memory access check in the wrong place. This could lead to local escalation of privilege with System
    execution privileges needed. User interaction is not needed for exploitation. (CVE-2023-21264)
