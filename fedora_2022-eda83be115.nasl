...
# extracted from Fedora Security Advisory FEDORA-2022-eda83be115
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-eda83be115");

  script_name(english:"Fedora 38 : python3.8 (2022-eda83be115)");
...
FEDORA-2022-eda83be115 advisory.
    ...
    ```
    * Mon Nov 14 2022 Miro Hronok <mhroncok@redhat.com> - 3.8.15-2
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-eda83be115");
...
var pkgs = [
    {'reference':'python3.8-3.8.15-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
