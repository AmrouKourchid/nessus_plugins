...
# extracted from Fedora Security Advisory FEDORA-2022-33dd0f2f3e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-33dd0f2f3e");

  script_name(english:"Fedora 36 : thunderbird (2022-33dd0f2f3e)");
...
FEDORA-2022-33dd0f2f3e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-33dd0f2f3e");
...
var pkgs = [
    {'reference':'thunderbird-102.2.0-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
