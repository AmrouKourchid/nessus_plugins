...
# extracted from Fedora Security Advisory FEDORA-2023-7fe02ec473
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-7fe02ec473");

  script_name(english:"Fedora 38 : galera / mariadb (2023-7fe02ec473)");
...
FEDORA-2023-7fe02ec473 advisory.

    **MariaDB 10.5.23 & Galera 26.4.16**
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-7fe02ec473");
...
var pkgs = [
    {'reference':'galera-26.4.16-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'mariadb-10.5.23-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'}
];
