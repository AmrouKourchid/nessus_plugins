...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : libwebp (EulerOS-SA-2024-1280)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1280
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9f7349e1");
...
var pkgs = [
  "libwebp-1.0.0-3.h2.eulerosv2r8"
];
