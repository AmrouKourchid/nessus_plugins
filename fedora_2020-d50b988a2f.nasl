...
# extracted from Fedora Security Advisory FEDORA-2020-d50b988a2f.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-d50b988a2f");

  script_name(english:"Fedora 31 : cacti / cacti-spine (2020-d50b988a2f)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-d50b988a2f");
  script_set_attribute(attribute:"see_also", value:"https://www.cacti.net/release_notes.php?version=1.2.12");
...
"Update the affected cacti and / or cacti-spine packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-13231");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"cacti-1.2.12-1.fc31")) flag++;
if (rpm_check(release:"FC31", reference:"cacti-spine-1.2.12-1.fc31")) flag++;
