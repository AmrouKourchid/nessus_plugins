...
# extracted from Fedora Security Advisory FEDORA-2023-af9e3098a5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-af9e3098a5");

  script_name(english:"Fedora 38 : python3.8 (2023-af9e3098a5)");
...
FEDORA-2023-af9e3098a5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-af9e3098a5");
...
var pkgs = [
    {'reference':'python3.8-3.8.18-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
