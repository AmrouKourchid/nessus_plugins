...
# extracted from Red Hat Security Advisory apache-ivy. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2022-37865", "CVE-2022-46751");

  script_name(english:"RHEL 7 : apache-ivy (Unpatched Vulnerability) (deprecated)");
