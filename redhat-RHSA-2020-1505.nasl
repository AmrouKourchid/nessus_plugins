...
# extracted from Red Hat Security Advisory RHSA-2020:1505. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:1505");

  script_name(english:"RHEL 7 : qemu-kvm-ma (RHSA-2020:1505)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for qemu-kvm-ma.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2020:1505 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_1505.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8f4a5d4f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:1505");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1794290");
  script_set_attribute(attribute:"see_also", value:"https://www.openwall.com/lists/oss-security/2020/01/23/3");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL qemu-kvm-ma package based on the guidance in RHSA-2020:1505.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'qemu-img-ma-2.10.0-21.el7_5.5', 'sp':'5', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10'},
      {'reference':'qemu-kvm-common-ma-2.10.0-21.el7_5.5', 'sp':'5', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10'},
      {'reference':'qemu-kvm-common-ma-2.10.0-21.el7_5.5', 'sp':'5', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10'},
      {'reference':'qemu-kvm-ma-2.10.0-21.el7_5.5', 'sp':'5', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10'},
      {'reference':'qemu-kvm-ma-2.10.0-21.el7_5.5', 'sp':'5', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10'},
      {'reference':'qemu-kvm-tools-ma-2.10.0-21.el7_5.5', 'sp':'5', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10'},
      {'reference':'qemu-kvm-tools-ma-2.10.0-21.el7_5.5', 'sp':'5', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10'}
    ]
  }
];
