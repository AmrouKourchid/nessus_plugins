...
# extracted from VMware Security Advisory PHSA-2021-2.0-0349. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Dhcp PHSA-2021-2.0-0349");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the dhcp package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-2-349.md");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'dhcp-client-4.3.5-7.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'dhcp-devel-4.3.5-7.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'dhcp-libs-4.3.5-7.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'dhcp-server-4.3.5-7.ph2')) flag++;
