...
# extracted from Fedora Security Advisory FEDORA-2023-df075a7f85
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-df075a7f85");
  script_xref(name:"IAVA", value:"2023-A-0203-S");

  script_name(english:"Fedora 38 : chromium (2023-df075a7f85)");
...
FEDORA-2023-df075a7f85 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-df075a7f85");
...
var pkgs = [
    {'reference':'chromium-112.0.5615.121-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
