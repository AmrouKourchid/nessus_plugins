...
if (description)
{
  ...
  script_name(english:"Oracle MySQL Cluster 8.0.x < 8.0.41 (January 2025 CPU)");
...
mysql_check_version(variant:'Cluster', fixed:'8.0.41', min:'8.0', severity:SECURITY_WARNING);