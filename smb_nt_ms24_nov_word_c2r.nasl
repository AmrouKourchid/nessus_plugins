...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2024-A-0735-S");

  script_name(english:"Security Updates for Microsoft Word Products C2R (November 2024)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://msrc.microsoft.com/update-guide/vulnerability/CVE-2024-49033");
