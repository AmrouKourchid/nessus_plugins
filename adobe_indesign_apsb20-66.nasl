...
if (description)
{
  ...
  script_name(english:"Adobe InDesign 15.0.0 < 16.0.0 Denial-of-service (APSB20-66)");
...
"The version of Adobe InDesign installed on the remote Windows host is prior to 16.0.0. It is, therefore, affected by a
