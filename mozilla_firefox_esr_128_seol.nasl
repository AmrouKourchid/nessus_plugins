...
if (description)
{
  ...
  script_name(english:"Mozilla Firefox ESR SEoL (128.x)");
...
"Upgrade to a version of Mozilla Firefox that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2025/09/16");
...
var constraints = [
{ max_branch : '128', min_branch : '128', seol : 20250916 }
];
