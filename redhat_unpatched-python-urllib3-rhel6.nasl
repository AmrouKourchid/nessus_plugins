...
# extracted from Red Hat Security Advisory python-urllib3. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2020-26137", "CVE-2023-43804");

  script_name(english:"RHEL 6 : python-urllib3 (Unpatched Vulnerability) (deprecated)");
