...
# AlmaLinux Security Advisory ALSA-2024:1872.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:1872");

  script_name(english:"AlmaLinux 9 : mod_http2 (ALSA-2024:1872)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2024-1872.html");
...
var pkgs = [
    {'reference':'mod_http2-1.15.19-5.el9_3.1', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'mod_http2-1.15.19-5.el9_3.1', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
