...
if (description)
{
  ...
  script_name(english:"RHCOS 4 : OpenShift Container Platform 4.12.56 (RHSA-2024:1899)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat CoreOS host is missing a security update for OpenShift Container Platform 4.12.56.");
...
referenced in the RHSA-2024:1899 advisory.
...
"Update the RHCOS OpenShift Container Platform 4.12.56 package based on the guidance in RHSA-2024:1899.");
...
var pkgs = [
    {'reference':'openshift-hyperkube-4.12.0-202404161006.p0.g054f0ba.assembly.stream.el8', 'release':'4', 'el_string':'el8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
    {'reference':'openshift-hyperkube-4.12.0-202404161006.p0.g054f0ba.assembly.stream.el9', 'release':'4', 'el_string':'el9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
];
