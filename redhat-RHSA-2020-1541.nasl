...
if (description)
{
  ...
  script_name(english:"RHEL 7 / 8 : Ansible security update (2.9.7) (Important) (RHSA-2020:1541)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_1541.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b46a5c12");
...
"Update the RHEL Ansible package based on the guidance in RHSA-2020:1541.");
