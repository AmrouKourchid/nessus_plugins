...
# extracted from Red Hat Security Advisory RHSA-2025:1678. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:1678");

  script_name(english:"RHEL 8 : bind9.16 (RHSA-2025:1678)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for bind9.16.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2025:1678 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_1678.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dba3f325");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:1678");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL bind9.16 package based on the guidance in RHSA-2025:1678.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'bind9.16-9.16.23-0.14.el8_8.6', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind9.16-chroot-9.16.23-0.14.el8_8.6', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind9.16-devel-9.16.23-0.14.el8_8.6', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind9.16-dnssec-utils-9.16.23-0.14.el8_8.6', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind9.16-doc-9.16.23-0.14.el8_8.6', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind9.16-libs-9.16.23-0.14.el8_8.6', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind9.16-license-9.16.23-0.14.el8_8.6', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind9.16-utils-9.16.23-0.14.el8_8.6', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'python3-bind9.16-9.16.23-0.14.el8_8.6', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'}
    ]
  }
];
