...
# extracted from Fedora Security Advisory FEDORA-2019-7ec5bb5d22.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-7ec5bb5d22");

  script_name(english:"Fedora 30 : python36 (2019-7ec5bb5d22)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"Python 3.6.10 is the latest security fix release of Python 3.6.

Security fix for CVE-2019-16056, CVE-2019-16935.

Note that Tenable Network Security has extracted the preceding
description block directly from the Fedora update system website.
Tenable has attempted to automatically clean and format it as much as
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-7ec5bb5d22");
  script_set_attribute(attribute:"solution", value:
"Update the affected python36 package.");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"python36-3.6.10-1.fc30")) flag++;
