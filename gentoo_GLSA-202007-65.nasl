...
# extracted from Gentoo Linux Security Advisory GLSA 202007-65.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2017-14245", "CVE-2017-14246", "CVE-2019-3832");
  script_xref(name:"GLSA", value:"202007-65");

  script_name(english:"GLSA-202007-65 : libsndfile: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202007-65
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202007-65");
...
if (qpkg_check(package:"media-libs/libsndfile", unaffected:make_list("ge 1.0.29_pre2_p20191024"), vulnerable:make_list("lt 1.0.29_pre2_p20191024"))) flag++;
