...
# extracted from Fedora Security Advisory FEDORA-2024-d2e583eab4
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-d2e583eab4");

  script_name(english:"Fedora 41 : polkit (2024-d2e583eab4)");
...
FEDORA-2024-d2e583eab4 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-d2e583eab4");
...
var pkgs = [
    {'reference':'polkit-125-1.fc41.1', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
