...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS : rsync vulnerabilities (USN-3506-1)");
...
referenced in the USN-3506-1 advisory.
    ...
    It was discovered that rsync does not check for fnamecmp filenames and also does not apply the
    sanitize_paths protection mechanism to pathnames. An attacker could use this to bypass access
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3506-1");
...
"Update the affected rsync package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-17434");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'rsync', 'pkgver': '3.1.0-2ubuntu0.3'},
    {'osver': '16.04', 'pkgname': 'rsync', 'pkgver': '3.1.1-3ubuntu1.1'}
];
