...
# extracted from Fedora Security Advisory FEDORA-2023-68ae37fca3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-68ae37fca3");

  script_name(english:"Fedora 36 : redis (2023-68ae37fca3)");
...
FEDORA-2023-68ae37fca3 advisory.
    ...
    *    Avoid possible hang when client issues long KEYS, SRANDMEMBER, HRANDFIELD,   and ZRANDMEMBER commands
    and gets disconnected by client output buffer limit (#11676)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-68ae37fca3");
...
"Update the affected redis package.");
  ...
  script_set_attribute(attribute:"vuln_publication_date", value:"2023/01/16");
...
var pkgs = [
    {'reference':'redis-6.2.10-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
