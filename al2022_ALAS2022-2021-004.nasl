...
# extracted from Amazon Linux 2022 Security Advisory ALAS2022-2021-004.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2022 : log4j, log4j-jcl, log4j-slf4j (ALAS2022-2021-004)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2022/ALAS-2021-004.html");
...
var pkgs = [
    {'reference':'log4j-2.16.0-1.amzn2022', 'release':'AL-2022', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'log4j-jcl-2.16.0-1.amzn2022', 'release':'AL-2022', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'log4j-slf4j-2.16.0-1.amzn2022', 'release':'AL-2022', 'rpm_spec_vers_cmp':TRUE}
];
