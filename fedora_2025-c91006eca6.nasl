...
# extracted from Fedora Security Advisory FEDORA-2025-c91006eca6
#
...
if (description)
{
  ...
  script_cve_id("CVE-2025-2849");
  script_xref(name:"FEDORA", value:"2025-c91006eca6");

  script_name(english:"Fedora 41 : upx (2025-c91006eca6)");
...
FEDORA-2025-c91006eca6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-c91006eca6");
...
"Update the affected upx package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-2849");
...
var pkgs = [
    {'reference':'upx-5.0.0-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
