...
if (description)
{
  ...
  script_name(english:"CentOS 9 : microcode_ctl-20240910-1.el9");
...
microcode_ctl-20240910-1.el9 build changelog.

  - Observable discrepancy in RAPL interface for some Intel(R) Processors may allow a privileged user to
    potentially enable information disclosure via local access. (CVE-2024-23984)
  ...
  - Improper finite state machines (FSMs) in hardware logic in some Intel(R) Processors may allow an
    privileged user to potentially enable a denial of service via local access. (CVE-2024-24968)
  ...
  - Mirrored regions with different values in 3rd Generation Intel(R) Xeon(R) Scalable Processors may allow a
    privileged user to potentially enable denial of service via local access. (CVE-2024-25939)

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=68391");
...
var pkgs = [
    {'reference':'microcode_ctl-20240910-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'}
];
