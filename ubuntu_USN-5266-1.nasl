...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-5266-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2021-22600', 'CVE-2021-42739');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-5266-1');
  }
  else
  {
