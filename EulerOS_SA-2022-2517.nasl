...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : libxml2 (EulerOS-SA-2022-2517)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2517
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3c847411");
...
var pkgs = [
  "libxml2-2.9.1-6.3.h30.eulerosv2r7",
  "libxml2-devel-2.9.1-6.3.h30.eulerosv2r7",
  "libxml2-python-2.9.1-6.3.h30.eulerosv2r7"
];
