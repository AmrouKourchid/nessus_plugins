...
if (description)
{
  ...
  script_cve_id("CVE-2019-11236", "CVE-2019-11324", "CVE-2020-26137");

  script_name(english:"Photon OS 3.0: Python PHSA-2021-3.0-0246");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2019-11324");
...
if (rpm_check(release:'PhotonOS-3.0', reference:'python-urllib3-1.25.11-1.ph3')) flag++;
