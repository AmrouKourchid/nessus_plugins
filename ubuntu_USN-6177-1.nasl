...
# extracted from Ubuntu Security Notice USN-6177-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6177-1");

  script_name(english:"Ubuntu 16.04 ESM / 18.04 ESM / 20.04 LTS / 22.04 LTS : Jettison vulnerabilities (USN-6177-1)");
...
multiple vulnerabilities as referenced in the USN-6177-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6177-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libjettison-java', 'pkgver': '1.2-3ubuntu0.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libjettison-java', 'pkgver': '1.4.0-1ubuntu0.18.04.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '20.04', 'pkgname': 'libjettison-java', 'pkgver': '1.4.0-1ubuntu0.20.04.1', 'ubuntu_pro': FALSE},
    {'osver': '22.04', 'pkgname': 'libjettison-java', 'pkgver': '1.4.1-1ubuntu0.22.04.1', 'ubuntu_pro': FALSE}
];
