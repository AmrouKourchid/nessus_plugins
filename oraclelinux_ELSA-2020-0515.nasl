...
# Oracle Linux Security Advisory ELSA-2020-0515 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : ksh (ELSA-2020-0515)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2020-0515.html");
...
"Update the affected ksh package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:ksh");
