...
# extracted from Fedora Security Advisory FEDORA-2019-ff2b5b5b47.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-ff2b5b5b47");

  script_name(english:"Fedora 29 : evince (2019-ff2b5b5b47)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-ff2b5b5b47");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"evince-3.30.2-4.fc29")) flag++;
