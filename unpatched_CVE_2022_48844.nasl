...
if (description)
{
  ...
  script_cve_id("CVE-2022-48844");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-48844");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: Bluetooth: hci_core: Fix leaking
    sent_cmd skb sent_cmd memory is not freed before freeing hci_dev causing it to leak it contents.
    (CVE-2022-48844)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-48844");
