...
# extracted from Ubuntu Security Notice USN-7048-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"7048-2");

  script_name(english:"Ubuntu 14.04 LTS : Vim vulnerability (USN-7048-2)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7048-2");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'vim', 'pkgver': '2:7.4.052-1ubuntu3.1+esm19', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'vim-athena', 'pkgver': '2:7.4.052-1ubuntu3.1+esm19', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'vim-common', 'pkgver': '2:7.4.052-1ubuntu3.1+esm19', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'vim-gnome', 'pkgver': '2:7.4.052-1ubuntu3.1+esm19', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'vim-gtk', 'pkgver': '2:7.4.052-1ubuntu3.1+esm19', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'vim-gui-common', 'pkgver': '2:7.4.052-1ubuntu3.1+esm19', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'vim-lesstif', 'pkgver': '2:7.4.052-1ubuntu3.1+esm19', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'vim-nox', 'pkgver': '2:7.4.052-1ubuntu3.1+esm19', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'vim-runtime', 'pkgver': '2:7.4.052-1ubuntu3.1+esm19', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'vim-tiny', 'pkgver': '2:7.4.052-1ubuntu3.1+esm19', 'ubuntu_pro': TRUE}
];
