...
# extracted from Fedora Security Advisory FEDORA-2022-d00969b4f0
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-d00969b4f0");

  script_name(english:"Fedora 37 : python3.7 (2022-d00969b4f0)");
...
FEDORA-2022-d00969b4f0 advisory.

    Automatic update for python3.7-3.7.13-2.fc37.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-d00969b4f0");
...
var pkgs = [
    {'reference':'python3.7-3.7.13-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
