...
# openSUSE Security Update openSUSE-SU-2024:0005-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : putty (openSUSE-SU-2024:0005-1)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5cf13978");
...
var pkgs = [
    {'reference':'putty-0.80-bp154.2.3.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE}
];
