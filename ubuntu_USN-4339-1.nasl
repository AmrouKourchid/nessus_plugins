...
vulnerabilities as referenced in the USN-4339-1 advisory.
    ...
    possibly execute arbitrary code. This issue only applied to Ubuntu 20.04 LTS. (CVE-2017-9111,
    ...
    possibly execute arbitrary code. This issue only applied to Ubuntu 20.04 LTS. (CVE-2018-18444)

    Samuel Gro discovered that OpenEXR incorrectly handled certain malformed EXR image files. If a user were
    tricked into opening a crafted EXR image file, a remote attacker could cause a denial of service, or
    possibly execute arbitrary code. (CVE-2020-11758, CVE-2020-11759, CVE-2020-11760, CVE-2020-11761,
    ...
    tricked into opening a crafted EXR image file, a remote attacker could cause a denial of service.
    (CVE-2020-11765)
