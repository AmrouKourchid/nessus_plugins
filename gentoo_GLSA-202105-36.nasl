...
# extracted from Gentoo Linux Security Advisory GLSA 202105-36.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2021-22876", "CVE-2021-22890", "CVE-2021-22898", "CVE-2021-22901");
  script_xref(name:"GLSA", value:"202105-36");

  script_name(english:"GLSA-202105-36 : cURL: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202105-36
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202105-36"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"net-misc/curl", unaffected:make_list("ge 7.77.0"), vulnerable:make_list("lt 7.77.0"))) flag++;
