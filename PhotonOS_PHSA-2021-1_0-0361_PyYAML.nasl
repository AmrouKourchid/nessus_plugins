...
# extracted from VMware Security Advisory PHSA-2021-1.0-0361. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Pyyaml PHSA-2021-1.0-0361");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the PyYAML package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-1.0-361.md");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'PyYAML-3.12-6.ph1')) flag++;
