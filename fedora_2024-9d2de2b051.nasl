...
# extracted from Fedora Security Advisory FEDORA-2024-9d2de2b051
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-9d2de2b051");

  script_name(english:"Fedora 40 : python-cryptography (2024-9d2de2b051)");
...
FEDORA-2024-9d2de2b051 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-9d2de2b051");
...
var pkgs = [
    {'reference':'python-cryptography-41.0.7-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
