...
# extracted from Gentoo Linux Security Advisory GLSA 202409-18.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202409-18 : liblouis: Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202409-18 (liblouis: Multiple Vulnerabilities)

    Multiple vulnerabilities have been discovered in liblouis. Please review the CVE identifiers referenced
    below for details.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202409-18");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=905298");
...
var packages = [
  {
    ...
    'unaffected' : make_list("ge 3.25.0"),
    'vulnerable' : make_list("lt 3.25.0")
  }
];
