...
# extracted from Fedora Security Advisory FEDORA-2022-76b3530ac2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-76b3530ac2");

  script_name(english:"Fedora 35 : php-pear-CAS (2022-76b3530ac2)");
...
FEDORA-2022-76b3530ac2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-76b3530ac2");
...
var pkgs = [
    {'reference':'php-pear-CAS-1.6.0-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
