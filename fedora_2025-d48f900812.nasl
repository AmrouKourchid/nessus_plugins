...
# extracted from Fedora Security Advisory FEDORA-2025-d48f900812
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-d48f900812");
  script_xref(name:"IAVB", value:"2025-B-0056");
  script_xref(name:"IAVA", value:"2025-A-0211-S");

  script_name(english:"Fedora 40 : firefox (2025-d48f900812)");
...
FEDORA-2025-d48f900812 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-d48f900812");
...
"Update the affected firefox package.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2025-3034");
...
var pkgs = [
    {'reference':'firefox-137.0-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
