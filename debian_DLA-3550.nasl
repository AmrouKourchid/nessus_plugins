...
# extracted from Debian Security Advisory dla-3550. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3550 : libopendmarc-dev - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3550
advisory.

    - -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3550-1                debian-lts@lists.debian.org
    https://www.debian.org/lts/security/                           Chris Lamb
    August 30, 2023                               https://wiki.debian.org/LTS
    - -------------------------------------------------------------------------

    Package        : opendmarc
    Version        : 1.3.2-6+deb10u4
    Debian Bug     : 965284

    It was discovered that there was an issue in the opendmarc DMARC
    email filter system. A call to db_stop was missing from the
    post-installation script which meant that, under some configurations,
    the script would hang indefinitely.

    This problem had been previously addressed in Debian bug #965284
    within Debian unstable; this update merely cherry-picks this update
    for Debian LTS.
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libopendmarc-dev', 'reference': '1.3.2-6+deb10u4'},
    {'release': '10.0', 'prefix': 'libopendmarc2', 'reference': '1.3.2-6+deb10u4'},
    {'release': '10.0', 'prefix': 'opendmarc', 'reference': '1.3.2-6+deb10u4'}
];
