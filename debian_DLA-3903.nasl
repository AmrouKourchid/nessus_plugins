...
# extracted from Debian Security Advisory dla-3903. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3903 : libunbound-dev - security update");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'libunbound-dev', 'reference': '1.13.1-1+deb11u3'},
    {'release': '11.0', 'prefix': 'libunbound8', 'reference': '1.13.1-1+deb11u3'},
    {'release': '11.0', 'prefix': 'python3-unbound', 'reference': '1.13.1-1+deb11u3'},
    {'release': '11.0', 'prefix': 'unbound', 'reference': '1.13.1-1+deb11u3'},
    {'release': '11.0', 'prefix': 'unbound-anchor', 'reference': '1.13.1-1+deb11u3'},
    {'release': '11.0', 'prefix': 'unbound-host', 'reference': '1.13.1-1+deb11u3'}
];
