...
# extracted from Fedora Security Advisory FEDORA-2024-aca908f73b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-aca908f73b");

  script_name(english:"Fedora 40 : kernel (2024-aca908f73b)");
...
FEDORA-2024-aca908f73b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-aca908f73b");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  var cve_list = make_list('FEDORA-2024-aca908f73b');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for FEDORA-2024-aca908f73b');
  }
  else
  {
...
var pkgs = [
    {'reference':'kernel-6.9.6-200.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
