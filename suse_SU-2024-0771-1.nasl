...
# SUSE update advisory SUSE-SU-2024:0771-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2024:0771-1");

  script_name(english:"SUSE SLES12 Security Update : postgresql-jdbc (SUSE-SU-2024:0771-1)");
...
in the SUSE-SU-2024:0771-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2024-March/018096.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b5130565");
...
var pkgs = [
    {'reference':'postgresql-jdbc-9.4-3.12.1', 'sp':'5', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5']},
    {'reference':'postgresql-jdbc-9.4-3.12.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.5']}
];
