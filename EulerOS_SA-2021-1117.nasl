...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : ruby (EulerOS-SA-2021-1117)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1117
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?faf85688");
...
pkgs = ["ruby-2.0.0.648-33.h20",
        "ruby-irb-2.0.0.648-33.h20",
        "ruby-libs-2.0.0.648-33.h20"];
