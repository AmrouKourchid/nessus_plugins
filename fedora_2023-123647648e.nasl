...
# extracted from Fedora Security Advisory FEDORA-2023-123647648e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-123647648e");

  script_name(english:"Fedora 38 : openssh (2023-123647648e)");
...
FEDORA-2023-123647648e advisory.

    Avoid possible self-DoS attack
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-123647648e");
...
var pkgs = [
    {'reference':'openssh-9.0p1-15.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
