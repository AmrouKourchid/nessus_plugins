...
if (description)
{
  ...
  script_cve_id("CVE-2024-26661");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-26661");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: drm/amd/display: Add NULL test for
    'timing generator' in 'dcn21_set_pipe()' In u32 otg_inst = pipe_ctx->stream_res.tg->inst;
    pipe_ctx->stream_res.tg could be NULL, it is relying on the caller to ensure the tg is not NULL.
    (CVE-2024-26661)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-26661");
