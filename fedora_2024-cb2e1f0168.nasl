...
# extracted from Fedora Security Advisory FEDORA-2024-cb2e1f0168
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-cb2e1f0168");

  script_name(english:"Fedora 40 : oath-toolkit (2024-cb2e1f0168)");
...
FEDORA-2024-cb2e1f0168 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-cb2e1f0168");
  script_set_attribute(attribute:"solution", value:
"Update the affected oath-toolkit package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:oath-toolkit");
...
var pkgs = [
    {'reference':'oath-toolkit-2.6.12-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
