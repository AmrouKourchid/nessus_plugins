...
if (description)
{
  ...
  script_cve_id("CVE-2024-24690");

  script_name(english:"Zoom VDI Meeting Client < 5.16.10 Vulnerability (ZSB-24007)");
...
vulnerability as referenced in the ZSB-24007 advisory.

  - Improper input validation in some Zoom clients may allow an authenticated user to conduct a denial of
    service via network access. (CVE-2024-24690)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.zoom.com/en/trust/security-bulletin/ZSB-24007");
...
"Upgrade to Zoom VDI Meeting Client 5.16.10 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-24690");
