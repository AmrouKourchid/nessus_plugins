...
# extracted from Red Hat Security Advisory RHSA-2022:8221. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:8221");

  script_name(english:"RHEL 9 : xorg-x11-server (RHSA-2022:8221)");
...
referenced in the RHSA-2022:8221 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8221.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?33a0d100");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8221");
...
"Update the RHEL xorg-x11-server package based on the guidance in RHSA-2022:8221.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'xorg-x11-server-common-1.20.11-11.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xorg-x11-server-devel-1.20.11-11.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xorg-x11-server-source-1.20.11-11.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xorg-x11-server-Xdmx-1.20.11-11.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xorg-x11-server-Xephyr-1.20.11-11.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xorg-x11-server-Xnest-1.20.11-11.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xorg-x11-server-Xorg-1.20.11-11.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xorg-x11-server-Xvfb-1.20.11-11.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
