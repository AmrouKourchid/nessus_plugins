...
# extracted from Amazon Linux 2 Security Advisory ALAS-2025-2813.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : jsoup (ALAS-2025-2813)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of jsoup installed on the remote host is prior to 1.16.1-4. It is, therefore, affected by a vulnerability as
referenced in the ALAS2-2025-2813 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2025-2813.html");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/cve/html/CVE-2021-37714.html");
...
var pkgs = [
    {'reference':'jsoup-1.16.1-4.amzn2.0.1', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'jsoup-javadoc-1.16.1-4.amzn2.0.1', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
