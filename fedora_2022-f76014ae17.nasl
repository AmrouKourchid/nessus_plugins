...
# extracted from Fedora Security Advisory FEDORA-2022-f76014ae17
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-f76014ae17");

  script_name(english:"Fedora 36 : java-17-openjdk (2022-f76014ae17)");
...
FEDORA-2022-f76014ae17 advisory.

    # New in release OpenJDK 17.0.5 (2022-10-18)

    * [Release announcement](https://bit.ly/openjdk1705)
    * [Full release notes](https://builds.shipilev.net/backports-monitor/release-notes-17.0.5.html)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-f76014ae17");
...
var pkgs = [
    {'reference':'java-17-openjdk-17.0.5.0.8-2.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
