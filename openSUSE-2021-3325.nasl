...
# openSUSE Security Update openSUSE-SU-2021:3325-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : rabbitmq-server (openSUSE-SU-2021:3325-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote SUSE Linux SUSE15 host has packages installed that are affected by multiple vulnerabilities as referenced in
the openSUSE-SU-2021:3325-1 advisory.
...
rendered in a confirmation message without proper `");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?05b095dd");
...
var pkgs = [
    {'reference':'erlang-rabbitmq-client-3.8.11-3.3.3', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rabbitmq-server-3.8.11-3.3.3', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rabbitmq-server-plugins-3.8.11-3.3.3', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE}
];
