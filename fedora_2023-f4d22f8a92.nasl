...
# extracted from Fedora Security Advisory FEDORA-2023-f4d22f8a92
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-f4d22f8a92");

  script_name(english:"Fedora 38 : drupal7 (2023-f4d22f8a92)");
...
FEDORA-2023-f4d22f8a92 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-f4d22f8a92");
...
var pkgs = [
    {'reference':'drupal7-7.98-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
