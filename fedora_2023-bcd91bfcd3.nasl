...
# extracted from Fedora Security Advisory FEDORA-2023-bcd91bfcd3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-bcd91bfcd3");
  script_xref(name:"IAVA", value:"2023-A-0376-S");

  script_name(english:"Fedora 37 : samba (2023-bcd91bfcd3)");
...
FEDORA-2023-bcd91bfcd3 advisory.

    Update to version 4.17.10, Security fixes for CVE-2022-2127, CVE-2023-3347, CVE-2023-34966, CVE-2023-34967
    and CVE-2023-34968

    ----

    Fix netlogon LogonGetCapabilities level 2 error handling

    ----

    Update to version 4.17.9

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-bcd91bfcd3");
...
var pkgs = [
    {'reference':'samba-4.17.10-0.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
