...
# extracted from Debian Security Advisory dla-2805. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2805-1 : libmspack - LTS security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 9 host has packages installed that are affected by a vulnerability as referenced in the dla-2805
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2021/dla-2805");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2019-1010305");
...
var pkgs = [
    {'release': '9.0', 'prefix': 'libmspack-dbg', 'reference': '0.5-1+deb9u4'},
    {'release': '9.0', 'prefix': 'libmspack-dev', 'reference': '0.5-1+deb9u4'},
    {'release': '9.0', 'prefix': 'libmspack-doc', 'reference': '0.5-1+deb9u4'},
    {'release': '9.0', 'prefix': 'libmspack0', 'reference': '0.5-1+deb9u4'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libmspack-dbg / libmspack-dev / libmspack-doc / libmspack0');
}
