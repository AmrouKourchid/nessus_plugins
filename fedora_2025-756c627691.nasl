...
# extracted from Fedora Security Advisory FEDORA-2025-756c627691
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-756c627691");

  script_name(english:"Fedora 41 : kitty (2025-756c627691)");
...
FEDORA-2025-756c627691 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-756c627691");
...
var pkgs = [
    {'reference':'kitty-0.40.0-2.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
