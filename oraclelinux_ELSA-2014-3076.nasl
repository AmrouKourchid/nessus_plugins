...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2014-3076.html");
...
var pkgs = [
    {'reference':'bash-4.2.45-5.el7_0.2.0.1', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'bash-doc-4.2.45-5.el7_0.2.0.1', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
];
