...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : xorg-x11-server (EulerOS-SA-2024-1901)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1901
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7581e63e");
...
var pkgs = [
  "xorg-x11-server-help-1.20.8-4.h14.eulerosv2r10"
];
