...
# AlmaLinux Security Advisory ALSA-2025:0711.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2025:0711");
  script_xref(name:"RHSA", value:"2025:0711");

  script_name(english:"AlmaLinux 8 : python-jinja2 (ALSA-2025:0711)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2025-0711.html");
...
"Update the affected python3-jinja2 package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:python3-jinja2");
...
var pkgs = [
    {'reference':'python3-jinja2-2.10.1-6.el8_10', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'}
];
