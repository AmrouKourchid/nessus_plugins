...
# extracted from openSUSE Security Update openSUSE-2018-691.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : mailman (openSUSE-2018-691)");
...
These non-security issues were fixed :
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1099510");
...
if ( rpm_check(release:"SUSE42.3", reference:"mailman-2.1.27-2.6.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"mailman-debuginfo-2.1.27-2.6.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"mailman-debugsource-2.1.27-2.6.1") ) flag++;
