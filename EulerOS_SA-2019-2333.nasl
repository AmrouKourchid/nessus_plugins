...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.3.0 : coreutils (EulerOS-SA-2019-2333)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization for ARM 64 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the version of the coreutils packages installed, the
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2333
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?648cb0e5");
...
"Update the affected coreutils package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:coreutils-common");
...
pkgs = ["coreutils-8.30-4.h7.eulerosv2r8",
        "coreutils-common-8.30-4.h7.eulerosv2r8"];
