...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.2.0 : sssd (EulerOS-SA-2020-1209)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1209
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?539b94a4");
...
pkgs = ["libipa_hbac-1.16.0-19.5.h7",
        "libsss_autofs-1.16.0-19.5.h7",
        "libsss_certmap-1.16.0-19.5.h7",
        "libsss_idmap-1.16.0-19.5.h7",
        "libsss_nss_idmap-1.16.0-19.5.h7",
        "libsss_sudo-1.16.0-19.5.h7",
        "python-sssdconfig-1.16.0-19.5.h7",
        "sssd-1.16.0-19.5.h7",
        "sssd-ad-1.16.0-19.5.h7",
        "sssd-client-1.16.0-19.5.h7",
        "sssd-common-1.16.0-19.5.h7",
        "sssd-common-pac-1.16.0-19.5.h7",
        "sssd-ipa-1.16.0-19.5.h7",
        "sssd-krb5-1.16.0-19.5.h7",
        "sssd-krb5-common-1.16.0-19.5.h7",
        "sssd-ldap-1.16.0-19.5.h7",
        "sssd-proxy-1.16.0-19.5.h7"];
