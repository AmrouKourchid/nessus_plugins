...
# extracted from Red Hat Security Advisory RHSA-2020:3456. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:3456");

  script_name(english:"RHEL 8 : libvncserver (RHSA-2020:3456)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for libvncserver.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2020:3456 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_3456.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?64cf7c13");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:3456");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1852356");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libvncserver package based on the guidance in RHSA-2020:3456.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libvncserver-0.9.11-9.el8_1.3', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvncserver-devel-0.9.11-9.el8_1.3', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
