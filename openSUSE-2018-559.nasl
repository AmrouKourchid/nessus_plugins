...
# extracted from openSUSE Security Update openSUSE-2018-559.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : ocaml (openSUSE-2018-559)");
...
"This update for ocaml fixes the following issues :
  ...
  - CVE-2018-9838: The caml_ba_deserialize function in
    byterun/bigarray.c in the standard library had an
    integer overflow which, in situations where marshalled
    data is accepted from an untrusted source, allows remote
    attackers to cause a denial of service (memory
    corruption) or possibly execute arbitrary code via a
    crafted object. [bsc#1088591]

This update was imported from the SUSE:SLE-12-SP2:Update update
project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1088591");
...
if ( rpm_check(release:"SUSE42.3", reference:"ocaml-4.03.0-4.6.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"ocaml-compiler-libs-4.03.0-4.6.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"ocaml-compiler-libs-devel-4.03.0-4.6.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"ocaml-debuginfo-4.03.0-4.6.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"ocaml-debugsource-4.03.0-4.6.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"ocaml-emacs-4.03.0-4.6.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"ocaml-ocamldoc-4.03.0-4.6.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"ocaml-ocamldoc-debuginfo-4.03.0-4.6.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"ocaml-rpm-macros-4.03.0-4.6.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"ocaml-runtime-4.03.0-4.6.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"ocaml-runtime-debuginfo-4.03.0-4.6.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"ocaml-source-4.03.0-4.6.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"ocaml-x11-4.03.0-4.6.1") ) flag++;
