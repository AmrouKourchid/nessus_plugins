...
# extracted from Debian Security Advisory dsa-5822. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2024-52596");

  script_name(english:"Debian dsa-5822 : simplesamlphp - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 12 host has a package installed that is affected by a vulnerability as referenced in the dsa-5822
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-52596");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bookworm/simplesamlphp");
...
"Upgrade the simplesamlphp packages.");
  ...
  script_set_attribute(attribute:"cvss4_vector", value:"CVSS:4.0/AV:N/AC:L/AT:N/PR:N/UI:N/VC:H/VI:N/VA:H/SC:L/SI:L/SA:N");
  script_set_attribute(attribute:"cvss4_threat_vector", value:"CVSS:4.0/E:U");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-52596");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'simplesamlphp', 'reference': '1.19.7-1+deb12u1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'simplesamlphp');
}
