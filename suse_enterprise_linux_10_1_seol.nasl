...
if (description)
{
  ...
  script_name(english:"SUSE Enterprise Linux SEoL (10.1.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of SUSE Enterprise Linux is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, SUSE Enterprise Linux is 10.1.x. It is, therefore, no longer maintained by its vendor or
provider.
...
"Upgrade to a version of SUSE Enterprise Linux that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2008/11/30");
...
var constraints = [
  { max_branch : '10.1', min_branch : '10.1', seol : 20081130, eseol : 20101231 }
];
