...
if (description)
{
  ...
  script_cve_id("CVE-2015-8631");

  script_name(english:"Photon OS 1.0: Krb5 PHSA-2017-0011");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'krb5-1.14-5.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'krb5-debuginfo-1.14-5.ph1')) flag++;
