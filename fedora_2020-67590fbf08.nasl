...
# extracted from Fedora Security Advisory FEDORA-2020-67590fbf08.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2018-11243", "CVE-2019-20021", "CVE-2019-20051");
  script_xref(name:"FEDORA", value:"2020-67590fbf08");

  script_name(english:"Fedora 31 : upx (2020-67590fbf08)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-67590fbf08");
...
"Update the affected upx package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-11243");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"upx-3.96-2.fc31")) flag++;
