...
# extracted from Fedora Security Advisory FEDORA-2022-89c22f2ea9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-89c22f2ea9");

  script_name(english:"Fedora 37 : plib (2022-89c22f2ea9)");
...
FEDORA-2022-89c22f2ea9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-89c22f2ea9");
  script_set_attribute(attribute:"solution", value:
"Update the affected plib package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:plib");
...
var pkgs = [
    {'reference':'plib-1.8.5-30.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
