...
# Rocky Linux Security Advisory RLSA-2024:2973.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2024:2973");

  script_name(english:"RockyLinux 8 : libX11 (RLSA-2024:2973)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2024:2973");
...
var pkgs = [
    {'reference':'libX11-1.6.8-8.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'libX11-1.6.8-8.el8', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'libX11-1.6.8-8.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'libX11-common-1.6.8-8.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'libX11-debuginfo-1.6.8-8.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'libX11-debuginfo-1.6.8-8.el8', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'libX11-debuginfo-1.6.8-8.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'libX11-debugsource-1.6.8-8.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'libX11-debugsource-1.6.8-8.el8', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'libX11-debugsource-1.6.8-8.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'libX11-devel-1.6.8-8.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'libX11-devel-1.6.8-8.el8', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'libX11-devel-1.6.8-8.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'libX11-xcb-1.6.8-8.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'libX11-xcb-1.6.8-8.el8', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'libX11-xcb-1.6.8-8.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'libX11-xcb-debuginfo-1.6.8-8.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'libX11-xcb-debuginfo-1.6.8-8.el8', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'libX11-xcb-debuginfo-1.6.8-8.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'}
];
