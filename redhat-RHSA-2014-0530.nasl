...
# extracted from Red Hat Security Advisory RHSA-2014:0530. The text 
...
if (description)
{
  ...
  script_cve_id("CVE-2014-0233");
  script_bugtraq_id(67586);
  script_xref(name:"RHSA", value:"2014:0530");

  script_name(english:"RHEL 6 : rubygem-openshift-origin-node (RHSA-2014:0530)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for rubygem-openshift-origin-node.");
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2014/rhsa-2014_0530.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5304dc44");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2014:0530");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1096955");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rubygem-openshift-origin-node package based on the guidance in RHSA-2014:0530.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:S/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-0233");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rubygem-openshift-origin-node-1.23.9.4-1.el6op', 'release':'6', 'el_string':'el6op', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-ansible'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'rubygem-openshift-origin-node');
}
