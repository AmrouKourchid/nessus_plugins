...
# extracted from Fedora Security Advisory FEDORA-2025-186e31ca40
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-186e31ca40");

  script_name(english:"Fedora 40 : java-latest-openjdk (2025-186e31ca40)");
...
FEDORA-2025-186e31ca40 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-186e31ca40");
...
var pkgs = [
    {'reference':'java-latest-openjdk-24.0.1.0.9-1.rolling.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
