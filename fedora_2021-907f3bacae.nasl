...
# extracted from Fedora Security Advisory FEDORA-2021-907f3bacae
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-907f3bacae");

  script_name(english:"Fedora 32 : python37 (2021-907f3bacae)");
...
FEDORA-2021-907f3bacae advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-907f3bacae");
  script_set_attribute(attribute:"solution", value:
"Update the affected python37 package.");
...
pkgs = [
    {'reference':'python37-3.7.10-1.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE}
];
