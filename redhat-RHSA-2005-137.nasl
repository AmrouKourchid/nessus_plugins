...
# extracted from Red Hat Security Advisory RHSA-2005:137. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2005:137");

  script_name(english:"RHEL 4 : mailman (RHSA-2005:137)");
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2005/rhsa-2005_137.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6717e06a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=147344");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2005:137");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL mailman package based on the guidance in RHSA-2005:137.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:N/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2005-0202");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'mailman-2.1.5-31.rhel4', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      {'reference':'mailman-2.1.5-31.rhel4', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      {'reference':'mailman-2.1.5-31.rhel4', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      {'reference':'mailman-2.1.5-31.rhel4', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      {'reference':'mailman-2.1.5-31.rhel4', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'}
    ]
  }
];
