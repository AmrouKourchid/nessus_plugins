...
# extracted from Red Hat Security Advisory RHSA-2024:1004. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2023-45230");
  script_xref(name:"RHSA", value:"2024:1004");

  script_name(english:"RHEL 8 : edk2 (RHSA-2024:1004)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_1004.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?df7f1361");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2258685");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:1004");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL edk2 package based on the guidance in RHSA-2024:1004.");
  script_set_cvss_base_vector("CVSS2#AV:A/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:A/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-45230");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'edk2-ovmf-20190829git37eef91017ad-9.el8_2.3', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
