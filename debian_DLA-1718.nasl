...
# extracted from Debian Security Advisory DLA-1718-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1718-1 : sqlalchemy security update");
...
SQLAlchemy has SQL Injection when the group_by parameter can be
controlled.
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2019/03/msg00020.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/jessie/sqlalchemy");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"python-sqlalchemy", reference:"0.9.8+dfsg-0.1+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"python-sqlalchemy-doc", reference:"0.9.8+dfsg-0.1+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"python-sqlalchemy-ext", reference:"0.9.8+dfsg-0.1+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"python3-sqlalchemy", reference:"0.9.8+dfsg-0.1+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"python3-sqlalchemy-ext", reference:"0.9.8+dfsg-0.1+deb8u1")) flag++;
