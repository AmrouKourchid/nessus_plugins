...
# extracted from Fedora Security Advisory FEDORA-2021-5e9894a0c5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-5e9894a0c5");

  script_name(english:"Fedora 32 : screen (2021-5e9894a0c5)");
...
FEDORA-2021-5e9894a0c5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-5e9894a0c5");
...
pkgs = [
    {'reference':'screen-4.8.0-5.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE}
];
