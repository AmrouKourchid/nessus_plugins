...
if (description)
{
  ...
  script_cve_id("CVE-2024-21758");

  script_name(english:"Fortinet FortiWeb - Stack overflow in execute backup command (FG-IR-23-458)");
...
vulnerability as referenced in the FG-IR-23-458 advisory.

  - A stack-based buffer overflow in Fortinet FortiWeb versions 7.2.0 through 7.2.7, and 7.4.0 through 7.4.1
    may allow a privileged user to execute arbitrary code via specially crafted CLI commands, provided the
    user is able to evade FortiWeb stack protections. (CVE-2024-21758)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.fortiguard.com/psirt/FG-IR-23-458");
  script_set_attribute(attribute:"solution", value:
"Upgrade to FortiWeb version 7.2.8 / 7.4.2 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-21758");
