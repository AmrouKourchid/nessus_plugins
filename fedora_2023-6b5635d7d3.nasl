...
# extracted from Fedora Security Advisory FEDORA-2023-6b5635d7d3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-6b5635d7d3");

  script_name(english:"Fedora 37 : thunderbird (2023-6b5635d7d3)");
...
FEDORA-2023-6b5635d7d3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-6b5635d7d3");
...
var pkgs = [
    {'reference':'thunderbird-102.15.1-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
