...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : gnutls (EulerOS-SA-2018-1444)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1444
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e8c398a2");
...
pkgs = ["gnutls-3.3.26-9.h1",
        "gnutls-c++-3.3.26-9.h1",
        "gnutls-dane-3.3.26-9.h1",
        "gnutls-devel-3.3.26-9.h1",
        "gnutls-utils-3.3.26-9.h1"];
