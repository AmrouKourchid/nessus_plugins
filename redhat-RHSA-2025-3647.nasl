...
# extracted from Red Hat Security Advisory RHSA-2025:3647. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:3647");

  script_name(english:"RHEL 9 : tomcat (RHSA-2025:3647)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for tomcat.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2025:3647 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_3647.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9af9ebf3");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:3647");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL tomcat package based on the guidance in RHSA-2025:3647.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'tomcat-9.0.87-1.el9_4.3', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'tomcat-admin-webapps-9.0.87-1.el9_4.3', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'tomcat-docs-webapp-9.0.87-1.el9_4.3', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'tomcat-el-3.0-api-9.0.87-1.el9_4.3', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'tomcat-jsp-2.3-api-9.0.87-1.el9_4.3', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'tomcat-lib-9.0.87-1.el9_4.3', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'tomcat-servlet-4.0-api-9.0.87-1.el9_4.3', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'tomcat-webapps-9.0.87-1.el9_4.3', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
