...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 ESM / 20.04 ESM / 22.04 ESM : Jupyter Core vulnerability (USN-6153-1)");
...
referenced in the USN-6153-1 advisory.

    It was discovered that Jupyter Core executed untrusted files in the current working directory. An attacker
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'jupyter', 'pkgver': '4.4.0-2ubuntu0.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'jupyter-core', 'pkgver': '4.4.0-2ubuntu0.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'python-jupyter-core', 'pkgver': '4.4.0-2ubuntu0.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'python3-jupyter-core', 'pkgver': '4.4.0-2ubuntu0.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '20.04', 'pkgname': 'jupyter', 'pkgver': '4.6.3-3ubuntu0.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '20.04', 'pkgname': 'jupyter-core', 'pkgver': '4.6.3-3ubuntu0.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '20.04', 'pkgname': 'python3-jupyter-core', 'pkgver': '4.6.3-3ubuntu0.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '22.04', 'pkgname': 'jupyter', 'pkgver': '4.9.1-1ubuntu0.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '22.04', 'pkgname': 'jupyter-core', 'pkgver': '4.9.1-1ubuntu0.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '22.04', 'pkgname': 'python3-jupyter-core', 'pkgver': '4.9.1-1ubuntu0.1~esm1', 'ubuntu_pro': TRUE}
];
