...
# extracted from Fedora Security Advisory FEDORA-2020-ab8553f302.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-ab8553f302");

  script_name(english:"Fedora 31 : mingw-openjpeg2 / openjpeg2 (2020-ab8553f302)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-ab8553f302");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"mingw-openjpeg2-2.3.1-5.fc31")) flag++;
if (rpm_check(release:"FC31", reference:"openjpeg2-2.3.1-4.fc31")) flag++;
