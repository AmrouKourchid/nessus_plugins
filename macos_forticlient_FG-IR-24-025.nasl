...
if (description)
{
  ...
  script_cve_id("CVE-2024-35281");

  script_name(english:"Fortinet FortiClient Code Execution due to Node.JS Environment Variable (FG-IR-24-025) (macOS)");
...
vulnerability as referenced in the FG-IR-24-025 advisory.

  - An improper isolation or compartmentalization vulnerability [CWE-653] in FortiClientMac version 7.4.2 and
    below, version 7.2.8 and below, 7.0 all versions and FortiVoiceUCDesktop 3.0 all versions desktop
    application may allow an authenticated attacker to inject code via Electron environment variables.
    (CVE-2024-35281)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.fortiguard.com/psirt/FG-IR-24-025");
...
FortiClient version 7.4.3 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-35281");
