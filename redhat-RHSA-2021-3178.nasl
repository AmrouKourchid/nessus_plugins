...
# extracted from Red Hat Security Advisory RHSA-2021:3178. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:3178");

  script_name(english:"RHEL 8 : sssd (RHSA-2021:3178)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for sssd.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2021:3178 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_3178.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f58c5b90");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:3178");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1975142");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL sssd package based on the guidance in RHSA-2021:3178.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libipa_hbac-2.2.0-19.el8_1.2', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsss_autofs-2.2.0-19.el8_1.2', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsss_certmap-2.2.0-19.el8_1.2', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsss_idmap-2.2.0-19.el8_1.2', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsss_nss_idmap-2.2.0-19.el8_1.2', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsss_nss_idmap-devel-2.2.0-19.el8_1.2', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsss_simpleifp-2.2.0-19.el8_1.2', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsss_sudo-2.2.0-19.el8_1.2', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-libipa_hbac-2.2.0-19.el8_1.2', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-libsss_nss_idmap-2.2.0-19.el8_1.2', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-sss-2.2.0-19.el8_1.2', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-sss-murmur-2.2.0-19.el8_1.2', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-sssdconfig-2.2.0-19.el8_1.2', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-2.2.0-19.el8_1.2', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-ad-2.2.0-19.el8_1.2', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-client-2.2.0-19.el8_1.2', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-common-2.2.0-19.el8_1.2', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-common-pac-2.2.0-19.el8_1.2', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-dbus-2.2.0-19.el8_1.2', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-ipa-2.2.0-19.el8_1.2', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-kcm-2.2.0-19.el8_1.2', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-krb5-2.2.0-19.el8_1.2', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-krb5-common-2.2.0-19.el8_1.2', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-ldap-2.2.0-19.el8_1.2', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-libwbclient-2.2.0-19.el8_1.2', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-nfs-idmap-2.2.0-19.el8_1.2', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-polkit-rules-2.2.0-19.el8_1.2', 'sp':'1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-polkit-rules-2.2.0-19.el8_1.2', 'sp':'1', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-polkit-rules-2.2.0-19.el8_1.2', 'sp':'1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-proxy-2.2.0-19.el8_1.2', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-tools-2.2.0-19.el8_1.2', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-winbind-idmap-2.2.0-19.el8_1.2', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
