...
if (description)
{
  ...
  script_name(english:"CentOS 9 : pam-1.5.1-23.el9");
...
pam-1.5.1-23.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=71977");
...
var pkgs = [
    {'reference':'pam-1.5.1-23.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pam-devel-1.5.1-23.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pam-docs-1.5.1-23.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
