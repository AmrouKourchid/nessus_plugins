...
# extracted from Fedora Security Advisory FEDORA-2019-307e117a2e.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-307e117a2e");

  script_name(english:"Fedora 30 : 2:samba (2019-307e117a2e)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-307e117a2e");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"samba-4.10.3-0.fc30", epoch:"2")) flag++;
