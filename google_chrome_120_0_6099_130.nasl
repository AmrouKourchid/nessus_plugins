...
if (description)
{
  ...
  script_name(english:"Google Chrome < 120.0.6099.130 Vulnerability");

  script_set_attribute(attribute:"synopsis", value:
"A web browser installed on the remote Windows host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Google Chrome installed on the remote Windows host is prior to 120.0.6099.130. It is, therefore, affected
by a vulnerability as referenced in the 2023_12_stable-channel-update-for-desktop_20 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ecad5ae2");
  script_set_attribute(attribute:"see_also", value:"https://crbug.com/1513170");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Google Chrome version 120.0.6099.130 or later.");
...
google_chrome_check_version(installs:installs, fix:'120.0.6099.130', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
