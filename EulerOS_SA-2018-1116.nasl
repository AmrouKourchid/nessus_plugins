...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : gcc (EulerOS-SA-2018-1116)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1116
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?12d8daaa");
...
pkgs = ["cpp-4.8.5-4.h5",
        "gcc-4.8.5-4.h5",
        "gcc-c++-4.8.5-4.h5",
        "gcc-gfortran-4.8.5-4.h5",
        "gcc-gnat-4.8.5-4.h5",
        "gcc-go-4.8.5-4.h5",
        "gcc-objc++-4.8.5-4.h5",
        "gcc-objc-4.8.5-4.h5",
        "libatomic-4.8.5-4.h5",
        "libatomic-static-4.8.5-4.h5",
        "libgcc-4.8.5-4.h5",
        "libgfortran-4.8.5-4.h5",
        "libgnat-4.8.5-4.h5",
        "libgnat-devel-4.8.5-4.h5",
        "libgo-4.8.5-4.h5",
        "libgo-devel-4.8.5-4.h5",
        "libgomp-4.8.5-4.h5",
        "libitm-4.8.5-4.h5",
        "libitm-devel-4.8.5-4.h5",
        "libobjc-4.8.5-4.h5",
        "libquadmath-4.8.5-4.h5",
        "libquadmath-devel-4.8.5-4.h5",
        "libstdc++-4.8.5-4.h5",
        "libstdc++-devel-4.8.5-4.h5",
        "libstdc++-docs-4.8.5-4.h5"];
