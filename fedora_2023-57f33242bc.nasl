...
# extracted from Fedora Security Advisory FEDORA-2023-57f33242bc
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-57f33242bc");

  script_name(english:"Fedora 37 : openssl (2023-57f33242bc)");
...
FEDORA-2023-57f33242bc advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-57f33242bc");
...
var pkgs = [
    {'reference':'openssl-3.0.8-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
