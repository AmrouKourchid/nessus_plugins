...
# extracted from Amazon Linux 2 Security Advisory ALAS-2023-2037.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2023-24534");
  script_xref(name:"IAVB", value:"2023-B-0022-S");

  script_name(english:"Amazon Linux 2 : golang (ALAS-2023-2037)");
...
as referenced in the ALAS2-2023-2037 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2023-2037.html");
...
"Run 'yum update golang' to update your system.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-24534");
...
var pkgs = [
    {'reference':'golang-1.18.9-1.amzn2.0.4', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-1.18.9-1.amzn2.0.4', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-bin-1.18.9-1.amzn2.0.4', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-bin-1.18.9-1.amzn2.0.4', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-docs-1.18.9-1.amzn2.0.4', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-misc-1.18.9-1.amzn2.0.4', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-race-1.18.9-1.amzn2.0.4', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-shared-1.18.9-1.amzn2.0.4', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-shared-1.18.9-1.amzn2.0.4', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-src-1.18.9-1.amzn2.0.4', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-tests-1.18.9-1.amzn2.0.4', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
