...
# Oracle Linux Security Advisory ELSA-2010-0122 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : sudo (ELSA-2010-0122)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2010-0122.html");
...
"Update the affected sudo package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2010-0426");
...
var pkgs = [
    {'reference':'sudo-1.6.9p17-6.el5_4', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sudo-1.6.9p17-6.el5_4', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
