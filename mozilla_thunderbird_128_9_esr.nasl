...
"The version of Thunderbird ESR installed on the remote Windows host is prior to 128.9. It is, therefore, affected by
multiple vulnerabilities as referenced in the mfsa2025-24 advisory.
...
mozilla_check_version(installs:installs, product:'thunderbird', esr:TRUE, fix:'128.9', min:'128.0.0', severity:SECURITY_HOLE);
