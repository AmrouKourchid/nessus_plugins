...
# extracted from Red Hat Security Advisory RHSA-2023:4411. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:4411");

  script_name(english:"RHEL 9 : cjose (RHSA-2023:4411)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for cjose.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_4411.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b87feec1");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2223295");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:4411");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL cjose package based on the guidance in RHSA-2023:4411.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cjose-0.6.1-13.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'cjose-0.6.1-13.el9_2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
