...
# extracted from Ubuntu Security Notice USN-5868-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5868-1");

  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS / 22.04 LTS : Django vulnerability (USN-5868-1)");
...
referenced in the USN-5868-1 advisory.

    Jakob Ackermann discovered that Django incorrectly handled certain file uploads. A remote attacker could
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5868-1");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'python-django', 'pkgver': '1:1.11.11-1ubuntu1.20'},
    {'osver': '18.04', 'pkgname': 'python-django-common', 'pkgver': '1:1.11.11-1ubuntu1.20'},
    {'osver': '18.04', 'pkgname': 'python3-django', 'pkgver': '1:1.11.11-1ubuntu1.20'},
    {'osver': '20.04', 'pkgname': 'python3-django', 'pkgver': '2:2.2.12-1ubuntu0.16'},
    {'osver': '22.04', 'pkgname': 'python3-django', 'pkgver': '2:3.2.12-2ubuntu1.5'}
];
