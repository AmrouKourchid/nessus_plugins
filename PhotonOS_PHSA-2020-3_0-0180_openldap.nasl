...
# extracted from VMware Security Advisory PHSA-2020-3.0-0180. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Openldap PHSA-2020-3.0-0180");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the openldap package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-3.0-180.md");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'openldap-2.4.48-3.ph3')) flag++;
