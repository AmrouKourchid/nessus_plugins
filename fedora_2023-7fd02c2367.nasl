...
# extracted from Fedora Security Advisory FEDORA-2023-7fd02c2367
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-7fd02c2367");

  script_name(english:"Fedora 37 : mingw-zstd (2023-7fd02c2367)");
...
FEDORA-2023-7fd02c2367 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-7fd02c2367");
...
var pkgs = [
    {'reference':'mingw-zstd-1.5.4-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
