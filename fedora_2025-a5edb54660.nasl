...
# extracted from Fedora Security Advisory FEDORA-2025-a5edb54660
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-a5edb54660");

  script_name(english:"Fedora 40 : libtasn1 (2025-a5edb54660)");
...
FEDORA-2025-a5edb54660 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-a5edb54660");
...
var pkgs = [
    {'reference':'libtasn1-4.20.0-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
