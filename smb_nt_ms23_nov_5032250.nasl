...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5032250");
  script_xref(name:"MSKB", value:"5032252");
  script_xref(name:"MSFT", value:"MS23-5032250");
  script_xref(name:"MSFT", value:"MS23-5032252");
  ...
  script_name(english:"KB5032250: Windows Server 2008 R2 Security Update (November 2023)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5032250");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5032252");
...
if (("windows server 2008 r2" >< tolower(os_name)) &&
  smb_check_rollup(os:'6.1',
                   ...
                   rollup_date:'11_2023',
                   bulletin:bulletin,
                   rollup_kb_list:[5032252, 5032250])
)
{
