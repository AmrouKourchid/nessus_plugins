...
# extracted from Fedora Security Advisory FEDORA-2024-40e8512956
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-40e8512956");

  script_name(english:"Fedora 39 : uriparser (2024-40e8512956)");
...
FEDORA-2024-40e8512956 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-40e8512956");
...
var pkgs = [
    {'reference':'uriparser-0.9.8-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
