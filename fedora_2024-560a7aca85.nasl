...
# extracted from Fedora Security Advisory FEDORA-2024-560a7aca85
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-560a7aca85");

  script_name(english:"Fedora 40 : apptainer (2024-560a7aca85)");
...
FEDORA-2024-560a7aca85 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-560a7aca85");
...
var pkgs = [
    {'reference':'apptainer-1.3.0-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
