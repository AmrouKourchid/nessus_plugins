...
# SUSE update advisory SUSE-SU-2021:2366-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2021:2366-1");

  script_name(english:"SUSE SLES12 / SLES15 Security Update : kernel (Live Patch 11 for SLE 15 SP2) (SUSE-SU-2021:2366-1)");
...
the SUSE-SU-2021:2366-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2021-July/009144.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c643b68e");
  script_set_attribute(attribute:"solution", value:
"Update the affected kernel-livepatch-5_3_18-24_52-default and / or kgraft-patch-4_12_14-122_71-default packages.");
...
var pkgs = [
    {'reference':'kgraft-patch-4_12_14-122_71-default-3-2.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.5']},
    {'reference':'kernel-livepatch-5_3_18-24_52-default-6-2.2', 'sp':'2', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.2']}
];
