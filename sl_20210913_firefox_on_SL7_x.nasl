...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"RHSA-2021:3498");
  script_xref(name:"IAVA", value:"2021-A-0405-S");

  script_name(english:"Scientific Linux Security Update : firefox on SL7.x i686/x86_64 (2021:3498)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.scientificlinux.org/category/sl-errata/slsa-20213498-1");
...
var pkgs = [
    {'reference':'firefox-78.14.0-1.el7_9', 'cpu':'i686', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-78.14.0-1.el7_9', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-debuginfo-78.14.0-1.el7_9', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
