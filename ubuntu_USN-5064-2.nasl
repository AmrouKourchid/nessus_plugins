...
# extracted from Ubuntu Security Notice USN-5064-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5064-2");

  script_name(english:"Ubuntu 16.04 ESM : GNU cpio vulnerability (USN-5064-2)");
...
USN-5064-2 advisory.
    ...
    USN-5064-1 fixed vulnerabilities in GNU cpio. This update provides the corresponding updates for Ubuntu
    16.04 ESM.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5064-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'cpio', 'pkgver': '2.11+dfsg-5ubuntu1.1+esm1', 'ubuntu_pro': TRUE}
];
