...
# Red Hat Security Advisory RHSA-2019:3590. The text
...
if (description)
{
  ...
  script_bugtraq_id(108815);
  script_xref(name:"RHSA", value:"2019:3590");

  script_name(english:"CentOS 8 : python-urllib3 (CESA-2019:3590)");
