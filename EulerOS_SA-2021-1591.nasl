...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.1 : brotli (EulerOS-SA-2021-1591)");
...
following vulnerability :
  ...
  - A buffer overflow exists in the Brotli library versions
    ...
    impose chunk size limits..(CVE-2020-8297)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1591
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?35b6aeb1");
...
"Update the affected brotli package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-8297");
