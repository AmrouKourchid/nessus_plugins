...
# extracted from Red Hat Security Advisory RHSA-2020:2985. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 6 : java-1.8.0-openjdk (RHSA-2020:2985)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_2985.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2ff929bc");
...
"Update the RHEL java-1.8.0-openjdk package based on the guidance in RHSA-2020:2985.");
...
var constraints = [
  {
    ...
    'pkgs': [
      ...
      {'reference':'java-1.8.0-openjdk-javadoc-1.8.0.262.b10-0.el6_10', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.8.0-openjdk-javadoc-debug-1.8.0.262.b10-0.el6_10', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
