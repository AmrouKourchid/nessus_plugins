...
# extracted from Fedora Security Advisory FEDORA-2024-b611e122fb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-b611e122fb");
  script_xref(name:"IAVA", value:"2024-A-0608-S");

  script_name(english:"Fedora 40 : openvpn (2024-b611e122fb)");
...
FEDORA-2024-b611e122fb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-b611e122fb");
...
var pkgs = [
    {'reference':'openvpn-2.6.11-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
