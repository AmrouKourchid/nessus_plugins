...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Apr PHSA-2024-4.0-0711");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'apr-1.7.2-3.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'apr-devel-1.7.2-3.ph4')) flag++;
