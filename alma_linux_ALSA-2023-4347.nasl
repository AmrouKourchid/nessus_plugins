...
# AlmaLinux Security Advisory ALSA-2023:4347.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:4347");

  script_name(english:"AlmaLinux 9 : libeconf (ALSA-2023:4347)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2023-4347.html");
...
"Update the affected libeconf package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:libeconf");
