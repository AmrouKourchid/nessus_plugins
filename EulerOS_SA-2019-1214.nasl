...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.4 : net-snmp (EulerOS-SA-2019-1214)");
...
the following vulnerability :
  ...
  - snmp_oid_compare in snmplib/snmp_api.c in Net-SNMP
    ...
    resulting in Denial of Service.i1/4^CVE-2018-18066i1/4%0

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1214
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1df2a1d7");
