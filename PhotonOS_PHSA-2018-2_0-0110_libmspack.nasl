...
if (description)
{
  ...
  script_cve_id("CVE-2018-14679", "CVE-2018-14680");

  script_name(english:"Photon OS 2.0: Libmspack PHSA-2018-2.0-0110");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-14680");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libmspack-0.5alpha-6.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libmspack-debuginfo-0.5alpha-6.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libmspack-devel-0.5alpha-6.ph2')) flag++;
