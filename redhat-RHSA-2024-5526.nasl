...
# extracted from Red Hat Security Advisory RHSA-2024:5526. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:5526");

  script_name(english:"RHEL 8 : python-urllib3 (RHSA-2024:5526)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_5526.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?90ccc14e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:5526");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-urllib3 package based on the guidance in RHSA-2024:5526.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-urllib3-1.24.2-5.el8_8.2', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
