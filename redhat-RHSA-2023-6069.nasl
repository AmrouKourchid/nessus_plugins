...
# extracted from Red Hat Security Advisory RHSA-2023:6069. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:6069");
  script_xref(name:"IAVA", value:"2023-A-0442-S");

  script_name(english:"RHEL 8 : python39:3.9 and python39-devel:3.9 (RHSA-2023:6069)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6069.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ed399519");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2235789");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6069");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python39:3.9 / python39-devel:3.9 packages based on the guidance in RHSA-2023:6069.");
  ...
  'python39:3.9': [
    {
      ...
      'pkgs': [
        {'reference':'python39-3.9.2-2.module+el8.4.0+20027+45e0e702.2', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'python39-devel-3.9.2-2.module+el8.4.0+20027+45e0e702.2', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python39-devel-3.9.2-2.module+el8.4.0+20027+45e0e702.2', 'sp':'4', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python39-idle-3.9.2-2.module+el8.4.0+20027+45e0e702.2', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'python39-libs-3.9.2-2.module+el8.4.0+20027+45e0e702.2', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'python39-test-3.9.2-2.module+el8.4.0+20027+45e0e702.2', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python39-test-3.9.2-2.module+el8.4.0+20027+45e0e702.2', 'sp':'4', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python39-tkinter-3.9.2-2.module+el8.4.0+20027+45e0e702.2', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
