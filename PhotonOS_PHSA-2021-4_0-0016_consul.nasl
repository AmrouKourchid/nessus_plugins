...
# extracted from VMware Security Advisory PHSA-2021-4.0-0016. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2020-25864", "CVE-2021-28156");

  script_name(english:"Photon OS 4.0: Consul PHSA-2021-4.0-0016");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the consul package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-16.md");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-28156");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'consul-1.9.5-1.ph4')) flag++;
