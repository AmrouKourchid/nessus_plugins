...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : 389-ds-base (EulerOS-SA-2022-1701)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1701
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?09065829");
...
var pkgs = [
  "389-ds-base-1.3.7.5-28.h8",
  "389-ds-base-libs-1.3.7.5-28.h8"
];
