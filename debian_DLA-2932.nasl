...
# extracted from Debian Security Advisory dla-2932. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2932-1 : tiff - LTS security update");
...
dla-2932 advisory.
    ...
    Several issues have been found in tiff, a library and tools to manipulate and convert files in the Tag
    Image File Format (TIFF). CVE-2022-22844 out-of-bounds read in _TIFFmemcpy in certain situations involving
    a custom tag and 0x0200 as the second word of the DE field. CVE-2022-0562 Null source pointer passed as an
    argument to memcpy() function within TIFFReadDirectory(). This could result in a Denial of Service via
    crafted TIFF files. CVE-2022-0561 Null source pointer passed as an argument to memcpy() function within
    TIFFFetchStripThing(). This could result in a Denial of Service via crafted TIFF files. For Debian 9
    stretch, these problems have been fixed in version 4.0.8-2+deb9u8. We recommend that you upgrade your tiff
    packages. For the detailed security status of tiff please refer to its security tracker page at:
    https://security-tracker.debian.org/tracker/tiff Further information about Debian LTS security advisories,
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2022/dla-2932");
...
var pkgs = [
    {'release': '9.0', 'prefix': 'libtiff-doc', 'reference': '4.0.8-2+deb9u8'},
    {'release': '9.0', 'prefix': 'libtiff-opengl', 'reference': '4.0.8-2+deb9u8'},
    {'release': '9.0', 'prefix': 'libtiff-tools', 'reference': '4.0.8-2+deb9u8'},
    {'release': '9.0', 'prefix': 'libtiff5', 'reference': '4.0.8-2+deb9u8'},
    {'release': '9.0', 'prefix': 'libtiff5-dev', 'reference': '4.0.8-2+deb9u8'},
    {'release': '9.0', 'prefix': 'libtiffxx5', 'reference': '4.0.8-2+deb9u8'}
];
