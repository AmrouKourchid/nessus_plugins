...
# extracted from Red Hat Security Advisory RHSA-2020:1037 and 
# CentOS Errata and Security Advisory 2020:1037 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : advancecomp (RHSA-2020:1037)");
...
var pkgs = [
    {'reference':'advancecomp-1.15-22.el7', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'advancecomp-1.15-22.el7', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE}
];
