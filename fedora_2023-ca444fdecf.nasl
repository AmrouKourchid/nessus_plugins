...
# extracted from Fedora Security Advisory FEDORA-2023-ca444fdecf
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-ca444fdecf");

  script_name(english:"Fedora 37 : gmailctl (2023-ca444fdecf)");
...
FEDORA-2023-ca444fdecf advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-ca444fdecf");
...
var pkgs = [
    {'reference':'gmailctl-0.10.6-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
