...
# extracted from Fedora Security Advisory FEDORA-2023-79335e1c60
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-79335e1c60");

  script_name(english:"Fedora 39 : libpcap / tcpdump (2023-79335e1c60)");
...
FEDORA-2023-79335e1c60 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-79335e1c60");
...
var pkgs = [
    {'reference':'libpcap-1.10.4-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'14'},
    {'reference':'tcpdump-4.99.4-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'14'}
];
