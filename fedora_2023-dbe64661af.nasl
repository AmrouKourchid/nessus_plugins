...
# extracted from Fedora Security Advisory FEDORA-2023-dbe64661af
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-dbe64661af");
  script_xref(name:"CEA-ID", value:"CEA-2024-0004");

  script_name(english:"Fedora 39 : nodejs18 (2023-dbe64661af)");
...
FEDORA-2023-dbe64661af advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-dbe64661af");
...
var pkgs = [
    {'reference':'nodejs18-18.18.2-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
