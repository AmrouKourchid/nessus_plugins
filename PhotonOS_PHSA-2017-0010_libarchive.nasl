...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'libarchive-3.3.1-1.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'libarchive-debuginfo-3.3.1-1.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'libarchive-devel-3.3.1-1.ph1')) flag++;
