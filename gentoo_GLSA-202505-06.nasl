...
# extracted from Gentoo Linux Security Advisory GLSA 202505-06.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202505-06 : glibc: Buffer Overflow");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202505-06 (glibc: Buffer Overflow)

    A vulnerability has been discovered in glibc. Please review the CVE identifier referenced below for
    details.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202505-06");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=948592");
...
var packages = [
  {
    'name' : 'sys-libs/glibc',
    'unaffected' : make_list("ge 2.40-r8"),
    'vulnerable' : make_list("lt 2.40-r8")
  }
];
