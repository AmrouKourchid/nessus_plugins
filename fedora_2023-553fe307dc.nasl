...
# extracted from Fedora Security Advisory FEDORA-2023-553fe307dc
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-553fe307dc");

  script_name(english:"Fedora 38 : python-reportlab (2023-553fe307dc)");
...
FEDORA-2023-553fe307dc advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-553fe307dc");
...
var pkgs = [
    {'reference':'python-reportlab-4.0.4-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
