...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Libseccomp PHSA-2019-2.0-0149");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libseccomp-2.4.0-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libseccomp-debuginfo-2.4.0-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libseccomp-devel-2.4.0-1.ph2')) flag++;
