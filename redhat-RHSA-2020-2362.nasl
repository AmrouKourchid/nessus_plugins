...
"The remote Red Hat host is missing one or more security updates for Red Hat OpenShift Service Mesh.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_2362.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ba5ec9fa");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:2362");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1739497");
...
"Update the RHEL Red Hat OpenShift Service Mesh package based on the guidance in RHSA-2020:2362.");
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'jaeger / kiali / servicemesh-grafana / etc');
}
