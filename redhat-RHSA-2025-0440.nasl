...
# extracted from Red Hat Security Advisory RHSA-2025:0440. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:0440");

  script_name(english:"RHEL 9 : iperf3 (RHSA-2025:0440)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_0440.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?864d000d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:0440");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL iperf3 package based on the guidance in RHSA-2025:0440.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'iperf3-3.9-10.el9_2.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
