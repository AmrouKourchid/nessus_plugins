...
# extracted from Red Hat Security Advisory RHSA-2025:7118. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2024-1394", "CVE-2024-9355", "CVE-2024-34158");
  script_xref(name:"RHSA", value:"2025:7118");

  script_name(english:"RHEL 9 : osbuild and osbuild-composer (RHSA-2025:7118)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for osbuild / osbuild-composer.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2025:7118 advisory.

    A service for building customized OS artifacts, such as VM images and OSTree commits, that uses osbuild
    under the hood. Besides building images for local usage, it can also upload images directly to cloud.  It
    is compatible with composer-cli and cockpit-composer clients.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-16396");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-4570");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-4617");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-4636");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-56049");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-78659");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_7118.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?baedd915");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:7118");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL osbuild / osbuild-composer packages based on the guidance in RHSA-2025:7118.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'osbuild-composer-132-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'osbuild-composer-core-132-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'osbuild-composer-worker-132-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'osbuild-composer / osbuild-composer-core / osbuild-composer-worker');
}
