...
however, Nessus has not tested that script.");
  # https://plugins.trac.wordpress.org/browser/mac-dock-gallery/trunk?rev=576587
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?94860e23");
