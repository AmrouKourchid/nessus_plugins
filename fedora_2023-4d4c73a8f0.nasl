...
# extracted from Fedora Security Advisory FEDORA-2023-4d4c73a8f0
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-4d4c73a8f0");

  script_name(english:"Fedora 39 : matrix-synapse (2023-4d4c73a8f0)");
...
FEDORA-2023-4d4c73a8f0 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-4d4c73a8f0");
...
"Update the affected matrix-synapse package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-42453");
...
var pkgs = [
    {'reference':'matrix-synapse-1.94.0-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
