...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS : Vim vulnerability (USN-3139-1)");
...
in the USN-3139-1 advisory.

    Florian Larysch discovered that the Vim text editor did not properly validate values for the 'filetype',
    'syntax', and 'keymap' options. An attacker could trick a user into opening a file with specially crafted
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3139-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'vim', 'pkgver': '2:7.4.052-1ubuntu3.1'},
    {'osver': '14.04', 'pkgname': 'vim-athena', 'pkgver': '2:7.4.052-1ubuntu3.1'},
    {'osver': '14.04', 'pkgname': 'vim-common', 'pkgver': '2:7.4.052-1ubuntu3.1'},
    {'osver': '14.04', 'pkgname': 'vim-gnome', 'pkgver': '2:7.4.052-1ubuntu3.1'},
    {'osver': '14.04', 'pkgname': 'vim-gtk', 'pkgver': '2:7.4.052-1ubuntu3.1'},
    {'osver': '14.04', 'pkgname': 'vim-gui-common', 'pkgver': '2:7.4.052-1ubuntu3.1'},
    {'osver': '14.04', 'pkgname': 'vim-lesstif', 'pkgver': '2:7.4.052-1ubuntu3.1'},
    {'osver': '14.04', 'pkgname': 'vim-nox', 'pkgver': '2:7.4.052-1ubuntu3.1'},
    {'osver': '14.04', 'pkgname': 'vim-runtime', 'pkgver': '2:7.4.052-1ubuntu3.1'},
    {'osver': '14.04', 'pkgname': 'vim-tiny', 'pkgver': '2:7.4.052-1ubuntu3.1'},
    {'osver': '16.04', 'pkgname': 'vim', 'pkgver': '2:7.4.1689-3ubuntu1.2'},
    {'osver': '16.04', 'pkgname': 'vim-athena', 'pkgver': '2:7.4.1689-3ubuntu1.2'},
    {'osver': '16.04', 'pkgname': 'vim-athena-py2', 'pkgver': '2:7.4.1689-3ubuntu1.2'},
    {'osver': '16.04', 'pkgname': 'vim-common', 'pkgver': '2:7.4.1689-3ubuntu1.2'},
    {'osver': '16.04', 'pkgname': 'vim-gnome', 'pkgver': '2:7.4.1689-3ubuntu1.2'},
    {'osver': '16.04', 'pkgname': 'vim-gnome-py2', 'pkgver': '2:7.4.1689-3ubuntu1.2'},
    {'osver': '16.04', 'pkgname': 'vim-gtk', 'pkgver': '2:7.4.1689-3ubuntu1.2'},
    {'osver': '16.04', 'pkgname': 'vim-gtk-py2', 'pkgver': '2:7.4.1689-3ubuntu1.2'},
    {'osver': '16.04', 'pkgname': 'vim-gtk3', 'pkgver': '2:7.4.1689-3ubuntu1.2'},
    {'osver': '16.04', 'pkgname': 'vim-gtk3-py2', 'pkgver': '2:7.4.1689-3ubuntu1.2'},
    {'osver': '16.04', 'pkgname': 'vim-gui-common', 'pkgver': '2:7.4.1689-3ubuntu1.2'},
    {'osver': '16.04', 'pkgname': 'vim-nox', 'pkgver': '2:7.4.1689-3ubuntu1.2'},
    {'osver': '16.04', 'pkgname': 'vim-nox-py2', 'pkgver': '2:7.4.1689-3ubuntu1.2'},
    {'osver': '16.04', 'pkgname': 'vim-runtime', 'pkgver': '2:7.4.1689-3ubuntu1.2'},
    {'osver': '16.04', 'pkgname': 'vim-tiny', 'pkgver': '2:7.4.1689-3ubuntu1.2'}
];
