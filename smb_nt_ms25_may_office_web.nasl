...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5002707");
  script_xref(name:"MSFT", value:"MS25-5002707");

  script_name(english:"Security Updates for Microsoft Office Online Server  (May 2025)");
...
affected by multiple vulnerabilities:
  - A remote code execution vulnerability. An attacker can exploit this to bypass authentication and execute
    unauthorized arbitrary commands. (CVE-2025-29977, CVE-2025-29979, CVE-2025-30375, CVE-2025-30376,
    CVE-2025-30379, CVE-2025-30381, CVE-2025-30383)");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002707");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released KB5002707 to address this issue.");
...
if (oos_path && (!isnull(oos_sp) && oos_sp == '0'))
{
  ...
  if (hotfix_check_fversion(file:'xlsrv.dll', version:'16.0.10417.20010', min_version:'16.0.10000.0', path:path, kb:'5002707', product:'Office Online Server') == HCF_OLDER)
    vuln = TRUE;
}
