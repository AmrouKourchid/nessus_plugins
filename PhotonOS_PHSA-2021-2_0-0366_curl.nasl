...
# extracted from VMware Security Advisory PHSA-2021-2.0-0366. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2021-22897");

  script_name(english:"Photon OS 2.0: Curl PHSA-2021-2.0-0366");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the curl package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-2-366.md");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'curl-7.75.0-3.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'curl-devel-7.75.0-3.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'curl-libs-7.75.0-3.ph2')) flag++;
