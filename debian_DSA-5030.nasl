...
# extracted from Debian Security Advisory dsa-5030. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-5030-1 : webkit2gtk - security update");
...
dsa-5030 advisory.
    ...
    The following vulnerabilities have been discovered in the webkit2gtk web engine: CVE-2021-30887 Narendra
    Bhati discovered that processing maliciously crafted web content may lead to unexpectedly unenforced
    Content Security Policy. CVE-2021-30890 An anonymous researcher discovered that processing maliciously
    crafted web content may lead to universal cross site scripting. For the oldstable distribution (buster),
    these problems have been fixed in version 2.34.3-1~deb10u1. For the stable distribution (bullseye), these
    problems have been fixed in version 2.34.3-1~deb11u1. We recommend that you upgrade your webkit2gtk
    packages. For the detailed security status of webkit2gtk please refer to its security tracker page at:
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2021/dsa-5030");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'gir1.2-javascriptcoregtk-4.0', 'reference': '2.34.3-1~deb10u1'},
    {'release': '10.0', 'prefix': 'gir1.2-webkit2-4.0', 'reference': '2.34.3-1~deb10u1'},
    {'release': '10.0', 'prefix': 'libjavascriptcoregtk-4.0-18', 'reference': '2.34.3-1~deb10u1'},
    {'release': '10.0', 'prefix': 'libjavascriptcoregtk-4.0-bin', 'reference': '2.34.3-1~deb10u1'},
    {'release': '10.0', 'prefix': 'libjavascriptcoregtk-4.0-dev', 'reference': '2.34.3-1~deb10u1'},
    {'release': '10.0', 'prefix': 'libwebkit2gtk-4.0-37', 'reference': '2.34.3-1~deb10u1'},
    {'release': '10.0', 'prefix': 'libwebkit2gtk-4.0-dev', 'reference': '2.34.3-1~deb10u1'},
    {'release': '10.0', 'prefix': 'libwebkit2gtk-4.0-doc', 'reference': '2.34.3-1~deb10u1'},
    {'release': '10.0', 'prefix': 'webkit2gtk-driver', 'reference': '2.34.3-1~deb10u1'},
    {'release': '11.0', 'prefix': 'gir1.2-javascriptcoregtk-4.0', 'reference': '2.34.3-1~deb11u1'},
    {'release': '11.0', 'prefix': 'gir1.2-webkit2-4.0', 'reference': '2.34.3-1~deb11u1'},
    {'release': '11.0', 'prefix': 'libjavascriptcoregtk-4.0-18', 'reference': '2.34.3-1~deb11u1'},
    {'release': '11.0', 'prefix': 'libjavascriptcoregtk-4.0-bin', 'reference': '2.34.3-1~deb11u1'},
    {'release': '11.0', 'prefix': 'libjavascriptcoregtk-4.0-dev', 'reference': '2.34.3-1~deb11u1'},
    {'release': '11.0', 'prefix': 'libwebkit2gtk-4.0-37', 'reference': '2.34.3-1~deb11u1'},
    {'release': '11.0', 'prefix': 'libwebkit2gtk-4.0-dev', 'reference': '2.34.3-1~deb11u1'},
    {'release': '11.0', 'prefix': 'libwebkit2gtk-4.0-doc', 'reference': '2.34.3-1~deb11u1'},
    {'release': '11.0', 'prefix': 'webkit2gtk-driver', 'reference': '2.34.3-1~deb11u1'}
];
