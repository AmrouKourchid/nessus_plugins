...
# extracted from Red Hat Security Advisory RHSA-2024:6662. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:6662");

  script_name(english:"RHEL 7 : python-setuptools (RHSA-2024:6662)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_6662.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b26d0007");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2297771");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:6662");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-setuptools package based on the guidance in RHSA-2024:6662.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python-setuptools-0.9.8-7.el7_9.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
