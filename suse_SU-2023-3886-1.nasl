...
# SUSE update advisory SUSE-SU-2023:3886-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:3886-1");

  script_name(english:"openSUSE 15 Security Update : grafana (SUSE-SU-2023:3886-1)");
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-September/016388.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?abc1006d");
...
var pkgs = [
    {'reference':'grafana-9.5.5-150200.3.47.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.4']},
    {'reference':'grafana-9.5.5-150200.3.47.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.5']}
];
