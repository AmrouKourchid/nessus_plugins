...
# extracted from Fedora Security Advisory FEDORA-2023-0a7690525f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-0a7690525f");
  script_xref(name:"IAVA", value:"2023-A-0521-S");

  script_name(english:"Fedora 37 : exim (2023-0a7690525f)");
...
FEDORA-2023-0a7690525f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-0a7690525f");
...
var pkgs = [
    {'reference':'exim-4.96.1-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
