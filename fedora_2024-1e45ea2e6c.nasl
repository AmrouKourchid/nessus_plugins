...
# extracted from Fedora Security Advisory FEDORA-2024-1e45ea2e6c
#
...
if (description)
{
  ...
  script_cve_id("CVE-2024-10827");
  script_xref(name:"FEDORA", value:"2024-1e45ea2e6c");

  script_name(english:"Fedora 41 : chromium (2024-1e45ea2e6c)");
...
FEDORA-2024-1e45ea2e6c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-1e45ea2e6c");
...
var pkgs = [
    {'reference':'chromium-130.0.6723.116-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
