...
# extracted from Fedora Security Advisory FEDORA-2024-4014fa4ecc
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-4014fa4ecc");

  script_name(english:"Fedora 40 : webkitgtk (2024-4014fa4ecc)");
...
FEDORA-2024-4014fa4ecc advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-4014fa4ecc");
...
var pkgs = [
    {'reference':'webkitgtk-2.46.4-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
