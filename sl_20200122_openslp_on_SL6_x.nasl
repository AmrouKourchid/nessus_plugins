...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : openslp on SL6.x i386/x86_64 (20200122)");
...
"Security Fix(es) :
  ...
  - openslp: Heap-based buffer overflow in ProcessSrvRqst()
    in slpd_process.c leading to remote code execution
    (CVE-2019-5544)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind2001&L=SCIENTIFIC-LINUX-ERRATA&P=7076
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b3c07d4a");
...
flag = 0;
if (rpm_check(release:"SL6", reference:"openslp-2.0.0-4.el6_10")) flag++;
if (rpm_check(release:"SL6", reference:"openslp-debuginfo-2.0.0-4.el6_10")) flag++;
if (rpm_check(release:"SL6", reference:"openslp-devel-2.0.0-4.el6_10")) flag++;
if (rpm_check(release:"SL6", reference:"openslp-server-2.0.0-4.el6_10")) flag++;
