...
# extracted from Ubuntu Security Notice USN-5885-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5885-1");

  script_name(english:"Ubuntu 22.04 LTS : APR vulnerability (USN-5885-1)");
...
USN-5885-1 advisory.
    ...
    Ronald Crane discovered integer overflow vulnerabilities in the Apache Portable Runtime (APR) that could
    potentially result in memory corruption. A remote attacker could possibly use these issues to cause a
    denial of service or execute arbitary code.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5885-1");
...
var pkgs = [
    {'osver': '22.04', 'pkgname': 'libapr1', 'pkgver': '1.7.0-8ubuntu0.22.04.1'},
    {'osver': '22.04', 'pkgname': 'libapr1-dev', 'pkgver': '1.7.0-8ubuntu0.22.04.1'}
];
