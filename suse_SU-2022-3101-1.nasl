...
# SUSE update advisory SUSE-SU-2022:3101-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:3101-1");

  script_name(english:"SUSE SLES12 Security Update : zabbix (SUSE-SU-2022:3101-1)");
...
in the SUSE-SU-2022:3101-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1201290");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2022-35230");
  # https://lists.suse.com/pipermail/sle-security-updates/2022-September/012111.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3891363c");
...
var pkgs = [
    {'reference':'zabbix-agent-4.0.12-4.18.1', 'sp':'5', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5']},
    {'reference':'zabbix-agent-4.0.12-4.18.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.5']}
];
