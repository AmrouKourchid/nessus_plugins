...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'mysql-8.0.16-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'mysql-debuginfo-8.0.16-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'mysql-devel-8.0.16-1.ph3')) flag++;
