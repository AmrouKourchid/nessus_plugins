...
# extracted from Red Hat Security Advisory RHSA-2024:3343. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:3343");

  script_name(english:"RHEL 8 : xorg-x11-server-Xwayland (RHSA-2024:3343)");
...
referenced in the RHSA-2024:3343 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_3343.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?74d72cd2");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:3343");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL xorg-x11-server-Xwayland packages based on the guidance in RHSA-2024:3343.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'xorg-x11-server-Xwayland-21.1.3-16.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
