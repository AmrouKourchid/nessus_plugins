...
# extracted from Red Hat Security Advisory RHSA-2024:9193. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:9193");

  script_name(english:"RHEL 9 : python3.12-PyMySQL (RHSA-2024:9193)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for python3.12-PyMySQL.");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_9193.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6b2c7e21");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:9193");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python3.12-PyMySQL package based on the guidance in RHSA-2024:9193.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:python3.12-PyMySQL");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:python3.12-PyMySQL+rsa");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3.12-PyMySQL+rsa-1.1.0-3.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.12-PyMySQL-1.1.0-3.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python3.12-PyMySQL / python3.12-PyMySQL+rsa');
}
