...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Openssl PHSA-2023-3.0-0538");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'openssl-1.0.2zg-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'openssl-c_rehash-1.0.2zg-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'openssl-devel-1.0.2zg-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'openssl-perl-1.0.2zg-1.ph3')) flag++;
