...
# extracted from VMware Security Advisory PHSA-2020-3.0-0130. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Etcd PHSA-2020-3.0-0130");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the etcd package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-3.0-130.md");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'etcd-3.4.10-2.ph3')) flag++;
