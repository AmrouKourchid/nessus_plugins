...
if (description)
{
  ...
  script_cve_id("CVE-2022-23457");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-23457");
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"vuln_publication_date", value:"2022/04/23");
