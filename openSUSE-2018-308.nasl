...
# extracted from openSUSE Security Update openSUSE-2018-308.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libvorbis (openSUSE-2018-308)");
...
This update was imported from the SUSE:SLE-12:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1085687");
...
if ( rpm_check(release:"SUSE42.3", reference:"libvorbis-debugsource-1.3.3-11.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libvorbis-devel-1.3.3-11.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libvorbis0-1.3.3-11.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libvorbis0-debuginfo-1.3.3-11.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libvorbisenc2-1.3.3-11.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libvorbisenc2-debuginfo-1.3.3-11.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libvorbisfile3-1.3.3-11.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libvorbisfile3-debuginfo-1.3.3-11.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", cpu:"x86_64", reference:"libvorbis0-32bit-1.3.3-11.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", cpu:"x86_64", reference:"libvorbis0-debuginfo-32bit-1.3.3-11.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", cpu:"x86_64", reference:"libvorbisenc2-32bit-1.3.3-11.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", cpu:"x86_64", reference:"libvorbisenc2-debuginfo-32bit-1.3.3-11.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", cpu:"x86_64", reference:"libvorbisfile3-32bit-1.3.3-11.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", cpu:"x86_64", reference:"libvorbisfile3-debuginfo-32bit-1.3.3-11.1") ) flag++;
