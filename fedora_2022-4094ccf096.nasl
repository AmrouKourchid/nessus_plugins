...
# extracted from Fedora Security Advisory FEDORA-2022-4094ccf096
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-4094ccf096");

  script_name(english:"Fedora 36 : python-django (2022-4094ccf096)");
...
FEDORA-2022-4094ccf096 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-4094ccf096");
...
var pkgs = [
    {'reference':'python-django-4.0.2-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
