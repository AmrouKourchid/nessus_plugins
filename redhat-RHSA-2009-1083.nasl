...
if (description)
{
  ...
  script_name(english:"RHEL 4 : cups (RHSA-2009:1083)");
...
referenced in the RHSA-2009:1083 advisory.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2009/rhsa-2009_1083.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?141cf9e5");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=491840");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=497135");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=500972");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2009:1083");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL cups package based on the guidance in RHSA-2009:1083.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:F/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:F/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2009-0791");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2009-0949");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cups-1.1.22-0.rc1.9.32.el4_8.3', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'cups-1.1.22-0.rc1.9.32.el4_8.3', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'cups-1.1.22-0.rc1.9.32.el4_8.3', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'cups-1.1.22-0.rc1.9.32.el4_8.3', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'cups-1.1.22-0.rc1.9.32.el4_8.3', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'cups-devel-1.1.22-0.rc1.9.32.el4_8.3', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'cups-devel-1.1.22-0.rc1.9.32.el4_8.3', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'cups-devel-1.1.22-0.rc1.9.32.el4_8.3', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'cups-devel-1.1.22-0.rc1.9.32.el4_8.3', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'cups-devel-1.1.22-0.rc1.9.32.el4_8.3', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'cups-libs-1.1.22-0.rc1.9.32.el4_8.3', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'cups-libs-1.1.22-0.rc1.9.32.el4_8.3', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'cups-libs-1.1.22-0.rc1.9.32.el4_8.3', 'cpu':'ppc64', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'cups-libs-1.1.22-0.rc1.9.32.el4_8.3', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'cups-libs-1.1.22-0.rc1.9.32.el4_8.3', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'cups-libs-1.1.22-0.rc1.9.32.el4_8.3', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
