...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Libssh2 PHSA-2019-2.0-0146");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libssh2-1.8.0-2.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libssh2-debuginfo-1.8.0-2.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libssh2-devel-1.8.0-2.ph2')) flag++;
