...
# extracted from Red Hat Security Advisory RHSA-2023:7879. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:7879");

  script_name(english:"RHEL 9 : opensc (RHSA-2023:7879)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for opensc.");
...
referenced in the RHSA-2023:7879 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_7879.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6bd529af");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2240912");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2240913");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2240914");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:7879");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL opensc package based on the guidance in RHSA-2023:7879.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'opensc-0.23.0-3.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
