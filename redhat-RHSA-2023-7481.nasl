...
if (description)
{
  ...
  script_name(english:"RHEL 8 : OpenShift Container Platform 4.11.54 (RHSA-2023:7481)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for OpenShift Container Platform 4.11.54.");
...
the RHSA-2023:7481 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.11.54. See the
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_7481.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7ad6cec9");
...
"Update the RHEL OpenShift Container Platform 4.11.54 packages based on the guidance in RHSA-2023:7481.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cri-o-1.24.6-6.1.rhaos4.11.git7f73171.el8_6', 'release':'8', 'el_string':'el8_6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
