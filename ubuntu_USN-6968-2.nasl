...
# extracted from Ubuntu Security Notice USN-6968-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6968-2");

  script_name(english:"Ubuntu 16.04 LTS : PostgreSQL vulnerability (USN-6968-2)");
...
USN-6968-2 advisory.
    ...
    This update provides the corresponding updates for PostgreSQL-9.5 in Ubuntu 16.04 LTS.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6968-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libecpg-compat3', 'pkgver': '9.5.25-0ubuntu0.16.04.1+esm8', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libecpg-dev', 'pkgver': '9.5.25-0ubuntu0.16.04.1+esm8', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libecpg6', 'pkgver': '9.5.25-0ubuntu0.16.04.1+esm8', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libpgtypes3', 'pkgver': '9.5.25-0ubuntu0.16.04.1+esm8', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libpq-dev', 'pkgver': '9.5.25-0ubuntu0.16.04.1+esm8', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libpq5', 'pkgver': '9.5.25-0ubuntu0.16.04.1+esm8', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'postgresql-9.5', 'pkgver': '9.5.25-0ubuntu0.16.04.1+esm8', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'postgresql-client-9.5', 'pkgver': '9.5.25-0ubuntu0.16.04.1+esm8', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'postgresql-contrib-9.5', 'pkgver': '9.5.25-0ubuntu0.16.04.1+esm8', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'postgresql-plperl-9.5', 'pkgver': '9.5.25-0ubuntu0.16.04.1+esm8', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'postgresql-plpython-9.5', 'pkgver': '9.5.25-0ubuntu0.16.04.1+esm8', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'postgresql-plpython3-9.5', 'pkgver': '9.5.25-0ubuntu0.16.04.1+esm8', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'postgresql-pltcl-9.5', 'pkgver': '9.5.25-0ubuntu0.16.04.1+esm8', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'postgresql-server-dev-9.5', 'pkgver': '9.5.25-0ubuntu0.16.04.1+esm8', 'ubuntu_pro': TRUE}
];
