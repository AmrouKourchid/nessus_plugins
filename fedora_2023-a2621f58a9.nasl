...
# extracted from Fedora Security Advisory FEDORA-2023-a2621f58a9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-a2621f58a9");
  script_xref(name:"IAVA", value:"2023-A-0500-S");

  script_name(english:"Fedora 38 : bind / bind-dyndb-ldap (2023-a2621f58a9)");
...
FEDORA-2023-a2621f58a9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-a2621f58a9");
...
var pkgs = [
    {'reference':'bind-9.18.19-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
    {'reference':'bind-dyndb-ldap-11.10-21.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
