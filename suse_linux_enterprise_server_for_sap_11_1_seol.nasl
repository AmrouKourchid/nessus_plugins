...
if (description)
{
  ...
  script_name(english:"SUSE Linux Enterprise Server For SAP SEoL (11.1.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of SUSE Linux Enterprise Server For SAP is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, SUSE Linux Enterprise Server For SAP is 11.1.x. It is, therefore, no longer maintained by its
vendor or provider.
...
var constraints = [
  { max_branch : '11.1', min_branch : '11.1', seol : 20131231 }
];
