...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : perl (ELSA-2011-1797)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2011-1797.html");
...
var pkgs = [
    {'reference':'perl-5.8.8-32.0.1.el5_7.6', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
    {'reference':'perl-suidperl-5.8.8-32.0.1.el5_7.6', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
    {'reference':'perl-5.8.8-32.0.1.el5_7.6', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
    {'reference':'perl-suidperl-5.8.8-32.0.1.el5_7.6', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'}
];
