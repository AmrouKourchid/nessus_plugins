...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : ruby (EulerOS-SA-2023-1458)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1458
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7d8d2a3c");
...
var pkgs = [
  "ruby-2.5.1-104.h15.eulerosv2r9",
  "ruby-help-2.5.1-104.h15.eulerosv2r9",
  "ruby-irb-2.5.1-104.h15.eulerosv2r9"
];
