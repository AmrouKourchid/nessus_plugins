...
if (description)
{
  ...
  script_name(english:"Foxit PhantomPDF < 8.1.1 Multiple Vulnerabilities");
...
8.1.1. It is, therefore, affected by multiple vulnerabilities.");
...
"Upgrade to Foxit PhantomPDF version 8.1.1 or later.");
