...
if (description)
{
  ...
  script_cve_id("CVE-2023-25433", "CVE-2023-26966");

  script_name(english:"EulerOS Virtualization 2.10.1 : libtiff (EulerOS-SA-2024-2003)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2003
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b71367ba");
...
var pkgs = [
  "libtiff-4.1.0-1.h34.r1.eulerosv2r10"
];
