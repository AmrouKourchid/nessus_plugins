...
# AlmaLinux Security Advisory ALSA-2023:4524.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:4524");

  script_name(english:"AlmaLinux 8 : libcap (ALSA-2023:4524)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ALSA-2023:4524 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2023-4524.html");
...
"Update the affected libcap and / or libcap-devel packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:libcap");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:libcap-devel");
