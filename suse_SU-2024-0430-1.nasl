...
# SUSE update advisory SUSE-SU-2024:0430-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2024:0430-1");

  script_name(english:"SUSE SLED15 / SLES15 / openSUSE 15 Security Update : cosign (SUSE-SU-2024:0430-1)");
...
affected by a vulnerability as referenced in the SUSE-SU-2024:0430-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1218207");
  # https://lists.suse.com/pipermail/sle-security-updates/2024-February/017891.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?478d95a6");
...
var pkgs = [
    {'reference':'cosign-2.2.3-150400.3.17.1', 'sp':'5', 'release':'SLED_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.5']},
    {'reference':'cosign-2.2.3-150400.3.17.1', 'sp':'5', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.5']},
    {'reference':'cosign-2.2.3-150400.3.17.1', 'sp':'5', 'release':'SLED15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.5', 'sle-module-basesystem-release-15.5', 'sled-release-15.5', 'sles-release-15.5']},
    {'reference':'cosign-2.2.3-150400.3.17.1', 'sp':'5', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.5', 'sle-module-basesystem-release-15.5', 'sled-release-15.5', 'sles-release-15.5']},
    {'reference':'cosign-2.2.3-150400.3.17.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.5']}
];
