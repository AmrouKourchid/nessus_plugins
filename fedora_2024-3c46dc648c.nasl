...
# extracted from Fedora Security Advisory FEDORA-2024-3c46dc648c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-3c46dc648c");

  script_name(english:"Fedora 39 : libnbd (2024-3c46dc648c)");
...
FEDORA-2024-3c46dc648c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-3c46dc648c");
...
var pkgs = [
    {'reference':'libnbd-1.18.5-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
