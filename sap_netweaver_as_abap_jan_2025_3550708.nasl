...
if (description)
{
  ...
  script_cve_id("CVE-2025-0066");
  script_xref(name:"IAVA", value:"2025-A-0008");

  script_name(english:"SAP NetWeaver AS ABAP (3550708)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SAP NetWeaver ABAP server may be affected by an improper access control vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote SAP NetWeaver ABAP server may be affected by a improper access control vulnerability. The ABAP Application 
Server of SAP NetWeaver as well as ABAP Platform allows an attacker to access restricted information due to weak access
controls. This can have a significant impact on the confidentiality, integrity, and availability of an application.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://me.sap.com/notes/3550708");
...
"Apply the appropriate patch according to the vendor advisory.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-0066");
...
var constraints = [
  ...
  {'min_version':'912', 'max_version': '914',	'fixed_display': fix},
];
