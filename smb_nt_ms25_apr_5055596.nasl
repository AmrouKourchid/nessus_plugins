...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5055596");
  script_xref(name:"MSKB", value:"5055609");
  script_xref(name:"MSFT", value:"MS25-5055596");
  script_xref(name:"MSFT", value:"MS25-5055609");
  script_xref(name:"IAVA", value:"2025-A-0255");
  script_xref(name:"IAVA", value:"2025-A-0256");

  script_name(english:"KB5055596: Windows Server 2008 Security Update (April 2025)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5055596. It is, therefore, affected by multiple vulnerabilities
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5055596");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5055609");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5055596 or Cumulative Update 5055609");
...
if (
  smb_check_rollup(os:'6.0',
                   ...
                   rollup_date:'04_2025',
                   bulletin:bulletin,
                   rollup_kb_list:[5055609, 5055596])
)
{
