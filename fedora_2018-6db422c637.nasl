...
# extracted from Fedora Security Advisory FEDORA-2018-6db422c637.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : matrix-synapse (2018-6db422c637)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-6db422c637");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"matrix-synapse-0.33.3.1-1.fc28")) flag++;
