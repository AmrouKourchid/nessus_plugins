...
# extracted from Debian Security Advisory dla-3179. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3179 : libpixman-1-0 - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3179
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/pixman");
  script_set_attribute(attribute:"solution", value:
"Upgrade the libpixman-1-0 packages.");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libpixman-1-0', 'reference': '0.36.0-1+deb10u1'},
    {'release': '10.0', 'prefix': 'libpixman-1-dev', 'reference': '0.36.0-1+deb10u1'}
];
