...
# extracted from Fedora Security Advisory FEDORA-2023-48c43df788
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-48c43df788");

  script_name(english:"Fedora 38 : fwupd (2023-48c43df788)");
...
FEDORA-2023-48c43df788 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-48c43df788");
...
var pkgs = [
    {'reference':'fwupd-1.9.6-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
