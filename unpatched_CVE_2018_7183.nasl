...
if (description)
{
  ...
  script_cve_id("CVE-2018-7183");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2018-7183");
...
patch available.
  ...
  - Buffer overflow in the decodearr function in ntpq in ntp 4.2.8p6 through 4.2.8p10 allows remote attackers
    to execute arbitrary code by leveraging an ntpq query and sending a response with a crafted array.
    (CVE-2018-7183)
