...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'redis-4.0.10-2.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'redis-debuginfo-4.0.10-2.ph2')) flag++;
