...
# extracted from Gentoo Linux Security Advisory GLSA 202405-04.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202405-04 : systemd: Multiple Vulnerabilities");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202405-04");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=882769");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=887581");
...
var packages = [
  {
    ...
    'unaffected' : make_list("ge 252.4"),
    'vulnerable' : make_list("lt 252.4")
  }
];
