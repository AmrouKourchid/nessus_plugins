...
# extracted from Fedora Security Advisory FEDORA-2024-b60eb661a4
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-b60eb661a4");

  script_name(english:"Fedora 39 : roundcubemail (2024-b60eb661a4)");
...
FEDORA-2024-b60eb661a4 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-b60eb661a4");
...
var pkgs = [
    {'reference':'roundcubemail-1.6.8-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
