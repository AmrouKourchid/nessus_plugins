...
# extracted from Red Hat Security Advisory RHSA-2020:5110. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:5110");

  script_name(english:"RHEL 7 : rh-postgresql10-postgresql (RHSA-2020:5110)");
...
referenced in the RHSA-2020:5110 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_5110.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1a728e16");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:5110");
...
"Update the RHEL rh-postgresql10-postgresql package based on the guidance in RHSA-2020:5110.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-postgresql10-postgresql-10.14-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql10-postgresql-contrib-10.14-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql10-postgresql-contrib-syspaths-10.14-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql10-postgresql-devel-10.14-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql10-postgresql-docs-10.14-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql10-postgresql-libs-10.14-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql10-postgresql-plperl-10.14-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql10-postgresql-plpython-10.14-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql10-postgresql-pltcl-10.14-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql10-postgresql-server-10.14-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql10-postgresql-server-syspaths-10.14-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql10-postgresql-static-10.14-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql10-postgresql-syspaths-10.14-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql10-postgresql-test-10.14-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
