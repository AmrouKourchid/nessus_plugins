...
# extracted from Red Hat Security Advisory RHSA-2022:6711.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : firefox (RHSA-2022:6711)");
...
var pkgs = [
    {'reference':'firefox-102.3.0-6.el7_9', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-102.3.0-6.el7_9', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
