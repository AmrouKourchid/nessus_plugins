...
"The version of thunderbird installed on the remote host is prior to 68.3.0-1. It is, therefore, affected by multiple
vulnerabilities as referenced in the ALAS2-2020-1386 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2020-1386.html");
...
var pkgs = [
    {'reference':'thunderbird-68.3.0-1.amzn2.0.1', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'thunderbird-debuginfo-68.3.0-1.amzn2.0.1', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
