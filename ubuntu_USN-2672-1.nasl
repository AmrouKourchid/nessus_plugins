...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : NSS vulnerabilities (USN-2672-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 14.04 LTS host has packages installed that are affected by multiple vulnerabilities as referenced in
the USN-2672-1 advisory.
    ...
    As a security improvement, this update modifies NSS behaviour to reject DH key sizes below 768 bits,
    preventing a possible downgrade attack.

    This update also refreshes the NSS package to version 3.19.2 which includes the latest CA certificate
    bundle.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2672-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'libnss3', 'pkgver': '2:3.19.2-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'libnss3-1d', 'pkgver': '2:3.19.2-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'libnss3-dev', 'pkgver': '2:3.19.2-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'libnss3-nssdb', 'pkgver': '2:3.19.2-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'libnss3-tools', 'pkgver': '2:3.19.2-0ubuntu0.14.04.1'}
];
