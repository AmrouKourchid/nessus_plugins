...
# extracted from Red Hat Security Advisory RHSA-2021:1195. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:1195");
  ...
  script_name(english:"RHEL 7 / 8 : Red Hat JBoss Web Server 5.4.2 Security Update (Important) (RHSA-2021:1195)");
...
referenced in the RHSA-2021:1195 advisory.
    ...
    This release of Red Hat JBoss Web Server 5.4.2 serves as a replacement for Red Hat JBoss Web Server 5.4.1,
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_1195.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?eafb3b94");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:1195");
...
"Update the affected jws5-tomcat-native package.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jws5-tomcat-native-1.2.25-4.redhat_4.el8jws', 'cpu':'x86_64', 'release':'8', 'el_string':'el8jws', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'jws5'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'jws5-tomcat-native-1.2.25-4.redhat_4.el7jws', 'cpu':'x86_64', 'release':'7', 'el_string':'el7jws', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'jws5'}
    ]
  }
];
