...
# AlmaLinux Security Advisory ALSA-2025:0673.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2025:0673");
  script_xref(name:"RHSA", value:"2025:0673");

  script_name(english:"AlmaLinux 9 : git-lfs (ALSA-2025:0673)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2025-0673.html");
...
var pkgs = [
    {'reference':'git-lfs-3.4.1-4.el9_5', 'cpu':'aarch64', 'release':'9', 'el_string':'el9_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'git-lfs-3.4.1-4.el9_5', 'cpu':'ppc64le', 'release':'9', 'el_string':'el9_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'git-lfs-3.4.1-4.el9_5', 'cpu':'s390x', 'release':'9', 'el_string':'el9_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'git-lfs-3.4.1-4.el9_5', 'cpu':'x86_64', 'release':'9', 'el_string':'el9_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'}
];
