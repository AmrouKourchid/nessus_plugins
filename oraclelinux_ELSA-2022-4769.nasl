...
# extracted from Oracle Linux Security Advisory ELSA-2022-4769.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : thunderbird (ELSA-2022-4769)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2022-4769.html");
...
var pkgs = [
    {'reference':'thunderbird-91.9.1-1.0.1.el8_6', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'thunderbird-91.9.1-1.0.1.el8_6', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
