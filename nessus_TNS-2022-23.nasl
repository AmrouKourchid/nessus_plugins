...
if (description)
{
  ...
  script_name(english:"Tenable Nessus 10.x < 10.3.2 Multiple Vulnerabilities (TNS-2022-23)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.tenable.com/security/tns-2022-23");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Tenable Nessus version 10.3.2 or later.");
...
constraints = [
  {'min_version':'10.0.0', 'fixed_version':'10.3.2'}
];
