...
# extracted from openSUSE Security Update openSUSE-2019-2225.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : python-numpy (openSUSE-2019-2225)");
...
if ( rpm_check(release:"SUSE15.0", reference:"python-numpy-debuginfo-1.16.1-lp150.8.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"python-numpy-debugsource-1.16.1-lp150.8.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"python-numpy_1_16_1-gnu-hpc-debuginfo-1.16.1-lp150.8.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"python-numpy_1_16_1-gnu-hpc-debugsource-1.16.1-lp150.8.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"python2-numpy-1.16.1-lp150.8.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"python2-numpy-debuginfo-1.16.1-lp150.8.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"python2-numpy-devel-1.16.1-lp150.8.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"python2-numpy-gnu-hpc-1.16.1-lp150.8.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"python2-numpy-gnu-hpc-devel-1.16.1-lp150.8.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"python2-numpy_1_16_1-gnu-hpc-1.16.1-lp150.8.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"python2-numpy_1_16_1-gnu-hpc-debuginfo-1.16.1-lp150.8.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"python2-numpy_1_16_1-gnu-hpc-devel-1.16.1-lp150.8.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"python3-numpy-1.16.1-lp150.8.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"python3-numpy-debuginfo-1.16.1-lp150.8.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"python3-numpy-devel-1.16.1-lp150.8.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"python3-numpy-gnu-hpc-1.16.1-lp150.8.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"python3-numpy-gnu-hpc-devel-1.16.1-lp150.8.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"python3-numpy_1_16_1-gnu-hpc-1.16.1-lp150.8.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"python3-numpy_1_16_1-gnu-hpc-debuginfo-1.16.1-lp150.8.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"python3-numpy_1_16_1-gnu-hpc-devel-1.16.1-lp150.8.1") ) flag++;
