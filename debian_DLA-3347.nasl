...
# extracted from Debian Security Advisory dla-3347. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3347 : spip - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has a package installed that is affected by a vulnerability as referenced in the dla-3347
advisory.

    -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3347-1                debian-lts@lists.debian.org
    ...
    It was discovered that SPIP, a content management system, was vulnerable
...
var pkgs = [
    {'release': '10.0', 'prefix': 'spip', 'reference': '3.2.4-1+deb10u10'}
];
