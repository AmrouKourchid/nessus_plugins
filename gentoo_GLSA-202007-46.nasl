...
# extracted from Gentoo Linux Security Advisory GLSA 202007-46.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202007-46");

  script_name(english:"GLSA-202007-46 : D-Bus: Denial of service");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202007-46
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202007-46");
...
if (qpkg_check(package:"sys-apps/dbus", unaffected:make_list("ge 1.12.18"), vulnerable:make_list("lt 1.12.18"))) flag++;
