...
# extracted from Red Hat Security Advisory RHSA-2020:4079 and
# CentOS Errata and Security Advisory 2020:4079 respectively.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : qemu-kvm (RHSA-2020:4079)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 7 host has packages installed that are affected by multiple vulnerabilities as referenced in the
RHSA-2020:4079 advisory.
...
var pkgs = [
    {'reference':'qemu-img-1.5.3-175.el7_9.1', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10'},
    {'reference':'qemu-kvm-1.5.3-175.el7_9.1', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10'},
    {'reference':'qemu-kvm-common-1.5.3-175.el7_9.1', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10'},
    {'reference':'qemu-kvm-tools-1.5.3-175.el7_9.1', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10'}
];
