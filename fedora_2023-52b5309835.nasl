...
# extracted from Fedora Security Advisory FEDORA-2023-52b5309835
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-52b5309835");

  script_name(english:"Fedora 40 : libeconf (2023-52b5309835)");
...
FEDORA-2023-52b5309835 advisory.

    Automatic update for libeconf-0.5.2-1.fc40.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-52b5309835");
...
"Update the affected libeconf package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:libeconf");
...
var pkgs = [
    {'reference':'libeconf-0.5.2-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
