...
# extracted from Debian Security Advisory dla-4159. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-4159 : libecpg-compat3 - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has packages installed that are affected by a vulnerability as referenced in the dla-4159
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2025-4207");
...
"Upgrade the libecpg-compat3 packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-4207");

  script_set_attribute(attribute:"exploitability_ease", value:"No known exploits are available");
  script_set_attribute(attribute:"exploit_available", value:"false");

  script_set_attribute(attribute:"vuln_publication_date", value:"2025/05/08");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'libecpg-compat3', 'reference': '13.21-0+deb11u1'},
    {'release': '11.0', 'prefix': 'libecpg-dev', 'reference': '13.21-0+deb11u1'},
    {'release': '11.0', 'prefix': 'libecpg6', 'reference': '13.21-0+deb11u1'},
    {'release': '11.0', 'prefix': 'libpgtypes3', 'reference': '13.21-0+deb11u1'},
    {'release': '11.0', 'prefix': 'libpq-dev', 'reference': '13.21-0+deb11u1'},
    {'release': '11.0', 'prefix': 'libpq5', 'reference': '13.21-0+deb11u1'},
    {'release': '11.0', 'prefix': 'postgresql-13', 'reference': '13.21-0+deb11u1'},
    {'release': '11.0', 'prefix': 'postgresql-client-13', 'reference': '13.21-0+deb11u1'},
    {'release': '11.0', 'prefix': 'postgresql-doc-13', 'reference': '13.21-0+deb11u1'},
    {'release': '11.0', 'prefix': 'postgresql-plperl-13', 'reference': '13.21-0+deb11u1'},
    {'release': '11.0', 'prefix': 'postgresql-plpython3-13', 'reference': '13.21-0+deb11u1'},
    {'release': '11.0', 'prefix': 'postgresql-pltcl-13', 'reference': '13.21-0+deb11u1'},
    {'release': '11.0', 'prefix': 'postgresql-server-dev-13', 'reference': '13.21-0+deb11u1'}
];
