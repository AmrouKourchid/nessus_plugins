...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : glib2 (EulerOS-SA-2019-2154)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2154
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5fa6a540");
...
pkgs = ["glib2-2.54.2-2.h2.eulerosv2r7",
        "glib2-devel-2.54.2-2.h2.eulerosv2r7"];
