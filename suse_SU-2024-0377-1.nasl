...
# SUSE update advisory SUSE-SU-2024:0377-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2024:0377-1");

  script_name(english:"SUSE SLES12 / SLES15 Security Update : kernel (Live Patch 47 for SLE 15 SP1) (SUSE-SU-2024:0377-1)");
...
the SUSE-SU-2024:0377-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2024-February/017875.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8da9f6cd");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2023-1829");
  script_set_attribute(attribute:"solution", value:
"Update the affected kernel-livepatch-4_12_14-150100_197_168-default and / or kgraft-patch-4_12_14-122_189-default
packages.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-122.189-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_12_14-122_189-default-2-2.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.5']}
        ]
      },
      '4.12.14-150100.197.168-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-4_12_14-150100_197_168-default-2-150100.2.1', 'sp':'1', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.1']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kernel-livepatch-4_12_14-150100_197_168-default / etc');
}
