...
# extracted from Fedora Security Advisory FEDORA-2024-99d177633f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-99d177633f");
  script_xref(name:"IAVA", value:"2024-A-0167-S");

  script_name(english:"Fedora 39 : chromium (2024-99d177633f)");
...
FEDORA-2024-99d177633f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-99d177633f");
...
var pkgs = [
    {'reference':'chromium-122.0.6261.128-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
