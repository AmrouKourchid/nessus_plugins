...
if (description)
{
  ...
  script_cve_id("CVE-2023-22028", "CVE-2023-22084", "CVE-2023-38545");
  script_xref(name:"IAVA", value:"2023-A-0562");
  script_xref(name:"CEA-ID", value:"CEA-2023-0052");

  script_name(english:"Oracle MySQL Server 5.7.x < 5.7.44 (October 2023 CPU)");
...
referenced in the October 2023 CPU advisory.
  ...
  - Vulnerability in the MySQL Server product of Oracle MySQL (component: Server: Optimizer). Supported versions
    that are affected are 5.7.43 and prior and 8.0.31 and prior. Easily exploitable vulnerability allows high
    ...
    (complete DOS) of MySQL Server. (CVE-2023-22028)

  - Vulnerability in the MySQL Server product of Oracle MySQL (component: InnoDB). Supported versions that are
    affected are 5.7.43 and prior, 8.0.34 and prior and 8.1.0. Easily exploitable vulnerability allows high privileged
    ...
    of MySQL Server. (CVE-2023-22084)

  - Vulnerability in the MySQL Server product of Oracle MySQL (component: Server: Compiling (curl)). Supported
    versions that are affected are 5.7.43 and prior, 8.0.34 and prior and 8.1.0. Difficult to exploit
    vulnerability allows unauthenticated attacker with network access via multiple protocols to compromise
    MySQL Server. Successful attacks require human interaction from a person other than the attacker.
    Successful attacks of this vulnerability can result in takeover of MySQL Server. (CVE-2023-38545)
...
var constraints = [{ 'min_version' : '5.7', 'fixed_version' : '5.7.44'}];
