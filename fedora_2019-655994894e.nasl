...
# extracted from Fedora Security Advisory FEDORA-2019-655994894e.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : freeimage / mingw-freeimage (2019-655994894e)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-655994894e");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"freeimage-3.18.0-6.fc31")) flag++;
if (rpm_check(release:"FC31", reference:"mingw-freeimage-3.18.0-7.fc31")) flag++;
