...
if (description)
{
  ...
  script_cve_id("CVE-2014-8138");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2014-8138");
...
patch available.
  ...
  - Heap-based buffer overflow in the jp2_decode function in JasPer 1.900.1 and earlier allows remote
