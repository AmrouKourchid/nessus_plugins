...
# extracted from Red Hat Security Advisory RHSA-2024:8132. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:8132");

  script_name(english:"RHEL 8 : libuv (RHSA-2024:8132)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for libuv.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:8132 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_8132.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?36515e6e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:8132");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libuv package based on the guidance in RHSA-2024:8132.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libuv-1.41.1-1.el8_8.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'libuv-devel-1.41.1-1.el8_8.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
