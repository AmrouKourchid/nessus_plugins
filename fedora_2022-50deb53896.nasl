...
# extracted from Fedora Security Advisory FEDORA-2022-50deb53896
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-50deb53896");

  script_name(english:"Fedora 37 : python3.7 (2022-50deb53896)");
...
FEDORA-2022-50deb53896 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-50deb53896");
...
var pkgs = [
    {'reference':'python3.7-3.7.16-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
