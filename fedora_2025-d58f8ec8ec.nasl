...
# extracted from Fedora Security Advisory FEDORA-2025-d58f8ec8ec
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-d58f8ec8ec");

  script_name(english:"Fedora 40 : python-django4.2 (2025-d58f8ec8ec)");
...
FEDORA-2025-d58f8ec8ec advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-d58f8ec8ec");
...
var pkgs = [
    {'reference':'python-django4.2-4.2.20-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
