...
if (description)
{
  ...
  script_cve_id("CVE-2025-24998", "CVE-2025-25003");
  script_xref(name:"IAVA", value:"2025-A-0178");

  script_name(english:"Security Updates for Microsoft Visual Studio 2019 16.11 Products (March 2025)");
...
self-reported version number.");
  # https://learn.microsoft.com/en-us/visualstudio/releases/2019/release-notes?view=vs-2022#release-notes-icon-visual-studio-2019-version-161145
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?319efad6");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released the following security updates to address this issue:
    - Update 16.11.45 for Visual Studio 2019");
...
var constraints = [
  {'product': '2019', 'min_version': '16.11.0', 'fixed_version': '16.11.35826.135', 'fixed_display': '16.11.35826.135 (16.11.45)'}
];
