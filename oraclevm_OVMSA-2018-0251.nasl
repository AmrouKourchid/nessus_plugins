...
# Security Advisory OVMSA-2018-0251.
#
...
if (description)
{
  ...
  script_name(english:"OracleVM 3.4 : xen (OVMSA-2018-0251) (Foreshadow)");
...
critical security updates :
  ...
  - BUILDINFO: xen
    commit=18ec2b68e519646188fd26a05b2cd26ebd829035
  ...
  - Revert 'xend: fix memory leak of XendConfig.XendConfig
    object' (Konrad Rzeszutek Wilk) [Orabug: 28506675]

  - BUILDINFO: xen
    commit=7023729bcb7dd5c156bc8ee31a7971f036e43f66
  ...
  - BUILDINFO: xen
    commit=63c397f89da7c720208e599696ada989121f3698
  ...
  - xend: fix memory leak of XendConfig.XendConfig object
    (Manjunath Patil) [Orabug: 28223470]");
  # https://oss.oracle.com/pipermail/oraclevm-errata/2018-August/000885.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bdcf73b7");
...
flag = 0;
if (rpm_exists(rpm:"xen-4.4.4-105", release:"OVS3.4") && rpm_check(release:"OVS3.4", reference:"xen-4.4.4-105.0.53.el6")) flag++;
if (rpm_exists(rpm:"xen-tools-4.4.4-105", release:"OVS3.4") && rpm_check(release:"OVS3.4", reference:"xen-tools-4.4.4-105.0.53.el6")) flag++;
