...
# extracted from Debian Security Advisory dsa-5826. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2023-28447", "CVE-2024-35226");

  script_name(english:"Debian dsa-5826 : smarty3 - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bookworm/smarty3");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'smarty3', 'reference': '3.1.47-2+deb12u1'}
];
