...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : java-11-openjdk on SL7.x x86_64 (20200421)");
...
"Security Fix(es) :
  ...
  - OpenJDK: Uncaught InstantiationError exception in
    ...
    (CVE-2020-2757)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind2004&L=SCIENTIFIC-LINUX-ERRATA&P=23349
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c28d9fc6");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"java-11-openjdk-11.0.7.10-4.el7_8")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"java-11-openjdk-debuginfo-11.0.7.10-4.el7_8")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"java-11-openjdk-demo-11.0.7.10-4.el7_8")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"java-11-openjdk-devel-11.0.7.10-4.el7_8")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"java-11-openjdk-headless-11.0.7.10-4.el7_8")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"java-11-openjdk-javadoc-11.0.7.10-4.el7_8")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"java-11-openjdk-javadoc-zip-11.0.7.10-4.el7_8")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"java-11-openjdk-jmods-11.0.7.10-4.el7_8")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"java-11-openjdk-src-11.0.7.10-4.el7_8")) flag++;
