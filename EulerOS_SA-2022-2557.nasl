...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : freetype (EulerOS-SA-2022-2557)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2557
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d7e75d18");
...
var pkgs = [
  "freetype-2.9.1-2.h2.eulerosv2r8",
  "freetype-devel-2.9.1-2.h2.eulerosv2r8"
];
