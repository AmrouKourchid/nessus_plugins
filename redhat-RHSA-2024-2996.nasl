...
# extracted from Red Hat Security Advisory RHSA-2024:2996. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 8 : xorg-x11-server-Xwayland (RHSA-2024:2996)");
...
referenced in the RHSA-2024:2996 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2996.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0d76c1b0");
...
"Update the RHEL xorg-x11-server-Xwayland packages based on the guidance in RHSA-2024:2996.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'xorg-x11-server-Xwayland-21.1.3-15.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
