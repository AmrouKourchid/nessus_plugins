...
# extracted from Red Hat Security Advisory RHSA-2024:2437. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2437");

  script_name(english:"RHEL 9 : exfatprogs (RHSA-2024:2437)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for exfatprogs.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2437.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4d66c5fa");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2437");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2246976");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-15865");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-7945");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL exfatprogs package based on the guidance in RHSA-2024:2437.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:exfatprogs");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'exfatprogs-1.2.2-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
