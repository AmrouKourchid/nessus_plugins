...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Libvirt PHSA-2023-5.0-0057");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'libvirt-9.3.0-2.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'libvirt-devel-9.3.0-2.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'libvirt-docs-9.3.0-2.ph5')) flag++;
