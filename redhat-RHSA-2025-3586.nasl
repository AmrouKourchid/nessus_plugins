...
# extracted from Red Hat Security Advisory RHSA-2025:3586. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:3586");

  script_name(english:"RHEL 9 : python-jinja2 (RHSA-2025:3586)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_3586.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?71b08e66");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:3586");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-jinja2 package based on the guidance in RHSA-2025:3586.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-jinja2-2.11.3-7.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
