...
# extracted from Amazon Linux 2 Security Advisory ALAS-2019-1197.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2019-1197");

  script_name(english:"Amazon Linux 2 : mod_http2 (ALAS-2019-1197)");
...
incoming data. This affects only HTTP/2 (mod_http2)
connections.(CVE-2018-17189)");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2019-1197.html");
...
"Run 'yum update mod_http2' to update your system.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-17189");
...
flag = 0;
if (rpm_check(release:"AL2", reference:"mod_http2-1.14.1-1.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"mod_http2-debuginfo-1.14.1-1.amzn2")) flag++;
