...
# extracted from Fedora Security Advisory FEDORA-2023-5399953e3b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-5399953e3b");

  script_name(english:"Fedora 36 : pesign (2023-5399953e3b)");
...
FEDORA-2023-5399953e3b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-5399953e3b");
...
var pkgs = [
    {'reference':'pesign-115-4.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
