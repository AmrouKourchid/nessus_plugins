...
if (description)
{
  ...
  script_cve_id("CVE-2024-43168");

  script_name(english:"EulerOS 2.0 SP12 : unbound (EulerOS-SA-2024-2924)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2924
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8394934d");
...
var pkgs = [
  "python3-unbound-1.13.2-7.h4.eulerosv2r12",
  "unbound-1.13.2-7.h4.eulerosv2r12",
  "unbound-libs-1.13.2-7.h4.eulerosv2r12"
];
