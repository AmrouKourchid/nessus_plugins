...
# SUSE update advisory SUSE-SU-2023:3046-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:3046-1");

  script_name(english:"SUSE SLES15 Security Update : kernel (Live Patch 33 for SLE 15 SP1) (SUSE-SU-2023:3046-1)");
...
the SUSE-SU-2023:3046-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-July/015702.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?db12c18c");
...
"Update the affected kernel-livepatch-4_12_14-150100_197_120-default package.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-150100.197.120-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-4_12_14-150100_197_120-default-12-150100.2.2', 'sp':'1', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.1']}
        ]
      }
    }
  }
