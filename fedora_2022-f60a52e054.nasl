...
# extracted from Fedora Security Advisory FEDORA-2022-f60a52e054
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-f60a52e054");

  script_name(english:"Fedora 35 : bcel (2022-f60a52e054)");
...
FEDORA-2022-f60a52e054 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-f60a52e054");
...
var pkgs = [
    {'reference':'bcel-6.4.1-10.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
