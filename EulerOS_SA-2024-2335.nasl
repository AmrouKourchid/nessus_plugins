...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.12.0 : python-cryptography (EulerOS-SA-2024-2335)");
...
Tenable has extracted the preceding description block directly from the EulerOS Virtualization python-cryptography
security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2335
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?beec2700");
...
var pkgs = [
  "python3-cryptography-36.0.1-1.h4.eulerosv2r12"
];
