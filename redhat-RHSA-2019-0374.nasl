...
# extracted from Red Hat Security Advisory RHSA-2019:0374. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:0374");

  script_name(english:"RHEL 7 : firefox (RHSA-2019:0374)");
...
referenced in the RHSA-2019:0374 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_0374.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?299e79e1");
  script_set_attribute(attribute:"see_also", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2019-05/");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:0374");
...
"Update the RHEL firefox package based on the guidance in RHSA-2019:0374.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-60.5.1-1.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
