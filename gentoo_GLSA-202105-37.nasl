...
# extracted from Gentoo Linux Security Advisory GLSA 202105-37.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202105-37");

  script_name(english:"GLSA-202105-37 : Nextcloud Desktop Client: User-assisted execution of arbitrary code");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202105-37
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202105-37"
  );
  script_set_attribute(
    attribute:"solution",
    value:
"All Nextcloud Desktop Client users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-22879");
...
if (qpkg_check(package:"net-misc/nextcloud-client", unaffected:make_list("ge 3.1.3"), vulnerable:make_list("lt 3.1.3"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "Nextcloud Desktop Client");
}
