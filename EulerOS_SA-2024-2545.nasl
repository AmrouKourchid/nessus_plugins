...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : bind (EulerOS-SA-2024-2545)");
...
following vulnerabilities :
    ...
    data may result in an assertion failure. This issue affects BIND 9 versions 9.16.13 through 9.16.50,
    9.18.0 through 9.18.27, 9.19.0 through 9.19.24, 9.11.33-S1 through 9.11.37-S1, 9.16.13-S1 through
    9.16.50-S1, and 9.18.11-S1 through 9.18.27-S1.(CVE-2024-4076)
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2545
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?70363a9a");
...
var pkgs = [
  "bind-9.16.23-6.h22.eulerosv2r11",
  "bind-chroot-9.16.23-6.h22.eulerosv2r11",
  "bind-dnssec-doc-9.16.23-6.h22.eulerosv2r11",
  "bind-dnssec-utils-9.16.23-6.h22.eulerosv2r11",
  "bind-libs-9.16.23-6.h22.eulerosv2r11",
  "bind-license-9.16.23-6.h22.eulerosv2r11",
  "bind-pkcs11-9.16.23-6.h22.eulerosv2r11",
  "bind-pkcs11-libs-9.16.23-6.h22.eulerosv2r11",
  "bind-pkcs11-utils-9.16.23-6.h22.eulerosv2r11",
  "bind-utils-9.16.23-6.h22.eulerosv2r11",
  "python3-bind-9.16.23-6.h22.eulerosv2r11"
];
