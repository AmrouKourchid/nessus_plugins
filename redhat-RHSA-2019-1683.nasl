...
# extracted from Red Hat Security Advisory RHSA-2019:1683. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:1683");

  script_name(english:"RHEL 7 : openstack-tripleo-common (RHSA-2019:1683)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1667894");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1694608");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1700760");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_1683.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b91107bc");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:1683");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL openstack-tripleo-common package based on the guidance in RHSA-2019:1683.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:python2-tripleo-common");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openstack-tripleo-common-9.5.0-5.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'openstack-tripleo-common-container-base-9.5.0-5.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'openstack-tripleo-common-containers-9.5.0-5.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'openstack-tripleo-common-devtools-9.5.0-5.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'python2-tripleo-common-9.5.0-5.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
