...
Alert advisory for CVE-2020-14750.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2019-17267");
...
var app_name_odi = 'Oracle Data Integrator Embedded Weblogic Server';
...
var normal_installs = get_installs(app_name:app_name, exit_if_not_found:FALSE);
var odi_installs = get_installs(app_name:app_name_odi, exit_if_not_found:FALSE);

var all_installs = {};

if (odi_installs[0] == IF_OK && !empty_or_null(odi_installs[1]))
  all_installs = odi_installs[1];

if (normal_installs[0] == IF_OK && !empty_or_null(normal_installs[1]))
  all_installs = make_list(all_installs, normal_installs[1]);
...
{
  var install = branch(all_installs);
