...
# extracted from Fedora Security Advisory FEDORA-2024-e8f7a74693
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-e8f7a74693");
  script_xref(name:"IAVB", value:"2024-B-0134");

  script_name(english:"Fedora 40 : clamav (2024-e8f7a74693)");
...
FEDORA-2024-e8f7a74693 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-e8f7a74693");
...
var pkgs = [
    {'reference':'clamav-1.0.7-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
