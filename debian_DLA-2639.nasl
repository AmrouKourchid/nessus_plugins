...
# extracted from Debian Security Advisory DLA-2639-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2639-1 : opendmarc security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2021/04/msg00026.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/stretch/opendmarc"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security-tracker.debian.org/tracker/source-package/opendmarc"
  );
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:rddmarc");
...
flag = 0;
if (deb_check(release:"9.0", prefix:"libopendmarc-dev", reference:"1.3.2-2+deb9u3")) flag++;
if (deb_check(release:"9.0", prefix:"libopendmarc2", reference:"1.3.2-2+deb9u3")) flag++;
if (deb_check(release:"9.0", prefix:"opendmarc", reference:"1.3.2-2+deb9u3")) flag++;
if (deb_check(release:"9.0", prefix:"rddmarc", reference:"1.3.2-2+deb9u3")) flag++;
