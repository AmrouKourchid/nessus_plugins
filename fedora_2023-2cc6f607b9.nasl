...
# extracted from Fedora Security Advisory FEDORA-2023-2cc6f607b9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-2cc6f607b9");
  script_xref(name:"CEA-ID", value:"CEA-2024-0004");

  script_name(english:"Fedora 40 : varnish (2023-2cc6f607b9)");
...
FEDORA-2023-2cc6f607b9 advisory.

    Automatic update for varnish-7.4.2-1.fc40.

    ##### **Changelog**

    ```
    * Wed Nov  8 2023 Ingvar Hagelund <ingvar@redpill-linpro.com> - 7.4.2-1
    ...
    * Thu Sep 14 2023 Lubo Uhliarik <luhliari@redhat.com> - 7.3.0-5
    - SPDX migration
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-2cc6f607b9");
...
var pkgs = [
    {'reference':'varnish-7.4.2-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
