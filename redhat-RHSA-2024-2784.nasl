...
# extracted from Red Hat Security Advisory RHSA-2024:2784. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2784");

  script_name(english:"RHEL 8 / 9 : OpenShift Container Platform 4.12.57 (RHSA-2024:2784)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for OpenShift Container Platform 4.12.57.");
...
referenced in the RHSA-2024:2784 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.12.57. See the
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2784.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bf71da68");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2784");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.12.57 package based on the guidance in RHSA-2024:2784.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cri-o-1.25.5-16.2.rhaos4.12.gitcb09013.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-3154']},
      {'reference':'podman-4.4.1-3.2.rhaos4.12.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-1753']},
      {'reference':'podman-catatonit-4.4.1-3.2.rhaos4.12.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-1753']},
      {'reference':'podman-docker-4.4.1-3.2.rhaos4.12.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-1753']},
      {'reference':'podman-gvproxy-4.4.1-3.2.rhaos4.12.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-1753']},
      {'reference':'podman-plugins-4.4.1-3.2.rhaos4.12.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-1753']},
      {'reference':'podman-remote-4.4.1-3.2.rhaos4.12.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-1753']},
      {'reference':'podman-tests-4.4.1-3.2.rhaos4.12.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-1753']},
      {'reference':'skopeo-1.9.4-4.3.rhaos4.12.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-28180']},
      {'reference':'skopeo-tests-1.9.4-4.3.rhaos4.12.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-28180']}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'skopeo-1.9.4-4.3.rhaos4.12.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-28180']},
      {'reference':'skopeo-tests-1.9.4-4.3.rhaos4.12.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-28180']}
    ]
  }
];
