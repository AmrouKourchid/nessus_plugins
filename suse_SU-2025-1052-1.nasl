...
# SUSE update advisory SUSE-SU-2025:1052-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2025:1052-1");

  script_name(english:"SUSE SLES15 / openSUSE 15 Security Update : govulncheck-vulndb (SUSE-SU-2025:1052-1)");
...
referenced in the SUSE-SU-2025:1052-1 advisory.

    - Update to version 0.0.20250326T201520 2025-03-26T20:15:20Z (jsc#PED-11136):
    * GO-2025-3520
    * GO-2025-3521
    * GO-2025-3522
    * GO-2025-3533
...
number.");
  # https://lists.suse.com/pipermail/sle-security-updates/2025-March/020618.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6be27122");
...
var pkgs = [
    {'reference':'govulncheck-vulndb-0.0.20250326T201520-150000.1.46.1', 'release':'SUSE15.6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.6']},
    {'reference':'govulncheck-vulndb-0.0.20250326T201520-150000.1.46.1', 'sp':'6', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-packagehub-subpackages-release-15.6']}
];
