...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : uboot-tools (EulerOS-SA-2022-2335)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2335
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?35517d9d");
...
var pkgs = [
  "uboot-tools-2018.09-8.h6.eulerosv2r9",
  "uboot-tools-help-2018.09-8.h6.eulerosv2r9"
];
