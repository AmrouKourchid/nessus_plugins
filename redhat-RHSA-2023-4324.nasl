...
# extracted from Red Hat Security Advisory RHSA-2023:4324. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:4324");
  script_xref(name:"IAVB", value:"2023-B-0041-S");

  script_name(english:"RHEL 9 : ghostscript (RHSA-2023:4324)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_4324.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2fa5d78c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2217798");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:4324");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL ghostscript package based on the guidance in RHSA-2023:4324.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ghostscript-9.54.0-7.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ghostscript-doc-9.54.0-7.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ghostscript-tools-dvipdf-9.54.0-7.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ghostscript-tools-fonts-9.54.0-7.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ghostscript-tools-printing-9.54.0-7.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ghostscript-x11-9.54.0-7.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libgs-9.54.0-7.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libgs-devel-9.54.0-7.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
