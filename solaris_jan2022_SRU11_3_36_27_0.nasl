...
if (description)
{
  ...
  script_cve_id("CVE-2021-43395");
  script_xref(name:"IAVA", value:"2022-A-0038");

  script_name(english:"Oracle Solaris Critical Patch Update : jan2022_SRU11_3_36_27_0");
...
security update :
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-43395");
...
fix_release = "0.5.11-0.175.3.36.0.27.0";

flag = 0;

if (solaris_check_release(release:"0.5.11-0.175.3.36.0.27.0", sru:"11.3.36.27.0") > 0) flag++;
