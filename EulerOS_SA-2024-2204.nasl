...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.0 : util-linux (EulerOS-SA-2024-2204)");
...
host is affected by the following vulnerabilities :
    ...
    An attacker with the ability to modify physical memory can control the value of AcpiS3ResumeRecord-
    ResumeCount. If the attacker sets the value of ResumeCount to MAX_UINT32 (0xFFFFFFFF), and ResumeCount
    is subsequently incremented, its new value will be 0 (due to UINT32 overflow). Since there is no check for
    overflow, when ResumeCount is 0 and passed as the second argument to DivU64x32(), it will trigger a
    division by 0, and cause a system crash, leading to a DoS.(CVE-2024-1298)
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2204
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b84faa49");
