...
# extracted from Fedora Security Advisory FEDORA-2023-11aaf99627
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-11aaf99627");
  script_xref(name:"IAVA", value:"2023-A-0645");

  script_name(english:"Fedora 38 : webkitgtk (2023-11aaf99627)");
...
FEDORA-2023-11aaf99627 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-11aaf99627");
...
var pkgs = [
    {'reference':'webkitgtk-2.42.2-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
