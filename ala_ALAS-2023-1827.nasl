...
# extracted from Amazon Linux AMI Security Advisory ALAS-2023-1827.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux AMI : kernel (ALAS-2023-1827)");
...
vulnerabilities as referenced in the ALAS-2023-1827 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/ALAS-2023-1827.html");
...
if (get_one_kb_item("Host/kpatch/kernel-cves"))
{
  ...
  var cve_list = make_list("CVE-2023-3390", "CVE-2023-4128", "CVE-2023-4206", "CVE-2023-4208", "CVE-2023-34319", "CVE-2023-52885", "CVE-2024-0639");
  if (hotfix_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, "kpatch hotfix for ALAS-2023-1827");
  }
  else
  {
