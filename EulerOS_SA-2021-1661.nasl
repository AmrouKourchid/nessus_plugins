...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.0 : libxml2 (EulerOS-SA-2021-1661)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1661
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ae4ae35c");
...
pkgs = ["libxml2-2.9.10-1.h16.eulerosv2r9",
        "python3-libxml2-2.9.10-1.h16.eulerosv2r9"];
