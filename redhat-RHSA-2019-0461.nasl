...
# extracted from Red Hat Security Advisory RHSA-2019:0461. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:0461");

  script_name(english:"RHEL 7 : rhvm-appliance (RHSA-2019:0461)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for rhvm-appliance.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_0461.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5c1e8290");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:0461");
...
"Update the RHEL rhvm-appliance package based on the guidance in RHSA-2019:0461.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rhvm-appliance-4.2-20190224.0.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ovirt-'}
    ]
  }
];
