...
# extracted from Ubuntu Security Notice USN-2935-2. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : PAM regression (USN-2935-2)");
...
USN-2935-2 advisory.
    ...
    USN-2935-1 fixed vulnerabilities in PAM. The updates contained a packaging change that prevented upgrades
    in certain multiarch environments. This update fixes the problem.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2935-2");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'libpam-cracklib', 'pkgver': '1.1.8-1ubuntu2.2'},
    {'osver': '14.04', 'pkgname': 'libpam-modules', 'pkgver': '1.1.8-1ubuntu2.2'},
    {'osver': '14.04', 'pkgname': 'libpam-modules-bin', 'pkgver': '1.1.8-1ubuntu2.2'},
    {'osver': '14.04', 'pkgname': 'libpam-runtime', 'pkgver': '1.1.8-1ubuntu2.2'},
    {'osver': '14.04', 'pkgname': 'libpam0g', 'pkgver': '1.1.8-1ubuntu2.2'},
    {'osver': '14.04', 'pkgname': 'libpam0g-dev', 'pkgver': '1.1.8-1ubuntu2.2'}
];
