...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS : Docker vulnerabilities (USN-4048-1)");
...
referenced in the USN-4048-1 advisory.

    Aleksa Sarai discovered that Docker was vulnerable to a directory traversal attack. An attacker could use
    this vulnerability to read and write arbitrary files on the host filesystem as root.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4048-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'docker.io', 'pkgver': '18.09.7-0ubuntu1~16.04.4'},
    {'osver': '18.04', 'pkgname': 'docker.io', 'pkgver': '18.09.7-0ubuntu1~18.04.3'}
];
