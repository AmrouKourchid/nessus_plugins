...
if (description)
{
  ...
  script_cve_id("CVE-2021-21345", "CVE-2021-29505");
  script_xref(name:"IAVA", value:"2021-A-0480");

  script_name(english:"Oracle Enterprise Manager Ops Center UI and Other Patches (Oct 2021 CPU)");
...
vulnerabilities as referenced in the October 2021 CPU advisory.
  ...
  - Vulnerability in the Enterprise Manager Ops Center product of Oracle Enterprise Manager (component: Guest
    Management (XStream)). The supported version that is affected is 12.4.0.0. Easily exploitable
    vulnerability allows low privileged attacker with network access via HTTP to compromise Enterprise Manager
    Ops Center. Successful attacks of this vulnerability can result in takeover of Enterprise Manager Ops
    Center. (CVE-2021-29505)

  - Vulnerability in the Enterprise Manager Ops Center product of Oracle Enterprise Manager Ops Center
    (component: Common Core (XStream)). The supported version that is affected is 12.4.0.0. Easily exploitable
    vulnerability allows low privileged attacker with network access via HTTP to compromise Enterprise Manager
    Ops Center. Successful attacks of this vulnerability can result in takeover of Enterprise Manager Ops
    Center. (CVE-2021-21345) 

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.oracle.com/docs/tech/security-alerts/cpuoct2021cvrf.xml");
...
var constraints = [
  {'min_version': '12.4.0.0', 'max_version': '12.4.0.9999', 'ui_patch': '33352410'}
];
