...
# extracted from Fedora Security Advisory FEDORA-2023-e3e4e3f51a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-e3e4e3f51a");

  script_name(english:"Fedora 39 : gmailctl (2023-e3e4e3f51a)");
...
FEDORA-2023-e3e4e3f51a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-e3e4e3f51a");
...
var pkgs = [
    {'reference':'gmailctl-0.10.7-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
