...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : python-dns (EulerOS-SA-2024-2564)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2564
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a6229999");
...
var pkgs = [
  "python3-dns-2.1.0-2.h1.eulerosv2r11"
];
