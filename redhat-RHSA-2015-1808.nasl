...
# extracted from Red Hat Security Advisory RHSA-2015:1808. The text 
...
if (description)
{
  ...
  script_cve_id("CVE-2015-5274");
  script_xref(name:"RHSA", value:"2015:1808");

  script_name(english:"RHEL 6 : rubygem-openshift-origin-console (RHSA-2015:1808)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for rubygem-openshift-origin-console.");
...
the RHSA-2015:1808 advisory.
    ...
    All rubygem-openshift-origin-console users are advised to upgrade to this updated package, which contains
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2015/rhsa-2015_1808.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a8656816");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2015:1808");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/site/articles/11258");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1262518");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rubygem-openshift-origin-console package based on the guidance in RHSA-2015:1808.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:S/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-5274");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rubygem-openshift-origin-console-1.34.1.3-1.el6op', 'release':'6', 'el_string':'el6op', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-ansible'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'rubygem-openshift-origin-console');
}
