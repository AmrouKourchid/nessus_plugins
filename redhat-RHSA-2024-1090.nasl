...
# extracted from Red Hat Security Advisory RHSA-2024:1090. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:1090");

  script_name(english:"RHEL 9 : tcpdump (RHSA-2024:1090)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_1090.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?20575321");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2040392");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:1090");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL tcpdump package based on the guidance in RHSA-2024:1090.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'tcpdump-4.99.0-6.el9_2.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'14'}
    ]
  }
];
