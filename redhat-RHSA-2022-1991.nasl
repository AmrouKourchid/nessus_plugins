...
# extracted from Red Hat Security Advisory RHSA-2022:1991. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:1991");

  script_name(english:"RHEL 8 : cpio (RHSA-2022:1991)");
...
the RHSA-2022:1991 advisory.
    ...
    * cpio: integer overflow in ds_fgetstr() in dstring.c can lead to an out-of-bounds write via a crafted
    pattern file (CVE-2021-38185)
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_1991.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ae60fff6");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:1991");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1991731");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL cpio package based on the guidance in RHSA-2022:1991.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cpio-2.12-11.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
