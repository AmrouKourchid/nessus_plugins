...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.1.0 : util-linux (EulerOS-SA-2019-1462)");
...
the following vulnerability :
  ...
  - A race condition was found in the way su handled the
    ...
    with root privileges under specific
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1462
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3aeedfc5");
...
pkgs = ["libblkid-2.23.2-52.1.h3.eulerosv2r7",
        "libmount-2.23.2-52.1.h3.eulerosv2r7",
        "libuuid-2.23.2-52.1.h3.eulerosv2r7",
        "util-linux-2.23.2-52.1.h3.eulerosv2r7"];
