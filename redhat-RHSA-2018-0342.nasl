...
referenced in the RHSA-2018:0342 advisory.
    ...
    * Further classes that an attacker could use to achieve code execution through deserialisation were
    discovered, and added to the blacklist introduced by CVE-2017-7525. (CVE-2017-15095, CVE-2017-17485)

    Red Hat would like to thank Liao Xinxi (NSFOCUS) for reporting CVE-2017-7525 and CVE-2017-15095 and 0c0c0f
    from 360 for reporting CVE-2017-17485.

Tenable has extracted the preceding description block directly from the Red Hat Enterprise Linux security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2018/rhsa-2018_0342.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0d904fca");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:0342");
...
"Update the RHEL rh-maven35-jackson-databind package based on the guidance in RHSA-2018:0342.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-maven35-jackson-databind-2.7.6-2.4.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-maven35-jackson-databind-javadoc-2.7.6-2.4.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
