...
# extracted from Fedora Security Advisory FEDORA-2024-a059ea1dfc
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-a059ea1dfc");

  script_name(english:"Fedora 39 : libsoup3 (2024-a059ea1dfc)");
...
FEDORA-2024-a059ea1dfc advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-a059ea1dfc");
...
var pkgs = [
    {'reference':'libsoup3-3.4.4-3.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
