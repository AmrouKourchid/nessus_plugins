...
# SUSE update advisory SUSE-SU-2024:3987-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2024:3987-1");

  script_name(english:"SUSE SLES12 Security Update : java-1_8_0-openjdk (SUSE-SU-2024:3987-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote SUSE Linux SLES12 host has packages installed that are affected by multiple vulnerabilities as referenced in
the SUSE-SU-2024:3987-1 advisory.

    Update to version jdk8u432 (icedtea-3.33.0):

    - CVE-2024-21208: Enhance HTTP client (bsc#1231702).
    - CVE-2024-21210: Improve handling of vectorization (bsc#1231711).
    - CVE-2024-21217: Improve deserialization support (bsc#1231716).
    - CVE-2024-21235: Improve graph optimizations (bsc#1231719).
    - CVE-2024-21145: Improve 2D image (bsc#1228051).
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2024-November/019817.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c508ab9b");
...
var pkgs = [
    {'reference':'java-1_8_0-openjdk-1.8.0.432-27.108.2', 'sp':'5', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-ltss-extended-security-release-12.5']},
    {'reference':'java-1_8_0-openjdk-demo-1.8.0.432-27.108.2', 'sp':'5', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-ltss-extended-security-release-12.5']},
    {'reference':'java-1_8_0-openjdk-devel-1.8.0.432-27.108.2', 'sp':'5', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-ltss-extended-security-release-12.5']},
    {'reference':'java-1_8_0-openjdk-headless-1.8.0.432-27.108.2', 'sp':'5', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-ltss-extended-security-release-12.5']},
    {'reference':'java-1_8_0-openjdk-1.8.0.432-27.108.2', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.5']},
    {'reference':'java-1_8_0-openjdk-demo-1.8.0.432-27.108.2', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.5']},
    {'reference':'java-1_8_0-openjdk-devel-1.8.0.432-27.108.2', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.5']},
    {'reference':'java-1_8_0-openjdk-headless-1.8.0.432-27.108.2', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.5']}
];
