...
if (description)
{
  ...
  script_cve_id("CVE-2024-27395");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-27395");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: net: openvswitch: Fix Use-After-Free
    in ovs_ct_exit Since kfree_rcu, which is called in the hlist_for_each_entry_rcu traversal of
