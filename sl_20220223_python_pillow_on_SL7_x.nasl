...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"RHSA-2022:0609");

  script_name(english:"Scientific Linux Security Update : python-pillow on SL7.x i686/x86_64 (2022:0609)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.scientificlinux.org/category/sl-errata/slsa-20220609-1");
...
var pkgs = [
    {'reference':'python-pillow-2.0.0-23.gitd1c6db8.el7_9', 'cpu':'i686', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python-pillow-2.0.0-23.gitd1c6db8.el7_9', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python-pillow-debuginfo-2.0.0-23.gitd1c6db8.el7_9', 'cpu':'i686', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python-pillow-debuginfo-2.0.0-23.gitd1c6db8.el7_9', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python-pillow-devel-2.0.0-23.gitd1c6db8.el7_9', 'cpu':'i686', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python-pillow-devel-2.0.0-23.gitd1c6db8.el7_9', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python-pillow-doc-2.0.0-23.gitd1c6db8.el7_9', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python-pillow-qt-2.0.0-23.gitd1c6db8.el7_9', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python-pillow-sane-2.0.0-23.gitd1c6db8.el7_9', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python-pillow-tk-2.0.0-23.gitd1c6db8.el7_9', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE}
];
