...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 20.04 LTS : PEAR vulnerabilities (USN-4654-1)");
...
vulnerabilities as referenced in the USN-4654-1 advisory.
    ...
    It was discovered that PEAR incorrectly sanitized filenames. A remote attacker could possibly use this
