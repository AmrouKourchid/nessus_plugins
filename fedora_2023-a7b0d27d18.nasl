...
# extracted from Fedora Security Advisory FEDORA-2023-a7b0d27d18
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-a7b0d27d18");

  script_name(english:"Fedora 37 : moodle (2023-a7b0d27d18)");
...
FEDORA-2023-a7b0d27d18 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-a7b0d27d18");
...
var pkgs = [
    {'reference':'moodle-4.1.6-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
