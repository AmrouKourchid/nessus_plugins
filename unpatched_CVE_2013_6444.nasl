...
if (description)
{
  ...
  script_cve_id("CVE-2013-6444");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2013-6444");
...
patch available.
  ...
  - PyWBEM 0.7 and earlier does not verify that the server hostname matches a domain name in the subject's
    Common Name (CN) or subjectAltName field of the X.509 certificate, which allows man-in-the-middle
    attackers to spoof SSL servers via an arbitrary valid certificate. (CVE-2013-6444)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-6444");
