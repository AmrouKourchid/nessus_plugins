...
# extracted from Fedora Security Advisory FEDORA-2022-bd02afca8c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-bd02afca8c");

  script_name(english:"Fedora 38 : python3.10 (2022-bd02afca8c)");
...
FEDORA-2022-bd02afca8c advisory.
    ...
    ```
    * Wed Nov  9 2022 Lumr Balhar <lbalhar@redhat.com> - 3.10.8-2
    - Fix CVE-2022-42919
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-bd02afca8c");
...
var pkgs = [
    {'reference':'python3.10-3.10.8-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
