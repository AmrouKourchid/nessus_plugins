...
# SUSE update advisory SUSE-SU-2023:2431. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:2431");

  script_name(english:"SUSE SLES15 Security Update : kernel (Live Patch 6 for SLE 15 SP4) (SUSE-SU-2023:2431)");
...
the SUSE-SU-2023:2431 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-June/015106.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fb4c3b8c");
...
var kernel_live_checks = [
  {
    'kernels': {
      '5.14.21-150400.24.38-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_14_21-150400_24_38-default-6-150400.2.3', 'sp':'4', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.4']}
        ]
      }
    }
  }
