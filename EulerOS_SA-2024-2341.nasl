...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.12.0 : qemu (EulerOS-SA-2024-2341)");
...
affected by the following vulnerabilities :
    ...
    of service condition.(CVE-2024-3447)
    ...
    denial of service or allow arbitrary code execution within the context of the QEMU process on the
    host.(CVE-2024-3446)
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2341
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bb9cbcd0");
...
"Update the affected qemu packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:qemu-6.2.0.oe2203sp1");
...
var pkgs = [
  "qemu-6.2.0.oe2203sp1-2.12.0.5.350"
];
