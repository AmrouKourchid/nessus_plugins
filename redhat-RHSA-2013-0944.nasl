...
# extracted from Red Hat Security Advisory RHSA-2013:0944. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2013:0944");

  script_name(english:"RHEL 6 : python-keystoneclient (RHSA-2013:0944)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for python-keystoneclient.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 6 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2013:0944 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=904351");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=928558");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=965852");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2013/rhsa-2013_0944.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4feeabca");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2013:0944");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-keystoneclient package based on the guidance in RHSA-2013:0944.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-2104");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python-keystoneclient-0.2.3-2.el6ost', 'release':'6', 'el_string':'el6ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'},
      {'reference':'python-keystoneclient-doc-0.2.3-2.el6ost', 'release':'6', 'el_string':'el6ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'}
    ]
  }
];
