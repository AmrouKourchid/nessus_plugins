...
the USN-4681-1 advisory.
    ...
    Ryan Hall discovered that the Intel 700 Series Ethernet Controllers driver in the Linux kernel did not
    properly deallocate memory in some conditions. A local attacker could use this to cause a denial of
    service (kernel memory exhaustion). (CVE-2019-0148)
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.4.0-198-powerpc-e500mc");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.4.0-198-powerpc-smp");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.4.0-198-powerpc64-emb");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.4.0-198-powerpc64-smp");
...
var kernel_mappings = {
  '16.04': {
    '4.4.0': {
      'generic': '4.4.0-198',
      'generic-lpae': '4.4.0-198',
      'lowlatency': '4.4.0-198',
      'powerpc-e500mc': '4.4.0-198',
      'powerpc-smp': '4.4.0-198',
      'powerpc64-emb': '4.4.0-198',
      'powerpc64-smp': '4.4.0-198',
      'kvm': '4.4.0-1085',
      'aws': '4.4.0-1119',
      'raspi2': '4.4.0-1143',
      'snapdragon': '4.4.0-1147'
    }
  }
};
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-4681-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2019-0148', 'CVE-2020-4788', 'CVE-2020-25656', 'CVE-2020-25668', 'CVE-2020-27675', 'CVE-2020-28974');
