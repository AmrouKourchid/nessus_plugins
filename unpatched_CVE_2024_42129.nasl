...
if (description)
{
  ...
  script_cve_id("CVE-2024-42129");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-42129");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: leds: mlxreg: Use devm_mutex_init()
    ...
    module's remove() so use devm API instead. (CVE-2024-42129)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-42129");
