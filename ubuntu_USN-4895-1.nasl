...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 20.04 LTS : Squid vulnerabilities (USN-4895-1)");
...
vulnerabilities as referenced in the USN-4895-1 advisory.
    ...
    cache poisoning. This issue only affected Ubuntu 20.04 LTS. (CVE-2020-15049)

    Jianjun Chen discovered that Squid incorrectly validated certain input. A remote attacker could use this
    issue to perform HTTP Request Smuggling and possibly access services forbidden by the security controls.
    (CVE-2020-25097)
