...
# extracted from Red Hat Security Advisory RHSA-2022:2253. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:2253");

  script_name(english:"RHEL 8 : pcs (RHSA-2022:2253)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for pcs.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2022:2253 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_2253.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?38c8c803");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:2253");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2081096");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL pcs package based on the guidance in RHSA-2022:2253.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'pcs-0.10.4-6.el8_2.2', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcs-snmp-0.10.4-6.el8_2.2', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
