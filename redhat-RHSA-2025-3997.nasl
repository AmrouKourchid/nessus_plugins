...
# extracted from Red Hat Security Advisory RHSA-2025:3997. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:3997");

  script_name(english:"RHEL 8 : mod_auth_openidc:2.3 (RHSA-2025:3997)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for mod_auth_openidc:2.3.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2025:3997 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_3997.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0764b560");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:3997");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL mod_auth_openidc:2.3 package based on the guidance in RHSA-2025:3997.");
  ...
  'mod_auth_openidc:2.3': [
    {
      ...
      'pkgs': [
        ...
        {'reference':'mod_auth_openidc-2.4.9.4-7.module+el8.10.0+23023+ba6d7066', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
