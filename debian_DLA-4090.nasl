...
# extracted from Debian Security Advisory dla-4090. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-4090 : ruby-rack - security update");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'ruby-rack', 'reference': '2.1.4-3+deb11u3'}
];
