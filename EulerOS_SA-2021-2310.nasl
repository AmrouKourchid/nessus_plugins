...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : openldap (EulerOS-SA-2021-2310)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2310
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0558a1e2");
...
pkgs = ["openldap-2.4.46-8.h14.eulerosv2r8",
        "openldap-clients-2.4.46-8.h14.eulerosv2r8",
        "openldap-devel-2.4.46-8.h14.eulerosv2r8",
        "openldap-servers-2.4.46-8.h14.eulerosv2r8"];
