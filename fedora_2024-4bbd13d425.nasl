...
# extracted from Fedora Security Advisory FEDORA-2024-4bbd13d425
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-4bbd13d425");

  script_name(english:"Fedora 39 : python-cbor2 (2024-4bbd13d425)");
...
FEDORA-2024-4bbd13d425 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-4bbd13d425");
...
var pkgs = [
    {'reference':'python-cbor2-5.6.2-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
