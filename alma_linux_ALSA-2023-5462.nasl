...
# AlmaLinux Security Advisory ALSA-2023:5462.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:5462");
  script_xref(name:"IAVA", value:"2023-A-0442-S");

  script_name(english:"AlmaLinux 9 : python3.9 (ALSA-2023:5462)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2023-5462.html");
