...
if (description)
{
  ...
  script_cve_id("CVE-2024-31912");
  script_xref(name:"IAVA", value:"2024-A-0418-S");

  script_name(english:"IBM MQ 9.3 < 9.3.0.20 LTS / 9.3 < 9.4 CD Privilege Escalation (7158072)");

  script_set_attribute(attribute:"synopsis", value:
"The remote web server is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of IBM MQ Server running on the remote host is affected by a vulnerability as referenced in the 7158072
advisory.

  - IBM MQ could allow an authenticated user to escalate their privileges under certain configurations due to
    incorrect privilege assignment. (CVE-2024-31912)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/node/7158072");
...
"Upgrade to IBM MQ 9.3.0.20 LTS, 9.4 CD or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-31912");
