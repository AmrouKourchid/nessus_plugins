...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : syslinux (EulerOS-SA-2024-2987)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2987
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?58bf4de9");
...
var pkgs = [
  "syslinux-6.04-9.h3.eulerosv2r11",
  "syslinux-nonlinux-6.04-9.h3.eulerosv2r11"
];
