...
# extracted from Debian Security Advisory DSA-4592. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"4592");

  script_name(english:"Debian DSA-4592-1 : mediawiki - security update");
...
a website engine for collaborative work, could by bypassed.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2019/dsa-4592");
...
version 1:1.31.6-1~deb10u1.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-19709");

  script_set_attribute(attribute:"exploitability_ease", value:"Exploits are available");
  script_set_attribute(attribute:"exploit_available", value:"true");

  script_set_attribute(attribute:"vuln_publication_date", value:"2019/12/11");
  script_set_attribute(attribute:"patch_publication_date", value:"2019/12/26");
...
flag = 0;
if (deb_check(release:"10.0", prefix:"mediawiki", reference:"1:1.31.6-1~deb10u1")) flag++;
if (deb_check(release:"10.0", prefix:"mediawiki-classes", reference:"1:1.31.6-1~deb10u1")) flag++;
if (deb_check(release:"9.0", prefix:"mediawiki", reference:"1:1.27.7-1~deb9u3")) flag++;
if (deb_check(release:"9.0", prefix:"mediawiki-classes", reference:"1:1.27.7-1~deb9u3")) flag++;
