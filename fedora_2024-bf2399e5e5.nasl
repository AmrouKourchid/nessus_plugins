...
# extracted from Fedora Security Advisory FEDORA-2024-bf2399e5e5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-bf2399e5e5");

  script_name(english:"Fedora 39 : qt5-qtwebengine (2024-bf2399e5e5)");
...
FEDORA-2024-bf2399e5e5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-bf2399e5e5");
...
var pkgs = [
    {'reference':'qt5-qtwebengine-5.15.16-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
