...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Gnutls PHSA-2020-3.0-0103");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'gnutls-3.6.14-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'gnutls-devel-3.6.14-1.ph3')) flag++;
