...
# SUSE update advisory SUSE-SU-2022:2356-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:2356-1");
  script_xref(name:"IAVA", value:"2022-A-0255-S");

  script_name(english:"SUSE SLES12 Security Update : curl (SUSE-SU-2022:2356-1)");
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-July/011504.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ebe19709");
...
var pkgs = [
    {'reference':'curl-7.37.0-37.79.1', 'sp':'2', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.2']},
    {'reference':'libcurl4-32bit-7.37.0-37.79.1', 'sp':'2', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.2']},
    {'reference':'libcurl4-7.37.0-37.79.1', 'sp':'2', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.2']},
    {'reference':'curl-7.37.0-37.79.1', 'sp':'3', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.3']},
    {'reference':'libcurl4-32bit-7.37.0-37.79.1', 'sp':'3', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.3']},
    {'reference':'libcurl4-7.37.0-37.79.1', 'sp':'3', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.3']}
];
