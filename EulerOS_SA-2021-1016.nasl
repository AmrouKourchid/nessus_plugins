...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : python-lxml (EulerOS-SA-2021-1016)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the version of the python-lxml package installed, the
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1016
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?42f61bb8");
...
pkgs = ["python3-lxml-4.2.3-4.h2.eulerosv2r9"];
