...
# extracted from Fedora Security Advisory FEDORA-2024-2e8944621e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-2e8944621e");

  script_name(english:"Fedora 41 : NetworkManager-libreswan (2024-2e8944621e)");
...
FEDORA-2024-2e8944621e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-2e8944621e");
...
var pkgs = [
    {'reference':'NetworkManager-libreswan-1.2.24-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
