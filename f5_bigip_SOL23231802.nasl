...
# extracted from F5 Networks BIG-IP Solution K23231802.
#
# @NOAGENT@
##
...
if (description)
{
  ...
  script_cve_id("CVE-2021-46143");

  script_name(english:"F5 Networks BIG-IP : Expat vulnerability (K23231802)");
...
affected by a vulnerability as referenced in the K23231802 advisory.

    In doProlog in xmlparse.c in Expat (aka libexpat) before 2.4.3, an integer overflow exists for
    m_groupSize.(CVE-2021-46143)ImpactA remote attacker could send specially crafted XML which, when parsed by
    an application using the Expat library, would result in a buffer over-read and cause the application to
    stop responding.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K23231802");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K23231802.");
