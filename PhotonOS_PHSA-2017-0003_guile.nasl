...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'guile-2.0.13-1.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'guile-debuginfo-2.0.13-1.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'guile-devel-2.0.13-1.ph1')) flag++;
