...
# extracted from Debian Security Advisory dla-3301. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3301 : cinder-api - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3301
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/cinder");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'cinder-api', 'reference': '2:13.0.7-1+deb10u2'},
    {'release': '10.0', 'prefix': 'cinder-backup', 'reference': '2:13.0.7-1+deb10u2'},
    {'release': '10.0', 'prefix': 'cinder-common', 'reference': '2:13.0.7-1+deb10u2'},
    {'release': '10.0', 'prefix': 'cinder-doc', 'reference': '2:13.0.7-1+deb10u2'},
    {'release': '10.0', 'prefix': 'cinder-scheduler', 'reference': '2:13.0.7-1+deb10u2'},
    {'release': '10.0', 'prefix': 'cinder-volume', 'reference': '2:13.0.7-1+deb10u2'},
    {'release': '10.0', 'prefix': 'python3-cinder', 'reference': '2:13.0.7-1+deb10u2'}
];
