...
# extracted from Fedora Security Advisory FEDORA-2018-a5e45fc9f7.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : 1:epiphany (2018-a5e45fc9f7)");
...
"- Fix CVE-2018-11396/CVE-2018-12016 (#795740)
  ...
  - Allow Ctrl+T in app mode again due to unintended
    consequences (#796204)
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-a5e45fc9f7");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"epiphany-3.28.3.1-1.fc28", epoch:"1")) flag++;
