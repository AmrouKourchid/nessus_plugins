...
# extracted from Red Hat Security Advisory RHSA-2024:1999. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:1999");

  script_name(english:"RHEL 9 : postgresql-jdbc (RHSA-2024:1999)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_1999.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b58509b9");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:1999");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL postgresql-jdbc package based on the guidance in RHSA-2024:1999.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'postgresql-jdbc-42.2.28-1.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
