...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Kapacitor PHSA-2023-5.0-0045");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2022-36640");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:vmware:photonos:kapacitor");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'kapacitor-1.6.6-1.ph5')) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kapacitor');
}
