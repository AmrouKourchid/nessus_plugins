...
# extracted from Red Hat Security Advisory RHSA-2025:7331. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:7331");

  script_name(english:"RHEL 9 : nginx (RHSA-2025:7331)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2344005");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_7331.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?90cb56f3");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:7331");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL nginx package based on the guidance in RHSA-2025:7331.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'nginx-1.20.1-22.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'nginx-all-modules-1.20.1-22.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'nginx-core-1.20.1-22.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'nginx-filesystem-1.20.1-22.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'nginx-mod-devel-1.20.1-22.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'nginx-mod-http-image-filter-1.20.1-22.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'nginx-mod-http-perl-1.20.1-22.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'nginx-mod-http-xslt-filter-1.20.1-22.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'nginx-mod-mail-1.20.1-22.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'nginx-mod-stream-1.20.1-22.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
    ]
  }
];
