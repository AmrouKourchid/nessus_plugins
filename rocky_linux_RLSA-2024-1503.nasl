...
# Rocky Linux Security Advisory RLSA-2024:1503.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2024:1503");

  script_name(english:"Rocky Linux 9 : nodejs:18 (RLSA-2024:1503)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2024:1503");
...
var appstreams = {
    'nodejs:18': [
      {'reference':'nodejs-nodemon-3.0.1-1.module+el9.2.0+15226+de336927', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nodejs-packaging-2021.06-4.module+el9.2.0+15226+de336927', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nodejs-packaging-bundler-2021.06-4.module+el9.2.0+15226+de336927', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
};
