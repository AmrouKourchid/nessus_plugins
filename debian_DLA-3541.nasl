...
# extracted from Debian Security Advisory dla-3541. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3541 : w3m - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3541
advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/w3m");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-38223");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/w3m");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'w3m', 'reference': '0.5.3-37+deb10u1'},
    {'release': '10.0', 'prefix': 'w3m-img', 'reference': '0.5.3-37+deb10u1'}
];
