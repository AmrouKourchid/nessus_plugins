...
# extracted from Ubuntu Security Notice USN-3704-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"3704-1");

  script_name(english:"Ubuntu 18.04 LTS : devscripts vulnerability (USN-3704-1)");
...
USN-3704-1 advisory.
    ...
    It was discovered that devscripts incorrectly handled certain YAML files. An attacker could possibly use
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3704-1");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'devscripts', 'pkgver': '2.17.12ubuntu1.1'}
];
