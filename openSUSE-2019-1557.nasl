...
# extracted from openSUSE Security Update openSUSE-2019-1557.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : chromium (openSUSE-2019-1557)");
...
&#9; - CVE-2019-5828: Fixed a Use after free in ServiceWorker
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1137332");
...
if ( rpm_check(release:"SUSE15.1", reference:"chromedriver-75.0.3770.80-lp151.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"chromedriver-debuginfo-75.0.3770.80-lp151.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"chromium-75.0.3770.80-lp151.2.6.1", allowmaj:TRUE) ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"chromium-debuginfo-75.0.3770.80-lp151.2.6.1", allowmaj:TRUE) ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"chromium-debugsource-75.0.3770.80-lp151.2.6.1", allowmaj:TRUE) ) flag++;
