...
if (description)
{
  ...
  script_name(english:"CentOS 9 : swtpm-0.6.0-3.20210607gitea627b3.el9 (deprecated)");
...
"This plugin was deprecated due to incorrect CVE matches for the build.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=13104");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-28407");
