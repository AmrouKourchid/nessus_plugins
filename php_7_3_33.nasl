...
if (description)
{
  ...
  script_name(english:"PHP 7.3.x < 7.3.33");

  script_set_attribute(attribute:"synopsis", value:
"The version PHP running on the remote web server is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of PHP installed on the remote host is prior to 7.3.33. It is, therefore, affected by a vulnerability as
referenced in the Version 7.3.33 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://php.net/ChangeLog-7.php#7.3.33");
...
var constraints = [
  { 'min_version' : '7.3.0alpha1', 'fixed_version' : '7.3.33' }
];
