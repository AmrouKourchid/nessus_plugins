...
# SUSE update advisory SUSE-SU-2021:2361-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2021-0512", "CVE-2021-23133");
  script_xref(name:"SuSE", value:"SUSE-SU-2021:2361-1");

  script_name(english:"SUSE SLES12 / SLES15 Security Update : kernel (Live Patch 11 for SLE 12 SP5) (SUSE-SU-2021:2361-1)");
...
referenced in the SUSE-SU-2021:2361-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2021-July/009148.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5c373a62");
  script_set_attribute(attribute:"solution", value:
"Update the affected kernel-livepatch-4_12_14-197_75-default, kernel-livepatch-5_3_18-24_43-default and / or kgraft-
patch-4_12_14-122_46-default packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:suse_linux:kernel-livepatch-4_12_14-197_75-default");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:suse_linux:kernel-livepatch-5_3_18-24_43-default");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:suse_linux:kgraft-patch-4_12_14-122_46-default");
...
var pkgs = [
    {'reference':'kgraft-patch-4_12_14-122_46-default-10-2.2', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.5']},
    {'reference':'kernel-livepatch-4_12_14-197_75-default-8-2.2', 'sp':'1', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.1']},
    {'reference':'kernel-livepatch-5_3_18-24_43-default-8-2.2', 'sp':'2', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.2']}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kernel-livepatch-4_12_14-197_75-default / etc');
}
