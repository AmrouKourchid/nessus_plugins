...
# extracted from Fedora Security Advisory FEDORA-2019-019c5314a0.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : 2:samba (2019-019c5314a0)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-019c5314a0");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"samba-4.8.11-0.fc28", epoch:"2")) flag++;
