...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.1 : sysstat (EulerOS-SA-2023-2971)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2971
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6994aec1");
...
var pkgs = [
  "sysstat-12.1.6-2.h5.eulerosv2r9"
];
