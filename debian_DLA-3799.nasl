...
# extracted from Debian Security Advisory dla-3799. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3799 : trafficserver - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3799
advisory.
...
var pkgs = [
    {'release': '10.0', 'prefix': 'trafficserver', 'reference': '8.1.7-0+deb10u4'},
    {'release': '10.0', 'prefix': 'trafficserver-dev', 'reference': '8.1.7-0+deb10u4'},
    {'release': '10.0', 'prefix': 'trafficserver-experimental-plugins', 'reference': '8.1.7-0+deb10u4'}
];
