...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.1 : qemu-kvm (EulerOS-SA-2018-1268)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1268
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7141abaf");
...
pkgs = ["qemu-kvm-2.8.1-25.139",
        "qemu-kvm-common-2.8.1-25.139",
        "qemu-kvm-tools-2.8.1-25.139"];
