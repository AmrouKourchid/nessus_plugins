...
# extracted from Red Hat Security Advisory RHSA-2022:4870 and
# CentOS Errata and Security Advisory 2022:4870 respectively.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : firefox (RHSA-2022:4870)");
...
var pkgs = [
    {'reference':'firefox-91.10.0-1.el7.centos', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-91.10.0-1.el7.centos', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
