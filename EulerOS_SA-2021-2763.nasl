...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.0 : qemu (EulerOS-SA-2021-2763)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2763
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?26f78357");
...
var pkgs = [
  "qemu-4.1.0-2.9.1.2.329",
  "qemu-img-4.1.0-2.9.1.2.329"
];
