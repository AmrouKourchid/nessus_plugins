...
# extracted from Fedora Security Advisory FEDORA-2024-3914113f25
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-3914113f25");

  script_name(english:"Fedora 39 : atril (2024-3914113f25)");
...
FEDORA-2024-3914113f25 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-3914113f25");
...
var pkgs = [
    {'reference':'atril-1.26.2-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
