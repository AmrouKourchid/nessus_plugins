...
ELSA-2015-2552 advisory.
    ...
    - [x86] virt: guest to host DoS by triggering an infinite loop in microcode (Paolo Bonzini) [1277560
    1277561] {CVE-2015-5307}
...
var pkgs = [
    ...
    {'reference':'kernel-abi-whitelists-3.10.0-327.3.1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-abi-whitelists-3.10.0'},
