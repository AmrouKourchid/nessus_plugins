...
# extracted from openSUSE Security Update openSUSE-2019-839.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : hostapd (openSUSE-2019-839)");
...
if ( rpm_check(release:"SUSE15.0", reference:"hostapd-2.6-lp150.2.3.2") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"hostapd-debuginfo-2.6-lp150.2.3.2") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"hostapd-debugsource-2.6-lp150.2.3.2") ) flag++;
