...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : freetype (EulerOS-SA-2023-3429)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the freetype packages installed, the EulerOS Virtualization installation on the remote host
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3429
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?533d6a5f");
...
var pkgs = [
  "freetype-2.9.1-2.h3.eulerosv2r8",
  "freetype-devel-2.9.1-2.h3.eulerosv2r8"
];
