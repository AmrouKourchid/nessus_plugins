...
# extracted from Fedora Security Advisory FEDORA-2024-1b36a483cc
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-1b36a483cc");

  script_name(english:"Fedora 40 : frr (2024-1b36a483cc)");
...
FEDORA-2024-1b36a483cc advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-1b36a483cc");
...
var pkgs = [
    {'reference':'frr-9.1.1-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
