...
# extracted from Ubuntu Security Notice USN-6482-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6482-1");

  script_name(english:"Ubuntu 20.04 LTS : Quagga vulnerabilities (USN-6482-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 20.04 LTS host has packages installed that are affected by multiple vulnerabilities as referenced in
the USN-6482-1 advisory.

    It was discovered that Quagga incorrectly handled certain BGP messages. A remote attacker could possibly
    use this issue to cause Quagga to crash, resulting in a denial of service.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6482-1");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'quagga', 'pkgver': '1.2.4-4ubuntu0.4'},
    {'osver': '20.04', 'pkgname': 'quagga-bgpd', 'pkgver': '1.2.4-4ubuntu0.4'},
    {'osver': '20.04', 'pkgname': 'quagga-core', 'pkgver': '1.2.4-4ubuntu0.4'},
    {'osver': '20.04', 'pkgname': 'quagga-isisd', 'pkgver': '1.2.4-4ubuntu0.4'},
    {'osver': '20.04', 'pkgname': 'quagga-ospf6d', 'pkgver': '1.2.4-4ubuntu0.4'},
    {'osver': '20.04', 'pkgname': 'quagga-ospfd', 'pkgver': '1.2.4-4ubuntu0.4'},
    {'osver': '20.04', 'pkgname': 'quagga-pimd', 'pkgver': '1.2.4-4ubuntu0.4'},
    {'osver': '20.04', 'pkgname': 'quagga-ripd', 'pkgver': '1.2.4-4ubuntu0.4'},
    {'osver': '20.04', 'pkgname': 'quagga-ripngd', 'pkgver': '1.2.4-4ubuntu0.4'}
];
