...
if (description)
{
  ...
  script_name(english:"RHEL 7 / 8 : OpenShift Container Platform 4.10.56 (RHSA-2023:1655)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for OpenShift Container Platform 4.10.56.");
...
referenced in the RHSA-2023:1655 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.10.56. See the
    ...
    * spring-security: Authorization rules can be bypassed via forward or include dispatcher types in Spring
    Security (CVE-2022-31692)
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?32e98dfd");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2162200");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2162206");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2164278");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2177626");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2177629");
...
"Update the RHEL OpenShift Container Platform 4.10.56 package based on the guidance in RHSA-2023:1655.");
  ...
  script_cwe_id(20, 79, 200, 266, 269, 378, 444, 863, 918, 1188);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'haproxy22-2.2.19-4.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2023-25725']},
      {'reference':'jenkins-2-plugins-4.10.1680703106-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2022-42889', 'CVE-2023-24422']},
      {'reference':'jenkins-2.387.1.1680701869-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2022-31690', 'CVE-2022-31692', 'CVE-2023-27898', 'CVE-2023-27899', 'CVE-2023-27903', 'CVE-2023-27904']},
      {'reference':'openshift-hyperkube-4.10.0-202303221742.p0.g16bcd69.assembly.stream.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2022-3172']}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'openshift-hyperkube-4.10.0-202303221742.p0.g16bcd69.assembly.stream.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2022-3172']}
    ]
  }
];
