...
# extracted from Fedora Security Advisory FEDORA-2018-d0bac4ff3b.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-d0bac4ff3b");

  script_name(english:"Fedora 29 : 1:gitolite3 (2018-d0bac4ff3b)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-d0bac4ff3b");
  script_set_attribute(attribute:"solution", value:
"Update the affected 1:gitolite3 package.");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"gitolite3-3.6.9-1.fc29", epoch:"1")) flag++;
