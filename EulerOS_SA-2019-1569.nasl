...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : dovecot (EulerOS-SA-2019-1569)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1569
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?458306e7");
...
pkgs = ["dovecot-2.2.10-5.h3",
        "dovecot-mysql-2.2.10-5.h3",
        "dovecot-pgsql-2.2.10-5.h3",
        "dovecot-pigeonhole-2.2.10-5.h3"];
