...
if (description)
{
  ...
  script_name(english:"Canonical Ubuntu Linux SEoL (16.04.x)");
...
contain security vulnerabilities.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cdd15280");
...
"Upgrade to a version of Canonical Ubuntu Linux that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2021/04/30");
...
var constraints = [
  { max_branch : '16.04', min_branch : '16.04', eseol : 20280423, seol : 20210430 }
];
