...
ELSA-2020-4059 advisory.
    ...
    - Resolves: bz#1869708
      (CVE-2020-14364 qemu-kvm: QEMU: usb: out-of-bounds r/w access issue while processing usb packets
    [rhel-8.2.0.z])
    - Resolves: bz#1838092
      (CVE-2020-10756 virt:8.2/qemu-kvm: QEMU: slirp: networking out-of-bounds read information disclosure
    vulnerability [rhel-av-8])
    - Resolves: bz#1867075
      (CVE-2020-10756 virt:8.3/qemu-kvm: QEMU: slirp: networking out-of-bounds read information disclosure
    vulnerability [rhel-av-8])
...
var appstreams = {
    'virt-devel:ol': [
      ...
      {'reference':'qemu-kvm-tests-2.12.0-99.0.1.module+el8.2.0+7798+88bea828.4', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
    ...
    'virt:ol': [
      ...
      {'reference':'qemu-guest-agent-2.12.0-99.0.1.module+el8.2.0+7798+88bea828.4', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
      {'reference':'qemu-img-2.12.0-99.0.1.module+el8.2.0+7798+88bea828.4', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
      {'reference':'qemu-kvm-2.12.0-99.0.1.module+el8.2.0+7798+88bea828.4', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
      {'reference':'qemu-kvm-block-curl-2.12.0-99.0.1.module+el8.2.0+7798+88bea828.4', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
      {'reference':'qemu-kvm-block-gluster-2.12.0-99.0.1.module+el8.2.0+7798+88bea828.4', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
      {'reference':'qemu-kvm-block-iscsi-2.12.0-99.0.1.module+el8.2.0+7798+88bea828.4', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
      {'reference':'qemu-kvm-block-rbd-2.12.0-99.0.1.module+el8.2.0+7798+88bea828.4', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
      {'reference':'qemu-kvm-block-ssh-2.12.0-99.0.1.module+el8.2.0+7798+88bea828.4', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
      {'reference':'qemu-kvm-common-2.12.0-99.0.1.module+el8.2.0+7798+88bea828.4', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
      {'reference':'qemu-kvm-core-2.12.0-99.0.1.module+el8.2.0+7798+88bea828.4', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
