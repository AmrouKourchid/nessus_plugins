...
# extracted from SUSE update advisory SUSE-SU-2020:3133-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : opensc (SUSE-SU-2020:3133-1)");
...
CVE-2019-6502: Fixed a memory leak in sc_context_create()
(bsc#1122756).
...
without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=1122756");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?993cbee9");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"5", reference:"opensc-0.13.0-3.6.27")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"opensc-debuginfo-0.13.0-3.6.27")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"opensc-debugsource-0.13.0-3.6.27")) flag++;
