...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'keepalived-1.3.5-3.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'keepalived-debuginfo-1.3.5-3.ph2')) flag++;
