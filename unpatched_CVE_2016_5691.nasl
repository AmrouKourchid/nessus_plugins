...
if (description)
{
  ...
  script_cve_id("CVE-2016-5691");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2016-5691");
...
patch available.
  ...
  - The DCM reader in ImageMagick before 6.9.4-5 and 7.x before 7.0.1-7 allows remote attackers to have
    unspecified impact by leveraging lack of validation of (1) pixel.red, (2) pixel.green, and (3) pixel.blue.
    (CVE-2016-5691)
