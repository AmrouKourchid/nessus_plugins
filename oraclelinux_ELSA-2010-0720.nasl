...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : mikmod (ELSA-2010-0720)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2010-0720.html");
  script_set_attribute(attribute:"solution", value:
"Update the affected mikmod and / or mikmod-devel packages.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:F/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:N/UI:R/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:F/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2009-3996");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2009-3995");
...
var pkgs = [
    {'reference':'mikmod-3.1.6-39.el5_5.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'mikmod-devel-3.1.6-39.el5_5.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'mikmod-3.1.6-39.el5_5.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'mikmod-devel-3.1.6-39.el5_5.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
