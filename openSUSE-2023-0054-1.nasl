...
# openSUSE Security Update openSUSE-SU-2023:0054-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : jhead (openSUSE-SU-2023:0054-1)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d183a544");
...
var pkgs = [
    {'reference':'jhead-3.06.0.1-bp154.2.9.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE}
];
