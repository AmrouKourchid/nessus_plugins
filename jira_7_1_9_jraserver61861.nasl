...
if (description)
{
  ...
  script_cve_id("CVE-2016-4318");
  script_bugtraq_id(97516);

  script_name(english:"Atlassian Jira < 7.1.9 Role Name XSS (JRASERVER-61861)");
...
prior to 7.1.9. It is, therefore, affected by a persistent cross-site scripting (XSS) vulnerability in the 
/project/ViewDefaultProjectRoleActors.jspa resource, due to improper validation of user-supplied input before returning
it to users. An authenticated, remote attacker can exploit this, by convincing a user to click a specially crafted URL,
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a1e0f034");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?36651058");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Atlassian Jira version 7.1.9 or later.");
  script_set_attribute(attribute:"agent", value:"all");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:S/C:N/I:P/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:H/UI:R/S:C/C:L/I:L/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-4318");
