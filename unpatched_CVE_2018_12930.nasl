...
if (description)
{
  ...
  script_cve_id("CVE-2018-12930");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2018-12930");
...
patch available.
  ...
  - ntfs_end_buffer_async_read in the ntfs.ko filesystem driver in the Linux kernel 4.15.0 allows attackers to
    trigger a stack-based out-of-bounds write and cause a denial of service (kernel oops or panic) or possibly
    have unspecified other impact via a crafted ntfs filesystem. (CVE-2018-12930)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-12930");
