...
# extracted from Fedora Security Advisory FEDORA-2024-1178c53bb1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-1178c53bb1");

  script_name(english:"Fedora 41 : chromium (2024-1178c53bb1)");
...
FEDORA-2024-1178c53bb1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-1178c53bb1");
...
var pkgs = [
    {'reference':'chromium-130.0.6723.69-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
