...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Containerd PHSA-2023-5.0-0010");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'containerd-1.6.21-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'containerd-doc-1.6.21-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'containerd-extras-1.6.21-1.ph5')) flag++;
