...
if (description)
{
  ...
  script_name(english:"IBM WebSphere Application Server 9.x < 9.0.5.12 Clickjacking");

  script_set_attribute(attribute:"synopsis", value:
"The remote web application server is vulnerable to clickjacking.");
  script_set_attribute(attribute:"description", value:
"The IBM WebSphere Application Server running on the remote host is 9.x prior to 9.0.5.12. It is, therefore, affected by
a clickjacking vulnerability. By persuading a victim to visit a malicious Web site, a remote attacker could exploit this
vulnerability to hijack the victim's click actions and possibly launch further attacks against the victim.
...
"Update to IBM WebSphere Application Server version 9.0.5.12 or later. Alternatively, upgrade to the minimal fix pack
levels required by the interim fix and then apply Interim Fix PH43760.");
...
vcf::check_version_and_report(app_info:app_info, constraints:constraints, require_paranoia:require_paranoia, severity:SECURITY_NOTE);
