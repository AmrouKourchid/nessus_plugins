...
# extracted from Fedora Security Advisory FEDORA-2023-1b99669138
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-1b99669138");

  script_name(english:"Fedora 37 : chromium (2023-1b99669138)");
...
FEDORA-2023-1b99669138 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-1b99669138");
...
var pkgs = [
    {'reference':'chromium-114.0.5735.133-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
