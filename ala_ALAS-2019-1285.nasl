...
# extracted from Amazon Linux AMI Security Advisory ALAS-2019-1285.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2019-1285");

  script_name(english:"Amazon Linux AMI : zsh (ALAS-2019-1285)");
...
one.(CVE-2018-13259)");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/ALAS-2019-1285.html");
...
flag = 0;
if (rpm_check(release:"ALA", reference:"zsh-5.0.2-33.18.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"zsh-debuginfo-5.0.2-33.18.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"zsh-html-5.0.2-33.18.amzn1")) flag++;
