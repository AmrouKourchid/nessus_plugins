...
# extracted from Fedora Security Advisory FEDORA-2025-9e6d18cb4f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-9e6d18cb4f");
  script_xref(name:"IAVA", value:"2025-A-0279-S");

  script_name(english:"Fedora 41 : thunderbird (2025-9e6d18cb4f)");
...
FEDORA-2025-9e6d18cb4f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-9e6d18cb4f");
...
var pkgs = [
    {'reference':'thunderbird-128.9.2-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
