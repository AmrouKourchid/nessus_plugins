...
# extracted from Fedora Security Advisory FEDORA-2024-d20163632f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-d20163632f");

  script_name(english:"Fedora 40 : djvulibre (2024-d20163632f)");
...
FEDORA-2024-d20163632f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-d20163632f");
...
var pkgs = [
    {'reference':'djvulibre-3.5.28-9.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
