...
# Rocky Linux Security Advisory RLSA-2024:1435.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2024:1435");

  script_name(english:"Rocky Linux 8 : postgresql-jdbc (RLSA-2024:1435)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Rocky Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Rocky Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
RLSA-2024:1435 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2024:1435");
...
"Update the affected postgresql-jdbc and / or postgresql-jdbc-javadoc packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:rocky:linux:postgresql-jdbc");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:rocky:linux:postgresql-jdbc-javadoc");
