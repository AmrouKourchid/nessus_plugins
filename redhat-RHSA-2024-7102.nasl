...
# extracted from Red Hat Security Advisory RHSA-2024:7102. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:7102");

  script_name(english:"RHEL 9 : grafana (RHSA-2024:7102)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_7102.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c5cda904");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:7102");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL grafana package based on the guidance in RHSA-2024:7102.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'grafana-7.5.11-7.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
