...
if (description)
{
  ...
  script_cve_id("CVE-2023-0286", "CVE-2023-0767", "CVE-2023-24329");

  script_name(english:"Nutanix AHV : Multiple Vulnerabilities (NXSA-AHV-20220304.423)");

  script_set_attribute(attribute:"synopsis", value:
"The Nutanix AHV host is affected by multiple vulnerabilities .");
  script_set_attribute(attribute:"description", value:
"The version of AHV installed on the remote host is prior to 20220304.423. It is, therefore, affected by multiple
vulnerabilities as referenced in the NXSA-AHV-20220304.423 advisory.
...
number.");
  # https://portal.nutanix.com/page/documents/security-advisories/release-advisories/details?id=NXSA-AHV-20220304.423
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?99b4db98");
...
var constraints = [
  { 'fixed_version' : '20220304.423', 'product' : 'AHV', 'fixed_display' : 'Upgrade the AHV install to 20220304.423 or higher.' }
];
