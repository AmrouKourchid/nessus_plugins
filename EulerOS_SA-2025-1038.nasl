...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : ghostscript (EulerOS-SA-2025-1038)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1038
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bc70e72c");
...
var pkgs = [
  "ghostscript-9.52-1.h16.eulerosv2r9",
  "ghostscript-help-9.52-1.h16.eulerosv2r9"
];
