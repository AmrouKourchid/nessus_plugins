...
# extracted from Debian Security Advisory dsa-5633. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5633 : knot-resolver - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-46317");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bookworm/knot-resolver");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'knot-resolver', 'reference': '5.6.0-1+deb12u1'},
    {'release': '12.0', 'prefix': 'knot-resolver-doc', 'reference': '5.6.0-1+deb12u1'},
    {'release': '12.0', 'prefix': 'knot-resolver-module-http', 'reference': '5.6.0-1+deb12u1'}
];
