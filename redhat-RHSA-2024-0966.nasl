...
# extracted from Red Hat Security Advisory RHSA-2024:0966. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:0966");

  script_name(english:"RHEL 9 : opensc (RHSA-2024:0966)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0966.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d26c1255");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2248685");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0966");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL opensc package based on the guidance in RHSA-2024:0966.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'opensc-0.23.0-4.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
