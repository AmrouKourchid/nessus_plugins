...
# extracted from Debian Security Advisory dla-3506. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3506 : iperf3 - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3506
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-38403");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/iperf3");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'iperf3', 'reference': '3.6-2+deb10u1'},
    {'release': '10.0', 'prefix': 'libiperf-dev', 'reference': '3.6-2+deb10u1'},
    {'release': '10.0', 'prefix': 'libiperf0', 'reference': '3.6-2+deb10u1'}
];
