...
# extracted from Amazon Linux 2 Security Advisory ALAS-2025-2730.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : rsync (ALAS-2025-2730)");
...
vulnerabilities as referenced in the ALAS2-2025-2730 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2025-2730.html");
...
var pkgs = [
    {'reference':'rsync-3.1.2-11.amzn2.0.3', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rsync-3.1.2-11.amzn2.0.3', 'cpu':'i686', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rsync-3.1.2-11.amzn2.0.3', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rsync-debuginfo-3.1.2-11.amzn2.0.3', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rsync-debuginfo-3.1.2-11.amzn2.0.3', 'cpu':'i686', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rsync-debuginfo-3.1.2-11.amzn2.0.3', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
