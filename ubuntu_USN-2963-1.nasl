...
# extracted from Ubuntu Security Notice USN-2963-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"2963-1");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2023/06/02");

  script_name(english:"Ubuntu 16.04 LTS : OpenJDK 8 vulnerabilities (USN-2963-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 16.04 LTS host has packages installed that are affected by multiple vulnerabilities as referenced in
the USN-2963-1 advisory.
    ...
    sensitive data over the network, or possibly execute arbitrary code. (CVE-2016-0686, CVE-2016-0687,
    CVE-2016-3427)

    Multiple vulnerabilities were discovered in the OpenJDK JRE related to information disclosure. An attacker
    could exploit this to expose sensitive data over the network. (CVE-2016-0695, CVE-2016-3426)

    A vulnerability was discovered in the OpenJDK JRE related to availability. An attacker could exploit this
    to cause a denial of service. (CVE-2016-3425)

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2963-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'openjdk-8-demo', 'pkgver': '8u91-b14-0ubuntu4~16.04.1'},
    {'osver': '16.04', 'pkgname': 'openjdk-8-jdk', 'pkgver': '8u91-b14-0ubuntu4~16.04.1'},
    {'osver': '16.04', 'pkgname': 'openjdk-8-jdk-headless', 'pkgver': '8u91-b14-0ubuntu4~16.04.1'},
    {'osver': '16.04', 'pkgname': 'openjdk-8-jre', 'pkgver': '8u91-b14-0ubuntu4~16.04.1'},
    {'osver': '16.04', 'pkgname': 'openjdk-8-jre-headless', 'pkgver': '8u91-b14-0ubuntu4~16.04.1'},
    {'osver': '16.04', 'pkgname': 'openjdk-8-jre-jamvm', 'pkgver': '8u91-b14-0ubuntu4~16.04.1'},
    {'osver': '16.04', 'pkgname': 'openjdk-8-jre-zero', 'pkgver': '8u91-b14-0ubuntu4~16.04.1'},
    {'osver': '16.04', 'pkgname': 'openjdk-8-source', 'pkgver': '8u91-b14-0ubuntu4~16.04.1'}
];
