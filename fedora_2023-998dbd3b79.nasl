...
# extracted from Fedora Security Advisory FEDORA-2023-998dbd3b79
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-998dbd3b79");

  script_name(english:"Fedora 36 : podman (2023-998dbd3b79)");
...
FEDORA-2023-998dbd3b79 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-998dbd3b79");
...
var pkgs = [
    {'reference':'podman-4.4.1-3.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'epoch':'5'}
];
