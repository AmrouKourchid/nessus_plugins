...
# Rocky Linux Security Advisory RLSA-2021:4221.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2021:4221");

  script_name(english:"Rocky Linux 8 : container-tools:2.0 (RLSA-2021:4221)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Rocky Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Rocky Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
RLSA-2021:4221 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2021:4221");
...
var appstreams = {
    'container-tools:2.0': [
      {'reference':'buildah-1.11.6-9.module+el8.5.0+708+6758137d', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'buildah-1.11.6-9.module+el8.5.0+708+6758137d', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'buildah-debuginfo-1.11.6-9.module+el8.5.0+708+6758137d', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'buildah-debuginfo-1.11.6-9.module+el8.5.0+708+6758137d', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'buildah-debugsource-1.11.6-9.module+el8.5.0+708+6758137d', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'buildah-debugsource-1.11.6-9.module+el8.5.0+708+6758137d', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'buildah-tests-1.11.6-9.module+el8.5.0+708+6758137d', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'buildah-tests-1.11.6-9.module+el8.5.0+708+6758137d', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'buildah-tests-debuginfo-1.11.6-9.module+el8.5.0+708+6758137d', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'buildah-tests-debuginfo-1.11.6-9.module+el8.5.0+708+6758137d', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
