...
if (description)
{
  ...
  script_cve_id("CVE-2008-0720");
  script_bugtraq_id(27662);

  script_name(english:"Webmin 1.370 / 1.390 webmin_search.cgi Cross Site Scripting");
...
the remote host is 1.370 or 1.390. It is, therefore, affected by 
a cross site scripting vulnerability in webmin_search.cgi");
  script_set_attribute(attribute:"see_also", value:"https://www.securityfocus.com/bid/27662");
  script_set_attribute(attribute:"see_also", value:"http://www.webmin.com/changes.html");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Webmin 1.400 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:N/I:P/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:U/RC:ND");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:R/S:C/C:N/I:L/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2008-0720");
...
if (ver_compare(ver:version, fix:"1.370", strict:FALSE) == 0 || ver_compare(ver:version, fix:"1.390", strict:FALSE) == 0)
{
  report =
    '\n  URL               : ' + install_url +
