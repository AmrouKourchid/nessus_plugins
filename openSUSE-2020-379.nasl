...
# extracted from openSUSE Security Update openSUSE-2020-379.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : nghttp2 (openSUSE-2020-379)");
...
This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1159003");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1166481");
...
if ( rpm_check(release:"SUSE15.1", reference:"libnghttp2-14-1.40.0-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libnghttp2-14-debuginfo-1.40.0-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libnghttp2-devel-1.40.0-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libnghttp2_asio-devel-1.40.0-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libnghttp2_asio1-1.40.0-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libnghttp2_asio1-debuginfo-1.40.0-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"nghttp2-1.40.0-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"nghttp2-debuginfo-1.40.0-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"nghttp2-debugsource-1.40.0-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"nghttp2-python-debugsource-1.40.0-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"python3-nghttp2-1.40.0-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"python3-nghttp2-debuginfo-1.40.0-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libnghttp2-14-32bit-1.40.0-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libnghttp2-14-32bit-debuginfo-1.40.0-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libnghttp2_asio1-32bit-1.40.0-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libnghttp2_asio1-32bit-debuginfo-1.40.0-lp151.3.6.1") ) flag++;
