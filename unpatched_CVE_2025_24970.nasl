...
if (description)
{
  ...
  script_cve_id("CVE-2025-24970");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2025-24970 (deprecated)");
...
"n/a");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2025-24970");
