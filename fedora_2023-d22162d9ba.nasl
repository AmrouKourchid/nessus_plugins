...
# extracted from Fedora Security Advisory FEDORA-2023-d22162d9ba
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-d22162d9ba");

  script_name(english:"Fedora 38 : mingw-dbus (2023-d22162d9ba)");
...
FEDORA-2023-d22162d9ba advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-d22162d9ba");
  script_set_attribute(attribute:"solution", value:
"Update the affected mingw-dbus package.");
...
var pkgs = [
    {'reference':'mingw-dbus-1.14.8-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
