...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Polkit PHSA-2022-4.0-0147");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'polkit-0.120-2.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'polkit-devel-0.120-2.ph4')) flag++;
