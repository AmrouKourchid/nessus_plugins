...
of arbitrary code if malformed documents are opened.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2018/dsa-4334");
...
in version 1.9a+ds1-4+deb9u4.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-17866");
