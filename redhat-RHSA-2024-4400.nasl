...
# extracted from Red Hat Security Advisory RHSA-2024:4400. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:4400");

  script_name(english:"RHEL 8 : booth (RHSA-2024:4400)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for booth.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:4400 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_4400.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0dbcfa9a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2272082");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:4400");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL booth package based on the guidance in RHSA-2024:4400.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'booth-1.0-199.1.ac1d34c.git.el8_6.2', 'sp':'6', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'booth-1.0-199.1.ac1d34c.git.el8_6.2', 'sp':'6', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'booth-arbitrator-1.0-199.1.ac1d34c.git.el8_6.2', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'booth-core-1.0-199.1.ac1d34c.git.el8_6.2', 'sp':'6', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'booth-core-1.0-199.1.ac1d34c.git.el8_6.2', 'sp':'6', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'booth-site-1.0-199.1.ac1d34c.git.el8_6.2', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'booth-test-1.0-199.1.ac1d34c.git.el8_6.2', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
