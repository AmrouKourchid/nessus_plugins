...
# extracted from Fedora Security Advisory FEDORA-2023-d19ccfc5b0
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-d19ccfc5b0");

  script_name(english:"Fedora 40 : godot (2023-d19ccfc5b0)");
...
FEDORA-2023-d19ccfc5b0 advisory.
    ...
    ```
    * Thu Oct 12 2023 Rmi Verschelde <akien@fedoraproject.org> - 4.1.2-1
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-d19ccfc5b0");
...
var pkgs = [
    {'reference':'godot-4.1.2-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
