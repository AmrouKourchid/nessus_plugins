...
# extracted from Fedora Security Advisory FEDORA-2025-736781dc2a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-736781dc2a");

  script_name(english:"Fedora 41 : podman-tui (2025-736781dc2a)");
...
FEDORA-2025-736781dc2a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-736781dc2a");
...
var pkgs = [
    {'reference':'podman-tui-1.4.0-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
