...
# extracted from Fedora Security Advisory FEDORA-2024-d05d37ead7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-d05d37ead7");

  script_name(english:"Fedora 40 : python-django4.2 (2024-d05d37ead7)");
...
FEDORA-2024-d05d37ead7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-d05d37ead7");
...
var pkgs = [
    {'reference':'python-django4.2-4.2.14-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
