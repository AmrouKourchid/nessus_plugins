...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : Moderate: / aide (ELSA-2007-0539)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2007-0539.html");
...
"Update the affected aide package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2007-3849");
...
var pkgs = [
    {'reference':'aide-0.13.1-2.0.4.el5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'aide-0.13.1-2.0.4.el5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
