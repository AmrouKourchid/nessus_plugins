...
if (description)
{
  ...
  script_cve_id("CVE-2022-31213");

  script_name(english:"CentOS 9 : dbus-broker-28-7.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update for dbus-broker.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 9 host has a package installed that is affected by a vulnerability as referenced in the dbus-
broker-28-7.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=24667");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream dbus-broker package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:dbus-broker");
...
var pkgs = [
    {'reference':'dbus-broker-28-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
