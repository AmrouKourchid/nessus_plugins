...
if (description)
{
  ...
  script_name(english:"RHEL 8 / 9 : OpenShift Container Platform 4.12.6 (RHSA-2023:1033)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for OpenShift Container Platform 4.12.6.");
...
in the RHSA-2023:1033 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.12.6. See the following
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_1033.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8c1ef967");
...
"Update the RHEL OpenShift Container Platform 4.12.6 packages based on the guidance in RHSA-2023:1033.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cri-o-1.25.2-10.rhaos4.12.git0a083f9.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'cri-o-1.25.2-9.rhaos4.12.git0a083f9.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
