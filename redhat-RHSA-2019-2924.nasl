...
# extracted from Red Hat Security Advisory RHSA-2019:2924. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:2924");

  script_name(english:"RHEL 7 : redhat-virtualization-host (RHSA-2019:2924)");
...
the RHSA-2019:2924 advisory.
    ...
    (4.2), redhat-virtualization-host (4.2). (BZ#1751435)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_2924.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1e8ea0ec");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/vulnerabilities/kernel-vhost");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1750351");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1750727");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:2924");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL redhat-virtualization-host package based on the guidance in RHSA-2019:2924.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'redhat-virtualization-host-image-update-4.2-20190919.0.el7_6', 'release':'7', 'el_string':'el7_6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'}
    ]
  }
];
