...
# extracted from Fedora Security Advisory FEDORA-2023-ffaebb1e10
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-ffaebb1e10");

  script_name(english:"Fedora 38 : radare2 (2023-ffaebb1e10)");
...
FEDORA-2023-ffaebb1e10 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-ffaebb1e10");
...
var pkgs = [
    {'reference':'radare2-5.8.8-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
