...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : php (EulerOS-SA-2019-1334)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1334
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?26db8782");
...
pkgs = ["php-5.4.16-45.h9.eulerosv2r7",
        "php-cli-5.4.16-45.h9.eulerosv2r7",
        "php-common-5.4.16-45.h9.eulerosv2r7",
        "php-gd-5.4.16-45.h9.eulerosv2r7",
        "php-ldap-5.4.16-45.h9.eulerosv2r7",
        "php-mysql-5.4.16-45.h9.eulerosv2r7",
        "php-odbc-5.4.16-45.h9.eulerosv2r7",
        "php-pdo-5.4.16-45.h9.eulerosv2r7",
        "php-pgsql-5.4.16-45.h9.eulerosv2r7",
        "php-process-5.4.16-45.h9.eulerosv2r7",
        "php-recode-5.4.16-45.h9.eulerosv2r7",
        "php-soap-5.4.16-45.h9.eulerosv2r7",
        "php-xml-5.4.16-45.h9.eulerosv2r7",
        "php-xmlrpc-5.4.16-45.h9.eulerosv2r7"];
