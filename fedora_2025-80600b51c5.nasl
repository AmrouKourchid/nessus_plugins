...
# extracted from Fedora Security Advisory FEDORA-2025-80600b51c5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-80600b51c5");

  script_name(english:"Fedora 40 : mod_auth_openidc (2025-80600b51c5)");
...
FEDORA-2025-80600b51c5 advisory.

    REbase mod_auth_openidc-2.4.16.11 resolves CVE-2025-31492 - mod_auth_openidc allows
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-80600b51c5");
...
var pkgs = [
    {'reference':'mod_auth_openidc-2.4.16.11-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
