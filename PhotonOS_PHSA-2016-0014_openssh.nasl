...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Openssh PHSA-2016-0014");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'openssh-7.1p2-5.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'openssh-debuginfo-7.1p2-5.ph1')) flag++;
