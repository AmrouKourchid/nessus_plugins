...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'strongswan-5.5.1-2.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'strongswan-debuginfo-5.5.1-2.ph1')) flag++;
