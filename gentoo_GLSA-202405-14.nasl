...
# extracted from Gentoo Linux Security Advisory GLSA 202405-14.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202405-14 : QtWebEngine: Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202405-14 (QtWebEngine: Multiple Vulnerabilities)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202405-14");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=927746");
...
var packages = [
  {
    ...
    'unaffected' : make_list("ge 5.15.13_p20240322"),
    'vulnerable' : make_list("lt 5.15.13_p20240322")
  }
];
