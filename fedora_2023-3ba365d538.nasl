...
# extracted from Fedora Security Advisory FEDORA-2023-3ba365d538
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-3ba365d538");

  script_name(english:"Fedora 36 : clamav (2023-3ba365d538)");
...
FEDORA-2023-3ba365d538 advisory.
     ...
     *   CVE-2023-20032<https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2023-20032>: Fixed a possible
    remote code execution vulnerability in the HFS+ file parser. The issue affects versions 1.0.0 and earlier,
    0.105.1 and earlier, and 0.103.7 and earlier. Thank you to Simon Scannell for reporting this issue.

     *   CVE-2023-20052<https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2023-20052>: Fixed a possible
    remote information leak vulnerability in the DMG file parser. The issue affects versions 1.0.0 and
    earlier, 0.105.1 and earlier, and 0.103.7 and earlier. Thank you to Simon Scannell for reporting this
    issue.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-3ba365d538");
...
var pkgs = [
    {'reference':'clamav-0.103.8-3.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
