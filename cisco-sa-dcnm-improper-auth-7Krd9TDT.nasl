...
if (description)
{
  ...
  script_cve_id("CVE-2020-3386");
  script_xref(name:"CISCO-BUG-ID", value:"CSCvs78207");
  script_xref(name:"CISCO-SA", value:"cisco-sa-dcnm-improper-auth-7Krd9TDT");
  script_xref(name:"IAVA", value:"2020-A-0279-S");

  script_name(english:"Cisco Data Center Network Manager Improper Authorization (cisco-sa-dcnm-improper-auth-7Krd9TDT)");
...
vulnerability in the REST API due to insufficient authorization of certain API functions. An attacker can exploit this
vulnerability by sending a crafted request to the API using low-privileged credentials in order to perform arbitrary
actions through the REST API with administrative privileges.

Please see the included Cisco BID and Cisco Security Advisory for more information.");
  # https://tools.cisco.com/security/center/content/CiscoSecurityAdvisory/cisco-sa-dcnm-improper-auth-7Krd9TDT
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9d424285");
  script_set_attribute(attribute:"see_also", value:"https://bst.cloudapps.cisco.com/bugsearch/bug/CSCvs78207");
...
"Upgrade to the relevant fixed version referenced in Cisco bug ID CSCvs78207");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-3386");
