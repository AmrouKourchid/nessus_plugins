...
if (description)
{
  ...
  script_name(english:"Fortinet Fortigate - Path traversal vulnerability allows VDOM escaping (FG-IR-22-401)");
...
vulnerability as referenced in the FG-IR-22-401 advisory.

  - A relative path traversal vulnerability [CWE-23] in Fortinet FortiOS version 7.2.0 through 7.2.2, 7.0.0
    through 7.0.8 and before 6.4.11, FortiProxy version 7.2.0 through 7.2.2 and 7.0.0 through 7.0.8 allows
    privileged VDOM administrators to escalate their privileges to super admin of the box via crafted CLI
    requests. (CVE-2022-42476)
...
"Please upgrade to FortiProxy version 2.0.12/7.0.8/7.2.2 or later.");
