...
# extracted from Fedora Security Advisory FEDORA-2025-b1804b97fc
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-b1804b97fc");

  script_name(english:"Fedora 40 : chromium (2025-b1804b97fc)");
...
FEDORA-2025-b1804b97fc advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-b1804b97fc");
...
var pkgs = [
    {'reference':'chromium-136.0.7103.59-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
