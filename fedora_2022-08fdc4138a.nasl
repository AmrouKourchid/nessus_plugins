...
# extracted from Fedora Security Advisory FEDORA-2022-08fdc4138a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-08fdc4138a");

  script_name(english:"Fedora 37 : webkitgtk (2022-08fdc4138a)");
...
FEDORA-2022-08fdc4138a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-08fdc4138a");
...
var pkgs = [
    {'reference':'webkitgtk-2.38.2-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
