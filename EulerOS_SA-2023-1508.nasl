...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : libksba (EulerOS-SA-2023-1508)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1508
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7e65a364");
...
var pkgs = [
  "libksba-1.3.0-5.h2.eulerosv2r7"
];
