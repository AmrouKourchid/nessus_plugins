...
if (description)
{
  ...
  script_name(english:"RHEL 8 / 9 : OpenShift Container Platform 4.14.9 (RHSA-2024:0207)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for OpenShift Container Platform 4.14.9.");
...
referenced in the RHSA-2024:0207 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.14.9. See the following
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0207.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?86678aa5");
...
"Update the RHEL OpenShift Container Platform 4.14.9 packages based on the guidance in RHSA-2024:0207.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cri-o-1.27.2-7.rhaos4.14.git1cc7a64.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'cri-o-1.27.2-7.rhaos4.14.git1cc7a64.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
