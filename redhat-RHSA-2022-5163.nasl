...
# extracted from Red Hat Security Advisory RHSA-2022:5163. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_5163.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c8d992cc");
...
"Update the RHEL httpd:2.4 package based on the guidance in RHSA-2022:5163.");
  ...
  'httpd:2.4': [
    {
      ...
      'pkgs': [
        {'reference':'httpd-2.4.37-47.module+el8.6.0+15654+427eba2e.2', 'sp':'6', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'httpd-devel-2.4.37-47.module+el8.6.0+15654+427eba2e.2', 'sp':'6', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'httpd-filesystem-2.4.37-47.module+el8.6.0+15654+427eba2e.2', 'sp':'6', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'httpd-manual-2.4.37-47.module+el8.6.0+15654+427eba2e.2', 'sp':'6', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'httpd-tools-2.4.37-47.module+el8.6.0+15654+427eba2e.2', 'sp':'6', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mod_http2-1.15.7-5.module+el8.6.0+13996+01710940', 'sp':'6', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mod_ldap-2.4.37-47.module+el8.6.0+15654+427eba2e.2', 'sp':'6', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mod_md-2.0.8-8.module+el8.3.0+6814+67d1e611', 'sp':'6', 'release':'8', 'el_string':'el8.3.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'mod_proxy_html-2.4.37-47.module+el8.6.0+15654+427eba2e.2', 'sp':'6', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'mod_session-2.4.37-47.module+el8.6.0+15654+427eba2e.2', 'sp':'6', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mod_ssl-2.4.37-47.module+el8.6.0+15654+427eba2e.2', 'sp':'6', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
      ]
    },
    {
      'repo_relative_urls': [
      ...
      'pkgs': [
        {'reference':'httpd-2.4.37-47.module+el8.6.0+15654+427eba2e.2', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'httpd-devel-2.4.37-47.module+el8.6.0+15654+427eba2e.2', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'httpd-filesystem-2.4.37-47.module+el8.6.0+15654+427eba2e.2', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'httpd-manual-2.4.37-47.module+el8.6.0+15654+427eba2e.2', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'httpd-tools-2.4.37-47.module+el8.6.0+15654+427eba2e.2', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mod_http2-1.15.7-5.module+el8.6.0+13996+01710940', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mod_ldap-2.4.37-47.module+el8.6.0+15654+427eba2e.2', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mod_md-2.0.8-8.module+el8.3.0+6814+67d1e611', 'release':'8', 'el_string':'el8.3.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'mod_proxy_html-2.4.37-47.module+el8.6.0+15654+427eba2e.2', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'mod_session-2.4.37-47.module+el8.6.0+15654+427eba2e.2', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mod_ssl-2.4.37-47.module+el8.6.0+15654+427eba2e.2', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
      ]
    }
  ]
};
