...
if (description)
{
  ...
  script_name(english:"OpenJDK 7 <= 7u351 / 8 <= 8u342 / 11.0.0 <= 11.0.16 / 13.0.0 <= 13.0.12 / 15.0.0 <= 15.0.8 / 17.0.0 <= 17.0.4 / 19.0.0 <= 19.0.0 Multiple Vulnerabilities (2022-10-18");

  script_set_attribute(attribute:"synopsis", value:
"OpenJDK is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of OpenJDK installed on the remote host is prior to 7 <= 7u351 / 8 <= 8u342 / 11.0.0 <= 11.0.16 / 13.0.0 <=
13.0.12 / 15.0.0 <= 15.0.8 / 17.0.0 <= 17.0.4 / 19.0.0 <= 19.0.0. It is, therefore, affected by multiple vulnerabilities
as referenced in the 2022-10-18 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://openjdk.java.net/groups/vulnerability/advisories/2022-10-18");
  script_set_attribute(attribute:"solution", value:
"Upgrade to an OpenJDK version greater than 7u351 / 8u342 / 11.0.16 / 13.0.12 / 15.0.8 / 17.0.4 / 19.0.0");
...
var constraints = [
  { 'min_version' : '7.0.0', 'max_version' : '7.0.351', 'fixed_display' : 'Upgrade to a version greater than 7u351' },
  { 'min_version' : '8.0.0', 'max_version' : '8.0.342', 'fixed_display' : 'Upgrade to a version greater than 8u342' },
  { 'min_version' : '11.0.0', 'max_version' : '11.0.16', 'fixed_display' : 'Upgrade to a version greater than 11.0.16' },
  { 'min_version' : '13.0.0', 'max_version' : '13.0.12', 'fixed_display' : 'Upgrade to a version greater than 13.0.12' },
  { 'min_version' : '15.0.0', 'max_version' : '15.0.8', 'fixed_display' : 'Upgrade to a version greater than 15.0.8' },
  { 'min_version' : '17.0.0', 'max_version' : '17.0.4', 'fixed_display' : 'Upgrade to a version greater than 17.0.4' },
  { 'min_version' : '19.0.0', 'max_version' : '19.0.0', 'fixed_display' : 'Upgrade to a version greater than 19.0.0' }
];
