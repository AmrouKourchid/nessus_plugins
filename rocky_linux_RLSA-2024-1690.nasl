...
# Rocky Linux Security Advisory RLSA-2024:1690.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2024:1690");

  script_name(english:"Rocky Linux 8 : varnish (RLSA-2024:1690)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Rocky Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Rocky Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
RLSA-2024:1690 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2024:1690");
...
var pkgs = [
    {'reference':'varnish-6.0.13-1.module+el8.9.0+1777+0acf9965', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'varnish-6.0.13-1.module+el8.9.0+1777+0acf9965', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'varnish-devel-6.0.13-1.module+el8.9.0+1777+0acf9965', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'varnish-devel-6.0.13-1.module+el8.9.0+1777+0acf9965', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'varnish-docs-6.0.13-1.module+el8.9.0+1777+0acf9965', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'varnish-docs-6.0.13-1.module+el8.9.0+1777+0acf9965', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
