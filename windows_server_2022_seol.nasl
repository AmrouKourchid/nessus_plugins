...
if (description)
{
  ...
  script_name(english:"Microsoft Windows Server 2022 SEoL");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Microsoft Windows is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"Microsoft Windows Server 2022 is no longer maintained by its vendor or provider.

Lack of support implies that no new security patches for the product will be released by the vendor. As a result, it may
contain security vulnerabilities.");
  # https://learn.microsoft.com/en-us/lifecycle/products/windows-server-2022
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ad7148f3");
...
"Upgrade to a version of Microsoft Windows that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2031/10/31");
...
var os = ucf::get_os_cpe(vendor:'microsoft', product:'windows_server_2022', type:'local');
