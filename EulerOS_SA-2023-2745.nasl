...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.1 : sysstat (EulerOS-SA-2023-2745)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2745
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d259afab");
...
var pkgs = [
  "sysstat-12.5.4-1.h7.eulerosv2r11"
];
