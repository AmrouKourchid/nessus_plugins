...
# extracted from Fedora Security Advisory FEDORA-2024-bec5d0df1f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-bec5d0df1f");

  script_name(english:"Fedora 40 : python3.13 (2024-bec5d0df1f)");
...
FEDORA-2024-bec5d0df1f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-bec5d0df1f");
...
var pkgs = [
    {'reference':'python3.13-3.13.0~rc1-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
