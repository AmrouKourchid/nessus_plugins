...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : openjpeg (EulerOS-SA-2021-1220)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1220
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cbae7f0a");
...
pkgs = ["openjpeg-libs-1.5.1-17.h4.eulerosv2r7"];
