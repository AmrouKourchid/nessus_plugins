...
# Red Hat Security Advisory RHSA-2024:3343. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : xorg-x11-server-Xwayland (CESA-2024:3343)");
...
var pkgs = [
    {'reference':'xorg-x11-server-Xwayland-21.1.3-16.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xorg-x11-server-Xwayland-21.1.3-16.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
