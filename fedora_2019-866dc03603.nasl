...
# extracted from Fedora Security Advisory FEDORA-2019-866dc03603.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : knot-resolver (2019-866dc03603)");
...
"- update to upstream version 4.3.0
  ...
  - root.keys is moved to /var/lib/knot-resolver -
    knot-resolver no longer requires write permission to
    /etc/knot-resolver/
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-866dc03603");
...
"Update the affected knot-resolver package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-19331");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"knot-resolver-4.3.0-1.fc31")) flag++;
