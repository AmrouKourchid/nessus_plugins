...
# extracted from Amazon Linux AMI Security Advisory ALAS-2019-1300.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2019-1300");

  script_name(english:"Amazon Linux AMI : mod24_auth_openidc (ALAS-2019-1300)");
...
information by sending crafted HTTP requests. (CVE-2017-6413 )");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/ALAS-2019-1300.html");
...
flag = 0;
if (rpm_check(release:"ALA", reference:"mod24_auth_openidc-1.8.8-5.5.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"mod24_auth_openidc-debuginfo-1.8.8-5.5.amzn1")) flag++;
