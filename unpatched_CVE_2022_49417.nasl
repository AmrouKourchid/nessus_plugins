...
if (description)
{
  ...
  script_cve_id("CVE-2022-49417");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-49417");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: iwlwifi: mei: fix potential NULL-ptr
    deref If SKB allocation fails, continue rather than using the NULL pointer. Coverity CID: 1497650
    (CVE-2022-49417)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-49417");
