...
# extracted from Fedora Security Advisory FEDORA-2024-39f1a828ed
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-39f1a828ed");
  script_xref(name:"IAVA", value:"2024-A-0378-S");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2025/05/22");

  script_name(english:"Fedora 40 : httpd (2024-39f1a828ed)");
...
FEDORA-2024-39f1a828ed advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-39f1a828ed");
...
var pkgs = [
    {'reference':'httpd-2.4.61-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
