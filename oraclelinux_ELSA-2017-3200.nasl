...
ELSA-2017-3200 advisory.
    ...
    - [net] packet: fix tp_reserve race in packet_set_ring (Stefano Brivio) [1481941 1481943]
    {CVE-2017-1000111}
    - [net] packet: fix overflow in check for tp_frame_nr (Stefano Brivio) [1481941 1481943]
    {CVE-2017-1000111}
    - [net] packet: fix overflow in check for tp_reserve (Stefano Brivio) [1481941 1481943] {CVE-2017-1000111}
    - [net] tcp: initialize rcv_mss to TCP_MIN_MSS instead of 0 (Davide Caratti) [1488344 1488340]
    {CVE-2017-14106}
    ...
    ip6_finish_output (Davide Caratti) [1481532 1481529] {CVE-2017-1000112}
    - [net] ipv4: Should use consistent conditional judgement for ip fragment in __ip_append_data and
    ip_finish_output (Davide Caratti) [1481532 1481529] {CVE-2017-1000112}
...
var pkgs = [
    ...
    {'reference':'kernel-abi-whitelists-2.6.32-696.16.1.el6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-abi-whitelists-2.6.32'},
    ...
    {'reference':'kernel-firmware-2.6.32-696.16.1.el6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-firmware-2.6.32'},
    ...
    {'reference':'kernel-abi-whitelists-2.6.32-696.16.1.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-abi-whitelists-2.6.32'},
    ...
    {'reference':'kernel-firmware-2.6.32-696.16.1.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-firmware-2.6.32'},
