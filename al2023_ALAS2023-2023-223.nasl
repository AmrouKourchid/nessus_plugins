...
"It is, therefore, affected by a vulnerability as referenced in the ALAS2023-2023-223 advisory.
    ...
    A vulnerability was found in cups-filters. This security flaw occurs if you use beh to create an
    accessible network printer, possibly resulting in remote code execution. (CVE-2023-24805)
