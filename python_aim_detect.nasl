...
if (description)
{
  ...
  script_name(english:"AIM Detection");

  script_set_attribute(attribute:"synopsis", value:
"An AIM Python library is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"An AIM Python library is installed on the remote host. 

Note that Nessus has relied upon on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/aimhubio/aim");
  ...
  script_set_attribute(attribute:"cpe", value:"cpe:/a:aim:aim");
