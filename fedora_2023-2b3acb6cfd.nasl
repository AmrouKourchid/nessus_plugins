...
# extracted from Fedora Security Advisory FEDORA-2023-2b3acb6cfd
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-2b3acb6cfd");

  script_name(english:"Fedora 36 : git (2023-2b3acb6cfd)");
...
FEDORA-2023-2b3acb6cfd advisory.

    Update to 2.39.2 (CVE-2023-22490, CVE-2023-23946)

    Refer to the [upstream release
    notes](https://github.com/git/git/raw/v2.39.2/Documentation/RelNotes/2.30.8.txt) and the security
    advisories ([CVE-2023-22490](https://github.com/git/git/security/advisories/GHSA-gw92-x3fm-3g3q),
    [CVE-2023-23946](https://github.com/git/git/security/advisories/GHSA-r87m-v37r-cwfh)) for details.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-2b3acb6cfd");
...
var pkgs = [
    {'reference':'git-2.39.2-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
