...
"The remote Red Hat host is missing one or more security updates for OpenShift Container Platform 4.5.13 jenkins.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_3841.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?809f06a1");
...
"Update the RHEL OpenShift Container Platform 4.5.13 jenkins package based on the guidance in RHSA-2020:3841.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jenkins-2.235.5.1600414805-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
