...
# AlmaLinux Security Advisory ALSA-2023:4954.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:4954");
  script_xref(name:"IAVA", value:"2023-A-0449-S");

  script_name(english:"AlmaLinux 8 : thunderbird (ALSA-2023:4954)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2023-4954.html");
...
var pkgs = [
    {'reference':'thunderbird-102.15.0-1.el8_8.alma', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'thunderbird-102.15.0-1.el8_8.alma', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
