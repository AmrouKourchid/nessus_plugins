...
# extracted from Debian Security Advisory dla-3100. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3100 : libgoogle-gson-java - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has a package installed that is affected by a vulnerability as referenced in the dla-3100
advisory.

    -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3100-1                debian-lts@lists.debian.org
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/libgoogle-gson-java");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libgoogle-gson-java', 'reference': '2.8.5-3+deb10u1'}
];
