...
if (description)
{
  ...
  script_cve_id("CVE-2023-45919");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2023-45919");
...
patch available.
  ...
  - Mesa 23.0.4 was discovered to contain a buffer over-read in glXQueryServerString(). NOTE: this is disputed
    because there are no common situations in which users require uninterrupted operation with an attacker-
    controller server. (CVE-2023-45919)
