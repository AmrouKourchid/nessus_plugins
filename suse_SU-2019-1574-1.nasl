...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=1134697");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=1137815");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2019-12435/");
  # https://www.suse.com/support/update/announcement/2019/suse-su-20191574-1/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bf3f4838");
...
if (rpm_check(release:"SLES15", sp:"1", reference:"libsamba-policy0-4.9.5+git.176.375e1f05788-3.6.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"libsamba-policy0-debuginfo-4.9.5+git.176.375e1f05788-3.6.1")) flag++;
...
if (rpm_check(release:"SLES15", sp:"1", reference:"samba-ad-dc-4.9.5+git.176.375e1f05788-3.6.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"samba-ad-dc-debuginfo-4.9.5+git.176.375e1f05788-3.6.1")) flag++;
...
if (rpm_check(release:"SLES15", sp:"1", reference:"samba-dsdb-modules-4.9.5+git.176.375e1f05788-3.6.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"samba-dsdb-modules-debuginfo-4.9.5+git.176.375e1f05788-3.6.1")) flag++;
...
if (rpm_check(release:"SLES15", sp:"1", reference:"samba-libs-python-4.9.5+git.176.375e1f05788-3.6.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"samba-libs-python-debuginfo-4.9.5+git.176.375e1f05788-3.6.1")) flag++;
...
if (rpm_check(release:"SLES15", sp:"1", reference:"samba-python-4.9.5+git.176.375e1f05788-3.6.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"samba-python-debuginfo-4.9.5+git.176.375e1f05788-3.6.1")) flag++;
...
if (rpm_check(release:"SLED15", sp:"1", reference:"libsamba-policy0-4.9.5+git.176.375e1f05788-3.6.1")) flag++;
if (rpm_check(release:"SLED15", sp:"1", reference:"libsamba-policy0-debuginfo-4.9.5+git.176.375e1f05788-3.6.1")) flag++;
...
if (rpm_check(release:"SLED15", sp:"1", reference:"samba-ad-dc-4.9.5+git.176.375e1f05788-3.6.1")) flag++;
if (rpm_check(release:"SLED15", sp:"1", reference:"samba-ad-dc-debuginfo-4.9.5+git.176.375e1f05788-3.6.1")) flag++;
...
if (rpm_check(release:"SLED15", sp:"1", reference:"samba-dsdb-modules-4.9.5+git.176.375e1f05788-3.6.1")) flag++;
if (rpm_check(release:"SLED15", sp:"1", reference:"samba-dsdb-modules-debuginfo-4.9.5+git.176.375e1f05788-3.6.1")) flag++;
...
if (rpm_check(release:"SLED15", sp:"1", reference:"samba-libs-python-4.9.5+git.176.375e1f05788-3.6.1")) flag++;
if (rpm_check(release:"SLED15", sp:"1", reference:"samba-libs-python-debuginfo-4.9.5+git.176.375e1f05788-3.6.1")) flag++;
...
if (rpm_check(release:"SLED15", sp:"1", reference:"samba-python-4.9.5+git.176.375e1f05788-3.6.1")) flag++;
if (rpm_check(release:"SLED15", sp:"1", reference:"samba-python-debuginfo-4.9.5+git.176.375e1f05788-3.6.1")) flag++;
