...
# extracted from Fedora Security Advisory FEDORA-2024-180560c54b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-180560c54b");

  script_name(english:"Fedora 39 : dotnet8.0 (2024-180560c54b)");
...
FEDORA-2024-180560c54b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-180560c54b");
...
var pkgs = [
    {'reference':'dotnet8.0-8.0.110-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
