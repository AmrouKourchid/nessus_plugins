...
# extracted from Fedora Security Advisory FEDORA-2018-ec5f10e626.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-ec5f10e626");

  script_name(english:"Fedora 26 : 1:cups (2018-ec5f10e626)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"Security fix for CVE-2017-18248

Note that Tenable Network Security has extracted the preceding
description block directly from the Fedora update system website.
Tenable has attempted to automatically clean and format it as much as
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-ec5f10e626");
...
flag = 0;
if (rpm_check(release:"FC26", reference:"cups-2.2.2-9.fc26", epoch:"1")) flag++;
