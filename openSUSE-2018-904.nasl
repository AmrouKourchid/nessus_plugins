...
# extracted from openSUSE Security Update openSUSE-2018-904.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : perl-Archive-Zip (openSUSE-2018-904)");
...
This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1099497");
...
"Update the affected perl-Archive-Zip package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:perl-Archive-Zip");
...
if ( rpm_check(release:"SUSE15.0", reference:"perl-Archive-Zip-1.60-lp150.2.3.1") ) flag++;
