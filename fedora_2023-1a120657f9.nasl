...
# extracted from Fedora Security Advisory FEDORA-2023-1a120657f9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-1a120657f9");

  script_name(english:"Fedora 38 : python-pillow (2023-1a120657f9)");
...
FEDORA-2023-1a120657f9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-1a120657f9");
...
var pkgs = [
    {'reference':'python-pillow-9.5.0-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
