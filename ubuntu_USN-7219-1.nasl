...
# extracted from Ubuntu Security Notice USN-7219-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"7219-1");

  script_name(english:"Ubuntu 24.04 LTS / 24.10 : Python vulnerability (USN-7219-1)");
...
the USN-7219-1 advisory.

    It was discovered that Python incorrectly handled asyncio write buffers. A remote attacker could possibly
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7219-1");
...
var pkgs = [
    {'osver': '24.04', 'pkgname': 'idle-python3.12', 'pkgver': '3.12.3-1ubuntu0.4'},
    {'osver': '24.04', 'pkgname': 'libpython3.12-dev', 'pkgver': '3.12.3-1ubuntu0.4'},
    {'osver': '24.04', 'pkgname': 'libpython3.12-minimal', 'pkgver': '3.12.3-1ubuntu0.4'},
    {'osver': '24.04', 'pkgname': 'libpython3.12-stdlib', 'pkgver': '3.12.3-1ubuntu0.4'},
    {'osver': '24.04', 'pkgname': 'libpython3.12-testsuite', 'pkgver': '3.12.3-1ubuntu0.4'},
    {'osver': '24.04', 'pkgname': 'libpython3.12t64', 'pkgver': '3.12.3-1ubuntu0.4'},
    {'osver': '24.04', 'pkgname': 'python3.12', 'pkgver': '3.12.3-1ubuntu0.4'},
    {'osver': '24.04', 'pkgname': 'python3.12-dev', 'pkgver': '3.12.3-1ubuntu0.4'},
    {'osver': '24.04', 'pkgname': 'python3.12-examples', 'pkgver': '3.12.3-1ubuntu0.4'},
    {'osver': '24.04', 'pkgname': 'python3.12-full', 'pkgver': '3.12.3-1ubuntu0.4'},
    {'osver': '24.04', 'pkgname': 'python3.12-minimal', 'pkgver': '3.12.3-1ubuntu0.4'},
    {'osver': '24.04', 'pkgname': 'python3.12-nopie', 'pkgver': '3.12.3-1ubuntu0.4'},
    {'osver': '24.04', 'pkgname': 'python3.12-venv', 'pkgver': '3.12.3-1ubuntu0.4'},
    {'osver': '24.10', 'pkgname': 'idle-python3.12', 'pkgver': '3.12.7-1ubuntu1.1'},
    {'osver': '24.10', 'pkgname': 'libpython3.12-dev', 'pkgver': '3.12.7-1ubuntu1.1'},
    {'osver': '24.10', 'pkgname': 'libpython3.12-minimal', 'pkgver': '3.12.7-1ubuntu1.1'},
    {'osver': '24.10', 'pkgname': 'libpython3.12-stdlib', 'pkgver': '3.12.7-1ubuntu1.1'},
    {'osver': '24.10', 'pkgname': 'libpython3.12-testsuite', 'pkgver': '3.12.7-1ubuntu1.1'},
    {'osver': '24.10', 'pkgname': 'libpython3.12t64', 'pkgver': '3.12.7-1ubuntu1.1'},
    {'osver': '24.10', 'pkgname': 'python3.12', 'pkgver': '3.12.7-1ubuntu1.1'},
    {'osver': '24.10', 'pkgname': 'python3.12-dev', 'pkgver': '3.12.7-1ubuntu1.1'},
    {'osver': '24.10', 'pkgname': 'python3.12-examples', 'pkgver': '3.12.7-1ubuntu1.1'},
    {'osver': '24.10', 'pkgname': 'python3.12-full', 'pkgver': '3.12.7-1ubuntu1.1'},
    {'osver': '24.10', 'pkgname': 'python3.12-gdbm', 'pkgver': '3.12.7-1ubuntu1.1'},
    {'osver': '24.10', 'pkgname': 'python3.12-minimal', 'pkgver': '3.12.7-1ubuntu1.1'},
    {'osver': '24.10', 'pkgname': 'python3.12-nopie', 'pkgver': '3.12.7-1ubuntu1.1'},
    {'osver': '24.10', 'pkgname': 'python3.12-tk', 'pkgver': '3.12.7-1ubuntu1.1'},
    {'osver': '24.10', 'pkgname': 'python3.12-venv', 'pkgver': '3.12.7-1ubuntu1.1'}
];
