...
if (description)
{
  ...
  script_name(english:"Tenable Nessus < 10.8.3 Multiple Vulnerabilities (TNS-2024-15 & TNS-2024-16)");

  script_set_attribute(attribute:"synopsis", value:
"An instance of Nessus installed on the remote system is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"According to its self-reported version, the Tenable Nessus application running on the remote host is prior to 10.8.3. It
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://docs.tenable.com/release-notes/Content/nessus/2024.htm?");
  script_set_attribute(attribute:"see_also", value:"https://www.tenable.com/security/TNS-2024-16");
  script_set_attribute(attribute:"see_also", value:"https://www.tenable.com/security/TNS-2024-15");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Tenable Nessus 10.8.3 or later.");
...
var constraints = [
  { 'max_version' : '10.7.5', 'fixed_display' : '10.7.6 / 10.8.3' },
