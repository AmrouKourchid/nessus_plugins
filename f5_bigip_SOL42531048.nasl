...
# extracted from F5 Networks BIG-IP Solution K42531048.
#
# @NOAGENT@
##
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : OpenSSH vulnerability (K42531048)");
...
affected by a vulnerability as referenced in the K42531048 advisory.
    ...
    codes to hide additional files being transferred.(CVE-2019-6110)ImpactAcceptance and display of
    arbitrarystderrallows for spoofing of OpenSSH SCP client output.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K42531048");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K42531048.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:H/Au:N/C:P/I:P/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:H/PR:N/UI:R/S:U/C:H/I:H/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-6110");
...
var vmatrix = {
  'AFM': {
    'affected': [
      '17.0.0-17.1.0','16.0.0-16.1.3','15.1.0-15.1.9','14.1.0-14.1.5','13.1.0-13.1.5','12.1.0-12.1.6','11.6.1-11.6.5'
    ],
    'unaffected': [
