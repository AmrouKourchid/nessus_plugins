...
# extracted from Red Hat Security Advisory RHSA-2024:7552. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:7552");

  script_name(english:"RHEL 9 : thunderbird (RHSA-2024:7552)");
...
referenced in the RHSA-2024:7552 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_7552.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0ac55df0");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:7552");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL thunderbird package based on the guidance in RHSA-2024:7552.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'thunderbird-128.3.0-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'thunderbird-128.3.0-1.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
