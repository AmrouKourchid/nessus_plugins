...
subject to the privileges of the web server user.");
  # https://packetstormsecurity.com/files/121438/FreePBX-2.9-Remote-Command-Execution.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4a0ff6a5");
