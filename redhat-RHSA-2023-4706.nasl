...
# extracted from Red Hat Security Advisory RHSA-2023:4706. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:4706");

  script_name(english:"RHEL 8 : subscription-manager (RHSA-2023:4706)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for subscription-manager.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2023:4706 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_4706.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e6128f9f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2225407");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:4706");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL subscription-manager package based on the guidance in RHSA-2023:4706.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:python3-cloud-what");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rhsm-icons");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'dnf-plugin-subscription-manager-1.28.36-3.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-cloud-what-1.28.36-3.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-subscription-manager-rhsm-1.28.36-3.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-syspurpose-1.28.36-3.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rhsm-gtk-1.28.36-3.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rhsm-icons-1.28.36-3.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'subscription-manager-1.28.36-3.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'subscription-manager-cockpit-1.28.36-3.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'subscription-manager-initial-setup-addon-1.28.36-3.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'subscription-manager-migration-1.28.36-3.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'subscription-manager-plugin-ostree-1.28.36-3.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'subscription-manager-rhsm-certificates-1.28.36-3.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'dnf-plugin-subscription-manager-1.28.36-3.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-cloud-what-1.28.36-3.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-subscription-manager-rhsm-1.28.36-3.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-syspurpose-1.28.36-3.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rhsm-gtk-1.28.36-3.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rhsm-icons-1.28.36-3.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'subscription-manager-1.28.36-3.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'subscription-manager-cockpit-1.28.36-3.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'subscription-manager-initial-setup-addon-1.28.36-3.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'subscription-manager-migration-1.28.36-3.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'subscription-manager-plugin-ostree-1.28.36-3.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'subscription-manager-rhsm-certificates-1.28.36-3.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
