...
# extracted from Fedora Security Advisory FEDORA-2024-03fd821ae2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-03fd821ae2");

  script_name(english:"Fedora 39 : bubblewrap / flatpak (2024-03fd821ae2)");
...
FEDORA-2024-03fd821ae2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-03fd821ae2");
  script_set_attribute(attribute:"solution", value:
"Update the affected bubblewrap and / or flatpak packages.");
...
var pkgs = [
    {'reference':'bubblewrap-0.10.0-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'flatpak-1.15.10-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'bubblewrap / flatpak');
}
