...
# extracted from SUSE update advisory SUSE-SU-2018:3068-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLED15 / SLES15 Security Update : soundtouch (SUSE-SU-2018:3068-1)");
...
without introducing additional issues.");
  ...
  # https://www.suse.com/support/update/announcement/2018/suse-su-20183068-1/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ca31ca56");
...
patch SUSE-SLE-Module-Desktop-Applications-15-2018-2171=1");
...
flag = 0;
if (rpm_check(release:"SLES15", sp:"0", reference:"libSoundTouch0-1.8.0-3.3.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", reference:"libSoundTouch0-debuginfo-1.8.0-3.3.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", reference:"soundtouch-debuginfo-1.8.0-3.3.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", reference:"soundtouch-debugsource-1.8.0-3.3.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", reference:"soundtouch-devel-1.8.0-3.3.1")) flag++;
if (rpm_check(release:"SLED15", sp:"0", reference:"libSoundTouch0-1.8.0-3.3.1")) flag++;
if (rpm_check(release:"SLED15", sp:"0", reference:"libSoundTouch0-debuginfo-1.8.0-3.3.1")) flag++;
if (rpm_check(release:"SLED15", sp:"0", reference:"soundtouch-debuginfo-1.8.0-3.3.1")) flag++;
if (rpm_check(release:"SLED15", sp:"0", reference:"soundtouch-debugsource-1.8.0-3.3.1")) flag++;
if (rpm_check(release:"SLED15", sp:"0", reference:"soundtouch-devel-1.8.0-3.3.1")) flag++;
