...
# extracted from Fedora Security Advisory FEDORA-2022-3e859b6bc6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-3e859b6bc6");

  script_name(english:"Fedora 37 : mingw-python3 (2022-3e859b6bc6)");
...
FEDORA-2022-3e859b6bc6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-3e859b6bc6");
...
var pkgs = [
    {'reference':'mingw-python3-3.10.8-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
