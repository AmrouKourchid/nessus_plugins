...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5058392");
  script_xref(name:"MSFT", value:"MS25-5058392");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2025/06/03");

  script_name(english:"KB5058392: Windows 10 version 1809 / Windows Server 2019 Security Update (May 2025)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5058392");
