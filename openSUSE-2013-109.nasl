...
# extracted from openSUSE Security Update openSUSE-2013-109.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : Opera (openSUSE-SU-2013:0273-2)");
...
Also check out http://www.opera.com/docs/changelogs/unix/1213");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.novell.com/show_bug.cgi?id=801233");
  script_set_attribute(attribute:"see_also", value:"https://lists.opensuse.org/opensuse-updates/2013-02/msg00025.html");
  script_set_attribute(attribute:"see_also", value:"https://lists.opensuse.org/opensuse-updates/2013-02/msg00088.html");
...
if ( rpm_check(release:"SUSE12.1", reference:"opera-12.13-38.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"opera-gtk-12.13-38.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"opera-kde4-12.13-38.1") ) flag++;
if ( rpm_check(release:"SUSE12.2", reference:"opera-12.13-1.12.1") ) flag++;
if ( rpm_check(release:"SUSE12.2", reference:"opera-gtk-12.13-1.12.1") ) flag++;
if ( rpm_check(release:"SUSE12.2", reference:"opera-kde4-12.13-1.12.1") ) flag++;
