...
referenced in the RHSA-2009:1512 advisory.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2009/rhsa-2009_1512.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?16f607e5");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=491840");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=495907");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=526911");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2009:1512");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL kdegraphics package based on the guidance in RHSA-2009:1512.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'kdegraphics-3.3.1-15.el4_8.2', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'kdegraphics-3.3.1-15.el4_8.2', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'kdegraphics-3.3.1-15.el4_8.2', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'kdegraphics-3.3.1-15.el4_8.2', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'kdegraphics-3.3.1-15.el4_8.2', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'kdegraphics-devel-3.3.1-15.el4_8.2', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'kdegraphics-devel-3.3.1-15.el4_8.2', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'kdegraphics-devel-3.3.1-15.el4_8.2', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'kdegraphics-devel-3.3.1-15.el4_8.2', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'kdegraphics-devel-3.3.1-15.el4_8.2', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
    ]
  }
];
