...
# extracted from Fedora Security Advisory FEDORA-2024-28fde3feb7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-28fde3feb7");

  script_name(english:"Fedora 40 : opensmtpd (2024-28fde3feb7)");
...
FEDORA-2024-28fde3feb7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-28fde3feb7");
...
var pkgs = [
    {'reference':'opensmtpd-7.4.0p1-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
