...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : php (EulerOS-SA-2021-2479)");
...
following vulnerabilities : Note that Tenable Network Security has extracted the preceding description block directly
from the EulerOS security advisory. Tenable has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2479
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?98060ae2");
