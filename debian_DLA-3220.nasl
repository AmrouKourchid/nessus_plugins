...
# extracted from Debian Security Advisory dla-3220. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3220 : clamav - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3220
advisory.
...
"Upgrade the clamav packages.");
  ...
  script_set_attribute(attribute:"plugin_publication_date", value:"2022/12/04");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'clamav', 'reference': '0.103.7+dfsg-0+deb10u1'},
    {'release': '10.0', 'prefix': 'clamav-base', 'reference': '0.103.7+dfsg-0+deb10u1'},
    {'release': '10.0', 'prefix': 'clamav-daemon', 'reference': '0.103.7+dfsg-0+deb10u1'},
    {'release': '10.0', 'prefix': 'clamav-docs', 'reference': '0.103.7+dfsg-0+deb10u1'},
    {'release': '10.0', 'prefix': 'clamav-freshclam', 'reference': '0.103.7+dfsg-0+deb10u1'},
    {'release': '10.0', 'prefix': 'clamav-milter', 'reference': '0.103.7+dfsg-0+deb10u1'},
    {'release': '10.0', 'prefix': 'clamav-testfiles', 'reference': '0.103.7+dfsg-0+deb10u1'},
    {'release': '10.0', 'prefix': 'clamdscan', 'reference': '0.103.7+dfsg-0+deb10u1'},
    {'release': '10.0', 'prefix': 'libclamav-dev', 'reference': '0.103.7+dfsg-0+deb10u1'},
    {'release': '10.0', 'prefix': 'libclamav9', 'reference': '0.103.7+dfsg-0+deb10u1'}
];
