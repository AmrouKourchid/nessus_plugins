...
if (description)
{
  ...
  script_name(english:"Amazon Corretto Java 11.x < 11.0.20.8.1 Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"Amazon Corretto is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Amazon Corretto installed on the remote host is prior to 11 < 11.0.20.8.1. It is, therefore, affected by
multiple vulnerabilities as referenced in the corretto-11-2023-Jul-18 advisory.

  - core-libs/java.net (CVE-2023-22006)

  - core-libs/java.util (CVE-2023-22036)

  - hotspot/compiler (CVE-2023-22041, CVE-2023-22045)
...
"Update to Amazon Corretto Java 11.0.20.8.1 or later");
...
var constraints = [
  { 'min_version' : '11.0', 'fixed_version' : '11.0.20.8.1' }
];
