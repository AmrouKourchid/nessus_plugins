...
# extracted from Fedora Security Advisory FEDORA-2023-5410d30cc9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-5410d30cc9");

  script_name(english:"Fedora 39 : godot (2023-5410d30cc9)");
...
FEDORA-2023-5410d30cc9 advisory.
    ...
    For Fedora 37 and 38, it updates from Godot 4.0.x to 4.1.x, so the release notes for the minor 4.1 release
    are worth reviewing.

    This update also improves the .blend file import integration by pre-filling the path to system packaged
    Blender.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-5410d30cc9");
...
"Update the affected godot package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-34300");
...
var pkgs = [
    {'reference':'godot-4.1.2-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
