...
# extracted from Ubuntu Security Notice USN-3924-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"3924-1");

  script_name(english:"Ubuntu 18.04 LTS : mod_auth_mellon vulnerabilities (USN-3924-1)");
...
the USN-3924-1 advisory.

    It was discovered that mod_auth_mellon incorrectly handled certain requests. An attacker could possibly
    use this issue to redirect a user to a malicious URL. (CVE-2019-3877)

    It was discovered that mod_auth_mellon incorrectly handled certain requests. An attacker could possibly
    use this issue to access sensitive information. (CVE-2019-3878)

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3924-1");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'libapache2-mod-auth-mellon', 'pkgver': '0.13.1-1ubuntu0.1'}
];
