...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS : Libtasn1 vulnerability (USN-2957-2)");
...
USN-2957-2 advisory.
    ...
    USN-2957-1 fixed a vulnerability in Libtasn1. This update provides the corresponding update for Ubuntu
    16.04 LTS.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2957-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libtasn1-3-bin', 'pkgver': '4.7-3ubuntu0.16.04.1'},
    {'osver': '16.04', 'pkgname': 'libtasn1-6', 'pkgver': '4.7-3ubuntu0.16.04.1'},
    {'osver': '16.04', 'pkgname': 'libtasn1-6-dev', 'pkgver': '4.7-3ubuntu0.16.04.1'},
    {'osver': '16.04', 'pkgname': 'libtasn1-bin', 'pkgver': '4.7-3ubuntu0.16.04.1'}
];
