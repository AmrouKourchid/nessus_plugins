...
"The remote Red Hat host is missing a security update for rh-maven35-apache-commons-collections4.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2020:4274 advisory.

    The Apache Commons Collections library provides new interfaces, implementations, and utilities to extend
    the features of the Java Collections Framework.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_4274.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?58dc04cb");
...
"Update the RHEL rh-maven35-apache-commons-collections4 package based on the guidance in RHSA-2020:4274.");
