...
# extracted from VMware Security Advisory PHSA-2021-2.0-0379. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Util PHSA-2021-2.0-0379");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the util package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-2-379.md");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'util-linux-2.32.1-2.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'util-linux-devel-2.32.1-2.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'util-linux-lang-2.32.1-2.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'util-linux-libs-2.32.1-2.ph2')) flag++;
