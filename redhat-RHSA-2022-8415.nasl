...
# extracted from Red Hat Security Advisory RHSA-2022:8415. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2021-46195");
  script_xref(name:"RHSA", value:"2022:8415");

  script_name(english:"RHEL 9 : mingw-gcc (RHSA-2022:8415)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for mingw-gcc.");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8415.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6613ef12");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8415");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2046300");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2080170");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2096010");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL mingw-gcc package based on the guidance in RHSA-2022:8415.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:N/I:N/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:N/UI:R/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-46195");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:mingw-gcc");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:mingw32-cpp");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:mingw32-gcc");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:mingw32-gcc-c++");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:mingw32-libgcc");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:mingw64-cpp");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:mingw64-gcc");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:mingw64-gcc-c++");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:mingw64-libgcc");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'mingw32-cpp-12.0.1-11.2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mingw32-gcc-12.0.1-11.2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mingw32-gcc-c++-12.0.1-11.2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mingw32-libgcc-12.0.1-11.2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mingw64-cpp-12.0.1-11.2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mingw64-gcc-12.0.1-11.2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mingw64-gcc-c++-12.0.1-11.2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mingw64-libgcc-12.0.1-11.2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'mingw32-cpp / mingw32-gcc / mingw32-gcc-c++ / mingw32-libgcc / etc');
}
