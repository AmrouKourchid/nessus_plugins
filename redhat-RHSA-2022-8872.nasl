...
"The remote Red Hat host is missing one or more security updates for Red Hat OpenStack Platform 16.1.9 (python-django20).");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8872.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e46a1b34");
...
"Update the RHEL Red Hat OpenStack Platform 16.1.9 (python-django20) package based on the guidance in RHSA-2022:8872.");
