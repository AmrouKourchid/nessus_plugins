...
# extracted from Red Hat Security Advisory RHSA-2020:5086. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:5086");

  script_name(english:"RHEL 7 : rh-nodejs12-nodejs (RHSA-2020:5086)");
...
referenced in the RHSA-2020:5086 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_5086.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0caacc7f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:5086");
...
"Update the RHEL rh-nodejs12-nodejs package based on the guidance in RHSA-2020:5086.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-nodejs12-nodejs-12.18.4-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs12-nodejs-devel-12.18.4-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs12-nodejs-docs-12.18.4-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs12-npm-6.14.6-12.18.4.3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
