...
# extracted from Red Hat Security Advisory RHSA-2024:8365. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:8365");

  script_name(english:"RHEL 7 : python-idna (RHSA-2024:8365)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?19d38c8f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:8365");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-idna package based on the guidance in RHSA-2024:8365.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python-idna-2.4-2.el7_9', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
