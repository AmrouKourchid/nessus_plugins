...
# extracted from Red Hat Security Advisory RHSA-2015:2523. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2015:2523");

  script_name(english:"RHEL 6 / 7 : rh-java-common-apache-commons-collections (RHSA-2015:2523)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for rh-java-common-apache-commons-collections.");
...
in the RHSA-2015:2523 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2015/rhsa-2015_2523.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bc6d167a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2015:2523");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rh-java-common-apache-commons-collections package based on the guidance in RHSA-2015:2523.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rh-java-common-apache-commons-collections");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rh-java-common-apache-commons-collections-javadoc");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rh-java-common-apache-commons-collections-testframework");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rh-java-common-apache-commons-collections-testframework-javadoc");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-java-common-apache-commons-collections-3.2.1-21.13.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-java-common-apache-commons-collections-javadoc-3.2.1-21.13.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-java-common-apache-commons-collections-testframework-3.2.1-21.13.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-java-common-apache-commons-collections-testframework-javadoc-3.2.1-21.13.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'rh-java-common-apache-commons-collections-3.2.1-21.13.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-java-common-apache-commons-collections-javadoc-3.2.1-21.13.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-java-common-apache-commons-collections-testframework-3.2.1-21.13.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-java-common-apache-commons-collections-testframework-javadoc-3.2.1-21.13.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'rh-java-common-apache-commons-collections / etc');
}
