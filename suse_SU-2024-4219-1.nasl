...
# SUSE update advisory SUSE-SU-2024:4219-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2024-35949", "CVE-2024-41059", "CVE-2024-43861");
  script_xref(name:"SuSE", value:"SUSE-SU-2024:4219-1");

  script_name(english:"SUSE SLES12 Security Update : kernel (Live Patch 58 for SLE 12 SP5) (SUSE-SU-2024:4219-1)");
...
the SUSE-SU-2024:4219-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2024-December/019940.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?70defefa");
...
"Update the affected kgraft-patch-4_12_14-122_222-default package.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-122.222-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_12_14-122_222-default-3-8.6.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.5']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kgraft-patch-4_12_14-122_222-default');
}
