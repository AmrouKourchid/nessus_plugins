...
# extracted from Red Hat Security Advisory RHSA-2022:1820. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:1820");

  script_name(english:"RHEL 8 : udisks2 (RHSA-2022:1820)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for udisks2.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2022:1820 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_1820.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b5877643");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:1820");
...
"Update the RHEL udisks2 package based on the guidance in RHSA-2022:1820.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libudisks2-2.9.0-9.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libudisks2-devel-2.9.0-9.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'udisks2-2.9.0-9.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'udisks2-iscsi-2.9.0-9.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'udisks2-lsm-2.9.0-9.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'udisks2-lvm2-2.9.0-9.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
