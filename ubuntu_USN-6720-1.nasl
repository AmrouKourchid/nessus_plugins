...
# extracted from Ubuntu Security Notice USN-6720-1. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2023-39361");
  script_xref(name:"USN", value:"6720-1");

  script_name(english:"Ubuntu 22.04 LTS : Cacti vulnerability (USN-6720-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6720-1");
...
var pkgs = [
    {'osver': '22.04', 'pkgname': 'cacti', 'pkgver': '1.2.19+ds1-2ubuntu1+esm1', 'ubuntu_pro': TRUE}
];
