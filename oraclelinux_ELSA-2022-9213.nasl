...
# extracted from Oracle Linux Security Advisory ELSA-2022-9213.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : Unbreakable Enterprise kernel-container (ELSA-2022-9213)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2022-9213.html");
...
if (machine_uptrack_level)
{
  ...
  var fixed_uptrack_levels = ['4.14.35-2047.511.5.6.el7'];
  foreach var fixed_uptrack_level ( fixed_uptrack_levels ) {
    if (rpm_spec_vers_cmp(a:trimmed_uptrack_level, b:fixed_uptrack_level) >= 0)
    {
      audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for ELSA-2022-9213');
    }
  }
...
var pkgs = [
    {'reference':'kernel-uek-container-4.14.35-2047.511.5.6.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-container-4.14.35'}
];
