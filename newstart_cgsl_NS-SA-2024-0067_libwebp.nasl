...
# extracted from ZTE advisory NS-SA-2024-0067. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 6.02 : libwebp Multiple Vulnerabilities (NS-SA-2024-0067)");
...
vulnerabilities:
  ...
  - A heap-based buffer flaw was found in the way libwebp, a library used to process WebP image format data,
    processes certain specially formatted WebP images. An attacker could use this flaw to crash or execute
    remotely arbitrary code in an application such as a web browser compiled with this library.
    (CVE-2023-4863)

  - This CVE ID has been rejected by its CVE Numbering Authority. Duplicate of CVE-2023-4863. (CVE-2023-5129)

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/notice/NS-SA-2024-0067");
