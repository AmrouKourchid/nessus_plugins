...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : libtiff (EulerOS-SA-2021-1089)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1089
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5beeeef7");
...
pkgs = ["libtiff-4.0.3-27.h20",
        "libtiff-devel-4.0.3-27.h20"];
