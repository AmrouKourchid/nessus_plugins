...
# extracted from Fedora Security Advisory FEDORA-2024-96903c39cb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-96903c39cb");

  script_name(english:"Fedora 40 : tcpreplay (2024-96903c39cb)");
...
FEDORA-2024-96903c39cb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-96903c39cb");
...
var pkgs = [
    {'reference':'tcpreplay-4.4.4-5.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
