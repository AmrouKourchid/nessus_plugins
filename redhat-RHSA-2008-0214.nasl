...
# extracted from Red Hat Security Advisory RHSA-2008:0214. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 4 / 5 : squid (RHSA-2008:0214)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for squid.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 4 / 5 host has a package installed that is affected by a vulnerability as referenced
in the RHSA-2008:0214 advisory.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2008/rhsa-2008_0214.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f81d9660");
  script_set_attribute(attribute:"see_also", value:"http://www.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2008:0214");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=439801");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL squid package based on the guidance in RHSA-2008:0214.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:N/I:N/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2008-1612");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'squid-2.5.STABLE14-1.4E.el4_6.2', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'squid-2.5.STABLE14-1.4E.el4_6.2', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'squid-2.5.STABLE14-1.4E.el4_6.2', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'squid-2.5.STABLE14-1.4E.el4_6.2', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'squid-2.5.STABLE14-1.4E.el4_6.2', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'squid-2.6.STABLE6-5.el5_1.3', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'squid-2.6.STABLE6-5.el5_1.3', 'cpu':'ppc', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'squid-2.6.STABLE6-5.el5_1.3', 'cpu':'s390x', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'squid-2.6.STABLE6-5.el5_1.3', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
    ]
  }
];
