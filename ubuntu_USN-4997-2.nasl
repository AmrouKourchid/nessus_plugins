...
# extracted from Ubuntu Security Notice USN-4997-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"4997-2");
  script_xref(name:"IAVA", value:"2021-A-0223-S");
  script_xref(name:"IAVA", value:"2021-A-0222-S");

  script_name(english:"Ubuntu 21.04 : Linux kernel (KVM) vulnerabilities (USN-4997-2)");
...
USN-4997-2 advisory.
    ...
    USN-4997-1 fixed vulnerabilities in the Linux kernel for Ubuntu 21.04. This update provides the
    corresponding updates for the Linux KVM kernel for Ubuntu 21.04.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4997-2");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-buildinfo-5.11.0-1009-kvm");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-headers-5.11.0-1009-kvm");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-headers-kvm");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.11.0-1009-kvm");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-kvm");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-unsigned-5.11.0-1009-kvm");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-kvm");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-kvm-headers-5.11.0-1009");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-kvm-tools-5.11.0-1009");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-modules-5.11.0-1009-kvm");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-tools-5.11.0-1009-kvm");
...
var pkgs = [
    {'osver': '21.04', 'pkgname': 'linux-buildinfo-5.11.0-1009-kvm', 'pkgver': '5.11.0-1009.9'},
    {'osver': '21.04', 'pkgname': 'linux-headers-5.11.0-1009-kvm', 'pkgver': '5.11.0-1009.9'},
    {'osver': '21.04', 'pkgname': 'linux-headers-kvm', 'pkgver': '5.11.0.1009.9'},
    {'osver': '21.04', 'pkgname': 'linux-image-5.11.0-1009-kvm', 'pkgver': '5.11.0-1009.9'},
    {'osver': '21.04', 'pkgname': 'linux-image-kvm', 'pkgver': '5.11.0.1009.9'},
    {'osver': '21.04', 'pkgname': 'linux-image-unsigned-5.11.0-1009-kvm', 'pkgver': '5.11.0-1009.9'},
    {'osver': '21.04', 'pkgname': 'linux-kvm', 'pkgver': '5.11.0.1009.9'},
    {'osver': '21.04', 'pkgname': 'linux-kvm-headers-5.11.0-1009', 'pkgver': '5.11.0-1009.9'},
    {'osver': '21.04', 'pkgname': 'linux-kvm-tools-5.11.0-1009', 'pkgver': '5.11.0-1009.9'},
    {'osver': '21.04', 'pkgname': 'linux-modules-5.11.0-1009-kvm', 'pkgver': '5.11.0-1009.9'},
    {'osver': '21.04', 'pkgname': 'linux-tools-5.11.0-1009-kvm', 'pkgver': '5.11.0-1009.9'},
    {'osver': '21.04', 'pkgname': 'linux-tools-kvm', 'pkgver': '5.11.0.1009.9'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'linux-buildinfo-5.11.0-1009-kvm / linux-headers-5.11.0-1009-kvm / etc');
}
