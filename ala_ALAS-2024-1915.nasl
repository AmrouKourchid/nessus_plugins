...
# extracted from Amazon Linux AMI Security Advisory ALAS-2024-1915.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2023-51448");

  script_name(english:"Amazon Linux AMI : cacti (ALAS-2024-1915)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux AMI host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of cacti installed on the remote host is prior to 1.1.19-6.24. It is, therefore, affected by a vulnerability
as referenced in the ALAS-2024-1915 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/ALAS-2024-1915.html");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/cve/html/CVE-2023-51448.html");
...
var pkgs = [
    {'reference':'cacti-1.1.19-6.24.amzn1', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE}
];
