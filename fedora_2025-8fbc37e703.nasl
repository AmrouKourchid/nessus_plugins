...
# extracted from Fedora Security Advisory FEDORA-2025-8fbc37e703
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-8fbc37e703");

  script_name(english:"Fedora 41 : chromium (2025-8fbc37e703)");
...
FEDORA-2025-8fbc37e703 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-8fbc37e703");
...
var pkgs = [
    {'reference':'chromium-136.0.7103.59-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
