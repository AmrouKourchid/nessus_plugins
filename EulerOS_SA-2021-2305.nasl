...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : libwebp (EulerOS-SA-2021-2305)");
...
vulnerabilities :
  ...
  - A flaw was found in libwebp in versions before 1.0.1.
    When reading a file libwebp allocates an excessive
    amount of memory. The highest threat from this
    vulnerability is to the service
    availability.(CVE-2020-36332)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2305
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5f2e6547");
...
pkgs = ["libwebp-1.0.0-3.h1.eulerosv2r8"];
