...
# extracted from Gentoo Linux Security Advisory GLSA 202210-42.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202210-42 : zlib: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202210-42 (zlib: Multiple vulnerabilities)
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=835958");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=863851");
...
var packages = [
  {
    'name' : 'sys-libs/zlib',
    'unaffected' : make_list("ge 1.2.12-r3", "lt 1.0.0"),
    'vulnerable' : make_list("lt 1.2.12-r3")
  }
];
