...
# extracted from Fedora Security Advisory FEDORA-2019-d7b5e168d1.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : libtiff (2019-d7b5e168d1)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-d7b5e168d1");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"libtiff-4.0.10-2.fc29")) flag++;
