...
# extracted from Red Hat Security Advisory RHSA-2023:0806. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:0806");
  script_xref(name:"IAVA", value:"2023-A-0081-S");

  script_name(english:"RHEL 8 : Mozilla Firefox (RHSA-2023:0806)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for Mozilla Firefox.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has a package installed that is affected by multiple vulnerabilities as
referenced in the RHSA-2023:0806 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_0806.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fdde742e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:0806");
...
"Update the RHEL Mozilla Firefox package based on the guidance in RHSA-2023:0806.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-102.8.0-2.el8_1', 'sp':'1', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-102.8.0-2.el8_1', 'sp':'1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
