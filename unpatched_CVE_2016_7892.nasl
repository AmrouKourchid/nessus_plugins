...
if (description)
{
  ...
  script_cve_id("CVE-2016-7892");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2022/04/15");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2016-7892");
...
patch available.
  ...
  - Adobe Flash Player versions 23.0.0.207 and earlier, 11.2.202.644 and earlier have an exploitable use after
    free vulnerability in the TextField class. Successful exploitation could lead to arbitrary code execution.
    (CVE-2016-7892)
