...
# extracted from Fedora Security Advisory FEDORA-2022-db674bafd9
#
...
if (description)
{
  ...
  script_cve_id("CVE-2022-3920", "CVE-2022-29153");
  script_xref(name:"FEDORA", value:"2022-db674bafd9");

  script_name(english:"Fedora 36 : containerd / golang-github-containerd-cgroups / moby-engine (2022-db674bafd9)");
...
FEDORA-2022-db674bafd9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-db674bafd9");
...
"Update the affected 1:golang-github-containerd-cgroups, containerd and / or moby-engine packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2022-3920");
...
var pkgs = [
    {'reference':'containerd-1.6.14-2.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-github-containerd-cgroups-1.0.4-3.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'moby-engine-20.10.21-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
