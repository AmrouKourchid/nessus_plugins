...
# extracted from Ubuntu Security Notice USN-4498-1. The text
...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS : Loofah vulnerability (USN-4498-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4498-1");
  script_set_attribute(attribute:"solution", value:
"Update the affected ruby-loofah package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:ruby-loofah");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'ruby-loofah', 'pkgver': '2.0.3-2+deb9u3build0.16.04.1'}
];
