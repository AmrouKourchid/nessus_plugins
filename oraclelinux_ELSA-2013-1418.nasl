...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2013-1418.html");
  script_set_attribute(attribute:"solution", value:
"Update the affected libtar and / or libtar-devel packages.");
...
var pkgs = [
    {'reference':'libtar-1.2.11-17.el6_4.1', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libtar-devel-1.2.11-17.el6_4.1', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libtar-1.2.11-17.el6_4.1', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libtar-devel-1.2.11-17.el6_4.1', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
];
