...
if (description)
{
  ...
  script_name(english:"Adobe Acrobat < 11.0.17 / 15.006.30198 / 15.017.20050 Multiple Vulnerabilities (APSB16-26) (macOS)");
...
"The version of Adobe Acrobat installed on the remote macOS host is a version prior to 11.0.17, 15.006.30198, or
15.017.20050. It is, therefore, affected by multiple vulnerabilities.
...
"Upgrade to Adobe Acrobat version 11.0.17 / 15.006.30198 / 15.017.20050 or later.");
...
var constraints = [
  { 'max_version' : '11.0.16', 'fixed_version' : '11.0.17', 'track' : 'DC Continuous' },
