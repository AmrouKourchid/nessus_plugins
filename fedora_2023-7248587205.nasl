...
# extracted from Fedora Security Advisory FEDORA-2023-7248587205
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-7248587205");

  script_name(english:"Fedora 38 : libcaca (2023-7248587205)");
...
FEDORA-2023-7248587205 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-7248587205");
...
var pkgs = [
    {'reference':'libcaca-0.99-0.69.beta20.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
