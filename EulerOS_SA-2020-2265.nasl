...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : python-ipaddress (EulerOS-SA-2020-2265)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2265
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?792602b8");
...
pkgs = ["python-ipaddress-1.0.16-2.eulerosv2r7.h1"];
