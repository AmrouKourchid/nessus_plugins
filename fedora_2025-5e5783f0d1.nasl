...
# extracted from Fedora Security Advisory FEDORA-2025-5e5783f0d1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-5e5783f0d1");

  script_name(english:"Fedora 40 : gnutls (2025-5e5783f0d1)");
...
FEDORA-2025-5e5783f0d1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-5e5783f0d1");
...
var pkgs = [
    {'reference':'gnutls-3.8.9-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
