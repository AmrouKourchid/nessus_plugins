...
# extracted from Red Hat Security Advisory RHSA-2024:1089. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:1089");

  script_name(english:"RHEL 9 : haproxy (RHSA-2024:1089)");
...
referenced in the RHSA-2024:1089 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_1089.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?520b1184");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:1089");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL haproxy package based on the guidance in RHSA-2024:1089.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'haproxy-2.4.17-6.el9_2.2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
