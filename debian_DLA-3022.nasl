...
# extracted from Debian Security Advisory dla-3022. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-3022-1 : dpkg - LTS security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 9 host has packages installed that are affected by a vulnerability as referenced in the dla-3022
advisory.

    Max Justicz reported a directory traversal vulnerability in Dpkg::Source::Archive in dpkg, the Debian
    package management system. This affects extracting untrusted source packages in the v2 and v3 source
    package formats that include a debian.tar. For Debian 9 stretch, this problem has been fixed in version
    1.18.26. We recommend that you upgrade your dpkg packages. For the detailed security status of dpkg please
    refer to its security tracker page at: https://security-tracker.debian.org/tracker/dpkg Further
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2022/dla-3022");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-1664");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/stretch/dpkg");
...
var pkgs = [
    {'release': '9.0', 'prefix': 'dpkg', 'reference': '1.18.26'},
    {'release': '9.0', 'prefix': 'dpkg-dev', 'reference': '1.18.26'},
    {'release': '9.0', 'prefix': 'dselect', 'reference': '1.18.26'},
    {'release': '9.0', 'prefix': 'libdpkg-dev', 'reference': '1.18.26'},
    {'release': '9.0', 'prefix': 'libdpkg-perl', 'reference': '1.18.26'}
];
