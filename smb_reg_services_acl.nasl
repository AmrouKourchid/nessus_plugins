...
{
    var extra_verbosity = "Verbosity must be set to 'Report as much information as possible' for this plugin to produce output.";
    security_note(port:kb_smb_transport(), extra:extra_verbosity);
}
