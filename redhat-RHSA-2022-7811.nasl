...
# extracted from Red Hat Security Advisory RHSA-2022:7811. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:7811");

  script_name(english:"RHEL 8 : mingw-expat (RHSA-2022:7811)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for mingw-expat.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2022:7811 advisory.

    Expat is a C library for parsing XML documents. The mingw-expat packages provide a port of the Expat
    library for MinGW.

    The following packages have been upgraded to a later upstream version: mingw-expat (2.4.8). (BZ#2057023,
    BZ#2057037, BZ#2057127)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_7811.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?71e28bfa");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:7811");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL mingw-expat package based on the guidance in RHSA-2022:7811.");
  ...
  script_cwe_id(179, 190, 770, 787, 838);
