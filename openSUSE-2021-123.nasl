...
# extracted from openSUSE Security Update openSUSE-2021-123.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : viewvc (openSUSE-2021-123)");
...
project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1167974");
...
if ( rpm_check(release:"SUSE15.2", reference:"viewvc-1.1.28-lp152.4.3.1") ) flag++;
