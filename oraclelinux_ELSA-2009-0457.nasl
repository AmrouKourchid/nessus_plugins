...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : libwmf (ELSA-2009-0457)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2009-0457.html");
...
"Update the affected libwmf and / or libwmf-devel packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2009-1364");
...
var pkgs = [
    {'reference':'libwmf-0.2.8.4-10.2', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libwmf-devel-0.2.8.4-10.2', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libwmf-0.2.8.4-10.2', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libwmf-devel-0.2.8.4-10.2', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
