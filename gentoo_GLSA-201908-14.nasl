...
# extracted from Gentoo Linux Security Advisory GLSA 201908-14.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2018-1116", "CVE-2018-19788");
  script_xref(name:"GLSA", value:"201908-14");

  script_name(english:"GLSA-201908-14 : polkit: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-201908-14
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/201908-14");
...
if (qpkg_check(package:"sys-auth/polkit", unaffected:make_list("ge 0.115-r2"), vulnerable:make_list("lt 0.115-r2"))) flag++;
