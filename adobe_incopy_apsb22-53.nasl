...
if (description)
{
  ...
  script_name(english:"Adobe InCopy < 16.4.3 / 17.0 < 17.4.0 Multiple Vulnerabilities (APSB22-53)");

  script_set_attribute(attribute:"synopsis", value:
"The Adobe InCopy instance installed on the remote host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe InCopy installed on the remote host is prior to 16.4.3, 17.4.0. It is, therefore, affected by
...
"Upgrade to Adobe InCopy version 16.4.3, 17.4.0 or later.");
...
var constraints = [
  ...
  { 'min_version' : '17.0', 'fixed_version' : '17.4.0' }
];
