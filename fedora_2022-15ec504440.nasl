...
# extracted from Fedora Security Advisory FEDORA-2022-15ec504440
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-15ec504440");

  script_name(english:"Fedora 36 : expat (2022-15ec504440)");
...
FEDORA-2022-15ec504440 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-15ec504440");
...
var pkgs = [
    {'reference':'expat-2.4.9-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
