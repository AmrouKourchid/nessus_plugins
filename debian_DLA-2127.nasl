...
# extracted from Debian Security Advisory DLA-2127-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2127-1 : dojo security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2020/02/msg00033.html");
...
"Upgrade the affected packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-10785");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"libjs-dojo-core", reference:"1.10.2+dfsg-1+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"libjs-dojo-dijit", reference:"1.10.2+dfsg-1+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"libjs-dojo-dojox", reference:"1.10.2+dfsg-1+deb8u2")) flag++;
