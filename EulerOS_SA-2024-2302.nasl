...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.12.1 : curl (EulerOS-SA-2024-2302)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2302
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c99640bc");
...
var pkgs = [
  "curl-7.79.1-14.h26.eulerosv2r12",
  "libcurl-7.79.1-14.h26.eulerosv2r12"
];
