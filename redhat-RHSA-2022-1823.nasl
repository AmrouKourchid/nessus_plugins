...
# extracted from Red Hat Security Advisory RHSA-2022:1823. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:1823");

  script_name(english:"RHEL 8 : mod_auth_openidc:2.3 (RHSA-2022:1823)");
...
referenced in the RHSA-2022:1823 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_1823.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?010b26ec");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/8.6_release_notes/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9341665d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:1823");
...
"Update the RHEL mod_auth_openidc:2.3 package based on the guidance in RHSA-2022:1823.");
  ...
  'mod_auth_openidc:2.3': [
    {
      ...
      'pkgs': [
        ...
        {'reference':'mod_auth_openidc-2.3.7-11.module+el8.6.0+14082+b6f23e95', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
