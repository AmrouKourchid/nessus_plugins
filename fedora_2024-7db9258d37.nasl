...
# extracted from Fedora Security Advisory FEDORA-2024-7db9258d37
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-7db9258d37");

  script_name(english:"Fedora 39 : python3.9 (2024-7db9258d37)");
...
FEDORA-2024-7db9258d37 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-7db9258d37");
...
var pkgs = [
    {'reference':'python3.9-3.9.20-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
