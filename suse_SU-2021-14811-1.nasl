...
# SUSE update advisory SUSE-SU-2021:14811-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2021:14811-1");
  script_xref(name:"IAVA", value:"2021-A-0440-S");

  script_name(english:"SUSE SLES11 Security Update : apache2 (SUSE-SU-2021:14811-1)");
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2021-September/009511.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fec1a8a3");
...
var pkgs = [
    {'reference':'apache2-2.2.34-70.38.1', 'sp':'4', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.4']},
    {'reference':'apache2-doc-2.2.34-70.38.1', 'sp':'4', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.4']},
    {'reference':'apache2-example-pages-2.2.34-70.38.1', 'sp':'4', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.4']},
    {'reference':'apache2-prefork-2.2.34-70.38.1', 'sp':'4', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.4']},
    {'reference':'apache2-utils-2.2.34-70.38.1', 'sp':'4', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.4']},
    {'reference':'apache2-worker-2.2.34-70.38.1', 'sp':'4', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.4']}
];
