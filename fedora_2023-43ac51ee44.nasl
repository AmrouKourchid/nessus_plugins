...
# extracted from Fedora Security Advisory FEDORA-2023-43ac51ee44
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-43ac51ee44");

  script_name(english:"Fedora 38 : suricata (2023-43ac51ee44)");
...
FEDORA-2023-43ac51ee44 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-43ac51ee44");
...
var pkgs = [
    {'reference':'suricata-6.0.11-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
