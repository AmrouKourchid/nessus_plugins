...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Chromium PHSA-2023-5.0-0160");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'chromium-119.0.6045.176-1.ph5')) flag++;
