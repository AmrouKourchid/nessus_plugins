...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?96a94024");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"4", cpu:"x86_64", reference:"shim-15+git47-25.11.1", rpm_spec_vers_cmp:TRUE)) flag++;
if (rpm_check(release:"SLES12", sp:"3", cpu:"x86_64", reference:"shim-15+git47-25.11.1", rpm_spec_vers_cmp:TRUE)) flag++;
if (rpm_check(release:"SLES12", sp:"5", cpu:"x86_64", reference:"shim-15+git47-25.11.1", rpm_spec_vers_cmp:TRUE)) flag++;
