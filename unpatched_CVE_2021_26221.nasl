...
if (description)
{
  ...
  script_cve_id("CVE-2021-26221");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2021-26221");
...
patch available.
  ...
  - The ezxml_new function in ezXML 0.8.6 and earlier is vulnerable to OOB write when opening XML file after
    exhausting the memory pool. (CVE-2021-26221)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-26221");
