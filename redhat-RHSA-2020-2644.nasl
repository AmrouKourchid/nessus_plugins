...
referenced in the RHSA-2020:2644 advisory.
    ...
    This release adds the new Apache HTTP Server 2.4.37 Service Pack 3 packages that are part of the JBoss
    ...
    Pack 2 and includes bug fixes and enhancements. Refer to the Release Notes for information on the most
    ...
    * libxml2: There's a memory leak in xmlParseBalancedChunkMemoryRecover in parser.c that could result in a
    crash (CVE-2019-19956)
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d2e7aea2");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/JBCS-941");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat JBoss Core Services Apache HTTP Server 2.4.37 SP3 package based on the guidance in
RHSA-2020:2644.");
  ...
  script_cwe_id(125, 400, 401, 416, 444, 456, 770, 772, 835);
