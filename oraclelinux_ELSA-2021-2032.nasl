...
# extracted from Oracle Linux Security Advisory ELSA-2021-2032.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : slapi-nis (ELSA-2021-2032)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2021-2032.html");
...
var pkgs = [
    {'reference':'slapi-nis-0.56.5-4.el7_9', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
