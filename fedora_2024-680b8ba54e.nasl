...
# extracted from Fedora Security Advisory FEDORA-2024-680b8ba54e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-680b8ba54e");

  script_name(english:"Fedora 40 : roundcubemail (2024-680b8ba54e)");
...
FEDORA-2024-680b8ba54e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-680b8ba54e");
...
var pkgs = [
    {'reference':'roundcubemail-1.6.7-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
