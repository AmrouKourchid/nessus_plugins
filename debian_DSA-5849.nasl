...
# extracted from Debian Security Advisory dsa-5849. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5849 : git-lfs - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 12 host has packages installed that are affected by a vulnerability as referenced in the dsa-5849
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bookworm/git-lfs");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'git-lfs', 'reference': '3.3.0-1+deb12u1'},
    {'release': '12.0', 'prefix': 'golang-github-git-lfs-git-lfs-dev', 'reference': '3.3.0-1+deb12u1'}
];
