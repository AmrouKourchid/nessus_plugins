...
# extracted from openSUSE Security Update openSUSE-2018-811.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : util-linux (openSUSE-2018-811)");
...
This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1084300");
...
if ( rpm_check(release:"SUSE15.0", reference:"libblkid-devel-2.31.1-lp150.7.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libblkid-devel-static-2.31.1-lp150.7.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libblkid1-2.31.1-lp150.7.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libblkid1-debuginfo-2.31.1-lp150.7.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libfdisk-devel-2.31.1-lp150.7.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libfdisk-devel-static-2.31.1-lp150.7.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libfdisk1-2.31.1-lp150.7.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libfdisk1-debuginfo-2.31.1-lp150.7.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libmount-devel-2.31.1-lp150.7.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libmount-devel-static-2.31.1-lp150.7.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libmount1-2.31.1-lp150.7.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libmount1-debuginfo-2.31.1-lp150.7.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libsmartcols-devel-2.31.1-lp150.7.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libsmartcols-devel-static-2.31.1-lp150.7.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libsmartcols1-2.31.1-lp150.7.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libsmartcols1-debuginfo-2.31.1-lp150.7.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libuuid-devel-2.31.1-lp150.7.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libuuid-devel-static-2.31.1-lp150.7.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libuuid1-2.31.1-lp150.7.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libuuid1-debuginfo-2.31.1-lp150.7.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"util-linux-2.31.1-lp150.7.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"util-linux-debuginfo-2.31.1-lp150.7.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"util-linux-debugsource-2.31.1-lp150.7.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"util-linux-lang-2.31.1-lp150.7.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"util-linux-systemd-2.31.1-lp150.7.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"util-linux-systemd-debuginfo-2.31.1-lp150.7.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"util-linux-systemd-debugsource-2.31.1-lp150.7.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"uuidd-2.31.1-lp150.7.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"uuidd-debuginfo-2.31.1-lp150.7.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libblkid-devel-32bit-2.31.1-lp150.7.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libblkid1-32bit-2.31.1-lp150.7.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libblkid1-32bit-debuginfo-2.31.1-lp150.7.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libmount-devel-32bit-2.31.1-lp150.7.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libmount1-32bit-2.31.1-lp150.7.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libmount1-32bit-debuginfo-2.31.1-lp150.7.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libuuid-devel-32bit-2.31.1-lp150.7.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libuuid1-32bit-2.31.1-lp150.7.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libuuid1-32bit-debuginfo-2.31.1-lp150.7.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"python-libmount-2.31.1-lp150.7.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"python-libmount-debuginfo-2.31.1-lp150.7.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"python-libmount-debugsource-2.31.1-lp150.7.6.1") ) flag++;
