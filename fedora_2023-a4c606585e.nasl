...
# extracted from Fedora Security Advisory FEDORA-2023-a4c606585e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-a4c606585e");
  script_xref(name:"IAVB", value:"2023-B-0081-S");

  script_name(english:"Fedora 38 : xen (2023-a4c606585e)");
...
FEDORA-2023-a4c606585e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-a4c606585e");
...
var pkgs = [
    {'reference':'xen-4.17.2-4.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
