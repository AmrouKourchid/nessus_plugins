...
# extracted from Amazon Linux AMI Security Advisory ALAS-2019-1188.
#
...
if (description)
{
  ...
  script_name(english:"Amazon Linux AMI : openssl (ALAS-2019-1188)");
...
(CVE-2019-1559)");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/ALAS-2019-1188.html");
...
flag = 0;
if (rpm_check(release:"ALA", reference:"openssl-1.0.2k-16.150.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"openssl-debuginfo-1.0.2k-16.150.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"openssl-devel-1.0.2k-16.150.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"openssl-perl-1.0.2k-16.150.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"openssl-static-1.0.2k-16.150.amzn1")) flag++;
