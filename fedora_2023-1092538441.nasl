...
# extracted from Fedora Security Advisory FEDORA-2023-1092538441
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-1092538441");
  script_xref(name:"IAVA", value:"2023-A-0283-S");

  script_name(english:"Fedora 38 : python3.11 (2023-1092538441)");
...
FEDORA-2023-1092538441 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-1092538441");
...
var pkgs = [
    {'reference':'python3.11-3.11.3-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
