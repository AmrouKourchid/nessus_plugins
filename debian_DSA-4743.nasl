...
# extracted from Debian Security Advisory DSA-4743. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"4743");

  script_name(english:"Debian DSA-4743-1 : ruby-kramdown - security update");
...
default the 'template' option is forbidden.");
  script_set_attribute(attribute:"see_also", value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=965305");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/ruby-kramdown");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2020/dsa-4743");
  script_set_attribute(attribute:"solution", value:
"Upgrade the ruby-kramdown packages.
...
flag = 0;
if (deb_check(release:"10.0", prefix:"ruby-kramdown", reference:"1.17.0-1+deb10u1")) flag++;
