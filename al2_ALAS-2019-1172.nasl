...
# extracted from Amazon Linux 2 Security Advisory ALAS-2019-1172.
#
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : golang (ALAS-2019-1172)");
...
Note: This CVE is also fixed in golang-1.11.3-2.amzn2.0.2 in the
golang1.11 extras repository.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2019-1172.html");
...
flag = 0;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"golang-1.9.4-3.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"golang-bin-1.9.4-3.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"golang-docs-1.9.4-3.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"golang-misc-1.9.4-3.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"golang-src-1.9.4-3.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"golang-tests-1.9.4-3.amzn2.0.1")) flag++;
