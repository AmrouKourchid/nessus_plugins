...
# extracted from Red Hat Security Advisory RHSA-2023:3067. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:3067");

  script_name(english:"RHEL 8 : autotrace (RHSA-2023:3067)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for autotrace.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_3067.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?16b27f4e");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/8.8_release_notes/index
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cfe2de5f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2107471");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:3067");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL autotrace package based on the guidance in RHSA-2023:3067.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'autotrace-0.31.1-55.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
