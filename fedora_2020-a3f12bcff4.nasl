...
# extracted from Fedora Security Advisory FEDORA-2020-a3f12bcff4.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : ansible (2020-a3f12bcff4)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-a3f12bcff4");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"ansible-2.9.6-1.fc31")) flag++;
