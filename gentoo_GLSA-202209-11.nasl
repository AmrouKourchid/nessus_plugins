...
# extracted from Gentoo Linux Security Advisory GLSA 202209-11.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2021-45931", "CVE-2022-33068");

  script_name(english:"GLSA-202209-11 : HarfBuzz: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202209-11 (HarfBuzz: Multiple vulnerabilities)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202209-11");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=830372");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=856049");
...
"All HarfBuzz users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2021-45931");
