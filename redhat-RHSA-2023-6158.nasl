...
# extracted from Red Hat Security Advisory RHSA-2023:6158. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2023-43665", "CVE-2023-43804");
  script_xref(name:"RHSA", value:"2023:6158");

  script_name(english:"RHEL 8 / 9 : Red Hat Ansible Automation Platform 2.4 Product Security and Bug Fix Update (Moderate) (RHSA-2023:6158)");
...
referenced in the RHSA-2023:6158 advisory.
    ...
    *  automation-controller: Django: Denial-of-service possibility in django.utils.text.Truncator
    (CVE-2023-43665)

    * python3-urllib3/python39-urllib3: Cookie request header isn't stripped during cross-origin redirects
    (CVE-2023-43804)
    ...
    * Customers using the infra.controller_configuration collection (which uses ansible.controller
    collection) to update their Ansible Automation Platform environment no longer receive an HTTP 499 response
    (AAP-17422)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6158.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?46e2eebd");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6158");
  script_set_attribute(attribute:"solution", value:
"Update the affected automation-controller-venv-tower, python3-urllib3 and / or python39-urllib3 packages.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'automation-controller-venv-tower-4.4.7-1.el8ap', 'release':'8', 'el_string':'el8ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.4', 'cves':['CVE-2023-43665']},
      {'reference':'python39-urllib3-1.26.18-1.el8ap', 'release':'8', 'el_string':'el8ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.4', 'cves':['CVE-2023-43804']}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'automation-controller-venv-tower-4.4.7-1.el9ap', 'release':'9', 'el_string':'el9ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.4', 'cves':['CVE-2023-43665']},
      {'reference':'python3-urllib3-1.26.18-1.el9ap', 'release':'9', 'el_string':'el9ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.4', 'cves':['CVE-2023-43804']}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'automation-controller-venv-tower / python3-urllib3 / etc');
}
