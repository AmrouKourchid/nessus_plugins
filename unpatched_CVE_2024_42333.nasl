...
if (description)
{
  ...
  script_cve_id("CVE-2024-42333");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-42333");
...
patch available.
  ...
  - The researcher is showing that it is possible to leak a small amount of Zabbix Server memory using an out
    of bounds read in src/libs/zbxmedia/email.c (CVE-2024-42333)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-42333");
