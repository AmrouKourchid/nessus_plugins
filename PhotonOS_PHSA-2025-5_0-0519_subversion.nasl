...
# extracted from VMware Security Advisory PHSA-2025-5.0-0519. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Subversion PHSA-2025-5.0-0519");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the subversion package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-5.0-519.md");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'subversion-1.14.2-13.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'subversion-devel-1.14.2-13.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'subversion-perl-1.14.2-13.ph5')) flag++;
