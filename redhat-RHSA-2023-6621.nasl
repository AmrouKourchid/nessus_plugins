...
# extracted from Red Hat Security Advisory RHSA-2023:6621. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:6621");

  script_name(english:"RHEL 9 : protobuf-c (RHSA-2023:6621)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6621.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cc2672c2");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2186673");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6621");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL protobuf-c package based on the guidance in RHSA-2023:6621.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'protobuf-c-1.3.3-13.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'protobuf-c-compiler-1.3.3-13.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'protobuf-c-devel-1.3.3-13.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
