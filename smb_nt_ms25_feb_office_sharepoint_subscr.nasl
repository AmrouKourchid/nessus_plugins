...
if (description)
{
  ...
  script_cve_id("CVE-2025-21400");
  script_xref(name:"MSKB", value:"5002681");
  script_xref(name:"MSFT", value:"MS25-5002681");
  script_xref(name:"IAVA", value:"2025-A-0106-S");

  script_name(english:"Security Updates for Microsoft SharePoint Server Subscription Edition (February 2025)");
...
security updates. It is, therefore, affected by a Remote Code Execution Vulnerability");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002681");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released KB5002681 to address this issue.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:S/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:L/UI:R/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-21400");
