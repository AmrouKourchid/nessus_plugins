...
# extracted from Fedora Security Advisory FEDORA-2023-7bad83a2e2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-7bad83a2e2");

  script_name(english:"Fedora 40 : python2.7 (2023-7bad83a2e2)");
...
FEDORA-2023-7bad83a2e2 advisory.
    ...
    ```
    * Mon Nov 27 2023 Lumr Balhar <lbalhar@redhat.com> - 2.7.18-36
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-7bad83a2e2");
  script_set_attribute(attribute:"solution", value:
"Update the affected python2.7 package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:python2.7");
...
var pkgs = [
    {'reference':'python2.7-2.7.18-36.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python2.7');
}
