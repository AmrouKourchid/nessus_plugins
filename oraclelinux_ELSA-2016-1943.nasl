...
ELSA-2016-1943 advisory.

    - Resolves: bz#1359723
      CVE-2016-5403 kvm: Qemu: virtio: unbounded memory allocation on host via guest leading to DoS
    [rhel-5.11.z]
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2016-1943.html");
...
var pkgs = [
    {'reference':'kmod-kvm-83-276.0.1.el5_11', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kmod-kvm-debug-83-276.0.1.el5_11', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kvm-83-276.0.1.el5_11', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kvm-qemu-img-83-276.0.1.el5_11', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kvm-tools-83-276.0.1.el5_11', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
