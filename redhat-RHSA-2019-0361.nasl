...
if (description)
{
  ...
  script_name(english:"RHEL 7 : rhvm-appliance (RHSA-2019:0361)");
...
referenced in the RHSA-2019:0361 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_0361.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4c02e286");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:0361");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1670464");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rhvm-appliance package based on the guidance in RHSA-2019:0361.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rhvm-appliance-4.2-20190129.0.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ovirt-'}
    ]
  }
];
