...
if (description)
{
  ...
  script_cve_id("CVE-2020-1733", "CVE-2020-1739");
  script_xref(name:"IAVB", value:"2019-B-0092-S");

  script_name(english:"Photon OS 2.0: Ansible PHSA-2020-2.0-0233");
...
if (rpm_check(release:'PhotonOS-2.0', reference:'ansible-2.7.16-2.ph2')) flag++;
