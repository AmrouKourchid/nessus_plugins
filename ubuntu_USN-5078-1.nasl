...
# extracted from Ubuntu Security Notice USN-5078-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5078-1");

  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS : Squashfs-Tools vulnerability (USN-5078-1)");
...
in the USN-5078-1 advisory.

    Richard Weinberger discovered that Squashfs-Tools mishandled certain malformed SQUASHFS files. An attacker
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5078-1");
...
"Update the affected squashfs-tools package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:squashfs-tools");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'squashfs-tools', 'pkgver': '1:4.3-6ubuntu0.18.04.4'},
    {'osver': '20.04', 'pkgname': 'squashfs-tools', 'pkgver': '1:4.4-1ubuntu0.2'}
];
