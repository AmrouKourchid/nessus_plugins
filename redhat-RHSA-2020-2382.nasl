...
# extracted from Red Hat Security Advisory RHSA-2020:2382. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_2382.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?738b2260");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:2382");
...
"Update the RHEL firefox package based on the guidance in RHSA-2020:2382.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-68.9.0-1.el8_0', 'sp':'0', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-68.9.0-1.el8_0', 'sp':'0', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
