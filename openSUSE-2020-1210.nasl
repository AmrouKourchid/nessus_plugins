...
# extracted from openSUSE Security Update openSUSE-2020-1210.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : hylafax+ (openSUSE-2020-1210)");
...
Non-security issues fixed :
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1173519");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1173521");
...
"Update the affected hylafax+ packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-15397");
...
if ( rpm_check(release:"SUSE15.1", reference:"hylafax+-7.0.3-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"hylafax+-client-7.0.3-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"hylafax+-client-debuginfo-7.0.3-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"hylafax+-debuginfo-7.0.3-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"hylafax+-debugsource-7.0.3-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libfaxutil7_0_3-7.0.3-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libfaxutil7_0_3-debuginfo-7.0.3-lp151.4.6.1") ) flag++;
