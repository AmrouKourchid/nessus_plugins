...
# extracted from Red Hat Security Advisory RHSA-2024:1919. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:1919");

  script_name(english:"RHEL 9 : sssd (RHSA-2024:1919)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_1919.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?02c8bdb3");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2223762");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:1919");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL sssd package based on the guidance in RHSA-2024:1919.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libipa_hbac-2.6.2-4.el9_0.3', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsss_autofs-2.6.2-4.el9_0.3', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsss_certmap-2.6.2-4.el9_0.3', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsss_idmap-2.6.2-4.el9_0.3', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsss_nss_idmap-2.6.2-4.el9_0.3', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsss_nss_idmap-devel-2.6.2-4.el9_0.3', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsss_simpleifp-2.6.2-4.el9_0.3', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsss_sudo-2.6.2-4.el9_0.3', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-libipa_hbac-2.6.2-4.el9_0.3', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-libsss_nss_idmap-2.6.2-4.el9_0.3', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-sss-2.6.2-4.el9_0.3', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-sss-murmur-2.6.2-4.el9_0.3', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-sssdconfig-2.6.2-4.el9_0.3', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-2.6.2-4.el9_0.3', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-ad-2.6.2-4.el9_0.3', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-client-2.6.2-4.el9_0.3', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-common-2.6.2-4.el9_0.3', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-common-pac-2.6.2-4.el9_0.3', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-dbus-2.6.2-4.el9_0.3', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-ipa-2.6.2-4.el9_0.3', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-kcm-2.6.2-4.el9_0.3', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-krb5-2.6.2-4.el9_0.3', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-krb5-common-2.6.2-4.el9_0.3', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-ldap-2.6.2-4.el9_0.3', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-nfs-idmap-2.6.2-4.el9_0.3', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-polkit-rules-2.6.2-4.el9_0.3', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-proxy-2.6.2-4.el9_0.3', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-tools-2.6.2-4.el9_0.3', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-winbind-idmap-2.6.2-4.el9_0.3', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
