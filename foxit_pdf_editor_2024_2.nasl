...
if (description)
{
  ...
  script_name(english:"Foxit PDF Editor < 2024.2 Multiple Vulnerabilities");
...
"Upgrade to Foxit PDF Editor version 2024.2 or later");
...
var constraints = [
  { 'max_version' : '11.2.8.53842', 'fixed_version' : '2024.2' },
  { 'min_version' : '12.0', 'max_version' : '12.1.4.15400', 'fixed_version' : '2024.2' },
  { 'min_version' : '13.0', 'max_version' : '13.0.1.21693', 'fixed_version' : '2024.2' },
  { 'min_version' : '2023.0', 'max_version' : '2023.3.0.23028', 'fixed_version' : '2024.2' },
  { 'fixed_version' : '2024.2', 'equal' : '2024.1.0.23997' }
];
