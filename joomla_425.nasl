...
if (description)
{
  ...
  script_name(english:"Joomla 4.0.x < 4.2.5 Joomla 4.2.5 Security and Bug Fix release (5873-joomla-4-2-5-security-and-bug-fix-release)");
...
4.2.5. It is, therefore, affected by a vulnerability.

  - Inadequate filtering of potentially malicious user input leads to reflected XSS vulnerabilities in
    com_media.. (CVE-2022-27914)
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?052c6d4c");
  # https://developer.joomla.org/security-centre/887-20221101-core-rxss-through-reflection-of-user-input-in-com-media.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?991aed08");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Joomla! version 4.2.5 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:P/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:R/S:C/C:L/I:L/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-27914");
...
var constraints = [
  { 'min_version' : '4.0.0', 'max_version' : '4.2.4', 'fixed_version' : '4.2.5' }
];
