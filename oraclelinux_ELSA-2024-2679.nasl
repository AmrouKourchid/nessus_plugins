...
# extracted from Oracle Linux Security Advisory ELSA-2024-2679.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : libxml2 (ELSA-2024-2679)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-2679.html");
...
var pkgs = [
    ...
    {'reference':'python3-libxml2-2.9.13-6.el9_4', 'cpu':'i686', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
