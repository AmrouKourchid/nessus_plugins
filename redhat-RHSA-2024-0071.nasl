...
# extracted from Red Hat Security Advisory RHSA-2024:0071. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:0071");

  script_name(english:"RHEL 9 : squid (RHSA-2024:0071)");
...
referenced in the RHSA-2024:0071 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0071.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9f5df045");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0071");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL squid package based on the guidance in RHSA-2024:0071.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'squid-5.5-6.el9_3.5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
    ]
  }
];
