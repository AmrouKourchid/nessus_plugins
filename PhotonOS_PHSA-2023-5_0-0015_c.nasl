...
# extracted from VMware Security Advisory PHSA-2023-5.0-0015. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: C PHSA-2023-5.0-0015");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the c package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-5.0-15.md");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'c-ares-1.19.1-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'c-ares-devel-1.19.1-1.ph5')) flag++;
