...
# extracted from Ubuntu Security Notice USN-5576-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5576-1");

  script_name(english:"Ubuntu 22.04 LTS : Twisted vulnerability (USN-5576-1)");
...
USN-5576-1 advisory.
    ...
    It was discovered that Twisted incorrectly parsed some types of HTTP requests in its web server
    implementation. In certain proxy or multi-server configurations, a remote attacker could craft malicious
    HTTP requests in order to obtain sensitive information.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5576-1");
...
var pkgs = [
    {'osver': '22.04', 'pkgname': 'python3-twisted', 'pkgver': '22.1.0-2ubuntu2.3'}
];
