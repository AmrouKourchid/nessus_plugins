...
# extracted from Red Hat Security Advisory RHSA-2023:7055. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 8 : webkit2gtk3 (RHSA-2023:7055)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2023:7055 advisory.
...
number.");
  # https://docs.redhat.com/en/documentation/red_hat_enterprise_linux/8/html/8.9_release_notes/index
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0a8d9b5a");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_7055.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1f8f8a6d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:7055");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2176269");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2270146");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2271437");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2271441");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2271444");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2271446");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'webkit2gtk3-2.40.5-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'webkit2gtk3-devel-2.40.5-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'webkit2gtk3-jsc-2.40.5-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'webkit2gtk3-jsc-devel-2.40.5-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
