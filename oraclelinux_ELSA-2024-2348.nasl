...
# extracted from Oracle Linux Security Advisory ELSA-2024-2348.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : python-jinja2 (ELSA-2024-2348)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-2348.html");
...
var pkgs = [
    {'reference':'python3-jinja2-2.11.3-5.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
