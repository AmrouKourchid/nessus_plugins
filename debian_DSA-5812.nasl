...
# extracted from Debian Security Advisory dsa-5812. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5812 : libecpg-compat3 - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-10976");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-10977");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-10978");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-10979");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'libecpg-compat3', 'reference': '15.9-0+deb12u1'},
    {'release': '12.0', 'prefix': 'libecpg-dev', 'reference': '15.9-0+deb12u1'},
    {'release': '12.0', 'prefix': 'libecpg6', 'reference': '15.9-0+deb12u1'},
    {'release': '12.0', 'prefix': 'libpgtypes3', 'reference': '15.9-0+deb12u1'},
    {'release': '12.0', 'prefix': 'libpq-dev', 'reference': '15.9-0+deb12u1'},
    {'release': '12.0', 'prefix': 'libpq5', 'reference': '15.9-0+deb12u1'},
    {'release': '12.0', 'prefix': 'postgresql-15', 'reference': '15.9-0+deb12u1'},
    {'release': '12.0', 'prefix': 'postgresql-client-15', 'reference': '15.9-0+deb12u1'},
    {'release': '12.0', 'prefix': 'postgresql-doc-15', 'reference': '15.9-0+deb12u1'},
    {'release': '12.0', 'prefix': 'postgresql-plperl-15', 'reference': '15.9-0+deb12u1'},
    {'release': '12.0', 'prefix': 'postgresql-plpython3-15', 'reference': '15.9-0+deb12u1'},
    {'release': '12.0', 'prefix': 'postgresql-pltcl-15', 'reference': '15.9-0+deb12u1'},
    {'release': '12.0', 'prefix': 'postgresql-server-dev-15', 'reference': '15.9-0+deb12u1'}
];
