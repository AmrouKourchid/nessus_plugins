...
# extracted from Debian Security Advisory dsa-5715. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5715 : composer - security update");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bookworm/composer");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/composer");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-35241");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-35242");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bullseye/composer");
  script_set_attribute(attribute:"solution", value:
"Upgrade the composer packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:composer");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'composer', 'reference': '2.0.9-2+deb11u3'},
    {'release': '12.0', 'prefix': 'composer', 'reference': '2.5.5-1+deb12u2'}
];
