...
if (description)
{
  ...
  script_cve_id("CVE-2020-21674");

  script_name(english:"Photon OS 2.0: Libarchive PHSA-2020-2.0-0294");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-21674");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libarchive-3.3.1-7.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libarchive-devel-3.3.1-7.ph2')) flag++;
