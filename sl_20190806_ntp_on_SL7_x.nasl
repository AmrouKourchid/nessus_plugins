...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : ntp on SL7.x x86_64 (20190806)");
...
"Security Fix(es) :
  ...
  - ntp: Stack-based buffer overflow in ntpq and ntpdc
    allows denial of service or code execution
    (CVE-2018-12327)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1908&L=SCIENTIFIC-LINUX-ERRATA&P=13421
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cef5821c");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"ntp-4.2.6p5-29.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"ntp-debuginfo-4.2.6p5-29.el7")) flag++;
if (rpm_check(release:"SL7", reference:"ntp-doc-4.2.6p5-29.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"ntp-doc-4.2.6p5-29.el7")) flag++;
if (rpm_check(release:"SL7", reference:"ntp-perl-4.2.6p5-29.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"ntp-perl-4.2.6p5-29.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"ntpdate-4.2.6p5-29.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"sntp-4.2.6p5-29.el7")) flag++;
