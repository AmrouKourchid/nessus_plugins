...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS : Linux kernel (HWE) vulnerabilities (USN-3342-2)");
...
the USN-3342-2 advisory.

    USN-3342-1 fixed vulnerabilities in the Linux kernel for Ubuntu 16.10. This update provides the
    corresponding updates for the Linux Hardware Enablement (HWE) kernel from Ubuntu 16.10 for Ubuntu 16.04
    LTS.

    USN-3333-1 fixed a vulnerability in the Linux kernel. However, that fix introduced regressions for some
    Java applications. This update addresses the issue. We apologize for the inconvenience.

    It was discovered that a use-after-free flaw existed in the filesystem encryption subsystem in the Linux
    kernel. A local attacker could use this to cause a denial of service (system crash). (CVE-2017-7374)
    ...
    Ingo Molnar discovered that the VideoCore DRM driver in the Linux kernel did not return an error after
    detecting certain overflows. A local attacker could exploit this issue to cause a denial of service
    (OOPS). (CVE-2017-5577)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3342-2");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.8.0-58-generic");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.8.0-58-generic-lpae");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.8.0-58-lowlatency");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-3342-2');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2017-5577', 'CVE-2017-7294', 'CVE-2017-7374', 'CVE-2017-8890', 'CVE-2017-9074', 'CVE-2017-9075', 'CVE-2017-9076', 'CVE-2017-9077', 'CVE-2017-9242', 'CVE-2017-1000363');
