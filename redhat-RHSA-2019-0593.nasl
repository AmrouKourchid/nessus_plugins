...
# extracted from Red Hat Security Advisory RHSA-2019:0593. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:0593");

  script_name(english:"RHEL 7 : openstack-octavia (RHSA-2019:0593)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for openstack-octavia.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2019:0593 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1547449");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1633019");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1634986");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1649165");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1672299");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_0593.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d099ea1a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:0593");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL openstack-octavia package based on the guidance in RHSA-2019:0593.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openstack-octavia-amphora-agent-3.0.2-0.20181219195054.ec4c88e.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'openstack-octavia-api-3.0.2-0.20181219195054.ec4c88e.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'openstack-octavia-common-3.0.2-0.20181219195054.ec4c88e.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'openstack-octavia-diskimage-create-3.0.2-0.20181219195054.ec4c88e.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'openstack-octavia-health-manager-3.0.2-0.20181219195054.ec4c88e.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'openstack-octavia-housekeeping-3.0.2-0.20181219195054.ec4c88e.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'openstack-octavia-worker-3.0.2-0.20181219195054.ec4c88e.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'python-octavia-3.0.2-0.20181219195054.ec4c88e.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'python-octavia-tests-golang-3.0.2-0.20181219195054.ec4c88e.el7ost', 'cpu':'ppc64le', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'python-octavia-tests-golang-3.0.2-0.20181219195054.ec4c88e.el7ost', 'cpu':'x86_64', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
