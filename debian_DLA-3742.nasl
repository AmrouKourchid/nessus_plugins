...
# extracted from Debian Security Advisory dla-3742. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3742 : libgit2-27 - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3742
advisory.
...
"Upgrade the libgit2-27 packages.");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libgit2-27', 'reference': '0.27.7+dfsg.1-0.2+deb10u2'},
    {'release': '10.0', 'prefix': 'libgit2-dev', 'reference': '0.27.7+dfsg.1-0.2+deb10u2'}
];
