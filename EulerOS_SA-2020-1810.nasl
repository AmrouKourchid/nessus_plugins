...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : libjpeg-turbo (EulerOS-SA-2020-1810)");
...
vulnerability :
  ...
  - libjpeg-turbo 2.0.4, and mozjpeg 4.0.0, has a
    ...
    via a malformed PPM input file.(CVE-2020-13790)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1810
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ad22dd1f");
...
pkgs = ["libjpeg-turbo-2.0.0-1.h1.eulerosv2r8",
        "libjpeg-turbo-devel-2.0.0-1.h1.eulerosv2r8"];
