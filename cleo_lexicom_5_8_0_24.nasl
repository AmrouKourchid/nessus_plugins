...
if (description)
{
  ...
  script_name(english:"Cleo LexiCom < 5.8.0.24 Unauthenticated Arbitrary Command Execution (CVE-2024-55956)");
...
"The version of Cleo LexiCom running on the remote host is prior to 5.8.0.24. It is, therefore, affected by an
