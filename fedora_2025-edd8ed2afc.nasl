...
# extracted from Fedora Security Advisory FEDORA-2025-edd8ed2afc
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-edd8ed2afc");

  script_name(english:"Fedora 41 : moodle (2025-edd8ed2afc)");
...
FEDORA-2025-edd8ed2afc advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-edd8ed2afc");
...
var pkgs = [
    {'reference':'moodle-4.4.8-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
