...
# extracted from Fedora Security Advisory FEDORA-2023-7d223ee343
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-7d223ee343");

  script_name(english:"Fedora 38 : python3.7 (2023-7d223ee343)");
...
FEDORA-2023-7d223ee343 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-7d223ee343");
...
var pkgs = [
    {'reference':'python3.7-3.7.17-4.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
