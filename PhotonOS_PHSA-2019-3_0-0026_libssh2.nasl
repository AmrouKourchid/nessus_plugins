...
if (description)
{
  ...
  script_cve_id("CVE-2019-13115");

  script_name(english:"Photon OS 3.0: Libssh2 PHSA-2019-3.0-0026");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-13115");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libssh2-1.9.0-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libssh2-debuginfo-1.9.0-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libssh2-devel-1.9.0-1.ph3')) flag++;
