...
if (description)
{
  ...
  script_cve_id("CVE-2018-2773", "CVE-2023-22084");

  script_name(english:"RHEL 8 : mysql (Unpatched Vulnerability) (deprecated)");
...
"This plugin has been deprecated as it does not adhere to established standards for this style of check.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2023-22084");
