...
"The version of Google Chrome installed on the remote Windows host is prior to 120.0.6099.62. It is, therefore, affected
by multiple vulnerabilities as referenced in the 2023_12_stable-channel-update-for-desktop advisory.
...
google_chrome_check_version(installs:installs, fix:'120.0.6099.62', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
