...
# extracted from Amazon Linux 2 Security Advisory ALAS-2019-1223.
#
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : python-jinja2 (ALAS-2019-1223)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"In Pallets Jinja, str.format allows a sandbox escape. (CVE-2016-10745)");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2019-1223.html");
...
flag = 0;
if (rpm_check(release:"AL2", reference:"python-jinja2-2.7.2-3.amzn2")) flag++;
