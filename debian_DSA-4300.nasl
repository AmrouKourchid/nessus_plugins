...
archive extraction.");
  script_set_attribute(attribute:"see_also", value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=902882");
  # https://security-tracker.debian.org/tracker/source-package/libarchive-zip-perl
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ef2cace5");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/stretch/libarchive-zip-perl");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2018/dsa-4300");
