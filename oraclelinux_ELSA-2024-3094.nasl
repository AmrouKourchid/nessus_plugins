...
# extracted from Oracle Linux Security Advisory ELSA-2024-3094.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : perl-CPAN (ELSA-2024-3094)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-3094.html");
...
var pkgs = [
    {'reference':'perl-CPAN-2.18-399.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
