...
if (description)
{
  ...
  script_name(english:"CentOS 9 : python3.11-3.11.5-1.el9");
...
python3.11-3.11.5-1.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=40126");
...
var pkgs = [
    {'reference':'python3.11-3.11.5-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3.11-debug-3.11.5-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3.11-devel-3.11.5-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3.11-idle-3.11.5-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3.11-libs-3.11.5-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3.11-test-3.11.5-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3.11-tkinter-3.11.5-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
