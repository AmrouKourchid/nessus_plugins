...
if (description)
{
  ...
  script_cve_id("CVE-2021-26934");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2021-26934");
...
patch available.
  ...
  - An issue was discovered in the Linux kernel 4.18 through 5.10.16, as used by Xen. The backend allocation
    (aka be-alloc) mode of the drm_xen_front drivers was not meant to be a supported configuration, but this
    wasn't stated accordingly in its support status entry. (CVE-2021-26934)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-26934");
