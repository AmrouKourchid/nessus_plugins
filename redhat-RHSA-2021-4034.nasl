...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_4034.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e0bb527e");
...
"Update the RHEL binutils package based on the guidance in RHSA-2021:4034.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'binutils-2.27-41.base.el7_7.4', 'sp':'7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'binutils-devel-2.27-41.base.el7_7.4', 'sp':'7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
