...
# extracted from Red Hat Security Advisory RHSA-2023:2179. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:2179");

  script_name(english:"RHEL 9 : libguestfs-winsupport (RHSA-2023:2179)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for libguestfs-winsupport.");
...
referenced in the RHSA-2023:2179 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_2179.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6f77119e");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:2179");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libguestfs-winsupport package based on the guidance in RHSA-2023:2179.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libguestfs-winsupport-9.2-1.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libguestfs-winsupport-9.2-1.el9', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libguestfs-winsupport-9.2-1.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
