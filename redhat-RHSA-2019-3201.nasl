...
# extracted from Red Hat Security Advisory RHSA-2019:3201. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:3201");

  script_name(english:"RHEL 7 : Ansible (RHSA-2019:3201)");
...
referenced in the RHSA-2019:3201 advisory.
    ...
    * ansible: secrets disclosed on logs when no_log enabled (CVE-2019-14846)
    ...
    See: https://github.com/ansible/ansible/blob/v2.6.20/changelogs/CHANGELOG-v2.6.rst for details on bug
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_3201.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0a7bf197");
  # https://github.com/ansible/ansible/blob/v2.6.20/changelogs/CHANGELOG-v2.6.rst
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d45e4931");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:3201");
...
"Update the RHEL Ansible package based on the guidance in RHSA-2019:3201.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ansible-2.6.20-1.el7ae', 'release':'7', 'el_string':'el7ae', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2.6'}
    ]
  }
];
