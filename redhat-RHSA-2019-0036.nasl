...
# extracted from Red Hat Security Advisory RHSA-2019:0036. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:0036");

  script_name(english:"RHEL 7 : source-to-image (RHSA-2019:0036)");
...
the RHSA-2019:0036 advisory.

    Source-to-Image (S2I) is a tool for building reproducible container images. It produces ready-to-run
    images by injecting a user source into a container image and assembling a new container image. The new
    image incorporates the base image (the builder) and built source, and is ready to use with the docker
    run command. S2I supports incremental builds, which re-use previously downloaded dependencies, previously
    built artifacts, and more.

    The following packages have been upgraded to a later upstream version: source-to-image (1.1.13).
    (BZ#1654243)
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1336631");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1450131");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1562246");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_0036.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9b7a1ba8");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:0036");
  script_set_attribute(attribute:"solution", value:
"Update the affected source-to-image package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:source-to-image");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'source-to-image-1.1.13-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'source-to-image');
}
