...
if (description)
{
  ...
  script_cve_id("CVE-2023-23005");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2023-23005");
...
patch available.
  ...
  - In the Linux kernel before 6.2, mm/memory-tiers.c misinterprets the alloc_memory_type return value
    (expects it to be NULL in the error case, whereas it is actually an error pointer). NOTE: this is disputed
    by third parties because there are no realistic cases in which a user can cause the alloc_memory_type
    error case to be reached. (CVE-2023-23005)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-23005");
