...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : zsh (EulerOS-SA-2020-1329)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1329
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1cf35b42");
...
pkgs = ["zsh-5.0.2-28.h11.eulerosv2r7"];
