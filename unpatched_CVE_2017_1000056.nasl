...
if (description)
{
  ...
  script_cve_id("CVE-2017-1000056");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2017-1000056");
...
patch available.
  ...
  - Kubernetes version 1.5.0-1.5.4 is vulnerable to a privilege escalation in the PodSecurityPolicy admission
    plugin resulting in the ability to make use of any existing PodSecurityPolicy object. (CVE-2017-1000056)
