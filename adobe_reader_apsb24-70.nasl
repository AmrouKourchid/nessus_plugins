...
if (description)
{
  ...
  script_name(english:"Adobe Reader < 20.005.30680 / 24.003.20112 Multiple Vulnerabilities (APSB24-70)");
...
"The version of Adobe Reader installed on the remote Windows host is a version prior to 20.005.30680 or 24.003.20112. It
...
"Upgrade to Adobe Reader version 20.005.30680 / 24.003.20112 or later.");
...
var constraints = [
  ...
  { 'min_version' : '15.7', 'max_version' : '24.003.20054', 'fixed_version' : '24.003.20112', 'track' : 'DC Continuous' }
];
