...
# extracted from Fedora Security Advisory FEDORA-2024-1d4155bd39
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-1d4155bd39");

  script_name(english:"Fedora 39 : microcode_ctl (2024-1d4155bd39)");
...
FEDORA-2024-1d4155bd39 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-1d4155bd39");
...
var pkgs = [
    {'reference':'microcode_ctl-2.1-58.3.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
