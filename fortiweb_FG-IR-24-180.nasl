...
if (description)
{
  ...
  script_cve_id("CVE-2024-36509");

  script_name(english:"Fortinet FortiWeb Exposure of password hashes to read-only admin (FG-IR-24-180)");
...
vulnerability as referenced in the FG-IR-24-180 advisory.

  - An exposure of sensitive system information to an unauthorized control sphere vulnerability [CWE-497] in
    FortiWeb version 7.6.0, version 7.4.3 and below, version 7.2.10 and below, version 7.0.10 and below,
    version 6.3.23 and below may allow an authenticated attacker to access the encrypted passwords of other
    administrators via the Log Access Event logs page. (CVE-2024-36509)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.fortiguard.com/psirt/FG-IR-24-180");
  script_set_attribute(attribute:"solution", value:
"Upgrade to FortiWeb version 6.3.999999 / 7.0.999999 / 7.2.999999 / 7.4.4 / 7.6.1 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-36509");
