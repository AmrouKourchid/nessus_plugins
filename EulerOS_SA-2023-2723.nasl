...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.1 : glib2 (EulerOS-SA-2023-2723)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2723
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?339b58f1");
...
var pkgs = [
  "glib2-2.68.1-10.h12.eulerosv2r11"
];
