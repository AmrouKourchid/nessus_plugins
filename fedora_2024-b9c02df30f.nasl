...
# extracted from Fedora Security Advisory FEDORA-2024-b9c02df30f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-b9c02df30f");

  script_name(english:"Fedora 38 : sofia-sip (2024-b9c02df30f)");
...
FEDORA-2024-b9c02df30f advisory.

    Security fix for CVE-2023-32307

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-b9c02df30f");
  script_set_attribute(attribute:"solution", value:
"Update the affected sofia-sip package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:sofia-sip");
...
var pkgs = [
    {'reference':'sofia-sip-1.13.12-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
