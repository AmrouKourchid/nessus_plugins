...
# extracted from Ubuntu Security Notice USN-2434-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"2434-1");

  script_name(english:"Ubuntu 14.04 LTS : JasPer vulnerability (USN-2434-1)");
...
USN-2434-1 advisory.
    ...
    Jose Duart discovered that JasPer incorrectly handled certain malformed JPEG-2000 image files. If a user
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2434-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'libjasper-dev', 'pkgver': '1.900.1-14ubuntu3.1'},
    {'osver': '14.04', 'pkgname': 'libjasper-runtime', 'pkgver': '1.900.1-14ubuntu3.1'},
    {'osver': '14.04', 'pkgname': 'libjasper1', 'pkgver': '1.900.1-14ubuntu3.1'}
];
