...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2022-A-0211-S");

  script_name(english:"Foxit PDF Editor < 11.2.2 Multiple Vulnerabilities");
...
Windows host is prior to 11.2.2. It is, therefore affected by multiple vulnerabilities:
...
"Upgrade to Foxit PDF Editor version 11.2.2 or later");
...
var constraints = [
  { 'max_version' : '10.1.7.37777', 'fixed_version' : '11.2.2' },
  { 'min_version' : '11.0', 'max_version' : '11.2.1.53537', 'fixed_version' : '11.2.2' }
];
