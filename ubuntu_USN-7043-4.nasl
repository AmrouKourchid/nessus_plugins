...
# extracted from Ubuntu Security Notice USN-7043-4. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"7043-4");

  script_name(english:"Ubuntu 20.04 LTS / 22.04 LTS : cups-filters vulnerabilities (USN-7043-4)");
...
referenced in the USN-7043-4 advisory.

    USN-7043-1 fixed vulnerabilities in cups-filters. This update improves the fix for CVE-2024-47176 by
    removing support for the legacy CUPS printer discovery protocol entirely.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7043-4");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'cups-browsed', 'pkgver': '1.27.4-1ubuntu0.4'},
    {'osver': '20.04', 'pkgname': 'cups-filters', 'pkgver': '1.27.4-1ubuntu0.4'},
    {'osver': '20.04', 'pkgname': 'cups-filters-core-drivers', 'pkgver': '1.27.4-1ubuntu0.4'},
    {'osver': '20.04', 'pkgname': 'libcupsfilters-dev', 'pkgver': '1.27.4-1ubuntu0.4'},
    {'osver': '20.04', 'pkgname': 'libcupsfilters1', 'pkgver': '1.27.4-1ubuntu0.4'},
    {'osver': '20.04', 'pkgname': 'libfontembed-dev', 'pkgver': '1.27.4-1ubuntu0.4'},
    {'osver': '20.04', 'pkgname': 'libfontembed1', 'pkgver': '1.27.4-1ubuntu0.4'},
    {'osver': '22.04', 'pkgname': 'cups-browsed', 'pkgver': '1.28.15-0ubuntu1.4'},
    {'osver': '22.04', 'pkgname': 'cups-filters', 'pkgver': '1.28.15-0ubuntu1.4'},
    {'osver': '22.04', 'pkgname': 'cups-filters-core-drivers', 'pkgver': '1.28.15-0ubuntu1.4'},
    {'osver': '22.04', 'pkgname': 'libcupsfilters-dev', 'pkgver': '1.28.15-0ubuntu1.4'},
    {'osver': '22.04', 'pkgname': 'libcupsfilters1', 'pkgver': '1.28.15-0ubuntu1.4'},
    {'osver': '22.04', 'pkgname': 'libfontembed-dev', 'pkgver': '1.28.15-0ubuntu1.4'},
    {'osver': '22.04', 'pkgname': 'libfontembed1', 'pkgver': '1.28.15-0ubuntu1.4'}
];
