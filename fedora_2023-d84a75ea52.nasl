...
# extracted from Fedora Security Advisory FEDORA-2023-d84a75ea52
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-d84a75ea52");

  script_name(english:"Fedora 37 : git (2023-d84a75ea52)");
...
FEDORA-2023-d84a75ea52 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-d84a75ea52");
...
var pkgs = [
    {'reference':'git-2.40.1-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
