...
# extracted from openSUSE Security Update openSUSE-2020-2028.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : postgresql10 (openSUSE-2020-2028)");
...
project.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.postgresql.org/docs/10/release-10-15.html");
...
if ( rpm_check(release:"SUSE15.1", reference:"postgresql10-10.15-lp151.2.21.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"postgresql10-contrib-10.15-lp151.2.21.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"postgresql10-contrib-debuginfo-10.15-lp151.2.21.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"postgresql10-debuginfo-10.15-lp151.2.21.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"postgresql10-debugsource-10.15-lp151.2.21.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"postgresql10-devel-10.15-lp151.2.21.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"postgresql10-devel-debuginfo-10.15-lp151.2.21.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"postgresql10-plperl-10.15-lp151.2.21.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"postgresql10-plperl-debuginfo-10.15-lp151.2.21.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"postgresql10-plpython-10.15-lp151.2.21.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"postgresql10-plpython-debuginfo-10.15-lp151.2.21.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"postgresql10-pltcl-10.15-lp151.2.21.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"postgresql10-pltcl-debuginfo-10.15-lp151.2.21.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"postgresql10-server-10.15-lp151.2.21.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"postgresql10-server-debuginfo-10.15-lp151.2.21.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"postgresql10-test-10.15-lp151.2.21.1") ) flag++;
