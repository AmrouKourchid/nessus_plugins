...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : emacs (EulerOS-SA-2024-2412)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2412
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?90ed78ce");
...
var pkgs = [
  "emacs-filesystem-27.1-4.h10.eulerosv2r10"
];
