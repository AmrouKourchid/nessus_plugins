...
# extracted from Fedora Security Advisory FEDORA-2021-954ebabcf7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-954ebabcf7");

  script_name(english:"Fedora 32 : isync (2021-954ebabcf7)");
...
FEDORA-2021-954ebabcf7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-954ebabcf7");
...
pkgs = [
    {'reference':'isync-1.4.1-1.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE}
];
