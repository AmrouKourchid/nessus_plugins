...
# extracted from Ubuntu Security Notice USN-7129-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"7129-1");

  script_name(english:"Ubuntu 22.04 LTS : TinyGLTF vulnerability (USN-7129-1)");
...
USN-7129-1 advisory.
    ...
    It was discovered that TinyGLTF performed file path expansion in an insecure way on certain inputs. An
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7129-1");
  script_set_attribute(attribute:"solution", value:
"Update the affected libtinygltf-dev and / or libtinygltf1d packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:libtinygltf-dev");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:libtinygltf1d");
...
var pkgs = [
    {'osver': '22.04', 'pkgname': 'libtinygltf-dev', 'pkgver': '2.5.0+dfsg-4ubuntu0.1'},
    {'osver': '22.04', 'pkgname': 'libtinygltf1d', 'pkgver': '2.5.0+dfsg-4ubuntu0.1'}
];
