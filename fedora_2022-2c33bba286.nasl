...
# extracted from Fedora Security Advisory FEDORA-2022-2c33bba286
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-2c33bba286");

  script_name(english:"Fedora 37 : moby-engine (2022-2c33bba286)");
...
FEDORA-2022-2c33bba286 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-2c33bba286");
...
var pkgs = [
    {'reference':'moby-engine-20.10.20-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
