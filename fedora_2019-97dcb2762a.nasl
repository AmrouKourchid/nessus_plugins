...
# extracted from Fedora Security Advisory FEDORA-2019-97dcb2762a.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-97dcb2762a");

  script_name(english:"Fedora 30 : file (2019-97dcb2762a)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"- fix heap-based buffer overflow in
    cdf_read_property_info() (CVE-2019-18218)

Note that Tenable Network Security has extracted the preceding
description block directly from the Fedora update system website.
Tenable has attempted to automatically clean and format it as much as
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-97dcb2762a");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"file-5.36-5.fc30")) flag++;
