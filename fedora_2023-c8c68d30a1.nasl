...
# extracted from Fedora Security Advisory FEDORA-2023-c8c68d30a1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-c8c68d30a1");

  script_name(english:"Fedora 39 : attract-mode (2023-c8c68d30a1)");
...
FEDORA-2023-c8c68d30a1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-c8c68d30a1");
...
var pkgs = [
    {'reference':'attract-mode-2.7.0-5.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
