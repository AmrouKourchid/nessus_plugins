...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Pmd PHSA-2023-4.0-0415");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the pmd package has been released.");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'pmd-ng-0.1-2.ph4')) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'pmd');
}
