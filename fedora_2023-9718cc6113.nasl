...
# extracted from Fedora Security Advisory FEDORA-2023-9718cc6113
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-9718cc6113");

  script_name(english:"Fedora 37 : git (2023-9718cc6113)");
...
FEDORA-2023-9718cc6113 advisory.

    Update to 2.39.1 (CVE-2022-41903, CVE-2022-23521)

    Refer to the [upstream release
    notes](https://github.com/git/git/raw/v2.39.1/Documentation/RelNotes/2.30.7.txt) and the security
    advisories ([CVE-2022-41903](https://github.com/git/git/security/advisories/GHSA-475x-2q3q-hvwq),
    [CVE-2022-23521](https://github.com/git/git/security/advisories/GHSA-c738-c5qq-xg89)) for details.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-9718cc6113");
...
var pkgs = [
    {'reference':'git-2.39.1-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
