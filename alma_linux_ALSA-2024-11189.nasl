...
# AlmaLinux Security Advisory ALSA-2024:11189.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:11189");
  script_xref(name:"RHSA", value:"2024:11189");

  script_name(english:"AlmaLinux 8 : python3.11-urllib3 (ALSA-2024:11189)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2024-11189.html");
...
var pkgs = [
    {'reference':'python3.11-urllib3-1.26.12-5.el8_10', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'}
];
