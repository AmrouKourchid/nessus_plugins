...
# Red Hat Security Advisory RHSA-2023:7187. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : procps-ng (CESA-2023:7187)");
...
"Update the affected procps-ng-devel package.");
...
var pkgs = [
    {'reference':'procps-ng-devel-3.3.15-1.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'procps-ng-devel-3.3.15-1.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'procps-ng-devel');
}
