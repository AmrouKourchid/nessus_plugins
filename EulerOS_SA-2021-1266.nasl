...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : ksh (EulerOS-SA-2021-1266)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1266
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?34086e4e");
...
pkgs = ["ksh-2020.0.0-2.h3.eulerosv2r9"];
