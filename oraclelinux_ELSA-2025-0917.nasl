...
# extracted from Oracle Linux Security Advisory ELSA-2025-0917.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : keepalived (ELSA-2025-0917)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2025-0917.html");
...
var pkgs = [
    {'reference':'keepalived-2.2.8-4.el9_5', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'keepalived-2.2.8-4.el9_5', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
