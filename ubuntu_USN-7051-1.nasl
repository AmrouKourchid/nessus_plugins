...
# extracted from Ubuntu Security Notice USN-7051-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"7051-1");

  script_name(english:"Ubuntu 20.04 LTS / 22.04 LTS / 24.04 LTS : AsyncSSH vulnerability (USN-7051-1)");
...
referenced in the USN-7051-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7051-1");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'python3-asyncssh', 'pkgver': '1.12.2-1ubuntu0.1', 'ubuntu_pro': FALSE},
    {'osver': '22.04', 'pkgname': 'python3-asyncssh', 'pkgver': '2.5.0-1ubuntu0.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '24.04', 'pkgname': 'python3-asyncssh', 'pkgver': '2.10.1-2ubuntu0.1', 'ubuntu_pro': FALSE}
];
