...
# extracted from Fedora Security Advisory FEDORA-2023-26ffe7d3c7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-26ffe7d3c7");

  script_name(english:"Fedora 39 : kernel (2023-26ffe7d3c7)");
...
FEDORA-2023-26ffe7d3c7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-26ffe7d3c7");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for FEDORA-2023-26ffe7d3c7');
  }
  else
  {
...
var pkgs = [
    {'reference':'kernel-6.6.7-200.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
