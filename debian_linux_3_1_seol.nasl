...
if (description)
{
  ...
  script_name(english:"Debian Linux SEoL (3.1.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Debian Linux is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Debian Linux is 3.1.x. It is, therefore, no longer maintained by its vendor or provider.

Lack of support implies that no new security patches for the product will be released by the vendor. As a result, it may
contain security vulnerabilities.");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/News/2008/20080229");
...
"Upgrade to a version of Debian Linux that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2008/03/31");
...
var constraints = [
  { max_branch : '3.1', min_branch : '3.1', seol : 20080331 }
];
