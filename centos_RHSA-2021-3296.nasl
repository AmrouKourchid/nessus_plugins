...
# extracted from Red Hat Security Advisory RHSA-2021:3296 and
# CentOS Errata and Security Advisory 2021:3296 respectively.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : libX11 (RHSA-2021:3296)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 7 host has packages installed that are affected by a vulnerability as referenced in the
RHSA-2021:3296 advisory.
...
var pkgs = [
    {'reference':'libX11-1.6.7-4.el7_9', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libX11-1.6.7-4.el7_9', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libX11-common-1.6.7-4.el7_9', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libX11-common-1.6.7-4.el7_9', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libX11-devel-1.6.7-4.el7_9', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libX11-devel-1.6.7-4.el7_9', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE}
];
