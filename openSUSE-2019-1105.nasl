...
# extracted from openSUSE Security Update openSUSE-2019-1105.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : openssl-1_0_0 (openSUSE-2019-1105)");
...
if ( rpm_check(release:"SUSE15.0", reference:"libopenssl-1_0_0-devel-1.0.2p-lp150.2.13.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libopenssl1_0_0-1.0.2p-lp150.2.13.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libopenssl1_0_0-debuginfo-1.0.2p-lp150.2.13.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libopenssl1_0_0-hmac-1.0.2p-lp150.2.13.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"openssl-1_0_0-1.0.2p-lp150.2.13.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"openssl-1_0_0-cavs-1.0.2p-lp150.2.13.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"openssl-1_0_0-cavs-debuginfo-1.0.2p-lp150.2.13.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"openssl-1_0_0-debuginfo-1.0.2p-lp150.2.13.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"openssl-1_0_0-debugsource-1.0.2p-lp150.2.13.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libopenssl-1_0_0-devel-32bit-1.0.2p-lp150.2.13.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libopenssl1_0_0-32bit-1.0.2p-lp150.2.13.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libopenssl1_0_0-32bit-debuginfo-1.0.2p-lp150.2.13.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libopenssl1_0_0-hmac-32bit-1.0.2p-lp150.2.13.1") ) flag++;
