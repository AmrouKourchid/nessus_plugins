...
# extracted from Fedora Security Advisory FEDORA-2024-1a79c2ef63
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-1a79c2ef63");

  script_name(english:"Fedora 39 : clamav (2024-1a79c2ef63)");
...
FEDORA-2024-1a79c2ef63 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-1a79c2ef63");
...
var pkgs = [
    {'reference':'clamav-1.0.6-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
