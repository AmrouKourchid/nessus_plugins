...
# extracted from Fedora Security Advisory FEDORA-2018-c188d3f09a.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 26 : unboundid-ldapsdk (2018-c188d3f09a)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-c188d3f09a");
...
flag = 0;
if (rpm_check(release:"FC26", reference:"unboundid-ldapsdk-4.0.5-1.fc26")) flag++;
