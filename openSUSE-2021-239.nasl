...
# extracted from openSUSE Security Update openSUSE-2021-239.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : openvswitch (openSUSE-2021-239)");
...
"This update for openvswitch fixes the following issues :
  ...
  - CVE-2020-27827: Fixed a memory leak when parsing lldp
    packets (bsc#1181345)

This update was imported from the SUSE:SLE-15-SP2:Update update
project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1117483");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1181345");
...
if ( rpm_check(release:"SUSE15.2", reference:"libopenvswitch-2_13-0-2.13.2-lp152.3.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libopenvswitch-2_13-0-debuginfo-2.13.2-lp152.3.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libovn-20_03-0-20.03.1-lp152.3.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libovn-20_03-0-debuginfo-20.03.1-lp152.3.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"openvswitch-2.13.2-lp152.3.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"openvswitch-debuginfo-2.13.2-lp152.3.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"openvswitch-debugsource-2.13.2-lp152.3.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"openvswitch-devel-2.13.2-lp152.3.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"openvswitch-ipsec-2.13.2-lp152.3.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"openvswitch-pki-2.13.2-lp152.3.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"openvswitch-test-2.13.2-lp152.3.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"openvswitch-test-debuginfo-2.13.2-lp152.3.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"openvswitch-vtep-2.13.2-lp152.3.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"openvswitch-vtep-debuginfo-2.13.2-lp152.3.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"ovn-20.03.1-lp152.3.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"ovn-central-20.03.1-lp152.3.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"ovn-central-debuginfo-20.03.1-lp152.3.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"ovn-debuginfo-20.03.1-lp152.3.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"ovn-devel-20.03.1-lp152.3.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"ovn-docker-20.03.1-lp152.3.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"ovn-host-20.03.1-lp152.3.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"ovn-host-debuginfo-20.03.1-lp152.3.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"ovn-vtep-20.03.1-lp152.3.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"ovn-vtep-debuginfo-20.03.1-lp152.3.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"python3-ovs-2.13.2-lp152.3.9.1") ) flag++;
