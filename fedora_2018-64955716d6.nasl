...
# extracted from Fedora Security Advisory FEDORA-2018-64955716d6.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : moodle (2018-64955716d6)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-64955716d6");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"moodle-3.4.4-1.fc28")) flag++;
