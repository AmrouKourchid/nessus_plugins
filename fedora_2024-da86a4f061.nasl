...
# extracted from Fedora Security Advisory FEDORA-2024-da86a4f061
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-da86a4f061");

  script_name(english:"Fedora 40 : mingw-python-urllib3 (2024-da86a4f061)");
...
FEDORA-2024-da86a4f061 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-da86a4f061");
  script_set_attribute(attribute:"solution", value:
"Update the affected mingw-python-urllib3 package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:mingw-python-urllib3");
...
var pkgs = [
    {'reference':'mingw-python-urllib3-1.26.19-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'mingw-python-urllib3');
}
