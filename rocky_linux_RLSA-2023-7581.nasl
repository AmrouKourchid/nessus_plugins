...
# Rocky Linux Security Advisory RLSA-2023:7581.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2023:7581");
  script_xref(name:"IAVB", value:"2023-B-0088-S");

  script_name(english:"Rocky Linux 8 : postgresql:13 (RLSA-2023:7581)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Rocky Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Rocky Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
RLSA-2023:7581 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2023:7581");
...
var appstreams = {
    'postgresql:13': [
      ...
      {'reference':'postgresql-13.13-1.module+el8.9.0+1593+6cfc6c10', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-contrib-13.13-1.module+el8.9.0+1593+6cfc6c10', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-contrib-debuginfo-13.13-1.module+el8.9.0+1593+6cfc6c10', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-debuginfo-13.13-1.module+el8.9.0+1593+6cfc6c10', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-debugsource-13.13-1.module+el8.9.0+1593+6cfc6c10', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-docs-13.13-1.module+el8.9.0+1593+6cfc6c10', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-docs-debuginfo-13.13-1.module+el8.9.0+1593+6cfc6c10', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-plperl-13.13-1.module+el8.9.0+1593+6cfc6c10', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-plperl-debuginfo-13.13-1.module+el8.9.0+1593+6cfc6c10', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-plpython3-13.13-1.module+el8.9.0+1593+6cfc6c10', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-plpython3-debuginfo-13.13-1.module+el8.9.0+1593+6cfc6c10', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-pltcl-13.13-1.module+el8.9.0+1593+6cfc6c10', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-pltcl-debuginfo-13.13-1.module+el8.9.0+1593+6cfc6c10', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-server-13.13-1.module+el8.9.0+1593+6cfc6c10', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-server-debuginfo-13.13-1.module+el8.9.0+1593+6cfc6c10', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-server-devel-13.13-1.module+el8.9.0+1593+6cfc6c10', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-server-devel-debuginfo-13.13-1.module+el8.9.0+1593+6cfc6c10', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-static-13.13-1.module+el8.9.0+1593+6cfc6c10', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-test-13.13-1.module+el8.9.0+1593+6cfc6c10', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-test-debuginfo-13.13-1.module+el8.9.0+1593+6cfc6c10', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-test-rpm-macros-13.13-1.module+el8.9.0+1593+6cfc6c10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-upgrade-13.13-1.module+el8.9.0+1593+6cfc6c10', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-upgrade-debuginfo-13.13-1.module+el8.9.0+1593+6cfc6c10', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-upgrade-devel-13.13-1.module+el8.9.0+1593+6cfc6c10', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-upgrade-devel-debuginfo-13.13-1.module+el8.9.0+1593+6cfc6c10', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
};
