...
# Oracle Linux Security Advisory ELSA-2020-0197 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : python-reportlab (ELSA-2020-0197)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2020-0197.html");
...
var pkgs = [
    ...
    {'reference':'python-reportlab-docs-2.3-3.el6_10.1', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python-reportlab-2.3-3.el6_10.1', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python-reportlab-docs-2.3-3.el6_10.1', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
];
