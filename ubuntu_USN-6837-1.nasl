...
# extracted from Ubuntu Security Notice USN-6837-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6837-1");

  script_name(english:"Ubuntu 23.10 / 24.04 LTS : Rack vulnerabilities (USN-6837-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 23.10 / 24.04 LTS host has a package installed that is affected by multiple vulnerabilities as
referenced in the USN-6837-1 advisory.
    ...
    affected Ubuntu 23.10. (CVE-2023-27530)
    ...
    use this issue to cause Rack to create large responses, leading to a denial of service. This issue only
    affected Ubuntu 24.04 LTS. (CVE-2024-26141)

    It was discovered that Rack incorrectly handled certain crafted headers. A remote attacker could possibly
    use this issue to cause Rack to consume resources, leading to a denial of service. This issue only
    affected Ubuntu 24.04 LTS. (CVE-2024-26146)

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6837-1");
...
var pkgs = [
    {'osver': '23.10', 'pkgname': 'ruby-rack', 'pkgver': '2.2.4-3ubuntu0.2'},
    {'osver': '24.04', 'pkgname': 'ruby-rack', 'pkgver': '2.2.7-1ubuntu0.1'}
];
