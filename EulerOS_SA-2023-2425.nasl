...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : httpd (EulerOS-SA-2023-2425)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2425
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?251cc8a9");
...
var pkgs = [
  "httpd-2.4.6-80.1.h20.eulerosv2r7",
  "httpd-devel-2.4.6-80.1.h20.eulerosv2r7",
  "httpd-manual-2.4.6-80.1.h20.eulerosv2r7",
  "httpd-tools-2.4.6-80.1.h20.eulerosv2r7",
  "mod_session-2.4.6-80.1.h20.eulerosv2r7",
  "mod_ssl-2.4.6-80.1.h20.eulerosv2r7"
];
