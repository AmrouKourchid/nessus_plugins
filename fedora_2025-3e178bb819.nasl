...
# extracted from Fedora Security Advisory FEDORA-2025-3e178bb819
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-3e178bb819");
  script_xref(name:"IAVA", value:"2025-A-0128-S");

  script_name(english:"Fedora 40 : vim (2025-3e178bb819)");
...
FEDORA-2025-3e178bb819 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-3e178bb819");
...
var pkgs = [
    {'reference':'vim-9.1.1122-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
