...
# extracted from SUSE update advisory SUSE-SU-2018:2979-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLED12 / SLES12 Security Update : mgetty (SUSE-SU-2018:2979-1)");
...
without introducing additional issues.");
  ...
  # https://www.suse.com/support/update/announcement/2018/suse-su-20182979-1/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?41c540f8");
...
SUSE-SLE-SERVER-12-SP3-2018-2122=1

SUSE Linux Enterprise Desktop 12-SP3:zypper in -t patch
SUSE-SLE-DESKTOP-12-SP3-2018-2122=1");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"3", reference:"g3utils-1.1.36-58.3.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"g3utils-debuginfo-1.1.36-58.3.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"mgetty-1.1.36-58.3.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"mgetty-debuginfo-1.1.36-58.3.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"mgetty-debugsource-1.1.36-58.3.1")) flag++;
if (rpm_check(release:"SLED12", sp:"3", cpu:"x86_64", reference:"g3utils-1.1.36-58.3.1")) flag++;
if (rpm_check(release:"SLED12", sp:"3", cpu:"x86_64", reference:"g3utils-debuginfo-1.1.36-58.3.1")) flag++;
if (rpm_check(release:"SLED12", sp:"3", cpu:"x86_64", reference:"mgetty-1.1.36-58.3.1")) flag++;
if (rpm_check(release:"SLED12", sp:"3", cpu:"x86_64", reference:"mgetty-debuginfo-1.1.36-58.3.1")) flag++;
if (rpm_check(release:"SLED12", sp:"3", cpu:"x86_64", reference:"mgetty-debugsource-1.1.36-58.3.1")) flag++;
