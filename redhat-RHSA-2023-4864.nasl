...
# extracted from Red Hat Security Advisory RHSA-2023:4864. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:4864");

  script_name(english:"RHEL 8 : cups (RHSA-2023:4864)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for cups.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2023:4864 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_4864.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bf4870b3");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2230495");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:4864");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL cups package based on the guidance in RHSA-2023:4864.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cups-2.2.6-51.el8_8.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'cups-client-2.2.6-51.el8_8.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'cups-devel-2.2.6-51.el8_8.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'cups-filesystem-2.2.6-51.el8_8.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'cups-ipptool-2.2.6-51.el8_8.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'cups-libs-2.2.6-51.el8_8.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'cups-lpd-2.2.6-51.el8_8.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'cups-2.2.6-51.el8_8.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'cups-client-2.2.6-51.el8_8.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'cups-devel-2.2.6-51.el8_8.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'cups-filesystem-2.2.6-51.el8_8.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'cups-ipptool-2.2.6-51.el8_8.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'cups-libs-2.2.6-51.el8_8.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'cups-lpd-2.2.6-51.el8_8.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
