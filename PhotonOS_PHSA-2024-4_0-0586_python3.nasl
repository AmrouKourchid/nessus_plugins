...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Python3 PHSA-2024-4.0-0586");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'python3-cryptography-41.0.7-2.ph4')) flag++;
