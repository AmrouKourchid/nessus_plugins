...
# extracted from Fedora Security Advisory FEDORA-2023-6f4c5b6331
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-6f4c5b6331");

  script_name(english:"Fedora 38 : gmailctl (2023-6f4c5b6331)");
...
FEDORA-2023-6f4c5b6331 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-6f4c5b6331");
  script_set_attribute(attribute:"solution", value:
"Update the affected gmailctl package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:gmailctl");
...
var pkgs = [
    {'reference':'gmailctl-0.10.7-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'gmailctl');
}
