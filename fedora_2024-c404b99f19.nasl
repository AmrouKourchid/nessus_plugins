...
# extracted from Fedora Security Advisory FEDORA-2024-c404b99f19
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-c404b99f19");
  script_xref(name:"IAVA", value:"2024-A-0144-S");

  script_name(english:"Fedora 40 : tomcat (2024-c404b99f19)");
...
FEDORA-2024-c404b99f19 advisory.

    This update includes a rebase from 9.0.83 to 9.0.89.

    * [#2269611](https://bugzilla.redhat.com/show_bug.cgi?id=2269611) CVE-2024-24549 tomcat: CVE-2024-24549:
    Apache Tomcat: HTTP/2 header handling DoS
    * [#2269612](https://bugzilla.redhat.com/show_bug.cgi?id=2269612)  CVE-2024-23672 tomcat: Apache Tomcat:
    WebSocket DoS with incomplete closing handshake
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-c404b99f19");
...
var pkgs = [
    {'reference':'tomcat-9.0.89-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
