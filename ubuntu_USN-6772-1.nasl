...
# extracted from Ubuntu Security Notice USN-6772-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6772-1");

  script_name(english:"Ubuntu 22.04 LTS : strongSwan vulnerability (USN-6772-1)");
...
USN-6772-1 advisory.
    ...
    Jan Schermer discovered that strongSwan incorrectly validated client certificates in certain
    configurations. A remote attacker could possibly use this issue to bypass access controls.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6772-1");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-4967");
...
var pkgs = [
    {'osver': '22.04', 'pkgname': 'charon-cmd', 'pkgver': '5.9.5-2ubuntu2.3'},
    {'osver': '22.04', 'pkgname': 'charon-systemd', 'pkgver': '5.9.5-2ubuntu2.3'},
    {'osver': '22.04', 'pkgname': 'libcharon-extauth-plugins', 'pkgver': '5.9.5-2ubuntu2.3'},
    {'osver': '22.04', 'pkgname': 'libcharon-extra-plugins', 'pkgver': '5.9.5-2ubuntu2.3'},
    {'osver': '22.04', 'pkgname': 'libstrongswan', 'pkgver': '5.9.5-2ubuntu2.3'},
    {'osver': '22.04', 'pkgname': 'libstrongswan-extra-plugins', 'pkgver': '5.9.5-2ubuntu2.3'},
    {'osver': '22.04', 'pkgname': 'libstrongswan-standard-plugins', 'pkgver': '5.9.5-2ubuntu2.3'},
    {'osver': '22.04', 'pkgname': 'strongswan', 'pkgver': '5.9.5-2ubuntu2.3'},
    {'osver': '22.04', 'pkgname': 'strongswan-charon', 'pkgver': '5.9.5-2ubuntu2.3'},
    {'osver': '22.04', 'pkgname': 'strongswan-libcharon', 'pkgver': '5.9.5-2ubuntu2.3'},
    {'osver': '22.04', 'pkgname': 'strongswan-nm', 'pkgver': '5.9.5-2ubuntu2.3'},
    {'osver': '22.04', 'pkgname': 'strongswan-pki', 'pkgver': '5.9.5-2ubuntu2.3'},
    {'osver': '22.04', 'pkgname': 'strongswan-scepclient', 'pkgver': '5.9.5-2ubuntu2.3'},
    {'osver': '22.04', 'pkgname': 'strongswan-starter', 'pkgver': '5.9.5-2ubuntu2.3'},
    {'osver': '22.04', 'pkgname': 'strongswan-swanctl', 'pkgver': '5.9.5-2ubuntu2.3'}
];
