...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Falco PHSA-2023-5.0-0046");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'falco-0.32.2-6.0601037001.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'falco-devel-0.32.2-6.0601037001.ph5')) flag++;
