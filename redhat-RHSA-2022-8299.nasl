...
# extracted from Red Hat Security Advisory RHSA-2022:8299. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:8299");

  script_name(english:"RHEL 9 : curl (RHSA-2022:8299)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8299.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1974600c");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/9/html/9.1_release_notes/index
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1f1eb6cc");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8299");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2078388");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL curl package based on the guidance in RHSA-2022:8299.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'curl-7.76.1-19.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'curl-minimal-7.76.1-19.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libcurl-7.76.1-19.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libcurl-devel-7.76.1-19.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libcurl-minimal-7.76.1-19.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
