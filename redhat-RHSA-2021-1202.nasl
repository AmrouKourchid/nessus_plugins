...
# extracted from Red Hat Security Advisory RHSA-2021:1202. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:1202");
  ...
  script_name(english:"RHEL 7 : Red Hat JBoss Web Server 3.1 Service Pack 12 (RHSA-2021:1202)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for Red Hat JBoss Web Server 3.1 Service Pack 12.");
...
referenced in the RHSA-2021:1202 advisory.
    ...
    This release of Red Hat JBoss Web Server 3.1 Service Pack 12 serves as a replacement for Red Hat JBoss Web
    Server 3.1.11, and includes bug fixes, which are documented in the Release Notes document linked to in the
    References.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_1202.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ba39ff57");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:1202");
...
"Update the RHEL Red Hat JBoss Web Server 3.1 Service Pack 12 package based on the guidance in RHSA-2021:1202.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'tomcat-native-1.2.23-24.redhat_24.ep7.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'jws-3'}
    ]
  }
];
