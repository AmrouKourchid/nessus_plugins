...
# extracted from Fedora Security Advisory FEDORA-2018-866bd0e3c2.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : dcraw (2018-866bd0e3c2)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-866bd0e3c2");
...
"Update the affected dcraw package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-5801");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"dcraw-9.28.0-1.fc28")) flag++;
