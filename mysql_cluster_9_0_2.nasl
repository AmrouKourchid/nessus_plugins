...
if (description)
{
  ...
  script_name(english:"Oracle MySQL Cluster 8.0.x < 8.0.40 / 8.4.x < 8.4.3 / 9.0.x < 9.0.2 (October 2024 CPU)");
...
in the October 2024 CPU advisory.
  ...
  - Vulnerability in the MySQL Cluster product of Oracle MySQL (component: Cluster: General (Kerberos)). 
    ...
    compromise MySQL Cluster. Successful attacks of this vulnerability can result in unauthorized access to 
    critical data or complete access to all MySQL Cluster accessible data and unauthorized ability to cause 
    a hang or frequently repeatable crash (complete DOS) of MySQL Cluster. (CVE-2024-37371)
...
mysql_check_version(fixed:make_list('8.0.40', '8.4.3', '9.0.2'), variant:'Cluster', severity:SECURITY_HOLE);