...
if (description)
{
  ...
  script_cve_id("CVE-2014-9807");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2014-9807");
...
patch available.
  ...
  - The pdb coder in ImageMagick allows remote attackers to cause a denial of service (double free) via
    unspecified vectors. (CVE-2014-9807)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-9807");
