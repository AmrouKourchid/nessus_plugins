...
# extracted from Fedora Security Advisory FEDORA-2021-e03b328043
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-e03b328043");

  script_name(english:"Fedora 32 : webkit2gtk3 (2021-e03b328043)");
...
FEDORA-2021-e03b328043 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-e03b328043");
...
pkgs = [
    {'reference':'webkit2gtk3-2.30.5-1.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE}
];
