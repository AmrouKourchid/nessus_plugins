...
# extracted from Debian Security Advisory dla-3646. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3646 : open-vm-tools - security update");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'open-vm-tools', 'reference': '2:10.3.10-1+deb10u6'},
    {'release': '10.0', 'prefix': 'open-vm-tools-desktop', 'reference': '2:10.3.10-1+deb10u6'},
    {'release': '10.0', 'prefix': 'open-vm-tools-dev', 'reference': '2:10.3.10-1+deb10u6'}
];
