...
# extracted from Red Hat Security Advisory RHSA-2020:0388. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:0388");
  script_xref(name:"IAVA", value:"2019-A-0378-S");

  script_name(english:"RHEL 8 : sudo (RHSA-2020:0388)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_0388.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8d55d5a7");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:0388");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1760531");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL sudo package based on the guidance in RHSA-2020:0388.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'sudo-1.8.25p1-4.el8_0.2', 'sp':'0', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sudo-1.8.25p1-4.el8_0.2', 'sp':'0', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
