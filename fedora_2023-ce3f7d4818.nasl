...
# extracted from Fedora Security Advisory FEDORA-2023-ce3f7d4818
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-ce3f7d4818");
  script_xref(name:"IAVA", value:"2023-A-0650-S");

  script_name(english:"Fedora 37 : vim (2023-ce3f7d4818)");
...
FEDORA-2023-ce3f7d4818 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-ce3f7d4818");
...
var pkgs = [
    {'reference':'vim-9.0.2120-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
