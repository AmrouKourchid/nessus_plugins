...
if (description)
{
  ...
  script_cve_id("CVE-2024-56682");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-56682");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: irqchip/riscv-aplic: Prevent crash
    when MSI domain is missing If the APLIC driver is probed before the IMSIC driver, the parent MSI domain
    will be missing, which causes a NULL pointer dereference in msi_create_device_irq_domain(). Avoid this by
    deferring probe until the parent MSI domain is available. Use dev_err_probe() to avoid printing an error
    message when returning -EPROBE_DEFER. (CVE-2024-56682)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-56682");
