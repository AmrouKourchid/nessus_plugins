...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 ESM / 18.04 LTS / 20.04 LTS / 22.04 LTS : Long Range ZIP vulnerabilities (USN-5840-1)");
...
multiple vulnerabilities as referenced in the USN-5840-1 advisory.
    ...
    specially crafted ZIP file, an attacker could possibly use this issue to cause a denial of service. This
    issue only affected Ubuntu 14.04 ESM, Ubuntu 16.04 ESM, Ubuntu 18.04 LTS, and Ubuntu 20.04 LTS.
    (CVE-2020-25467)
    ...
    to cause a denial of service. This issue only affected Ubuntu 18.04 LTS and Ubuntu 20.04 LTS.
    (CVE-2021-27345, CVE-2021-27347)
    ...
    specially crafted ZIP file, an attacker could possibly use this issue to cause a denial of service. This
    issue only affected Ubuntu 16.04 ESM, Ubuntu 18.04 LTS, and Ubuntu 20.04 LTS. (CVE-2022-26291)

    It was discovered that Long Range ZIP incorrectly handled memory allocation,

    which could lead to a heap memory corruption. An attacker could possibly use this issue to cause denial of
    service. This issue affected Ubuntu 14.04 ESM, Ubuntu 16.04 ESM, Ubuntu 18.04 LTS, Ubuntu 20.04 LTS,
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'lrzip', 'pkgver': '0.621-1ubuntu0.1~esm2', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'lrzip', 'pkgver': '0.631-1+deb9u3build0.18.04.1', 'ubuntu_pro': FALSE},
    {'osver': '20.04', 'pkgname': 'lrzip', 'pkgver': '0.631+git180528-1+deb10u1build0.20.04.1', 'ubuntu_pro': FALSE},
    {'osver': '22.04', 'pkgname': 'lrzip', 'pkgver': '0.651-2ubuntu0.22.04.1', 'ubuntu_pro': FALSE}
];
