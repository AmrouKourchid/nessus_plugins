...
"The version of ppp installed on the remote host is prior to 2.4.5-11.9. It is, therefore, affected by a vulnerability as
referenced in the ALAS-2020-1371 advisory.
...
var pkgs = [
    {'reference':'ppp-2.4.5-11.9.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ppp-2.4.5-11.9.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ppp-debuginfo-2.4.5-11.9.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ppp-debuginfo-2.4.5-11.9.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ppp-devel-2.4.5-11.9.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ppp-devel-2.4.5-11.9.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE}
];
