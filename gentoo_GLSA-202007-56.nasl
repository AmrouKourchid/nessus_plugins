...
# extracted from Gentoo Linux Security Advisory GLSA 202007-56.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202007-56");

  script_name(english:"GLSA-202007-56 : Claws Mail: Improper STARTTLS handling");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202007-56
(Claws Mail: Improper STARTTLS handling)

    It was discovered that Claws Mail was not properly handling state within
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202007-56");
...
if (qpkg_check(package:"mail-client/claws-mail", unaffected:make_list("ge 3.17.6"), vulnerable:make_list("lt 3.17.6"))) flag++;
