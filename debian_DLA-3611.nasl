...
# extracted from Debian Security Advisory dla-3611. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3611 : inetutils-ftp - security update");
...
dla-3611 advisory.
    ...
    -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3611-1                debian-lts@lists.debian.org
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-40303");
...
"Upgrade the inetutils-ftp packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2023-40303");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'inetutils-ftp', 'reference': '2:1.9.4-7+deb10u3'},
    {'release': '10.0', 'prefix': 'inetutils-ftpd', 'reference': '2:1.9.4-7+deb10u3'},
    {'release': '10.0', 'prefix': 'inetutils-inetd', 'reference': '2:1.9.4-7+deb10u3'},
    {'release': '10.0', 'prefix': 'inetutils-ping', 'reference': '2:1.9.4-7+deb10u3'},
    {'release': '10.0', 'prefix': 'inetutils-syslogd', 'reference': '2:1.9.4-7+deb10u3'},
    {'release': '10.0', 'prefix': 'inetutils-talk', 'reference': '2:1.9.4-7+deb10u3'},
    {'release': '10.0', 'prefix': 'inetutils-talkd', 'reference': '2:1.9.4-7+deb10u3'},
    {'release': '10.0', 'prefix': 'inetutils-telnet', 'reference': '2:1.9.4-7+deb10u3'},
    {'release': '10.0', 'prefix': 'inetutils-telnetd', 'reference': '2:1.9.4-7+deb10u3'},
    {'release': '10.0', 'prefix': 'inetutils-tools', 'reference': '2:1.9.4-7+deb10u3'},
    {'release': '10.0', 'prefix': 'inetutils-traceroute', 'reference': '2:1.9.4-7+deb10u3'}
];
