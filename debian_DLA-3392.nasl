...
# extracted from Debian Security Advisory dla-3392. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3392 : ruby-rack - security update");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'ruby-rack', 'reference': '2.0.6-3+deb10u3'}
];
