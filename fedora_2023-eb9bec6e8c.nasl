...
# extracted from Fedora Security Advisory FEDORA-2023-eb9bec6e8c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-eb9bec6e8c");

  script_name(english:"Fedora 37 : tang (2023-eb9bec6e8c)");
...
FEDORA-2023-eb9bec6e8c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-eb9bec6e8c");
...
var pkgs = [
    {'reference':'tang-14-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
