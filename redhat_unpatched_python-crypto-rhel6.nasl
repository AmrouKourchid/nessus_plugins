...
# extracted from Red Hat Security Advisory python-crypto. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2012-2417", "CVE-2018-6594");

  script_name(english:"RHEL 6 : python-crypto (Unpatched Vulnerability) (deprecated)");
