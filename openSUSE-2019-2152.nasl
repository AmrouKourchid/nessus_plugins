...
# extracted from openSUSE Security Update openSUSE-2019-2152.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : chromium (openSUSE-2019-2152)");
...
Security issues fixed :
  ...
  - CVE-2019-13683: Fixed an exceptions leaked by devtools.
    (boo#1150425)");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1150425");
...
if ( rpm_check(release:"SUSE15.1", reference:"chromedriver-77.0.3865.75-lp151.2.30.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"chromedriver-debuginfo-77.0.3865.75-lp151.2.30.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"chromium-77.0.3865.75-lp151.2.30.1", allowmaj:TRUE) ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"chromium-debuginfo-77.0.3865.75-lp151.2.30.1", allowmaj:TRUE) ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"chromium-debugsource-77.0.3865.75-lp151.2.30.1", allowmaj:TRUE) ) flag++;
