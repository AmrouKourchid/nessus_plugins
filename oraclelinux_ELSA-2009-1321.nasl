...
# extracted from Oracle Linux Security Advisory ELSA-2009-1321.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : nfs-utils (ELSA-2009-1321)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2009-1321.html");
...
"Update the affected nfs-utils package.");
  ...
  script_set_attribute(attribute:"vuln_publication_date", value:"2008/08/11");
