...
# extracted from Red Hat Security Advisory RHSA-2023:3216. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2022-2995");
  script_xref(name:"RHSA", value:"2023:3216");

  script_name(english:"RHEL 7 / 8 : OpenShift Container Platform 4.10.60 (RHSA-2023:3216)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for OpenShift Container Platform 4.10.60.");
...
in the RHSA-2023:3216 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.10.60. See the
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_3216.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8453ed19");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:3216");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.10.60 packages based on the guidance in RHSA-2023:3216.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:S/C:C/I:C/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:L/UI:N/S:U/C:H/I:H/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-2995");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cri-o-1.23.5-11.rhaos4.10.gitfc32aac.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'cri-o-1.23.5-11.rhaos4.10.gitfc32aac.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
