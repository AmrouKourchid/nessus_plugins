...
if (description)
{
  ...
  script_cve_id("CVE-2024-34155", "CVE-2024-34158");

  script_name(english:"EulerOS 2.0 SP12 : golang (EulerOS-SA-2025-1190)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1190
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4ff8d73d");
...
var pkgs = [
  "golang-1.17.3-12.h23.eulerosv2r12",
  "golang-devel-1.17.3-12.h23.eulerosv2r12",
  "golang-help-1.17.3-12.h23.eulerosv2r12"
];
