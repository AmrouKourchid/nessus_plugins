...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : openssl098e (EulerOS-SA-2024-2073)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the openssl098e package installed, the EulerOS installation on the remote host is affected
...
Tenable has extracted the preceding description block directly from the EulerOS openssl098e security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2073
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?521f47d8");
...
var pkgs = [
  "openssl098e-0.9.8e-29.3.h20.eulerosv2r7"
];
