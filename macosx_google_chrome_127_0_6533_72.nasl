...
"The version of Google Chrome installed on the remote macOS host is prior to 127.0.6533.72. It is, therefore, affected by
multiple vulnerabilities as referenced in the 2024_07_stable-channel-update-for-desktop_23 advisory.
...
google_chrome_check_version(fix:'127.0.6533.72', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
