...
if (description)
{
  ...
  script_cve_id("CVE-2024-42156");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-42156");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: s390/pkey: Wipe copies of clear-key
    structures on failure Wipe all sensitive data from stack for all IOCTLs, which convert a clear-key into a
    protected- or secure-key. (CVE-2024-42156)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-42156");
