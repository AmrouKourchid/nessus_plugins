...
if (description)
{
  ...
  script_name(english:"CentOS 9 : bash-5.1.8-6.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update for bash.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 9 host has packages installed that are affected by a vulnerability as referenced in the
bash-5.1.8-6.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=27195");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream bash package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:bash-devel");
...
var pkgs = [
    {'reference':'bash-5.1.8-6.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'bash-devel-5.1.8-6.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'bash-doc-5.1.8-6.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'bash / bash-devel / bash-doc');
}
