...
# extracted from Debian Security Advisory dla-4125. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2024-6531");

  script_name(english:"Debian dla-4125 : libjs-bootstrap4 - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has a package installed that is affected by a vulnerability as referenced in the dla-4125
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d09fc264");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-6531");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bullseye/twitter-bootstrap4");
  script_set_attribute(attribute:"solution", value:
"Upgrade the libjs-bootstrap4 packages.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:H/Au:N/C:C/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:H/PR:N/UI:R/S:U/C:H/I:L/A:L");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-6531");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:libjs-bootstrap4");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'libjs-bootstrap4', 'reference': '4.5.2+dfsg1-8~deb11u2'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libjs-bootstrap4');
}
