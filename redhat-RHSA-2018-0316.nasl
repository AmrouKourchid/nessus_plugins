...
# extracted from Red Hat Security Advisory RHSA-2018:0316. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:0316");

  script_name(english:"RHEL 6 : httpd24-apr (RHSA-2018:0316)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for httpd24-apr.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 6 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2018:0316 advisory.
...
number.");
  ...
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_0316.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8bcdf94b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:0316");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL httpd24-apr package based on the guidance in RHSA-2018:0316.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:httpd24-apr");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:httpd24-apr-devel");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'httpd24-apr-1.5.1-1.el6.1', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'httpd24-apr-devel-1.5.1-1.el6.1', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'httpd24-apr / httpd24-apr-devel');
}
