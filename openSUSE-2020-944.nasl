...
# extracted from openSUSE Security Update openSUSE-2020-944.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : live555 (openSUSE-2020-944)");
...
project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1121995");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1124159");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1127341");
  script_set_attribute(attribute:"solution", value:
"Update the affected live555 packages.");
...
if ( rpm_check(release:"SUSE15.2", reference:"libBasicUsageEnvironment1-2019.06.28-lp152.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libBasicUsageEnvironment1-debuginfo-2019.06.28-lp152.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libUsageEnvironment3-2019.06.28-lp152.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libUsageEnvironment3-debuginfo-2019.06.28-lp152.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libgroupsock8-2019.06.28-lp152.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libgroupsock8-debuginfo-2019.06.28-lp152.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libliveMedia66-2019.06.28-lp152.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libliveMedia66-debuginfo-2019.06.28-lp152.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"live555-2019.06.28-lp152.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"live555-debuginfo-2019.06.28-lp152.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"live555-debugsource-2019.06.28-lp152.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"live555-devel-2019.06.28-lp152.3.3.1") ) flag++;
