...
# extracted from Fedora Security Advisory FEDORA-2022-b8b34e62ab
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-b8b34e62ab");

  script_name(english:"Fedora 35 : python3.6 (2022-b8b34e62ab)");
...
FEDORA-2022-b8b34e62ab advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-b8b34e62ab");
...
var pkgs = [
    {'reference':'python3.6-3.6.15-6.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
