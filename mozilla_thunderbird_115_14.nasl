...
"The version of Thunderbird installed on the remote Windows host is prior to 115.14. It is, therefore, affected by
multiple vulnerabilities as referenced in the mfsa2024-38 advisory.
...
mozilla_check_version(installs:installs, product:'thunderbird', esr:FALSE, fix:'115.14', severity:SECURITY_HOLE);
