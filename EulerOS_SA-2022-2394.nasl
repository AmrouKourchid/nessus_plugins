...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.0 : openldap (EulerOS-SA-2022-2394)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2394
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c160e6a8");
...
var pkgs = [
  "openldap-2.4.49-3.h12.eulerosv2r9",
  "openldap-clients-2.4.49-3.h12.eulerosv2r9",
  "openldap-servers-2.4.49-3.h12.eulerosv2r9"
];
