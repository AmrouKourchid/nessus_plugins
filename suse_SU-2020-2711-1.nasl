...
# extracted from SUSE update advisory SUSE-SU-2020:2711-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : libmspack (SUSE-SU-2020:2711-1)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?245d9a3c");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"5", reference:"libmspack-debugsource-0.4-15.7.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libmspack0-0.4-15.7.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libmspack0-debuginfo-0.4-15.7.1")) flag++;
