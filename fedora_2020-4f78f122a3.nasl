...
# extracted from Fedora Security Advisory FEDORA-2020-4f78f122a3.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : mingw-gnutls (2020-4f78f122a3)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-4f78f122a3");
...
flag = 0;
if (rpm_check(release:"FC32", reference:"mingw-gnutls-3.6.14-1.fc32")) flag++;
