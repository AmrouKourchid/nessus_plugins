...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP13 : proftpd (EulerOS-SA-2025-1322)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1322
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ab50b38c");
...
var pkgs = [
  "proftpd-1.3.7c-4.h10.eulerosv2r13"
];
