...
# extracted from Red Hat Security Advisory RHSA-2018:2091. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:2091");

  script_name(english:"RHEL 7 : patch (RHSA-2018:2091)");
...
the RHSA-2018:2091 advisory.

  - patch: Malicious patch files cause ed to execute arbitrary commands (CVE-2018-1000156)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_2091.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6a3211f7");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:2091");
...
"Update the RHEL patch package based on the guidance in RHSA-2018:2091.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'patch-2.7.1-10.el7_4', 'sp':'4', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'patch-2.7.1-10.el7_4', 'sp':'4', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'patch-2.7.1-10.el7_4', 'sp':'4', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'patch-2.7.1-10.el7_4', 'sp':'4', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
