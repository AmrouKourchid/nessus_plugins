...
# extracted from Red Hat Security Advisory RHSA-2024:5002. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:5002");

  script_name(english:"RHEL 8 : python3.11-setuptools (RHSA-2024:5002)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for python3.11-setuptools.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:5002 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_5002.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d722069d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:5002");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python3.11-setuptools package based on the guidance in RHSA-2024:5002.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3.11-setuptools-65.5.1-2.el8_8.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.11-setuptools-wheel-65.5.1-2.el8_8.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
