...
# SUSE update advisory SUSE-SU-2023:3600-2. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:3600-2");

  script_name(english:"SUSE SLES15 Security Update : kernel (SUSE-SU-2023:3600-2)");
...
the SUSE-SU-2023:3600-2 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-updates/2023-September/031622.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7263e0e5");
...
"Update the affected kernel-livepatch-5_14_21-150400_15_49-rt package.");
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kernel-livepatch-5_14_21-150400_15_49-rt');
}
