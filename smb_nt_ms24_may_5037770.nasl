...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5037770");
  script_xref(name:"MSFT", value:"MS24-5037770");
  ...
  script_name(english:"KB5037770: Windows 11 version 21H2 Security Update (May 2024)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5037770");
