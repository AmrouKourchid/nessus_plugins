...
# extracted from Fedora Security Advisory FEDORA-2025-d4263ef3ef
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-d4263ef3ef");

  script_name(english:"Fedora 40 : zabbix (2025-d4263ef3ef)");
...
FEDORA-2025-d4263ef3ef advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-d4263ef3ef");
...
var pkgs = [
    {'reference':'zabbix-6.0.39-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
