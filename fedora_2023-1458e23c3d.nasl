...
# extracted from Fedora Security Advisory FEDORA-2023-1458e23c3d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-1458e23c3d");

  script_name(english:"Fedora 37 : dotnet7.0 (2023-1458e23c3d)");
...
FEDORA-2023-1458e23c3d advisory.

    This is the October 24, 2023 release for .NET 7.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-1458e23c3d");
...
var pkgs = [
    {'reference':'dotnet7.0-7.0.113-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
