...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : firefox on SL6.x i386/x86_64 (20200826)");
...
"Security Fix(es) :
  ...
  - Mozilla: Use-After-Free when aborting an operation
    (CVE-2020-15669)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind2008&L=SCIENTIFIC-LINUX-ERRATA&P=10391
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6a2e5bfb");
...
flag = 0;
if (rpm_check(release:"SL6", reference:"firefox-68.12.0-1.el6_10", allowmaj:TRUE)) flag++;
if (rpm_check(release:"SL6", reference:"firefox-debuginfo-68.12.0-1.el6_10", allowmaj:TRUE)) flag++;
