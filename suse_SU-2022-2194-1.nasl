...
# SUSE update advisory SUSE-SU-2022:2194-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:2194-1");

  script_name(english:"SUSE SLES12 Security Update : kernel (Live Patch 24 for SLE 12 SP5) (SUSE-SU-2022:2194-1)");
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-June/011367.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?05dfee9f");
...
var pkgs = [
    {'reference':'kgraft-patch-4_12_14-95_93-default-5-2.2', 'sp':'4', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.4']},
    {'reference':'kgraft-patch-4_12_14-122_91-default-13-2.2', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.5']}
];
