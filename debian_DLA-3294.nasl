...
# extracted from Debian Security Advisory dla-3294. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3294 : bsdcpio - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3294
advisory.
...
var pkgs = [
    {'release': '10.0', 'prefix': 'bsdcpio', 'reference': '3.3.3-4+deb10u3'},
    {'release': '10.0', 'prefix': 'bsdtar', 'reference': '3.3.3-4+deb10u3'},
    {'release': '10.0', 'prefix': 'libarchive-dev', 'reference': '3.3.3-4+deb10u3'},
    {'release': '10.0', 'prefix': 'libarchive-tools', 'reference': '3.3.3-4+deb10u3'},
    {'release': '10.0', 'prefix': 'libarchive13', 'reference': '3.3.3-4+deb10u3'}
];
