...
# extracted from Oracle Linux Security Advisory ELSA-2024-1147.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : rear (ELSA-2024-1147)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-1147.html");
...
var pkgs = [
    {'reference':'rear-2.6-21.0.1.el9_3', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
