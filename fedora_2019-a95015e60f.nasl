...
# extracted from Fedora Security Advisory FEDORA-2019-a95015e60f.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : kernel / kernel-headers (2019-a95015e60f)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-a95015e60f");
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  cve_list = make_list("CVE-2019-13272");
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for FEDORA-2019-a95015e60f");
  }
  else
  {
...
flag = 0;
if (rpm_check(release:"FC29", reference:"kernel-5.1.18-200.fc29")) flag++;
if (rpm_check(release:"FC29", reference:"kernel-headers-5.1.18-200.fc29")) flag++;
