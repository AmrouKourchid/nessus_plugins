...
# extracted from Fedora Security Advisory FEDORA-2023-40e14b37c2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-40e14b37c2");

  script_name(english:"Fedora 36 : phoronix-test-suite (2023-40e14b37c2)");
...
FEDORA-2023-40e14b37c2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-40e14b37c2");
...
var pkgs = [
    {'reference':'phoronix-test-suite-10.8.4-2.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
