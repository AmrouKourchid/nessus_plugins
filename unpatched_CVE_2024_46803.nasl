...
if (description)
{
  ...
  script_cve_id("CVE-2024-46803");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-46803");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: drm/amdkfd: Check debug trap enable
    before write dbg_ev_file In interrupt context, write dbg_ev_file will be run by work queue. It will cause
    write dbg_ev_file execution after debug_trap_disable, which will cause NULL pointer access. v2: cancel
    work debug_event_workarea before set dbg_ev_file as NULL. (CVE-2024-46803)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-46803");
