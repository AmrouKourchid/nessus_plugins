...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5037782");
  script_xref(name:"MSKB", value:"5037848");
  script_xref(name:"MSFT", value:"MS24-5037782");
  script_xref(name:"MSFT", value:"MS24-5037848");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2024/06/04");
  script_xref(name:"IAVA", value:"2024-A-0281-S");

  script_name(english:"KB5037782: Windows Server 2022 / Azure Stack HCI 22H2 Security Update (May 2024)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5037782 or Azure HotPatch 5037848. It is, therefore, 
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5037782");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5037848");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5037782 or 5037848.");
...
if (
  smb_check_rollup(os:'10',
                   ...
                   rollup_date:'05_2024',
                   bulletin:bulletin,
                   rollup_kb_list:[5037782,5037848])
)
{
