...
# extracted from Fedora Security Advisory FEDORA-2023-f75af676f2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-f75af676f2");

  script_name(english:"Fedora 38 : llhttp / python-aiohttp (2023-f75af676f2)");
...
FEDORA-2023-f75af676f2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-f75af676f2");
...
var pkgs = [
    {'reference':'llhttp-8.1.1-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python-aiohttp-3.8.5-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
