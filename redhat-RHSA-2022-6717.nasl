...
# extracted from Red Hat Security Advisory RHSA-2022:6717. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:6717");
  script_xref(name:"IAVA", value:"2022-A-0349-S");
  script_xref(name:"IAVA", value:"2022-A-0386-S");

  script_name(english:"RHEL 9 : thunderbird (RHSA-2022:6717)");
...
referenced in the RHSA-2022:6717 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_6717.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ca6df870");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:6717");
...
"Update the RHEL thunderbird package based on the guidance in RHSA-2022:6717.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'thunderbird-102.3.0-3.el9_0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'thunderbird-102.3.0-3.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
