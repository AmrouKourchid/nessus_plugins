...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Chromium PHSA-2025-4.0-0734");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'chromium-131.0.6778.268-1.ph4')) flag++;
