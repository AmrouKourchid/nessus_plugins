...
# extracted from Red Hat Security Advisory e2fsprogs. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2019-5094", "CVE-2019-5188", "CVE-2022-1304");

  script_name(english:"RHEL 6 : e2fsprogs (Unpatched Vulnerability) (deprecated)");
