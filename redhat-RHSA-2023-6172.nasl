...
# extracted from Red Hat Security Advisory RHSA-2023:6172. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:6172");

  script_name(english:"RHEL 8 : Red Hat Product OCP Tools 4.12 Openshift Jenkins (RHSA-2023:6172)");
...
referenced in the RHSA-2023:6172 advisory.
    ...
    CVE-2023-25762 jenkins-2-plugins: jenkins-2-plugins/pipeline-build-step: Stored XSS vulnerability in
    ...
    CVE-2022-25857 jenkins-2-plugins: snakeyaml: Denial of Service due to missing nested depth limitation for
    collections
    CVE-2022-42889 jenkins-2-plugins: apache-commons-text: variable interpolation RCE
    CVE-2020-7692 jenkins-2-plugins: google-oauth-client: missing PKCE support in accordance with the RFC for
    OAuth 2.0 for Native Apps can lead to improper authorization
    CVE-2023-24422 jenkins-2-plugins: jenkins-2-plugins/script-security: Sandbox bypass vulnerability in
    ...
    CVE-2023-39325 openshift-jenkins-2-container: golang: net/http, x/net/http2: rapid stream resets can cause
    excessive work
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6172.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7c87b845");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6172");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat Product OCP Tools 4.12 Openshift Jenkins package based on the guidance in RHSA-2023:6172.");
  ...
  script_cwe_id(20, 77, 79, 200, 266, 358, 400, 1188);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jenkins-2-plugins-4.12.1698294000-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2020-7692', 'CVE-2022-25857', 'CVE-2022-29599', 'CVE-2022-42889', 'CVE-2023-24422', 'CVE-2023-25761', 'CVE-2023-25762', 'CVE-2023-39325']},
      {'reference':'jenkins-2.414.3.1698293911-3.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2023-27903', 'CVE-2023-27904', 'CVE-2023-39325']}
    ]
  }
];
