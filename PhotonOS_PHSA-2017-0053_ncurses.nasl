...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'ncurses-6.0-13.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'ncurses-compat-6.0-13.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'ncurses-debuginfo-6.0-13.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'ncurses-devel-6.0-13.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'ncurses-libs-6.0-13.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'ncurses-terminfo-6.0-13.ph2')) flag++;
