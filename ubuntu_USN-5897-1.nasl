...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS / 22.04 LTS : OpenJDK vulnerabilities (USN-5897-1)");
...
vulnerabilities as referenced in the USN-5897-1 advisory.
    ...
    Juraj Somorovsky, Marcel Maehren, Nurullah Erinola, and Robert Merget discovered that the DTLS
    implementation in the JSSE subsystem of OpenJDK did not properly restrict handshake initiation requests
    from clients. A remote attacker could possibly use this to cause a denial of service. (CVE-2023-21835)
