...
# extracted from Fedora Security Advisory FEDORA-2019-309f559057.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-309f559057");

  script_name(english:"Fedora 30 : cyrus-imapd (2019-309f559057)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"Update to version 3.0.10, which fixes a security issue (a buffer
overrun vulnerability in the httpd daemon, CVE-2019-11356).

Note that Tenable Network Security has extracted the preceding
description block directly from the Fedora update system website.
Tenable has attempted to automatically clean and format it as much as
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-309f559057");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"cyrus-imapd-3.0.10-1.fc30")) flag++;
