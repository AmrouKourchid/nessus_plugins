...
if (description)
{
  ...
  script_cve_id("CVE-2021-43784", "CVE-2022-41724", "CVE-2023-28642");

  script_name(english:"CentOS 9 : runc-1.1.7-2.el9");
...
runc-1.1.7-2.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=33736");
...
var pkgs = [
    {'reference':'runc-1.1.7-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'}
];
