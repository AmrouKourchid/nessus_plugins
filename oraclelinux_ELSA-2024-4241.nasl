...
# extracted from Oracle Linux Security Advisory ELSA-2024-4241.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : iperf3 (ELSA-2024-4241)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-4241.html");
...
var pkgs = [
    {'reference':'iperf3-3.5-10.el8_10', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'iperf3-3.5-10.el8_10', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'iperf3-3.5-10.el8_10', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
