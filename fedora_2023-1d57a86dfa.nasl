...
# extracted from Fedora Security Advisory FEDORA-2023-1d57a86dfa
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-1d57a86dfa");

  script_name(english:"Fedora 39 : CuraEngine (2023-1d57a86dfa)");
...
FEDORA-2023-1d57a86dfa advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-1d57a86dfa");
...
var pkgs = [
    {'reference':'CuraEngine-5.3.0-5.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
