...
"The version of Thunderbird installed on the remote Windows host is prior to 132.0.1. It is, therefore, affected by a
vulnerability as referenced in the mfsa2024-62 advisory.
...
mozilla_check_version(installs:installs, product:'thunderbird', esr:FALSE, fix:'132.0.1', severity:SECURITY_WARNING);
