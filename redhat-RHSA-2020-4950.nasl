...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_4950.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f121235e");
...
"Update the RHEL freetype package based on the guidance in RHSA-2020:4950.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'freetype-2.9.1-4.el8_1.1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freetype-devel-2.9.1-4.el8_1.1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
