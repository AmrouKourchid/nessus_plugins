...
# extracted from Fedora Security Advisory FEDORA-2023-f696934fbf
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-f696934fbf");

  script_name(english:"Fedora 37 : libvpx (2023-f696934fbf)");
...
FEDORA-2023-f696934fbf advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-f696934fbf");
...
var pkgs = [
    {'reference':'libvpx-1.12.0-4.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
