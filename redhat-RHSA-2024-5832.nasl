...
# extracted from Red Hat Security Advisory RHSA-2024:5832. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:5832");

  script_name(english:"RHEL 9 : httpd (RHSA-2024:5832)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_5832.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ceadfdee");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:5832");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL httpd package based on the guidance in RHSA-2024:5832.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'httpd-2.4.51-7.el9_0.8', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'httpd-devel-2.4.51-7.el9_0.8', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'httpd-filesystem-2.4.51-7.el9_0.8', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'httpd-manual-2.4.51-7.el9_0.8', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'httpd-tools-2.4.51-7.el9_0.8', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mod_ldap-2.4.51-7.el9_0.8', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mod_lua-2.4.51-7.el9_0.8', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mod_proxy_html-2.4.51-7.el9_0.8', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'mod_session-2.4.51-7.el9_0.8', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mod_ssl-2.4.51-7.el9_0.8', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
