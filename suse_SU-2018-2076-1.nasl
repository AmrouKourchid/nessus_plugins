...
# extracted from SUSE update advisory SUSE-SU-2018:2076-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES11 Security Update : microcode_ctl (SUSE-SU-2018:2076-1) (Spectre)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"This update for microcode_ctl fixes the following issues: The Intel
CPU Microcode bundle was updated to the 20180703 release For the
listed CPU chipsets this fixes CVE-2018-3640 (Spectre v3a) and helps
mitigating CVE-2018-3639 (Spectre v4) (bsc#1100147 bsc#1087082
bsc#1087083) More details can be found on:
...
without introducing additional issues.");
  ...
  # https://www.suse.com/support/update/announcement/2018/suse-su-20182076-1/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?56ab3e55");
...
slessp4-microcode_ctl-13704=1

SUSE Linux Enterprise Server 11-SP3-LTSS:zypper in -t patch
slessp3-microcode_ctl-13704=1

SUSE Linux Enterprise Point of Sale 11-SP3:zypper in -t patch
sleposp3-microcode_ctl-13704=1");
...
flag = 0;
if (rpm_check(release:"SLES11", sp:"4", cpu:"x86_64", reference:"microcode_ctl-1.17-102.83.24.1")) flag++;
if (rpm_check(release:"SLES11", sp:"4", cpu:"i586", reference:"microcode_ctl-1.17-102.83.24.1")) flag++;
if (rpm_check(release:"SLES11", sp:"3", cpu:"x86_64", reference:"microcode_ctl-1.17-102.83.24.1")) flag++;
if (rpm_check(release:"SLES11", sp:"3", cpu:"i586", reference:"microcode_ctl-1.17-102.83.24.1")) flag++;
