...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS : hivex vulnerability (USN-5148-1)");
...
in the USN-5148-1 advisory.

    It was discovered that hivex incorrectly handled certain input. An attacker could use this vulnerability
    to cause a crash or obtain sensitive information.
