...
if (description)
{
  ...
  script_name(english:"Oracle Siebel CRM SEoL (7.5.3)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Oracle Siebel CRM is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Oracle Siebel CRM is 7.5.3. It is, therefore, no longer maintained by its
vendor or provider.
