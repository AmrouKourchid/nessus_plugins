...
if (description)
{
  ...
  script_cve_id("CVE-2011-1948");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2011-1948");
...
patch available.
  ...
  - Cross-site scripting (XSS) vulnerability in Plone 4.1 and earlier allows remote attackers to inject
    arbitrary web script or HTML via a crafted URL. (CVE-2011-1948)
