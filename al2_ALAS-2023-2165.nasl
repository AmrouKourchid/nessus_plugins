...
# extracted from Amazon Linux 2 Security Advisory ALAS-2023-2165.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2022-37866");

  script_name(english:"Amazon Linux 2 : apache-ivy (ALAS-2023-2165)");
...
vulnerability as referenced in the ALAS2-2023-2165 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2023-2165.html");
...
"Run 'yum update apache-ivy' to update your system.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-37866");
...
var pkgs = [
    {'reference':'apache-ivy-2.3.0-4.amzn2.0.1', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'apache-ivy-javadoc-2.3.0-4.amzn2.0.1', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
