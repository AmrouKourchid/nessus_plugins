...
# extracted from Fedora Security Advisory FEDORA-2024-5e5d8c2581
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-5e5d8c2581");

  script_name(english:"Fedora 38 : stb (2024-5e5d8c2581)");
...
FEDORA-2024-5e5d8c2581 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-5e5d8c2581");
...
"Update the affected stb package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-47212");
...
var pkgs = [
    {'reference':'stb-0^20240213gitae721c5-5.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
