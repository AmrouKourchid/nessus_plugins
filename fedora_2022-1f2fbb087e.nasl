...
# extracted from Fedora Security Advisory FEDORA-2022-1f2fbb087e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-1f2fbb087e");

  script_name(english:"Fedora 36 : wireshark (2022-1f2fbb087e)");
...
FEDORA-2022-1f2fbb087e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-1f2fbb087e");
...
var pkgs = [
    {'reference':'wireshark-3.6.10-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
