...
# SUSE update advisory SUSE-SU-2024:0902-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2024:0902-1");

  script_name(english:"openSUSE 15 Security Update : python-Django (SUSE-SU-2024:0902-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1220358");
  # https://lists.suse.com/pipermail/sle-security-updates/2024-March/018165.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?93f31a1c");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2024-27351");
...
var pkgs = [
    {'reference':'python3-Django-2.0.7-150000.1.17.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.5']}
];
