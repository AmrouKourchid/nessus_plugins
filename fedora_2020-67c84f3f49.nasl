...
# extracted from Fedora Security Advisory FEDORA-2020-67c84f3f49.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-67c84f3f49");

  script_name(english:"Fedora 31 : 1:cups (2020-67c84f3f49)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-67c84f3f49");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"cups-2.2.12-8.fc31", epoch:"1")) flag++;
