...
# SUSE update advisory SUSE-SU-2024:4122-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2024:4122-1");

  script_name(english:"SUSE SLES15 Security Update : kernel RT (Live Patch 10 for SLE 15 SP5) (SUSE-SU-2024:4122-1)");
...
the SUSE-SU-2024:4122-1 advisory.
    ...
    - CVE-2022-48662: Update for 'really move i915_gem_context.link under ref protection' (bsc#1223521)
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2024-December/019885.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3f36dcce");
...
"Update the affected kernel-livepatch-5_14_21-150500_13_35-rt package.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '5.14.21-150500.13.35-rt-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_14_21-150500_13_35-rt-11-150500.11.8.1', 'sp':'5', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.5']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kernel-livepatch-5_14_21-150500_13_35-rt');
}
