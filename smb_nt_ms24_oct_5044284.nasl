...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5044284");
  script_xref(name:"MSFT", value:"MS24-5044284");
  ...
  script_name(english:"KB5044284: Windows 11 Version 24H2 / Windows Server 2025 Security Update (October 2024)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5044284");
