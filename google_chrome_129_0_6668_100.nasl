...
"The version of Google Chrome installed on the remote Windows host is prior to 129.0.6668.100. It is, therefore, affected
...
google_chrome_check_version(installs:installs, fix:'129.0.6668.100', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
