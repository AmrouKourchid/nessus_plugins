...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : Sudo vulnerability (USN-2533-1)");
...
USN-2533-1 advisory.
    ...
    Jakub Wilk and Stephane Chazelas discovered that Sudo incorrectly handled the TZ environment variable. An
    attacker with Sudo access could possibly use this issue to open arbitrary files, bypassing intended
    permissions.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2533-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'sudo', 'pkgver': '1.8.9p5-1ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'sudo-ldap', 'pkgver': '1.8.9p5-1ubuntu1.1'}
];
