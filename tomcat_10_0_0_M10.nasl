...
if (description)
{
  ...
  script_name(english:"Apache Tomcat 10.0.0.M1 < 10.0.0.M10 multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Apache Tomcat server is affected by multiple vulnerabilities");
  script_set_attribute(attribute:"description", value:
"The version of Tomcat installed on the remote host is prior to 10.0.0.M10. It is, therefore, affected by multiple
vulnerabilities as referenced in the fixed_in_apache_tomcat_10.0.0-m10_security-10 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?32f44cf1");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5bd634bb");
  # https://tomcat.apache.org/security-10.html#Fixed_in_Apache_Tomcat_10.0.0-M10
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0856ba95");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Apache Tomcat version 10.0.0.M10 or later.");
...
var constraints = [
  { 'min_version' : '10.0.0.M1', 'max_version' : '10.0.0.M9', 'fixed_version' : '10.0.0.M10' }
];
