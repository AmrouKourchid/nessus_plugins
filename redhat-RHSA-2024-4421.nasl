...
# extracted from Red Hat Security Advisory RHSA-2024:4421. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:4421");

  script_name(english:"RHEL 8 : python39:3.9 and python39-devel:3.9 (RHSA-2024:4421)");
...
the RHSA-2024:4421 advisory.

    Python is an interpreted, interactive, object-oriented programming language,
    which includes modules, classes, exceptions, very high level dynamic data types and dynamic typing. Python
    supports interfaces to many system calls and
    libraries, as well as to various windowing systems.

    Security Fix(es):

    * python39:3.9/python3x-setuptools: Regular Expression Denial of Service (ReDoS) in package_index.py
    (CVE-2022-40897)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_4421.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?baa0d716");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2158559");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:4421");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python39:3.9 / python39-devel:3.9 packages based on the guidance in RHSA-2024:4421.");
  ...
  'python39:3.9': [
    {
      ...
      'pkgs': [
        ...
        {'reference':'python39-setuptools-50.3.2-5.module+el8.8.0+21635+a173a6fa', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python39-setuptools-wheel-50.3.2-5.module+el8.8.0+21635+a173a6fa', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
