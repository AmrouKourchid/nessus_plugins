...
if (description)
{
  ...
  script_cve_id("CVE-2024-35847");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-35847");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: irqchip/gic-v3-its: Prevent double
    ...
    bitmap/vprop_page freeing from its_vpe_irq_domain_alloc(). [ tglx: Massaged change log ] (CVE-2024-35847)
