...
# extracted from Fedora Security Advisory FEDORA-2023-7a94186139
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-7a94186139");

  script_name(english:"Fedora 38 : xorg-x11-server-Xwayland (2023-7a94186139)");
...
FEDORA-2023-7a94186139 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-7a94186139");
...
"Update the affected xorg-x11-server-Xwayland package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:xorg-x11-server-Xwayland");
...
var pkgs = [
    {'reference':'xorg-x11-server-Xwayland-22.1.9-3.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
