...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : libsndfile (EulerOS-SA-2020-1724)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1724
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1aea632a");
...
pkgs = ["libsndfile-1.0.25-10.h10.eulerosv2r7"];
