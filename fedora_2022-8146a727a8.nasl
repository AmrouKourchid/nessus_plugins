...
# extracted from Fedora Security Advisory FEDORA-2022-8146a727a8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-8146a727a8");

  script_name(english:"Fedora 37 : GitPython (2022-8146a727a8)");
...
FEDORA-2022-8146a727a8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-8146a727a8");
...
var pkgs = [
    {'reference':'GitPython-3.1.30-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
