...
# extracted from Fedora Security Advisory FEDORA-2023-7141950083
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-7141950083");

  script_name(english:"Fedora 39 : filezilla (2023-7141950083)");
...
FEDORA-2023-7141950083 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-7141950083");
  script_set_attribute(attribute:"solution", value:
"Update the affected filezilla package.");
...
var pkgs = [
    {'reference':'filezilla-3.66.4-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
