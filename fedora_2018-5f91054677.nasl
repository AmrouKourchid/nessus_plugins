...
# extracted from Fedora Security Advisory FEDORA-2018-5f91054677.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-5f91054677");

  script_name(english:"Fedora 29 : tcpreplay (2018-5f91054677)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-5f91054677");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"tcpreplay-4.3.1-1.fc29")) flag++;
