...
# extracted from Red Hat Security Advisory RHSA-2024:6187. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:6187");

  script_name(english:"RHEL 9 : gvisor-tap-vsock (RHSA-2024:6187)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_6187.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a27a74b0");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2268019");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:6187");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL gvisor-tap-vsock package based on the guidance in RHSA-2024:6187.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gvisor-tap-vsock-0.7.3-5.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'6'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'gvisor-tap-vsock-0.7.3-5.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'6'}
    ]
  }
];
