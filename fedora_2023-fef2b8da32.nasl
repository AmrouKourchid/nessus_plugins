...
# extracted from Fedora Security Advisory FEDORA-2023-fef2b8da32
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-fef2b8da32");
  script_xref(name:"CEA-ID", value:"CEA-2023-0052");
  script_xref(name:"IAVA", value:"2023-A-0531-S");

  script_name(english:"Fedora 37 : curl (2023-fef2b8da32)");
...
FEDORA-2023-fef2b8da32 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-fef2b8da32");
...
var pkgs = [
    {'reference':'curl-7.85.0-12.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
