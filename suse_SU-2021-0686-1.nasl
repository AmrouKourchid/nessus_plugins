...
# extracted from SUSE update advisory SUSE-SU-2021:0686-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES15 Security Update : nodejs8 (SUSE-SU-2021:0686-1)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fa9fb264");
...
zypper in -t patch SUSE-SLE-Module-Web-Scripting-15-SP2-2021-686=1");
...
flag = 0;
if (rpm_check(release:"SLES15", sp:"2", reference:"nodejs8-8.17.0-10.9.2")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"nodejs8-debuginfo-8.17.0-10.9.2")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"nodejs8-debugsource-8.17.0-10.9.2")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"nodejs8-devel-8.17.0-10.9.2")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"npm8-8.17.0-10.9.2")) flag++;
