...
# extracted from openSUSE Security Update openSUSE-2020-1916.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : SDL (openSUSE-2020-1916)");
...
if ( rpm_check(release:"SUSE15.2", reference:"SDL-debugsource-1.2.15-lp152.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libSDL-1_2-0-1.2.15-lp152.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libSDL-1_2-0-debuginfo-1.2.15-lp152.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libSDL-devel-1.2.15-lp152.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"libSDL-1_2-0-32bit-1.2.15-lp152.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"libSDL-1_2-0-32bit-debuginfo-1.2.15-lp152.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"libSDL-devel-32bit-1.2.15-lp152.5.3.1") ) flag++;
