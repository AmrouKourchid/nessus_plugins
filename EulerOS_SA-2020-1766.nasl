...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : patch (EulerOS-SA-2020-1766)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1766
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?40536f50");
...
pkgs = ["patch-2.7.1-10.h5.eulerosv2r7"];
