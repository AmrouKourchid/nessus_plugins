...
if (description)
{
  ...
  script_name(english:"Fortinet Fortigate Access of NULL pointer in SSLVPNd (FG-IR-22-477)");
...
vulnerability as referenced in the FG-IR-22-477 advisory.

  - An access of uninitialized pointer vulnerability [CWE-824] in the SSL VPN portal of Fortinet FortiOS
    version 7.2.0 through 7.2.3, version 7.0.0 through 7.0.9 and before 6.4.11 and FortiProxy version 7.2.0
    through 7.2.1, version 7.0.0 through 7.0.7 and before 2.0.11 allows a remote authenticated attacker to
    crash the sslvpn daemon via an HTTP GET request. (CVE-2022-45861)
