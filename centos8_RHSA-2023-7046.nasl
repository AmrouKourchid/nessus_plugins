...
# Red Hat Security Advisory RHSA-2023:7046. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : dnsmasq (CESA-2023:7046)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
CESA-2023:7046 advisory.
...
var pkgs = [
    {'reference':'dnsmasq-2.79-31.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'dnsmasq-2.79-31.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'dnsmasq-utils-2.79-31.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'dnsmasq-utils-2.79-31.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
