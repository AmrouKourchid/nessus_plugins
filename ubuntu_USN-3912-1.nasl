...
# extracted from Ubuntu Security Notice USN-3912-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS : GDK-PixBuf vulnerability (USN-3912-1)");
...
USN-3912-1 advisory.
    ...
    It was discovered that the GDK-PixBuf library did not properly handle certain BMP images. If an user or
    automated system were tricked into opening a specially crafted BMP file, a remote attacker could use this
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3912-1");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-12447");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'gir1.2-gdkpixbuf-2.0', 'pkgver': '2.32.2-1ubuntu1.6'},
    {'osver': '16.04', 'pkgname': 'libgdk-pixbuf2.0-0', 'pkgver': '2.32.2-1ubuntu1.6'},
    {'osver': '16.04', 'pkgname': 'libgdk-pixbuf2.0-0-udeb', 'pkgver': '2.32.2-1ubuntu1.6'},
    {'osver': '16.04', 'pkgname': 'libgdk-pixbuf2.0-common', 'pkgver': '2.32.2-1ubuntu1.6'},
    {'osver': '16.04', 'pkgname': 'libgdk-pixbuf2.0-dev', 'pkgver': '2.32.2-1ubuntu1.6'}
];
