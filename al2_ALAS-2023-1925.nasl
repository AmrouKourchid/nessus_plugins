...
# extracted from Amazon Linux 2 Security Advisory ALAS-2023-1925.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : sysstat (ALAS-2023-1925)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"It is, therefore, affected by a vulnerability as referenced in the ALAS2-2023-1925 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2023-1925.html");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/cve/html/CVE-2022-39377.html");
  script_set_attribute(attribute:"solution", value:
"pkg_manager = 'yum'Run ' update sysstat' to update your system.");
...
var pkgs = [
    {'reference':'sysstat-10.1.5-18.amzn2.0.2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sysstat-10.1.5-18.amzn2.0.2', 'cpu':'i686', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sysstat-10.1.5-18.amzn2.0.2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sysstat-debuginfo-10.1.5-18.amzn2.0.2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sysstat-debuginfo-10.1.5-18.amzn2.0.2', 'cpu':'i686', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sysstat-debuginfo-10.1.5-18.amzn2.0.2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
