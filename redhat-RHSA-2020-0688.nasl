...
"The remote Red Hat host is missing a security update for OpenShift Container Platform 4.2.22 runc.");
...
the RHSA-2020:0688 advisory.
    ...
    * runc: volume mount race condition with shared mounts led to information leak/integrity manipulation
    (CVE-2019-19921)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_0688.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ea116b50");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:0688");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1796107");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.2.22 runc package based on the guidance in RHSA-2020:0688.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'runc-1.0.0-63.rc10.rhaos4.2.gitdc9208a.el8', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'runc-1.0.0-63.rc10.rhaos4.2.gitdc9208a.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
