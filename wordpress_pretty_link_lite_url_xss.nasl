...
however, Nessus has not tested for these.");
  script_set_attribute(attribute:"see_also", value:"https://packetstormsecurity.com/files/107551/wordpressprettylink-xss.txt");
  # https://wordpress.org/support/topic/plugin-pretty-link-lite-152-xss-vulnerability/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?64d545c5");
  script_set_attribute(attribute:"see_also", value:"https://wordpress.org/plugins/pretty-link/#changelog");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Pretty Link Lite 1.5.4 or later");
