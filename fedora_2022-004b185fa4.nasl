...
# extracted from Fedora Security Advisory FEDORA-2022-004b185fa4
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-004b185fa4");

  script_name(english:"Fedora 35 : python3.6 (2022-004b185fa4)");
...
FEDORA-2022-004b185fa4 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-004b185fa4");
...
var pkgs = [
    {'reference':'python3.6-3.6.15-14.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
