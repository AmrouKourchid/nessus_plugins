...
# extracted from Red Hat Security Advisory RHSA-2019:1422. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:1422");

  script_name(english:"RHEL 7 : OpenShift Container Platform 3.11 atomic-openshift-web-console (RHSA-2019:1422)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for OpenShift Container Platform 3.11 atomic-openshift-web-console.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_1422.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9b7fc868");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:1422");
...
"Update the RHEL OpenShift Container Platform 3.11 atomic-openshift-web-console package based on the guidance in
RHSA-2019:1422.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'atomic-openshift-web-console-3.11.104-1.git.1.3c3a7f2.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-ansible'},
      {'reference':'atomic-openshift-web-console-3.11.104-1.git.1.3c3a7f2.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-ansible'}
    ]
  }
];
