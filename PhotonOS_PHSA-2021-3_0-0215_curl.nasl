...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Curl PHSA-2021-3.0-0215");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'curl-7.75.0-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'curl-devel-7.75.0-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'curl-libs-7.75.0-1.ph3')) flag++;
