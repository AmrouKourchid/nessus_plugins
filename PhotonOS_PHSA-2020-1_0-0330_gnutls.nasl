...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Gnutls PHSA-2020-1.0-0330");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'gnutls-3.6.15-1.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'gnutls-devel-3.6.15-1.ph1')) flag++;
