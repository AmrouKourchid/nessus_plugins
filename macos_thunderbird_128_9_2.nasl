...
"The version of Thunderbird installed on the remote macOS or Mac OS X host is prior to 128.9.2. It is, therefore,
affected by multiple vulnerabilities as referenced in the mfsa2025-27 advisory.
...
mozilla_check_version(version:version, path:path, product:'thunderbird', esr:FALSE, fix:'128.9.2', severity:SECURITY_WARNING);
