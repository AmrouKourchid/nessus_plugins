...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.3 : ghostscript (EulerOS-SA-2019-1361)");
...
the following vulnerability :
  ...
  - It was found that the superexec operator was available
    ...
    constrains imposed by -dSAFER.i1/4^CVE-2019-3835i1/4%0

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1361
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?04c8d3e9");
