...
if (description)
{
  ...
  script_cve_id("CVE-2022-49564");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-49564");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: crypto: qat - add param check for DH
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-49564");
