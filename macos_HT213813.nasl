...
if (description)
{
  ...
  script_xref(name:"APPLE-SA", value:"HT213813");
  script_xref(name:"IAVA", value:"2023-A-0317-S");
  ...
  script_name(english:"macOS 13.x < 13.4.1 Multiple Vulnerabilities (HT213813)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host is missing a macOS update that fixes multiple vulnerabilities");
  script_set_attribute(attribute:"description", value:
"The remote host is running a version of macOS / Mac OS X that is 13.x prior to 13.4.1. It is, therefore, affected by
multiple vulnerabilities:

  - An integer overflow was addressed with improved input validation. This issue is fixed in watchOS 9.5.2,
    macOS Big Sur 11.7.8, iOS 15.7.7 and iPadOS 15.7.7, macOS Monterey 12.6.7, watchOS 8.8.1, iOS 16.5.1 and
    iPadOS 16.5.1, macOS Ventura 13.4.1. An app may be able to execute arbitrary code with kernel privileges.
    Apple is aware of a report that this issue may have been actively exploited against versions of iOS
    released before iOS 15.7. (CVE-2023-32434)
...
version number.");
  script_set_attribute(attribute:"see_also", value:"https://support.apple.com/en-us/HT213813");
  script_set_attribute(attribute:"solution", value:
"Upgrade to macOS 13.4.1 or later.");
...
var constraints = [
  { 'fixed_version' : '13.4.1', 'min_version' : '13.0', 'fixed_display' : 'macOS Ventura 13.4.1' }
];
