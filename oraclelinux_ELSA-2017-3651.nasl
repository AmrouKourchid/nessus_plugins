...
the ELSA-2017-3651 advisory.
    ...
    [Orabug: 27200879]  {CVE-2017-1000405}
    - fix unbalanced page refcounting in bio_map_user_iov (Vitaly Mayatskikh)  [Orabug: 27069038]
    {CVE-2017-12190}
    - more bio_map_user_iov() leak fixes (Al Viro)  [Orabug: 27069038]  {CVE-2017-12190}
    - packet: in packet_do_bind, test fanout with bind_lock held (Willem de Bruijn)  [Orabug: 27069065]
    {CVE-2017-15649}
    - packet: hold bind lock when rebinding to fanout hook (Willem de Bruijn)  [Orabug: 27069065]
    {CVE-2017-15649}
    - net: convert packet_fanout.sk_ref from atomic_t to refcount_t (Reshetova, Elena)  [Orabug: 27069065]
    {CVE-2017-15649}
    - packet: fix races in fanout_add() (Eric Dumazet)  [Orabug: 27069065]  {CVE-2017-15649}
    - refcount_t: Introduce a special purpose refcount type (Peter Zijlstra)  [Orabug: 27069065]
    {CVE-2017-15649}
    ...
    - selinux: fix off-by-one in setprocattr (Stephen Smalley)  [Orabug: 27001717]  {CVE-2017-2618}
    {CVE-2017-2618} {CVE-2017-2618}
    - sysctl: Drop reference added by grab_header in proc_sys_readdir (Zhou Chengming)  [Orabug: 27036903]
...
var pkgs = [
    ...
    {'reference':'kernel-uek-doc-4.1.12-103.10.1.el6uek', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-doc-4.1.12'},
    {'reference':'kernel-uek-firmware-4.1.12-103.10.1.el6uek', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-firmware-4.1.12'},
    ...
    {'reference':'kernel-uek-doc-4.1.12-103.10.1.el7uek', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-doc-4.1.12'},
    {'reference':'kernel-uek-firmware-4.1.12-103.10.1.el7uek', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-firmware-4.1.12'}
];
