...
# extracted from Fedora Security Advisory FEDORA-2022-2004702d98
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-2004702d98");

  script_name(english:"Fedora 35 : kubernetes (2022-2004702d98)");
...
FEDORA-2022-2004702d98 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-2004702d98");
...
var pkgs = [
    {'reference':'kubernetes-1.22.16-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
