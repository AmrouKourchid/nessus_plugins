...
# SUSE update advisory SUSE-SU-2023:4690-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:4690-1");

  script_name(english:"openSUSE 15 Security Update : poppler (SUSE-SU-2023:4690-1)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://lists.suse.com/pipermail/sle-updates/2023-December/033043.html");
...
var pkgs = [
    {'reference':'libpoppler73-0.62.0-150000.4.34.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.4']},
    {'reference':'libpoppler73-32bit-0.62.0-150000.4.34.1', 'cpu':'x86_64', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.4']}
];
