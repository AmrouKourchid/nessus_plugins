...
if (description)
{
  ...
  script_cve_id("CVE-2011-5320");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2011-5320");
...
patch available.
  ...
  - scanf and related functions in glibc before 2.15 allow local users to cause a denial of service
    (segmentation fault) via a large string of 0s. (CVE-2011-5320)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2011-5320");
