...
# extracted from Oracle Linux Security Advisory ELSA-2023-6524.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : dnsmasq (ELSA-2023-6524)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-6524.html");
...
var pkgs = [
    {'reference':'dnsmasq-2.85-14.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'dnsmasq-utils-2.85-14.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'dnsmasq-2.85-14.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'dnsmasq-utils-2.85-14.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
