...
# extracted from Red Hat Security Advisory RHSA-2020:3908. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:3908");

  script_name(english:"RHEL 7 : cpio (RHSA-2020:3908)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for cpio.");
...
the RHSA-2020:3908 advisory.

    The cpio packages provide the GNU cpio utility for creating and extracting archives, or copying files from
    one place to another.

    Security Fix(es):

    * cpio: improper input validation when writing tar header fields leads to unexpect tar generation
    (CVE-2019-14866)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_3908.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8f68d3d3");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/7/html/7.9_release_notes/index
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dd3afe18");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:3908");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1765511");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL cpio package based on the guidance in RHSA-2020:3908.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cpio-2.11-28.el7', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'cpio-2.11-28.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'cpio-2.11-28.el7', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'cpio-2.11-28.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
