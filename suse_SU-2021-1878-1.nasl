...
# SUSE update advisory SUSE-SU-2021:1878-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2021:1878-1");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1185356");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2021-3514");
  # https://lists.suse.com/pipermail/sle-security-updates/2021-June/008944.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e8eff156");
...
var pkgs = [
    {'reference':'389-ds-1.4.3.23~git0.f53d0132b-3.15', 'sp':'2', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-server-applications-release-15.2']},
    {'reference':'389-ds-devel-1.4.3.23~git0.f53d0132b-3.15', 'sp':'2', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-server-applications-release-15.2']},
    {'reference':'lib389-1.4.3.23~git0.f53d0132b-3.15', 'sp':'2', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-server-applications-release-15.2']},
    {'reference':'libsvrcore0-1.4.3.23~git0.f53d0132b-3.15', 'sp':'2', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-server-applications-release-15.2']}
];
