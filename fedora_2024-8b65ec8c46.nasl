...
# extracted from Fedora Security Advisory FEDORA-2024-8b65ec8c46
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-8b65ec8c46");

  script_name(english:"Fedora 41 : microcode_ctl (2024-8b65ec8c46)");
...
FEDORA-2024-8b65ec8c46 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-8b65ec8c46");
...
var pkgs = [
    {'reference':'microcode_ctl-2.1-66.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
