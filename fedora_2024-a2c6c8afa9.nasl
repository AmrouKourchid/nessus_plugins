...
# extracted from Fedora Security Advisory FEDORA-2024-a2c6c8afa9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-a2c6c8afa9");
  script_xref(name:"IAVA", value:"2024-A-0279-S");

  script_name(english:"Fedora 39 : firefox (2024-a2c6c8afa9)");
...
FEDORA-2024-a2c6c8afa9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-a2c6c8afa9");
...
var pkgs = [
    {'reference':'firefox-126.0-5.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
