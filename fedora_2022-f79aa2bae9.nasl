...
# extracted from Fedora Security Advisory FEDORA-2022-f79aa2bae9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-f79aa2bae9");
  script_xref(name:"IAVB", value:"2022-B-0050-S");

  script_name(english:"Fedora 36 : poppler (2022-f79aa2bae9)");
...
FEDORA-2022-f79aa2bae9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-f79aa2bae9");
...
var pkgs = [
    {'reference':'poppler-22.01.0-6.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
