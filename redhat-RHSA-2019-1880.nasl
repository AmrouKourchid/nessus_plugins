...
# extracted from Red Hat Security Advisory RHSA-2019:1880. The text 
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_1880.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?55da51d5");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:1880");
...
"Update the RHEL curl package based on the guidance in RHSA-2019:1880.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'curl-7.29.0-51.el7_6.3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libcurl-7.29.0-51.el7_6.3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libcurl-devel-7.29.0-51.el7_6.3', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
