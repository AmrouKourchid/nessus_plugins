...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2009-1138.html");
...
"Update the affected openswan and / or openswan-doc packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2009-2185");
...
var pkgs = [
    {'reference':'openswan-2.6.14-1.el5_3.3', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'openswan-doc-2.6.14-1.el5_3.3', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'openswan-2.6.14-1.el5_3.3', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'openswan-doc-2.6.14-1.el5_3.3', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
