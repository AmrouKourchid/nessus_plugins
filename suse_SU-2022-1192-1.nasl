...
# SUSE update advisory SUSE-SU-2022:1192-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:1192-1");

  script_name(english:"SUSE SLES12 Security Update : kernel (Live Patch 29 for SLE 12 SP5) (SUSE-SU-2022:1192-1)");
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-April/010708.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6ec0120e");
  script_set_attribute(attribute:"solution", value:
"Update the affected kgraft-patch-4_12_14-122_113-default package.");
...
var pkgs = [
    {'reference':'kgraft-patch-4_12_14-122_113-default-2-2.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.5']}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kgraft-patch-4_12_14-122_113-default');
}
