...
# openSUSE Security Update openSUSE-SU-2021:1876-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : snakeyaml (openSUSE-SU-2021:1876-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote SUSE Linux SUSE15 host has packages installed that are affected by a vulnerability as referenced in the
openSUSE-SU-2021:1876-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e66c88fc");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2017-18640");
  script_set_attribute(attribute:"solution", value:
"Update the affected snakeyaml and / or snakeyaml-javadoc packages.");
...
pkgs = [
    {'reference':'snakeyaml-1.28-3.5.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'snakeyaml-javadoc-1.28-3.5.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE}
];
