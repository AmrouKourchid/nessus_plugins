...
if (description)
{
  ...
  script_cve_id("CVE-2023-52734");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2023-52734 (deprecated)");
...
"Plugin has been deprecated due to the specified CVE being rejected by NVD.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-52734");
