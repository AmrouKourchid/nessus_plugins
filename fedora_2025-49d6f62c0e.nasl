...
# extracted from Fedora Security Advisory FEDORA-2025-49d6f62c0e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-49d6f62c0e");

  script_name(english:"Fedora 41 : pgadmin4 (2025-49d6f62c0e)");
...
FEDORA-2025-49d6f62c0e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-49d6f62c0e");
...
"Update the affected pgadmin4 package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-2946");
...
var pkgs = [
    {'reference':'pgadmin4-9.2-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
