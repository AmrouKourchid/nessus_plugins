...
if (description)
{
  ...
  script_name(english:"OpenSSL 0.9.8h < 0.9.8o Vulnerability");

  script_set_attribute(attribute:"synopsis", value:
"The remote service is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of OpenSSL installed on the remote host is prior to 0.9.8o. It is, therefore, affected by a vulnerability as
referenced in the 0.9.8o advisory.
...
"Upgrade to OpenSSL version 0.9.8o or later.");
...
var constraints = [
  { 'min_version' : '0.9.8h', 'fixed_version' : '0.9.8o' }
];
