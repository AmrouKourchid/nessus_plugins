...
# extracted from Debian Security Advisory DLA-2654-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2654-1 : composer security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2021/05/msg00009.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/stretch/composer"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security-tracker.debian.org/tracker/source-package/composer"
  );
  script_set_attribute(
    attribute:"solution",
    value:"Upgrade the affected composer package."
  );
...
flag = 0;
if (deb_check(release:"9.0", prefix:"composer", reference:"1.2.2-1+deb9u1")) flag++;
