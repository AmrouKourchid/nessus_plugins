...
if (description)
{
  ...
  script_cve_id("CVE-2024-43831");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-43831");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: media: mediatek: vcodec: Handle
    invalid decoder vsi Handle an invalid decoder vsi in vpu_dec_init to ensure the decoder vsi is valid for
    future use. (CVE-2024-43831)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-43831");
