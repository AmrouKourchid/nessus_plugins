...
# extracted from Fedora Security Advisory FEDORA-2023-327346caa5
#
...
if (description)
{
  ...
  script_cve_id("CVE-2022-41717", "CVE-2022-41723", "CVE-2023-39325");
  script_xref(name:"FEDORA", value:"2023-327346caa5");

  script_name(english:"Fedora 39 : podman-tui (2023-327346caa5)");
...
FEDORA-2023-327346caa5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-327346caa5");
...
var pkgs = [
    {'reference':'podman-tui-0.12.0-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
