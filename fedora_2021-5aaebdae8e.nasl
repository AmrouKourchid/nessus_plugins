...
# extracted from Fedora Security Advisory FEDORA-2021-5aaebdae8e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-5aaebdae8e");
  script_xref(name:"IAVA", value:"2021-A-0524-S");

  script_name(english:"Fedora 33 : salt (2021-5aaebdae8e)");
...
FEDORA-2021-5aaebdae8e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-5aaebdae8e");
...
pkgs = [
    {'reference':'salt-3003-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
