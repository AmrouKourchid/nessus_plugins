...
# extracted from Fedora Security Advisory FEDORA-2024-d9be3edddb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-d9be3edddb");

  script_name(english:"Fedora 39 : qt5-qtbase (2024-d9be3edddb)");
...
FEDORA-2024-d9be3edddb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-d9be3edddb");
...
var pkgs = [
    {'reference':'qt5-qtbase-5.15.12-5.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
