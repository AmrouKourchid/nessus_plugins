...
"The remote Red Hat host is missing a security update for PackageKit.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2018:1224 advisory.

    PackageKit is a D-Bus abstraction layer that allows the session user to manage packages in a secure way
    using a cross-distribution, cross-architecture API.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_1224.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cc963c47");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:1224");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1565992");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL PackageKit package based on the guidance in RHSA-2018:1224.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'PackageKit-1.1.5-2.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'PackageKit-command-not-found-1.1.5-2.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'PackageKit-cron-1.1.5-2.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'PackageKit-glib-1.1.5-2.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'PackageKit-glib-devel-1.1.5-2.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'PackageKit-gstreamer-plugin-1.1.5-2.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'PackageKit-gtk3-module-1.1.5-2.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'PackageKit-yum-1.1.5-2.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'PackageKit-yum-plugin-1.1.5-2.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
