...
# extracted from Debian Security Advisory dsa-5169. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-5169-1 : openssl - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 / 11 host has packages installed that are affected by a vulnerability as referenced in the dsa-5169
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2022/dsa-5169");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-2068");
...
For the stable distribution (bullseye), this problem has been fixed in version 1.1.1n-0+deb11u3.");
  ...
  script_set_attribute(attribute:"patch_publication_date", value:"2022/06/26");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libcrypto1.1-udeb', 'reference': '1.1.1n-0+deb10u3'},
    {'release': '10.0', 'prefix': 'libssl-dev', 'reference': '1.1.1n-0+deb10u3'},
    {'release': '10.0', 'prefix': 'libssl-doc', 'reference': '1.1.1n-0+deb10u3'},
    {'release': '10.0', 'prefix': 'libssl1.1', 'reference': '1.1.1n-0+deb10u3'},
    {'release': '10.0', 'prefix': 'libssl1.1-udeb', 'reference': '1.1.1n-0+deb10u3'},
    {'release': '10.0', 'prefix': 'openssl', 'reference': '1.1.1n-0+deb10u3'},
    {'release': '11.0', 'prefix': 'libcrypto1.1-udeb', 'reference': '1.1.1n-0+deb11u3'},
    {'release': '11.0', 'prefix': 'libssl-dev', 'reference': '1.1.1n-0+deb11u3'},
    {'release': '11.0', 'prefix': 'libssl-doc', 'reference': '1.1.1n-0+deb11u3'},
    {'release': '11.0', 'prefix': 'libssl1.1', 'reference': '1.1.1n-0+deb11u3'},
    {'release': '11.0', 'prefix': 'libssl1.1-udeb', 'reference': '1.1.1n-0+deb11u3'},
    {'release': '11.0', 'prefix': 'openssl', 'reference': '1.1.1n-0+deb11u3'}
];
