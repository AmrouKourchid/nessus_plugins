...
# extracted from Amazon Linux 2023 Security Advisory ALAS2023-2023-300.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2023 : ecs-service-connect-agent (ALAS2023-2023-300)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2023 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"It is, therefore, affected by multiple vulnerabilities as referenced in the ALAS2023-2023-300 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2023/ALAS-2023-300.html");
...
"Run 'dnf update ecs-service-connect-agent --releasever 2023.1.20230823' to update your system.");
...
var pkgs = [
    {'reference':'ecs-service-connect-agent-v1.26.4.0-1.amzn2023', 'cpu':'aarch64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ecs-service-connect-agent-v1.26.4.0-1.amzn2023', 'cpu':'x86_64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE}
];
