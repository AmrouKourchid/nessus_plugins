...
# extracted from Red Hat Security Advisory RHSA-2023:4431. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:4431");

  script_name(english:"RHEL 9 : iperf3 (RHSA-2023:4431)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_4431.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e4b53274");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2222204");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:4431");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL iperf3 package based on the guidance in RHSA-2023:4431.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'iperf3-3.9-10.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
