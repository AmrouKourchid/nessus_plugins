...
# extracted from Fedora Security Advisory FEDORA-2023-d15f5a186a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-d15f5a186a");

  script_name(english:"Fedora 38 : linux-firmware (2023-d15f5a186a)");
...
FEDORA-2023-d15f5a186a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-d15f5a186a");
...
var pkgs = [
    {'reference':'linux-firmware-20230804-152.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
