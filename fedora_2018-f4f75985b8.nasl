...
# extracted from Fedora Security Advisory FEDORA-2018-f4f75985b8.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : soundtouch (2018-f4f75985b8)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-f4f75985b8");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"soundtouch-2.0.0-6.fc28")) flag++;
