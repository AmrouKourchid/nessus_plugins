...
if (description)
{
  ...
  script_cve_id("CVE-2021-36053");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2021-36053");
...
patch available.
  ...
  - XMP Toolkit SDK versions 2020.1 (and earlier) are affected by an out-of-bounds read vulnerability that
    ...
    a malicious file. (CVE-2021-36053)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-36053");
