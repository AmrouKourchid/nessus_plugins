...
# extracted from Red Hat Security Advisory RHSA-2021:2205. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:2205");

  script_name(english:"RHEL 7 : Red Hat OpenStack Platform 10.0 (openvswitch) (RHSA-2021:2205)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for Red Hat OpenStack Platform 10.0 (openvswitch).");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2021:2205 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_2205.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ada223ff");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:2205");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1896536");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat OpenStack Platform 10.0 (openvswitch) package based on the guidance in RHSA-2021:2205.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openvswitch-2.9.9-1.el7fdp', 'cpu':'x86_64', 'release':'7', 'el_string':'el7fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'openvswitch-devel-2.9.9-1.el7fdp', 'cpu':'x86_64', 'release':'7', 'el_string':'el7fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'openvswitch-test-2.9.9-1.el7fdp', 'release':'7', 'el_string':'el7fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'python-openvswitch-2.9.9-1.el7fdp', 'cpu':'x86_64', 'release':'7', 'el_string':'el7fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
