...
# extracted from Ubuntu Security Notice USN-6834-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6834-1");

  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS : H2 vulnerabilities (USN-6834-1)");
...
referenced in the USN-6834-1 advisory.

    It was discovered that H2 was vulnerable to deserialization of untrusted data. An attacker could possibly
    use this issue to execute arbitrary code. (CVE-2021-42392)

    It was discovered that H2 incorrectly handled some specially crafted connection URLs. An attacker could
    possibly use this issue to execute arbitrary code. (CVE-2022-23221)

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6834-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libh2-java', 'pkgver': '1.4.191-1ubuntu0.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libh2-java', 'pkgver': '1.4.196-2ubuntu0.1~esm1', 'ubuntu_pro': TRUE}
];
