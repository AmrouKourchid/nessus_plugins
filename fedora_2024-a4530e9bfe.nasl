...
# extracted from Fedora Security Advisory FEDORA-2024-a4530e9bfe
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-a4530e9bfe");

  script_name(english:"Fedora 39 : openvswitch (2024-a4530e9bfe)");
...
FEDORA-2024-a4530e9bfe advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-a4530e9bfe");
...
var pkgs = [
    {'reference':'openvswitch-3.2.2-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
