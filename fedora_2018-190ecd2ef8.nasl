...
# extracted from Fedora Security Advisory FEDORA-2018-190ecd2ef8.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-190ecd2ef8");

  script_name(english:"Fedora 27 : ruby (2018-190ecd2ef8)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-190ecd2ef8");
...
flag = 0;
if (rpm_check(release:"FC27", reference:"ruby-2.4.5-90.fc27")) flag++;
