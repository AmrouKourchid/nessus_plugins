...
# extracted from Fedora Security Advisory FEDORA-2024-791f8d9804
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-791f8d9804");

  script_name(english:"Fedora 40 : vips (2024-791f8d9804)");
...
FEDORA-2024-791f8d9804 advisory.

    Automatic update for vips-8.15.1-1.fc40.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-791f8d9804");
  script_set_attribute(attribute:"solution", value:
"Update the affected vips package.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:S/C:N/I:N/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:L/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-40032");
...
var pkgs = [
    {'reference':'vips-8.15.1-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
