...
# extracted from Gentoo Linux Security Advisory GLSA 201812-01.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201812-01");

  script_name(english:"GLSA-201812-01 : PHP: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-201812-01
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/201812-01");
...
if (qpkg_check(package:"dev-lang/php", unaffected:make_list("ge 5.6.38", "ge 7.0.32", "ge 7.1.22", "ge 7.2.10"), vulnerable:make_list("lt 5.6.38", "lt 7.0.32", "lt 7.1.22", "lt 7.2.10"))) flag++;
