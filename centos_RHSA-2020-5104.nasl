...
# extracted from Red Hat Security Advisory RHSA-2020:5104.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : firefox (RHSA-2020:5104)");
...
var pkgs = [
    {'reference':'firefox-78.4.1-1.el7.centos', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
