...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : Moderate: / mutt (ELSA-2007-0386)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2007-0386.html");
...
"Update the affected mutt package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2007-2683");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2007-1558");
...
var pkgs = [
    {'reference':'mutt-1.4.2.2-3.0.2.el5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'5'},
    {'reference':'mutt-1.4.2.2-3.0.2.el5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'5'}
];
