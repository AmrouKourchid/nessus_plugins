...
# extracted from Red Hat Security Advisory RHSA-2020:2071. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:2071");

  script_name(english:"RHEL 8 : libreswan (RHSA-2020:2071)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_2071.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?30eff069");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:2071");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1814541");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libreswan package based on the guidance in RHSA-2020:2071.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libreswan-3.29-7.el8_1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
