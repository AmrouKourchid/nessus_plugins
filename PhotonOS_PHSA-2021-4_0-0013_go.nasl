...
if (description)
{
  ...
  script_cve_id("CVE-2021-27918", "CVE-2021-3114");
  script_xref(name:"IAVB", value:"2021-B-0040-S");

  script_name(english:"Photon OS 4.0: Go PHSA-2021-4.0-0013");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the go package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-13.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'go-1.16.2-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'go-md2man-2.0.0-4.ph4')) flag++;
