...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.3.0 : file (EulerOS-SA-2019-2317)");
...
by the following vulnerability :
  ...
  - The do_core_note function in readelf.c in libmagic.a in
    file 5.33 allows remote attackers to cause a denial of
    service (out-of-bounds read and application crash) via
    a crafted ELF file.(CVE-2018-10360)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2317
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4190e6b8");
...
pkgs = ["file-5.34-3.h1.eulerosv2r8",
        "file-libs-5.34-3.h1.eulerosv2r8"];
