...
# extracted from Red Hat Security Advisory bootstrap. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2018-14040", "CVE-2018-14042");

  script_name(english:"RHEL 7 : bootstrap (Unpatched Vulnerability) (deprecated)");
