...
# extracted from Debian Security Advisory DSA-4356. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"4356");
  script_xref(name:"TRA", value:"TRA-2018-48");

  script_name(english:"Debian DSA-4356-1 : netatalk - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"Jacob Baines discovered a flaw in the handling of the DSI Opensession
command in Netatalk, an implementation of the AppleTalk Protocol
Suite, allowing an unauthenticated user to execute arbitrary code with
root privileges.");
  script_set_attribute(attribute:"see_also", value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=916930");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/netatalk");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/stretch/netatalk");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2018/dsa-4356");
...
flag = 0;
if (deb_check(release:"9.0", prefix:"netatalk", reference:"2.2.5-2+deb9u1")) flag++;
if (deb_check(release:"9.0", prefix:"netatalk-dbg", reference:"2.2.5-2+deb9u1")) flag++;
