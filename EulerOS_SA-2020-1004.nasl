...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : flatpak (EulerOS-SA-2020-1004)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1004
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?80d9c728");
...
pkgs = ["flatpak-1.0.3-1.h2.eulerosv2r8",
        "flatpak-libs-1.0.3-1.h2.eulerosv2r8"];
