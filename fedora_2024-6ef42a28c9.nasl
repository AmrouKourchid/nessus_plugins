...
# extracted from Fedora Security Advisory FEDORA-2024-6ef42a28c9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-6ef42a28c9");

  script_name(english:"Fedora 39 : redis (2024-6ef42a28c9)");
...
FEDORA-2024-6ef42a28c9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-6ef42a28c9");
...
var pkgs = [
    {'reference':'redis-7.2.4-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
