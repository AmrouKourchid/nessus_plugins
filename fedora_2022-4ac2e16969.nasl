...
# extracted from Fedora Security Advisory FEDORA-2022-4ac2e16969
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-4ac2e16969");

  script_name(english:"Fedora 36 : pypy3.9 (2022-4ac2e16969)");
...
FEDORA-2022-4ac2e16969 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-4ac2e16969");
...
var pkgs = [
    {'reference':'pypy3.9-7.3.9-4.3.9.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
