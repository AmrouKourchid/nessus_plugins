...
# extracted from Fedora Security Advisory FEDORA-2023-e692a72898
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-e692a72898");

  script_name(english:"Fedora 37 : libwebp (2023-e692a72898)");
...
FEDORA-2023-e692a72898 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-e692a72898");
...
var pkgs = [
    {'reference':'libwebp-1.3.2-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
