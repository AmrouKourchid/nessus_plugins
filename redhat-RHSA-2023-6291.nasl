...
# extracted from Red Hat Security Advisory RHSA-2023:6291. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:6291");

  script_name(english:"RHEL 9 : c-ares (RHSA-2023:6291)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6291.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dea1e74a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2168631");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6291");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL c-ares package based on the guidance in RHSA-2023:6291.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'c-ares-1.17.1-5.el9_0.2', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'c-ares-devel-1.17.1-5.el9_0.2', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
