...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : httpd (EulerOS-SA-2024-1684)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1684
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8372b557");
...
var pkgs = [
  "httpd-2.4.34-8.h28.eulerosv2r8",
  "httpd-devel-2.4.34-8.h28.eulerosv2r8",
  "httpd-filesystem-2.4.34-8.h28.eulerosv2r8",
  "httpd-manual-2.4.34-8.h28.eulerosv2r8",
  "httpd-tools-2.4.34-8.h28.eulerosv2r8",
  "mod_session-2.4.34-8.h28.eulerosv2r8",
  "mod_ssl-2.4.34-8.h28.eulerosv2r8"
];
