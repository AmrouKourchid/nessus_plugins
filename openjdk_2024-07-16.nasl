...
if (description)
{
  ...
  script_name(english:"OpenJDK 8 <= 8u412 / 11.0.0 <= 11.0.23 / 17.0.0 <= 17.0.11 / 21.0.0 <= 21.0.3 / 22.0.0 <= 22.0.1 Multiple Vulnerabilities (2024-07-16)");

  script_set_attribute(attribute:"synopsis", value:
"OpenJDK is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of OpenJDK installed on the remote host is prior to 8 <= 8u412 / 11.0.0 <= 11.0.23 / 17.0.0 <= 17.0.11 /
21.0.0 <= 21.0.3 / 22.0.0 <= 22.0.1. It is, therefore, affected by multiple vulnerabilities as referenced in the
2024-07-16 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://openjdk.java.net/groups/vulnerability/advisories/2024-07-16");
  script_set_attribute(attribute:"solution", value:
"Upgrade to an OpenJDK version greater than 8u412 / 11.0.23 / 17.0.11 / 21.0.3 / 22.0.1");
...
var constraints = [
  { 'min_version' : '8.0.0', 'max_version' : '8.0.412', 'fixed_display' : 'Upgrade to a version greater than 8u412' },
  { 'min_version' : '11.0.0', 'max_version' : '11.0.23', 'fixed_display' : 'Upgrade to a version greater than 11.0.23' },
  { 'min_version' : '17.0.0', 'max_version' : '17.0.11', 'fixed_display' : 'Upgrade to a version greater than 17.0.11' },
  { 'min_version' : '21.0.0', 'max_version' : '21.0.3', 'fixed_display' : 'Upgrade to a version greater than 21.0.3' },
  { 'min_version' : '22.0.0', 'max_version' : '22.0.1', 'fixed_display' : 'Upgrade to a version greater than 22.0.1' }
];
