...
# extracted from Fedora Security Advisory FEDORA-2019-f6ff819834.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-f6ff819834");

  script_name(english:"Fedora 29 : openssh (2019-f6ff819834)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"This update fixes CVE-2018-20685 (the first 'variant') and backports
several fixes to unbreak ECDSA authentication from PKCS#11,
certificate authentication and so on.

Note that Tenable Network Security has extracted the preceding
description block directly from the Fedora update system website.
Tenable has attempted to automatically clean and format it as much as
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-f6ff819834");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"openssh-7.9p1-3.fc29")) flag++;
