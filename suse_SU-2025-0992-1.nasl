...
# SUSE update advisory SUSE-SU-2025:0992-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2025:0992-1");

  script_name(english:"SUSE SLES12 Security Update : docker (SUSE-SU-2025:0992-1)");
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2025-March/020584.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?86ed4653");
...
var pkgs = [
    {'reference':'docker-27.5.1_ce-98.123.1', 'sp':'5', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-ltss-extended-security-release-12.5']},
    {'reference':'docker-bash-completion-27.5.1_ce-98.123.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-ltss-extended-security-release-12.5']}
];
