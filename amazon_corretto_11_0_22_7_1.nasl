...
if (description)
{
  ...
  script_name(english:"Amazon Corretto Java 11.x < 11.0.22.7.1 Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"Amazon Corretto is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Amazon Corretto installed on the remote host is prior to 11 < 11.0.22.7.1. It is, therefore, affected by
multiple vulnerabilities as referenced in the corretto-11-2024-Jan-16 advisory.
...
"Update to Amazon Corretto Java 11.0.22.7.1 or later");
...
var constraints = [
  { 'min_version' : '11.0', 'fixed_version' : '11.0.22.7.1' }
];
