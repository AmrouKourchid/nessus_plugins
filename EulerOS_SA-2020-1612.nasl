...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : openldap (EulerOS-SA-2020-1612)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1612
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d2fd39d2");
...
pkgs = ["openldap-2.4.44-15.h10.eulerosv2r7",
        ...
        "openldap-devel-2.4.44-15.h10.eulerosv2r7",
        "openldap-servers-2.4.44-15.h10.eulerosv2r7"];
