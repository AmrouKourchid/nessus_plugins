...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : Moderate: / tk (ELSA-2008-0136)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2008-0136.html");
...
"Update the affected tk and / or tk-devel packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2008-0553");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2007-5137");
...
var pkgs = [
    {'reference':'tk-8.4.13-5.el5_1.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tk-devel-8.4.13-5.el5_1.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tk-8.4.13-5.el5_1.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tk-devel-8.4.13-5.el5_1.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
