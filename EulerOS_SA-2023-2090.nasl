...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.0 : libX11 (EulerOS-SA-2023-2090)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2090
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0045afea");
...
var pkgs = [
  "libX11-1.7.2-2.h3.eulerosv2r11"
];
