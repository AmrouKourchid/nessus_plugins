...
# SUSE update advisory SUSE-SU-2024:1143-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2024:1143-1");

  script_name(english:"SUSE SLES15 / openSUSE 15 Security Update : buildah (SUSE-SU-2024:1143-1)");
...
as referenced in the SUSE-SU-2024:1143-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://lists.suse.com/pipermail/sle-updates/2024-April/034879.html");
...
var pkgs = [
    {'reference':'buildah-1.34.1-150500.3.7.1', 'sp':'5', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.5']},
    {'reference':'buildah-1.34.1-150500.3.7.1', 'sp':'5', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.5', 'sle-module-containers-release-15.5', 'sles-release-15.5']},
    {'reference':'buildah-1.34.1-150500.3.7.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.5']}
];
