...
vulnerabilities as referenced in the USN-5998-1 advisory.
    ...
    An attacker could possibly use this issue to execute arbitrary code. This issue only affected Ubuntu 16.04
    ESM. (CVE-2019-17571)

    It was discovered that the JMSSink component of Apache Log4j 1.2 incorrectly handled deserialization. An
    attacker could possibly use this issue to execute arbitrary code. (CVE-2022-23302)

    It was discovered that Apache Log4j 1.2 incorrectly handled certain SQL statements. A remote attacker
    could possibly use this issue to perform an SQL injection attack and alter the database. This issue was
    only fixed in Ubuntu 18.04 LTS and Ubuntu 20.04 LTS. (CVE-2022-23305)

    It was discovered that the Chainsaw component of Apache Log4j 1.2 incorrectly handled deserialization. An
    attacker could possibly use this issue to execute arbitrary code. This issue was only fixed in Ubuntu
    18.04 LTS and Ubuntu 20.04 LTS. (CVE-2022-23307)
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'liblog4j1.2-java', 'pkgver': '1.2.17-7ubuntu1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'liblog4j1.2-java', 'pkgver': '1.2.17-8+deb10u1ubuntu0.2', 'ubuntu_pro': FALSE},
    {'osver': '20.04', 'pkgname': 'liblog4j1.2-java', 'pkgver': '1.2.17-9ubuntu0.2', 'ubuntu_pro': FALSE}
];
