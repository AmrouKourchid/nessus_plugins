...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 5 : bind (IJ29230)");
  script_summary(english:"Check for APAR IJ29230");
...
if (aix_check_ifix(release:"7.1", ml:"05", sp:"05", patch:"IJ29230m7a", package:"bos.net.tcp.client", minfilesetver:"7.1.5.0", maxfilesetver:"7.1.5.36") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"05", sp:"06", patch:"IJ29230m7a", package:"bos.net.tcp.client", minfilesetver:"7.1.5.0", maxfilesetver:"7.1.5.36") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"05", sp:"07", patch:"IJ29230m7a", package:"bos.net.tcp.client", minfilesetver:"7.1.5.0", maxfilesetver:"7.1.5.36") < 0) flag++;
