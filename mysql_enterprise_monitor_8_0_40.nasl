...
if (description)
{
  ...
  script_name(english:"Oracle MySQL Enterprise Monitor (October 2024 CPU)");
...
referenced in the October 2024 CPU advisory.
  ...
  - Vulnerability in the MySQL Enterprise Monitor product of Oracle MySQL (component: Monitoring: General
    (OpenSSL)). Supported versions that are affected are 8.0.39 and prior. Easily exploitable vulnerability
    allows unauthenticated attacker with network access via multiple protocols to compromise MySQL Enterprise
    Monitor. Successful attacks of this vulnerability can result in unauthorized access to critical data or
    complete access to all MySQL Enterprise Monitor accessible data and unauthorized ability to cause a hang
    or frequently repeatable crash (complete DOS) of MySQL Enterprise Monitor. (CVE-2024-5535, CVE-2024-6119)
...
var constraints = [
  { 'min_version' : '8.0', 'fixed_version' : '8.0.40' }
];
