...
if (description)
{
  ...
  script_name(english:"Google Chrome < 135.0.7049.114 Vulnerability");

  script_set_attribute(attribute:"synopsis", value:
"A web browser installed on the remote Windows host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Google Chrome installed on the remote Windows host is prior to 135.0.7049.114. It is, therefore, affected
by a vulnerability as referenced in the 2025_04_stable-channel-update-for-desktop_22 advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://chromereleases.googleblog.com/2025/04/stable-channel-update-for-desktop_22.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?91a16864");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Google Chrome version 135.0.7049.114 or later.");
...
google_chrome_check_version(installs:installs, fix:'135.0.7049.114', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
