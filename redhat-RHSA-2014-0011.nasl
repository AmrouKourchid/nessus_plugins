...
# extracted from Red Hat Security Advisory RHSA-2014:0011. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2014:0011");

  script_name(english:"RHEL 6 : ruby193-ruby (RHSA-2014:0011)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for ruby193-ruby.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 6 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2014:0011 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2014/rhsa-2014_0011.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b79f7f14");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2014:0011");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL ruby193-ruby package based on the guidance in RHSA-2014:0011.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ruby193-ruby-1.9.3.448-40.1.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'ruby193-ruby-devel-1.9.3.448-40.1.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'ruby193-ruby-doc-1.9.3.448-40.1.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'ruby193-ruby-irb-1.9.3.448-40.1.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'ruby193-ruby-libs-1.9.3.448-40.1.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'ruby193-ruby-tcltk-1.9.3.448-40.1.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'ruby193-rubygem-bigdecimal-1.1.0-40.1.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'ruby193-rubygem-io-console-0.3-40.1.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'ruby193-rubygem-json-1.5.5-40.1.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'ruby193-rubygem-minitest-2.5.1-40.1.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'ruby193-rubygem-rake-0.9.2.2-40.1.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
