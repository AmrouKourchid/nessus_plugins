...
# extracted from Debian Security Advisory dla-3291. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2020-15256", "CVE-2021-3805", "CVE-2021-23434");

  script_name(english:"Debian dla-3291 : node-object-path - security update");
...
number.");
  # https://security-tracker.debian.org/tracker/source-package/node-object-path
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d109f415");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2020-15256");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2021-23434");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2021-3805");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/node-object-path");
...
"Upgrade the node-object-path packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-23434");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2020-15256");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:node-object-path");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'node-object-path', 'reference': '0.11.4-2+deb10u2'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'node-object-path');
}
