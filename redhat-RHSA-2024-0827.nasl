...
# extracted from Red Hat Security Advisory RHSA-2024:0827. The text
...
referenced in the RHSA-2024:0827 advisory.
    ...
    .NET SDK 8.0.102 and .NET Runtime 8.0.2.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0827.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a01e0153");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-23939");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0827");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL .NET 8.0 package based on the guidance in RHSA-2024:0827.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'aspnetcore-runtime-8.0-8.0.2-2.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'aspnetcore-runtime-dbg-8.0-8.0.2-2.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'aspnetcore-targeting-pack-8.0-8.0.2-2.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-8.0.102-2.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-apphost-pack-8.0-8.0.2-2.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-host-8.0.2-2.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-hostfxr-8.0-8.0.2-2.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-runtime-8.0-8.0.2-2.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-runtime-dbg-8.0-8.0.2-2.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-sdk-8.0-8.0.102-2.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-sdk-8.0-source-built-artifacts-8.0.102-2.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-sdk-dbg-8.0-8.0.102-2.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-targeting-pack-8.0-8.0.2-2.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-templates-8.0-8.0.102-2.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'netstandard-targeting-pack-2.1-8.0.102-2.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
