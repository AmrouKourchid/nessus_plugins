...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : openssl (EulerOS-SA-2022-2578)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2578
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5bbd4474");
...
var pkgs = [
  "openssl-1.1.1-3.h14.eulerosv2r8",
