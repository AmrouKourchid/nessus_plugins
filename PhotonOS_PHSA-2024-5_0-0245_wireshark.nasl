...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Wireshark PHSA-2024-5.0-0245");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'wireshark-4.0.14-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'wireshark-devel-4.0.14-1.ph5')) flag++;
