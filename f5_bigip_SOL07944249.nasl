...
# extracted from F5 Networks BIG-IP Solution K07944249.
#
# @NOAGENT@
##
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : Node.js vulnerability (K07944249)");

  script_set_attribute(attribute:"synopsis", value:
"The remote device is missing a vendor-supplied security patch.");
  script_set_attribute(attribute:"description", value:
"The version of F5 Networks BIG-IP installed on the remote host is prior to 14.1.4.4 / 15.1.4.1 / 16.1.0. It is,
therefore, affected by a vulnerability as referenced in the K07944249 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K07944249");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K07944249.");
...
var vmatrix = {
  'AFM': {
    'affected': [
      '16.0.0-16.1.4','16.0.0-16.0.1','15.1.0-15.1.4','15.1.0-15.1.10','14.1.0-14.1.4','13.1.0-13.1.4','12.1.0-12.1.6'
    ],
    'unaffected': [
