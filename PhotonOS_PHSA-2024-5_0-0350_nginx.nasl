...
# extracted from VMware Security Advisory PHSA-2024-5.0-0350. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Nginx PHSA-2024-5.0-0350");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the nginx package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-5.0-350.md");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss4_score_source", value:"CVE-2024-7347");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'nginx-1.26.2-1.ph5')) flag++;
