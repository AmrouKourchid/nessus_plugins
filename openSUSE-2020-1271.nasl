...
# extracted from openSUSE Security Update openSUSE-2020-1271.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : inn (openSUSE-2020-1271)");
...
if ( rpm_check(release:"SUSE15.1", reference:"inn-2.5.4-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"inn-debuginfo-2.5.4-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"inn-debugsource-2.5.4-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"inn-devel-2.5.4-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"mininews-2.5.4-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"mininews-debuginfo-2.5.4-lp151.3.6.1") ) flag++;
