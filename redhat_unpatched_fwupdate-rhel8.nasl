...
# extracted from Red Hat Security Advisory fwupdate. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 8 : fwupdate (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-25647");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2020-25632");
