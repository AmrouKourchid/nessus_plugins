...
# extracted from Red Hat Security Advisory RHSA-2022:4930. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:4930");

  script_name(english:"RHEL 7 : python-twisted-web (RHSA-2022:4930)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_4930.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4d76cd04");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:4930");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2073114");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-twisted-web package based on the guidance in RHSA-2022:4930.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python-twisted-web-12.1.0-8.el7_9', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python-twisted-web-12.1.0-8.el7_9', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python-twisted-web-12.1.0-8.el7_9', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
