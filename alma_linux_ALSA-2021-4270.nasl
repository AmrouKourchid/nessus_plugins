...
# AlmaLinux Security Advisory ALSA-2021:4270.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2021:4270");

  script_name(english:"AlmaLinux 8 : rust-toolset:rhel8 (ALSA-2021:4270)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2021-4270.html");
