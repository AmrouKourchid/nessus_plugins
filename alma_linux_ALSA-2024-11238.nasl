...
# AlmaLinux Security Advisory ALSA-2024:11238.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:11238");
  script_xref(name:"RHSA", value:"2024:11238");

  script_name(english:"AlmaLinux 9 : python3.11-urllib3 (ALSA-2024:11238)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2024-11238.html");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:11238");
  script_set_attribute(attribute:"solution", value:
"Update the affected python3.11-urllib3 package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:python3.11-urllib3");
...
var pkgs = [
    {'reference':'python3.11-urllib3-1.26.12-2.el9_5.2', 'release':'9', 'el_string':'el9_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'}
];
