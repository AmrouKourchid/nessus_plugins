...
Bug fixes :
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1100333");
  script_set_attribute(attribute:"see_also", value:"https://github.com/NVIDIA/libnvidia-container");
  # https://github.com/singularityware/singularity/blob/master/etc/nvliblist.conf
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d5a7b5c8");
...
"Update the affected singularity packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-12021");
