...
# extracted from Fedora Security Advisory FEDORA-2018-7c2e0a998d.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : acpica-tools (2018-7c2e0a998d)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-7c2e0a998d");
...
"Update the affected acpica-tools package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-13693");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2017-13695");
...
flag = 0;
if (rpm_check(release:"FC27", reference:"acpica-tools-20180209-1.fc27")) flag++;
