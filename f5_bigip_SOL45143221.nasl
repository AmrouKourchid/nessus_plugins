...
therefore, affected by a vulnerability as referenced in the K45143221 advisory.

  - On BIG-IP ASM & Advanced WAF versions 16.0.0-16.0.0.1, 15.1.0-15.1.0.5, and 14.1.0-14.1.3, under certain
    conditions, Analytics, Visibility, and Reporting daemon (AVRD) may generate a core file and restart on the
    BIG-IP system when processing requests sent from mobile devices. (CVE-2020-27728)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K45143221");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K45143221.");
...
var vmatrix = {
  'ASM': {
    'affected': [
      '16.0.0','15.0.0-15.1.0','14.1.0-14.1.3'
    ],
    'unaffected': [
