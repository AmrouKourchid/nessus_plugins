...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.0 : ncurses (EulerOS-SA-2022-2094)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2094
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?36cddf09");
...
var pkgs = [
  "ncurses-6.2-1.h3.eulerosv2r10",
  "ncurses-base-6.2-1.h3.eulerosv2r10",
  "ncurses-help-6.2-1.h3.eulerosv2r10",
  "ncurses-libs-6.2-1.h3.eulerosv2r10"
];
