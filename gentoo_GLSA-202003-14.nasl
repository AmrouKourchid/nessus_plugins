...
# extracted from Gentoo Linux Security Advisory GLSA 202003-14.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202003-14");

  script_name(english:"GLSA-202003-14 : atftp: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202003-14
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202003-14");
...
"All atftp users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:atftp");
...
if (qpkg_check(package:"net-ftp/atftp", unaffected:make_list("ge 0.7.2"), vulnerable:make_list("lt 0.7.2"))) flag++;
