...
if (description)
{
  ...
  script_name(english:"IBM DB2 SEoL (10.1.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of IBM DB2 is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, IBM DB2 is 10.1.x. It is, therefore, no longer maintained by its vendor or provider.
...
contain security vulnerabilities.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/docs/en/announcements/archive/ENUSC16-015#916-003");
...
"Upgrade to a version of IBM DB2 that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2017/09/30");
...
var constraints = [
  { max_branch : '10.1', min_branch : '10.1', eseol : 20250430, seol : 20170930 }
];
