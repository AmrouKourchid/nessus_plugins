...
# extracted from Red Hat Security Advisory RHSA-2024:2156. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2156");

  script_name(english:"RHEL 9 : frr (RHSA-2024:2156)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for frr.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:2156 advisory.

    FRRouting is free software that manages TCP/IP based routing protocols. It supports BGP4, OSPFv2, OSPFv3,
    ISIS, RIP, RIPng, PIM, NHRP, PBR, EIGRP and BFD.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2156.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?22775c83");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2156");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2235839");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2235840");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2235842");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2237416");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2238990");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2238992");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2246379");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2246381");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-11664");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-15291");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL frr package based on the guidance in RHSA-2024:2156.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:frr");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:frr-selinux");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'frr-8.5.3-4.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'frr-selinux-8.5.3-4.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
