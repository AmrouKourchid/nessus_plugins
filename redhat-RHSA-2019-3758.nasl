...
# extracted from Red Hat Security Advisory RHSA-2019:3758. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:3758");

  script_name(english:"RHEL 7 : patch (RHSA-2019:3758)");
...
referenced in the RHSA-2019:3758 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_3758.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?75a64bda");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:3758");
...
"Update the RHEL patch package based on the guidance in RHSA-2019:3758.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'patch-2.7.1-11.el7_6', 'sp':'6', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'patch-2.7.1-11.el7_6', 'sp':'6', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'patch-2.7.1-11.el7_6', 'sp':'6', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'patch-2.7.1-11.el7_6', 'sp':'6', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'patch-2.7.1-11.el7_6', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'patch-2.7.1-11.el7_6', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'patch-2.7.1-11.el7_6', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'patch-2.7.1-11.el7_6', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
