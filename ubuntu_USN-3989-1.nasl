...
# extracted from Ubuntu Security Notice USN-3989-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS : LibRaw vulnerabilities (USN-3989-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 16.04 LTS / 18.04 LTS host has packages installed that are affected by multiple vulnerabilities as
referenced in the USN-3989-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3989-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libraw-bin', 'pkgver': '0.17.1-1ubuntu0.5'},
    {'osver': '16.04', 'pkgname': 'libraw-dev', 'pkgver': '0.17.1-1ubuntu0.5'},
    {'osver': '16.04', 'pkgname': 'libraw15', 'pkgver': '0.17.1-1ubuntu0.5'},
    {'osver': '18.04', 'pkgname': 'libraw-bin', 'pkgver': '0.18.8-1ubuntu0.3'},
    {'osver': '18.04', 'pkgname': 'libraw-dev', 'pkgver': '0.18.8-1ubuntu0.3'},
    {'osver': '18.04', 'pkgname': 'libraw16', 'pkgver': '0.18.8-1ubuntu0.3'}
];
