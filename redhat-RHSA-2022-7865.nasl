...
# extracted from Red Hat Security Advisory RHSA-2022:7865. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2022-36881");
  script_xref(name:"RHSA", value:"2022:7865");

  script_name(english:"RHEL 8 : OpenShift Container Platform 4.10.41 (RHSA-2022:7865)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for OpenShift Container Platform 4.10.41.");
...
the RHSA-2022:7865 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.10.41. See the
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_7865.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?180dab9e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:7865");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2114755");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.10.41 package based on the guidance in RHSA-2022:7865.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:H/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:H/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-36881");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jenkins-2-plugins-4.10.1667388055-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
