...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : 389-ds-base on SL7.x x86_64 (20191202)");
...
"Security Fix(es) :
  ...
  - 389-ds-base: Read permission check bypass via the deref
    plugin (CVE-2019-14824)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1912&L=SCIENTIFIC-LINUX-ERRATA&P=79
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9076a34e");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"389-ds-base-1.3.9.1-12.el7_7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"389-ds-base-debuginfo-1.3.9.1-12.el7_7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"389-ds-base-devel-1.3.9.1-12.el7_7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"389-ds-base-libs-1.3.9.1-12.el7_7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"389-ds-base-snmp-1.3.9.1-12.el7_7")) flag++;
