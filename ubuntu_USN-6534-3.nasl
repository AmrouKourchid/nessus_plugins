...
# extracted from Ubuntu Security Notice USN-6534-3. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6534-3");

  script_name(english:"Ubuntu 22.04 LTS : Linux kernel vulnerabilities (USN-6534-3)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6534-3");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-6.2.0-1013-nvidia");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-6.2.0-1013-nvidia-64k");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-6.2.0-1018-lowlatency");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-6.2.0-1018-lowlatency-64k");
...
var kernel_mappings = {
  '22.04': {
    '6.2.0': {
      ...
      'nvidia': '6.2.0-1013',
      'nvidia-64k': '6.2.0-1013',
      'lowlatency': '6.2.0-1018',
      'lowlatency-64k': '6.2.0-1018'
    }
  }
};
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-6534-3');
}
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-6534-3');
  }
  else
  {
