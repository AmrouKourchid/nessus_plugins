...
by a vulnerability as referenced in the K05380109 advisory.
    ...
    In Bootstrap before 4.1.2, XSS is possible in the data-target property of
    scrollspy.(CVE-2018-14041)ImpactAn attacker may exploit this vulnerability to perform a cross-site
...
var vmatrix = {
  ...
  'ASM': {
    'affected': [
      '17.0.0','16.1.0-16.1.4','15.1.0-15.1.10','14.1.0-14.1.5','13.1.0-13.1.5'
    ],
    'unaffected': [
      '17.1.0'
    ],
