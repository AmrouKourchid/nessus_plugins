...
# extracted from Fedora Security Advisory FEDORA-2024-2ba00c906c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-2ba00c906c");
  script_xref(name:"IAVA", value:"2024-A-0682");

  script_name(english:"Fedora 39 : unbound (2024-2ba00c906c)");
...
FEDORA-2024-2ba00c906c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-2ba00c906c");
...
var pkgs = [
    {'reference':'unbound-1.21.1-3.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
