...
# extracted from Fedora Security Advisory FEDORA-2024-237107cece
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-237107cece");

  script_name(english:"Fedora 38 : chromium (2024-237107cece)");
...
FEDORA-2024-237107cece advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-237107cece");
...
var pkgs = [
    {'reference':'chromium-120.0.6099.216-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
