...
if (description)
{
  ...
  script_name(english:"Microsoft Word Viewer Unsupported Version Detection");
  script_summary(english:"Checks the Word Viewer version.");

  script_set_attribute(attribute:"synopsis", value:
"The version of Microsoft Word Viewer installed on the remote host is
no longer supported.");
  script_set_attribute(attribute:"description", value:
"Microsoft has ended support for all versions of Word Viewer.

Lack of support implies that no new security patches for the product
will be released by the vendor. As a result, it is likely to contain
security vulnerabilities.

Note that Word Viewer was formerly known as Word Viewer 2003 Service
Pack 3. The file versions are the same, only the name has changed in
...
"Uninstall Microsoft Word Viewer.");
  ...
  script_dependencies("microsoft_word_viewer_installed.nbin");
  script_require_keys("installed_sw/Microsoft Word Viewer");

  exit(0);
}
include('ucf.inc');

var app = 'Microsoft Word Viewer';
