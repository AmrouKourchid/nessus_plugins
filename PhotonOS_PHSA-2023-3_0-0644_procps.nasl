...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Procps PHSA-2023-3.0-0644");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'procps-ng-3.3.15-4.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'procps-ng-devel-3.3.15-4.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'procps-ng-lang-3.3.15-4.ph3')) flag++;
