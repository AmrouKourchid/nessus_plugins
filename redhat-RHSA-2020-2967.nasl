...
# extracted from Red Hat Security Advisory RHSA-2020:2967. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:2967");

  script_name(english:"RHEL 8 : sane-backends (RHSA-2020:2967)");
...
referenced in the RHSA-2020:2967 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_2967.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1da814c8");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:2967");
...
"Update the RHEL sane-backends package based on the guidance in RHSA-2020:2967.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'sane-backends-1.0.27-19.el8_1.1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sane-backends-daemon-1.0.27-19.el8_1.1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sane-backends-devel-1.0.27-19.el8_1.1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sane-backends-doc-1.0.27-19.el8_1.1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sane-backends-drivers-cameras-1.0.27-19.el8_1.1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sane-backends-drivers-scanners-1.0.27-19.el8_1.1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sane-backends-libs-1.0.27-19.el8_1.1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
