...
# extracted from Fedora Security Advisory FEDORA-2022-a6812b0224
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-a6812b0224");

  script_name(english:"Fedora 37 : libxml2 / xmlsec1 (2022-a6812b0224)");
...
FEDORA-2022-a6812b0224 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-a6812b0224");
  script_set_attribute(attribute:"solution", value:
"Update the affected libxml2 and / or xmlsec1 packages.");
...
var pkgs = [
    {'reference':'libxml2-2.10.3-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xmlsec1-1.2.34-4.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libxml2 / xmlsec1');
}
