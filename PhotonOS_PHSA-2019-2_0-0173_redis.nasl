...
if (description)
{
  ...
  script_cve_id("CVE-2019-10193");

  script_name(english:"Photon OS 2.0: Redis PHSA-2019-2.0-0173");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'redis-4.0.14-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'redis-debuginfo-4.0.14-1.ph2')) flag++;
