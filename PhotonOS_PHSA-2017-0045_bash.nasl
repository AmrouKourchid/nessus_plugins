...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'bash-4.4.12-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'bash-debuginfo-4.4.12-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'bash-devel-4.4.12-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'bash-lang-4.4.12-1.ph2')) flag++;
