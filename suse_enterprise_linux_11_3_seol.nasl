...
if (description)
{
  ...
  script_name(english:"SUSE Enterprise Linux SEoL (11.3.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of SUSE Enterprise Linux is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, SUSE Enterprise Linux is 11.3.x. It is, therefore, no longer maintained by its vendor or
provider.
...
"Upgrade to a version of SUSE Enterprise Linux that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2016/01/31");
...
var constraints = [
  { max_branch : '11.3', min_branch : '11.3', seol : 20160131, eseol : 20190130 }
];
