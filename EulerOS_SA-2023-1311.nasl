...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : expat (EulerOS-SA-2023-1311)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1311
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?acba678f");
...
var pkgs = [
  "expat-2.2.6-1.h8.eulerosv2r8",
  "expat-devel-2.2.6-1.h8.eulerosv2r8"
];
