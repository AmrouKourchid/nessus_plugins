...
# extracted from Red Hat Security Advisory RHSA-2024:9195. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:9195");

  script_name(english:"RHEL 9 : cyrus-imapd (RHSA-2024:9195)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-6509");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_9195.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7f19ee27");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:9195");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL cyrus-imapd package based on the guidance in RHSA-2024:9195.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:cyrus-imapd-libs");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cyrus-imapd-3.4.8-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'cyrus-imapd-libs-3.4.8-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'cyrus-imapd-utils-3.4.8-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'perl-Cyrus-3.4.8-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'cyrus-imapd / cyrus-imapd-libs / cyrus-imapd-utils / perl-Cyrus');
}
