...
# extracted from Oracle Linux Security Advisory ELSA-2023-2120.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : libreswan (ELSA-2023-2120)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-2120.html");
...
var pkgs = [
    {'reference':'libreswan-4.6-3.0.1.el9_1.1', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libreswan-4.6-3.0.1.el9_1.1', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
