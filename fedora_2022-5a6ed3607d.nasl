...
# extracted from Fedora Security Advisory FEDORA-2022-5a6ed3607d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-5a6ed3607d");

  script_name(english:"Fedora 35 : keylime (2022-5a6ed3607d)");
...
FEDORA-2022-5a6ed3607d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-5a6ed3607d");
...
var pkgs = [
    {'reference':'keylime-6.4.3-2.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
