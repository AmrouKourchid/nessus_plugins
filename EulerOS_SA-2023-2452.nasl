...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : libtiff (EulerOS-SA-2023-2452)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2452
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d508bffe");
...
var pkgs = [
  "libtiff-4.1.0-1.h22.eulerosv2r10"
];
