...
# extracted from Red Hat Security Advisory RHSA-2007:1176. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 5 : autofs (RHSA-2007:1176)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for autofs.");
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2007/rhsa-2007_1176.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c43c743b");
  script_set_attribute(attribute:"see_also", value:"http://www.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=426218");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2007:1176");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL autofs package based on the guidance in RHSA-2007:1176.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:H/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2007-6285");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'autofs-5.0.1-0.rc2.55.el5.2', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'autofs-5.0.1-0.rc2.55.el5.2', 'cpu':'ppc', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'autofs-5.0.1-0.rc2.55.el5.2', 'cpu':'s390x', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'autofs-5.0.1-0.rc2.55.el5.2', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
