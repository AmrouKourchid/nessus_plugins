...
# extracted from Debian Security Advisory dla-4099. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-4099 : flatpak - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has packages installed that are affected by a vulnerability as referenced in the dla-4099
advisory.
...
var pkgs = [
    {'release': '11.0', 'prefix': 'flatpak', 'reference': '1.10.8-0+deb11u3'},
    {'release': '11.0', 'prefix': 'flatpak-tests', 'reference': '1.10.8-0+deb11u3'},
    {'release': '11.0', 'prefix': 'gir1.2-flatpak-1.0', 'reference': '1.10.8-0+deb11u3'},
    {'release': '11.0', 'prefix': 'libflatpak-dev', 'reference': '1.10.8-0+deb11u3'},
    {'release': '11.0', 'prefix': 'libflatpak-doc', 'reference': '1.10.8-0+deb11u3'},
    {'release': '11.0', 'prefix': 'libflatpak0', 'reference': '1.10.8-0+deb11u3'}
];
