...
# extracted from Fedora Security Advisory FEDORA-2019-8107ac4399.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-8107ac4399");

  script_name(english:"Fedora 29 : libnbd (2019-8107ac4399)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"New upstream version 1.0.2. Contains fix for NBD Protocol Downgrade
Attack (CVE-2019-14842).
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-8107ac4399");
...
"Update the affected libnbd package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-14842");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"libnbd-1.0.2-1.fc29")) flag++;
