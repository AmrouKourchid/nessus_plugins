...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 / 6 : curl (ELSA-2011-0918)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2011-0918.html");
