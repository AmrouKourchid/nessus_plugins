...
# extracted from Ubuntu Security Notice USN-5781-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5781-1");

  script_name(english:"Ubuntu 16.04 ESM : Emacs vulnerability (USN-5781-1)");
...
USN-5781-1 advisory.
    ...
    It was discovered that Emacs did not properly manage certain inputs. An attacker could possibly use this
    issue to execute arbitrary commands.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5781-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'emacs24', 'pkgver': '24.5+1-6ubuntu1.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'emacs24-bin-common', 'pkgver': '24.5+1-6ubuntu1.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'emacs24-common', 'pkgver': '24.5+1-6ubuntu1.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'emacs24-el', 'pkgver': '24.5+1-6ubuntu1.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'emacs24-lucid', 'pkgver': '24.5+1-6ubuntu1.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'emacs24-nox', 'pkgver': '24.5+1-6ubuntu1.1+esm1', 'ubuntu_pro': TRUE}
];
