...
# extracted from Fedora Security Advisory FEDORA-2023-5f29c4709a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-5f29c4709a");
  script_xref(name:"IAVB", value:"2023-B-0066-S");

  script_name(english:"Fedora 38 : vim (2023-5f29c4709a)");
...
FEDORA-2023-5f29c4709a advisory.
    ...
    Security fixes for CVE-2023-4733, CVE-2023-4752, CVE-2023-4750

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-5f29c4709a");
...
var pkgs = [
    {'reference':'vim-9.0.1872-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
