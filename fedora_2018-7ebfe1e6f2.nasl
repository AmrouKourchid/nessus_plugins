...
# extracted from Fedora Security Advisory FEDORA-2018-7ebfe1e6f2.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : php (2018-7ebfe1e6f2)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-7ebfe1e6f2");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"php-7.2.13-2.fc29")) flag++;
