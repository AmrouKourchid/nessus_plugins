...
# extracted from Red Hat Security Advisory RHSA-2025:1189. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:1189");

  script_name(english:"RHEL 9 : podman (RHSA-2025:1189)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_1189.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1c2cedd0");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:1189");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL podman package based on the guidance in RHSA-2025:1189.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'podman-4.9.4-17.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
      {'reference':'podman-docker-4.9.4-17.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
      {'reference':'podman-plugins-4.9.4-17.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
      {'reference':'podman-remote-4.9.4-17.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
      {'reference':'podman-tests-4.9.4-17.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'}
    ]
  }
];
