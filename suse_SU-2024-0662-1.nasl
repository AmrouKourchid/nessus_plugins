...
# SUSE update advisory SUSE-SU-2024:0662-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2023-39198", "CVE-2023-51780");
  script_xref(name:"SuSE", value:"SUSE-SU-2024:0662-1");

  script_name(english:"SUSE SLES12 / SLES15 Security Update : kernel (Live Patch 41 for SLE 15 SP2) (SUSE-SU-2024:0662-1)");
...
referenced in the SUSE-SU-2024:0662-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2024-February/018065.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?78d1cb26");
...
"Update the affected kernel-livepatch-5_3_18-150200_24_166-default and / or kgraft-patch-4_12_14-122_179-default
packages.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-122.179-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_12_14-122_179-default-4-2.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.5']}
        ]
      },
      '5.3.18-150200.24.166-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_3_18-150200_24_166-default-5-150200.2.1', 'sp':'2', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.2']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kernel-livepatch-5_3_18-150200_24_166-default / etc');
}
