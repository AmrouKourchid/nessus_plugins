...
# Rocky Linux Security Advisory RLSA-2024:1438.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2024:1438");

  script_name(english:"Rocky Linux 9 : nodejs (RLSA-2024:1438)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2024:1438");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2264574");
  script_set_attribute(attribute:"solution", value:
"Update the affected nodejs-docs package.");
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'nodejs-docs');
}
