...
if (description)
{
  ...
  script_name(english:"CentOS 9 : avahi-0.8-15.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update for avahi.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 9 host has packages installed that are affected by a vulnerability as referenced in the
avahi-0.8-15.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=36628");
...
var pkgs = [
    ...
    {'reference':'avahi-autoipd-0.8-15.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'avahi-dnsconfd-0.8-15.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'avahi-gobject-0.8-15.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'avahi-gobject-devel-0.8-15.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'avahi-ui-0.8-15.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'avahi-ui-devel-0.8-15.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'avahi-ui-gtk3-0.8-15.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'avahi-ui-tools-0.8-15.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
