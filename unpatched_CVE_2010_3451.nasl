...
if (description)
{
  ...
  script_cve_id("CVE-2010-3451");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2010-3451");
...
patch available.
  ...
  - Use-after-free vulnerability in oowriter in OpenOffice.org (OOo) 2.x and 3.x before 3.3 allows remote
    ...
    malformed tables in an RTF document. (CVE-2010-3451)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2010-3451");
