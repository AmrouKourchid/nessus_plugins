...
# extracted from Fedora Security Advisory FEDORA-2018-dc060c6f2a.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : 1:gitolite3 (2018-dc060c6f2a)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-dc060c6f2a");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"gitolite3-3.6.9-1.fc28", epoch:"1")) flag++;
