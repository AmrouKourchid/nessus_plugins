...
# Oracle Linux Security Advisory ELSA-2008-0847 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : libtiff (ELSA-2008-0847)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2008-0847.html");
...
"Update the affected libtiff and / or libtiff-devel packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2008-2327");
...
var pkgs = [
    {'reference':'libtiff-3.8.2-7.el5_2.2', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libtiff-devel-3.8.2-7.el5_2.2', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libtiff-3.8.2-7.el5_2.2', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libtiff-devel-3.8.2-7.el5_2.2', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
