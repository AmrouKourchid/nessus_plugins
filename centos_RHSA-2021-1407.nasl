...
# extracted from Red Hat Security Advisory RHSA-2021:1407.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : etcd (RHSA-2021:1407)");
...
"Update the affected etcd package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:etcd");
...
var pkgs = [
    {'reference':'etcd-3.2.32-1.el7_9', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'etcd-3.2.32-1.el7_9', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE}
];
