...
# extracted from Fedora Security Advisory FEDORA-2024-6ecf5236ae
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-6ecf5236ae");

  script_name(english:"Fedora 41 : p7zip (2024-6ecf5236ae)");
...
FEDORA-2024-6ecf5236ae advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-6ecf5236ae");
...
var pkgs = [
    {'reference':'p7zip-16.02-31.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
