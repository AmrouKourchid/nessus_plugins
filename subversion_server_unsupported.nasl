...
if (description)
{
  ...
  script_name(english:"Apache Subversion Server Unsupported Version Detection (deprecated)");
  ...
  script_set_attribute(attribute:"description", value: "This plugin has been deprecated. For plugins which identify 
  unsupported instances of this product, search the plugin feed for Subversion Server SEoL.");
...
exit(0, 'This plugin has been deprecated. For plugins which identify unsupported instances of this product, search the plugin feed for Subversion Server SEoL.');