...
# extracted from Fedora Security Advisory FEDORA-2023-4d443bd03f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-4d443bd03f");

  script_name(english:"Fedora 37 : tigervnc (2023-4d443bd03f)");
...
FEDORA-2023-4d443bd03f advisory.

    Tigervnc 1.13.0 update.

    CVE-2023-0494 tigervnc: xorg-x11-server: DeepCopyPointerClasses use-after-free leads to privilege
    elevation
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-4d443bd03f");
...
var pkgs = [
    {'reference':'tigervnc-1.13.0-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
