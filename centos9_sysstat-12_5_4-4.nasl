...
if (description)
{
  ...
  script_name(english:"CentOS 9 : sysstat-12.5.4-4.el9");
...
sysstat-12.5.4-4.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=26500");
...
var pkgs = [
    {'reference':'sysstat-12.5.4-4.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
