...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.1 : curl (EulerOS-SA-2024-2164)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2164
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?817ba4c8");
...
var pkgs = [
  "curl-7.79.1-2.h29.eulerosv2r11",
  "libcurl-7.79.1-2.h29.eulerosv2r11"
];
