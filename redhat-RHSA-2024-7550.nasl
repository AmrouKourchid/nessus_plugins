...
# extracted from Red Hat Security Advisory RHSA-2024:7550. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:7550");

  script_name(english:"RHEL 9 : golang (RHSA-2024:7550)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_7550.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?13cb81c8");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:7550");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL golang package based on the guidance in RHSA-2024:7550.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'go-toolset-1.21.13-4.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-1.21.13-4.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-bin-1.21.13-4.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-docs-1.21.13-4.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-misc-1.21.13-4.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-src-1.21.13-4.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-tests-1.21.13-4.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'go-toolset-1.21.13-4.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-1.21.13-4.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-bin-1.21.13-4.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-docs-1.21.13-4.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-misc-1.21.13-4.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-src-1.21.13-4.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-tests-1.21.13-4.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
