...
# extracted from Red Hat Security Advisory emacs. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2017-1000383", "CVE-2022-45939");

  script_name(english:"RHEL 7 : emacs (Unpatched Vulnerability) (deprecated)");
...
"This plugin has been deprecated as it does not adhere to established standards for this style of check.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2022-45939");
