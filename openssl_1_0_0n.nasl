...
"The version of OpenSSL installed on the remote host is prior to 1.0.0n. It is, therefore, affected by multiple
vulnerabilities as referenced in the 1.0.0n advisory.
...
var constraints = [
  { 'min_version' : '1.0.0', 'fixed_version' : '1.0.0n' },
  { 'min_version' : '1.0.0a', 'fixed_version' : '1.0.0n' }
];
