...
if (description)
{
  ...
  script_cve_id("CVE-2022-49611");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-49611");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: x86/speculation: Fill RSB on vmexit
    for IBRS Prevent RSB underflow/poisoning attacks with RSB. While at it, add a bunch of comments to attempt
    to document the current state of tribal knowledge about RSB attacks and what exactly is being mitigated.
    (CVE-2022-49611)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-49611");
