...
# extracted from Ubuntu Security Notice USN-5089-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5089-2");

  script_name(english:"Ubuntu 16.04 ESM : ca-certificates update (USN-5089-2)");
...
USN-5089-2 advisory.
    ...
    USN-5089-1 updated ca-certificates. This update provides the corresponding update for Ubuntu 14.04 ESM and
    Ubuntu 16.04 ESM.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5089-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'ca-certificates', 'pkgver': '20210119~16.04.1ubuntu0.1~esm1', 'ubuntu_pro': TRUE}
];
