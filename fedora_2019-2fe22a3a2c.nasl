...
# extracted from Fedora Security Advisory FEDORA-2019-2fe22a3a2c.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-2fe22a3a2c");

  script_name(english:"Fedora 29 : 1:libreoffice (2019-2fe22a3a2c)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-2fe22a3a2c");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"libreoffice-6.1.6.3-3.fc29", epoch:"1")) flag++;
