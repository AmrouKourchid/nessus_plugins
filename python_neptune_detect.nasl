...
if (description)
{
  ...
  script_name(english:"Neptune AI SDK Detection");

  script_set_attribute(attribute:"synopsis", value:
"A Neptune AI Python library is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"A Neptune AI Python library is installed on the remote host. 

Note that Nessus has relied upon on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://docs.neptune.ai/setup/");
  ...
  script_set_attribute(attribute:"cpe", value:"x-cpe:/a:python:neptune-ai-sdk");
...
var app_name = 'Neptune.AI SDK';
var pkg_name = 'Neptune';

var found_lib, libs = [];

found_lib = python::query_python_package(os:os, pkg_name:tolower(pkg_name));

if (!empty_or_null(found_lib))
  foreach (var found in found_lib)
  {
    found.pkg_name = pkg_name;
...
var lib_info = {
  ...
  'path' : lib.path + '/site-packages/' + tolower(lib.pkg_name)
};
  ...
  register_install(
    ...
    cpe             : 'x-cpe:/a:python:neptune-ai-sdk'
  );
