...
# extracted from Fedora Security Advisory FEDORA-2024-b32b4e1b88
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-b32b4e1b88");

  script_name(english:"Fedora 41 : thunderbird (2024-b32b4e1b88)");
...
FEDORA-2024-b32b4e1b88 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-b32b4e1b88");
...
var pkgs = [
    {'reference':'thunderbird-128.5.2-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
