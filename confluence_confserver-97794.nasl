...
if (description)
{
  ...
  script_name(english:"Atlassian Confluence 6.0 < 7.19.23 / 7.20.x < 8.5.9 / 8.6.x < 8.9.1 (CONFSERVER-97794)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://jira.atlassian.com/browse/CONFSERVER-97794");
...
var constraints = [
  { 'min_version' : '6.0.0','fixed_version' : '7.19.23' },
  { 'min_version' : '7.20.0', 'fixed_version' : '8.5.9' },
  { 'min_version' : '8.6.0', 'fixed_version' : '8.9.1' }
];
