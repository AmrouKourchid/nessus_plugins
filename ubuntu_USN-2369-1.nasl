...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : file vulnerability (USN-2369-1)");
...
USN-2369-1 advisory.
    ...
    It was discovered that file incorrectly handled certain CDF documents. A attacker could use this issue to
    cause file to hang or crash, resulting in a denial of service.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2369-1");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-3587");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'file', 'pkgver': '1:5.14-2ubuntu3.2'},
    {'osver': '14.04', 'pkgname': 'libmagic-dev', 'pkgver': '1:5.14-2ubuntu3.2'},
    {'osver': '14.04', 'pkgname': 'libmagic1', 'pkgver': '1:5.14-2ubuntu3.2'},
    {'osver': '14.04', 'pkgname': 'python-magic', 'pkgver': '1:5.14-2ubuntu3.2'},
    {'osver': '14.04', 'pkgname': 'python3-magic', 'pkgver': '1:5.14-2ubuntu3.2'}
];
