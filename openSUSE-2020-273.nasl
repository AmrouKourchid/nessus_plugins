...
# extracted from openSUSE Security Update openSUSE-2020-273.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : proftpd (openSUSE-2020-273)");
...
Security issues fixed :
  ...
  - CVE-2020-9272: Fixed an out-of-bounds read in mod_cap
    (bsc#1164572).

  - CVE-2020-9273: Fixed a potential memory corruption
    caused by an interruption of the data transfer channel
    (bsc#1164574).");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1164572");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1164574");
...
if ( rpm_check(release:"SUSE15.1", reference:"proftpd-1.3.6c-lp151.3.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"proftpd-debuginfo-1.3.6c-lp151.3.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"proftpd-debugsource-1.3.6c-lp151.3.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"proftpd-devel-1.3.6c-lp151.3.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"proftpd-lang-1.3.6c-lp151.3.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"proftpd-ldap-1.3.6c-lp151.3.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"proftpd-ldap-debuginfo-1.3.6c-lp151.3.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"proftpd-mysql-1.3.6c-lp151.3.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"proftpd-mysql-debuginfo-1.3.6c-lp151.3.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"proftpd-pgsql-1.3.6c-lp151.3.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"proftpd-pgsql-debuginfo-1.3.6c-lp151.3.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"proftpd-radius-1.3.6c-lp151.3.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"proftpd-radius-debuginfo-1.3.6c-lp151.3.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"proftpd-sqlite-1.3.6c-lp151.3.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"proftpd-sqlite-debuginfo-1.3.6c-lp151.3.9.1") ) flag++;
