...
# extracted from Fedora Security Advisory FEDORA-2024-78e43b4de6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-78e43b4de6");

  script_name(english:"Fedora 39 : perl-App-cpanminus (2024-78e43b4de6)");
...
FEDORA-2024-78e43b4de6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-78e43b4de6");
...
var pkgs = [
    {'reference':'perl-App-cpanminus-1.7047-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
