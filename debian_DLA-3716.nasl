...
# extracted from Debian Security Advisory dla-3716. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3716 : ruby-httparty - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has a package installed that is affected by a vulnerability as referenced in the dla-3716
advisory.
...
number.");
  # https://security-tracker.debian.org/tracker/source-package/ruby-httparty
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f1907813");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-22049");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/ruby-httparty");
  script_set_attribute(attribute:"solution", value:
"Upgrade the ruby-httparty packages.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:P/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:L/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-22049");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:ruby-httparty");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'ruby-httparty', 'reference': '0.16.2+dfsg1-3+deb10u1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'ruby-httparty');
}
