...
# extracted from Fedora Security Advisory FEDORA-2022-6720bd776b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-6720bd776b");

  script_name(english:"Fedora 37 : python-slixmpp (2022-6720bd776b)");
...
FEDORA-2022-6720bd776b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-6720bd776b");
...
var pkgs = [
    {'reference':'python-slixmpp-1.8.3-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
