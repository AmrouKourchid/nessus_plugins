...
# extracted from Debian Security Advisory DSA-4344. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"4344");

  script_name(english:"Debian DSA-4344-1 : roundcube - security update");
...
vulnerability in handling invalid style tag content.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2018/dsa-4344");
...
version 1.2.3+dfsg.1-4+deb9u3.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-19206");
...
flag = 0;
if (deb_check(release:"9.0", prefix:"roundcube", reference:"1.2.3+dfsg.1-4+deb9u3")) flag++;
if (deb_check(release:"9.0", prefix:"roundcube-core", reference:"1.2.3+dfsg.1-4+deb9u3")) flag++;
if (deb_check(release:"9.0", prefix:"roundcube-mysql", reference:"1.2.3+dfsg.1-4+deb9u3")) flag++;
if (deb_check(release:"9.0", prefix:"roundcube-pgsql", reference:"1.2.3+dfsg.1-4+deb9u3")) flag++;
if (deb_check(release:"9.0", prefix:"roundcube-plugins", reference:"1.2.3+dfsg.1-4+deb9u3")) flag++;
if (deb_check(release:"9.0", prefix:"roundcube-sqlite3", reference:"1.2.3+dfsg.1-4+deb9u3")) flag++;
