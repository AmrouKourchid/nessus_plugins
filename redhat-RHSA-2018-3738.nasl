...
# extracted from Red Hat Security Advisory RHSA-2018:3738. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : ruby (RHSA-2018:3738)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for ruby.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2018:3738 advisory.

  - ruby: OpenSSL::X509::Name equality check does not work correctly (CVE-2018-16395)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_3738.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c323e7f3");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:3738");
...
"Update the RHEL ruby package based on the guidance in RHSA-2018:3738.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ruby-2.0.0.648-34.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ruby-devel-2.0.0.648-34.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ruby-doc-2.0.0.648-34.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ruby-irb-2.0.0.648-34.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ruby-libs-2.0.0.648-34.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ruby-tcltk-2.0.0.648-34.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rubygem-bigdecimal-1.2.0-34.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rubygem-io-console-0.4.2-34.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rubygem-json-1.7.7-34.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rubygem-minitest-4.3.2-34.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rubygem-psych-2.0.0-34.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rubygem-rake-0.9.6-34.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rubygem-rdoc-4.0.0-34.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rubygems-2.0.14.1-34.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rubygems-devel-2.0.14.1-34.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
