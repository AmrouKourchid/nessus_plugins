...
# extracted from Ubuntu Security Notice USN-6727-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6727-2");

  script_name(english:"Ubuntu 20.04 LTS / 22.04 LTS : NSS regression (USN-6727-2)");
...
in the USN-6727-2 advisory.

    USN-6727-1 fixed vulnerabilities in NSS. The update introduced a regression when trying to load security
    modules on Ubuntu 20.04 LTS and Ubuntu 22.04 LTS. This update fixes the problem.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6727-2");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'libnss3', 'pkgver': '2:3.98-0ubuntu0.20.04.2'},
    {'osver': '20.04', 'pkgname': 'libnss3-dev', 'pkgver': '2:3.98-0ubuntu0.20.04.2'},
    {'osver': '20.04', 'pkgname': 'libnss3-tools', 'pkgver': '2:3.98-0ubuntu0.20.04.2'},
    {'osver': '22.04', 'pkgname': 'libnss3', 'pkgver': '2:3.98-0ubuntu0.22.04.2'},
    {'osver': '22.04', 'pkgname': 'libnss3-dev', 'pkgver': '2:3.98-0ubuntu0.22.04.2'},
    {'osver': '22.04', 'pkgname': 'libnss3-tools', 'pkgver': '2:3.98-0ubuntu0.22.04.2'}
];
