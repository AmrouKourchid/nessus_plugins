...
# extracted from Fedora Security Advisory FEDORA-2022-a36a18c9a8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-a36a18c9a8");

  script_name(english:"Fedora 37 : pypy3.7 (2022-a36a18c9a8)");
...
FEDORA-2022-a36a18c9a8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-a36a18c9a8");
...
var pkgs = [
    {'reference':'pypy3.7-7.3.9-2.3.7.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
