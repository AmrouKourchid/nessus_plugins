...
if (description)
{
  ...
  script_cve_id("CVE-2011-3045", "CVE-2011-3048", "CVE-2015-7981");

  script_name(english:"RHEL 4 : libpng (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2015-7981");
