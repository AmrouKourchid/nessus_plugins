...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : libtiff (EulerOS-SA-2019-2056)");
...
vulnerabilities :
  ...
  - LibTIFF before 4.0.6 mishandles the reading of TIFF
    files, as demonstrated by a heap-based buffer over-read
    in the ReadTIFFImage function in coders/tiff.c in
    GraphicsMagick 1.3.27.(CVE-2018-5360)
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2056
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?437363ac");
...
"Update the affected libtiff packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-5360");
...
pkgs = ["libtiff-4.0.3-27.h11",
        "libtiff-devel-4.0.3-27.h11"];
