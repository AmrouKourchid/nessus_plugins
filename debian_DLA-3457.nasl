...
# extracted from Debian Security Advisory dla-3457. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3457 : duende - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/maradns");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'duende', 'reference': '2.0.13-1.2+deb10u1'},
    {'release': '10.0', 'prefix': 'maradns', 'reference': '2.0.13-1.2+deb10u1'},
    {'release': '10.0', 'prefix': 'maradns-deadwood', 'reference': '2.0.13-1.2+deb10u1'},
    {'release': '10.0', 'prefix': 'maradns-docs', 'reference': '2.0.13-1.2+deb10u1'},
    {'release': '10.0', 'prefix': 'maradns-zoneserver', 'reference': '2.0.13-1.2+deb10u1'}
];
