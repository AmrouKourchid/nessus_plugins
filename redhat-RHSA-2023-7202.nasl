...
# extracted from Red Hat Security Advisory RHSA-2023:7202. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:7202");

  script_name(english:"RHEL 8 : container-tools:4.0 (RHSA-2023:7202)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for container-tools:4.0.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2023:7202 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b407e45b");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-13035");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:7202");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL container-tools:4.0 package based on the guidance in RHSA-2023:7202.");
  ...
  'container-tools:4.0': [
    {
      ...
      'pkgs': [
        {'reference':'aardvark-dns-1.0.1-38.module+el8.9.0+20325+b2853e6e', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'buildah-1.24.6-7.module+el8.9.0+20325+b2853e6e', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'buildah-tests-1.24.6-7.module+el8.9.0+20325+b2853e6e', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'cockpit-podman-46-1.module+el8.9.0+20325+b2853e6e', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
        {'reference':'conmon-2.1.4-2.module+el8.9.0+20325+b2853e6e', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'container-selinux-2.205.0-3.module+el8.9.0+20325+b2853e6e', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'containernetworking-plugins-1.1.1-5.module+el8.9.0+20325+b2853e6e', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'containers-common-1-38.module+el8.9.0+20325+b2853e6e', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'allowmaj':TRUE},
        {'reference':'crit-3.15-3.module+el8.9.0+20325+b2853e6e', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'criu-3.15-3.module+el8.9.0+20325+b2853e6e', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'criu-devel-3.15-3.module+el8.9.0+20325+b2853e6e', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'criu-libs-3.15-3.module+el8.9.0+20325+b2853e6e', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'crun-1.8.7-1.module+el8.9.0+20325+b2853e6e', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'fuse-overlayfs-1.9-2.module+el8.9.0+20325+b2853e6e', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'libslirp-4.4.0-1.module+el8.9.0+20325+b2853e6e', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'libslirp-devel-4.4.0-1.module+el8.9.0+20325+b2853e6e', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'netavark-1.0.1-38.module+el8.9.0+20325+b2853e6e', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'oci-seccomp-bpf-hook-1.2.5-2.module+el8.9.0+20325+b2853e6e', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'podman-4.0.2-24.module+el8.9.0+20325+b2853e6e', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'podman-catatonit-4.0.2-24.module+el8.9.0+20325+b2853e6e', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'podman-docker-4.0.2-24.module+el8.9.0+20325+b2853e6e', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'podman-gvproxy-4.0.2-24.module+el8.9.0+20325+b2853e6e', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'podman-plugins-4.0.2-24.module+el8.9.0+20325+b2853e6e', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'podman-remote-4.0.2-24.module+el8.9.0+20325+b2853e6e', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'podman-tests-4.0.2-24.module+el8.9.0+20325+b2853e6e', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'python3-criu-3.15-3.module+el8.9.0+20325+b2853e6e', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-podman-4.0.0-2.module+el8.9.0+20325+b2853e6e', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'runc-1.1.5-2.module+el8.9.0+20325+b2853e6e', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'skopeo-1.6.2-9.module+el8.9.0+20325+b2853e6e', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'skopeo-tests-1.6.2-9.module+el8.9.0+20325+b2853e6e', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'slirp4netns-1.1.8-3.module+el8.9.0+20325+b2853e6e', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'toolbox-0.0.99.4-5.module+el8.9.0+20325+b2853e6e', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'toolbox-tests-0.0.99.4-5.module+el8.9.0+20325+b2853e6e', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'udica-0.2.6-4.module+el8.9.0+20325+b2853e6e', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
