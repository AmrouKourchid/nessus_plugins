...
# extracted from Fedora Security Advisory FEDORA-2023-e4e985b5dd
#
...
if (description)
{
  ...
  script_cve_id("CVE-2023-31248", "CVE-2023-35001");
  script_xref(name:"FEDORA", value:"2023-e4e985b5dd");

  script_name(english:"Fedora 38 : kernel / kernel-headers / kernel-tools (2023-e4e985b5dd)");
...
FEDORA-2023-e4e985b5dd advisory.

    The 6.4.4 stable kernel rebase contains additional hardware support, new features, and a number of
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-e4e985b5dd");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  var cve_list = make_list('CVE-2023-31248', 'CVE-2023-35001');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for FEDORA-2023-e4e985b5dd');
  }
  else
  {
...
var pkgs = [
    {'reference':'kernel-6.4.4-200.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kernel-headers-6.4.4-200.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kernel-tools-6.4.4-200.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
