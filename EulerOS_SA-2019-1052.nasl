...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : libxslt (EulerOS-SA-2019-1052)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1052
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a3e6261a");
...
"Update the affected libxslt package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-9019");
...
pkgs = ["libxslt-1.1.28-5.h1",
        "libxslt-devel-1.1.28-5.h1",
        "libxslt-python-1.1.28-5.h1"];
