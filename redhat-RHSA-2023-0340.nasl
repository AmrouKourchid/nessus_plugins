...
# extracted from Red Hat Security Advisory RHSA-2023:0340. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:0340");

  script_name(english:"RHEL 9 : bash (RHSA-2023:0340)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_0340.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a2729f8e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2022-3715");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2126720");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:0340");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL bash package based on the guidance in RHSA-2023:0340.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:bash-devel");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'bash-5.1.8-6.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bash-devel-5.1.8-6.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'bash / bash-devel');
}
