...
if (description)
{
  ...
  script_name(english:"OpenSSL 1.1.1 < 1.1.1zb Vulnerability");
...
as referenced in the 1.1.1zb advisory.
...
number.");
  # https://openssl-corporation.org/support/?giturl=https://github.openssl.org/openssl/extended-releases/commit/8efc0cbaa8ebba8e116f7b81a876a4123594d86a%22
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e0db7b41");
...
"Upgrade to OpenSSL version 1.1.1zb or later.");
...
var constraints = [
  { 'min_version' : '1.1.1', 'fixed_version' : '1.1.1zb' }
];
