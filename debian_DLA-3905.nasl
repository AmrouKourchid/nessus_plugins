...
# extracted from Debian Security Advisory dla-3905. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3905 : cups-browsed - security update");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'cups-browsed', 'reference': '1.28.7-1+deb11u3'},
    {'release': '11.0', 'prefix': 'cups-filters', 'reference': '1.28.7-1+deb11u3'},
    {'release': '11.0', 'prefix': 'cups-filters-core-drivers', 'reference': '1.28.7-1+deb11u3'},
    {'release': '11.0', 'prefix': 'libcupsfilters-dev', 'reference': '1.28.7-1+deb11u3'},
    {'release': '11.0', 'prefix': 'libcupsfilters1', 'reference': '1.28.7-1+deb11u3'},
    {'release': '11.0', 'prefix': 'libfontembed-dev', 'reference': '1.28.7-1+deb11u3'},
    {'release': '11.0', 'prefix': 'libfontembed1', 'reference': '1.28.7-1+deb11u3'}
];
