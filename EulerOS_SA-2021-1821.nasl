...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : ntp (EulerOS-SA-2021-1821)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1821
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8f0abdac");
...
"Update the affected ntp package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-7427");
...
pkgs = ["ntp-4.2.6p5-25.0.1.h25",
        "ntpdate-4.2.6p5-25.0.1.h25",
        "sntp-4.2.6p5-25.0.1.h25"];
