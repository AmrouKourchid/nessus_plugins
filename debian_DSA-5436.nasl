...
# extracted from Debian Security Advisory dsa-5436. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-5436-1 : hsqldb1.8.0 - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 / 12 host has packages installed that are affected by a vulnerability as referenced in the dsa-5436
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2023/dsa-5436");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-1183");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bullseye/hsqldb1.8.0");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bookworm/hsqldb1.8.0");
  script_set_attribute(attribute:"solution", value:
"Upgrade the hsqldb1.8.0 packages.
...
For the stable distribution (bookworm), this problem has been fixed in version 1.8.0.10+dfsg-11+deb12u1.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:hsqldb1.8.0");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'libhsqldb1.8.0-java', 'reference': '1.8.0.10+dfsg-10+deb11u1'},
    {'release': '12.0', 'prefix': 'libhsqldb1.8.0-java', 'reference': '1.8.0.10+dfsg-11+deb12u1'}
];
