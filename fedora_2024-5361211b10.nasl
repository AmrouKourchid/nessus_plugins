...
# extracted from Fedora Security Advisory FEDORA-2024-5361211b10
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-5361211b10");
  script_xref(name:"IAVA", value:"2024-A-0108-S");

  script_name(english:"Fedora 38 : thunderbird (2024-5361211b10)");
...
FEDORA-2024-5361211b10 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-5361211b10");
...
var pkgs = [
    {'reference':'thunderbird-115.8.0-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
