...
# extracted from Red Hat Security Advisory RHSA-2021:3757. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_3757.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2a18222f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:3757");
...
"Update the RHEL firefox package based on the guidance in RHSA-2021:3757.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-91.2.0-4.el8_1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
