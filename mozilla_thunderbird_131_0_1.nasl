...
"The version of Thunderbird installed on the remote Windows host is prior to 131.0.1. It is, therefore, affected by a
...
mozilla_check_version(installs:installs, product:'thunderbird', esr:FALSE, fix:'131.0.1', min:'131.0.0', severity:SECURITY_HOLE);
