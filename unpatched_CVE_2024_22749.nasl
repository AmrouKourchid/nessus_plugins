...
if (description)
{
  ...
  script_cve_id("CVE-2024-22749");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-22749");
...
patch available.
  ...
  - GPAC v2.3 was detected to contain a buffer overflow via the function
    gf_isom_new_generic_sample_description function in the isomedia/isom_write.c:4577 (CVE-2024-22749)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-22749");
