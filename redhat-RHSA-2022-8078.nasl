...
# extracted from Red Hat Security Advisory RHSA-2022:8078. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:8078");

  script_name(english:"RHEL 9 : flac (RHSA-2022:8078)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8078.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?49202364");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8078");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2057776");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL flac package based on the guidance in RHSA-2022:8078.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'flac-1.3.3-10.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'flac-devel-1.3.3-10.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'flac-libs-1.3.3-10.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
