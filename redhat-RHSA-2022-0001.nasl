...
# extracted from Red Hat Security Advisory RHSA-2022:0001. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:0001");

  script_name(english:"RHEL 8 : grafana (RHSA-2022:0001)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_0001.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?51efd3cb");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:0001");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2030801");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL grafana package based on the guidance in RHSA-2022:0001.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'grafana-7.5.9-5.el8_5', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
