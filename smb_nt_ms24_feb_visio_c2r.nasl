...
if (description)
{
  ...
  script_cve_id("CVE-2024-21384");
  script_xref(name:"IAVA", value:"2024-A-0094-S");

  script_name(english:"Security Updates for Microsoft Visio Products C2R (February 2024)");

  script_set_attribute(attribute:"synopsis", value:
"The Microsoft Visio Products are affected by a remote code execution vulnerability.");
  script_set_attribute(attribute:"description", value:
"The Microsoft Visio Products are missing security updates. It is, therefore, affected by the following:
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://msrc.microsoft.com/update-guide/vulnerability/CVE-2024-21384");
...
manually perform an update.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-21384");
