...
# extracted from Fedora Security Advisory FEDORA-2024-f9e8f7d3a7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-f9e8f7d3a7");
  script_xref(name:"IAVA", value:"2024-A-0386-S");

  script_name(english:"Fedora 40 : firefox (2024-f9e8f7d3a7)");
...
FEDORA-2024-f9e8f7d3a7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-f9e8f7d3a7");
...
var pkgs = [
    {'reference':'firefox-128.0-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
