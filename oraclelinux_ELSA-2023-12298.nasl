...
# extracted from Oracle Linux Security Advisory ELSA-2023-12298.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : cloud-init (ELSA-2023-12298)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-12298.html");
...
var pkgs = [
    {'reference':'cloud-init-22.1-6.0.4.el8_7.2', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
