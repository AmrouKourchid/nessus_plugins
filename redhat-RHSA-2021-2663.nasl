...
# extracted from Red Hat Security Advisory RHSA-2021:2663. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:2663");
  script_xref(name:"IAVB", value:"2022-B-0007");

  script_name(english:"RHEL 7 / 8 : Ansible security update (2.9.23) (Important) (RHSA-2021:2663)");
...
in the RHSA-2021:2663 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_2663.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?645c2d3e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:2663");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1968412");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Ansible package based on the guidance in RHSA-2021:2663.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ansible-2.9.23-1.el8ae', 'release':'8', 'el_string':'el8ae', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2.9'},
      {'reference':'ansible-test-2.9.23-1.el8ae', 'release':'8', 'el_string':'el8ae', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2.9'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'ansible-2.9.23-1.el7ae', 'release':'7', 'el_string':'el7ae', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2.9'},
      {'reference':'ansible-test-2.9.23-1.el7ae', 'release':'7', 'el_string':'el7ae', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2.9'}
    ]
  }
];
