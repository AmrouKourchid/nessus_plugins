...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'git-2.17.1-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'git-debuginfo-2.17.1-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'git-lang-2.17.1-1.ph2')) flag++;
