...
# extracted from Fedora Security Advisory FEDORA-2024-bcdea6e995
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-bcdea6e995");
  script_xref(name:"IAVA", value:"2024-A-0836-S");

  script_name(english:"Fedora 40 : zabbix (2024-bcdea6e995)");
...
FEDORA-2024-bcdea6e995 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-bcdea6e995");
...
var pkgs = [
    {'reference':'zabbix-6.0.36-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
