...
# extracted from Fedora Security Advisory FEDORA-2023-e76c8fab34
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-e76c8fab34");

  script_name(english:"Fedora 36 : ImageMagick (2023-e76c8fab34)");
...
FEDORA-2023-e76c8fab34 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-e76c8fab34");
  script_set_attribute(attribute:"solution", value:
"Update the affected 1:ImageMagick package.");
  script_set_attribute(attribute:"risk_factor", value:"High");

  script_set_attribute(attribute:"exploitability_ease", value:"No known exploits are available");
  script_set_attribute(attribute:"exploit_available", value:"false");

  script_set_attribute(attribute:"vuln_publication_date", value:"2023/03/25");
...
var pkgs = [
    {'reference':'ImageMagick-6.9.12.82-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
