...
# extracted from VMware Security Advisory PHSA-2020-2.0-0276. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Go PHSA-2020-2.0-0276");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the go package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-2-276.md");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'go-1.13.5-3.ph2')) flag++;
