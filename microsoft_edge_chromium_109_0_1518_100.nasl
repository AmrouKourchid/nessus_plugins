...
if (description)
{
  ...
  script_name(english:"Microsoft Edge (Chromium) < 109.0.1518.100 (CVE-2023-2033)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host has an web browser installed that is affected by type confusion vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Microsoft Edge (Chromium) installed on the remote Windows host is prior to 109.0.1518.100. It is, therefore, 
affected by a type confusion vulnerability in V8 as referenced in the April 24, 2023 advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  # https://learn.microsoft.com/en-us/DeployEdge/microsoft-edge-relnotes-security#april-24-2023
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f30ff0e5");
...
"Upgrade to Microsoft Edge version 109.0.1518.100 or later. 
...
var constraints = [ { 'fixed_version' : '109.0.1518.100' } ];
