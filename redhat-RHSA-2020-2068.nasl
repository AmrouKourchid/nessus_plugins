...
# extracted from Red Hat Security Advisory RHSA-2020:2068. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:2068");

  script_name(english:"RHEL 7 : python-pip (RHSA-2020:2068)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_2068.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?66d2a321");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:2068");
...
"Update the RHEL python-pip package based on the guidance in RHSA-2020:2068.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-pip-9.0.3-7.el7_8', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
