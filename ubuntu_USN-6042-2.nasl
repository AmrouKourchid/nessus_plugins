...
# extracted from Ubuntu Security Notice USN-6042-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6042-2");

  script_name(english:"Ubuntu 20.04 LTS : Cloud-init regression (USN-6042-2)");
...
USN-6042-2 advisory.
    ...
    USN-6042-1 fixed a vulnerability in Cloud-init. The update introduced a regression on Ubuntu 20.04 LTS
    resulting in a possible loss of networking. This update fixes the problem.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6042-2");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'cloud-init', 'pkgver': '23.1.2-0ubuntu0~20.04.2'}
];
