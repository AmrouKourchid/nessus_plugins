...
var appstreams = {
    'container-tools:ol8': [
      ...
      {'reference':'cockpit-podman-53-1.module+el8.7.0+20877+e0f9ac15', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'conmon-2.1.4-1.module+el8.7.0+20877+e0f9ac15', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      {'reference':'container-selinux-2.189.0-1.module+el8.7.0+20877+e0f9ac15', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      ...
      {'reference':'podman-docker-4.2.0-4.module+el8.7.0+20877+e0f9ac15', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      ...
      {'reference':'python3-podman-4.2.1-1.module+el8.7.0+20877+e0f9ac15', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'udica-0.2.6-3.module+el8.7.0+20877+e0f9ac15', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'cockpit-podman-53-1.module+el8.7.0+20877+e0f9ac15', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'conmon-2.1.4-1.module+el8.7.0+20877+e0f9ac15', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      {'reference':'container-selinux-2.189.0-1.module+el8.7.0+20877+e0f9ac15', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      ...
      {'reference':'podman-docker-4.2.0-4.module+el8.7.0+20877+e0f9ac15', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      ...
      {'reference':'python3-podman-4.2.1-1.module+el8.7.0+20877+e0f9ac15', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'udica-0.2.6-3.module+el8.7.0+20877+e0f9ac15', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
};
