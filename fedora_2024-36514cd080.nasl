...
# extracted from Fedora Security Advisory FEDORA-2024-36514cd080
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-36514cd080");

  script_name(english:"Fedora 41 : krb5 (2024-36514cd080)");
...
FEDORA-2024-36514cd080 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-36514cd080");
...
var pkgs = [
    {'reference':'krb5-1.21.2-6.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
