...
# extracted from Fedora Security Advisory FEDORA-2024-aec80d6e8a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-aec80d6e8a");

  script_name(english:"Fedora 39 : glibc (2024-aec80d6e8a)");
...
FEDORA-2024-aec80d6e8a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-aec80d6e8a");
...
var pkgs = [
    {'reference':'glibc-2.38-16.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
