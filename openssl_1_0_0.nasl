...
DTLS handshake message.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cf69d6a5");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2009-1379");
...
var constraints = [{ 'min_version' : '1.0.0-beta0', 'fixed_version' : '1.0.0-beta2'}];
