...
if (description)
{
  ...
  script_name(english:"CentOS 6 : kernel (RHSA-2020:0790)");
...
var pkgs = [
    {'reference':'kernel-bootwrapper-2.6.32-754.28.1.el6', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kernel-kdump-2.6.32-754.28.1.el6', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kernel-kdump-devel-2.6.32-754.28.1.el6', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE}
];
