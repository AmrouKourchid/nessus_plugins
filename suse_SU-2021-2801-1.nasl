...
# SUSE update advisory SUSE-SU-2021:2801-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2021:2801-1");

  script_name(english:"SUSE SLES15 Security Update : 389-ds (SUSE-SU-2021:2801-1)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?937b9183");
...
var pkgs = [
    {'reference':'389-ds-1.4.4.16~git16.c1926dfc6-3.4.1', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-server-applications-release-15.3']},
    {'reference':'389-ds-devel-1.4.4.16~git16.c1926dfc6-3.4.1', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-server-applications-release-15.3']},
    {'reference':'lib389-1.4.4.16~git16.c1926dfc6-3.4.1', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-server-applications-release-15.3']},
    {'reference':'libsvrcore0-1.4.4.16~git16.c1926dfc6-3.4.1', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-server-applications-release-15.3']}
];
