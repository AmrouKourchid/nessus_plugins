...
# extracted from Red Hat Security Advisory RHSA-2021:2659. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:2659");

  script_name(english:"RHEL 8 : linuxptp (RHSA-2021:2659)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_2659.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?399cab9a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:2659");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1966240");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL linuxptp package based on the guidance in RHSA-2021:2659.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'linuxptp-2.0-4.el8_1.1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
