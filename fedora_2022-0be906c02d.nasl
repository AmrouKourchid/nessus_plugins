...
# extracted from Fedora Security Advisory FEDORA-2022-0be906c02d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-0be906c02d");

  script_name(english:"Fedora 36 : apptainer (2022-0be906c02d)");
...
FEDORA-2022-0be906c02d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-0be906c02d");
...
var pkgs = [
    {'reference':'apptainer-1.1.2-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
