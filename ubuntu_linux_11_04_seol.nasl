...
if (description)
{
  ...
  script_name(english:"Canonical Ubuntu Linux SEoL (11.04.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Canonical Ubuntu Linux is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Canonical Ubuntu Linux is 11.04.x. It is, therefore, no longer maintained by its vendor or
provider.

Lack of support implies that no new security patches for the product will be released by the vendor. As a result, it may
contain security vulnerabilities.");
  # https://lists.ubuntu.com/archives/ubuntu-announce/2012-October/000165.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?08fe0895");
...
"Upgrade to a version of Canonical Ubuntu Linux that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2012/10/28");
...
var constraints = [
  { max_branch : '11.04', min_branch : '11.04', seol : 20121028 }
];
