...
# extracted from Fedora Security Advisory FEDORA-2023-01ff262091
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-01ff262091");

  script_name(english:"Fedora 37 : apptainer (2023-01ff262091)");
...
FEDORA-2023-01ff262091 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-01ff262091");
...
var pkgs = [
    {'reference':'apptainer-1.1.6-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
