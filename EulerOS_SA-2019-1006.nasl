...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : libtasn1 (EulerOS-SA-2019-1006)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1006
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7ac3c808");
...
pkgs = ["libtasn1-4.10-1.h3.eulerosv2r7",
        "libtasn1-devel-4.10-1.h3.eulerosv2r7"];
