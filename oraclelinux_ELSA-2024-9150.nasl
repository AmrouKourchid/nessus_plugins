...
# extracted from Oracle Linux Security Advisory ELSA-2024-9150.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : python-jinja2 (ELSA-2024-9150)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-9150.html");
...
var pkgs = [
    {'reference':'python3-jinja2-2.11.3-6.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
