...
# extracted from Fedora Security Advisory FEDORA-2024-3f9eb3c86c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-3f9eb3c86c");

  script_name(english:"Fedora 40 : tor (2024-3f9eb3c86c)");
...
FEDORA-2024-3f9eb3c86c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-3f9eb3c86c");
...
var pkgs = [
    {'reference':'tor-0.4.8.12-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
