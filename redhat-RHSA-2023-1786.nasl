...
# extracted from Red Hat Security Advisory RHSA-2023:1786. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_1786.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3c679862");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:1786");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL firefox package based on the guidance in RHSA-2023:1786.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-102.10.0-1.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-x11-102.10.0-1.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
