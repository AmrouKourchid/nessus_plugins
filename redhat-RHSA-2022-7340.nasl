...
# extracted from Red Hat Security Advisory RHSA-2022:7340. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:7340");

  script_name(english:"RHEL 7 : php-pear (RHSA-2022:7340)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for php-pear.");
...
referenced in the RHSA-2022:7340 advisory.

    The php-pear package contains the PHP Extension and Application Repository (PEAR), a framework and
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_7340.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ccf8144a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:7340");
...
"Update the RHEL php-pear package based on the guidance in RHSA-2022:7340.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'php-pear-1.9.4-23.el7_9', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
