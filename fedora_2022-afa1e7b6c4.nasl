...
# extracted from Fedora Security Advisory FEDORA-2022-afa1e7b6c4
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-afa1e7b6c4");

  script_name(english:"Fedora 36 : libmodsecurity (2022-afa1e7b6c4)");
...
FEDORA-2022-afa1e7b6c4 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-afa1e7b6c4");
...
var pkgs = [
    {'reference':'libmodsecurity-3.0.8-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
