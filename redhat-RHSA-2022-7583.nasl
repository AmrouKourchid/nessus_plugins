...
# extracted from Red Hat Security Advisory RHSA-2022:7583. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:7583");

  script_name(english:"RHEL 8 : xorg-x11-server and xorg-x11-server-Xwayland (RHSA-2022:7583)");
...
referenced in the RHSA-2022:7583 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_7583.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b69f439f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:7583");
...
"Update the RHEL xorg-x11-server / xorg-x11-server-Xwayland packages based on the guidance in RHSA-2022:7583.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'xorg-x11-server-common-1.20.11-9.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xorg-x11-server-devel-1.20.11-9.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xorg-x11-server-source-1.20.11-9.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xorg-x11-server-Xdmx-1.20.11-9.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xorg-x11-server-Xephyr-1.20.11-9.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xorg-x11-server-Xnest-1.20.11-9.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xorg-x11-server-Xorg-1.20.11-9.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xorg-x11-server-Xvfb-1.20.11-9.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'xorg-x11-server-Xwayland-21.1.3-6.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
