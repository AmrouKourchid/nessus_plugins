...
# SUSE update advisory SUSE-SU-2021:4171-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2021:4171-1");

  script_name(english:"SUSE SLES15 Security Update : runc (SUSE-SU-2021:4171-1)");
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2021-December/009939.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?65e119f4");
...
var pkgs = [
    {'reference':'runc-1.0.3-27.1', 'sp':'2', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-containers-release-15.2']},
    {'reference':'runc-1.0.3-27.1', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-containers-release-15.3']}
];
