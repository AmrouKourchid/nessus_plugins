...
# extracted from Fedora Security Advisory FEDORA-2025-20f63c4273
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-20f63c4273");

  script_name(english:"Fedora 41 : xen (2025-20f63c4273)");
...
FEDORA-2025-20f63c4273 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-20f63c4273");
...
var pkgs = [
    {'reference':'xen-4.19.1-5.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
