...
# extracted from Fedora Security Advisory FEDORA-2024-3891a08c9e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-3891a08c9e");
  script_xref(name:"IAVA", value:"2024-A-0763-S");

  script_name(english:"Fedora 41 : php (2024-3891a08c9e)");
...
FEDORA-2024-3891a08c9e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-3891a08c9e");
...
var pkgs = [
    {'reference':'php-8.3.14-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
