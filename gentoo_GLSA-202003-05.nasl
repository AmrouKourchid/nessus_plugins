...
# extracted from Gentoo Linux Security Advisory GLSA 202003-05.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202003-05");

  script_name(english:"GLSA-202003-05 : e2fsprogs: Arbitrary code execution");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202003-05
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202003-05");
...
if (qpkg_check(package:"sys-fs/e2fsprogs", unaffected:make_list("ge 1.45.4"), vulnerable:make_list("lt 1.45.4"))) flag++;
