...
# extracted from Fedora Security Advisory FEDORA-2024-eafbf519ec
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-eafbf519ec");

  script_name(english:"Fedora 40 : glibc (2024-eafbf519ec)");
...
FEDORA-2024-eafbf519ec advisory.

    This update includes several bug fixes from the upstream glibc release branch, including the fix for a
    buffer overflow in `iconv` when converting to the ISO-2022-CN-EXT character set (CVE-2024-2961,
    RHBZ#2275855).
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-eafbf519ec");
...
var pkgs = [
    {'reference':'glibc-2.39-8.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
