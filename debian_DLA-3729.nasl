...
# extracted from Debian Security Advisory dla-3729. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3729 : debian-security-support - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has a package installed that is affected by a vulnerability as referenced in the dla-3729
advisory.
...
var pkgs = [
    {'release': '10.0', 'prefix': 'debian-security-support', 'reference': '1:10+2024.01.31'}
];
