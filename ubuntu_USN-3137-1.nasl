...
# extracted from Ubuntu Security Notice USN-3137-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS : MoinMoin vulnerabilities (USN-3137-1)");
...
referenced in the USN-3137-1 advisory.

    It was discovered that MoinMoin did not properly sanitize certain inputs, resulting in cross-site
    scripting (XSS) vulnerabilities. With cross-site scripting vulnerabilities, if a user were tricked into
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3137-1");
...
"Update the affected python-moinmoin package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-9119");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'python-moinmoin', 'pkgver': '1.9.7-1ubuntu2.1'},
    {'osver': '16.04', 'pkgname': 'python-moinmoin', 'pkgver': '1.9.8-1ubuntu1.16.04.1'}
];
