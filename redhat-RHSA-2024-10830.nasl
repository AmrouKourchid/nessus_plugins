...
# extracted from Red Hat Security Advisory RHSA-2024:10830. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:10830");

  script_name(english:"RHEL 8 : postgresql:15 (RHSA-2024:10830)");
...
referenced in the RHSA-2024:10830 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_10830.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f8e861bd");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:10830");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL postgresql:15 package based on the guidance in RHSA-2024:10830.");
  ...
  'postgresql:15': [
    {
      ...
      'pkgs': [
        {'reference':'pg_repack-1.4.8-1.module+el8.9.0+19797+c4ce5969', 'release':'8', 'el_string':'el8.9.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'pgaudit-1.7.0-1.module+el8.9.0+19797+c4ce5969', 'release':'8', 'el_string':'el8.9.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgres-decoderbufs-1.9.7-1.Final.module+el8.9.0+19797+c4ce5969', 'release':'8', 'el_string':'el8.9.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-15.10-1.module+el8.10.0+22550+22c7d5ca', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-contrib-15.10-1.module+el8.10.0+22550+22c7d5ca', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-docs-15.10-1.module+el8.10.0+22550+22c7d5ca', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plperl-15.10-1.module+el8.10.0+22550+22c7d5ca', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plpython3-15.10-1.module+el8.10.0+22550+22c7d5ca', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-pltcl-15.10-1.module+el8.10.0+22550+22c7d5ca', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-private-devel-15.10-1.module+el8.10.0+22550+22c7d5ca', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-private-libs-15.10-1.module+el8.10.0+22550+22c7d5ca', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-15.10-1.module+el8.10.0+22550+22c7d5ca', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-devel-15.10-1.module+el8.10.0+22550+22c7d5ca', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-static-15.10-1.module+el8.10.0+22550+22c7d5ca', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-15.10-1.module+el8.10.0+22550+22c7d5ca', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-rpm-macros-15.10-1.module+el8.10.0+22550+22c7d5ca', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-upgrade-15.10-1.module+el8.10.0+22550+22c7d5ca', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-upgrade-devel-15.10-1.module+el8.10.0+22550+22c7d5ca', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
