...
# extracted from Red Hat Security Advisory RHSA-2020:2761.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : chromium-browser (RHSA-2020:2761)");
...
RHSA-2020:2761 advisory.

  - Use after free in extensions in Google Chrome prior to 83.0.4103.116 allowed an attacker who convinced a
    user to install a malicious extension to potentially perform a sandbox escape via a crafted Chrome
    Extension. (CVE-2020-6509)
...
var pkgs = [
    {'reference':'chromium-browser-83.0.4103.116-1.el6_10', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
