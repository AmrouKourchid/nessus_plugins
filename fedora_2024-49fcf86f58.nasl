...
# extracted from Fedora Security Advisory FEDORA-2024-49fcf86f58
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-49fcf86f58");

  script_name(english:"Fedora 39 : kernel (2024-49fcf86f58)");
...
FEDORA-2024-49fcf86f58 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-49fcf86f58");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  var cve_list = make_list('CVE-2024-21823', 'CVE-2024-27398', 'CVE-2024-27399', 'CVE-2024-27400', 'CVE-2024-27401');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for FEDORA-2024-49fcf86f58');
  }
  else
  {
...
var pkgs = [
    {'reference':'kernel-6.8.10-200.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
