...
# extracted from Fedora Security Advisory FEDORA-2018-a71b957c50.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : mingw-openjpeg2 / openjpeg2 (2018-a71b957c50)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-a71b957c50");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"mingw-openjpeg2-2.3.0-4.fc28")) flag++;
if (rpm_check(release:"FC28", reference:"openjpeg2-2.3.0-9.fc28")) flag++;
