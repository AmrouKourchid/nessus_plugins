...
# CentOS Errata and Security Advisory 2017:1382 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 / 7 : sudo (CESA-2017:1382)");
...
Red Hat would like to thank Qualys Security for reporting this issue."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2017-May/022442.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b6ddd3a0"
  );
  # https://lists.centos.org/pipermail/centos-announce/2017-May/022450.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a8f1ff87"
  );
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"sudo-1.8.6p3-28.el6_9")) flag++;
if (rpm_check(release:"CentOS-6", reference:"sudo-devel-1.8.6p3-28.el6_9")) flag++;

if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"sudo-1.8.6p7-22.el7_3")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"sudo-devel-1.8.6p7-22.el7_3")) flag++;
