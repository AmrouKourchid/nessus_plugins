...
# extracted from Fedora Security Advisory FEDORA-2024-d96cdeb8ec
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-d96cdeb8ec");
  script_xref(name:"IAVA", value:"2024-A-0184");

  script_name(english:"Fedora 39 : libvirt (2024-d96cdeb8ec)");
...
FEDORA-2024-d96cdeb8ec advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-d96cdeb8ec");
...
var pkgs = [
    {'reference':'libvirt-9.7.0-3.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
