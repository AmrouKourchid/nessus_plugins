...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : sqlite (EulerOS-SA-2018-1180)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1180
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?52c9f3a7");
...
pkgs = ["sqlite-3.7.17-8.h1",
        "sqlite-devel-3.7.17-8.h1"];
