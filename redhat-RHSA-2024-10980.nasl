...
# extracted from Red Hat Security Advisory RHSA-2024:10980. The text
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_10980.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3318ad1a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:10980");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python3.12 package based on the guidance in RHSA-2024:10980.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3.12-3.12.8-1.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.12-debug-3.12.8-1.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.12-devel-3.12.8-1.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.12-idle-3.12.8-1.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.12-libs-3.12.8-1.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.12-rpm-macros-3.12.8-1.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.12-test-3.12.8-1.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.12-tkinter-3.12.8-1.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
