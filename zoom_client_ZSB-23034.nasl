...
if (description)
{
  ...
  script_cve_id("CVE-2023-39218");

  script_name(english:"Zoom Client for Meetings < 5.14.10 Vulnerability (ZSB-23034)");
...
a vulnerability as referenced in the ZSB-23034 advisory.

  - Client-side enforcement of server-side security in Zoom clients before 5.14.10 may allow a privileged user
    to enable information disclosure via network access. (CVE-2023-39218)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://explore.zoom.us/en/trust/security/security-bulletin/?filter-cve=&filter=&keywords=ZSB-23034
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a4610b08");
...
"Upgrade to Zoom Client for Meetings 5.14.10 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-39218");
