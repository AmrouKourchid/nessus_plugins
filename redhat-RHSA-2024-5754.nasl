...
# extracted from Red Hat Security Advisory RHSA-2024:5754. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2022-23772");
  script_xref(name:"RHSA", value:"2024:5754");

  script_name(english:"RHEL 8 / 9 : OpenShift Container Platform 4.15.29 (RHSA-2024:5754)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for OpenShift Container Platform 4.15.29.");
...
in the RHSA-2024:5754 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.15.29. See the
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_5754.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8cc8223e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2053532");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:5754");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.15.29 packages based on the guidance in RHSA-2024:5754.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openshift-hyperkube-4.15.0-202408131909.p0.gbc3c7c5.assembly.stream.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'openshift-hyperkube-4.15.0-202408131909.p0.gbc3c7c5.assembly.stream.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
