...
# extracted from Red Hat Security Advisory ricci. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2014-0194");

  script_name(english:"RHEL 6 : ricci (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-0194");
