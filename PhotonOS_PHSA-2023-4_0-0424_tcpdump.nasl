...
if (description)
{
  ...
  script_cve_id("CVE-2020-8036");

  script_name(english:"Photon OS 4.0: Tcpdump PHSA-2023-4.0-0424");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-8036");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'tcpdump-4.99.4-1.ph4')) flag++;
