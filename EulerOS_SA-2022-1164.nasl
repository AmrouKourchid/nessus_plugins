...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : glibc (EulerOS-SA-2022-1164)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1164
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?22de2087");
...
var pkgs = [
  "glibc-2.17-196.h49",
  "glibc-common-2.17-196.h49",
  "glibc-devel-2.17-196.h49",
  "glibc-headers-2.17-196.h49",
  "glibc-static-2.17-196.h49",
  "glibc-utils-2.17-196.h49",
  "nscd-2.17-196.h49"
];
