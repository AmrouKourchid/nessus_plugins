...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : Simple Streams regression (USN-2746-2)");
...
USN-2746-2 advisory.
    ...
    USN-2746-1 fixed a vulnerability in Simple Streams. The update caused a regression preventing MAAS from
    downloading PXE images. This update fixes the problem.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2746-2");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'python-simplestreams', 'pkgver': '0.1.0~bzr341-0ubuntu2.3'},
    {'osver': '14.04', 'pkgname': 'python-simplestreams-openstack', 'pkgver': '0.1.0~bzr341-0ubuntu2.3'},
    {'osver': '14.04', 'pkgname': 'python3-simplestreams', 'pkgver': '0.1.0~bzr341-0ubuntu2.3'},
    {'osver': '14.04', 'pkgname': 'simplestreams', 'pkgver': '0.1.0~bzr341-0ubuntu2.3'}
];
