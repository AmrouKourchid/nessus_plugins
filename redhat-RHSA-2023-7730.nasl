...
# extracted from Red Hat Security Advisory RHSA-2023:7730. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:7730");

  script_name(english:"RHEL 8 : tracker-miners (RHSA-2023:7730)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_7730.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d7ae830d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2243096");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:7730");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL tracker-miners package based on the guidance in RHSA-2023:7730.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'tracker-miners-2.1.5-2.el8_8.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
