...
# extracted from Fedora Security Advisory FEDORA-2021-6e805a5051
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-6e805a5051");

  script_name(english:"Fedora 32 : kernel (2021-6e805a5051)");
...
FEDORA-2021-6e805a5051 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-6e805a5051");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  cve_list = make_list('CVE-2021-3347');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for FEDORA-2021-6e805a5051');
  }
  else
  {
...
pkgs = [
    {'reference':'kernel-5.10.12-100.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE}
];
