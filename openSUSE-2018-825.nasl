...
# extracted from openSUSE Security Update openSUSE-2018-825.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : kernel-firmware (openSUSE-2018-825) (Spectre)");

  script_set_attribute(attribute:"synopsis", value:
"The remote openSUSE host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"This update for kernel-firmware to version 20180525 fixes the
following issues :
...
if ( rpm_check(release:"SUSE15.0", reference:"kernel-firmware-20180525-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"ucode-amd-20180525-lp150.2.3.1") ) flag++;
