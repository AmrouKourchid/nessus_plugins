...
# extracted from Red Hat Security Advisory RHSA-2025:1802. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:1802");

  script_name(english:"RHEL 9 : tuned (RHSA-2025:1802)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-65350");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_1802.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0e4263fd");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:1802");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL tuned package based on the guidance in RHSA-2025:1802.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'tuned-2.20.0-3.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tuned-gtk-2.20.0-3.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tuned-profiles-atomic-2.20.0-3.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tuned-profiles-cpu-partitioning-2.20.0-3.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tuned-profiles-mssql-2.20.0-3.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tuned-profiles-nfv-2.20.0-3.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tuned-profiles-nfv-guest-2.20.0-3.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tuned-profiles-nfv-host-2.20.0-3.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tuned-profiles-oracle-2.20.0-3.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tuned-profiles-postgresql-2.20.0-3.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tuned-profiles-realtime-2.20.0-3.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tuned-profiles-sap-2.20.0-3.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tuned-profiles-sap-hana-2.20.0-3.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tuned-profiles-spectrumscale-2.20.0-3.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tuned-utils-2.20.0-3.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
