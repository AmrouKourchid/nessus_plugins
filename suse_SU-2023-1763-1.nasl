...
# SUSE update advisory SUSE-SU-2023:1763-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:1763-1");

  script_name(english:"SUSE SLES15 Security Update : python-cryptography (SUSE-SU-2023:1763-1)");
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-April/014363.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?03a2b077");
...
var pkgs = [
    {'reference':'python3-cryptography-3.3.2-150200.19.1', 'sp':'3', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_RT-release-15.3']}
];
