...
# extracted from Fedora Security Advisory FEDORA-2024-7ee03010c5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-7ee03010c5");

  script_name(english:"Fedora 40 : webkitgtk (2024-7ee03010c5)");
...
FEDORA-2024-7ee03010c5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-7ee03010c5");
...
var pkgs = [
    {'reference':'webkitgtk-2.44.0-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
