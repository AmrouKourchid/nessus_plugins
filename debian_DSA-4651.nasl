...
# extracted from Debian Security Advisory DSA-4651. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"4651");

  script_name(english:"Debian DSA-4651-1 : mediawiki - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"It was discovered that some user-generated CSS selectors in MediaWiki,
a website engine for collaborative work, were not escaped.
...
The oldstable distribution (stretch) is not affected.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2020/dsa-4651");
...
version 1:1.31.7-1~deb10u1.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-10960");
...
flag = 0;
if (deb_check(release:"10.0", prefix:"mediawiki", reference:"1:1.31.7-1~deb10u1")) flag++;
if (deb_check(release:"10.0", prefix:"mediawiki-classes", reference:"1:1.31.7-1~deb10u1")) flag++;
