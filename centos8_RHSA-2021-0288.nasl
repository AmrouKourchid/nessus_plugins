...
# Red Hat Security Advisory RHSA-2021:0288. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : firefox (CESA-2021:0288)");
...
pkgs = [
    {'reference':'firefox-78.7.0-2.el8_3', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-78.7.0-2.el8_3', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
