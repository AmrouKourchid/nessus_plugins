...
# extracted from Fedora Security Advisory FEDORA-2023-6e5d4757df
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-6e5d4757df");

  script_name(english:"Fedora 37 : editorconfig (2023-6e5d4757df)");
...
FEDORA-2023-6e5d4757df advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-6e5d4757df");
...
var pkgs = [
    {'reference':'editorconfig-0.12.6-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
