...
# extracted from OracleVM Security Advisory OVMSA-2021-0018.
##
...
if (description)
{
  ...
  script_name(english:"OracleVM 3.4 : dhclient (OVMSA-2021-0018)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/cve/CVE-2021-25217.html");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/OVMSA-2021-0018.html");
...
var pkgs = [
    {'reference':'dhclient-4.1.1-63.P1.0.2.el6_10', 'cpu':'x86_64', 'release':'3.4', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'dhcp-common-4.1.1-63.P1.0.2.el6_10', 'cpu':'x86_64', 'release':'3.4', 'rpm_spec_vers_cmp':TRUE}
];
