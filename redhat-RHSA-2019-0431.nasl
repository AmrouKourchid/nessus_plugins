...
# extracted from Red Hat Security Advisory RHSA-2019:0431. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:0431");

  script_name(english:"RHEL 7 : ansible (RHSA-2019:0431)");
...
the RHSA-2019:0431 advisory.
    ...
    * ansible: path traversal in the fetch module (CVE-2019-3828)
    ...
    See https://github.com/ansible/ansible/blob/v2.7.8/changelogs/CHANGELOG-v2.7.rst for details on bug fixes
    in this release.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_0431.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d4973ff3");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:0431");
...
"Update the RHEL ansible package based on the guidance in RHSA-2019:0431.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ansible-2.7.8-1.el7ae', 'release':'7', 'el_string':'el7ae', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2.7'}
    ]
  }
];
