...
# Rocky Linux Security Advisory RLSA-2022:5775.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2022:5775");
  script_xref(name:"IAVB", value:"2022-B-0025-S");

  script_name(english:"Rocky Linux 8 : go-toolset:rhel8 (RLSA-2022:5775)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Rocky Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Rocky Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
RLSA-2022:5775 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2022:5775");
...
var pkgs = [
    ...
    {'reference':'go-toolset-1.17.12-1.module+el8.6.0+993+4fde2340', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'go-toolset-1.17.12-1.module+el8.6.0+993+4fde2340', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-1.17.12-1.module+el8.6.0+993+4fde2340', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-1.17.12-1.module+el8.6.0+993+4fde2340', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-bin-1.17.12-1.module+el8.6.0+993+4fde2340', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-bin-1.17.12-1.module+el8.6.0+993+4fde2340', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-docs-1.17.12-1.module+el8.6.0+993+4fde2340', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-misc-1.17.12-1.module+el8.6.0+993+4fde2340', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-race-1.17.12-1.module+el8.6.0+993+4fde2340', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-src-1.17.12-1.module+el8.6.0+993+4fde2340', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-tests-1.17.12-1.module+el8.6.0+993+4fde2340', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
