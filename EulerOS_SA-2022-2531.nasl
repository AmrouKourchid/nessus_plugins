...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : python-paramiko (EulerOS-SA-2022-2531)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the python-paramiko package installed, the EulerOS Virtualization installation on the
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2531
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6bf9e6e2");
...
var pkgs = [
  "python-paramiko-2.1.1-4.h4.eulerosv2r7"
];
