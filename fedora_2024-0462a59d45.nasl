...
# extracted from Fedora Security Advisory FEDORA-2024-0462a59d45
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-0462a59d45");

  script_name(english:"Fedora 40 : chromium (2024-0462a59d45)");
...
FEDORA-2024-0462a59d45 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-0462a59d45");
...
var pkgs = [
    {'reference':'chromium-127.0.6533.99-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
