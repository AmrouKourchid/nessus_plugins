...
# extracted from Fedora Security Advisory FEDORA-2024-4357ec611d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-4357ec611d");
  script_xref(name:"IAVB", value:"2024-B-0200");

  script_name(english:"Fedora 39 : xen (2024-4357ec611d)");
...
FEDORA-2024-4357ec611d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-4357ec611d");
...
var pkgs = [
    {'reference':'xen-4.17.4-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
