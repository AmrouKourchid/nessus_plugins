...
the USN-5807-2 advisory.
    ...
    USN-5807-1 fixed vulnerabilities in libXpm. This update provides the corresponding updates for Ubuntu
    16.04 ESM.
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libxpm-dev', 'pkgver': '1:3.5.11-1ubuntu0.16.04.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libxpm4', 'pkgver': '1:3.5.11-1ubuntu0.16.04.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'xpmutils', 'pkgver': '1:3.5.11-1ubuntu0.16.04.1+esm1', 'ubuntu_pro': TRUE}
];
