...
# SUSE update advisory SUSE-SU-2025:0056-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2025:0056-1");
  script_xref(name:"IAVA", value:"2025-A-0009-S");

  script_name(english:"SUSE SLES12 Security Update : MozillaFirefox (SUSE-SU-2025:0056-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote SUSE Linux SLES12 host has packages installed that are affected by multiple vulnerabilities as referenced in
the SUSE-SU-2025:0056-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2025-January/020078.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?82b9ca2b");
...
var pkgs = [
    {'reference':'MozillaFirefox-128.6.0-112.243.1', 'sp':'5', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE, 'exists_check':['sles-ltss-extended-security-release-12.5']},
    {'reference':'MozillaFirefox-devel-128.6.0-112.243.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE, 'exists_check':['sles-ltss-extended-security-release-12.5']},
    {'reference':'MozillaFirefox-translations-common-128.6.0-112.243.1', 'sp':'5', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE, 'exists_check':['sles-ltss-extended-security-release-12.5']},
    {'reference':'MozillaFirefox-128.6.0-112.243.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE, 'exists_check':['sles-release-12.5']},
    {'reference':'MozillaFirefox-devel-128.6.0-112.243.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE, 'exists_check':['sles-release-12.5']},
    {'reference':'MozillaFirefox-translations-common-128.6.0-112.243.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE, 'exists_check':['sles-release-12.5']}
];
