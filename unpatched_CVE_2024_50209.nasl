...
if (description)
{
  ...
  script_cve_id("CVE-2024-50209");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-50209");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: RDMA/bnxt_re: Add a check for memory
    allocation __alloc_pbl() can return error when memory allocation fails. Driver is not checking the status
    on one of the instances. (CVE-2024-50209)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-50209");
