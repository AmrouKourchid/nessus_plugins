...
# extracted from Gentoo Linux Security Advisory GLSA 202104-07.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202104-07");

  script_name(english:"GLSA-202104-07 : ClamAV: Denial of service");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202104-07
(ClamAV: Denial of service)

    A vulnerability has been discovered in ClamAV. Please review the CVE
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202104-07"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"app-antivirus/clamav", unaffected:make_list("ge 0.103.2"), vulnerable:make_list("lt 0.103.2"))) flag++;
