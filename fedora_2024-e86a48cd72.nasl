...
# extracted from Fedora Security Advisory FEDORA-2024-e86a48cd72
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-e86a48cd72");

  script_name(english:"Fedora 39 : mingw-expat (2024-e86a48cd72)");
...
FEDORA-2024-e86a48cd72 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-e86a48cd72");
...
var pkgs = [
    {'reference':'mingw-expat-2.6.3-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
