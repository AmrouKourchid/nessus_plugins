...
if (description)
{
  ...
  script_cve_id("CVE-2017-15046");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2017-15046");
...
patch available.
  ...
  - LAME 3.99.5, 3.99.4, 3.98.4, 3.98.2, 3.98 and 3.97 have a stack-based buffer overflow in
    unpack_read_samples in frontend/get_audio.c, a different vulnerability than CVE-2017-9412.
    (CVE-2017-15046)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-15046");
