...
var appstreams = {
    'nodejs:18': [
      ...
      {'reference':'nodejs-docs-18.14.2-2.module+el8.7.0+21020+b7aeeb08', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-full-i18n-18.14.2-2.module+el8.7.0+21020+b7aeeb08', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-nodemon-2.0.20-2.module+el8.7.0+21020+b7aeeb08', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'nodejs-docs-18.14.2-2.module+el8.7.0+21020+b7aeeb08', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-full-i18n-18.14.2-2.module+el8.7.0+21020+b7aeeb08', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-nodemon-2.0.20-2.module+el8.7.0+21020+b7aeeb08', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
