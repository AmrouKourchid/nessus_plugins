...
# SUSE update advisory SUSE-SU-2023:2621-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:2621-1");

  script_name(english:"SUSE SLES12 Security Update : openvswitch (SUSE-SU-2023:2621-1)");
...
in the SUSE-SU-2023:2621-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://lists.suse.com/pipermail/sle-updates/2023-June/030014.html");
...
var pkgs = [
    {'reference':'libopenvswitch-2_11-0-2.11.5-3.18.2', 'sp':'5', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5']},
    {'reference':'openvswitch-2.11.5-3.18.2', 'sp':'5', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5']},
    {'reference':'libopenvswitch-2_11-0-2.11.5-3.18.2', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.5']},
    {'reference':'openvswitch-2.11.5-3.18.2', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.5']}
];
