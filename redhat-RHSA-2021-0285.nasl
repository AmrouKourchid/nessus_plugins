...
# extracted from Red Hat Security Advisory RHSA-2021:0285. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_0285.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dce8d175");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:0285");
...
"Update the RHEL firefox package based on the guidance in RHSA-2021:0285.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-78.7.0-2.el8_1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
