...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : gstreamer1-plugins-base (EulerOS-SA-2019-1738)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1738
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?05722a8a");
...
pkgs = ["gstreamer1-plugins-base-1.10.4-1.h1",
        "gstreamer1-plugins-base-devel-1.10.4-1.h1"];
