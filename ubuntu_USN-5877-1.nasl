...
# extracted from Ubuntu Security Notice USN-5877-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5877-1");

  script_name(english:"Ubuntu 20.04 LTS : Linux kernel (GKE) vulnerabilities (USN-5877-1)");
...
the USN-5877-1 advisory.

    Kyle Zeng discovered that the sysctl implementation in the Linux kernel contained a stack-based buffer
    overflow. A local attacker could use this to cause a denial of service (system crash) or execute arbitrary
    code. (CVE-2022-4378)
    ...
    Mingwei Zhang discovered that the KVM implementation for AMD processors in the Linux kernel did not
    properly handle cache coherency with Secure Encrypted Virtualization (SEV). A local attacker could
    possibly use this to cause a denial of service (host system crash). (CVE-2022-0171)
    ...
    Hyunwoo Kim discovered that an integer overflow vulnerability existed in the PXA3xx graphics driver in the
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5877-1");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.15.0-1027-gke");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-5877-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2022-0171', 'CVE-2022-2663', 'CVE-2022-3061', 'CVE-2022-3303', 'CVE-2022-3543', 'CVE-2022-3586', 'CVE-2022-3619', 'CVE-2022-3623', 'CVE-2022-3628', 'CVE-2022-3640', 'CVE-2022-3643', 'CVE-2022-3646', 'CVE-2022-3649', 'CVE-2022-4095', 'CVE-2022-4378', 'CVE-2022-4662', 'CVE-2022-20421', 'CVE-2022-39188', 'CVE-2022-39842', 'CVE-2022-40307', 'CVE-2022-41849', 'CVE-2022-41850', 'CVE-2022-42895', 'CVE-2022-42896', 'CVE-2022-43750', 'CVE-2022-45934', 'CVE-2022-47940', 'CVE-2023-0590');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-5877-1');
  }
  else
  {
