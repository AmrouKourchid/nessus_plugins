...
if (description)
{
  ...
  script_cve_id("CVE-2024-47697");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-47697");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: drivers: media: dvb-frontends/rtl2830:
    fix an out-of-bounds write error Ensure index in rtl2830_pid_filter does not exceed 31 to prevent out-of-
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-47697");
