...
if (description)
{
  ...
  script_name(english:"CentOS 9 : tigervnc-1.12.0-9.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing one or more security updates for tigervnc.");
...
tigervnc-1.12.0-9.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=27918");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream tigervnc package.");
...
var pkgs = [
    {'reference':'tigervnc-1.12.0-9.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tigervnc-icons-1.12.0-9.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tigervnc-license-1.12.0-9.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tigervnc-selinux-1.12.0-9.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tigervnc-server-1.12.0-9.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tigervnc-server-minimal-1.12.0-9.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tigervnc-server-module-1.12.0-9.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
