...
# extracted from Fedora Security Advisory FEDORA-2024-e6a35cd250
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-e6a35cd250");

  script_name(english:"Fedora 38 : freeimage / mingw-freeimage (2024-e6a35cd250)");
...
FEDORA-2024-e6a35cd250 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-e6a35cd250");
...
var pkgs = [
    {'reference':'freeimage-3.19.0-0.23.svn1909.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'mingw-freeimage-3.19.0-0.20.svn1909.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
