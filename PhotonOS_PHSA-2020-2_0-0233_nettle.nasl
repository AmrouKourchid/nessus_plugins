...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Nettle PHSA-2020-2.0-0233");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'nettle-3.4.1-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'nettle-debuginfo-3.4.1-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'nettle-devel-3.4.1-1.ph2')) flag++;
