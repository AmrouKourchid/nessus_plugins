...
# extracted from Fedora Security Advisory FEDORA-2023-8f9d949dbc
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-8f9d949dbc");

  script_name(english:"Fedora 37 : python-django3 (2023-8f9d949dbc)");
...
FEDORA-2023-8f9d949dbc advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-8f9d949dbc");
...
var pkgs = [
    {'reference':'python-django3-3.2.19-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
