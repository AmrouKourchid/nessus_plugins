...
# extracted from Gentoo Linux Security Advisory GLSA 202101-12.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202101-12");
  script_xref(name:"IAVB", value:"2021-B-0001-S");

  script_name(english:"GLSA-202101-12 : Wireshark: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202101-12
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202101-12");
...
if (qpkg_check(package:"net-analyzer/wireshark", unaffected:make_list("ge 3.4.2"), vulnerable:make_list("lt 3.4.2"))) flag++;
