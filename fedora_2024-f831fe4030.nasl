...
# extracted from Fedora Security Advisory FEDORA-2024-f831fe4030
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-f831fe4030");

  script_name(english:"Fedora 41 : apr (2024-f831fe4030)");
...
FEDORA-2024-f831fe4030 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-f831fe4030");
...
var pkgs = [
    {'reference':'apr-1.7.5-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
