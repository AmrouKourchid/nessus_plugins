...
if (description)
{
  ...
  script_name(english:"Adobe InDesign < 17.4.1 / 18.0 < 18.1.0 Multiple Vulnerabilities (APSB23-07) (macOS)");

  script_set_attribute(attribute:"synopsis", value:
"The Adobe InDesign instance installed on the remote host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe InDesign installed on the remote macOS host is prior to 17.4.1, 18.1.0. It is, therefore, affected
by multiple vulnerabilities as referenced in the APSB23-07 advisory.
