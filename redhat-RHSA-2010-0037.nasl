...
referenced in the RHSA-2010:0037 advisory.
  ...
  - acroread: multiple code execution flaws (APSB10-02) (CVE-2009-3953, CVE-2009-3954, CVE-2009-3955,
    CVE-2009-3959)
...
number.");
  ...
  # https://access.redhat.com/security/data/csaf/v2/advisories/2010/rhsa-2010_0037.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0ddb655c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#critical");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=472975");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=473217");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=547799");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=554293");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=554296");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2010:0037");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL acroread package based on the guidance in RHSA-2010:0037.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:H/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:R/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:H/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2009-3959");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2009-3955");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'acroread-9.3-1.el5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'acroread-plugin-9.3-1.el5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
