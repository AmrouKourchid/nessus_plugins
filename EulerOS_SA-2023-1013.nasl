...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : libtasn1 (EulerOS-SA-2023-1013)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1013
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d3726958");
...
var pkgs = [
  "libtasn1-4.17.0-1.h3.eulerosv2r11"
];
