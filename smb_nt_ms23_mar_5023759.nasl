...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5023759");
  script_xref(name:"MSKB", value:"5023769");
  script_xref(name:"MSFT", value:"MS23-5023759");
  script_xref(name:"MSFT", value:"MS23-5023769");
  script_xref(name:"IAVA", value:"2023-A-0135-S");
  script_xref(name:"IAVA", value:"2023-A-0139-S");

  script_name(english:"KB5023759: Windows Server 2008 R2 Security Update (March 2023)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5023759");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5023769");
...
if (("windows server 2008 r2" >< tolower(os_name)) && 
  smb_check_rollup(os:'6.1',
                   ...
                   rollup_date:'03_2023',
                   bulletin:bulletin,
                   rollup_kb_list:[5023769, 5023759])
)
{
