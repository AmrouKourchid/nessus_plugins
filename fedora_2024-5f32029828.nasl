...
# extracted from Fedora Security Advisory FEDORA-2024-5f32029828
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-5f32029828");

  script_name(english:"Fedora 41 : unbound (2024-5f32029828)");
...
FEDORA-2024-5f32029828 advisory.
    ...
    ```
    * Fri Apr 12 2024 Petr Menk <pemensik@redhat.com> - 1.19.3-1
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-5f32029828");
...
var pkgs = [
    {'reference':'unbound-1.19.3-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
