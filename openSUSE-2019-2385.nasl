...
# extracted from openSUSE Security Update openSUSE-2019-2385.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : openconnect (openSUSE-2019-2385)");
...
"This update for openconnect fixes the following issues :
  ...
  - CVE-2019-16239: Fixed a buffer overflow when a malicious
    server uses HTTP chunked encoding with crafted chunk
    sizes. (bsc#1151178)

This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1151178");
...
if ( rpm_check(release:"SUSE15.1", reference:"openconnect-7.08-lp151.6.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"openconnect-debuginfo-7.08-lp151.6.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"openconnect-debugsource-7.08-lp151.6.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"openconnect-devel-7.08-lp151.6.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"openconnect-lang-7.08-lp151.6.3.1") ) flag++;
