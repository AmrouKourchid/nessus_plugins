...
if (description)
{
  ...
  script_name(english:"Oracle MySQL Server 8.0.x < 8.0.34 (October 2023 CPU)");
...
October 2023 CPU advisory.
  ...
  - Vulnerability in the MySQL Server product of Oracle MySQL (component: Server: Compiling (Zstandard)).
    Supported versions that are affected are 8.0.33 and prior. Easily exploitable vulnerability allows unauthenticated
    ...
    MySQL Server. (CVE-2022-4899)

  - Vulnerability in the MySQL Server product of Oracle MySQL (component: InnoDB). Supported versions that are
    affected are 8.0.33 and prior. Easily exploitable vulnerability allows high privileged attacker with network
    access via multiple protocols to compromise MySQL Server. Successful attacks of this vulnerability can result in
    unauthorized ability to cause a hang or frequently repeatable crash (complete DOS) of MySQL Server. (CVE-2023-22008)
