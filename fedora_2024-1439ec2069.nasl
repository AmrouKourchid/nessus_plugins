...
# extracted from Fedora Security Advisory FEDORA-2024-1439ec2069
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-1439ec2069");

  script_name(english:"Fedora 38 : libreswan (2024-1439ec2069)");
...
FEDORA-2024-1439ec2069 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-1439ec2069");
...
var pkgs = [
    {'reference':'libreswan-4.14-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
