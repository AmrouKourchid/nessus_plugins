...
# extracted from VMware Security Advisory PHSA-2023-5.0-0176. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Vim PHSA-2023-5.0-0176");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the vim package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-5.0-176.md");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'vim-9.0.2121-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'vim-extra-9.0.2121-1.ph5')) flag++;
