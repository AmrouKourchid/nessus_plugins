...
# extracted from Red Hat Security Advisory RHSA-2020:2116.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : buildah (RHSA-2020:2116)");
...
var pkgs = [
    {'reference':'buildah-1.11.6-11.el7_8', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'buildah-1.11.6-11.el7_8', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE}
];
