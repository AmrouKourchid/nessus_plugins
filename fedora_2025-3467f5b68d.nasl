...
# extracted from Fedora Security Advisory FEDORA-2025-3467f5b68d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-3467f5b68d");

  script_name(english:"Fedora 40 : trafficserver (2025-3467f5b68d)");
...
FEDORA-2025-3467f5b68d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-3467f5b68d");
...
var pkgs = [
    {'reference':'trafficserver-9.2.10-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
