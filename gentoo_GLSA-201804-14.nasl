...
(GDK-PixBuf: Remote code execution)
    ...
    Several integer overflows were discovered in GDK-PixBuf&rsquo;s gif_get_lzw
      function.
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/201804-14");
