...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5037765");
  script_xref(name:"MSFT", value:"MS24-5037765");
  ...
  script_name(english:"KB5037765: Windows 10 version 1809 / Windows Server 2019 Security Update (May 2024)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5037765");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5039705");
...
var oob_installed = get_kb_item('WMI/Installed/Hotfix/KB5039705');

if (oob_installed) audit(AUDIT_OS_SP_NOT_VULN);
...
if (
  smb_check_rollup(os:'10',
                   ...
                   rollup_date:'05_2024',
                   bulletin:bulletin,
                   rollup_kb_list:[5037765, 5039705])
)
{
