...
# extracted from ZTE advisory NS-SA-2020-0103. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.05 / MAIN 5.05 : lftp Vulnerability (NS-SA-2020-0103)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version CORE 5.05 / MAIN 5.05, has lftp packages installed that are affected by a
vulnerability:
...
number.");
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/notice/NS-SA-2020-0103");
...
pkgs = {
  'CGSL CORE 5.05': [
    'lftp-4.4.8-12.el7.cgslv5_5.0.2.gabcddec',
    'lftp-debuginfo-4.4.8-12.el7.cgslv5_5.0.2.gabcddec',
    'lftp-scripts-4.4.8-12.el7.cgslv5_5.0.2.gabcddec'
  ],
  'CGSL MAIN 5.05': [
    'lftp-4.4.8-12.el7.cgslv5_5.0.2.gabcddec',
    'lftp-debuginfo-4.4.8-12.el7.cgslv5_5.0.2.gabcddec',
