...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : Bash vulnerability (USN-2363-1)");
...
USN-2363-1 advisory.
    ...
    Tavis Ormandy discovered that the security fix for Bash included in USN-2362-1 was incomplete. An attacker
    could use this issue to bypass certain environment restrictions. (CVE-2014-7169)

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2363-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'bash', 'pkgver': '4.3-7ubuntu1.2'},
    {'osver': '14.04', 'pkgname': 'bash-builtins', 'pkgver': '4.3-7ubuntu1.2'},
    {'osver': '14.04', 'pkgname': 'bash-static', 'pkgver': '4.3-7ubuntu1.2'}
];
