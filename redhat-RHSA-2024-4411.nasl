...
# extracted from Red Hat Security Advisory RHSA-2024:4411. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:4411");

  script_name(english:"RHEL 9 : booth (RHSA-2024:4411)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_4411.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?14170488");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2272082");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:4411");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL booth package based on the guidance in RHSA-2024:4411.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'booth-1.0-251.3.bfb2f92.git.el9_0.2', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'booth-arbitrator-1.0-251.3.bfb2f92.git.el9_0.2', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'booth-core-1.0-251.3.bfb2f92.git.el9_0.2', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'booth-site-1.0-251.3.bfb2f92.git.el9_0.2', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'booth-test-1.0-251.3.bfb2f92.git.el9_0.2', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
