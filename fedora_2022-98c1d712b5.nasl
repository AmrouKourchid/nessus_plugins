...
# extracted from Fedora Security Advisory FEDORA-2022-98c1d712b5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-98c1d712b5");

  script_name(english:"Fedora 37 : nextcloud (2022-98c1d712b5)");
...
FEDORA-2022-98c1d712b5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-98c1d712b5");
...
var pkgs = [
    {'reference':'nextcloud-25.0.1-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
