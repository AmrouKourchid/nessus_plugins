...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : binutils (EulerOS-SA-2020-1372)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1372
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f03a5852");
...
pkgs = ["binutils-2.25.1-22.base.h38",
        "binutils-devel-2.25.1-22.base.h38"];
