...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.6 : postgresql (EulerOS-SA-2021-1448)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the version of the postgresql package installed, the
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1448
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b5f245cb");
...
pkgs = ["postgresql-libs-9.2.24-1.h1.eulerosv2r7"];
