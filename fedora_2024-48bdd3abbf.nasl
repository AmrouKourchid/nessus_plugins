...
# extracted from Fedora Security Advisory FEDORA-2024-48bdd3abbf
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-48bdd3abbf");
  script_xref(name:"IAVA", value:"2024-A-0328");

  script_name(english:"Fedora 38 : ruby (2024-48bdd3abbf)");
...
FEDORA-2024-48bdd3abbf advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-48bdd3abbf");
...
var pkgs = [
    {'reference':'ruby-3.2.4-182.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
