...
# extracted from Red Hat Security Advisory RHSA-2021:3971. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:3971");

  script_name(english:"RHEL 7 : Red Hat OpenStack Platform 10.0 (redis) (RHSA-2021:3971)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for Red Hat OpenStack Platform 10.0 (redis).");
...
referenced in the RHSA-2021:3971 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_3971.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8f8482af");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:3971");
...
"Update the RHEL Red Hat OpenStack Platform 10.0 (redis) package based on the guidance in RHSA-2021:3971.");
