...
# SUSE update advisory SUSE-SU-2022:4550-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:4550-1");

  script_name(english:"SUSE SLES12 / SLES15 Security Update : kernel (Live Patch 23 for SLE 12 SP4) (SUSE-SU-2022:4550-1)");
...
multiple vulnerabilities as referenced in the SUSE-SU-2022:4550-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-December/013277.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e170d8be");
  script_set_attribute(attribute:"solution", value:
"Update the affected kernel-livepatch-4_12_14-150_78-default, kgraft-patch-4_12_14-122_98-default and / or kgraft-
patch-4_12_14-95_83-default packages.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-122.98-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_12_14-122_98-default-17-2.2', 'sp':'5', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5']},
          {'reference':'kgraft-patch-4_12_14-122_98-default-17-2.2', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-12.5', 'sle-live-patching-release-12.5', 'sles-release-12.5']}
        ]
      },
      '4.12.14-150.78-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-4_12_14-150_78-default-16-150000.2.2', 'sp':'0', 'cpu':'x86_64', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15']},
          {'reference':'kernel-livepatch-4_12_14-150_78-default-16-150000.2.2', 'sp':'0', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15', 'sle-module-live-patching-release-15', 'sles-release-15']}
        ]
      },
      '4.12.14-95.83-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_12_14-95_83-default-16-2.2', 'sp':'4', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.4']},
          {'reference':'kgraft-patch-4_12_14-95_83-default-16-2.2', 'sp':'4', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-12.4', 'sle-live-patching-release-12.4', 'sles-release-12.4']}
        ]
      }
    }
  }
