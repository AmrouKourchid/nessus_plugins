...
# extracted from Fedora Security Advisory FEDORA-2022-25e330a435
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-25e330a435");

  script_name(english:"Fedora 37 : firefox (2022-25e330a435)");
...
FEDORA-2022-25e330a435 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-25e330a435");
...
var pkgs = [
    {'reference':'firefox-105.0.1-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
