...
# AlmaLinux Security Advisory ALSA-2024:10472.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:10472");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2024/12/12");
  script_xref(name:"RHSA", value:"2024:10472");

  script_name(english:"AlmaLinux 9 : webkit2gtk3 (ALSA-2024:10472)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2024-10472.html");
...
var pkgs = [
    {'reference':'webkit2gtk3-2.46.3-2.el9_5', 'release':'9', 'el_string':'el9_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'webkit2gtk3-devel-2.46.3-2.el9_5', 'release':'9', 'el_string':'el9_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'webkit2gtk3-jsc-2.46.3-2.el9_5', 'release':'9', 'el_string':'el9_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'webkit2gtk3-jsc-devel-2.46.3-2.el9_5', 'release':'9', 'el_string':'el9_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'}
];
