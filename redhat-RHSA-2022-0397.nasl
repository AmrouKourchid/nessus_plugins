...
# extracted from Red Hat Security Advisory RHSA-2022:0397. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2021-3716", "CVE-2021-20196");
  script_xref(name:"RHSA", value:"2022:0397");

  script_name(english:"RHEL 8 : virt:av and virt-devel:av (RHSA-2022:0397)");
...
referenced in the RHSA-2022:0397 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_0397.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e72a16f1");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:0397");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2040778");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2040781");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL virt:av / virt-devel:av packages based on the guidance in RHSA-2022:0397.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:S/C:N/I:N/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:L/UI:N/S:C/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-3716");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2021-20196");

  script_set_attribute(attribute:"exploitability_ease", value:"Exploits are available");
  script_set_attribute(attribute:"exploit_available", value:"true");
  script_cwe_id(476, 924);
  ...
  'virt:av': [
    {
      ...
      'pkgs': [
        ...
        {'reference':'qemu-guest-agent-6.0.0-33.module+el8.5.0+13740+349232b6.2', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-img-6.0.0-33.module+el8.5.0+13740+349232b6.2', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kiwi-6.0.0-33.module+el8.5.0+13740+349232b6.2', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-6.0.0-33.module+el8.5.0+13740+349232b6.2', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-block-curl-6.0.0-33.module+el8.5.0+13740+349232b6.2', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-block-gluster-6.0.0-33.module+el8.5.0+13740+349232b6.2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-block-iscsi-6.0.0-33.module+el8.5.0+13740+349232b6.2', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-block-rbd-6.0.0-33.module+el8.5.0+13740+349232b6.2', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-block-ssh-6.0.0-33.module+el8.5.0+13740+349232b6.2', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-common-6.0.0-33.module+el8.5.0+13740+349232b6.2', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-core-6.0.0-33.module+el8.5.0+13740+349232b6.2', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-docs-6.0.0-33.module+el8.5.0+13740+349232b6.2', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-hw-usbredir-6.0.0-33.module+el8.5.0+13740+349232b6.2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-ui-opengl-6.0.0-33.module+el8.5.0+13740+349232b6.2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-ui-spice-6.0.0-33.module+el8.5.0+13740+349232b6.2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
  ...
  'virt-devel:av': [
    {
      ...
      'pkgs': [
        ...
        {'reference':'qemu-kvm-tests-6.0.0-33.module+el8.5.0+13740+349232b6.2', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
