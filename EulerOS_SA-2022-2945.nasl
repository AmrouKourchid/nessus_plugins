...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : shim (EulerOS-SA-2022-2945)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2945
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?edcc4280");
...
var pkgs = [
  "shim-15-20.h6.eulerosv2r10",
  "shim-aa64-storage-15-20.h6.eulerosv2r10"
];
