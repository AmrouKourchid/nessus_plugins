...
if (description)
{
  ...
  script_cve_id("CVE-2024-20920");
  script_xref(name:"IAVA", value: "2024-A-0036");

  script_name(english:"Oracle Solaris Critical Patch Update : jan2024_SRU11_4_61_151_2");

  script_set_attribute(attribute:"synopsis", value:
"The remote Solaris system is missing a security patch from CPU Jan2024.");
  script_set_attribute(attribute:"description", value:
"The version of Solaris installed on the remote host is prior to 11.4.61.151.2. It is, therefore, affected by a
vulnerability as referenced in the solaris11_jan2024_SRU11_4_61_151_2 advisory.
  ...
  - Vulnerability in the Oracle Solaris product of Oracle Systems (component: Filesystem). The supported
    ...
    to the infrastructure where Oracle Solaris executes to compromise Oracle Solaris. While the vulnerability
    is in Oracle Solaris, attacks may significantly impact additional products (scope change). Successful
    attacks of this vulnerability can result in unauthorized read access to a subset of Oracle Solaris
    accessible data. (CVE-2024-20920)
...
"Install the Jan2024 CPU from the Oracle support website.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-20920");
