...
"An update of the binutils package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-3.0-22.md");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'binutils-2.31.1-5.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'binutils-debuginfo-2.31.1-5.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'binutils-devel-2.31.1-5.ph3')) flag++;
