...
# extracted from Fedora Security Advisory FEDORA-2018-7270b39f50.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2017-13755", "CVE-2018-11737");
  script_xref(name:"FEDORA", value:"2018-7270b39f50");

  script_name(english:"Fedora 27 : sleuthkit (2018-7270b39f50)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-7270b39f50");
  script_set_attribute(attribute:"solution", value:
"Update the affected sleuthkit package.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:P/I:N/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:R/S:U/C:H/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-11737");
...
flag = 0;
if (rpm_check(release:"FC27", reference:"sleuthkit-4.6.2-1.fc27")) flag++;
