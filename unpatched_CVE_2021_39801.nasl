...
if (description)
{
  ...
  script_cve_id("CVE-2021-39801");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2021-39801");
...
patch available.
  ...
  - In ion_ioctl of ion-ioctl.c, there is a possible use after free due to improper locking. This could lead
    to local escalation of privilege with no additional execution privileges needed. User interaction is not
    needed for exploitation.Product: AndroidVersions: Android kernelAndroid ID: A-209791720References:
    Upstream kernel (CVE-2021-39801)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-39801");
