...
# extracted from Fedora Security Advisory FEDORA-2022-94bee848e6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-94bee848e6");

  script_name(english:"Fedora 37 : python3.8 (2022-94bee848e6)");
...
FEDORA-2022-94bee848e6 advisory.

    The release you're looking at is Python 3.8.15, a security bugfix release for the legacy 3.8 series.
    https://docs.python.org/release/3.8.15/whatsnew/changelog.html#python-3-8-15-final

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-94bee848e6");
...
var pkgs = [
    {'reference':'python3.8-3.8.15-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
