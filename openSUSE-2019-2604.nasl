...
# extracted from openSUSE Security Update openSUSE-2019-2604.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : freerdp (openSUSE-2019-2604)");
...
This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1153163");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1153164");
...
if ( rpm_check(release:"SUSE15.0", reference:"freerdp-2.0.0~rc4-lp150.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"freerdp-debuginfo-2.0.0~rc4-lp150.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"freerdp-debugsource-2.0.0~rc4-lp150.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"freerdp-devel-2.0.0~rc4-lp150.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"freerdp-server-2.0.0~rc4-lp150.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"freerdp-server-debuginfo-2.0.0~rc4-lp150.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"freerdp-wayland-2.0.0~rc4-lp150.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"freerdp-wayland-debuginfo-2.0.0~rc4-lp150.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libfreerdp2-2.0.0~rc4-lp150.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libfreerdp2-debuginfo-2.0.0~rc4-lp150.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libuwac0-0-2.0.0~rc4-lp150.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libuwac0-0-debuginfo-2.0.0~rc4-lp150.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libwinpr2-2.0.0~rc4-lp150.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libwinpr2-debuginfo-2.0.0~rc4-lp150.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"uwac0-0-devel-2.0.0~rc4-lp150.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"winpr2-devel-2.0.0~rc4-lp150.10.1") ) flag++;
