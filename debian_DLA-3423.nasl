...
# extracted from Debian Security Advisory dla-3423. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3423 : epiphany-browser - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3423
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-26081");
...
"Upgrade the epiphany-browser packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-26081");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'epiphany-browser', 'reference': '3.32.1.2-3~deb10u3'},
    {'release': '10.0', 'prefix': 'epiphany-browser-data', 'reference': '3.32.1.2-3~deb10u3'}
];
