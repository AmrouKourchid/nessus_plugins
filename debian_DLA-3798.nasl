...
# extracted from Debian Security Advisory dla-3798. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3798 : zabbix-agent - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3798
advisory.
...
var pkgs = [
    {'release': '10.0', 'prefix': 'zabbix-agent', 'reference': '1:4.0.4+dfsg-1+deb10u5'},
    {'release': '10.0', 'prefix': 'zabbix-frontend-php', 'reference': '1:4.0.4+dfsg-1+deb10u5'},
    {'release': '10.0', 'prefix': 'zabbix-java-gateway', 'reference': '1:4.0.4+dfsg-1+deb10u5'},
    {'release': '10.0', 'prefix': 'zabbix-proxy-mysql', 'reference': '1:4.0.4+dfsg-1+deb10u5'},
    {'release': '10.0', 'prefix': 'zabbix-proxy-pgsql', 'reference': '1:4.0.4+dfsg-1+deb10u5'},
    {'release': '10.0', 'prefix': 'zabbix-proxy-sqlite3', 'reference': '1:4.0.4+dfsg-1+deb10u5'},
    {'release': '10.0', 'prefix': 'zabbix-server-mysql', 'reference': '1:4.0.4+dfsg-1+deb10u5'},
    {'release': '10.0', 'prefix': 'zabbix-server-pgsql', 'reference': '1:4.0.4+dfsg-1+deb10u5'}
];
