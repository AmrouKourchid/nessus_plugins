...
# extracted from Red Hat Security Advisory RHSA-2024:9423. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:9423");

  script_name(english:"RHEL 9 : python-dns (RHSA-2024:9423)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for python-dns.");
...
the RHSA-2024:9423 advisory.

    The python-dns package contains the dnslib module that implements a DNS client and additional modules that
    define certain symbolic constants used by DNS, such as dnstype, dnsclass and dnsopcode.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-32663");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_9423.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?626cecac");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:9423");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-dns package based on the guidance in RHSA-2024:9423.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-dns-2.6.1-3.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python3-dns');
}
