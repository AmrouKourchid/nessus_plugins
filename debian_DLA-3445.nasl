...
# extracted from Debian Security Advisory dla-3445. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3445 : cpio - security update");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/cpio");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2019-14866");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2021-38185");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/cpio");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'cpio', 'reference': '2.12+dfsg-9+deb10u1'},
    {'release': '10.0', 'prefix': 'cpio-win32', 'reference': '2.12+dfsg-9+deb10u1'}
];
