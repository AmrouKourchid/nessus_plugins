...
# extracted from Fedora Security Advisory FEDORA-2024-1bd7266df0
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-1bd7266df0");

  script_name(english:"Fedora 39 : chromium (2024-1bd7266df0)");
...
FEDORA-2024-1bd7266df0 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-1bd7266df0");
...
var pkgs = [
    {'reference':'chromium-128.0.6613.119-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
