...
# extracted from Fedora Security Advisory FEDORA-2024-6d1d9f70d2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-6d1d9f70d2");

  script_name(english:"Fedora 39 : fonttools (2024-6d1d9f70d2)");
...
FEDORA-2024-6d1d9f70d2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-6d1d9f70d2");
  script_set_attribute(attribute:"solution", value:
"Update the affected fonttools package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:fonttools");
...
var pkgs = [
    {'reference':'fonttools-4.43.1-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'fonttools');
}
