...
# extracted from Red Hat Security Advisory RHSA-2018:0050. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:0050");
  script_xref(name:"IAVA", value:"2018-A-0020");
  script_xref(name:"IAVA", value:"2018-A-0017-S");

  script_name(english:"RHEL 7 : Virtualization (RHSA-2018:0050) (Spectre)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"An update for vdsm is now available for RHEV 4.X, RHEV-H, and Agents
...
issue.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:0050");
...
else
{
  ...
  if (! (rpm_exists(release:"RHEL7", rpm:"vdsm-4.19"))) audit(AUDIT_PACKAGE_NOT_INSTALLED, "Virtualization");

  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"vdsm-4.19.43-3.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-api-4.19.43-3.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-cli-4.19.43-3.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-client-4.19.43-3.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-gluster-4.19.43-3.el7")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"vdsm-hook-checkips-4.19.43-3.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-hook-ethtool-options-4.19.43-3.el7")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"vdsm-hook-extra-ipv4-addrs-4.19.43-3.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-hook-fcoe-4.19.43-3.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-hook-localdisk-4.19.43-3.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-hook-macspoof-4.19.43-3.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-hook-nestedvt-4.19.43-3.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-hook-openstacknet-4.19.43-3.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-hook-vfio-mdev-4.19.43-3.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-hook-vhostmd-4.19.43-3.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-hook-vmfex-dev-4.19.43-3.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-jsonrpc-4.19.43-3.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-python-4.19.43-3.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-xmlrpc-4.19.43-3.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-yajsonrpc-4.19.43-3.el7")) flag++;
  ...
  else
  {
    ...
    else audit(AUDIT_PACKAGE_NOT_INSTALLED, "vdsm / vdsm-api / vdsm-cli / vdsm-client / vdsm-gluster / etc");
  }
}
