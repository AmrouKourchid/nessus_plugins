...
# extracted from Red Hat Security Advisory RHSA-2025:0137. The text
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_0137.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7cf7cb6b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:0137");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL firefox package based on the guidance in RHSA-2025:0137.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-128.6.0-1.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
