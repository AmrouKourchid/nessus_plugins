...
if (description)
{
  ...
  script_cve_id("CVE-2023-3896");
  script_xref(name:"IAVB", value:"2023-B-0066-S");
  script_xref(name:"IAVA", value:"2023-A-0579-S");

  script_name(english:"Photon OS 4.0: Vim PHSA-2023-4.0-0450");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-3896");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'vim-9.0.1664-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'vim-extra-9.0.1664-1.ph4')) flag++;
