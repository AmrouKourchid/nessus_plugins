...
# extracted from Fedora Security Advisory FEDORA-2024-3699706b25
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-3699706b25");
  script_xref(name:"IAVA", value:"2024-A-0133-S");

  script_name(english:"Fedora 39 : thunderbird (2024-3699706b25)");
...
FEDORA-2024-3699706b25 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-3699706b25");
...
var pkgs = [
    {'reference':'thunderbird-115.8.1-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
