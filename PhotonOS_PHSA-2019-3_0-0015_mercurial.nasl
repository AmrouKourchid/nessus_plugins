...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Mercurial PHSA-2019-3.0-0015");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'mercurial-4.7.1-4.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'mercurial-debuginfo-4.7.1-4.ph3')) flag++;
