...
# extracted from Red Hat Security Advisory RHSA-2023:5540. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:5540");

  script_name(english:"RHEL 9 : libvpx (RHSA-2023:5540)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for libvpx.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2023:5540 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_5540.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2405d2cc");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:5540");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libvpx package based on the guidance in RHSA-2023:5540.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libvpx-1.9.0-7.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvpx-devel-1.9.0-7.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
