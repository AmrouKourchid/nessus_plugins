...
# extracted from Fedora Security Advisory FEDORA-2023-755b8bb6db
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-755b8bb6db");

  script_name(english:"Fedora 38 : linux-firmware (2023-755b8bb6db)");
...
FEDORA-2023-755b8bb6db advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-755b8bb6db");
...
var pkgs = [
    {'reference':'linux-firmware-20230804-153.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
