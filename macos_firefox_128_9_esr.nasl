...
"The version of Firefox ESR installed on the remote macOS or Mac OS X host is prior to 128.9. It is, therefore, affected
by multiple vulnerabilities as referenced in the mfsa2025-22 advisory.
...
mozilla_check_version(version:version, path:path, product:'firefox', esr:TRUE, fix:'128.9', min:'128.0.0', severity:SECURITY_HOLE);
