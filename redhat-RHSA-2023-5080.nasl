...
# extracted from Red Hat Security Advisory RHSA-2023:5080. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:5080");

  script_name(english:"RHEL 9 : keylime (RHSA-2023:5080)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for keylime.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2023:5080 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_5080.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9ee5e528");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2222692");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2222693");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:5080");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL keylime package based on the guidance in RHSA-2023:5080.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:keylime");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:keylime-base");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:keylime-registrar");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:keylime-selinux");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:keylime-tenant");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:keylime-verifier");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:python3-keylime");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'keylime-6.5.2-6.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'keylime-base-6.5.2-6.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'keylime-registrar-6.5.2-6.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'keylime-selinux-6.5.2-6.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'keylime-tenant-6.5.2-6.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'keylime-verifier-6.5.2-6.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-keylime-6.5.2-6.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'keylime-6.5.2-6.el9_2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'keylime-base-6.5.2-6.el9_2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'keylime-registrar-6.5.2-6.el9_2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'keylime-selinux-6.5.2-6.el9_2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'keylime-tenant-6.5.2-6.el9_2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'keylime-verifier-6.5.2-6.el9_2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-keylime-6.5.2-6.el9_2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
