...
referenced in the RHSA-2019:2591 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_2591.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2b011209");
...
"Update the RHEL ghostscript package based on the guidance in RHSA-2019:2591.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ghostscript-9.25-2.el8_0.3', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ghostscript-doc-9.25-2.el8_0.3', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ghostscript-tools-dvipdf-9.25-2.el8_0.3', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ghostscript-tools-fonts-9.25-2.el8_0.3', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ghostscript-tools-printing-9.25-2.el8_0.3', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ghostscript-x11-9.25-2.el8_0.3', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libgs-9.25-2.el8_0.3', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libgs-devel-9.25-2.el8_0.3', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
