...
# extracted from Fedora Security Advisory FEDORA-2024-0ba1c1a435
#
...
if (description)
{
  script_id(201940);
  script_version("1.1");
  script_set_attribute(attribute:"plugin_modification_date", value:"2024/07/07");

  script_cve_id("CVE-2024-38519");
  script_xref(name:"FEDORA", value:"2024-0ba1c1a435");

  script_name(english:"Fedora 40 : yt-dlp (2024-0ba1c1a435)");
...
FEDORA-2024-0ba1c1a435 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-0ba1c1a435");
...
"Update the affected yt-dlp package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-38519");
...
var pkgs = [
    {'reference':'yt-dlp-2024.07.02-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
