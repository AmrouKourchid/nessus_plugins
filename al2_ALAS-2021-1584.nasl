...
"The version of php-pear installed on the remote host is prior to 1.10.12-4. It is, therefore, affected by multiple
vulnerabilities as referenced in the ALAS2-2021-1584 advisory.
...
var pkgs = [
    {'reference':'php-pear-1.10.12-4.amzn2.0.1', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
