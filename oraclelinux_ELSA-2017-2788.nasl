...
# Oracle Linux Security Advisory ELSA-2017-2788 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : augeas (ELSA-2017-2788)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 7 host has packages installed that are affected by a vulnerability as referenced in the
ELSA-2017-2788 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2017-2788.html");
...
var pkgs = [
    {'reference':'augeas-devel-1.4.0-2.el7_4.1', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'augeas-devel-1.4.0-2.el7_4.1', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
