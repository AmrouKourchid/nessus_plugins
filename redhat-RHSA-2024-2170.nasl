...
# extracted from Red Hat Security Advisory RHSA-2024:2170. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2170");

  script_name(english:"RHEL 9 : xorg-x11-server-Xwayland (RHSA-2024:2170)");
...
referenced in the RHSA-2024:2170 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2170.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?848b07d7");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2170");
...
"Update the RHEL xorg-x11-server-Xwayland packages based on the guidance in RHSA-2024:2170.");
  ...
  script_cwe_id(122, 125, 158, 190, 787, 788);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'xorg-x11-server-Xwayland-22.1.9-5.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
