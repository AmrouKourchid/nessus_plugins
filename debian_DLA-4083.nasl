...
# extracted from Debian Security Advisory dla-4083. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2024-25111", "CVE-2024-37894", "CVE-2024-45802");
  script_xref(name:"IAVB", value:"2024-B-0087-S");
  script_xref(name:"IAVB", value:"2024-B-0168");

  script_name(english:"Debian dla-4083 : squid - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-45802");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'squid', 'reference': '4.13-10+deb11u4'},
    {'release': '11.0', 'prefix': 'squid-cgi', 'reference': '4.13-10+deb11u4'},
    {'release': '11.0', 'prefix': 'squid-common', 'reference': '4.13-10+deb11u4'},
    {'release': '11.0', 'prefix': 'squid-openssl', 'reference': '4.13-10+deb11u4'},
    {'release': '11.0', 'prefix': 'squid-purge', 'reference': '4.13-10+deb11u4'},
    {'release': '11.0', 'prefix': 'squidclient', 'reference': '4.13-10+deb11u4'}
];
