...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.12.1 : python-urllib3 (EulerOS-SA-2024-2761)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the python-urllib3 package installed, the EulerOS Virtualization installation on the remote
...
Tenable has extracted the preceding description block directly from the EulerOS Virtualization python-urllib3 security
advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2761
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6b4d6b1d");
...
var pkgs = [
  "python3-urllib3-1.26.12-1.h5.eulerosv2r12"
];
