...
if (description)
{
  ...
  script_cve_id("CVE-2024-27268");
  script_xref(name:"IAVA", value:"2024-A-0205");

  script_name(english:"IBM WebSphere Application Server Liberty 18.0.0.2 < 24.0.0.5 DoS (7145809)");
...
referenced in the 7145809 advisory.

  - IBM WebSphere Application Server Liberty 18.0.0.2 through 24.0.0.3 is vulnerable to a denial of service,
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/node/7145809");
...
pack levels required by the interim fix and then apply Interim Fix PH60146.");
...
if ('PH60146' >< app_info['Fixes'])
  audit(AUDIT_INST_VER_NOT_VULN, app);

var constraints = [
  { 'min_version' : '18.0.0.2', 'fixed_version' : '24.0.0.5', 'fixed_display' : '24.0.0.5 or Interim Fix PH60146' }
];
