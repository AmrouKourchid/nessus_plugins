...
# extracted from Debian Security Advisory dla-4117. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-4117 : atop - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has a package installed that is affected by a vulnerability as referenced in the dla-4117
advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/atop");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2025-31160");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bullseye/atop");
  script_set_attribute(attribute:"solution", value:
"Upgrade the atop packages.");
  ...
  script_set_attribute(attribute:"patch_publication_date", value:"2025/04/06");
  script_set_attribute(attribute:"plugin_publication_date", value:"2025/04/06");

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:atop");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'atop', 'reference': '2.6.0-2+deb11u1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'atop');
}
