...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.2.0 : policycoreutils (EulerOS-SA-2021-1395)");
...
is affected by the following vulnerability :
  ...
  - Context relabeling of filesystems is vulnerable to
    ...
    enable (permissive or enforcing)(CVE-2018-1063)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1395
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b721ea44");
...
pkgs = ["policycoreutils-2.5-22.h2",
        "policycoreutils-newrole-2.5-22.h2",
        "policycoreutils-python-2.5-22.h2"];
