...
# extracted from Red Hat Security Advisory RHSA-2023:5193. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:5193");

  script_name(english:"RHEL 8 : dbus (RHSA-2023:5193)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for dbus.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2023:5193 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_5193.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6335b749");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2213166");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:5193");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL dbus package based on the guidance in RHSA-2023:5193.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'dbus-1.12.8-18.el8_6.3', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'dbus-common-1.12.8-18.el8_6.3', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'dbus-daemon-1.12.8-18.el8_6.3', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'dbus-devel-1.12.8-18.el8_6.3', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'dbus-libs-1.12.8-18.el8_6.3', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'dbus-tools-1.12.8-18.el8_6.3', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'dbus-x11-1.12.8-18.el8_6.3', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
