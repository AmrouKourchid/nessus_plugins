...
# extracted from Fedora Security Advisory FEDORA-2024-8eff1bffb1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-8eff1bffb1");

  script_name(english:"Fedora 39 : dotnet8.0 (2024-8eff1bffb1)");
...
FEDORA-2024-8eff1bffb1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-8eff1bffb1");
...
var pkgs = [
    {'reference':'dotnet8.0-8.0.108-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
