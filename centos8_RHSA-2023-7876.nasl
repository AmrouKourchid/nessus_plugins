...
# Red Hat Security Advisory RHSA-2023:7876. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : opensc (CESA-2023:7876)");
...
var pkgs = [
    {'reference':'opensc-0.20.0-7.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'opensc-0.20.0-7.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
