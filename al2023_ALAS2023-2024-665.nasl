...
# extracted from Amazon Linux 2023 Security Advisory ALAS2023-2024-665.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2023 : bpftool, kernel, kernel-devel (ALAS2023-2024-665)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2023 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"It is, therefore, affected by multiple vulnerabilities as referenced in the ALAS2023-2024-665 advisory.

    2024-08-14: CVE-2024-42063 was added to this advisory.

    2024-08-14: CVE-2024-41009 was added to this advisory.

    2024-08-14: CVE-2024-42070 was added to this advisory.

    2024-08-14: CVE-2024-42096 was added to this advisory.

    2024-08-14: CVE-2024-41092 was added to this advisory.

    2024-08-14: CVE-2024-42068 was added to this advisory.

    2024-08-14: CVE-2024-42090 was added to this advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2023/ALAS-2024-665.html");
...
if (get_one_kb_item("Host/kpatch/kernel-cves"))
{
  ...
  var cve_list = make_list("CVE-2024-27397", "CVE-2024-41009", "CVE-2024-41092", "CVE-2024-42063", "CVE-2024-42068", "CVE-2024-42070", "CVE-2024-42090", "CVE-2024-42096");
  if (hotfix_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, "kpatch hotfix for ALAS2023-2024-665");
  }
  else
  {
