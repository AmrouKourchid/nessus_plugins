...
# extracted from Gentoo Linux Security Advisory GLSA 201904-04.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201904-04");

  script_name(english:"GLSA-201904-04 : Poppler: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-201904-04
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/201904-04");
...
if (qpkg_check(package:"app-text/poppler", unaffected:make_list("ge 0.70.0"), vulnerable:make_list("lt 0.70.0"))) flag++;
