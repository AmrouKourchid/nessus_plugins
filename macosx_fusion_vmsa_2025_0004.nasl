...
if (description)
{
  ...
  script_name(english:"VMware Fusion 13.x < 13.6.3 HGFS Information Disclosure (VMSA-2025-0004)");
...
"The version of VMware Fusion installed on the remote macOS host is 13.x prior to 13.6.3. It is, therefore, affected by
...
"Update to VMware Fusion version 13.6.3, or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-22226");
...
var constraints = [
  { 'min_version' : '13.0', 'fixed_version' : '13.6.3' }
];
