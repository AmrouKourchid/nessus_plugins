...
# extracted from Ubuntu Security Notice USN-6639-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6639-1");

  script_name(english:"Ubuntu 22.04 LTS : Linux kernel (OEM) vulnerabilities (USN-6639-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6639-1");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2024-22705");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-6.1.0-1033-oem");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-6639-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2023-6121', 'CVE-2023-6531', 'CVE-2023-6622', 'CVE-2023-6932', 'CVE-2023-51780', 'CVE-2023-51781', 'CVE-2023-51782', 'CVE-2024-0565', 'CVE-2024-0607', 'CVE-2024-0646', 'CVE-2024-22705');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-6639-1');
  }
  else
  {
