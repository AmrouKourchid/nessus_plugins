...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Gnutls PHSA-2022-4.0-0240");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'gnutls-3.7.1-4.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'gnutls-devel-3.7.1-4.ph4')) flag++;
