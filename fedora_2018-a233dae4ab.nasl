...
# extracted from Fedora Security Advisory FEDORA-2018-a233dae4ab.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 26 : 1:tomcat (2018-a233dae4ab)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-a233dae4ab");
...
flag = 0;
if (rpm_check(release:"FC26", reference:"tomcat-8.0.50-1.fc26", epoch:"1")) flag++;
