...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : uboot-tools (EulerOS-SA-2025-1047)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1047
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b9605388");
...
var pkgs = [
  "uboot-tools-2018.09-8.h8.eulerosv2r9",
  "uboot-tools-help-2018.09-8.h8.eulerosv2r9"
];
