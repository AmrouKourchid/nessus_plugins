...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : openjpeg2 (EulerOS-SA-2024-2835)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2835
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?12d53a39");
...
var pkgs = [
  "openjpeg2-2.3.1-2.h10.eulerosv2r9"
];
