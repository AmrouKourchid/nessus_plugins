...
# extracted from Fedora Security Advisory FEDORA-2023-541c04817f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-541c04817f");

  script_name(english:"Fedora 37 : ImageMagick (2023-541c04817f)");
...
FEDORA-2023-541c04817f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-541c04817f");
...
var pkgs = [
    {'reference':'ImageMagick-6.9.12.86-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
