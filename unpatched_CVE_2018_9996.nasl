...
if (description)
{
  ...
  script_cve_id("CVE-2018-9996");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2018-9996");
...
patch available.
  ...
  - An issue was discovered in cplus-dem.c in GNU libiberty, as distributed in GNU Binutils 2.30. Stack
    Exhaustion occurs in the C++ demangling functions provided by libiberty, and there are recursive stack
    frames: demangle_template_value_parm, demangle_integral_value, and demangle_expression. (CVE-2018-9996)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-9996");
