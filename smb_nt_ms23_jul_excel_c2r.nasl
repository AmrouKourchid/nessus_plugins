...
if (description)
{
  ...
  script_cve_id("CVE-2023-33158", "CVE-2023-33161", "CVE-2023-33162");
  script_xref(name:"IAVA", value:"2023-A-0341-S");

  script_name(english:"Security Updates for Microsoft Excel Products C2R (July 2023)");
...
follows:
  ...
  - Two remote code execution vulnerabilities. (CVE-2023-33161, CVE-2023-33158)

  - An information disclosure vulnerability. (CVE-2023-33162)
