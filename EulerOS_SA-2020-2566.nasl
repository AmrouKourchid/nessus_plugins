...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : taglib (EulerOS-SA-2020-2566)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the version of the taglib package installed, the EulerOS
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2566
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?92ec7ae5");
  script_set_attribute(attribute:"solution", value:
"Update the affected taglib package.");
...
pkgs = ["taglib-1.8-7.20130218git.h1.eulerosv2r7"];
