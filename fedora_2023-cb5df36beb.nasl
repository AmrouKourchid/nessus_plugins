...
# extracted from Fedora Security Advisory FEDORA-2023-cb5df36beb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-cb5df36beb");
  script_xref(name:"IAVA", value:"2023-A-0121-S");

  script_name(english:"Fedora 36 : sudo (2023-cb5df36beb)");
...
FEDORA-2023-cb5df36beb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-cb5df36beb");
...
var pkgs = [
    {'reference':'sudo-1.9.13-1.p2.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
