...
if (description)
{
  ...
  script_name(english:"Canonical Ubuntu Linux SEoL (7.10.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Canonical Ubuntu Linux is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Canonical Ubuntu Linux is 7.10.x. It is, therefore, no longer maintained by its vendor or
provider.

Lack of support implies that no new security patches for the product will be released by the vendor. As a result, it may
contain security vulnerabilities.");
  # https://web.archive.org/web/20090326001959/https://ubuntu.com/news/ubuntu-7.10-eol
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fd9447e6");
...
"Upgrade to a version of Canonical Ubuntu Linux that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2009/04/18");
...
var constraints = [
  { max_branch : '7.10', min_branch : '7.10', seol : 20090418 }
];
