...
# extracted from Fedora Security Advisory FEDORA-2023-fa01e4c6ba
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-fa01e4c6ba");
  script_xref(name:"IAVB", value:"2023-B-0090-S");

  script_name(english:"Fedora 39 : xen (2023-fa01e4c6ba)");
...
FEDORA-2023-fa01e4c6ba advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-fa01e4c6ba");
...
var pkgs = [
    {'reference':'xen-4.17.2-5.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
