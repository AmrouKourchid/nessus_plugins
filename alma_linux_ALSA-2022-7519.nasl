...
# AlmaLinux Security Advisory ALSA-2022:7519.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2022:7519");
  script_xref(name:"IAVB", value:"2022-B-0025-S");

  script_name(english:"AlmaLinux 8 : grafana (ALSA-2022:7519)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2022-7519.html");
