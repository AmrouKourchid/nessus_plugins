...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : vim (EulerOS-SA-2025-1542)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1542
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ca4252a8");
...
"Update the affected vim packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2025-24014");
...
var pkgs = [
  "vim-common-9.0-1.h22.r3.eulerosv2r10",
  "vim-enhanced-9.0-1.h22.r3.eulerosv2r10",
  "vim-filesystem-9.0-1.h22.r3.eulerosv2r10",
  "vim-minimal-9.0-1.h22.r3.eulerosv2r10"
];
