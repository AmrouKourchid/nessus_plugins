...
# extracted from Debian Security Advisory dla-4127. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-4127 : libapache2-mod-svn - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has packages installed that are affected by a vulnerability as referenced in the dla-4127
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-46901");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bullseye/subversion");
  script_set_attribute(attribute:"solution", value:
"Upgrade the libapache2-mod-svn packages.");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'libapache2-mod-svn', 'reference': '1.14.1-3+deb11u2'},
    {'release': '11.0', 'prefix': 'libsvn-dev', 'reference': '1.14.1-3+deb11u2'},
    {'release': '11.0', 'prefix': 'libsvn-doc', 'reference': '1.14.1-3+deb11u2'},
    {'release': '11.0', 'prefix': 'libsvn-java', 'reference': '1.14.1-3+deb11u2'},
    {'release': '11.0', 'prefix': 'libsvn-perl', 'reference': '1.14.1-3+deb11u2'},
    {'release': '11.0', 'prefix': 'libsvn1', 'reference': '1.14.1-3+deb11u2'},
    {'release': '11.0', 'prefix': 'python3-subversion', 'reference': '1.14.1-3+deb11u2'},
    {'release': '11.0', 'prefix': 'ruby-svn', 'reference': '1.14.1-3+deb11u2'},
    {'release': '11.0', 'prefix': 'subversion', 'reference': '1.14.1-3+deb11u2'},
    {'release': '11.0', 'prefix': 'subversion-tools', 'reference': '1.14.1-3+deb11u2'}
];
