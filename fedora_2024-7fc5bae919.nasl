...
# extracted from Fedora Security Advisory FEDORA-2024-7fc5bae919
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-7fc5bae919");

  script_name(english:"Fedora 39 : mingw-openexr (2024-7fc5bae919)");
...
FEDORA-2024-7fc5bae919 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-7fc5bae919");
  script_set_attribute(attribute:"solution", value:
"Update the affected mingw-openexr package.");
...
var pkgs = [
    {'reference':'mingw-openexr-3.1.10-4.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
