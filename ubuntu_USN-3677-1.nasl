...
# extracted from Ubuntu Security Notice USN-3677-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 17.10 : Linux kernel vulnerabilities (USN-3677-1)");
...
It was discovered that the 802.11 software simulator implementation in
the Linux kernel contained a memory leak when handling certain error
conditions. A local attacker could possibly use this to cause a denial
of service (memory exhaustion). (CVE-2018-8087)
...
without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://usn.ubuntu.com/3677-1/");
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  cve_list = make_list("CVE-2018-1068", "CVE-2018-1092", "CVE-2018-7492", "CVE-2018-8087", "CVE-2018-8781");
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for USN-3677-1");
  }
  else
  {
...
if (ubuntu_check(osver:"17.10", pkgname:"linux-image-4.13.0-1022-raspi2", pkgver:"4.13.0-1022.23")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"linux-image-4.13.0-45-generic", pkgver:"4.13.0-45.50")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"linux-image-4.13.0-45-generic-lpae", pkgver:"4.13.0-45.50")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"linux-image-4.13.0-45-lowlatency", pkgver:"4.13.0-45.50")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"linux-image-generic", pkgver:"4.13.0.45.48")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"linux-image-generic-lpae", pkgver:"4.13.0.45.48")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"linux-image-lowlatency", pkgver:"4.13.0.45.48")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"linux-image-raspi2", pkgver:"4.13.0.1022.20")) flag++;
