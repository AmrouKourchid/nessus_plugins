...
# extracted from Red Hat Security Advisory RHSA-2024:3341. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:3341");

  script_name(english:"RHEL 8 : gdk-pixbuf2 (RHSA-2024:3341)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for gdk-pixbuf2.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:3341 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_3341.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bcf51537");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2260545");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:3341");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL gdk-pixbuf2 package based on the guidance in RHSA-2024:3341.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gdk-pixbuf2-2.36.12-6.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gdk-pixbuf2-devel-2.36.12-6.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gdk-pixbuf2-modules-2.36.12-6.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gdk-pixbuf2-xlib-2.36.12-6.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gdk-pixbuf2-xlib-devel-2.36.12-6.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
