...
if (description)
{
  ...
  script_name(english:"Canonical Ubuntu Linux SEoL (16.10.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Canonical Ubuntu Linux is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Canonical Ubuntu Linux is 16.10.x. It is, therefore, no longer maintained by its vendor or
provider.
...
contain security vulnerabilities.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5dbf8e96");
...
"Upgrade to a version of Canonical Ubuntu Linux that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2017/07/20");
...
var constraints = [
  { max_branch : '16.10', min_branch : '16.10', seol : 20170720 }
];
