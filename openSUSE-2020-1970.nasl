...
Updating tor to a newer version in the respective codestream.
  ...
  - Fix logrotate to not fail when tor is stopped
    (boo#1164275)");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1164275");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1173979");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1178741");
...
"Update the affected tor packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2020-15572");
