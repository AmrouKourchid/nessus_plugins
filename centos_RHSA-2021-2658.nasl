...
# extracted from Red Hat Security Advisory RHSA-2021:2658 and
# CentOS Errata and Security Advisory 2021:2658 respectively.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : linuxptp (RHSA-2021:2658)");
...
var pkgs = [
    {'reference':'linuxptp-2.0-2.el7', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'linuxptp-2.0-2.el7', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE}
];
