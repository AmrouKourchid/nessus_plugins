...
# extracted from Fedora Security Advisory FEDORA-2023-edb2509e26
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-edb2509e26");
  script_xref(name:"IAVA", value:"2023-A-0284-S");

  script_name(english:"Fedora 38 : thunderbird (2023-edb2509e26)");
...
FEDORA-2023-edb2509e26 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-edb2509e26");
...
var pkgs = [
    {'reference':'thunderbird-102.12.0-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
