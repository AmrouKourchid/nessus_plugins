...
# extracted from openSUSE Security Update openSUSE-2018-794.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : bouncycastle (openSUSE-2018-794)");
...
Security issue fixed :
  ...
  - CVE-2018-1000613: Fix use of Externally-Controlled Input
    ...
    (boo#1100694).");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1100694");
...
if ( rpm_check(release:"SUSE42.3", reference:"bouncycastle-1.60-23.7.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"bouncycastle-javadoc-1.60-23.7.1") ) flag++;
