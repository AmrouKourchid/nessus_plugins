...
if (description)
{
  ...
  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2025-1713");
...
patch available.
  ...
  - deadlock potential with VT-d and legacy PCI device pass-through [XSA-467, CVE-2025-1713] (CVE-2025-1713)
