...
if (description)
{
  ...
  script_cve_id("CVE-2018-6356", "CVE-2018-1000068");
  script_bugtraq_id(103037, 103101, 103209);

  script_name(english:"Jenkins < 2.89.4 / 2.107 Multiple Vulnerabilities");
...
2.107 or is a version of Jenkins LTS prior to 2.89.4. It is, therefore,
...
"Upgrade Jenkins to version 2.107 or later, Jenkins LTS to version
2.89.4 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-1000068");
...
var constraints = [
  { 'fixed_version' : '2.107',  'edition' : 'Open Source' },
  { 'fixed_version' : '2.89.4', 'edition' : 'Open Source LTS' }
];
