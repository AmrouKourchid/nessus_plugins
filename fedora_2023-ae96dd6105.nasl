...
# extracted from Fedora Security Advisory FEDORA-2023-ae96dd6105
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-ae96dd6105");

  script_name(english:"Fedora 37 : pcs (2023-ae96dd6105)");
...
FEDORA-2023-ae96dd6105 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-ae96dd6105");
...
var pkgs = [
    {'reference':'pcs-0.11.6-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
