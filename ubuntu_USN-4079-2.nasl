...
# extracted from Ubuntu Security Notice USN-4079-2. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"4079-2");

  script_name(english:"Ubuntu 18.04 LTS : SoX vulnerabilities (USN-4079-2)");
...
the USN-4079-2 advisory.

    USN-4079-1 fixed vulnerabilities in SoX. This update provides the corresponding update for Ubuntu 18.04
    LTS and Ubuntu 19.04.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4079-2");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'libsox-dev', 'pkgver': '14.4.2-3ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'libsox-fmt-all', 'pkgver': '14.4.2-3ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'libsox-fmt-alsa', 'pkgver': '14.4.2-3ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'libsox-fmt-ao', 'pkgver': '14.4.2-3ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'libsox-fmt-base', 'pkgver': '14.4.2-3ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'libsox-fmt-mp3', 'pkgver': '14.4.2-3ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'libsox-fmt-oss', 'pkgver': '14.4.2-3ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'libsox-fmt-pulse', 'pkgver': '14.4.2-3ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'libsox3', 'pkgver': '14.4.2-3ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'sox', 'pkgver': '14.4.2-3ubuntu0.18.04.1'}
];
