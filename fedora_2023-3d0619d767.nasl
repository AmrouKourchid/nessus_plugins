...
# extracted from Fedora Security Advisory FEDORA-2023-3d0619d767
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-3d0619d767");

  script_name(english:"Fedora 38 : amanda (2023-3d0619d767)");
...
FEDORA-2023-3d0619d767 advisory.

    Update to version 3.5.3, which contains fixes for three minor security issues as well as other minor
    bugfixes.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-3d0619d767");
...
"Update the affected amanda package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:amanda");
...
var pkgs = [
    {'reference':'amanda-3.5.3-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
