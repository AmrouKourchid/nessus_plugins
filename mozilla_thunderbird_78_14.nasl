...
"The version of Thunderbird installed on the remote Windows host is prior to 78.14. It is, therefore, affected by
multiple vulnerabilities as referenced in the mfsa2021-42 advisory.
...
mozilla_check_version(installs:installs, product:'thunderbird', esr:FALSE, fix:'78.14', severity:SECURITY_WARNING);
