...
# extracted from Red Hat Security Advisory RHSA-2024:1876. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:1876");

  script_name(english:"RHEL 9 : shim  update (Important) (RHSA-2024:1876)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:1876 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_1876.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8fa5e304");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:1876");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'shim-aa64-15.8-3.el9_2', 'sp':'2', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'shim-x64-15.8-3.el9_2', 'sp':'2', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
