...
if (description)
{
  ...
  script_cve_id("CVE-2022-49502");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-49502");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: media: rga: fix possible memory leak
    in rga_probe rga->m2m_dev needs to be freed when rga_probe fails. (CVE-2022-49502)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-49502");
