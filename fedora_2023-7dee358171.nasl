...
# extracted from Fedora Security Advisory FEDORA-2023-7dee358171
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-7dee358171");
  script_xref(name:"IAVA", value:"2023-A-0702-S");

  script_name(english:"Fedora 39 : thunderbird (2023-7dee358171)");
...
FEDORA-2023-7dee358171 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-7dee358171");
...
var pkgs = [
    {'reference':'thunderbird-115.6.0-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
