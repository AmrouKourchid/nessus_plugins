...
# extracted from Fedora Security Advisory FEDORA-2021-013d9a30e0
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-013d9a30e0");

  script_name(english:"Fedora 33 : 1:xpdf (2021-013d9a30e0)");
...
FEDORA-2021-013d9a30e0 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-013d9a30e0");
...
pkgs = [
    {'reference':'xpdf-4.03-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
