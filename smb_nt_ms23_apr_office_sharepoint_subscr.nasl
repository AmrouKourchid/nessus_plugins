...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5002375");
  script_xref(name:"MSFT", value:"MS23-5002375");
...
It is, therefore, affected by a Sharepoint server spoofing vulnerability.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002375");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released KB5002375 to address this issue.");
