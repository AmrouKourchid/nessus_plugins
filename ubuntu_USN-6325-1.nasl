...
# extracted from Ubuntu Security Notice USN-6325-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6325-1");

  script_name(english:"Ubuntu 20.04 LTS / 22.04 LTS : Linux kernel vulnerabilities (USN-6325-1)");
...
referenced in the USN-6325-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6325-1");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-6325-1');
}
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-6325-1');
  }
  else
  {
