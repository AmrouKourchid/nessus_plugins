...
# extracted from Debian Security Advisory DLA-2185-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2185-1 : eog security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2020/04/msg00018.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/jessie/eog");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"eog", reference:"3.14.1-1+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"eog-dbg", reference:"3.14.1-1+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"eog-dev", reference:"3.14.1-1+deb8u1")) flag++;
