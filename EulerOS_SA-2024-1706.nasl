...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : shim (EulerOS-SA-2024-1706)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1706
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e00a3378");
...
var pkgs = [
  "shim-aa64-15-7.h14.eulerosv2r8"
];
