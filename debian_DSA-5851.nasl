...
# extracted from Debian Security Advisory dsa-5851. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5851 : pdns-recursor - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 12 host has a package installed that is affected by a vulnerability as referenced in the dsa-5851
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-25590");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'pdns-recursor', 'reference': '4.8.8-1+deb12u1'}
];
