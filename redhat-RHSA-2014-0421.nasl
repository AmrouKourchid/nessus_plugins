...
referenced in the RHSA-2014:0421 advisory.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2014/rhsa-2014_0421.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?33d5f307");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2014:0421");
...
"Update the RHEL qemu-kvm-rhev package based on the guidance in RHSA-2014:0421.");
  ...
  script_cwe_id(119, 190, 20, 369, 476);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'qemu-img-rhev-0.12.1.2-2.415.el6_5.8', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ovirt-'},
      {'reference':'qemu-kvm-rhev-0.12.1.2-2.415.el6_5.8', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ovirt-'},
      {'reference':'qemu-kvm-rhev-tools-0.12.1.2-2.415.el6_5.8', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ovirt-'}
    ]
  }
];
