...
if (description)
{
  ...
  script_cve_id("CVE-2023-36841");
  script_xref(name:"JSA", value:"JSA73172");
  script_xref(name:"IAVA", value:"2023-A-0565");

  script_name(english:"Juniper Junos OS Vulnerability (JSA73172)");

  script_set_attribute(attribute:"synopsis", value:
"The remote device is missing a vendor-supplied security patch.");
  script_set_attribute(attribute:"description", value:
"The version of Junos OS installed on the remote host is affected by a vulnerability as referenced in the JSA73172
advisory.

  - An Improper Check for Unusual or Exceptional Conditions vulnerability in the Packet Forwarding Engine
    (pfe) of Juniper Networks Junos OS on MX Series allows a unauthenticated network-based attacker to cause
    an infinite loop, resulting in a Denial of Service (DoS). (CVE-2023-36841)
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e1808598");
  script_set_attribute(attribute:"solution", value:
"Apply the relevant Junos software release referenced in Juniper advisory JSA73172");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:N/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-36841");
...
var vuln_ranges = [
  {'min_ver':'0.0', 'fixed_ver':'20.4R3-S7', 'model':'^MX'},
  {'min_ver':'21.1', 'fixed_ver':'21.1R1', 'model':'^MX'},
  {'min_ver':'21.2', 'fixed_ver':'21.2R3-S6', 'model':'^MX'},
  ...
  {'min_ver':'22.3', 'fixed_ver':'22.3R2-S2', 'model':'^MX'},
