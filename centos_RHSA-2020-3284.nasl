...
# extracted from Red Hat Security Advisory RHSA-2020:3284 and
# CentOS Errata and Security Advisory 2020:3284 respectively.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : postgresql-jdbc (RHSA-2020:3284)");
...
var pkgs = [
    {'reference':'postgresql-jdbc-8.4.704-4.el6_10', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE}
];
