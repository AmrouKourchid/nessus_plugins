...
# AlmaLinux Security Advisory ALSA-2023:4202.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:4202");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2023/07/14");

  script_name(english:"AlmaLinux 8 : webkit2gtk3 (ALSA-2023:4202)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ALSA-2023:4202 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2023-4202.html");
...
var pkgs = [
    {'reference':'webkit2gtk3-2.38.5-1.el8_8.5.alma', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'webkit2gtk3-devel-2.38.5-1.el8_8.5.alma', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'webkit2gtk3-jsc-2.38.5-1.el8_8.5.alma', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'webkit2gtk3-jsc-devel-2.38.5-1.el8_8.5.alma', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
