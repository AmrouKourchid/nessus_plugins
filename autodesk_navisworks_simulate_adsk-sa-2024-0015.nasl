...
if (description)
{
  ...
  script_name(english:"Autodesk Navisworks Simulate 25.0.x < 25.0.999.0 (2025.3) Multiple Vulnerabilities (adsk-sa-2024-0015)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The version of Autodesk Navisworks Simulate installed on the remote host is prior to 25.0.999.0 (2025.3). It is,
...
"Upgrade to Autodesk Navisworks Simulate version 25.0.999.0 (2025.3) or later.");
  ...
  script_set_attribute(attribute:"cpe", value:"x-cpe:/a:autodesk:navisworks_simulate");
  ...
  script_dependencies("autodesk_navisworks_simulate_win_installed.nbin");
  script_require_keys("installed_sw/Autodesk Navisworks Simulate");
...
var app_info = vcf::autodesk::navisworks::get_app_info(type:'Simulate');
