...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : ghostscript (EulerOS-SA-2018-1430)");
...
vulnerabilities :
  ...
  - ghostscript: /invalidaccess bypass after failed
    restore.(CVE-2018-16509)

  - ghostscript: LockDistillerParams type
    confusion.(CVE-2018-15910)

  - ghostscript: definemodifiedfont memory corruption if
    /typecheck is handled.(CVE-2018-16542)
  ...
  - ghostscript: incorrect free logic in pagedevice
    replacement.(CVE-2018-16541)

  - ghostscript:se-after-free in copydevice
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1430
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?651fd502");
...
"Update the affected ghostscript packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2018-16543");
...
pkgs = ["ghostscript-9.07-29.2.h3",
        "ghostscript-cups-9.07-29.2.h3"];
