...
# extracted from Red Hat Security Advisory RHSA-2014:0793. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2014:0793");

  script_name(english:"RHEL 5 / 6 : Red Hat JBoss Enterprise Application Platform 5.2.0 (RHSA-2014:0793)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for Red Hat JBoss Enterprise Application Platform 5.2.0.");
...
in the RHSA-2014:0793 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2014/rhsa-2014_0793.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fb7d89e6");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2014:0793");
...
"Update the RHEL Red Hat JBoss Enterprise Application Platform 5.2.0 package based on the guidance in RHSA-2014:0793.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jboss-seam2-2.2.6.EAP5-12.ep5.el5', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap5'},
      {'reference':'jboss-seam2-docs-2.2.6.EAP5-12.ep5.el5', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap5'},
      {'reference':'jboss-seam2-examples-2.2.6.EAP5-12.ep5.el5', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap5'},
      {'reference':'jboss-seam2-runtime-2.2.6.EAP5-12.ep5.el5', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap5'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'jboss-seam2-2.2.6.EAP5-16.el6_5', 'release':'6', 'el_string':'el6_5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap5'},
      {'reference':'jboss-seam2-docs-2.2.6.EAP5-16.el6_5', 'release':'6', 'el_string':'el6_5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap5'},
      {'reference':'jboss-seam2-examples-2.2.6.EAP5-16.el6_5', 'release':'6', 'el_string':'el6_5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap5'},
      {'reference':'jboss-seam2-runtime-2.2.6.EAP5-16.el6_5', 'release':'6', 'el_string':'el6_5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap5'}
    ]
  }
];
