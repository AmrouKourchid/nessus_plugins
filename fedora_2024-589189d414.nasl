...
# extracted from Fedora Security Advisory FEDORA-2024-589189d414
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-589189d414");

  script_name(english:"Fedora 40 : rpm-ostree (2024-589189d414)");
...
FEDORA-2024-589189d414 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-589189d414");
...
var pkgs = [
    {'reference':'rpm-ostree-2024.4-5.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
