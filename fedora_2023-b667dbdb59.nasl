...
# extracted from Fedora Security Advisory FEDORA-2023-b667dbdb59
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-b667dbdb59");

  script_name(english:"Fedora 37 : mingw-binutils (2023-b667dbdb59)");
...
FEDORA-2023-b667dbdb59 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-b667dbdb59");
...
var pkgs = [
    {'reference':'mingw-binutils-2.38-8.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
