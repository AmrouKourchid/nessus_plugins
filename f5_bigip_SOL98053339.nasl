...
# extracted from F5 Networks BIG-IP Solution K98053339.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2019-9512");
  script_xref(name:"CEA-ID", value:"CEA-2019-0643");

  script_name(english:"F5 Networks BIG-IP : HTTP/2 Ping Flood vulnerability (K98053339)");
...
another system in the device group.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K98053339");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K98053339.");
