...
# extracted from Fedora Security Advisory FEDORA-2025-1de066b8af
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-1de066b8af");

  script_name(english:"Fedora 41 : git-lfs (2025-1de066b8af)");
...
FEDORA-2025-1de066b8af advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-1de066b8af");
...
"Update the affected git-lfs package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:git-lfs");
...
var pkgs = [
    {'reference':'git-lfs-3.6.1-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
