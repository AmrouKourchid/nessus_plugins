...
# extracted from Ubuntu Security Notice USN-7091-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"7091-1");

  script_name(english:"Ubuntu 22.04 LTS / 24.04 LTS / 24.10 : Ruby vulnerabilities (USN-7091-1)");
...
vulnerabilities as referenced in the USN-7091-1 advisory.
    ...
    resulting in a denial of service. This issue only affected in Ubuntu 22.04 LTS and Ubuntu 24.04 LTS.
    (CVE-2024-35176, CVE-2024-39908, CVE-2024-41123)

    It was discovered that Ruby incorrectly handled parsing of an XML document that has many entity expansions
    with SAX2 or pull parser API. An attacker could use this issue to cause Ruby to crash, resulting in a
    denial of service. (CVE-2024-41946)

    It was discovered that Ruby incorrectly handled parsing of an XML document that has many digits in a hex
    numeric character reference. An attacker could use this issue to cause Ruby to crash, resulting in a
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7091-1");
...
var pkgs = [
    {'osver': '22.04', 'pkgname': 'libruby3.0', 'pkgver': '3.0.2-7ubuntu2.8'},
    {'osver': '22.04', 'pkgname': 'ruby3.0', 'pkgver': '3.0.2-7ubuntu2.8'},
    {'osver': '22.04', 'pkgname': 'ruby3.0-dev', 'pkgver': '3.0.2-7ubuntu2.8'},
    {'osver': '24.04', 'pkgname': 'libruby3.2', 'pkgver': '3.2.3-1ubuntu0.24.04.3'},
    {'osver': '24.04', 'pkgname': 'ruby3.2', 'pkgver': '3.2.3-1ubuntu0.24.04.3'},
    {'osver': '24.04', 'pkgname': 'ruby3.2-dev', 'pkgver': '3.2.3-1ubuntu0.24.04.3'},
    {'osver': '24.10', 'pkgname': 'libruby3.3', 'pkgver': '3.3.4-2ubuntu5.1'},
    {'osver': '24.10', 'pkgname': 'ruby3.3', 'pkgver': '3.3.4-2ubuntu5.1'},
    {'osver': '24.10', 'pkgname': 'ruby3.3-dev', 'pkgver': '3.3.4-2ubuntu5.1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libruby3.0 / libruby3.2 / libruby3.3 / ruby3.0 / ruby3.0-dev / etc');
}
