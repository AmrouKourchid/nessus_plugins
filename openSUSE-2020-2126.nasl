...
# extracted from openSUSE Security Update openSUSE-2020-2126.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libssh2_org (openSUSE-2020-2126)");
...
"This update for libssh2_org fixes the following issues :
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1178083");
...
if ( rpm_check(release:"SUSE15.1", reference:"libssh2-1-1.9.0-lp151.6.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libssh2-1-debuginfo-1.9.0-lp151.6.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libssh2-devel-1.9.0-lp151.6.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libssh2_org-debugsource-1.9.0-lp151.6.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libssh2-1-32bit-1.9.0-lp151.6.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libssh2-1-32bit-debuginfo-1.9.0-lp151.6.6.1") ) flag++;
