...
# extracted from Ubuntu Security Notice USN-3183-2. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : GnuTLS vulnerability (USN-3183-2)");
...
USN-3183-2 advisory.
    ...
    USN-3183-1 fixed CVE-2016-8610 in GnuTLS in Ubuntu 16.04 LTS and Ubuntu 16.10. This update provides the
    corresponding update for Ubuntu 12.04 LTS and Ubuntu 14.04 LTS.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3183-2");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'gnutls-bin', 'pkgver': '3.0.11+really2.12.23-12ubuntu2.7'},
    {'osver': '14.04', 'pkgname': 'libgnutls-dev', 'pkgver': '2.12.23-12ubuntu2.7'},
    {'osver': '14.04', 'pkgname': 'libgnutls-openssl27', 'pkgver': '2.12.23-12ubuntu2.7'},
    {'osver': '14.04', 'pkgname': 'libgnutls26', 'pkgver': '2.12.23-12ubuntu2.7'},
    {'osver': '14.04', 'pkgname': 'libgnutlsxx27', 'pkgver': '2.12.23-12ubuntu2.7'}
];
