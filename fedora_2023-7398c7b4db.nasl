...
# extracted from Fedora Security Advisory FEDORA-2023-7398c7b4db
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-7398c7b4db");

  script_name(english:"Fedora 39 : golang-github-macaron-inject (2023-7398c7b4db)");
...
FEDORA-2023-7398c7b4db advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-7398c7b4db");
...
"Update the affected golang-github-macaron-inject package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:golang-github-macaron-inject");
...
var pkgs = [
    {'reference':'golang-github-macaron-inject-0-0.19.20210110git138e592.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'golang-github-macaron-inject');
}
