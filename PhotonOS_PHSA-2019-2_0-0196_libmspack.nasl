...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Libmspack PHSA-2019-2.0-0196");
...
if (rpm_exists(rpm:'libmspack-0.7', release:'PhotonOS-2.0') && rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libmspack-0.7.1alpha-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libmspack-debuginfo-0.7.1alpha-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libmspack-devel-0.7.1alpha-1.ph2')) flag++;
