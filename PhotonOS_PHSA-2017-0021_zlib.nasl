...
if (description)
{
  ...
  script_cve_id("CVE-2016-9841", "CVE-2016-9843");

  script_name(english:"Photon OS 1.0: Zlib PHSA-2017-0021");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the zlib package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-51.md");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'zlib-1.2.8-5.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'zlib-debuginfo-1.2.8-5.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'zlib-devel-1.2.8-5.ph1')) flag++;
