...
# extracted from Fedora Security Advisory FEDORA-2023-97eea79acb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-97eea79acb");
  script_xref(name:"IAVA", value:"2023-A-0522-S");

  script_name(english:"Fedora 38 : firefox (2023-97eea79acb)");
...
FEDORA-2023-97eea79acb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-97eea79acb");
...
var pkgs = [
    {'reference':'firefox-118.0.1-4.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
