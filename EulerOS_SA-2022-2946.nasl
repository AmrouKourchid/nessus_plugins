...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : sqlite (EulerOS-SA-2022-2946)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2946
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4061466d");
...
var pkgs = [
  "sqlite-3.32.3-2.h7.eulerosv2r10"
];
