...
# extracted from Red Hat Security Advisory RHSA-2023:3541. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2022-2995", "CVE-2023-30861");
  script_xref(name:"RHSA", value:"2023:3541");

  script_name(english:"RHEL 8 : OpenShift Container Platform 4.11.43 (RHSA-2023:3541)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for OpenShift Container Platform 4.11.43.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2023:3541 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.11.43. See the
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?76855fc1");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2121632");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_3541.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?25244673");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:3541");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.11.43 packages based on the guidance in RHSA-2023:3541.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python-flask-doc-1.1.2-6.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2023-30861']},
      {'reference':'python3-flask-1.1.2-6.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2023-30861']}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'cri-o-1.24.5-5.rhaos4.11.git8bf967b.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2022-2995']}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'cri-o / python-flask-doc / python3-flask');
}
