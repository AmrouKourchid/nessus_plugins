...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : curl (EulerOS-SA-2023-1379)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1379
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?26e89d00");
...
var pkgs = [
  "curl-7.71.1-4.h18.eulerosv2r10",
  "libcurl-7.71.1-4.h18.eulerosv2r10"
];
