...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : libxslt (EulerOS-SA-2025-1529)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the libxslt package installed, the EulerOS installation on the remote host is affected by
...
Tenable has extracted the preceding description block directly from the EulerOS libxslt security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1529
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a58192d0");
...
var pkgs = [
  "libxslt-1.1.34-3.h3.eulerosv2r10"
];
