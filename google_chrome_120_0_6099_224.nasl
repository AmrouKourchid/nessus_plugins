...
"The version of Google Chrome installed on the remote Windows host is prior to 120.0.6099.224. It is, therefore, affected
...
google_chrome_check_version(installs:installs, fix:'120.0.6099.224', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
