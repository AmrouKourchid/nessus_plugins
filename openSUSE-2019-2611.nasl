...
# extracted from openSUSE Security Update openSUSE-2019-2611.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libidn2 (openSUSE-2019-2611)");
...
This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1154884");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1154887");
...
if ( rpm_check(release:"SUSE15.1", reference:"libidn2-0-2.2.0-lp151.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libidn2-0-debuginfo-2.2.0-lp151.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libidn2-debugsource-2.2.0-lp151.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libidn2-devel-2.2.0-lp151.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libidn2-lang-2.2.0-lp151.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libidn2-tools-2.2.0-lp151.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libidn2-tools-debuginfo-2.2.0-lp151.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libidn2-0-32bit-2.2.0-lp151.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libidn2-0-32bit-debuginfo-2.2.0-lp151.3.3.1") ) flag++;
