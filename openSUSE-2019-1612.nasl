...
enigmail was updated to 2.0.10 :
  ...
  - UI fixes for dialogs, messages, and dark Thunderbird
    themes");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1135855");
...
if ( rpm_check(release:"SUSE15.1", reference:"enigmail-2.0.11-lp151.2.3.1") ) flag++;
