...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Samba PHSA-2023-3.0-0603");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'samba-client-4.17.8-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'samba-client-devel-4.17.8-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'samba-client-libs-4.17.8-1.ph3')) flag++;
