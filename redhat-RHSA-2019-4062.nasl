...
# extracted from Red Hat Security Advisory RHSA-2019:4062. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:4062");

  script_name(english:"RHEL 7 : python-jinja2 (RHSA-2019:4062)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_4062.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1a38ed82");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:4062");
...
"Update the RHEL python-jinja2 package based on the guidance in RHSA-2019:4062.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python-jinja2-2.7.2-3.el7_4', 'sp':'4', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
