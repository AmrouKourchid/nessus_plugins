...
# extracted from Fedora Security Advisory FEDORA-2024-529fe8a802
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-529fe8a802");

  script_name(english:"Fedora 38 : podman-tui (2024-529fe8a802)");
...
FEDORA-2024-529fe8a802 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-529fe8a802");
...
var pkgs = [
    {'reference':'podman-tui-1.0.0-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
