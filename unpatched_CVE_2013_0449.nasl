...
if (description)
{
  ...
  script_cve_id("CVE-2013-0449");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2013-0449");
...
patch available.
  ...
  - Unspecified vulnerability in the Java Runtime Environment (JRE) component in Oracle Java SE 7 through
    Update 11 allows remote attackers to affect confidentiality via unknown vectors related to Deployment.
    (CVE-2013-0449)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-0449");
