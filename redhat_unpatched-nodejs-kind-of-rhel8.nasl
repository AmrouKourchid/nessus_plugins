...
# extracted from Red Hat Security Advisory nodejs-kind-of. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2019-20149");

  script_name(english:"RHEL 8 : nodejs-kind-of (Unpatched Vulnerability) (deprecated)");
...
"This plugin has been deprecated as it does not adhere to established standards for this style of check.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-20149");
