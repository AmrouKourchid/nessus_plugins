...
"The remote Citrix ADC or Citrix Gateway device is version 12.1.x prior to 12.1-65.21, 12.1-FIPS, prior to 12.1-55.289,
13.0.x prior to 13.0-88.12 or 13.1.x prior to 13.1-33.47. It may, therefore, be affected by multiple vulnerabilities, as follows:
...
"For versions 12.1.x, 12.1-FIPS, 13.0.x and 13.1.x, upgrade to 12.1-65.21, 12.1.55.289-FIPS, 13.0-88.12 and 13.1-33.47, or later, respectively.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-27516");
...
if (app_info['fips_status'] == 1)
{
  if (preg(pattern:"^12.1.*", string:app_info['version']))
    constraints = [ {'min_version': '12.1', 'fixed_version': '12.1.55.289', 'fixed_display': '12.1.55.289 and later releases of 12.1-FIPS.'} ];
}
else
{
  constraints = [
