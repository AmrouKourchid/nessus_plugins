...
# extracted from Debian Security Advisory DSA-4907. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"4907");

  script_name(english:"Debian DSA-4907-1 : composer - security update");
...
execution."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/buster/composer"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2021/dsa-4907"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
flag = 0;
if (deb_check(release:"10.0", prefix:"composer", reference:"1.8.4-1+deb10u1")) flag++;
