...
# extracted from Fedora Security Advisory FEDORA-2023-dcf59d2db2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-dcf59d2db2");

  script_name(english:"Fedora 37 : dotnet6.0 (2023-dcf59d2db2)");
...
FEDORA-2023-dcf59d2db2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-dcf59d2db2");
...
var pkgs = [
    {'reference':'dotnet6.0-6.0.123-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
