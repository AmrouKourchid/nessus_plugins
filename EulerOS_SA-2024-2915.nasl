...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : syslinux (EulerOS-SA-2024-2915)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2915
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1f38338c");
...
var pkgs = [
  "syslinux-6.04-5.h5.eulerosv2r10",
  "syslinux-nonlinux-6.04-5.h5.eulerosv2r10"
];
