...
6.4.8, or 7.0.x through 7.0.5. It is, therefore, affected by a buffer overflow vulnerability. An authenticated, remote
attacker can exploit this issue, via the TFTP protocol with crafted CLI 'execute restore image' and 'execute certificate
remote' operations, to execute arbitrary code or commands in the system.
...
var constraints = [
  { 'min_version': '6.0', 'max_version' : '6.0.14', 'fixed_display' : '6.2.11 / 6.4.9 / 7.0.6 / 7.2.0' },
