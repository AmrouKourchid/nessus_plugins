...
# extracted from Fedora Security Advisory FEDORA-2022-105be2997e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-105be2997e");

  script_name(english:"Fedora 38 : mod_auth_openidc (2022-105be2997e)");
...
FEDORA-2022-105be2997e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-105be2997e");
...
var pkgs = [
    {'reference':'mod_auth_openidc-2.4.12.2-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
