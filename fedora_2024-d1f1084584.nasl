...
# extracted from Fedora Security Advisory FEDORA-2024-d1f1084584
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-d1f1084584");

  script_name(english:"Fedora 39 : python3.6 (2024-d1f1084584)");
...
FEDORA-2024-d1f1084584 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-d1f1084584");
...
var pkgs = [
    {'reference':'python3.6-3.6.15-27.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
