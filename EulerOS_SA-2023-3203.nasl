...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : cups (EulerOS-SA-2023-3203)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3203
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6ed3bd42");
...
var pkgs = [
  "cups-libs-2.2.13-4.h9.eulerosv2r10"
];
