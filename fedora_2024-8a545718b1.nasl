...
# extracted from Fedora Security Advisory FEDORA-2024-8a545718b1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-8a545718b1");

  script_name(english:"Fedora 40 : booth (2024-8a545718b1)");
...
FEDORA-2024-8a545718b1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-8a545718b1");
...
var pkgs = [
    {'reference':'booth-1.2-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
