...
# extracted from Red Hat Security Advisory RHSA-2024:0072. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:0072");

  script_name(english:"RHEL 9 : squid (RHSA-2024:0072)");
...
referenced in the RHSA-2024:0072 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0072.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a590226e");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0072");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL squid package based on the guidance in RHSA-2024:0072.");
  ...
  script_cwe_id(126, 476, 617, 755, 823);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'squid-5.5-5.el9_2.3', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
    ]
  }
];
