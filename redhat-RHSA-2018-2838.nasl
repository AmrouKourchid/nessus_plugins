...
# extracted from Red Hat Security Advisory RHSA-2018:2838. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:2838");

  script_name(english:"RHEL 7 : ceph-iscsi-cli (RHSA-2018:2838)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"An update for ceph-iscsi-cli is now available for Red Hat Ceph Storage
3.1 for Red Hat Enterprise Linux 7.
...
(CVE-2018-14649)");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:2838");
...
else
{
  ...
  if (rpm_check(release:"RHEL7", reference:"ceph-iscsi-cli-2.7-7.el7")) flag++;
