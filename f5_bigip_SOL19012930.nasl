...
# extracted from F5 Networks BIG-IP Solution K19012930.
#
# @NOAGENT@
##
...
if (description)
{
  ...
  script_cve_id("CVE-2021-23048");
  script_xref(name:"IAVA", value:"2021-A-0394-S");

  script_name(english:"F5 Networks BIG-IP : TMM GTP vulnerability (K19012930)");
...
16.1.0. It is, therefore, affected by a vulnerability as referenced in the K19012930 advisory.

  - On BIG-IP version 16.0.x before 16.0.1.2, 15.1.x before 15.1.3.1, 14.1.x before 14.1.4.3, 13.1.x before
    13.1.4.1, and all versions of 12.1.x and 11.6.x, when GPRS Tunneling Protocol (GTP) iRules commands or a
    GTP profile is configured on a virtual server, undisclosed GTP messages can cause the Traffic Management
    Microkernel (TMM) to terminate. Note: Software versions which have reached End of Technical Support (EoTS)
    are not evaluated. (CVE-2021-23048)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K19012930");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K19012930.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-23048");
