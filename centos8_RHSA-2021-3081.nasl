...
# Red Hat Security Advisory RHSA-2021:3081. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : cloud-init (CESA-2021:3081)");
...
var pkgs = [
    {'reference':'cloud-init-20.3-10.el8_4.5', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
