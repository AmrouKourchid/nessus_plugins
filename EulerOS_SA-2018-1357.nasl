...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : 389-ds-base (EulerOS-SA-2018-1357)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1357
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?56b5b43a");
...
"Update the affected 389-ds-base packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2018-14624");
...
pkgs = ["389-ds-base-1.3.5.10-20.h7",
        "389-ds-base-libs-1.3.5.10-20.h7"];
