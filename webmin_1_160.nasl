...
if (description)
{
  ...
  script_cve_id("CVE-2004-1468");
  script_bugtraq_id(11122);

  script_name(english:"Webmin 1.x < 1.160 Remote Code Execution");
...
the remote host is 1.x prior to 1.160. It is, therefore, affected by 
a remote code execution vulnerability.");
  script_set_attribute(attribute:"see_also", value:"https://www.securityfocus.com/bid/11122");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/200409-15");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Webmin 1.160 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:L/I:L/A:L");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2004-1468");
