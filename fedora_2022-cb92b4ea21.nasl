...
# extracted from Fedora Security Advisory FEDORA-2022-cb92b4ea21
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-cb92b4ea21");

  script_name(english:"Fedora 37 : samba (2022-cb92b4ea21)");
...
FEDORA-2022-cb92b4ea21 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-cb92b4ea21");
...
var pkgs = [
    {'reference':'samba-4.17.4-0.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
