...
# SUSE update advisory SUSE-SU-2023:4244-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:4244-1");

  script_name(english:"SUSE SLES12 / SLES15 Security Update : kernel (Live Patch 35 for SLE 15 SP1) (SUSE-SU-2023:4244-1)");
...
the SUSE-SU-2023:4244-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-October/016914.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cc9e8601");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2023-4623");
  script_set_attribute(attribute:"solution", value:
"Update the affected kernel-livepatch-4_12_14-150100_197_126-default, kernel-livepatch-5_3_18-150200_24_160-default and /
or kgraft-patch-4_12_14-122_173-default packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:suse_linux:kernel-livepatch-5_3_18-150200_24_160-default");
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-122.173-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_12_14-122_173-default-3-2.2', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.5']}
        ]
      },
      '4.12.14-150100.197.126-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-4_12_14-150100_197_126-default-12-150100.2.3', 'sp':'1', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.1']}
        ]
      },
      '5.3.18-150200.24.160-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_3_18-150200_24_160-default-3-150200.2.1', 'sp':'2', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.2']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kernel-livepatch-4_12_14-150100_197_126-default / etc');
}
