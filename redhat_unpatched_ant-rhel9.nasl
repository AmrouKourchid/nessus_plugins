...
# extracted from Red Hat Security Advisory ant. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2021-36373");

  script_name(english:"RHEL 9 : ant (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-36373");
