...
# SUSE update advisory SUSE-SU-2025:0613-2. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2025:0613-2");

  script_name(english:"SUSE SLES15 Security Update : openssl-1_1 (SUSE-SU-2025:0613-2)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://lists.suse.com/pipermail/sle-updates/2025-May/039184.html");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2024-13176");
  script_set_attribute(attribute:"solution", value:
"Update the affected libopenssl1_1 package.");
...
var pkgs = [
    {'reference':'libopenssl1_1-1.1.1w-150600.5.12.2', 'sp':'7', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-certifications-release-15.7']}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libopenssl1_1');
}
