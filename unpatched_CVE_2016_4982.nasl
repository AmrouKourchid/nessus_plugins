...
if (description)
{
  ...
  script_cve_id("CVE-2016-4982");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2016-4982");
...
patch available.
  ...
  - authd sets weak permissions for /etc/ident.key, which allows local users to obtain the key by leveraging a
    race condition between the creation of the key, and the chmod to protect it. (CVE-2016-4982)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-4982");
