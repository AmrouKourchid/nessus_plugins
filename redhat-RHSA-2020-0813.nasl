...
if (description)
{
  ...
  script_name(english:"RHEL 6 / 7 / 8 : Red Hat JBoss Enterprise Application Platform 7.2 (RHSA-2020:0813)");
...
referenced in the RHSA-2020:0813 advisory.

    Red Hat JBoss Enterprise Application Platform 7 is a platform for Java applications based on the WildFly
    application runtime.

    This asynchronous patch is a security update for the Undertow package in Red Hat JBoss Enterprise
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_0813.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?40b03761");
...
"Update the RHEL Red Hat JBoss Enterprise Application Platform 7.2 package based on the guidance in RHSA-2020:0813.");
