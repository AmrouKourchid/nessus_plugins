...
if (description)
{
  ...
  script_cve_id("CVE-2023-38211", "CVE-2023-38212", "CVE-2023-38213");
  script_xref(name:"IAVA", value:"2023-A-0420-S");

  script_name(english:"Adobe Dimension < 3.4.10 Multiple Vulnerabilities (APSB23-44) (macOS)");

  script_set_attribute(attribute:"synopsis", value:
"The Adobe Dimension instance installed on the remote host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Dimension installed on the remote macOS host is prior to 3.4.10. It is, therefore, affected by
multiple vulnerabilities as referenced in the APSB23-44 advisory.

  - Adobe Dimension version 3.4.9 is affected by a Heap-based Buffer Overflow vulnerability that could result
    in arbitrary code execution in the context of the current user. Exploitation of this issue requires user
    interaction in that a victim must open a malicious file. (CVE-2023-38212)

  - Adobe Dimension version 3.4.9 is affected by a Use After Free vulnerability that could result in arbitrary
    code execution in the context of the current user. Exploitation of this issue requires user interaction in
    that a victim must open a malicious file. (CVE-2023-38211)

  - Adobe Dimension version 3.4.9 is affected by an out-of-bounds read vulnerability that could lead to
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://helpx.adobe.com/security/products/dimension/apsb23-44.html");
...
"Upgrade to Adobe Dimension version 3.4.10 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-38212");
