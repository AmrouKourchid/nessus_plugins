...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Zlib PHSA-2023-5.0-0126");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'zlib-1.2.13-2.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'zlib-devel-1.2.13-2.ph5')) flag++;
