...
# extracted from Fedora Security Advisory FEDORA-2025-dbeb2c60c3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-dbeb2c60c3");
  script_xref(name:"IAVB", value:"2025-B-0056");

  script_name(english:"Fedora 40 : nextcloud (2025-dbeb2c60c3)");
...
FEDORA-2025-dbeb2c60c3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-dbeb2c60c3");
...
var pkgs = [
    {'reference':'nextcloud-31.0.2-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
