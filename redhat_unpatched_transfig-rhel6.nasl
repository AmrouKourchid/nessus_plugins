...
# extracted from Red Hat Security Advisory transfig. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2017-16899", "CVE-2018-16140");

  script_name(english:"RHEL 6 : transfig (Unpatched Vulnerability) (deprecated)");
