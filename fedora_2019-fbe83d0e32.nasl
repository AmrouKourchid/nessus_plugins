...
# extracted from Fedora Security Advisory FEDORA-2019-fbe83d0e32.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-fbe83d0e32");

  script_name(english:"Fedora 30 : libarchive (2019-fbe83d0e32)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-fbe83d0e32");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"libarchive-3.3.3-6.fc30")) flag++;
