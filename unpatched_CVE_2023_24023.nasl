...
if (description)
{
  ...
  script_cve_id("CVE-2023-24023");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2023-24023");
...
patch available.
  ...
  - Bluetooth BR/EDR devices with Secure Simple Pairing and Secure Connections pairing in Bluetooth Core
    Specification 4.2 through 5.4 allow certain man-in-the-middle attacks that force a short key length, and
    might lead to discovery of the encryption key and live injection, aka BLUFFS. (CVE-2023-24023)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-24023");
