...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : libtiff (EulerOS-SA-2024-1361)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1361
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1aa83c24");
...
var pkgs = [
  "libtiff-4.1.0-1.h34.eulerosv2r10"
];
