...
# extracted from Red Hat Security Advisory RHSA-2018:0528. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:0528");

  script_name(english:"RHEL 7 : erlang (RHSA-2018:0528)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for erlang.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2018:0528 advisory.
...
number.");
  ...
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_0528.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?412b5206");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:0528");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL erlang package based on the guidance in RHSA-2018:0528.");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for RHSA-2018:0528');
  }
  else
  {
