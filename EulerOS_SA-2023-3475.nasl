...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.0 : libtiff (EulerOS-SA-2023-3475)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3475
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c55afcc3");
...
var pkgs = [
  "libtiff-4.1.0-1.h30.eulerosv2r10"
];
