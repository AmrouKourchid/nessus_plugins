...
# extracted from Fedora Security Advisory FEDORA-2023-6b924d3b75
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-6b924d3b75");

  script_name(english:"Fedora 38 : ruby (2023-6b924d3b75)");
...
FEDORA-2023-6b924d3b75 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-6b924d3b75");
...
var pkgs = [
    {'reference':'ruby-3.2.2-180.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
