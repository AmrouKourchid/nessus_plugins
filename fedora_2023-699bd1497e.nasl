...
# extracted from Fedora Security Advisory FEDORA-2023-699bd1497e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-699bd1497e");

  script_name(english:"Fedora 39 : rt (2023-699bd1497e)");
...
FEDORA-2023-699bd1497e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-699bd1497e");
...
var pkgs = [
    {'reference':'rt-5.0.5-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
