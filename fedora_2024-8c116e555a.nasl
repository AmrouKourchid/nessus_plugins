...
# extracted from Fedora Security Advisory FEDORA-2024-8c116e555a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-8c116e555a");

  script_name(english:"Fedora 41 : golang-github-dvsekhvalnov-jose2go (2024-8c116e555a)");
...
FEDORA-2024-8c116e555a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-8c116e555a");
  script_set_attribute(attribute:"solution", value:
"Update the affected golang-github-dvsekhvalnov-jose2go package.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:N/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-50658");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:golang-github-dvsekhvalnov-jose2go");
...
var pkgs = [
    {'reference':'golang-github-dvsekhvalnov-jose2go-1.7.0-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'golang-github-dvsekhvalnov-jose2go');
}
