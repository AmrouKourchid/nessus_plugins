...
# extracted from Ubuntu Security Notice USN-6376-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6376-1");

  script_name(english:"Ubuntu 20.04 LTS : c-ares vulnerability (USN-6376-1)");
...
USN-6376-1 advisory.
    ...
    It was discovered that c-ares incorrectly parsed certain SOA replies. A remote attacker could possibly use
    this issue to cause c-res to crash, resulting in a denial of service.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6376-1");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'libc-ares-dev', 'pkgver': '1.15.0-1ubuntu0.4'},
    {'osver': '20.04', 'pkgname': 'libc-ares2', 'pkgver': '1.15.0-1ubuntu0.4'}
];
