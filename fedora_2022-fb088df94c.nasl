...
# extracted from Fedora Security Advisory FEDORA-2022-fb088df94c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-fb088df94c");

  script_name(english:"Fedora 37 : git (2022-fb088df94c)");
...
FEDORA-2022-fb088df94c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-fb088df94c");
...
var pkgs = [
    {'reference':'git-2.38.1-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
