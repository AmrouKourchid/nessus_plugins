...
ELSA-2015-1137 advisory.
    ...
    - [fs] pipe: fix pipe corruption and iovec overrun on partial copy (Seth Jennings) [1202861 1198843]
    {CVE-2015-1805}
    - [x86] kernel: Remove a bogus 'ret_from_fork' optimization (Mateusz Guzik) [1209234 1209235]
    {CVE-2015-2830}
    - [x86] mm: Linux stack ASLR implementation (Jacob Tanenbaum) [1195684 1195685] {CVE-2015-1593}
    - [net] netfilter: nf_tables: fix flush ruleset chain dependencies (Jiri Pirko) [1192880 1192881]
    {CVE-2015-1573}
    - [fs] isofs: Fix unchecked printing of ER records (Mateusz Guzik) [1180482 1180483] {CVE-2014-9584}
    - [security] keys: memory corruption or panic during key garbage collection (Jacob Tanenbaum) [1179851
    1179852] {CVE-2014-9529}
...
var pkgs = [
    ...
    {'reference':'kernel-abi-whitelists-3.10.0-229.7.2.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-abi-whitelists-3.10.0'},
