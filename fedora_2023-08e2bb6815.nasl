...
# extracted from Fedora Security Advisory FEDORA-2023-08e2bb6815
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-08e2bb6815");

  script_name(english:"Fedora 38 : open-vm-tools (2023-08e2bb6815)");
...
FEDORA-2023-08e2bb6815 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-08e2bb6815");
...
var pkgs = [
    {'reference':'open-vm-tools-12.3.0-3.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
