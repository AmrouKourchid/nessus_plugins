...
# extracted from Fedora Security Advisory FEDORA-2022-5495b36bed
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-5495b36bed");

  script_name(english:"Fedora 35 : xorg-x11-server-Xwayland (2022-5495b36bed)");
...
FEDORA-2022-5495b36bed advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-5495b36bed");
...
var pkgs = [
    {'reference':'xorg-x11-server-Xwayland-21.1.4-3.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
