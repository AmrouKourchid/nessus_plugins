...
# extracted from Red Hat Security Advisory RHSA-2022:8067. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:8067");

  script_name(english:"RHEL 9 : httpd (RHSA-2022:8067)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2022:8067 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8067.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?37b04a37");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8067");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'httpd-2.4.53-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'httpd-core-2.4.53-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'httpd-devel-2.4.53-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'httpd-tools-2.4.53-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mod_ldap-2.4.53-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mod_lua-2.4.53-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mod_proxy_html-2.4.53-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'mod_session-2.4.53-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mod_ssl-2.4.53-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
