...
if (description)
{
  ...
  script_name(english:"RHEL 5 / 6 : Red Hat JBoss Enterprise Application Platform 5.2 (RHSA-2017:3399)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for Red Hat JBoss Enterprise Application Platform 5.2.");
...
referenced in the RHSA-2017:3399 advisory.

    Red Hat JBoss Enterprise Application Platform is a platform for Java applications based on the JBoss
    Application Server.

    This asynchronous patch is a security update for log4j package in Red Hat JBoss Enterprise Application
    Platform 5.2.0.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2017/rhsa-2017_3399.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?928a00df");
  # https://access.redhat.com/documentation/en-us/red_hat_jboss_enterprise_application_platform/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bf165061");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2017:3399");
...
"Update the RHEL Red Hat JBoss Enterprise Application Platform 5.2 package based on the guidance in RHSA-2017:3399.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'log4j-1.2.14-19.patch_01.ep5.el5', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap5'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'log4j-1.2.14-19.patch_01.ep5.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap5'}
    ]
  }
];
