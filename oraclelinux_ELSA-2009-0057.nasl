...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : squirrelmail (ELSA-2009-0057)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2009-0057.html");
...
"Update the affected squirrelmail package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2009-0030");
...
var pkgs = [
    {'reference':'squirrelmail-1.4.8-5.0.1.el5_2.3', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
