...
if (description)
{
  ...
  script_name(english:"IBM MQ 9.1 < 9.1.0.24 LTS / 9.2 < 9.2.0.28 LTS / 9.3 < 9.3.0.25 LTS / 9.3 < 9.4.1 CD / 9.4 < 9.4.0.6 LTS (7174362)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/node/7174362");
