...
# AlmaLinux Security Advisory ALSA-2024:0966.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:0966");

  script_name(english:"AlmaLinux 9 : opensc (ALSA-2024:0966)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2024-0966.html");
