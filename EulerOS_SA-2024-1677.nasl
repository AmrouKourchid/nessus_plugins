...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : curl (EulerOS-SA-2024-1677)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1677
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d8b8f7ae");
...
var pkgs = [
  "curl-7.61.1-2.h32.eulerosv2r8",
  "libcurl-7.61.1-2.h32.eulerosv2r8",
  "libcurl-devel-7.61.1-2.h32.eulerosv2r8"
];
