...
if (description)
{
  ...
  script_name(english:"GIGABYTE XTREME GAMING ENGINE < 1.26 Multiple Vulnerabilities");
...
"The version of GIGABYTE XTREME GAMING ENGINE installed on the remote host is prior to 1.26. It is, therefore, affected
...
"Upgrade to GIGABYTE XTREME GAMING ENGINE 1.27 or later.");
  ...
  script_set_attribute(attribute:"cpe", value:"cpe:/a:gigabyte:xtreme_gaming_engine");
  ...
  script_dependencies("gigabyte_xtreme_gaming_engine_win_installed.nbin");
  script_require_keys("installed_sw/Gigabyte Xtreme Gaming Engine");
...
var app = 'Gigabyte Xtreme Gaming Engine';

var app_info = vcf::get_app_info(app:app, win_local:TRUE);

var constraints = [
  { 'fixed_version':'1.26', 'fixed_display':'1.27' }
];
