...
# extracted from Fedora Security Advisory FEDORA-2024-be032e564d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-be032e564d");

  script_name(english:"Fedora 39 : mingw-glib2 (2024-be032e564d)");
...
FEDORA-2024-be032e564d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-be032e564d");
...
var pkgs = [
    {'reference':'mingw-glib2-2.78.5-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
