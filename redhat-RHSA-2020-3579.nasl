...
"The remote Red Hat host is missing a security update for OpenShift Container Platform 4.4.19 openshift.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_3579.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1d991336");
...
"Update the RHEL OpenShift Container Platform 4.4.19 openshift package based on the guidance in RHSA-2020:3579.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openshift-hyperkube-4.4.0-202008250319.p0.git.0.d653415.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'openshift-hyperkube-4.4.0-202008250319.p0.git.0.d653415.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'openshift-hyperkube-4.4.0-202008250319.p0.git.0.d653415.el7', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'openshift-hyperkube-4.4.0-202008250319.p0.git.0.d653415.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
