...
if (description)
{
  ...
  script_name(english:"Adobe Illustrator < 27.9.4 / 28.0 < 28.5 Multiple Vulnerabilities (APSB24-30)");

  script_set_attribute(attribute:"synopsis", value:
"The Adobe Illustrator instance installed on the remote host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Illustrator installed on the remote Windows host is prior to 27.9.4, 28.5. It is, therefore,
affected by multiple vulnerabilities as referenced in the APSB24-30 advisory.
