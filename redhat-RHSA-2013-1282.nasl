...
"The remote Red Hat host is missing a security update for rtkit.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2013/rhsa-2013_1282.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8b64bcae");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2013:1282");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1006677");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rtkit package based on the guidance in RHSA-2013:1282.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rtkit-0.5-2.el6_4', 'cpu':'i686', 'release':'6', 'el_string':'el6_4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rtkit-0.5-2.el6_4', 'cpu':'ppc64', 'release':'6', 'el_string':'el6_4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rtkit-0.5-2.el6_4', 'cpu':'s390x', 'release':'6', 'el_string':'el6_4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rtkit-0.5-2.el6_4', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_4', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
