...
"The remote Red Hat host is missing one or more security updates for etcd.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_1407.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?38335cd4");
...
"Update the RHEL etcd package based on the guidance in RHSA-2021:1407.");
