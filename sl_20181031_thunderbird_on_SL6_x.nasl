...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : thunderbird on SL6.x i386/x86_64 (20181031)");
...
feed.");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1810&L=scientific-linux-errata&F=&S=&P=13678
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a52904dc");
...
flag = 0;
if (rpm_check(release:"SL6", reference:"thunderbird-60.2.1-5.el6", allowmaj:TRUE)) flag++;
if (rpm_check(release:"SL6", reference:"thunderbird-debuginfo-60.2.1-5.el6", allowmaj:TRUE)) flag++;
