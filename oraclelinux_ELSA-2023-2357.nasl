...
# extracted from Oracle Linux Security Advisory ELSA-2023-2357.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : git-lfs (ELSA-2023-2357)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-2357.html");
...
var pkgs = [
    {'reference':'git-lfs-3.2.0-1.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'git-lfs-3.2.0-1.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
