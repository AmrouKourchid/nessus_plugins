...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_1294.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?be90c6b2");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:1294");
...
"Update the RHEL bind package based on the guidance in RHSA-2019:1294.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'bind-9.9.4-74.el7_6.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-chroot-9.9.4-74.el7_6.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-devel-9.9.4-74.el7_6.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-libs-9.9.4-74.el7_6.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-libs-lite-9.9.4-74.el7_6.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-license-9.9.4-74.el7_6.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-lite-devel-9.9.4-74.el7_6.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-pkcs11-9.9.4-74.el7_6.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-pkcs11-devel-9.9.4-74.el7_6.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-pkcs11-libs-9.9.4-74.el7_6.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-pkcs11-utils-9.9.4-74.el7_6.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-sdb-9.9.4-74.el7_6.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-sdb-chroot-9.9.4-74.el7_6.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-utils-9.9.4-74.el7_6.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'}
    ]
  }
];
