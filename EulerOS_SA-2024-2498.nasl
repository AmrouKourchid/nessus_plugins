...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP12 : c-ares (EulerOS-SA-2024-2498)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2498
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bcdb239b");
...
var pkgs = [
  "c-ares-1.18.1-5.h2.eulerosv2r12"
];
