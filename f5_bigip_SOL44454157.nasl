...
# extracted from F5 Networks BIG-IP Solution K44454157.
#
# @NOAGENT@
##
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : Expat vulnerability (K44454157)");
...
affected by a vulnerability as referenced in the K44454157 advisory.

    libexpat before 2.4.9 has a use-after-free in the doContent function in
    xmlparse.c.(CVE-2022-40674)ImpactAn attacker may be able to use crafted XML to reference previously freed
    memory, leading to data corruption or the execution of arbitrary code.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K44454157");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K44454157.");
...
var vmatrix = {
  ...
  'ASM': {
    'affected': [
      '17.0.0-17.1.1','17.0.0-17.1.0','16.1.0-16.1.4','16.1.0-16.1.3','15.1.0-15.1.8','15.1.0-15.1.10','14.1.0-14.1.5','13.1.0-13.1.5'
    ],
    'unaffected': [
      '17.1.1','16.1.4','15.1.9'
    ],
