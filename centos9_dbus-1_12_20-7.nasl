...
if (description)
{
  ...
  script_name(english:"CentOS 9 : dbus-1.12.20-7.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing one or more security updates for dbus.");
...
dbus-1.12.20-7.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=25404");
...
var pkgs = [
    {'reference':'dbus-1.12.20-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'dbus-common-1.12.20-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'dbus-daemon-1.12.20-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'dbus-devel-1.12.20-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'dbus-doc-1.12.20-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'dbus-libs-1.12.20-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'dbus-tests-1.12.20-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'dbus-tools-1.12.20-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'dbus-x11-1.12.20-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
