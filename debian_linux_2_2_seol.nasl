...
if (description)
{
  ...
  script_name(english:"Debian Linux SEoL (2.2.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Debian Linux is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Debian Linux is 2.2.x. It is, therefore, no longer maintained by its vendor or provider.
...
var constraints = [
  { max_branch : '2.2', min_branch : '2.2', seol : 20030630 }
];
