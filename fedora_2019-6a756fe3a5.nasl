...
# extracted from Fedora Security Advisory FEDORA-2019-6a756fe3a5.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-6a756fe3a5");

  script_name(english:"Fedora 28 : libX11 (2019-6a756fe3a5)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-6a756fe3a5");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"libX11-1.6.7-1.fc28")) flag++;
