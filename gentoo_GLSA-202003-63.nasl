...
# extracted from Gentoo Linux Security Advisory GLSA 202003-63.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202003-63");

  script_name(english:"GLSA-202003-63 : GNU IDN Library 2: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202003-63
...
Impact :
    ...
    A remote attacker could send specially crafted input, possibly resulting
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202003-63");
...
"All GNU IDN Library 2 users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:libidn2");
...
if (qpkg_check(package:"net-dns/libidn2", unaffected:make_list("ge 2.2.0"), vulnerable:make_list("lt 2.2.0"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "GNU IDN Library 2");
}
