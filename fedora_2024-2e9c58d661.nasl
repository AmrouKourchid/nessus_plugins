...
# extracted from Fedora Security Advisory FEDORA-2024-2e9c58d661
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-2e9c58d661");

  script_name(english:"Fedora 39 : python-authlib (2024-2e9c58d661)");
...
FEDORA-2024-2e9c58d661 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-2e9c58d661");
...
var pkgs = [
    {'reference':'python-authlib-1.3.1-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
