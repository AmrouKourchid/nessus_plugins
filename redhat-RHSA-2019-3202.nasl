...
# extracted from Red Hat Security Advisory RHSA-2019:3202. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:3202");

  script_name(english:"RHEL 7 : Ansible (RHSA-2019:3202)");
...
referenced in the RHSA-2019:3202 advisory.
...
number.");
  # https://github.com/ansible/ansible/blob/v2.7.14/changelogs/CHANGELOG-v2.7.rst
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c707b527");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_3202.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e4b02d15");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:3202");
...
"Update the RHEL Ansible package based on the guidance in RHSA-2019:3202.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ansible-2.7.14-1.el7ae', 'release':'7', 'el_string':'el7ae', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2.7'}
    ]
  }
];
