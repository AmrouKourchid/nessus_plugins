...
# extracted from Amazon Linux 2023 Security Advisory ALAS2023-2023-303.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2023 : php8.1, php8.1-bcmath, php8.1-cli (ALAS2023-2023-303)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2023 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"It is, therefore, affected by a vulnerability as referenced in the ALAS2023-2023-303 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2023/ALAS-2023-303.html");
...
"Run 'dnf update php8.1 --releasever 2023.1.20230823' to update your system.");
