...
# extracted from Ubuntu Security Notice USN-6642-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6642-1");
  script_xref(name:"IAVA", value:"2024-A-0103-S");

  script_name(english:"Ubuntu 20.04 LTS : Bind vulnerabilities (USN-6642-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 20.04 LTS host has packages installed that are affected by multiple vulnerabilities as referenced in
the USN-6642-1 advisory.
    ...
    It was discovered that Bind incorrectly handled certain specific recursive query patterns. A remote
    attacker could possibly use this issue to cause Bind to consume memory, leading to a denial of service.
    (CVE-2023-6516)

    Bind has been updated to 9.6.48. In addition to security fixes, the updated packages contain bug fixes,
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6642-1");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'bind9', 'pkgver': '1:9.16.48-0ubuntu0.20.04.1'},
    {'osver': '20.04', 'pkgname': 'bind9-dnsutils', 'pkgver': '1:9.16.48-0ubuntu0.20.04.1'},
    {'osver': '20.04', 'pkgname': 'bind9-host', 'pkgver': '1:9.16.48-0ubuntu0.20.04.1'},
    {'osver': '20.04', 'pkgname': 'bind9-libs', 'pkgver': '1:9.16.48-0ubuntu0.20.04.1'},
    {'osver': '20.04', 'pkgname': 'bind9-utils', 'pkgver': '1:9.16.48-0ubuntu0.20.04.1'},
    {'osver': '20.04', 'pkgname': 'bind9utils', 'pkgver': '1:9.16.48-0ubuntu0.20.04.1'},
    {'osver': '20.04', 'pkgname': 'dnsutils', 'pkgver': '1:9.16.48-0ubuntu0.20.04.1'}
];
