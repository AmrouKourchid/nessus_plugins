...
if (description)
{
  ...
  script_cve_id("CVE-2020-12866");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2020-12866");
...
patch available.
  ...
  - A NULL pointer dereference in SANE Backends before 1.0.30 allows a malicious device connected to the same
    local network as the victim to cause a denial of service, GHSL-2020-079. (CVE-2020-12866)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-12866");
