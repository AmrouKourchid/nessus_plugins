...
# extracted from Fedora Security Advisory FEDORA-2023-c487bde4b4
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-c487bde4b4");

  script_name(english:"Fedora 37 : libtpms (2023-c487bde4b4)");
...
FEDORA-2023-c487bde4b4 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-c487bde4b4");
...
var pkgs = [
    {'reference':'libtpms-0.9.6-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
