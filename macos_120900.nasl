...
if (description)
{
  ...
  script_xref(name:"APPLE-SA", value:"120900");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2024/03/27");

  script_name(english:"macOS 13.x < 13.6.7 Multiple Vulnerabilities (120900)");
...
version number.");
  script_set_attribute(attribute:"see_also", value:"https://support.apple.com/en-us/120900");
