...
# extracted from Gentoo Linux Security Advisory GLSA 202103-04.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202103-04");
  script_xref(name:"IAVA", value:"2021-A-0493-S");
  script_xref(name:"IAVA", value:"2022-A-0382-S");
  script_xref(name:"CEA-ID", value:"CEA-2021-0025");

  script_name(english:"GLSA-202103-04 : SQLite: Remote code execution");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202103-04
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202103-04"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"dev-db/sqlite", unaffected:make_list("ge 3.34.1"), vulnerable:make_list("lt 3.34.1"))) flag++;
