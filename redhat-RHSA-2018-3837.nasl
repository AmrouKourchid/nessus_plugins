...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_3837.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9f2cf10e");
...
"Update the RHEL ansible package based on the guidance in RHSA-2018:3837.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ansible-2.7.5-1.el7ae', 'release':'7', 'el_string':'el7ae', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2.7'}
    ]
  }
];
