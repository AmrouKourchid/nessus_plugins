...
# extracted from Red Hat Security Advisory RHSA-2024:3661. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:3661");

  script_name(english:"RHEL 9 : booth (RHSA-2024:3661)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_3661.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7b3eada1");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2272082");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:3661");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL booth package based on the guidance in RHSA-2024:3661.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:H/Au:N/C:N/I:C/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:H/PR:N/UI:N/S:U/C:N/I:H/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-3049");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'booth-1.1-1.el9_4.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'booth-arbitrator-1.1-1.el9_4.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'booth-core-1.1-1.el9_4.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'booth-site-1.1-1.el9_4.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'booth-test-1.1-1.el9_4.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
      'content/e4s/rhel9/9.4/aarch64/highavailability/debug',
      'content/e4s/rhel9/9.4/aarch64/highavailability/os',
      'content/e4s/rhel9/9.4/aarch64/highavailability/source/SRPMS',
      ...
      'content/eus/rhel9/9.4/aarch64/highavailability/debug',
      'content/eus/rhel9/9.4/aarch64/highavailability/os',
      'content/eus/rhel9/9.4/aarch64/highavailability/source/SRPMS',
    ...
    'pkgs': [
      {'reference':'booth-1.1-1.el9_4.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'booth-arbitrator-1.1-1.el9_4.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'booth-core-1.1-1.el9_4.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'booth-site-1.1-1.el9_4.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'booth-test-1.1-1.el9_4.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
