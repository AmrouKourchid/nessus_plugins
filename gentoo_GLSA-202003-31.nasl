...
(gdb: Buffer overflow)
    ...
    It was discovered that gdb didn&rsquo;t properly validate the ELF section
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202003-31");
