...
# SUSE update advisory SUSE-SU-2023:2986-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:2986-1");

  script_name(english:"SUSE SLES12 Security Update : kernel-firmware (SUSE-SU-2023:2986-1)");
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-July/015670.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?af3d1581");
...
var pkgs = [
    {'reference':'kernel-firmware-20170530-21.37.1', 'sp':'2', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-bcl-release-12.2']},
    {'reference':'ucode-amd-20170530-21.37.1', 'sp':'2', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-bcl-release-12.2']}
];
