...
# extracted from Gentoo Linux Security Advisory GLSA 202008-04.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202008-04");
  script_xref(name:"IAVA", value:"2020-A-0376-S");
  script_xref(name:"CEA-ID", value:"CEA-2021-0004");

  script_name(english:"GLSA-202008-04 : Apache: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202008-04
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202008-04");
...
if (qpkg_check(package:"www-servers/apache", unaffected:make_list("ge 2.4.46"), vulnerable:make_list("lt 2.4.46"))) flag++;
