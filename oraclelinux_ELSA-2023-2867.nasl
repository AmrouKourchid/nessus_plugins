...
# extracted from Oracle Linux Security Advisory ELSA-2023-2867.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : postgresql-jdbc (ELSA-2023-2867)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
ELSA-2023-2867 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-2867.html");
...
var pkgs = [
    {'reference':'postgresql-jdbc-42.2.14-2.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'postgresql-jdbc-javadoc-42.2.14-2.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
