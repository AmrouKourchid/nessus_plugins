...
# extracted from Ubuntu Security Notice USN-3383-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS : libsoup vulnerability (USN-3383-1)");
...
in the USN-3383-1 advisory.

    Aleksandar Nikolic discovered a stack based buffer overflow when handling chunked encoding. An attacker
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3383-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'gir1.2-soup-2.4', 'pkgver': '2.44.2-1ubuntu2.2'},
    {'osver': '14.04', 'pkgname': 'libsoup-gnome2.4-1', 'pkgver': '2.44.2-1ubuntu2.2'},
    {'osver': '14.04', 'pkgname': 'libsoup-gnome2.4-dev', 'pkgver': '2.44.2-1ubuntu2.2'},
    {'osver': '14.04', 'pkgname': 'libsoup2.4-1', 'pkgver': '2.44.2-1ubuntu2.2'},
    {'osver': '14.04', 'pkgname': 'libsoup2.4-dev', 'pkgver': '2.44.2-1ubuntu2.2'},
    {'osver': '16.04', 'pkgname': 'gir1.2-soup-2.4', 'pkgver': '2.52.2-1ubuntu0.2'},
    {'osver': '16.04', 'pkgname': 'libsoup-gnome2.4-1', 'pkgver': '2.52.2-1ubuntu0.2'},
    {'osver': '16.04', 'pkgname': 'libsoup-gnome2.4-dev', 'pkgver': '2.52.2-1ubuntu0.2'},
    {'osver': '16.04', 'pkgname': 'libsoup2.4-1', 'pkgver': '2.52.2-1ubuntu0.2'},
    {'osver': '16.04', 'pkgname': 'libsoup2.4-dev', 'pkgver': '2.52.2-1ubuntu0.2'}
];
