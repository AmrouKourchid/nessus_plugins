...
# extracted from Red Hat Security Advisory RHSA-2022:1792. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:1792");

  script_name(english:"RHEL 8 : flatpak (RHSA-2022:1792)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for flatpak.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2022:1792 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_1792.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?80b7d7f7");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/8.6_release_notes/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9341665d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:1792");
...
"Update the RHEL flatpak package based on the guidance in RHSA-2022:1792.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'flatpak-1.8.7-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'flatpak-devel-1.8.7-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'flatpak-libs-1.8.7-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'flatpak-selinux-1.8.7-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'flatpak-session-helper-1.8.7-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
