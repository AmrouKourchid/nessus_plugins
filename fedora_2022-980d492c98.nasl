...
# extracted from Fedora Security Advisory FEDORA-2022-980d492c98
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-980d492c98");

  script_name(english:"Fedora 36 : dotnet3.1 (2022-980d492c98)");
...
FEDORA-2022-980d492c98 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-980d492c98");
...
var pkgs = [
    {'reference':'dotnet3.1-3.1.423-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
