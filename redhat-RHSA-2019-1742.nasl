...
# extracted from Red Hat Security Advisory RHSA-2019:1742. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2019-3895");
  script_xref(name:"RHSA", value:"2019:1742");

  script_name(english:"RHEL 7 : openstack-tripleo-common (RHSA-2019:1742)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for openstack-tripleo-common.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2019:1742 advisory.

    openstack-tripleo-common contains the python library for code common to the Red Hat OpenStack Platform
    director CLI and GUI (codename tripleo).
    ...
    * Introspection of baremetal nodes fail with 'No hypervisor matching' problem when node name used instead
    of uuid (BZ#1677016)

    * config-download backports from RHOSP 14 to RHOSP 13 (openstack-tripleo-common) (BZ#1688461)

    * RHOSP-13 Connection reset by peer: libvirtError: operation failed: Failed to connect to remote libvirt
    URI  # Live Migration failure: operation failed: Failed to connect to remote libvirt URI (BZ#1712410)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_1742.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?65a02c89");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1677016");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1688461");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1694608");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1717060");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1722738");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:1742");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL openstack-tripleo-common package based on the guidance in RHSA-2019:1742.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:L/UI:R/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-3895");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openstack-tripleo-common-8.6.8-11.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'openstack-tripleo-common-container-base-8.6.8-11.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'openstack-tripleo-common-containers-8.6.8-11.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'openstack-tripleo-common-devtools-8.6.8-11.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
