...
# extracted from Fedora Security Advisory FEDORA-2023-e6d5cb11bb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-e6d5cb11bb");

  script_name(english:"Fedora 37 : dotnet7.0 (2023-e6d5cb11bb)");
...
FEDORA-2023-e6d5cb11bb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-e6d5cb11bb");
...
var pkgs = [
    {'reference':'dotnet7.0-7.0.107-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
