...
# extracted from Mozilla Foundation Security Advisory mfsa2020-31.
...
if (description)
{
  ...
  script_xref(name:"MFSA", value:"2020-31");
  script_xref(name:"IAVA", value:"2020-A-0344-S");

  script_name(english:"Mozilla Firefox ESR < 68.11");

  script_set_attribute(attribute:"synopsis", value:
"A web browser installed on the remote macOS or Mac OS X host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Firefox ESR installed on the remote macOS or Mac OS X host is prior to 68.11. It is, therefore, affected
by multiple vulnerabilities as referenced in the mfsa2020-31 advisory.
...
mozilla_check_version(version:version, path:path, product:'firefox', esr:TRUE, fix:'68.11', min:'68.0.0', severity:SECURITY_HOLE);
