...
# extracted from Red Hat Security Advisory RHSA-2024:1499. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_1499.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4d45e09d");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:1499");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL thunderbird package based on the guidance in RHSA-2024:1499.");
  ...
  script_cwe_id(79, 120, 208, 252, 311, 416, 449, 1262);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'thunderbird-115.9.0-1.el8_4', 'sp':'4', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'thunderbird-115.9.0-1.el8_4', 'sp':'4', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
