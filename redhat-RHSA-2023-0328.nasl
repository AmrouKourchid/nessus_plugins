...
# extracted from Red Hat Security Advisory RHSA-2023:0328. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:0328");

  script_name(english:"RHEL 9 : go-toolset and golang (RHSA-2023:0328)");
...
referenced in the RHSA-2023:0328 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_0328.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fe94eb3b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:0328");
...
"Update the RHEL go-toolset / golang packages based on the guidance in RHSA-2023:0328.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'golang-1.18.9-1.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-bin-1.18.9-1.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
