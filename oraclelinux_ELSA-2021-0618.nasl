...
# extracted from Oracle Linux Security Advisory ELSA-2021-0618.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : stunnel (ELSA-2021-0618)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2021-0618.html");
