...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : libtiff (EulerOS-SA-2023-1039)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1039
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1779604b");
...
"Update the affected libtiff packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2022-3627");
...
var pkgs = [
  "libtiff-4.3.0-9.h9.eulerosv2r11"
];
