...
# extracted from Fedora Security Advisory FEDORA-2023-4d5f7e5cb0
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-4d5f7e5cb0");

  script_name(english:"Fedora 36 : dotnet6.0 (2023-4d5f7e5cb0)");
...
FEDORA-2023-4d5f7e5cb0 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-4d5f7e5cb0");
...
var pkgs = [
    {'reference':'dotnet6.0-6.0.113-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
