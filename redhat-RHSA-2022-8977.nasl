...
# extracted from Red Hat Security Advisory RHSA-2022:8977. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:8977");

  script_name(english:"RHEL 9 : dbus (RHSA-2022:8977)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for dbus.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2022:8977 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8977.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?901ffd12");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8977");
...
"Update the RHEL dbus package based on the guidance in RHSA-2022:8977.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'dbus-1.12.20-5.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'dbus-common-1.12.20-5.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'dbus-daemon-1.12.20-5.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'dbus-devel-1.12.20-5.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'dbus-libs-1.12.20-5.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'dbus-tools-1.12.20-5.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'dbus-x11-1.12.20-5.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
