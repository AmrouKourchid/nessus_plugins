...
# extracted from Fedora Security Advisory FEDORA-2023-f992309b7e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-f992309b7e");

  script_name(english:"Fedora 38 : ImageMagick / rubygem-rmagick (2023-f992309b7e)");
...
FEDORA-2023-f992309b7e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-f992309b7e");
  script_set_attribute(attribute:"solution", value:
"Update the affected 1:ImageMagick and / or rubygem-rmagick packages.");
...
var pkgs = [
    {'reference':'ImageMagick-7.1.1.4-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'rubygem-rmagick-5.2.0-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'ImageMagick / rubygem-rmagick');
}
