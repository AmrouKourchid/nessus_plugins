...
# extracted from Amazon Linux AMI Security Advisory ALAS-2023-1817.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux AMI : ca-certificates (ALAS-2023-1817)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux AMI host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of ca-certificates installed on the remote host is prior to 2018.2.22-65.1.31. It is, therefore, affected by
a vulnerability as referenced in the ALAS-2023-1817 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/ALAS-2023-1817.html");
...
var pkgs = [
    {'reference':'ca-certificates-2018.2.22-65.1.31.amzn1', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE}
];
