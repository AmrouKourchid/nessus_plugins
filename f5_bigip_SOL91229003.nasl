...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : Side-channel processor vulnerabilities (K91229003)");
...
in the following table, there is no impact.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K91229003");
...
var vmatrix = {
  'AFM': {
    ...
    'unaffected': [
      '15.0.0','14.0.0','13.1.0.4','13.0.1','12.1.3.3','11.6.3.1','11.5.6'
    ],
  },
  'AM': {
    'affected': [
