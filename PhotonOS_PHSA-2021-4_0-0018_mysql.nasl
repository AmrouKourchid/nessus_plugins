...
# extracted from VMware Security Advisory PHSA-2021-4.0-0018. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Mysql PHSA-2021-4.0-0018");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the mysql package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-18.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'mysql-8.0.24-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'mysql-devel-8.0.24-1.ph4')) flag++;
