...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Elasticsearch PHSA-2020-2.0-0253");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'elasticsearch-6.8.9-1.ph2')) flag++;
