...
# extracted from Fedora Security Advisory FEDORA-2021-fb1a136393
#
...
if (description)
{
  ...
  script_name(english:"Fedora 33 : 1:nodejs (2021-fb1a136393)");
...
FEDORA-2021-fb1a136393 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-fb1a136393");
...
pkgs = [
    {'reference':'nodejs-14.15.4-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
