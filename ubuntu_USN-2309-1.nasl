...
# extracted from Ubuntu Security Notice USN-2309-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS : libav vulnerabilities (USN-2309-1)");
...
without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://usn.ubuntu.com/2309-1/");
  script_set_attribute(attribute:"solution", value:
"Update the affected libavcodec53 and / or libavformat53 packages.");
...
if (ubuntu_check(osver:"12.04", pkgname:"libavcodec53", pkgver:"4:0.8.15-0ubuntu0.12.04.1")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"libavformat53", pkgver:"4:0.8.15-0ubuntu0.12.04.1")) flag++;
