...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : mercurial (EulerOS-SA-2018-1112)");
...
vulnerabilities :
  ...
  - Mercurial is a fast, lightweight source control
    management system designed for efficient handling of
  ...
  - Mercurial version 4.5 and earlier contains a Incorrect
    ...
    server that can result in Unauthorized data access.
    This attack appear to be exploitable via network
    connectivity. (CVE-2018-1000132)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1112
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e69a9067");
