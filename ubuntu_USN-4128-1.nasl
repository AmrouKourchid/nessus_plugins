...
referenced in the USN-4128-1 advisory.
    ...
    It was discovered that Tomcat 8 did not address HTTP/2 connection window exhaustion on write while
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4128-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libservlet3.1-java', 'pkgver': '8.0.32-1ubuntu1.10'},
    {'osver': '16.04', 'pkgname': 'libtomcat8-java', 'pkgver': '8.0.32-1ubuntu1.10'},
    {'osver': '16.04', 'pkgname': 'tomcat8', 'pkgver': '8.0.32-1ubuntu1.10'},
    {'osver': '16.04', 'pkgname': 'tomcat8-admin', 'pkgver': '8.0.32-1ubuntu1.10'},
    {'osver': '16.04', 'pkgname': 'tomcat8-common', 'pkgver': '8.0.32-1ubuntu1.10'},
    {'osver': '16.04', 'pkgname': 'tomcat8-examples', 'pkgver': '8.0.32-1ubuntu1.10'},
    {'osver': '16.04', 'pkgname': 'tomcat8-user', 'pkgver': '8.0.32-1ubuntu1.10'},
    {'osver': '18.04', 'pkgname': 'libtomcat8-embed-java', 'pkgver': '8.5.39-1ubuntu1~18.04.3'},
    {'osver': '18.04', 'pkgname': 'libtomcat8-java', 'pkgver': '8.5.39-1ubuntu1~18.04.3'},
    {'osver': '18.04', 'pkgname': 'tomcat8', 'pkgver': '8.5.39-1ubuntu1~18.04.3'},
    {'osver': '18.04', 'pkgname': 'tomcat8-admin', 'pkgver': '8.5.39-1ubuntu1~18.04.3'},
    {'osver': '18.04', 'pkgname': 'tomcat8-common', 'pkgver': '8.5.39-1ubuntu1~18.04.3'},
    {'osver': '18.04', 'pkgname': 'tomcat8-examples', 'pkgver': '8.5.39-1ubuntu1~18.04.3'},
    {'osver': '18.04', 'pkgname': 'tomcat8-user', 'pkgver': '8.5.39-1ubuntu1~18.04.3'}
];
