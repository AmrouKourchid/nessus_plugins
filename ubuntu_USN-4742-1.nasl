...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS : Django vulnerability (USN-4742-1)");
...
in the USN-4742-1 advisory.

    It was discovered that Django incorrectly accepted semicolons as query parameters. A remote attacker could
    possibly use this issue to perform a Web Cache Poisoning attack.
