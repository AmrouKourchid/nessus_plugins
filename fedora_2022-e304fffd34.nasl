...
# extracted from Fedora Security Advisory FEDORA-2022-e304fffd34
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-e304fffd34");

  script_name(english:"Fedora 35 : vim (2022-e304fffd34)");
...
FEDORA-2022-e304fffd34 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-e304fffd34");
...
var pkgs = [
    {'reference':'vim-8.2.4804-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
