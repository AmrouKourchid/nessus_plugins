...
if (description)
{
  ...
  script_cve_id("CVE-2017-17973");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2017-17973");
...
patch available.
  ...
  - In LibTIFF 4.0.8, there is a heap-based use-after-free in the t2p_writeproc function in tiff2pdf.c. NOTE:
    there is a third-party report of inability to reproduce this issue (CVE-2017-17973)
