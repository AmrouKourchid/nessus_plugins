...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Nodejs PHSA-2024-5.0-0213");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'nodejs-20.11.1-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'nodejs-devel-20.11.1-1.ph5')) flag++;
