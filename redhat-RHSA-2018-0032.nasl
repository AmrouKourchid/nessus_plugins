...
# extracted from Red Hat Security Advisory RHSA-2018:0032. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:0032");
  script_xref(name:"IAVA", value:"2018-A-0020");
  script_xref(name:"IAVA", value:"2018-A-0017-S");

  script_name(english:"RHEL 7 : libvirt (RHSA-2018:0032) (Spectre)");
...
issue.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:0032");
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", sp:"2", cpu:"x86_64", reference:"libvirt-1.2.17-13.el7_2.7")) flag++;
  if (rpm_check(release:"RHEL7", sp:"2", cpu:"i686", reference:"libvirt-client-1.2.17-13.el7_2.7")) flag++;
  if (rpm_check(release:"RHEL7", sp:"2", cpu:"x86_64", reference:"libvirt-client-1.2.17-13.el7_2.7")) flag++;
  if (rpm_check(release:"RHEL7", sp:"2", cpu:"x86_64", reference:"libvirt-daemon-1.2.17-13.el7_2.7")) flag++;
  if (rpm_check(release:"RHEL7", sp:"2", cpu:"x86_64", reference:"libvirt-daemon-config-network-1.2.17-13.el7_2.7")) flag++;
  if (rpm_check(release:"RHEL7", sp:"2", cpu:"x86_64", reference:"libvirt-daemon-config-nwfilter-1.2.17-13.el7_2.7")) flag++;
  if (rpm_check(release:"RHEL7", sp:"2", cpu:"x86_64", reference:"libvirt-daemon-driver-interface-1.2.17-13.el7_2.7")) flag++;
  if (rpm_check(release:"RHEL7", sp:"2", cpu:"x86_64", reference:"libvirt-daemon-driver-lxc-1.2.17-13.el7_2.7")) flag++;
  if (rpm_check(release:"RHEL7", sp:"2", cpu:"x86_64", reference:"libvirt-daemon-driver-network-1.2.17-13.el7_2.7")) flag++;
  if (rpm_check(release:"RHEL7", sp:"2", cpu:"x86_64", reference:"libvirt-daemon-driver-nodedev-1.2.17-13.el7_2.7")) flag++;
  if (rpm_check(release:"RHEL7", sp:"2", cpu:"x86_64", reference:"libvirt-daemon-driver-nwfilter-1.2.17-13.el7_2.7")) flag++;
  if (rpm_check(release:"RHEL7", sp:"2", cpu:"x86_64", reference:"libvirt-daemon-driver-qemu-1.2.17-13.el7_2.7")) flag++;
  if (rpm_check(release:"RHEL7", sp:"2", cpu:"x86_64", reference:"libvirt-daemon-driver-secret-1.2.17-13.el7_2.7")) flag++;
  if (rpm_check(release:"RHEL7", sp:"2", cpu:"x86_64", reference:"libvirt-daemon-driver-storage-1.2.17-13.el7_2.7")) flag++;
  if (rpm_check(release:"RHEL7", sp:"2", cpu:"x86_64", reference:"libvirt-daemon-kvm-1.2.17-13.el7_2.7")) flag++;
  if (rpm_check(release:"RHEL7", sp:"2", cpu:"x86_64", reference:"libvirt-daemon-lxc-1.2.17-13.el7_2.7")) flag++;
  if (rpm_check(release:"RHEL7", sp:"2", cpu:"i686", reference:"libvirt-debuginfo-1.2.17-13.el7_2.7")) flag++;
  if (rpm_check(release:"RHEL7", sp:"2", cpu:"x86_64", reference:"libvirt-debuginfo-1.2.17-13.el7_2.7")) flag++;
  if (rpm_check(release:"RHEL7", sp:"2", cpu:"i686", reference:"libvirt-devel-1.2.17-13.el7_2.7")) flag++;
  if (rpm_check(release:"RHEL7", sp:"2", cpu:"x86_64", reference:"libvirt-devel-1.2.17-13.el7_2.7")) flag++;
  if (rpm_check(release:"RHEL7", sp:"2", cpu:"x86_64", reference:"libvirt-docs-1.2.17-13.el7_2.7")) flag++;
  if (rpm_check(release:"RHEL7", sp:"2", cpu:"x86_64", reference:"libvirt-lock-sanlock-1.2.17-13.el7_2.7")) flag++;
  if (rpm_check(release:"RHEL7", sp:"2", cpu:"x86_64", reference:"libvirt-login-shell-1.2.17-13.el7_2.7")) flag++;
