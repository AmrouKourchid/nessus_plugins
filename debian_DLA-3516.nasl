...
# extracted from Debian Security Advisory dla-3516. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3516 : burp - security update");
...
dla-3516 advisory.
    ...
    -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3516-1                debian-lts@lists.debian.org
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/burp");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/burp");
  script_set_attribute(attribute:"solution", value:
"Upgrade the burp packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:burp");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'burp', 'reference': '2.1.32-2+deb10u1'}
];
