...
# extracted from Fedora Security Advisory FEDORA-2024-73626281d8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-73626281d8");

  script_name(english:"Fedora 40 : hostapd / wpa_supplicant (2024-73626281d8)");
...
FEDORA-2024-73626281d8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-73626281d8");
  script_set_attribute(attribute:"solution", value:
"Update the affected 1:wpa_supplicant and / or hostapd packages.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:A/AC:L/PR:L/UI:R/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-52424");
...
var pkgs = [
    {'reference':'hostapd-2.11-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'wpa_supplicant-2.11-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'hostapd / wpa_supplicant');
}
