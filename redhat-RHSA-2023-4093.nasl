...
if (description)
{
  ...
  script_name(english:"RHEL 8 / 9 : OpenShift Container Platform 4.13.5 (RHSA-2023:4093)");
...
referenced in the RHSA-2023:4093 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.13.5. See the following
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3fbb4b73");
...
"Update the RHEL OpenShift Container Platform 4.13.5 package based on the guidance in RHSA-2023:4093.");
  ...
  script_cwe_id(94, 176, 288, 327, 400, 835);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openshift-clients-4.13.0-202306230038.p0.ge4c9a6a.assembly.stream.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2023-24534', 'CVE-2023-24536', 'CVE-2023-24537', 'CVE-2023-24538', 'CVE-2023-24539', 'CVE-2023-29400']},
      {'reference':'openshift-clients-redistributable-4.13.0-202306230038.p0.ge4c9a6a.assembly.stream.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2023-24534', 'CVE-2023-24536', 'CVE-2023-24537', 'CVE-2023-24538', 'CVE-2023-24539', 'CVE-2023-29400']},
      {'reference':'openshift-hyperkube-4.13.0-202307132344.p0.gf245ced.assembly.stream.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2023-1260', 'CVE-2023-3089']}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'openshift-clients-4.13.0-202306230038.p0.ge4c9a6a.assembly.stream.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2023-24534', 'CVE-2023-24536', 'CVE-2023-24537', 'CVE-2023-24538', 'CVE-2023-24539', 'CVE-2023-29400']},
      {'reference':'openshift-clients-redistributable-4.13.0-202306230038.p0.ge4c9a6a.assembly.stream.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2023-24534', 'CVE-2023-24536', 'CVE-2023-24537', 'CVE-2023-24538', 'CVE-2023-24539', 'CVE-2023-29400']},
      {'reference':'openshift-hyperkube-4.13.0-202307132344.p0.gf245ced.assembly.stream.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2023-1260', 'CVE-2023-3089']}
    ]
  }
];
