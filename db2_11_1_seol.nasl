...
if (description)
{
  ...
  script_name(english:"IBM DB2 SEoL (11.0.x <= x <= 11.1.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of IBM DB2 is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, IBM DB2 is between 11.0.x and 11.1.x. It is, therefore, no longer maintained by its vendor or
provider.
...
var constraints = [
  { max_branch : '11.1', min_branch : '11.0', eseol : 20260430, seol : 20220430 }
];
