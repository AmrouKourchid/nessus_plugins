...
if (description)
{
  ...
  script_cve_id("CVE-2021-47648");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2021-47648");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: gpu: host1x: Fix a memory leak in
    'host1x_remove()' Add a missing 'host1x_channel_list_free()' call in the remove function, as already done
    in the error handling path of the probe function. (CVE-2021-47648)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-47648");
