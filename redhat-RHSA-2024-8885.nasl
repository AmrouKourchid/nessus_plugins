...
# extracted from Red Hat Security Advisory RHSA-2024:8885. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:8885");

  script_name(english:"RHEL 8 : Red Hat Product OCP Tools 4.14 Openshift Jenkins (RHSA-2024:8885)");
...
referenced in the RHSA-2024:8885 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_8885.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?89775c37");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:8885");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat Product OCP Tools 4.14 Openshift Jenkins package based on the guidance in RHSA-2024:8885.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jenkins-2-plugins-4.14.1729839844-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'jenkins-2.462.3.1729839727-3.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
