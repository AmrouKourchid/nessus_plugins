...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : python-jinja2 (EulerOS-SA-2025-1164)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1164
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4f697b1d");
...
var pkgs = [
  "python3-jinja2-3.0.3-1.h4.eulerosv2r11"
];
