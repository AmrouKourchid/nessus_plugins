...
# extracted from Debian Security Advisory DLA-1933-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1933-1 : ruby-nokogiri security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"A command injection vulnerability in Nokogiri allows commands to be
executed in a subprocess by Ruby's `Kernel.open` method.
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2019/09/msg00027.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/jessie/ruby-nokogiri");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"ruby-nokogiri", reference:"1.6.3.1+ds-1+deb8u1")) flag++;
