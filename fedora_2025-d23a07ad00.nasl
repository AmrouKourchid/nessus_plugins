...
# extracted from Fedora Security Advisory FEDORA-2025-d23a07ad00
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-d23a07ad00");

  script_name(english:"Fedora 41 : deluge (2025-d23a07ad00)");
...
FEDORA-2025-d23a07ad00 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-d23a07ad00");
...
var pkgs = [
    {'reference':'deluge-2.2.0-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
