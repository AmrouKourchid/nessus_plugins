...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : glusterfs (EulerOS-SA-2024-1588)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1588
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?eebdba9c");
...
var pkgs = [
  "glusterfs-7.0-6.h3.eulerosv2r10",
  "python3-gluster-7.0-6.h3.eulerosv2r10"
];
