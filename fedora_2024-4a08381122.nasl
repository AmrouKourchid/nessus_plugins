...
# extracted from Fedora Security Advisory FEDORA-2024-4a08381122
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-4a08381122");
  script_xref(name:"IAVA", value:"2024-A-0540-S");

  script_name(english:"Fedora 40 : python-django (2024-4a08381122)");
...
FEDORA-2024-4a08381122 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-4a08381122");
...
var pkgs = [
    {'reference':'python-django-4.2.16-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
