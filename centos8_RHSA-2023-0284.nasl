...
# Red Hat Security Advisory RHSA-2023:0284. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : sudo (CESA-2023:0284)");
...
var pkgs = [
    {'reference':'sudo-1.8.29-8.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sudo-1.8.29-8.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
