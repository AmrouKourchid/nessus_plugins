...
# extracted from Debian Security Advisory dsa-5856. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5856 : redis - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-51741");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'redis', 'reference': '5:7.0.15-1~deb12u3'},
    {'release': '12.0', 'prefix': 'redis-sentinel', 'reference': '5:7.0.15-1~deb12u3'},
    {'release': '12.0', 'prefix': 'redis-server', 'reference': '5:7.0.15-1~deb12u3'},
    {'release': '12.0', 'prefix': 'redis-tools', 'reference': '5:7.0.15-1~deb12u3'}
];
