...
# extracted from Fedora Security Advisory FEDORA-2023-3d44a41fa3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-3d44a41fa3");

  script_name(english:"Fedora 37 : syslog-ng (2023-3d44a41fa3)");
...
FEDORA-2023-3d44a41fa3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-3d44a41fa3");
...
"Update the affected syslog-ng package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:syslog-ng");
...
var pkgs = [
    {'reference':'syslog-ng-3.37.1-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
