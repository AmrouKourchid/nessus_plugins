...
# extracted from Fedora Security Advisory FEDORA-2024-f2e57b108e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-f2e57b108e");
  script_xref(name:"IAVA", value:"2024-A-0452-S");

  script_name(english:"Fedora 39 : chromium (2024-f2e57b108e)");
...
FEDORA-2024-f2e57b108e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-f2e57b108e");
...
var pkgs = [
    {'reference':'chromium-127.0.6533.72-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
