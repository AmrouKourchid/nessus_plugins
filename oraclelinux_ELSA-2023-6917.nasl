...
# extracted from Oracle Linux Security Advisory ELSA-2023-6917.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : xorg-x11-server-Xwayland (ELSA-2023-6917)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-6917.html");
