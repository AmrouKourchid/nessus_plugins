...
# extracted from Oracle Linux Security Advisory ELSA-2024-3501.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : nghttp2 (ELSA-2024-3501)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-3501.html");
...
var pkgs = [
    ...
    {'reference':'nghttp2-1.43.0-5.el9_4.3', 'cpu':'i686', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
