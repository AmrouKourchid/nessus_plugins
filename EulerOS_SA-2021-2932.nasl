...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : icu (EulerOS-SA-2021-2932)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2932
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?383d4eef");
...
var pkgs = [
  ...
  "libicu-devel-50.1.2-15.h10.eulerosv2r7"
];
