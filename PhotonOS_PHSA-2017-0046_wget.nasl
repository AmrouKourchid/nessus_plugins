...
# extracted from VMware Security Advisory PHSA-2017-0046. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Wget PHSA-2017-0046");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the wget package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-2-3.md");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'wget-1.19.1-3.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'wget-debuginfo-1.19.1-3.ph2')) flag++;
