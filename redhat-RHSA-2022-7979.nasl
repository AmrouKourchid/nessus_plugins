...
# extracted from Red Hat Security Advisory RHSA-2022:7979. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:7979");

  script_name(english:"RHEL 9 : speex (RHSA-2022:7979)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for speex.");
...
the RHSA-2022:7979 advisory.

    Speex is a patent-free compression format designed especially for speech. It is specialized for voice
    communications at low bit-rates.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_7979.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?13e5305f");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/9/html/9.1_release_notes/index
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1f1eb6cc");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:7979");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2024250");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL speex package based on the guidance in RHSA-2022:7979.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:speex");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:speex-devel");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'speex-1.2.0-11.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'speex-devel-1.2.0-11.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
