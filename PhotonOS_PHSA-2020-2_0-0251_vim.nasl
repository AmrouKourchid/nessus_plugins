...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Vim PHSA-2020-2.0-0251");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'vim-8.0.0533-8.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'vim-extra-8.0.0533-8.ph2')) flag++;
