...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : libmspack on SL7.x x86_64 (20201001)");
...
"Security Fix(es) :
  ...
  - libmspack: buffer overflow in function
    chmd_read_headers() (CVE-2019-1010305)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind2010&L=SCIENTIFIC-LINUX-ERRATA&P=24552
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2295e6d8");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"libmspack-0.5-0.8.alpha.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"libmspack-debuginfo-0.5-0.8.alpha.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"libmspack-devel-0.5-0.8.alpha.el7")) flag++;
