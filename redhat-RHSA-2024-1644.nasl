...
# extracted from Red Hat Security Advisory RHSA-2024:1644. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:1644");

  script_name(english:"RHEL 8 : grafana-pcp (RHSA-2024:1644)");
...
the RHSA-2024:1644 advisory.
    ...
    * TRIAGE CVE-2024-1394 grafana-pcp: golang-fips/openssl: Memory leaks in code encrypting and decrypting
    RSA payloads (JIRA:RHEL-30544)

Tenable has extracted the preceding description block directly from the Red Hat Enterprise Linux security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_1644.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fee8b978");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2262921");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:1644");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL grafana-pcp package based on the guidance in RHSA-2024:1644.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'grafana-pcp-5.1.1-2.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
