...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5053620");
  script_xref(name:"MSKB", value:"5053627");
  script_xref(name:"MSFT", value:"MS25-5053620");
  script_xref(name:"MSFT", value:"MS25-5053627");
  ...
  script_name(english:"KB5053627: Windows Server 2008 R2 Security Update (March 2025)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5053620");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5053627");
...
if (("windows server 2008 r2" >< tolower(os_name)) &&
  smb_check_rollup(os:'6.1',
                   ...
                   rollup_date:'03_2025',
                   bulletin:bulletin,
                   rollup_kb_list:[5053627, 5053620])
)
{
