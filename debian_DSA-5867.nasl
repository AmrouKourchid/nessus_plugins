...
# extracted from Debian Security Advisory dsa-5867. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5867 : gnutls-bin - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 12 host has packages installed that are affected by a vulnerability as referenced in the dsa-5867
advisory.

    - -------------------------------------------------------------------------
    Debian Security Advisory DSA-5867-1                   security@debian.org
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-12243");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bookworm/gnutls28");
...
"Upgrade the gnutls-bin packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:libgnutlsxx30");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'gnutls-bin', 'reference': '3.7.9-2+deb12u4'},
    {'release': '12.0', 'prefix': 'gnutls-doc', 'reference': '3.7.9-2+deb12u4'},
    {'release': '12.0', 'prefix': 'guile-gnutls', 'reference': '3.7.9-2+deb12u4'},
    {'release': '12.0', 'prefix': 'libgnutls-dane0', 'reference': '3.7.9-2+deb12u4'},
    {'release': '12.0', 'prefix': 'libgnutls-openssl27', 'reference': '3.7.9-2+deb12u4'},
    {'release': '12.0', 'prefix': 'libgnutls28-dev', 'reference': '3.7.9-2+deb12u4'},
    {'release': '12.0', 'prefix': 'libgnutls30', 'reference': '3.7.9-2+deb12u4'},
    {'release': '12.0', 'prefix': 'libgnutlsxx30', 'reference': '3.7.9-2+deb12u4'}
];
