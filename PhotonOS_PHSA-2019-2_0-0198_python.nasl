...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Python PHSA-2019-2.0-0198");
...
if (rpm_exists(rpm:'python-cryptography-2.3', release:'PhotonOS-2.0') && rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'python-cryptography-2.3.1-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'python-cryptography-debuginfo-2.3.1-1.ph2')) flag++;
