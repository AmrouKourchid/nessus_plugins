...
# extracted from Fedora Security Advisory FEDORA-2025-bca38111fc
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-bca38111fc");

  script_name(english:"Fedora 40 : icecat (2025-bca38111fc)");
...
FEDORA-2025-bca38111fc advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-bca38111fc");
...
var pkgs = [
    {'reference':'icecat-115.22.0-2.rh1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
