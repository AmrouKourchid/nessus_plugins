...
# extracted from Fedora Security Advisory FEDORA-2023-b7e90bc682
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-b7e90bc682");

  script_name(english:"Fedora 36 : stellarium (2023-b7e90bc682)");
...
FEDORA-2023-b7e90bc682 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-b7e90bc682");
...
var pkgs = [
    {'reference':'stellarium-1.2-9.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
