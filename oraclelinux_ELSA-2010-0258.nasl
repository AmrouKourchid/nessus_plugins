...
# extracted from Oracle Linux Security Advisory ELSA-2010-0258.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : pam_krb5 (ELSA-2010-0258)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2010-0258.html");
...
"Update the affected pam_krb5 package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2009-1384");
...
var pkgs = [
    {'reference':'pam_krb5-2.2.14-15', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pam_krb5-2.2.14-15', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
