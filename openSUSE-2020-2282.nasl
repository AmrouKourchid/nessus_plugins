...
# extracted from openSUSE Security Update openSUSE-2020-2282.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : python-urllib3 (openSUSE-2020-2282)");
...
project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1177120");
...
if ( rpm_check(release:"SUSE15.1", reference:"python2-urllib3-1.24-lp151.2.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"python2-urllib3-test-1.24-lp151.2.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"python3-urllib3-1.24-lp151.2.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"python3-urllib3-test-1.24-lp151.2.9.1") ) flag++;
