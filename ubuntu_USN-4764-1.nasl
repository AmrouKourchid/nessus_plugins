...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 20.04 LTS : GLib vulnerability (USN-4764-1)");
...
referenced in the USN-4764-1 advisory.

    It was discovered that GLib incorrectly handled certain symlinks when replacing files. If a user or
    automated system were tricked into extracting a specially crafted file with File Roller, a remote attacker
    could possibly create files outside of the intended directory.
