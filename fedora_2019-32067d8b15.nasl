...
# extracted from Fedora Security Advisory FEDORA-2019-32067d8b15.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-32067d8b15");

  script_name(english:"Fedora 29 : php-symfony4 (2019-32067d8b15)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-32067d8b15");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"php-symfony4-4.1.12-1.fc29")) flag++;
