...
if (description)
{
  ...
  script_cve_id("CVE-2023-50312");
  script_xref(name:"IAVA", value:"2024-A-0122-S");

  script_name(english:"IBM WebSphere Application Server Liberty 17.0.0.3 < 24.0.0.3 (7125527)");
...
referenced in the 7125527 advisory.

  - IBM WebSphere Application Server Liberty 17.0.0.3 through 24.0.0.2 could provide weaker than expected
    security for outbound TLS connections caused by a failure to honor user configuration. IBM X-Force ID:
    274711. (CVE-2023-50312)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/node/7125527");
  script_set_attribute(attribute:"solution", value:
"Update to IBM WebSphere Application Server Liberty version 24.0.0.3 or later. Alternatively, upgrade to the minimal fix
pack levels required by the interim fix and then apply Interim Fix PH60113.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-50312");
...
if ('PH60113' >< app_info['Fixes'])
  audit(AUDIT_INST_VER_NOT_VULN, app);

var constraints = [
  { 'min_version' : '17.0.0.3', 'fixed_version' : '24.0.0.3', 'fixed_display' : '24.0.0.3 or Interim Fix PH60113' }
];
