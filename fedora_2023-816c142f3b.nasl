...
# extracted from Fedora Security Advisory FEDORA-2023-816c142f3b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-816c142f3b");

  script_name(english:"Fedora 37 : thunderbird (2023-816c142f3b)");
...
FEDORA-2023-816c142f3b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-816c142f3b");
...
var pkgs = [
    {'reference':'thunderbird-102.11.0-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
