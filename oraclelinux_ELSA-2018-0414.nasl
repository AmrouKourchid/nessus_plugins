...
# Oracle Linux Security Advisory ELSA-2018-0414 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : 389-ds-base (ELSA-2018-0414)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 7 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ELSA-2018-0414 advisory.

    - Resolves: Bug 1540105 - CVE-2018-1054 - remote Denial of Service (DoS) via search filters in
    SetUnicodeStringFromUTF_8
    - Resolves: Bug 1535539 - CVE-2017-15135 - Authentication bypass due to lack of size check in
    slapi_ct_memcmp function

Tenable has extracted the preceding description block directly from the Oracle Linux security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2018-0414.html");
...
var pkgs = [
    {'reference':'389-ds-base-1.3.6.1-28.el7_4', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'389-ds-base-devel-1.3.6.1-28.el7_4', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'389-ds-base-libs-1.3.6.1-28.el7_4', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'389-ds-base-snmp-1.3.6.1-28.el7_4', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
];
