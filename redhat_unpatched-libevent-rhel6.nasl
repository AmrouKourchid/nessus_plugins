...
# extracted from Red Hat Security Advisory libevent. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2016-10195", "CVE-2016-10197");

  script_name(english:"RHEL 6 : libevent (Unpatched Vulnerability) (deprecated)");
