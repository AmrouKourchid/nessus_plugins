...
# extracted from Fedora Security Advisory FEDORA-2024-126d22c121
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-126d22c121");
  script_xref(name:"IAVB", value:"2024-B-0161-S");

  script_name(english:"Fedora 40 : pgadmin4 (2024-126d22c121)");
...
FEDORA-2024-126d22c121 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-126d22c121");
...
"Update the affected pgadmin4 package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-9014");
...
var pkgs = [
    {'reference':'pgadmin4-8.9-3.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
