...
# extracted from Fedora Security Advisory FEDORA-2023-dd526ed2e4
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-dd526ed2e4");

  script_name(english:"Fedora 37 : python3.7 (2023-dd526ed2e4)");
...
FEDORA-2023-dd526ed2e4 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-dd526ed2e4");
...
var pkgs = [
    {'reference':'python3.7-3.7.16-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
