...
if (description)
{
  ...
  script_cve_id("CVE-2022-39401");
  script_xref(name:"IAVA", value:"2022-A-0433");

  script_name(english:"Oracle Solaris Critical Patch Update : oct2022_SRU11_4_49_126_2");
...
security update :
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-39401");
...
fix_release = "11.4-11.4.49.0.1.126.2";

flag = 0;

if (solaris_check_release(release:"11.4-11.4.49.0.1.126.2", sru:"11.4.49.126.2") > 0) flag++;
