...
# extracted from Oracle Linux Security Advisory ELSA-2024-0001.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : thunderbird (ELSA-2024-0001)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-0001.html");
...
var pkgs = [
    {'reference':'thunderbird-115.6.0-1.0.1.el9_3', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'thunderbird-115.6.0-1.0.1.el9_3', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
