...
# extracted from Red Hat Security Advisory RHSA-2019:2630. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:2630");

  script_name(english:"RHEL 7 : redis (RHSA-2019:2630)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_2630.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9fe66466");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:2630");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL redis package based on the guidance in RHSA-2019:2630.");
