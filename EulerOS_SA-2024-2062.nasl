...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : tigervnc (EulerOS-SA-2024-2062)");
...
Tenable has extracted the preceding description block directly from the EulerOS tigervnc security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2062
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?37ed6961");
...
var pkgs = [
  "tigervnc-1.9.0-3.h10.eulerosv2r8",
  "tigervnc-icons-1.9.0-3.h10.eulerosv2r8",
  "tigervnc-license-1.9.0-3.h10.eulerosv2r8",
  "tigervnc-server-1.9.0-3.h10.eulerosv2r8",
  "tigervnc-server-minimal-1.9.0-3.h10.eulerosv2r8"
];
