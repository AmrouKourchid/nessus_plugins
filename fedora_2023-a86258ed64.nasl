...
# extracted from Fedora Security Advisory FEDORA-2023-a86258ed64
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-a86258ed64");

  script_name(english:"Fedora 37 : mingw-binutils (2023-a86258ed64)");
...
FEDORA-2023-a86258ed64 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-a86258ed64");
...
var pkgs = [
    {'reference':'mingw-binutils-2.38-7.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
