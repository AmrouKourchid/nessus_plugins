...
# extracted from openSUSE Security Update openSUSE-2020-653.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : ghostscript (openSUSE-2020-653)");
...
This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1170603");
...
if ( rpm_check(release:"SUSE15.1", reference:"ghostscript-9.52-lp151.3.12.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"ghostscript-debuginfo-9.52-lp151.3.12.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"ghostscript-debugsource-9.52-lp151.3.12.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"ghostscript-devel-9.52-lp151.3.12.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"ghostscript-mini-9.52-lp151.3.12.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"ghostscript-mini-debuginfo-9.52-lp151.3.12.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"ghostscript-mini-debugsource-9.52-lp151.3.12.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"ghostscript-mini-devel-9.52-lp151.3.12.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"ghostscript-x11-9.52-lp151.3.12.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"ghostscript-x11-debuginfo-9.52-lp151.3.12.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libspectre-debugsource-0.2.8-lp151.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libspectre-devel-0.2.8-lp151.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libspectre1-0.2.8-lp151.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libspectre1-debuginfo-0.2.8-lp151.3.3.1") ) flag++;
