...
# extracted from Gentoo Linux Security Advisory GLSA 201909-03.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201909-03");

  script_name(english:"GLSA-201909-03 : Pango: Buffer overflow");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-201909-03
(Pango: Buffer overflow)

    A buffer overflow has been discovered in Pango&rsquo;s
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/201909-03");
...
if (qpkg_check(package:"x11-libs/pango", unaffected:make_list("ge 1.42.4-r2"), vulnerable:make_list("lt 1.42.4-r2"))) flag++;
