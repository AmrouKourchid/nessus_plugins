...
# extracted from Fedora Security Advisory FEDORA-2019-af3d726d38.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : gsi-openssh (2019-af3d726d38)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-af3d726d38");
  script_set_attribute(attribute:"solution", value:
"Update the affected gsi-openssh package.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:P/I:N/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:H/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-7639");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"gsi-openssh-7.9p1-5.fc29")) flag++;
