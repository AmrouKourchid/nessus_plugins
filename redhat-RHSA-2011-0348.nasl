...
# extracted from Red Hat Security Advisory RHSA-2011:0348. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2011:0348");

  script_name(english:"RHEL 5 : tomcat6 (RHSA-2011:0348)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for tomcat6.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 5 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2011:0348 advisory.

  - JDK Double.parseDouble Denial-Of-Service (CVE-2010-4476)

  - tomcat: remote DoS via NIO connector (CVE-2011-0534)
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=675338");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2011/rhsa-2011_0348.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3cd491f6");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2011:0348");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL tomcat6 package based on the guidance in RHSA-2011:0348.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'tomcat6-6.0.24-11.patch_03.ep5.el5', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'tomcat'},
      {'reference':'tomcat6-admin-webapps-6.0.24-11.patch_03.ep5.el5', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'tomcat'},
      {'reference':'tomcat6-docs-webapp-6.0.24-11.patch_03.ep5.el5', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'tomcat'},
      {'reference':'tomcat6-el-1.0-api-6.0.24-11.patch_03.ep5.el5', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'tomcat'},
      {'reference':'tomcat6-javadoc-6.0.24-11.patch_03.ep5.el5', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'tomcat'},
      {'reference':'tomcat6-jsp-2.1-api-6.0.24-11.patch_03.ep5.el5', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'tomcat'},
      {'reference':'tomcat6-lib-6.0.24-11.patch_03.ep5.el5', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'tomcat'},
      {'reference':'tomcat6-log4j-6.0.24-11.patch_03.ep5.el5', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'tomcat'},
      {'reference':'tomcat6-servlet-2.5-api-6.0.24-11.patch_03.ep5.el5', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'tomcat'},
      {'reference':'tomcat6-webapps-6.0.24-11.patch_03.ep5.el5', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'tomcat'}
    ]
  }
];
