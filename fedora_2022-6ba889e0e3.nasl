...
# extracted from Fedora Security Advisory FEDORA-2022-6ba889e0e3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-6ba889e0e3");
  script_xref(name:"IAVA", value:"2023-A-0061-S");

  script_name(english:"Fedora 36 : python3.11 (2022-6ba889e0e3)");
...
FEDORA-2022-6ba889e0e3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-6ba889e0e3");
...
var pkgs = [
    {'reference':'python3.11-3.11.1-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
