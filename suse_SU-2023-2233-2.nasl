...
# SUSE update advisory SUSE-SU-2023:2233-2. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:2233-2");

  script_name(english:"openSUSE 15 Security Update : cups-filters (SUSE-SU-2023:2233-2)");
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-July/015529.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?68d770ea");
...
var pkgs = [
    {'reference':'cups-filters-1.25.0-150200.3.6.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.5']},
    {'reference':'cups-filters-devel-1.25.0-150200.3.6.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.5']}
];
