...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : ghostscript (EulerOS-SA-2020-2344)");
...
vulnerabilities :
  ...
  - A buffer overflow vulnerability in lprn_is_black() in
    ...
    denial of service via a crafted PDF
    file.(CVE-2020-16287)
  ...
  - A buffer overflow vulnerability in
    ...
    cause a denial of service via a crafted PDF
    file.(CVE-2020-16288)
  ...
  - A buffer overflow vulnerability in
    ...
    Software GhostScript v9.50 allows a remote attacker to
    cause a denial of service via a crafted eps
    file.(CVE-2020-16309)
  ...
  - A buffer overflow vulnerability in
    jetp3852_print_page() in devices/gdev3852.c of Artifex
    Software GhostScript v9.50 allows a remote attacker to
    escalate privileges via a crafted PDF
    file.(CVE-2020-16302)
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2344
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4772980d");
...
"Update the affected ghostscript packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-9611");
...
pkgs = ["ghostscript-9.07-31.6.h20",
        "ghostscript-cups-9.07-31.6.h20"];
