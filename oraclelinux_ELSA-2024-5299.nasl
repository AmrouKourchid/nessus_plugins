...
# extracted from Oracle Linux Security Advisory ELSA-2024-5299.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : wget (ELSA-2024-5299)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-5299.html");
...
var pkgs = [
    {'reference':'wget-1.19.5-12.0.1.el8_10', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'wget-1.19.5-12.0.1.el8_10', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
