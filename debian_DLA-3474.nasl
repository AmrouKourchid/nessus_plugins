...
# extracted from Debian Security Advisory dla-3474. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3474 : libnss-myhostname - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3474
advisory.

    - -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3474-1                debian-lts@lists.debian.org
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-3821");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libnss-myhostname', 'reference': '241-7~deb10u10'},
    {'release': '10.0', 'prefix': 'libnss-mymachines', 'reference': '241-7~deb10u10'},
    {'release': '10.0', 'prefix': 'libnss-resolve', 'reference': '241-7~deb10u10'},
    {'release': '10.0', 'prefix': 'libnss-systemd', 'reference': '241-7~deb10u10'},
    {'release': '10.0', 'prefix': 'libpam-systemd', 'reference': '241-7~deb10u10'},
    {'release': '10.0', 'prefix': 'libsystemd-dev', 'reference': '241-7~deb10u10'},
    {'release': '10.0', 'prefix': 'libsystemd0', 'reference': '241-7~deb10u10'},
    {'release': '10.0', 'prefix': 'libudev-dev', 'reference': '241-7~deb10u10'},
    {'release': '10.0', 'prefix': 'libudev1', 'reference': '241-7~deb10u10'},
    {'release': '10.0', 'prefix': 'systemd', 'reference': '241-7~deb10u10'},
    {'release': '10.0', 'prefix': 'systemd-container', 'reference': '241-7~deb10u10'},
    {'release': '10.0', 'prefix': 'systemd-coredump', 'reference': '241-7~deb10u10'},
    {'release': '10.0', 'prefix': 'systemd-journal-remote', 'reference': '241-7~deb10u10'},
    {'release': '10.0', 'prefix': 'systemd-sysv', 'reference': '241-7~deb10u10'},
    {'release': '10.0', 'prefix': 'systemd-tests', 'reference': '241-7~deb10u10'},
    {'release': '10.0', 'prefix': 'udev', 'reference': '241-7~deb10u10'}
];
