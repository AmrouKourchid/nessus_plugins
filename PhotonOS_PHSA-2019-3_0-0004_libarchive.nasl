...
# extracted from VMware Security Advisory PHSA-2019-3.0-0004. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Libarchive PHSA-2019-3.0-0004");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the libarchive package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-3.0-4.md");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libarchive-3.3.3-2.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libarchive-debuginfo-3.3.3-2.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libarchive-devel-3.3.3-2.ph3')) flag++;
