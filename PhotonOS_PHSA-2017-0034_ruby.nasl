...
if (description)
{
  ...
  script_cve_id("CVE-2017-14064");

  script_name(english:"Photon OS 1.0: Ruby PHSA-2017-0034");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-14064");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'ruby-2.4.0-6.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'ruby-debuginfo-2.4.0-6.ph1')) flag++;
