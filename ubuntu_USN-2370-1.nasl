...
# extracted from Ubuntu Security Notice USN-2370-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : APT vulnerability (USN-2370-1)");
...
USN-2370-1 advisory.
    ...
    Guillem Jover discovered that APT incorrectly created a temporary file when handling the changelog
    command. A local attacker could use this issue to overwrite arbitrary files. In the default installation
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2370-1");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-7206");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'apt', 'pkgver': '1.0.1ubuntu2.5'},
    {'osver': '14.04', 'pkgname': 'apt-transport-https', 'pkgver': '1.0.1ubuntu2.5'},
    {'osver': '14.04', 'pkgname': 'apt-utils', 'pkgver': '1.0.1ubuntu2.5'},
    {'osver': '14.04', 'pkgname': 'libapt-inst1.5', 'pkgver': '1.0.1ubuntu2.5'},
    {'osver': '14.04', 'pkgname': 'libapt-pkg-dev', 'pkgver': '1.0.1ubuntu2.5'},
    {'osver': '14.04', 'pkgname': 'libapt-pkg4.12', 'pkgver': '1.0.1ubuntu2.5'}
];
