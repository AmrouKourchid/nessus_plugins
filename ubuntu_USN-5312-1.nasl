...
# extracted from Ubuntu Security Notice USN-5312-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5312-1");

  script_name(english:"Ubuntu 20.04 LTS : HAProxy vulnerability (USN-5312-1)");
...
USN-5312-1 advisory.
    ...
    It was discovered that HAProxy incorrectly handled certain headers. A remote attacker could possibly use
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5312-1");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'haproxy', 'pkgver': '2.0.13-2ubuntu0.5'},
    {'osver': '20.04', 'pkgname': 'vim-haproxy', 'pkgver': '2.0.13-2ubuntu0.5'}
];
