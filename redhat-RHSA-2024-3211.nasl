...
# extracted from Red Hat Security Advisory RHSA-2024:3211. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:3211");

  script_name(english:"RHEL 8 : traceroute (RHSA-2024:3211)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_3211.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c96a6f3c");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2246303");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:3211");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL traceroute package based on the guidance in RHSA-2024:3211.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'traceroute-2.1.0-8.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'}
    ]
  }
];
