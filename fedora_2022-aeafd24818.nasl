...
# extracted from Fedora Security Advisory FEDORA-2022-aeafd24818
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-aeafd24818");

  script_name(english:"Fedora 36 : libxml2 / xmlsec1 (2022-aeafd24818)");
...
FEDORA-2022-aeafd24818 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-aeafd24818");
...
var pkgs = [
    {'reference':'libxml2-2.10.3-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xmlsec1-1.2.33-3.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
