...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.0 : deltarpm (EulerOS-SA-2023-1217)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the deltarpm package installed, the EulerOS Virtualization installation on the remote host
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1217
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1a97b8ba");
...
var pkgs = [
  "deltarpm-3.6.2-2.h3.eulerosv2r9"
];
