...
if (description)
{
  ...
  script_name(english:"Adobe Photoshop CC 18.x < 18.1.6 / CC 19.x < 19.1.6 Multiple Vulnerabilities (APSB18-28)");

  script_set_attribute(attribute:"synopsis", value:
"Adobe Photoshop installed on remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Photoshop CC installed on the remote Windows host is prior to 18.1.6/19.1.6. It is, therefore,
affected by multiple vulnerabilities as referenced in the apsb18-28 advisory.
