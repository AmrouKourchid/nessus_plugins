...
# extracted from Red Hat Security Advisory RHSA-2020:0120. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : thunderbird (RHSA-2020:0120)");
...
referenced in the RHSA-2020:0120 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_0120.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5441dc58");
...
"Update the RHEL thunderbird package based on the guidance in RHSA-2020:0120.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'thunderbird-68.4.1-2.el7_7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'thunderbird-68.4.1-2.el7_7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
