...
if (description)
{
  ...
  script_name(english:"RHCOS 4 : OpenShift Container Platform 4.9.56 (RHSA-2023:0777)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat CoreOS host is missing one or more security updates for OpenShift Container Platform 4.9.56.");
...
as referenced in the RHSA-2023:0777 advisory.
...
"Update the RHCOS OpenShift Container Platform 4.9.56 package based on the guidance in RHSA-2023:0777.");
  ...
  script_cwe_id(20, 22, 79, 200, 203, 208, 285, 328, 352, 358, 400, 410, 502, 552, 668, 693, 838, 862, 1066);
...
var pkgs = [
    {'reference':'jenkins-2-plugins-4.9.1675668922-1.el8', 'release':'4', 'el_string':'el8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
    {'reference':'jenkins-2.361.1.1675668150-1.el8', 'release':'4', 'el_string':'el8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
];
