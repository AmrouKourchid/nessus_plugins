...
# extracted from Fedora Security Advisory FEDORA-2019-1030f4816a.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : libmp4v2 (2019-1030f4816a)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-1030f4816a");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"libmp4v2-2.1.0-0.19.trunkREV507.fc30")) flag++;
