...
# extracted from Fedora Security Advisory FEDORA-2018-eaa7de17ae.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-eaa7de17ae");

  script_name(english:"Fedora 28 : botan2 (2018-eaa7de17ae)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-eaa7de17ae");
  script_set_attribute(attribute:"see_also", value:"https://botan.randombit.net/news.html#version-2-7-0-2018-07-02");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"botan2-2.7.0-1.fc28")) flag++;
