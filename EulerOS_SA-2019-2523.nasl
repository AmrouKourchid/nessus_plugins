...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : elfutils (EulerOS-SA-2019-2523)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the version of the elfutils packages installed, the
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2523
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8101f2f8");
...
pkgs = ["elfutils-0.170-4.h5.eulerosv2r7",
        "elfutils-default-yama-scope-0.170-4.h5.eulerosv2r7",
        "elfutils-devel-0.170-4.h5.eulerosv2r7",
        "elfutils-libelf-0.170-4.h5.eulerosv2r7",
        "elfutils-libelf-devel-0.170-4.h5.eulerosv2r7",
        "elfutils-libs-0.170-4.h5.eulerosv2r7"];
