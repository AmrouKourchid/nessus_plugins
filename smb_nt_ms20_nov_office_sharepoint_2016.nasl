...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"4486717");
  script_xref(name:"MSFT", value:"MS20-4486717");
  script_xref(name:"IAVA", value:"2020-A-0514-S");
  script_xref(name:"CEA-ID", value:"CEA-2020-0135");

  script_name(english:"Security Updates for Microsoft SharePoint Server 2016 (November 2020)");
...
affected by multiple vulnerabilities :
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e0592c63");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released KB4486717 to address this issue.");
