...
if (description)
{
  ...
  script_name(english:"Virtuozzo 6 : parallels-server-bm-release / shaman / vzkernel / etc (VZA-2019-033)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Virtuozzo host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the version of the parallels-server-bm-release / shaman
/ vzkernel / etc packages installed, the Virtuozzo installation on
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://virtuozzosupport.force.com/s/article/VZA-2019-033");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:0717");
  script_set_attribute(attribute:"solution", value:
"Update the affected parallels-server-bm-release / shaman / vzkernel / etc package.");
...
pkgs = ["parallels-server-bm-release-6.0.12-3738",
        "shaman-6.0.12-80",
        "vzkernel-2.6.32-042stab137.1",
        "vzkernel-devel-2.6.32-042stab137.1",
        "vzkernel-firmware-2.6.32-042stab137.1",
        "vzmodules-2.6.32-042stab137.1",
        "vzmodules-devel-2.6.32-042stab137.1"];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "parallels-server-bm-release / shaman / vzkernel / etc");
}
