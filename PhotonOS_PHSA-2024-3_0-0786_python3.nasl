...
# extracted from VMware Security Advisory PHSA-2024-3.0-0786. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Python3 PHSA-2024-3.0-0786");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the python3 package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-3.0-786.md");
...
if (rpm_check(release:'PhotonOS-3.0', reference:'python3-setuptools-57.4.0-2.ph3')) flag++;
