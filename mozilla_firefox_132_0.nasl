...
"The version of Firefox installed on the remote Windows host is prior to 132.0. It is, therefore, affected by multiple
vulnerabilities as referenced in the mfsa2024-55 advisory.
...
mozilla_check_version(installs:installs, product:'firefox', esr:FALSE, fix:'132.0', severity:SECURITY_HOLE);
