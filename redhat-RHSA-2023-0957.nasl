...
# extracted from Red Hat Security Advisory RHSA-2023:0957. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:0957");

  script_name(english:"RHEL 9 : lua (RHSA-2023:0957)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for lua.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2023:0957 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_0957.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8a798e61");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:0957");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL lua package based on the guidance in RHSA-2023:0957.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'lua-5.4.4-2.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'lua-devel-5.4.4-2.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'lua-libs-5.4.4-2.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
