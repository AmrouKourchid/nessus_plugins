...
# extracted from Debian Security Advisory dla-3005. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-3005-1 : lrzip - LTS security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 9 host has a package installed that is affected by a vulnerability as referenced in the dla-3005
advisory.

    lrzip, a compression program, was found to have a heap memory corruption bug. For Debian 9 stretch, this
    problem has been fixed in version 0.631-1+deb9u3. We recommend that you upgrade your lrzip packages. For
    the detailed security status of lrzip please refer to its security tracker page at: https://security-
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2022/dla-3005");
...
var pkgs = [
    {'release': '9.0', 'prefix': 'lrzip', 'reference': '0.631-1+deb9u3'}
];
