...
# extracted from Red Hat Security Advisory RHSA-2023:6882. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:6882");

  script_name(english:"RHEL 6 : squid34 (RHSA-2023:6882)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for squid34.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6882.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a8f14a85");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#critical");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2245916");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6882");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL squid34 package based on the guidance in RHSA-2023:6882.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'squid34-3.4.14-15.el6_10.1', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'squid34-3.4.14-15.el6_10.1', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'squid34-3.4.14-15.el6_10.1', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
    ]
  }
];
