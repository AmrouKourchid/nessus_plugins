...
# extracted from Fedora Security Advisory FEDORA-2023-09f0496e60
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-09f0496e60");

  script_name(english:"Fedora 37 : mod_security (2023-09f0496e60)");
...
FEDORA-2023-09f0496e60 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-09f0496e60");
...
var pkgs = [
    {'reference':'mod_security-2.9.7-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
