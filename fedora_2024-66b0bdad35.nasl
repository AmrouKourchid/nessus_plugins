...
# extracted from Fedora Security Advisory FEDORA-2024-66b0bdad35
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-66b0bdad35");

  script_name(english:"Fedora 40 : yarnpkg (2024-66b0bdad35)");
...
FEDORA-2024-66b0bdad35 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-66b0bdad35");
...
var pkgs = [
    {'reference':'yarnpkg-1.22.22-5.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
