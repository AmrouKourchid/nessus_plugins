...
# extracted from ZTE advisory NS-SA-2023-0056. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 5.04 : kernel Vulnerability (NS-SA-2023-0056)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/notice/NS-SA-2023-0056");
...
var pkgs = {
  'CGSL MAIN 5.04': [
    'kernel-3.10.0-693.21.1.el7.cgslv5_4.55.1132.3.gc8be537',
    'kernel-abi-whitelists-3.10.0-693.21.1.el7.cgslv5_4.55.1132.3.gc8be537',
    'kernel-devel-3.10.0-693.21.1.el7.cgslv5_4.55.1132.3.gc8be537',
    'kernel-headers-3.10.0-693.21.1.el7.cgslv5_4.55.1132.3.gc8be537',
    'kernel-tools-3.10.0-693.21.1.el7.cgslv5_4.55.1132.3.gc8be537',
    'kernel-tools-libs-3.10.0-693.21.1.el7.cgslv5_4.55.1132.3.gc8be537',
    'kernel-tools-libs-devel-3.10.0-693.21.1.el7.cgslv5_4.55.1132.3.gc8be537',
    'perf-3.10.0-693.21.1.el7.cgslv5_4.55.1132.3.gc8be537',
    'python-perf-3.10.0-693.21.1.el7.cgslv5_4.55.1132.3.gc8be537'
  ]
};
