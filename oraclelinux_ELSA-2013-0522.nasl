...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2013-0522.html");
  script_set_attribute(attribute:"solution", value:
"Update the affected gdb and / or gdb-gdbserver packages.");
...
var pkgs = [
    {'reference':'gdb-7.2-60.el6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'gdb-gdbserver-7.2-60.el6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'gdb-7.2-60.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'gdb-gdbserver-7.2-60.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
];
