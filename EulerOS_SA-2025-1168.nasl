...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : xorg-x11-server (EulerOS-SA-2025-1168)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1168
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?de8268c5");
...
var pkgs = [
  "xorg-x11-server-help-1.20.11-4.h17.eulerosv2r11"
];
