...
# extracted from Oracle Linux Security Advisory ELSA-2020-1113.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : bash (ELSA-2020-1113)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 7 host has packages installed that are affected by a vulnerability as referenced in the
ELSA-2020-1113 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2020-1113.html");
...
var pkgs = [
    {'reference':'bash-4.2.46-34.el7', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'bash-doc-4.2.46-34.el7', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
