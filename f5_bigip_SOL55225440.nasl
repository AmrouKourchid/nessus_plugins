...
# extracted from F5 Networks BIG-IP Solution K55225440.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2017-6148");

  script_name(english:"F5 Networks BIG-IP : BIG-IP SOCKS proxy vulnerability (K55225440)");

  script_set_attribute(attribute:"synopsis", value:
"The remote device is missing a vendor-supplied security patch.");
  script_set_attribute(attribute:"description", value:
"Responses to SOCKS proxy requests made through the BIG-IP system may
...
a BIG-IP system by causing the TMM process to restart.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K55225440");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K55225440.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-6148");
...
var vmatrix = {
  'AFM': {
    'affected': [
      '13.0.0','12.0.0-12.1.3','11.6.1-11.6.2','11.5.1-11.5.5'
    ],
    'unaffected': [
