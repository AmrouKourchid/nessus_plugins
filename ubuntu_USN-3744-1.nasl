...
vulnerabilities as referenced in the USN-3744-1 advisory.

    Andrew Krasichkov discovered that the PostgreSQL client library incorrectly reset its internal state
    between connections. A remote attacker could possibly use this issue to bypass certain client-side
    connection security features. This issue only affected Ubuntu 16.04 LTS and Ubuntu 18.04 LTS.
    (CVE-2018-10915)

    It was discovered that PostgreSQL incorrectly checked authorization on certain statements. A remote
    attacker could possibly use this issue to read arbitrary server memory or alter certain data.
    (CVE-2018-10925)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3744-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'libecpg-compat3', 'pkgver': '9.3.24-0ubuntu0.14.04'},
    {'osver': '14.04', 'pkgname': 'libecpg-dev', 'pkgver': '9.3.24-0ubuntu0.14.04'},
    {'osver': '14.04', 'pkgname': 'libecpg6', 'pkgver': '9.3.24-0ubuntu0.14.04'},
    {'osver': '14.04', 'pkgname': 'libpgtypes3', 'pkgver': '9.3.24-0ubuntu0.14.04'},
    {'osver': '14.04', 'pkgname': 'libpq-dev', 'pkgver': '9.3.24-0ubuntu0.14.04'},
    {'osver': '14.04', 'pkgname': 'libpq5', 'pkgver': '9.3.24-0ubuntu0.14.04'},
    {'osver': '14.04', 'pkgname': 'postgresql-9.3', 'pkgver': '9.3.24-0ubuntu0.14.04'},
    {'osver': '14.04', 'pkgname': 'postgresql-client-9.3', 'pkgver': '9.3.24-0ubuntu0.14.04'},
    {'osver': '14.04', 'pkgname': 'postgresql-contrib-9.3', 'pkgver': '9.3.24-0ubuntu0.14.04'},
    {'osver': '14.04', 'pkgname': 'postgresql-plperl-9.3', 'pkgver': '9.3.24-0ubuntu0.14.04'},
    {'osver': '14.04', 'pkgname': 'postgresql-plpython-9.3', 'pkgver': '9.3.24-0ubuntu0.14.04'},
    {'osver': '14.04', 'pkgname': 'postgresql-plpython3-9.3', 'pkgver': '9.3.24-0ubuntu0.14.04'},
    {'osver': '14.04', 'pkgname': 'postgresql-pltcl-9.3', 'pkgver': '9.3.24-0ubuntu0.14.04'},
    {'osver': '14.04', 'pkgname': 'postgresql-server-dev-9.3', 'pkgver': '9.3.24-0ubuntu0.14.04'},
    {'osver': '16.04', 'pkgname': 'libecpg-compat3', 'pkgver': '9.5.14-0ubuntu0.16.04'},
    {'osver': '16.04', 'pkgname': 'libecpg-dev', 'pkgver': '9.5.14-0ubuntu0.16.04'},
    {'osver': '16.04', 'pkgname': 'libecpg6', 'pkgver': '9.5.14-0ubuntu0.16.04'},
    {'osver': '16.04', 'pkgname': 'libpgtypes3', 'pkgver': '9.5.14-0ubuntu0.16.04'},
    {'osver': '16.04', 'pkgname': 'libpq-dev', 'pkgver': '9.5.14-0ubuntu0.16.04'},
    {'osver': '16.04', 'pkgname': 'libpq5', 'pkgver': '9.5.14-0ubuntu0.16.04'},
    {'osver': '16.04', 'pkgname': 'postgresql-9.5', 'pkgver': '9.5.14-0ubuntu0.16.04'},
    {'osver': '16.04', 'pkgname': 'postgresql-client-9.5', 'pkgver': '9.5.14-0ubuntu0.16.04'},
    {'osver': '16.04', 'pkgname': 'postgresql-contrib-9.5', 'pkgver': '9.5.14-0ubuntu0.16.04'},
    {'osver': '16.04', 'pkgname': 'postgresql-plperl-9.5', 'pkgver': '9.5.14-0ubuntu0.16.04'},
    {'osver': '16.04', 'pkgname': 'postgresql-plpython-9.5', 'pkgver': '9.5.14-0ubuntu0.16.04'},
    {'osver': '16.04', 'pkgname': 'postgresql-plpython3-9.5', 'pkgver': '9.5.14-0ubuntu0.16.04'},
    {'osver': '16.04', 'pkgname': 'postgresql-pltcl-9.5', 'pkgver': '9.5.14-0ubuntu0.16.04'},
    {'osver': '16.04', 'pkgname': 'postgresql-server-dev-9.5', 'pkgver': '9.5.14-0ubuntu0.16.04'},
    {'osver': '18.04', 'pkgname': 'libecpg-compat3', 'pkgver': '10.5-0ubuntu0.18.04'},
    {'osver': '18.04', 'pkgname': 'libecpg-dev', 'pkgver': '10.5-0ubuntu0.18.04'},
    {'osver': '18.04', 'pkgname': 'libecpg6', 'pkgver': '10.5-0ubuntu0.18.04'},
    {'osver': '18.04', 'pkgname': 'libpgtypes3', 'pkgver': '10.5-0ubuntu0.18.04'},
    {'osver': '18.04', 'pkgname': 'libpq-dev', 'pkgver': '10.5-0ubuntu0.18.04'},
    {'osver': '18.04', 'pkgname': 'libpq5', 'pkgver': '10.5-0ubuntu0.18.04'},
    {'osver': '18.04', 'pkgname': 'postgresql-10', 'pkgver': '10.5-0ubuntu0.18.04'},
    {'osver': '18.04', 'pkgname': 'postgresql-client-10', 'pkgver': '10.5-0ubuntu0.18.04'},
    {'osver': '18.04', 'pkgname': 'postgresql-plperl-10', 'pkgver': '10.5-0ubuntu0.18.04'},
    {'osver': '18.04', 'pkgname': 'postgresql-plpython-10', 'pkgver': '10.5-0ubuntu0.18.04'},
    {'osver': '18.04', 'pkgname': 'postgresql-plpython3-10', 'pkgver': '10.5-0ubuntu0.18.04'},
    {'osver': '18.04', 'pkgname': 'postgresql-pltcl-10', 'pkgver': '10.5-0ubuntu0.18.04'},
    {'osver': '18.04', 'pkgname': 'postgresql-server-dev-10', 'pkgver': '10.5-0ubuntu0.18.04'}
];
