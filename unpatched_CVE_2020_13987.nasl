...
if (description)
{
  ...
  script_cve_id("CVE-2020-13987");
  script_xref(name:"CEA-ID", value:"CEA-2020-0139");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2020-13987 (deprecated)");
...
"n/a");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-13987");
