...
# extracted from Fedora Security Advisory FEDORA-2024-acb9425c93
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-acb9425c93");

  script_name(english:"Fedora 41 : bluez / iwd / libell (2024-acb9425c93)");
...
FEDORA-2024-acb9425c93 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-acb9425c93");
...
var pkgs = [
    {'reference':'bluez-5.78-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'iwd-2.21-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libell-0.69-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
