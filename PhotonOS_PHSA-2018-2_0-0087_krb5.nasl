...
if (description)
{
  ...
  script_cve_id("CVE-2018-5730");

  script_name(english:"Photon OS 2.0: Krb5 PHSA-2018-2.0-0087");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'krb5-1.16-2.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'krb5-debuginfo-1.16-2.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'krb5-devel-1.16-2.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'krb5-lang-1.16-2.ph2')) flag++;
