...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5002296");
  script_xref(name:"MSFT", value:"MS22-5002296");
  script_xref(name:"IAVA", value:"2022-A-0481-S");

  script_name(english:"Security Updates for Microsoft SharePoint Server Subscription Edition (November 2022)");
...
is missing security updates. It is, therefore, affected by multiple vulnerabilities:
  ...
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002296");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released KB5002296 to address this issue.");
