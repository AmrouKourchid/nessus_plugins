...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_0602.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8d24bcf5");
...
"Update the RHEL rh-nodejs12-nodejs package based on the guidance in RHSA-2020:0602.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-nodejs12-nodejs-12.16.1-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs12-nodejs-devel-12.16.1-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs12-nodejs-docs-12.16.1-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs12-npm-6.13.4-12.16.1.1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
