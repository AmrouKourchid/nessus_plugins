...
if (description)
{
  ...
  script_name(english:"PHP 7.1.x < 7.1.15 Stack Buffer Overflow");
...
server is 7.1.x prior to 7.1.15. It is, therefore, affected by
a stack buffer overflow vulnerability.");
  script_set_attribute(attribute:"see_also", value:"http://php.net/ChangeLog-7.php#7.1.15");
  # https://www.cisecurity.org/advisory/multiple-vulnerabilities-in-php-could-allow-for-arbitrary-code-execution_2018-023/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?77aa0aa0");
  script_set_attribute(attribute:"solution", value:
"Upgrade to PHP version 7.1.15 or later.");
