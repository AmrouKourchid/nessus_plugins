...
if (description)
{
  ...
  script_cve_id("CVE-2023-5520");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2023-5520");
...
patch available.
  ...
  - Out-of-bounds Read in GitHub repository gpac/gpac prior to 2.2.2. (CVE-2023-5520)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-5520");
