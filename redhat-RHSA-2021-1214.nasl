...
# extracted from Red Hat Security Advisory RHSA-2021:1214. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_1214.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e03be7f0");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:1214");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1941402");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libldb package based on the guidance in RHSA-2021:1214.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ldb-tools-1.5.4-3.el8_1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libldb-1.5.4-3.el8_1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libldb-devel-1.5.4-3.el8_1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-ldb-1.5.4-3.el8_1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
