...
# AlmaLinux Security Advisory ALSA-2022:7822.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2022:7822");

  script_name(english:"AlmaLinux 8 : container-tools:rhel8 (ALSA-2022:7822)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ALSA-2022:7822 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2022-7822.html");
