...
# extracted from Red Hat Security Advisory RHSA-2023:3525.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : python-flask (RHSA-2023:3525)");
...
var pkgs = [
    {'reference':'python-flask-0.10.1-7.el7_9', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
