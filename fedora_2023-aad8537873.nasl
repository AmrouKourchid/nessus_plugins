...
# extracted from Fedora Security Advisory FEDORA-2023-aad8537873
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-aad8537873");

  script_name(english:"Fedora 38 : golang (2023-aad8537873)");
...
FEDORA-2023-aad8537873 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-aad8537873");
...
var pkgs = [
    {'reference':'golang-1.20.8-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
