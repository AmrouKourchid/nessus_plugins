...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : Linux kernel (Wily HWE) vulnerabilities (USN-2978-2)");
...
the USN-2978-2 advisory.

    USN-2978-1 fixed vulnerabilities in the Linux kernel for Ubuntu 15.10. This update provides the
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2978-2");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-2978-2');
}
