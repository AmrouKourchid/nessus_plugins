...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : ghostscript (EulerOS-SA-2020-2153)");
...
vulnerabilities :
  ...
  - A use-after-free vulnerability in
    ...
    attacker to escalate privileges via a crafted PDF
    file.(CVE-2020-16303)
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2153
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5eefdec8");
...
pkgs = ["ghostscript-9.25-1.h9.eulerosv2r8",
        "libgs-9.25-1.h9.eulerosv2r8"];
