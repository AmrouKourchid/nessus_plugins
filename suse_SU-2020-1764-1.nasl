...
# extracted from SUSE update advisory SUSE-SU-2020:1764-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : kernel (SUSE-SU-2020:1764-1)");
...
without introducing additional issues.");
  ...
  # https://www.suse.com/support/update/announcement/2020/suse-su-20201764-1
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e1eda5ab");
...
zypper in -t patch SUSE-SLE-SAP-12-SP2-2020-1764=1
SUSE-SLE-SAP-12-SP2-2020-1765=1

SUSE Linux Enterprise Server 12-SP2-LTSS :

zypper in -t patch SUSE-SLE-SERVER-12-SP2-2020-1764=1
SUSE-SLE-SERVER-12-SP2-2020-1765=1");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"kgraft-patch-4_4_121-92_125-default-6-2.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"kgraft-patch-4_4_121-92_129-default-3-2.1")) flag++;
