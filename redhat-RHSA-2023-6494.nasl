...
# extracted from Red Hat Security Advisory RHSA-2023:6494. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:6494");

  script_name(english:"RHEL 9 : python3.11 (RHSA-2023:6494)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for python3.11.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2023:6494 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6494.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bf2b81c2");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6494");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python3.11 package based on the guidance in RHSA-2023:6494.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3.11-3.11.5-1.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.11-debug-3.11.5-1.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.11-devel-3.11.5-1.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.11-idle-3.11.5-1.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.11-libs-3.11.5-1.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.11-test-3.11.5-1.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.11-tkinter-3.11.5-1.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
