...
# SUSE update advisory SUSE-SU-2024:0376-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2023-1829", "CVE-2023-6932");
  script_xref(name:"SuSE", value:"SUSE-SU-2024:0376-1");

  script_name(english:"SUSE SLES12 / SLES15 Security Update : kernel (Live Patch 43 for SLE 15 SP2) (SUSE-SU-2024:0376-1)");
...
referenced in the SUSE-SU-2024:0376-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1218255");
  # https://lists.suse.com/pipermail/sle-security-updates/2024-February/017876.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d5f192f0");
...
"Update the affected kernel-livepatch-4_12_14-150100_197_165-default, kernel-livepatch-5_3_18-150200_24_172-default and /
or kgraft-patch-4_12_14-122_186-default packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:suse_linux:kernel-livepatch-4_12_14-150100_197_165-default");
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-122.186-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_12_14-122_186-default-2-2.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.5']}
        ]
      },
      '4.12.14-150100.197.165-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-4_12_14-150100_197_165-default-2-150100.2.1', 'sp':'1', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.1']}
        ]
      },
      '5.3.18-150200.24.172-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_3_18-150200_24_172-default-2-150200.2.1', 'sp':'2', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.2']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kernel-livepatch-4_12_14-150100_197_165-default / etc');
}
