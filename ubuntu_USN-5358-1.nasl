...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS : Linux kernel vulnerabilities (USN-5358-1)");
...
referenced in the USN-5358-1 advisory.
...
var kernel_mappings = {
  '18.04': {
    '5.4.0': {
      'generic': '5.4.0-107',
      'generic-lpae': '5.4.0-107',
      'lowlatency': '5.4.0-107',
      'oracle': '5.4.0-1069'
    }
  },
  '20.04': {
    '5.13.0': {
      'generic': '5.13.0-39',
      'generic-64k': '5.13.0-39',
      'generic-lpae': '5.13.0-39',
      'lowlatency': '5.13.0-39'
    },
    '5.4.0': {
      'generic': '5.4.0-107',
      'generic-lpae': '5.4.0-107',
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-5358-1');
}
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-5358-1');
  }
  else
  {
