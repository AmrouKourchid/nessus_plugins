...
# extracted from Fedora Security Advisory FEDORA-2022-8bff5db98e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-8bff5db98e");

  script_name(english:"Fedora 37 : firefox (2022-8bff5db98e)");
...
FEDORA-2022-8bff5db98e advisory.

    - New upstream version (106.0.1)

    ----

    - Updated to new upstream version (105.0.2)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-8bff5db98e");
...
var pkgs = [
    {'reference':'firefox-106.0.1-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
