...
if (description)
{
  ...
  script_name(english:"CentOS 9 : xorg-x11-server-Xwayland-21.1.3-7.el9");
...
xorg-x11-server-Xwayland-21.1.3-7.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=30061");
...
var pkgs = [
    ...
    {'reference':'xorg-x11-server-Xwayland-devel-21.1.3-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
