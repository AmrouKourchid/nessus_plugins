...
# extracted from Fedora Security Advisory FEDORA-2018-319b9d0f68.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-319b9d0f68");

  script_name(english:"Fedora 29 : ruby (2018-319b9d0f68)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-319b9d0f68");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"ruby-2.5.3-99.fc29")) flag++;
