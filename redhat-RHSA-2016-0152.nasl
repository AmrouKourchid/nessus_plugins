...
"The remote Red Hat host is missing a security update for sos.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2016/rhsa-2016_0152.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6ae0c002");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2016:0152");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1282542");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL sos package based on the guidance in RHSA-2016:0152.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-7529");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'sos-3.2-28.el6_7.2', 'release':'6', 'el_string':'el6_7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
