...
# extracted from Ubuntu Security Notice USN-5331-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5331-2");
  script_xref(name:"IAVA", value:"2021-A-0202-S");

  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS : tcpdump vulnerabilities (USN-5331-2)");
...
referenced in the USN-5331-2 advisory.

    USN-5331-1 fixed several vulnerabilities in tcpdump. This update provides the corresponding update for
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5331-2");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'tcpdump', 'pkgver': '4.9.3-0ubuntu0.18.04.2'},
    {'osver': '20.04', 'pkgname': 'tcpdump', 'pkgver': '4.9.3-4ubuntu0.1'}
];
