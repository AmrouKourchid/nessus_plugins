...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : sssd (EulerOS-SA-2024-1826)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1826
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b7563c95");
...
var pkgs = [
  "python3-sssd-2.6.1-1.h16.eulerosv2r11",
  "sssd-2.6.1-1.h16.eulerosv2r11"
];
