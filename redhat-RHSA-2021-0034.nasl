...
"The remote Red Hat host is missing one or more security updates for OpenShift Container Platform 4.5.27.");
...
referenced in the RHSA-2021:0034 advisory.
    ...
    * python-urllib3: CRLF injection via HTTP request method (CVE-2020-26137)
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.5.27. See the following
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_0034.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ead5237f");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1913121");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.5.27 packages based on the guidance in RHSA-2021:0034.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jenkins-2-plugins-4.5.1610108899-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2020-2304', 'CVE-2020-2305', 'CVE-2020-2306', 'CVE-2020-2307', 'CVE-2020-2308', 'CVE-2020-2309']},
      {'reference':'python2-urllib3-1.26.2-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2020-26137']}
    ]
  }
];
