...
"The version of Thunderbird installed on the remote Windows host is prior to 102.13.1. It is, therefore, affected by a
vulnerability as referenced in the mfsa2023-28 advisory.
...
mozilla_check_version(installs:installs, product:'thunderbird', esr:FALSE, fix:'102.13.1', severity:SECURITY_HOLE);
