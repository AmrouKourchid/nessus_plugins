...
# extracted from Red Hat Security Advisory RHSA-2021:2034. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:2034");

  script_name(english:"RHEL 8 : redis:6 (RHSA-2021:2034)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for redis:6.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2021:2034 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_2034.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e0582e57");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:2034");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1957410");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL redis:6 package based on the guidance in RHSA-2021:2034.");
  ...
  'redis:6': [
    {
      ...
      'pkgs': [
        {'reference':'redis-6.0.9-3.module+el8.4.0+10984+ed187465', 'sp':'4', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'redis-devel-6.0.9-3.module+el8.4.0+10984+ed187465', 'sp':'4', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'redis-doc-6.0.9-3.module+el8.4.0+10984+ed187465', 'sp':'4', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE}
      ]
    },
    {
      'repo_relative_urls': [
      ...
      'pkgs': [
        {'reference':'redis-6.0.9-3.module+el8.4.0+10984+ed187465', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'redis-devel-6.0.9-3.module+el8.4.0+10984+ed187465', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'redis-doc-6.0.9-3.module+el8.4.0+10984+ed187465', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
