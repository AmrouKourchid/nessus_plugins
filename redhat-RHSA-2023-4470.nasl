...
# extracted from Red Hat Security Advisory RHSA-2023:4470. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:4470");

  script_name(english:"RHEL 8 : Red Hat Ansible Automation Platform 2.3 Product Security and Bug Fix Update (Important) (RHSA-2023:4470)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has a package installed that is affected by multiple vulnerabilities as
referenced in the RHSA-2023:4470 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_4470.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0443651f");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:4470");
  script_set_attribute(attribute:"solution", value:
"Update the affected openshift-clients package.");
  ...
  script_cwe_id(94, 176, 400, 770, 835);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openshift-clients-4.12.0-202307200611.p0.g49844f7.assembly.stream.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.3'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'openshift-clients');
}
