...
# extracted from Fedora Security Advisory FEDORA-2023-684eb03db0
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-684eb03db0");

  script_name(english:"Fedora 40 : gh (2023-684eb03db0)");
...
FEDORA-2023-684eb03db0 advisory.

    Automatic update for gh-2.33.0-1.fc40.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-684eb03db0");
...
var pkgs = [
    {'reference':'gh-2.33.0-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
