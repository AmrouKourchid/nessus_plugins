...
the RHSA-2023:1141 advisory.
    ...
    * In FIPS mode, gnutls should reject RSASSA-PSS salt lengths larger than the output size of the hash
    function used, or provide an indicator (BZ#2144537)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_1141.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dec127ce");
...
"Update the RHEL gnutls package based on the guidance in RHSA-2023:1141.");
