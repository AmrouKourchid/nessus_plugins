...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : haproxy (EulerOS-SA-2024-1195)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1195
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7f1783fe");
...
var pkgs = [
  "haproxy-2.0.14-1.h8.eulerosv2r9"
];
