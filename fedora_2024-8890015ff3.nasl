...
# extracted from Fedora Security Advisory FEDORA-2024-8890015ff3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-8890015ff3");

  script_name(english:"Fedora 39 : seamonkey (2024-8890015ff3)");
...
FEDORA-2024-8890015ff3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-8890015ff3");
...
var pkgs = [
    {'reference':'seamonkey-2.53.18.2-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
