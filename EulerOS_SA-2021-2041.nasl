...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : perl-DBI (EulerOS-SA-2021-2041)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the version of the perl-DBI package installed, the
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2041
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?84544d2c");
...
pkgs = ["perl-DBI-1.627-4.h3.eulerosv2r7"];
