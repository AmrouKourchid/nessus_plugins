...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2020-A-0420-S");

  script_name(english:"PHP 7.4.x < 7.4.10 Memory Leak Vulnerability");
...
the remote web server is 7.4.x prior to 7.4.10. It is, therefore affected by
a memory leak vulnerability in the LDAP component. An unauthenticated, remote
attacker could exploit this issue to cause a denial-of-service condition.");
  script_set_attribute(attribute:"see_also", value:"https://www.php.net/ChangeLog-7.php#7.4.10");
  script_set_attribute(attribute:"solution", value:
"Upgrade to PHP version 7.4.10 or later");
...
constraints = [{'min_version':'7.4.0alpha1', 'fixed_version':'7.4.10'}];
