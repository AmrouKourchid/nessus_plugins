...
# extracted from Fedora Security Advisory FEDORA-2023-18fd476362
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-18fd476362");

  script_name(english:"Fedora 36 : yarnpkg (2023-18fd476362)");
...
FEDORA-2023-18fd476362 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-18fd476362");
...
var pkgs = [
    {'reference':'yarnpkg-1.22.19-3.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
