...
referenced in the RHSA-2022:0871 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.8.35. See the following
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_0871.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a66d58ad");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2064010");
...
"Update the RHEL OpenShift Container Platform 4.8.35 package based on the guidance in RHSA-2022:0871.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2022-25183");

  script_set_attribute(attribute:"exploitability_ease", value:"Exploits are available");
  script_set_attribute(attribute:"exploit_available", value:"true");
  script_cwe_id(59, 78, 79, 94, 179, 522);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cri-o-1.21.5-3.rhaos4.8.gitaf64931.el8', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2022-0811']},
      {'reference':'cri-o-1.21.5-3.rhaos4.8.gitaf64931.el8', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2022-0811']},
      {'reference':'cri-o-1.21.5-3.rhaos4.8.gitaf64931.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2022-0811']},
      {'reference':'jenkins-2-plugins-4.8.1646993358-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2022-25173', 'CVE-2022-25174', 'CVE-2022-25175', 'CVE-2022-25176', 'CVE-2022-25177', 'CVE-2022-25178', 'CVE-2022-25179', 'CVE-2022-25180', 'CVE-2022-25181', 'CVE-2022-25182', 'CVE-2022-25183', 'CVE-2022-25184', 'CVE-2022-29036', 'CVE-2022-29046']}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'cri-o-1.21.5-3.rhaos4.8.gitaf64931.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2022-0811']}
    ]
  }
];
