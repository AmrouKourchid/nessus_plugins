...
# extracted from Fedora Security Advisory FEDORA-2024-110b39017e
#
...
if (description)
{
  ...
  script_cve_id("CVE-2024-33427", "CVE-2024-37894");
  script_xref(name:"FEDORA", value:"2024-110b39017e");
  script_xref(name:"IAVB", value:"2024-B-0087-S");

  script_name(english:"Fedora 40 : squid (2024-110b39017e)");
...
FEDORA-2024-110b39017e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-110b39017e");
...
var pkgs = [
    {'reference':'squid-6.10-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
];
