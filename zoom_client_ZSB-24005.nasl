...
if (description)
{
  ...
  script_cve_id("CVE-2024-24698");

  script_name(english:"Zoom Client for Meetings < 5.17.0 Vulnerability (ZSB-24005)");
...
vulnerability as referenced in the ZSB-24005 advisory.

  - Improper authentication in some Zoom clients may allow a privileged user to conduct a disclosure of
    information via local access. (CVE-2024-24698)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.zoom.com/en/trust/security-bulletin/ZSB-24005");
...
"Upgrade to Zoom Client for Meetings 5.17.0 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-24698");
