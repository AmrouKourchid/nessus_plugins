...
if (description)
{
  ...
  script_name(english:"Fortinet FortiProxy Out-of-bound Write in sslvpnd (FG-IR-24-255)");
...
(Access-Accept, Access-Reject, or Access-Challenge) to any other response using a chosen-prefix collision attack 
against MD5 Response Authenticator signature.
...
"Please upgrade to FortiProxy version 7.4.6 or later.");
...
var constraints = [
  { 'min_version' : '7.0', 'max_version' : '7.0.999', 'fixed_version' : '7.4.6' },
  { 'min_version' : '7.2', 'max_version' : '7.2.999', 'fixed_version' : '7.4.6' },
  { 'min_version' : '7.4', 'max_version' : '7.4.5.999', 'fixed_version' : '7.4.6' }
];
