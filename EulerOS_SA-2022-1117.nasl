...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : dhcp (EulerOS-SA-2022-1117)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1117
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7f75fcce");
...
var pkgs = [
  "dhclient-4.2.5-68.1.h18.eulerosv2r7",
