...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : python-pillow (EulerOS-SA-2022-1184)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1184
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a6b43b87");
...
var pkgs = [
  "python-pillow-2.0.0-19.gitd1c6db8.h10"
];
