...
# extracted from Red Hat Security Advisory RHSA-2025:1211. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:1211");
  script_xref(name:"CEA-ID", value:"CEA-2021-0025");

  script_name(english:"RHEL 9 : tbb (RHSA-2025:1211)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_1211.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a6cd7c8d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:1211");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL tbb package based on the guidance in RHSA-2025:1211.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-tbb-2020.3-8.el9_4.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tbb-2020.3-8.el9_4.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tbb-devel-2020.3-8.el9_4.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tbb-doc-2020.3-8.el9_4.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
