...
if (description)
{
  ...
  script_name(english:"Oracle MySQL Cluster 8.4.x < 8.4.4 (January 2025 CPU)");
...
mysql_check_version(variant:'Cluster', fixed:'8.4.4', min:'8.4', severity:SECURITY_WARNING);
