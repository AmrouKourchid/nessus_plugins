...
if (description)
{
  ...
  script_name(english:"H2O-3 Detection");

  script_set_attribute(attribute:"synopsis", value:
"A H2O-3 Python library is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"A H2O-3 Python library is installed on the remote host. H2O-3 is an open source, 
in-memory, distributed, fast, and scalable machine learning and predictive analytics 
platform that allows you to build machine learning models on big data and provides 
easy productionalization of those models in an enterprise environment. 

Note that Nessus has relied upon on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://docs.h2o.ai/h2o/latest-stable/h2o-docs/welcome.html");
