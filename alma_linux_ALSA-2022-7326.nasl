...
# AlmaLinux Security Advisory ALSA-2022:7326.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2022:7326");

  script_name(english:"AlmaLinux 9 : pki-core (ALSA-2022:7326)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2022-7326.html");
