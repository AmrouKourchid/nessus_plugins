...
# extracted from Gentoo Linux Security Advisory GLSA 202008-24.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202008-24");

  script_name(english:"GLSA-202008-24 : OpenJDK: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202008-24
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202008-24");
...
if (qpkg_check(package:"dev-java/openjdk", unaffected:make_list("ge 8.262_p01"), vulnerable:make_list("lt 8.262_p01"))) flag++;
if (qpkg_check(package:"dev-java/openjdk-bin", unaffected:make_list("ge 8.262_p01"), vulnerable:make_list("lt 8.262_p01"))) flag++;
