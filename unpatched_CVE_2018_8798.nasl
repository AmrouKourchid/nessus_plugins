...
if (description)
{
  ...
  script_cve_id("CVE-2018-8798");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2018-8798");
...
patch available.
  ...
  - rdesktop versions up to and including v1.8.3 contain an Out-Of-Bounds Read in function
    rdpsnd_process_ping() that results in an information leak. (CVE-2018-8798)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-8798");
