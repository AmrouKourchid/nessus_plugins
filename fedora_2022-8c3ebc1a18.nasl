...
# extracted from Fedora Security Advisory FEDORA-2022-8c3ebc1a18
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-8c3ebc1a18");

  script_name(english:"Fedora 36 : firefox (2022-8c3ebc1a18)");
...
FEDORA-2022-8c3ebc1a18 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-8c3ebc1a18");
...
var pkgs = [
    {'reference':'firefox-107.0.1-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
