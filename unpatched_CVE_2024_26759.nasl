...
if (description)
{
  ...
  script_cve_id("CVE-2024-26759");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-26759");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: mm/swap: fix race when skipping
    ...
    (Dropping SWP_SYNCHRONOUS_IO flag) [kasong@tencent.com: v4] Link:
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-26759");
