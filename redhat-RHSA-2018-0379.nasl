...
the RHSA-2018:0379 advisory.
    ...
    versions are .NET Core 1.0.9, 1.1.6, and 2.0.5.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_0379.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f1c27422");
  script_set_attribute(attribute:"see_also", value:"https://github.com/dotnet/announcements/issues/52");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:0379");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1533730");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL .NET Core on Red Hat Enterprise Linux package based on the guidance in RHSA-2018:0379.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-0764");
  script_cwe_id(20);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-dotnet20-dotnet-2.0.5-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet20'},
      {'reference':'rh-dotnet20-dotnet-host-2.0.5-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet20'},
      {'reference':'rh-dotnet20-dotnet-runtime-2.0-2.0.5-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet20'},
      {'reference':'rh-dotnet20-dotnet-sdk-2.1-2.1.4-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet20'},
      {'reference':'rh-dotnetcore10-dotnetcore-1.0.9-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet10'},
      {'reference':'rh-dotnetcore11-dotnetcore-1.1.6-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet11'}
    ]
  }
];
