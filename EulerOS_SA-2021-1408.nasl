...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.6 : binutils (EulerOS-SA-2021-1408)");
...
the following vulnerabilities :
  ...
  - ** REJECT ** DO NOT USE THIS CANDIDATE NUMBER.
    ...
    by its CNA. Further investigation showed that it was
    not a security issue. Notes: none.(CVE-2020-16598)
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1408
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?89464162");
...
pkgs = ["binutils-2.27-28.base.1.h48.eulerosv2r7"];
