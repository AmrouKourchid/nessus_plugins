...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5041580");
  script_xref(name:"MSFT", value:"MS24-5041580");
  ...
  script_name(english:"KB5041580: Windows 10 Version 21H2 / Windows 10 Version 22H2 Security Update (August 2024)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5041580. It is, therefore, affected by multiple vulnerabilities
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5041580");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5041580");
