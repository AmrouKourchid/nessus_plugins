...
# SUSE update advisory SUSE-SU-2023:3289-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:3289-1");

  script_name(english:"SUSE SLES12 Security Update : ucode-intel (SUSE-SU-2023:3289-1)");
...
the SUSE-SU-2023:3289-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-August/015879.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?756dca9e");
...
var pkgs = [
    {'reference':'ucode-intel-20230808-13.110.1', 'sp':'2', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-bcl-release-12.2']}
];
