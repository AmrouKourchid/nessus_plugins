...
# extracted from Red Hat Security Advisory RHSA-2024:0134. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 8 : kernel-rt (RHSA-2024:0134)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for kernel-rt.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:0134 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0134.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d818277b");
...
"Update the RHEL kernel-rt package based on the guidance in RHSA-2024:0134.");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for RHSA-2024:0134');
  }
  else
  {
