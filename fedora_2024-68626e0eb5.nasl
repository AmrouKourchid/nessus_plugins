...
# extracted from Fedora Security Advisory FEDORA-2024-68626e0eb5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-68626e0eb5");

  script_name(english:"Fedora 40 : unbound (2024-68626e0eb5)");
...
FEDORA-2024-68626e0eb5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-68626e0eb5");
...
var pkgs = [
    {'reference':'unbound-1.20.0-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
