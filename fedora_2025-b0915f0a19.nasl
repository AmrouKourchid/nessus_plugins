...
# extracted from Fedora Security Advisory FEDORA-2025-b0915f0a19
#
...
if (description)
{
  ...
  script_cve_id("CVE-2025-22869", "CVE-2025-22870", "CVE-2025-27144");
  script_xref(name:"FEDORA", value:"2025-b0915f0a19");

  script_name(english:"Fedora 41 : prometheus-podman-exporter (2025-b0915f0a19)");
...
FEDORA-2025-b0915f0a19 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-b0915f0a19");
...
var pkgs = [
    {'reference':'prometheus-podman-exporter-1.16.0-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
