...
# extracted from Fedora Security Advisory FEDORA-2024-7b063bce0a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-7b063bce0a");

  script_name(english:"Fedora 38 : suricata (2024-7b063bce0a)");
...
FEDORA-2024-7b063bce0a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-7b063bce0a");
...
var pkgs = [
    {'reference':'suricata-6.0.16-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
