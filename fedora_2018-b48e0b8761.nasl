...
# extracted from Fedora Security Advisory FEDORA-2018-b48e0b8761.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : libpng15 (2018-b48e0b8761)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-b48e0b8761");
  script_set_attribute(attribute:"solution", value:
"Update the affected libpng15 package.");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"libpng15-1.5.30-6.fc28")) flag++;
