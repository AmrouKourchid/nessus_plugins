...
# extracted from Debian Security Advisory dla-3104. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3104 : paramiko-doc - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3104
advisory.

    - -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3104-1                debian-lts@lists.debian.org
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-24302");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/paramiko");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/paramiko");
  script_set_attribute(attribute:"solution", value:
"Upgrade the paramiko-doc packages.");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'paramiko-doc', 'reference': '2.4.2-0.1+deb10u1'},
    {'release': '10.0', 'prefix': 'python-paramiko', 'reference': '2.4.2-0.1+deb10u1'},
    {'release': '10.0', 'prefix': 'python3-paramiko', 'reference': '2.4.2-0.1+deb10u1'}
];
