...
if (description)
{
  ...
  script_name(english:"Mozilla Firefox ESR SEoL (115.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Mozilla Firefox ESR is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Mozilla Firefox ESR version install on the remote host has reached end of support. 
...
"Upgrade to a version of Mozilla Firefox that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2025/04/01");
...
var app = 'Mozilla Firefox ESR';

var app_info = vcf::combined_get_app_info(app:app);

if (app_info['sw_edition'] != "ESR")
    audit(AUDIT_NOT_INST, "The ESR version of Firefox");

vcf::check_all_backporting(app_info:app_info);

var constraints = [
{ max_branch : '115', min_branch : '115', seol : 20250401 }
];
