...
# extracted from Fedora Security Advisory FEDORA-2024-5acee8c47f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-5acee8c47f");
  script_xref(name:"IAVA", value:"2024-A-0354-S");

  script_name(english:"Fedora 40 : chromium (2024-5acee8c47f)");
...
FEDORA-2024-5acee8c47f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-5acee8c47f");
...
var pkgs = [
    {'reference':'chromium-126.0.6478.55-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
