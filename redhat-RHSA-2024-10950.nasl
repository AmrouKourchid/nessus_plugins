...
# extracted from Red Hat Security Advisory RHSA-2024:10950. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:10950");

  script_name(english:"RHEL 9 : php:8.1 (RHSA-2024:10950)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for php:8.1.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:10950 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e1de6467");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:10950");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL php:8.1 package based on the guidance in RHSA-2024:10950.");
  ...
  'php:8.1': [
    {
      ...
      'pkgs': [
        ...
        {'reference':'php-8.1.30-1.module+el9.5.0+22481+3e1c6d75', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'php-bcmath-8.1.30-1.module+el9.5.0+22481+3e1c6d75', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'php-cli-8.1.30-1.module+el9.5.0+22481+3e1c6d75', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'php-common-8.1.30-1.module+el9.5.0+22481+3e1c6d75', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'php-dba-8.1.30-1.module+el9.5.0+22481+3e1c6d75', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'php-dbg-8.1.30-1.module+el9.5.0+22481+3e1c6d75', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'php-devel-8.1.30-1.module+el9.5.0+22481+3e1c6d75', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'php-embedded-8.1.30-1.module+el9.5.0+22481+3e1c6d75', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'php-enchant-8.1.30-1.module+el9.5.0+22481+3e1c6d75', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'php-ffi-8.1.30-1.module+el9.5.0+22481+3e1c6d75', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'php-fpm-8.1.30-1.module+el9.5.0+22481+3e1c6d75', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'php-gd-8.1.30-1.module+el9.5.0+22481+3e1c6d75', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'php-gmp-8.1.30-1.module+el9.5.0+22481+3e1c6d75', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'php-intl-8.1.30-1.module+el9.5.0+22481+3e1c6d75', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'php-ldap-8.1.30-1.module+el9.5.0+22481+3e1c6d75', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'php-mbstring-8.1.30-1.module+el9.5.0+22481+3e1c6d75', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'php-mysqlnd-8.1.30-1.module+el9.5.0+22481+3e1c6d75', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'php-odbc-8.1.30-1.module+el9.5.0+22481+3e1c6d75', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'php-opcache-8.1.30-1.module+el9.5.0+22481+3e1c6d75', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'php-pdo-8.1.30-1.module+el9.5.0+22481+3e1c6d75', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'php-pgsql-8.1.30-1.module+el9.5.0+22481+3e1c6d75', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'php-process-8.1.30-1.module+el9.5.0+22481+3e1c6d75', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'php-snmp-8.1.30-1.module+el9.5.0+22481+3e1c6d75', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'php-soap-8.1.30-1.module+el9.5.0+22481+3e1c6d75', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'php-xml-8.1.30-1.module+el9.5.0+22481+3e1c6d75', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
