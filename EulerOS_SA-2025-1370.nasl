...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : openssl (EulerOS-SA-2025-1370)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1370
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3d5e5c1f");
...
var pkgs = [
  "openssl-1.1.1m-2.h53.eulerosv2r11",
  "openssl-libs-1.1.1m-2.h53.eulerosv2r11",
  "openssl-perl-1.1.1m-2.h53.eulerosv2r11",
  "openssl-pkcs11-0.4.11-5.eulerosv2r11"
];
