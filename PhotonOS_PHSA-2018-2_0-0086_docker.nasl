...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Docker PHSA-2018-2.0-0086");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'docker-17.06.0-6.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'docker-doc-17.06.0-6.ph2')) flag++;
