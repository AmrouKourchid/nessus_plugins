...
if (description)
{
  ...
  script_name(english:"Fortinet FortiClient CVE-2023-4863 - Heap overflow in Chrome/libwebp (FG-IR-23-381)");
...
var constraints = [
  { 'min_version' : '6.4', 'max_version' : '6.4', 'fixed_version' : '7.0.10' },
  { 'min_version' : '7.0.0', 'max_version' : '7.0.9', 'fixed_version' : '7.0.10' },
  { 'min_version' : '7.2.0', 'max_version' : '7.2.1', 'fixed_version' : '7.2.3' }
];
