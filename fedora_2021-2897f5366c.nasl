...
# extracted from Fedora Security Advisory FEDORA-2021-2897f5366c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-2897f5366c");

  script_name(english:"Fedora 32 : python3.10 (2021-2897f5366c)");
...
FEDORA-2021-2897f5366c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-2897f5366c");
...
pkgs = [
    {'reference':'python3.10-3.10.0~a6-1.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE}
];
