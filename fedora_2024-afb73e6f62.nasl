...
# extracted from Fedora Security Advisory FEDORA-2024-afb73e6f62
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-afb73e6f62");

  script_name(english:"Fedora 40 : mingw-expat (2024-afb73e6f62)");
...
FEDORA-2024-afb73e6f62 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-afb73e6f62");
...
var pkgs = [
    {'reference':'mingw-expat-2.6.1-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
