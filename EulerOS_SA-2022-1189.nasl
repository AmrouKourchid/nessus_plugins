...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : squashfs-tools (EulerOS-SA-2022-1189)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1189
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?13de8692");
...
var pkgs = [
  "squashfs-tools-4.3-0.21.gitaae0aff4.h3"
];
