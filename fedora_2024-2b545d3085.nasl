...
# extracted from Fedora Security Advisory FEDORA-2024-2b545d3085
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-2b545d3085");

  script_name(english:"Fedora 40 : grub2 (2024-2b545d3085)");
...
FEDORA-2024-2b545d3085 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-2b545d3085");
...
var pkgs = [
    {'reference':'grub2-2.06-121.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
