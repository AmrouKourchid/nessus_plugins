...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 ESM / 18.04 LTS : Linux kernel vulnerability (USN-5357-1)");
...
var kernel_mappings = {
  '16.04': {
    '4.15.0': {
      'generic': '4.15.0-175',
      'lowlatency': '4.15.0-175'
    }
  },
  '18.04': {
    '4.15.0': {
      'generic': '4.15.0-175',
      'generic-lpae': '4.15.0-175',
      'lowlatency': '4.15.0-175',
      'dell300x': '4.15.0-1040',
      'kvm': '4.15.0-1112',
      'snapdragon': '4.15.0-1125',
      'aws': '4.15.0-1126',
      'azure': '4.15.0-1136'
    }
  }
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-5357-1');
}
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-5357-1');
  }
  else
  {
