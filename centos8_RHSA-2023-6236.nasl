...
# Red Hat Security Advisory RHSA-2023:6236. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : binutils (CESA-2023:6236)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
CESA-2023:6236 advisory.
...
var pkgs = [
    {'reference':'binutils-2.30-119.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'binutils-2.30-119.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'binutils-devel-2.30-119.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'binutils-devel-2.30-119.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
