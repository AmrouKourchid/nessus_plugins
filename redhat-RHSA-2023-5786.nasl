...
# extracted from Red Hat Security Advisory RHSA-2023:5786. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:5786");

  script_name(english:"RHEL 8 : python-reportlab (RHSA-2023:5786)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_5786.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?50eae03b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2239920");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:5786");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-reportlab package based on the guidance in RHSA-2023:5786.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-reportlab-3.4.0-8.el8_6.1', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
