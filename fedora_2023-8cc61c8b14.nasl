...
# extracted from Fedora Security Advisory FEDORA-2023-8cc61c8b14
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-8cc61c8b14");

  script_name(english:"Fedora 38 : pgadmin4 (2023-8cc61c8b14)");
...
FEDORA-2023-8cc61c8b14 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-8cc61c8b14");
...
var pkgs = [
    {'reference':'pgadmin4-6.21-3.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
