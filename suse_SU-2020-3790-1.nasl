...
# extracted from SUSE update advisory SUSE-SU-2020:3790-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLED15 / SLES15 Security Update : clamav (SUSE-SU-2020:3790-1)");
...
Update to 0.102.2 :
  ...
  - Fixed an issue where running freshclam manually causes a
    ...
    of an update instead of using a hard-coded directory
...
Update to 0.102.0 :
  ...
  - An all new libfreshclam library API. created new
    subpackage libfreshclam2
...
without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=1104457");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=1118459");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=1130721");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2019-12625/");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2019-1785/");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2019-1786/");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2019-1787/");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2019-1788/");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2019-1789/");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2019-1798/");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ed0d58eb");
...
flag = 0;
if (rpm_check(release:"SLES15", sp:"1", reference:"clamav-0.103.0-3.23.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"clamav-debuginfo-0.103.0-3.23.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"clamav-debugsource-0.103.0-3.23.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"clamav-devel-0.103.0-3.23.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"libclamav9-0.103.0-3.23.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"libclamav9-debuginfo-0.103.0-3.23.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"libfreshclam2-0.103.0-3.23.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"libfreshclam2-debuginfo-0.103.0-3.23.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"clamav-0.103.0-3.23.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"clamav-debuginfo-0.103.0-3.23.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"clamav-debugsource-0.103.0-3.23.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"clamav-devel-0.103.0-3.23.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"libclamav9-0.103.0-3.23.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"libclamav9-debuginfo-0.103.0-3.23.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"libfreshclam2-0.103.0-3.23.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"libfreshclam2-debuginfo-0.103.0-3.23.1")) flag++;
if (rpm_check(release:"SLED15", sp:"1", reference:"clamav-0.103.0-3.23.1")) flag++;
if (rpm_check(release:"SLED15", sp:"1", reference:"clamav-debuginfo-0.103.0-3.23.1")) flag++;
if (rpm_check(release:"SLED15", sp:"1", reference:"clamav-debugsource-0.103.0-3.23.1")) flag++;
if (rpm_check(release:"SLED15", sp:"1", reference:"clamav-devel-0.103.0-3.23.1")) flag++;
if (rpm_check(release:"SLED15", sp:"1", reference:"libclamav9-0.103.0-3.23.1")) flag++;
if (rpm_check(release:"SLED15", sp:"1", reference:"libclamav9-debuginfo-0.103.0-3.23.1")) flag++;
if (rpm_check(release:"SLED15", sp:"1", reference:"libfreshclam2-0.103.0-3.23.1")) flag++;
if (rpm_check(release:"SLED15", sp:"1", reference:"libfreshclam2-debuginfo-0.103.0-3.23.1")) flag++;
if (rpm_check(release:"SLED15", sp:"2", reference:"clamav-0.103.0-3.23.1")) flag++;
if (rpm_check(release:"SLED15", sp:"2", reference:"clamav-debuginfo-0.103.0-3.23.1")) flag++;
if (rpm_check(release:"SLED15", sp:"2", reference:"clamav-debugsource-0.103.0-3.23.1")) flag++;
if (rpm_check(release:"SLED15", sp:"2", reference:"clamav-devel-0.103.0-3.23.1")) flag++;
if (rpm_check(release:"SLED15", sp:"2", reference:"libclamav9-0.103.0-3.23.1")) flag++;
if (rpm_check(release:"SLED15", sp:"2", reference:"libclamav9-debuginfo-0.103.0-3.23.1")) flag++;
if (rpm_check(release:"SLED15", sp:"2", reference:"libfreshclam2-0.103.0-3.23.1")) flag++;
if (rpm_check(release:"SLED15", sp:"2", reference:"libfreshclam2-debuginfo-0.103.0-3.23.1")) flag++;
