...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.2 : openssh (EulerOS-SA-2018-1413)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1413
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d18fa761");
...
pkgs = ["openssh-7.4p1-13.h7",
        "openssh-clients-7.4p1-13.h7",
        "openssh-keycat-7.4p1-13.h7",
        "openssh-server-7.4p1-13.h7"];
