...
# extracted from Fedora Security Advisory FEDORA-2022-de755fd092
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-de755fd092");
  script_xref(name:"IAVA", value:"2023-A-0061-S");

  script_name(english:"Fedora 36 : python3.12 (2022-de755fd092)");
...
FEDORA-2022-de755fd092 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-de755fd092");
...
var pkgs = [
    {'reference':'python3.12-3.12.0~a3-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
