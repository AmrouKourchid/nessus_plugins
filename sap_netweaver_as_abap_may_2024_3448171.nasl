...
if (description)
{
  ...
  script_cve_id("CVE-2024-33006");
  script_xref(name:"IAVA", value:"2024-A-0277");

  script_name(english:"SAP NetWeaver AS ABAP File Upload Vulnerability (May 2024) (3448171)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SAP NetWeaver ABAP server may be affected by an arbitrary file upload.");
  script_set_attribute(attribute:"description", value:
"The remote SAP NetWeaver ABAP server may be affected by an arbitrary file upload vulnerability. An arbitrary file upload
vulnerability exists in the content repositiory due to missing a signature check. An unauthenticated, remote attacker can
exploit this to upload arbitrary files on the remote host subject to the privileges of the user.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://me.sap.com/notes/3448171");
...
"Apply the appropriate patch according to the vendor advisory.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-33006");
