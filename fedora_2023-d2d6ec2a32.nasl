...
# extracted from Fedora Security Advisory FEDORA-2023-d2d6ec2a32
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-d2d6ec2a32");
  script_xref(name:"IAVA", value:"2023-A-0121-S");

  script_name(english:"Fedora 37 : sudo (2023-d2d6ec2a32)");
...
FEDORA-2023-d2d6ec2a32 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-d2d6ec2a32");
...
var pkgs = [
    {'reference':'sudo-1.9.13-1.p2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
