...
# extracted from Amazon Linux 2 Security Advisory ALAS-2018-981.
#
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : libvorbis (ALAS-2018-981)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"Vorbis audio processing out of bounds write (MFSA 2018-08) :
...
(CVE-2018-5146)");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2018-981.html");
...
flag = 0;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"libvorbis-1.3.3-8.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"libvorbis-debuginfo-1.3.3-8.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"libvorbis-devel-1.3.3-8.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"libvorbis-devel-docs-1.3.3-8.amzn2.0.1")) flag++;
