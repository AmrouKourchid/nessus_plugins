...
# extracted from Fedora Security Advisory FEDORA-2023-31b242abfa
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-31b242abfa");

  script_name(english:"Fedora 39 : pypy3.9 (2023-31b242abfa)");
...
FEDORA-2023-31b242abfa advisory.

    Automatic update for pypy3.9-7.3.11-4.3.9.fc39.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-31b242abfa");
...
var pkgs = [
    {'reference':'pypy3.9-7.3.11-4.3.9.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
