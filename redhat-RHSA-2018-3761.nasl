...
# extracted from Red Hat Security Advisory RHSA-2018:3761. The text 
...
the RHSA-2018:3761 advisory.
    ...
    * Previously, the flushpage operator has been removed as part of a major clean-up of a non-standard
    operator. However, flushpage has been found to be used in a few specific use cases. With this update, it
    has been re-added to support those use cases. (BZ#1654290)

Tenable has extracted the preceding description block directly from the Red Hat Enterprise Linux security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2018/rhsa-2018_3761.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6ba6563d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:3761");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1652893");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1654290");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ghostscript-9.07-31.el7_6.3', 'release':'7', 'el_string':'el7_6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ghostscript-cups-9.07-31.el7_6.3', 'release':'7', 'el_string':'el7_6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ghostscript-devel-9.07-31.el7_6.3', 'release':'7', 'el_string':'el7_6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ghostscript-doc-9.07-31.el7_6.3', 'release':'7', 'el_string':'el7_6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ghostscript-gtk-9.07-31.el7_6.3', 'release':'7', 'el_string':'el7_6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
