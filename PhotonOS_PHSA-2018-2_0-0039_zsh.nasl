...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Zsh PHSA-2018-2.0-0039");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'zsh-5.3.1-7.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'zsh-debuginfo-5.3.1-7.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'zsh-html-5.3.1-7.ph2')) flag++;
