...
# extracted from Fedora Security Advisory FEDORA-2022-a425aea810
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-a425aea810");

  script_name(english:"Fedora 37 : snapd (2022-a425aea810)");
...
FEDORA-2022-a425aea810 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-a425aea810");
...
var pkgs = [
    {'reference':'snapd-2.57.6-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
