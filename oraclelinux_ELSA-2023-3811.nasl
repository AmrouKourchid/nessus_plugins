...
# extracted from Oracle Linux Security Advisory ELSA-2023-3811.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : python39:3.9 / and / python39-devel:3.9 (ELSA-2023-3811)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
ELSA-2023-3811 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-3811.html");
...
var appstreams = {
    'python39:3.9': [
      {'reference':'python39-3.9.16-1.module+el8.8.0+21116+ee8c18cf.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python39-debug-3.9.16-1.module+el8.8.0+21116+ee8c18cf.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-devel-3.9.16-1.module+el8.8.0+21116+ee8c18cf.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-idle-3.9.16-1.module+el8.8.0+21116+ee8c18cf.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-idna-2.10-3.module+el8.4.0+20109+b7b1db01', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-libs-3.9.16-1.module+el8.8.0+21116+ee8c18cf.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python39-rpm-macros-3.9.16-1.module+el8.8.0+21116+ee8c18cf.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python39-test-3.9.16-1.module+el8.8.0+21116+ee8c18cf.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-tkinter-3.9.16-1.module+el8.8.0+21116+ee8c18cf.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python39-3.9.16-1.module+el8.8.0+21116+ee8c18cf.1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python39-debug-3.9.16-1.module+el8.8.0+21116+ee8c18cf.1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-devel-3.9.16-1.module+el8.8.0+21116+ee8c18cf.1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-idle-3.9.16-1.module+el8.8.0+21116+ee8c18cf.1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-idna-2.10-3.module+el8.4.0+20109+b7b1db01', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-libs-3.9.16-1.module+el8.8.0+21116+ee8c18cf.1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python39-rpm-macros-3.9.16-1.module+el8.8.0+21116+ee8c18cf.1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python39-test-3.9.16-1.module+el8.8.0+21116+ee8c18cf.1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-tkinter-3.9.16-1.module+el8.8.0+21116+ee8c18cf.1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
