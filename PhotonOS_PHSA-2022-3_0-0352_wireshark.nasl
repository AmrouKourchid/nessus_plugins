...
# extracted from VMware Security Advisory PHSA-2022-3.0-0352. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Wireshark PHSA-2022-3.0-0352");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the wireshark package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-3.0-352.md");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'wireshark-3.6.1-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'wireshark-devel-3.6.1-1.ph3')) flag++;
