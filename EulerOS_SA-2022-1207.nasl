...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : icu (EulerOS-SA-2022-1207)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1207
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9d5e3486");
...
"Update the affected icu packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:icu-help");
...
var pkgs = [
  "icu-help-62.1-5.h2.eulerosv2r10",
  "libicu-62.1-5.h2.eulerosv2r10",
  "libicu-devel-62.1-5.h2.eulerosv2r10"
];
