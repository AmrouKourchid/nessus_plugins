...
# extracted from Red Hat Security Advisory jruby. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2018-1000073");

  script_name(english:"RHEL 6 : jruby (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-1000073");
