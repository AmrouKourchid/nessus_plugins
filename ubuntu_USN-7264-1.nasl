...
# extracted from Ubuntu Security Notice USN-7264-1. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2024-9143", "CVE-2024-12797", "CVE-2024-13176");
  script_xref(name:"USN", value:"7264-1");
  script_xref(name:"IAVA", value:"2025-A-0127");

  script_name(english:"Ubuntu 24.10 : OpenSSL vulnerabilities (USN-7264-1)");
...
USN-7264-1 advisory.
    ...
    It was discovered that OpenSSL clients incorrectly handled authenticating servers using RFC7250 Raw Public
    Keys. In certain cases, the connection will not abort as expected, possibly causing the communication to
    be intercepted. (CVE-2024-12797)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7264-1");
  script_set_attribute(attribute:"solution", value:
"Update the affected libssl-dev, libssl3t64 and / or openssl packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2024-12797");
...
var pkgs = [
    {'osver': '24.10', 'pkgname': 'libssl-dev', 'pkgver': '3.3.1-2ubuntu2.1'},
    {'osver': '24.10', 'pkgname': 'libssl3t64', 'pkgver': '3.3.1-2ubuntu2.1'},
    {'osver': '24.10', 'pkgname': 'openssl', 'pkgver': '3.3.1-2ubuntu2.1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libssl-dev / libssl3t64 / openssl');
}
