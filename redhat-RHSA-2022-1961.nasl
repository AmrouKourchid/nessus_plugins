...
# extracted from Red Hat Security Advisory RHSA-2022:1961. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:1961");

  script_name(english:"RHEL 8 : cairo and pixman (RHSA-2022:1961)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for cairo / pixman.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2022:1961 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_1961.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9d267bdf");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:1961");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1898396");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL cairo / pixman packages based on the guidance in RHSA-2022:1961.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cairo-1.15.12-6.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'cairo-devel-1.15.12-6.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'cairo-gobject-1.15.12-6.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'cairo-gobject-devel-1.15.12-6.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'cairo / cairo-devel / cairo-gobject / cairo-gobject-devel');
}
