...
# extracted from Red Hat Security Advisory RHSA-2021:1608. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:1608");

  script_name(english:"RHEL 8 : python-cryptography (RHSA-2021:1608)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has a package installed that is affected by multiple vulnerabilities as
referenced in the RHSA-2021:1608 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_1608.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c6a6aecb");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:1608");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-cryptography-3.2.1-4.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
