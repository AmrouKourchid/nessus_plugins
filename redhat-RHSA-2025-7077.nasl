...
# extracted from Red Hat Security Advisory RHSA-2025:7077. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:7077");

  script_name(english:"RHEL 9 : libtasn1 (RHSA-2025:7077)");
...
the RHSA-2025:7077 advisory.

    A library that provides Abstract Syntax Notation One (ASN.1, as specified by the X.680 ITU-T
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2344611");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_7077.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f7a72f2f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:7077");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libtasn1 package based on the guidance in RHSA-2025:7077.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libtasn1-4.16.0-9.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libtasn1-devel-4.16.0-9.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libtasn1-tools-4.16.0-9.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
