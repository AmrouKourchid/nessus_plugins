...
if (description)
{
  ...
  script_cve_id("CVE-2024-49942");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-49942 (deprecated)");
...
"n/a");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-49942");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2024-49942");
