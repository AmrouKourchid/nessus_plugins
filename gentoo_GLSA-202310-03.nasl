...
# extracted from Gentoo Linux Security Advisory GLSA 202310-03.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202310-03 : glibc: Multiple vulnerabilities");
...
"The remote host is affected by the vulnerability described in GLSA-202310-03 (glibc: Multiple vulnerabilities)
  ...
  - An issue was discovered in the GNU C Library (glibc) 2.36. When the syslog function is passed a crafted
    input string larger than 1024 bytes, it reads uninitialized memory from the heap and prints it to the
    target log file, potentially revealing a portion of the contents of the heap. (CVE-2022-39046)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202310-03");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=867952");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=914281");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=915127");
...
var packages = [
  {
    'name' : 'sys-libs/glibc',
    'unaffected' : make_list("ge 2.37-r7"),
    'vulnerable' : make_list("lt 2.37-r7")
  }
];
