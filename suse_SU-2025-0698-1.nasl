...
# SUSE update advisory SUSE-SU-2025:0698-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2025:0698-1");

  script_name(english:"SUSE SLES15 Security Update : kernel (Live Patch 25 for SLE 15 SP4) (SUSE-SU-2025:0698-1)");
...
the SUSE-SU-2025:0698-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2025-February/020430.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2703a9a9");
...
"Update the affected kernel-livepatch-5_14_21-150400_24_116-default package.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '5.14.21-150400.24.116-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_14_21-150400_24_116-default-13-150400.2.1', 'sp':'4', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.4']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kernel-livepatch-5_14_21-150400_24_116-default');
}
