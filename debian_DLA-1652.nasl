...
# extracted from Debian Security Advisory DLA-1652-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1652-1 : libvncserver security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"A vulnerability was found by Kaspersky Lab in libvncserver, a C
library to implement VNC server/client functionalities. In addition,
some of the vulnerabilities addressed in DLA 1617-1 were found to have
incomplete fixes, and have been addressed in this update.

CVE-2018-15126

An attacker can cause denial of service or remote code execution via a
heap use-after-free issue in the tightvnc-filetransfer extension.
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2019/01/msg00029.html");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"libvncclient0", reference:"0.9.9+dfsg2-6.1+deb8u5")) flag++;
if (deb_check(release:"8.0", prefix:"libvncclient0-dbg", reference:"0.9.9+dfsg2-6.1+deb8u5")) flag++;
if (deb_check(release:"8.0", prefix:"libvncserver-config", reference:"0.9.9+dfsg2-6.1+deb8u5")) flag++;
if (deb_check(release:"8.0", prefix:"libvncserver-dev", reference:"0.9.9+dfsg2-6.1+deb8u5")) flag++;
if (deb_check(release:"8.0", prefix:"libvncserver0", reference:"0.9.9+dfsg2-6.1+deb8u5")) flag++;
if (deb_check(release:"8.0", prefix:"libvncserver0-dbg", reference:"0.9.9+dfsg2-6.1+deb8u5")) flag++;
if (deb_check(release:"8.0", prefix:"linuxvnc", reference:"0.9.9+dfsg2-6.1+deb8u5")) flag++;
