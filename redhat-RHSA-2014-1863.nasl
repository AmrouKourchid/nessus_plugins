...
if (description)
{
  ...
  script_name(english:"RHEL 6 : Subscription Asset Manager 1.4 (RHSA-2014:1863)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for Subscription Asset Manager 1.4.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 6 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2014:1863 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2014/rhsa-2014_1863.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?02f1bab9");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2014:1863");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1036483");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1036910");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1036922");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1095105");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=921329");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=921331");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=921335");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Subscription Asset Manager 1.4 package based on the guidance in RHSA-2014:1863.");
...
var constraints = [
  {
    'repo_relative_urls': [
      'content/dist/rhel/server/6/6Server/x86_64/subscription-asset-manager/1/debug',
      'content/dist/rhel/server/6/6Server/x86_64/subscription-asset-manager/1/os',
      'content/dist/rhel/server/6/6Server/x86_64/subscription-asset-manager/1/source/SRPMS'
    ],
    'pkgs': [
      {'reference':'katello-common-1.4.3.28-1.el6sam_splice', 'release':'6', 'el_string':'el6sam_splice', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'katello-glue-candlepin-1.4.3.28-1.el6sam_splice', 'release':'6', 'el_string':'el6sam_splice', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'katello-glue-elasticsearch-1.4.3.28-1.el6sam_splice', 'release':'6', 'el_string':'el6sam_splice', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'katello-headpin-1.4.3.28-1.el6sam_splice', 'release':'6', 'el_string':'el6sam_splice', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'katello-headpin-all-1.4.3.28-1.el6sam_splice', 'release':'6', 'el_string':'el6sam_splice', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ruby193-rubygem-actionmailer-3.2.17-1.el6sam', 'release':'6', 'el_string':'el6sam', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'ruby193-rubygem-actionpack-3.2.17-6.el6sam', 'release':'6', 'el_string':'el6sam', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'ruby193-rubygem-activemodel-3.2.17-1.el6sam', 'release':'6', 'el_string':'el6sam', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'ruby193-rubygem-activerecord-3.2.17-5.el6sam', 'release':'6', 'el_string':'el6sam', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'ruby193-rubygem-activeresource-3.2.17-1.el6sam', 'release':'6', 'el_string':'el6sam', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'ruby193-rubygem-activesupport-3.2.17-2.el6sam', 'release':'6', 'el_string':'el6sam', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'ruby193-rubygem-i18n-0.6.9-1.el6sam', 'release':'6', 'el_string':'el6sam', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ruby193-rubygem-mail-2.5.4-1.el6sam', 'release':'6', 'el_string':'el6sam', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ruby193-rubygem-rack-1.4.5-3.el6sam', 'release':'6', 'el_string':'el6sam', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'ruby193-rubygem-rails-3.2.17-1.el6sam', 'release':'6', 'el_string':'el6sam', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'ruby193-rubygem-railties-3.2.17-1.el6sam', 'release':'6', 'el_string':'el6sam', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
