...
# extracted from Red Hat Security Advisory RHSA-2020:3084. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:3084");
  script_xref(name:"CEA-ID", value:"CEA-2021-0004");

  script_name(english:"RHEL 7 : rh-nodejs10-nodejs (RHSA-2020:3084)");
...
referenced in the RHSA-2020:3084 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_3084.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?98f09d14");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:3084");
...
"Update the RHEL rh-nodejs10-nodejs package based on the guidance in RHSA-2020:3084.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-nodejs10-nodejs-10.21.0-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs10-nodejs-devel-10.21.0-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs10-nodejs-docs-10.21.0-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs10-npm-6.14.4-10.21.0.3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
