...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : pcre (EulerOS-SA-2019-1098)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1098
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3661e8c9");
...
pkgs = ["pcre-8.32-15.1.h7",
        "pcre-devel-8.32-15.1.h7"];
