...
# extracted from Red Hat Security Advisory RHSA-2024:5927. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:5927");

  script_name(english:"RHEL 8 : postgresql:16 (RHSA-2024:5927)");
...
referenced in the RHSA-2024:5927 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_5927.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5ad2c11d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:5927");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL postgresql:16 package based on the guidance in RHSA-2024:5927.");
  ...
  'postgresql:16': [
    {
      ...
      'pkgs': [
        {'reference':'pg_repack-1.4.8-1.module+el8.10.0+20413+d8116364', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'postgresql-16.4-1.module+el8.10.0+22209+060d7a0a', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-contrib-16.4-1.module+el8.10.0+22209+060d7a0a', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-docs-16.4-1.module+el8.10.0+22209+060d7a0a', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plperl-16.4-1.module+el8.10.0+22209+060d7a0a', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plpython3-16.4-1.module+el8.10.0+22209+060d7a0a', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-pltcl-16.4-1.module+el8.10.0+22209+060d7a0a', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-private-devel-16.4-1.module+el8.10.0+22209+060d7a0a', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-private-libs-16.4-1.module+el8.10.0+22209+060d7a0a', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-16.4-1.module+el8.10.0+22209+060d7a0a', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-devel-16.4-1.module+el8.10.0+22209+060d7a0a', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-static-16.4-1.module+el8.10.0+22209+060d7a0a', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-16.4-1.module+el8.10.0+22209+060d7a0a', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-rpm-macros-16.4-1.module+el8.10.0+22209+060d7a0a', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-upgrade-16.4-1.module+el8.10.0+22209+060d7a0a', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-upgrade-devel-16.4-1.module+el8.10.0+22209+060d7a0a', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
