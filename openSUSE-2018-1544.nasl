...
# extracted from openSUSE Security Update openSUSE-2018-1544.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : Mozilla Firefox (openSUSE-2018-1544)");
...
if ( rpm_check(release:"SUSE42.3", reference:"MozillaFirefox-60.4.0-125.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"MozillaFirefox-branding-upstream-60.4.0-125.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"MozillaFirefox-buildsymbols-60.4.0-125.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"MozillaFirefox-debuginfo-60.4.0-125.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"MozillaFirefox-debugsource-60.4.0-125.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"MozillaFirefox-devel-60.4.0-125.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"MozillaFirefox-translations-common-60.4.0-125.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"MozillaFirefox-translations-other-60.4.0-125.1") ) flag++;
