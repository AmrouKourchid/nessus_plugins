...
# extracted from Fedora Security Advisory FEDORA-2023-608dd04117
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-608dd04117");
  script_xref(name:"IAVA", value:"2023-A-0702-S");

  script_name(english:"Fedora 38 : thunderbird (2023-608dd04117)");
...
FEDORA-2023-608dd04117 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-608dd04117");
...
var pkgs = [
    {'reference':'thunderbird-115.6.0-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
