...
# extracted from SUSE update advisory SUSE-SU-2020:2118-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLED15 / SLES15 Security Update : MozillaFirefox (SUSE-SU-2020:2118-1)");
...
without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=1174538");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?61cc0764");
...
zypper in -t patch
SUSE-SLE-Module-Desktop-Applications-15-SP1-2020-2118=1");
...
flag = 0;
if (rpm_check(release:"SLES15", sp:"1", cpu:"x86_64", reference:"MozillaFirefox-devel-78.1.0-3.100.2")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"MozillaFirefox-78.1.0-3.100.2")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"MozillaFirefox-debuginfo-78.1.0-3.100.2")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"MozillaFirefox-debugsource-78.1.0-3.100.2")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"MozillaFirefox-translations-common-78.1.0-3.100.2")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"MozillaFirefox-translations-other-78.1.0-3.100.2")) flag++;
if (rpm_check(release:"SLED15", sp:"1", cpu:"x86_64", reference:"MozillaFirefox-devel-78.1.0-3.100.2")) flag++;
if (rpm_check(release:"SLED15", sp:"1", reference:"MozillaFirefox-78.1.0-3.100.2")) flag++;
if (rpm_check(release:"SLED15", sp:"1", reference:"MozillaFirefox-debuginfo-78.1.0-3.100.2")) flag++;
if (rpm_check(release:"SLED15", sp:"1", reference:"MozillaFirefox-debugsource-78.1.0-3.100.2")) flag++;
if (rpm_check(release:"SLED15", sp:"1", reference:"MozillaFirefox-translations-common-78.1.0-3.100.2")) flag++;
if (rpm_check(release:"SLED15", sp:"1", reference:"MozillaFirefox-translations-other-78.1.0-3.100.2")) flag++;
