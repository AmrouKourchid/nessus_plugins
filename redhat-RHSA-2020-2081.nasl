...
# extracted from Red Hat Security Advisory RHSA-2020:2081. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:2081");

  script_name(english:"RHEL 7 : python-virtualenv (RHSA-2020:2081)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for python-virtualenv.");
...
referenced in the RHSA-2020:2081 advisory.

    The virtualenv tool creates isolated Python environments. The virtualenv tool is a successor to
    workingenv, and an extension of virtual-python.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_2081.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?17cc2106");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:2081");
...
"Update the RHEL python-virtualenv package based on the guidance in RHSA-2020:2081.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python-virtualenv-15.1.0-4.el7_8', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
