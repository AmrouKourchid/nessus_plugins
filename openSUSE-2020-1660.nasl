...
# extracted from openSUSE Security Update openSUSE-2020-1660.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : nodejs10 (openSUSE-2020-1660)");
...
This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1172686");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1173937");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1176589");
...
if ( rpm_check(release:"SUSE15.2", reference:"nodejs10-10.22.1-lp152.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"nodejs10-debuginfo-10.22.1-lp152.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"nodejs10-debugsource-10.22.1-lp152.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"nodejs10-devel-10.22.1-lp152.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"npm10-10.22.1-lp152.2.6.1") ) flag++;
