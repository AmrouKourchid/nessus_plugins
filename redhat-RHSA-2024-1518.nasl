...
# extracted from Red Hat Security Advisory RHSA-2024:1518. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:1518");

  script_name(english:"RHEL 8 : Red Hat OpenStack Platform 16.2.6 (python-twisted) (RHSA-2024:1518)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for Red Hat OpenStack Platform 16.2.6 (python-twisted).");
...
the RHSA-2024:1518 advisory.

    Twisted is a networking engine written in Python, supporting numerous protocols. It contains a web server,
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_1518.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?66a51037");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2246264");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:1518");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat OpenStack Platform 16.2.6 (python-twisted) package based on the guidance in RHSA-2024:1518.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-twisted-16.4.1-21.el8ost', 'cpu':'ppc64le', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'python3-twisted-16.4.1-21.el8ost', 'cpu':'x86_64', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
