...
# extracted from Gentoo Linux Security Advisory GLSA 202003-11.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202003-11");

  script_name(english:"GLSA-202003-11 : SVG Salamander: Server-Side Request Forgery");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202003-11
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202003-11");
...
"Gentoo has discontinued support for SVG Salamander. We recommend that
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-5617");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:svgsalamander");
...
if (qpkg_check(package:"dev-java/svgsalamander", unaffected:make_list(), vulnerable:make_list("le 0.0-r2"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "SVG Salamander");
}
