...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : sssd (EulerOS-SA-2024-1922)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1922
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9abcf957");
...
var pkgs = [
  "python3-sssd-2.2.2-6.h20.eulerosv2r10",
  "sssd-2.2.2-6.h20.eulerosv2r10"
];
