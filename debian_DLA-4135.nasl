...
# extracted from Debian Security Advisory dla-4135. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-4135 : haproxy - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has packages installed that are affected by a vulnerability as referenced in the dla-4135
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2025-32464");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'haproxy', 'reference': '2.2.9-2+deb11u7'},
    {'release': '11.0', 'prefix': 'haproxy-doc', 'reference': '2.2.9-2+deb11u7'},
    {'release': '11.0', 'prefix': 'vim-haproxy', 'reference': '2.2.9-2+deb11u7'}
];
