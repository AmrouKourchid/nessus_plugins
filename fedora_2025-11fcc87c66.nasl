...
# extracted from Fedora Security Advisory FEDORA-2025-11fcc87c66
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-11fcc87c66");

  script_name(english:"Fedora 41 : perl / perl-Devel-Cover / perl-PAR-Packer (2025-11fcc87c66)");
...
FEDORA-2025-11fcc87c66 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-11fcc87c66");
  script_set_attribute(attribute:"solution", value:
"Update the affected 4:perl, perl-Devel-Cover and / or perl-PAR-Packer packages.");
...
var pkgs = [
    {'reference':'perl-5.40.2-515.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
    {'reference':'perl-Devel-Cover-1.44-4.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'perl-PAR-Packer-1.063-5.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'perl / perl-Devel-Cover / perl-PAR-Packer');
}
