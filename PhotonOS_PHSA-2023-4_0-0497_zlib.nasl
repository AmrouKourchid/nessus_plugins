...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Zlib PHSA-2023-4.0-0497");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'zlib-1.2.11-6.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'zlib-devel-1.2.11-6.ph4')) flag++;
