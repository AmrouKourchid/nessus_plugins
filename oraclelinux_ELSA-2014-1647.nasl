...
# Oracle Linux Security Advisory ELSA-2014-1647 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : thunderbird (ELSA-2014-1647)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2014-1647.html");
...
var pkgs = [
    {'reference':'thunderbird-31.2.0-3.0.1.el6_6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'thunderbird-31.2.0-3.0.1.el6_6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
