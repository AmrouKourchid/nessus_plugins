...
# extracted from Ubuntu Security Notice USN-4071-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"4071-1");

  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS : Patch vulnerabilities (USN-4071-1)");
...
referenced in the USN-4071-1 advisory.

    It was discovered that Patch incorrectly handled certain files. An attacker could possibly use this issue
    to access sensitive information. (CVE-2019-13636)

    It was discovered that Patch incorrectly handled certain files. An attacker could possibly use this issue
    to execute arbitrary code. (CVE-2019-13638)

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4071-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'patch', 'pkgver': '2.7.5-1ubuntu0.16.04.2'},
    {'osver': '18.04', 'pkgname': 'patch', 'pkgver': '2.7.6-2ubuntu1.1'}
];
