...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : curl (EulerOS-SA-2024-1926)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1926
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dd9771fe");
...
var pkgs = [
  "curl-7.69.1-2.h26.eulerosv2r9",
  "libcurl-7.69.1-2.h26.eulerosv2r9"
];
