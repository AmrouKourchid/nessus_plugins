...
if (description)
{
  ...
  script_name(english:"Tenable Nessus 8.x < 8.15.8 Privilege Escalation (TNS-2023-02)");
...
8.15.8. It is, therefore, affected by a privilege escalation vulnerability. An authenticated attacker could potentially 
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.tenable.com/security/tns-2023-02");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Tenable Nessus version 8.15.8 or later.");
...
constraints = [
  {'min_version':'8.0.0', 'fixed_version':'8.15.8'}
];
