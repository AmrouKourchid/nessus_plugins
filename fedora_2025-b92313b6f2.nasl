...
# extracted from Fedora Security Advisory FEDORA-2025-b92313b6f2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-b92313b6f2");

  script_name(english:"Fedora 41 : webkitgtk (2025-b92313b6f2)");
...
FEDORA-2025-b92313b6f2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-b92313b6f2");
...
var pkgs = [
    {'reference':'webkitgtk-2.48.0-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
