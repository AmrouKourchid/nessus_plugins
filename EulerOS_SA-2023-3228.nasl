...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : qemu-micro (EulerOS-SA-2023-3228)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the qemu-micro package installed, the EulerOS installation on the remote host is affected
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3228
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?48adb48e");
  script_set_attribute(attribute:"solution", value:
"Update the affected qemu-micro packages.");
...
var pkgs = [
  "qemu-img-4.1.0-35.h7.eulerosv2r10"
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "qemu-micro");
}
