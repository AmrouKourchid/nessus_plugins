...
# extracted from Red Hat Security Advisory RHSA-2021:0742. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:0742");

  script_name(english:"RHEL 7 : screen (RHSA-2021:0742)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for screen.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_0742.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ec7cd802");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:0742");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1927062");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL screen package based on the guidance in RHSA-2021:0742.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:screen");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'screen-4.1.0-0.27.20120314git3c2946.el7_9', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'screen-4.1.0-0.27.20120314git3c2946.el7_9', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'screen-4.1.0-0.27.20120314git3c2946.el7_9', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'screen-4.1.0-0.27.20120314git3c2946.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
