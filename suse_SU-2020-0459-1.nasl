...
# extracted from SUSE update advisory SUSE-SU-2020:0459-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : libvpx (SUSE-SU-2020:0459-1)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?29440a25");
...
SUSE-SLE-WE-12-SP5-2020-459=1

SUSE Linux Enterprise Workstation Extension 12-SP4:zypper in -t patch
SUSE-SLE-WE-12-SP4-2020-459=1

SUSE Linux Enterprise Software Development Kit 12-SP5:zypper in -t
patch SUSE-SLE-SDK-12-SP5-2020-459=1

SUSE Linux Enterprise Software Development Kit 12-SP4:zypper in -t
patch SUSE-SLE-SDK-12-SP4-2020-459=1

SUSE Linux Enterprise Server 12-SP5:zypper in -t patch
SUSE-SLE-SERVER-12-SP5-2020-459=1

SUSE Linux Enterprise Server 12-SP4:zypper in -t patch
SUSE-SLE-SERVER-12-SP4-2020-459=1");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:suse_linux:libvpx1-debuginfo");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"4", reference:"libvpx-debugsource-1.3.0-3.6.1")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libvpx1-1.3.0-3.6.1")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libvpx1-debuginfo-1.3.0-3.6.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libvpx-debugsource-1.3.0-3.6.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libvpx1-1.3.0-3.6.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libvpx1-debuginfo-1.3.0-3.6.1")) flag++;
