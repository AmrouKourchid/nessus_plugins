...
# extracted from openSUSE Security Update openSUSE-2019-8.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libraw (openSUSE-2019-8)");
...
The following security vulnerabilities were addressed :
  ...
  - CVE-2018-5804,CVE-2018-5816: Fixed a type confusion
    error in the identify function (bsc#1097975)

This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1097975");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1103200");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1103206");
...
if ( rpm_check(release:"SUSE15.0", reference:"libraw-debuginfo-0.18.9-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libraw-debugsource-0.18.9-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libraw-devel-0.18.9-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libraw-devel-static-0.18.9-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libraw-tools-0.18.9-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libraw-tools-debuginfo-0.18.9-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libraw16-0.18.9-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libraw16-debuginfo-0.18.9-lp150.2.3.1") ) flag++;
