...
# extracted from Red Hat Security Advisory RHSA-2024:0212. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:0212");

  script_name(english:"RHEL 9 : Red Hat OpenStack Platform 17.1 (python-django) (RHSA-2024:0212)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0212.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?61decbfd");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2218004");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0212");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat OpenStack Platform 17.1 (python-django) package based on the guidance in RHSA-2024:0212.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-django-2.2.24-5.el9ost', 'release':'9', 'el_string':'el9ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
