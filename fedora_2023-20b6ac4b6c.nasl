...
# extracted from Fedora Security Advisory FEDORA-2023-20b6ac4b6c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-20b6ac4b6c");

  script_name(english:"Fedora 39 : open-vm-tools (2023-20b6ac4b6c)");
...
FEDORA-2023-20b6ac4b6c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-20b6ac4b6c");
...
var pkgs = [
    {'reference':'open-vm-tools-12.3.0-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
