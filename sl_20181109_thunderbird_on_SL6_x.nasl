...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : thunderbird on SL6.x i386/x86_64 (20181109)");
...
Security Fix(es) :
  ...
  - Mozilla: Memory safety bugs fixed in Firefox ESR 60.3
    (CVE-2018-12389)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1811&L=scientific-linux-errata&F=&S=&P=413
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3035db6a");
...
flag = 0;
if (rpm_check(release:"SL6", reference:"thunderbird-60.3.0-1.el6", allowmaj:TRUE)) flag++;
if (rpm_check(release:"SL6", reference:"thunderbird-debuginfo-60.3.0-1.el6", allowmaj:TRUE)) flag++;
