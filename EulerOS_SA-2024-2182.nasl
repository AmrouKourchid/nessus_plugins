...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.0 : libtiff (EulerOS-SA-2024-2182)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2182
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a8768a81");
...
var pkgs = [
  "libtiff-4.3.0-9.h26.eulerosv2r11"
];
