...
# AlmaLinux Security Advisory ALSA-2022:5214.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2022:5214");

  script_name(english:"AlmaLinux 9 : kpatch-patch (ALSA-2022:5214)");
...
ALSA-2022:5214 advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2022-5214.html");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  var cve_list = make_list('CVE-2022-1012', 'CVE-2022-1966', 'CVE-2022-27666');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for ALSA-2022:5214');
  }
  else
  {
