...
# extracted from Red Hat Security Advisory openjpeg2. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2016-9112", "CVE-2017-14164");

  script_name(english:"RHEL 6 : openjpeg2 (Unpatched Vulnerability) (deprecated)");
