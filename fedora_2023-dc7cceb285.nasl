...
# extracted from Fedora Security Advisory FEDORA-2023-dc7cceb285
#
...
if (description)
{
  ...
  script_cve_id("CVE-2022-41723", "CVE-2023-3978");
  script_xref(name:"FEDORA", value:"2023-dc7cceb285");

  script_name(english:"Fedora 39 : golang-x-net (2023-dc7cceb285)");
...
FEDORA-2023-dc7cceb285 advisory.

    Automatic update for golang-x-net-0.14.0-1.fc39.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-dc7cceb285");
  script_set_attribute(attribute:"solution", value:
"Update the affected golang-x-net package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:golang-x-net");
...
var pkgs = [
    {'reference':'golang-x-net-0.14.0-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'golang-x-net');
}
