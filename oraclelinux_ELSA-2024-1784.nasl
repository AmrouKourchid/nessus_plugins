...
# extracted from Oracle Linux Security Advisory ELSA-2024-1784.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : gnutls (ELSA-2024-1784)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
ELSA-2024-1784 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-1784.html");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"cpe:/a:oracle:linux:8::u4_security_validation");
...
var pkgs = [
    {'reference':'gnutls-3.6.16-8.el8_9.3_fips', 'cpu':'aarch64', 'release':'8', 'el_string':'el8_9.3_fips', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10'},
    {'reference':'gnutls-c++-3.6.16-8.el8_9.3_fips', 'cpu':'aarch64', 'release':'8', 'el_string':'el8_9.3_fips', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10'},
    {'reference':'gnutls-dane-3.6.16-8.el8_9.3_fips', 'cpu':'aarch64', 'release':'8', 'el_string':'el8_9.3_fips', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10'},
    {'reference':'gnutls-devel-3.6.16-8.el8_9.3_fips', 'cpu':'aarch64', 'release':'8', 'el_string':'el8_9.3_fips', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10'},
    {'reference':'gnutls-utils-3.6.16-8.el8_9.3_fips', 'cpu':'aarch64', 'release':'8', 'el_string':'el8_9.3_fips', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10'},
    {'reference':'gnutls-3.6.16-8.el8_9.3_fips', 'cpu':'i686', 'release':'8', 'el_string':'el8_9.3_fips', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10'},
    {'reference':'gnutls-c++-3.6.16-8.el8_9.3_fips', 'cpu':'i686', 'release':'8', 'el_string':'el8_9.3_fips', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10'},
    {'reference':'gnutls-dane-3.6.16-8.el8_9.3_fips', 'cpu':'i686', 'release':'8', 'el_string':'el8_9.3_fips', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10'},
    {'reference':'gnutls-devel-3.6.16-8.el8_9.3_fips', 'cpu':'i686', 'release':'8', 'el_string':'el8_9.3_fips', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10'},
    {'reference':'gnutls-utils-3.6.16-8.el8_9.3_fips', 'cpu':'i686', 'release':'8', 'el_string':'el8_9.3_fips', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10'},
    {'reference':'gnutls-3.6.16-8.el8_9.3_fips', 'cpu':'x86_64', 'release':'8', 'el_string':'el8_9.3_fips', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10'},
    {'reference':'gnutls-c++-3.6.16-8.el8_9.3_fips', 'cpu':'x86_64', 'release':'8', 'el_string':'el8_9.3_fips', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10'},
    {'reference':'gnutls-dane-3.6.16-8.el8_9.3_fips', 'cpu':'x86_64', 'release':'8', 'el_string':'el8_9.3_fips', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10'},
    {'reference':'gnutls-devel-3.6.16-8.el8_9.3_fips', 'cpu':'x86_64', 'release':'8', 'el_string':'el8_9.3_fips', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10'},
    {'reference':'gnutls-utils-3.6.16-8.el8_9.3_fips', 'cpu':'x86_64', 'release':'8', 'el_string':'el8_9.3_fips', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10'}
];
