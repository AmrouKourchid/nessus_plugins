...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_2039.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?21e642db");
...
"Update the RHEL squid:4 package based on the guidance in RHSA-2020:2039.");
  ...
  'squid:4': [
    {
      ...
      'pkgs': [
        ...
        {'reference':'squid-4.4-8.module+el8.1.0+6436+af881f9b.1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
      ]
    }
  ]
};
