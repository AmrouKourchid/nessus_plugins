...
# Rocky Linux Security Advisory RLSA-2024:4212.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2024:4212");
  script_xref(name:"IAVB", value:"2024-B-0071-S");

  script_name(english:"Rocky Linux 9 : golang (RLSA-2024:4212)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2024:4212");
...
var pkgs = [
    ...
    {'reference':'go-toolset-1.21.11-1.el9_4', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'golang-1.21.11-1.el9_4', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'golang-bin-1.21.11-1.el9_4', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
