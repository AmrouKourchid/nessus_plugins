...
# extracted from Fedora Security Advisory FEDORA-2023-37bdea9241
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-37bdea9241");

  script_name(english:"Fedora 38 : tcpreplay (2023-37bdea9241)");
...
FEDORA-2023-37bdea9241 advisory.

    Patch CVE-2023-27783 - CVE-2023-27789
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-37bdea9241");
...
var pkgs = [
    {'reference':'tcpreplay-4.4.3-3.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
