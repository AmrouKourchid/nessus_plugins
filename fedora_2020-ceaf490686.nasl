...
# extracted from Fedora Security Advisory FEDORA-2020-ceaf490686.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 33 : curl (2020-ceaf490686)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-ceaf490686");
...
flag = 0;
if (rpm_check(release:"FC33", reference:"curl-7.71.1-8.fc33")) flag++;
