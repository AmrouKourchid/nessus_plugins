...
if (description)
{
  ...
  script_cve_id("CVE-2020-0478");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2020-0478");
...
patch available.
  ...
  - In extend_frame_lowbd of restoration.c, there is a possible out of bounds write due to a missing bounds
    check. This could lead to local escalation of privilege with no additional execution privileges needed.
    User interaction is needed for exploitation.Product: AndroidVersions: Android-11Android ID: A-150780418
    (CVE-2020-0478)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-0478");
