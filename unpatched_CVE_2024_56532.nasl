...
if (description)
{
  ...
  script_cve_id("CVE-2024-56532");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-56532");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: ALSA: us122l: Use
    ...
    release at the last close. The loop of us122l->mmap_count check is dropped as well. The check is useless
    for the asynchronous operation with *_when_closed(). (CVE-2024-56532)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-56532");
