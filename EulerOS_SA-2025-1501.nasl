...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : binutils (EulerOS-SA-2025-1501)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1501
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2acdb878");
...
var pkgs = [
  "binutils-2.34-4.h24.r2.eulerosv2r10"
];
