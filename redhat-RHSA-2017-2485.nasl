...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2017/rhsa-2017_2485.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?42d30227");
...
"Update the RHEL git package based on the guidance in RHSA-2017:2485.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'emacs-git-1.7.1-9.el6_9', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'emacs-git-el-1.7.1-9.el6_9', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-1.7.1-9.el6_9', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-1.7.1-9.el6_9', 'cpu':'ppc64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-1.7.1-9.el6_9', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-1.7.1-9.el6_9', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-all-1.7.1-9.el6_9', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-cvs-1.7.1-9.el6_9', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-daemon-1.7.1-9.el6_9', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-daemon-1.7.1-9.el6_9', 'cpu':'ppc64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-daemon-1.7.1-9.el6_9', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-daemon-1.7.1-9.el6_9', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-email-1.7.1-9.el6_9', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-gui-1.7.1-9.el6_9', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-svn-1.7.1-9.el6_9', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gitk-1.7.1-9.el6_9', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gitweb-1.7.1-9.el6_9', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'perl-Git-1.7.1-9.el6_9', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
