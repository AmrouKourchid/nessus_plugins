...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_7529.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bc21d61a");
...
"Update the RHEL container-tools:3.0 package based on the guidance in RHSA-2022:7529.");
  ...
  script_cwe_id(200, 444, 770, 772, 1325);
