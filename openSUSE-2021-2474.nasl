...
# openSUSE Security Update openSUSE-SU-2021:2474-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : qemu (openSUSE-SU-2021:2474-1)");
...
the openSUSE-SU-2021:2474-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?98333537");
...
var pkgs = [
    {'reference':'qemu-s390-4.2.1-11.25.2', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE}
];
