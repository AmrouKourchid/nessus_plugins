...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : openldap (EulerOS-SA-2020-1872)");
...
vulnerability :
  ...
  - libldap in certain third-party OpenLDAP packages has a
    certificate-validation flaw when the third-party
    package is asserting RFC6125 support. It considers CN
    even when there is a non-matching subjectAltName (SAN).
    This is fixed in, for example, openldap-2.4.46-10.el8
    in Red Hat Enterprise Linux.(CVE-2020-15719)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1872
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2cc618ac");
...
pkgs = ["openldap-2.4.46-8.h9.eulerosv2r8",
        "openldap-clients-2.4.46-8.h9.eulerosv2r8",
        "openldap-devel-2.4.46-8.h9.eulerosv2r8",
        "openldap-servers-2.4.46-8.h9.eulerosv2r8"];
