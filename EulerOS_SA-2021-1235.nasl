...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : subversion (EulerOS-SA-2021-1235)");
...
vulnerability :
  ...
  - In Apache Subversion versions up to and including
    ...
    process may exit when a well-formed read-only request
    produces a particular answer. This can lead to
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1235
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f2d458a5");
...
pkgs = ["mod_dav_svn-1.7.14-14.h2.eulerosv2r7",
        "subversion-1.7.14-14.h2.eulerosv2r7",
        "subversion-libs-1.7.14-14.h2.eulerosv2r7"];
