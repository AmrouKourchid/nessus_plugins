...
# extracted from F5 Networks BIG-IP Solution K54252492.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2018-3693");

  script_name(english:"F5 Networks BIG-IP : Side-channel processor vulnerability (K54252492)");

  script_set_attribute(attribute:"synopsis", value:
"The remote device is missing a vendor-supplied security patch.");
  script_set_attribute(attribute:"description", value:
"The version of F5 Networks BIG-IP installed on the remote host is prior to 14.1.2.3 / 15.0.0. It is, therefore, affected
by a vulnerability as referenced in the K54252492 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K54252492");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K54252492.");
...
var vmatrix = {
  'AFM': {
    'affected': [
      '14.0.0-14.1.2','13.0.0-13.1.5','12.1.0-12.1.6','11.6.1-11.6.5','11.5.1-11.5.10','11.2.1'
    ],
    'unaffected': [
      '15.0.0','14.1.2.3'
    ],
