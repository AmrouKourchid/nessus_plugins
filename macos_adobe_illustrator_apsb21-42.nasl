...
if (description)
{
  ...
  script_name(english:"Adobe Illustrator < 25.3.0 Multiple Vulnerabilities (APSB21-42) (macOS)");

  script_set_attribute(attribute:"synopsis", value:
"The Adobe Illustrator instance installed on the remote host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Illustrator installed on the remote macOS host is prior to 25.3.0. It is, therefore, affected by
