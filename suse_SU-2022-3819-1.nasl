...
# SUSE update advisory SUSE-SU-2022:3819-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:3819-1");

  script_name(english:"SUSE SLES15 Security Update : podman (SUSE-SU-2022:3819-1)");
...
in the SUSE-SU-2022:3819-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-October/012774.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1407f293");
...
var pkgs = [
    {'reference':'podman-3.4.7-150300.9.12.1', 'sp':'3', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.3']},
    {'reference':'podman-cni-config-3.4.7-150300.9.12.1', 'sp':'3', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.3']},
    {'reference':'podman-3.4.7-150300.9.12.1', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.3', 'sle-module-containers-release-15.3', 'sles-release-15.3']},
    {'reference':'podman-cni-config-3.4.7-150300.9.12.1', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.3', 'sle-module-containers-release-15.3', 'sles-release-15.3']}
];
