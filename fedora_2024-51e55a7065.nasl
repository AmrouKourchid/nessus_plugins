...
# extracted from Fedora Security Advisory FEDORA-2024-51e55a7065
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-51e55a7065");

  script_name(english:"Fedora 38 : micropython (2024-51e55a7065)");
...
FEDORA-2024-51e55a7065 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-51e55a7065");
...
"Update the affected micropython package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-7158");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:micropython");
...
var pkgs = [
    {'reference':'micropython-1.22.2-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
