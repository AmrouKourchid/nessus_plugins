...
# openSUSE Security Update openSUSE-SU-2024:0274-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : cacti, cacti-spine (openSUSE-SU-2024:0274-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote openSUSE host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote openSUSE 15 host has packages installed that are affected by multiple vulnerabilities as referenced in the
openSUSE-SU-2024:0274-1 advisory.
...
number.");
  ...
  # https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/RAIZKHB2VPK6KRYTE3TU44EJVFAT4WWP/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?caa3619f");
...
var pkgs = [
    {'reference':'cacti-1.2.27-bp155.2.9.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cacti-spine-1.2.27-bp155.2.9.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE}
];
