...
# extracted from Fedora Security Advisory FEDORA-2024-d5de04f5cd
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-d5de04f5cd");

  script_name(english:"Fedora 38 : dotnet8.0 (2024-d5de04f5cd)");
...
FEDORA-2024-d5de04f5cd advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-d5de04f5cd");
...
var pkgs = [
    {'reference':'dotnet8.0-8.0.101-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
