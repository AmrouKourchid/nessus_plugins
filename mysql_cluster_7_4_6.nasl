...
if (description)
{
  ...
  script_name(english:"MySQL Cluster 7.4.x < 7.4.6 General Subcomponent DoS (January 2017 CPU)");
...
to 7.4.6. It is, therefore, affected by an unspecified flaw in the
General subcomponent that allows an unauthenticated, remote attacker
to cause a denial of service condition.");
  # https://dev.mysql.com/doc/relnotes/mysql-cluster/7.4/en/mysql-cluster-news-7-4-6.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?507ee478");
  # http://www.oracle.com/technetwork/security-advisory/cpujan2017-2881727.html#AppendixMSQL
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a1c38e52");
  script_set_attribute(attribute:"solution", value:
"Upgrade to MySQL Cluster version 7.4.6 or later as referenced in the
...
mysql_check_version(variant:'Cluster', fixed:'7.4.6', min:'7.4', severity:SECURITY_WARNING);
