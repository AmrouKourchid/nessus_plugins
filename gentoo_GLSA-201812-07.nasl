...
# extracted from Gentoo Linux Security Advisory GLSA 201812-07.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201812-07");

  script_name(english:"GLSA-201812-07 : SpamAssassin: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-201812-07
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/201812-07");
...
if (qpkg_check(package:"mail-filter/spamassassin", unaffected:make_list("ge 3.4.2-r2"), vulnerable:make_list("lt 3.4.2-r2"))) flag++;
