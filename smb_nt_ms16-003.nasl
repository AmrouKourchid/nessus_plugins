...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"3124625");
  script_xref(name:"MSKB", value:"3124624");
...
arbitrary code in the context of the current user.");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2016/ms16-003");
