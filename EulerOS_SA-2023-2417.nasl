...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : unbound (EulerOS-SA-2023-2417)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2417
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e587416c");
...
var pkgs = [
  "unbound-1.6.6-1.h6.eulerosv2r7",
  "unbound-libs-1.6.6-1.h6.eulerosv2r7"
];
