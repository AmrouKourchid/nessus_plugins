...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : wavpack (EulerOS-SA-2022-1954)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the wavpack package installed, the EulerOS installation on the remote host is affected by
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1954
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?71484e54");
...
var pkgs = [
  "wavpack-5.1.0-9.h6.eulerosv2r8"
];
