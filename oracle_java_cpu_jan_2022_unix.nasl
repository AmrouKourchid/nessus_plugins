...
if (description)
{
  ...
  script_name(english:"Oracle Java SE 1.7.0_331 / 1.8.0_321 / 1.11.0_14 / 1.17.0_2 Multiple Vulnerabilities (Unix January 2022 CPU)");
...
# 7u321, 8u311, 11.0.13, 17.01
var constraints = [
  { 'min_version' : '7.0.0', 'fixed_version' : '7.0.331', 'fixed_display' : 'Upgrade to version 7.0.331 or greater' },
  { 'min_version' : '8.0.0', 'fixed_version' : '8.0.321', 'fixed_display' : 'Upgrade to version 8.0.321 or greater' },
  { 'min_version' : '11.0.0', 'fixed_version' : '11.0.14', 'fixed_display' : 'Upgrade to version 11.0.14 or greater' },
  { 'min_version' : '17.0.0', 'fixed_version' : '17.0.2', 'fixed_display' : 'Upgrade to version 17.0.2 or greater' }
];
