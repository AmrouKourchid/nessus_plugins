...
# extracted from Debian Security Advisory DLA-1948-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1948-1 : ruby-mini-magick security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2019/10/msg00007.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/jessie/ruby-mini-magick");
  script_set_attribute(attribute:"solution", value:
"Upgrade the affected ruby-mini-magick package.");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"ruby-mini-magick", reference:"3.8.1-1+deb8u1")) flag++;
