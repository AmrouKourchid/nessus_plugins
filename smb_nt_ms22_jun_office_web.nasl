...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5002210");
  script_xref(name:"MSKB", value:"5002214");
  script_xref(name:"MSFT", value:"MS22-5002210");
  script_xref(name:"MSFT", value:"MS22-5002214");
  script_xref(name:"IAVA", value:"2022-A-0239-S");
  script_xref(name:"IAVA", value:"2022-A-0238-S");

  script_name(english:"Security Updates for Microsoft Office Web Apps (June 2022)");

  script_set_attribute(attribute:"synopsis", value:
"The Microsoft Office Web Apps installation on the remote host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The Microsoft Office Web Apps installation on the remote host is missing security updates. It is, therefore, affected by
multiple vulnerabilities:
  ...
  - An information disclosure vulnerability. An attacker can
    ...
    information. (CVE-2022-30159, CVE-2022-30171,
    CVE-2022-30172)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002210");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002214");
...
if (owa_2013_path && (!isnull(owa_2013_sp) && owa_2013_sp == '1'))
{
  ...
  if (hotfix_check_fversion(file:'sword.dll', version:'15.0.5459.1000', min_version:'15.0.0.0', path:path, kb:'5002214', product:'Office Web Apps 2013') == HCF_OLDER)
    vuln = TRUE;
}
...
if (oos_path && (!isnull(oos_sp) && oos_sp == '0'))
{
  ...
  if (hotfix_check_fversion(file:'sword.dll', version:'16.0.10387.20000', min_version:'16.0.10000.0', path:path, kb:'5002210', product:'Office Online Server') == HCF_OLDER)
    vuln = TRUE;
}
