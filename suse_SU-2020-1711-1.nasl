...
# extracted from SUSE update advisory SUSE-SU-2020:1711-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES15 Security Update : mariadb (SUSE-SU-2020:1711-1)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4a5fe6cd");
...
zypper in -t patch
SUSE-SLE-Module-Server-Applications-15-SP1-2020-1711=1");
...
flag = 0;
if (rpm_check(release:"SLES15", sp:"1", reference:"libmysqld-devel-10.2.32-3.29.2")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"libmysqld19-10.2.32-3.29.2")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"libmysqld19-debuginfo-10.2.32-3.29.2")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"mariadb-10.2.32-3.29.2")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"mariadb-client-10.2.32-3.29.2")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"mariadb-client-debuginfo-10.2.32-3.29.2")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"mariadb-debuginfo-10.2.32-3.29.2")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"mariadb-debugsource-10.2.32-3.29.2")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"mariadb-tools-10.2.32-3.29.2")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"mariadb-tools-debuginfo-10.2.32-3.29.2")) flag++;
