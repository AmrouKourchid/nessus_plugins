...
# extracted from Fedora Security Advisory FEDORA-2020-126a0dd319.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : curl (2020-126a0dd319)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"- fix expired pointer dereference via multi API with
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-126a0dd319");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"curl-7.66.0-3.fc31")) flag++;
