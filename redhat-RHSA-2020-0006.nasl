...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_0006.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7c913f3f");
...
"Update the RHEL java-1.8.0-ibm package based on the guidance in RHSA-2020:0006.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'java-1.8.0-ibm-1.8.0.6.0-1jpp.1.el6_10', 'cpu':'s390x', 'release':'6', 'el_string':'el6_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.8.0-ibm-1.8.0.6.0-1jpp.1.el6_10', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.8.0-ibm-devel-1.8.0.6.0-1jpp.1.el6_10', 'cpu':'s390x', 'release':'6', 'el_string':'el6_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.8.0-ibm-devel-1.8.0.6.0-1jpp.1.el6_10', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
