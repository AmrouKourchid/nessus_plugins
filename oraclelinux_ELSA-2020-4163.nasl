...
# extracted from Oracle Linux Security Advisory ELSA-2020-4163.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : thunderbird (ELSA-2020-4163)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2020-4163.html");
...
var pkgs = [
    {'reference':'thunderbird-78.3.1-1.0.1.el7_9', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'thunderbird-78.3.1-1.0.1.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
