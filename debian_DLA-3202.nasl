...
# extracted from Debian Security Advisory dla-3202. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3202 : bsdcpio - security update");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'bsdcpio', 'reference': '3.3.3-4+deb10u2'},
    {'release': '10.0', 'prefix': 'bsdtar', 'reference': '3.3.3-4+deb10u2'},
    {'release': '10.0', 'prefix': 'libarchive-dev', 'reference': '3.3.3-4+deb10u2'},
    {'release': '10.0', 'prefix': 'libarchive-tools', 'reference': '3.3.3-4+deb10u2'},
    {'release': '10.0', 'prefix': 'libarchive13', 'reference': '3.3.3-4+deb10u2'}
];
