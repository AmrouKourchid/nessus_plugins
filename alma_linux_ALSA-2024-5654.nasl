...
# AlmaLinux Security Advisory ALSA-2024:5654.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:5654");

  script_name(english:"AlmaLinux 8 : curl (ALSA-2024:5654)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 8 host has packages installed that are affected by a vulnerability as referenced in the
ALSA-2024:5654 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2024-5654.html");
...
var pkgs = [
    {'reference':'curl-7.61.1-34.el8_10.2', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'libcurl-7.61.1-34.el8_10.2', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'libcurl-devel-7.61.1-34.el8_10.2', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'libcurl-minimal-7.61.1-34.el8_10.2', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'}
];
