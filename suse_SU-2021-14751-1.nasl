...
# SUSE update advisory SUSE-SU-2021:14751-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2021:14751-1");

  script_name(english:"SUSE SLES11 Security Update : libgcrypt (SUSE-SU-2021:14751-1)");
...
in the SUSE-SU-2021:14751-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f7071a4a");
  script_set_attribute(attribute:"solution", value:
"Update the affected libgcrypt11 and / or libgcrypt11-32bit packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:suse_linux:libgcrypt11-32bit");
...
var pkgs = [
    {'reference':'libgcrypt11-1.5.0-0.26.6', 'sp':'4', 'release':'SLES_SAP11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-11.4']},
    {'reference':'libgcrypt11-32bit-1.5.0-0.26.6', 'sp':'4', 'cpu':'s390x', 'release':'SLES_SAP11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-11.4']},
    {'reference':'libgcrypt11-32bit-1.5.0-0.26.6', 'sp':'4', 'cpu':'x86_64', 'release':'SLES_SAP11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-11.4']},
    {'reference':'libgcrypt11-1.5.0-0.26.6', 'sp':'4', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.4']},
    {'reference':'libgcrypt11-32bit-1.5.0-0.26.6', 'sp':'4', 'cpu':'s390x', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.4']},
    {'reference':'libgcrypt11-32bit-1.5.0-0.26.6', 'sp':'4', 'cpu':'x86_64', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.4']}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libgcrypt11 / libgcrypt11-32bit');
}
