...
# extracted from openSUSE Security Update openSUSE-2019-2265.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : bind (openSUSE-2019-2265)");
...
Security issue fixed :
  ...
  - CVE-2019-6471: Fixed a reachable assert in dispatch.c.
    (bsc#1138687)

Non-security issue fixed :

  - bind will no longer rely on /etc/insserv.conf
...
This update was imported from the SUSE:SLE-15:Update update project.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1138687");
...
if ( rpm_check(release:"SUSE15.1", reference:"bind-9.11.2-lp151.11.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"bind-chrootenv-9.11.2-lp151.11.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"bind-debuginfo-9.11.2-lp151.11.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"bind-debugsource-9.11.2-lp151.11.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"bind-devel-9.11.2-lp151.11.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"bind-lwresd-9.11.2-lp151.11.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"bind-lwresd-debuginfo-9.11.2-lp151.11.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"bind-utils-9.11.2-lp151.11.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"bind-utils-debuginfo-9.11.2-lp151.11.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libbind9-160-9.11.2-lp151.11.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libbind9-160-debuginfo-9.11.2-lp151.11.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libdns169-9.11.2-lp151.11.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libdns169-debuginfo-9.11.2-lp151.11.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libirs-devel-9.11.2-lp151.11.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libirs160-9.11.2-lp151.11.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libirs160-debuginfo-9.11.2-lp151.11.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libisc166-9.11.2-lp151.11.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libisc166-debuginfo-9.11.2-lp151.11.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libisccc160-9.11.2-lp151.11.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libisccc160-debuginfo-9.11.2-lp151.11.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libisccfg160-9.11.2-lp151.11.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libisccfg160-debuginfo-9.11.2-lp151.11.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"liblwres160-9.11.2-lp151.11.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"liblwres160-debuginfo-9.11.2-lp151.11.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"python3-bind-9.11.2-lp151.11.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"bind-devel-32bit-9.11.2-lp151.11.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libbind9-160-32bit-9.11.2-lp151.11.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libbind9-160-32bit-debuginfo-9.11.2-lp151.11.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libdns169-32bit-9.11.2-lp151.11.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libdns169-32bit-debuginfo-9.11.2-lp151.11.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libirs160-32bit-9.11.2-lp151.11.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libirs160-32bit-debuginfo-9.11.2-lp151.11.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libisc166-32bit-9.11.2-lp151.11.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libisc166-32bit-debuginfo-9.11.2-lp151.11.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libisccc160-32bit-9.11.2-lp151.11.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libisccc160-32bit-debuginfo-9.11.2-lp151.11.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libisccfg160-32bit-9.11.2-lp151.11.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libisccfg160-32bit-debuginfo-9.11.2-lp151.11.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"liblwres160-32bit-9.11.2-lp151.11.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"liblwres160-32bit-debuginfo-9.11.2-lp151.11.6.1") ) flag++;
