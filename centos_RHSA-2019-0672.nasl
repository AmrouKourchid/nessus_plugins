...
# extracted from Red Hat Security Advisory RHSA-2019:0672 and 
# CentOS Errata and Security Advisory 2019:0672 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : firefox (CESA-2019:0672)");
...
the CVE page(s) listed in the References section.");
  # https://lists.centos.org/pipermail/centos-announce/2019-April/023255.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?76895583");
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"firefox-60.6.1-1.el6.centos", allowmaj:TRUE)) flag++;
