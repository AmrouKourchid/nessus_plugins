...
if (description)
{
  ...
  script_name(english:"Apache Tomcat 10.1.27 < 10.1.31 multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Apache Tomcat server is affected by multiple vulnerabilities");
  script_set_attribute(attribute:"description", value:
"The version of Tomcat installed on the remote host is prior to 10.1.31. It is, therefore, affected by multiple
vulnerabilities as referenced in the fixed_in_apache_tomcat_10.1.31_security-10 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?010a9fda");
  # https://github.com/apache/tomcat/commit/acc2f01395f895980f5d8a64573fcc1bade13369
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b595cdf0");
  # https://tomcat.apache.org/security-10.html#Fixed_in_Apache_Tomcat_10.1.31
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e8ab0762");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Apache Tomcat version 10.1.31 or later.");
...
var constraints = [
  { 'min_version' : '10.1.27', 'max_version' : '10.1.30', 'fixed_version' : '10.1.31' }
];
