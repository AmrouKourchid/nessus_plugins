...
# extracted from Fedora Security Advisory FEDORA-2023-cfe20dbcab
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-cfe20dbcab");

  script_name(english:"Fedora 37 : mingw-glib2 (2023-cfe20dbcab)");
...
FEDORA-2023-cfe20dbcab advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-cfe20dbcab");
...
var pkgs = [
    {'reference':'mingw-glib2-2.74.1-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
