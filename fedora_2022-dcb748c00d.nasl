...
# extracted from Fedora Security Advisory FEDORA-2022-dcb748c00d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-dcb748c00d");

  script_name(english:"Fedora 37 : gopass (2022-dcb748c00d)");
...
FEDORA-2022-dcb748c00d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-dcb748c00d");
  script_set_attribute(attribute:"solution", value:
"Update the affected gopass package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:gopass");
...
var pkgs = [
    {'reference':'gopass-1.14.0-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'gopass');
}
