...
if (description)
{
  ...
  script_name(english:"Amazon Corretto Java 17.x < 17.0.14.7.1 Vulnerability");

  script_set_attribute(attribute:"synopsis", value:
"Amazon Corretto is affected a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Amazon Corretto installed on the remote host is 17 prior to 17.0.14.7.1. It is, therefore, affected by a
vulnerability as referenced in the corretto-17-2025-Jan-21 advisory.

  - hotspot/compiler (CVE-2025-21502)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"solution", value:
"Update to Amazon Corretto Java 17.0.14.7.1 or later");
...
var constraints = [
  { 'min_version' : '17.0', 'fixed_version' : '17.0.14.7.1' }
];
