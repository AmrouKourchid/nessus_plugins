...
# extracted from Gentoo Linux Security Advisory GLSA 202312-16.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2023-6004", "CVE-2023-48795");

  script_name(english:"GLSA-202312-16 : libssh: Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202312-16 (libssh: Multiple Vulnerabilities)
  ...
  - ProxyCommand/ProxyJump features allow injection of malicious code through hostname [fedora-all]
    (CVE-2023-6004)

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202312-16");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=920291");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=920724");
...
var packages = [
  {
    ...
    'unaffected' : make_list("ge 0.10.6"),
    'vulnerable' : make_list("lt 0.10.6")
  }
];
