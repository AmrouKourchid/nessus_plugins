...
# extracted from Oracle Linux Security Advisory ELSA-2020-1604.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : tcpdump (ELSA-2020-1604)");
...
ELSA-2020-1604 advisory.

    [14:4.9.2-6]
    - Resolves: #1715423 - tcpdump pre creates user and groups unconditionally
    - Resolves: #1655622 - CVE-2018-19519 Stack-based buffer over-read in print-hncp.c:print_prefix() via
    crafted pcap
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2020-1604.html");
...
var pkgs = [
    {'reference':'tcpdump-4.9.2-6.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'14'},
    {'reference':'tcpdump-4.9.2-6.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'14'}
];
