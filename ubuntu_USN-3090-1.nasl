...
the USN-3090-1 advisory.

    It was discovered that a flaw in processing a compressed text chunk in a PNG image could cause the image
    to have a large size when decompressed, potentially leading to a denial of service. (CVE-2014-9601)

    Andrew Drake discovered that Pillow incorrectly validated input. A remote attacker could use this to cause
    Pillow to crash, resulting in a denial of service. (CVE-2014-3589)

    Eric Soroos discovered that Pillow incorrectly handled certain malformed FLI, Tiff, and PhotoCD files. A
    remote attacker could use this issue to cause Pillow to crash, resulting in a denial of service.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3090-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'python-imaging', 'pkgver': '2.3.0-1ubuntu3.2'},
    {'osver': '14.04', 'pkgname': 'python-imaging-compat', 'pkgver': '2.3.0-1ubuntu3.2'},
    {'osver': '14.04', 'pkgname': 'python-imaging-sane', 'pkgver': '2.3.0-1ubuntu3.2'},
    {'osver': '14.04', 'pkgname': 'python-imaging-tk', 'pkgver': '2.3.0-1ubuntu3.2'},
    {'osver': '14.04', 'pkgname': 'python-pil', 'pkgver': '2.3.0-1ubuntu3.2'},
    {'osver': '14.04', 'pkgname': 'python-pil.imagetk', 'pkgver': '2.3.0-1ubuntu3.2'},
    {'osver': '14.04', 'pkgname': 'python-sane', 'pkgver': '2.3.0-1ubuntu3.2'},
    {'osver': '14.04', 'pkgname': 'python3-imaging', 'pkgver': '2.3.0-1ubuntu3.2'},
    {'osver': '14.04', 'pkgname': 'python3-imaging-sane', 'pkgver': '2.3.0-1ubuntu3.2'},
    {'osver': '14.04', 'pkgname': 'python3-imaging-tk', 'pkgver': '2.3.0-1ubuntu3.2'},
    {'osver': '14.04', 'pkgname': 'python3-pil', 'pkgver': '2.3.0-1ubuntu3.2'},
    {'osver': '14.04', 'pkgname': 'python3-pil.imagetk', 'pkgver': '2.3.0-1ubuntu3.2'},
    {'osver': '14.04', 'pkgname': 'python3-sane', 'pkgver': '2.3.0-1ubuntu3.2'}
];
