...
# extracted from Red Hat Security Advisory RHSA-2024:9317. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:9317");

  script_name(english:"RHEL 9 : NetworkManager (RHSA-2024:9317)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2295734");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-1418");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-17310");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-17350");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-17972");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-23446");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-24622");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-26750");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-26753");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-29856");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-29902");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-30348");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-31182");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-31980");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-33368");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-34617");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-36648");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-43720");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-44345");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-46904");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_9317.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?eac18b9c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:9317");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL NetworkManager package based on the guidance in RHSA-2024:9317.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'NetworkManager-1.48.10-2.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'NetworkManager-adsl-1.48.10-2.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'NetworkManager-bluetooth-1.48.10-2.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'NetworkManager-cloud-setup-1.48.10-2.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'NetworkManager-config-connectivity-redhat-1.48.10-2.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'NetworkManager-config-server-1.48.10-2.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'NetworkManager-dispatcher-routing-rules-1.48.10-2.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'NetworkManager-initscripts-updown-1.48.10-2.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'NetworkManager-libnm-1.48.10-2.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'NetworkManager-libnm-devel-1.48.10-2.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'NetworkManager-ovs-1.48.10-2.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'NetworkManager-ppp-1.48.10-2.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'NetworkManager-team-1.48.10-2.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'NetworkManager-tui-1.48.10-2.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'NetworkManager-wifi-1.48.10-2.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'NetworkManager-wwan-1.48.10-2.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
