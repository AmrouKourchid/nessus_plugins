...
# extracted from Red Hat Security Advisory RHSA-2024:6358. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:6358");

  script_name(english:"RHEL 9 : python-urllib3 (RHSA-2024:6358)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_6358.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4ed5b83a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2292788");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:6358");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-urllib3 package based on the guidance in RHSA-2024:6358.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-urllib3-1.26.5-3.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
