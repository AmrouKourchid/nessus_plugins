...
# extracted from Red Hat Security Advisory RHSA-2024:7702. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:7702");

  script_name(english:"RHEL 7 : firefox (RHSA-2024:7702)");
...
referenced in the RHSA-2024:7702 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-13327");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_7702.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0a453780");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:7702");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL firefox package based on the guidance in RHSA-2024:7702.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-128.3.0-1.el7_9', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-128.3.0-1.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
