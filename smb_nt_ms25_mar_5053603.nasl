...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5053603");
  script_xref(name:"MSFT", value:"MS25-5053603");
  ...
  script_name(english:"KB5053603: Windows Server 2022 / Azure Stack HCI 22H2 Security Update (March 2025)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5053603. It is, therefore, affected by multiple vulnerabilities
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5053603");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5053603");
