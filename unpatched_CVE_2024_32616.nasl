...
if (description)
{
  ...
  script_cve_id("CVE-2024-32616");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-32616");
...
patch available.
  ...
  - HDF5 Library through 1.14.3 contains a heap-based buffer over-read in H5O__dtype_encode_helper in
    H5Odtype.c. (CVE-2024-32616)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-32616");
