...
# extracted from Fedora Security Advisory FEDORA-2025-91031f9df9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-91031f9df9");

  script_name(english:"Fedora 40 : thunderbird (2025-91031f9df9)");
...
FEDORA-2025-91031f9df9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-91031f9df9");
...
var pkgs = [
    {'reference':'thunderbird-128.6.0-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
