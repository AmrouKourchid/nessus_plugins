...
# extracted from Oracle Linux Security Advisory ELSA-2022-7541.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : redis:6 (ELSA-2022-7541)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ELSA-2022-7541 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2022-7541.html");
...
var appstreams = {
    'redis:6': [
      {'reference':'redis-6.2.7-1.module+el8.7.0+20764+cc495aeb', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'redis-devel-6.2.7-1.module+el8.7.0+20764+cc495aeb', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'redis-doc-6.2.7-1.module+el8.7.0+20764+cc495aeb', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'redis-6.2.7-1.module+el8.7.0+20764+cc495aeb', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'redis-devel-6.2.7-1.module+el8.7.0+20764+cc495aeb', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'redis-doc-6.2.7-1.module+el8.7.0+20764+cc495aeb', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
};
