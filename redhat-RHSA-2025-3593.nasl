...
# extracted from Red Hat Security Advisory RHSA-2025:3593. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:3593");

  script_name(english:"RHEL 9 : opentelemetry-collector (RHSA-2025:3593)");
...
referenced in the RHSA-2025:3593 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_3593.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bd68c559");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:3593");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL opentelemetry-collector package based on the guidance in RHSA-2025:3593.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'opentelemetry-collector-0.107.0-7.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
