...
# AlmaLinux Security Advisory ALSA-2023:5071.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:5071");

  script_name(english:"AlmaLinux 9 : libcap (ALSA-2023:5071)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 9 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ALSA-2023:5071 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2023-5071.html");
