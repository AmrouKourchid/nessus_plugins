...
# extracted from Fedora Security Advisory FEDORA-2024-cd3a64f43b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-cd3a64f43b");
  script_xref(name:"IAVA", value:"2024-A-0245-S");

  script_name(english:"Fedora 40 : firefox (2024-cd3a64f43b)");
...
FEDORA-2024-cd3a64f43b advisory.

    - Updated to 124.0

    ----

    - Updated to latest upstream (123.0.1)

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-cd3a64f43b");
...
var pkgs = [
    {'reference':'firefox-124.0-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
