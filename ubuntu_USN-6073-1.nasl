...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS / 22.04 LTS / 23.04 : Cinder vulnerability (USN-6073-1)");
...
referenced in the USN-6073-1 advisory.

    Jan Wasilewski and Gorka Eguileor discovered that Cinder incorrectly handled deleted volume attachments.
