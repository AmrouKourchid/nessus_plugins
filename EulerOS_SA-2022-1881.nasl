...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : 389-ds-base (EulerOS-SA-2022-1881)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1881
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?53750b75");
...
var pkgs = [
  "389-ds-base-1.3.7.5-28.h6.eulerosv2r7",
  "389-ds-base-libs-1.3.7.5-28.h6.eulerosv2r7"
];
