...
if (description)
{
  ...
  script_name(english:"NuGet Package 'OpenAI' Detection");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.nuget.org/packages/OpenAI/");
  script_set_attribute(attribute:"solution", value:
"The OpenAI package is installed on the remote host.");
  ...
  script_set_attribute(attribute:"cpe", value:"cpe:/a:openai:openai");
...
var app_info = vcf::nuget_package::get_app_info(pkg_name:"OpenAI");
app_info.vendor = "OpenAI";
app_info.cpe = "cpe:/a:openai:openai";
