...
# extracted from Fedora Security Advisory FEDORA-2024-7b08207cdb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-7b08207cdb");

  script_name(english:"Fedora 39 : golang-x-crypto (2024-7b08207cdb)");
...
FEDORA-2024-7b08207cdb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-7b08207cdb");
...
var pkgs = [
    {'reference':'golang-x-crypto-0.18.0-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
