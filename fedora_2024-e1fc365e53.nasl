...
# extracted from Fedora Security Advisory FEDORA-2024-e1fc365e53
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-e1fc365e53");

  script_name(english:"Fedora 39 : dhcpcd (2024-e1fc365e53)");
...
FEDORA-2024-e1fc365e53 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-e1fc365e53");
...
"Update the affected dhcpcd package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:dhcpcd");
...
var pkgs = [
    {'reference':'dhcpcd-10.0.6-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
