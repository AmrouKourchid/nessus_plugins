...
January 2017 Oracle Critical Patch Update advisory.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-3323");
...
mysql_check_version(variant:'Cluster', fixed:'7.2.26', min:'7.2', severity:SECURITY_WARNING);
