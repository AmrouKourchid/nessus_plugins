...
# extracted from Fedora Security Advisory FEDORA-2019-d2257607b8.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : irssi (2019-d2257607b8)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-d2257607b8");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"irssi-1.2.2-1.fc31")) flag++;
