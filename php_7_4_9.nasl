...
if (description)
{
  ...
  script_name(english:"PHP 7.4.x < 7.4.9 Use-After-Free Vulnerability");
...
7.4.9. It is, therefore affected by a use-after-free vulnerability in the phar_parse function due to mishandling of the
...
which could lead to arbitrary code execution.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.php.net/ChangeLog-7.php#7.4.9");
...
constraints = [{'min_version':'7.4.0alpha1', 'fixed_version':'7.4.9'}];
