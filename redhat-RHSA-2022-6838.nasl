...
# extracted from Red Hat Security Advisory RHSA-2022:6838. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:6838");

  script_name(english:"RHEL 9 : expat (RHSA-2022:6838)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_6838.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?aa9a7626");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2130769");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:6838");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL expat package based on the guidance in RHSA-2022:6838.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'expat-2.2.10-12.el9_0.3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'expat-devel-2.2.10-12.el9_0.3', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'expat-2.2.10-12.el9_0.3', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'expat-devel-2.2.10-12.el9_0.3', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
