...
# Red Hat Security Advisory RHSA-2023:4520. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : python-requests (CESA-2023:4520)");
...
var pkgs = [
    {'reference':'python3-requests-2.20.0-3.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
