...
if (description)
{
  ...
  script_cve_id("CVE-2013-4237");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2013-4237");
...
patch available.
  ...
  - sysdeps/posix/readdir_r.c in the GNU C Library (aka glibc or libc6) 2.18 and earlier allows context-
    dependent attackers to cause a denial of service (out-of-bounds write and crash) or possibly execute
