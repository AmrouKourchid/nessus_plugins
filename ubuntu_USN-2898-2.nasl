...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : Eye of GNOME vulnerability (USN-2898-2)");
...
USN-2898-2 advisory.
    ...
    It was discovered that Eye of GNOME incorrectly handled certain large images. If a user were tricked into
    opening a specially-crafted image, a remote attacker could use this issue to cause Eye of GNOME to crash,
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2898-2");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'eog', 'pkgver': '3.10.2-0ubuntu5.1'},
    {'osver': '14.04', 'pkgname': 'eog-dev', 'pkgver': '3.10.2-0ubuntu5.1'}
];
