...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : postgresql (EulerOS-SA-2021-2426)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2426
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?73223bce");
...
pkgs = ["postgresql-9.2.24-1.h2",
        "postgresql-contrib-9.2.24-1.h2",
        "postgresql-devel-9.2.24-1.h2",
        "postgresql-docs-9.2.24-1.h2",
        "postgresql-libs-9.2.24-1.h2",
        "postgresql-plperl-9.2.24-1.h2",
        "postgresql-plpython-9.2.24-1.h2",
        "postgresql-pltcl-9.2.24-1.h2",
        "postgresql-server-9.2.24-1.h2",
        "postgresql-test-9.2.24-1.h2"];
