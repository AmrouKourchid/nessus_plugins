...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : haproxy (EulerOS-SA-2020-1757)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1757
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8a396376");
...
pkgs = ["haproxy-1.5.18-7.h1.eulerosv2r7"];
