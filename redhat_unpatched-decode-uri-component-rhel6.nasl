...
# extracted from Red Hat Security Advisory decode-uri-component. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 6 : decode-uri-component (Unpatched Vulnerability) (deprecated)");
