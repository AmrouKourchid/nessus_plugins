...
# extracted from Fedora Security Advisory FEDORA-2025-aaa849ae74
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-aaa849ae74");

  script_name(english:"Fedora 40 : libssh2 (2025-aaa849ae74)");
...
FEDORA-2025-aaa849ae74 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-aaa849ae74");
...
var pkgs = [
    {'reference':'libssh2-1.11.1-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
