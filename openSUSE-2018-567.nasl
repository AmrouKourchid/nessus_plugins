...
# extracted from openSUSE Security Update openSUSE-2018-567.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : glibc (openSUSE-2018-567)");
...
project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1086690");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1094150");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1094154");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1094161");
...
if ( rpm_check(release:"SUSE42.3", reference:"glibc-2.22-19.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"glibc-debuginfo-2.22-19.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"glibc-debugsource-2.22-19.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"glibc-devel-2.22-19.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"glibc-devel-debuginfo-2.22-19.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"glibc-devel-static-2.22-19.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"glibc-extra-2.22-19.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"glibc-extra-debuginfo-2.22-19.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"glibc-html-2.22-19.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"glibc-i18ndata-2.22-19.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"glibc-info-2.22-19.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"glibc-locale-2.22-19.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"glibc-locale-debuginfo-2.22-19.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"glibc-obsolete-2.22-19.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"glibc-obsolete-debuginfo-2.22-19.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"glibc-profile-2.22-19.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"glibc-utils-2.22-19.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"glibc-utils-debuginfo-2.22-19.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"glibc-utils-debugsource-2.22-19.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"nscd-2.22-19.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"nscd-debuginfo-2.22-19.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", cpu:"x86_64", reference:"glibc-utils-32bit-2.22-19.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", cpu:"x86_64", reference:"glibc-utils-debuginfo-32bit-2.22-19.1") ) flag++;
