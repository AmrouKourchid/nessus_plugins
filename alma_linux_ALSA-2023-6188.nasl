...
# AlmaLinux Security Advisory ALSA-2023:6188.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:6188");
  script_xref(name:"IAVA", value:"2023-A-0585-S");

  script_name(english:"AlmaLinux 9 : firefox (ALSA-2023:6188)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 9 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ALSA-2023:6188 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2023-6188.html");
...
"Update the affected firefox and / or firefox-x11 packages.");
  ...
  script_cwe_id(1021, 120, 356, 401, 450, 601, 755);
...
var pkgs = [
    {'reference':'firefox-115.4.0-1.el9_2.alma.1', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-115.4.0-1.el9_2.alma.1', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-x11-115.4.0-1.el9_2.alma.1', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-x11-115.4.0-1.el9_2.alma.1', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
