...
# extracted from Fedora Security Advisory FEDORA-2025-59cbb4663d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-59cbb4663d");

  script_name(english:"Fedora 41 : python3.6 (2025-59cbb4663d)");
...
FEDORA-2025-59cbb4663d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-59cbb4663d");
...
var pkgs = [
    {'reference':'python3.6-3.6.15-43.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
