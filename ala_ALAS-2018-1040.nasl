...
# extracted from Amazon Linux AMI Security Advisory ALAS-2018-1040.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2018-1040");

  script_name(english:"Amazon Linux AMI : wget (ALAS-2018-1040)");
...
arbitrary domains.(CVE-2018-0494)");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/ALAS-2018-1040.html");
...
flag = 0;
if (rpm_check(release:"ALA", reference:"wget-1.18-4.29.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"wget-debuginfo-1.18-4.29.amzn1")) flag++;
