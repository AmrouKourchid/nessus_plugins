...
if (description)
{
  ...
  script_name(english:"AIX (IJ45246)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AIX host is missing a security patch.");
  script_set_attribute(attribute:"description", value:
"The version of AIX installed on the remote host is prior to APAR IJ45246. It is, therefore, affected by a vulnerability
as referenced in the IJ45246 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/apar/IJ45246");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/node/6983236");
  script_set_attribute(attribute:"solution", value:
"Please apply the appropriate interim fix per APAR IJ45246.");
...
var constraints = [
    {'release': '7.3', 'ml': '01', 'sp': '01', 'patch': 'IJ45246s1a', 'package': 'bos.mp64', 'minfilesetver': '7.3.1.0', 'maxfilesetver': '7.3.1.1'},
    {'release': '7.3', 'ml': '01', 'sp': '01', 'patch': 'IJ45246s1a', 'package': 'bos.rte.serv_aid', 'minfilesetver': '7.3.1.0', 'maxfilesetver': '7.3.1.1'},
    {'release': '7.3', 'ml': '01', 'sp': '01', 'patch': 'IJ45246s1a', 'package': 'bos.sysmgt.serv_aid', 'minfilesetver': '7.3.1.0', 'maxfilesetver': '7.3.1.0'}
];
