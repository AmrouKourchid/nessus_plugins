...
if (description)
{
  ...
  script_name(english:"RHEL 6 : flash-plugin (RHSA-2011:1144)");
...
referenced in the RHSA-2011:1144 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2011/rhsa-2011_1144.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?82997c00");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#critical");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=729497");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2011:1144");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL flash-plugin package based on the guidance in RHSA-2011:1144.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:H/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:H/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:H/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2011-2425");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2011-2415");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'flash-plugin-10.3.183.5-1.el6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
