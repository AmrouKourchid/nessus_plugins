...
# extracted from Fedora Security Advisory FEDORA-2024-044dcdff8e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-044dcdff8e");

  script_name(english:"Fedora 40 : opendmarc (2024-044dcdff8e)");
...
FEDORA-2024-044dcdff8e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-044dcdff8e");
...
"Update the affected opendmarc package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-25768");
...
var pkgs = [
    {'reference':'opendmarc-1.4.2-21.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
