...
# extracted from Debian Security Advisory dla-4055. The text
...
if (description)
{
  script_id(216355);
  script_version("1.1");
  script_set_attribute(attribute:"plugin_modification_date", value:"2025/02/16");

  script_cve_id("CVE-2024-38479", "CVE-2024-50306");

  script_name(english:"Debian dla-4055 : trafficserver - security update");
...
"Upgrade the trafficserver packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-50306");
  ...
  script_set_attribute(attribute:"plugin_publication_date", value:"2025/02/16");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'trafficserver', 'reference': '8.1.11+ds-0+deb11u2'},
    {'release': '11.0', 'prefix': 'trafficserver-dev', 'reference': '8.1.11+ds-0+deb11u2'},
    {'release': '11.0', 'prefix': 'trafficserver-experimental-plugins', 'reference': '8.1.11+ds-0+deb11u2'}
];
