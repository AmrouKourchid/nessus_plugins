...
# extracted from Red Hat Security Advisory RHSA-2024:2551. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2551");

  script_name(english:"RHEL 9 : bind (RHSA-2024:2551)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for bind.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:2551 advisory.
    ...
    * bind: Enabling both DNS64 and serve-stale may cause an assertion failure during recursive resolution
    (CVE-2023-5679)

    * bind: Querying RFC 1918 reverse zones may cause an assertion failure when nxdomain-redirect is
    enabled (CVE-2023-5517)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2551.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9c928823");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2551");
...
"Update the RHEL bind package based on the guidance in RHSA-2024:2551.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:bind-doc");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'bind-9.16.23-18.el9_4.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-chroot-9.16.23-18.el9_4.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-devel-9.16.23-18.el9_4.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-dnssec-doc-9.16.23-18.el9_4.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-dnssec-utils-9.16.23-18.el9_4.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-doc-9.16.23-18.el9_4.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-libs-9.16.23-18.el9_4.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-license-9.16.23-18.el9_4.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-utils-9.16.23-18.el9_4.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'python3-bind-9.16.23-18.el9_4.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'bind-dyndb-ldap-11.9-9.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'bind-9.16.23-18.el9_4.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-chroot-9.16.23-18.el9_4.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-devel-9.16.23-18.el9_4.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-dnssec-doc-9.16.23-18.el9_4.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-dnssec-utils-9.16.23-18.el9_4.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-doc-9.16.23-18.el9_4.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-libs-9.16.23-18.el9_4.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-license-9.16.23-18.el9_4.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-utils-9.16.23-18.el9_4.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
  ...
  },
  {
    ...
    'pkgs': [
      {'reference':'bind-dyndb-ldap-11.9-9.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
