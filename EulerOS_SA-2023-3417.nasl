...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : vim (EulerOS-SA-2023-3417)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3417
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?30bd4d40");
...
var pkgs = [
  "vim-X11-7.4.160-4.h41.eulerosv2r7",
  "vim-common-7.4.160-4.h41.eulerosv2r7",
  "vim-enhanced-7.4.160-4.h41.eulerosv2r7",
  "vim-filesystem-7.4.160-4.h41.eulerosv2r7",
  "vim-minimal-7.4.160-4.h41.eulerosv2r7"
];
