...
# extracted from Red Hat Security Advisory RHSA-2022:0826. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:0826");

  script_name(english:"RHEL 8 : .NET 6.0 (RHSA-2022:0826)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2022:0826 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_0826.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?782b10b6");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:0826");
...
var constraints = [
  {
    ...
    'pkgs': [
      ...
      {'reference':'aspnetcore-runtime-6.0-6.0.3-4.el8_5', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'aspnetcore-targeting-pack-6.0-6.0.3-4.el8_5', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'aspnetcore-targeting-pack-6.0-6.0.3-4.el8_5', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-6.0.103-4.el8_5', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-6.0.103-4.el8_5', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'dotnet-apphost-pack-6.0-6.0.3-4.el8_5', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'dotnet-host-6.0.3-4.el8_5', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'dotnet-hostfxr-6.0-6.0.3-4.el8_5', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'dotnet-runtime-6.0-6.0.3-4.el8_5', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'dotnet-sdk-6.0-6.0.103-4.el8_5', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'dotnet-targeting-pack-6.0-6.0.3-4.el8_5', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'dotnet-templates-6.0-6.0.103-4.el8_5', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'netstandard-targeting-pack-2.1-6.0.103-4.el8_5', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
