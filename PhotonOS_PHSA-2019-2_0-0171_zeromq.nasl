...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Zeromq PHSA-2019-2.0-0171");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'zeromq-4.1.4-4.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'zeromq-debuginfo-4.1.4-4.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'zeromq-devel-4.1.4-4.ph2')) flag++;
