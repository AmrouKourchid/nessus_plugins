...
# extracted from Fedora Security Advisory FEDORA-2024-d1d07e01e8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-d1d07e01e8");

  script_name(english:"Fedora 41 : python3.9 (2024-d1d07e01e8)");
...
FEDORA-2024-d1d07e01e8 advisory.
    ...
    ```
    * Tue Aug 13 2024 Lumr Balhar <lbalhar@redhat.com> - 3.9.19-5
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-d1d07e01e8");
...
var pkgs = [
    {'reference':'python3.9-3.9.19-5.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
