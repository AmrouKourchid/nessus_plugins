...
# extracted from Ubuntu Security Notice USN-6960-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6960-1");

  script_name(english:"Ubuntu 20.04 LTS / 22.04 LTS : RMagick vulnerability (USN-6960-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6960-1");
  script_set_attribute(attribute:"solution", value:
"Update the affected ruby-rmagick package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:ruby-rmagick");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'ruby-rmagick', 'pkgver': '2.16.0-6ubuntu0.1', 'ubuntu_pro': FALSE},
    {'osver': '22.04', 'pkgname': 'ruby-rmagick', 'pkgver': '4.2.3-2ubuntu0.22.04.1~esm2', 'ubuntu_pro': TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'ruby-rmagick');
}
