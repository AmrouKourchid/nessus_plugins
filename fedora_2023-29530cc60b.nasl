...
# extracted from Fedora Security Advisory FEDORA-2023-29530cc60b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-29530cc60b");

  script_name(english:"Fedora 38 : opensc (2023-29530cc60b)");
...
FEDORA-2023-29530cc60b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-29530cc60b");
...
var pkgs = [
    {'reference':'opensc-0.23.0-5.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
