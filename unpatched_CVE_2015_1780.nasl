...
if (description)
{
  ...
  script_cve_id("CVE-2015-1780");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2015-1780 (deprecated)");
...
"n/a");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-1780");
