...
# extracted from Ubuntu Security Notice USN-4384-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"4384-1");

  script_name(english:"Ubuntu 20.04 LTS : GnuTLS vulnerability (USN-4384-1)");
...
USN-4384-1 advisory.
    ...
    It was discovered that GnuTLS incorrectly handled session ticket encryption keys. A remote attacker could
    possibly use this issue to bypass authentication or recover sensitive information.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4384-1");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'gnutls-bin', 'pkgver': '3.6.13-2ubuntu1.1'},
    {'osver': '20.04', 'pkgname': 'guile-gnutls', 'pkgver': '3.6.13-2ubuntu1.1'},
    {'osver': '20.04', 'pkgname': 'libgnutls-dane0', 'pkgver': '3.6.13-2ubuntu1.1'},
    {'osver': '20.04', 'pkgname': 'libgnutls-openssl27', 'pkgver': '3.6.13-2ubuntu1.1'},
    {'osver': '20.04', 'pkgname': 'libgnutls28-dev', 'pkgver': '3.6.13-2ubuntu1.1'},
    {'osver': '20.04', 'pkgname': 'libgnutls30', 'pkgver': '3.6.13-2ubuntu1.1'},
    {'osver': '20.04', 'pkgname': 'libgnutlsxx28', 'pkgver': '3.6.13-2ubuntu1.1'}
];
