...
# extracted from Red Hat Security Advisory RHSA-2025:4187. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:4187");

  script_name(english:"RHEL 9 : Red Hat OpenStack Platform 17.1 (python-django) (RHSA-2025:4187)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_4187.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?454b70d4");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:4187");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat OpenStack Platform 17.1 (python-django) package based on the guidance in RHSA-2025:4187.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-django-2.2.24-9.el9ost', 'release':'9', 'el_string':'el9ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
