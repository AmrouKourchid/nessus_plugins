...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : libvirt (EulerOS-SA-2024-2153)");
...
is affected by the following vulnerabilities :
    ...
    was concurrently being 'freed' when returning from virNetClientIOEventLoop(). The 'virtproxyd' daemon can
    be used to trigger requests. If libvirt is configured with fine-grained access control, this issue, in
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2153
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b93ebce8");
