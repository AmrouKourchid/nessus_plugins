...
# extracted from Red Hat Security Advisory RHSA-2024:6148. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:6148");

  script_name(english:"RHEL 8 : nodejs:18 (RHSA-2024:6148)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for nodejs:18.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:6148 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_6148.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e535f394");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:6148");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL nodejs:18 package based on the guidance in RHSA-2024:6148.");
  ...
  'nodejs:18': [
    {
      ...
      'pkgs': [
        {'reference':'nodejs-18.20.4-1.module+el8.10.0+22199+56ea0ead', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-devel-18.20.4-1.module+el8.10.0+22199+56ea0ead', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-docs-18.20.4-1.module+el8.10.0+22199+56ea0ead', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-full-i18n-18.20.4-1.module+el8.10.0+22199+56ea0ead', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        ...
        {'reference':'npm-10.7.0-1.18.20.4.1.module+el8.10.0+22199+56ea0ead', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
      ]
    }
  ]
};
