...
# extracted from Fedora Security Advisory FEDORA-2023-46c95e2c57
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-46c95e2c57");

  script_name(english:"Fedora 39 : golang-helm-3 (2023-46c95e2c57)");
...
FEDORA-2023-46c95e2c57 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-46c95e2c57");
  script_set_attribute(attribute:"solution", value:
"Update the affected golang-helm-3 package.");
...
var pkgs = [
    {'reference':'golang-helm-3-3.11.1-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'golang-helm-3');
}
