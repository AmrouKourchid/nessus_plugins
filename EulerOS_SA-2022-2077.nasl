...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.0 : libtiff (EulerOS-SA-2022-2077)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2077
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?417da306");
...
"Update the affected libtiff packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-0908");
...
var pkgs = [
  "libtiff-4.1.0-1.h6.eulerosv2r10"
];
