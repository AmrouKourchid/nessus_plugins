...
# extracted from Fedora Security Advisory FEDORA-2022-3d354ef0fb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-3d354ef0fb");

  script_name(english:"Fedora 35 : vim (2022-3d354ef0fb)");
...
FEDORA-2022-3d354ef0fb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-3d354ef0fb");
...
var pkgs = [
    {'reference':'vim-9.0.828-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
