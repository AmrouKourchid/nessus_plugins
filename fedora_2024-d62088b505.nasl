...
# extracted from Fedora Security Advisory FEDORA-2024-d62088b505
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-d62088b505");

  script_name(english:"Fedora 41 : ghc-base64 / ghc-hakyll / ghc-isocline / gitit / pandoc / etc (2024-d62088b505)");
...
FEDORA-2024-d62088b505 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-d62088b505");
...
var pkgs = [
    {'reference':'ghc-base64-0.4.2.4-28.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ghc-hakyll-4.16.2.0-4.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ghc-isocline-1.0.9-28.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'gitit-0.15.1.1-6.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pandoc-3.1.3-28.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pandoc-cli-0.1.1.1-28.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'patat-0.11.0.0-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'ghc-base64 / ghc-hakyll / ghc-isocline / gitit / pandoc / etc');
}
