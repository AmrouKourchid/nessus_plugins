...
# extracted from Fedora Security Advisory FEDORA-2023-1f5f7b9b92
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-1f5f7b9b92");
  script_xref(name:"IAVA", value:"2023-A-0522-S");

  script_name(english:"Fedora 38 : thunderbird (2023-1f5f7b9b92)");
...
FEDORA-2023-1f5f7b9b92 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-1f5f7b9b92");
...
var pkgs = [
    {'reference':'thunderbird-115.3.1-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
