...
# SUSE update advisory SUSE-SU-2022:0943-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:0943-1");

  script_name(english:"SUSE SLES15 Security Update : slirp4netns (SUSE-SU-2022:0943-1)");
...
in the SUSE-SU-2022:0943-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-March/010508.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?18cee5de");
  script_set_attribute(attribute:"solution", value:
"Update the affected slirp4netns package.");
...
var pkgs = [
    {'reference':'slirp4netns-0.4.7-3.15.1', 'sp':'3', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.3']},
    {'reference':'slirp4netns-0.4.7-3.15.1', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.3', 'sle-module-containers-release-15.3', 'sles-release-15.3']}
];
