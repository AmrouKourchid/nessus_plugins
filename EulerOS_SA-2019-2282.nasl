...
if (description)
{
  ...
  script_cve_id("CVE-2018-9055", "CVE-2018-19539", "CVE-2018-19542");

  script_name(english:"EulerOS 2.0 SP8 : jasper (EulerOS-SA-2019-2282)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2282
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5a83ef1f");
...
"Update the affected jasper packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2018-19542");
...
pkgs = ["jasper-libs-2.0.14-7.h2.eulerosv2r8"];
