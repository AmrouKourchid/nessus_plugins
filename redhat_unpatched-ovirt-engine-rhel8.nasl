...
if (description)
{
  ...
  script_cve_id("CVE-2018-1062");

  script_name(english:"RHEL 8 : ovirt-engine (Unpatched Vulnerability) (deprecated)");
...
"This plugin has been deprecated as it does not adhere to established standards for this style of check.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-1062");
