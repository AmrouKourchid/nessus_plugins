...
# extracted from Fedora Security Advisory FEDORA-2023-3dba61ad8c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-3dba61ad8c");

  script_name(english:"Fedora 37 : dotnet6.0 (2023-3dba61ad8c)");
...
FEDORA-2023-3dba61ad8c advisory.

    This is the October 24, 2023 release for .NET 6.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-3dba61ad8c");
...
var pkgs = [
    {'reference':'dotnet6.0-6.0.124-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
