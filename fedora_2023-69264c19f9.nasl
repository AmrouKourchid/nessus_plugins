...
# extracted from Fedora Security Advisory FEDORA-2023-69264c19f9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-69264c19f9");
  script_xref(name:"IAVA", value:"2023-A-0265-S");

  script_name(english:"Fedora 37 : chromium (2023-69264c19f9)");
...
FEDORA-2023-69264c19f9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-69264c19f9");
...
var pkgs = [
    {'reference':'chromium-113.0.5672.126-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
