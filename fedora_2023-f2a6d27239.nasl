...
# extracted from Fedora Security Advisory FEDORA-2023-f2a6d27239
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-f2a6d27239");

  script_name(english:"Fedora 37 : radare2 (2023-f2a6d27239)");
...
FEDORA-2023-f2a6d27239 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-f2a6d27239");
...
"Update the affected radare2 package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-5686");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2023-4322");
...
var pkgs = [
    {'reference':'radare2-5.8.8-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
