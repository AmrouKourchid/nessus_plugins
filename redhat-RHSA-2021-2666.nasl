...
referenced in the RHSA-2021:2666 advisory.
    ...
    * [Azure][RHEL8.4] Two Patches Needed To Enable Azure Host Time-syncing in VMs (BZ#1963052)

Tenable has extracted the preceding description block directly from the Red Hat Enterprise Linux security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_2666.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?43642a62");
...
"Update the RHEL kernel package based on the guidance in RHSA-2021:2666.");
