...
# extracted from Red Hat Security Advisory numpy. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2019-6446", "CVE-2021-34141");

  script_name(english:"RHEL 8 : numpy (Unpatched Vulnerability) (deprecated)");
