...
# extracted from Fedora Security Advisory FEDORA-2019-00d5e55259.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-00d5e55259");

  script_name(english:"Fedora 30 : chromium (2019-00d5e55259)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-00d5e55259");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"chromium-78.0.3904.108-1.fc30", allowmaj:TRUE)) flag++;
