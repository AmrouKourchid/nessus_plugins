...
# extracted from VMware Security Advisory PHSA-2021-4.0-0079. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2021-3672", "CVE-2023-31124", "CVE-2023-31130");

  script_name(english:"Photon OS 4.0: C PHSA-2021-4.0-0079");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the c package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-79.md");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2023-31130");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'c-ares-1.17.1-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'c-ares-devel-1.17.1-1.ph4')) flag++;
