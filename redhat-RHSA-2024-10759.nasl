...
# extracted from Red Hat Security Advisory RHSA-2024:10759. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2022-3064");
  script_xref(name:"RHSA", value:"2024:10759");

  script_name(english:"RHEL 9 : rhc (RHSA-2024:10759)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_10759.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?31a447c4");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:10759");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rhc package based on the guidance in RHSA-2024:10759.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rhc-0.2.5-1.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'rhc-devel-0.2.5-1.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
