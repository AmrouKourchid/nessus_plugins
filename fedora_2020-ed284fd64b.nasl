...
# extracted from Fedora Security Advisory FEDORA-2020-ed284fd64b.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : LibRaw (2020-ed284fd64b)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-ed284fd64b");
...
flag = 0;
if (rpm_check(release:"FC32", reference:"LibRaw-0.19.5-4.fc32")) flag++;
