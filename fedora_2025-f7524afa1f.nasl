...
# extracted from Fedora Security Advisory FEDORA-2025-f7524afa1f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-f7524afa1f");

  script_name(english:"Fedora 41 : buildah (2025-f7524afa1f)");
...
FEDORA-2025-f7524afa1f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-f7524afa1f");
  script_set_attribute(attribute:"solution", value:
"Update the affected 2:buildah package.");
...
var pkgs = [
    {'reference':'buildah-1.39.2-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
