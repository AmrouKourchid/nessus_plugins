...
# extracted from Ubuntu Security Notice USN-3633-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS : Linux kernel (Intel Euclid) vulnerability (USN-3633-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3633-1");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-16995");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.4.0-9026-euclid");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-3633-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2017-16995');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-3633-1');
  }
  else
  {
