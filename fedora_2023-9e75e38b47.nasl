...
# extracted from Fedora Security Advisory FEDORA-2023-9e75e38b47
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-9e75e38b47");

  script_name(english:"Fedora 38 : webkitgtk (2023-9e75e38b47)");
...
FEDORA-2023-9e75e38b47 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-9e75e38b47");
...
var pkgs = [
    {'reference':'webkitgtk-2.40.2-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
