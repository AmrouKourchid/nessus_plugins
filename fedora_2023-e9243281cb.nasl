...
# extracted from Fedora Security Advisory FEDORA-2023-e9243281cb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-e9243281cb");

  script_name(english:"Fedora 37 : rust-askama / rust-askama_shared / rust-comrak (2023-e9243281cb)");
...
FEDORA-2023-e9243281cb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-e9243281cb");
...
var pkgs = [
    {'reference':'rust-askama-0.11.1-4.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-askama_shared-0.12.2-4.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-comrak-0.18.0-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
