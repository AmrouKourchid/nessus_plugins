...
# extracted from Fedora Security Advisory FEDORA-2023-f5d075f7f2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-f5d075f7f2");

  script_name(english:"Fedora 37 : tkimg (2023-f5d075f7f2)");
...
FEDORA-2023-f5d075f7f2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-f5d075f7f2");
...
"Update the affected tkimg package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:tkimg");
...
var pkgs = [
    {'reference':'tkimg-1.4.14-3.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'tkimg');
}
