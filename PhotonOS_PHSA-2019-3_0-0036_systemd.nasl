...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Systemd PHSA-2019-3.0-0036");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'systemd-239-14.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'systemd-debuginfo-239-14.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'systemd-devel-239-14.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'systemd-lang-239-14.ph3')) flag++;
