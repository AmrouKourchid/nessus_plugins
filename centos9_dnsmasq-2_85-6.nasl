...
if (description)
{
  ...
  script_name(english:"CentOS 9 : dnsmasq-2.85-6.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update for dnsmasq.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 9 host has packages installed that are affected by a vulnerability as referenced in the
dnsmasq-2.85-6.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=29823");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream dnsmasq package.");
...
var pkgs = [
    {'reference':'dnsmasq-2.85-6.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'dnsmasq-utils-2.85-6.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
