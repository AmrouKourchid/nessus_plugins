...
if (description)
{
  ...
  script_cve_id("CVE-2022-3570");

  script_name(english:"Photon OS 4.0: Libtiff PHSA-2022-4.0-0270");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-3570");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libtiff-4.4.0-6.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libtiff-devel-4.4.0-6.ph4')) flag++;
