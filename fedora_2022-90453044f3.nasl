...
# extracted from Fedora Security Advisory FEDORA-2022-90453044f3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-90453044f3");

  script_name(english:"Fedora 37 : libmodsecurity (2022-90453044f3)");
...
FEDORA-2022-90453044f3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-90453044f3");
...
var pkgs = [
    {'reference':'libmodsecurity-3.0.8-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
