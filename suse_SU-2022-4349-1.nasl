...
# SUSE update advisory SUSE-SU-2022:4349-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:4349-1");

  script_name(english:"SUSE SLES15 Security Update : buildah (SUSE-SU-2022:4349-1)");
...
referenced in the SUSE-SU-2022:4349-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-December/013200.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6b2a5570");
...
var pkgs = [
    {'reference':'buildah-1.28.2-150400.3.11.1', 'sp':'4', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.4']},
    {'reference':'buildah-1.28.2-150400.3.11.1', 'sp':'4', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.4', 'sle-module-containers-release-15.4', 'sles-release-15.4']}
];
