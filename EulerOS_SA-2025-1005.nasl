...
if (description)
{
  ...
  script_cve_id("CVE-2024-34155");

  script_name(english:"EulerOS 2.0 SP10 : golang (EulerOS-SA-2025-1005)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1005
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8ae24586");
...
"Update the affected golang packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-34155");
...
var pkgs = [
  "golang-1.15.7-15.h26.r9.eulerosv2r10",
  "golang-devel-1.15.7-15.h26.r9.eulerosv2r10",
  "golang-help-1.15.7-15.h26.r9.eulerosv2r10"
];
