...
# extracted from Red Hat Security Advisory RHSA-2025:3773. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 9 : delve and golang (RHSA-2025:3773)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for delve / golang.");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_3773.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?60db4892");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:3773");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL delve / golang packages based on the guidance in RHSA-2025:3773.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'delve-1.24.1-2.el9_5', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'delve-1.24.1-2.el9_5', 'cpu':'ppc64le', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'delve-1.24.1-2.el9_5', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'go-toolset-1.23.6-2.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-1.23.6-2.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-bin-1.23.6-2.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-docs-1.23.6-2.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-misc-1.23.6-2.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-race-1.23.6-2.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-src-1.23.6-2.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-tests-1.23.6-2.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
