...
# extracted from Fedora Security Advisory FEDORA-2020-f34d97b1fd.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : 1:xpdf (2020-f34d97b1fd)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-f34d97b1fd");
...
"Update the affected 1:xpdf package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-12360");
...
flag = 0;
if (rpm_check(release:"FC32", reference:"xpdf-4.02-4.fc32", epoch:"1")) flag++;
