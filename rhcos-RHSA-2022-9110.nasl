...
if (description)
{
  ...
  script_name(english:"RHCOS 4 : OpenShift Container Platform 4.9.54 (RHSA-2022:9110)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat CoreOS host is missing a security update for OpenShift Container Platform 4.9.54.");
...
referenced in the RHSA-2022:9110 advisory.
...
"Update the RHCOS OpenShift Container Platform 4.9.54 packages based on the guidance in RHSA-2022:9110.");
...
os_ver = os_ver[1];
if (!rhel_check_release(operator: 'eq', os_version: os_ver, rhel_version: '4.9')) audit(AUDIT_OS_NOT, 'Red Hat CoreOS 4.9', 'Red Hat CoreOS ' + os_ver);
...
var pkgs = [
    {'reference':'jenkins-2-plugins-4.9.1669894222-1.el8', 'release':'4', 'el_string':'el8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
];
