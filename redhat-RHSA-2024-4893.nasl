...
# extracted from Red Hat Security Advisory RHSA-2024:4893. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:4893");

  script_name(english:"RHEL 7 : rhc-worker-script (RHSA-2024:4893)");
...
referenced in the RHSA-2024:4893 advisory.

    The rhc-worker-script package provides a worker for the Remote Host Configuration (rhc) for the purpose of
    executing an interpreted programming language script on hosts managed by Red Hat Insights.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_4893.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a37a5984");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:4893");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rhc-worker-script package based on the guidance in RHSA-2024:4893.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rhc-worker-script-0.9-5.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
