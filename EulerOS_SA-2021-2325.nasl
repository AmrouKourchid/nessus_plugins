...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : curl (EulerOS-SA-2021-2325)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2325
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8ec39581");
...
pkgs = ["curl-7.29.0-46.h20.eulerosv2r7",
        "libcurl-7.29.0-46.h20.eulerosv2r7",
        "libcurl-devel-7.29.0-46.h20.eulerosv2r7"];
