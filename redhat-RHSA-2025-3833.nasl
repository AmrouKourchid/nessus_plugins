...
# extracted from Red Hat Security Advisory RHSA-2025:3833. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:3833");

  script_name(english:"RHEL 9 : gvisor-tap-vsock (RHSA-2025:3833)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5b19aa27");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:3833");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL gvisor-tap-vsock package based on the guidance in RHSA-2025:3833.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gvisor-tap-vsock-0.8.5-1.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'6'}
    ]
  }
];
