...
# extracted from Oracle Linux Security Advisory ELSA-2024-9541.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : expat (ELSA-2024-9541)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-9541.html");
...
var pkgs = [
    {'reference':'expat-2.5.0-3.el9_5.1', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'expat-devel-2.5.0-3.el9_5.1', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'expat-2.5.0-3.el9_5.1', 'cpu':'i686', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'expat-devel-2.5.0-3.el9_5.1', 'cpu':'i686', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'expat-2.5.0-3.el9_5.1', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'expat-devel-2.5.0-3.el9_5.1', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
