...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.1 : ntp (EulerOS-SA-2023-2734)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the ntp packages installed, the EulerOS Virtualization installation on the remote host is
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2734
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?702194e3");
...
"Update the affected ntp packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:ntp-help");
...
var pkgs = [
  "ntp-4.2.8p15-5.h5.eulerosv2r11",
  "ntp-help-4.2.8p15-5.h5.eulerosv2r11"
];
