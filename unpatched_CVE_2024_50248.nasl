...
if (description)
{
  ...
  script_cve_id("CVE-2024-50248");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-50248");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: ntfs3: Add bounds checking to
    mi_enum_attr() Added bounds checking to make sure that every attr don't stray beyond valid memory region.
    (CVE-2024-50248)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-50248");
