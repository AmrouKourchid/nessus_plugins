...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS / 22.04 LTS : Thunderbird vulnerabilities (USN-5435-1)");
...
vulnerabilities as referenced in the USN-5435-1 advisory.
    ...
    service, bypass permission prompts, obtain sensitive information, bypass security restrictions, cause user
    confusion, or execute arbitrary code. (CVE-2022-29909, CVE-2022-29911, CVE-2022-29912, CVE-2022-29913,
    CVE-2022-29914, CVE-2022-29916, CVE-2022-29917)

    It was discovered that Thunderbird would show the wrong security status after viewing an attached message
    that is signed or encrypted. An attacker could potentially exploit this by tricking the user into trusting
    the authenticity of a message. (CVE-2022-1520)
    ...
    crafted website in a browsing context, an attacker could exploit this to execute JavaScript in a
    privileged context. (CVE-2022-1529, CVE-2022-1802)
