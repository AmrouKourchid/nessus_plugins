...
# extracted from Debian Security Advisory DSA-4672. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"4672");

  script_name(english:"Debian DSA-4672-1 : trafficserver - security update");
...
service or request smuggling attacks.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2020/dsa-4672");
  script_set_attribute(attribute:"solution", value:
"Upgrade the trafficserver packages.

For the stable distribution (buster), these problems have been fixed
in version 8.0.2+ds-1+deb10u2.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-1944");
...
flag = 0;
if (deb_check(release:"10.0", prefix:"trafficserver", reference:"8.0.2+ds-1+deb10u2")) flag++;
if (deb_check(release:"10.0", prefix:"trafficserver-dev", reference:"8.0.2+ds-1+deb10u2")) flag++;
if (deb_check(release:"10.0", prefix:"trafficserver-experimental-plugins", reference:"8.0.2+ds-1+deb10u2")) flag++;
