...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.0 : libxml2 (EulerOS-SA-2024-2122)");
...
is affected by the following vulnerabilities :
    ...
    untrusted input is received (also remotely) and processed via iterwalk function, a crash can be
    triggered.(CVE-2022-2309)
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2122
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4078380c");
...
var pkgs = [
  "libxml2-2.9.10-11.h28.eulerosv2r10",
  "python3-libxml2-2.9.10-11.h28.eulerosv2r10"
];
