...
# extracted from Red Hat Security Advisory nagios. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2016-6209", "CVE-2016-8641");

  script_name(english:"RHEL 7 : nagios (Unpatched Vulnerability) (deprecated)");
