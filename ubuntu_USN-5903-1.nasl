...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS / 22.04 LTS : lighttpd vulnerabilities (USN-5903-1)");
...
referenced in the USN-5903-1 advisory.
    ...
    It was discovered that lighttpd incorrectly handled certain inputs, which could result in a stack buffer
