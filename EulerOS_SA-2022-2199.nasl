...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.0 : httpd (EulerOS-SA-2022-2199)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2199
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5435a44d");
...
var pkgs = [
  "httpd-2.4.34-24.h13.eulerosv2r9",
  "httpd-filesystem-2.4.34-24.h13.eulerosv2r9",
  "httpd-tools-2.4.34-24.h13.eulerosv2r9",
  "mod_ssl-2.4.34-24.h13.eulerosv2r9"
];
