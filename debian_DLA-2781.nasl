...
# extracted from Debian Security Advisory dla-2781. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2781-1 : neutron - LTS security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 9 host has packages installed that are affected by a vulnerability as referenced in the dla-2781
advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2021/dla-2781");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2021-40085");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/stretch/neutron");
...
For Debian 9 Stretch, these problems have been fixed in version 2");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:neutron-plugin-linuxbridge-agent");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:neutron-plugin-nec-agent");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:neutron-plugin-openvswitch-agent");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:python-neutron");
...
var pkgs = [
    {'release': '9.0', 'prefix': 'neutron-common', 'reference': '2:9.1.1-3+deb9u2'},
    {'release': '9.0', 'prefix': 'neutron-dhcp-agent', 'reference': '2:9.1.1-3+deb9u2'},
    {'release': '9.0', 'prefix': 'neutron-l3-agent', 'reference': '2:9.1.1-3+deb9u2'},
    {'release': '9.0', 'prefix': 'neutron-linuxbridge-agent', 'reference': '2:9.1.1-3+deb9u2'},
    {'release': '9.0', 'prefix': 'neutron-macvtap-agent', 'reference': '2:9.1.1-3+deb9u2'},
    {'release': '9.0', 'prefix': 'neutron-metadata-agent', 'reference': '2:9.1.1-3+deb9u2'},
    {'release': '9.0', 'prefix': 'neutron-metering-agent', 'reference': '2:9.1.1-3+deb9u2'},
    {'release': '9.0', 'prefix': 'neutron-openvswitch-agent', 'reference': '2:9.1.1-3+deb9u2'},
    {'release': '9.0', 'prefix': 'neutron-plugin-linuxbridge-agent', 'reference': '2:9.1.1-3+deb9u2'},
    {'release': '9.0', 'prefix': 'neutron-plugin-nec-agent', 'reference': '2:9.1.1-3+deb9u2'},
    {'release': '9.0', 'prefix': 'neutron-plugin-openvswitch-agent', 'reference': '2:9.1.1-3+deb9u2'},
    {'release': '9.0', 'prefix': 'neutron-server', 'reference': '2:9.1.1-3+deb9u2'},
    {'release': '9.0', 'prefix': 'neutron-sriov-agent', 'reference': '2:9.1.1-3+deb9u2'},
    {'release': '9.0', 'prefix': 'python-neutron', 'reference': '2:9.1.1-3+deb9u2'}
];
