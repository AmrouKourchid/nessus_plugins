...
# extracted from Debian Security Advisory DLA-1991-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1991-1 : libssh2 security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2019/11/msg00010.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/jessie/libssh2");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"libssh2-1", reference:"1.4.3-4.1+deb8u6")) flag++;
if (deb_check(release:"8.0", prefix:"libssh2-1-dbg", reference:"1.4.3-4.1+deb8u6")) flag++;
if (deb_check(release:"8.0", prefix:"libssh2-1-dev", reference:"1.4.3-4.1+deb8u6")) flag++;
