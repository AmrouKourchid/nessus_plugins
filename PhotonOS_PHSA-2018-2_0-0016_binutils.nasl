...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-14930");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2017-17123");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'binutils-2.30-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'binutils-debuginfo-2.30-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'binutils-devel-2.30-1.ph2')) flag++;
