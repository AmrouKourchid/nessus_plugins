...
if (description)
{
  ...
  script_name(english:"Foxit PDF Editor < 12.1.7 Vulnerability");
...
Windows host is prior to 12.1.7. It is, therefore affected by vulnerability:
...
"Upgrade to Foxit PDF Editor version 12.1.7 or later");
...
var constraints = [
  { 'max_version' : '11.2.9.53938', 'fixed_version' : '12.1.7' },
  { 'min_version' : '12.0', 'max_version' : '12.1.6.15509', 'fixed_version' : '12.1.7' }
];
