...
# extracted from Red Hat Security Advisory RHSA-2022:8853. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:8853");

  script_name(english:"RHEL 8 : Red Hat OpenStack Platform 16.2.4 (python-django20) (RHSA-2022:8853)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for Red Hat OpenStack Platform 16.2.4 (python-django20).");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has a package installed that is affected by multiple vulnerabilities as
referenced in the RHSA-2022:8853 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8853.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?592b6cfa");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8853");
...
"Update the RHEL Red Hat OpenStack Platform 16.2.4 (python-django20) package based on the guidance in RHSA-2022:8853.");
