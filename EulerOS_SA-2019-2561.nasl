...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : cairo (EulerOS-SA-2019-2561)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2561
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?84848101");
...
pkgs = ["cairo-1.14.2-1.h4",
        "cairo-devel-1.14.2-1.h4",
        "cairo-gobject-1.14.2-1.h4",
        "cairo-gobject-devel-1.14.2-1.h4"];
