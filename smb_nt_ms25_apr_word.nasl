...
if (description)
{
  ...
  script_cve_id("CVE-2025-27747", "CVE-2025-29816", "CVE-2025-29820");
  script_xref(name:"MSKB", value:"5002702");
  script_xref(name:"MSFT", value:"MS25-5002702");
  script_xref(name:"IAVA", value:"2025-A-0244");

  script_name(english:"Security Updates for Microsoft Word Products (April 2025)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002702");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released KB5002702 to address this issue.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:C/I:C/A:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:N/UI:R/S:U/C:H/I:H/A:H");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-27747");
...
var constraints = [
  { 'kb':'5002702', 'channel':'MSI', 'fixed_version': '16.0.5495.1002', 'sp' : 0}
];
