...
# extracted from Mozilla Foundation Security Advisory mfsa2024-02.
...
if (description)
{
  ...
  script_name(english:"Mozilla Firefox ESR < 115.7");

  script_set_attribute(attribute:"synopsis", value:
"A web browser installed on the remote macOS or Mac OS X host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Firefox ESR installed on the remote macOS or Mac OS X host is prior to 115.7. It is, therefore, affected
by multiple vulnerabilities as referenced in the mfsa2024-02 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2024-02/");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Mozilla Firefox ESR version 115.7 or later.");
...
mozilla_check_version(version:version, path:path, product:'firefox', esr:TRUE, fix:'115.7', min:'115.0.0', severity:SECURITY_HOLE);
