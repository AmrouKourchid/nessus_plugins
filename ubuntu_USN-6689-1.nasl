...
# extracted from Ubuntu Security Notice USN-6689-1. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2023-27539", "CVE-2024-26141", "CVE-2024-26146");
  script_xref(name:"USN", value:"6689-1");

  script_name(english:"Ubuntu 23.10 : Rack vulnerabilities (USN-6689-1)");
...
USN-6689-1 advisory.
    ...
    It was discovered that Rack incorrectly parse some headers. An attacker could possibly use this issue to
    cause a denial of service. (CVE-2023-27539, CVE-2024-26141, CVE-2024-26146)

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6689-1");
...
var pkgs = [
    {'osver': '23.10', 'pkgname': 'ruby-rack', 'pkgver': '2.2.4-3ubuntu0.1'}
];
