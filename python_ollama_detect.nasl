...
if (description)
{
  ...
  script_name(english:"Ollama Detection");

  script_set_attribute(attribute:"synopsis", value:
"An Ollama Python library is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"An Ollama Python library is installed on the remote host. 

Note that Nessus has relied upon on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/ollama/ollama-python");
