...
# extracted from Gentoo Linux Security Advisory GLSA 202405-17.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202405-17 : glibc: Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202405-17 (glibc: Multiple Vulnerabilities)
  ...
  -  Please review the referenced CVE identifiers for details.  (CVE-2024-33599, CVE-2024-33600,
    CVE-2024-33601, CVE-2024-33602)

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202405-17");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=930177");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=930667");
...
var packages = [
  {
    'name' : 'sys-libs/glibc',
    'unaffected' : make_list("ge 2.38-r13"),
    'vulnerable' : make_list("lt 2.38-r13")
  }
];
