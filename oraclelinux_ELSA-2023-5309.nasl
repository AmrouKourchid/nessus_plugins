...
# extracted from Oracle Linux Security Advisory ELSA-2023-5309.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : libwebp (ELSA-2023-5309)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
ELSA-2023-5309 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-5309.html");
...
var pkgs = [
    ...
    {'reference':'libwebp-1.0.0-8.el8_8.1', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libwebp-devel-1.0.0-8.el8_8.1', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libwebp-1.0.0-8.el8_8.1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libwebp-devel-1.0.0-8.el8_8.1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
