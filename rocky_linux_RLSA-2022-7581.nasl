...
# Rocky Linux Security Advisory RLSA-2022:7581.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2022:7581");

  script_name(english:"Rocky Linux 8 : python38:3.8 and python38-devel:3.8 (RLSA-2022:7581)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Rocky Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Rocky Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
RLSA-2022:7581 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2022:7581");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2075390");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2086141");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2090006");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2095265");
...
var appstreams = {
    'python38-devel:3.8': [
      ...
      {'reference':'python38-3.8.13-1.module+el8.7.0+1063+20f2b9a4', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-3.8.13-1.module+el8.7.0+1063+20f2b9a4', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python38-debug-3.8.13-1.module+el8.7.0+1063+20f2b9a4', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-debug-3.8.13-1.module+el8.7.0+1063+20f2b9a4', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-debuginfo-3.8.13-1.module+el8.7.0+1063+20f2b9a4', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-debuginfo-3.8.13-1.module+el8.7.0+1063+20f2b9a4', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-debugsource-3.8.13-1.module+el8.7.0+1063+20f2b9a4', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-debugsource-3.8.13-1.module+el8.7.0+1063+20f2b9a4', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-devel-3.8.13-1.module+el8.7.0+1063+20f2b9a4', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-devel-3.8.13-1.module+el8.7.0+1063+20f2b9a4', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-idle-3.8.13-1.module+el8.7.0+1063+20f2b9a4', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-idle-3.8.13-1.module+el8.7.0+1063+20f2b9a4', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python38-libs-3.8.13-1.module+el8.7.0+1063+20f2b9a4', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-libs-3.8.13-1.module+el8.7.0+1063+20f2b9a4', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python38-rpm-macros-3.8.13-1.module+el8.7.0+1063+20f2b9a4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python38-test-3.8.13-1.module+el8.7.0+1063+20f2b9a4', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-test-3.8.13-1.module+el8.7.0+1063+20f2b9a4', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-tkinter-3.8.13-1.module+el8.7.0+1063+20f2b9a4', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-tkinter-3.8.13-1.module+el8.7.0+1063+20f2b9a4', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
