...
# extracted from Fedora Security Advisory FEDORA-2024-8401d42de6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-8401d42de6");
  script_xref(name:"IAVA", value:"2024-A-0243");

  script_name(english:"Fedora 39 : filezilla / libfilezilla (2024-8401d42de6)");
...
FEDORA-2024-8401d42de6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-8401d42de6");
...
var pkgs = [
    {'reference':'filezilla-3.67.0-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libfilezilla-0.47.0-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
