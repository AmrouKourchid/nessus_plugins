...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : mariadb-connector-c (EulerOS-SA-2022-2691)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the mariadb-connector-c package installed, the EulerOS installation on the remote host is
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2691
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f1c725ca");
