...
# extracted from Fedora Security Advisory FEDORA-2023-0733306be9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-0733306be9");

  script_name(english:"Fedora 39 : libssh (2023-0733306be9)");
...
FEDORA-2023-0733306be9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-0733306be9");
...
var pkgs = [
    {'reference':'libssh-0.10.6-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
