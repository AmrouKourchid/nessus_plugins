...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.3 : ghostscript (EulerOS-SA-2019-1241)");
...
the following vulnerabilities :
  ...
  - It was discovered that the ghostscript PDF14 compositor
    ...
    specially crafted PostScript
    document.i1/4^CVE-2018-16540i1/4%0

  - It was discovered that the ghostscript gssetresolution
    and gsgetresolution procedures were available, although
    they have dangerous side effects. An attacker could
    ...
    PostScript document.i1/4^CVE-2018-16543i1/4%0

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1241
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b70576f6");
...
"Update the affected ghostscript packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-16543");
