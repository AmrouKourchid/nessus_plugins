...
# extracted from Fedora Security Advisory FEDORA-2023-df375d0634
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-df375d0634");

  script_name(english:"Fedora 38 : open-vm-tools (2023-df375d0634)");
...
FEDORA-2023-df375d0634 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-df375d0634");
...
var pkgs = [
    {'reference':'open-vm-tools-12.3.0-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
