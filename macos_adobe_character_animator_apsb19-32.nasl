...
if (description)
{
  ...
  script_name(english:"Adobe Character Animator 2.0.0 < 2.1.1 Arbitrary code execution (APSB19-32) (macOS)");
...
"The version of Adobe Character Animator installed on the remote macOS host is prior to 2.1.1. It is, therefore, affected
by a vulnerability as referenced in the APSB19-32 advisory.
