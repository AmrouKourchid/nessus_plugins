...
the USN-5433-1 advisory.
    ...
    It was discovered that Vim incorrectly handled parsing of filenames in its search functionality. If a user
    were tricked into opening a specially crafted file, an attacker could crash the application, leading to a
    denial of service. (CVE-2021-3973)

    It was discovered that Vim incorrectly handled memory when opening and searching the contents of certain
    files. If a user were tricked into opening a specially crafted file, an attacker could crash the
    application, leading to a denial of service, or possibly achieve code execution with user privileges.
    (CVE-2021-3974)

    It was discovered that Vim incorrectly handled memory when opening and editing certain files. If a user
    were tricked into opening a specially crafted file, an attacker could crash the application, leading to a
    denial of service, or possibly achieve code execution with user privileges. (CVE-2021-3984, CVE-2021-4019,
    CVE-2021-4069)
    ...
    possibly achieve code execution with user privileges. (CVE-2022-0261, CVE-2022-0318)

    It was discovered that Vim was using freed memory when dealing with regular expressions through its old
    regular expression engine. If a user were tricked into opening a specially crafted file, an attacker could
    crash the application, leading to a denial of service, or possibly achieve code execution with user
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'vim', 'pkgver': '2:7.4.1689-3ubuntu1.5+esm4', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'vim-athena', 'pkgver': '2:7.4.1689-3ubuntu1.5+esm4', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'vim-athena-py2', 'pkgver': '2:7.4.1689-3ubuntu1.5+esm4', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'vim-common', 'pkgver': '2:7.4.1689-3ubuntu1.5+esm4', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'vim-gnome', 'pkgver': '2:7.4.1689-3ubuntu1.5+esm4', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'vim-gnome-py2', 'pkgver': '2:7.4.1689-3ubuntu1.5+esm4', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'vim-gtk', 'pkgver': '2:7.4.1689-3ubuntu1.5+esm4', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'vim-gtk-py2', 'pkgver': '2:7.4.1689-3ubuntu1.5+esm4', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'vim-gtk3', 'pkgver': '2:7.4.1689-3ubuntu1.5+esm4', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'vim-gtk3-py2', 'pkgver': '2:7.4.1689-3ubuntu1.5+esm4', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'vim-gui-common', 'pkgver': '2:7.4.1689-3ubuntu1.5+esm4', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'vim-nox', 'pkgver': '2:7.4.1689-3ubuntu1.5+esm4', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'vim-nox-py2', 'pkgver': '2:7.4.1689-3ubuntu1.5+esm4', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'vim-runtime', 'pkgver': '2:7.4.1689-3ubuntu1.5+esm4', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'vim-tiny', 'pkgver': '2:7.4.1689-3ubuntu1.5+esm4', 'ubuntu_pro': TRUE}
];
