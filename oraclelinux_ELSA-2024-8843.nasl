...
# extracted from Oracle Linux Security Advisory ELSA-2024-8843.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : python3.11-urllib3 (ELSA-2024-8843)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-8843.html");
...
var pkgs = [
    {'reference':'python3.11-urllib3-1.26.12-4.el8_10', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
