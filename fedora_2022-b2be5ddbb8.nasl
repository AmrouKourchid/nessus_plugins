...
# extracted from Fedora Security Advisory FEDORA-2022-b2be5ddbb8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-b2be5ddbb8");

  script_name(english:"Fedora 37 : cacti / cacti-spine (2022-b2be5ddbb8)");
...
FEDORA-2022-b2be5ddbb8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-b2be5ddbb8");
...
var pkgs = [
    {'reference':'cacti-1.2.22-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cacti-spine-1.2.22-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
