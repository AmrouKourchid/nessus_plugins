...
# extracted from Fedora Security Advisory FEDORA-2024-ee43b83290
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-ee43b83290");

  script_name(english:"Fedora 39 : webkitgtk (2024-ee43b83290)");
...
FEDORA-2024-ee43b83290 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-ee43b83290");
...
var pkgs = [
    {'reference':'webkitgtk-2.44.0-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
