...
# extracted from SUSE update advisory SUSE-SU-2021:0436-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLED15 / SLES15 Security Update : openvswitch (SUSE-SU-2021:0436-1)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c654fcc4");
...
zypper in -t patch
SUSE-SLE-Module-Server-Applications-15-SP2-2021-436=1

SUSE Linux Enterprise Module for Packagehub Subpackages 15-SP2 :

zypper in -t patch
SUSE-SLE-Module-Packagehub-Subpackages-15-SP2-2021-436=1");
...
flag = 0;
if (rpm_check(release:"SLES15", sp:"2", reference:"libopenvswitch-2_13-0-2.13.2-9.14.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"libopenvswitch-2_13-0-debuginfo-2.13.2-9.14.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"libovn-20_03-0-20.03.1-9.14.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"libovn-20_03-0-debuginfo-20.03.1-9.14.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"openvswitch-2.13.2-9.14.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"openvswitch-debuginfo-2.13.2-9.14.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"openvswitch-debugsource-2.13.2-9.14.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"openvswitch-devel-2.13.2-9.14.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"openvswitch-ipsec-2.13.2-9.14.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"openvswitch-pki-2.13.2-9.14.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"openvswitch-test-2.13.2-9.14.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"openvswitch-test-debuginfo-2.13.2-9.14.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"openvswitch-vtep-2.13.2-9.14.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"openvswitch-vtep-debuginfo-2.13.2-9.14.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"ovn-20.03.1-9.14.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"ovn-central-20.03.1-9.14.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"ovn-devel-20.03.1-9.14.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"ovn-docker-20.03.1-9.14.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"ovn-host-20.03.1-9.14.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"ovn-vtep-20.03.1-9.14.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"python3-ovs-2.13.2-9.14.1")) flag++;
if (rpm_check(release:"SLED15", sp:"2", reference:"libopenvswitch-2_13-0-2.13.2-9.14.1")) flag++;
if (rpm_check(release:"SLED15", sp:"2", reference:"libopenvswitch-2_13-0-debuginfo-2.13.2-9.14.1")) flag++;
if (rpm_check(release:"SLED15", sp:"2", reference:"openvswitch-debuginfo-2.13.2-9.14.1")) flag++;
if (rpm_check(release:"SLED15", sp:"2", reference:"openvswitch-debugsource-2.13.2-9.14.1")) flag++;
if (rpm_check(release:"SLED15", sp:"2", reference:"python3-ovs-2.13.2-9.14.1")) flag++;
