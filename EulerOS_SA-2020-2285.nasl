...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : java-1.8.0-openjdk (EulerOS-SA-2020-2285)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2285
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?41353c37");
...
"Update the affected java-1.8.0-openjdk package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-14581");
...
pkgs = ["java-1.8.0-openjdk-1.8.0.191.b12-0.h14.eulerosv2r7",
        "java-1.8.0-openjdk-devel-1.8.0.191.b12-0.h14.eulerosv2r7",
        "java-1.8.0-openjdk-headless-1.8.0.191.b12-0.h14.eulerosv2r7"];
