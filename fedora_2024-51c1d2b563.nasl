...
# extracted from Fedora Security Advisory FEDORA-2024-51c1d2b563
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-51c1d2b563");

  script_name(english:"Fedora 40 : libnbd (2024-51c1d2b563)");
...
FEDORA-2024-51c1d2b563 advisory.

    New stable branch version 1.20.2

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-51c1d2b563");
...
var pkgs = [
    {'reference':'libnbd-1.20.2-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
