...
# extracted from Amazon Linux 2 Security Advisory ALASNITRO-ENCLAVES-2023-025.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : runc (ALASNITRO-ENCLAVES-2023-025)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of runc installed on the remote host is prior to 1.1.7-2. It is, therefore, affected by a vulnerability as
referenced in the ALAS2NITRO-ENCLAVES-2023-025 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALASNITRO-ENCLAVES-2023-025.html");
...
var pkgs = [
    {'reference':'runc-1.1.7-2.amzn2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'runc-1.1.7-2.amzn2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'runc-debuginfo-1.1.7-2.amzn2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'runc-debuginfo-1.1.7-2.amzn2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
