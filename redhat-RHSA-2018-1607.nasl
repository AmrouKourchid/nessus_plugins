...
if (description)
{
  ...
  script_name(english:"RHEL 6 : Red Hat JBoss Enterprise Application Platform 5.2 (RHSA-2018:1607)");
...
the RHSA-2018:1607 advisory.

    Red Hat JBoss Enterprise Application Platform is a platform for Java applications based on the JBoss
    Application Server.

    This asynchronous patch is a security update for JBoss invoker in Red Hat JBoss Enterprise Application
    Platform 5.2.0.

    Security Fix(es):

    * jbossas: Arbitrary code execution via unrestricted deserialization in ReadOnlyAccessFilter of HTTP
    Invoker. (CVE-2017-12149)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2018/rhsa-2018_1607.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a3ff4d8a");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1486220");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat JBoss Enterprise Application Platform 5.2 package based on the guidance in RHSA-2018:1607.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jbossas-5.2.0-24.ep5.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap5'},
      {'reference':'jbossas-client-5.2.0-24.ep5.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap5'},
      {'reference':'jbossas-messaging-5.2.0-24.ep5.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap5'},
      {'reference':'jbossas-ws-native-5.2.0-24.ep5.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap5'}
    ]
  }
];
