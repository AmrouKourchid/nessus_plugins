...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP12 : docker-runc (EulerOS-SA-2024-2501)");
...
by the following vulnerabilities :
    ...
    user who can create a pod with an arbitrary annotation may perform an arbitrary action on the host
    system.(CVE-2024-3154)
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2501
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?41e93db2");
...
var pkgs = [
  "docker-runc-1.1.3-9.h27.eulerosv2r12"
];
