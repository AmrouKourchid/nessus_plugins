...
# extracted from Red Hat Security Advisory RHSA-2017:2596. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2017:2596");

  script_name(english:"RHEL 6 / 7 : rh-maven33-groovy (RHSA-2017:2596)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for rh-maven33-groovy.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 6 / 7 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2017:2596 advisory.

    Groovy is an agile and dynamic language for the Java Virtual Machine, built upon Java with features
    inspired by languages like Python, Ruby, and Smalltalk. It seamlessly integrates with all existing Java
    objects and libraries and compiles straight to Java bytecode so you can use it anywhere you can use Java.

    Security Fix(es):

    * Multiple object deserialization flaws were discovered in the MethodClosure class in Groovy. A specially
    crafted serialized object deserialized by an application using the Groovy library could cause the
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2017/rhsa-2017_2596.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2bbed2de");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1243934");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1413466");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2017:2596");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rh-maven33-groovy package based on the guidance in RHSA-2017:2596.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rh-maven33-groovy");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rh-maven33-groovy-javadoc");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-maven33-groovy-1.8.9-7.19.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-maven33-groovy-javadoc-1.8.9-7.19.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'rh-maven33-groovy-1.8.9-7.19.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-maven33-groovy-javadoc-1.8.9-7.19.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'rh-maven33-groovy / rh-maven33-groovy-javadoc');
}
