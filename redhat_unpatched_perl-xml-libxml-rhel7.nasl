...
# extracted from Red Hat Security Advisory perl-xml-libxml. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2015-3451", "CVE-2017-10672");

  script_name(english:"RHEL 7 : perl-xml-libxml (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:perl-xml-libxml");
