...
# extracted from Red Hat Security Advisory gstreamer-plugins. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 3 : gstreamer-plugins (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2011-2911");
