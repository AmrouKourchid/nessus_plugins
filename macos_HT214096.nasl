...
if (description)
{
  ...
  script_xref(name:"APPLE-SA", value:"HT214096");
  script_xref(name:"IAVA", value:"2024-A-0179-S");
  script_xref(name:"IAVA", value:"2024-A-0275-S");

  script_name(english:"macOS 14.x < 14.4.1 (HT214096)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host is missing a macOS update that fixes a vulnerability");
  script_set_attribute(attribute:"description", value:
"The remote host is running a version of macOS / Mac OS X that is 14.x prior to 14.4.1. It is, therefore, affected by a
vulnerability:
...
version number.");
  script_set_attribute(attribute:"see_also", value:"https://support.apple.com/en-us/HT214096");
  script_set_attribute(attribute:"solution", value:
"Upgrade to macOS 14.4.1 or later.");
...
var constraints = [
  { 'fixed_version' : '14.4.1', 'min_version' : '14.0', 'fixed_display' : 'macOS Sonoma 14.4.1' }
];
