...
# extracted from Ubuntu Security Notice USN-5359-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5359-2");

  script_name(english:"Ubuntu 16.04 ESM : rsync vulnerability (USN-5359-2)");
...
USN-5359-2 advisory.
    ...
    USN-5359-1 fixed vulnerabilities in rsync. This update provides the corresponding updates for Ubuntu 16.04
    ESM.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5359-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'rsync', 'pkgver': '3.1.1-3ubuntu1.3+esm1', 'ubuntu_pro': TRUE}
];
