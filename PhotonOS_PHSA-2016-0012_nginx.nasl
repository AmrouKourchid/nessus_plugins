...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'nginx-1.10.0-4.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'nginx-debuginfo-1.10.0-4.ph1')) flag++;
