...
# extracted from Red Hat Security Advisory RHSA-2025:3627. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:3627");

  script_name(english:"RHEL 9 : libxslt (RHSA-2025:3627)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for libxslt.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2025:3627 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_3627.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?00bf89fe");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:3627");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libxslt package based on the guidance in RHSA-2025:3627.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libxslt-1.1.34-11.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libxslt-devel-1.1.34-11.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
