...
# extracted from Fedora Security Advisory FEDORA-2020-f3fcb1608a.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : coturn (2020-f3fcb1608a)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-f3fcb1608a");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"coturn-4.5.1.1-3.fc30")) flag++;
