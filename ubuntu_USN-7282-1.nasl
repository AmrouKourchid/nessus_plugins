...
# extracted from Ubuntu Security Notice USN-7282-1. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2017-12616", "CVE-2017-12617");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2022/04/15");
  script_xref(name:"IAVA", value:"2018-A-0118-S");
  script_xref(name:"IAVB", value:"2017-B-0133-S");
  script_xref(name:"IAVB", value:"2017-B-0136-S");
  script_xref(name:"USN", value:"7282-1");
  script_xref(name:"CEA-ID", value:"CEA-2019-0240");

  script_name(english:"Ubuntu 16.04 LTS : tomcat7 vulnerabilities (USN-7282-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 16.04 LTS host has packages installed that are affected by multiple vulnerabilities as referenced in
the USN-7282-1 advisory.

    It was discovered that Tomcat incorrectly handled being configured with HTTP PUTs enabled. A remote
    attacker could use this issue to upload a JSP file to the server and execute arbitrary code.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7282-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libservlet3.0-java', 'pkgver': '7.0.68-1ubuntu0.4+esm3', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libtomcat7-java', 'pkgver': '7.0.68-1ubuntu0.4+esm3', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'tomcat7', 'pkgver': '7.0.68-1ubuntu0.4+esm3', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'tomcat7-admin', 'pkgver': '7.0.68-1ubuntu0.4+esm3', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'tomcat7-common', 'pkgver': '7.0.68-1ubuntu0.4+esm3', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'tomcat7-examples', 'pkgver': '7.0.68-1ubuntu0.4+esm3', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'tomcat7-user', 'pkgver': '7.0.68-1ubuntu0.4+esm3', 'ubuntu_pro': TRUE}
];
