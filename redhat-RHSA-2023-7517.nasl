...
# extracted from Red Hat Security Advisory RHSA-2023:7517. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2023-39321", "CVE-2023-39322");
  script_xref(name:"RHSA", value:"2023:7517");

  script_name(english:"RHEL 8 / 9 : Red Hat Ansible Automation Platform 2.4 Product Security and Bug Fix Update (Moderate) (RHSA-2023:7517)");
...
referenced in the RHSA-2023:7517 advisory.
    ...
    * receptor: golang: crypto/tls: panic when processing post-handshake message on QUIC connections
    (CVE-2023-39321)
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_7517.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f7bc4fa0");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:7517");
  script_set_attribute(attribute:"solution", value:
"Update the affected receptor package.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:N/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-39322");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'receptor-1.4.3-1.el8ap', 'release':'8', 'el_string':'el8ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.4'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'receptor-1.4.3-1.el9ap', 'release':'9', 'el_string':'el9ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.4'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'receptor');
}
