...
# SUSE update advisory SUSE-SU-2022:14890-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:14890-1");

  script_name(english:"SUSE SLES11 Security Update : tcpdump (SUSE-SU-2022:14890-1)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b9169da5");
...
var pkgs = [
    {'reference':'tcpdump-3.9.8-1.30.19.1', 'sp':'4', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.4']}
];
