...
# extracted from Fedora Security Advisory FEDORA-2024-a00de83de9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-a00de83de9");

  script_name(english:"Fedora 39 : nghttp2 (2024-a00de83de9)");
...
FEDORA-2024-a00de83de9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-a00de83de9");
...
var pkgs = [
    {'reference':'nghttp2-1.55.1-5.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
