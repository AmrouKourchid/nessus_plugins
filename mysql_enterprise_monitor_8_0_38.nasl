...
if (description)
{
  ...
  script_name(english:"Oracle MySQL Enterprise Monitor (Apr 2024 CPU)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host is affected by a vulnerability");
  script_set_attribute(attribute:"description", value:
"The versions of MySQL Enterprise Monitor installed on the remote host are affected by a vulnerability as referenced 
in the April 2024 CPU advisory. Vulnerability in the MySQL Enterprise Monitor product of Oracle MySQL (component: 
Monitoring: General (OpenSSL)). Supported versions that are affected are 8.0.37 and prior. Difficult to exploit 
vulnerability allows unauthenticated attacker with network access via multiple protocols to compromise MySQL Enterprise 
Monitor. Successful attacks of this vulnerability can result in unauthorized ability to cause a hang or frequently 
repeatable crash (complete DOS) of MySQL Enterprise Monitor as well as unauthorized update, insert or delete access to 
some of MySQL Enterprise Monitor accessible data.
...
var constraints = [
  { 'min_version' : '8.0', 'fixed_version' : '8.0.38' }
];
