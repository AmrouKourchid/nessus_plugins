...
# extracted from Red Hat Security Advisory mod_fcgid. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : mod_fcgid (Unpatched Vulnerability) (deprecated)");
...
"This plugin has been deprecated as it does not adhere to established standards for this style of check.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-1000104");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:mod_fcgid");
