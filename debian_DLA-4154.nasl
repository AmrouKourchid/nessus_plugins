...
# extracted from Debian Security Advisory dla-4154. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2023-52969", "CVE-2023-52970");

  script_name(english:"Debian dla-4154 : libmariadb-dev - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-52969");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-52970");
...
"Upgrade the libmariadb-dev packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-52970");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'libmariadb-dev', 'reference': '1:10.5.28-0+deb11u2'},
    {'release': '11.0', 'prefix': 'libmariadb-dev-compat', 'reference': '1:10.5.28-0+deb11u2'},
    {'release': '11.0', 'prefix': 'libmariadb3', 'reference': '1:10.5.28-0+deb11u2'},
    {'release': '11.0', 'prefix': 'libmariadbd-dev', 'reference': '1:10.5.28-0+deb11u2'},
    {'release': '11.0', 'prefix': 'libmariadbd19', 'reference': '1:10.5.28-0+deb11u2'},
    {'release': '11.0', 'prefix': 'mariadb-backup', 'reference': '1:10.5.28-0+deb11u2'},
    {'release': '11.0', 'prefix': 'mariadb-client', 'reference': '1:10.5.28-0+deb11u2'},
    {'release': '11.0', 'prefix': 'mariadb-client-10.5', 'reference': '1:10.5.28-0+deb11u2'},
    {'release': '11.0', 'prefix': 'mariadb-client-core-10.5', 'reference': '1:10.5.28-0+deb11u2'},
    {'release': '11.0', 'prefix': 'mariadb-common', 'reference': '1:10.5.28-0+deb11u2'},
    {'release': '11.0', 'prefix': 'mariadb-plugin-connect', 'reference': '1:10.5.28-0+deb11u2'},
    {'release': '11.0', 'prefix': 'mariadb-plugin-cracklib-password-check', 'reference': '1:10.5.28-0+deb11u2'},
    {'release': '11.0', 'prefix': 'mariadb-plugin-gssapi-client', 'reference': '1:10.5.28-0+deb11u2'},
    {'release': '11.0', 'prefix': 'mariadb-plugin-gssapi-server', 'reference': '1:10.5.28-0+deb11u2'},
    {'release': '11.0', 'prefix': 'mariadb-plugin-mroonga', 'reference': '1:10.5.28-0+deb11u2'},
    {'release': '11.0', 'prefix': 'mariadb-plugin-oqgraph', 'reference': '1:10.5.28-0+deb11u2'},
    {'release': '11.0', 'prefix': 'mariadb-plugin-rocksdb', 'reference': '1:10.5.28-0+deb11u2'},
    {'release': '11.0', 'prefix': 'mariadb-plugin-s3', 'reference': '1:10.5.28-0+deb11u2'},
    {'release': '11.0', 'prefix': 'mariadb-plugin-spider', 'reference': '1:10.5.28-0+deb11u2'},
    {'release': '11.0', 'prefix': 'mariadb-server', 'reference': '1:10.5.28-0+deb11u2'},
    {'release': '11.0', 'prefix': 'mariadb-server-10.5', 'reference': '1:10.5.28-0+deb11u2'},
    {'release': '11.0', 'prefix': 'mariadb-server-core-10.5', 'reference': '1:10.5.28-0+deb11u2'},
    {'release': '11.0', 'prefix': 'mariadb-test', 'reference': '1:10.5.28-0+deb11u2'},
    {'release': '11.0', 'prefix': 'mariadb-test-data', 'reference': '1:10.5.28-0+deb11u2'}
];
