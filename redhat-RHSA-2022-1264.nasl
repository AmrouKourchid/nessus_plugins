...
# extracted from Red Hat Security Advisory RHSA-2022:1264. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:1264");

  script_name(english:"RHEL 7 : Red Hat OpenStack Platform 13.0 (python-waitress) (RHSA-2022:1264)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for Red Hat OpenStack Platform 13.0 (python-waitress).");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_1264.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3d84ab29");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:1264");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2065086");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat OpenStack Platform 13.0 (python-waitress) package based on the guidance in RHSA-2022:1264.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:python2-waitress");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python2-waitress-1.4.4-2.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python2-waitress');
}
