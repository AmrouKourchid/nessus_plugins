...
# extracted from Fedora Security Advisory FEDORA-2024-ab4573fb3b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-ab4573fb3b");

  script_name(english:"Fedora 40 : rust (2024-ab4573fb3b)");
...
FEDORA-2024-ab4573fb3b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-ab4573fb3b");
...
var pkgs = [
    {'reference':'rust-1.77.2-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
