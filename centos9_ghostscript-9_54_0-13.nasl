...
if (description)
{
  ...
  script_name(english:"CentOS 9 : ghostscript-9.54.0-13.el9");
...
ghostscript-9.54.0-13.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=35710");
...
var pkgs = [
    ...
    {'reference':'ghostscript-gtk-9.54.0-13.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
