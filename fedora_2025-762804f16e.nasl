...
# extracted from Fedora Security Advisory FEDORA-2025-762804f16e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-762804f16e");

  script_name(english:"Fedora 40 : chromium (2025-762804f16e)");
...
FEDORA-2025-762804f16e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-762804f16e");
...
var pkgs = [
    {'reference':'chromium-134.0.6998.35-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
