...
# extracted from Red Hat Security Advisory RHSA-2021:4374. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_4374.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3041c513");
...
"Update the RHEL file package based on the guidance in RHSA-2021:4374.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:python3-magic");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'file-5.33-20.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'file-devel-5.33-20.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'file-libs-5.33-20.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
