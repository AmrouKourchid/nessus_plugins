...
# extracted from Red Hat Security Advisory RHSA-2023:6615. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:6615");

  script_name(english:"RHEL 9 : python-cryptography (RHSA-2023:6615)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6615.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?691eda8e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2171817");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2172399");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2203840");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6615");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-cryptography package based on the guidance in RHSA-2023:6615.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-cryptography-36.0.1-4.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
