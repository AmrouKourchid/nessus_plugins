...
# extracted from Oracle Linux Security Advisory ELSA-2023-1093.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : pesign (ELSA-2023-1093)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-1093.html");
...
var pkgs = [
    {'reference':'pesign-0.109-11.el7_9', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
