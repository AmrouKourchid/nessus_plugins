...
# extracted from Oracle Linux Security Advisory ELSA-2020-2774.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : virt:ol (ELSA-2020-2774)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ELSA-2020-2774 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2020-2774.html");
...
var appstreams = {
    'virt-devel:ol': [
      {'reference':'qemu-kvm-tests-2.12.0-99.0.1.module+el8.2.0+7633+22bb8eb4.2', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
      {'reference':'qemu-kvm-tests-2.12.0-99.0.1.module+el8.2.0+7633+22bb8eb4.2', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
      {'reference':'qemu-kvm-tests-2.12.0-99.0.1.module+el8.2.0+7633+22bb8eb4.2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'}
    ],
    'virt:ol': [
      ...
      {'reference':'libguestfs-bash-completion-1.38.4-15.0.1.module+el8.2.0+5598+5fbb295f', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      ...
      {'reference':'libguestfs-inspect-icons-1.38.4-15.0.1.module+el8.2.0+5598+5fbb295f', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      ...
      {'reference':'libguestfs-javadoc-1.38.4-15.0.1.module+el8.2.0+5598+5fbb295f', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'libguestfs-man-pages-ja-1.38.4-15.0.1.module+el8.2.0+5598+5fbb295f', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'libguestfs-man-pages-uk-1.38.4-15.0.1.module+el8.2.0+5598+5fbb295f', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      ...
      {'reference':'libguestfs-tools-1.38.4-15.0.1.module+el8.2.0+5598+5fbb295f', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      ...
      {'reference':'nbdkit-bash-completion-1.4.2-5.module+el8.2.0+5598+5fbb295f', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'qemu-guest-agent-2.12.0-99.0.1.module+el8.2.0+7633+22bb8eb4.2', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
      {'reference':'qemu-img-2.12.0-99.0.1.module+el8.2.0+7633+22bb8eb4.2', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
      {'reference':'qemu-kvm-2.12.0-99.0.1.module+el8.2.0+7633+22bb8eb4.2', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
      {'reference':'qemu-kvm-block-curl-2.12.0-99.0.1.module+el8.2.0+7633+22bb8eb4.2', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
      {'reference':'qemu-kvm-block-iscsi-2.12.0-99.0.1.module+el8.2.0+7633+22bb8eb4.2', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
      {'reference':'qemu-kvm-block-rbd-2.12.0-99.0.1.module+el8.2.0+7633+22bb8eb4.2', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
      {'reference':'qemu-kvm-block-ssh-2.12.0-99.0.1.module+el8.2.0+7633+22bb8eb4.2', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
      {'reference':'qemu-kvm-common-2.12.0-99.0.1.module+el8.2.0+7633+22bb8eb4.2', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
      {'reference':'qemu-kvm-core-2.12.0-99.0.1.module+el8.2.0+7633+22bb8eb4.2', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
      ...
      {'reference':'libguestfs-1.38.4-15.0.1.module+el8.2.0+5598+5fbb295f', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'libguestfs-bash-completion-1.38.4-15.0.1.module+el8.2.0+5598+5fbb295f', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'libguestfs-benchmarking-1.38.4-15.0.1.module+el8.2.0+5598+5fbb295f', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'libguestfs-devel-1.38.4-15.0.1.module+el8.2.0+5598+5fbb295f', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'libguestfs-gfs2-1.38.4-15.0.1.module+el8.2.0+5598+5fbb295f', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'libguestfs-gobject-1.38.4-15.0.1.module+el8.2.0+5598+5fbb295f', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'libguestfs-gobject-devel-1.38.4-15.0.1.module+el8.2.0+5598+5fbb295f', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'libguestfs-inspect-icons-1.38.4-15.0.1.module+el8.2.0+5598+5fbb295f', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'libguestfs-java-1.38.4-15.0.1.module+el8.2.0+5598+5fbb295f', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'libguestfs-java-devel-1.38.4-15.0.1.module+el8.2.0+5598+5fbb295f', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'libguestfs-javadoc-1.38.4-15.0.1.module+el8.2.0+5598+5fbb295f', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'libguestfs-man-pages-ja-1.38.4-15.0.1.module+el8.2.0+5598+5fbb295f', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'libguestfs-man-pages-uk-1.38.4-15.0.1.module+el8.2.0+5598+5fbb295f', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'libguestfs-rescue-1.38.4-15.0.1.module+el8.2.0+5598+5fbb295f', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'libguestfs-rsync-1.38.4-15.0.1.module+el8.2.0+5598+5fbb295f', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'libguestfs-tools-1.38.4-15.0.1.module+el8.2.0+5598+5fbb295f', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'libguestfs-tools-c-1.38.4-15.0.1.module+el8.2.0+5598+5fbb295f', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'libguestfs-winsupport-8.0-4.module+el8.2.0+5598+5fbb295f', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libguestfs-xfs-1.38.4-15.0.1.module+el8.2.0+5598+5fbb295f', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      ...
      {'reference':'libvirt-daemon-driver-qemu-4.5.0-42.0.1.module+el8.2.0+5598+5fbb295f', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'libvirt-daemon-driver-storage-gluster-4.5.0-42.0.1.module+el8.2.0+5598+5fbb295f', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'libvirt-daemon-kvm-4.5.0-42.0.1.module+el8.2.0+5598+5fbb295f', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'libvirt-lock-sanlock-4.5.0-42.0.1.module+el8.2.0+5598+5fbb295f', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-nss-4.5.0-42.0.1.module+el8.2.0+5598+5fbb295f', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'lua-guestfs-1.38.4-15.0.1.module+el8.2.0+5598+5fbb295f', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nbdkit-1.4.2-5.module+el8.2.0+5598+5fbb295f', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nbdkit-bash-completion-1.4.2-5.module+el8.2.0+5598+5fbb295f', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nbdkit-basic-plugins-1.4.2-5.module+el8.2.0+5598+5fbb295f', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nbdkit-devel-1.4.2-5.module+el8.2.0+5598+5fbb295f', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nbdkit-example-plugins-1.4.2-5.module+el8.2.0+5598+5fbb295f', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nbdkit-plugin-gzip-1.4.2-5.module+el8.2.0+5598+5fbb295f', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nbdkit-plugin-python-common-1.4.2-5.module+el8.2.0+5598+5fbb295f', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nbdkit-plugin-python3-1.4.2-5.module+el8.2.0+5598+5fbb295f', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nbdkit-plugin-vddk-1.4.2-5.module+el8.2.0+5598+5fbb295f', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nbdkit-plugin-xz-1.4.2-5.module+el8.2.0+5598+5fbb295f', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'ocaml-libguestfs-1.38.4-15.0.1.module+el8.2.0+5598+5fbb295f', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'ocaml-libguestfs-devel-1.38.4-15.0.1.module+el8.2.0+5598+5fbb295f', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'perl-Sys-Guestfs-1.38.4-15.0.1.module+el8.2.0+5598+5fbb295f', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      ...
      {'reference':'python3-libguestfs-1.38.4-15.0.1.module+el8.2.0+5598+5fbb295f', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'python3-libvirt-4.5.0-2.module+el8.2.0+5598+5fbb295f', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'qemu-guest-agent-2.12.0-99.0.1.module+el8.2.0+7633+22bb8eb4.2', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
      {'reference':'qemu-img-2.12.0-99.0.1.module+el8.2.0+7633+22bb8eb4.2', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
      {'reference':'qemu-kvm-2.12.0-99.0.1.module+el8.2.0+7633+22bb8eb4.2', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
      {'reference':'qemu-kvm-block-curl-2.12.0-99.0.1.module+el8.2.0+7633+22bb8eb4.2', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
      {'reference':'qemu-kvm-block-gluster-2.12.0-99.0.1.module+el8.2.0+7633+22bb8eb4.2', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
      {'reference':'qemu-kvm-block-iscsi-2.12.0-99.0.1.module+el8.2.0+7633+22bb8eb4.2', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
      {'reference':'qemu-kvm-block-rbd-2.12.0-99.0.1.module+el8.2.0+7633+22bb8eb4.2', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
      {'reference':'qemu-kvm-block-ssh-2.12.0-99.0.1.module+el8.2.0+7633+22bb8eb4.2', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
      {'reference':'qemu-kvm-common-2.12.0-99.0.1.module+el8.2.0+7633+22bb8eb4.2', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
      {'reference':'qemu-kvm-core-2.12.0-99.0.1.module+el8.2.0+7633+22bb8eb4.2', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
      {'reference':'ruby-hivex-1.3.15-7.module+el8.2.0+5598+5fbb295f', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ruby-libguestfs-1.38.4-15.0.1.module+el8.2.0+5598+5fbb295f', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'seabios-1.11.1-4.module+el8.2.0+5598+5fbb295f', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'seabios-bin-1.11.1-4.module+el8.2.0+5598+5fbb295f', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'seavgabios-bin-1.11.1-4.module+el8.2.0+5598+5fbb295f', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sgabios-0.20170427git-3.module+el8.2.0+5598+5fbb295f', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'sgabios-bin-0.20170427git-3.module+el8.2.0+5598+5fbb295f', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'supermin-5.1.19-9.module+el8.2.0+5598+5fbb295f', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'supermin-devel-5.1.19-9.module+el8.2.0+5598+5fbb295f', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'virt-dib-1.38.4-15.0.1.module+el8.2.0+5598+5fbb295f', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'virt-v2v-1.38.4-15.0.1.module+el8.2.0+5598+5fbb295f', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      ...
      {'reference':'libguestfs-bash-completion-1.38.4-15.0.1.module+el8.2.0+5598+5fbb295f', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      ...
      {'reference':'libguestfs-inspect-icons-1.38.4-15.0.1.module+el8.2.0+5598+5fbb295f', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      ...
      {'reference':'libguestfs-javadoc-1.38.4-15.0.1.module+el8.2.0+5598+5fbb295f', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'libguestfs-man-pages-ja-1.38.4-15.0.1.module+el8.2.0+5598+5fbb295f', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'libguestfs-man-pages-uk-1.38.4-15.0.1.module+el8.2.0+5598+5fbb295f', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      ...
      {'reference':'libguestfs-tools-1.38.4-15.0.1.module+el8.2.0+5598+5fbb295f', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      ...
      {'reference':'nbdkit-bash-completion-1.4.2-5.module+el8.2.0+5598+5fbb295f', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'qemu-guest-agent-2.12.0-99.0.1.module+el8.2.0+7633+22bb8eb4.2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
      {'reference':'qemu-img-2.12.0-99.0.1.module+el8.2.0+7633+22bb8eb4.2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
      {'reference':'qemu-kvm-2.12.0-99.0.1.module+el8.2.0+7633+22bb8eb4.2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
      {'reference':'qemu-kvm-block-curl-2.12.0-99.0.1.module+el8.2.0+7633+22bb8eb4.2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
      {'reference':'qemu-kvm-block-gluster-2.12.0-99.0.1.module+el8.2.0+7633+22bb8eb4.2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
      {'reference':'qemu-kvm-block-iscsi-2.12.0-99.0.1.module+el8.2.0+7633+22bb8eb4.2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
      {'reference':'qemu-kvm-block-rbd-2.12.0-99.0.1.module+el8.2.0+7633+22bb8eb4.2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
      {'reference':'qemu-kvm-block-ssh-2.12.0-99.0.1.module+el8.2.0+7633+22bb8eb4.2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
      {'reference':'qemu-kvm-common-2.12.0-99.0.1.module+el8.2.0+7633+22bb8eb4.2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
      {'reference':'qemu-kvm-core-2.12.0-99.0.1.module+el8.2.0+7633+22bb8eb4.2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
      ...
      {'reference':'seabios-bin-1.11.1-4.module+el8.2.0+5598+5fbb295f', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'seavgabios-bin-1.11.1-4.module+el8.2.0+5598+5fbb295f', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sgabios-0.20170427git-3.module+el8.2.0+5598+5fbb295f', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'sgabios-bin-0.20170427git-3.module+el8.2.0+5598+5fbb295f', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
