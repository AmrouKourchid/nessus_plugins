...
# extracted from Debian Security Advisory dla-3086. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3086 : libmaven-shared-utils-java - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3086
advisory.

    -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3086-1                debian-lts@lists.debian.org
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/maven-shared-utils");
  script_set_attribute(attribute:"solution", value:
"Upgrade the libmaven-shared-utils-java packages.");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libmaven-shared-utils-java', 'reference': '3.3.0-1+deb10u1'},
    {'release': '10.0', 'prefix': 'libmaven-shared-utils-java-doc', 'reference': '3.3.0-1+deb10u1'}
];
