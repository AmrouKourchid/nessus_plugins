...
# extracted from Fedora Security Advisory FEDORA-2023-00c78aad58
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-00c78aad58");

  script_name(english:"Fedora 39 : podman (2023-00c78aad58)");
...
FEDORA-2023-00c78aad58 advisory.

    Automatic update for podman-4.7.2-1.fc39.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-00c78aad58");
...
var pkgs = [
    {'reference':'podman-4.7.2-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'5'}
];
