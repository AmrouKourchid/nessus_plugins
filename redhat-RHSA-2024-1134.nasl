...
# extracted from Red Hat Security Advisory RHSA-2024:1134. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:1134");
  script_xref(name:"IAVA", value:"2023-A-0661-S");

  script_name(english:"RHEL 9 : tomcat (RHSA-2024:1134)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_1134.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?07aa67a7");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2252050");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:1134");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL tomcat package based on the guidance in RHSA-2024:1134.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'tomcat-9.0.62-37.el9_3.2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'tomcat-admin-webapps-9.0.62-37.el9_3.2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'tomcat-docs-webapp-9.0.62-37.el9_3.2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'tomcat-el-3.0-api-9.0.62-37.el9_3.2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'tomcat-jsp-2.3-api-9.0.62-37.el9_3.2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'tomcat-lib-9.0.62-37.el9_3.2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'tomcat-servlet-4.0-api-9.0.62-37.el9_3.2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'tomcat-webapps-9.0.62-37.el9_3.2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
