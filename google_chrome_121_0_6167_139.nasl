...
"The version of Google Chrome installed on the remote Windows host is prior to 121.0.6167.139. It is, therefore, affected
...
google_chrome_check_version(installs:installs, fix:'121.0.6167.139', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
