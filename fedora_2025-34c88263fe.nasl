...
# extracted from Fedora Security Advisory FEDORA-2025-34c88263fe
#
...
if (description)
{
  ...
  script_cve_id("CVE-2024-12361");
  script_xref(name:"FEDORA", value:"2025-34c88263fe");
  script_xref(name:"IAVB", value:"2025-B-0060");

  script_name(english:"Fedora 40 : ffmpeg (2025-34c88263fe)");
...
FEDORA-2025-34c88263fe advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-34c88263fe");
  script_set_attribute(attribute:"solution", value:
"Update the affected ffmpeg package.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:N/I:N/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:L");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-12361");
...
var pkgs = [
    {'reference':'ffmpeg-6.1.2-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
