...
# extracted from Red Hat Security Advisory RHSA-2021:0617. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:0617");

  script_name(english:"RHEL 7 : xterm (RHSA-2021:0617)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_0617.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?594bce81");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:0617");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1927559");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL xterm package based on the guidance in RHSA-2021:0617.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'xterm-295-3.el7_9.1', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xterm-295-3.el7_9.1', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xterm-295-3.el7_9.1', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xterm-295-3.el7_9.1', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
