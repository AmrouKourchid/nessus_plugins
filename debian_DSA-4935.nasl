...
# extracted from Debian Security Advisory dsa-4935. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-4935-1 : php7.3 - security update");
...
dsa-4935 advisory.
    ...
    Multiple security issues were found in PHP, a widely-used open source general purpose scripting language
    which could result an SSRF bypass of the FILTER_VALIDATE_URL check and denial of service or potentially
    the execution of arbitrary code in the Firebird PDO. For the stable distribution (buster), these problems
    have been fixed in version 7.3.29-1~deb10u1. We recommend that you upgrade your php7.3 packages. For the
    detailed security status of php7.3 please refer to its security tracker page at: https://security-
    tracker.debian.org/tracker/php7.3
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2021/dsa-4935");
...
For the stable distribution (buster), these problems have been fixed in version 7.3.29-1~deb10u1.");
  ...
  script_set_attribute(attribute:"vuln_publication_date", value:"2021/07/05");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libapache2-mod-php7.3', 'reference': '7.3.29-1~deb10u1'},
    {'release': '10.0', 'prefix': 'libphp7.3-embed', 'reference': '7.3.29-1~deb10u1'},
    {'release': '10.0', 'prefix': 'php7.3', 'reference': '7.3.29-1~deb10u1'},
    {'release': '10.0', 'prefix': 'php7.3-bcmath', 'reference': '7.3.29-1~deb10u1'},
    {'release': '10.0', 'prefix': 'php7.3-bz2', 'reference': '7.3.29-1~deb10u1'},
    {'release': '10.0', 'prefix': 'php7.3-cgi', 'reference': '7.3.29-1~deb10u1'},
    {'release': '10.0', 'prefix': 'php7.3-cli', 'reference': '7.3.29-1~deb10u1'},
    {'release': '10.0', 'prefix': 'php7.3-common', 'reference': '7.3.29-1~deb10u1'},
    {'release': '10.0', 'prefix': 'php7.3-curl', 'reference': '7.3.29-1~deb10u1'},
    {'release': '10.0', 'prefix': 'php7.3-dba', 'reference': '7.3.29-1~deb10u1'},
    {'release': '10.0', 'prefix': 'php7.3-dev', 'reference': '7.3.29-1~deb10u1'},
    {'release': '10.0', 'prefix': 'php7.3-enchant', 'reference': '7.3.29-1~deb10u1'},
    {'release': '10.0', 'prefix': 'php7.3-fpm', 'reference': '7.3.29-1~deb10u1'},
    {'release': '10.0', 'prefix': 'php7.3-gd', 'reference': '7.3.29-1~deb10u1'},
    {'release': '10.0', 'prefix': 'php7.3-gmp', 'reference': '7.3.29-1~deb10u1'},
    {'release': '10.0', 'prefix': 'php7.3-imap', 'reference': '7.3.29-1~deb10u1'},
    {'release': '10.0', 'prefix': 'php7.3-interbase', 'reference': '7.3.29-1~deb10u1'},
    {'release': '10.0', 'prefix': 'php7.3-intl', 'reference': '7.3.29-1~deb10u1'},
    {'release': '10.0', 'prefix': 'php7.3-json', 'reference': '7.3.29-1~deb10u1'},
    {'release': '10.0', 'prefix': 'php7.3-ldap', 'reference': '7.3.29-1~deb10u1'},
    {'release': '10.0', 'prefix': 'php7.3-mbstring', 'reference': '7.3.29-1~deb10u1'},
    {'release': '10.0', 'prefix': 'php7.3-mysql', 'reference': '7.3.29-1~deb10u1'},
    {'release': '10.0', 'prefix': 'php7.3-odbc', 'reference': '7.3.29-1~deb10u1'},
    {'release': '10.0', 'prefix': 'php7.3-opcache', 'reference': '7.3.29-1~deb10u1'},
    {'release': '10.0', 'prefix': 'php7.3-pgsql', 'reference': '7.3.29-1~deb10u1'},
    {'release': '10.0', 'prefix': 'php7.3-phpdbg', 'reference': '7.3.29-1~deb10u1'},
    {'release': '10.0', 'prefix': 'php7.3-pspell', 'reference': '7.3.29-1~deb10u1'},
    {'release': '10.0', 'prefix': 'php7.3-readline', 'reference': '7.3.29-1~deb10u1'},
    {'release': '10.0', 'prefix': 'php7.3-recode', 'reference': '7.3.29-1~deb10u1'},
    {'release': '10.0', 'prefix': 'php7.3-snmp', 'reference': '7.3.29-1~deb10u1'},
    {'release': '10.0', 'prefix': 'php7.3-soap', 'reference': '7.3.29-1~deb10u1'},
    {'release': '10.0', 'prefix': 'php7.3-sqlite3', 'reference': '7.3.29-1~deb10u1'},
    {'release': '10.0', 'prefix': 'php7.3-sybase', 'reference': '7.3.29-1~deb10u1'},
    {'release': '10.0', 'prefix': 'php7.3-tidy', 'reference': '7.3.29-1~deb10u1'},
    {'release': '10.0', 'prefix': 'php7.3-xml', 'reference': '7.3.29-1~deb10u1'},
    {'release': '10.0', 'prefix': 'php7.3-xmlrpc', 'reference': '7.3.29-1~deb10u1'},
    {'release': '10.0', 'prefix': 'php7.3-xsl', 'reference': '7.3.29-1~deb10u1'},
    {'release': '10.0', 'prefix': 'php7.3-zip', 'reference': '7.3.29-1~deb10u1'}
];
