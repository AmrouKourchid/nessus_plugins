...
# extracted from Fedora Security Advisory FEDORA-2023-6c1200da3d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-6c1200da3d");

  script_name(english:"Fedora 38 : tkimg (2023-6c1200da3d)");
...
FEDORA-2023-6c1200da3d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-6c1200da3d");
...
var pkgs = [
    {'reference':'tkimg-1.4.14-3.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
