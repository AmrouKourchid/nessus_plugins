...
# extracted from Red Hat Security Advisory RHSA-2022:8560 and
# CentOS Errata and Security Advisory 2022:8560 respectively.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : hsqldb (RHSA-2022:8560)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 7 host has packages installed that are affected by a vulnerability as referenced in the
RHSA-2022:8560 advisory.
...
var pkgs = [
    {'reference':'hsqldb-1.8.1.3-15.el7_9', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'hsqldb-demo-1.8.1.3-15.el7_9', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'hsqldb-javadoc-1.8.1.3-15.el7_9', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'hsqldb-manual-1.8.1.3-15.el7_9', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE}
];
