...
# extracted from openSUSE Security Update openSUSE-2018-994.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : MozillaThunderbird (openSUSE-2018-994)");
...
These non-security issues were fixed :
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1084603");
...
if ( rpm_check(release:"SUSE42.3", reference:"MozillaThunderbird-60.0-74.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"MozillaThunderbird-buildsymbols-60.0-74.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"MozillaThunderbird-debuginfo-60.0-74.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"MozillaThunderbird-debugsource-60.0-74.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"MozillaThunderbird-translations-common-60.0-74.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"MozillaThunderbird-translations-other-60.0-74.1") ) flag++;
