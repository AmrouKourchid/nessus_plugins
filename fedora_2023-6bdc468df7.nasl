...
# extracted from Fedora Security Advisory FEDORA-2023-6bdc468df7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-6bdc468df7");

  script_name(english:"Fedora 39 : firefox (2023-6bdc468df7)");
...
FEDORA-2023-6bdc468df7 advisory.

    This update provides Firefox 117.0.1, with a significant security fix (for
    [CVE-2023-4863](https://access.redhat.com/security/cve/CVE-2023-4863)) and various bug fixes.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-6bdc468df7");
...
var pkgs = [
    {'reference':'firefox-117.0.1-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
