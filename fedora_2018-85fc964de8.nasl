...
# extracted from Fedora Security Advisory FEDORA-2018-85fc964de8.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-85fc964de8");

  script_name(english:"Fedora 29 : pdns (2018-85fc964de8)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-85fc964de8");
  # https://doc.powerdns.com/authoritative/security-advisories/powerdns-advisory-2018-03.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?56fddf39");
  # https://doc.powerdns.com/authoritative/security-advisories/powerdns-advisory-2018-05.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?156cee5a");
  script_set_attribute(attribute:"solution", value:
"Update the affected pdns package.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-14626");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"pdns-4.1.5-1.fc29")) flag++;
