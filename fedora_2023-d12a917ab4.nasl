...
# extracted from Fedora Security Advisory FEDORA-2023-d12a917ab4
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-d12a917ab4");

  script_name(english:"Fedora 38 : nodejs16 / nodejs18 / nodejs20 (2023-d12a917ab4)");
...
FEDORA-2023-d12a917ab4 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-d12a917ab4");
...
var pkgs = [
    {'reference':'nodejs16-16.20.2-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'nodejs18-18.17.1-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'nodejs20-20.5.1-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
