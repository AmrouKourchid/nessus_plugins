...
# extracted from Red Hat Security Advisory RHSA-2025:1118. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:1118");

  script_name(english:"RHEL 9 : OpenShift Container Platform 4.13.55 (RHSA-2025:1118)");
...
referenced in the RHSA-2025:1118 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.13.55. See the
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_1118.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5c1280f2");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:1118");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.13.55 packages based on the guidance in RHSA-2025:1118.");
