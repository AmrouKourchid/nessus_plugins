...
# extracted from Red Hat Security Advisory RHSA-2021:4134 and
# CentOS Errata and Security Advisory 2021:4134 respectively.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : thunderbird (RHSA-2021:4134)");
...
RHSA-2021:4134 advisory.
  ...
  - Thunderbird versions prior to 91.3.0 are vulnerable to the heap overflow described in CVE-2021-43527 when
...
var pkgs = [
    {'reference':'thunderbird-91.3.0-2.el7.centos', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'thunderbird-91.3.0-2.el7.centos', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
