...
if (description)
{
  ...
  script_cve_id("CVE-2024-50245");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-50245");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: fs/ntfs3: Fix possible deadlock in
    mi_read Mutex lock with another subclass used in ni_lock_dir(). (CVE-2024-50245)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-50245");
