...
# extracted from Fedora Security Advisory FEDORA-2024-0a4a65f805
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-0a4a65f805");

  script_name(english:"Fedora 40 : chromium (2024-0a4a65f805)");
...
FEDORA-2024-0a4a65f805 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-0a4a65f805");
...
var pkgs = [
    {'reference':'chromium-128.0.6613.137-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
