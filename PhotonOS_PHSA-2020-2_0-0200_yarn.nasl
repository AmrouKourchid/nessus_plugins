...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Yarn PHSA-2020-2.0-0200");
...
if (rpm_exists(rpm:'yarn-1.10', release:'PhotonOS-2.0') && rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'yarn-1.10.1-5.ph2')) flag++;
