...
# extracted from Red Hat Security Advisory RHSA-2025:0762. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:0762");

  script_name(english:"RHEL 8 : git-lfs (RHSA-2025:0762)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_0762.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5f5c6e94");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:0762");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL git-lfs package based on the guidance in RHSA-2025:0762.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'git-lfs-3.2.0-2.el8_8.3', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
