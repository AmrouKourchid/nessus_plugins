...
if (description)
{
  ...
  script_name(english:"Adobe Illustrator < 25.4.4 / 26.0.0 < 26.0.3 Multiple Vulnerabilities (APSB22-07) (macOS)");

  script_set_attribute(attribute:"synopsis", value:
"The Adobe Illustrator instance installed on the remote host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Illustrator installed on the remote macOS host is prior to 25.4.4, 26.0.3. It is, therefore,
...
"Upgrade to Adobe Illustrator version 25.4.4, 26.0.3 or later.");
...
var constraints = [
  { 'fixed_version' : '25.4.4' },
  { 'min_version' : '26.0.0', 'fixed_version' : '26.0.3' }
];
