...
# extracted from openSUSE Security Update openSUSE-2019-2388.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : openconnect (openSUSE-2019-2388)");
...
if ( rpm_check(release:"SUSE15.0", reference:"openconnect-7.08-lp150.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"openconnect-debuginfo-7.08-lp150.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"openconnect-debugsource-7.08-lp150.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"openconnect-devel-7.08-lp150.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"openconnect-lang-7.08-lp150.5.3.1") ) flag++;
