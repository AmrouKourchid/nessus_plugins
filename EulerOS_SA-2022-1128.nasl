...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : libjpeg-turbo (EulerOS-SA-2022-1128)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the libjpeg-turbo packages installed, the EulerOS Virtualization installation on the remote
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1128
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9c42f5f8");
...
var pkgs = [
  "libjpeg-turbo-1.2.90-6.h10.eulerosv2r7",
  "libjpeg-turbo-devel-1.2.90-6.h10.eulerosv2r7"
];
