...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Nasm PHSA-2023-3.0-0568");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the nasm package has been released.");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:vmware:photonos:nasm");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'nasm-2.16.01-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'nasm-doc-2.16.01-1.ph3')) flag++;
