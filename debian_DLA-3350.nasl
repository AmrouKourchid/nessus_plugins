...
# extracted from Debian Security Advisory dla-3350. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3350 : node-css-what - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?28bfcbfa");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2021-33587");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-21222");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/node-css-what");
  script_set_attribute(attribute:"solution", value:
"Upgrade the node-css-what packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:node-css-what");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'node-css-what', 'reference': '2.1.0-1+deb10u1'}
];
