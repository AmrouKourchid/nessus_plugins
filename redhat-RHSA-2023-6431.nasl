...
# extracted from Red Hat Security Advisory RHSA-2023:6431. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:6431");

  script_name(english:"RHEL 9 : libfastjson (RHSA-2023:6431)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for libfastjson.");
...
the RHSA-2023:6431 advisory.

    The libfastjson library provides essential JavaScript Object Notation (JSON) handling functions. The
    library enables users to construct JSON objects in C, output them as JSON-formatted strings, and convert
    JSON-formatted strings back to the C representation of JSON objects.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6431.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?58dbeb65");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2227786");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6431");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libfastjson package based on the guidance in RHSA-2023:6431.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:libfastjson");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:libfastjson-devel");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libfastjson-0.99.9-5.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libfastjson-devel-0.99.9-5.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libfastjson / libfastjson-devel');
}
