...
# extracted from HP patch PHSS_32183. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_32183 : s700_800 11.04 Virtualvault 4.6 OWS update");
...
"Install patch PHSS_32183 or subsequent.");
...
{
  exit(0, "The host is not affected since PHSS_32183 applies to a different OS release.");
}

patches = make_list("PHSS_32183", "PHSS_33397", "PHSS_34120", "PHSS_35108", "PHSS_35462", "PHSS_35557");
