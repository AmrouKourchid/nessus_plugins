...
# extracted from Fedora Security Advisory FEDORA-2022-64ad80875c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-64ad80875c");

  script_name(english:"Fedora 37 : xorg-x11-server (2022-64ad80875c)");
...
FEDORA-2022-64ad80875c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-64ad80875c");
...
var pkgs = [
    {'reference':'xorg-x11-server-1.20.14-9.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
