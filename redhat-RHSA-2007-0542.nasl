...
"The remote Red Hat host is missing a security update for mcstrans.");
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2007/rhsa-2007_0542.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?012a182d");
  script_set_attribute(attribute:"see_also", value:"http://www.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=228398");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=288201");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2007:0542");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL mcstrans package based on the guidance in RHSA-2007:0542.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:M/Au:N/C:N/I:N/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:L/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2007-4570");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'mcstrans-0.2.6-1.el5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mcstrans-0.2.6-1.el5', 'cpu':'ppc', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mcstrans-0.2.6-1.el5', 'cpu':'s390x', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mcstrans-0.2.6-1.el5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
