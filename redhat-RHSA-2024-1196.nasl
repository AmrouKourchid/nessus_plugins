...
# extracted from Red Hat Security Advisory RHSA-2024:1196. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:1196");

  script_name(english:"RHEL 7 / 8 / 9 : Red Hat JBoss Enterprise Application Platform 7.4 (RHSA-2024:1196)");
...
referenced in the RHSA-2024:1196 advisory.
    ...
    * libssh: ssh: Prefix truncation attack on Binary Packet Protocol [services-edge-fleet-management-
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_1196.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8d999474");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:1196");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat JBoss Enterprise Application Platform 7.4 package based on the guidance in RHSA-2024:1196.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'eap7-apache-sshd-2.12.1-1.redhat_00001.1.el8eap', 'release':'8', 'el_string':'el8eap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap7'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'eap7-apache-sshd-2.12.1-1.redhat_00001.1.el9eap', 'release':'9', 'el_string':'el9eap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap7'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'eap7-apache-sshd-2.12.1-1.redhat_00001.1.el7eap', 'release':'7', 'el_string':'el7eap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap7'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'eap7-apache-sshd');
}
