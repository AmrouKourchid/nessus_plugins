...
if (description)
{
  ...
  script_name(english:"Fortinet FortiClient TunnelVision - CVE-2024-3661 (FG-IR-24-170) (macOS)");
...
FortiClient version 7.4.3 or later.");
  ...
  script_require_keys("installed_sw/FortiClient (macOS)", "Settings/ParanoidReport");
