...
if (description)
{
  ...
  script_name(english:"Oracle Access Manager DoS (October 2023 CPU)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host has a Single Sign On (SSO) application installed that is affected by a vulnerability");
  script_set_attribute(attribute:"description", value:
"The version of Oracle Access Manager installed on the remote host is missing a security patch from the October 2023 CPU 
Advisory. It is, therefore, affected by denial of service vulnerability. Vulnerability in the Oracle Access Manager 
product of Oracle Fusion Middleware (component: Centralized Thirdparty Jars (Netty)). The supported version that is 
affected is 12.2.1.4.0. Easily exploitable vulnerability allows unauthenticated attacker with network access via HTTP to
compromise Oracle Access Manager. Successful attacks of this vulnerability can result in unauthorized ability to cause a 
hang or frequently repeatable crash (complete DOS) of Oracle Access Manager. 
...
"Apply the appropriate patches according to the October 2023 Oracle Critical Patch Update advisory.");
...
var constraints = [ {'min_version': '12.2.1.4', 'fixed_version': '12.2.1.4.231005'} ];
