...
# extracted from Fedora Security Advisory FEDORA-2024-a7af4e0ea2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-a7af4e0ea2");

  script_name(english:"Fedora 39 : python3.6 (2024-a7af4e0ea2)");
...
FEDORA-2024-a7af4e0ea2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-a7af4e0ea2");
...
var pkgs = [
    {'reference':'python3.6-3.6.15-35.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
