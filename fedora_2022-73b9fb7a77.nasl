...
# extracted from Fedora Security Advisory FEDORA-2022-73b9fb7a77
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-73b9fb7a77");

  script_name(english:"Fedora 37 : php-twig2 (2022-73b9fb7a77)");
...
FEDORA-2022-73b9fb7a77 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-73b9fb7a77");
...
var pkgs = [
    {'reference':'php-twig2-2.15.3-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
