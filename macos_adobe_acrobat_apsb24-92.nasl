...
if (description)
{
  ...
  script_name(english:"Adobe Acrobat < 20.005.30748 / 24.001.30225 / 24.005.20320 Multiple Vulnerabilities (APSB24-92) (macOS)");
...
"The version of Adobe Acrobat installed on the remote macOS host is a version prior to 20.005.30748, 24.001.30225, or
24.005.20320. It is, therefore, affected by multiple vulnerabilities.
...
"Upgrade to Adobe Acrobat version 20.005.30748 / 24.001.30225 / 24.005.20320 or later.");
...
var constraints = [
  { 'min_version' : '20.1', 'max_version' : '20.005.30710', 'fixed_version' : '20.005.30748', 'track' : 'DC Classic' },
  { 'min_version' : '24.1', 'max_version' : '24.001.30193', 'fixed_version' : '24.001.30225', 'track' : 'DC Classic' },
