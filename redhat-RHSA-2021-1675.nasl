...
# extracted from Red Hat Security Advisory RHSA-2021:1675. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:1675");

  script_name(english:"RHEL 8 : libdb (RHSA-2021:1675)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for libdb.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2021:1675 advisory.

    The libdb packages provide the Berkeley Database, an embedded database supporting both traditional and
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_1675.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?eb2c7ec8");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:1675");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1853242");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libdb package based on the guidance in RHSA-2021:1675.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:libdb-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:libdb-devel-doc");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:libdb-sql");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:libdb-sql-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:libdb-utils");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libdb-5.3.28-40.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libdb-cxx-5.3.28-40.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libdb-cxx-devel-5.3.28-40.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libdb-devel-5.3.28-40.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libdb-devel-doc-5.3.28-40.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libdb-sql-5.3.28-40.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libdb-sql-devel-5.3.28-40.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libdb-utils-5.3.28-40.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libdb / libdb-cxx / libdb-cxx-devel / libdb-devel / libdb-devel-doc / etc');
}
