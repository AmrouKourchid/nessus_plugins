...
# extracted from Red Hat Security Advisory RHSA-2012:0722. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2012:0722");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2022/04/18");

  script_name(english:"RHEL 5 / 6 : flash-plugin (RHSA-2012:0722)");
...
referenced in the RHSA-2012:0722 advisory.

  - flash-plugin: multiple code execution flaws (APSB12-14) (CVE-2012-2034, CVE-2012-2035, CVE-2012-2036,
    CVE-2012-2037, CVE-2012-2039)

  - flash-plugin: information disclosure flaw (APSB12-14) (CVE-2012-2038)
...
number.");
  ...
  # https://access.redhat.com/security/data/csaf/v2/advisories/2012/rhsa-2012_0722.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9a0c686a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2012:0722");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#critical");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=830310");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=830311");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL flash-plugin package based on the guidance in RHSA-2012:0722.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:H/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:N/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:H/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2012-2039");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2012-2038");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'flash-plugin-10.3.183.20-1.el5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'flash-plugin-10.3.183.20-1.el6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
