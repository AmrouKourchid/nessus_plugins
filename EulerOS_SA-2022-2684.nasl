...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : harfbuzz (EulerOS-SA-2022-2684)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the harfbuzz packages installed, the EulerOS installation on the remote host is affected by
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2684
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?81bb292a");
...
"Update the affected harfbuzz packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:harfbuzz-help");
...
var pkgs = [
  "harfbuzz-2.8.1-1.h2.eulerosv2r10",
  "harfbuzz-devel-2.8.1-1.h2.eulerosv2r10",
  "harfbuzz-help-2.8.1-1.h2.eulerosv2r10"
];
