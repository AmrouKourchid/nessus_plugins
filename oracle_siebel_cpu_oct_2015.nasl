...
if (description)
{
  ...
  script_cve_id("CVE-2015-4841");

  script_name(english:"Oracle Siebel CRM (October 2015 CPU)");
...
October 2015 CPU advisory.

  - Vulnerability in the Siebel Core - Server Framework component of Oracle Siebel CRM (subcomponent:
    Services). Supported versions that are affected are IP2014 PS10 and IP2015 PS5. Difficult to exploit
    vulnerability allows successful unauthenticated network attacks via HTTP. Successful attack of this
    vulnerability can result in unauthorized read access to a subset of Siebel Core - Server Framework
    accessible data. (CVE-2015-4841)
...
"Apply the appropriate patch according to the October 2015 Oracle Critical Patch Update advisory.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-4841");
...
var constraints = [
  { 'min_version' : '8.1.1.14', 'fixed_version' : '8.1.1.14.10'},
  { 'min_version' : '8.1.1.15', 'fixed_version' : '8.1.1.15.5'},
  { 'min_version' : '8.2.2.14', 'fixed_version' : '8.2.2.14.10'},
  { 'min_version' : '8.2.2.15', 'fixed_version' : '8.2.2.15.5'},
