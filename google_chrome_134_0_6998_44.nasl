...
# This plugin has been deprecated because the OS is not affected
##
...
if (description)
{
  ...
  script_name(english:"Google Chrome < 134.0.6998.44 Multiple Vulnerabilities (deprecated)");

  script_set_attribute(attribute:"synopsis", value: "This plugin has been deprecated because the OS is not affected");
...
exit(0, "This plugin has been deprecated because the OS is not affected");
