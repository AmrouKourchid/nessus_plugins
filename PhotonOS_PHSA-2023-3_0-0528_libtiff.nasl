...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Libtiff PHSA-2023-3.0-0528");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libtiff-4.5.0-2.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libtiff-devel-4.5.0-2.ph3')) flag++;
