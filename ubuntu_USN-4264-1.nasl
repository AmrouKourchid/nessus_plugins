...
# extracted from Ubuntu Security Notice USN-4264-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"4264-1");

  script_name(english:"Ubuntu 18.04 LTS : Django vulnerability (USN-4264-1)");
...
USN-4264-1 advisory.
    ...
    Simon Charette discovered that Django incorrectly handled input in the PostgreSQL module. A remote
    attacker could possibly use this to perform SQL injection attacks.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4264-1");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'python-django', 'pkgver': '1:1.11.11-1ubuntu1.7'},
    {'osver': '18.04', 'pkgname': 'python-django-common', 'pkgver': '1:1.11.11-1ubuntu1.7'},
    {'osver': '18.04', 'pkgname': 'python3-django', 'pkgver': '1:1.11.11-1ubuntu1.7'}
];
