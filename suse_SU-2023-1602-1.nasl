...
# SUSE update advisory SUSE-SU-2023:1602-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:1602-1");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2023/04/20");

  script_name(english:"SUSE SLES12 Security Update : kernel (Live Patch 34 for SLE 12 SP5) (SUSE-SU-2023:1602-1)");
...
the SUSE-SU-2023:1602-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-March/014199.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cbeac5f4");
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-122.130-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_12_14-122_130-default-8-2.3', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.5']}
        ]
      }
    }
  }
