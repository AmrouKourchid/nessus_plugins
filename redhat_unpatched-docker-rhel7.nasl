...
# extracted from Red Hat Security Advisory docker. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : docker (Unpatched Vulnerability) (deprecated)");
...
"This plugin has been deprecated as it does not adhere to established standards for this style of check.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2021-41092");
