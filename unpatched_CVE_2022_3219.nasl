...
if (description)
{
  ...
  script_cve_id("CVE-2022-3219");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-3219");
...
patch available.
  ...
  - GnuPG can be made to spin on a relatively small input by (for example) crafting a public key with
    thousands of signatures attached, compressed down to just a few KB. (CVE-2022-3219)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-3219");
