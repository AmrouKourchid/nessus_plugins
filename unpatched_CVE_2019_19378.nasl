...
if (description)
{
  ...
  script_cve_id("CVE-2019-19378");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2019-19378");
...
patch available.
  ...
  - In the Linux kernel 5.0.21, mounting a crafted btrfs filesystem image can lead to slab-out-of-bounds write
    access in index_rbio_pages in fs/btrfs/raid56.c. (CVE-2019-19378)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-19378");
