...
# extracted from Fedora Security Advisory FEDORA-2023-b6612f3819
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-b6612f3819");

  script_name(english:"Fedora 39 : java-17-openjdk (2023-b6612f3819)");
...
FEDORA-2023-b6612f3819 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-b6612f3819");
...
var pkgs = [
    {'reference':'java-17-openjdk-17.0.9.0.9-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
