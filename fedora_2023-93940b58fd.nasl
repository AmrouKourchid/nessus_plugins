...
# extracted from Fedora Security Advisory FEDORA-2023-93940b58fd
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-93940b58fd");

  script_name(english:"Fedora 39 : xorg-x11-server-Xwayland (2023-93940b58fd)");
...
FEDORA-2023-93940b58fd advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-93940b58fd");
...
var pkgs = [
    {'reference':'xorg-x11-server-Xwayland-23.2.3-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
