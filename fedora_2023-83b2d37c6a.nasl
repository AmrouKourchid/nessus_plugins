...
# extracted from Fedora Security Advisory FEDORA-2023-83b2d37c6a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-83b2d37c6a");

  script_name(english:"Fedora 37 : xorg-x11-server-Xwayland (2023-83b2d37c6a)");
...
FEDORA-2023-83b2d37c6a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-83b2d37c6a");
...
var pkgs = [
    {'reference':'xorg-x11-server-Xwayland-22.1.8-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
