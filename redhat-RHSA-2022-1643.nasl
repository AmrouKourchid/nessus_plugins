...
# extracted from Red Hat Security Advisory RHSA-2022:1643. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:1643");

  script_name(english:"RHEL 8 : xmlrpc-c (RHSA-2022:1643)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for xmlrpc-c.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2022:1643 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_1643.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?22a0d51e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2056366");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:1643");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL xmlrpc-c package based on the guidance in RHSA-2022:1643.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'xmlrpc-c-1.51.0-5.el8_5.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xmlrpc-c-c++-1.51.0-5.el8_5.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xmlrpc-c-client++-1.51.0-5.el8_5.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xmlrpc-c-client-1.51.0-5.el8_5.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xmlrpc-c-devel-1.51.0-5.el8_5.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
