...
# extracted from Red Hat Security Advisory RHSA-2020:3046. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_3046.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?68fb3d12");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:3046");
...
"Update the RHEL thunderbird package based on the guidance in RHSA-2020:3046.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'thunderbird-68.10.0-1.el8_0', 'sp':'0', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'thunderbird-68.10.0-1.el8_0', 'sp':'0', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
