...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : cairo (EulerOS-SA-2021-1769)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1769
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a3cc691c");
...
pkgs = ["cairo-1.14.2-1.h6",
        "cairo-devel-1.14.2-1.h6",
        "cairo-gobject-1.14.2-1.h6",
        "cairo-gobject-devel-1.14.2-1.h6"];
