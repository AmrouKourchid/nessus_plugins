...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2018-2812");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'mysql-5.7.22-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'mysql-debuginfo-5.7.22-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'mysql-devel-5.7.22-1.ph2')) flag++;
