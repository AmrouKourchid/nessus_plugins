...
# SUSE update advisory SUSE-SU-2023:2979-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:2979-1");

  script_name(english:"openSUSE 15 Security Update : mysql-connector-java (SUSE-SU-2023:2979-1)");
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-July/015640.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?00f5b997");
...
var pkgs = [
    {'reference':'mysql-connector-java-8.0.33-150200.3.18.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.4']},
    {'reference':'mysql-connector-java-8.0.33-150200.3.18.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.5']}
];
