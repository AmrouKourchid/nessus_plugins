...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 ESM / 18.04 LTS : Linux kernel vulnerabilities (USN-5319-1)");
...
referenced in the USN-5319-1 advisory.
    ...
    attacker could potentially use this to expose sensitive information.
...
var kernel_mappings = {
  ...
  '18.04': {
    '4.15.0': {
      'generic': '4.15.0-171',
      'generic-lpae': '4.15.0-171',
      'lowlatency': '4.15.0-171',
      'dell300x': '4.15.0-1037',
      'oracle': '4.15.0-1089',
      'raspi2': '4.15.0-1105',
      'kvm': '4.15.0-1109',
      'gcp': '4.15.0-1118',
      'snapdragon': '4.15.0-1122',
      'aws': '4.15.0-1123',
      'azure': '4.15.0-1133'
    }
  }
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-5319-1');
}
