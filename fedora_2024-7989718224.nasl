...
# extracted from Fedora Security Advisory FEDORA-2024-7989718224
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-7989718224");
  script_xref(name:"IAVB", value:"2024-B-0058-S");

  script_name(english:"Fedora 39 : libreoffice (2024-7989718224)");
...
FEDORA-2024-7989718224 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-7989718224");
...
var pkgs = [
    {'reference':'libreoffice-7.6.7.2-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
