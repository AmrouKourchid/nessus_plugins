...
# extracted from Fedora Security Advisory FEDORA-2024-c46536abe6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-c46536abe6");

  script_name(english:"Fedora 39 : syncthing (2024-c46536abe6)");
...
FEDORA-2024-c46536abe6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-c46536abe6");
...
var pkgs = [
    {'reference':'syncthing-1.27.3-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
