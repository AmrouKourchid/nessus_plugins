...
# extracted from Oracle Linux Security Advisory ELSA-2009-1278.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : lftp (ELSA-2009-1278)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2009-1278.html");
