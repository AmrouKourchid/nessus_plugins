...
# extracted from Fedora Security Advisory FEDORA-2023-e075ac32be
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-e075ac32be");

  script_name(english:"Fedora 39 : gnutls (2023-e075ac32be)");
...
FEDORA-2023-e075ac32be advisory.

    New upstream release with a fix for [GNUTLS-SA-2023-10-23](https://www.gnutls.org/security-
    new.html#GNUTLS-SA-2023-10-23).

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-e075ac32be");
...
var pkgs = [
    {'reference':'gnutls-3.8.2-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
