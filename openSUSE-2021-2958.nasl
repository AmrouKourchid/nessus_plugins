...
# openSUSE Security Update openSUSE-SU-2021:2958-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : xerces-c (openSUSE-SU-2021:2958-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote SUSE Linux SUSE15 host has packages installed that are affected by a vulnerability as referenced in the
openSUSE-SU-2021:2958-1 advisory.
...
number.");
  ...
  # https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/BGBVRVIJEOW5LG3NVS52NA3VNX37UM7D/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c061addc");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2018-1311");
  script_set_attribute(attribute:"solution", value:
"Update the affected libxerces-c-3_1 and / or libxerces-c-3_1-32bit packages.");
...
var pkgs = [
    {'reference':'libxerces-c-3_1-3.1.4-10.3.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libxerces-c-3_1-32bit-3.1.4-10.3.1', 'cpu':'x86_64', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libxerces-c-3_1 / libxerces-c-3_1-32bit');
}
