...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Docker PHSA-2021-4.0-0007");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'docker-19.03.15-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'docker-cli-19.03.15-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'docker-doc-19.03.15-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'docker-engine-19.03.15-1.ph4')) flag++;
