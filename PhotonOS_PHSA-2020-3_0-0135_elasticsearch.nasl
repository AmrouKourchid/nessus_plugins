...
# extracted from VMware Security Advisory PHSA-2020-3.0-0135. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Elasticsearch PHSA-2020-3.0-0135");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the elasticsearch package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-3.0-135.md");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'elasticsearch-6.8.12-1.ph3')) flag++;
