...
# Oracle Linux Security Advisory ELSA-2010-0166 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : gnutls (ELSA-2010-0166)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2010-0166.html");
