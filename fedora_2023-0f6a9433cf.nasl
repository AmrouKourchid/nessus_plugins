...
# extracted from Fedora Security Advisory FEDORA-2023-0f6a9433cf
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-0f6a9433cf");

  script_name(english:"Fedora 37 : vim (2023-0f6a9433cf)");
...
FEDORA-2023-0f6a9433cf advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-0f6a9433cf");
...
var pkgs = [
    {'reference':'vim-9.0.1160-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
