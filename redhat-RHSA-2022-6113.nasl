...
# extracted from Red Hat Security Advisory RHSA-2022:6113. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:6113");

  script_name(english:"RHEL 8 : Red Hat Application Interconnect 1.0 Release (rpms) (Important) (RHSA-2022:6113)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has a package installed that is affected by multiple vulnerabilities as
referenced in the RHSA-2022:6113 advisory.

    This release addresses several security issues in the underlying golang compiler by moving to golang
    version 1.17.12.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0fd57b07");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_6113.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7b64e0ea");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:6113");
  script_set_attribute(attribute:"solution", value:
"Update the affected skupper-cli package.");
...
var constraints = [
  {
    'repo_relative_urls': [
      'content/dist/layered/rhel8/x86_64/rhai/1/debug',
      'content/dist/layered/rhel8/x86_64/rhai/1/os',
      'content/dist/layered/rhel8/x86_64/rhai/1/source/SRPMS'
    ],
    'pkgs': [
      {'reference':'skupper-cli-1.0.2-2.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
