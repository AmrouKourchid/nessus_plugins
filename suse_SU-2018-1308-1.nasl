...
# extracted from SUSE update advisory SUSE-SU-2018:1308-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES11 Security Update : kvm (SUSE-SU-2018:1308-1) (Spectre)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"This update for kvm fixes the following issues: This update has the
next round of Spectre v2 related patches, which now integrates with
...
without introducing additional issues.");
  ...
  # https://www.suse.com/support/update/announcement/2018/suse-su-20181308-1/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bf9e6578");
...
flag = 0;
if (rpm_check(release:"SLES11", sp:"3", reference:"kvm-1.4.2-53.17.1")) flag++;
