...
# extracted from Ubuntu Security Notice USN-3089-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"3089-1");

  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS : Django vulnerability (USN-3089-1)");
...
in the USN-3089-1 advisory.

    Sergey Bobrov discovered that Django incorrectly parsed cookies when being used with Google Analytics. A
    remote attacker could possibly use this issue to set arbitrary cookies leading to a CSRF protection
    bypass.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3089-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'python-django', 'pkgver': '1.6.1-2ubuntu0.15'},
    {'osver': '16.04', 'pkgname': 'python-django', 'pkgver': '1.8.7-1ubuntu5.2'},
    {'osver': '16.04', 'pkgname': 'python-django-common', 'pkgver': '1.8.7-1ubuntu5.2'},
    {'osver': '16.04', 'pkgname': 'python3-django', 'pkgver': '1.8.7-1ubuntu5.2'}
];
