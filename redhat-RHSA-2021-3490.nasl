...
# extracted from Red Hat Security Advisory RHSA-2021:3490. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2021-3281", "CVE-2021-33203", "CVE-2021-33571");
  script_xref(name:"RHSA", value:"2021:3490");

  script_name(english:"RHEL 8 : Red Hat OpenStack Platform 16.2 (python-django20) (RHSA-2021:3490)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for Red Hat OpenStack Platform 16.2 (python-django20).");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has a package installed that is affected by multiple vulnerabilities as
referenced in the RHSA-2021:3490 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_3490.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c64dbb6c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:3490");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1919969");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1937284");
...
"Update the RHEL Red Hat OpenStack Platform 16.2 (python-django20) package based on the guidance in RHSA-2021:3490.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:python-django20");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-django20-2.0.13-16.el8ost.1', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python3-django20');
}
