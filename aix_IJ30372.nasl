...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 5 : lpd (IJ30372)");
  script_summary(english:"Check for APAR IJ30372");
...
if (aix_check_ifix(release:"7.1", ml:"05", sp:"06", patch:"IJ30372s5a", package:"bos.rte.printers", minfilesetver:"7.1.5.0", maxfilesetver:"7.1.5.32") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"05", sp:"07", patch:"IJ30372s5a", package:"bos.rte.printers", minfilesetver:"7.1.5.0", maxfilesetver:"7.1.5.32") < 0) flag++;
