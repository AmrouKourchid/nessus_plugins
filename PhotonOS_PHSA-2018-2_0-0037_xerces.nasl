...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Xerces PHSA-2018-2.0-0037");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'xerces-c-3.2.1-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'xerces-c-debuginfo-3.2.1-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'xerces-c-devel-3.2.1-1.ph2')) flag++;
