...
# SUSE update advisory SUSE-SU-2022:2446-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:2446-1");

  script_name(english:"SUSE SLES12 Security Update : kernel (Live Patch 22 for SLE 12 SP4) (SUSE-SU-2022:2446-1)");
...
the SUSE-SU-2022:2446-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-July/011600.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0309e3b8");
...
var pkgs = [
    {'reference':'kgraft-patch-4_12_14-95_80-default-16-2.3', 'sp':'4', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.4']}
];
