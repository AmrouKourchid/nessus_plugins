...
# extracted from Red Hat Security Advisory RHSA-2022:5234. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:5234");

  script_name(english:"RHEL 7 : python-virtualenv (RHSA-2022:5234)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for python-virtualenv.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_5234.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?17b9b8e0");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:5234");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1868135");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-virtualenv package based on the guidance in RHSA-2022:5234.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python-virtualenv-15.1.0-7.el7_9', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
