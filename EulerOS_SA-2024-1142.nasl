...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : harfbuzz (EulerOS-SA-2024-1142)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1142
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?21f81eba");
...
var pkgs = [
  "harfbuzz-1.3.2-1.h1.eulerosv2r7",
  "harfbuzz-devel-1.3.2-1.h1.eulerosv2r7",
  "harfbuzz-icu-1.3.2-1.h1.eulerosv2r7"
];
