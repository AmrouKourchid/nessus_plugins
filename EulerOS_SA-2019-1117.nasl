...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : libpng (EulerOS-SA-2019-1117)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1117
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6017d9eb");
...
pkgs = ["libpng-1.5.13-7.h5",
        "libpng-devel-1.5.13-7.h5"];
