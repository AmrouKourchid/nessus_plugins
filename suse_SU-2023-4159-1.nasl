...
# SUSE update advisory SUSE-SU-2023:4159-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:4159-1");

  script_name(english:"SUSE SLES12 Security Update : suse-module-tools (SUSE-SU-2023:4159-1)");
...
referenced in the SUSE-SU-2023:4159-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1187196");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-October/016807.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f23183a9");
...
var pkgs = [
    {'reference':'suse-module-tools-12.13-3.11.1', 'sp':'5', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5']},
    {'reference':'suse-module-tools-12.13-3.11.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.5']}
];
