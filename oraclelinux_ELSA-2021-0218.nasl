...
# extracted from Oracle Linux Security Advisory ELSA-2021-0218.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : sudo (ELSA-2021-0218)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2021-0218.html");
...
var pkgs = [
    {'reference':'sudo-1.8.29-6.el8_3.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sudo-1.8.29-6.el8_3.1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
