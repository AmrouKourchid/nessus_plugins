...
# extracted from VMware Security Advisory PHSA-2021-3.0-0266. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Python PHSA-2021-3.0-0266");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the python package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-3.0-266.md");
...
if (rpm_check(release:'PhotonOS-3.0', reference:'python-urllib3-1.25.11-2.ph3')) flag++;
