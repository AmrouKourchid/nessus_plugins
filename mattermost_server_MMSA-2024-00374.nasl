...
if (description)
{
  ...
  script_cve_id("CVE-2024-8071");
  script_xref(name:"IAVA", value:"2024-A-0677-S");

  script_name(english:"Mattermost Server 9.5.x < 9.5.8 / 9.8.x < 9.8.3 / 9.9.x < 9.9.2 / 9.10.x < 9.10.1 (MMSA-2024-00374)");
...
therefore, affected by a vulnerability as referenced in the MMSA-2024-00374 advisory.

  - Mattermost versions 9.9.x <= 9.9.1, 9.5.x <= 9.5.7, 9.10.x <= 9.10.0 and 9.8.x <= 9.8.2 fail to restrict
    which roles can promote a user as system admin which allows a System Role with edit access to the
    permissions section of system console to update their role (e.g. member) to include the `manage_system`
    permission, effectively becoming a System Admin. (CVE-2024-8071)
...
"Upgrade to Mattermost Server version 9.5.8 / 9.8.3 / 9.9.2 / 9.10.1 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-8071");
