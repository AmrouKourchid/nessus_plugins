...
# extracted from Fedora Security Advisory FEDORA-2022-d7ee33d4ad
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-d7ee33d4ad");

  script_name(english:"Fedora 37 : curl (2022-d7ee33d4ad)");
...
FEDORA-2022-d7ee33d4ad advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-d7ee33d4ad");
...
var pkgs = [
    {'reference':'curl-7.85.0-5.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
