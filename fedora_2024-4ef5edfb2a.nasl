...
# extracted from Fedora Security Advisory FEDORA-2024-4ef5edfb2a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-4ef5edfb2a");

  script_name(english:"Fedora 39 : iwd (2024-4ef5edfb2a)");
...
FEDORA-2024-4ef5edfb2a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-4ef5edfb2a");
  script_set_attribute(attribute:"solution", value:
"Update the affected iwd package.");
...
var pkgs = [
    {'reference':'iwd-2.16-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
