...
if (description)
{
  ...
  script_name(english:"Apache Tomcat 7.0.0 < 7.0.21");

  script_set_attribute(attribute:"synopsis", value:
"The remote Apache Tomcat server is affected by a vulnerability");
  script_set_attribute(attribute:"description", value:
"The version of Tomcat installed on the remote host is prior to 7.0.21. It is, therefore, affected by a vulnerability as
referenced in the fixed_in_apache_tomcat_7.0.21_security-7 advisory.
  ...
  - Certain AJP protocol connector implementations in Apache Tomcat 7.0.0 through 7.0.20, 6.0.0 through
    ...
    body as a new request. (CVE-2011-3190)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://svn.apache.org/viewvc?view=rev&rev=1162958");
  script_set_attribute(attribute:"see_also", value:"https://tomcat.apache.org/connectors-doc/reference/workers.html");
  script_set_attribute(attribute:"see_also", value:"https://tomcat.apache.org/tomcat-7.0-doc/config/ajp.html");
  # https://tomcat.apache.org/security-7.html#Fixed_in_Apache_Tomcat_7.0.21
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c91c2811");
...
var constraints = [
  { 'min_version' : '7.0.0', 'max_version' : '7.0.20', 'fixed_version' : '7.0.21' }
];
