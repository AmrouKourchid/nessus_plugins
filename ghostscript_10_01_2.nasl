...
if (description)
{
  ...
  script_name(english:"Artifex Ghostscript < 10.01.2 Security Bypass");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host contains a library that is affected by a security bypass vulnerability.");
  script_set_attribute(attribute:"description", value:
"An authentication bypass vulnerability exists in Artifex Ghostscript prior to 10.01.2 due to mishandling permission validation
for pipe devices (with the %pipe% prefix or the | pipe character prefix) An unauthenticated, remote attacker can exploit this,
to bypass authentication.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.ghostscript.com/");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Artifex Ghostscript 10.01.2 or later.");
...
var constraints = [{'fixed_version' : '10.01.2'}];
