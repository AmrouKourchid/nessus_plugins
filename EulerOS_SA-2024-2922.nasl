...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP12 : jbig2dec (EulerOS-SA-2024-2922)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2922
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?190f6a68");
...
var pkgs = [
  "jbig2dec-0.19-4.h1.eulerosv2r12",
  "jbig2dec-help-0.19-4.h1.eulerosv2r12"
];
