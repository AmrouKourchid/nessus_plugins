...
# extracted from Red Hat Security Advisory stb_image. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2021-37789");

  script_name(english:"RHEL 7 : stb_image (Unpatched Vulnerability) (deprecated)");
...
"This plugin has been deprecated as it does not adhere to established standards for this style of check.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-37789");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:compat-cogl114");
