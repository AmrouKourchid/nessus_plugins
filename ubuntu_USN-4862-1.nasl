...
# extracted from Ubuntu Security Notice USN-4862-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"4862-1");

  script_name(english:"Ubuntu 18.04 ESM : Neovim vulnerability (USN-4862-1)");
...
USN-4862-1 advisory.
    ...
    It was discovered that Neovim incorrectly handled certain files. An attacker could possibly use this issue
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4862-1");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'neovim', 'pkgver': '0.2.2-3ubuntu0.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'neovim-runtime', 'pkgver': '0.2.2-3ubuntu0.1~esm1', 'ubuntu_pro': TRUE}
];
