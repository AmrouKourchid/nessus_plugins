...
# extracted from Red Hat Security Advisory RHSA-2021:1566. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:1566");

  script_name(english:"RHEL 7 / 8 : OpenShift Container Platform 4.6.30 (RHSA-2021:1566)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for OpenShift Container Platform 4.6.30.");
...
in the RHSA-2021:1566 advisory.

    Red Hat OpenShift Container Platform is Red Hat's cloud computing
    Kubernetes application platform solution designed for on-premise or private
    cloud deployments.

    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.6.30. See the following
    ...
    * runc: vulnerable to symlink exchange attack (CVE-2021-30465)
    ...
    channel. To check for available updates, use the OpenShift Console or the CLI oc command. Instructions for
    upgrading a cluster are available at
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_1566.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b567a2c7");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:1566");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1954736");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1961019");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.6.30 packages based on the guidance in RHSA-2021:1566.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openshift-hyperkube-4.6.0-202105150940.p0.git.9caf8fe.el8', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'openshift-hyperkube-4.6.0-202105150940.p0.git.9caf8fe.el8', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'openshift-hyperkube-4.6.0-202105150940.p0.git.9caf8fe.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'runc-1.0.0-87.rhaos4.6.git23384e2.el8', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'runc-1.0.0-87.rhaos4.6.git23384e2.el8', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'runc-1.0.0-87.rhaos4.6.git23384e2.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'openshift-hyperkube-4.6.0-202105150940.p0.git.9caf8fe.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'runc-1.0.0-87.rhaos4.6.git23384e2.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
