...
# extracted from Red Hat Security Advisory RHSA-2024:2548. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2548");

  script_name(english:"RHEL 9 : podman (RHSA-2024:2548)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for podman.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:2548 advisory.
    ...
    * podman: golang-protobuf: encoding/protojson, internal/encoding/json: infinite loop in
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2548.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3ae46519");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2548");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-14922");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-28629");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-28636");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-30886");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL podman package based on the guidance in RHSA-2024:2548.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'podman-4.9.4-3.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
      {'reference':'podman-docker-4.9.4-3.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
      {'reference':'podman-plugins-4.9.4-3.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
      {'reference':'podman-remote-4.9.4-3.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
      {'reference':'podman-tests-4.9.4-3.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'podman-4.9.4-3.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
      {'reference':'podman-docker-4.9.4-3.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
      {'reference':'podman-plugins-4.9.4-3.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
      {'reference':'podman-remote-4.9.4-3.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
      {'reference':'podman-tests-4.9.4-3.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'}
    ]
  }
];
