...
# extracted from Red Hat Security Advisory RHSA-2019:2545. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:2545");

  script_name(english:"RHEL 7 : Ansible (RHSA-2019:2545)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8454ae0f");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_2545.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b37af2b7");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:2545");
...
"Update the RHEL Ansible package based on the guidance in RHSA-2019:2545.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ansible-2.6.19-1.el7ae', 'release':'7', 'el_string':'el7ae', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2.6'}
    ]
  }
];
