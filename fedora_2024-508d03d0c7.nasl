...
# extracted from Fedora Security Advisory FEDORA-2024-508d03d0c7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-508d03d0c7");
  script_xref(name:"IAVA", value:"2024-A-0369-S");

  script_name(english:"Fedora 39 : chromium (2024-508d03d0c7)");
...
FEDORA-2024-508d03d0c7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-508d03d0c7");
...
var pkgs = [
    {'reference':'chromium-126.0.6478.126-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
