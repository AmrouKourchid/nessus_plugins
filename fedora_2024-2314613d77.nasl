...
# extracted from Fedora Security Advisory FEDORA-2024-2314613d77
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-2314613d77");

  script_name(english:"Fedora 40 : libmodsecurity (2024-2314613d77)");
...
FEDORA-2024-2314613d77 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-2314613d77");
  script_set_attribute(attribute:"solution", value:
"Update the affected libmodsecurity package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:libmodsecurity");
...
var pkgs = [
    {'reference':'libmodsecurity-3.0.12-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libmodsecurity');
}
