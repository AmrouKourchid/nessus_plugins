...
# extracted from Fedora Security Advisory FEDORA-2022-6744980220
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-6744980220");

  script_name(english:"Fedora 36 : booth (2022-6744980220)");
...
FEDORA-2022-6744980220 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-6744980220");
...
var pkgs = [
    {'reference':'booth-1.0-262.3.d0ac26c.git.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
