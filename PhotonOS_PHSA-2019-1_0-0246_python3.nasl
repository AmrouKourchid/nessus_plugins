...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Python3 PHSA-2019-1.0-0246");
...
if (rpm_check(release:"PhotonOS-1.0", reference:"python3-3.5.6-8.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"python3-debuginfo-3.5.6-8.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"python3-devel-3.5.6-8.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"python3-libs-3.5.6-8.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"python3-tools-3.5.6-8.ph1")) flag++;
