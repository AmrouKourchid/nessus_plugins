...
# extracted from Fedora Security Advisory FEDORA-2018-9954b282ec.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-9954b282ec");

  script_name(english:"Fedora 29 : mingw-openjpeg2 / openjpeg2 (2018-9954b282ec)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-9954b282ec");
...
"Update the affected mingw-openjpeg2 and / or openjpeg2 packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-5785");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"mingw-openjpeg2-2.3.0-4.fc29")) flag++;
if (rpm_check(release:"FC29", reference:"openjpeg2-2.3.0-9.fc29")) flag++;
