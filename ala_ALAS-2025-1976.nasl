...
# extracted from Amazon Linux AMI Security Advisory ALAS-2025-1976.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux AMI : freetype (ALAS-2025-1976)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux AMI host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of freetype installed on the remote host is prior to 2.3.11-19.17. It is, therefore, affected by a
vulnerability as referenced in the ALAS-2025-1976 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/ALAS-2025-1976.html");
...
var pkgs = [
    {'reference':'freetype-2.3.11-19.17.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'freetype-2.3.11-19.17.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'freetype-debuginfo-2.3.11-19.17.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'freetype-debuginfo-2.3.11-19.17.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'freetype-demos-2.3.11-19.17.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'freetype-demos-2.3.11-19.17.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'freetype-devel-2.3.11-19.17.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'freetype-devel-2.3.11-19.17.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE}
];
