...
# extracted from Amazon Linux 2 Security Advisory ALAS-2023-2248.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2023-3417", "CVE-2023-4056", "CVE-2023-4584");
  script_xref(name:"IAVA", value:"2023-A-0379-S");
  script_xref(name:"IAVA", value:"2023-A-0449-S");

  script_name(english:"Amazon Linux 2 : thunderbird (ALAS-2023-2248)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of thunderbird installed on the remote host is prior to 102.15.0-1. It is, therefore, affected by multiple
vulnerabilities as referenced in the ALAS2-2023-2248 advisory.
    ...
    Thunderbird < 115.0.1. (CVE-2023-3417)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2023-2248.html");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/cve/html/CVE-2023-3417.html");
...
"Run 'yum update thunderbird' to update your system.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2023-4056");
...
var pkgs = [
    {'reference':'thunderbird-102.15.0-1.amzn2.0.1', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'thunderbird-102.15.0-1.amzn2.0.1', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'thunderbird-debuginfo-102.15.0-1.amzn2.0.1', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'thunderbird-debuginfo-102.15.0-1.amzn2.0.1', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
