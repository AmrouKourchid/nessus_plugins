...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : openssl (EulerOS-SA-2024-1660)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1660
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?029888e6");
...
var pkgs = [
  "openssl-1.0.2k-16.h29.eulerosv2r7",
  "openssl-devel-1.0.2k-16.h29.eulerosv2r7",
  "openssl-libs-1.0.2k-16.h29.eulerosv2r7"
];
