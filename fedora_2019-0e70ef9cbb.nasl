...
# extracted from Fedora Security Advisory FEDORA-2019-0e70ef9cbb.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-0e70ef9cbb");

  script_name(english:"Fedora 30 : znc (2019-0e70ef9cbb)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-0e70ef9cbb");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"znc-1.7.5-1.fc30")) flag++;
