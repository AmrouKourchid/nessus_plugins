...
"The version of Firefox installed on the remote macOS or Mac OS X host is prior to 136.0.4. It is, therefore, affected by
a vulnerability as referenced in the mfsa2025-19 advisory.
...
mozilla_check_version(version:version, path:path, product:'firefox', esr:FALSE, fix:'136.0.4', severity:SECURITY_HOLE);
