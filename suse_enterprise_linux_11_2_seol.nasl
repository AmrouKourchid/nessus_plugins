...
if (description)
{
  ...
  script_name(english:"SUSE Enterprise Linux SEoL (11.2.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of SUSE Enterprise Linux is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, SUSE Enterprise Linux is 11.2.x. It is, therefore, no longer maintained by its vendor or
provider.
...
"Upgrade to a version of SUSE Enterprise Linux that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2014/01/31");
...
var constraints = [
  { max_branch : '11.2', min_branch : '11.2', seol : 20140131, eseol : 20170130 }
];
