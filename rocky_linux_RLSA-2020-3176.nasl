...
# Rocky Linux Security Advisory RLSA-2020:3176.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2020:3176");

  script_name(english:"Rocky Linux 8 : postgresql-jdbc (RLSA-2020:3176)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Rocky Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Rocky Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
RLSA-2020:3176 advisory.

  - PostgreSQL JDBC Driver (aka PgJDBC) before 42.2.13 allows XXE. (CVE-2020-13692)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2020:3176");
