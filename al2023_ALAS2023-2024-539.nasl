...
"It is, therefore, affected by a vulnerability as referenced in the ALAS2023-2024-539 advisory.
    ...
    A reset can also be done on these files by the following:```shrm vendor/composer/installed.php
    vendor/composer/InstalledVersions.phpcomposer install --no-scripts --no-plugins``` (CVE-2024-24821)
