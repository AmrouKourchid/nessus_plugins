...
# extracted from Ubuntu Security Notice USN-4575-1. The text
...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS : dom4j vulnerability (USN-4575-1)");
...
USN-4575-1 advisory.
    ...
    It was discovered that dom4j incorrectly handled reading XML data. A remote attacker could exploit this
    with a crafted XML file to expose sensitive data or possibly execute arbitrary code. (CVE-2020-10683)

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4575-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libdom4j-java', 'pkgver': '1.6.1+dfsg.3-2ubuntu1.1'}
];
