...
# extracted from Red Hat Security Advisory spice. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2020-14355", "CVE-2020-23793", "CVE-2021-20201");

  script_name(english:"RHEL 6 : spice (Unpatched Vulnerability) (deprecated)");
...
"This plugin has been deprecated as it does not adhere to established standards for this style of check.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:spice-client");
