...
# extracted from Debian Security Advisory dla-4066. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-4066 : fort-validator - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-45234");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-45235");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-45236");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-45237");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-45238");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-45239");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-48943");
...
"Upgrade the fort-validator packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-45237");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'fort-validator', 'reference': '1.5.3-1~deb11u2'}
];
