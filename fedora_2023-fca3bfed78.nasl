...
# extracted from Fedora Security Advisory FEDORA-2023-fca3bfed78
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-fca3bfed78");

  script_name(english:"Fedora 37 : libldb / samba (2023-fca3bfed78)");
...
FEDORA-2023-fca3bfed78 advisory.

    Update to ldb 2.6.2 and samba 4.17.7
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-fca3bfed78");
...
var pkgs = [
    {'reference':'libldb-2.6.2-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'samba-4.17.7-0.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
