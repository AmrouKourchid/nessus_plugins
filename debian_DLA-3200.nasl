...
# extracted from Debian Security Advisory dla-3200. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3200 : graphicsmagick - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3200
advisory.

    - -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3200-1                debian-lts@lists.debian.org
    https://www.debian.org/lts/security/                    Thorsten Alteholz
    November 21, 2022                             https://wiki.debian.org/LTS
    - -------------------------------------------------------------------------

    Package        : graphicsmagick
    Version        : 1.4+really1.3.35-1~deb10u3
    CVE ID         : CVE-2022-1270


    An issue has been found in graphicsmagick, a collection of image
    processing tools.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/graphicsmagick");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'graphicsmagick', 'reference': '1.4+really1.3.35-1~deb10u3'},
    {'release': '10.0', 'prefix': 'graphicsmagick-dbg', 'reference': '1.4+really1.3.35-1~deb10u3'},
    {'release': '10.0', 'prefix': 'graphicsmagick-imagemagick-compat', 'reference': '1.4+really1.3.35-1~deb10u3'},
    {'release': '10.0', 'prefix': 'graphicsmagick-libmagick-dev-compat', 'reference': '1.4+really1.3.35-1~deb10u3'},
    {'release': '10.0', 'prefix': 'libgraphics-magick-perl', 'reference': '1.4+really1.3.35-1~deb10u3'},
    {'release': '10.0', 'prefix': 'libgraphicsmagick++-q16-12', 'reference': '1.4+really1.3.35-1~deb10u3'},
    {'release': '10.0', 'prefix': 'libgraphicsmagick++1-dev', 'reference': '1.4+really1.3.35-1~deb10u3'},
    {'release': '10.0', 'prefix': 'libgraphicsmagick-q16-3', 'reference': '1.4+really1.3.35-1~deb10u3'},
    {'release': '10.0', 'prefix': 'libgraphicsmagick1-dev', 'reference': '1.4+really1.3.35-1~deb10u3'}
];
