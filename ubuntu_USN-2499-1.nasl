...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : PostgreSQL vulnerabilities (USN-2499-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 14.04 LTS host has packages installed that are affected by multiple vulnerabilities as referenced in
the USN-2499-1 advisory.

    Stephen Frost discovered that PostgreSQL incorrectly displayed certain values in error messages. An
    authenticated user could gain access to seeing certain values, contrary to expected permissions.
    (CVE-2014-8161)

    Andres Freund, Peter Geoghegan and Noah Misch discovered that PostgreSQL incorrectly handled buffers in
    to_char functions. An authenticated attacker could possibly use this issue to cause PostgreSQL to crash,
    resulting in a denial of service, or possibly execute arbitrary code. (CVE-2015-0241)

    It was discovered that PostgreSQL incorrectly handled memory in the pgcrypto extension. An authenticated
    attacker could possibly use this issue to cause PostgreSQL to crash, resulting in a denial of service, or
    possibly execute arbitrary code. (CVE-2015-0243)

    Emil Lenngren discovered that PostgreSQL incorrectly handled extended protocol message reading. An
    authenticated attacker could possibly use this issue to cause PostgreSQL to crash, resulting in a denial
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2499-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'libecpg-compat3', 'pkgver': '9.3.6-0ubuntu0.14.04'},
    {'osver': '14.04', 'pkgname': 'libecpg-dev', 'pkgver': '9.3.6-0ubuntu0.14.04'},
    {'osver': '14.04', 'pkgname': 'libecpg6', 'pkgver': '9.3.6-0ubuntu0.14.04'},
    {'osver': '14.04', 'pkgname': 'libpgtypes3', 'pkgver': '9.3.6-0ubuntu0.14.04'},
    {'osver': '14.04', 'pkgname': 'libpq-dev', 'pkgver': '9.3.6-0ubuntu0.14.04'},
    {'osver': '14.04', 'pkgname': 'libpq5', 'pkgver': '9.3.6-0ubuntu0.14.04'},
    {'osver': '14.04', 'pkgname': 'postgresql-9.3', 'pkgver': '9.3.6-0ubuntu0.14.04'},
    {'osver': '14.04', 'pkgname': 'postgresql-client-9.3', 'pkgver': '9.3.6-0ubuntu0.14.04'},
    {'osver': '14.04', 'pkgname': 'postgresql-contrib-9.3', 'pkgver': '9.3.6-0ubuntu0.14.04'},
    {'osver': '14.04', 'pkgname': 'postgresql-plperl-9.3', 'pkgver': '9.3.6-0ubuntu0.14.04'},
    {'osver': '14.04', 'pkgname': 'postgresql-plpython-9.3', 'pkgver': '9.3.6-0ubuntu0.14.04'},
    {'osver': '14.04', 'pkgname': 'postgresql-plpython3-9.3', 'pkgver': '9.3.6-0ubuntu0.14.04'},
    {'osver': '14.04', 'pkgname': 'postgresql-pltcl-9.3', 'pkgver': '9.3.6-0ubuntu0.14.04'},
    {'osver': '14.04', 'pkgname': 'postgresql-server-dev-9.3', 'pkgver': '9.3.6-0ubuntu0.14.04'}
];
