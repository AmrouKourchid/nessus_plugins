...
# extracted from Red Hat Security Advisory RHSA-2022:1662. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:1662");

  script_name(english:"RHEL 7 : rh-maven36-maven-shared-utils (RHSA-2022:1662)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for rh-maven36-maven-shared-utils.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2022:1662 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?06fc564e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2066479");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:1662");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rh-maven36-maven-shared-utils package based on the guidance in RHSA-2022:1662.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rh-maven36-maven-shared-utils");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rh-maven36-maven-shared-utils-javadoc");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-maven36-maven-shared-utils-3.2.1-0.2.3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-maven36-maven-shared-utils-javadoc-3.2.1-0.2.3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'rh-maven36-maven-shared-utils / etc');
}
