...
# extracted from Fedora Security Advisory FEDORA-2024-c8a49099c6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-c8a49099c6");

  script_name(english:"Fedora 39 : java-latest-openjdk (2024-c8a49099c6)");
...
FEDORA-2024-c8a49099c6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-c8a49099c6");
...
"Update the affected 1:java-latest-openjdk package.");
  ...
  script_set_attribute(attribute:"vuln_publication_date", value:"2024/01/20");
...
var pkgs = [
    {'reference':'java-latest-openjdk-21.0.2.0.13-1.rolling.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
