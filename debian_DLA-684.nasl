...
# extracted from Debian Security Advisory DLA-684-2. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-684-2 : libx11 regression update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2017/01/msg00016.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/wheezy/libx11");
...
flag = 0;
if (deb_check(release:"7.0", prefix:"libx11-6", reference:"2:1.5.0-1+deb7u4")) flag++;
if (deb_check(release:"7.0", prefix:"libx11-6-dbg", reference:"2:1.5.0-1+deb7u4")) flag++;
if (deb_check(release:"7.0", prefix:"libx11-6-udeb", reference:"2:1.5.0-1+deb7u4")) flag++;
if (deb_check(release:"7.0", prefix:"libx11-data", reference:"2:1.5.0-1+deb7u4")) flag++;
if (deb_check(release:"7.0", prefix:"libx11-dev", reference:"2:1.5.0-1+deb7u4")) flag++;
if (deb_check(release:"7.0", prefix:"libx11-doc", reference:"2:1.5.0-1+deb7u4")) flag++;
if (deb_check(release:"7.0", prefix:"libx11-xcb-dev", reference:"2:1.5.0-1+deb7u4")) flag++;
if (deb_check(release:"7.0", prefix:"libx11-xcb1", reference:"2:1.5.0-1+deb7u4")) flag++;
if (deb_check(release:"7.0", prefix:"libx11-xcb1-dbg", reference:"2:1.5.0-1+deb7u4")) flag++;
