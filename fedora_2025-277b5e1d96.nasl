...
# extracted from Fedora Security Advisory FEDORA-2025-277b5e1d96
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-277b5e1d96");

  script_name(english:"Fedora 41 : openvpn (2025-277b5e1d96)");
...
FEDORA-2025-277b5e1d96 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-277b5e1d96");
...
var pkgs = [
    {'reference':'openvpn-2.6.14-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
