...
# extracted from Amazon Linux 2 Security Advisory ALASNITRO-ENCLAVES-2025-054.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : docker (ALASNITRO-ENCLAVES-2025-054)");
...
as referenced in the ALAS2NITRO-ENCLAVES-2025-054 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALASNITRO-ENCLAVES-2025-054.html");
...
var pkgs = [
    {'reference':'docker-25.0.8-1.amzn2.0.3', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'docker-25.0.8-1.amzn2.0.3', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'docker-debuginfo-25.0.8-1.amzn2.0.3', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'docker-debuginfo-25.0.8-1.amzn2.0.3', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
