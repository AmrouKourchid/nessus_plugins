...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : emacs (EulerOS-SA-2023-3124)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the emacs packages installed, the EulerOS installation on the remote host is affected by
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3124
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?68731c96");
...
var pkgs = [
  "emacs-common-26.1-8.h4.eulerosv2r8",
  "emacs-filesystem-26.1-8.h4.eulerosv2r8",
  "emacs-nox-26.1-8.h4.eulerosv2r8"
];
