...
# extracted from Fedora Security Advisory FEDORA-2023-ddc617c87f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-ddc617c87f");

  script_name(english:"Fedora 37 : mingw-freetype (2023-ddc617c87f)");
...
FEDORA-2023-ddc617c87f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-ddc617c87f");
...
var pkgs = [
    {'reference':'mingw-freetype-2.12.1-4.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
