...
# AlmaLinux Security Advisory ALSA-2025:2679.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2025:2679");
  script_xref(name:"RHSA", value:"2025:2679");

  script_name(english:"AlmaLinux 9 : libxml2 (ALSA-2025:2679)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 9 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ALSA-2025:2679 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2025-2679.html");
...
var pkgs = [
    {'reference':'libxml2-2.9.13-6.el9_5.2', 'release':'9', 'el_string':'el9_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'libxml2-devel-2.9.13-6.el9_5.2', 'release':'9', 'el_string':'el9_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'python3-libxml2-2.9.13-6.el9_5.2', 'release':'9', 'el_string':'el9_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'}
];
