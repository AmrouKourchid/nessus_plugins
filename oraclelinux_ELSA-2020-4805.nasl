...
# extracted from Oracle Linux Security Advisory ELSA-2020-4805.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : edk2 (ELSA-2020-4805)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2020-4805.html");
...
var pkgs = [
    {'reference':'edk2-ovmf-20200602gitca407c7246bf-3.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
