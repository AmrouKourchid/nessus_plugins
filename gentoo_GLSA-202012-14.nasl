...
# extracted from Gentoo Linux Security Advisory GLSA 202012-14.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202012-14");
  script_xref(name:"IAVA", value:"2020-A-0581");
  script_xref(name:"CEA-ID", value:"CEA-2021-0025");

  script_name(english:"GLSA-202012-14 : cURL: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202012-14
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202012-14");
...
if (qpkg_check(package:"net-misc/curl", unaffected:make_list("ge 7.74.0"), vulnerable:make_list("lt 7.74.0"))) flag++;
