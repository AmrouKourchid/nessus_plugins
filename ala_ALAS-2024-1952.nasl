...
# extracted from Amazon Linux AMI Security Advisory ALAS-2024-1952.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux AMI : kernel (ALAS-2024-1952)");
...
vulnerabilities as referenced in the ALAS-2024-1952 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/ALAS-2024-1952.html");
...
"Run 'yum update kernel' to update your system.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2021-46938");
...
if (get_one_kb_item("Host/kpatch/kernel-cves"))
{
  ...
  var cve_list = make_list("CVE-2021-29650", "CVE-2021-33200", "CVE-2021-46938", "CVE-2021-46992", "CVE-2021-47245", "CVE-2021-47280");
  if (hotfix_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, "kpatch hotfix for ALAS-2024-1952");
  }
  else
  {
