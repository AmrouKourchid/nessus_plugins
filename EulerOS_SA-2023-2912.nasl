...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : binutils (EulerOS-SA-2023-2912)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2912
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?39df69d8");
...
"Update the affected binutils packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-25584");
...
var pkgs = [
  "binutils-2.34-4.h20.eulerosv2r10"
];
