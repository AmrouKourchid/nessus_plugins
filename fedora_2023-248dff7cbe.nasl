...
# extracted from Fedora Security Advisory FEDORA-2023-248dff7cbe
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-248dff7cbe");

  script_name(english:"Fedora 39 : cacti / cacti-spine (2023-248dff7cbe)");
...
FEDORA-2023-248dff7cbe advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-248dff7cbe");
...
var pkgs = [
    {'reference':'cacti-1.2.25-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cacti-spine-1.2.25-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
