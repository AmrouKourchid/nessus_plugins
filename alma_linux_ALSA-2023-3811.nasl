...
# AlmaLinux Security Advisory ALSA-2023:3811.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:3811");

  script_name(english:"AlmaLinux 8 : python39:3.9 and python39-devel:3.9 (ALSA-2023:3811)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 8 host has packages installed that are affected by a vulnerability as referenced in the
ALSA-2023:3811 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2023-3811.html");
...
var appstreams = {
    'python39-devel:3.9': [
      {'reference':'python39-3.9.16-1.module_el8.8.0+3577+f4afbb0e.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-3.9.16-1.module_el8.8.0+3577+f4afbb0e.1', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-3.9.16-1.module_el8.8.0+3577+f4afbb0e.1', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-3.9.16-1.module_el8.8.0+3577+f4afbb0e.1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python39-debug-3.9.16-1.module_el8.8.0+3577+f4afbb0e.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-debug-3.9.16-1.module_el8.8.0+3577+f4afbb0e.1', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-debug-3.9.16-1.module_el8.8.0+3577+f4afbb0e.1', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-debug-3.9.16-1.module_el8.8.0+3577+f4afbb0e.1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-devel-3.9.16-1.module_el8.8.0+3577+f4afbb0e.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-devel-3.9.16-1.module_el8.8.0+3577+f4afbb0e.1', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-devel-3.9.16-1.module_el8.8.0+3577+f4afbb0e.1', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-devel-3.9.16-1.module_el8.8.0+3577+f4afbb0e.1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-idle-3.9.16-1.module_el8.8.0+3577+f4afbb0e.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-idle-3.9.16-1.module_el8.8.0+3577+f4afbb0e.1', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-idle-3.9.16-1.module_el8.8.0+3577+f4afbb0e.1', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-idle-3.9.16-1.module_el8.8.0+3577+f4afbb0e.1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python39-libs-3.9.16-1.module_el8.8.0+3577+f4afbb0e.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-libs-3.9.16-1.module_el8.8.0+3577+f4afbb0e.1', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-libs-3.9.16-1.module_el8.8.0+3577+f4afbb0e.1', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-libs-3.9.16-1.module_el8.8.0+3577+f4afbb0e.1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python39-rpm-macros-3.9.16-1.module_el8.8.0+3577+f4afbb0e.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python39-test-3.9.16-1.module_el8.8.0+3577+f4afbb0e.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-test-3.9.16-1.module_el8.8.0+3577+f4afbb0e.1', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-test-3.9.16-1.module_el8.8.0+3577+f4afbb0e.1', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-test-3.9.16-1.module_el8.8.0+3577+f4afbb0e.1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-tkinter-3.9.16-1.module_el8.8.0+3577+f4afbb0e.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-tkinter-3.9.16-1.module_el8.8.0+3577+f4afbb0e.1', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-tkinter-3.9.16-1.module_el8.8.0+3577+f4afbb0e.1', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-tkinter-3.9.16-1.module_el8.8.0+3577+f4afbb0e.1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
