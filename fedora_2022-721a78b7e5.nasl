...
# extracted from Fedora Security Advisory FEDORA-2022-721a78b7e5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-721a78b7e5");

  script_name(english:"Fedora 37 : xorg-x11-server-Xwayland (2022-721a78b7e5)");
...
FEDORA-2022-721a78b7e5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-721a78b7e5");
...
var pkgs = [
    {'reference':'xorg-x11-server-Xwayland-22.1.6-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
