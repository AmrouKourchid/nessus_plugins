...
# extracted from Red Hat Security Advisory RHSA-2023:7090. The text
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_7090.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f041a4a8");
...
"Update the RHEL libmicrohttpd package based on the guidance in RHSA-2023:7090.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libmicrohttpd-0.9.59-3.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'libmicrohttpd-devel-0.9.59-3.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'libmicrohttpd-doc-0.9.59-3.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
