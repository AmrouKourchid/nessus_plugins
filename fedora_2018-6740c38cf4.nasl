...
# extracted from Fedora Security Advisory FEDORA-2018-6740c38cf4.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : 1:gdm (2018-6740c38cf4)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"gdm 3.28.3 release, fixing CVE-2018-14424.

  - CVE-2018-14424 - double free fix

  - lifecycle fixes to libgdm/GdmClient

  - follow up fixes dealing with login screen reaping form
    last release
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-6740c38cf4");
  script_set_attribute(attribute:"solution", value:
"Update the affected 1:gdm package.");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"gdm-3.28.3-1.fc28", epoch:"1")) flag++;
