...
# extracted from Debian Security Advisory dla-4158. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-4158 : fossil - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has a package installed that is affected by a vulnerability as referenced in the dla-4158
advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/fossil");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-24795");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bullseye/fossil");
  script_set_attribute(attribute:"solution", value:
"Upgrade the fossil packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:fossil");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'fossil', 'reference': '1:2.15.2-1+deb11u1'}
];
