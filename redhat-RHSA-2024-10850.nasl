...
# extracted from Red Hat Security Advisory RHSA-2024:10850. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:10850");

  script_name(english:"RHEL 8 : ruby:2.5 (RHSA-2024:10850)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for ruby:2.5.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:10850 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_10850.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?081aeedf");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:10850");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL ruby:2.5 package based on the guidance in RHSA-2024:10850.");
  ...
  'ruby:2.5': [
    {
      ...
      'pkgs': [
        {'reference':'ruby-2.5.9-113.module+el8.10.0+22581+23fc9c9e', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ruby-devel-2.5.9-113.module+el8.10.0+22581+23fc9c9e', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ruby-doc-2.5.9-113.module+el8.10.0+22581+23fc9c9e', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ruby-irb-2.5.9-113.module+el8.10.0+22581+23fc9c9e', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ruby-libs-2.5.9-113.module+el8.10.0+22581+23fc9c9e', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'rubygem-bigdecimal-1.3.4-113.module+el8.10.0+22581+23fc9c9e', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'rubygem-did_you_mean-1.2.0-113.module+el8.10.0+22581+23fc9c9e', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-io-console-0.4.6-113.module+el8.10.0+22581+23fc9c9e', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-json-2.1.0-113.module+el8.10.0+22581+23fc9c9e', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-minitest-5.10.3-113.module+el8.10.0+22581+23fc9c9e', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'rubygem-net-telnet-0.1.1-113.module+el8.10.0+22581+23fc9c9e', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-openssl-2.1.2-113.module+el8.10.0+22581+23fc9c9e', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'rubygem-power_assert-1.1.1-113.module+el8.10.0+22581+23fc9c9e', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-psych-3.0.2-113.module+el8.10.0+22581+23fc9c9e', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-rake-12.3.3-113.module+el8.10.0+22581+23fc9c9e', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-rdoc-6.0.1.1-113.module+el8.10.0+22581+23fc9c9e', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-test-unit-3.2.7-113.module+el8.10.0+22581+23fc9c9e', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-xmlrpc-0.3.0-113.module+el8.10.0+22581+23fc9c9e', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygems-2.7.6.3-113.module+el8.10.0+22581+23fc9c9e', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygems-devel-2.7.6.3-113.module+el8.10.0+22581+23fc9c9e', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
