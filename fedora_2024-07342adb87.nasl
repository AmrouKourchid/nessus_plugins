...
# extracted from Fedora Security Advisory FEDORA-2024-07342adb87
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-07342adb87");

  script_name(english:"Fedora 40 : efifs (2024-07342adb87)");
...
FEDORA-2024-07342adb87 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-07342adb87");
...
var pkgs = [
    {'reference':'efifs-1.9-6.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
