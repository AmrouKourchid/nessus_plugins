...
# extracted from Fedora Security Advisory FEDORA-2024-2705241461
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-2705241461");

  script_name(english:"Fedora 38 : golang-x-crypto (2024-2705241461)");
...
FEDORA-2024-2705241461 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-2705241461");
...
var pkgs = [
    {'reference':'golang-x-crypto-0.18.0-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
