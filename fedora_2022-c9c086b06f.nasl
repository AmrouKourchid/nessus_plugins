...
# extracted from Fedora Security Advisory FEDORA-2022-c9c086b06f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-c9c086b06f");

  script_name(english:"Fedora 35 : wavpack (2022-c9c086b06f)");
...
FEDORA-2022-c9c086b06f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-c9c086b06f");
...
var pkgs = [
    {'reference':'wavpack-5.5.0-2.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
