...
# extracted from Red Hat Security Advisory RHSA-2023:2259. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:2259");
  script_xref(name:"IAVB", value:"2022-B-0050-S");

  script_name(english:"RHEL 9 : poppler (RHSA-2023:2259)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_2259.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b9068421");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2144768");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:2259");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL poppler package based on the guidance in RHSA-2023:2259.");
