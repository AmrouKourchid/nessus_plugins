...
# extracted from Oracle Linux Security Advisory ELSA-2024-2517.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : wpa_supplicant (ELSA-2024-2517)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-2517.html");
