...
# extracted from Red Hat Security Advisory RHSA-2024:1750. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:1750");

  script_name(english:"RHEL 9 : unbound (RHSA-2024:1750)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_1750.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a3acf764");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:1750");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL unbound package based on the guidance in RHSA-2024:1750.");
