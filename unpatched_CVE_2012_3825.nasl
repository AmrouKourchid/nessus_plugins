...
if (description)
{
  ...
  script_cve_id("CVE-2012-3825");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2012-3825");
...
patch available.
  ...
  - Multiple integer overflows in Wireshark 1.4.x before 1.4.13 and 1.6.x before 1.6.8 allow remote attackers
    ...
    dissectors, a different vulnerability than CVE-2012-2392. (CVE-2012-3825)
