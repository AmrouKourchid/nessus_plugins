...
# extracted from Red Hat Security Advisory RHSA-2020:5495. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_5495.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6c3c4a8a");
...
"Update the RHEL nginx:1.16 package based on the guidance in RHSA-2020:5495.");
  ...
  'nginx:1.16': [
    {
      ...
      'pkgs': [
        {'reference':'nginx-1.16.1-1.module+el8.3.0+8844+e5e7039f.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-all-modules-1.16.1-1.module+el8.3.0+8844+e5e7039f.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-filesystem-1.16.1-1.module+el8.3.0+8844+e5e7039f.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-mod-http-image-filter-1.16.1-1.module+el8.3.0+8844+e5e7039f.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-mod-http-perl-1.16.1-1.module+el8.3.0+8844+e5e7039f.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-mod-http-xslt-filter-1.16.1-1.module+el8.3.0+8844+e5e7039f.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-mod-mail-1.16.1-1.module+el8.3.0+8844+e5e7039f.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-mod-stream-1.16.1-1.module+el8.3.0+8844+e5e7039f.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
      ]
    }
  ]
};
