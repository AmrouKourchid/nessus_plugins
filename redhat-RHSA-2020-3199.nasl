...
# extracted from Red Hat Security Advisory RHSA-2020:3199. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:3199");

  script_name(english:"RHEL 8 : openstack-tripleo-heat-templates (RHSA-2020:3199)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_3199.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?878ff522");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:3199");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1831544");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL openstack-tripleo-heat-templates package based on the guidance in RHSA-2020:3199.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openstack-tripleo-heat-templates-11.3.2-0.20200616081532.396affd.el8ost', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
