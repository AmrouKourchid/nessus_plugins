...
# extracted from Fedora Security Advisory FEDORA-2023-e3e1f9dd4d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-e3e1f9dd4d");

  script_name(english:"Fedora 38 : redis (2023-e3e1f9dd4d)");
...
FEDORA-2023-e3e1f9dd4d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-e3e1f9dd4d");
...
var pkgs = [
    {'reference':'redis-7.0.10-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
