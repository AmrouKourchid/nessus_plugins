...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : libtiff (EulerOS-SA-2024-2373)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2373
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?49a02363");
...
var pkgs = [
  "libtiff-4.1.0-1.h1.r32.eulerosv2r9"
];
