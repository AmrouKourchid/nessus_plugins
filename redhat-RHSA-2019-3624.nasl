...
# extracted from Red Hat Security Advisory RHSA-2019:3624. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:3624");

  script_name(english:"RHEL 8 : libseccomp (RHSA-2019:3624)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2019:3624 advisory.

    The libseccomp library provides an interface to the Linux Kernel's syscall filtering mechanism, seccomp.
    The libseccomp API allows an application to specify which system calls or system call arguments the
    application is allowed to execute, all of which are then enforced by the Linux Kernel.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_3624.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cb1e1a6b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:3624");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1688938");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1690897");
  script_set_attribute(attribute:"solution", value:
"Update the affected libseccomp and / or libseccomp-devel packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:libseccomp");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:libseccomp-devel");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libseccomp-2.4.1-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libseccomp-devel-2.4.1-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libseccomp / libseccomp-devel');
}
