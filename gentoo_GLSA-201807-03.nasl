...
# extracted from Gentoo Linux Security Advisory GLSA 201807-03.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201807-03");

  script_name(english:"GLSA-201807-03 : ZNC:Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-201807-03
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/201807-03");
...
if (qpkg_check(package:"net-irc/znc", unaffected:make_list("ge 1.7.1"), vulnerable:make_list("lt 1.7.1"))) flag++;
