...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : libvorbis (EulerOS-SA-2021-2274)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the libvorbis packages installed, the
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2274
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?adaa0b0b");
...
"Update the affected libvorbis packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-14160");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:libvorbis-help");
...
pkgs = ["libvorbis-1.3.6-5.h1.eulerosv2r9",
        "libvorbis-help-1.3.6-5.h1.eulerosv2r9"];
