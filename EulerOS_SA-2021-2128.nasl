...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.2 : bindutils (EulerOS-SA-2021-2128)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing multiple security
updates.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the bindutils package installed, the
...
the following vulnerabilities :
  ...
  - There's a flaw in bfd_pef_parse_function_stubs of
    bfd/pef.c in binutils in versions prior to 2.34 which
    could allow an attacker who is able to submit a crafted
    file to be processed by objdump to cause a NULL pointer
    dereference. The greatest threat of this flaw is to
    application availability.(CVE-2020-35507)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2128
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?53e8df65");
  script_set_attribute(attribute:"solution", value:
"Update the affected bindutils packages.");
...
pkgs = ["binutils-2.27-28.base.1.h49.eulerosv2r7"];
