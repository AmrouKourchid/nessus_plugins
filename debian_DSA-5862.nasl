...
# extracted from Debian Security Advisory dsa-5862. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5862 : cacti - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-27082");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'cacti', 'reference': '1.2.24+ds1-1+deb12u5'}
];
