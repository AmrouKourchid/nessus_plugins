...
# extracted from Fedora Security Advisory FEDORA-2019-e66b1889ec.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-e66b1889ec");

  script_name(english:"Fedora 29 : slurm (2019-e66b1889ec)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-e66b1889ec");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"slurm-17.11.13-2.fc29")) flag++;
