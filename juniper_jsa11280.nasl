...
number.");
  # https://supportportal.juniper.net/s/article/2022-01-Security-Bulletin-Junos-OS-QFX5000-Series-EX4600-Device-may-run-out-of-memory-causing-traffic-loss-upon-receipt-of-specific-packets-CVE-2022-22174
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?10acdc3d");
...
var vuln_ranges = [
  ...
  {'min_ver':'18.4', 'fixed_ver':'18.4R2-S9', 'model':'^(EX4600|QFX5)'},
  {'min_ver':'18.4R3', 'fixed_ver':'18.4R3-S9', 'model':'^(EX4600|QFX5)'},
  {'min_ver':'19.1', 'fixed_ver':'19.1R2-S3', 'model':'^(EX4600|QFX5)'},
