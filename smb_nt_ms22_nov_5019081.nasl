...
if (description)
{
  ...
  script_name(english:"KB5019081: Windows Server 2022 / Azure Stack HCI 21H2 / 22H2  Security Update (November 2022)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5019081. It is, therefore, affected by multiple vulnerabilities
...
"Apply Security Update 5019081");
  ...
  script_set_attribute(attribute:"cpe", value:"cpe:/o:microsoft:azure_stack_hci_21h2");
