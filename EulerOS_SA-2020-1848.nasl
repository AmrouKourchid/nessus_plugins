...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : freerdp (EulerOS-SA-2020-1848)");
...
vulnerabilities :
  ...
  - An issue was discovered in FreeRDP before 2.1.1. An
    ...
    detected in ntlm_read_ChallengeMessage in
    winpr/libwinpr/sspi/NTLM/
    ntlm_message.c.(CVE-2020-13396)

  - libfreerdp/codec/region.c in FreeRDP through 1.1.x and
    2.x through 2.0.0-rc4 has memory leaks because a
    supplied realloc pointer (i.e., the first argument to
    realloc) is also used for a realloc return
    value.(CVE-2019-17177)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1848
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c407ab00");
...
"Update the affected freerdp packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-13396");
...
pkgs = ["freerdp-2.0.0-44.rc3.h9.eulerosv2r8",
        "freerdp-libs-2.0.0-44.rc3.h9.eulerosv2r8",
        "libwinpr-2.0.0-44.rc3.h9.eulerosv2r8"];
