...
# extracted from Fedora Security Advisory FEDORA-2024-b673d8c70f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-b673d8c70f");

  script_name(english:"Fedora 41 : python3.12 (2024-b673d8c70f)");
...
FEDORA-2024-b673d8c70f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-b673d8c70f");
...
var pkgs = [
    {'reference':'python3.12-3.12.5-2.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
