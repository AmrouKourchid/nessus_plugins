...
# extracted from Fedora Security Advisory FEDORA-2023-994ecd7dbc
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-994ecd7dbc");
  script_xref(name:"IAVA", value:"2023-A-0283-S");

  script_name(english:"Fedora 38 : python3.10 (2023-994ecd7dbc)");
...
FEDORA-2023-994ecd7dbc advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-994ecd7dbc");
...
var pkgs = [
    {'reference':'python3.10-3.10.11-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
