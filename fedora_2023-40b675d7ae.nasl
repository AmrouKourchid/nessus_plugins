...
# extracted from Fedora Security Advisory FEDORA-2023-40b675d7ae
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-40b675d7ae");

  script_name(english:"Fedora 36 : tkimg (2023-40b675d7ae)");
...
FEDORA-2023-40b675d7ae advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-40b675d7ae");
...
var pkgs = [
    {'reference':'tkimg-1.4.14-3.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
