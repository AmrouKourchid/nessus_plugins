...
# extracted from VMware Security Advisory PHSA-2020-3.0-0049. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Sqlite PHSA-2020-3.0-0049");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the sqlite package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-3.0-49.md");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'sqlite-3.30.1-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'sqlite-devel-3.30.1-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'sqlite-libs-3.30.1-1.ph3')) flag++;
