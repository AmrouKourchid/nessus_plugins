...
# extracted from Gentoo Linux Security Advisory GLSA 202312-08.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202312-08 : LibRaw: Heap Buffer Overflow");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202312-08 (LibRaw: Heap Buffer Overflow)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202312-08");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=908041");
...
var packages = [
  {
    ...
    'unaffected' : make_list("ge 0.21.1-r1"),
    'vulnerable' : make_list("lt 0.21.1-r1")
  }
];
