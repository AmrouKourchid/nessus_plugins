...
# extracted from Red Hat Security Advisory RHSA-2020:1290. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:1290");

  script_name(english:"RHEL 7 : rh-haproxy18-haproxy (RHSA-2020:1290)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for rh-haproxy18-haproxy.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2020:1290 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_1290.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?368d3249");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#critical");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/vulnerabilities/haproxy");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:1290");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1819111");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rh-haproxy18-haproxy package based on the guidance in RHSA-2020:1290.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-haproxy18-haproxy-1.8.17-1.el7.1', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-haproxy18-haproxy-syspaths-1.8.17-1.el7.1', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
