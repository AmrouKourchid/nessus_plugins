...
# extracted from Red Hat Security Advisory RHSA-2014:0579. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2014-0040", "CVE-2014-0041", "CVE-2014-0042");
  script_xref(name:"RHSA", value:"2014:0579");

  script_name(english:"RHEL 6 : openstack-heat-templates (RHSA-2014:0579)");
...
referenced in the RHSA-2014:0579 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1059514");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1059515");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1059520");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2014/rhsa-2014_0579.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d73d18c7");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2014:0579");
...
"Update the RHEL openstack-heat-templates package based on the guidance in RHSA-2014:0579.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-0042");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2014-0040");

  script_set_attribute(attribute:"exploitability_ease", value:"Exploits are available");
  script_set_attribute(attribute:"exploit_available", value:"true");
  script_cwe_id(295, 494, 522);
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:openstack-heat-templates");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openstack-heat-templates-0-0.3.20140407git.el6ost', 'release':'6', 'el_string':'el6ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'openstack-heat-templates');
}
