...
# extracted from VMware Security Advisory PHSA-2023-5.0-0125. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2023-40745", "CVE-2023-41175");

  script_name(english:"Photon OS 5.0: Libtiff PHSA-2023-5.0-0125");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the libtiff package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-5.0-125.md");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'libtiff-4.5.1-2.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'libtiff-devel-4.5.1-2.ph5')) flag++;
