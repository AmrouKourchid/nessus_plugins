...
# extracted from Amazon Linux 2023 Security Advisory ALAS2023-2024-730.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2023 : python3-pip, python3-pip-wheel (ALAS2023-2024-730)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2023 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"It is, therefore, affected by a vulnerability as referenced in the ALAS2023-2024-730 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2023/ALAS-2024-730.html");
...
"Run 'dnf update python-pip --releasever 2023.6.20241010' to update your system.");
...
var pkgs = [
    {'reference':'python3-pip-21.3.1-2.amzn2023.0.8', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-pip-wheel-21.3.1-2.amzn2023.0.8', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE}
];
