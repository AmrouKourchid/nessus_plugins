...
# extracted from Amazon Linux AMI Security Advisory ALAS-2023-1780.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux AMI : c-ares (ALAS-2023-1780)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux AMI host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of c-ares installed on the remote host is prior to 1.17.2-1.10. It is, therefore, affected by a
vulnerability as referenced in the ALAS-2023-1780 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/ALAS-2023-1780.html");
...
var pkgs = [
    {'reference':'c-ares-1.17.2-1.10.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'c-ares-1.17.2-1.10.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'c-ares-debuginfo-1.17.2-1.10.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'c-ares-debuginfo-1.17.2-1.10.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'c-ares-devel-1.17.2-1.10.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'c-ares-devel-1.17.2-1.10.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE}
];
