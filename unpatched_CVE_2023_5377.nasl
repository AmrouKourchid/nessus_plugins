...
if (description)
{
  ...
  script_cve_id("CVE-2023-5377");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2023-5377");
...
patch available.
  ...
  - Out-of-bounds Read in GitHub repository gpac/gpac prior to v2.2.2-DEV. (CVE-2023-5377)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-5377");
