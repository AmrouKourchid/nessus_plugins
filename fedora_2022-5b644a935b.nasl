...
# extracted from Fedora Security Advisory FEDORA-2022-5b644a935b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-5b644a935b");

  script_name(english:"Fedora 35 : bash (2022-5b644a935b)");
...
FEDORA-2022-5b644a935b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-5b644a935b");
...
var pkgs = [
    {'reference':'bash-5.1.8-3.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
