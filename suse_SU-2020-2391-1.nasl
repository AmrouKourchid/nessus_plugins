...
# extracted from SUSE update advisory SUSE-SU-2020:2391-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : freeradius-server (SUSE-SU-2020:2391-1)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?98b37f00");
...
zypper in -t patch SUSE-OpenStack-Cloud-7-2020-2391=1

SUSE Linux Enterprise Server for SAP 12-SP2 :

zypper in -t patch SUSE-SLE-SAP-12-SP2-2020-2391=1

SUSE Linux Enterprise Server 12-SP2-LTSS :

zypper in -t patch SUSE-SLE-SERVER-12-SP2-2020-2391=1

SUSE Linux Enterprise Server 12-SP2-BCL :

zypper in -t patch SUSE-SLE-SERVER-12-SP2-BCL-2020-2391=1");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"2", reference:"freeradius-server-3.0.3-17.15.2")) flag++;
if (rpm_check(release:"SLES12", sp:"2", reference:"freeradius-server-debuginfo-3.0.3-17.15.2")) flag++;
if (rpm_check(release:"SLES12", sp:"2", reference:"freeradius-server-debugsource-3.0.3-17.15.2")) flag++;
if (rpm_check(release:"SLES12", sp:"2", reference:"freeradius-server-doc-3.0.3-17.15.2")) flag++;
if (rpm_check(release:"SLES12", sp:"2", reference:"freeradius-server-krb5-3.0.3-17.15.2")) flag++;
if (rpm_check(release:"SLES12", sp:"2", reference:"freeradius-server-krb5-debuginfo-3.0.3-17.15.2")) flag++;
if (rpm_check(release:"SLES12", sp:"2", reference:"freeradius-server-ldap-3.0.3-17.15.2")) flag++;
if (rpm_check(release:"SLES12", sp:"2", reference:"freeradius-server-ldap-debuginfo-3.0.3-17.15.2")) flag++;
if (rpm_check(release:"SLES12", sp:"2", reference:"freeradius-server-libs-3.0.3-17.15.2")) flag++;
if (rpm_check(release:"SLES12", sp:"2", reference:"freeradius-server-libs-debuginfo-3.0.3-17.15.2")) flag++;
if (rpm_check(release:"SLES12", sp:"2", reference:"freeradius-server-mysql-3.0.3-17.15.2")) flag++;
if (rpm_check(release:"SLES12", sp:"2", reference:"freeradius-server-mysql-debuginfo-3.0.3-17.15.2")) flag++;
if (rpm_check(release:"SLES12", sp:"2", reference:"freeradius-server-perl-3.0.3-17.15.2")) flag++;
if (rpm_check(release:"SLES12", sp:"2", reference:"freeradius-server-perl-debuginfo-3.0.3-17.15.2")) flag++;
if (rpm_check(release:"SLES12", sp:"2", reference:"freeradius-server-postgresql-3.0.3-17.15.2")) flag++;
if (rpm_check(release:"SLES12", sp:"2", reference:"freeradius-server-postgresql-debuginfo-3.0.3-17.15.2")) flag++;
if (rpm_check(release:"SLES12", sp:"2", reference:"freeradius-server-python-3.0.3-17.15.2")) flag++;
if (rpm_check(release:"SLES12", sp:"2", reference:"freeradius-server-python-debuginfo-3.0.3-17.15.2")) flag++;
if (rpm_check(release:"SLES12", sp:"2", reference:"freeradius-server-sqlite-3.0.3-17.15.2")) flag++;
if (rpm_check(release:"SLES12", sp:"2", reference:"freeradius-server-sqlite-debuginfo-3.0.3-17.15.2")) flag++;
if (rpm_check(release:"SLES12", sp:"2", reference:"freeradius-server-utils-3.0.3-17.15.2")) flag++;
if (rpm_check(release:"SLES12", sp:"2", reference:"freeradius-server-utils-debuginfo-3.0.3-17.15.2")) flag++;
