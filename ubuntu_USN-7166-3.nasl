...
# extracted from Ubuntu Security Notice USN-7166-3. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"7166-3");

  script_name(english:"Ubuntu 20.04 LTS : Linux kernel (HWE) vulnerabilities (USN-7166-3)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7166-3");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-7166-3');
}
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-7166-3');
  }
  else
  {
