...
# extracted from Red Hat Security Advisory RHSA-2023:3362. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:3362");

  script_name(english:"RHEL 8 : OpenShift Container Platform 4.10.61 (RHSA-2023:3362)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for OpenShift Container Platform 4.10.61.");
...
the RHSA-2023:3362 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.10.61. See the
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_3362.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e1991930");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:3362");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.10.61 packages based on the guidance in RHSA-2023:3362.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jenkins-2-plugins-4.10.1684982411-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
