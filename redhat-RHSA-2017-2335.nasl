...
the RHSA-2017:2335 advisory.

    Red Hat Certificate System is an enterprise software system designed to manage enterprise public key
    infrastructure (PKI) deployments. PKI Core contains fundamental packages required by Red Hat Certificate
    System, which comprise the Certificate Authority (CA) subsystem.

    Security Fix(es):

    * It was found that a mock CMC authentication plugin with a hardcoded secret was accidentally enabled by
    default in the pki-core package. An attacker could potentially use this flaw to bypass the regular
    authentication process and trick the CA server into issuing certificates. (CVE-2017-7537)
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2017/rhsa-2017_2335.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2e3b1385");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2017:2335");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1469432");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1470817");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL pki-core package based on the guidance in RHSA-2017:2335.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'pki-base-10.4.1-11.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pki-base-java-10.4.1-11.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pki-ca-10.4.1-11.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pki-javadoc-10.4.1-11.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pki-kra-10.4.1-11.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pki-server-10.4.1-11.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pki-symkey-10.4.1-11.el7', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pki-symkey-10.4.1-11.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pki-symkey-10.4.1-11.el7', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pki-symkey-10.4.1-11.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pki-tools-10.4.1-11.el7', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pki-tools-10.4.1-11.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pki-tools-10.4.1-11.el7', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pki-tools-10.4.1-11.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
