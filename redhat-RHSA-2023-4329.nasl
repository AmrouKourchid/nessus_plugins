...
# extracted from Red Hat Security Advisory RHSA-2023:4329. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:4329");
  script_xref(name:"IAVA", value:"2023-A-0377-S");

  script_name(english:"RHEL 9 : openssh (RHSA-2023:4329)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8a244974");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2224173");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:4329");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL openssh package based on the guidance in RHSA-2023:4329.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openssh-8.7p1-11.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'openssh-askpass-8.7p1-11.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'openssh-clients-8.7p1-11.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'openssh-keycat-8.7p1-11.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'openssh-server-8.7p1-11.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'pam_ssh_agent_auth-0.10.4-4.11.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
