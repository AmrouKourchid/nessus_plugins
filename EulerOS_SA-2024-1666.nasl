...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : shim (EulerOS-SA-2024-1666)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1666
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?03d58ba2");
...
var pkgs = [
  "shim-unsigned-x64-12-1.h13.eulerosv2r7"
];
