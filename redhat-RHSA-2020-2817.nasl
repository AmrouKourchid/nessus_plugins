...
# extracted from Red Hat Security Advisory RHSA-2020:2817. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:2817");

  script_name(english:"RHEL 7 : rh-nginx116-nginx (RHSA-2020:2817)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for rh-nginx116-nginx.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2020:2817 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_2817.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c62f9b38");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:2817");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1790277");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rh-nginx116-nginx package based on the guidance in RHSA-2020:2817.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-nginx116-nginx-1.16.1-4.el7.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'rh-nginx116-nginx-mod-http-image-filter-1.16.1-4.el7.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'rh-nginx116-nginx-mod-http-perl-1.16.1-4.el7.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'rh-nginx116-nginx-mod-http-xslt-filter-1.16.1-4.el7.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'rh-nginx116-nginx-mod-mail-1.16.1-4.el7.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'rh-nginx116-nginx-mod-stream-1.16.1-4.el7.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
