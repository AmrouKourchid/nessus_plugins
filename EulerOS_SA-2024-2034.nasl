...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : haproxy (EulerOS-SA-2024-2034)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2034
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7c6bf5eb");
...
var pkgs = [
  "haproxy-1.8.14-1.h4.eulerosv2r8"
];
