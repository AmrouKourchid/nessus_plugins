...
"The remote Red Hat host is missing a security update for httpcomponents-client.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2014:1146 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2014/rhsa-2014_1146.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7c8787a6");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2014:1146");
...
"Update the RHEL httpcomponents-client package based on the guidance in RHSA-2014:1146.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'httpcomponents-client-4.2.5-5.el7_0', 'release':'7', 'el_string':'el7_0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'httpcomponents-client-javadoc-4.2.5-5.el7_0', 'release':'7', 'el_string':'el7_0', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
