...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Python3 PHSA-2024-5.0-0332");
...
if (rpm_check(release:'PhotonOS-5.0', reference:'python3-setuptools-69.0.3-4.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', reference:'python3-setuptools-wheel-69.0.3-4.ph5')) flag++;
