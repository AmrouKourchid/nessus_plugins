...
# extracted from openSUSE Security Update openSUSE-2018-1297.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : mercurial (openSUSE-2018-1297)");
...
"This update for mercurial fixes the following issues :
  ...
  - CVE-2018-17983: Fix an out-of-bounds read during parsing
    of a malformed manifest entry (bsc#1110899).

This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1110899");
...
if ( rpm_check(release:"SUSE15.0", reference:"mercurial-4.5.2-lp150.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"mercurial-debuginfo-4.5.2-lp150.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"mercurial-debugsource-4.5.2-lp150.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"mercurial-lang-4.5.2-lp150.2.6.1") ) flag++;
