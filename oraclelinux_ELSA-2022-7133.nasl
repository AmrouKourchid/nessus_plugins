...
var appstreams = {
    '389-ds:1.4': [
      ...
      {'reference':'python3-lib389-1.4.3.28-8.module+el8.6.0+20852+b8a6303c', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python3-lib389-1.4.3.28-8.module+el8.6.0+20852+b8a6303c', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
};
