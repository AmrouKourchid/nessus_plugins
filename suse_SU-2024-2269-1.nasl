...
# SUSE update advisory SUSE-SU-2024:2269-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2024:2269-1");
  script_xref(name:"IAVB", value:"2024-B-0087-S");

  script_name(english:"SUSE SLES15 / openSUSE 15 Security Update : squid (SUSE-SU-2024:2269-1)");
...
as referenced in the SUSE-SU-2024:2269-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1227086");
  # https://lists.suse.com/pipermail/sle-security-updates/2024-July/018841.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a7b58cc8");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2024-37894");
...
var pkgs = [
    {'reference':'squid-5.7-150400.3.32.1', 'sp':'5', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.5']},
    {'reference':'squid-5.7-150400.3.32.1', 'sp':'5', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.5', 'sle-module-server-applications-release-15.5', 'sles-release-15.5']},
    {'reference':'squid-5.7-150400.3.32.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.5']}
];
