...
# extracted from Fedora Security Advisory FEDORA-2021-f6bd75e9d4
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-f6bd75e9d4");
  script_xref(name:"IAVB", value:"2021-B-0012-S");
  script_xref(name:"CEA-ID", value:"CEA-2021-0025");

  script_name(english:"Fedora 32 : 1:nodejs (2021-f6bd75e9d4)");
...
FEDORA-2021-f6bd75e9d4 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-f6bd75e9d4");
...
pkgs = [
    {'reference':'nodejs-12.21.0-2.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
