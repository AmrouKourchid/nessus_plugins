...
# extracted from Fedora Security Advisory FEDORA-2022-f0f6c6bec2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-f0f6c6bec2");

  script_name(english:"Fedora 37 : ruby (2022-f0f6c6bec2)");
...
FEDORA-2022-f0f6c6bec2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-f0f6c6bec2");
...
var pkgs = [
    {'reference':'ruby-3.1.3-172.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
