...
# extracted from Fedora Security Advisory FEDORA-2023-d5759f1edb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-d5759f1edb");
  script_xref(name:"IAVA", value:"2023-A-0337-S");

  script_name(english:"Fedora 38 : firefox (2023-d5759f1edb)");
...
FEDORA-2023-d5759f1edb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-d5759f1edb");
...
var pkgs = [
    {'reference':'firefox-115.0.2-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
