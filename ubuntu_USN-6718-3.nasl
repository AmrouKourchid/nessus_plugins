...
# extracted from Ubuntu Security Notice USN-6718-3. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6718-3");
  script_xref(name:"IAVA", value:"2024-A-0185-S");

  script_name(english:"Ubuntu 24.04 LTS. : curl vulnerabilities (USN-6718-3)");
...
the USN-6718-3 advisory.

    USN-6718-1 fixed vulnerabilities in curl. This update provides the corresponding updates for Ubuntu 24.04
    LTS.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6718-3");
...
var pkgs = [
    {'osver': '24.04', 'pkgname': 'curl', 'pkgver': '8.5.0-2ubuntu10.1'},
    {'osver': '24.04', 'pkgname': 'libcurl3t64-gnutls', 'pkgver': '8.5.0-2ubuntu10.1'},
    {'osver': '24.04', 'pkgname': 'libcurl4-gnutls-dev', 'pkgver': '8.5.0-2ubuntu10.1'},
    {'osver': '24.04', 'pkgname': 'libcurl4-openssl-dev', 'pkgver': '8.5.0-2ubuntu10.1'},
    {'osver': '24.04', 'pkgname': 'libcurl4t64', 'pkgver': '8.5.0-2ubuntu10.1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'curl / libcurl3t64-gnutls / libcurl4-gnutls-dev / etc');
}
