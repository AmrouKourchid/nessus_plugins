...
# extracted from Fedora Security Advisory FEDORA-2020-203ffedeb5.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : kernel (2020-203ffedeb5)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The 5.6.16 stable kernel update contains a number of important fixes
across the tree.
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-203ffedeb5");
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for FEDORA-2020-203ffedeb5");
  }
  else
  {
...
flag = 0;
if (rpm_check(release:"FC31", reference:"kernel-5.6.16-200.fc31")) flag++;
