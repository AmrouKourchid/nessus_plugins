...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS : Nagios regression (USN-3253-2)");
...
in the USN-3253-2 advisory.

    USN-3253-1 fixed vulnerabilities in Nagios. The update prevented log files from being displayed in the web
    interface. This update fixes the problem.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3253-2");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'nagios3', 'pkgver': '3.5.1-1ubuntu1.3'},
    {'osver': '14.04', 'pkgname': 'nagios3-cgi', 'pkgver': '3.5.1-1ubuntu1.3'},
    {'osver': '14.04', 'pkgname': 'nagios3-common', 'pkgver': '3.5.1-1ubuntu1.3'},
    {'osver': '14.04', 'pkgname': 'nagios3-core', 'pkgver': '3.5.1-1ubuntu1.3'},
    {'osver': '16.04', 'pkgname': 'nagios3', 'pkgver': '3.5.1.dfsg-2.1ubuntu1.3'},
    {'osver': '16.04', 'pkgname': 'nagios3-cgi', 'pkgver': '3.5.1.dfsg-2.1ubuntu1.3'},
    {'osver': '16.04', 'pkgname': 'nagios3-common', 'pkgver': '3.5.1.dfsg-2.1ubuntu1.3'},
    {'osver': '16.04', 'pkgname': 'nagios3-core', 'pkgver': '3.5.1.dfsg-2.1ubuntu1.3'}
];
