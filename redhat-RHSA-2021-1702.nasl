...
# extracted from Red Hat Security Advisory RHSA-2021:1702. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:1702");

  script_name(english:"RHEL 8 : brotli (RHSA-2021:1702)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for brotli.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2021:1702 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_1702.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9904fa34");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:1702");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1879225");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL brotli package based on the guidance in RHSA-2021:1702.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:brotli");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:brotli-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:python3-brotli");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'brotli-1.0.6-3.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'brotli-devel-1.0.6-3.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-brotli-1.0.6-3.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
