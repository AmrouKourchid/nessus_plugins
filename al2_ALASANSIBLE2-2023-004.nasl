...
# extracted from Amazon Linux 2 Security Advisory ALASANSIBLE2-2023-004.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : ansible (ALASANSIBLE2-2023-004)");
...
vulnerabilities as referenced in the ALAS2ANSIBLE2-2023-004 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALASANSIBLE2-2023-004.html");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/cve/html/CVE-2021-20178.html");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/cve/html/CVE-2021-20180.html");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/cve/html/CVE-2021-20191.html");
...
var pkgs = [
    {'reference':'ansible-2.9.18-1.amzn2', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible2'},
    {'reference':'ansible-doc-2.9.18-1.amzn2', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible2'}
];
