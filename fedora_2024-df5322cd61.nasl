...
# extracted from Fedora Security Advisory FEDORA-2024-df5322cd61
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-df5322cd61");

  script_name(english:"Fedora 40 : upx (2024-df5322cd61)");
...
FEDORA-2024-df5322cd61 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-df5322cd61");
...
var pkgs = [
    {'reference':'upx-4.2.3-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
