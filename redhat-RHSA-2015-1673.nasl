...
if (description)
{
  ...
  script_name(english:"RHEL 6 : jboss-ec2-eap  (RHSA-2015:1673)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for jboss-ec2-eap.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 6 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2015:1673 advisory.

    Red Hat JBoss Enterprise Application Platform 6 is a platform for Java EE applications. It is based on
    JBoss Application Server 7 and incorporates multiple open-source projects to provide a complete Java EE
    platform solution.

    * The jboss-ec2-eap package provides scripts for Red Hat JBoss Enterprise Application Platform running on
    the Amazon Web Services (AWS) Elastic Compute Cloud (EC2). With this update, the package has been updated
    to ensure compatibility with Red Hat JBoss Enterprise Application Platform 6.4.3. (BZ#1228766)
    ...
    Users of Red Hat JBoss Enterprise Application Platform 6.4.2 jboss-ec2-eap are advised to upgrade to this
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2015/rhsa-2015_1673.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?eeb2773a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2015:1673");
...
"Update the RHEL jboss-ec2-eap package based on the guidance in RHSA-2015:1673.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jboss-ec2-eap-7.5.3-1.Final_redhat_2.ep6.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap6'},
      {'reference':'jboss-ec2-eap-samples-7.5.3-1.Final_redhat_2.ep6.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap6'}
    ]
  }
];
