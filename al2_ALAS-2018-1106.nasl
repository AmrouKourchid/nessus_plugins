...
# extracted from Amazon Linux 2 Security Advisory ALAS-2018-1106.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2018-1106");

  script_name(english:"Amazon Linux 2 : 389-ds-base (ALAS-2018-1106)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"It was found that a specially crafted search query could lead to
...
service.(CVE-2018-14648)");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2018-1106.html");
...
flag = 0;
if (rpm_check(release:"AL2", reference:"389-ds-base-1.3.8.4-15.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"389-ds-base-debuginfo-1.3.8.4-15.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"389-ds-base-devel-1.3.8.4-15.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"389-ds-base-libs-1.3.8.4-15.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"389-ds-base-snmp-1.3.8.4-15.amzn2.0.1")) flag++;
