...
# extracted from Mozilla Foundation Security Advisory mfsa2025-30.
...
if (description)
{
  ...
  script_name(english:"Mozilla Firefox ESR < 115.23");

  script_set_attribute(attribute:"synopsis", value:
"A web browser installed on the remote macOS or Mac OS X host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Firefox ESR installed on the remote macOS or Mac OS X host is prior to 115.23. It is, therefore, affected
by multiple vulnerabilities as referenced in the mfsa2025-30 advisory.
  ...
  - Due to insufficient escaping of the ampersand character in the copy as cURL feature, an attacker could
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2025-30/");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Mozilla Firefox ESR version 115.23 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:L/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-4082");
...
mozilla_check_version(version:version, path:path, product:'firefox', esr:TRUE, fix:'115.23', min:'115.0.0', severity:SECURITY_WARNING);
