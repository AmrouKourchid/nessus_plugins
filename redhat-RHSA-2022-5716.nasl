...
# extracted from Red Hat Security Advisory RHSA-2022:5716. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:5716");

  script_name(english:"RHEL 9 : grafana (RHSA-2022:5716)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_5716.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5c3ee882");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:5716");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2104367");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL grafana package based on the guidance in RHSA-2022:5716.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'grafana-7.5.11-5.el9_0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'grafana-7.5.11-5.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
