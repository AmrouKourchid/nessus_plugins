...
# extracted from Ubuntu Security Notice USN-2258-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : GnuPG vulnerability (USN-2258-1)");
...
USN-2258-1 advisory.
    ...
    Jean-Ren Reinhard, Olivier Levillain and Florian Maury discovered that GnuPG incorrectly handled certain
    OpenPGP messages. If a user or automated system were tricked into processing a specially-crafted message,
    GnuPG could consume resources, resulting in a denial of service.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2258-1");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-4617");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'gnupg', 'pkgver': '1.4.16-1ubuntu2.1'},
    {'osver': '14.04', 'pkgname': 'gnupg-agent', 'pkgver': '2.0.22-3ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'gnupg-curl', 'pkgver': '1.4.16-1ubuntu2.1'},
    {'osver': '14.04', 'pkgname': 'gnupg-udeb', 'pkgver': '1.4.16-1ubuntu2.1'},
    {'osver': '14.04', 'pkgname': 'gnupg2', 'pkgver': '2.0.22-3ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'gpgsm', 'pkgver': '2.0.22-3ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'gpgv', 'pkgver': '1.4.16-1ubuntu2.1'},
    {'osver': '14.04', 'pkgname': 'gpgv-udeb', 'pkgver': '1.4.16-1ubuntu2.1'},
    {'osver': '14.04', 'pkgname': 'gpgv2', 'pkgver': '2.0.22-3ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'scdaemon', 'pkgver': '2.0.22-3ubuntu1.1'}
];
