...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS : Linux kernel vulnerability (USN-5219-1)");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-4204");
...
var kernel_mappings = {
  '20.04': {
    ...
    '5.11.0': {
      'generic': '5.11.0-46',
      'generic-64k': '5.11.0-46',
      'generic-lpae': '5.11.0-46',
      'lowlatency': '5.11.0-46',
      'aws': '5.11.0-1025',
      'azure': '5.11.0-1025',
      'oracle': '5.11.0-1025',
      'gcp': '5.11.0-1026'
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-5219-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2021-4204');
