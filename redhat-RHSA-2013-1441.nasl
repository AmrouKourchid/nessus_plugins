...
"The remote Red Hat host is missing one or more security updates for rubygems.");
...
referenced in the RHSA-2013:1441 advisory.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2013/rhsa-2013_1441.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?10b226a9");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2013:1441");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1002364");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=814718");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rubygems package based on the guidance in RHSA-2013:1441.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rubygems-1.3.7-4.el6_4', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
