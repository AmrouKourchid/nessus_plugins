...
# extracted from Fedora Security Advisory FEDORA-2025-117fe4c81f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-117fe4c81f");

  script_name(english:"Fedora 41 : augeas (2025-117fe4c81f)");
...
FEDORA-2025-117fe4c81f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-117fe4c81f");
...
var pkgs = [
    {'reference':'augeas-1.14.2-0.4.20250324git4dffa3d.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
