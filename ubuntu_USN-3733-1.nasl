...
# extracted from Ubuntu Security Notice USN-3733-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS : GnuPG vulnerability (USN-3733-1)");
...
in the USN-3733-1 advisory.

    Daniel J. Bernstein, Joachim Breitner, Daniel Genkin, Leon Groot Bruinderink, Nadia Heninger, Tanja Lange,
    Christine van Vredendaal, and Yuval Yarom discovered that GnuPG is vulnerable to a cache side-channel
    attack. A local attacker could use this attack to recover RSA private keys.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3733-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'gnupg', 'pkgver': '1.4.16-1ubuntu2.6'},
    {'osver': '14.04', 'pkgname': 'gnupg-curl', 'pkgver': '1.4.16-1ubuntu2.6'},
    {'osver': '14.04', 'pkgname': 'gnupg-udeb', 'pkgver': '1.4.16-1ubuntu2.6'},
    {'osver': '14.04', 'pkgname': 'gpgv', 'pkgver': '1.4.16-1ubuntu2.6'},
    {'osver': '14.04', 'pkgname': 'gpgv-udeb', 'pkgver': '1.4.16-1ubuntu2.6'},
    {'osver': '16.04', 'pkgname': 'gnupg', 'pkgver': '1.4.20-1ubuntu3.3'},
    {'osver': '16.04', 'pkgname': 'gnupg-curl', 'pkgver': '1.4.20-1ubuntu3.3'},
    {'osver': '16.04', 'pkgname': 'gpgv', 'pkgver': '1.4.20-1ubuntu3.3'},
    {'osver': '16.04', 'pkgname': 'gpgv-udeb', 'pkgver': '1.4.20-1ubuntu3.3'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'gnupg / gnupg-curl / gnupg-udeb / gpgv / gpgv-udeb');
}
