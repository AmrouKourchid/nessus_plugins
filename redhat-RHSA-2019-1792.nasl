...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_1792.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?26fd3e9a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:1792");
...
"Update the RHEL keepalived package based on the guidance in RHSA-2019:1792.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'keepalived-1.3.5-7.el7_5.2', 'sp':'5', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'keepalived-1.3.5-7.el7_5.2', 'sp':'5', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'keepalived-1.3.5-7.el7_5.2', 'sp':'5', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'keepalived-1.3.5-7.el7_5.2', 'sp':'5', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
