...
"The version of Thunderbird ESR installed on the remote macOS or Mac OS X host is prior to 128.6. It is, therefore,
affected by multiple vulnerabilities as referenced in the mfsa2025-05 advisory.
...
mozilla_check_version(version:version, path:path, product:'thunderbird', esr:TRUE, fix:'128.6', min:'128.0.0', severity:SECURITY_HOLE);
