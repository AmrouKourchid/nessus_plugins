...
# extracted from Fedora Security Advisory FEDORA-2019-aba3cca74a.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-aba3cca74a");

  script_name(english:"Fedora 30 : python3 (2019-aba3cca74a)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"Python 3.7.5 is the fifth and most recent maintenance release of
Python 3.7.

Includes a security fix for CVE-2019-16056.

Note that Tenable Network Security has extracted the preceding
description block directly from the Fedora update system website.
Tenable has attempted to automatically clean and format it as much as
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-aba3cca74a");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"python3-3.7.5-1.fc30")) flag++;
