...
# Rocky Linux Security Advisory RLSA-2023:7790.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2023:7790");
  script_xref(name:"IAVB", value:"2023-B-0088-S");

  script_name(english:"Rocky Linux 8 : postgresql:10 (RLSA-2023:7790)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Rocky Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Rocky Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
RLSA-2023:7790 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2023:7790");
...
var appstreams = {
    'postgresql:10': [
      {'reference':'postgresql-10.23-3.module+el8.9.0+1608+45f68f05', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-contrib-10.23-3.module+el8.9.0+1608+45f68f05', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-contrib-debuginfo-10.23-3.module+el8.9.0+1608+45f68f05', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-debuginfo-10.23-3.module+el8.9.0+1608+45f68f05', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-debugsource-10.23-3.module+el8.9.0+1608+45f68f05', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-docs-10.23-3.module+el8.9.0+1608+45f68f05', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-docs-debuginfo-10.23-3.module+el8.9.0+1608+45f68f05', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-plperl-10.23-3.module+el8.9.0+1608+45f68f05', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-plperl-debuginfo-10.23-3.module+el8.9.0+1608+45f68f05', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-plpython3-10.23-3.module+el8.9.0+1608+45f68f05', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-plpython3-debuginfo-10.23-3.module+el8.9.0+1608+45f68f05', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-pltcl-10.23-3.module+el8.9.0+1608+45f68f05', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-pltcl-debuginfo-10.23-3.module+el8.9.0+1608+45f68f05', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-server-10.23-3.module+el8.9.0+1608+45f68f05', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-server-debuginfo-10.23-3.module+el8.9.0+1608+45f68f05', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-server-devel-10.23-3.module+el8.9.0+1608+45f68f05', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-server-devel-debuginfo-10.23-3.module+el8.9.0+1608+45f68f05', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-static-10.23-3.module+el8.9.0+1608+45f68f05', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-test-10.23-3.module+el8.9.0+1608+45f68f05', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-test-debuginfo-10.23-3.module+el8.9.0+1608+45f68f05', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-test-rpm-macros-10.23-3.module+el8.9.0+1608+45f68f05', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-upgrade-10.23-3.module+el8.9.0+1608+45f68f05', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-upgrade-debuginfo-10.23-3.module+el8.9.0+1608+45f68f05', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-upgrade-devel-10.23-3.module+el8.9.0+1608+45f68f05', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-upgrade-devel-debuginfo-10.23-3.module+el8.9.0+1608+45f68f05', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
};
