...
# AlmaLinux Security Advisory ALSA-2023:0284.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:0284");

  script_name(english:"AlmaLinux 8 : sudo (ALSA-2023:0284)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2023-0284.html");
