...
# extracted from VMware Security Advisory PHSA-2021-1.0-0383. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Rpm PHSA-2021-1.0-0383");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the rpm package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-1.0-383.md");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'rpm-4.13.0.2-4.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'rpm-build-4.13.0.2-4.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'rpm-devel-4.13.0.2-4.ph1')) flag++;
