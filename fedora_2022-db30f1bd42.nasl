...
# extracted from Fedora Security Advisory FEDORA-2022-db30f1bd42
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-db30f1bd42");

  script_name(english:"Fedora 35 : flac (2022-db30f1bd42)");
...
FEDORA-2022-db30f1bd42 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-db30f1bd42");
...
var pkgs = [
    {'reference':'flac-1.3.4-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
