...
if (description)
{
  ...
  script_name(english:"Adobe Audition < 14.4.2 Multiple Vulnerabilities (APSB21-92) (macOS)");

  script_set_attribute(attribute:"synopsis", value:
"The Adobe Audition instance installed on the remote host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Audition installed on the remote macOS host is prior to 14.4.2. It is, therefore, affected by
