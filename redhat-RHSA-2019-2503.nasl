...
# extracted from Red Hat Security Advisory RHSA-2019:2503. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:2503");
  script_xref(name:"TRA", value:"TRA-2019-35");

  script_name(english:"RHEL 7 : OpenShift Container Platform 3.11 jenkins (RHSA-2019:2503)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for OpenShift Container Platform 3.11 jenkins.");
...
referenced in the RHSA-2019:2503 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_2503.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2b0bd95f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:2503");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1730824");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1730869");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1730877");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 3.11 jenkins package based on the guidance in RHSA-2019:2503.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jenkins-2.176.2.1563460897-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-ansible'}
    ]
  }
];
