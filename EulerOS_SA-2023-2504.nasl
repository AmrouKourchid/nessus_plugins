...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : libxml2 (EulerOS-SA-2023-2504)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2504
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?69f745db");
...
var pkgs = [
  "libxml2-2.9.8-4.h23.eulerosv2r8",
  "libxml2-devel-2.9.8-4.h23.eulerosv2r8",
  "python2-libxml2-2.9.8-4.h23.eulerosv2r8",
  "python3-libxml2-2.9.8-4.h23.eulerosv2r8"
];
