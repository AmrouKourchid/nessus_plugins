...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : Moderate: / file (ELSA-2007-0391)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2007-0391.html");
...
"Update the affected file package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2007-2799");
...
var pkgs = [
    {'reference':'file-4.17-9.0.1.el5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'file-4.17-9.0.1.el5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
