...
# extracted from Fedora Security Advisory FEDORA-2023-578506ae4b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-578506ae4b");

  script_name(english:"Fedora 36 : firefox (2023-578506ae4b)");
...
FEDORA-2023-578506ae4b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-578506ae4b");
...
var pkgs = [
    {'reference':'firefox-110.0-3.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
