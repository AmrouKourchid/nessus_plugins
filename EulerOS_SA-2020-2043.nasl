...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.6.0 : netpbm (EulerOS-SA-2020-2043)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2043
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?72397219");
...
pkgs = ["netpbm-10.83.01-1.eulerosv2r8",
        "netpbm-progs-10.83.01-1.eulerosv2r8"];
