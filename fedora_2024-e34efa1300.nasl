...
# extracted from Fedora Security Advisory FEDORA-2024-e34efa1300
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-e34efa1300");

  script_name(english:"Fedora 39 : baresip (2024-e34efa1300)");
...
FEDORA-2024-e34efa1300 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-e34efa1300");
  script_set_attribute(attribute:"solution", value:
"Update the affected baresip package.");
...
var pkgs = [
    {'reference':'baresip-3.10.1-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'baresip');
}
