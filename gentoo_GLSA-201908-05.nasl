...
# extracted from Gentoo Linux Security Advisory GLSA 201908-05.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201908-05");

  script_name(english:"GLSA-201908-05 : LibVNCServer: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-201908-05
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/201908-05");
...
"All LibVNCServer users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-7226");
...
if (qpkg_check(package:"net-libs/libvncserver", unaffected:make_list("ge 0.9.12"), vulnerable:make_list("lt 0.9.12"))) flag++;
