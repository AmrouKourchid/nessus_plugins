...
# SUSE update advisory SUSE-SU-2023:4961-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:4961-1");

  script_name(english:"SUSE SLES12 Security Update : ppp (SUSE-SU-2023:4961-1)");
...
in the SUSE-SU-2023:4961-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-December/017531.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9f41fbb6");
...
var pkgs = [
    {'reference':'ppp-2.4.7-4.6.1', 'sp':'5', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5']},
    {'reference':'ppp-devel-2.4.7-4.6.1', 'sp':'5', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5']},
    {'reference':'ppp-devel-2.4.7-4.6.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-sdk-release-12.5', 'sles-release-12.5']},
    {'reference':'ppp-2.4.7-4.6.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.5']}
];
