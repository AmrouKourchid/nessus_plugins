...
# extracted from Red Hat Security Advisory http-cache-semantics. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 8 : http-cache-semantics (Unpatched Vulnerability) (deprecated)");
