...
# extracted from Mozilla Foundation Security Advisory mfsa2024-59.
...
if (description)
{
  ...
  script_name(english:"Mozilla Thunderbird < 132.0");

  script_set_attribute(attribute:"synopsis", value:
"A mail client installed on the remote macOS or Mac OS X host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Thunderbird installed on the remote macOS or Mac OS X host is prior to 132.0. It is, therefore, affected
by multiple vulnerabilities as referenced in the mfsa2024-59 advisory.
  ...
  - Potential race conditions in IndexedDB could have caused memory corruption, leading to a potentially
    exploitable crash. (CVE-2024-10468)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2024-59/");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Mozilla Thunderbird version 132.0 or later.");
...
mozilla_check_version(version:version, path:path, product:'thunderbird', esr:FALSE, fix:'132.0', severity:SECURITY_HOLE);
