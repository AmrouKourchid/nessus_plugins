...
# extracted from Oracle Linux Security Advisory ELSA-2021-1751.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : mailman:2.1 (ELSA-2021-1751)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2021-1751.html");
...
var appstreams = {
    'mailman:2.1': [
      {'reference':'mailman-2.1.29-11.module+el8.4.0+20063+5e2c6e6e', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      {'reference':'mailman-2.1.29-11.module+el8.4.0+20063+5e2c6e6e', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'}
    ]
};
