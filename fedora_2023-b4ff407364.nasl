...
# extracted from Fedora Security Advisory FEDORA-2023-b4ff407364
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-b4ff407364");

  script_name(english:"Fedora 37 : mariadb (2023-b4ff407364)");
...
FEDORA-2023-b4ff407364 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-b4ff407364");
...
var pkgs = [
    {'reference':'mariadb-10.5.20-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'}
];
