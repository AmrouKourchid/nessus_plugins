...
if (description)
{
  ...
  script_cve_id("CVE-2024-7018");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-7018");
...
patch available.
  ...
  - Heap buffer overflow in PDF in Google Chrome prior to 124.0.6367.78 allowed a remote attacker to
    potentially exploit heap corruption via a crafted PDF file. (Chromium security severity: Medium)
    (CVE-2024-7018)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-7018");
