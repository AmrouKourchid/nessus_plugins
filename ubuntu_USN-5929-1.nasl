...
# extracted from Ubuntu Security Notice USN-5929-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5929-1");

  script_name(english:"Ubuntu 22.10 : Linux kernel (Raspberry Pi) vulnerabilities (USN-5929-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5929-1");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.19.0-1014-raspi");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.19.0-1014-raspi-nolpae");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-5929-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2022-3169', 'CVE-2022-3344', 'CVE-2022-3435', 'CVE-2022-3521', 'CVE-2022-3545', 'CVE-2022-4139', 'CVE-2022-4379', 'CVE-2022-45869', 'CVE-2022-47518', 'CVE-2022-47519', 'CVE-2022-47520', 'CVE-2022-47521', 'CVE-2023-0179', 'CVE-2023-0461');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-5929-1');
  }
  else
  {
