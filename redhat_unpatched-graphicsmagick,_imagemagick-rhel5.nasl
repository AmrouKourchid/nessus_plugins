...
# extracted from Red Hat Security Advisory graphicsmagick,_imagemagick. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2017-12427", "CVE-2017-12430");

  script_name(english:"RHEL 5 : graphicsmagick,_imagemagick (Unpatched Vulnerability) (deprecated)");
