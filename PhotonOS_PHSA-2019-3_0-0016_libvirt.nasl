...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Libvirt PHSA-2019-3.0-0016");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libvirt-4.7.0-3.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libvirt-debuginfo-4.7.0-3.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libvirt-devel-4.7.0-3.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libvirt-docs-4.7.0-3.ph3')) flag++;
