...
# Rocky Linux Security Advisory RLSA-2022:8226.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2022:8226");

  script_name(english:"Rocky Linux 9 : python-lxml (RLSA-2022:8226)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2022:8226");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2107571");
  script_set_attribute(attribute:"solution", value:
"Update the affected python3-lxml and / or python3-lxml-debuginfo packages.");
...
var pkgs = [
    ...
    {'reference':'python3-lxml-4.6.5-3.el9', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-lxml-4.6.5-3.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-lxml-debuginfo-4.6.5-3.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-lxml-debuginfo-4.6.5-3.el9', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-lxml-debuginfo-4.6.5-3.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python3-lxml / python3-lxml-debuginfo');
}
