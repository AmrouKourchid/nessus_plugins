...
# extracted from Fedora Security Advisory FEDORA-2023-7e185b8c12
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-7e185b8c12");

  script_name(english:"Fedora 37 : golang (2023-7e185b8c12)");
...
FEDORA-2023-7e185b8c12 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-7e185b8c12");
...
var pkgs = [
    {'reference':'golang-1.20.11-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
