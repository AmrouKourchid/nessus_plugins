...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : python (EulerOS-SA-2021-1512)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1512
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?06f6a2d5");
...
pkgs = ["python-2.7.5-69.h32.eulerosv2r7",
        "python-devel-2.7.5-69.h32.eulerosv2r7",
        "python-libs-2.7.5-69.h32.eulerosv2r7",
        "tkinter-2.7.5-69.h32.eulerosv2r7"];
