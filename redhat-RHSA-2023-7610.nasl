...
# extracted from Red Hat Security Advisory RHSA-2023:7610. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2023-44487", "CVE-2023-46136");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2023/10/31");
  script_xref(name:"RHSA", value:"2023:7610");
  script_xref(name:"CEA-ID", value:"CEA-2024-0004");

  script_name(english:"RHEL 8 / 9 : OpenShift Container Platform 4.12.45 (RHSA-2023:7610)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for OpenShift Container Platform 4.12.45.");
...
referenced in the RHSA-2023:7610 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.12.45. See the
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_7610.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f87d845c");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:7610");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.12.45 packages based on the guidance in RHSA-2023:7610.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cri-o-1.25.5-2.rhaos4.12.git0217273.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2023-44487']}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'python3-werkzeug-2.0.3-5.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2023-46136']}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'cri-o / python3-werkzeug');
}
