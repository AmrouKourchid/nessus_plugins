...
if (description)
{
  ...
  script_name(english:"RHEL 8 : nghttp2 (RHSA-2019:2692)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for nghttp2.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2019:2692 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_2692.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7a37d3a2");
...
"Update the RHEL nghttp2 package based on the guidance in RHSA-2019:2692.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libnghttp2-1.33.0-1.el8_0.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libnghttp2-devel-1.33.0-1.el8_0.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nghttp2-1.33.0-1.el8_0.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
