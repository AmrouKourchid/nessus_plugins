...
# extracted from Fedora Security Advisory FEDORA-2023-3ca351353f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-3ca351353f");

  script_name(english:"Fedora 38 : moodle (2023-3ca351353f)");
...
FEDORA-2023-3ca351353f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-3ca351353f");
...
"Update the affected moodle package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-35133");
...
var pkgs = [
    {'reference':'moodle-4.1.4-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
