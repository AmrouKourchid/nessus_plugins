...
# extracted from Fedora Security Advisory FEDORA-2023-ca086f015c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-ca086f015c");
  script_xref(name:"IAVB", value:"2023-B-0061-S");

  script_name(english:"Fedora 38 : krb5 (2023-ca086f015c)");
...
FEDORA-2023-ca086f015c advisory.

    This is a backport of the upstream fix for CVE-2023-39975:
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-ca086f015c");
...
var pkgs = [
    {'reference':'krb5-1.21-3.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
