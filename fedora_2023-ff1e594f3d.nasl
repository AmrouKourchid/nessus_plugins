...
# extracted from Fedora Security Advisory FEDORA-2023-ff1e594f3d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-ff1e594f3d");

  script_name(english:"Fedora 40 : rclone (2023-ff1e594f3d)");
...
FEDORA-2023-ff1e594f3d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-ff1e594f3d");
...
var pkgs = [
    {'reference':'rclone-1.64.0-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
