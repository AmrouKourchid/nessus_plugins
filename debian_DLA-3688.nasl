...
# extracted from Debian Security Advisory dla-3688. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3688 : haproxy - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3688
advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-45539");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'haproxy', 'reference': '1.8.19-1+deb10u5'},
    {'release': '10.0', 'prefix': 'haproxy-doc', 'reference': '1.8.19-1+deb10u5'},
    {'release': '10.0', 'prefix': 'vim-haproxy', 'reference': '1.8.19-1+deb10u5'}
];
