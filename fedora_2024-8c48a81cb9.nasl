...
# extracted from Fedora Security Advisory FEDORA-2024-8c48a81cb9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-8c48a81cb9");

  script_name(english:"Fedora 40 : yyjson (2024-8c48a81cb9)");
...
FEDORA-2024-8c48a81cb9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-8c48a81cb9");
...
var pkgs = [
    {'reference':'yyjson-0.9.0-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
