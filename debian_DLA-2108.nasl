...
# extracted from Debian Security Advisory DLA-2108-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2108-1 : clamav security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2020/02/msg00016.html");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"clamav", reference:"0.101.5+dfsg-0+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"clamav-base", reference:"0.101.5+dfsg-0+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"clamav-daemon", reference:"0.101.5+dfsg-0+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"clamav-dbg", reference:"0.101.5+dfsg-0+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"clamav-docs", reference:"0.101.5+dfsg-0+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"clamav-freshclam", reference:"0.101.5+dfsg-0+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"clamav-milter", reference:"0.101.5+dfsg-0+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"clamav-testfiles", reference:"0.101.5+dfsg-0+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"clamdscan", reference:"0.101.5+dfsg-0+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"libclamav-dev", reference:"0.101.5+dfsg-0+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"libclamav7", reference:"0.101.5+dfsg-0+deb8u1")) flag++;
