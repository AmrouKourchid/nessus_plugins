...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5034123");
  script_xref(name:"MSFT", value:"MS24-5034123");
  script_xref(name:"IAVA", value:"2024-A-0015-S");
  script_xref(name:"IAVA", value:"2024-A-0016-S");

  script_name(english:"KB5034123: Windows 11 version 22H2 / Windows 11 version 23H2 Security Update (January 2024)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5034123");
