...
# extracted from Fedora Security Advisory FEDORA-2023-cb2e422088
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-cb2e422088");

  script_name(english:"Fedora 37 : pcs (2023-cb2e422088)");
...
FEDORA-2023-cb2e422088 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-cb2e422088");
...
var pkgs = [
    {'reference':'pcs-0.11.5-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
