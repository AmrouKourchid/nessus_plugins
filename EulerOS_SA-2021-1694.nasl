...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : openssh (EulerOS-SA-2021-1694)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1694
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?62ff3940");
