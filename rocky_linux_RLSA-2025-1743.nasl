...
# Rocky Linux Security Advisory RLSA-2025:1743.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2025:1743");

  script_name(english:"RockyLinux 9 : postgresql:16 (RLSA-2025:1743)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2025:1743");
