...
# extracted from Fedora Security Advisory FEDORA-2023-371519fd09
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-371519fd09");
  script_xref(name:"IAVB", value:"2023-B-0019-S");

  script_name(english:"Fedora 37 : qemu (2023-371519fd09)");
...
FEDORA-2023-371519fd09 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-371519fd09");
...
var pkgs = [
    {'reference':'qemu-7.0.0-15.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
