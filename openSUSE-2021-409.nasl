...
# extracted from openSUSE Security Update openSUSE-2021-409.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : stunnel (openSUSE-2021-409)");
...
project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1177580");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1182529");
...
if ( rpm_check(release:"SUSE15.2", reference:"stunnel-5.57-lp152.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"stunnel-debuginfo-5.57-lp152.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"stunnel-debugsource-5.57-lp152.2.6.1") ) flag++;
