...
# extracted from Red Hat Security Advisory RHSA-2024:3676. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:3676");
  script_xref(name:"IAVA", value:"2024-A-0356");

  script_name(english:"RHEL 8 / 9 : OpenShift Container Platform 4.15.17 (RHSA-2024:3676)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for OpenShift Container Platform 4.15.17.");
...
in the RHSA-2024:3676 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.15.17. See the
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_3676.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?22de4bf2");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2280190");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:3676");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.15.17 package based on the guidance in RHSA-2024:3676.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cri-o-1.28.7-2.rhaos4.15.git111aec5.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'cri-o-1.28.7-2.rhaos4.15.git111aec5.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
