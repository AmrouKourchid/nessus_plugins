...
# extracted from VMware Security Advisory PHSA-2023-4.0-0371. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Curl PHSA-2023-4.0-0371");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the curl package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-371.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'curl-8.0.1-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'curl-devel-8.0.1-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'curl-libs-8.0.1-1.ph4')) flag++;
