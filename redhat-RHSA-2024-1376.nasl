...
# extracted from Red Hat Security Advisory RHSA-2024:1376. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2023-50269", "CVE-2024-25111", "CVE-2024-25617");
  script_xref(name:"RHSA", value:"2024:1376");

  script_name(english:"RHEL 9 : squid (RHSA-2024:1376)");
...
referenced in the RHSA-2024:1376 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_1376.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?addaf776");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:1376");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL squid package based on the guidance in RHSA-2024:1376.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'squid-5.5-6.el9_3.8', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
    ]
  }
];
