...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : python-pillow (EulerOS-SA-2024-2378)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2378
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?21c0eaff");
...
var pkgs = [
  "python3-pillow-5.3.0-4.h25.eulerosv2r9"
];
