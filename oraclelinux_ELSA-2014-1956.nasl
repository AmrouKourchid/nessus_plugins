...
# Oracle Linux Security Advisory ELSA-2014-1956 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : wpa_supplicant (ELSA-2014-1956)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2014-1956.html");
...
var pkgs = [
    {'reference':'wpa_supplicant-2.0-13.el7_0', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
