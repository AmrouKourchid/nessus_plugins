...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : compat-openssl (EulerOS-SA-2024-2021)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the compat-openssl package installed, the EulerOS installation on the remote host is
...
Tenable has extracted the preceding description block directly from the EulerOS compat-openssl security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2021
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cfbe2eb0");
...
var pkgs = [
  "compat-openssl10-1.0.2o-3.h23.eulerosv2r8"
];
