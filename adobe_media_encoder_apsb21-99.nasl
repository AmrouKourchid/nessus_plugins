...
if (description)
{
  ...
  script_name(english:"Adobe Media Encoder < 15.4.2 Multiple Vulnerabilities (APSB21-99)");

  script_set_attribute(attribute:"synopsis", value:
"The Adobe Media Encoder instance installed on the remote host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Media Encoder installed on the remote Windows host is prior to 15.4.2. It is, therefore, affected
by multiple vulnerabilities as referenced in the APSB21-99 advisory.
