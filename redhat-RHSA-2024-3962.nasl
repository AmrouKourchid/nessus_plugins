...
# extracted from Red Hat Security Advisory RHSA-2024:3962. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:3962");

  script_name(english:"RHEL 8 : flatpak (RHSA-2024:3962)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for flatpak.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:3962 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_3962.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7d1cfc6c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:3962");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL flatpak package based on the guidance in RHSA-2024:3962.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'flatpak-1.10.7-2.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'flatpak-devel-1.10.7-2.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'flatpak-libs-1.10.7-2.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'flatpak-selinux-1.10.7-2.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'flatpak-session-helper-1.10.7-2.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
