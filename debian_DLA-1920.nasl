...
# extracted from Debian Security Advisory DLA-1920-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1920-1 : golang-go.crypto security update");
...
Headers, but also prepend arbitrary text to cleartext messages without
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2019/09/msg00011.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/jessie/golang-go.crypto");
  script_set_attribute(attribute:"solution", value:
"Upgrade the affected golang-go.crypto-dev package.");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"golang-go.crypto-dev", reference:"0.0~hg190-1+deb8u2")) flag++;
