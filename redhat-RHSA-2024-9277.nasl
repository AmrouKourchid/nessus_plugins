...
# extracted from Red Hat Security Advisory RHSA-2024:9277. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:9277");

  script_name(english:"RHEL 9 : oci-seccomp-bpf-hook (RHSA-2024:9277)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for oci-seccomp-bpf-hook.");
...
the RHSA-2024:9277 advisory.

    OCI Hook to generate seccomp json files based on EBF syscalls used by container oci-seccomp-bpf-hook
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dc2fec75");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:9277");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL oci-seccomp-bpf-hook package based on the guidance in RHSA-2024:9277.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'oci-seccomp-bpf-hook-1.2.10-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'oci-seccomp-bpf-hook');
}
