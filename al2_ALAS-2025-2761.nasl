...
# extracted from Amazon Linux 2 Security Advisory ALAS-2025-2761.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : python-ipaddress (ALAS-2025-2761)");
...
vulnerability as referenced in the ALAS2-2025-2761 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2025-2761.html");
...
var pkgs = [
    {'reference':'python-ipaddress-1.0.16-2.amzn2.0.3', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
