...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : libtasn1 (EulerOS-SA-2023-1325)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the libtasn1 packages installed, the EulerOS installation on the remote host is affected by
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1325
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4180baab");
...
var pkgs = [
  "libtasn1-4.13-4.h1.eulerosv2r8",
  "libtasn1-devel-4.13-4.h1.eulerosv2r8"
];
