...
if (description)
{
  ...
  script_name(english:"Fortinet FortiClient Dylib injection (FG-IR-21-079) (macOS)");
...
vulnerability as referenced in the FG-IR-21-079 advisory.

  - An improper control of generation of code vulnerability [CWE-94] in FortiClientMacOS versions 7.0.0 and
    below and 6.4.5 and below may allow an authenticated attacker to hijack the MacOS camera without the user
    permission via the malicious dylib file. (CVE-2021-42754)
...
"Please upgrade to FortiClientMac version 6.4.6/7.0.1 or later.");
