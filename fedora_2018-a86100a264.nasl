...
# extracted from Fedora Security Advisory FEDORA-2018-a86100a264.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-a86100a264");

  script_name(english:"Fedora 28 : PackageKit (2018-a86100a264)");
...
"New upstream release
  ...
  - This release fixes CVE-2018-1106 which is a moderate
    security issue.
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-a86100a264");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"PackageKit-1.1.10-1.fc28")) flag++;
