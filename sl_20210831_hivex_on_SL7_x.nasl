...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"RHSA-2021:3338");

  script_name(english:"Scientific Linux Security Update : hivex on SL7.x i686/x86_64 (2021:3338)");
...
SLSA-2021:3338-1 advisory.

  - hivex: stack overflow due to recursive call of _get_children() (CVE-2021-3622)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.scientificlinux.org/category/sl-errata/slsa-20213338-1");
...
var pkgs = [
    {'reference':'hivex-1.3.10-6.12.el7_9', 'cpu':'i686', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'hivex-1.3.10-6.12.el7_9', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'hivex-debuginfo-1.3.10-6.12.el7_9', 'cpu':'i686', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'hivex-debuginfo-1.3.10-6.12.el7_9', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'hivex-devel-1.3.10-6.12.el7_9', 'cpu':'i686', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'hivex-devel-1.3.10-6.12.el7_9', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ocaml-hivex-1.3.10-6.12.el7_9', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ocaml-hivex-devel-1.3.10-6.12.el7_9', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'perl-hivex-1.3.10-6.12.el7_9', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python-hivex-1.3.10-6.12.el7_9', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ruby-hivex-1.3.10-6.12.el7_9', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE}
];
