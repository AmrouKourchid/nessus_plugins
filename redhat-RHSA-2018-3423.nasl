...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2018/rhsa-2018_3423.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?20c46179");
...
"Update the RHEL qemu-kvm package based on the guidance in RHSA-2018:3423.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libcacard-1.5.3-105.el7_2.18', 'sp':'2', 'cpu':'i686', 'release':'7', 'el_string':'el7_2', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10'},
      {'reference':'libcacard-1.5.3-105.el7_2.18', 'sp':'2', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_2', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10'},
      {'reference':'libcacard-devel-1.5.3-105.el7_2.18', 'sp':'2', 'cpu':'i686', 'release':'7', 'el_string':'el7_2', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10'},
      {'reference':'libcacard-devel-1.5.3-105.el7_2.18', 'sp':'2', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_2', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10'},
      {'reference':'libcacard-tools-1.5.3-105.el7_2.18', 'sp':'2', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_2', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10'},
      {'reference':'qemu-img-1.5.3-105.el7_2.18', 'sp':'2', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_2', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10'},
      {'reference':'qemu-kvm-1.5.3-105.el7_2.18', 'sp':'2', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_2', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10'},
      {'reference':'qemu-kvm-common-1.5.3-105.el7_2.18', 'sp':'2', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_2', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10'},
      {'reference':'qemu-kvm-tools-1.5.3-105.el7_2.18', 'sp':'2', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_2', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10'}
    ]
  }
];
