...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Ntp PHSA-2023-3.0-0606");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'ntp-4.2.8p16-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'ntp-perl-4.2.8p16-1.ph3')) flag++;
