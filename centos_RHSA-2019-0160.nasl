...
# CentOS Errata and Security Advisory 2019:0160 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : thunderbird (CESA-2019:0160)");
...
original reporters.");
  # https://lists.centos.org/pipermail/centos-announce/2019-February/023154.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?493fcb91");
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"thunderbird-60.4.0-1.el7.centos", allowmaj:TRUE)) flag++;
