...
# extracted from Red Hat Security Advisory RHSA-2024:1408. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:1408");

  script_name(english:"RHEL 8 : emacs (RHSA-2024:1408)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for emacs.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:1408 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_1408.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e4861265");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:1408");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL emacs package based on the guidance in RHSA-2024:1408.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'emacs-26.1-10.el8_8.4', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'emacs-common-26.1-10.el8_8.4', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'emacs-filesystem-26.1-10.el8_8.4', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'emacs-lucid-26.1-10.el8_8.4', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'emacs-nox-26.1-10.el8_8.4', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'emacs-terminal-26.1-10.el8_8.4', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
