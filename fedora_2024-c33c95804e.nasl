...
# extracted from Fedora Security Advisory FEDORA-2024-c33c95804e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-c33c95804e");

  script_name(english:"Fedora 41 : golang-x-crypto (2024-c33c95804e)");
...
FEDORA-2024-c33c95804e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-c33c95804e");
...
var pkgs = [
    {'reference':'golang-x-crypto-0.31.0-2.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
