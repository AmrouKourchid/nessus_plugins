...
# extracted from Fedora Security Advisory FEDORA-2024-b93312a597
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-b93312a597");

  script_name(english:"Fedora 38 : syncthing (2024-b93312a597)");
...
FEDORA-2024-b93312a597 advisory.

    Update to version 1.27.3.

    Release notes: https://github.com/syncthing/syncthing/releases/tag/v1.27.3

    This update also addresses CVE-2023-49295 in quic-go: https://github.com/quic-go/quic-
    go/security/advisories/GHSA-ppxx-5m9h-6vxf

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-b93312a597");
...
var pkgs = [
    {'reference':'syncthing-1.27.3-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
