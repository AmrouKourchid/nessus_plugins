...
# extracted from Fedora Security Advisory FEDORA-2023-cb5feb5602
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-cb5feb5602");

  script_name(english:"Fedora 37 : java-1.8.0-openjdk (2023-cb5feb5602)");
...
FEDORA-2023-cb5feb5602 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-cb5feb5602");
...
var pkgs = [
    {'reference':'java-1.8.0-openjdk-1.8.0.372.b07-6.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
