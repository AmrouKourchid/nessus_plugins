...
if (description)
{
  ...
  script_cve_id("CVE-2025-0725");
  script_xref(name:"IAVA", value:"2025-A-0085");

  script_name(english:"EulerOS 2.0 SP10 : curl (EulerOS-SA-2025-1503)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1503
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?63a53e7e");
...
var pkgs = [
  "curl-7.71.1-4.h31.r4.eulerosv2r10",
  "libcurl-7.71.1-4.h31.r4.eulerosv2r10"
];
