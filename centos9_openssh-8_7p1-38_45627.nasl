...
if (description)
{
  ...
  script_name(english:"CentOS 9 : openssh-8.7p1-38.el9");
...
openssh-8.7p1-38.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=45627");
...
var pkgs = [
    {'reference':'openssh-8.7p1-38.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'openssh-askpass-8.7p1-38.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'openssh-clients-8.7p1-38.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'openssh-keycat-8.7p1-38.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'openssh-server-8.7p1-38.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'openssh-sk-dummy-8.7p1-38.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'pam_ssh_agent_auth-0.10.4-5.38.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
