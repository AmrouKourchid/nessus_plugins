...
# extracted from Fedora Security Advisory FEDORA-2023-fd63c401df
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-fd63c401df");

  script_name(english:"Fedora 38 : libheif (2023-fd63c401df)");
...
FEDORA-2023-fd63c401df advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-fd63c401df");
...
var pkgs = [
    {'reference':'libheif-1.15.2-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
