...
if (description)
{
  ...
  script_cve_id("CVE-2017-18085");
  script_bugtraq_id(103062);

  script_name(english:"Atlassian Confluence < 6.6.1 viewdefaultdecorator Reflected XSS (CVE-2017-18085)");
...
Confluence application running on the remote host is prior to 6.6.1.
It is, therefore, affected by a reflected cross-site scripting
vulnerability in the viewdefaultdecorator resource.

Note that Nessus has not tested for this issue but has instead relied
only on the application's self-reported version number.");
  script_set_attribute(attribute:"see_also", value:"https://jira.atlassian.com/browse/CONFSERVER-54905");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Atlassian Confluence version 6.6.1 or later.");
...
if (version =~ '^6(\\.6)?$') audit(AUDIT_VER_NOT_GRANULAR, "Confluence", port, version);
