...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.1 : procps-ng (EulerOS-SA-2023-3366)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the procps-ng packages installed, the EulerOS Virtualization installation on the remote
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3366
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4c701219");
...
"Update the affected procps-ng packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:procps-ng-i18n");
...
var pkgs = [
  "procps-ng-3.3.17-2.h15.eulerosv2r11",
  "procps-ng-i18n-3.3.17-2.h15.eulerosv2r11"
];
