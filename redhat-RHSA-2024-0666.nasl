...
# extracted from Red Hat Security Advisory RHSA-2024:0666. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:0666");

  script_name(english:"RHEL 8 : OpenShift Container Platform 4.12.49 (RHSA-2024:0666)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for OpenShift Container Platform 4.12.49.");
...
the RHSA-2024:0666 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.12.49. See the
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?54fb5de8");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0666");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.12.49 packages based on the guidance in RHSA-2024:0666.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'runc-1.1.6-5.1.rhaos4.12.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube'}
    ]
  }
];
