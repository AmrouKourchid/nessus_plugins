...
# extracted from Fedora Security Advisory FEDORA-2024-1e29ad7d25
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-1e29ad7d25");

  script_name(english:"Fedora 40 : mingw-glib2 (2024-1e29ad7d25)");
...
FEDORA-2024-1e29ad7d25 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-1e29ad7d25");
...
var pkgs = [
    {'reference':'mingw-glib2-2.82.2-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
