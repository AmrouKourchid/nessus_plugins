...
# extracted from Red Hat Security Advisory RHSA-2024:3823. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2024-2905");
  script_xref(name:"RHSA", value:"2024:3823");
  script_xref(name:"IAVA", value:"2024-A-0356");

  script_name(english:"RHEL 9 : rpm-ostree (RHSA-2024:3823)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_3823.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b3f51de8");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2271585");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:3823");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rpm-ostree package based on the guidance in RHSA-2024:3823.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:C/I:N/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:N/UI:N/S:U/C:H/I:N/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-2905");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rpm-ostree-2024.3-3.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-ostree-libs-2024.3-3.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'rpm-ostree-2024.3-3.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-ostree-libs-2024.3-3.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
