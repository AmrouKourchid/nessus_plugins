...
# extracted from Fedora Security Advisory FEDORA-2022-63ca9a1129
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-63ca9a1129");

  script_name(english:"Fedora 35 : vim (2022-63ca9a1129)");
...
FEDORA-2022-63ca9a1129 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-63ca9a1129");
...
"Update the affected 2:vim package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-0729");
...
var pkgs = [
    {'reference':'vim-8.2.4460-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
