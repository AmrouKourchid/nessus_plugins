...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.2.0 : openssl (EulerOS-SA-2021-1376)");
...
affected by the following vulnerability :
  ...
  - A null pointer dereference flaw was found in openssl. A
    remote attacker, able to control the arguments of the
    GENERAL_NAME_cmp function, could cause the application,
    compiled with openssl to crash resulting in a denial of
    service. The highest threat from this vulnerability is
    to system availability.(CVE-2020-1971)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1376
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2e01358e");
...
pkgs = ["openssl-1.0.2k-16.h11",
        "openssl-devel-1.0.2k-16.h11",
        "openssl-libs-1.0.2k-16.h11"];
