...
# Oracle Linux Security Advisory ELSA-2020-0850 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : python-pip (ELSA-2020-0850)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2020-0850.html");
...
var pkgs = [
    {'reference':'python3-pip-9.0.3-7.el7_7', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
];
