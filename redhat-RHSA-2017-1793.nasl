...
# extracted from Red Hat Security Advisory RHSA-2017:1793. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : graphite2 (RHSA-2017:1793)");
...
original reporters of these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2017:1793"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", reference:"graphite2-1.3.10-1.el7_3")) flag++;

  if (rpm_check(release:"RHEL7", reference:"graphite2-debuginfo-1.3.10-1.el7_3")) flag++;

  if (rpm_check(release:"RHEL7", reference:"graphite2-devel-1.3.10-1.el7_3")) flag++;
