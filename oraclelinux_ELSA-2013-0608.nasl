...
# Oracle Linux Security Advisory ELSA-2013-0608 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : kvm (ELSA-2013-0608)");
...
ELSA-2013-0608 advisory.
    ...
    LPE flags are disabled [rhel-5.9.z])

Tenable has extracted the preceding description block directly from the Oracle Linux security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2013-0608.html");
...
var pkgs = [
    {'reference':'kmod-kvm-83-262.0.1.el5_9.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kmod-kvm-debug-83-262.0.1.el5_9.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kvm-83-262.0.1.el5_9.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kvm-qemu-img-83-262.0.1.el5_9.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kvm-tools-83-262.0.1.el5_9.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kmod-kvm / kmod-kvm-debug / kvm / etc');
}
