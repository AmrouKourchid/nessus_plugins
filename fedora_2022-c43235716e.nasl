...
# extracted from Fedora Security Advisory FEDORA-2022-c43235716e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-c43235716e");

  script_name(english:"Fedora 35 : mingw-expat (2022-c43235716e)");
...
FEDORA-2022-c43235716e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-c43235716e");
...
var pkgs = [
    {'reference':'mingw-expat-2.5.0-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
