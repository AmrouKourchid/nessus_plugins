...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"4020535");
  script_xref(name:"MSFT", value:"MS17-4020535");

  script_name(english:"KB4020535: Security Update for the Scripting Engine Memory Corruption Vulnerability (May 2017)");
...
open a specially crafted document file, to execute arbitrary code.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/4020535/title/");
...
"Apply security update KB4020535.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-0158");
...
if (
  ...
  # Windows Server 2008
  hotfix_is_vulnerable(os:"6.0", sp:2, file:"Msado15.dll", version:"6.0.6002.24092", min_version:"6.0.6002.22000", path:ado_path, bulletin:bulletin, kb:kb) ||
  hotfix_is_vulnerable(os:"6.0", sp:2, file:"Msado15.dll", version:"6.0.6002.19774", min_version:"6.0.6002.18000", path:ado_path, bulletin:bulletin, kb:kb)
