...
# extracted from Debian Security Advisory dla-3717. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3717 : zabbix-agent - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-32723");
...
"Upgrade the zabbix-agent packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-32723");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'zabbix-agent', 'reference': '1:4.0.4+dfsg-1+deb10u4'},
    {'release': '10.0', 'prefix': 'zabbix-frontend-php', 'reference': '1:4.0.4+dfsg-1+deb10u4'},
    {'release': '10.0', 'prefix': 'zabbix-java-gateway', 'reference': '1:4.0.4+dfsg-1+deb10u4'},
    {'release': '10.0', 'prefix': 'zabbix-proxy-mysql', 'reference': '1:4.0.4+dfsg-1+deb10u4'},
    {'release': '10.0', 'prefix': 'zabbix-proxy-pgsql', 'reference': '1:4.0.4+dfsg-1+deb10u4'},
    {'release': '10.0', 'prefix': 'zabbix-proxy-sqlite3', 'reference': '1:4.0.4+dfsg-1+deb10u4'},
    {'release': '10.0', 'prefix': 'zabbix-server-mysql', 'reference': '1:4.0.4+dfsg-1+deb10u4'},
    {'release': '10.0', 'prefix': 'zabbix-server-pgsql', 'reference': '1:4.0.4+dfsg-1+deb10u4'}
];
