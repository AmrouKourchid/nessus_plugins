...
# extracted from Ubuntu Security Notice USN-5073-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5073-2");

  script_name(english:"Ubuntu 16.04 ESM / 18.04 LTS : Linux kernel (GCP) vulnerabilities (USN-5073-2)");
...
referenced in the USN-5073-2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5073-2");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"plugin_publication_date", value:"2021/09/18");

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"cpe:/o:canonical:ubuntu_linux:16.04:-:esm");
  script_set_attribute(attribute:"cpe", value:"cpe:/o:canonical:ubuntu_linux:18.04:-:lts");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.15.0-1108-gcp");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-5073-2');
}
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-5073-2');
  }
  else
  {
