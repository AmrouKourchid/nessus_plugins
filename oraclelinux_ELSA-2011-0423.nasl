...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : post (ELSA-2011-0423)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2011-0423.html");
  script_set_attribute(attribute:"solution", value:
"Update the affected postfix and / or postfix-perl-scripts packages.");
...
var pkgs = [
    {'reference':'postfix-2.6.6-2.1.el6_0', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'postfix-perl-scripts-2.6.6-2.1.el6_0', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'postfix-2.6.6-2.1.el6_0', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'postfix-perl-scripts-2.6.6-2.1.el6_0', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
