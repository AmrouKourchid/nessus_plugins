...
# extracted from Red Hat Security Advisory RHSA-2024:5629. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:5629");

  script_name(english:"RHEL 9 : orc (RHSA-2024:5629)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_5629.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b20c6338");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:5629");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL orc package based on the guidance in RHSA-2024:5629.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'orc-0.4.31-7.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'orc-compiler-0.4.31-7.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'orc-devel-0.4.31-7.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
