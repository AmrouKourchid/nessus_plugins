...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : libseccomp (EulerOS-SA-2019-1794)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1794
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e860a62d");
...
pkgs = ["libseccomp-2.3.1-3.h2.eulerosv2r7"];
