...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : OpenJDK 7 vulnerabilities (USN-2487-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 14.04 LTS host has packages installed that are affected by multiple vulnerabilities as referenced in
the USN-2487-1 advisory.
    ...
    sensitive data over the network. (CVE-2014-3566, CVE-2014-6587, CVE-2014-6601, CVE-2015-0395,
    ...
    could exploit these to expose sensitive data over the network. (CVE-2014-6585, CVE-2014-6591,
    CVE-2015-0400, CVE-2015-0407)

    A vulnerability was discovered in the OpenJDK JRE related to information disclosure and integrity. An
    attacker could exploit this to expose sensitive data over the network. (CVE-2014-6593)

    A vulnerability was discovered in the OpenJDK JRE related to integrity and availability. An attacker could
    exploit this to cause a denial of service. (CVE-2015-0383)

    A vulnerability was discovered in the OpenJDK JRE related to availability. An attacker could this exploit
    to cause a denial of service. (CVE-2015-0410)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2487-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'icedtea-7-jre-jamvm', 'pkgver': '7u75-2.5.4-1~trusty1'},
    {'osver': '14.04', 'pkgname': 'openjdk-7-demo', 'pkgver': '7u75-2.5.4-1~trusty1'},
    {'osver': '14.04', 'pkgname': 'openjdk-7-jdk', 'pkgver': '7u75-2.5.4-1~trusty1'},
    {'osver': '14.04', 'pkgname': 'openjdk-7-jre', 'pkgver': '7u75-2.5.4-1~trusty1'},
    {'osver': '14.04', 'pkgname': 'openjdk-7-jre-headless', 'pkgver': '7u75-2.5.4-1~trusty1'},
    {'osver': '14.04', 'pkgname': 'openjdk-7-jre-lib', 'pkgver': '7u75-2.5.4-1~trusty1'},
    {'osver': '14.04', 'pkgname': 'openjdk-7-jre-zero', 'pkgver': '7u75-2.5.4-1~trusty1'},
    {'osver': '14.04', 'pkgname': 'openjdk-7-source', 'pkgver': '7u75-2.5.4-1~trusty1'}
];
