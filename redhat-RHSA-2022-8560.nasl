...
# extracted from Red Hat Security Advisory RHSA-2022:8560. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:8560");

  script_name(english:"RHEL 7 : hsqldb (RHSA-2022:8560)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for hsqldb.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2022:8560 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8560.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?53295a3b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2136141");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8560");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL hsqldb package based on the guidance in RHSA-2022:8560.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'hsqldb-1.8.1.3-15.el7_9', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'hsqldb-demo-1.8.1.3-15.el7_9', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'hsqldb-javadoc-1.8.1.3-15.el7_9', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'hsqldb-manual-1.8.1.3-15.el7_9', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
