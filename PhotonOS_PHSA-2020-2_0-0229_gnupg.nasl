...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Gnupg PHSA-2020-2.0-0229");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'gnupg-2.2.18-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'gnupg-debuginfo-2.2.18-1.ph2')) flag++;
