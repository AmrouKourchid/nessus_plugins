...
# extracted from Ubuntu Security Notice USN-3731-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 18.04 LTS : LFTP vulnerability (USN-3731-1)");
...
referenced in the USN-3731-1 advisory.

    It was discovered that LFTP incorrectly handled certain files. An attacker could possibly use this issue
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3731-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'lftp', 'pkgver': '4.4.13-1ubuntu0.1'},
    {'osver': '16.04', 'pkgname': 'lftp', 'pkgver': '4.6.3a-1ubuntu0.1'},
    {'osver': '18.04', 'pkgname': 'lftp', 'pkgver': '4.8.1-1ubuntu0.1'}
];
