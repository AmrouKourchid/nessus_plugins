...
# extracted from Fedora Security Advisory FEDORA-2022-bf188fb91a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-bf188fb91a");

  script_name(english:"Fedora 37 : golang (2022-bf188fb91a)");
...
FEDORA-2022-bf188fb91a advisory.
    ...
    ```
    * Wed Jul 13 2022 Alejandro Sez <asm@redhat.com> - 1.18.4-1
    - Update to 1.18.4
    * Sun Jun 19 2022 Robert-Andr Mauchin <zebob.m@gmail.com> - 1.18.3-2
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-bf188fb91a");
...
var pkgs = [
    {'reference':'golang-1.18.4-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
