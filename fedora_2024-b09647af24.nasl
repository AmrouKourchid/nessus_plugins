...
# extracted from Fedora Security Advisory FEDORA-2024-b09647af24
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-b09647af24");

  script_name(english:"Fedora 39 : dotnet7.0 (2024-b09647af24)");
...
FEDORA-2024-b09647af24 advisory.

    This is the January 2024 update for .NET 7. Release Notes:
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-b09647af24");
...
var pkgs = [
    {'reference':'dotnet7.0-7.0.115-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
