...
if (description)
{
  ...
  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2020-19752");
...
patch available.
  ...
  - The find_color_or_error function in gifsicle 1.92 contains a NULL pointer dereference. (CVE-2020-19752)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-19752");
