...
"The remote Red Hat host is missing one or more security updates for Red Hat Single Sign-On 7.4.9.");
...
referenced in the RHSA-2021:3529 advisory.
    ...
    This release of Red Hat Single Sign-On 7.4.9 serves as a replacement for Red Hat Single Sign-On 7.4.8, and
    ...
    * keycloak-model-infinispan: authenticationSessions map in RootAuthenticationSessionEntity grows
    boundlessly could lead to a DoS attack (CVE-2021-3637)
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_3529.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e885698a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:3529");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1912427");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1930423");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1953439");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1978196");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1979638");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat Single Sign-On 7.4.9 package based on the guidance in RHSA-2021:3529.");
