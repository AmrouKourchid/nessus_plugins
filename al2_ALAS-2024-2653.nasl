...
# extracted from Amazon Linux 2 Security Advisory ALAS-2024-2653.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : python-urllib3 (ALAS-2024-2653)");
...
vulnerability as referenced in the ALAS2-2024-2653 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2024-2653.html");
...
var pkgs = [
    {'reference':'python-urllib3-1.25.9-1.amzn2.0.4', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
