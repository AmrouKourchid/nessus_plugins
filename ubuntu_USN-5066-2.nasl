...
# extracted from Ubuntu Security Notice USN-5066-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5066-2");

  script_name(english:"Ubuntu 16.04 ESM : PySAML2 vulnerability (USN-5066-2)");
...
USN-5066-2 advisory.
    ...
    USN-5066-1 fixed a vulnerability in PySAML2. This update provides the corresponding update for Ubuntu
    16.04 ESM.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5066-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'python-pysaml2', 'pkgver': '3.0.0-3ubuntu1.16.04.4+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'python3-pysaml2', 'pkgver': '3.0.0-3ubuntu1.16.04.4+esm1', 'ubuntu_pro': TRUE}
];
