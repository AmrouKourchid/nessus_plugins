...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : python-requests (EulerOS-SA-2023-2927)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2927
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e6156c36");
...
var pkgs = [
  "python3-requests-2.24.0-1.h3.eulerosv2r10"
];
