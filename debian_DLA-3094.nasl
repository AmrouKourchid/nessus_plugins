...
# extracted from Debian Security Advisory dla-3094. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3094 : flac - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3094
advisory.

    - -----------------------------------------------------------------------
    Debian LTS Advisory DLA-3094-1              debian-lts@lists.debian.org
...
var pkgs = [
    {'release': '10.0', 'prefix': 'flac', 'reference': '1.3.2-3+deb10u2'},
    {'release': '10.0', 'prefix': 'libflac++-dev', 'reference': '1.3.2-3+deb10u2'},
    {'release': '10.0', 'prefix': 'libflac++6v5', 'reference': '1.3.2-3+deb10u2'},
    {'release': '10.0', 'prefix': 'libflac-dev', 'reference': '1.3.2-3+deb10u2'},
    {'release': '10.0', 'prefix': 'libflac-doc', 'reference': '1.3.2-3+deb10u2'},
    {'release': '10.0', 'prefix': 'libflac8', 'reference': '1.3.2-3+deb10u2'}
];
