...
# extracted from Amazon Linux 2 Security Advisory ALAS-2018-939.
#
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : kernel (ALAS-2018-939) (Meltdown) (Spectre)");
...
Updated on 2018-01-13: Additional fixes for CVE-2017-5715");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2018-939.html");
...
flag = 0;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"kernel-4.9.76-38.79.amzn2")) flag++;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"kernel-debuginfo-4.9.76-38.79.amzn2")) flag++;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"kernel-debuginfo-common-x86_64-4.9.76-38.79.amzn2")) flag++;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"kernel-devel-4.9.76-38.79.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"kernel-doc-4.9.76-38.79.amzn2")) flag++;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"kernel-headers-4.9.76-38.79.amzn2")) flag++;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"kernel-tools-4.9.76-38.79.amzn2")) flag++;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"kernel-tools-debuginfo-4.9.76-38.79.amzn2")) flag++;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"kernel-tools-devel-4.9.76-38.79.amzn2")) flag++;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"perf-4.9.76-38.79.amzn2")) flag++;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"perf-debuginfo-4.9.76-38.79.amzn2")) flag++;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"python-perf-4.9.76-38.79.amzn2")) flag++;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"python-perf-debuginfo-4.9.76-38.79.amzn2")) flag++;
