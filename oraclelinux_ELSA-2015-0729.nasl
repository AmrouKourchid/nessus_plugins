...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 / 7 : setroubleshoot (ELSA-2015-0729)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2015-0729.html");
  script_set_attribute(attribute:"solution", value:
"Update the affected setroubleshoot, setroubleshoot-doc and / or setroubleshoot-server packages.");
...
var pkgs = [
    {'reference':'setroubleshoot-3.0.47-6.0.1.el6_6.1', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'setroubleshoot-doc-3.0.47-6.0.1.el6_6.1', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'setroubleshoot-server-3.0.47-6.0.1.el6_6.1', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'setroubleshoot-3.0.47-6.0.1.el6_6.1', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'setroubleshoot-doc-3.0.47-6.0.1.el6_6.1', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'setroubleshoot-server-3.0.47-6.0.1.el6_6.1', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'setroubleshoot-3.2.17-4.1.0.1.el7_1', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'setroubleshoot-server-3.2.17-4.1.0.1.el7_1', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
];
