...
# extracted from Red Hat Security Advisory rubygem-bundler. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2016-7954", "CVE-2021-43809");

  script_name(english:"RHEL 7 : rubygem-bundler (Unpatched Vulnerability) (deprecated)");
...
"This plugin has been deprecated as it does not adhere to established standards for this style of check.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2016-7954");
