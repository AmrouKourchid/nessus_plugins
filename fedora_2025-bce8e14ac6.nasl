...
# extracted from Fedora Security Advisory FEDORA-2025-bce8e14ac6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-bce8e14ac6");

  script_name(english:"Fedora 40 : mingw-poppler (2025-bce8e14ac6)");
...
FEDORA-2025-bce8e14ac6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-bce8e14ac6");
...
var pkgs = [
    {'reference':'mingw-poppler-24.02.0-5.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
