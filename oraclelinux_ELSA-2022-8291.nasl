...
# extracted from Oracle Linux Security Advisory ELSA-2022-8291.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : rsync (ELSA-2022-8291)");
...
ELSA-2022-8291 advisory.

    [3.2.3-18]
    - Resolves: #2111177 - remote arbitrary files write inside the directories of connecting peers

    [3.2.3-17]
    - Resolves: #2116669 - zlib: a heap-based buffer over-read or buffer overflow in inflate in inflate.c via
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2022-8291.html");
...
var pkgs = [
    ...
    {'reference':'rsync-daemon-3.2.3-18.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rsync-3.2.3-18.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rsync-daemon-3.2.3-18.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
