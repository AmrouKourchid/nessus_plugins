...
# extracted from Red Hat Security Advisory RHSA-2023:2357. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:2357");

  script_name(english:"RHEL 9 : git-lfs (RHSA-2023:2357)");
...
referenced in the RHSA-2023:2357 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_2357.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2a8666a6");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2139383");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2161274");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:2357");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL git-lfs package based on the guidance in RHSA-2023:2357.");
  ...
  script_cwe_id(200, 400, 444, 770, 1325);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'git-lfs-3.2.0-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
