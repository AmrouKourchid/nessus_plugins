...
# extracted from Red Hat Security Advisory RHSA-2022:8867. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:8867");

  script_name(english:"RHEL 8 : Red Hat OpenStack Platform 16.1.9 (rabbitmq-server) (RHSA-2022:8867)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for Red Hat OpenStack Platform 16.1.9 (rabbitmq-server).");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8867.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?954ecdac");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8867");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1977002");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat OpenStack Platform 16.1.9 (rabbitmq-server) package based on the guidance in RHSA-2022:8867.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rabbitmq-server-3.7.23-9.el8ost', 'cpu':'ppc64le', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'rabbitmq-server-3.7.23-9.el8ost', 'cpu':'x86_64', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
