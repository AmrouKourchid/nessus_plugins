...
# extracted from Red Hat Security Advisory RHSA-2019:0159 and 
# CentOS Errata and Security Advisory 2019:0159 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : thunderbird (CESA-2019:0159)");
...
original reporters.");
  # https://lists.centos.org/pipermail/centos-announce/2019-February/023188.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e665adf1");
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"thunderbird-60.4.0-1.el6.centos", allowmaj:TRUE)) flag++;
