...
# extracted from Fedora Security Advisory FEDORA-2023-ce436d56f8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-ce436d56f8");

  script_name(english:"Fedora 37 : frr (2023-ce436d56f8)");
...
FEDORA-2023-ce436d56f8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-ce436d56f8");
...
var pkgs = [
    {'reference':'frr-8.5.3-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
