...
# extracted from Red Hat Security Advisory RHSA-2021:4913 and
# CentOS Errata and Security Advisory 2021:4913 respectively.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : mailman (RHSA-2021:4913)");
...
var pkgs = [
    {'reference':'mailman-2.1.15-30.el7_9.2', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
    {'reference':'mailman-2.1.15-30.el7_9.2', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'}
];
