...
# extracted from Fedora Security Advisory FEDORA-2023-25800591ef
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-25800591ef");

  script_name(english:"Fedora 37 : strongswan (2023-25800591ef)");
...
FEDORA-2023-25800591ef advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-25800591ef");
...
var pkgs = [
    {'reference':'strongswan-5.9.10-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
