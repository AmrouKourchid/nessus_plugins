...
# extracted from Red Hat Security Advisory RHSA-2022:7464. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:7464");

  script_name(english:"RHEL 8 : protobuf (RHSA-2022:7464)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for protobuf.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2022:7464 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_7464.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1a1fb192");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/8.7_release_notes/index
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?790bc9ea");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:7464");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2049429");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL protobuf package based on the guidance in RHSA-2022:7464.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'protobuf-3.5.0-15.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'protobuf-compiler-3.5.0-15.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'protobuf-devel-3.5.0-15.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'protobuf-lite-3.5.0-15.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'protobuf-lite-devel-3.5.0-15.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
