...
if (description)
{
  ...
  script_name(english:"Apache Subversion Client SEoL (1.4.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Apache Subversion Client is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Apache Subversion Client is 1.4.x. It is, therefore, no longer maintained by its vendor or
provider.
...
"Upgrade to a version of Apache Subversion Client that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2010/09/10");
...
var constraints = [
  { max_branch : '1.4', min_branch : '1.4', seol : 20100910 }
];
