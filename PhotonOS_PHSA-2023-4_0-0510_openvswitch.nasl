...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Openvswitch PHSA-2023-4.0-0510");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'openvswitch-2.14.0-14.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'openvswitch-devel-2.14.0-14.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'openvswitch-devel-static-2.14.0-14.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'openvswitch-doc-2.14.0-14.ph4')) flag++;
