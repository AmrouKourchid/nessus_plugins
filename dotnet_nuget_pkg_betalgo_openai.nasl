...
if (description)
{
  ...
  script_name(english:"NuGet Package 'Betalgo.OpenAI' Detection");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.nuget.org/packages/Betalgo.OpenAI/");
  script_set_attribute(attribute:"solution", value:
"The Betalgo.OpenAI package is installed on the remote host.");
  ...
  script_set_attribute(attribute:"cpe", value:"cpe:/a:betalgoup:betalgo.openai");
...
var app_info = vcf::nuget_package::get_app_info(pkg_name:"Betalgo.OpenAI");
app_info.vendor = "BetalgoUp";
app_info.cpe = "cpe:/a:betalgoup:betalgo.openai";
