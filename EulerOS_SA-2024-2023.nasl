...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : dnsmasq (EulerOS-SA-2024-2023)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the dnsmasq packages installed, the EulerOS installation on the remote host is affected by
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2023
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?969de5d1");
...
var pkgs = [
  "dnsmasq-2.79-7.h10.eulerosv2r8",
  "dnsmasq-utils-2.79-7.h10.eulerosv2r8"
];
