...
# extracted from Red Hat Security Advisory RHSA-2020:0726 and 
# Oracle Linux Security Advisory ELSA-2020-0726 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : sudo (ELSA-2020-0726)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2020-0726.html");
...
var pkgs = [
    {'reference':'sudo-1.8.6p3-29.0.1.el6_10.3', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sudo-devel-1.8.6p3-29.0.1.el6_10.3', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sudo-1.8.6p3-29.0.1.el6_10.3', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sudo-devel-1.8.6p3-29.0.1.el6_10.3', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
];
