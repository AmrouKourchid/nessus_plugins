...
if (description)
{
  ...
  script_cve_id("CVE-2016-6345");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2016-6345 (deprecated)");
...
"n/a");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-6345");
