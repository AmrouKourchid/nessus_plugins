...
# extracted from Red Hat Security Advisory RHSA-2023:1093 and
# CentOS Errata and Security Advisory 2023:1093 respectively.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : pesign (RHSA-2023:1093)");
...
var pkgs = [
    {'reference':'pesign-0.109-11.el7_9', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE}
];
