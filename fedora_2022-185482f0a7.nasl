...
# extracted from Fedora Security Advisory FEDORA-2022-185482f0a7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-185482f0a7");

  script_name(english:"Fedora 36 : mediawiki (2022-185482f0a7)");
...
FEDORA-2022-185482f0a7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-185482f0a7");
...
var pkgs = [
    {'reference':'mediawiki-1.37.6-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
