...
if (description)
{
  ...
  script_name(english:"Apple iCloud 7.x < 7.16 Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"An iCloud software installed on the remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"According to its version, the iCloud application installed on the remote Windows host is 7.x prior to 7.16. 
It is, therefore, affected by multiple vulnerabilities:
  ...
  script_set_attribute(attribute:"see_also", value:"https://support.apple.com/en-us/HT210795");
  script_set_attribute(attribute:"solution", value:
"Upgrade to iCloud version 7.16 or later.");
...
constraints = [
  {'min_version' : '7.0',  'fixed_version' : '7.16'},
];
