...
# extracted from Red Hat Security Advisory RHSA-2022:0495. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 8 : .NET 5.0 (RHSA-2022:0495)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2022:0495 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_0495.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a84e81e5");
