...
# extracted from Red Hat Security Advisory RHSA-2021:4703. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:4703");

  script_name(english:"RHEL 8 : RHV Engine and Host Common Packages security update [ovirt-4.4.9] (Important) (RHSA-2021:4703)");
...
the RHSA-2021:4703 advisory.
    ...
    otopi is a standalone, plug-in based installation framework to be used to set up system components. The
    plug-in nature provides simplicity to add new installation functionality without the complexity of the
    ...
    * A playbook executed by Ansible Engine 2.9.25 inside a virtual machine running on Red Hat Virtualization
    4.4.9 correctly detects that this is a virtual machine running on Red Hat Virtualization by using Ansible
    facts. (BZ#1904085)

    * Red Hat Virtualization now supports Ansible-2.9.27 for internal usage. (BZ#2003671)

    * Previously, upgrading from Red Hat Virtualization 4.3 failed when using an isolated network during IPv6
    deployment. In this release, a forward network is used instead of an isolated network during an IPv6
    deployment. As a result, upgrade from Red Hat Virtualization 4.3 using IPv6 now succeeds. (BZ#1947709)

Tenable has extracted the preceding description block directly from the Red Hat Enterprise Linux security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_4703.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ce7a84ea");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:4703");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1947709");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1975767");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2003671");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2010670");
...
"Update the RHEL RHV Engine / Host Common Packages packages based on the guidance in RHSA-2021:4703.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-3620");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ansible-2.9.27-1.el8ae', 'release':'8', 'el_string':'el8ae', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'},
      {'reference':'ovirt-ansible-collection-1.6.5-1.el8ev', 'release':'8', 'el_string':'el8ev', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'ansible / ovirt-ansible-collection');
}
