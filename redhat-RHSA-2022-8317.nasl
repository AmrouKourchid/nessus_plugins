...
# extracted from Red Hat Security Advisory RHSA-2022:8317. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:8317");
  script_xref(name:"IAVA", value:"2022-A-0299-S");

  script_name(english:"RHEL 9 : samba (RHSA-2022:8317)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8317.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?42072ccc");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8317");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ctdb-4.16.4-101.el9', 'cpu':'ppc64le', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'libsmbclient-4.16.4-101.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsmbclient-devel-4.16.4-101.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libwbclient-4.16.4-101.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libwbclient-devel-4.16.4-101.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-samba-4.16.4-101.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-4.16.4-101.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-client-4.16.4-101.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-client-libs-4.16.4-101.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-common-4.16.4-101.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-common-libs-4.16.4-101.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-common-tools-4.16.4-101.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-devel-4.16.4-101.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-krb5-printing-4.16.4-101.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-libs-4.16.4-101.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-pidl-4.16.4-101.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-test-4.16.4-101.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-test-libs-4.16.4-101.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-vfs-iouring-4.16.4-101.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-winbind-4.16.4-101.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-winbind-clients-4.16.4-101.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-winbind-krb5-locator-4.16.4-101.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-winbind-modules-4.16.4-101.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
