...
# extracted from Fedora Security Advisory FEDORA-2023-de99cdb793
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-de99cdb793");

  script_name(english:"Fedora 40 : python2.7 (2023-de99cdb793)");
...
FEDORA-2023-de99cdb793 advisory.
    ...
    ```
    * Fri Oct  6 2023 Lumr Balhar <lbalhar@redhat.com> - 2.7.18-35
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-de99cdb793");
...
var pkgs = [
    {'reference':'python2.7-2.7.18-35.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
