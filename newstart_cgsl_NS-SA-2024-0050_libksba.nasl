...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 6.02 : libksba Vulnerability (NS-SA-2024-0050)");

  script_set_attribute(attribute:"synopsis", value:
"The remote NewStart CGSL host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 6.02, has libksba packages installed that are affected by a
vulnerability:

  - A vulnerability was found in the Libksba library, due to an integer overflow within the CRL's signature
    parser. This issue can be exploited remotely for code execution on the target system by passing specially
    crafted data to the application, for example, a malicious S/MIME attachment. (CVE-2022-47629)
...
"Upgrade the vulnerable CGSL libksba packages. Note that updated packages may not be available yet. Please contact ZTE
