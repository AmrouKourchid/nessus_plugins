...
# extracted from Fedora Security Advisory FEDORA-2025-c634be56bc
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-c634be56bc");

  script_name(english:"Fedora 41 : trafficserver (2025-c634be56bc)");
...
FEDORA-2025-c634be56bc advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-c634be56bc");
...
"Update the affected trafficserver package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-56202");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2024-56195");
...
var pkgs = [
    {'reference':'trafficserver-9.2.9-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
