...
# extracted from Amazon Linux 2 Security Advisory ALAS-2021-1732.
##
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2021-1732");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2021/12/24");
  script_xref(name:"CEA-ID", value:"CEA-2022-0014");

  script_name(english:"Amazon Linux 2 : log4j-cve-2021-44228-hotpatch (ALAS-2021-1732)");
...
by a vulnerability as referenced in the ALAS2-2021-1732 advisory.

    The Apache Log4j hotpatch package starting with log4j-cve-2021-44228-hotpatch-1.1-13 will now explicitly
    mimic the permissions of the JVM attempting to be updated.

Tenable has extracted the preceding description block directly from the tested product security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2021-1732.html");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/cve/html/CVE-2021-3100.html");
...
var pkgs = [
    {'reference':'log4j-cve-2021-44228-hotpatch-1.1-13.amzn2', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
