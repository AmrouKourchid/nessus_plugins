...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 ESM / 18.04 LTS / 20.04 LTS : Linux kernel vulnerability (USN-5086-1)");
...
referenced in the USN-5086-1 advisory.

    Johan Almbladh discovered that the eBPF JIT implementation for IBM s390x systems in the Linux kernel
    miscompiled operations in some situations, allowing circumvention of the BPF verifier. A local attacker
...
var kernel_mappings = {
  '16.04': {
    '4.15.0': {
      'generic': '4.15.0-158',
      'lowlatency': '4.15.0-158'
    },
    '4.4.0': {
      'generic': '4.4.0-216',
      'lowlatency': '4.4.0-216'
    }
  },
  '18.04': {
    '4.15.0': {
      'generic': '4.15.0-158',
      'generic-lpae': '4.15.0-158',
      'lowlatency': '4.15.0-158'
    },
    '5.4.0': {
      'generic': '5.4.0-86',
      'generic-lpae': '5.4.0-86',
      'lowlatency': '5.4.0-86'
    }
  },
  '20.04': {
    '5.11.0': {
      'generic': '5.11.0-36',
      'generic-64k': '5.11.0-36',
      'generic-lpae': '5.11.0-36',
      'lowlatency': '5.11.0-36'
    },
    '5.4.0': {
      'generic': '5.4.0-86',
      'generic-lpae': '5.4.0-86',
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-5086-1');
}
