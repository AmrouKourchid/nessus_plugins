...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"0001-A-0625");
...
not guaranteed to be continued in the future.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0022ddd0");
...
eol_dates = make_array(
  ...
  "^4\.7($|[^0-9])",     "2017/06/08", # date 4.8 released
  "^4\.8($|[^0-9])",     "2017/11/29", # date 4.9 released
  "^4\.9($|[^0-9])",     "2018/12/06", # date 5.0 released
  "^5\.0($|[^0-9])",     "2019/02/21"  # date 5.1 released
  # Dates : https://wordpress.org/about/roadmap/
  # https://wordpress.org/download/release-archive/ :
  # "None of these are safe to use, except the latest in the 5.1 series, which is actively maintained."
);
...
foreach regex (keys(eol_dates))
{
  if (version =~ regex)
  {
    ...
    report_eol_url = "https://codex.wordpress.org/WordPress_Versions";
    break;
  }
}
