...
# extracted from Red Hat Security Advisory RHSA-2014:0898. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2014:0898");

  script_name(english:"RHEL 6 : Red Hat JBoss Enterprise Web Platform 5.2.0 (RHSA-2014:0898)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2014/rhsa-2014_0898.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ac6f65f3");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2014:0898");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1112987");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat JBoss Enterprise Web Platform 5.2.0 package based on the guidance in RHSA-2014:0898.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:L/I:L/A:L");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-3530");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'picketlink-federation-2.1.5-3_patch_01.el6_5', 'release':'6', 'el_string':'el6_5', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
