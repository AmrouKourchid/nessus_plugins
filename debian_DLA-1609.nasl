...
# extracted from Debian Security Advisory DLA-1609-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1609-1 : libapache-mod-jk security update");
...
The libapache-mod-jk connector is susceptible to information
disclosure and privilege escalation because of a mishandling of URL
normalization.
...
introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2018/12/msg00007.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/jessie/libapache-mod-jk");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"libapache-mod-jk-doc", reference:"1.2.46-0+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"libapache2-mod-jk", reference:"1.2.46-0+deb8u1")) flag++;
