...
# extracted from Debian Security Advisory dla-4151. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2025-24358");

  script_name(english:"Debian dla-4151 : golang-github-gorilla-csrf-dev - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has a package installed that is affected by a vulnerability as referenced in the dla-4151
advisory.
...
number.");
  # https://security-tracker.debian.org/tracker/source-package/golang-github-gorilla-csrf
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bae97b12");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2025-24358");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bullseye/golang-github-gorilla-csrf");
  script_set_attribute(attribute:"solution", value:
"Upgrade the golang-github-gorilla-csrf-dev packages.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:R/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss4_vector", value:"CVSS:4.0/AV:N/AC:L/AT:P/PR:N/UI:P/VC:N/VI:H/VA:N/SC:N/SI:N/SA:N");
  script_set_attribute(attribute:"cvss4_threat_vector", value:"CVSS:4.0/E:U");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-24358");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:golang-github-gorilla-csrf-dev");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'golang-github-gorilla-csrf-dev', 'reference': '1.6.2-2+deb11u1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'golang-github-gorilla-csrf-dev');
}
