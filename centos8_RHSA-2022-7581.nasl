...
# Red Hat Security Advisory RHSA-2022:7581. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : python38:3.8 and python38-devel:3.8 (CESA-2022:7581)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
CESA-2022:7581 advisory.
...
var appstreams = {
    'python38-devel:3.8': [
      {'reference':'python38-3.8.13-1.module_el8.7.0+1177+19c53253', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-3.8.13-1.module_el8.7.0+1177+19c53253', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python38-debug-3.8.13-1.module_el8.7.0+1177+19c53253', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-debug-3.8.13-1.module_el8.7.0+1177+19c53253', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-devel-3.8.13-1.module_el8.7.0+1177+19c53253', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-devel-3.8.13-1.module_el8.7.0+1177+19c53253', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-idle-3.8.13-1.module_el8.7.0+1177+19c53253', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-idle-3.8.13-1.module_el8.7.0+1177+19c53253', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python38-libs-3.8.13-1.module_el8.7.0+1177+19c53253', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-libs-3.8.13-1.module_el8.7.0+1177+19c53253', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python38-rpm-macros-3.8.13-1.module_el8.7.0+1177+19c53253', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-rpm-macros-3.8.13-1.module_el8.7.0+1177+19c53253', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python38-test-3.8.13-1.module_el8.7.0+1177+19c53253', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-test-3.8.13-1.module_el8.7.0+1177+19c53253', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-tkinter-3.8.13-1.module_el8.7.0+1177+19c53253', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-tkinter-3.8.13-1.module_el8.7.0+1177+19c53253', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
