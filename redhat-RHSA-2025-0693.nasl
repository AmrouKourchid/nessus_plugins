...
# extracted from Red Hat Security Advisory RHSA-2025:0693. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:0693");

  script_name(english:"RHEL 9 : redis (RHSA-2025:0693)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for redis.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2025:0693 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-26627");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_0693.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2e5eb0c0");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:0693");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL redis package based on the guidance in RHSA-2025:0693.");
  ...
  script_cwe_id(20, 269, 416, 674, 680);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'redis-6.2.17-1.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'redis-devel-6.2.17-1.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'redis-doc-6.2.17-1.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
