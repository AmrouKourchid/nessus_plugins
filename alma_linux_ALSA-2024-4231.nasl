...
# AlmaLinux Security Advisory ALSA-2024:4231.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:4231");

  script_name(english:"AlmaLinux 8 : python-jinja2 (ALSA-2024:4231)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2024-4231.html");
