...
# extracted from Ubuntu Security Notice USN-4638-1. The text
...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.10 : c-ares vulnerability (USN-4638-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 20.10 host has packages installed that are affected by a vulnerability as referenced in the USN-4638-1
advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4638-1");
...
var pkgs = [
    {'osver': '20.10', 'pkgname': 'libc-ares-dev', 'pkgver': '1.16.1-1ubuntu0.1'},
    {'osver': '20.10', 'pkgname': 'libc-ares2', 'pkgver': '1.16.1-1ubuntu0.1'}
];
