...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.2.0 : unzip (EulerOS-SA-2019-1949)");
...
by the following vulnerabilities :
  ...
  - A heap-based buffer overflow exists in Info-Zip UnZip
    version i1/4oe= 6.00 in the processing of
    password-protected archives that allows an attacker to
    perform a denial of service or to possibly achieve code
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1949
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e7cb5423");
