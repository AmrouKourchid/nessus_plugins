...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Redis PHSA-2022-4.0-0207");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-33105");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'redis-7.0.0-2.ph4')) flag++;
