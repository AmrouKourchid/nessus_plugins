...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : gnupg2 (EulerOS-SA-2022-2460)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the gnupg2 packages installed, the EulerOS installation on the remote host is affected by
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2460
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?288f77af");
...
var pkgs = [
  "gnupg2-2.2.9-1.h9.eulerosv2r8",
  "gnupg2-smime-2.2.9-1.h9.eulerosv2r8"
];
