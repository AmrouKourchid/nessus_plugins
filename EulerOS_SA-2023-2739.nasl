...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.1 : python3 (EulerOS-SA-2023-2739)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2739
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cedbaabb");
...
var pkgs = [
  "python3-3.9.9-7.h21.eulerosv2r11",
  "python3-unversioned-command-3.9.9-7.h21.eulerosv2r11"
];
