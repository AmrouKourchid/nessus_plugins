...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Sqlite PHSA-2019-2.0-0184");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'sqlite-3.27.2-5.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'sqlite-debuginfo-3.27.2-5.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'sqlite-devel-3.27.2-5.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'sqlite-libs-3.27.2-5.ph2')) flag++;
