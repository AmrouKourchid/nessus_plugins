...
# extracted from SUSE update advisory SUSE-SU-2019:0231-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : spice (SUSE-SU-2019:0231-1)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?98d9ebc1");
...
SUSE-SLE-SERVER-12-SP1-2019-231=1");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"1", cpu:"x86_64", reference:"libspice-server1-0.12.5-10.2.3.1")) flag++;
if (rpm_check(release:"SLES12", sp:"1", cpu:"x86_64", reference:"libspice-server1-debuginfo-0.12.5-10.2.3.1")) flag++;
if (rpm_check(release:"SLES12", sp:"1", cpu:"x86_64", reference:"spice-debugsource-0.12.5-10.2.3.1")) flag++;
