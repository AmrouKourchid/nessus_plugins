...
# extracted from Red Hat Security Advisory RHSA-2019:3135. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:3135");

  script_name(english:"RHEL 8 : java-11-openjdk (RHSA-2019:3135)");
...
referenced in the RHSA-2019:3135 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_3135.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dc6938cf");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:3135");
...
"Update the RHEL java-11-openjdk package based on the guidance in RHSA-2019:3135.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'java-11-openjdk-11.0.5.10-0.el8_0', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-11-openjdk-demo-11.0.5.10-0.el8_0', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-11-openjdk-devel-11.0.5.10-0.el8_0', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-11-openjdk-headless-11.0.5.10-0.el8_0', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-11-openjdk-javadoc-11.0.5.10-0.el8_0', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-11-openjdk-javadoc-zip-11.0.5.10-0.el8_0', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-11-openjdk-jmods-11.0.5.10-0.el8_0', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-11-openjdk-src-11.0.5.10-0.el8_0', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
