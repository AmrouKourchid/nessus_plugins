...
# extracted from Fedora Security Advisory FEDORA-2024-3d656dafe1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-3d656dafe1");

  script_name(english:"Fedora 40 : mingw-python3 (2024-3d656dafe1)");
...
FEDORA-2024-3d656dafe1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-3d656dafe1");
...
var pkgs = [
    {'reference':'mingw-python3-3.11.9-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
