...
# extracted from Fedora Security Advisory FEDORA-2025-7b9adcd6ea
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-7b9adcd6ea");

  script_name(english:"Fedora 41 : radare2 (2025-7b9adcd6ea)");
...
FEDORA-2025-7b9adcd6ea advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-7b9adcd6ea");
...
var pkgs = [
    {'reference':'radare2-5.9.8-7.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
