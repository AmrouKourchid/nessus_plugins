...
# extracted from Fedora Security Advisory FEDORA-2023-298c136eee
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-298c136eee");

  script_name(english:"Fedora 36 : sudo (2023-298c136eee)");
...
FEDORA-2023-298c136eee advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-298c136eee");
...
var pkgs = [
    {'reference':'sudo-1.9.12-2.p2.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
