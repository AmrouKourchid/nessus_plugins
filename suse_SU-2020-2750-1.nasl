...
without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=1047054");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2017-11527/");
  # https://www.suse.com/support/update/announcement/2020/suse-su-20202750-1
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d54abede");
...
zypper in -t patch SUSE-SLE-SERVER-12-SP5-2020-2750=1");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-11527");
