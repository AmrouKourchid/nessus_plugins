...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5022346");
  script_xref(name:"MSKB", value:"5022352");
  script_xref(name:"MSFT", value:"MS23-5022346");
  script_xref(name:"MSFT", value:"MS23-5022352");
  ...
  script_name(english:"KB5022346: Windows 8.1 Embedded and Windows Server 2012 R2 Security Update (January 2023)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5022346. It is, therefore, affected by multiple vulnerabilities
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5022346");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5022352");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5022346 or Cumulative Update 5022352");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:H/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:L/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:H/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-21732");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2023-28297");
...
if (
  smb_check_rollup(os:'6.3',
                   ...
                   rollup_date:'01_2023',
                   bulletin:bulletin,
                   rollup_kb_list:[5022352, 5022346])
)
{
