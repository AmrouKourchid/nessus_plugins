...
# extracted from Fedora Security Advisory FEDORA-2025-ab5fe60520
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-ab5fe60520");
  script_xref(name:"IAVB", value:"2025-B-0018-S");

  script_name(english:"Fedora 41 : ffmpeg (2025-ab5fe60520)");
...
FEDORA-2025-ab5fe60520 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-ab5fe60520");
...
"Update the affected ffmpeg package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-25468");
...
var pkgs = [
    {'reference':'ffmpeg-7.1.1-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
