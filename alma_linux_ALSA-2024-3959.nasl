...
# AlmaLinux Security Advisory ALSA-2024:3959.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:3959");

  script_name(english:"AlmaLinux 9 : flatpak (ALSA-2024:3959)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2024-3959.html");
