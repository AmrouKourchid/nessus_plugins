...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS : Linux kernel (AWS) vulnerabilities (USN-3833-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3833-1");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.15.0-1029-aws");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-3833-1');
}
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-3833-1');
  }
  else
  {
