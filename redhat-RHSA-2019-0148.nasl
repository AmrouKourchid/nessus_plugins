...
# extracted from Red Hat Security Advisory RHSA-2019:0148. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:0148");

  script_name(english:"RHEL 7 : qemu-kvm-rhev (RHSA-2019:0148)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for qemu-kvm-rhev.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2019:0148 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_0148.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0c46dbf2");
...
"Update the RHEL qemu-kvm-rhev package based on the guidance in RHSA-2019:0148.");
...
var constraints = [
  {
    'repo_relative_urls': [
      'content/els/rhel/server/7/7.4/x86_64/openstack/7.0/debug',
      'content/els/rhel/server/7/7.4/x86_64/openstack/7.0/os',
      'content/els/rhel/server/7/7.4/x86_64/openstack/7.0/source/SRPMS'
    ],
    'pkgs': [
      {'reference':'qemu-img-rhev-2.9.0-16.el7_4.18', 'sp':'4', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10', 'exists_check':'openstack-'},
      {'reference':'qemu-kvm-common-rhev-2.9.0-16.el7_4.18', 'sp':'4', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10', 'exists_check':'openstack-'},
      {'reference':'qemu-kvm-rhev-2.9.0-16.el7_4.18', 'sp':'4', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10', 'exists_check':'openstack-'},
      {'reference':'qemu-kvm-tools-rhev-2.9.0-16.el7_4.18', 'sp':'4', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10', 'exists_check':'openstack-'}
    ]
  }
];
