...
# extracted from Red Hat Security Advisory RHSA-2017:3470. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2017:3470");

  script_name(english:"RHEL 7 : qemu-kvm-rhev (RHSA-2017:3470)");
...
referenced in the RHSA-2017:3470 advisory.
    ...
    * Hot-unplugging Virtual Function I/O (VFIO) devices previously failed when performed after hot-unplugging
    ...
    in the described circumstances. (BZ#1498140)
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1498140");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1501290");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2017/rhsa-2017_3470.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?10e0004d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2017:3470");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL qemu-kvm-rhev package based on the guidance in RHSA-2017:3470.");
