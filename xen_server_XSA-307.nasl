...
if (description)
{
  ...
  script_cve_id("CVE-2019-19581", "CVE-2019-19582");
  script_xref(name:"IAVB", value:"2019-B-0091-S");

  script_name(english:"Xen 32-bit Arm Guest OS Denial Of Service vulnerability (XSA-307)");
...
denial of service vulnerability due to a mishandling of a certain bit iteration in 32-bit Arm systems. An authenticated local 
attacker can exploit this issue, to cause a denial of service (DOS).
...
configurations or if patches were applied manually to the source code before a recompile and reinstall.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?368c81ac");
...
"Apply the appropiate patch according to the vendor advisory.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-19582");
...
fixes['4.8']['fixed_ver_display']   = '4.8.5 (changeset 714a65a)';
fixes['4.8']['affected_ver_regex']  = '^4\\.8\\.';
fixes['4.8']['affected_changesets'] = make_list("d1d3431", "a260e93",
...
fixes['4.9']['fixed_ver_display']   = '4.9.4 (changeset ce126c9)';
fixes['4.9']['affected_ver_regex']  = '^4\\.9\\.';
fixes['4.9']['affected_changesets'] = make_list("4b69427", "8d1ee9f",
...
fixes['4.10']['fixed_ver_display']   = '4.10.4 (changeset c9f9ff7)';
fixes['4.10']['affected_ver_regex']  = '^4\\.10\\.';
fixes['4.10']['affected_changesets'] = make_list("406d40d", "e489955",
...
fixes['4.11']['fixed_ver_display']   = '4.11.4-pre (changeset b8a8278)';
fixes['4.11']['affected_ver_regex']  = '^4\\.11\\.';
fixes['4.11']['affected_changesets'] = make_list("06555fd");
  

fixes['4.12']['fixed_ver']           = '4.12.2';
fixes['4.12']['fixed_ver_display']   = '4.12.2-pre (changeset 0e3fd5d)';
fixes['4.12']['affected_ver_regex']  = '^4\\.12\\.';
fixes['4.12']['affected_changesets'] = make_list("212b850", "2590905",
...
fixes['4.13']['fixed_ver_display']   = '4.13.0-rc (changeset d8538f7)';
fixes['4.13']['affected_ver_regex']  = '^4\\.13\\.';
fixes['4.13']['affected_changesets'] = make_list("fd31193", "b0f0bbc",
