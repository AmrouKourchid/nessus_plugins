...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : net-snmp (EulerOS-SA-2019-1036)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1036
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7410c7a0");
...
pkgs = ["net-snmp-5.7.2-33.2.h1.eulerosv2r7",
        "net-snmp-agent-libs-5.7.2-33.2.h1.eulerosv2r7",
        "net-snmp-devel-5.7.2-33.2.h1.eulerosv2r7",
        "net-snmp-libs-5.7.2-33.2.h1.eulerosv2r7",
        "net-snmp-utils-5.7.2-33.2.h1.eulerosv2r7"];
