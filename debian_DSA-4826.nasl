...
# extracted from Debian Security Advisory DSA-4826. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"4826");
  script_xref(name:"IAVB", value:"2021-B-0004-S");

  script_name(english:"Debian DSA-4826-1 : nodejs - security update");
...
HTTP request smuggling.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2021/dsa-4826");
  script_set_attribute(attribute:"solution", value:
"Upgrade the nodejs packages.

For the stable distribution (buster), these problems have been fixed
in version 10.23.1~dfsg-1~deb10u1.");
...
flag = 0;
if (deb_check(release:"10.0", prefix:"libnode-dev", reference:"10.23.1~dfsg-1~deb10u1")) flag++;
if (deb_check(release:"10.0", prefix:"libnode64", reference:"10.23.1~dfsg-1~deb10u1")) flag++;
if (deb_check(release:"10.0", prefix:"nodejs", reference:"10.23.1~dfsg-1~deb10u1")) flag++;
if (deb_check(release:"10.0", prefix:"nodejs-doc", reference:"10.23.1~dfsg-1~deb10u1")) flag++;
