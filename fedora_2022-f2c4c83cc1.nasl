...
# extracted from Fedora Security Advisory FEDORA-2022-f2c4c83cc1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-f2c4c83cc1");

  script_name(english:"Fedora 37 : rsyslog (2022-f2c4c83cc1)");
...
FEDORA-2022-f2c4c83cc1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-f2c4c83cc1");
...
var pkgs = [
    {'reference':'rsyslog-8.2204.0-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
