...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS : MySQL regression (USN-4441-2)");
...
USN-4441-2 advisory.
    ...
    USN-4441-1 fixed vulnerabilities in MySQL. The new upstream version changed compiler options and caused a
    regression in certain scenarios. This update fixes the problem.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4441-2");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'libmysqlclient-dev', 'pkgver': '8.0.21-0ubuntu0.20.04.4'},
    {'osver': '20.04', 'pkgname': 'libmysqlclient21', 'pkgver': '8.0.21-0ubuntu0.20.04.4'},
    {'osver': '20.04', 'pkgname': 'mysql-client', 'pkgver': '8.0.21-0ubuntu0.20.04.4'},
    {'osver': '20.04', 'pkgname': 'mysql-client-8.0', 'pkgver': '8.0.21-0ubuntu0.20.04.4'},
    {'osver': '20.04', 'pkgname': 'mysql-client-core-8.0', 'pkgver': '8.0.21-0ubuntu0.20.04.4'},
    {'osver': '20.04', 'pkgname': 'mysql-router', 'pkgver': '8.0.21-0ubuntu0.20.04.4'},
    {'osver': '20.04', 'pkgname': 'mysql-server', 'pkgver': '8.0.21-0ubuntu0.20.04.4'},
    {'osver': '20.04', 'pkgname': 'mysql-server-8.0', 'pkgver': '8.0.21-0ubuntu0.20.04.4'},
    {'osver': '20.04', 'pkgname': 'mysql-server-core-8.0', 'pkgver': '8.0.21-0ubuntu0.20.04.4'},
    {'osver': '20.04', 'pkgname': 'mysql-source-8.0', 'pkgver': '8.0.21-0ubuntu0.20.04.4'},
    {'osver': '20.04', 'pkgname': 'mysql-testsuite', 'pkgver': '8.0.21-0ubuntu0.20.04.4'},
    {'osver': '20.04', 'pkgname': 'mysql-testsuite-8.0', 'pkgver': '8.0.21-0ubuntu0.20.04.4'}
];
