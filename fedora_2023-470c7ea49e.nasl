...
# extracted from Fedora Security Advisory FEDORA-2023-470c7ea49e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-470c7ea49e");

  script_name(english:"Fedora 37 : libgit2 (2023-470c7ea49e)");
...
FEDORA-2023-470c7ea49e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-470c7ea49e");
...
var pkgs = [
    {'reference':'libgit2-1.3.2-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
