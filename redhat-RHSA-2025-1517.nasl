...
# extracted from Red Hat Security Advisory RHSA-2025:1517. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:1517");

  script_name(english:"RHEL 8 : libxml2 (RHSA-2025:1517)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for libxml2.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2025:1517 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_1517.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1d8524a3");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:1517");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libxml2-2.9.7-18.el8_10.2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libxml2-devel-2.9.7-18.el8_10.2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-libxml2-2.9.7-18.el8_10.2', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
