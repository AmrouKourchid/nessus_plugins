...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.0 : python-paramiko (EulerOS-SA-2022-2078)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2078
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?010c7c8a");
...
var pkgs = [
  "python3-paramiko-2.4.1-8.h1.eulerosv2r10"
];
