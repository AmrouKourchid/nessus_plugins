...
# CentOS Errata and Security Advisory 2019:2773 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : thunderbird (CESA-2019:2773)");
...
the CVE page(s) listed in the References section.");
  # https://lists.centos.org/pipermail/centos-announce/2019-September/023410.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6aafc0b7");
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"thunderbird-60.9.0-1.el7.centos", allowmaj:TRUE)) flag++;
