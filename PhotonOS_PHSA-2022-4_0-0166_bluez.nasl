...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Bluez PHSA-2022-4.0-0166");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'bluez-5.58-4.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'bluez-devel-5.58-4.ph4')) flag++;
