...
# extracted from Fedora Security Advisory FEDORA-2022-3b4c68d85d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-3b4c68d85d");

  script_name(english:"Fedora 37 : golang (2022-3b4c68d85d)");
...
FEDORA-2022-3b4c68d85d advisory.

    go1.19.4 (released 2022-12-06) includes security fixes to the net/http and os packages, as well as bug
    fixes to the compiler, the runtime, and the crypto/x509, os/exec, and sync/atomic packages.  See the [Go
    1.19.4 milestone on the upstream issue
    tracker](https://github.com/golang/go/issues?q=milestone%3AGo1.19.4+label%3ACherryPickApproved) for
    details.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-3b4c68d85d");
...
var pkgs = [
    {'reference':'golang-1.19.4-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
