...
# CentOS Errata and Security Advisory 2015:0998 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : qemu-kvm (CESA-2015:0998) (Venom)");
...
to take effect.");
  # https://lists.centos.org/pipermail/centos-announce/2015-May/021136.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dc6920e3");
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"qemu-guest-agent-0.12.1.2-2.448.el6_6.3")) flag++;
if (rpm_check(release:"CentOS-6", cpu:"x86_64", reference:"qemu-img-0.12.1.2-2.448.el6_6.3")) flag++;
if (rpm_check(release:"CentOS-6", cpu:"x86_64", reference:"qemu-kvm-0.12.1.2-2.448.el6_6.3")) flag++;
if (rpm_check(release:"CentOS-6", cpu:"x86_64", reference:"qemu-kvm-tools-0.12.1.2-2.448.el6_6.3")) flag++;
