...
# extracted from Red Hat Security Advisory RHSA-2009:1503. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 4 : gpdf (RHSA-2009:1503)");
...
referenced in the RHSA-2009:1503 advisory.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2009/rhsa-2009_1503.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c0aee2d3");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2009:1503");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL gpdf package based on the guidance in RHSA-2009:1503.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gpdf-2.8.2-7.7.2.el4_8.5', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gpdf-2.8.2-7.7.2.el4_8.5', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gpdf-2.8.2-7.7.2.el4_8.5', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gpdf-2.8.2-7.7.2.el4_8.5', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gpdf-2.8.2-7.7.2.el4_8.5', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
