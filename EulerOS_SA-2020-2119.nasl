...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : glusterfs (EulerOS-SA-2020-2119)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2119
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dc7ada1e");
...
pkgs = ["glusterfs-3.8.4-54.15.h2",
        ...
        "glusterfs-fuse-3.8.4-54.15.h2",
        "glusterfs-libs-3.8.4-54.15.h2",
        "glusterfs-rdma-3.8.4-54.15.h2"];
