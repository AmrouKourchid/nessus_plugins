...
dla-2915 advisory.
    ...
    Several issues were found in ConnMan, a connection manager for embedded devices, that could cause denial
    of service via service crash or excessive CPU usage. For Debian 9 stretch, these problems have been fixed
    in version 1.33-3+deb9u3. We recommend that you upgrade your connman packages. For the detailed security
    status of connman please refer to its security tracker page at: https://security-
    tracker.debian.org/tracker/connman Further information about Debian LTS security advisories, how to apply
