...
if (description)
{
  ...
  script_cve_id("CVE-2020-3382");
  script_xref(name:"CISCO-BUG-ID", value:"CSCvt41161");
  script_xref(name:"CISCO-SA", value:"cisco-sa-dcnm-bypass-dyEejUMs");
  script_xref(name:"IAVA", value:"2020-A-0279-S");

  script_name(english:"Cisco Data Center Network Manager Authentication Bypass (cisco-sa-dcnm-bypass-dyEejUMs)");
...
vulnerability in the REST API due to shared use of a static encryption key between installations. An unauthenticated,
remote attacker can exploit this vulnerability to bypass authentication and execute arbitrary actions with
...
Please see the included Cisco BID and Cisco Security Advisory for more information.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6ba35e2d");
  script_set_attribute(attribute:"see_also", value:"https://bst.cloudapps.cisco.com/bugsearch/bug/CSCvt41161");
...
"Upgrade to the relevant fixed version referenced in Cisco bug ID CSCvt41161");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-3382");
