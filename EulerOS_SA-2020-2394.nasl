...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : rsyslog (EulerOS-SA-2020-2394)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2394
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2ae5b7c8");
...
pkgs = ["rsyslog-7.4.7-7.2.h27",
        "rsyslog-gnutls-7.4.7-7.2.h27",
        "rsyslog-gssapi-7.4.7-7.2.h27",
        "rsyslog-mmjsonparse-7.4.7-7.2.h27",
        "rsyslog-mysql-7.4.7-7.2.h27",
        "rsyslog-pgsql-7.4.7-7.2.h27",
        "rsyslog-relp-7.4.7-7.2.h27"];
