...
# extracted from Fedora Security Advisory FEDORA-2024-43a0920f12
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-43a0920f12");

  script_name(english:"Fedora 39 : perl-Clipboard (2024-43a0920f12)");
...
FEDORA-2024-43a0920f12 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-43a0920f12");
...
var pkgs = [
    {'reference':'perl-Clipboard-0.29-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
