...
# extracted from Fedora Security Advisory FEDORA-2024-9694c3eec0
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-9694c3eec0");

  script_name(english:"Fedora 40 : webkit2gtk4.0 (2024-9694c3eec0)");
...
FEDORA-2024-9694c3eec0 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-9694c3eec0");
...
var pkgs = [
    {'reference':'webkit2gtk4.0-2.46.1-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
