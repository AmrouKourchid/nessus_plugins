...
# extracted from Amazon Linux AMI Security Advisory ALAS-2023-1849.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux AMI : containerd (ALAS-2023-1849)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux AMI host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of containerd installed on the remote host is prior to 1.4.13-5. It is, therefore, affected by multiple
vulnerabilities as referenced in the ALAS-2023-1849 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/ALAS-2023-1849.html");
...
var pkgs = [
    {'reference':'containerd-1.4.13-5.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'containerd-debuginfo-1.4.13-5.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'containerd-stress-1.4.13-5.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE}
];
