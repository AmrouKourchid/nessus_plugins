...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Haproxy PHSA-2022-4.0-0167");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'haproxy-2.3.4-6.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'haproxy-doc-2.3.4-6.ph4')) flag++;
