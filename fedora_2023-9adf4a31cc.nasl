...
# extracted from Fedora Security Advisory FEDORA-2023-9adf4a31cc
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-9adf4a31cc");

  script_name(english:"Fedora 39 : netconsd (2023-9adf4a31cc)");
...
FEDORA-2023-9adf4a31cc advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-9adf4a31cc");
...
var pkgs = [
    {'reference':'netconsd-0.3-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
