...
# extracted from Red Hat Security Advisory RHSA-2022:4991. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_4991.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1c8b7f05");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:4991");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2073310");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL xz package based on the guidance in RHSA-2022:4991.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'xz-5.2.4-4.el8_6', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xz-devel-5.2.4-4.el8_6', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xz-libs-5.2.4-4.el8_6', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xz-lzma-compat-5.2.4-4.el8_6', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'xz-5.2.4-4.el8_6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xz-devel-5.2.4-4.el8_6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xz-libs-5.2.4-4.el8_6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xz-lzma-compat-5.2.4-4.el8_6', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'xz / xz-devel / xz-libs / xz-lzma-compat');
}
