...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_2210.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?276f2025");
...
"Update the RHEL ksh package based on the guidance in RHSA-2020:2210.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ksh-20120801-36.el7_4', 'sp':'4', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ksh-20120801-36.el7_4', 'sp':'4', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
