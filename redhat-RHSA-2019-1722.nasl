...
# extracted from Red Hat Security Advisory RHSA-2019:1722. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:1722");

  script_name(english:"RHEL 7 : openstack-ironic-inspector (RHSA-2019:1722)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_1722.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4f705305");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:1722");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL openstack-ironic-inspector package based on the guidance in RHSA-2019:1722.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openstack-ironic-inspector-4.2.2-6.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
