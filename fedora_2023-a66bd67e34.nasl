...
# extracted from Fedora Security Advisory FEDORA-2023-a66bd67e34
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-a66bd67e34");

  script_name(english:"Fedora 37 : libpcap / tcpdump (2023-a66bd67e34)");
...
FEDORA-2023-a66bd67e34 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-a66bd67e34");
...
var pkgs = [
    {'reference':'libpcap-1.10.4-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'14'},
    {'reference':'tcpdump-4.99.4-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'14'}
];
