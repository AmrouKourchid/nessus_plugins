...
# CentOS Errata and Security Advisory 2018:2252 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : thunderbird (CESA-2018:2252)");
...
and OSS-Fuzz as the original reporters.");
  # https://lists.centos.org/pipermail/centos-announce/2018-July/022973.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?06023ae2");
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"thunderbird-52.9.1-1.el7.centos", allowmaj:TRUE)) flag++;
