...
# extracted from Fedora Security Advisory FEDORA-2024-ba5bb9f63a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-ba5bb9f63a");

  script_name(english:"Fedora 39 : dovecot (2024-ba5bb9f63a)");
...
FEDORA-2024-ba5bb9f63a advisory.

    - CVE-2024-23184: A large number of address headers in email resulted in excessive CPU usage.
    - CVE-2024-23185: Abnormally large email headers are now truncated or discarded, with a limit of 10MB on a
    single header and 50MB for all the headers of all the parts of an email.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-ba5bb9f63a");
...
var pkgs = [
    {'reference':'dovecot-2.3.21.1-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
