...
var appstreams = {
    'nginx:1.16': [
      ...
      {'reference':'nginx-all-modules-1.16.1-2.0.1.module+el8.4.0+20188+a733e426.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nginx-filesystem-1.16.1-2.0.1.module+el8.4.0+20188+a733e426.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      ...
      {'reference':'nginx-all-modules-1.16.1-2.0.1.module+el8.4.0+20188+a733e426.1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nginx-filesystem-1.16.1-2.0.1.module+el8.4.0+20188+a733e426.1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
