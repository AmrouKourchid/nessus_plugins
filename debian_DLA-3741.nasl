...
# extracted from Debian Security Advisory dla-3741. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3741 : engrampa - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3741
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/engrampa");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'engrampa', 'reference': '1.20.2-1+deb10u1'},
    {'release': '10.0', 'prefix': 'engrampa-common', 'reference': '1.20.2-1+deb10u1'}
];
