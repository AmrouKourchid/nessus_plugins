...
# CentOS Errata and Security Advisory 2018:2240 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : openslp (CESA-2018:2240)");
...
listed in the References section.");
  # https://lists.centos.org/pipermail/centos-announce/2018-July/022971.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?42106a08");
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"openslp-2.0.0-7.el7_5")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"openslp-devel-2.0.0-7.el7_5")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"openslp-server-2.0.0-7.el7_5")) flag++;
