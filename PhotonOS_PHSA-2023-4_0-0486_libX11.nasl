...
# extracted from VMware Security Advisory PHSA-2023-4.0-0486. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Libx11 PHSA-2023-4.0-0486");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the libX11 package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-486.md");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:vmware:photonos:libX11");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libX11-1.8.5-2.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libX11-devel-1.8.5-2.ph4')) flag++;
