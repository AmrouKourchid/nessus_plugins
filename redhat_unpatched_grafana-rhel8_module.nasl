...
if (description)
{
  ...
  script_cve_id("CVE-2021-23358", "CVE-2022-0235", "CVE-2022-25758");

  script_name(english:"RHEL 8 : grafana (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:cockpit-composer");
