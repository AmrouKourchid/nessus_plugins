...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : libjpeg-turbo (EulerOS-SA-2022-1075)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1075
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e4a10c36");
...
var pkgs = [
  "libjpeg-turbo-2.0.0-1.h4.eulerosv2r8",
  "libjpeg-turbo-devel-2.0.0-1.h4.eulerosv2r8"
];
