...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5002294");
  script_xref(name:"MSFT", value:"MS22-5002294");
  script_xref(name:"IAVA", value:"2022-A-0481-S");

  script_name(english:"Security Updates for Microsoft SharePoint Server 2019 (November 2022)");
...
affected by multiple vulnerabilities:
  ...
  - A remote code execution vulnerability. An attacker can
    ...
    CVE-2022-41062)");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002294");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released KB5002294 to address this issue.");
