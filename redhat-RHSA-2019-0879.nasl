...
# extracted from Red Hat Security Advisory RHSA-2019:0879. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:0879");

  script_name(english:"RHEL 7 : openstack-neutron (RHSA-2019:0879)");
...
referenced in the RHSA-2019:0879 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1690150");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_0879.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2dc02b00");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:0879");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL openstack-neutron package based on the guidance in RHSA-2019:0879.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openstack-neutron-13.0.3-0.20190313155649.00b63be.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'},
      {'reference':'openstack-neutron-common-13.0.3-0.20190313155649.00b63be.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'},
      {'reference':'openstack-neutron-linuxbridge-13.0.3-0.20190313155649.00b63be.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'},
      {'reference':'openstack-neutron-macvtap-agent-13.0.3-0.20190313155649.00b63be.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'},
      {'reference':'openstack-neutron-metering-agent-13.0.3-0.20190313155649.00b63be.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'},
      {'reference':'openstack-neutron-ml2-13.0.3-0.20190313155649.00b63be.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'},
      {'reference':'openstack-neutron-openvswitch-13.0.3-0.20190313155649.00b63be.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'},
      {'reference':'openstack-neutron-rpc-server-13.0.3-0.20190313155649.00b63be.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'},
      {'reference':'openstack-neutron-sriov-nic-agent-13.0.3-0.20190313155649.00b63be.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'},
      {'reference':'python-neutron-13.0.3-0.20190313155649.00b63be.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'}
    ]
  }
];
