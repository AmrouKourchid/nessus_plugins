...
# extracted from Fedora Security Advisory FEDORA-2024-9f8235fb21
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-9f8235fb21");

  script_name(english:"Fedora 39 : thunderbird (2024-9f8235fb21)");
...
FEDORA-2024-9f8235fb21 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-9f8235fb21");
...
var pkgs = [
    {'reference':'thunderbird-115.9.0-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
