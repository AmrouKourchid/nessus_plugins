...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : openwsman (EulerOS-SA-2019-1331)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1331
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?71e4973a");
...
pkgs = ["libwsman1-2.6.3-3.h1.git4391e5c.eulerosv2r7",
        "openwsman-client-2.6.3-3.h1.git4391e5c.eulerosv2r7",
        "openwsman-python-2.6.3-3.h1.git4391e5c.eulerosv2r7",
        "openwsman-server-2.6.3-3.h1.git4391e5c.eulerosv2r7"];
