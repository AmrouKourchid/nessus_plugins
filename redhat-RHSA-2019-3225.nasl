...
# extracted from Red Hat Security Advisory RHSA-2019:3225. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:3225");

  script_name(english:"RHEL 7 : jss (RHSA-2019:3225)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for jss.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2019:3225 advisory.

    Java Security Services (JSS) provides an interface between Java Virtual Machine and Network Security
    Services (NSS). It supports most of the security standards and encryption technologies supported by NSS
    including communication through SSL/TLS network protocols. JSS is primarily utilized by the Certificate
    Server as a part of the Identity Management System.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_3225.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?34b43f03");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:3225");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1747435");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL jss package based on the guidance in RHSA-2019:3225.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jss-4.4.4-6.el7_6', 'sp':'6', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'jss-4.4.4-6.el7_6', 'sp':'6', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'jss-4.4.4-6.el7_6', 'sp':'6', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'jss-4.4.4-6.el7_6', 'sp':'6', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'jss-javadoc-4.4.4-6.el7_6', 'sp':'6', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'jss-javadoc-4.4.4-6.el7_6', 'sp':'6', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'jss-javadoc-4.4.4-6.el7_6', 'sp':'6', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'jss-javadoc-4.4.4-6.el7_6', 'sp':'6', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'jss-4.4.4-6.el7_6', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'jss-4.4.4-6.el7_6', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'jss-4.4.4-6.el7_6', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'jss-4.4.4-6.el7_6', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'jss-javadoc-4.4.4-6.el7_6', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'jss-javadoc-4.4.4-6.el7_6', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'jss-javadoc-4.4.4-6.el7_6', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'jss-javadoc-4.4.4-6.el7_6', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
