...
# extracted from VMware Security Advisory PHSA-2021-3.0-0280. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2021-33505");

  script_name(english:"Photon OS 3.0: Falco PHSA-2021-3.0-0280");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the falco package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-3.0-280.md");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-33505");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'falco-0.15.1-2.0419198001.ph3')) flag++;
