...
# extracted from Oracle Linux Security Advisory ELSA-2023-0808.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : firefox (ELSA-2023-0808)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-0808.html");
...
var pkgs = [
    {'reference':'firefox-102.8.0-2.0.1.el8_7', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-102.8.0-2.0.1.el8_7', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
