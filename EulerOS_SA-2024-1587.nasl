...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : ghostscript (EulerOS-SA-2024-1587)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1587
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cca75790");
...
var pkgs = [
  "ghostscript-9.52-4.h8.eulerosv2r10",
  "ghostscript-help-9.52-4.h8.eulerosv2r10"
];
