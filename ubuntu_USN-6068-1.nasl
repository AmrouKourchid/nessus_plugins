...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS / 22.04 LTS : Open vSwitch vulnerability (USN-6068-1)");
...
referenced in the USN-6068-1 advisory.

    David Marchand discovered that Open vSwitch incorrectly handled IP packets with the protocol set to 0. A
