...
# extracted from Gentoo Linux Security Advisory GLSA 202105-21.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202105-21");

  script_name(english:"GLSA-202105-21 : Tcpreplay: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202105-21
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202105-21"
  );
  script_set_attribute(
    attribute:"solution",
    value:
"All Tcpreplay users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-24266");
...
if (qpkg_check(package:"net-analyzer/tcpreplay", unaffected:make_list("ge 4.3.4"), vulnerable:make_list("lt 4.3.4"))) flag++;
