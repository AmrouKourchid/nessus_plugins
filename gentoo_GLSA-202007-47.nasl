...
# extracted from Gentoo Linux Security Advisory GLSA 202007-47.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202007-47");

  script_name(english:"GLSA-202007-47 : Okular: Local restricted command execution");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202007-47
(Okular: Local restricted command execution)

    A logic error was discovered in Okular, which results in trusting action
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202007-47");
...
"All Okular users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:okular");
...
if (qpkg_check(package:"kde-apps/okular", unaffected:make_list("ge 19.12.3-r1"), vulnerable:make_list("lt 19.12.3-r1"))) flag++;
