...
# extracted from Fedora Security Advisory FEDORA-2024-582d2a7648
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-582d2a7648");

  script_name(english:"Fedora 41 : chromium (2024-582d2a7648)");
...
FEDORA-2024-582d2a7648 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-582d2a7648");
...
var pkgs = [
    {'reference':'chromium-131.0.6778.85-2.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
