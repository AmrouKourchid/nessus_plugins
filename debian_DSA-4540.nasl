...
# extracted from Debian Security Advisory DSA-4540. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"4540");

  script_name(english:"Debian DSA-4540-1 : openssl1.0 - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"Two security issues were discovered in OpenSSL: A timing attack
against ECDSA and a padding oracle in PKCS7_dataDecode() and
CMS_decrypt_set1_pkey().");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2019/dsa-4540");
  script_set_attribute(attribute:"solution", value:
"Upgrade the openssl1.0 packages.

For the oldstable distribution (stretch), these problems have been
fixed in version 1.0.2t-1~deb9u1.");
...
flag = 0;
if (deb_check(release:"9.0", prefix:"libssl1.0-dev", reference:"1.0.2t-1~deb9u1")) flag++;
if (deb_check(release:"9.0", prefix:"libssl1.0.2", reference:"1.0.2t-1~deb9u1")) flag++;
