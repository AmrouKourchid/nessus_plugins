...
# extracted from Red Hat Security Advisory RHSA-2023:5236. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:5236");

  script_name(english:"RHEL 8 : libwebp: critical (RHSA-2023:5236)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for libwebp: critical.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2023:5236 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_5236.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?62c92019");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:5236");
...
"Update the RHEL libwebp: critical package based on the guidance in RHSA-2023:5236.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libwebp-1.0.0-5.2.el8_1.1', 'sp':'1', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libwebp-1.0.0-5.2.el8_1.1', 'sp':'1', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libwebp-1.0.0-5.2.el8_1.1', 'sp':'1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libwebp-devel-1.0.0-5.2.el8_1.1', 'sp':'1', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libwebp-devel-1.0.0-5.2.el8_1.1', 'sp':'1', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libwebp-devel-1.0.0-5.2.el8_1.1', 'sp':'1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
