...
# extracted from Red Hat Security Advisory RHSA-2020:4629. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:4629");

  script_name(english:"RHEL 8 : libvpx (RHSA-2020:4629)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for libvpx.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2020:4629 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_4629.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3e287ef5");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/8.3_release_notes/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b7e37d18");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:4629");
...
"Update the RHEL libvpx package based on the guidance in RHSA-2020:4629.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libvpx-1.7.0-8.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvpx-devel-1.7.0-8.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
