...
# extracted from Fedora Security Advisory FEDORA-2023-3bc3404fc1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-3bc3404fc1");

  script_name(english:"Fedora 39 : grafana-pcp (2023-3bc3404fc1)");
...
FEDORA-2023-3bc3404fc1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-3bc3404fc1");
...
"Update the affected grafana-pcp package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:grafana-pcp");
...
var pkgs = [
    {'reference':'grafana-pcp-5.1.1-4.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
