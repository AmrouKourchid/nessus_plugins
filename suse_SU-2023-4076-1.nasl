...
# SUSE update advisory SUSE-SU-2023:4076-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:4076-1");

  script_name(english:"SUSE SLES15 / openSUSE 15 Security Update : cni (SUSE-SU-2023:4076-1)");
...
as referenced in the SUSE-SU-2023:4076-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-October/016682.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?21236167");
...
var pkgs = [
    {'reference':'cni-1.1.2-150500.3.2.1', 'sp':'5', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.5']},
    {'reference':'cni-1.1.2-150500.3.2.1', 'sp':'5', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.5', 'sle-module-containers-release-15.5', 'sles-release-15.5']},
    {'reference':'cni-1.1.2-150500.3.2.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.5']}
];
