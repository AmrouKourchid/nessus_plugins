...
# extracted from Ubuntu Security Notice USN-6155-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6155-1");

  script_name(english:"Ubuntu 20.04 LTS / 22.04 LTS / 23.04 : Requests vulnerability (USN-6155-1)");
...
referenced in the USN-6155-1 advisory.

    Dennis Brinkrolf and Tobias Funke discovered that Requests incorrectly leaked Proxy-Authorization headers.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6155-1");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'python3-requests', 'pkgver': '2.22.0-2ubuntu1.1'},
    {'osver': '22.04', 'pkgname': 'python3-requests', 'pkgver': '2.25.1+dfsg-2ubuntu0.1'},
    {'osver': '23.04', 'pkgname': 'python3-requests', 'pkgver': '2.28.1+dfsg-1ubuntu1.1'}
];
