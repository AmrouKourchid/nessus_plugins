...
# extracted from Fedora Security Advisory FEDORA-2025-d2f32b0607
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-d2f32b0607");

  script_name(english:"Fedora 40 : java-latest-openjdk (2025-d2f32b0607)");
...
FEDORA-2025-d2f32b0607 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-d2f32b0607");
...
var pkgs = [
    {'reference':'java-latest-openjdk-23.0.2.0.7-1.rolling.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
