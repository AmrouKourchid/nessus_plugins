...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : tomcat (EulerOS-SA-2021-1175)");
...
vulnerabilities :
  ...
  - While investigating bug 64830 it was discovered that
    Apache Tomcat 10.0.0-M1 to 10.0.0-M9, 9.0.0-M1 to
    9.0.39 and 8.5.0 to 8.5.59 could re-use an HTTP request
    header value from the previous stream received on an
    HTTP/2 connection for the request associated with the
    subsequent stream. While this would most likely lead to
    an error and the closure of the HTTP/2 connection, it
    is possible that information could leak between
    requests.(CVE-2020-17527)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1175
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?91339a6c");
...
pkgs = ["tomcat-9.0.10-1.h12.eulerosv2r8",
        "tomcat-admin-webapps-9.0.10-1.h12.eulerosv2r8",
        "tomcat-el-3.0-api-9.0.10-1.h12.eulerosv2r8",
        "tomcat-jsp-2.3-api-9.0.10-1.h12.eulerosv2r8",
        "tomcat-lib-9.0.10-1.h12.eulerosv2r8",
        "tomcat-servlet-4.0-api-9.0.10-1.h12.eulerosv2r8"];
