...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Nodejs PHSA-2023-3.0-0545");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2023-23918");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'nodejs-16.19.1-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'nodejs-devel-16.19.1-1.ph3')) flag++;
