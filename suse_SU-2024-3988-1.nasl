...
# SUSE update advisory SUSE-SU-2024:3988-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2024:3988-1");
  script_xref(name:"IAVA", value:"2024-A-0672-S");

  script_name(english:"SUSE SLES15 Security Update : buildah (SUSE-SU-2024:3988-1)");
...
referenced in the SUSE-SU-2024:3988-1 advisory.

    - CVE-2024-9676: Fixed github.com/containers/storage: symlink traversal vulnerability in the
    containers/storage library can cause Denial of Service (DoS) (bsc#1231698):
    - CVE-2024-9675: VUL-0: CVE-2024-9675: buildah,podman: buildah: cache arbitrary directory mount
    (bsc#1231499):
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1232522");
  # https://lists.suse.com/pipermail/sle-security-updates/2024-November/019818.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a613d853");
...
var pkgs = [
    {'reference':'buildah-1.35.4-150400.3.33.1', 'sp':'4', 'cpu':'x86_64', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.4']},
    {'reference':'buildah-1.35.4-150400.3.33.1', 'sp':'4', 'cpu':'aarch64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-ESPOS-release-4']},
    {'reference':'buildah-1.35.4-150400.3.33.1', 'sp':'4', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-ESPOS-release-4']},
    {'reference':'buildah-1.35.4-150400.3.33.1', 'sp':'4', 'cpu':'aarch64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-LTSS-release-15.4']},
    {'reference':'buildah-1.35.4-150400.3.33.1', 'sp':'4', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-LTSS-release-15.4']},
    {'reference':'buildah-1.35.4-150400.3.33.1', 'sp':'4', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-ltss-release-15.4']}
];
