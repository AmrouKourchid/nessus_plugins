...
# extracted from Debian Security Advisory DSA-4594. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"4594");
  script_xref(name:"IAVA", value:"2019-A-0303-S");

  script_name(english:"Debian DSA-4594-1 : openssl1.0 - security update");
...
squaring procedure used in exponentiation with 512-bit moduli.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2019/dsa-4594");
...
flag = 0;
if (deb_check(release:"9.0", prefix:"libssl1.0-dev", reference:"1.0.2u-1~deb9u1")) flag++;
if (deb_check(release:"9.0", prefix:"libssl1.0.2", reference:"1.0.2u-1~deb9u1")) flag++;
