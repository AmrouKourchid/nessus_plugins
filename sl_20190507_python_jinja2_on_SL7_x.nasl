...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : python-jinja2 on SL7.x (noarch) (20190507)");
...
str.format (CVE-2016-10745)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1905&L=SCIENTIFIC-LINUX-ERRATA&P=1074
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dcb0c585");
...
"Update the affected python-jinja2 package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fermilab:scientific_linux:python-jinja2");
...
flag = 0;
if (rpm_check(release:"SL7", reference:"python-jinja2-2.7.2-3.el7_6")) flag++;
