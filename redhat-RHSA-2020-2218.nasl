...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_2218.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?142ea15c");
...
"Update the RHEL OpenShift Container Platform 3.11 package based on the guidance in RHSA-2020:2218.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cri-o-1.11.16-0.9.dev.rhaos3.11.git6d43aae.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-ansible'},
      {'reference':'cri-o-1.11.16-0.9.dev.rhaos3.11.git6d43aae.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-ansible'}
    ]
  }
];
