...
# extracted from Red Hat Security Advisory RHSA-2022:9080. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:9080");
  ...
  script_name(english:"RHEL 9 : thunderbird (RHSA-2022:9080)");
...
referenced in the RHSA-2022:9080 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_9080.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c7c2a306");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:9080");
...
"Update the RHEL thunderbird package based on the guidance in RHSA-2022:9080.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'thunderbird-102.6.0-2.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
