...
if (description)
{
  ...
  script_name(english:"CentOS 9 : liblouis-3.16.1-5.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing one or more security updates for liblouis.");
...
liblouis-3.16.1-5.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=32506");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream liblouis package.");
...
var pkgs = [
    ...
    {'reference':'liblouis-devel-3.16.1-5.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'liblouis-doc-3.16.1-5.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'liblouis-utils-3.16.1-5.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'liblouis / liblouis-devel / liblouis-doc / liblouis-utils / etc');
}
