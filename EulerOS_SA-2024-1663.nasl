...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : python (EulerOS-SA-2024-1663)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1663
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1780be5c");
...
var pkgs = [
  "python-2.7.5-69.h45.eulerosv2r7",
  "python-devel-2.7.5-69.h45.eulerosv2r7",
  "python-libs-2.7.5-69.h45.eulerosv2r7",
  "tkinter-2.7.5-69.h45.eulerosv2r7"
];
