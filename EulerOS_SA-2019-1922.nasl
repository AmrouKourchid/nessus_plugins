...
if (description)
{
  ...
  script_bugtraq_id(72846);

  script_name(english:"EulerOS Virtualization for ARM 64 3.0.2.0 : patch (EulerOS-SA-2019-1922)");
...
by the following vulnerabilities :
  ...
  - A double-free flaw was found in the way the patch
    utility processed patch files. An attacker could
    potentially use this flaw to crash the patch utility by
    tricking it into processing crafted
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1922
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?00d50167");
