...
if (description)
{
  ...
  script_cve_id("CVE-2024-32617");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-32617");
...
patch available.
  ...
  - HDF5 Library through 1.14.3 contains a heap-based buffer over-read caused by the unsafe use of strdup in
    H5MM_xstrdup in H5MM.c (called from H5G__ent_to_link in H5Glink.c). (CVE-2024-32617)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-32617");
