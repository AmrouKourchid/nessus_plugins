...
if (description)
{
  ...
  script_cve_id("CVE-2024-31582");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-31582");
...
patch available.
  ...
  - FFmpeg version n6.1 was discovered to contain a heap buffer overflow vulnerability in the
    ...
    undefined behavior or a Denial of Service (DoS) via crafted input. (CVE-2024-31582)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-31582");
