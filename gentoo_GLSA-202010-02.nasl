...
# extracted from Gentoo Linux Security Advisory GLSA 202010-02.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202010-02");

  script_name(english:"GLSA-202010-02 : Mozilla Firefox, Mozilla Thunderbird: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202010-02
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2020-44/");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202010-02");
...
if (qpkg_check(package:"mail-client/thunderbird", unaffected:make_list("ge 78.3.1"), vulnerable:make_list("lt 78.3.1"))) flag++;
if (qpkg_check(package:"mail-client/thunderbird-bin", unaffected:make_list("ge 78.3.1"), vulnerable:make_list("lt 78.3.1"))) flag++;
if (qpkg_check(package:"www-client/firefox", unaffected:make_list("ge 81.0", "ge 78.3.0"), vulnerable:make_list("lt 81.0"))) flag++;
if (qpkg_check(package:"www-client/firefox-bin", unaffected:make_list("ge 81.0", "ge 78.3.0"), vulnerable:make_list("lt 81.0"))) flag++;
