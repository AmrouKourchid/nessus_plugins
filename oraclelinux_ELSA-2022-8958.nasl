...
# extracted from Oracle Linux Security Advisory ELSA-2022-8958.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : bcel (ELSA-2022-8958)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 7 host has packages installed that are affected by a vulnerability as referenced in the
ELSA-2022-8958 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2022-8958.html");
...
"Update the affected bcel and / or bcel-javadoc packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:bcel-javadoc");
...
var pkgs = [
    {'reference':'bcel-5.2-19.el7_9', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'bcel-javadoc-5.2-19.el7_9', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
];
