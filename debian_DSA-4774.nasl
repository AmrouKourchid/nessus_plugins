...
denial of service or information leaks.
  ...
  - CVE-2020-25645
    ...
    unencrypted instead.");
  script_set_attribute(attribute:"see_also", value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=908712");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2020-12351");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2020-12352");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2020-25211");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2020-25643");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2020-25645");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2020/dsa-4774");
...
if (deb_check(release:"10.0", prefix:"linux-image-4.19.0-5-686-pae", reference:"4.19.152-1")) flag++;
if (deb_check(release:"10.0", prefix:"linux-image-4.19.0-5-686", reference:"4.19.152-1")) flag++;
if (deb_check(release:"10.0", prefix:"linux-image-4.19.0-5-amd64-dbg", reference:"4.19.152-1")) flag++;
if (deb_check(release:"10.0", prefix:"linux-image-4.19.0-5-amd64", reference:"4.19.152-1")) flag++;
if (deb_check(release:"10.0", prefix:"linux-image-4.19.0-5-arm64-dbg", reference:"4.19.152-1")) flag++;
if (deb_check(release:"10.0", prefix:"linux-image-4.19.0-5-arm64", reference:"4.19.152-1")) flag++;
...
if (deb_check(release:"10.0", prefix:"linux-image-4.19.0-5-cloud-amd64", reference:"4.19.152-1")) flag++;
...
if (deb_check(release:"10.0", prefix:"linux-image-4.19.0-5-rt-686-pae", reference:"4.19.152-1")) flag++;
if (deb_check(release:"10.0", prefix:"linux-image-4.19.0-5-rt-amd64-dbg", reference:"4.19.152-1")) flag++;
if (deb_check(release:"10.0", prefix:"linux-image-4.19.0-5-rt-amd64", reference:"4.19.152-1")) flag++;
if (deb_check(release:"10.0", prefix:"linux-image-4.19.0-5-rt-arm64-dbg", reference:"4.19.152-1")) flag++;
if (deb_check(release:"10.0", prefix:"linux-image-4.19.0-5-rt-arm64", reference:"4.19.152-1")) flag++;
