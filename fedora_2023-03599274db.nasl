...
# extracted from Fedora Security Advisory FEDORA-2023-03599274db
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-03599274db");
  script_xref(name:"IAVA", value:"2023-A-0283-S");

  script_name(english:"Fedora 37 : python3.9 (2023-03599274db)");
...
FEDORA-2023-03599274db advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-03599274db");
...
var pkgs = [
    {'reference':'python3.9-3.9.16-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
