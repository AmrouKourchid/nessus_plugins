...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : libsoup (EulerOS-SA-2025-1160)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1160
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?51442bbe");
...
var pkgs = [
  "libsoup-2.74.2-1.h2.eulerosv2r11",
  "libsoup-help-2.74.2-1.h2.eulerosv2r11"
];
