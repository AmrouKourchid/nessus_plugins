...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5046687");
  script_xref(name:"MSKB", value:"5046705");
  script_xref(name:"MSFT", value:"MS24-5046687");
  script_xref(name:"MSFT", value:"MS24-5046705");
  ...
  script_name(english:"KB5046705: Windows Server 2008 R2 Security Update (November 2024)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5046687");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5046705");
...
if (
  smb_check_rollup(os:'6.1',
                   ...
                   rollup_date:'11_2024',
                   bulletin:bulletin,
                   rollup_kb_list:[5046705, 5046687])
)
{
