...
# AlmaLinux Security Advisory ALSA-2023:7876.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:7876");

  script_name(english:"AlmaLinux 8 : opensc (ALSA-2023:7876)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2023-7876.html");
