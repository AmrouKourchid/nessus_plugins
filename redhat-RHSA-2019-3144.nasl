...
# extracted from Red Hat Security Advisory RHSA-2019:3144. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:3144");

  script_name(english:"RHEL 7 : OpenShift Container Platform 3.11 jenkins (RHSA-2019:3144)");
...
referenced in the RHSA-2019:3144 advisory.
    ...
    * jenkins: CSRF protection tokens for anonymous users did not expire in some circumstances
    (CVE-2019-10384)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_3144.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b0c6fcd3");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:3144");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1747293");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1747297");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 3.11 jenkins package based on the guidance in RHSA-2019:3144.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jenkins-2.176.3.1569349414-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-ansible'}
    ]
  }
];
