...
if (description)
{
  ...
  script_cve_id("CVE-2018-19541");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2018-19541");
...
patch available.
  ...
  - An issue was discovered in JasPer 1.900.8, 1.900.9, 1.900.10, 1.900.11, 1.900.12, 1.900.13, 1.900.14,
    ...
    heap-based buffer over-read of size 8 in the function jas_image_depalettize in libjasper/base/jas_image.c.
    (CVE-2018-19541)
