...
# extracted from Red Hat Security Advisory RHSA-2016:1655. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2016:1655");

  script_name(english:"RHEL 7 : qemu-kvm-rhev (RHSA-2016:1655)");
...
referenced in the RHSA-2016:1655 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2016/rhsa-2016_1655.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cc0bd339");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2016:1655");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL qemu-kvm-rhev package based on the guidance in RHSA-2016:1655.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libcacard-devel-rhev-2.3.0-31.el7_2.21', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_2', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10', 'exists_check':'openstack-'},
