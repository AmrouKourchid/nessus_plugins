...
# extracted from Red Hat Security Advisory RHSA-2024:4861. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:4861");

  script_name(english:"RHEL 9 : squid (RHSA-2024:4861)");
...
referenced in the RHSA-2024:4861 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?66b05d7d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:4861");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL squid package based on the guidance in RHSA-2024:4861.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'squid-5.5-13.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'squid-5.5-13.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
    ]
  }
];
