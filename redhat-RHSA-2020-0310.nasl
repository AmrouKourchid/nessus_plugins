...
# extracted from Red Hat Security Advisory RHSA-2020:0310. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:0310");

  script_name(english:"RHEL 6 / 7 : rh-java-common-xmlrpc (RHSA-2020:0310)");
...
in the RHSA-2020:0310 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_0310.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4915e258");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:0310");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1775193");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rh-java-common-xmlrpc package based on the guidance in RHSA-2020:0310.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-java-common-xmlrpc-client-3.1.3-8.17.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'rh-java-common-xmlrpc-common-3.1.3-8.17.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'rh-java-common-xmlrpc-javadoc-3.1.3-8.17.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'rh-java-common-xmlrpc-server-3.1.3-8.17.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'rh-java-common-xmlrpc-client-3.1.3-8.17.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'rh-java-common-xmlrpc-common-3.1.3-8.17.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'rh-java-common-xmlrpc-javadoc-3.1.3-8.17.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'rh-java-common-xmlrpc-server-3.1.3-8.17.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
