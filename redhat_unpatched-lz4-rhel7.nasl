...
# extracted from Red Hat Security Advisory lz4. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2019-17543", "CVE-2021-3520");

  script_name(english:"RHEL 7 : lz4 (Unpatched Vulnerability) (deprecated)");
