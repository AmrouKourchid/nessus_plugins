...
if (description)
{
  ...
  script_cve_id("CVE-2024-32618");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-32618");
...
patch available.
  ...
  - HDF5 Library through 1.14.3 contains a heap-based buffer overflow in H5T__get_native_type in H5Tnative.c,
    resulting in the corruption of the instruction pointer. (CVE-2024-32618)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-32618");
