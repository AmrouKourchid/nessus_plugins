...
# extracted from Red Hat Security Advisory RHSA-2014:0134. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2014:0134");

  script_name(english:"RHEL 6 : java-1.7.0-ibm (RHSA-2014:0134)");
...
referenced in the RHSA-2014:0134 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2014/rhsa-2014_0134.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ac06481b");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/developerworks/java/jdk/alerts/");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2014:0134");
...
"Update the RHEL java-1.7.0-ibm package based on the guidance in RHSA-2014:0134.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'java-1.7.0-ibm-1.7.0.6.1-1jpp.1.el6_5', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.7.0-ibm-1.7.0.6.1-1jpp.1.el6_5', 'cpu':'ppc64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.7.0-ibm-1.7.0.6.1-1jpp.1.el6_5', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.7.0-ibm-1.7.0.6.1-1jpp.1.el6_5', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.7.0-ibm-demo-1.7.0.6.1-1jpp.1.el6_5', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.7.0-ibm-demo-1.7.0.6.1-1jpp.1.el6_5', 'cpu':'ppc64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.7.0-ibm-demo-1.7.0.6.1-1jpp.1.el6_5', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.7.0-ibm-demo-1.7.0.6.1-1jpp.1.el6_5', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.7.0-ibm-devel-1.7.0.6.1-1jpp.1.el6_5', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.7.0-ibm-devel-1.7.0.6.1-1jpp.1.el6_5', 'cpu':'ppc64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.7.0-ibm-devel-1.7.0.6.1-1jpp.1.el6_5', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.7.0-ibm-devel-1.7.0.6.1-1jpp.1.el6_5', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.7.0-ibm-jdbc-1.7.0.6.1-1jpp.1.el6_5', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.7.0-ibm-jdbc-1.7.0.6.1-1jpp.1.el6_5', 'cpu':'ppc64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.7.0-ibm-jdbc-1.7.0.6.1-1jpp.1.el6_5', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.7.0-ibm-jdbc-1.7.0.6.1-1jpp.1.el6_5', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.7.0-ibm-plugin-1.7.0.6.1-1jpp.1.el6_5', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.7.0-ibm-plugin-1.7.0.6.1-1jpp.1.el6_5', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.7.0-ibm-src-1.7.0.6.1-1jpp.1.el6_5', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.7.0-ibm-src-1.7.0.6.1-1jpp.1.el6_5', 'cpu':'ppc64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.7.0-ibm-src-1.7.0.6.1-1jpp.1.el6_5', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.7.0-ibm-src-1.7.0.6.1-1jpp.1.el6_5', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
