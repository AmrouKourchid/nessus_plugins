...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS / 22.04 LTS : OpenSSL vulnerability (USN-5488-1)");
...
referenced in the USN-5488-1 advisory.

    Chancen and Daniel Fiala discovered that OpenSSL incorrectly handled the c_rehash script. A local attacker
    could possibly use this issue to execute arbitrary commands when c_rehash is run.
