...
# extracted from Red Hat Security Advisory RHSA-2024:2295. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2295");

  script_name(english:"RHEL 9 : libjpeg-turbo (RHSA-2024:2295)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for libjpeg-turbo.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2295.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7c5825a8");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2295");
...
"Update the RHEL libjpeg-turbo package based on the guidance in RHSA-2024:2295.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libjpeg-turbo-2.0.90-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libjpeg-turbo-devel-2.0.90-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libjpeg-turbo-utils-2.0.90-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'turbojpeg-2.0.90-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'turbojpeg-devel-2.0.90-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
