...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : kernel (EulerOS-SA-2022-1817)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1817
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?61b6cf99");
...
var pkgs = [
  ...
  "kernel-abi-stablelists-4.18.0-147.5.2.8.h878.eulerosv2r10",
