...
if (description)
{
  ...
  script_cve_id("CVE-2023-46720");

  script_name(english:"Fortinet Fortigate Stack buffer overflow on bluetooth write feature (FG-IR-23-356)");
...
vulnerability as referenced in the FG-IR-23-356 advisory.

  - A stack-based buffer overflow in Fortinet FortiOS version 7.4.0 through 7.4.1 and 7.2.0 through 7.2.7 and
    7.0.0 through 7.0.12 and 6.4.6 through 6.4.15 and 6.2.9 through 6.2.16 and 6.0.13 through 6.0.18 allows
    attacker to execute unauthorized code or commands via specially crafted CLI commands. (CVE-2023-46720)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.fortiguard.com/psirt/FG-IR-23-356");
  script_set_attribute(attribute:"solution", value:
"For 6.0.x / 6.2.x / 6.4.x, see vendor advisory. For 7.0.x, upgrade to Fortigate version 7.0.16 or later. For 7.2.x,
upgrade to Fortigate version 7.2.8 or later. For 7.4.x, upgrade to Fortigate version 7.4.4 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-46720");
