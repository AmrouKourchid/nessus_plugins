...
# extracted from VMware Security Advisory PHSA-2024-4.0-0709. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Curl PHSA-2024-4.0-0709");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the curl package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-709.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'curl-8.7.1-4.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'curl-devel-8.7.1-4.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'curl-libs-8.7.1-4.ph4')) flag++;
