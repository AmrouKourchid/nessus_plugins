...
# extracted from Red Hat Security Advisory RHSA-2023:7029. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_7029.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?06ea17b8");
...
"Update the RHEL libX11 package based on the guidance in RHSA-2023:7029.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libX11-1.6.8-6.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libX11-common-1.6.8-6.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libX11-devel-1.6.8-6.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libX11-xcb-1.6.8-6.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
