...
# extracted from Fedora Security Advisory FEDORA-2018-7db7ccda4d.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : krb5 (2018-7db7ccda4d)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-7db7ccda4d");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"krb5-1.16.1-22.fc29")) flag++;
