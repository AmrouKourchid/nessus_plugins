...
# extracted from Red Hat Security Advisory RHSA-2020:2081.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : python-virtualenv (RHSA-2020:2081)");
...
var pkgs = [
    {'reference':'python-virtualenv-15.1.0-4.el7_7', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE}
];
