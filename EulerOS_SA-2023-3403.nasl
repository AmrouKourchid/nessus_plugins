...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : libX11 (EulerOS-SA-2023-3403)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3403
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bf3bc99e");
...
var pkgs = [
  "libX11-1.6.5-1.h7.eulerosv2r7",
  "libX11-common-1.6.5-1.h7.eulerosv2r7",
  "libX11-devel-1.6.5-1.h7.eulerosv2r7"
];
