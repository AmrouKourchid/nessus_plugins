...
# extracted from Ubuntu Security Notice USN-4682-1. The text
...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS : WavPack vulnerability (USN-4682-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4682-1");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'libwavpack-dev', 'pkgver': '5.1.0-2ubuntu1.5'},
    {'osver': '18.04', 'pkgname': 'libwavpack1', 'pkgver': '5.1.0-2ubuntu1.5'},
    {'osver': '18.04', 'pkgname': 'wavpack', 'pkgver': '5.1.0-2ubuntu1.5'},
    {'osver': '20.04', 'pkgname': 'libwavpack-dev', 'pkgver': '5.2.0-1ubuntu0.1'},
    {'osver': '20.04', 'pkgname': 'libwavpack1', 'pkgver': '5.2.0-1ubuntu0.1'},
    {'osver': '20.04', 'pkgname': 'wavpack', 'pkgver': '5.2.0-1ubuntu0.1'}
];
