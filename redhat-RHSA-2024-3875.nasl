...
# extracted from Red Hat Security Advisory RHSA-2024:3875. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:3875");

  script_name(english:"RHEL 9 : nghttp2 (RHSA-2024:3875)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_3875.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?23ab2032");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2268639");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:3875");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL nghttp2 package based on the guidance in RHSA-2024:3875.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libnghttp2-1.43.0-5.el9_0.3', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
