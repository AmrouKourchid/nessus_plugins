...
# extracted from openSUSE Security Update openSUSE-2019-10.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : polkit (openSUSE-2019-10)");
...
Security issue fixed :
  ...
  - CVE-2018-19788: Fixed handling of UIDs over MAX_UINT
    (bsc#1118277)

This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1118277");
...
if ( rpm_check(release:"SUSE15.0", reference:"libpolkit0-0.114-lp150.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libpolkit0-debuginfo-0.114-lp150.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"polkit-0.114-lp150.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"polkit-debuginfo-0.114-lp150.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"polkit-debugsource-0.114-lp150.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"polkit-devel-0.114-lp150.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"polkit-devel-debuginfo-0.114-lp150.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"typelib-1_0-Polkit-1_0-0.114-lp150.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libpolkit0-32bit-0.114-lp150.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libpolkit0-32bit-debuginfo-0.114-lp150.2.6.1") ) flag++;
