...
# openSUSE Security Update openSUSE-SU-2024:0253-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : python-Pillow (openSUSE-SU-2024:0253-1)");
...
number.");
  ...
  # https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/GCGXLEMT363ZHOQX2SPXT2G7LEECANKD/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?40c46b0d");
...
var pkgs = [
    {'reference':'python3-Pillow-8.4.0-bp155.3.9.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-Pillow-tk-8.4.0-bp155.3.9.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE}
];
