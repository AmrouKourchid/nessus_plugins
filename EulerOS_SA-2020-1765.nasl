...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : telnet (EulerOS-SA-2020-1765)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1765
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f80bc946");
...
pkgs = ["telnet-0.17-64.h1.eulerosv2r7"];
