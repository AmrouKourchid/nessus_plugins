...
if (description)
{
  ...
  script_cve_id("CVE-2024-36621", "CVE-2024-36623");

  script_name(english:"EulerOS 2.0 SP11 : docker-engine (EulerOS-SA-2025-1134)");
...
affected by the following vulnerabilities :
    ...
    moby v25.0.5 is affected by a Race Condition in builder/builder-next/adapters/snapshot/layer.go. The
    vulnerability could be used to trigger concurrent builds that call the EnsureLayer function resulting in
    resource leaks/exhaustion.(CVE-2024-36621)

    moby v25.0.3 has a Race Condition vulnerability in the streamformatter package which can be used to
    trigger multiple concurrent write operations resulting in data corruption or application
    crashes.(CVE-2024-36623)
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1134
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e6cf48ba");
...
"Update the affected docker-engine packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-36623");
...
var pkgs = [
  "docker-engine-18.09.0-300.h59.47.45.eulerosv2r11",
  "docker-engine-selinux-18.09.0-300.h59.47.45.eulerosv2r11"
];
