...
if (description)
{
  ...
  script_cve_id("CVE-2022-49629");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-49629");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: nexthop: Fix data-races around
    nexthop_compat_mode. While reading nexthop_compat_mode, it can be changed concurrently. Thus, we need to
    add READ_ONCE() to its readers. (CVE-2022-49629)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-49629");
