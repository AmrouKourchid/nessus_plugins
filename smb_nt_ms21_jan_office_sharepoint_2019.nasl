...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"4493161");
  script_xref(name:"MSKB", value:"4493162");
  script_xref(name:"MSFT", value:"MS21-4493161");
  script_xref(name:"MSFT", value:"MS21-4493162");
  script_xref(name:"CEA-ID", value:"CEA-2021-0001");

  script_name(english:"Security Updates for Microsoft SharePoint Server 2019 (January 2021)");
...
number.");
  # https://support.microsoft.com/en-us/help/4493161/security-update-for-sharepoint-server-2019-language-pack-jan-12-2021
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?08f9a93f");
  # https://support.microsoft.com/en-us/help/4493162/security-update-for-sharepoint-server-2019-january-12-2021
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?57386ea2");
