...
if (description)
{
  ...
  script_cve_id("CVE-2022-2880", "CVE-2022-39229", "CVE-2022-41715");

  script_name(english:"CentOS 9 : grafana-9.0.9-2.el9");
...
grafana-9.0.9-2.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=25553");
