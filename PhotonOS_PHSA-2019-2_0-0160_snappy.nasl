...
if (description)
{
  ...
  script_cve_id("CVE-2018-7577");

  script_name(english:"Photon OS 2.0: Snappy PHSA-2019-2.0-0160");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the snappy package has been released.");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-7577");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:vmware:photonos:snappy");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'snappy-1.1.7-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'snappy-debuginfo-1.1.7-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'snappy-devel-1.1.7-1.ph2')) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'snappy');
}
