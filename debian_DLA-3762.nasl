...
# extracted from Debian Security Advisory dla-3762. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3762 : unadf - security update");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/unadf");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2016-1243");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2016-1244");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/unadf");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'unadf', 'reference': '0.7.11a-4+deb11u1~deb10u1'}
];
