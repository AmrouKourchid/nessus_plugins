...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2013-0502.html");
  script_set_attribute(attribute:"solution", value:
"Update the affected xorg-x11-apps, xorg-x11-server-utils and / or xorg-x11-utils packages.");
...
var pkgs = [
    {'reference':'xorg-x11-apps-7.6-6.el6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xorg-x11-server-utils-7.5-13.el6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xorg-x11-utils-7.5-6.el6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xorg-x11-apps-7.6-6.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xorg-x11-server-utils-7.5-13.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xorg-x11-utils-7.5-6.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
];
