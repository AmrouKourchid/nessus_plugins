...
# extracted from Red Hat Security Advisory RHSA-2025:7540. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:7540");

  script_name(english:"RHEL 8 : libjpeg-turbo (RHSA-2025:7540)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for libjpeg-turbo.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2025:7540 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1847155");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_7540.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f6e2ce7a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:7540");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libjpeg-turbo package based on the guidance in RHSA-2025:7540.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libjpeg-turbo-1.5.3-14.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libjpeg-turbo-devel-1.5.3-14.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libjpeg-turbo-utils-1.5.3-14.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'turbojpeg-1.5.3-14.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'turbojpeg-devel-1.5.3-14.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
