...
# extracted from Ubuntu Security Notice USN-7089-7. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"7089-7");

  script_name(english:"Ubuntu 22.04 LTS / 24.04 LTS : Linux kernel (Low Latency) vulnerabilities (USN-7089-7)");
...
referenced in the USN-7089-7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7089-7");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-6.8.0-48-lowlatency");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-6.8.0-48-lowlatency-64k");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-7089-7');
}
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-7089-7');
  }
  else
  {
