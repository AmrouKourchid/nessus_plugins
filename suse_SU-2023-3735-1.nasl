...
# SUSE update advisory SUSE-SU-2023:3735-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:3735-1");

  script_name(english:"SUSE SLES12 Security Update : xrdp (SUSE-SU-2023:3735-1)");
...
in the SUSE-SU-2023:3735-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-September/016297.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1d246ba9");
...
var pkgs = [
    {'reference':'xrdp-0.9.10-3.11.1', 'sp':'5', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5']},
    {'reference':'xrdp-0.9.10-3.11.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.5']}
];
