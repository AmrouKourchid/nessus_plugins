...
# extracted from Red Hat Security Advisory samba3x. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2015-5296", "CVE-2015-5299", "CVE-2015-7560");

  script_name(english:"RHEL 5 : samba3x (Unpatched Vulnerability) (deprecated)");
