...
if (description)
{
  ...
  script_name(english:"Adobe Digital Editions < 4.5.7 Multiple Vulnerabilities (APSB17-39)");
...
"The version of Adobe Digital Editions installed on the remote Windows host is prior to 4.5.7. It is, therefore, affected
