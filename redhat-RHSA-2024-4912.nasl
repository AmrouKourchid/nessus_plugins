...
# extracted from Red Hat Security Advisory RHSA-2024:4912. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:4912");

  script_name(english:"RHEL 9 : freeradius (RHSA-2024:4912)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_4912.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5ab8fca1");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2263240");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:4912");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL freeradius package based on the guidance in RHSA-2024:4912.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'freeradius-3.0.21-26.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freeradius-devel-3.0.21-26.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freeradius-doc-3.0.21-26.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freeradius-krb5-3.0.21-26.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freeradius-ldap-3.0.21-26.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freeradius-utils-3.0.21-26.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-freeradius-3.0.21-26.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
