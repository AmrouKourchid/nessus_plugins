...
# extracted from Ubuntu Security Notice USN-4464-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS : GNOME Shell vulnerability (USN-4464-1)");
...
USN-4464-1 advisory.
    ...
    It was discovered that GNOME Shell incorrectly handled the login screen password dialog. Sensitive
    information could possibly be exposed during user logout.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4464-1");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'gnome-shell', 'pkgver': '3.36.4-1ubuntu1~20.04.2'},
    {'osver': '20.04', 'pkgname': 'gnome-shell-common', 'pkgver': '3.36.4-1ubuntu1~20.04.2'},
    {'osver': '20.04', 'pkgname': 'gnome-shell-extension-prefs', 'pkgver': '3.36.4-1ubuntu1~20.04.2'}
];
