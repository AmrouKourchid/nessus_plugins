...
# extracted from Fedora Security Advisory FEDORA-2023-4953fc03b9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-4953fc03b9");

  script_name(english:"Fedora 39 : python3.11 (2023-4953fc03b9)");
...
FEDORA-2023-4953fc03b9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-4953fc03b9");
...
var pkgs = [
    {'reference':'python3.11-3.11.5-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
