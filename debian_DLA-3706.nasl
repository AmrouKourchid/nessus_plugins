...
# extracted from Debian Security Advisory dla-3706. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3706 : netatalk - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3706
advisory.
...
var pkgs = [
    {'release': '10.0', 'prefix': 'netatalk', 'reference': '3.1.12~ds-3+deb10u5'},
    {'release': '10.0', 'prefix': 'netatalk-dbg', 'reference': '3.1.12~ds-3+deb10u5'}
];
