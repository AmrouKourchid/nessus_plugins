...
if (description)
{
  ...
  script_cve_id("CVE-2025-0501");
  script_xref(name:"IAVA", value:"2025-A-0064");

  script_name(english:"Amazon WorkSpaces < 5.22.1 MITM");
...
"Update to version 5.22.1 or later");
  script_set_attribute(attribute:"agent", value:"all");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:H/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:H/PR:N/UI:R/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-0501");
  ...
  script_dependencies("amazon_workspaces_client_win_installed.nbin", "amazon_workspaces_client_macos_installed.nbin");
