...
# Rocky Linux Security Advisory RLSA-2023:4520.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2023:4520");

  script_name(english:"Rocky Linux 8 : python-requests (RLSA-2023:4520)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2023:4520");
