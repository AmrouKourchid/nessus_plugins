...
# extracted from Oracle Linux Security Advisory ELSA-2020-1054.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : mailman (ELSA-2020-1054)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2020-1054.html");
...
var pkgs = [
    {'reference':'mailman-2.1.15-30.el7', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
