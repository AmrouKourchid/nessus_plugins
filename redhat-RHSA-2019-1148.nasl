...
referenced in the RHSA-2019:1148 advisory.
    ...
    The following packages have been upgraded to a later upstream version: rh-ruby25-ruby (2.5.5).
    (BZ#1700274)
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_1148.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b3e0cf1b");
