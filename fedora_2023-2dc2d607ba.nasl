...
# extracted from Fedora Security Advisory FEDORA-2023-2dc2d607ba
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-2dc2d607ba");

  script_name(english:"Fedora 36 : php (2023-2dc2d607ba)");
...
FEDORA-2023-2dc2d607ba advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-2dc2d607ba");
...
var pkgs = [
    {'reference':'php-8.1.14-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
