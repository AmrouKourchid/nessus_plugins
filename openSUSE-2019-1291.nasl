...
# extracted from openSUSE Security Update openSUSE-2019-1291.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libssh2_org (openSUSE-2019-1291)");
...
This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1130103");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1133528");
...
if ( rpm_check(release:"SUSE15.0", reference:"libssh2-1-1.8.0-lp150.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libssh2-1-debuginfo-1.8.0-lp150.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libssh2-devel-1.8.0-lp150.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libssh2_org-debugsource-1.8.0-lp150.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libssh2-1-32bit-1.8.0-lp150.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libssh2-1-32bit-debuginfo-1.8.0-lp150.3.6.1") ) flag++;
