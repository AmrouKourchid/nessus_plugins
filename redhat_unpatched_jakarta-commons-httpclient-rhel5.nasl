...
# extracted from Red Hat Security Advisory jakarta-commons-httpclient. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 5 : jakarta-commons-httpclient (Unpatched Vulnerability) (deprecated)");
