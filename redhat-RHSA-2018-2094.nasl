...
# extracted from Red Hat Security Advisory RHSA-2018:2094. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:2094");

  script_name(english:"RHEL 6 : patch (RHSA-2018:2094)");
...
the RHSA-2018:2094 advisory.

  - patch: Malicious patch files cause ed to execute arbitrary commands (CVE-2018-1000156)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_2094.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c447edfb");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:2094");
...
"Update the RHEL patch package based on the guidance in RHSA-2018:2094.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'patch-2.6-8.el6_7', 'sp':'7', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'patch-2.6-8.el6_7', 'sp':'7', 'cpu':'ppc64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'patch-2.6-8.el6_7', 'sp':'7', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'patch-2.6-8.el6_7', 'sp':'7', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
