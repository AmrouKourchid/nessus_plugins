...
# extracted from Fedora Security Advisory FEDORA-2024-cafa04a149
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-cafa04a149");

  script_name(english:"Fedora 39 : exercism (2024-cafa04a149)");
...
FEDORA-2024-cafa04a149 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-cafa04a149");
  script_set_attribute(attribute:"solution", value:
"Update the affected exercism package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:exercism");
...
var pkgs = [
    {'reference':'exercism-3.3.0-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'exercism');
}
