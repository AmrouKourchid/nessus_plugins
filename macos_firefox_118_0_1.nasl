...
if (description)
{
  ...
  script_name(english:"Mozilla Firefox < 118.0.1");

  script_set_attribute(attribute:"synopsis", value:
"A web browser installed on the remote macOS or Mac OS X host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Firefox installed on the remote macOS or Mac OS X host is prior to 118.0.1. It is, therefore, affected by
a vulnerability as referenced in the mfsa2023-44 advisory.
...
"Upgrade to Mozilla Firefox version 118.0.1 or later.");
...
mozilla_check_version(version:version, path:path, product:'firefox', esr:FALSE, fix:'118.0.1', severity:SECURITY_HOLE);
