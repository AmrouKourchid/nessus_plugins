...
# extracted from Red Hat Security Advisory RHSA-2024:2377. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2377");

  script_name(english:"RHEL 9 : zziplib (RHSA-2024:2377)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2377.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ea98eb0d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2377");
...
"Update the RHEL zziplib package based on the guidance in RHSA-2024:2377.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'zziplib-0.13.71-11.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'zziplib-devel-0.13.71-11.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'zziplib-utils-0.13.71-11.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
