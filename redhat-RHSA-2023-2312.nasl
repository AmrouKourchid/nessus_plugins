...
"The remote Red Hat host is missing a security update for jackson.");
...
the RHSA-2023:2312 advisory.
    ...
    Jackson is a suite of data-processing tools for Java, including the flagship streaming JSON parser /
    generator library, matching data-binding library, and additional modules to process data encoded in
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3479a418");
...
"Update the RHEL jackson package based on the guidance in RHSA-2023:2312.");
