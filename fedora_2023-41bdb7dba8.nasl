...
# extracted from Fedora Security Advisory FEDORA-2023-41bdb7dba8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-41bdb7dba8");

  script_name(english:"Fedora 38 : polkit (2023-41bdb7dba8)");
...
FEDORA-2023-41bdb7dba8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-41bdb7dba8");
...
var pkgs = [
    {'reference':'polkit-122-3.fc38.1', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
