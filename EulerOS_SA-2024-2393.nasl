...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : httpd (EulerOS-SA-2024-2393)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2393
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bd81a8ae");
...
var pkgs = [
  "httpd-2.4.34-24.h22.eulerosv2r9",
  "httpd-filesystem-2.4.34-24.h22.eulerosv2r9",
  "httpd-tools-2.4.34-24.h22.eulerosv2r9",
  "mod_ssl-2.4.34-24.h22.eulerosv2r9"
];
