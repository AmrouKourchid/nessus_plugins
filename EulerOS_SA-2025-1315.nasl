...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP13 : git (EulerOS-SA-2025-1315)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1315
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?74c2ac86");
...
var pkgs = [
  "git-2.33.0-13.h3.eulerosv2r13",
  "git-core-2.33.0-13.h3.eulerosv2r13",
  "git-help-2.33.0-13.h3.eulerosv2r13"
];
