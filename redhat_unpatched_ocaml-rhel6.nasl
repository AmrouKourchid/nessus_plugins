...
# extracted from Red Hat Security Advisory ocaml. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2012-0839", "CVE-2018-9838");

  script_name(english:"RHEL 6 : ocaml (Unpatched Vulnerability) (deprecated)");
