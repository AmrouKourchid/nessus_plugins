...
# extracted from Fedora Security Advisory FEDORA-2024-45b02f63e4
#
...
if (description)
{
  ...
  script_cve_id("CVE-2023-34457");
  script_xref(name:"FEDORA", value:"2024-45b02f63e4");

  script_name(english:"Fedora 41 : python-mechanicalsoup (2024-45b02f63e4)");
...
FEDORA-2024-45b02f63e4 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-45b02f63e4");
  script_set_attribute(attribute:"solution", value:
"Update the affected python-mechanicalsoup package.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:C/I:N/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:N/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-34457");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:python-mechanicalsoup");
...
var pkgs = [
    {'reference':'python-mechanicalsoup-1.3.0-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python-mechanicalsoup');
}
