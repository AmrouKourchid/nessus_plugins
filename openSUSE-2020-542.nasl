...
# extracted from openSUSE Security Update openSUSE-2020-542.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : freeradius-server (openSUSE-2020-542)");
...
This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1132549");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1132664");
...
if ( rpm_check(release:"SUSE15.1", reference:"freeradius-server-3.0.16-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"freeradius-server-debuginfo-3.0.16-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"freeradius-server-debugsource-3.0.16-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"freeradius-server-devel-3.0.16-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"freeradius-server-krb5-3.0.16-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"freeradius-server-krb5-debuginfo-3.0.16-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"freeradius-server-ldap-3.0.16-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"freeradius-server-ldap-debuginfo-3.0.16-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"freeradius-server-libs-3.0.16-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"freeradius-server-libs-debuginfo-3.0.16-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"freeradius-server-mysql-3.0.16-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"freeradius-server-mysql-debuginfo-3.0.16-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"freeradius-server-perl-3.0.16-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"freeradius-server-perl-debuginfo-3.0.16-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"freeradius-server-postgresql-3.0.16-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"freeradius-server-postgresql-debuginfo-3.0.16-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"freeradius-server-python-3.0.16-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"freeradius-server-python-debuginfo-3.0.16-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"freeradius-server-sqlite-3.0.16-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"freeradius-server-sqlite-debuginfo-3.0.16-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"freeradius-server-utils-3.0.16-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"freeradius-server-utils-debuginfo-3.0.16-lp151.4.3.1") ) flag++;
