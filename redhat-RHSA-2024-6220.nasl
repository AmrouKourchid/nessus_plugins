...
# extracted from Red Hat Security Advisory RHSA-2024:6220. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:6220");

  script_name(english:"RHEL 8 : python39:3.9 (RHSA-2024:6220)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for python39:3.9.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:6220 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_6220.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f0da4a5d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:6220");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python39:3.9 package based on the guidance in RHSA-2024:6220.");
  ...
  'python39:3.9': [
    {
      ...
      'pkgs': [
        {'reference':'python39-3.9.7-2.module+el8.6.0+20026+579726f4.2', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python39-3.9.7-2.module+el8.6.0+20026+579726f4.2', 'sp':'6', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'python39-devel-3.9.7-2.module+el8.6.0+20026+579726f4.2', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python39-devel-3.9.7-2.module+el8.6.0+20026+579726f4.2', 'sp':'6', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python39-idle-3.9.7-2.module+el8.6.0+20026+579726f4.2', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python39-idle-3.9.7-2.module+el8.6.0+20026+579726f4.2', 'sp':'6', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python39-idna-2.10-3.module+el8.4.0+9822+20bf1249', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python39-libs-3.9.7-2.module+el8.6.0+20026+579726f4.2', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python39-libs-3.9.7-2.module+el8.6.0+20026+579726f4.2', 'sp':'6', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'python39-rpm-macros-3.9.7-2.module+el8.6.0+20026+579726f4.2', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'python39-test-3.9.7-2.module+el8.6.0+20026+579726f4.2', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python39-test-3.9.7-2.module+el8.6.0+20026+579726f4.2', 'sp':'6', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python39-tkinter-3.9.7-2.module+el8.6.0+20026+579726f4.2', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python39-tkinter-3.9.7-2.module+el8.6.0+20026+579726f4.2', 'sp':'6', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
