...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : openldap (EulerOS-SA-2020-1685)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1685
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?176de708");
...
pkgs = ["openldap-2.4.44-5.h5",
        "openldap-clients-2.4.44-5.h5",
        "openldap-devel-2.4.44-5.h5",
        "openldap-servers-2.4.44-5.h5"];
