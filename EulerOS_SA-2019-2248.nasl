...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : icu (EulerOS-SA-2019-2248)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2248
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7f03760f");
...
pkgs = ["libicu-50.1.2-15.h3",
        "libicu-devel-50.1.2-15.h3"];
