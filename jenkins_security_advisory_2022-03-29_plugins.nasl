...
var constraints = [
  { 'max_version' : '1.41', 'fixed_version' : '1.42', 'plugin' : 'instant-messaging Plugin' },
  { 'max_version' : '1.3.3', 'plugin' : 'Tests Selector Plugin', 'fixed_display' : 'See vendor advisory' },
  { 'max_version' : '0.6', 'plugin' : 'SiteMonitor Plugin', 'fixed_display' : 'See vendor advisory' },
  { 'max_version' : '1.4.10', 'fixed_version' : '1.5.0', 'plugin' : 'RocketChat Notifier Plugin' },
  { 'max_version' : '0.7.0', 'fixed_version' : '0.7.1', 'plugin' : 'Proxmox Plugin' },
  { 'max_version' : '1.3', 'plugin' : 'Pipeline: Phoenix AutoTest Plugin', 'fixed_display' : 'See vendor advisory' },
  { 'max_version' : '0.13.0', 'plugin' : 'Job and Node ownership Plugin', 'fixed_display' : 'See vendor advisory' },
  { 'max_version' : '165.', 'fixed_version' : '166.', 'plugin' : 'JiraTestResultReporter Plugin' },
  { 'max_version' : '1.2.1', 'fixed_version' : '1.2.2', 'plugin' : 'Flaky Test Handler Plugin' },
  { 'max_version' : '1.1.1', 'plugin' : 'Coverage/Complexity Scatter Plot Plugin', 'fixed_display' : 'See vendor advisory' },
  { 'max_version' : '2.3', 'fixed_version' : '2.4', 'plugin' : 'Continuous Integration with Toad Edge Plugin' },
  { 'max_version' : '3.1.0', 'fixed_version' : '3.2.0', 'plugin' : 'Bitbucket Server Integration Plugin' }
];
