...
# extracted from Fedora Security Advisory FEDORA-2024-4d2d73ab31
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-4d2d73ab31");

  script_name(english:"Fedora 40 : chromium (2024-4d2d73ab31)");
...
FEDORA-2024-4d2d73ab31 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-4d2d73ab31");
...
"Update the affected chromium package.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2024-3157");
...
var pkgs = [
    {'reference':'chromium-123.0.6312.122-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
