...
# extracted from Fedora Security Advisory FEDORA-2022-9cd3e3a570
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-9cd3e3a570");

  script_name(english:"Fedora 37 : rubygem-rails-html-sanitizer (2022-9cd3e3a570)");
...
FEDORA-2022-9cd3e3a570 advisory.
    ...
    ```
    * Fri Aug  5 2022 Vt Ondruch <vondruch@redhat.com> - 1.4.3-1
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-9cd3e3a570");
...
var pkgs = [
    {'reference':'rubygem-rails-html-sanitizer-1.4.3-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
