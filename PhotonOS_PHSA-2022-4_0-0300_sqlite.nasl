...
# extracted from VMware Security Advisory PHSA-2022-4.0-0300. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Sqlite PHSA-2022-4.0-0300");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the sqlite package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-300.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'sqlite-3.38.5-2.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'sqlite-devel-3.38.5-2.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'sqlite-libs-3.38.5-2.ph4')) flag++;
