...
# extracted from Fedora Security Advisory FEDORA-2024-cfbdc342a2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-cfbdc342a2");

  script_name(english:"Fedora 41 : cyrus-imapd (2024-cfbdc342a2)");
...
FEDORA-2024-cfbdc342a2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-cfbdc342a2");
...
var pkgs = [
    {'reference':'cyrus-imapd-3.8.3-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
