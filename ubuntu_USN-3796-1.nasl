...
referenced in the USN-3796-1 advisory.

    Daniel Hoffman discovered that Paramiko incorrectly handled authentication when being used as a server. A
    remote attacker could use this issue to bypass authentication without any credentials.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3796-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'python-paramiko', 'pkgver': '1.10.1-1git1ubuntu0.2'},
    {'osver': '16.04', 'pkgname': 'python-paramiko', 'pkgver': '1.16.0-1ubuntu0.2'},
    {'osver': '16.04', 'pkgname': 'python3-paramiko', 'pkgver': '1.16.0-1ubuntu0.2'},
    {'osver': '18.04', 'pkgname': 'python-paramiko', 'pkgver': '2.0.0-1ubuntu1.1'},
    {'osver': '18.04', 'pkgname': 'python3-paramiko', 'pkgver': '2.0.0-1ubuntu1.1'}
];
