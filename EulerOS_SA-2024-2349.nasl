...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP12 : python-pip (EulerOS-SA-2024-2349)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2349
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8b14667e");
...
var pkgs = [
  "python-pip-wheel-21.3.1-2.h3.eulerosv2r12",
