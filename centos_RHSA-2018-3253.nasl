...
# CentOS Errata and Security Advisory 2018:3253 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : jasper (CESA-2018:3253)");
...
Enterprise Linux 7.6 Release Notes linked from the References section.");
  # https://lists.centos.org/pipermail/centos-cr-announce/2018-November/005479.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1b4ce02f");
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"jasper-1.900.1-33.el7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"jasper-devel-1.900.1-33.el7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"jasper-libs-1.900.1-33.el7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"jasper-utils-1.900.1-33.el7")) flag++;
