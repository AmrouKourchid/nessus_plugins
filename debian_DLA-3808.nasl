...
# extracted from Debian Security Advisory dla-3808. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3808 : intel-microcode - security update");
...
dla-3808 advisory.
    ...
    -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3808-1                debian-lts@lists.debian.org
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-22655");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-28746");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-38575");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-39368");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-43490");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'intel-microcode', 'reference': '3.20240312.1~deb10u1'}
];
