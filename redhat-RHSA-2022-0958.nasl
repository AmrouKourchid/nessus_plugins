...
"The remote Red Hat host is missing one or more security updates for kpatch-patch-4_18_0-147_58_1.");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c948f53e");
...
"Update the RHEL kpatch-patch-4_18_0-147_58_1 package based on the guidance in RHSA-2022:0958.");
  ...
  script_cwe_id(131, 281, 362, 416, 862);
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  var cve_list = make_list('CVE-2021-0920', 'CVE-2021-4028', 'CVE-2021-4083', 'CVE-2021-4155', 'CVE-2022-0330', 'CVE-2022-0492', 'CVE-2022-22942');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for RHSA-2022:0958');
  }
  else
  {
