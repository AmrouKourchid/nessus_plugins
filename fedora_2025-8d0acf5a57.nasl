...
# extracted from Fedora Security Advisory FEDORA-2025-8d0acf5a57
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-8d0acf5a57");

  script_name(english:"Fedora 41 : php (2025-8d0acf5a57)");
...
FEDORA-2025-8d0acf5a57 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-8d0acf5a57");
...
var pkgs = [
    {'reference':'php-8.3.19-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
