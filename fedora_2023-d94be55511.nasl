...
# extracted from Fedora Security Advisory FEDORA-2023-d94be55511
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-d94be55511");

  script_name(english:"Fedora 38 : gdb (2023-d94be55511)");
...
FEDORA-2023-d94be55511 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-d94be55511");
...
var pkgs = [
    {'reference':'gdb-13.2-5.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
