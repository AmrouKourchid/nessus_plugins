...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Elasticsearch PHSA-2021-2.0-0317");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'elasticsearch-6.8.13-1.ph2')) flag++;
