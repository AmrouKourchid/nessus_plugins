...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Subversion PHSA-2021-4.0-0008");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'subversion-1.14.1-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'subversion-devel-1.14.1-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'subversion-perl-1.14.1-1.ph4')) flag++;
