...
# extracted from Debian Security Advisory dla-4113. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2025-30349");

  script_name(english:"Debian dla-4113 : php-horde-imp - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has a package installed that is affected by a vulnerability as referenced in the dla-4113
advisory.
...
number.");
  # https://security-tracker.debian.org/tracker/source-package/php-horde-imp
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8f1624a1");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2025-30349");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bullseye/php-horde-imp");
  script_set_attribute(attribute:"solution", value:
"Upgrade the php-horde-imp packages.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:P/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:C/C:L/I:L/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-30349");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:php-horde-imp");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'php-horde-imp', 'reference': '6.2.27-2+deb11u1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'php-horde-imp');
}
