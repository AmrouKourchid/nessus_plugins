...
# extracted from Red Hat Security Advisory RHSA-2024:9827. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:9827");

  script_name(english:"RHEL 9 : libvpx (RHSA-2024:9827)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for libvpx.");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_9827.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?de1c34fb");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:9827");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libvpx package based on the guidance in RHSA-2024:9827.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libvpx-1.9.0-8.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvpx-devel-1.9.0-8.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
