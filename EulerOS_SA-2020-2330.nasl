...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : binutils (EulerOS-SA-2020-2330)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2330
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4e8b61b8");
...
pkgs = ["binutils-2.25.1-22.base.h52",
        "binutils-devel-2.25.1-22.base.h52"];
