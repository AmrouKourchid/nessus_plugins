...
if (description)
{
  ...
  script_name(english:"MariaDB 11.1.0 < 11.1.3");

  script_set_attribute(attribute:"synopsis", value:
"The remote database server is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of MariaDB installed on the remote host is prior to 11.1.3. It is, therefore, affected by a vulnerability as
referenced in the mariadb-1113-release-notes advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://mariadb.com/kb/en/mariadb-1113-release-notes");
  script_set_attribute(attribute:"solution", value:
"Upgrade to MariaDB version 11.1.3 or later.");
