...
if (description)
{
  ...
  script_name(english:"MariaDB 10.2.0 < 10.2.43 Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote database server is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of MariaDB installed on the remote host is prior to 10.2.43. It is, therefore, affected by multiple
vulnerabilities as referenced in the mdb-10243-rn advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://mariadb.com/kb/en/mariadb-10-2-43-release-notes");
  script_set_attribute(attribute:"solution", value:
"Upgrade to MariaDB version 10.2.43 or later.");
...
var constraints = [
  { 'min_version' : '10.2', 'fixed_version' : '10.2.43' }
];
