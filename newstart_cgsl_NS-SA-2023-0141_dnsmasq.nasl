...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 6.06 : dnsmasq Vulnerability (NS-SA-2023-0141) (deprecated)");
...
"This plugin has been deprecated.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/info/CVE-2022-0934");
