...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5034795");
  script_xref(name:"MSKB", value:"5034833");
  script_xref(name:"MSFT", value:"MS24-5034795");
  script_xref(name:"MSFT", value:"MS24-5034833");
  script_xref(name:"IAVA", value:"2024-A-0092-S");
  script_xref(name:"IAVA", value:"2024-A-0091-S");

  script_name(english:"KB5034833: Windows Server 2008 Security Update (February 2024)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5034833. It is, therefore, affected by multiple vulnerabilities
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5034795");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5034833");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5034833 or Cumulative Update 5034795");
...
if (
  smb_check_rollup(os:'6.0',
                   ...
                   rollup_date:'02_2024',
                   bulletin:bulletin,
                   rollup_kb_list:[5034833, 5034795])
)
{
