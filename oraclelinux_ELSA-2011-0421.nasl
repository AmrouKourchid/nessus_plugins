...
ELSA-2011-0421 advisory.
    ...
    - [fs] Revert '[fs] inotify: stop kernel memory leak on file creation failure' (Eric Paris) [656831
    656832] {CVE-2010-4250}
    ...
    - [ib] cm: Bump reference count on cm_id before invoking callback (Doug Ledford) [676190 676191]
    {CVE-2011-0695}
    - [rdma] cm: Fix crash in request handlers (Doug Ledford) [676190 676191] {CVE-2011-0695}
    - [net] bridge: Fix mglist corruption that leads to memory corruption (Herbert Xu) [678172 659421]
    {CVE-2011-0716}
    - [netdrv] cxgb3/cxgb3_main.c: prevent reading uninitialized stack memory (Doug Ledford) [633156 633157]
    {CVE-2010-3296}
    ...
    - [fs] inotify: stop kernel memory leak on file creation failure (Eric Paris) [656831 656832]
    {CVE-2010-4250}
    - [net] sctp: fix kernel panic resulting from mishandling of icmp dest unreachable msg (Neil Horman)
    [667028 667029] {CVE-2010-4526}
    - [mm] install_special_mapping skips security_file_mmap check (Frantisek Hrbata) [662198 662199]
    {CVE-2010-4346}
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2010-4656");
...
var pkgs = [
    ...
    {'reference':'kernel-firmware-2.6.32-71.24.1.el6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-firmware-2.6.32'},
    {'reference':'kernel-headers-2.6.32-71.24.1.el6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-headers-2.6.32'},
    {'reference':'perf-2.6.32-71.24.1.el6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'kernel-firmware-2.6.32-71.24.1.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-firmware-2.6.32'},
    ...
    {'reference':'perf-2.6.32-71.24.1.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
];
