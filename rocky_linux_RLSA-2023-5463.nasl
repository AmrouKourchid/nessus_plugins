...
# Rocky Linux Security Advisory RLSA-2023:5463.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2023:5463");

  script_name(english:"Rocky Linux 8 : python3.11 (RLSA-2023:5463)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Rocky Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Rocky Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
RLSA-2023:5463 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2023:5463");
...
var pkgs = [
    ...
    {'reference':'python3.11-debuginfo-3.11.2-2.el8_8.2', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3.11-debugsource-3.11.2-2.el8_8.2', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
