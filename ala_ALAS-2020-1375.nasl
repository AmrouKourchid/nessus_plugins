...
if (description)
{
  ...
  script_cve_id("CVE-2018-20852", "CVE-2019-18348");
...
"The version of python27 installed on the remote host is prior to 2.7.18-1.137. It is, therefore, affected by multiple
vulnerabilities as referenced in the ALAS-2020-1375 advisory.
    ...
    inject CRLF sequences and HTTP headers by abusing the host part of the URL. (CVE-2019-18348)(Additional
    CVE details added after release.)
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/ALAS-2020-1375.html");
...
"Run 'yum update python27' to update your system.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2019-18348");
...
var pkgs = [
    {'reference':'python27-2.7.18-1.137.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python27-2.7.18-1.137.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python27-debuginfo-2.7.18-1.137.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python27-debuginfo-2.7.18-1.137.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python27-devel-2.7.18-1.137.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python27-devel-2.7.18-1.137.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python27-libs-2.7.18-1.137.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python27-libs-2.7.18-1.137.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python27-test-2.7.18-1.137.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python27-test-2.7.18-1.137.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python27-tools-2.7.18-1.137.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python27-tools-2.7.18-1.137.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE}
];
