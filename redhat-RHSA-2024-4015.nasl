...
# extracted from Red Hat Security Advisory RHSA-2024:4015. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:4015");
  script_xref(name:"IAVA", value:"2024-A-0387-S");

  script_name(english:"RHEL 9 : thunderbird (RHSA-2024:4015)");
...
referenced in the RHSA-2024:4015 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_4015.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?30c89701");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:4015");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL thunderbird package based on the guidance in RHSA-2024:4015.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'thunderbird-115.12.1-1.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
