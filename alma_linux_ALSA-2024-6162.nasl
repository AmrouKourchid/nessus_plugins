...
# AlmaLinux Security Advisory ALSA-2024:6162.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:6162");

  script_name(english:"AlmaLinux 9 : python-urllib3 (ALSA-2024:6162)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2024-6162.html");
...
var pkgs = [
    {'reference':'python3-urllib3-1.26.5-5.el9_4.1', 'release':'9', 'el_string':'el9_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'}
];
