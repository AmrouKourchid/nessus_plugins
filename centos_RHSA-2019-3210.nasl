...
# CentOS Errata and Security Advisory 2019:3210 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : thunderbird (CESA-2019:3210)");
...
the CVE page(s) listed in the References section.");
  # https://lists.centos.org/pipermail/centos-announce/2019-October/023498.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dd26060c");
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"thunderbird-68.2.0-1.el7.centos", allowmaj:TRUE)) flag++;
