...
# extracted from Debian Security Advisory dla-3848. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3848 : elpa-org - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3848
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/org-mode");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'elpa-org', 'reference': '9.1.14+dfsg-3+deb10u3'},
    {'release': '10.0', 'prefix': 'org-mode', 'reference': '9.1.14+dfsg-3+deb10u3'}
];
