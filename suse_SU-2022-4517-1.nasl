...
# SUSE update advisory SUSE-SU-2022:4517-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:4517-1");

  script_name(english:"SUSE SLES15 Security Update : kernel (Live Patch 25 for SLE 15 SP3) (SUSE-SU-2022:4517-1)");
...
referenced in the SUSE-SU-2022:4517-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-December/013256.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5848f4c2");
  script_set_attribute(attribute:"solution", value:
"Update the affected kernel-livepatch-5_3_18-150300_59_98-default package.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '5.3.18-150300.59.98-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_3_18-150300_59_98-default-3-150300.2.1', 'sp':'3', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.3']},
          {'reference':'kernel-livepatch-5_3_18-150300_59_98-default-3-150300.2.1', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.3', 'sle-module-live-patching-release-15.3', 'sles-release-15.3']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kernel-livepatch-5_3_18-150300_59_98-default');
}
