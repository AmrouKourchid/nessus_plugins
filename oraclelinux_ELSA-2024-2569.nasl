...
# extracted from Oracle Linux Security Advisory ELSA-2024-2569.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : grafana-pcp (ELSA-2024-2569)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-2569.html");
...
var pkgs = [
    {'reference':'grafana-pcp-5.1.1-2.el9_4', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'grafana-pcp-5.1.1-2.el9_4', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
