...
# extracted from Red Hat Security Advisory RHSA-2024:1614. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:1614");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2024/06/20");

  script_name(english:"RHEL 8 : kernel-rt (RHSA-2024:1614)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for kernel-rt.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:1614 advisory.
    ...
    * kernel-rt: kernel: nf_tables: use-after-free vulnerability in the nft_verdict_init() function
    (JIRA:RHEL-24015)
    ...
    * kernel-rt: kernel: CIFS Filesystem Decryption Improper Input Validation Remote Code Execution
    Vulnerability in function receive_encrypted_standard of client (JIRA:RHEL-22080)

    * kernel-rt: kernel: Out of boundary write in perf_read_group() as result of overflow a perf_event's
    read_size (JIRA:RHEL-22933)

    * kernel-rt: kernel: use-after-free in amdgpu_cs_wait_all_fences in drivers/gpu/drm/amd/amdgpu/amdgpu_cs.c
    (JIRA:RHEL-24498)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_1614.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?116474ce");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:1614");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL kernel-rt package based on the guidance in RHSA-2024:1614.");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for RHSA-2024:1614');
  }
  else
  {
