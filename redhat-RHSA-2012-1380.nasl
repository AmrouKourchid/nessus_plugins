...
# extracted from Red Hat Security Advisory RHSA-2012:1380. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2012:1380");

  script_name(english:"RHEL 6 : python-django-horizon (RHSA-2012:1380)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for python-django-horizon.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 6 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2012:1380 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=852246");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2012/rhsa-2012_1380.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fa483caf");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2012:1380");
...
"Update the RHEL python-django-horizon package based on the guidance in RHSA-2012:1380.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2012-3540");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openstack-dashboard-2012.1.1-3.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'python-django-horizon-2012.1.1-3.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'python-django-horizon-doc-2012.1.1-3.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'openstack-dashboard / python-django-horizon / etc');
}
