...
# extracted from Fedora Security Advisory FEDORA-2022-91ce497459
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-91ce497459");

  script_name(english:"Fedora 36 : drupal7-i18n (2022-91ce497459)");
...
FEDORA-2022-91ce497459 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-91ce497459");
...
var pkgs = [
    {'reference':'drupal7-i18n-1.31-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
