...
# extracted from Red Hat Security Advisory espeak-ng. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 8 : espeak-ng (Unpatched Vulnerability) (deprecated)");
...
"This plugin has been deprecated as it does not adhere to established standards for this style of check.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:espeak-ng");
