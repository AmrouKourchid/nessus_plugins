...
# SUSE update advisory SUSE-SU-2025:0667-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2021-47511", "CVE-2024-35789", "CVE-2024-53104");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2025/02/26");
  script_xref(name:"SuSE", value:"SUSE-SU-2025:0667-1");

  script_name(english:"SUSE SLES12 Security Update : kernel (Live Patch 53 for SLE 12 SP5) (SUSE-SU-2025:0667-1)");
...
the SUSE-SU-2025:0667-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1227700");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1236783");
  # https://lists.suse.com/pipermail/sle-security-updates/2025-February/020417.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?adee9dcf");
...
"Update the affected kgraft-patch-4_12_14-122_194-default package.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-122.194-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_12_14-122_194-default-14-2.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.5']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kgraft-patch-4_12_14-122_194-default');
}
