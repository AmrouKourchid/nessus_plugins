...
# extracted from Fedora Security Advisory FEDORA-2024-1c5e37820f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-1c5e37820f");

  script_name(english:"Fedora 40 : ceph (2024-1c5e37820f)");
...
FEDORA-2024-1c5e37820f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-1c5e37820f");
...
var pkgs = [
    {'reference':'ceph-18.2.2-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
