...
# extracted from Red Hat Security Advisory RHSA-2021:0183. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:0183");

  script_name(english:"RHEL 8 : linux-firmware (RHSA-2021:0183)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_0183.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6f5f3551");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:0183");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1893914");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL linux-firmware package based on the guidance in RHSA-2021:0183.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'linux-firmware-20190516-96.git711d3297.el8_1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
