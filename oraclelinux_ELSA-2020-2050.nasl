...
# Oracle Linux Security Advisory ELSA-2020-2050 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : thunderbird (ELSA-2020-2050)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2020-2050.html");
...
var pkgs = [
    {'reference':'thunderbird-68.8.0-1.0.1.el7_8', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'thunderbird-68.8.0-1.0.1.el7_8', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
