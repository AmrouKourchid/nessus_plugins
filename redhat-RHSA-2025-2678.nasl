...
# extracted from Red Hat Security Advisory RHSA-2025:2678. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2022-49043", "CVE-2024-56171", "CVE-2025-24928");
  script_xref(name:"RHSA", value:"2025:2678");

  script_name(english:"RHEL 9 : libxml2 (RHSA-2025:2678)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for libxml2.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2025:2678 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_2678.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?82475437");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:2678");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libxml2 package based on the guidance in RHSA-2025:2678.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libxml2-2.9.13-9.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libxml2-devel-2.9.13-9.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-libxml2-2.9.13-9.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
