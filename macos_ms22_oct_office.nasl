...
vulnerabilities:
  ...
  - A information disclosure vulnerability in Excel. An attacker who exploited the vulnerability could use 
    the information together with other vulnerabilities in order to compromise the user’s computer or data. 
    (CVE-2022-41043)
...
"Microsoft has released a set of patches for Microsoft Office for Mac.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2022-41043");
