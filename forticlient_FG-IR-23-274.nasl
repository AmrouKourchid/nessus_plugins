...
if (description)
{
  ...
  script_cve_id("CVE-2023-41840");
  script_xref(name:"IAVA", value:"2023-A-0643-S");

  script_name(english:"Fortinet FortiClient DLL Hijacking via openssl.cnf (FG-IR-23-274)");
...
vulnerability as referenced in the FG-IR-23-274 advisory.

  - A untrusted search path vulnerability in Fortinet FortiClientWindows 7.0.9 allows an attacker to perform a
    DLL Hijack attack via a malicious OpenSSL engine library in the search path. (CVE-2023-41840)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.fortiguard.com/psirt/FG-IR-23-274");
  script_set_attribute(attribute:"solution", value:
"Upgrade to FortiClient version 7.0.10 / 7.2.2 or later.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:N/UI:R/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-41840");
...
var constraints = [
  { 'min_version' : '7.0.9', 'fixed_version' : '7.0.10' },
