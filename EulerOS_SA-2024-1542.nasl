...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : binutils (EulerOS-SA-2024-1542)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1542
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9f34d230");
...
var pkgs = [
  "binutils-2.34-4.h24.r1.eulerosv2r10"
];
