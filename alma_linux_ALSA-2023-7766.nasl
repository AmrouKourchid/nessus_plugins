...
# AlmaLinux Security Advisory ALSA-2023:7766.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:7766");
  ...
  script_name(english:"AlmaLinux 9 : containernetworking-plugins (ALSA-2023:7766)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2023-7766.html");
...
var pkgs = [
    {'reference':'containernetworking-plugins-1.3.0-6.el9_3', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'containernetworking-plugins-1.3.0-6.el9_3', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
