...
# extracted from Fedora Security Advisory FEDORA-2019-7104a00054.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-7104a00054");

  script_name(english:"Fedora 29 : cronie (2019-7104a00054)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-7104a00054");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"cronie-1.5.4-1.fc29")) flag++;
