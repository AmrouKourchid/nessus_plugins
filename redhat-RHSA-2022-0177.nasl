...
# extracted from Red Hat Security Advisory RHSA-2022:0177. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:0177");

  script_name(english:"RHEL 8 : gegl04 (RHSA-2022:0177)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for gegl04.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2022:0177 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_0177.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?096a5cb6");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:0177");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2035383");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL gegl04 package based on the guidance in RHSA-2022:0177.");
...
var constraints = [
  {
    ...
    'pkgs': [
      ...
      {'reference':'gegl04-0.4.4-6.el8_5.2', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'gegl04-devel-0.4.4-6.el8_5.2', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
