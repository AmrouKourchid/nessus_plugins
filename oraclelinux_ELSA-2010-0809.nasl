...
# extracted from Red Hat Security Advisory RHSA-2010:0809 and 
# Oracle Linux Security Advisory ELSA-2010-0809 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : xulrunner (ELSA-2010-0809)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2010-0809.html");
...
var pkgs = [
    {'reference':'xulrunner-1.9.2.11-4.0.1.el5_5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xulrunner-devel-1.9.2.11-4.0.1.el5_5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xulrunner-1.9.2.11-4.0.1.el5_5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xulrunner-devel-1.9.2.11-4.0.1.el5_5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
