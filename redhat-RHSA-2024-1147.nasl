...
# extracted from Red Hat Security Advisory RHSA-2024:1147. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:1147");

  script_name(english:"RHEL 9 : rear (RHSA-2024:1147)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for rear.");
...
the RHSA-2024:1147 advisory.

    Relax-and-Recover is a recovery and system migration utility. The utility produces a bootable image and
    restores from backup using this image. It allows to restore to different hardware and can therefore be
    also used as a migration utility.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_1147.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cc1f0164");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2258396");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:1147");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rear package based on the guidance in RHSA-2024:1147.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rear");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rear-2.6-21.el9_3', 'cpu':'ppc64le', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rear-2.6-21.el9_3', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rear-2.6-21.el9_3', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
