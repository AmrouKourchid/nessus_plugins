...
if (description)
{
  ...
  script_name(english:"SAP NetWeaver AS ABAP Multiple Vulnerabilities (3488039)");
...
"Multiple vulnerabilities may be present in SAP NetWeaver Application Server ABAP, including the following:
  ...
  - The RFC enabled function module allows a low privileged user to delete the workplace favourites of any user. This
    vulnerability could be utilized to identify usernames and access information about targeted user's workplaces and
    nodes.There is low impact on integrity and availability of the application. (CVE-2024-42371)

  - The RFC enabled function module allows a low privileged user to perform various actions, such as modifying the
    URLs of any user's favourite nodes and workbook ID.There is low impact on integrity and availability of the
    application. (CVE-2024-44117)

  - The RFC enabled function module allows a low privileged user to perform denial of service on any user and also
    change or delete favourite nodes. By sending a crafted packet in the function module targeting specific parameters,
    the specific targeted user will no longer have access to any functionality of SAP GUI. There is low impact on
    integrity and availability of the application. (CVE-2024-45285)
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://me.sap.com/notes/3488039");
...
"Apply the appropriate patch according to the vendor advisory.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-42371");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2024-45285");
