...
# extracted from Fedora Security Advisory FEDORA-2020-0e6a67af5a.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : 1:dovecot (2020-0e6a67af5a)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-0e6a67af5a");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"dovecot-2.3.9.3-1.fc30", epoch:"1")) flag++;
