...
if (description)
{
  ...
  script_name(english:"IBM DB2 DoS (7165341) (Unix)");

  script_set_attribute(attribute:"synopsis", value:
"The remote database server is affected by a denial of service vulnerability.");
  script_set_attribute(attribute:"description", value:
"According to its self-reported version number, IBM Db2 on Unix is vulnerable to a denial of service with a specially 
crafted query under certain conditions. 
...
var constraints = [
  {'equal':'10.5.0.11', 'fixed_build':'41496'},
  {'min_version':'10.5', 'fixed_version':'10.5.0.11', 'fixed_display':'10.5.0.11 + Special Build 41496'},
