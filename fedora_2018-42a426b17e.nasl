...
# extracted from Fedora Security Advisory FEDORA-2018-42a426b17e.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-42a426b17e");

  script_name(english:"Fedora 26 : gnupg2 (2018-42a426b17e)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"Minor update from upstream with fix for CVE-2018-9234 and other bug
fixes.
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-42a426b17e");
...
flag = 0;
if (rpm_check(release:"FC26", reference:"gnupg2-2.2.6-1.fc26")) flag++;
