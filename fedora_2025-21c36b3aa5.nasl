...
# extracted from Fedora Security Advisory FEDORA-2025-21c36b3aa5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-21c36b3aa5");

  script_name(english:"Fedora 40 : dnf (2025-21c36b3aa5)");
...
FEDORA-2025-21c36b3aa5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-21c36b3aa5");
  script_set_attribute(attribute:"solution", value:
"Update the affected dnf package.");
...
var pkgs = [
    {'reference':'dnf-4.23.0-1.fc40.1', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
