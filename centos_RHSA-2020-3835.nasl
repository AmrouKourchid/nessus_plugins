...
# extracted from Red Hat Security Advisory RHSA-2020:3835.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : firefox (RHSA-2020:3835)");
...
var pkgs = [
    {'reference':'firefox-78.3.0-1.el6.centos', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
