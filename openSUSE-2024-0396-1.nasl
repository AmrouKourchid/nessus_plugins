...
# openSUSE Security Update openSUSE-SU-2024:0396-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : radare2 (openSUSE-SU-2024:0396-1)");
...
number.");
  ...
  # https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/O2TWZ4JPBWFDDWVAOUETBZRA6JUPKB5S/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a7d49301");
...
var pkgs = [
    {'reference':'radare2-5.9.8-bp155.2.3.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'radare2-devel-5.9.8-bp155.2.3.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'radare2-zsh-completion-5.9.8-bp155.2.3.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE}
];
