...
# extracted from Red Hat Security Advisory RHSA-2024:2700. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2700");

  script_name(english:"RHEL 9 : varnish (RHSA-2024:2700)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2700.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ab4051a4");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2700");
...
"Update the RHEL varnish package based on the guidance in RHSA-2024:2700.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'varnish-6.6.2-2.el9_0.3', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'varnish-devel-6.6.2-2.el9_0.3', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'varnish-docs-6.6.2-2.el9_0.3', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
