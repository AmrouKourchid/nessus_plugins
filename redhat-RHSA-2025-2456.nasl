...
# extracted from Red Hat Security Advisory RHSA-2025:2456. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:2456");

  script_name(english:"RHEL 8 / 9 : OpenShift Container Platform 4.15.47 (RHSA-2025:2456)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for OpenShift Container Platform 4.15.47.");
...
in the RHSA-2025:2456 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.15.47. See the
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_2456.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?857e6932");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:2456");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.15.47 packages based on the guidance in RHSA-2025:2456.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'buildah-1.29.5-1.rhaos4.15.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openshift-hyperkube'},
      {'reference':'buildah-tests-1.29.5-1.rhaos4.15.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openshift-hyperkube'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'buildah-1.29.5-1.rhaos4.15.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openshift-hyperkube'},
      {'reference':'buildah-tests-1.29.5-1.rhaos4.15.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openshift-hyperkube'}
    ]
  }
];
