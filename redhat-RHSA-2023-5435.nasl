...
# extracted from Red Hat Security Advisory RHSA-2023:5435. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:5435");
  script_xref(name:"IAVA", value:"2023-A-0507-S");

  script_name(english:"RHEL 9 : thunderbird (RHSA-2023:5435)");
...
referenced in the RHSA-2023:5435 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_5435.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d1fd1c1c");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:5435");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL thunderbird package based on the guidance in RHSA-2023:5435.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'thunderbird-115.3.1-1.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'thunderbird-115.3.1-1.el9_2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
