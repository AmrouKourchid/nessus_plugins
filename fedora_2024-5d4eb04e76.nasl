...
# extracted from Fedora Security Advisory FEDORA-2024-5d4eb04e76
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-5d4eb04e76");

  script_name(english:"Fedora 40 : redis (2024-5d4eb04e76)");
...
FEDORA-2024-5d4eb04e76 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-5d4eb04e76");
...
var pkgs = [
    {'reference':'redis-7.2.6-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
