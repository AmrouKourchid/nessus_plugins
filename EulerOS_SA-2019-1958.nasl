...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : avahi (EulerOS-SA-2019-1958)");
...
vulnerability :
  ...
  - avahi-daemon in Avahi through 0.6.32 and 0.7
    inadvertently responds to IPv6 unicast queries with
    source addresses that are not on-link, which allows
    ...
    responding device via port-5353 UDP packets.
    (CVE-2017-6519)
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1958
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f263ffbd");
...
pkgs = ["avahi-0.6.31-19.h1.eulerosv2r7",
        "avahi-autoipd-0.6.31-19.h1.eulerosv2r7",
        "avahi-glib-0.6.31-19.h1.eulerosv2r7",
        "avahi-gobject-0.6.31-19.h1.eulerosv2r7",
        "avahi-libs-0.6.31-19.h1.eulerosv2r7",
        "avahi-ui-gtk3-0.6.31-19.h1.eulerosv2r7"];
