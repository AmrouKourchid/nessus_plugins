...
# extracted from Red Hat Security Advisory RHSA-2020:3574. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:3574");

  script_name(english:"RHEL 7 : CloudForms 4.7.16 (RHSA-2020:3574)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2020:3574 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_3574.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?68dc3491");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#critical");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:3574");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1811145");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cfme-5.10.16.0-1.el7cf', 'cpu':'x86_64', 'release':'7', 'el_string':'el7cf', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'cfme-5.10', 'cves':['CVE-2020-14324']},
      {'reference':'cfme-appliance-5.10.16.0-1.el7cf', 'cpu':'x86_64', 'release':'7', 'el_string':'el7cf', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'cfme-5.10', 'cves':['CVE-2020-14325']},
      {'reference':'cfme-appliance-common-5.10.16.0-1.el7cf', 'cpu':'x86_64', 'release':'7', 'el_string':'el7cf', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'cfme-5.10', 'cves':['CVE-2020-14325']},
      {'reference':'cfme-appliance-tools-5.10.16.0-1.el7cf', 'cpu':'x86_64', 'release':'7', 'el_string':'el7cf', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'cfme-5.10', 'cves':['CVE-2020-14325']},
      {'reference':'cfme-gemset-5.10.16.0-1.el7cf', 'cpu':'x86_64', 'release':'7', 'el_string':'el7cf', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'cfme-5.10', 'cves':['CVE-2020-10778', 'CVE-2020-10783']}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'cfme / cfme-appliance / cfme-appliance-common / etc');
}
