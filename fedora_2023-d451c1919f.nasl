...
# extracted from Fedora Security Advisory FEDORA-2023-d451c1919f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-d451c1919f");
  script_xref(name:"IAVA", value:"2024-A-0395");

  script_name(english:"Fedora 38 : mingw-zstd (2023-d451c1919f)");
...
FEDORA-2023-d451c1919f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-d451c1919f");
  script_set_attribute(attribute:"solution", value:
"Update the affected mingw-zstd package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:mingw-zstd");
...
var pkgs = [
    {'reference':'mingw-zstd-1.5.4-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'mingw-zstd');
}
