...
# extracted from Oracle Linux Security Advisory ELSA-2023-4418.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : mod_auth_openidc:2.3 (ELSA-2023-4418)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
ELSA-2023-4418 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-4418.html");
...
var appstreams = {
    'mod_auth_openidc:2.3': [
      {'reference':'cjose-0.6.1-3.module+el8.8.0+21137+b6cedbc2', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'cjose-devel-0.6.1-3.module+el8.8.0+21137+b6cedbc2', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mod_auth_openidc-2.4.9.4-1.module+el8.7.0+20769+fca4d9d0', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'cjose-0.6.1-3.module+el8.8.0+21137+b6cedbc2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'cjose-devel-0.6.1-3.module+el8.8.0+21137+b6cedbc2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mod_auth_openidc-2.4.9.4-1.module+el8.7.0+20769+fca4d9d0', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
};
