...
referenced in the RHSA-2019:0049 advisory.
    ...
    * systemd: stack overflow when receiving many journald entries (CVE-2018-16865)
    ...
    Red Hat would like to thank Ubuntu Security Team for reporting CVE-2018-15688 and Qualys Research Labs for
    reporting CVE-2018-16864 and CVE-2018-16865. Upstream acknowledges Felix Wilhelm (Google) as the original
    reporter of CVE-2018-15688.

Tenable has extracted the preceding description block directly from the Red Hat Enterprise Linux security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_0049.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f0feb7a1");
...
"Update the RHEL systemd package based on the guidance in RHSA-2019:0049.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libgudev1-219-62.el7_6.2', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libgudev1-devel-219-62.el7_6.2', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-219-62.el7_6.2', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-devel-219-62.el7_6.2', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-journal-gateway-219-62.el7_6.2', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-libs-219-62.el7_6.2', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-networkd-219-62.el7_6.2', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-python-219-62.el7_6.2', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-resolved-219-62.el7_6.2', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-sysv-219-62.el7_6.2', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
