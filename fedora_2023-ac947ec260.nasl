...
# extracted from Fedora Security Advisory FEDORA-2023-ac947ec260
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-ac947ec260");

  script_name(english:"Fedora 38 : sysstat (2023-ac947ec260)");
...
FEDORA-2023-ac947ec260 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-ac947ec260");
...
var pkgs = [
    {'reference':'sysstat-12.7.4-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
