...
# extracted from Fedora Security Advisory FEDORA-2024-516b214c25
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-516b214c25");

  script_name(english:"Fedora 41 : linux-firmware (2024-516b214c25)");
...
FEDORA-2024-516b214c25 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-516b214c25");
...
var pkgs = [
    {'reference':'linux-firmware-20241210-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
