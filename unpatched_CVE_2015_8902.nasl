...
if (description)
{
  ...
  script_cve_id("CVE-2015-8902");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2015-8902");
...
patch available.
  ...
  - The ReadBlobByte function in coders/pdb.c in ImageMagick 6.x before 6.9.0-5 Beta allows remote attackers
    to cause a denial of service (infinite loop) via a crafted PDB file. (CVE-2015-8902)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-8902");
