...
# extracted from Oracle Linux Security Advisory ELSA-2023-6694.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : python-pip (ELSA-2023-6694)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-6694.html");
  script_set_attribute(attribute:"solution", value:
"Update the affected python3-pip and / or python3-pip-wheel packages.");
...
var pkgs = [
    {'reference':'python3-pip-21.2.3-7.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-pip-wheel-21.2.3-7.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
