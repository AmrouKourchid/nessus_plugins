...
if (description)
{
  ...
  script_cve_id("CVE-2024-29990");
  script_xref(name:"IAVA", value:"2024-A-0224");

  script_name(english:"Microsoft Azure CLI Confcom Extension < 0.3.4 Privilege Escalation");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://msrc.microsoft.com/update-guide/vulnerability/CVE-2024-29990");
...
"Upgrade to Microsoft Azure Command-Line Interface (CLI) Confcom Extension version 0.3.4 or later");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:H/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:H/PR:N/UI:N/S:C/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-29990");
