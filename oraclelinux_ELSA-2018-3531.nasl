...
# extracted from Red Hat Security Advisory RHSA-2018:3531 and 
# Oracle Linux Security Advisory ELSA-2018-3531 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : thunderbird (ELSA-2018-3531)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2018-3531.html");
...
var pkgs = [
    {'reference':'thunderbird-60.3.0-1.0.1.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
