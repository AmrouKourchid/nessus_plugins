...
# Rocky Linux Security Advisory RLSA-2024:3044.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2024:3044");

  script_name(english:"Rocky Linux 8 : idm:DL1 (RLSA-2024:3044)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Rocky Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Rocky Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
RLSA-2024:3044 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2024:3044");
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'custodia / ipa-healthcheck / ipa-healthcheck-core / opendnssec / etc');
}
