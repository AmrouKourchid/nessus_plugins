...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'gnutls-3.5.15-4.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'gnutls-debuginfo-3.5.15-4.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'gnutls-devel-3.5.15-4.ph2')) flag++;
