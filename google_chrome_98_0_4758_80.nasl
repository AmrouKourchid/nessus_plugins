...
"The version of Google Chrome installed on the remote Windows host is prior to 98.0.4758.80. It is, therefore, affected
by multiple vulnerabilities as referenced in the 2022_02_stable-channel-update-for-desktop advisory.
...
google_chrome_check_version(installs:installs, fix:'98.0.4758.80', severity:SECURITY_WARNING, xss:FALSE, xsrf:FALSE);
