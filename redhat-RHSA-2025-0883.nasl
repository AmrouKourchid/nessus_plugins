...
# extracted from Red Hat Security Advisory RHSA-2025:0883. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:0883");

  script_name(english:"RHEL 8 : python-jinja2 (RHSA-2025:0883)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_0883.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?021e2982");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:0883");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-jinja2 package based on the guidance in RHSA-2025:0883.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-jinja2-2.10.1-4.el8_8.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
