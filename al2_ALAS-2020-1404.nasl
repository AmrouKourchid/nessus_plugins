...
# extracted from Amazon Linux 2 Security Advisory ALAS-2020-1404.
#
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : sudo (ALAS-2020-1404)");
...
referenced in the ALAS2-2020-1404 advisory.
    ...
    administrator.) The attacker needs to deliver a long string to the stdin of getln() in
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2020-1404.html");
...
var pkgs = [
    {'reference':'sudo-1.8.23-4.amzn2.2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sudo-1.8.23-4.amzn2.2', 'cpu':'i686', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sudo-1.8.23-4.amzn2.2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sudo-debuginfo-1.8.23-4.amzn2.2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sudo-debuginfo-1.8.23-4.amzn2.2', 'cpu':'i686', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sudo-debuginfo-1.8.23-4.amzn2.2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sudo-devel-1.8.23-4.amzn2.2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sudo-devel-1.8.23-4.amzn2.2', 'cpu':'i686', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sudo-devel-1.8.23-4.amzn2.2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
