...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.1 : shim (EulerOS-SA-2023-3050)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3050
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5e470d38");
...
var pkgs = [
  "shim-15.4-2.h20.eulerosv2r11",
  "shim-aa64-storage-15.4-2.h20.eulerosv2r11"
];
