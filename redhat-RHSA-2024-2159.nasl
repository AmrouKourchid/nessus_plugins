...
# extracted from Red Hat Security Advisory RHSA-2024:2159. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2159");

  script_name(english:"RHEL 9 : python3.11-urllib3 (RHSA-2024:2159)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2159.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f19993aa");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2159");
...
"Update the RHEL python3.11-urllib3 package based on the guidance in RHSA-2024:2159.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3.11-urllib3-1.26.12-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
