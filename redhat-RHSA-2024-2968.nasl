...
# extracted from Red Hat Security Advisory RHSA-2024:2968. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2968.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5ce56776");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-14343");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-5397");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2968");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL fence-agents package based on the guidance in RHSA-2024:2968.");
...
var constraints = [
  {
    ...
    'pkgs': [
      ...
      {'reference':'fence-agents-all-4.2.1-129.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'fence-agents-kdump-4.2.1-129.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fence-agents-kubevirt-4.2.1-129.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'fence-agents-openstack-4.2.1-129.el8', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fence-agents-openstack-4.2.1-129.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fence-agents-redfish-4.2.1-129.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'fence-agents-zvm-4.2.1-129.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
