...
# extracted from Red Hat Security Advisory RHSA-2023:7513. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:7513");

  script_name(english:"RHEL 7 : linux-firmware (RHSA-2023:7513)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2023:7513 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2023-20569");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2023-20593");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:7513");
...
// Check if its not AMD / ZEN 2
if ('amd' >!< cpu && 'Zen 2' >!< cpu) audit(AUDIT_LOCAL_CHECKS_NOT_IMPLEMENTED, 'Red Hat', cpu);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'iwl100-firmware-39.31.5.1-81.el7_9', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'iwl1000-firmware-39.31.5.1-81.el7_9', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'iwl105-firmware-18.168.6.1-81.el7_9', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'iwl135-firmware-18.168.6.1-81.el7_9', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'iwl2000-firmware-18.168.6.1-81.el7_9', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'iwl2030-firmware-18.168.6.1-81.el7_9', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'iwl3160-firmware-25.30.13.0-81.el7_9', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'iwl3945-firmware-15.32.2.9-81.el7_9', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'iwl4965-firmware-228.61.2.24-81.el7_9', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'iwl5000-firmware-8.83.5.1_1-81.el7_9', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'iwl5150-firmware-8.24.2.2-81.el7_9', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'iwl6000-firmware-9.221.4.1-81.el7_9', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'iwl6000g2a-firmware-18.168.6.1-81.el7_9', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'iwl6000g2b-firmware-18.168.6.1-81.el7_9', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'iwl6050-firmware-41.28.5.1-81.el7_9', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'iwl7260-firmware-25.30.13.0-81.el7_9', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'linux-firmware-20200421-81.git78c0348.el7_9', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
