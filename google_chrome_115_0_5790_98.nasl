...
"The version of Google Chrome installed on the remote Windows host is prior to 115.0.5790.98. It is, therefore, affected
by multiple vulnerabilities as referenced in the 2023_07_stable-channel-update-for-desktop advisory.
...
google_chrome_check_version(installs:installs, fix:'115.0.5790.98', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
