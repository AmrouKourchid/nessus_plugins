...
if (description)
{
  ...
  script_cve_id("CVE-2024-39810");
  script_xref(name:"IAVA", value:"2024-A-0677-S");

  script_name(english:"Mattermost Server 9.5.x < 9.5.8 / 9.10.x < 9.10.1 (MMSA-2024-00359)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of Mattermost Server installed on the remote host is prior to 9.5.8 or 9.10.1. It is, therefore, affected by
a vulnerability as referenced in the MMSA-2024-00359 advisory.

  - Mattermost versions 9.5.x <= 9.5.7 and 9.10.x <= 9.10.0 fail to time limit and size limit the CA path file
    in the ElasticSearch configuration which allows a System Role with access to the Elasticsearch system
    console to add any file as a CA path field, such as /dev/zero and, after testing the connection, cause the
    application to crash. (CVE-2024-39810)
...
"Upgrade to Mattermost Server version 9.5.8 / 9.10.1 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-39810");
