...
# extracted from Fedora Security Advisory FEDORA-2024-e60359f212
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-e60359f212");

  script_name(english:"Fedora 39 : chromium (2024-e60359f212)");
...
FEDORA-2024-e60359f212 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-e60359f212");
...
"Update the affected chromium package.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2024-7024");
...
var pkgs = [
    {'reference':'chromium-129.0.6668.70-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
