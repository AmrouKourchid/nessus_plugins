...
# extracted from Fedora Security Advisory FEDORA-2024-01607ac0ae
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-01607ac0ae");
  script_xref(name:"IAVA", value:"2024-A-0020-S");

  script_name(english:"Fedora 39 : chromium (2024-01607ac0ae)");
...
FEDORA-2024-01607ac0ae advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-01607ac0ae");
...
var pkgs = [
    {'reference':'chromium-120.0.6099.216-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
