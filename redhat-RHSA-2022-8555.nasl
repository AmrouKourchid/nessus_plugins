...
# extracted from Red Hat Security Advisory RHSA-2022:8555. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:8555");
  script_xref(name:"IAVA", value:"2022-A-0492-S");

  script_name(english:"RHEL 7 : thunderbird (RHSA-2022:8555)");
...
referenced in the RHSA-2022:8555 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8555.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a960f5e3");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8555");
...
"Update the RHEL thunderbird package based on the guidance in RHSA-2022:8555.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'thunderbird-102.5.0-2.el7_9', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'thunderbird-102.5.0-2.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
