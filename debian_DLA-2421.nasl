...
# extracted from Debian Security Advisory DLA-2421-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2421-1 : cimg security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2020/10/msg00033.html");
...
"Upgrade the affected cimg-dev, cimg-doc, and cimg-examples packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-1010174");
...
flag = 0;
if (deb_check(release:"9.0", prefix:"cimg-dev", reference:"1.7.9+dfsg-1+deb9u1")) flag++;
if (deb_check(release:"9.0", prefix:"cimg-doc", reference:"1.7.9+dfsg-1+deb9u1")) flag++;
if (deb_check(release:"9.0", prefix:"cimg-examples", reference:"1.7.9+dfsg-1+deb9u1")) flag++;
