...
# extracted from Red Hat Security Advisory RHSA-2020:4172. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2020-10713", "CVE-2020-14364");
  script_xref(name:"IAVA", value:"2020-A-0349");
  script_xref(name:"RHSA", value:"2020:4172");
  script_xref(name:"IAVB", value:"2020-B-0063-S");
  script_xref(name:"CEA-ID", value:"CEA-2020-0061");

  script_name(english:"RHEL 8 : Red Hat Virtualization (RHSA-2020:4172)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has a package installed that is affected by multiple vulnerabilities as
referenced in the RHSA-2020:4172 advisory.
    ...
    The following packages have been upgraded to a later upstream version: cockpit-ovirt (0.14.11), imgbased
    (1.2.12), redhat-release-virtualization-host (4.4.2), redhat-virtualization-host (4.4.2). (BZ#1875362,
    BZ#1878045)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_4172.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f2c1c516");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:4172");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1805589");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1825243");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1847547");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1852721");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1859876");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1868312");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1869201");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1873049");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1875362");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'redhat-virtualization-host-image-update-4.4.2-20200930.0.el8_2', 'release':'8', 'el_string':'el8_2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'}
    ]
  }
];
