...
# extracted from Red Hat Security Advisory RHSA-2018:0034. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:0034");
  script_xref(name:"IAVA", value:"2018-A-0020");
  script_xref(name:"IAVA", value:"2018-A-0017-S");

  script_name(english:"RHEL 7 : microcode_ctl (RHSA-2018:0034) (Spectre)");
...
issue.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:0034");
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", sp:"3", cpu:"x86_64", reference:"microcode_ctl-2.1-16.4.el7_3")) flag++;
  if (rpm_check(release:"RHEL7", sp:"3", cpu:"x86_64", reference:"microcode_ctl-debuginfo-2.1-16.4.el7_3")) flag++;
