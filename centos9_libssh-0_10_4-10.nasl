...
if (description)
{
  ...
  script_name(english:"CentOS 9 : libssh-0.10.4-10.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing one or more security updates for libssh.");
...
libssh-0.10.4-10.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=33066");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream libssh package.");
...
var pkgs = [
    {'reference':'libssh-0.10.4-10.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libssh-config-0.10.4-10.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libssh-devel-0.10.4-10.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
