...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : python-dns (EulerOS-SA-2025-1043)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1043
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c90fafd8");
...
var pkgs = [
  "python3-dns-1.15.0-10.h2.eulerosv2r9"
];
