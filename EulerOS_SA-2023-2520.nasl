...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.1 : shim (EulerOS-SA-2023-2520)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2520
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?12a70bbb");
...
var pkgs = [
  "shim-15-19.h13.eulerosv2r9",
  "shim-aa64-storage-15-19.h13.eulerosv2r9"
];
