...
# extracted from Fedora Security Advisory FEDORA-2024-b60f51180f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-b60f51180f");

  script_name(english:"Fedora 39 : chromium (2024-b60f51180f)");
...
FEDORA-2024-b60f51180f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-b60f51180f");
...
var pkgs = [
    {'reference':'chromium-127.0.6533.99-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
