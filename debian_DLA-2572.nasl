...
# extracted from Debian Security Advisory DLA-2572-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2572-1 : wpa security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"An issue has been found in wpa, a set of tools to support WPA and WPA2
(IEEE 802.11i). Missing validation of data can result in a buffer
over-write, which might lead to a DoS of the wpa_supplicant process or
potentially arbitrary code execution.

On request, together with this upload support for
WPA-EAP-SUITE-B(-192) has been enabled.
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2021/02/msg00033.html");
...
flag = 0;
if (deb_check(release:"9.0", prefix:"hostapd", reference:"2:2.4-1+deb9u8")) flag++;
if (deb_check(release:"9.0", prefix:"wpagui", reference:"2:2.4-1+deb9u8")) flag++;
if (deb_check(release:"9.0", prefix:"wpasupplicant", reference:"2:2.4-1+deb9u8")) flag++;
if (deb_check(release:"9.0", prefix:"wpasupplicant-udeb", reference:"2:2.4-1+deb9u8")) flag++;
