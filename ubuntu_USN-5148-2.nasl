...
# extracted from Ubuntu Security Notice USN-5148-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5148-2");

  script_name(english:"Ubuntu 16.04 ESM : hivex vulnerability (USN-5148-2)");
...
USN-5148-2 advisory.
    ...
    USN-5148-1 fixed a vulnerability in hivex. This update provides the corresponding update for Ubuntu 14.04
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5148-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libhivex-bin', 'pkgver': '1.3.13-1ubuntu0.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libhivex-dev', 'pkgver': '1.3.13-1ubuntu0.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libhivex-ocaml', 'pkgver': '1.3.13-1ubuntu0.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libhivex-ocaml-dev', 'pkgver': '1.3.13-1ubuntu0.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libhivex0', 'pkgver': '1.3.13-1ubuntu0.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libwin-hivex-perl', 'pkgver': '1.3.13-1ubuntu0.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'python-hivex', 'pkgver': '1.3.13-1ubuntu0.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'python3-hivex', 'pkgver': '1.3.13-1ubuntu0.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'ruby-hivex', 'pkgver': '1.3.13-1ubuntu0.1~esm1', 'ubuntu_pro': TRUE}
];
