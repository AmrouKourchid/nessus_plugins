...
# extracted from Fedora Security Advisory FEDORA-2019-155e34df5a.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-155e34df5a");

  script_name(english:"Fedora 29 : pango (2019-155e34df5a)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-155e34df5a");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"pango-1.42.4-3.fc29")) flag++;
