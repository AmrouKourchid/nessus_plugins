...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2023-A-0095-S");

  script_name(english:"Adobe InDesign < 17.4.1 / 18.0 < 18.2.0 Application denial-of-service (APSB23-12)");
...
"The version of Adobe InDesign installed on the remote Windows host is prior to 17.4.1, 18.2.0. It is, therefore,
affected by a vulnerability as referenced in the APSB23-12 advisory.

  - Adobe InDesign versions ID18.1 (and earlier) and ID17.4 (and earlier) are affected by a NULL Pointer
    ...
    interaction in that a victim must open a malicious file. (CVE-2023-21593)
...
var constraints = [
  { 'max_version' : '17.4.0', 'fixed_version' : '17.4.1', 'fixed_display' : 'ID17.4.1' },
  { 'min_version' : '18.0', 'max_version' : '18.1', 'fixed_version' : '18.2.0', 'fixed_display' : 'ID18.2' }
];
