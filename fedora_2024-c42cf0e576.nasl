...
# extracted from Fedora Security Advisory FEDORA-2024-c42cf0e576
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-c42cf0e576");
  script_xref(name:"IAVB", value:"2024-B-0008-S");

  script_name(english:"Fedora 38 : clamav (2024-c42cf0e576)");
...
FEDORA-2024-c42cf0e576 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-c42cf0e576");
...
var pkgs = [
    {'reference':'clamav-1.0.5-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
