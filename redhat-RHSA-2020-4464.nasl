...
# extracted from Red Hat Security Advisory RHSA-2020:4464. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:4464");

  script_name(english:"RHEL 8 : libxslt (RHSA-2020:4464)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for libxslt.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2020:4464 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_4464.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ed6647a1");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:4464");
...
"Update the RHEL libxslt package based on the guidance in RHSA-2020:4464.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libxslt-1.1.32-5.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libxslt-devel-1.1.32-5.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
