...
if (description)
{
  ...
  script_cve_id("CVE-2024-39821");
  script_xref(name:"IAVA", value:"2024-A-0436-S");

  script_name(english:"Zoom Workplace Desktop App For Windows < 6.0.10 RACE condition (ZSB-24028)");
...
affected by a privilage escalation vulnerability that may allow a local authenticated attacker to cause a denial of 
service via local access.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.zoom.com/en/trust/security-bulletin/ZSB-24028/");
...
"Upgrade to Zoom Workplace Desktop App 6.0.10 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-39821");
