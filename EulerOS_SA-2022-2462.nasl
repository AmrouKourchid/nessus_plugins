...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : golang (EulerOS-SA-2022-2462)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2462
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9ccfdc6f");
...
var pkgs = [
  "golang-1.11.2-17.h19.eulerosv2r8",
  "golang-bin-1.11.2-17.h19.eulerosv2r8",
  "golang-src-1.11.2-17.h19.eulerosv2r8"
];
