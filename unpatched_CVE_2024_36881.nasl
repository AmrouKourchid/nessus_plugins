...
if (description)
{
  ...
  script_cve_id("CVE-2024-36881");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-36881");
...
"There is no known solution at this time.");
  ...
  script_set_cvss_base_vector("CVSS2#AV:L/AC:H/Au:S/C:P/I:N/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:L/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-36881");
