...
Fixed :
  ...
  - Attachments: do not provide anymore attachments content
    in XML by default, fixes");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1173630");
  script_set_attribute(attribute:"see_also", value:"https://mediaarea.net/AudioChannelLayout");
  script_set_attribute(attribute:"solution", value:
"Update the affected libmediainfo / mediainfo packages.");
