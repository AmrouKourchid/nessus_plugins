...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.3 : qemu-kvm (EulerOS-SA-2019-1368)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1368
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f34e68af");
...
pkgs = ["qemu-gpu-specs-2.8.1-25.215",
        "qemu-guest-agent-2.8.1-25.215",
        "qemu-img-2.8.1-25.215",
        "qemu-kvm-2.8.1-25.215",
        "qemu-kvm-common-2.8.1-25.215",
        "qemu-kvm-tools-2.8.1-25.215",
        "qemu-seabios-2.8.1-25.215"];
