...
# extracted from Red Hat Security Advisory RHSA-2023:2378. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:2378");

  script_name(english:"RHEL 9 : postgresql-jdbc (RHSA-2023:2378)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_2378.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d6b04550");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:2378");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL postgresql-jdbc package based on the guidance in RHSA-2023:2378.");
