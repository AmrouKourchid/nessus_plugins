...
# extracted from Red Hat Security Advisory RHSA-2022:8418. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:8418");

  script_name(english:"RHEL 9 : mingw-glib2 (RHSA-2022:8418)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for mingw-glib2.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8418.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?08924d52");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/9/html/9.1_release_notes/index
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1f1eb6cc");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8418");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1938291");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2116278");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL mingw-glib2 package based on the guidance in RHSA-2022:8418.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'mingw32-glib2-2.70.1-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mingw32-glib2-static-2.70.1-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mingw64-glib2-2.70.1-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mingw64-glib2-static-2.70.1-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
