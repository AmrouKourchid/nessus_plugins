...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : postgresql-jdbc (EulerOS-SA-2022-1946)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1946
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5f400d44");
...
var pkgs = [
  "postgresql-jdbc-42.2.4-1.h4.eulerosv2r8"
];
