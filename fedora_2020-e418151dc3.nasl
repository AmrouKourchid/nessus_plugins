...
# extracted from Fedora Security Advisory FEDORA-2020-e418151dc3.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : 1:java-1.8.0-openjdk (2020-e418151dc3)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-e418151dc3");
  script_set_attribute(attribute:"see_also", value:"https://bugs.openjdk.java.net/browse/JDK-8205622");
  script_set_attribute(attribute:"see_also", value:"https://bugs.openjdk.java.net/browse/JDK-8223147");
  script_set_attribute(attribute:"see_also", value:"https://bugs.openjdk.java.net/browse/JDK-8240191");
  script_set_attribute(attribute:"see_also", value:"https://bugs.openjdk.java.net/browse/JDK-8240687");
  script_set_attribute(attribute:"see_also", value:"https://bugs.openjdk.java.net/browse/JDK-8244166");
  script_set_attribute(attribute:"see_also", value:"https://bugs.openjdk.java.net/browse/JDK-8244167");
  script_set_attribute(attribute:"see_also", value:"https://openjdk.java.net/jeps/328");
...
flag = 0;
if (rpm_check(release:"FC32", reference:"java-1.8.0-openjdk-1.8.0.262.b10-1.fc32", epoch:"1")) flag++;
