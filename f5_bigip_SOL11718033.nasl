...
# extracted from F5 Networks BIG-IP Solution K11718033.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2018-5504");

  script_name(english:"F5 Networks BIG-IP : TMM WebSocket vulnerability (K11718033)");
...
This vulnerability allowsunauthorized remote code execution and
disruption of service through an unspecified crafted WebSocket packet.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K11718033");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K11718033.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:H/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-5504");
