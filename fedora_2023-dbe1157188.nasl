...
# extracted from Fedora Security Advisory FEDORA-2023-dbe1157188
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-dbe1157188");

  script_name(english:"Fedora 37 : nautilus (2023-dbe1157188)");
...
FEDORA-2023-dbe1157188 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-dbe1157188");
...
"Update the affected nautilus package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:nautilus");
...
var pkgs = [
    {'reference':'nautilus-43.2-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
