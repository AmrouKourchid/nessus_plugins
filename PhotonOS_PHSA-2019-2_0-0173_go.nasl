...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Go PHSA-2019-2.0-0173");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'go-1.9.4-6.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'go-debuginfo-1.9.4-6.ph2')) flag++;
