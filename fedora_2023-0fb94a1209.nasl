...
# extracted from Fedora Security Advisory FEDORA-2023-0fb94a1209
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-0fb94a1209");

  script_name(english:"Fedora 38 : rdiff-backup (2023-0fb94a1209)");
...
FEDORA-2023-0fb94a1209 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-0fb94a1209");
...
var pkgs = [
    {'reference':'rdiff-backup-2.2.6-3.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
