...
# extracted from Fedora Security Advisory FEDORA-2024-28ea86c8aa
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-28ea86c8aa");

  script_name(english:"Fedora 41 : microcode_ctl (2024-28ea86c8aa)");
...
FEDORA-2024-28ea86c8aa advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-28ea86c8aa");
...
var pkgs = [
    {'reference':'microcode_ctl-2.1-67.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
