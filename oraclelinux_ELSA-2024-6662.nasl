...
# extracted from Oracle Linux Security Advisory ELSA-2024-6662.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : python-setuptools (ELSA-2024-6662)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-6662.html");
...
"Update the affected python-setuptools package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:python-setuptools");
...
var pkgs = [
    {'reference':'python-setuptools-0.9.8-7.0.1.el7', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
];
