...
if (description)
{
  ...
  script_cve_id("CVE-2023-34058");
  script_xref(name:"VMSA", value:"2023-0024");
  script_xref(name:"IAVA", value:"2023-A-0590-S");

  script_name(english:"VMware Tools 10.3.x / 11.x / 12.x < 12.3.5 Token Bypass (VMSA-2023-0024)");
...
"The version of VMware Tools installed on the remote Windows host is 10.3.x, 11.x or 12.x prior to 12.3.5. It is,
...
var constraints = [{ 'min_version' : '10.3', 'fixed_version' : '12.3.5' }];
