...
# extracted from Red Hat Security Advisory RHSA-2020:0214. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:0214");
  script_xref(name:"IAVA", value:"2020-A-0036-S");

  script_name(english:"RHEL 6 : chromium-browser (RHSA-2020:0214)");
...
referenced in the RHSA-2020:0214 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_0214.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?898f13c6");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:0214");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1793514");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1793529");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1793537");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL chromium-browser package based on the guidance in RHSA-2020:0214.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'chromium-browser-79.0.3945.130-1.el6_10', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'chromium-browser-79.0.3945.130-1.el6_10', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
