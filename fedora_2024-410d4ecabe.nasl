...
# extracted from Fedora Security Advisory FEDORA-2024-410d4ecabe
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-410d4ecabe");

  script_name(english:"Fedora 38 : uriparser (2024-410d4ecabe)");
...
FEDORA-2024-410d4ecabe advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-410d4ecabe");
...
var pkgs = [
    {'reference':'uriparser-0.9.8-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
