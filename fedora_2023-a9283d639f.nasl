...
# extracted from Fedora Security Advisory FEDORA-2023-a9283d639f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-a9283d639f");

  script_name(english:"Fedora 37 : community-mysql (2023-a9283d639f)");
...
FEDORA-2023-a9283d639f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-a9283d639f");
...
var pkgs = [
    {'reference':'community-mysql-8.0.34-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
