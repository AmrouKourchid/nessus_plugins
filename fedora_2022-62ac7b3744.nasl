...
# extracted from Fedora Security Advisory FEDORA-2022-62ac7b3744
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-62ac7b3744");

  script_name(english:"Fedora 35 : gnutls (2022-62ac7b3744)");
...
FEDORA-2022-62ac7b3744 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-62ac7b3744");
...
var pkgs = [
    {'reference':'gnutls-3.7.2-3.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
