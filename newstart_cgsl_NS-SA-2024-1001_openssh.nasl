...
# extracted from ZTE advisory NS-SA-2024-1001. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.04 / MAIN 5.04 : openssh Vulnerability (NS-SA-2024-1001)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/notice/NS-SA-2024-1001");
...
var pkgs = {
  'CGSL CORE 5.04': [
    'openssh-8.5p1-2.el7.cgslv5.1.24.gc95680d',
    'openssh-askpass-8.5p1-2.el7.cgslv5.1.24.gc95680d',
    'openssh-clients-8.5p1-2.el7.cgslv5.1.24.gc95680d',
    'openssh-server-8.5p1-2.el7.cgslv5.1.24.gc95680d'
  ],
  'CGSL MAIN 5.04': [
    'openssh-8.5p1-2.el7.cgslv5.1.24.gc95680d',
    'openssh-askpass-8.5p1-2.el7.cgslv5.1.24.gc95680d',
