...
# extracted from Red Hat Security Advisory gnupg. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2018-9234", "CVE-2019-13050", "CVE-2022-3219");

  script_name(english:"RHEL 6 : gnupg (Unpatched Vulnerability) (deprecated)");
