...
# extracted from Gentoo Linux Security Advisory GLSA 202007-17.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202007-17");

  script_name(english:"GLSA-202007-17 : JHead: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202007-17
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202007-17");
...
"All JHead users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-19035");
...
if (qpkg_check(package:"media-gfx/jhead", unaffected:make_list("ge 3.04"), vulnerable:make_list("lt 3.04"))) flag++;
