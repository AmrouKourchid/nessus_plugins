...
referenced in the USN-4143-1 advisory.

    It was discovered that SDL 2.0 mishandled crafted image files resulting in an integer overflow. If a user
    were tricked into opening a malicious file, SDL 2.0 could be caused to crash or potentially run arbitrary
    code. (CVE-2017-2888)
    ...
    potentially run arbitrary code. (CVE-2019-7635, CVE-2019-7636, CVE-2019-7637, CVE-2019-7638)
