...
# extracted from Oracle Linux Security Advisory ELSA-2022-8126.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : ignition (ELSA-2022-8126)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2022-8126.html");
...
"Update the affected ignition package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:ignition");
