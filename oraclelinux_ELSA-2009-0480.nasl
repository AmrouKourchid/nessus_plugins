...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2009-0480.html");
...
"Update the affected poppler, poppler-devel and / or poppler-utils packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2009-3606");
...
var pkgs = [
    {'reference':'poppler-0.5.4-4.4.el5_3.9', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'poppler-devel-0.5.4-4.4.el5_3.9', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'poppler-utils-0.5.4-4.4.el5_3.9', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'poppler-0.5.4-4.4.el5_3.9', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'poppler-devel-0.5.4-4.4.el5_3.9', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'poppler-utils-0.5.4-4.4.el5_3.9', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
