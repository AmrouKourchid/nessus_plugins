...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : libtiff (EulerOS-SA-2022-1175)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1175
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2defaa71");
...
var pkgs = [
  "libtiff-4.0.3-27.h26",
  "libtiff-devel-4.0.3-27.h26"
];
