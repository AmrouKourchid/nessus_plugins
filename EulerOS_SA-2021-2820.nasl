...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.0 : glibc (EulerOS-SA-2021-2820)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2820
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4885c53b");
...
var pkgs = [
  "glibc-2.28-9.h65",
  "glibc-all-langpacks-2.28-9.h65",
  "glibc-common-2.28-9.h65",
  "glibc-devel-2.28-9.h65",
  "glibc-headers-2.28-9.h65",
  "libnsl-2.28-9.h65",
  "nscd-2.28-9.h65"
];
