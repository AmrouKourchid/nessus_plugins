...
# extracted from Red Hat Security Advisory RHSA-2021:1627. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:1627");

  script_name(english:"RHEL 8 : trousers (RHSA-2021:1627)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2021:1627 advisory.

    TrouSerS is an implementation of the Trusted Computing Group's Software Stack (TSS) specification.
    TrouSerS enables the user to write applications that make use of the Trusted Platform Module (TPM)
    hardware.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_1627.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5d0f1f2f");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/8.4_release_notes/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?862005a9");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:1627");
...
"Update the affected trousers, trousers-devel and / or trousers-lib packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:trousers-lib");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'trousers-0.3.15-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'trousers-devel-0.3.15-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'trousers-lib-0.3.15-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
