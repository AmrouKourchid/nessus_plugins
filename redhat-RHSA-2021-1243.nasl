...
# extracted from Red Hat Security Advisory RHSA-2021:1243. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:1243");

  script_name(english:"RHEL 8 : redhat-ds:11 (RHSA-2021:1243)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for redhat-ds:11.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2021:1243 advisory.
    ...
    * Searches by an unauthorized client can no longer determine if an entry exists or not by the result code
    (BZ#1925537)
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1751082");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1859215");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1859288");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1905565");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1925537");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1927051");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1930272");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1937036");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_1243.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a0d0cba9");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:1243");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL redhat-ds:11 package based on the guidance in RHSA-2021:1243.");
  ...
  'redhat-ds:11': [
    {
      ...
      'pkgs': [
        {'reference':'389-ds-base-1.4.3.21-3.module+el8dsrv+10401+3d549418', 'cpu':'x86_64', 'release':'8', 'el_string':'el8dsrv', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'389-ds-base-devel-1.4.3.21-3.module+el8dsrv+10401+3d549418', 'cpu':'x86_64', 'release':'8', 'el_string':'el8dsrv', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'389-ds-base-legacy-tools-1.4.3.21-3.module+el8dsrv+10401+3d549418', 'cpu':'x86_64', 'release':'8', 'el_string':'el8dsrv', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'389-ds-base-libs-1.4.3.21-3.module+el8dsrv+10401+3d549418', 'cpu':'x86_64', 'release':'8', 'el_string':'el8dsrv', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'389-ds-base-snmp-1.4.3.21-3.module+el8dsrv+10401+3d549418', 'cpu':'x86_64', 'release':'8', 'el_string':'el8dsrv', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'cockpit-389-ds-1.4.3.21-3.module+el8dsrv+10401+3d549418', 'release':'8', 'el_string':'el8dsrv', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
        {'reference':'python3-lib389-1.4.3.21-3.module+el8dsrv+10401+3d549418', 'release':'8', 'el_string':'el8dsrv', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
