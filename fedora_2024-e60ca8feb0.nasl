...
# extracted from Fedora Security Advisory FEDORA-2024-e60ca8feb0
#
...
if (description)
{
  ...
  script_cve_id("CVE-2024-31949", "CVE-2024-31950", "CVE-2024-31951");
  script_xref(name:"FEDORA", value:"2024-e60ca8feb0");

  script_name(english:"Fedora 40 : frr (2024-e60ca8feb0)");
...
FEDORA-2024-e60ca8feb0 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-e60ca8feb0");
...
var pkgs = [
    {'reference':'frr-9.1.1-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
