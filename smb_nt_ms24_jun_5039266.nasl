...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5039245");
  script_xref(name:"MSKB", value:"5039266");
  script_xref(name:"MSFT", value:"MS24-5039245");
  script_xref(name:"MSFT", value:"MS24-5039266");
  ...
  script_name(english:"KB5039266: Windows Server 2008 Security Update (June 2024)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5039266. It is, therefore, affected by multiple vulnerabilities

  - Microsoft Message Queuing (MSMQ) Remote Code Execution Vulnerability (CVE-2024-30080)

  - Windows Link Layer Topology Discovery Protocol Remote Code Execution Vulnerability (CVE-2024-30074,
    CVE-2024-30075)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5039245");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5039266");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5039266 or Cumulative Update 5039245");
...
if (
  smb_check_rollup(os:'6.0',
                   ...
                   rollup_date:'06_2024',
                   bulletin:bulletin,
                   rollup_kb_list:[5039266, 5039245])
)
{
