...
# AlmaLinux Security Advisory ALSA-2024:1142.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:1142");

  script_name(english:"AlmaLinux 9 : haproxy (ALSA-2024:1142)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2024-1142.html");
...
var pkgs = [
    {'reference':'haproxy-2.4.22-3.el9_3', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'haproxy-2.4.22-3.el9_3', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
