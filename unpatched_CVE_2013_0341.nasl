...
if (description)
{
  ...
  script_cve_id("CVE-2013-0341");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2013-0341 (deprecated)");
...
"Plugin has been deprecated due to the specified CVE being rejected by NVD.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-0341");
