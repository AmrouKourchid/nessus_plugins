...
# extracted from Gentoo Linux Security Advisory GLSA 201904-01.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201904-01");

  script_name(english:"GLSA-201904-01 : Cairo: Denial of service");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-201904-01
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/201904-01");
...
if (qpkg_check(package:"x11-libs/cairo", unaffected:make_list("ge 1.16.0-r3"), vulnerable:make_list("lt 1.16.0-r3"))) flag++;
