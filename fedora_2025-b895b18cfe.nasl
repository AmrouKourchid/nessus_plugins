...
# extracted from Fedora Security Advisory FEDORA-2025-b895b18cfe
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-b895b18cfe");

  script_name(english:"Fedora 41 : fastd (2025-b895b18cfe)");
...
FEDORA-2025-b895b18cfe advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-b895b18cfe");
...
var pkgs = [
    {'reference':'fastd-23-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
