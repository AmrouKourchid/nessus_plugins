...
# SUSE update advisory SUSE-SU-2023:1948-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:1948-1");

  script_name(english:"openSUSE 15 Security Update : jettison (SUSE-SU-2023:1948-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1209605");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2023-1436");
  # https://lists.suse.com/pipermail/sle-security-updates/2023-April/014547.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?68a2e7ba");
  script_set_attribute(attribute:"solution", value:
"Update the affected jettison and / or jettison-javadoc packages.");
...
var pkgs = [
    {'reference':'jettison-1.5.4-150200.3.7.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.4']},
    {'reference':'jettison-javadoc-1.5.4-150200.3.7.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.4']}
];
