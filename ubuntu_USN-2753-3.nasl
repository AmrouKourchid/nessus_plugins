...
USN-2753-3 advisory.
    ...
    from starting. This regression only affected containers that had a path that contained a '/./' directory
    specified as a bind mount target in their configuration file. This update fixes the problem. We apologize
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2753-3");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'liblxc1', 'pkgver': '1.0.7-0ubuntu0.7'},
    {'osver': '14.04', 'pkgname': 'lxc', 'pkgver': '1.0.7-0ubuntu0.7'},
    {'osver': '14.04', 'pkgname': 'lxc-dev', 'pkgver': '1.0.7-0ubuntu0.7'},
    {'osver': '14.04', 'pkgname': 'lxc-templates', 'pkgver': '1.0.7-0ubuntu0.7'},
    {'osver': '14.04', 'pkgname': 'lxc-tests', 'pkgver': '1.0.7-0ubuntu0.7'},
    {'osver': '14.04', 'pkgname': 'python3-lxc', 'pkgver': '1.0.7-0ubuntu0.7'}
];
