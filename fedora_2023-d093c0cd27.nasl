...
# extracted from Fedora Security Advisory FEDORA-2023-d093c0cd27
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-d093c0cd27");
  script_xref(name:"IAVA", value:"2023-A-0166-S");

  script_name(english:"Fedora 37 : thunderbird (2023-d093c0cd27)");
...
FEDORA-2023-d093c0cd27 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-d093c0cd27");
...
var pkgs = [
    {'reference':'thunderbird-102.9.1-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
