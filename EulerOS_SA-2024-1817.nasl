...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : libyaml (EulerOS-SA-2024-1817)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the libyaml package installed, the EulerOS installation on the remote host is affected by
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1817
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?09e6b330");
...
var pkgs = [
  "libyaml-0.2.5-2.h2.eulerosv2r11"
];
