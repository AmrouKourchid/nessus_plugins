...
if (description)
{
  ...
  script_name(english:"Oracle Siebel Server <= 22.12 (July 2024 CPU)");
...
2024 CPU advisory.
  ...
  - Vulnerability in the Siebel CRM Deployment product of Oracle Siebel CRM (component: Server Infrastructure
    (Apache Xalan-Java)). Supported versions that are affected are 22.12 and prior. Easily exploitable
    vulnerability allows unauthenticated attacker with network access via HTTP to compromise Siebel CRM
    Deployment. Successful attacks of this vulnerability can result in unauthorized creation, deletion or
    modification access to critical data or all Siebel CRM Deployment accessible data. (CVE-2022-34169)
...
var constraints = [
  { 'max_version' : '22.12.999', 'fixed_version' : '24.7' }
];
