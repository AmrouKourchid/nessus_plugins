...
# extracted from Red Hat Security Advisory RHSA-2022:4786. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:4786");

  script_name(english:"RHEL 8 : openvswitch2.13 (RHSA-2022:4786)");
...
referenced in the RHSA-2022:4786 advisory.
    ...
    * openvswitch2.13: DPDK: Out-of-bounds read/write in vhost_user_set_inflight_fd() may lead to crash
    (CVE-2021-3839)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_4786.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1d0f56dd");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:4786");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2080270");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL openvswitch2.13 package based on the guidance in RHSA-2022:4786.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openvswitch2.13-2.13.0-180.el8fdp', 'release':'8', 'el_string':'el8fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openvswitch'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'openvswitch2.13');
}
