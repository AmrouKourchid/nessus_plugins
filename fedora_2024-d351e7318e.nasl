...
# extracted from Fedora Security Advisory FEDORA-2024-d351e7318e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-d351e7318e");

  script_name(english:"Fedora 38 : c-ares (2024-d351e7318e)");
...
FEDORA-2024-d351e7318e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-d351e7318e");
...
var pkgs = [
    {'reference':'c-ares-1.28.1-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
