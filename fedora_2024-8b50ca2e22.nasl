...
# extracted from Fedora Security Advisory FEDORA-2024-8b50ca2e22
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-8b50ca2e22");

  script_name(english:"Fedora 40 : chromium (2024-8b50ca2e22)");
...
FEDORA-2024-8b50ca2e22 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-8b50ca2e22");
...
var pkgs = [
    {'reference':'chromium-124.0.6367.60-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
