...
# extracted from Fedora Security Advisory FEDORA-2024-38c2261ca0
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-38c2261ca0");

  script_name(english:"Fedora 38 : w3m (2024-38c2261ca0)");
...
FEDORA-2024-38c2261ca0 advisory.

    - Added upstream patch to fix out-of-bounds access due to multiple backspaces to address incomplete fix
    for CVE-2022-38223 (#2222775, #2222780, #2255207)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-38c2261ca0");
...
var pkgs = [
    {'reference':'w3m-0.5.3-63.git20230121.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
