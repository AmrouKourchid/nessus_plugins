...
# extracted from Fedora Security Advisory FEDORA-2024-5b8cfa7937
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-5b8cfa7937");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2024/11/05");

  script_name(english:"Fedora 40 : thunderbird (2024-5b8cfa7937)");
...
FEDORA-2024-5b8cfa7937 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-5b8cfa7937");
...
var pkgs = [
    {'reference':'thunderbird-128.3.1-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
