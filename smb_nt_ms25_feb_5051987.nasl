...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5051987");
  script_xref(name:"MSKB", value:"5052105");
  script_xref(name:"MSFT", value:"MS25-5051987");
  script_xref(name:"MSFT", value:"MS25-5052105");
  ...
  script_name(english:"KB5051987: Windows 11 Version 24H2 / Windows Server 2025 Security Update (February 2025)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5051987");
...
var wmi_patch_found = get_kb_item("WMI/Installed/Hotfix/KB5052105");
...
if (
  smb_check_rollup(os:'10',
                   ...
                   rollup_date:'02_2025',
                   bulletin:bulletin,
                   rollup_kb_list:[5051987, 5052105])
)
{
