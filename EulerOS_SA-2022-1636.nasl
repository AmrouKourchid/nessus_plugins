...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.0 : python-pillow (EulerOS-SA-2022-1636)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1636
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?48e2edd0");
...
var pkgs = [
  "python3-pillow-5.3.0-4.h21.eulerosv2r9"
];
