...
# extracted from Red Hat Security Advisory RHSA-2013:1204. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2013:1204");

  script_name(english:"RHEL 6 : haproxy (RHSA-2013:1204)");
...
this issue.");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2013:1204");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/cve-2013-2175");
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"haproxy-1.4.22-6.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"haproxy-debuginfo-1.4.22-6.el6")) flag++;
