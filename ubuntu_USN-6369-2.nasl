...
# extracted from Ubuntu Security Notice USN-6369-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6369-2");

  script_name(english:"Ubuntu 18.04 ESM : libwebp vulnerability (USN-6369-2)");
...
USN-6369-2 advisory.
    ...
    USN-6369-1 fixed a vulnerability in libwebp. This update provides the corresponding update for Ubuntu
    18.04 LTS.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6369-2");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'libwebp-dev', 'pkgver': '0.6.1-2ubuntu0.18.04.2+esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libwebp6', 'pkgver': '0.6.1-2ubuntu0.18.04.2+esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libwebpdemux2', 'pkgver': '0.6.1-2ubuntu0.18.04.2+esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libwebpmux3', 'pkgver': '0.6.1-2ubuntu0.18.04.2+esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'webp', 'pkgver': '0.6.1-2ubuntu0.18.04.2+esm1', 'ubuntu_pro': TRUE}
];
