...
# extracted from Red Hat Security Advisory RHSA-2024:2246. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2246");

  script_name(english:"RHEL 9 : ansible-core (RHSA-2024:2246)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2246.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1cfdd1d7");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2246");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2259013");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-18950");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-19298");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-23783");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL ansible-core package based on the guidance in RHSA-2024:2246.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ansible-core-2.14.14-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'ansible-test-2.14.14-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
