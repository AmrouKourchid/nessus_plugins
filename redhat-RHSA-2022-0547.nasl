...
# extracted from Red Hat Security Advisory RHSA-2022:0547. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:0547");

  script_name(english:"RHEL 8 : ruby:2.5 (RHSA-2022:0547)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for ruby:2.5.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2022:0547 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_0547.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a946c5b0");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/articles/6206172");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:0547");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1958999");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL ruby:2.5 package based on the guidance in RHSA-2022:0547.");
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'rubygem-bundler / rubygem-bundler-doc');
}
