...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Openjdk8 PHSA-2020-2.0-0235");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'openjdk8-1.8.0.252-2.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'openjdk8-debuginfo-1.8.0.252-2.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'openjdk8-doc-1.8.0.252-2.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'openjdk8-sample-1.8.0.252-2.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'openjdk8-src-1.8.0.252-2.ph2')) flag++;
