...
# SUSE update advisory SUSE-SU-2022:14926-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:14926-1");

  script_name(english:"SUSE SLES11 Security Update : java-1_7_0-ibm (SUSE-SU-2022:14926-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote SUSE Linux SLES11 host has packages installed that are affected by multiple vulnerabilities as referenced in
the SUSE-SU-2022:14926-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-March/010503.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dad2f042");
...
var pkgs = [
    {'reference':'java-1_7_0-ibm-1.7.0_sr11.5-65.66.1', 'sp':'3', 'cpu':'i586', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-pos-release-11.3']},
    {'reference':'java-1_7_0-ibm-alsa-1.7.0_sr11.5-65.66.1', 'sp':'3', 'cpu':'i586', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-pos-release-11.3']},
    {'reference':'java-1_7_0-ibm-devel-1.7.0_sr11.5-65.66.1', 'sp':'3', 'cpu':'i586', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-pos-release-11.3']},
    {'reference':'java-1_7_0-ibm-jdbc-1.7.0_sr11.5-65.66.1', 'sp':'3', 'cpu':'i586', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-pos-release-11.3']},
    {'reference':'java-1_7_0-ibm-plugin-1.7.0_sr11.5-65.66.1', 'sp':'3', 'cpu':'i586', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-pos-release-11.3']}
];
