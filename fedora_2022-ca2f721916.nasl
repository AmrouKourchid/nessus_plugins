...
# extracted from Fedora Security Advisory FEDORA-2022-ca2f721916
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-ca2f721916");

  script_name(english:"Fedora 36 : wavpack (2022-ca2f721916)");
...
FEDORA-2022-ca2f721916 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-ca2f721916");
...
var pkgs = [
    {'reference':'wavpack-5.5.0-2.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
