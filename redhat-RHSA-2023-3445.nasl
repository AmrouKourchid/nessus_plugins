...
# extracted from Red Hat Security Advisory RHSA-2023:3445. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:3445");

  script_name(english:"RHEL 8 : Red Hat OpenStack Platform 16.2 (etcd) (RHSA-2023:3445)");
...
referenced in the RHSA-2023:3445 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_3445.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b9a9b28e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:3445");
...
"Update the RHEL Red Hat OpenStack Platform 16.2 (etcd) package based on the guidance in RHSA-2023:3445.");
  ...
  script_cwe_id(94, 176, 287, 400, 835);
