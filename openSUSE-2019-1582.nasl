...
# extracted from openSUSE Security Update openSUSE-2019-1582.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : gnome-shell (openSUSE-2019-1582)");
...
This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1124493");
  script_set_attribute(attribute:"solution", value:
"Update the affected gnome-shell packages.");
...
if ( rpm_check(release:"SUSE15.1", reference:"gnome-shell-3.26.2+20180130.0d9c74212-lp151.7.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"gnome-shell-browser-plugin-3.26.2+20180130.0d9c74212-lp151.7.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"gnome-shell-browser-plugin-debuginfo-3.26.2+20180130.0d9c74212-lp151.7.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"gnome-shell-calendar-3.26.2+20180130.0d9c74212-lp151.7.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"gnome-shell-calendar-debuginfo-3.26.2+20180130.0d9c74212-lp151.7.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"gnome-shell-debuginfo-3.26.2+20180130.0d9c74212-lp151.7.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"gnome-shell-debugsource-3.26.2+20180130.0d9c74212-lp151.7.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"gnome-shell-devel-3.26.2+20180130.0d9c74212-lp151.7.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"gnome-shell-lang-3.26.2+20180130.0d9c74212-lp151.7.3.1") ) flag++;
