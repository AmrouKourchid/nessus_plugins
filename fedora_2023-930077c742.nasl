...
# extracted from Fedora Security Advisory FEDORA-2023-930077c742
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-930077c742");

  script_name(english:"Fedora 36 : pypy3.7 (2023-930077c742)");
...
FEDORA-2023-930077c742 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-930077c742");
  script_set_attribute(attribute:"solution", value:
"Update the affected pypy3.7 package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:pypy3.7");
...
var pkgs = [
    {'reference':'pypy3.7-7.3.9-5.3.7.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'pypy3.7');
}
