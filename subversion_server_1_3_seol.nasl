...
if (description)
{
  ...
  script_name(english:"Apache Subversion Server SEoL (1.3.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Apache Subversion Server is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Apache Subversion Server is 1.3.x. It is, therefore, no longer maintained by its vendor or
provider.
