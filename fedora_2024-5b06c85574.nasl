...
# extracted from Fedora Security Advisory FEDORA-2024-5b06c85574
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-5b06c85574");

  script_name(english:"Fedora 39 : golang (2024-5b06c85574)");
...
FEDORA-2024-5b06c85574 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-5b06c85574");
...
var pkgs = [
    {'reference':'golang-1.21.12-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
