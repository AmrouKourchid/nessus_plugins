...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : apr-util (EulerOS-SA-2023-2497)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the apr-util packages installed, the EulerOS Virtualization installation on the remote host
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2497
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?90bef832");
...
"Update the affected apr-util packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:apr-util-bdb");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:apr-util-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:apr-util-openssl");
...
var pkgs = [
  "apr-util-1.6.1-8.h2.eulerosv2r8",
  "apr-util-bdb-1.6.1-8.h2.eulerosv2r8",
  "apr-util-devel-1.6.1-8.h2.eulerosv2r8",
  "apr-util-openssl-1.6.1-8.h2.eulerosv2r8"
];
