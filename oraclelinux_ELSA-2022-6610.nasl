...
ELSA-2022-6610 advisory.
    ...
    - netfilter: nf_tables: sanitize nft_set_desc_concat_parse() (Florian Westphal) [2108199 2096401]
    {CVE-2022-1972}
    - netfilter: nf_tables: stricter validation of element data (Florian Westphal) [2104591 2104592]
    {CVE-2022-34918}
...
var pkgs = [
    ...
    {'reference':'kernel-abi-stablelists-5.14.0-70.26.1.0.1.el9_0', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-abi-stablelists-5.14.0'},
