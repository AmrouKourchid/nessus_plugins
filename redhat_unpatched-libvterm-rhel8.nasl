...
# extracted from Red Hat Security Advisory libvterm. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2018-20786");

  script_name(english:"RHEL 8 : libvterm (Unpatched Vulnerability) (deprecated)");
...
"This plugin has been deprecated as it does not adhere to established standards for this style of check.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-20786");
