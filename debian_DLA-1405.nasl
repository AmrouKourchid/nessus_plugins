...
# extracted from Debian Security Advisory DLA-1405-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1405-1 : libgcrypt20 security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2018/06/msg00013.html");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"libgcrypt11-dev", reference:"1.6.3-2+deb8u5")) flag++;
if (deb_check(release:"8.0", prefix:"libgcrypt20", reference:"1.6.3-2+deb8u5")) flag++;
if (deb_check(release:"8.0", prefix:"libgcrypt20-dbg", reference:"1.6.3-2+deb8u5")) flag++;
if (deb_check(release:"8.0", prefix:"libgcrypt20-dev", reference:"1.6.3-2+deb8u5")) flag++;
if (deb_check(release:"8.0", prefix:"libgcrypt20-doc", reference:"1.6.3-2+deb8u5")) flag++;
