...
# extracted from Fedora Security Advisory FEDORA-2024-ab372beea4
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-ab372beea4");

  script_name(english:"Fedora 39 : mingw-python-jinja2 (2024-ab372beea4)");
...
FEDORA-2024-ab372beea4 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-ab372beea4");
...
var pkgs = [
    {'reference':'mingw-python-jinja2-3.1.3-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
