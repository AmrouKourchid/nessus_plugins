...
# extracted from Fedora Security Advisory FEDORA-2024-e00eceb11c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-e00eceb11c");

  script_name(english:"Fedora 38 : dnsmasq (2024-e00eceb11c)");
...
FEDORA-2024-e00eceb11c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-e00eceb11c");
...
var pkgs = [
    {'reference':'dnsmasq-2.90-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
