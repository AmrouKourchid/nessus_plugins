...
# extracted from Fedora Security Advisory FEDORA-2018-f76e6d17f1.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : chromium (2018-f76e6d17f1)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-f76e6d17f1");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"chromium-69.0.3497.100-1.fc28")) flag++;
