...
"The remote Red Hat host is missing a security update for ibus / glib2.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_1880.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d74e6b30");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1777213");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL ibus / glib2 packages based on the guidance in RHSA-2020:1880.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ibus-1.5.19-11.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ibus-devel-1.5.19-11.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ibus-devel-docs-1.5.19-11.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ibus-gtk2-1.5.19-11.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ibus-gtk3-1.5.19-11.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ibus-libs-1.5.19-11.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ibus-setup-1.5.19-11.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ibus-wayland-1.5.19-11.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'glib2-2.56.4-8.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glib2-devel-2.56.4-8.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glib2-doc-2.56.4-8.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glib2-fam-2.56.4-8.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glib2-static-2.56.4-8.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glib2-tests-2.56.4-8.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
