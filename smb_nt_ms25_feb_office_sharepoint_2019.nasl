...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5002678");
  script_xref(name:"MSFT", value:"MS25-5002678");
  script_xref(name:"IAVA", value:"2025-A-0106-S");

  script_name(english:"Security Updates for Microsoft SharePoint Server 2019 (February 2025)");
...
security updates. It is, therefore, affected by a Remote Code Execution Vulnerability");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002678");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released KB5002678 to address this issue.");
