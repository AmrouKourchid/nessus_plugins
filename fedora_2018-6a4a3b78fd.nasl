...
# extracted from Fedora Security Advisory FEDORA-2018-6a4a3b78fd.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-6a4a3b78fd");

  script_name(english:"Fedora 29 : moodle (2018-6a4a3b78fd)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-6a4a3b78fd");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"moodle-3.5.3-1.fc29")) flag++;
