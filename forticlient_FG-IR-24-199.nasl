...
if (description)
{
  ...
  script_cve_id("CVE-2024-47574");
  script_xref(name:"IAVA", value:"2024-A-0742-S");

  script_name(english:"Fortinet FortiClient Named Pipes Improper Access Control (FG-IR-24-199)");
...
vulnerability as referenced in the FG-IR-24-199 advisory.

  - An authentication bypass using an alternate path or channel vulnerability (CWE-288) in FortiClient
    (Windows) may allow a low privilege attacker to execute arbitrary code with high privilege via spoofed
    named pipe messages. (CVE-2024-47574)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.fortiguard.com/psirt/FG-IR-24-199");
  script_set_attribute(attribute:"solution", value:
"Upgrade to FortiClient version 6.4.999999 / 7.0.13 / 7.2.5 / 7.4.1 or later.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:S/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:L/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-47574");
