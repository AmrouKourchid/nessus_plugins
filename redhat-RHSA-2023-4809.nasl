...
# extracted from Red Hat Security Advisory RHSA-2023:4809. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:4809");

  script_name(english:"RHEL 9 : librsvg2 (RHSA-2023:4809)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_4809.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8a57dc3d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2224945");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:4809");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL librsvg2 package based on the guidance in RHSA-2023:4809.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'librsvg2-2.50.7-1.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'librsvg2-devel-2.50.7-1.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'librsvg2-tools-2.50.7-1.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
