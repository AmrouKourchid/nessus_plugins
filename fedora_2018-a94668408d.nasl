...
# extracted from Fedora Security Advisory FEDORA-2018-a94668408d.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : mod_perl (2018-a94668408d)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-a94668408d");
...
flag = 0;
if (rpm_check(release:"FC27", reference:"mod_perl-2.0.10-9.fc27")) flag++;
