...
referenced in the RHSA-2019:2137 advisory.

    The keycloak-httpd-client-install packages provide various libraries and tools that can automate and
    simplify the configuration of Apache httpd authentication modules when registering as a Red Hat Single
    Sign-On (RH-SSO, also called Keycloak) federated Identity Provider (IdP) client.

    The following packages have been upgraded to a later upstream version: keycloak-httpd-client-install
    (0.8). (BZ#1673716)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_2137.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4afe51d1");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/7/html/7.7_release_notes/index
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cc7115e8");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:2137");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1511623");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1511626");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1673716");
  script_set_attribute(attribute:"solution", value:
"Update the affected keycloak-httpd-client-install and / or python2-keycloak-httpd-client-install packages.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'keycloak-httpd-client-install-0.8-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python2-keycloak-httpd-client-install-0.8-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
