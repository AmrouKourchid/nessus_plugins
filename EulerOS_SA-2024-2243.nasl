...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP12 : llvm (EulerOS-SA-2024-2243)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2243
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e4097a8e");
...
var pkgs = [
  "llvm-12.0.1-4.h1.eulerosv2r12",
  "llvm-help-12.0.1-4.h1.eulerosv2r12",
  "llvm-libs-12.0.1-4.h1.eulerosv2r12"
];
