...
# extracted from Fedora Security Advisory FEDORA-2023-7e952959f8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-7e952959f8");

  script_name(english:"Fedora 38 : suricata (2023-7e952959f8)");
...
FEDORA-2023-7e952959f8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-7e952959f8");
...
var pkgs = [
    {'reference':'suricata-6.0.13-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
