...
# extracted from VMware Security Advisory PHSA-2023-4.0-0393. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Apache PHSA-2023-4.0-0393");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the apache package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-393.md");
...
if (rpm_check(release:'PhotonOS-4.0', reference:'apache-tomcat-8.5.86-1.ph4')) flag++;
