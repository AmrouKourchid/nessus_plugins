...
# extracted from Fedora Security Advisory FEDORA-2022-4ff296fe8e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-4ff296fe8e");

  script_name(english:"Fedora 36 : bash (2022-4ff296fe8e)");
...
FEDORA-2022-4ff296fe8e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-4ff296fe8e");
...
var pkgs = [
    {'reference':'bash-5.1.16-3.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
