...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_4373.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0c4f70c3");
...
"Update the RHEL pcre package based on the guidance in RHSA-2021:4373.");
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'pcre / pcre-cpp / pcre-devel / pcre-static / pcre-utf16 / etc');
}
