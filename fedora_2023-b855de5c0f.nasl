...
# extracted from Fedora Security Advisory FEDORA-2023-b855de5c0f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-b855de5c0f");
  script_xref(name:"CEA-ID", value:"CEA-2023-0052");
  script_xref(name:"IAVA", value:"2023-A-0531-S");

  script_name(english:"Fedora 38 : curl (2023-b855de5c0f)");
...
FEDORA-2023-b855de5c0f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-b855de5c0f");
...
var pkgs = [
    {'reference':'curl-8.0.1-5.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
