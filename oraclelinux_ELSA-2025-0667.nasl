...
# extracted from Oracle Linux Security Advisory ELSA-2025-0667.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : python-jinja2 (ELSA-2025-0667)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2025-0667.html");
...
var pkgs = [
    {'reference':'python3-jinja2-2.11.3-7.el9_5', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-jinja2-2.11.3-7.el9_5', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
