...
# extracted from Fedora Security Advisory FEDORA-2024-6b9aeecbe8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-6b9aeecbe8");

  script_name(english:"Fedora 41 : chisel (2024-6b9aeecbe8)");
...
FEDORA-2024-6b9aeecbe8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-6b9aeecbe8");
  script_set_attribute(attribute:"solution", value:
"Update the affected chisel package.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:C/I:N/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:C/C:H/I:N/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-43798");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:chisel");
...
var pkgs = [
    {'reference':'chisel-1.10.0-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'chisel');
}
