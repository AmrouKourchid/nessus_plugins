...
# extracted from VMware Security Advisory PHSA-2024-3.0-0751. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2023-5824", "CVE-2024-25111", "CVE-2024-25617");

  script_name(english:"Photon OS 3.0: Squid PHSA-2024-3.0-0751");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the squid package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-3.0-751.md");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'squid-5.9-6.ph3')) flag++;
