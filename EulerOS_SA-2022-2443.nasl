...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : libtiff (EulerOS-SA-2022-2443)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2443
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a601bd0f");
...
var pkgs = [
  "libtiff-4.0.3-27.h36.eulerosv2r7",
  "libtiff-devel-4.0.3-27.h36.eulerosv2r7"
];
