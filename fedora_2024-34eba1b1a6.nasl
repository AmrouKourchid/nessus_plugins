...
# extracted from Fedora Security Advisory FEDORA-2024-34eba1b1a6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-34eba1b1a6");

  script_name(english:"Fedora 38 : suricata (2024-34eba1b1a6)");
...
FEDORA-2024-34eba1b1a6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-34eba1b1a6");
...
var pkgs = [
    {'reference':'suricata-6.0.17-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
