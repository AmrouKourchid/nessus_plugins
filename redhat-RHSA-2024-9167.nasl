...
# extracted from Red Hat Security Advisory RHSA-2024:9167. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:9167");

  script_name(english:"RHEL 9 : poppler (RHSA-2024:9167)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_9167.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?38e02329");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:9167");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL poppler package based on the guidance in RHSA-2024:9167.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'poppler-21.01.0-21.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'poppler-cpp-21.01.0-21.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'poppler-cpp-devel-21.01.0-21.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'poppler-devel-21.01.0-21.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'poppler-glib-21.01.0-21.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'poppler-glib-devel-21.01.0-21.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'poppler-glib-doc-21.01.0-21.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'poppler-qt5-21.01.0-21.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'poppler-qt5-devel-21.01.0-21.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'poppler-utils-21.01.0-21.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
