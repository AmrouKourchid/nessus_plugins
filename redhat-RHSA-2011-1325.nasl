...
"The remote Red Hat host is missing a security update for evolution28-pango.");
...
the RHSA-2011:1325 advisory.

  - qt/harfbuzz buffer overflow (CVE-2011-3193)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2011/rhsa-2011_1325.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e330d4b5");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=733118");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2011:1325");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL evolution28-pango package based on the guidance in RHSA-2011:1325.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'evolution28-pango-1.14.9-13.el4_11', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'evolution28-pango-1.14.9-13.el4_11', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'evolution28-pango-1.14.9-13.el4_11', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'evolution28-pango-1.14.9-13.el4_11', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'evolution28-pango-1.14.9-13.el4_11', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'evolution28-pango-devel-1.14.9-13.el4_11', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'evolution28-pango-devel-1.14.9-13.el4_11', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'evolution28-pango-devel-1.14.9-13.el4_11', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'evolution28-pango-devel-1.14.9-13.el4_11', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'evolution28-pango-devel-1.14.9-13.el4_11', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
