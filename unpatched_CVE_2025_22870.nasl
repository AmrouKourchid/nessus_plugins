...
if (description)
{
  ...
  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2025-22870");
...
patch available.
  ...
  - Debian Linux - golang-1.15 - None  golang-1.19 - None  golang-1.23 - None  golang-1.24 - None
    (CVE-2025-22870)
