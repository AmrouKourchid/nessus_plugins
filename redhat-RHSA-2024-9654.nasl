...
# extracted from Red Hat Security Advisory RHSA-2024:9654. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2024-52530");
  script_xref(name:"RHSA", value:"2024:9654");

  script_name(english:"RHEL 7 : libsoup (RHSA-2024:9654)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for libsoup.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:9654 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2325284");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_9654.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a1c17986");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:9654");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libsoup package based on the guidance in RHSA-2024:9654.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libsoup-2.62.2-3.el7_9', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsoup-2.62.2-3.el7_9', 'cpu':'ppc', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsoup-2.62.2-3.el7_9', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsoup-2.62.2-3.el7_9', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsoup-2.62.2-3.el7_9', 'cpu':'s390', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsoup-2.62.2-3.el7_9', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsoup-2.62.2-3.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsoup-devel-2.62.2-3.el7_9', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsoup-devel-2.62.2-3.el7_9', 'cpu':'ppc', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsoup-devel-2.62.2-3.el7_9', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsoup-devel-2.62.2-3.el7_9', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsoup-devel-2.62.2-3.el7_9', 'cpu':'s390', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsoup-devel-2.62.2-3.el7_9', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsoup-devel-2.62.2-3.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
