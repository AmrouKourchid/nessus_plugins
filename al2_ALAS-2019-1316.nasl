...
# extracted from Amazon Linux 2 Security Advisory ALAS-2019-1316.
#
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : java-11-amazon-corretto (ALAS-2019-1316)");
...
Vector: (CVSS:3.0/AV:N/AC:H/PR:N/UI:N/S:U/C:N/I:H/A:N).(CVE-2019-2958)
...
Hotspot). Supported versions that are affected are Java SE: 11.0.4 and
13. Difficult to exploit vulnerability allows unauthenticated attacker
with network access via multiple protocols to compromise Java SE.
Successful attacks of this vulnerability can result in unauthorized
read access to a subset of Java SE accessible data and unauthorized
...
installed by an administrator). CVSS 3.0 Base Score 4.8
(Confidentiality and Availability impacts). CVSS Vector:
(CVSS:3.0/AV:N/AC:H/PR:N/UI:N/S:U/C:L/I:N/A:L).(CVE-2019-2977)
...
sandbox for security. This vulnerability can also be exploited by
using APIs in the specified Component, e.g., through a web service
which supplies data to the APIs. CVSS 3.0 Base Score 3.7
(Confidentiality impacts). CVSS Vector:
(CVSS:3.0/AV:N/AC:H/PR:N/UI:N/S:U/C:L/I:N/A:N).(CVE-2019-2894)");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2019-1316.html");
...
flag = 0;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"java-11-amazon-corretto-11.0.5+10-1.amzn2")) flag++;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"java-11-amazon-corretto-headless-11.0.5+10-1.amzn2")) flag++;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"java-11-amazon-corretto-javadoc-11.0.5+10-1.amzn2")) flag++;
