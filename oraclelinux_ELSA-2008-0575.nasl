...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2008-0575.html");
...
"Update the affected rdesktop package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2008-1803");
...
var pkgs = [
    {'reference':'rdesktop-1.4.1-6', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rdesktop-1.4.1-6', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
