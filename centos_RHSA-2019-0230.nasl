...
# CentOS Errata and Security Advisory 2019:0230 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : polkit (CESA-2019:0230)");
...
the original reporter.");
  # https://lists.centos.org/pipermail/centos-announce/2019-April/023271.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9517d1cd");
  # https://lists.centos.org/pipermail/centos-announce/2019-March/023215.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5fca4ca6");
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"polkit-0.112-18.el7_6.1")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"polkit-devel-0.112-18.el7_6.1")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"polkit-docs-0.112-18.el7_6.1")) flag++;
