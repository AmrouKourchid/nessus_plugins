...
# CentOS Errata and Security Advisory 2020:0726 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : sudo (RHSA-2020:0726)");
...
var pkgs = [
    {'reference':'sudo-1.8.6p3-29.el6_9', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sudo-devel-1.8.6p3-29.el6_9', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE}
];
