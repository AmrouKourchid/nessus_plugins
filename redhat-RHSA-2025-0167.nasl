...
# extracted from Red Hat Security Advisory RHSA-2025:0167. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:0167");

  script_name(english:"RHEL 9 : thunderbird (RHSA-2025:0167)");
...
referenced in the RHSA-2025:0167 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_0167.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?564af09a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:0167");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL thunderbird package based on the guidance in RHSA-2025:0167.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'thunderbird-128.6.0-3.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
