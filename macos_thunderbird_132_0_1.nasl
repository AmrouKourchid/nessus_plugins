...
# extracted from Mozilla Foundation Security Advisory mfsa2024-62.
...
if (description)
{
  ...
  script_name(english:"Mozilla Thunderbird < 132.0.1");

  script_set_attribute(attribute:"synopsis", value:
"A mail client installed on the remote macOS or Mac OS X host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Thunderbird installed on the remote macOS or Mac OS X host is prior to 132.0.1. It is, therefore,
affected by a vulnerability as referenced in the mfsa2024-62 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2024-62/");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Mozilla Thunderbird version 132.0.1 or later.");
...
mozilla_check_version(version:version, path:path, product:'thunderbird', esr:FALSE, fix:'132.0.1', severity:SECURITY_WARNING);
