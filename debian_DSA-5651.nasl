...
# extracted from Debian Security Advisory dsa-5651. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5651 : mediawiki - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 / 12 host has packages installed that are affected by a vulnerability as referenced in the dsa-5651
advisory.
...
"Upgrade the mediawiki packages.");
  ...
  script_set_attribute(attribute:"vuln_publication_date", value:"2024/03/31");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'mediawiki', 'reference': '1:1.35.13-1+deb11u2'},
    {'release': '11.0', 'prefix': 'mediawiki-classes', 'reference': '1:1.35.13-1+deb11u2'},
    {'release': '12.0', 'prefix': 'mediawiki', 'reference': '1:1.39.7-1~deb12u1'},
    {'release': '12.0', 'prefix': 'mediawiki-classes', 'reference': '1:1.39.7-1~deb12u1'}
];
