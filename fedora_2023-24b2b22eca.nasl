...
# extracted from Fedora Security Advisory FEDORA-2023-24b2b22eca
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-24b2b22eca");

  script_name(english:"Fedora 37 : firefox (2023-24b2b22eca)");
...
FEDORA-2023-24b2b22eca advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-24b2b22eca");
...
var pkgs = [
    {'reference':'firefox-111.0-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
