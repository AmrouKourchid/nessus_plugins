...
# extracted from Fedora Security Advisory FEDORA-2025-cc269f80fa
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-cc269f80fa");

  script_name(english:"Fedora 41 : rust-zincati (2025-cc269f80fa)");
...
FEDORA-2025-cc269f80fa advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-cc269f80fa");
...
"Update the affected rust-zincati package.");
  ...
  script_set_attribute(attribute:"cvss4_vector", value:"CVSS:4.0/AV:L/AC:L/AT:P/PR:N/UI:N/VC:N/VI:H/VA:N/SC:N/SI:N/SA:N");
  script_set_attribute(attribute:"cvss4_threat_vector", value:"CVSS:4.0/E:U");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-27512");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:rust-zincati");
...
var pkgs = [
    {'reference':'rust-zincati-0.0.30-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'rust-zincati');
}
