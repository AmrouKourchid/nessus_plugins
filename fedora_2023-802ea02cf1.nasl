...
# extracted from Fedora Security Advisory FEDORA-2023-802ea02cf1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-802ea02cf1");

  script_name(english:"Fedora 38 : golang (2023-802ea02cf1)");
...
FEDORA-2023-802ea02cf1 advisory.

    go1.20.5 (released 2023-06-06) includes four security fixes to the cmd/go and runtime packages, as well as
    bug fixes to the compiler, the go command, the runtime, and the crypto/rsa, net, and os packages. [See the
    milestone on the issue tracker for
    details](https://github.com/golang/go/issues?q=milestone%3AGo1.20.5+label%3ACherryPickApproved).

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-802ea02cf1");
...
var pkgs = [
    {'reference':'golang-1.20.5-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
