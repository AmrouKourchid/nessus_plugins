...
# extracted from Red Hat Security Advisory log4j. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2023-26048", "CVE-2023-26049", "CVE-2023-26464");

  script_name(english:"RHEL 9 : log4j (Unpatched Vulnerability) (deprecated)");
