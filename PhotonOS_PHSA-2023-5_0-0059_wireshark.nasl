...
if (description)
{
  ...
  script_cve_id("CVE-2023-2952", "CVE-2023-3648", "CVE-2023-3649");
  script_xref(name:"IAVB", value:"2023-B-0036-S");
  script_xref(name:"IAVB", value:"2023-B-0051-S");

  script_name(english:"Photon OS 5.0: Wireshark PHSA-2023-5.0-0059");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'wireshark-4.0.7-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'wireshark-devel-4.0.7-1.ph5')) flag++;
