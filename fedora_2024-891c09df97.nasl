...
# extracted from Fedora Security Advisory FEDORA-2024-891c09df97
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-891c09df97");

  script_name(english:"Fedora 39 : djvulibre (2024-891c09df97)");
...
FEDORA-2024-891c09df97 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-891c09df97");
...
var pkgs = [
    {'reference':'djvulibre-3.5.28-7.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
