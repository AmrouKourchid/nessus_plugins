...
if (description)
{
  ...
  script_name(english:"Adobe After Effects < 18.2 Multiple Vulnerabilities (APSB21-33) (macOS)");

  script_set_attribute(attribute:"synopsis", value:
"The Adobe After Effects instance installed on the remote host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe After Effects installed on the remote macOS host is prior to 18.2. It is, therefore, affected by
