...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_5620.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e95ef63b");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.postgresql.org/docs/12/release-12-2.html");
...
"Update the RHEL postgresql:12 package based on the guidance in RHSA-2020:5620.");
  ...
  script_cwe_id(20, 89, 270, 285, 327);
  ...
  'postgresql:12': [
    {
      ...
      'pkgs': [
        {'reference':'pgaudit-1.4.0-4.module+el8.3.0+9042+664538f4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgres-decoderbufs-0.10.0-2.module+el8.3.0+9042+664538f4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-12.5-1.module+el8.3.0+9042+664538f4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-contrib-12.5-1.module+el8.3.0+9042+664538f4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-docs-12.5-1.module+el8.3.0+9042+664538f4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plperl-12.5-1.module+el8.3.0+9042+664538f4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plpython3-12.5-1.module+el8.3.0+9042+664538f4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-pltcl-12.5-1.module+el8.3.0+9042+664538f4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-12.5-1.module+el8.3.0+9042+664538f4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-devel-12.5-1.module+el8.3.0+9042+664538f4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-static-12.5-1.module+el8.3.0+9042+664538f4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-12.5-1.module+el8.3.0+9042+664538f4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-rpm-macros-12.5-1.module+el8.3.0+9042+664538f4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-upgrade-12.5-1.module+el8.3.0+9042+664538f4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-upgrade-devel-12.5-1.module+el8.3.0+9042+664538f4', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
