...
# extracted from Fedora Security Advisory FEDORA-2023-6fe7ff3452
#
...
if (description)
{
  ...
  script_cve_id("CVE-2023-3079", "CVE-2023-3709");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2023/06/28");
  script_xref(name:"FEDORA", value:"2023-6fe7ff3452");

  script_name(english:"Fedora 38 : chromium (2023-6fe7ff3452)");
...
FEDORA-2023-6fe7ff3452 advisory.

    update to 114.0.5735.106. Fixes the following security issue:
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-6fe7ff3452");
...
var pkgs = [
    {'reference':'chromium-114.0.5735.106-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
