...
# extracted from Slackware Security Advisory SSA:2023-216-02. The text
...
if (description)
{
  ...
  script_name(english:"Slackware Linux 15.0 / current samba  Multiple Vulnerabilities (SSA:2023-216-02)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Slackware Linux host is missing a security update to samba.");
  script_set_attribute(attribute:"description", value:
"The version of samba installed on the remote host is prior to 4.18.5. It is, therefore, affected by multiple
vulnerabilities as referenced in the SSA:2023-216-02 advisory.
...
number.");
  # http://www.slackware.com/security/viewer.php?l=slackware-security&y=2023&m=slackware-security.476615
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?98d3af76");
...
var flag = 0;
var constraints = [
    { 'fixed_version' : '4.18.5', 'product' : 'samba', 'os_name' : 'Slackware Linux', 'os_version' : '15.0', 'service_pack' : '1_slack15.0', 'arch' : 'i586' },
    { 'fixed_version' : '4.18.5', 'product' : 'samba', 'os_name' : 'Slackware Linux', 'os_version' : '15.0', 'service_pack' : '1_slack15.0', 'arch' : 'x86_64' },
    { 'fixed_version' : '4.18.5', 'product' : 'samba', 'os_name' : 'Slackware Linux', 'os_version' : 'current', 'service_pack' : '1', 'arch' : 'i586' },
    { 'fixed_version' : '4.18.5', 'product' : 'samba', 'os_name' : 'Slackware Linux', 'os_version' : 'current', 'service_pack' : '1', 'arch' : 'x86_64' }
];
