...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : libssh2 (EulerOS-SA-2024-1548)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1548
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b88ddd36");
...
var pkgs = [
  "libssh2-1.9.0-6.h11.eulerosv2r10"
];
