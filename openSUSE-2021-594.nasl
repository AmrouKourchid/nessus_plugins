...
# extracted from openSUSE Security Update openSUSE-2021-594.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2021-3496");

  script_name(english:"openSUSE Security Update : jhead (openSUSE-2021-594)");
...
"This update for jhead fixes the following issues :
  ...
  - CVE-2021-3496: Fixed heap-based buffer overflow in
    Get16u() in exif.c (bsc#1184756)");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1184756");
...
if ( rpm_check(release:"SUSE15.2", reference:"jhead-3.00-lp152.7.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"jhead-debuginfo-3.00-lp152.7.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"jhead-debugsource-3.00-lp152.7.3.1") ) flag++;
