...
# extracted from Fedora Security Advisory FEDORA-2024-2a0f7e9e97
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-2a0f7e9e97");

  script_name(english:"Fedora 41 : yyjson (2024-2a0f7e9e97)");
...
FEDORA-2024-2a0f7e9e97 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-2a0f7e9e97");
...
var pkgs = [
    {'reference':'yyjson-0.9.0-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
