...
# extracted from Debian Security Advisory dla-3317. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3317 : snort - security update");
...
dla-3317 advisory.
    ...
    -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3317-1                debian-lts@lists.debian.org
    https://www.debian.org/lts/security/                      Markus Koschany
    February 11, 2023                             https://wiki.debian.org/LTS
    -------------------------------------------------------------------------

    Package        : snort
    Version        : 2.9.20-0+deb10u1
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/snort");
...
"Upgrade the snort packages.");
  ...
  script_set_attribute(attribute:"patch_publication_date", value:"2023/02/11");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'snort', 'reference': '2.9.20-0+deb10u1'},
    {'release': '10.0', 'prefix': 'snort-common', 'reference': '2.9.20-0+deb10u1'},
    {'release': '10.0', 'prefix': 'snort-common-libraries', 'reference': '2.9.20-0+deb10u1'},
    {'release': '10.0', 'prefix': 'snort-doc', 'reference': '2.9.20-0+deb10u1'},
    {'release': '10.0', 'prefix': 'snort-rules-default', 'reference': '2.9.20-0+deb10u1'}
];
