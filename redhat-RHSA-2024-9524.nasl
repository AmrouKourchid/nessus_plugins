...
# extracted from Red Hat Security Advisory RHSA-2024:9524. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:9524");

  script_name(english:"RHEL 8 : libsoup (RHSA-2024:9524)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for libsoup.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:9524 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_9524.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fee004fc");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:9524");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libsoup package based on the guidance in RHSA-2024:9524.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libsoup-2.62.3-3.el8_8.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsoup-devel-2.62.3-3.el8_8.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
