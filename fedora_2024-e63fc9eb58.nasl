...
# extracted from Fedora Security Advisory FEDORA-2024-e63fc9eb58
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-e63fc9eb58");

  script_name(english:"Fedora 41 : python-cbor2 (2024-e63fc9eb58)");
...
FEDORA-2024-e63fc9eb58 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-e63fc9eb58");
...
var pkgs = [
    {'reference':'python-cbor2-5.6.2-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
