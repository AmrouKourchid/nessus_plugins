...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2018-1169.html");
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'corosync / corosync-qdevice / corosync-qnetd / etc');
}
