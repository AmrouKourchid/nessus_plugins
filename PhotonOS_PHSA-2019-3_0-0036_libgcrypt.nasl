...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Libgcrypt PHSA-2019-3.0-0036");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libgcrypt-1.8.5-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libgcrypt-debuginfo-1.8.5-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libgcrypt-devel-1.8.5-1.ph3')) flag++;
