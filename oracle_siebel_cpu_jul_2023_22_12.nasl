...
if (description)
{
  ...
  script_name(english:"Oracle Siebel Server <= 22.12 (July 2023 CPU)");
...
2023 CPU advisory.
  ...
  - Vulnerability in the Siebel CRM product of Oracle Siebel CRM (component: UI Framework (CodeMirror)).
    Supported versions that are affected are 22.12 and prior. Easily exploitable vulnerability allows
    ...
    DOS) of Siebel CRM. (CVE-2020-7760)
...
"Apply the appropriate patch according to the July 2023 Oracle Critical Patch Update advisory.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-7760");
...
var constraints = [
  { 'max_version' : '22.12.999', 'fixed_version' : '23.7' }
];
