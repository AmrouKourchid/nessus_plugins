...
# extracted from Red Hat Security Advisory RHSA-2023:6236. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:6236");

  script_name(english:"RHEL 8 : binutils (RHSA-2023:6236)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for binutils.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2023:6236 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6236.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ad422100");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2150768");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6236");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL binutils package based on the guidance in RHSA-2023:6236.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'binutils-2.30-119.el8_8.2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'binutils-devel-2.30-119.el8_8.2', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'binutils-2.30-119.el8_8.2', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'binutils-devel-2.30-119.el8_8.2', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
