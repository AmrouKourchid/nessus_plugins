...
# extracted from Red Hat Security Advisory RHSA-2022:6463. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:6463");

  script_name(english:"RHEL 8 : gnupg2 (RHSA-2022:6463)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for gnupg2.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2022:6463 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_6463.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e91e9d61");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:6463");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2102868");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL gnupg2 package based on the guidance in RHSA-2022:6463.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gnupg2-2.2.20-3.el8_6', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gnupg2-smime-2.2.20-3.el8_6', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'gnupg2-2.2.20-3.el8_6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gnupg2-smime-2.2.20-3.el8_6', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
