...
# extracted from Red Hat Security Advisory RHSA-2024:4522. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2024-28102", "CVE-2024-34064", "CVE-2024-35195");
  script_xref(name:"RHSA", value:"2024:4522");

  script_name(english:"RHEL 8 / 9 : Red Hat Ansible Automation Platform 2.4 Product Security and Bug Fix Update (Moderate) (RHSA-2024:4522)");
...
referenced in the RHSA-2024:4522 advisory.
    ...
    * automation-controller: requests: subsequent requests to the same host ignore cert verification
    (CVE-2024-35195)
    ...
    * Fixed a bug where the controller does not respect DATABASES[OPTIONS] setting, if specified
    (AAP-26398)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_4522.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1b906d44");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:4522");
...
"Update the affected automation-controller-venv-tower package.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2024-35195");

  script_set_attribute(attribute:"exploitability_ease", value:"No known exploits are available");
  script_set_attribute(attribute:"exploit_available", value:"false");
  script_cwe_id(79, 400, 670);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'automation-controller-venv-tower-4.5.8-1.el8ap', 'release':'8', 'el_string':'el8ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.4'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'automation-controller-venv-tower-4.5.8-1.el9ap', 'release':'9', 'el_string':'el9ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.4'}
    ]
  }
];
