...
if (description)
{
  ...
  script_name(english:"IBM WebSphere Application Server 6.1.0.x <= 6.1.0.47 / 7.0.0.x < 7.0.0.39 / 8.0.0.x < 8.0.0.12 / 8.5.x < 8.5.5.8 HTTP Response Splitting (CVE-2015-2017)");
...
7.0.0.39, 8.0.0.x prior to 8.0.0.12, or 8.5.0.x prior to 8.5.5.8. It is, therefore, affected by an HTTP response splitting
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/node/266251");
  script_set_attribute(attribute:"solution", value:
"Upgrade to IBM WebSphere Application Server 7.0.0.39, 8.0.0.12, 8.5.5.8, or later. Alternatively, upgrade to the
minimal fix pack levels required by the interim fix and then apply Interim Fix PI45266.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:N/I:P/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:R/S:U/C:N/I:L/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-2017");
...
constraints = [
  ...
  {'min_version':'8.5.0.0', 'max_version':'8.5.5.7', 'fixed_display':'8.5.5.8 or ' + fix}
];
