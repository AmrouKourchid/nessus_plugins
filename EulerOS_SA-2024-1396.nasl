...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.1 : binutils (EulerOS-SA-2024-1396)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1396
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?adab1a54");
...
var pkgs = [
  "binutils-2.37-6.h26.eulerosv2r11"
];
