...
# extracted from Fedora Security Advisory FEDORA-2023-5a717dd33d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-5a717dd33d");
  script_xref(name:"IAVB", value:"2024-B-0077-S");

  script_name(english:"Fedora 38 : libqb (2023-5a717dd33d)");
...
FEDORA-2023-5a717dd33d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-5a717dd33d");
...
"Update the affected libqb package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:libqb");
...
var pkgs = [
    {'reference':'libqb-2.0.8-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
