...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : samba on SL7.x x86_64 (20190806)");
...
Security Fix(es) :
  ...
  - samba: save registry file outside share as unprivileged
    user (CVE-2019-3880)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1908&L=SCIENTIFIC-LINUX-ERRATA&P=29734
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d8484179");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"libsmbclient-4.9.1-6.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"libsmbclient-devel-4.9.1-6.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"libwbclient-4.9.1-6.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"libwbclient-devel-4.9.1-6.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"samba-4.9.1-6.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"samba-client-4.9.1-6.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"samba-client-libs-4.9.1-6.el7")) flag++;
if (rpm_check(release:"SL7", reference:"samba-common-4.9.1-6.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"samba-common-4.9.1-6.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"samba-common-libs-4.9.1-6.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"samba-common-tools-4.9.1-6.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"samba-dc-4.9.1-6.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"samba-dc-libs-4.9.1-6.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"samba-debuginfo-4.9.1-6.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"samba-devel-4.9.1-6.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"samba-krb5-printing-4.9.1-6.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"samba-libs-4.9.1-6.el7")) flag++;
if (rpm_check(release:"SL7", reference:"samba-pidl-4.9.1-6.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"samba-pidl-4.9.1-6.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"samba-python-4.9.1-6.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"samba-python-test-4.9.1-6.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"samba-test-4.9.1-6.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"samba-test-libs-4.9.1-6.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"samba-vfs-glusterfs-4.9.1-6.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"samba-winbind-4.9.1-6.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"samba-winbind-clients-4.9.1-6.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"samba-winbind-krb5-locator-4.9.1-6.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"samba-winbind-modules-4.9.1-6.el7")) flag++;
