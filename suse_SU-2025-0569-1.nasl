...
# SUSE update advisory SUSE-SU-2025:0569-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2025:0569-1");

  script_name(english:"SUSE SLES12 Security Update : ucode-intel (SUSE-SU-2025:0569-1)");
...
the SUSE-SU-2025:0569-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2025-February/020362.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c2d15e11");
...
var pkgs = [
    {'reference':'ucode-intel-20250211-149.2', 'sp':'5', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-ltss-extended-security-release-12.5']},
    {'reference':'ucode-intel-20250211-149.2', 'sp':'5', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.5']}
];
