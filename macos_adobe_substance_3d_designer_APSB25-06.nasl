...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2025-A-0027-S");

  script_name(english:"Adobe Substance 3D Designer 14.1 Multiple Vulnerabilities (APSB25-06)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Substance 3D Designer installed on the remote host is prior to 14.1. It is, therefore, affected by
multiple vulnerabilities as referenced in the APSB25-06 advisory.

  - Substance3D - Designer versions 14.0 and earlier are affected by an out-of-bounds write vulnerability that
    could result in arbitrary code execution in the context of the current user. Exploitation of this issue
    requires user interaction in that a victim must open a malicious file. (CVE-2025-21136, CVE-2025-21138)
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cfa9eb84");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Adobe Substance 3D Designer version 14.1 or later.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:N/UI:R/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-21139");
