...
# extracted from Red Hat Security Advisory jsoup. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2021-37714", "CVE-2022-36033");

  script_name(english:"RHEL 8 : jsoup (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2022-36033");
