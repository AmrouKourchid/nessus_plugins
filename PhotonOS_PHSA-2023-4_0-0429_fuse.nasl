...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Fuse PHSA-2023-4.0-0429");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'fuse-overlayfs-snapshotter-1.0.6-1.ph4')) flag++;
