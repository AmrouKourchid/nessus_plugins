...
# extracted from Mozilla Foundation Security Advisory mfsa2025-24.
...
if (description)
{
  ...
  script_name(english:"Mozilla Thunderbird ESR < 128.9");

  script_set_attribute(attribute:"synopsis", value:
"A mail client installed on the remote macOS or Mac OS X host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Thunderbird ESR installed on the remote macOS or Mac OS X host is prior to 128.9. It is, therefore,
affected by multiple vulnerabilities as referenced in the mfsa2025-24 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2025-24/");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Mozilla Thunderbird ESR version 128.9 or later.");
...
mozilla_check_version(version:version, path:path, product:'thunderbird', esr:TRUE, fix:'128.9', min:'128.0.0', severity:SECURITY_HOLE);
