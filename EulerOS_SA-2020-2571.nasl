...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : zziplib (EulerOS-SA-2020-2571)");
...
vulnerabilities :
  ...
  - In ZZIPlib 0.13.67, 0.13.66, 0.13.65, 0.13.64 and
    0.13.63 there is a segmentation fault caused by invalid
    memory access in the zzip_disk_fread function
    (zzip/mmapped.c) because the size variable is not
    validated against the amount of file->stored
    data.(CVE-2018-6381)
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2571
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?aa57131f");
...
"Update the affected zziplib packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-6540");
...
pkgs = ["zziplib-0.13.62-11.h1.eulerosv2r7"];
