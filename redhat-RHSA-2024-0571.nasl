...
# extracted from Red Hat Security Advisory RHSA-2024:0571. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:0571");

  script_name(english:"RHEL 8 : tcpdump (RHSA-2024:0571)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0571.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ebb1bd51");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2040392");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0571");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL tcpdump package based on the guidance in RHSA-2024:0571.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'tcpdump-4.9.3-3.el8_8.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'14'}
    ]
  }
];
