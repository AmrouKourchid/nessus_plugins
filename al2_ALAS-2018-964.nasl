...
# extracted from Amazon Linux 2 Security Advisory ALAS-2018-964.
#
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : memcached (ALAS-2018-964)");
...
response to the target. (CVE-2018-1000115)");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2018-964.html");
...
flag = 0;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"memcached-1.4.15-10.amzn2.1.1")) flag++;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"memcached-debuginfo-1.4.15-10.amzn2.1.1")) flag++;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"memcached-devel-1.4.15-10.amzn2.1.1")) flag++;
