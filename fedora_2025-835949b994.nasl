...
# extracted from Fedora Security Advisory FEDORA-2025-835949b994
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-835949b994");

  script_name(english:"Fedora 41 : proftpd (2025-835949b994)");
...
FEDORA-2025-835949b994 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-835949b994");
...
var pkgs = [
    {'reference':'proftpd-1.3.8c-3.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
