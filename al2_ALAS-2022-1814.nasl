...
vulnerabilities as referenced in the ALAS2-2022-1814 advisory.
    ...
    A flaw was found in libtiff-4.0.3-35.amzn2.0.1 as packaged on Amazon Linux 2. When processing a malicious
    TIFF file, an invalid range may be passed as an argument to the memset() function within
    TIFFFetchStripThing() in tif_dirread.c. This will cause TIFFFetchStripThing() to segfault. Actors can use
    this issue to potentially cause a Denial of Service condition. (CVE-2022-34266)
...
"Run 'yum update libtiff' to update your system.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2022-34266");
