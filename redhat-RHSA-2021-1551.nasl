...
"The remote Red Hat host is missing one or more security updates for OpenShift Container Platform 4.7.11.");
...
referenced in the RHSA-2021:1551 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.7.11. See the following
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_1551.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8c510955");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1959660");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.7.11 package based on the guidance in RHSA-2021:1551.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cri-tools-1.20.0-2.el8', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2020-28362', 'CVE-2021-3114']},
      {'reference':'cri-tools-1.20.0-2.el8', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2020-28362', 'CVE-2021-3114']},
      {'reference':'cri-tools-1.20.0-2.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2020-28362', 'CVE-2021-3114']},
      {'reference':'jenkins-2.277.3.1620393611-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2021-21639', 'CVE-2021-21640', 'CVE-2021-28163', 'CVE-2021-28165']},
      {'reference':'runc-1.0.0-95.rhaos4.8.gitcd80260.el8', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2020-28362', 'CVE-2021-3114', 'CVE-2021-28163', 'CVE-2021-28165']},
      {'reference':'runc-1.0.0-95.rhaos4.8.gitcd80260.el8', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2020-28362', 'CVE-2021-3114', 'CVE-2021-28163', 'CVE-2021-28165']},
      {'reference':'runc-1.0.0-95.rhaos4.8.gitcd80260.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2020-28362', 'CVE-2021-3114', 'CVE-2021-28163', 'CVE-2021-28165']}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'cri-tools-1.20.0-2.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2020-28362', 'CVE-2021-3114']},
      {'reference':'runc-1.0.0-95.rhaos4.8.gitcd80260.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2020-28362', 'CVE-2021-3114', 'CVE-2021-28163', 'CVE-2021-28165']}
    ]
  }
];
