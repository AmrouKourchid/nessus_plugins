...
# extracted from Fedora Security Advisory FEDORA-2023-5210df1dd1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-5210df1dd1");

  script_name(english:"Fedora 37 : webkitgtk (2023-5210df1dd1)");
...
FEDORA-2023-5210df1dd1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-5210df1dd1");
...
var pkgs = [
    {'reference':'webkitgtk-2.38.4-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
