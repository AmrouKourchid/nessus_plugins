...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2019-A-0332-S");
...
var version, path, prod, runtime_dll_ver, runtime_dll_path;
...
foreach var install (installs[1])
{
  ...
  {
    foreach var name (get_kb_list('SMB/Registry/HKLM/SOFTWARE/Microsoft/Windows/CurrentVersion/Uninstall/*/DisplayName'))
    if ('4513696' >< name)
