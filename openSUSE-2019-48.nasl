...
issues and bugs.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1121396");
...
if ( rpm_check(release:"SUSE15.0", reference:"irssi-1.1.2-lp150.2.4.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"irssi-debuginfo-1.1.2-lp150.2.4.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"irssi-debugsource-1.1.2-lp150.2.4.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"irssi-devel-1.1.2-lp150.2.4.1") ) flag++;
