...
# extracted from Red Hat Security Advisory RHSA-2022:6602. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:6602");

  script_name(english:"RHEL 9 : gnupg2 (RHSA-2022:6602)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_6602.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9a3d1fb9");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:6602");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2102868");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL gnupg2 package based on the guidance in RHSA-2022:6602.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gnupg2-2.3.3-2.el9_0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gnupg2-smime-2.3.3-2.el9_0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'gnupg2-2.3.3-2.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gnupg2-smime-2.3.3-2.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
