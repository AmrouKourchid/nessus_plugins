...
# extracted from Fedora Security Advisory FEDORA-2025-76012a9a99
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-76012a9a99");

  script_name(english:"Fedora 40 : golang-github-nvidia-container-toolkit (2025-76012a9a99)");
...
FEDORA-2025-76012a9a99 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-76012a9a99");
...
var pkgs = [
    {'reference':'golang-github-nvidia-container-toolkit-1.17.3-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
