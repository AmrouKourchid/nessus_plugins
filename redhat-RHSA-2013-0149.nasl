...
# extracted from Red Hat Security Advisory RHSA-2013:0149. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2013:0149");

  script_name(english:"RHEL 5 / 6 : flash-plugin (RHSA-2013:0149)");
...
in the RHSA-2013:0149 advisory.

  - flash-plugin: buffer overflow flaw that can lead to arbitrary code execution (APSB13-01) (CVE-2013-0630)
...
number.");
  ...
  # https://access.redhat.com/security/data/csaf/v2/advisories/2013/rhsa-2013_0149.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7fedec61");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2013:0149");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#critical");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=893223");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL flash-plugin package based on the guidance in RHSA-2013:0149.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'flash-plugin-11.2.202.261-1.el6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'flash-plugin-11.2.202.261-1.el5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
