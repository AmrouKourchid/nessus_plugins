...
# extracted from Red Hat Security Advisory containernetworking_plugins. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 8 : containernetworking_plugins (Unpatched Vulnerability) (deprecated)");
