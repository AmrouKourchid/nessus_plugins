...
# extracted from openSUSE Security Update openSUSE-2020-2097.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : LibVNCServer (openSUSE-2020-2097)");
...
"This update for LibVNCServer fixes the following issues :
  ...
  - CVE-2020-25708 [bsc#1178682], libvncserver/rfbserver.c
    has a divide by zero which could result in DoS

This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1178682");
...
if ( rpm_check(release:"SUSE15.1", reference:"LibVNCServer-debugsource-0.9.10-lp151.7.12.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"LibVNCServer-devel-0.9.10-lp151.7.12.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libvncclient0-0.9.10-lp151.7.12.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libvncclient0-debuginfo-0.9.10-lp151.7.12.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libvncserver0-0.9.10-lp151.7.12.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libvncserver0-debuginfo-0.9.10-lp151.7.12.1") ) flag++;
