...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Ntp PHSA-2020-3.0-0093");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'ntp-4.2.8p14-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'ntp-perl-4.2.8p14-1.ph3')) flag++;
