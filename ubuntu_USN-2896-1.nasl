...
# extracted from Ubuntu Security Notice USN-2896-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"2896-1");

  script_name(english:"Ubuntu 14.04 LTS : Libgcrypt vulnerability (USN-2896-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2896-1");
...
"Update the affected libgcrypt11, libgcrypt11-dev and / or libgcrypt11-udeb packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-7511");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'libgcrypt11', 'pkgver': '1.5.3-2ubuntu4.3'},
    {'osver': '14.04', 'pkgname': 'libgcrypt11-dev', 'pkgver': '1.5.3-2ubuntu4.3'},
    {'osver': '14.04', 'pkgname': 'libgcrypt11-udeb', 'pkgver': '1.5.3-2ubuntu4.3'}
];
