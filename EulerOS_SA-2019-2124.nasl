...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : zziplib (EulerOS-SA-2019-2124)");
...
vulnerabilities :
  ...
  - Directory traversal vulnerability in ZZIPlib 0.13.69
    ...
    unzzip_cat in the bins/unzzipcat-mem.c
    file.(CVE-2018-17828)
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2124
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?746d7ce5");
...
pkgs = ["zziplib-0.13.69-1.h2.eulerosv2r8"];
