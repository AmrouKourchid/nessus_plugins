...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : c-ares (EulerOS-SA-2024-2824)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2824
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7a722234");
...
var pkgs = [
  "c-ares-1.16.0-1.h9.eulerosv2r9"
];
