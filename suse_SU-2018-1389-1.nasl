...
# extracted from SUSE update advisory SUSE-SU-2018:1389-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES11 Security Update : kvm (SUSE-SU-2018:1389-1) (Spectre)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"This update for kvm fixes the following issues: This security issue
was fixed :
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?38c85371");
...
flag = 0;
if (rpm_check(release:"SLES11", sp:"3", reference:"kvm-1.4.2-53.20.1")) flag++;
