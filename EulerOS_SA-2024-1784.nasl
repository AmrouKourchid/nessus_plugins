...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : dnsmasq (EulerOS-SA-2024-1784)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1784
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?78ad50fe");
...
var pkgs = [
  "dnsmasq-2.86-1.h15.eulerosv2r11"
];
