...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : openslp on SL7.x x86_64 (20180723)");
...
"Security Fix(es) :
  ...
  - openslp: Heap memory corruption in slpd/slpd_process.c
    ...
    (CVE-2017-17833)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1807&L=scientific-linux-errata&F=&S=&P=9294
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?01f89ccd");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"openslp-2.0.0-7.el7_5")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"openslp-debuginfo-2.0.0-7.el7_5")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"openslp-devel-2.0.0-7.el7_5")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"openslp-server-2.0.0-7.el7_5")) flag++;
