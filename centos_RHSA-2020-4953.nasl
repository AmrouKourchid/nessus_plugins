...
# extracted from Red Hat Security Advisory RHSA-2020:4953 and
# CentOS Errata and Security Advisory 2020:4953 respectively.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : xorg-x11-server (RHSA-2020:4953)");
...
var pkgs = [
    {'reference':'xorg-x11-server-common-1.17.4-18.el6.centos', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xorg-x11-server-devel-1.17.4-18.el6.centos', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xorg-x11-server-source-1.17.4-18.el6.centos', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xorg-x11-server-Xdmx-1.17.4-18.el6.centos', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xorg-x11-server-Xephyr-1.17.4-18.el6.centos', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xorg-x11-server-Xnest-1.17.4-18.el6.centos', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xorg-x11-server-Xorg-1.17.4-18.el6.centos', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xorg-x11-server-Xvfb-1.17.4-18.el6.centos', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE}
];
