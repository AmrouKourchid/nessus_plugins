...
# extracted from Fedora Security Advisory FEDORA-2019-19b1d53695.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : kf5-kauth (2019-19b1d53695)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-19b1d53695");
  script_set_attribute(attribute:"solution", value:
"Update the affected kf5-kauth package.");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"kf5-kauth-5.54.0-2.fc29")) flag++;
