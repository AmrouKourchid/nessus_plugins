...
# extracted from Fedora Security Advisory FEDORA-2023-e679ea4fa2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-e679ea4fa2");

  script_name(english:"Fedora 36 : libheif (2023-e679ea4fa2)");
...
FEDORA-2023-e679ea4fa2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-e679ea4fa2");
...
"Update the affected libheif package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:libheif");
...
var pkgs = [
    {'reference':'libheif-1.15.2-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libheif');
}
