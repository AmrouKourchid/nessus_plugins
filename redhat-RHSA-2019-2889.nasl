...
# extracted from Red Hat Security Advisory RHSA-2019:2889. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:2889");

  script_name(english:"RHEL 7 : redhat-virtualization-host (RHSA-2019:2889)");
...
the RHSA-2019:2889 advisory.

    The redhat-virtualization-host packages provide the Red Hat Virtualization Host. Red Hat Virtualization
    ...
    (4.3.5), redhat-virtualization-host (4.3.5). (BZ#1751436, BZ#1754063)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_2889.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4d0efd20");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1754063");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:2889");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL redhat-virtualization-host package based on the guidance in RHSA-2019:2889.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'redhat-virtualization-host-image-update-4.3.5-20190920.0.el7_7', 'release':'7', 'el_string':'el7_7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'}
    ]
  }
];
