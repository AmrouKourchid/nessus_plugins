...
# extracted from Fedora Security Advisory FEDORA-2023-822aab0a5a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-822aab0a5a");
  script_xref(name:"IAVB", value:"2023-B-0080-S");
  script_xref(name:"CEA-ID", value:"CEA-2024-0004");

  script_name(english:"Fedora 39 : golang (2023-822aab0a5a)");
...
FEDORA-2023-822aab0a5a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-822aab0a5a");
...
var pkgs = [
    {'reference':'golang-1.21.3-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
