...
# extracted from openSUSE Security Update openSUSE-2019-1163.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : ldb (openSUSE-2019-1163)");
...
Security issue fixed :
  ...
  - CVE-2019-3824: Fixed an out-of-bound read vulnerability
    in ldb_wildcard_compare (bsc#1125410).

This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1125410");
  script_set_attribute(attribute:"solution", value:
"Update the affected ldb packages.");
...
if ( rpm_check(release:"SUSE15.0", reference:"ldb-debugsource-1.2.3-lp150.7.2") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"ldb-tools-1.2.3-lp150.7.2") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"ldb-tools-debuginfo-1.2.3-lp150.7.2") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libldb-devel-1.2.3-lp150.7.2") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libldb1-1.2.3-lp150.7.2") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libldb1-debuginfo-1.2.3-lp150.7.2") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"python-ldb-1.2.3-lp150.7.2") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"python-ldb-debuginfo-1.2.3-lp150.7.2") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"python-ldb-devel-1.2.3-lp150.7.2") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"python3-ldb-1.2.3-lp150.7.2") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"python3-ldb-debuginfo-1.2.3-lp150.7.2") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"python3-ldb-devel-1.2.3-lp150.7.2") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libldb1-32bit-1.2.3-lp150.7.2") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libldb1-32bit-debuginfo-1.2.3-lp150.7.2") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"python-ldb-32bit-1.2.3-lp150.7.2") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"python-ldb-32bit-debuginfo-1.2.3-lp150.7.2") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"python3-ldb-32bit-1.2.3-lp150.7.2") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"python3-ldb-32bit-debuginfo-1.2.3-lp150.7.2") ) flag++;
