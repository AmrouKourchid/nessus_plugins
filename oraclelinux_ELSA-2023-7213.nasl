...
# extracted from Oracle Linux Security Advisory ELSA-2023-7213.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : squid:4 (ELSA-2023-7213)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ELSA-2023-7213 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-7213.html");
...
var appstreams = {
    'squid:4': [
      ...
      {'reference':'squid-4.15-7.module+el8.9.0+90083+f7556140.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      ...
      {'reference':'squid-4.15-7.module+el8.9.0+90083+f7556140.1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
    ]
};
