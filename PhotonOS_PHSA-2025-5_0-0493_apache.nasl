...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Apache PHSA-2025-5.0-0493");
...
if (rpm_check(release:'PhotonOS-5.0', reference:'apache-tomcat9-9.0.98-2.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', reference:'apache-tomcat9-webapps-9.0.98-2.ph5')) flag++;
