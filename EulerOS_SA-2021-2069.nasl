...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.2.0 : ruby (EulerOS-SA-2021-2069)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2069
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6731d3e2");
...
pkgs = ["ruby-2.0.0.648-33.h30",
        "ruby-irb-2.0.0.648-33.h30",
        "ruby-libs-2.0.0.648-33.h30",
        "rubygem-bigdecimal-1.2.0-33.h30",
        "rubygem-io-console-0.4.2-33.h30",
        "rubygem-json-1.7.7-33.h30",
        "rubygem-psych-2.0.0-33.h30",
        "rubygem-rdoc-4.0.0-33.h30",
        "rubygems-2.0.14.1-33.h30"];
