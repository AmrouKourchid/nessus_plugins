...
# extracted from VMware Security Advisory PHSA-2025-4.0-0746. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2023-6228");

  script_name(english:"Photon OS 4.0: Libtiff PHSA-2025-4.0-0746");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the libtiff package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-746.md");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-6228");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libtiff-4.5.1-6.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libtiff-devel-4.5.1-6.ph4')) flag++;
