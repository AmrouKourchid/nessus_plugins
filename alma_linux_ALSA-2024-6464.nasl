...
# AlmaLinux Security Advisory ALSA-2024:6464.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:6464");

  script_name(english:"AlmaLinux 9 : glib2 (ALSA-2024:6464)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2024-6464.html");
...
var pkgs = [
    {'reference':'glib2-2.68.4-14.el9_4.1', 'release':'9', 'el_string':'el9_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'glib2-devel-2.68.4-14.el9_4.1', 'release':'9', 'el_string':'el9_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'glib2-doc-2.68.4-14.el9_4.1', 'release':'9', 'el_string':'el9_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'glib2-static-2.68.4-14.el9_4.1', 'release':'9', 'el_string':'el9_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'glib2-tests-2.68.4-14.el9_4.1', 'release':'9', 'el_string':'el9_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'}
];
