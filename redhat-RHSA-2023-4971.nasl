...
# extracted from Red Hat Security Advisory RHSA-2023:4971. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2023-23931", "CVE-2023-40267");
  script_xref(name:"RHSA", value:"2023:4971");

  script_name(english:"RHEL 8 / 9 : Red Hat Ansible Automation Platform 2.4 Product Security and Bug Fix Update (Moderate) (RHSA-2023:4971)");
...
referenced in the RHSA-2023:4971 advisory.
    ...
    * automation-controller: GitPython: Insecure non-multi options in clone and clone_from is not blocked
    (CVE-2023-40267)
    * python3-gitpython/python39-gitpython: Insecure non-multi options in clone and clone_from is not blocked
    (CVE-2023-40267)
    ...
    * automation controller: Fix bug that can cause a deadlock on shutdown when redis is unavailable.
    (AAP-14203)
    * automation controller: The login form no longer supports autocomplete on the password field due to
    security concerns. (AAP-15545)

Tenable has extracted the preceding description block directly from the Red Hat Enterprise Linux security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_4971.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c6e5ca18");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:4971");
  script_set_attribute(attribute:"solution", value:
"Update the affected automation-controller-venv-tower, python3-gitpython and / or python39-gitpython packages.");
  ...
  script_set_attribute(attribute:"cvss4_score_source", value:"CVE-2023-23931");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'automation-controller-venv-tower-4.4.3-1.el8ap', 'release':'8', 'el_string':'el8ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.4', 'cves':['CVE-2023-23931', 'CVE-2023-40267']},
      {'reference':'python39-gitpython-3.1.32-1.el8ap', 'release':'8', 'el_string':'el8ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.4', 'cves':['CVE-2023-40267']}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'automation-controller-venv-tower-4.4.3-1.el9ap', 'release':'9', 'el_string':'el9ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.4', 'cves':['CVE-2023-23931', 'CVE-2023-40267']},
      {'reference':'python3-gitpython-3.1.32-1.el9ap', 'release':'9', 'el_string':'el9ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.4', 'cves':['CVE-2023-40267']}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'automation-controller-venv-tower / python3-gitpython / etc');
}
