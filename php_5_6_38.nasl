...
if (description)
{
  ...
  script_name(english:"PHP 5.6.x < 5.6.38 Transfer-Encoding Parameter XSS Vulnerability");
...
server is 5.6.x prior to 5.6.38. It is, therefore, affected by
...
security context of the affected site.");
  script_set_attribute(attribute:"see_also", value:"http://php.net/ChangeLog-5.php#5.6.38");
