...
# extracted from Fedora Security Advisory FEDORA-2024-e8b9bedd36
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-e8b9bedd36");

  script_name(english:"Fedora 38 : djvulibre (2024-e8b9bedd36)");
...
FEDORA-2024-e8b9bedd36 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-e8b9bedd36");
...
var pkgs = [
    {'reference':'djvulibre-3.5.28-6.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
