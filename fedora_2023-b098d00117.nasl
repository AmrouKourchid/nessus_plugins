...
# extracted from Fedora Security Advisory FEDORA-2023-b098d00117
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-b098d00117");

  script_name(english:"Fedora 38 : chromium (2023-b098d00117)");
...
FEDORA-2023-b098d00117 advisory.

    update to 113.0.5672.64. Fixes the following security issues:

    CVE-2023-2459 CVE-2023-2460 CVE-2023-2461 CVE-2023-2462 CVE-2023-2463 CVE-2023-2464 CVE-2023-2465
    CVE-2023-2466 CVE-2023-2467 CVE-2023-2468

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-b098d00117");
...
var pkgs = [
    {'reference':'chromium-113.0.5672.63-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
