...
# extracted from Oracle Linux Security Advisory ELSA-2022-9204.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : python-pip (ELSA-2022-9204)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2022-9204.html");
...
var pkgs = [
    {'reference':'python3-pip-9.0.3-8.0.1.el7', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
];
