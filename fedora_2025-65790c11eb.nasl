...
# extracted from Fedora Security Advisory FEDORA-2025-65790c11eb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-65790c11eb");
  script_xref(name:"IAVA", value:"2025-A-0123-S");

  script_name(english:"Fedora 41 : libxml2 (2025-65790c11eb)");
...
FEDORA-2025-65790c11eb advisory.

    Update to 2.12.10

    Fix CVE-2024-56171 and CVE-2025-24928.

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-65790c11eb");
...
var pkgs = [
    {'reference':'libxml2-2.12.10-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
