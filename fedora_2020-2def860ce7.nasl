...
# extracted from Fedora Security Advisory FEDORA-2020-2def860ce7.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : claws-mail (2020-2def860ce7)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-2def860ce7");
...
flag = 0;
if (rpm_check(release:"FC32", reference:"claws-mail-3.17.6-1.fc32")) flag++;
