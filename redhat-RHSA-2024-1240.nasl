...
# extracted from Red Hat Security Advisory RHSA-2024:1240. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:1240");
  script_xref(name:"IAVB", value:"2024-B-0009-S");

  script_name(english:"RHEL 9 : postgresql (RHSA-2024:1240)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_1240.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cd03bd5a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2263384");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:1240");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL postgresql package based on the guidance in RHSA-2024:1240.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'postgresql-13.14-1.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-contrib-13.14-1.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-plperl-13.14-1.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-plpython3-13.14-1.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-pltcl-13.14-1.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-private-devel-13.14-1.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-private-libs-13.14-1.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-server-13.14-1.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-server-devel-13.14-1.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-test-13.14-1.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-upgrade-13.14-1.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
