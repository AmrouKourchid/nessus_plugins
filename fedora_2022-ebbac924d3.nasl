...
# extracted from Fedora Security Advisory FEDORA-2022-ebbac924d3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-ebbac924d3");

  script_name(english:"Fedora 35 : exim (2022-ebbac924d3)");
...
FEDORA-2022-ebbac924d3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-ebbac924d3");
...
var pkgs = [
    {'reference':'exim-4.96-5.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
