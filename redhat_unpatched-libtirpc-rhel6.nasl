...
# extracted from Red Hat Security Advisory libtirpc. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2018-14622", "CVE-2021-46828");

  script_name(english:"RHEL 6 : libtirpc (Unpatched Vulnerability) (deprecated)");
...
"This plugin has been deprecated as it does not adhere to established standards for this style of check.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2021-46828");
