...
if (description)
{
  ...
  script_name(english:"Adobe Digital Editions < 3.0 (APSB14-03) (macOS)");

  script_set_attribute(attribute:"synopsis", value:
"The Adobe Digital Editions instance installed on the remote host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Digital Editions installed on the remote macOS host is prior to 3.0. It is, therefore, affected by
a vulnerability as referenced in the APSB14-03 advisory.
