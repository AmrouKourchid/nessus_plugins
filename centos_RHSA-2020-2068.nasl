...
# extracted from Red Hat Security Advisory RHSA-2020:2068.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : python-pip (RHSA-2020:2068)");
...
var pkgs = [
    {'reference':'python3-pip-9.0.3-7.el7_7', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE}
];
