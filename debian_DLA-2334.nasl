...
# extracted from Debian Security Advisory DLA-2334-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2334-1 : ruby-websocket-extensions security update");
...
For the detailed security status of ruby-websocket-extensions please
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2020/08/msg00031.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/stretch/ruby-websocket-extensions");
  # https://security-tracker.debian.org/tracker/source-package/ruby-websocket-extensions
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e9b63587");
  script_set_attribute(attribute:"solution", value:
"Upgrade the affected ruby-websocket-extensions package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:ruby-websocket-extensions");
...
flag = 0;
if (deb_check(release:"9.0", prefix:"ruby-websocket-extensions", reference:"0.1.2-1+deb9u1")) flag++;
