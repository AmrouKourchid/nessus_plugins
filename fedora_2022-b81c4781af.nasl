...
# extracted from Fedora Security Advisory FEDORA-2022-b81c4781af
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-b81c4781af");

  script_name(english:"Fedora 36 : weechat (2022-b81c4781af)");
...
FEDORA-2022-b81c4781af advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-b81c4781af");
...
var pkgs = [
    {'reference':'weechat-3.6-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
