...
# extracted from Fedora Security Advisory FEDORA-2025-0cb4a35438
#
...
if (description)
{
  ...
  script_cve_id("CVE-2024-54479");
  script_xref(name:"FEDORA", value:"2025-0cb4a35438");

  script_name(english:"Fedora 41 : webkit2gtk4.0 (2025-0cb4a35438)");
...
FEDORA-2025-0cb4a35438 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-0cb4a35438");
...
"Update the affected webkit2gtk4.0 package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-54479");
...
var pkgs = [
    {'reference':'webkit2gtk4.0-2.46.5-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
