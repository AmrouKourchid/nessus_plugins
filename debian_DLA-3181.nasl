...
# extracted from Debian Security Advisory dla-3181. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3181 : sudo - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3181
advisory.

    - -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3181-1                debian-lts@lists.debian.org
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2021-23239");
...
"Upgrade the sudo packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-23239");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'sudo', 'reference': '1.8.27-1+deb10u4'},
    {'release': '10.0', 'prefix': 'sudo-ldap', 'reference': '1.8.27-1+deb10u4'}
];
