...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Curl PHSA-2024-5.0-0345");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'curl-8.7.1-3.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'curl-devel-8.7.1-3.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'curl-libs-8.7.1-3.ph5')) flag++;
