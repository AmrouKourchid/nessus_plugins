...
# extracted from Fedora Security Advisory FEDORA-2023-957972e77c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-957972e77c");

  script_name(english:"Fedora 39 : matrix-synapse (2023-957972e77c)");
...
FEDORA-2023-957972e77c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-957972e77c");
...
var pkgs = [
    {'reference':'matrix-synapse-1.95.1-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
