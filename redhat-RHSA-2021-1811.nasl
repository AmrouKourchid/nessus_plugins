...
# extracted from Red Hat Security Advisory RHSA-2021:1811. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:1811");

  script_name(english:"RHEL 8 : libvncserver (RHSA-2021:1811)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for libvncserver.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2021:1811 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_1811.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5b2d223f");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/8.4_release_notes/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?862005a9");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:1811");
...
"Update the RHEL libvncserver package based on the guidance in RHSA-2021:1811.");
  ...
  script_cwe_id(119, 120, 200, 369, 770);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libvncserver-0.9.11-17.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvncserver-devel-0.9.11-17.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
