...
# extracted from Red Hat Security Advisory RHSA-2024:1801. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:1801");

  script_name(english:"RHEL 9 : unbound (RHSA-2024:1801)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for unbound.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:1801 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_1801.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a13bc7f2");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:1801");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-unbound-1.13.1-13.el9_0.4', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'unbound-1.13.1-13.el9_0.4', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'unbound-libs-1.13.1-13.el9_0.4', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python3-unbound / unbound / unbound-libs');
}
