...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : Moderate: / kdelibs (ELSA-2007-0909)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2007-0909.html");
...
var pkgs = [
    {'reference':'kdelibs-3.5.4-13.el5.0.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'6'},
    {'reference':'kdelibs-apidocs-3.5.4-13.el5.0.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'6'},
    {'reference':'kdelibs-devel-3.5.4-13.el5.0.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'6'},
    {'reference':'kdelibs-3.5.4-13.el5.0.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'6'},
    {'reference':'kdelibs-apidocs-3.5.4-13.el5.0.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'6'},
    {'reference':'kdelibs-devel-3.5.4-13.el5.0.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'6'}
];
