...
# extracted from Fedora Security Advisory FEDORA-2024-15039ba9f9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-15039ba9f9");

  script_name(english:"Fedora 40 : kitty (2024-15039ba9f9)");
...
FEDORA-2024-15039ba9f9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-15039ba9f9");
...
var pkgs = [
    {'reference':'kitty-0.35.1-4.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
