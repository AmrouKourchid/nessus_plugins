...
# extracted from Amazon Linux 2023 Security Advisory ALAS2023-2023-338.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2022-41723", "CVE-2023-29406", "CVE-2023-29409");
  ...
  script_name(english:"Amazon Linux 2023 : cni-plugins (ALAS2023-2023-338)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2023/ALAS-2023-338.html");
...
"Run 'dnf update cni-plugins --releasever 2023.1.20230906' to update your system.");
...
var pkgs = [
    {'reference':'cni-plugins-1.2.0-1.amzn2023.0.2', 'cpu':'aarch64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cni-plugins-1.2.0-1.amzn2023.0.2', 'cpu':'x86_64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cni-plugins-debuginfo-1.2.0-1.amzn2023.0.2', 'cpu':'aarch64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cni-plugins-debuginfo-1.2.0-1.amzn2023.0.2', 'cpu':'x86_64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cni-plugins-debugsource-1.2.0-1.amzn2023.0.2', 'cpu':'aarch64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cni-plugins-debugsource-1.2.0-1.amzn2023.0.2', 'cpu':'x86_64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE}
];
