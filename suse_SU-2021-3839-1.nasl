...
# SUSE update advisory SUSE-SU-2021:3839-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2021:3839-1");

  script_name(english:"SUSE SLED15 / SLES15 Security Update : python-Pygments (SUSE-SU-2021:3839-1)");
...
the SUSE-SU-2021:3839-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2021-December/009805.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8d2a91da");
...
var pkgs = [
    {'reference':'python3-Pygments-2.6.1-4.3.1', 'sp':'3', 'release':'SLED15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-basesystem-release-15.3']},
    {'reference':'python3-Pygments-2.6.1-4.3.1', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-basesystem-release-15.3']}
];
