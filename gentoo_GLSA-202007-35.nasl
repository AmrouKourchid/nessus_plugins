...
# extracted from Gentoo Linux Security Advisory GLSA 202007-35.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202007-35");

  script_name(english:"GLSA-202007-35 : ReportLab: Arbitrary code execution");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202007-35
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202007-35");
...
"All ReportLab users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:reportlab");
...
if (qpkg_check(package:"dev-python/reportlab", unaffected:make_list("ge 3.5.42"), vulnerable:make_list("lt 3.5.42"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "ReportLab");
}
