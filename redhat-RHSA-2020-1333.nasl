...
# extracted from Red Hat Security Advisory RHSA-2020:1333. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:1333");

  script_name(english:"RHEL 7 : ksh (RHSA-2020:1333)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for ksh.");
...
the RHSA-2020:1333 advisory.

    KornShell (ksh) is a Unix shell developed by AT&T Bell Laboratories, which is backward-compatible with the
    Bourne shell (sh) and includes many features of the C shell. The most recent version is KSH-93. KornShell
    complies with the POSIX.2 standard (IEEE Std 1003.2-1992).

    Security Fix(es):

    * ksh: certain environment variables interpreted as arithmetic expressions on startup, leading to code
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_1333.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?35fc90f0");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:1333");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1757324");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL ksh package based on the guidance in RHSA-2020:1333.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ksh-20120801-140.el7_6', 'sp':'6', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ksh-20120801-140.el7_6', 'sp':'6', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ksh-20120801-140.el7_6', 'sp':'6', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ksh-20120801-140.el7_6', 'sp':'6', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'ksh-20120801-140.el7_6', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ksh-20120801-140.el7_6', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ksh-20120801-140.el7_6', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ksh-20120801-140.el7_6', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
