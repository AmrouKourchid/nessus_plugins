...
# extracted from Fedora Security Advisory FEDORA-2024-698e541c52
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-698e541c52");

  script_name(english:"Fedora 38 : libmodsecurity (2024-698e541c52)");
...
FEDORA-2024-698e541c52 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-698e541c52");
...
var pkgs = [
    {'reference':'libmodsecurity-3.0.12-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
