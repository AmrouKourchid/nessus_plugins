...
# extracted from Red Hat Security Advisory RHSA-2023:1583. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 8 : nodejs:18 (RHSA-2023:1583)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2023:1583 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_1583.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?03899f5b");
...
"Update the affected packages.");
  ...
  script_cwe_id(93, 400, 426, 863, 1333);
  ...
  'nodejs:18': [
    {
      ...
      'pkgs': [
        {'reference':'nodejs-18.14.2-2.module+el8.7.0+18445+9493b6ea', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-devel-18.14.2-2.module+el8.7.0+18445+9493b6ea', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-docs-18.14.2-2.module+el8.7.0+18445+9493b6ea', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-full-i18n-18.14.2-2.module+el8.7.0+18445+9493b6ea', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-nodemon-2.0.20-2.module+el8.7.0+18445+9493b6ea', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'npm-9.5.0-1.18.14.2.2.module+el8.7.0+18445+9493b6ea', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
      ]
    }
  ]
};
