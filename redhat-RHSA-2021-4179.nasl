...
# extracted from Red Hat Security Advisory RHSA-2021:4179. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:4179");

  script_name(english:"RHEL 8 : file-roller (RHSA-2021:4179)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for file-roller.");
...
the RHSA-2021:4179 advisory.
    ...
    * file-roller: directory traversal via directory symlink pointing outside of the target directory
    (incomplete fix for CVE-2020-11736) (CVE-2020-36314)
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_4179.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f394de34");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:4179");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1947534");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL file-roller package based on the guidance in RHSA-2021:4179.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'file-roller-3.28.1-4.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
