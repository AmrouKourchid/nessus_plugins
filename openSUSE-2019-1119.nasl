...
# extracted from openSUSE Security Update openSUSE-2019-1119.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : ghostscript (openSUSE-2019-1119)");

  script_set_attribute(attribute:"synopsis", value:
"The remote openSUSE host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"This update for ghostscript fixes the following issue: &#9; Security
issue fixed :
...
if ( rpm_check(release:"SUSE42.3", reference:"ghostscript-9.26a-14.18.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"ghostscript-debuginfo-9.26a-14.18.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"ghostscript-debugsource-9.26a-14.18.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"ghostscript-devel-9.26a-14.18.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"ghostscript-mini-9.26a-14.18.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"ghostscript-mini-debuginfo-9.26a-14.18.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"ghostscript-mini-debugsource-9.26a-14.18.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"ghostscript-mini-devel-9.26a-14.18.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"ghostscript-x11-9.26a-14.18.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"ghostscript-x11-debuginfo-9.26a-14.18.1") ) flag++;
