...
if (description)
{
  ...
  script_name(english:"CentOS 9 : zlib-1.2.11-34.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing one or more security updates for minizip-compat.");
...
zlib-1.2.11-34.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=24814");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream minizip-compat package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:minizip-compat");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:minizip-compat-devel");
...
var pkgs = [
    {'reference':'minizip-compat-1.2.11-34.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'minizip-compat-devel-1.2.11-34.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'zlib-1.2.11-34.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'zlib-devel-1.2.11-34.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'zlib-static-1.2.11-34.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'minizip-compat / minizip-compat-devel / zlib / zlib-devel / etc');
}
