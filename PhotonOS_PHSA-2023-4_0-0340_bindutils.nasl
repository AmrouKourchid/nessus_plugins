...
# extracted from VMware Security Advisory PHSA-2023-4.0-0340. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Bindutils PHSA-2023-4.0-0340");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the bindutils package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-340.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'bindutils-9.16.38-1.ph4')) flag++;
