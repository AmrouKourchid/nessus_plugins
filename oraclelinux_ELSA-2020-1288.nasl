...
# extracted from Red Hat Security Advisory RHSA-2020:1288 and 
# Oracle Linux Security Advisory ELSA-2020-1288 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : haproxy (ELSA-2020-1288)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2020-1288.html");
...
var pkgs = [
    {'reference':'haproxy-1.8.15-6.el8_1.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'haproxy-1.8.15-6.el8_1.1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
