...
# extracted from Red Hat Security Advisory RHSA-2024:4077. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:4077");

  script_name(english:"RHEL 9 : python3.11 (RHSA-2024:4077)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4a3c477f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:4077");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python3.11 package based on the guidance in RHSA-2024:4077.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3.11-3.11.7-1.el9_4.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.11-debug-3.11.7-1.el9_4.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.11-devel-3.11.7-1.el9_4.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.11-idle-3.11.7-1.el9_4.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.11-libs-3.11.7-1.el9_4.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.11-test-3.11.7-1.el9_4.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.11-tkinter-3.11.7-1.el9_4.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'python3.11-3.11.7-1.el9_4.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.11-debug-3.11.7-1.el9_4.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.11-devel-3.11.7-1.el9_4.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.11-idle-3.11.7-1.el9_4.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.11-libs-3.11.7-1.el9_4.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.11-test-3.11.7-1.el9_4.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.11-tkinter-3.11.7-1.el9_4.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
