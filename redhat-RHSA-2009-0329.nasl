...
if (description)
{
  ...
  script_name(english:"RHEL 4 : freetype (RHSA-2009:0329)");
...
referenced in the RHSA-2009:0329 advisory.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2009/rhsa-2009_0329.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4e730a69");
  script_set_attribute(attribute:"see_also", value:"http://www.redhat.com/support/policy/soc/production/");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=240200");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=450774");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=484437");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=491384");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2009:0329");
...
"Update the RHEL freetype package based on the guidance in RHSA-2009:0329.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2009-0946");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2008-1808");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'freetype-2.1.9-10.el4.7', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freetype-2.1.9-10.el4.7', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freetype-2.1.9-10.el4.7', 'cpu':'ppc64', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freetype-2.1.9-10.el4.7', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freetype-2.1.9-10.el4.7', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freetype-2.1.9-10.el4.7', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freetype-demos-2.1.9-10.el4.7', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freetype-demos-2.1.9-10.el4.7', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freetype-demos-2.1.9-10.el4.7', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freetype-demos-2.1.9-10.el4.7', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freetype-demos-2.1.9-10.el4.7', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freetype-devel-2.1.9-10.el4.7', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freetype-devel-2.1.9-10.el4.7', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freetype-devel-2.1.9-10.el4.7', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freetype-devel-2.1.9-10.el4.7', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freetype-devel-2.1.9-10.el4.7', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freetype-utils-2.1.9-10.el4.7', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freetype-utils-2.1.9-10.el4.7', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freetype-utils-2.1.9-10.el4.7', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freetype-utils-2.1.9-10.el4.7', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freetype-utils-2.1.9-10.el4.7', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
