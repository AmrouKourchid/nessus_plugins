...
# extracted from Red Hat Security Advisory RHSA-2024:10267. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:10267");

  script_name(english:"RHEL 8 : haproxy (RHSA-2024:10267)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_10267.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5c81a55e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:10267");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL haproxy package based on the guidance in RHSA-2024:10267.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'haproxy-1.8.27-5.el8_8.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
