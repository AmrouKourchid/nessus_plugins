...
# extracted from Fedora Security Advisory FEDORA-2023-3a9674404c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-3a9674404c");

  script_name(english:"Fedora 36 : tpm2-tools / tpm2-tss (2023-3a9674404c)");
...
FEDORA-2023-3a9674404c advisory.

    Fixed:

    * A buffer overflow in tss2-rc as CVE-2023-22745.
    * The drv layer in tss2-rc should have been the policy layer.
    * Spec deviation in Fapi_GetDescription caused description to be NULL when it should be empty string. This
    is API breaking but           considered a bug since it deviated from the FAPI spec
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-3a9674404c");
...
var pkgs = [
    {'reference':'tpm2-tools-5.4-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tpm2-tss-3.2.2-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
