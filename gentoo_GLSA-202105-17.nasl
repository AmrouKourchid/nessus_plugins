...
# extracted from Gentoo Linux Security Advisory GLSA 202105-17.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202105-17");

  script_name(english:"GLSA-202105-17 : rxvt-unicode: User-assisted execution of arbitrary code");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202105-17
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202105-17"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"x11-terms/rxvt-unicode", unaffected:make_list("ge 9.22-r9"), vulnerable:make_list("lt 9.22-r9"))) flag++;
