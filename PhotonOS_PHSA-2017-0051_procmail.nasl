...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Procmail PHSA-2017-0051");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the procmail package has been released.");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'procmail-3.22-5.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'procmail-debuginfo-3.22-5.ph2')) flag++;
