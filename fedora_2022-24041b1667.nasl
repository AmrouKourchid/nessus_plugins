...
# extracted from Fedora Security Advisory FEDORA-2022-24041b1667
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-24041b1667");

  script_name(english:"Fedora 36 : kernel (2022-24041b1667)");
...
FEDORA-2022-24041b1667 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-24041b1667");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  var cve_list = make_list('CVE-2022-4129', 'CVE-2022-4139');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for FEDORA-2022-24041b1667');
  }
  else
  {
...
var pkgs = [
    {'reference':'kernel-6.0.11-200.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
