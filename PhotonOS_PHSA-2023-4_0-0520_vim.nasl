...
# extracted from VMware Security Advisory PHSA-2023-4.0-0520. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Vim PHSA-2023-4.0-0520");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the vim package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-520.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'vim-9.0.2112-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'vim-extra-9.0.2112-1.ph4')) flag++;
