...
if (description)
{
  ...
  script_cve_id("CVE-2021-43204");

  script_name(english:"Fortinet FortiClient DoS due to folder access permission change (FG-IR-21-167)");
...
vulnerability as referenced in the FG-IR-21-167 advisory.

  - A improper control of a resource through its lifetime in Fortinet FortiClientWindows version 6.4.1 and
    6.4.0, version 6.2.9 and below, version 6.0.10 and below allows attacker to cause a complete denial of
    service of its components via changes of directory access permissions. (CVE-2021-43204)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.fortiguard.com/psirt/FG-IR-21-167");
  script_set_attribute(attribute:"solution", value:
"Please upgrade to FortiClientWindows version 6.4.2/7.0.0 or later.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:N/I:N/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:H/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-43204");
...
var constraints = [
  { 'min_version' : '6.0.0', 'max_version' : '6.0.10', 'fixed_version' : '6.4.2' },
  { 'min_version' : '6.2.0', 'max_version' : '6.2.9', 'fixed_version' : '6.4.2' },
