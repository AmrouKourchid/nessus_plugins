...
# extracted from Oracle Linux Security Advisory ELSA-2021-3081.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : cloud-init (ELSA-2021-3081)");
...
ELSA-2021-3081 advisory.

    - Resolves: bz#1979252
      (CVE-2021-3429 cloud-init: randomly generated passwords logged in clear-text to world-readable file
    [rhel-8] [rhel-8.4.0.z])
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2021-3081.html");
...
var pkgs = [
    {'reference':'cloud-init-20.3-10.0.1.el8_4.5', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
