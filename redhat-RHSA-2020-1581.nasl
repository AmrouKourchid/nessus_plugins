...
# extracted from Red Hat Security Advisory RHSA-2020:1581. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 8 : wavpack (RHSA-2020:1581)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for wavpack.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2020:1581 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_1581.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?31262a82");
...
"Update the RHEL wavpack package based on the guidance in RHSA-2020:1581.");
  ...
  script_cwe_id(125, 369, 456, 665, 835);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'wavpack-5.1.0-15.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'wavpack-devel-5.1.0-15.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
