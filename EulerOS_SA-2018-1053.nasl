...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP1 : nautilus (EulerOS-SA-2018-1053)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the version of the nautilus packages installed, the
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1053
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fbc0fd3d");
  script_set_attribute(attribute:"solution", value:
"Update the affected nautilus package.");
...
pkgs = ["nautilus-3.8.2-10.h1",
        "nautilus-extensions-3.8.2-10.h1"];
