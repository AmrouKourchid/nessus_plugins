...
if (description)
{
  ...
  script_name(english:"OpenSSL 1.0.2 < 1.0.2zl Vulnerability");

  script_set_attribute(attribute:"synopsis", value:
"The remote service is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of OpenSSL installed on the remote host is prior to 1.0.2zl. It is, therefore, affected by a vulnerability
as referenced in the 1.0.2zl advisory.
...
number.");
  # https://openssl-corporation.org/support/?giturl=https://github.openssl.org/openssl/extended-releases/commit/9d576994cec2b7aa37a91740ea7e680810957e41%22
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?09a3136b");
...
var constraints = [
  { 'min_version' : '1.0.2', 'fixed_version' : '1.0.2zl' }
];
