...
if (description)
{
  ...
  script_name(english:"PHP 8.0.x < 8.0.12");

  script_set_attribute(attribute:"synopsis", value:
"The version PHP running on the remote web server is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of PHP installed on the remote host is prior to 8.0.12. It is, therefore, affected by a vulnerability as
referenced in the Version 8.0.12 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://php.net/ChangeLog-8.php#8.0.12");
  script_set_attribute(attribute:"solution", value:
"Upgrade to PHP version 8.0.12 or later.");
...
var constraints = [
  { 'min_version' : '8.0.0alpha1', 'fixed_version' : '8.0.12' }
];
