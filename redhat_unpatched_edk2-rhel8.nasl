...
# extracted from Red Hat Security Advisory edk2. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2019-14562", "CVE-2023-2650");

  script_name(english:"RHEL 8 : edk2 (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2023-2650");
