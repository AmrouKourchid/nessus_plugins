...
# extracted from Fedora Security Advisory FEDORA-2022-927df621df
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-927df621df");

  script_name(english:"Fedora 35 : thunderbird (2022-927df621df)");
...
FEDORA-2022-927df621df advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-927df621df");
...
var pkgs = [
    {'reference':'thunderbird-102.5.0-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
