...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.2 : mariadb (EulerOS-SA-2021-2148)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the version of the mariadb package installed, the
...
the following vulnerability :
  ...
  - Vulnerability in the MySQL Client product of Oracle
    ...
    Client.(CVE-2020-2574)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2148
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d179c70e");
...
pkgs = ["mariadb-libs-5.5.66-1.h1.eulerosv2r7"];
