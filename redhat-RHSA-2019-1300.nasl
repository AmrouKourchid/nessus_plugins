...
# extracted from Red Hat Security Advisory RHSA-2019:1300. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:1300");

  script_name(english:"RHEL 7 : go-toolset-1.11-golang (RHSA-2019:1300)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for go-toolset-1.11-golang.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2019:1300 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_1300.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?52107411");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:1300");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1688230");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL go-toolset-1.11-golang package based on the guidance in RHSA-2019:1300.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'go-toolset-1.11-1.11.5-2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'go-toolset-1.11-build-1.11.5-2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'go-toolset-1.11-golang-1.11.5-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'go-toolset-1.11-golang-bin-1.11.5-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'go-toolset-1.11-golang-docs-1.11.5-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'go-toolset-1.11-golang-misc-1.11.5-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'go-toolset-1.11-golang-race-1.11.5-3.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'go-toolset-1.11-golang-src-1.11.5-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'go-toolset-1.11-golang-tests-1.11.5-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'go-toolset-1.11-runtime-1.11.5-2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'go-toolset-1.11-scldevel-1.11.5-2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
