...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'systemd-228-43.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'systemd-debuginfo-228-43.ph1')) flag++;
