...
# extracted from Red Hat Security Advisory RHSA-2021:4035. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_4035.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d911dd8c");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:4035");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2005819");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL binutils package based on the guidance in RHSA-2021:4035.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'binutils-2.27-34.base.el7_6.4', 'sp':'6', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'binutils-2.27-34.base.el7_6.4', 'sp':'6', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'binutils-devel-2.27-34.base.el7_6.4', 'sp':'6', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'binutils-devel-2.27-34.base.el7_6.4', 'sp':'6', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'binutils-devel-2.27-34.base.el7_6.4', 'sp':'6', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
