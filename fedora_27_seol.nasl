...
if (description)
{
  ...
  script_name(english:"Fedoraproject Fedora SEoL (27.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Fedoraproject Fedora is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Fedoraproject Fedora is 27.x. It is, therefore, no longer maintained by its vendor or
provider.
...
var constraints = [
  { max_branch : '27', min_branch : '27', seol : 20181130 }
];
