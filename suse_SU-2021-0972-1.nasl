...
# extracted from SUSE update advisory SUSE-SU-2021:0972-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES15 Security Update : ovmf (SUSE-SU-2021:0972-1)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?63e1f547");
...
zypper in -t patch
SUSE-SLE-Module-Server-Applications-15-SP2-2021-972=1");
...
flag = 0;
if (rpm_check(release:"SLES15", sp:"2", cpu:"x86_64", reference:"ovmf-201911-7.11.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", cpu:"x86_64", reference:"ovmf-tools-201911-7.11.1")) flag++;
