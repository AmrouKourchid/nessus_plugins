...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : python-configobj (EulerOS-SA-2024-1699)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the python-configobj packages installed, the EulerOS Virtualization installation on the
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1699
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3e28b6f0");
...
"Update the affected python-configobj packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:python2-configobj");
...
var pkgs = [
  "python2-configobj-5.0.6-14.h1.eulerosv2r8",
  "python3-configobj-5.0.6-14.h1.eulerosv2r8"
];
