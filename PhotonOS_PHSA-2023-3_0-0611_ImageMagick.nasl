...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Imagemagick PHSA-2023-3.0-0611");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'ImageMagick-7.1.1.11-2.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'ImageMagick-devel-7.1.1.11-2.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'ImageMagick-doc-7.1.1.11-2.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'ImageMagick-libs-7.1.1.11-2.ph3')) flag++;
