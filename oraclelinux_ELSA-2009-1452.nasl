...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : neon (ELSA-2009-1452)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2009-1452.html");
...
"Update the affected neon and / or neon-devel packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2009-2474");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2009-2473");
...
var pkgs = [
    {'reference':'neon-0.25.5-10.el5_4.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'neon-devel-0.25.5-10.el5_4.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'neon-0.25.5-10.el5_4.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'neon-devel-0.25.5-10.el5_4.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
