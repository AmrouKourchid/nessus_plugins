...
# extracted from Fedora Security Advisory FEDORA-2023-b121bd62a9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-b121bd62a9");

  script_name(english:"Fedora 37 : c-ares (2023-b121bd62a9)");
...
FEDORA-2023-b121bd62a9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-b121bd62a9");
...
var pkgs = [
    {'reference':'c-ares-1.19.0-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
