...
# extracted from Fedora Security Advisory FEDORA-2024-fd3545a844
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-fd3545a844");

  script_name(english:"Fedora 38 : golang-x-text (2024-fd3545a844)");
...
FEDORA-2024-fd3545a844 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-fd3545a844");
  script_set_attribute(attribute:"solution", value:
"Update the affected golang-x-text package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:golang-x-text");
...
var pkgs = [
    {'reference':'golang-x-text-0.14.0-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'golang-x-text');
}
