...
if (description)
{
  ...
  script_name(english:"CentOS 9 : aide-0.16-100.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update for aide.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 9 host has a package installed that is affected by a vulnerability as referenced in the
aide-0.16-100.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=16514");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream aide package.");
...
var pkgs = [
    {'reference':'aide-0.16-100.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
