...
# extracted from Debian Security Advisory dla-4003. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-4003 : node-postcss - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ff0037ab");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2021-23566");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-44270");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-55565");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bullseye/node-postcss");
...
"Upgrade the node-postcss packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:node-postcss");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'node-postcss', 'reference': '8.2.1+~cs5.3.23-8+deb11u1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'node-postcss');
}
