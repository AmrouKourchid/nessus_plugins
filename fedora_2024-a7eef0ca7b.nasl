...
# extracted from Fedora Security Advisory FEDORA-2024-a7eef0ca7b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-a7eef0ca7b");

  script_name(english:"Fedora 39 : python-django4.2 (2024-a7eef0ca7b)");
...
FEDORA-2024-a7eef0ca7b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-a7eef0ca7b");
...
"Update the affected python-django4.2 package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-3930");
...
var pkgs = [
    {'reference':'python-django4.2-4.2.14-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
