...
# extracted from Red Hat Security Advisory RHSA-2022:8022. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:8022");

  script_name(english:"RHEL 9 : qt5 (RHSA-2022:8022)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for qt5.");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8022.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?caa866b7");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8022");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2055505");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2061352");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL qt5 package based on the guidance in RHSA-2022:8022.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'qt5-5.15.3-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'qt5-devel-5.15.3-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'qt5-rpm-macros-5.15.3-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'qt5-srpm-macros-5.15.3-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'qt5 / qt5-devel / qt5-rpm-macros / qt5-srpm-macros');
}
