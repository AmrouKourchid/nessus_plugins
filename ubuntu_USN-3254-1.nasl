...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS : Django vulnerabilities (USN-3254-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 14.04 LTS / 16.04 LTS host has packages installed that are affected by multiple vulnerabilities as
referenced in the USN-3254-1 advisory.

    It was discovered that Django incorrectly handled numeric redirect URLs. A remote attacker could possibly
    use this issue to perform XSS attacks, and to use a Django server as an open redirect. (CVE-2017-7233)

    Phithon Gong discovered that Django incorrectly handled certain URLs when the jango.views.static.serve()
    view is being used. A remote attacker could possibly use a Django server as an open redirect.
    (CVE-2017-7234)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3254-1");
...
"Update the affected python-django, python-django-common and / or python3-django packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-7234");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'python-django', 'pkgver': '1.6.11-0ubuntu1.1'},
    {'osver': '16.04', 'pkgname': 'python-django', 'pkgver': '1.8.7-1ubuntu5.5'},
    {'osver': '16.04', 'pkgname': 'python-django-common', 'pkgver': '1.8.7-1ubuntu5.5'},
    {'osver': '16.04', 'pkgname': 'python3-django', 'pkgver': '1.8.7-1ubuntu5.5'}
];
