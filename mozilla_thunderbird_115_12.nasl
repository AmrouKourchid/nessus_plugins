...
"The version of Thunderbird installed on the remote Windows host is prior to 115.12. It is, therefore, affected by
multiple vulnerabilities as referenced in the mfsa2024-28 advisory.
...
mozilla_check_version(installs:installs, product:'thunderbird', esr:FALSE, fix:'115.12', severity:SECURITY_HOLE);
