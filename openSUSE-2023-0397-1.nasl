...
# openSUSE Security Update openSUSE-SU-2023:0397-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : opera (openSUSE-SU-2023:0397-1)");
...
openSUSE-SU-2023:0397-1 advisory.
...
number.");
  # https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/V7AX36UQ4VSQGG4N3ZTQIAWX4Z4ZHQAF/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?33f9b9c9");
...
var pkgs = [
    {'reference':'opera-105.0.4970.34-lp154.2.65.1', 'cpu':'x86_64', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE}
];
