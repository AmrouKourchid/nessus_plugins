...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.0 : curl (EulerOS-SA-2023-1164)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1164
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?550f64cf");
...
var pkgs = [
  "curl-7.71.1-4.h17.eulerosv2r10",
  "libcurl-7.71.1-4.h17.eulerosv2r10"
];
