...
# extracted from Red Hat Security Advisory php53. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 5 : php53 (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2015-4021");
