...
# extracted from openSUSE Security Update openSUSE-2019-2434.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : docker-runc (openSUSE-2019-2434)");
...
if ( rpm_check(release:"SUSE15.1", reference:"docker-runc-1.0.0rc8+gitr3826_425e105d5a03-lp151.3.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"docker-runc-debuginfo-1.0.0rc8+gitr3826_425e105d5a03-lp151.3.9.1") ) flag++;
