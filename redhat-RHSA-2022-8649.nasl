...
# extracted from Red Hat Security Advisory RHSA-2022:8649. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:8649");

  script_name(english:"RHEL 8 : varnish:6 (RHSA-2022:8649)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for varnish:6.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2022:8649 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8649.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1963e178");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8649");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2141844");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL varnish:6 package based on the guidance in RHSA-2022:8649.");
  ...
  'varnish:6': [
    {
      ...
      'pkgs': [
        {'reference':'varnish-6.0.8-2.module+el8.7.0+17239+94d153bd.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'varnish-devel-6.0.8-2.module+el8.7.0+17239+94d153bd.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'varnish-docs-6.0.8-2.module+el8.7.0+17239+94d153bd.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
