...
if (description)
{
  ...
  script_cve_id("CVE-2015-7317");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2015-7317");
...
patch available.
  ...
  - Kupu 3.3.0 through 3.3.6, 4.0.0 through 4.0.10, 4.1.0 through 4.1.6, and 4.2.0 through 4.2.7 allows remote
    authenticated users to edit Kupu settings. (CVE-2015-7317)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-7317");
