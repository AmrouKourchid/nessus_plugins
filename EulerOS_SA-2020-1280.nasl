...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.2 : sqlite (EulerOS-SA-2020-1280)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1280
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?afc0edb9");
...
pkgs = ["sqlite-3.7.17-8.h6",
        "sqlite-devel-3.7.17-8.h6"];
