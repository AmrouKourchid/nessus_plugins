...
# extracted from Fedora Security Advisory FEDORA-2024-d76e37ba62
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-d76e37ba62");

  script_name(english:"Fedora 38 : cpp-jwt (2024-d76e37ba62)");
...
FEDORA-2024-d76e37ba62 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-d76e37ba62");
  script_set_attribute(attribute:"solution", value:
"Update the affected cpp-jwt package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:cpp-jwt");
...
var pkgs = [
    {'reference':'cpp-jwt-1.4-7.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'cpp-jwt');
}
