...
# extracted from Red Hat Security Advisory rpm. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2015-8865", "CVE-2017-7500", "CVE-2017-7501");

  script_name(english:"RHEL 6 : rpm (Unpatched Vulnerability) (deprecated)");
