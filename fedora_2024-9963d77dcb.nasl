...
# extracted from Fedora Security Advisory FEDORA-2024-9963d77dcb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-9963d77dcb");

  script_name(english:"Fedora 40 : c-ares (2024-9963d77dcb)");
...
FEDORA-2024-9963d77dcb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-9963d77dcb");
...
var pkgs = [
    {'reference':'c-ares-1.28.1-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
