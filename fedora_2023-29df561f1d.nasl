...
# extracted from Fedora Security Advisory FEDORA-2023-29df561f1d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-29df561f1d");

  script_name(english:"Fedora 37 : emacs (2023-29df561f1d)");
...
FEDORA-2023-29df561f1d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-29df561f1d");
...
var pkgs = [
    {'reference':'emacs-28.3-0.rc1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
