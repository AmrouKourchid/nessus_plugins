...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : python-virtualenv on SL7.x (noarch) (20200512)");
...
"Security Fix(es) :
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind2006&L=SCIENTIFIC-LINUX-ERRATA&P=696
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?544b615e");
...
flag = 0;
if (rpm_check(release:"SL7", reference:"python-virtualenv-15.1.0-4.el7_8")) flag++;
