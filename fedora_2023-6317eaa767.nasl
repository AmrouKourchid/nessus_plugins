...
# extracted from Fedora Security Advisory FEDORA-2023-6317eaa767
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-6317eaa767");

  script_name(english:"Fedora 38 : squid (2023-6317eaa767)");
...
FEDORA-2023-6317eaa767 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-6317eaa767");
...
var pkgs = [
    {'reference':'squid-6.6-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
];
