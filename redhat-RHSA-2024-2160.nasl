...
# extracted from Red Hat Security Advisory RHSA-2024:2160. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2023-39318", "CVE-2023-39319", "CVE-2023-39326");
  script_xref(name:"RHSA", value:"2024:2160");

  script_name(english:"RHEL 9 : toolbox (RHSA-2024:2160)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for toolbox.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:2160 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2160.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3daf3c0a");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2160");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-1834");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-19772");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL toolbox package based on the guidance in RHSA-2024:2160.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'toolbox-0.0.99.5-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'toolbox-tests-0.0.99.5-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
