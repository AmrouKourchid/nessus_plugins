...
# extracted from Ubuntu Security Notice USN-3520-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS : PySAML2 vulnerability (USN-3520-1)");
...
USN-3520-1 advisory.
    ...
    It was discovered that PySAML2 incorrectly accepted any password when run with python optimizations
    enabled. An attacker could use this issue to authenticate as any user without a valid password.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3520-1");
...
"Update the affected python-pysaml2 and / or python3-pysaml2 packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-1000433");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'python-pysaml2', 'pkgver': '3.0.0-3ubuntu1.16.04.3'},
    {'osver': '16.04', 'pkgname': 'python3-pysaml2', 'pkgver': '3.0.0-3ubuntu1.16.04.3'}
];
