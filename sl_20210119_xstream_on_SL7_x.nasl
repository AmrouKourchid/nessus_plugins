...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"RHSA-2021:0162");
  script_xref(name:"CEA-ID", value:"CEA-2021-0025");

  script_name(english:"Scientific Linux Security Update : xstream on SL7.x (noarch) (2021:0162)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.scientificlinux.org/category/sl-errata/slsa-20210162-1");
...
pkgs = [
    {'reference':'xstream-1.3.1-12.el7_9', 'release':'SL7'},
    {'reference':'xstream-javadoc-1.3.1-12.el7_9', 'release':'SL7'}
];
