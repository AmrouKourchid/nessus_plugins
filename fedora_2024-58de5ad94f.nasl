...
# extracted from Fedora Security Advisory FEDORA-2024-58de5ad94f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-58de5ad94f");

  script_name(english:"Fedora 41 : webkit2gtk4.0 (2024-58de5ad94f)");
...
FEDORA-2024-58de5ad94f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-58de5ad94f");
...
var pkgs = [
    {'reference':'webkit2gtk4.0-2.46.3-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
