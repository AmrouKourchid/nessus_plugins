...
if (description)
{
  ...
  script_cve_id("CVE-2023-36429");
  script_xref(name:"MSKB", value:"5031499");
  script_xref(name:"MSKB", value:"5031500");
  script_xref(name:"MSFT", value:"MS23-5031499");
  script_xref(name:"MSFT", value:"MS23-5031500");
  script_xref(name:"IAVA", value:"2023-A-0544-S");

  script_name(english:"Security Updates for Microsoft Dynamics 365 (on-premises) (October 2023)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5031499");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5031500");
...
"Microsoft has released the following security updates to address this issue:  
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-36429");
...
var constraints = [
  { 'min_version' : '9.0', 'fixed_version' : '9.0.50.03', 'fixed_display' : 'Update v9.0 (on-premises) Update 0.50' },
  { 'min_version' : '9.1', 'fixed_version' : '9.1.22.04', 'fixed_display' : 'Update v9.1 (on-premises) Update 1.22' }
];
