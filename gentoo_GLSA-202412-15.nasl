...
# extracted from Gentoo Linux Security Advisory GLSA 202412-15.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202412-15 : OpenSC: Multiple Vulnerabilities");
...
"The remote host is affected by the vulnerability described in GLSA-202412-15 (OpenSC: Multiple Vulnerabilities)
    ...
    Multiple vulnerabilities have been discovered in OpenSC. Please review the CVE identifiers referenced
    below for details.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202412-15");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=907930");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=917651");
...
var packages = [
  {
    ...
    'unaffected' : make_list("ge 0.24.0"),
    'vulnerable' : make_list("lt 0.24.0")
  }
];
