...
if (description)
{
  ...
  script_name(english:"DeepSpeed Detection");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/microsoft/DeepSpeed");
  script_set_attribute(attribute:"see_also", value:"https://pypi.org/project/DeepSpeed/");
