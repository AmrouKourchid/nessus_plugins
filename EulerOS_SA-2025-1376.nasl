...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : python-jinja2 (EulerOS-SA-2025-1376)");
...
affected by the following vulnerabilities :
    ...
    templates where the template author can also choose the template filename. This vulnerability is fixed in
    3.1.5.(CVE-2024-56201)
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1376
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?56c50976");
...
var pkgs = [
  "python3-jinja2-3.0.3-1.h5.eulerosv2r11"
];
