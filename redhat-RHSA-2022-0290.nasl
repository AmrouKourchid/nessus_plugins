...
"The remote Red Hat host is missing one or more security updates for parfait:0.5.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2022:0290 advisory.

    Parfait is a Java performance monitoring library that collects metrics and exposes them through a variety
    of outputs. It provides APIs for extracting performance metrics from the JVM and other sources. It
    interfaces to Performance Co-Pilot (PCP) using the Memory Mapped Value (MMV) machinery for extremely
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_0290.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?101e65ca");
...
"Update the RHEL parfait:0.5 package based on the guidance in RHSA-2022:0290.");
  ...
  'parfait:0.5': [
    {
      ...
      'pkgs': [
        {'reference':'parfait-0.5.4-4.module+el8.5.0+13988+de2b8c0b', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'parfait-examples-0.5.4-4.module+el8.5.0+13988+de2b8c0b', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'parfait-javadoc-0.5.4-4.module+el8.5.0+13988+de2b8c0b', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'pcp-parfait-agent-0.5.4-4.module+el8.5.0+13988+de2b8c0b', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
