...
# extracted from Fedora Security Advisory FEDORA-2023-f8e94641dc
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-f8e94641dc");

  script_name(english:"Fedora 38 : chromium (2023-f8e94641dc)");
...
FEDORA-2023-f8e94641dc advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-f8e94641dc");
...
var pkgs = [
    {'reference':'chromium-116.0.5845.96-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
