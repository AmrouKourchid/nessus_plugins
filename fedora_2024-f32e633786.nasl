...
# extracted from Fedora Security Advisory FEDORA-2024-f32e633786
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-f32e633786");

  script_name(english:"Fedora 40 : linux-firmware (2024-f32e633786)");
...
FEDORA-2024-f32e633786 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-f32e633786");
...
var pkgs = [
    {'reference':'linux-firmware-20240909-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
