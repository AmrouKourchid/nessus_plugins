...
if (description)
{
  ...
  script_cve_id("CVE-2017-12944");

  script_name(english:"Photon OS 2.0: Libtiff PHSA-2017-0045");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-12944");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libtiff-4.0.8-5.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libtiff-debuginfo-4.0.8-5.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libtiff-devel-4.0.8-5.ph2')) flag++;
