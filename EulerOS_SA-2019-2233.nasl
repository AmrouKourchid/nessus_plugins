...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : tcpdump (EulerOS-SA-2019-2233)");
...
vulnerabilities :
  ...
  - tcpdump.org tcpdump 4.9.2 is affected by: CWE-126:
    ...
    Pointer, Return Address etc. on stack. The victim must
    open a specially crafted pcap file. (CVE-2019-1010220)
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2233
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4fe77799");
...
"Update the affected tcpdump packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-1010220");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2018-19519");
...
pkgs = ["tcpdump-4.9.2-3.h1.eulerosv2r7"];
