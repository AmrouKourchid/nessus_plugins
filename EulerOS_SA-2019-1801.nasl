...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : patch (EulerOS-SA-2019-1801)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1801
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?721d6e7c");
...
pkgs = ["patch-2.7.1-10.h1.eulerosv2r7"];
