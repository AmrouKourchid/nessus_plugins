...
"The version of Firefox installed on the remote Windows host is prior to 115.5. It is, therefore, affected by multiple
vulnerabilities as referenced in the mfsa2023-50 advisory.
...
mozilla_check_version(installs:installs, product:'firefox', esr:FALSE, fix:'115.5', severity:SECURITY_HOLE);
