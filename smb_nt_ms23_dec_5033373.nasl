...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5033373");
  script_xref(name:"MSFT", value:"MS23-5033373");
  script_xref(name:"IAVA", value:"2023-A-0689-S");
  script_xref(name:"IAVA", value:"2023-A-0690-S");

  script_name(english:"KB5033373: Windows 10 Version 1607 and Windows Server 2016 Security Update (December 2023)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5033373");
...
"Apply Security Update 5033373");
  ...
  script_dependencies("smb_check_rollup.nasl", "smb_hotfixes.nasl", "ms_bulletin_checks_possible.nasl", "wmi_enum_qfes.nbin");
...
var patch_installed = get_kb_item('WMI/Installed/Hotfix/KB5033373');

if (patch_installed) audit(AUDIT_OS_SP_NOT_VULN);
