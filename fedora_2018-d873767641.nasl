...
# extracted from Fedora Security Advisory FEDORA-2018-d873767641.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : glusterfs (2018-d873767641)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"4.1.1 GA, security fix for CVE-2018-10841
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-d873767641");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"glusterfs-4.1.1-1.fc28")) flag++;
