...
# extracted from Red Hat Security Advisory RHSA-2024:4642. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:4642");

  script_name(english:"RHEL 9 : libndp (RHSA-2024:4642)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_4642.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f1c2b493");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:4642");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libndp package based on the guidance in RHSA-2024:4642.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libndp-1.8-5.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
