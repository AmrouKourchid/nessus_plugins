...
if (description)
{
  ...
  script_cve_id("CVE-2019-10901");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2019-10901");
...
patch available.
  ...
  - In Wireshark 2.4.0 to 2.4.13, 2.6.0 to 2.6.7, and 3.0.0, the LDSS dissector could crash. This was
    addressed in epan/dissectors/packet-ldss.c by handling file digests properly. (CVE-2019-10901)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-10901");
