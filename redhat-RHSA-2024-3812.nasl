...
# extracted from Red Hat Security Advisory RHSA-2024:3812. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_3812.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5d768444");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2186673");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:3812");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL protobuf-c package based on the guidance in RHSA-2024:3812.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'protobuf-c-1.3.0-8.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'protobuf-c-compiler-1.3.0-8.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'protobuf-c-devel-1.3.0-8.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
