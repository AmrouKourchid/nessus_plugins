...
# extracted from SUSE update advisory SUSE-SU-2020:3070-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES15 Security Update : spice (SUSE-SU-2020:3070-1)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?99659bf1");
...
zypper in -t patch
SUSE-SLE-Module-Server-Applications-15-SP2-2020-3070=1");
...
flag = 0;
if (rpm_check(release:"SLES15", sp:"2", reference:"libspice-server-devel-0.14.2-3.3.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"libspice-server1-0.14.2-3.3.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"libspice-server1-debuginfo-0.14.2-3.3.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"spice-debugsource-0.14.2-3.3.1")) flag++;
