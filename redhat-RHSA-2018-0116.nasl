...
"The remote Red Hat host is missing a security update for rh-eclipse46-jackson-databind.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2018:0116 advisory.
    ...
    * A deserialization flaw was discovered in the jackson-databind which could allow an unauthenticated user
    to perform code execution by sending maliciously crafted input to the readValue method of ObjectMapper.
    This issue extends upon the previous flaws CVE-2017-7525 and CVE-2017-15095 by blacklisting more classes
    that could be used maliciously. (CVE-2017-17485)

    Red Hat would like to thank 0c0c0f from 360 for reporting this issue.

Tenable has extracted the preceding description block directly from the Red Hat Enterprise Linux security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_0116.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a018b844");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:0116");
...
"Update the RHEL rh-eclipse46-jackson-databind package based on the guidance in RHSA-2018:0116.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-eclipse46-jackson-databind-2.6.3-2.6.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-eclipse46-jackson-databind-javadoc-2.6.3-2.6.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
