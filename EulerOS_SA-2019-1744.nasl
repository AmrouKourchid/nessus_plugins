...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : samba (EulerOS-SA-2019-1744)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1744
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?949b5f02");
...
pkgs = ["libsmbclient-4.6.2-8.h7",
        "libwbclient-4.6.2-8.h7",
        "samba-4.6.2-8.h7",
        "samba-client-4.6.2-8.h7",
        "samba-client-libs-4.6.2-8.h7",
        "samba-common-4.6.2-8.h7",
        "samba-common-libs-4.6.2-8.h7",
        "samba-common-tools-4.6.2-8.h7",
        "samba-libs-4.6.2-8.h7",
        "samba-python-4.6.2-8.h7",
        "samba-winbind-4.6.2-8.h7",
        "samba-winbind-clients-4.6.2-8.h7",
        "samba-winbind-modules-4.6.2-8.h7"];
