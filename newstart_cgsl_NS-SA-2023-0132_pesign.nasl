...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 6.06 : pesign Vulnerability (NS-SA-2023-0132) (deprecated)");
...
"This plugin has been deprecated.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/info/CVE-2022-3560");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:pesign");
