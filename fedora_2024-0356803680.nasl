...
# extracted from Fedora Security Advisory FEDORA-2024-0356803680
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-0356803680");

  script_name(english:"Fedora 38 : freeglut (2024-0356803680)");
...
FEDORA-2024-0356803680 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-0356803680");
...
var pkgs = [
    {'reference':'freeglut-3.4.0-7.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
