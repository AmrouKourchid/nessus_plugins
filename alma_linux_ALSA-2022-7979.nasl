...
# AlmaLinux Security Advisory ALSA-2022:7979.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2022:7979");

  script_name(english:"AlmaLinux 9 : speex (ALSA-2022:7979)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2022-7979.html");
...
"Update the affected speex and / or speex-devel packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:speex");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:speex-devel");
