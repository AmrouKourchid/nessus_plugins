...
# extracted from Ubuntu Security Notice USN-2321-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : OpenStack Neutron vulnerabilities (USN-2321-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 14.04 LTS host has packages installed that are affected by multiple vulnerabilities as referenced in
the USN-2321-1 advisory.

    Liping Mao discovered that OpenStack Neutron did not properly handle requests for a large number of
    allowed address pairs. A remote authenticated attacker could exploit this to cause a denial of service.
    (CVE-2014-3555)

    Zhi Kun Liu discovered that OpenStack Neutron incorrectly filtered certain tokens. An attacker could
    possibly use this issue to obtain authentication tokens used in REST requests. (CVE-2014-4615)

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2321-1");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-4615");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2014-3555");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'neutron-common', 'pkgver': '1:2014.1.2-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'neutron-dhcp-agent', 'pkgver': '1:2014.1.2-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'neutron-l3-agent', 'pkgver': '1:2014.1.2-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'neutron-lbaas-agent', 'pkgver': '1:2014.1.2-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'neutron-metadata-agent', 'pkgver': '1:2014.1.2-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'neutron-metering-agent', 'pkgver': '1:2014.1.2-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'neutron-plugin-bigswitch', 'pkgver': '1:2014.1.2-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'neutron-plugin-bigswitch-agent', 'pkgver': '1:2014.1.2-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'neutron-plugin-brocade', 'pkgver': '1:2014.1.2-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'neutron-plugin-cisco', 'pkgver': '1:2014.1.2-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'neutron-plugin-hyperv', 'pkgver': '1:2014.1.2-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'neutron-plugin-ibm', 'pkgver': '1:2014.1.2-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'neutron-plugin-ibm-agent', 'pkgver': '1:2014.1.2-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'neutron-plugin-linuxbridge', 'pkgver': '1:2014.1.2-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'neutron-plugin-linuxbridge-agent', 'pkgver': '1:2014.1.2-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'neutron-plugin-metaplugin', 'pkgver': '1:2014.1.2-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'neutron-plugin-metering-agent', 'pkgver': '1:2014.1.2-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'neutron-plugin-midonet', 'pkgver': '1:2014.1.2-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'neutron-plugin-ml2', 'pkgver': '1:2014.1.2-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'neutron-plugin-mlnx', 'pkgver': '1:2014.1.2-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'neutron-plugin-mlnx-agent', 'pkgver': '1:2014.1.2-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'neutron-plugin-nec', 'pkgver': '1:2014.1.2-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'neutron-plugin-nec-agent', 'pkgver': '1:2014.1.2-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'neutron-plugin-nicira', 'pkgver': '1:2014.1.2-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'neutron-plugin-oneconvergence', 'pkgver': '1:2014.1.2-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'neutron-plugin-oneconvergence-agent', 'pkgver': '1:2014.1.2-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'neutron-plugin-openflow-agent', 'pkgver': '1:2014.1.2-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'neutron-plugin-openvswitch', 'pkgver': '1:2014.1.2-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'neutron-plugin-openvswitch-agent', 'pkgver': '1:2014.1.2-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'neutron-plugin-plumgrid', 'pkgver': '1:2014.1.2-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'neutron-plugin-ryu', 'pkgver': '1:2014.1.2-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'neutron-plugin-ryu-agent', 'pkgver': '1:2014.1.2-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'neutron-plugin-vmware', 'pkgver': '1:2014.1.2-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'neutron-plugin-vpn-agent', 'pkgver': '1:2014.1.2-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'neutron-server', 'pkgver': '1:2014.1.2-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'neutron-vpn-agent', 'pkgver': '1:2014.1.2-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'python-neutron', 'pkgver': '1:2014.1.2-0ubuntu1.1'}
];
