...
if (description)
{
  ...
  script_name(english:"Foxit PDF Reader for Mac < 2023.3 Multiple Vulnerabilities");
...
the remote macOS host is prior to 2023.3. It is, therefore affected by multiple vulnerabilities:
...
"Upgrade to Foxit PDF Reader for Mac version 2023.3 or later");
...
var constraints = [
  { 'max_version' : '2023.2.0.61611', 'fixed_version' : '2023.3' }
];
