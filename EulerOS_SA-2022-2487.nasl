...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : binutils (EulerOS-SA-2022-2487)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2487
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8845400f");
...
var pkgs = [
  ...
  "binutils-devel-2.27-28.base.1.h53.eulerosv2r7"
];
