...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : dnsmasq (EulerOS-SA-2020-1595)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1595
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?04dd05ae");
