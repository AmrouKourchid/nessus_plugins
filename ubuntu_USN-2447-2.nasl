...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : Linux kernel (Utopic HWE) regression (USN-2447-2)");
...
USN-2447-2 advisory.
    ...
    USN-2447-1 fixed vulnerabilities in the Linux kernel. Due to an unrelated regression TCP Throughput drops
    to zero for several drivers after upgrading. This update fixes the problem.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2447-2");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-2447-2');
}
