...
# extracted from Fedora Security Advisory FEDORA-2023-e26d3a5b89
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-e26d3a5b89");

  script_name(english:"Fedora 38 : dotnet7.0 (2023-e26d3a5b89)");
...
FEDORA-2023-e26d3a5b89 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-e26d3a5b89");
...
var pkgs = [
    {'reference':'dotnet7.0-7.0.113-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
