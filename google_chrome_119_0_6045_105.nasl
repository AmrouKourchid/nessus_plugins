...
if (description)
{
  ...
  script_name(english:"Google Chrome < 119.0.6045.105 Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"A web browser installed on the remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Google Chrome installed on the remote Windows host is prior to 119.0.6045.105. It is, therefore, affected
by multiple vulnerabilities as referenced in the 2023_10_stable-channel-update-for-desktop_31 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f9f9d025");
  script_set_attribute(attribute:"see_also", value:"https://crbug.com/1492698");
  script_set_attribute(attribute:"see_also", value:"https://crbug.com/1492381");
  script_set_attribute(attribute:"see_also", value:"https://crbug.com/1492384");
  script_set_attribute(attribute:"see_also", value:"https://crbug.com/1281972");
  script_set_attribute(attribute:"see_also", value:"https://crbug.com/1473957");
  script_set_attribute(attribute:"see_also", value:"https://crbug.com/1480852");
  script_set_attribute(attribute:"see_also", value:"https://crbug.com/1456876");
  script_set_attribute(attribute:"see_also", value:"https://crbug.com/1488267");
  script_set_attribute(attribute:"see_also", value:"https://crbug.com/1492396");
  script_set_attribute(attribute:"see_also", value:"https://crbug.com/1493380");
  script_set_attribute(attribute:"see_also", value:"https://crbug.com/1493435");
  script_set_attribute(attribute:"see_also", value:"https://crbug.com/1457704");
  script_set_attribute(attribute:"see_also", value:"https://crbug.com/1482045");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Google Chrome version 119.0.6045.105 or later.");
...
google_chrome_check_version(installs:installs, fix:'119.0.6045.105', severity:SECURITY_HOLE, xss:TRUE, xsrf:FALSE);
