...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : httpd (EulerOS-SA-2019-1295)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1295
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c536afef");
...
pkgs = ["httpd-2.4.6-80.1.h6.eulerosv2r7",
        "httpd-devel-2.4.6-80.1.h6.eulerosv2r7",
        "httpd-manual-2.4.6-80.1.h6.eulerosv2r7",
        "httpd-tools-2.4.6-80.1.h6.eulerosv2r7",
        "mod_session-2.4.6-80.1.h6.eulerosv2r7",
        "mod_ssl-2.4.6-80.1.h6.eulerosv2r7"];
