...
# extracted from Red Hat Security Advisory RHSA-2022:8070. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:8070");

  script_name(english:"RHEL 9 : dnsmasq (RHSA-2022:8070)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8070.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?203b3fc1");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8070");
...
"Update the RHEL dnsmasq package based on the guidance in RHSA-2022:8070.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'dnsmasq-2.85-5.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dnsmasq-utils-2.85-5.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
