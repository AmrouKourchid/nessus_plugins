...
# extracted from Gentoo Linux Security Advisory GLSA 202008-12.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202008-12");
  script_xref(name:"IAVA", value:"2020-A-0384-S");

  script_name(english:"GLSA-202008-12 : Net-SNMP: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202008-12
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202008-12");
...
if (qpkg_check(package:"net-analyzer/net-snmp", unaffected:make_list("ge 5.8.1_pre1"), vulnerable:make_list("lt 5.8.1_pre1"))) flag++;
