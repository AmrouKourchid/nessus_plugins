...
# extracted from Red Hat Security Advisory RHSA-2017:0936. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2017:0936");

  script_name(english:"RHEL 7 : python-defusedxml and python-pysaml2 (RHSA-2017:0936)");
...
number.");
  ...
  # https://access.redhat.com/security/data/csaf/v2/advisories/2017/rhsa-2017_0936.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fb9f030f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2017:0936");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-defusedxml / python-pysaml2 packages based on the guidance in RHSA-2017:0936.");
