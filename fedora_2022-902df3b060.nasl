...
# extracted from Fedora Security Advisory FEDORA-2022-902df3b060
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-902df3b060");

  script_name(english:"Fedora 36 : nextcloud (2022-902df3b060)");
...
FEDORA-2022-902df3b060 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-902df3b060");
...
"Update the affected nextcloud package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-39346");
...
var pkgs = [
    {'reference':'nextcloud-25.0.1-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
