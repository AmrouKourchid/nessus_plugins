...
if (description)
{
  ...
  script_cve_id("CVE-2014-8504");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2014-8504");
...
patch available.
  ...
  - Stack-based buffer overflow in the srec_scan function in bfd/srec.c in GNU binutils 2.24 and earlier
