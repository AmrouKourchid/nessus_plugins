...
# extracted from Fedora Security Advisory FEDORA-2023-3b82f4aa86
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-3b82f4aa86");

  script_name(english:"Fedora 37 : python-reportlab (2023-3b82f4aa86)");
...
FEDORA-2023-3b82f4aa86 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-3b82f4aa86");
...
var pkgs = [
    {'reference':'python-reportlab-4.0.4-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
