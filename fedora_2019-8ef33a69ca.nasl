...
# extracted from Fedora Security Advisory FEDORA-2019-8ef33a69ca.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : SDL2 (2019-8ef33a69ca)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-8ef33a69ca");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"SDL2-2.0.10-1.fc29")) flag++;
