...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5002045");
  script_xref(name:"MSFT", value:"MS21-5002045");

  script_name(english:"Security Updates for Microsoft SharePoint Server Subscription Edition (December 2021)");
...
vulnerabilities:
  ...
  - A remote code execution vulnerability. An attacker can
    ...
    CVE-2021-42309)");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002045");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released KB5002045 to address this issue.");
