...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP12 : python-paramiko (EulerOS-SA-2024-1773)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the python-paramiko package installed, the EulerOS installation on the remote host is
...
Tenable has extracted the preceding description block directly from the EulerOS python-paramiko security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1773
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9eee15b6");
...
var pkgs = [
  "python3-paramiko-2.11.0-2.h3.eulerosv2r12"
];
