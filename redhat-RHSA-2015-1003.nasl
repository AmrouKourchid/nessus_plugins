...
# extracted from Red Hat Security Advisory RHSA-2015:1003. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 5 : kvm (RHSA-2015:1003)");
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2015/rhsa-2015_1003.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6d90c6c7");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2015:1003");
...
"Update the RHEL kvm package based on the guidance in RHSA-2015:1003.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'kmod-kvm-83-272.el5_11', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'kmod-kvm-debug-83-272.el5_11', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'kvm-83-272.el5_11', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'kvm-qemu-img-83-272.el5_11', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'kvm-tools-83-272.el5_11', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
