...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Dnsmasq PHSA-2024-5.0-0215");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'dnsmasq-2.90-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'dnsmasq-utils-2.90-1.ph5')) flag++;
