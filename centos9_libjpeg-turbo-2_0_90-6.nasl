...
if (description)
{
  ...
  script_name(english:"CentOS 9 : libjpeg-turbo-2.0.90-6.el9");
...
turbo-2.0.90-6.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=30407");
...
var pkgs = [
    {'reference':'libjpeg-turbo-2.0.90-6.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libjpeg-turbo-devel-2.0.90-6.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libjpeg-turbo-utils-2.0.90-6.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'turbojpeg-2.0.90-6.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'turbojpeg-devel-2.0.90-6.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
