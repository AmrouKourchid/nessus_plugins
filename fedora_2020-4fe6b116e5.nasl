...
# extracted from Fedora Security Advisory FEDORA-2020-4fe6b116e5.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : php (2020-4fe6b116e5)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-4fe6b116e5");
...
flag = 0;
if (rpm_check(release:"FC32", reference:"php-7.4.11-1.fc32")) flag++;
