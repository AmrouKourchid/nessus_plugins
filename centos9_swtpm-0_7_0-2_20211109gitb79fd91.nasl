...
if (description)
{
  ...
  script_name(english:"CentOS 9 : swtpm-0.7.0-2.20211109gitb79fd91.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update for swtpm.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 9 host has packages installed that are affected by a vulnerability as referenced in the
swtpm-0.7.0-2.20211109gitb79fd91.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=18248");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream swtpm package.");
...
var pkgs = [
    {'reference':'swtpm-0.7.0-2.20211109gitb79fd91.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'swtpm-devel-0.7.0-2.20211109gitb79fd91.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'swtpm-libs-0.7.0-2.20211109gitb79fd91.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'swtpm-tools-0.7.0-2.20211109gitb79fd91.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'swtpm-tools-pkcs11-0.7.0-2.20211109gitb79fd91.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'swtpm / swtpm-devel / swtpm-libs / swtpm-tools / swtpm-tools-pkcs11');
}
