...
# extracted from VMware Security Advisory PHSA-2022-4.0-0142. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Httpd PHSA-2022-4.0-0142");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the httpd package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-142.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'httpd-2.4.52-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'httpd-devel-2.4.52-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'httpd-docs-2.4.52-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'httpd-tools-2.4.52-1.ph4')) flag++;
