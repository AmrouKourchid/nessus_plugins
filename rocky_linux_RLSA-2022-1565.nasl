...
# Rocky Linux Security Advisory RLSA-2022:1565.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2022:1565");

  script_name(english:"Rocky Linux 8 : container-tools:3.0 (RLSA-2022:1565)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Rocky Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Rocky Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
RLSA-2022:1565 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2022:1565");
...
var appstreams = {
    'container-tools:3.0': [
      {'reference':'buildah-1.19.9-2.module+el8.5.0+769+55ca48e8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'buildah-1.19.9-2.module+el8.5.0+769+55ca48e8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'buildah-debuginfo-1.19.9-2.module+el8.5.0+769+55ca48e8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'buildah-debuginfo-1.19.9-2.module+el8.5.0+769+55ca48e8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'buildah-debugsource-1.19.9-2.module+el8.5.0+769+55ca48e8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'buildah-debugsource-1.19.9-2.module+el8.5.0+769+55ca48e8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'buildah-tests-1.19.9-2.module+el8.5.0+769+55ca48e8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'buildah-tests-1.19.9-2.module+el8.5.0+769+55ca48e8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'buildah-tests-debuginfo-1.19.9-2.module+el8.5.0+769+55ca48e8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'buildah-tests-debuginfo-1.19.9-2.module+el8.5.0+769+55ca48e8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
