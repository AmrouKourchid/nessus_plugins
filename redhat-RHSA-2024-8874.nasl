...
# extracted from Red Hat Security Advisory RHSA-2024:8874. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:8874");

  script_name(english:"RHEL 8 : haproxy (RHSA-2024:8874)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_8874.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c6a4fe5e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:8874");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL haproxy package based on the guidance in RHSA-2024:8874.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'haproxy-1.8.27-4.el8_6.1', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'haproxy-1.8.27-4.el8_6.1', 'sp':'6', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
