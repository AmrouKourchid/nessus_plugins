...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : graphviz (EulerOS-SA-2019-1677)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1677
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0c794011");
...
pkgs = ["graphviz-2.30.1-21.h3.eulerosv2r7",
        "graphviz-tcl-2.30.1-21.h3.eulerosv2r7"];
