...
if (description)
{
  ...
  script_cve_id("CVE-2021-23240");
  script_xref(name:"IAVA", value:"2021-A-0053");

  script_name(english:"NewStart CGSL MAIN 6.02 : sudo Vulnerability (NS-SA-2022-0100)");

  script_set_attribute(attribute:"synopsis", value:
"The remote NewStart CGSL host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 6.02, has sudo packages installed that are affected by a
vulnerability:
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/info/CVE-2021-23240");
...
var pkgs = {
  'CGSL MAIN 6.02': [
    'sudo-1.8.29-6.el8_3.1.cgslv6_2.6.g458285e'
  ]
};
