...
# SUSE update advisory SUSE-SU-2023:2244-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:2244-1");

  script_name(english:"SUSE SLES15 Security Update : ucode-intel (SUSE-SU-2023:2244-1)");
...
in the SUSE-SU-2023:2244-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://lists.suse.com/pipermail/sle-updates/2023-May/029456.html");
...
var pkgs = [
    {'reference':'ucode-intel-20230512-150100.3.220.1', 'sp':'1', 'cpu':'x86_64', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.1']},
    {'reference':'ucode-intel-20230512-150100.3.220.1', 'sp':'1', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-LTSS-release-15.1', 'sles-ltss-release-15.1']}
];
