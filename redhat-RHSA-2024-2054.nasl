...
# extracted from Red Hat Security Advisory RHSA-2024:2054. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2024-28180", "CVE-2024-3177");
  script_xref(name:"RHSA", value:"2024:2054");

  script_name(english:"RHEL 8 / 9 : OpenShift Container Platform 4.14.23 (RHSA-2024:2054)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for OpenShift Container Platform 4.14.23.");
...
referenced in the RHSA-2024:2054 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.14.23. See the
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2054.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?17cfca31");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2268854");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2054");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.14.23 package based on the guidance in RHSA-2024:2054.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openshift-hyperkube-4.14.0-202404231437.p0.g401bb48.assembly.stream.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-3177']},
      {'reference':'skopeo-1.11.3-0.1.rhaos4.14.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-28180']},
      {'reference':'skopeo-tests-1.11.3-0.1.rhaos4.14.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-28180']}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'openshift-hyperkube-4.14.0-202404231437.p0.g401bb48.assembly.stream.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-3177']},
      {'reference':'skopeo-1.11.3-0.1.rhaos4.14.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-28180']},
      {'reference':'skopeo-tests-1.11.3-0.1.rhaos4.14.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-28180']}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'openshift-hyperkube / skopeo / skopeo-tests');
}
