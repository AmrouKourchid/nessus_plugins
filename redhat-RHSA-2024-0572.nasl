...
# extracted from Red Hat Security Advisory RHSA-2024:0572. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:0572");

  script_name(english:"RHEL 8 : oniguruma (RHSA-2024:0572)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for oniguruma.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:0572 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0572.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e2cf39d9");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0572");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL oniguruma package based on the guidance in RHSA-2024:0572.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'oniguruma-6.8.2-2.1.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'oniguruma-devel-6.8.2-2.1.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
