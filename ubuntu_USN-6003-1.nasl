...
# extracted from Ubuntu Security Notice USN-6003-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6003-1");

  script_name(english:"Ubuntu 16.04 ESM : Emacs vulnerability (USN-6003-1)");
...
USN-6003-1 advisory.
    ...
    Xi Lu discovered that Emacs did not properly handle certain inputs. An attacker could possibly use this
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6003-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'emacs24', 'pkgver': '24.5+1-6ubuntu1.1+esm3', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'emacs24-bin-common', 'pkgver': '24.5+1-6ubuntu1.1+esm3', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'emacs24-common', 'pkgver': '24.5+1-6ubuntu1.1+esm3', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'emacs24-el', 'pkgver': '24.5+1-6ubuntu1.1+esm3', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'emacs24-lucid', 'pkgver': '24.5+1-6ubuntu1.1+esm3', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'emacs24-nox', 'pkgver': '24.5+1-6ubuntu1.1+esm3', 'ubuntu_pro': TRUE}
];
