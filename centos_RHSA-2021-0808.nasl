...
# extracted from Red Hat Security Advisory RHSA-2021:0808 and
# CentOS Errata and Security Advisory 2021:0808 respectively.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : wpa_supplicant (RHSA-2021:0808)");
...
var pkgs = [
    {'reference':'wpa_supplicant-2.6-12.el7', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'wpa_supplicant-2.6-12.el7', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
