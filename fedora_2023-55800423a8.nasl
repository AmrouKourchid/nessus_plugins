...
# extracted from Fedora Security Advisory FEDORA-2023-55800423a8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-55800423a8");

  script_name(english:"Fedora 38 : libssh (2023-55800423a8)");
...
FEDORA-2023-55800423a8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-55800423a8");
...
var pkgs = [
    {'reference':'libssh-0.10.6-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
