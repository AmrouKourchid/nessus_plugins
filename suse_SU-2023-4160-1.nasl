...
# SUSE update advisory SUSE-SU-2023:4160-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:4160-1");

  script_name(english:"SUSE SLES15 Security Update : suse-module-tools (SUSE-SU-2023:4160-1)");
...
referenced in the SUSE-SU-2023:4160-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-October/016806.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4e3280a4");
...
var pkgs = [
    {'reference':'suse-module-tools-15.1.25-150100.3.25.1', 'sp':'1', 'cpu':'x86_64', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.1']},
    {'reference':'suse-module-tools-15.1.25-150100.3.25.1', 'sp':'1', 'cpu':'aarch64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-LTSS-release-15.1']},
    {'reference':'suse-module-tools-15.1.25-150100.3.25.1', 'sp':'1', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-LTSS-release-15.1']},
    {'reference':'suse-module-tools-15.1.25-150100.3.25.1', 'sp':'1', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-ltss-release-15.1']}
];
