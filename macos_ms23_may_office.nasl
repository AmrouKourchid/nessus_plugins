...
if (description)
{
  ...
  script_cve_id("CVE-2023-24953", "CVE-2023-29344");
  script_xref(name:"IAVA", value:"2023-A-0245-S");

  script_name(english:"Security Updates for Microsoft Office Products (May 2023) (macOS)");

  script_set_attribute(attribute:"synopsis", value:
"The Microsoft Office product installed on the remote host is affected by multiple vulnerabilities");
  script_set_attribute(attribute:"description", value:
"The version of Microsoft Office for Mac installed on the remote host is affected by multiple remote code execution
vulnerabilities as referenced in the may-16-2023 advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  # https://learn.microsoft.com/en-us/officeupdates/release-notes-office-for-mac#may-16-2023
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e6c255af");
  script_set_attribute(attribute:"solution", value:
"Update to Office for Mac version 16.73 or later.");
...
var constraints = [
  { 'fixed_version' : '16.73', 'fixed_display' : 'Version 16.73 (Build 23051401)' }
];
