...
the ELSA-2014-3095 advisory.
    ...
    - Update source to 1.3.2 from https://github.com/docker/docker/releases/tag/v1.3.2
      ...
      The '--insecure-registry' flag of the 'docker run' command has undergone several refinements and
    additions.
      You can now specify a sub-net in order to set a range of registries which the Docker daemon will
    consider insecure.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2014-3095.html");
  script_set_attribute(attribute:"solution", value:
"Update the affected docker, docker-devel and / or docker-pkg-devel packages.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:L/I:L/A:L");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-6407");
...
var pkgs = [
    {'reference':'docker-1.3.2-1.0.1.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'docker-devel-1.3.2-1.0.1.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'docker-pkg-devel-1.3.2-1.0.1.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'docker-1.3.2-1.0.1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'docker-devel-1.3.2-1.0.1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'docker-pkg-devel-1.3.2-1.0.1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
];
