...
# extracted from Red Hat Security Advisory RHSA-2016:0085. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2016:0085");

  script_name(english:"RHEL 6 : qemu-kvm-rhev (RHSA-2016:0085)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for qemu-kvm-rhev.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 6 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2016:0085 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2016/rhsa-2016_0085.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?01489e32");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1296060");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2016:0085");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL qemu-kvm-rhev package based on the guidance in RHSA-2016:0085.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'qemu-img-rhev-0.12.1.2-2.479.el6_7.4', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'openstack-'},
      {'reference':'qemu-kvm-rhev-0.12.1.2-2.479.el6_7.4', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'openstack-'},
      {'reference':'qemu-kvm-rhev-tools-0.12.1.2-2.479.el6_7.4', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'openstack-'}
    ]
  }
];
