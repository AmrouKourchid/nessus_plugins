...
# extracted from Red Hat Security Advisory jasperreports-server-pro. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : jasperreports-server-pro (Unpatched Vulnerability) (deprecated)");
