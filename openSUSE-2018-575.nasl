...
# extracted from openSUSE Security Update openSUSE-2018-575.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : MozillaFirefox / mozilla-nss (openSUSE-2018-575)");
...
changes are included in NSS :
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1093059");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1094747");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1096449");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1096515");
...
if ( rpm_check(release:"SUSE42.3", reference:"libfreebl3-3.36.4-50.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libfreebl3-debuginfo-3.36.4-50.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libsoftokn3-3.36.4-50.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libsoftokn3-debuginfo-3.36.4-50.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"mozilla-nss-3.36.4-50.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"mozilla-nss-certs-3.36.4-50.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"mozilla-nss-certs-debuginfo-3.36.4-50.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"mozilla-nss-debuginfo-3.36.4-50.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"mozilla-nss-debugsource-3.36.4-50.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"mozilla-nss-devel-3.36.4-50.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"mozilla-nss-sysinit-3.36.4-50.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"mozilla-nss-sysinit-debuginfo-3.36.4-50.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"mozilla-nss-tools-3.36.4-50.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"mozilla-nss-tools-debuginfo-3.36.4-50.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", cpu:"x86_64", reference:"MozillaFirefox-60.0.2-101.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", cpu:"x86_64", reference:"MozillaFirefox-branding-upstream-60.0.2-101.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", cpu:"x86_64", reference:"MozillaFirefox-buildsymbols-60.0.2-101.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", cpu:"x86_64", reference:"MozillaFirefox-debuginfo-60.0.2-101.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", cpu:"x86_64", reference:"MozillaFirefox-debugsource-60.0.2-101.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", cpu:"x86_64", reference:"MozillaFirefox-devel-60.0.2-101.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", cpu:"x86_64", reference:"MozillaFirefox-translations-common-60.0.2-101.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", cpu:"x86_64", reference:"MozillaFirefox-translations-other-60.0.2-101.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", cpu:"x86_64", reference:"libfreebl3-32bit-3.36.4-50.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", cpu:"x86_64", reference:"libfreebl3-debuginfo-32bit-3.36.4-50.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", cpu:"x86_64", reference:"libsoftokn3-32bit-3.36.4-50.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", cpu:"x86_64", reference:"libsoftokn3-debuginfo-32bit-3.36.4-50.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", cpu:"x86_64", reference:"mozilla-nss-32bit-3.36.4-50.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", cpu:"x86_64", reference:"mozilla-nss-certs-32bit-3.36.4-50.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", cpu:"x86_64", reference:"mozilla-nss-certs-debuginfo-32bit-3.36.4-50.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", cpu:"x86_64", reference:"mozilla-nss-debuginfo-32bit-3.36.4-50.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", cpu:"x86_64", reference:"mozilla-nss-sysinit-32bit-3.36.4-50.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", cpu:"x86_64", reference:"mozilla-nss-sysinit-debuginfo-32bit-3.36.4-50.1") ) flag++;
