...
# extracted from Amazon Linux 2 Security Advisory ALAS-2020-1468.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2020-1468");

  script_name(english:"Amazon Linux 2 : thunderbird (ALAS-2020-1468)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of thunderbird installed on the remote host is prior to 68.9.0-1. It is, therefore, affected by multiple
vulnerabilities as referenced in the ALAS2-2020-1468 advisory.
    ...
    in a crash. We presume that with enough effort that it could be exploited to run arbitrary code.
    (CVE-2020-12406)
    ...
    resulting in memory corruption and a potentially exploitable crash. (CVE-2020-12417)

    The Mozilla Foundation Security Advisory describes this flaw as:

    Manipulating individual parts of a URL object could have caused an out-of-bounds read, leaking process
    memory to malicious JavaScript. (CVE-2020-12418)
    ...
    leading to memory corruption and a potentially exploitable crash. (CVE-2020-12420)
    ...
    silently without notification to the user. (CVE-2020-12421)

Tenable has extracted the preceding description block directly from the tested product security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2020-1468.html");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/cve/html/CVE-2020-12398.html");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/cve/html/CVE-2020-12405.html");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/cve/html/CVE-2020-12406.html");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/cve/html/CVE-2020-12410.html");
...
var pkgs = [
    {'reference':'thunderbird-68.9.0-1.amzn2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'thunderbird-debuginfo-68.9.0-1.amzn2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
