...
server." );
 ...
 script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/837964");
...
bind = 
        ...
        der_encode(tag:BER_AUTHENTICATION_TAG, data:"");
...
for (var i=0; i<max_index(data); i++)
{
  if (data[i][0] == "supportedLDAPVersion")
  {
    data = data[i];
    break;
  }
...
if (data[0] != "supportedLDAPVersion")
  exit(1, "ldap_parse_search_entry() failed for port " + port);
