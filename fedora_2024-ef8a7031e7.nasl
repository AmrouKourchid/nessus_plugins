...
# extracted from Fedora Security Advisory FEDORA-2024-ef8a7031e7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-ef8a7031e7");
  script_xref(name:"IAVA", value:"2024-A-0442-S");

  script_name(english:"Fedora 39 : bind / bind-dyndb-ldap (2024-ef8a7031e7)");
...
FEDORA-2024-ef8a7031e7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-ef8a7031e7");
...
var pkgs = [
    {'reference':'bind-9.18.28-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
    {'reference':'bind-dyndb-ldap-11.10-26.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
