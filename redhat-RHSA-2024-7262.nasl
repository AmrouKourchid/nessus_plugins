...
# extracted from Red Hat Security Advisory RHSA-2024:7262. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:7262");

  script_name(english:"RHEL 8 : osbuild-composer (RHSA-2024:7262)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for osbuild-composer.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:7262 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_7262.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9d5e7566");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:7262");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL osbuild-composer package based on the guidance in RHSA-2024:7262.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'osbuild-composer-101-2.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'osbuild-composer-core-101-2.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'osbuild-composer-worker-101-2.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
