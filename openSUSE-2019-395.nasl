...
# extracted from openSUSE Security Update openSUSE-2019-395.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : enigmail (openSUSE-2019-395) (EFAIL)");
...
if ( rpm_check(release:"SUSE15.0", reference:"enigmail-2.0.5-lp150.2.6.1") ) flag++;
