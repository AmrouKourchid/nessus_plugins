...
# extracted from Oracle Linux Security Advisory ELSA-2022-7970.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : protobuf (ELSA-2022-7970)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2022-7970.html");
...
var pkgs = [
    ...
    {'reference':'python3-protobuf-3.14.0-13.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'python3-protobuf-3.14.0-13.el9', 'cpu':'i686', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'python3-protobuf-3.14.0-13.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
