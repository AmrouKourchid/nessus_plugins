...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : polkit (EulerOS-SA-2019-1752)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1752
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ccfd438a");
...
pkgs = ["polkit-0.112-7.h4",
        "polkit-devel-0.112-7.h4",
        "polkit-docs-0.112-7.h4"];
