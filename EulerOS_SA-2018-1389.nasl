...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : jasper (EulerOS-SA-2018-1389)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1389
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6c21dc50");
...
pkgs = ["jasper-libs-1.900.1-33.h1"];
