...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Cifs PHSA-2021-3.0-0236");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the cifs package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-3.0-236.md");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'cifs-utils-6.8-3.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'cifs-utils-devel-6.8-3.ph3')) flag++;
