...
# extracted from Red Hat Security Advisory RHSA-2025:0739. The text
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-31426");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_0739.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c6ef5d94");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:0739");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL mariadb:10.5 package based on the guidance in RHSA-2025:0739.");
  ...
  'mariadb:10.5': [
    {
      ...
      'pkgs': [
        {'reference':'galera-26.4.20-1.module+el8.10.0+22630+cacda3f1', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'Judy-1.0.5-18.module+el8.10.0+22630+cacda3f1', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mariadb-10.5.27-1.module+el8.10.0+22630+cacda3f1', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
        {'reference':'mariadb-backup-10.5.27-1.module+el8.10.0+22630+cacda3f1', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
        {'reference':'mariadb-common-10.5.27-1.module+el8.10.0+22630+cacda3f1', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
        {'reference':'mariadb-devel-10.5.27-1.module+el8.10.0+22630+cacda3f1', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
        {'reference':'mariadb-embedded-10.5.27-1.module+el8.10.0+22630+cacda3f1', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
        {'reference':'mariadb-embedded-devel-10.5.27-1.module+el8.10.0+22630+cacda3f1', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
        {'reference':'mariadb-errmsg-10.5.27-1.module+el8.10.0+22630+cacda3f1', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
        {'reference':'mariadb-gssapi-server-10.5.27-1.module+el8.10.0+22630+cacda3f1', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
        {'reference':'mariadb-oqgraph-engine-10.5.27-1.module+el8.10.0+22630+cacda3f1', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
        {'reference':'mariadb-pam-10.5.27-1.module+el8.10.0+22630+cacda3f1', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
        {'reference':'mariadb-server-10.5.27-1.module+el8.10.0+22630+cacda3f1', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
        {'reference':'mariadb-server-galera-10.5.27-1.module+el8.10.0+22630+cacda3f1', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
        {'reference':'mariadb-server-utils-10.5.27-1.module+el8.10.0+22630+cacda3f1', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
        {'reference':'mariadb-test-10.5.27-1.module+el8.10.0+22630+cacda3f1', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'}
      ]
    }
  ]
};
