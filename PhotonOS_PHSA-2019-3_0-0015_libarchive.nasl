...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Libarchive PHSA-2019-3.0-0015");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libarchive-3.3.3-3.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libarchive-debuginfo-3.3.3-3.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libarchive-devel-3.3.3-3.ph3')) flag++;
