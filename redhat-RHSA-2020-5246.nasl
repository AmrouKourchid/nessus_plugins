...
# extracted from Red Hat Security Advisory RHSA-2020:5246. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:5246");
  script_xref(name:"CEA-ID", value:"CEA-2021-0004");
  script_xref(name:"CEA-ID", value:"CEA-2021-0025");

  script_name(english:"RHEL 7 : rh-mariadb103-mariadb and rh-mariadb103-galera (RHSA-2020:5246)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for rh-mariadb103-mariadb / rh-mariadb103-galera.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2020:5246 advisory.
    ...
    The following packages have been upgraded to a later upstream version: rh-mariadb103-mariadb (10.3.27),
    rh-mariadb103-galera (25.3.31). (BZ#1894122, BZ#1894124)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_5246.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a30db73d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:5246");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1894070");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1894105");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1894114");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1894122");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1894919");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rh-mariadb103-mariadb / rh-mariadb103-galera packages based on the guidance in RHSA-2020:5246.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-mariadb103-galera-25.3.31-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-mariadb103-mariadb-10.3.27-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      {'reference':'rh-mariadb103-mariadb-backup-10.3.27-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      {'reference':'rh-mariadb103-mariadb-backup-syspaths-10.3.27-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      {'reference':'rh-mariadb103-mariadb-common-10.3.27-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      {'reference':'rh-mariadb103-mariadb-config-10.3.27-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      {'reference':'rh-mariadb103-mariadb-config-syspaths-10.3.27-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      {'reference':'rh-mariadb103-mariadb-connect-engine-10.3.27-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      {'reference':'rh-mariadb103-mariadb-devel-10.3.27-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      {'reference':'rh-mariadb103-mariadb-errmsg-10.3.27-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      {'reference':'rh-mariadb103-mariadb-gssapi-server-10.3.27-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      {'reference':'rh-mariadb103-mariadb-oqgraph-engine-10.3.27-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      {'reference':'rh-mariadb103-mariadb-server-10.3.27-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      {'reference':'rh-mariadb103-mariadb-server-galera-10.3.27-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      {'reference':'rh-mariadb103-mariadb-server-galera-syspaths-10.3.27-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      {'reference':'rh-mariadb103-mariadb-server-syspaths-10.3.27-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      {'reference':'rh-mariadb103-mariadb-server-utils-10.3.27-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      {'reference':'rh-mariadb103-mariadb-server-utils-syspaths-10.3.27-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      {'reference':'rh-mariadb103-mariadb-syspaths-10.3.27-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      {'reference':'rh-mariadb103-mariadb-test-10.3.27-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'}
    ]
  }
];
