...
# extracted from Fedora Security Advisory FEDORA-2024-11821b16ac
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-11821b16ac");

  script_name(english:"Fedora 39 : gdcm (2024-11821b16ac)");
...
FEDORA-2024-11821b16ac advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-11821b16ac");
...
var pkgs = [
    {'reference':'gdcm-3.0.23-5.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
