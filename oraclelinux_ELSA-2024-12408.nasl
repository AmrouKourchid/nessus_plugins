...
# extracted from Oracle Linux Security Advisory ELSA-2024-12408.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : edk2 (ELSA-2024-12408)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 7 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ELSA-2024-12408 advisory.
    ...
    * Tue Nov 23 2021 Aaron Young <aaron.young@oracle.com>
    - Create new 1.5.0 release for OL7 which includes the following fixed CVEs:
      {CVE-2021-23840} {CVE-2021-23841} {CVE-2021-38575}

    * Thu Feb 18 2021 Aaron Young <aaron.young@oracle.com>
    - Create new 1.4.0 release for OL7 which includes the following fixed CVEs:
      {CVE-2019-14584} {CVE-2019-14562} {CVE-2019-11098} {CVE-2019-14559} {CVE-2019-14575} {CVE-2019-14559}
    {CVE-2019-14587} {CVE-2019-14558} {CVE-2019-14586} {CVE-2019-14563}

    * Sat Oct 10 2020 Aaron Young <aaron.young@oracle.com>
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-12408.html");
  script_set_attribute(attribute:"solution", value:
"Update the affected AAVMF and / or OVMF packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"cpe:/a:oracle:linux:7::developer_kvm_utils");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:AAVMF");
...
var pkgs = [
    {'reference':'AAVMF-1.7.0-5.el7', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'OVMF-1.7.0-5.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'AAVMF / OVMF');
}
