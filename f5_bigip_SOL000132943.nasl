...
# extracted from F5 Networks BIG-IP Solution K000132943.
#
# @NOAGENT@
##
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : OpenSSL vulnerability (K000132943)");

  script_set_attribute(attribute:"synopsis", value:
"The remote device is missing a vendor-supplied security patch.");
  script_set_attribute(attribute:"description", value:
"The version of F5 Networks BIG-IP installed on the remote host is prior to 15.1.10 / 16.1.5 / 17.1.1 17.1.0.1. It is,
therefore, affected by a vulnerability as referenced in the K000132943 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K000132943");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K000132943.");
  script_set_attribute(attribute:"workaround_type", value:"config_change");
  script_set_attribute(attribute:"workaround", value:
"F5 lists a workaround with instructions listed at https://my.f5.com/manage/s/article/K000132943 that can be achieved using
the following steps:

  1. Disable RSA ciphers for the Configuration utility, ClientSSL and ServerSSL profiles, and HTTPS health monitors.
...
Tenable is not responsible for any negative effects that may occur from enacting this workaround.");
  script_set_attribute(attribute:"workaround_publication_date", value:"2022/12/15");
...
var vmatrix = {
  'AFM': {
    ...
    'unaffected': [
      '17.1.1-17.1.0.1','16.1.5','15.1.10'
    ],
  },
  'APM': {
    'affected': [
