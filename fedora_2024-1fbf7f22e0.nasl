...
# extracted from Fedora Security Advisory FEDORA-2024-1fbf7f22e0
#
...
if (description)
{
  ...
  script_cve_id("CVE-2024-42458");
  script_xref(name:"FEDORA", value:"2024-1fbf7f22e0");

  script_name(english:"Fedora 40 : neatvnc (2024-1fbf7f22e0)");
...
FEDORA-2024-1fbf7f22e0 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-1fbf7f22e0");
  script_set_attribute(attribute:"solution", value:
"Update the affected neatvnc package.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-42458");
...
var pkgs = [
    {'reference':'neatvnc-0.8.1-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'neatvnc');
}
