...
# AlmaLinux Security Advisory ALSA-2024:0827.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:0827");

  script_name(english:"AlmaLinux 8 : .NET 8.0 (ALSA-2024:0827)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ALSA-2024:0827 advisory.

  - .NET Denial of Service Vulnerability (CVE-2024-21386, CVE-2024-21404)

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2024-0827.html");
...
var pkgs = [
    ...
    {'reference':'aspnetcore-runtime-dbg-8.0-8.0.2-2.el8_9', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'aspnetcore-runtime-dbg-8.0-8.0.2-2.el8_9', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'dotnet-runtime-dbg-8.0-8.0.2-2.el8_9', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'dotnet-runtime-dbg-8.0-8.0.2-2.el8_9', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'dotnet-sdk-dbg-8.0-8.0.102-2.el8_9', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'dotnet-sdk-dbg-8.0-8.0.102-2.el8_9', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
