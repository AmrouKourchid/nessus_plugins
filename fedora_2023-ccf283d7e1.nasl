...
# extracted from Fedora Security Advisory FEDORA-2023-ccf283d7e1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-ccf283d7e1");

  script_name(english:"Fedora 38 : vim (2023-ccf283d7e1)");
...
FEDORA-2023-ccf283d7e1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-ccf283d7e1");
...
var pkgs = [
    {'reference':'vim-9.0.1367-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
