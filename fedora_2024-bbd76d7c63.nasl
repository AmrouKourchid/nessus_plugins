...
# extracted from Fedora Security Advisory FEDORA-2024-bbd76d7c63
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-bbd76d7c63");

  script_name(english:"Fedora 38 : python-dns (2024-bbd76d7c63)");
...
FEDORA-2024-bbd76d7c63 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-bbd76d7c63");
  script_set_attribute(attribute:"solution", value:
"Update the affected python-dns package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:python-dns");
...
var pkgs = [
    {'reference':'python-dns-2.3.0-3.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
