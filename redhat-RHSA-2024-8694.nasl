...
# extracted from Red Hat Security Advisory RHSA-2024:8694. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:8694");

  script_name(english:"RHEL 8 / 9 : OpenShift Container Platform 4.12.68 (RHSA-2024:8694)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for OpenShift Container Platform 4.12.68.");
...
referenced in the RHSA-2024:8694 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.12.68. See the
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_8694.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?10f332ae");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:8694");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.12.68 package based on the guidance in RHSA-2024:8694.");
  ...
  script_cwe_id(22, 59, 200, 674, 1325);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'containernetworking-plugins-1.4.0-4.rhaos4.12.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-34156']},
      {'reference':'cri-o-1.25.5-30.rhaos4.12.git53dc492.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-9341', 'CVE-2024-9676']},
      {'reference':'podman-4.4.1-8.rhaos4.12.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-34155', 'CVE-2024-34156', 'CVE-2024-34158']},
      {'reference':'podman-catatonit-4.4.1-8.rhaos4.12.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-34155', 'CVE-2024-34156', 'CVE-2024-34158']},
      {'reference':'podman-docker-4.4.1-8.rhaos4.12.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-34155', 'CVE-2024-34156', 'CVE-2024-34158']},
      {'reference':'podman-gvproxy-4.4.1-8.rhaos4.12.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-34155', 'CVE-2024-34156', 'CVE-2024-34158']},
      {'reference':'podman-plugins-4.4.1-8.rhaos4.12.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-34155', 'CVE-2024-34156', 'CVE-2024-34158']},
      {'reference':'podman-remote-4.4.1-8.rhaos4.12.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-34155', 'CVE-2024-34156', 'CVE-2024-34158']},
      {'reference':'podman-tests-4.4.1-8.rhaos4.12.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-34155', 'CVE-2024-34156', 'CVE-2024-34158']},
      {'reference':'skopeo-1.9.4-7.rhaos4.12.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-34156']},
      {'reference':'skopeo-tests-1.9.4-7.rhaos4.12.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-34156']}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'openstack-ironic-21.0.1-0.20240913135525.114badc.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-44082']},
      {'reference':'openstack-ironic-api-21.0.1-0.20240913135525.114badc.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-44082']},
      {'reference':'openstack-ironic-common-21.0.1-0.20240913135525.114badc.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-44082']},
      {'reference':'openstack-ironic-conductor-21.0.1-0.20240913135525.114badc.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-44082']},
      {'reference':'openstack-ironic-dnsmasq-tftp-server-21.0.1-0.20240913135525.114badc.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-44082']},
      {'reference':'python3-ironic-tests-21.0.1-0.20240913135525.114badc.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-44082']}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'cri-o-1.25.5-5.rhaos4.12.git53dc492.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-9341', 'CVE-2024-9676']},
      {'reference':'podman-4.2.0-12.rhaos4.12.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-34155', 'CVE-2024-34156', 'CVE-2024-34158']},
      {'reference':'podman-catatonit-4.2.0-12.rhaos4.12.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-34155', 'CVE-2024-34156', 'CVE-2024-34158']},
      {'reference':'podman-docker-4.2.0-12.rhaos4.12.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-34155', 'CVE-2024-34156', 'CVE-2024-34158']},
      {'reference':'podman-gvproxy-4.2.0-12.rhaos4.12.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-34155', 'CVE-2024-34156', 'CVE-2024-34158']},
      {'reference':'podman-plugins-4.2.0-12.rhaos4.12.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-34155', 'CVE-2024-34156', 'CVE-2024-34158']},
      {'reference':'podman-remote-4.2.0-12.rhaos4.12.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-34155', 'CVE-2024-34156', 'CVE-2024-34158']},
      {'reference':'podman-tests-4.2.0-12.rhaos4.12.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-34155', 'CVE-2024-34156', 'CVE-2024-34158']},
      {'reference':'skopeo-1.9.4-7.rhaos4.12.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-34156']},
      {'reference':'skopeo-tests-1.9.4-7.rhaos4.12.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-34156']}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'containernetworking-plugins / cri-o / openstack-ironic / etc');
}
