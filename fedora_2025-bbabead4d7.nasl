...
# extracted from Fedora Security Advisory FEDORA-2025-bbabead4d7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-bbabead4d7");

  script_name(english:"Fedora 41 : rust-routinator (2025-bbabead4d7)");
...
FEDORA-2025-bbabead4d7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-bbabead4d7");
...
var pkgs = [
    {'reference':'rust-routinator-0.14.1-2.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
