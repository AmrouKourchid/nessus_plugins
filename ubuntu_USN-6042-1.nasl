...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 ESM / 18.04 LTS / 20.04 LTS / 22.04 LTS / 23.04 : Cloud-init vulnerability (USN-6042-1)");
...
a vulnerability as referenced in the USN-6042-1 advisory.

    James Golovich discovered that sensitive data could be exposed in logs. An attacker could use this
    information to find hashed passwords and possibly escalate their privilege.
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'cloud-init', 'pkgver': '21.1-19-gbad84ad4-0ubuntu1~16.04.4', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'ec2-init', 'pkgver': '21.1-19-gbad84ad4-0ubuntu1~16.04.4', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'grub-legacy-ec2', 'pkgver': '21.1-19-gbad84ad4-0ubuntu1~16.04.4', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'cloud-init', 'pkgver': '23.1.2-0ubuntu0~18.04.1', 'ubuntu_pro': FALSE},
    {'osver': '20.04', 'pkgname': 'cloud-init', 'pkgver': '23.1.2-0ubuntu0~20.04.1', 'ubuntu_pro': FALSE},
    {'osver': '22.04', 'pkgname': 'cloud-init', 'pkgver': '23.1.2-0ubuntu0~22.04.1', 'ubuntu_pro': FALSE},
    {'osver': '23.04', 'pkgname': 'cloud-init', 'pkgver': '23.1.2-0ubuntu0~23.04.1', 'ubuntu_pro': FALSE}
];
