...
# extracted from Amazon Linux 2023 Security Advisory ALAS2023-2025-886.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2023 : ecs-init (ALAS2023-2025-886)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2023 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"It is, therefore, affected by a vulnerability as referenced in the ALAS2023-2025-886 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2023/ALAS-2025-886.html");
...
"Run 'dnf update ecs-init --releasever 2023.6.20250303' to update your system.");
...
var pkgs = [
    {'reference':'ecs-init-1.89.1-1.amzn2023', 'cpu':'aarch64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ecs-init-1.89.1-1.amzn2023', 'cpu':'x86_64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE}
];
