...
# extracted from Red Hat Security Advisory RHSA-2024:8680. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:8680");

  script_name(english:"RHEL 9 : mod_http2 (RHSA-2024:8680)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for mod_http2.");
...
the RHSA-2024:8680 advisory.

    The mod_h2 Apache httpd module implements the HTTP2 protocol (h2+h2c) on top of libnghttp2 for httpd 2.4
    servers.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_8680.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a011b3d1");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:8680");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL mod_http2 package based on the guidance in RHSA-2024:8680.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'mod_http2-2.0.26-2.el9_4.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'mod_http2-2.0.26-2.el9_4.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
