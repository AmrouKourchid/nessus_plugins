...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : llvm (EulerOS-SA-2024-1890)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1890
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?362d0220");
...
var pkgs = [
  "llvm-help-10.0.1-1.h3.eulerosv2r10",
  "llvm-libs-10.0.1-1.h3.eulerosv2r10"
];
