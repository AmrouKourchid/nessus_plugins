...
if (description)
{
  ...
  script_name(english:"RHEL 6 : libtasn1 (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2017-6891");
  script_set_attribute(attribute:"cvss4_score_source", value:"CVE-2018-1000654");
