...
# extracted from Fedora Security Advisory FEDORA-2020-fae2e1f2bc.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 33 : 14:tcpdump (2020-fae2e1f2bc)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-fae2e1f2bc");
...
flag = 0;
if (rpm_check(release:"FC33", reference:"tcpdump-4.9.3-5.fc33", epoch:"14")) flag++;
