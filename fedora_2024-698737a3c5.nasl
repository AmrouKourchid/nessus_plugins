...
# extracted from Fedora Security Advisory FEDORA-2024-698737a3c5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-698737a3c5");

  script_name(english:"Fedora 38 : espeak-ng (2024-698737a3c5)");
...
FEDORA-2024-698737a3c5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-698737a3c5");
...
var pkgs = [
    {'reference':'espeak-ng-1.51.1-6.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
