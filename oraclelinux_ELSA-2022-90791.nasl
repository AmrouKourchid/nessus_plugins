...
# extracted from Oracle Linux Security Advisory ELSA-2022-90791.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : ELSA-2022-9079-1: / thunderbird (ELSA-2022-90791)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2022-9079-1.html");
...
var pkgs = [
    {'reference':'thunderbird-102.6.0-2.0.1.el7_9', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'thunderbird-102.6.0-2.0.1.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
