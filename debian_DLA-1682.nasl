...
# extracted from Debian Security Advisory DLA-1682-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1682-1 : uriparser security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2019/02/msg00028.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/jessie/uriparser");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"liburiparser-dev", reference:"0.8.0.1-2+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"liburiparser1", reference:"0.8.0.1-2+deb8u2")) flag++;
