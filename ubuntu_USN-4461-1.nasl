...
# extracted from Ubuntu Security Notice USN-4461-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS : Ark vulnerability (USN-4461-1)");
...
in the USN-4461-1 advisory.

    Dominik Penner discovered that Ark did not properly sanitize zip archive files before performing
    extraction. An attacker could use this to construct a malicious zip archive that, when opened, would
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4461-1");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'ark', 'pkgver': '4:17.12.3-0ubuntu1.1'},
    {'osver': '20.04', 'pkgname': 'ark', 'pkgver': '4:19.12.3-0ubuntu1.1'}
];
