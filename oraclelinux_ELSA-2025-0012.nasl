...
# extracted from Oracle Linux Security Advisory ELSA-2025-0012.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : python-requests (ELSA-2025-0012)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2025-0012.html");
...
var pkgs = [
    {'reference':'python3-requests-2.20.0-5.el8_10', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-requests-2.20.0-5.el8_10', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
