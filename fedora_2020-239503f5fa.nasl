...
# extracted from Fedora Security Advisory FEDORA-2020-239503f5fa.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : resteasy (2020-239503f5fa)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-239503f5fa");
...
flag = 0;
if (rpm_check(release:"FC32", reference:"resteasy-3.0.26-6.fc32")) flag++;
