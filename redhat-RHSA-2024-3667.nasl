...
# extracted from Red Hat Security Advisory RHSA-2024:3667. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:3667");

  script_name(english:"RHEL 8 : cockpit (RHSA-2024:3667)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for cockpit.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:3667 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_3667.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9cc438e6");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2271614");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:3667");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL cockpit package based on the guidance in RHSA-2024:3667.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cockpit-310.4-1.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'cockpit-bridge-310.4-1.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      ...
      {'reference':'cockpit-ws-310.4-1.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
