...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : freetype (EulerOS-SA-2020-1382)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1382
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e59f1248");
...
pkgs = ["freetype-2.4.11-10_1.1.h8",
        "freetype-devel-2.4.11-10_1.1.h8"];
