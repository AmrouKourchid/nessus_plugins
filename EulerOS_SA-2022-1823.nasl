...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : glibc (EulerOS-SA-2022-1823)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1823
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a41ce320");
...
var pkgs = [
  ...
  "libnsl-2.28-63.h67.eulerosv2r10",
  "nscd-2.28-63.h67.eulerosv2r10"
];
