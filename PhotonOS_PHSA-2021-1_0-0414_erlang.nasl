...
if (description)
{
  ...
  script_cve_id("CVE-2021-29221");

  script_name(english:"Photon OS 1.0: Erlang PHSA-2021-1.0-0414");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-29221");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'erlang-19.3-3.ph1')) flag++;
