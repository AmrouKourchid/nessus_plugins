...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : zsh on SL7.x x86_64 (20190806)");
...
"Security Fix(es) :
  ...
  - zsh: Improper handling of shebang line longer than 64
    (CVE-2018-13259)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1908&L=SCIENTIFIC-LINUX-ERRATA&P=10099
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?be2c5489");
  script_set_attribute(attribute:"solution", value:
"Update the affected zsh, zsh-debuginfo and / or zsh-html packages.");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"zsh-5.0.2-33.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"zsh-debuginfo-5.0.2-33.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"zsh-html-5.0.2-33.el7")) flag++;
