...
if (description)
{
  ...
  script_cve_id("CVE-2014-8768");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2014-8768");
...
patch available.
  ...
  - Multiple Integer underflows in the geonet_print function in tcpdump 4.5.0 through 4.6.2, when in verbose
    mode, allow remote attackers to cause a denial of service (segmentation fault and crash) via a crafted
    length value in a Geonet frame. (CVE-2014-8768)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-8768");
