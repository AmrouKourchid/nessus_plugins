...
the USN-5665-1 advisory.
    ...
    this issue to cause applications using PCRE to crash, resulting in a denial of service. (CVE-2017-6004)

    It was discovered that PCRE incorrectly handled certain Unicode encoding. A remote attacker could use this
    issue to cause applications using PCRE to crash, resulting in a denial of service. (CVE-2017-7186)
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libpcre16-3', 'pkgver': '2:8.38-3.1ubuntu0.1~esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libpcre3', 'pkgver': '2:8.38-3.1ubuntu0.1~esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libpcre3-dev', 'pkgver': '2:8.38-3.1ubuntu0.1~esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libpcre32-3', 'pkgver': '2:8.38-3.1ubuntu0.1~esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libpcrecpp0v5', 'pkgver': '2:8.38-3.1ubuntu0.1~esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'pcregrep', 'pkgver': '2:8.38-3.1ubuntu0.1~esm2', 'ubuntu_pro': TRUE}
];
