...
# extracted from Red Hat Security Advisory RHSA-2015:0983. The text 
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2015/rhsa-2015_0983.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0dc4ce53");
  # https://tomcat.apache.org/security-7.html#Fixed_in_Apache_Tomcat_7.0.55
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b752042c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2015:0983");
...
"Update the RHEL tomcat package based on the guidance in RHSA-2015:0983.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'tomcat-7.0.54-2.el7_1', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat-admin-webapps-7.0.54-2.el7_1', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat-docs-webapp-7.0.54-2.el7_1', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat-el-2.2-api-7.0.54-2.el7_1', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat-javadoc-7.0.54-2.el7_1', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat-jsp-2.2-api-7.0.54-2.el7_1', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat-jsvc-7.0.54-2.el7_1', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat-lib-7.0.54-2.el7_1', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat-servlet-3.0-api-7.0.54-2.el7_1', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat-webapps-7.0.54-2.el7_1', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
