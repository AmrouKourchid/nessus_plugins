...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Wget PHSA-2019-3.0-0016");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'wget-1.20.3-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'wget-debuginfo-1.20.3-1.ph3')) flag++;
