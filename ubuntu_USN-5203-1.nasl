...
# extracted from Ubuntu Security Notice USN-5203-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5203-1");

  script_name(english:"Ubuntu 20.04 LTS : Apache Log4j 2 vulnerability (USN-5203-1)");
...
USN-5203-1 advisory.
    ...
    leading to a denial of service. Please see the following link for more information:
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5203-1");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'liblog4j2-java', 'pkgver': '2.17.0-0.20.04.1'}
];
