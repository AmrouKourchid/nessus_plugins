...
if (description)
{
  ...
  script_name(english:"OpenSSL 1.1.1 < 1.1.1o Vulnerability");

  script_set_attribute(attribute:"synopsis", value:
"The remote service is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of OpenSSL installed on the remote host is prior to 1.1.1o. It is, therefore, affected by a vulnerability as
referenced in the 1.1.1o advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4d87f2b7");
...
var constraints = [
  { 'min_version' : '1.1.1', 'fixed_version' : '1.1.1o' }
];
