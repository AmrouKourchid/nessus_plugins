...
if (description)
{
  ...
  script_name(english:"MariaDB 11.5.0 < 11.5.1");

  script_set_attribute(attribute:"synopsis", value:
"The remote database server is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of MariaDB installed on the remote host is prior to 11.5.1. It is, therefore, affected by a vulnerability as
referenced in the mariadb-1151-release-notes advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://mariadb.com/kb/en/mariadb-1151-release-notes");
  script_set_attribute(attribute:"solution", value:
"Upgrade to MariaDB version 11.5.1 or later.");
...
var constraints = [
  { 'min_version' : '11.5', 'fixed_version' : '11.5.1' }
];
