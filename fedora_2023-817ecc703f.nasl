...
# extracted from Fedora Security Advisory FEDORA-2023-817ecc703f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-817ecc703f");

  script_name(english:"Fedora 39 : xerces-c (2023-817ecc703f)");
...
FEDORA-2023-817ecc703f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-817ecc703f");
...
var pkgs = [
    {'reference':'xerces-c-3.2.5-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
