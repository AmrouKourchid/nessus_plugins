...
# extracted from Fedora Security Advisory FEDORA-2022-8b58806840
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-8b58806840");

  script_name(english:"Fedora 36 : git (2022-8b58806840)");
...
FEDORA-2022-8b58806840 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-8b58806840");
...
var pkgs = [
    {'reference':'git-2.38.1-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
