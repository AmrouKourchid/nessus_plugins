...
# extracted from Debian Security Advisory dla-3593. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3593 : gerbv - security update");
...
dla-3593 advisory.
    ...
    - -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3593-1                debian-lts@lists.debian.org
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-4508");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'gerbv', 'reference': '2.7.0-1+deb10u3'}
];
