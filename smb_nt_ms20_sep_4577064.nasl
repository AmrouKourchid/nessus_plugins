...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"4577070");
  script_xref(name:"MSKB", value:"4577064");
  script_xref(name:"MSFT", value:"MS20-4577070");
  ...
  script_name(english:"KB4577070: Windows Server 2008 September 2020 Security Update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 4577070
or cumulative update 4577064. It is, therefore, affected by
multiple vulnerabilities :
  ...
  - An elevation of privilege vulnerability exists when the
    ...
    (CVE-2020-1559)");
  # https://support.microsoft.com/en-us/help/4577070/windows-server-2008-update
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2cef1869");
...
"Apply Security Only update KB4577070 or Cumulative Update KB4577064.");
...
if (
  smb_check_rollup(os:'6.0', 
                   ...
                   rollup_date:'09_2020',
                   bulletin:bulletin,
                   rollup_kb_list:[4577064, 4577070])
)
{
