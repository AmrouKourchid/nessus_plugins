...
# extracted from Red Hat Security Advisory RHSA-2022:7191. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:7191");

  script_name(english:"RHEL 8 : device-mapper-multipath (RHSA-2022:7191)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_7191.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1c62b6a9");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2133988");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:7191");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL device-mapper-multipath package based on the guidance in RHSA-2022:7191.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'device-mapper-multipath-0.8.4-10.el8_4.4', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
