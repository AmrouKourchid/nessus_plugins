...
# extracted from Fedora Security Advisory FEDORA-2023-7e04833463
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-7e04833463");

  script_name(english:"Fedora 36 : haproxy (2023-7e04833463)");
...
FEDORA-2023-7e04833463 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-7e04833463");
...
var pkgs = [
    {'reference':'haproxy-2.4.22-2.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
