...
# extracted from Ubuntu Security Notice USN-6982-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6982-1");

  script_name(english:"Ubuntu 24.04 LTS : Dovecot vulnerabilities (USN-6982-1)");
...
the USN-6982-1 advisory.

    It was discovered that Dovecot did not not properly have restrictions on ithe size of address headers. A
    remote attacker could possibly use this issue to cause denial of service. (CVE-2024-23184, CVE-2024-23185)

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6982-1");
...
var pkgs = [
    {'osver': '24.04', 'pkgname': 'dovecot-auth-lua', 'pkgver': '1:2.3.21+dfsg1-2ubuntu6'},
    {'osver': '24.04', 'pkgname': 'dovecot-core', 'pkgver': '1:2.3.21+dfsg1-2ubuntu6'},
    {'osver': '24.04', 'pkgname': 'dovecot-dev', 'pkgver': '1:2.3.21+dfsg1-2ubuntu6'},
    {'osver': '24.04', 'pkgname': 'dovecot-gssapi', 'pkgver': '1:2.3.21+dfsg1-2ubuntu6'},
    {'osver': '24.04', 'pkgname': 'dovecot-imapd', 'pkgver': '1:2.3.21+dfsg1-2ubuntu6'},
    {'osver': '24.04', 'pkgname': 'dovecot-ldap', 'pkgver': '1:2.3.21+dfsg1-2ubuntu6'},
    {'osver': '24.04', 'pkgname': 'dovecot-lmtpd', 'pkgver': '1:2.3.21+dfsg1-2ubuntu6'},
    {'osver': '24.04', 'pkgname': 'dovecot-managesieved', 'pkgver': '1:2.3.21+dfsg1-2ubuntu6'},
    {'osver': '24.04', 'pkgname': 'dovecot-mysql', 'pkgver': '1:2.3.21+dfsg1-2ubuntu6'},
    {'osver': '24.04', 'pkgname': 'dovecot-pgsql', 'pkgver': '1:2.3.21+dfsg1-2ubuntu6'},
    {'osver': '24.04', 'pkgname': 'dovecot-pop3d', 'pkgver': '1:2.3.21+dfsg1-2ubuntu6'},
    {'osver': '24.04', 'pkgname': 'dovecot-sieve', 'pkgver': '1:2.3.21+dfsg1-2ubuntu6'},
    {'osver': '24.04', 'pkgname': 'dovecot-solr', 'pkgver': '1:2.3.21+dfsg1-2ubuntu6'},
    {'osver': '24.04', 'pkgname': 'dovecot-sqlite', 'pkgver': '1:2.3.21+dfsg1-2ubuntu6'},
    {'osver': '24.04', 'pkgname': 'dovecot-submissiond', 'pkgver': '1:2.3.21+dfsg1-2ubuntu6'}
];
