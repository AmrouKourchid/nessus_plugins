...
"The version of Google Chrome installed on the remote Windows host is prior to 118.0.5993.70. It is, therefore, affected
by multiple vulnerabilities as referenced in the 2023_10_stable-channel-update-for-desktop_10 advisory.
...
google_chrome_check_version(installs:installs, fix:'118.0.5993.70', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
