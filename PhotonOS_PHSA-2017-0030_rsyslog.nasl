...
# extracted from VMware Security Advisory PHSA-2017-0030. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Rsyslog PHSA-2017-0030");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the rsyslog package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-63.md");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'rsyslog-8.15.0-6.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'rsyslog-debuginfo-8.15.0-6.ph1')) flag++;
