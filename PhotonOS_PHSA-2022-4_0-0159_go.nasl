...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Go PHSA-2022-4.0-0159");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'go-1.17.2-3.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'go-md2man-2.0.0-9.ph4')) flag++;
