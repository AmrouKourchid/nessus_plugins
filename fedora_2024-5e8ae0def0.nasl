...
# extracted from Fedora Security Advisory FEDORA-2024-5e8ae0def0
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-5e8ae0def0");
  script_xref(name:"IAVA", value:"2024-A-0244-S");

  script_name(english:"Fedora 40 : php (2024-5e8ae0def0)");
...
FEDORA-2024-5e8ae0def0 advisory.

    **PHP version 8.3.6** (11 Apr 2024)

    **Core:**

    * Fixed [GH-13569](https://github.com/php/php-src/issues/13569) (GC buffer unnecessarily grows up to
    GC_MAX_BUF_SIZE when scanning WeakMaps). (Arnaud)
    * Fixed bug [GH-13612](https://github.com/php/php-src/issues/13612) (Corrupted memory in destructor with
    weak references). (nielsdos)
    * Fixed bug [GH-13446](https://github.com/php/php-src/issues/13446) (Restore exception handler after it
    finishes). (ilutov)
    ...
    * Fixed [GH-11086](https://github.com/php/php-src/issues/11086) (FPM: config test runs twice in daemonised
    mode). (Jakub Zelenka)
    ...
    * Fixed bug [GHSA-h746-cjrr-wfmr](https://github.com/php/php-src/security/advisories/GHSA-h746-cjrr-wfmr)
    (password_verify can erroneously return true, opening ATO risk). (**CVE-2024-3096**) (Jakub Zelenka) Fixed
    bug [GHSA-fjp9-9hwx-59fq](https://github.com/php/php-src/security/advisories/GHSA-fjp9-9hwx-59fq)
    (mb_encode_mimeheader runs endlessly for some inputs). (**CVE-2024-2757**) (Alex Dowad)
    * Fix bug [GH-13932](https://github.com/php/php-src/issues/13932) (Attempt to fix mbstring on windows
    build) (msvc). (David Carlier)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-5e8ae0def0");
...
var pkgs = [
    {'reference':'php-8.3.6-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
