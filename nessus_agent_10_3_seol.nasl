...
if (description)
{
  ...
  script_name(english:"Tenable Nessus Agent SEoL (10.3.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Tenable Nessus Agent is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Tenable Nessus Agent is 10.3.x. It is, therefore, no longer maintained by its vendor or
provider.
...
var constraints = [
  { max_branch : '10.3', min_branch : '10.3', seol : 20240531, eseol : 20241130 }
];
