...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : openssh (EulerOS-SA-2021-1159)");
...
vulnerability :
  ...
  - The client side in OpenSSH 5.7 through 8.3 has an
    Observable Discrepancy leading to an information leak
    in the algorithm negotiation. This allows
    man-in-the-middle attackers to target initial
    connection attempts (where no host key for the server
    has been cached by the client).(CVE-2020-14145)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1159
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d875eb64");
...
pkgs = ["openssh-7.8p1-3.h42.eulerosv2r8",
        "openssh-askpass-7.8p1-3.h42.eulerosv2r8",
        "openssh-cavs-7.8p1-3.h42.eulerosv2r8",
        "openssh-clients-7.8p1-3.h42.eulerosv2r8",
        "openssh-keycat-7.8p1-3.h42.eulerosv2r8",
        "openssh-ldap-7.8p1-3.h42.eulerosv2r8",
        "openssh-server-7.8p1-3.h42.eulerosv2r8"];
