...
# extracted from Fedora Security Advisory FEDORA-2020-fa83ea0492.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : pure-ftpd (2020-fa83ea0492)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-fa83ea0492");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"pure-ftpd-1.0.49-5.fc30")) flag++;
