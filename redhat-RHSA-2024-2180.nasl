...
# extracted from Red Hat Security Advisory RHSA-2024:2180. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2180");

  script_name(english:"RHEL 9 : runc (RHSA-2024:2180)");
...
referenced in the RHSA-2024:2180 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2180.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ac2fc302");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2180");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-25116");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL runc package based on the guidance in RHSA-2024:2180.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'runc-1.1.12-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'}
    ]
  }
];
