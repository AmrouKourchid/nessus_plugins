...
# Oracle Linux Security Advisory ELSA-2007-0385 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : Moderate: / fetchmail (ELSA-2007-0385)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2007-0385.html");
...
var pkgs = [
    {'reference':'fetchmail-6.3.6-1.0.1.el5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'fetchmail-6.3.6-1.0.1.el5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
