...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 / 6 : postgresql / and / postgresql84 (ELSA-2012-1037)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2012-1037.html");
