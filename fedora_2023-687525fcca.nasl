...
# extracted from Fedora Security Advisory FEDORA-2023-687525fcca
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-687525fcca");

  script_name(english:"Fedora 40 : bind / bind-dyndb-ldap (2023-687525fcca)");
...
FEDORA-2023-687525fcca advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-687525fcca");
...
var pkgs = [
    {'reference':'bind-9.18.19-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
    {'reference':'bind-dyndb-ldap-11.10-21.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
