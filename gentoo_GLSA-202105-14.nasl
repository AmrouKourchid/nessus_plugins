...
# extracted from Gentoo Linux Security Advisory GLSA 202105-14.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2020-25097", "CVE-2021-28116", "CVE-2021-28651", "CVE-2021-28652", "CVE-2021-28662", "CVE-2021-31806", "CVE-2021-31807", "CVE-2021-31808");
  script_xref(name:"GLSA", value:"202105-14");

  script_name(english:"GLSA-202105-14 : Squid: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202105-14
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202105-14"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"net-proxy/squid", unaffected:make_list("ge 4.15"), vulnerable:make_list("lt 4.15"))) flag++;
