...
# extracted from Fedora Security Advisory FEDORA-2023-1ad796067e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-1ad796067e");

  script_name(english:"Fedora 39 : java-latest-openjdk (2023-1ad796067e)");
...
FEDORA-2023-1ad796067e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-1ad796067e");
...
var pkgs = [
    {'reference':'java-latest-openjdk-21.0.1.0.12-1.rolling.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
