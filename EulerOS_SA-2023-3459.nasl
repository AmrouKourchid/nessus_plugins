...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : vim (EulerOS-SA-2023-3459)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3459
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0a9c4af1");
...
var pkgs = [
  "vim-X11-8.1.450-1.h50.eulerosv2r8",
  "vim-common-8.1.450-1.h50.eulerosv2r8",
  "vim-enhanced-8.1.450-1.h50.eulerosv2r8",
  "vim-filesystem-8.1.450-1.h50.eulerosv2r8",
  "vim-minimal-8.1.450-1.h50.eulerosv2r8"
];
