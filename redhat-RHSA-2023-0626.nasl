...
# extracted from Red Hat Security Advisory RHSA-2023:0626. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:0626");
  script_xref(name:"IAVA", value:"2023-A-0072");

  script_name(english:"RHEL 9 : libksba (RHSA-2023:0626)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_0626.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d7aa679d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2161571");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:0626");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libksba package based on the guidance in RHSA-2023:0626.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libksba-1.5.1-6.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libksba-devel-1.5.1-6.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
