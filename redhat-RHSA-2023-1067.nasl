...
# extracted from Red Hat Security Advisory RHSA-2023:1067. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:1067");

  script_name(english:"RHEL 9 : pesign (RHSA-2023:1067)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_1067.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8022991c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2135420");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:1067");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL pesign package based on the guidance in RHSA-2023:1067.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'pesign-115-6.el9_1', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pesign-115-6.el9_1', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
