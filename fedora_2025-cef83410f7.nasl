...
# extracted from Fedora Security Advisory FEDORA-2025-cef83410f7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-cef83410f7");

  script_name(english:"Fedora 40 : matrix-synapse (2025-cef83410f7)");
...
FEDORA-2025-cef83410f7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-cef83410f7");
...
"Update the affected matrix-synapse package.");
  ...
  script_set_attribute(attribute:"vuln_publication_date", value:"2025/03/29");
...
var pkgs = [
    {'reference':'matrix-synapse-1.111.1-4.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
