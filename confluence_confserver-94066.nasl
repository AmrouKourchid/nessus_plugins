...
if (description)
{
  ...
  script_cve_id("CVE-2024-21674");
  script_xref(name:"IAVA", value:"2024-A-0025-S");

  script_name(english:"Atlassian Confluence < 7.19.18 / 8.0.x < 8.5.5 / 8.6.x < 8.7.2 (CONFSERVER-94066)");
...
the CONFSERVER-94066 advisory.

  - RCE in Confluence Data Center and Server (CVE-2024-21674)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://jira.atlassian.com/browse/CONFSERVER-94066");
...
"Upgrade to Atlassian Confluence version 7.19.18, 8.5.5, 8.7.2 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-21674");
