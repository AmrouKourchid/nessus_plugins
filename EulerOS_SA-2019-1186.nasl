...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.3 : fuse (EulerOS-SA-2019-1186)");
...
following vulnerability :
  ...
  - A vulnerability was discovered in fuse. When SELinux is
    active, fusermount is vulnerable to a restriction
    ...
    effects.i1/4^CVE-2018-10906i1/4%0

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1186
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d221a027");
...
pkgs = ["fuse-2.9.2-11.h2",
        "fuse-devel-2.9.2-11.h2",
        "fuse-libs-2.9.2-11.h2"];
