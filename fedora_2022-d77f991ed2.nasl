...
# extracted from Fedora Security Advisory FEDORA-2022-d77f991ed2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-d77f991ed2");

  script_name(english:"Fedora 36 : varnish (2022-d77f991ed2)");
...
FEDORA-2022-d77f991ed2 advisory.

    Automatic update for varnish-7.0.2-1.fc36.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-d77f991ed2");
...
var pkgs = [
    {'reference':'varnish-7.0.2-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
