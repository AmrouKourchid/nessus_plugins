...
vulnerabilities. Refer to the vendor for additional information.");
  # https://www.cvedetails.com/cve/CVE-2018-15607%20
...
var constraints = [{'fixed_version' : '7.0.8.44', 'fixed_display' : '7.0.8-44'}];
