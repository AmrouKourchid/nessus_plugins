...
if (description)
{
  ...
  script_name(english:"CentOS 9 : xorg-x11-server-1.20.11-18.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update for xorg-x11-server-Xdmx.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 9 host has packages installed that are affected by a vulnerability as referenced in the
xorg-x11-server-1.20.11-18.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=31462");
...
var pkgs = [
    {'reference':'xorg-x11-server-Xdmx-1.20.11-18.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xorg-x11-server-Xephyr-1.20.11-18.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xorg-x11-server-Xnest-1.20.11-18.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xorg-x11-server-Xorg-1.20.11-18.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xorg-x11-server-Xvfb-1.20.11-18.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xorg-x11-server-common-1.20.11-18.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xorg-x11-server-devel-1.20.11-18.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xorg-x11-server-source-1.20.11-18.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
