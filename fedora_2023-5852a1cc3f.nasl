...
# extracted from Fedora Security Advisory FEDORA-2023-5852a1cc3f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-5852a1cc3f");

  script_name(english:"Fedora 40 : gh (2023-5852a1cc3f)");
...
FEDORA-2023-5852a1cc3f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-5852a1cc3f");
...
var pkgs = [
    {'reference':'gh-2.39.1-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
