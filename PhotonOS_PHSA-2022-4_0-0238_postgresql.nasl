...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Postgresql PHSA-2022-4.0-0238");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'postgresql-14.5-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'postgresql-devel-14.5-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'postgresql-libs-14.5-1.ph4')) flag++;
