...
# extracted from Red Hat Security Advisory RHSA-2023:6068. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:6068");
  script_xref(name:"IAVA", value:"2023-A-0442-S");

  script_name(english:"RHEL 8 : python39:3.9 and python39-devel:3.9 (RHSA-2023:6068)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6068.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b12f82cf");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2235789");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6068");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python39:3.9 / python39-devel:3.9 packages based on the guidance in RHSA-2023:6068.");
  ...
  'python39-devel:3.9': [
    {
      ...
      'pkgs': [
        ...
        {'reference':'python39-debug-3.9.7-2.module+el8.6.0+20026+579726f4.2', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
