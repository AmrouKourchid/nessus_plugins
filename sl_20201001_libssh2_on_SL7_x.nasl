...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : libssh2 on SL7.x x86_64 (20201001)");
...
"Security Fix(es) :
  ...
  - libssh2: integer overflow in SSH_MSG_DISCONNECT logic in
    packet.c (CVE-2019-17498)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind2010&L=SCIENTIFIC-LINUX-ERRATA&P=23195
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f2d42832");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"libssh2-1.8.0-4.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"libssh2-debuginfo-1.8.0-4.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"libssh2-devel-1.8.0-4.el7")) flag++;
if (rpm_check(release:"SL7", reference:"libssh2-docs-1.8.0-4.el7")) flag++;
