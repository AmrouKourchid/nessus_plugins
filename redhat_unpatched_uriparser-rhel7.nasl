...
# extracted from Red Hat Security Advisory uriparser. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2018-19200", "CVE-2018-20721");

  script_name(english:"RHEL 7 : uriparser (Unpatched Vulnerability) (deprecated)");
