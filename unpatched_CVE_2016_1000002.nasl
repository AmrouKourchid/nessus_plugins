...
if (description)
{
  ...
  script_cve_id("CVE-2016-1000002");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2016-1000002");
...
patch available.
  ...
  - gdm3 3.14.2 and possibly later has an information leak before screen lock (CVE-2016-1000002)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-1000002");
