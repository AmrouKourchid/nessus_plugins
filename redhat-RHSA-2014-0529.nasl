...
# extracted from Red Hat Security Advisory RHSA-2014:0529. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2014:0529");

  script_name(english:"RHEL 6 : rubygem-openshift-origin-node (RHSA-2014:0529)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"An updated rubygem-openshift-origin-node package that fixes one
security issue is now available for Red Hat OpenShift Enterprise 2.0.
...
remote, authenticated user permitted to run cartridges via the web
...
issue.");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2014:0529");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/cve-2014-0233");
  script_set_attribute(attribute:"solution", value:
"Update the affected rubygem-openshift-origin-node package.");
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", reference:"rubygem-openshift-origin-node-1.17.5.16-1.el6")) flag++;
