...
# extracted from Red Hat Security Advisory RHSA-2024:6757. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:6757");

  script_name(english:"RHEL 9 : libnbd (RHSA-2024:6757)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for libnbd.");
...
the RHSA-2024:6757 advisory.

    Network Block Device (NBD) is a protocol for accessing Block Devices (hard disks and disk-like devices)
    over a Network. The libnbd is a userspace client library for writing NBD clients.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_6757.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c1e3d150");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:6757");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libnbd package based on the guidance in RHSA-2024:6757.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libnbd-1.18.1-4.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libnbd-bash-completion-1.18.1-4.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libnbd-devel-1.18.1-4.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nbdfuse-1.18.1-4.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ocaml-libnbd-1.18.1-4.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ocaml-libnbd-devel-1.18.1-4.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-libnbd-1.18.1-4.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'libnbd-1.18.1-4.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libnbd-bash-completion-1.18.1-4.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libnbd-devel-1.18.1-4.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nbdfuse-1.18.1-4.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ocaml-libnbd-1.18.1-4.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ocaml-libnbd-devel-1.18.1-4.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-libnbd-1.18.1-4.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libnbd / libnbd-bash-completion / libnbd-devel / nbdfuse / etc');
}
