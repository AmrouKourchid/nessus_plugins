...
# extracted from Red Hat Security Advisory RHSA-2022:8669. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:8669");

  script_name(english:"RHEL 9 : krb5 (RHSA-2022:8669)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8669.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bad6069e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8669");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2140960");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL krb5 package based on the guidance in RHSA-2022:8669.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'krb5-devel-1.19.1-16.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'krb5-libs-1.19.1-16.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'krb5-pkinit-1.19.1-16.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'krb5-server-1.19.1-16.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'krb5-server-ldap-1.19.1-16.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'krb5-workstation-1.19.1-16.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libkadm5-1.19.1-16.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
