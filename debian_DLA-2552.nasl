...
# extracted from Debian Security Advisory DLA-2552-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2552-1 : connman security update");
...
For the detailed security status of connman please refer to its
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2021/02/msg00013.html");
...
flag = 0;
if (deb_check(release:"9.0", prefix:"connman", reference:"1.33-3+deb9u2")) flag++;
if (deb_check(release:"9.0", prefix:"connman-dev", reference:"1.33-3+deb9u2")) flag++;
if (deb_check(release:"9.0", prefix:"connman-doc", reference:"1.33-3+deb9u2")) flag++;
if (deb_check(release:"9.0", prefix:"connman-vpn", reference:"1.33-3+deb9u2")) flag++;
