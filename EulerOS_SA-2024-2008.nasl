...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : python-cryptography (EulerOS-SA-2024-2008)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2008
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e1816c27");
...
var pkgs = [
  "python3-cryptography-2.9.2-1.h6.eulerosv2r10"
];
