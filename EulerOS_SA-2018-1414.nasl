...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : firefox (EulerOS-SA-2018-1414)");
...
vulnerabilities :
  ...
  - Mozilla: WebExtension local file permission check
    bypass (CVE-2018-12397)
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1414
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a2b2ec5a");
