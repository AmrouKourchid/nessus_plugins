...
# extracted from Fedora Security Advisory FEDORA-2021-64168929e4
#
...
if (description)
{
  ...
  script_name(english:"Fedora 33 : adplug / audacious-plugins / ocp (2021-64168929e4)");
...
FEDORA-2021-64168929e4 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-64168929e4");
...
pkgs = [
    {'reference':'adplug-2.3.3-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'audacious-plugins-4.0.5-3.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ocp-0.1.22-0.28.git849cc42.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
