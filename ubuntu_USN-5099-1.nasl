...
# extracted from Ubuntu Security Notice USN-5099-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5099-1");

  script_name(english:"Ubuntu 20.04 LTS : Imlib2 vulnerability (USN-5099-1)");
...
USN-5099-1 advisory.
    ...
    It was discovered that Imlib2 incorrectly handled certain ICO images. An attacker could use this issue to
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5099-1");
...
"Update the affected libimlib2 and / or libimlib2-dev packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-12761");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'libimlib2', 'pkgver': '1.6.1-1ubuntu0.1'},
    {'osver': '20.04', 'pkgname': 'libimlib2-dev', 'pkgver': '1.6.1-1ubuntu0.1'}
];
