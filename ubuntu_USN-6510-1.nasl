...
# extracted from Ubuntu Security Notice USN-6510-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6510-1");
  script_xref(name:"IAVA", value:"2023-A-0572-S");

  script_name(english:"Ubuntu 16.04 ESM / 18.04 ESM : Apache HTTP Server vulnerability (USN-6510-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6510-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'apache2', 'pkgver': '2.4.18-2ubuntu3.17+esm11', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'apache2-bin', 'pkgver': '2.4.18-2ubuntu3.17+esm11', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'apache2-data', 'pkgver': '2.4.18-2ubuntu3.17+esm11', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'apache2-dev', 'pkgver': '2.4.18-2ubuntu3.17+esm11', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'apache2-suexec-custom', 'pkgver': '2.4.18-2ubuntu3.17+esm11', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'apache2-suexec-pristine', 'pkgver': '2.4.18-2ubuntu3.17+esm11', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'apache2-utils', 'pkgver': '2.4.18-2ubuntu3.17+esm11', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'apache2', 'pkgver': '2.4.29-1ubuntu4.27+esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'apache2-bin', 'pkgver': '2.4.29-1ubuntu4.27+esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'apache2-data', 'pkgver': '2.4.29-1ubuntu4.27+esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'apache2-dev', 'pkgver': '2.4.29-1ubuntu4.27+esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'apache2-ssl-dev', 'pkgver': '2.4.29-1ubuntu4.27+esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'apache2-suexec-custom', 'pkgver': '2.4.29-1ubuntu4.27+esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'apache2-suexec-pristine', 'pkgver': '2.4.29-1ubuntu4.27+esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'apache2-utils', 'pkgver': '2.4.29-1ubuntu4.27+esm1', 'ubuntu_pro': TRUE}
];
