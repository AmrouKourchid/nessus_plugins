...
# extracted from Fedora Security Advisory FEDORA-2024-b0f9656a76
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-b0f9656a76");

  script_name(english:"Fedora 39 : pdns-recursor (2024-b0f9656a76)");
...
FEDORA-2024-b0f9656a76 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-b0f9656a76");
...
var pkgs = [
    {'reference':'pdns-recursor-4.9.3-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
