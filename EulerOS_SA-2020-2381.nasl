...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : perl-DBD-MySQL (EulerOS-SA-2020-2381)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2381
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?60fff0b2");
...
pkgs = ["perl-DBD-MySQL-4.023-5.h1"];
