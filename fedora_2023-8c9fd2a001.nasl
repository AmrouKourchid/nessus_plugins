...
# extracted from Fedora Security Advisory FEDORA-2023-8c9fd2a001
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-8c9fd2a001");

  script_name(english:"Fedora 38 : chromium (2023-8c9fd2a001)");
...
FEDORA-2023-8c9fd2a001 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-8c9fd2a001");
...
var pkgs = [
    {'reference':'chromium-118.0.5993.70-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
