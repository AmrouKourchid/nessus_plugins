...
# extracted from Red Hat Security Advisory 8.1_libvirt. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2020-12430", "CVE-2020-25637");

  script_name(english:"RHEL 8 : 8.1_libvirt (Unpatched Vulnerability) (deprecated)");
