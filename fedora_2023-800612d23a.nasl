...
# extracted from Fedora Security Advisory FEDORA-2023-800612d23a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-800612d23a");

  script_name(english:"Fedora 37 : redis (2023-800612d23a)");
...
FEDORA-2023-800612d23a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-800612d23a");
...
var pkgs = [
    {'reference':'redis-7.0.12-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
