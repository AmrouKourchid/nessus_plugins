...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2015/rhsa-2015_1979.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?448049c1");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2015:1979");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1232320");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1268775");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1273719");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libreswan package based on the guidance in RHSA-2015:1979.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:N/I:N/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-3240");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libreswan-3.15-5.el7_1', 'cpu':'ppc64', 'release':'7', 'el_string':'el7_1', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libreswan-3.15-5.el7_1', 'cpu':'s390x', 'release':'7', 'el_string':'el7_1', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libreswan-3.15-5.el7_1', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_1', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'libreswan-3.15-5.ael7b_1', 'cpu':'ppc64le', 'release':'7', 'el_string':'ael7b_1', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
