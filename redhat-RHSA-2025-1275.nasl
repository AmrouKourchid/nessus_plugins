...
# extracted from Red Hat Security Advisory RHSA-2025:1275. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:1275");

  script_name(english:"RHEL 8 : container-tools:rhel8 (RHSA-2025:1275)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for container-tools:rhel8.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2025:1275 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_1275.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?46d55dad");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:1275");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL container-tools:rhel8 package based on the guidance in RHSA-2025:1275.");
  ...
  'container-tools:rhel8': [
    {
      ...
      'pkgs': [
        ...
        {'reference':'podman-4.4.1-26.module+el8.8.0+22779+ce927503', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
        {'reference':'podman-catatonit-4.4.1-26.module+el8.8.0+22779+ce927503', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
        {'reference':'podman-docker-4.4.1-26.module+el8.8.0+22779+ce927503', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
        {'reference':'podman-gvproxy-4.4.1-26.module+el8.8.0+22779+ce927503', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
        {'reference':'podman-plugins-4.4.1-26.module+el8.8.0+22779+ce927503', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
        {'reference':'podman-remote-4.4.1-26.module+el8.8.0+22779+ce927503', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
        {'reference':'podman-tests-4.4.1-26.module+el8.8.0+22779+ce927503', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
