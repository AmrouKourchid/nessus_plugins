...
# extracted from Fedora Security Advisory FEDORA-2024-22a01aab2f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-22a01aab2f");

  script_name(english:"Fedora 41 : pypy (2024-22a01aab2f)");
...
FEDORA-2024-22a01aab2f advisory.
    ...
    ```
    * Thu Aug  1 2024 Miro Hronok <miro@hroncok.cz> - 7.3.16-2
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-22a01aab2f");
...
var pkgs = [
    {'reference':'pypy-7.3.16-2.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
