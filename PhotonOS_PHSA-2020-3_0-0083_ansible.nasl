...
if (description)
{
  ...
  script_cve_id("CVE-2020-1733");
  script_xref(name:"IAVB", value:"2019-B-0092-S");

  script_name(english:"Photon OS 3.0: Ansible PHSA-2020-3.0-0083");
...
if (rpm_check(release:'PhotonOS-3.0', reference:'ansible-2.8.10-2.ph3')) flag++;
