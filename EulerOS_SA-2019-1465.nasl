...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.1.0 : ghostscript (EulerOS-SA-2019-1465)");
...
the following vulnerabilities :
  ...
  - It was found that the forceput operator could be
    extracted from the DefineResource method. A specially
    crafted PostScript file could use this flaw in order
    to, for example, have access to the file system outside
    of the constrains imposed by -dSAFER.(CVE-2019-3838)

  - t was found that the superexec operator was available
    in the internal dictionary. A specially crafted
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1465
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?57694ec3");
