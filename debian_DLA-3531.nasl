...
# extracted from Debian Security Advisory dla-3531. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3531 : open-vm-tools - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3531
advisory.
...
var pkgs = [
    {'release': '10.0', 'prefix': 'open-vm-tools', 'reference': '2:10.3.10-1+deb10u4'},
    {'release': '10.0', 'prefix': 'open-vm-tools-desktop', 'reference': '2:10.3.10-1+deb10u4'},
    {'release': '10.0', 'prefix': 'open-vm-tools-dev', 'reference': '2:10.3.10-1+deb10u4'}
];
