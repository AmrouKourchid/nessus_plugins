...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : libldb (EulerOS-SA-2020-2253)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2253
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?135baf95");
...
pkgs = ["libldb-1.2.2-1.h1.eulerosv2r7",
        "pyldb-1.2.2-1.h1.eulerosv2r7"];
