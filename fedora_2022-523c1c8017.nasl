...
# extracted from Fedora Security Advisory FEDORA-2022-523c1c8017
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-523c1c8017");

  script_name(english:"Fedora 35 : python3.9 (2022-523c1c8017)");
...
FEDORA-2022-523c1c8017 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-523c1c8017");
...
var pkgs = [
    {'reference':'python3.9-3.9.15-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
