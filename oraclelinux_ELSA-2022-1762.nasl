...
var appstreams = {
    'container-tools:ol8': [
      ...
      {'reference':'cockpit-podman-43-1.module+el8.6.0+20656+53f7e955', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'conmon-2.1.0-1.module+el8.6.0+20656+53f7e955', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'container-selinux-2.179.1-1.module+el8.6.0+20656+53f7e955', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      ...
      {'reference':'podman-docker-4.0.2-6.module+el8.6.0+20656+53f7e955', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      ...
      {'reference':'python3-podman-4.0.0-1.module+el8.6.0+20656+53f7e955', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'udica-0.2.6-2.module+el8.6.0+20656+53f7e955', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'cockpit-podman-43-1.module+el8.6.0+20656+53f7e955', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'conmon-2.1.0-1.module+el8.6.0+20656+53f7e955', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'container-selinux-2.179.1-1.module+el8.6.0+20656+53f7e955', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      ...
      {'reference':'podman-docker-4.0.2-6.module+el8.6.0+20656+53f7e955', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      ...
      {'reference':'python3-podman-4.0.0-1.module+el8.6.0+20656+53f7e955', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'udica-0.2.6-2.module+el8.6.0+20656+53f7e955', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
};
