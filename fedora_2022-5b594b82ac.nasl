...
# extracted from Fedora Security Advisory FEDORA-2022-5b594b82ac
#
...
if (description)
{
  ...
  script_cve_id("CVE-2022-33746", "CVE-2022-33747", "CVE-2022-33748");
  script_xref(name:"IAVB", value:"2021-B-0068-S");
  script_xref(name:"FEDORA", value:"2022-5b594b82ac");

  script_name(english:"Fedora 36 : xen (2022-5b594b82ac)");
...
FEDORA-2022-5b594b82ac advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-5b594b82ac");
...
var pkgs = [
    {'reference':'xen-4.16.2-2.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
