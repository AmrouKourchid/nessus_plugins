...
# extracted from Fedora Security Advisory FEDORA-2024-41c1bf8de6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-41c1bf8de6");

  script_name(english:"Fedora 39 : xrdp (2024-41c1bf8de6)");
...
FEDORA-2024-41c1bf8de6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-41c1bf8de6");
...
var pkgs = [
    {'reference':'xrdp-0.10.1-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
