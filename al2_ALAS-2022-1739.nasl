...
# extracted from Amazon Linux 2 Security Advisory ALAS-2022-1739.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : log4j (ALAS-2022-1739)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of log4j installed on the remote host is prior to 1.2.17-17. It is, therefore, affected by multiple
vulnerabilities as referenced in the ALAS2-2022-1739 advisory.

    A flaw was found in the Java logging library Apache Log4j in version 1.x . This allows a remote attacker
    to execute code on the server if the deployed application is configured to use JMSAppender. This flaw has
    been filed for Log4j 1.x, the corresponding flaw information for Log4j 2.x is available at:
    https://access.redhat.com/security/cve/CVE-2021-44228 (CVE-2021-4104)

Tenable has extracted the preceding description block directly from the tested product security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2022-1739.html");
...
var pkgs = [
    {'reference':'log4j-1.2.17-17.amzn2', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'log4j-javadoc-1.2.17-17.amzn2', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'log4j-manual-1.2.17-17.amzn2', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
