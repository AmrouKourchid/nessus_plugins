...
the RHSA-2019:0432 advisory.
    ...
    * ansible: path traversal in the fetch module (CVE-2019-3828)
    ...
    See https://github.com/ansible/ansible/blob/v2.5.15/changelogs/CHANGELOG-v2.5.rst for details on bug fixes
    in this release.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_0432.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?40b2b50e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:0432");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1676689");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL ansible package based on the guidance in RHSA-2019:0432.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ansible-2.5.15-1.el7ae', 'release':'7', 'el_string':'el7ae', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2.5'},
      {'reference':'ansible-doc-2.5.15-1.el7ae', 'release':'7', 'el_string':'el7ae', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2.5'}
    ]
  }
];
