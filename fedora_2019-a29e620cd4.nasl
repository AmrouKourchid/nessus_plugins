...
# extracted from Fedora Security Advisory FEDORA-2019-a29e620cd4.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-a29e620cd4");

  script_name(english:"Fedora 31 : unbound (2019-a29e620cd4)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-a29e620cd4");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"unbound-1.9.6-1.fc31")) flag++;
