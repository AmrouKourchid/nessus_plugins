...
# extracted from Red Hat Security Advisory spring-webflow. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2017-4971", "CVE-2017-8039");

  script_name(english:"RHEL 7 : spring-webflow (Unpatched Vulnerability) (deprecated)");
...
"This plugin has been deprecated as it does not adhere to established standards for this style of check.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-8039");
