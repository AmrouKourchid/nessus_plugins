...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5026411");
  script_xref(name:"MSKB", value:"5026419");
  script_xref(name:"MSFT", value:"MS23-5026411");
  script_xref(name:"MSFT", value:"MS23-5026419");
  ...
  script_name(english:"KB5026411: Windows Server 2012 Security Update (May 2023)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5026411. It is, therefore, affected by multiple vulnerabilities
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5026411");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5026419");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5026411 or Cumulative Update 5026419");
...
if (
  smb_check_rollup(os:'6.2',
                   ...
                   rollup_date:'05_2023',
                   bulletin:bulletin,
                   rollup_kb_list:[5026419, 5026411])
)
{
