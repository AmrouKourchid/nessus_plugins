...
# extracted from Ubuntu Security Notice USN-3853-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS : GnuPG vulnerability (USN-3853-1)");
...
USN-3853-1 advisory.
    ...
    Ben Fuhrmannek discovered that GnuPG incorrectly handled Web Key Directory lookups. A remote attacker
    could possibly use this issue to cause a denial of service, or perform Cross-Site Request Forgery attacks.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3853-1");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'dirmngr', 'pkgver': '2.2.4-1ubuntu1.2'},
    {'osver': '18.04', 'pkgname': 'gnupg', 'pkgver': '2.2.4-1ubuntu1.2'},
    {'osver': '18.04', 'pkgname': 'gnupg-agent', 'pkgver': '2.2.4-1ubuntu1.2'},
    {'osver': '18.04', 'pkgname': 'gnupg-l10n', 'pkgver': '2.2.4-1ubuntu1.2'},
    {'osver': '18.04', 'pkgname': 'gnupg-utils', 'pkgver': '2.2.4-1ubuntu1.2'},
    {'osver': '18.04', 'pkgname': 'gnupg2', 'pkgver': '2.2.4-1ubuntu1.2'},
    {'osver': '18.04', 'pkgname': 'gpg', 'pkgver': '2.2.4-1ubuntu1.2'},
    {'osver': '18.04', 'pkgname': 'gpg-agent', 'pkgver': '2.2.4-1ubuntu1.2'},
    {'osver': '18.04', 'pkgname': 'gpg-wks-client', 'pkgver': '2.2.4-1ubuntu1.2'},
    {'osver': '18.04', 'pkgname': 'gpg-wks-server', 'pkgver': '2.2.4-1ubuntu1.2'},
    {'osver': '18.04', 'pkgname': 'gpgconf', 'pkgver': '2.2.4-1ubuntu1.2'},
    {'osver': '18.04', 'pkgname': 'gpgsm', 'pkgver': '2.2.4-1ubuntu1.2'},
    {'osver': '18.04', 'pkgname': 'gpgv', 'pkgver': '2.2.4-1ubuntu1.2'},
    {'osver': '18.04', 'pkgname': 'gpgv-static', 'pkgver': '2.2.4-1ubuntu1.2'},
    {'osver': '18.04', 'pkgname': 'gpgv-udeb', 'pkgver': '2.2.4-1ubuntu1.2'},
    {'osver': '18.04', 'pkgname': 'gpgv-win32', 'pkgver': '2.2.4-1ubuntu1.2'},
    {'osver': '18.04', 'pkgname': 'gpgv2', 'pkgver': '2.2.4-1ubuntu1.2'},
    {'osver': '18.04', 'pkgname': 'scdaemon', 'pkgver': '2.2.4-1ubuntu1.2'}
];
