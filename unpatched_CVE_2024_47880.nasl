...
if (description)
{
  ...
  script_cve_id("CVE-2024-47880");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-47880");
...
"There is no known solution at this time.");
  ...
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:H/PR:N/UI:R/S:C/C:H/I:L/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-47880");
