...
# extracted from Fedora Security Advisory FEDORA-2019-e40253f67e.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-e40253f67e");

  script_name(english:"Fedora 29 : tcpreplay (2019-e40253f67e)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-e40253f67e");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"tcpreplay-4.3.2-1.fc29")) flag++;
