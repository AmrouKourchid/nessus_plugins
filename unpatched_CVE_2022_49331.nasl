...
if (description)
{
  ...
  script_cve_id("CVE-2022-49331");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-49331");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: nfc: st21nfca: fix memory leaks in
    EVT_TRANSACTION handling Error paths do not free previously allocated memory. Add devm_kfree() to those
    failure paths. (CVE-2022-49331)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-49331");
