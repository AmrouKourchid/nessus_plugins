...
# extracted from Red Hat Security Advisory RHSA-2017:2180. The text 
...
the RHSA-2017:2180 advisory.
    ...
    * A NULL pointer dereference flaw was found in ghostscript's mem_get_bits_rectangle function. A specially
    crafted postscript document could cause a crash in the context of the gs process. (CVE-2017-7207)
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2017/rhsa-2017_2180.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c5bd376e");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2017:2180");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1411725");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1424752");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1434353");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1436273");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL ghostscript package based on the guidance in RHSA-2017:2180.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ghostscript-9.07-28.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ghostscript-cups-9.07-28.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ghostscript-devel-9.07-28.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ghostscript-doc-9.07-28.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ghostscript-gtk-9.07-28.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
