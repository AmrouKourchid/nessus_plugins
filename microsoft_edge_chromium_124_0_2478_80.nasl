...
if (description)
{
  ...
  script_name(english:"Microsoft Edge (Chromium) < 124.0.2478.80 Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote host has an web browser installed that is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Microsoft Edge installed on the remote Windows host is prior to 124.0.2478.80. It is, therefore, affected
by multiple vulnerabilities as referenced in the May 2, 2024 advisory.
...
number.");
  # https://docs.microsoft.com/en-us/DeployEdge/microsoft-edge-relnotes-security#may-2-2024
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2e10e71d");
  script_set_attribute(attribute:"see_also", value:"https://msrc.microsoft.com/update-guide/vulnerability/CVE-2024-4331");
  script_set_attribute(attribute:"see_also", value:"https://msrc.microsoft.com/update-guide/vulnerability/CVE-2024-4368");
