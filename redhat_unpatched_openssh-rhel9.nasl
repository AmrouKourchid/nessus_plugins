...
if (description)
{
  ...
  script_cve_id("CVE-2016-20012", "CVE-2023-51767");

  script_name(english:"RHEL 9 : openssh (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-20012");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2023-51767");
