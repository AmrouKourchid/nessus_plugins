...
# extracted from Ubuntu Security Notice USN-6247-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6247-1");

  script_name(english:"Ubuntu 22.04 LTS : Linux kernel (OEM) vulnerabilities (USN-6247-1)");
...
the USN-6247-1 advisory.
    ...
    Lucas Leong discovered that the IPv6 SR implementation in the Linux kernel did not properly validate SEG6
    configuration attributes, leading to an out- of-bounds read vulnerability. A privileged attacker could use
    this to expose sensitive information (kernel memory). (CVE-2023-2860)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6247-1");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.17.0-1035-oem");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-6247-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2022-2663', 'CVE-2022-3635', 'CVE-2022-47929', 'CVE-2023-2860', 'CVE-2023-31248', 'CVE-2023-35001');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-6247-1');
  }
  else
  {
