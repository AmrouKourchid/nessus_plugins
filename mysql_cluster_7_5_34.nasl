...
if (description)
{
  ...
  script_cve_id("CVE-2024-21101", "CVE-2024-21102");
  script_xref(name:"IAVA", value:"2024-A-0240");

  script_name(english:"Oracle MySQL Cluster 7.5.x < 7.5.34 (Apr 2024 CPU)");
...
"Apply the appropriate patch according to the April 2024 Oracle Critical Patch Update advisory.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-21101");
...
mysql_check_version(variant:'Cluster', fixed:'7.5.34', min:'7.5', severity:SECURITY_NOTE);
