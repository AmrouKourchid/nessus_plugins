...
# extracted from Fedora Security Advisory FEDORA-2020-b58dc5df38.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : mod_http2 (2020-b58dc5df38)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"This update includes the latest stable release of `mod_http2`, fixing
various bugs. Two security vulnerabilities are addressed in this
update :

  - **CVE-2020-11993**:
    https://httpd.apache.org/security/vulnerabilities_24.htm
    l#CVE-2020-11993
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-b58dc5df38");
  # https://httpd.apache.org/security/vulnerabilities_24.html#CVE-2020-9490
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d20bd0fa");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"mod_http2-1.15.14-1.fc31")) flag++;
