...
# extracted from Red Hat Security Advisory calamari-server. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2019-7164");
  script_xref(name:"CEA-ID", value:"CEA-2021-0004");

  script_name(english:"RHEL 6 : calamari-server (Unpatched Vulnerability) (deprecated)");
