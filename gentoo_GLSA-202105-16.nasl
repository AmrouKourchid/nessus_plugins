...
# extracted from Gentoo Linux Security Advisory GLSA 202105-16.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202105-16");

  script_name(english:"GLSA-202105-16 : X.Org X11 library: Denial of service");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202105-16
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202105-16"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"x11-libs/libX11", unaffected:make_list("ge 1.7.1"), vulnerable:make_list("lt 1.7.1"))) flag++;
