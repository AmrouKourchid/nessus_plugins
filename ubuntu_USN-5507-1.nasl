...
# extracted from Ubuntu Security Notice USN-5507-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5507-1");

  script_name(english:"Ubuntu 16.04 ESM : Vim vulnerabilities (USN-5507-1)");
...
the USN-5507-1 advisory.

    It was discovered that Vim incorrectly handled memory access. An attacker could potentially use this issue
    to cause the program to crash, use unexpected values, or execute arbitrary code. (CVE-2022-1968)

    It was discovered that Vim incorrectly handled memory access. An attacker could potentially use this issue
    to cause the corruption of sensitive information, a crash, or arbitrary code execution. (CVE-2022-1897,
    CVE-2022-1942)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5507-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'vim', 'pkgver': '2:7.4.1689-3ubuntu1.5+esm10', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'vim-athena', 'pkgver': '2:7.4.1689-3ubuntu1.5+esm10', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'vim-athena-py2', 'pkgver': '2:7.4.1689-3ubuntu1.5+esm10', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'vim-common', 'pkgver': '2:7.4.1689-3ubuntu1.5+esm10', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'vim-gnome', 'pkgver': '2:7.4.1689-3ubuntu1.5+esm10', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'vim-gnome-py2', 'pkgver': '2:7.4.1689-3ubuntu1.5+esm10', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'vim-gtk', 'pkgver': '2:7.4.1689-3ubuntu1.5+esm10', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'vim-gtk-py2', 'pkgver': '2:7.4.1689-3ubuntu1.5+esm10', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'vim-gtk3', 'pkgver': '2:7.4.1689-3ubuntu1.5+esm10', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'vim-gtk3-py2', 'pkgver': '2:7.4.1689-3ubuntu1.5+esm10', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'vim-gui-common', 'pkgver': '2:7.4.1689-3ubuntu1.5+esm10', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'vim-nox', 'pkgver': '2:7.4.1689-3ubuntu1.5+esm10', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'vim-nox-py2', 'pkgver': '2:7.4.1689-3ubuntu1.5+esm10', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'vim-runtime', 'pkgver': '2:7.4.1689-3ubuntu1.5+esm10', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'vim-tiny', 'pkgver': '2:7.4.1689-3ubuntu1.5+esm10', 'ubuntu_pro': TRUE}
];
