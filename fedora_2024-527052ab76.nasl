...
# extracted from Fedora Security Advisory FEDORA-2024-527052ab76
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-527052ab76");
  script_xref(name:"IAVA", value:"2024-A-0543-S");

  script_name(english:"Fedora 39 : expat (2024-527052ab76)");
...
FEDORA-2024-527052ab76 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-527052ab76");
...
var pkgs = [
    {'reference':'expat-2.6.3-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
