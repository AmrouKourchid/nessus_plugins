...
"This update for libmediainfo fixes the following issues :
  ...
  - CVE-2019-11372: Fixed out-of-bounds read in function
    ...
    (boo#1133157)");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1133156");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1133157");
  script_set_attribute(attribute:"solution", value:
"Update the affected libmediainfo packages.");
