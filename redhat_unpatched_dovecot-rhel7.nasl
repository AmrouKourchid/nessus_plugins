...
# extracted from Red Hat Security Advisory dovecot. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2016-4983", "CVE-2020-28200");

  script_name(english:"RHEL 7 : dovecot (Unpatched Vulnerability) (deprecated)");
