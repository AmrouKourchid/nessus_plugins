...
if (description)
{
  ...
  script_cve_id("CVE-2024-56704");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-56704");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: 9p/xen: fix release of IRQ Kernel logs
    indicate an IRQ was double-freed. Pass correct device ID during IRQ release. [Dominique: remove confusing
    variable reset to 0] (CVE-2024-56704)
