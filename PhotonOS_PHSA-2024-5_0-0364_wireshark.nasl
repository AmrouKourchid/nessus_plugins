...
if (description)
{
  ...
  script_cve_id("CVE-2024-24476", "CVE-2024-8250");
  script_xref(name:"IAVB", value:"2024-B-0001-S");
  script_xref(name:"IAVB", value:"2024-B-0126-S");

  script_name(english:"Photon OS 5.0: Wireshark PHSA-2024-5.0-0364");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'wireshark-4.2.7-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'wireshark-devel-4.2.7-1.ph5')) flag++;
