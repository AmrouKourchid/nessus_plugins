...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS : c-ares vulnerability (USN-3143-1)");
...
in the USN-3143-1 advisory.

    Gzob Qq discovered that c-ares incorrectly handled certain hostnames. A remote attacker could use this
    issue to cause applications using c-ares to crash, resulting in a denial of service, or possibly execute
    arbitrary code.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3143-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'libc-ares-dev', 'pkgver': '1.10.0-2ubuntu0.1'},
    {'osver': '14.04', 'pkgname': 'libc-ares2', 'pkgver': '1.10.0-2ubuntu0.1'},
    {'osver': '16.04', 'pkgname': 'libc-ares-dev', 'pkgver': '1.10.0-3ubuntu0.1'},
    {'osver': '16.04', 'pkgname': 'libc-ares2', 'pkgver': '1.10.0-3ubuntu0.1'}
];
