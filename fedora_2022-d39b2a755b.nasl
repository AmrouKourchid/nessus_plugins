...
# extracted from Fedora Security Advisory FEDORA-2022-d39b2a755b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-d39b2a755b");

  script_name(english:"Fedora 35 : php-twig2 (2022-d39b2a755b)");
...
FEDORA-2022-d39b2a755b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-d39b2a755b");
...
var pkgs = [
    {'reference':'php-twig2-2.15.3-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
