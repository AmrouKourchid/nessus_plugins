...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : cairo (EulerOS-SA-2021-1977)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1977
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?906f4415");
...
pkgs = ["cairo-1.15.14-1.h2.eulerosv2r8",
        "cairo-devel-1.15.14-1.h2.eulerosv2r8",
        "cairo-gobject-1.15.14-1.h2.eulerosv2r8",
        "cairo-gobject-devel-1.15.14-1.h2.eulerosv2r8"];
