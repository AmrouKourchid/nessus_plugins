...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : emacs (EulerOS-SA-2023-2461)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2461
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?35178f2c");
...
var pkgs = [
  "emacs-filesystem-27.1-4.h7.eulerosv2r10"
];
