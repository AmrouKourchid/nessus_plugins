...
# extracted from Fedora Security Advisory FEDORA-2018-00647ae0d5.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-00647ae0d5");

  script_name(english:"Fedora 27 : 3:mariadb (2018-00647ae0d5)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-00647ae0d5");
...
flag = 0;
if (rpm_check(release:"FC27", reference:"mariadb-10.2.13-2.fc27", epoch:"3")) flag++;
