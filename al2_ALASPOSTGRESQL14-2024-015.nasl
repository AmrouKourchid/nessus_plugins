...
# extracted from Amazon Linux 2 Security Advisory ALASPOSTGRESQL14-2024-015.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : libpq (ALASPOSTGRESQL14-2024-015)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of libpq installed on the remote host is prior to 14.14-1. It is, therefore, affected by multiple
vulnerabilities as referenced in the ALAS2POSTGRESQL14-2024-015 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALASPOSTGRESQL14-2024-015.html");
...
var pkgs = [
    {'reference':'libpq-14.14-1.amzn2.0.1', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'postgresql14'},
    {'reference':'libpq-14.14-1.amzn2.0.1', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'postgresql14'},
    {'reference':'libpq-debuginfo-14.14-1.amzn2.0.1', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'postgresql14'},
    {'reference':'libpq-debuginfo-14.14-1.amzn2.0.1', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'postgresql14'},
    {'reference':'libpq-devel-14.14-1.amzn2.0.1', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'postgresql14'},
    {'reference':'libpq-devel-14.14-1.amzn2.0.1', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'postgresql14'}
];
