...
# extracted from Red Hat Security Advisory RHSA-2017:2913. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2017:2913");

  script_name(english:"RHEL 6 / 7 : rh-nodejs6-nodejs-tough-cookie (RHSA-2017:2913)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for rh-nodejs6-nodejs-tough-cookie.");
...
in the RHSA-2017:2913 advisory.

    Tough-Cookie is a Node.js module that offers RFC6265 Cookies and Cookie Jar.

    The following packages have been upgraded to a later upstream version: rh-nodejs6-nodejs-tough-cookie
    (2.3.3). (BZ#1497701)

    Security Fix(es):

    * A regular expression denial of service flaw was found in Tough-Cookie. An attacker able to make an
    application using Touch-Cookie to parse a sufficiently large HTTP request Cookie header could cause the
    application to consume an excessive amount of CPU. (CVE-2017-15010)
...
number.");
  ...
  # https://access.redhat.com/security/data/csaf/v2/advisories/2017/rhsa-2017_2913.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4a209be5");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2017:2913");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rh-nodejs6-nodejs-tough-cookie package based on the guidance in RHSA-2017:2913.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rh-nodejs6-nodejs-tough-cookie");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-nodejs6-nodejs-tough-cookie-2.3.3-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'rh-nodejs6-nodejs-tough-cookie-2.3.3-1.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'rh-nodejs6-nodejs-tough-cookie');
}
