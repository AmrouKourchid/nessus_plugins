...
if (description)
{
  ...
  script_cve_id("CVE-2014-1490");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2014-1490");
...
patch available.
  ...
  - Race condition in libssl in Mozilla Network Security Services (NSS) before 3.15.4, as used in Mozilla
    ...
    of a session ticket. (CVE-2014-1490)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-1490");
