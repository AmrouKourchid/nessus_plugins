...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : bind (EulerOS-SA-2021-1458)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1458
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8921ab25");
...
pkgs = ["bind-9.9.4-61.1.h13.eulerosv2r7",
        "bind-chroot-9.9.4-61.1.h13.eulerosv2r7",
        "bind-libs-9.9.4-61.1.h13.eulerosv2r7",
        "bind-libs-lite-9.9.4-61.1.h13.eulerosv2r7",
        "bind-license-9.9.4-61.1.h13.eulerosv2r7",
        "bind-pkcs11-9.9.4-61.1.h13.eulerosv2r7",
        "bind-pkcs11-libs-9.9.4-61.1.h13.eulerosv2r7",
        "bind-pkcs11-utils-9.9.4-61.1.h13.eulerosv2r7",
        "bind-utils-9.9.4-61.1.h13.eulerosv2r7"];
