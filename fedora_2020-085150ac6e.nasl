...
# extracted from Fedora Security Advisory FEDORA-2020-085150ac6e.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : libexif (2020-085150ac6e)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"New upstream release. It largely contains stability, security and
bugfixes. Some EXIF 2.3 tags have been added. See also:
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-085150ac6e");
  script_set_attribute(attribute:"see_also", value:"https://github.com/libexif/libexif/releases/tag/libexif-0_6_22-release");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"libexif-0.6.22-1.fc31")) flag++;
