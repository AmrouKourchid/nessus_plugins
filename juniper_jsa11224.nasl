...
advisory.
  ...
  - A Protection Mechanism Failure vulnerability in RPD (routing protocol daemon) of Juniper Networks Junos OS
    ...
    go down by sending a spoofed hello PDU leading to a Denial of Service (DoS) condition. (CVE-2021-31362)

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  # https://supportportal.juniper.net/s/article/2021-10-Security-Bulletin-Junos-OS-and-Junos-OS-Evolved-An-IS-IS-adjacency-might-be-taken-down-if-a-bad-hello-PDU-is-received-for-an-existing-adjacency-causing-a-DoS-CVE-2021-31362
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c0e71c31");
...
var vuln_ranges = [
  {'min_ver':'0.0', 'fixed_ver':'18.2R3-S8'},
