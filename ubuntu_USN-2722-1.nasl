...
# extracted from Ubuntu Security Notice USN-2722-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"2722-1");

  script_name(english:"Ubuntu 14.04 LTS : GDK-PixBuf vulnerability (USN-2722-1)");
...
USN-2722-1 advisory.
    ...
    Gustavo Grieco discovered that GDK-PixBuf incorrectly handled scaling bitmap images. If a user or
    automated system were tricked into opening a BMP image file, a remote attacker could use this flaw to
    cause GDK-PixBuf to crash, resulting in a denial of service, or possibly execute arbitrary code.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2722-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'gir1.2-gdkpixbuf-2.0', 'pkgver': '2.30.7-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'libgdk-pixbuf2.0-0', 'pkgver': '2.30.7-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'libgdk-pixbuf2.0-0-udeb', 'pkgver': '2.30.7-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'libgdk-pixbuf2.0-common', 'pkgver': '2.30.7-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'libgdk-pixbuf2.0-dev', 'pkgver': '2.30.7-0ubuntu1.1'}
];
