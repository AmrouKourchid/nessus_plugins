...
# extracted from Debian Security Advisory DLA-2096-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2096-1 : ruby-rack-cors security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2020/02/msg00004.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/jessie/ruby-rack-cors");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"ruby-rack-cors", reference:"0.2.9-1+deb8u1")) flag++;
