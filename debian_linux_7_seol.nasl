...
if (description)
{
  ...
  script_name(english:"Debian Linux SEoL (7.x)");
...
contain security vulnerabilities.");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/News/2016/20160425");
...
"Upgrade to a version of Debian Linux that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2016/04/25");
...
var constraints = [
  { max_branch : '7', min_branch : '7', seol : 20160425 }
];
