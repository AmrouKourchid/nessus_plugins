...
# extracted from Amazon Linux 2 Security Advisory ALAS-2025-2726.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : python-webob (ALAS-2025-2726)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of python-webob installed on the remote host is prior to 1.2.3-7. It is, therefore, affected by a
vulnerability as referenced in the ALAS2-2025-2726 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2025-2726.html");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/cve/html/CVE-2024-42353.html");
...
"Run 'yum update python-webob' to update your system.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:amazon:linux:python-webob");
...
var pkgs = [
    {'reference':'python-webob-1.2.3-7.amzn2.0.1', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
