...
# extracted from Red Hat Security Advisory RHSA-2018:2884. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : firefox (RHSA-2018:2884)");
...
referenced in the RHSA-2018:2884 advisory.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_2884.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1a108d76");
  script_set_attribute(attribute:"see_also", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2018-24/");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:2884");
...
"Update the RHEL firefox package based on the guidance in RHSA-2018:2884.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-60.2.2-1.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
