...
# extracted from Red Hat Security Advisory RHSA-2023:7633. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:7633");

  script_name(english:"RHEL 7 : rh-mariadb105-galera and rh-mariadb105-mariadb (RHSA-2023:7633)");
...
referenced in the RHSA-2023:7633 advisory.
    ...
    The following packages have been upgraded to a later upstream version: rh-mariadb105-galera (26.4.14), rh-
    mariadb105-mariadb (10.5.22). (BZ#2114888, BZ#2173013, BZ#2240558)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_7633.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?87d51c1e");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:7633");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-mariadb105-galera-26.4.14-1.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2023-5157']},
      {'reference':'rh-mariadb105-galera-26.4.14-1.el7', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2023-5157']},
      {'reference':'rh-mariadb105-galera-26.4.14-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2023-5157']},
      {'reference':'rh-mariadb105-mariadb-10.5.22-1.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'cves':['CVE-2022-32081', 'CVE-2022-32082', 'CVE-2022-32084', 'CVE-2022-32089', 'CVE-2022-32091', 'CVE-2022-38791', 'CVE-2022-47015', 'CVE-2023-5157']},
      {'reference':'rh-mariadb105-mariadb-10.5.22-1.el7', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'cves':['CVE-2022-32081', 'CVE-2022-32082', 'CVE-2022-32084', 'CVE-2022-32089', 'CVE-2022-32091', 'CVE-2022-38791', 'CVE-2022-47015', 'CVE-2023-5157']},
      {'reference':'rh-mariadb105-mariadb-10.5.22-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'cves':['CVE-2022-32081', 'CVE-2022-32082', 'CVE-2022-32084', 'CVE-2022-32089', 'CVE-2022-32091', 'CVE-2022-38791', 'CVE-2022-47015', 'CVE-2023-5157']}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'rh-mariadb105-galera / rh-mariadb105-mariadb');
}
