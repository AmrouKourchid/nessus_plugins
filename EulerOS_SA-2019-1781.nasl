...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : libexif (EulerOS-SA-2019-1781)");
...
vulnerabilities :
  ...
  - An error when processing the EXIF_IFD_INTEROPERABILITY
    and EXIF_IFD_EXIF tags within libexif version 0.6.21
    can be exploited to exhaust available CPU
    resources.(CVE-2018-20030)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1781
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f34b2d1c");
...
pkgs = ["libexif-0.6.21-17.h3.eulerosv2r8"];
