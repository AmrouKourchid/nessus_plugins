...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : procps-ng (EulerOS-SA-2023-3508)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3508
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8eb56f1f");
...
var pkgs = [
  "procps-ng-3.3.16-16.h9.eulerosv2r10",
  "procps-ng-i18n-3.3.16-16.h9.eulerosv2r10"
];
