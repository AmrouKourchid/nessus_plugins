...
if (description)
{
  ...
  script_name(english:"Adobe FrameMaker Publishing Server 2022 < 2022 Update 1 Security Feature Bypass (APSB23-58)");
...
Publishing Server version 2022 Update 1. It is, therefore, affected by a vulnerability as referenced in the apsb23-58
advisory.

  - Improper Access Control (CWE-284) potentially leading to Security feature bypass (CVE-2023-44324)
...
var constraints = [
  { 'fixed_version' : '17.0.1.45', 'fixed_display' : 'Version 2022 Update 1' }
];
