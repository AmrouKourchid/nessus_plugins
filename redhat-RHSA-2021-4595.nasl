...
# extracted from Red Hat Security Advisory RHSA-2021:4595. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_4595.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c510ed7c");
...
"Update the RHEL binutils package based on the guidance in RHSA-2021:4595.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'binutils-2.30-108.el8_5.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'binutils-devel-2.30-108.el8_5.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
