...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5010384");
  script_xref(name:"MSKB", value:"5010403");
  script_xref(name:"MSFT", value:"MS22-5010384");
  script_xref(name:"MSFT", value:"MS22-5010403");
  script_xref(name:"IAVA", value:"2022-A-0068-S");
  script_xref(name:"IAVA", value:"2022-A-0074-S");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2022/04/15");

  script_name(english:"KB5010403: Windows Server 2008 Security Update (February 2022)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5010403. It is, therefore, affected by multiple vulnerabilities
  ...
  - A remote code execution vulnerability. An attacker can
    ...
    unauthorized arbitrary commands. (CVE-2022-x)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5010403");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5010384");
  script_set_attribute(attribute:"solution", value:
"Apply Cumulative Update 5010403 or Security Update 5010384");
...
if (
  smb_check_rollup(os:'6.0',
                   ...
                   rollup_date:'02_2022',
                   bulletin:bulletin,
                   rollup_kb_list:[5010403, 5010384])
)
{
