...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.12.0 : nghttp2 (EulerOS-SA-2024-2332)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the nghttp2 package installed, the EulerOS Virtualization installation on the remote host
...
Tenable has extracted the preceding description block directly from the EulerOS Virtualization nghttp2 security
advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2332
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e136a9a7");
...
var pkgs = [
  "libnghttp2-1.46.0-3.h3.eulerosv2r12"
];
