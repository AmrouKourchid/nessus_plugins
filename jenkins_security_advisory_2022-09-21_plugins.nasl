...
if (description)
{
  ...
  script_name(english:"Jenkins plugins Multiple Vulnerabilities (2022-09-21)");
...
"Update Jenkins plugins to the following versions:
  - Anchore Container Image Scanner Plugin to version 1.0.25 or later
  - Apprenda Plugin: See vendor advisory
  - BigPanda Notifier Plugin: See vendor advisory
  - build-publisher Plugin: See vendor advisory
  - Compuware Common Configuration Plugin to version 1.0.15 or later
  - CONS3RT Plugin: See vendor advisory
  - DotCi Plugin: See vendor advisory
  - extreme-feedback Plugin: See vendor advisory
  - NS-ND Integration Performance Publisher Plugin: See vendor advisory
  - RQM Plugin: See vendor advisory
  - Rundeck Plugin: See vendor advisory
  - SCM HttpClient Plugin: See vendor advisory
  - Security Inspector Plugin: See vendor advisory
  - SmallTest Plugin: See vendor advisory
  - View26 Test-Reporting Plugin: See vendor advisory
  - Walti Plugin: See vendor advisory
  - WildFly Deployer Plugin: See vendor advisory
  - Worksoft Execution Manager Plugin: See vendor advisory
...
var constraints = [
    {'max_version' : '1.0.24', 'fixed_version' : '1.0.25', 'plugin' : 'Anchore Container Image Scanner Plugin'},
    {'max_version' : '2.2.0', 'fixed_display' : 'See vendor advisory', 'plugin' : 'Apprenda Plugin'},
    {'max_version' : '1.4.0', 'fixed_display' : 'See vendor advisory', 'plugin' : 'BigPanda Notifier Plugin'},
    {'max_version' : '1.22', 'fixed_display' : 'See vendor advisory', 'plugin' : 'build-publisher Plugin'},
    {'max_version' : '1.0.14', 'fixed_version' : '1.0.15', 'plugin' : 'Compuware Common Configuration Plugin'},
    {'max_version' : '1.0.0', 'fixed_display' : 'See vendor advisory', 'plugin' : 'CONS3RT Plugin'},
    {'max_version' : '2.40.00', 'fixed_display' : 'See vendor advisory', 'plugin' : 'DotCi Plugin'},
    {'max_version' : '1.7', 'fixed_display' : 'See vendor advisory', 'plugin' : 'extreme-feedback Plugin'},
    {'max_version' : '4.8.0.134', 'fixed_display' : 'See vendor advisory', 'plugin' : 'NS-ND Integration Performance Publisher Plugin'},
    {'max_version' : '2.8', 'fixed_display' : 'See vendor advisory', 'plugin' : 'RQM Plugin'},
    {'max_version' : '3.6.11', 'fixed_display' : 'See vendor advisory', 'plugin' : 'Rundeck Plugin'},
    {'max_version' : '1.5', 'fixed_display' : 'See vendor advisory', 'plugin' : 'SCM HttpClient Plugin'},
    {'max_version' : '117', 'fixed_display' : 'See vendor advisory', 'plugin' : 'Security Inspector Plugin'},
    {'max_version' : '1.0.4', 'fixed_display' : 'See vendor advisory', 'plugin' : 'SmallTest Plugin'},
    {'max_version' : '1.0.7', 'fixed_display' : 'See vendor advisory', 'plugin' : 'View26 Test-Reporting Plugin'},
    {'max_version' : '1.0.1', 'fixed_display' : 'See vendor advisory', 'plugin' : 'Walti Plugin'},
    {'max_version' : '1.0.2', 'fixed_display' : 'See vendor advisory', 'plugin' : 'WildFly Deployer Plugin'},
    {'max_version' : '10.0.3.503', 'fixed_display' : 'See vendor advisory', 'plugin' : 'Worksoft Execution Manager Plugin'}
];
