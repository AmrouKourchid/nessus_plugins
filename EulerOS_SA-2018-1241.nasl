...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.0 : dhcp (EulerOS-SA-2018-1241)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1241
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3b918fa9");
...
pkgs = ["dhcp-4.2.5-36.h4",
        "dhcp-common-4.2.5-36.h4",
        "dhcp-libs-4.2.5-36.h4"];
