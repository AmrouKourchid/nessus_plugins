...
the RHSA-2013:0699 advisory.

  - rubygem-activerecord: attribute_dos Symbol DoS vulnerability (CVE-2013-1854)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2013/rhsa-2013_0699.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e36f8d9c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2013:0699");
...
"Update the RHEL ruby193-rubygem-activerecord package based on the guidance in RHSA-2013:0699.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-1854");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ruby193-rubygem-activerecord-3.2.8-6.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openshift-ansible'},
      {'reference':'ruby193-rubygem-activerecord-doc-3.2.8-6.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openshift-ansible'}
    ]
  }
];
