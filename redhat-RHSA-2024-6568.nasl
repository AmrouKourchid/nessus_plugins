...
# extracted from Red Hat Security Advisory RHSA-2024:6568. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:6568");

  script_name(english:"RHEL 8 : redhat-ds:11 (RHSA-2024:6568)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for redhat-ds:11.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:6568 advisory.
    ...
    * Improved performance of filter component when evaluating a large value set, such as group members
    (DIRSRV-149)
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_6568.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c321b84c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:6568");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL redhat-ds:11 package based on the guidance in RHSA-2024:6568.");
  ...
  'redhat-ds:11': [
    {
      ...
      'pkgs': [
        {'reference':'389-ds-base-1.4.3.39-5.module+el8dsrv+22259+114d7218', 'cpu':'x86_64', 'release':'8', 'el_string':'el8dsrv', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'389-ds-base-devel-1.4.3.39-5.module+el8dsrv+22259+114d7218', 'cpu':'x86_64', 'release':'8', 'el_string':'el8dsrv', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'389-ds-base-legacy-tools-1.4.3.39-5.module+el8dsrv+22259+114d7218', 'cpu':'x86_64', 'release':'8', 'el_string':'el8dsrv', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'389-ds-base-libs-1.4.3.39-5.module+el8dsrv+22259+114d7218', 'cpu':'x86_64', 'release':'8', 'el_string':'el8dsrv', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'389-ds-base-snmp-1.4.3.39-5.module+el8dsrv+22259+114d7218', 'cpu':'x86_64', 'release':'8', 'el_string':'el8dsrv', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'cockpit-389-ds-1.4.3.39-5.module+el8dsrv+22259+114d7218', 'release':'8', 'el_string':'el8dsrv', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
        {'reference':'python3-lib389-1.4.3.39-5.module+el8dsrv+22259+114d7218', 'release':'8', 'el_string':'el8dsrv', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
