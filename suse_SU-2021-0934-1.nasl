...
# extracted from SUSE update advisory SUSE-SU-2021:0934-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES15 Security Update : gnutls (SUSE-SU-2021:0934-1)");
...
without introducing additional issues.");
  ...
  # https://www.suse.com/support/update/announcement/2021/suse-su-20210934-1
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?00132084");
...
zypper in -t patch
SUSE-SLE-Product-SUSE-Manager-Retail-Branch-Server-4.0-2021-934=1
...
zypper in -t patch SUSE-SLE-Product-SLES_SAP-15-SP1-2021-934=1

SUSE Linux Enterprise Server for SAP 15 :

zypper in -t patch SUSE-SLE-Product-SLES_SAP-15-2021-934=1
...
flag = 0;
if (rpm_check(release:"SLES15", sp:"1", cpu:"x86_64", reference:"libgnutls30-32bit-3.6.7-6.40.2")) flag++;
if (rpm_check(release:"SLES15", sp:"1", cpu:"x86_64", reference:"libgnutls30-32bit-debuginfo-3.6.7-6.40.2")) flag++;
if (rpm_check(release:"SLES15", sp:"1", cpu:"x86_64", reference:"libgnutls30-hmac-32bit-3.6.7-6.40.2")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"gnutls-3.6.7-6.40.2")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"gnutls-debuginfo-3.6.7-6.40.2")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"gnutls-debugsource-3.6.7-6.40.2")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"libgnutls-devel-3.6.7-6.40.2")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"libgnutls30-3.6.7-6.40.2")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"libgnutls30-debuginfo-3.6.7-6.40.2")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"libgnutls30-hmac-3.6.7-6.40.2")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"libgnutlsxx-devel-3.6.7-6.40.2")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"libgnutlsxx28-3.6.7-6.40.2")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"libgnutlsxx28-debuginfo-3.6.7-6.40.2")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"gnutls-3.6.7-6.40.2")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"gnutls-debuginfo-3.6.7-6.40.2")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"gnutls-debugsource-3.6.7-6.40.2")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"libgnutls-devel-3.6.7-6.40.2")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"libgnutls30-3.6.7-6.40.2")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"libgnutls30-debuginfo-3.6.7-6.40.2")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"libgnutls30-hmac-3.6.7-6.40.2")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"libgnutlsxx-devel-3.6.7-6.40.2")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"libgnutlsxx28-3.6.7-6.40.2")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"libgnutlsxx28-debuginfo-3.6.7-6.40.2")) flag++;
