...
if (description)
{
  ...
  script_name(english:"Google Chrome < 114.0.5735.110 Vulnerability");

  script_set_attribute(attribute:"synopsis", value:
"A web browser installed on the remote Windows host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Google Chrome installed on the remote Windows host is prior to 114.0.5735.110. It is, therefore, affected
...
"Upgrade to Google Chrome version 114.0.5735.110 or later.");
...
google_chrome_check_version(installs:installs, fix:'114.0.5735.110', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
