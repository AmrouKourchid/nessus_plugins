...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : libgcrypt (EulerOS-SA-2021-2914)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2914
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4d0d57dd");
...
var pkgs = [
  "libgcrypt-1.8.5-1.h6.eulerosv2r9"
];
