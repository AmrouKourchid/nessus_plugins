...
# extracted from Fedora Security Advisory FEDORA-2024-0489e7ba1e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-0489e7ba1e");

  script_name(english:"Fedora 38 : filezilla / libfilezilla (2024-0489e7ba1e)");
...
FEDORA-2024-0489e7ba1e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-0489e7ba1e");
...
var pkgs = [
    {'reference':'filezilla-3.67.0-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libfilezilla-0.47.0-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
