...
# extracted from openSUSE Security Update openSUSE-2020-15.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : trousers (openSUSE-2020-15)");
...
project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1157651");
...
if ( rpm_check(release:"SUSE15.1", reference:"libtspi1-0.3.14-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libtspi1-debuginfo-0.3.14-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"trousers-0.3.14-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"trousers-debuginfo-0.3.14-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"trousers-debugsource-0.3.14-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"trousers-devel-0.3.14-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libtspi1-32bit-0.3.14-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libtspi1-32bit-debuginfo-0.3.14-lp151.4.3.1") ) flag++;
