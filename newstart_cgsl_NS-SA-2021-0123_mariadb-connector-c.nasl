...
# extracted from ZTE advisory NS-SA-2021-0123. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 6.02 : mariadb-connector-c Multiple Vulnerabilities (NS-SA-2021-0123)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/notice/NS-SA-2021-0123");
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/info/CVE-2020-13249");
  ...
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/info/CVE-2020-2922");
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/info/CVE-2021-2007");
...
contact ZTE for more information.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:mariadb-connector-c");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:mariadb-connector-c-config");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:mariadb-connector-c-debuginfo");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:mariadb-connector-c-debugsource");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:mariadb-connector-c-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:mariadb-connector-c-devel-debuginfo");
