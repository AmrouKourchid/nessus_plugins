...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP12 : llvm (EulerOS-SA-2025-1427)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1427
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?aca8fe44");
...
var pkgs = [
  "llvm-12.0.1-4.h2.eulerosv2r12",
  "llvm-help-12.0.1-4.h2.eulerosv2r12",
  "llvm-libs-12.0.1-4.h2.eulerosv2r12"
];
