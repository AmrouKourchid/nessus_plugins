...
# extracted from Gentoo Linux Security Advisory GLSA 202008-16.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202008-16");
  script_xref(name:"IAVA", value:"2020-A-0391-S");

  script_name(english:"GLSA-202008-16 : Mozilla Firefox, Mozilla Thunderbird: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202008-16
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2020-37/");
  script_set_attribute(attribute:"see_also", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2020-40/");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202008-16");
...
if (qpkg_check(package:"mail-client/thunderbird", unaffected:make_list("ge 68.12.0"), vulnerable:make_list("lt 68.12.0"))) flag++;
if (qpkg_check(package:"mail-client/thunderbird-bin", unaffected:make_list("ge 68.12.0"), vulnerable:make_list("lt 68.12.0"))) flag++;
if (qpkg_check(package:"www-client/firefox", unaffected:make_list("ge 68.12.0"), vulnerable:make_list("lt 68.12.0"))) flag++;
if (qpkg_check(package:"www-client/firefox-bin", unaffected:make_list("ge 68.12.0"), vulnerable:make_list("lt 68.12.0"))) flag++;
