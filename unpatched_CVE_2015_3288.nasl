...
if (description)
{
  ...
  script_cve_id("CVE-2015-3288");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2015-3288");
...
patch available.
  ...
  - mm/memory.c in the Linux kernel before 4.1.4 mishandles anonymous pages, which allows local users to gain
    privileges or cause a denial of service (page tainting) via a crafted application that triggers writing to
    page zero. (CVE-2015-3288)
