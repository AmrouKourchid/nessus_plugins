...
# extracted from Fedora Security Advisory FEDORA-2024-81c9a3fe50
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-81c9a3fe50");

  script_name(english:"Fedora 39 : thunderbird (2024-81c9a3fe50)");
...
FEDORA-2024-81c9a3fe50 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-81c9a3fe50");
...
var pkgs = [
    {'reference':'thunderbird-115.10.1-4.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
