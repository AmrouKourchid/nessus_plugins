...
# extracted from openSUSE Security Update openSUSE-2019-1498.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libtasn1 (openSUSE-2019-1498)");
...
"Update the affected libtasn1 packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:libtasn1-6-32bit-debuginfo");
...
if ( rpm_check(release:"SUSE15.1", reference:"libtasn1-4.13-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libtasn1-6-4.13-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libtasn1-6-debuginfo-4.13-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libtasn1-debuginfo-4.13-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libtasn1-debugsource-4.13-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libtasn1-devel-4.13-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libtasn1-6-32bit-4.13-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libtasn1-6-32bit-debuginfo-4.13-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libtasn1-devel-32bit-4.13-lp151.4.3.1") ) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "libtasn1 / libtasn1-6 / libtasn1-6-debuginfo / libtasn1-debuginfo / etc");
}
