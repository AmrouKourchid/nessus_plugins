...
# extracted from Fedora Security Advisory FEDORA-2019-28d3ca93d2.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : hostapd (2019-28d3ca93d2)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-28d3ca93d2");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"hostapd-2.8-1.fc30")) flag++;
