...
# extracted from Fedora Security Advisory FEDORA-2019-52145aa7ca.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-52145aa7ca");

  script_name(english:"Fedora 30 : wavpack (2019-52145aa7ca)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-52145aa7ca");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"wavpack-5.1.0-13.fc30")) flag++;
