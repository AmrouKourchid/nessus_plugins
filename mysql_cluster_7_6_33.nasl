...
if (description)
{
  ...
  script_name(english:"Oracle MySQL Cluster 7.6.x < 7.6.33 (January 2025 CPU)");
...
mysql_check_version(variant:'Cluster', fixed:'7.6.33', min:'7.6', severity:SECURITY_WARNING);