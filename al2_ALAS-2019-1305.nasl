...
# extracted from Amazon Linux 2 Security Advisory ALAS-2019-1305.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2019-1305");

  script_name(english:"Amazon Linux 2 : nss (ALAS-2019-1305)");
...
virtual machine on the same physical host. (CVE-2018-0495)");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2019-1305.html");
...
flag = 0;
if (rpm_check(release:"AL2", reference:"nss-3.44.0-4.amzn2.0.2")) flag++;
if (rpm_check(release:"AL2", reference:"nss-debuginfo-3.44.0-4.amzn2.0.2")) flag++;
if (rpm_check(release:"AL2", reference:"nss-devel-3.44.0-4.amzn2.0.2")) flag++;
if (rpm_check(release:"AL2", reference:"nss-pkcs11-devel-3.44.0-4.amzn2.0.2")) flag++;
if (rpm_check(release:"AL2", reference:"nss-sysinit-3.44.0-4.amzn2.0.2")) flag++;
if (rpm_check(release:"AL2", reference:"nss-tools-3.44.0-4.amzn2.0.2")) flag++;
