...
# extracted from Red Hat Security Advisory RHSA-2020:1293. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:1293");

  script_name(english:"RHEL 8 : nodejs:12 (RHSA-2020:1293)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for nodejs:12.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2020:1293 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_1293.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6751e4f0");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:1293");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1807349");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL nodejs:12 package based on the guidance in RHSA-2020:1293.");
  ...
  'nodejs:12': [
    {
      ...
      'pkgs': [
        {'reference':'nodejs-12.16.1-2.module+el8.1.0+6117+b25a342c', 'release':'8', 'el_string':'el8.1.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-devel-12.16.1-2.module+el8.1.0+6117+b25a342c', 'release':'8', 'el_string':'el8.1.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-docs-12.16.1-2.module+el8.1.0+6117+b25a342c', 'release':'8', 'el_string':'el8.1.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        ...
        {'reference':'npm-6.13.4-1.12.16.1.2.module+el8.1.0+6117+b25a342c', 'release':'8', 'el_string':'el8.1.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
      ]
    },
    {
      'repo_relative_urls': [
      ...
      'pkgs': [
        {'reference':'nodejs-12.16.1-2.module+el8.1.0+6117+b25a342c', 'sp':'1', 'release':'8', 'el_string':'el8.1.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-devel-12.16.1-2.module+el8.1.0+6117+b25a342c', 'sp':'1', 'release':'8', 'el_string':'el8.1.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-docs-12.16.1-2.module+el8.1.0+6117+b25a342c', 'sp':'1', 'release':'8', 'el_string':'el8.1.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-nodemon-1.18.3-1.module+el8.1.0+3369+37ae6a45', 'sp':'1', 'release':'8', 'el_string':'el8.1.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'nodejs-packaging-17-3.module+el8.1.0+3369+37ae6a45', 'sp':'1', 'release':'8', 'el_string':'el8.1.0', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
        {'reference':'npm-6.13.4-1.12.16.1.2.module+el8.1.0+6117+b25a342c', 'sp':'1', 'release':'8', 'el_string':'el8.1.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
      ]
    }
  ]
};
