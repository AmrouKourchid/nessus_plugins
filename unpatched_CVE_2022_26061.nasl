...
if (description)
{
  ...
  script_cve_id("CVE-2022-26061");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-26061");
...
patch available.
  ...
  - A heap-based buffer overflow vulnerability exists in the gif2h5 functionality of HDF5 Group libhdf5
    1.10.4. A specially-crafted GIF file can lead to code execution. An attacker can provide a malicious file
    to trigger this vulnerability. (CVE-2022-26061)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-26061");
