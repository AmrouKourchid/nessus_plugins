...
"The version of Firefox ESR installed on the remote macOS or Mac OS X host is prior to 115.16. It is, therefore, affected
by multiple vulnerabilities as referenced in the mfsa2024-48 advisory.
...
mozilla_check_version(version:version, path:path, product:'firefox', esr:TRUE, fix:'115.16', min:'115.0.0', severity:SECURITY_HOLE);
