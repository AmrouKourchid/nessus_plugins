...
if (description)
{
  ...
  script_cve_id("CVE-2019-14575");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2019-14575");
...
patch available.
  ...
  - Logic issue in DxeImageVerificationHandler() for EDK II may allow an authenticated user to potentially
    enable escalation of privilege via local access. (CVE-2019-14575)
