...
if (description)
{
  ...
  script_cve_id("CVE-2016-9540");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2016-9540");
...
patch available.
  ...
  - tools/tiffcp.c in libtiff 4.0.6 has an out-of-bounds write on tiled images with odd tile width versus
    image width. Reported as MSVR 35103, aka cpStripToTile heap-buffer-overflow. (CVE-2016-9540)
