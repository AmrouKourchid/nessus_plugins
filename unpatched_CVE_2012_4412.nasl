...
if (description)
{
  ...
  script_cve_id("CVE-2012-4412");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2012-4412");
...
patch available.
  ...
  - Integer overflow in string/strcoll_l.c in the GNU C Library (aka glibc or libc6) 2.17 and earlier allows
