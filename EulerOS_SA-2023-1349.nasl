...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : binutils (EulerOS-SA-2023-1349)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1349
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?88ff18ab");
...
var pkgs = [
  "binutils-2.34-4.h16.eulerosv2r10"
];
