...
if (description)
{
  ...
  script_name(english:"Mozilla Firefox ESR < 115.2.1");

  script_set_attribute(attribute:"synopsis", value:
"A web browser installed on the remote macOS or Mac OS X host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Firefox ESR installed on the remote macOS or Mac OS X host is prior to 115.2.1. It is, therefore,
...
"Upgrade to Mozilla Firefox ESR version 115.2.1 or later.");
...
mozilla_check_version(version:version, path:path, product:'firefox', esr:TRUE, fix:'115.2.1', min:'115.0.0', severity:SECURITY_HOLE);
