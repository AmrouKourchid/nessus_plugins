...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : python-pip (EulerOS-SA-2024-2451)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2451
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b24abdee");
...
var pkgs = [
  "python-pip-wheel-20.2.2-1.h10.eulerosv2r10",
  "python3-pip-20.2.2-1.h10.eulerosv2r10"
];
