...
# extracted from Fedora Security Advisory FEDORA-2024-a7b8b6bfe2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-a7b8b6bfe2");

  script_name(english:"Fedora 40 : uriparser (2024-a7b8b6bfe2)");
...
FEDORA-2024-a7b8b6bfe2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-a7b8b6bfe2");
...
var pkgs = [
    {'reference':'uriparser-0.9.8-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
