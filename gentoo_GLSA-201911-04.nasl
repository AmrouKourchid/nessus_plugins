...
# extracted from Gentoo Linux Security Advisory GLSA 201911-04.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201911-04");

  script_name(english:"GLSA-201911-04 : OpenSSL: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-201911-04
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/201911-04");
...
if (qpkg_check(package:"dev-libs/openssl", unaffected:make_list("ge 1.0.2t"), vulnerable:make_list("lt 1.0.2t"))) flag++;
