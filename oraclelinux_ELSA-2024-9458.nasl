...
# extracted from Oracle Linux Security Advisory ELSA-2024-9458.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : python3.11-urllib3 (ELSA-2024-9458)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-9458.html");
...
var pkgs = [
    {'reference':'python3.11-urllib3-1.26.12-2.el9_5.1', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
