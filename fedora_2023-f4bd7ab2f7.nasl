...
# extracted from Fedora Security Advisory FEDORA-2023-f4bd7ab2f7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-f4bd7ab2f7");

  script_name(english:"Fedora 38 : containernetworking-plugins (2023-f4bd7ab2f7)");
...
FEDORA-2023-f4bd7ab2f7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-f4bd7ab2f7");
...
var pkgs = [
    {'reference':'containernetworking-plugins-1.1.1-16.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
