...
# AlmaLinux Security Advisory ALSA-2023:0328.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:0328");
  script_xref(name:"IAVB", value:"2022-B-0042-S");

  script_name(english:"AlmaLinux 9 : go-toolset and golang (ALSA-2023:0328)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 9 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ALSA-2023:0328 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2023-0328.html");
...
var pkgs = [
    ...
    {'reference':'golang-race-1.18.9-1.el9_1', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
