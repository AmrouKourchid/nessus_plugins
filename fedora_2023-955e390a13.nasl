...
# extracted from Fedora Security Advisory FEDORA-2023-955e390a13
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-955e390a13");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2023/11/16");

  script_name(english:"Fedora 38 : roundcubemail (2023-955e390a13)");
...
FEDORA-2023-955e390a13 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-955e390a13");
...
var pkgs = [
    {'reference':'roundcubemail-1.6.4-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
