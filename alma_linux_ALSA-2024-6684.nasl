...
# AlmaLinux Security Advisory ALSA-2024:6684.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:6684");

  script_name(english:"AlmaLinux 8 : thunderbird (ALSA-2024:6684)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2024-6684.html");
...
"Update the affected thunderbird package.");
  ...
  script_cwe_id(120, 358, 416, 497, 704, 787, 843);
...
var pkgs = [
    {'reference':'thunderbird-128.2.0-1.el8_10.alma.1', 'cpu':'aarch64', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0', 'allowmaj':TRUE},
    {'reference':'thunderbird-128.2.0-1.el8_10.alma.1', 'cpu':'ppc64le', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0', 'allowmaj':TRUE},
    {'reference':'thunderbird-128.2.0-1.el8_10.alma.1', 'cpu':'s390x', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0', 'allowmaj':TRUE},
    {'reference':'thunderbird-128.2.0-1.el8_10.alma.1', 'cpu':'x86_64', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0', 'allowmaj':TRUE}
];
