...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : gnupg2 (EulerOS-SA-2022-2929)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2929
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ea2304d8");
...
var pkgs = [
  "gnupg2-2.2.21-1.h5.eulerosv2r10"
];
