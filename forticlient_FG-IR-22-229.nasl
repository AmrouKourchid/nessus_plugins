...
if (description)
{
  ...
  script_name(english:"Fortinet FortiClient Insecure Installation Folder (FG-IR-22-229)");
...
vulnerability as referenced in the FG-IR-22-229 advisory.
  ...
  - An incorrect default permission [CWE-276] vulnerability in FortiClient (Windows) versions 7.0.0 through
    7.0.6 and 6.4.0 through 6.4.8 and FortiConverter (Windows) versions 6.2.0 through 6.2.1, 7.0.0 and all
    versions of 6.0.0 may allow a local authenticated attacker to tamper with files in the installation
    folder, if FortiClient or FortiConverter is installed in an insecure folder. (CVE-2022-33877)
...
"Please upgrade to FortiClientWindows version 6.4.9/7.0.7 or later.");
