...
# extracted from Fedora Security Advisory FEDORA-2022-061f857481
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-061f857481");

  script_name(english:"Fedora 35 : mingw-libtasn1 (2022-061f857481)");
...
FEDORA-2022-061f857481 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-061f857481");
...
var pkgs = [
    {'reference':'mingw-libtasn1-4.19.0-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
