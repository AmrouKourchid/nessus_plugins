...
referenced in the RHSA-2012:0144 advisory.

  - flash-plugin: multiple code execution flaws (APSB12-03) (CVE-2012-0752, CVE-2012-0753, CVE-2012-0754,
    CVE-2012-0755, CVE-2012-0756)

  - flash-plugin: universal cross-site scripting flaw (APSB12-03) (CVE-2012-0767)
...
number.");
  ...
  # https://access.redhat.com/security/data/csaf/v2/advisories/2012/rhsa-2012_0144.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?663acb52");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2012:0144");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#critical");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=791034");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=791035");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL flash-plugin package based on the guidance in RHSA-2012:0144.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:H/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:R/S:C/C:L/I:L/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:H/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2012-0756");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2012-0767");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'flash-plugin-10.3.183.15-1.el5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'flash-plugin-10.3.183.15-1.el6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
