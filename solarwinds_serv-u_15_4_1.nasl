...
if (description)
{
  ...
  script_cve_id("CVE-2023-40053");
  script_xref(name:"IAVA", value:"2023-A-0671-S");

  script_name(english:"SolarWinds Serv-U 15.4 < 15.4.1");

  script_set_attribute(attribute:"synopsis", value:
"SolarWinds Serv-U is affected by a vulnerability");
  script_set_attribute(attribute:"description", value:
"The version of SolarWinds Serv-U installed on the remote host is prior to 15.4.1. It is, therefore, affected by a
vulnerability as referenced in the serv-u_15_4_1 advisory.

  - A vulnerability has been identified within Serv-U 15.4 that allows an authenticated actor to insert
    content on the file share function feature of Serv-U, which could be used maliciously. (CVE-2023-40053)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://www.solarwinds.com/trust-center/security-advisories/cve-2023-40053
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e030944e");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Serv-U version 15.4.1 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:S/C:N/I:P/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:L/UI:N/S:C/C:N/I:L/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-40053");
...
var constraints = [
  { 'min_version' : '15.4', 'max_version' : '15.4 HF2', 'fixed_version' : '15.4.1' }
];
