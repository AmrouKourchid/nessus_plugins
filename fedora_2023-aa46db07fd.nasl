...
# extracted from Fedora Security Advisory FEDORA-2023-aa46db07fd
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-aa46db07fd");

  script_name(english:"Fedora 39 : rust-askama / rust-askama_shared / rust-comrak (2023-aa46db07fd)");
...
FEDORA-2023-aa46db07fd advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-aa46db07fd");
...
var pkgs = [
    {'reference':'rust-askama-0.11.1-4.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-askama_shared-0.12.2-4.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-comrak-0.18.0-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
