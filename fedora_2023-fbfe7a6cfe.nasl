...
# extracted from Fedora Security Advisory FEDORA-2023-fbfe7a6cfe
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-fbfe7a6cfe");

  script_name(english:"Fedora 37 : redis (2023-fbfe7a6cfe)");
...
FEDORA-2023-fbfe7a6cfe advisory.
    ...
    *    Avoid possible hang when client issues long KEYS, SRANDMEMBER, HRANDFIELD,    and ZRANDMEMBER
    commands and gets disconnected by client output buffer limit (#11676)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-fbfe7a6cfe");
...
var pkgs = [
    {'reference':'redis-7.0.8-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
