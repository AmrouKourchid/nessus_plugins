...
if (description)
{
  ...
  script_cve_id("CVE-2007-1358");

  script_name(english:"Apache Tomcat < 6.0.6 Cross-Site Scripting");

  script_set_attribute(attribute:"synopsis", value:
"The remote Apache Tomcat server is affected by a cross-site
...
relied only on the application's self-reported version number.");
  script_set_attribute(attribute:"see_also", value:"http://tomcat.apache.org/security-6.html#Fixed_in_Apache_Tomcat_6.0.6");
...
tomcat_check_version(fixed:"6.0.6", min:"6.0.0", severity:SECURITY_NOTE, xss:TRUE, granularity_regex:"^6(\.0)?$");
