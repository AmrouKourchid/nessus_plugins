...
# extracted from Fedora Security Advisory FEDORA-2018-e87eb1ae68.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 26 : 1:libreoffice (2018-e87eb1ae68)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"- CVE-2018-10119 Use after free in sdstor/stgstrms.cxx

  - CVE-2018-10120 Out of bounds write in
    filter/ww8/ww8toolbar.cxx

Note that Tenable Network Security has extracted the preceding
description block directly from the Fedora update system website.
Tenable has attempted to automatically clean and format it as much as
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-e87eb1ae68");
...
flag = 0;
if (rpm_check(release:"FC26", reference:"libreoffice-5.3.7.2-9.fc26", epoch:"1")) flag++;
