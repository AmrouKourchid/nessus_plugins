...
# SUSE update advisory SUSE-SU-2025:1465-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2025:1465-1");

  script_name(english:"SUSE SLES12 Security Update : apache2-mod_auth_openidc (SUSE-SU-2025:1465-1)");
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2025-May/020800.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b05db761");
...
var pkgs = [
    {'reference':'apache2-mod_auth_openidc-2.4.0-7.19.1', 'sp':'5', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-ltss-extended-security-release-12.5']},
    {'reference':'apache2-mod_auth_openidc-2.4.0-7.19.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.5']}
];
