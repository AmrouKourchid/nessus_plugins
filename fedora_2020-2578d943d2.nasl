...
# extracted from Fedora Security Advisory FEDORA-2020-2578d943d2.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 33 : matrix-synapse / python-canonicaljson (2020-2578d943d2)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-2578d943d2");
  script_set_attribute(attribute:"see_also", value:"https://github.com/matrix-org/synapse/blob/develop/UPGRADE.rst");
  script_set_attribute(attribute:"solution", value:
"Update the affected matrix-synapse and / or python-canonicaljson
packages.");
...
flag = 0;
if (rpm_check(release:"FC33", reference:"matrix-synapse-1.23.0-1.fc33")) flag++;
if (rpm_check(release:"FC33", reference:"python-canonicaljson-1.4.0-1.fc33")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "matrix-synapse / python-canonicaljson");
}
