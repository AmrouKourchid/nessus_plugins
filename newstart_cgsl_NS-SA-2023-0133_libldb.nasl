...
# extracted from ZTE advisory NS-SA-2023-0133. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 6.06 : libldb Vulnerability (NS-SA-2023-0133) (deprecated)");

  script_set_attribute(attribute:"synopsis", value:
"This plugin has been deprecated.");
  script_set_attribute(attribute:"description", value:
"This plugin has been deprecated.");
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/notice/NS-SA-2023-0133");
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/info/CVE-2022-32746");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:libldb-doc");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:python-ldb-devel-common");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:python3-ldb");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:python3-ldb-devel");
