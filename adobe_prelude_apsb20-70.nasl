...
"The version of Adobe Prelude installed on the remote Windows host is prior to 9.0.2. It is, therefore, affected by a
vulnerability as referenced in the APSB20-70 advisory.

  - Adobe Prelude version 9.0.1 (and earlier) is affected by an uncontrolled search path element that could
    result in arbitrary code execution in the context of the current user. Exploitation of this issue requires
    user interaction in that a victim must open a malicious file. (CVE-2020-24440)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://helpx.adobe.com/security/products/prelude/apsb20-70.html");
