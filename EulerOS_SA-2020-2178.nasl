...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : libxml2 (EulerOS-SA-2020-2178)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2178
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?946d74c7");
...
pkgs = ["libxml2-2.9.10-1.h15.eulerosv2r9",
        "python3-libxml2-2.9.10-1.h15.eulerosv2r9"];
