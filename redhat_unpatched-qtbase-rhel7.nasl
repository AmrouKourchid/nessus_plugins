...
# extracted from Red Hat Security Advisory qtbase. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2023-37369", "CVE-2023-38197", "CVE-2024-25580");

  script_name(english:"RHEL 7 : qtbase (Unpatched Vulnerability) (deprecated)");
