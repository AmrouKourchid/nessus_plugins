...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : libsndfile (EulerOS-SA-2022-2570)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the libsndfile packages installed, the EulerOS Virtualization installation on the remote
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2570
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?940d5ee7");
...
var pkgs = [
  "libsndfile-1.0.28-9.h7.eulerosv2r8",
  "libsndfile-devel-1.0.28-9.h7.eulerosv2r8"
];
