...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'openssh-7.5p1-14.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'openssh-clients-7.5p1-14.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'openssh-debuginfo-7.5p1-14.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'openssh-server-7.5p1-14.ph2')) flag++;
