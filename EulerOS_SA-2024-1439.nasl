...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.0 : curl (EulerOS-SA-2024-1439)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1439
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bc02718e");
...
var pkgs = [
  "curl-7.79.1-2.h26.eulerosv2r11",
  "libcurl-7.79.1-2.h26.eulerosv2r11"
];
