...
# extracted from Red Hat Security Advisory RHSA-2024:2079. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2079");

  script_name(english:"RHEL 9 : git-lfs (RHSA-2024:2079)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2269b734");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2079");
...
"Update the RHEL git-lfs package based on the guidance in RHSA-2024:2079.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'git-lfs-3.2.0-2.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
