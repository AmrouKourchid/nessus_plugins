...
if (description)
{
  ...
  script_name(english:"OpenSSL 3.1.0 < 3.1.6 Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote service is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of OpenSSL installed on the remote host is prior to 3.1.6. It is, therefore, affected by multiple
vulnerabilities as referenced in the 3.1.6 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5ee92eab");
  # https://github.com/openssl/openssl/commit/704f725b96aa373ee45ecfb23f6abfe8be8d9177
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6f15218c");
  # https://github.com/openssl/openssl/commit/7e4d731b1c07201ad9374c1cd9ac5263bdf35bce
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f40bd907");
