...
# Rocky Linux Security Advisory RLSA-2023:0318.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2023:0318");

  script_name(english:"Rocky Linux 9 : postgresql-jdbc (RLSA-2023:0318)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2023:0318");
