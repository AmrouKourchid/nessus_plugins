...
# extracted from Fedora Security Advisory FEDORA-2024-e513c6594d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-e513c6594d");

  script_name(english:"Fedora 38 : kernel (2024-e513c6594d)");
...
FEDORA-2024-e513c6594d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-e513c6594d");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  var cve_list = make_list('FEDORA-2024-e513c6594d');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for FEDORA-2024-e513c6594d');
  }
  else
  {
...
var pkgs = [
    {'reference':'kernel-6.8.9-100.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
