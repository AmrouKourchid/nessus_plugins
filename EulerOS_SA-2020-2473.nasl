...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : python-pillow (EulerOS-SA-2020-2473)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2473
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?73d6b287");
...
"Update the affected python-pillow packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-10378");
...
pkgs = ["python-pillow-2.0.0-19.h7.gitd1c6db8.eulerosv2r7"];
