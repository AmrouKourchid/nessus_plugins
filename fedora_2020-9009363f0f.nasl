...
# extracted from Fedora Security Advisory FEDORA-2020-9009363f0f.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : zsh (2020-9009363f0f)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-9009363f0f");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"zsh-5.7.1-6.fc30")) flag++;
