...
# extracted from Fedora Security Advisory FEDORA-2023-6454c8edea
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-6454c8edea");

  script_name(english:"Fedora 37 : iniparser (2023-6454c8edea)");
...
FEDORA-2023-6454c8edea advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-6454c8edea");
...
var pkgs = [
    {'reference':'iniparser-4.1-11.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
