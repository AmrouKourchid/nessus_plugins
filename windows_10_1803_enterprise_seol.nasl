...
if (description)
{
  ...
  script_name(english:"Microsoft Windows 10 1803 Enterprise SEoL");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Microsoft Windows is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"Microsoft Windows 10 1803 Enterprise is no longer maintained by its vendor or provider.
...
"Upgrade to a version of Microsoft Windows that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2021/04/11");
...
var os = ucf::get_os_cpe(vendor:'microsoft', product:'windows_10_1803', type:'local');

var constraints = [
  { seol : 20210411, cpe_attributes : [{'edition': 'enterprise*'}] }
];
