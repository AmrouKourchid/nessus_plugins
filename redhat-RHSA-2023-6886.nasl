...
# extracted from Red Hat Security Advisory RHSA-2023:6886. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : plexus-archiver (RHSA-2023:6886)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for plexus-archiver.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2023:6886 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6886.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?586e4b5f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2242288");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6886");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL plexus-archiver package based on the guidance in RHSA-2023:6886.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'plexus-archiver-2.4.2-6.el7_9', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'plexus-archiver-javadoc-2.4.2-6.el7_9', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
