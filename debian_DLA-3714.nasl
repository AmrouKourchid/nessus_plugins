...
# extracted from Debian Security Advisory dla-3714. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3714 : keystone - security update");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/keystone");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2021-3563");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2021-38155");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/keystone");
...
"Upgrade the keystone packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-38155");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:keystone-doc");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:python3-keystone");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'keystone', 'reference': '2:14.2.0-0+deb10u2'},
    {'release': '10.0', 'prefix': 'keystone-doc', 'reference': '2:14.2.0-0+deb10u2'},
    {'release': '10.0', 'prefix': 'python3-keystone', 'reference': '2:14.2.0-0+deb10u2'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'keystone / keystone-doc / python3-keystone');
}
