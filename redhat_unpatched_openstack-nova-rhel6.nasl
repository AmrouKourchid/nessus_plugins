...
# extracted from Red Hat Security Advisory openstack-nova. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2015-1850", "CVE-2015-5162");

  script_name(english:"RHEL 6 : openstack-nova (Unpatched Vulnerability) (deprecated)");
