...
# extracted from Fedora Security Advisory FEDORA-2023-6325ed25c4
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-6325ed25c4");

  script_name(english:"Fedora 36 : kernel (2023-6325ed25c4)");
...
FEDORA-2023-6325ed25c4 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-6325ed25c4");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for FEDORA-2023-6325ed25c4');
  }
  else
  {
...
var pkgs = [
    {'reference':'kernel-6.2.12-100.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
