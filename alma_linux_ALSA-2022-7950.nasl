...
# AlmaLinux Security Advisory ALSA-2022:7950.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2022:7950");

  script_name(english:"AlmaLinux 9 : Image Builder (ALSA-2022:7950)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2022-7950.html");
