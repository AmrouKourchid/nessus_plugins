...
# extracted from Fedora Security Advisory FEDORA-2025-adbb0031f7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-adbb0031f7");
  script_xref(name:"IAVA", value:"2025-A-0123-S");

  script_name(english:"Fedora 40 : libxml2 (2025-adbb0031f7)");
...
FEDORA-2025-adbb0031f7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-adbb0031f7");
...
var pkgs = [
    {'reference':'libxml2-2.12.10-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
