...
the ALAS2-2021-1722 advisory.
    ...
    NSS.When verifying a DER-encoded signature, NSS decodes the signature into a fixed-size buffer and passes
    the buffer to the underlying PKCS \#11 module. The length of the signature is not correctly checked when
