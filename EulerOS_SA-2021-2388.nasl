...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : java-1.7.0-openjdk (EulerOS-SA-2021-2388)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2388
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?21da6d8c");
...
"Update the affected java-1.7.0-openjdk package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-2958");
...
pkgs = ["java-1.7.0-openjdk-1.7.0.191-2.6.15.4.h12",
        "java-1.7.0-openjdk-devel-1.7.0.191-2.6.15.4.h12",
        "java-1.7.0-openjdk-headless-1.7.0.191-2.6.15.4.h12"];
