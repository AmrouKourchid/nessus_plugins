...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS / 22.04 LTS : Python vulnerabilities (USN-5767-1)");
...
vulnerabilities as referenced in the USN-5767-1 advisory.
    ...
    Nicky Mouha discovered that Python incorrectly handled certain SHA-3 internals. An attacker could possibly
    use this issue to cause a crash or execute arbitrary code. (CVE-2022-37454)

    It was discovered that Python incorrectly handled certain IDNA inputs. An attacker could possibly use this
    issue to expose sensitive information denial of service, or cause a crash. (CVE-2022-45061)
