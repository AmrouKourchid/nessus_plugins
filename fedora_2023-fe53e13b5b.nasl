...
# extracted from Fedora Security Advisory FEDORA-2023-fe53e13b5b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-fe53e13b5b");
  script_xref(name:"IAVB", value:"2023-B-0080-S");
  script_xref(name:"CEA-ID", value:"CEA-2024-0004");

  script_name(english:"Fedora 38 : golang (2023-fe53e13b5b)");
...
FEDORA-2023-fe53e13b5b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-fe53e13b5b");
...
var pkgs = [
    {'reference':'golang-1.20.10-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
