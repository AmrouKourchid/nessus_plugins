...
# extracted from Fedora Security Advisory FEDORA-2025-e45eecf53a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-e45eecf53a");

  script_name(english:"Fedora 40 : webkit2gtk4.0 (2025-e45eecf53a)");
...
FEDORA-2025-e45eecf53a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-e45eecf53a");
...
var pkgs = [
    {'reference':'webkit2gtk4.0-2.46.5-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
