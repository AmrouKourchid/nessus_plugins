...
not world readable.");
 ...
 script_set_attribute(attribute:"cvss_score_source", value:"CVE-1999-0082");
 ...
 script_dependencies("ftpserver_detect_type_nd_version.nasl", "ftp_anonymous.nasl", "ftp_root.nasl");
