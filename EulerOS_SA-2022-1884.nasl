...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : compat-libtiff3 (EulerOS-SA-2022-1884)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1884
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0a1eeb32");
...
var pkgs = [
  "compat-libtiff3-3.9.4-11.h30.eulerosv2r7"
];
