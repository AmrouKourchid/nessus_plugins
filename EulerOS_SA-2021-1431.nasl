...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.6 : gd (EulerOS-SA-2021-1431)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1431
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?61d0dfe5");
...
pkgs = ["gd-2.0.35-26.h9.eulerosv2r7"];
