...
# extracted from Fedora Security Advisory FEDORA-2024-e457192aa2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-e457192aa2");

  script_name(english:"Fedora 40 : lemonldap-ng (2024-e457192aa2)");
...
FEDORA-2024-e457192aa2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-e457192aa2");
...
var pkgs = [
    {'reference':'lemonldap-ng-2.20.1-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
