...
# extracted from Red Hat Security Advisory RHSA-2022:8644. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:8644");

  script_name(english:"RHEL 9 : varnish (RHSA-2022:8644)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8644.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fc0fdd62");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8644");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2141844");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL varnish package based on the guidance in RHSA-2022:8644.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'varnish-6.6.2-2.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'varnish-devel-6.6.2-2.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'varnish-docs-6.6.2-2.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
