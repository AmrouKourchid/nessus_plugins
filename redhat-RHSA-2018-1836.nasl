...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_1836.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?88a85fc9");
  script_set_attribute(attribute:"see_also", value:"https://snyk.io/research/zip-slip-vulnerability");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:1836");
...
"Update the RHEL plexus-archiver package based on the guidance in RHSA-2018:1836.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'plexus-archiver-2.4.2-5.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'plexus-archiver-javadoc-2.4.2-5.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
