...
# extracted from Red Hat Security Advisory RHSA-2022:1764. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:1764");
  script_xref(name:"IAVA", value:"2021-A-0497-S");

  script_name(english:"RHEL 8 : python38:3.8 and python38-devel:3.8 (RHSA-2022:1764)");
...
referenced in the RHSA-2022:1764 advisory.
    ...
    The following packages have been upgraded to a later upstream version: python38 (3.8), python38-devel
    (3.8). (BZ#1997680, BZ#1997860)
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_1764.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c4c1b83d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:1764");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2004587");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2006789");
...
"Update the RHEL python38:3.8 / python38-devel:3.8 packages based on the guidance in RHSA-2022:1764.");
  ...
  'python38:3.8': [
    {
      ...
      'pkgs': [
        {'reference':'python38-3.8.12-1.module+el8.6.0+12642+c3710b74', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2021-3733', 'CVE-2021-3737', 'CVE-2021-43818', 'CVE-2022-0391']},
        {'reference':'python38-asn1crypto-1.2.0-3.module+el8.4.0+8888+89bc7e79', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2021-3733', 'CVE-2021-3737', 'CVE-2021-43818', 'CVE-2022-0391']},
        {'reference':'python38-babel-2.7.0-11.module+el8.5.0+11015+9c1c7c42', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2021-3733', 'CVE-2021-3737', 'CVE-2021-43818', 'CVE-2022-0391']},
        {'reference':'python38-cffi-1.13.2-3.module+el8.4.0+8888+89bc7e79', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2021-3733', 'CVE-2021-3737', 'CVE-2021-43818', 'CVE-2022-0391']},
        {'reference':'python38-chardet-3.0.4-19.module+el8.4.0+8888+89bc7e79', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2021-3733', 'CVE-2021-3737', 'CVE-2021-43818', 'CVE-2022-0391']},
        {'reference':'python38-cryptography-2.8-3.module+el8.4.0+8888+89bc7e79', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2021-3733', 'CVE-2021-3737', 'CVE-2021-43818', 'CVE-2022-0391']},
        {'reference':'python38-Cython-0.29.14-4.module+el8.4.0+8888+89bc7e79', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2021-3733', 'CVE-2021-3737', 'CVE-2021-43818', 'CVE-2022-0391']},
        {'reference':'python38-debug-3.8.12-1.module+el8.6.0+12642+c3710b74', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2021-3733', 'CVE-2021-3737', 'CVE-2021-43818', 'CVE-2022-0391']},
        {'reference':'python38-devel-3.8.12-1.module+el8.6.0+12642+c3710b74', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2021-3733', 'CVE-2021-3737', 'CVE-2021-43818', 'CVE-2022-0391']},
        {'reference':'python38-idle-3.8.12-1.module+el8.6.0+12642+c3710b74', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2021-3733', 'CVE-2021-3737', 'CVE-2021-43818', 'CVE-2022-0391']},
        {'reference':'python38-idna-2.8-6.module+el8.4.0+8888+89bc7e79', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2021-3733', 'CVE-2021-3737', 'CVE-2021-43818', 'CVE-2022-0391']},
        {'reference':'python38-jinja2-2.10.3-5.module+el8.5.0+10542+ba057329', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2021-3733', 'CVE-2021-3737', 'CVE-2021-43818', 'CVE-2022-0391']},
        {'reference':'python38-libs-3.8.12-1.module+el8.6.0+12642+c3710b74', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2021-3733', 'CVE-2021-3737', 'CVE-2021-43818', 'CVE-2022-0391']},
        {'reference':'python38-lxml-4.4.1-7.module+el8.6.0+13958+214a5473', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2021-3733', 'CVE-2021-3737', 'CVE-2021-43818', 'CVE-2022-0391']},
        {'reference':'python38-markupsafe-1.1.1-6.module+el8.4.0+8888+89bc7e79', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2021-3733', 'CVE-2021-3737', 'CVE-2021-43818', 'CVE-2022-0391']},
        {'reference':'python38-mod_wsgi-4.6.8-3.module+el8.4.0+8888+89bc7e79', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2021-3733', 'CVE-2021-3737', 'CVE-2021-43818', 'CVE-2022-0391']},
        {'reference':'python38-numpy-1.17.3-6.module+el8.5.0+12205+a865257a', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2021-3733', 'CVE-2021-3737', 'CVE-2021-43818', 'CVE-2022-0391']},
        {'reference':'python38-numpy-doc-1.17.3-6.module+el8.5.0+12205+a865257a', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2021-3733', 'CVE-2021-3737', 'CVE-2021-43818', 'CVE-2022-0391']},
        {'reference':'python38-numpy-f2py-1.17.3-6.module+el8.5.0+12205+a865257a', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2021-3733', 'CVE-2021-3737', 'CVE-2021-43818', 'CVE-2022-0391']},
        {'reference':'python38-pip-19.3.1-5.module+el8.6.0+13002+70cfc74a', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2021-3733', 'CVE-2021-3737', 'CVE-2021-43818', 'CVE-2022-0391']},
        {'reference':'python38-pip-wheel-19.3.1-5.module+el8.6.0+13002+70cfc74a', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2021-3733', 'CVE-2021-3737', 'CVE-2021-43818', 'CVE-2022-0391']},
        {'reference':'python38-ply-3.11-10.module+el8.4.0+9579+e9717e18', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2021-3733', 'CVE-2021-3737', 'CVE-2021-43818', 'CVE-2022-0391']},
        {'reference':'python38-psutil-5.6.4-4.module+el8.5.0+12031+10ce4870', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2021-3733', 'CVE-2021-3737', 'CVE-2021-43818', 'CVE-2022-0391']},
        {'reference':'python38-psycopg2-2.8.4-4.module+el8.4.0+8888+89bc7e79', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2021-3733', 'CVE-2021-3737', 'CVE-2021-43818', 'CVE-2022-0391']},
        {'reference':'python38-psycopg2-doc-2.8.4-4.module+el8.4.0+8888+89bc7e79', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2021-3733', 'CVE-2021-3737', 'CVE-2021-43818', 'CVE-2022-0391']},
        {'reference':'python38-psycopg2-tests-2.8.4-4.module+el8.4.0+8888+89bc7e79', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2021-3733', 'CVE-2021-3737', 'CVE-2021-43818', 'CVE-2022-0391']},
        {'reference':'python38-pycparser-2.19-3.module+el8.4.0+8888+89bc7e79', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2021-3733', 'CVE-2021-3737', 'CVE-2021-43818', 'CVE-2022-0391']},
        {'reference':'python38-PyMySQL-0.10.1-1.module+el8.4.0+9692+8e86ab84', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2021-3733', 'CVE-2021-3737', 'CVE-2021-43818', 'CVE-2022-0391']},
        {'reference':'python38-pysocks-1.7.1-4.module+el8.4.0+8888+89bc7e79', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2021-3733', 'CVE-2021-3737', 'CVE-2021-43818', 'CVE-2022-0391']},
        {'reference':'python38-pytz-2019.3-3.module+el8.4.0+8888+89bc7e79', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2021-3733', 'CVE-2021-3737', 'CVE-2021-43818', 'CVE-2022-0391']},
        {'reference':'python38-pyyaml-5.4.1-1.module+el8.5.0+10721+14d8e0d5', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2021-3733', 'CVE-2021-3737', 'CVE-2021-43818', 'CVE-2022-0391']},
        {'reference':'python38-requests-2.22.0-9.module+el8.4.0+8888+89bc7e79', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2021-3733', 'CVE-2021-3737', 'CVE-2021-43818', 'CVE-2022-0391']},
        {'reference':'python38-rpm-macros-3.8.12-1.module+el8.6.0+12642+c3710b74', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2021-3733', 'CVE-2021-3737', 'CVE-2021-43818', 'CVE-2022-0391']},
        {'reference':'python38-scipy-1.3.1-4.module+el8.4.0+8888+89bc7e79', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2021-3733', 'CVE-2021-3737', 'CVE-2021-43818', 'CVE-2022-0391']},
        {'reference':'python38-setuptools-41.6.0-5.module+el8.5.0+12205+a865257a', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2021-3733', 'CVE-2021-3737', 'CVE-2021-43818', 'CVE-2022-0391']},
        {'reference':'python38-setuptools-wheel-41.6.0-5.module+el8.5.0+12205+a865257a', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2021-3733', 'CVE-2021-3737', 'CVE-2021-43818', 'CVE-2022-0391']},
        {'reference':'python38-six-1.12.0-10.module+el8.4.0+8888+89bc7e79', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2021-3733', 'CVE-2021-3737', 'CVE-2021-43818', 'CVE-2022-0391']},
        {'reference':'python38-test-3.8.12-1.module+el8.6.0+12642+c3710b74', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2021-3733', 'CVE-2021-3737', 'CVE-2021-43818', 'CVE-2022-0391']},
        {'reference':'python38-tkinter-3.8.12-1.module+el8.6.0+12642+c3710b74', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2021-3733', 'CVE-2021-3737', 'CVE-2021-43818', 'CVE-2022-0391']},
        {'reference':'python38-urllib3-1.25.7-5.module+el8.5.0+11639+ea5b349d', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2021-3733', 'CVE-2021-3737', 'CVE-2021-43818', 'CVE-2022-0391']},
        {'reference':'python38-wheel-0.33.6-6.module+el8.5.0+12205+a865257a', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2021-3733', 'CVE-2021-3737', 'CVE-2021-43818', 'CVE-2022-0391']},
        {'reference':'python38-wheel-wheel-0.33.6-6.module+el8.5.0+12205+a865257a', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2021-3733', 'CVE-2021-3737', 'CVE-2021-43818', 'CVE-2022-0391']}
      ]
    }
  ],
  'python38-devel:3.8': [
    {
      ...
      'pkgs': [
        {'reference':'python38-atomicwrites-1.3.0-8.module+el8.4.0+8888+89bc7e79', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2021-3733', 'CVE-2021-3737', 'CVE-2022-0391']},
        {'reference':'python38-attrs-19.3.0-3.module+el8.4.0+8888+89bc7e79', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2021-3733', 'CVE-2021-3737', 'CVE-2022-0391']},
        {'reference':'python38-more-itertools-7.2.0-5.module+el8.4.0+8888+89bc7e79', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2021-3733', 'CVE-2021-3737', 'CVE-2022-0391']},
        {'reference':'python38-packaging-19.2-3.module+el8.4.0+8888+89bc7e79', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2021-3733', 'CVE-2021-3737', 'CVE-2022-0391']},
        {'reference':'python38-pluggy-0.13.0-3.module+el8.4.0+8888+89bc7e79', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2021-3733', 'CVE-2021-3737', 'CVE-2022-0391']},
        {'reference':'python38-py-1.8.0-8.module+el8.4.0+8888+89bc7e79', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2021-3733', 'CVE-2021-3737', 'CVE-2022-0391']},
        {'reference':'python38-pyparsing-2.4.5-3.module+el8.4.0+8888+89bc7e79', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2021-3733', 'CVE-2021-3737', 'CVE-2022-0391']},
        {'reference':'python38-pytest-4.6.6-3.module+el8.4.0+8888+89bc7e79', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2021-3733', 'CVE-2021-3737', 'CVE-2022-0391']},
        {'reference':'python38-wcwidth-0.1.7-16.module+el8.4.0+8888+89bc7e79', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2021-3733', 'CVE-2021-3737', 'CVE-2022-0391']}
      ]
    }
  ]
};
