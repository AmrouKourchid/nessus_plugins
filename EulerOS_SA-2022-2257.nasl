...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : kernel (EulerOS-SA-2022-2257)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2257
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e8dde0c2");
...
var pkgs = [
  "bpftool-4.18.0-147.5.2.10.h933.eulerosv2r10",
  "kernel-4.18.0-147.5.2.10.h933.eulerosv2r10",
  "kernel-abi-stablelists-4.18.0-147.5.2.10.h933.eulerosv2r10",
  "kernel-tools-4.18.0-147.5.2.10.h933.eulerosv2r10",
  "kernel-tools-libs-4.18.0-147.5.2.10.h933.eulerosv2r10",
  "python3-perf-4.18.0-147.5.2.10.h933.eulerosv2r10"
];
