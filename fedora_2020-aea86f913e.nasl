...
# extracted from Fedora Security Advisory FEDORA-2020-aea86f913e.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : chromium (2020-aea86f913e)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"Update to 85.0.4183.121. Why? Because security, that's why. It fixes
these CVEs :
...
Update Chromium to 85.0.4183.102. Fix issue where unpackaged
components prevented hardware accelerated rendering from working. Also
fixes the following security issues: CVE-2020-6573 CVE-2020-6574
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-aea86f913e");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"chromium-85.0.4183.121-1.fc31", allowmaj:TRUE)) flag++;
