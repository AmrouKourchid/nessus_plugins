...
if (description)
{
  ...
  script_cve_id("CVE-2012-4233", "CVE-2014-3575");

  script_name(english:"RHEL 5 : libreoffice (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2012-4233");
