...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.3 : kvm (EulerOS-SA-2019-1255)");
...
following vulnerability :
  ...
  - A use-after-free vulnerability was found in the way the
    ...
    to a system.i1/4^CVE-2019-6974i1/4%0

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1255
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7ee6ece6");
