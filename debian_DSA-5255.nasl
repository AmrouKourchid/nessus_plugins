...
# extracted from Debian Security Advisory dsa-5255. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-5255-1 : libksba - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has packages installed that are affected by a vulnerability as referenced in the dsa-5255
advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=1021928");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/libksba");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2022/dsa-5255");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'libksba-dev', 'reference': '1.5.0-3+deb11u1'},
    {'release': '11.0', 'prefix': 'libksba-mingw-w64-dev', 'reference': '1.5.0-3+deb11u1'},
    {'release': '11.0', 'prefix': 'libksba8', 'reference': '1.5.0-3+deb11u1'}
];
