...
if (description)
{
  ...
  script_cve_id("CVE-2025-20086");
  script_xref(name:"IAVA", value:"2025-A-0017-S");

  script_name(english:"Mattermost Server 9.11.x < 9.11.6 / 10.0.x < 10.0.4 / 10.1.x < 10.1.4 / 10.2.x < 10.2.1 DoS (MMSA-2025-00426)");
...
"Upgrade to Mattermost Server version 9.11.6, 10.0.4,  10.1.4, 10.2.1, 10.3.0, or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-20086");
