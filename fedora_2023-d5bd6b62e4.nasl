...
# extracted from Fedora Security Advisory FEDORA-2023-d5bd6b62e4
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-d5bd6b62e4");

  script_name(english:"Fedora 40 : python-aiohttp / python-pysqueezebox / python-wled (2023-d5bd6b62e4)");
...
FEDORA-2023-d5bd6b62e4 advisory.

    Security fix for CVE-2023-49081, CVE-2023-49082.

    Update `python-aiohttp` to 3.9.1.

    Patch `python-pysqeezebox` and `python-wled` so they do not have an implicit dependency on `python-async-
    timeout` via `python-aiohttp`.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-d5bd6b62e4");
...
var pkgs = [
    {'reference':'python-aiohttp-3.9.1-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python-pysqueezebox-0.5.5-11.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python-wled-0.4.4-11.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
