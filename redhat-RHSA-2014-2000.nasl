...
# extracted from Red Hat Security Advisory RHSA-2014:2000. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2014:2000");

  script_name(english:"RHEL 6 / 7 : thermostat1-thermostat (RHSA-2014:2000)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for thermostat1-thermostat.");
...
in the RHSA-2014:2000 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1168977");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2014/rhsa-2014_2000.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?26454dff");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2014:2000");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL thermostat1-thermostat package based on the guidance in RHSA-2014:2000.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:M/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:L/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-8120");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'thermostat1-thermostat-1.0.4-60.6.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'thermostat1-thermostat-javadoc-1.0.4-60.6.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'thermostat1-thermostat-webapp-1.0.4-60.6.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'thermostat1-thermostat-1.0.4-70.6.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'thermostat1-thermostat-javadoc-1.0.4-70.6.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'thermostat1-thermostat-webapp-1.0.4-70.6.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'thermostat1-thermostat / thermostat1-thermostat-javadoc / etc');
}
