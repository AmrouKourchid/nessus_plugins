...
# extracted from openSUSE Security Update openSUSE-2020-694.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : openconnect (openSUSE-2020-694)");
...
Security issue fixed :
  ...
  - CVE-2020-12105: Fixed the improper handling of negative
    return values from X509_check_ function calls that might
    have allowed MITM attacks (bsc#1170452).

This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1170452");
...
"Update the affected openconnect packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-12105");
...
if ( rpm_check(release:"SUSE15.1", reference:"openconnect-7.08-lp151.6.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"openconnect-debuginfo-7.08-lp151.6.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"openconnect-debugsource-7.08-lp151.6.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"openconnect-devel-7.08-lp151.6.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"openconnect-lang-7.08-lp151.6.6.1") ) flag++;
