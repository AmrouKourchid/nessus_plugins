...
if (description)
{
  ...
  script_name(english:"CentOS 9 : sqlite-3.34.1-6.el9");
...
sqlite-3.34.1-6.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=27186");
...
var pkgs = [
    {'reference':'lemon-3.34.1-6.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sqlite-3.34.1-6.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sqlite-analyzer-3.34.1-6.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sqlite-devel-3.34.1-6.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sqlite-doc-3.34.1-6.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sqlite-libs-3.34.1-6.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sqlite-tcl-3.34.1-6.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sqlite-tools-3.34.1-6.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
