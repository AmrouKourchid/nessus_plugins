...
# extracted from Red Hat Security Advisory RHSA-2021:3177. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:3177");

  script_name(english:"RHEL 8 : cloud-init (RHSA-2021:3177)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_3177.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a1969665");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:3177");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1940967");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL cloud-init package based on the guidance in RHSA-2021:3177.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cloud-init-18.5-7.el8_1.6', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
