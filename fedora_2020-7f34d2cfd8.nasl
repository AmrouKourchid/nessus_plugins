...
# extracted from Fedora Security Advisory FEDORA-2020-7f34d2cfd8.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-7f34d2cfd8");

  script_name(english:"Fedora 31 : webkit2gtk3 (2020-7f34d2cfd8)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-7f34d2cfd8");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"webkit2gtk3-2.28.2-1.fc31")) flag++;
