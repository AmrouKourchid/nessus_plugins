...
# extracted from Red Hat Security Advisory RHSA-2024:3402. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:3402");

  script_name(english:"RHEL 9 : mod_http2 (RHSA-2024:3402)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fadaa43c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:3402");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL mod_http2 package based on the guidance in RHSA-2024:3402.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'mod_http2-1.15.19-4.el9_2.6', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
