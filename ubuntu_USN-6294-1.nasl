...
# extracted from Ubuntu Security Notice USN-6294-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6294-1");

  script_name(english:"Ubuntu 22.04 LTS / 23.04 : HAProxy vulnerability (USN-6294-1)");
...
the USN-6294-1 advisory.

    Ben Kallus discovered that HAProxy incorrectly handled empty Content-Length headers. A remote attacker
    could possibly use this issue to manipulate the payload and bypass certain restrictions.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6294-1");
...
var pkgs = [
    {'osver': '22.04', 'pkgname': 'haproxy', 'pkgver': '2.4.22-0ubuntu0.22.04.2'},
    {'osver': '22.04', 'pkgname': 'vim-haproxy', 'pkgver': '2.4.22-0ubuntu0.22.04.2'},
    {'osver': '23.04', 'pkgname': 'haproxy', 'pkgver': '2.6.9-1ubuntu1.1'},
    {'osver': '23.04', 'pkgname': 'vim-haproxy', 'pkgver': '2.6.9-1ubuntu1.1'}
];
