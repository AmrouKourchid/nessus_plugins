...
# extracted from Red Hat Security Advisory RHSA-2024:6195. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:6195");

  script_name(english:"RHEL 9 : skopeo (RHSA-2024:6195)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_6195.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?21462735");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2268019");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-40805");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:6195");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL skopeo package based on the guidance in RHSA-2024:6195.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'skopeo-1.14.5-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'skopeo-tests-1.14.5-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'skopeo-1.14.5-1.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'skopeo-tests-1.14.5-1.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
    ]
  }
];
