...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 ESM / 18.04 ESM / 20.04 ESM / 22.04 ESM : EditorConfig Core C vulnerability (USN-5842-1)");
...
vulnerability as referenced in the USN-5842-1 advisory.
    ...
    Mark Esler and David Fernandez Gonzalez discovered that EditorConfig Core C incorrectly handled memory
    when handling certain inputs. An attacker could possibly use this issue to cause applications using
    EditorConfig Core C to crash, resulting in a denial of service, or possibly execute arbitrary code.
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'editorconfig', 'pkgver': '0.12.0-2ubuntu0.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libeditorconfig-dev', 'pkgver': '0.12.0-2ubuntu0.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libeditorconfig0', 'pkgver': '0.12.0-2ubuntu0.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'editorconfig', 'pkgver': '0.12.1-1.1ubuntu0.18.04.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libeditorconfig-dev', 'pkgver': '0.12.1-1.1ubuntu0.18.04.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libeditorconfig0', 'pkgver': '0.12.1-1.1ubuntu0.18.04.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '20.04', 'pkgname': 'editorconfig', 'pkgver': '0.12.1-1.1ubuntu0.20.04.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '20.04', 'pkgname': 'libeditorconfig-dev', 'pkgver': '0.12.1-1.1ubuntu0.20.04.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '20.04', 'pkgname': 'libeditorconfig0', 'pkgver': '0.12.1-1.1ubuntu0.20.04.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '22.04', 'pkgname': 'editorconfig', 'pkgver': '0.12.5-2ubuntu0.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '22.04', 'pkgname': 'libeditorconfig-dev', 'pkgver': '0.12.5-2ubuntu0.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '22.04', 'pkgname': 'libeditorconfig0', 'pkgver': '0.12.5-2ubuntu0.1~esm1', 'ubuntu_pro': TRUE}
];
