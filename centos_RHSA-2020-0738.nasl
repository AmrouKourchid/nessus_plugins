...
# extracted from Red Hat Security Advisory RHSA-2020:0738.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : chromium-browser (RHSA-2020:0738)");
...
RHSA-2020:0738 advisory.
  ...
  - Type confusion in V8 in Google Chrome prior to 80.0.3987.116 allowed a remote attacker to potentially
    exploit heap corruption via a crafted HTML page. (CVE-2020-6383)

  - Use after free in WebAudio in Google Chrome prior to 80.0.3987.116 allowed a remote attacker to
    potentially exploit heap corruption via a crafted HTML page. (CVE-2020-6384)

  - Use after free in speech in Google Chrome prior to 80.0.3987.116 allowed a remote attacker to potentially
    exploit heap corruption via a crafted HTML page. (CVE-2020-6386)

  - Out of bounds memory access in streams in Google Chrome prior to 80.0.3987.122 allowed a remote attacker
    to potentially exploit heap corruption via a crafted HTML page. (CVE-2020-6407)

  - Type confusion in V8 in Google Chrome prior to 80.0.3987.122 allowed a remote attacker to potentially
    exploit heap corruption via a crafted HTML page. (CVE-2020-6418)
...
var pkgs = [
    {'reference':'chromium-browser-80.0.3987.122-1.el6_10', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
