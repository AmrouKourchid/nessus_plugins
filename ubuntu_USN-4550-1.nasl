...
the USN-4550-1 advisory.

    Ryan Hall discovered that DPDK incorrectly handled vhost crypto. An attacker inside a guest could use
    these issues to perform multiple attacks, including denial of service attacks, obtaining sensitive
