...
# extracted from Fedora Security Advisory FEDORA-2019-eba8e44ee6.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : drupal8 (2019-eba8e44ee6)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-eba8e44ee6");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"drupal8-8.6.15-1.fc30")) flag++;
