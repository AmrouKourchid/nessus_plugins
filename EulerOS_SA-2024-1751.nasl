...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP12 : python-pillow (EulerOS-SA-2024-1751)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1751
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b9fdcde8");
...
var pkgs = [
  "python3-pillow-9.0.1-3.h4.eulerosv2r12"
];
