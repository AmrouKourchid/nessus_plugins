...
# extracted from Gentoo Linux Security Advisory GLSA 202409-09.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202409-09 : Exo: Arbitrary Code Execution");
...
"The remote host is affected by the vulnerability described in GLSA-202409-09 (Exo: Arbitrary Code Execution)
    ...
    A vulnerability has been discovered in Exo. Please review the CVE identifiers referenced below for
    details.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202409-09");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=851201");
...
"All Exo users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:exo");
...
var packages = [
  {
    'name' : 'xfce-base/exo',
    'unaffected' : make_list("ge 4.17.2"),
    'vulnerable' : make_list("lt 4.17.2")
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'Exo');
}
