...
# Rocky Linux Security Advisory RLSA-2025:1446.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2025:1446");

  script_name(english:"RockyLinux 9 : nodejs:18 (RLSA-2025:1446)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2025:1446");
