...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : python-setuptools (EulerOS-SA-2024-2913)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2913
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8c59b905");
...
var pkgs = [
  "python-setuptools-44.1.1-1.h3.eulerosv2r10",
  "python3-setuptools-44.1.1-1.h3.eulerosv2r10"
];
