...
# extracted from openSUSE Security Update openSUSE-2019-2039.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : python-SQLAlchemy (openSUSE-2019-2039)");
...
if ( rpm_check(release:"SUSE15.0", reference:"python-SQLAlchemy-debuginfo-1.2.7-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"python-SQLAlchemy-debugsource-1.2.7-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"python2-SQLAlchemy-1.2.7-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"python2-SQLAlchemy-debuginfo-1.2.7-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"python3-SQLAlchemy-1.2.7-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"python3-SQLAlchemy-debuginfo-1.2.7-lp150.2.3.1") ) flag++;
