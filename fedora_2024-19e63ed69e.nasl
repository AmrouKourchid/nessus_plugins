...
# extracted from Fedora Security Advisory FEDORA-2024-19e63ed69e
#
...
if (description)
{
  ...
  script_cve_id("CVE-2024-39338");
  script_xref(name:"FEDORA", value:"2024-19e63ed69e");

  script_name(english:"Fedora 41 : nextcloud (2024-19e63ed69e)");
...
FEDORA-2024-19e63ed69e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-19e63ed69e");
...
"Update the affected nextcloud package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-39338");
...
var pkgs = [
    {'reference':'nextcloud-29.0.6-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
