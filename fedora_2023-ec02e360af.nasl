...
# extracted from Fedora Security Advisory FEDORA-2023-ec02e360af
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-ec02e360af");

  script_name(english:"Fedora 38 : tigervnc / xorg-x11-server (2023-ec02e360af)");
...
FEDORA-2023-ec02e360af advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-ec02e360af");
...
var pkgs = [
    {'reference':'tigervnc-1.13.1-9.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xorg-x11-server-1.20.14-28.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
