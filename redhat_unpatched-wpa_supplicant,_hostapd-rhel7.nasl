...
# extracted from Red Hat Security Advisory wpa_supplicant,_hostapd. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : wpa_supplicant,_hostapd (Unpatched Vulnerability) (deprecated)");
