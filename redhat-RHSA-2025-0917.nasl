...
# extracted from Red Hat Security Advisory RHSA-2025:0917. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:0917");

  script_name(english:"RHEL 9 : keepalived (RHSA-2025:0917)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_0917.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?14cf1829");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:0917");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL keepalived package based on the guidance in RHSA-2025:0917.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'keepalived-2.2.8-4.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
