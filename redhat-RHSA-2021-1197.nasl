...
# extracted from Red Hat Security Advisory RHSA-2021:1197. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_1197.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c7f22cd0");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:1197");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1941402");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libldb package based on the guidance in RHSA-2021:1197.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ldb-tools-2.1.3-3.el8_3', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libldb-2.1.3-3.el8_3', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libldb-devel-2.1.3-3.el8_3', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-ldb-2.1.3-3.el8_3', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
