...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : openssl (EulerOS-SA-2023-3441)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3441
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?130051aa");
...
var pkgs = [
  "openssl-1.1.1-3.h30.eulerosv2r8",
  "openssl-devel-1.1.1-3.h30.eulerosv2r8",
  "openssl-libs-1.1.1-3.h30.eulerosv2r8",
  "openssl-perl-1.1.1-3.h30.eulerosv2r8"
];
