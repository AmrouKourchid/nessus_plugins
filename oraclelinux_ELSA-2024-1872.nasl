...
# extracted from Oracle Linux Security Advisory ELSA-2024-1872.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : mod_http2 (ELSA-2024-1872)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-1872.html");
