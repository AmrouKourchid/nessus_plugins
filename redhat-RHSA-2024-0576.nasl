...
# extracted from Red Hat Security Advisory RHSA-2024:0576. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:0576");

  script_name(english:"RHEL 8 : avahi (RHSA-2024:0576)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for avahi.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:0576 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0576.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0be63baa");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0576");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL avahi package based on the guidance in RHSA-2024:0576.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'avahi-0.7-20.el8_8.4', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'avahi-autoipd-0.7-20.el8_8.4', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'avahi-compat-howl-0.7-20.el8_8.4', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'avahi-compat-howl-devel-0.7-20.el8_8.4', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'avahi-compat-libdns_sd-0.7-20.el8_8.4', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'avahi-compat-libdns_sd-devel-0.7-20.el8_8.4', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'avahi-devel-0.7-20.el8_8.4', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'avahi-glib-0.7-20.el8_8.4', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'avahi-glib-devel-0.7-20.el8_8.4', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'avahi-gobject-0.7-20.el8_8.4', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'avahi-gobject-devel-0.7-20.el8_8.4', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'avahi-libs-0.7-20.el8_8.4', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'avahi-ui-0.7-20.el8_8.4', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'avahi-ui-devel-0.7-20.el8_8.4', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'avahi-ui-gtk3-0.7-20.el8_8.4', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-avahi-0.7-20.el8_8.4', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
