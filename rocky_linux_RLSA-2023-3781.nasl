...
# Rocky Linux Security Advisory RLSA-2023:3781.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2023:3781");

  script_name(english:"Rocky Linux 8 : python38:3.8 and python38-devel:3.8 (RLSA-2023:3781)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Rocky Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Rocky Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
RLSA-2023:3781 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2023:3781");
...
var appstreams = {
    'python38-devel:3.8': [
      ...
      {'reference':'python-cryptography-debugsource-2.8-3.module+el8.5.0+672+ab6eb015', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python-cryptography-debugsource-2.8-3.module+el8.5.0+672+ab6eb015', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python-lxml-debugsource-4.4.1-7.module+el8.6.0+794+eba84017', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python-lxml-debugsource-4.4.1-7.module+el8.6.0+794+eba84017', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python-psycopg2-debugsource-2.8.4-4.module+el8.6.0+794+eba84017', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python-psycopg2-debugsource-2.8.4-4.module+el8.6.0+794+eba84017', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-3.8.16-1.module+el8.8.0+1110+b297ede1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-3.8.16-1.module+el8.8.0+1110+b297ede1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python38-cryptography-2.8-3.module+el8.5.0+672+ab6eb015', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-cryptography-2.8-3.module+el8.5.0+672+ab6eb015', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-cryptography-debuginfo-2.8-3.module+el8.5.0+672+ab6eb015', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-cryptography-debuginfo-2.8-3.module+el8.5.0+672+ab6eb015', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python38-debug-3.8.16-1.module+el8.8.0+1110+b297ede1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-debug-3.8.16-1.module+el8.8.0+1110+b297ede1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-debuginfo-3.8.16-1.module+el8.8.0+1110+b297ede1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-debuginfo-3.8.16-1.module+el8.8.0+1110+b297ede1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-debugsource-3.8.16-1.module+el8.8.0+1110+b297ede1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-debugsource-3.8.16-1.module+el8.8.0+1110+b297ede1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-devel-3.8.16-1.module+el8.8.0+1110+b297ede1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-devel-3.8.16-1.module+el8.8.0+1110+b297ede1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-idle-3.8.16-1.module+el8.8.0+1110+b297ede1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-idle-3.8.16-1.module+el8.8.0+1110+b297ede1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-idna-2.8-6.module+el8.4.0+570+c2eaf144', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-jinja2-2.11.3-1.module+el8.7.0+1063+20f2b9a4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-libs-3.8.16-1.module+el8.8.0+1110+b297ede1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-libs-3.8.16-1.module+el8.8.0+1110+b297ede1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-lxml-4.4.1-7.module+el8.6.0+794+eba84017', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-lxml-4.4.1-7.module+el8.6.0+794+eba84017', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-lxml-debuginfo-4.4.1-7.module+el8.6.0+794+eba84017', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-lxml-debuginfo-4.4.1-7.module+el8.6.0+794+eba84017', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python38-mod_wsgi-4.6.8-4.module+el8.7.0+1063+20f2b9a4', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-mod_wsgi-4.6.8-4.module+el8.7.0+1063+20f2b9a4', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python38-pip-19.3.1-6.module+el8.7.0+1063+20f2b9a4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-pip-wheel-19.3.1-6.module+el8.7.0+1063+20f2b9a4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python38-psycopg2-2.8.4-4.module+el8.6.0+794+eba84017', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-psycopg2-2.8.4-4.module+el8.6.0+794+eba84017', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-psycopg2-debuginfo-2.8.4-4.module+el8.6.0+794+eba84017', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-psycopg2-debuginfo-2.8.4-4.module+el8.6.0+794+eba84017', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-psycopg2-doc-2.8.4-4.module+el8.6.0+794+eba84017', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-psycopg2-doc-2.8.4-4.module+el8.6.0+794+eba84017', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-psycopg2-tests-2.8.4-4.module+el8.6.0+794+eba84017', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-psycopg2-tests-2.8.4-4.module+el8.6.0+794+eba84017', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python38-PyMySQL-0.10.1-1.module+el8.5.0+672+ab6eb015', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python38-pyyaml-5.4.1-1.module+el8.5.0+672+ab6eb015', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-pyyaml-5.4.1-1.module+el8.5.0+672+ab6eb015', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-pyyaml-debuginfo-5.4.1-1.module+el8.5.0+672+ab6eb015', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-pyyaml-debuginfo-5.4.1-1.module+el8.5.0+672+ab6eb015', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-requests-2.22.0-9.module+el8.4.0+570+c2eaf144', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-rpm-macros-3.8.16-1.module+el8.8.0+1110+b297ede1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-scipy-1.3.1-4.module+el8.5.0+672+ab6eb015', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-scipy-1.3.1-4.module+el8.5.0+672+ab6eb015', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-scipy-debuginfo-1.3.1-4.module+el8.5.0+672+ab6eb015', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-scipy-debuginfo-1.3.1-4.module+el8.5.0+672+ab6eb015', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python38-test-3.8.16-1.module+el8.8.0+1110+b297ede1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-test-3.8.16-1.module+el8.8.0+1110+b297ede1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-tkinter-3.8.16-1.module+el8.8.0+1110+b297ede1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-tkinter-3.8.16-1.module+el8.8.0+1110+b297ede1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'PyYAML-debugsource-5.4.1-1.module+el8.5.0+672+ab6eb015', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'PyYAML-debugsource-5.4.1-1.module+el8.5.0+672+ab6eb015', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'scipy-debugsource-1.3.1-4.module+el8.5.0+672+ab6eb015', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'scipy-debugsource-1.3.1-4.module+el8.5.0+672+ab6eb015', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ],
    'python38:3.8': [
      {'reference':'Cython-debugsource-0.29.14-4.module+el8.4.0+570+c2eaf144', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'Cython-debugsource-0.29.14-4.module+el8.4.0+570+c2eaf144', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
