...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5002109");
  script_xref(name:"MSFT", value:"MS22-5002109");
  script_xref(name:"IAVA", value:"2022-A-0007-S");

  script_name(english:"Security Updates for Microsoft SharePoint Server 2019 (January 2022)");
...
unauthorized arbitrary commands. (CVE-2022-21837,CVE-2022-21840)");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002109");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released security update KB5002109 to address this issue.");
