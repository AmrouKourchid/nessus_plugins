...
# extracted from Fedora Security Advisory FEDORA-2024-5aad2fda6a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-5aad2fda6a");

  script_name(english:"Fedora 40 : chisel (2024-5aad2fda6a)");
...
FEDORA-2024-5aad2fda6a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-5aad2fda6a");
...
var pkgs = [
    {'reference':'chisel-1.10.0-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
