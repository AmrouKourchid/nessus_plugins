...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : edk2 (EulerOS-SA-2023-2443)");
...
affected by the following vulnerabilities :
  ...
  - Use after free vulnerability in EDK II may allow an authenticated user to potentially enable escalation of
    privilege, information disclosure and/or denial of service via adjacent access. (CVE-2019-14586)

  - Logic issue EDK II may allow an unauthenticated user to potentially enable denial of service via adjacent
    access. (CVE-2019-14587)
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2443
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ffbf69b3");
