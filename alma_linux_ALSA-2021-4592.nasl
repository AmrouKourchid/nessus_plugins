...
# AlmaLinux Security Advisory ALSA-2021:4592.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2021:4592");
  script_xref(name:"IAVA", value:"2021-A-0528");

  script_name(english:"AlmaLinux 8 : gcc-toolset-10-annobin (ALSA-2021:4592)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2021-4592.html");
...
"Update the affected gcc-toolset-10-annobin package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:gcc-toolset-10-annobin");
