...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : spice-gtk on SL6.x i386/x86_64 (20200211)");
...
"Security Fix(es) :
  ...
  - spice-client: Insufficient encoding checks for LZ can
    ...
    (CVE-2018-10893)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind2002&L=SCIENTIFIC-LINUX-ERRATA&P=7129
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?61bc977a");
...
flag = 0;
if (rpm_check(release:"SL6", reference:"spice-glib-0.26-8.el6_10.2")) flag++;
if (rpm_check(release:"SL6", reference:"spice-glib-devel-0.26-8.el6_10.2")) flag++;
if (rpm_check(release:"SL6", reference:"spice-gtk-0.26-8.el6_10.2")) flag++;
if (rpm_check(release:"SL6", reference:"spice-gtk-debuginfo-0.26-8.el6_10.2")) flag++;
if (rpm_check(release:"SL6", reference:"spice-gtk-devel-0.26-8.el6_10.2")) flag++;
if (rpm_check(release:"SL6", reference:"spice-gtk-python-0.26-8.el6_10.2")) flag++;
if (rpm_check(release:"SL6", reference:"spice-gtk-tools-0.26-8.el6_10.2")) flag++;
