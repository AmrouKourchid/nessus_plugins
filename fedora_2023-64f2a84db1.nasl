...
# extracted from Fedora Security Advisory FEDORA-2023-64f2a84db1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-64f2a84db1");

  script_name(english:"Fedora 38 : libtpms (2023-64f2a84db1)");
...
FEDORA-2023-64f2a84db1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-64f2a84db1");
...
"Update the affected libtpms package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:libtpms");
...
var pkgs = [
    {'reference':'libtpms-0.9.6-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
