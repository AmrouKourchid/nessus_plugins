...
# SUSE update advisory SUSE-SU-2024:1532-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2024:1532-1");

  script_name(english:"SUSE SLES15 Security Update : SUSE Manager Server 4.3 (SUSE-SU-2024:1532-1)");
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2024-May/018453.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?130062bb");
...
var pkgs = [
    {'reference':'release-notes-susemanager-4.3.12-150400.3.108.2', 'sp':'4', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SUSE-Manager-Server-release-4.3']}
];
