...
# Red Hat Security Advisory RHSA-2024:1644. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : grafana-pcp (CESA-2024:1644)");
...
var pkgs = [
    {'reference':'grafana-pcp-5.1.1-2.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'grafana-pcp-5.1.1-2.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
