...
# extracted from Fedora Security Advisory FEDORA-2024-966c267928
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-966c267928");

  script_name(english:"Fedora 41 : perl-Clipboard (2024-966c267928)");
...
FEDORA-2024-966c267928 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-966c267928");
  script_set_attribute(attribute:"solution", value:
"Update the affected perl-Clipboard package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:perl-Clipboard");
...
var pkgs = [
    {'reference':'perl-Clipboard-0.29-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'perl-Clipboard');
}
