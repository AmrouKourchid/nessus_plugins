...
# extracted from Fedora Security Advisory FEDORA-2022-d7d49b2fac
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-d7d49b2fac");

  script_name(english:"Fedora 36 : postgresql-jdbc (2022-d7d49b2fac)");
...
FEDORA-2022-d7d49b2fac advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-d7d49b2fac");
...
var pkgs = [
    {'reference':'postgresql-jdbc-42.3.1-4.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
