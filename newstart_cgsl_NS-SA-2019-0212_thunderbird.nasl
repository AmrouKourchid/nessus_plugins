...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 4.06 : thunderbird Multiple Vulnerabilities (NS-SA-2019-0212)");
...
pkgs = {
  "CGSL MAIN 4.06": [
    "thunderbird-60.9.0-1.el6.centos",
    "thunderbird-debuginfo-60.9.0-1.el6.centos"
  ]
};
