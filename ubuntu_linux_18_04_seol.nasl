...
if (description)
{
  ...
  script_name(english:"Canonical Ubuntu Linux SEoL (18.04.x)");
...
contain security vulnerabilities.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/blog/18-04-end-of-standard-support");
...
var constraints = [
  { max_branch : '18.04', min_branch : '18.04', eseol : 20300426, seol : 20230531 }
];
