...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : SDL (EulerOS-SA-2022-1018)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1018
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7b129418");
...
var pkgs = [
  "SDL-help-1.2.15-36.h2.eulerosv2r9"
];
