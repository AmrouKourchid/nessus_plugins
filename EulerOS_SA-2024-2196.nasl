...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.0 : mod_http2 (EulerOS-SA-2024-2196)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the mod_http2 package installed, the EulerOS Virtualization installation on the remote host
is affected by the following vulnerabilities :

    HTTP/2 incoming headers exceeding the limit are temporarily buffered in nghttp2 in order to generate an
    informative HTTP 413 response. If a client does not stop sending headers, this leads to memory
    exhaustion.(CVE-2024-27316)

Tenable has extracted the preceding description block directly from the EulerOS Virtualization mod_http2 security
advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2196
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?365b8597");
  script_set_attribute(attribute:"solution", value:
"Update the affected mod_http2 packages.");
...
var pkgs = [
  "mod_http2-1.15.25-1.h1.eulerosv2r11"
];
