...
# extracted from Red Hat Security Advisory moby_buildkit. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2024-23652");

  script_name(english:"RHEL 7 : moby_buildkit (Unpatched Vulnerability) (deprecated)");
