...
# extracted from Red Hat Security Advisory RHSA-2022:7958. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:7958");

  script_name(english:"RHEL 9 : libguestfs (RHSA-2022:7958)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_7958.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?24a9af17");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:7958");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:php-libguestfs");
