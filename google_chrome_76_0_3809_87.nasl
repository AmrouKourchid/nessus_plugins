...
by multiple vulnerabilities as referenced in the 2019_07_stable-channel-update-for-desktop_30 advisory. Note that Nessus
...
google_chrome_check_version(installs:installs, fix:'76.0.3809.87', severity:SECURITY_WARNING, xss:FALSE, xsrf:FALSE);
