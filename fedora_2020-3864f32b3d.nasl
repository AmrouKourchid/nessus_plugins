...
# extracted from Fedora Security Advisory FEDORA-2020-3864f32b3d.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-3864f32b3d");

  script_name(english:"Fedora 30 : python-markdown2 (2020-3864f32b3d)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-3864f32b3d");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"python-markdown2-2.3.9-1.fc30")) flag++;
