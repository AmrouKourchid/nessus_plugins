...
# Rocky Linux Security Advisory RLSA-2024:1688.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2024:1688");

  script_name(english:"Rocky Linux 9 : nodejs:20 (RLSA-2024:1688)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2024:1688");
...
var appstreams = {
    'nodejs:20': [
      {'reference':'nodejs-20.11.1-1.module+el9.4.0+19932+a5bb191c', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-20.11.1-1.module+el9.4.0+19932+a5bb191c', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-20.11.1-1.module+el9.4.0+19932+a5bb191c', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-debuginfo-20.11.1-1.module+el9.4.0+19932+a5bb191c', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-debuginfo-20.11.1-1.module+el9.4.0+19932+a5bb191c', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-debuginfo-20.11.1-1.module+el9.4.0+19932+a5bb191c', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-debugsource-20.11.1-1.module+el9.4.0+19932+a5bb191c', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-debugsource-20.11.1-1.module+el9.4.0+19932+a5bb191c', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-debugsource-20.11.1-1.module+el9.4.0+19932+a5bb191c', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-devel-20.11.1-1.module+el9.4.0+19932+a5bb191c', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-devel-20.11.1-1.module+el9.4.0+19932+a5bb191c', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-devel-20.11.1-1.module+el9.4.0+19932+a5bb191c', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-docs-20.11.1-1.module+el9.4.0+19932+a5bb191c', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-full-i18n-20.11.1-1.module+el9.4.0+19932+a5bb191c', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-full-i18n-20.11.1-1.module+el9.4.0+19932+a5bb191c', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-full-i18n-20.11.1-1.module+el9.4.0+19932+a5bb191c', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-nodemon-3.0.1-1.module+el9.2.0+15226+de336927', 'release':'9', 'el_string':'el9.2.0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nodejs-nodemon-3.0.1-1.module+el9.4.0+19932+a5bb191c', 'release':'9', 'el_string':'el9.4.0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nodejs-packaging-2021.06-4.module+el9.2.0+15226+de336927', 'release':'9', 'el_string':'el9.2.0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nodejs-packaging-2021.06-4.module+el9.4.0+19932+a5bb191c', 'release':'9', 'el_string':'el9.4.0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nodejs-packaging-bundler-2021.06-4.module+el9.2.0+15226+de336927', 'release':'9', 'el_string':'el9.2.0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nodejs-packaging-bundler-2021.06-4.module+el9.4.0+19932+a5bb191c', 'release':'9', 'el_string':'el9.4.0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'npm-10.2.4-1.20.11.1.1.module+el9.4.0+19932+a5bb191c', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'npm-10.2.4-1.20.11.1.1.module+el9.4.0+19932+a5bb191c', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'npm-10.2.4-1.20.11.1.1.module+el9.4.0+19932+a5bb191c', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
};
