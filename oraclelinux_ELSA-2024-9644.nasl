...
# extracted from Oracle Linux Security Advisory ELSA-2024-9644.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : squid (ELSA-2024-9644)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ELSA-2024-9644 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-9644.html");
...
var appstreams = {
    'squid:4': [
      ...
      {'reference':'squid-4.15-10.module+el8.10.0+90442+8ef3f586.3', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      ...
      {'reference':'squid-4.15-10.module+el8.10.0+90442+8ef3f586.3', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
    ]
};
