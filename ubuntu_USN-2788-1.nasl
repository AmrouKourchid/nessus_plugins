...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : unzip vulnerabilities (USN-2788-1)");
...
the USN-2788-1 advisory.

    Gustavo Grieco discovered that unzip incorrectly handled certain password protected archives. If a user or
    automated system were tricked into processing a specially crafted zip archive, an attacker could possibly
    execute arbitrary code. (CVE-2015-7696)

    Gustavo Grieco discovered that unzip incorrectly handled certain malformed archives. If a user or
    automated system were tricked into processing a specially crafted zip archive, an attacker could possibly
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2788-1");
...
"Update the affected unzip package.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2015-7697");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'unzip', 'pkgver': '6.0-9ubuntu1.4'}
];
