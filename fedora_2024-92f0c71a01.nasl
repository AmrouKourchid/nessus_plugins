...
# extracted from Fedora Security Advisory FEDORA-2024-92f0c71a01
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-92f0c71a01");

  script_name(english:"Fedora 40 : libreswan (2024-92f0c71a01)");
...
FEDORA-2024-92f0c71a01 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-92f0c71a01");
...
var pkgs = [
    {'reference':'libreswan-4.14-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
