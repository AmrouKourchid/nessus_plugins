...
# extracted from Fedora Security Advisory FEDORA-2019-dcd49378b8.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : 2:vim (2019-dcd49378b8)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"1717503 - Security issue: patch 8.1.1365: source command doesn't check
for the sandbox
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-dcd49378b8");
...
"Update the affected 2:vim package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:2:vim");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"vim-8.1.1471-1.fc29", epoch:"2")) flag++;
