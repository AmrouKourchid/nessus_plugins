...
# extracted from Red Hat Security Advisory RHSA-2024:1154. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:1154");

  script_name(english:"RHEL 9 : libfastjson (RHSA-2024:1154)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_1154.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?64bd73fa");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1835253");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:1154");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libfastjson package based on the guidance in RHSA-2024:1154.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libfastjson-0.99.9-3.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libfastjson');
}
