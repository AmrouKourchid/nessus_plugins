...
if (description)
{
  ...
  script_name(english:"Microsoft Windows 7 SEoL");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Microsoft Windows is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"Microsoft Windows 7 is no longer maintained by its vendor or provider.
...
contain security vulnerabilities.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d8063520");
...
var os = ucf::get_os_cpe(vendor:'microsoft', product:'windows_7', type:'local');
