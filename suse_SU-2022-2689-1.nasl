...
# SUSE update advisory SUSE-SU-2022:2689-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:2689-1");

  script_name(english:"SUSE SLES12 Security Update : dpkg (SUSE-SU-2022:2689-1)");
...
in the SUSE-SU-2022:2689-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?30beefb1");
  script_set_attribute(attribute:"solution", value:
"Update the affected update-alternatives package.");
...
var pkgs = [
    {'reference':'update-alternatives-1.18.4-16.3.5', 'sp':'5', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5']},
    {'reference':'update-alternatives-1.18.4-16.3.5', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.5']}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'update-alternatives');
}
