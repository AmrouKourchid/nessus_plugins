...
# extracted from Fedora Security Advisory FEDORA-2024-2fb325d068
#
...
if (description)
{
  ...
  script_cve_id("CVE-2024-35176", "CVE-2024-39908");
  script_xref(name:"FEDORA", value:"2024-2fb325d068");

  script_name(english:"Fedora 39 : ruby (2024-2fb325d068)");
...
FEDORA-2024-2fb325d068 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-2fb325d068");
...
"Update the affected ruby package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-39908");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2024-35176");
...
var pkgs = [
    {'reference':'ruby-3.2.5-183.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
