...
if (description)
{
  ...
  script_name(english:"Nutanix AHV : Multiple Vulnerabilities (NXSA-AHV-20230302.2024)");
...
vulnerabilities as referenced in the NXSA-AHV-20230302.2024 advisory.
...
number.");
  # https://portal.nutanix.com/page/documents/security-advisories/release-advisories/details?id=NXSA-AHV-20230302.2024
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a5bf5f56");
