...
# extracted from Red Hat Security Advisory RHSA-2024:9452. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:9452");

  script_name(english:"RHEL 9 : pcp (RHSA-2024:9452)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for pcp.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:9452 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-58307");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_9452.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?92417ee8");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:9452");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL pcp package based on the guidance in RHSA-2024:9452.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:pcp-export-pcp2openmetrics");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:pcp-pmda-uwsgi");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'pcp-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-conf-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-devel-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-doc-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-export-pcp2elasticsearch-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-export-pcp2graphite-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-export-pcp2influxdb-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-export-pcp2json-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-export-pcp2openmetrics-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-export-pcp2spark-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-export-pcp2xml-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-export-pcp2zabbix-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-export-zabbix-agent-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-geolocate-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-gui-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-import-collectl2pcp-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-import-ganglia2pcp-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-import-iostat2pcp-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-import-mrtg2pcp-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-import-sar2pcp-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-libs-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-libs-devel-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-activemq-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-apache-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-bash-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-bcc-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-bind2-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-bonding-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-bpf-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-bpftrace-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-cifs-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-cisco-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-dbping-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-denki-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-dm-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-docker-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-ds389-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-ds389log-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-elasticsearch-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-farm-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-gfs2-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-gluster-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-gpfs-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-gpsd-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-hacluster-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-haproxy-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-infiniband-6.2.2-7.el9_5', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-infiniband-6.2.2-7.el9_5', 'cpu':'ppc64le', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-infiniband-6.2.2-7.el9_5', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-json-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-libvirt-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-lio-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-lmsensors-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-logger-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-lustre-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-lustrecomm-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-mailq-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-memcache-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-mic-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-mongodb-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-mounts-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-mssql-6.2.2-7.el9_5', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-mysql-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-named-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-netcheck-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-netfilter-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-news-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-nfsclient-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-nginx-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-nvidia-gpu-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-openmetrics-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-openvswitch-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-oracle-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-pdns-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-perfevent-6.2.2-7.el9_5', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-perfevent-6.2.2-7.el9_5', 'cpu':'ppc64le', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-perfevent-6.2.2-7.el9_5', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-podman-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-postfix-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-postgresql-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-rabbitmq-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-redis-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-resctrl-6.2.2-7.el9_5', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-roomtemp-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-rsyslog-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-samba-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-sendmail-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-shping-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-slurm-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-smart-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-snmp-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-sockets-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-statsd-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-summary-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-systemd-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-trace-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-unbound-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-uwsgi-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-weblog-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-zimbra-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-zswap-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-selinux-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-system-tools-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-testsuite-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-zeroconf-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'perl-PCP-LogImport-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'perl-PCP-LogSummary-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'perl-PCP-MMV-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'perl-PCP-PMDA-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-pcp-6.2.2-7.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
