...
# extracted from Debian Security Advisory dla-3219. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3219 : jhead - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/jhead");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'jhead', 'reference': '1:3.00-8+deb10u1'}
];
