...
# extracted from Fedora Security Advisory FEDORA-2023-426b3a500d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-426b3a500d");

  script_name(english:"Fedora 39 : ckeditor (2023-426b3a500d)");
...
FEDORA-2023-426b3a500d advisory.

    - [4.22.0/4.22.1](https://ckeditor.com/cke4/release/CKEditor-4.22.0-4.22.1)
    - [4.21.0](https://ckeditor.com/cke4/release/CKEditor-4.21.0)
        - [GHSA-vh5c-xwqv-cv9g /
    CVE-2023-28439](https://github.com/ckeditor/ckeditor4/security/advisories/GHSA-vh5c-xwqv-cv9g)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-426b3a500d");
...
var pkgs = [
    {'reference':'ckeditor-4.22.1-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
