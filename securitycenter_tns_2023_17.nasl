...
running 5.22 to 6.0.0 and is therefore affected by an Apache vulnerability which could result in bypassing of 
access controls.");
...
var constraints = [
  { 'min_version' : '5.22.0', 'max_version': '6.0.0', 'fixed_display' : 'Apply Patch SC-202303.2'}
];
