...
# extracted from Fedora Security Advisory FEDORA-2024-4d2c8e6f85
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-4d2c8e6f85");
  script_xref(name:"IAVB", value:"2024-B-0041-S");

  script_name(english:"Fedora 39 : ffmpeg (2024-4d2c8e6f85)");
...
FEDORA-2024-4d2c8e6f85 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-4d2c8e6f85");
...
var pkgs = [
    {'reference':'ffmpeg-6.1.1-4.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
