...
# extracted from VMware Security Advisory PHSA-2017-0047. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Wget PHSA-2017-0047");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the wget package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-87.md");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'wget-1.18-3.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'wget-debuginfo-1.18-3.ph1')) flag++;
