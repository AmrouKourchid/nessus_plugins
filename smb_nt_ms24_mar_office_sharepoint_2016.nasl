...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5002559");
  script_xref(name:"MSFT", value:"MS23-5002559");
  script_xref(name:"IAVA", value:"2024-A-0154-S");

  script_name(english:"Security Updates for Microsoft SharePoint Server 2016 (March 2024)");
...
unauthorized arbitrary commands.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002559");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released KB5002559 to address this issue.");
