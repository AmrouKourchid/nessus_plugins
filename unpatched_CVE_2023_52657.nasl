...
if (description)
{
  ...
  script_cve_id("CVE-2023-52657");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2023-52657");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: Revert drm/amd/pm: resolve reboot
    exception for si oland This reverts commit e490d60a2f76bff636c68ce4fe34c1b6c34bbd86. This causes hangs on
    SI when DC is enabled and errors on driver reboot and power off cycles. (CVE-2023-52657)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-52657");
