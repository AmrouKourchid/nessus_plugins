...
# extracted from Oracle Linux Security Advisory ELSA-2024-2996.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : xorg-x11-server-Xwayland (ELSA-2024-2996)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-2996.html");
