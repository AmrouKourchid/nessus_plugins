...
# Oracle Linux Security Advisory ELSA-2009-1100 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : wireshark (ELSA-2009-1100)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2009-1100.html");
...
var pkgs = [
    {'reference':'wireshark-1.0.8-1.0.1.el5_3.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'wireshark-gnome-1.0.8-1.0.1.el5_3.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'wireshark-1.0.8-1.0.1.el5_3.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'wireshark-gnome-1.0.8-1.0.1.el5_3.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
