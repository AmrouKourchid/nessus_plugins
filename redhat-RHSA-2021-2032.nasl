...
# extracted from Red Hat Security Advisory RHSA-2021:2032. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:2032");

  script_name(english:"RHEL 7 : slapi-nis (RHSA-2021:2032)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for slapi-nis.");
...
the RHSA-2021:2032 advisory.

    The slapi-nis packages contain the NIS server plug-in and the Schema Compatibility plug-in for use with
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_2032.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6ca04c03");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:2032");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1944640");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL slapi-nis package based on the guidance in RHSA-2021:2032.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'slapi-nis-0.56.5-4.el7_9', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'slapi-nis-0.56.5-4.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'slapi-nis');
}
