...
# extracted from Red Hat Security Advisory RHSA-2022:1665. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:1665");
  script_xref(name:"IAVA", value:"2024-A-0327");

  script_name(english:"RHEL 8 : gzip (RHSA-2022:1665)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_1665.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7fada223");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:1665");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2073310");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL gzip package based on the guidance in RHSA-2022:1665.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gzip-1.9-10.el8_2', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
