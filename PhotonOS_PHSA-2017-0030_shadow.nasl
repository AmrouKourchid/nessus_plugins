...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Shadow PHSA-2017-0030");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'shadow-4.2.1-11.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'shadow-debuginfo-4.2.1-11.ph1')) flag++;
