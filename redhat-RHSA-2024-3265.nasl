...
# extracted from Red Hat Security Advisory RHSA-2024:3265. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_3265.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?080d58e0");
...
"Update the RHEL grafana package based on the guidance in RHSA-2024:3265.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'grafana-9.2.10-16.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'grafana-selinux-9.2.10-16.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
