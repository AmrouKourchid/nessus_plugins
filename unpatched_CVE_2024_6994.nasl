...
if (description)
{
  ...
  script_cve_id("CVE-2024-6994");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-6994");
...
patch available.
  ...
  - Heap buffer overflow in Layout in Google Chrome prior to 127.0.6533.72 allowed a remote attacker to
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-6994");
