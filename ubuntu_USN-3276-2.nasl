...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS : shadow regression (USN-3276-2)");
...
in the USN-3276-2 advisory.

    USN-3276-1 intended to fix a vulnerability in su. The solution introduced a regression in su signal
    handling. This update modifies the security fix. We apologize for the inconvenience.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3276-2");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'login', 'pkgver': '1:4.1.5.1-1ubuntu9.5'},
    {'osver': '14.04', 'pkgname': 'passwd', 'pkgver': '1:4.1.5.1-1ubuntu9.5'},
    {'osver': '14.04', 'pkgname': 'uidmap', 'pkgver': '1:4.1.5.1-1ubuntu9.5'},
    {'osver': '16.04', 'pkgname': 'login', 'pkgver': '1:4.2-3.1ubuntu5.3'},
    {'osver': '16.04', 'pkgname': 'passwd', 'pkgver': '1:4.2-3.1ubuntu5.3'},
    {'osver': '16.04', 'pkgname': 'uidmap', 'pkgver': '1:4.2-3.1ubuntu5.3'}
];
