...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Grpc PHSA-2025-5.0-0456");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'grpc-1.59.5-3.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'grpc-devel-1.59.5-3.ph5')) flag++;
