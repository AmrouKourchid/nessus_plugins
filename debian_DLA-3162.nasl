...
# extracted from Debian Security Advisory dla-3162. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3162 : libdatetime-timezone-perl - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has a package installed that is affected by a vulnerability as referenced in the dla-3162
advisory.

    - -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3162-1                debian-lts@lists.debian.org
    https://www.debian.org/lts/security/               Emilio Pozuelo Monfort
    October 26, 2022                              https://wiki.debian.org/LTS
    - -------------------------------------------------------------------------

    Package        : libdatetime-timezone-perl
    Version        : 1:2.23-1+2022e

    This update includes the changes in tzdata 2022e for the
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libdatetime-timezone-perl', 'reference': '1:2.23-1+2022e'}
];
