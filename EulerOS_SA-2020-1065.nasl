...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.5.0 : patch (EulerOS-SA-2020-1065)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1065
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e8457711");
...
pkgs = ["patch-2.7.6-5.h3.eulerosv2r8"];
