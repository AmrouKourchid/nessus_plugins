...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : flatpak (EulerOS-SA-2019-1134)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1134
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e36bf23e");
...
pkgs = ["flatpak-0.8.8-3.h1.eulerosv2r7",
        "flatpak-libs-0.8.8-3.h1.eulerosv2r7"];
