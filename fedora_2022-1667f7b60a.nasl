...
# extracted from Fedora Security Advisory FEDORA-2022-1667f7b60a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-1667f7b60a");

  script_name(english:"Fedora 37 : nodejs (2022-1667f7b60a)");
...
FEDORA-2022-1667f7b60a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-1667f7b60a");
...
var pkgs = [
    {'reference':'nodejs-18.12.1-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
