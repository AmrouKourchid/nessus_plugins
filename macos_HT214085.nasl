...
if (description)
{
  ...
  script_xref(name:"APPLE-SA", value:"HT214085");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2024/03/27");
  script_xref(name:"IAVA", value:"2024-A-0142-S");

  script_name(english:"macOS 13.x < 13.6.5 Multiple Vulnerabilities (HT214085)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host is missing a macOS update that fixes multiple vulnerabilities");
  script_set_attribute(attribute:"description", value:
"The remote host is running a version of macOS / Mac OS X that is 13.x prior to 13.6.5. It is, therefore, affected by
...
version number.");
  script_set_attribute(attribute:"see_also", value:"https://support.apple.com/en-us/HT214085");
  script_set_attribute(attribute:"solution", value:
"Upgrade to macOS 13.6.5 or later.");
...
var constraints = [
  { 'fixed_version' : '13.6.5', 'min_version' : '13.0', 'fixed_display' : 'macOS Ventura 13.6.5' }
];
