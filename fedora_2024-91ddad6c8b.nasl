...
# extracted from Fedora Security Advisory FEDORA-2024-91ddad6c8b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-91ddad6c8b");
  script_xref(name:"IAVB", value:"2024-B-0095-S");

  script_name(english:"Fedora 40 : xen (2024-91ddad6c8b)");
...
FEDORA-2024-91ddad6c8b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-91ddad6c8b");
...
var pkgs = [
    {'reference':'xen-4.18.2-5.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
