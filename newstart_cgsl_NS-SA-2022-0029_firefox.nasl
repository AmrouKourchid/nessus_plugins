...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.05 / MAIN 5.05 : firefox Multiple Vulnerabilities (NS-SA-2022-0029)");
...
var pkgs = {
  'CGSL CORE 5.05': [
    'firefox-78.11.0-3.el7.centos',
    'firefox-debuginfo-78.11.0-3.el7.centos'
  ],
  'CGSL MAIN 5.05': [
    'firefox-78.11.0-3.el7.centos',
    'firefox-debuginfo-78.11.0-3.el7.centos'
