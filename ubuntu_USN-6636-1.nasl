...
# extracted from Ubuntu Security Notice USN-6636-1. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2024-20290", "CVE-2024-20328");
  script_xref(name:"USN", value:"6636-1");
  script_xref(name:"IAVB", value:"2024-B-0008-S");

  script_name(english:"Ubuntu 23.10 : ClamAV vulnerabilities (USN-6636-1)");
...
USN-6636-1 advisory.
    ...
    It was discovered that ClamAV incorrectly handled parsing certain OLE2 files. A remote attacker could
    possibly use this issue to cause ClamAV to crash, resulting in a denial of service. (CVE-2024-20290)

    Amit Schendel discovered that the ClamAV ClamD service incorrectly handled the VirusEvent feature. An
    attacker able to connect to ClamD could possibly use this issue to execute arbitrary code.
    (CVE-2024-20328)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6636-1");
...
var pkgs = [
    {'osver': '23.10', 'pkgname': 'clamav', 'pkgver': '1.0.5+dfsg-0ubuntu0.23.10.1'},
    {'osver': '23.10', 'pkgname': 'clamav-base', 'pkgver': '1.0.5+dfsg-0ubuntu0.23.10.1'},
    {'osver': '23.10', 'pkgname': 'clamav-daemon', 'pkgver': '1.0.5+dfsg-0ubuntu0.23.10.1'},
    {'osver': '23.10', 'pkgname': 'clamav-freshclam', 'pkgver': '1.0.5+dfsg-0ubuntu0.23.10.1'},
    {'osver': '23.10', 'pkgname': 'clamav-milter', 'pkgver': '1.0.5+dfsg-0ubuntu0.23.10.1'},
    {'osver': '23.10', 'pkgname': 'clamav-testfiles', 'pkgver': '1.0.5+dfsg-0ubuntu0.23.10.1'},
    {'osver': '23.10', 'pkgname': 'clamdscan', 'pkgver': '1.0.5+dfsg-0ubuntu0.23.10.1'},
    {'osver': '23.10', 'pkgname': 'libclamav-dev', 'pkgver': '1.0.5+dfsg-0ubuntu0.23.10.1'},
    {'osver': '23.10', 'pkgname': 'libclamav11', 'pkgver': '1.0.5+dfsg-0ubuntu0.23.10.1'}
];
