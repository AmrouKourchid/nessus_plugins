...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.0 : squashfs-tools (EulerOS-SA-2022-1414)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1414
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?47cbb8b1");
...
var pkgs = [
  "squashfs-tools-4.4-1.h3.eulerosv2r10"
];
