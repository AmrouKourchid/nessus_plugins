...
# extracted from Red Hat Security Advisory RHSA-2020:0005.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : chromium-browser (RHSA-2020:0005)");
...
RHSA-2020:0005 advisory.

  - Use after free in media picker in Google Chrome prior to 79.0.3945.88 allowed a remote attacker who had
...
var pkgs = [
    {'reference':'chromium-browser-79.0.3945.88-1.el6_10', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
