...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : java-1.7.0-openjdk (EulerOS-SA-2020-1394)");
...
the following vulnerabilities :
  ...
  - Vulnerability in the Java SE, Java SE Embedded, JRockit
    ...
    Java SE Embedded, JRockit. (CVE-2018-3180)
  ...
  - Vulnerability in the Java SE, Java SE Embedded, JRockit
    ...
    SE, Java SE Embedded, JRockit. (CVE-2018-3214)
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1394
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5a09d70e");
...
pkgs = ["java-1.7.0-openjdk-1.7.0.191-2.6.15.4.h8",
        "java-1.7.0-openjdk-devel-1.7.0.191-2.6.15.4.h8",
        "java-1.7.0-openjdk-headless-1.7.0.191-2.6.15.4.h8"];
