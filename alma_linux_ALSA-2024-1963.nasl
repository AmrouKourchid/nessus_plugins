...
# AlmaLinux Security Advisory ALSA-2024:1963.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:1963");
  script_xref(name:"IAVB", value:"2024-B-0032-S");

  script_name(english:"AlmaLinux 9 : golang (ALSA-2024:1963)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2024-1963.html");
