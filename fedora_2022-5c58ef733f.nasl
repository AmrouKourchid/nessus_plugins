...
# extracted from Fedora Security Advisory FEDORA-2022-5c58ef733f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-5c58ef733f");

  script_name(english:"Fedora 38 : dhcp (2022-5c58ef733f)");
...
FEDORA-2022-5c58ef733f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-5c58ef733f");
...
var pkgs = [
    {'reference':'dhcp-4.4.3-4.P1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'12'}
];
