...
if (description)
{
  ...
  script_name(english:"AIX (IJ35078)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AIX host is missing a security patch.");
  script_set_attribute(attribute:"description", value:
"The version of AIX installed on the remote host is prior to APAR IJ35078. It is, therefore, affected by a vulnerability
as referenced in the IJ35078 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/apar/IJ35078");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/node/6516786");
  script_set_attribute(attribute:"solution", value:
"Please apply the appropriate interim fix per APAR IJ35078.");
...
var constraints = [
    {'release': '3.1', 'ml': '03', 'sp': '10', 'patch': 'IJ35078s3a', 'package': 'bos.rte.security', 'minfilesetver': '7.2.5.0', 'maxfilesetver': '7.2.5.100'},
    {'release': '7.2', 'ml': '05', 'sp': '03', 'patch': 'IJ35078s3a', 'package': 'bos.rte.security', 'minfilesetver': '7.2.5.0', 'maxfilesetver': '7.2.5.100'}
];
