...
# extracted from Ubuntu Security Notice USN-5446-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5446-2");

  script_name(english:"Ubuntu 16.04 ESM : dpkg vulnerability (USN-5446-2)");
...
USN-5446-2 advisory.
    ...
    USN-5446-1 fixed a vulnerability in dpkg. This update provides the corresponding update for Ubuntu 16.04
    ESM.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5446-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'dpkg', 'pkgver': '1.18.4ubuntu1.7+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'dpkg-dev', 'pkgver': '1.18.4ubuntu1.7+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'dselect', 'pkgver': '1.18.4ubuntu1.7+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libdpkg-dev', 'pkgver': '1.18.4ubuntu1.7+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libdpkg-perl', 'pkgver': '1.18.4ubuntu1.7+esm1', 'ubuntu_pro': TRUE}
];
