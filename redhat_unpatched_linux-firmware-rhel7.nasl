...
# extracted from Red Hat Security Advisory linux-firmware. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2019-15126", "CVE-2020-12362");

  script_name(english:"RHEL 7 : linux-firmware (Unpatched Vulnerability) (deprecated)");
