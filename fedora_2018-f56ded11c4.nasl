...
# extracted from Fedora Security Advisory FEDORA-2018-f56ded11c4.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : openssh (2018-f56ded11c4)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"Security fix for CVE-2018-15473

Note that Tenable Network Security has extracted the preceding
description block directly from the Fedora update system website.
Tenable has attempted to automatically clean and format it as much as
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-f56ded11c4");
...
flag = 0;
if (rpm_check(release:"FC27", reference:"openssh-7.6p1-6.fc27")) flag++;
