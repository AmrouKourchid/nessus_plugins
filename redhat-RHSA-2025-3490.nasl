...
# extracted from Red Hat Security Advisory RHSA-2025:3490. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2025-27407", "CVE-2025-27610");
  script_xref(name:"RHSA", value:"2025:3490");
  script_xref(name:"IAVB", value:"2025-B-0065");

  script_name(english:"RHEL 8 / 9 : Satellite 6.16.4 Async Update (Important) (RHSA-2025:3490)");
...
referenced in the RHSA-2025:3490 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2351231");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2351767");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/SAT-30808");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/SAT-31568");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/SAT-31569");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/SAT-31570");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/SAT-31572");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/SAT-31576");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/SAT-31577");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_3490.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0e0c6a2f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:3490");
  script_set_attribute(attribute:"solution", value:
"Update the affected rubygem-graphql and / or rubygem-rack packages.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rubygem-rack-2.2.13-1.el8sat', 'release':'8', 'el_string':'el8sat', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'satellite-6', 'cves':['CVE-2025-27610']}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'rubygem-graphql-1.13.24-1.el8sat', 'release':'8', 'el_string':'el8sat', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'satellite-6', 'cves':['CVE-2025-27407']}
    ]
  },
  {
    'repo_relative_urls': [
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'rubygem-graphql / rubygem-rack');
}
