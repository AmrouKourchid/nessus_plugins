...
# extracted from Fedora Security Advisory FEDORA-2024-b4dab205d7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-b4dab205d7");
  script_xref(name:"IAVA", value:"2024-A-0183-S");

  script_name(english:"Fedora 38 : chromium (2024-b4dab205d7)");
...
FEDORA-2024-b4dab205d7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-b4dab205d7");
...
var pkgs = [
    {'reference':'chromium-123.0.6312.86-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
