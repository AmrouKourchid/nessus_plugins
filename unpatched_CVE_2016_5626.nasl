...
if (description)
{
  ...
  script_cve_id("CVE-2016-5626");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2016-5626");
...
patch available.
  ...
  - Unspecified vulnerability in Oracle MySQL 5.5.51 and earlier, 5.6.32 and earlier, and 5.7.14 and earlier
    allows remote authenticated users to affect availability via vectors related to GIS. (CVE-2016-5626)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-5626");
