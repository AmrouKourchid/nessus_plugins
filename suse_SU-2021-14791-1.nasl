...
# SUSE update advisory SUSE-SU-2021:14791-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2021:14791-1");
  script_xref(name:"IAVA", value:"2021-A-0395-S");

  script_name(english:"SUSE SLES11 Security Update : openssl (SUSE-SU-2021:14791-1)");
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2021-August/009339.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8b0baa9b");
...
var pkgs = [
    {'reference':'libopenssl0_9_8-0.9.8j-0.106.40.1', 'sp':'4', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.4']},
    {'reference':'libopenssl0_9_8-32bit-0.9.8j-0.106.40.1', 'sp':'4', 'cpu':'s390x', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.4']},
    {'reference':'libopenssl0_9_8-32bit-0.9.8j-0.106.40.1', 'sp':'4', 'cpu':'x86_64', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.4']},
    {'reference':'libopenssl0_9_8-hmac-0.9.8j-0.106.40.1', 'sp':'4', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.4']},
    {'reference':'libopenssl0_9_8-hmac-32bit-0.9.8j-0.106.40.1', 'sp':'4', 'cpu':'s390x', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.4']},
    {'reference':'libopenssl0_9_8-hmac-32bit-0.9.8j-0.106.40.1', 'sp':'4', 'cpu':'x86_64', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.4']},
    {'reference':'openssl-0.9.8j-0.106.40.1', 'sp':'4', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.4']},
    {'reference':'openssl-doc-0.9.8j-0.106.40.1', 'sp':'4', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.4']}
];
