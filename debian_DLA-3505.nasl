...
# extracted from Debian Security Advisory dla-3505. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3505 : gstreamer1.0-gtk3 - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3505
advisory.

    - -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3505-1                debian-lts@lists.debian.org
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-37327");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'gstreamer1.0-gtk3', 'reference': '1.14.4-1+deb10u3'},
    {'release': '10.0', 'prefix': 'gstreamer1.0-plugins-good', 'reference': '1.14.4-1+deb10u3'},
    {'release': '10.0', 'prefix': 'gstreamer1.0-plugins-good-dbg', 'reference': '1.14.4-1+deb10u3'},
    {'release': '10.0', 'prefix': 'gstreamer1.0-plugins-good-doc', 'reference': '1.14.4-1+deb10u3'},
    {'release': '10.0', 'prefix': 'gstreamer1.0-pulseaudio', 'reference': '1.14.4-1+deb10u3'},
    {'release': '10.0', 'prefix': 'gstreamer1.0-qt5', 'reference': '1.14.4-1+deb10u3'}
];
