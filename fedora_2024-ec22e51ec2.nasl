...
# extracted from Fedora Security Advisory FEDORA-2024-ec22e51ec2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-ec22e51ec2");

  script_name(english:"Fedora 38 : nghttp2 (2024-ec22e51ec2)");
...
FEDORA-2024-ec22e51ec2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-ec22e51ec2");
...
var pkgs = [
    {'reference':'nghttp2-1.52.0-3.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
