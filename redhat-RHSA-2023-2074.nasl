...
# extracted from Red Hat Security Advisory RHSA-2023:2074. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:2074");

  script_name(english:"RHEL 9 : emacs (RHSA-2023:2074)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_2074.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b7ee8c44");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2180544");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:2074");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL emacs package based on the guidance in RHSA-2023:2074.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'emacs-27.2-6.el9_1.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'emacs-common-27.2-6.el9_1.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'emacs-filesystem-27.2-6.el9_1.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'emacs-lucid-27.2-6.el9_1.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'emacs-nox-27.2-6.el9_1.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
