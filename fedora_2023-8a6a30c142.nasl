...
# extracted from Fedora Security Advisory FEDORA-2023-8a6a30c142
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-8a6a30c142");

  script_name(english:"Fedora 38 : insight (2023-8a6a30c142)");
...
FEDORA-2023-8a6a30c142 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-8a6a30c142");
...
var pkgs = [
    {'reference':'insight-13.0.50.20220502-9.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
