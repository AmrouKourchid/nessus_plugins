...
if (description)
{
  ...
  script_cve_id("CVE-2024-28073");
  script_xref(name:"IAVA", value:"2024-A-0249-S");

  script_name(english:"SolarWinds Serv-U 15.4.1.0 < 15.4.2");

  script_set_attribute(attribute:"synopsis", value:
"SolarWinds Serv-U is affected by a vulnerability");
  script_set_attribute(attribute:"description", value:
"The version of SolarWinds Serv-U installed on the remote host is prior to 15.4.2. It is, therefore, affected by a
vulnerability as referenced in the solarwinds_serv-u_15_4_2 advisory.

  - SolarWinds Serv-U was found to be susceptible to a Directory Traversal Remote Code Vulnerability. This
    vulnerability requires a highly privileged account to be exploited. (CVE-2024-28073)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://www.solarwinds.com/trust-center/security-advisories/cve-2024-28073
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?92becb19");
  script_set_attribute(attribute:"solution", value:
"Upgrade to SolarWinds Serv-U version 15.4.2 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:M/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:H/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-28073");
...
var constraints = [
  { 'min_version' : '15.4.1.0', 'max_version' : '15.4.1.128', 'fixed_version' : '15.4.2' }
];
