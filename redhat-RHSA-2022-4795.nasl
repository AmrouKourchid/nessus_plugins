...
# extracted from Red Hat Security Advisory RHSA-2022:4795. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:4795");

  script_name(english:"RHEL 9 : rsyslog (RHSA-2022:4795)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_4795.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2deb0ebe");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:4795");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2081353");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rsyslog package based on the guidance in RHSA-2022:4795.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rsyslog-logrotate");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rsyslog-mmaudit");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rsyslog-mmfields");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rsyslog-omamqp1");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rsyslog-openssl");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rsyslog-8.2102.0-101.el9_0.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsyslog-crypto-8.2102.0-101.el9_0.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsyslog-doc-8.2102.0-101.el9_0.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsyslog-elasticsearch-8.2102.0-101.el9_0.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsyslog-gnutls-8.2102.0-101.el9_0.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsyslog-gssapi-8.2102.0-101.el9_0.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsyslog-kafka-8.2102.0-101.el9_0.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsyslog-logrotate-8.2102.0-101.el9_0.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsyslog-mmaudit-8.2102.0-101.el9_0.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsyslog-mmfields-8.2102.0-101.el9_0.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsyslog-mmjsonparse-8.2102.0-101.el9_0.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsyslog-mmkubernetes-8.2102.0-101.el9_0.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsyslog-mmnormalize-8.2102.0-101.el9_0.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsyslog-mmsnmptrapd-8.2102.0-101.el9_0.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsyslog-mysql-8.2102.0-101.el9_0.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsyslog-omamqp1-8.2102.0-101.el9_0.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsyslog-openssl-8.2102.0-101.el9_0.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsyslog-pgsql-8.2102.0-101.el9_0.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsyslog-relp-8.2102.0-101.el9_0.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsyslog-snmp-8.2102.0-101.el9_0.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsyslog-udpspoof-8.2102.0-101.el9_0.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'rsyslog-8.2102.0-101.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsyslog-crypto-8.2102.0-101.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsyslog-doc-8.2102.0-101.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsyslog-elasticsearch-8.2102.0-101.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsyslog-gnutls-8.2102.0-101.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsyslog-gssapi-8.2102.0-101.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsyslog-kafka-8.2102.0-101.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsyslog-logrotate-8.2102.0-101.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsyslog-mmaudit-8.2102.0-101.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsyslog-mmfields-8.2102.0-101.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsyslog-mmjsonparse-8.2102.0-101.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsyslog-mmkubernetes-8.2102.0-101.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsyslog-mmnormalize-8.2102.0-101.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsyslog-mmsnmptrapd-8.2102.0-101.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsyslog-mysql-8.2102.0-101.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsyslog-omamqp1-8.2102.0-101.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsyslog-openssl-8.2102.0-101.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsyslog-pgsql-8.2102.0-101.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsyslog-relp-8.2102.0-101.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsyslog-snmp-8.2102.0-101.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsyslog-udpspoof-8.2102.0-101.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
