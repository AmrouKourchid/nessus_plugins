...
# extracted from Ubuntu Security Notice USN-5860-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5860-1");

  script_name(english:"Ubuntu 22.04 LTS : Linux kernel (GKE) vulnerabilities (USN-5860-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5860-1");
