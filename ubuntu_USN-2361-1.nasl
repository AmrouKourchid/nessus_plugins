...
# extracted from Ubuntu Security Notice USN-2361-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"2361-1");

  script_name(english:"Ubuntu 14.04 LTS : NSS vulnerability (USN-2361-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2361-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'libnss3', 'pkgver': '2:3.17.1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'libnss3-1d', 'pkgver': '2:3.17.1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'libnss3-dev', 'pkgver': '2:3.17.1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'libnss3-nssdb', 'pkgver': '2:3.17.1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'libnss3-tools', 'pkgver': '2:3.17.1-0ubuntu0.14.04.1'}
];
