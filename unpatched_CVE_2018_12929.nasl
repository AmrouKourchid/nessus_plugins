...
if (description)
{
  ...
  script_cve_id("CVE-2018-12929");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2018-12929");
...
patch available.
  ...
  - ntfs_read_locked_inode in the ntfs.ko filesystem driver in the Linux kernel 4.15.0 allows attackers to
    trigger a use-after-free read and possibly cause a denial of service (kernel oops or panic) via a crafted
    ntfs filesystem. (CVE-2018-12929)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-12929");
