...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Libssh2 PHSA-2019-3.0-0009");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libssh2-1.8.2-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libssh2-debuginfo-1.8.2-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libssh2-devel-1.8.2-1.ph3')) flag++;
