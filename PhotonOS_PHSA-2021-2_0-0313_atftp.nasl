...
# extracted from VMware Security Advisory PHSA-2021-2.0-0313. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Atftp PHSA-2021-2.0-0313");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the atftp package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-2-313.md");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'atftp-0.7.1-10.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'atftp-client-0.7.1-10.ph2')) flag++;
