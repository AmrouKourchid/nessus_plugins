...
# extracted from Red Hat Security Advisory RHSA-2014:1862. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2014:1862");

  script_name(english:"RHEL 6 / 7 : mariadb55-mariadb (RHSA-2014:1862)");
...
referenced in the RHSA-2014:1862 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2014/rhsa-2014_1862.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?80e47d19");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2014:1862");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL mariadb55-mariadb package based on the guidance in RHSA-2014:1862.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'mariadb55-mariadb-5.5.40-10.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mariadb55-mariadb-bench-5.5.40-10.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mariadb55-mariadb-devel-5.5.40-10.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mariadb55-mariadb-libs-5.5.40-10.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mariadb55-mariadb-server-5.5.40-10.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mariadb55-mariadb-test-5.5.40-10.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'mariadb55-mariadb-5.5.40-10.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mariadb55-mariadb-bench-5.5.40-10.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mariadb55-mariadb-devel-5.5.40-10.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mariadb55-mariadb-libs-5.5.40-10.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mariadb55-mariadb-server-5.5.40-10.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mariadb55-mariadb-test-5.5.40-10.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
