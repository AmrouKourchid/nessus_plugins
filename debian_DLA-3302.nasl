...
# extracted from Debian Security Advisory dla-3302. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3302 : nova-api - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3302
advisory.
...
var pkgs = [
    {'release': '10.0', 'prefix': 'nova-api', 'reference': '2:18.1.0-6+deb10u2'},
    {'release': '10.0', 'prefix': 'nova-cells', 'reference': '2:18.1.0-6+deb10u2'},
    {'release': '10.0', 'prefix': 'nova-common', 'reference': '2:18.1.0-6+deb10u2'},
    {'release': '10.0', 'prefix': 'nova-compute', 'reference': '2:18.1.0-6+deb10u2'},
    {'release': '10.0', 'prefix': 'nova-compute-ironic', 'reference': '2:18.1.0-6+deb10u2'},
    {'release': '10.0', 'prefix': 'nova-compute-kvm', 'reference': '2:18.1.0-6+deb10u2'},
    {'release': '10.0', 'prefix': 'nova-compute-lxc', 'reference': '2:18.1.0-6+deb10u2'},
    {'release': '10.0', 'prefix': 'nova-compute-qemu', 'reference': '2:18.1.0-6+deb10u2'},
    {'release': '10.0', 'prefix': 'nova-conductor', 'reference': '2:18.1.0-6+deb10u2'},
    {'release': '10.0', 'prefix': 'nova-console', 'reference': '2:18.1.0-6+deb10u2'},
    {'release': '10.0', 'prefix': 'nova-consoleauth', 'reference': '2:18.1.0-6+deb10u2'},
    {'release': '10.0', 'prefix': 'nova-consoleproxy', 'reference': '2:18.1.0-6+deb10u2'},
    {'release': '10.0', 'prefix': 'nova-doc', 'reference': '2:18.1.0-6+deb10u2'},
    {'release': '10.0', 'prefix': 'nova-placement-api', 'reference': '2:18.1.0-6+deb10u2'},
    {'release': '10.0', 'prefix': 'nova-scheduler', 'reference': '2:18.1.0-6+deb10u2'},
    {'release': '10.0', 'prefix': 'nova-volume', 'reference': '2:18.1.0-6+deb10u2'},
    {'release': '10.0', 'prefix': 'python3-nova', 'reference': '2:18.1.0-6+deb10u2'}
];
