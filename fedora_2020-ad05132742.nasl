...
# extracted from Fedora Security Advisory FEDORA-2020-ad05132742.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : mingw-curl (2020-ad05132742)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-ad05132742");
  script_set_attribute(attribute:"solution", value:
"Update the affected mingw-curl package.");
...
flag = 0;
if (rpm_check(release:"FC32", reference:"mingw-curl-7.71.1-1.fc32")) flag++;
