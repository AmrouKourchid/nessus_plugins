...
# extracted from Fedora Security Advisory FEDORA-2025-98dd4c4639
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-98dd4c4639");

  script_name(english:"Fedora 41 : chromium (2025-98dd4c4639)");
...
FEDORA-2025-98dd4c4639 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-98dd4c4639");
...
var pkgs = [
    {'reference':'chromium-135.0.7049.52-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
