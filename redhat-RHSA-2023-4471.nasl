...
# extracted from Red Hat Security Advisory RHSA-2023:4471. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:4471");

  script_name(english:"RHEL 8 : Release of OpenShift Serverless Client kn 1.29.1 (Moderate) (RHSA-2023:4471)");
...
the RHSA-2023:4471 advisory.

    Red Hat OpenShift Serverless Client kn 1.29.1 provides a CLI to interact with Red Hat OpenShift Serverless
    1.29.1. The kn CLI is delivered as an RPM package for installation on RHEL platforms, and as binaries for
    non-Linux platforms.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_4471.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?57d493ff");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2212085");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:4471");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openshift-serverless-clients-1.8.1-6.el8', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openshift-serverless-clients-1.8.1-6.el8', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openshift-serverless-clients-1.8.1-6.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
