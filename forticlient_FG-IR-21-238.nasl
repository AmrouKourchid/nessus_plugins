...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2022-A-0137-S");

  script_name(english:"Fortinet FortiClient Privilege escalation in online installer due to incorrect working director (FG-IR-21-238)");
...
vulnerability as referenced in the FG-IR-21-238 advisory.

  - A improper initialization in Fortinet FortiClient (Windows) version 6.0.10 and below, version 6.2.9 and
    below, version 6.4.7 and below, version 7.0.3 and below allows attacker to gain administrative privileges
    via placing a malicious executable inside the FortiClient installer's directory. (CVE-2021-44169)
...
"Please upgrade to FortiClientWindows version 6.4.8/7.0.3 or later.");
...
var constraints = [
  { 'min_version' : '6.0', 'max_version' : '6.2', 'fixed_version' : '6.4.8' },
