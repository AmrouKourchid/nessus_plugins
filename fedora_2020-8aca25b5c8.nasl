...
# extracted from Fedora Security Advisory FEDORA-2020-8aca25b5c8.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : chromium (2020-8aca25b5c8)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-8aca25b5c8");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"chromium-86.0.4240.111-1.fc31", allowmaj:TRUE)) flag++;
