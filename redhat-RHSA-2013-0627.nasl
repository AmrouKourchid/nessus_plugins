...
# extracted from Red Hat Security Advisory RHSA-2013:0627. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 6 : thunderbird (RHSA-2013:0627)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2013/rhsa-2013_0627.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?314924cf");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2013:0627");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=918876");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL thunderbird package based on the guidance in RHSA-2013:0627.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'thunderbird-17.0.3-2.el6_4', 'cpu':'i686', 'release':'6', 'el_string':'el6_4', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'thunderbird-17.0.3-2.el6_4', 'cpu':'ppc64', 'release':'6', 'el_string':'el6_4', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'thunderbird-17.0.3-2.el6_4', 'cpu':'s390x', 'release':'6', 'el_string':'el6_4', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'thunderbird-17.0.3-2.el6_4', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_4', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
