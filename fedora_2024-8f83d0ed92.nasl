...
# extracted from Fedora Security Advisory FEDORA-2024-8f83d0ed92
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-8f83d0ed92");

  script_name(english:"Fedora 40 : golang-x-crypto (2024-8f83d0ed92)");
...
FEDORA-2024-8f83d0ed92 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-8f83d0ed92");
...
var pkgs = [
    {'reference':'golang-x-crypto-0.31.0-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
