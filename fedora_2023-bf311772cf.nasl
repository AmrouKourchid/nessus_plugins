...
# extracted from Fedora Security Advisory FEDORA-2023-bf311772cf
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-bf311772cf");

  script_name(english:"Fedora 37 : nispor (2023-bf311772cf)");
...
FEDORA-2023-bf311772cf advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-bf311772cf");
  script_set_attribute(attribute:"solution", value:
"Update the affected nispor package.");
...
var pkgs = [
    {'reference':'nispor-1.2.11-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'nispor');
}
