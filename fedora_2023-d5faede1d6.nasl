...
# extracted from Fedora Security Advisory FEDORA-2023-d5faede1d6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-d5faede1d6");

  script_name(english:"Fedora 40 : libwebp (2023-d5faede1d6)");
...
FEDORA-2023-d5faede1d6 advisory.

    Automatic update for libwebp-1.3.1-3.fc40.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-d5faede1d6");
...
var pkgs = [
    {'reference':'libwebp-1.3.1-3.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
