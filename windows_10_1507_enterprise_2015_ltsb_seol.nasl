...
if (description)
{
  ...
  script_name(english:"Microsoft Windows 10 1507 Enterprise 2015 LTSB SEoL");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Microsoft Windows is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"Microsoft Windows 10 1507 Enterprise 2015 LTSB is no longer maintained by its vendor or provider.

Lack of support implies that no new security patches for the product will be released by the vendor. As a result, it may
contain security vulnerabilities.");
  # https://learn.microsoft.com/en-us/lifecycle/products/windows-10-2015-ltsb
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5980f58e");
...
var constraints = [
  { seol : 20251014, cpe_attributes : [{'edition': 'enterprise_2015_ltsb'}] }
];
