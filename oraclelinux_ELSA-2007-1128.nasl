...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : Important: / autofs (ELSA-2007-1128)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2007-1128.html");
...
"Update the affected autofs package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2007-5964");
...
var pkgs = [
    {'reference':'autofs-5.0.1-0.rc2.55.el5.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'autofs-5.0.1-0.rc2.55.el5.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
