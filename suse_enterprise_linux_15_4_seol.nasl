...
{  
  ...
  script_name(english:"SUSE Enterprise Linux SEoL (15.4.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of SUSE Enterprise Linux is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, SUSE Enterprise Linux is 15.4.x. It is, therefore, no longer maintained by its vendor or
provider.
...
var os = ucf::get_os_cpe(vendor:'suse', product:'enterprise_linux', type:'combined');

var constraints = [
  { max_branch : '15.4', min_branch : '15.4', seol : 20231231, eseol : 20261231 }
];
