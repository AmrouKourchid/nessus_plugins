...
# extracted from Red Hat Security Advisory RHSA-2024:4545. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:4545");

  script_name(english:"RHEL 8 : git-lfs (RHSA-2024:4545)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dbda7590");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:4545");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL git-lfs package based on the guidance in RHSA-2024:4545.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'git-lfs-3.2.0-2.el8_8.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
