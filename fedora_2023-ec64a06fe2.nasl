...
# extracted from Fedora Security Advisory FEDORA-2023-ec64a06fe2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-ec64a06fe2");

  script_name(english:"Fedora 38 : edk2 (2023-ec64a06fe2)");
...
FEDORA-2023-ec64a06fe2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-ec64a06fe2");
...
var pkgs = [
    {'reference':'edk2-20230301gitf80f052277c8-26.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
