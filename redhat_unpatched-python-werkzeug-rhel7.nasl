...
# extracted from Red Hat Security Advisory python-werkzeug. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2023-23934", "CVE-2023-46136");

  script_name(english:"RHEL 7 : python-werkzeug (Unpatched Vulnerability) (deprecated)");
