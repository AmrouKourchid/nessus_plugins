...
# extracted from Fedora Security Advisory FEDORA-2023-5d51a42413
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-5d51a42413");

  script_name(english:"Fedora 36 : insight (2023-5d51a42413)");
...
FEDORA-2023-5d51a42413 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-5d51a42413");
...
var pkgs = [
    {'reference':'insight-13.0.50.20220502-9.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
