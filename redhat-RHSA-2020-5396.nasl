...
# extracted from Red Hat Security Advisory RHSA-2020:5396. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:5396");

  script_name(english:"RHEL 8 : libexif (RHSA-2020:5396)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_5396.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dbc3fb6d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:5396");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1902004");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libexif package based on the guidance in RHSA-2020:5396.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libexif-0.6.21-18.el8_0', 'sp':'0', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libexif-0.6.21-18.el8_0', 'sp':'0', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libexif-0.6.21-18.el8_0', 'sp':'0', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
