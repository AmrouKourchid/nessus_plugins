...
# AlmaLinux Security Advisory ALSA-2022:4582.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2022:4582");
  script_xref(name:"IAVA", value:"2024-A-0327");

  script_name(english:"AlmaLinux 9 : gzip (ALSA-2022:4582)");
...
ALSA-2022:4582 advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2022-4582.html");
...
"Update the affected gzip package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:gzip");
