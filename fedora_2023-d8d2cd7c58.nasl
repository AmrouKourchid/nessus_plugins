...
# extracted from Fedora Security Advisory FEDORA-2023-d8d2cd7c58
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-d8d2cd7c58");

  script_name(english:"Fedora 37 : epiphany (2023-d8d2cd7c58)");
...
FEDORA-2023-d8d2cd7c58 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-d8d2cd7c58");
...
var pkgs = [
    {'reference':'epiphany-43.1-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
