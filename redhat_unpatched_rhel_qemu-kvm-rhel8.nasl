...
# extracted from Red Hat Security Advisory rhel_qemu-kvm. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2020-10717");

  script_name(english:"RHEL 8 : rhel_qemu-kvm (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-10717");
