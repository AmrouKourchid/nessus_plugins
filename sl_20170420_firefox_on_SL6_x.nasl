...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : firefox on SL6.x i386/x86_64 (20170420)");
...
Security Fix(es) :
  ...
  - Multiple flaws were found in the processing of malformed
    ...
    Firefox. (CVE-2017-5429, CVE-2017-5432, CVE-2017-5433,
    CVE-2017-5434, CVE-2017-5435, CVE-2017-5436,
    CVE-2017-5438, CVE-2017-5439,
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1704&L=scientific-linux-errata&F=&S=&P=17959
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?864bd8d3"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"SL6", reference:"firefox-52.1.0-2.el6_9", allowmaj:TRUE)) flag++;
if (rpm_check(release:"SL6", reference:"firefox-debuginfo-52.1.0-2.el6_9", allowmaj:TRUE)) flag++;
