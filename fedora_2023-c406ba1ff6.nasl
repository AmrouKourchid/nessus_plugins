...
# extracted from Fedora Security Advisory FEDORA-2023-c406ba1ff6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-c406ba1ff6");

  script_name(english:"Fedora 38 : redis (2023-c406ba1ff6)");
...
FEDORA-2023-c406ba1ff6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-c406ba1ff6");
...
var pkgs = [
    {'reference':'redis-7.0.12-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
