...
if (description)
{
  ...
  script_name(english:"Mozilla Firefox ESR < 60.2.1 Multiple Vulnerabilities");
...
mozilla_check_version(installs:installs, product:'firefox', esr:TRUE, fix:'60.2.1', min:'60.0', severity:SECURITY_WARNING);
