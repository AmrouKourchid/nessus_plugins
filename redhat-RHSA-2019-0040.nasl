...
if (description)
{
  ...
  script_name(english:"RHEL 7 : .NET Core on Red Hat Enterprise Linux (RHSA-2019:0040)");
...
referenced in the RHSA-2019:0040 advisory.
    ...
    * .NET Core: NCL - SocketsHttpHandler mishandling 1xx response as a final response leads to info
    disclosure (CVE-2019-0545)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_0040.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1271a9be");
  # https://portal.msrc.microsoft.com/en-US/security-guidance/advisory/CVE-2019-0564
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bb9bad83");
  # https://portal.msrc.microsoft.com/en-US/security-guidance/advisory/CVE-2019-0545
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c1cb22b8");
  # https://portal.msrc.microsoft.com/en-US/security-guidance/advisory/CVE-2019-0548
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ec9714b3");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:0040");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1660632");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1660634");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1660636");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL .NET Core on Red Hat Enterprise Linux package based on the guidance in RHSA-2019:0040.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-dotnet21-2.1-6.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet21'},
      {'reference':'rh-dotnet21-dotnet-2.1.503-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet21'},
      {'reference':'rh-dotnet21-dotnet-host-2.1.7-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet21'},
      {'reference':'rh-dotnet21-dotnet-runtime-2.1-2.1.7-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet21'},
      {'reference':'rh-dotnet21-dotnet-sdk-2.1-2.1.503-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet21'},
      {'reference':'rh-dotnet21-dotnet-sdk-2.1.5xx-2.1.503-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet21'},
      {'reference':'rh-dotnet21-runtime-2.1-6.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet21'},
      {'reference':'rh-dotnet22-2.2-2.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet22'},
      {'reference':'rh-dotnet22-dotnet-2.2.102-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet22'},
      {'reference':'rh-dotnet22-dotnet-host-2.2.1-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet22'},
      {'reference':'rh-dotnet22-dotnet-host-fxr-2.2-2.2.1-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet22'},
      {'reference':'rh-dotnet22-dotnet-runtime-2.2-2.2.1-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet22'},
      {'reference':'rh-dotnet22-dotnet-sdk-2.2-2.2.102-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet22'},
      {'reference':'rh-dotnet22-dotnet-sdk-2.2.1xx-2.2.102-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet22'},
      {'reference':'rh-dotnet22-runtime-2.2-2.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet22'}
    ]
  }
];
