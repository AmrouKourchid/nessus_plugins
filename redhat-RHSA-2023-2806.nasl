...
# extracted from Red Hat Security Advisory RHSA-2023:2806. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:2806");

  script_name(english:"RHEL 8 : xorg-x11-server (RHSA-2023:2806)");
...
referenced in the RHSA-2023:2806 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_2806.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a6f08576");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2169522");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:2806");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL xorg-x11-server package based on the guidance in RHSA-2023:2806.");
