...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : squashfs-tools (EulerOS-SA-2022-1096)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1096
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?077c8f73");
...
var pkgs = [
  "squashfs-tools-4.3-16.h6.eulerosv2r8"
];
