...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : telnet (EulerOS-SA-2020-1577)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1577
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bc1a51d3");
...
pkgs = ["telnet-0.17-74.h1.eulerosv2r8",
        "telnet-server-0.17-74.h1.eulerosv2r8"];
