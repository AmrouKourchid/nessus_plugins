...
# extracted from Red Hat Security Advisory RHSA-2018:1927 and 
# CentOS Errata and Security Advisory 2018:1927 respectively.
#
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:1927");

  script_name(english:"CentOS 6 : pcs (CESA-2018:1927)");
...
Technical Notes linked from the References section.");
  # https://lists.centos.org/pipermail/centos-cr-announce/2018-June/005287.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4d9f14db");
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"pcs-0.9.155-3.el6.centos")) flag++;
