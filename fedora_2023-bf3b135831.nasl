...
# extracted from Fedora Security Advisory FEDORA-2023-bf3b135831
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-bf3b135831");

  script_name(english:"Fedora 39 : libfastjson (2023-bf3b135831)");
...
FEDORA-2023-bf3b135831 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-bf3b135831");
...
"Update the affected libfastjson package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:libfastjson");
...
var pkgs = [
    {'reference':'libfastjson-1.2304.0-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
