...
# extracted from Red Hat Security Advisory RHSA-2023:0952. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:0952");

  script_name(english:"RHEL 9 : python-setuptools (RHSA-2023:0952)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_0952.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?179c7081");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2158559");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:0952");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-setuptools package based on the guidance in RHSA-2023:0952.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-setuptools-53.0.0-10.el9_1.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-setuptools-wheel-53.0.0-10.el9_1.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
