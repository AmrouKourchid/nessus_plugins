...
if (description)
{
  ...
  script_name(english:"SUSE SLES15 Security Update : kernel (SUSE-SU-2022:4617-1)");
...
var kernel_live_checks = [
  {
    'kernels': {
      '5.14.21-150400.15.5-rt-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_14_21-150400_15_5-rt-1-150400.1.3.1', 'sp':'4', 'cpu':'x86_64', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.4']},
          {'reference':'kernel-livepatch-5_14_21-150400_15_5-rt-1-150400.1.3.1', 'sp':'4', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.4', 'sle-module-live-patching-release-15.4', 'sles-release-15.4']}
        ]
      }
    }
  }
