...
# AlmaLinux Security Advisory ALSA-2023:4571.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:4571");

  script_name(english:"AlmaLinux 9 : iperf3 (ALSA-2023:4571)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2023-4571.html");
...
var pkgs = [
    {'reference':'iperf3-3.9-10.el9_2.alma', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
