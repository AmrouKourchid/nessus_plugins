...
# Red Hat Security Advisory RHSA-2022:7592. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:7592");

  script_name(english:"CentOS 8 : python39:3.9 and python39-devel:3.9 (CESA-2022:7592)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
CESA-2022:7592 advisory.

  - python: mailcap: findmatch() function does not sanitize the second argument (CVE-2015-20107)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:7592");
...
var appstreams = {
    'python39-devel:3.9': [
      {'reference':'python39-3.9.13-1.module_el8.7.0+1178+0ba51308', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-3.9.13-1.module_el8.7.0+1178+0ba51308', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python39-debug-3.9.13-1.module_el8.7.0+1178+0ba51308', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-debug-3.9.13-1.module_el8.7.0+1178+0ba51308', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-devel-3.9.13-1.module_el8.7.0+1178+0ba51308', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-devel-3.9.13-1.module_el8.7.0+1178+0ba51308', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-idle-3.9.13-1.module_el8.7.0+1178+0ba51308', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-idle-3.9.13-1.module_el8.7.0+1178+0ba51308', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python39-libs-3.9.13-1.module_el8.7.0+1178+0ba51308', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-libs-3.9.13-1.module_el8.7.0+1178+0ba51308', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python39-rpm-macros-3.9.13-1.module_el8.7.0+1178+0ba51308', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-rpm-macros-3.9.13-1.module_el8.7.0+1178+0ba51308', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python39-test-3.9.13-1.module_el8.7.0+1178+0ba51308', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-test-3.9.13-1.module_el8.7.0+1178+0ba51308', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-tkinter-3.9.13-1.module_el8.7.0+1178+0ba51308', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-tkinter-3.9.13-1.module_el8.7.0+1178+0ba51308', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
