...
# extracted from Fedora Security Advisory FEDORA-2024-7d5c1bcc78
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-7d5c1bcc78");

  script_name(english:"Fedora 41 : openssl (2024-7d5c1bcc78)");
...
FEDORA-2024-7d5c1bcc78 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-7d5c1bcc78");
...
var pkgs = [
    {'reference':'openssl-3.2.2-7.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
