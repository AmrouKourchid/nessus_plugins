...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 6.02 : libjpeg-turbo Vulnerability (NS-SA-2024-0051)");

  script_set_attribute(attribute:"synopsis", value:
"The remote NewStart CGSL host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 6.02, has libjpeg-turbo packages installed that are affected by a
vulnerability:

  - A stack-based buffer overflow flaw was found in libjpeg-turbo library in the tranform component. An
    attacker may use this flaw to input a malicious image file to an application utilizing this library,
    leading to arbitrary code execution. The highest threat from this vulnerability is to data confidentiality
    and integrity as well as system availability. (CVE-2020-17541)

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/notice/NS-SA-2024-0051");
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/info/CVE-2020-17541");
...
var pkgs = {
  'CGSL MAIN 6.02': [
    ...
    'libjpeg-turbo-devel-1.5.3-12.el8'
  ]
};
