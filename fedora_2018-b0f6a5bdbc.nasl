...
# extracted from Fedora Security Advisory FEDORA-2018-b0f6a5bdbc.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 26 : glpi (2018-b0f6a5bdbc)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-b0f6a5bdbc");
...
"Update the affected glpi package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-7563");
...
flag = 0;
if (rpm_check(release:"FC26", reference:"glpi-9.1.7.1-2.fc26")) flag++;
