...
# AlmaLinux Security Advisory ALSA-2024:3339.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:3339");
  script_xref(name:"IAVA", value:"2025-A-0062");

  script_name(english:"AlmaLinux 9 : glibc (ALSA-2024:3339)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 9 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ALSA-2024:3339 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2024-3339.html");
...
var pkgs = [
    ...
    {'reference':'glibc-headers-2.34-100.el9_4.2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
