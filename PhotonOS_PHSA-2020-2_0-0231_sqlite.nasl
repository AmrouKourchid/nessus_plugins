...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Sqlite PHSA-2020-2.0-0231");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'sqlite-3.31.1-2.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'sqlite-debuginfo-3.31.1-2.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'sqlite-devel-3.31.1-2.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'sqlite-libs-3.31.1-2.ph2')) flag++;
