...
if (description)
{
  ...
  script_cve_id("CVE-2015-8553");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2015-8553");
...
patch available.
  ...
  - Xen allows guest OS users to obtain sensitive information from uninitialized locations in host OS kernel
    memory by not enabling memory and I/O decoding control bits. NOTE: this vulnerability exists because of an
    incomplete fix for CVE-2015-0777. (CVE-2015-8553)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-8553");
