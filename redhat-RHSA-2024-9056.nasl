...
# extracted from Red Hat Security Advisory RHSA-2024:9056. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 8 : gstreamer1-plugins-base (RHSA-2024:9056)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_9056.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?aad4cf41");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:9056");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL gstreamer1-plugins-base package based on the guidance in RHSA-2024:9056.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gstreamer1-plugins-base-1.16.1-4.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gstreamer1-plugins-base-devel-1.16.1-4.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
