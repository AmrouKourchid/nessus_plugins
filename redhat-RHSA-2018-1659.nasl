...
# extracted from Red Hat Security Advisory RHSA-2018:1659. The text 
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2018/rhsa-2018_1659.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c4ab117e");
...
"Update the RHEL qemu-kvm package based on the guidance in RHSA-2018:1659.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'qemu-guest-agent-0.12.1.2-2.479.el6_7.7', 'sp':'7', 'cpu':'i686', 'release':'6', 'el_string':'el6_7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'qemu-guest-agent-0.12.1.2-2.479.el6_7.7', 'sp':'7', 'cpu':'ppc64', 'release':'6', 'el_string':'el6_7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'qemu-guest-agent-0.12.1.2-2.479.el6_7.7', 'sp':'7', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'qemu-img-0.12.1.2-2.479.el6_7.7', 'sp':'7', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'qemu-kvm-0.12.1.2-2.479.el6_7.7', 'sp':'7', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'qemu-kvm-tools-0.12.1.2-2.479.el6_7.7', 'sp':'7', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
    ]
  }
];
