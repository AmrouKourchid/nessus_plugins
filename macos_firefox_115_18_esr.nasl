...
"The version of Firefox ESR installed on the remote macOS or Mac OS X host is prior to 115.18. It is, therefore, affected
by multiple vulnerabilities as referenced in the mfsa2024-65 advisory.
...
mozilla_check_version(version:version, path:path, product:'firefox', esr:TRUE, fix:'115.18', min:'115.0.0', xss:TRUE, severity:SECURITY_WARNING);
