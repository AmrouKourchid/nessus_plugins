...
# extracted from Red Hat Security Advisory RHSA-2024:6683. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:6683");

  script_name(english:"RHEL 9 : thunderbird (RHSA-2024:6683)");
...
referenced in the RHSA-2024:6683 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_6683.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cc42ae36");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:6683");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL thunderbird package based on the guidance in RHSA-2024:6683.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'thunderbird-128.2.0-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'thunderbird-128.2.0-1.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
