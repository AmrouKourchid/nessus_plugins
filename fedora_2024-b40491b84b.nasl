...
# extracted from Fedora Security Advisory FEDORA-2024-b40491b84b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-b40491b84b");

  script_name(english:"Fedora 40 : apr (2024-b40491b84b)");
...
FEDORA-2024-b40491b84b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-b40491b84b");
...
var pkgs = [
    {'reference':'apr-1.7.5-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
