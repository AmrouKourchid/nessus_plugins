...
# extracted from SUSE update advisory SUSE-SU-2018:2041-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES15 Security Update : openssl-1_1 (SUSE-SU-2018:2041-1)");
...
without introducing additional issues.");
  ...
  # https://www.suse.com/support/update/announcement/2018/suse-su-20182041-1/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?982b451f");
...
SUSE-SLE-Module-Legacy-15-2018-1371=1");
...
flag = 0;
if (rpm_check(release:"SLES15", sp:"0", reference:"libopenssl-1_0_0-devel-1.0.2n-3.3.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", reference:"libopenssl1_0_0-1.0.2n-3.3.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", reference:"libopenssl1_0_0-debuginfo-1.0.2n-3.3.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", reference:"openssl-1_0_0-1.0.2n-3.3.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", reference:"openssl-1_0_0-debuginfo-1.0.2n-3.3.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", reference:"openssl-1_0_0-debugsource-1.0.2n-3.3.1")) flag++;
