...
# extracted from Fedora Security Advisory FEDORA-2023-f5680e3b4b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-f5680e3b4b");

  script_name(english:"Fedora 37 : libtommath (2023-f5680e3b4b)");
...
FEDORA-2023-f5680e3b4b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-f5680e3b4b");
...
var pkgs = [
    {'reference':'libtommath-1.2.0-11.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
