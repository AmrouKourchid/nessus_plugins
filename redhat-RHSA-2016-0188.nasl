...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2016/rhsa-2016_0188.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f14abf1e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2016:0188");
...
"Update the RHEL sos package based on the guidance in RHSA-2016:0188.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'sos-3.2-35.el7_2.3', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
