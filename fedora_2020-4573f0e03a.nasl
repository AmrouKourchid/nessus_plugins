...
# extracted from Fedora Security Advisory FEDORA-2020-4573f0e03a.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 33 : php (2020-4573f0e03a)");
...
**Core:**
  ...
  - Fixed bug php#79979 (passing value to by-ref param via
    CUFA crashes). (cmb, Nikita)

  - Fixed bug php#80037 (Typed property must not be accessed
    before initialization when __get() declared). (Nikita)
...
**OPcache:**
  ...
  - Fixed bug php#80046 (FREE for SWITCH_STRING optimized
    away). (Nikita)
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-4573f0e03a");
...
flag = 0;
if (rpm_check(release:"FC33", reference:"php-7.4.11-1.fc33")) flag++;
