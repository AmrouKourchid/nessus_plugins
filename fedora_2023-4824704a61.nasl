...
# extracted from Fedora Security Advisory FEDORA-2023-4824704a61
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-4824704a61");

  script_name(english:"Fedora 37 : rust (2023-4824704a61)");
...
FEDORA-2023-4824704a61 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-4824704a61");
...
var pkgs = [
    {'reference':'rust-1.71.1-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
