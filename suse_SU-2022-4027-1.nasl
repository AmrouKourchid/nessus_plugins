...
referenced in the SUSE-SU-2022:4027-1 advisory.
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-150000.150.95-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-4_12_14-150000_150_95-default-4-150000.2.1', 'sp':'0', 'cpu':'x86_64', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15']},
          {'reference':'kernel-livepatch-4_12_14-150000_150_95-default-4-150000.2.1', 'sp':'0', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15', 'sle-module-live-patching-release-15', 'sles-release-15']}
        ]
      }
    }
  }
