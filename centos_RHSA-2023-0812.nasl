...
if (description)
{
  ...
  script_name(english:"CentOS 7 : firefox (RHSA-2023:0812)");
...
var pkgs = [
    {'reference':'firefox-102.8.0-2.el7.centos', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
