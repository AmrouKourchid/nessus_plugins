...
commands under multiple scenarios.");
  script_set_attribute(attribute:"see_also", value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=950258");
  # https://security-tracker.debian.org/tracker/source-package/spamassassin
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?92e1b8a1");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/stretch/spamassassin");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/spamassassin");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2020/dsa-4615");
