...
# extracted from Red Hat Security Advisory RHSA-2020:4453. The text
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_4453.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e6adb99e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:4453");
...
"Update the RHEL vim package based on the guidance in RHSA-2020:4453.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'vim-common-8.0.1763-15.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'vim-enhanced-8.0.1763-15.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'vim-filesystem-8.0.1763-15.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'vim-minimal-8.0.1763-15.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'vim-X11-8.0.1763-15.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
    ]
  }
];
