...
# extracted from Fedora Security Advisory FEDORA-2019-1ba2a6e386.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-1ba2a6e386");

  script_name(english:"Fedora 31 : crun (2019-1ba2a6e386)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-1ba2a6e386");
...
"Update the affected crun package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-18837");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"crun-0.10.5-2.fc31")) flag++;
