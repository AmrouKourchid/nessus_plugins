...
if (description)
{
  ...
  script_name(english:"RHEL 8 : OpenShift Container Platform 4.6.51 (RHSA-2021:4799)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for OpenShift Container Platform 4.6.51.");
...
referenced in the RHSA-2021:4799 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.6.51. See the following
    ...
    * jenkins: When creating temporary files, permission to create files is
    only checked after theyve been created. (CVE-2021-21693)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_4799.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d66ce138");
...
"Update the RHEL OpenShift Container Platform 4.6.51 packages based on the guidance in RHSA-2021:4799.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jenkins-2-plugins-4.6.1637602169-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2021-21698']},
      {'reference':'jenkins-2.303.3.1637597493-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2021-21685', 'CVE-2021-21686', 'CVE-2021-21687', 'CVE-2021-21688', 'CVE-2021-21689', 'CVE-2021-21690', 'CVE-2021-21691', 'CVE-2021-21692', 'CVE-2021-21693', 'CVE-2021-21694', 'CVE-2021-21695', 'CVE-2021-21696', 'CVE-2021-21697']}
    ]
  }
];
