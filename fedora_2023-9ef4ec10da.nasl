...
# extracted from Fedora Security Advisory FEDORA-2023-9ef4ec10da
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-9ef4ec10da");

  script_name(english:"Fedora 37 : java-17-openjdk (2023-9ef4ec10da)");
...
FEDORA-2023-9ef4ec10da advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-9ef4ec10da");
...
var pkgs = [
    {'reference':'java-17-openjdk-17.0.8.0.7-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
