...
if (description)
{
  ...
  script_name(english:"RHEL 6 : Red Hat Satellite IBM Java Runtime (RHSA-2015:1091)");
...
referenced in the RHSA-2015:1091 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2015/rhsa-2015_1091.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f1b2456e");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2015:1091");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'java-1.6.0-ibm-1.6.0.16.4-1jpp.1.el6_6', 'cpu':'s390x', 'release':'6', 'el_string':'el6_6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.6.0-ibm-1.6.0.16.4-1jpp.1.el6_6', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.6.0-ibm-devel-1.6.0.16.4-1jpp.1.el6_6', 'cpu':'s390x', 'release':'6', 'el_string':'el6_6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.6.0-ibm-devel-1.6.0.16.4-1jpp.1.el6_6', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
