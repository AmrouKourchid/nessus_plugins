...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : qt (EulerOS-SA-2019-2012)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2012
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cb252e3f");
...
pkgs = ["qt-4.8.5-13.h3",
        "qt-devel-4.8.5-13.h3",
        "qt-mysql-4.8.5-13.h3",
        "qt-odbc-4.8.5-13.h3",
        "qt-postgresql-4.8.5-13.h3",
        "qt-x11-4.8.5-13.h3"];
