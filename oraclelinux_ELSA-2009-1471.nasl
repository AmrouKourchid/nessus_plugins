...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : elinks (ELSA-2009-1471)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2009-1471.html");
...
"Update the affected elinks package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2007-2027");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2008-7224");
...
var pkgs = [
    {'reference':'elinks-0.11.1-6.el5_4.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'elinks-0.11.1-6.el5_4.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
