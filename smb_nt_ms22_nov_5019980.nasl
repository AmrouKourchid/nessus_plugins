...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5019980");
  script_xref(name:"MSFT", value:"MS22-5019980");
  ...
  script_name(english:"KB5019980: Windows 11 22H2 Security Update (November 2022)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5019980. It is, therefore, affected by multiple vulnerabilities
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5019980");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5019980");
