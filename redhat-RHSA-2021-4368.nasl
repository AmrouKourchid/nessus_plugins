...
# extracted from Red Hat Security Advisory RHSA-2021:4368. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:4368");

  script_name(english:"RHEL 8 : openssh (RHSA-2021:4368)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for openssh.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2021:4368 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_4368.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d1fc4145");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:4368");
...
"Update the RHEL openssh package based on the guidance in RHSA-2021:4368.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openssh-8.0p1-10.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'openssh-askpass-8.0p1-10.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'openssh-cavs-8.0p1-10.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'openssh-clients-8.0p1-10.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'openssh-keycat-8.0p1-10.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'openssh-ldap-8.0p1-10.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'openssh-server-8.0p1-10.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'pam_ssh_agent_auth-0.10.3-7.10.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
