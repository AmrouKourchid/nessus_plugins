...
# extracted from Red Hat Security Advisory RHSA-2022:7314. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:7314");

  script_name(english:"RHEL 9 : zlib (RHSA-2022:7314)");
...
the RHSA-2022:7314 advisory.
    ...
    * zlib: a heap-based buffer over-read or buffer overflow in inflate in inflate.c via a large gzip header
    extra field (CVE-2022-37434)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_7314.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e2267645");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2116639");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:7314");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL zlib package based on the guidance in RHSA-2022:7314.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'zlib-1.2.11-32.el9_0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'zlib-devel-1.2.11-32.el9_0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'zlib-static-1.2.11-32.el9_0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'zlib-1.2.11-32.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'zlib-devel-1.2.11-32.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'zlib-static-1.2.11-32.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'zlib / zlib-devel / zlib-static');
}
