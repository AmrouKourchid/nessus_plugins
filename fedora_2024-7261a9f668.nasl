...
# extracted from Fedora Security Advisory FEDORA-2024-7261a9f668
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-7261a9f668");

  script_name(english:"Fedora 38 : libebml (2024-7261a9f668)");
...
FEDORA-2024-7261a9f668 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-7261a9f668");
...
var pkgs = [
    {'reference':'libebml-1.4.5-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
