...
# extracted from Red Hat Security Advisory RHSA-2023:1503. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:1503");

  script_name(english:"RHEL 8 : OpenShift Container Platform 4.11.34 (RHSA-2023:1503)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for OpenShift Container Platform 4.11.34.");
...
the RHSA-2023:1503 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.11.34. See the
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2152703");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_1503.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ed404df3");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:1503");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.11.34 packages based on the guidance in RHSA-2023:1503.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cri-o-1.24.4-10.rhaos4.11.git1ed5ac5.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
