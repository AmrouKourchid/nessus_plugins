...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : ImageMagick (EulerOS-SA-2019-1138)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1138
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?30865b18");
...
pkgs = ["ImageMagick-6.7.8.9-15.h19.eulerosv2r7",
        "ImageMagick-c++-6.7.8.9-15.h19.eulerosv2r7",
        "ImageMagick-perl-6.7.8.9-15.h19.eulerosv2r7"];
