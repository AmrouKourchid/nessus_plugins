...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5002028");
  script_xref(name:"MSFT", value:"MS21-5002028");
  script_xref(name:"IAVA", value:"2021-A-0469-S");

  script_name(english:"Security Updates for Microsoft SharePoint Server 2019 (October 2021)");
...
affected by multiple vulnerabilities :
  ...
  - An information disclosure vulnerability. An attacker can exploit this to disclose 
    potentially sensitive information. (CVE-2021-40482)

  - A session spoofing vulnerability exists. An attacker can exploit this to perform 
    actions with the privileges of another user. (CVE-2021-40483, CVE-2021-40484)

  - A remote code execution vulnerability. An attacker can exploit this to bypass 
    authentication and execute unauthorized arbitrary commands. (CVE-2021-40486,
    CVE-2021-40487, CVE-2021-41344)
    
Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version 
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002028");
