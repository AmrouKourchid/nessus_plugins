...
# extracted from Debian Security Advisory DSA-4781. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"4781");

  script_name(english:"Debian DSA-4781-1 : blueman - security update");
...
result in denial of service or privilege escalation.");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/blueman");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/blueman");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2020/dsa-4781");
...
flag = 0;
if (deb_check(release:"10.0", prefix:"blueman", reference:"2.0.8-1+deb10u1")) flag++;
