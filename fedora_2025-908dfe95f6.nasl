...
# extracted from Fedora Security Advisory FEDORA-2025-908dfe95f6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-908dfe95f6");

  script_name(english:"Fedora 41 : buildah / containers-common / podman (2025-908dfe95f6)");
...
FEDORA-2025-908dfe95f6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-908dfe95f6");
...
var pkgs = [
    {'reference':'buildah-1.38.1-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'containers-common-0.61.1-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'epoch':'5'},
    {'reference':'podman-5.3.2-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'epoch':'5'}
];
