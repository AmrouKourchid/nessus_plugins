...
# extracted from Fedora Security Advisory FEDORA-2023-e1ffb79ddf
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-e1ffb79ddf");

  script_name(english:"Fedora 37 : edk2 (2023-e1ffb79ddf)");
...
FEDORA-2023-e1ffb79ddf advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-e1ffb79ddf");
  script_set_attribute(attribute:"solution", value:
"Update the affected edk2 package.");
...
var pkgs = [
    {'reference':'edk2-20221117gitfff6d81270b5-13.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
