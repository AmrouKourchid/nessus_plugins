...
# extracted from Fedora Security Advisory FEDORA-2024-f10a0a02d6
#
...
if (description)
{
  ...
  script_xref(name:"IAVB", value:"2024-B-0018");
  script_xref(name:"FEDORA", value:"2024-f10a0a02d6");

  script_name(english:"Fedora 41 : age (2024-f10a0a02d6)");
...
FEDORA-2024-f10a0a02d6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-f10a0a02d6");
  script_set_attribute(attribute:"solution", value:
"Update the affected age package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:age");
...
var pkgs = [
    {'reference':'age-1.2.0-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'age');
}
