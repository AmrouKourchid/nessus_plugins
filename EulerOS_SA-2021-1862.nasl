...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : xerces-c (EulerOS-SA-2021-1862)");
...
vulnerability :
  ...
  - The Apache Xerces-C 3.0.0 to 3.2.3 XML parser contains
    a use-after-free error triggered during the scanning of
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1862
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?126b4ef3");
