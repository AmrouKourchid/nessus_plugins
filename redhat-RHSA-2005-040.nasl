...
"The remote Red Hat host is missing one or more security updates for enscript.");
...
referenced in the RHSA-2005:040 advisory.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2005/rhsa-2005_040.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?32bbe699");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=144686");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2005:040");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL enscript package based on the guidance in RHSA-2005:040.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:L/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2004-1185");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2004-1186");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'enscript-1.6.1-28.3', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'enscript-1.6.1-28.3', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'enscript-1.6.1-28.3', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'enscript-1.6.1-28.3', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'enscript-1.6.1-28.3', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
