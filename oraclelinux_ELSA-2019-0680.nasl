...
# Oracle Linux Security Advisory ELSA-2019-0680 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : thunderbird (ELSA-2019-0680)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2019-0680.html");
...
var pkgs = [
    {'reference':'thunderbird-60.6.1-1.0.1.el6_10', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
