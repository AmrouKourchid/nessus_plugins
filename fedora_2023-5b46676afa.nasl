...
# extracted from Fedora Security Advisory FEDORA-2023-5b46676afa
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-5b46676afa");

  script_name(english:"Fedora 38 : chromium (2023-5b46676afa)");
...
FEDORA-2023-5b46676afa advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-5b46676afa");
...
var pkgs = [
    {'reference':'chromium-119.0.6045.159-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
