...
# extracted from Fedora Security Advisory FEDORA-2024-74563262c0
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-74563262c0");

  script_name(english:"Fedora 39 : cjson (2024-74563262c0)");
...
FEDORA-2024-74563262c0 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-74563262c0");
...
var pkgs = [
    {'reference':'cjson-1.7.17-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
