...
# extracted from Red Hat Security Advisory RHSA-2024:9573. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:9573");

  script_name(english:"RHEL 8 : libsoup (RHSA-2024:9573)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for libsoup.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:9573 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_9573.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5d0bd569");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:9573");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libsoup package based on the guidance in RHSA-2024:9573.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libsoup-2.62.3-6.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsoup-devel-2.62.3-6.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
