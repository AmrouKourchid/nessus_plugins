...
# extracted from Fedora Security Advisory FEDORA-2019-0ea42f074e.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2019-10871", "CVE-2019-10872", "CVE-2019-12293");
  script_xref(name:"FEDORA", value:"2019-0ea42f074e");

  script_name(english:"Fedora 29 : poppler (2019-0ea42f074e)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-0ea42f074e");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"poppler-0.67.0-21.fc29")) flag++;
