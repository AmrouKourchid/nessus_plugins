...
# extracted from openSUSE Security Update openSUSE-2019-1708.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libu2f-host / pam_u2f (openSUSE-2019-1708)");
...
This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1128140");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1135727");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1135729");
  script_set_attribute(attribute:"solution", value:
"Update the affected libu2f-host / pam_u2f packages.");
...
if ( rpm_check(release:"SUSE15.1", reference:"libu2f-host-debuginfo-1.1.6-lp151.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libu2f-host-debugsource-1.1.6-lp151.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libu2f-host-devel-1.1.6-lp151.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libu2f-host0-1.1.6-lp151.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libu2f-host0-debuginfo-1.1.6-lp151.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"pam_u2f-1.0.8-lp151.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"pam_u2f-debuginfo-1.0.8-lp151.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"pam_u2f-debugsource-1.0.8-lp151.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"u2f-host-1.1.6-lp151.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"u2f-host-debuginfo-1.1.6-lp151.2.6.1") ) flag++;
