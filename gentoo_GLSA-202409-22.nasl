...
# extracted from Gentoo Linux Security Advisory GLSA 202409-22.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202409-22 : GCC: Flawed Code Generation");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202409-22 (GCC: Flawed Code Generation)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202409-22");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=719466");
...
In this case, users should also rebuild all affected packages with emerge -e, e.g.:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:gcc");
...
var packages = [
  {
    'name' : 'sys-devel/gcc',
    'unaffected' : make_list("ge 10.0"),
    'vulnerable' : make_list("lt 10.0")
  }
];
