...
# extracted from Fedora Security Advisory FEDORA-2023-3388038193
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-3388038193");

  script_name(english:"Fedora 37 : libwebp (2023-3388038193)");
...
FEDORA-2023-3388038193 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-3388038193");
  script_set_attribute(attribute:"solution", value:
"Update the affected libwebp package.");
...
var pkgs = [
    {'reference':'libwebp-1.3.1-3.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
