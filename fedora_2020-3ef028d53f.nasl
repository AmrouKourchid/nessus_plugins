...
# extracted from Fedora Security Advisory FEDORA-2020-3ef028d53f.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-3ef028d53f");

  script_name(english:"Fedora 31 : transmission (2020-3ef028d53f)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-3ef028d53f");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"transmission-2.94-9.fc31")) flag++;
