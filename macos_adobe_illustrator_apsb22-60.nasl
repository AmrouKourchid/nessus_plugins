...
if (description)
{
  ...
  script_name(english:"Adobe Illustrator < 26.5.2 / 27.0.0 < 27.0.1 Multiple Memory leak (APSB22-60) (macOS)");

  script_set_attribute(attribute:"synopsis", value:
"The Adobe Illustrator instance installed on the remote host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Illustrator installed on the remote macOS host is prior to 26.5.2, 27.0.1. It is, therefore,
affected by multiple vulnerabilities as referenced in the APSB22-60 advisory.

  - Adobe Illustrator versions 26.5.1 (and earlier), and 27.0 (and earlier) are affected by an out-of-bounds
    ...
    that a victim must open a malicious file. (CVE-2022-44498, CVE-2022-44499, CVE-2022-44500, CVE-2022-44502)
...
"Upgrade to Adobe Illustrator version 26.5.2, 27.0.1 or later.");
...
var constraints = [
  { 'fixed_version' : '26.5.2' },
  { 'min_version' : '27.0.0', 'fixed_version' : '27.0.1' }
];
