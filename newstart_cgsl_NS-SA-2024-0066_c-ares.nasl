...
if (description)
{
  ...
  script_cve_id("CVE-2021-3672", "CVE-2023-32067");

  script_name(english:"NewStart CGSL MAIN 6.02 : c-ares Multiple Vulnerabilities (NS-SA-2024-0066)");

  script_set_attribute(attribute:"synopsis", value:
"The remote NewStart CGSL host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 6.02, has c-ares packages installed that are affected by multiple
vulnerabilities:
  ...
  - A vulnerability was found in c-ares. This issue occurs due to a 0-byte UDP payload that can cause a Denial
    of Service. (CVE-2023-32067)

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/notice/NS-SA-2024-0066");
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/info/CVE-2021-3672");
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/info/CVE-2023-32067");
  script_set_attribute(attribute:"solution", value:
"Upgrade the vulnerable CGSL c-ares packages. Note that updated packages may not be available yet. Please contact ZTE for
more information.");
