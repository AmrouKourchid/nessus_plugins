...
if (description)
{
  ...
  script_cve_id("CVE-2024-53086");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-53086");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: drm/xe: Drop VM dma-resv lock on
    xe_sync_in_fence_get failure in exec IOCTL Upon failure all locks need to be dropped before returning to
    the user. (cherry picked from commit 7d1a4258e602ffdce529f56686925034c1b3b095) (CVE-2024-53086)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-53086");
