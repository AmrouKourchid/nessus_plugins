...
# Rocky Linux Security Advisory RLSA-2023:5689.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2023:5689");
  script_xref(name:"IAVA", value:"2023-A-0500-S");

  script_name(english:"Rocky Linux 9 : bind (RLSA-2023:5689)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2023:5689");
...
var pkgs = [
    ...
    {'reference':'bind-debuginfo-9.16.23-11.el9_2.2', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
    {'reference':'bind-debugsource-9.16.23-11.el9_2.2', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
    ...
    {'reference':'bind-dnssec-utils-debuginfo-9.16.23-11.el9_2.2', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
    ...
    {'reference':'bind-libs-debuginfo-9.16.23-11.el9_2.2', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
    ...
    {'reference':'bind-utils-debuginfo-9.16.23-11.el9_2.2', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
