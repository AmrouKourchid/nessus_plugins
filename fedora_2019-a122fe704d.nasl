...
# extracted from Fedora Security Advisory FEDORA-2019-a122fe704d.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-a122fe704d");

  script_name(english:"Fedora 30 : python3 (2019-a122fe704d)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-a122fe704d");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"python3-3.7.2-8.fc30")) flag++;
