...
# extracted from Red Hat Security Advisory RHSA-2025:3336. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:3336");

  script_name(english:"RHEL 9 : podman (RHSA-2025:3336)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c2bfd21b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:3336");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL podman package based on the guidance in RHSA-2025:3336.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'podman-5.2.2-15.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
      {'reference':'podman-docker-5.2.2-15.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
      {'reference':'podman-plugins-5.2.2-15.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
      {'reference':'podman-remote-5.2.2-15.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
      {'reference':'podman-tests-5.2.2-15.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'}
    ]
  }
];
