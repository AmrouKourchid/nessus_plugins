...
unsanitized user input.");
  script_set_attribute(attribute:"see_also", value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=931932");
  # https://security-tracker.debian.org/tracker/source-package/ruby-mini-magick
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0f716220");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/stretch/ruby-mini-magick");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/ruby-mini-magick");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2019/dsa-4481");
...
version 4.9.2-1+deb10u1.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-13574");
