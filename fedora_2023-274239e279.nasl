...
# extracted from Fedora Security Advisory FEDORA-2023-274239e279
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-274239e279");

  script_name(english:"Fedora 37 : chromium (2023-274239e279)");
...
FEDORA-2023-274239e279 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-274239e279");
...
var pkgs = [
    {'reference':'chromium-117.0.5938.149-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
