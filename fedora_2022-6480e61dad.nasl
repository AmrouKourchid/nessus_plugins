...
# extracted from Fedora Security Advisory FEDORA-2022-6480e61dad
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-6480e61dad");

  script_name(english:"Fedora 37 : grafana (2022-6480e61dad)");
...
FEDORA-2022-6480e61dad advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-6480e61dad");
...
var pkgs = [
    {'reference':'grafana-9.0.2-3.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
