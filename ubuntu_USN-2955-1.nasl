...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS : Oxide vulnerabilities (USN-2955-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 14.04 LTS / 16.04 LTS host has packages installed that are affected by multiple vulnerabilities as
referenced in the USN-2955-1 advisory.

    A use-after-free was discovered when responding synchronously to permission requests. An attacker could
    potentially exploit this to cause a denial of service via application crash, or execute arbitrary code
    with the privileges of the user invoking the program. (CVE-2016-1578)

    An out-of-bounds read was discovered in V8. If a user were tricked in to opening a specially crafted
    website, an attacker could potentially exploit this to cause a denial of service via renderer crash.
    (CVE-2016-1646)

    A use-after-free was discovered in the navigation implementation in Chromium in some circumstances. If a
    ...
    invoking the program. (CVE-2016-1647)

    A buffer overflow was discovered in ANGLE. If a user were tricked in to opening a specially crafted
    website, an attacker could potentially exploit this to cause a denial of service via application crash, or
    execute arbitrary code with the privileges of the user invoking the program. (CVE-2016-1649)

    An out-of-bounds write was discovered in V8. If a user were tricked in to opening a specially crafted
    website, an attacker could potentially exploit this to cause a denial of service via renderer crash, or
    execute arbitrary code with the privileges of the sandboxed renderer process. (CVE-2016-1653)

    An invalid read was discovered in the media subsystem in Chromium. If a user were tricked in to opening a
    ...
    It was discovered that frame removal during callback execution could trigger a use-after-free in Blink. If
    a user were tricked in to opening a specially crafted website, an attacker could potentially exploit this
    to cause a denial of service via renderer crash, or execute arbitrary code with the privileges of the
    sandboxed renderer process. (CVE-2016-1655)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2955-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'liboxideqt-qmlplugin', 'pkgver': '1.14.7-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'liboxideqtcore-dev', 'pkgver': '1.14.7-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'liboxideqtcore0', 'pkgver': '1.14.7-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'liboxideqtquick-dev', 'pkgver': '1.14.7-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'liboxideqtquick0', 'pkgver': '1.14.7-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'oxideqmlscene', 'pkgver': '1.14.7-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'oxideqt-chromedriver', 'pkgver': '1.14.7-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'oxideqt-codecs', 'pkgver': '1.14.7-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'oxideqt-codecs-extra', 'pkgver': '1.14.7-0ubuntu0.14.04.1'},
    {'osver': '16.04', 'pkgname': 'liboxideqt-qmlplugin', 'pkgver': '1.14.7-0ubuntu1'},
    {'osver': '16.04', 'pkgname': 'liboxideqtcore-dev', 'pkgver': '1.14.7-0ubuntu1'},
    {'osver': '16.04', 'pkgname': 'liboxideqtcore0', 'pkgver': '1.14.7-0ubuntu1'},
    {'osver': '16.04', 'pkgname': 'liboxideqtquick-dev', 'pkgver': '1.14.7-0ubuntu1'},
    {'osver': '16.04', 'pkgname': 'liboxideqtquick0', 'pkgver': '1.14.7-0ubuntu1'},
    {'osver': '16.04', 'pkgname': 'oxideqt-codecs', 'pkgver': '1.14.7-0ubuntu1'},
    {'osver': '16.04', 'pkgname': 'oxideqt-codecs-extra', 'pkgver': '1.14.7-0ubuntu1'}
];
