...
# extracted from Fedora Security Advisory FEDORA-2024-e83af0855e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-e83af0855e");

  script_name(english:"Fedora 39 : httpd (2024-e83af0855e)");
...
FEDORA-2024-e83af0855e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-e83af0855e");
...
var pkgs = [
    {'reference':'httpd-2.4.62-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
