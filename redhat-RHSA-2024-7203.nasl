...
# extracted from Red Hat Security Advisory RHSA-2024:7203. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:7203");

  script_name(english:"RHEL 9 : git-lfs (RHSA-2024:7203)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_7203.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?80c23060");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:7203");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL git-lfs package based on the guidance in RHSA-2024:7203.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'git-lfs-3.2.0-2.el9_2.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
