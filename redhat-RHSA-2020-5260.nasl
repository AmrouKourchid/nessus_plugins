...
# extracted from Red Hat Security Advisory RHSA-2020:5260. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2020-8563");
  script_xref(name:"RHSA", value:"2020:5260");

  script_name(english:"RHEL 7 / 8 : OpenShift Container Platform 4.6.8 (RHSA-2020:5260)");
...
in the RHSA-2020:5260 advisory.
    ...
    * kubernetes: Secret leaks in kube-controller-manager when using vSphere Provider (CVE-2020-8563)
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.6.8. See the following
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_5260.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3117cf06");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:5260");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1886635");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1902559");
...
"Update the affected openshift-hyperkube package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-8563");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openshift-hyperkube-4.6.0-202012051246.p0.git.94231.efc9027.el8', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'openshift-hyperkube-4.6.0-202012051246.p0.git.94231.efc9027.el8', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'openshift-hyperkube-4.6.0-202012051246.p0.git.94231.efc9027.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'openshift-hyperkube-4.6.0-202012051246.p0.git.94231.efc9027.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
