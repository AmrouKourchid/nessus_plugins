...
# extracted from SUSE update advisory SUSE-SU-2020:3107-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : liblouis (SUSE-SU-2020:3107-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"This update for liblouis, python-luis and python3-louis fixes the
following issue :
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?281fed85");
...
zypper in -t patch SUSE-SLE-SDK-12-SP5-2020-3107=1

SUSE Linux Enterprise Server 12-SP5 :

zypper in -t patch SUSE-SLE-SERVER-12-SP5-2020-3107=1");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:N/I:N/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:R/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-17294");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"5", reference:"liblouis-data-2.6.4-6.9.24")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"liblouis-debugsource-2.6.4-6.9.24")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"liblouis9-2.6.4-6.9.24")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"liblouis9-debuginfo-2.6.4-6.9.24")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"python-louis-2.6.4-6.9.39")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"python3-louis-2.6.4-6.9.41")) flag++;
