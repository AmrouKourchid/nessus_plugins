...
if (description)
{
  ...
  script_cve_id("CVE-2024-50564");
  script_xref(name:"IAVA", value:"2024-A-0742-S");

  script_name(english:"Fortinet FortiClient Hardcoded Encryption Key Used for Named Pipe Communication (FG-IR-24-216)");
...
vulnerability as referenced in the FG-IR-24-216 advisory.

  - Threat actors can gain access to a plain text encryption key that is saved as part of the FortiClient
    services executable files. Accessing this results in the decryption of sensitive information.
    (CVE-2024-50564)

  - A use of hard-coded cryptographic key in Fortinet FortiClientWindows version 7.4.0, 7.2.x all versions,
    7.0.x all versions, and 6.4.x all versions may allow a low-privileged user to decrypt interprocess
    communication via monitoring named piped. (CVE-2024-50564)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.fortiguard.com/psirt/FG-IR-24-216");
  script_set_attribute(attribute:"solution", value:
"For 6.4.x / 7.0.x, see vendor advisory. For 7.2.x, upgrade to FortiClient version 7.2.9 or later. For 7.4.x, upgrade to
FortiClient version 7.4.1 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-50564");
