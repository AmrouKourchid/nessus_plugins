...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : exim (ELSA-2010-0970)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2010-0970.html");
  script_set_attribute(attribute:"solution", value:
"Update the affected exim, exim-mon and / or exim-sa packages.");
...
var pkgs = [
    {'reference':'exim-4.63-5.el5_5.2', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'exim-mon-4.63-5.el5_5.2', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'exim-sa-4.63-5.el5_5.2', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'exim-4.63-5.el5_5.2', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'exim-mon-4.63-5.el5_5.2', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'exim-sa-4.63-5.el5_5.2', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'exim / exim-mon / exim-sa');
}
