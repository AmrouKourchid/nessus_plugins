...
"The remote Red Hat host is missing a security update for jakarta-taglibs-standard.");
...
in the RHSA-2015:1695 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e4335d89");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/solutions/1584363");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1198606");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2015:1695");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL jakarta-taglibs-standard packages based on the guidance in RHSA-2015:1695.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jakarta-taglibs-standard-1.1.2-14.el7_1', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'jakarta-taglibs-standard-javadoc-1.1.2-14.el7_1', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'jakarta-taglibs-standard-1.1.2-14.ael7b_1', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'el_string': 'ael7b_1'},
      {'reference':'jakarta-taglibs-standard-javadoc-1.1.2-14.ael7b_1', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'el_string': 'ael7b_1'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'jakarta-taglibs-standard-1.1.1-11.7.el6_7', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'jakarta-taglibs-standard-javadoc-1.1.1-11.7.el6_7', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
