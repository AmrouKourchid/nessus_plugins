...
# extracted from Fedora Security Advisory FEDORA-2024-b15a51292f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-b15a51292f");

  script_name(english:"Fedora 39 : libarchive (2024-b15a51292f)");
...
FEDORA-2024-b15a51292f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-b15a51292f");
...
var pkgs = [
    {'reference':'libarchive-3.7.1-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
