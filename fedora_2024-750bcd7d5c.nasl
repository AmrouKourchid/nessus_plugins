...
# extracted from Fedora Security Advisory FEDORA-2024-750bcd7d5c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-750bcd7d5c");

  script_name(english:"Fedora 41 : python3.12 (2024-750bcd7d5c)");
...
FEDORA-2024-750bcd7d5c advisory.
    ...
    ```
    * Wed Aug  7 2024 Tom Hrniar <thrnciar@redhat.com> - 3.12.5-1
    - Update to 3.12.5
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-750bcd7d5c");
...
var pkgs = [
    {'reference':'python3.12-3.12.5-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
