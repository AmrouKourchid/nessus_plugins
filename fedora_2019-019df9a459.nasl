...
# extracted from Fedora Security Advisory FEDORA-2019-019df9a459.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-019df9a459");

  script_name(english:"Fedora 31 : 2:dpdk (2019-019df9a459)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-019df9a459");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"dpdk-18.11.2-3.fc31", epoch:"2")) flag++;
