...
# extracted from Fedora Security Advisory FEDORA-2023-da094276a2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-da094276a2");

  script_name(english:"Fedora 39 : python-oauthlib (2023-da094276a2)");
...
FEDORA-2023-da094276a2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-da094276a2");
...
var pkgs = [
    {'reference':'python-oauthlib-3.2.2-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
