...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : xz (EulerOS-SA-2022-1775)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1775
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5c1eefc4");
...
var pkgs = [
  "xz-5.1.2-12alpha.h1",
  "xz-devel-5.1.2-12alpha.h1",
  "xz-libs-5.1.2-12alpha.h1"
];
