...
# extracted from Fedora Security Advisory FEDORA-2023-c41e8f24bb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-c41e8f24bb");

  script_name(english:"Fedora 36 : tigervnc (2023-c41e8f24bb)");
...
FEDORA-2023-c41e8f24bb advisory.

    Tigervnc 1.13.1 update.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-c41e8f24bb");
...
var pkgs = [
    {'reference':'tigervnc-1.13.1-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
