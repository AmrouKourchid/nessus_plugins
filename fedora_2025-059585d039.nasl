...
# extracted from Fedora Security Advisory FEDORA-2025-059585d039
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-059585d039");

  script_name(english:"Fedora 41 : webkitgtk (2025-059585d039)");
...
FEDORA-2025-059585d039 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-059585d039");
...
"Update the affected webkitgtk package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-24208");
...
var pkgs = [
    {'reference':'webkitgtk-2.48.1-2.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
