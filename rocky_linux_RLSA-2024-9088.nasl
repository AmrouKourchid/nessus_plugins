...
# Rocky Linux Security Advisory RLSA-2024:9088.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2024:9088");

  script_name(english:"RockyLinux 9 : edk2 (RLSA-2024:9088)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2024:9088");
