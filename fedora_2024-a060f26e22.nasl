...
# extracted from Fedora Security Advisory FEDORA-2024-a060f26e22
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-a060f26e22");
  script_xref(name:"IAVA", value:"2024-A-0465-S");

  script_name(english:"Fedora 40 : thunderbird (2024-a060f26e22)");
...
FEDORA-2024-a060f26e22 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-a060f26e22");
...
var pkgs = [
    {'reference':'thunderbird-115.14.0-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
