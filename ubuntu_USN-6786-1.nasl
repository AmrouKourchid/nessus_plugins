...
# extracted from Ubuntu Security Notice USN-6786-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6786-1");

  script_name(english:"Ubuntu 20.04 LTS / 22.04 LTS : Netatalk vulnerabilities (USN-6786-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6786-1");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'netatalk', 'pkgver': '3.1.12~ds-4ubuntu0.20.04.3+esm1', 'ubuntu_pro': TRUE},
    {'osver': '22.04', 'pkgname': 'netatalk', 'pkgver': '3.1.12~ds-9ubuntu0.22.04.3+esm1', 'ubuntu_pro': TRUE}
];
