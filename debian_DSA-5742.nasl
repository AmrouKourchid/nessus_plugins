...
# extracted from Debian Security Advisory dsa-5742. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5742 : odoo-14 - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has a package installed that is affected by a vulnerability as referenced in the dsa-5742
advisory.
...
var pkgs = [
    {'release': '11.0', 'prefix': 'odoo-14', 'reference': '14.0.0+dfsg.2-7+deb11u2'}
];
