...
# extracted from Red Hat Security Advisory RHSA-2023:7438. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:7438");

  script_name(english:"RHEL 9 : Red Hat OpenStack Platform 17.1.1 (python-gevent) (RHSA-2023:7438)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for Red Hat OpenStack Platform 17.1.1 (python-gevent).");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_7438.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b0433f47");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2240651");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:7438");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat OpenStack Platform 17.1.1 (python-gevent) package based on the guidance in RHSA-2023:7438.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-gevent-21.1.2-2.el9ost', 'cpu':'x86_64', 'release':'9', 'el_string':'el9ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
