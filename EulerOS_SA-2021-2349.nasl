...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : spice (EulerOS-SA-2021-2349)");
...
vulnerability :
  ...
  - A flaw was found in spice in versions before 0.14.92. A
    DoS tool might make it easier for remote attackers to
    cause a denial of service (CPU consumption) by
    performing many renegotiations within a single
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2349
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?417c2ab9");
...
pkgs = ["spice-server-0.14.0-6.1.h2.eulerosv2r7"];
