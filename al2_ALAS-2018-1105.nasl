...
# extracted from Amazon Linux 2 Security Advisory ALAS-2018-1105.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2018-1105");

  script_name(english:"Amazon Linux 2 : tomcat (ALAS-2018-1105)");
...
causing a Denial of Service.(CVE-2018-1336)");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2018-1105.html");
...
flag = 0;
if (rpm_check(release:"AL2", reference:"tomcat-7.0.76-8.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"tomcat-admin-webapps-7.0.76-8.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"tomcat-docs-webapp-7.0.76-8.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"tomcat-el-2.2-api-7.0.76-8.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"tomcat-javadoc-7.0.76-8.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"tomcat-jsp-2.2-api-7.0.76-8.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"tomcat-jsvc-7.0.76-8.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"tomcat-lib-7.0.76-8.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"tomcat-servlet-3.0-api-7.0.76-8.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"tomcat-webapps-7.0.76-8.amzn2")) flag++;
