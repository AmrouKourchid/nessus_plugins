...
# extracted from Red Hat Security Advisory audiofile. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 4 : audiofile (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2008-5824");
