...
# extracted from Red Hat Security Advisory openstack-swift-plugin-swift3. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 6 : openstack-swift-plugin-swift3 (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-8466");
