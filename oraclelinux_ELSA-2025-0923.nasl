...
# extracted from Oracle Linux Security Advisory ELSA-2025-0923.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : buildah (ELSA-2025-0923)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2025-0923.html");
...
var pkgs = [
    {'reference':'buildah-1.37.6-1.0.1.el9_5', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'buildah-tests-1.37.6-1.0.1.el9_5', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'buildah-1.37.6-1.0.1.el9_5', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'buildah-tests-1.37.6-1.0.1.el9_5', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
