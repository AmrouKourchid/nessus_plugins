...
if (description)
{
  ...
  script_name(english:"QNAP QTS / QuTS hero Information Disclosure (QSA-23-58)");

  script_set_attribute(attribute:"synopsis", value:
"The remote device is missing a vendor-supplied security patch.");
  script_set_attribute(attribute:"description", value:
"The version of QNAP QTS / QuTS hero installed on the remote host is affected by an information disclosure vulnerability
as referenced in the QSA-23-58 advisory. A cleartext transmission of sensitive information vulnerability has been
reported to affect QNAP operating systems. If exploited, the vulnerability possibly allows local network clients to read
the contents of unexpected sensitive data via unspecified vectors.
...
"Apply the solution referenced in the QSA-23-58 advisory");
...
var constraints = [
  { 'min_version' : '5.0.1', 'max_version' : '5.0.1', 'product' : 'QTS', 'fixed_display' : 'QTS 5.0.1.2425 build 20230609', 'Number' : '2425', 'Build' : '20230609' },
