...
if (description)
{
  ...
  script_name(english:"PHP 5.4.x < 5.4.17 Buffer Overflow");
...
but instead, relies only on PHP's self-reported version number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.php.net/ChangeLog-5.php#5.4.17");
