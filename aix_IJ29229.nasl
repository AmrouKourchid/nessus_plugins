...
if (description)
{
  ...
  script_name(english:"AIX 7.2 TL 3 : bind (IJ29229)");
  script_summary(english:"Check for APAR IJ29229");
...
if (aix_check_ifix(release:"7.2", ml:"03", sp:"03", patch:"IJ29229m5a", package:"bos.net.tcp.bind_utils", minfilesetver:"7.2.3.0", maxfilesetver:"7.2.3.16") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"03", sp:"04", patch:"IJ29229m5a", package:"bos.net.tcp.bind_utils", minfilesetver:"7.2.3.0", maxfilesetver:"7.2.3.16") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"03", sp:"05", patch:"IJ29229m5a", package:"bos.net.tcp.bind_utils", minfilesetver:"7.2.3.0", maxfilesetver:"7.2.3.16") < 0) flag++;
