...
# extracted from Red Hat Security Advisory RHSA-2024:2276. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2276");

  script_name(english:"RHEL 9 : qt5-qtbase (RHSA-2024:2276)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for qt5-qtbase.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:2276 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2276.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?82263e82");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2276");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2255856");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2264423");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL qt5-qtbase package based on the guidance in RHSA-2024:2276.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'qt5-qtbase-5.15.9-9.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'qt5-qtbase-common-5.15.9-9.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'qt5-qtbase-devel-5.15.9-9.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'qt5-qtbase-examples-5.15.9-9.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'qt5-qtbase-gui-5.15.9-9.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'qt5-qtbase-mysql-5.15.9-9.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'qt5-qtbase-odbc-5.15.9-9.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'qt5-qtbase-postgresql-5.15.9-9.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'qt5-qtbase-private-devel-5.15.9-9.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'qt5-qtbase-static-5.15.9-9.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
