...
if (description)
{
  ...
  script_name(english:"Microsoft Windows Defender Elevation of Privilege Vulnerability (CVE-2020-1163 & CVE-2020-1170)");
...
"The version of Microsoft Windows Defender component MpCmdRun.exe installed on the remote Windows host
is prior to 4.18.2005.1. It is, therefore, affected by a elevation of privilege vulnerability which could allow an
attacker who successfully exploited this vulnerability to elevate privileges on the system.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?949ab302");
  # https://portal.msrc.microsoft.com/en-US/security-guidance/advisory/CVE-2020-1170
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?32b38eb5");
...
Article 2510781 for information on how to verify that MMPE has been updated.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-1170");
...
constraints = [{'max_version': '4.18.2004.6', 'fixed_version':'4.18.2005.1'}];
