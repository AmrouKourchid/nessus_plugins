...
# extracted from Ubuntu Security Notice USN-4039-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"4039-1");

  script_name(english:"Ubuntu 18.04 LTS : CImg vulnerabilities (USN-4039-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4039-1");
...
"Update the affected cimg-dev and / or cimg-examples packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-7589");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'cimg-dev', 'pkgver': '1.7.9+dfsg-2ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'cimg-examples', 'pkgver': '1.7.9+dfsg-2ubuntu0.18.04.1'}
];
