...
# extracted from Debian Security Advisory dla-3939. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2022-24439", "CVE-2023-40267", "CVE-2023-41040");

  script_name(english:"Debian dla-3939 : python-git-doc - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-40267");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-41040");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bullseye/python-git");
  script_set_attribute(attribute:"solution", value:
"Upgrade the python-git-doc packages.");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'python-git-doc', 'reference': '3.1.14-1+deb11u1'},
    {'release': '11.0', 'prefix': 'python3-git', 'reference': '3.1.14-1+deb11u1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python-git-doc / python3-git');
}
