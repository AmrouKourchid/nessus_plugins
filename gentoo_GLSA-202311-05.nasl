...
# extracted from Gentoo Linux Security Advisory GLSA 202311-05.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202311-05 : LinuxCIFS utils: Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202311-05 (LinuxCIFS utils: Multiple Vulnerabilities)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202311-05");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=842234");
...
var packages = [
  {
    ...
    'unaffected' : make_list("ge 6.15"),
    'vulnerable' : make_list("lt 6.15")
  }
];
