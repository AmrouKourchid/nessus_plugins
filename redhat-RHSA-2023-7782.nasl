...
# extracted from Red Hat Security Advisory RHSA-2023:7782. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:7782");

  script_name(english:"RHEL 7 : linux-firmware (RHSA-2023:7782)");
...
referenced in the RHSA-2023:7782 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_7782.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7aa46df4");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:7782");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL linux-firmware package based on the guidance in RHSA-2023:7782.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'iwl100-firmware-39.31.5.1-69.2.el7_6', 'sp':'6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'iwl1000-firmware-39.31.5.1-69.2.el7_6', 'sp':'6', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'iwl105-firmware-18.168.6.1-69.2.el7_6', 'sp':'6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'iwl135-firmware-18.168.6.1-69.2.el7_6', 'sp':'6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'iwl2000-firmware-18.168.6.1-69.2.el7_6', 'sp':'6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'iwl2030-firmware-18.168.6.1-69.2.el7_6', 'sp':'6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'iwl3160-firmware-22.0.7.0-69.2.el7_6', 'sp':'6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'iwl3945-firmware-15.32.2.9-69.2.el7_6', 'sp':'6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'iwl4965-firmware-228.61.2.24-69.2.el7_6', 'sp':'6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'iwl5000-firmware-8.83.5.1_1-69.2.el7_6', 'sp':'6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'iwl5150-firmware-8.24.2.2-69.2.el7_6', 'sp':'6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'iwl6000-firmware-9.221.4.1-69.2.el7_6', 'sp':'6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'iwl6000g2a-firmware-17.168.5.3-69.2.el7_6', 'sp':'6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'iwl6000g2b-firmware-17.168.5.2-69.2.el7_6', 'sp':'6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'iwl6050-firmware-41.28.5.1-69.2.el7_6', 'sp':'6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'iwl7260-firmware-22.0.7.0-69.2.el7_6', 'sp':'6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'iwl7265-firmware-22.0.7.0-69.2.el7_6', 'sp':'6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'linux-firmware-20180911-69.2.git85c5d90.el7_6', 'sp':'6', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
