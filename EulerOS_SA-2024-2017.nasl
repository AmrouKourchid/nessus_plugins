...
if (description)
{
  ...
  script_cve_id("CVE-2024-24474");

  script_name(english:"EulerOS Virtualization 2.12.1 : qemu (EulerOS-SA-2024-2017)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2017
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ec3b110e");
...
"Update the affected qemu packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-24474");
...
var pkgs = [
  "qemu-6.2.0.oe2203sp1-2.12.0.5.324"
];
