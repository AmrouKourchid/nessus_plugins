...
# extracted from VMware Security Advisory PHSA-2022-4.0-0227. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Libxml2 PHSA-2022-4.0-0227");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the libxml2 package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-227.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libxml2-2.9.12-5.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libxml2-devel-2.9.12-5.ph4')) flag++;
