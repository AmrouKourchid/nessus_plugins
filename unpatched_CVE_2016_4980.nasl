...
if (description)
{
  ...
  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2016-4980");
...
patch available.
  ...
  - A password generation weakness exists in xquest through 2016-06-13. (CVE-2016-4980)
