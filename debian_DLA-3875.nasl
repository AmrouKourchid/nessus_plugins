...
# extracted from Debian Security Advisory dla-3875. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3875 : gnutls-bin - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-28834");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-28835");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'gnutls-bin', 'reference': '3.7.1-5+deb11u6'},
    {'release': '11.0', 'prefix': 'gnutls-doc', 'reference': '3.7.1-5+deb11u6'},
    {'release': '11.0', 'prefix': 'guile-gnutls', 'reference': '3.7.1-5+deb11u6'},
    {'release': '11.0', 'prefix': 'libgnutls-dane0', 'reference': '3.7.1-5+deb11u6'},
    {'release': '11.0', 'prefix': 'libgnutls-openssl27', 'reference': '3.7.1-5+deb11u6'},
    {'release': '11.0', 'prefix': 'libgnutls28-dev', 'reference': '3.7.1-5+deb11u6'},
    {'release': '11.0', 'prefix': 'libgnutls30', 'reference': '3.7.1-5+deb11u6'},
    {'release': '11.0', 'prefix': 'libgnutlsxx28', 'reference': '3.7.1-5+deb11u6'}
];
