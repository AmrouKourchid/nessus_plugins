...
# AlmaLinux Security Advisory ALSA-2023:0288.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:0288");
  script_xref(name:"IAVA", value:"2022-A-0517-S");
  script_xref(name:"IAVA", value:"2023-A-0048-S");

  script_name(english:"AlmaLinux 8 : firefox (ALSA-2023:0288)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2023-0288.html");
...
var pkgs = [
    {'reference':'firefox-102.7.0-1.el8_7.alma', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-102.7.0-1.el8_7.alma', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
