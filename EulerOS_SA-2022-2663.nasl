...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : python-lxml (EulerOS-SA-2022-2663)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2663
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c10f37a3");
...
"Update the affected python-lxml packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:python-lxml-help");
...
var pkgs = [
  "python-lxml-help-4.5.2-2.h8.eulerosv2r10"
];
