...
# extracted from Red Hat Security Advisory RHSA-2021:5014. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : firefox (RHSA-2021:5014)");
...
referenced in the RHSA-2021:5014 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_5014.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?87c45384");
...
"Update the RHEL firefox package based on the guidance in RHSA-2021:5014.");
  ...
  script_cwe_id(79, 120, 209, 416, 428, 835, 1021);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-91.4.0-1.el7_9', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-91.4.0-1.el7_9', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-91.4.0-1.el7_9', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-91.4.0-1.el7_9', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-91.4.0-1.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
