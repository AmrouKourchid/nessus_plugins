...
# extracted from openSUSE Security Update openSUSE-2019-176.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : spice (openSUSE-2019-176)");
...
project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1122706");
...
if ( rpm_check(release:"SUSE42.3", reference:"libspice-server-devel-0.12.8-13.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libspice-server1-0.12.8-13.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libspice-server1-debuginfo-0.12.8-13.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"spice-debugsource-0.12.8-13.1") ) flag++;
