...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : libxkbcommon (EulerOS-SA-2019-2540)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2540
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4d62f586");
...
pkgs = ["libxkbcommon-0.7.1-1.h1.eulerosv2r7",
        "libxkbcommon-devel-0.7.1-1.h1.eulerosv2r7",
        "libxkbcommon-x11-0.7.1-1.h1.eulerosv2r7"];
