...
vulnerability as referenced in the K62532228 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K62532228");
...
var vmatrix = {
  'AFM': {
    'affected': [
      '16.0.0-16.1.4','15.1.0-15.1.10','14.1.0-14.1.5','13.1.0-13.1.5','12.1.0-12.1.6','11.6.1-11.6.5'
    ],
    'unaffected': [
      '17.0.0'
    ],
