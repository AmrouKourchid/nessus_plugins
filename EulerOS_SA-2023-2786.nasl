...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : golang (EulerOS-SA-2023-2786)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2786
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ebac450e");
...
var pkgs = [
  "golang-1.15.7-15.h19.eulerosv2r10",
  "golang-devel-1.15.7-15.h19.eulerosv2r10",
  "golang-help-1.15.7-15.h19.eulerosv2r10"
];
