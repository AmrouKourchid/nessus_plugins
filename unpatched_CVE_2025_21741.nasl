...
if (description)
{
  ...
  script_cve_id("CVE-2025-21741");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2025-21741");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: usbnet: ipheth: fix DPE OoB read Fix
    an out-of-bounds DPE read, limit the number of processed DPEs to the amount that fits into the fixed-size
    NDP16 header. (CVE-2025-21741)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-21741");
