...
# SUSE update advisory SUSE-SU-2023:2508-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:2508-1");

  script_name(english:"SUSE SLES15 Security Update : opensc (SUSE-SU-2023:2508-1)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://lists.suse.com/pipermail/sle-updates/2023-June/029882.html");
...
var pkgs = [
    {'reference':'opensc-0.19.0-150100.3.22.1', 'sp':'3', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_RT-release-15.3']}
];
