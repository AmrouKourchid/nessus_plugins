...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.0 : qemu (EulerOS-SA-2023-1242)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1242
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?94fb5eb5");
...
"Update the affected qemu packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2021-3929");
...
var pkgs = [
  "qemu-4.1.0-2.9.1.2.388",
  "qemu-img-4.1.0-2.9.1.2.388"
];
