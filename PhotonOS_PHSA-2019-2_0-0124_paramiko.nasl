...
# extracted from VMware Security Advisory PHSA-2019-2.0-0124. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Paramiko PHSA-2019-2.0-0124");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the paramiko package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-2-124.md");
...
if (rpm_check(release:'PhotonOS-2.0', reference:'paramiko-2.1.5-2.ph2')) flag++;
