...
# extracted from Red Hat Security Advisory RHSA-2023:3923. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:3923");
  script_xref(name:"IAVB", value:"2023-B-0040-S");
  script_xref(name:"IAVB", value:"2023-B-0080-S");

  script_name(english:"RHEL 9 : go-toolset and golang (RHSA-2023:3923)");
...
referenced in the RHSA-2023:3923 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_3923.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?732fb2aa");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:3923");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL go-toolset / golang packages based on the guidance in RHSA-2023:3923.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'go-toolset-1.19.10-1.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-1.19.10-1.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-bin-1.19.10-1.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-docs-1.19.10-1.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-misc-1.19.10-1.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-race-1.19.10-1.el9_2', 'sp':'2', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-src-1.19.10-1.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-tests-1.19.10-1.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'go-toolset-1.19.10-1.el9_2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-1.19.10-1.el9_2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-bin-1.19.10-1.el9_2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
