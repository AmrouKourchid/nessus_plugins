...
# extracted from Fedora Security Advisory FEDORA-2022-0002284730
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-0002284730");

  script_name(english:"Fedora 37 : libksba (2022-0002284730)");
...
FEDORA-2022-0002284730 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-0002284730");
  script_set_attribute(attribute:"solution", value:
"Update the affected libksba package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:libksba");
...
var pkgs = [
    {'reference':'libksba-1.6.2-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
