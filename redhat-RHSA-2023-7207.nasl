...
# extracted from Red Hat Security Advisory RHSA-2023:7207. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:7207");

  script_name(english:"RHEL 8 : c-ares (RHSA-2023:7207)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for c-ares.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2023:7207 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_7207.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c6a1e6ba");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:7207");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL c-ares package based on the guidance in RHSA-2023:7207.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'c-ares-1.13.0-9.el8_9.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'c-ares-devel-1.13.0-9.el8_9.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
