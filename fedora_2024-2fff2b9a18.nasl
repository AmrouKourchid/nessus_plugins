...
# extracted from Fedora Security Advisory FEDORA-2024-2fff2b9a18
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-2fff2b9a18");

  script_name(english:"Fedora 39 : frr (2024-2fff2b9a18)");
...
FEDORA-2024-2fff2b9a18 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-2fff2b9a18");
...
var pkgs = [
    {'reference':'frr-8.5.5-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
