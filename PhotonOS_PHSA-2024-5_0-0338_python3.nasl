...
# extracted from VMware Security Advisory PHSA-2024-5.0-0338. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Python3 PHSA-2024-5.0-0338");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the python3 package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-5.0-338.md");
...
if (rpm_check(release:'PhotonOS-5.0', reference:'python3-dnspython-2.6.1-1.ph5')) flag++;
