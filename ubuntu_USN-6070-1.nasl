...
# extracted from Ubuntu Security Notice USN-6070-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6070-1");

  script_name(english:"Ubuntu 20.04 LTS / 22.04 LTS : Linux kernel vulnerabilities (USN-6070-1)");
...
referenced in the USN-6070-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6070-1");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.15.0-1028-raspi");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.15.0-1028-raspi-nolpae");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.15.0-1037-azure-fde");
...
var kernel_mappings = {
  '20.04': {
    '5.15.0': {
      'azure-fde': '5.15.0-1037'
    }
  },
  '22.04': {
    '5.15.0': {
      'raspi': '5.15.0-1028',
      'raspi-nolpae': '5.15.0-1028'
    }
  }
};
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-6070-1');
}
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-6070-1');
  }
  else
  {
