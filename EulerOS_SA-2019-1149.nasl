...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : python (EulerOS-SA-2019-1149)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1149
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9e71fa63");
...
pkgs = ["python-2.7.5-69.h11.eulerosv2r7",
        "python-devel-2.7.5-69.h11.eulerosv2r7",
        "python-libs-2.7.5-69.h11.eulerosv2r7",
        "tkinter-2.7.5-69.h11.eulerosv2r7"];
