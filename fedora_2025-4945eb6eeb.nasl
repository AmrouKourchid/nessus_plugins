...
# extracted from Fedora Security Advisory FEDORA-2025-4945eb6eeb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-4945eb6eeb");

  script_name(english:"Fedora 40 : seamonkey (2025-4945eb6eeb)");
...
FEDORA-2025-4945eb6eeb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-4945eb6eeb");
...
var pkgs = [
    {'reference':'seamonkey-2.53.20-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
