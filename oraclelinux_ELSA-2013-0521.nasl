...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2013-0521.html");
...
"Update the affected pam and / or pam-devel packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2011-3149");
...
var pkgs = [
    {'reference':'pam-1.1.1-13.el6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pam-devel-1.1.1-13.el6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pam-1.1.1-13.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pam-devel-1.1.1-13.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
];
