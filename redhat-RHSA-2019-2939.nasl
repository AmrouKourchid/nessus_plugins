...
# extracted from Red Hat Security Advisory RHSA-2019:2939. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:2939");
  script_xref(name:"CEA-ID", value:"CEA-2019-0643");

  script_name(english:"RHEL 7 : rh-nodejs10-nodejs (RHSA-2019:2939)");
...
referenced in the RHSA-2019:2939 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_2939.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5ba3f528");
...
"Update the RHEL rh-nodejs10-nodejs package based on the guidance in RHSA-2019:2939.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rh-nodejs10");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rh-nodejs10-runtime");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rh-nodejs10-scldevel");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-nodejs10-3.2-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs10-nodejs-10.16.3-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs10-nodejs-devel-10.16.3-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs10-nodejs-docs-10.16.3-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs10-npm-6.9.0-10.16.3.3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs10-runtime-3.2-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs10-scldevel-3.2-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'rh-nodejs10 / rh-nodejs10-nodejs / rh-nodejs10-nodejs-devel / etc');
}
