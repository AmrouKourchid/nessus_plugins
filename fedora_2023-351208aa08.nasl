...
# extracted from Fedora Security Advisory FEDORA-2023-351208aa08
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-351208aa08");

  script_name(english:"Fedora 39 : cups (2023-351208aa08)");
...
FEDORA-2023-351208aa08 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-351208aa08");
...
var pkgs = [
    {'reference':'cups-2.4.7-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
