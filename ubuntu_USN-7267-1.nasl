...
# extracted from Ubuntu Security Notice USN-7267-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"7267-1");

  script_name(english:"Ubuntu 16.04 LTS : libsndfile vulnerability (USN-7267-1)");
...
USN-7267-1 advisory.
    ...
    possibly use this issue to cause libsndfile to crash, resulting in a denial of service.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7267-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libsndfile1', 'pkgver': '1.0.25-10ubuntu0.16.04.3+esm4', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libsndfile1-dev', 'pkgver': '1.0.25-10ubuntu0.16.04.3+esm4', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'sndfile-programs', 'pkgver': '1.0.25-10ubuntu0.16.04.3+esm4', 'ubuntu_pro': TRUE}
];
