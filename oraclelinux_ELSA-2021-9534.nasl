...
the ELSA-2021-9534 advisory.
    ...
    - Bluetooth: hci_uart: check for missing tty operations (Vladis Dronov)  [Orabug: 30244627]
    {CVE-2019-10207} {CVE-2019-10207}
    - Bluetooth: hci_uart: Add basic support for Intel Lightning Peak devices (Loic Poulain)  [Orabug:
    30244627]  {CVE-2019-10207}
    - Bluetooth: hci_uart: Add new line discipline enhancements (Ilya Faenson)  [Orabug: 30244627]
    {CVE-2019-10207}
    - Bluetooth: hci_uart: Support operational speed during setup (Frederic Danis)  [Orabug: 30244627]
    {CVE-2019-10207}
    - btrfs: fix return value mixup in btrfs_get_extent (Pavel Machek)  [Orabug: 31864610]  {CVE-2019-19813}
    - btrfs: inode: Verify inode mode to avoid NULL pointer dereference (Qu Wenruo)  [Orabug: 31864610]
    {CVE-2019-19813}
    - net: create skb_gso_validate_mac_len() (Daniel Axtens)  [Orabug: 28094432]  {CVE-2018-1000026}
    - bnx2x: disable GSO where gso_size is too big for hardware (Daniel Axtens)  [Orabug: 28094432]
    {CVE-2018-1000026}
    - Bluetooth: fix the erroneous flush_work() order (Lin Ma)  [Orabug: 33014035]  {CVE-2021-3564}
    {CVE-2021-3564}
...
var pkgs = [
    ...
    {'reference':'kernel-uek-doc-4.1.12-124.57.1.el6uek', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-doc-4.1.12'},
    {'reference':'kernel-uek-firmware-4.1.12-124.57.1.el6uek', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-firmware-4.1.12'},
    ...
    {'reference':'kernel-uek-doc-4.1.12-124.57.1.el7uek', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-doc-4.1.12'},
    {'reference':'kernel-uek-firmware-4.1.12-124.57.1.el7uek', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-firmware-4.1.12'}
];
