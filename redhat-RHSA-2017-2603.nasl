...
# extracted from Red Hat Security Advisory RHSA-2017:2603. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2017:2603");

  script_name(english:"RHEL 7 : docker-distribution (RHSA-2017:2603)");
...
the RHSA-2017:2603 advisory.

    The docker-distribution package provides the tool set to support the Docker Registry version 2.

    The following packages have been upgraded to a later upstream version: docker-distribution (2.6.2).
    (BZ#1479494)

    Security Fix(es):

    * It was found that docker-distribution did not properly restrict memory allocation size for a registry
    instance through the manifest endpoint. An attacker could send a specially crafted request that would
    exhaust the memory of the docker-distribution service. (CVE-2017-11468)

Tenable has extracted the preceding description block directly from the Red Hat Enterprise Linux security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2017/rhsa-2017_2603.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ed422929");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2017:2603");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1474893");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1479494");
  script_set_attribute(attribute:"solution", value:
"Update the affected docker-distribution package.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'docker-distribution-2.6.2-1.git48294d9.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'docker-distribution-2.6.2-1.git48294d9.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'docker-distribution');
}
