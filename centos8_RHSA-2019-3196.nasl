...
# Red Hat Security Advisory RHSA-2019:3196. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : firefox (CESA-2019:3196)");
...
pkgs = [
    {'reference':'firefox-68.2.0-2.el8_0', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-68.2.0-2.el8_0', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
