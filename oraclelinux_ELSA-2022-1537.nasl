...
# extracted from Oracle Linux Security Advisory ELSA-2022-1537.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : gzip (ELSA-2022-1537)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2022-1537.html");
