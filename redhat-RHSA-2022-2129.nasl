...
# extracted from Red Hat Security Advisory RHSA-2022:2129. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:2129");

  script_name(english:"RHEL 8 : lynx (RHSA-2022:2129)");
...
the RHSA-2022:2129 advisory.

    Lynx is a text-based Web browser. Lynx does not display any images, but it does support frames, tables,
    and most other HTML tags.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_2129.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d32b2c73");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:2129");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1994998");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL lynx package based on the guidance in RHSA-2022:2129.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'lynx-2.8.9-4.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
