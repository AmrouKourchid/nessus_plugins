...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Binutils PHSA-2023-5.0-0036");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'binutils-2.39-3.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'binutils-devel-2.39-3.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'binutils-libs-2.39-3.ph5')) flag++;
