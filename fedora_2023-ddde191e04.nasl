...
# extracted from Fedora Security Advisory FEDORA-2023-ddde191e04
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-ddde191e04");

  script_name(english:"Fedora 39 : pypy3.10 (2023-ddde191e04)");
...
FEDORA-2023-ddde191e04 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-ddde191e04");
...
var pkgs = [
    {'reference':'pypy3.10-7.3.12-1.3.10.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
