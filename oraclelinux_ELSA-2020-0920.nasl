...
# extracted from Oracle Linux Security Advisory ELSA-2020-0920.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : libvncserver (ELSA-2020-0920)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
ELSA-2020-0920 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2020-0920.html");
...
var pkgs = [
    {'reference':'libvncserver-0.9.11-9.el8_1.2', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libvncserver-devel-0.9.11-9.el8_1.2', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
