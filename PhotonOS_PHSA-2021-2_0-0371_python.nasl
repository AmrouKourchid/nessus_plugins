...
# extracted from VMware Security Advisory PHSA-2021-2.0-0371. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Python PHSA-2021-2.0-0371");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the python package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-3.0-271.md");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'python-numpy-1.12.1-6.ph2')) flag++;
