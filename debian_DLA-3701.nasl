...
# extracted from Debian Security Advisory dla-3701. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2023-34194", "CVE-2023-40462");

  script_name(english:"Debian dla-3701 : libtinyxml-dev - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-34194");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-40462");
...
"Upgrade the libtinyxml-dev packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-40462");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libtinyxml-dev', 'reference': '2.6.2-4+deb10u2'},
    {'release': '10.0', 'prefix': 'libtinyxml-doc', 'reference': '2.6.2-4+deb10u2'},
    {'release': '10.0', 'prefix': 'libtinyxml2.6.2v5', 'reference': '2.6.2-4+deb10u2'},
    {'release': '10.0', 'prefix': 'libtinyxml2.6.2v5-dbg', 'reference': '2.6.2-4+deb10u2'}
];
