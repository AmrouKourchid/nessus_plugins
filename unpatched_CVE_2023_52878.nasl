...
if (description)
{
  ...
  script_cve_id("CVE-2023-52878");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2023-52878");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: can: dev: can_put_echo_skb(): don't
    crash kernel if can_priv::echo_skb is accessed out of bounds If the struct can_priv::echoo_skb is
    accessed out of bounds, this would cause a kernel crash. Instead, issue a meaningful warning message and
    return with an error. (CVE-2023-52878)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-52878");
