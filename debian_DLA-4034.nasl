...
# extracted from Debian Security Advisory dla-4034. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2025-0781");

  script_name(english:"Debian dla-4034 : libsimgear-dev - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has a package installed that is affected by a vulnerability as referenced in the dla-4034
advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/simgear");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2025-0781");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bullseye/simgear");
  script_set_attribute(attribute:"solution", value:
"Upgrade the libsimgear-dev packages.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:N/UI:R/S:C/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-0781");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:libsimgear-dev");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'libsimgear-dev', 'reference': '1:2020.3.6+dfsg-1+deb11u1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libsimgear-dev');
}
