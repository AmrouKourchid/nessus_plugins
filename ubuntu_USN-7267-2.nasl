...
# extracted from Ubuntu Security Notice USN-7267-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"7267-2");

  script_name(english:"Ubuntu 24.04 LTS / 24.10 : libsndfile vulnerability (USN-7267-2)");
...
the USN-7267-2 advisory.

    USN-7267-1 fixed a vulnerability in libsndfile. This update provides the corresponding updates for Ubuntu
    24.04 LTS and Ubuntu 24.10.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7267-2");
...
var pkgs = [
    {'osver': '24.04', 'pkgname': 'libsndfile1', 'pkgver': '1.2.2-1ubuntu5.24.04.1'},
    {'osver': '24.04', 'pkgname': 'libsndfile1-dev', 'pkgver': '1.2.2-1ubuntu5.24.04.1'},
    {'osver': '24.04', 'pkgname': 'sndfile-programs', 'pkgver': '1.2.2-1ubuntu5.24.04.1'},
    {'osver': '24.10', 'pkgname': 'libsndfile1', 'pkgver': '1.2.2-1ubuntu5.24.10.1'},
    {'osver': '24.10', 'pkgname': 'libsndfile1-dev', 'pkgver': '1.2.2-1ubuntu5.24.10.1'},
    {'osver': '24.10', 'pkgname': 'sndfile-programs', 'pkgver': '1.2.2-1ubuntu5.24.10.1'}
];
