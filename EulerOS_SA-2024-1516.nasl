...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : python-pillow (EulerOS-SA-2024-1516)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1516
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0c917255");
...
var pkgs = [
  "python3-pillow-5.3.0-4.h24.eulerosv2r9"
];
