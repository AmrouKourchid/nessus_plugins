...
# extracted from Red Hat Security Advisory RHSA-2021:3219. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:3219");
  script_xref(name:"IAVA", value:"2021-A-0392-S");

  script_name(english:"RHEL 7 / 8 : Red Hat JBoss Enterprise Application Platform 7.4 (RHSA-2021:3219)");
...
in the RHSA-2021:3219 advisory.

    Red Hat JBoss Enterprise Application Platform 7 is a platform for Java applications based on the WildFly
    application runtime.

    This asynchronous patch is a security update for Red Hat JBoss Enterprise Application Platform 7.4 for Red
    Hat Enterprise Linux 7 and 8.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?020e48c6");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:3219");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1991299");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat JBoss Enterprise Application Platform 7.4 package based on the guidance in RHSA-2021:3219.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'eap7-undertow-2.2.5-2.SP1_redhat_00001.1.el8eap', 'release':'8', 'el_string':'el8eap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap7'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'eap7-undertow-2.2.5-2.SP1_redhat_00001.1.el7eap', 'release':'7', 'el_string':'el7eap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap7'}
    ]
  }
];
