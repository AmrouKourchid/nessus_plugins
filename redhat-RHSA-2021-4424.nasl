...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_4424.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?706b5237");
...
"Update the RHEL openssl package based on the guidance in RHSA-2021:4424.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openssl-1.1.1k-4.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'openssl-devel-1.1.1k-4.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'openssl-libs-1.1.1k-4.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'openssl-perl-1.1.1k-4.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
