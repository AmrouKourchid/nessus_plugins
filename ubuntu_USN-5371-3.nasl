...
# extracted from Ubuntu Security Notice USN-5371-3. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5371-3");

  script_name(english:"Ubuntu 16.04 ESM : nginx vulnerability (USN-5371-3)");
...
USN-5371-3 advisory.
    ...
    USN-5371-1 and USN-5371-2 fixed several vulnerabilities in nginx. This update provides the corresponding
    update for CVE-2020-11724 for Ubuntu 16.04 ESM.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5371-3");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'nginx', 'pkgver': '1.10.3-0ubuntu0.16.04.5+esm4', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'nginx-common', 'pkgver': '1.10.3-0ubuntu0.16.04.5+esm4', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'nginx-core', 'pkgver': '1.10.3-0ubuntu0.16.04.5+esm4', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'nginx-extras', 'pkgver': '1.10.3-0ubuntu0.16.04.5+esm4', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'nginx-full', 'pkgver': '1.10.3-0ubuntu0.16.04.5+esm4', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'nginx-light', 'pkgver': '1.10.3-0ubuntu0.16.04.5+esm4', 'ubuntu_pro': TRUE}
];
