...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : binutils (EulerOS-SA-2023-1118)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1118
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d991fe5c");
...
var pkgs = [
  "binutils-2.34-1.h28.eulerosv2r9"
];
