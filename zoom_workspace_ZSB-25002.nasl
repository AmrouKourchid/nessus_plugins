...
if (description)
{
  ...
  script_cve_id("CVE-2025-0143");
  script_xref(name:"IAVA", value:"2025-A-0025-S");

  script_name(english:"Zoom Workplace Desktop App < 6.2.5 DoS (ZSB-25002)");
...
a vulnerability as referenced in the ZSB-25002 advisory.

  - Out-of-bounds write in the Zoom Workplace App for Linux before version 6.2.5 may allow an unauthorized 
    user to conduct a denial of service via network access. (CVE-2025-0143)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.zoom.com/en/trust/security-bulletin/ZSB-25002/");
...
"Upgrade to Zoom Client for Meetings 6.2.5 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-0143");
