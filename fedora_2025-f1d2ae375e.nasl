...
# extracted from Fedora Security Advisory FEDORA-2025-f1d2ae375e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-f1d2ae375e");

  script_name(english:"Fedora 41 : podman-tui (2025-f1d2ae375e)");
...
FEDORA-2025-f1d2ae375e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-f1d2ae375e");
...
var pkgs = [
    {'reference':'podman-tui-1.5.0-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
