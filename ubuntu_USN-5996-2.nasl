...
# extracted from Ubuntu Security Notice USN-5996-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5996-2");

  script_name(english:"Ubuntu 23.04 : Libloius vulnerabilities (USN-5996-2)");
...
USN-5996-2 advisory.
    ...
    USN-5996-1 fixed vulnerabilities in Liblouis. This update provides the corresponding updates for Ubuntu
    23.04.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5996-2");
...
var pkgs = [
    {'osver': '23.04', 'pkgname': 'liblouis-bin', 'pkgver': '3.24.0-1ubuntu0.1'},
    {'osver': '23.04', 'pkgname': 'liblouis-data', 'pkgver': '3.24.0-1ubuntu0.1'},
    {'osver': '23.04', 'pkgname': 'liblouis-dev', 'pkgver': '3.24.0-1ubuntu0.1'},
    {'osver': '23.04', 'pkgname': 'liblouis20', 'pkgver': '3.24.0-1ubuntu0.1'},
    {'osver': '23.04', 'pkgname': 'python3-louis', 'pkgver': '3.24.0-1ubuntu0.1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'liblouis-bin / liblouis-data / liblouis-dev / liblouis20 / etc');
}
