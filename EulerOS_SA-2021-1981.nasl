...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : gstreamer-plugins-good (EulerOS-SA-2021-1981)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1981
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5d9afe76");
...
pkgs = ["gstreamer-plugins-good-0.10.31-20.h4.eulerosv2r8"];
