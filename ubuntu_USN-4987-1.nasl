...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS : ExifTool vulnerability (USN-4987-1)");
...
in the USN-4987-1 advisory.

    It was discovered that ExifTool did not properly sanitize user data for the DjVu file format. An attacker
    could use this vulnerability to cause a DoS or possibly execute arbitrary code.
