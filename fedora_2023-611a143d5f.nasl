...
# extracted from Fedora Security Advisory FEDORA-2023-611a143d5f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-611a143d5f");

  script_name(english:"Fedora 38 : ntp-refclock (2023-611a143d5f)");
...
FEDORA-2023-611a143d5f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-611a143d5f");
  script_set_attribute(attribute:"solution", value:
"Update the affected ntp-refclock package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:ntp-refclock");
...
var pkgs = [
    {'reference':'ntp-refclock-0.6-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'ntp-refclock');
}
