...
# extracted from Red Hat Security Advisory RHSA-2023:7885. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:7885");
  script_xref(name:"IAVB", value:"2023-B-0088-S");

  script_name(english:"RHEL 9 : postgresql:15 (RHSA-2023:7885)");
...
referenced in the RHSA-2023:7885 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_7885.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?789d0d91");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:7885");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL postgresql:15 package based on the guidance in RHSA-2023:7885.");
  ...
  'postgresql:15': [
    {
      ...
      'pkgs': [
        ...
        {'reference':'postgresql-15.5-1.module+el9.2.0.z+20667+a2d2a8a9', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-contrib-15.5-1.module+el9.2.0.z+20667+a2d2a8a9', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-docs-15.5-1.module+el9.2.0.z+20667+a2d2a8a9', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plperl-15.5-1.module+el9.2.0.z+20667+a2d2a8a9', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plpython3-15.5-1.module+el9.2.0.z+20667+a2d2a8a9', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-pltcl-15.5-1.module+el9.2.0.z+20667+a2d2a8a9', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-private-devel-15.5-1.module+el9.2.0.z+20667+a2d2a8a9', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-private-libs-15.5-1.module+el9.2.0.z+20667+a2d2a8a9', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-15.5-1.module+el9.2.0.z+20667+a2d2a8a9', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-devel-15.5-1.module+el9.2.0.z+20667+a2d2a8a9', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-static-15.5-1.module+el9.2.0.z+20667+a2d2a8a9', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-15.5-1.module+el9.2.0.z+20667+a2d2a8a9', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-rpm-macros-15.5-1.module+el9.2.0.z+20667+a2d2a8a9', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-upgrade-15.5-1.module+el9.2.0.z+20667+a2d2a8a9', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-upgrade-devel-15.5-1.module+el9.2.0.z+20667+a2d2a8a9', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
