...
# extracted from Fedora Security Advisory FEDORA-2023-c69d73674a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-c69d73674a");

  script_name(english:"Fedora 40 : python3.8 (2023-c69d73674a)");
...
FEDORA-2023-c69d73674a advisory.

    Automatic update for python3.8-3.8.18-3.fc40.

    ##### **Changelog**

    ```
    * Mon Dec 18 2023 Lumr Balhar <lbalhar@redhat.com> - 3.8.18-3
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-c69d73674a");
...
var pkgs = [
    {'reference':'python3.8-3.8.18-3.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
