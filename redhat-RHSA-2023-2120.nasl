...
# extracted from Red Hat Security Advisory RHSA-2023:2120. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:2120");

  script_name(english:"RHEL 9 : libreswan (RHSA-2023:2120)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_2120.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cdb867c3");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2187165");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:2120");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libreswan package based on the guidance in RHSA-2023:2120.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libreswan-4.6-3.el9_1.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
