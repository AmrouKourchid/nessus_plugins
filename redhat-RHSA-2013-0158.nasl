...
# extracted from Red Hat Security Advisory RHSA-2013:0158. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2013:0158");

  script_name(english:"RHEL 6 : tomcat6 (RHSA-2013:0158)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for tomcat6.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 6 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2013:0158 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2013/rhsa-2013_0158.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b731f5f4");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2013:0158");
...
"Update the RHEL tomcat6 package based on the guidance in RHSA-2013:0158.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'tomcat6-6.0.32-31_patch_08.ep5.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'tomcat'},
      {'reference':'tomcat6-admin-webapps-6.0.32-31_patch_08.ep5.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'tomcat'},
      {'reference':'tomcat6-docs-webapp-6.0.32-31_patch_08.ep5.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'tomcat'},
      {'reference':'tomcat6-el-1.0-api-6.0.32-31_patch_08.ep5.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'tomcat'},
      {'reference':'tomcat6-javadoc-6.0.32-31_patch_08.ep5.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'tomcat'},
      {'reference':'tomcat6-jsp-2.1-api-6.0.32-31_patch_08.ep5.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'tomcat'},
      {'reference':'tomcat6-lib-6.0.32-31_patch_08.ep5.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'tomcat'},
      {'reference':'tomcat6-log4j-6.0.32-31_patch_08.ep5.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'tomcat'},
      {'reference':'tomcat6-servlet-2.5-api-6.0.32-31_patch_08.ep5.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'tomcat'},
      {'reference':'tomcat6-webapps-6.0.32-31_patch_08.ep5.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'tomcat'}
    ]
  }
];
