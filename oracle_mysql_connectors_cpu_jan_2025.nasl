...
if (description)
{
  ...
  script_cve_id("CVE-2025-21548");
  script_xref(name:"IAVA", value:"2025-A-0050");

  script_name(english:"Oracle MySQL Connectors (January 2025 CPU)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host is affected by a vulnerability");
  script_set_attribute(attribute:"description", value:
"The 9.1.0 versions of MySQL Connectors installed on the remote host are affected by a vulnerability as referenced in the
January 2025 CPU advisory.
  ...
  - Vulnerability in the MySQL Connectors product of Oracle MySQL (component: Connector/Python). Supported
    versions that are affected are 9.1.0 and prior. Easily exploitable vulnerability allows high privileged
    attacker with network access via multiple protocols to compromise MySQL Connectors. Successful attacks
    require human interaction from a person other than the attacker. Successful attacks of this vulnerability
    can result in unauthorized creation, deletion or modification access to critical data or all MySQL
...
"Apply the appropriate patch according to the January 2025 Oracle Critical Patch Update advisory.");
  ...
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:H/UI:R/S:U/C:L/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-21548");
...
var constraints = [
  { 'min_version' : '0.0.0', 'fixed_version' : '9.2.0' }
];
