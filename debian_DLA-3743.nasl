...
# extracted from Debian Security Advisory dla-3743. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3743 : hostapd - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3743
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-52160");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/wpa");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'hostapd', 'reference': '2:2.7+git20190128+0c1e29f-6+deb10u4'},
    {'release': '10.0', 'prefix': 'wpagui', 'reference': '2:2.7+git20190128+0c1e29f-6+deb10u4'},
    {'release': '10.0', 'prefix': 'wpasupplicant', 'reference': '2:2.7+git20190128+0c1e29f-6+deb10u4'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'hostapd / wpagui / wpasupplicant');
}
