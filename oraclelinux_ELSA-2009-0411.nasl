...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : device-mapper-multipath (ELSA-2009-0411)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2009-0411.html");
...
"Update the affected device-mapper-multipath and / or kpartx packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2009-0115");
...
var pkgs = [
    {'reference':'device-mapper-multipath-0.4.7-23.el5_3.2', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kpartx-0.4.7-23.el5_3.2', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'device-mapper-multipath-0.4.7-23.el5_3.2', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kpartx-0.4.7-23.el5_3.2', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
