...
if (description)
{
  ...
  script_xref(name:"APPLE-SA", value:"HT213915");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2023/10/02");
  script_xref(name:"IAVA", value:"2023-A-0468-S");

  script_name(english:"macOS 11.x < 11.7.10 (HT213915)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host is missing a macOS update that fixes a vulnerability");
  script_set_attribute(attribute:"description", value:
"The remote host is running a version of macOS / Mac OS X that is 11.x prior to 11.7.10. It is, therefore, affected by a
vulnerability:
...
version number.");
  script_set_attribute(attribute:"see_also", value:"https://support.apple.com/en-us/HT213915");
  script_set_attribute(attribute:"solution", value:
"Upgrade to macOS 11.7.10 or later.");
...
var constraints = [
  { 'fixed_version' : '11.7.10', 'min_version' : '11.0', 'fixed_display' : 'macOS Big Sur 11.7.10' }
];
