...
# extracted from Oracle Linux Security Advisory ELSA-2009-1364.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : gdm (ELSA-2009-1364)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2009-1364.html");
...
"Update the affected gdm and / or gdm-docs packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2009-2697");
...
var pkgs = [
    {'reference':'gdm-2.16.0-56.el5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'gdm-docs-2.16.0-56.el5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'gdm-2.16.0-56.el5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'gdm-docs-2.16.0-56.el5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
