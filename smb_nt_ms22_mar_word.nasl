...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5002068");
  script_xref(name:"MSKB", value:"5002139");
  script_xref(name:"MSFT", value:"MS22-5002068");
  script_xref(name:"MSFT", value:"MS22-5002139");
  script_xref(name:"IAVA", value:"2022-A-0107-S");

  script_name(english:"Security Updates for Microsoft Word Products (March 2022)");
...
It is, therefore, affected by the following vulnerability:
  ...
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002068");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002139");
...
var checks = make_array(
  '15.0', make_array('sp', 1, 'version', '15.0.5431.1000', 'kb', '5002068'),
  '16.0', make_nested_list(
    make_array('sp', 0, 'version', '16.0.5290.1000', 'channel', 'MSI', 'kb', '5002139')
  )
);
