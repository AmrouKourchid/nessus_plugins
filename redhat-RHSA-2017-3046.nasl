...
if (description)
{
  ...
  script_name(english:"RHEL 7 : java-1.7.0-oracle (RHSA-2017:3046)");
...
referenced in the RHSA-2017:3046 advisory.
    ...
    * This update fixes multiple vulnerabilities in the Oracle Java Runtime Environment and the Oracle Java
    ...
    CVE-2017-10293, CVE-2017-10295, CVE-2017-10345, CVE-2017-10346, CVE-2017-10347, CVE-2017-10348,
    CVE-2017-10349, CVE-2017-10350, CVE-2017-10355, CVE-2017-10356, CVE-2017-10357, CVE-2017-10388)

    Note: Starting with this update, Java web browser plugin and Java Web Start application are no longer
    included with Oracle Java SE 7. Refer to the Releases Notes and the Oracle Java SE Support Roadmap pages
    linked to in the References section for further information about this change.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?58295c79");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2017/rhsa-2017_3046.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c7df5d55");
  script_set_attribute(attribute:"see_also", value:"http://www.oracle.com/technetwork/java/javase/eol-135779.html");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2017:3046");
...
"Update the RHEL java-1.7.0-oracle package based on the guidance in RHSA-2017:3046.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'java-1.7.0-oracle-1.7.0.161-1jpp.4.el7', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.7.0-oracle-1.7.0.161-1jpp.4.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.7.0-oracle-devel-1.7.0.161-1jpp.4.el7', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.7.0-oracle-devel-1.7.0.161-1jpp.4.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.7.0-oracle-javafx-1.7.0.161-1jpp.4.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.7.0-oracle-jdbc-1.7.0.161-1jpp.4.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.7.0-oracle-plugin-1.7.0.161-1jpp.4.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.7.0-oracle-src-1.7.0.161-1jpp.4.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
