...
# extracted from Oracle Linux Security Advisory ELSA-2022-8022.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : qt5 (ELSA-2022-8022)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2022-8022.html");
...
var pkgs = [
    {'reference':'qt5-5.15.3-1.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'qt5-devel-5.15.3-1.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'qt5-rpm-macros-5.15.3-1.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'qt5-srpm-macros-5.15.3-1.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
