...
# extracted from Red Hat Security Advisory RHSA-2024:4867. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:4867");

  script_name(english:"RHEL 8 : Release of openshift-serverless-clients kn 1.33.1 security updatees (Moderate) (RHSA-2024:4867)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for Release of openshift-serverless-clients kn 1.33.1.");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?820becdd");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_4867.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8e8bbb20");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2292668");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2296266");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:4867");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Release of openshift-serverless-clients kn 1.33.1 package based on the guidance in RHSA-2024:4867.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:S/C:N/I:C/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:L/UI:N/S:U/C:N/I:H/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-24789");
...
var constraints = [
  {
    'repo_relative_urls': [
      'content/dist/layered/rhel8/aarch64/rhoss/1/debug',
      'content/dist/layered/rhel8/aarch64/rhoss/1/os',
      'content/dist/layered/rhel8/aarch64/rhoss/1/source/SRPMS',
    ...
    'pkgs': [
      {'reference':'openshift-serverless-clients-1.12.0-10.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
