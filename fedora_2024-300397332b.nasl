...
# extracted from Fedora Security Advisory FEDORA-2024-300397332b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-300397332b");

  script_name(english:"Fedora 40 : llvm-test-suite (2024-300397332b)");
...
FEDORA-2024-300397332b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-300397332b");
...
var pkgs = [
    {'reference':'llvm-test-suite-18.1.8-3.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
