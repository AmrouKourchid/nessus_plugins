...
the USN-6045-1 advisory.
    ...
    It was discovered that the TIPC protocol implementation in the Linux kernel did not properly validate the
    queue of socket buffers (skb) when handling certain UDP packets. A remote attacker could use this to cause
    a denial of service. (CVE-2023-1390)
