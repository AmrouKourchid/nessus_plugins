...
if (description)
{
  ...
  script_cve_id("CVE-2022-22785");

  script_name(english:"Zoom Client for Meetings < 5.10.0 Vulnerability (ZSB-22007)");
...
vulnerability as referenced in the ZSB-22007 advisory.

  - The Zoom Client for Meetings (for Android, iOS, Linux, macOS, and Windows) before version 5.10.0 fails to
    properly constrain client session cookies to Zoom domains. This issue could be used in a more
    sophisticated attack to send a user's Zoom-scoped session cookies to a non-Zoom domain. This could
    potentially allow for spoofing of a Zoom user. Users can help keep themselves secure by applying current
    updates or downloading the latest Zoom software with all current security updates from
    https://zoom.us/download. (CVE-2022-22785)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://explore.zoom.us/en/trust/security/security-bulletin/?filter-cve=&filter=&keywords=ZSB-22007
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?48dbb310");
