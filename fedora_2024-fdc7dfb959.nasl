...
# extracted from Fedora Security Advisory FEDORA-2024-fdc7dfb959
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-fdc7dfb959");
  script_xref(name:"IAVB", value:"2024-B-0001-S");

  script_name(english:"Fedora 38 : wireshark (2024-fdc7dfb959)");
...
FEDORA-2024-fdc7dfb959 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-fdc7dfb959");
...
var pkgs = [
    {'reference':'wireshark-4.0.12-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
