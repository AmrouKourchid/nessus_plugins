...
# extracted from Fedora Security Advisory FEDORA-2022-0f1d2e0537
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-0f1d2e0537");
  script_xref(name:"CEA-ID", value:"CEA-2022-0036");

  script_name(english:"Fedora 37 : openssl (2022-0f1d2e0537)");
...
FEDORA-2022-0f1d2e0537 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-0f1d2e0537");
...
var pkgs = [
    {'reference':'openssl-3.0.5-3.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
