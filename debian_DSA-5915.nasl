...
# extracted from Debian Security Advisory dsa-5915. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5915 : gir1.2-vips-8.0 - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 12 host has packages installed that are affected by a vulnerability as referenced in the dsa-5915
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bookworm/vips");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'gir1.2-vips-8.0', 'reference': '8.14.1-3+deb12u2'},
    {'release': '12.0', 'prefix': 'libvips-dev', 'reference': '8.14.1-3+deb12u2'},
    {'release': '12.0', 'prefix': 'libvips-doc', 'reference': '8.14.1-3+deb12u2'},
    {'release': '12.0', 'prefix': 'libvips-tools', 'reference': '8.14.1-3+deb12u2'},
    {'release': '12.0', 'prefix': 'libvips42', 'reference': '8.14.1-3+deb12u2'}
];
