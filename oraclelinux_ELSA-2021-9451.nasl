...
the ELSA-2021-9451 advisory.
    ...
    [Orabug: 33226010]  {CVE-2021-3653}
    - Revert KVM: nSVM: avoid picking up unsupported bits from L2 in int_ctl (Liam Merwick)  [Orabug:
    33226010]  {CVE-2021-3653}
    - Bluetooth: defer cleanup of resources in hci_unregister_dev() (Tetsuo Handa)   {CVE-2021-3573}
    - KVM: nSVM: always intercept VMLOAD/VMSAVE when nested (Maxim Levitsky)  [Orabug: 33235071]
    {CVE-2021-3656}
