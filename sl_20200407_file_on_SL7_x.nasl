...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : file on SL7.x x86_64 (20200407)");
...
"* file: out-of-bounds read via a crafted ELF file");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind2004&L=SCIENTIFIC-LINUX-ERRATA&P=12222
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?14e7bce2");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"file-5.11-36.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"file-debuginfo-5.11-36.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"file-devel-5.11-36.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"file-libs-5.11-36.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"file-static-5.11-36.el7")) flag++;
if (rpm_check(release:"SL7", reference:"python-magic-5.11-36.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"python-magic-5.11-36.el7")) flag++;
