...
# extracted from VMware Security Advisory PHSA-2021-2.0-0336. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Redis PHSA-2021-2.0-0336");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the redis package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-2-336.md");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'redis-4.0.14-4.ph2')) flag++;
