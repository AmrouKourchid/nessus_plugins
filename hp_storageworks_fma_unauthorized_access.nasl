...
issue to modify archives and retrieve credentials.");
  script_set_attribute(attribute:"see_also", value:"https://www.zerodayinitiative.com/advisories/ZDI-11-094/");
  script_set_attribute(attribute:"solution", value:
"Restrict access to TCP port 9111.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:P/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:U/RC:ND");

  script_set_attribute(attribute:"cvss_score_source", value:"manual");
  script_set_attribute(attribute:"cvss_score_rationale", value:"Tenable assigned score for unauthenticated network file manipulation.");
...
function query_cfg(type, id)
{
  ...
  {
    # UTF-16 CSV.
    res = utf16_to_ascii(s:res, pos:0);
...
while ( i < strlen(recs) )
{
  ...
  name = utf16_to_ascii(s:rec, pos:16);
  type = utf16_to_ascii(s:rec, pos:82);
  desc = utf16_to_ascii(s:rec, pos:244);
