...
# SUSE update advisory SUSE-SU-2022:3613-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:3613-1");

  script_name(english:"SUSE SLES15 Security Update : postgresql-jdbc (SUSE-SU-2022:3613-1)");
...
in the SUSE-SU-2022:3613-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-October/012559.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fe085529");
...
var pkgs = [
    {'reference':'postgresql-jdbc-42.2.25-150300.3.8.1', 'sp':'3', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.3']},
    {'reference':'postgresql-jdbc-42.2.25-150300.3.8.1', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.3', 'sle-module-server-applications-release-15.3', 'sles-release-15.3']}
];
