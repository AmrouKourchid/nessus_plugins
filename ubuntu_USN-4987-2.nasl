...
# extracted from Ubuntu Security Notice USN-4987-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"4987-2");

  script_name(english:"Ubuntu 16.04 ESM : ExifTool vulnerability (USN-4987-2)");
...
USN-4987-2 advisory.
    ...
    USN-4987-1 fixed a vulnerability in ExifTool. This update provides the corresponding update for Ubuntu
    16.04 ESM.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4987-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libimage-exiftool-perl', 'pkgver': '10.10-1ubuntu0.1~esm1', 'ubuntu_pro': TRUE}
];
