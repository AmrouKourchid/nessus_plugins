...
# extracted from Fedora Security Advisory FEDORA-2022-2156b74a6a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-2156b74a6a");

  script_name(english:"Fedora 37 : samba (2022-2156b74a6a)");
...
FEDORA-2022-2156b74a6a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-2156b74a6a");
...
var pkgs = [
    {'reference':'samba-4.17.3-0.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
