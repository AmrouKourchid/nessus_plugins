...
# extracted from Red Hat Security Advisory RHSA-2020:0902. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:0902");

  script_name(english:"RHEL 8 : icu (RHSA-2020:0902)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for icu.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2020:0902 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_0902.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9627f207");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:0902");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1807349");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL icu package based on the guidance in RHSA-2020:0902.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'icu-60.3-2.el8_1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libicu-60.3-2.el8_1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libicu-devel-60.3-2.el8_1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
  ...
  },
  {
    ...
    'pkgs': [
      {'reference':'icu-60.3-2.el8_1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libicu-60.3-2.el8_1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libicu-devel-60.3-2.el8_1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libicu-doc-60.3-2.el8_1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
