...
# extracted from Fedora Security Advisory FEDORA-2023-c95d3f825f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-c95d3f825f");

  script_name(english:"Fedora 38 : dbus (2023-c95d3f825f)");
...
FEDORA-2023-c95d3f825f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-c95d3f825f");
...
var pkgs = [
    {'reference':'dbus-1.14.8-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
