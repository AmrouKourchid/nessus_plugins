...
# extracted from Fedora Security Advisory FEDORA-2022-d50ded078e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-d50ded078e");

  script_name(english:"Fedora 35 : woff (2022-d50ded078e)");
...
FEDORA-2022-d50ded078e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-d50ded078e");
  script_set_attribute(attribute:"solution", value:
"Update the affected woff package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:woff");
...
var pkgs = [
    {'reference':'woff-0.20091126-33.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'woff');
}
