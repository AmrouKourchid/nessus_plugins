...
# CentOS Errata and Security Advisory 2020:2381 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : firefox (RHSA-2020:2381)");
...
var pkgs = [
    {'reference':'firefox-68.9.0-1.el7.centos', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-68.9.0-1.el7.centos', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
