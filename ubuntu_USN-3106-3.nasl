...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS : Linux kernel (Raspberry Pi 2) vulnerability (USN-3106-3)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3106-3");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.4.0-1029-raspi2");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-3106-3');
}
