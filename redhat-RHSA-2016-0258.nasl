...
# extracted from Red Hat Security Advisory RHSA-2016:0258. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 6 / 7 : thunderbird (RHSA-2016:0258)");
...
referenced in the RHSA-2016:0258 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2016/rhsa-2016_0258.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3abd3f85");
  # https://www.mozilla.org/en-US/security/known-vulnerabilities/thunderbird/#thunderbird38.6
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9b4c4870");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2016:0258");
...
"Update the RHEL thunderbird package based on the guidance in RHSA-2016:0258.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'thunderbird-38.6.0-1.el7_2', 'cpu':'ppc64le', 'release':'7', 'el_string':'el7_2', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'thunderbird-38.6.0-1.el7_2', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_2', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'thunderbird-38.6.0-1.el6_7', 'cpu':'i686', 'release':'6', 'el_string':'el6_7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'thunderbird-38.6.0-1.el6_7', 'cpu':'ppc64', 'release':'6', 'el_string':'el6_7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'thunderbird-38.6.0-1.el6_7', 'cpu':'s390x', 'release':'6', 'el_string':'el6_7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'thunderbird-38.6.0-1.el6_7', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
