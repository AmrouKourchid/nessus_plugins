...
# extracted from Fedora Security Advisory FEDORA-2024-60627905b6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-60627905b6");

  script_name(english:"Fedora 40 : libdwarf (2024-60627905b6)");
...
FEDORA-2024-60627905b6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-60627905b6");
  script_set_attribute(attribute:"solution", value:
"Update the affected 1:libdwarf package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:libdwarf");
...
var pkgs = [
    {'reference':'libdwarf-0.9.2-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
