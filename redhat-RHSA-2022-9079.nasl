...
# extracted from Red Hat Security Advisory RHSA-2022:9079. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : thunderbird (RHSA-2022:9079)");
...
referenced in the RHSA-2022:9079 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_9079.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d879562d");
...
"Update the RHEL thunderbird package based on the guidance in RHSA-2022:9079.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'thunderbird-102.6.0-2.el7_9', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'thunderbird-102.6.0-2.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
