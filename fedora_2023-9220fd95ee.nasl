...
# extracted from Fedora Security Advisory FEDORA-2023-9220fd95ee
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-9220fd95ee");

  script_name(english:"Fedora 37 : java-1.8.0-openjdk (2023-9220fd95ee)");
...
FEDORA-2023-9220fd95ee advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-9220fd95ee");
...
var pkgs = [
    {'reference':'java-1.8.0-openjdk-1.8.0.362.b09-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
