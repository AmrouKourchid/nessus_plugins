...
# extracted from Red Hat Security Advisory RHSA-2024:0950. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:0950");
  script_xref(name:"IAVB", value:"2024-B-0009-S");

  script_name(english:"RHEL 9 : postgresql:15 (RHSA-2024:0950)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0950.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?edcd71b3");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2263384");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0950");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL postgresql:15 package based on the guidance in RHSA-2024:0950.");
  ...
  'postgresql:15': [
    {
      ...
      'pkgs': [
        ...
        {'reference':'postgresql-15.6-1.module+el9.3.0+21283+b0ea34b6', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-contrib-15.6-1.module+el9.3.0+21283+b0ea34b6', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-docs-15.6-1.module+el9.3.0+21283+b0ea34b6', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plperl-15.6-1.module+el9.3.0+21283+b0ea34b6', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plpython3-15.6-1.module+el9.3.0+21283+b0ea34b6', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-pltcl-15.6-1.module+el9.3.0+21283+b0ea34b6', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-private-devel-15.6-1.module+el9.3.0+21283+b0ea34b6', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-private-libs-15.6-1.module+el9.3.0+21283+b0ea34b6', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-15.6-1.module+el9.3.0+21283+b0ea34b6', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-devel-15.6-1.module+el9.3.0+21283+b0ea34b6', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-static-15.6-1.module+el9.3.0+21283+b0ea34b6', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-15.6-1.module+el9.3.0+21283+b0ea34b6', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-rpm-macros-15.6-1.module+el9.3.0+21283+b0ea34b6', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-upgrade-15.6-1.module+el9.3.0+21283+b0ea34b6', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-upgrade-devel-15.6-1.module+el9.3.0+21283+b0ea34b6', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
