...
# extracted from Fedora Security Advisory FEDORA-2023-ff372f9829
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-ff372f9829");

  script_name(english:"Fedora 37 : mingw-qt6-qtbase (2023-ff372f9829)");
...
FEDORA-2023-ff372f9829 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-ff372f9829");
  script_set_attribute(attribute:"solution", value:
"Update the affected mingw-qt6-qtbase package.");
...
var pkgs = [
    {'reference':'mingw-qt6-qtbase-6.5.1-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'mingw-qt6-qtbase');
}
