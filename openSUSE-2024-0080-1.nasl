...
# openSUSE Security Update openSUSE-SU-2024:0080-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : python-Django1 (openSUSE-SU-2024:0080-1)");
...
number.");
  ...
  # https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/BROIU2USAKIOU6XOT2YPTIGOODLQMAPF/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?45cac9e3");
...
var pkgs = [
    {'reference':'python3-Django1-1.11.29-bp155.4.9.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE}
];
