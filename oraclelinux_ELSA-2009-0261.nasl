...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : vnc (ELSA-2009-0261)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2009-0261.html");
...
"Update the affected vnc and / or vnc-server packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2008-4770");
...
var pkgs = [
    {'reference':'vnc-4.1.2-14.el5_3.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'vnc-server-4.1.2-14.el5_3.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'vnc-4.1.2-14.el5_3.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'vnc-server-4.1.2-14.el5_3.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
