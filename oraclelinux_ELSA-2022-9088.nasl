...
the ELSA-2022-9088 advisory.
    ...
    33699627] [Orabug: 33762471]  {CVE-2021-4155}
    - fix regression in 'epoll: Keep a reference on files added to the check list' (Al Viro)  [Orabug:
    33679854] [Orabug: 33762505]  {CVE-2021-1048} {CVE-2021-1048}
    - Bluetooth: fix use-after-free error in lock_sock_nested() (Wang ShaoBo)  [Orabug: 33406421]
    {CVE-2021-3752}
    - vt_kdsetmode: extend console locking (Linus Torvalds)  [Orabug: 33406445]  {CVE-2021-3753}
    - Bluetooth: SMP: Fail if remote and local public keys are identical (Luiz Augusto von Dentz)  [Orabug:
    33556779]  {CVE-2021-0129}
    - Bluetooth: use constant time memory comparison for secret values (Jason A. Donenfeld)  [Orabug:
    33556779]  {CVE-2021-0129}
...
var pkgs = [
    ...
    {'reference':'kernel-uek-doc-4.1.12-124.60.1.el6uek', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-doc-4.1.12'},
    {'reference':'kernel-uek-firmware-4.1.12-124.60.1.el6uek', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-firmware-4.1.12'},
    ...
    {'reference':'kernel-uek-doc-4.1.12-124.60.1.el7uek', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-doc-4.1.12'},
    {'reference':'kernel-uek-firmware-4.1.12-124.60.1.el7uek', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-firmware-4.1.12'}
];
