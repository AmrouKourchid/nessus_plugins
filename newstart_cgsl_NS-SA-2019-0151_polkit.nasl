...
# extracted from ZTE advisory NS-SA-2019-0151. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 4.05 : polkit Vulnerability (NS-SA-2019-0151)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 4.05, has polkit packages installed that are affected by a
vulnerability:
...
number.");
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/notice/NS-SA-2019-0151");
