...
advisory.
    ...
    the stable distribution (bullseye), this problem has been fixed in version 105.0.5195.102-1~deb11u1. We
    recommend that you upgrade your chromium packages. For the detailed security status of chromium please
