...
# extracted from Fedora Security Advisory FEDORA-2023-7ffeed7339
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-7ffeed7339");

  script_name(english:"Fedora 36 : tcpreplay (2023-7ffeed7339)");
...
FEDORA-2023-7ffeed7339 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-7ffeed7339");
...
var pkgs = [
    {'reference':'tcpreplay-4.4.3-3.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
