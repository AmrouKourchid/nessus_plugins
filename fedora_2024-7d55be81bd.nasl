...
# extracted from Fedora Security Advisory FEDORA-2024-7d55be81bd
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-7d55be81bd");

  script_name(english:"Fedora 40 : qpdf (2024-7d55be81bd)");
...
FEDORA-2024-7d55be81bd advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-7d55be81bd");
...
var pkgs = [
    {'reference':'qpdf-11.9.0-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
