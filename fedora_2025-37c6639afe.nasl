...
# extracted from Fedora Security Advisory FEDORA-2025-37c6639afe
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-37c6639afe");

  script_name(english:"Fedora 41 : cri-tools1.29 (2025-37c6639afe)");
...
FEDORA-2025-37c6639afe advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-37c6639afe");
  script_set_attribute(attribute:"solution", value:
"Update the affected cri-tools1.29 package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:cri-tools1.29");
...
var pkgs = [
    {'reference':'cri-tools1.29-1.29.0-11.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'cri-tools1.29');
}
