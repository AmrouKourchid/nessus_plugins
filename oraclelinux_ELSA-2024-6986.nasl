...
# extracted from Oracle Linux Security Advisory ELSA-2024-6986.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : nano (ELSA-2024-6986)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-6986.html");
...
"Update the affected nano package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:nano");
