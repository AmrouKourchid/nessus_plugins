...
# extracted from Fedora Security Advisory FEDORA-2024-9bef6cc6d4
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-9bef6cc6d4");

  script_name(english:"Fedora 41 : mysql8.0 (2024-9bef6cc6d4)");
...
FEDORA-2024-9bef6cc6d4 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-9bef6cc6d4");
...
var pkgs = [
    {'reference':'mysql8.0-8.0.40-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
