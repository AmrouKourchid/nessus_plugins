...
# extracted from Fedora Security Advisory FEDORA-2018-3247413570.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-3247413570");

  script_name(english:"Fedora 27 : ghostscript (2018-3247413570)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/cve-2018-10194");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-3247413570");
...
flag = 0;
if (rpm_check(release:"FC27", reference:"ghostscript-9.22-4.fc27")) flag++;
