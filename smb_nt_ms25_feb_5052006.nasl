...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5052006");
  script_xref(name:"MSFT", value:"MS25-5052006");
  ...
  script_name(english:"KB5052006: Windows 10 Version 1607 / Windows Server 2016 Security Update (February 2025)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5052006");
