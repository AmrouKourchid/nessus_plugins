...
# extracted from Debian Security Advisory DLA-2032-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2032-1 : cacti security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2019/12/msg00014.html");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"cacti", reference:"0.8.8b+dfsg-8+deb8u8")) flag++;
