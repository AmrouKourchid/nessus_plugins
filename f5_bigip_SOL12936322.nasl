...
# extracted from F5 Networks BIG-IP Solution K12936322.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2020-5912");
  script_xref(name:"IAVA", value:"2020-A-0395-S");

  script_name(english:"F5 Networks BIG-IP : BIG-IP restjavad vulnerability (K12936322)");
...
A locally authenticated attacker may exploit this vulnerability by
overwriting arbitrary files on the file system.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K12936322");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K12936322.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:N/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:L/UI:N/S:U/C:N/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-5912");
