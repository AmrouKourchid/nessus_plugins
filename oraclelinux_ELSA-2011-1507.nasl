...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2011-1507.html");
  script_set_attribute(attribute:"solution", value:
"Update the affected libarchive and / or libarchive-devel packages.");
...
var pkgs = [
    {'reference':'libarchive-2.8.3-3.el6_1', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libarchive-devel-2.8.3-3.el6_1', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libarchive-2.8.3-3.el6_1', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libarchive-devel-2.8.3-3.el6_1', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
];
