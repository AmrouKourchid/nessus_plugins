...
if (description)
{
  ...
  script_name(english:"Adobe Character Animator 4.0.0 < 4.4.7 / 22.0 < 22.4 Arbitrary code execution (APSB22-21)");
...
"The version of Adobe Character Animator installed on the remote Windows host is prior to 22.4, 4.4.7. It is, therefore,
