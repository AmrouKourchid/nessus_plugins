...
# extracted from Red Hat Security Advisory RHSA-2025:0743. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:0743");

  script_name(english:"RHEL 8 : keepalived (RHSA-2025:0743)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_0743.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e66047b6");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:0743");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL keepalived package based on the guidance in RHSA-2025:0743.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'keepalived-2.1.5-10.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
