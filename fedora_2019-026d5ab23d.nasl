...
# extracted from Fedora Security Advisory FEDORA-2019-026d5ab23d.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-026d5ab23d");

  script_name(english:"Fedora 29 : perl-Email-Address (2019-026d5ab23d)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-026d5ab23d");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"perl-Email-Address-1.912-1.fc29")) flag++;
