...
# extracted from Red Hat Security Advisory RHSA-2023:6057. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:6057");
  script_xref(name:"CEA-ID", value:"CEA-2024-0004");

  script_name(english:"RHEL 9 : toolbox (RHSA-2023:6057)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for toolbox.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2023:6057 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6057.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f52979cc");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6057");
...
"Update the RHEL toolbox package based on the guidance in RHSA-2023:6057.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'toolbox-0.0.99.3-4.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'toolbox-tests-0.0.99.3-4.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
