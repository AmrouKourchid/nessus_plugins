...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : expat (EulerOS-SA-2024-2884)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2884
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2c1788af");
...
var pkgs = [
  "expat-2.2.9-2.h12.eulerosv2r10"
];
