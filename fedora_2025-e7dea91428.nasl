...
# extracted from Fedora Security Advisory FEDORA-2025-e7dea91428
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-e7dea91428");
  script_xref(name:"IAVA", value:"2025-A-0306");

  script_name(english:"Fedora 41 : mingw-LibRaw (2025-e7dea91428)");
...
FEDORA-2025-e7dea91428 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-e7dea91428");
...
var pkgs = [
    {'reference':'mingw-LibRaw-0.21.4-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
