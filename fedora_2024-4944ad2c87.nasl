...
# extracted from Fedora Security Advisory FEDORA-2024-4944ad2c87
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-4944ad2c87");

  script_name(english:"Fedora 41 : pgadmin4 (2024-4944ad2c87)");
...
FEDORA-2024-4944ad2c87 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-4944ad2c87");
...
var pkgs = [
    {'reference':'pgadmin4-8.12-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
