...
# extracted from Fedora Security Advisory FEDORA-2023-71442d7613
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-71442d7613");

  script_name(english:"Fedora 37 : less (2023-71442d7613)");
...
FEDORA-2023-71442d7613 advisory.

    Security fix for CVE-2022-46663

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-71442d7613");
...
var pkgs = [
    {'reference':'less-633-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
