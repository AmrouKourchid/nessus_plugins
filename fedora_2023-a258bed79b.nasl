...
# extracted from Fedora Security Advisory FEDORA-2023-a258bed79b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-a258bed79b");

  script_name(english:"Fedora 36 : caddy (2023-a258bed79b)");
...
FEDORA-2023-a258bed79b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-a258bed79b");
...
"Update the affected caddy package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-29718");
...
var pkgs = [
    {'reference':'caddy-2.4.6-6.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
