...
if (description)
{
  ...
  script_cve_id("CVE-2016-1906");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2016-1906");
...
patch available.
  ...
  - Openshift allows remote attackers to gain privileges by updating a build configuration that was created
    with an allowed type to a type that is not allowed. (CVE-2016-1906)
