...
# extracted from Debian Security Advisory dsa-5750. The text
...
if (description)
{
  script_id(205755);
  script_version("1.1");
  script_set_attribute(attribute:"plugin_modification_date", value:"2024/08/18");

  script_cve_id("CVE-2023-48795");

  script_name(english:"Debian dsa-5750 : python-asyncssh-doc - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 12 host has packages installed that are affected by a vulnerability as referenced in the dsa-5750
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bookworm/python-asyncssh");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'python-asyncssh-doc', 'reference': '2.10.1-2+deb12u1'},
    {'release': '12.0', 'prefix': 'python3-asyncssh', 'reference': '2.10.1-2+deb12u1'}
];
