...
# extracted from openSUSE Security Update openSUSE-2020-1552.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : conmon / fuse-overlayfs / libcontainers-common / etc (openSUSE-2020-1552)");
...
project.");
  script_set_attribute(attribute:"see_also", value:"http://localhost/v1.40/_ping");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1162432");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1164090");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1165738");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1171578");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1174075");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1175821");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1175957");
  script_set_attribute(attribute:"see_also", value:"https://github.com//issues/7230]");
  script_set_attribute(attribute:"see_also", value:"https://github.com/SUSE/container-suseconnect/issues/41");
  script_set_attribute(attribute:"see_also", value:"https://github.com/containers/libpod/issues/4628");
  script_set_attribute(attribute:"see_also", value:"https://github.com/containers/libpod/issues/4907");
  script_set_attribute(attribute:"see_also", value:"https://github.com/containers/libpod/issues/5110");
  script_set_attribute(attribute:"see_also", value:"https://github.com/containers/libpod/issues/5219");
  script_set_attribute(attribute:"see_also", value:"https://github.com/containers/libpod/issues/5256");
  script_set_attribute(attribute:"see_also", value:"https://github.com/containers/libpod/issues/5411");
  script_set_attribute(attribute:"see_also", value:"https://github.com/containers/libpod/issues/5652");
  script_set_attribute(attribute:"see_also", value:"https://github.com/containers/libpod/issues/6212");
  script_set_attribute(attribute:"see_also", value:"https://github.com/containers/libpod/issues/6555");
  script_set_attribute(attribute:"see_also", value:"https://github.com/containers/libpod/issues/6596");
  script_set_attribute(attribute:"see_also", value:"https://github.com/containers/libpod/issues/6613");
  script_set_attribute(attribute:"solution", value:
"Update the affected conmon / fuse-overlayfs / libcontainers-common / etc packages.");
...
if ( rpm_check(release:"SUSE15.1", reference:"conmon-2.0.20-lp151.5.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"conmon-debuginfo-2.0.20-lp151.5.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"fuse-overlayfs-1.1.2-lp151.8.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"fuse-overlayfs-debuginfo-1.1.2-lp151.8.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"fuse-overlayfs-debugsource-1.1.2-lp151.8.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libcontainers-common-20200727-lp151.2.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"podman-2.0.6-lp151.3.21.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"podman-cni-config-2.0.6-lp151.3.21.1") ) flag++;
