...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : cloud-init (EulerOS-SA-2023-2576)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2576
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9b17f0ec");
...
var pkgs = [
  "cloud-init-17.1-16.h9.eulerosv2r9"
];
