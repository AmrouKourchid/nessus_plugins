...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.0 : libxml2 (EulerOS-SA-2024-1431)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1431
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e1d6d10e");
...
var pkgs = [
  "libxml2-2.9.12-5.h25.eulerosv2r11",
  "python3-libxml2-2.9.12-5.h25.eulerosv2r11"
];
