...
# extracted from openSUSE Security Update openSUSE-2019-2340.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : dhcp (openSUSE-2019-2340)");
...
if ( rpm_check(release:"SUSE15.0", reference:"dhcp-4.3.5-lp150.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"dhcp-client-4.3.5-lp150.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"dhcp-client-debuginfo-4.3.5-lp150.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"dhcp-debuginfo-4.3.5-lp150.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"dhcp-debugsource-4.3.5-lp150.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"dhcp-devel-4.3.5-lp150.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"dhcp-relay-4.3.5-lp150.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"dhcp-relay-debuginfo-4.3.5-lp150.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"dhcp-server-4.3.5-lp150.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"dhcp-server-debuginfo-4.3.5-lp150.5.3.1") ) flag++;
