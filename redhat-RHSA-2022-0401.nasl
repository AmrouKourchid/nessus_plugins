...
referenced in the RHSA-2022:0401 advisory.
    ...
    JBoss Enterprise Application Platform 7.4.2 and includes bug fixes and enhancements. See the Red Hat JBoss
    Enterprise Application Platform 7.4.3 Release Notes for information about the most significant bug fixes
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_0401.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b8cfc545");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/JBEAP-22642");
...
"Update the RHEL Red Hat JBoss Enterprise Application Platform 7.4.3 package based on the guidance in RHSA-2022:0401.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'eap7-hornetq-2.4.8-1.Final_redhat_00001.1.el8eap', 'release':'8', 'el_string':'el8eap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap7', 'cves':['CVE-2021-20318']},
      {'reference':'eap7-hornetq-commons-2.4.8-1.Final_redhat_00001.1.el8eap', 'release':'8', 'el_string':'el8eap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap7', 'cves':['CVE-2021-20318']},
      {'reference':'eap7-hornetq-core-client-2.4.8-1.Final_redhat_00001.1.el8eap', 'release':'8', 'el_string':'el8eap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap7', 'cves':['CVE-2021-20318']},
      {'reference':'eap7-hornetq-jms-client-2.4.8-1.Final_redhat_00001.1.el8eap', 'release':'8', 'el_string':'el8eap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap7', 'cves':['CVE-2021-20318']},
      {'reference':'eap7-undertow-2.2.13-1.SP2_redhat_00001.1.el8eap', 'release':'8', 'el_string':'el8eap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap7', 'cves':['CVE-2021-3859']}
    ]
  }
];
