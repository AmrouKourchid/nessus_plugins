...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : compat-libtiff3 (EulerOS-SA-2022-1526)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1526
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?065e1579");
...
var pkgs = [
  "compat-libtiff3-3.9.4-11.h28.eulerosv2r7"
];
