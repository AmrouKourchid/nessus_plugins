...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : dovecot on SL7.x x86_64 (20200903)");
...
"Security Fix(es) :
  ...
  - dovecot: Out of bound reads in dovecot NTLM
    implementation (CVE-2020-12673)

  - dovecot: Crash due to assert in RPA implementation
    (CVE-2020-12674)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind2009&L=SCIENTIFIC-LINUX-ERRATA&P=2371
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3d5f74e9");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"dovecot-2.2.36-6.el7_8.1")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"dovecot-debuginfo-2.2.36-6.el7_8.1")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"dovecot-devel-2.2.36-6.el7_8.1")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"dovecot-mysql-2.2.36-6.el7_8.1")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"dovecot-pgsql-2.2.36-6.el7_8.1")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"dovecot-pigeonhole-2.2.36-6.el7_8.1")) flag++;
