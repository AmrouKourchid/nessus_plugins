...
# Red Hat Security Advisory RHSA-2023:2866. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : git-lfs (CESA-2023:2866)");
...
"Update the affected git-lfs package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:git-lfs");
