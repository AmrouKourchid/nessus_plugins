...
referenced in the RHSA-2021:3327 advisory.
    ...
    * The memcg_params field of kmem_cache struct contains an old slab address that is to small for the
    current size of memcg_limited_groups_array_size. (BZ#1951810)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_3327.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2ff412bb");
