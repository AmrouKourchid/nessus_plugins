...
# extracted from Fedora Security Advisory FEDORA-2023-af75e27098
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-af75e27098");

  script_name(english:"Fedora 37 : mingw-python-werkzeug (2023-af75e27098)");
...
FEDORA-2023-af75e27098 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-af75e27098");
...
var pkgs = [
    {'reference':'mingw-python-werkzeug-2.2.3-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
