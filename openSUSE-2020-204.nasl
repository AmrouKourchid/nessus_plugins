...
# extracted from openSUSE Security Update openSUSE-2020-204.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : nginx (openSUSE-2020-204)");
...
"This update for nginx fixes the following issues :
  ...
  - CVE-2019-20372: Fixed an HTTP request smuggling with
    certain error_page configurations which could have
    allowed unauthorized web page reads (bsc#1160682). 

This update was imported from the SUSE:SLE-15-SP1:Update update
project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1160682");
...
if ( rpm_check(release:"SUSE15.1", reference:"nginx-1.14.2-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"nginx-debuginfo-1.14.2-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"nginx-debugsource-1.14.2-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"nginx-source-1.14.2-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"vim-plugin-nginx-1.14.2-lp151.4.6.1") ) flag++;
