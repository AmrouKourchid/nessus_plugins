...
# extracted from Debian Security Advisory dla-3635. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3635 : node-browserify-sign - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has a package installed that is affected by a vulnerability as referenced in the dla-3635
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/node-browserify-sign");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'node-browserify-sign', 'reference': '4.0.4-2+deb10u1'}
];
