...
# extracted from Fedora Security Advisory FEDORA-2023-1bb427c240
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-1bb427c240");

  script_name(english:"Fedora 39 : python3.8 (2023-1bb427c240)");
...
FEDORA-2023-1bb427c240 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-1bb427c240");
...
var pkgs = [
    {'reference':'python3.8-3.8.18-3.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
