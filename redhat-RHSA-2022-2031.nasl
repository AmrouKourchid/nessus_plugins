...
# extracted from Red Hat Security Advisory RHSA-2022:2031. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 8 : libssh (RHSA-2022:2031)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2022:2031 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_2031.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?86feae49");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libssh-0.9.6-3.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libssh-config-0.9.6-3.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libssh-devel-0.9.6-3.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
