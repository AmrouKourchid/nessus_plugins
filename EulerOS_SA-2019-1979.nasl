...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : nss-softokn (EulerOS-SA-2019-1979)");
...
vulnerability :
  ...
  - A cached side channel attack during handshakes using
    ...
    and affects all NSS versions prior to NSS
    3.41.(CVE-2018-12404)
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1979
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?afd0893f");
...
pkgs = ["nss-softokn-3.36.0-5.h6.eulerosv2r7",
        "nss-softokn-devel-3.36.0-5.h6.eulerosv2r7",
        "nss-softokn-freebl-3.36.0-5.h6.eulerosv2r7",
        "nss-softokn-freebl-devel-3.36.0-5.h6.eulerosv2r7"];
