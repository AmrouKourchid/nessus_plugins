...
if (description)
{
  ...
  script_name(english:"CentOS 9 : expat-2.5.0-4.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update for expat.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 9 host has packages installed that are affected by a vulnerability as referenced in the
expat-2.5.0-4.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=71548");
...
var pkgs = [
    {'reference':'expat-2.5.0-4.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'expat-devel-2.5.0-4.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'expat-static-2.5.0-4.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
