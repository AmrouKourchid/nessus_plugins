...
referenced in the USN-5124-1 advisory.
    ...
    It was discovered that GNU binutils incorrectly handled certain hash lookups. An attacker could use this
    issue to cause GNU binutils to crash, resulting in a denial of service, or possibly execute arbitrary
    code. (CVE-2020-16592)
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-16592");
