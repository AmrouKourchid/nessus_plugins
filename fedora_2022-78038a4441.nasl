...
# extracted from Fedora Security Advisory FEDORA-2022-78038a4441
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-78038a4441");

  script_name(english:"Fedora 36 : krb5 (2022-78038a4441)");
...
FEDORA-2022-78038a4441 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-78038a4441");
...
var pkgs = [
    {'reference':'krb5-1.19.2-12.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
