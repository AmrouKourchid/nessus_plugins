...
# extracted from Ubuntu Security Notice USN-5892-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5892-2");

  script_name(english:"Ubuntu 16.04 ESM : NSS vulnerability (USN-5892-2)");
...
USN-5892-2 advisory.
    ...
    USN-5892-1 fixed a vulnerability in NSS. This update provides the corresponding update for Ubuntu 14.04
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5892-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libnss3', 'pkgver': '2:3.28.4-0ubuntu0.16.04.14+esm4', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libnss3-1d', 'pkgver': '2:3.28.4-0ubuntu0.16.04.14+esm4', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libnss3-dev', 'pkgver': '2:3.28.4-0ubuntu0.16.04.14+esm4', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libnss3-nssdb', 'pkgver': '2:3.28.4-0ubuntu0.16.04.14+esm4', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libnss3-tools', 'pkgver': '2:3.28.4-0ubuntu0.16.04.14+esm4', 'ubuntu_pro': TRUE}
];
