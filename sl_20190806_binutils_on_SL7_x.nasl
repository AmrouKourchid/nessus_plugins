...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : binutils on SL7.x x86_64 (20190806)");
...
"Security Fix(es) :
  ...
  - binutils: Stack Exhaustion in the demangling functions
    provided by libiberty (CVE-2018-12641)

  - binutils: NULL pointer dereference in
    work_stuff_copy_to_from in cplus- dem.c.
    (CVE-2018-12697)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1908&L=SCIENTIFIC-LINUX-ERRATA&P=27009
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d1993caf");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"binutils-2.27-41.base.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"binutils-debuginfo-2.27-41.base.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"binutils-devel-2.27-41.base.el7")) flag++;
