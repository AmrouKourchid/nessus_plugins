...
# AlmaLinux Security Advisory ALSA-2024:4861.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:4861");

  script_name(english:"AlmaLinux 9 : squid (ALSA-2024:4861)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2024-4861.html");
...
var pkgs = [
    {'reference':'squid-5.5-13.el9_4', 'cpu':'aarch64', 'release':'9', 'el_string':'el9_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
    {'reference':'squid-5.5-13.el9_4', 'cpu':'ppc64le', 'release':'9', 'el_string':'el9_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
    {'reference':'squid-5.5-13.el9_4', 'cpu':'s390x', 'release':'9', 'el_string':'el9_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
    {'reference':'squid-5.5-13.el9_4', 'cpu':'x86_64', 'release':'9', 'el_string':'el9_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
];
