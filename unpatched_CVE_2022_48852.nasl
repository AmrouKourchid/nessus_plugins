...
if (description)
{
  ...
  script_cve_id("CVE-2022-48852");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-48852");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: drm/vc4: hdmi: Unregister codec device
    on unbind On bind we will register the HDMI codec device but we don't unregister it on unbind, leading to
    a device leakage. Unregister our device at unbind. (CVE-2022-48852)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-48852");
