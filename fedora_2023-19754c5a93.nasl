...
# extracted from Fedora Security Advisory FEDORA-2023-19754c5a93
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-19754c5a93");

  script_name(english:"Fedora 37 : webkitgtk (2023-19754c5a93)");
...
FEDORA-2023-19754c5a93 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-19754c5a93");
...
var pkgs = [
    {'reference':'webkitgtk-2.40.5-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
