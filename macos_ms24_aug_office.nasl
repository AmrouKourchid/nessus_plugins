...
if (description)
{
  ...
  script_cve_id("CVE-2024-38170", "CVE-2024-38171", "CVE-2024-38172");
  script_xref(name:"IAVA", value:"2024-A-0494");
  script_xref(name:"IAVA", value:"2024-A-0492");

  script_name(english:"Security Updates for Microsoft Office Products (August 2024) (macOS)");
...
referenced in the august-13-2024 advisory.

  - Microsoft Excel Remote Code Execution Vulnerability (CVE-2024-38170, CVE-2024-38172)

  - Microsoft PowerPoint Remote Code Execution Vulnerability (CVE-2024-38171)

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  # https://learn.microsoft.com/en-us/officeupdates/release-notes-office-for-mac#august-13-2024
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?268e87d3");
  script_set_attribute(attribute:"solution", value:
"Update to Office for Mac version 16.88 or later.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:N/UI:R/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-38172");
...
var constraints = [
  { 'fixed_version' : '16.88', 'fixed_display' : 'Version 16.88 (Build 24081116)' }
];
