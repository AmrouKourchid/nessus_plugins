...
# extracted from VMware Security Advisory PHSA-2024-4.0-0668. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2024-24784", "CVE-2024-24787", "CVE-2024-24791");
  script_xref(name:"IAVB", value:"2024-B-0020-S");
  script_xref(name:"IAVB", value:"2024-B-0052-S");

  script_name(english:"Photon OS 4.0: Go PHSA-2024-4.0-0668");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the go package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-668.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'go-1.21.12-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'go-md2man-2.0.0-25.ph4')) flag++;
