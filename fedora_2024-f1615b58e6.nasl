...
# extracted from Fedora Security Advisory FEDORA-2024-f1615b58e6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-f1615b58e6");

  script_name(english:"Fedora 40 : python-fastapi / python-openapi-core / python-platformio / etc (2024-f1615b58e6)");
...
FEDORA-2024-f1615b58e6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-f1615b58e6");
...
var pkgs = [
    {'reference':'python-fastapi-0.111.1-7.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python-openapi-core-0.19.4-3.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python-platformio-6.1.14-7.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python-starlette-0.40.0-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
