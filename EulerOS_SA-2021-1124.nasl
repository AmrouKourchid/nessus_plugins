...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : subversion (EulerOS-SA-2021-1124)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1124
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ee784e88");
...
pkgs = ["mod_dav_svn-1.7.14-11.h3",
        "subversion-1.7.14-11.h3",
        "subversion-libs-1.7.14-11.h3"];
