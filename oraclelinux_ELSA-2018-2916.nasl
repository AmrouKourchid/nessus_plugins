...
# extracted from Red Hat Security Advisory RHSA-2018:2916 and 
# Oracle Linux Security Advisory ELSA-2018-2916 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : spamassassin (ELSA-2018-2916)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2018-2916.html");
...
var pkgs = [
    {'reference':'spamassassin-3.4.0-4.el7_5', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'spamassassin-3.4.0-4.el7_5', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
];
