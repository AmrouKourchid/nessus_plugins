...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2012/rhsa-2012_1376.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?52236e76");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2012:1376");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=843335");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL jboss-ec2-eap package based on the guidance in RHSA-2012:1376.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:P/I:N/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:L/UI:N/S:U/C:H/I:N/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2012-3427");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jboss-ec2-eap-5.1.2-8.11.ep5.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap5'}
    ]
  }
];
