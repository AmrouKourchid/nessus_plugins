...
if (description)
{
  ...
  script_cve_id("CVE-2015-5232");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2015-5232");
...
patch available.
  ...
  - Race conditions in opa-fm before 10.4.0.0.196 and opa-ff before 10.4.0.0.197. (CVE-2015-5232)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-5232");
