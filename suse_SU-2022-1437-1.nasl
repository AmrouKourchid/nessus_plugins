...
# SUSE update advisory SUSE-SU-2022:1437-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:1437-1");

  script_name(english:"SUSE SLES15 Security Update : buildah (SUSE-SU-2022:1437-1)");
...
in the SUSE-SU-2022:1437-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-April/010855.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fa8ed597");
...
var pkgs = [
    {'reference':'buildah-1.25.1-150300.8.6.1', 'sp':'3', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.3']},
    {'reference':'buildah-1.25.1-150300.8.6.1', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.3', 'sle-module-containers-release-15.3', 'sles-release-15.3']}
];
