...
# SUSE update advisory SUSE-SU-2024:2270-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2024:2270-1");
  script_xref(name:"IAVB", value:"2024-B-0087-S");

  script_name(english:"SUSE SLES12 Security Update : squid (SUSE-SU-2024:2270-1)");
...
in the SUSE-SU-2024:2270-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0c967e14");
...
var pkgs = [
    {'reference':'squid-4.17-4.50.1', 'sp':'5', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5']},
    {'reference':'squid-4.17-4.50.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.5']}
];
