...
# extracted from Red Hat Security Advisory RHSA-2024:2353. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2353");

  script_name(english:"RHEL 9 : mingw components (RHSA-2024:2353)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for mingw components.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2353.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8e343121");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2353");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2180905");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-24343");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-24347");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-24350");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-24357");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-24368");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-24381");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-24400");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL mingw components package based on the guidance in RHSA-2024:2353.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'mingw-binutils-generic-2.41-3.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mingw32-binutils-2.41-3.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mingw64-binutils-2.41-3.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'mingw-binutils-generic / mingw32-binutils / mingw64-binutils');
}
