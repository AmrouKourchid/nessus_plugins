...
# extracted from Red Hat Security Advisory RHSA-2023:5405. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:5405");

  script_name(english:"RHEL 8 : virt:av and virt-devel:av (RHSA-2023:5405)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for virt:av / virt-devel:av.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2023:5405 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_5405.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0fd88bb8");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2236130");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:5405");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL virt:av / virt-devel:av packages based on the guidance in RHSA-2023:5405.");
  ...
  'virt-devel:av': [
    {
      ...
      'pkgs': [
        ...
        {'reference':'qemu-kvm-tests-5.2.0-16.module+el8.4.0+18177+78c83690.19', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-tests-5.2.0-16.module+el8.4.0+18177+78c83690.19', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-tests-5.2.0-16.module+el8.4.0+18177+78c83690.19', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
  ...
  'virt:av': [
    {
      ...
      'pkgs': [
        ...
        {'reference':'qemu-guest-agent-5.2.0-16.module+el8.4.0+18177+78c83690.19', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-guest-agent-5.2.0-16.module+el8.4.0+18177+78c83690.19', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-guest-agent-5.2.0-16.module+el8.4.0+18177+78c83690.19', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-img-5.2.0-16.module+el8.4.0+18177+78c83690.19', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-img-5.2.0-16.module+el8.4.0+18177+78c83690.19', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-img-5.2.0-16.module+el8.4.0+18177+78c83690.19', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kiwi-5.2.0-16.module+el8.4.0+18177+78c83690.19', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kiwi-5.2.0-16.module+el8.4.0+18177+78c83690.19', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kiwi-5.2.0-16.module+el8.4.0+18177+78c83690.19', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-5.2.0-16.module+el8.4.0+18177+78c83690.19', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-5.2.0-16.module+el8.4.0+18177+78c83690.19', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-5.2.0-16.module+el8.4.0+18177+78c83690.19', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-block-curl-5.2.0-16.module+el8.4.0+18177+78c83690.19', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-block-curl-5.2.0-16.module+el8.4.0+18177+78c83690.19', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-block-curl-5.2.0-16.module+el8.4.0+18177+78c83690.19', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-block-gluster-5.2.0-16.module+el8.4.0+18177+78c83690.19', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-block-iscsi-5.2.0-16.module+el8.4.0+18177+78c83690.19', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-block-iscsi-5.2.0-16.module+el8.4.0+18177+78c83690.19', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-block-iscsi-5.2.0-16.module+el8.4.0+18177+78c83690.19', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-block-rbd-5.2.0-16.module+el8.4.0+18177+78c83690.19', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-block-rbd-5.2.0-16.module+el8.4.0+18177+78c83690.19', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-block-rbd-5.2.0-16.module+el8.4.0+18177+78c83690.19', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-block-ssh-5.2.0-16.module+el8.4.0+18177+78c83690.19', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-block-ssh-5.2.0-16.module+el8.4.0+18177+78c83690.19', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-block-ssh-5.2.0-16.module+el8.4.0+18177+78c83690.19', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-common-5.2.0-16.module+el8.4.0+18177+78c83690.19', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-common-5.2.0-16.module+el8.4.0+18177+78c83690.19', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-common-5.2.0-16.module+el8.4.0+18177+78c83690.19', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-core-5.2.0-16.module+el8.4.0+18177+78c83690.19', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-core-5.2.0-16.module+el8.4.0+18177+78c83690.19', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-core-5.2.0-16.module+el8.4.0+18177+78c83690.19', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-docs-5.2.0-16.module+el8.4.0+18177+78c83690.19', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-docs-5.2.0-16.module+el8.4.0+18177+78c83690.19', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-docs-5.2.0-16.module+el8.4.0+18177+78c83690.19', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-ui-opengl-5.2.0-16.module+el8.4.0+18177+78c83690.19', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-ui-spice-5.2.0-16.module+el8.4.0+18177+78c83690.19', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
