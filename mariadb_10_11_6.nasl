...
if (description)
{
  ...
  script_name(english:"MariaDB 10.11.0 < 10.11.6");

  script_set_attribute(attribute:"synopsis", value:
"The remote database server is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of MariaDB installed on the remote host is prior to 10.11.6. It is, therefore, affected by a vulnerability
as referenced in the mdb-10-11-6-rn advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://mariadb.com/kb/en/mdb-10-11-6-rn");
  script_set_attribute(attribute:"solution", value:
"Upgrade to MariaDB version 10.11.6 or later.");
...
var constraints = [
  { 'min_version' : '10.11', 'fixed_version' : '10.11.6' }
];
