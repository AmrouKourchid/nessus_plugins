...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.2 : gnupg2 (EulerOS-SA-2023-1256)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1256
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d45cbcbc");
...
var pkgs = [
  "gnupg2-2.0.22-5.h4.eulerosv2r7"
];
