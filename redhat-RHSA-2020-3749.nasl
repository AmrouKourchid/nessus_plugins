...
# extracted from Red Hat Security Advisory RHSA-2020:3749. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:3749");

  script_name(english:"RHEL 8 : librepo (RHSA-2020:3749)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for librepo.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2020:3749 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_3749.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9deedd5c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:3749");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1866498");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL librepo package based on the guidance in RHSA-2020:3749.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'librepo-1.10.3-4.el8_1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-librepo-1.10.3-4.el8_1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
