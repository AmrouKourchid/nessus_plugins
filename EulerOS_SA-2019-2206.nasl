...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : libidn (EulerOS-SA-2019-2206)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2206
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9709029b");
...
pkgs = ["libidn-1.28-4.2.h5.eulerosv2r7"];
