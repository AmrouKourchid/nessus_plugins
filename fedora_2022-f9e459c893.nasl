...
# extracted from Fedora Security Advisory FEDORA-2022-f9e459c893
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-f9e459c893");

  script_name(english:"Fedora 37 : python-notebook (2022-f9e459c893)");
...
FEDORA-2022-f9e459c893 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-f9e459c893");
...
var pkgs = [
    {'reference':'python-notebook-6.4.11-3.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
