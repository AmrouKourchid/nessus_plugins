...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP12 : haproxy (EulerOS-SA-2025-1297)");
...
the following vulnerabilities :
    ...
    Control List) set on the product. As a result, the attacker may obtain sensitive
    information.(CVE-2024-53008)
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1297
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?86b02921");
...
var pkgs = [
  "haproxy-2.6.6-2.h14.eulerosv2r12"
];
