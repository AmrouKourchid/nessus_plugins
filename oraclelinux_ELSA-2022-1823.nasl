...
# extracted from Oracle Linux Security Advisory ELSA-2022-1823.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : mod_auth_openidc:2.3 (ELSA-2022-1823)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ELSA-2022-1823 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2022-1823.html");
...
var appstreams = {
    'mod_auth_openidc:2.3': [
      ...
      {'reference':'mod_auth_openidc-2.3.7-11.module+el8.6.0+20572+b6f23e95', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'mod_auth_openidc-2.3.7-11.module+el8.6.0+20572+b6f23e95', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
};
