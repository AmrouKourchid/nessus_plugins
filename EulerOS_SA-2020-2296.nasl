...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : python-lxml (EulerOS-SA-2020-2296)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2296
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b80f92c9");
...
pkgs = ["python-lxml-3.2.1-4.h2.eulerosv2r7"];
