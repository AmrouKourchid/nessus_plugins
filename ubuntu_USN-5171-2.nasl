...
# extracted from Ubuntu Security Notice USN-5171-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5171-2");

  script_name(english:"Ubuntu 16.04 ESM : Long Range ZIP vulnerabilities (USN-5171-2)");
...
the USN-5171-2 advisory.

    USN-5171-1 fixed vulnerabilities in Long Range ZIP. This update provides the corresponding updates for
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5171-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'lrzip', 'pkgver': '0.621-1ubuntu0.1~esm1', 'ubuntu_pro': TRUE}
];
