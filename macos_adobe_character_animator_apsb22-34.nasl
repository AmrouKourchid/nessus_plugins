...
if (description)
{
  ...
  script_name(english:"Adobe Character Animator 4.0.0 < 22.5.0 / 22.0 < 22.5 Multiple Arbitrary code execution (APSB22-34) (macOS)");
...
"The version of Adobe Character Animator installed on the remote macOS host is prior to 22.5, 22.5.0. It is, therefore,
