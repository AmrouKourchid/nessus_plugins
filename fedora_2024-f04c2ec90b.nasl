...
# extracted from Fedora Security Advisory FEDORA-2024-f04c2ec90b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-f04c2ec90b");
  script_xref(name:"IAVB", value:"2024-B-0044-S");

  script_name(english:"Fedora 39 : pgadmin4 (2024-f04c2ec90b)");
...
FEDORA-2024-f04c2ec90b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-f04c2ec90b");
...
"Update the affected pgadmin4 package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-3116");

  script_set_attribute(attribute:"exploitability_ease", value:"Exploits are available");
  script_set_attribute(attribute:"exploit_available", value:"true");
  script_set_attribute(attribute:"metasploit_name", value:'pgAdmin Binary Path API RCE');
...
var pkgs = [
    {'reference':'pgadmin4-7.8-5.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
