...
# extracted from Red Hat Security Advisory RHSA-2024:6827. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:6827");

  script_name(english:"RHEL 9 : OpenShift Container Platform 4.16.14 (RHSA-2024:6827)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for OpenShift Container Platform 4.16.14.");
...
the RHSA-2024:6827 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.16.14. See the
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_6827.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f4dde373");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:6827");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.16.14 package based on the guidance in RHSA-2024:6827.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-webob-1.8.8-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
