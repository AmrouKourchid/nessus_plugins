...
# extracted from Fedora Security Advisory FEDORA-2023-ca393d660a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-ca393d660a");

  script_name(english:"Fedora 37 : edk2 (2023-ca393d660a)");
...
FEDORA-2023-ca393d660a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-ca393d660a");
...
var pkgs = [
    {'reference':'edk2-20230301gitf80f052277c8-26.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
