...
# extracted from VMware Security Advisory PHSA-2021-1.0-0394. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Dhcp PHSA-2021-1.0-0394");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the dhcp package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-1.0-394.md");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'dhcp-client-4.3.5-6.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'dhcp-devel-4.3.5-6.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'dhcp-libs-4.3.5-6.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'dhcp-server-4.3.5-6.ph1')) flag++;
