...
referenced in the RHSA-2015:2101 advisory.
  ...
  - python: multiple unbound readline() DoS flaws in python stdlib (CVE-2013-1752)

  - python: XMLRPC library unrestricted decompression of HTTP responses using gzip enconding (CVE-2013-1753)

  - python: missing boundary check in JSON module (CVE-2014-4616)

  - python: CGIHTTPServer module does not properly handle URL-encoded path separators in URLs (CVE-2014-4650)

  - python: buffer() integer overflow leading to out of bounds read (CVE-2014-7185)

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2015/rhsa-2015_2101.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4d814831");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/articles/2039753");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2015:2101");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1058482");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1177613");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1181624");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1237107");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1250611");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1259421");
  script_set_attribute(attribute:"see_also", value:"https://www.python.org/dev/peps/pep-0466/");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python-2.7.5-34.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python-debug-2.7.5-34.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python-devel-2.7.5-34.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python-libs-2.7.5-34.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python-test-2.7.5-34.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python-tools-2.7.5-34.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tkinter-2.7.5-34.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
