...
# extracted from ZTE advisory NS-SA-2021-0108. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.04 / MAIN 5.04 : logrotate Multiple Vulnerabilities (NS-SA-2021-0108)");

  script_set_attribute(attribute:"synopsis", value:
"The remote NewStart CGSL host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version CORE 5.04 / MAIN 5.04, has logrotate packages installed that are affected
...
number.");
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/notice/NS-SA-2021-0108");
...
var pkgs = {
  'CGSL CORE 5.04': [
    'logrotate-3.8.6-17.el7.cgslv5_4.0.1.g318e71c',
    'logrotate-debuginfo-3.8.6-17.el7.cgslv5_4.0.1.g318e71c'
  ],
  'CGSL MAIN 5.04': [
    'logrotate-3.8.6-17.el7.cgslv5_4.0.1.g318e71c',
    'logrotate-debuginfo-3.8.6-17.el7.cgslv5_4.0.1.g318e71c'
