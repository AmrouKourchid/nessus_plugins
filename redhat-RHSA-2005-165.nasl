...
# extracted from Red Hat Security Advisory RHSA-2005:165. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 4 : rsh (RHSA-2005:165)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for rsh.");
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2005/rhsa-2005_165.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4a3edc73");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=146978");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=146979");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2005:165");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rsh package based on the guidance in RHSA-2005:165.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:N/I:P/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:H/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2004-0175");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rsh-0.17-25.3', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsh-0.17-25.3', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsh-0.17-25.3', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsh-0.17-25.3', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsh-0.17-25.3', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsh-server-0.17-25.3', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsh-server-0.17-25.3', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsh-server-0.17-25.3', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsh-server-0.17-25.3', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsh-server-0.17-25.3', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
