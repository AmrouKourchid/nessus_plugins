...
# extracted from Fedora Security Advisory FEDORA-2023-492105ed08
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-492105ed08");

  script_name(english:"Fedora 38 : community-mysql (2023-492105ed08)");
...
FEDORA-2023-492105ed08 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-492105ed08");
...
"Update the affected community-mysql package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-21929");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2023-22053");
...
var pkgs = [
    {'reference':'community-mysql-8.0.34-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
