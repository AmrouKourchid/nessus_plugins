...
# extracted from Amazon Linux 2023 Security Advisory ALAS2023-2024-498.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2023 : amazon-cloudwatch-agent (ALAS2023-2024-498)");
...
"It is, therefore, affected by multiple vulnerabilities as referenced in the ALAS2023-2024-498 advisory.
    ...
    2024-02-29: CVE-2023-47108 was added to this advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2023/ALAS-2024-498.html");
...
"Run 'dnf update amazon-cloudwatch-agent --releasever 2023.3.20240122' to update your system.");
...
var pkgs = [
    {'reference':'amazon-cloudwatch-agent-1.300032.3-1.amzn2023', 'cpu':'aarch64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'amazon-cloudwatch-agent-1.300032.3-1.amzn2023', 'cpu':'x86_64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE}
];
