...
# extracted from Red Hat Security Advisory RHSA-2025:1670. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:1670");

  script_name(english:"RHEL 9 : bind9.18 (RHSA-2025:1670)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for bind9.18.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2025:1670 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2342880");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_1670.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?eb156df3");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:1670");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL bind9.18 package based on the guidance in RHSA-2025:1670.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:bind9.18");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:bind9.18-chroot");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:bind9.18-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:bind9.18-dnssec-utils");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:bind9.18-doc");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:bind9.18-libs");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:bind9.18-utils");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'bind9.18-9.18.29-1.el9_5.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind9.18-chroot-9.18.29-1.el9_5.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind9.18-devel-9.18.29-1.el9_5.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind9.18-dnssec-utils-9.18.29-1.el9_5.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind9.18-doc-9.18.29-1.el9_5.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind9.18-libs-9.18.29-1.el9_5.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind9.18-utils-9.18.29-1.el9_5.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'bind9.18 / bind9.18-chroot / bind9.18-devel / bind9.18-dnssec-utils / etc');
}
