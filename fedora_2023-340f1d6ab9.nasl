...
# extracted from Fedora Security Advisory FEDORA-2023-340f1d6ab9
#
...
if (description)
{
  ...
  script_cve_id("CVE-2022-4292", "CVE-2023-0288");
  script_xref(name:"FEDORA", value:"2023-340f1d6ab9");
  script_xref(name:"IAVB", value:"2023-B-0016-S");
  script_xref(name:"IAVB", value:"2023-B-0018-S");

  script_name(english:"Fedora 36 : vim (2023-340f1d6ab9)");
...
FEDORA-2023-340f1d6ab9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-340f1d6ab9");
...
"Update the affected 2:vim package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-0288");
...
var pkgs = [
    {'reference':'vim-9.0.1262-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
