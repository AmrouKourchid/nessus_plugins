...
# extracted from openSUSE Security Update openSUSE-2021-555.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : clamav (openSUSE-2021-555)");
...
"This update for clamav fixes the following issues :
  ...
  - CVE-2021-1405: Fix for mail parser NULL-dereference
    crash. (bsc#1184534)
...
This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1181256");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1184532");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1184533");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1184534");
...
if ( rpm_check(release:"SUSE15.2", reference:"clamav-0.103.2-lp152.6.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"clamav-debuginfo-0.103.2-lp152.6.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"clamav-debugsource-0.103.2-lp152.6.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"clamav-devel-0.103.2-lp152.6.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libclamav9-0.103.2-lp152.6.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libclamav9-debuginfo-0.103.2-lp152.6.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libfreshclam2-0.103.2-lp152.6.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libfreshclam2-debuginfo-0.103.2-lp152.6.6.1") ) flag++;
