...
# extracted from Red Hat Security Advisory RHSA-2023:1524. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:1524");

  script_name(english:"RHEL 8 : OpenShift Container Platform 4.9.59 (RHSA-2023:1524)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for OpenShift Container Platform 4.9.59.");
...
the RHSA-2023:1524 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.9.59. See the following
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_1524.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c186b380");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/OCPBUGS-11081");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:1524");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.9.59 package based on the guidance in RHSA-2023:1524.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jenkins-2-plugins-4.9.1680069756-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
