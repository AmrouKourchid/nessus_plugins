...
# extracted from Fedora Security Advisory FEDORA-2023-078e257f1c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-078e257f1c");

  script_name(english:"Fedora 37 : python-requests (2023-078e257f1c)");
...
FEDORA-2023-078e257f1c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-078e257f1c");
...
var pkgs = [
    {'reference':'python-requests-2.28.1-3.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
