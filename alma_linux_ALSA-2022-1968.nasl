...
# AlmaLinux Security Advisory ALSA-2022:1968.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2022:1968");

  script_name(english:"AlmaLinux 8 : libsndfile (ALSA-2022:1968)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2022-1968.html");
