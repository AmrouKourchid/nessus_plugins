...
# extracted from Red Hat Security Advisory RHSA-2024:2570. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2570");

  script_name(english:"RHEL 9 : gnutls (RHSA-2024:2570)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for gnutls.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:2570 advisory.

    The gnutls package provide the GNU Transport Layer Security (GnuTLS) library, which implements
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2570.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ff8b5fa5");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2570");
...
"Update the RHEL gnutls package based on the guidance in RHSA-2024:2570.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gnutls-3.8.3-4.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gnutls-c++-3.8.3-4.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gnutls-dane-3.8.3-4.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gnutls-devel-3.8.3-4.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gnutls-utils-3.8.3-4.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'gnutls-3.8.3-4.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gnutls-c++-3.8.3-4.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gnutls-dane-3.8.3-4.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gnutls-devel-3.8.3-4.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gnutls-utils-3.8.3-4.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
