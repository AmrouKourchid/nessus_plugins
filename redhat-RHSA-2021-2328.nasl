...
# extracted from Red Hat Security Advisory RHSA-2021:2328. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : qt5-qtimageformats (RHSA-2021:2328)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for qt5-qtimageformats.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2021:2328 advisory.

    The Qt Image Formats in an add-on module for the core Qt Gui library that provides support for additional
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_2328.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?18207ad0");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:2328");
...
"Update the RHEL qt5-qtimageformats package based on the guidance in RHSA-2021:2328.");
...
var constraints = [
  {
    ...
    'pkgs': [
      ...
      {'reference':'qt5-qtimageformats-5.9.7-2.el7_9', 'cpu':'ppc', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'qt5-qtimageformats-5.9.7-2.el7_9', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'qt5-qtimageformats-5.9.7-2.el7_9', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'qt5-qtimageformats-5.9.7-2.el7_9', 'cpu':'s390', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'qt5-qtimageformats-5.9.7-2.el7_9', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
