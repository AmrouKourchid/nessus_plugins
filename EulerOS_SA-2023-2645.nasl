...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : haproxy (EulerOS-SA-2023-2645)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2645
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4e684e84");
...
var pkgs = [
  "haproxy-2.4.8-2.h3.eulerosv2r11"
];
