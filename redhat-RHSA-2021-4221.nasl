...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_4221.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b3be7f6a");
...
"Update the RHEL container-tools:2.0 package based on the guidance in RHSA-2021:4221.");
  ...
  'container-tools:2.0': [
    {
      ...
      'pkgs': [
        {'reference':'buildah-1.11.6-9.module+el8.5.0+12239+ec01067b', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'buildah-tests-1.11.6-9.module+el8.5.0+12239+ec01067b', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'cockpit-podman-11-1.module+el8.5.0+10223+f7559c42', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
        {'reference':'conmon-2.0.15-1.module+el8.5.0+10223+f7559c42', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'container-selinux-2.130.0-1.module+el8.5.0+10223+f7559c42', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'containernetworking-plugins-0.8.3-4.module+el8.5.0+10223+f7559c42', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'containers-common-0.1.41-4.module+el8.5.0+10223+f7559c42', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'crit-3.12-9.module+el8.5.0+10223+f7559c42', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'criu-3.12-9.module+el8.5.0+10223+f7559c42', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'fuse-overlayfs-0.7.8-1.module+el8.5.0+10223+f7559c42', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'podman-1.6.4-26.module+el8.5.0+10223+f7559c42', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'podman-docker-1.6.4-26.module+el8.5.0+10223+f7559c42', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'podman-remote-1.6.4-26.module+el8.5.0+10223+f7559c42', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'podman-tests-1.6.4-26.module+el8.5.0+10223+f7559c42', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python-podman-api-1.2.0-0.2.gitd0a45fe.module+el8.5.0+10223+f7559c42', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-criu-3.12-9.module+el8.5.0+10223+f7559c42', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'runc-1.0.0-66.rc10.module+el8.5.0+11041+627a5cdc', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'skopeo-0.1.41-4.module+el8.5.0+10223+f7559c42', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'skopeo-tests-0.1.41-4.module+el8.5.0+10223+f7559c42', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'slirp4netns-0.4.2-3.git21fdece.module+el8.5.0+10223+f7559c42', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'toolbox-0.0.7-1.module+el8.5.0+10223+f7559c42', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'udica-0.2.1-2.module+el8.5.0+10223+f7559c42', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
