...
"The version of Firefox installed on the remote Windows host is prior to 135.0.1. It is, therefore, affected by a
vulnerability as referenced in the mfsa2025-12 advisory.
...
mozilla_check_version(installs:installs, product:'firefox', esr:FALSE, fix:'135.0.1', severity:SECURITY_HOLE);
