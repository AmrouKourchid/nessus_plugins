...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : mariadb (EulerOS-SA-2021-1327)");
...
vulnerability :
  ...
  - Vulnerability in the MySQL Server product of Oracle
    MySQL (component: Server: Optimizer). Supported
    versions that are affected are 5.6.45 and prior, 5.7.27
    and prior and 8.0.17 and prior. Easily exploitable
    ...
    Server.(CVE-2019-2974)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1327
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1ec6da14");
...
pkgs = ["mariadb-5.5.60-1.h3",
        "mariadb-bench-5.5.60-1.h3",
        "mariadb-devel-5.5.60-1.h3",
        "mariadb-libs-5.5.60-1.h3",
        "mariadb-server-5.5.60-1.h3"];
