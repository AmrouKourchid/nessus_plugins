...
# extracted from Debian Security Advisory dla-3129. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3129 : gdal-bin - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/gdal");
  script_set_attribute(attribute:"solution", value:
"Upgrade the gdal-bin packages.");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'gdal-bin', 'reference': '2.4.0+dfsg-1+deb10u1'},
    {'release': '10.0', 'prefix': 'gdal-data', 'reference': '2.4.0+dfsg-1+deb10u1'},
    {'release': '10.0', 'prefix': 'libgdal-dev', 'reference': '2.4.0+dfsg-1+deb10u1'},
    {'release': '10.0', 'prefix': 'libgdal-doc', 'reference': '2.4.0+dfsg-1+deb10u1'},
    {'release': '10.0', 'prefix': 'libgdal-java', 'reference': '2.4.0+dfsg-1+deb10u1'},
    {'release': '10.0', 'prefix': 'libgdal-perl', 'reference': '2.4.0+dfsg-1+deb10u1'},
    {'release': '10.0', 'prefix': 'libgdal-perl-doc', 'reference': '2.4.0+dfsg-1+deb10u1'},
    {'release': '10.0', 'prefix': 'libgdal20', 'reference': '2.4.0+dfsg-1+deb10u1'},
    {'release': '10.0', 'prefix': 'python-gdal', 'reference': '2.4.0+dfsg-1+deb10u1'},
    {'release': '10.0', 'prefix': 'python3-gdal', 'reference': '2.4.0+dfsg-1+deb10u1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'gdal-bin / gdal-data / libgdal-dev / libgdal-doc / libgdal-java / etc');
}
