...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : python-pip on SL7.x (noarch) (20200512)");
...
"Security Fix(es) :
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind2006&L=SCIENTIFIC-LINUX-ERRATA&P=1031
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7b4fe177");
...
flag = 0;
if (rpm_check(release:"SL7", reference:"python3-pip-9.0.3-7.el7_8")) flag++;
