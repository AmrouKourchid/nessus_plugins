...
# extracted from ZTE advisory NS-SA-2020-0089. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.05 / MAIN 5.05 : python3 Multiple Vulnerabilities (NS-SA-2020-0089)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/notice/NS-SA-2020-0089");
...
pkgs = {
  'CGSL CORE 5.05': [
    ...
    'python3-debug-3.6.8-13.el7',
    'python3-devel-3.6.8-13.el7',
    'python3-idle-3.6.8-13.el7',
    'python3-libs-3.6.8-13.el7',
    'python3-test-3.6.8-13.el7',
    'python3-tkinter-3.6.8-13.el7'
  ],
  'CGSL MAIN 5.05': [
    'python3-3.6.8-13.el7',
    'python3-debug-3.6.8-13.el7',
