...
# Rocky Linux Security Advisory RLSA-2024:3307.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2024:3307");
  script_xref(name:"IAVA", value:"2024-A-0144-S");

  script_name(english:"Rocky Linux 9 : tomcat (RLSA-2024:3307)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2024:3307");
