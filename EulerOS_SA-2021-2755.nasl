...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.1 : python-jinja2 (EulerOS-SA-2021-2755)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2755
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d0e8c152");
...
var pkgs = [
  "python3-jinja2-2.10-10.h2.eulerosv2r9"
];
