...
# extracted from Fedora Security Advisory FEDORA-2023-8816029058
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-8816029058");

  script_name(english:"Fedora 38 : python-jupyter-server (2023-8816029058)");
...
FEDORA-2023-8816029058 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-8816029058");
...
"Update the affected python-jupyter-server package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-49080");
...
var pkgs = [
    {'reference':'python-jupyter-server-2.1.0-3.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
