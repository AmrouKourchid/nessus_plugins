...
# extracted from Fedora Security Advisory FEDORA-2023-2b0f2e4bc3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-2b0f2e4bc3");

  script_name(english:"Fedora 38 : python-yfinance (2023-2b0f2e4bc3)");
...
FEDORA-2023-2b0f2e4bc3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-2b0f2e4bc3");
  script_set_attribute(attribute:"solution", value:
"Update the affected python-yfinance package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:python-yfinance");
...
var pkgs = [
    {'reference':'python-yfinance-0.2.28-4.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python-yfinance');
}
