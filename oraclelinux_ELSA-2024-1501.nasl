...
# extracted from Oracle Linux Security Advisory ELSA-2024-1501.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : grafana (ELSA-2024-1501)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-1501.html");
...
var pkgs = [
    {'reference':'grafana-9.2.10-8.el9_3', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'grafana-9.2.10-8.el9_3', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
