...
# extracted from Red Hat Security Advisory RHSA-2024:9184. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:9184");

  script_name(english:"RHEL 9 : gtk3 (RHSA-2024:9184)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for gtk3.");
...
the RHSA-2024:9184 advisory.

    The GTK+ library provides a multi-platform toolkit for creating graphical user interfaces. The gtk3
    packages contain GTK+ version 3.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-22483");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_9184.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3883d9db");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:9184");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL gtk3 package based on the guidance in RHSA-2024:9184.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gtk-update-icon-cache-3.24.31-5.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gtk3-3.24.31-5.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gtk3-devel-3.24.31-5.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gtk3-devel-docs-3.24.31-5.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gtk3-immodule-xim-3.24.31-5.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'gtk-update-icon-cache / gtk3 / gtk3-devel / gtk3-devel-docs / etc');
}
