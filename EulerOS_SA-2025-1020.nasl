...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : expat (EulerOS-SA-2025-1020)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1020
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7c72a452");
...
var pkgs = [
  "expat-2.2.9-2.h13.eulerosv2r10"
];
