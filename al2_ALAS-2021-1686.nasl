...
# extracted from Amazon Linux 2 Security Advisory ALAS-2021-1686.
##
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2021-1686");

  script_name(english:"Amazon Linux 2 : libX11 (ALAS-2021-1686)");
...
referenced in the ALAS2-2021-1686 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2021-1686.html");
...
var pkgs = [
    {'reference':'libX11-1.6.7-3.amzn2.0.2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libX11-1.6.7-3.amzn2.0.2', 'cpu':'i686', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libX11-1.6.7-3.amzn2.0.2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libX11-common-1.6.7-3.amzn2.0.2', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libX11-debuginfo-1.6.7-3.amzn2.0.2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libX11-debuginfo-1.6.7-3.amzn2.0.2', 'cpu':'i686', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libX11-debuginfo-1.6.7-3.amzn2.0.2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libX11-devel-1.6.7-3.amzn2.0.2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libX11-devel-1.6.7-3.amzn2.0.2', 'cpu':'i686', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libX11-devel-1.6.7-3.amzn2.0.2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
