...
# extracted from Red Hat Security Advisory RHSA-2024:11024. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:11024");

  script_name(english:"RHEL 9 : python3.9:3.9.18 (RHSA-2024:11024)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for python3.9:3.9.18.");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_11024.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6800fa4e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:11024");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python3.9:3.9.18 package based on the guidance in RHSA-2024:11024.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python-unversioned-command-3.9.18-3.el9_4.7', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-3.9.18-3.el9_4.7', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-debug-3.9.18-3.el9_4.7', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-devel-3.9.18-3.el9_4.7', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-idle-3.9.18-3.el9_4.7', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-libs-3.9.18-3.el9_4.7', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-test-3.9.18-3.el9_4.7', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-tkinter-3.9.18-3.el9_4.7', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
