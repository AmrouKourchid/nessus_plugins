...
# extracted from Red Hat Security Advisory RHSA-2016:2042. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2016:2042");

  script_name(english:"RHEL 7 : python-django (RHSA-2016:2042)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for python-django.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2016:2042 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2016/rhsa-2016_2042.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?67acc2b4");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2016:2042");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-django package based on the guidance in RHSA-2016:2042.");
