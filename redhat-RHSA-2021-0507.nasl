...
# extracted from Red Hat Security Advisory RHSA-2021:0507. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_0507.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6cd439c9");
...
"Update the RHEL subversion:1.10 package based on the guidance in RHSA-2021:0507.");
  ...
  'subversion:1.10': [
    {
      ...
      'pkgs': [
        {'reference':'libserf-1.3.9-9.module+el8.3.0+6671+2675c974', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mod_dav_svn-1.10.2-4.module+el8.3.0+9886+ac338b6d', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'subversion-1.10.2-4.module+el8.3.0+9886+ac338b6d', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'subversion-devel-1.10.2-4.module+el8.3.0+9886+ac338b6d', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'subversion-gnome-1.10.2-4.module+el8.3.0+9886+ac338b6d', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'subversion-javahl-1.10.2-4.module+el8.3.0+9886+ac338b6d', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'subversion-libs-1.10.2-4.module+el8.3.0+9886+ac338b6d', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'subversion-perl-1.10.2-4.module+el8.3.0+9886+ac338b6d', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'subversion-tools-1.10.2-4.module+el8.3.0+9886+ac338b6d', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'utf8proc-2.1.1-5.module+el8.3.0+6671+2675c974', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
