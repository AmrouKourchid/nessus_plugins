...
# extracted from Debian Security Advisory DLA-1366-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1366-1 : wordpress security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2018/04/msg00031.html");
...
"Upgrade the affected wordpress, and wordpress-l10n packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-10100");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2018-10102");
...
flag = 0;
if (deb_check(release:"7.0", prefix:"wordpress", reference:"3.6.1+dfsg-1~deb7u21")) flag++;
if (deb_check(release:"7.0", prefix:"wordpress-l10n", reference:"3.6.1+dfsg-1~deb7u21")) flag++;
