...
if (description)
{
  ...
  script_name(english:"CentOS 7 : tomcat (RHSA-2020:4004)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 7 host has packages installed that are affected by multiple vulnerabilities as referenced in the
RHSA-2020:4004 advisory.
...
var pkgs = [
    {'reference':'tomcat-7.0.76-15.el7', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tomcat-admin-webapps-7.0.76-15.el7', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tomcat-docs-webapp-7.0.76-15.el7', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tomcat-el-2.2-api-7.0.76-15.el7', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tomcat-javadoc-7.0.76-15.el7', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tomcat-jsp-2.2-api-7.0.76-15.el7', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tomcat-jsvc-7.0.76-15.el7', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tomcat-lib-7.0.76-15.el7', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tomcat-servlet-3.0-api-7.0.76-15.el7', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tomcat-webapps-7.0.76-15.el7', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE}
];
