...
# extracted from Fedora Security Advisory FEDORA-2024-3dbd2c53ac
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-3dbd2c53ac");

  script_name(english:"Fedora 39 : xmedcon (2024-3dbd2c53ac)");
...
FEDORA-2024-3dbd2c53ac advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-3dbd2c53ac");
...
var pkgs = [
    {'reference':'xmedcon-0.24.0-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
