...
# extracted from Fedora Security Advisory FEDORA-2021-3da33cdc80
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-3da33cdc80");

  script_name(english:"Fedora 33 : dotnet3.1 (2021-3da33cdc80)");
...
FEDORA-2021-3da33cdc80 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-3da33cdc80");
...
pkgs = [
    {'reference':'dotnet3.1-3.1.113-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
