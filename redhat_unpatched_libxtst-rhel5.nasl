...
# extracted from Red Hat Security Advisory libxtst. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2013-2063", "CVE-2016-7951", "CVE-2016-7952");

  script_name(english:"RHEL 5 : libxtst (Unpatched Vulnerability) (deprecated)");
