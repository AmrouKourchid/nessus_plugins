...
if (description)
{
  ...
  script_cve_id("CVE-2024-50291");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-50291");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: media: dvb-core: add missing buffer
    index check dvb_vb2_expbuf() didn't check if the given buffer index was for a valid buffer. Add this
    check. (CVE-2024-50291)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-50291");
