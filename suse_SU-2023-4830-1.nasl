...
# SUSE update advisory SUSE-SU-2023:4830-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:4830-1");

  script_name(english:"SUSE SLES15 Security Update : python-Twisted (SUSE-SU-2023:4830-1)");
...
in the SUSE-SU-2023:4830-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-December/017363.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5b8586a6");
...
var pkgs = [
    {'reference':'python3-Twisted-17.9.0-150000.3.11.1', 'sp':'1', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.1']},
    {'reference':'python3-Twisted-17.9.0-150000.3.11.1', 'sp':'1', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.1', 'SUSE-Manager-Proxy-release-4.0', 'SUSE-Manager-Server-release-4.0', 'sle-module-public-cloud-release-15.1', 'sles-release-15.1', 'suse-manager-server-release-4.0']}
];
