...
if (description)
{
  ...
  script_name(english:"CentOS 9 : xz-5.2.5-8.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update for xz.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 9 host has packages installed that are affected by a vulnerability as referenced in the
xz-5.2.5-8.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=21540");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream xz package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:xz-static");
...
var pkgs = [
    {'reference':'xz-5.2.5-8.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xz-devel-5.2.5-8.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xz-libs-5.2.5-8.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xz-lzma-compat-5.2.5-8.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xz-static-5.2.5-8.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'xz / xz-devel / xz-libs / xz-lzma-compat / xz-static');
}
