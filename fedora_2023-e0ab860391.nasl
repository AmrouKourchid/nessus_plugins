...
# extracted from Fedora Security Advisory FEDORA-2023-e0ab860391
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-e0ab860391");

  script_name(english:"Fedora 37 : mbedtls (2023-e0ab860391)");
...
FEDORA-2023-e0ab860391 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-e0ab860391");
...
var pkgs = [
    {'reference':'mbedtls-2.28.5-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
