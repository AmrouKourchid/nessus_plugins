...
# extracted from Red Hat Security Advisory opentelemetry-go-contrib. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 8 : opentelemetry-go-contrib (Unpatched Vulnerability) (deprecated)");
