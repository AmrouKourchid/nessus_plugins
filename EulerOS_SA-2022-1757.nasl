...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : python (EulerOS-SA-2022-1757)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1757
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b29e35f1");
...
var pkgs = [
  "python-2.7.5-58.h34",
  "python-devel-2.7.5-58.h34",
  "python-libs-2.7.5-58.h34",
  "tkinter-2.7.5-58.h34"
];
