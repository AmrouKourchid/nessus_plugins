...
if (description)
{
  ...
  script_name(english:"AIX (IJ36593)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AIX host is missing a security patch.");
  script_set_attribute(attribute:"description", value:
"The version of AIX installed on the remote host is prior to APAR IJ36593. It is, therefore, affected by a vulnerability
as referenced in the IJ36593 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/apar/IJ36593");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/node/6561275");
  script_set_attribute(attribute:"solution", value:
"Please apply the appropriate interim fix per APAR IJ36593.");
...
var constraints = [
    {'release': '7.3', 'ml': '00', 'sp': '01', 'patch': 'IJ36593m1a', 'package': 'bos.sysmgt.nim.client', 'minfilesetver': '7.3.0.0', 'maxfilesetver': '7.3.0.0'}
];
