...
# extracted from Fedora Security Advisory FEDORA-2024-d2ec3e14a7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-d2ec3e14a7");

  script_name(english:"Fedora 41 : kitty (2024-d2ec3e14a7)");
...
FEDORA-2024-d2ec3e14a7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-d2ec3e14a7");
...
var pkgs = [
    {'reference':'kitty-0.35.1-4.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
