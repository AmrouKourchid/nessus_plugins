...
if (description)
{
  ...
  script_name(english:"CentOS 9 : openssh-8.7p1-45.el9");
...
openssh-8.7p1-45.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=75144");
...
var pkgs = [
    ...
    {'reference':'openssh-sk-dummy-8.7p1-45.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
