...
if (description)
{
  ...
  script_cve_id("CVE-2014-8166");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2014-8166");
...
patch available.
  ...
  - The browsing feature in the server in CUPS does not filter ANSI escape sequences from shared printer
    names, which might allow remote attackers to execute arbitrary code via a crafted printer name.
    (CVE-2014-8166)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-8166");
