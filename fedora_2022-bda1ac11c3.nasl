...
# extracted from Fedora Security Advisory FEDORA-2022-bda1ac11c3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-bda1ac11c3");

  script_name(english:"Fedora 35 : python3.8 (2022-bda1ac11c3)");
...
FEDORA-2022-bda1ac11c3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-bda1ac11c3");
...
var pkgs = [
    {'reference':'python3.8-3.8.15-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
