...
# extracted from Fedora Security Advisory FEDORA-2023-392085b92b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-392085b92b");

  script_name(english:"Fedora 40 : PyDrive2 (2023-392085b92b)");
...
FEDORA-2023-392085b92b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-392085b92b");
...
var pkgs = [
    {'reference':'PyDrive2-1.18.0-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
