...
if (description)
{
  ...
  script_cve_id("CVE-2024-0160");
  script_xref(name:"IAVA", value:"2024-A-0360");

  script_name(english:"Dell Client BIOS Incorrect Authorization (DSA-2024-122)");

  script_set_attribute(attribute:"synopsis", value:
"The remote device is missing a vendor-supplied security patch");
  script_set_attribute(attribute:"description", value:
"Dell Client Platform contains an incorrect authorization vulnerability. An attacker with physical access to the system
could potentially exploit this vulnerability by bypassing BIOS authorization to modify settings in the BIOS.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.dell.com/support/kbdoc/en-us/000224763/dsa-2024-122");
...
"Apply the security patch in accordance with the vendor advisory.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-0160");
...
if (model)
{
  if (model == 'Dell G7 7500' || model == 'Dell G7 7700') fix = '1.32.0';
  else
  {
