...
if (description)
{
  ...
  script_name(english:"RHCOS 4 : OpenShift Container Platform 4.12.48 (RHSA-2024:0489)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat CoreOS host is missing a security update for OpenShift Container Platform 4.12.48.");
...
referenced in the RHSA-2024:0489 advisory.
...
"Update the RHCOS OpenShift Container Platform 4.12.48 packages based on the guidance in RHSA-2024:0489.");
...
var pkgs = [
    {'reference':'cri-o-1.25.5-6.rhaos4.12.gitfcf6ef3.el8', 'release':'4', 'el_string':'el8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
];
