...
# extracted from Fedora Security Advisory FEDORA-2022-dbb811d203
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-dbb811d203");

  script_name(english:"Fedora 37 : python3-docs / python3.11 (2022-dbb811d203)");
...
FEDORA-2022-dbb811d203 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-dbb811d203");
...
var pkgs = [
    {'reference':'python3-docs-3.11.1-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3.11-3.11.1-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
