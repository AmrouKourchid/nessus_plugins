...
# extracted from Fedora Security Advisory FEDORA-2023-659606fa84
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-659606fa84");

  script_name(english:"Fedora 38 : LibRaw (2023-659606fa84)");
...
FEDORA-2023-659606fa84 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-659606fa84");
...
var pkgs = [
    {'reference':'LibRaw-0.21.1-4.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
