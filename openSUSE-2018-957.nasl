...
# extracted from openSUSE Security Update openSUSE-2018-957.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : spice (openSUSE-2018-957)");
...
Security issues fixed :
  ...
  - CVE-2018-10893: Avoid buffer overflow on image lz checks
    (bsc#1101295) This update was imported from the
...
if ( rpm_check(release:"SUSE42.3", reference:"libspice-server-devel-0.12.8-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libspice-server1-0.12.8-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libspice-server1-debuginfo-0.12.8-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"spice-debugsource-0.12.8-7.1") ) flag++;
