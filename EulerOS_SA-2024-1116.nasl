...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : avahi (EulerOS-SA-2024-1116)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1116
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c2f569f6");
...
var pkgs = [
  "avahi-libs-0.8-12.h5.eulerosv2r11"
];
