...
# extracted from Fedora Security Advisory FEDORA-2023-e49d18c283
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-e49d18c283");

  script_name(english:"Fedora 37 : python3.8 (2023-e49d18c283)");
...
FEDORA-2023-e49d18c283 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-e49d18c283");
...
var pkgs = [
    {'reference':'python3.8-3.8.18-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
