...
if (description)
{
  ...
  script_cve_id("CVE-2023-52673");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2023-52673");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: drm/amd/display: Fix a debugfs null
    pointer error [WHY & HOW] Check whether get_subvp_en() callback exists before calling it. (CVE-2023-52673)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-52673");
