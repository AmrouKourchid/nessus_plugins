...
# extracted from Fedora Security Advisory FEDORA-2024-6712c699fc
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-6712c699fc");

  script_name(english:"Fedora 40 : strongswan (2024-6712c699fc)");
...
FEDORA-2024-6712c699fc advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-6712c699fc");
...
var pkgs = [
    {'reference':'strongswan-5.9.14-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
