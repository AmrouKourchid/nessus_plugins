...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Rubygem PHSA-2025-4.0-0765");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'rubygem-activesupport-7.1.3.4-1.ph4')) flag++;
