...
# extracted from ZTE advisory NS-SA-2021-0011. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.04 / MAIN 5.04 : cloud-init Vulnerability (NS-SA-2021-0011)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/notice/NS-SA-2021-0011");
...
pkgs = {
  'CGSL CORE 5.04': [
    'cloud-init-18.2-1.el7.centos.2.cgslv5.0.17.g64ce243.lite'
  ],
  'CGSL MAIN 5.04': [
    'cloud-init-18.5-6.el7.cgslv5.0.1.ga08616c'
  ]
};
