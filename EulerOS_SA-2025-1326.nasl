...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP13 : ruby (EulerOS-SA-2025-1326)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1326
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?aae6ac06");
...
var pkgs = [
  "ruby-3.0.3-131.h9.eulerosv2r13",
  "ruby-help-3.0.3-131.h9.eulerosv2r13",
  "ruby-irb-3.0.3-131.h9.eulerosv2r13"
];
