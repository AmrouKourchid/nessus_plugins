...
# extracted from Red Hat Security Advisory RHSA-2024:3259. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:3259");

  script_name(english:"RHEL 8 : go-toolset:rhel8 (RHSA-2024:3259)");
...
referenced in the RHSA-2024:3259 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_3259.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ed3a4a39");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:3259");
...
"Update the RHEL go-toolset:rhel8 package based on the guidance in RHSA-2024:3259.");
  ...
  script_cwe_id(20, 74, 115, 200, 400);
  ...
  'go-toolset:rhel8': [
    {
      ...
      'pkgs': [
        ...
        {'reference':'go-toolset-1.21.9-1.module+el8.10.0+21671+b35c3b78', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'golang-1.21.9-1.module+el8.10.0+21671+b35c3b78', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'golang-bin-1.21.9-1.module+el8.10.0+21671+b35c3b78', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'golang-docs-1.21.9-1.module+el8.10.0+21671+b35c3b78', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'golang-misc-1.21.9-1.module+el8.10.0+21671+b35c3b78', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'golang-src-1.21.9-1.module+el8.10.0+21671+b35c3b78', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'golang-tests-1.21.9-1.module+el8.10.0+21671+b35c3b78', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
