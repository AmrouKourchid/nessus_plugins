...
if (description)
{
  ...
  script_name(english:"Adobe Photoshop 21.x < 21.2.12 / 22.x < 22.5.1 Vulnerability (APSB21-84)");

  script_set_attribute(attribute:"synopsis", value:
"Adobe Photoshop installed on remote Windows host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Photoshop installed on the remote Windows host is prior to 21.2.12/22.5.1. It is, therefore,
affected by a vulnerability as referenced in the apsb21-84 advisory.
