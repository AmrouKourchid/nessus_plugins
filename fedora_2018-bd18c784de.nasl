...
# extracted from Fedora Security Advisory FEDORA-2018-bd18c784de.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : libtiff (2018-bd18c784de)");
...
possible without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-bd18c784de");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"libtiff-4.0.10-1.fc29")) flag++;
