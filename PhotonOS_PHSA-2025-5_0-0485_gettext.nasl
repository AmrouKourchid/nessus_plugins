...
# extracted from VMware Security Advisory PHSA-2025-5.0-0485. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Gettext PHSA-2025-5.0-0485");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the gettext package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-5.0-485.md");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'gettext-0.21.1-5.ph5')) flag++;
