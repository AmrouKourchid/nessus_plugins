...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_4949.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1c178c6c");
...
"Update the RHEL freetype package based on the guidance in RHSA-2020:4949.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'freetype-2.9.1-4.el8_0.1', 'sp':'0', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freetype-2.9.1-4.el8_0.1', 'sp':'0', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freetype-2.9.1-4.el8_0.1', 'sp':'0', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freetype-devel-2.9.1-4.el8_0.1', 'sp':'0', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freetype-devel-2.9.1-4.el8_0.1', 'sp':'0', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freetype-devel-2.9.1-4.el8_0.1', 'sp':'0', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
