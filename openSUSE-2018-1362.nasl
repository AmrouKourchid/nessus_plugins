...
# extracted from openSUSE Security Update openSUSE-2018-1362.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : soundtouch (openSUSE-2018-1362)");
...
This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1108630");
...
if ( rpm_check(release:"SUSE15.0", reference:"libSoundTouch0-1.8.0-lp150.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libSoundTouch0-debuginfo-1.8.0-lp150.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"soundtouch-1.8.0-lp150.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"soundtouch-debuginfo-1.8.0-lp150.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"soundtouch-debugsource-1.8.0-lp150.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"soundtouch-devel-1.8.0-lp150.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libSoundTouch0-32bit-1.8.0-lp150.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libSoundTouch0-32bit-debuginfo-1.8.0-lp150.2.6.1") ) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "libSoundTouch0 / libSoundTouch0-debuginfo / soundtouch / etc");
}
