...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : qemu (EulerOS-SA-2024-2152)");
...
affected by the following vulnerabilities :
    ...
    ** RESERVED ** This candidate has been reserved by an organization or individual that will use it when
    ...
    will be provided.(CVE-2024-3447)
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2152
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?134396ac");
