...
# extracted from Debian Security Advisory dla-3250. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3250 : kpartx - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/multipath-tools");
  script_set_attribute(attribute:"solution", value:
"Upgrade the kpartx packages.");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'kpartx', 'reference': '0.7.9-3+deb10u2'},
    {'release': '10.0', 'prefix': 'multipath-tools', 'reference': '0.7.9-3+deb10u2'},
    {'release': '10.0', 'prefix': 'multipath-tools-boot', 'reference': '0.7.9-3+deb10u2'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kpartx / multipath-tools / multipath-tools-boot');
}
