...
# extracted from Red Hat Security Advisory RHSA-2019:0433. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:0433");

  script_name(english:"RHEL 7 : ansible (RHSA-2019:0433)");
...
the RHSA-2019:0433 advisory.
    ...
    * ansible: path traversal in the fetch module (CVE-2019-3828)
    ...
    See https://github.com/ansible/ansible/blob/v2.6.14/changelogs/CHANGELOG-v2.6.rst for details on bug fixes
    in this release.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_0433.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?16fb0397");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:0433");
...
"Update the RHEL ansible package based on the guidance in RHSA-2019:0433.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ansible-2.6.14-1.el7ae', 'release':'7', 'el_string':'el7ae', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2.6'}
    ]
  }
];
