...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : spice-gtk (EulerOS-SA-2020-1727)");
...
the following vulnerability :
  ...
  - Multiple integer overflow and buffer overflow issues
    ...
    client to crash or, potentially, execute arbitrary
    code.(CVE-2018-10893)
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1727
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?027aafac");
...
pkgs = ["spice-glib-0.34-3.2.h1.eulerosv2r7",
        "spice-gtk3-0.34-3.2.h1.eulerosv2r7"];
