...
if (description)
{
  ...
  script_cve_id("CVE-2023-33226", "CVE-2023-33227", "CVE-2023-33228");

  script_name(english:"SolarWinds Platform < 2023.4 Multiple Vulnerabilities");
...
multiple vulnerabilities as referenced in the solarwinds_platform_2023_4 advisory.
  ...
  - The Network Configuration Manager was susceptible to a Directory Traversal Remote Code Execution 
    ...
    (CVE-2023-33226, CVE-2023-33227)

  - The SolarWinds Network Configuration Manager was susceptible to the Exposure of Sensitive Information 
    Vulnerability. This vulnerability allows users with administrative access to SolarWinds Web Console to 
    obtain sensitive information. (CVE-2023-33228)
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?af4a1b62");
...
"Upgrade to SolarWinds Platform version 2023.4 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-33227");
...
var constraints = [{ 'fixed_version' : '2023.4' }];
