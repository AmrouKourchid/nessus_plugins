...
"The remote Red Hat host is missing one or more security updates for giflib.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 5 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2009:0444 advisory.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2009/rhsa-2009_0444.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dd4fa3bc");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=494823");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=494826");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2009:0444");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL giflib package based on the guidance in RHSA-2009:0444.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2005-3350");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2005-2974");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'giflib-4.1.3-7.1.el5_3.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'giflib-4.1.3-7.1.el5_3.1', 'cpu':'ppc', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'giflib-4.1.3-7.1.el5_3.1', 'cpu':'ppc64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'giflib-4.1.3-7.1.el5_3.1', 'cpu':'s390', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'giflib-4.1.3-7.1.el5_3.1', 'cpu':'s390x', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'giflib-4.1.3-7.1.el5_3.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'giflib-devel-4.1.3-7.1.el5_3.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'giflib-devel-4.1.3-7.1.el5_3.1', 'cpu':'ppc', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'giflib-devel-4.1.3-7.1.el5_3.1', 'cpu':'ppc64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'giflib-devel-4.1.3-7.1.el5_3.1', 'cpu':'s390', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'giflib-devel-4.1.3-7.1.el5_3.1', 'cpu':'s390x', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'giflib-devel-4.1.3-7.1.el5_3.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'giflib-utils-4.1.3-7.1.el5_3.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'giflib-utils-4.1.3-7.1.el5_3.1', 'cpu':'ppc', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'giflib-utils-4.1.3-7.1.el5_3.1', 'cpu':'s390x', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'giflib-utils-4.1.3-7.1.el5_3.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
