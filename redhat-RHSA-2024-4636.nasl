...
# extracted from Red Hat Security Advisory RHSA-2024:4636. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:4636");

  script_name(english:"RHEL 9 : libndp (RHSA-2024:4636)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_4636.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2a33d888");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2284122");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:4636");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libndp package based on the guidance in RHSA-2024:4636.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libndp-1.8-6.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'libndp-1.8-6.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
