...
if (description)
{
  ...
  script_cve_id("CVE-2020-27067");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2020-27067");
...
patch available.
  ...
  - In the l2tp subsystem, there is a possible use after free due to a race condition. This could lead to
    local escalation of privilege with System execution privileges needed. User interaction is not needed for
    exploitation.Product: AndroidVersions: Android kernelAndroid ID: A-152409173 (CVE-2020-27067)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-27067");
