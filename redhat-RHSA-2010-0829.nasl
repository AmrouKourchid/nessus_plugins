...
referenced in the RHSA-2010:0829 advisory.
...
number.");
  ...
  # https://access.redhat.com/security/data/csaf/v2/advisories/2010/rhsa-2010_0829.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?27790189");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2010:0829");
...
"Update the RHEL flash-plugin package based on the guidance in RHSA-2010:0829.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'flash-plugin-10.1.102.64-1.el5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
