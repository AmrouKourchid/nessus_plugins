...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : icu (EulerOS-SA-2020-1602)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1602
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c0ee6314");
...
pkgs = ["libicu-50.1.2-15.h9.eulerosv2r7",
        "libicu-devel-50.1.2-15.h9.eulerosv2r7"];
