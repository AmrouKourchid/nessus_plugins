...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5002676");
  script_xref(name:"MSFT", value:"MS25-5002676");
  script_xref(name:"IAVA", value:"2025-A-0031-S");

  script_name(english:"Security Updates for Microsoft SharePoint Server Subscription Edition (January 2025)");
...
security updates. It is, therefore, affected by multiple vulnerabilities:
  ...
  - Spoofing Vulnerability.
    (CVE-2025-21393)");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002676");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released KB5002676 to address this issue.");
