...
# extracted from Red Hat Security Advisory RHSA-2021:4464. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:4464");

  script_name(english:"RHEL 8 : dnf (RHSA-2021:4464)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for dnf.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2021:4464 advisory.

    dnf is a package manager that allows users to manage packages on their systems. It supports RPMs, modules
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_4464.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c3d67625");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:4464");
...
"Update the RHEL dnf package based on the guidance in RHSA-2021:4464.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:libdnf-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:python3-dnf");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:python3-dnf-plugin-post-transaction-actions");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libdnf-0.63.0-3.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libdnf-devel-0.63.0-3.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-hawkey-0.63.0-3.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-libdnf-0.63.0-3.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
