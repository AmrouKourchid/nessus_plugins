...
# extracted from Debian Security Advisory DLA-2506-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2506-1 : awstats security update");
...
For the detailed security status of awstats please refer to its
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2020/12/msg00035.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/stretch/awstats");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/awstats");
  script_set_attribute(attribute:"solution", value:
"Upgrade the affected awstats package.");
...
flag = 0;
if (deb_check(release:"9.0", prefix:"awstats", reference:"7.6+dfsg-1+deb9u2")) flag++;
