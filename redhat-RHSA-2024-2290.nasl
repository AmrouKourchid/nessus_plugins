...
# extracted from Red Hat Security Advisory RHSA-2024:2290. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2290");

  script_name(english:"RHEL 9 : mutt (RHSA-2024:2290)");
...
referenced in the RHSA-2024:2290 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2290.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a7fadaea");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2290");
...
"Update the RHEL mutt package based on the guidance in RHSA-2024:2290.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'mutt-2.2.6-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'5'}
    ]
  }
];
