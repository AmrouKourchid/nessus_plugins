...
# extracted from Fedora Security Advisory FEDORA-2022-e15be0091f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-e15be0091f");

  script_name(english:"Fedora 37 : libarchive (2022-e15be0091f)");
...
FEDORA-2022-e15be0091f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-e15be0091f");
...
var pkgs = [
    {'reference':'libarchive-3.6.1-3.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
