...
# extracted from Red Hat Security Advisory subscription-manager. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 5 : subscription-manager (Unpatched Vulnerability) (deprecated)");
