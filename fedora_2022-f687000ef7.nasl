...
# extracted from Fedora Security Advisory FEDORA-2022-f687000ef7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-f687000ef7");

  script_name(english:"Fedora 37 : java-17-openjdk (2022-f687000ef7)");
...
FEDORA-2022-f687000ef7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-f687000ef7");
...
var pkgs = [
    {'reference':'java-17-openjdk-17.0.5.0.8-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
