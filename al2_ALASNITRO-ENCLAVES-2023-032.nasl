...
# extracted from Amazon Linux 2 Security Advisory ALASNITRO-ENCLAVES-2023-032.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : runc (ALASNITRO-ENCLAVES-2023-032)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of runc installed on the remote host is prior to 1.1.7-4. It is, therefore, affected by a vulnerability as
referenced in the ALAS2NITRO-ENCLAVES-2023-032 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALASNITRO-ENCLAVES-2023-032.html");
