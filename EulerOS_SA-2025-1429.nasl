...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP12 : openssh (EulerOS-SA-2025-1429)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1429
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1499f808");
...
var pkgs = [
  "openssh-8.8p1-14.h23.eulerosv2r12",
  "openssh-clients-8.8p1-14.h23.eulerosv2r12",
  "openssh-server-8.8p1-14.h23.eulerosv2r12"
];
