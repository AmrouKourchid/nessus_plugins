...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.2 : systemd (EulerOS-SA-2019-1063)");
...
the following vulnerability :
  ...
  - In systemd through 233, certain sizes passed to
    dns_packet_new in systemd-resolved can cause it to
    allocate a buffer that's too small. A malicious DNS
    server can exploit this via a response with a specially
    crafted TCP payload to trick systemd-resolved into
    allocating a buffer that's too small, and subsequently
    write arbitrary data beyond the end of
    it.(CVE-2017-9445)
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1063
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?78811123");
...
"Update the affected systemd package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-9445");
...
pkgs = ["libgudev1-219-57.h64",
        "systemd-219-57.h64",
        "systemd-devel-219-57.h64",
        "systemd-libs-219-57.h64",
        "systemd-networkd-219-57.h64",
        "systemd-python-219-57.h64",
        "systemd-resolved-219-57.h64",
        "systemd-sysv-219-57.h64"];
