...
# extracted from Fedora Security Advisory FEDORA-2023-fa5d0b461d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-fa5d0b461d");

  script_name(english:"Fedora 37 : python-cryptography (2023-fa5d0b461d)");
...
FEDORA-2023-fa5d0b461d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-fa5d0b461d");
...
var pkgs = [
    {'reference':'python-cryptography-37.0.2-5.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
