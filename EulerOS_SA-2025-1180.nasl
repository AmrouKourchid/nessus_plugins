...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP12 : python-configobj (EulerOS-SA-2025-1180)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1180
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?359b00c7");
...
var pkgs = [
  "python3-configobj-5.0.6-18.h1.eulerosv2r12"
];
