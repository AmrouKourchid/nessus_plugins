...
# extracted from Red Hat Security Advisory gtk-vnc. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2017-5884", "CVE-2017-5885", "CVE-2017-1000044");

  script_name(english:"RHEL 5 : gtk-vnc (Unpatched Vulnerability) (deprecated)");
