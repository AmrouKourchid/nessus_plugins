...
# extracted from Fedora Security Advisory FEDORA-2023-11dafed208
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-11dafed208");

  script_name(english:"Fedora 37 : manifest-tool (2023-11dafed208)");
...
FEDORA-2023-11dafed208 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-11dafed208");
...
var pkgs = [
    {'reference':'manifest-tool-2.0.8-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
