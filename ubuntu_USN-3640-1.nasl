...
in the USN-3640-1 advisory.

    Ivan Fratric discovered that WebKitGTK+ incorrectly handled certain web content. If a user were tricked
    into viewing a malicious website, a remote attacker could possibly exploit this to execute arbitrary code.
