...
# extracted from VMware Security Advisory PHSA-2022-4.0-0305. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Go PHSA-2022-4.0-0305");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the go package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-305.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'go-1.19.3-2.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'go-md2man-2.0.0-16.ph4')) flag++;
