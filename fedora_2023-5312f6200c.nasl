...
# extracted from Fedora Security Advisory FEDORA-2023-5312f6200c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-5312f6200c");

  script_name(english:"Fedora 38 : manifest-tool (2023-5312f6200c)");
...
FEDORA-2023-5312f6200c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-5312f6200c");
...
var pkgs = [
    {'reference':'manifest-tool-2.0.8-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
