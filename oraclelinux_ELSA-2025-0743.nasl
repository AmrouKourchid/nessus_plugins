...
# extracted from Oracle Linux Security Advisory ELSA-2025-0743.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : keepalived (ELSA-2025-0743)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2025-0743.html");
...
var pkgs = [
    {'reference':'keepalived-2.1.5-10.el8_10', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'keepalived-2.1.5-10.el8_10', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
