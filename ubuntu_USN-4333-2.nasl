...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS : Python vulnerabilities (USN-4333-2)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 20.04 LTS host has packages installed that are affected by multiple vulnerabilities as referenced in
the USN-4333-2 advisory.

    USN-4333-1 fixed vulnerabilities in Python. This update provides the corresponding update for Ubuntu 20.04
    LTS.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4333-2");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'idle-python3.8', 'pkgver': '3.8.2-1ubuntu1.1'},
    {'osver': '20.04', 'pkgname': 'libpython3.8', 'pkgver': '3.8.2-1ubuntu1.1'},
    {'osver': '20.04', 'pkgname': 'libpython3.8-dev', 'pkgver': '3.8.2-1ubuntu1.1'},
    {'osver': '20.04', 'pkgname': 'libpython3.8-minimal', 'pkgver': '3.8.2-1ubuntu1.1'},
    {'osver': '20.04', 'pkgname': 'libpython3.8-stdlib', 'pkgver': '3.8.2-1ubuntu1.1'},
    {'osver': '20.04', 'pkgname': 'libpython3.8-testsuite', 'pkgver': '3.8.2-1ubuntu1.1'},
    {'osver': '20.04', 'pkgname': 'python3.8', 'pkgver': '3.8.2-1ubuntu1.1'},
    {'osver': '20.04', 'pkgname': 'python3.8-dev', 'pkgver': '3.8.2-1ubuntu1.1'},
    {'osver': '20.04', 'pkgname': 'python3.8-examples', 'pkgver': '3.8.2-1ubuntu1.1'},
    {'osver': '20.04', 'pkgname': 'python3.8-minimal', 'pkgver': '3.8.2-1ubuntu1.1'},
    {'osver': '20.04', 'pkgname': 'python3.8-venv', 'pkgver': '3.8.2-1ubuntu1.1'}
];
