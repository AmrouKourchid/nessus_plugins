...
# extracted from Gentoo Linux Security Advisory GLSA 201811-08.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201811-08");

  script_name(english:"GLSA-201811-08 : Okular: Directory traversal");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-201811-08
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/201811-08");
...
if (qpkg_check(package:"kde-apps/okular", unaffected:make_list("ge 18.04.3-r1"), vulnerable:make_list("lt 18.04.3-r1"))) flag++;
