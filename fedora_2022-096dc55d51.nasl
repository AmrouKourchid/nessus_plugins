...
# extracted from Fedora Security Advisory FEDORA-2022-096dc55d51
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-096dc55d51");

  script_name(english:"Fedora 37 : thunderbird (2022-096dc55d51)");
...
FEDORA-2022-096dc55d51 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-096dc55d51");
...
var pkgs = [
    {'reference':'thunderbird-102.5.1-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
