...
if (description)
{
  ...
  script_cve_id("CVE-2022-3524", "CVE-2023-26607");
...
"The version of kernel installed on the remote host is prior to 4.14.301-153.528. It is, therefore, affected by multiple
vulnerabilities as referenced in the ALAS-2023-1707 advisory.
...
"Run 'yum update kernel' to update your system.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-26607");
...
if (get_one_kb_item("Host/kpatch/kernel-cves"))
{
  ...
  var cve_list = make_list("CVE-2022-3524", "CVE-2023-26607");
