...
# extracted from Red Hat Security Advisory RHSA-2020:3658. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_3658.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?31758f4d");
...
"Update the RHEL librepo package based on the guidance in RHSA-2020:3658.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'librepo-1.11.0-3.el8_2', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-librepo-1.11.0-3.el8_2', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'librepo-1.11.0-3.el8_2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-librepo-1.11.0-3.el8_2', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
