...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : cairo (EulerOS-SA-2019-2130)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2130
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fdb08b02");
...
pkgs = ["cairo-1.14.8-2.h3.eulerosv2r7",
        "cairo-devel-1.14.8-2.h3.eulerosv2r7",
        "cairo-gobject-1.14.8-2.h3.eulerosv2r7",
        "cairo-gobject-devel-1.14.8-2.h3.eulerosv2r7"];
