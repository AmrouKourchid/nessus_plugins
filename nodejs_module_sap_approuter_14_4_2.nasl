...
if (description)
{
  ...
  script_name(english:"Node.js Module @sap/approuter < 14.4.2 Privilege Escalation");
...
"The nodejs module @sap/approuter detected on the host is prior to version 14.4.2. It is, therefore, affected by a
...
"Upgrade to @sap/approuter version 14.4.2 or later.");
  ...
  script_set_attribute(attribute:"cpe", value:"x-cpe:/a:sap:%40sap%2fapprouter");
...
var app_info = vcf_extras::nodejs_modules::get_app_info(app:'@sap/approuter');
