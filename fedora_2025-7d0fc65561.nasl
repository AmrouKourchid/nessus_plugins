...
# extracted from Fedora Security Advisory FEDORA-2025-7d0fc65561
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-7d0fc65561");

  script_name(english:"Fedora 40 : giflib (2025-7d0fc65561)");
...
FEDORA-2025-7d0fc65561 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-7d0fc65561");
...
var pkgs = [
    {'reference':'giflib-5.2.2-6.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
