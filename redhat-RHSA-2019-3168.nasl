...
# extracted from Red Hat Security Advisory RHSA-2019:3168. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:3168");

  script_name(english:"RHEL 7 : wget (RHSA-2019:3168)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_3168.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f8fa1e66");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:3168");
...
"Update the RHEL wget package based on the guidance in RHSA-2019:3168.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'wget-1.14-15.el7_4.2', 'sp':'4', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'wget-1.14-15.el7_4.2', 'sp':'4', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
