...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_3506.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1d2bbbcf");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:3506");
...
"Update the RHEL xerces-c package based on the guidance in RHSA-2018:3506.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'xerces-c-3.1.1-8.el7_5.1', 'sp':'5', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xerces-c-3.1.1-8.el7_5.1', 'sp':'5', 'cpu':'ppc', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xerces-c-3.1.1-8.el7_5.1', 'sp':'5', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xerces-c-3.1.1-8.el7_5.1', 'sp':'5', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xerces-c-3.1.1-8.el7_5.1', 'sp':'5', 'cpu':'s390', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xerces-c-3.1.1-8.el7_5.1', 'sp':'5', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xerces-c-3.1.1-8.el7_5.1', 'sp':'5', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xerces-c-devel-3.1.1-8.el7_5.1', 'sp':'5', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xerces-c-devel-3.1.1-8.el7_5.1', 'sp':'5', 'cpu':'ppc', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xerces-c-devel-3.1.1-8.el7_5.1', 'sp':'5', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xerces-c-devel-3.1.1-8.el7_5.1', 'sp':'5', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xerces-c-devel-3.1.1-8.el7_5.1', 'sp':'5', 'cpu':'s390', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xerces-c-devel-3.1.1-8.el7_5.1', 'sp':'5', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xerces-c-devel-3.1.1-8.el7_5.1', 'sp':'5', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xerces-c-doc-3.1.1-8.el7_5.1', 'sp':'5', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
