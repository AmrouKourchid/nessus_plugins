...
# extracted from Slackware Security Advisory SSA:2023-353-01. The text
...
if (description)
{
  ...
  script_name(english:"Slackware Linux 14.2 / 15.0 / current libssh  Multiple Vulnerabilities (SSA:2023-353-01)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Slackware Linux host is missing a security update to libssh.");
  script_set_attribute(attribute:"description", value:
"The version of libssh installed on the remote host is prior to 0.10.6. It is, therefore, affected by multiple
vulnerabilities as referenced in the SSA:2023-353-01 advisory.
  ...
  - The SSH transport protocol with certain OpenSSH extensions, found in OpenSSH before 9.6 and other
    ...
    through 18.2.0, ProFTPD 1.3.9rc1, ORYX CycloneSSH before 2.3.4, NetSarang XShell 7 before Build 0144,
    CrushFTP before 10.6.0, ConnectBot SSH library before 2.2.22, the mscdex ssh2 module before 1.15.0 for
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?babc1914");
...
var flag = 0;
var constraints = [
    { 'fixed_version' : '0.10.6', 'product' : 'libssh', 'os_name' : 'Slackware Linux', 'os_version' : '14.2', 'service_pack' : '1_slack14.2', 'arch' : 'i586' },
    { 'fixed_version' : '0.10.6', 'product' : 'libssh', 'os_name' : 'Slackware Linux', 'os_version' : '14.2', 'service_pack' : '1_slack14.2', 'arch' : 'x86_64' },
    { 'fixed_version' : '0.10.6', 'product' : 'libssh', 'os_name' : 'Slackware Linux', 'os_version' : '15.0', 'service_pack' : '1_slack15.0', 'arch' : 'i586' },
    { 'fixed_version' : '0.10.6', 'product' : 'libssh', 'os_name' : 'Slackware Linux', 'os_version' : '15.0', 'service_pack' : '1_slack15.0', 'arch' : 'x86_64' },
    { 'fixed_version' : '0.10.6', 'product' : 'libssh', 'os_name' : 'Slackware Linux', 'os_version' : 'current', 'service_pack' : '1', 'arch' : 'i586' },
    { 'fixed_version' : '0.10.6', 'product' : 'libssh', 'os_name' : 'Slackware Linux', 'os_version' : 'current', 'service_pack' : '1', 'arch' : 'x86_64' }
];
