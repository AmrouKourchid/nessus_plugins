...
# extracted from Fedora Security Advisory FEDORA-2024-9ce64d8940
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-9ce64d8940");

  script_name(english:"Fedora 39 : chromium (2024-9ce64d8940)");
...
FEDORA-2024-9ce64d8940 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-9ce64d8940");
...
var pkgs = [
    {'reference':'chromium-122.0.6261.94-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
