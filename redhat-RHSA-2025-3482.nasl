...
# extracted from Red Hat Security Advisory RHSA-2025:3482. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:3482");

  script_name(english:"RHEL 9 : Red Hat OpenStack Platform 17.1 (openstack-ironic) (RHSA-2025:3482)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for Red Hat OpenStack Platform 17.1 (openstack-ironic).");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_3482.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?49aade65");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:3482");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat OpenStack Platform 17.1 (openstack-ironic) package based on the guidance in RHSA-2025:3482.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openstack-ironic-api-17.1.1-17.1.20241122190825.c31db88.el9ost', 'release':'9', 'el_string':'el9ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'},
      {'reference':'openstack-ironic-common-17.1.1-17.1.20241122190825.c31db88.el9ost', 'release':'9', 'el_string':'el9ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'},
      {'reference':'openstack-ironic-conductor-17.1.1-17.1.20241122190825.c31db88.el9ost', 'release':'9', 'el_string':'el9ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'}
    ]
  }
];
