...
# extracted from openSUSE Security Update openSUSE-2019-2279.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : jasper (openSUSE-2019-2279)");
...
if ( rpm_check(release:"SUSE15.0", reference:"jasper-2.0.14-lp150.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"jasper-debuginfo-2.0.14-lp150.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"jasper-debugsource-2.0.14-lp150.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libjasper-devel-2.0.14-lp150.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libjasper4-2.0.14-lp150.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libjasper4-debuginfo-2.0.14-lp150.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libjasper4-32bit-2.0.14-lp150.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libjasper4-32bit-debuginfo-2.0.14-lp150.2.6.1") ) flag++;
