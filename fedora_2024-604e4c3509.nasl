...
# extracted from Fedora Security Advisory FEDORA-2024-604e4c3509
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-604e4c3509");

  script_name(english:"Fedora 38 : python-jinja2 (2024-604e4c3509)");
...
FEDORA-2024-604e4c3509 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-604e4c3509");
...
var pkgs = [
    {'reference':'python-jinja2-3.1.3-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
