...
# extracted from Fedora Security Advisory FEDORA-2024-4e0b4ce6ad
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-4e0b4ce6ad");

  script_name(english:"Fedora 41 : webkitgtk (2024-4e0b4ce6ad)");
...
FEDORA-2024-4e0b4ce6ad advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-4e0b4ce6ad");
...
var pkgs = [
    {'reference':'webkitgtk-2.46.3-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
