...
# extracted from Oracle Linux Security Advisory ELSA-2020-0559.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : ksh (ELSA-2020-0559)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2020-0559.html");
...
var pkgs = [
    {'reference':'ksh-20120801-253.0.1.el8_1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ksh-20120801-253.0.1.el8_1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
