...
This update includes a security fix :
  ...
  - CVE-2015-3456: Fixed a buffer overflow in the floppy
    ...
    host.");
  script_set_attribute(attribute:"see_also", value:"https://wiki.qemu.org/ChangeLog/2.1");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=929339");
