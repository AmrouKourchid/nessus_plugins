...
# extracted from Fedora Security Advisory FEDORA-2024-430678b035
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-430678b035");

  script_name(english:"Fedora 40 : lua-mpack (2024-430678b035)");
...
FEDORA-2024-430678b035 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-430678b035");
  script_set_attribute(attribute:"solution", value:
"Update the affected lua-mpack package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:lua-mpack");
...
var pkgs = [
    {'reference':'lua-mpack-1.0.12-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'lua-mpack');
}
