...
referenced in the RHSA-2019:0219 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_0219.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?625c9a24");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:0219");
...
"Update the RHEL firefox package based on the guidance in RHSA-2019:0219.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-60.5.0-2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
