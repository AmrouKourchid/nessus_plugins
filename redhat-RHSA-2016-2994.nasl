...
# extracted from Red Hat Security Advisory RHSA-2016:2994. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2016:2994");

  script_name(english:"RHEL 7 : Red Hat Ceph Storage 1.3 (RHSA-2016:2994)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"An update is now available for Red Hat Ceph Storage 1.3. This erratum
is for Red Hat Ceph Storage that runs on Red Hat Enterprise Linux 7.
...
cross-origin HTTP requests if the CORS policy was set to allow origin
on a bucket. A remote unauthenticated attacker could use this flaw to
cause denial of service by sending a specially crafted cross-origin
HTTP request. (CVE-2016-9579)");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2016:2994");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/cve-2016-9579");
...
else
{
  ...
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"ceph-common-0.94.9-9.el7cp")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"ceph-debuginfo-0.94.9-9.el7cp")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"ceph-radosgw-0.94.9-9.el7cp")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"ceph-selinux-0.94.9-9.el7cp")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"librados2-0.94.9-9.el7cp")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"librados2-devel-0.94.9-9.el7cp")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"librbd1-0.94.9-9.el7cp")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"librbd1-devel-0.94.9-9.el7cp")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"python-rados-0.94.9-9.el7cp")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"python-rbd-0.94.9-9.el7cp")) flag++;
