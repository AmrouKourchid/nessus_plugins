...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : cups (EulerOS-SA-2019-1568)");
...
vulnerabilities :
  ...
  - The session cookie generated by the CUPS web interface
    was easy to guess on Linux, allowing unauthorized
    scripted access to the web interface when the web
    interface is enabled. (CVE-2018-4300)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1568
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d8a00da8");
...
pkgs = ["cups-1.6.3-35.h3.eulerosv2r7",
        "cups-client-1.6.3-35.h3.eulerosv2r7",
        "cups-devel-1.6.3-35.h3.eulerosv2r7",
        "cups-filesystem-1.6.3-35.h3.eulerosv2r7",
        "cups-libs-1.6.3-35.h3.eulerosv2r7",
        "cups-lpd-1.6.3-35.h3.eulerosv2r7"];
