...
# extracted from Ubuntu Security Notice USN-6707-3. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6707-3");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2024/06/20");

  script_name(english:"Ubuntu 22.04 LTS / 23.10 : Linux kernel (AWS) vulnerabilities (USN-6707-3)");
...
referenced in the USN-6707-3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6707-3");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-6.5.0-1016-aws");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-6707-3');
}
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-6707-3');
  }
  else
  {
