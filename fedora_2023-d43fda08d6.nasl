...
# extracted from Fedora Security Advisory FEDORA-2023-d43fda08d6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-d43fda08d6");

  script_name(english:"Fedora 37 : libopenmpt (2023-d43fda08d6)");
...
FEDORA-2023-d43fda08d6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-d43fda08d6");
...
var pkgs = [
    {'reference':'libopenmpt-0.6.11-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
