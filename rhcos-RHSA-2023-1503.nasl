...
if (description)
{
  ...
  script_name(english:"RHCOS 4 : OpenShift Container Platform 4.11.34 (RHSA-2023:1503)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat CoreOS host is missing a security update for OpenShift Container Platform 4.11.34.");
...
referenced in the RHSA-2023:1503 advisory.
...
"Update the RHCOS OpenShift Container Platform 4.11.34 packages based on the guidance in RHSA-2023:1503.");
...
var pkgs = [
    {'reference':'cri-o-1.24.4-10.rhaos4.11.git1ed5ac5.el8', 'release':'4', 'el_string':'el8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
];
