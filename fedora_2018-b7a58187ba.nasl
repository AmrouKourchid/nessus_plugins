...
# extracted from Fedora Security Advisory FEDORA-2018-b7a58187ba.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-b7a58187ba");

  script_name(english:"Fedora 29 : 1:wireshark (2018-b7a58187ba)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"New version 2.6.4, contains security fix for CVE-2018-16056,
CVE-2018-16057, CVE-2018-16058.

Note that Tenable Network Security has extracted the preceding
description block directly from the Fedora update system website.
Tenable has attempted to automatically clean and format it as much as
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-b7a58187ba");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"wireshark-2.6.4-1.fc29", epoch:"1")) flag++;
