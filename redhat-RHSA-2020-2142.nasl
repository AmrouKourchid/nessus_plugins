...
# extracted from Red Hat Security Advisory RHSA-2020:2142. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:2142");
  script_xref(name:"IAVB", value:"2020-B-0016-S");

  script_name(english:"RHEL 7 : Ansible security update (2.7.18) (Moderate) (RHSA-2020:2142)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_2142.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fea97a23");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:2142");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1811008");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Ansible package based on the guidance in RHSA-2020:2142.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ansible-2.7.18-1.el7ae', 'release':'7', 'el_string':'el7ae', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2.7'}
    ]
  }
];
