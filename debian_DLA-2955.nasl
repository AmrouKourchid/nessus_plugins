...
# extracted from Debian Security Advisory dla-2955. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2955-1 : bind9 - LTS security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 9 host has packages installed that are affected by a vulnerability as referenced in the dla-2955
advisory.

    It was found that bind9, an internet domain name server, was vulnerable to cache poisoning. When using
    forwarders, bogus NS records supplied by, or via, those forwarders may be cached and used by named if it
    needs to recurse for any reason, causing it to obtain and pass on potentially incorrect answers. For
    Debian 9 stretch, this problem has been fixed in version 1:9.10.3.dfsg.P4-12.3+deb9u11. We recommend that
    you upgrade your bind9 packages. For the detailed security status of bind9 please refer to its security
    tracker page at: https://security-tracker.debian.org/tracker/bind9 Further information about Debian LTS
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2022/dla-2955");
...
For Debian 9 stretch, this problem has been fixed in version 1");
  ...
  script_set_attribute(attribute:"plugin_publication_date", value:"2022/03/19");
...
var pkgs = [
    {'release': '9.0', 'prefix': 'bind9', 'reference': '1:9.10.3.dfsg.P4-12.3+deb9u11'},
    {'release': '9.0', 'prefix': 'bind9-doc', 'reference': '1:9.10.3.dfsg.P4-12.3+deb9u11'},
    {'release': '9.0', 'prefix': 'bind9-host', 'reference': '1:9.10.3.dfsg.P4-12.3+deb9u11'},
    {'release': '9.0', 'prefix': 'bind9utils', 'reference': '1:9.10.3.dfsg.P4-12.3+deb9u11'},
    {'release': '9.0', 'prefix': 'dnsutils', 'reference': '1:9.10.3.dfsg.P4-12.3+deb9u11'},
    {'release': '9.0', 'prefix': 'host', 'reference': '1:9.10.3.dfsg.P4-12.3+deb9u11'},
    {'release': '9.0', 'prefix': 'libbind-dev', 'reference': '1:9.10.3.dfsg.P4-12.3+deb9u11'},
    {'release': '9.0', 'prefix': 'libbind-export-dev', 'reference': '1:9.10.3.dfsg.P4-12.3+deb9u11'},
    {'release': '9.0', 'prefix': 'libbind9-140', 'reference': '1:9.10.3.dfsg.P4-12.3+deb9u11'},
    {'release': '9.0', 'prefix': 'libdns-export162', 'reference': '1:9.10.3.dfsg.P4-12.3+deb9u11'},
    {'release': '9.0', 'prefix': 'libdns162', 'reference': '1:9.10.3.dfsg.P4-12.3+deb9u11'},
    {'release': '9.0', 'prefix': 'libirs-export141', 'reference': '1:9.10.3.dfsg.P4-12.3+deb9u11'},
    {'release': '9.0', 'prefix': 'libirs141', 'reference': '1:9.10.3.dfsg.P4-12.3+deb9u11'},
    {'release': '9.0', 'prefix': 'libisc-export160', 'reference': '1:9.10.3.dfsg.P4-12.3+deb9u11'},
    {'release': '9.0', 'prefix': 'libisc160', 'reference': '1:9.10.3.dfsg.P4-12.3+deb9u11'},
    {'release': '9.0', 'prefix': 'libisccc-export140', 'reference': '1:9.10.3.dfsg.P4-12.3+deb9u11'},
    {'release': '9.0', 'prefix': 'libisccc140', 'reference': '1:9.10.3.dfsg.P4-12.3+deb9u11'},
    {'release': '9.0', 'prefix': 'libisccfg-export140', 'reference': '1:9.10.3.dfsg.P4-12.3+deb9u11'},
    {'release': '9.0', 'prefix': 'libisccfg140', 'reference': '1:9.10.3.dfsg.P4-12.3+deb9u11'},
    {'release': '9.0', 'prefix': 'liblwres141', 'reference': '1:9.10.3.dfsg.P4-12.3+deb9u11'},
    {'release': '9.0', 'prefix': 'lwresd', 'reference': '1:9.10.3.dfsg.P4-12.3+deb9u11'}
];
