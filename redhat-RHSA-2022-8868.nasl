...
# extracted from Red Hat Security Advisory RHSA-2022:8868. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:8868");

  script_name(english:"RHEL 8 : Red Hat OpenStack Platform 16.1.9 (python-scciclient) (RHSA-2022:8868)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for Red Hat OpenStack Platform 16.1.9 (python-scciclient).");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8868.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b624b68b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8868");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2115122");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat OpenStack Platform 16.1.9 (python-scciclient) package based on the guidance in RHSA-2022:8868.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-scciclient-0.9.1-2.20220111031440.el8ost', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
