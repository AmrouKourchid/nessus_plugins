...
# extracted from Fedora Security Advisory FEDORA-2022-8d29386f00
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-8d29386f00");

  script_name(english:"Fedora 37 : sfnt2woff-zopfli (2022-8d29386f00)");
...
FEDORA-2022-8d29386f00 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-8d29386f00");
  script_set_attribute(attribute:"solution", value:
"Update the affected sfnt2woff-zopfli package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:sfnt2woff-zopfli");
...
var pkgs = [
    {'reference':'sfnt2woff-zopfli-1.3.1-3.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'sfnt2woff-zopfli');
}
