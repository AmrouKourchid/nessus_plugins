...
# extracted from Fedora Security Advisory FEDORA-2023-ed9922536e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-ed9922536e");

  script_name(english:"Fedora 38 : keylime (2023-ed9922536e)");
...
FEDORA-2023-ed9922536e advisory.

    Backport upstream fixes

    - Fixes: CVE-2023-38200
    - Fixes: CVE-2023-38201
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-ed9922536e");
...
var pkgs = [
    {'reference':'keylime-6.6.0-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
