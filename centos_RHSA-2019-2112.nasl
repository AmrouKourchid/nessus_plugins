...
# extracted from Red Hat Security Advisory RHSA-2019:2112 and 
# CentOS Errata and Security Advisory 2019:2112 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : mod_auth_openidc (CESA-2019:2112)");
...
mod_auth_openidc enables an Apache 2.x web server to operate as an
...
Enterprise Linux 7.7 Release Notes linked from the References section.");
  # https://lists.centos.org/pipermail/centos-cr-announce/2019-August/005996.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bf90a600");
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"mod_auth_openidc-1.8.8-5.el7")) flag++;
