...
# extracted from Fedora Security Advisory FEDORA-2023-4708733ccc
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-4708733ccc");

  script_name(english:"Fedora 37 : tigervnc (2023-4708733ccc)");
...
FEDORA-2023-4708733ccc advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-4708733ccc");
...
var pkgs = [
    {'reference':'tigervnc-1.13.1-6.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
