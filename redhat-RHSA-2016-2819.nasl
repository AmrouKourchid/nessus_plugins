...
# extracted from Red Hat Security Advisory RHSA-2016:2819. The text 
...
referenced in the RHSA-2016:2819 advisory.
    ...
    * An integer overflow flaw, leading to a heap-based buffer overflow, was found in memcached's parsing of
    SASL authentication messages. An attacker could create a specially crafted message that would cause the
    memcached server to crash or, potentially, execute arbitrary code. (CVE-2016-8706)

Tenable has extracted the preceding description block directly from the Red Hat Enterprise Linux security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2016/rhsa-2016_2819.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7916a611");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2016:2819");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1390512");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL memcached package based on the guidance in RHSA-2016:2819.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'memcached-1.4.15-10.el7_3.1', 'release':'7', 'el_string':'el7_3', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'memcached-devel-1.4.15-10.el7_3.1', 'release':'7', 'el_string':'el7_3', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
