...
# SUSE update advisory SUSE-SU-2023:2660-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:2660-1");

  script_name(english:"SUSE SLES12 Security Update : kernel (Live Patch 28 for SLE 12 SP4) (SUSE-SU-2023:2660-1)");
...
the SUSE-SU-2023:2660-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://lists.suse.com/pipermail/sle-updates/2023-June/030088.html");
...
"Update the affected kgraft-patch-4_12_14-95_102-default package.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-95.102-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_12_14-95_102-default-11-2.3', 'sp':'4', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.4']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kgraft-patch-4_12_14-95_102-default');
}
