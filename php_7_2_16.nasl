...
if (description)
{
  ...
  script_name(english:"PHP 7.2.x < 7.2.16 Multiple vulnerabilities.");
...
server is 7.2.x prior to 7.2.16. It is, therefore, affected by
multiple vulnerabilities:
  ...
  - An access control bypass vulnerability exists due to the
    ...
    to (CVE-2019-9637).");
  script_set_attribute(attribute:"see_also", value:"http://php.net/ChangeLog-7.php#7.2.16");
  script_set_attribute(attribute:"solution", value:
"Upgrade to PHP version 7.2.16 or later.");
