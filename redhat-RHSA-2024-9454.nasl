...
# extracted from Red Hat Security Advisory RHSA-2024:9454. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:9454");

  script_name(english:"RHEL 9 : podman (RHSA-2024:9454)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for podman.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:9454 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-60263");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-61249");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_9454.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?816c1f67");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:9454");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL podman package based on the guidance in RHSA-2024:9454.");
  ...
  script_cwe_id(20, 22, 59, 674, 1325);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'podman-5.2.2-9.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
      {'reference':'podman-docker-5.2.2-9.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
      {'reference':'podman-plugins-5.2.2-9.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
      {'reference':'podman-remote-5.2.2-9.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
      {'reference':'podman-tests-5.2.2-9.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'}
    ]
  }
];
