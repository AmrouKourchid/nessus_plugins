...
# extracted from Fedora Security Advisory FEDORA-2019-c96a8d12b0.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : apache-commons-compress (2019-c96a8d12b0)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-c96a8d12b0");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"apache-commons-compress-1.19-1.fc30")) flag++;
