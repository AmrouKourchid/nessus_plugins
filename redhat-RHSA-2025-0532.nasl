...
# extracted from Red Hat Security Advisory RHSA-2025:0532. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:0532");

  script_name(english:"RHEL 9 : .NET 8.0 (RHSA-2025:0532)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for .NET 8.0.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2025:0532 advisory.
    ...
    .NET SDK 8.0.112 and .NET Runtime 8.0.12.Security Fix(es):
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_0532.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5e29a9c6");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:0532");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL .NET 8.0 package based on the guidance in RHSA-2025:0532.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'aspnetcore-runtime-8.0-8.0.12-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'aspnetcore-runtime-dbg-8.0-8.0.12-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'aspnetcore-targeting-pack-8.0-8.0.12-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-apphost-pack-8.0-8.0.12-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-host-8.0.12-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-hostfxr-8.0-8.0.12-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-runtime-8.0-8.0.12-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-runtime-dbg-8.0-8.0.12-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-sdk-8.0-8.0.112-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-sdk-8.0-source-built-artifacts-8.0.112-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-sdk-dbg-8.0-8.0.112-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-targeting-pack-8.0-8.0.12-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-templates-8.0-8.0.112-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'netstandard-targeting-pack-2.1-8.0.112-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
