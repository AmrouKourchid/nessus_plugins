...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : dhcp (EulerOS-SA-2018-1162)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1162
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9d0b9083");
...
pkgs = ["dhclient-4.2.5-58.3.h3",
        "dhcp-4.2.5-58.3.h3",
        "dhcp-common-4.2.5-58.3.h3",
        "dhcp-libs-4.2.5-58.3.h3"];
