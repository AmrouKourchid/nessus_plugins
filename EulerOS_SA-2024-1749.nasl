...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP12 : python-jinja2 (EulerOS-SA-2024-1749)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1749
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fe508ca8");
...
var pkgs = [
  "python3-jinja2-3.0.3-2.h1.eulerosv2r12"
];
