...
# extracted from Fedora Security Advisory FEDORA-2023-179053442b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-179053442b");

  script_name(english:"Fedora 37 : phpMyAdmin (2023-179053442b)");
...
FEDORA-2023-179053442b advisory.

    **phpMyAdmin 5.2.1**

    This is a bugfix release that also contains a security fix for an XSS vulnerability in the drag-and-drop
    upload functionality (**PMASA-2023-01**).
    ...
    - issue #16042 Exported gzip file of database has first ~73 kB uncompressed and rest is gzip compressed in
    Firefox
    - issue #17705 Fix inline SQL query edit FK checkbox preventing submit buttons from working
    - issue #17777 Fix Uncaught TypeError: Cannot read properties of null (reading 'inline') on datepickers
    when re-opened
    ...
    - issue #17446 Fix missing option for STORED virtual column on MySQL and PERSISTENT is not supported on
    MySQL
    ...
    - issue        Add `spellcheck=false` to all password fields and some text fields to avoid spell-jacking
    data leaks
    ...
    - issue #18019 Fix Call to a member function fetchAssoc() on bool with SQL mode ONLY_FULL_GROUP_BY on
    monitor search logs
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-179053442b");
...
var pkgs = [
    {'reference':'phpMyAdmin-5.2.1-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
