...
# extracted from Fedora Security Advisory FEDORA-2024-7dac82a14e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-7dac82a14e");

  script_name(english:"Fedora 40 : python-django (2024-7dac82a14e)");
...
FEDORA-2024-7dac82a14e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-7dac82a14e");
...
var pkgs = [
    {'reference':'python-django-4.2.14-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
