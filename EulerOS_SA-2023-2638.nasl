...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : docker-runc (EulerOS-SA-2023-2638)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2638
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d777156b");
...
var pkgs = [
  "docker-runc-1.0.0.rc3-300.h18.eulerosv2r11"
];
