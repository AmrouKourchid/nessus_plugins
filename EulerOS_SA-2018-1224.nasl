...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : php (EulerOS-SA-2018-1224)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1224
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b8f18a71");
...
"Update the affected php package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-10548");
...
pkgs = ["php-5.4.16-42.h34",
        "php-cli-5.4.16-42.h34",
        "php-common-5.4.16-42.h34",
        "php-gd-5.4.16-42.h34",
        "php-ldap-5.4.16-42.h34",
        "php-mysql-5.4.16-42.h34",
        "php-odbc-5.4.16-42.h34",
        "php-pdo-5.4.16-42.h34",
        "php-pgsql-5.4.16-42.h34",
        "php-process-5.4.16-42.h34",
        "php-recode-5.4.16-42.h34",
        "php-soap-5.4.16-42.h34",
        "php-xml-5.4.16-42.h34",
        "php-xmlrpc-5.4.16-42.h34"];
