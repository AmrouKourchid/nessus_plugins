...
# extracted from Fedora Security Advisory FEDORA-2024-a702b78744
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-a702b78744");

  script_name(english:"Fedora 40 : python3.6 (2024-a702b78744)");
...
FEDORA-2024-a702b78744 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-a702b78744");
...
var pkgs = [
    {'reference':'python3.6-3.6.15-30.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
