...
# extracted from Fedora Security Advisory FEDORA-2019-b3aec99d2c.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : 1:xpdf (2019-b3aec99d2c)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-b3aec99d2c");
...
"Update the affected 1:xpdf package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-7454");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"xpdf-4.01-1.fc29", epoch:"1")) flag++;
