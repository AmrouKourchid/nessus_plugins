...
# extracted from Gentoo Linux Security Advisory GLSA 202012-15.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202012-15");

  script_name(english:"GLSA-202012-15 : GDK-PixBuf: Denial of service");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202012-15
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202012-15");
...
if (qpkg_check(package:"x11-libs/gdk-pixbuf", unaffected:make_list("ge 2.42.2"), vulnerable:make_list("lt 2.42.2"))) flag++;
