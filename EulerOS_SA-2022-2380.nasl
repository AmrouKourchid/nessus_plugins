...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.0 : gnupg2 (EulerOS-SA-2022-2380)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2380
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6d69e347");
...
var pkgs = [
  "gnupg2-2.2.17-5.h9.eulerosv2r9"
];
