...
# extracted from Debian Security Advisory DLA-1983-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1983-1 : simplesamlphp security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2019/11/msg00003.html");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"simplesamlphp", reference:"1.13.1-2+deb8u3")) flag++;
