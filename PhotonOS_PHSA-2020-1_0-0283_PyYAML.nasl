...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Pyyaml PHSA-2020-1.0-0283");
...
if (rpm_check(release:"PhotonOS-1.0", cpu:"x86_64", reference:"PyYAML-3.12-4.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", cpu:"x86_64", reference:"PyYAML-debuginfo-3.12-4.ph1")) flag++;
