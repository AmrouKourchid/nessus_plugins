...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : grub2 (EulerOS-SA-2023-1443)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1443
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2f2fd953");
...
var pkgs = [
  ...
  "grub2-efi-aa64-2.02-73.h42.eulerosv2r9",
  "grub2-efi-aa64-modules-2.02-73.h42.eulerosv2r9",
