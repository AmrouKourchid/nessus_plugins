...
# extracted from Fedora Security Advisory FEDORA-2023-1332ed94a7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-1332ed94a7");

  script_name(english:"Fedora 37 : mingw-xerces-c (2023-1332ed94a7)");
...
FEDORA-2023-1332ed94a7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-1332ed94a7");
...
var pkgs = [
    {'reference':'mingw-xerces-c-3.2.4-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
