...
the CVE page(s) listed in the References section.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bd53079c");
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"firefox-60.6.0-3.el6.centos", allowmaj:TRUE)) flag++;
