...
# SUSE update advisory SUSE-SU-2024:4248-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2024:4248-1");

  script_name(english:"SUSE SLES15 Security Update : kernel (Live Patch 50 for SLE 15 SP2) (SUSE-SU-2024:4248-1)");
...
the SUSE-SU-2024:4248-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2024-December/019954.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fcc32ea5");
...
"Update the affected kernel-livepatch-5_3_18-150200_24_197-default package.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:S/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:L/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-47600");
...
var kernel_live_checks = [
  {
    'kernels': {
      '5.3.18-150200.24.197-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_3_18-150200_24_197-default-4-150200.5.6.1', 'sp':'2', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.2']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kernel-livepatch-5_3_18-150200_24_197-default');
}
