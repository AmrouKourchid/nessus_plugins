...
if (description)
{
  ...
  script_name(english:"Apache Tomcat 10.1.0.M1 < 10.1.35");

  script_set_attribute(attribute:"synopsis", value:
"The remote Apache Tomcat server is affected by a vulnerability");
  script_set_attribute(attribute:"description", value:
"The version of Tomcat installed on the remote host is prior to 10.1.35. It is, therefore, affected by a vulnerability as
referenced in the fixed_in_apache_tomcat_10.1.35_security-10 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7de582f9");
  # https://tomcat.apache.org/security-10.html#Fixed_in_Apache_Tomcat_10.1.35
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?668593b7");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Apache Tomcat version 10.1.35 or later.");
...
var constraints = [
  { 'min_version' : '10.1.0.M1', 'max_version' : '10.1.34', 'fixed_version' : '10.1.35' }
];
