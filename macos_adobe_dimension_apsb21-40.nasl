...
if (description)
{
  ...
  script_name(english:"Adobe Dimension < 3.4.3 Arbitrary code execution (APSB21-40) (macOS)");
...
"The version of Adobe Dimension installed on the remote macOS host is prior to 3.4.3. It is, therefore, affected by a
