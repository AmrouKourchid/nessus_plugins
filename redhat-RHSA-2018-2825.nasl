...
# extracted from Red Hat Security Advisory RHSA-2018:2825. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:2825");

  script_name(english:"RHEL 7 : rh-perl526-mod_perl (RHSA-2018:2825)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for rh-perl526-mod_perl.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2018:2825 advisory.
...
number.");
  ...
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_2825.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d1eacb3e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:2825");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rh-perl526-mod_perl package based on the guidance in RHSA-2018:2825.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rh-perl526-mod_perl");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rh-perl526-mod_perl-devel");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-perl526-mod_perl-2.0.10-10.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-perl526-mod_perl-devel-2.0.10-10.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'rh-perl526-mod_perl / rh-perl526-mod_perl-devel');
}
