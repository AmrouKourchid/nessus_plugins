...
# extracted from Gentoo Linux Security Advisory GLSA 202107-50.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2021-32635");
  script_xref(name:"GLSA", value:"202107-50");

  script_name(english:"GLSA-202107-50 : Singularity: Remote code execution");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202107-50
(Singularity: Remote code execution)

    Singularity always uses the default remote endpoint,
      &lsquo;cloud.syslabs.io&rsquo;, for action commands using the &lsquo;library://&rsquo;
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202107-50"
  );
  script_set_attribute(
    attribute:"solution",
    value:
"All Singularity users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-32635");
  script_set_attribute(attribute:"exploitability_ease", value:"No known exploits are available");
  script_set_attribute(attribute:"exploit_available", value:"false");

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:singularity");
...
if (qpkg_check(package:"sys-cluster/singularity", unaffected:make_list("ge 3.7.4"), vulnerable:make_list("lt 3.7.4"))) flag++;
