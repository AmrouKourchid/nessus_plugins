...
# extracted from Gentoo Linux Security Advisory GLSA 201804-07.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201804-07");

  script_name(english:"GLSA-201804-07 : libvirt: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-201804-07
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/201804-07");
...
if (qpkg_check(package:"app-emulation/libvirt", unaffected:make_list("ge 4.1.0"), vulnerable:make_list("lt 4.1.0"))) flag++;
