...
# extracted from Red Hat Security Advisory RHSA-2024:9185. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:9185");

  script_name(english:"RHEL 9 : iperf3 (RHSA-2024:9185)");
...
referenced in the RHSA-2024:9185 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_9185.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5af6b787");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:9185");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL iperf3 package based on the guidance in RHSA-2024:9185.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'iperf3-3.9-13.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
