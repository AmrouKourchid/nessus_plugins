...
# extracted from Fedora Security Advisory FEDORA-2022-6d2b6ad1a6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-6d2b6ad1a6");

  script_name(english:"Fedora 36 : golang (2022-6d2b6ad1a6)");
...
FEDORA-2022-6d2b6ad1a6 advisory.

    go1.18.9 (released 2022-12-06) includes security fixes to the net/http and os packages, as well as bug
    fixes to cgo, the compiler, the runtime, and the crypto/x509 and os/exec packages. See the [Go 1.18.9
    milestone on the upstream issue
    tracker](https://github.com/golang/go/issues?q=milestone%3AGo1.18.9+label%3ACherryPickApproved) for
    details.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-6d2b6ad1a6");
...
var pkgs = [
    {'reference':'golang-1.18.9-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
