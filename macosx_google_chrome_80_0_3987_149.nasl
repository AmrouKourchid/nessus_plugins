...
"The version of Google Chrome installed on the remote macOS host is prior to 80.0.3987.149. It is, therefore, affected by
multiple vulnerabilities as referenced in the 2020_03_stable-channel-update-for-desktop_18 advisory. Note that Nessus
...
google_chrome_check_version(fix:'80.0.3987.149', severity:SECURITY_WARNING, xss:FALSE, xsrf:FALSE);
