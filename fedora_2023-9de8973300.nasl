...
# extracted from Fedora Security Advisory FEDORA-2023-9de8973300
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-9de8973300");
  script_xref(name:"IAVA", value:"2023-A-0674-S");

  script_name(english:"Fedora 39 : curl (2023-9de8973300)");
...
FEDORA-2023-9de8973300 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-9de8973300");
...
var pkgs = [
    {'reference':'curl-8.2.1-4.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
