...
# extracted from Oracle Linux Security Advisory ELSA-2024-6162.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : python-urllib3 (ELSA-2024-6162)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-6162.html");
...
var pkgs = [
    {'reference':'python3-urllib3-1.26.5-5.el9_4.1', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
