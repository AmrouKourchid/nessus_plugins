...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Python2 PHSA-2018-2.0-0037");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'python2-2.7.13-12.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'python2-debuginfo-2.7.13-12.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'python2-devel-2.7.13-12.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'python2-libs-2.7.13-12.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'python2-test-2.7.13-12.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'python2-tools-2.7.13-12.ph2')) flag++;
