...
if (description)
{
  ...
  script_name(english:"Security Update for Microsoft .NET Core (February 2024)");
...
vulnerability as referenced in the 2024_Feb_13 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://msrc.microsoft.com/update-guide/vulnerability/CVE-2024-21404");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5035119");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5035120");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5035121");
  # https://github.com/dotnet/core/blob/master/release-notes/6.0/6.0.27/6.0.27.md
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5c6a0fcb");
  # https://github.com/dotnet/core/blob/master/release-notes/7.0/7.0.16/7.0.16.md
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?18384751");
  # https://github.com/dotnet/core/blob/master/release-notes/8.0/8.0.2/8.0.2.md
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?83ecb845");
...
var constraints = [
  { 'min_version' : '6.0', 'fixed_version' : '6.0.27' },
