...
# extracted from Fedora Security Advisory FEDORA-2024-b2db508cc2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-b2db508cc2");

  script_name(english:"Fedora 38 : dotnet8.0 (2024-b2db508cc2)");
...
FEDORA-2024-b2db508cc2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-b2db508cc2");
...
var pkgs = [
    {'reference':'dotnet8.0-8.0.102-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
