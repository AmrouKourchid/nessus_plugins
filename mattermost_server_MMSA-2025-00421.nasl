...
if (description)
{
  ...
  script_cve_id("CVE-2025-25274");
  script_xref(name:"IAVA", value:"2025-A-0195-S");

  script_name(english:"Mattermost Server 9.11.x < 9.11.9 / 10.3.x < 10.3.4 / 10.4.x < 10.4.3 (MMSA-2025-00421)");
...
affected by a vulnerability as referenced in the MMSA-2025-00421 advisory.

  - Mattermost versions 10.4.x <= 10.4.2, 10.3.x <= 10.3.3, 9.11.x <= 9.11.8 fail to restrict command
...
"Upgrade to Mattermost Server version 9.11.9 / 10.3.4 / 10.4.3 / 10.5.0 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-25274");
