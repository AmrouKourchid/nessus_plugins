...
# extracted from Fedora Security Advisory FEDORA-2024-f71b7dad10
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-f71b7dad10");

  script_name(english:"Fedora 39 : mosquitto (2024-f71b7dad10)");
...
FEDORA-2024-f71b7dad10 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-f71b7dad10");
...
var pkgs = [
    {'reference':'mosquitto-2.0.19-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
