...
# extracted from Amazon Linux 2 Security Advisory ALASECS-2024-036.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : amazon-ecr-credential-helper (ALASECS-2024-036)");
...
by a vulnerability as referenced in the ALAS2ECS-2024-036 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALASECS-2024-036.html");
