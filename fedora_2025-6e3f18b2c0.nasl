...
# extracted from Fedora Security Advisory FEDORA-2025-6e3f18b2c0
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-6e3f18b2c0");

  script_name(english:"Fedora 40 : thunderbird (2025-6e3f18b2c0)");
...
FEDORA-2025-6e3f18b2c0 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-6e3f18b2c0");
...
var pkgs = [
    {'reference':'thunderbird-128.10.0-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
