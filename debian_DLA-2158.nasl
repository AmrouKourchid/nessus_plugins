...
# extracted from Debian Security Advisory DLA-2158-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2158-1 : ruby2.1 security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2020/03/msg00032.html");
...
"Upgrade the affected packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-2338");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"libruby2.1", reference:"2.1.5-2+deb8u9")) flag++;
if (deb_check(release:"8.0", prefix:"ruby2.1", reference:"2.1.5-2+deb8u9")) flag++;
if (deb_check(release:"8.0", prefix:"ruby2.1-dev", reference:"2.1.5-2+deb8u9")) flag++;
if (deb_check(release:"8.0", prefix:"ruby2.1-doc", reference:"2.1.5-2+deb8u9")) flag++;
if (deb_check(release:"8.0", prefix:"ruby2.1-tcltk", reference:"2.1.5-2+deb8u9")) flag++;
