...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.0 : python-pillow (EulerOS-SA-2024-2128)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2128
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6aa3564b");
...
var pkgs = [
  "python3-pillow-8.1.1-2.h12.eulerosv2r10"
];
