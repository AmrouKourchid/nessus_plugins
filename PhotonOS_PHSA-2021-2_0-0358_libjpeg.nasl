...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Libjpeg PHSA-2021-2.0-0358");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libjpeg-turbo-2.1.0-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libjpeg-turbo-devel-2.1.0-1.ph2')) flag++;
