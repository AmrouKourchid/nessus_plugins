...
# extracted from Red Hat Security Advisory RHSA-2024:2764. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2023-1973", "CVE-2023-4639", "CVE-2024-1459");
  script_xref(name:"RHSA", value:"2024:2764");

  script_name(english:"RHEL 8 / 9 : Red Hat JBoss Enterprise Application Platform 8.0 (RHSA-2024:2764)");
...
referenced in the RHSA-2024:2764 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2764.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?958edf0b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2764");
...
"Update the RHEL Red Hat JBoss Enterprise Application Platform 8.0 package based on the guidance in RHSA-2024:2764.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:H/Au:N/C:C/I:C/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:L/I:N/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-4639");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2024-1459");

  script_set_attribute(attribute:"exploitability_ease", value:"No known exploits are available");
  script_set_attribute(attribute:"exploit_available", value:"false");
  script_cwe_id(20, 24, 444);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'eap8-undertow-2.3.11-1.SP1_redhat_00001.1.el8eap', 'release':'8', 'el_string':'el8eap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap8'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'eap8-undertow-2.3.11-1.SP1_redhat_00001.1.el9eap', 'release':'9', 'el_string':'el9eap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap8'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'eap8-undertow');
}
