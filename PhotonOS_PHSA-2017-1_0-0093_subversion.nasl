...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'subversion-1.9.4-4.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'subversion-debuginfo-1.9.4-4.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'subversion-devel-1.9.4-4.ph1')) flag++;
