...
# extracted from Fedora Security Advisory FEDORA-2024-6f8c1d9005
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-6f8c1d9005");

  script_name(english:"Fedora 39 : ImageMagick (2024-6f8c1d9005)");
...
FEDORA-2024-6f8c1d9005 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-6f8c1d9005");
...
var pkgs = [
    {'reference':'ImageMagick-7.1.1.26-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
