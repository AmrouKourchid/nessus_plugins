...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2010-0585.html");
...
"Update the affected lftp package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2010-2251");
...
var pkgs = [
    {'reference':'lftp-3.7.11-4.el5_5.3', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'lftp-3.7.11-4.el5_5.3', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
