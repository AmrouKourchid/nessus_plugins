...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS : NTFS-3G vulnerability (USN-3182-1)");
...
USN-3182-1 advisory.
    ...
    Jann Horn discovered that NTFS-3G incorrectly filtered environment variables when using the modprobe
    utility. A local attacker could possibly use this issue to load arbitrary kernel modules.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3182-1");
  script_set_attribute(attribute:"solution", value:
"Update the affected ntfs-3g, ntfs-3g-dev and / or ntfs-3g-udeb packages.");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'ntfs-3g', 'pkgver': '1:2015.3.14AR.1-1ubuntu0.1'},
    {'osver': '16.04', 'pkgname': 'ntfs-3g-dev', 'pkgver': '1:2015.3.14AR.1-1ubuntu0.1'},
    {'osver': '16.04', 'pkgname': 'ntfs-3g-udeb', 'pkgver': '1:2015.3.14AR.1-1ubuntu0.1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'ntfs-3g / ntfs-3g-dev / ntfs-3g-udeb');
}
