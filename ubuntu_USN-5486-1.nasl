...
# extracted from Ubuntu Security Notice USN-5486-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5486-1");

  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS / 22.04 LTS : Intel Microcode vulnerabilities (USN-5486-1)");
...
vulnerabilities as referenced in the USN-5486-1 advisory.

    It was discovered that some Intel processors did not implement sufficient control flow management. A local
    attacker could use this to cause a denial of service. (CVE-2021-0127)
    ...
    cause a denial of service. (CVE-2021-33120)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5486-1");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'intel-microcode', 'pkgver': '3.20220510.0ubuntu0.18.04.1'},
    {'osver': '20.04', 'pkgname': 'intel-microcode', 'pkgver': '3.20220510.0ubuntu0.20.04.1'},
    {'osver': '22.04', 'pkgname': 'intel-microcode', 'pkgver': '3.20220510.0ubuntu0.22.04.1'}
];
