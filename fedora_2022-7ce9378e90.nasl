...
# extracted from Fedora Security Advisory FEDORA-2022-7ce9378e90
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-7ce9378e90");

  script_name(english:"Fedora 35 : grub2 (2022-7ce9378e90)");
...
FEDORA-2022-7ce9378e90 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-7ce9378e90");
...
var pkgs = [
    {'reference':'grub2-2.06-14.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
