...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.0 : python-cryptography (EulerOS-SA-2023-2491)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2491
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1674ad83");
...
var pkgs = [
  "python3-cryptography-2.9.2-1.h5.eulerosv2r10"
];
