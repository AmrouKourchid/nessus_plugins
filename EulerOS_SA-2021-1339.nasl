...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : openssl110f (EulerOS-SA-2021-1339)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1339
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3a82b332");
...
pkgs = ["openssl110f-1.1.0f-5.h16",
        "openssl110f-devel-1.1.0f-5.h16",
        "openssl110f-libs-1.1.0f-5.h16"];
