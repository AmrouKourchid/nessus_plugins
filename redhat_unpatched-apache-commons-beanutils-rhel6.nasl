...
# extracted from Red Hat Security Advisory apache-commons-beanutils. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 6 : apache-commons-beanutils (Unpatched Vulnerability) (deprecated)");
