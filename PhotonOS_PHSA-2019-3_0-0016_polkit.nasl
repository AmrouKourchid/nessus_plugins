...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Polkit PHSA-2019-3.0-0016");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'polkit-0.113-5.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'polkit-debuginfo-0.113-5.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'polkit-devel-0.113-5.ph3')) flag++;
