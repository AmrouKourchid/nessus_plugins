...
# extracted from Oracle Linux Security Advisory ELSA-2023-3584.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : c-ares (ELSA-2023-3584)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
ELSA-2023-3584 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-3584.html");
...
var pkgs = [
    {'reference':'c-ares-1.13.0-6.el8_8.2', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'c-ares-devel-1.13.0-6.el8_8.2', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'c-ares-1.13.0-6.el8_8.2', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'c-ares-devel-1.13.0-6.el8_8.2', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'c-ares-1.13.0-6.el8_8.2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'c-ares-devel-1.13.0-6.el8_8.2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
