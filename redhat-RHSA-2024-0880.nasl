...
# extracted from Red Hat Security Advisory RHSA-2024:0880. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:0880");

  script_name(english:"RHEL 8 : Release of OpenShift Serverless Client kn 1.31.1 (RHSA-2024:0880)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for Release of OpenShift Serverless Client kn 1.31.1.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has a package installed that is affected by multiple vulnerabilities as
referenced in the RHSA-2024:0880 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4694892b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#critical");
  # https://access.redhat.com/documentation/en-us/red_hat_openshift_serverless/1.31
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6377a5c6");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0880");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Release of OpenShift Serverless Client kn 1.31.1 package based on the guidance in RHSA-2024:0880.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openshift-serverless-clients-1.10.0-6.el8', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openshift-serverless-clients-1.10.0-6.el8', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openshift-serverless-clients-1.10.0-6.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
