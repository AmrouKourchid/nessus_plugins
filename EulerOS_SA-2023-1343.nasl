...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : wayland (EulerOS-SA-2023-1343)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the wayland packages installed, the EulerOS installation on the remote host is affected by
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1343
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?be87d39d");
  script_set_attribute(attribute:"solution", value:
"Update the affected wayland packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:libwayland-client");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:libwayland-cursor");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:libwayland-egl");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:libwayland-server");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:wayland-devel");
...
var pkgs = [
  "libwayland-client-1.16.0-1.h1.eulerosv2r8",
  "libwayland-cursor-1.16.0-1.h1.eulerosv2r8",
  "libwayland-egl-1.16.0-1.h1.eulerosv2r8",
  "libwayland-server-1.16.0-1.h1.eulerosv2r8",
  "wayland-devel-1.16.0-1.h1.eulerosv2r8"
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "wayland");
}
