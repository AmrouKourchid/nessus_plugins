...
if (description)
{
  ...
  script_name(english:"TYPO3 8.0.0 < 8.7.49 ELTS / 9.0.0 < 9.5.38 ELTS / 10.0.0 < 10.4.33 / 11.0.0 < 11.5.20 / 12.0.0 < 12.1.1 (TYPO3-CORE-SA-2022-013)");
...
TYPO3-CORE-SA-2022-013 advisory.

  - Restricting frontend login to specific users, organized in different storage folders (partitions), can be
    bypassed. A potential attacker might use this ambiguity in usernames to get access to a different account
    - however, credentials must be known to the adversary. (CVE-2022-23501)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://typo3.org/security/advisory/typo3-core-sa-2022-013");
...
"Upgrade to TYPO3 8.7.49 ELTS, 9.5.38 ELTS, 10.4.33, 11.5.20, 12.1.1 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-23501");
