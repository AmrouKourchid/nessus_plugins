...
# extracted from Fedora Security Advisory FEDORA-2024-325c1d1fce
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-325c1d1fce");
  script_xref(name:"IAVA", value:"2024-A-0133-S");

  script_name(english:"Fedora 38 : thunderbird (2024-325c1d1fce)");
...
FEDORA-2024-325c1d1fce advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-325c1d1fce");
...
var pkgs = [
    {'reference':'thunderbird-115.8.1-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
