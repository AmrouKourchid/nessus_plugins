...
# extracted from Fedora Security Advisory FEDORA-2024-666210bd74
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-666210bd74");

  script_name(english:"Fedora 39 : mbedtls (2024-666210bd74)");
...
FEDORA-2024-666210bd74 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-666210bd74");
...
var pkgs = [
    {'reference':'mbedtls-2.28.8-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
