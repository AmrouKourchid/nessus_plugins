...
# extracted from Red Hat Security Advisory RHSA-2024:6973. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:6973");

  script_name(english:"RHEL 8 : dovecot (RHSA-2024:6973)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for dovecot.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:6973 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_6973.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1de8d6b3");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:6973");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL dovecot package based on the guidance in RHSA-2024:6973.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'dovecot-2.3.16-6.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'dovecot-devel-2.3.16-6.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'dovecot-mysql-2.3.16-6.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'dovecot-pgsql-2.3.16-6.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'dovecot-pigeonhole-2.3.16-6.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
