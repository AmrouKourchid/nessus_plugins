...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.0 : libXpm (EulerOS-SA-2024-1530)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1530
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ea4ef691");
...
var pkgs = [
  "libXpm-3.5.13-1.h4.eulerosv2r10"
];
