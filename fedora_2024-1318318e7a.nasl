...
# extracted from Fedora Security Advisory FEDORA-2024-1318318e7a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-1318318e7a");

  script_name(english:"Fedora 41 : libsndfile (2024-1318318e7a)");
...
FEDORA-2024-1318318e7a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-1318318e7a");
...
var pkgs = [
    {'reference':'libsndfile-1.2.2-5.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
