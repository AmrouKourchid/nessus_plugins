...
# extracted from Red Hat Security Advisory RHSA-2022:0260. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:0260");
  script_xref(name:"IAVB", value:"2021-B-0047-S");

  script_name(english:"RHEL 8 : Red Hat OpenStack Platform 16.1 (etcd) (RHSA-2022:0260)");
...
referenced in the RHSA-2022:0260 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_0260.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c1f4ddfe");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:0260");
...
"Update the RHEL Red Hat OpenStack Platform 16.1 (etcd) package based on the guidance in RHSA-2022:0260.");
