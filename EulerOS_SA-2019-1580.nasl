...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : httpd (EulerOS-SA-2019-1580)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1580
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d1c85d65");
...
pkgs = ["httpd-2.4.6-45.0.1.4.h12",
        "httpd-devel-2.4.6-45.0.1.4.h12",
        "httpd-manual-2.4.6-45.0.1.4.h12",
        "httpd-tools-2.4.6-45.0.1.4.h12",
        "mod_ssl-2.4.6-45.0.1.4.h12"];
