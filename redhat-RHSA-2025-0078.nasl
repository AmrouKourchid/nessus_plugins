...
# extracted from Red Hat Security Advisory RHSA-2025:0078. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:0078");

  script_name(english:"RHEL 8 : python3.11-urllib3 (RHSA-2025:0078)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_0078.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?124d353f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:0078");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python3.11-urllib3 package based on the guidance in RHSA-2025:0078.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3.11-urllib3-1.26.12-1.el8_8.2', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
