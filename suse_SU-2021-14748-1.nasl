...
# SUSE update advisory SUSE-SU-2021:14748-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2021:14748-1");

  script_name(english:"SUSE SLES11 Security Update : xorg-x11-libX11 (SUSE-SU-2021:14748-1)");
...
in the SUSE-SU-2021:14748-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2021-June/009017.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?07965806");
  script_set_attribute(attribute:"solution", value:
"Update the affected xorg-x11-libX11 and / or xorg-x11-libX11-32bit packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:suse_linux:xorg-x11-libX11-32bit");
...
var pkgs = [
    {'reference':'xorg-x11-libX11-32bit-7.4-5.11.72.27', 'sp':'4', 'cpu':'s390x', 'release':'SLES_SAP11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-11.4']},
    {'reference':'xorg-x11-libX11-32bit-7.4-5.11.72.27', 'sp':'4', 'cpu':'x86_64', 'release':'SLES_SAP11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-11.4']},
    {'reference':'xorg-x11-libX11-7.4-5.11.72.27', 'sp':'4', 'release':'SLES_SAP11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-11.4']},
    {'reference':'xorg-x11-libX11-32bit-7.4-5.11.72.27', 'sp':'4', 'cpu':'s390x', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.4']},
    {'reference':'xorg-x11-libX11-32bit-7.4-5.11.72.27', 'sp':'4', 'cpu':'x86_64', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.4']},
    {'reference':'xorg-x11-libX11-7.4-5.11.72.27', 'sp':'4', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.4']}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'xorg-x11-libX11 / xorg-x11-libX11-32bit');
}
