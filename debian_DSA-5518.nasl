...
# extracted from Debian Security Advisory dsa-5518. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-5518-1 : libvpx - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 / 12 host has packages installed that are affected by a vulnerability as referenced in the dsa-5518
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2023/dsa-5518");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'libvpx-dev', 'reference': '1.9.0-1+deb11u2'},
    {'release': '11.0', 'prefix': 'libvpx-doc', 'reference': '1.9.0-1+deb11u2'},
    {'release': '11.0', 'prefix': 'libvpx6', 'reference': '1.9.0-1+deb11u2'},
    {'release': '11.0', 'prefix': 'vpx-tools', 'reference': '1.9.0-1+deb11u2'},
    {'release': '12.0', 'prefix': 'libvpx-dev', 'reference': '1.12.0-1+deb12u2'},
    {'release': '12.0', 'prefix': 'libvpx-doc', 'reference': '1.12.0-1+deb12u2'},
    {'release': '12.0', 'prefix': 'libvpx7', 'reference': '1.12.0-1+deb12u2'},
    {'release': '12.0', 'prefix': 'vpx-tools', 'reference': '1.12.0-1+deb12u2'}
];
