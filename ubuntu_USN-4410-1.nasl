...
# extracted from Ubuntu Security Notice USN-4410-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS : Net-SNMP vulnerability (USN-4410-1)");
...
USN-4410-1 advisory.
    ...
    A double-free bug was discovered in snmpd server. An authenticated user could potentially cause a DoS by
    sending a crafted request to the server. (CVE-2019-20892)

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4410-1");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'libsnmp-base', 'pkgver': '5.8+dfsg-2ubuntu2.1'},
    {'osver': '20.04', 'pkgname': 'libsnmp-dev', 'pkgver': '5.8+dfsg-2ubuntu2.1'},
    {'osver': '20.04', 'pkgname': 'libsnmp-perl', 'pkgver': '5.8+dfsg-2ubuntu2.1'},
    {'osver': '20.04', 'pkgname': 'libsnmp35', 'pkgver': '5.8+dfsg-2ubuntu2.1'},
    {'osver': '20.04', 'pkgname': 'snmp', 'pkgver': '5.8+dfsg-2ubuntu2.1'},
    {'osver': '20.04', 'pkgname': 'snmpd', 'pkgver': '5.8+dfsg-2ubuntu2.1'},
    {'osver': '20.04', 'pkgname': 'snmptrapd', 'pkgver': '5.8+dfsg-2ubuntu2.1'},
    {'osver': '20.04', 'pkgname': 'tkmib', 'pkgver': '5.8+dfsg-2ubuntu2.1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libsnmp-base / libsnmp-dev / libsnmp-perl / libsnmp35 / snmp / etc');
}
