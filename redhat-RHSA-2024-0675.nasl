...
# extracted from Red Hat Security Advisory RHSA-2024:0675. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:0675");

  script_name(english:"RHEL 9 : gimp (RHSA-2024:0675)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for gimp.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:0675 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0675.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fa02754b");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0675");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL gimp package based on the guidance in RHSA-2024:0675.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gimp-2.99.8-4.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'gimp-libs-2.99.8-4.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
    ]
  }
];
