...
if (description)
{
  ...
  script_cve_id("CVE-2021-36194");

  script_name(english:"Fortinet FortiWeb Stack-based buffer overflows in API controllers (FG-IR-21-152)");
...
vulnerability as referenced in the FG-IR-21-152 advisory.

  - Multiple stack-based buffer overflows in the API controllers of FortiWeb 6.4.1, 6.4.0, and 6.3.0 through
    6.3.15 may allow an authenticated attacker to achieve arbitrary code execution via specially crafted
    requests. (CVE-2021-36194)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.fortiguard.com/psirt/FG-IR-21-152");
...
"Please upgrade to FortiWeb version 6.3.16/6.4.2/7.0.0 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-36194");
