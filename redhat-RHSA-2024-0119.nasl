...
# extracted from Red Hat Security Advisory RHSA-2024:0119. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0119.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?df988566");
...
"Update the RHEL libxml2 package based on the guidance in RHSA-2024:0119.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libxml2-2.9.7-18.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libxml2-devel-2.9.7-18.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-libxml2-2.9.7-18.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
