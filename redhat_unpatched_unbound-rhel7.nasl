...
# extracted from Red Hat Security Advisory unbound. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2017-15105", "CVE-2019-18934");

  script_name(english:"RHEL 7 : unbound (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  # https://security.access.redhat.com/data/csaf/v2/vex/2024/cve-2024-8508.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c74d6352");
