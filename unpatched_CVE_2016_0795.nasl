...
if (description)
{
  ...
  script_cve_id("CVE-2016-0795");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2016-0795");
...
patch available.
  ...
  - LibreOffice before 5.0.5 allows remote attackers to cause a denial of service (memory corruption) or
    possibly have unspecified other impact via a crafted LwpTocSuperLayout record in a LotusWordPro (lwp)
    document. (CVE-2016-0795)
