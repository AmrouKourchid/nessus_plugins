...
# extracted from Fedora Security Advisory FEDORA-2024-e88cc97dba
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-e88cc97dba");

  script_name(english:"Fedora 40 : NetworkManager-libreswan (2024-e88cc97dba)");
...
FEDORA-2024-e88cc97dba advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-e88cc97dba");
...
var pkgs = [
    {'reference':'NetworkManager-libreswan-1.2.24-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
