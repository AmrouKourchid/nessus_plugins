...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : ntp (EulerOS-SA-2019-2215)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2215
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cf420a6d");
