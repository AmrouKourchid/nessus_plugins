...
# extracted from Ubuntu Security Notice USN-4973-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"4973-1");

  script_name(english:"Ubuntu 20.04 LTS : Python vulnerability (USN-4973-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4973-1");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'idle-python3.8', 'pkgver': '3.8.5-1~20.04.3'},
    {'osver': '20.04', 'pkgname': 'libpython3.8', 'pkgver': '3.8.5-1~20.04.3'},
    {'osver': '20.04', 'pkgname': 'libpython3.8-dev', 'pkgver': '3.8.5-1~20.04.3'},
    {'osver': '20.04', 'pkgname': 'libpython3.8-minimal', 'pkgver': '3.8.5-1~20.04.3'},
    {'osver': '20.04', 'pkgname': 'libpython3.8-stdlib', 'pkgver': '3.8.5-1~20.04.3'},
    {'osver': '20.04', 'pkgname': 'libpython3.8-testsuite', 'pkgver': '3.8.5-1~20.04.3'},
    {'osver': '20.04', 'pkgname': 'python3.8', 'pkgver': '3.8.5-1~20.04.3'},
    {'osver': '20.04', 'pkgname': 'python3.8-dev', 'pkgver': '3.8.5-1~20.04.3'},
    {'osver': '20.04', 'pkgname': 'python3.8-examples', 'pkgver': '3.8.5-1~20.04.3'},
    {'osver': '20.04', 'pkgname': 'python3.8-minimal', 'pkgver': '3.8.5-1~20.04.3'},
    {'osver': '20.04', 'pkgname': 'python3.8-venv', 'pkgver': '3.8.5-1~20.04.3'}
];
