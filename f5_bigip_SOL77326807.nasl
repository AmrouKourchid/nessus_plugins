...
# extracted from F5 Networks BIG-IP Solution K77326807.
#
# @NOAGENT@
##
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : BIND vulnerability (K77326807)");

  script_set_attribute(attribute:"synopsis", value:
"The remote device is missing a vendor-supplied security patch.");
  script_set_attribute(attribute:"description", value:
"The version of F5 Networks BIG-IP installed on the remote host is prior to 13.1.5 / 14.1.5 / 15.1.6 / 16.1.3 / 17.0.0.
It is, therefore, affected by a vulnerability as referenced in the K77326807 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K77326807");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K77326807.");
...
var vmatrix = {
  'AFM': {
    ...
    'unaffected': [
      '17.0.0','16.1.3','15.1.6','14.1.5','13.1.5'
    ],
  },
  'APM': {
    'affected': [
