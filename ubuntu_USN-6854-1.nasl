...
# extracted from Ubuntu Security Notice USN-6854-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6854-1");

  script_name(english:"Ubuntu 22.04 LTS : OpenSSL vulnerability (USN-6854-1)");
...
USN-6854-1 advisory.
    ...
    shared-secrets in the Diffie-Hellman Key Agreement Protocol. A remote attacker could possibly use this
    issue to cause OpenSSL to consume resources, resulting in a denial of service.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6854-1");
...
var pkgs = [
    {'osver': '22.04', 'pkgname': 'libssl-dev', 'pkgver': '3.0.2-0ubuntu1.16'},
    {'osver': '22.04', 'pkgname': 'libssl3', 'pkgver': '3.0.2-0ubuntu1.16'},
    {'osver': '22.04', 'pkgname': 'openssl', 'pkgver': '3.0.2-0ubuntu1.16'}
];
