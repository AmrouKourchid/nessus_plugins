...
# extracted from Fedora Security Advisory FEDORA-2025-66ce799182
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-66ce799182");

  script_name(english:"Fedora 41 : mariadb10.11 (2025-66ce799182)");
...
FEDORA-2025-66ce799182 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-66ce799182");
  script_set_attribute(attribute:"solution", value:
"Update the affected 3:mariadb10.11 package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-52971");
...
var pkgs = [
    {'reference':'mariadb10.11-10.11.11-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'mariadb10.11');
}
