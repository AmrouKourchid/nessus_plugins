...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : openssh (EulerOS-SA-2024-1321)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1321
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?662a5888");
