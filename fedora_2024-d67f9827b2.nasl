...
# extracted from Fedora Security Advisory FEDORA-2024-d67f9827b2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-d67f9827b2");

  script_name(english:"Fedora 38 : nextcloud (2024-d67f9827b2)");
...
FEDORA-2024-d67f9827b2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-d67f9827b2");
...
"Update the affected nextcloud package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-22403");
...
var pkgs = [
    {'reference':'nextcloud-28.0.4-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
