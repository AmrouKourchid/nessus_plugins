...
if (description)
{
  ...
  script_name(english:"Atlassian Jira < 8.13.18 / 8.14.0 < 8.20.6 / 8.21.0 (JRASERVER-73171)");
...
vulnerability as referenced in the JRASERVER-73171 advisory.

  - Request smuggling via a vulnerable version of Apache Tomcat - CVE-2021-33037 (CVE-2021-33037)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://jira.atlassian.com/browse/JRASERVER-73171");
