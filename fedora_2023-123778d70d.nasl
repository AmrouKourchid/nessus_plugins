...
# extracted from Fedora Security Advisory FEDORA-2023-123778d70d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-123778d70d");

  script_name(english:"Fedora 37 : tar (2023-123778d70d)");
...
FEDORA-2023-123778d70d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-123778d70d");
  script_set_attribute(attribute:"solution", value:
"Update the affected 2:tar package.");
...
var pkgs = [
    {'reference':'tar-1.34-6.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
