...
if (description)
{
  ...
  script_xref(name:"CISCO-BUG-ID", value:"CSCwe77122");
  script_xref(name:"CISCO-BUG-ID", value:"CSCwe77480");
  script_xref(name:"CISCO-BUG-ID", value:"CSCwf09318");
  script_xref(name:"CISCO-SA", value:"cisco-sa-pi-epnm-BFjSRJP5");
  script_xref(name:"IAVA", value:"2023-A-0430-S");

  script_name(english:"Cisco Prime Infrastructure XSS (cisco-sa-pi-epnm-BFjSRJP5)");
...
by a cross-site scripting (XSS) vulnerability. Due to insufficient validation of user input, an authenticated, remote
attacker can, by persuading a user of the affected interface to view a specially crafted page, execute malicious HTML
or script content in the context of the user.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bst.cloudapps.cisco.com/bugsearch/bug/CSCwe77122");
  script_set_attribute(attribute:"see_also", value:"https://bst.cloudapps.cisco.com/bugsearch/bug/CSCwe77480");
  script_set_attribute(attribute:"see_also", value:"https://bst.cloudapps.cisco.com/bugsearch/bug/CSCwf09318");
  script_set_attribute(attribute:"solution", value:
"Upgrade to the relevant fixed version referenced in Cisco bug IDs CSCwe77122, CSCwe77480 and CSCwf09318");
