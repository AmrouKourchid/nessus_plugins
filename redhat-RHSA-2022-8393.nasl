...
# extracted from Red Hat Security Advisory RHSA-2022:8393. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:8393");

  script_name(english:"RHEL 9 : logrotate (RHSA-2022:8393)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for logrotate.");
...
the RHSA-2022:8393 advisory.

    The logrotate utility simplifies the administration of multiple log files by allowing their automatic
    rotation, compression, removal, and mailing.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8393.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0605a9c1");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/9/html/9.1_release_notes/index
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1f1eb6cc");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8393");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2075074");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL logrotate package based on the guidance in RHSA-2022:8393.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'logrotate-3.18.0-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
