...
# extracted from Fedora Security Advisory FEDORA-2023-21d2191c73
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-21d2191c73");

  script_name(english:"Fedora 38 : PyDrive2 (2023-21d2191c73)");
...
FEDORA-2023-21d2191c73 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-21d2191c73");
  script_set_attribute(attribute:"solution", value:
"Update the affected PyDrive2 package.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:N/UI:R/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-49297");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:PyDrive2");
...
var pkgs = [
    {'reference':'PyDrive2-1.18.0-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'PyDrive2');
}
