...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2015-1459.html");
...
var pkgs = [
    ...
    {'reference':'ntp-doc-4.2.6p5-5.el6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'ntp-doc-4.2.6p5-5.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
