...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : cups (EulerOS-SA-2020-2241)");
...
vulnerability :
  ...
  - heap based buffer overflow in libcups's ppdFindOption()
    in ppd-mark.c(CVE-2020-3898)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2241
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7aed2ca2");
...
pkgs = ["cups-1.6.3-35.h6.eulerosv2r7",
        "cups-client-1.6.3-35.h6.eulerosv2r7",
        "cups-devel-1.6.3-35.h6.eulerosv2r7",
        "cups-filesystem-1.6.3-35.h6.eulerosv2r7",
        "cups-libs-1.6.3-35.h6.eulerosv2r7",
        "cups-lpd-1.6.3-35.h6.eulerosv2r7"];
