...
# extracted from Debian Security Advisory dla-4046. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-4046 : ark - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has a package installed that is affected by a vulnerability as referenced in the dla-4046
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-57966");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bullseye/ark");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'ark', 'reference': '4:20.12.2-1+deb11u1'}
];
