...
if (description)
{
  ...
  script_name(english:"Apache Tomcat 8.0.0.RC1 < 8.0.36");

  script_set_attribute(attribute:"synopsis", value:
"The remote Apache Tomcat server is affected by a vulnerability");
  script_set_attribute(attribute:"description", value:
"The version of Tomcat installed on the remote host is prior to 8.0.36. It is, therefore, affected by a vulnerability as
referenced in the fixed_in_apache_tomcat_8.5.3_and_8.0.36_security-8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://svn.apache.org/viewvc?view=rev&rev=1743722");
  script_set_attribute(attribute:"see_also", value:"https://svn.apache.org/viewvc?view=rev&rev=1743738");
  # https://tomcat.apache.org/security-8.html#Fixed_in_Apache_Tomcat_8.5.3_and_8.0.36
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?902a830c");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Apache Tomcat version 8.0.36 or later.");
...
var constraints = [
  { 'min_version' : '8.0.0.RC1', 'max_version' : '8.0.35', 'fixed_version' : '8.0.36' }
];
