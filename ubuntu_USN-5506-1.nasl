...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS / 22.04 LTS : NSS vulnerabilities (USN-5506-1)");
...
vulnerabilities as referenced in the USN-5506-1 advisory.
    ...
    possibly use this issue to cause NSS to crash, resulting in a denial of service. This issue only affected
    Ubuntu 18.04 LTS, Ubuntu 20.04 LTS, and Ubuntu 21.10. (CVE-2022-22747)
