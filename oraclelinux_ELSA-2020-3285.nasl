...
# extracted from Red Hat Security Advisory RHSA-2020:3285 and 
# Oracle Linux Security Advisory ELSA-2020-3285 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : postgresql-jdbc (ELSA-2020-3285)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 7 host has packages installed that are affected by a vulnerability as referenced in the
ELSA-2020-3285 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2020-3285.html");
...
var pkgs = [
    {'reference':'postgresql-jdbc-9.2.1002-8.el7_8', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'postgresql-jdbc-javadoc-9.2.1002-8.el7_8', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
];
