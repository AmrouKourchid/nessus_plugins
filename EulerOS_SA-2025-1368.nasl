...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : openssh (EulerOS-SA-2025-1368)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1368
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ac773ba1");
...
var pkgs = [
  "openssh-8.8p1-2.h36.eulerosv2r11",
  "openssh-clients-8.8p1-2.h36.eulerosv2r11",
  "openssh-server-8.8p1-2.h36.eulerosv2r11"
];
