...
if (description)
{
  ...
  script_name(english:"SUSE Enterprise Linux SEoL (9.3.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of SUSE Enterprise Linux is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, SUSE Enterprise Linux is 9.3.x. It is, therefore, no longer maintained by its vendor or
provider.
...
"Upgrade to a version of SUSE Enterprise Linux that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2008/02/29");
...
var constraints = [
  { max_branch : '9.3', min_branch : '9.3', seol : 20080229, eseol : 20110301 }
];
