...
# extracted from Fedora Security Advisory FEDORA-2024-9be1b94714
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-9be1b94714");

  script_name(english:"Fedora 39 : glibc (2024-9be1b94714)");
...
FEDORA-2024-9be1b94714 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-9be1b94714");
...
var pkgs = [
    {'reference':'glibc-2.38-18.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
