...
# extracted from Red Hat Security Advisory RHSA-2018:2001. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:2001");

  script_name(english:"RHEL 7 : qemu-kvm (RHSA-2018:2001)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for qemu-kvm.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2018:2001 advisory.
    ...
    * An industry-wide issue was found in the way many modern microprocessor designs have implemented
    ...
    Note: This is the qemu-kvm side of the CVE-2018-3639 mitigation that includes support for guests running
    on hosts with AMD processors.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_2001.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4557ece4");
...
"Update the RHEL qemu-kvm package based on the guidance in RHSA-2018:2001.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'qemu-img-1.5.3-156.el7_5.3', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10'},
      {'reference':'qemu-kvm-1.5.3-156.el7_5.3', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10'},
      {'reference':'qemu-kvm-common-1.5.3-156.el7_5.3', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10'},
      {'reference':'qemu-kvm-tools-1.5.3-156.el7_5.3', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10'}
    ]
  }
];
