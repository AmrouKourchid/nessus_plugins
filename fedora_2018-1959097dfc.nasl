...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-1959097dfc");
  script_set_attribute(attribute:"solution", value:
"Update the affected 7:texlive-base and / or 8:texlive packages.");
