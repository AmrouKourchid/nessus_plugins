...
# extracted from Red Hat Security Advisory RHSA-2024:0670. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:0670");
  script_xref(name:"IAVA", value:"2024-A-0071");

  script_name(english:"RHEL 9 : runc (RHSA-2024:0670)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b7bb2ef3");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0670");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL runc package based on the guidance in RHSA-2024:0670.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'runc-1.1.12-1.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'}
    ]
  }
];
