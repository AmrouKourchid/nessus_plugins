...
# extracted from Fedora Security Advisory FEDORA-2023-ce8943223c
#
...
if (description)
{
  ...
  script_cve_id("CVE-2020-7677", "CVE-2021-43138", "CVE-2022-3517");
  script_xref(name:"FEDORA", value:"2023-ce8943223c");

  script_name(english:"Fedora 37 : yarnpkg (2023-ce8943223c)");
...
FEDORA-2023-ce8943223c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-ce8943223c");
...
"Update the affected yarnpkg package.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2020-7677");
...
var pkgs = [
    {'reference':'yarnpkg-1.22.19-3.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
