...
if (description)
{
  ...
  script_name(english:"Java JRE Enabled (Internet Explorer)");
...
"Java JRE is enabled in Internet Explorer. Internet Explorer is no longer supported by Microsoft.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/2751647/how-to-disable-the-java-web-plug-in-in-internet-explorer");
