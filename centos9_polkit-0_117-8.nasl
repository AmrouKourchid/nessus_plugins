...
if (description)
{
  ...
  script_name(english:"CentOS 9 : polkit-0.117-8.el9");
...
polkit-0.117-8.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=16593");
...
var pkgs = [
    {'reference':'polkit-0.117-8.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'polkit-devel-0.117-8.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'polkit-docs-0.117-8.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'polkit-libs-0.117-8.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
