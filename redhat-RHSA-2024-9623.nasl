...
# extracted from Red Hat Security Advisory RHSA-2024:9623. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:9623");

  script_name(english:"RHEL 9 : OpenShift Container Platform 4.14.41 (RHSA-2024:9623)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for OpenShift Container Platform 4.14.41.");
...
referenced in the RHSA-2024:9623 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.14.41. See the
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_9623.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?07566bae");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:9623");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.14.41 packages based on the guidance in RHSA-2024:9623.");
