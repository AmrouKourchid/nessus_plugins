...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : curl (EulerOS-SA-2020-1842)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1842
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?361fef7e");
...
pkgs = ["curl-7.61.1-2.h10.eulerosv2r8",
        ...
        "libcurl-devel-7.61.1-2.h10.eulerosv2r8"];
