...
referenced in the USN-4945-1 advisory.
    ...
    It was discovered that the USB/IP driver in the Linux kernel contained race conditions during the update
    of local and shared status. An attacker could use this to cause a denial of service (system crash).
    (CVE-2021-29265)
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-4945-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2020-25639', 'CVE-2021-28038', 'CVE-2021-28375', 'CVE-2021-28660', 'CVE-2021-29265', 'CVE-2021-29650', 'CVE-2021-30002');
