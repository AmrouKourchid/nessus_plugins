...
# extracted from Ubuntu Security Notice USN-5894-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5894-1");
  script_xref(name:"IAVA", value:"2023-A-0008-S");
  script_xref(name:"IAVA", value:"2021-A-0352-S");

  script_name(english:"Ubuntu 16.04 ESM : curl vulnerabilities (USN-5894-1)");
...
the USN-5894-1 advisory.
    ...
    sent to the remote server, contrary to expectations. This issue was only fixed in Ubuntu 14.04 ESM.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5894-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'curl', 'pkgver': '7.47.0-1ubuntu2.19+esm7', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libcurl3', 'pkgver': '7.47.0-1ubuntu2.19+esm7', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libcurl3-gnutls', 'pkgver': '7.47.0-1ubuntu2.19+esm7', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libcurl3-nss', 'pkgver': '7.47.0-1ubuntu2.19+esm7', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libcurl4-gnutls-dev', 'pkgver': '7.47.0-1ubuntu2.19+esm7', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libcurl4-nss-dev', 'pkgver': '7.47.0-1ubuntu2.19+esm7', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libcurl4-openssl-dev', 'pkgver': '7.47.0-1ubuntu2.19+esm7', 'ubuntu_pro': TRUE}
];
