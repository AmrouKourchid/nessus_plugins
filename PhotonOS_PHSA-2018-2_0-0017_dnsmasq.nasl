...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Dnsmasq PHSA-2018-2.0-0017");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'dnsmasq-2.76-5.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'dnsmasq-debuginfo-2.76-5.ph2')) flag++;
