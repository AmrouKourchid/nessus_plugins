...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.2.0 : net-snmp (EulerOS-SA-2021-1040)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1040
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?807870e9");
...
pkgs = ["net-snmp-5.7.2-33.2.h6",
        "net-snmp-agent-libs-5.7.2-33.2.h6",
        "net-snmp-libs-5.7.2-33.2.h6",
        "net-snmp-utils-5.7.2-33.2.h6"];
