...
if (description)
{
  ...
  script_name(english:"Debian dla-3395 : golang-1.11 - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3395
advisory.

    - -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3395-2                debian-lts@lists.debian.org
    https://www.debian.org/lts/security/                      Sylvain Beucler
    April 20, 2023                                https://wiki.debian.org/LTS
    - -------------------------------------------------------------------------

    Package        : golang-1.11
    Version        : 1.11.6-1+deb10u7

    The previous golang-1.11 update released as DLA-3395-1 failed to build
    ...
    has otherwise no impact on the published golang-1.11 package.
...
var pkgs = [
    {'release': '10.0', 'prefix': 'golang-1.11', 'reference': '1.11.6-1+deb10u7'},
    {'release': '10.0', 'prefix': 'golang-1.11-doc', 'reference': '1.11.6-1+deb10u7'},
    {'release': '10.0', 'prefix': 'golang-1.11-go', 'reference': '1.11.6-1+deb10u7'},
    {'release': '10.0', 'prefix': 'golang-1.11-src', 'reference': '1.11.6-1+deb10u7'}
];
