...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP1 : ruby (EulerOS-SA-2018-1143)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1143
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?abc54c68");
...
pkgs = ["ruby-2.0.0.648-33.h4",
        "ruby-irb-2.0.0.648-33.h4",
        "ruby-libs-2.0.0.648-33.h4"];
