...
if (description)
{
  ...
  script_cve_id("CVE-2024-29162");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-29162");
...
patch available.
  ...
  - HDF5 through 1.13.3 and/or 1.14.2 contains a stack buffer overflow in H5HG_read, resulting in denial of
    service or potential code execution. (CVE-2024-29162)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-29162");
