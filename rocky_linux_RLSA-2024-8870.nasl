...
# Rocky Linux Security Advisory RLSA-2024:8870.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2024:8870");

  script_name(english:"RockyLinux 8 : kernel-rt (RLSA-2024:8870)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2024:8870");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for RLSA-2024:8870');
  }
  else
  {
...
var pkgs = [
    ...
    {'reference':'kernel-rt-debug-debuginfo-4.18.0-553.27.1.rt7.368.el8_10', 'cpu':'x86_64', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    ...
    {'reference':'kernel-rt-debug-kvm-4.18.0-553.27.1.rt7.368.el8_10', 'cpu':'x86_64', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    ...
    {'reference':'kernel-rt-debuginfo-4.18.0-553.27.1.rt7.368.el8_10', 'cpu':'x86_64', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'kernel-rt-debuginfo-common-x86_64-4.18.0-553.27.1.rt7.368.el8_10', 'cpu':'x86_64', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    ...
    {'reference':'kernel-rt-kvm-4.18.0-553.27.1.rt7.368.el8_10', 'cpu':'x86_64', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
