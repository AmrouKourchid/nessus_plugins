...
if (description)
{
  ...
  script_name(english:"Flickr Gallery Plugin for WordPress < 1.5.3 PHP Object Injection");
...
"According to its self-reported version, the Flickr Gallery Plugin
for WordPress running on the remote web server is prior to 1.5.3.
...
only on the application's self-reported version number.");
  # https://www.pluginvulnerabilities.com/2017/10/02/vulnerability-details-php-object-injection-vulnerability-in-flickr-gallery/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cf64da33");
  script_set_attribute(attribute:"see_also", value:"https://wordpress.org/plugins/flickr-gallery/");
  script_set_attribute(attribute:"solution", value:
"Upgrade the Flickr Gallery Plugin for WordPress to version 1.5.3
  or later.");
...
plugin_url = install_url + "wp-content/plugins/flickr-gallery/";
...
if (!installed)
{
  ...
  regexes[0] = make_list("flickr-gallery");
  checks["/wp-content/plugins/flickr-gallery/flightbox/jquery.flightbox.js"] = regexes;
...
res = http_send_recv3(
  method : "GET",
  port   : port,
  item   : dir + "/wp-content/plugins/flickr-gallery/readme.txt",
  exit_on_fail : TRUE
);

body = res[2];

if ("=== Flickr" >< body && "Gallery ===" >< body)
{
  # Grab version
