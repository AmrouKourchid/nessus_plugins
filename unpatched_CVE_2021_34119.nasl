...
if (description)
{
  ...
  script_cve_id("CVE-2021-34119");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2021-34119");
...
patch available.
  ...
  - A flaw was discovered in htmodoc 1.9.12 in function parse_paragraph in ps-pdf.cxx ,this flaw possibly
    allows possible code execution and a denial of service via a crafted file. (CVE-2021-34119)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-34119");
