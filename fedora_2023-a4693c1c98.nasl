...
# extracted from Fedora Security Advisory FEDORA-2023-a4693c1c98
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-a4693c1c98");

  script_name(english:"Fedora 39 : webkitgtk (2023-a4693c1c98)");
...
FEDORA-2023-a4693c1c98 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-a4693c1c98");
...
var pkgs = [
    {'reference':'webkitgtk-2.42.1-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
