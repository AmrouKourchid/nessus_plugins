...
# extracted from Fedora Security Advisory FEDORA-2018-2575edf8d3.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : nss (2018-2575edf8d3)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-2575edf8d3");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"nss-3.40.1-1.0.fc28")) flag++;
