...
if (description)
{
  ...
  script_name(english:"RHEL 4 : mozilla (RHSA-2005:435)");
...
referenced in the RHSA-2005:435 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?247b6b8d");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2005/rhsa-2005_435.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?67e47580");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=157349");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=158533");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2005:435");
...
"Update the RHEL mozilla package based on the guidance in RHSA-2005:435.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2005-1532");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2005-1477");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'devhelp-0.9.2-2.4.5', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'devhelp-0.9.2-2.4.5', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'devhelp-0.9.2-2.4.5', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'devhelp-devel-0.9.2-2.4.5', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'devhelp-devel-0.9.2-2.4.5', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'devhelp-devel-0.9.2-2.4.5', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
