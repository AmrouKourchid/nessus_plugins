...
# extracted from Fedora Security Advisory FEDORA-2022-1dd9dc5140
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-1dd9dc5140");

  script_name(english:"Fedora 37 : mbedtls (2022-1dd9dc5140)");
...
FEDORA-2022-1dd9dc5140 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-1dd9dc5140");
...
"Update the affected mbedtls package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-45451");
...
var pkgs = [
    {'reference':'mbedtls-2.28.1-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
