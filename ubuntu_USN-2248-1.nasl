...
# extracted from Ubuntu Security Notice USN-2248-1. The text 
...
if (description)
{
  ...
  script_bugtraq_id(68094);
  script_xref(name:"USN", value:"2248-1");

  script_name(english:"Ubuntu 14.04 LTS : OpenStack Cinder vulnerability (USN-2248-1)");
...
USN-2248-1 advisory.
    ...
    Darragh O'Reilly discovered that the Ubuntu packaging for OpenStack Cinder did not properly set up its
    sudo configuration. If a different flaw was found in OpenStack Cinder, this vulnerability could be used to
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2248-1");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-1068");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'cinder-api', 'pkgver': '1:2014.1-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'cinder-backup', 'pkgver': '1:2014.1-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'cinder-common', 'pkgver': '1:2014.1-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'cinder-scheduler', 'pkgver': '1:2014.1-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'cinder-volume', 'pkgver': '1:2014.1-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'python-cinder', 'pkgver': '1:2014.1-0ubuntu1.1'}
];
