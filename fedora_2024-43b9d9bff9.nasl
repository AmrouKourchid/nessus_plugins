...
# extracted from Fedora Security Advisory FEDORA-2024-43b9d9bff9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-43b9d9bff9");

  script_name(english:"Fedora 38 : tkimg (2024-43b9d9bff9)");
...
FEDORA-2024-43b9d9bff9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-43b9d9bff9");
...
var pkgs = [
    {'reference':'tkimg-1.4.16-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
