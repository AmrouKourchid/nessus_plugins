...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : freetype (EulerOS-SA-2020-1148)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1148
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cbd71725");
...
pkgs = ["freetype-2.9.1-2.eulerosv2r8",
        "freetype-devel-2.9.1-2.eulerosv2r8"];
