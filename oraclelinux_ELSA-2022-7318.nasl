...
ELSA-2022-7318 advisory.
    ...
    - ptrace: Check PTRACE_O_SUSPEND_SECCOMP permission on PTRACE_SEIZE (Oleg Nesterov) [2127875 2121271]
    {CVE-2022-30594}
    - posix-cpu-timers: Cleanup CPU timers before freeing them during exec (Wander Lairson Costa) [2116967
    2116968] {CVE-2022-2585}
...
var pkgs = [
    ...
    {'reference':'kernel-abi-stablelists-5.14.0-70.30.1.0.1.el9_0', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-abi-stablelists-5.14.0'},
