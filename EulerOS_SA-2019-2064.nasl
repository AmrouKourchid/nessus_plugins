...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : graphviz (EulerOS-SA-2019-2064)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2064
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a7391561");
...
pkgs = ["graphviz-2.30.1-19.h2",
        "graphviz-tcl-2.30.1-19.h2"];
