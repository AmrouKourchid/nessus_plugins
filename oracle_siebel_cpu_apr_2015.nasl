...
if (description)
{
  ...
  script_cve_id("CVE-2015-0502");

  script_name(english:"Oracle Siebel CRM (April 2015 CPU)");
...
April 2015 CPU advisory.

  - Vulnerability in the Siebel UI Framework component of Oracle Siebel CRM (subcomponent: Portal Framework).
    Supported versions that are affected are 8.1 and 8.2. Difficult to exploit vulnerability allows successful
    unauthenticated network attacks via HTTP. Successful attack of this vulnerability can result in
    unauthorized update, insert or delete access to some Siebel UI Framework accessible data. (CVE-2015-0502)
...
"Apply the appropriate patch according to the April 2015 Oracle Critical Patch Update advisory.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-0502");
...
var constraints = [
  { 'min_version' : '8.1.1', 'fixed_version' : '8.1.1.14.5' },
  { 'min_version' : '8.2.2', 'fixed_version' : '8.2.2.14.5' }
];
