...
# extracted from Fedora Security Advisory FEDORA-2021-324479472c
#
...
if (description)
{
  ...
  script_name(english:"Fedora 33 : sudo (2021-324479472c)");
...
FEDORA-2021-324479472c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-324479472c");
...
pkgs = [
    {'reference':'sudo-1.9.5p1-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
