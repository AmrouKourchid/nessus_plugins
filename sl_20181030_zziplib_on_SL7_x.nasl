...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : zziplib on SL7.x x86_64 (20181030)");
...
"Security Fix(es) :
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?da2afbf8");
