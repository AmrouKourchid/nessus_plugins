...
# extracted from Fedora Security Advisory FEDORA-2025-e39bfb1baa
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-e39bfb1baa");
  script_xref(name:"IAVB", value:"2025-B-0002-S");

  script_name(english:"Fedora 41 : mingw-poppler (2025-e39bfb1baa)");
...
FEDORA-2025-e39bfb1baa advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-e39bfb1baa");
...
var pkgs = [
    {'reference':'mingw-poppler-24.02.0-4.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
