...
# extracted from Oracle Linux Security Advisory ELSA-2011-1533.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : ipa (ELSA-2011-1533)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2011-1533.html");
