...
if (description)
{
  ...
  script_cve_id("CVE-2025-1864");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2025-1864");
...
patch available.
  ...
  - Improper Restriction of Operations within the Bounds of a Memory Buffer vulnerability in radareorg radare2
    allows Overflow Buffers.This issue affects radare2: before <5.9.9. (CVE-2025-1864)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-1864");
