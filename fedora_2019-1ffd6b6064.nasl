...
# extracted from Fedora Security Advisory FEDORA-2019-1ffd6b6064.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-1ffd6b6064");

  script_name(english:"Fedora 30 : python3 (2019-1ffd6b6064)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"Security fix for CVE-2019-9740 and CVE-2019-9947. Fix a regression
introduced by the fix for CVE-2019-9636. Add manual page link for
python3.7m.
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-1ffd6b6064");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"python3-3.7.3-3.fc30")) flag++;
