...
# extracted from Fedora Security Advisory FEDORA-2023-985a025a03
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-985a025a03");

  script_name(english:"Fedora 39 : thunderbird (2023-985a025a03)");
...
FEDORA-2023-985a025a03 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-985a025a03");
...
var pkgs = [
    {'reference':'thunderbird-115.5.0-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
