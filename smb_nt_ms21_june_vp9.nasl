...
if (description)
{
  ...
  script_name(english:"Microsoft Windows VP9 Video Extensions Library RCE (June 2021)");
...
requires that a program process a specially crafted file.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?af8af611");
...
"Upgrade to app version 1.0.41182.0, or later via the Microsoft Store.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-31967");
