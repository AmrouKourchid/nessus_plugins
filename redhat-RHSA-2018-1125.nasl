...
# extracted from Red Hat Security Advisory RHSA-2018:1125. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:1125");

  script_name(english:"RHEL 6 : python-paramiko (RHSA-2018:1125)");
...
the RHSA-2018:1125 advisory.

  - python-paramiko: Authentication bypass in transport.py (CVE-2018-7750)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_1125.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b2b392f8");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:1125");
...
"Update the RHEL python-paramiko package based on the guidance in RHSA-2018:1125.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python-paramiko-1.7.5-4.el6_4', 'sp':'4', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'python-paramiko-1.7.5-4.el6_5', 'sp':'5', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'python-paramiko-1.7.5-4.el6_6', 'sp':'6', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'python-paramiko-1.7.5-4.el6_7', 'sp':'7', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
