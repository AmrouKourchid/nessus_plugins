...
referenced in the RHSA-2021:4251 advisory.
    ...
    * openjpeg: heap-based buffer overflow in functions opj_pi_next_rlcp, opj_pi_next_rpcl and
    opj_pi_next_lrcp in openjp2/pi.c (CVE-2020-27845)
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_4251.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8c86e540");
...
"Update the RHEL openjpeg2 package based on the guidance in RHSA-2021:4251.");
  ...
  script_cwe_id(20, 122, 125, 190, 369, 416, 787);
