...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.2 : kernel (EulerOS-SA-2018-1382)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1382
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f8e33fb0");
...
pkgs = ["kernel-3.10.0-514.44.5.10_106",
        "kernel-devel-3.10.0-514.44.5.10_106",
        "kernel-headers-3.10.0-514.44.5.10_106",
        "kernel-tools-3.10.0-514.44.5.10_106",
        "kernel-tools-libs-3.10.0-514.44.5.10_106",
        "kernel-tools-libs-devel-3.10.0-514.44.5.10_106"];
