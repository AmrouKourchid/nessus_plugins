...
# extracted from VMware Security Advisory PHSA-2019-2.0-0166. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Systemd PHSA-2019-2.0-0166");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the systemd package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-2-166.md");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'systemd-233-20.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'systemd-debuginfo-233-20.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'systemd-devel-233-20.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'systemd-lang-233-20.ph2')) flag++;
