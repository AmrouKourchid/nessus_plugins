...
# extracted from Ubuntu Security Notice USN-2413-1. The text 
...
if (description)
{
  ...
  script_bugtraq_id(71288);
  script_xref(name:"USN", value:"2413-1");

  script_name(english:"Ubuntu 14.04 LTS : AppArmor vulnerability (USN-2413-1)");
...
USN-2413-1 advisory.
    ...
    An AppArmor policy miscompilation flaw was discovered in apparmor_parser. Under certain circumstances, a
    malicious application could use this flaw to perform operations that are not allowed by AppArmor policy.
    The flaw may also prevent applications from accessing resources that are allowed by AppArmor policy.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2413-1");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-1424");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'apparmor', 'pkgver': '2.8.95~2430-0ubuntu5.1'},
    {'osver': '14.04', 'pkgname': 'apparmor-easyprof', 'pkgver': '2.8.95~2430-0ubuntu5.1'},
    {'osver': '14.04', 'pkgname': 'apparmor-notify', 'pkgver': '2.8.95~2430-0ubuntu5.1'},
    {'osver': '14.04', 'pkgname': 'apparmor-profiles', 'pkgver': '2.8.95~2430-0ubuntu5.1'},
    {'osver': '14.04', 'pkgname': 'apparmor-utils', 'pkgver': '2.8.95~2430-0ubuntu5.1'},
    {'osver': '14.04', 'pkgname': 'dh-apparmor', 'pkgver': '2.8.95~2430-0ubuntu5.1'},
    {'osver': '14.04', 'pkgname': 'libapache2-mod-apparmor', 'pkgver': '2.8.95~2430-0ubuntu5.1'},
    {'osver': '14.04', 'pkgname': 'libapparmor-dev', 'pkgver': '2.8.95~2430-0ubuntu5.1'},
    {'osver': '14.04', 'pkgname': 'libapparmor-perl', 'pkgver': '2.8.95~2430-0ubuntu5.1'},
    {'osver': '14.04', 'pkgname': 'libapparmor1', 'pkgver': '2.8.95~2430-0ubuntu5.1'},
    {'osver': '14.04', 'pkgname': 'libpam-apparmor', 'pkgver': '2.8.95~2430-0ubuntu5.1'},
    {'osver': '14.04', 'pkgname': 'python-apparmor', 'pkgver': '2.8.95~2430-0ubuntu5.1'},
    {'osver': '14.04', 'pkgname': 'python-libapparmor', 'pkgver': '2.8.95~2430-0ubuntu5.1'},
    {'osver': '14.04', 'pkgname': 'python3-apparmor', 'pkgver': '2.8.95~2430-0ubuntu5.1'},
    {'osver': '14.04', 'pkgname': 'python3-libapparmor', 'pkgver': '2.8.95~2430-0ubuntu5.1'}
];
