...
# extracted from Fedora Security Advisory FEDORA-2023-a5a5542890
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-a5a5542890");

  script_name(english:"Fedora 37 : podman-tui (2023-a5a5542890)");
...
FEDORA-2023-a5a5542890 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-a5a5542890");
...
var pkgs = [
    {'reference':'podman-tui-0.12.0-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
