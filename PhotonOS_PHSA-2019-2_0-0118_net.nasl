...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'net-snmp-5.7.3-10.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'net-snmp-debuginfo-5.7.3-10.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'net-snmp-devel-5.7.3-10.ph2')) flag++;
