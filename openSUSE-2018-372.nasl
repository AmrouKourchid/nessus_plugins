...
# extracted from openSUSE Security Update openSUSE-2018-372.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : python3 (openSUSE-2018-372)");
...
if ( rpm_check(release:"SUSE42.3", reference:"libpython3_4m1_0-3.4.6-12.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libpython3_4m1_0-debuginfo-3.4.6-12.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"python3-3.4.6-12.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"python3-base-3.4.6-12.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"python3-base-debuginfo-3.4.6-12.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"python3-base-debugsource-3.4.6-12.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"python3-curses-3.4.6-12.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"python3-curses-debuginfo-3.4.6-12.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"python3-dbm-3.4.6-12.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"python3-dbm-debuginfo-3.4.6-12.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"python3-debuginfo-3.4.6-12.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"python3-debugsource-3.4.6-12.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"python3-devel-3.4.6-12.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"python3-devel-debuginfo-3.4.6-12.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"python3-doc-pdf-3.4.6-12.3.2") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"python3-idle-3.4.6-12.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"python3-testsuite-3.4.6-12.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"python3-testsuite-debuginfo-3.4.6-12.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"python3-tk-3.4.6-12.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"python3-tk-debuginfo-3.4.6-12.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"python3-tools-3.4.6-12.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", cpu:"x86_64", reference:"libpython3_4m1_0-32bit-3.4.6-12.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", cpu:"x86_64", reference:"libpython3_4m1_0-debuginfo-32bit-3.4.6-12.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", cpu:"x86_64", reference:"python3-32bit-3.4.6-12.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", cpu:"x86_64", reference:"python3-base-32bit-3.4.6-12.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", cpu:"x86_64", reference:"python3-base-debuginfo-32bit-3.4.6-12.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", cpu:"x86_64", reference:"python3-debuginfo-32bit-3.4.6-12.3.1") ) flag++;
