...
# extracted from Red Hat Security Advisory RHSA-2021:1024. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_1024.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0b54d837");
...
"Update the RHEL openssl package based on the guidance in RHSA-2021:1024.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openssl-1.1.1g-15.el8_3', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'openssl-devel-1.1.1g-15.el8_3', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'openssl-libs-1.1.1g-15.el8_3', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'openssl-perl-1.1.1g-15.el8_3', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
