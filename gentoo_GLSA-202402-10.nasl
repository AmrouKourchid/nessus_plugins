...
# extracted from Gentoo Linux Security Advisory GLSA 202402-10.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202402-10 : NBD Tools: Multiple Vulnerabilities");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202402-10");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=834678");
...
var packages = [
  {
    'name' : 'sys-block/nbd',
    'unaffected' : make_list("ge 3.24"),
    'vulnerable' : make_list("lt 3.24")
  }
];
