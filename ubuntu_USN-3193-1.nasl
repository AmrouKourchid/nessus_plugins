...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS : Nettle vulnerability (USN-3193-1)");
...
in the USN-3193-1 advisory.

    It was discovered that Nettle incorrectly mitigated certain timing side-channel attacks. A remote attacker
    could possibly use this flaw to recover private keys.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3193-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'libhogweed2', 'pkgver': '2.7.1-1ubuntu0.2'},
    {'osver': '14.04', 'pkgname': 'libnettle4', 'pkgver': '2.7.1-1ubuntu0.2'},
    {'osver': '14.04', 'pkgname': 'nettle-bin', 'pkgver': '2.7.1-1ubuntu0.2'},
    {'osver': '14.04', 'pkgname': 'nettle-dev', 'pkgver': '2.7.1-1ubuntu0.2'},
    {'osver': '16.04', 'pkgname': 'libhogweed4', 'pkgver': '3.2-1ubuntu0.16.04.1'},
    {'osver': '16.04', 'pkgname': 'libnettle6', 'pkgver': '3.2-1ubuntu0.16.04.1'},
    {'osver': '16.04', 'pkgname': 'nettle-bin', 'pkgver': '3.2-1ubuntu0.16.04.1'},
    {'osver': '16.04', 'pkgname': 'nettle-dev', 'pkgver': '3.2-1ubuntu0.16.04.1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libhogweed2 / libhogweed4 / libnettle4 / libnettle6 / nettle-bin / etc');
}
