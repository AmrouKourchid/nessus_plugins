...
# extracted from Fedora Security Advisory FEDORA-2023-9695066ded
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-9695066ded");

  script_name(english:"Fedora 36 : seamonkey (2023-9695066ded)");
...
FEDORA-2023-9695066ded advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-9695066ded");
...
var pkgs = [
    {'reference':'seamonkey-2.53.15-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
