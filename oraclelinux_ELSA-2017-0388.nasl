...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2017-0388.html");
...
var pkgs = [
    {'reference':'ipa-admintools-4.4.0-14.0.1.el7_3.6', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ipa-client-4.4.0-14.0.1.el7_3.6', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ipa-client-common-4.4.0-14.0.1.el7_3.6', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ipa-common-4.4.0-14.0.1.el7_3.6', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ipa-python-compat-4.4.0-14.0.1.el7_3.6', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ipa-server-4.4.0-14.0.1.el7_3.6', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ipa-server-common-4.4.0-14.0.1.el7_3.6', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ipa-server-dns-4.4.0-14.0.1.el7_3.6', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ipa-server-trust-ad-4.4.0-14.0.1.el7_3.6', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python2-ipaclient-4.4.0-14.0.1.el7_3.6', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python2-ipalib-4.4.0-14.0.1.el7_3.6', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python2-ipaserver-4.4.0-14.0.1.el7_3.6', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
];
