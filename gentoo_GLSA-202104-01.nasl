...
# extracted from Gentoo Linux Security Advisory GLSA 202104-01.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202104-01");

  script_name(english:"GLSA-202104-01 : Git: User-assisted execution of arbitrary code");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202104-01
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202104-01"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"dev-vcs/git", unaffected:make_list("ge 2.26.3"), vulnerable:make_list("lt 2.26.3"))) flag++;
