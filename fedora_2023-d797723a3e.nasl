...
# extracted from Fedora Security Advisory FEDORA-2023-d797723a3e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-d797723a3e");

  script_name(english:"Fedora 37 : python-managesieve (2023-d797723a3e)");
...
FEDORA-2023-d797723a3e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-d797723a3e");
  script_set_attribute(attribute:"solution", value:
"Update the affected python-managesieve package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:python-managesieve");
...
var pkgs = [
    {'reference':'python-managesieve-0.7.1-6.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python-managesieve');
}
