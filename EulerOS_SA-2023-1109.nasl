...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : python3 (EulerOS-SA-2023-1109)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1109
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5cd36003");
...
var pkgs = [
  "python3-3.7.4-7.h49.eulerosv2r9",
  "python3-unversioned-command-3.7.4-7.h49.eulerosv2r9"
];
