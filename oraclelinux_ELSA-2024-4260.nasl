...
# extracted from Oracle Linux Security Advisory ELSA-2024-4260.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : python-idna (ELSA-2024-4260)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-4260.html");
...
var pkgs = [
    {'reference':'python3-idna-2.5-7.el8_10', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
