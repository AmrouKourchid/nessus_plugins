...
# extracted from Red Hat Security Advisory RHSA-2018:2526. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 6 / 7 : mutt (RHSA-2018:2526)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for mutt.");
...
referenced in the RHSA-2018:2526 advisory.

    Mutt is a low resource, highly configurable, text-based MIME e-mail client. Mutt supports most e-mail
    storing formats, such as mbox and Maildir, as well as most protocols, including POP3 and IMAP.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_2526.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b9b548af");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:2526");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1602069");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1602079");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1602915");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL mutt package based on the guidance in RHSA-2018:2526.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'mutt-1.5.21-28.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'5'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'mutt-1.5.20-9.20091214hg736b6a.el6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'5'},
      {'reference':'mutt-1.5.20-9.20091214hg736b6a.el6', 'cpu':'ppc64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'5'},
      {'reference':'mutt-1.5.20-9.20091214hg736b6a.el6', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'5'},
      {'reference':'mutt-1.5.20-9.20091214hg736b6a.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'5'}
    ]
  }
];
