...
USN-5698-2 advisory.
    ...
    USN-5698-1 fixed a vulnerability in Open. This update provides the corresponding update for Ubuntu 16.04
    ESM.
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'openvswitch-common', 'pkgver': '2.5.9-0ubuntu0.16.04.3+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'openvswitch-ipsec', 'pkgver': '2.5.9-0ubuntu0.16.04.3+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'openvswitch-pki', 'pkgver': '2.5.9-0ubuntu0.16.04.3+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'openvswitch-switch', 'pkgver': '2.5.9-0ubuntu0.16.04.3+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'openvswitch-switch-dpdk', 'pkgver': '2.5.9-0ubuntu0.16.04.3+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'openvswitch-test', 'pkgver': '2.5.9-0ubuntu0.16.04.3+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'openvswitch-testcontroller', 'pkgver': '2.5.9-0ubuntu0.16.04.3+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'openvswitch-vtep', 'pkgver': '2.5.9-0ubuntu0.16.04.3+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'ovn-central', 'pkgver': '2.5.9-0ubuntu0.16.04.3+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'ovn-common', 'pkgver': '2.5.9-0ubuntu0.16.04.3+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'ovn-host', 'pkgver': '2.5.9-0ubuntu0.16.04.3+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'python-openvswitch', 'pkgver': '2.5.9-0ubuntu0.16.04.3+esm1', 'ubuntu_pro': TRUE}
];
