...
# extracted from Red Hat Security Advisory RHSA-2023:6804. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:6804");

  script_name(english:"RHEL 8 : squid:4 (RHSA-2023:6804)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for squid:4.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2023:6804 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6804.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?88640057");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6804");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL squid:4 package based on the guidance in RHSA-2023:6804.");
  ...
  'squid:4': [
    {
      ...
      'pkgs': [
        ...
        {'reference':'squid-4.11-4.module+el8.4.0+20587+c1238193.5', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
        {'reference':'squid-4.11-4.module+el8.4.0+20587+c1238193.5', 'sp':'4', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
      ]
    }
  ]
};
