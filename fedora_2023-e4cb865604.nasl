...
# extracted from Fedora Security Advisory FEDORA-2023-e4cb865604
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-e4cb865604");

  script_name(english:"Fedora 39 : microcode_ctl (2023-e4cb865604)");
...
FEDORA-2023-e4cb865604 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-e4cb865604");
...
var pkgs = [
    {'reference':'microcode_ctl-2.1-58.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
