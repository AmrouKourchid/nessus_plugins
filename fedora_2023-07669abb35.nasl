...
# extracted from Fedora Security Advisory FEDORA-2023-07669abb35
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-07669abb35");

  script_name(english:"Fedora 38 : audiofile (2023-07669abb35)");
...
FEDORA-2023-07669abb35 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-07669abb35");
...
"Update the affected 1:audiofile package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:audiofile");
...
var pkgs = [
    {'reference':'audiofile-0.3.6-36.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
