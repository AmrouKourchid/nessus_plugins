...
# extracted from SUSE update advisory SUSE-SU-2021:0284-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : openvswitch (SUSE-SU-2021:0284-1)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9d9883ce");
...
zypper in -t patch SUSE-OpenStack-Cloud-Crowbar-8-2021-284=1

SUSE OpenStack Cloud 8 :

zypper in -t patch SUSE-OpenStack-Cloud-8-2021-284=1

SUSE Linux Enterprise Server for SAP 12-SP3 :

zypper in -t patch SUSE-SLE-SAP-12-SP3-2021-284=1

SUSE Linux Enterprise Server 12-SP3-LTSS :

zypper in -t patch SUSE-SLE-SERVER-12-SP3-2021-284=1

SUSE Linux Enterprise Server 12-SP3-BCL :

zypper in -t patch SUSE-SLE-SERVER-12-SP3-BCL-2021-284=1

SUSE Enterprise Storage 5 :

zypper in -t patch SUSE-Storage-5-2021-284=1

HPE Helion Openstack 8 :

zypper in -t patch HPE-Helion-OpenStack-8-2021-284=1");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"3", reference:"openvswitch-2.7.12-3.36.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"openvswitch-debuginfo-2.7.12-3.36.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"openvswitch-debugsource-2.7.12-3.36.1")) flag++;
