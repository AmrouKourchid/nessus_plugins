...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : ghostscript (EulerOS-SA-2021-1067)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1067
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3a39c81e");
...
pkgs = ["ghostscript-9.07-31.6.h19",
        "ghostscript-cups-9.07-31.6.h19"];
