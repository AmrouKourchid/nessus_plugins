...
# extracted from Fedora Security Advisory FEDORA-2024-b8312ca5b3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-b8312ca5b3");

  script_name(english:"Fedora 39 : systemd (2024-b8312ca5b3)");
...
FEDORA-2024-b8312ca5b3 advisory.

    - A bunch of fixes for various components: systemd, systemctl, systemd-firstboot, systemd-repart, bootctl,
    systemd-networkd, systemd-network-generator, systemd-analyze, systemd-dissect, ukify, man pages.
    - Also has a patch for CVE-2023-7008 (rhbz#2222260)
    - Add missing %postun scriptlets for systemd-{resolved,networkd} so that they are restarted on package
    updates.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-b8312ca5b3");
...
var pkgs = [
    {'reference':'systemd-254.8-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
