...
# extracted from Fedora Security Advisory FEDORA-2024-19d093c14d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-19d093c14d");

  script_name(english:"Fedora 40 : caddy (2024-19d093c14d)");
...
FEDORA-2024-19d093c14d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-19d093c14d");
...
var pkgs = [
    {'reference':'caddy-2.7.6-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
