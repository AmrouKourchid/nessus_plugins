...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Lz4 PHSA-2020-2.0-0235");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'lz4-1.9.2-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'lz4-debuginfo-1.9.2-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'lz4-devel-1.9.2-1.ph2')) flag++;
