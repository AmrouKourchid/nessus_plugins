...
# extracted from Oracle Linux Security Advisory ELSA-2019-3673.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : lldpad (ELSA-2019-3673)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2019-3673.html");
...
"Update the affected lldpad package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:lldpad");
