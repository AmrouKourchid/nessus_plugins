...
# extracted from Fedora Security Advisory FEDORA-2024-bbfef02415
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-bbfef02415");

  script_name(english:"Fedora 38 : freeipa (2024-bbfef02415)");
...
FEDORA-2024-bbfef02415 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-bbfef02415");
...
var pkgs = [
    {'reference':'freeipa-4.10.3-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
