...
# extracted from Fedora Security Advisory FEDORA-2024-3ae3a47901
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-3ae3a47901");

  script_name(english:"Fedora 40 : libsndfile (2024-3ae3a47901)");
...
FEDORA-2024-3ae3a47901 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-3ae3a47901");
...
var pkgs = [
    {'reference':'libsndfile-1.2.2-4.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
