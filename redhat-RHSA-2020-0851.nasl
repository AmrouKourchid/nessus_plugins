...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_0851.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?43e73d9c");
...
"Update the RHEL python-virtualenv package based on the guidance in RHSA-2020:0851.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python-virtualenv-15.1.0-4.el7_7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
