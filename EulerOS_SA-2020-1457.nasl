...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.2 : ntp (EulerOS-SA-2020-1457)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1457
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c5c43499");
...
pkgs = ["ntp-4.2.6p5-28.h12.eulerosv2r7",
        "ntpdate-4.2.6p5-28.h12.eulerosv2r7",
        "sntp-4.2.6p5-28.h12.eulerosv2r7"];
