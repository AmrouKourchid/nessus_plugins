...
# extracted from Fedora Security Advisory FEDORA-2024-296a0db958
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-296a0db958");

  script_name(english:"Fedora 40 : nextcloud (2024-296a0db958)");
...
FEDORA-2024-296a0db958 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-296a0db958");
...
var pkgs = [
    {'reference':'nextcloud-29.0.6-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
