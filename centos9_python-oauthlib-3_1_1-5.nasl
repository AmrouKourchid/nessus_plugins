...
if (description)
{
  ...
  script_name(english:"CentOS 9 : python-oauthlib-3.1.1-5.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update for python3-oauthlib.");
...
oauthlib-3.1.1-5.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=26865");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream python3-oauthlib package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:python3-oauthlib");
...
var pkgs = [
    {'reference':'python3-oauthlib-3.1.1-5.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
