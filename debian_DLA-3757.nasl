...
# extracted from Debian Security Advisory dla-3757. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3757 : libnss3 - security update");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libnss3', 'reference': '2:3.42.1-1+deb10u8'},
    {'release': '10.0', 'prefix': 'libnss3-dev', 'reference': '2:3.42.1-1+deb10u8'},
    {'release': '10.0', 'prefix': 'libnss3-tools', 'reference': '2:3.42.1-1+deb10u8'}
];
