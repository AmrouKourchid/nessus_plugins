...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : python-pip (EulerOS-SA-2023-1152)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1152
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5db0fd97");
...
var pkgs = [
  "python-pip-wheel-20.2.2-1.h7.eulerosv2r10",
  "python3-pip-20.2.2-1.h7.eulerosv2r10"
];
