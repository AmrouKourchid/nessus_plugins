...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.6.0 : lldpad (EulerOS-SA-2021-1588)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1588
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c440aff6");
...
pkgs = ["lldpad-1.0.1-11.git036e314.h2.eulerosv2r8"];
