...
# extracted from Red Hat Security Advisory RHSA-2018:0052. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:0052");
  script_xref(name:"IAVA", value:"2018-A-0020");
  script_xref(name:"IAVA", value:"2018-A-0017-S");

  script_name(english:"RHEL 6 : rhevm-setup-plugins (RHSA-2018:0052) (Spectre)");
...
Note: This is the rhevm-setup-plugins side of the CVE-2017-5715
mitigation.
...
issue.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:0052");
...
{
  flag = 0;
  if (rpm_exists(rpm:"rhevm-setup-plugins-3.6.", release:"RHEL6") && rpm_check(release:"RHEL6", reference:"rhevm-setup-plugins-3.6.6-1.el6")) flag++;
