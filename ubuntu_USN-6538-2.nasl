...
# extracted from Ubuntu Security Notice USN-6538-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6538-2");

  script_name(english:"Ubuntu 18.04 ESM : PostgreSQL vulnerabilities (USN-6538-2)");
...
the USN-6538-2 advisory.

    USN-6538-1 fixed several vulnerabilities in PostgreSQL. This update provides the corresponding updates for
    Ubuntu 18.04 LTS.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6538-2");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'libecpg-compat3', 'pkgver': '10.23-0ubuntu0.18.04.2+esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libecpg-dev', 'pkgver': '10.23-0ubuntu0.18.04.2+esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libecpg6', 'pkgver': '10.23-0ubuntu0.18.04.2+esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libpgtypes3', 'pkgver': '10.23-0ubuntu0.18.04.2+esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libpq-dev', 'pkgver': '10.23-0ubuntu0.18.04.2+esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libpq5', 'pkgver': '10.23-0ubuntu0.18.04.2+esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'postgresql-10', 'pkgver': '10.23-0ubuntu0.18.04.2+esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'postgresql-client-10', 'pkgver': '10.23-0ubuntu0.18.04.2+esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'postgresql-plperl-10', 'pkgver': '10.23-0ubuntu0.18.04.2+esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'postgresql-plpython-10', 'pkgver': '10.23-0ubuntu0.18.04.2+esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'postgresql-plpython3-10', 'pkgver': '10.23-0ubuntu0.18.04.2+esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'postgresql-pltcl-10', 'pkgver': '10.23-0ubuntu0.18.04.2+esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'postgresql-server-dev-10', 'pkgver': '10.23-0ubuntu0.18.04.2+esm1', 'ubuntu_pro': TRUE}
];
