...
# extracted from Amazon Linux 2 Security Advisory ALAS-2019-1161.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2019-1161");

  script_name(english:"Amazon Linux 2 : libvncserver (ALAS-2019-1161)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"LibVNC contains heap out-of-bound write vulnerability in server code
of file transfer extension that can result remote code execution
(CVE-2018-15127)");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2019-1161.html");
...
flag = 0;
if (rpm_check(release:"AL2", reference:"libvncserver-0.9.9-13.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"libvncserver-debuginfo-0.9.9-13.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"libvncserver-devel-0.9.9-13.amzn2")) flag++;
