...
# extracted from Oracle Linux Security Advisory ELSA-2024-9404.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : libgcrypt (ELSA-2024-9404)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-9404.html");
...
var pkgs = [
    {'reference':'libgcrypt-1.10.0-11.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libgcrypt-devel-1.10.0-11.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libgcrypt-1.10.0-11.el9', 'cpu':'i686', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libgcrypt-devel-1.10.0-11.el9', 'cpu':'i686', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libgcrypt-1.10.0-11.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libgcrypt-devel-1.10.0-11.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
