...
# extracted from Red Hat Security Advisory RHSA-2020:1981.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : chromium-browser (RHSA-2020:1981)");
...
RHSA-2020:1981 advisory.

  - Use after free in storage in Google Chrome prior to 81.0.4044.129 allowed a remote attacker who had
    compromised the renderer process to potentially perform a sandbox escape via a crafted HTML page.
    (CVE-2020-6461)

  - Use after free in task scheduling in Google Chrome prior to 81.0.4044.129 allowed a remote attacker who
...
var pkgs = [
    {'reference':'chromium-browser-81.0.4044.129-1.el6_10', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
