...
# extracted from Fedora Security Advisory FEDORA-2022-5f32512090
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-5f32512090");

  script_name(english:"Fedora 37 : plantuml (2022-5f32512090)");
...
FEDORA-2022-5f32512090 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-5f32512090");
...
var pkgs = [
    {'reference':'plantuml-1.2022.4-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
