...
if (description)
{
  ...
  script_name(english:"Adobe Illustrator < 24.2.0 Multiple Vulnerabilities (APSB20-37) (macOS)");

  script_set_attribute(attribute:"synopsis", value:
"The Adobe Illustrator instance installed on the remote host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Illustrator installed on the remote macOS host is prior to 24.2.0. It is, therefore, affected by
