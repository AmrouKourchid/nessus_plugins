...
# extracted from Fedora Security Advisory FEDORA-2020-6e3e0c6386.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-6e3e0c6386");

  script_name(english:"Fedora 30 : sleuthkit (2020-6e3e0c6386)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-6e3e0c6386");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"sleuthkit-4.9.0-1.fc30")) flag++;
