...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5002660");
  script_xref(name:"MSFT", value:"MS24-5002660");
  script_xref(name:"IAVA", value:"2024-A-0806-S");

  script_name(english:"Security Updates for Microsoft Excel Products (December 2024)");
...
"The Microsoft Excel Products are missing a security update. It is, therefore, affected by the following vulnerability:
  ...
  - A remote code execution vulnerability. An attacker can exploit this to bypass authentication and execute
    unauthorized arbitrary commands. (CVE-2024-49069)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002660");
...
var constraints = [
  { 'kb':'5002660', 'channel':'MSI', 'fixed_version': '16.0.5478.1002', 'sp' : 0}
];
