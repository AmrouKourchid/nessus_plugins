...
# extracted from Fedora Security Advisory FEDORA-2024-5661c87b25
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-5661c87b25");

  script_name(english:"Fedora 39 : espeak-ng (2024-5661c87b25)");
...
FEDORA-2024-5661c87b25 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-5661c87b25");
  script_set_attribute(attribute:"solution", value:
"Update the affected espeak-ng package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:espeak-ng");
...
var pkgs = [
    {'reference':'espeak-ng-1.51.1-6.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'espeak-ng');
}
