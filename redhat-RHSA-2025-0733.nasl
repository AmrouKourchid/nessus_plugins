...
# extracted from Red Hat Security Advisory RHSA-2025:0733. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:0733");

  script_name(english:"RHEL 8 : bzip2 (RHSA-2025:0733)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for bzip2.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2025:0733 advisory.

    The bzip2 packages contain a freely available, high-quality data compressor. It provides both standalone
    compression and decompression utilities, as well as a shared library for use with other programs.

    Security Fix(es):

    * bzip2: bzip2: Data integrity error when decompressing (with data integrity tests fail). (CVE-2019-12900)

    * bzip2: bzip2: Data integrity error when decompressing (with data integrity tests fail). [rhel-8.10.z]
    (CVE-2019-12900)
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-67824");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_0733.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d6b0d0cc");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:0733");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL bzip2 package based on the guidance in RHSA-2025:0733.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'bzip2-1.0.6-28.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bzip2-devel-1.0.6-28.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bzip2-libs-1.0.6-28.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
