...
# extracted from Fedora Security Advisory FEDORA-2023-18eae45792
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-18eae45792");

  script_name(english:"Fedora 38 : dotnet6.0 (2023-18eae45792)");
...
FEDORA-2023-18eae45792 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-18eae45792");
...
var pkgs = [
    {'reference':'dotnet6.0-6.0.122-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
