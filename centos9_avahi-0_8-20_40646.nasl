...
if (description)
{
  ...
  script_name(english:"CentOS 9 : avahi-0.8-20.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing one or more security updates for avahi.");
...
avahi-0.8-20.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=40646");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream avahi package.");
...
var pkgs = [
    ...
    {'reference':'avahi-autoipd-0.8-20.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'avahi-dnsconfd-0.8-20.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'avahi-gobject-0.8-20.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'avahi-gobject-devel-0.8-20.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'avahi-ui-0.8-20.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'avahi-ui-devel-0.8-20.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'avahi-ui-gtk3-0.8-20.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'avahi-ui-tools-0.8-20.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
