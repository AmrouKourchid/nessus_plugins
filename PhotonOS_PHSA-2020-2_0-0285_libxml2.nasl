...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Libxml2 PHSA-2020-2.0-0285");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libxml2-2.9.10-3.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libxml2-devel-2.9.10-3.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libxml2-python-2.9.10-3.ph2')) flag++;
