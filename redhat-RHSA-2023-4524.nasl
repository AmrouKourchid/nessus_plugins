...
# extracted from Red Hat Security Advisory RHSA-2023:4524. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:4524");

  script_name(english:"RHEL 8 : libcap (RHSA-2023:4524)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for libcap.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2023:4524 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_4524.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0382da33");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:4524");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libcap package based on the guidance in RHSA-2023:4524.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libcap-2.48-5.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libcap-devel-2.48-5.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'libcap-2.48-5.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libcap-devel-2.48-5.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
