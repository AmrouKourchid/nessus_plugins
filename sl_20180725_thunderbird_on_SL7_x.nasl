...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : thunderbird on SL7.x x86_64 (20180725)");
...
Security Fix(es) :
  ...
  - thunderbird: S/MIME and PGP decryption oracles can be
    built with HTML emails (CVE-2018-12372)
  ...
  - thunderbird: Using form to exfiltrate encrypted mail
    part by pressing enter in form field (CVE-2018-12374)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1807&L=scientific-linux-errata&F=&S=&P=10512
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b2f6a8af");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"thunderbird-52.9.1-1.el7_5", allowmaj:TRUE)) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"thunderbird-debuginfo-52.9.1-1.el7_5", allowmaj:TRUE)) flag++;
