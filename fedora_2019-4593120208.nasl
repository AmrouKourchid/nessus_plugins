...
# extracted from Fedora Security Advisory FEDORA-2019-4593120208.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-4593120208");
  script_xref(name:"IAVB", value:"2019-B-0085-S");

  script_name(english:"Fedora 31 : golang (2019-4593120208)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"Security fix for CVE-2019-17596 Rebase to 1.13.3

Note that Tenable Network Security has extracted the preceding
description block directly from the Fedora update system website.
Tenable has attempted to automatically clean and format it as much as
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-4593120208");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"golang-1.13.3-1.fc31")) flag++;
