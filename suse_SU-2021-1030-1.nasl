...
# extracted from SUSE update advisory SUSE-SU-2021:1030-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : gssproxy (SUSE-SU-2021:1030-1)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?13086cf8");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"5", reference:"gssproxy-0.8.2-4.5.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"gssproxy-debuginfo-0.8.2-4.5.1")) flag++;
