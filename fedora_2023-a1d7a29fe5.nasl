...
# extracted from Fedora Security Advisory FEDORA-2023-a1d7a29fe5
#
...
if (description)
{
  ...
  script_cve_id("CVE-2021-25743", "CVE-2023-2431");
  script_xref(name:"FEDORA", value:"2023-a1d7a29fe5");

  script_name(english:"Fedora 37 : kubernetes (2023-a1d7a29fe5)");
...
FEDORA-2023-a1d7a29fe5 advisory.

    Patch update to Kubernetes 1.25 for Fedora 37. Primarily a security fix for CVE-2023-2431: Bypass of
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-a1d7a29fe5");
...
"Update the affected kubernetes package.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2023-2431");

  script_set_attribute(attribute:"exploitability_ease", value:"No known exploits are available");
  script_set_attribute(attribute:"exploit_available", value:"false");

  script_set_attribute(attribute:"vuln_publication_date", value:"2022/01/07");
...
var pkgs = [
    {'reference':'kubernetes-1.25.11-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
