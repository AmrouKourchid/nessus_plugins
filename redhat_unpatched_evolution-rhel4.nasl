...
# extracted from Red Hat Security Advisory evolution. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2006-0040", "CVE-2011-3201");

  script_name(english:"RHEL 4 : evolution (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2006-0040");
