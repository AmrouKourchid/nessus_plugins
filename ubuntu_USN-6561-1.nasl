...
# extracted from Ubuntu Security Notice USN-6561-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6561-1");
  script_xref(name:"IAVA", value:"2023-A-0703");

  script_name(english:"Ubuntu 20.04 LTS / 22.04 LTS / 23.04 / 23.10 : libssh vulnerability (USN-6561-1)");
...
as referenced in the USN-6561-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6561-1");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'libssh-4', 'pkgver': '0.9.3-2ubuntu2.4'},
    {'osver': '20.04', 'pkgname': 'libssh-dev', 'pkgver': '0.9.3-2ubuntu2.4'},
    {'osver': '20.04', 'pkgname': 'libssh-gcrypt-4', 'pkgver': '0.9.3-2ubuntu2.4'},
    {'osver': '20.04', 'pkgname': 'libssh-gcrypt-dev', 'pkgver': '0.9.3-2ubuntu2.4'},
    {'osver': '22.04', 'pkgname': 'libssh-4', 'pkgver': '0.9.6-2ubuntu0.22.04.2'},
    {'osver': '22.04', 'pkgname': 'libssh-dev', 'pkgver': '0.9.6-2ubuntu0.22.04.2'},
    {'osver': '22.04', 'pkgname': 'libssh-gcrypt-4', 'pkgver': '0.9.6-2ubuntu0.22.04.2'},
    {'osver': '22.04', 'pkgname': 'libssh-gcrypt-dev', 'pkgver': '0.9.6-2ubuntu0.22.04.2'},
    {'osver': '23.04', 'pkgname': 'libssh-4', 'pkgver': '0.10.4-2ubuntu0.2'},
    {'osver': '23.04', 'pkgname': 'libssh-dev', 'pkgver': '0.10.4-2ubuntu0.2'},
    {'osver': '23.04', 'pkgname': 'libssh-gcrypt-4', 'pkgver': '0.10.4-2ubuntu0.2'},
    {'osver': '23.04', 'pkgname': 'libssh-gcrypt-dev', 'pkgver': '0.10.4-2ubuntu0.2'},
    {'osver': '23.10', 'pkgname': 'libssh-4', 'pkgver': '0.10.5-3ubuntu1.1'},
    {'osver': '23.10', 'pkgname': 'libssh-dev', 'pkgver': '0.10.5-3ubuntu1.1'},
    {'osver': '23.10', 'pkgname': 'libssh-gcrypt-4', 'pkgver': '0.10.5-3ubuntu1.1'},
    {'osver': '23.10', 'pkgname': 'libssh-gcrypt-dev', 'pkgver': '0.10.5-3ubuntu1.1'}
];
