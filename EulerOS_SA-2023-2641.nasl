...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : git (EulerOS-SA-2023-2641)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2641
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?92c87453");
...
var pkgs = [
  "git-2.33.0-1.h11.eulerosv2r11",
  "git-help-2.33.0-1.h11.eulerosv2r11"
];
