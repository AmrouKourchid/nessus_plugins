...
# extracted from Fedora Security Advisory FEDORA-2025-dd11f92771
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-dd11f92771");

  script_name(english:"Fedora 41 : java-1.8.0-openjdk (2025-dd11f92771)");
...
FEDORA-2025-dd11f92771 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-dd11f92771");
...
var pkgs = [
    {'reference':'java-1.8.0-openjdk-1.8.0.442.b06-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
