...
if (description)
{
  ...
  script_cve_id("CVE-2022-44032");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-44032");
...
patch available.
  ...
  - An issue was discovered in the Linux kernel through 6.0.6. drivers/char/pcmcia/cm4000_cs.c has a race
    condition and resultant use-after-free if a physically proximate attacker removes a PCMCIA device while
    calling open(), aka a race condition between cmm_open() and cm4000_detach(). (CVE-2022-44032)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-44032");
