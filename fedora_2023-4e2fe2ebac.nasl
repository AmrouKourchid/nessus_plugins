...
# extracted from Fedora Security Advisory FEDORA-2023-4e2fe2ebac
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-4e2fe2ebac");

  script_name(english:"Fedora 37 : suricata (2023-4e2fe2ebac)");
...
FEDORA-2023-4e2fe2ebac advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-4e2fe2ebac");
...
var pkgs = [
    {'reference':'suricata-6.0.15-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
