...
# extracted from SUSE update advisory SUSE-SU-2019:0574-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLED15 / SLES15 Security Update : java-1_8_0-openjdk (SUSE-SU-2019:0574-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"This update for java-1_8_0-openjdk to version jdk8u201 (icedtea
3.11.0) fixes the following issues :
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?06320193");
  ...
  # https://www.suse.com/support/update/announcement/2019/suse-su-20190574-1/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a31577b4");
...
-t patch SUSE-SLE-Module-Packagehub-Subpackages-15-2019-574=1

SUSE Linux Enterprise Module for Open Buildservice Development Tools
15:zypper in -t patch
SUSE-SLE-Module-Development-Tools-OBS-15-2019-574=1

SUSE Linux Enterprise Module for Legacy Software 15:zypper in -t patch
SUSE-SLE-Module-Legacy-15-2019-574=1");
...
flag = 0;
if (rpm_check(release:"SLES15", sp:"0", reference:"java-1_8_0-openjdk-1.8.0.201-3.16.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", reference:"java-1_8_0-openjdk-accessibility-1.8.0.201-3.16.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", reference:"java-1_8_0-openjdk-debuginfo-1.8.0.201-3.16.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", reference:"java-1_8_0-openjdk-debugsource-1.8.0.201-3.16.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", reference:"java-1_8_0-openjdk-demo-1.8.0.201-3.16.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", reference:"java-1_8_0-openjdk-demo-debuginfo-1.8.0.201-3.16.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", reference:"java-1_8_0-openjdk-devel-1.8.0.201-3.16.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", reference:"java-1_8_0-openjdk-devel-debuginfo-1.8.0.201-3.16.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", reference:"java-1_8_0-openjdk-headless-1.8.0.201-3.16.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", reference:"java-1_8_0-openjdk-headless-debuginfo-1.8.0.201-3.16.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", reference:"java-1_8_0-openjdk-src-1.8.0.201-3.16.1")) flag++;
if (rpm_check(release:"SLED15", sp:"0", reference:"java-1_8_0-openjdk-accessibility-1.8.0.201-3.16.1")) flag++;
if (rpm_check(release:"SLED15", sp:"0", reference:"java-1_8_0-openjdk-debuginfo-1.8.0.201-3.16.1")) flag++;
if (rpm_check(release:"SLED15", sp:"0", reference:"java-1_8_0-openjdk-debugsource-1.8.0.201-3.16.1")) flag++;
if (rpm_check(release:"SLED15", sp:"0", reference:"java-1_8_0-openjdk-src-1.8.0.201-3.16.1")) flag++;
