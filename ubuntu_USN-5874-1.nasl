...
# extracted from Ubuntu Security Notice USN-5874-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5874-1");

  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS : Linux kernel vulnerabilities (USN-5874-1)");
...
referenced in the USN-5874-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5874-1");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.4.0-1044-ibm");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.4.0-1100-gcp");
...
var kernel_mappings = {
  '18.04': {
    '5.4.0': {
      'generic': '5.4.0-139',
      'generic-lpae': '5.4.0-139',
      'lowlatency': '5.4.0-139',
      'ibm': '5.4.0-1044',
      'oracle': '5.4.0-1093',
      'aws': '5.4.0-1096',
      'gcp': '5.4.0-1100'
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-5874-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2022-3628', 'CVE-2022-3640', 'CVE-2022-3649', 'CVE-2022-41849', 'CVE-2022-41850', 'CVE-2022-42895', 'CVE-2023-20928');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-5874-1');
  }
  else
  {
