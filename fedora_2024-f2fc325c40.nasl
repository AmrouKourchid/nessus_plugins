...
# extracted from Fedora Security Advisory FEDORA-2024-f2fc325c40
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-f2fc325c40");

  script_name(english:"Fedora 39 : python3.13 (2024-f2fc325c40)");
...
FEDORA-2024-f2fc325c40 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-f2fc325c40");
...
var pkgs = [
    {'reference':'python3.13-3.13.0~rc2-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
