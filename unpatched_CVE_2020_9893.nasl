...
if (description)
{
  ...
  script_cve_id("CVE-2020-9893");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2020-9893");
...
patch available.
  ...
  - A use after free issue was addressed with improved memory management. This issue is fixed in iOS 13.6 and
    ...
    or arbitrary code execution. (CVE-2020-9893)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-9893");
