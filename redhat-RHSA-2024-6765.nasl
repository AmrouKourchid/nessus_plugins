...
# extracted from Red Hat Security Advisory RHSA-2024:6765. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:6765");

  script_name(english:"RHEL 8 / 9 : Red Hat Ansible Automation Platform 2.4 Product Security and Bug Fix Update (Moderate) (RHSA-2024:6765)");
...
referenced in the RHSA-2024:6765 advisory.
    ...
    * python3-pulpcore/python39-pulpcore: RBAC permissions incorrectly assigned in tasks that create objects
    (CVE-2024-7143)
    * python3-urllib3/python39-urllib3: urllib3: proxy-authorization request header is not stripped during
    cross-origin redirects (CVE-2024-37891)
    * receptor: golang: net/netip: Unexpected behavior from Is methods for IPv4-mapped IPv6 addresses
    (CVE-2024-24790)
    ...
    * Updated fallback to use RHSM subscription credential for shipping analytics data if analytics gathering
    is enabled (AAP-30228)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_6765.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?035ff607");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2300125");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:6765");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:python3x-pulpcore");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:python3x-urllib3");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'receptor-1.4.8-1.1.el8ap', 'release':'8', 'el_string':'el8ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.4', 'cves':['CVE-2024-7143', 'CVE-2024-24788', 'CVE-2024-24790']},
      {'reference':'receptorctl-1.4.8-1.1.el8ap', 'release':'8', 'el_string':'el8ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.4', 'cves':['CVE-2024-7143', 'CVE-2024-24788', 'CVE-2024-24790']}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'automation-controller-4.5.11-1.el8ap', 'release':'8', 'el_string':'el8ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.4', 'cves':['CVE-2024-7143']},
      {'reference':'automation-controller-cli-4.5.11-1.el8ap', 'release':'8', 'el_string':'el8ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.4', 'cves':['CVE-2024-7143']},
      {'reference':'automation-controller-server-4.5.11-1.el8ap', 'release':'8', 'el_string':'el8ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.4', 'cves':['CVE-2024-7143']},
      {'reference':'automation-controller-ui-4.5.11-1.el8ap', 'release':'8', 'el_string':'el8ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.4', 'cves':['CVE-2024-7143']},
      {'reference':'automation-controller-venv-tower-4.5.11-1.el8ap', 'release':'8', 'el_string':'el8ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.4', 'cves':['CVE-2024-7143']},
      {'reference':'python39-urllib3-1.26.20-1.el8ap', 'release':'8', 'el_string':'el8ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.4', 'cves':['CVE-2024-7143', 'CVE-2024-37891']}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'python39-django-4.2.16-1.el8ap', 'release':'8', 'el_string':'el8ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.4', 'cves':['CVE-2024-7143']},
      {'reference':'python39-pulpcore-3.28.32-1.el8ap', 'release':'8', 'el_string':'el8ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.4', 'cves':['CVE-2024-7143']}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'receptor-1.4.8-1.1.el9ap', 'release':'9', 'el_string':'el9ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.4', 'cves':['CVE-2024-7143', 'CVE-2024-24788', 'CVE-2024-24790']},
      {'reference':'receptorctl-1.4.8-1.1.el9ap', 'release':'9', 'el_string':'el9ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.4', 'cves':['CVE-2024-7143', 'CVE-2024-24788', 'CVE-2024-24790']}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'automation-controller-4.5.11-1.el9ap', 'release':'9', 'el_string':'el9ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.4', 'cves':['CVE-2024-7143']},
      {'reference':'automation-controller-cli-4.5.11-1.el9ap', 'release':'9', 'el_string':'el9ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.4', 'cves':['CVE-2024-7143']},
      {'reference':'automation-controller-server-4.5.11-1.el9ap', 'release':'9', 'el_string':'el9ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.4', 'cves':['CVE-2024-7143']},
      {'reference':'automation-controller-ui-4.5.11-1.el9ap', 'release':'9', 'el_string':'el9ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.4', 'cves':['CVE-2024-7143']},
      {'reference':'automation-controller-venv-tower-4.5.11-1.el9ap', 'release':'9', 'el_string':'el9ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.4', 'cves':['CVE-2024-7143']},
      {'reference':'python3-urllib3-1.26.20-1.el9ap', 'release':'9', 'el_string':'el9ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.4', 'cves':['CVE-2024-7143', 'CVE-2024-37891']}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'python3-django-4.2.16-1.el9ap', 'release':'9', 'el_string':'el9ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.4', 'cves':['CVE-2024-7143']},
      {'reference':'python3-pulpcore-3.28.32-1.el9ap', 'release':'9', 'el_string':'el9ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.4', 'cves':['CVE-2024-7143']}
    ]
  }
];
