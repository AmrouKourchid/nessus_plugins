...
# extracted from Fedora Security Advisory FEDORA-2024-2b429e720e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-2b429e720e");
  script_xref(name:"IAVA", value:"2024-A-0330-S");
  script_xref(name:"IAVA", value:"2024-A-0609-S");

  script_name(english:"Fedora 40 : php (2024-2b429e720e)");
...
FEDORA-2024-2b429e720e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-2b429e720e");
...
var pkgs = [
    {'reference':'php-8.3.12-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
