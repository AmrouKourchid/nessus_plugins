...
if (description)
{
  ...
  script_cve_id("CVE-2024-22123");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-22123");
...
patch available.
  ...
  - Setting SMS media allows to set GSM modem file. Later this file is used as Linux device. But due
    everything is a file for Linux, it is possible to set another file, e.g. log file and zabbix_server will
    try to communicate with it as modem. As a result, log file will be broken with AT commands and small part
    for log file content will be leaked to UI. (CVE-2024-22123)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-22123");
