...
# extracted from VMware Security Advisory PHSA-2023-5.0-0155. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Python3 PHSA-2023-5.0-0155");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the python3 package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-5.0-155.md");
...
if (rpm_check(release:'PhotonOS-5.0', reference:'python3-urllib3-1.25.11-4.ph5')) flag++;
