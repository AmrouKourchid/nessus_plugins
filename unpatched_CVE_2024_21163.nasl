...
if (description)
{
  ...
  script_cve_id("CVE-2024-21163");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-21163");
...
patch available.
  ...
  - Vulnerability in the MySQL Server product of Oracle MySQL (component: Server: Optimizer). Supported
    ...
    some of MySQL Server accessible data. (CVE-2024-21163)
