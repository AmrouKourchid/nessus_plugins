...
# extracted from Red Hat Security Advisory RHSA-2020:3102. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:3102");

  script_name(english:"RHEL 8 : openstack-keystone (RHSA-2020:3102)");
...
referenced in the RHSA-2020:3102 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_3102.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fd73d151");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:3102");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1833164");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL openstack-keystone package based on the guidance in RHSA-2020:3102.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openstack-keystone-15.0.1-0.20200512110437.95b2bbe.el8ost', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'},
      {'reference':'python3-keystone-15.0.1-0.20200512110437.95b2bbe.el8ost', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'}
    ]
  }
];
