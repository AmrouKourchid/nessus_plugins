...
# CentOS Errata and Security Advisory 2018:0913 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : policycoreutils (CESA-2018:0913)");
...
This issue was discovered by Renaud Metrich (Red Hat).

Additional Changes :

For detailed information on changes in this release, see the Red Hat
Enterprise Linux 7.5 Release Notes linked from the References section.");
  # https://lists.centos.org/pipermail/centos-cr-announce/2018-April/005065.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3700e0cf");
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"policycoreutils-2.5-22.el7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"policycoreutils-devel-2.5-22.el7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"policycoreutils-gui-2.5-22.el7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"policycoreutils-newrole-2.5-22.el7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"policycoreutils-python-2.5-22.el7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"policycoreutils-restorecond-2.5-22.el7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"policycoreutils-sandbox-2.5-22.el7")) flag++;
