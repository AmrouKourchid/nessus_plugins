...
if (description)
{
  ...
  script_name(english:"CentOS 9 : tar-1.34-6.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update for tar.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 9 host has a package installed that is affected by a vulnerability as referenced in the
tar-1.34-6.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=30366");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream tar package.");
...
var pkgs = [
    {'reference':'tar-1.34-6.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
