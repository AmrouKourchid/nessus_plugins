...
# extracted from Fedora Security Advisory FEDORA-2019-8deebad756.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : perl-Email-Address (2019-8deebad756)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-8deebad756");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"perl-Email-Address-1.912-1.fc28")) flag++;
