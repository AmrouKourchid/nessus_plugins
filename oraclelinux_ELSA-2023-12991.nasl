...
# extracted from Oracle Linux Security Advisory ELSA-2023-12991.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : microcode_ctl (ELSA-2023-12991)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-12991.html");
...
var pkgs = [
    {'reference':'microcode_ctl-20230808-2.0.2.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'}
];
