...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : mesa (EulerOS-SA-2021-1499)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1499
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?19818a6c");
...
"Update the affected mesa package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:mesa-libwayland-egl");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:mesa-libwayland-egl-devel");
...
pkgs = ["mesa-dri-drivers-17.2.3-8.20171019.h1.eulerosv2r7",
        "mesa-filesystem-17.2.3-8.20171019.h1.eulerosv2r7",
        "mesa-libEGL-17.2.3-8.20171019.h1.eulerosv2r7",
        "mesa-libEGL-devel-17.2.3-8.20171019.h1.eulerosv2r7",
        "mesa-libGL-17.2.3-8.20171019.h1.eulerosv2r7",
        "mesa-libGL-devel-17.2.3-8.20171019.h1.eulerosv2r7",
        "mesa-libGLES-17.2.3-8.20171019.h1.eulerosv2r7",
        "mesa-libgbm-17.2.3-8.20171019.h1.eulerosv2r7",
        "mesa-libglapi-17.2.3-8.20171019.h1.eulerosv2r7",
        "mesa-libwayland-egl-17.2.3-8.20171019.h1.eulerosv2r7",
        "mesa-libwayland-egl-devel-17.2.3-8.20171019.h1.eulerosv2r7",
        "mesa-libxatracker-17.2.3-8.20171019.h1.eulerosv2r7"];
