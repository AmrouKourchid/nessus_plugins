...
# extracted from Red Hat Security Advisory openswan. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2015-3240", "CVE-2016-5361", "CVE-2018-5389");

  script_name(english:"RHEL 5 : openswan (Unpatched Vulnerability) (deprecated)");
