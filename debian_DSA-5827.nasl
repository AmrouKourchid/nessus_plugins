...
# extracted from Debian Security Advisory dsa-5827. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5827 : proftpd-basic - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 12 host has packages installed that are affected by a vulnerability as referenced in the dsa-5827
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bookworm/proftpd-dfsg");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'proftpd-basic', 'reference': '1.3.8+dfsg-4+deb12u4'},
    {'release': '12.0', 'prefix': 'proftpd-core', 'reference': '1.3.8+dfsg-4+deb12u4'},
    {'release': '12.0', 'prefix': 'proftpd-dev', 'reference': '1.3.8+dfsg-4+deb12u4'},
    {'release': '12.0', 'prefix': 'proftpd-doc', 'reference': '1.3.8+dfsg-4+deb12u4'},
    {'release': '12.0', 'prefix': 'proftpd-mod-crypto', 'reference': '1.3.8+dfsg-4+deb12u4'},
    {'release': '12.0', 'prefix': 'proftpd-mod-geoip', 'reference': '1.3.8+dfsg-4+deb12u4'},
    {'release': '12.0', 'prefix': 'proftpd-mod-ldap', 'reference': '1.3.8+dfsg-4+deb12u4'},
    {'release': '12.0', 'prefix': 'proftpd-mod-mysql', 'reference': '1.3.8+dfsg-4+deb12u4'},
    {'release': '12.0', 'prefix': 'proftpd-mod-odbc', 'reference': '1.3.8+dfsg-4+deb12u4'},
    {'release': '12.0', 'prefix': 'proftpd-mod-pgsql', 'reference': '1.3.8+dfsg-4+deb12u4'},
    {'release': '12.0', 'prefix': 'proftpd-mod-snmp', 'reference': '1.3.8+dfsg-4+deb12u4'},
    {'release': '12.0', 'prefix': 'proftpd-mod-sqlite', 'reference': '1.3.8+dfsg-4+deb12u4'},
    {'release': '12.0', 'prefix': 'proftpd-mod-wrap', 'reference': '1.3.8+dfsg-4+deb12u4'}
];
