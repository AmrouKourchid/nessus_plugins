...
if (description)
{
  ...
  script_cve_id("CVE-2019-19814");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2019-19814");
...
patch available.
  ...
  - In the Linux kernel 5.0.21, mounting a crafted f2fs filesystem image can cause __remove_dirty_segment
    slab-out-of-bounds write access because an array is bounded by the number of dirty types (8) but the array
    index can exceed this. (CVE-2019-19814)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-19814");
