...
# extracted from Oracle Linux Security Advisory ELSA-2022-9751.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : openssl (ELSA-2022-9751)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 9 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ELSA-2022-9751 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2022-9751.html");
...
var pkgs = [
    {'reference':'openssl-3.0.1-41.0.1.ksplice1.el9_0', 'cpu':'aarch64', 'release':'9', 'el_string':'ksplice1.el9_0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'openssl-devel-3.0.1-41.0.1.ksplice1.el9_0', 'cpu':'aarch64', 'release':'9', 'el_string':'ksplice1.el9_0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'openssl-libs-3.0.1-41.0.1.ksplice1.el9_0', 'cpu':'aarch64', 'release':'9', 'el_string':'ksplice1.el9_0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'openssl-perl-3.0.1-41.0.1.ksplice1.el9_0', 'cpu':'aarch64', 'release':'9', 'el_string':'ksplice1.el9_0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
