...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.3 : kernel (EulerOS-SA-2019-1182)");
...
the following vulnerability :
  ...
  - A security flaw was found in the
    ...
    believe it is highly unlikely.i1/4^CVE-2018-14633i1/4%0

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1182
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a73b0da4");
...
pkgs = ["kernel-3.10.0-514.44.5.10_110",
        "kernel-devel-3.10.0-514.44.5.10_110",
        "kernel-headers-3.10.0-514.44.5.10_110",
        "kernel-tools-3.10.0-514.44.5.10_110",
        "kernel-tools-libs-3.10.0-514.44.5.10_110",
        "kernel-tools-libs-devel-3.10.0-514.44.5.10_110"];
