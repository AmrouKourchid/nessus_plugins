...
if (description)
{
  ...
  script_cve_id("CVE-2014-8139", "CVE-2018-1000035", "CVE-2021-4217");

  script_name(english:"Photon OS 5.0: Unzip PHSA-2023-5.0-0057");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'unzip-6.0-16.ph5')) flag++;
