...
if (description)
{
  ...
  script_name(english:"CentOS 7 : apache-commons-beanutils (RHSA-2020:0194)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 7 host has packages installed that are affected by a vulnerability as referenced in the
RHSA-2020:0194 advisory.
...
var pkgs = [
    {'reference':'apache-commons-beanutils-1.8.3-15.el7_7', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'apache-commons-beanutils-javadoc-1.8.3-15.el7_7', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE}
];
