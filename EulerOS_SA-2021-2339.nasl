...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : libxml2 (EulerOS-SA-2021-2339)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2339
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?191682fb");
...
pkgs = ["libxml2-2.9.1-6.3.h27.eulerosv2r7",
        "libxml2-devel-2.9.1-6.3.h27.eulerosv2r7",
        "libxml2-python-2.9.1-6.3.h27.eulerosv2r7"];
