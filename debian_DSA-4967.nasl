...
# extracted from Debian Security Advisory dsa-4967. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-4967-1 : squashfs-tools - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has a package installed that is affected by a vulnerability as referenced in the dsa-4967
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2021/dsa-4967");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'squashfs-tools', 'reference': '1:4.4-2+deb11u1'}
];
