...
"The remote Red Hat host is missing one or more security updates for Red Hat OpenStack Platform 16.1.6 (python-httplib2).");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_2116.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?28b65678");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1926885");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat OpenStack Platform 16.1.6 (python-httplib2) package based on the guidance in RHSA-2021:2116.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-httplib2-0.13.1-2.el8ost', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
