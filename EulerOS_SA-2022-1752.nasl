...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : opensc (EulerOS-SA-2022-1752)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the opensc package installed, the EulerOS installation on the remote host is affected by
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1752
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9d640cb5");
...
var pkgs = [
  "opensc-0.16.0-5.20170227git777e2a3.h4"
];
