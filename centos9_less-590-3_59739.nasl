...
if (description)
{
  ...
  script_name(english:"CentOS 9 : less-590-3.el9");
...
less-590-3.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=59739");
...
var pkgs = [
    {'reference':'less-590-3.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
