...
# extracted from Red Hat Security Advisory RHSA-2024:2528. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2528");

  script_name(english:"RHEL 9 : mingw-glib2 (RHSA-2024:2528)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for mingw-glib2.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:2528 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2528.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?85fae461");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2528");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2211827");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2211828");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2211829");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2211833");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL mingw-glib2 package based on the guidance in RHSA-2024:2528.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:N/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-32636");

  script_set_attribute(attribute:"exploitability_ease", value:"No known exploits are available");
  script_set_attribute(attribute:"exploit_available", value:"false");
  script_cwe_id(400, 502);
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:mingw-glib2");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:mingw32-glib2");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:mingw32-glib2-static");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:mingw64-glib2");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:mingw64-glib2-static");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'mingw32-glib2-2.78.0-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mingw32-glib2-static-2.78.0-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mingw64-glib2-2.78.0-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mingw64-glib2-static-2.78.0-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'mingw32-glib2 / mingw32-glib2-static / mingw64-glib2 / etc');
}
