...
# extracted from Fedora Security Advisory FEDORA-2023-5b372318ff
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-5b372318ff");

  script_name(english:"Fedora 37 : git (2023-5b372318ff)");
...
FEDORA-2023-5b372318ff advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-5b372318ff");
...
var pkgs = [
    {'reference':'git-2.39.2-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
