...
# extracted from Fedora Security Advisory FEDORA-2022-9172acadf8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-9172acadf8");

  script_name(english:"Fedora 38 : qpress (2022-9172acadf8)");
...
FEDORA-2022-9172acadf8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-9172acadf8");
...
var pkgs = [
    {'reference':'qpress-20220819-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
