...
if (description)
{
  ...
  script_name(english:"Canonical Ubuntu Linux SEoL (13.10.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Canonical Ubuntu Linux is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Canonical Ubuntu Linux is 13.10.x. It is, therefore, no longer maintained by its vendor or
provider.

Lack of support implies that no new security patches for the product will be released by the vendor. As a result, it may
contain security vulnerabilities.");
  # https://fridge.ubuntu.com/2014/07/17/ubuntu-13-10-saucy-salamander-end-of-life-reached-on-july-17-2014/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?23a9f80c");
...
"Upgrade to a version of Canonical Ubuntu Linux that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2014/07/17");
...
var constraints = [
  { max_branch : '13.10', min_branch : '13.10', seol : 20140717 }
];
