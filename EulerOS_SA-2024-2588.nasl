...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : openssl (EulerOS-SA-2024-2588)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2588
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?272309d9");
...
var pkgs = [
  "openssl-1.1.1m-2.h48.eulerosv2r11",
  "openssl-libs-1.1.1m-2.h48.eulerosv2r11",
  "openssl-perl-1.1.1m-2.h48.eulerosv2r11"
];
