...
# extracted from Ubuntu Security Notice USN-4976-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"4976-1");

  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS : Dnsmasq vulnerability (USN-4976-1)");
...
in the USN-4976-1 advisory.

    Petr Mensik discovered that Dnsmasq incorrectly randomized source ports in certain configurations. A
    remote attacker could possibly use this issue to facilitate DNS cache poisoning attacks.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4976-1");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'dnsmasq', 'pkgver': '2.79-1ubuntu0.4'},
    {'osver': '18.04', 'pkgname': 'dnsmasq-base', 'pkgver': '2.79-1ubuntu0.4'},
    {'osver': '18.04', 'pkgname': 'dnsmasq-base-lua', 'pkgver': '2.79-1ubuntu0.4'},
    {'osver': '18.04', 'pkgname': 'dnsmasq-utils', 'pkgver': '2.79-1ubuntu0.4'},
    {'osver': '20.04', 'pkgname': 'dnsmasq', 'pkgver': '2.80-1.1ubuntu1.4'},
    {'osver': '20.04', 'pkgname': 'dnsmasq-base', 'pkgver': '2.80-1.1ubuntu1.4'},
    {'osver': '20.04', 'pkgname': 'dnsmasq-base-lua', 'pkgver': '2.80-1.1ubuntu1.4'},
    {'osver': '20.04', 'pkgname': 'dnsmasq-utils', 'pkgver': '2.80-1.1ubuntu1.4'}
];
