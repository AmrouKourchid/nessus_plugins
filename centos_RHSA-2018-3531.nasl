...
# CentOS Errata and Security Advisory 2018:3531 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : thunderbird (CESA-2018:3531)");
...
reporters.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?94a77a43");
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"thunderbird-60.3.0-1.el6.centos", allowmaj:TRUE)) flag++;
