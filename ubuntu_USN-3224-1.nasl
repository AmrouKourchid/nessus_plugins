...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS : LXC vulnerability (USN-3224-1)");
...
in the USN-3224-1 advisory.

    Jann Horn discovered that LXC incorrectly verified permissions when creating virtual network interfaces. A
    local attacker could possibly use this issue to create virtual network interfaces in network namespaces
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3224-1");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-5985");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'liblxc1', 'pkgver': '1.0.9-0ubuntu3'},
    {'osver': '14.04', 'pkgname': 'lxc', 'pkgver': '1.0.9-0ubuntu3'},
    {'osver': '14.04', 'pkgname': 'lxc-dev', 'pkgver': '1.0.9-0ubuntu3'},
    {'osver': '14.04', 'pkgname': 'lxc-templates', 'pkgver': '1.0.9-0ubuntu3'},
    {'osver': '14.04', 'pkgname': 'lxc-tests', 'pkgver': '1.0.9-0ubuntu3'},
    {'osver': '14.04', 'pkgname': 'python3-lxc', 'pkgver': '1.0.9-0ubuntu3'},
    {'osver': '16.04', 'pkgname': 'liblxc1', 'pkgver': '2.0.7-0ubuntu1~16.04.2'},
    {'osver': '16.04', 'pkgname': 'lua-lxc', 'pkgver': '2.0.7-0ubuntu1~16.04.2'},
    {'osver': '16.04', 'pkgname': 'lxc', 'pkgver': '2.0.7-0ubuntu1~16.04.2'},
    {'osver': '16.04', 'pkgname': 'lxc-common', 'pkgver': '2.0.7-0ubuntu1~16.04.2'},
    {'osver': '16.04', 'pkgname': 'lxc-dev', 'pkgver': '2.0.7-0ubuntu1~16.04.2'},
    {'osver': '16.04', 'pkgname': 'lxc-templates', 'pkgver': '2.0.7-0ubuntu1~16.04.2'},
    {'osver': '16.04', 'pkgname': 'lxc-tests', 'pkgver': '2.0.7-0ubuntu1~16.04.2'},
    {'osver': '16.04', 'pkgname': 'lxc1', 'pkgver': '2.0.7-0ubuntu1~16.04.2'},
    {'osver': '16.04', 'pkgname': 'python3-lxc', 'pkgver': '2.0.7-0ubuntu1~16.04.2'}
];
