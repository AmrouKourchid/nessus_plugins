...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : spice-gtk (EulerOS-SA-2021-1362)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1362
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ddf27f27");
...
pkgs = ["spice-glib-0.26-5.h4",
        "spice-gtk3-0.26-5.h4"];
