...
if (description)
{
  ...
  script_cve_id("CVE-2024-46841");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-46841");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: btrfs: don't BUG_ON on ENOMEM from
    btrfs_lookup_extent_info() in walk_down_proc() We handle errors here properly, ENOMEM isn't fatal, return
    the error. (CVE-2024-46841)
