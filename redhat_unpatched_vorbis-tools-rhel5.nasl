...
# extracted from Red Hat Security Advisory vorbis-tools. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2014-9638", "CVE-2015-6749", "CVE-2017-11331");

  script_name(english:"RHEL 5 : vorbis-tools (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-9638");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2017-11331");
