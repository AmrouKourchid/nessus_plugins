...
if (description)
{
  ...
  script_name(english:"PHP 5.5.x < 5.5.11 awk Magic Parsing BEGIN DoS");
...
remote host is a version prior to 5.5.11. It is, therefore,
...
instead relied only on PHP's self-reported version number.");
  script_set_attribute(attribute:"see_also", value:"http://www.php.net/ChangeLog-5.php#5.5.11");
  script_set_attribute(attribute:"solution", value:
"Upgrade to PHP version 5.5.11 or later.");
