...
# extracted from Red Hat Security Advisory RHSA-2025:1070. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:1070");
  script_xref(name:"CEA-ID", value:"CEA-2021-0025");

  script_name(english:"RHEL 8 : Red Hat OpenStack Platform 16.2 (python-django20) (RHSA-2025:1070)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for Red Hat OpenStack Platform 16.2 (python-django20).");
...
the RHSA-2025:1070 advisory.

    A high-level Python Web framework

    Security Fix(es):

    * python-django20: jquery: Untrusted code execution via <option> tag in HTML passed to DOM manipulation
    methods (CVE-2020-11023)
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_1070.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2002d5f6");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:1070");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat OpenStack Platform 16.2 (python-django20) package based on the guidance in RHSA-2025:1070.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-django20-2.0.13-19.el8ost', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
