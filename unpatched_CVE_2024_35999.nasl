...
if (description)
{
  ...
  script_cve_id("CVE-2024-35999");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-35999");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: smb3: missing lock when picking
    channel Coverity spotted a place where we should have been holding the channel lock when accessing the ses
    channel index. Addresses-Coverity: 1582039 (Data race condition (MISSING_LOCK)) (CVE-2024-35999)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-35999");
