...
# extracted from Red Hat Security Advisory RHSA-2022:8162. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:8162");

  script_name(english:"RHEL 9 : 389-ds-base (RHSA-2022:8162)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2022:8162 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8162.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9f0506c9");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8162");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'389-ds-base-2.1.3-4.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'389-ds-base-libs-2.1.3-4.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
