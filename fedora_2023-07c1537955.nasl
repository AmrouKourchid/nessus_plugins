...
# extracted from Fedora Security Advisory FEDORA-2023-07c1537955
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-07c1537955");

  script_name(english:"Fedora 38 : firefox (2023-07c1537955)");
...
FEDORA-2023-07c1537955 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-07c1537955");
...
var pkgs = [
    {'reference':'firefox-112.0-3.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
