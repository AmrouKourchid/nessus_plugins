...
if (description)
{
  ...
  script_name(english:"TeamViewer 15.48 < 15.54 Improper Fingerprint Validation (tv-2024-1004)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of TeamViewer Client installed on the remote Windows host is between 15.48 and 15.53. It is, therefore,
affected by an improper fingerprint validation vulnerability. It could allow a local attacker with administrative user 
rights to further elevate privileges (e.g. to SYSTEM) via executable sideloading.
...
var constraints = [{'min_version': '15.48', 'fixed_version': '15.54'}];
