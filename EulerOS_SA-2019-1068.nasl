...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : libvncserver (EulerOS-SA-2019-1068)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1068
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?568b93fc");
...
pkgs = ["libvncserver-0.9.9-12.h10.eulerosv2r7"];
