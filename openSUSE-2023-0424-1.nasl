...
# openSUSE Security Update openSUSE-SU-2023:0424-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : deepin-compressor (openSUSE-SU-2023:0424-1)");
...
number.");
  ...
  # https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/DAZVQ2SNKDTHKSUK47UVIS2467BT56Z4/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8f846f1e");
...
var pkgs = [
    {'reference':'deepin-compressor-5.12.2-bp154.2.3.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'deepin-compressor-lang-5.12.2-bp154.2.3.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE}
];
