...
# extracted from Red Hat Security Advisory RHSA-2021:1610. The text
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_1610.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e726bf07");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:1610");
...
"Update the RHEL curl package based on the guidance in RHSA-2021:1610.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'curl-7.61.1-18.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libcurl-7.61.1-18.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libcurl-devel-7.61.1-18.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libcurl-minimal-7.61.1-18.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
