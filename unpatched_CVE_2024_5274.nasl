...
if (description)
{
  ...
  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-5274");
...
patch available.
  ...
  - Type Confusion in V8 in Google Chrome prior to 125.0.6422.112 allowed a remote attacker to execute
