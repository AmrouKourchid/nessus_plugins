...
# extracted from Debian Security Advisory dla-3012. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-3012-1 : libxml2 - LTS security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 9 host has packages installed that are affected by a vulnerability as referenced in the dla-3012
advisory.

    Felix Wilhelm discovered that libxml2, the GNOME XML library, did not correctly check for integer
    overflows or used wrong types for buffer sizes. This could result in out-of-bounds writes or other memory
    errors when working on large, multi-gigabyte buffers. For Debian 9 stretch, this problem has been fixed in
    version 2.9.4+dfsg1-2.2+deb9u7. We recommend that you upgrade your libxml2 packages. For the detailed
    security status of libxml2 please refer to its security tracker page at: https://security-
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2022/dla-3012");
...
var pkgs = [
    {'release': '9.0', 'prefix': 'libxml2', 'reference': '2.9.4+dfsg1-2.2+deb9u7'},
    {'release': '9.0', 'prefix': 'libxml2-dbg', 'reference': '2.9.4+dfsg1-2.2+deb9u7'},
    {'release': '9.0', 'prefix': 'libxml2-dev', 'reference': '2.9.4+dfsg1-2.2+deb9u7'},
    {'release': '9.0', 'prefix': 'libxml2-doc', 'reference': '2.9.4+dfsg1-2.2+deb9u7'},
    {'release': '9.0', 'prefix': 'libxml2-utils', 'reference': '2.9.4+dfsg1-2.2+deb9u7'},
    {'release': '9.0', 'prefix': 'libxml2-utils-dbg', 'reference': '2.9.4+dfsg1-2.2+deb9u7'},
    {'release': '9.0', 'prefix': 'python-libxml2', 'reference': '2.9.4+dfsg1-2.2+deb9u7'},
    {'release': '9.0', 'prefix': 'python-libxml2-dbg', 'reference': '2.9.4+dfsg1-2.2+deb9u7'},
    {'release': '9.0', 'prefix': 'python3-libxml2', 'reference': '2.9.4+dfsg1-2.2+deb9u7'},
    {'release': '9.0', 'prefix': 'python3-libxml2-dbg', 'reference': '2.9.4+dfsg1-2.2+deb9u7'}
];
