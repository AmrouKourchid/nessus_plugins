...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : openjpeg2 (EulerOS-SA-2025-1365)");
...
the following vulnerabilities :
    ...
    A flaw was found in the OpenJPEG project. A heap buffer overflow condition may be triggered when certain
    options are specified while using the opj_decompress utility.  This can lead to an application crash or
    other undefined behavior.(CVE-2024-56827)

    A flaw was found in the OpenJPEG project. A heap buffer overflow condition may be triggered when certain
    options are specified while using the opj_decompress utility.  This can lead to an application crash or
    other undefined behavior.(CVE-2024-56826)
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1365
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?36225f01");
...
var pkgs = [
  "openjpeg2-2.4.0-4.h5.eulerosv2r11"
];
