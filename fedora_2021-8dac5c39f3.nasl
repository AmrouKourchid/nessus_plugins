...
# extracted from Fedora Security Advisory FEDORA-2021-8dac5c39f3
#
...
if (description)
{
  ...
  script_name(english:"Fedora 33 : php (2021-8dac5c39f3)");
...
FEDORA-2021-8dac5c39f3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-8dac5c39f3");
...
pkgs = [
    {'reference':'php-7.4.14-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
