...
# extracted from Red Hat Security Advisory RHSA-2021:0618. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:0618");

  script_name(english:"RHEL 8 : stunnel (RHSA-2021:0618)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_0618.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fb5fb393");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:0618");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1925226");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL stunnel package based on the guidance in RHSA-2021:0618.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'stunnel-5.56-5.el8_3', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
