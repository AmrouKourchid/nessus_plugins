...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : ksh (EulerOS-SA-2020-1681)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1681
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a3dcb943");
