...
# extracted from Red Hat Security Advisory RHSA-2023:0958. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:0958");
  script_xref(name:"IAVB", value:"2023-B-0018-S");

  script_name(english:"RHEL 9 : vim (RHSA-2023:0958)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_0958.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e2cc2820");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:0958");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2163613");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL vim package based on the guidance in RHSA-2023:0958.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'vim-common-8.2.2637-20.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'vim-enhanced-8.2.2637-20.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'vim-filesystem-8.2.2637-20.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'vim-minimal-8.2.2637-20.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'vim-X11-8.2.2637-20.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
    ]
  }
];
