...
# extracted from Amazon Linux 2 Security Advisory ALAS-2020-1453.
#
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : lftp (ALAS-2020-1453)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of lftp installed on the remote host is prior to 4.4.8-12. It is, therefore, affected by a vulnerability as
referenced in the ALAS2-2020-1453 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2020-1453.html");
...
var pkgs = [
    {'reference':'lftp-4.4.8-12.amzn2.1', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'lftp-4.4.8-12.amzn2.1', 'cpu':'i686', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'lftp-4.4.8-12.amzn2.1', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'lftp-debuginfo-4.4.8-12.amzn2.1', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'lftp-debuginfo-4.4.8-12.amzn2.1', 'cpu':'i686', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'lftp-debuginfo-4.4.8-12.amzn2.1', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'lftp-scripts-4.4.8-12.amzn2.1', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
