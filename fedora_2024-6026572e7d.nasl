...
# extracted from Fedora Security Advisory FEDORA-2024-6026572e7d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-6026572e7d");

  script_name(english:"Fedora 39 : python-jinja2 (2024-6026572e7d)");
...
FEDORA-2024-6026572e7d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-6026572e7d");
...
var pkgs = [
    {'reference':'python-jinja2-3.1.3-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
