...
# extracted from Fedora Security Advisory FEDORA-2024-0f8a88da75
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-0f8a88da75");

  script_name(english:"Fedora 39 : webkitgtk (2024-0f8a88da75)");
...
FEDORA-2024-0f8a88da75 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-0f8a88da75");
...
var pkgs = [
    {'reference':'webkitgtk-2.46.3-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
