...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : sendmail (EulerOS-SA-2019-2549)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2549
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?38b303a7");
...
pkgs = ["sendmail-8.14.7-5.h1.eulerosv2r7",
        "sendmail-cf-8.14.7-5.h1.eulerosv2r7"];
