...
# extracted from VMware Security Advisory PHSA-2023-5.0-0075. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Haproxy PHSA-2023-5.0-0075");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the haproxy package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-5.0-75.md");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'haproxy-2.7.10-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'haproxy-dataplaneapi-2.7.1-7.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'haproxy-doc-2.7.10-1.ph5')) flag++;
