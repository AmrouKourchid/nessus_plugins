...
# SUSE update advisory SUSE-SU-2022:3896-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:3896-1");

  script_name(english:"SUSE SLES15 Security Update : conmon (SUSE-SU-2022:3896-1)");
...
in the SUSE-SU-2022:3896-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1200285");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2022-1708");
  # https://lists.suse.com/pipermail/sle-security-updates/2022-November/012837.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?47560ffd");
...
var pkgs = [
    {'reference':'conmon-2.1.3-150100.3.9.1', 'sp':'2', 'cpu':'x86_64', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.2']},
    {'reference':'conmon-2.1.3-150100.3.9.1', 'sp':'1', 'cpu':'aarch64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-ESPOS-release-1']},
    {'reference':'conmon-2.1.3-150100.3.9.1', 'sp':'1', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-ESPOS-release-1']}
];
