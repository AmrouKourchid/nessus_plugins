...
# extracted from Red Hat Security Advisory nautilus. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2017-14604", "CVE-2022-37290");

  script_name(english:"RHEL 6 : nautilus (Unpatched Vulnerability) (deprecated)");
