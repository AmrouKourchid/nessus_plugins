...
# extracted from Fedora Security Advisory FEDORA-2023-b0811dc6e4
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-b0811dc6e4");

  script_name(english:"Fedora 38 : php-nyholm-psr7 (2023-b0811dc6e4)");
...
FEDORA-2023-b0811dc6e4 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-b0811dc6e4");
...
"Update the affected php-nyholm-psr7 package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:php-nyholm-psr7");
...
var pkgs = [
    {'reference':'php-nyholm-psr7-1.7.0-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
