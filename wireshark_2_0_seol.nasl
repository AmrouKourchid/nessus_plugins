...
if (description)
{
  ...
  script_name(english:"Wireshark SEoL (2.0.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Wireshark is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Wireshark is 2.0.x. It is, therefore, no longer maintained by its vendor or provider.
...
"Upgrade to a version of Wireshark that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2017/11/18");
...
var constraints = [
  { max_branch : '2.0', min_branch : '2.0', seol : 20171118 }
];
