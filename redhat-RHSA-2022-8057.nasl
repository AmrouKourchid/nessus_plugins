...
# extracted from Red Hat Security Advisory RHSA-2022:8057. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:8057");

  script_name(english:"RHEL 9 : grafana (RHSA-2022:8057)");
...
referenced in the RHSA-2022:8057 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9225a87e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8057");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'grafana-7.5.15-3.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
