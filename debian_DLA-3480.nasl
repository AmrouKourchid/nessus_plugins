...
# extracted from Debian Security Advisory dla-3480. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3480 : ruby-redcloth - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has a package installed that is affected by a vulnerability as referenced in the dla-3480
advisory.
...
number.");
  # https://security-tracker.debian.org/tracker/source-package/ruby-redcloth
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5254a1cd");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-31606");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/ruby-redcloth");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'ruby-redcloth', 'reference': '4.3.2-3+deb10u1'}
];
