...
# extracted from Red Hat Security Advisory hardlink. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2011-3631", "CVE-2011-3632");

  script_name(english:"RHEL 6 : hardlink (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:hardlink");
