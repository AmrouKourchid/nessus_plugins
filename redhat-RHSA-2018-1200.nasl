...
# extracted from Red Hat Security Advisory RHSA-2018:1200. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : patch (RHSA-2018:1200)");
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_1200.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3797c445");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:1200");
...
"Update the RHEL patch package based on the guidance in RHSA-2018:1200.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'patch-2.7.1-10.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
