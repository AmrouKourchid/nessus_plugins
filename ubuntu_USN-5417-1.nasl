...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS : Linux kernel vulnerabilities (USN-5417-1)");
...
the USN-5417-1 advisory.
    ...
    It was discovered that the MMC/SD subsystem in the Linux kernel did not properly handle read errors from
    SD cards in certain situations. An attacker could possibly use this to expose sensitive information
    (kernel memory). (CVE-2022-20008)
    ...
    Miaoqian Lin discovered that the RDMA Transport (RTRS) client implementation in the Linux kernel contained
    a double-free when handling certain error conditions. An attacker could use this to cause a denial of
...
var kernel_mappings = {
  '20.04': {
    '5.13.0': {
      'generic': '5.13.0-41',
      'generic-64k': '5.13.0-41',
      'generic-lpae': '5.13.0-41',
      'lowlatency': '5.13.0-41',
      'azure': '5.13.0-1023',
      'gcp': '5.13.0-1025'
    }
  }
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-5417-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2021-26401', 'CVE-2022-20008', 'CVE-2022-25258', 'CVE-2022-25375', 'CVE-2022-26490', 'CVE-2022-26966', 'CVE-2022-27223', 'CVE-2022-29156');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-5417-1');
  }
  else
  {
