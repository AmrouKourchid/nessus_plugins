...
# extracted from Red Hat Security Advisory RHSA-2025:3534. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:3534");

  script_name(english:"RHEL 9 : libgcrypt (RHSA-2025:3534)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_3534.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?622fb7ce");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:3534");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libgcrypt package based on the guidance in RHSA-2025:3534.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libgcrypt-1.10.0-10.el9_2.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libgcrypt-devel-1.10.0-10.el9_2.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
