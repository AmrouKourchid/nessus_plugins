...
# extracted from Red Hat Security Advisory RHSA-2023:0318. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:0318");

  script_name(english:"RHEL 9 : postgresql-jdbc (RHSA-2023:0318)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_0318.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e222a881");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2129428");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:0318");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL postgresql-jdbc package based on the guidance in RHSA-2023:0318.");
