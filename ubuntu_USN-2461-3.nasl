...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : PyYAML vulnerability (USN-2461-3)");
...
USN-2461-3 advisory.
    ...
    Stanisaw Pitucha and Jonathan Gray discovered that PyYAML did not properly handle wrapped strings. An
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2461-3");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'python-yaml', 'pkgver': '3.10-4ubuntu0.1'},
    {'osver': '14.04', 'pkgname': 'python3-yaml', 'pkgver': '3.10-4ubuntu0.1'}
];
