...
# extracted from VMware Security Advisory PHSA-2020-3.0-0109. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Python PHSA-2020-3.0-0109");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the python package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-3.0-109.md");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'python-Twisted-19.10.0-4.ph3')) flag++;
