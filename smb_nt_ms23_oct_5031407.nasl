...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5031407");
  script_xref(name:"MSKB", value:"5031419");
  script_xref(name:"MSFT", value:"MS23-5031407");
  script_xref(name:"MSFT", value:"MS23-5031419");
  ...
  script_name(english:"KB5031407: Windows Server 2012 R2 Security Update (October 2023)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5031407. It is, therefore, affected by multiple vulnerabilities
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5031407");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5031419");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5031407 or Cumulative Update 5031419");
...
if (
  smb_check_rollup(os:'6.3',
                   ...
                   rollup_date:'10_2023',
                   bulletin:bulletin,
                   rollup_kb_list:[5031419, 5031407])
)
{
