...
# extracted from Fedora Security Advisory FEDORA-2024-f7745a5990
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-f7745a5990");

  script_name(english:"Fedora 40 : clojure (2024-f7745a5990)");
...
FEDORA-2024-f7745a5990 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-f7745a5990");
...
var pkgs = [
    {'reference':'clojure-1.11.2-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
