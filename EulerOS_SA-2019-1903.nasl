...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : java-1.7.0-openjdk (EulerOS-SA-2019-1903)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1903
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ea629bbc");
...
pkgs = ["java-1.7.0-openjdk-1.7.0.191-2.6.15.4.h6.eulerosv2r7",
        "java-1.7.0-openjdk-devel-1.7.0.191-2.6.15.4.h6.eulerosv2r7",
        "java-1.7.0-openjdk-headless-1.7.0.191-2.6.15.4.h6.eulerosv2r7"];
