...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2016/rhsa-2016_0189.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6cc7bb3b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2016:0189");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1245684");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL polkit package based on the guidance in RHSA-2016:0189.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'polkit-0.112-6.el7_2', 'cpu':'i686', 'release':'7', 'el_string':'el7_2', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-0.112-6.el7_2', 'cpu':'ppc', 'release':'7', 'el_string':'el7_2', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-0.112-6.el7_2', 'cpu':'ppc64', 'release':'7', 'el_string':'el7_2', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-0.112-6.el7_2', 'cpu':'ppc64le', 'release':'7', 'el_string':'el7_2', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-0.112-6.el7_2', 'cpu':'s390', 'release':'7', 'el_string':'el7_2', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-0.112-6.el7_2', 'cpu':'s390x', 'release':'7', 'el_string':'el7_2', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-0.112-6.el7_2', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_2', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-devel-0.112-6.el7_2', 'cpu':'i686', 'release':'7', 'el_string':'el7_2', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-devel-0.112-6.el7_2', 'cpu':'ppc', 'release':'7', 'el_string':'el7_2', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-devel-0.112-6.el7_2', 'cpu':'ppc64', 'release':'7', 'el_string':'el7_2', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-devel-0.112-6.el7_2', 'cpu':'ppc64le', 'release':'7', 'el_string':'el7_2', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-devel-0.112-6.el7_2', 'cpu':'s390', 'release':'7', 'el_string':'el7_2', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-devel-0.112-6.el7_2', 'cpu':'s390x', 'release':'7', 'el_string':'el7_2', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-devel-0.112-6.el7_2', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_2', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-docs-0.112-6.el7_2', 'release':'7', 'el_string':'el7_2', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
