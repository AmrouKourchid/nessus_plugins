...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 ESM / 22.04 LTS : Twisted vulnerability (USN-5354-2)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 16.04 ESM / 22.04 LTS host has packages installed that are affected by a vulnerability as referenced
in the USN-5354-2 advisory.

    USN-5354-1 fixed vulnerabilities in Twisted. This update provides the

    corresponding updates for Ubuntu 14.04 ESM, Ubuntu 16.04 ESM and Ubuntu 22.04 LTS.
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'python-twisted', 'pkgver': '16.0.0-1ubuntu0.4+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'python-twisted-bin', 'pkgver': '16.0.0-1ubuntu0.4+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'python-twisted-conch', 'pkgver': '1:16.0.0-1ubuntu0.4+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'python-twisted-core', 'pkgver': '16.0.0-1ubuntu0.4+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'python-twisted-mail', 'pkgver': '16.0.0-1ubuntu0.4+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'python-twisted-names', 'pkgver': '16.0.0-1ubuntu0.4+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'python-twisted-news', 'pkgver': '16.0.0-1ubuntu0.4+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'python-twisted-runner', 'pkgver': '16.0.0-1ubuntu0.4+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'python-twisted-web', 'pkgver': '16.0.0-1ubuntu0.4+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'python-twisted-words', 'pkgver': '16.0.0-1ubuntu0.4+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'python3-twisted', 'pkgver': '16.0.0-1ubuntu0.4+esm1', 'ubuntu_pro': TRUE},
    {'osver': '22.04', 'pkgname': 'python3-twisted', 'pkgver': '22.1.0-2ubuntu2.1', 'ubuntu_pro': FALSE}
];
