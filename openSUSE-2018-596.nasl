...
# extracted from openSUSE Security Update openSUSE-2018-596.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : prosody (openSUSE-2018-596)");
...
These non-security issues were fixed :
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1094890");
