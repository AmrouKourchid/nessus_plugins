...
# extracted from Fedora Security Advisory FEDORA-2019-6eeff0f801.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-6eeff0f801");

  script_name(english:"Fedora 31 : libtiff (2019-6eeff0f801)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-6eeff0f801");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"libtiff-4.0.10-7.fc31")) flag++;
