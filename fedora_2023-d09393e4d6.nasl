...
# extracted from Fedora Security Advisory FEDORA-2023-d09393e4d6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-d09393e4d6");

  script_name(english:"Fedora 38 : xen (2023-d09393e4d6)");
...
FEDORA-2023-d09393e4d6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-d09393e4d6");
...
var pkgs = [
    {'reference':'xen-4.17.1-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
