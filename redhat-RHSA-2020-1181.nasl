...
# extracted from Red Hat Security Advisory RHSA-2020:1181. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:1181");

  script_name(english:"RHEL 7 : unzip (RHSA-2020:1181)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for unzip.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_1181.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5bab9e6a");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:1181");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1727761");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL unzip package based on the guidance in RHSA-2020:1181.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:N/I:N/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:L/UI:N/S:U/C:N/I:N/A:L");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-13232");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'unzip-6.0-21.el7', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'unzip-6.0-21.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'unzip-6.0-21.el7', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'unzip-6.0-21.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
