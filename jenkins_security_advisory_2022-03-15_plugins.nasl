...
var constraints = [
  ...
  { 'max_version' : '1.5', 'plugin' : 'global-build-stats plugin', 'fixed_display' : 'See vendor advisory' },
  { 'max_version' : '0.5.2', 'plugin' : 'dbCharts plugin', 'fixed_display' : 'See vendor advisory' },
  ...
  { 'max_version' : '1.3.3', 'plugin' : 'Release Helper Plugin', 'fixed_display' : 'See vendor advisory' },
  { 'max_version' : '2.43', 'fixed_version' : '2.43.1', 'plugin' : 'Parameterized Trigger plugin' },
  { 'max_version' : '0.0.9', 'plugin' : 'List Git Branches Parameter PlugIn', 'fixed_display' : 'See vendor advisory' },
  { 'max_version' : '2.3.1', 'plugin' : 'kubernetes-cd plugin', 'fixed_display' : 'See vendor advisory' },
  { 'max_version' : '1.13', 'plugin' : 'GitLab Authentication plugin', 'fixed_display' : 'See vendor advisory' },
  { 'max_version' : '1.3', 'fixed_version' : '1.4', 'plugin' : 'Folder-based Authorization Strategy Plugin' },
  { 'max_version' : '2.4.0', 'fixed_version' : '2.4.1', 'plugin' : 'Favorite Plugin' },
  { 'max_version' : '346.', 'plugin' : 'Extended Choice Parameter Plugin', 'fixed_display' : 'See vendor advisory' },
  { 'max_version' : '1.1.10', 'plugin' : 'Environment Dashboard Plugin', 'fixed_display' : 'See vendor advisory' },
  { 'max_version' : '2.18', 'fixed_version' : '2.18.1', 'plugin' : 'Dashboard View Plugin' },
