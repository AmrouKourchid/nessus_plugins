...
# extracted from Ubuntu Security Notice USN-3531-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"3531-1");
  script_xref(name:"IAVA", value:"2018-A-0020");

  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS : Intel Microcode update (USN-3531-1)");
...
in the USN-3531-1 advisory.
    ...
    use this to expose sensitive information, including kernel memory. (CVE-2017-5715)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3531-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'intel-microcode', 'pkgver': '3.20180108.0~ubuntu14.04.2'},
    {'osver': '16.04', 'pkgname': 'intel-microcode', 'pkgver': '3.20180108.0~ubuntu16.04.2'}
];
