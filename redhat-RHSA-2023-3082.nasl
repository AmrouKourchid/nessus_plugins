...
# extracted from Red Hat Security Advisory RHSA-2023:3082. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:3082");

  script_name(english:"RHEL 8 : pcs (RHSA-2023:3082)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for pcs.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2023:3082 advisory.
    ...
    * Need a way to add a scsi fencing device to a cluster without requiring a restart of all cluster
    resources (BZ#2180706)

Tenable has extracted the preceding description block directly from the Red Hat Enterprise Linux security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_3082.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?af2a24f0");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2180700");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2180706");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:3082");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL pcs package based on the guidance in RHSA-2023:3082.");
...
var constraints = [
  {
    'repo_relative_urls': [
      'content/dist/rhel8/8.10/aarch64/highavailability/debug',
      'content/dist/rhel8/8.10/aarch64/highavailability/os',
      'content/dist/rhel8/8.10/aarch64/highavailability/source/SRPMS',
      ...
      'content/dist/rhel8/8.8/aarch64/highavailability/debug',
      'content/dist/rhel8/8.8/aarch64/highavailability/os',
      'content/dist/rhel8/8.8/aarch64/highavailability/source/SRPMS',
      ...
      'content/dist/rhel8/8.9/aarch64/highavailability/debug',
      'content/dist/rhel8/8.9/aarch64/highavailability/os',
      'content/dist/rhel8/8.9/aarch64/highavailability/source/SRPMS',
    ...
    'pkgs': [
      {'reference':'pcs-0.10.15-4.el8_8.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcs-snmp-0.10.15-4.el8_8.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
      ...
      'content/eus/rhel8/8.8/aarch64/highavailability/debug',
      'content/eus/rhel8/8.8/aarch64/highavailability/os',
      'content/eus/rhel8/8.8/aarch64/highavailability/source/SRPMS',
      ...
      'content/eus/rhel8/8.8/s390x/highavailability/debug',
      'content/eus/rhel8/8.8/s390x/highavailability/os',
      'content/eus/rhel8/8.8/s390x/highavailability/source/SRPMS',
      'content/eus/rhel8/8.8/s390x/resilientstorage/debug',
      'content/eus/rhel8/8.8/s390x/resilientstorage/os',
      'content/eus/rhel8/8.8/s390x/resilientstorage/source/SRPMS',
    ...
    'pkgs': [
      {'reference':'pcs-0.10.15-4.el8_8.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcs-snmp-0.10.15-4.el8_8.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
