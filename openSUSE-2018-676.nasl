...
# extracted from openSUSE Security Update openSUSE-2018-676.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : MozillaFirefox (openSUSE-2018-676)");
...
if ( rpm_check(release:"SUSE42.3", reference:"MozillaFirefox-60.1.0-106.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"MozillaFirefox-branding-upstream-60.1.0-106.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"MozillaFirefox-buildsymbols-60.1.0-106.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"MozillaFirefox-debuginfo-60.1.0-106.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"MozillaFirefox-debugsource-60.1.0-106.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"MozillaFirefox-devel-60.1.0-106.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"MozillaFirefox-translations-common-60.1.0-106.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"MozillaFirefox-translations-other-60.1.0-106.1") ) flag++;
