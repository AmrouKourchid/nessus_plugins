...
vulnerabilities as referenced in the SUSE-SU-2022:3370-1 advisory.
...
"Update the affected kernel-livepatch-5_14_21-150400_22-default and / or kgraft-patch-4_12_14-122_88-default packages.");
...
var pkgs = [
    {'reference':'kernel-livepatch-5_14_21-150400_22-default-6-150400.4.15.3', 'sp':'4', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.4']},
    {'reference':'kernel-livepatch-5_14_21-150400_22-default-6-150400.4.15.3', 'sp':'4', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.4', 'sle-module-live-patching-release-15.4', 'sles-release-15.4']},
