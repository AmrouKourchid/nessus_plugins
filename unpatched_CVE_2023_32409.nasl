...
if (description)
{
  ...
  script_cve_id("CVE-2023-32409");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2023/06/12");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2023-32409");
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-32409");
