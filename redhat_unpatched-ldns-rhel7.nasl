...
# extracted from Red Hat Security Advisory ldns. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2017-1000231", "CVE-2020-19860");

  script_name(english:"RHEL 7 : ldns (Unpatched Vulnerability) (deprecated)");
...
"This plugin has been deprecated as it does not adhere to established standards for this style of check.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-1000231");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:ldns");
