...
"The remote Red Hat host is missing a security update for ceph-iscsi-cli.");
...
the RHSA-2018:2837 advisory.

    ceph-iscsi-cli provides a CLI interface similar to the targetcli tool used to interact with the kernel LIO
    subsystem.

    Security Fix(es):

    * It was found that rbd-target-api service provided by ceph-iscsi-cli was running in debug mode. An
    unauthenticated attacker could use this to remotely execute arbitrary code and escalate privileges.
    (CVE-2018-14649)
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_2837.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9e926bc6");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1632078");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL ceph-iscsi-cli package based on the guidance in RHSA-2018:2837.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ceph-iscsi-cli-2.0-7.el7cp', 'release':'7', 'el_string':'el7cp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ceph-mon-'}
    ]
  }
];
