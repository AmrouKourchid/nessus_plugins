...
# Oracle Linux Security Advisory ELSA-2007-0674 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : Moderate: / perl-Net-DNS (ELSA-2007-0674)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2007-0674.html");
...
"Update the affected perl-Net-DNS package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2007-3377");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2007-3409");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:perl-Net-DNS");
...
var pkgs = [
    {'reference':'perl-Net-DNS-0.59-3.el5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'perl-Net-DNS-0.59-3.el5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
