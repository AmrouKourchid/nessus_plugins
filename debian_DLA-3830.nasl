...
# extracted from Debian Security Advisory dla-3830. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3830 : libvpx-dev - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3830
advisory.

    - -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3830-1                debian-lts@lists.debian.org
    https://www.debian.org/lts/security/                          Adrian Bunk
    June 16, 2024                                 https://wiki.debian.org/LTS
    - -------------------------------------------------------------------------

    Package        : libvpx
    Version        : 1.7.0-3+deb10u3
    CVE ID         : CVE-2024-5197

    Integer overflows have been fixed in libvpx, a library for decoding and
    encoding VP8 and VP9 videos.
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libvpx-dev', 'reference': '1.7.0-3+deb10u3'},
    {'release': '10.0', 'prefix': 'libvpx-doc', 'reference': '1.7.0-3+deb10u3'},
    {'release': '10.0', 'prefix': 'libvpx5', 'reference': '1.7.0-3+deb10u3'},
    {'release': '10.0', 'prefix': 'vpx-tools', 'reference': '1.7.0-3+deb10u3'}
];
