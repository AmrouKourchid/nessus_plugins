...
# extracted from Red Hat Security Advisory RHSA-2022:8011. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:8011");

  script_name(english:"RHEL 9 : fribidi (RHSA-2022:8011)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for fribidi.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2022:8011 advisory.

    FriBidi is a library to handle bidirectional scripts (for example Hebrew, Arabic), so that the display is
    done in the proper way, while the text data itself is always written in logical order.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8011.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f0222146");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8011");
...
"Update the RHEL fribidi package based on the guidance in RHSA-2022:8011.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'fribidi-1.0.10-6.el9.2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fribidi-devel-1.0.10-6.el9.2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
