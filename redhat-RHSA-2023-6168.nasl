...
# extracted from Red Hat Security Advisory RHSA-2023:6168. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:6168");

  script_name(english:"RHEL 9 : libguestfs-winsupport (RHSA-2023:6168)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6168.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?caefd654");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2236130");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6168");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libguestfs-winsupport package based on the guidance in RHSA-2023:6168.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libguestfs-winsupport-9.0-2.el9_0', 'sp':'0', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libguestfs-winsupport-9.0-2.el9_0', 'sp':'0', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libguestfs-winsupport-9.0-2.el9_0', 'sp':'0', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
