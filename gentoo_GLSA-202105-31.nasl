...
# extracted from Gentoo Linux Security Advisory GLSA 202105-31.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202105-31");

  script_name(english:"GLSA-202105-31 : Nettle: Denial of service");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202105-31
...
if (qpkg_check(package:"dev-libs/nettle", unaffected:make_list("ge 3.7.2"), vulnerable:make_list("lt 3.7.2"))) flag++;
