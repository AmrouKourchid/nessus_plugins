...
if (description)
{
  ...
  script_name(english:"Adobe Digital Editions < 4.5.3 Multiple Vulnerabilities (APSB16-45) (macOS)");
...
"The version of Adobe Digital Editions installed on the remote macOS host is prior to 4.5.3. It is, therefore, affected
by multiple vulnerabilities as referenced in the APSB16-45 advisory.

  - Adobe Digital Editions versions 4.5.2 and earlier has an issue with parsing crafted XML entries that could
    lead to information disclosure. (CVE-2016-7889)

  - Adobe Digital Editions versions 4.5.2 and earlier has an important vulnerability that could lead to memory
    address leak. (CVE-2016-7888)
...
"Upgrade to Adobe Digital Editions version 4.5.3 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-7889");
