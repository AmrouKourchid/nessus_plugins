...
# extracted from Red Hat Security Advisory RHSA-2025:1681. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:1681");

  script_name(english:"RHEL 9 : bind (RHSA-2025:1681)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_1681.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4d9d7cd8");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:1681");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL bind package based on the guidance in RHSA-2025:1681.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'bind-9.16.23-24.el9_5.3', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-chroot-9.16.23-24.el9_5.3', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-devel-9.16.23-24.el9_5.3', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-dnssec-doc-9.16.23-24.el9_5.3', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-dnssec-utils-9.16.23-24.el9_5.3', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-doc-9.16.23-24.el9_5.3', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-libs-9.16.23-24.el9_5.3', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-license-9.16.23-24.el9_5.3', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-utils-9.16.23-24.el9_5.3', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'python3-bind-9.16.23-24.el9_5.3', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'}
    ]
  }
];
