...
# extracted from Red Hat Security Advisory RHSA-2022:0540. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:0540");
  ...
  script_name(english:"RHEL 8 : Red Hat Virtualization Host security update [ovirt-4.4.10-1] (Important) (RHSA-2022:0540)");
...
referenced in the RHSA-2022:0540 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_0540.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f2fea724");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:0540");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2025869");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2030082");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2034685");
...
"Update the RHEL Red Hat Virtualization Host package based on the guidance in RHSA-2022:0540.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'redhat-virtualization-host-image-update-4.4.10-202202081536_8.5', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'}
    ]
  }
];
