...
# SUSE update advisory SUSE-SU-2024:4180-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2024:4180-1");

  script_name(english:"SUSE SLES15 Security Update : kernel (Live Patch 44 for SLE 15 SP3) (SUSE-SU-2024:4180-1)");
...
the SUSE-SU-2024:4180-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2024-December/019918.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c3e2f7dc");
...
var kernel_live_checks = [
  {
    'kernels': {
      '5.3.18-150300.59.161-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_3_18-150300_59_161-default-8-150300.7.6.1', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.3']}
        ]
      }
    }
  }
