...
# extracted from Fedora Security Advisory FEDORA-2025-603b975ee6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-603b975ee6");

  script_name(english:"Fedora 40 : java-11-openjdk (2025-603b975ee6)");
...
FEDORA-2025-603b975ee6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-603b975ee6");
...
var pkgs = [
    {'reference':'java-11-openjdk-11.0.26.0.4-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
