...
# extracted from Red Hat Security Advisory RHSA-2005:035. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2005:035");

  script_name(english:"RHEL 4 : libtiff (RHSA-2005:035)");
...
referenced in the RHSA-2005:035 advisory.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2005/rhsa-2005_035.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ac58fa04");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=144185");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=144186");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2005:035");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libtiff package based on the guidance in RHSA-2005:035.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:N/UI:R/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2004-1308");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2004-1183");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libtiff-3.6.1-8', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libtiff-3.6.1-8', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libtiff-3.6.1-8', 'cpu':'ppc64', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libtiff-3.6.1-8', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libtiff-3.6.1-8', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libtiff-3.6.1-8', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libtiff-devel-3.6.1-8', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libtiff-devel-3.6.1-8', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libtiff-devel-3.6.1-8', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libtiff-devel-3.6.1-8', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libtiff-devel-3.6.1-8', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
