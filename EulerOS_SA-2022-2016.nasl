...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : zlib (EulerOS-SA-2022-2016)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the zlib package installed, the EulerOS installation on the remote host is affected by the
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2016
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4bf37222");
...
var pkgs = [
  "zlib-1.2.11-17.h1.r2.eulerosv2r9"
];
