...
if (description)
{
  ...
  script_cve_id("CVE-2019-14494", "CVE-2020-27778");
  script_xref(name:"IAVB", value:"2019-B-0064-S");

  script_name(english:"NewStart CGSL MAIN 6.02 : poppler Multiple Vulnerabilities (NS-SA-2022-0093)");

  script_set_attribute(attribute:"synopsis", value:
"The remote NewStart CGSL host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 6.02, has poppler packages installed that are affected by multiple
vulnerabilities:
...
var pkgs = {
  'CGSL MAIN 6.02': [
    'poppler-20.11.0-3.el8_5.1',
    'poppler-glib-20.11.0-3.el8_5.1',
    'poppler-utils-20.11.0-3.el8_5.1'
  ]
};
