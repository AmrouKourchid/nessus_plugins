...
if (description)
{
  ...
  script_bugtraq_id(91108, 91109, 91110);
  script_xref(name:"MSFT", value:"MS16-069");
  script_xref(name:"MSKB", value:"3158363");
  script_xref(name:"MSKB", value:"3158364");
...
in the context of the current user.");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2016/ms16-069");
...
the vendor advisory.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-3207");
