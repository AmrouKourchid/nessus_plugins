...
# Oracle Linux Security Advisory ELSA-2014-1764 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 / 7 : wget (ELSA-2014-1764)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2014-1764.html");
