...
# extracted from Fedora Security Advisory FEDORA-2020-85fa9f07f4.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-85fa9f07f4");

  script_name(english:"Fedora 30 : pure-ftpd (2020-85fa9f07f4)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-85fa9f07f4");
...
"Update the affected pure-ftpd package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-20176");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"pure-ftpd-1.0.49-3.fc30")) flag++;
