...
# SUSE update advisory SUSE-SU-2021:1952-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2021:1952-1");

  script_name(english:"SUSE SLES12 Security Update : csync2 (SUSE-SU-2021:1952-1)");
...
the SUSE-SU-2021:1952-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2021-June/008993.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2f70a210");
...
var pkgs = [
    {'reference':'csync2-2.0+git.1368794815.cf835a7-3.9', 'sp':'3', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-ha-release-12.3', 'sle-ha-release-12.4', 'sle-ha-release-12.5']},
    {'reference':'csync2-2.0+git.1368794815.cf835a7-3.9', 'sp':'4', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-ha-release-12.3', 'sle-ha-release-12.4', 'sle-ha-release-12.5']},
    {'reference':'csync2-2.0+git.1368794815.cf835a7-3.9', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-ha-release-12.3', 'sle-ha-release-12.4', 'sle-ha-release-12.5']}
];
