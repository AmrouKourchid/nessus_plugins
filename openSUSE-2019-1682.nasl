...
Version 7.6.0 :
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1084909");
...
if ( rpm_check(release:"SUSE15.1", reference:"libheimdal-7.7.0-lp151.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libheimdal-debuginfo-7.7.0-lp151.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libheimdal-debugsource-7.7.0-lp151.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libheimdal-devel-7.7.0-lp151.3.3.1") ) flag++;
