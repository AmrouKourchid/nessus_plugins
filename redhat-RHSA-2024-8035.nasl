...
# extracted from Red Hat Security Advisory RHSA-2024:8035. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:8035");

  script_name(english:"RHEL 8 : python3.11-urllib3 (RHSA-2024:8035)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_8035.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c65a81bd");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:8035");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python3.11-urllib3 package based on the guidance in RHSA-2024:8035.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3.11-urllib3-1.26.12-1.el8_8.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
