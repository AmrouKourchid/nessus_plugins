...
if (description)
{
  ...
  script_name(english:"HCLTech Domino SEoL (10.0.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of HCLTech Domino is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, HCLTech Domino is 10.0.x. It is, therefore, no longer maintained by its vendor or provider.

Lack of support implies that no new security patches for the product will be released by the vendor. As a result, it may
contain security vulnerabilities.");
  # https://support.hcltechsw.com/csm?id=kb_article&sysparm_article=KB0099055
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2229bce2");
...
"Upgrade to a version of HCLTech Domino that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2024/06/01");
...
var constraints = [
  { max_branch : '10.0', min_branch : '10.0', seol : 20240601 }
];
