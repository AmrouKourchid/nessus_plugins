...
# extracted from ZTE advisory NS-SA-2023-0100. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 6.06 : gnutls Multiple Vulnerabilities (NS-SA-2023-0100)");

  script_set_attribute(attribute:"synopsis", value:
"The remote NewStart CGSL host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 6.06, has gnutls packages installed that are affected by multiple
vulnerabilities:
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/notice/NS-SA-2023-0100");
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/info/CVE-2020-24659");
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/info/CVE-2021-20231");
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/info/CVE-2021-20232");
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/info/CVE-2022-2509");
...
var pkgs = {
  'CGSL MAIN 6.06': [
    'gnutls-3.6.16-5.0.1.zncgsl6_6',
    'gnutls-dane-3.6.16-5.0.1.zncgsl6_6',
    'gnutls-utils-3.6.16-5.0.1.zncgsl6_6'
  ]
};
