...
if (description)
{
  ...
  script_cve_id("CVE-2023-26257");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2023-26257");
...
patch available.
  ...
  - An issue was discovered in the Connected Vehicle Systems Alliance (COVESA; formerly GENIVI) dlt-daemon
    through 2.18.8. Dynamic memory is not released after it is allocated in dlt-control-common.c.
    (CVE-2023-26257)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-26257");
