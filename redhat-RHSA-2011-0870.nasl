...
# extracted from Red Hat Security Advisory RHSA-2011:0870. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2011:0870");

  script_name(english:"RHEL 5 : java-1.4.2-ibm-sap (RHSA-2011:0870)");
...
referenced in the RHSA-2011:0870 advisory.
...
number.");
  ...
  # https://access.redhat.com/security/data/csaf/v2/advisories/2011/rhsa-2011_0870.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?29df6b7c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2011:0870");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL java-1.4.2-ibm-sap package based on the guidance in RHSA-2011:0870.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'java-1.4.2-ibm-sap-1.4.2.13.9.sap-1jpp.1.el5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'java-1.4.2-ibm-sap-demo-1.4.2.13.9.sap-1jpp.1.el5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'java-1.4.2-ibm-sap-devel-1.4.2.13.9.sap-1jpp.1.el5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'java-1.4.2-ibm-sap-javacomm-1.4.2.13.9.sap-1jpp.1.el5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'java-1.4.2-ibm-sap-src-1.4.2.13.9.sap-1jpp.1.el5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
