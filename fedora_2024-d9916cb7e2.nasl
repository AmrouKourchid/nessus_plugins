...
# extracted from Fedora Security Advisory FEDORA-2024-d9916cb7e2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-d9916cb7e2");

  script_name(english:"Fedora 39 : chromium (2024-d9916cb7e2)");
...
FEDORA-2024-d9916cb7e2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-d9916cb7e2");
...
var pkgs = [
    {'reference':'chromium-126.0.6478.182-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
