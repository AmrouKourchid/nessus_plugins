...
# extracted from openSUSE Security Update openSUSE-2021-55.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : crmsh (openSUSE-2021-55)");
...
if ( rpm_check(release:"SUSE15.2", reference:"crmsh-4.2.0+git.1607075079.a25648d8-lp152.4.39.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"crmsh-scripts-4.2.0+git.1607075079.a25648d8-lp152.4.39.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"crmsh-test-4.2.0+git.1607075079.a25648d8-lp152.4.39.1") ) flag++;
