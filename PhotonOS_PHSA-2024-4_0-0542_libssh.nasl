...
# extracted from VMware Security Advisory PHSA-2024-4.0-0542. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Libssh PHSA-2024-4.0-0542");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the libssh package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-542.md");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:vmware:photonos:libssh");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libssh-0.10.6-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', reference:'libssh-config-0.10.6-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libssh-devel-0.10.6-1.ph4')) flag++;
