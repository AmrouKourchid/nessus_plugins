...
# extracted from openSUSE Security Update openSUSE-2019-1750.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : dbus-1 (openSUSE-2019-1750)");
...
Security issue fixed:&#9; 
  ...
  - CVE-2019-12749: Fixed an implementation flaw in
    ...
    update was imported from the SUSE:SLE-15-SP1:Update
    update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1137832");
...
if ( rpm_check(release:"SUSE15.1", reference:"dbus-1-1.12.2-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"dbus-1-debuginfo-1.12.2-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"dbus-1-debugsource-1.12.2-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"dbus-1-devel-1.12.2-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"dbus-1-x11-1.12.2-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"dbus-1-x11-debuginfo-1.12.2-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"dbus-1-x11-debugsource-1.12.2-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libdbus-1-3-1.12.2-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libdbus-1-3-debuginfo-1.12.2-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"dbus-1-32bit-debuginfo-1.12.2-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"dbus-1-devel-32bit-1.12.2-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libdbus-1-3-32bit-1.12.2-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libdbus-1-3-32bit-debuginfo-1.12.2-lp151.4.3.1") ) flag++;
