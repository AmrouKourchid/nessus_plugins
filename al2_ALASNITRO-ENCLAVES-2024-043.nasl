...
# extracted from Amazon Linux 2 Security Advisory ALASNITRO-ENCLAVES-2024-043.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : oci-add-hooks (ALASNITRO-ENCLAVES-2024-043)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of oci-add-hooks installed on the remote host is prior to 0-0.2.20200504git325a340. It is, therefore,
affected by a vulnerability as referenced in the ALAS2NITRO-ENCLAVES-2024-043 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALASNITRO-ENCLAVES-2024-043.html");
...
"Run 'yum update oci-add-hooks' to update your system.");
...
var pkgs = [
    {'reference':'oci-add-hooks-0-0.2.20200504git325a340.amzn2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'oci-add-hooks-0-0.2.20200504git325a340.amzn2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'oci-add-hooks-debuginfo-0-0.2.20200504git325a340.amzn2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'oci-add-hooks-debuginfo-0-0.2.20200504git325a340.amzn2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "oci-add-hooks / oci-add-hooks-debuginfo");
}
