...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.0 : kernel (EulerOS-SA-2024-1527)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1527
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?08c265f1");
...
var pkgs = [
  "kernel-4.18.0-147.5.2.19.h1436.eulerosv2r10",
  "kernel-abi-stablelists-4.18.0-147.5.2.19.h1436.eulerosv2r10",
  "kernel-tools-4.18.0-147.5.2.19.h1436.eulerosv2r10",
  "kernel-tools-libs-4.18.0-147.5.2.19.h1436.eulerosv2r10",
  "python3-perf-4.18.0-147.5.2.19.h1436.eulerosv2r10"
];
