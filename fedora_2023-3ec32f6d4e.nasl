...
# extracted from Fedora Security Advisory FEDORA-2023-3ec32f6d4e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-3ec32f6d4e");

  script_name(english:"Fedora 36 : rust-bat / rust-cargo-c / rust-exa / rust-git-delta / rust-gitui / etc (2023-3ec32f6d4e)");
...
FEDORA-2023-3ec32f6d4e advisory.

    This update contains rebuilds of all Rust applications against versions of the libgit2-sys crate that ship
    fixes for CVE-2022-24765 and CVE-2022-29187 in the bundled copies of libgit2.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-3ec32f6d4e");
...
var pkgs = [
    {'reference':'rust-bat-0.21.0-6.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-cargo-c-0.9.12-3.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-exa-0.10.1-9.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-git-delta-0.13.0-4.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-gitui-0.20.1-6.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-pore-0.1.8-2.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-pretty-git-prompt-0.2.1-15.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-rd-agent-2.1.2-7.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-rd-hashd-2.1.2-7.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-resctl-bench-2.1.2-8.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-resctl-demo-2.1.2-8.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-silver-2.0.1-4.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-tokei-12.1.2-4.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'rust-bat / rust-cargo-c / rust-exa / rust-git-delta / rust-gitui / etc');
}
