...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.2.0 : PyYAML (EulerOS-SA-2019-1615)");
...
by the following vulnerability :
  ...
  - In PyYAML before 4.1, the yaml.load() API could execute
    ...
    used.i1/4^CVE-2017-18342i1/4%0

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1615
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b4b0ce17");
