...
if (description)
{
  ...
  script_name(english:"CentOS 7 : thunderbird (RHSA-2022:5480)");
...
var pkgs = [
    {'reference':'thunderbird-91.11.0-2.el7.centos', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
