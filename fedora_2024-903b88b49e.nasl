...
# extracted from Fedora Security Advisory FEDORA-2024-903b88b49e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-903b88b49e");

  script_name(english:"Fedora 39 : qt6-qtbase (2024-903b88b49e)");
...
FEDORA-2024-903b88b49e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-903b88b49e");
  script_set_attribute(attribute:"solution", value:
"Update the affected qt6-qtbase package.");
...
var pkgs = [
    {'reference':'qt6-qtbase-6.6.2-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'qt6-qtbase');
}
