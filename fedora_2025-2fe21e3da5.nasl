...
# extracted from Fedora Security Advisory FEDORA-2025-2fe21e3da5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-2fe21e3da5");

  script_name(english:"Fedora 40 : kitty (2025-2fe21e3da5)");
...
FEDORA-2025-2fe21e3da5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-2fe21e3da5");
...
var pkgs = [
    {'reference':'kitty-0.40.0-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
