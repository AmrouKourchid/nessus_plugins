...
USN-3243-1 advisory.
    ...
    It was discovered that Git incorrectly sanitized branch names in the PS1 variable when configured to
    display the repository status in the shell prompt. If a user were tricked into exploring a malicious
    repository, a remote attacker could use this issue to execute arbitrary code.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3243-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'git', 'pkgver': '1:1.9.1-1ubuntu0.4'},
    {'osver': '14.04', 'pkgname': 'git-all', 'pkgver': '1:1.9.1-1ubuntu0.4'},
    {'osver': '14.04', 'pkgname': 'git-arch', 'pkgver': '1:1.9.1-1ubuntu0.4'},
    {'osver': '14.04', 'pkgname': 'git-bzr', 'pkgver': '1:1.9.1-1ubuntu0.4'},
    {'osver': '14.04', 'pkgname': 'git-core', 'pkgver': '1:1.9.1-1ubuntu0.4'},
    {'osver': '14.04', 'pkgname': 'git-cvs', 'pkgver': '1:1.9.1-1ubuntu0.4'},
    {'osver': '14.04', 'pkgname': 'git-daemon-run', 'pkgver': '1:1.9.1-1ubuntu0.4'},
    {'osver': '14.04', 'pkgname': 'git-daemon-sysvinit', 'pkgver': '1:1.9.1-1ubuntu0.4'},
    {'osver': '14.04', 'pkgname': 'git-el', 'pkgver': '1:1.9.1-1ubuntu0.4'},
    {'osver': '14.04', 'pkgname': 'git-email', 'pkgver': '1:1.9.1-1ubuntu0.4'},
    {'osver': '14.04', 'pkgname': 'git-gui', 'pkgver': '1:1.9.1-1ubuntu0.4'},
    {'osver': '14.04', 'pkgname': 'git-man', 'pkgver': '1:1.9.1-1ubuntu0.4'},
    {'osver': '14.04', 'pkgname': 'git-mediawiki', 'pkgver': '1:1.9.1-1ubuntu0.4'},
    {'osver': '14.04', 'pkgname': 'git-svn', 'pkgver': '1:1.9.1-1ubuntu0.4'},
    {'osver': '14.04', 'pkgname': 'gitk', 'pkgver': '1:1.9.1-1ubuntu0.4'},
    {'osver': '14.04', 'pkgname': 'gitweb', 'pkgver': '1:1.9.1-1ubuntu0.4'}
];
