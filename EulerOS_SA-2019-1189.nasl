...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.4 : kernel (EulerOS-SA-2019-1189)");
...
the following vulnerability :
  ...
  - An information leak was discovered in the Linux kernel
    ...
    location.i1/4^CVE-2018-16658i1/4%0

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1189
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?34ea33e7");
...
pkgs = ["kernel-3.10.0-862.14.1.1_39",
        "kernel-devel-3.10.0-862.14.1.1_39",
        "kernel-headers-3.10.0-862.14.1.1_39",
        "kernel-tools-3.10.0-862.14.1.1_39",
        "kernel-tools-libs-3.10.0-862.14.1.1_39",
        "kernel-tools-libs-devel-3.10.0-862.14.1.1_39"];
