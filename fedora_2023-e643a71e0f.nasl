...
# extracted from Fedora Security Advisory FEDORA-2023-e643a71e0f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-e643a71e0f");

  script_name(english:"Fedora 37 : java-11-openjdk (2023-e643a71e0f)");
...
FEDORA-2023-e643a71e0f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-e643a71e0f");
...
var pkgs = [
    {'reference':'java-11-openjdk-11.0.20.0.8-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
