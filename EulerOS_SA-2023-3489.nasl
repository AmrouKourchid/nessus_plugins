...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : bind (EulerOS-SA-2023-3489)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3489
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?294bbacb");
...
var pkgs = [
  "bind-9.11.21-4.h24.eulerosv2r10",
  "bind-chroot-9.11.21-4.h24.eulerosv2r10",
  "bind-export-libs-9.11.21-4.h24.eulerosv2r10",
  "bind-libs-9.11.21-4.h24.eulerosv2r10",
  "bind-libs-lite-9.11.21-4.h24.eulerosv2r10",
  "bind-pkcs11-9.11.21-4.h24.eulerosv2r10",
  "bind-utils-9.11.21-4.h24.eulerosv2r10",
  "python3-bind-9.11.21-4.h24.eulerosv2r10"
];
