...
# extracted from Gentoo Linux Security Advisory GLSA 201903-18.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201903-18");

  script_name(english:"GLSA-201903-18 : GD: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-201903-18
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/201903-18");
...
if (qpkg_check(package:"media-libs/gd", unaffected:make_list("ge 2.2.5-r2"), vulnerable:make_list("lt 2.2.5-r2"))) flag++;
