...
# extracted from Fedora Security Advisory FEDORA-2018-07083800ac.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2018-15909");
  script_xref(name:"FEDORA", value:"2018-07083800ac");

  script_name(english:"Fedora 28 : ghostscript (2018-07083800ac)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-07083800ac");
...
"Update the affected ghostscript package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-15909");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"ghostscript-9.23-6.fc28")) flag++;
