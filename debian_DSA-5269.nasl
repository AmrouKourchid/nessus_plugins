...
# extracted from Debian Security Advisory dsa-5269. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-5269-1 : pypy3 - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has packages installed that are affected by a vulnerability as referenced in the dsa-5269
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2022/dsa-5269");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'pypy3', 'reference': '7.3.5+dfsg-2+deb11u2'},
    {'release': '11.0', 'prefix': 'pypy3-dev', 'reference': '7.3.5+dfsg-2+deb11u2'},
    {'release': '11.0', 'prefix': 'pypy3-doc', 'reference': '7.3.5+dfsg-2+deb11u2'},
    {'release': '11.0', 'prefix': 'pypy3-lib', 'reference': '7.3.5+dfsg-2+deb11u2'},
    {'release': '11.0', 'prefix': 'pypy3-lib-testsuite', 'reference': '7.3.5+dfsg-2+deb11u2'},
    {'release': '11.0', 'prefix': 'pypy3-tk', 'reference': '7.3.5+dfsg-2+deb11u2'}
];
