...
# extracted from Fedora Security Advisory FEDORA-2024-94f6f1b500
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-94f6f1b500");

  script_name(english:"Fedora 39 : seamonkey (2024-94f6f1b500)");
...
FEDORA-2024-94f6f1b500 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-94f6f1b500");
...
var pkgs = [
    {'reference':'seamonkey-2.53.19-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
