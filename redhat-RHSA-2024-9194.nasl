...
# extracted from Red Hat Security Advisory RHSA-2024:9194. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:9194");

  script_name(english:"RHEL 9 : python3.11-PyMySQL (RHSA-2024:9194)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for python3.11-PyMySQL.");
...
the RHSA-2024:9194 advisory.

    This package contains a pure-Python MySQL client library. The goal of PyMySQL is to be a drop-in
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2282821");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_9194.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d7929a7b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:9194");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python3.11-PyMySQL package based on the guidance in RHSA-2024:9194.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:python3.11-PyMySQL");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:python3.11-PyMySQL+rsa");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3.11-PyMySQL+rsa-1.0.2-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.11-PyMySQL-1.0.2-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python3.11-PyMySQL / python3.11-PyMySQL+rsa');
}
