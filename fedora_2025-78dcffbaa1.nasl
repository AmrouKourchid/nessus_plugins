...
# extracted from Fedora Security Advisory FEDORA-2025-78dcffbaa1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-78dcffbaa1");

  script_name(english:"Fedora 40 : dotnet9.0 (2025-78dcffbaa1)");
...
FEDORA-2025-78dcffbaa1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-78dcffbaa1");
...
var pkgs = [
    {'reference':'dotnet9.0-9.0.104-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
