...
if (description)
{
  ...
  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2009-3546");
...
patch available.
  ...
  - The _gdGetColors function in gd_gd.c in PHP 5.2.11 and 5.3.x before 5.3.1, and the GD Graphics Library
    ...
    than CVE-2009-3293. NOTE: some of these details are obtained from third party information. (CVE-2009-3546)
