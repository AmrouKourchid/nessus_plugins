...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : docker-engine (EulerOS-SA-2025-1119)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1119
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e9a6a06c");
...
var pkgs = [
  "docker-engine-18.09.0.101-1.h74.28.24.eulerosv2r8",
  "docker-engine-selinux-18.09.0.101-1.h74.28.24.eulerosv2r8"
];
