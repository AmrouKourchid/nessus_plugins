...
# Red Hat Security Advisory RHSA-2023:0050. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:0050");

  script_name(english:"CentOS 8 : nodejs:14 (CESA-2023:0050)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
CESA-2023:0050 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:0050");
...
var appstreams = {
    'nodejs:14': [
      {'reference':'nodejs-14.21.1-2.module_el8.7.0+1235+834c02a1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nodejs-14.21.1-2.module_el8.7.0+1235+834c02a1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nodejs-devel-14.21.1-2.module_el8.7.0+1235+834c02a1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nodejs-devel-14.21.1-2.module_el8.7.0+1235+834c02a1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nodejs-docs-14.21.1-2.module_el8.7.0+1235+834c02a1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nodejs-docs-14.21.1-2.module_el8.7.0+1235+834c02a1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nodejs-full-i18n-14.21.1-2.module_el8.7.0+1235+834c02a1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nodejs-full-i18n-14.21.1-2.module_el8.7.0+1235+834c02a1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'npm-6.14.17-1.14.21.1.2.module_el8.7.0+1235+834c02a1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'npm-6.14.17-1.14.21.1.2.module_el8.7.0+1235+834c02a1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
};
