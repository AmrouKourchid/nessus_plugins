...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Nss PHSA-2019-2.0-0164");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'nss-3.44-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'nss-debuginfo-3.44-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'nss-devel-3.44-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'nss-libs-3.44-1.ph2')) flag++;
