...
# extracted from Fedora Security Advisory FEDORA-2024-15b892ebd3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-15b892ebd3");

  script_name(english:"Fedora 38 : thunderbird (2024-15b892ebd3)");
...
FEDORA-2024-15b892ebd3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-15b892ebd3");
...
var pkgs = [
    {'reference':'thunderbird-115.10.1-4.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
