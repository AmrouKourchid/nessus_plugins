...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Unzip PHSA-2024-5.0-0424");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2016-9844");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'unzip-6.0-18.ph5')) flag++;
