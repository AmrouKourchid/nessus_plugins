...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : speex (EulerOS-SA-2022-1552)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the speex package installed, the EulerOS installation on the remote host is affected by the
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1552
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a409546f");
  script_set_attribute(attribute:"solution", value:
"Update the affected speex packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:speex");
...
var pkgs = [
  "speex-1.2-0.19.rc1.h1.eulerosv2r7"
];
