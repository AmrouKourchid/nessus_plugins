...
"The remote Red Hat host is missing a security update for OpenShift Container Platform 4.1.41.");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f3512b01");
...
"Update the RHEL OpenShift Container Platform 4.1.41 package based on the guidance in RHSA-2020:1449.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'podman-1.0.2-4.dev.git96ccc2e.rhaos4.1.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'podman-docker-1.0.2-4.dev.git96ccc2e.rhaos4.1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
