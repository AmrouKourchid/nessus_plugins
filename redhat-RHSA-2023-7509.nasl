...
# extracted from Red Hat Security Advisory RHSA-2023:7509. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:7509");
  script_xref(name:"IAVA", value:"2023-A-0654-S");

  script_name(english:"RHEL 7 : firefox (RHSA-2023:7509)");
...
referenced in the RHSA-2023:7509 advisory.
    ...
    * Mozilla: Memory safety bugs fixed in Firefox 120, Firefox ESR 115.5, and Thunderbird 115.5
    (CVE-2023-6212)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_7509.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d63f9113");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:7509");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL firefox package based on the guidance in RHSA-2023:7509.");
  ...
  script_cwe_id(22, 120, 125, 416, 1021);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-115.5.0-1.el7_9', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-115.5.0-1.el7_9', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-115.5.0-1.el7_9', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-115.5.0-1.el7_9', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-115.5.0-1.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
