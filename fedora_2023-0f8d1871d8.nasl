...
# extracted from Fedora Security Advisory FEDORA-2023-0f8d1871d8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-0f8d1871d8");
  script_xref(name:"CEA-ID", value:"CEA-2023-0052");
  script_xref(name:"IAVA", value:"2023-A-0531-S");

  script_name(english:"Fedora 39 : curl (2023-0f8d1871d8)");
...
FEDORA-2023-0f8d1871d8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-0f8d1871d8");
...
var pkgs = [
    {'reference':'curl-8.2.1-3.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
