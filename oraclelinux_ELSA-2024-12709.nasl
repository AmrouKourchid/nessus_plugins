...
# extracted from Oracle Linux Security Advisory ELSA-2024-12709.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : python-urllib3 (ELSA-2024-12709)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-12709.html");
...
var pkgs = [
    {'reference':'python-urllib3-1.10.2-7.0.1.el7', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
];
