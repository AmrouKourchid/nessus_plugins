...
# extracted from openSUSE Security Update openSUSE-2019-2183.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libreoffice (openSUSE-2019-2183)");
...
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-base-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-base-debuginfo-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-base-drivers-firebird-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-base-drivers-firebird-debuginfo-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-base-drivers-postgresql-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-base-drivers-postgresql-debuginfo-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-branding-upstream-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-calc-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-calc-debuginfo-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-calc-extensions-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-debuginfo-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-debugsource-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-draw-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-draw-debuginfo-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-filters-optional-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-gdb-pretty-printers-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-glade-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-gnome-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-gnome-debuginfo-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-gtk2-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-gtk2-debuginfo-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-gtk3-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-gtk3-debuginfo-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-icon-themes-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-impress-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-impress-debuginfo-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-af-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-am-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-ar-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-as-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-ast-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-be-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-bg-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-bn-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-bn_IN-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-bo-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-br-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-brx-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-bs-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-ca-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-ca_valencia-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-cs-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-cy-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-da-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-de-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-dgo-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-dsb-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-dz-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-el-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-en-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-en_GB-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-en_ZA-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-eo-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-es-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-et-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-eu-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-fa-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-fi-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-fr-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-fy-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-ga-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-gd-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-gl-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-gu-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-gug-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-he-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-hi-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-hr-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-hsb-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-hu-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-id-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-is-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-it-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-ja-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-ka-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-kab-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-kk-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-km-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-kmr_Latn-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-kn-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-ko-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-kok-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-ks-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-lb-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-lo-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-lt-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-lv-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-mai-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-mk-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-ml-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-mn-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-mni-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-mr-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-my-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-nb-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-ne-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-nl-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-nn-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-nr-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-nso-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-oc-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-om-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-or-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-pa-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-pl-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-pt_BR-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-pt_PT-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-ro-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-ru-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-rw-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-sa_IN-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-sat-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-sd-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-si-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-sid-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-sk-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-sl-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-sq-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-sr-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-ss-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-st-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-sv-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-sw_TZ-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-ta-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-te-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-tg-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-th-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-tn-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-tr-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-ts-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-tt-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-ug-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-uk-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-uz-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-ve-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-vec-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-vi-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-xh-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-zh_CN-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-zh_TW-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-l10n-zu-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-mailmerge-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-math-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-math-debuginfo-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-officebean-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-officebean-debuginfo-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-pyuno-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-pyuno-debuginfo-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-qt5-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-qt5-debuginfo-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-sdk-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-sdk-debuginfo-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-writer-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-writer-debuginfo-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreoffice-writer-extensions-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreofficekit-6.2.7.1-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libreofficekit-devel-6.2.7.1-lp151.3.6.1") ) flag++;
