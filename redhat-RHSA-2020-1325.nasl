...
"The remote Red Hat host is missing a security update for python-XStatic-jQuery.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_1325.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d13865b1");
...
"Update the RHEL python-XStatic-jQuery package based on the guidance in RHSA-2020:1325.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-XStatic-jQuery-3.4.1.0-1.el8ost', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
