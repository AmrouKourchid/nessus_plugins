...
# extracted from Fedora Security Advisory FEDORA-2022-fbf6a320fe
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-fbf6a320fe");

  script_name(english:"Fedora 37 : python3.6 (2022-fbf6a320fe)");
...
FEDORA-2022-fbf6a320fe advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-fbf6a320fe");
...
var pkgs = [
    {'reference':'python3.6-3.6.15-15.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
