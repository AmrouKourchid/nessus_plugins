...
if (description)
{
  ...
  script_cve_id("CVE-2024-21329");
  script_xref(name:"IAVA", value:"2024-A-0102-S");

  script_name(english:"Security Updates for Azure Connected Machine Agent (February 2024)");

  script_set_attribute(attribute:"synopsis", value:
"The Microsoft Azure Connected Machine Agent is affected by an elevation of privilege vulnerability.");
  script_set_attribute(attribute:"description", value:
"The Microsoft Azure Connected Machine Agent running on the remote host is prior to 1.38. It is, therefore affected by
an elevation of privilege vulnerability.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://msrc.microsoft.com/update-guide/vulnerability/CVE-2024-21329");
...
"Update Microsoft Azure Connected Machine Agent in accordance with vendor instructions.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-21329");
