...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : git (EulerOS-SA-2021-1897)");
...
vulnerability :
  ...
  - Git is an open-source distributed revision control
    ...
    to avoid cloning repositories from untrusted
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1897
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?162c8579");
