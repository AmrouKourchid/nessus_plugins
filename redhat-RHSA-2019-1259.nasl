...
referenced in the RHSA-2019:1259 advisory.
    ...
    A new version of .NET Core that address security vulnerabilities is now available. The updated version is
    .NET Core Runtime 2.1.11 and SDK 2.1.507.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?189728f9");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_1259.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?55143bdc");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1696836");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1710068");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1712471");
