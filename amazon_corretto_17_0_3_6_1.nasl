...
if (description)
{
  ...
  script_name(english:"Amazon Corretto Java 17.x < 17.0.3.6.1 Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"Amazon Corretto is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Amazon Corretto installed on the remote host is prior to 17 < 17.0.3.6.1. It is, therefore, affected by
multiple vulnerabilities as referenced in the corretto-17-2022-Apr-17 advisory.
...
number.");
  # https://github.com/corretto/corretto-17/blob/develop/CHANGELOG.md#corretto-version-170361
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4e204005");
  script_set_attribute(attribute:"solution", value:
"Update to Amazon Corretto Java 17.0.3.6.1 or later");
...
var constraints = [
  { 'min_version' : '17.0', 'fixed_version' : '17.0.3.6.1' }
];
