...
if (description)
{
  ...
  script_cve_id("CVE-2016-10371");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2016-10371");
...
patch available.
  ...
  - The TIFFWriteDirectoryTagCheckedRational function in tif_dirwrite.c in LibTIFF 4.0.6 allows remote
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-10371");
