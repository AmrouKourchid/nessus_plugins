...
if (description)
{
  ...
  script_cve_id("CVE-2018-7485");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2018-7485");
...
patch available.
  ...
  - The SQLWriteFileDSN function in odbcinst/SQLWriteFileDSN.c in unixODBC 2.3.5 has strncpy arguments in the
    wrong order, which allows attackers to cause a denial of service or possibly have unspecified other
    impact. (CVE-2018-7485)
