...
if (description)
{
  ...
  script_name(english:"Foxit PDF Reader < 2024.4 Multiple Vulnerabilities");
...
Windows host is prior to 2024.4. It is, therefore affected by multiple vulnerabilities:
...
"Upgrade to Foxit PDF Reader version 2024.4 or later");
...
var constraints = [
  { 'max_version' : '2024.3.0.26795', 'fixed_version' : '2024.4' }
];
