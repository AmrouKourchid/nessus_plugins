...
if (description)
{
  ...
  script_cve_id("CVE-2016-3716");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2016-3716");
...
patch available.
  ...
  - The MSL coder in ImageMagick before 6.9.3-10 and 7.x before 7.0.1-1 allows remote attackers to move
    arbitrary files via a crafted image. (CVE-2016-3716)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-3716");
