...
# extracted from Fedora Security Advisory FEDORA-2025-af22a87e43
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-af22a87e43");

  script_name(english:"Fedora 40 : qt6-qtwebengine (2025-af22a87e43)");
...
FEDORA-2025-af22a87e43 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-af22a87e43");
  script_set_attribute(attribute:"solution", value:
"Update the affected qt6-qtwebengine package.");
...
var pkgs = [
    {'reference':'qt6-qtwebengine-6.8.2-4.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'qt6-qtwebengine');
}
