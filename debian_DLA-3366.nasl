...
# extracted from Debian Security Advisory dla-3366. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3366 : tzdata - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has a package installed that is affected by a vulnerability as referenced in the dla-3366
advisory.

    - -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3366-1                debian-lts@lists.debian.org
...
var pkgs = [
    {'release': '10.0', 'prefix': 'tzdata', 'reference': '2021a-0+deb10u10'}
];
