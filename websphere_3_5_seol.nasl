...
if (description)
{
  ...
  script_name(english:"IBM WebSphere Application Server SEoL (<= 3.5.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of IBM WebSphere Application Server is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, IBM WebSphere Application Server is less than or equal to 3.5.x. It is, therefore, no longer
...
"Upgrade to a version of IBM WebSphere Application Server that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2003/11/30");
...
var constraints = [
  { max_branch : '3.5', seol : 20031130, eseol : 20051130 }
];
