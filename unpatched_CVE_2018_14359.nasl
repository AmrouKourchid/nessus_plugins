...
if (description)
{
  ...
  script_cve_id("CVE-2018-14359");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2018-14359");
...
patch available.
  ...
  - An issue was discovered in Mutt before 1.10.1 and NeoMutt before 2018-07-16. They have a buffer overflow
