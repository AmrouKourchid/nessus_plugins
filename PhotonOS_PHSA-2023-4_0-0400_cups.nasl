...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Cups PHSA-2023-4.0-0400");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'cups-2.2.7-4.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'cups-devel-2.2.7-4.ph4')) flag++;
