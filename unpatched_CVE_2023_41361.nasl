...
if (description)
{
  ...
  script_cve_id("CVE-2023-41361");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2023-41361");
...
patch available.
  ...
  - An issue was discovered in FRRouting FRR 9.0. bgpd/bgp_open.c does not check for an overly large length of
    the rcv software version. (CVE-2023-41361)
