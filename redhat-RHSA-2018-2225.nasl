...
# extracted from Red Hat Security Advisory RHSA-2018:2225. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2017-10906");
  script_xref(name:"RHSA", value:"2018:2225");

  script_name(english:"RHEL 7 : fluentd (RHSA-2018:2225)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for fluentd.");
...
the RHSA-2018:2225 advisory.

    Fluentd is an open source data collector designed to scale and simplify log management. It can collect,
    process and ship many kinds of data in near real-time.

    The following packages have been upgraded to a later upstream version: fluentd (0.12.41). (BZ#1552379)

    Security Fix(es):

    * fluentd: Escape sequence injection in filter_parser.rb:filter_stream can lead to arbitrary command
    execution when processing logs (CVE-2017-10906)
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1524783");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2018/rhsa-2018_2225.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?11d7ff02");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:2225");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL fluentd package based on the guidance in RHSA-2018:2225.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-10906");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'fluentd-0.12.41-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'fluentd');
}
