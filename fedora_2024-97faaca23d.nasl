...
# extracted from Fedora Security Advisory FEDORA-2024-97faaca23d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-97faaca23d");

  script_name(english:"Fedora 39 : webkitgtk (2024-97faaca23d)");
...
FEDORA-2024-97faaca23d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-97faaca23d");
...
var pkgs = [
    {'reference':'webkitgtk-2.42.5-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
