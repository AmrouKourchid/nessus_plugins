...
# extracted from Red Hat Security Advisory RHSA-2021:3234.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : compat-exiv2-023 (RHSA-2021:3234)");
...
"Update the affected compat-exiv2-023 package.");
...
var pkgs = [
    {'reference':'compat-exiv2-023-0.23-2.el7', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'compat-exiv2-023-0.23-2.el7', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE}
];
