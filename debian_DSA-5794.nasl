...
# extracted from Debian Security Advisory dsa-5794. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5794 : openjdk-17-dbg - security update");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'openjdk-17-dbg', 'reference': '17.0.13+11-2~deb12u1'},
    {'release': '12.0', 'prefix': 'openjdk-17-demo', 'reference': '17.0.13+11-2~deb12u1'},
    {'release': '12.0', 'prefix': 'openjdk-17-doc', 'reference': '17.0.13+11-2~deb12u1'},
    {'release': '12.0', 'prefix': 'openjdk-17-jdk', 'reference': '17.0.13+11-2~deb12u1'},
    {'release': '12.0', 'prefix': 'openjdk-17-jdk-headless', 'reference': '17.0.13+11-2~deb12u1'},
    {'release': '12.0', 'prefix': 'openjdk-17-jre', 'reference': '17.0.13+11-2~deb12u1'},
    {'release': '12.0', 'prefix': 'openjdk-17-jre-headless', 'reference': '17.0.13+11-2~deb12u1'},
    {'release': '12.0', 'prefix': 'openjdk-17-jre-zero', 'reference': '17.0.13+11-2~deb12u1'},
    {'release': '12.0', 'prefix': 'openjdk-17-source', 'reference': '17.0.13+11-2~deb12u1'}
];
