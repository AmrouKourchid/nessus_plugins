...
# extracted from Fedora Security Advisory FEDORA-2018-64d64bd05e.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : mingw-openjpeg2 / openjpeg2 (2018-64d64bd05e)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-64d64bd05e");
...
flag = 0;
if (rpm_check(release:"FC27", reference:"mingw-openjpeg2-2.3.0-4.fc27")) flag++;
if (rpm_check(release:"FC27", reference:"openjpeg2-2.3.0-9.fc27")) flag++;
