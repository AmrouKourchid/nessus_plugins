...
if (description)
{
  ...
  script_name(english:"AIX (IJ37411)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AIX host is missing a security patch.");
  script_set_attribute(attribute:"description", value:
"The version of AIX installed on the remote host is prior to APAR IJ37411. It is, therefore, affected by a vulnerability
as referenced in the IJ37411 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/apar/IJ37411");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/node/6561277");
  script_set_attribute(attribute:"solution", value:
"Please apply the appropriate interim fix per APAR IJ37411.");
...
var constraints = [
    {'release': '7.3', 'ml': '00', 'sp': '01', 'patch': 'IJ37411s1a', 'package': 'bos.pmapi.pmsvcs', 'minfilesetver': '7.3.0.0', 'maxfilesetver': '7.3.0.0'}
];
