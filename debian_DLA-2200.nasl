...
# extracted from Debian Security Advisory DLA-2200-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2200-1 : mailman security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"A vulnerability was discovered in mailman. GNU Mailman 2.x before
2.1.30 uses the .obj extension for scrubbed application/octet-stream
MIME parts. This behavior may contribute to XSS attacks against
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2020/05/msg00002.html");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"mailman", reference:"1:2.1.18-2+deb8u5")) flag++;
