...
# extracted from Red Hat Security Advisory RHSA-2015:1685. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2015:1685");

  script_name(english:"RHEL 6 / 7 : python-keystoneclient (RHSA-2015:1685)");
...
in the RHSA-2015:1685 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1209527");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2015/rhsa-2015_1685.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9fb34094");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2015:1685");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-keystoneclient package based on the guidance in RHSA-2015:1685.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-1852");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python-keystoneclient-0.9.0-6.el6ost', 'release':'6', 'el_string':'el6ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'},
      {'reference':'python-keystoneclient-doc-0.9.0-6.el6ost', 'release':'6', 'el_string':'el6ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'python-keystoneclient-0.9.0-6.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'},
      {'reference':'python-keystoneclient-doc-0.9.0-6.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'}
    ]
  }
];
