...
# extracted from Fedora Security Advisory FEDORA-2024-c83b7dcae0
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-c83b7dcae0");

  script_name(english:"Fedora 41 : lua-mpack (2024-c83b7dcae0)");
...
FEDORA-2024-c83b7dcae0 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-c83b7dcae0");
...
var pkgs = [
    {'reference':'lua-mpack-1.0.12-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
