...
# extracted from Red Hat Security Advisory RHSA-2025:7064. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2024-52949");
  script_xref(name:"RHSA", value:"2025:7064");

  script_name(english:"RHEL 9 : iptraf-ng (RHSA-2025:7064)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for iptraf-ng.");
...
the RHSA-2025:7064 advisory.

    IPTraf-ng is a console-based network monitoring utility which includes an IP traffic monitor, a TCP and
    UDP service monitor, and a LAN statistics module. It supports Ethernet, FDDI, ISDN, SLIP, PPP, and
    loopback interfaces as well as the built-in raw socket interface of the Linux kernel.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2332702");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-77280");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_7064.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?19fd4338");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:7064");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL iptraf-ng package based on the guidance in RHSA-2025:7064.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:S/C:P/I:P/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-52949");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:iptraf-ng");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'iptraf-ng-1.2.2-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'iptraf-ng');
}
