...
if (description)
{
  ...
  script_cve_id("CVE-2023-0466", "CVE-2023-2650");
  script_xref(name:"IAVA", value:"2023-A-0158-S");

  script_name(english:"Photon OS 5.0: Openssl PHSA-2023-5.0-0041");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'openssl-3.0.9-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'openssl-c_rehash-3.0.9-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'openssl-devel-3.0.9-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'openssl-docs-3.0.9-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'openssl-libs-3.0.9-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'openssl-perl-3.0.9-1.ph5')) flag++;
