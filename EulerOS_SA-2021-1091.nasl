...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : libvncserver (EulerOS-SA-2021-1091)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1091
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a267e37b");
...
pkgs = ["libvncserver-0.9.9-12.h13"];
