...
USN-5159-1 advisory.
    ...
    It was discovered that bl incorrectly handled certain inputs. An attacker could possibly use this issue to
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'node-bl', 'pkgver': '0.9.3-1ubuntu0.1~esm1', 'ubuntu_pro': TRUE}
];
