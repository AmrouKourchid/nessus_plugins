...
if (description)
{
  ...
  script_cve_id("CVE-2024-42439");

  script_name(english:"Zoom Workplace Desktop App for macOS < 6.1.0 Buffer Overflow (ZSB-24033)");
...
affected by a buffer overflow vulnerability as referenced in the ZSB-24033 advisory:

  - Untrusted search path in the installer for Zoom Workplace Desktop App for macOS and Zoom Meeting SDK for macOS
    before 6.1.0 may allow a privileged user to conduct an escalation of privilege via local access. (CVE-2024-42439)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://www.zoom.com/en/trust/security-bulletin/zsb-24033/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0522defe");
...
"Upgrade to Zoom Workplace Desktop App for macOS version 6.1.0 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-42439");
