...
# AlmaLinux Security Advisory ALSA-2022:0185.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2022:0185");
  script_xref(name:"IAVA", value:"2022-A-0031-S");

  script_name(english:"AlmaLinux 8 : java-11-openjdk (ALSA-2022:0185)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ALSA-2022:0185 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2022-0185.html");
