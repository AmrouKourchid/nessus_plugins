...
if (description)
{
  ...
  script_cve_id("CVE-2025-21819");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2025-21819");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: Revert drm/amd/display: Use HW lock
    mgr for PSR1 This reverts commit a2b5a9956269 (drm/amd/display: Use HW lock mgr for PSR1) Because it
    may cause system hang while connect with two edp panel. (CVE-2025-21819)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-21819");
