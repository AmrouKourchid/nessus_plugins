...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : cairo (EulerOS-SA-2018-1161)");
...
vulnerability :
  ...
  - Integer overflow in the write_png function in cairo
    1.14.6 allows remote attackers to cause a denial of
    service (invalid pointer dereference) via a large svg
    file.(CVE-2016-9082)
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1161
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?11573bf9");
...
"Update the affected cairo package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-9082");
...
pkgs = ["cairo-1.14.2-1.h1",
        "cairo-devel-1.14.2-1.h1",
        "cairo-gobject-1.14.2-1.h1",
        "cairo-gobject-devel-1.14.2-1.h1"];
