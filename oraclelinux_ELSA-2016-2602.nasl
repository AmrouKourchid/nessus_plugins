...
# Oracle Linux Security Advisory ELSA-2016-2602 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : mod_nss (ELSA-2016-2602)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2016-2602.html");
...
var pkgs = [
    {'reference':'mod_nss-1.0.14-7.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
];
