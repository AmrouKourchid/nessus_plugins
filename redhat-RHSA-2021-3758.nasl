...
if (description)
{
  ...
  script_name(english:"RHEL 7 / 8 : OpenShift Container Platform 4.9.0 (RHSA-2021:3758)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for OpenShift Container Platform 4.9.0.");
...
referenced in the RHSA-2021:3758 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.9.0. See the following
    ...
    * jetty: SessionListener can prevent a session from being invalidated breaking logout (CVE-2021-34428)
    ...
    https://docs.openshift.com/container-platform/4.9/updating/updating-cluster-between-
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_3758.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ed8dcce3");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1971016");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1974891");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1984473");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.9.0 packages based on the guidance in RHSA-2021:3758.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'coreos-installer-0.10.0-2.rhaos4.9.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2021-3917']},
      {'reference':'coreos-installer-bootinfra-0.10.0-2.rhaos4.9.el8', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2021-3917']},
      {'reference':'coreos-installer-bootinfra-0.10.0-2.rhaos4.9.el8', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2021-3917']},
      {'reference':'jenkins-2.289.3.1630554997-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2021-28169', 'CVE-2021-34428']},
      {'reference':'network-scripts-openvswitch2.15-2.15.0-28.el8fdp', 'release':'8', 'el_string':'el8fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2021-36980']},
      {'reference':'openshift-hyperkube-4.9.0-202110080828.p0.git.894a78b.assembly.stream.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2021-33196']},
      {'reference':'openvswitch2.15-2.15.0-28.el8fdp', 'release':'8', 'el_string':'el8fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2021-36980']},
      {'reference':'openvswitch2.15-devel-2.15.0-28.el8fdp', 'release':'8', 'el_string':'el8fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2021-36980']},
      {'reference':'openvswitch2.15-ipsec-2.15.0-28.el8fdp', 'release':'8', 'el_string':'el8fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2021-36980']},
      {'reference':'openvswitch2.15-test-2.15.0-28.el8fdp', 'release':'8', 'el_string':'el8fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2021-36980']},
      {'reference':'python3-openvswitch2.15-2.15.0-28.el8fdp', 'release':'8', 'el_string':'el8fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2021-36980']}
    ]
  },
  {
    'repo_relative_urls': [
      'content/dist/rhel/power-le/7/7Server/ppc64le/ose/4.9/debug',
      'content/dist/rhel/power-le/7/7Server/ppc64le/ose/4.9/os',
      'content/dist/rhel/power-le/7/7Server/ppc64le/ose/4.9/source/SRPMS',
    ...
    'pkgs': [
      {'reference':'openshift-hyperkube-4.9.0-202110080828.p0.git.894a78b.assembly.stream.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2021-33196']}
    ]
  }
];
