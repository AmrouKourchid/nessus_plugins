...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : libpng (ELSA-2010-0534)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2010-0534.html");
