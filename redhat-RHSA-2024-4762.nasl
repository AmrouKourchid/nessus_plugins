...
# extracted from Red Hat Security Advisory RHSA-2024:4762. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:4762");

  script_name(english:"RHEL 9 : runc (RHSA-2024:4762)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_4762.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a30bb53e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2262921");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:4762");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL runc package based on the guidance in RHSA-2024:4762.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'runc-1.1.12-3.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'runc-1.1.12-3.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'}
    ]
  }
];
