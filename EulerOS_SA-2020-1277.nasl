...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.2 : python-urllib3 (EulerOS-SA-2020-1277)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1277
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dce0617f");
...
pkgs = ["python-urllib3-1.10.2-2.h2"];
