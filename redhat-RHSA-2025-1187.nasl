...
# extracted from Red Hat Security Advisory RHSA-2025:1187. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:1187");

  script_name(english:"RHEL 9 : buildah (RHSA-2025:1187)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_1187.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2fee95fb");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:1187");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL buildah package based on the guidance in RHSA-2025:1187.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'buildah-1.26.9-1.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'buildah-tests-1.26.9-1.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
