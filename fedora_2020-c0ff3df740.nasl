...
# extracted from Fedora Security Advisory FEDORA-2020-c0ff3df740.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : pdns-recursor (2020-c0ff3df740)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-c0ff3df740");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"pdns-recursor-4.2.2-1.fc31")) flag++;
