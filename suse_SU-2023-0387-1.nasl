...
# SUSE update advisory SUSE-SU-2023:0387-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:0387-1");

  script_name(english:"SUSE SLES12 Security Update : xrdp (SUSE-SU-2023:0387-1)");
...
the SUSE-SU-2023:0387-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-February/013741.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b54c55c0");
...
var pkgs = [
    {'reference':'xrdp-0.9.0~git.1456906198.f422461-16.23.2', 'sp':'2', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-bcl-release-12.2']}
];
