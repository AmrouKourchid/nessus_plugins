...
# extracted from Fedora Security Advisory FEDORA-2024-3ecdf562bf
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-3ecdf562bf");

  script_name(english:"Fedora 41 : openjpeg (2024-3ecdf562bf)");
...
FEDORA-2024-3ecdf562bf advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-3ecdf562bf");
...
var pkgs = [
    {'reference':'openjpeg-2.5.2-4.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
