...
if (description)
{
  ...
  script_name(english:"Adobe Photoshop CC 20.x < 20.0.8 / 21.x < 21.0.2 Multiple Vulnerabilities (macOS APSB19-56)");

  script_set_attribute(attribute:"synopsis", value:
"Adobe Photoshop installed on remote macOS or Mac OS X host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Photoshop CC or Photoshop installed on the remote macOS or Mac OS X host is prior to 20.0.8/21.0.2.
It is, therefore, affected by multiple vulnerabilities as referenced in the apsb19-56 advisory.

  - Adobe Photoshop CC versions before 20.0.8 and 21.0.x before 21.0.2 have a memory corruption vulnerability.
    Successful exploitation could lead to arbitrary code execution. (CVE-2019-8253, CVE-2019-8254)
...
"Upgrade to Adobe Photoshop version 20.0.8/21.0.2 or later.");
...
var constraints = [
  { 'min_version' : '20.0.0', 'fixed_version' : '20.0.8' },
