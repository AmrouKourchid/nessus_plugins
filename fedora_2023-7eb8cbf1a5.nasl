...
# extracted from Fedora Security Advisory FEDORA-2023-7eb8cbf1a5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-7eb8cbf1a5");

  script_name(english:"Fedora 38 : samba (2023-7eb8cbf1a5)");
...
FEDORA-2023-7eb8cbf1a5 advisory.

    Update to version 4.18.8 - Security fixes for CVE-2023-3961, CVE-2023-4091, CVE-2023-4154,  CVE-2023-42669
    and CVE-2023-42670
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-7eb8cbf1a5");
...
var pkgs = [
    {'reference':'samba-4.18.8-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
