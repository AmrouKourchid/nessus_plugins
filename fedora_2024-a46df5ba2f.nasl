...
# extracted from Fedora Security Advisory FEDORA-2024-a46df5ba2f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-a46df5ba2f");
  script_xref(name:"IAVB", value:"2024-B-0200");

  script_name(english:"Fedora 40 : xen (2024-a46df5ba2f)");
...
FEDORA-2024-a46df5ba2f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-a46df5ba2f");
...
var pkgs = [
    {'reference':'xen-4.18.2-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
