...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : gnutls (EulerOS-SA-2025-1358)");
...
the following vulnerabilities :
    ...
    certificate, causing GnuTLS to become unresponsive or slow, resulting in a denial-of-service
    condition.(CVE-2024-12243)
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1358
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d5e207cd");
...
var pkgs = [
  "gnutls-3.7.2-2.h31.eulerosv2r11",
  "gnutls-utils-3.7.2-2.h31.eulerosv2r11"
];
