...
# extracted from Red Hat Security Advisory gdm. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2019-3825", "CVE-2020-16125", "CVE-2020-27837");

  script_name(english:"RHEL 6 : gdm (Unpatched Vulnerability) (deprecated)");
...
"This plugin has been deprecated as it does not adhere to established standards for this style of check.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2020-16125");
