...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.0 : shadow (EulerOS-SA-2023-2532)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2532
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d369c967");
...
var pkgs = [
  "shadow-4.8.1-1.h8.r11.eulerosv2r9"
];
