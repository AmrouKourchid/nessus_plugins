...
if (description)
{
  ...
  script_cve_id("CVE-2017-4965");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2017-4965");
...
patch available.
  ...
  - An issue was discovered in these Pivotal RabbitMQ versions: all 3.4.x versions, all 3.5.x versions, and
    ...
    vulnerable to XSS attacks. (CVE-2017-4965)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-4965");
