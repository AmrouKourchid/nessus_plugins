...
if (description)
{
  ...
  script_name(english:"RHEL 6 : java-1.8.0-openjdk (RHSA-2016:0050)");
...
referenced in the RHSA-2016:0050 advisory.
  ...
  - OpenJDK: PBE incorrect key lengths (Libraries, 8138589) (CVE-2016-0475)
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2016/rhsa-2016_0050.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2baf260b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2016:0050");
...
"Update the RHEL java-1.8.0-openjdk package based on the guidance in RHSA-2016:0050.");
...
var constraints = [
  {
    ...
    'pkgs': [
      ...
      {'reference':'java-1.8.0-openjdk-javadoc-1.8.0.71-1.b15.el6_7', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.8.0-openjdk-javadoc-debug-1.8.0.71-1.b15.el6_7', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
