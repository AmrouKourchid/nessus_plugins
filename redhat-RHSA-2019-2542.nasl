...
# extracted from Red Hat Security Advisory RHSA-2019:2542. The text 
...
if (description)
{
  ...
  script_cve_id("CVE-2019-10206", "CVE-2019-10217");
  script_xref(name:"RHSA", value:"2019:2542");

  script_name(english:"RHEL 7 / 8 : Ansible (RHSA-2019:2542)");
...
referenced in the RHSA-2019:2542 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_2542.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1a826c43");
  # https://github.com/ansible/ansible/blob/v2.8.4/changelogs/CHANGELOG-v2.8.rst
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a9bcc5a1");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:2542");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1732623");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1733509");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Ansible package based on the guidance in RHSA-2019:2542.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:S/C:P/I:N/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:L/UI:N/S:U/C:H/I:N/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-10217");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ansible-2.8.4-1.el8ae', 'release':'8', 'el_string':'el8ae', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2.8'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'ansible-2.8.4-1.el7ae', 'release':'7', 'el_string':'el7ae', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2.8'}
    ]
  }
];
