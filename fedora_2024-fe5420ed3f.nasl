...
# extracted from Fedora Security Advisory FEDORA-2024-fe5420ed3f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-fe5420ed3f");
  script_xref(name:"IAVA", value:"2024-A-0461-S");

  script_name(english:"Fedora 40 : vim (2024-fe5420ed3f)");
...
FEDORA-2024-fe5420ed3f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-fe5420ed3f");
...
var pkgs = [
    {'reference':'vim-9.1.660-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
