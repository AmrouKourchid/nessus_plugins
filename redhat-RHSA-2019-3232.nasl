...
# extracted from Red Hat Security Advisory RHSA-2019:3232. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:3232");

  script_name(english:"RHEL 7 : polkit (RHSA-2019:3232)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for polkit.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2019:3232 advisory.

    The polkit packages provide a component for controlling system-wide privileges. This component provides a
    uniform and organized way for non-privileged processes to communicate with privileged ones.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_3232.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?70a090ca");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:3232");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1655925");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL polkit package based on the guidance in RHSA-2019:3232.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'polkit-0.112-18.el7_6.2', 'sp':'6', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-0.112-18.el7_6.2', 'sp':'6', 'cpu':'ppc', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-0.112-18.el7_6.2', 'sp':'6', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-0.112-18.el7_6.2', 'sp':'6', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-0.112-18.el7_6.2', 'sp':'6', 'cpu':'s390', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-0.112-18.el7_6.2', 'sp':'6', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-0.112-18.el7_6.2', 'sp':'6', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-devel-0.112-18.el7_6.2', 'sp':'6', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-devel-0.112-18.el7_6.2', 'sp':'6', 'cpu':'ppc', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-devel-0.112-18.el7_6.2', 'sp':'6', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-devel-0.112-18.el7_6.2', 'sp':'6', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-devel-0.112-18.el7_6.2', 'sp':'6', 'cpu':'s390', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-devel-0.112-18.el7_6.2', 'sp':'6', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-devel-0.112-18.el7_6.2', 'sp':'6', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-docs-0.112-18.el7_6.2', 'sp':'6', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'polkit-0.112-18.el7_6.2', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-0.112-18.el7_6.2', 'cpu':'ppc', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-0.112-18.el7_6.2', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-0.112-18.el7_6.2', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-0.112-18.el7_6.2', 'cpu':'s390', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-0.112-18.el7_6.2', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-0.112-18.el7_6.2', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-devel-0.112-18.el7_6.2', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-devel-0.112-18.el7_6.2', 'cpu':'ppc', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-devel-0.112-18.el7_6.2', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-devel-0.112-18.el7_6.2', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-devel-0.112-18.el7_6.2', 'cpu':'s390', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-devel-0.112-18.el7_6.2', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-devel-0.112-18.el7_6.2', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-docs-0.112-18.el7_6.2', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
