...
# extracted from Red Hat Security Advisory RHSA-2024:1786. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:1786");

  script_name(english:"RHEL 8 : httpd:2.4/mod_http2 (RHSA-2024:1786)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for httpd:2.4/mod_http2.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:1786 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?125ea988");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2268277");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:1786");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL httpd:2.4/mod_http2 package based on the guidance in RHSA-2024:1786.");
  ...
  'httpd:2.4': [
    {
      ...
      'pkgs': [
        {'reference':'httpd-2.4.37-62.module+el8.9.0+19699+7a7a2044', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'httpd-devel-2.4.37-62.module+el8.9.0+19699+7a7a2044', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'httpd-filesystem-2.4.37-62.module+el8.9.0+19699+7a7a2044', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'httpd-manual-2.4.37-62.module+el8.9.0+19699+7a7a2044', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'httpd-tools-2.4.37-62.module+el8.9.0+19699+7a7a2044', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mod_http2-1.15.7-8.module+el8.9.0+21652+2dd1200b.5', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mod_ldap-2.4.37-62.module+el8.9.0+19699+7a7a2044', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mod_md-2.0.8-8.module+el8.9.0+19080+567b90f8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'mod_proxy_html-2.4.37-62.module+el8.9.0+19699+7a7a2044', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'mod_session-2.4.37-62.module+el8.9.0+19699+7a7a2044', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mod_ssl-2.4.37-62.module+el8.9.0+19699+7a7a2044', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
      ]
    }
  ]
};
