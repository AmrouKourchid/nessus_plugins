...
if (description)
{
  ...
  script_cve_id("CVE-2024-56533");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-56533");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: ALSA: usx2y: Use
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-56533");
