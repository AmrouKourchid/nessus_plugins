...
(Tablib: Arbitrary command execution)
    ...
    A vulnerability was discovered in Tablib&rsquo;s Databook loading
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/201811-18");
...
"All Tablib users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-2810");
