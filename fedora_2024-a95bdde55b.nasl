...
# extracted from Fedora Security Advisory FEDORA-2024-a95bdde55b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-a95bdde55b");

  script_name(english:"Fedora 39 : wpa_supplicant (2024-a95bdde55b)");
...
FEDORA-2024-a95bdde55b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-a95bdde55b");
  script_set_attribute(attribute:"solution", value:
"Update the affected 1:wpa_supplicant package.");
...
var pkgs = [
    {'reference':'wpa_supplicant-2.10-9.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
