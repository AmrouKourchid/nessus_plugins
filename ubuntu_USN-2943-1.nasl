...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : PCRE vulnerabilities (USN-2943-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 14.04 LTS host has packages installed that are affected by multiple vulnerabilities as referenced in
the USN-2943-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2943-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'libpcre3', 'pkgver': '1:8.31-2ubuntu2.2'},
    {'osver': '14.04', 'pkgname': 'libpcre3-dev', 'pkgver': '1:8.31-2ubuntu2.2'},
    {'osver': '14.04', 'pkgname': 'libpcre3-udeb', 'pkgver': '1:8.31-2ubuntu2.2'},
    {'osver': '14.04', 'pkgname': 'libpcrecpp0', 'pkgver': '1:8.31-2ubuntu2.2'},
    {'osver': '14.04', 'pkgname': 'pcregrep', 'pkgver': '1:8.31-2ubuntu2.2'}
];
