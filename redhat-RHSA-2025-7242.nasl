...
# extracted from Red Hat Security Advisory RHSA-2025:7242. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:7242");

  script_name(english:"RHEL 9 : gstreamer1-plugins-good (RHSA-2025:7242)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for gstreamer1-plugins-good.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2025:7242 advisory.

    GStreamer is a streaming media framework based on graphs of filters which operate on media data. The
    gstreamer1-plugins-good packages contain a collection of well-supported plug-ins of good quality and under
    the LGPL license.
    ...
    * gstreamer1-plugins-good: insufficient error handling in JPEG decoder that can lead to NULL-pointer
    dereferences (CVE-2024-47599)
    ...
    * gstreamer1-plugins-good: integer underflow in FOURCC_strf parsing leading to OOB-read (CVE-2024-47545)
    ...
    For detailed information on changes in this release, see the Red Hat Enterprise Linux 9 Release Notes
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a7e51e86");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2331723");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2331739");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2331741");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2331743");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2331744");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2331747");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2331748");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2331749");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2331750");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2331751");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2331752");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2331755");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2331756");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2331759");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2331761");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2331762");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2331763");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_7242.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a693896f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:7242");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL gstreamer1-plugins-good package based on the guidance in RHSA-2025:7242.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-47834");
  script_set_attribute(attribute:"cvss4_score_source", value:"CVE-2024-47546");

  script_set_attribute(attribute:"exploitability_ease", value:"No known exploits are available");
  script_set_attribute(attribute:"exploit_available", value:"false");
  script_cwe_id(125, 191, 416, 476);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gstreamer1-plugins-good-1.22.12-4.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gstreamer1-plugins-good-gtk-1.22.12-4.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
