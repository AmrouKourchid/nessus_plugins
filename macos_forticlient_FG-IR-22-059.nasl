...
if (description)
{
  ...
  script_name(english:"Fortinet FortiClient in OpenSSL library (FG-IR-22-059) (macOS)");
...
"Please upgrade to FortiOS version 6.0.15/6.2.11/6.4.9/7.0.6/7.2.0 or later.");
