...
if (description)
{
  ...
  script_cve_id("CVE-2023-39202");

  script_name(english:"Zoom VDI Meeting Client < 5.16.0 Vulnerability (ZSB-23046)");
...
vulnerability as referenced in the ZSB-23046 advisory.

  - Untrusted search path in Zoom Rooms Client for Windows and Zoom VDI Client may allow a privileged user to
    conduct a denial of service via local access. Users can help keep themselves secure by applying current
    updates or downloading the latest Zoom software with all current security updates from
    https://zoom.us/download. (CVE-2023-39202)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://explore.zoom.us/en/trust/security/security-bulletin/?filter-cve=&filter=&keywords=ZSB-23046
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5ea23588");
...
"Upgrade to Zoom VDI Meeting Client 5.16.0 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-39202");
