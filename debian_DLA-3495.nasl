...
# extracted from Debian Security Advisory dla-3495. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3495 : php-dompdf - security update");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/php-dompdf");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2021-3838");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-2400");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/php-dompdf");
  script_set_attribute(attribute:"solution", value:
"Upgrade the php-dompdf packages.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-3838");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'php-dompdf', 'reference': '0.6.2+dfsg-3+deb10u1'}
];
