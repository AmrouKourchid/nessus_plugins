...
# extracted from Red Hat Security Advisory RHSA-2022:4845. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:4845");

  script_name(english:"RHEL 8 : zlib (RHSA-2022:4845)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for zlib.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2022:4845 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_4845.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?574bf644");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2067945");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:4845");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL zlib package based on the guidance in RHSA-2022:4845.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'zlib-1.2.11-18.el8_4', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'zlib-devel-1.2.11-18.el8_4', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'zlib-static-1.2.11-18.el8_4', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
