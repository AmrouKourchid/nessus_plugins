...
# extracted from Debian Security Advisory dla-3945. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2023-0996", "CVE-2023-29659");

  script_name(english:"Debian dla-3945 : heif-gdk-pixbuf - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-0996");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-29659");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bullseye/libheif");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'heif-gdk-pixbuf', 'reference': '1.11.0-1+deb11u2'},
    {'release': '11.0', 'prefix': 'heif-thumbnailer', 'reference': '1.11.0-1+deb11u2'},
    {'release': '11.0', 'prefix': 'libheif-dev', 'reference': '1.11.0-1+deb11u2'},
    {'release': '11.0', 'prefix': 'libheif-examples', 'reference': '1.11.0-1+deb11u2'},
    {'release': '11.0', 'prefix': 'libheif1', 'reference': '1.11.0-1+deb11u2'}
];
