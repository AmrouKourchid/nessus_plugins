...
# extracted from VMware Security Advisory PHSA-2023-3.0-0544. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Emacs PHSA-2023-3.0-0544");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the emacs package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-3.0-544.md");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'emacs-27.1-3.ph3')) flag++;
