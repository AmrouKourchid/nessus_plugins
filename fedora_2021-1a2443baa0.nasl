...
# extracted from Fedora Security Advisory FEDORA-2021-1a2443baa0
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-1a2443baa0");

  script_name(english:"Fedora 32 : 1:wpa_supplicant (2021-1a2443baa0)");
...
FEDORA-2021-1a2443baa0 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-1a2443baa0");
...
pkgs = [
    {'reference':'wpa_supplicant-2.9-5.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
