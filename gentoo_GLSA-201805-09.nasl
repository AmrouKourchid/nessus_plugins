...
# extracted from Gentoo Linux Security Advisory GLSA 201805-09.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201805-09");

  script_name(english:"GLSA-201805-09 : Shadow: security bypass");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-201805-09
(Shadow: security bypass)

    A local attacker could possibly bypass security restrictions if an
      administrator used &ldquo;group blacklisting&rdquo; to restrict access to file
      system paths.
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/201805-09");
...
if (qpkg_check(package:"sys-apps/shadow", unaffected:make_list("ge 4.6"), vulnerable:make_list("lt 4.6"))) flag++;
