...
# extracted from Red Hat Security Advisory RHSA-2023:1333 and
# CentOS Errata and Security Advisory 2023:1333 respectively.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : firefox (RHSA-2023:1333)");
...
var pkgs = [
    {'reference':'firefox-102.9.0-3.el7.centos', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-102.9.0-3.el7.centos', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
