...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2018-19046");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'keepalived-2.0.16-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'keepalived-debuginfo-2.0.16-1.ph3')) flag++;
