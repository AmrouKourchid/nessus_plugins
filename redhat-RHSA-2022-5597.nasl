...
# extracted from Red Hat Security Advisory RHSA-2022:5597. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:5597");

  script_name(english:"RHEL 8 : pandoc (RHSA-2022:5597)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for pandoc.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2022:5597 advisory.

    Pandoc is a markdown/markup conversion tool. The version of pandoc in RHEL 8 CRB uses cmark-gfm (GitHub's
    extended version of the C reference implementation of CommonMark) for parts of its conversion. The update,
    fixes CVE-2022-24724: an integer overflow in cmark-gfm's table row parsing which may lead to heap memory
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_5597.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?76928c76");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:5597");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2060662");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL pandoc packages based on the guidance in RHSA-2022:5597.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-24724");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:pandoc");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:pandoc-common");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'pandoc-2.0.6-6.el8_6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pandoc-common-2.0.6-6.el8_6', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'pandoc-2.0.6-6.el8_6', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pandoc-common-2.0.6-6.el8_6', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'pandoc / pandoc-common');
}
