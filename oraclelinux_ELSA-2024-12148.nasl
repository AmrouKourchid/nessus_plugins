...
# extracted from Oracle Linux Security Advisory ELSA-2024-12148.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : runc (ELSA-2024-12148)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-12148.html");
