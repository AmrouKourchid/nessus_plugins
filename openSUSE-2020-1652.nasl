...
nextcloud version 20.0.0 fix some security issues :
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1177346");
...
"Update the affected nextcloud package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-8233");
