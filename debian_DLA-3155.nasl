...
if (description)
{
  ...
  script_name(english:"Debian dla-3155 : libbcel-java - security update");
...
advisory.
    ...
    -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3155-1                debian-lts@lists.debian.org
...
"Upgrade the libbcel-java packages.");
