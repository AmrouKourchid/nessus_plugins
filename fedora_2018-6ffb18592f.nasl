...
# extracted from Fedora Security Advisory FEDORA-2018-6ffb18592f.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : mod_http2 (2018-6ffb18592f)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-6ffb18592f");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"mod_http2-1.11.1-1.fc28")) flag++;
