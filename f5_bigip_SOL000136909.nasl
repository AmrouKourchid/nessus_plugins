...
# extracted from F5 Networks BIG-IP Solution K000136909.
#
# @NOAGENT@
##
...
if (description)
{
  ...
  script_cve_id("CVE-2023-43125");

  script_name(english:"F5 Networks BIG-IP : BIG-IP APM Clients TunnelCrack vulnerability (K000136909)");
...
therefore, affected by a vulnerability as referenced in the K000136909 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K000136909");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K000136909.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-43125");
