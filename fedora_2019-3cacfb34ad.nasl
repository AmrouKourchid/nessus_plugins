...
# extracted from Fedora Security Advisory FEDORA-2019-3cacfb34ad.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-3cacfb34ad");

  script_name(english:"Fedora 30 : cobbler (2019-3cacfb34ad)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-3cacfb34ad");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"cobbler-2.8.5-0.1.fc30")) flag++;
