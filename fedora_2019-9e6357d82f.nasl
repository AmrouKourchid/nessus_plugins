...
# extracted from Fedora Security Advisory FEDORA-2019-9e6357d82f.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-9e6357d82f");

  script_name(english:"Fedora 30 : curl (2019-9e6357d82f)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-9e6357d82f");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"curl-7.65.3-4.fc30")) flag++;
