...
# extracted from Ubuntu Security Notice USN-4236-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"4236-1");

  script_name(english:"Ubuntu 18.04 LTS : Libgcrypt vulnerability (USN-4236-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4236-1");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'libgcrypt-mingw-w64-dev', 'pkgver': '1.8.1-4ubuntu1.2'},
    {'osver': '18.04', 'pkgname': 'libgcrypt11-dev', 'pkgver': '1.5.4-3+really1.8.1-4ubuntu1.2'},
    {'osver': '18.04', 'pkgname': 'libgcrypt20', 'pkgver': '1.8.1-4ubuntu1.2'},
    {'osver': '18.04', 'pkgname': 'libgcrypt20-dev', 'pkgver': '1.8.1-4ubuntu1.2'},
    {'osver': '18.04', 'pkgname': 'libgcrypt20-udeb', 'pkgver': '1.8.1-4ubuntu1.2'}
];
