...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : screen (EulerOS-SA-2023-2667)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the screen package installed, the EulerOS installation on the remote host is affected by
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2667
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?749c1bea");
...
var pkgs = [
  "screen-4.8.0-11.h1.eulerosv2r11"
];
