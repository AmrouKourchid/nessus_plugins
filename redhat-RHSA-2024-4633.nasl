...
# extracted from Red Hat Security Advisory RHSA-2024:4633. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:4633");

  script_name(english:"RHEL 9 : 389-ds-base (RHSA-2024:4633)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for 389-ds-base.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:4633 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_4633.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1caabc33");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:4633");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL 389-ds-base package based on the guidance in RHSA-2024:4633.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'389-ds-base-2.2.4-9.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'389-ds-base-libs-2.2.4-9.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-lib389-2.2.4-9.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
