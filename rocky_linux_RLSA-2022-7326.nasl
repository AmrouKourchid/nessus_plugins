...
# Rocky Linux Security Advisory RLSA-2022:7326.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2022:7326");

  script_name(english:"Rocky Linux 9 : pki-core (RLSA-2022:7326)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2022:7326");
...
var pkgs = [
    ...
    {'reference':'pki-symkey-11.0.6-2.el9_0', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pki-symkey-11.0.6-2.el9_0', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pki-symkey-11.0.6-2.el9_0', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pki-tools-11.0.6-2.el9_0', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pki-tools-11.0.6-2.el9_0', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pki-tools-11.0.6-2.el9_0', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
