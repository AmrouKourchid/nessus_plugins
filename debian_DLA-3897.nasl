...
# extracted from Debian Security Advisory dla-3897. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3897 : trafficserver - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-38522");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-35161");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-35296");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'trafficserver', 'reference': '8.1.11+ds-0+deb11u1'},
    {'release': '11.0', 'prefix': 'trafficserver-dev', 'reference': '8.1.11+ds-0+deb11u1'},
    {'release': '11.0', 'prefix': 'trafficserver-experimental-plugins', 'reference': '8.1.11+ds-0+deb11u1'}
];
