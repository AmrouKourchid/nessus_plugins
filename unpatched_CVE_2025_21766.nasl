...
if (description)
{
  ...
  script_cve_id("CVE-2025-21766");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2025-21766");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: ipv4: use RCU protection in
    __ip_rt_update_pmtu() __ip_rt_update_pmtu() must use RCU protection to make sure the net structure it
    reads does not disappear. (CVE-2025-21766)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-21766");
