...
# extracted from Red Hat Security Advisory RHSA-2024:10803. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:10803");

  script_name(english:"RHEL 9 : bzip2 (RHSA-2024:10803)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_10803.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?18113d3b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:10803");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL bzip2 package based on the guidance in RHSA-2024:10803.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'bzip2-1.0.8-8.el9_4.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bzip2-devel-1.0.8-8.el9_4.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bzip2-libs-1.0.8-8.el9_4.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
