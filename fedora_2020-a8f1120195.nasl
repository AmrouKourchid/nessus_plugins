...
# extracted from Fedora Security Advisory FEDORA-2020-a8f1120195.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 33 : 2:ceph (2020-a8f1120195)");
...
ceph-15.2.6 GA Security fix for CVE-2020-25660

Note that Tenable Network Security has extracted the preceding
description block directly from the Fedora update system website.
Tenable has attempted to automatically clean and format it as much as
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-a8f1120195");
...
flag = 0;
if (rpm_check(release:"FC33", reference:"ceph-15.2.7-1.fc33", epoch:"2")) flag++;
