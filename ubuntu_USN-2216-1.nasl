...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : Pidgin vulnerability (USN-2216-1)");
...
USN-2216-1 advisory.
    ...
    It was discovered that Pidgin incorrectly handled certain messages from Gadu-Gadu file relay servers. A
    malicious remote server or a machine-in-the-middle could use this issue to cause Pidgin to crash,
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2216-1");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-3775");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'finch', 'pkgver': '1:2.10.9-0ubuntu3.1'},
    {'osver': '14.04', 'pkgname': 'finch-dev', 'pkgver': '1:2.10.9-0ubuntu3.1'},
    {'osver': '14.04', 'pkgname': 'libpurple-bin', 'pkgver': '1:2.10.9-0ubuntu3.1'},
    {'osver': '14.04', 'pkgname': 'libpurple-dev', 'pkgver': '1:2.10.9-0ubuntu3.1'},
    {'osver': '14.04', 'pkgname': 'libpurple0', 'pkgver': '1:2.10.9-0ubuntu3.1'},
    {'osver': '14.04', 'pkgname': 'pidgin', 'pkgver': '1:2.10.9-0ubuntu3.1'},
    {'osver': '14.04', 'pkgname': 'pidgin-data', 'pkgver': '1:2.10.9-0ubuntu3.1'},
    {'osver': '14.04', 'pkgname': 'pidgin-dev', 'pkgver': '1:2.10.9-0ubuntu3.1'}
];
