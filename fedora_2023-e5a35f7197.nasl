...
# extracted from Fedora Security Advisory FEDORA-2023-e5a35f7197
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-e5a35f7197");
  script_xref(name:"IAVB", value:"2023-B-0019-S");

  script_name(english:"Fedora 38 : qemu (2023-e5a35f7197)");
...
FEDORA-2023-e5a35f7197 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-e5a35f7197");
...
var pkgs = [
    {'reference':'qemu-7.2.1-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
