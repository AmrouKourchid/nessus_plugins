...
# extracted from VMware Security Advisory PHSA-2019-2.0-0183. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Sudo PHSA-2019-2.0-0183");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the sudo package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-2-183.md");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'sudo-1.8.20p2-6.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'sudo-debuginfo-1.8.20p2-6.ph2')) flag++;
