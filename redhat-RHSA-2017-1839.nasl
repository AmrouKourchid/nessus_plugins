...
# extracted from Red Hat Security Advisory RHSA-2017:1839. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2017:1839");

  script_name(english:"RHEL 7 : rh-eclipse46-jackson-databind (RHSA-2017:1839)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2017/rhsa-2017_1839.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?34d7da72");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2017:1839");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rh-eclipse46-jackson-databind package based on the guidance in RHSA-2017:1839.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-eclipse46-jackson-databind-2.6.3-2.3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-eclipse46-jackson-databind-javadoc-2.6.3-2.3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
