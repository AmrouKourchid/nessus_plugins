...
# extracted from Ubuntu Security Notice USN-7161-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"7161-2");

  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 20.04 LTS / 22.04 LTS : Docker vulnerabilities (USN-7161-2)");
...
multiple vulnerabilities as referenced in the USN-7161-2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7161-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'docker.io', 'pkgver': '18.09.7-0ubuntu1~16.04.9+esm2', 'ubuntu_pro': TRUE, 'cves': ['CVE-2024-29018']},
    {'osver': '18.04', 'pkgname': 'docker.io', 'pkgver': '20.10.21-0ubuntu1~18.04.3+esm2', 'ubuntu_pro': TRUE, 'cves': ['CVE-2024-29018', 'CVE-2024-41110']},
    {'osver': '20.04', 'pkgname': 'docker.io', 'pkgver': '26.1.3-0ubuntu1~20.04.1+esm1', 'ubuntu_pro': TRUE, 'cves': ['CVE-2024-29018']},
    {'osver': '22.04', 'pkgname': 'docker.io', 'pkgver': '26.1.3-0ubuntu1~22.04.1+esm1', 'ubuntu_pro': TRUE, 'cves': ['CVE-2024-29018']}
];
