...
# extracted from Red Hat Security Advisory RHSA-2022:6170 and
# CentOS Errata and Security Advisory 2022:6170 respectively.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : rsync (RHSA-2022:6170)");
...
var pkgs = [
    {'reference':'rsync-3.1.2-11.el7_9', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rsync-3.1.2-11.el7_9', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE}
];
