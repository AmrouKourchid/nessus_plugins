...
if (description)
{
  ...
  script_name(english:"Adobe Photoshop 21.x < 21.2.6 / 22.x < 22.3 Multiple Vulnerabilities (APSB21-17)");

  script_set_attribute(attribute:"synopsis", value:
"Adobe Photoshop installed on remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Photoshop installed on the remote Windows host is prior to 21.2.6/22.3. It is, therefore, affected
by multiple vulnerabilities as referenced in the apsb21-17 advisory.

  - Adobe Photoshop versions 21.2.5 (and earlier) and 22.2 (and earlier) are affected by an Out-of-bounds
    Write vulnerability in the CoolType library. An unauthenticated attacker could leverage this vulnerability
    to achieve arbitrary code execution in the context of the current user. Exploitation of this issue
    requires user interaction in that a victim must open a malicious file. (CVE-2021-21067)

  - Adobe Photoshop versions 21.2.5 (and earlier) and 22.2 (and earlier) are affected by a Memory Corruption
    ...
    issue requires user interaction in that a victim must open a malicious file. (CVE-2021-21082)
...
"Upgrade to Adobe Photoshop version 21.2.6/22.3 or later.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2021-21082");
...
var constraints = [
  { 'min_version' : '21.0.0', 'fixed_version' : '21.2.6' },
  { 'min_version' : '22.0', 'fixed_version' : '22.2.1', 'fixed_display' : '22.3' }
];
