...
# extracted from Oracle Linux Security Advisory ELSA-2023-2222.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : conmon (ELSA-2023-2222)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-2222.html");
...
var pkgs = [
    {'reference':'conmon-2.1.7-1.el9_2', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'conmon-2.1.7-1.el9_2', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
