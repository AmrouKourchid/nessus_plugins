...
if (description)
{
  ...
  script_name(english:"Amazon Corretto Java 8.x < 8.322.06.1 Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"Amazon Corretto is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Amazon Corretto installed on the remote host is prior to 8 < 8.322.06.1. It is, therefore, affected by
multiple vulnerabilities as referenced in the corretto-8-2022-Jan-18 advisory.
  ...
  - client-libs/2d (CVE-2022-21349)

  - client-libs/javax.imageio (CVE-2022-21360, CVE-2022-21365)

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  # https://github.com/corretto/corretto-8/blob/develop/CHANGELOG.md#corretto-version-8322061
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4a66bb55");
  script_set_attribute(attribute:"solution", value:
"Update to Amazon Corretto Java 8.322.06.1 or later");
...
var constraints = [
  { 'min_version' : '8.0', 'fixed_version' : '8.322.06.1' }
];
