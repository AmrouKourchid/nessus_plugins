...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : qt (EulerOS-SA-2020-2158)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2158
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?adf20956");
...
pkgs = ["qt-4.8.7-42.h9.eulerosv2r8",
        "qt-common-4.8.7-42.h9.eulerosv2r8",
        "qt-devel-4.8.7-42.h9.eulerosv2r8",
        "qt-mysql-4.8.7-42.h9.eulerosv2r8",
        "qt-odbc-4.8.7-42.h9.eulerosv2r8",
        "qt-x11-4.8.7-42.h9.eulerosv2r8"];
