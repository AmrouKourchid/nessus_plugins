...
if (description)
{
  ...
  script_cve_id("CVE-2021-47381");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2021-47381");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: ASoC: SOF: Fix DSP oops stack dump
    output contents Fix @buf arg given to hex_dump_to_buffer() and stack address used in dump error output.
    (CVE-2021-47381)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-47381");
