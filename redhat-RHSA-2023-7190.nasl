...
# extracted from Red Hat Security Advisory RHSA-2023:7190. The text
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_7190.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?feec28ef");
...
"Update the RHEL avahi package based on the guidance in RHSA-2023:7190.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'avahi-0.7-21.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'avahi-autoipd-0.7-21.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'avahi-compat-howl-0.7-21.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'avahi-compat-howl-devel-0.7-21.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'avahi-compat-libdns_sd-0.7-21.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'avahi-compat-libdns_sd-devel-0.7-21.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'avahi-devel-0.7-21.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'avahi-glib-0.7-21.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'avahi-glib-devel-0.7-21.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'avahi-gobject-0.7-21.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'avahi-gobject-devel-0.7-21.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'avahi-libs-0.7-21.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'avahi-tools-0.7-21.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'avahi-ui-0.7-21.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'avahi-ui-devel-0.7-21.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'avahi-ui-gtk3-0.7-21.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-avahi-0.7-21.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
