...
if (description)
{
  ...
  script_name(english:"Mozilla Firefox ESR < 52.2 Multiple Vulnerabilities");
...
mozilla_check_version(installs:installs, product:'firefox', esr:TRUE, fix:'52.2', min:'52', severity:SECURITY_HOLE);
