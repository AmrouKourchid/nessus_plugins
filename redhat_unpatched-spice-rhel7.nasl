...
if (description)
{
  ...
  script_cve_id("CVE-2020-23793", "CVE-2021-20201");

  script_name(english:"RHEL 7 : spice (Unpatched Vulnerability) (deprecated)");
...
"This plugin has been deprecated as it does not adhere to established standards for this style of check.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2020-23793");
