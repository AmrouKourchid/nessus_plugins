...
if (description)
{
  ...
  script_cve_id("CVE-2017-10979");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2017-10979");
...
patch available.
  ...
  - An FR-GV-202 issue in FreeRADIUS 2.x before 2.2.10 allows Write overflow in rad_coalesce() - this allows
    remote attackers to cause a denial of service (daemon crash) or possibly execute arbitrary code.
    (CVE-2017-10979)
