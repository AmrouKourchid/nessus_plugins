...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5032192");
  script_xref(name:"MSFT", value:"MS23-5032192");
  ...
  script_name(english:"KB5032192: Windows 11 version 21H2 Security Update (November 2023)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5032192");
