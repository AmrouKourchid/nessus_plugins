...
In Tenable Nessus and Tenable Vulnerabilty Management (formerly Tenable.io), this option can be found under the 
following section in the scan policy:

  Credentials > Windows > Global Credential Settings.

In Tenable Security Center, this option can be found under the following section in the scan policy:

  Authentication > Windows.
");
 script_set_attribute(attribute:"see_also", value:"https://docs.tenable.com/nessus/Content/Windows.htm");
 # https://docs.tenable.com/vulnerability-management/Content/Scans/Host.htm?Highlight=start%20the%20remote%20registry#Windows
 script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b080ce11");
 # https://docs.tenable.com/security-center/6_4/Content/CustomScanPolicyOptions.htm#
 script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?575d44d9");
