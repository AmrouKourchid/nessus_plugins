...
if (description)
{
  ...
  script_cve_id("CVE-2017-17689");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2017-17689");
...
patch available.
  ...
  - The S/MIME specification allows a Cipher Block Chaining (CBC) malleability-gadget attack that can
    indirectly lead to plaintext exfiltration, aka EFAIL. (CVE-2017-17689)
