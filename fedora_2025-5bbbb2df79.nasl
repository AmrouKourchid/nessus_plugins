...
# extracted from Fedora Security Advisory FEDORA-2025-5bbbb2df79
#
...
if (description)
{
  ...
  script_cve_id("CVE-2025-43963", "CVE-2025-43964");
  script_xref(name:"FEDORA", value:"2025-5bbbb2df79");
  script_xref(name:"IAVA", value:"2025-A-0306");

  script_name(english:"Fedora 41 : digikam (2025-5bbbb2df79)");
...
FEDORA-2025-5bbbb2df79 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-5bbbb2df79");
...
var pkgs = [
    {'reference':'digikam-8.6.0-4.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
