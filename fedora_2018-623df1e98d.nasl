...
# extracted from Fedora Security Advisory FEDORA-2018-623df1e98d.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-623df1e98d");

  script_name(english:"Fedora 28 : wordpress (2018-623df1e98d)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"Update to 4.9.7 security release.
https://wordpress.org/news/2018/07/wordpress-4-9-7-security-and-mainte
nance-release/
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-623df1e98d");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"wordpress-4.9.7-1.fc28")) flag++;
