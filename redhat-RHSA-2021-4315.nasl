...
# extracted from Red Hat Security Advisory RHSA-2021:4315. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:4315");

  script_name(english:"RHEL 8 : spamassassin (RHSA-2021:4315)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_4315.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5c8ac48c");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/8.5_release_notes/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7240878e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:4315");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1943276");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL spamassassin package based on the guidance in RHSA-2021:4315.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'spamassassin-3.4.4-4.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
