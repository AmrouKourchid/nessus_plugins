...
# extracted from Gentoo Linux Security Advisory GLSA 202210-05.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202210-05 : virglrenderer: Multiple vulnerabilities");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202210-05");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=866821");
...
"All virglrenderer users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:virglrenderer");
...
var packages = [
  {
    'name' : "media-libs/virglrenderer",
    'unaffected' : make_list("ge 0.10.1", "lt 0.0.0"),
