...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : dbus on SL7.x x86_64 (20201001)");
...
"Security Fix(es) :
  ...
  - dbus: DBusServer DBUS_COOKIE_SHA1 authentication bypass
    (CVE-2019-12749)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind2010&L=SCIENTIFIC-LINUX-ERRATA&P=4689
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?afc58d84");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"dbus-1.10.24-15.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"dbus-debuginfo-1.10.24-15.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"dbus-devel-1.10.24-15.el7")) flag++;
if (rpm_check(release:"SL7", reference:"dbus-doc-1.10.24-15.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"dbus-libs-1.10.24-15.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"dbus-tests-1.10.24-15.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"dbus-x11-1.10.24-15.el7")) flag++;
