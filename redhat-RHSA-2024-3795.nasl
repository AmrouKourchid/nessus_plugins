...
# extracted from Red Hat Security Advisory RHSA-2024:3795. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:3795");

  script_name(english:"RHEL 8 : fence-agents (RHSA-2024:3795)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for fence-agents.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:3795 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_3795.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7c91c102");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2279476");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:3795");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL fence-agents package based on the guidance in RHSA-2024:3795.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'fence-agents-all-4.2.1-65.el8_4.15', 'sp':'4', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fence-agents-all-4.2.1-65.el8_4.15', 'sp':'4', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fence-agents-amt-ws-4.2.1-65.el8_4.15', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fence-agents-apc-4.2.1-65.el8_4.15', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fence-agents-apc-snmp-4.2.1-65.el8_4.15', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fence-agents-bladecenter-4.2.1-65.el8_4.15', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fence-agents-brocade-4.2.1-65.el8_4.15', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fence-agents-cisco-mds-4.2.1-65.el8_4.15', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fence-agents-cisco-ucs-4.2.1-65.el8_4.15', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fence-agents-common-4.2.1-65.el8_4.15', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fence-agents-compute-4.2.1-65.el8_4.15', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fence-agents-drac5-4.2.1-65.el8_4.15', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fence-agents-eaton-snmp-4.2.1-65.el8_4.15', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fence-agents-emerson-4.2.1-65.el8_4.15', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fence-agents-eps-4.2.1-65.el8_4.15', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fence-agents-heuristics-ping-4.2.1-65.el8_4.15', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fence-agents-hpblade-4.2.1-65.el8_4.15', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fence-agents-ibm-powervs-4.2.1-65.el8_4.15', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fence-agents-ibm-vpc-4.2.1-65.el8_4.15', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fence-agents-ibmblade-4.2.1-65.el8_4.15', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fence-agents-ifmib-4.2.1-65.el8_4.15', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fence-agents-ilo-moonshot-4.2.1-65.el8_4.15', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fence-agents-ilo-mp-4.2.1-65.el8_4.15', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fence-agents-ilo-ssh-4.2.1-65.el8_4.15', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fence-agents-ilo2-4.2.1-65.el8_4.15', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fence-agents-intelmodular-4.2.1-65.el8_4.15', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fence-agents-ipdu-4.2.1-65.el8_4.15', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fence-agents-ipmilan-4.2.1-65.el8_4.15', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fence-agents-kdump-4.2.1-65.el8_4.15', 'sp':'4', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fence-agents-kdump-4.2.1-65.el8_4.15', 'sp':'4', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fence-agents-kubevirt-4.2.1-65.el8_4.15', 'sp':'4', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fence-agents-kubevirt-4.2.1-65.el8_4.15', 'sp':'4', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fence-agents-lpar-4.2.1-65.el8_4.15', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fence-agents-mpath-4.2.1-65.el8_4.15', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fence-agents-redfish-4.2.1-65.el8_4.15', 'sp':'4', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fence-agents-redfish-4.2.1-65.el8_4.15', 'sp':'4', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fence-agents-rhevm-4.2.1-65.el8_4.15', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fence-agents-rsa-4.2.1-65.el8_4.15', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fence-agents-rsb-4.2.1-65.el8_4.15', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fence-agents-sbd-4.2.1-65.el8_4.15', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fence-agents-scsi-4.2.1-65.el8_4.15', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fence-agents-virsh-4.2.1-65.el8_4.15', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fence-agents-vmware-rest-4.2.1-65.el8_4.15', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fence-agents-vmware-soap-4.2.1-65.el8_4.15', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fence-agents-wti-4.2.1-65.el8_4.15', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'fence-agents-aliyun-4.2.1-65.el8_4.15', 'sp':'4', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fence-agents-aws-4.2.1-65.el8_4.15', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fence-agents-azure-arm-4.2.1-65.el8_4.15', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fence-agents-gce-4.2.1-65.el8_4.15', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
