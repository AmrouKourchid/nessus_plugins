...
# extracted from Red Hat Security Advisory RHSA-2023:6707. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:6707");

  script_name(english:"RHEL 9 : avahi (RHSA-2023:6707)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for avahi.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2023:6707 advisory.
    ...
    * avahi: reachable assertion in avahi_s_host_name_resolver_start when trying to resolve badly-formatted
    hostnames (CVE-2021-3502)
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6707.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e21cf144");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1939614");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1946914");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2185911");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6707");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL avahi package based on the guidance in RHSA-2023:6707.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'avahi-0.8-15.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'avahi-compat-howl-0.8-15.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'avahi-compat-howl-devel-0.8-15.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'avahi-compat-libdns_sd-0.8-15.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'avahi-compat-libdns_sd-devel-0.8-15.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'avahi-devel-0.8-15.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'avahi-glib-0.8-15.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'avahi-glib-devel-0.8-15.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'avahi-libs-0.8-15.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'avahi-tools-0.8-15.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
