...
# extracted from VMware Security Advisory PHSA-2021-2.0-0330. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Nodejs PHSA-2021-2.0-0330");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the nodejs package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-2-330.md");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'nodejs-10.24.0-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'nodejs-devel-10.24.0-1.ph2')) flag++;
