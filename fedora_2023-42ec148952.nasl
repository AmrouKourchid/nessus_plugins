...
# extracted from Fedora Security Advisory FEDORA-2023-42ec148952
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-42ec148952");

  script_name(english:"Fedora 37 : libreswan (2023-42ec148952)");
...
FEDORA-2023-42ec148952 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-42ec148952");
...
var pkgs = [
    {'reference':'libreswan-4.10-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
