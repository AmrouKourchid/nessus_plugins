...
# CentOS Errata and Security Advisory 2018:3833 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : firefox (CESA-2018:3833)");
...
original reporters.");
  # https://lists.centos.org/pipermail/centos-announce/2018-December/023139.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?17cd98d0");
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"firefox-60.4.0-1.el7.centos", allowmaj:TRUE)) flag++;
