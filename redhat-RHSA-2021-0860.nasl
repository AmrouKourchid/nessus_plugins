...
# extracted from Red Hat Security Advisory RHSA-2021:0860. The text
...
the RHSA-2021:0860 advisory.
    ...
    * improve IPA PKI susbsystem detection by other means than a directory presence, use pki-server subsystem-
    find (BZ#1895197)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_0860.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ebf14bec");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:0860");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1846349");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1850004");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1863619");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1884819");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1892793");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1895197");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1897253");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL ipa package based on the guidance in RHSA-2021:0860.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ipa-client-4.6.8-5.el7_9.4', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-client-4.6.8-5.el7_9.4', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-client-4.6.8-5.el7_9.4', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-client-4.6.8-5.el7_9.4', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-client-common-4.6.8-5.el7_9.4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-common-4.6.8-5.el7_9.4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-python-compat-4.6.8-5.el7_9.4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-server-4.6.8-5.el7_9.4', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-server-common-4.6.8-5.el7_9.4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-server-dns-4.6.8-5.el7_9.4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-server-trust-ad-4.6.8-5.el7_9.4', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python2-ipaclient-4.6.8-5.el7_9.4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python2-ipalib-4.6.8-5.el7_9.4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python2-ipaserver-4.6.8-5.el7_9.4', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
