...
# extracted from Ubuntu Security Notice USN-5811-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5811-2");

  script_name(english:"Ubuntu 16.04 ESM : Sudo vulnerability (USN-5811-2)");
...
USN-5811-2 advisory.
    ...
    USN-5811-1 fixed a vulnerability in Sudo. This update provides the corresponding update for Ubuntu 16.04
    ESM.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5811-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'sudo', 'pkgver': '1.8.16-0ubuntu1.10+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'sudo-ldap', 'pkgver': '1.8.16-0ubuntu1.10+esm1', 'ubuntu_pro': TRUE}
];
