...
if (description)
{
  ...
  script_name(english:"RHCOS 4 : Red Hat OpenShift Enterprise (RHSA-2023:3910)");
...
as referenced in the RHSA-2023:3910 advisory.
...
"Update the RHCOS Red Hat OpenShift Enterprise package based on the guidance in RHSA-2023:3910.");
...
var pkgs = [
    {'reference':'containers-common-1.2.4-1.1.el8', 'release':'4', 'el_string':'el8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openshift-hyperkube'},
    {'reference':'openshift-hyperkube-4.10.0-202306170106.p0.g16bcd69.assembly.stream.el7', 'cpu':'x86_64', 'release':'4', 'el_string':'el7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
    {'reference':'openshift-hyperkube-4.10.0-202306170106.p0.g16bcd69.assembly.stream.el8', 'release':'4', 'el_string':'el8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
    {'reference':'podman-3.2.3-1.1.rhaos4.10.el8', 'release':'4', 'el_string':'el8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
    {'reference':'podman-catatonit-3.2.3-1.1.rhaos4.10.el8', 'release':'4', 'el_string':'el8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
    {'reference':'podman-docker-3.2.3-1.1.rhaos4.10.el8', 'release':'4', 'el_string':'el8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
    {'reference':'podman-plugins-3.2.3-1.1.rhaos4.10.el8', 'release':'4', 'el_string':'el8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
    {'reference':'podman-remote-3.2.3-1.1.rhaos4.10.el8', 'release':'4', 'el_string':'el8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
    {'reference':'podman-tests-3.2.3-1.1.rhaos4.10.el8', 'release':'4', 'el_string':'el8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
    {'reference':'skopeo-1.2.4-1.1.el8', 'release':'4', 'el_string':'el8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openshift-hyperkube'},
    {'reference':'skopeo-tests-1.2.4-1.1.el8', 'release':'4', 'el_string':'el8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openshift-hyperkube'}
];
