...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.0 : sssd (EulerOS-SA-2023-2481)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2481
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f36e2993");
...
var pkgs = [
  "python3-sssd-2.2.2-6.h16.eulerosv2r10",
  "sssd-2.2.2-6.h16.eulerosv2r10"
];
