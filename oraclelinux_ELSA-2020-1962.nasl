...
# Oracle Linux Security Advisory ELSA-2020-1962 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : python-twisted-web (ELSA-2020-1962)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2020-1962.html");
