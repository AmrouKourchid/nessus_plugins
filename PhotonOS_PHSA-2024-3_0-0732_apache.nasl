...
# extracted from VMware Security Advisory PHSA-2024-3.0-0732. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Apache PHSA-2024-3.0-0732");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the apache package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-3.0-732.md");
...
if (rpm_check(release:'PhotonOS-3.0', reference:'apache-tomcat-8.5.96-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', reference:'apache-tomcat-webapps-8.5.96-1.ph3')) flag++;
