...
# extracted from Red Hat Security Advisory RHSA-2022:7469. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 8 : container-tools:4.0 (RHSA-2022:7469)");
...
referenced in the RHSA-2022:7469 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_7469.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?860a26bb");
...
"Update the RHEL container-tools:4.0 package based on the guidance in RHSA-2022:7469.");
  ...
  'container-tools:4.0': [
    {
      ...
      'pkgs': [
        {'reference':'aardvark-dns-1.0.1-35.module+el8.7.0+16520+2db5507d', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'buildah-1.24.5-2.module+el8.7.0+16520+2db5507d', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'buildah-tests-1.24.5-2.module+el8.7.0+16520+2db5507d', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'cockpit-podman-46-1.module+el8.7.0+16520+2db5507d', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
        {'reference':'conmon-2.1.4-1.module+el8.7.0+16520+2db5507d', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'container-selinux-2.189.0-1.module+el8.7.0+16520+2db5507d', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'containernetworking-plugins-1.1.1-2.module+el8.7.0+16520+2db5507d', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'containers-common-1-35.module+el8.7.0+16520+2db5507d', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'allowmaj':TRUE},
        {'reference':'crit-3.15-3.module+el8.7.0+16520+2db5507d', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'criu-3.15-3.module+el8.7.0+16520+2db5507d', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'criu-devel-3.15-3.module+el8.7.0+16520+2db5507d', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'criu-libs-3.15-3.module+el8.7.0+16520+2db5507d', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'crun-1.5-1.module+el8.7.0+16520+2db5507d', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'fuse-overlayfs-1.9-1.module+el8.7.0+16520+2db5507d', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'libslirp-4.4.0-1.module+el8.7.0+16520+2db5507d', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'libslirp-devel-4.4.0-1.module+el8.7.0+16520+2db5507d', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'netavark-1.0.1-35.module+el8.7.0+16520+2db5507d', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'oci-seccomp-bpf-hook-1.2.5-1.module+el8.7.0+16520+2db5507d', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'podman-4.0.2-8.module+el8.7.0+16520+2db5507d', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'podman-catatonit-4.0.2-8.module+el8.7.0+16520+2db5507d', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'podman-docker-4.0.2-8.module+el8.7.0+16520+2db5507d', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'podman-gvproxy-4.0.2-8.module+el8.7.0+16520+2db5507d', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'podman-plugins-4.0.2-8.module+el8.7.0+16520+2db5507d', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'podman-remote-4.0.2-8.module+el8.7.0+16520+2db5507d', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'podman-tests-4.0.2-8.module+el8.7.0+16520+2db5507d', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'python3-criu-3.15-3.module+el8.7.0+16520+2db5507d', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-podman-4.0.0-1.module+el8.7.0+16520+2db5507d', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'runc-1.1.4-1.module+el8.7.0+16520+2db5507d', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'skopeo-1.6.2-5.module+el8.7.0+16520+2db5507d', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'skopeo-tests-1.6.2-5.module+el8.7.0+16520+2db5507d', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'slirp4netns-1.1.8-2.module+el8.7.0+16520+2db5507d', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'toolbox-0.0.99.3-0.5.module+el8.7.0+16520+2db5507d', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'toolbox-tests-0.0.99.3-0.5.module+el8.7.0+16520+2db5507d', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'udica-0.2.6-3.module+el8.7.0+16520+2db5507d', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
