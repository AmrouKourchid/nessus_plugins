...
# SUSE update advisory SUSE-SU-2023:2100-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:2100-1");

  script_name(english:"SUSE SLES15 Security Update : terraform-provider-helm (SUSE-SU-2023:2100-1)");
...
in the SUSE-SU-2023:2100-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-May/014768.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f6a6869a");
...
var pkgs = [
    {'reference':'terraform-provider-helm-2.9.0-150100.3.6.3', 'sp':'1', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.1']},
    {'reference':'terraform-provider-helm-2.9.0-150100.3.6.3', 'sp':'1', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.1', 'sle-module-public-cloud-release-15.1', 'sles-release-15.1']}
];
