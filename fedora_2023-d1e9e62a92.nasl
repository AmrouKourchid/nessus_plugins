...
# extracted from Fedora Security Advisory FEDORA-2023-d1e9e62a92
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-d1e9e62a92");

  script_name(english:"Fedora 39 : ghostwriter (2023-d1e9e62a92)");
...
FEDORA-2023-d1e9e62a92 advisory.
    ...
    * Fri Mar 31 2023 Marc Deop i Argem <marcdeop@fedoraproject.org> - 23.03.90-1
    - 23.03.90
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-d1e9e62a92");
  script_set_attribute(attribute:"solution", value:
"Update the affected ghostwriter package.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:S/C:N/I:N/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:L/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-39209");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:ghostwriter");
...
var pkgs = [
    {'reference':'ghostwriter-23.03.90-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'ghostwriter');
}
