...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Cairo PHSA-2021-2.0-0340");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'cairo-1.16.0-2.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'cairo-devel-1.16.0-2.ph2')) flag++;
