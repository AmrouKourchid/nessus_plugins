...
# extracted from Fedora Security Advisory FEDORA-2025-d4d7cfe35a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-d4d7cfe35a");

  script_name(english:"Fedora 40 : libxslt (2025-d4d7cfe35a)");
...
FEDORA-2025-d4d7cfe35a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-d4d7cfe35a");
...
var pkgs = [
    {'reference':'libxslt-1.1.43-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
