...
# extracted from Fedora Security Advisory FEDORA-2024-9ffc6cc7bf
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-9ffc6cc7bf");

  script_name(english:"Fedora 40 : mingw-libxml2 (2024-9ffc6cc7bf)");
...
FEDORA-2024-9ffc6cc7bf advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-9ffc6cc7bf");
...
var pkgs = [
    {'reference':'mingw-libxml2-2.12.7-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
