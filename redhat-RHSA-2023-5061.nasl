...
# extracted from Red Hat Security Advisory RHSA-2023:5061. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:5061");

  script_name(english:"RHEL 9 : dmidecode (RHSA-2023:5061)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for dmidecode.");
...
the RHSA-2023:5061 advisory.

    The dmidecode packages provide utilities for extracting Intel 64 and Intel Itanium hardware information
    from the system BIOS or Extensible Firmware Interface (EFI), depending on the SMBIOS/DMI standard. This
    information typically includes system manufacturer, model name, serial number, BIOS version, and asset
    tag, as well as other details, depending on the manufacturer.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_5061.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c0be6935");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2186669");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:5061");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL dmidecode package based on the guidance in RHSA-2023:5061.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:dmidecode");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'dmidecode-3.3-7.el9_2.1', 'sp':'2', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'dmidecode-3.3-7.el9_2.1', 'sp':'2', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'dmidecode-3.3-7.el9_2.1', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'dmidecode-3.3-7.el9_2.1', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
