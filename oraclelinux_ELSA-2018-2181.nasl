...
# Oracle Linux Security Advisory ELSA-2018-2181 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : gnupg2 (ELSA-2018-2181)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 7 host has packages installed that are affected by a vulnerability as referenced in the
ELSA-2018-2181 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2018-2181.html");
...
var pkgs = [
    {'reference':'gnupg2-2.0.22-5.el7_5', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'gnupg2-smime-2.0.22-5.el7_5', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'gnupg2-2.0.22-5.el7_5', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'gnupg2-smime-2.0.22-5.el7_5', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
];
