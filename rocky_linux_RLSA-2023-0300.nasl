...
# Rocky Linux Security Advisory RLSA-2023:0300.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2023:0300");

  script_name(english:"Rocky Linux 9 : kernel-rt (RLSA-2023:0300)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2023:0300");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for RLSA-2023:0300');
  }
  else
  {
...
var pkgs = [
    ...
    {'reference':'kernel-rt-debug-debuginfo-5.14.0-162.12.1.rt21.175.el9_1', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'kernel-rt-debuginfo-5.14.0-162.12.1.rt21.175.el9_1', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
