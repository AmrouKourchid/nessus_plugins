...
# extracted from Ubuntu Security Notice USN-6071-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6071-1");

  script_name(english:"Ubuntu 22.04 LTS : Linux kernel (OEM) vulnerabilities (USN-6071-1)");
...
the USN-6071-1 advisory.
    ...
    David Hildenbrand discovered that a race condition existed in the memory manager of the Linux kernel when
    handling copy-on-write with shared memory pages. A local attacker could use this to cause a denial of
    service (system crash) or execute arbitrary code. (CVE-2022-2590)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6071-1");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.17.0-1031-oem");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-6071-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2022-2590', 'CVE-2022-3303', 'CVE-2022-3586', 'CVE-2022-4095', 'CVE-2022-4662', 'CVE-2022-40307', 'CVE-2023-0386', 'CVE-2023-0468', 'CVE-2023-1829', 'CVE-2023-1859', 'CVE-2023-23455', 'CVE-2023-26545');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-6071-1');
  }
  else
  {
