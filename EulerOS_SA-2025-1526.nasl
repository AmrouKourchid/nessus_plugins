...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : libxml2 (EulerOS-SA-2025-1526)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1526
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2f6acaaf");
...
var pkgs = [
  "libxml2-2.9.10-11.h32.eulerosv2r10",
  "python3-libxml2-2.9.10-11.h32.eulerosv2r10"
];
