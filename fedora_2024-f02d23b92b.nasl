...
# extracted from Fedora Security Advisory FEDORA-2024-f02d23b92b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-f02d23b92b");

  script_name(english:"Fedora 40 : xmedcon (2024-f02d23b92b)");
...
FEDORA-2024-f02d23b92b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-f02d23b92b");
  script_set_attribute(attribute:"solution", value:
"Update the affected xmedcon package.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-29421");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:xmedcon");
...
var pkgs = [
    {'reference':'xmedcon-0.24.0-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'xmedcon');
}
