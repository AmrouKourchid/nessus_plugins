...
if (description)
{
  ...
  script_name(english:"Atlassian Confluence 1.0.1  < 7.19.18 / 7.20.x < 8.5.5 / 8.6.x < 8.7.2 / 8.8.0 (CONFSERVER-94106)");
...
the CONFSERVER-94106 advisory.

  - This High severity org.apache.struts:struts2-core Dependency vulnerability was introduced in versions 1.0.1 of 
    Confluence Data Center and Server.(CVE-2023-41835)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://jira.atlassian.com/browse/CONFSERVER-94106");
...
var constraints = [
  { 'min_version' : '1.0.1', 'max_version' : '7.17.5', 'fixed_display' : '7.19.19' },
  ...
  { 'min_version' : '8.5.0', 'max_version' : '8.5.4', 'fixed_display' : '8.5.5 / 8.5.6' },
  { 'min_version' : '8.6.0', 'max_version' : '8.6.1', 'fixed_display' : '8.8.0 (Data Center Only)' },
  { 'min_version' : '8.7.0', 'max_version' : '8.7.1', 'fixed_display' : '8.7.1 / 8.8.0 (Data Center Only)' }
];
