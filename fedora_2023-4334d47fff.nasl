...
# extracted from Fedora Security Advisory FEDORA-2023-4334d47fff
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-4334d47fff");

  script_name(english:"Fedora 39 : dotnet7.0 (2023-4334d47fff)");
...
FEDORA-2023-4334d47fff advisory.

    This is the November 2023 monthly update for .NET 7. It includes several security fixes.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-4334d47fff");
...
var pkgs = [
    {'reference':'dotnet7.0-7.0.114-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
