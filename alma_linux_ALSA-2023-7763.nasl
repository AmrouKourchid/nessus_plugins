...
# AlmaLinux Security Advisory ALSA-2023:7763.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:7763");
  script_xref(name:"IAVB", value:"2023-B-0064-S");
  script_xref(name:"IAVB", value:"2023-B-0068-S");

  script_name(english:"AlmaLinux 9 : runc (ALSA-2023:7763)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2023-7763.html");
...
var pkgs = [
    {'reference':'runc-1.1.9-2.el9_3', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
    {'reference':'runc-1.1.9-2.el9_3', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'}
];
