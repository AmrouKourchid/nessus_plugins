...
the USN-5558-1 advisory.
    ...
    Zhao Liang discovered that libcdio was not properly performing memory management operations when
    processing ISO files, which could result in a heap buffer overflow or in a NULL pointer dereference. If a
    user or automated system were tricked into opening a specially crafted file, an attacker could possibly
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libcdio-cdda-dev', 'pkgver': '0.83-4.2ubuntu1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libcdio-cdda1', 'pkgver': '0.83-4.2ubuntu1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libcdio-dev', 'pkgver': '0.83-4.2ubuntu1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libcdio-paranoia-dev', 'pkgver': '0.83-4.2ubuntu1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libcdio-paranoia1', 'pkgver': '0.83-4.2ubuntu1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libcdio-utils', 'pkgver': '0.83-4.2ubuntu1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libcdio13', 'pkgver': '0.83-4.2ubuntu1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libiso9660-8', 'pkgver': '0.83-4.2ubuntu1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libiso9660-dev', 'pkgver': '0.83-4.2ubuntu1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libudf-dev', 'pkgver': '0.83-4.2ubuntu1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libudf0', 'pkgver': '0.83-4.2ubuntu1+esm1', 'ubuntu_pro': TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libcdio-cdda-dev / libcdio-cdda1 / libcdio-dev / etc');
}
