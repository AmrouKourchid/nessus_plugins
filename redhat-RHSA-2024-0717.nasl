...
# extracted from Red Hat Security Advisory RHSA-2024:0717. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:0717");
  script_xref(name:"IAVA", value:"2024-A-0071");

  script_name(english:"RHEL 7 : runc (RHSA-2024:0717)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f95c578f");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0717");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL runc package based on the guidance in RHSA-2024:0717.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'runc-1.0.0-70.rc10.el7_9', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'runc-1.0.0-70.rc10.el7_9', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'runc-1.0.0-70.rc10.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
