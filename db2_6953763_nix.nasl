...
if (description)
{
  ...
  script_name(english:"IBM DB2 11.1 < 11.1.4 FP6 41246 / 11.5 < 11.5.8  FP0 26513 Denial of Service (Unix)");

  script_set_attribute(attribute:"synopsis", value:
"The remote database server is affected by a denial of service vulnerability.");
  script_set_attribute(attribute:"description", value:
"According to its self-reported version number, IBM Db2 is affected by a denial of service when executing a
specially crafted 'Load' command.
