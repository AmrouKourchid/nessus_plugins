...
if (description)
{
  ...
  script_cve_id("CVE-2025-32414");
  script_xref(name:"IAVA", value:"2025-A-0229-S");

  script_name(english:"Photon OS 5.0: Libxml2 PHSA-2025-5.0-0516");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'libxml2-2.12.10-3.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'libxml2-devel-2.12.10-3.ph5')) flag++;
