...
# extracted from Red Hat Security Advisory RHSA-2023:7792. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:7792");

  script_name(english:"RHEL 9 : gstreamer1-plugins-bad-free (RHSA-2023:7792)");
...
referenced in the RHSA-2023:7792 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_7792.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c26b8274");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:7792");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL gstreamer1-plugins-bad-free package based on the guidance in RHSA-2023:7792.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gstreamer1-plugins-bad-free-1.18.4-7.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gstreamer1-plugins-bad-free-devel-1.18.4-7.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
