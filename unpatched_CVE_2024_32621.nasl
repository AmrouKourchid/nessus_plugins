...
if (description)
{
  ...
  script_cve_id("CVE-2024-32621");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-32621");
...
patch available.
  ...
  - HDF5 Library through 1.14.3 contains a heap-based buffer overflow in H5HG_read in H5HG.c (called from
    H5VL__native_blob_get in H5VLnative_blob.c), resulting in the corruption of the instruction pointer.
    (CVE-2024-32621)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-32621");
