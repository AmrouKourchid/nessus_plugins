...
# extracted from Fedora Security Advisory FEDORA-2024-a2129a4eb5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-a2129a4eb5");

  script_name(english:"Fedora 39 : sos (2024-a2129a4eb5)");
...
FEDORA-2024-a2129a4eb5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-a2129a4eb5");
...
var pkgs = [
    {'reference':'sos-4.6.1-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
