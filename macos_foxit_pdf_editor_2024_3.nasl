...
if (description)
{
  ...
  script_name(english:"Foxit PDF Editor for Mac < 2024.3 Multiple Vulnerabilities");
...
on the remote macOS host is prior to 2024.3. It is, therefore affected by multiple vulnerabilities:
...
"Upgrade to Foxit PDF Editor for Mac version 2024.3 or later");
...
var constraints = [
  { 'max_version' : '11.1.9.0524', 'fixed_version' : '2024.3' },
  { 'min_version' : '12.0', 'max_version' : '12.1.5.55449', 'fixed_version' : '2024.3' },
  { 'min_version' : '13.0', 'max_version' : '13.1.2.62201', 'fixed_version' : '2024.3' },
  { 'min_version' : '2023.0', 'max_version' : '2023.3.0.63083', 'fixed_version' : '2024.3' },
  { 'min_version' : '2024.0', 'max_version' : '2024.2.3.64402', 'fixed_version' : '2024.3' }
];
