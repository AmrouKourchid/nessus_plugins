...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : openldap (EulerOS-SA-2023-3439)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3439
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?87c6708d");
...
var pkgs = [
  "openldap-2.4.46-8.h17.eulerosv2r8",
  "openldap-clients-2.4.46-8.h17.eulerosv2r8",
  "openldap-devel-2.4.46-8.h17.eulerosv2r8",
  "openldap-servers-2.4.46-8.h17.eulerosv2r8"
];
