...
# extracted from Amazon Linux 2 Security Advisory ALAS-2023-2324.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : cri-tools (ALAS-2023-2324)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of cri-tools installed on the remote host is prior to 1.26.1-1. It is, therefore, affected by a
vulnerability as referenced in the ALAS2-2023-2324 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2023-2324.html");
...
var pkgs = [
    {'reference':'cri-tools-1.26.1-1.amzn2.0.3', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cri-tools-1.26.1-1.amzn2.0.3', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cri-tools-debuginfo-1.26.1-1.amzn2.0.3', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cri-tools-debuginfo-1.26.1-1.amzn2.0.3', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
