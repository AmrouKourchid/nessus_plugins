...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2013-1473.html");
...
var pkgs = [
    {'reference':'spice-server-0.12.0-12.el6_4.5', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'spice-server-devel-0.12.0-12.el6_4.5', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
];
