...
# SUSE update advisory SUSE-SU-2024:3228-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2024:3228-1");
  script_xref(name:"IAVB", value:"2024-B-0134");

  script_name(english:"SUSE SLES12 Security Update : clamav (SUSE-SU-2024:3228-1)");
...
referenced in the SUSE-SU-2024:3228-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2024-September/019429.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?048f611c");
...
var pkgs = [
    {'reference':'clamav-0.103.12-3.33.1', 'sp':'5', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5']},
    {'reference':'clamav-0.103.12-3.33.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.5']}
];
