...
"The remote Red Hat host is missing one or more security updates for OpenShift Container Platform 4.10.5.");
...
referenced in the RHSA-2022:0927 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.10.5. See the following
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_0927.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?88982ec5");
...
"Update the RHEL OpenShift Container Platform 4.10.5 packages based on the guidance in RHSA-2022:0927.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'containernetworking-plugins-0.9.1-2.rhaos4.10.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2021-44716', 'CVE-2021-44717']},
      {'reference':'runc-1.1.0-2.rhaos4.10.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2021-44717']}
    ]
  }
];
