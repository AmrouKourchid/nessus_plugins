...
if (description)
{
  ...
  script_xref(name:"APPLE-SA", value:"HT213906");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2023/10/02");
  script_xref(name:"IAVA", value:"2023-A-0468-S");

  script_name(english:"macOS 13.x < 13.5.2 (HT213906)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host is missing a macOS update that fixes a vulnerability");
  script_set_attribute(attribute:"description", value:
"The remote host is running a version of macOS / Mac OS X that is 13.x prior to 13.5.2. It is, therefore, affected by a
vulnerability:

  - A buffer overflow issue was addressed with improved memory handling. (CVE-2023-41064)

Note that Nessus has not tested for this issue but has instead relied only on the operating system's self-reported
version number.");
  script_set_attribute(attribute:"see_also", value:"https://support.apple.com/en-us/HT213906");
  script_set_attribute(attribute:"solution", value:
"Upgrade to macOS 13.5.2 or later.");
...
var constraints = [
  { 'fixed_version' : '13.5.2', 'min_version' : '13.0', 'fixed_display' : 'macOS Ventura 13.5.2' }
];
