...
if (description)
{
  ...
  script_name(english:"Atlassian Confluence 7.19.x < 7.19.26 (CONFSERVER-98190)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://jira.atlassian.com/browse/CONFSERVER-98190");
