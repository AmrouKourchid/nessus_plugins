...
if (description)
{
  ...
  script_name(english:"Security Updates for Microsoft Outlook Products C2R (January 2025)");

  script_set_attribute(attribute:"synopsis", value:
"The Microsoft Outlook Products are missing a security update.");
  script_set_attribute(attribute:"description", value:
"The Microsoft Outlook Products are missing a security update. It is, therefore, affected by a 
