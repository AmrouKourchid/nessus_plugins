...
if (description)
{
  ...
  script_name(english:"Adobe Dreamweaver 18.0.0 < 18.2.1 / 19.0 < 19.1 Sensitive data disclosure if SMB request is subject to a relay attack (APSB19-21)");
...
"The version of Adobe Dreamweaver installed on the remote Windows host is prior to 18.2.1, 19.1. It is, therefore,
affected by a vulnerability as referenced in the APSB19-21 advisory.
