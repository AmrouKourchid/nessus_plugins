...
# extracted from Red Hat Security Advisory RHSA-2023:0812. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : firefox (RHSA-2023:0812)");
...
referenced in the RHSA-2023:0812 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_0812.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ce0c71eb");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:0812");
...
"Update the RHEL firefox package based on the guidance in RHSA-2023:0812.");
  ...
  script_cwe_id(84, 120, 173, 357, 416, 704, 787, 821, 1021);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-102.8.0-2.el7_9', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-102.8.0-2.el7_9', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-102.8.0-2.el7_9', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-102.8.0-2.el7_9', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-102.8.0-2.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
