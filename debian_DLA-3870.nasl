...
# extracted from Debian Security Advisory dla-3870. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3870 : python-oslo.utils-doc - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has packages installed that are affected by a vulnerability as referenced in the dla-3870
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bullseye/python-oslo.utils");
  script_set_attribute(attribute:"solution", value:
"Upgrade the python-oslo.utils-doc packages.");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'python-oslo.utils-doc', 'reference': '4.6.1-0+deb11u1'},
    {'release': '11.0', 'prefix': 'python3-oslo.utils', 'reference': '4.6.1-0+deb11u1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python-oslo.utils-doc / python3-oslo.utils');
}
