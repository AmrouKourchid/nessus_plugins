...
# extracted from Fedora Security Advisory FEDORA-2024-aab6aded81
#
...
if (description)
{
  script_id(211740);
  script_version("1.1");
  script_set_attribute(attribute:"plugin_modification_date", value:"2024/11/23");

  script_cve_id("CVE-2024-43498", "CVE-2024-43499");
  script_xref(name:"FEDORA", value:"2024-aab6aded81");

  script_name(english:"Fedora 41 : dotnet9.0 (2024-aab6aded81)");
...
FEDORA-2024-aab6aded81 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-aab6aded81");
  script_set_attribute(attribute:"solution", value:
"Update the affected dotnet9.0 package.");
  ...
  script_set_attribute(attribute:"plugin_publication_date", value:"2024/11/23");

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"cpe:/o:fedoraproject:fedora:41");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:dotnet9.0");
...
var pkgs = [
    {'reference':'dotnet9.0-9.0.100-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'dotnet9.0');
}
