...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : OpenStack Neutron vulnerabilities (USN-2255-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 14.04 LTS host has packages installed that are affected by multiple vulnerabilities as referenced in
the USN-2255-1 advisory.

    Darragh O'Reilly discovered that the Ubuntu packaging for OpenStack Neutron did not properly set up its
    sudo configuration. If a different flaw was found in OpenStack Neutron, this vulnerability could be used
    to escalate privileges. (CVE-2013-6433)

    Stephen Ma and Christoph Thiel discovered that the openvswitch-agent in OpenStack Neutron did not properly
    perform input validation when creating security group rules when specifying --remote-ip-prefix. A remote
    authenticated attacker could exploit this to prevent application of additional rules. (CVE-2014-0187)

    Thiago Martins discovered that OpenStack Neutron would inappropriately apply SNAT rules to IPv6 subnets
    when using the L3-agent. A remote authenticated attacker could exploit this to prevent floating IPv4
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2255-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'neutron-common', 'pkgver': '1:2014.1-0ubuntu1.3'},
    {'osver': '14.04', 'pkgname': 'neutron-dhcp-agent', 'pkgver': '1:2014.1-0ubuntu1.3'},
    {'osver': '14.04', 'pkgname': 'neutron-l3-agent', 'pkgver': '1:2014.1-0ubuntu1.3'},
    {'osver': '14.04', 'pkgname': 'neutron-lbaas-agent', 'pkgver': '1:2014.1-0ubuntu1.3'},
    {'osver': '14.04', 'pkgname': 'neutron-metadata-agent', 'pkgver': '1:2014.1-0ubuntu1.3'},
    {'osver': '14.04', 'pkgname': 'neutron-metering-agent', 'pkgver': '1:2014.1-0ubuntu1.3'},
    {'osver': '14.04', 'pkgname': 'neutron-plugin-bigswitch', 'pkgver': '1:2014.1-0ubuntu1.3'},
    {'osver': '14.04', 'pkgname': 'neutron-plugin-bigswitch-agent', 'pkgver': '1:2014.1-0ubuntu1.3'},
    {'osver': '14.04', 'pkgname': 'neutron-plugin-brocade', 'pkgver': '1:2014.1-0ubuntu1.3'},
    {'osver': '14.04', 'pkgname': 'neutron-plugin-cisco', 'pkgver': '1:2014.1-0ubuntu1.3'},
    {'osver': '14.04', 'pkgname': 'neutron-plugin-hyperv', 'pkgver': '1:2014.1-0ubuntu1.3'},
    {'osver': '14.04', 'pkgname': 'neutron-plugin-ibm', 'pkgver': '1:2014.1-0ubuntu1.3'},
    {'osver': '14.04', 'pkgname': 'neutron-plugin-ibm-agent', 'pkgver': '1:2014.1-0ubuntu1.3'},
    {'osver': '14.04', 'pkgname': 'neutron-plugin-linuxbridge', 'pkgver': '1:2014.1-0ubuntu1.3'},
    {'osver': '14.04', 'pkgname': 'neutron-plugin-linuxbridge-agent', 'pkgver': '1:2014.1-0ubuntu1.3'},
    {'osver': '14.04', 'pkgname': 'neutron-plugin-metaplugin', 'pkgver': '1:2014.1-0ubuntu1.3'},
    {'osver': '14.04', 'pkgname': 'neutron-plugin-metering-agent', 'pkgver': '1:2014.1-0ubuntu1.3'},
    {'osver': '14.04', 'pkgname': 'neutron-plugin-midonet', 'pkgver': '1:2014.1-0ubuntu1.3'},
    {'osver': '14.04', 'pkgname': 'neutron-plugin-ml2', 'pkgver': '1:2014.1-0ubuntu1.3'},
    {'osver': '14.04', 'pkgname': 'neutron-plugin-mlnx', 'pkgver': '1:2014.1-0ubuntu1.3'},
    {'osver': '14.04', 'pkgname': 'neutron-plugin-mlnx-agent', 'pkgver': '1:2014.1-0ubuntu1.3'},
    {'osver': '14.04', 'pkgname': 'neutron-plugin-nec', 'pkgver': '1:2014.1-0ubuntu1.3'},
    {'osver': '14.04', 'pkgname': 'neutron-plugin-nec-agent', 'pkgver': '1:2014.1-0ubuntu1.3'},
    {'osver': '14.04', 'pkgname': 'neutron-plugin-nicira', 'pkgver': '1:2014.1-0ubuntu1.3'},
    {'osver': '14.04', 'pkgname': 'neutron-plugin-oneconvergence', 'pkgver': '1:2014.1-0ubuntu1.3'},
    {'osver': '14.04', 'pkgname': 'neutron-plugin-oneconvergence-agent', 'pkgver': '1:2014.1-0ubuntu1.3'},
    {'osver': '14.04', 'pkgname': 'neutron-plugin-openflow-agent', 'pkgver': '1:2014.1-0ubuntu1.3'},
    {'osver': '14.04', 'pkgname': 'neutron-plugin-openvswitch', 'pkgver': '1:2014.1-0ubuntu1.3'},
    {'osver': '14.04', 'pkgname': 'neutron-plugin-openvswitch-agent', 'pkgver': '1:2014.1-0ubuntu1.3'},
    {'osver': '14.04', 'pkgname': 'neutron-plugin-plumgrid', 'pkgver': '1:2014.1-0ubuntu1.3'},
    {'osver': '14.04', 'pkgname': 'neutron-plugin-ryu', 'pkgver': '1:2014.1-0ubuntu1.3'},
    {'osver': '14.04', 'pkgname': 'neutron-plugin-ryu-agent', 'pkgver': '1:2014.1-0ubuntu1.3'},
    {'osver': '14.04', 'pkgname': 'neutron-plugin-vmware', 'pkgver': '1:2014.1-0ubuntu1.3'},
    {'osver': '14.04', 'pkgname': 'neutron-plugin-vpn-agent', 'pkgver': '1:2014.1-0ubuntu1.3'},
    {'osver': '14.04', 'pkgname': 'neutron-server', 'pkgver': '1:2014.1-0ubuntu1.3'},
    {'osver': '14.04', 'pkgname': 'neutron-vpn-agent', 'pkgver': '1:2014.1-0ubuntu1.3'},
    {'osver': '14.04', 'pkgname': 'python-neutron', 'pkgver': '1:2014.1-0ubuntu1.3'}
];
