...
if (description)
{
  ...
  script_cve_id("CVE-2010-4578");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2010-4578");
...
patch available.
  ...
  - Google Chrome before 8.0.552.224 and Chrome OS before 8.0.552.343 do not properly perform cursor handling,
    which allows remote attackers to cause a denial of service or possibly have unspecified other impact via
    unknown vectors that lead to stale pointers. (CVE-2010-4578)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2010-4578");
