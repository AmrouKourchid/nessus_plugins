...
# SUSE update advisory SUSE-SU-2023:4103-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:4103-1");

  script_name(english:"SUSE SLES15 Security Update : buildah (SUSE-SU-2023:4103-1)");
...
in the SUSE-SU-2023:4103-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-October/016708.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?46953449");
...
var pkgs = [
    {'reference':'buildah-1.29.1-150500.3.2.1', 'sp':'5', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.5']},
    {'reference':'buildah-1.29.1-150500.3.2.1', 'sp':'5', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.5', 'sle-module-containers-release-15.5', 'sles-release-15.5']}
];
