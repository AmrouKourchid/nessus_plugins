...
# extracted from Red Hat Security Advisory RHSA-2022:5718. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:5718");

  script_name(english:"RHEL 8 : grafana (RHSA-2022:5718)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_5718.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1ec38e79");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:5718");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2104367");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL grafana package based on the guidance in RHSA-2022:5718.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'grafana-7.3.6-5.el8_4', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
