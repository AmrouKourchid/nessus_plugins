...
if (description)
{
  ...
  script_cve_id("CVE-2024-31583");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-31583");
...
patch available.
  ...
  - Pytorch before version v2.2.0 was discovered to contain a use-after-free vulnerability in
    torch/csrc/jit/mobile/interpreter.cpp. (CVE-2024-31583)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-31583");
