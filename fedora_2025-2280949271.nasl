...
# extracted from Fedora Security Advisory FEDORA-2025-2280949271
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-2280949271");

  script_name(english:"Fedora 40 : golang-github-openprinting-ipp-usb (2025-2280949271)");
...
FEDORA-2025-2280949271 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-2280949271");
...
var pkgs = [
    {'reference':'golang-github-openprinting-ipp-usb-0.9.30-4.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
