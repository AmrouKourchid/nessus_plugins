...
# Rocky Linux Security Advisory RLSA-2023:4035.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2023:4035");

  script_name(english:"Rocky Linux 8 : nodejs:18 (RLSA-2023:4035)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Rocky Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Rocky Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
RLSA-2023:4035 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2023:4035");
...
var appstreams = {
    'nodejs:18': [
      {'reference':'nodejs-18.14.2-3.module+el8.8.0+1337+7ea46b57', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-18.14.2-3.module+el8.8.0+1337+7ea46b57', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-debuginfo-18.14.2-3.module+el8.8.0+1337+7ea46b57', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-debuginfo-18.14.2-3.module+el8.8.0+1337+7ea46b57', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-debugsource-18.14.2-3.module+el8.8.0+1337+7ea46b57', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-debugsource-18.14.2-3.module+el8.8.0+1337+7ea46b57', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-devel-18.14.2-3.module+el8.8.0+1337+7ea46b57', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-devel-18.14.2-3.module+el8.8.0+1337+7ea46b57', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-docs-18.14.2-3.module+el8.8.0+1337+7ea46b57', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-full-i18n-18.14.2-3.module+el8.8.0+1337+7ea46b57', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-full-i18n-18.14.2-3.module+el8.8.0+1337+7ea46b57', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      ...
      {'reference':'npm-9.5.0-1.18.14.2.3.module+el8.8.0+1337+7ea46b57', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'npm-9.5.0-1.18.14.2.3.module+el8.8.0+1337+7ea46b57', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
};
