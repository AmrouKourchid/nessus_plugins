...
# Rocky Linux Security Advisory RLSA-2024:6987.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2024:6987");

  script_name(english:"RockyLinux 8 : emacs (RLSA-2024:6987)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2024:6987");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2293942");
...
var pkgs = [
    ...
    {'reference':'emacs-common-debuginfo-26.1-12.el8_10', 'cpu':'aarch64', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'emacs-common-debuginfo-26.1-12.el8_10', 'cpu':'x86_64', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'emacs-debuginfo-26.1-12.el8_10', 'cpu':'aarch64', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'emacs-debuginfo-26.1-12.el8_10', 'cpu':'x86_64', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'emacs-debugsource-26.1-12.el8_10', 'cpu':'aarch64', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'emacs-debugsource-26.1-12.el8_10', 'cpu':'x86_64', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    ...
    {'reference':'emacs-lucid-debuginfo-26.1-12.el8_10', 'cpu':'aarch64', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'emacs-lucid-debuginfo-26.1-12.el8_10', 'cpu':'x86_64', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    ...
    {'reference':'emacs-nox-debuginfo-26.1-12.el8_10', 'cpu':'aarch64', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'emacs-nox-debuginfo-26.1-12.el8_10', 'cpu':'x86_64', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
