...
# extracted from Red Hat Security Advisory RHSA-2022:6161. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:6161");

  script_name(english:"RHEL 8 : systemd (RHSA-2022:6161)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for systemd.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2022:6161 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_6161.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?16c1e7e1");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:6161");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2109926");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL systemd package based on the guidance in RHSA-2022:6161.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'systemd-239-45.el8_4.12', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-container-239-45.el8_4.12', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-devel-239-45.el8_4.12', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-journal-remote-239-45.el8_4.12', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-libs-239-45.el8_4.12', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-pam-239-45.el8_4.12', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-tests-239-45.el8_4.12', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-udev-239-45.el8_4.12', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
