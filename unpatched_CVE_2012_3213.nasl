...
if (description)
{
  ...
  script_cve_id("CVE-2012-3213");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2012-3213");
...
patch available.
  ...
  - Unspecified vulnerability in the Java Runtime Environment (JRE) component in Oracle Java SE 7 through
    ...
    availability via unknown vectors related to Scripting. (CVE-2012-3213)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2012-3213");
