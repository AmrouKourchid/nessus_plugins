...
# extracted from Debian Security Advisory dsa-5634. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5634 : chromium - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-1938");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-1939");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'chromium', 'reference': '122.0.6261.94-1~deb12u1'},
    {'release': '12.0', 'prefix': 'chromium-common', 'reference': '122.0.6261.94-1~deb12u1'},
    {'release': '12.0', 'prefix': 'chromium-driver', 'reference': '122.0.6261.94-1~deb12u1'},
    {'release': '12.0', 'prefix': 'chromium-l10n', 'reference': '122.0.6261.94-1~deb12u1'},
    {'release': '12.0', 'prefix': 'chromium-sandbox', 'reference': '122.0.6261.94-1~deb12u1'},
    {'release': '12.0', 'prefix': 'chromium-shell', 'reference': '122.0.6261.94-1~deb12u1'}
];
