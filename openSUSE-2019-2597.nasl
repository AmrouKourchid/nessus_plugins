...
# extracted from openSUSE Security Update openSUSE-2019-2597.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : clamav (openSUSE-2019-2597)");
...
This update was imported from the SUSE:SLE-15:Update update project.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1151839");
...
if ( rpm_check(release:"SUSE15.0", reference:"clamav-0.100.3-lp150.2.13.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"clamav-debuginfo-0.100.3-lp150.2.13.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"clamav-debugsource-0.100.3-lp150.2.13.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"clamav-devel-0.100.3-lp150.2.13.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libclamav7-0.100.3-lp150.2.13.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libclamav7-debuginfo-0.100.3-lp150.2.13.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libclammspack0-0.100.3-lp150.2.13.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libclammspack0-debuginfo-0.100.3-lp150.2.13.1") ) flag++;
