...
# extracted from Red Hat Security Advisory RHSA-2021:0145. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:0145");

  script_name(english:"RHEL 8 : Red Hat OpenShift Serverless Client kn 1.12.0 (Moderate) (RHSA-2021:0145)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has a package installed that is affected by multiple vulnerabilities as
referenced in the RHSA-2021:0145 advisory.

    Red Hat OpenShift Serverless Client kn CLI is delivered as an RPM package for installation on RHEL
    platforms, and as binaries for non-Linux platforms.

    Red Hat OpenShift Serverless Client kn 1.12.0 provides a CLI to interact
    with Red Hat OpenShift Serverless 1.12.0, and includes security and bug fixes and enhancements. For more
    information, see the release notes listed in the References section.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4b7188a7");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1906386");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_0145.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c9ce74ff");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:0145");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openshift-serverless-clients-0.18.4-2.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
