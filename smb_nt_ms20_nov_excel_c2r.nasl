...
if (description)
{
  ...
  script_name(english:"Security Updates for Microsoft Excel Products C2R (November 2020)");
...
update.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2020-17067");
