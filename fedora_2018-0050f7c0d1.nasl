...
# extracted from Fedora Security Advisory FEDORA-2018-0050f7c0d1.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 26 : 1:perl-Module-CoreList / 4:perl (2018-0050f7c0d1)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-0050f7c0d1");
...
flag = 0;
if (rpm_check(release:"FC26", reference:"perl-Module-CoreList-5.20180414-1.fc26", epoch:"1")) flag++;
if (rpm_check(release:"FC26", reference:"perl-5.24.4-397.fc26", epoch:"4")) flag++;
