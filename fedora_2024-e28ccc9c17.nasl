...
# extracted from Fedora Security Advisory FEDORA-2024-e28ccc9c17
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-e28ccc9c17");

  script_name(english:"Fedora 39 : nodejs20 (2024-e28ccc9c17)");
...
FEDORA-2024-e28ccc9c17 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-e28ccc9c17");
...
var pkgs = [
    {'reference':'nodejs20-20.12.2-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
