...
An attacker may be able to cause a remote denial of service (DoS).");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K54562183");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K54562183.");
...
var vmatrix = {
  'PEM': {
    'affected': [
      '13.0.0-13.1.0','12.0.0-12.1.3'
    ],
    'unaffected': [
      '14.0.0','13.1.1','13.1.0.4','12.1.3.2'
    ],
  }
};
