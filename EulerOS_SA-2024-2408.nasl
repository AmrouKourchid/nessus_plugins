...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : busybox (EulerOS-SA-2024-2408)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2408
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?abbe852b");
...
var pkgs = [
  "busybox-1.31.1-6.h12.eulerosv2r10"
];
