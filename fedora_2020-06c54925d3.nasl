...
# extracted from Fedora Security Advisory FEDORA-2020-06c54925d3.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-06c54925d3");

  script_name(english:"Fedora 30 : chromium (2020-06c54925d3)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-06c54925d3");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"chromium-81.0.4044.138-1.fc30", allowmaj:TRUE)) flag++;
