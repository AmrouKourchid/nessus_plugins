...
# extracted from Red Hat Security Advisory RHSA-2019:2051. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:2051");

  script_name(english:"RHEL 7 : compat-libtiff3 (RHSA-2019:2051)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for compat-libtiff3.");
...
the RHSA-2019:2051 advisory.

    The compat-libtiff3 package provides libtiff 3, an older version of libtiff library for manipulating TIFF
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_2051.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6001810f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:2051");
...
"Update the RHEL compat-libtiff3 package based on the guidance in RHSA-2019:2051.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'compat-libtiff3-3.9.4-12.el7', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'compat-libtiff3-3.9.4-12.el7', 'cpu':'ppc', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'compat-libtiff3-3.9.4-12.el7', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'compat-libtiff3-3.9.4-12.el7', 'cpu':'s390', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'compat-libtiff3-3.9.4-12.el7', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'compat-libtiff3-3.9.4-12.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
