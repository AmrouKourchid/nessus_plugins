...
# extracted from Red Hat Security Advisory RHSA-2019:2978. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:2978");

  script_name(english:"RHEL 7 : polkit (RHSA-2019:2978)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for polkit.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2019:2978 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_2978.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?24b08188");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:2978");
...
"Update the RHEL polkit package based on the guidance in RHSA-2019:2978.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'polkit-0.112-14.el7_5.1', 'sp':'5', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-0.112-14.el7_5.1', 'sp':'5', 'cpu':'ppc', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-0.112-14.el7_5.1', 'sp':'5', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-0.112-14.el7_5.1', 'sp':'5', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-0.112-14.el7_5.1', 'sp':'5', 'cpu':'s390', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-0.112-14.el7_5.1', 'sp':'5', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-0.112-14.el7_5.1', 'sp':'5', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-devel-0.112-14.el7_5.1', 'sp':'5', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-devel-0.112-14.el7_5.1', 'sp':'5', 'cpu':'ppc', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-devel-0.112-14.el7_5.1', 'sp':'5', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-devel-0.112-14.el7_5.1', 'sp':'5', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-devel-0.112-14.el7_5.1', 'sp':'5', 'cpu':'s390', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-devel-0.112-14.el7_5.1', 'sp':'5', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-devel-0.112-14.el7_5.1', 'sp':'5', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-docs-0.112-14.el7_5.1', 'sp':'5', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
