...
# extracted from SUSE update advisory SUSE-SU-2018:1836-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLED12 / SLES12 Security Update : procps (SUSE-SU-2018:1836-1)");
...
without introducing additional issues.");
  ...
  # https://www.suse.com/support/update/announcement/2018/suse-su-20181836-1/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?51292c6e");
...
patch SUSE-SLE-SDK-12-SP3-2018-1242=1

SUSE Linux Enterprise Server 12-SP3:zypper in -t patch
SUSE-SLE-SERVER-12-SP3-2018-1242=1

SUSE Linux Enterprise Desktop 12-SP3:zypper in -t patch
SUSE-SLE-DESKTOP-12-SP3-2018-1242=1
...
SUSE-OpenStack-Cloud-Magnum-Orchestration-7-2018-1242=1");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"3", reference:"libprocps3-3.3.9-11.11.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"libprocps3-debuginfo-3.3.9-11.11.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"procps-3.3.9-11.11.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"procps-debuginfo-3.3.9-11.11.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"procps-debugsource-3.3.9-11.11.1")) flag++;
if (rpm_check(release:"SLED12", sp:"3", cpu:"x86_64", reference:"libprocps3-3.3.9-11.11.1")) flag++;
if (rpm_check(release:"SLED12", sp:"3", cpu:"x86_64", reference:"libprocps3-debuginfo-3.3.9-11.11.1")) flag++;
if (rpm_check(release:"SLED12", sp:"3", cpu:"x86_64", reference:"procps-3.3.9-11.11.1")) flag++;
if (rpm_check(release:"SLED12", sp:"3", cpu:"x86_64", reference:"procps-debuginfo-3.3.9-11.11.1")) flag++;
if (rpm_check(release:"SLED12", sp:"3", cpu:"x86_64", reference:"procps-debugsource-3.3.9-11.11.1")) flag++;
