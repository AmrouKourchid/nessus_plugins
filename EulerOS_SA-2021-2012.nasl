...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.6.0 : ruby (EulerOS-SA-2021-2012)");
...
by the following vulnerability :
  ...
  - The REXML gem before 3.2.5 in Ruby before 2.6.7, 2.7.x
    before 2.7.3, and 3.x before 3.0.1 does not properly
    address XML round-trip issues. An incorrect document
    can be produced after parsing and
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2012
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5ba9e852");
...
pkgs = ["ruby-2.5.1-98.h11.eulerosv2r8",
        "ruby-irb-2.5.1-98.h11.eulerosv2r8",
        "ruby-libs-2.5.1-98.h11.eulerosv2r8",
        "rubygem-bigdecimal-1.3.4-98.h11.eulerosv2r8",
        "rubygem-io-console-0.4.6-98.h11.eulerosv2r8",
        "rubygem-json-2.1.0-98.h11.eulerosv2r8",
        "rubygem-openssl-2.1.0-98.h11.eulerosv2r8",
        "rubygem-psych-3.0.2-98.h11.eulerosv2r8",
        "rubygem-rdoc-6.0.1-98.h11.eulerosv2r8",
        "rubygems-2.7.6-98.h11.eulerosv2r8"];
