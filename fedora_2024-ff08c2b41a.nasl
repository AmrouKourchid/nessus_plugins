...
# extracted from Fedora Security Advisory FEDORA-2024-ff08c2b41a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-ff08c2b41a");

  script_name(english:"Fedora 41 : libgsf (2024-ff08c2b41a)");
...
FEDORA-2024-ff08c2b41a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-ff08c2b41a");
...
"Update the affected libgsf package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:libgsf");
...
var pkgs = [
    {'reference':'libgsf-1.14.53-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
