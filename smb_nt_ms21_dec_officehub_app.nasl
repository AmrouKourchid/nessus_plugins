...
if (description)
{
  ...
  script_cve_id("CVE-2021-43905");
  script_xref(name:"IAVA", value:"2021-A-0584-S");

  script_name(english:"Microsoft 365 (Office) App Code Execution (December 2021)");

  script_set_attribute(attribute:"synopsis", value:
"The Windows app installed on the remote host is affected by a code execution vulnerability.");
  script_set_attribute(attribute:"description", value:
"The Windows 'Microsoft 365 (Office)' app installed on the remote host is affected by a code execution vulnerability. An
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://msrc.microsoft.com/update-guide/vulnerability/CVE-2021-43905");
...
"Upgrade to app version 18.2110.13110.0, or later via the Microsoft Store.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-43905");
...
var apps = ['Microsoft.MicrosoftOfficeHub'];
