...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5046617");
  script_xref(name:"MSKB", value:"5046696");
  script_xref(name:"MSFT", value:"MS24-5046617");
  script_xref(name:"MSFT", value:"MS24-5046696");
  ...
  script_name(english:"KB5046617: Windows 11 Version 24H2 / Windows Server 2025 Security Update (November 2024)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5046617");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5046696");
...
if (
  smb_check_rollup(os:'10',
                   ...
                   rollup_date:'11_2024',
                   bulletin:bulletin,
                   rollup_kb_list:[5046617, 5046696])
)
{
