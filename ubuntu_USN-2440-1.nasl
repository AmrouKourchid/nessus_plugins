...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : Mutt vulnerability (USN-2440-1)");
...
USN-2440-1 advisory.
    ...
    Jakub Wilk discovered that the write_one_header function in mutt did not properly handle newline
    characters at the beginning of a header. An attacker could specially craft an email to cause mutt to
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2440-1");
...
"Update the affected mutt and / or mutt-patched packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-9116");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'mutt', 'pkgver': '1.5.21-6.4ubuntu2.1'},
    {'osver': '14.04', 'pkgname': 'mutt-patched', 'pkgver': '1.5.21-6.4ubuntu2.1'}
];
