...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2024-A-0443-S");

  script_name(english:"TeamCity Server < 2024.7 Multiple Vulnerabilities");
...
remote host is a version prior to 2024.7 It is, therefore, affected by multiple vulnerabilities:

  - Access tokens could continue working after deletion or expiration (CVE-2024-41827) 
    
  - Parameters of the 'password' type could leak into the build log in some specific cases (CVE-2024-41824) 

  - Stored XSS was possible on the Code Inspection tab (CVE-2024-41825) 
...
"Upgrade to JetBrains TeamCity version 2024.7 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-41827");
