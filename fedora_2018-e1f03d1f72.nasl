...
# extracted from Fedora Security Advisory FEDORA-2018-e1f03d1f72.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-e1f03d1f72");

  script_name(english:"Fedora 27 : poppler (2018-e1f03d1f72)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"Security fix for CVE-2018-13988.

Note that Tenable Network Security has extracted the preceding
description block directly from the Fedora update system website.
Tenable has attempted to automatically clean and format it as much as
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-e1f03d1f72");
...
flag = 0;
if (rpm_check(release:"FC27", reference:"poppler-0.57.0-10.fc27")) flag++;
