...
if (description)
{
  ...
  script_name(english:"RHEL 4 : HelixPlayer removal (Critical) (RHSA-2010:0981)");
...
referenced in the RHSA-2010:0981 advisory.

  - HelixPlayer multiple flaws (CVE-2010-2997, CVE-2010-4375, CVE-2010-4378, CVE-2010-4379, CVE-2010-4382,
    CVE-2010-4383, CVE-2010-4385, CVE-2010-4386, CVE-2010-4392, CVE-2010-4376) (CVE-2010-2997, CVE-2010-4375,
    CVE-2010-4378, CVE-2010-4379, CVE-2010-4382, CVE-2010-4383, CVE-2010-4384, CVE-2010-4385, CVE-2010-4386,
    CVE-2010-4392)

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2010/rhsa-2010_0981.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6e97bfa4");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#critical");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=662772");
  script_set_attribute(attribute:"see_also", value:"https://player.helixcommunity.org/");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2010:0981");
...
"Update the affected HelixPlayer-uninstall package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2010-4392");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2010-4384");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'HelixPlayer-uninstall-1.0.6-3.el4_8.1', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'HelixPlayer-uninstall-1.0.6-3.el4_8.1', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
