...
if (description)
{
  ...
  script_name(english:"Adobe Dreamweaver 20.0 < 21.0 Privilege Escalation (APSB20-55)");
...
"The version of Adobe Dreamweaver installed on the remote Windows host is prior to 21.0. It is, therefore, affected by a
