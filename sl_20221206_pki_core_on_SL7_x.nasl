...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"RHSA-2022:8799");

  script_name(english:"Scientific Linux Security Update : pki-core on SL7.x x86_64 (2022:8799)");
...
SLSA-2022:8799-1 advisory.

  - pki-core: access to external entities when parsing XML can lead to XXE (CVE-2022-2414)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.scientificlinux.org/category/sl-errata/slsa-20228799-1");
...
var pkgs = [
    {'reference':'pki-base-10.5.18-24.el7_9', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pki-base-java-10.5.18-24.el7_9', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pki-ca-10.5.18-24.el7_9', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pki-core-debuginfo-10.5.18-24.el7_9', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pki-javadoc-10.5.18-24.el7_9', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pki-kra-10.5.18-24.el7_9', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pki-server-10.5.18-24.el7_9', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pki-symkey-10.5.18-24.el7_9', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pki-tools-10.5.18-24.el7_9', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE}
];
