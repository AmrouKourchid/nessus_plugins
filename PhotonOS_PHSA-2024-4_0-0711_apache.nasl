...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Apache PHSA-2024-4.0-0711");
...
if (rpm_check(release:'PhotonOS-4.0', reference:'apache-tomcat9-9.0.97-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', reference:'apache-tomcat9-webapps-9.0.97-1.ph4')) flag++;
