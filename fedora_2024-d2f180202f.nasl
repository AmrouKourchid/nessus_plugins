...
# extracted from Fedora Security Advisory FEDORA-2024-d2f180202f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-d2f180202f");

  script_name(english:"Fedora 38 : moodle (2024-d2f180202f)");
...
FEDORA-2024-d2f180202f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-d2f180202f");
...
"Update the affected moodle package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-25982");
...
var pkgs = [
    {'reference':'moodle-4.1.9-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
