...
# extracted from Red Hat Security Advisory RHSA-2021:2658. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:2658");

  script_name(english:"RHEL 7 : linuxptp (RHSA-2021:2658)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for linuxptp.");
...
the RHSA-2021:2658 advisory.

    The linuxptp packages provide Precision Time Protocol (PTP) implementation for Linux according to IEEE
    standard 1588 for Linux. The dual design goals are to provide a robust implementation of the standard and
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_2658.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?db81bb3f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:2658");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1966240");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL linuxptp package based on the guidance in RHSA-2021:2658.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:linuxptp");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'linuxptp-2.0-2.el7_9.1', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'linuxptp-2.0-2.el7_9.1', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'linuxptp-2.0-2.el7_9.1', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'linuxptp-2.0-2.el7_9.1', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
