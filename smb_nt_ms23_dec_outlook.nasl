...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5002529");
  script_xref(name:"MSFT", value:"MS23-5002529");
  script_xref(name:"IAVA", value:"2023-A-0686-S");

  script_name(english:"Security Updates for Outlook (December 2023)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002529");
...
var constraints = [
  { 'kb':'5002529', 'channel':'MSI', 'fixed_version': '16.0.5426.1000', 'sp' : 0}
];
