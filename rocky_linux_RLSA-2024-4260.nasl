...
# Rocky Linux Security Advisory RLSA-2024:4260.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2024:4260");

  script_name(english:"RockyLinux 8 : python-idna (RLSA-2024:4260)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2024:4260");
...
"Update the affected python3-idna package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:rocky:linux:python3-idna");
...
var pkgs = [
    {'reference':'python3-idna-2.5-7.el8_10', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'}
];
