...
# extracted from Red Hat Security Advisory RHSA-2025:0208. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:0208");

  script_name(english:"RHEL 9 : dpdk (RHSA-2025:0208)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_0208.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b511465d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:0208");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL dpdk package based on the guidance in RHSA-2025:0208.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'dpdk-22.11-4.el9_2', 'sp':'2', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'dpdk-22.11-4.el9_2', 'sp':'2', 'cpu':'ppc64le', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'dpdk-22.11-4.el9_2', 'sp':'2', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'dpdk-devel-22.11-4.el9_2', 'sp':'2', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'dpdk-devel-22.11-4.el9_2', 'sp':'2', 'cpu':'ppc64le', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'dpdk-devel-22.11-4.el9_2', 'sp':'2', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'dpdk-doc-22.11-4.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'dpdk-tools-22.11-4.el9_2', 'sp':'2', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'dpdk-tools-22.11-4.el9_2', 'sp':'2', 'cpu':'ppc64le', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'dpdk-tools-22.11-4.el9_2', 'sp':'2', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
    ]
  }
];
