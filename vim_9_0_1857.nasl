...
if (description)
{
  ...
  script_cve_id("CVE-2023-4750");
  script_xref(name:"IAVB", value:"2023-B-0066-S");

  script_name(english:"Vim < 9.0.1857");

  script_set_attribute(attribute:"synopsis", value:
"A text editor installed on the remote Windows host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"Use After Free flaw in vim prior to 9.0.1857.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://github.com/advisories/GHSA-ph6h-mvrc-7rq5
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e0f0f6a3");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Vim version 9.0.1857 or later");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:N/UI:R/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-4750");
