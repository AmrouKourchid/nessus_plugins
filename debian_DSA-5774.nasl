...
# extracted from Debian Security Advisory dsa-5774. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5774 : ruby-saml - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 12 host has a package installed that is affected by a vulnerability as referenced in the dsa-5774
advisory.

    - -------------------------------------------------------------------------
    Debian Security Advisory DSA-5774-1                   security@debian.org
    https://www.debian.org/security/                     Salvatore Bonaccorso
    September 20, 2024                    https://www.debian.org/security/faq
    - -------------------------------------------------------------------------
    ...
    For the detailed security status of ruby-saml please refer to its
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-45409");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bookworm/ruby-saml");
...
"Upgrade the ruby-saml packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-45409");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'ruby-saml', 'reference': '1.13.0-1+deb12u1'}
];
