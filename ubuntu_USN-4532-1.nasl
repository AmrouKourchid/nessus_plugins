...
the USN-4532-1 advisory.
    ...
    possibly use this issue to perform an HTTP request smuggling attack. (CVE-2019-20444)

    It was discovered that Netty incorrectly handled certain HTTP headers.

    By sending a Content-Length header accompanied by a second Content-Length

    header, or by a Transfer-Encoding header, a remote attacker could possibly use this issue to perform an
