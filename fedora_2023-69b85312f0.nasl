...
# extracted from Fedora Security Advisory FEDORA-2023-69b85312f0
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-69b85312f0");

  script_name(english:"Fedora 38 : libtommath (2023-69b85312f0)");
...
FEDORA-2023-69b85312f0 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-69b85312f0");
  script_set_attribute(attribute:"solution", value:
"Update the affected libtommath package.");
...
var pkgs = [
    {'reference':'libtommath-1.2.0-12.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
