...
# Oracle Linux Security Advisory ELSA-2020-1331 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : ipmitool (ELSA-2020-1331)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2020-1331.html");
