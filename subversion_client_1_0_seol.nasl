...
if (description)
{
  ...
  script_name(english:"Apache Subversion Client SEoL (<= 1.0.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Apache Subversion Client is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Apache Subversion Client is less than or equal to 1.0.x. It is, therefore, no longer
...
"Upgrade to a version of Apache Subversion Client that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2008/02/23");
