...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5028232");
  script_xref(name:"MSKB", value:"5028233");
  script_xref(name:"MSFT", value:"MS23-5028232");
  script_xref(name:"MSFT", value:"MS23-5028233");
  script_xref(name:"IAVA", value:"2023-A-0347-S");
  script_xref(name:"IAVA", value:"2023-A-0345-S");

  script_name(english:"KB5028233: Windows Server 2012 Security Update (July 2023)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5028233. It is, therefore, affected by multiple vulnerabilities
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5028232");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5028233");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5028233 or Cumulative Update 5028232");
...
if (
  smb_check_rollup(os:'6.2',
                   ...
                   rollup_date:'07_2023',
                   bulletin:bulletin,
                   rollup_kb_list:[5028233, 5028232])
)
{
