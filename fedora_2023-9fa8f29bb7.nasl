...
# extracted from Fedora Security Advisory FEDORA-2023-9fa8f29bb7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-9fa8f29bb7");

  script_name(english:"Fedora 37 : ntpsec (2023-9fa8f29bb7)");
...
FEDORA-2023-9fa8f29bb7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-9fa8f29bb7");
...
var pkgs = [
    {'reference':'ntpsec-1.2.2a-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
