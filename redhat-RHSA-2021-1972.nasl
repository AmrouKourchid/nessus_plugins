...
# extracted from Red Hat Security Advisory RHSA-2021:1972. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:1972");

  script_name(english:"RHEL 8 : pandoc (RHSA-2021:1972)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for pandoc.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2021:1972 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_1972.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?65135d24");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/8.4_release_notes/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?862005a9");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:1972");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1854328");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL pandoc packages based on the guidance in RHSA-2021:1972.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:S/C:N/I:N/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:L/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-5238");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'pandoc-2.0.6-5.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pandoc-common-2.0.6-5.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
