...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Pyyaml PHSA-2020-2.0-0229");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'PyYAML-3.12-6.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'PyYAML-debuginfo-3.12-6.ph2')) flag++;
