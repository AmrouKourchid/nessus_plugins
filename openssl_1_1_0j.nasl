...
"The version of OpenSSL installed on the remote host is prior to 1.1.0j. It is, therefore, affected by multiple
vulnerabilities as referenced in the 1.1.0j advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4ab9bcc9");
  # https://git.openssl.org/gitweb/?p=openssl.git;a=commitdiff;h=56fb454d281a023b3f950d969693553d3f3ceea1
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b969b525");
...
"Upgrade to OpenSSL version 1.1.0j or later.");
...
var constraints = [
  { 'min_version' : '1.1.0', 'fixed_version' : '1.1.0j' }
];
