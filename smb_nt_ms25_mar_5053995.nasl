...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5053888");
  script_xref(name:"MSKB", value:"5053995");
  script_xref(name:"MSFT", value:"MS25-5053888");
  script_xref(name:"MSFT", value:"MS25-5053995");
  script_xref(name:"IAVA", value:"2025-A-0181-S");
  script_xref(name:"IAVA", value:"2025-A-0182-S");

  script_name(english:"KB5053995: Windows Server 2008 Security Update (March 2025)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5053995. It is, therefore, affected by multiple vulnerabilities
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5053888");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5053995");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5053995 or Cumulative Update 5053888");
...
if (
  smb_check_rollup(os:'6.0',
                   ...
                   rollup_date:'03_2025',
                   bulletin:bulletin,
                   rollup_kb_list:[5053995, 5053888])
)
{
