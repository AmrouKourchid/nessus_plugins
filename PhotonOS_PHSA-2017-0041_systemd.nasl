...
if (description)
{
  ...
  script_cve_id("CVE-2015-7510", "CVE-2017-9217");

  script_name(english:"Photon OS 1.0: Systemd PHSA-2017-0041");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'systemd-228-41.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'systemd-debuginfo-228-41.ph1')) flag++;
