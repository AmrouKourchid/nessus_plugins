...
if (description)
{
  ...
  script_cve_id("CVE-2024-50172");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-50172");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: RDMA/bnxt_re: Fix a possible memory
    leak In bnxt_re_setup_chip_ctx() when bnxt_qplib_map_db_bar() fails driver is not freeing the memory
    allocated for rdev->chip_ctx. (CVE-2024-50172)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-50172");
