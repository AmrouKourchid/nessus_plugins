...
# extracted from Fedora Security Advisory FEDORA-2020-d9abb0c06d.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : pdns-recursor (2020-d9abb0c06d)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-d9abb0c06d");
...
flag = 0;
if (rpm_check(release:"FC32", reference:"pdns-recursor-4.3.1-1.fc32")) flag++;
