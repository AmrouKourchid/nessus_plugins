...
# extracted from Debian Security Advisory dla-3968. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3968 : netatalk - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-22995");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-38439");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-38440");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-38441");
...
"Upgrade the netatalk packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2024-38439");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'netatalk', 'reference': '3.1.12~ds-8+deb11u2'}
];
