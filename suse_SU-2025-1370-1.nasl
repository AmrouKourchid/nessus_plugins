...
# SUSE update advisory SUSE-SU-2025:1370-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2025:1370-1");

  script_name(english:"SUSE SLES15 / openSUSE 15 Security Update : govulncheck-vulndb (SUSE-SU-2025:1370-1)");
...
referenced in the SUSE-SU-2025:1370-1 advisory.

    - Update to version 0.0.20250422T181640 2025-04-22T18:16:40Z (jsc#PED-11136)
      * GO-2025-3603
      * GO-2025-3604
      * GO-2025-3607
      * GO-2025-3608
    ...
    - Update to version 0.0.20250422T152923 (jsc#PED-11136)
      * GO-2025-3600
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://lists.suse.com/pipermail/sle-updates/2025-April/039085.html");
...
var pkgs = [
    {'reference':'govulncheck-vulndb-0.0.20250422T181640-150000.1.65.1', 'release':'SUSE15.6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.6']},
    {'reference':'govulncheck-vulndb-0.0.20250422T181640-150000.1.65.1', 'sp':'6', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-packagehub-subpackages-release-15.6']}
];
