...
# extracted from Fedora Security Advisory FEDORA-2024-2bf73514cd
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-2bf73514cd");
  script_xref(name:"IAVA", value:"2024-A-0144-S");

  script_name(english:"Fedora 39 : tomcat (2024-2bf73514cd)");
...
FEDORA-2024-2bf73514cd advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-2bf73514cd");
...
var pkgs = [
    {'reference':'tomcat-9.0.89-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
