...
# extracted from Red Hat Security Advisory RHSA-2019:3789. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2019-3828", "CVE-2019-10156", "CVE-2019-10206");
  script_xref(name:"RHSA", value:"2019:3789");

  script_name(english:"RHEL 7 : ansible (RHSA-2019:3789)");
...
referenced in the RHSA-2019:3789 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_3789.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?658e449a");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:3789");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL ansible package based on the guidance in RHSA-2019:3789.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:S/C:P/I:P/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:L/UI:N/S:U/C:H/I:N/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-10156");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2019-10206");

  script_set_attribute(attribute:"exploitability_ease", value:"Exploits are available");
  script_set_attribute(attribute:"exploit_available", value:"true");
  script_cwe_id(22, 200, 522);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ansible-2.6.19-1.el7ae', 'release':'7', 'el_string':'el7ae', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
