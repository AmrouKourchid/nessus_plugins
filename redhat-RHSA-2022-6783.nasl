...
"The remote Red Hat host is missing one or more security updates for Red Hat Single Sign-On 7.5.3.");
...
referenced in the RHSA-2022:6783 advisory.
    ...
    This release of Red Hat Single Sign-On 7.5.3 on RHEL 8 serves as a replacement for Red Hat Single Sign-On
    7.5.2, and includes bug fixes and enhancements, which are documented in the Release Notes document linked
    ...
    * keycloak-saml-core: keycloak: Uploading of SAML javascript protocol mapper scripts through the admin
    (CVE-2022-2668)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_6783.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ac097e3f");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2101942");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2115392");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat Single Sign-On 7.5.3 package based on the guidance in RHSA-2022:6783.");
  ...
  script_cwe_id(79, 400, 440, 444, 502, 770, 1220);
