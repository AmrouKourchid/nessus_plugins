...
if (description)
{
  ...
  script_name(english:"Apache Tomcat 8.0.0.RC1 < 8.0.44");

  script_set_attribute(attribute:"synopsis", value:
"The remote Apache Tomcat server is affected by a vulnerability");
  script_set_attribute(attribute:"description", value:
"The version of Tomcat installed on the remote host is prior to 8.0.44. It is, therefore, affected by a vulnerability as
referenced in the fixed_in_apache_tomcat_8.0.44_security-8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://svn.apache.org/viewvc?view=rev&rev=1793470");
  script_set_attribute(attribute:"see_also", value:"https://svn.apache.org/viewvc?view=rev&rev=1793489");
  # https://tomcat.apache.org/security-8.html#Fixed_in_Apache_Tomcat_8.0.44
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cf8309f3");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Apache Tomcat version 8.0.44 or later.");
...
var constraints = [
  { 'min_version' : '8.0.0.RC1', 'max_version' : '8.0.43', 'fixed_version' : '8.0.44' }
];
