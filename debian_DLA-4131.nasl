...
# extracted from Debian Security Advisory dla-4131. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-4131 : zabbix-agent - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-36469");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-42325");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-45699");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-45700");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'zabbix-agent', 'reference': '1:5.0.46+dfsg-1+deb11u1'},
    {'release': '11.0', 'prefix': 'zabbix-frontend-php', 'reference': '1:5.0.46+dfsg-1+deb11u1'},
    {'release': '11.0', 'prefix': 'zabbix-java-gateway', 'reference': '1:5.0.46+dfsg-1+deb11u1'},
    {'release': '11.0', 'prefix': 'zabbix-proxy-mysql', 'reference': '1:5.0.46+dfsg-1+deb11u1'},
    {'release': '11.0', 'prefix': 'zabbix-proxy-pgsql', 'reference': '1:5.0.46+dfsg-1+deb11u1'},
    {'release': '11.0', 'prefix': 'zabbix-proxy-sqlite3', 'reference': '1:5.0.46+dfsg-1+deb11u1'},
    {'release': '11.0', 'prefix': 'zabbix-server-mysql', 'reference': '1:5.0.46+dfsg-1+deb11u1'},
    {'release': '11.0', 'prefix': 'zabbix-server-pgsql', 'reference': '1:5.0.46+dfsg-1+deb11u1'}
];
