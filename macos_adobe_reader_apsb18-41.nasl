...
if (description)
{
  ...
  script_name(english:"Adobe Reader < 2015.006.30461 / 2017.011.30110 / 2019.010.20064 Multiple Vulnerabilities (APSB18-41) (macOS)");

  script_set_attribute(attribute:"synopsis", value:
"The version of Adobe Reader installed on the remote macOS host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Reader installed on the remote macOS host is a version prior to 2015.006.30461, 2017.011.30110, or
2019.010.20064. It is, therefore, affected by multiple vulnerabilities.
...
"Upgrade to Adobe Reader version 2015.006.30461 / 2017.011.30110 / 2019.010.20064 or later.");
...
var constraints = [
  { 'min_version' : '15.6', 'max_version' : '15.006.30456', 'fixed_version' : '15.006.30461', 'track' : 'DC Classic' },
  { 'min_version' : '17.8', 'max_version' : '17.011.30105', 'fixed_version' : '17.011.30110', 'track' : 'DC Classic' },
  { 'min_version' : '15.7', 'max_version' : '19.008.20080', 'fixed_version' : '19.010.20064', 'track' : 'DC Continuous' }
];
