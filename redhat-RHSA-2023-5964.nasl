...
# extracted from Red Hat Security Advisory RHSA-2023:5964. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:5964");
  script_xref(name:"CEA-ID", value:"CEA-2024-0004");

  script_name(english:"RHEL 8 : Red Hat OpenStack Platform 16.2.5 (collectd-libpod-stats) (RHSA-2023:5964)");
...
referenced in the RHSA-2023:5964 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_5964.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d813256d");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:5964");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat OpenStack Platform 16.2.5 (collectd-libpod-stats) package based on the guidance in
RHSA-2023:5964.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'collectd-libpod-stats-1.0.4-5.el8ost', 'cpu':'ppc64le', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'collectd-libpod-stats-1.0.4-5.el8ost', 'cpu':'x86_64', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
