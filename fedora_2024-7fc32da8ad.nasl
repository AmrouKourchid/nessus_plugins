...
# extracted from Fedora Security Advisory FEDORA-2024-7fc32da8ad
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-7fc32da8ad");

  script_name(english:"Fedora 40 : suricata (2024-7fc32da8ad)");
...
FEDORA-2024-7fc32da8ad advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-7fc32da8ad");
...
var pkgs = [
    {'reference':'suricata-7.0.6-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
