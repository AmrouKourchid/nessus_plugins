...
# extracted from Red Hat Security Advisory RHSA-2023:1279. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:1279");

  script_name(english:"RHEL 7 / 8 : Synopsis: Red Hat OpenStack Platform (openstack-cinder) (RHSA-2023:1279)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for Synopsis: Red Hat OpenStack Platform (openstack-cinder).");
...
in the RHSA-2023:1279 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_1279.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a9f8f3df");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:1279");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Synopsis: Red Hat OpenStack Platform (openstack-cinder) package based on the guidance in RHSA-2023:1279.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openstack-cinder-15.4.0-1.20230206163350.58f0e73.el8ost', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'},
      {'reference':'python3-cinder-15.4.0-1.20230206163350.58f0e73.el8ost', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'openstack-cinder-15.6.1-2.20221003154726.87578a0.el8ost', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'},
      {'reference':'python3-cinder-15.6.1-2.20221003154726.87578a0.el8ost', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'openstack-cinder-12.0.10-27.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'},
      {'reference':'python-cinder-12.0.10-27.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'openstack-cinder / python-cinder / python3-cinder');
}
