...
# SUSE update advisory SUSE-SU-2021:2768-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2021:2768-1");

  script_name(english:"SUSE SLES15 Security Update : haproxy (SUSE-SU-2021:2768-1)");
...
SU-2021:2768-1 advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1189366");
  script_set_attribute(attribute:"see_also", value:"https://lists.suse.com/pipermail/sle-updates/2021-August/019882.html");
...
var pkgs = [
    {'reference':'haproxy-2.0.14-8.19.1', 'sp':'1', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-ha-release-15.1']}
];
