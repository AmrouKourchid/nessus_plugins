...
# extracted from Red Hat Security Advisory RHSA-2025:0570. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:0570");

  script_name(english:"RHEL 9 : iperf3 (RHSA-2025:0570)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_0570.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ffa840fa");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:0570");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL iperf3 package based on the guidance in RHSA-2025:0570.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'iperf3-3.9-10.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
