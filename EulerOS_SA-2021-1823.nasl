...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : openjpeg (EulerOS-SA-2021-1823)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1823
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b1586f04");
...
pkgs = ["openjpeg-libs-1.5.1-16.h5"];
