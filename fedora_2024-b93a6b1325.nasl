...
# extracted from Fedora Security Advisory FEDORA-2024-b93a6b1325
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-b93a6b1325");

  script_name(english:"Fedora 40 : cjson (2024-b93a6b1325)");
...
FEDORA-2024-b93a6b1325 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-b93a6b1325");
...
var pkgs = [
    {'reference':'cjson-1.7.17-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
