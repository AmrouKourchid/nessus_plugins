...
# Red Hat Security Advisory RHSA-2020:1605. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : python27:2.7 (CESA-2020:1605)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
CESA-2020:1605 advisory.
...
var appstreams = {
    'python27:2.7': [
      ...
      {'reference':'python2-2.7.17-1.module_el8.2.0+381+9a5b3c3b', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python2-2.7.17-1.module_el8.2.0+381+9a5b3c3b', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python2-debug-2.7.17-1.module_el8.2.0+381+9a5b3c3b', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python2-debug-2.7.17-1.module_el8.2.0+381+9a5b3c3b', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python2-devel-2.7.17-1.module_el8.2.0+381+9a5b3c3b', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python2-devel-2.7.17-1.module_el8.2.0+381+9a5b3c3b', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python2-libs-2.7.17-1.module_el8.2.0+381+9a5b3c3b', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python2-libs-2.7.17-1.module_el8.2.0+381+9a5b3c3b', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python2-pip-9.0.3-16.module_el8.2.0+381+9a5b3c3b', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python2-pip-9.0.3-16.module_el8.2.0+381+9a5b3c3b', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python2-pip-wheel-9.0.3-16.module_el8.2.0+381+9a5b3c3b', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python2-pip-wheel-9.0.3-16.module_el8.2.0+381+9a5b3c3b', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python2-test-2.7.17-1.module_el8.2.0+381+9a5b3c3b', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python2-test-2.7.17-1.module_el8.2.0+381+9a5b3c3b', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python2-tkinter-2.7.17-1.module_el8.2.0+381+9a5b3c3b', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python2-tkinter-2.7.17-1.module_el8.2.0+381+9a5b3c3b', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python2-tools-2.7.17-1.module_el8.2.0+381+9a5b3c3b', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python2-tools-2.7.17-1.module_el8.2.0+381+9a5b3c3b', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
