...
# extracted from Gentoo Linux Security Advisory GLSA 202105-06.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202105-06");

  script_name(english:"GLSA-202105-06 : Smarty: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202105-06
(Smarty: Multiple vulnerabilities)

    Multiple vulnerabilities have been discovered in Smarty template engine.
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202105-06"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"dev-php/smarty", unaffected:make_list("ge 3.1.39"), vulnerable:make_list("lt 3.1.39"))) flag++;
