...
# extracted from Fedora Security Advisory FEDORA-2024-6def755315
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-6def755315");

  script_name(english:"Fedora 41 : python3.12 (2024-6def755315)");
...
FEDORA-2024-6def755315 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-6def755315");
...
var pkgs = [
    {'reference':'python3.12-3.12.6-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
