...
# extracted from Fedora Security Advisory FEDORA-2025-5f04326f4f
#
...
if (description)
{
  ...
  script_cve_id("CVE-2024-56201");
  script_xref(name:"FEDORA", value:"2025-5f04326f4f");

  script_name(english:"Fedora 40 : mingw-python-jinja2 (2025-5f04326f4f)");
...
FEDORA-2025-5f04326f4f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-5f04326f4f");
  script_set_attribute(attribute:"solution", value:
"Update the affected mingw-python-jinja2 package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:mingw-python-jinja2");
...
var pkgs = [
    {'reference':'mingw-python-jinja2-3.1.5-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'mingw-python-jinja2');
}
