...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Go PHSA-2023-3.0-0665");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'go-1.20.8-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'go-md2man-2.0.0-23.ph3')) flag++;
