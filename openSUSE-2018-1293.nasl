...
# extracted from openSUSE Security Update openSUSE-2018-1293.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : hostapd (openSUSE-2018-1293)");
...
"hostapd was updated to fix following security issue :
  ...
  - CVE-2018-14526: Ignore unauthenticated encrypted
    EAPOL-Key data (bsc#1104205)");
...
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"hostapd-2.6-lp150.2.3.2") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"hostapd-debuginfo-2.6-lp150.2.3.2") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"hostapd-debugsource-2.6-lp150.2.3.2") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"hostapd-2.6-11.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"hostapd-debuginfo-2.6-11.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"hostapd-debugsource-2.6-11.1") ) flag++;
