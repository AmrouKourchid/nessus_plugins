...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.0 : freetype (EulerOS-SA-2023-3070)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3070
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fc92555f");
...
"Update the affected freetype packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-31782");
...
var pkgs = [
  "freetype-2.11.0-1.h3.eulerosv2r11"
];
