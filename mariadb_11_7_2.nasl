...
if (description)
{
  ...
  script_name(english:"MariaDB 11.7.0 < 11.7.2");

  script_set_attribute(attribute:"synopsis", value:
"The remote database server is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of MariaDB installed on the remote host is prior to 11.7.2. It is, therefore, affected by a vulnerability as
referenced in the mdb-1172-rn advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://mariadb.com/kb/en/mdb-1172-rn");
...
var constraints = [
  { 'min_version' : '11.7', 'fixed_version' : '11.7.2' }
];
