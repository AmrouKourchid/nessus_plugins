...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : wireshark (ELSA-2009-0313)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2009-0313.html");
...
"Update the affected wireshark and / or wireshark-gnome packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2009-0599");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2008-4684");
...
var pkgs = [
    {'reference':'wireshark-1.0.6-2.0.1.el5_3', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'wireshark-gnome-1.0.6-2.0.1.el5_3', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'wireshark-1.0.6-2.0.1.el5_3', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'wireshark-gnome-1.0.6-2.0.1.el5_3', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
