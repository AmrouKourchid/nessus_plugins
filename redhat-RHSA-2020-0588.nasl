...
# extracted from Red Hat Security Advisory RHSA-2020:0588. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:0588");

  script_name(english:"RHEL 8 : CloudForms 5.0.3 (RHSA-2020:0588)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for CloudForms 5.0.3.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2020:0588 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_0588.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4e5973ef");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:0588");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cfme-5.11.3.1-1.el8cf', 'cpu':'x86_64', 'release':'8', 'el_string':'el8cf', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'cfme-5.11'},
      {'reference':'cfme-amazon-smartstate-5.11.3.1-1.el8cf', 'cpu':'x86_64', 'release':'8', 'el_string':'el8cf', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'cfme-5.11'},
      {'reference':'cfme-appliance-5.11.3.1-1.el8cf', 'cpu':'x86_64', 'release':'8', 'el_string':'el8cf', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'cfme-5.11'},
      {'reference':'cfme-appliance-common-5.11.3.1-1.el8cf', 'cpu':'x86_64', 'release':'8', 'el_string':'el8cf', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'cfme-5.11'},
      {'reference':'cfme-appliance-tools-5.11.3.1-1.el8cf', 'cpu':'x86_64', 'release':'8', 'el_string':'el8cf', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'cfme-5.11'},
      {'reference':'cfme-gemset-5.11.3.1-1.el8cf', 'cpu':'x86_64', 'release':'8', 'el_string':'el8cf', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'cfme-5.11'}
    ]
  }
];
