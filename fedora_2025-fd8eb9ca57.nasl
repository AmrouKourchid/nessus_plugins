...
# extracted from Fedora Security Advisory FEDORA-2025-fd8eb9ca57
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-fd8eb9ca57");
  script_xref(name:"IAVA", value:"2025-A-0279-S");

  script_name(english:"Fedora 40 : thunderbird (2025-fd8eb9ca57)");
...
FEDORA-2025-fd8eb9ca57 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-fd8eb9ca57");
...
var pkgs = [
    {'reference':'thunderbird-128.9.2-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
