...
# extracted from Red Hat Security Advisory RHSA-2024:1875. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:1875");

  script_name(english:"RHEL 8 : less (RHSA-2024:1875)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_1875.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?089a5003");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2265081");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:1875");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL less package based on the guidance in RHSA-2024:1875.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'less-530-2.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
