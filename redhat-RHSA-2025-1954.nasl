...
# extracted from Red Hat Security Advisory RHSA-2025:1954. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2025-1801");
  script_xref(name:"RHSA", value:"2025:1954");

  script_name(english:"RHEL 8 / 9 : Red Hat Ansible Automation Platform 2.5 Product Security and Bug Fix Update (Important) (RHSA-2025:1954)");
...
in the RHSA-2025:1954 advisory.
    ...
    An issue was found in affected versions of Ansible Automation Platform that enabled a lesser privileged
    user (even unauthenticated) promotion to a greater privileged user.

    All Ansible Automation Platform 2.5 customers should upgrade their environments to the latest version as
    soon as possible.

    Ansible Automation Platform on Microsoft Azure and Ansible Automation Platform Service on AWS environments
    have already been patched by Red Hat.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2349081");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_1954.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2ccaafd5");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:1954");
  script_set_attribute(attribute:"solution", value:
"Update the affected automation-gateway, automation-gateway-config and / or automation-gateway-server packages.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:S/C:C/I:C/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:L/UI:N/S:U/C:H/I:H/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-1801");
  ...
  script_set_attribute(attribute:"vuln_publication_date", value:"2025/03/01");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:automation-gateway");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:automation-gateway-config");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'automation-gateway-2.5.20250305-1.el8ap', 'release':'8', 'el_string':'el8ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.5'},
      {'reference':'automation-gateway-config-2.5.20250305-1.el8ap', 'release':'8', 'el_string':'el8ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.5'},
      {'reference':'automation-gateway-server-2.5.20250305-1.el8ap', 'release':'8', 'el_string':'el8ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.5'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'automation-gateway-2.5.20250305-1.el9ap', 'release':'9', 'el_string':'el9ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.5'},
      {'reference':'automation-gateway-config-2.5.20250305-1.el9ap', 'release':'9', 'el_string':'el9ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.5'},
      {'reference':'automation-gateway-server-2.5.20250305-1.el9ap', 'release':'9', 'el_string':'el9ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.5'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'automation-gateway / automation-gateway-config / etc');
}
