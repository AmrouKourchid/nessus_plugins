...
# extracted from ZTE advisory NS-SA-2021-0007. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.04 / MAIN 5.04 : firefox Multiple Vulnerabilities (NS-SA-2021-0007)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/notice/NS-SA-2021-0007");
...
pkgs = {
  'CGSL CORE 5.04': [
    ...
    'firefox-debuginfo-68.11.0-1.el7.centos'
  ],
  'CGSL MAIN 5.04': [
    'firefox-68.11.0-1.el7.centos',
    'firefox-debuginfo-68.11.0-1.el7.centos'
