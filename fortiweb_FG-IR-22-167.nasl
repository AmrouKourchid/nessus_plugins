...
if (description)
{
  ...
  script_cve_id("CVE-2022-30306");

  script_name(english:"Fortinet FortiWeb Buffer overflow in CA sign function (FG-IR-22-167)");
...
vulnerability as referenced in the FG-IR-22-167 advisory.

  - A stack-based buffer overflow vulnerability [CWE-121] in the CA sign functionality of FortiWeb version
    7.0.1 and below, 6.4 all versions, version 6.3.19 and below may allow an authenticated attacker to achieve
    arbitrary code execution via specifically crafted password. (CVE-2022-30306)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.fortiguard.com/psirt/FG-IR-22-167");
...
"Please upgrade to FortiWeb version 6.3.20/7.0.2 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-30306");
