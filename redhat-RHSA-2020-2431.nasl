...
referenced in the RHSA-2020:2431 advisory.
    ...
    * Update Intel CPU microcode to microcode-20200602 release, addresses:
      ...
      - Update of 06-9e-0d/0x22 (CFL-H R0) microcode from revision 0xca up to 0xd6.
       - Change the URL to point to the GitHub repository since the microcode download section at Intel
    Download Center does not exist anymore.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_2431.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2758d8b4");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'microcode_ctl-20191115-4.20200602.2.el8_2', 'sp':'2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'}
    ]
  },
  {
    'repo_relative_urls': [
