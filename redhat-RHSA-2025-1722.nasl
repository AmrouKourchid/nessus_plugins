...
# extracted from Red Hat Security Advisory RHSA-2025:1722. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:1722");
  script_xref(name:"IAVB", value:"2025-B-0028");

  script_name(english:"RHEL 9 : postgresql:15 (RHSA-2025:1722)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_1722.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?20892434");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:1722");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL postgresql:15 package based on the guidance in RHSA-2025:1722.");
  ...
  'postgresql:15': [
    {
      ...
      'pkgs': [
        ...
        {'reference':'postgresql-15.12-1.module+el9.2.0+22870+3f900c25', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-contrib-15.12-1.module+el9.2.0+22870+3f900c25', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-docs-15.12-1.module+el9.2.0+22870+3f900c25', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plperl-15.12-1.module+el9.2.0+22870+3f900c25', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plpython3-15.12-1.module+el9.2.0+22870+3f900c25', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-pltcl-15.12-1.module+el9.2.0+22870+3f900c25', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-private-devel-15.12-1.module+el9.2.0+22870+3f900c25', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-private-libs-15.12-1.module+el9.2.0+22870+3f900c25', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-15.12-1.module+el9.2.0+22870+3f900c25', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-devel-15.12-1.module+el9.2.0+22870+3f900c25', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-static-15.12-1.module+el9.2.0+22870+3f900c25', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-15.12-1.module+el9.2.0+22870+3f900c25', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-rpm-macros-15.12-1.module+el9.2.0+22870+3f900c25', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-upgrade-15.12-1.module+el9.2.0+22870+3f900c25', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-upgrade-devel-15.12-1.module+el9.2.0+22870+3f900c25', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
