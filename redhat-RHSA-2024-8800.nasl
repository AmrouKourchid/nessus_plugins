...
# extracted from Red Hat Security Advisory RHSA-2024:8800. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:8800");

  script_name(english:"RHEL 9 : openexr (RHSA-2024:8800)");
...
the RHSA-2024:8800 advisory.

    OpenEXR is an open-source high-dynamic-range floating-point image file format for high-quality image
    processing and storage. This document presents a brief overview of OpenEXR and explains concepts that are
    specific to this format.  This package containes the binaries for OpenEXR.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_8800.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8dc2754c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:8800");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL openexr package based on the guidance in RHSA-2024:8800.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openexr-3.1.1-2.el9_4.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openexr-devel-3.1.1-2.el9_4.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openexr-libs-3.1.1-2.el9_4.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'openexr-3.1.1-2.el9_4.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openexr-devel-3.1.1-2.el9_4.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openexr-libs-3.1.1-2.el9_4.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
