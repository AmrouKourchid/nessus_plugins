...
# extracted from Oracle Linux Security Advisory ELSA-2019-2125.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : ovmf (ELSA-2019-2125)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2019-2125.html");
...
var rpm_list = get_kb_item_or_exit('Host/RedHat/rpm-list');
if (rpm_list !~ "((?<=^)|(?<=\\n))OVMF-20[0-9]{6}-")
  audit(AUDIT_PACKAGE_NOT_INSTALLED, 'OVMF (old name format)');
