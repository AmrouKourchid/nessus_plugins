...
"The version of Firefox ESR installed on the remote Windows host is prior to 115.2.1. It is, therefore, affected by a
...
mozilla_check_version(installs:installs, product:'firefox', esr:TRUE, fix:'115.2.1', min:'115.0.0', severity:SECURITY_HOLE);
