...
# extracted from Fedora Security Advisory FEDORA-2025-cc8f9d8943
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-cc8f9d8943");

  script_name(english:"Fedora 40 : nodejs18 (2025-cc8f9d8943)");
...
FEDORA-2025-cc8f9d8943 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-cc8f9d8943");
...
var pkgs = [
    {'reference':'nodejs18-18.20.6-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
