...
# extracted from Amazon Linux 2 Security Advisory ALAS-2025-2735.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : python3-jinja2 (ALAS-2025-2735)");
...
vulnerability as referenced in the ALAS2-2025-2735 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2025-2735.html");
...
var pkgs = [
    {'reference':'python3-jinja2-2.7.2-4.amzn2.0.6', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
