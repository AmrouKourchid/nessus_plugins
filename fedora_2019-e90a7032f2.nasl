...
# extracted from Fedora Security Advisory FEDORA-2019-e90a7032f2.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-e90a7032f2");

  script_name(english:"Fedora 31 : htmldoc (2019-e90a7032f2)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-e90a7032f2");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"htmldoc-1.9.7-1.fc31")) flag++;
