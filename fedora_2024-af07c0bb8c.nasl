...
# extracted from Fedora Security Advisory FEDORA-2024-af07c0bb8c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-af07c0bb8c");

  script_name(english:"Fedora 40 : python-urllib3 (2024-af07c0bb8c)");
...
FEDORA-2024-af07c0bb8c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-af07c0bb8c");
...
var pkgs = [
    {'reference':'python-urllib3-1.26.19-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
