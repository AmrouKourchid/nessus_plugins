...
the USN-5471-1 advisory.
    ...
    of service (system crash) or possibly execute arbitrary code. (CVE-2022-1836)
    ...
    Joseph Ravichandran and Michael Wang discovered that the io_uring subsystem in the Linux kernel did not
    properly initialize data in some situations. A local attacker could use this to expose sensitive
    information (kernel memory). (CVE-2022-29968)
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-29968");
...
{
  var cve_list = make_list('CVE-2022-1012', 'CVE-2022-1205', 'CVE-2022-1734', 'CVE-2022-21499', 'CVE-2022-29968');
