...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Binutils PHSA-2018-2.0-0037");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"vuln_publication_date", value:"2018/02/17");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'binutils-2.30-4.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'binutils-debuginfo-2.30-4.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'binutils-devel-2.30-4.ph2')) flag++;
