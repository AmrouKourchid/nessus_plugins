...
# extracted from Red Hat Security Advisory RHSA-2019:3743. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:3743");

  script_name(english:"RHEL 7 : openstack-octavia (RHSA-2019:3743)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for openstack-octavia.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2019:3743 advisory.
    ...
    * openstack-octavia: amphora-agent not requiring client certificate (CVE-2019-17134)
    ...
    For more details about the security issue, including the impact, a CVSS score, acknowledgments, and other
    related information, refer to the CVE page listed in the References section.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1761307");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1762807");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_3743.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f215d9a8");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:3743");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL openstack-octavia package based on the guidance in RHSA-2019:3743.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openstack-octavia-amphora-agent-3.1.0-3.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'openstack-octavia-api-3.1.0-3.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'openstack-octavia-common-3.1.0-3.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'openstack-octavia-diskimage-create-3.1.0-3.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'openstack-octavia-health-manager-3.1.0-3.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'openstack-octavia-housekeeping-3.1.0-3.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'openstack-octavia-worker-3.1.0-3.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'python-octavia-3.1.0-3.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'python-octavia-tests-golang-3.1.0-3.el7ost', 'cpu':'ppc64le', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'python-octavia-tests-golang-3.1.0-3.el7ost', 'cpu':'x86_64', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
