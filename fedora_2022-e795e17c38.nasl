...
# extracted from Fedora Security Advisory FEDORA-2022-e795e17c38
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-e795e17c38");

  script_name(english:"Fedora 37 : drupal7-link (2022-e795e17c38)");
...
FEDORA-2022-e795e17c38 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-e795e17c38");
...
var pkgs = [
    {'reference':'drupal7-link-1.11-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
