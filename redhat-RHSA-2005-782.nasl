...
if (description)
{
  ...
  script_name(english:"RHEL 4 : util-linux and mount (RHSA-2005:782)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for util-linux / mount.");
...
referenced in the RHSA-2005:782 advisory.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2005/rhsa-2005_782.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?01f0e35c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=161337");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=168206");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=168209");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2005:782");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL util-linux / mount packages based on the guidance in RHSA-2005:782.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:L/UI:N/S:U/C:N/I:H/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2005-2876");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2001-1494");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'util-linux-2.12a-16.EL4.12', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'util-linux-2.12a-16.EL4.12', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'util-linux-2.12a-16.EL4.12', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'util-linux-2.12a-16.EL4.12', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'util-linux-2.12a-16.EL4.12', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
