...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : glusterfs (EulerOS-SA-2024-1933)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1933
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?154a878d");
...
var pkgs = [
  "glusterfs-7.0-5.h3.eulerosv2r9",
  "python3-gluster-7.0-5.h3.eulerosv2r9"
];
