...
# extracted from Fedora Security Advisory FEDORA-2023-ccaf5538dd
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-ccaf5538dd");

  script_name(english:"Fedora 38 : skopeo (2023-ccaf5538dd)");
...
FEDORA-2023-ccaf5538dd advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-ccaf5538dd");
...
var pkgs = [
    {'reference':'skopeo-1.11.2-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
