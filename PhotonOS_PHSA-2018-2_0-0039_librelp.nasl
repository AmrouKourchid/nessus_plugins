...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Librelp PHSA-2018-2.0-0039");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'librelp-1.2.13-2.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'librelp-debuginfo-1.2.13-2.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'librelp-devel-1.2.13-2.ph2')) flag++;
