...
if (description)
{
  ...
  script_name(english:"Foxit PDF Editor for Mac < 11.1.5 Multiple Vulnerabilities");
...
on the remote macOS host is prior to 11.1.5. It is, therefore affected by multiple vulnerabilities:
...
"Upgrade to Foxit PDF Editor for Mac version 11.1.5 or later");
...
var constraints = [
  { 'max_version' : '11.1.4.1121', 'fixed_version' : '11.1.5' }
];
