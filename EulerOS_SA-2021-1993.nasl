...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : openssh (EulerOS-SA-2021-1993)");
...
vulnerability :
  ...
  - scp in OpenSSH through 8.3p1 allows command injection
    in the scp.c toremote function, as demonstrated by
    backtick characters in the destination argument. NOTE:
    the vendor reportedly has stated that they
    intentionally omit validation of 'anomalous argument
    transfers' because that could 'stand a great chance of
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1993
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?90427668");
...
pkgs = ["openssh-7.8p1-3.h48.eulerosv2r8",
        "openssh-askpass-7.8p1-3.h48.eulerosv2r8",
        "openssh-cavs-7.8p1-3.h48.eulerosv2r8",
        "openssh-clients-7.8p1-3.h48.eulerosv2r8",
        "openssh-keycat-7.8p1-3.h48.eulerosv2r8",
        "openssh-ldap-7.8p1-3.h48.eulerosv2r8",
