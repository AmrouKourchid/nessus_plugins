...
# extracted from Fedora Security Advisory FEDORA-2023-dc0a020a2e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-dc0a020a2e");

  script_name(english:"Fedora 37 : golang (2023-dc0a020a2e)");
...
FEDORA-2023-dc0a020a2e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-dc0a020a2e");
...
var pkgs = [
    {'reference':'golang-1.19.7-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
