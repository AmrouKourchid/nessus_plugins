...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Mysql PHSA-2022-3.0-0415");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2021-22570");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'mysql-8.0.29-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'mysql-devel-8.0.29-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'mysql-icu-data-files-8.0.29-1.ph3')) flag++;
