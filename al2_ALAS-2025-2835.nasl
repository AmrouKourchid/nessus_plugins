...
# extracted from Amazon Linux 2 Security Advisory ALAS-2025-2835.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : nss-softokn (ALAS-2025-2835)");
...
vulnerability as referenced in the ALAS2-2025-2835 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2025-2835.html");
