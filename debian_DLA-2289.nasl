...
# extracted from Debian Security Advisory DLA-2289-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2289-1 : mupdf security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"Several issues have been found in mupdf, a lightweight PDF viewer.

The issues could be exploited by crafted PDF files that result in
denial of service by heap-based buffer overflows, segmentation faults
or out of bound reads.
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2020/07/msg00019.html");
...
"Upgrade the affected libmupdf-dev, mupdf, and mupdf-tools packages.");
...
flag = 0;
if (deb_check(release:"9.0", prefix:"libmupdf-dev", reference:"1.9a+ds1-4+deb9u5")) flag++;
if (deb_check(release:"9.0", prefix:"mupdf", reference:"1.9a+ds1-4+deb9u5")) flag++;
if (deb_check(release:"9.0", prefix:"mupdf-tools", reference:"1.9a+ds1-4+deb9u5")) flag++;
