...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.04 / MAIN 5.04 : gnome-shell Vulnerability (NS-SA-2020-0066)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version CORE 5.04 / MAIN 5.04, has gnome-shell packages installed that are
...
pkgs = {
  'CGSL CORE 5.04': [
    'gnome-shell-3.28.3-24.el7.cgslv5.0.3.gaeef1a3',
    'gnome-shell-debuginfo-3.28.3-24.el7.cgslv5.0.3.gaeef1a3'
  ],
  'CGSL MAIN 5.04': [
    'gnome-shell-3.28.3-24.el7.cgslv5.0.3.gaeef1a3',
    'gnome-shell-debuginfo-3.28.3-24.el7.cgslv5.0.3.gaeef1a3'
