...
# extracted from Fedora Security Advisory FEDORA-2024-2aac54ebb7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-2aac54ebb7");

  script_name(english:"Fedora 38 : openssh (2024-2aac54ebb7)");
...
FEDORA-2024-2aac54ebb7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-2aac54ebb7");
...
var pkgs = [
    {'reference':'openssh-9.0p1-19.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
