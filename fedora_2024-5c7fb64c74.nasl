...
# extracted from Fedora Security Advisory FEDORA-2024-5c7fb64c74
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-5c7fb64c74");

  script_name(english:"Fedora 40 : python-django (2024-5c7fb64c74)");
...
FEDORA-2024-5c7fb64c74 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-5c7fb64c74");
...
var pkgs = [
    {'reference':'python-django-4.2.11-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
