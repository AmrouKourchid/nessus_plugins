...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Gnupg PHSA-2019-1.0-0246");
...
if (rpm_check(release:"PhotonOS-1.0", reference:"gnupg-2.2.17-1.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"gnupg-debuginfo-2.2.17-1.ph1")) flag++;
