...
referenced in the USN-4627-1 advisory.

    Moritz Lipp, Michael Schwarz, Andreas Kogler, David Oswald, Catherine Easdon, Claudio Canella, and Daniel
    Gruss discovered that the Intel Running Average Power Limit (RAPL) driver in the Linux kernel did not
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.4.0-194-powerpc-e500mc");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.4.0-194-powerpc-smp");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.4.0-194-powerpc64-emb");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.4.0-194-powerpc64-smp");
...
var kernel_mappings = {
  '16.04': {
    '4.15.0': {
      'generic': '4.15.0-123',
      'generic-lpae': '4.15.0-123',
      'lowlatency': '4.15.0-123',
      'oracle': '4.15.0-1058',
      'gcp': '4.15.0-1087'
    },
    '4.4.0': {
      'generic': '4.4.0-194',
      'generic-lpae': '4.4.0-194',
      'lowlatency': '4.4.0-194',
      'powerpc-e500mc': '4.4.0-194',
      'powerpc-smp': '4.4.0-194',
      'powerpc64-emb': '4.4.0-194',
      'powerpc64-smp': '4.4.0-194'
    }
  },
  '18.04': {
    '4.15.0': {
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-4627-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2020-8694');
