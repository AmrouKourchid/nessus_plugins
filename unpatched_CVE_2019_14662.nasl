...
if (description)
{
  ...
  script_cve_id("CVE-2019-14662");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2019-14662");
...
patch available.
  ...
  - Brandy 1.20.1 has a stack-based buffer overflow in fileio_openout in fileio.c via crafted BASIC source
    code. (CVE-2019-14662)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-14662");
