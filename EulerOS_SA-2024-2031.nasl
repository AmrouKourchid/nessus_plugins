...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : graphviz (EulerOS-SA-2024-2031)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the graphviz packages installed, the EulerOS installation on the remote host is affected by
...
Tenable has extracted the preceding description block directly from the EulerOS graphviz security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2031
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8db7d0c7");
...
var pkgs = [
  "graphviz-2.40.1-36.h6.eulerosv2r8",
  "graphviz-tcl-2.40.1-36.h6.eulerosv2r8"
];
