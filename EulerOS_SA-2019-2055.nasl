...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : wpa_supplicant (EulerOS-SA-2019-2055)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2055
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0c889057");
...
pkgs = ["wpa_supplicant-2.6-5.1.h10"];
