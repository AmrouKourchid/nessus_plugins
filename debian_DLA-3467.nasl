...
# extracted from Debian Security Advisory dla-3467. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3467 : hsqldb-utils - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3467
advisory.

    -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3467-1                debian-lts@lists.debian.org
...
var pkgs = [
    {'release': '10.0', 'prefix': 'hsqldb-utils', 'reference': '2.4.1-2+deb10u2'},
    {'release': '10.0', 'prefix': 'libhsqldb-java', 'reference': '2.4.1-2+deb10u2'},
    {'release': '10.0', 'prefix': 'libhsqldb-java-doc', 'reference': '2.4.1-2+deb10u2'}
];
