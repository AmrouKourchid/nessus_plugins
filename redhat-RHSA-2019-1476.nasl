...
# extracted from Red Hat Security Advisory RHSA-2019:1476. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:1476");

  script_name(english:"RHEL 6 : flash-plugin (RHSA-2019:1476)");
...
referenced in the RHSA-2019:1476 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_1476.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0335443a");
  script_set_attribute(attribute:"see_also", value:"https://helpx.adobe.com/security/products/flash-player/apsb19-30.html");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:1476");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#critical");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1719449");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL flash-plugin package based on the guidance in RHSA-2019:1476.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'flash-plugin-32.0.0.207-1.el6_10', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
