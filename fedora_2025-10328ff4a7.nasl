...
# extracted from Fedora Security Advisory FEDORA-2025-10328ff4a7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-10328ff4a7");
  script_xref(name:"IAVA", value:"2025-A-0306");

  script_name(english:"Fedora 40 : LibRaw (2025-10328ff4a7)");
...
FEDORA-2025-10328ff4a7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-10328ff4a7");
...
var pkgs = [
    {'reference':'LibRaw-0.21.4-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
