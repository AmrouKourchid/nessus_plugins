...
# extracted from Amazon Linux 2 Security Advisory ALASNITRO-ENCLAVES-2023-030.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : docker (ALASNITRO-ENCLAVES-2023-030)");
...
vulnerabilities as referenced in the ALAS2NITRO-ENCLAVES-2023-030 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALASNITRO-ENCLAVES-2023-030.html");
