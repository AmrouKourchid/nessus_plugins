...
# extracted from Fedora Security Advisory FEDORA-2024-4b0288e34f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-4b0288e34f");

  script_name(english:"Fedora 40 : dr_libs (2024-4b0288e34f)");
...
FEDORA-2024-4b0288e34f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-4b0288e34f");
...
var pkgs = [
    {'reference':'dr_libs-0^20241216git660795b-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
