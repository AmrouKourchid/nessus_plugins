...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2011-0345.html");
...
"Update the affected qemu-img, qemu-kvm and / or qemu-kvm-tools packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2011-0011");
...
var pkgs = [
    {'reference':'qemu-img-0.12.1.2-2.113.el6_0.8', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'qemu-kvm-0.12.1.2-2.113.el6_0.8', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'qemu-kvm-tools-0.12.1.2-2.113.el6_0.8', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
