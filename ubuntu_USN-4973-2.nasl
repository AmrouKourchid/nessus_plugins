...
USN-4973-2 advisory.
    ...
    USN-4973-1 fixed this vulnerability previously, but it was re-introduced in python3.8 in focal because of
    the SRU in LP: #1928057. This update fixes the problem.
