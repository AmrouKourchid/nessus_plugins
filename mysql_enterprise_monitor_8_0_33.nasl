...
if (description)
{
  ...
  script_name(english:"Oracle MySQL Enterprise Monitor (Jan 2023 CPU)");
...
referenced in the January 2023 CPU advisory.
  ...
  - Vulnerability in the MySQL Enterprise Monitor product of Oracle MySQL (component: Monitoring: General
    (Spring Security)). Supported versions that are affected are 8.0.32 and prior. Easily exploitable
    vulnerability allows unauthenticated attacker with network access via multiple protocols to compromise
    MySQL Enterprise Monitor. Successful attacks of this vulnerability can result in takeover of MySQL
    Enterprise Monitor. (CVE-2022-31692)

  - Vulnerability in the MySQL Enterprise Monitor product of Oracle MySQL (component: Monitoring: General
    (Apache Tomcat)). Supported versions that are affected are 8.0.32 and prior. Easily exploitable
    vulnerability allows unauthenticated attacker with network access via multiple protocols to compromise
  ...
  - Vulnerability in the MySQL Enterprise Monitor product of Oracle MySQL (component: Monitoring: General
    (Spring Framework)). Supported versions that are affected are 8.0.32 and prior. Easily exploitable
    ...
    cause a hang or frequently repeatable crash (complete DOS) of MySQL Enterprise Monitor. (CVE-2022-22971)
...
"Apply the appropriate patch according to the January 2023 Oracle Critical Patch Update advisory.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2022-31692");
...
var constraints = [
  { 'min_version' : '8.0', 'fixed_version' : '8.0.33' }
];
