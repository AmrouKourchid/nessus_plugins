...
# extracted from Fedora Security Advisory FEDORA-2024-d8a0e599e2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-d8a0e599e2");

  script_name(english:"Fedora 40 : thunderbird (2024-d8a0e599e2)");
...
FEDORA-2024-d8a0e599e2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-d8a0e599e2");
...
var pkgs = [
    {'reference':'thunderbird-115.8.1-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
