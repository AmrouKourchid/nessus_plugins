...
if (description)
{
  ...
  script_cve_id("CVE-2023-30431");
  script_xref(name:"IAVB", value:"2023-B-0057-S");

  script_name(english:"IBM DB2 Buffer Overflow (7010565) (Unix)");

  script_set_attribute(attribute:"synopsis", value:
"The remote database server is affected by a buffer overflow condition");
  script_set_attribute(attribute:"description", value:
"According to it self-reported version number, IBM Db2 is is vulnerable to a is vulnerable to a buffer overflow, 
caused by improper bounds checking. An attacker could overflow the buffer and execute arbitrary code.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/node/7010565");
...
"Apply the appropriate IBM DB2 Fix Pack or Special Build based on the most recent fix pack level for your branch.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-30431");
...
var constraints = [
  {'equal':'10.5.0.11', 'fixed_build':'41328'},
  {'min_version':'10.5', 'fixed_version':'10.5.0.11', 'fixed_display':'10.5.0.11 + Special Build 41328'},
  {'equal':'11.1.4.7', 'fixed_build':'41327'},
  {'min_version':'11.1', 'fixed_version':'11.1.4.7', 'fixed_display':'11.1.4.7 + Special Build 41327'},
  {'equal':'11.5.7.0', 'fixed_build':'31201'},
  {'min_version':'11.5', 'fixed_version':'11.5.7.0', 'fixed_display':'11.5.7 + Special Build 31201'},
  {'equal':'11.5.8.0', 'fixed_build':'31203'}
];
