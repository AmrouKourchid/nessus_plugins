...
# extracted from Debian Security Advisory DLA-2183-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2183-1 : libgsf security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2020/04/msg00016.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/jessie/libgsf");
...
"Upgrade the affected packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-9888");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"gir1.2-gsf-1", reference:"1.14.30-2+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"libgsf-1-114", reference:"1.14.30-2+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"libgsf-1-114-dbg", reference:"1.14.30-2+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"libgsf-1-common", reference:"1.14.30-2+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"libgsf-1-dev", reference:"1.14.30-2+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"libgsf-bin", reference:"1.14.30-2+deb8u1")) flag++;
