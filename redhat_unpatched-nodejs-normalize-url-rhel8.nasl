...
# extracted from Red Hat Security Advisory nodejs-normalize-url. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2021-33502");

  script_name(english:"RHEL 8 : nodejs-normalize-url (Unpatched Vulnerability) (deprecated)");
...
"This plugin has been deprecated as it does not adhere to established standards for this style of check.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-33502");
