...
# extracted from Oracle Linux Security Advisory ELSA-2020-0487.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : sudo (ELSA-2020-0487)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2020-0487.html");
...
var pkgs = [
    {'reference':'sudo-1.8.25p1-8.el8_1.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sudo-1.8.25p1-8.el8_1.1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
