...
# extracted from Fedora Security Advisory FEDORA-2019-03ac7f1d2f.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-03ac7f1d2f");

  script_name(english:"Fedora 30 : 1:qt (2019-03ac7f1d2f)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-03ac7f1d2f");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"qt-4.8.7-47.fc30", epoch:"1")) flag++;
