...
# extracted from Red Hat Security Advisory RHSA-2021:3297. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:3297");

  script_name(english:"RHEL 8 : libsndfile (RHSA-2021:3297)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for libsndfile.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2021:3297 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_3297.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c09beeaa");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:3297");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1984319");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libsndfile package based on the guidance in RHSA-2021:3297.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libsndfile-1.0.28-8.el8_1.1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsndfile-devel-1.0.28-8.el8_1.1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
