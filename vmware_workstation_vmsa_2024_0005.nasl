...
if (description)
{
  ...
  script_xref(name:"VMSA", value:"2024-0005");
  script_xref(name:"IAVA", value:"2024-A-0120");

  script_name(english:"VMware Workstation 17.0.x < 17.5.1 Vulnerability (VMSA-2024-0005)");

  script_set_attribute(attribute:"synopsis", value:
"A virtualization application installed on the remote Windows host is affected by a vulnerability");
  script_set_attribute(attribute:"description", value:
"The version of VMware Workstation installed on the remote host is 17.0.x prior to 17.5.1. It is, therefore, affected by
a vulnerability.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.vmware.com/security/advisories/VMSA-2024-0005.html");
  script_set_attribute(attribute:"solution", value:
"Update to VMware Workstation version 17.5.1, or later.");
  script_set_attribute(attribute:"agent", value:"all");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:H/PR:N/UI:N/S:C/C:H/I:N/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2024-22251");
...
var constraints = [
  { 'min_version' : '17.0', 'fixed_version' : '17.5.1' }
];
