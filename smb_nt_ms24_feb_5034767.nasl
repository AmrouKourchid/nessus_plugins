...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5034767");
  script_xref(name:"MSFT", value:"MS24-5034767");
  script_xref(name:"IAVA", value:"2024-A-0092-S");
  script_xref(name:"IAVA", value:"2024-A-0091-S");

  script_name(english:"KB5034767: Windows 10 Version 1607 and Windows Server 2016 Security Update (February 2024)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5034767");
