...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Libevent PHSA-2017-0013");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'libevent-2.1.8-1.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'libevent-debuginfo-2.1.8-1.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'libevent-devel-2.1.8-1.ph1')) flag++;
