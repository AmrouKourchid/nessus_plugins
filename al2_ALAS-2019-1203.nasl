...
# extracted from Amazon Linux 2 Security Advisory ALAS-2019-1203.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2019-1203");

  script_name(english:"Amazon Linux 2 : gnupg2 (ALAS-2019-1203)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The do_uncompress function in g10/compress.c allows context-dependent
attackers to cause a denial of service (infinite loop) via malformed
compressed packets, as demonstrated by an a3 01 5b ff byte
sequence.(CVE-2014-4617)");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2019-1203.html");
...
flag = 0;
if (rpm_check(release:"AL2", reference:"gnupg2-2.0.22-5.amzn2.0.3")) flag++;
if (rpm_check(release:"AL2", reference:"gnupg2-debuginfo-2.0.22-5.amzn2.0.3")) flag++;
if (rpm_check(release:"AL2", reference:"gnupg2-smime-2.0.22-5.amzn2.0.3")) flag++;
