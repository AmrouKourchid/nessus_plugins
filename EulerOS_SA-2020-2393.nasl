...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : qt (EulerOS-SA-2020-2393)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2393
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a374392f");
...
pkgs = ["qt-4.8.5-12.h9",
        "qt-devel-4.8.5-12.h9",
        "qt-mysql-4.8.5-12.h9",
        "qt-odbc-4.8.5-12.h9",
        "qt-postgresql-4.8.5-12.h9",
        "qt-x11-4.8.5-12.h9"];
