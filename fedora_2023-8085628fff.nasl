...
# extracted from Fedora Security Advisory FEDORA-2023-8085628fff
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-8085628fff");

  script_name(english:"Fedora 38 : python3.9 (2023-8085628fff)");
...
FEDORA-2023-8085628fff advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-8085628fff");
...
var pkgs = [
    {'reference':'python3.9-3.9.18-3.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
