...
# extracted from Gentoo Linux Security Advisory GLSA 202003-13.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2019-14697");
  script_xref(name:"GLSA", value:"202003-13");

  script_name(english:"GLSA-202003-13 : musl: x87 floating-point stack adjustment imbalance");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202003-13
(musl: x87 floating-point stack adjustment imbalance)

    A flaw in musl libc&rsquo;s arch-specific math assembly code for i386 was
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202003-13");
...
if (qpkg_check(package:"sys-libs/musl", unaffected:make_list("ge 1.1.24"), vulnerable:make_list("lt 1.1.24"))) flag++;
