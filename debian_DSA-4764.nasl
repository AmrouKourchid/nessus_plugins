...
the InspIRCd IRC daemon, which could result in denial of service.");
  script_set_attribute(attribute:"see_also", value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=960650");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/inspircd");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/inspircd");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2020/dsa-4764");
...
in version 2.0.27-1+deb10u1.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-25269");
