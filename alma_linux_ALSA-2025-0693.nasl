...
# AlmaLinux Security Advisory ALSA-2025:0693.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2025:0693");
  script_xref(name:"RHSA", value:"2025:0693");

  script_name(english:"AlmaLinux 9 : redis (ALSA-2025:0693)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 9 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ALSA-2025:0693 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2025-0693.html");
...
"Update the affected redis, redis-devel and / or redis-doc packages.");
  ...
  script_cwe_id(121, 20, 269, 416, 674, 680);
...
var pkgs = [
    {'reference':'redis-6.2.17-1.el9_5', 'release':'9', 'el_string':'el9_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'redis-devel-6.2.17-1.el9_5', 'release':'9', 'el_string':'el9_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
