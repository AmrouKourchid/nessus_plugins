...
# extracted from Debian Security Advisory dsa-5913. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5913 : openjdk-17-dbg - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2025-21587");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2025-30691");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2025-30698");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'openjdk-17-dbg', 'reference': '17.0.15+6-1~deb12u1'},
    {'release': '12.0', 'prefix': 'openjdk-17-demo', 'reference': '17.0.15+6-1~deb12u1'},
    {'release': '12.0', 'prefix': 'openjdk-17-doc', 'reference': '17.0.15+6-1~deb12u1'},
    {'release': '12.0', 'prefix': 'openjdk-17-jdk', 'reference': '17.0.15+6-1~deb12u1'},
    {'release': '12.0', 'prefix': 'openjdk-17-jdk-headless', 'reference': '17.0.15+6-1~deb12u1'},
    {'release': '12.0', 'prefix': 'openjdk-17-jre', 'reference': '17.0.15+6-1~deb12u1'},
    {'release': '12.0', 'prefix': 'openjdk-17-jre-headless', 'reference': '17.0.15+6-1~deb12u1'},
    {'release': '12.0', 'prefix': 'openjdk-17-jre-zero', 'reference': '17.0.15+6-1~deb12u1'},
    {'release': '12.0', 'prefix': 'openjdk-17-source', 'reference': '17.0.15+6-1~deb12u1'}
];
