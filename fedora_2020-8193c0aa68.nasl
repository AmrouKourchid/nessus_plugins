...
# extracted from Fedora Security Advisory FEDORA-2020-8193c0aa68.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-8193c0aa68");

  script_name(english:"Fedora 30 : mingw-openjpeg2 / openjpeg2 (2020-8193c0aa68)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-8193c0aa68");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"mingw-openjpeg2-2.3.1-7.fc30")) flag++;
if (rpm_check(release:"FC30", reference:"openjpeg2-2.3.1-6.fc30")) flag++;
