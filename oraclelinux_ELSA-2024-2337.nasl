...
# extracted from Oracle Linux Security Advisory ELSA-2024-2337.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : python3.11-cryptography (ELSA-2024-2337)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-2337.html");
...
var pkgs = [
    {'reference':'python3.11-cryptography-37.0.2-6.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3.11-cryptography-37.0.2-6.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
