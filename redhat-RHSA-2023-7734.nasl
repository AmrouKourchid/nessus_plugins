...
# extracted from Red Hat Security Advisory RHSA-2023:7734. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2023-5345", "CVE-2023-45871");
  script_xref(name:"RHSA", value:"2023:7734");

  script_name(english:"RHEL 9 : kpatch-patch (RHSA-2023:7734)");
...
referenced in the RHSA-2023:7734 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_7734.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?580c97f2");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:7734");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL kpatch-patch package based on the guidance in RHSA-2023:7734.");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  var cve_list = make_list('CVE-2023-5345', 'CVE-2023-45871');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for RHSA-2023:7734');
  }
  else
  {
...
var kernel_live_checks = [
  {
    ...
    'kernels': {
      '5.14.0-362.8.1.el9_3.ppc64le': {
        'pkgs': [
          {'reference':'kpatch-patch-5_14_0-362_8_1-1-1.el9_3', 'cpu':'ppc64le', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        ]
      },
      '5.14.0-362.8.1.el9_3.x86_64': {
        'pkgs': [
          {'reference':'kpatch-patch-5_14_0-362_8_1-1-1.el9_3', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kpatch-patch-5_14_0-362_8_1');
}
