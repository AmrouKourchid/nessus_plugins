...
# extracted from Red Hat Security Advisory nodejs. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 8 : nodejs (Unpatched Vulnerability) (deprecated)");
...
"This plugin has been deprecated as it does not adhere to established standards for this style of check.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-15897");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2023-38552");
