...
if (description)
{
  ...
  script_name(english:"Debian dla-3393 : libprotobuf-dev - security update");
...
dla-3393 advisory.
    ...
    -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3393-1                debian-lts@lists.debian.org
    https://www.debian.org/lts/security/                        Helmut Grohne
    April 18, 2023                                https://wiki.debian.org/LTS
    -------------------------------------------------------------------------

    Package        : protobuf
    Version        : 3.6.1.3-2+deb10u1
    CVE ID         : CVE-2021-22569 CVE-2021-22570 CVE-2022-1941
...
"Upgrade the libprotobuf-dev packages.");
