...
# extracted from Fedora Security Advisory FEDORA-2023-575fcaf4bf
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-575fcaf4bf");

  script_name(english:"Fedora 36 : rust (2023-575fcaf4bf)");
...
FEDORA-2023-575fcaf4bf advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-575fcaf4bf");
...
var pkgs = [
    {'reference':'rust-1.66.1-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
