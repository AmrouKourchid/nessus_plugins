...
USN-5424-2 advisory.
    ...
    USN-5424-1 fixed a vulnerability in OpenLDAP. This update provides the corresponding update for Ubuntu
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'ldap-utils', 'pkgver': '2.4.42+dfsg-2ubuntu3.13+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libldap-2.4-2', 'pkgver': '2.4.42+dfsg-2ubuntu3.13+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libldap2-dev', 'pkgver': '2.4.42+dfsg-2ubuntu3.13+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'slapd', 'pkgver': '2.4.42+dfsg-2ubuntu3.13+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'slapd-smbk5pwd', 'pkgver': '2.4.42+dfsg-2ubuntu3.13+esm1', 'ubuntu_pro': TRUE}
];
