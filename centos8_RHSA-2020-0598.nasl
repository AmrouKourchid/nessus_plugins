...
# Red Hat Security Advisory RHSA-2020:0598. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : nodejs:12 (CESA-2020:0598)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
CESA-2020:0598 advisory.
...
var appstreams = {
    'nodejs:12': [
      {'reference':'nodejs-nodemon-1.18.3-1.module_el8.1.0+251+8afea200', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nodejs-packaging-17-3.module_el8.1.0+251+8afea200', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
};
