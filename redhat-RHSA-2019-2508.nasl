...
# extracted from Red Hat Security Advisory RHSA-2019:2508. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:2508");

  script_name(english:"RHEL 7 : redis (RHSA-2019:2508)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_2508.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a263f5cb");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:2508");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL redis package based on the guidance in RHSA-2019:2508.");
