...
if (description)
{
  ...
  script_name(english:"Adobe InDesign < 19.5.1 / 19.0 < 20.0.0 Multiple Vulnerabilities (APSB24-97)");

  script_set_attribute(attribute:"synopsis", value:
"The Adobe InDesign instance installed on the remote host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe InDesign installed on the remote Windows host is prior to 19.5.1, 20.0.0. It is, therefore,
affected by multiple vulnerabilities as referenced in the APSB24-97 advisory.
