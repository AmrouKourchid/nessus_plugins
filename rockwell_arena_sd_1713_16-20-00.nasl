...
if (description)
{
  ...
  script_cve_id("CVE-2024-11155", "CVE-2024-11158");
  script_xref(name:"IAVB", value:"2024-B-0195-S");

  script_name(english:"Rockwell Automation Arena < 16.20.06 Multiple Vulnerabilities");
...
16.20.06. It is, therefore, affected by a number of different vulnerabilities
  ...
  - A “use after free”  code execution vulnerability exists in the affected products that could allow a threat actor 
    to craft a DOE file and force the software to use a resource that was already used. If exploited, a threat actor
    could leverage this vulnerability to execute arbitrary code. To exploit this vulnerability, a legitimate user must 
    execute the malicious code crafted by the threat actor. (CVE_2024-11155)

  - An “uninitialized variable”  code execution vulnerability exists in the affected products that could allow a 
    threat actor to craft a DOE file and force the software to access a variable before it being initialized. 
    If exploited, a threat actor could leverage this vulnerability to execute arbitrary code. To exploit this 
    vulnerability, a legitimate user must execute the malicious code crafted by the threat actor. (CVE-2024-11158)
...
"Upgrade to Rockwell Automation Arena 16.20.06 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-11155");
...
var constraints = [
  { 'max_version':'16.20.00', 'fixed_version' : '16.20.06' }
];
