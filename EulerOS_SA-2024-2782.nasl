...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.12.0 : qemu (EulerOS-SA-2024-2782)");
...
affected by the following vulnerabilities :
    ...
    of service condition.(CVE-2024-4467)
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2782
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9dfc4354");
...
var pkgs = [
  "qemu-6.2.0.oe2203sp1-2.12.0.5.388"
];
