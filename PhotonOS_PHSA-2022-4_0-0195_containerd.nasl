...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Containerd PHSA-2022-4.0-0195");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'containerd-1.4.13-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'containerd-doc-1.4.13-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'containerd-extras-1.4.13-1.ph4')) flag++;
