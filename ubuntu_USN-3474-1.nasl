...
USN-3474-1 advisory.
    ...
    Raphael Sanchez Prudencio discovered that Liblouis incorrectly handled certain files. If a user were
    tricked into opening a crafted file, an attacker could possibly use this to cause a denial of service or
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3474-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'liblouis-bin', 'pkgver': '2.5.3-2ubuntu1.2'},
    {'osver': '14.04', 'pkgname': 'liblouis-data', 'pkgver': '2.5.3-2ubuntu1.2'},
    {'osver': '14.04', 'pkgname': 'liblouis-dev', 'pkgver': '2.5.3-2ubuntu1.2'},
    {'osver': '14.04', 'pkgname': 'liblouis2', 'pkgver': '2.5.3-2ubuntu1.2'},
    {'osver': '14.04', 'pkgname': 'python-louis', 'pkgver': '2.5.3-2ubuntu1.2'},
    {'osver': '14.04', 'pkgname': 'python3-louis', 'pkgver': '2.5.3-2ubuntu1.2'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'liblouis-bin / liblouis-data / liblouis-dev / liblouis2 / etc');
}
