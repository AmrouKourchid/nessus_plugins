...
# extracted from Fedora Security Advisory FEDORA-2021-c314017fcc
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-c314017fcc");

  script_name(english:"Fedora 32 : perl-Net-Netmask (2021-c314017fcc)");
...
FEDORA-2021-c314017fcc advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-c314017fcc");
...
"Update the affected perl-Net-Netmask package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:perl-Net-Netmask");
...
pkgs = [
    {'reference':'perl-Net-Netmask-2.0001-1.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE}
];
