...
# extracted from Ubuntu Security Notice USN-4225-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS : Linux kernel vulnerabilities (USN-4225-1)");
...
the USN-4225-1 advisory.
    ...
    It was discovered that the Broadcom V3D DRI driver in the Linux kernel did not properly deallocate memory
    in certain error conditions. A local attacker could possibly use this to cause a denial of service (kernel
    ...
    It was discovered that the Mellanox Technologies ConnectX driver in the Linux kernel did not properly
    deallocate memory in certain failure conditions. A local attacker could use this to cause a denial of
    service (kernel memory exhaustion). (CVE-2019-19047)
    ...
    Tristan Madani discovered that the ALSA timer implementation in the Linux kernel contained a use-after-
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4225-1");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.3.0-1009-azure");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.3.0-1010-gcp");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-4225-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2019-14895', 'CVE-2019-14896', 'CVE-2019-14897', 'CVE-2019-14901', 'CVE-2019-16231', 'CVE-2019-18660', 'CVE-2019-18813', 'CVE-2019-19044', 'CVE-2019-19045', 'CVE-2019-19047', 'CVE-2019-19051', 'CVE-2019-19052', 'CVE-2019-19055', 'CVE-2019-19072', 'CVE-2019-19524', 'CVE-2019-19529', 'CVE-2019-19534', 'CVE-2019-19807');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-4225-1');
  }
  else
  {
