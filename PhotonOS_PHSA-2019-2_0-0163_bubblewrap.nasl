...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Bubblewrap PHSA-2019-2.0-0163");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'bubblewrap-0.1.8-2.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'bubblewrap-debuginfo-0.1.8-2.ph2')) flag++;
