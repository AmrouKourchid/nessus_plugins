...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : avahi (EulerOS-SA-2024-1053)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1053
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?02b40db8");
...
var pkgs = [
  "avahi-libs-0.8-1.h13.eulerosv2r10"
];
