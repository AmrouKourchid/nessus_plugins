...
# extracted from Fedora Security Advisory FEDORA-2024-4ab266b9ca
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-4ab266b9ca");

  script_name(english:"Fedora 40 : chromium (2024-4ab266b9ca)");
...
FEDORA-2024-4ab266b9ca advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-4ab266b9ca");
...
var pkgs = [
    {'reference':'chromium-129.0.6668.100-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
