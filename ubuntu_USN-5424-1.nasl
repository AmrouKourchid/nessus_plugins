...
referenced in the USN-5424-1 advisory.

    It was discovered that OpenLDAP incorrectly handled certain SQL statements within LDAP queries in the
    experimental back-sql backend. A remote attacker could possibly use this issue to perform an SQL injection
    attack and alter the database.
