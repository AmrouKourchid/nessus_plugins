...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : http-parser on SL7.x x86_64 (20200304)");
...
"Security Fix(es) :
  ...
  - nodejs: HTTP request smuggling using malformed
    Transfer-Encoding header (CVE-2019-15605)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind2003&L=SCIENTIFIC-LINUX-ERRATA&P=76
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ed6bc1d0");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"http-parser-2.7.1-8.el7_7.2")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"http-parser-debuginfo-2.7.1-8.el7_7.2")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"http-parser-devel-2.7.1-8.el7_7.2")) flag++;
