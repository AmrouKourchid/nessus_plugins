...
# SUSE update advisory SUSE-SU-2020:14355-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2020:14355-1");
  script_xref(name:"IAVA", value:"2020-A-0381");

  script_name(english:"SUSE SLES11 Security Update : LibVNCServer (SUSE-SU-2020:14355-1)");
...
the SUSE-SU-2020:14355-1 advisory.
  ...
  - libvncclient/cursor.c in LibVNCServer through 0.9.12 has a HandleCursorShape integer overflow and heap-
    based buffer overflow via a large height or width value. NOTE: this may overlap CVE-2019-15690.
    (CVE-2019-20788)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1155419");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1160471");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1170441");
  # https://lists.suse.com/pipermail/sle-security-updates/2020-May/006774.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?42121f86");
...
pkgs = [
    {'reference':'LibVNCServer-0.9.1-160.14', 'sp':'4', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'SLES_SAP-release-11.4'},
    {'reference':'LibVNCServer-0.9.1-160.14', 'sp':'4', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'sles-release-11.4'}
];
