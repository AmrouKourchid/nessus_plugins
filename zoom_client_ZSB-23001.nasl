...
if (description)
{
  ...
  script_name(english:"Zoom VDI Meeting Client < 5.13.1 Vulnerability (ZSB-23001)");
...
"Upgrade to Zoom VDI Meeting Client 5.13.1 or later.");
  ...
  script_require_ports("installed_sw/Zoom Client for VDI", "installed_sw/Zoom Client for VDI", "installed_sw/zoom");
