...
# extracted from VMware Security Advisory PHSA-2023-4.0-0309. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Libksba PHSA-2023-4.0-0309");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the libksba package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-309.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libksba-1.4.0-3.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libksba-devel-1.4.0-3.ph4')) flag++;
