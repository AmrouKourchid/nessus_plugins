...
# extracted from Slackware Security Advisory SSA:2023-348-01. The text
...
if (description)
{
  ...
  script_name(english:"Slackware Linux 15.0 / current bluez  Vulnerability (SSA:2023-348-01)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Slackware Linux host is missing a security update to bluez.");
  script_set_attribute(attribute:"description", value:
"The version of bluez installed on the remote host is prior to 5.71. It is, therefore, affected by a vulnerability as
referenced in the SSA:2023-348-01 advisory.
...
number.");
  # http://www.slackware.com/security/viewer.php?l=slackware-security&y=2023&m=slackware-security.349382
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9d36e867");
  script_set_attribute(attribute:"solution", value:
"Upgrade the affected bluez package.");
...
var flag = 0;
var constraints = [
    { 'fixed_version' : '5.71', 'product' : 'bluez', 'os_name' : 'Slackware Linux', 'os_version' : '15.0', 'service_pack' : '1_slack15.0', 'arch' : 'i586' },
    { 'fixed_version' : '5.71', 'product' : 'bluez', 'os_name' : 'Slackware Linux', 'os_version' : '15.0', 'service_pack' : '1_slack15.0', 'arch' : 'x86_64' },
    { 'fixed_version' : '5.71', 'product' : 'bluez', 'os_name' : 'Slackware Linux', 'os_version' : 'current', 'service_pack' : '1', 'arch' : 'i586' },
    { 'fixed_version' : '5.71', 'product' : 'bluez', 'os_name' : 'Slackware Linux', 'os_version' : 'current', 'service_pack' : '1', 'arch' : 'x86_64' }
];
