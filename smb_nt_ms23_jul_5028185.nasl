...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5028185");
  script_xref(name:"MSFT", value:"MS23-5028185");
  script_xref(name:"IAVA", value:"2023-A-0347-S");
  script_xref(name:"IAVA", value:"2023-A-0345-S");

  script_name(english:"KB5028185: Windows 11 version 22H2 Security Update (July 2023)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5028185. It is, therefore, affected by multiple vulnerabilities
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5028185");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5028185");
