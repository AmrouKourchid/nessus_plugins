...
# extracted from Amazon Linux AMI Security Advisory ALAS-2022-1590.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux AMI : gzip (ALAS-2022-1590)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux AMI host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of gzip installed on the remote host is prior to 1.5-9.20. It is, therefore, affected by a vulnerability as
referenced in the ALAS-2022-1590 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/ALAS-2022-1590.html");
...
var pkgs = [
    {'reference':'gzip-1.5-9.20.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'gzip-1.5-9.20.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'gzip-debuginfo-1.5-9.20.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'gzip-debuginfo-1.5-9.20.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE}
];
