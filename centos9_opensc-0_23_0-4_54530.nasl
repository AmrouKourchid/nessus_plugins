...
if (description)
{
  ...
  script_name(english:"CentOS 9 : opensc-0.23.0-4.el9");
...
opensc-0.23.0-4.el9 build changelog.

  - Side-channel leaks while stripping encryption PKCS#1.5 padding (CVE-2023-5992)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=54530");
...
var pkgs = [
    {'reference':'opensc-0.23.0-4.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
