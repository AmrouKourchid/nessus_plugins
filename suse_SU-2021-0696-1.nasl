...
# extracted from SUSE update advisory SUSE-SU-2021:0696-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES15 Security Update : python-cryptography (SUSE-SU-2021:0696-1)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bb019bb8");
...
zypper in -t patch
SUSE-SLE-Product-SUSE-Manager-Retail-Branch-Server-4.0-2021-696=1
...
flag = 0;
if (rpm_check(release:"SLES15", sp:"1", reference:"python-cryptography-debuginfo-2.1.4-4.9.2")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"python-cryptography-debugsource-2.1.4-4.9.2")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"python2-cryptography-2.1.4-4.9.2")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"python2-cryptography-debuginfo-2.1.4-4.9.2")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"python3-cryptography-2.1.4-4.9.2")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"python3-cryptography-debuginfo-2.1.4-4.9.2")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"python-cryptography-debuginfo-2.1.4-4.9.2")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"python-cryptography-debugsource-2.1.4-4.9.2")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"python2-cryptography-2.1.4-4.9.2")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"python2-cryptography-debuginfo-2.1.4-4.9.2")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"python3-cryptography-2.1.4-4.9.2")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"python3-cryptography-debuginfo-2.1.4-4.9.2")) flag++;
