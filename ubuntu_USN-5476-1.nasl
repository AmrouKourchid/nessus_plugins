...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS / 22.04 LTS : Liblouis vulnerabilities (USN-5476-1)");
...
vulnerabilities as referenced in the USN-5476-1 advisory.
    ...
    Han Zheng discovered that Liblouis incorrectly handled certain inputs. An attacker could possibly use this
    issue to cause a crash. This issue was addressed in Ubuntu 21.10 and Ubuntu 22.04 LTS. (CVE-2022-26981)

    It was discovered that Liblouis incorrectly handled certain inputs. An attacker could possibly use this
    issue to execute arbitrary code or cause a crash. (CVE-2022-31783)
