...
# extracted from Red Hat Security Advisory RHSA-2021:0830. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:0830");
  script_xref(name:"CEA-ID", value:"CEA-2021-0025");

  script_name(english:"RHEL 7 : rh-nodejs14-nodejs (RHSA-2021:0830)");
...
referenced in the RHSA-2021:0830 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_0830.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?68484ba3");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:0830");
...
"Update the RHEL rh-nodejs14-nodejs package based on the guidance in RHSA-2021:0830.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-nodejs14-nodejs-14.16.0-1.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs14-nodejs-14.16.0-1.el7', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs14-nodejs-14.16.0-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs14-nodejs-devel-14.16.0-1.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs14-nodejs-devel-14.16.0-1.el7', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs14-nodejs-devel-14.16.0-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs14-nodejs-docs-14.16.0-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs14-npm-6.14.11-14.16.0.1.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs14-npm-6.14.11-14.16.0.1.el7', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs14-npm-6.14.11-14.16.0.1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
