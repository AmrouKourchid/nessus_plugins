...
# extracted from VMware Security Advisory PHSA-2021-4.0-0116. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Redis PHSA-2021-4.0-0116");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the redis package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-116.md");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-32672");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'redis-6.0.15-3.ph4')) flag++;
