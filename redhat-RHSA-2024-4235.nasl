...
# extracted from Red Hat Security Advisory RHSA-2024:4235. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:4235");

  script_name(english:"RHEL 8 : 389-ds (RHSA-2024:4235)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for 389-ds.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:4235 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_4235.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?69903bad");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-16277");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:4235");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL 389-ds package based on the guidance in RHSA-2024:4235.");
  ...
  '389-ds:1.4': [
    {
      ...
      'pkgs': [
        {'reference':'389-ds-base-1.4.3.39-7.module+el8.10.0+21985+3665ccdb', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'389-ds-base-devel-1.4.3.39-7.module+el8.10.0+21985+3665ccdb', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'389-ds-base-legacy-tools-1.4.3.39-7.module+el8.10.0+21985+3665ccdb', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'389-ds-base-libs-1.4.3.39-7.module+el8.10.0+21985+3665ccdb', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'389-ds-base-snmp-1.4.3.39-7.module+el8.10.0+21985+3665ccdb', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-lib389-1.4.3.39-7.module+el8.10.0+21985+3665ccdb', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
