...
# extracted from Gentoo Linux Security Advisory GLSA 202401-06.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202401-06 : CUPS filters: Remote Code Execution");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202401-06 (CUPS filters: Remote Code Execution)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202401-06");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=906944");
...
"All cups-filters users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:cups-filters");
...
var packages = [
  {
    ...
    'unaffected' : make_list("ge 1.28.17-r2"),
    'vulnerable' : make_list("lt 1.28.17-r2")
  }
];
