...
# extracted from Fedora Security Advisory FEDORA-2024-aa2fdd75f7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-aa2fdd75f7");

  script_name(english:"Fedora 39 : suricata (2024-aa2fdd75f7)");
...
FEDORA-2024-aa2fdd75f7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-aa2fdd75f7");
...
var pkgs = [
    {'reference':'suricata-6.0.19-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
