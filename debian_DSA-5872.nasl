...
# extracted from Debian Security Advisory dsa-5872. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5872 : xnest - security update");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'xnest', 'reference': '2:21.1.7-3+deb12u9'},
    {'release': '12.0', 'prefix': 'xorg-server-source', 'reference': '2:21.1.7-3+deb12u9'},
    {'release': '12.0', 'prefix': 'xserver-common', 'reference': '2:21.1.7-3+deb12u9'},
    {'release': '12.0', 'prefix': 'xserver-xephyr', 'reference': '2:21.1.7-3+deb12u9'},
    {'release': '12.0', 'prefix': 'xserver-xorg-core', 'reference': '2:21.1.7-3+deb12u9'},
    {'release': '12.0', 'prefix': 'xserver-xorg-core-udeb', 'reference': '2:21.1.7-3+deb12u9'},
    {'release': '12.0', 'prefix': 'xserver-xorg-dev', 'reference': '2:21.1.7-3+deb12u9'},
    {'release': '12.0', 'prefix': 'xserver-xorg-legacy', 'reference': '2:21.1.7-3+deb12u9'},
    {'release': '12.0', 'prefix': 'xvfb', 'reference': '2:21.1.7-3+deb12u9'}
];
