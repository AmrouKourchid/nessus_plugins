...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.2.0 : nss-softokn (EulerOS-SA-2020-1252)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1252
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d4596e2c");
...
pkgs = ["nss-softokn-3.36.0-5.h8",
        "nss-softokn-freebl-3.36.0-5.h8"];
