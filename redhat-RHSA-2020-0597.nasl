...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_0597.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1b8d170b");
...
"Update the RHEL rh-nodejs10-nodejs package based on the guidance in RHSA-2020:0597.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-nodejs10-nodejs-10.19.0-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs10-nodejs-devel-10.19.0-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs10-nodejs-docs-10.19.0-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs10-npm-6.13.4-10.19.0.1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
