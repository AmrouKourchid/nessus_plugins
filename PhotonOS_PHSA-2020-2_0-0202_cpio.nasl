...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Cpio PHSA-2020-2.0-0202");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'cpio-2.12-5.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'cpio-lang-2.12-5.ph2')) flag++;
