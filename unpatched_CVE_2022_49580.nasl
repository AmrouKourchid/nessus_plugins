...
if (description)
{
  ...
  script_cve_id("CVE-2022-49580");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-49580");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: ipv4: Fix a data-race around
    sysctl_fib_multipath_use_neigh. While reading sysctl_fib_multipath_use_neigh, it can be changed
    concurrently. Thus, we need to add READ_ONCE() to its reader. (CVE-2022-49580)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-49580");
