...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.1 : libldb (EulerOS-SA-2021-1606)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1606
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f0a6296a");
...
pkgs = ["libldb-2.0.8-2.h1.eulerosv2r9"];
