...
# extracted from Red Hat Security Advisory RHSA-2025:0566. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:0566");

  script_name(english:"RHEL 9 : redis:7 (RHSA-2025:0566)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_0566.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7fa7870c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:0566");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL redis:7 package based on the guidance in RHSA-2025:0566.");
  ...
  'redis:7': [
    {
      ...
      'pkgs': [
        {'reference':'redis-7.0.12-1.module+el9.4.0+22724+5f7cf862.2', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'redis-devel-7.0.12-1.module+el9.4.0+22724+5f7cf862.2', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'redis-doc-7.0.12-1.module+el9.4.0+22724+5f7cf862.2', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
