...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : Important: / libXfont (ELSA-2008-0064)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2008-0064.html");
...
"Update the affected libXfont and / or libXfont-devel packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2008-0006");
...
var pkgs = [
    {'reference':'libXfont-1.2.2-1.0.3.el5_1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libXfont-devel-1.2.2-1.0.3.el5_1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libXfont-1.2.2-1.0.3.el5_1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libXfont-devel-1.2.2-1.0.3.el5_1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
