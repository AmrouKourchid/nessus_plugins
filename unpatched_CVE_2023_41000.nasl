...
if (description)
{
  ...
  script_cve_id("CVE-2023-41000");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2023-41000");
...
patch available.
  ...
  - GPAC through 2.2.1 has a use-after-free vulnerability in the function gf_bifs_flush_command_list in
    bifs/memory_decoder.c. (CVE-2023-41000)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-41000");
