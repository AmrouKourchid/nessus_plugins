...
# extracted from VMware Security Advisory PHSA-2021-1.0-0381. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Openvswitch PHSA-2021-1.0-0381");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the openvswitch package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-1.0-381.md");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'openvswitch-2.6.1-8.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'openvswitch-devel-2.6.1-8.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'openvswitch-doc-2.6.1-8.ph1')) flag++;
