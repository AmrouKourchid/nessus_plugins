...
if (description)
{
  ...
  script_cve_id("CVE-2023-52766");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2023-52766");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: i3c: mipi-i3c-hci: Fix out of bounds
    access in hci_dma_irq_handler Do not loop over ring headers in hci_dma_irq_handler() that are not
    allocated and enabled in hci_dma_init(). Otherwise out of bounds access will occur from rings->headers[i]
    access when i >= number of allocated ring headers. (CVE-2023-52766)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-52766");
