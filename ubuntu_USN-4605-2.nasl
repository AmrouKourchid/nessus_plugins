...
# extracted from Ubuntu Security Notice USN-4605-2. The text
...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS : Blueman update (USN-4605-2)");
...
USN-4605-2 advisory.
    ...
    While a previous security update fixed the issue, this update provides additional improvements by enabling
    PolicyKit authentication for privileged commands.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4605-2");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'blueman', 'pkgver': '2.1.2-1ubuntu0.2'}
];
