...
# AlmaLinux Security Advisory ALSA-2021:4142.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2020-7656", "CVE-2020-11023");
  script_xref(name:"ALSA", value:"2021:4142");
  ...
  script_name(english:"AlmaLinux 8 : pcs (ALSA-2021:4142)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ALSA-2021:4142 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2021-4142.html");
...
var pkgs = [
    {'reference':'pcs-0.10.10-4.el8.alma', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pcs-snmp-0.10.10-4.el8.alma', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
