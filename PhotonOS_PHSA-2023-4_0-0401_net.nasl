...
# extracted from VMware Security Advisory PHSA-2023-4.0-0401. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Net PHSA-2023-4.0-0401");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the net package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-401.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'net-snmp-5.8-11.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'net-snmp-devel-5.8-11.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'net-snmp-perl-5.8-11.ph4')) flag++;
