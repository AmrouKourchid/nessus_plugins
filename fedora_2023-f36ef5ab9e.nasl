...
# extracted from Fedora Security Advisory FEDORA-2023-f36ef5ab9e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-f36ef5ab9e");

  script_name(english:"Fedora 38 : thunderbird (2023-f36ef5ab9e)");
...
FEDORA-2023-f36ef5ab9e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-f36ef5ab9e");
...
var pkgs = [
    {'reference':'thunderbird-102.9.0-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
