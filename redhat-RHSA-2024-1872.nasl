...
# extracted from Red Hat Security Advisory RHSA-2024:1872. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:1872");

  script_name(english:"RHEL 9 : mod_http2 (RHSA-2024:1872)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?df095841");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:1872");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL mod_http2 package based on the guidance in RHSA-2024:1872.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'mod_http2-1.15.19-5.el9_3.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
