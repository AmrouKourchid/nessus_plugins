...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : cockpit (EulerOS-SA-2020-1143)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the version of the cockpit packages installed, the
EulerOS installation on the remote host is affected by the following
vulnerability :

  - It was found that cockpit before version 184 used
    glib's base64 decode functionality incorrectly
    resulting in a denial of service attack. An
    unauthenticated attacker could send a specially crafted
    request with an invalid base64-encoded cookie which
    could cause the web service to crash.(CVE-2019-3804)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1143
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4ef896c7");
  script_set_attribute(attribute:"solution", value:
"Update the affected cockpit package.");
...
pkgs = ["cockpit-178-1.h1.eulerosv2r8",
        "cockpit-bridge-178-1.h1.eulerosv2r8",
        "cockpit-doc-178-1.h1.eulerosv2r8",
        "cockpit-packagekit-178-1.h1.eulerosv2r8",
        "cockpit-storaged-178-1.h1.eulerosv2r8",
        "cockpit-system-178-1.h1.eulerosv2r8",
        "cockpit-ws-178-1.h1.eulerosv2r8"];
