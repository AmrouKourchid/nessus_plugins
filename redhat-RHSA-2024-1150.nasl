...
# extracted from Red Hat Security Advisory RHSA-2024:1150. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:1150");

  script_name(english:"RHEL 9 : buildah (RHSA-2024:1150)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_1150.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?871a1625");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2254210");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:1150");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL buildah package based on the guidance in RHSA-2024:1150.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'buildah-1.31.4-1.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'buildah-tests-1.31.4-1.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
