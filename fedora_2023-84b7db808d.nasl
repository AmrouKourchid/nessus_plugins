...
# extracted from Fedora Security Advisory FEDORA-2023-84b7db808d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-84b7db808d");

  script_name(english:"Fedora 37 : netconsd (2023-84b7db808d)");
...
FEDORA-2023-84b7db808d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-84b7db808d");
...
var pkgs = [
    {'reference':'netconsd-0.3-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
