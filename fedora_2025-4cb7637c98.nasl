...
# extracted from Fedora Security Advisory FEDORA-2025-4cb7637c98
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-4cb7637c98");

  script_name(english:"Fedora 41 : vaultwarden (2025-4cb7637c98)");
...
FEDORA-2025-4cb7637c98 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-4cb7637c98");
...
var pkgs = [
    {'reference':'vaultwarden-1.32.7-4.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
