...
# extracted from Oracle Linux Security Advisory ELSA-2020-4946.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : libX11 (ELSA-2020-4946)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2020-4946.html");
...
var pkgs = [
    ...
    {'reference':'libX11-common-1.6.4-4.el6_10', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'libX11-common-1.6.4-4.el6_10', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
