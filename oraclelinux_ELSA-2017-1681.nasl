...
# extracted from Red Hat Security Advisory RHSA-2017:1681 and 
# Oracle Linux Security Advisory ELSA-2017-1681 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : qemu-kvm (ELSA-2017-1681)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 7 host has packages installed that are affected by a vulnerability as referenced in the
ELSA-2017-1681 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2017-1681.html");
...
var pkgs = [
    {'reference':'qemu-img-1.5.3-126.el7_3.10', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10'},
    {'reference':'qemu-kvm-1.5.3-126.el7_3.10', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10'},
    {'reference':'qemu-kvm-common-1.5.3-126.el7_3.10', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10'},
    {'reference':'qemu-kvm-tools-1.5.3-126.el7_3.10', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10'}
];
