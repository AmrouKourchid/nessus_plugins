...
referenced in the RHSA-2022:0350 advisory.
    ...
    The following packages have been upgraded to a later upstream version: nodejs (14.18.2), nodejs-nodemon
    (2.0.15). (BZ#2027609)
    ...
    * nodejs-tar: Insufficient symlink protection due to directory cache poisoning using symbolic links
    allowing arbitrary file creation and overwrite (CVE-2021-37701)

    * nodejs-tar: Insufficient symlink protection due to directory cache poisoning using symbolic links
    allowing arbitrary file creation and overwrite (CVE-2021-37712)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_0350.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?76c05a7a");
  ...
  'nodejs:14': [
    {
      ...
      'pkgs': [
        {'reference':'nodejs-14.18.2-2.module+el8.5.0+13644+8d46dafd', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-devel-14.18.2-2.module+el8.5.0+13644+8d46dafd', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-docs-14.18.2-2.module+el8.5.0+13644+8d46dafd', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-full-i18n-14.18.2-2.module+el8.5.0+13644+8d46dafd', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-nodemon-2.0.15-1.module+el8.5.0+13504+a2e74d91', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'nodejs-packaging-23-3.module+el8.3.0+6519+9f98ed83', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
        {'reference':'npm-6.14.15-1.14.18.2.2.module+el8.5.0+13644+8d46dafd', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
      ]
    }
  ]
};
