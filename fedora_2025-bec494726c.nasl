...
# extracted from Fedora Security Advisory FEDORA-2025-bec494726c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-bec494726c");

  script_name(english:"Fedora 41 : python3.8 (2025-bec494726c)");
...
FEDORA-2025-bec494726c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-bec494726c");
...
var pkgs = [
    {'reference':'python3.8-3.8.20-2.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
