...
if (description)
{
  ...
  script_name(english:"RHEL 5 : jbossas (RHSA-2013:0147)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for jbossas.");
...
number.");
  ...
  # https://access.redhat.com/security/data/csaf/v2/advisories/2013/rhsa-2013_0147.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?27850515");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2013:0147");
...
"Update the RHEL jbossas package based on the guidance in RHSA-2013:0147.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jbossas-4.3.0-11.GA_CP10_patch_02.2.ep1.el5', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap4'},
      {'reference':'jbossas-client-4.3.0-11.GA_CP10_patch_02.2.ep1.el5', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap4'}
    ]
  }
];
