...
if (description)
{
  ...
  script_name(english:"IBM WebSphere Application Server SEoL (4.0.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of IBM WebSphere Application Server is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, IBM WebSphere Application Server is 4.0.x. It is, therefore, no longer maintained by its
vendor or provider.
...
var constraints = [
  { max_branch : '4.0', min_branch : '4.0', seol : 20050430, eseol : 20070430 }
];
