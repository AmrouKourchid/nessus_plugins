...
# extracted from Fedora Security Advisory FEDORA-2024-851219f5e3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-851219f5e3");

  script_name(english:"Fedora 41 : crosswords (2024-851219f5e3)");
...
FEDORA-2024-851219f5e3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-851219f5e3");
  script_set_attribute(attribute:"solution", value:
"Update the affected crosswords package.");
...
var pkgs = [
    {'reference':'crosswords-0.3.13.3-4.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'crosswords');
}
