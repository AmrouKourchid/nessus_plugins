...
if (description)
{
  ...
  script_cve_id("CVE-2018-5208");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2018-5208");
...
patch available.
  ...
  - In Irssi before 1.0.6, a calculation error in the completion code could cause a heap buffer overflow when
