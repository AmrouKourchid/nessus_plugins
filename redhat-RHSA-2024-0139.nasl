...
# extracted from Red Hat Security Advisory RHSA-2024:0139. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:0139");

  script_name(english:"RHEL 8 : idm:DL1 (RHSA-2024:0139)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for idm:DL1.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:0139 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0139.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6fa1aafb");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-17120");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0139");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL idm:DL1 package based on the guidance in RHSA-2024:0139.");
  ...
  'idm:DL1': [
    {
      ...
      'pkgs': [
        {'reference':'bind-dyndb-ldap-11.6-4.module+el8.6.0+16878+6c033536', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'custodia-0.6.0-3.module+el8.1.0+4098+f286395e', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-client-4.9.8-11.module+el8.6.0+20984+095e5c46', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-client-common-4.9.8-11.module+el8.6.0+20984+095e5c46', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-client-epn-4.9.8-11.module+el8.6.0+20984+095e5c46', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-client-samba-4.9.8-11.module+el8.6.0+20984+095e5c46', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-common-4.9.8-11.module+el8.6.0+20984+095e5c46', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'ipa-python-compat-4.9.8-11.module+el8.6.0+20984+095e5c46', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-selinux-4.9.8-11.module+el8.6.0+20984+095e5c46', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-server-4.9.8-11.module+el8.6.0+20984+095e5c46', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-server-common-4.9.8-11.module+el8.6.0+20984+095e5c46', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-server-dns-4.9.8-11.module+el8.6.0+20984+095e5c46', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-server-trust-ad-4.9.8-11.module+el8.6.0+20984+095e5c46', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'opendnssec-2.1.7-1.module+el8.4.0+9007+5084bdd8', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-custodia-0.6.0-3.module+el8.1.0+4098+f286395e', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-ipaclient-4.9.8-11.module+el8.6.0+20984+095e5c46', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-ipalib-4.9.8-11.module+el8.6.0+20984+095e5c46', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-ipaserver-4.9.8-11.module+el8.6.0+20984+095e5c46', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-ipatests-4.9.8-11.module+el8.6.0+20984+095e5c46', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'slapi-nis-0.60.0-1.module+el8.6.0+16878+6c033536', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'softhsm-2.6.0-5.module+el8.4.0+10227+076cd560', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'softhsm-devel-2.6.0-5.module+el8.4.0+10227+076cd560', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
