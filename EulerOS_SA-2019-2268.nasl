...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : cairo (EulerOS-SA-2019-2268)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2268
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e7114313");
...
pkgs = ["cairo-1.14.2-1.h2",
        "cairo-devel-1.14.2-1.h2",
        "cairo-gobject-1.14.2-1.h2",
        "cairo-gobject-devel-1.14.2-1.h2"];
