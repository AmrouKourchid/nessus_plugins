...
if (description)
{
  ...
  script_name(english:"Zoom Client for Meetings < 5.16.5 Vulnerability (ZSB-23062)");
...
vulnerability as referenced in the ZSB-23062 advisory.

  - Improper authentication in some Zoom clients before version 5.16.5 may allow an authenticated user to
    conduct a denial of service via network access. (CVE-2023-49646)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.zoom.com/en/trust/security-bulletin/ZSB-23062");
...
"Upgrade to Zoom Client for Meetings 5.16.5 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-49646");
