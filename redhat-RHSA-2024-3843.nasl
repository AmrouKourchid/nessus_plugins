...
# extracted from Red Hat Security Advisory RHSA-2024:3843. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:3843");
  script_xref(name:"IAVA", value:"2024-A-0356");

  script_name(english:"RHEL 9 : cockpit (RHSA-2024:3843)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for cockpit.");
...
the RHSA-2024:3843 advisory.

    Cockpit enables users to administer GNU/Linux servers using a web browser. It offers network
    configuration, log inspection, diagnostic reports, SELinux troubleshooting, interactive command-line
    sessions, and more.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_3843.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6a5d825b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2271614");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:3843");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL cockpit package based on the guidance in RHSA-2024:3843.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cockpit-311.2-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'cockpit-bridge-311.2-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'cockpit-doc-311.2-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'cockpit-packagekit-311.2-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'cockpit-pcp-311.2-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'cockpit-storaged-311.2-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'cockpit-system-311.2-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'cockpit-ws-311.2-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'cockpit-311.2-1.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'cockpit-bridge-311.2-1.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'cockpit-doc-311.2-1.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'cockpit-packagekit-311.2-1.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'cockpit-pcp-311.2-1.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'cockpit-storaged-311.2-1.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'cockpit-system-311.2-1.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'cockpit-ws-311.2-1.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
