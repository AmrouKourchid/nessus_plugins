...
if (description)
{
  ...
  script_cve_id("CVE-2022-29404", "CVE-2022-30556");
  script_xref(name:"IAVA", value:"2022-A-0230-S");

  script_name(english:"Apache 2.4.x < 2.4.54 Multiple Vulnerabilities (mod_lua)");
...
"Upgrade to Apache version 2.4.54 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-30556");
...
var constraints = [
  { 'max_version' : '2.4.53', 'fixed_version' : '2.4.54', 'modules':['mod_lua'] }
];
