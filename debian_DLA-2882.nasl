...
# extracted from Debian Security Advisory dla-2882. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2882-1 : sphinxsearch - LTS security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 9 host has a package installed that is affected by a vulnerability as referenced in the dla-2882
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2022/dla-2882");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2020-29050");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/stretch/sphinxsearch");
...
var pkgs = [
    {'release': '9.0', 'prefix': 'sphinxsearch', 'reference': '2.2.11-1.1+deb9u1'}
];
