...
# extracted from Fedora Security Advisory FEDORA-2024-b92d44f141
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-b92d44f141");

  script_name(english:"Fedora 38 : opensc (2024-b92d44f141)");
...
FEDORA-2024-b92d44f141 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-b92d44f141");
...
var pkgs = [
    {'reference':'opensc-0.25.0-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
