...
if (description)
{
  ...
  script_cve_id("CVE-2021-45293");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2021-45293");
...
patch available.
  ...
  - A Denial of Service vulnerability exists in Binaryen 103 due to an Invalid memory address dereference in
    wasm::WasmBinaryBuilder::visitLet. (CVE-2021-45293)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-45293");
