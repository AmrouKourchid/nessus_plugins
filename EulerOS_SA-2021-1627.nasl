...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.1 : sudo (EulerOS-SA-2021-1627)");
...
following vulnerability :
  ...
  - Sudo (superuser do) allows a system administrator to
    ...
    (sudoers) on many different machines.Security
    Fix(es):In Sudo before 1.8.26, if pwfeedback is enabled
    in /etc/sudoers, users can trigger a stack-based buffer
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1627
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?817a67bf");
