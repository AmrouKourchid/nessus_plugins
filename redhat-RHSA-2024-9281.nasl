...
# extracted from Red Hat Security Advisory RHSA-2024:9281. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:9281");

  script_name(english:"RHEL 9 : python-jwcrypto (RHSA-2024:9281)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for python-jwcrypto.");
...
the RHSA-2024:9281 advisory.

    The python-jwcrypto package provides Python implementations of the JSON Web Key (JWK), JSON Web Signature
    (JWS), JSON Web Encryption (JWE), and JSON Web Token (JWT) JOSE (JSON Object Signing and Encryption)
    standards.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-34809");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_9281.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b433a4d8");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:9281");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-jwcrypto package based on the guidance in RHSA-2024:9281.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-jwcrypto-1.5.6-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
