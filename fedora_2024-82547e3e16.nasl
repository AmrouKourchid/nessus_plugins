...
# extracted from Fedora Security Advisory FEDORA-2024-82547e3e16
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-82547e3e16");

  script_name(english:"Fedora 39 : python-django (2024-82547e3e16)");
...
FEDORA-2024-82547e3e16 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-82547e3e16");
...
var pkgs = [
    {'reference':'python-django-4.2.14-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
