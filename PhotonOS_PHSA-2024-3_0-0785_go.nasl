...
# extracted from VMware Security Advisory PHSA-2024-3.0-0785. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Go PHSA-2024-3.0-0785");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the go package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-3.0-785.md");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'go-1.20.14-3.ph3')) flag++;
