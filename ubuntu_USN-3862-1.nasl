...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 18.04 LTS : Irssi vulnerability (USN-3862-1)");
...
referenced in the USN-3862-1 advisory.

    It was discovered that Irssi incorrectly handled certain inputs. An attacker could possibly use this issue
    to cause a denial of service or to execute arbitrary code.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3862-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'irssi', 'pkgver': '0.8.15-5ubuntu3.6'},
    {'osver': '14.04', 'pkgname': 'irssi-dev', 'pkgver': '0.8.15-5ubuntu3.6'},
    {'osver': '16.04', 'pkgname': 'irssi', 'pkgver': '0.8.19-1ubuntu1.8'},
    {'osver': '16.04', 'pkgname': 'irssi-dev', 'pkgver': '0.8.19-1ubuntu1.8'},
    {'osver': '18.04', 'pkgname': 'irssi', 'pkgver': '1.0.5-1ubuntu4.1'},
    {'osver': '18.04', 'pkgname': 'irssi-dev', 'pkgver': '1.0.5-1ubuntu4.1'}
];
