...
if (description)
{
  ...
  script_cve_id("CVE-2017-12135");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2017-12135");
...
patch available.
  ...
  - Xen allows local OS guest users to cause a denial of service (crash) or possibly obtain sensitive
    information or gain privileges via vectors involving transitive grants. (CVE-2017-12135)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-12135");
