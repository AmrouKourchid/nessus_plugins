...
# extracted from F5 Networks BIG-IP Solution K57110035.
#
# @NOAGENT@
##
...
if (description)
{
  ...
  script_cve_id("CVE-2022-27636");
  script_xref(name:"IAVA", value:"2022-A-0189-S");

  script_name(english:"F5 Networks BIG-IP : BIG-IP APM Edge Client for Windows logging vulnerability (K57110035)");
...
17.0.0. It is, therefore, affected by a vulnerability as referenced in the K57110035 advisory.
  ...
  - On F5 BIG-IP APM 16.1.x versions prior to 16.1.2.2, 15.1.x versions prior to 15.1.5.1, 14.1.x versions
    ...
    BIG-IP APM Clients 7.x versions prior to 7.2.1.5, BIG-IP Edge Client may log sensitive APM session-related
    information when VPN is launched on a Windows system. Note: Software versions which have reached End of
    Technical Support (EoTS) are not evaluated (CVE-2022-27636)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K57110035");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K57110035.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:P/I:N/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:L/UI:N/S:U/C:H/I:N/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-27636");
