...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Wireshark PHSA-2023-3.0-0574");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'wireshark-3.6.13-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'wireshark-devel-3.6.13-1.ph3')) flag++;
