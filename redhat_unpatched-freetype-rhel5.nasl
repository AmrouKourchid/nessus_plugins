...
# extracted from Red Hat Security Advisory freetype. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2016-10244", "CVE-2018-6942");

  script_name(english:"RHEL 5 : freetype (Unpatched Vulnerability) (deprecated)");
