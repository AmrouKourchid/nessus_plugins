...
# extracted from Fedora Security Advisory FEDORA-2023-6bd1586dc5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-6bd1586dc5");

  script_name(english:"Fedora 39 : moodle (2023-6bd1586dc5)");
...
FEDORA-2023-6bd1586dc5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-6bd1586dc5");
...
var pkgs = [
    {'reference':'moodle-4.3-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
