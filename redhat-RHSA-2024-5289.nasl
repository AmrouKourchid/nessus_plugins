...
# extracted from Red Hat Security Advisory RHSA-2024:5289. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:5289");

  script_name(english:"RHEL 8 : mod_auth_openidc:2.3 (RHSA-2024:5289)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for mod_auth_openidc:2.3.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:5289 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-36492");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_5289.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?277e54c1");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:5289");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL mod_auth_openidc:2.3 package based on the guidance in RHSA-2024:5289.");
  ...
  'mod_auth_openidc:2.3': [
    {
      ...
      'pkgs': [
        {'reference':'cjose-0.6.1-4.module+el8.10.0+21813+b5444eb8', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'cjose-devel-0.6.1-4.module+el8.10.0+21813+b5444eb8', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mod_auth_openidc-2.4.9.4-6.module+el8.10.0+21813+b5444eb8', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
