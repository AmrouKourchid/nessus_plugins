...
# extracted from Fedora Security Advisory FEDORA-2022-288e2fa22b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-288e2fa22b");

  script_name(english:"Fedora 35 : drupal7-context (2022-288e2fa22b)");
...
FEDORA-2022-288e2fa22b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-288e2fa22b");
...
var pkgs = [
    {'reference':'drupal7-context-3.11-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
