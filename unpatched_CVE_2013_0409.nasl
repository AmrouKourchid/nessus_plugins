...
if (description)
{
  ...
  script_cve_id("CVE-2013-0409");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2013-0409");
...
patch available.
  ...
  - Unspecified vulnerability in the Java Runtime Environment (JRE) component in Oracle Java SE 7 through
    ...
    confidentiality via vectors related to JMX. (CVE-2013-0409)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-0409");
