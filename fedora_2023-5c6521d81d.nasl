...
# extracted from Fedora Security Advisory FEDORA-2023-5c6521d81d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-5c6521d81d");

  script_name(english:"Fedora 38 : mbedtls (2023-5c6521d81d)");
...
FEDORA-2023-5c6521d81d advisory.
    ...
    Security Advisory: https://mbed-tls.readthedocs.io/en/latest/security-advisories/mbedtls-security-
    advisory-2023-10-1/
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-5c6521d81d");
...
"Update the affected mbedtls package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-43615");
...
var pkgs = [
    {'reference':'mbedtls-2.28.5-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
