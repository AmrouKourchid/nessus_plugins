...
# extracted from Ubuntu Security Notice USN-6587-5. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6587-5");

  script_name(english:"Ubuntu 14.04 LTS : X.Org X Server vulnerabilities (USN-6587-5)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 14.04 LTS host has packages installed that are affected by multiple vulnerabilities as referenced in
the USN-6587-5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6587-5");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'xdmx', 'pkgver': '2:1.15.1-0ubuntu2.11+esm9', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'xdmx-tools', 'pkgver': '2:1.15.1-0ubuntu2.11+esm9', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'xnest', 'pkgver': '2:1.15.1-0ubuntu2.11+esm9', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'xorg-server-source', 'pkgver': '2:1.15.1-0ubuntu2.11+esm9', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'xserver-common', 'pkgver': '2:1.15.1-0ubuntu2.11+esm9', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'xserver-xephyr', 'pkgver': '2:1.15.1-0ubuntu2.11+esm9', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'xserver-xorg-core', 'pkgver': '2:1.15.1-0ubuntu2.11+esm9', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'xserver-xorg-dev', 'pkgver': '2:1.15.1-0ubuntu2.11+esm9', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'xserver-xorg-xmir', 'pkgver': '2:1.15.1-0ubuntu2.11+esm9', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'xvfb', 'pkgver': '2:1.15.1-0ubuntu2.11+esm9', 'ubuntu_pro': TRUE}
];
