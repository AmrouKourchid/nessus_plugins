...
# extracted from Fedora Security Advisory FEDORA-2023-39f0ec3879
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-39f0ec3879");

  script_name(english:"Fedora 39 : netatalk (2023-39f0ec3879)");
...
FEDORA-2023-39f0ec3879 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-39f0ec3879");
...
var pkgs = [
    {'reference':'netatalk-3.1.18-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'5'}
];
