...
# extracted from VMware Security Advisory PHSA-2017-0031. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Subversion PHSA-2017-0031");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the subversion package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-65.md");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'subversion-1.9.4-2.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'subversion-debuginfo-1.9.4-2.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'subversion-devel-1.9.4-2.ph1')) flag++;
