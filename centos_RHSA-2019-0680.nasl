...
the CVE page(s) listed in the References section.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?277d246c");
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"thunderbird-60.6.1-1.el6.centos", allowmaj:TRUE)) flag++;
