...
# extracted from Red Hat Security Advisory RHSA-2023:6549. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:6549");

  script_name(english:"RHEL 9 : libreswan (RHSA-2023:6549)");
...
referenced in the RHSA-2023:6549 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6549.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?100c58ba");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6549");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libreswan package based on the guidance in RHSA-2023:6549.");
