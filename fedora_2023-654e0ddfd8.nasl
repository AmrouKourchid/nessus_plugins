...
# extracted from Fedora Security Advisory FEDORA-2023-654e0ddfd8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-654e0ddfd8");

  script_name(english:"Fedora 40 : golang-github-prometheus-node-exporter (2023-654e0ddfd8)");
...
FEDORA-2023-654e0ddfd8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-654e0ddfd8");
  script_set_attribute(attribute:"solution", value:
"Update the affected golang-github-prometheus-node-exporter package.");
...
var pkgs = [
    {'reference':'golang-github-prometheus-node-exporter-1.6.1-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'golang-github-prometheus-node-exporter');
}
