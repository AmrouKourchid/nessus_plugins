...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : docker-runc (EulerOS-SA-2024-2965)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2965
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1d487f3c");
...
var pkgs = [
  "docker-runc-1.0.0.rc3-300.h30.eulerosv2r11"
];
