...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS : Linux kernel (GCP) vulnerabilities (USN-3507-2)");
...
the USN-3507-2 advisory.
    ...
    It was discovered that a null pointer dereference error existed in the PowerPC KVM implementation in the
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3507-2");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.13.0-1002-gcp");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-3507-2');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2017-12193', 'CVE-2017-15299', 'CVE-2017-15306', 'CVE-2017-15951', 'CVE-2017-16939', 'CVE-2017-1000405');
