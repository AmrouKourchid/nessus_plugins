...
which result in denial of service or the execution of arbitrary code.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2018/dsa-4217");
...
in version 2.2.6+g32dac6a-2+deb9u3.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-9273");
