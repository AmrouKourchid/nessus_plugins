...
# extracted from Fedora Security Advisory FEDORA-2018-4943b0505b.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-4943b0505b");

  script_name(english:"Fedora 27 : ant (2018-4943b0505b)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-4943b0505b");
...
flag = 0;
if (rpm_check(release:"FC27", reference:"ant-1.10.1-10.fc27")) flag++;
