...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : libxml2 (ELSA-2008-0884)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2008-0884.html");
...
var pkgs = [
    {'reference':'libxml2-2.6.26-2.1.2.6.0.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libxml2-devel-2.6.26-2.1.2.6.0.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libxml2-python-2.6.26-2.1.2.6.0.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libxml2-2.6.26-2.1.2.6.0.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libxml2-devel-2.6.26-2.1.2.6.0.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libxml2-python-2.6.26-2.1.2.6.0.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
