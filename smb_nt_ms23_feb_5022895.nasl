...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5022895");
  script_xref(name:"MSKB", value:"5022903");
  script_xref(name:"MSFT", value:"MS23-5022895");
  script_xref(name:"MSFT", value:"MS23-5022903");
  ...
  script_name(english:"KB5022895: Windows Server 2012 Security Update (February 2023)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5022895. It is, therefore, affected by multiple vulnerabilities
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5022895");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5022903");
...
if (
  smb_check_rollup(os:'6.2',
                   ...
                   rollup_date:'02_2023',
                   bulletin:bulletin,
                   rollup_kb_list:[5022903, 5022895])
)
{
