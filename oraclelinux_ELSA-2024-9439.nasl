...
# extracted from Oracle Linux Security Advisory ELSA-2024-9439.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : fontforge (ELSA-2024-9439)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-9439.html");
...
var pkgs = [
    {'reference':'fontforge-20201107-6.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'fontforge-20201107-6.el9', 'cpu':'i686', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'fontforge-20201107-6.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
