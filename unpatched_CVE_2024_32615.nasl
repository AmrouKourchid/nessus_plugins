...
if (description)
{
  ...
  script_cve_id("CVE-2024-32615");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-32615");
...
patch available.
  ...
  - HDF5 Library through 1.14.3 contains a heap-based buffer overflow in H5Z__nbit_decompress_one_byte in
    H5Znbit.c, caused by the earlier use of an initialized pointer. (CVE-2024-32615)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-32615");
