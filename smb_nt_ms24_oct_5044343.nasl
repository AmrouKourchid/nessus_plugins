...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5044343");
  script_xref(name:"MSFT", value:"MS24-5044343");
  ...
  script_name(english:"KB5044343: Windows Server 2012 R2 Security Update (October 2024)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5044343");
