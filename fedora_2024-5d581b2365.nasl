...
# extracted from Fedora Security Advisory FEDORA-2024-5d581b2365
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-5d581b2365");

  script_name(english:"Fedora 39 : apache-commons-io (2024-5d581b2365)");
...
FEDORA-2024-5d581b2365 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-5d581b2365");
  script_set_attribute(attribute:"solution", value:
"Update the affected 1:apache-commons-io package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:apache-commons-io");
...
var pkgs = [
    {'reference':'apache-commons-io-2.11.0-5.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
