...
# extracted from Fedora Security Advisory FEDORA-2023-452714dbc6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-452714dbc6");
  script_xref(name:"IAVA", value:"2023-A-0423-S");

  script_name(english:"Fedora 37 : php (2023-452714dbc6)");
...
FEDORA-2023-452714dbc6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-452714dbc6");
...
var pkgs = [
    {'reference':'php-8.1.16-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
