...
# SUSE update advisory SUSE-SU-2021:2852-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2021:2852-1");

  script_name(english:"SUSE SLES12 Security Update : compat-openssl098 (SUSE-SU-2021:2852-1)");
...
in the SUSE-SU-2021:2852-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2021-August/009363.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d905fcdc");
...
var pkgs = [
    {'reference':'libopenssl0_9_8-0.9.8j-106.27.2', 'sp':'3', 'cpu':'x86_64', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.3']},
    {'reference':'libopenssl0_9_8-0.9.8j-106.27.2', 'sp':'4', 'cpu':'x86_64', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.4']},
    {'reference':'libopenssl0_9_8-0.9.8j-106.27.2', 'sp':'5', 'cpu':'x86_64', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5']},
    {'reference':'libopenssl0_9_8-0.9.8j-106.27.2', 'sp':'0', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-legacy-release-12-0']},
    {'reference':'libopenssl0_9_8-0.9.8j-106.27.2', 'sp':'3', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-legacy-release-12-0']},
    {'reference':'libopenssl0_9_8-0.9.8j-106.27.2', 'sp':'4', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-legacy-release-12-0']},
    {'reference':'libopenssl0_9_8-0.9.8j-106.27.2', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-legacy-release-12-0']},
    {'reference':'libopenssl0_9_8-32bit-0.9.8j-106.27.2', 'sp':'0', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-legacy-release-12-0']},
    {'reference':'libopenssl0_9_8-32bit-0.9.8j-106.27.2', 'sp':'3', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-legacy-release-12-0']},
    {'reference':'libopenssl0_9_8-32bit-0.9.8j-106.27.2', 'sp':'4', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-legacy-release-12-0']},
    {'reference':'libopenssl0_9_8-32bit-0.9.8j-106.27.2', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-legacy-release-12-0']}
];
