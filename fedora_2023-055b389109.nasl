...
# extracted from Fedora Security Advisory FEDORA-2023-055b389109
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-055b389109");

  script_name(english:"Fedora 36 : rust-libgit2-sys (2023-055b389109)");
...
FEDORA-2023-055b389109 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-055b389109");
  script_set_attribute(attribute:"solution", value:
"Update the affected rust-libgit2-sys package.");
...
var pkgs = [
    {'reference':'rust-libgit2-sys-0.13.5-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'rust-libgit2-sys');
}
