...
# SUSE update advisory SUSE-SU-2024:1154-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2024:1154-1");

  script_name(english:"openSUSE 15 Security Update : python-Pillow (SUSE-SU-2024:1154-1)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://lists.suse.com/pipermail/sle-updates/2024-April/034869.html");
...
var pkgs = [
    {'reference':'python3-Pillow-7.2.0-150300.3.9.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.5']},
    {'reference':'python3-Pillow-tk-7.2.0-150300.3.9.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.5']}
];
