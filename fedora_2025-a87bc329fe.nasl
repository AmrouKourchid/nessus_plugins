...
# extracted from Fedora Security Advisory FEDORA-2025-a87bc329fe
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-a87bc329fe");

  script_name(english:"Fedora 40 : tigervnc (2025-a87bc329fe)");
...
FEDORA-2025-a87bc329fe advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-a87bc329fe");
...
var pkgs = [
    {'reference':'tigervnc-1.15.0-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
