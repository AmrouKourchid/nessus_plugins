...
# extracted from Red Hat Security Advisory RHSA-2020:3631. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:3631");
  script_xref(name:"IAVA", value:"2020-A-0391-S");

  script_name(english:"RHEL 7 : thunderbird (RHSA-2020:3631)");
...
referenced in the RHSA-2020:3631 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_3631.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f6d9e804");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:3631");
...
"Update the RHEL thunderbird package based on the guidance in RHSA-2020:3631.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'thunderbird-68.12.0-1.el7_8', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'thunderbird-68.12.0-1.el7_8', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
