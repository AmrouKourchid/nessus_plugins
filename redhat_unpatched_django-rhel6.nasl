...
# extracted from Red Hat Security Advisory django. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2015-5144", "CVE-2016-9014", "CVE-2017-7233");

  script_name(english:"RHEL 6 : django (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-9014");
