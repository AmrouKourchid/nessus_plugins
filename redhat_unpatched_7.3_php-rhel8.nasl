...
# extracted from Red Hat Security Advisory 7.3_php. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2017-8923", "CVE-2020-7069");

  script_name(english:"RHEL 8 : 7.3_php (Unpatched Vulnerability) (deprecated)");
