...
# extracted from Fedora Security Advisory FEDORA-2024-dee1ef052e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-dee1ef052e");
  script_xref(name:"IAVA", value:"2024-A-0695-S");

  script_name(english:"Fedora 40 : firefox (2024-dee1ef052e)");
...
FEDORA-2024-dee1ef052e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-dee1ef052e");
...
var pkgs = [
    {'reference':'firefox-132.0-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
