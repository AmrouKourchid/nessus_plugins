...
# extracted from Fedora Security Advisory FEDORA-2023-4b03f6cd8a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-4b03f6cd8a");

  script_name(english:"Fedora 37 : php-Smarty (2023-4b03f6cd8a)");
...
FEDORA-2023-4b03f6cd8a advisory.
    ...
    ### Fixed
    - Output buffer is now cleaned for internal PHP errors as well, not just for Exceptions
    [#514](https://github.com/smarty-php/smarty/issues/514)

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-4b03f6cd8a");
...
var pkgs = [
    {'reference':'php-Smarty-3.1.48-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
