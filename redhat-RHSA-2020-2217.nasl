...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_2217.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5a4b9218");
...
"Update the RHEL OpenShift Container Platform 3.11 package based on the guidance in RHSA-2020:2217.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'atomic-openshift-web-console-3.11.219-1.git.1.9b9b889.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-ansible'},
