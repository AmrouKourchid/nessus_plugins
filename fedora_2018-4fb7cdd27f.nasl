...
# extracted from Fedora Security Advisory FEDORA-2018-4fb7cdd27f.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2016-8568");
  script_xref(name:"FEDORA", value:"2018-4fb7cdd27f");

  script_name(english:"Fedora 27 : libgit2 (2018-4fb7cdd27f)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-4fb7cdd27f");
...
"Update the affected libgit2 package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-8568");
...
flag = 0;
if (rpm_check(release:"FC27", reference:"libgit2-0.26.3-1.fc27")) flag++;
