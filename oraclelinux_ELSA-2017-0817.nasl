...
ELSA-2017-0817 advisory.
    ...
    - [net] dccp: fix freeing skb too early for IPV6_RECVPKTINFO (Hannes Frederic Sowa) [1424628]
    {CVE-2017-6074}
    - [fs] posix_acl: Clear SGID bit when setting file permissions (Andreas Grunbacher) [1371252]
    {CVE-2016-7097}
    ...
    - [scsi] sg_write()/bsg_write() is not fit to be called under KERNEL_DS (Ewan Milne) [1414823]
    {CVE-2016-10088 CVE-2016-9576}
    - [net] sctp: validate chunk len before actually using it (Hangbin Liu) [1399457] {CVE-2016-9555}
    - [kernel] audit: fix a double fetch in audit_log_single_execve_arg() (Paul Moore) [1359304]
    {CVE-2016-6136}
    - [security] keys: Fix short sprintf buffer in /proc/keys show function (Frantisek Hrbata) [1375208]
    {CVE-2016-7042}
    ...
    - [net] netfilter: x_tables: make sure e->next_offset covers remaining blob size (Mateusz Guzik) [1351422]
    {CVE-2016-4998}
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2016-9576");
...
var pkgs = [
    ...
    {'reference':'kernel-abi-whitelists-2.6.32-696.el6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-abi-whitelists-2.6.32'},
    ...
    {'reference':'kernel-firmware-2.6.32-696.el6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-firmware-2.6.32'},
    ...
    {'reference':'kernel-abi-whitelists-2.6.32-696.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-abi-whitelists-2.6.32'},
    ...
    {'reference':'kernel-firmware-2.6.32-696.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-firmware-2.6.32'},
