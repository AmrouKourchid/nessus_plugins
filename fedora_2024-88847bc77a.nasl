...
# extracted from Fedora Security Advisory FEDORA-2024-88847bc77a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-88847bc77a");

  script_name(english:"Fedora 39 : kernel (2024-88847bc77a)");
...
FEDORA-2024-88847bc77a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-88847bc77a");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-1151");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  var cve_list = make_list('CVE-2023-52429', 'CVE-2024-1151');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for FEDORA-2024-88847bc77a');
  }
  else
  {
...
var pkgs = [
    {'reference':'kernel-6.7.5-200.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
