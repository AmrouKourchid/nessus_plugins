...
you should upgrade to the stable distribution (buster).");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2020/dsa-4691");
...
in version 4.1.11-1+deb10u1.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-12244");
