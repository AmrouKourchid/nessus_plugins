...
# extracted from Amazon Linux 2 Security Advisory ALASNITRO-ENCLAVES-2024-046.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2023-45289", "CVE-2024-24790");
  script_xref(name:"IAVB", value:"2024-B-0020-S");
  script_xref(name:"IAVB", value:"2024-B-0071-S");

  script_name(english:"Amazon Linux 2 : docker (ALASNITRO-ENCLAVES-2024-046)");
...
vulnerabilities as referenced in the ALAS2NITRO-ENCLAVES-2024-046 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALASNITRO-ENCLAVES-2024-046.html");
...
var pkgs = [
    {'reference':'docker-25.0.3-1.amzn2.0.2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'docker-25.0.3-1.amzn2.0.2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'docker-debuginfo-25.0.3-1.amzn2.0.2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'docker-debuginfo-25.0.3-1.amzn2.0.2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
