...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : unbound (EulerOS-SA-2024-2569)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2569
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?985bc966");
...
var pkgs = [
  "python3-unbound-1.13.2-3.h6.eulerosv2r11",
  "unbound-1.13.2-3.h6.eulerosv2r11",
  "unbound-libs-1.13.2-3.h6.eulerosv2r11"
];
