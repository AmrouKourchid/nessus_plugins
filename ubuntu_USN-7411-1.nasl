...
# extracted from Ubuntu Security Notice USN-7411-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"7411-1");

  script_name(english:"Ubuntu 24.04 LTS / 24.10 : OpenVPN vulnerability (USN-7411-1)");
...
the USN-7411-1 advisory.

    It was discovered that OpenVPN incorrectly handled certain malformed packets. A remote attacker could
    possibly use this issue to cause OpenVPN to crash, resulting in a denial of service.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7411-1");
...
var pkgs = [
    {'osver': '24.04', 'pkgname': 'openvpn', 'pkgver': '2.6.12-0ubuntu0.24.04.3'},
    {'osver': '24.10', 'pkgname': 'openvpn', 'pkgver': '2.6.12-1ubuntu1.2'}
];
