...
# extracted from Red Hat Security Advisory RHSA-2024:5389. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:5389");

  script_name(english:"RHEL 9 : python-setuptools (RHSA-2024:5389)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_5389.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1400ad26");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2297771");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:5389");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-setuptools package based on the guidance in RHSA-2024:5389.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-setuptools-53.0.0-12.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-setuptools-wheel-53.0.0-12.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
