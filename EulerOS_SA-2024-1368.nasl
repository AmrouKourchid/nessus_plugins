...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : python-pillow (EulerOS-SA-2024-1368)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1368
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b84c1b5f");
...
var pkgs = [
  "python3-pillow-8.1.1-2.h10.eulerosv2r10"
];
