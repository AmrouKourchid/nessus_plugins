...
# extracted from Red Hat Security Advisory RHSA-2025:4568. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:4568");

  script_name(english:"RHEL 8 : libsoup (RHSA-2025:4568)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for libsoup.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2025:4568 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_4568.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8c4d541a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:4568");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libsoup package based on the guidance in RHSA-2025:4568.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libsoup-2.62.3-3.el8_8.4', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsoup-devel-2.62.3-3.el8_8.4', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
