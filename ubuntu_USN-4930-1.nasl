...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 20.04 LTS : Samba vulnerability (USN-4930-1)");
...
referenced in the USN-4930-1 advisory.

    Peter Eriksson discovered that Samba incorrectly handled certain negative idmap cache entries. This issue
    could result in certain users gaining unauthorized access to files, contrary to expected behaviour.
