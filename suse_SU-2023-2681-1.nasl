...
# SUSE update advisory SUSE-SU-2023:2681-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2023-1390", "CVE-2023-28466", "CVE-2023-31436");
  script_xref(name:"SuSE", value:"SUSE-SU-2023:2681-1");

  script_name(english:"SUSE SLES15 Security Update : kernel (Live Patch 37 for SLE 15 SP1) (SUSE-SU-2023:2681-1)");
...
the SUSE-SU-2023:2681-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-June/015349.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?73bc6b96");
  script_set_attribute(attribute:"solution", value:
"Update the affected kernel-livepatch-4_12_14-150100_197_134-default package.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-150100.197.134-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-4_12_14-150100_197_134-default-5-150100.2.2', 'sp':'1', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.1']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kernel-livepatch-4_12_14-150100_197_134-default');
}
