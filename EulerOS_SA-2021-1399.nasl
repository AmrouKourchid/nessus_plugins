...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.2.0 : curl (EulerOS-SA-2021-1399)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1399
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5443cf4c");
...
pkgs = ["curl-7.29.0-46.h19",
        "libcurl-7.29.0-46.h19"];
