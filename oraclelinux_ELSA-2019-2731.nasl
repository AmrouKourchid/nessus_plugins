...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : .NET / Core / on / Red / Hat / Enterprise / Linux (ELSA-2019-2731)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
ELSA-2019-2731 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2019-2731.html");
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'dotnet / dotnet-host / dotnet-host-fxr-2.1 / etc');
}
