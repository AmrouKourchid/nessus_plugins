...
referenced in the RHSA-2022:0211 advisory.
    ...
    * Enable the import of plain keys into the NSS Software Token while in FIPS mode [rhel-8, openjdk-11]
    (BZ#2014211)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_0211.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?54e0fcd1");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2014199");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2014203");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2014211");
...
"Update the RHEL java-11-openjdk package based on the guidance in RHSA-2022:0211.");
