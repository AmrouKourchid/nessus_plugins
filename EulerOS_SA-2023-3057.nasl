...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.1 : openssh (EulerOS-SA-2023-3057)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3057
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?67d296d6");
...
var pkgs = [
  "openssh-8.8p1-2.h27.eulerosv2r11",
  "openssh-clients-8.8p1-2.h27.eulerosv2r11",
  "openssh-server-8.8p1-2.h27.eulerosv2r11"
];
