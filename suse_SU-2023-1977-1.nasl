...
# SUSE update advisory SUSE-SU-2023:1977-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2023-1118", "CVE-2023-1652");
  script_xref(name:"SuSE", value:"SUSE-SU-2023:1977-1");

  script_name(english:"SUSE SLES15 Security Update : kernel RT (Live Patch 3 for SLE 15 SP4) (SUSE-SU-2023:1977-1)");
...
the SUSE-SU-2023:1977-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1209797");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-April/014567.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d861a2a0");
  script_set_attribute(attribute:"solution", value:
"Update the affected kernel-livepatch-5_14_21-150400_15_11-rt package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:suse_linux:kernel-livepatch-5_14_21-150400_15_11-rt");
...
var kernel_live_checks = [
  {
    'kernels': {
      '5.14.21-150400.15.11-rt-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_14_21-150400_15_11-rt-3-150400.2.2', 'sp':'4', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.4']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kernel-livepatch-5_14_21-150400_15_11-rt');
}
