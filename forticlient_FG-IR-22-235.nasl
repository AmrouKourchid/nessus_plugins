...
if (description)
{
  ...
  script_name(english:"Fortinet FortiClient Information disclosure of folders to exclude from scanning (FG-IR-22-235)");
...
"Upgrade to FortiClient version 6.2.999999 / 6.4.999999 / 7.0.999999 / 7.2.1 or later.");
