...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Openssl PHSA-2019-3.0-0032");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'openssl-1.0.2t-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'openssl-c_rehash-1.0.2t-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'openssl-debuginfo-1.0.2t-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'openssl-devel-1.0.2t-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'openssl-perl-1.0.2t-1.ph3')) flag++;
