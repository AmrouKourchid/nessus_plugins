...
# extracted from WordPress Security Advisory wordpress-6-2-2-security-release.
...
if (description)
{
  ...
  script_name(english:"WordPress 6.0 < 6.2.2");

  script_set_attribute(attribute:"synopsis", value:
"A PHP application running on the remote web server is affected by one or more vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"WordPress versions 6.0 < 6.2.2 are affected by one or more vulnerabilities");
  script_set_attribute(attribute:"see_also", value:"https://wordpress.org/download/releases/");
  script_set_attribute(attribute:"see_also", value:"https://wordpress.org/news/2023/05/wordpress-6-2-2-security-release/");
  script_set_attribute(attribute:"see_also", value:"https://wordpress.org/support/wordpress-version/version-6-2-2");
  script_set_attribute(attribute:"solution", value:
"Upgrade to WordPress version 6.2.2 or later.");
...
var constraints = [
  { 'min_version' : '6.0', 'fixed_version' : '6.2.2' }
];
