...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : ntp on SL6.x i386/x86_64 (20181220)");
...
"Security Fix(es) :
  ...
  - ntp: Stack-based buffer overflow in ntpq and ntpdc
    ...
    (CVE-2018-12327)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1812&L=scientific-linux-errata&F=&S=&P=11804
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cd222fa0");
...
flag = 0;
if (rpm_check(release:"SL6", reference:"ntp-4.2.6p5-15.el6_10")) flag++;
if (rpm_check(release:"SL6", reference:"ntp-debuginfo-4.2.6p5-15.el6_10")) flag++;
if (rpm_check(release:"SL6", reference:"ntp-doc-4.2.6p5-15.el6_10")) flag++;
if (rpm_check(release:"SL6", reference:"ntp-perl-4.2.6p5-15.el6_10")) flag++;
if (rpm_check(release:"SL6", reference:"ntpdate-4.2.6p5-15.el6_10")) flag++;
