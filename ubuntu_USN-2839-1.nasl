...
# extracted from Ubuntu Security Notice USN-2839-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : CUPS update (USN-2839-1)");
...
USN-2839-1 advisory.
    ...
    As a security improvement against the POODLE attack, this update disables SSLv3 support in the CUPS web
    interface.

    For legacy environments where SSLv3 support is still required, it can be re-enabled by adding SSLOptions
    AllowSSL3 to /etc/cups/cupsd.conf.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2839-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'cups', 'pkgver': '1.7.2-0ubuntu1.7'},
    {'osver': '14.04', 'pkgname': 'cups-bsd', 'pkgver': '1.7.2-0ubuntu1.7'},
    {'osver': '14.04', 'pkgname': 'cups-client', 'pkgver': '1.7.2-0ubuntu1.7'},
    {'osver': '14.04', 'pkgname': 'cups-common', 'pkgver': '1.7.2-0ubuntu1.7'},
    {'osver': '14.04', 'pkgname': 'cups-core-drivers', 'pkgver': '1.7.2-0ubuntu1.7'},
    {'osver': '14.04', 'pkgname': 'cups-daemon', 'pkgver': '1.7.2-0ubuntu1.7'},
    {'osver': '14.04', 'pkgname': 'cups-ppdc', 'pkgver': '1.7.2-0ubuntu1.7'},
    {'osver': '14.04', 'pkgname': 'cups-server-common', 'pkgver': '1.7.2-0ubuntu1.7'},
    {'osver': '14.04', 'pkgname': 'libcups2', 'pkgver': '1.7.2-0ubuntu1.7'},
    {'osver': '14.04', 'pkgname': 'libcups2-dev', 'pkgver': '1.7.2-0ubuntu1.7'},
    {'osver': '14.04', 'pkgname': 'libcupscgi1', 'pkgver': '1.7.2-0ubuntu1.7'},
    {'osver': '14.04', 'pkgname': 'libcupscgi1-dev', 'pkgver': '1.7.2-0ubuntu1.7'},
    {'osver': '14.04', 'pkgname': 'libcupsimage2', 'pkgver': '1.7.2-0ubuntu1.7'},
    {'osver': '14.04', 'pkgname': 'libcupsimage2-dev', 'pkgver': '1.7.2-0ubuntu1.7'},
    {'osver': '14.04', 'pkgname': 'libcupsmime1', 'pkgver': '1.7.2-0ubuntu1.7'},
    {'osver': '14.04', 'pkgname': 'libcupsmime1-dev', 'pkgver': '1.7.2-0ubuntu1.7'},
    {'osver': '14.04', 'pkgname': 'libcupsppdc1', 'pkgver': '1.7.2-0ubuntu1.7'},
    {'osver': '14.04', 'pkgname': 'libcupsppdc1-dev', 'pkgver': '1.7.2-0ubuntu1.7'}
];
