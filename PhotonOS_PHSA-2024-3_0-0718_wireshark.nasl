...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Wireshark PHSA-2024-3.0-0718");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'wireshark-3.6.20-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'wireshark-devel-3.6.20-1.ph3')) flag++;
