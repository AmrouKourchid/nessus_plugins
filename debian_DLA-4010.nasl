...
# extracted from Debian Security Advisory dla-4010. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-4010 : python-django-doc - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has packages installed that are affected by a vulnerability as referenced in the dla-4010
advisory.
...
var pkgs = [
    {'release': '11.0', 'prefix': 'python-django-doc', 'reference': '2:2.2.28-1~deb11u4'},
    {'release': '11.0', 'prefix': 'python3-django', 'reference': '2:2.2.28-1~deb11u4'}
];
