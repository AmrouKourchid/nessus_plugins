...
# extracted from Red Hat Security Advisory RHSA-2013:1192 and 
# Oracle Linux Security Advisory ELSA-2013-1192 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : spice-server (ELSA-2013-1192)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2013-1192.html");
...
var pkgs = [
    {'reference':'spice-server-0.12.0-12.el6_4.3', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'spice-server-devel-0.12.0-12.el6_4.3', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
];
