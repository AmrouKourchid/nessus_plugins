...
# extracted from Red Hat Security Advisory RHSA-2016:0308. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2016:0308");

  script_name(english:"RHEL 7 : rabbitmq-server (RHSA-2016:0308)");
...
referenced in the RHSA-2016:0308 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1303747");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2016/rhsa-2016_0308.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?826a6b4e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2016:0308");
