...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.0 : python3 (EulerOS-SA-2021-1747)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1747
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b076e886");
...
pkgs = ["python3-3.7.4-7.h25.eulerosv2r9",
        "python3-unversioned-command-3.7.4-7.h25.eulerosv2r9"];
