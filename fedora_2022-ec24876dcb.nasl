...
# extracted from Fedora Security Advisory FEDORA-2022-ec24876dcb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-ec24876dcb");

  script_name(english:"Fedora 36 : thunderbird (2022-ec24876dcb)");
...
FEDORA-2022-ec24876dcb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-ec24876dcb");
...
var pkgs = [
    {'reference':'thunderbird-102.6.0-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
