...
# extracted from Fedora Security Advisory FEDORA-2024-c5c5671edb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-c5c5671edb");

  script_name(english:"Fedora 41 : python-django (2024-c5c5671edb)");
...
FEDORA-2024-c5c5671edb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-c5c5671edb");
...
var pkgs = [
    {'reference':'python-django-4.2.11-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
