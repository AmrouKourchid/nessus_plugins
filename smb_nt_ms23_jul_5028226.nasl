...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5028222");
  script_xref(name:"MSKB", value:"5028226");
  script_xref(name:"MSFT", value:"MS23-5028222");
  script_xref(name:"MSFT", value:"MS23-5028226");
  script_xref(name:"IAVA", value:"2023-A-0347-S");
  script_xref(name:"IAVA", value:"2023-A-0345-S");

  script_name(english:"KB5028226: Windows Server 2008 Security Update (July 2023)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5028226. It is, therefore, affected by multiple vulnerabilities
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5028222");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5028226");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5028226 or Cumulative Update 5028222");
...
if (
  smb_check_rollup(os:'6.0',
                   ...
                   rollup_date:'07_2023',
                   bulletin:bulletin,
                   rollup_kb_list:[5028226, 5028222])
)
{
