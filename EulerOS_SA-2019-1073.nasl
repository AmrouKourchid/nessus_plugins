...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : rsyslog (EulerOS-SA-2019-1073)");
...
vulnerability :
  ...
  - A denial of service vulnerability was found in rsyslog
    in the imptcp module. An attacker could send a
    specially crafted message to the imptcp socket, which
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1073
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9376fb9e");
...
pkgs = ["rsyslog-8.24.0-17.h12.eulerosv2r7",
        "rsyslog-gnutls-8.24.0-17.h12.eulerosv2r7",
        "rsyslog-gssapi-8.24.0-17.h12.eulerosv2r7",
        "rsyslog-mmjsonparse-8.24.0-17.h12.eulerosv2r7",
        "rsyslog-mysql-8.24.0-17.h12.eulerosv2r7",
        "rsyslog-pgsql-8.24.0-17.h12.eulerosv2r7",
        "rsyslog-relp-8.24.0-17.h12.eulerosv2r7"];
