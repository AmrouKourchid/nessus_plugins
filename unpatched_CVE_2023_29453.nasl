...
if (description)
{
  ...
  script_cve_id("CVE-2023-29453");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2023-29453");
...
patch available.
  ...
  - Templates do not properly consider backticks (`) as Javascript string delimiters, and do not escape them
    ...
    now be escaped. This should be used with caution. (CVE-2023-29453)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-29453");
