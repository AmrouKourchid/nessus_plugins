...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : LWP::Protocol::https vulnerability (USN-2292-1)");
...
USN-2292-1 advisory.
    ...
    It was discovered that the LWP::Protocol::https perl module incorrectly disabled peer certificate
    verification completely when only hostname verification was requested to be disabled. If a remote attacker
    were able to perform a machine-in-the-middle attack, this flaw could possibly be exploited in certain
    scenarios to alter or compromise confidential information in applications that used the
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2292-1");
...
"Update the affected liblwp-protocol-https-perl package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-3230");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'liblwp-protocol-https-perl', 'pkgver': '6.04-2ubuntu0.1'}
];
