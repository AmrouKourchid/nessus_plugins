...
# extracted from Red Hat Security Advisory RHSA-2025:3160. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2025-26699", "CVE-2025-27516");
  script_xref(name:"RHSA", value:"2025:3160");

  script_name(english:"RHEL 8 / 9 : Red Hat Ansible Automation Platform 2.5 Product Security and Bug Fix Update (Important) (RHSA-2025:3160)");
...
referenced in the RHSA-2025:3160 advisory.
    ...
    * python3.11-django: Potential denial-of-service vulnerability in django.utils.text.wrap()
    (CVE-2025-26699)
    ...
    Automation Platform
    * Fixed an issue when migrating user accounts with invalid email addresses, the process would print a
    message showing the user name of the user whose email address has been removed (AAP-42146)
    * When migrating user accounts with invalid email addresses the process will print a message showing the
    user name of the user whose email address has been removed (AAP-41675)
    ...
    * Removed ANSIBLE_COLLECTIONS_PATHS from the controllers job output due to the discontinuation of
    ansible-engine 2.9 (AAP-41566)
    * Fixed the system auditor to no longer download the execution node install bundle (AAP-37922)
    * Fixed host records to no longer be added to the HostMetric if the host had only failures or unreachable
    tasks done (AAP-32094)
    ...
    * Fixed gateway installations which resulted in failures in environments with IPv6 due to nginx
    configuration timing (AAP-41816)
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_3160.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f6dc8d1a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:3160");
...
"Update the affected automation-controller-venv-tower, python3.11-django and / or python3.11-jinja2 packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2025-26699");

  script_set_attribute(attribute:"exploitability_ease", value:"No known exploits are available");
  script_set_attribute(attribute:"exploit_available", value:"false");
  script_cwe_id(400, 1336);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3.11-jinja2-3.1.6-1.el8ap', 'release':'8', 'el_string':'el8ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.5', 'cves':['CVE-2025-27516']}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'automation-controller-venv-tower-4.6.10-1.el8ap', 'release':'8', 'el_string':'el8ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.5', 'cves':['CVE-2025-27516']},
      {'reference':'python3.11-django-4.2.20-1.el8ap', 'release':'8', 'el_string':'el8ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.5', 'cves':['CVE-2025-26699']}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'python3.11-jinja2-3.1.6-1.el9ap', 'release':'9', 'el_string':'el9ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.5', 'cves':['CVE-2025-27516']}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'automation-controller-venv-tower-4.6.10-1.el9ap', 'release':'9', 'el_string':'el9ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.5', 'cves':['CVE-2025-27516']},
      {'reference':'python3.11-django-4.2.20-1.el9ap', 'release':'9', 'el_string':'el9ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.5', 'cves':['CVE-2025-26699']}
    ]
  }
];
