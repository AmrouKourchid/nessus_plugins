...
# extracted from Red Hat Security Advisory microcode_ctl. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2022-33972", "CVE-2022-38090");

  script_name(english:"RHEL 7 : microcode_ctl (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-38090");
