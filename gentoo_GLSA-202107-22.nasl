...
# extracted from Gentoo Linux Security Advisory GLSA 202107-22.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2021-33586");
  script_xref(name:"GLSA", value:"202107-22");

  script_name(english:"GLSA-202107-22 : InspIRCd: Information disclosure");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202107-22
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202107-22"
  );
  script_set_attribute(
    attribute:"solution",
    value:
"All InspIRCd users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-33586");
  script_set_attribute(attribute:"exploitability_ease", value:"No known exploits are available");
  script_set_attribute(attribute:"exploit_available", value:"false");

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:inspircd");
...
if (qpkg_check(package:"net-irc/inspircd", unaffected:make_list("ge 3.10.0"), vulnerable:make_list("lt 3.10.0"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "InspIRCd");
}
