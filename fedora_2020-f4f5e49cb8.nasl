...
# extracted from Fedora Security Advisory FEDORA-2020-f4f5e49cb8.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : libssh (2020-f4f5e49cb8)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-f4f5e49cb8");
...
flag = 0;
if (rpm_check(release:"FC32", reference:"libssh-0.9.5-1.fc32")) flag++;
