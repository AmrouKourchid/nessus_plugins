...
# extracted from Red Hat Security Advisory RHSA-2023:3068. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:3068");

  script_name(english:"RHEL 8 : mingw-expat (RHSA-2023:3068)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for mingw-expat.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2023:3068 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_3068.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?386c3b44");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:3068");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL mingw-expat package based on the guidance in RHSA-2023:3068.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'mingw32-expat-2.4.8-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mingw64-expat-2.4.8-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
