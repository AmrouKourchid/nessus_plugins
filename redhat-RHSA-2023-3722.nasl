...
referenced in the RHSA-2023:3722 advisory.
    ...
    * In FIPS mode, openssl should provide an indicator for AES-GCM to query whether the IV was generated
    internally or provided externally (BZ#2175868)

    * openssl FIPS mode self-test should zeroize `out` in `verify_integrity` in providers/fips/self_test.c
    (BZ#2175873)

    * In FIPS mode, openssl should not support RSA encryption or decryption without padding (outside of
    RSASVE) or provide an indicator (BZ#2178029)

    * In FIPS mode, openssl should reject EVP_PKEY_fromdata() for short DHX keys, or provide an indicator
    (BZ#2178030)

    * In FIPS mode, openssl should not use the legacy ECDSA_do_sign(), RSA_public_encrypt(),
    RSA_private_decrypt() functions for pairwise consistency tests (BZ#2178034)

    * In FIPS mode, openssl should enter error state when DH PCT fails (BZ#2178039)

    * In FIPS mode, openssl should always run the PBKDF2 lower bounds checks or provide an indicator when the
    pkcs5 parameter is set to 1 (BZ#2178137)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_3722.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2b781915");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2175860");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2175864");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2175868");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2175873");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2178029");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2178030");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2178034");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2178039");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2178137");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2179379");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2188046");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2188052");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2188461");
...
"Update the RHEL openssl package based on the guidance in RHSA-2023:3722.");
