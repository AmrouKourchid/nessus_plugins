...
# SUSE update advisory SUSE-SU-2022:4196-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:4196-1");

  script_name(english:"SUSE SLED15 / SLES15 Security Update : opensc (SUSE-SU-2022:4196-1)");
...
vulnerability as referenced in the SUSE-SU-2022:4196-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-November/013092.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ee8749cd");
...
"Update the affected opensc package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-6502");
...
var pkgs = [
    {'reference':'opensc-0.19.0-150100.3.19.1', 'sp':'3', 'release':'SLED_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.3']},
    {'reference':'opensc-0.19.0-150100.3.19.1', 'sp':'3', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.3']},
    {'reference':'opensc-0.19.0-150100.3.19.1', 'sp':'3', 'release':'SLED15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.3', 'sle-module-basesystem-release-15.3', 'sled-release-15.3', 'sles-release-15.3']},
    {'reference':'opensc-0.19.0-150100.3.19.1', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.3', 'sle-module-basesystem-release-15.3', 'sled-release-15.3', 'sles-release-15.3']}
];
