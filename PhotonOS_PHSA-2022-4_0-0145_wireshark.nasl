...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Wireshark PHSA-2022-4.0-0145");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'wireshark-3.6.1-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'wireshark-devel-3.6.1-1.ph4')) flag++;
