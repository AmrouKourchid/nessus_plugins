...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : ghostscript (EulerOS-SA-2024-1649)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1649
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?053cef8f");
...
var pkgs = [
  "ghostscript-9.07-31.6.h24.eulerosv2r7",
  "ghostscript-cups-9.07-31.6.h24.eulerosv2r7"
];
