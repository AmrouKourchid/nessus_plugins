...
# extracted from Amazon Linux 2 Security Advisory ALAS-2019-1174.
#
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : libwmf (ALAS-2019-1174)");
...
NOTE: PHP is unaffected.(CVE-2019-6978)");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2019-1174.html");
...
flag = 0;
if (rpm_check(release:"AL2", reference:"libwmf-0.2.8.4-41.amzn2.0.3")) flag++;
if (rpm_check(release:"AL2", reference:"libwmf-debuginfo-0.2.8.4-41.amzn2.0.3")) flag++;
if (rpm_check(release:"AL2", reference:"libwmf-devel-0.2.8.4-41.amzn2.0.3")) flag++;
if (rpm_check(release:"AL2", reference:"libwmf-lite-0.2.8.4-41.amzn2.0.3")) flag++;
