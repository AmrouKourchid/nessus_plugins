...
# extracted from Fedora Security Advisory FEDORA-2021-851c6e4e2d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-851c6e4e2d");

  script_name(english:"Fedora 33 : python3.10 (2021-851c6e4e2d)");
...
FEDORA-2021-851c6e4e2d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-851c6e4e2d");
...
pkgs = [
    {'reference':'python3.10-3.10.0~a5-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
