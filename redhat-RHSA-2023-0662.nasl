...
# extracted from Red Hat Security Advisory RHSA-2023:0662. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_0662.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d7a6804e");
...
"Update the RHEL tigervnc package based on the guidance in RHSA-2023:0662.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'tigervnc-1.12.0-9.el8_7.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'tigervnc-server-1.12.0-9.el8_7.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tigervnc-server-minimal-1.12.0-9.el8_7.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tigervnc-server-module-1.12.0-9.el8_7.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
