...
# extracted from Debian Security Advisory dsa-5773. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5773 : chromium - security update");
...
dsa-5773 advisory.
    ...
    - -------------------------------------------------------------------------
    Debian Security Advisory DSA-5773-1                   security@debian.org
    https://www.debian.org/security/                           Andres Salomon
    September 19, 2024                    https://www.debian.org/security/faq
    - -------------------------------------------------------------------------
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-8904");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-8905");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-8906");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-8907");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-8908");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-8909");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'chromium', 'reference': '129.0.6668.58-1~deb12u1'},
    {'release': '12.0', 'prefix': 'chromium-common', 'reference': '129.0.6668.58-1~deb12u1'},
    {'release': '12.0', 'prefix': 'chromium-driver', 'reference': '129.0.6668.58-1~deb12u1'},
    {'release': '12.0', 'prefix': 'chromium-l10n', 'reference': '129.0.6668.58-1~deb12u1'},
    {'release': '12.0', 'prefix': 'chromium-sandbox', 'reference': '129.0.6668.58-1~deb12u1'},
    {'release': '12.0', 'prefix': 'chromium-shell', 'reference': '129.0.6668.58-1~deb12u1'}
];
