...
# extracted from Fedora Security Advisory FEDORA-2024-d9c7181a19
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-d9c7181a19");

  script_name(english:"Fedora 40 : onnx (2024-d9c7181a19)");
...
FEDORA-2024-d9c7181a19 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-d9c7181a19");
...
"Update the affected onnx package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-5187");
...
var pkgs = [
    {'reference':'onnx-1.14.1-3.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
