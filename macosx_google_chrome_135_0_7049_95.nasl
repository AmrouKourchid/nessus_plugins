...
"The version of Google Chrome installed on the remote macOS host is prior to 135.0.7049.95. It is, therefore, affected by
multiple vulnerabilities as referenced in the 2025_04_stable-channel-update-for-desktop_15 advisory.
...
google_chrome_check_version(fix:'135.0.7049.95', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
