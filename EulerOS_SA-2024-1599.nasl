...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : python-cryptography (EulerOS-SA-2024-1599)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1599
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e5cad8eb");
