...
"The version of Firefox installed on the remote Windows host is prior to 106.0. It is, therefore, affected by multiple
vulnerabilities as referenced in the mfsa2022-44 advisory.
...
"Upgrade to Mozilla Firefox version 106.0 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-46885");
...
mozilla_check_version(installs:installs, product:'firefox', esr:FALSE, fix:'106.0', severity:SECURITY_HOLE);
