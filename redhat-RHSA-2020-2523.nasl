...
# extracted from Red Hat Security Advisory RHSA-2020:2523. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:2523");
  script_xref(name:"CEA-ID", value:"CEA-2021-0004");

  script_name(english:"RHEL 8 : Red Hat OpenShift Service Mesh 1.1.2 servicemesh-proxy (RHSA-2020:2523)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for Red Hat OpenShift Service Mesh 1.1.2 servicemesh-proxy.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_2523.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?743f29f3");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:2523");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1844929");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat OpenShift Service Mesh 1.1.2 servicemesh-proxy package based on the guidance in RHSA-2020:2523.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'servicemesh-proxy-1.1.2-3.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'servicemesh-'}
    ]
  }
];
