...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.0 : dnsmasq (EulerOS-SA-2023-2485)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2485
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?282bb9de");
...
var pkgs = [
  "dnsmasq-2.82-5.h19.eulerosv2r10"
];
