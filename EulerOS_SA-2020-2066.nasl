...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : opensc (EulerOS-SA-2020-2066)");
...
vulnerabilities :
  ...
  - OpenSC before 0.20.0-rc1 has an out-of-bounds access of
    an ASN.1 Bitstring in decode_bit_string in
    libopensc/asn1.c.(CVE-2019-15945)

  - OpenSC before 0.20.0-rc1 has an out-of-bounds access of
    an ASN.1 Octet string in asn1_decode_entry in
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2066
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5de14320");
...
pkgs = ["opensc-0.16.0-5.20170227git777e2a3.h2"];
