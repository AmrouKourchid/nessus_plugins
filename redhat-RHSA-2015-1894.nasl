...
# extracted from Red Hat Security Advisory RHSA-2015:1894. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2015:1894");

  script_name(english:"RHEL 7 : python-django (RHSA-2015:1894)");
...
referenced in the RHSA-2015:1894 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1252890");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1252891");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2015/rhsa-2015_1894.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c2774e21");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2015:1894");
...
"Update the RHEL python-django package based on the guidance in RHSA-2015:1894.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-5964");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python-django-1.6.11-3.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'python-django-bash-completion-1.6.11-3.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'python-django-doc-1.6.11-3.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
