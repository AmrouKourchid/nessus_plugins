...
# extracted from Red Hat Security Advisory RHSA-2022:6715. The text
...
referenced in the RHSA-2022:6715 advisory.
    ...
    * Mozilla: Remote content specified in an HTML document that was nested inside an iframe's srcdoc
    attribute was not blocked (CVE-2022-3032)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_6715.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bcaff2bc");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:6715");
...
"Update the RHEL thunderbird package based on the guidance in RHSA-2022:6715.");
  ...
  script_cwe_id(120, 125, 200, 240, 416, 440, 449, 784, 1021);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'thunderbird-102.3.0-3.el8_2', 'sp':'2', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'thunderbird-102.3.0-3.el8_2', 'sp':'2', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'thunderbird-102.3.0-3.el8_2', 'sp':'2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
