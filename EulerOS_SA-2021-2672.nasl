...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : qt (EulerOS-SA-2021-2672)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the qt packages installed, the EulerOS installation on the remote host is affected by the
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2672
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ec0b5f2d");
...
var pkgs = [
  "qt-4.8.7-2.h9.eulerosv2r7",
  "qt-devel-4.8.7-2.h9.eulerosv2r7",
  "qt-mysql-4.8.7-2.h9.eulerosv2r7",
  "qt-odbc-4.8.7-2.h9.eulerosv2r7",
  "qt-postgresql-4.8.7-2.h9.eulerosv2r7",
  "qt-x11-4.8.7-2.h9.eulerosv2r7"
];
