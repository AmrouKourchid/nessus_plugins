...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : libsndfile (EulerOS-SA-2022-1129)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1129
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?54a08b53");
...
var pkgs = [
  "libsndfile-1.0.25-10.h12.eulerosv2r7"
];
