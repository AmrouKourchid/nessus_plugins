...
# extracted from openSUSE Security Update openSUSE-2020-2051.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : perl-DBI (openSUSE-2020-2051)");
...
"This update for perl-DBI fixes the following issues :
  ...
  - DBD::File drivers could open files from folders other
    than those specifically passed via the f_dir attribute
    in the data source name (DSN). [bsc#1176492,
...
if ( rpm_check(release:"SUSE15.1", reference:"perl-DBI-1.639-lp151.3.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"perl-DBI-debuginfo-1.639-lp151.3.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"perl-DBI-debugsource-1.639-lp151.3.16.1") ) flag++;
