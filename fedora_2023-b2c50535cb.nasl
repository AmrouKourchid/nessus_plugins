...
# extracted from Fedora Security Advisory FEDORA-2023-b2c50535cb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-b2c50535cb");
  script_xref(name:"CEA-ID", value:"CEA-2024-0004");

  script_name(english:"Fedora 37 : nghttp2 (2023-b2c50535cb)");
...
FEDORA-2023-b2c50535cb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-b2c50535cb");
...
var pkgs = [
    {'reference':'nghttp2-1.51.0-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
