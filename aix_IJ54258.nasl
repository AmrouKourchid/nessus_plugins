...
if (description)
{
  ...
  script_name(english:"AIX (IJ54258)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AIX host is missing a security patch.");
  script_set_attribute(attribute:"description", value:
"The version of AIX installed on the remote host is prior to APAR IJ54258. It is, therefore, affected by a vulnerability
as referenced in the IJ54258 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/apar/IJ54258");
  script_set_attribute(attribute:"solution", value:
"Please apply the appropriate interim fix per APAR IJ54258.");
...
var constraints = [
    {'release': '4.1', 'ml': '00', 'sp': '10', 'patch': 'IJ54258s3a', 'package': 'bos.rte.control', 'minfilesetver': '7.3.2.0', 'maxfilesetver': '7.3.2.2'},
    {'release': '4.1', 'ml': '00', 'sp': '21', 'patch': 'IJ54258s3a', 'package': 'bos.rte.control', 'minfilesetver': '7.3.2.0', 'maxfilesetver': '7.3.2.2'},
    {'release': '4.1', 'ml': '00', 'sp': '30', 'patch': 'IJ54258s3a', 'package': 'bos.rte.control', 'minfilesetver': '7.3.2.0', 'maxfilesetver': '7.3.2.2'},
    {'release': '7.3', 'ml': '02', 'sp': '01', 'patch': 'IJ54258m1a', 'package': 'bos.rte.control', 'minfilesetver': '7.3.2.0', 'maxfilesetver': '7.3.2.2'},
    {'release': '7.3', 'ml': '02', 'sp': '02', 'patch': 'IJ54258s3a', 'package': 'bos.rte.control', 'minfilesetver': '7.3.2.0', 'maxfilesetver': '7.3.2.2'},
    {'release': '7.3', 'ml': '02', 'sp': '03', 'patch': 'IJ54258s3a', 'package': 'bos.rte.control', 'minfilesetver': '7.3.2.0', 'maxfilesetver': '7.3.2.2'}
];
