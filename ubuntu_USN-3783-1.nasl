...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS : Apache HTTP Server vulnerabilities (USN-3783-1)");
...
the USN-3783-1 advisory.

    Robert Swiecki discovered that the Apache HTTP Server HTTP/2 module incorrectly destroyed certain streams.
    A remote attacker could possibly use this issue to cause the server to crash, leading to a denial of
    ...
    remote attacker could possibly use this issue to cause the server to consume resources, leading to a
    denial of service. (CVE-2018-1333)

    Gal Goldshtein discovered that the Apache HTTP Server HTTP/2 module incorrectly handled large SETTINGS
    frames. A remote attacker could possibly use this issue to cause the server to consume resources, leading
    to a denial of service. (CVE-2018-11763)

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3783-1");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'apache2', 'pkgver': '2.4.29-1ubuntu4.4'},
    {'osver': '18.04', 'pkgname': 'apache2-bin', 'pkgver': '2.4.29-1ubuntu4.4'},
    {'osver': '18.04', 'pkgname': 'apache2-data', 'pkgver': '2.4.29-1ubuntu4.4'},
    {'osver': '18.04', 'pkgname': 'apache2-dev', 'pkgver': '2.4.29-1ubuntu4.4'},
    {'osver': '18.04', 'pkgname': 'apache2-ssl-dev', 'pkgver': '2.4.29-1ubuntu4.4'},
    {'osver': '18.04', 'pkgname': 'apache2-suexec-custom', 'pkgver': '2.4.29-1ubuntu4.4'},
    {'osver': '18.04', 'pkgname': 'apache2-suexec-pristine', 'pkgver': '2.4.29-1ubuntu4.4'},
    {'osver': '18.04', 'pkgname': 'apache2-utils', 'pkgver': '2.4.29-1ubuntu4.4'}
];
