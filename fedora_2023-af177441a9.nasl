...
# extracted from Fedora Security Advisory FEDORA-2023-af177441a9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-af177441a9");

  script_name(english:"Fedora 36 : mingw-zstd (2023-af177441a9)");
...
FEDORA-2023-af177441a9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-af177441a9");
...
var pkgs = [
    {'reference':'mingw-zstd-1.5.4-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
