...
# extracted from Fedora Security Advisory FEDORA-2023-2840932fa8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-2840932fa8");

  script_name(english:"Fedora 39 : freeimage / mingw-freeimage (2023-2840932fa8)");
...
FEDORA-2023-2840932fa8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-2840932fa8");
...
var pkgs = [
    {'reference':'freeimage-3.19.0-0.19.svn1909.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'mingw-freeimage-3.19.0-0.16.svn1909.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
