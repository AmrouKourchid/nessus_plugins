...
# extracted from SUSE update advisory SUSE-SU-2020:1623-1.
...
if (description)
{
  ...
  script_cve_id("CVE-2020-7598", "CVE-2020-8174");
  script_xref(name:"CEA-ID", value:"CEA-2021-0004");

  script_name(english:"SUSE SLES12 Security Update : nodejs6 (SUSE-SU-2020:1623-1)");
...
without introducing additional issues.");
  ...
  # https://www.suse.com/support/update/announcement/2020/suse-su-20201623-1/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d51eb5e9");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"0", reference:"nodejs6-6.17.1-11.37.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"nodejs6-debuginfo-6.17.1-11.37.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"nodejs6-debugsource-6.17.1-11.37.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"nodejs6-devel-6.17.1-11.37.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"npm6-6.17.1-11.37.1")) flag++;
