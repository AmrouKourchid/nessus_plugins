...
# extracted from Ubuntu Security Notice USN-7038-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"7038-2");

  script_name(english:"Ubuntu 14.04 LTS : APR vulnerability (USN-7038-2)");
...
USN-7038-2 advisory.
    ...
    USN-7038-1 fixed a vulnerability in Apache Portable Runtime (APR) library. This update provides the
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7038-2");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'libapr1', 'pkgver': '1.5.0-1ubuntu0.1~esm2', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'libapr1-dev', 'pkgver': '1.5.0-1ubuntu0.1~esm2', 'ubuntu_pro': TRUE}
];
