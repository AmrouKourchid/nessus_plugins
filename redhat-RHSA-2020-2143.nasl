...
"The remote Red Hat host is missing a security update for .NET Core.");
...
the RHSA-2020:2143 advisory.
    ...
    is .NET Core Runtime 2.1.18 and SDK 2.1.514.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_2143.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5c50ad97");
...
"Update the RHEL .NET Core package based on the guidance in RHSA-2020:2143.");
