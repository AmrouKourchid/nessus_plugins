...
# extracted from Fedora Security Advisory FEDORA-2020-7906a64449.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : librepo (2020-7906a64449)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-7906a64449");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"librepo-1.12.1-1.fc31")) flag++;
