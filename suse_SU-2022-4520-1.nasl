...
# SUSE update advisory SUSE-SU-2022:4520-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:4520-1");

  script_name(english:"SUSE SLES12 / SLES15 Security Update : kernel (Live Patch 26 for SLE 12 SP5) (SUSE-SU-2022:4520-1)");
...
multiple vulnerabilities as referenced in the SUSE-SU-2022:4520-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-December/013261.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0255bd41");
  script_set_attribute(attribute:"solution", value:
"Update the affected kernel-livepatch-4_12_14-197_108-default, kgraft-patch-4_12_14-122_103-default and / or kgraft-
patch-4_12_14-122_113-default packages.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-122.103-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_12_14-122_103-default-17-2.2', 'sp':'5', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5']},
          {'reference':'kgraft-patch-4_12_14-122_103-default-17-2.2', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-12.5', 'sle-live-patching-release-12.5', 'sles-release-12.5']}
        ]
      },
      '4.12.14-122.113-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_12_14-122_113-default-12-2.2', 'sp':'5', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5']},
          {'reference':'kgraft-patch-4_12_14-122_113-default-12-2.2', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-12.5', 'sle-live-patching-release-12.5', 'sles-release-12.5']}
        ]
      },
      '4.12.14-197.108-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-4_12_14-197_108-default-11-150100.2.2', 'sp':'1', 'cpu':'x86_64', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.1']},
          {'reference':'kernel-livepatch-4_12_14-197_108-default-11-150100.2.2', 'sp':'1', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.1', 'sle-module-live-patching-release-15.1', 'sles-release-15.1']}
        ]
      }
    }
  }
