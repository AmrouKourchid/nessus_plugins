...
# AlmaLinux Security Advisory ALSA-2023:4570.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:4570");

  script_name(english:"AlmaLinux 8 : iperf3 (ALSA-2023:4570)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2023-4570.html");
...
var pkgs = [
    {'reference':'iperf3-3.5-7.el8_8.alma', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
