...
# extracted from Red Hat Security Advisory RHSA-2024:8494. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:8494");

  script_name(english:"RHEL 9 : pki-servlet-engine (RHSA-2024:8494)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c75948ae");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:8494");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL pki-servlet-engine package based on the guidance in RHSA-2024:8494.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'pki-servlet-4.0-api-9.0.50-1.el9_2.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'pki-servlet-engine-9.0.50-1.el9_2.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
