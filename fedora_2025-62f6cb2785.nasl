...
# extracted from Fedora Security Advisory FEDORA-2025-62f6cb2785
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-62f6cb2785");
  script_xref(name:"IAVA", value:"2025-A-0126-S");

  script_name(english:"Fedora 40 : openssh (2025-62f6cb2785)");
...
FEDORA-2025-62f6cb2785 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-62f6cb2785");
...
var pkgs = [
    {'reference':'openssh-9.6p1-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
