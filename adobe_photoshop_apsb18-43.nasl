...
if (description)
{
  ...
  script_name(english:"Adobe Photoshop CC 19.x < 19.1.7 Vulnerability (APSB18-43)");

  script_set_attribute(attribute:"synopsis", value:
"Adobe Photoshop installed on remote Windows host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Photoshop CC installed on the remote Windows host is prior to 19.1.7. It is, therefore, affected by
a vulnerability as referenced in the apsb18-43 advisory.
