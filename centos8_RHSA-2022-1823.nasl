...
# Red Hat Security Advisory RHSA-2022:1823. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : mod_auth_openidc:2.3 (CESA-2022:1823)");
...
var pkgs = [
    {'reference':'mod_auth_openidc-2.3.7-11.module_el8.6.0', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'mod_auth_openidc-2.3.7-11.module_el8.6.0', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
