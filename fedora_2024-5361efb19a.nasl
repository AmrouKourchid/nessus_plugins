...
# extracted from Fedora Security Advisory FEDORA-2024-5361efb19a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-5361efb19a");

  script_name(english:"Fedora 40 : python3.13 (2024-5361efb19a)");
...
FEDORA-2024-5361efb19a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-5361efb19a");
...
var pkgs = [
    {'reference':'python3.13-3.13.0~rc1-3.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
