...
"The remote Red Hat host is missing a security update for rh-eclipse47-jackson-databind.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2017:3189 advisory.
    ...
    * A deserialization flaw was discovered in the jackson-databind which could allow an unauthenticated user
    ...
    ObjectMapper. This issue extends the previous flaw CVE-2017-7525 by blacklisting more classes that could
    be used maliciously. (CVE-2017-15095)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2017/rhsa-2017_3189.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8b28e293");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2017:3189");
...
"Update the RHEL rh-eclipse47-jackson-databind package based on the guidance in RHSA-2017:3189.");
...
var constraints = [
  {
    'repo_relative_urls': [
      'content/dist/rhel-alt/server/7/7Server/armv8-a/aarch64/devtools/1/debug',
      'content/dist/rhel-alt/server/7/7Server/armv8-a/aarch64/devtools/1/os',
      'content/dist/rhel-alt/server/7/7Server/armv8-a/aarch64/devtools/1/source/SRPMS',
    ...
    'pkgs': [
      {'reference':'rh-eclipse47-jackson-databind-2.7.6-3.3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-eclipse47-jackson-databind-javadoc-2.7.6-3.3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
