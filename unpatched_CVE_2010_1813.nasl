...
if (description)
{
  ...
  script_cve_id("CVE-2010-1813");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2010-1813");
...
patch available.
  ...
  - WebKit in Apple iOS before 4.1 on the iPhone and iPod touch allows remote attackers to execute arbitrary
    code or cause a denial of service (memory corruption and application crash) via vectors involving HTML
    object outlines. (CVE-2010-1813)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2010-1813");
