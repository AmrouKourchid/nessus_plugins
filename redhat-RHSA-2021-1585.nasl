...
# extracted from Red Hat Security Advisory RHSA-2021:1585. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 8 : glibc (RHSA-2021:1585)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2021:1585 advisory.
    ...
    * glibc: buffer over-read in iconv when processing invalid multi-byte input sequences in the EUC-KR
    encoding (CVE-2019-25013)

    * glibc: regular-expression match via proceed_next_node in posix/regexec.c leads to heap-based buffer
    over-read (CVE-2019-9169)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_1585.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1a89c1fe");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1428290");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1684057");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1704868");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1855790");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1856398");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1868106");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1871385");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1871387");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1871394");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1871395");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1871396");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1871397");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1880670");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1893662");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1893708");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1912960");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1918115");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1921916");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1927040");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1931305");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'compat-libpthread-nonshared-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-all-langpacks-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-benchtests-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-common-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-devel-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-headers-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-aa-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-af-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-agr-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-ak-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-am-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-an-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-anp-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-ar-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-as-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-ast-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-ayc-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-az-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-be-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-bem-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-ber-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-bg-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-bhb-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-bho-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-bi-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-bn-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-bo-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-br-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-brx-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-bs-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-byn-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-ca-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-ce-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-chr-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-cmn-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-crh-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-cs-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-csb-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-cv-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-cy-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-da-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-de-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-doi-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-dsb-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-dv-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-dz-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-el-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-en-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-eo-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-es-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-et-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-eu-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-fa-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-ff-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-fi-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-fil-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-fo-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-fr-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-fur-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-fy-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-ga-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-gd-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-gez-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-gl-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-gu-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-gv-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-ha-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-hak-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-he-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-hi-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-hif-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-hne-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-hr-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-hsb-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-ht-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-hu-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-hy-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-ia-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-id-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-ig-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-ik-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-is-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-it-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-iu-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-ja-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-ka-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-kab-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-kk-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-kl-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-km-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-kn-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-ko-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-kok-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-ks-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-ku-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-kw-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-ky-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-lb-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-lg-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-li-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-lij-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-ln-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-lo-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-lt-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-lv-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-lzh-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-mag-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-mai-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-mfe-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-mg-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-mhr-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-mi-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-miq-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-mjw-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-mk-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-ml-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-mn-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-mni-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-mr-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-ms-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-mt-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-my-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-nan-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-nb-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-nds-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-ne-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-nhn-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-niu-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-nl-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-nn-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-nr-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-nso-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-oc-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-om-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-or-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-os-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-pa-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-pap-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-pl-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-ps-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-pt-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-quz-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-raj-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-ro-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-ru-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-rw-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-sa-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-sah-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-sat-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-sc-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-sd-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-se-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-sgs-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-shn-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-shs-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-si-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-sid-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-sk-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-sl-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-sm-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-so-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-sq-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-sr-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-ss-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-st-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-sv-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-sw-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-szl-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-ta-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-tcy-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-te-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-tg-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-th-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-the-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-ti-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-tig-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-tk-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-tl-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-tn-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-to-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-tpi-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-tr-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-ts-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-tt-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-ug-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-uk-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-unm-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-ur-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-uz-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-ve-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-vi-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-wa-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-wae-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-wal-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-wo-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-xh-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-yi-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-yo-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-yue-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-yuw-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-zh-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-langpack-zu-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-locale-source-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-minimal-langpack-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-nss-devel-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-static-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glibc-utils-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libnsl-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nscd-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nss_db-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nss_hesiod-2.28-151.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
