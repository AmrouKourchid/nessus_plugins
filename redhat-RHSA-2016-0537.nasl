...
# extracted from Red Hat Security Advisory RHSA-2016:0537. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2016:0537");

  script_name(english:"RHEL 7 : openvswitch (RHSA-2016:0537)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for openvswitch.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2016:0537 advisory.
    ...
    * A buffer overflow flaw was discovered in the OVS processing of MPLS labels. A remote attacker able to
    deliver a frame containing a malicious MPLS label that would be processed by OVS could trigger the flaw
    and use the resulting memory corruption to cause a denial of service (DoS) or, possibly, execute arbitrary
    code. (CVE-2016-2074)

    Red Hat would like to thank the Open vSwitch project for reporting this issue. Upstream acknowledges
    Kashyap Thimmaraju and Bhargava Shastry as the original reporters.
...
number.");
  ...
  # https://access.redhat.com/security/data/csaf/v2/advisories/2016/rhsa-2016_0537.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4d9bb6e5");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2016:0537");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL openvswitch package based on the guidance in RHSA-2016:0537.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:openvswitch-dpdk");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openvswitch-2.4.0-2.el7_2', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'openvswitch-dpdk-2.4.0-0.10346.git97bab959.3.el7_2', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'python-openvswitch-2.4.0-2.el7_2', 'release':'7', 'el_string':'el7_2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'openvswitch / openvswitch-dpdk / python-openvswitch');
}
