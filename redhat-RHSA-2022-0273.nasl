...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_0273.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ae6bb8d4");
...
"Update the RHEL polkit package based on the guidance in RHSA-2022:0273.");
...
var constraints = [
  {
    ...
    'pkgs': [
      ...
      {'reference':'polkit-0.112-22.el7_7.2', 'sp':'7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'polkit-devel-0.112-22.el7_7.2', 'sp':'7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
