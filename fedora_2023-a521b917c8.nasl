...
# extracted from Fedora Security Advisory FEDORA-2023-a521b917c8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-a521b917c8");

  script_name(english:"Fedora 38 : libxml2 (2023-a521b917c8)");
...
FEDORA-2023-a521b917c8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-a521b917c8");
...
var pkgs = [
    {'reference':'libxml2-2.10.4-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
