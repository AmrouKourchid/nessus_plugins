...
# SUSE update advisory SUSE-SU-2023:2465-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:2465-1");

  script_name(english:"SUSE SLES12 Security Update : supportutils (SUSE-SU-2023:2465-1)");
...
in the SUSE-SU-2023:2465-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1206350");
  ...
  script_set_attribute(attribute:"see_also", value:"https://lists.suse.com/pipermail/sle-updates/2023-June/029775.html");
...
var pkgs = [
    {'reference':'supportutils-3.0.11-95.54.1', 'sp':'5', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5']},
    {'reference':'supportutils-3.0.11-95.54.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.5']}
];
