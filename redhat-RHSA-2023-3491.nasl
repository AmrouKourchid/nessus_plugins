...
# extracted from Red Hat Security Advisory RHSA-2023:3491. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:3491");

  script_name(english:"RHEL 8 : Red Hat Virtualization Host 4.4.z SP 1 (RHSA-2023:3491)");
...
referenced in the RHSA-2023:3491 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_3491.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a12f7eaa");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:3491");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat Virtualization Host 4.4.z SP 1 package based on the guidance in RHSA-2023:3491.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'redhat-virtualization-host-image-update-4.5.3-202306050942_8.6', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'}
    ]
  }
];
