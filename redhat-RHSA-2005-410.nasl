...
if (description)
{
  ...
  script_name(english:"RHEL 4 : gftp (RHSA-2005:410)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for gftp.");
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2005/rhsa-2005_410.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6db5daa7");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=149109");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2005:410");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL gftp package based on the guidance in RHSA-2005:410.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:N/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2005-0372");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gftp-2.0.17-5', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'gftp-2.0.17-5', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'gftp-2.0.17-5', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'gftp-2.0.17-5', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'gftp-2.0.17-5', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
