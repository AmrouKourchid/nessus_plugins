...
# extracted from Red Hat Security Advisory RHSA-2020:2729. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:2729");

  script_name(english:"RHEL 7 : openstack-manila and openstack-manila (RHSA-2020:2729)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for openstack-manila / openstack-manila.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2020:2729 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_2729.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b6bc123e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:2729");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1809855");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1832361");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL openstack-manila / openstack-manila packages based on the guidance in RHSA-2020:2729.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openstack-manila-6.3.2-3.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'},
      {'reference':'openstack-manila-share-6.3.2-3.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'},
      {'reference':'python-manila-6.3.2-3.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'},
      {'reference':'python-manila-tests-6.3.2-3.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'openstack-manila / openstack-manila-share / python-manila / etc');
}
