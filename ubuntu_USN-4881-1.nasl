...
# extracted from Ubuntu Security Notice USN-4881-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"4881-1");

  script_name(english:"Ubuntu 20.04 LTS : containerd vulnerability (USN-4881-1)");
...
USN-4881-1 advisory.
    ...
    It was discovered that containerd incorrectly handled certain environment variables. Contrary to
    expectations, a container could receive environment variables defined for a different container, possibly
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4881-1");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'containerd', 'pkgver': '1.3.3-0ubuntu2.3'}
];
