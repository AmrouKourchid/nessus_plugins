...
# extracted from Fedora Security Advisory FEDORA-2024-d6b0e72e3d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-d6b0e72e3d");

  script_name(english:"Fedora 40 : php-tcpdf (2024-d6b0e72e3d)");
...
FEDORA-2024-d6b0e72e3d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-d6b0e72e3d");
  script_set_attribute(attribute:"solution", value:
"Update the affected php-tcpdf package.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:C/I:N/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-56522");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2024-56521");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:php-tcpdf");
...
var pkgs = [
    {'reference':'php-tcpdf-6.8.0-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'php-tcpdf');
}
