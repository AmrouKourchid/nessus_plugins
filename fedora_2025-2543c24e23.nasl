...
# extracted from Fedora Security Advisory FEDORA-2025-2543c24e23
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-2543c24e23");

  script_name(english:"Fedora 40 : python3.12 (2025-2543c24e23)");
...
FEDORA-2025-2543c24e23 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-2543c24e23");
...
var pkgs = [
    {'reference':'python3.12-3.12.9-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
