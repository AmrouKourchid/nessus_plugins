...
if (description)
{
  ...
  script_cve_id("CVE-2023-3817", "CVE-2023-38545");
  script_xref(name:"IAVA", value:"2024-A-0031");
  script_xref(name:"CEA-ID", value:"CEA-2023-0052");

  script_name(english:"Oracle HTTP Server Multiple Vulnerabilities (January 2024 CPU)");
...
in the January 2024 CPU advisory.

  - Vulnerability in the Oracle HTTP Server product of Oracle Fusion Middleware (component: Third Party (curl)). Easily
    exploitable vulnerability allows unauthenticated attacker with network access via HTTP to compromise Oracle HTTP 
    Server. Successful attacks of this vulnerability can result in takeover of Oracle HTTP Server. (CVE-2023-38545)

  - Vulnerability in the Oracle HTTP Server product of Oracle Fusion Middleware (component: SSL Module (OpenSSL)). 
    Easily exploitable vulnerability allows unauthenticated attacker with network access via TLS to compromise Oracle 
    HTTP Server. Successful attacks of this vulnerability can result in unauthorized ability to cause a partial denial 
    of service (partial DOS) of Oracle HTTP Server. (CVE-2023-3817)
