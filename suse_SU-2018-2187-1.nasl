...
# extracted from SUSE update advisory SUSE-SU-2018:2187-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : glibc (SUSE-SU-2018:2187-1)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=1074293");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2018-1000001/");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2018-11236/");
  # https://www.suse.com/support/update/announcement/2018/suse-su-20182187-1/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?40212e6b");
...
SUSE-SLE-SERVER-12-2018-1484=1");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"0", reference:"glibc-2.19-22.27.958")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"glibc-32bit-2.19-22.27.958")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"glibc-debuginfo-2.19-22.27.958")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"glibc-debuginfo-32bit-2.19-22.27.958")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"glibc-debugsource-2.19-22.27.958")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"glibc-devel-2.19-22.27.958")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"glibc-devel-32bit-2.19-22.27.958")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"glibc-devel-debuginfo-2.19-22.27.958")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"glibc-devel-debuginfo-32bit-2.19-22.27.958")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"glibc-locale-2.19-22.27.958")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"glibc-locale-32bit-2.19-22.27.958")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"glibc-locale-debuginfo-2.19-22.27.958")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"glibc-locale-debuginfo-32bit-2.19-22.27.958")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"glibc-profile-2.19-22.27.958")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"glibc-profile-32bit-2.19-22.27.958")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"nscd-2.19-22.27.958")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"nscd-debuginfo-2.19-22.27.958")) flag++;
