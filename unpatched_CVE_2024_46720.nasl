...
if (description)
{
  ...
  script_cve_id("CVE-2024-46720");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-46720");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: drm/amdgpu: fix dereference after null
    check check the pointer hive before use. (CVE-2024-46720)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-46720");
