...
# extracted from Red Hat Security Advisory RHSA-2022:4947. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2022-1708", "CVE-2022-29036", "CVE-2022-29046");
  script_xref(name:"RHSA", value:"2022:4947");

  script_name(english:"RHEL 7 / 8 : OpenShift Container Platform 4.6.59 (RHSA-2022:4947)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for OpenShift Container Platform 4.6.59.");
...
referenced in the RHSA-2022:4947 advisory.

    Red Hat OpenShift Container Platform is Red Hat's cloud computing
    Kubernetes application platform solution designed for on-premise or private
    cloud deployments.

    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.6.59. See the following
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_4947.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?354287fa");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:4947");
...
"Update the RHEL OpenShift Container Platform 4.6.59 package based on the guidance in RHSA-2022:4947.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'conmon-2.0.21-3.rhaos4.6.el8', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2022-1708']},
      {'reference':'conmon-2.0.21-3.rhaos4.6.el8', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2022-1708']},
      {'reference':'conmon-2.0.21-3.rhaos4.6.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2022-1708']},
      {'reference':'cri-o-1.19.7-2.rhaos4.6.git3c20b65.el8', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2022-1708']},
      {'reference':'cri-o-1.19.7-2.rhaos4.6.git3c20b65.el8', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2022-1708']},
      {'reference':'cri-o-1.19.7-2.rhaos4.6.git3c20b65.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2022-1708']},
      {'reference':'jenkins-2-plugins-4.6.1653312933-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2022-29036', 'CVE-2022-29046']}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'conmon-2.0.21-3.rhaos4.6.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2022-1708']},
      {'reference':'cri-o-1.19.7-2.rhaos4.6.git3c20b65.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2022-1708']}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'conmon / cri-o / jenkins-2-plugins');
}
