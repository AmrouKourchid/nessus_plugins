...
# extracted from Fedora Security Advisory FEDORA-2020-2cbe0089e2.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : pacemaker (2020-2cbe0089e2)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-2cbe0089e2");
...
flag = 0;
if (rpm_check(release:"FC32", reference:"pacemaker-2.0.5-0.7.rc3.fc32")) flag++;
