...
"This update for adminer fixes the following issues :
  ...
  - Update to version v4.4.0 for boo#1083948 to resolve
    CVE-2018-7667");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1002214");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1083948");
  script_set_attribute(attribute:"solution", value:
"Update the affected adminer packages.");
