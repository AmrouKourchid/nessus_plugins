...
# extracted from Red Hat Security Advisory RHSA-2024:4231. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:4231");

  script_name(english:"RHEL 8 : python-jinja2 (RHSA-2024:4231)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_4231.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e771e4e7");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:4231");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-jinja2 package based on the guidance in RHSA-2024:4231.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-jinja2-2.10.1-5.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
