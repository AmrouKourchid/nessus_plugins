...
# extracted from Fedora Security Advisory FEDORA-2019-7a0497cbc2.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : wget (2019-7a0497cbc2)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-7a0497cbc2");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"wget-1.20.3-1.fc29")) flag++;
