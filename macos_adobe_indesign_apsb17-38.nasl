...
if (description)
{
  ...
  script_name(english:"Adobe InDesign 12.0.0 < 13.0.0 Remote Code Execution (APSB17-38) (macOS)");
...
"The version of Adobe InDesign installed on the remote macOS host is prior to 13.0.0. It is, therefore, affected by a
