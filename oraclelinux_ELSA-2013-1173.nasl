...
ELSA-2013-1173 advisory.
    ...
    - [x86] perf/x86: Fix offcore_rsp valid mask for SNB/IVB (Nikola Pajkovsky) [971314 971315]
    {CVE-2013-2146}
    ...
    - [net] af_key: initialize satype in key_notify_policy_flush() (Thomas Graf) [981225 981227]
    {CVE-2013-2237}
    - [net] ipv4: fix invalid free in ip_cmsg_send() callers (Petr Matousek) [980144 979788] {CVE-2013-2224}
    - [net] sctp: Use correct sideffect command in duplicate cookie handling (Daniel Borkmann) [976571 963843]
    {CVE-2013-2206}
...
var pkgs = [
    ...
    {'reference':'kernel-firmware-2.6.32-358.18.1.el6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-firmware-2.6.32'},
    ...
    {'reference':'kernel-firmware-2.6.32-358.18.1.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-firmware-2.6.32'},
