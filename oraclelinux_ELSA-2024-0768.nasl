...
# extracted from Oracle Linux Security Advisory ELSA-2024-0768.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : libmaxminddb (ELSA-2024-0768)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
ELSA-2024-0768 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-0768.html");
  script_set_attribute(attribute:"solution", value:
"Update the affected libmaxminddb and / or libmaxminddb-devel packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:libmaxminddb");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:libmaxminddb-devel");
