...
# extracted from Fedora Security Advisory FEDORA-2024-ff9a2fb31c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-ff9a2fb31c");

  script_name(english:"Fedora 40 : filezilla / libfilezilla (2024-ff9a2fb31c)");
...
FEDORA-2024-ff9a2fb31c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-ff9a2fb31c");
...
var pkgs = [
    {'reference':'filezilla-3.67.0-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libfilezilla-0.47.0-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
