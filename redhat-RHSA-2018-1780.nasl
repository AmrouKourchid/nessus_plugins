...
# extracted from Red Hat Security Advisory RHSA-2018:1780. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : xmlrpc (RHSA-2018:1780)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for xmlrpc.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2018:1780 advisory.

  - xmlrpc: Deserialization of untrusted Java object through <ex:serializable> tag (CVE-2016-5003)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_1780.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7a567933");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:1780");
...
"Update the RHEL xmlrpc package based on the guidance in RHSA-2018:1780.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'xmlrpc-client-3.1.3-9.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'xmlrpc-common-3.1.3-9.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'xmlrpc-javadoc-3.1.3-9.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'xmlrpc-server-3.1.3-9.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
