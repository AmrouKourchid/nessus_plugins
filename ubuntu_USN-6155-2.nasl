...
# extracted from Ubuntu Security Notice USN-6155-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6155-2");

  script_name(english:"Ubuntu 16.04 ESM / 18.04 ESM : Requests vulnerability (USN-6155-2)");
...
in the USN-6155-2 advisory.

    USN-6155-1 fixed a vulnerability in Requests. This update provides the corresponding update for Ubuntu
    16.04 ESM and 18.04 ESM.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6155-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'python-requests', 'pkgver': '2.9.1-3ubuntu0.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'python3-requests', 'pkgver': '2.9.1-3ubuntu0.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'python-requests', 'pkgver': '2.18.4-2ubuntu0.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'python3-requests', 'pkgver': '2.18.4-2ubuntu0.1+esm1', 'ubuntu_pro': TRUE}
];
