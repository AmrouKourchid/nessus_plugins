...
# extracted from Oracle Linux Security Advisory ELSA-2021-9400.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : bootstrap (ELSA-2021-9400)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2021-9400.html");
  script_set_attribute(attribute:"solution", value:
"Update the affected bootstrap package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:bootstrap");
...
var pkgs = [
    {'reference':'bootstrap-3.0.0-7.0.1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'bootstrap');
}
