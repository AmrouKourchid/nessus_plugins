...
multiple vulnerabilities as referenced in the USN-5910-1 advisory.
    ...
    a denial of service. This issue was only fixed in Ubuntu 20.04 ESM and Ubuntu 22.04 ESM. (CVE-2022-44572)
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'ruby-rack', 'pkgver': '1.6.4-3ubuntu0.2+esm4', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'ruby-rack', 'pkgver': '1.6.4-4ubuntu0.2+esm4', 'ubuntu_pro': TRUE},
    {'osver': '20.04', 'pkgname': 'ruby-rack', 'pkgver': '2.0.7-2ubuntu0.1+esm3', 'ubuntu_pro': TRUE},
    {'osver': '22.04', 'pkgname': 'ruby-rack', 'pkgver': '2.1.4-5ubuntu1+esm3', 'ubuntu_pro': TRUE}
];
