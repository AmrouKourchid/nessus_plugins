...
# extracted from Red Hat Security Advisory RHSA-2023:7279. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:7279");

  script_name(english:"RHEL 7 : open-vm-tools (RHSA-2023:7279)");
...
referenced in the RHSA-2023:7279 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_7279.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?67667112");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:7279");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL open-vm-tools package based on the guidance in RHSA-2023:7279.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'open-vm-tools-11.0.5-3.el7_9.9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'open-vm-tools-desktop-11.0.5-3.el7_9.9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'open-vm-tools-devel-11.0.5-3.el7_9.9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'open-vm-tools-test-11.0.5-3.el7_9.9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
