...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Pixman PHSA-2023-5.0-0013");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'pixman-0.42.2-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'pixman-devel-0.42.2-1.ph5')) flag++;
