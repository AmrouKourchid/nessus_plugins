...
if (description)
{
  ...
  script_cve_id("CVE-2022-40609");

  script_name(english:"IBM Java 7.1 < 7.1.5.19 / 8.0 < 8.0.8.5");

  script_set_attribute(attribute:"synopsis", value:
"IBM Java is affected a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of IBM Java installed on the remote host is prior to 7.1 < 7.1.5.19 / 8.0 < 8.0.8.5. It is, therefore,
affected by a vulnerability as referenced in the IBM Security Update August 2023 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"http://www-01.ibm.com/support/docview.wss?uid=swg1IX90192");
  # https://www.ibm.com/support/pages/java-sdk-security-vulnerabilities#IBM_Security_Update_August_2023
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?73e59dd8");
  script_set_attribute(attribute:"solution", value:
"Apply the appropriate patch according to the IBM Security Update August 2023 advisory.");
...
var constraints = [
  { 'min_version' : '7.1.0', 'fixed_version' : '7.1.5.19' },
  { 'min_version' : '8.0.0', 'fixed_version' : '8.0.8.5' }
];
