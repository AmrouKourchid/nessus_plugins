...
# extracted from Debian Security Advisory dla-2729. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2729-1 : asterisk - LTS security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 9 host has packages installed that are affected by a vulnerability as referenced in the dla-2729
advisory.

    It was discovered that there was an issue in the Asterisk telephony system. If the IAX2 channel driver
    received a packet that contained an unsupported media format, a crash could have occured. CVE-2021-32558
    ...
    packet that contains an unsupported media format, a crash can occur. For Debian 9 Stretch, these problems
    have been fixed in version 1:13.14.1~dfsg-2+deb9u5. We recommend that you upgrade your asterisk packages.
    In addition, Asterisk are tracking this issue as AST-2021-008 Further information about Debian LTS
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2021/dla-2729");
...
var pkgs = [
    {'release': '9.0', 'prefix': 'asterisk', 'reference': '1:13.14.1~dfsg-2+deb9u5'},
    {'release': '9.0', 'prefix': 'asterisk-config', 'reference': '1:13.14.1~dfsg-2+deb9u5'},
    {'release': '9.0', 'prefix': 'asterisk-dahdi', 'reference': '1:13.14.1~dfsg-2+deb9u5'},
    {'release': '9.0', 'prefix': 'asterisk-dev', 'reference': '1:13.14.1~dfsg-2+deb9u5'},
    {'release': '9.0', 'prefix': 'asterisk-doc', 'reference': '1:13.14.1~dfsg-2+deb9u5'},
    {'release': '9.0', 'prefix': 'asterisk-mobile', 'reference': '1:13.14.1~dfsg-2+deb9u5'},
    {'release': '9.0', 'prefix': 'asterisk-modules', 'reference': '1:13.14.1~dfsg-2+deb9u5'},
    {'release': '9.0', 'prefix': 'asterisk-mp3', 'reference': '1:13.14.1~dfsg-2+deb9u5'},
    {'release': '9.0', 'prefix': 'asterisk-mysql', 'reference': '1:13.14.1~dfsg-2+deb9u5'},
    {'release': '9.0', 'prefix': 'asterisk-ooh323', 'reference': '1:13.14.1~dfsg-2+deb9u5'},
    {'release': '9.0', 'prefix': 'asterisk-voicemail', 'reference': '1:13.14.1~dfsg-2+deb9u5'},
    {'release': '9.0', 'prefix': 'asterisk-voicemail-imapstorage', 'reference': '1:13.14.1~dfsg-2+deb9u5'},
    {'release': '9.0', 'prefix': 'asterisk-voicemail-odbcstorage', 'reference': '1:13.14.1~dfsg-2+deb9u5'},
    {'release': '9.0', 'prefix': 'asterisk-vpb', 'reference': '1:13.14.1~dfsg-2+deb9u5'}
];
