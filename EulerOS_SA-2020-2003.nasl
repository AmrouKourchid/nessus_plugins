...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.6.0 : cpio (EulerOS-SA-2020-2003)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2003
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b81652c3");
...
"Update the affected cpio package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-2037");
...
pkgs = ["cpio-2.12-9.h4.eulerosv2r8"];
