...
# extracted from Fedora Security Advisory FEDORA-2023-107939d153
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-107939d153");
  script_xref(name:"IAVA", value:"2023-A-0585-S");

  script_name(english:"Fedora 39 : thunderbird (2023-107939d153)");
...
FEDORA-2023-107939d153 advisory.
    ...
    * https://www.mozilla.org/en-US/security/advisories/mfsa2023-47/
    ...
    Update to 115.3.2 ; https://www.thunderbird.net/en-US/thunderbird/115.3.2/releasenotes/

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-107939d153");
...
var pkgs = [
    {'reference':'thunderbird-115.4.1-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
