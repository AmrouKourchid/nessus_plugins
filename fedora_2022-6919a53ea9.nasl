...
# extracted from Fedora Security Advisory FEDORA-2022-6919a53ea9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-6919a53ea9");

  script_name(english:"Fedora 37 : systemd (2022-6919a53ea9)");
...
FEDORA-2022-6919a53ea9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-6919a53ea9");
...
var pkgs = [
    {'reference':'systemd-251.10-588.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
