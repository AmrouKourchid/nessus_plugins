...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : libwebp (EulerOS-SA-2023-3309)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3309
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5460f358");
...
var pkgs = [
  "libwebp-1.1.0-1.h3.eulerosv2r9"
];
