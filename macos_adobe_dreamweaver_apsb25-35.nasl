...
if (description)
{
  ...
  script_name(english:"Adobe Dreamweaver 21.0 < 21.5 Arbitrary code execution (APSB25-35) (macOS)");
...
"The version of Adobe Dreamweaver installed on the remote macOS host is prior to 21.5. It is, therefore, affected by a
