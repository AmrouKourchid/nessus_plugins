...
# extracted from Red Hat Security Advisory RHSA-2023:0004. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:0004");

  script_name(english:"RHEL 9 : bcel (RHSA-2023:0004)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for bcel.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_0004.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1577fec7");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2142707");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:0004");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL bcel package based on the guidance in RHSA-2023:0004.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'bcel-6.4.1-9.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
