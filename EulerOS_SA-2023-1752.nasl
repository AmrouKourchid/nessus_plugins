...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.0 : samba (EulerOS-SA-2023-1752)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1752
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e8fb24ae");
...
var pkgs = [
  "libsmbclient-4.7.1-9.h31",
  "libwbclient-4.7.1-9.h31",
  "samba-client-libs-4.7.1-9.h31",
  "samba-common-4.7.1-9.h31",
  "samba-common-libs-4.7.1-9.h31",
  "samba-common-tools-4.7.1-9.h31",
  "samba-libs-4.7.1-9.h31"
];
