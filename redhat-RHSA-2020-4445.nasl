...
# extracted from Red Hat Security Advisory RHSA-2020:4445. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:4445");

  script_name(english:"RHEL 8 : librabbitmq (RHSA-2020:4445)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for librabbitmq.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2020:4445 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_4445.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?455b672b");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/8.3_release_notes/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b7e37d18");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:4445");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1786646");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL librabbitmq package based on the guidance in RHSA-2020:4445.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'librabbitmq-0.9.0-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'librabbitmq-devel-0.9.0-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'librabbitmq / librabbitmq-devel');
}
