...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : ghostscript on SL7.x x86_64 (20181127)");
...
"Security Fix(es) :
  ...
  - ghostscript: shading_param incomplete type checking
    (699660) (CVE-2018-15909)
  ...
  - ghostscript: incorrect access checking in temp file
    ...
    (CVE-2018-16539)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1811&L=scientific-linux-errata&F=&S=&P=14756
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0e85242b");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"ghostscript-9.07-31.el7_6.1")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"ghostscript-cups-9.07-31.el7_6.1")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"ghostscript-debuginfo-9.07-31.el7_6.1")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"ghostscript-devel-9.07-31.el7_6.1")) flag++;
if (rpm_check(release:"SL7", reference:"ghostscript-doc-9.07-31.el7_6.1")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"ghostscript-gtk-9.07-31.el7_6.1")) flag++;
