...
# extracted from Red Hat Security Advisory RHSA-2023:7763. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2023-29409", "CVE-2023-39321", "CVE-2023-39322");
  script_xref(name:"RHSA", value:"2023:7763");

  script_name(english:"RHEL 9 : runc (RHSA-2023:7763)");
...
referenced in the RHSA-2023:7763 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_7763.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a4ad5dd5");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:7763");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL runc package based on the guidance in RHSA-2023:7763.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'runc-1.1.9-2.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'}
    ]
  }
];
