...
# extracted from Fedora Security Advisory FEDORA-2022-fd6e43dec8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-fd6e43dec8");

  script_name(english:"Fedora 36 : freerdp (2022-fd6e43dec8)");
...
FEDORA-2022-fd6e43dec8 advisory.

    Update to 2.9.0 (CVE-2022-39316, CVE-2022-39317, CVE-2022-39318, CVE-2022-39319, CVE-2022-39320,
    CVE-2022-41877 and CVE-2022-39347).
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-fd6e43dec8");
...
var pkgs = [
    {'reference':'freerdp-2.9.0-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
