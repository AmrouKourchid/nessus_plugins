...
# extracted from Red Hat Security Advisory RHSA-2024:0453. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:0453");

  script_name(english:"RHEL 9 : rpm (RHSA-2024:0453)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for rpm.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:0453 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0453.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?260b957f");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0453");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rpm package based on the guidance in RHSA-2024:0453.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-rpm-4.16.1.3-24.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-4.16.1.3-24.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-apidocs-4.16.1.3-24.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-build-4.16.1.3-24.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-build-libs-4.16.1.3-24.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-cron-4.16.1.3-24.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-devel-4.16.1.3-24.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-libs-4.16.1.3-24.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-plugin-audit-4.16.1.3-24.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-plugin-fapolicyd-4.16.1.3-24.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-plugin-ima-4.16.1.3-24.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-plugin-selinux-4.16.1.3-24.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-plugin-syslog-4.16.1.3-24.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-plugin-systemd-inhibit-4.16.1.3-24.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-sign-4.16.1.3-24.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-sign-libs-4.16.1.3-24.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
