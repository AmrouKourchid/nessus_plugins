...
# extracted from Red Hat Security Advisory RHSA-2025:0080. The text
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_0080.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3582b524");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:0080");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL firefox package based on the guidance in RHSA-2025:0080.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-128.6.0-1.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-x11-128.6.0-1.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
