...
# extracted from Fedora Security Advisory FEDORA-2024-e7bb8bc2da
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-e7bb8bc2da");

  script_name(english:"Fedora 39 : php-bartlett-PHP-CompatInfo (2024-e7bb8bc2da)");
...
FEDORA-2024-e7bb8bc2da advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-e7bb8bc2da");
...
var pkgs = [
    {'reference':'php-bartlett-PHP-CompatInfo-7.1.4-3.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
