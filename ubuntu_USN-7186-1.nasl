...
# extracted from Ubuntu Security Notice USN-7186-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"7186-1");

  script_name(english:"Ubuntu 22.04 LTS : Linux kernel (Intel IoTG) vulnerabilities (USN-7186-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7186-1");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-7186-1');
}
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-7186-1');
  }
  else
  {
