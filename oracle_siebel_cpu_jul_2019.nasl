...
if (description)
{
  ...
  script_cve_id("CVE-2019-2777", "CVE-2019-2779", "CVE-2019-2857");

  script_name(english:"Oracle Siebel Server (July 2019 CPU)");
...
the July 2019 CPU advisory.
  ...
  - Vulnerability in the Siebel Core - Server Framework product of Oracle Siebel CRM (component: Search).
    Supported versions that are affected are 19.0 and prior. Easily exploitable vulnerability allows
    unauthenticated attacker with network access via HTTP to compromise Siebel Core - Server Framework.
    ...
    Siebel Core - Server Framework accessible data. (CVE-2019-2777)

  - Vulnerability in the Siebel UI Framework product of Oracle Siebel CRM (component: UIF Open UI). Supported
    versions that are affected are 19.0 and prior. Easily exploitable vulnerability allows low privileged
    ...
    unauthorized read access to a subset of Siebel UI Framework accessible data. (CVE-2019-2857)

  - Vulnerability in the Siebel Core - Common Components product of Oracle Siebel CRM (component: Email).
    Supported versions that are affected are 19.0 and prior. Difficult to exploit vulnerability allows high
    privileged attacker with network access via HTTP to compromise Siebel Core - Common Components. Successful
    attacks require human interaction from a person other than the attacker. Successful attacks of this
    vulnerability can result in unauthorized access to critical data or complete access to all Siebel Core -
    Common Components accessible data. (CVE-2019-2779)

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.oracle.com/a/tech/docs/5572395.xml");
...
"Apply the appropriate patch according to the July 2019 Oracle Critical Patch Update advisory.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-2777");
...
var constraints = [
  { 'max_version' : '19.0', 'fixed_version' : '19.7' }
];
