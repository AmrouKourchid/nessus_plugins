...
# extracted from Debian Security Advisory dla-3630. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3630 : roundcube - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3630
advisory.

    -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3630-1                debian-lts@lists.debian.org
    https://www.debian.org/lts/security/                       Guilhem Moulin
    October 24, 2023                              https://wiki.debian.org/LTS
    -------------------------------------------------------------------------

    Package        : roundcube
    Version        : 1.3.17+dfsg.1-1~deb10u4
    CVE ID         : CVE-2023-5631
    Debian Bug     : 1054079

    Denys Klymenko discovered a cross-site scripting (XSS) vulnerability in
    ...
    via a malicious text/html e-mail message with a crafted SVG document.
...
var pkgs = [
    {'release': '10.0', 'prefix': 'roundcube', 'reference': '1.3.17+dfsg.1-1~deb10u4'},
    {'release': '10.0', 'prefix': 'roundcube-core', 'reference': '1.3.17+dfsg.1-1~deb10u4'},
    {'release': '10.0', 'prefix': 'roundcube-mysql', 'reference': '1.3.17+dfsg.1-1~deb10u4'},
    {'release': '10.0', 'prefix': 'roundcube-pgsql', 'reference': '1.3.17+dfsg.1-1~deb10u4'},
    {'release': '10.0', 'prefix': 'roundcube-plugins', 'reference': '1.3.17+dfsg.1-1~deb10u4'},
    {'release': '10.0', 'prefix': 'roundcube-sqlite3', 'reference': '1.3.17+dfsg.1-1~deb10u4'}
];
