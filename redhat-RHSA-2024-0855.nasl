...
# extracted from Red Hat Security Advisory RHSA-2024:0855. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:0855");

  script_name(english:"RHEL 8 / 9 : Red Hat Ansible Automation Platform 2.4 Product Security and Bug Fix Update (Moderate) (RHSA-2024:0855)");
...
in the RHSA-2024:0855 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2257815");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0855.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?72c582e0");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0855");
...
"Update the affected receptor package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-49295");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'receptor-1.4.4-1.el8ap', 'release':'8', 'el_string':'el8ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.4'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'receptor-1.4.4-1.el9ap', 'release':'9', 'el_string':'el9ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.4'}
    ]
  }
];
