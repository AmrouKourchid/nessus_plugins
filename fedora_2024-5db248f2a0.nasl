...
# extracted from Fedora Security Advisory FEDORA-2024-5db248f2a0
#
...
if (description)
{
  script_id(207901);
  script_version("1.1");
  script_set_attribute(attribute:"plugin_modification_date", value:"2024/09/29");

  script_cve_id("CVE-2024-31755");
  script_xref(name:"FEDORA", value:"2024-5db248f2a0");

  script_name(english:"Fedora 40 : cjson (2024-5db248f2a0)");
...
FEDORA-2024-5db248f2a0 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-5db248f2a0");
  script_set_attribute(attribute:"solution", value:
"Update the affected cjson package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-31755");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:cjson");
...
var pkgs = [
    {'reference':'cjson-1.7.18-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'cjson');
}
