...
# extracted from Fedora Security Advisory FEDORA-2023-5a4fd08de9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-5a4fd08de9");

  script_name(english:"Fedora 37 : zchunk (2023-5a4fd08de9)");
...
FEDORA-2023-5a4fd08de9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-5a4fd08de9");
...
var pkgs = [
    {'reference':'zchunk-1.3.1-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
