...
if (description)
{
  ...
  script_cve_id("CVE-2025-21171", "CVE-2025-21172", "CVE-2025-21173");

  script_name(english:"Security Update for Microsoft .NET 9 Core (January 2025)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by a .NET Core vulnerability");
  script_set_attribute(attribute:"description", value:
"The version of Microsoft .NET 9 Core installed on the remote host is prior to 9.0.1. It is, therefore, affected by
...
number.");
  ...
  # https://github.com/dotnet/core/blob/master/release-notes/9.0/9.0.1/9.0.1.md
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0b77d4b6");
  script_set_attribute(attribute:"see_also", value:"https://msrc.microsoft.com/update-guide/vulnerability/CVE-2025-21171");
  script_set_attribute(attribute:"see_also", value:"https://msrc.microsoft.com/update-guide/vulnerability/CVE-2025-21172");
  script_set_attribute(attribute:"see_also", value:"https://msrc.microsoft.com/update-guide/vulnerability/CVE-2025-21173");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5050526");
...
"Update .NET Core, remove vulnerable packages and refer to vendor advisory.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-21172");
