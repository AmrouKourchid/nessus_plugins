...
# extracted from Ubuntu Security Notice USN-4932-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"4932-1");

  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS : Django vulnerability (USN-4932-1)");
...
in the USN-4932-1 advisory.

    It was discovered that Django incorrectly handled certain filenames. A remote attacker could possibly use
    this issue to create or overwrite files in unexpected directories.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4932-1");
...
"Update the affected python-django, python-django-common and / or python3-django packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-31542");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'python-django', 'pkgver': '1:1.11.11-1ubuntu1.13'},
    {'osver': '18.04', 'pkgname': 'python-django-common', 'pkgver': '1:1.11.11-1ubuntu1.13'},
    {'osver': '18.04', 'pkgname': 'python3-django', 'pkgver': '1:1.11.11-1ubuntu1.13'},
    {'osver': '20.04', 'pkgname': 'python3-django', 'pkgver': '2:2.2.12-1ubuntu0.6'}
];
