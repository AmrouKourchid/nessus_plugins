...
# - Modified description (04/30/2024)
...
"The remote Citrix NetScaler web management interface does not use TLS or
...
"Consider disabling this port completely and using only HTTPS.");
  ...
  script_copyright(english:"This script is Copyright (c) 2007-2025 nnposter");
...
# check if netscaler is using https / 443
if (get_kb_item("www/netscaler") && get_kb_item("www/netscaler/443")) exit(0);
