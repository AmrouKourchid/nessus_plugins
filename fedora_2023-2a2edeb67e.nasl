...
# extracted from Fedora Security Advisory FEDORA-2023-2a2edeb67e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-2a2edeb67e");

  script_name(english:"Fedora 36 : java-11-openjdk (2023-2a2edeb67e)");
...
FEDORA-2023-2a2edeb67e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-2a2edeb67e");
...
var pkgs = [
    {'reference':'java-11-openjdk-11.0.19.0.7-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
