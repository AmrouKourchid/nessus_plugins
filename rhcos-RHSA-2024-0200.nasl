...
if (description)
{
  ...
  script_name(english:"RHCOS 4 : OpenShift Container Platform 4.12.47 (RHSA-2024:0200)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat CoreOS host is missing a security update for OpenShift Container Platform 4.12.47.");
...
referenced in the RHSA-2024:0200 advisory.
...
"Update the RHCOS OpenShift Container Platform 4.12.47 package based on the guidance in RHSA-2024:0200.");
...
var pkgs = [
    {'reference':'haproxy22-2.2.24-4.rhaos4.12.el8', 'release':'4', 'el_string':'el8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
];
