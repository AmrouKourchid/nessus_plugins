...
# extracted from Fedora Security Advisory FEDORA-2023-3eda7b85f5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-3eda7b85f5");
  script_xref(name:"IAVA", value:"2023-A-0609-S");

  script_name(english:"Fedora 39 : salt (2023-3eda7b85f5)");
...
FEDORA-2023-3eda7b85f5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-3eda7b85f5");
...
var pkgs = [
    {'reference':'salt-3006.4-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
