...
# extracted from Gentoo Linux Security Advisory GLSA 202407-14.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202407-14 : TigerVNC: Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202407-14 (TigerVNC: Multiple Vulnerabilities)

    Multiple vulnerabilities have been discovered in TigerVNC. Please review the CVE identifiers referenced
    below for details.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202407-14");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=700464");
...
var packages = [
  {
    ...
    'unaffected' : make_list("ge 1.12.0-r2"),
    'vulnerable' : make_list("lt 1.12.0-r2")
  }
];
