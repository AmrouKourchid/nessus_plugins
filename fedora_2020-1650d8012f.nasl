...
# extracted from Fedora Security Advisory FEDORA-2020-1650d8012f.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 33 : 1:gdm (2020-1650d8012f)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"gdm 3.38.2.1 release :
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-1650d8012f");
...
"Update the affected 1:gdm package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-27837");
...
flag = 0;
if (rpm_check(release:"FC33", reference:"gdm-3.38.2.1-1.fc33", epoch:"1")) flag++;
