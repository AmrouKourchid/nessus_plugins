...
# Red Hat Security Advisory RHSA-2023:5989. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : varnish (CESA-2023:5989)");
...
"Update the affected varnish-modules package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:varnish-modules");
...
var appstreams = {
    'varnish:6': [
      {'reference':'varnish-modules-0.15.0-6.module_el8.5.0+995+944219f1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'varnish-modules-0.15.0-6.module_el8.5.0+995+944219f1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
};
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'varnish-modules');
}
