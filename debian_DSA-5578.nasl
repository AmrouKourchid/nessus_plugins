...
# extracted from Debian Security Advisory dsa-5578. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-5578-1 : ghostscript - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 12 host has packages installed that are affected by a vulnerability as referenced in the dsa-5578
advisory.

    It was discovered that Ghostscript, the GPL PostScript/PDF interpreter, does not properly handle errors in
    the gdev_prn_open_printer_seekable() function, which could result in the execution of arbitrary commands
    if malformed document files are processed. For the stable distribution (bookworm), this problem has been
    fixed in version 10.0.0~dfsg-11+deb12u3. We recommend that you upgrade your ghostscript packages. For the
    detailed security status of ghostscript please refer to its security tracker page at: https://security-
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2023/dsa-5578");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-46751");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'ghostscript', 'reference': '10.0.0~dfsg-11+deb12u3'},
    {'release': '12.0', 'prefix': 'ghostscript-doc', 'reference': '10.0.0~dfsg-11+deb12u3'},
    {'release': '12.0', 'prefix': 'ghostscript-x', 'reference': '10.0.0~dfsg-11+deb12u3'},
    {'release': '12.0', 'prefix': 'libgs-common', 'reference': '10.0.0~dfsg-11+deb12u3'},
    {'release': '12.0', 'prefix': 'libgs-dev', 'reference': '10.0.0~dfsg-11+deb12u3'},
    {'release': '12.0', 'prefix': 'libgs10', 'reference': '10.0.0~dfsg-11+deb12u3'},
    {'release': '12.0', 'prefix': 'libgs10-common', 'reference': '10.0.0~dfsg-11+deb12u3'},
    {'release': '12.0', 'prefix': 'libgs9-common', 'reference': '10.0.0~dfsg-11+deb12u3'}
];
