...
if (description)
{
  ...
  script_cve_id("CVE-2022-4055");

  script_name(english:"RHEL 9 : xdg-utils (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-4055");
