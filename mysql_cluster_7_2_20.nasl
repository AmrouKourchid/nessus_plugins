...
if (description)
{
  ...
  script_name(english:"MySQL Cluster 7.2.x < 7.2.20 General Subcomponent DoS (January 2017 CPU)");
...
to 7.2.20. It is, therefore, affected by an unspecified flaw in the
General subcomponent that allows an unauthenticated, remote attacker
to cause a denial of service condition.");
  # https://dev.mysql.com/doc/relnotes/mysql-cluster/7.2/en/mysql-cluster-news-7-2-20.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a190a872");
  # http://www.oracle.com/technetwork/security-advisory/cpujan2017-2881727.html#AppendixMSQL
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a1c38e52");
  script_set_attribute(attribute:"solution", value:
"Upgrade to MySQL Cluster version 7.2.20 or later as referenced in the
January 2017 Oracle Critical Patch Update advisory.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:N/I:N/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:L");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-3321");
...
mysql_check_version(variant:'Cluster', fixed:'7.2.20', min:'7.2', severity:SECURITY_WARNING);
