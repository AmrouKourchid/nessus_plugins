...
referenced in the RHSA-2013:0869 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2013/rhsa-2013_0869.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bc85de8c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2013:0869");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=927622");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=959047");
  script_set_attribute(attribute:"see_also", value:"https://rhn.redhat.com/errata/RHSA-2013-0623.html");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL tomcat6 package based on the guidance in RHSA-2013:0869.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:M/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-1976");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2013-2051");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'tomcat6-6.0.24-55.el6_4', 'release':'6', 'el_string':'el6_4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat6-admin-webapps-6.0.24-55.el6_4', 'release':'6', 'el_string':'el6_4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat6-docs-webapp-6.0.24-55.el6_4', 'release':'6', 'el_string':'el6_4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat6-el-2.1-api-6.0.24-55.el6_4', 'release':'6', 'el_string':'el6_4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat6-javadoc-6.0.24-55.el6_4', 'release':'6', 'el_string':'el6_4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat6-jsp-2.1-api-6.0.24-55.el6_4', 'release':'6', 'el_string':'el6_4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat6-lib-6.0.24-55.el6_4', 'release':'6', 'el_string':'el6_4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat6-servlet-2.5-api-6.0.24-55.el6_4', 'release':'6', 'el_string':'el6_4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat6-webapps-6.0.24-55.el6_4', 'release':'6', 'el_string':'el6_4', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
