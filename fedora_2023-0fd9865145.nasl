...
# extracted from Fedora Security Advisory FEDORA-2023-0fd9865145
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-0fd9865145");
  script_xref(name:"IAVA", value:"2023-A-0667-S");

  script_name(english:"Fedora 38 : roundcubemail (2023-0fd9865145)");
...
FEDORA-2023-0fd9865145 advisory.
    ...
    **Release 1.6.5**
    ...
    - Fix cross-site scripting (XSS) vulnerability in setting Content-Type/Content-Disposition for attachment
    preview/download
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-0fd9865145");
...
var pkgs = [
    {'reference':'roundcubemail-1.6.5-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
