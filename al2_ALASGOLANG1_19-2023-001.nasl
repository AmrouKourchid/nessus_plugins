...
# extracted from Amazon Linux 2 Security Advisory ALASGOLANG1.19-2023-001.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : golang (ALASGOLANG1.19-2023-001)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of golang installed on the remote host is prior to 1.19.10-1. It is, therefore, affected by multiple
vulnerabilities as referenced in the ALAS2GOLANG1.19-2023-001 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALASGOLANG1.19-2023-001.html");
  ...
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/cve/html/CVE-2023-29402.html");
...
var pkgs = [
    {'reference':'golang-1.19.10-1.amzn2.0.2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'golang1.19'},
    {'reference':'golang-1.19.10-1.amzn2.0.2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'golang1.19'},
    {'reference':'golang-bin-1.19.10-1.amzn2.0.2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'golang1.19'},
    {'reference':'golang-bin-1.19.10-1.amzn2.0.2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'golang1.19'},
    {'reference':'golang-docs-1.19.10-1.amzn2.0.2', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'golang1.19'},
    {'reference':'golang-misc-1.19.10-1.amzn2.0.2', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'golang1.19'},
    {'reference':'golang-race-1.19.10-1.amzn2.0.2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'golang1.19'},
    {'reference':'golang-shared-1.19.10-1.amzn2.0.2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'golang1.19'},
    {'reference':'golang-shared-1.19.10-1.amzn2.0.2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'golang1.19'},
    {'reference':'golang-src-1.19.10-1.amzn2.0.2', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'golang1.19'},
    {'reference':'golang-tests-1.19.10-1.amzn2.0.2', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'golang1.19'}
];
