...
# extracted from Red Hat Security Advisory RHSA-2023:4350. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:4350");

  script_name(english:"RHEL 9 : python-requests (RHSA-2023:4350)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_4350.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bb4d45ed");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2209469");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:4350");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-requests package based on the guidance in RHSA-2023:4350.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-requests+security-2.25.1-7.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-requests+socks-2.25.1-7.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-requests-2.25.1-7.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'python3-requests+security-2.25.1-7.el9_2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-requests+socks-2.25.1-7.el9_2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-requests-2.25.1-7.el9_2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
