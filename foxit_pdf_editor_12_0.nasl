...
if (description)
{
  ...
  script_cve_id("CVE-2022-34873", "CVE-2022-34874", "CVE-2022-34875");

  script_name(english:"Foxit PDF Editor < 12.0 Multiple Vulnerabilities");
...
Windows host is prior to 12.0. It is, therefore affected by multiple vulnerabilities:
...
"Upgrade to Foxit PDF Editor version 12.0 or later");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:P/I:N/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:N/UI:R/S:U/C:L/I:N/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-34875");
...
var constraints = [
  { 'max_version' : '10.1.8.37795', 'fixed_version' : '12.0' },
  { 'min_version' : '11.0', 'max_version' : '11.2.2.53575', 'fixed_version' : '12.0' }
];
