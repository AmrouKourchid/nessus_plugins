...
# extracted from Fedora Security Advisory FEDORA-2019-75b4a34d4f.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-75b4a34d4f");

  script_name(english:"Fedora 30 : mod_http2 (2019-75b4a34d4f)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-75b4a34d4f");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"mod_http2-1.14.1-1.fc30")) flag++;
