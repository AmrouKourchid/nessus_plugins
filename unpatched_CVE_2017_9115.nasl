...
if (description)
{
  ...
  script_cve_id("CVE-2017-9115");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2017-9115");
...
patch available.
  ...
  - In OpenEXR 2.2.0, an invalid write of size 2 in the = operator function in half.h could cause the
    application to crash or execute arbitrary code. (CVE-2017-9115)
