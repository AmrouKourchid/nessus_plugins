...
if (description)
{
  ...
  script_cve_id("CVE-2023-52926");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2023-52926");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: IORING_OP_READ did not correctly
    consume the provided buffer list when read i/o returned < 0 (except for -EAGAIN and -EIOCBQUEUED return).
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-52926");
