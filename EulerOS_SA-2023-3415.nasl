...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : shim (EulerOS-SA-2023-3415)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3415
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1708b158");
...
var pkgs = [
  "shim-unsigned-x64-12-1.h11.eulerosv2r7"
];
