...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS / 22.04 LTS / 23.04 : Bind vulnerabilities (USN-6183-1)");
...
vulnerabilities as referenced in the USN-6183-1 advisory.
    ...
    the cache size limit. A remote attacker could possibly use this issue to consume memory, leading to a
    denial of service. (CVE-2023-2828)

    It was discovered that Bind incorrectly handled the recursive-clients quota. A remote attacker could
    possibly use this issue to cause Bind to crash, resulting in a denial of service. This issue only affected
    Ubuntu 22.04 LTS, Ubuntu 22.10, and Ubuntu 23.04. (CVE-2023-2911)
