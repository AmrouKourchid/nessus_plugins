...
if (description)
{
  ...
  script_cve_id("CVE-2024-50242");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-50242");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: fs/ntfs3: Additional check in
    ntfs_file_release (CVE-2024-50242)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-50242");
