...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : libssh2 (EulerOS-SA-2019-2536)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2536
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a35dcd17");
...
pkgs = ["libssh2-1.4.3-10.1.h5.eulerosv2r7"];
