...
buffer or to cause the application to stop responding.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a50f36f3");
  # https://github.com/ImageMagick/ImageMagick/commit/cb1214c124e1bd61f7dd551b94a794864861592e
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e36cdee1");
...
var constraints = [{'fixed_version' : '7.0.7.28', 'fixed_display' : '7.0.7-28'}];
