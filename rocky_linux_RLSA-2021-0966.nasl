...
# Rocky Linux Security Advisory RLSA-2021:0966.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2021:0966");

  script_name(english:"Rocky Linux 8 : pki-core:10.6 (RLSA-2021:0966)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Rocky Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Rocky Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
RLSA-2021:0966 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2021:0966");
...
"Update the affected ldapjdk and / or ldapjdk-javadoc packages.");
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'ldapjdk / ldapjdk-javadoc');
}
