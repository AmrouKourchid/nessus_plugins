...
# extracted from Fedora Security Advisory FEDORA-2023-ef901c862c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-ef901c862c");

  script_name(english:"Fedora 37 : netatalk (2023-ef901c862c)");
...
FEDORA-2023-ef901c862c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-ef901c862c");
...
var pkgs = [
    {'reference':'netatalk-3.1.18-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'5'}
];
