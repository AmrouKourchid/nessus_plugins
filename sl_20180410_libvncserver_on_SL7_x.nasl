...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : libvncserver on SL7.x x86_64 (20180410)");
...
"Security Fix(es) :
  ...
  - libvncserver: Improper input sanitization in
    ...
    (CVE-2018-7225)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1804&L=scientific-linux-errata&F=&S=&P=3718
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?813a61d9");
