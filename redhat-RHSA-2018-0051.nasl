...
# extracted from Red Hat Security Advisory RHSA-2018:0051. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:0051");
  script_xref(name:"IAVA", value:"2018-A-0020");
  script_xref(name:"IAVA", value:"2018-A-0017-S");

  script_name(english:"RHEL 7 : rhevm-setup-plugins (RHSA-2018:0051) (Spectre)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"An update for rhevm-setup-plugins is now available for RHEV Engine
version 4.1.
...
issue.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:0051");
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", reference:"rhevm-setup-plugins-4.1.4-1.el7")) flag++;
