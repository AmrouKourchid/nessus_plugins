...
# extracted from Red Hat Security Advisory RHSA-2022:8385. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:8385");

  script_name(english:"RHEL 9 : dhcp (RHSA-2022:8385)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8385.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d230c706");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8385");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2064512");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL dhcp package based on the guidance in RHSA-2022:8385.");
