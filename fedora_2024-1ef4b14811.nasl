...
# extracted from Fedora Security Advisory FEDORA-2024-1ef4b14811
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-1ef4b14811");

  script_name(english:"Fedora 38 : dotnet8.0 (2024-1ef4b14811)");
...
FEDORA-2024-1ef4b14811 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-1ef4b14811");
...
var pkgs = [
    {'reference':'dotnet8.0-8.0.103-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
