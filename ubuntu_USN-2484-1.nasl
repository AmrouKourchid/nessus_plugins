...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : Unbound vulnerability (USN-2484-1)");
...
USN-2484-1 advisory.
    ...
    Florian Maury discovered that Unbound incorrectly handled delegation. A remote attacker could possibly use
    this issue to cause Unbound to consume resources, resulting in a denial of service.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2484-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'libunbound-dev', 'pkgver': '1.4.22-1ubuntu4.14.04.1'},
    {'osver': '14.04', 'pkgname': 'libunbound2', 'pkgver': '1.4.22-1ubuntu4.14.04.1'},
    {'osver': '14.04', 'pkgname': 'python-unbound', 'pkgver': '1.4.22-1ubuntu4.14.04.1'},
    {'osver': '14.04', 'pkgname': 'unbound', 'pkgver': '1.4.22-1ubuntu4.14.04.1'},
    {'osver': '14.04', 'pkgname': 'unbound-anchor', 'pkgver': '1.4.22-1ubuntu4.14.04.1'},
    {'osver': '14.04', 'pkgname': 'unbound-host', 'pkgver': '1.4.22-1ubuntu4.14.04.1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libunbound-dev / libunbound2 / python-unbound / unbound / etc');
}
