...
# extracted from Fedora Security Advisory FEDORA-2018-8fc2cb8cb0.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : wordpress (2018-8fc2cb8cb0)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-8fc2cb8cb0");
...
flag = 0;
if (rpm_check(release:"FC27", reference:"wordpress-4.9.7-1.fc27")) flag++;
