...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5035920");
  script_xref(name:"MSKB", value:"5035933");
  script_xref(name:"MSFT", value:"MS24-5035920");
  script_xref(name:"MSFT", value:"MS24-5035933");
  script_xref(name:"IAVA", value:"2024-A-0149-S");
  script_xref(name:"IAVA", value:"2024-A-0148-S");

  script_name(english:"KB5035933: Windows Server 2008 Security Update (March 2024)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5035933. It is, therefore, affected by multiple vulnerabilities
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5035920");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5035933");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5035933 or Cumulative Update 5035920");
...
if (
  smb_check_rollup(os:'6.0',
                   ...
                   rollup_date:'03_2024',
                   bulletin:bulletin,
                   rollup_kb_list:[5035933, 5035920])
)
{
