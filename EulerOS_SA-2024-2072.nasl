...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : openssl (EulerOS-SA-2024-2072)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2072
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?81d99e2c");
...
var pkgs = [
  "openssl-1.0.2k-16.h30.eulerosv2r7",
  "openssl-devel-1.0.2k-16.h30.eulerosv2r7",
  "openssl-libs-1.0.2k-16.h30.eulerosv2r7"
];
