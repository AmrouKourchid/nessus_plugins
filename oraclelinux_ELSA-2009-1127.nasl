...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : kdelibs (ELSA-2009-1127)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2009-1127.html");
...
"Update the affected kdelibs, kdelibs-apidocs and / or kdelibs-devel packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2009-1698");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2009-1690");
...
var pkgs = [
    {'reference':'kdelibs-3.5.4-22.0.1.el5_3', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'6'},
    {'reference':'kdelibs-apidocs-3.5.4-22.0.1.el5_3', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'6'},
    {'reference':'kdelibs-devel-3.5.4-22.0.1.el5_3', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'6'},
    {'reference':'kdelibs-3.5.4-22.0.1.el5_3', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'6'},
    {'reference':'kdelibs-apidocs-3.5.4-22.0.1.el5_3', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'6'},
    {'reference':'kdelibs-devel-3.5.4-22.0.1.el5_3', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'6'}
];
