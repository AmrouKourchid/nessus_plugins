...
if (description)
{
  ...
  script_cve_id("CVE-2016-9533");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2016-9533");
...
patch available.
  ...
  - tif_pixarlog.c in libtiff 4.0.6 has out-of-bounds write vulnerabilities in heap allocated buffers.
    Reported as MSVR 35094, aka PixarLog horizontalDifference heap-buffer-overflow. (CVE-2016-9533)
