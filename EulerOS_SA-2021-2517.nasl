...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : python-lxml (EulerOS-SA-2021-2517)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2517
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c00a8498");
...
var pkgs = [
  "python-lxml-3.2.1-4.h4.eulerosv2r7"
];
