...
# extracted from Red Hat Security Advisory RHSA-2018:2933. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:2933");

  script_name(english:"RHEL 6 : kernel (RHSA-2018:2933)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for kernel.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 6 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2018:2933 advisory.
    ...
    * Previously, invalid headers in the sk_buff struct led to an indefinite loop in the tcp_collapse()
    function. As a consequence, the system became unresponsive. This update backports the upstream changes
    that remove the problematic code in tcp_collapse(). As a result, the system no longer hangs in the
    described scenario. (BZ#1619630)
    ...
    * After updating the system to prevent the L1 Terminal Fault (L1TF) vulnerability, only one thread was
    ...
    described situation. (BZ#1625333)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2018/rhsa-2018_2933.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d22cfd69");
...
"Update the RHEL kernel package based on the guidance in RHSA-2018:2933.");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for RHSA-2018:2933');
  }
  else
  {
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'kernel-2.6.32-431.93.2.el6', 'sp':'5', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'kernel-debug-2.6.32-431.93.2.el6', 'sp':'5', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'kernel-debug-devel-2.6.32-431.93.2.el6', 'sp':'5', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'kernel-devel-2.6.32-431.93.2.el6', 'sp':'5', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'kernel-firmware-2.6.32-431.93.2.el6', 'sp':'5', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'kernel-headers-2.6.32-431.93.2.el6', 'sp':'5', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'perf-2.6.32-431.93.2.el6', 'sp':'5', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python-perf-2.6.32-431.93.2.el6', 'sp':'5', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
