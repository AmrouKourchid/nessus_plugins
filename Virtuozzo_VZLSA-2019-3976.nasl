...
if (description)
{
  ...
  script_name(english:"Virtuozzo 7 : tcpdump (VZLSA-2019-3976)");
...
it as much as possible without introducing additional issues.");
  # http://repo.virtuozzo.com/vzlinux/announcements/json/VZLSA-2019-3976.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6f49fced");
...
"Update the affected tcpdump package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:virtuozzo:virtuozzo:tcpdump");
