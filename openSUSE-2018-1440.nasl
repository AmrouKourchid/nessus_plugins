...
# extracted from openSUSE Security Update openSUSE-2018-1440.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libwpd (openSUSE-2018-1440)");
...
Security issue fixed :
  ...
  - CVE-2018-19208: Fixed illegal address access inside
    libwpd at function WP6ContentListener:defineTable
    (bsc#1115713).

This update was imported from the SUSE:SLE-12:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1115713");
  script_set_attribute(attribute:"solution", value:
"Update the affected libwpd packages.");
...
if ( rpm_check(release:"SUSE42.3", reference:"libwpd-0_10-10-0.10.2-11.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libwpd-0_10-10-debuginfo-0.10.2-11.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libwpd-debugsource-0.10.2-11.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libwpd-devel-0.10.2-11.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libwpd-tools-0.10.2-11.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libwpd-tools-debuginfo-0.10.2-11.1") ) flag++;
