...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.0 : squashfs-tools (EulerOS-SA-2021-2774)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2774
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4bd92103");
...
var pkgs = [
  "squashfs-tools-4.4-1.h1.r1.eulerosv2r9"
];
