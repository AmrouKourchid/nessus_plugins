...
# extracted from Fedora Security Advisory FEDORA-2023-8dd1a1a2e6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-8dd1a1a2e6");

  script_name(english:"Fedora 37 : rubygem-rmagick (2023-8dd1a1a2e6)");
...
FEDORA-2023-8dd1a1a2e6 advisory.

    A security flaw was found on rubygem-rmagick that Magick::Draw causes memleak. This issue is assigned as
    CVE-2023-5349. This new rpm fixes this issue.

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-8dd1a1a2e6");
  script_set_attribute(attribute:"solution", value:
"Update the affected rubygem-rmagick package.");
...
var pkgs = [
    {'reference':'rubygem-rmagick-5.2.0-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'rubygem-rmagick');
}
