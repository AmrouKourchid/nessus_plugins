...
# extracted from Red Hat Security Advisory RHSA-2017:2491. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2017-8386", "CVE-2017-1000117");
  script_xref(name:"RHSA", value:"2017:2491");

  script_name(english:"RHEL 6 / 7 : rh-git29-git (RHSA-2017:2491)");
...
referenced in the RHSA-2017:2491 advisory.
    ...
    * A shell command injection flaw related to the handling of ssh URLs has been discovered in Git. An
    attacker could use this flaw to execute shell commands with the privileges of the user running the Git
    client, for example, when performing a clone action on a malicious repository or a legitimate repository
    containing a malicious commit. (CVE-2017-1000117)

    * A flaw was found in the way git-shell handled command-line options for the restricted set of git-shell
    commands. A remote, authenticated attacker could use this flaw to bypass git-shell restrictions, to view
    and manipulate files, by abusing the instance of the less command launched using crafted command-line
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2017/rhsa-2017_2491.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2929b01d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1450407");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1480386");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2017:2491");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rh-git29-git package based on the guidance in RHSA-2017:2491.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-git29-emacs-git-2.9.3-3.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git29-emacs-git-el-2.9.3-3.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git29-git-2.9.3-3.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git29-git-all-2.9.3-3.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git29-git-core-2.9.3-3.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git29-git-core-doc-2.9.3-3.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git29-git-cvs-2.9.3-3.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git29-git-daemon-2.9.3-3.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git29-git-email-2.9.3-3.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git29-git-gui-2.9.3-3.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git29-git-p4-2.9.3-3.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git29-git-svn-2.9.3-3.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git29-gitk-2.9.3-3.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git29-gitweb-2.9.3-3.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git29-perl-Git-2.9.3-3.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git29-perl-Git-SVN-2.9.3-3.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'rh-git29-git-2.9.3-3.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git29-git-all-2.9.3-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git29-git-core-2.9.3-3.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git29-git-core-doc-2.9.3-3.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git29-git-cvs-2.9.3-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git29-git-daemon-2.9.3-3.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git29-git-email-2.9.3-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git29-git-gui-2.9.3-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git29-git-p4-2.9.3-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git29-git-svn-2.9.3-3.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git29-gitk-2.9.3-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git29-gitweb-2.9.3-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git29-perl-Git-2.9.3-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git29-perl-Git-SVN-2.9.3-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
