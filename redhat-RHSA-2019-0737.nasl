...
# extracted from Red Hat Security Advisory RHSA-2019:0737. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:0737");

  script_name(english:"RHEL 6 : flash-plugin (RHSA-2019:0737)");
...
referenced in the RHSA-2019:0737 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_0737.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7f87cae8");
  script_set_attribute(attribute:"see_also", value:"https://helpx.adobe.com/security/products/flash-player/apsb19-19.html");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:0737");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#critical");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1698202");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1698203");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL flash-plugin package based on the guidance in RHSA-2019:0737.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'flash-plugin-32.0.0.171-1.el6_10', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
