...
# Red Hat Security Advisory RHSA-2024:3058. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : mutt (CESA-2024:3058)");
...
var pkgs = [
    {'reference':'mutt-2.0.7-3.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'5'},
    {'reference':'mutt-2.0.7-3.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'5'}
];
