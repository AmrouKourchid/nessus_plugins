...
# extracted from Oracle Linux Security Advisory ELSA-2024-5962.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : python39:3.9 / and / python39-devel:3.9 (ELSA-2024-5962)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ELSA-2024-5962 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-5962.html");
...
var appstreams = {
    'python39-devel:3.9': [
      {'reference':'python39-debug-3.9.19-7.module+el8.10.0+90395+b6c4aad1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-debug-3.9.19-7.module+el8.10.0+90395+b6c4aad1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ],
    'python39:3.9': [
      {'reference':'python39-3.9.19-7.module+el8.10.0+90395+b6c4aad1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python39-devel-3.9.19-7.module+el8.10.0+90395+b6c4aad1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-idle-3.9.19-7.module+el8.10.0+90395+b6c4aad1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-idna-2.10-4.module+el8.10.0+90341+71ca88f4', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-libs-3.9.19-7.module+el8.10.0+90395+b6c4aad1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python39-rpm-macros-3.9.19-7.module+el8.10.0+90395+b6c4aad1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python39-test-3.9.19-7.module+el8.10.0+90395+b6c4aad1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-tkinter-3.9.19-7.module+el8.10.0+90395+b6c4aad1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python39-3.9.19-7.module+el8.10.0+90395+b6c4aad1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python39-devel-3.9.19-7.module+el8.10.0+90395+b6c4aad1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-idle-3.9.19-7.module+el8.10.0+90395+b6c4aad1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-idna-2.10-4.module+el8.10.0+90341+71ca88f4', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-libs-3.9.19-7.module+el8.10.0+90395+b6c4aad1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python39-rpm-macros-3.9.19-7.module+el8.10.0+90395+b6c4aad1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python39-test-3.9.19-7.module+el8.10.0+90395+b6c4aad1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python39-tkinter-3.9.19-7.module+el8.10.0+90395+b6c4aad1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
