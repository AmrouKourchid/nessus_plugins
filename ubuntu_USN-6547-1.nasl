...
# extracted from Ubuntu Security Notice USN-6547-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6547-1");

  script_name(english:"Ubuntu 23.04 : Python vulnerability (USN-6547-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 23.04 host has packages installed that are affected by a vulnerability as referenced in the USN-6547-1
advisory.

    it was discovered that Python incorrectly handled null bytes when normalizing pathnames. An attacker could
    possibly use this issue to bypass certain filename checks.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6547-1");
...
var pkgs = [
    {'osver': '23.04', 'pkgname': 'idle-python3.11', 'pkgver': '3.11.4-1~23.04.2'},
    {'osver': '23.04', 'pkgname': 'libpython3.11', 'pkgver': '3.11.4-1~23.04.2'},
    {'osver': '23.04', 'pkgname': 'libpython3.11-dev', 'pkgver': '3.11.4-1~23.04.2'},
    {'osver': '23.04', 'pkgname': 'libpython3.11-minimal', 'pkgver': '3.11.4-1~23.04.2'},
    {'osver': '23.04', 'pkgname': 'libpython3.11-stdlib', 'pkgver': '3.11.4-1~23.04.2'},
    {'osver': '23.04', 'pkgname': 'libpython3.11-testsuite', 'pkgver': '3.11.4-1~23.04.2'},
    {'osver': '23.04', 'pkgname': 'python3.11', 'pkgver': '3.11.4-1~23.04.2'},
    {'osver': '23.04', 'pkgname': 'python3.11-dev', 'pkgver': '3.11.4-1~23.04.2'},
    {'osver': '23.04', 'pkgname': 'python3.11-examples', 'pkgver': '3.11.4-1~23.04.2'},
    {'osver': '23.04', 'pkgname': 'python3.11-full', 'pkgver': '3.11.4-1~23.04.2'},
    {'osver': '23.04', 'pkgname': 'python3.11-minimal', 'pkgver': '3.11.4-1~23.04.2'},
    {'osver': '23.04', 'pkgname': 'python3.11-nopie', 'pkgver': '3.11.4-1~23.04.2'},
    {'osver': '23.04', 'pkgname': 'python3.11-venv', 'pkgver': '3.11.4-1~23.04.2'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'idle-python3.11 / libpython3.11 / libpython3.11-dev / etc');
}
