...
the ELSA-2019-4600 advisory.
    ...
    - can: gw: ensure DLC boundaries after CAN frame modification (Oliver Hartkopp)  [Orabug: 29215300]
    {CVE-2019-3701} {CVE-2019-3701}
    - ext4: verify the depth of extent tree in ext4_find_extent() (Theodore Ts'o)  [Orabug: 29396713]
    {CVE-2018-10877} {CVE-2018-10877}
    - ext4: always verify the magic number in xattr blocks (Theodore Ts'o)  [Orabug: 29437128]
    {CVE-2018-10879} {CVE-2018-10879}
    - ext4: add corruption check in ext4_xattr_set_entry() (Theodore Ts'o)  [Orabug: 29437128]
    {CVE-2018-10879} {CVE-2018-10879}
    - ext4: clear i_data in ext4_inode_info when removing inline data (Theodore Ts'o)  [Orabug: 29540710]
...
var pkgs = [
    ...
    {'reference':'kernel-uek-doc-3.8.13-118.32.1.el6uek', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-doc-3.8.13'},
    {'reference':'kernel-uek-firmware-3.8.13-118.32.1.el6uek', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-firmware-3.8.13'},
    ...
    {'reference':'kernel-uek-doc-3.8.13-118.32.1.el7uek', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-doc-3.8.13'},
    {'reference':'kernel-uek-firmware-3.8.13-118.32.1.el7uek', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-firmware-3.8.13'}
];
