...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Glib PHSA-2021-3.0-0201");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'glib-2.58.0-6.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'glib-devel-2.58.0-6.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'glib-schemas-2.58.0-6.ph3')) flag++;
