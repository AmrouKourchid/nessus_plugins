...
referenced in the RHSA-2015:0697 advisory.

  - flash-plugin: multiple code execution issues fixed in APSB15-05 (CVE-2015-0332, CVE-2015-0333,
    CVE-2015-0334, CVE-2015-0335, CVE-2015-0336, CVE-2015-0338, CVE-2015-0339, CVE-2015-0341, CVE-2015-0342)

  - flash-plugin: cross-domain policy bypass (APSB15-05) (CVE-2015-0337)

  - flash-plugin: file upload restriction bypass (APSB15-05) (CVE-2015-0340)

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2015/rhsa-2015_0697.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0eab8c77");
  script_set_attribute(attribute:"see_also", value:"https://helpx.adobe.com/security/products/flash-player/apsb15-05.html");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2015:0697");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#critical");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1201636");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1201649");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1201651");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL flash-plugin package based on the guidance in RHSA-2015:0697.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'flash-plugin-11.2.202.451-1.el5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'flash-plugin-11.2.202.451-1.el6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
