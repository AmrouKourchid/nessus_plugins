...
# extracted from Fedora Security Advisory FEDORA-2025-c26ac54608
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-c26ac54608");

  script_name(english:"Fedora 41 : c-ares (2025-c26ac54608)");
...
FEDORA-2025-c26ac54608 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-c26ac54608");
...
var pkgs = [
    {'reference':'c-ares-1.34.5-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
