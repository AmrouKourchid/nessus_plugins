...
# extracted from Debian Security Advisory dla-3631. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3631 : xdmx - security update");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'xdmx', 'reference': '2:1.20.4-1+deb10u10'},
    {'release': '10.0', 'prefix': 'xdmx-tools', 'reference': '2:1.20.4-1+deb10u10'},
    {'release': '10.0', 'prefix': 'xnest', 'reference': '2:1.20.4-1+deb10u10'},
    {'release': '10.0', 'prefix': 'xorg-server-source', 'reference': '2:1.20.4-1+deb10u10'},
    {'release': '10.0', 'prefix': 'xserver-common', 'reference': '2:1.20.4-1+deb10u10'},
    {'release': '10.0', 'prefix': 'xserver-xephyr', 'reference': '2:1.20.4-1+deb10u10'},
    {'release': '10.0', 'prefix': 'xserver-xorg-core', 'reference': '2:1.20.4-1+deb10u10'},
    {'release': '10.0', 'prefix': 'xserver-xorg-dev', 'reference': '2:1.20.4-1+deb10u10'},
    {'release': '10.0', 'prefix': 'xserver-xorg-legacy', 'reference': '2:1.20.4-1+deb10u10'},
    {'release': '10.0', 'prefix': 'xvfb', 'reference': '2:1.20.4-1+deb10u10'},
    {'release': '10.0', 'prefix': 'xwayland', 'reference': '2:1.20.4-1+deb10u10'}
];
