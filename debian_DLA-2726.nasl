...
dla-2726 advisory.
    ...
    CVE-2020-13933 Fix an authentication bypass resulting from a specially crafted HTTP request.
    CVE-2020-17510 Fix an authentication bypass resulting from a specially crafted HTTP request. For Debian 9
    stretch, these problems have been fixed in version 1.3.2-1+deb9u2. We recommend that you upgrade your
    shiro packages. For the detailed security status of shiro please refer to its security tracker page at:
    https://security-tracker.debian.org/tracker/shiro Further information about Debian LTS security
