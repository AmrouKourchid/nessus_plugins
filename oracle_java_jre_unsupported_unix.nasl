...
var longterm_support_lists = make_array(
 ...
 "^1\.3\.", make_array( 
  ...
  "^1\.18\.", make_array(
        'support_type' , 'out_of_support',
        'support_dates', "2023-09-01 (end of Premier Support) / n/a (end of Extended Support)"
      ),
  "^1\.19\.", make_array(
        'support_type' , 'out_of_support',
  ...
  "^1\.20\.", make_array(
        'support_type' , 'out_of_support',
        'support_dates', "2023-09-01 (end of Premier Support)"
      ),
  "^1\.21\.", make_array(
        'support_type' , 'premier_support',
  ...
  "^1\.22\.", make_array(
        'support_type' , 'out_of_support',
        'support_dates', "2024-09-01 (end of Premier Support)"
      ),
  "^1\.23\.", make_array(
        'support_type' , 'out_of_support',
