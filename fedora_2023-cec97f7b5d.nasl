...
# extracted from Fedora Security Advisory FEDORA-2023-cec97f7b5d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-cec97f7b5d");

  script_name(english:"Fedora 38 : netatalk (2023-cec97f7b5d)");
...
FEDORA-2023-cec97f7b5d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-cec97f7b5d");
...
var pkgs = [
    {'reference':'netatalk-3.1.18-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'5'}
];
