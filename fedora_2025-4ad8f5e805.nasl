...
# extracted from Fedora Security Advisory FEDORA-2025-4ad8f5e805
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-4ad8f5e805");

  script_name(english:"Fedora 40 : chromium (2025-4ad8f5e805)");
...
FEDORA-2025-4ad8f5e805 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-4ad8f5e805");
...
var pkgs = [
    {'reference':'chromium-135.0.7049.84-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
