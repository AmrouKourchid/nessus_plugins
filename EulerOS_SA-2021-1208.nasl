...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : libvncserver (EulerOS-SA-2021-1208)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1208
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?280dd6e1");
...
pkgs = ["libvncserver-0.9.9-12.h14.eulerosv2r7"];
