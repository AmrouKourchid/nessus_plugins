...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2005/rhsa-2005_201.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?31e300ea");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=148882");
  # http://www.squid-cache.org/Versions/v2/2.5/bugs/#squid-2.5.STABLE8-dns_assert
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bacf8ab4");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2005:201");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL squid package based on the guidance in RHSA-2005:201.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2005-0446");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'squid-2.5.STABLE6-3.4E.5', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'squid-2.5.STABLE6-3.4E.5', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'squid-2.5.STABLE6-3.4E.5', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'squid-2.5.STABLE6-3.4E.5', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'squid-2.5.STABLE6-3.4E.5', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
    ]
  }
];
