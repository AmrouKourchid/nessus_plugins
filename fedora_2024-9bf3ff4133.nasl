...
# extracted from Fedora Security Advisory FEDORA-2024-9bf3ff4133
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-9bf3ff4133");

  script_name(english:"Fedora 40 : qt6-qtbase (2024-9bf3ff4133)");
...
FEDORA-2024-9bf3ff4133 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-9bf3ff4133");
...
var pkgs = [
    {'reference':'qt6-qtbase-6.7.2-3.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
