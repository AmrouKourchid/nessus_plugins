...
# extracted from Oracle Linux Security Advisory ELSA-2021-4826.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : mailman:2.1 (ELSA-2021-4826)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2021-4826.html");
...
var appstreams = {
    'mailman:2.1': [
      {'reference':'mailman-2.1.29-12.module+el8.5.0+20429+dde04a6e.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      {'reference':'mailman-2.1.29-12.module+el8.5.0+20429+dde04a6e.1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'}
    ]
};
