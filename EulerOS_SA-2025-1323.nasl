...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP13 : python3 (EulerOS-SA-2025-1323)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1323
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?09bb619a");
...
var pkgs = [
  "python3-3.9.9-28.h10.eulerosv2r13",
  "python3-fgo-3.9.9-28.h10.eulerosv2r13",
  "python3-unversioned-command-3.9.9-28.h10.eulerosv2r13"
];
