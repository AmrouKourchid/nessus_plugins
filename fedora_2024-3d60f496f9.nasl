...
# extracted from Fedora Security Advisory FEDORA-2024-3d60f496f9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-3d60f496f9");

  script_name(english:"Fedora 39 : gtk3 (2024-3d60f496f9)");
...
FEDORA-2024-3d60f496f9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-3d60f496f9");
...
var pkgs = [
    {'reference':'gtk3-3.24.43-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
