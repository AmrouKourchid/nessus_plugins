...
# extracted from Fedora Security Advisory FEDORA-2023-71dc071847
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-71dc071847");

  script_name(english:"Fedora 39 : python3.9 (2023-71dc071847)");
...
FEDORA-2023-71dc071847 advisory.
    ...
    ```
    * Mon May 29 2023 Lumr Balhar <lbalhar@redhat.com> - 3.9.16-4
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-71dc071847");
...
var pkgs = [
    {'reference':'python3.9-3.9.16-4.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
