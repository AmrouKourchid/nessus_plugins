...
# extracted from Fedora Security Advisory FEDORA-2023-464caf9bb6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-464caf9bb6");

  script_name(english:"Fedora 37 : CuraEngine (2023-464caf9bb6)");
...
FEDORA-2023-464caf9bb6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-464caf9bb6");
  script_set_attribute(attribute:"solution", value:
"Update the affected 1:CuraEngine package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:CuraEngine");
...
var pkgs = [
    {'reference':'CuraEngine-4.13.1-7.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'CuraEngine');
}
