...
if (description)
{
  ...
  script_cve_id("CVE-2020-14364", "CVE-2020-1983");
  script_xref(name:"IAVB", value:"2020-B-0063-S");

  script_name(english:"Scientific Linux Security Update : qemu-kvm on SL7.x x86_64 (20201001)");
...
"Security Fix(es) :
  ...
  - QEMU: usb: out-of-bounds r/w access issue while
    processing usb packets (CVE-2020-14364)

  - QEMU: slirp: use-after-free in ip_reass() function in
    ip_input.c (CVE-2020-1983)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind2010&L=SCIENTIFIC-LINUX-ERRATA&P=10721
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dabc145b");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"qemu-img-1.5.3-175.el7_9.1")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"qemu-kvm-1.5.3-175.el7_9.1")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"qemu-kvm-common-1.5.3-175.el7_9.1")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"qemu-kvm-debuginfo-1.5.3-175.el7_9.1")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"qemu-kvm-tools-1.5.3-175.el7_9.1")) flag++;
