...
if (description)
{
  ...
  script_cve_id("CVE-2016-9105");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2016-9105");
...
patch available.
  ...
  - Memory leak in the v9fs_link function in hw/9pfs/9p.c in QEMU (aka Quick Emulator) allows local guest OS
    administrators to cause a denial of service (memory consumption) via vectors involving a reference to the
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-9105");
