...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.4 : kernel (EulerOS-SA-2019-1187)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1187
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ad09370a");
...
pkgs = ["kernel-3.10.0-862.14.1.1_38",
        "kernel-devel-3.10.0-862.14.1.1_38",
        "kernel-headers-3.10.0-862.14.1.1_38",
        "kernel-tools-3.10.0-862.14.1.1_38",
        "kernel-tools-libs-3.10.0-862.14.1.1_38",
        "kernel-tools-libs-devel-3.10.0-862.14.1.1_38"];
