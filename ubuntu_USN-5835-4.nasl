...
# extracted from Ubuntu Security Notice USN-5835-4. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5835-4");

  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS : Cinder vulnerability (USN-5835-4)");
...
in the USN-5835-4 advisory.

    USN-5835-1 fixed vulnerabilities in Cinder. This update provides the corresponding updates for Ubuntu
    18.04 LTS. In addition, a regression was fixed for Ubuntu 20.04 LTS.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5835-4");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'cinder-api', 'pkgver': '2:12.0.10-0ubuntu2.2'},
    {'osver': '18.04', 'pkgname': 'cinder-backup', 'pkgver': '2:12.0.10-0ubuntu2.2'},
    {'osver': '18.04', 'pkgname': 'cinder-common', 'pkgver': '2:12.0.10-0ubuntu2.2'},
    {'osver': '18.04', 'pkgname': 'cinder-scheduler', 'pkgver': '2:12.0.10-0ubuntu2.2'},
    {'osver': '18.04', 'pkgname': 'cinder-volume', 'pkgver': '2:12.0.10-0ubuntu2.2'},
    {'osver': '18.04', 'pkgname': 'python-cinder', 'pkgver': '2:12.0.10-0ubuntu2.2'},
    {'osver': '20.04', 'pkgname': 'cinder-api', 'pkgver': '2:16.4.2-0ubuntu2.2'},
    {'osver': '20.04', 'pkgname': 'cinder-backup', 'pkgver': '2:16.4.2-0ubuntu2.2'},
    {'osver': '20.04', 'pkgname': 'cinder-common', 'pkgver': '2:16.4.2-0ubuntu2.2'},
    {'osver': '20.04', 'pkgname': 'cinder-scheduler', 'pkgver': '2:16.4.2-0ubuntu2.2'},
    {'osver': '20.04', 'pkgname': 'cinder-volume', 'pkgver': '2:16.4.2-0ubuntu2.2'},
    {'osver': '20.04', 'pkgname': 'python3-cinder', 'pkgver': '2:16.4.2-0ubuntu2.2'}
];
