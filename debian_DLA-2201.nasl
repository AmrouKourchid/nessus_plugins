...
# extracted from Debian Security Advisory DLA-2201-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2201-1 : ntp security update");
...
address because transmissions were rescheduled even if a packet lacked
a valid 'origin timestamp'
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2020/05/msg00004.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/jessie/ntp");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"ntp", reference:"1:4.2.6.p5+dfsg-7+deb8u3")) flag++;
if (deb_check(release:"8.0", prefix:"ntp-doc", reference:"1:4.2.6.p5+dfsg-7+deb8u3")) flag++;
if (deb_check(release:"8.0", prefix:"ntpdate", reference:"1:4.2.6.p5+dfsg-7+deb8u3")) flag++;
