...
if (description)
{
  ...
  script_name(english:"OpenSSL 1.0.2 < 1.0.2zf Vulnerability");

  script_set_attribute(attribute:"synopsis", value:
"The remote service is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of OpenSSL installed on the remote host is prior to 1.0.2zf. It is, therefore, affected by a vulnerability
as referenced in the 1.0.2zf advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5b3cb0db");
...
var constraints = [
  { 'min_version' : '1.0.2', 'fixed_version' : '1.0.2zf' }
];
