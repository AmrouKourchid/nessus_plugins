...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : polkit (EulerOS-SA-2019-1070)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1070
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6d31d2ee");
...
pkgs = ["polkit-0.112-14.h5.eulerosv2r7",
        "polkit-devel-0.112-14.h5.eulerosv2r7",
        "polkit-docs-0.112-14.h5.eulerosv2r7"];
