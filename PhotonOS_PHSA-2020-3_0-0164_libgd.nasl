...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Libgd PHSA-2020-3.0-0164");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libgd-2.2.5-7.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libgd-devel-2.2.5-7.ph3')) flag++;
