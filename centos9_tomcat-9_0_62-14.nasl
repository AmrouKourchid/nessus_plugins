...
if (description)
{
  ...
  script_cve_id("CVE-2023-28708", "CVE-2023-28709");
  script_xref(name:"IAVA", value:"2023-A-0266-S");
  script_xref(name:"IAVA", value:"2023-A-0156-S");

  script_name(english:"CentOS 9 : tomcat-9.0.62-14.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing one or more security updates for tomcat.");
...
tomcat-9.0.62-14.el9 build changelog.

  - not including the secure attribute causes information (CVE-2023-28708)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=35629");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream tomcat package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:tomcat-java-jdk11");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:tomcat-java-jdk17");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:tomcat-java-jdk8");
...
var pkgs = [
    {'reference':'tomcat-9.0.62-14.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'tomcat-admin-webapps-9.0.62-14.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'tomcat-docs-webapp-9.0.62-14.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'tomcat-el-3.0-api-9.0.62-14.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'tomcat-java-jdk11-9.0.62-14.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'tomcat-java-jdk17-9.0.62-14.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'tomcat-java-jdk8-9.0.62-14.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'tomcat-jsp-2.3-api-9.0.62-14.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'tomcat-lib-9.0.62-14.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'tomcat-servlet-4.0-api-9.0.62-14.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'tomcat-webapps-9.0.62-14.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
