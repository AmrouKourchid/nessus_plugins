...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.0 : numpy (EulerOS-SA-2023-1720)");
...
affected by the following vulnerabilities :
  ...
  - Null Pointer Dereference vulnerability exists in numpy.sort in NumPy < and 1.19 in the PyArray_DescrNew
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1720
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?26de19f9");
