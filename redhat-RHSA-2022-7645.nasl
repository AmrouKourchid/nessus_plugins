...
# extracted from Red Hat Security Advisory RHSA-2022:7645. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:7645");

  script_name(english:"RHEL 8 : openjpeg2 (RHSA-2022:7645)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for openjpeg2.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2022:7645 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_7645.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d17e8e34");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:7645");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2067052");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL openjpeg2 package based on the guidance in RHSA-2022:7645.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openjpeg2-2.4.0-5.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openjpeg2-devel-2.4.0-5.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openjpeg2-devel-docs-2.4.0-5.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openjpeg2-tools-2.4.0-5.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
