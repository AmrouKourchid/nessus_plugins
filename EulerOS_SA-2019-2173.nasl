...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : netpbm (EulerOS-SA-2019-2173)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the version of the netpbm packages installed, the
EulerOS installation on the remote host is affected by the following
vulnerability :

  - The netpbm package contains a library of functions
    which support programs for handling various graphics
    file formats, including .pbm (portable bitmaps), .pgm
    (portable graymaps), .pnm (portable anymaps),.ppm
    (portable pixmaps) and others.Security Fix(es):The
    pm_mallocarray2 function in lib/util/mallocvar.c in
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2173
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?be3f2e22");
...
pkgs = ["netpbm-10.79.00-7.h1.eulerosv2r7",
        "netpbm-devel-10.79.00-7.h1.eulerosv2r7",
        "netpbm-progs-10.79.00-7.h1.eulerosv2r7"];
