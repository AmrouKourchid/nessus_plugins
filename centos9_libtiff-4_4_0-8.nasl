...
if (description)
{
  ...
  script_name(english:"CentOS 9 : libtiff-4.4.0-8.el9");
...
libtiff-4.4.0-8.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=32715");
...
var pkgs = [
    {'reference':'libtiff-4.4.0-8.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libtiff-devel-4.4.0-8.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libtiff-static-4.4.0-8.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libtiff-tools-4.4.0-8.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
