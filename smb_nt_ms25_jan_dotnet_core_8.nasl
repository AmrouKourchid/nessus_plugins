...
if (description)
{
  ...
  script_name(english:"Security Update for Microsoft .NET 8 Core (January 2025)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by a .NET Core vulnerability");
  script_set_attribute(attribute:"description", value:
"The version of Microsoft .NET 8 Core installed on the remote host is prior to 8.0.12. It is, therefore, affected by
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3f1a3f29");
  ...
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5050525");
