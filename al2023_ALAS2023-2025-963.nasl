...
# extracted from Amazon Linux 2023 Security Advisory ALAS2023-2025-963.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2023 : libxml2, libxml2-devel, libxml2-static (ALAS2023-2025-963)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2023/ALAS-2025-963.html");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/cve/html/CVE-2025-32414.html");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/cve/html/CVE-2025-32415.html");
...
var pkgs = [
    {'reference':'libxml2-2.10.4-1.amzn2023.0.10', 'cpu':'aarch64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libxml2-2.10.4-1.amzn2023.0.10', 'cpu':'x86_64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libxml2-debuginfo-2.10.4-1.amzn2023.0.10', 'cpu':'aarch64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libxml2-debuginfo-2.10.4-1.amzn2023.0.10', 'cpu':'x86_64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libxml2-debugsource-2.10.4-1.amzn2023.0.10', 'cpu':'aarch64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libxml2-debugsource-2.10.4-1.amzn2023.0.10', 'cpu':'x86_64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libxml2-devel-2.10.4-1.amzn2023.0.10', 'cpu':'aarch64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libxml2-devel-2.10.4-1.amzn2023.0.10', 'cpu':'x86_64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libxml2-static-2.10.4-1.amzn2023.0.10', 'cpu':'aarch64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libxml2-static-2.10.4-1.amzn2023.0.10', 'cpu':'x86_64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-libxml2-2.10.4-1.amzn2023.0.10', 'cpu':'aarch64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-libxml2-2.10.4-1.amzn2023.0.10', 'cpu':'x86_64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-libxml2-debuginfo-2.10.4-1.amzn2023.0.10', 'cpu':'aarch64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-libxml2-debuginfo-2.10.4-1.amzn2023.0.10', 'cpu':'x86_64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE}
];
