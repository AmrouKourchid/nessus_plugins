...
if (description)
{
  ...
  script_name(english:"Nutanix AOS : Multiple Vulnerabilities (NXSA-AOS-6.8.1.5)");

  script_set_attribute(attribute:"synopsis", value:
"The Nutanix AOS host is affected by multiple vulnerabilities .");
  script_set_attribute(attribute:"description", value:
"The version of AOS installed on the remote host is prior to 6.8.1.5. It is, therefore, affected by multiple
vulnerabilities as referenced in the NXSA-AOS-6.8.1.5 advisory.
...
number.");
  # https://portal.nutanix.com/page/documents/security-advisories/release-advisories/details?id=NXSA-AOS-6.8.1.5
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d674b23f");
...
var constraints = [
  { 'fixed_version' : '6.8.1.5', 'product' : 'AOS', 'fixed_display' : 'Upgrade the AOS install to 6.8.1.5 or higher.', 'lts' : FALSE },
  { 'fixed_version' : '6.8.1.5', 'product' : 'NDFS', 'fixed_display' : 'Upgrade the AOS install to 6.8.1.5 or higher.', 'lts' : FALSE }
];
