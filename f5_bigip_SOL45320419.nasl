...
# extracted from F5 Networks BIG-IP Solution K45320419.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2018-5514");

  script_name(english:"F5 Networks BIG-IP : TMM with HTTP/2 vulnerability (K45320419)");

  script_set_attribute(attribute:"synopsis", value:
"The remote device is missing a vendor-supplied security patch.");
  script_set_attribute(attribute:"description", value:
"Maliciously crafted HTTP/2 request frames can lead to denial of
...
devices configured as a high availability (HA) pair may fail over.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K45320419");
...
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K45320419.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-5514");
