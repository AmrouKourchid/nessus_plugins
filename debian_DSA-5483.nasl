...
# extracted from Debian Security Advisory dsa-5483. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-5483-1 : chromium - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2023/dsa-5483");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-4427");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-4428");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-4429");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-4430");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-4431");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'chromium', 'reference': '116.0.5845.110-1~deb11u1'},
    {'release': '11.0', 'prefix': 'chromium-common', 'reference': '116.0.5845.110-1~deb11u1'},
    {'release': '11.0', 'prefix': 'chromium-driver', 'reference': '116.0.5845.110-1~deb11u1'},
    {'release': '11.0', 'prefix': 'chromium-l10n', 'reference': '116.0.5845.110-1~deb11u1'},
    {'release': '11.0', 'prefix': 'chromium-sandbox', 'reference': '116.0.5845.110-1~deb11u1'},
    {'release': '11.0', 'prefix': 'chromium-shell', 'reference': '116.0.5845.110-1~deb11u1'},
    {'release': '12.0', 'prefix': 'chromium', 'reference': '116.0.5845.110-1~deb12u1'},
    {'release': '12.0', 'prefix': 'chromium-common', 'reference': '116.0.5845.110-1~deb12u1'},
    {'release': '12.0', 'prefix': 'chromium-driver', 'reference': '116.0.5845.110-1~deb12u1'},
    {'release': '12.0', 'prefix': 'chromium-l10n', 'reference': '116.0.5845.110-1~deb12u1'},
    {'release': '12.0', 'prefix': 'chromium-sandbox', 'reference': '116.0.5845.110-1~deb12u1'},
    {'release': '12.0', 'prefix': 'chromium-shell', 'reference': '116.0.5845.110-1~deb12u1'}
];
