...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : cloud-init (EulerOS-SA-2023-2805)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2805
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dab4b8d8");
...
var pkgs = [
  "cloud-init-19.4-2.h11.eulerosv2r10"
];
