...
# Red Hat Security Advisory RHSA-2023:0842. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : tar (CESA-2023:0842)");
...
var pkgs = [
    {'reference':'tar-1.30-6.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'tar-1.30-6.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
