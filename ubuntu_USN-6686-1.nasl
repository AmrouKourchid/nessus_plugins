...
# extracted from Ubuntu Security Notice USN-6686-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6686-1");

  script_name(english:"Ubuntu 20.04 LTS / 22.04 LTS : Linux kernel vulnerabilities (USN-6686-1)");
...
referenced in the USN-6686-1 advisory.

    It was discovered that the DesignWare USB3 for Qualcomm SoCs driver in the Linux kernel did not properly
    handle certain error conditions during device registration. A local attacker could possibly use this to
    cause a denial of service (system crash). (CVE-2023-22995)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6686-1");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.15.0-100-generic");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.15.0-100-generic-64k");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.15.0-100-generic-lpae");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.15.0-100-lowlatency");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.15.0-100-lowlatency-64k");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.15.0-1038-gkeop");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.15.0-1046-nvidia");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.15.0-1046-nvidia-lowlatency");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.15.0-1048-ibm");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.15.0-1052-gke");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.15.0-1053-gcp");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.15.0-1058-azure-fde");
...
var kernel_mappings = {
  '20.04': {
    '5.15.0': {
      'generic': '5.15.0-100',
      'generic-64k': '5.15.0-100',
      'generic-lpae': '5.15.0-100',
      'lowlatency': '5.15.0-100',
      'lowlatency-64k': '5.15.0-100',
      'gkeop': '5.15.0-1038',
      'ibm': '5.15.0-1048',
      'gcp': '5.15.0-1053',
      'azure-fde': '5.15.0-1058'
    }
  },
  '22.04': {
    '5.15.0': {
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-6686-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2023-4134', 'CVE-2023-6121', 'CVE-2023-22995', 'CVE-2023-46343', 'CVE-2023-46862', 'CVE-2023-51779', 'CVE-2023-51782', 'CVE-2024-0340', 'CVE-2024-0607');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-6686-1');
  }
  else
  {
