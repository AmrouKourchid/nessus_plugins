...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.0 : curl (EulerOS-SA-2024-1467)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1467
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5c0ed7ea");
...
var pkgs = [
  "curl-7.69.1-2.h25.eulerosv2r9",
  "libcurl-7.69.1-2.h25.eulerosv2r9"
];
