...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 ESM / 18.04 LTS : Linux kernel vulnerability (USN-5357-2)");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.15.0-1107-raspi2");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-5357-2');
}
