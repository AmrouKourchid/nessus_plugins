...
# extracted from Oracle Linux Security Advisory ELSA-2024-1435.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : postgresql-jdbc (ELSA-2024-1435)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
ELSA-2024-1435 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-1435.html");
...
var pkgs = [
    {'reference':'postgresql-jdbc-42.2.14-3.el8_9', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'postgresql-jdbc-javadoc-42.2.14-3.el8_9', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
