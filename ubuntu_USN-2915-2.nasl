...
# extracted from Ubuntu Security Notice USN-2915-2. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"2915-2");

  script_name(english:"Ubuntu 14.04 LTS : Django regression (USN-2915-2)");
...
USN-2915-2 advisory.
    ...
    USN-2915-1 fixed vulnerabilities in Django. The upstream fix for CVE-2016-2512 introduced a regression for
    certain applications. This update fixes the problem by applying the complete upstream regression fix.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2915-2");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'python-django', 'pkgver': '1.6.1-2ubuntu0.14'}
];
