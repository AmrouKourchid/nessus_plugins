...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Rpm PHSA-2017-1.0-0095");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'rpm-4.13.0.1-4.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'rpm-debuginfo-4.13.0.1-4.ph1')) flag++;
