...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_1022.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?abdc17b9");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:1022");
...
"Update the RHEL python-jinja2 package based on the guidance in RHSA-2019:1022.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python-jinja2-2.7.2-3.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
