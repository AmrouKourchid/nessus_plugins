...
# extracted from Fedora Security Advisory FEDORA-2023-ed41d3a922
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-ed41d3a922");

  script_name(english:"Fedora 38 : firefox (2023-ed41d3a922)");
...
FEDORA-2023-ed41d3a922 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-ed41d3a922");
...
var pkgs = [
    {'reference':'firefox-111.0-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
