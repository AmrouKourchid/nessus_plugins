...
# extracted from Fedora Security Advisory FEDORA-2024-01a020d192
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-01a020d192");

  script_name(english:"Fedora 40 : python3.6 (2024-01a020d192)");
...
FEDORA-2024-01a020d192 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-01a020d192");
...
var pkgs = [
    {'reference':'python3.6-3.6.15-34.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
