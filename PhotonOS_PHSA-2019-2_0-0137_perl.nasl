...
if (description)
{
  ...
  script_cve_id("CVE-2018-18312", "CVE-2018-18314");
  script_xref(name:"IAVA", value:"2018-A-0407-S");
  script_xref(name:"IAVA", value:"2020-A-0328");

  script_name(english:"Photon OS 2.0: Perl PHSA-2019-2.0-0137");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'perl-5.24.1-8.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'perl-debuginfo-5.24.1-8.ph2')) flag++;
