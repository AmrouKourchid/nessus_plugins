...
if (description)
{
  ...
  script_name(english:"Adobe Media Encoder < 15.2 Privilege escalation (APSB21-32) (macOS)");
...
"The version of Adobe Media Encoder installed on the remote macOS host is prior to 15.2. It is, therefore, affected by a
vulnerability as referenced in the APSB21-32 advisory.
