...
# extracted from Fedora Security Advisory FEDORA-2023-51706f88e3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-51706f88e3");

  script_name(english:"Fedora 39 : python-cryptography (2023-51706f88e3)");
...
FEDORA-2023-51706f88e3 advisory.
    ...
    * Wed Feb 22 2023 Christian Heimes <cheimes@redhat.com> - 37.0.2-8
    ...
    - Fix FTBFS due to failing test_load_invalid_ec_key_from_pem and test_decrypt_invalid_decrypt, resolves
    rhbz#2171661
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-51706f88e3");
...
var pkgs = [
    {'reference':'python-cryptography-37.0.2-8.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
