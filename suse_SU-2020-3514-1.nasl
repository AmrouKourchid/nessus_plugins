...
# extracted from SUSE update advisory SUSE-SU-2020:3514-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : ucode-intel (SUSE-SU-2020:3514-1)");
...
5-v3- spec-update.html?wapkw=processor+spec+update+e5) for details.
  ...
  - Update for functional issues. Refer to [10th Gen
    Intel&Acirc;&reg; Core&acirc;&#132;&cent; Processor
...
rs/co re/8th-gen-core-spec-update.html) for details.
  ...
  - Update for functional issues. Refer to [7th Gen and 8th
    Gen (U Quad-Core) Intel&Acirc;&reg; Processor Families
    Specification
...
n-cor e-family-spec-update.html) for details.
  ...
  - Update for functional issues. Refer to [6th Gen
    Intel&Acirc;&reg; Processor Family Specification
    Update](https://cdrdv2.intel.com/v1/dl/getContent/332689
    ) for details.

  - Update for functional issues. Refer to
    [Intel&Acirc;&reg; Xeon&Acirc;&reg; E3-1200 v6 Processor
    Family Specification
...
3-120 0v6-spec-update.html) for details.
  ...
  - Update for functional issues. Refer to
    [Intel&Acirc;&reg; Xeon&Acirc;&reg; E-2100 and E-2200
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=1173592");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=1173594");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=1178971");
  script_set_attribute(attribute:"see_also", value:"https://cdrdv2.intel.com/v1/dl/getContent/332689");
  script_set_attribute(attribute:"see_also", value:"https://cdrdv2.intel.com/v1/dl/getContent/338848");
  script_set_attribute(attribute:"see_also", value:"https://cdrdv2.intel.com/v1/dl/getContent/613537");
  script_set_attribute(attribute:"see_also", value:"https://www.intel.com/content/www/us/en/processors/core/7th-gen-cor");
  script_set_attribute(attribute:"see_also", value:"https://www.intel.com/content/www/us/en/processors/xeon/xeon-e3-120");
  script_set_attribute(attribute:"see_also", value:"https://www.intel.com/content/www/us/en/processors/xeon/xeon-e5-v3-");
  script_set_attribute(attribute:"see_also", value:"https://www.intel.com/content/www/us/en/products/docs/processors/co");
  script_set_attribute(attribute:"see_also", value:"https://www.intel.com/content/www/us/en/products/docs/processors/xe");
  script_set_attribute(attribute:"see_also", value:"https://www.intel.com/content/www/us/en/security-center/ad");
  ...
  # https://www.suse.com/support/update/announcement/2020/suse-su-20203514-1
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8118df0d");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"4", cpu:"x86_64", reference:"ucode-intel-20201118-13.81.1")) flag++;
if (rpm_check(release:"SLES12", sp:"4", cpu:"x86_64", reference:"ucode-intel-debuginfo-20201118-13.81.1")) flag++;
if (rpm_check(release:"SLES12", sp:"4", cpu:"x86_64", reference:"ucode-intel-debugsource-20201118-13.81.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", cpu:"x86_64", reference:"ucode-intel-20201118-13.81.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", cpu:"x86_64", reference:"ucode-intel-debuginfo-20201118-13.81.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", cpu:"x86_64", reference:"ucode-intel-debugsource-20201118-13.81.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"ucode-intel-20201118-13.81.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"ucode-intel-debuginfo-20201118-13.81.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"ucode-intel-debugsource-20201118-13.81.1")) flag++;
