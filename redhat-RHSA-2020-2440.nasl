...
"The remote Red Hat host is missing a security update for OpenShift Container Platform 4.3.25 openshift.");
...
in the RHSA-2020:2440 advisory.
    ...
    * kubernetes: A server side request forgery (SSRF) in the kube-controller-manager allows certain
    authorized users to leak up to 500 bytes of arbitrary information from the master's host network
    (CVE-2020-8555)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_2440.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?51f85f7e");
...
"Update the RHEL OpenShift Container Platform 4.3.25 openshift package based on the guidance in RHSA-2020:2440.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openshift-hyperkube-4.3.25-202006060952.git.1.96c30f6.el8', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
  ...
  },
  {
    ...
    'pkgs': [
      {'reference':'openshift-hyperkube-4.3.25-202006060952.git.1.96c30f6.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
