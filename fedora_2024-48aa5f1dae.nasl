...
# extracted from Fedora Security Advisory FEDORA-2024-48aa5f1dae
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-48aa5f1dae");

  script_name(english:"Fedora 40 : gh (2024-48aa5f1dae)");
...
FEDORA-2024-48aa5f1dae advisory.

    Automatic update for gh-2.41.0-1.fc40.

    ##### **Changelog**

    ```
    * Mon Jan  8 2024 Mikel Olasagasti Uranga <mikel@olasagasti.info> - 2.41.0-1
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-48aa5f1dae");
...
var pkgs = [
    {'reference':'gh-2.41.0-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
