...
# extracted from Fedora Security Advisory FEDORA-2024-2e8c63e8bf
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-2e8c63e8bf");

  script_name(english:"Fedora 41 : buildah / podman (2024-2e8c63e8bf)");
...
FEDORA-2024-2e8c63e8bf advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-2e8c63e8bf");
  script_set_attribute(attribute:"solution", value:
"Update the affected 2:buildah and / or 5:podman packages.");
...
var pkgs = [
    {'reference':'buildah-1.37.4-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'podman-5.2.4-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'epoch':'5'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'buildah / podman');
}
