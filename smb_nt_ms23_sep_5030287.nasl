...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5030269");
  script_xref(name:"MSKB", value:"5030287");
  script_xref(name:"MSFT", value:"MS23-5030269");
  script_xref(name:"MSFT", value:"MS23-5030287");
  script_xref(name:"IAVA", value:"2023-A-0472-S");
  script_xref(name:"IAVA", value:"2023-A-0471-S");

  script_name(english:"KB5030287: Windows Server 2012 R2 Security Update (September 2023)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5030287. It is, therefore, affected by multiple vulnerabilities
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5030269");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5030287");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5030287 or Cumulative Update 5030269");
...
# Win 8.1 is EOS since Jan 10, 2023
...
if (
  smb_check_rollup(os:'6.3',
                   ...
                   rollup_date:'09_2023',
                   bulletin:bulletin,
                   rollup_kb_list:[5030287, 5030269])
)
{
