...
# extracted from Fedora Security Advisory FEDORA-2023-84ee781688
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-84ee781688");

  script_name(english:"Fedora 38 : matrix-synapse (2023-84ee781688)");
...
FEDORA-2023-84ee781688 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-84ee781688");
...
var pkgs = [
    {'reference':'matrix-synapse-1.93.0-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
