...
# extracted from Fedora Security Advisory FEDORA-2023-b7efbdc392
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-b7efbdc392");

  script_name(english:"Fedora 38 : chromium (2023-b7efbdc392)");
...
FEDORA-2023-b7efbdc392 advisory.

    Update to 114.0.5735.198. Fixes the following security issues:

    CVE-2023-3420 CVE-2023-3421 CVE-2023-3422 CVE-2023-36191
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-b7efbdc392");
...
var pkgs = [
    {'reference':'chromium-114.0.5735.198-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
