...
# extracted from Gentoo Linux Security Advisory GLSA 202003-58.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202003-58");

  script_name(english:"GLSA-202003-58 : UnZip: User-assisted execution of arbitrary code");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202003-58
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202003-58");
...
if (qpkg_check(package:"app-arch/unzip", unaffected:make_list("ge 6.0_p25"), vulnerable:make_list("lt 6.0_p25"))) flag++;
