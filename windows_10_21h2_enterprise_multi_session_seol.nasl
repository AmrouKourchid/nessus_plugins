...
if (description)
{
  ...
  script_name(english:"Microsoft Windows 10 21H2 Enterprise Multi Session SEoL");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Microsoft Windows is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"Microsoft Windows 10 21H2 Enterprise Multi Session is no longer maintained by its vendor or provider.
...
var constraints = [
  { seol : 20240611, cpe_attributes : [{'edition': 'enterprise_multi_session'}] }
];
