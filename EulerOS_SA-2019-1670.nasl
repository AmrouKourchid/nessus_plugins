...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : util-linux (EulerOS-SA-2019-1670)");
...
vulnerability :
  ...
  - Blkid in util-linux before 2.26rc-1 allows local users
    to execute arbitrary code.(CVE-2014-9114)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1670
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?03e814a1");
...
pkgs = ["libblkid-2.23.2-52.1.h5.eulerosv2r7",
        "libblkid-devel-2.23.2-52.1.h5.eulerosv2r7",
        "libmount-2.23.2-52.1.h5.eulerosv2r7",
        "libuuid-2.23.2-52.1.h5.eulerosv2r7",
        "libuuid-devel-2.23.2-52.1.h5.eulerosv2r7",
        "util-linux-2.23.2-52.1.h5.eulerosv2r7",
        "uuidd-2.23.2-52.1.h5.eulerosv2r7"];
