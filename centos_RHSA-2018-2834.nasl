...
# extracted from Red Hat Security Advisory RHSA-2018:2834 and 
# CentOS Errata and Security Advisory 2018:2834 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : firefox (CESA-2018:2834)");
...
issues. Upstream acknowledges Philipp and Jurgen Gaeremyn as the
original reporters.");
  # https://lists.centos.org/pipermail/centos-announce/2018-September/023026.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?19e4b5e6");
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"firefox-60.2.1-1.el6.centos", allowmaj:TRUE)) flag++;
