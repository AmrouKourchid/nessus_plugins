...
if (description)
{
  ...
  script_cve_id("CVE-2024-53681");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-53681");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: nvmet: Don't overflow subsysnqn
    nvmet_root_discovery_nqn_store treats the subsysnqn string like a fixed size buffer, even though it is
    dynamically allocated to the size of the string. Create a new string with kstrndup instead of using the
    old buffer. (CVE-2024-53681)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-53681");
