...
# extracted from Fedora Security Advisory FEDORA-2022-20a2dbdd45
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-20a2dbdd45");

  script_name(english:"Fedora 36 : python-slixmpp (2022-20a2dbdd45)");
...
FEDORA-2022-20a2dbdd45 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-20a2dbdd45");
...
var pkgs = [
    {'reference':'python-slixmpp-1.8.3-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
