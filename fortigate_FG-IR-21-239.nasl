...
if (description)
{
  ...
  script_name(english:"Fortinet Fortigate Lack of certificate verification when establishing secure connections to external end-points (FG-IR-21-239)");
...
vulnerability as referenced in the FG-IR-21-239 advisory.

  - An improper certificate validation vulnerability [CWE-295] in FortiOS 6.0.0 through 6.0.14, 6.2.0 through
    6.2.10, 6.4.0 through 6.4.8, 7.0.0 may allow a network adjacent and unauthenticated attacker to man-in-
    the-middle the communication between the FortiGate and some peers such as private SDNs and external cloud
    platforms. (CVE-2022-22306)
...
"Please upgrade to FortiOS version 6.4.9/7.0.1 or later.");
...
var constraints = [
  { 'min_version' : '6.0.0', 'max_version' : '6.0.14', 'fixed_version' : '6.4.9' },
  { 'min_version' : '6.2.0', 'max_version' : '6.2.10', 'fixed_version' : '6.4.9' },
