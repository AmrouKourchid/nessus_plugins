...
# extracted from Debian Security Advisory dla-4036. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-4036 : debian-security-support - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has a package installed that is affected by a vulnerability as referenced in the dla-4036
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bullseye/debian-security-support");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'debian-security-support', 'reference': '1:11+2025.01.30'}
];
