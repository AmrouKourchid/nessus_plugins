...
# Oracle Linux Security Advisory ELSA-2008-0214 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : squid (ELSA-2008-0214)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2008-0214.html");
