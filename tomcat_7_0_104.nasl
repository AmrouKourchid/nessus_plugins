...
if (description)
{
  ...
  script_name(english:"Apache Tomcat 7.0.0 < 7.0.104");

  script_set_attribute(attribute:"synopsis", value:
"The remote Apache Tomcat server is affected by a vulnerability");
  script_set_attribute(attribute:"description", value:
"The version of Tomcat installed on the remote host is prior to 7.0.104. It is, therefore, affected by a vulnerability as
referenced in the fixed_in_apache_tomcat_7.0.104_security-7 advisory.
...
var constraints = [
  { 'min_version' : '7.0.0', 'fixed_version' : '7.0.104' }
];
