...
# extracted from Fedora Security Advisory FEDORA-2023-b2e5612471
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-b2e5612471");

  script_name(english:"Fedora 38 : roundcubemail (2023-b2e5612471)");
...
FEDORA-2023-b2e5612471 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-b2e5612471");
...
var pkgs = [
    {'reference':'roundcubemail-1.6.3-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
