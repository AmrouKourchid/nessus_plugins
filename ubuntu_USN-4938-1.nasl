...
referenced in the USN-4938-1 advisory.
    ...
    It was discovered that Unbound contained multiple security issues. A remote attacker could possibly use
    these issues to cause a denial of service, inject arbitrary commands, execute arbitrary code, and
