...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : cups (EulerOS-SA-2020-1501)");
...
vulnerability :
  ...
  - In array_find of array.c, there is a possible
    out-of-bounds read due to an incorrect bounds check.
    This could lead to local information disclosure in the
    printer spooler with no additional execution privileges
    needed. User interaction is not needed for
    exploitation.Product: AndroidVersions: Android-8.0
    Android-8.1 Android-9 Android-10Android ID:
    A-111210196(CVE-2019-2228)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1501
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e0977ce9");
...
pkgs = ["cups-2.2.8-5.h4.eulerosv2r8",
        "cups-client-2.2.8-5.h4.eulerosv2r8",
        "cups-devel-2.2.8-5.h4.eulerosv2r8",
        "cups-filesystem-2.2.8-5.h4.eulerosv2r8",
        "cups-libs-2.2.8-5.h4.eulerosv2r8",
        "cups-lpd-2.2.8-5.h4.eulerosv2r8"];
