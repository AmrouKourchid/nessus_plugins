...
# extracted from Fedora Security Advisory FEDORA-2023-12504e8774
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-12504e8774");

  script_name(english:"Fedora 37 : golang (2023-12504e8774)");
...
FEDORA-2023-12504e8774 advisory.

    go1.19.9 (released 2023-05-02) includes three security fixes to the html/template package, as well as bug
    fixes to the compiler, the runtime, and the crypto/tls and syscall packages. [See the milestone on the
    issue tracker for
    details](https://github.com/golang/go/issues?q=milestone%3AGo1.19.9+label%3ACherryPickApproved).
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-12504e8774");
...
var pkgs = [
    {'reference':'golang-1.19.9-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
