...
# extracted from Red Hat Security Advisory RHSA-2022:7187. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:7187");

  script_name(english:"RHEL 8 : device-mapper-multipath (RHSA-2022:7187)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_7187.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e4c9aca4");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:7187");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2133988");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL device-mapper-multipath package based on the guidance in RHSA-2022:7187.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'device-mapper-multipath-0.8.0-5.el8_1.1', 'sp':'1', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'device-mapper-multipath-0.8.0-5.el8_1.1', 'sp':'1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
