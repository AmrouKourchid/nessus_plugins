...
# extracted from Red Hat Security Advisory RHSA-2024:9158. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:9158");

  script_name(english:"RHEL 9 : lldpd (RHSA-2024:9158)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for lldpd.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:9158 advisory.

    LLDP is an industry standard protocol designed to supplant proprietary Link-Layer protocols such as EDP or
    CDP. The goal of LLDP is to provide an inter-vendor compatible mechanism to deliver Link-Layer
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-22127");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-25990");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-5787");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_9158.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5d7ef345");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:9158");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL lldpd package based on the guidance in RHSA-2024:9158.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:lldpd");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:lldpd-devel");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'lldpd-1.0.18-4.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'lldpd-devel-1.0.18-4.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'lldpd / lldpd-devel');
}
