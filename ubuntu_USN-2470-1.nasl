...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : Git vulnerability (USN-2470-1)");
...
USN-2470-1 advisory.
    ...
    Matt Mackall and Augie Fackler discovered that Git incorrectly handled certain filesystem paths. A remote
    attacker could possibly use this issue to execute arbitrary code if the Git tree is stored in an HFS+ or
    NTFS filesystem. The remote attacker would need write access to a Git repository that the victim pulls
    from.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2470-1");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-9390");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'git', 'pkgver': '1:1.9.1-1ubuntu0.1'},
    {'osver': '14.04', 'pkgname': 'git-all', 'pkgver': '1:1.9.1-1ubuntu0.1'},
    {'osver': '14.04', 'pkgname': 'git-arch', 'pkgver': '1:1.9.1-1ubuntu0.1'},
    {'osver': '14.04', 'pkgname': 'git-bzr', 'pkgver': '1:1.9.1-1ubuntu0.1'},
    {'osver': '14.04', 'pkgname': 'git-core', 'pkgver': '1:1.9.1-1ubuntu0.1'},
    {'osver': '14.04', 'pkgname': 'git-cvs', 'pkgver': '1:1.9.1-1ubuntu0.1'},
    {'osver': '14.04', 'pkgname': 'git-daemon-run', 'pkgver': '1:1.9.1-1ubuntu0.1'},
    {'osver': '14.04', 'pkgname': 'git-daemon-sysvinit', 'pkgver': '1:1.9.1-1ubuntu0.1'},
    {'osver': '14.04', 'pkgname': 'git-el', 'pkgver': '1:1.9.1-1ubuntu0.1'},
    {'osver': '14.04', 'pkgname': 'git-email', 'pkgver': '1:1.9.1-1ubuntu0.1'},
    {'osver': '14.04', 'pkgname': 'git-gui', 'pkgver': '1:1.9.1-1ubuntu0.1'},
    {'osver': '14.04', 'pkgname': 'git-man', 'pkgver': '1:1.9.1-1ubuntu0.1'},
    {'osver': '14.04', 'pkgname': 'git-mediawiki', 'pkgver': '1:1.9.1-1ubuntu0.1'},
    {'osver': '14.04', 'pkgname': 'git-svn', 'pkgver': '1:1.9.1-1ubuntu0.1'},
    {'osver': '14.04', 'pkgname': 'gitk', 'pkgver': '1:1.9.1-1ubuntu0.1'},
    {'osver': '14.04', 'pkgname': 'gitweb', 'pkgver': '1:1.9.1-1ubuntu0.1'}
];
