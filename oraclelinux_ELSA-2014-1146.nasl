...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2014-1146.html");
  script_set_attribute(attribute:"solution", value:
"Update the affected httpcomponents-client and / or httpcomponents-client-javadoc packages.");
...
var pkgs = [
    {'reference':'httpcomponents-client-4.2.5-5.el7_0', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'httpcomponents-client-javadoc-4.2.5-5.el7_0', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
];
