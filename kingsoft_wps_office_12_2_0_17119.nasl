...
if (description)
{
  ...
  script_cve_id("CVE-2024-7263");
  script_xref(name:"IAVB", value:"2024-B-0129");

  script_name(english:"Kingsoft WPS Office 12.2.0.13110 < 12.2.0.17119 Arbitrary Code Execution (CVE-2024-7263)");
...
12.2.0.17119. It is, therefore, affected by an arbitrary code execution vulnerability:

  - Improper path validation in promecefpluginhost.exe in Kingsoft WPS Office version ranging from 12.2.0.13110 to
    12.2.0.17115 (exclusive) on Windows allows an attacker to load an arbitrary Windows library. The patch released in 
    version 12.1.0.17119 to mitigate CVE-2024-7262 was not restrictive enough. Another parameter was not properly
    sanitized which leads to the execution of an arbitrary Windows library. (CVE-2024-7263)
...
"Upgrade to Kingsoft WPS Office 12.2.0.17119 or later.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:N/UI:R/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-7263");
...
var constraints = [
  { 'min_version':'12.2.0.13110', 'fixed_version' : '12.2.0.17119' }
];
