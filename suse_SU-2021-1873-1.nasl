...
# SUSE update advisory SUSE-SU-2021:1873-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2021:1873-1");

  script_name(english:"SUSE SLES12 Security Update : gstreamer-plugins-bad (SUSE-SU-2021:1873-1)");
...
in the SUSE-SU-2021:1873-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2021-June/008941.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fba171ec");
  script_set_attribute(attribute:"solution", value:
"Update the affected libgstegl-1_0-0 package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:suse_linux:libgstegl-1_0-0");
...
var pkgs = [
    {'reference':'libgstegl-1_0-0-1.2.4-3.7', 'sp':'2', 'cpu':'x86_64', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.2']},
    {'reference':'libgstegl-1_0-0-1.2.4-3.7', 'sp':'2', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.2']}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libgstegl-1_0-0');
}
