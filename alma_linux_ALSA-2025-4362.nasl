...
# AlmaLinux Security Advisory ALSA-2025:4362.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2025:4362");
  script_xref(name:"RHSA", value:"2025:4362");

  script_name(english:"AlmaLinux 8 : ghostscript (ALSA-2025:4362)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ALSA-2025:4362 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2025-4362.html");
...
"Update the affected packages.");
  ...
  script_cwe_id(119, 120, 125, 190, 22, 416, 824);
...
var pkgs = [
    {'reference':'ghostscript-9.27-16.el8_10', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'ghostscript-doc-9.27-16.el8_10', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'ghostscript-tools-dvipdf-9.27-16.el8_10', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'ghostscript-tools-fonts-9.27-16.el8_10', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'ghostscript-tools-printing-9.27-16.el8_10', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'ghostscript-x11-9.27-16.el8_10', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'libgs-9.27-16.el8_10', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'libgs-devel-9.27-16.el8_10', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'}
];
