...
# extracted from Red Hat Security Advisory RHSA-2023:6632. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:6632");

  script_name(english:"RHEL 9 : shadow-utils (RHSA-2023:6632)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6632.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7a3c0647");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2179987");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2179988");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2215945");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6632");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL shadow-utils package based on the guidance in RHSA-2023:6632.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'shadow-utils-4.9-8.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'shadow-utils-subid-4.9-8.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'shadow-utils-subid-devel-4.9-8.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
    ]
  }
];
