...
# extracted from Fedora Security Advisory FEDORA-2023-3f70b8d406
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-3f70b8d406");
  script_xref(name:"CEA-ID", value:"CEA-2024-0004");

  script_name(english:"Fedora 39 : nghttp2 (2023-3f70b8d406)");
...
FEDORA-2023-3f70b8d406 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-3f70b8d406");
...
var pkgs = [
    {'reference':'nghttp2-1.55.1-4.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
