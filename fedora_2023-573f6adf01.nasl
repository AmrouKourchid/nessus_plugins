...
# extracted from Fedora Security Advisory FEDORA-2023-573f6adf01
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-573f6adf01");

  script_name(english:"Fedora 36 : digikam (2023-573f6adf01)");
...
FEDORA-2023-573f6adf01 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-573f6adf01");
...
var pkgs = [
    {'reference':'digikam-8.0.0-2.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
