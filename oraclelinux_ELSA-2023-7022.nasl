...
# extracted from Oracle Linux Security Advisory ELSA-2023-7022.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : tang (ELSA-2023-7022)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-7022.html");
