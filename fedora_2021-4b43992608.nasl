...
# extracted from Fedora Security Advisory FEDORA-2021-4b43992608
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-4b43992608");

  script_name(english:"Fedora 33 : upx (2021-4b43992608)");
...
FEDORA-2021-4b43992608 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-4b43992608");
...
pkgs = [
    {'reference':'upx-3.96-8.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
