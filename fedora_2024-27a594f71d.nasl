...
# extracted from Fedora Security Advisory FEDORA-2024-27a594f71d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-27a594f71d");

  script_name(english:"Fedora 39 : cacti / cacti-spine (2024-27a594f71d)");
...
FEDORA-2024-27a594f71d advisory.

    Update cacti and cacti-spine to version 1.2.27. This includes the upstream fixes for many CVEs, including
    a critical remote code execution bug.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-27a594f71d");
...
var pkgs = [
    {'reference':'cacti-1.2.27-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cacti-spine-1.2.27-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
