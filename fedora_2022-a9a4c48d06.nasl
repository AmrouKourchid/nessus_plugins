...
# extracted from Fedora Security Advisory FEDORA-2022-a9a4c48d06
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-a9a4c48d06");

  script_name(english:"Fedora 37 : python3-docs / python3.11 (2022-a9a4c48d06)");
...
FEDORA-2022-a9a4c48d06 advisory.

    The final release of Python 3.11.0.

    Contains security fix for CVE-2022-42919.

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-a9a4c48d06");
  script_set_attribute(attribute:"solution", value:
"Update the affected python3-docs and / or python3.11 packages.");
...
var pkgs = [
    {'reference':'python3-docs-3.11.0-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3.11-3.11.0-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python3-docs / python3.11');
}
