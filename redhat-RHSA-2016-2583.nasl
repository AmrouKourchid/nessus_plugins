...
referenced in the RHSA-2016:2583 advisory.
    ...
    * It was found that NTP's :config command could be used to set the pidfile and driftfile paths without any
    ...
    (in hourly intervals). (CVE-2015-5196, CVE-2015-7703)
    ...
    * A flaw was found in the way NTP verified trusted keys during symmetric key authentication. An
    authenticated client (A) could use this flaw to modify a packet sent between a server (B) and a client (C)
    using a key that is different from the one known to the client (A). (CVE-2015-7974)

    * A flaw was found in the way the ntpq client processed certain incoming packets in a loop in the
    getresponse() function. A remote attacker could potentially use this flaw to crash an ntpq client
...
number.");
  ...
  # https://access.redhat.com/security/data/csaf/v2/advisories/2016/rhsa-2016_2583.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?50cd055a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2016:2583");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1242553");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1297471");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1300273");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL ntp package based on the guidance in RHSA-2016:2583.");
  ...
  script_cwe_id(121, 193, 20, 304, 401, 476, 73, 787, 835);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ntp-4.2.6p5-25.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ntp-doc-4.2.6p5-25.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ntp-perl-4.2.6p5-25.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ntpdate-4.2.6p5-25.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sntp-4.2.6p5-25.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
