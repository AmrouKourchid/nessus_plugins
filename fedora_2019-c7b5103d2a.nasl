...
# extracted from Fedora Security Advisory FEDORA-2019-c7b5103d2a.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-c7b5103d2a");

  script_name(english:"Fedora 30 : unbound (2019-c7b5103d2a)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"Fix for CVE-2019-18934 and misc other security items

Note that Tenable Network Security has extracted the preceding
description block directly from the Fedora update system website.
Tenable has attempted to automatically clean and format it as much as
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-c7b5103d2a");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"unbound-1.9.6-1.fc30")) flag++;
