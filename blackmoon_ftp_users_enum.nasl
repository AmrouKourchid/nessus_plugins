...
which can be used to mount further attacks." );
 ...
 script_set_attribute(attribute:"cvss_score_source", value: "CVE-2003-0343");
...
close(soc);
if("530-Account does not exist" >< r)
