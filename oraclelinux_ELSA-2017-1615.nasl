...
ELSA-2017-1615 advisory.
    ...
    - [fs] nfsd: stricter decoding of write-like NFSv2/v3 ops ('J. Bruce Fields') [1449282 1443204]
    {CVE-2017-7895}
    ...
    - [x86] kvm: x86: fix emulation of 'MOV SS, null selector' (Radim Krcmar) [1414742 1414743]
    {CVE-2017-2583}
...
var pkgs = [
    ...
    {'reference':'kernel-abi-whitelists-3.10.0-514.26.1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-abi-whitelists-3.10.0'},
