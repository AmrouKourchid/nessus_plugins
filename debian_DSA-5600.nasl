...
# extracted from Debian Security Advisory dsa-5600. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5600 : php-phpseclib - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 / 12 host has a package installed that is affected by a vulnerability as referenced in the dsa-5600
advisory.
    ...
    - -------------------------------------------------------------------------
    Debian Security Advisory DSA-5600-1                   security@debian.org
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bookworm/php-phpseclib");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bullseye/php-phpseclib");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'php-phpseclib', 'reference': '2.0.30-2+deb11u1'},
    {'release': '12.0', 'prefix': 'php-phpseclib', 'reference': '2.0.42-1+deb12u1'}
];
