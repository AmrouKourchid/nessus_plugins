...
if (description)
{
  ...
  script_cve_id("CVE-2023-52498");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2023-52498");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: PM: sleep: Fix possible deadlocks in
    ...
    functions and to directly run them synchronously if async_schedule_dev_nocall() returns false.
    (CVE-2023-52498)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-52498");
