...
# extracted from Red Hat Security Advisory RHSA-2023:0600 and
# CentOS Errata and Security Advisory 2023:0600 respectively.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : thunderbird (RHSA-2023:0600)");
...
var pkgs = [
    {'reference':'thunderbird-102.7.1-2.el7.centos', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'thunderbird-102.7.1-2.el7.centos', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
