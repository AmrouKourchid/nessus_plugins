...
# extracted from Fedora Security Advisory FEDORA-2025-7c4a6154e5
#
...
if (description)
{
  ...
  script_cve_id("CVE-2024-53868");
  script_xref(name:"FEDORA", value:"2025-7c4a6154e5");

  script_name(english:"Fedora 41 : trafficserver (2025-7c4a6154e5)");
...
FEDORA-2025-7c4a6154e5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-7c4a6154e5");
...
"Update the affected trafficserver package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-53868");
...
var pkgs = [
    {'reference':'trafficserver-9.2.10-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
