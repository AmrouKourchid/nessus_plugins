...
if (description)
{
  ...
  script_name(english:"openSUSE SEoL (11.0.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of openSUSE is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, openSUSE is 11.0.x. It is, therefore, no longer maintained by its vendor or provider.
...
"Upgrade to a version of openSUSE that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2010/07/26");
...
var constraints = [
  { max_branch : '11.0', min_branch : '11.0', seol : 20100726 }
];
