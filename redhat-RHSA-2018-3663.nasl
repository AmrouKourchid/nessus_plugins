...
# extracted from Red Hat Security Advisory RHSA-2018:3663. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : sos-collector (RHSA-2018:3663)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for sos-collector.");
...
the RHSA-2018:3663 advisory.

    sos-collector is a utility that gathers sosreports from multi-node environments. sos-collector facilitates
    data collection for support cases and it can be run from either a node or from an administrator's local
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_3663.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e0713a66");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:3663");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1633243");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL sos-collector package based on the guidance in RHSA-2018:3663.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:sos-collector");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'sos-collector-1.5-3.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
