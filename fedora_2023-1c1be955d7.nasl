...
# extracted from Fedora Security Advisory FEDORA-2023-1c1be955d7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-1c1be955d7");

  script_name(english:"Fedora 40 : golang-github-onsi-ginkgo-2 (2023-1c1be955d7)");
...
FEDORA-2023-1c1be955d7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-1c1be955d7");
...
var pkgs = [
    {'reference':'golang-github-onsi-ginkgo-2-2.13.2-3.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
