...
# extracted from Debian Security Advisory dsa-5714. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5714 : roundcube - security update");
...
dsa-5714 advisory.
    ...
    Huy Nguyn Phm Nht, and Valentin T. and Lutz Wolf of CrowdStrike,
...
var pkgs = [
    {'release': '11.0', 'prefix': 'roundcube', 'reference': '1.4.15+dfsg.1-1+deb11u3'},
    {'release': '11.0', 'prefix': 'roundcube-core', 'reference': '1.4.15+dfsg.1-1+deb11u3'},
    {'release': '11.0', 'prefix': 'roundcube-mysql', 'reference': '1.4.15+dfsg.1-1+deb11u3'},
    {'release': '11.0', 'prefix': 'roundcube-pgsql', 'reference': '1.4.15+dfsg.1-1+deb11u3'},
    {'release': '11.0', 'prefix': 'roundcube-plugins', 'reference': '1.4.15+dfsg.1-1+deb11u3'},
    {'release': '11.0', 'prefix': 'roundcube-sqlite3', 'reference': '1.4.15+dfsg.1-1+deb11u3'},
    {'release': '12.0', 'prefix': 'roundcube', 'reference': '1.6.5+dfsg-1+deb12u2'},
    {'release': '12.0', 'prefix': 'roundcube-core', 'reference': '1.6.5+dfsg-1+deb12u2'},
    {'release': '12.0', 'prefix': 'roundcube-mysql', 'reference': '1.6.5+dfsg-1+deb12u2'},
    {'release': '12.0', 'prefix': 'roundcube-pgsql', 'reference': '1.6.5+dfsg-1+deb12u2'},
    {'release': '12.0', 'prefix': 'roundcube-plugins', 'reference': '1.6.5+dfsg-1+deb12u2'},
    {'release': '12.0', 'prefix': 'roundcube-sqlite3', 'reference': '1.6.5+dfsg-1+deb12u2'}
];
