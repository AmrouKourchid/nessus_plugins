...
# extracted from Fedora Security Advisory FEDORA-2023-f2be748f28
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-f2be748f28");

  script_name(english:"Fedora 37 : php-phpmailer6 (2023-f2be748f28)");
...
FEDORA-2023-f2be748f28 advisory.

    Minor security note

    * The DSN support added in 6.8.0 reflects the DSN back to the user in an error message if it is invalid.
    If a DSN uses user-supplied input (a very bad idea), it opens a distant possibility of XSS if the host app
    does not escape output. In an abundance of caution, malformed DSNs are no longer reflected in error
    messages.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-f2be748f28");
...
var pkgs = [
    {'reference':'php-phpmailer6-6.8.1-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
