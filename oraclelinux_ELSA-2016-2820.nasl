...
# Oracle Linux Security Advisory ELSA-2016-2820 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : memcached (ELSA-2016-2820)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 6 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ELSA-2016-2820 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2016-2820.html");
...
var pkgs = [
    {'reference':'memcached-1.4.4-3.el6_8.1', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'memcached-devel-1.4.4-3.el6_8.1', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'memcached-1.4.4-3.el6_8.1', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'memcached-devel-1.4.4-3.el6_8.1', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
];
