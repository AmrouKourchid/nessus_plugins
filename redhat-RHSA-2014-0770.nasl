...
# extracted from Red Hat Security Advisory RHSA-2014:0770. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2014:0770");

  script_name(english:"RHEL 6 : foreman-proxy (RHSA-2014:0770)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for foreman-proxy.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 6 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2014:0770 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1105369");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2014/rhsa-2014_0770.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8b3a22c3");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2014:0770");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL foreman-proxy package based on the guidance in RHSA-2014:0770.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-0007");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:ruby193-foreman-proxy");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'foreman-proxy-1.3.0-5.el6sat', 'release':'6', 'el_string':'el6sat', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'ruby193-foreman-proxy-1.1.10001-7.el6ost', 'release':'6', 'el_string':'el6ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'foreman-proxy / ruby193-foreman-proxy');
}
