...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : qemu-kvm on SL7.x x86_64 (20180522) (Spectre)");
...
Note: This is the qemu-kvm side of the CVE-2018-3639 mitigation.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e32d69fb");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"qemu-img-1.5.3-156.el7_5.2")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"qemu-kvm-1.5.3-156.el7_5.2")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"qemu-kvm-common-1.5.3-156.el7_5.2")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"qemu-kvm-debuginfo-1.5.3-156.el7_5.2")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"qemu-kvm-tools-1.5.3-156.el7_5.2")) flag++;
