...
# extracted from Fedora Security Advisory FEDORA-2025-3e8ed13bf0
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-3e8ed13bf0");

  script_name(english:"Fedora 41 : webkitgtk (2025-3e8ed13bf0)");
...
FEDORA-2025-3e8ed13bf0 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-3e8ed13bf0");
...
var pkgs = [
    {'reference':'webkitgtk-2.46.6-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
