...
referenced in the RHSA-2015:1913 advisory.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2015/rhsa-2015_1913.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e5c82128");
  script_set_attribute(attribute:"see_also", value:"https://helpx.adobe.com/security/products/flash-player/apsb15-27.html");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2015:1913");
...
"Update the RHEL flash-plugin package based on the guidance in RHSA-2015:1913.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'flash-plugin-11.2.202.540-1.el6_7', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
