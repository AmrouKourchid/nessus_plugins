...
# extracted from F5 Networks BIG-IP Solution K44305703.
#
# @NOAGENT@
##
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : NTP vulnerability (K44305703)");

  script_set_attribute(attribute:"synopsis", value:
"The remote device is missing a vendor-supplied security patch.");
  script_set_attribute(attribute:"description", value:
"The version of F5 Networks BIG-IP installed on the remote host is prior to tested version. It is, therefore, affected by
a vulnerability as referenced in the K44305703 advisory.

    The ntpd daemon in ntp before 4.2.8p14 and 4.3.x before 4.3.100 allows an off-path attacker to block
    ...
    timestamp.(CVE-2020-11868)ImpactAttackers who can guess the IP address of configured time server(s) and
    deliver a spoofed packet to TMOS systems may delay communication with time servers, potentially causing a
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K44305703");
...
var vmatrix = {
  'AFM': {
    'affected': [
      '17.5.0 17.1.0-17.1.2','16.0.0-16.1.6','15.0.0-15.1.10','14.1.0-14.1.5','13.1.0-13.1.5','12.1.0-12.1.6','11.6.1-11.6.5'
    ],
  },
  'AM': {
    'affected': [
