...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.0 : python-pillow (EulerOS-SA-2021-2843)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2843
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a5b253d2");
...
var pkgs = [
  "python-pillow-2.0.0-19.h13.gitd1c6db8"
];
