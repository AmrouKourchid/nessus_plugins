...
# extracted from Amazon Linux 2 Security Advisory ALAS-2024-2641.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : python-setuptools (ALAS-2024-2641)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"It is, therefore, affected by a vulnerability as referenced in the ALAS2-2024-2641 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2024-2641.html");
...
var pkgs = [
    {'reference':'python-setuptools-wheel-49.1.3-1.amzn2.0.5', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-setuptools-49.1.3-1.amzn2.0.5', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
