...
# extracted from Fedora Security Advisory FEDORA-2023-61abba57d8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-61abba57d8");

  script_name(english:"Fedora 38 : frr (2023-61abba57d8)");
...
FEDORA-2023-61abba57d8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-61abba57d8");
...
var pkgs = [
    {'reference':'frr-8.5.3-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
