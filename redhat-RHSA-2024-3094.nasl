...
# extracted from Red Hat Security Advisory RHSA-2024:3094. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:3094");

  script_name(english:"RHEL 8 : perl-CPAN (RHSA-2024:3094)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for perl-CPAN.");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_3094.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?af6c51bc");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2218667");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:3094");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL perl-CPAN package based on the guidance in RHSA-2024:3094.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'perl-CPAN-2.18-399.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'perl-CPAN');
}
