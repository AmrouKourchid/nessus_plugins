...
# SUSE update advisory SUSE-SU-2022:4150-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:4150-1");

  script_name(english:"SUSE SLES15 Security Update : cni (SUSE-SU-2022:4150-1)");
...
in the SUSE-SU-2022:4150-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0f319862");
...
var pkgs = [
    {'reference':'cni-0.7.1-150000.1.7.1', 'sp':'0', 'cpu':'x86_64', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15']},
    {'reference':'cni-0.7.1-150000.1.7.1', 'sp':'0', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15', 'sle-module-public-cloud-release-15', 'sles-release-15']}
];
