...
vulnerability.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K31152411");
...
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K31152411.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-6655");
...
var vmatrix = {
  'AFM': {
    'affected': [
      '13.1.0','12.1.0-12.1.4','11.6.1-11.6.4','11.5.2-11.5.9'
    ],
    'unaffected': [
      '14.0.0','13.1.0.2','12.1.5','11.6.5','11.5.10'
    ],
  },
  'AM': {
    'affected': [
