...
# extracted from Fedora Security Advisory FEDORA-2024-f7e3c98cd6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-f7e3c98cd6");
  script_xref(name:"IAVA", value:"2024-A-0053-S");
  script_xref(name:"IAVA", value:"2024-A-0174-S");

  script_name(english:"Fedora 38 : firefox (2024-f7e3c98cd6)");
...
FEDORA-2024-f7e3c98cd6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-f7e3c98cd6");
...
var pkgs = [
    {'reference':'firefox-122.0-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
