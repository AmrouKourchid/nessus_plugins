...
if (description)
{
  ...
  script_name(english:"CentOS 9 : xmlrpc-c-1.51.0-16.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update for xmlrpc-c.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 9 host has packages installed that are affected by a vulnerability as referenced in the
xmlrpc-c-1.51.0-16.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=17685");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream xmlrpc-c package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:xmlrpc-c-apps");
...
var pkgs = [
    {'reference':'xmlrpc-c-1.51.0-16.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xmlrpc-c-apps-1.51.0-16.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xmlrpc-c-c++-1.51.0-16.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xmlrpc-c-client++-1.51.0-16.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xmlrpc-c-client-1.51.0-16.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xmlrpc-c-devel-1.51.0-16.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'xmlrpc-c / xmlrpc-c-apps / xmlrpc-c-c++ / xmlrpc-c-client / etc');
}
