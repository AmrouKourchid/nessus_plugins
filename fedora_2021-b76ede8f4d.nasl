...
# extracted from Fedora Security Advisory FEDORA-2021-b76ede8f4d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-b76ede8f4d");

  script_name(english:"Fedora 33 : mingw-python3 (2021-b76ede8f4d)");
...
FEDORA-2021-b76ede8f4d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-b76ede8f4d");
...
pkgs = [
    {'reference':'mingw-python3-3.9.2-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
