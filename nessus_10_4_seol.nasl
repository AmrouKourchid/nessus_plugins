...
if (description)
{
  ...
  script_name(english:"Tenable Nessus SEoL (10.4.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Tenable Nessus is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Tenable Nessus is 10.4.x. It is, therefore, no longer maintained by its vendor or provider.
...
"Upgrade to a version of Tenable Nessus that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2024/04/30");
...
var constraints = [
  { max_branch : '10.4', min_branch : '10.4', seol : 20240430, eseol : 20241031 }
];
