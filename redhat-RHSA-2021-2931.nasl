...
# extracted from Red Hat Security Advisory RHSA-2021:2931. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:2931");
  script_xref(name:"IAVB", value:"2021-B-0041-S");

  script_name(english:"RHEL 7 : rh-nodejs12-nodejs and rh-nodejs12-nodejs-nodemon (RHSA-2021:2931)");
...
referenced in the RHSA-2021:2931 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_2931.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?af30196f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:2931");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1941471");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1942592");
...
"Update the RHEL rh-nodejs12-nodejs / rh-nodejs12-nodejs-nodemon packages based on the guidance in RHSA-2021:2931.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-nodejs12-nodejs-12.22.2-1.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs12-nodejs-12.22.2-1.el7', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs12-nodejs-12.22.2-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs12-nodejs-devel-12.22.2-1.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs12-nodejs-devel-12.22.2-1.el7', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs12-nodejs-devel-12.22.2-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs12-nodejs-docs-12.22.2-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs12-nodejs-nodemon-2.0.3-2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs12-npm-6.14.13-12.22.2.1.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs12-npm-6.14.13-12.22.2.1.el7', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs12-npm-6.14.13-12.22.2.1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
