...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : libxml2 (EulerOS-SA-2024-2424)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2424
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c36a91da");
...
var pkgs = [
  "libxml2-2.9.10-11.h29.eulerosv2r10",
  "python3-libxml2-2.9.10-11.h29.eulerosv2r10"
];
