...
# extracted from Debian Security Advisory DLA-2112-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2112-1 : python-reportlab security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2020/02/msg00019.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/jessie/python-reportlab");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"python-renderpm", reference:"3.1.8-3+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"python-renderpm-dbg", reference:"3.1.8-3+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"python-reportlab", reference:"3.1.8-3+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"python-reportlab-accel", reference:"3.1.8-3+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"python-reportlab-accel-dbg", reference:"3.1.8-3+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"python-reportlab-doc", reference:"3.1.8-3+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"python3-renderpm", reference:"3.1.8-3+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"python3-renderpm-dbg", reference:"3.1.8-3+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"python3-reportlab", reference:"3.1.8-3+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"python3-reportlab-accel", reference:"3.1.8-3+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"python3-reportlab-accel-dbg", reference:"3.1.8-3+deb8u2")) flag++;
