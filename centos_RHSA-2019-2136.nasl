...
# extracted from Red Hat Security Advisory RHSA-2019:2136 and 
# CentOS Errata and Security Advisory 2019:2136 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : libssh2 (CESA-2019:2136)");
...
Enterprise Linux 7.7 Release Notes linked from the References section.");
  # https://lists.centos.org/pipermail/centos-cr-announce/2019-August/005964.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?27db0161");
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"libssh2-1.8.0-3.el7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"libssh2-devel-1.8.0-3.el7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"libssh2-docs-1.8.0-3.el7")) flag++;
