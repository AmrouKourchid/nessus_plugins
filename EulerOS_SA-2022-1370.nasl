...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : curl (EulerOS-SA-2022-1370)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1370
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bf9644a9");
...
var pkgs = [
  "curl-7.71.1-4.h12.eulerosv2r10",
  "curl-help-7.71.1-4.h12.eulerosv2r10",
  "libcurl-7.71.1-4.h12.eulerosv2r10",
  "libcurl-devel-7.71.1-4.h12.eulerosv2r10"
];
