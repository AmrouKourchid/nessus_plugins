...
# extracted from Red Hat Security Advisory RHSA-2022:2191. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:2191");
  script_xref(name:"IAVA", value:"2024-A-0327");

  script_name(english:"RHEL 7 : gzip (RHSA-2022:2191)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_2191.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?084c6f4c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:2191");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2073310");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL gzip package based on the guidance in RHSA-2022:2191.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gzip-1.5-11.el7_9', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gzip-1.5-11.el7_9', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gzip-1.5-11.el7_9', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gzip-1.5-11.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
