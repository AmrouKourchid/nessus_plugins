...
# extracted from Red Hat Security Advisory RHSA-2022:6854. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:6854");

  script_name(english:"RHEL 9 : gnutls and nettle (RHSA-2022:6854)");
...
the RHSA-2022:6854 advisory.
    ...
    * [IBM 9.1] [P10] POWER10 performance enhancements for cryptography: nettle - incremental work
    (BZ#2102589)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_6854.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4a496a6c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:6854");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gnutls-3.7.6-12.el9_0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gnutls-c++-3.7.6-12.el9_0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gnutls-dane-3.7.6-12.el9_0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gnutls-devel-3.7.6-12.el9_0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gnutls-utils-3.7.6-12.el9_0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'gnutls-3.7.6-12.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gnutls-c++-3.7.6-12.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gnutls-dane-3.7.6-12.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gnutls-devel-3.7.6-12.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gnutls-utils-3.7.6-12.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
