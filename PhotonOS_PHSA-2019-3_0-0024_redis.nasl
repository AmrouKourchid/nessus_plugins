...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'redis-5.0.5-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'redis-debuginfo-5.0.5-1.ph3')) flag++;
