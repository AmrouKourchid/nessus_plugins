...
# SUSE update advisory SUSE-SU-2023:4201-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:4201-1");

  script_name(english:"SUSE SLES15 Security Update : kernel RT (Live Patch 1 for SLE 15 SP4) (SUSE-SU-2023:4201-1)");
...
the SUSE-SU-2023:4201-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-October/016845.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e47310e8");
...
var kernel_live_checks = [
  {
    'kernels': {
      '5.14.21-150400.15.5-rt-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_14_21-150400_15_5-rt-11-150400.2.3', 'sp':'4', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.4']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kernel-livepatch-5_14_21-150400_15_5-rt');
}
