...
# extracted from Fedora Security Advisory FEDORA-2024-70741fe21f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-70741fe21f");

  script_name(english:"Fedora 39 : dotnet8.0 (2024-70741fe21f)");
...
FEDORA-2024-70741fe21f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-70741fe21f");
...
var pkgs = [
    {'reference':'dotnet8.0-8.0.107-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
