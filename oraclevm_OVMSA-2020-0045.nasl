...
# Security Advisory OVMSA-2020-0045.
#
...
if (description)
{
  ...
  script_name(english:"OracleVM 3.4 : bind (OVMSA-2020-0045)");
...
critical security updates :
  ...
  # https://oss.oracle.com/pipermail/oraclevm-errata/2020-October/001001.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b88376ba");
...
flag = 0;
if (rpm_check(release:"OVS3.4", reference:"bind-libs-9.8.2-0.68.rc1.el6_10.8")) flag++;
if (rpm_check(release:"OVS3.4", reference:"bind-utils-9.8.2-0.68.rc1.el6_10.8")) flag++;
