...
# extracted from Fedora Security Advisory FEDORA-2023-47d4f575a3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-47d4f575a3");

  script_name(english:"Fedora 39 : audiofile (2023-47d4f575a3)");
...
FEDORA-2023-47d4f575a3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-47d4f575a3");
...
var pkgs = [
    {'reference':'audiofile-0.3.6-36.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
