...
# extracted from Red Hat Security Advisory RHSA-2020:3970. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:3970");

  script_name(english:"RHEL 7 : mod_auth_openidc (RHSA-2020:3970)");
...
referenced in the RHSA-2020:3970 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_3970.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ce0d89d4");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/7/html/7.9_release_notes/index
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dd3afe18");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:3970");
...
"Update the RHEL mod_auth_openidc package based on the guidance in RHSA-2020:3970.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'mod_auth_openidc-1.8.8-7.el7', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mod_auth_openidc-1.8.8-7.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mod_auth_openidc-1.8.8-7.el7', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mod_auth_openidc-1.8.8-7.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
