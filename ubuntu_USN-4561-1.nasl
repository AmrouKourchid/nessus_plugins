...
# extracted from Ubuntu Security Notice USN-4561-1. The text
...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS : Rack vulnerabilities (USN-4561-1)");
...
the USN-4561-1 advisory.

    It was discovered that Rack incorrectly handled certain paths. An attacker could possibly use this issue
    to obtain sensitive information. (CVE-2020-8161)

    It was discovered that Rack incorrectly validated cookies. An attacker could possibly use this issue to
    forge a secure cookie. (CVE-2020-8184)

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4561-1");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'ruby-rack', 'pkgver': '1.6.4-4ubuntu0.2'}
];
