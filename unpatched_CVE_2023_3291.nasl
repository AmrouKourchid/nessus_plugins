...
if (description)
{
  ...
  script_cve_id("CVE-2023-3291");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2023-3291");
...
patch available.
  ...
  - Heap-based Buffer Overflow in GitHub repository gpac/gpac prior to 2.2.2. (CVE-2023-3291)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-3291");
