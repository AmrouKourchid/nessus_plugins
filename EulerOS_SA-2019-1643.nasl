...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : compat-openssl10 (EulerOS-SA-2019-1643)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1643
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6492eecb");
...
pkgs = ["compat-openssl10-1.0.2o-3.h3.eulerosv2r8"];
