...
if (description)
{
  ...
  script_name(english:"OpenSSL 0.9.8 < 0.9.8p Vulnerability");

  script_set_attribute(attribute:"synopsis", value:
"The remote service is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of OpenSSL installed on the remote host is prior to 0.9.8p. It is, therefore, affected by a vulnerability as
referenced in the 0.9.8p advisory.
...
var constraints = [
  { 'min_version' : '0.9.8', 'fixed_version' : '0.9.8p' }
];
