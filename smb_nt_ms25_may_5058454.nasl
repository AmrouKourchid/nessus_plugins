...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5058430");
  script_xref(name:"MSKB", value:"5058454");
  script_xref(name:"MSFT", value:"MS25-5058430");
  script_xref(name:"MSFT", value:"MS25-5058454");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2025/06/03");

  script_name(english:"KB5058454: Windows Server 2008 R2 Security Update (May 2025)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5058430");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5058454");
...
if (
  smb_check_rollup(os:'6.1',
                   ...
                   rollup_date:'05_2025',
                   bulletin:bulletin,
                   rollup_kb_list:[5058454, 5058430])
)
{
