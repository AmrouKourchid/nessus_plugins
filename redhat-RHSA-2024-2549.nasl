...
# extracted from Red Hat Security Advisory RHSA-2024:2549. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2549");

  script_name(english:"RHEL 9 : skopeo (RHSA-2024:2549)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for skopeo.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:2549 advisory.
    ...
    * TRIAGE CVE-2024-24786 skopeo: golang-protobuf: encoding/protojson, internal/encoding/json: infinite loop
    in protojson.Unmarshal when unmarshaling certain forms of invalid JSON [rhel-9] - RHEL 9.4 0day
    (JIRA:RHEL-28235)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2549.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8c24ba37");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2549");
...
"Update the RHEL skopeo package based on the guidance in RHSA-2024:2549.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'skopeo-1.14.3-2.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'skopeo-tests-1.14.3-2.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'skopeo-1.14.3-2.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'skopeo-tests-1.14.3-2.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
    ]
  }
];
