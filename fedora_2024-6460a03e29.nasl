...
# extracted from Fedora Security Advisory FEDORA-2024-6460a03e29
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-6460a03e29");

  script_name(english:"Fedora 39 : opensc (2024-6460a03e29)");
...
FEDORA-2024-6460a03e29 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-6460a03e29");
...
var pkgs = [
    {'reference':'opensc-0.25.0-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
