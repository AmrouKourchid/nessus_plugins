...
# extracted from Debian Security Advisory DLA-2225-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2225-1 : gst-plugins-good0.10 security update");
...
An out of bounds heap read can be triggered in the qtdemux element via
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2020/05/msg00029.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/jessie/gst-plugins-good0.10");
...
"Upgrade the affected packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-5840");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"gstreamer0.10-gconf", reference:"0.10.31-3+nmu4+deb8u3")) flag++;
if (deb_check(release:"8.0", prefix:"gstreamer0.10-plugins-good", reference:"0.10.31-3+nmu4+deb8u3")) flag++;
if (deb_check(release:"8.0", prefix:"gstreamer0.10-plugins-good-dbg", reference:"0.10.31-3+nmu4+deb8u3")) flag++;
if (deb_check(release:"8.0", prefix:"gstreamer0.10-plugins-good-doc", reference:"0.10.31-3+nmu4+deb8u3")) flag++;
if (deb_check(release:"8.0", prefix:"gstreamer0.10-pulseaudio", reference:"0.10.31-3+nmu4+deb8u3")) flag++;
