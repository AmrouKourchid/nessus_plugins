...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_0978.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?598004ed");
...
"Update the RHEL zsh package based on the guidance in RHSA-2020:0978.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'zsh-5.5.1-6.el8_0.2', 'sp':'0', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'zsh-5.5.1-6.el8_0.2', 'sp':'0', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'zsh-html-5.5.1-6.el8_0.2', 'sp':'0', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
