...
# extracted from openSUSE Security Update openSUSE-2019-2397.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : sysstat (openSUSE-2019-2397)");
...
This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1150114");
...
if ( rpm_check(release:"SUSE15.0", reference:"sysstat-12.0.2-lp150.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"sysstat-debuginfo-12.0.2-lp150.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"sysstat-debugsource-12.0.2-lp150.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"sysstat-isag-12.0.2-lp150.16.1") ) flag++;
