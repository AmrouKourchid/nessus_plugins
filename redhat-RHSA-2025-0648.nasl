...
# extracted from Red Hat Security Advisory RHSA-2025:0648. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2024-8676");
  script_xref(name:"RHSA", value:"2025:0648");

  script_name(english:"RHEL 8 / 9 : OpenShift Container Platform 4.15.44 (RHSA-2025:0648)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for OpenShift Container Platform 4.15.44.");
...
in the RHSA-2025:0648 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.15.44. See the
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_0648.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?641e41b8");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:0648");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.15.44 package based on the guidance in RHSA-2025:0648.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:H/Au:N/C:C/I:C/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:H/PR:N/UI:N/S:U/C:H/I:H/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-8676");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cri-o-1.28.11-7.rhaos4.15.gitc4c0556.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'cri-o-1.28.11-7.rhaos4.15.gitc4c0556.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
