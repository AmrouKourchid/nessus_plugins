...
# extracted from openSUSE Security Update openSUSE-2019-399.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : wireshark (openSUSE-2019-399)");
...
https://www.wireshark.org/docs/relnotes/wireshark-2.4.7.html");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.wireshark.org/docs/relnotes/wireshark-2.4.7.html");
