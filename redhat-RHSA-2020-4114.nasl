...
referenced in the RHSA-2020:4114 advisory.
    ...
    ovirt-ansible-repositories is an Ansible role used to set up the repositories required for oVirt engine or
    host installation.

    The openvswitch package contains components for enabling Open vSwitch; a software-based Ethernet virtual
    switch. It also includes OVN (Open Virtual Network) components for supporting virtual network abstraction.

    The Red Hat Virtualization Python SDK is a program that simplifies access to the Red Hat Virtualization
    API by providing an object-oriented view to developers.
    ...
    * Previously, during RHHI-V deployment of 3 hosts using ovirt-ansible-hosted-engine-setup, the Self-Hosted
    Engine was added to the default cluster, but the additional 2 hosts were not added.
    In this release, deployment with ovirt-ansible-hosted-engine-setup successfully adds all hosts to the
    cluster. (BZ#1855283)

    * Previously, when creating large numbers of virtual machines (~2300 VMs), the associated Data Centers
    became unresponsive, and the hosts did not have Storage Pool Managers (SPM).
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_4114.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?91946cdd");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1849558");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1849595");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1855283");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1873117");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat Virtualization package based on the guidance in RHSA-2020:4114.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openvswitch2.11-2.11.0-54.20200327gita4efc59.el7fdp', 'cpu':'ppc64le', 'release':'7', 'el_string':'el7fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'},
      {'reference':'openvswitch2.11-2.11.0-54.20200327gita4efc59.el7fdp', 'cpu':'x86_64', 'release':'7', 'el_string':'el7fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'},
      {'reference':'openvswitch2.11-devel-2.11.0-54.20200327gita4efc59.el7fdp', 'cpu':'ppc64le', 'release':'7', 'el_string':'el7fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'},
      {'reference':'openvswitch2.11-devel-2.11.0-54.20200327gita4efc59.el7fdp', 'cpu':'x86_64', 'release':'7', 'el_string':'el7fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'},
      {'reference':'ovn2.11-2.11.1-44.el7fdp', 'cpu':'ppc64le', 'release':'7', 'el_string':'el7fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'},
      {'reference':'ovn2.11-2.11.1-44.el7fdp', 'cpu':'x86_64', 'release':'7', 'el_string':'el7fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'},
      {'reference':'ovn2.11-host-2.11.1-44.el7fdp', 'cpu':'ppc64le', 'release':'7', 'el_string':'el7fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'},
      {'reference':'ovn2.11-host-2.11.1-44.el7fdp', 'cpu':'x86_64', 'release':'7', 'el_string':'el7fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'},
      {'reference':'ovn2.11-vtep-2.11.1-44.el7fdp', 'cpu':'ppc64le', 'release':'7', 'el_string':'el7fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'},
      {'reference':'ovn2.11-vtep-2.11.1-44.el7fdp', 'cpu':'x86_64', 'release':'7', 'el_string':'el7fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'},
      {'reference':'python-openvswitch2.11-2.11.0-54.20200327gita4efc59.el7fdp', 'cpu':'ppc64le', 'release':'7', 'el_string':'el7fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'},
      {'reference':'python-openvswitch2.11-2.11.0-54.20200327gita4efc59.el7fdp', 'cpu':'x86_64', 'release':'7', 'el_string':'el7fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'openvswitch2.11 / openvswitch2.11-devel / ovn2.11 / ovn2.11-host / etc');
}
