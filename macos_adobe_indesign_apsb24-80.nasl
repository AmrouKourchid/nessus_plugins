...
if (description)
{
  ...
  script_name(english:"Adobe InDesign < 18.5.4 / 19.0 < 19.5.0 Arbitrary code execution (APSB24-80) (macOS)");
...
"The version of Adobe InDesign installed on the remote macOS host is prior to 18.5.4, 19.5.0. It is, therefore, affected
by a vulnerability as referenced in the APSB24-80 advisory.
