...
referenced in the RHSA-2023:1202 advisory.
    ...
    * RHEL9:[P10] With Guest Secure Boot and lockdown enabled, DLPAR operations can't be done (Rainier)
    (BZ#2107480)
    ...
    * In FIPS mode, the kernel should reject SHA-224, SHA-384, SHA-512-224, and SHA-512-256 as hashes for
    hash-based DRBGs, or provide an indicator after 2023-05-16 (BZ#2165131)

    * [RHEL 9] FIPS: deadlock between PID 1 and modprobe crypto-jitterentropy_rng at boot, preventing system
    to boot. (BZ#2167762)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_1202.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8a186612");
