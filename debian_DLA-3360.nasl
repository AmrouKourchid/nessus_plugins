...
# extracted from Debian Security Advisory dla-3360. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3360 : ruby-sidekiq - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/ruby-sidekiq");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'ruby-sidekiq', 'reference': '5.2.3+dfsg-1+deb10u1'}
];
