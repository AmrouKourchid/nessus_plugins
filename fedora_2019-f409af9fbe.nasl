...
# extracted from Fedora Security Advisory FEDORA-2019-f409af9fbe.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-f409af9fbe");

  script_name(english:"Fedora 29 : hostapd (2019-f409af9fbe)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-f409af9fbe");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"hostapd-2.7-2.fc29")) flag++;
