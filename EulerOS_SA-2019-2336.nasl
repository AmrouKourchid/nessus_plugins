...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.3.0 : dhcp (EulerOS-SA-2019-2336)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2336
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b50f48fc");
...
pkgs = ["dhcp-client-4.3.6-28.h6.eulerosv2r8",
        "dhcp-common-4.3.6-28.h6.eulerosv2r8",
        "dhcp-libs-4.3.6-28.h6.eulerosv2r8",
        "dhcp-relay-4.3.6-28.h6.eulerosv2r8",
        "dhcp-server-4.3.6-28.h6.eulerosv2r8"];
