...
# extracted from Red Hat Security Advisory RHSA-2020:4542. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:4542");

  script_name(english:"RHEL 8 : cryptsetup (RHSA-2020:4542)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2020:4542 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_4542.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a561926f");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/8.3_release_notes/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b7e37d18");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:4542");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1743891");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1785748");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1796826");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1874712");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:cryptsetup");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:cryptsetup-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:cryptsetup-libs");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:cryptsetup-reencrypt");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:integritysetup");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:veritysetup");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cryptsetup-2.3.3-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'cryptsetup-devel-2.3.3-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'cryptsetup-libs-2.3.3-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'cryptsetup-reencrypt-2.3.3-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'integritysetup-2.3.3-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'veritysetup-2.3.3-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
