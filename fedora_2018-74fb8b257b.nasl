...
# extracted from Fedora Security Advisory FEDORA-2018-74fb8b257b.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2017-16845", "CVE-2018-11806", "CVE-2018-12617");
  script_xref(name:"FEDORA", value:"2018-74fb8b257b");

  script_name(english:"Fedora 28 : 2:qemu (2018-74fb8b257b)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"- CVE-2017-16845: ps2: information leakage via post_load
    (bz #1514150)

  - CVE-2018-11806: slirp: heap buffer overflow while
    reassembling fragmented datagrams (bz #1586249)

  - CVE-2018-12617: qemu-guest-agent: Integer overflow
    causes segmentation fault in qmp_guest_file_read (bz
    #1594055)
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-74fb8b257b");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"qemu-2.11.2-2.fc28", epoch:"2")) flag++;
