...
# extracted from VMware Security Advisory PHSA-2023-4.0-0349. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Logrotate PHSA-2023-4.0-0349");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the logrotate package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-349.md");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:vmware:photonos:logrotate");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'logrotate-3.21.0-1.ph4')) flag++;
