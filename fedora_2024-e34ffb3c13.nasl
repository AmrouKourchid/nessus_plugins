...
# extracted from Fedora Security Advisory FEDORA-2024-e34ffb3c13
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-e34ffb3c13");

  script_name(english:"Fedora 41 : restic (2024-e34ffb3c13)");
...
FEDORA-2024-e34ffb3c13 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-e34ffb3c13");
  script_set_attribute(attribute:"solution", value:
"Update the affected restic package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:restic");
...
var pkgs = [
    {'reference':'restic-0.17.0-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'restic');
}
