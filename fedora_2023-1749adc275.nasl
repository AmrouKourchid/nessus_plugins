...
# extracted from Fedora Security Advisory FEDORA-2023-1749adc275
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-1749adc275");

  script_name(english:"Fedora 37 : firefox (2023-1749adc275)");
...
FEDORA-2023-1749adc275 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-1749adc275");
...
var pkgs = [
    {'reference':'firefox-112.0-3.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
