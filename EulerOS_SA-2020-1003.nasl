...
if (description)
{
  ...
  script_cve_id("CVE-2018-4868", "CVE-2018-17581");

  script_name(english:"EulerOS 2.0 SP8 : exiv2 (EulerOS-SA-2020-1003)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1003
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?11ce16eb");
...
"Update the affected exiv2 packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-4868");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2018-17581");
...
pkgs = ["exiv2-0.26-12.h8.eulerosv2r8",
        "exiv2-libs-0.26-12.h8.eulerosv2r8"];
