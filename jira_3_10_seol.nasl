...
if (description)
{
  ...
  script_name(english:"Atlassian JIRA SEoL (3.10.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Atlassian JIRA is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Atlassian JIRA is 3.10.x. It is, therefore, no longer maintained by its vendor or provider.
...
"Upgrade to a version of Atlassian JIRA that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2009/08/20");
...
var constraints = [
  { max_branch : '3.10', min_branch : '3.10', seol : 20090820 }
];
