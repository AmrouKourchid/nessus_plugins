...
if (description)
{
  ...
  script_cve_id("CVE-2022-41062");
  script_xref(name:"MSKB", value:"5002303");
  script_xref(name:"MSFT", value:"MS22-5002303");
  script_xref(name:"IAVA", value:"2022-A-0481-S");

  script_name(english:"Security Updates for Microsoft SharePoint Foundation 2013 (November 2022)");
...
exploit this to bypass authentication and execute unauthorized arbitrary commands.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002303");
