...
# extracted from Gentoo Linux Security Advisory GLSA 202309-14.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202309-14 : libarchive: Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202309-14 (libarchive: Multiple Vulnerabilities)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202309-14");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=882521");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=911486");
...
var packages = [
  {
    ...
    'unaffected' : make_list("ge 3.7.1"),
    'vulnerable' : make_list("lt 3.7.1")
  }
];
