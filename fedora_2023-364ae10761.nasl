...
# extracted from Fedora Security Advisory FEDORA-2023-364ae10761
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-364ae10761");

  script_name(english:"Fedora 38 : mingw-qt6-qtbase (2023-364ae10761)");
...
FEDORA-2023-364ae10761 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-364ae10761");
...
var pkgs = [
    {'reference':'mingw-qt6-qtbase-6.5.1-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
