...
# extracted from Fedora Security Advisory FEDORA-2024-39d459dd00
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-39d459dd00");

  script_name(english:"Fedora 39 : python3.10 (2024-39d459dd00)");
...
FEDORA-2024-39d459dd00 advisory.

    This is a security release of Python 3.10
    -----------------------------------------

    **Note:** The release you're looking at is Python 3.10.15, a **security bugfix release** for the legacy
    3.10 series. *Python 3.12* is now the latest feature release series of Python 3.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-39d459dd00");
...
var pkgs = [
    {'reference':'python3.10-3.10.15-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
