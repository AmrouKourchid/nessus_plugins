...
# extracted from Red Hat Security Advisory RHSA-2018:3246. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : libcdio (RHSA-2018:3246)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for libcdio.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2018:3246 advisory.

    The libcdio library provides an interface for CD-ROM access. It can be used by applications that need OS-
    independent and device-independent access to CD-ROM devices.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_3246.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?03533392");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:3246");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1549644");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1549701");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1549707");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libcdio package based on the guidance in RHSA-2018:3246.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:libcdio");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:libcdio-devel");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libcdio-0.92-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libcdio-devel-0.92-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
