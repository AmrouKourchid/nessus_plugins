...
# extracted from Fedora Security Advisory FEDORA-2024-c89d2ecdea
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-c89d2ecdea");

  script_name(english:"Fedora 39 : zabbix (2024-c89d2ecdea)");
...
FEDORA-2024-c89d2ecdea advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-c89d2ecdea");
...
var pkgs = [
    {'reference':'zabbix-6.0.33-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
