...
# extracted from Red Hat Security Advisory RHSA-2023:7267. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:7267");

  script_name(english:"RHEL 9 : open-vm-tools (RHSA-2023:7267)");
...
referenced in the RHSA-2023:7267 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_7267.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e273e59e");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:7267");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL open-vm-tools package based on the guidance in RHSA-2023:7267.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'open-vm-tools-11.3.5-1.el9_0.5', 'sp':'0', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'open-vm-tools-11.3.5-1.el9_0.5', 'sp':'0', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'open-vm-tools-desktop-11.3.5-1.el9_0.5', 'sp':'0', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'open-vm-tools-desktop-11.3.5-1.el9_0.5', 'sp':'0', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'open-vm-tools-sdmp-11.3.5-1.el9_0.5', 'sp':'0', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'open-vm-tools-test-11.3.5-1.el9_0.5', 'sp':'0', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'open-vm-tools-test-11.3.5-1.el9_0.5', 'sp':'0', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
