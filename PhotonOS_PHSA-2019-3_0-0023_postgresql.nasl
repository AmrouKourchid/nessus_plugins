...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Postgresql PHSA-2019-3.0-0023");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'postgresql-10.9-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'postgresql-debuginfo-10.9-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'postgresql-devel-10.9-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'postgresql-libs-10.9-1.ph3')) flag++;
