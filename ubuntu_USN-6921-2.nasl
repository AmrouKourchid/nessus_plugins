...
# extracted from Ubuntu Security Notice USN-6921-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6921-2");

  script_name(english:"Ubuntu 24.04 LTS : Linux kernel vulnerabilities (USN-6921-2)");
...
the USN-6921-2 advisory.
    ...
    - IPv4 networking; (CVE-2024-35997, CVE-2024-36016, CVE-2024-35990, CVE-2024-35984, CVE-2024-35992,
    CVE-2024-36008)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6921-2");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-6.8.0-39-lowlatency");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-6.8.0-39-lowlatency-64k");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-6921-2');
}
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-6921-2');
  }
  else
  {
