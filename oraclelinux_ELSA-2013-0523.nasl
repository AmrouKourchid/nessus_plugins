...
# Oracle Linux Security Advisory ELSA-2013-0523 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : ccid (ELSA-2013-0523)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2013-0523.html");
