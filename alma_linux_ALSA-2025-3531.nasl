...
# AlmaLinux Security Advisory ALSA-2025:3531.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2025:3531");
  script_xref(name:"RHSA", value:"2025:3531");

  script_name(english:"AlmaLinux 9 : expat (ALSA-2025:3531)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2025-3531.html");
...
var pkgs = [
    {'reference':'expat-2.5.0-3.el9_5.3', 'release':'9', 'el_string':'el9_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'expat-devel-2.5.0-3.el9_5.3', 'release':'9', 'el_string':'el9_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'}
];
