...
# extracted from Fedora Security Advisory FEDORA-2019-a095a16c47.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-a095a16c47");

  script_name(english:"Fedora 29 : spice (2019-a095a16c47)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-a095a16c47");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"spice-0.14.1-2.fc29")) flag++;
