...
# extracted from Fedora Security Advisory FEDORA-2025-97687e7f68
#
...
if (description)
{
  ...
  script_cve_id("CVE-2025-43962", "CVE-2025-43963", "CVE-2025-43964");
  script_xref(name:"FEDORA", value:"2025-97687e7f68");
  script_xref(name:"IAVA", value:"2025-A-0306");

  script_name(english:"Fedora 40 : digikam (2025-97687e7f68)");
...
FEDORA-2025-97687e7f68 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-97687e7f68");
  script_set_attribute(attribute:"solution", value:
"Update the affected digikam package.");
...
var pkgs = [
    {'reference':'digikam-8.6.0-4.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'digikam');
}
