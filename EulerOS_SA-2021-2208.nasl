...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.0 : python-cryptography (EulerOS-SA-2021-2208)");
...
is affected by the following vulnerability :
  ...
  - In the cryptography package before 3.3.2 for Python,
    certain sequences of update calls to symmetrically
    encrypt multi-GB values could result in an integer
    overflow and buffer overflow, as demonstrated by the
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2208
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?20a9d8bf");
...
pkgs = ["python3-cryptography-2.9-1.h1.eulerosv2r9"];
