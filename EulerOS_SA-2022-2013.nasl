...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : subversion (EulerOS-SA-2022-2013)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2013
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?327d6766");
...
var pkgs = [
  "subversion-1.10.6-2.h5.eulerosv2r9",
  "subversion-help-1.10.6-2.h5.eulerosv2r9"
];
