...
# extracted from Fedora Security Advisory FEDORA-2022-c8cad41c95
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-c8cad41c95");

  script_name(english:"Fedora 36 : squid (2022-c8cad41c95)");
...
FEDORA-2022-c8cad41c95 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-c8cad41c95");
...
var pkgs = [
    {'reference':'squid-5.7-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
];
