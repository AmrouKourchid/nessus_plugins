...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : 389-ds-base (EulerOS-SA-2022-1921)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the 389-ds-base package installed, the EulerOS installation on the remote host is affected
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1921
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f8ed44b2");
...
var pkgs = [
  "389-ds-base-libs-1.4.0.16-1.h3.eulerosv2r8"
];
