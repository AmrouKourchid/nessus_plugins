...
with a known, hard-coded key.");
  # https://issues.jenkins-ci.org/login.jsp?permissionViolation=true&os_destination=%2Fbrowse%2FJENKINS-17515&page_caps=&user_role=
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6db2b6e6");
