...
# extracted from Fedora Security Advisory FEDORA-2023-7228464f28
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-7228464f28");

  script_name(english:"Fedora 38 : spectre-meltdown-checker (2023-7228464f28)");
...
FEDORA-2023-7228464f28 advisory.

    This release mainly focuses on the detection of the new Zenbleed (CVE-2023-20593) vulnerability, among few
    other changes that were in line waiting for a release:
    ...
    * fix: rewrite SQL to be sqlite3 >= 3.41 compatible ([#443](https://github.com/speed47/spectre-meltdown-
    checker/issues/443))
    * fix: a /devnull file was mistakenly created on the filesystem
    * fix: fwdb: ignore MCEdb versions where an official Intel version exists (fixes
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-7228464f28");
...
"Update the affected spectre-meltdown-checker package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:spectre-meltdown-checker");
...
var pkgs = [
    {'reference':'spectre-meltdown-checker-0.46-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
