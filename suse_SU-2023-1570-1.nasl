...
# SUSE update advisory SUSE-SU-2023:1570-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:1570-1");

  script_name(english:"openSUSE 15 Security Update : libgit2 (SUSE-SU-2023:1570-1)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ed22042a");
  script_set_attribute(attribute:"solution", value:
"Update the affected libgit2-26 and / or libgit2-26-32bit packages.");
...
var pkgs = [
    {'reference':'libgit2-26-0.26.8-150000.3.18.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.4']},
    {'reference':'libgit2-26-32bit-0.26.8-150000.3.18.1', 'cpu':'x86_64', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.4']}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libgit2-26 / libgit2-26-32bit');
}
