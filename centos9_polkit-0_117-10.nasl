...
if (description)
{
  ...
  script_name(english:"CentOS 9 : polkit-0.117-10.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update for polkit.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 9 host has packages installed that are affected by a vulnerability as referenced in the
polkit-0.117-10.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=17619");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream polkit package.");
...
var pkgs = [
    {'reference':'polkit-0.117-10.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'polkit-devel-0.117-10.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'polkit-docs-0.117-10.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'polkit-libs-0.117-10.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
