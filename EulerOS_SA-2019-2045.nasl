...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : SDL (EulerOS-SA-2019-2045)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2045
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cdda8c84");
...
pkgs = ["SDL-1.2.15-14.h2",
        "SDL-devel-1.2.15-14.h2"];
