...
# extracted from Fedora Security Advisory FEDORA-2020-127d40f1ab.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-127d40f1ab");

  script_name(english:"Fedora 32 : chromium (2020-127d40f1ab)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-127d40f1ab");
...
flag = 0;
if (rpm_check(release:"FC32", reference:"chromium-86.0.4240.111-1.fc32", allowmaj:TRUE)) flag++;
