...
# extracted from Gentoo Linux Security Advisory GLSA 202101-31.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202101-31");

  script_name(english:"GLSA-202101-31 : Cacti: Remote code execution");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202101-31
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202101-31");
...
if (qpkg_check(package:"net-analyzer/cacti", unaffected:make_list("ge 1.2.16-r1"), vulnerable:make_list("lt 1.2.16-r1"))) flag++;
