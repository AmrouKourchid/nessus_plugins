...
# SUSE update advisory SUSE-SU-2024:1505-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2024:1505-1");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2024/06/20");

  script_name(english:"SUSE SLES12 Security Update : kernel (Live Patch 42 for SLE 12 SP5) (SUSE-SU-2024:1505-1)");
...
the SUSE-SU-2024:1505-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2024-May/018452.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?642e90a7");
...
"Update the affected kgraft-patch-4_12_14-122_156-default package.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-122.156-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_12_14-122_156-default-14-2.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.5']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kgraft-patch-4_12_14-122_156-default');
}
