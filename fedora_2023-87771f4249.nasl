...
# extracted from Fedora Security Advisory FEDORA-2023-87771f4249
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-87771f4249");

  script_name(english:"Fedora 39 : python3.11 (2023-87771f4249)");
...
FEDORA-2023-87771f4249 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-87771f4249");
...
var pkgs = [
    {'reference':'python3.11-3.11.7-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
