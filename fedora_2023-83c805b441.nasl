...
# extracted from Fedora Security Advisory FEDORA-2023-83c805b441
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-83c805b441");
  script_xref(name:"IAVB", value:"2023-B-0041-S");

  script_name(english:"Fedora 37 : ghostscript (2023-83c805b441)");
...
FEDORA-2023-83c805b441 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-83c805b441");
...
var pkgs = [
    {'reference':'ghostscript-9.56.1-8.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
