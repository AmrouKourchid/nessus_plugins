...
# extracted from Fedora Security Advisory FEDORA-2023-79b5902a52
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-79b5902a52");

  script_name(english:"Fedora 38 : ckeditor (2023-79b5902a52)");
...
FEDORA-2023-79b5902a52 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-79b5902a52");
...
var pkgs = [
    {'reference':'ckeditor-4.22.1-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
