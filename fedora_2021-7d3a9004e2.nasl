...
# extracted from Fedora Security Advisory FEDORA-2021-7d3a9004e2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-7d3a9004e2");

  script_name(english:"Fedora 33 : python3.8 (2021-7d3a9004e2)");
...
FEDORA-2021-7d3a9004e2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-7d3a9004e2");
...
pkgs = [
    {'reference':'python3.8-3.8.8-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
