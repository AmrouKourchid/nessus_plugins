...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : logwatch (ELSA-2011-0324)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2011-0324.html");
...
var pkgs = [
    {'reference':'logwatch-7.3.6-49.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
];
