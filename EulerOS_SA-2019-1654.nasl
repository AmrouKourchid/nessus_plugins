...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : openssl (EulerOS-SA-2019-1654)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1654
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b1f7f950");
...
pkgs = ["openssl-1.1.1-3.h4.eulerosv2r8",
        "openssl-devel-1.1.1-3.h4.eulerosv2r8",
        "openssl-libs-1.1.1-3.h4.eulerosv2r8",
        "openssl-perl-1.1.1-3.h4.eulerosv2r8"];
