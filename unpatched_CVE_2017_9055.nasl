...
if (description)
{
  ...
  script_cve_id("CVE-2017-9055");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2017-9055");
...
patch available.
  ...
  - An issue, also known as DW201703-001, was discovered in libdwarf 2017-03-21. In dwarf_formsdata() a few
    data types were not checked for being in bounds, leading to a heap-based buffer over-read. (CVE-2017-9055)
