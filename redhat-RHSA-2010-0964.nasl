...
if (description)
{
  ...
  script_cve_id("CVE-2010-4265");
  script_xref(name:"RHSA", value:"2010:0964");

  script_name(english:"RHEL 5 : jboss-remoting (RHSA-2010:0964)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for jboss-remoting.");
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2010/rhsa-2010_0964.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b8f1af92");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2010:0964");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=660623");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL jboss-remoting package based on the guidance in RHSA-2010:0964.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:H/Au:N/C:N/I:N/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2010-4265");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jboss-remoting-2.2.3-4.SP3.ep1.1.el5', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap4'}
    ]
  }
];
