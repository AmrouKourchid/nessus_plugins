...
if (description)
{
  ...
  script_name(english:"Adobe Premiere Pro < 15.4.1 Arbitrary Code Execution (APSB21-67) (macOS)");
...
"The version of Adobe Premiere Pro installed on the remote macOS host is prior to 15.4.1. It is, therefore, affected by a
vulnerability as referenced in the APSB21-67 advisory.

  - Adobe Premiere Pro version 15.4 (and earlier) are affected by a memory corruption vulnerability. An
    ...
    open a malicious M4A file. (CVE-2021-46816)
...
"Upgrade to Adobe Premiere Pro version 15.4.1 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-46816");
