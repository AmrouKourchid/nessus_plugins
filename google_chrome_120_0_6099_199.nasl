...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2024-A-0004-S");

  script_name(english:"Google Chrome < 120.0.6099.199 Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"A web browser installed on the remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Google Chrome installed on the remote Windows host is prior to 120.0.6099.199. It is, therefore, affected
by multiple vulnerabilities as referenced in the 2024_01_stable-channel-update-for-desktop advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9a495657");
  script_set_attribute(attribute:"see_also", value:"https://crbug.com/1501798");
  script_set_attribute(attribute:"see_also", value:"https://crbug.com/1505009");
  script_set_attribute(attribute:"see_also", value:"https://crbug.com/1505086");
  script_set_attribute(attribute:"see_also", value:"https://crbug.com/1506923");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Google Chrome version 120.0.6099.199 or later.");
...
google_chrome_check_version(installs:installs, fix:'120.0.6099.199', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
