...
# extracted from Fedora Security Advisory FEDORA-2021-93a7c8b7c6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-93a7c8b7c6");
  script_xref(name:"IAVA", value:"2021-A-0524-S");

  script_name(english:"Fedora 33 : salt (2021-93a7c8b7c6)");
...
FEDORA-2021-93a7c8b7c6 advisory.
  ...
  - An issue was discovered in SaltStack Salt before 3003.3. The salt minion installer will accept and use a
    minion config file at C:\salt\conf if that file is in place before the installer is run. This allows for a
    malicious actor to subvert the proper behaviour of the given minion software. (CVE-2021-22004)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-93a7c8b7c6");
...
"Update the affected salt package.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2021-31607");
...
var pkgs = [
    {'reference':'salt-3003.3-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
