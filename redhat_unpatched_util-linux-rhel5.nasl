...
# extracted from Red Hat Security Advisory util-linux. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2013-0157", "CVE-2015-5218", "CVE-2016-5011");

  script_name(english:"RHEL 5 : util-linux (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2016-5011");
