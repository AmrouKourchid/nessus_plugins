...
# extracted from Fedora Security Advisory FEDORA-2023-65413f7fd0
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-65413f7fd0");

  script_name(english:"Fedora 40 : dnsx (2023-65413f7fd0)");
...
FEDORA-2023-65413f7fd0 advisory.

    Automatic update for dnsx-1.1.5-1.fc40.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-65413f7fd0");
...
var pkgs = [
    {'reference':'dnsx-1.1.5-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
