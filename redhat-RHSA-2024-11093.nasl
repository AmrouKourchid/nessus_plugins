...
# extracted from Red Hat Security Advisory RHSA-2024:11093. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:11093");

  script_name(english:"RHEL 8 : python36:3.6 (RHSA-2024:11093)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for python36:3.6.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:11093 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_11093.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?00175cd4");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:11093");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python36:3.6 package based on the guidance in RHSA-2024:11093.");
  ...
  'python36:3.6': [
    {
      ...
      'pkgs': [
        {'reference':'python-nose-docs-1.3.7-31.module+el8.5.0+12207+5c5719bc', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python-pymongo-doc-3.7.0-1.module+el8.4.0+9670+1849b5f9', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python-sqlalchemy-doc-1.3.2-2.module+el8.8.0+20977+39d98680.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python-virtualenv-doc-15.1.0-22.module+el8.8.0+22625+4a966c0c.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-bson-3.7.0-1.module+el8.4.0+9670+1849b5f9', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-distro-1.4.0-2.module+el8.1.0+3334+5cb623d7', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-docs-3.6.7-2.module+el8.1.0+3334+5cb623d7', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-docutils-0.14-12.module+el8.1.0+3334+5cb623d7', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-nose-1.3.7-31.module+el8.5.0+12207+5c5719bc', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-pygments-2.2.0-22.module+el8.5.0+10789+e4939b94', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-pymongo-3.7.0-1.module+el8.4.0+9670+1849b5f9', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-pymongo-gridfs-3.7.0-1.module+el8.4.0+9670+1849b5f9', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-PyMySQL-0.10.1-2.module+el8.4.0+9657+a4b6a102', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-scipy-1.0.0-21.module+el8.5.0+10916+41bd434d', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-sqlalchemy-1.3.2-2.module+el8.8.0+20977+39d98680.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-virtualenv-15.1.0-22.module+el8.8.0+22625+4a966c0c.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-wheel-0.31.1-3.module+el8.5.0+12207+5c5719bc', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'python3-wheel-wheel-0.31.1-3.module+el8.5.0+12207+5c5719bc', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'python36-3.6.8-38.module+el8.5.0+12207+5c5719bc', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python36-debug-3.6.8-38.module+el8.5.0+12207+5c5719bc', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python36-devel-3.6.8-38.module+el8.5.0+12207+5c5719bc', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python36-rpm-macros-3.6.8-38.module+el8.5.0+12207+5c5719bc', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
