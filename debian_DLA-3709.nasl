...
# extracted from Debian Security Advisory dla-3709. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3709 : squid - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3709
advisory.

    -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3709-2                debian-lts@lists.debian.org
    https://www.debian.org/lts/security/                      Markus Koschany
    January 22, 2024                              https://wiki.debian.org/LTS
    -------------------------------------------------------------------------

    Package        : squid
    Version        : 4.6-1+deb10u10
    CVE ID         : CVE-2023-46846
    Debian Bug     : 1060857

    It was discovered that the fix for CVE-2023-46846 was incomplete. In some
    cases Squid, a full featured web proxy cache, returned empty responses for
    URLs when Transfer-Encoding: chunked was in use.
...
var pkgs = [
    {'release': '10.0', 'prefix': 'squid', 'reference': '4.6-1+deb10u10'},
    {'release': '10.0', 'prefix': 'squid-cgi', 'reference': '4.6-1+deb10u10'},
    {'release': '10.0', 'prefix': 'squid-common', 'reference': '4.6-1+deb10u10'},
    {'release': '10.0', 'prefix': 'squid-purge', 'reference': '4.6-1+deb10u10'},
    {'release': '10.0', 'prefix': 'squid3', 'reference': '4.6-1+deb10u10'},
    {'release': '10.0', 'prefix': 'squidclient', 'reference': '4.6-1+deb10u10'}
];
