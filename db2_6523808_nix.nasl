...
"According to its self-reported version number, IBM Db2 is affected by a privilege escalation vulnerability due to
allowing modification of columns of existing tasks. An unauthenticated, local attacker can exploit this to elevate to
higher privileges.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/node/6523808");
...
"Apply the appropriate IBM DB2 Fix Pack or Special Build based on the most recent fix pack level for your branch.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-38926");
