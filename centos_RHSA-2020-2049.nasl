...
if (description)
{
  ...
  script_name(english:"CentOS 6 : thunderbird (RHSA-2020:2049)");
...
var pkgs = [
    {'reference':'thunderbird-68.8.0-1.el7.centos', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
