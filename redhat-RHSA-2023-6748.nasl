...
# extracted from Red Hat Security Advisory RHSA-2023:6748. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:6748");

  script_name(english:"RHEL 9 : squid (RHSA-2023:6748)");
...
referenced in the RHSA-2023:6748 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6748.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5854fe5a");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6748");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL squid package based on the guidance in RHSA-2023:6748.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'squid-5.5-6.el9_3.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
    ]
  }
];
