...
if (description)
{
  ...
  script_name(english:"Solaris 10 (x86) : 119784-50");
  script_summary(english:"Check for patch 119784-50");

  script_set_attribute(
    attribute:"synopsis",
    value:"The remote host is missing Sun Security Patch number 119784-50"
  );
  script_set_attribute(
...
execution."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://getupdates.oracle.com/readme/119784-50"
  );
  script_set_attribute(attribute:"solution", value:"Install patch 119784-50 or higher");
...
if (solaris_check_patch(release:"5.10_x86", arch:"i386", patch:"119784-50", obsoleted_by:"", package:"SUNWbind", version:"11.10.0,REV=2005.01.08.01.09") < 0) flag++;
if (solaris_check_patch(release:"5.10_x86", arch:"i386", patch:"119784-50", obsoleted_by:"", package:"SUNWbindS", version:"11.10.0,REV=2005.01.08.01.09") < 0) flag++;
if (solaris_check_patch(release:"5.10_x86", arch:"i386", patch:"119784-50", obsoleted_by:"", package:"SUNWbindr", version:"11.10.0,REV=2005.01.08.01.09") < 0) flag++;
