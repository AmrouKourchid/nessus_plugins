...
# Oracle Linux Security Advisory ELSA-2009-1209 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : curl (ELSA-2009-1209)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2009-1209.html");
...
"Update the affected curl and / or curl-devel packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2009-2417");
...
var pkgs = [
    {'reference':'curl-7.15.5-2.1.el5_3.5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'curl-devel-7.15.5-2.1.el5_3.5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'curl-7.15.5-2.1.el5_3.5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'curl-devel-7.15.5-2.1.el5_3.5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
