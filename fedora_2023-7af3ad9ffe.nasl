...
# extracted from Fedora Security Advisory FEDORA-2023-7af3ad9ffe
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-7af3ad9ffe");

  script_name(english:"Fedora 37 : wireshark (2023-7af3ad9ffe)");
...
FEDORA-2023-7af3ad9ffe advisory.

    New version 4.0.5. Fixes Bug #2159392, CVE-2023-1992, CVE-2023-1993 and CVE-2023-1994.

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-7af3ad9ffe");
...
var pkgs = [
    {'reference':'wireshark-4.0.5-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
