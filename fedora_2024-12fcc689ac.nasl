...
# extracted from Fedora Security Advisory FEDORA-2024-12fcc689ac
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-12fcc689ac");

  script_name(english:"Fedora 40 : dav1d (2024-12fcc689ac)");
...
FEDORA-2024-12fcc689ac advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-12fcc689ac");
...
var pkgs = [
    {'reference':'dav1d-1.4.0-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
