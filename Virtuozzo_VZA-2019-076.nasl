...
if (description)
{
  ...
  script_cve_id("CVE-2019-11810");

  script_name(english:"Virtuozzo 7 : readykernel-patch (VZA-2019-076)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://virtuozzosupport.force.com/s/article/VZA-2019-076");
  # https://readykernel.com/patch/Virtuozzo-7/readykernel-patch-43.10-88.0-1.vl7/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7fb5dca4");
...
"Update the readykernel patch.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-11810");
...
checks = make_list2(
  make_array(
    ...
    "patch","readykernel-patch-43.10-88.0-1.vl7"
  )
);
