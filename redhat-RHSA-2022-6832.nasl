...
# extracted from Red Hat Security Advisory RHSA-2022:6832. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:6832");

  script_name(english:"RHEL 8 : expat (RHSA-2022:6832)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for expat.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2022:6832 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_6832.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?44f6cb9d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2130769");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:6832");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL expat package based on the guidance in RHSA-2022:6832.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'expat-2.2.5-3.el8_2.3', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'expat-devel-2.2.5-3.el8_2.3', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
