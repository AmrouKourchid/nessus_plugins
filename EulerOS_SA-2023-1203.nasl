...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.1 : rsync (EulerOS-SA-2023-1203)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1203
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e9d7ec86");
...
var pkgs = [
  "rsync-3.1.3-6.h1.r2.eulerosv2r9"
];
