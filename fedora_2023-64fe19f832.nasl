...
# extracted from Fedora Security Advisory FEDORA-2023-64fe19f832
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-64fe19f832");

  script_name(english:"Fedora 38 : rt (2023-64fe19f832)");
...
FEDORA-2023-64fe19f832 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-64fe19f832");
...
var pkgs = [
    {'reference':'rt-5.0.5-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
