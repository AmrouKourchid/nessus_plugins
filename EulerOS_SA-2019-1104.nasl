...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : rsyslog (EulerOS-SA-2019-1104)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1104
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?678912ac");
...
pkgs = ["rsyslog-7.4.7-7.2.h18",
        "rsyslog-gnutls-7.4.7-7.2.h18",
        "rsyslog-gssapi-7.4.7-7.2.h18",
        "rsyslog-mmjsonparse-7.4.7-7.2.h18",
        "rsyslog-mysql-7.4.7-7.2.h18",
        "rsyslog-pgsql-7.4.7-7.2.h18",
        "rsyslog-relp-7.4.7-7.2.h18"];
