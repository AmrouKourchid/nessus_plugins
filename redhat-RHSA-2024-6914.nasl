...
# extracted from Red Hat Security Advisory RHSA-2024:6914. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:6914");

  script_name(english:"RHEL 9 : golang (RHSA-2024:6914)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for golang.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:6914 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_6914.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9460f3e6");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:6914");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL golang package based on the guidance in RHSA-2024:6914.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'golang-1.19.13-12.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-bin-1.19.13-12.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-docs-1.19.13-12.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-misc-1.19.13-12.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-race-1.19.13-12.el9_2', 'sp':'2', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-src-1.19.13-12.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-tests-1.19.13-12.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
