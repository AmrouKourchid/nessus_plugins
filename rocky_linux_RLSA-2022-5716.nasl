...
# Rocky Linux Security Advisory RLSA-2022:5716.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2022:5716");

  script_name(english:"Rocky Linux 9 : grafana (RLSA-2022:5716)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2022:5716");
...
var pkgs = [
    {'reference':'grafana-7.5.11-5.el9_0', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'grafana-7.5.11-5.el9_0', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'grafana-7.5.11-5.el9_0', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'grafana-debuginfo-7.5.11-5.el9_0', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'grafana-debuginfo-7.5.11-5.el9_0', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'grafana-debuginfo-7.5.11-5.el9_0', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
