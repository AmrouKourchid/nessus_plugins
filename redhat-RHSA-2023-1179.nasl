...
# extracted from Red Hat Security Advisory RHSA-2023:1179. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:1179");

  script_name(english:"RHEL 8 : Release of OpenShift Serverless Client kn 1.27.1 (Moderate) (RHSA-2023:1179)");
...
the RHSA-2023:1179 advisory.

    Red Hat OpenShift Serverless Client kn 1.27.1 provides a CLI to interact with Red Hat OpenShift Serverless
    1.27.1. The kn CLI is delivered as an RPM package for installation on RHEL platforms, and as binaries for
    non-Linux platforms.
    ...
    - golang: net/http: An attacker can cause excessive memory growth in a Go server accepting HTTP/2
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_1179.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?99da1ce8");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:1179");
...
"Update the affected openshift-serverless-clients package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-41717");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openshift-serverless-clients-1.6.1-2.el8', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openshift-serverless-clients-1.6.1-2.el8', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openshift-serverless-clients-1.6.1-2.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
