...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 ESM / 18.04 LTS : Simple DirectMedia Layer vulnerability (USN-5398-1)");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libsdl1.2-dev', 'pkgver': '1.2.15+dfsg1-3ubuntu0.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libsdl1.2debian', 'pkgver': '1.2.15+dfsg1-3ubuntu0.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libsdl1.2-dev', 'pkgver': '1.2.15+dfsg2-0.1ubuntu0.2', 'ubuntu_pro': FALSE},
    {'osver': '18.04', 'pkgname': 'libsdl1.2debian', 'pkgver': '1.2.15+dfsg2-0.1ubuntu0.2', 'ubuntu_pro': FALSE}
];
