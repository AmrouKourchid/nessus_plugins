...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS / 22.04 LTS : ImageMagick regression (USN-5855-3)");
...
in the USN-5855-3 advisory.

    USN-5855-2 fixed vulnerabilities in ImageMagick. Unfortunately an additional mitigation caused a
