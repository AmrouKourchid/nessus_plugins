...
# extracted from Red Hat Security Advisory RHSA-2024:0094. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:0094");

  script_name(english:"RHEL 7 : Red Hat Single Sign-On 7.6.6 security update on RHEL 7 (Moderate) (RHSA-2024:0094)");
...
referenced in the RHSA-2024:0094 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0094.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6852f8fd");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0094");
...
"Update the RHEL Red Hat Single Sign-On 7.6.6 package based on the guidance in RHSA-2024:0094.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-sso7-keycloak-18.0.11-3.redhat_00001.1.el7sso', 'release':'7', 'el_string':'el7sso', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-sso'},
      {'reference':'rh-sso7-keycloak-server-18.0.11-3.redhat_00001.1.el7sso', 'release':'7', 'el_string':'el7sso', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-sso'}
    ]
  }
];
