...
# extracted from Fedora Security Advisory FEDORA-2024-278a776610
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-278a776610");
  script_xref(name:"IAVA", value:"2024-A-0053-S");

  script_name(english:"Fedora 38 : thunderbird (2024-278a776610)");
...
FEDORA-2024-278a776610 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-278a776610");
...
var pkgs = [
    {'reference':'thunderbird-115.7.0-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
