...
if (description)
{
  ...
  script_cve_id("CVE-2016-8660");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2016-8660");
...
patch available.
  ...
  - The XFS subsystem in the Linux kernel through 4.8.2 allows local users to cause a denial of service
    (fdatasync failure and system hang) by using the vfs syscall group in the trinity program, related to a
    page lock order bug in the XFS seek hole/data implementation. (CVE-2016-8660)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-8660");
