...
# extracted from SUSE update advisory SUSE-SU-2018:1319-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES11 Security Update : MozillaFirefox (SUSE-SU-2018:1319-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"This update for MozillaFirefox to ESR 52.8 release fixes the following
issues: Update to Firefox ESR 52.8 (bsc#1092548) Security issues 
fixed :
...
without introducing additional issues.");
  ...
  # https://www.suse.com/support/update/announcement/2018/suse-su-20181319-1/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?48973a18");
...
patch sdksp4-MozillaFirefox-13605=1

SUSE Linux Enterprise Server 11-SP4:zypper in -t patch
slessp4-MozillaFirefox-13605=1

SUSE Linux Enterprise Server 11-SP3-LTSS:zypper in -t patch
slessp3-MozillaFirefox-13605=1

SUSE Linux Enterprise Point of Sale 11-SP3:zypper in -t patch
sleposp3-MozillaFirefox-13605=1

SUSE Linux Enterprise Debuginfo 11-SP4:zypper in -t patch
dbgsp4-MozillaFirefox-13605=1

SUSE Linux Enterprise Debuginfo 11-SP3:zypper in -t patch
dbgsp3-MozillaFirefox-13605=1");
...
flag = 0;
if (rpm_check(release:"SLES11", sp:"4", reference:"MozillaFirefox-52.8.0esr-72.32.1")) flag++;
if (rpm_check(release:"SLES11", sp:"4", reference:"MozillaFirefox-translations-52.8.0esr-72.32.1")) flag++;
if (rpm_check(release:"SLES11", sp:"3", reference:"MozillaFirefox-52.8.0esr-72.32.1")) flag++;
if (rpm_check(release:"SLES11", sp:"3", reference:"MozillaFirefox-translations-52.8.0esr-72.32.1")) flag++;
