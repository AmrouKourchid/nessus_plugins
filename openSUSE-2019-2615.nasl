...
# extracted from openSUSE Security Update openSUSE-2019-2615.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libarchive (openSUSE-2019-2615)");
...
This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1120653");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1120654");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1124341");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1124342");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1155079");
...
if ( rpm_check(release:"SUSE15.0", reference:"bsdtar-3.3.2-lp150.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"bsdtar-debuginfo-3.3.2-lp150.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libarchive-debugsource-3.3.2-lp150.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libarchive-devel-3.3.2-lp150.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libarchive13-3.3.2-lp150.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libarchive13-debuginfo-3.3.2-lp150.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libarchive13-32bit-3.3.2-lp150.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libarchive13-32bit-debuginfo-3.3.2-lp150.10.1") ) flag++;
