...
if (description)
{
  ...
  script_cve_id("CVE-2024-23917", "CVE-2024-24942");
  script_xref(name:"IAVA", value:"2024-A-0334");
  script_xref(name:"IAVA", value:"2024-A-0069-S");

  script_name(english:"TeamCity Server < 2023.11.3 Multiple Vulnerabilities");
...
remote host is a version prior to 2023.11.3. It is, therefore, affected by
multiple vulnerabilities:

  - Authentication bypass leading to RCE vulnerability (CVE-2024-23917)

  - Path traversal allowed reading data within JAR archives vulnerability (CVE-2024-24942)
...
"Upgrade to JetBrains TeamCity version 2023.11.3 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-23917");
