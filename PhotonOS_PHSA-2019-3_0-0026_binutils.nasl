...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'binutils-2.31.1-6.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'binutils-debuginfo-2.31.1-6.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'binutils-devel-2.31.1-6.ph3')) flag++;
