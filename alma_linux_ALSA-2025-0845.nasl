...
# AlmaLinux Security Advisory ALSA-2025:0845.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2025:0845");
  script_xref(name:"RHSA", value:"2025:0845");

  script_name(english:"AlmaLinux 8 : git-lfs (ALSA-2025:0845)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2025-0845.html");
...
var pkgs = [
    ...
    {'reference':'git-lfs-3.4.1-4.el8_10', 'cpu':'ppc64le', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'git-lfs-3.4.1-4.el8_10', 'cpu':'s390x', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
