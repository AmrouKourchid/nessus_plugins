...
# extracted from Fedora Security Advisory FEDORA-2023-e4cb7a5bda
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-e4cb7a5bda");

  script_name(english:"Fedora 39 : pcs (2023-e4cb7a5bda)");
...
FEDORA-2023-e4cb7a5bda advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-e4cb7a5bda");
...
var pkgs = [
    {'reference':'pcs-0.11.6-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
