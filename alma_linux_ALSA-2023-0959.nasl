...
# AlmaLinux Security Advisory ALSA-2023:0959.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:0959");

  script_name(english:"AlmaLinux 9 : tar (ALSA-2023:0959)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2023-0959.html");
