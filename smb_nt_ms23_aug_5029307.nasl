...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5029296");
  script_xref(name:"MSKB", value:"5029307");
  script_xref(name:"MSFT", value:"MS23-5029296");
  script_xref(name:"MSFT", value:"MS23-5029307");
  ...
  script_name(english:"KB5029307: Windows Server 2008 R2 Security Update (August 2023)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5029296");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5029307");
...
if (("windows server 2008 r2" >< tolower(os_name)) && 
  smb_check_rollup(os:'6.1',
                   ...
                   rollup_date:'08_2023',
                   bulletin:bulletin,
                   rollup_kb_list:[5029307, 5029296])
)
{
