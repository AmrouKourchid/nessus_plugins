...
# extracted from SUSE update advisory SUSE-SU-2020:1581-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : texlive (SUSE-SU-2020:1581-1)");
...
without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=1138793");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=1158910");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=1159740");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2020-8016/");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2020-8017/");
  # https://www.suse.com/support/update/announcement/2020/suse-su-20201581-1/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7a6dbb61");
...
zypper in -t patch SUSE-SLE-SERVER-12-SP4-2020-1581=1");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-8016");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"4", reference:"libkpathsea6-6.2.0dev-22.8.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libkpathsea6-debuginfo-6.2.0dev-22.8.2")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libkpathsea6-6.2.0dev-22.8.2")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libkpathsea6-debuginfo-6.2.0dev-22.8.2")) flag++;
