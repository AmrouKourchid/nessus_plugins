...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Ntp PHSA-2020-2.0-0279");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'ntp-4.2.8p14-2.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'ntp-perl-4.2.8p14-2.ph2')) flag++;
