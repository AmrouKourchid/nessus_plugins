...
# extracted from Red Hat Security Advisory RHSA-2022:0464. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:0464");

  script_name(english:"RHEL 8 : aide (RHSA-2022:0464)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_0464.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?332c2f8d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:0464");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2041489");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL aide package based on the guidance in RHSA-2022:0464.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'aide-0.16-11.el8_1.1', 'sp':'1', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'aide-0.16-11.el8_1.1', 'sp':'1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
