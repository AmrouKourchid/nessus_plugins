...
# extracted from Fedora Security Advisory FEDORA-2024-b07b0b41ec
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-b07b0b41ec");

  script_name(english:"Fedora 40 : llama-cpp (2024-b07b0b41ec)");
...
FEDORA-2024-b07b0b41ec advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-b07b0b41ec");
...
var pkgs = [
    {'reference':'llama-cpp-b3561-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
