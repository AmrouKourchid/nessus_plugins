...
# extracted from Debian Security Advisory dsa-5754. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5754 : cinder-api - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 12 host has packages installed that are affected by a vulnerability as referenced in the dsa-5754
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bookworm/cinder");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'cinder-api', 'reference': '2:21.3.1-1~deb12u1'},
    {'release': '12.0', 'prefix': 'cinder-backup', 'reference': '2:21.3.1-1~deb12u1'},
    {'release': '12.0', 'prefix': 'cinder-common', 'reference': '2:21.3.1-1~deb12u1'},
    {'release': '12.0', 'prefix': 'cinder-doc', 'reference': '2:21.3.1-1~deb12u1'},
    {'release': '12.0', 'prefix': 'cinder-scheduler', 'reference': '2:21.3.1-1~deb12u1'},
    {'release': '12.0', 'prefix': 'cinder-volume', 'reference': '2:21.3.1-1~deb12u1'},
    {'release': '12.0', 'prefix': 'python3-cinder', 'reference': '2:21.3.1-1~deb12u1'}
];
