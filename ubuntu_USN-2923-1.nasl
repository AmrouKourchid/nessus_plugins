...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : BeanShell vulnerability (USN-2923-1)");
...
USN-2923-1 advisory.
    ...
    Alvaro Muoz and Christian Schneider discovered that BeanShell incorrectly handled deserialization. A
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2923-1");
  script_set_attribute(attribute:"solution", value:
"Update the affected bsh, bsh-src and / or libbsh-java packages.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:H/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-2510");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:bsh-src");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'bsh', 'pkgver': '2.0b4-15ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'bsh-src', 'pkgver': '2.0b4-15ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'libbsh-java', 'pkgver': '2.0b4-15ubuntu0.14.04.1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'bsh / bsh-src / libbsh-java');
}
