...
if (description)
{
  ...
  script_name(english:"RHEL 4 : squirrelmail (RHSA-2005:595)");
...
referenced in the RHSA-2005:595 advisory.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2005/rhsa-2005_595.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?be2a2449");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=160241");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=162275");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2005:595");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL squirrelmail package based on the guidance in RHSA-2005:595.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:P/I:N/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:R/S:C/C:L/I:L/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2005-2095");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2005-1769");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'squirrelmail-1.4.3a-12.EL4', 'release':'4', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
