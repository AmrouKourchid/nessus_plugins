...
if (description)
{
  ...
  script_name(english:"RHEL 8 : Red Hat Single Sign-On 7.3.5 security update on RHEL 8 (Important) (RHSA-2019:4042)");
...
referenced in the RHSA-2019:4042 advisory.
    ...
    This release of Red Hat Single Sign-On 7.3.5 on RHEL 8 serves as a replacement for Red Hat Single Sign-On
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a24ffaff");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/KEYCLOAK-11817");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat Single Sign-On 7.3.5 package based on the guidance in RHSA-2019:4042.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-sso7-keycloak-4.8.15-1.Final_redhat_00001.1.el8sso', 'release':'8', 'el_string':'el8sso', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-sso'},
      {'reference':'rh-sso7-keycloak-server-4.8.15-1.Final_redhat_00001.1.el8sso', 'release':'8', 'el_string':'el8sso', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-sso'}
    ]
  }
];
