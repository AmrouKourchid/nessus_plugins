...
# extracted from Red Hat Security Advisory RHSA-2021:2203. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:2203");

  script_name(english:"RHEL 7 : glib2 (RHSA-2021:2203)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for glib2.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2021:2203 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_2203.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?86d78609");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:2203");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1929858");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL glib2 package based on the guidance in RHSA-2021:2203.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'glib2-2.42.2-6.el7_2', 'sp':'2', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glib2-2.42.2-6.el7_2', 'sp':'2', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glib2-devel-2.42.2-6.el7_2', 'sp':'2', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glib2-devel-2.42.2-6.el7_2', 'sp':'2', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glib2-doc-2.42.2-6.el7_2', 'sp':'2', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glib2-fam-2.42.2-6.el7_2', 'sp':'2', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
