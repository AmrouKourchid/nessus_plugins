...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : openssl (EulerOS-SA-2025-1026)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1026
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d5012306");
...
var pkgs = [
  "openssl-1.1.1f-8.h47.r5.eulerosv2r10",
  "openssl-libs-1.1.1f-8.h47.r5.eulerosv2r10",
  "openssl-perl-1.1.1f-8.h47.r5.eulerosv2r10"
];
