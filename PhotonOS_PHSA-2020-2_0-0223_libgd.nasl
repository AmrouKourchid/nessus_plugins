...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Libgd PHSA-2020-2.0-0223");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libgd-2.2.5-6.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libgd-debuginfo-2.2.5-6.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libgd-devel-2.2.5-6.ph2')) flag++;
