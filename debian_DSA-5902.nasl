...
# extracted from Debian Security Advisory dsa-5902. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5902 : libperl-dev - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 12 host has packages installed that are affected by a vulnerability as referenced in the dsa-5902
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-56406");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bookworm/perl");
...
"Upgrade the libperl-dev packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:libperl5.36");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:perl-modules-5.36");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'libperl-dev', 'reference': '5.36.0-7+deb12u2'},
    {'release': '12.0', 'prefix': 'libperl5.36', 'reference': '5.36.0-7+deb12u2'},
    {'release': '12.0', 'prefix': 'perl', 'reference': '5.36.0-7+deb12u2'},
    {'release': '12.0', 'prefix': 'perl-base', 'reference': '5.36.0-7+deb12u2'},
    {'release': '12.0', 'prefix': 'perl-debug', 'reference': '5.36.0-7+deb12u2'},
    {'release': '12.0', 'prefix': 'perl-doc', 'reference': '5.36.0-7+deb12u2'},
    {'release': '12.0', 'prefix': 'perl-modules-5.36', 'reference': '5.36.0-7+deb12u2'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libperl-dev / libperl5.36 / perl / perl-base / perl-debug / perl-doc / etc');
}
