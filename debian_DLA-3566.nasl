...
# extracted from Debian Security Advisory dla-3566. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3566 : ruby-rails-html-sanitizer - security update");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'ruby-rails-html-sanitizer', 'reference': '1.0.4-1+deb10u2'}
];
