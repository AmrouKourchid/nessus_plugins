...
# extracted from Fedora Security Advisory FEDORA-2023-a32ad3e643
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-a32ad3e643");

  script_name(english:"Fedora 38 : chromium (2023-a32ad3e643)");
...
FEDORA-2023-a32ad3e643 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-a32ad3e643");
...
var pkgs = [
    {'reference':'chromium-120.0.6099.62-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
