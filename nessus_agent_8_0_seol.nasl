...
if (description)
{
  ...
  script_name(english:"Tenable Nessus Agent SEoL (8.0.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Tenable Nessus Agent is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Tenable Nessus Agent is 8.0.x. It is, therefore, no longer maintained by its vendor or
provider.
...
"Upgrade to a version of Tenable Nessus Agent that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2022/02/28");
...
var constraints = [
  { max_branch : '8.0', min_branch : '8.0', seol : 20220228, eseol : 20220831 }
];
