...
# extracted from Oracle Linux Security Advisory ELSA-2024-7136.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : git-lfs (ELSA-2024-7136)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-7136.html");
