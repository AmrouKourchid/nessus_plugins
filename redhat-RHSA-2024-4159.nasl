...
# extracted from Red Hat Security Advisory RHSA-2024:4159. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:4159");

  script_name(english:"RHEL 8 / 9 : OpenShift Container Platform 4.16.1 (RHSA-2024:4159)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for OpenShift Container Platform 4.16.1.");
...
in the RHSA-2024:4159 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.16.1. See the following
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_4159.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fd6b332f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:4159");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.16.1 packages based on the guidance in RHSA-2024:4159.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cri-o-1.29.5-7.rhaos4.16.git7db4ada.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'cri-o-1.29.5-7.rhaos4.16.git7db4ada.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
