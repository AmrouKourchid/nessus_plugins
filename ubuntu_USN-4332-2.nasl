...
# extracted from Ubuntu Security Notice USN-4332-2. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"4332-2");

  script_name(english:"Ubuntu 20.04 LTS : File Roller vulnerability (USN-4332-2)");
...
USN-4332-2 advisory.
    ...
    USN-4332-1 fixed vulnerabilities in File Roller. This update provides the corresponding update for Ubuntu
    20.04 LTS.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4332-2");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'file-roller', 'pkgver': '3.36.1-1ubuntu0.1'}
];
