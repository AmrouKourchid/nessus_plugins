...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : nghttp2 (ELSA-2019-2692)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ELSA-2019-2692 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2019-2692.html");
...
var pkgs = [
    ...
    {'reference':'libnghttp2-1.33.0-1.el8_0.1', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libnghttp2-devel-1.33.0-1.el8_0.1', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'nghttp2-1.33.0-1.el8_0.1', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
