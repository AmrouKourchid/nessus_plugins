...
# extracted from Red Hat Security Advisory RHSA-2025:0595. The text
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-66165");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_0595.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?885aedd4");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:0595");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL redis:6 package based on the guidance in RHSA-2025:0595.");
  ...
  script_cwe_id(20, 190, 269, 407, 416, 674, 680);
  ...
  'redis:6': [
    {
      ...
      'pkgs': [
        {'reference':'redis-6.2.17-1.module+el8.10.0+22680+748527fd', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'redis-devel-6.2.17-1.module+el8.10.0+22680+748527fd', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'redis-doc-6.2.17-1.module+el8.10.0+22680+748527fd', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
