...
# AlmaLinux Security Advisory ALSA-2025:2452.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2025:2452");
  script_xref(name:"RHSA", value:"2025:2452");

  script_name(english:"AlmaLinux 8 : firefox (ALSA-2025:2452)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2025-2452.html");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:2452");
...
"Update the affected firefox package.");
  ...
  script_cwe_id(1021, 120, 125, 416, 460, 754, 843);
...
var pkgs = [
    {'reference':'firefox-128.8.0-1.el8_10', 'cpu':'aarch64', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0', 'allowmaj':TRUE},
    {'reference':'firefox-128.8.0-1.el8_10', 'cpu':'ppc64le', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0', 'allowmaj':TRUE},
    {'reference':'firefox-128.8.0-1.el8_10', 'cpu':'s390x', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0', 'allowmaj':TRUE},
    {'reference':'firefox-128.8.0-1.el8_10', 'cpu':'x86_64', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0', 'allowmaj':TRUE}
];
