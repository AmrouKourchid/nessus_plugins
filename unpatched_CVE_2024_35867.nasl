...
if (description)
{
  ...
  script_cve_id("CVE-2024-35867");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-35867");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: smb: client: fix potential UAF in
    cifs_stats_proc_show() Skip sessions that are being teared down (status == SES_EXITING) to avoid UAF.
    (CVE-2024-35867)
