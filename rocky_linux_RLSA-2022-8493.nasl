...
# Rocky Linux Security Advisory RLSA-2022:8493.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2022:8493");

  script_name(english:"Rocky Linux 9 : python3.9 (RLSA-2022:8493)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2022:8493");
