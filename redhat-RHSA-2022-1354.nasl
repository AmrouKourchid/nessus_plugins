...
# extracted from Red Hat Security Advisory RHSA-2022:1354. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:1354");
  script_xref(name:"IAVA", value:"2022-A-0035");
  script_xref(name:"IAVA", value:"2022-A-0030-S");

  script_name(english:"RHEL 7 : rh-dotnet31-curl (RHSA-2022:1354)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for rh-dotnet31-curl.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2022:1354 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_1354.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?01eb7f95");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:1354");
...
"Update the RHEL rh-dotnet31-curl package based on the guidance in RHSA-2022:1354.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rh-dotnet31-curl");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rh-dotnet31-libcurl");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rh-dotnet31-libcurl-devel");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-dotnet31-curl-7.61.1-22.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet31'},
      {'reference':'rh-dotnet31-libcurl-7.61.1-22.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet31'},
      {'reference':'rh-dotnet31-libcurl-devel-7.61.1-22.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet31'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'rh-dotnet31-curl / rh-dotnet31-libcurl / rh-dotnet31-libcurl-devel');
}
