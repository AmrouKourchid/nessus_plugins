...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'fuse-2.9.7-3.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'fuse-debuginfo-2.9.7-3.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'fuse-devel-2.9.7-3.ph2')) flag++;
