...
# extracted from Red Hat Security Advisory RHSA-2025:1910. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:1910");

  script_name(english:"RHEL 8 / 9 : OpenShift Container Platform 4.16.37 (RHSA-2025:1910)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for OpenShift Container Platform 4.16.37.");
...
in the RHSA-2025:1910 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.16.37. See the
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_1910.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c69258f9");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:1910");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.16.37 package based on the guidance in RHSA-2025:1910.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'buildah-1.33.12-1.rhaos4.16.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'openshift-hyperkube'},
      {'reference':'buildah-tests-1.33.12-1.rhaos4.16.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'openshift-hyperkube'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'buildah-1.33.12-1.rhaos4.16.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'openshift-hyperkube'},
      {'reference':'buildah-tests-1.33.12-1.rhaos4.16.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'openshift-hyperkube'}
    ]
  }
];
