...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.0 : ruby (EulerOS-SA-2024-2199)");
...
affected by the following vulnerabilities :
    ...
    forward, and extensible.(CVE-2024-27280)

    Ruby is the interpreted scripting language for quick and easy object-oriented programming. It has many
    features to process text files and to do system management tasks (as in Perl). It is simple, straight-
    forward, and extensible.(CVE-2024-27281)

Tenable has extracted the preceding description block directly from the EulerOS Virtualization ruby security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2199
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5f42665a");
...
var pkgs = [
  "ruby-3.0.3-122.h10.eulerosv2r11",
  "ruby-help-3.0.3-122.h10.eulerosv2r11",
  "ruby-irb-3.0.3-122.h10.eulerosv2r11"
];
