...
if (description)
{
  ...
  script_name(english:"Fortinet Fortigate xss (FG-IR-20-103)");
...
vulnerability as referenced in the FG-IR-20-103 advisory.

  - An improper neutralization of input vulnerability in the FortiGate may allow a remote attacker to perform
    a stored cross site scripting attack (XSS) via the IPS and WAF logs dashboard. (CVE-2020-29010)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.fortiguard.com/psirt/FG-IR-20-103");
  script_set_attribute(attribute:"solution", value:
"Please upgrade to FortiOS version 6.0.11/6.2.5/6.4.2 or later.");
...
var constraints = [
  { 'min_version' : '6.0.0', 'max_version' : '6.0.10', 'fixed_version' : '6.0.11' },
