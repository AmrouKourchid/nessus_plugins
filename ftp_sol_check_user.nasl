...
script_end_attributes();
 ...
 script_copyright(english: "This script is Copyright (C) 2001-2024 and is owned by Tenable, Inc. or an Affiliate thereof.");
...
dbg::detailed_log(name:'ftp_func', src:SCRIPT_NAME, lvl:2, msg:"Sending data.");
