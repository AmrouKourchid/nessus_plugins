...
if (description)
{
  ...
  script_cve_id("CVE-2024-25048");
  script_xref(name:"IAVA", value:"2024-A-0264-S");

  script_name(english:"IBM MQ 9.0 <= 9.0.0.24 / 9.1 <= 9.1.0.21 / 9.2 <= 9.2.0.25 / 9.3 < 9.3.5 CD / 9.3 <= 9.3.0.17 (7149582)");

  script_set_attribute(attribute:"synopsis", value:
"The remote web server is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of IBM MQ Server running on the remote host is affected by a vulnerability as referenced in the 7149582
advisory.

  - IBM MQ is vulnerable to a heap-based buffer overflow, caused by improper bounds checking. A remote
    authenticated attacker could overflow a buffer and execute arbitrary code on the system or cause the
    server to crash. (CVE-2024-25048)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/node/7149582");
  script_set_attribute(attribute:"solution", value:
"Upgrade to IBM MQ 9.0.0.24 CU9, 9.1.0.21 CU9, 9.2.0.25 CU9, 9.3.0.17 CU9, 9.3.5 CD or later. Alternatively, install
where appropriate.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-25048");
...
else
{
  ...
  constraints = [
    { 'min_version' : '9.0', 'max_version' : '9.0.0.24', 'fixed_version' : '9.0.0.24', 'fixed_display' : '9.0.0.24 CU9' },
    { 'min_version' : '9.1', 'max_version' : '9.1.0.21', 'fixed_version' : '9.1.0.21', 'fixed_display' : '9.1.0.21 CU9' },
