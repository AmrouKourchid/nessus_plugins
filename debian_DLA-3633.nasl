...
# extracted from Debian Security Advisory dla-3633. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3633 : gir1.2-gst-plugins-bad-1.0 - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/gst-plugins-bad1.0");
...
"Upgrade the gir1.2-gst-plugins-bad-1.0 packages.");
  ...
  script_set_attribute(attribute:"patch_publication_date", value:"2023/10/28");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'gir1.2-gst-plugins-bad-1.0', 'reference': '1.14.4-1+deb10u4'},
    {'release': '10.0', 'prefix': 'gstreamer1.0-opencv', 'reference': '1.14.4-1+deb10u4'},
    {'release': '10.0', 'prefix': 'gstreamer1.0-plugins-bad', 'reference': '1.14.4-1+deb10u4'},
    {'release': '10.0', 'prefix': 'gstreamer1.0-plugins-bad-dbg', 'reference': '1.14.4-1+deb10u4'},
    {'release': '10.0', 'prefix': 'gstreamer1.0-plugins-bad-doc', 'reference': '1.14.4-1+deb10u4'},
    {'release': '10.0', 'prefix': 'libgstreamer-opencv1.0-0', 'reference': '1.14.4-1+deb10u4'},
    {'release': '10.0', 'prefix': 'libgstreamer-plugins-bad1.0-0', 'reference': '1.14.4-1+deb10u4'},
    {'release': '10.0', 'prefix': 'libgstreamer-plugins-bad1.0-dev', 'reference': '1.14.4-1+deb10u4'}
];
