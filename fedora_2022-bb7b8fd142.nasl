...
# extracted from Fedora Security Advisory FEDORA-2022-bb7b8fd142
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-bb7b8fd142");

  script_name(english:"Fedora 36 : dotnet-build-reference-packages / dotnet3.1 (2022-bb7b8fd142)");
...
FEDORA-2022-bb7b8fd142 advisory.

    This the monthly update to .NET Core 3.1 that updates .NET Core 3.1 to SDK 3.1.416 and Runtime 3.1.22.

    This includes a number of cumulative security fixes.

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-bb7b8fd142");
  script_set_attribute(attribute:"solution", value:
"Update the affected dotnet-build-reference-packages and / or dotnet3.1 packages.");
...
var pkgs = [
    {'reference':'dotnet-build-reference-packages-0-11.20220201git045b288.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'dotnet3.1-3.1.416-2.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
