...
referenced in the USN-5697-1 advisory.
    ...
    Douglas Mendizabal discovered that Barbican incorrectly handled certain query strings. A remote attacker
    could possibly use this issue to bypass the access policy.
