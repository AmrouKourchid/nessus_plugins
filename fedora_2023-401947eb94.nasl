...
# extracted from Fedora Security Advisory FEDORA-2023-401947eb94
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-401947eb94");
  script_xref(name:"IAVA", value:"2023-A-0283-S");

  script_name(english:"Fedora 37 : pypy3.9 (2023-401947eb94)");
...
FEDORA-2023-401947eb94 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-401947eb94");
...
var pkgs = [
    {'reference':'pypy3.9-7.3.11-2.3.9.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
