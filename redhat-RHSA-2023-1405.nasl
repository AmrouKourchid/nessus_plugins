...
# extracted from Red Hat Security Advisory RHSA-2023:1405. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_1405.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e9767e3c");
...
"Update the RHEL openssl package based on the guidance in RHSA-2023:1405.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openssl-1.1.1k-9.el8_7', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'openssl-devel-1.1.1k-9.el8_7', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'openssl-libs-1.1.1k-9.el8_7', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'openssl-perl-1.1.1k-9.el8_7', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
