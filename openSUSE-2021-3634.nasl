...
# openSUSE Security Update openSUSE-SU-2021:3634-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : rubygem-activerecord-5_1 (openSUSE-SU-2021:3634-1)");
...
openSUSE-SU-2021:3634-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?775fa4f1");
...
var pkgs = [
    {'reference':'ruby2.5-rubygem-activerecord-5_1-5.1.4-5.3.3', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE}
];
