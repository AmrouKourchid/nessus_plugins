...
if (description)
{
  ...
  script_name(english:"Security Updates for Microsoft SharePoint Server 2016 (Language Pack (February 2023))");
...
"The Microsoft SharePoint Server 2016 installation on the
  ...
  - An elevation of privilege vulnerability. An attacker can
    ...
    (CVE-2023-21717)");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002350");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released KB5002350 to address this issue.");
