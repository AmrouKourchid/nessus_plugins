...
if (description)
{
  ...
  script_cve_id("CVE-2023-50007");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2023-50007");
...
patch available.
  ...
  - Buffer Overflow vulnerability in Ffmpeg v.n6.1-3-g466799d4f5 allows a local attacker to execute arbitrary
    code via theav_samples_set_silence function in thelibavutil/samplefmt.c:260:9 component. (CVE-2023-50007)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-50007");
