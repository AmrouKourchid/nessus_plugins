...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'elfutils-0.176-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'elfutils-debuginfo-0.176-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'elfutils-devel-0.176-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'elfutils-devel-static-0.176-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'elfutils-libelf-0.176-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'elfutils-libelf-devel-0.176-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'elfutils-libelf-devel-static-0.176-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'elfutils-libelf-lang-0.176-1.ph2')) flag++;
