...
# extracted from Amazon Linux 2 Security Advisory ALASDOCKER-2025-053.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : runfinch-finch (ALASDOCKER-2025-053)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of runfinch-finch installed on the remote host is prior to 1.7.1-1. It is, therefore, affected by multiple
vulnerabilities as referenced in the ALAS2DOCKER-2025-053 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALASDOCKER-2025-053.html");
...
var pkgs = [
    {'reference':'runfinch-finch-1.7.1-1.amzn2.0.1', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'runfinch-finch-1.7.1-1.amzn2.0.1', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
