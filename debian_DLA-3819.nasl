...
# extracted from Debian Security Advisory dla-3819. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3819 : fossil - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has a package installed that is affected by a vulnerability as referenced in the dla-3819
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/fossil");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'fossil', 'reference': '1:2.8-1+deb10u1'}
];
