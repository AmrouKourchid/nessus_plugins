...
if (description)
{
  ...
  script_name(english:"BeyondTrust Remote Support (RS) <= 24.3.1 Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"An application running on the remote web server is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of BeyondTrust Remote Support (RS) running on the remote host is prior or equal to 24.3.1. It is,
therefore, potentially affected by multiple vulnerabilities.

  - All BeyondTrust Remote Support (RS) versions contain a command injection vulnerability which can be
  ...
  - All BeyondTrust Remote Support (RS) versions contain a command injection vulnerability that can be 
...
"Upgrade BeyondTrust Remote Support (RS) according to the vendor advisory.");
  ...
  script_dependencies("beyondtrust_remote_support_detect.nbin");
  script_require_keys("installed_sw/BeyondTrust Remote Support", "Settings/ParanoidReport");
