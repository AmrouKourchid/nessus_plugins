...
if (description)
{
  ...
  script_name(english:"Fortinet Fortigate Telnet on the SSL-VPN interface results in information leak (FG-IR-22-223)");
...
vulnerability as referenced in the FG-IR-22-223 advisory.

  - An exposure of sensitive information to an unauthorized actor vulnerabiltiy [CWE-200] in FortiOS SSL-VPN
    versions 7.2.0, versions 7.0.0 through 7.0.6 and versions 6.4.0 through 6.4.9 may allow a remote
    unauthenticated attacker to gain information about LDAP and SAML settings configured in FortiOS.
    (CVE-2022-35842)
...
"Please upgrade to FortiOS version 6.2.13/6.4.10/7.0.8/7.2.1 or later.");
