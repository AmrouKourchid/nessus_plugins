...
# extracted from Fedora Security Advisory FEDORA-2023-00484b4120
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-00484b4120");

  script_name(english:"Fedora 38 : libppd (2023-00484b4120)");
...
FEDORA-2023-00484b4120 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-00484b4120");
  script_set_attribute(attribute:"solution", value:
"Update the affected 1:libppd package.");
...
var pkgs = [
    {'reference':'libppd-2.0~rc2-4.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libppd');
}
