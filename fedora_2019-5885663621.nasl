...
# extracted from Fedora Security Advisory FEDORA-2019-5885663621.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-5885663621");

  script_name(english:"Fedora 29 : libssh2 (2019-5885663621)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-5885663621");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"libssh2-1.9.0-1.fc29")) flag++;
