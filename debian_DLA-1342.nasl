...
# extracted from Debian Security Advisory DLA-1342-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1342-1 : ldap-account-manager security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2018/04/msg00007.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/wheezy/ldap-account-manager");
...
"Upgrade the affected packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-8763");
...
flag = 0;
if (deb_check(release:"7.0", prefix:"ldap-account-manager", reference:"3.7-2+deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"ldap-account-manager-lamdaemon", reference:"3.7-2+deb7u1")) flag++;
