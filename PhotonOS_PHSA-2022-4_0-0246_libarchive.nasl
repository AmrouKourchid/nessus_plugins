...
# extracted from VMware Security Advisory PHSA-2022-4.0-0246. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Libarchive PHSA-2022-4.0-0246");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the libarchive package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-246.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libarchive-3.4.3-7.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libarchive-devel-3.4.3-7.ph4')) flag++;
