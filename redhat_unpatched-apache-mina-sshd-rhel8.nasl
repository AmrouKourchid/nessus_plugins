...
# extracted from Red Hat Security Advisory apache-mina-sshd. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2023-35887");

  script_name(english:"RHEL 8 : apache-mina-sshd (Unpatched Vulnerability) (deprecated)");
...
"This plugin has been deprecated as it does not adhere to established standards for this style of check.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-35887");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:sshd-common");
