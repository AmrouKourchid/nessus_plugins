...
repository.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K31404801");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K31404801.");
...
var vmatrix = {
  'PEM': {
    'affected': [
      '13.0.0','12.0.0-12.1.3','11.6.0-11.6.2'
    ],
    'unaffected': [
      '13.1.0','13.0.0 HF1','12.1.3.1','11.6.3'
    ],
  }
};
