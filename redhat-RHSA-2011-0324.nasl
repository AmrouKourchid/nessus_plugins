...
if (description)
{
  ...
  script_name(english:"RHEL 6 : logwatch (RHSA-2011:0324)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for logwatch.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2011/rhsa-2011_0324.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?edab03d8");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=680237");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2011:0324");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL logwatch package based on the guidance in RHSA-2011:0324.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2011-1018");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'logwatch-7.3.6-49.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
