...
# extracted from Red Hat Security Advisory RHSA-2016:0369. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2014-9649", "CVE-2014-9650");
  script_xref(name:"RHSA", value:"2016:0369");

  script_name(english:"RHEL 7 : rabbitmq-server (RHSA-2016:0369)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for rabbitmq-server.");
...
referenced in the RHSA-2016:0369 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1185514");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1185515");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1303748");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2016/rhsa-2016_0369.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2017ea5c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2016:0369");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rabbitmq-server package based on the guidance in RHSA-2016:0369.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:P/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:R/S:C/C:L/I:L/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-9650");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2014-9649");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rabbitmq-server-3.3.5-18.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
