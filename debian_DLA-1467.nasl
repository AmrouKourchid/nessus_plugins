...
# extracted from Debian Security Advisory DLA-1467-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1467-1 : ruby-zip security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2018/08/msg00013.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/jessie/ruby-zip");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"ruby-zip", reference:"1.1.6-1+deb8u2")) flag++;
