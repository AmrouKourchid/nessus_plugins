...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS : Thunderbird vulnerability (USN-5168-2)");
...
in the USN-5168-2 advisory.

    Tavis Ormandy discovered that NSS, included with Thunderbird, incorrectly handled verifying DSA/RSA-PSS
    signatures. A remote attacker could use this issue to cause Thunderbird to crash, resulting in a denial of
...
var pkgs = [
    ...
    {'osver': '20.04', 'pkgname': 'xul-ext-lightning', 'pkgver': '1:78.14.0+build1-0ubuntu0.20.04.2'}
];
