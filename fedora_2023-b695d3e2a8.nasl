...
# extracted from Fedora Security Advisory FEDORA-2023-b695d3e2a8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-b695d3e2a8");
  script_xref(name:"IAVB", value:"2023-B-0074-S");

  script_name(english:"Fedora 38 : vim (2023-b695d3e2a8)");
...
FEDORA-2023-b695d3e2a8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-b695d3e2a8");
...
var pkgs = [
    {'reference':'vim-9.0.1984-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
