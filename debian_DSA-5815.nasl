...
# extracted from Debian Security Advisory dsa-5815. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5815 : needrestart - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 12 host has a package installed that is affected by a vulnerability as referenced in the dsa-5815
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bookworm/needrestart");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'needrestart', 'reference': '3.6-4+deb12u3'}
];
