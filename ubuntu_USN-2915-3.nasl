...
# extracted from Ubuntu Security Notice USN-2915-3. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"2915-3");

  script_name(english:"Ubuntu 14.04 LTS : Django regression (USN-2915-3)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2915-3");
