...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS : Ubufox update (USN-3391-2)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3391-2");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'ubufox', 'pkgver': '3.4-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'xul-ext-ubufox', 'pkgver': '3.4-0ubuntu0.14.04.1'},
    {'osver': '16.04', 'pkgname': 'ubufox', 'pkgver': '3.4-0ubuntu0.16.04.1'},
    {'osver': '16.04', 'pkgname': 'xul-ext-ubufox', 'pkgver': '3.4-0ubuntu0.16.04.1'}
];
