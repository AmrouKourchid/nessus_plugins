...
# extracted from Ubuntu Security Notice USN-5301-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5301-2");

  script_name(english:"Ubuntu 16.04 ESM : Cyrus SASL vulnerability (USN-5301-2)");
...
USN-5301-2 advisory.
    ...
    USN-5301-1 fixed a vulnerability in Cyrus. This update provides the corresponding update for Ubuntu 14.04
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5301-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libsasl2-2', 'pkgver': '2.1.26.dfsg1-14ubuntu0.2+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libsasl2-dev', 'pkgver': '2.1.26.dfsg1-14ubuntu0.2+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libsasl2-modules', 'pkgver': '2.1.26.dfsg1-14ubuntu0.2+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libsasl2-modules-db', 'pkgver': '2.1.26.dfsg1-14ubuntu0.2+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libsasl2-modules-gssapi-heimdal', 'pkgver': '2.1.26.dfsg1-14ubuntu0.2+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libsasl2-modules-gssapi-mit', 'pkgver': '2.1.26.dfsg1-14ubuntu0.2+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libsasl2-modules-ldap', 'pkgver': '2.1.26.dfsg1-14ubuntu0.2+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libsasl2-modules-otp', 'pkgver': '2.1.26.dfsg1-14ubuntu0.2+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libsasl2-modules-sql', 'pkgver': '2.1.26.dfsg1-14ubuntu0.2+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'sasl2-bin', 'pkgver': '2.1.26.dfsg1-14ubuntu0.2+esm1', 'ubuntu_pro': TRUE}
];
