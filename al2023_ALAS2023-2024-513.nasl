...
# extracted from Amazon Linux 2023 Security Advisory ALAS2023-2024-513.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2023 : redis6 (ALAS2023-2024-513)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2023 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of redis6 installed on the remote host is prior to 6.2.14-1. It is, therefore, affected by a vulnerability
as referenced in the ALAS2023-2024-513 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2023/ALAS-2024-513.html");
...
"Run 'yum update redis6' to update your system.");
