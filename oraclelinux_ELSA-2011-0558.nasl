...
# extracted from Oracle Linux Security Advisory ELSA-2011-0558.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : perl (ELSA-2011-0558)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 6 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ELSA-2011-0558 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2011-0558.html");
...
var pkgs = [
    ...
    {'reference':'perl-Compress-Raw-Zlib-2.023-119.el6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'perl-Compress-Raw-Zlib-2.023-119.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
