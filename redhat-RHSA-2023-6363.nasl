...
# extracted from Red Hat Security Advisory RHSA-2023:6363. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:6363");

  script_name(english:"RHEL 9 : skopeo (RHSA-2023:6363)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for skopeo.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2023:6363 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?aa2b9d5f");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6363");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL skopeo package based on the guidance in RHSA-2023:6363.");
  ...
  script_cwe_id(94, 113, 176, 400, 835);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'skopeo-1.13.3-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'skopeo-tests-1.13.3-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
    ]
  }
];
