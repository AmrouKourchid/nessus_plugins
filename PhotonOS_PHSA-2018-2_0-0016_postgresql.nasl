...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Postgresql PHSA-2018-2.0-0016");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2018-1053");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'postgresql-9.6.7-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'postgresql-debuginfo-9.6.7-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'postgresql-devel-9.6.7-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'postgresql-libs-9.6.7-1.ph2')) flag++;
