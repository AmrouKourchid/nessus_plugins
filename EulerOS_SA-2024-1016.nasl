...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.0 : libxml2 (EulerOS-SA-2024-1016)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1016
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?05c2e3e2");
...
var pkgs = [
  "libxml2-2.9.10-1.h33.eulerosv2r9",
  "python3-libxml2-2.9.10-1.h33.eulerosv2r9"
];
