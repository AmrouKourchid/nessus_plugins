...
# extracted from Red Hat Security Advisory RHSA-2024:1088. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:1088");

  script_name(english:"RHEL 9 : libX11 (RHSA-2024:1088)");
...
the RHSA-2024:1088 advisory.

    The libX11 packages contain the core X11 protocol client library.

    Security Fix(es):

    * libX11: InitExt.c can overwrite unintended portions of the Display structure if the extension request
    leads to a buffer overflow (CVE-2023-3138)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_1088.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6688e9a6");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2213748");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:1088");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libX11 package based on the guidance in RHSA-2024:1088.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libX11-1.7.0-8.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libX11-common-1.7.0-8.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libX11-devel-1.7.0-8.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libX11-xcb-1.7.0-8.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
