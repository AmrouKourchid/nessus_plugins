...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2011-0496.html");
...
"Update the affected xen, xen-devel and / or xen-libs packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2011-1583");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2011-3262");
...
var pkgs = [
    {'reference':'xen-3.0.3-120.el5_6.2', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xen-devel-3.0.3-120.el5_6.2', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xen-libs-3.0.3-120.el5_6.2', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xen-3.0.3-120.el5_6.2', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xen-devel-3.0.3-120.el5_6.2', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xen-libs-3.0.3-120.el5_6.2', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
