...
# extracted from Oracle Linux Security Advisory ELSA-2023-6972.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : grafana (ELSA-2023-6972)");
...
ELSA-2023-6972 advisory.
    ...
    - resolve CVE-2022-2880 golang: net/http/httputil: ReverseProxy should not forward unparseable query
    parameters
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-6972.html");
...
var pkgs = [
    {'reference':'grafana-9.2.10-7.el8_9', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'grafana-9.2.10-7.el8_9', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
