...
if (description)
{
  ...
  script_cve_id("CVE-2024-47780");

  script_name(english:"TYPO3 10.0.0 < 10.4.46 ELTS / 11.0.0 < 11.5.40 / 12.0.0 < 12.4.21 / 13.0.0 < 13.3.1 (TYPO3-CORE-SA-2024-012)");
...
12.4.21 / 13.0.0 < 13.3.1. It is, therefore, affected by a vulnerability as referenced in the TYPO3-CORE-SA-2024-012
advisory.

  - Backend users could see items in the backend page tree without having access if the mounts pointed to
    pages restricted for their user/group, or if no mounts were configured but the pages allowed access to
    everybody. However, affected users could not manipulate these pages. (CVE-2024-47780)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://typo3.org/security/advisory/typo3-core-sa-2024-012");
...
"Upgrade to TYPO3 10.4.46 ELTS, 11.5.40, 12.4.21, 13.3.1 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-47780");
