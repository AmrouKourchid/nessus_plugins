...
# extracted from Red Hat Security Advisory RHSA-2018:0026. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:0026");
  script_xref(name:"IAVA", value:"2018-A-0020");
  script_xref(name:"IAVA", value:"2018-A-0017-S");

  script_name(english:"RHEL 7 : qemu-kvm (RHSA-2018:0026) (Spectre)");
...
issue.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:0026");
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", sp:"2", cpu:"x86_64", reference:"libcacard-1.5.3-105.el7_2.16")) flag++;
  if (rpm_check(release:"RHEL7", sp:"2", cpu:"x86_64", reference:"libcacard-devel-1.5.3-105.el7_2.16")) flag++;
  if (rpm_check(release:"RHEL7", sp:"2", cpu:"x86_64", reference:"libcacard-tools-1.5.3-105.el7_2.16")) flag++;
  if (rpm_check(release:"RHEL7", sp:"2", cpu:"x86_64", reference:"qemu-img-1.5.3-105.el7_2.16")) flag++;
  if (rpm_check(release:"RHEL7", sp:"2", cpu:"x86_64", reference:"qemu-kvm-1.5.3-105.el7_2.16")) flag++;
  if (rpm_check(release:"RHEL7", sp:"2", cpu:"x86_64", reference:"qemu-kvm-common-1.5.3-105.el7_2.16")) flag++;
  if (rpm_check(release:"RHEL7", sp:"2", cpu:"x86_64", reference:"qemu-kvm-debuginfo-1.5.3-105.el7_2.16")) flag++;
  if (rpm_check(release:"RHEL7", sp:"2", cpu:"x86_64", reference:"qemu-kvm-tools-1.5.3-105.el7_2.16")) flag++;
