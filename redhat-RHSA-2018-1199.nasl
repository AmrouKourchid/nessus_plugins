...
# extracted from Red Hat Security Advisory RHSA-2018:1199. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:1199");

  script_name(english:"RHEL 6 : patch (RHSA-2018:1199)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for patch.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2018/rhsa-2018_1199.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fd4eeb69");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:1199");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1564326");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL patch package based on the guidance in RHSA-2018:1199.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'patch-2.6-8.el6_9', 'cpu':'i686', 'release':'6', 'el_string':'el6_9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'patch-2.6-8.el6_9', 'cpu':'ppc64', 'release':'6', 'el_string':'el6_9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'patch-2.6-8.el6_9', 'cpu':'s390x', 'release':'6', 'el_string':'el6_9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'patch-2.6-8.el6_9', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
