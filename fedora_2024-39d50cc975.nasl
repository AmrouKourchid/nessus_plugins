...
# extracted from Fedora Security Advisory FEDORA-2024-39d50cc975
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-39d50cc975");
  script_xref(name:"IAVA", value:"2024-A-0244-S");

  script_name(english:"Fedora 38 : php (2024-39d50cc975)");
...
FEDORA-2024-39d50cc975 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-39d50cc975");
...
var pkgs = [
    {'reference':'php-8.2.18-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
