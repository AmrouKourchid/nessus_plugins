...
# extracted from Fedora Security Advisory FEDORA-2019-15d61c1f7f.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : memcached (2019-15d61c1f7f)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-15d61c1f7f");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"memcached-1.5.14-2.fc29")) flag++;
