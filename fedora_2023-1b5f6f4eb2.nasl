...
# extracted from Fedora Security Advisory FEDORA-2023-1b5f6f4eb2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-1b5f6f4eb2");

  script_name(english:"Fedora 38 : giflib (2023-1b5f6f4eb2)");
...
FEDORA-2023-1b5f6f4eb2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-1b5f6f4eb2");
...
var pkgs = [
    {'reference':'giflib-5.2.1-17.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
