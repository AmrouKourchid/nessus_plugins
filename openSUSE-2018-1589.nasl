...
# extracted from openSUSE Security Update openSUSE-2018-1589.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : tcpdump (openSUSE-2018-1589)");
...
This update was imported from the SUSE:SLE-12:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1117267");
...
if ( rpm_check(release:"SUSE42.3", reference:"tcpdump-4.9.2-12.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"tcpdump-debuginfo-4.9.2-12.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"tcpdump-debugsource-4.9.2-12.1") ) flag++;
