...
# extracted from VMware Security Advisory PHSA-2025-4.0-0776. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Elfutils PHSA-2025-4.0-0776");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the elfutils package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-776.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'elfutils-0.181-8.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'elfutils-devel-0.181-8.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'elfutils-devel-static-0.181-8.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'elfutils-libelf-0.181-8.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'elfutils-libelf-devel-0.181-8.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'elfutils-libelf-devel-static-0.181-8.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'elfutils-libelf-lang-0.181-8.ph4')) flag++;
