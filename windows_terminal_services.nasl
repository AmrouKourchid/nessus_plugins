...
if (description)
{
  ...
  script_name(english:"Remote Desktop Protocol Service Detection");
  script_summary(english:"Connects to the RDP server");

  script_set_attribute(attribute:"synopsis", value:
"The remote host has an remote desktop protocol service enabled.");
  script_set_attribute(attribute:"description", value:
"The Remote Desktop Protocol allows a user to remotely obtain a graphical
...
"Disable the service if you do not use it, and do not allow this
