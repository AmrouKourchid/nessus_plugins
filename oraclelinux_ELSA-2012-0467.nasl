...
# Oracle Linux Security Advisory ELSA-2012-0467 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 / 6 : freetype (ELSA-2012-0467)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2012-0467.html");
