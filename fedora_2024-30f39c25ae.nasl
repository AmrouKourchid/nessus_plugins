...
# extracted from Fedora Security Advisory FEDORA-2024-30f39c25ae
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-30f39c25ae");
  script_xref(name:"IAVB", value:"2024-B-0091-S");

  script_name(english:"Fedora 40 : kubernetes (2024-30f39c25ae)");
...
FEDORA-2024-30f39c25ae advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-30f39c25ae");
...
"Update the affected kubernetes package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-5321");
...
var pkgs = [
    {'reference':'kubernetes-1.29.7-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
