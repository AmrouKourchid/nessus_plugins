...
if (description)
{
  ...
  script_cve_id("CVE-2025-21156");
  script_xref(name:"IAVA", value:"2025-A-0088");

  script_name(english:"Adobe InCopy < 19.5.2 / 20.0 < 20.1.0 Arbitrary code execution (APSB25-10)");

  script_set_attribute(attribute:"synopsis", value:
"The Adobe InCopy instance installed on the remote host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe InCopy installed on the remote host is prior to 19.5.2, 20.1.0. It is, therefore, affected by a
vulnerability as referenced in the APSB25-10 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://helpx.adobe.com/security/products/incopy/apsb25-10.html");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Adobe InCopy version 19.5.2, 20.1.0 or later.");
  script_set_attribute(attribute:"agent", value:"all");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:N/UI:R/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-21156");
...
var constraints = [
  { 'fixed_version' : '19.5.2' },
  { 'min_version' : '20.0', 'fixed_version' : '20.1.0' }
];
