...
# extracted from Fedora Security Advisory FEDORA-2023-d966145959
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-d966145959");

  script_name(english:"Fedora 36 : python-jupyter-core (2023-d966145959)");
...
FEDORA-2023-d966145959 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-d966145959");
...
var pkgs = [
    {'reference':'python-jupyter-core-4.9.1-3.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
