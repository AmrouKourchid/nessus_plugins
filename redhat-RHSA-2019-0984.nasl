...
referenced in the RHSA-2019:0984 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_0984.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?956400d5");
...
"Update the RHEL python36:3.6 package based on the guidance in RHSA-2019:0984.");
  ...
  'python36:3.6': [
    {
      ...
      'pkgs': [
        {'reference':'python-nose-docs-1.3.7-30.module+el8.0.0+2966+d39a1df3', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python-pymongo-doc-3.6.1-9.module+el8.0.0+2966+d39a1df3', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python-sqlalchemy-doc-1.3.2-1.module+el8.0.0+2975+e0f02136', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python-virtualenv-doc-15.1.0-18.module+el8.0.0+2966+d39a1df3', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-bson-3.6.1-9.module+el8.0.0+2966+d39a1df3', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-docs-3.6.7-2.module+el8.0.0+2966+d39a1df3', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-docutils-0.14-12.module+el8.0.0+2966+d39a1df3', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-nose-1.3.7-30.module+el8.0.0+2966+d39a1df3', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-pygments-2.2.0-20.module+el8.0.0+2966+d39a1df3', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-pymongo-3.6.1-9.module+el8.0.0+2966+d39a1df3', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-pymongo-gridfs-3.6.1-9.module+el8.0.0+2966+d39a1df3', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-PyMySQL-0.8.0-10.module+el8.0.0+2966+d39a1df3', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-scipy-1.0.0-19.module+el8.0.0+2966+d39a1df3', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-sqlalchemy-1.3.2-1.module+el8.0.0+2975+e0f02136', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-virtualenv-15.1.0-18.module+el8.0.0+2966+d39a1df3', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-wheel-0.30.0-13.module+el8.0.0+2966+d39a1df3', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'python36-3.6.8-2.module+el8.0.0+2975+e0f02136', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python36-debug-3.6.8-2.module+el8.0.0+2975+e0f02136', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python36-devel-3.6.8-2.module+el8.0.0+2975+e0f02136', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python36-rpm-macros-3.6.8-2.module+el8.0.0+2975+e0f02136', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
