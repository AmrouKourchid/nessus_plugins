...
# Rocky Linux Security Advisory RLSA-2024:6913.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2024:6913");
  script_xref(name:"IAVB", value:"2024-B-0132-S");

  script_name(english:"Rocky Linux 9 : golang (RLSA-2024:6913)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2024:6913");
...
var pkgs = [
    ...
    {'reference':'go-toolset-1.21.13-3.el9_4', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'golang-1.21.13-3.el9_4', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'golang-bin-1.21.13-3.el9_4', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
