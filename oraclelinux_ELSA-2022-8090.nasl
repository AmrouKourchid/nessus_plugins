...
# extracted from Oracle Linux Security Advisory ELSA-2022-8090.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : runc (ELSA-2022-8090)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2022-8090.html");
...
var pkgs = [
    {'reference':'runc-1.1.4-1.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
    {'reference':'runc-1.1.4-1.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'}
];
