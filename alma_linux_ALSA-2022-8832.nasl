...
var appstreams = {
    'nodejs:18': [
      ...
      {'reference':'nodejs-18.12.1-1.module_el9.1.0+16+91bc168f', 'cpu':'ppc64le', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-18.12.1-1.module_el9.1.0+16+91bc168f', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      ...
      {'reference':'nodejs-devel-18.12.1-1.module_el9.1.0+16+91bc168f', 'cpu':'ppc64le', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-devel-18.12.1-1.module_el9.1.0+16+91bc168f', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      ...
      {'reference':'nodejs-full-i18n-18.12.1-1.module_el9.1.0+16+91bc168f', 'cpu':'ppc64le', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-full-i18n-18.12.1-1.module_el9.1.0+16+91bc168f', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      ...
      {'reference':'npm-8.19.2-1.18.12.1.1.module_el9.1.0+16+91bc168f', 'cpu':'ppc64le', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'npm-8.19.2-1.18.12.1.1.module_el9.1.0+16+91bc168f', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
