...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS : Linux kernel (HWE) vulnerabilities (USN-3581-2)");
...
the USN-3581-2 advisory.

    USN-3581-1 fixed vulnerabilities in the Linux kernel for Ubuntu 17.10. This update provides the
    ...
    USN-3541-2 mitigated CVE-2017-5715 (Spectre Variant 2) for the amd64 architecture in Ubuntu 16.04 LTS.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3581-2");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.13.0-1011-gcp");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.13.0-1021-oem");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.13.0-36-generic");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.13.0-36-generic-lpae");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.13.0-36-lowlatency");
...
var kernel_mappings = {
  '16.04': {
    '4.13.0': {
      'generic': '4.13.0-36',
      'generic-lpae': '4.13.0-36',
      'lowlatency': '4.13.0-36',
      'gcp': '4.13.0-1011',
      'oem': '4.13.0-1021'
    }
  }
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-3581-2');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2017-5715', 'CVE-2017-8824', 'CVE-2017-15115', 'CVE-2017-17712');
