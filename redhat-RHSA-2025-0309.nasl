...
# extracted from Red Hat Security Advisory RHSA-2025:0309. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:0309");

  script_name(english:"RHEL 9 : libreswan (RHSA-2025:0309)");
...
referenced in the RHSA-2025:0309 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_0309.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ff305a17");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:0309");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libreswan package based on the guidance in RHSA-2025:0309.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libreswan-4.9-5.el9_2.4', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
