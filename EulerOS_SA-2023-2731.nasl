...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.1 : libxml2 (EulerOS-SA-2023-2731)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2731
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c8bdb63a");
...
var pkgs = [
  "libxml2-2.9.12-5.h20.eulerosv2r11",
  "python3-libxml2-2.9.12-5.h20.eulerosv2r11"
];
