...
# extracted from VMware Security Advisory PHSA-2020-1.0-0346. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Curl PHSA-2020-1.0-0346");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the curl package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-1.0-346.md");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'curl-7.59.0-12.ph1')) flag++;
