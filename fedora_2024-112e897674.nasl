...
# extracted from Fedora Security Advisory FEDORA-2024-112e897674
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-112e897674");

  script_name(english:"Fedora 40 : python-virtualenv (2024-112e897674)");
...
FEDORA-2024-112e897674 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-112e897674");
...
var pkgs = [
    {'reference':'python-virtualenv-20.21.1-25.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
