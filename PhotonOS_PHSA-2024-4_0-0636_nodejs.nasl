...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Nodejs PHSA-2024-4.0-0636");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'nodejs-18.20.3-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'nodejs-devel-18.20.3-1.ph4')) flag++;
