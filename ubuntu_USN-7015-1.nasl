...
# extracted from Ubuntu Security Notice USN-7015-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"7015-1");

  script_name(english:"Ubuntu 20.04 LTS / 22.04 LTS / 24.04 LTS : Python vulnerabilities (USN-7015-1)");
...
vulnerabilities as referenced in the USN-7015-1 advisory.

    It was discovered that the Python email module incorrectly parsed email addresses that contain special
    characters. A remote attacker could possibly use this issue to bypass certain protection mechanisms.
    (CVE-2023-27043)

    It was discovered that Python allowed excessive backtracking while parsing certain tarfile headers. A
    remote attacker could possibly use this issue to cause Python to consume resources, leading to a denial of
    service. (CVE-2024-6232)

    It was discovered that the Python email module incorrectly quoted newlines for email headers. A remote
    attacker could possibly use this issue to perform header injection. (CVE-2024-6923)

    It was discovered that the Python http.cookies module incorrectly handled parsing cookies that contained
    backslashes for quoted characters. A remote attacker could possibly use this issue to cause Python to
    consume resources, leading to a denial of service. (CVE-2024-7592)

    It was discovered that the Python zipfile module incorrectly handled certain malformed zip files. A remote
    attacker could possibly use this issue to cause Python to stop responding, resulting in a denial of
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7015-1");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'idle-python3.8', 'pkgver': '3.8.10-0ubuntu1~20.04.12'},
    {'osver': '20.04', 'pkgname': 'libpython3.8', 'pkgver': '3.8.10-0ubuntu1~20.04.12'},
    {'osver': '20.04', 'pkgname': 'libpython3.8-dev', 'pkgver': '3.8.10-0ubuntu1~20.04.12'},
    {'osver': '20.04', 'pkgname': 'libpython3.8-minimal', 'pkgver': '3.8.10-0ubuntu1~20.04.12'},
    {'osver': '20.04', 'pkgname': 'libpython3.8-stdlib', 'pkgver': '3.8.10-0ubuntu1~20.04.12'},
    {'osver': '20.04', 'pkgname': 'libpython3.8-testsuite', 'pkgver': '3.8.10-0ubuntu1~20.04.12'},
    {'osver': '20.04', 'pkgname': 'python3.8', 'pkgver': '3.8.10-0ubuntu1~20.04.12'},
    {'osver': '20.04', 'pkgname': 'python3.8-dev', 'pkgver': '3.8.10-0ubuntu1~20.04.12'},
    {'osver': '20.04', 'pkgname': 'python3.8-examples', 'pkgver': '3.8.10-0ubuntu1~20.04.12'},
    {'osver': '20.04', 'pkgname': 'python3.8-full', 'pkgver': '3.8.10-0ubuntu1~20.04.12'},
    {'osver': '20.04', 'pkgname': 'python3.8-minimal', 'pkgver': '3.8.10-0ubuntu1~20.04.12'},
    {'osver': '20.04', 'pkgname': 'python3.8-venv', 'pkgver': '3.8.10-0ubuntu1~20.04.12'},
    {'osver': '22.04', 'pkgname': 'idle-python3.10', 'pkgver': '3.10.12-1~22.04.6'},
    {'osver': '22.04', 'pkgname': 'libpython3.10', 'pkgver': '3.10.12-1~22.04.6'},
    {'osver': '22.04', 'pkgname': 'libpython3.10-dev', 'pkgver': '3.10.12-1~22.04.6'},
    {'osver': '22.04', 'pkgname': 'libpython3.10-minimal', 'pkgver': '3.10.12-1~22.04.6'},
    {'osver': '22.04', 'pkgname': 'libpython3.10-stdlib', 'pkgver': '3.10.12-1~22.04.6'},
    {'osver': '22.04', 'pkgname': 'libpython3.10-testsuite', 'pkgver': '3.10.12-1~22.04.6'},
    {'osver': '22.04', 'pkgname': 'python3.10', 'pkgver': '3.10.12-1~22.04.6'},
    {'osver': '22.04', 'pkgname': 'python3.10-dev', 'pkgver': '3.10.12-1~22.04.6'},
    {'osver': '22.04', 'pkgname': 'python3.10-examples', 'pkgver': '3.10.12-1~22.04.6'},
    {'osver': '22.04', 'pkgname': 'python3.10-full', 'pkgver': '3.10.12-1~22.04.6'},
    {'osver': '22.04', 'pkgname': 'python3.10-minimal', 'pkgver': '3.10.12-1~22.04.6'},
    {'osver': '22.04', 'pkgname': 'python3.10-nopie', 'pkgver': '3.10.12-1~22.04.6'},
    {'osver': '22.04', 'pkgname': 'python3.10-venv', 'pkgver': '3.10.12-1~22.04.6'},
    {'osver': '24.04', 'pkgname': 'idle-python3.12', 'pkgver': '3.12.3-1ubuntu0.2'},
    {'osver': '24.04', 'pkgname': 'libpython3.12-dev', 'pkgver': '3.12.3-1ubuntu0.2'},
    {'osver': '24.04', 'pkgname': 'libpython3.12-minimal', 'pkgver': '3.12.3-1ubuntu0.2'},
    {'osver': '24.04', 'pkgname': 'libpython3.12-stdlib', 'pkgver': '3.12.3-1ubuntu0.2'},
    {'osver': '24.04', 'pkgname': 'libpython3.12-testsuite', 'pkgver': '3.12.3-1ubuntu0.2'},
    {'osver': '24.04', 'pkgname': 'libpython3.12t64', 'pkgver': '3.12.3-1ubuntu0.2'},
    {'osver': '24.04', 'pkgname': 'python3.12', 'pkgver': '3.12.3-1ubuntu0.2'},
    {'osver': '24.04', 'pkgname': 'python3.12-dev', 'pkgver': '3.12.3-1ubuntu0.2'},
    {'osver': '24.04', 'pkgname': 'python3.12-examples', 'pkgver': '3.12.3-1ubuntu0.2'},
    {'osver': '24.04', 'pkgname': 'python3.12-full', 'pkgver': '3.12.3-1ubuntu0.2'},
    {'osver': '24.04', 'pkgname': 'python3.12-minimal', 'pkgver': '3.12.3-1ubuntu0.2'},
    {'osver': '24.04', 'pkgname': 'python3.12-nopie', 'pkgver': '3.12.3-1ubuntu0.2'},
    {'osver': '24.04', 'pkgname': 'python3.12-venv', 'pkgver': '3.12.3-1ubuntu0.2'}
];
