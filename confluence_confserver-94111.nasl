...
if (description)
{
  ...
  script_cve_id("CVE-2023-6481");

  script_name(english:"Atlassian Confluence 6.0.1 < 7.19.18 / 7.20.x < 8.5.5 / 8.6.x < 8.7.2 / 8.8.0 (CONFSERVER-94111)");
...
the CONFSERVER-94111 advisory.

  - This High severity ch.qos.logback:logback-classic Dependency vulnerability was introduced in versions 6.0.1 of 
    Confluence Data Center and Server. (CVE-2023-6481)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://jira.atlassian.com/browse/CONFSERVER-94111");
...
"Upgrade to Atlassian Confluence version 7.19.18, 8.5.5, 8.7.2, 8.8.0 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-6481");
