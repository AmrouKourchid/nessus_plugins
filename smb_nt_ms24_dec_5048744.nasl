...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5048710");
  script_xref(name:"MSKB", value:"5048744");
  script_xref(name:"MSFT", value:"MS24-5048710");
  script_xref(name:"MSFT", value:"MS24-5048744");
  ...
  script_name(english:"KB5048744: Windows Server 2008 Security Update (December 2024)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5048744. It is, therefore, affected by multiple vulnerabilities
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5048710");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5048744");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5048744 or Cumulative Update 5048710");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:H/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:H/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-49125");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2024-49112");
...
if (
  smb_check_rollup(os:'6.0',
                   ...
                   rollup_date:'12_2024',
                   bulletin:bulletin,
                   rollup_kb_list:[5048744, 5048710])
)
{
