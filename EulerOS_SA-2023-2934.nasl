...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.0 : dbus (EulerOS-SA-2023-2934)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2934
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bafbce57");
...
var pkgs = [
  "dbus-1.12.16-15.h7.eulerosv2r10",
  "dbus-common-1.12.16-15.h7.eulerosv2r10",
  "dbus-daemon-1.12.16-15.h7.eulerosv2r10",
  "dbus-libs-1.12.16-15.h7.eulerosv2r10",
  "dbus-tools-1.12.16-15.h7.eulerosv2r10"
];
