...
# extracted from F5 Networks BIG-IP Solution K21548854.
#
# @NOAGENT@
##
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : zlib vulnerability (K21548854)");

  script_set_attribute(attribute:"synopsis", value:
"The remote device is missing a vendor-supplied security patch.");
  script_set_attribute(attribute:"description", value:
"The version of F5 Networks BIG-IP installed on the remote host is prior to tested version. It is, therefore, affected by
a vulnerability as referenced in the K21548854 advisory.

    zlib before 1.2.12 allows memory corruption when deflating (i.e., when compressing) if the input has many
    distant matches.(CVE-2018-25032)ImpactThis vulnerability results in corrupted output, which leads to out-
    of-bound access, corrupting the memory and potentially causing the application to no longer respond.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K21548854");
...
var vmatrix = {
  'AFM': {
    'affected': [
      '17.5.0 17.0.0-17.1.2','16.1.0-16.1.6','15.1.0-15.1.10','14.1.0-14.1.5','13.1.0-13.1.5'
    ],
  },
  'APM': {
    'affected': [
