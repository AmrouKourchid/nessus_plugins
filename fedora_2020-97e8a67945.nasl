...
# extracted from Fedora Security Advisory FEDORA-2020-97e8a67945.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-97e8a67945");

  script_name(english:"Fedora 31 : golang-github-buger-jsonparser (2020-97e8a67945)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-97e8a67945");
...
"Update the affected golang-github-buger-jsonparser package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-10675");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"golang-github-buger-jsonparser-0-0.8.20200406gitf7e751e.fc31")) flag++;
