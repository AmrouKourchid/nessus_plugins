...
# extracted from Red Hat Security Advisory json-c,_libfastjson. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 6 : json-c,_libfastjson (Unpatched Vulnerability) (deprecated)");
