...
# extracted from Fedora Security Advisory FEDORA-2022-12790ca71a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-12790ca71a");

  script_name(english:"Fedora 36 : moby-engine (2022-12790ca71a)");
...
FEDORA-2022-12790ca71a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-12790ca71a");
...
var pkgs = [
    {'reference':'moby-engine-20.10.20-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
