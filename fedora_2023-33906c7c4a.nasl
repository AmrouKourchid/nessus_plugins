...
# extracted from Fedora Security Advisory FEDORA-2023-33906c7c4a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-33906c7c4a");

  script_name(english:"Fedora 38 : libpcap / tcpdump (2023-33906c7c4a)");
...
FEDORA-2023-33906c7c4a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-33906c7c4a");
  script_set_attribute(attribute:"solution", value:
"Update the affected 14:libpcap and / or 14:tcpdump packages.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:N/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:R/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-1801");
...
var pkgs = [
    {'reference':'libpcap-1.10.4-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'14'},
    {'reference':'tcpdump-4.99.4-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'14'}
];
