...
# extracted from Fedora Security Advisory FEDORA-2023-e82fd2abcb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-e82fd2abcb");

  script_name(english:"Fedora 38 : exercism (2023-e82fd2abcb)");
...
FEDORA-2023-e82fd2abcb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-e82fd2abcb");
...
var pkgs = [
    {'reference':'exercism-3.2.0-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
