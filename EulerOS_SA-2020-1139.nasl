...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : wireshark (EulerOS-SA-2020-1139)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1139
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dc49ad3d");
...
pkgs = ["wireshark-1.10.14-14.h4.eulerosv2r7",
        "wireshark-gnome-1.10.14-14.h4.eulerosv2r7"];
