...
# extracted from Fedora Security Advisory FEDORA-2022-20116fb6aa
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-20116fb6aa");

  script_name(english:"Fedora 37 : pypy3.8 (2022-20116fb6aa)");
...
FEDORA-2022-20116fb6aa advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-20116fb6aa");
...
var pkgs = [
    {'reference':'pypy3.8-7.3.9-5.3.8.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
