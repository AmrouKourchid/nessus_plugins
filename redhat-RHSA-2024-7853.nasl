...
# extracted from Red Hat Security Advisory RHSA-2024:7853. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:7853");

  script_name(english:"RHEL 9 : thunderbird (RHSA-2024:7853)");
...
referenced in the RHSA-2024:7853 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b84c86ee");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:7853");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL thunderbird package based on the guidance in RHSA-2024:7853.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'thunderbird-128.3.0-1.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
