...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS : Redis vulnerability (USN-5316-1)");
...
USN-5316-1 advisory.
    ...
    Reginaldo Silva discovered that due to a packaging issue, a remote attacker with the ability to execute
    arbitrary Lua scripts could possibly escape the Lua sandbox and execute arbitrary code on the host.
