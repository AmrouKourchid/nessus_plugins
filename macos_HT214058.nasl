...
if (description)
{
  ...
  script_xref(name:"APPLE-SA", value:"HT214058");
  ...
  script_name(english:"macOS 13.x < 13.6.4 Multiple Vulnerabilities (HT214058)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host is missing a macOS update that fixes multiple vulnerabilities");
  script_set_attribute(attribute:"description", value:
"The remote host is running a version of macOS / Mac OS X that is 13.x prior to 13.6.4. It is, therefore, affected by
multiple vulnerabilities:
  ...
  - This issue was addressed by removing the vulnerable code. This issue is fixed in tvOS 17, watchOS 10,
    macOS Sonoma 14, iOS 17 and iPadOS 17, macOS Ventura 13.6.4. An app may be able to bypass Privacy
    preferences. (CVE-2023-40528)
...
version number.");
  script_set_attribute(attribute:"see_also", value:"https://support.apple.com/en-us/HT214058");
  script_set_attribute(attribute:"solution", value:
"Upgrade to macOS 13.6.4 or later.");
...
var constraints = [
  { 'fixed_version' : '13.6.4', 'min_version' : '13.0', 'fixed_display' : 'macOS Ventura 13.6.4' }
];
