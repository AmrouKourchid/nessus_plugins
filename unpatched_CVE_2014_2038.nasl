...
if (description)
{
  ...
  script_cve_id("CVE-2014-2038");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2014-2038");
...
patch available.
  ...
  - The nfs_can_extend_write function in fs/nfs/write.c in the Linux kernel before 3.13.3 relies on a write
    ...
    an NFS filesystem and then reading the same file. (CVE-2014-2038)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-2038");
