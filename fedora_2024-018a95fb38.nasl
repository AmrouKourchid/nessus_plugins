...
# extracted from Fedora Security Advisory FEDORA-2024-018a95fb38
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-018a95fb38");

  script_name(english:"Fedora 39 : libopenmpt (2024-018a95fb38)");
...
FEDORA-2024-018a95fb38 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-018a95fb38");
...
var pkgs = [
    {'reference':'libopenmpt-0.7.8-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
