...
# extracted from Fedora Security Advisory FEDORA-2019-68333329e0.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-68333329e0");

  script_name(english:"Fedora 30 : memcached (2019-68333329e0)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-68333329e0");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"memcached-1.5.14-2.fc30")) flag++;
