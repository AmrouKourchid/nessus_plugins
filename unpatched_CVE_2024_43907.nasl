...
if (description)
{
  ...
  script_cve_id("CVE-2024-43907");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-43907");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: drm/amdgpu/pm: Fix the null pointer
    dereference in apply_state_adjust_rules Check the pointer value to fix potential null pointer dereference
    (CVE-2024-43907)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-43907");
