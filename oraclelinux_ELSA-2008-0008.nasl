...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : Moderate: / httpd (ELSA-2008-0008)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2008-0008.html");
...
var pkgs = [
    {'reference':'httpd-2.2.3-11.el5_1.3.0.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'httpd-devel-2.2.3-11.el5_1.3.0.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'httpd-manual-2.2.3-11.el5_1.3.0.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'mod_ssl-2.2.3-11.el5_1.3.0.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'httpd-2.2.3-11.el5_1.3.0.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'httpd-devel-2.2.3-11.el5_1.3.0.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'httpd-manual-2.2.3-11.el5_1.3.0.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'mod_ssl-2.2.3-11.el5_1.3.0.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
