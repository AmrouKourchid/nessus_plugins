...
# extracted from Red Hat Security Advisory openssl097a. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2011-5095", "CVE-2015-0289");

  script_name(english:"RHEL 6 : openssl097a (Unpatched Vulnerability) (deprecated)");
