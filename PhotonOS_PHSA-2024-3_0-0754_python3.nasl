...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Python3 PHSA-2024-3.0-0754");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'python3-pycryptodomex-3.20.0-1.ph3')) flag++;
