...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_3497.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?83602a98");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1686488");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL http-parser package based on the guidance in RHSA-2019:3497.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'http-parser-2.8.0-5.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
