...
# extracted from Ubuntu Security Notice USN-6260-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6260-1");

  script_name(english:"Ubuntu 22.04 LTS : Linux kernel vulnerabilities (USN-6260-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6260-1");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.19.0-1029-aws");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.19.0-1030-gcp");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.19.0-50-generic");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.19.0-50-generic-64k");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.19.0-50-generic-lpae");
...
var kernel_mappings = {
  '22.04': {
    '5.19.0': {
      'generic': '5.19.0-50',
      'generic-64k': '5.19.0-50',
      'generic-lpae': '5.19.0-50',
      'aws': '5.19.0-1029',
      'gcp': '5.19.0-1030'
    }
  }
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-6260-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2022-48502', 'CVE-2023-2640', 'CVE-2023-3090', 'CVE-2023-3141', 'CVE-2023-3389', 'CVE-2023-3390', 'CVE-2023-31248', 'CVE-2023-32629', 'CVE-2023-35001');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-6260-1');
  }
  else
  {
