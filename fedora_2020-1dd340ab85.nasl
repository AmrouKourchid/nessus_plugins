...
# extracted from Fedora Security Advisory FEDORA-2020-1dd340ab85.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-1dd340ab85");

  script_name(english:"Fedora 31 : sleuthkit (2020-1dd340ab85)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-1dd340ab85");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"sleuthkit-4.9.0-1.fc31")) flag++;
