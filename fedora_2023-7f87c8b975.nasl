...
# extracted from Fedora Security Advisory FEDORA-2023-7f87c8b975
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-7f87c8b975");

  script_name(english:"Fedora 37 : chromium (2023-7f87c8b975)");
...
FEDORA-2023-7f87c8b975 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-7f87c8b975");
...
var pkgs = [
    {'reference':'chromium-118.0.5993.117-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
