...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.2 : e2fsprogs (EulerOS-SA-2020-1272)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1272
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?edc5fd8f");
...
pkgs = ["e2fsprogs-1.45.0-1.h2",
        "e2fsprogs-libs-1.45.0-1.h2",
        "libcom_err-1.45.0-1.h2",
        "libcom_err-devel-1.45.0-1.h2",
        "libss-1.45.0-1.h2"];
