...
if (description)
{
  ...
  script_name(english:"Tenable Nessus SEoL (6.7.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Tenable Nessus is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Tenable Nessus is 6.7.x. It is, therefore, no longer maintained by its vendor or provider.
...
"Upgrade to a version of Tenable Nessus that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2017/11/30");
...
var constraints = [
  { max_branch : '6.7', min_branch : '6.7', seol : 20171130, eseol : 20180531 }
];
