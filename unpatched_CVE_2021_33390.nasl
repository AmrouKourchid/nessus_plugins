...
if (description)
{
  ...
  script_cve_id("CVE-2021-33390");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2021-33390");
...
patch available.
  ...
  - dpic 2021.04.10 has a use-after-free in thedeletestringbox() function in dpic.y. A different
    vulnerablility than CVE-2021-32421. (CVE-2021-33390)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-33390");
