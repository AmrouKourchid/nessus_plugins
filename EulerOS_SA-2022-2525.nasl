...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : openssl (EulerOS-SA-2022-2525)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2525
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?084e4e02");
...
var pkgs = [
  "openssl-1.0.2k-16.h16.eulerosv2r7",
  "openssl-devel-1.0.2k-16.h16.eulerosv2r7",
  "openssl-libs-1.0.2k-16.h16.eulerosv2r7"
];
