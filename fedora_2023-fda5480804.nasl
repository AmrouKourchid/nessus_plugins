...
# extracted from Fedora Security Advisory FEDORA-2023-fda5480804
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-fda5480804");

  script_name(english:"Fedora 36 : awstats (2023-fda5480804)");
...
FEDORA-2023-fda5480804 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-fda5480804");
...
"Update the affected awstats package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:awstats");
...
var pkgs = [
    {'reference':'awstats-7.8-9.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
