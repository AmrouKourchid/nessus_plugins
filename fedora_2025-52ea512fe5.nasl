...
# extracted from Fedora Security Advisory FEDORA-2025-52ea512fe5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-52ea512fe5");
  script_xref(name:"IAVA", value:"2025-A-0010-S");

  script_name(english:"Fedora 40 : chromium (2025-52ea512fe5)");
...
FEDORA-2025-52ea512fe5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-52ea512fe5");
...
var pkgs = [
    {'reference':'chromium-131.0.6778.264-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
