...
# extracted from Fedora Security Advisory FEDORA-2022-cfe50b5ebb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-cfe50b5ebb");

  script_name(english:"Fedora 37 : golang-github-containerd-imgcrypt (2022-cfe50b5ebb)");
...
FEDORA-2022-cfe50b5ebb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-cfe50b5ebb");
  script_set_attribute(attribute:"solution", value:
"Update the affected golang-github-containerd-imgcrypt package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:golang-github-containerd-imgcrypt");
...
var pkgs = [
    {'reference':'golang-github-containerd-imgcrypt-1.1.4-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'golang-github-containerd-imgcrypt');
}
