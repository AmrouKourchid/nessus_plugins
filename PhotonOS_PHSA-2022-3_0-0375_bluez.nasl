...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Bluez PHSA-2022-3.0-0375");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'bluez-5.58-4.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'bluez-devel-5.58-4.ph3')) flag++;
