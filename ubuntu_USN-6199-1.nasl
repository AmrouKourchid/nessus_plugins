...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS / 22.04 LTS / 23.04 : PHP vulnerability (USN-6199-1)");
...
referenced in the USN-6199-1 advisory.

    It was discovered that PHP incorrectly handled certain Digest authentication for SOAP. An attacker could
