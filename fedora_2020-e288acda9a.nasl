...
# extracted from Fedora Security Advisory FEDORA-2020-e288acda9a.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : kernel (2020-e288acda9a)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-e288acda9a");
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for FEDORA-2020-e288acda9a");
  }
  else
  {
...
flag = 0;
if (rpm_check(release:"FC32", reference:"kernel-5.8.15-201.fc32")) flag++;
