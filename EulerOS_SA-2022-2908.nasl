...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.0 : libldb (EulerOS-SA-2022-2908)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2908
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1f217564");
...
var pkgs = [
  "libldb-2.0.12-1.h4.eulerosv2r10"
];
