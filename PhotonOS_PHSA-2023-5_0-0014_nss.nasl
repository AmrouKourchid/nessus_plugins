...
# extracted from VMware Security Advisory PHSA-2023-5.0-0014. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Nss PHSA-2023-5.0-0014");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the nss package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-5.0-14.md");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-3479");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'nss-3.78-5.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'nss-devel-3.78-5.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'nss-libs-3.78-5.ph5')) flag++;
