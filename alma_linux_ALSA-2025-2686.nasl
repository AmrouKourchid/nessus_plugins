...
# AlmaLinux Security Advisory ALSA-2025:2686.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2025:2686");
  script_xref(name:"RHSA", value:"2025:2686");

  script_name(english:"AlmaLinux 8 : libxml2 (ALSA-2025:2686)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ALSA-2025:2686 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2025-2686.html");
...
var pkgs = [
    {'reference':'libxml2-2.9.7-19.el8_10', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'libxml2-devel-2.9.7-19.el8_10', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'python3-libxml2-2.9.7-19.el8_10', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'}
];
