...
include("structured_data_authentication_status_information.inc");
include("structured_data_package_manager_packages.inc");
include("structured_data_system_asset_info.inc");
