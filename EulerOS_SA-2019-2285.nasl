...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : libmspack (EulerOS-SA-2019-2285)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2285
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d997a073");
...
pkgs = ["libmspack-0.7-0.1.alpha.h4.eulerosv2r8"];
