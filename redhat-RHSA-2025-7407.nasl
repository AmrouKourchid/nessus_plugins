...
# extracted from Red Hat Security Advisory RHSA-2025:7407. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:7407");

  script_name(english:"RHEL 9 : opentelemetry-collector (RHSA-2025:7407)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for opentelemetry-collector.");
...
referenced in the RHSA-2025:7407 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2348366");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2352914");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2354195");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_7407.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?31af1062");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:7407");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL opentelemetry-collector package based on the guidance in RHSA-2025:7407.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-30204");

  script_set_attribute(attribute:"exploitability_ease", value:"No known exploits are available");
  script_set_attribute(attribute:"exploit_available", value:"false");
  script_cwe_id(405, 770, 1286);
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:opentelemetry-collector");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'opentelemetry-collector-0.107.0-8.el9_6', 'sp':'6', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'opentelemetry-collector-0.107.0-8.el9_6', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'opentelemetry-collector');
}
