...
if (description)
{
  ...
  script_cve_id("CVE-2018-8799");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2018-8799");
...
patch available.
  ...
  - rdesktop versions up to and including v1.8.3 contain an Out-Of-Bounds Read in function
    process_secondary_order() that results in a Denial of Service (segfault). (CVE-2018-8799)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-8799");
