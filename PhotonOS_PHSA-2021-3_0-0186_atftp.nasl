...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Atftp PHSA-2021-3.0-0186");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'atftp-0.7.2-2.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'atftp-client-0.7.2-2.ph3')) flag++;
