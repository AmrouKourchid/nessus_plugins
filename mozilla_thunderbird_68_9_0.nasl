...
"The version of Thunderbird installed on the remote Windows host is prior to 68.9.0. It is, therefore, affected by
multiple vulnerabilities as referenced in the mfsa2020-22 advisory.
...
mozilla_check_version(installs:installs, product:'thunderbird', esr:FALSE, fix:'68.9.0', severity:SECURITY_HOLE);
