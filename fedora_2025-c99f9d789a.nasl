...
# extracted from Fedora Security Advisory FEDORA-2025-c99f9d789a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-c99f9d789a");

  script_name(english:"Fedora 41 : microcode_ctl (2025-c99f9d789a)");
...
FEDORA-2025-c99f9d789a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-c99f9d789a");
...
var pkgs = [
    {'reference':'microcode_ctl-2.1-67.1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
