...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.6.0 : ghostscript (EulerOS-SA-2021-1539)");
...
affected by the following vulnerabilities :
  ...
  - A use-after-free vulnerability in
    xps_finish_image_path() in devices/vector/gdevxps.c of
  ...
  - A use after free was found in igc_reloc_struct_ptr() of
    psi/igc.c of ghostscript-9.25. A local attacker could
    supply a specially crafted PDF file to cause a denial
    of service.(CVE-2020-14373)
  ...
  - A null pointer dereference vulnerability in
    devices/vector/gdevtxtw.c and psi/zbfont.c of Artifex
    Software GhostScript v9.50 allows a remote attacker to
    cause a denial of service via a crafted postscript
    file. This is fixed in v9.51.(CVE-2020-16307)

  - A null pointer dereference vulnerability in
    devices/gdevtsep.c of Artifex Software GhostScript
    v9.50 allows a remote attacker to cause a denial of
    service via a crafted postscript file. This is fixed in
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1539
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?208a8ac5");
