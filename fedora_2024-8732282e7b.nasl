...
# extracted from Fedora Security Advisory FEDORA-2024-8732282e7b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-8732282e7b");

  script_name(english:"Fedora 39 : python3.6 (2024-8732282e7b)");
...
FEDORA-2024-8732282e7b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-8732282e7b");
...
var pkgs = [
    {'reference':'python3.6-3.6.15-23.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
