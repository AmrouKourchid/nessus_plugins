...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : libxcursor (EulerOS-SA-2018-1438)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1438
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?12a8d546");
...
pkgs = ["libXcursor-1.1.14-8.h2",
        "libXcursor-devel-1.1.14-8.h2"];
