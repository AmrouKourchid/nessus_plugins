...
if ( rpm_check(release:"SUSE15.0", reference:"chromium-76.0.3809.100-lp150.229.1", allowmaj:TRUE) ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"chromium-debuginfo-76.0.3809.100-lp150.229.1", allowmaj:TRUE) ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"chromium-debugsource-76.0.3809.100-lp150.229.1", allowmaj:TRUE) ) flag++;
