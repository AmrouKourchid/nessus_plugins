...
# extracted from Fedora Security Advisory FEDORA-2023-026c8ba371
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-026c8ba371");

  script_name(english:"Fedora 38 : openssl (2023-026c8ba371)");
...
FEDORA-2023-026c8ba371 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-026c8ba371");
...
var pkgs = [
    {'reference':'openssl-3.0.9-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
