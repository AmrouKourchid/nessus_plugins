...
# extracted from Debian Security Advisory dsa-5795. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5795 : python3-sql - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 12 host has a package installed that is affected by a vulnerability as referenced in the dsa-5795
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bookworm/python-sql");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'python3-sql', 'reference': '1.4.0-1+deb12u1'}
];
