...
# extracted from Red Hat Security Advisory RHSA-2020:4183 and
# CentOS Errata and Security Advisory 2020:4183 respectively.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : bind (RHSA-2020:4183)");
...
var pkgs = [
    {'reference':'bind-9.8.2-0.68.rc1.el6', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
    {'reference':'bind-chroot-9.8.2-0.68.rc1.el6', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
    {'reference':'bind-devel-9.8.2-0.68.rc1.el6', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
    {'reference':'bind-libs-9.8.2-0.68.rc1.el6', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
    {'reference':'bind-sdb-9.8.2-0.68.rc1.el6', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
    {'reference':'bind-utils-9.8.2-0.68.rc1.el6', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'}
];
