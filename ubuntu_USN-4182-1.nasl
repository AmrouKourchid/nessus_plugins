...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS : Intel Microcode update (USN-4182-1)");
...
referenced in the USN-4182-1 advisory.
    ...
    It was discovered that certain Intel Xeon processors did not properly restrict access to a voltage
    modulation interface. A local privileged attacker could use this to cause a denial of service (system
    crash). (CVE-2019-11139)

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4182-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'intel-microcode', 'pkgver': '3.20191112-0ubuntu0.16.04.2'},
    {'osver': '18.04', 'pkgname': 'intel-microcode', 'pkgver': '3.20191112-0ubuntu0.18.04.2'}
];
