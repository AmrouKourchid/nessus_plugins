...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Libjpeg PHSA-2021-3.0-0254");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libjpeg-turbo-2.1.0-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libjpeg-turbo-devel-2.1.0-1.ph3')) flag++;
