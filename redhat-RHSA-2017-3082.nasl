...
# extracted from Red Hat Security Advisory RHSA-2017:3082. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2017:3082");

  script_name(english:"RHEL 6 : chromium-browser (RHSA-2017:3082)");
...
referenced in the RHSA-2017:3082 advisory.

  - , CVE-2017-15406 chromium-browser: stack overflow in v8 (CVE-2017-15396, CVE-2017-15406)

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  # https://chromereleases.googleblog.com/2017/10/stable-channel-update-for-desktop_26.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6133a3fa");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2017/rhsa-2017_3082.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8685ddb1");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2017:3082");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1506942");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL chromium-browser package based on the guidance in RHSA-2017:3082.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:R/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-15406");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'chromium-browser-62.0.3202.75-1.el6_9', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'chromium-browser-62.0.3202.75-1.el6_9', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
