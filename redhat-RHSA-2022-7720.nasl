...
# extracted from Red Hat Security Advisory RHSA-2022:7720. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:7720");

  script_name(english:"RHEL 8 : e2fsprogs (RHSA-2022:7720)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for e2fsprogs.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2022:7720 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_7720.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?06861506");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/8.7_release_notes/index
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?790bc9ea");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:7720");
...
"Update the RHEL e2fsprogs package based on the guidance in RHSA-2022:7720.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'e2fsprogs-1.45.6-5.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'e2fsprogs-devel-1.45.6-5.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'e2fsprogs-libs-1.45.6-5.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libcom_err-1.45.6-5.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libcom_err-devel-1.45.6-5.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libss-1.45.6-5.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libss-devel-1.45.6-5.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'e2fsprogs / e2fsprogs-devel / e2fsprogs-libs / libcom_err / etc');
}
