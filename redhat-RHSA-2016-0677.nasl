...
# extracted from Red Hat Security Advisory RHSA-2016:0677. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2016:0677");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2023/06/02");

  script_name(english:"RHEL 7 : java-1.8.0-oracle (RHSA-2016:0677)");
...
referenced in the RHSA-2016:0677 advisory.
    ...
    * This update fixes multiple vulnerabilities in the Oracle Java Runtime Environment and the Oracle Java
    ...
    Critical Patch Update Advisory page, listed in the References section. (CVE-2016-0686, CVE-2016-0687,
    CVE-2016-0695, CVE-2016-3422, CVE-2016-3425, CVE-2016-3426, CVE-2016-3427, CVE-2016-3443, CVE-2016-3449)

Tenable has extracted the preceding description block directly from the Red Hat Enterprise Linux security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2016/rhsa-2016_0677.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2474c18e");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2016:0677");
...
"Update the RHEL java-1.8.0-oracle package based on the guidance in RHSA-2016:0677.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'java-1.8.0-oracle-1.8.0.91-1jpp.1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.8.0-oracle-devel-1.8.0.91-1jpp.1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.8.0-oracle-javafx-1.8.0.91-1jpp.1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.8.0-oracle-jdbc-1.8.0.91-1jpp.1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.8.0-oracle-plugin-1.8.0.91-1jpp.1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.8.0-oracle-src-1.8.0.91-1jpp.1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
