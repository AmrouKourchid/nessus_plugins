...
if (description)
{
  ...
  script_cve_id("CVE-2022-48285");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-48285");
...
patch available.
  ...
  - loadAsync in JSZip before 3.8.0 allows Directory Traversal via a crafted ZIP archive. (CVE-2022-48285)
