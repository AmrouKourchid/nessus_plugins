...
# extracted from Debian Security Advisory DSA-4158. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"4158");

  script_name(english:"Debian DSA-4158-1 : openssl1.0 - security update");
...
https://www.openssl.org/news/secadv/20180327.txt");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2018/dsa-4158");
...
flag = 0;
if (deb_check(release:"9.0", prefix:"libssl1.0-dev", reference:"1.0.2l-2+deb9u3")) flag++;
if (deb_check(release:"9.0", prefix:"libssl1.0.2", reference:"1.0.2l-2+deb9u3")) flag++;
