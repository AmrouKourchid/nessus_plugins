...
# extracted from Red Hat Security Advisory RHSA-2018:3249 and 
# Oracle Linux Security Advisory ELSA-2018-3249 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : setup (ELSA-2018-3249)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2018-3249.html");
...
"Update the affected setup package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:setup");
...
var pkgs = [
    {'reference':'setup-2.8.71-10.el7', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
];
