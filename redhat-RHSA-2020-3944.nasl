...
# extracted from Red Hat Security Advisory RHSA-2020:3944. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2019-17400");
  script_xref(name:"RHSA", value:"2020:3944");

  script_name(english:"RHEL 7 : unoconv (RHSA-2020:3944)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for unoconv.");
...
the RHSA-2020:3944 advisory.

    Universal Office Converter (unoconv) is a command line tool to convert any document format that
    LibreOffice can import to any document format that LibreOffice can export. It makes use of the
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_3944.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fe186c00");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:3944");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1765007");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL unoconv package based on the guidance in RHSA-2020:3944.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:N/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-17400");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:unoconv");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'unoconv-0.6-8.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'unoconv');
}
