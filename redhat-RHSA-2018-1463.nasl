...
referenced in the RHSA-2018:1463 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2018/rhsa-2018_1463.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d3efccbf");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:1463");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1568966");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL java-1.8.0-ibm package based on the guidance in RHSA-2018:1463.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'java-1.8.0-ibm-1.8.0.5.10-1jpp.1.el6_9', 'cpu':'s390x', 'release':'6', 'el_string':'el6_9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.8.0-ibm-1.8.0.5.10-1jpp.1.el6_9', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.8.0-ibm-devel-1.8.0.5.10-1jpp.1.el6_9', 'cpu':'s390x', 'release':'6', 'el_string':'el6_9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.8.0-ibm-devel-1.8.0.5.10-1jpp.1.el6_9', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
