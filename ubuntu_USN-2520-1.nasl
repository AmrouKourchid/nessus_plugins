...
# extracted from Ubuntu Security Notice USN-2520-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : CUPS vulnerability (USN-2520-1)");
...
USN-2520-1 advisory.
    ...
    Peter De Wachter discovered that CUPS incorrectly handled certain malformed compressed raster files. A
    remote attacker could use this issue to cause CUPS to crash, resulting in a denial of service, or possibly
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2520-1");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-9679");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'cups', 'pkgver': '1.7.2-0ubuntu1.5'},
    {'osver': '14.04', 'pkgname': 'cups-bsd', 'pkgver': '1.7.2-0ubuntu1.5'},
    {'osver': '14.04', 'pkgname': 'cups-client', 'pkgver': '1.7.2-0ubuntu1.5'},
    {'osver': '14.04', 'pkgname': 'cups-common', 'pkgver': '1.7.2-0ubuntu1.5'},
    {'osver': '14.04', 'pkgname': 'cups-core-drivers', 'pkgver': '1.7.2-0ubuntu1.5'},
    {'osver': '14.04', 'pkgname': 'cups-daemon', 'pkgver': '1.7.2-0ubuntu1.5'},
    {'osver': '14.04', 'pkgname': 'cups-ppdc', 'pkgver': '1.7.2-0ubuntu1.5'},
    {'osver': '14.04', 'pkgname': 'cups-server-common', 'pkgver': '1.7.2-0ubuntu1.5'},
    {'osver': '14.04', 'pkgname': 'libcups2', 'pkgver': '1.7.2-0ubuntu1.5'},
    {'osver': '14.04', 'pkgname': 'libcups2-dev', 'pkgver': '1.7.2-0ubuntu1.5'},
    {'osver': '14.04', 'pkgname': 'libcupscgi1', 'pkgver': '1.7.2-0ubuntu1.5'},
    {'osver': '14.04', 'pkgname': 'libcupscgi1-dev', 'pkgver': '1.7.2-0ubuntu1.5'},
    {'osver': '14.04', 'pkgname': 'libcupsimage2', 'pkgver': '1.7.2-0ubuntu1.5'},
    {'osver': '14.04', 'pkgname': 'libcupsimage2-dev', 'pkgver': '1.7.2-0ubuntu1.5'},
    {'osver': '14.04', 'pkgname': 'libcupsmime1', 'pkgver': '1.7.2-0ubuntu1.5'},
    {'osver': '14.04', 'pkgname': 'libcupsmime1-dev', 'pkgver': '1.7.2-0ubuntu1.5'},
    {'osver': '14.04', 'pkgname': 'libcupsppdc1', 'pkgver': '1.7.2-0ubuntu1.5'},
    {'osver': '14.04', 'pkgname': 'libcupsppdc1-dev', 'pkgver': '1.7.2-0ubuntu1.5'}
];
