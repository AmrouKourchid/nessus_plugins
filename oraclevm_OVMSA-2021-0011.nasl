...
# extracted from OracleVM Security Advisory OVMSA-2021-0011.
##
...
if (description)
{
  ...
  script_name(english:"OracleVM 3.4 : openssl (OVMSA-2021-0011)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/cve/CVE-2020-1971.html");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/OVMSA-2021-0011.html");
...
var pkgs = [
    {'reference':'openssl-1.0.1e-59.0.1.el6_10', 'cpu':'x86_64', 'release':'3.4', 'rpm_spec_vers_cmp':TRUE}
];
