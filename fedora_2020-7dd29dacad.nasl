...
# extracted from Fedora Security Advisory FEDORA-2020-7dd29dacad.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : mingw-libxml2 (2020-7dd29dacad)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-7dd29dacad");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"mingw-libxml2-2.9.10-3.fc31")) flag++;
