...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2017-3511.html");
...
"Update the affected docker-engine and / or docker-engine-selinux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-9962");
...
var pkgs = [
    {'reference':'docker-engine-1.12.6-1.0.1.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'docker-engine-1.12.6-1.0.1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'docker-engine-selinux-1.12.6-1.0.1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
];
