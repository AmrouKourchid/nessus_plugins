...
# extracted from Fedora Security Advisory FEDORA-2018-6a9fea1b3a.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-6a9fea1b3a");

  script_name(english:"Fedora 26 : webkitgtk4 (2018-6a9fea1b3a)");
...
"This update addresses the following vulnerabilities :
  ...
  -
    [CVE-2018-4200](https://cve.mitre.org/cgi-bin/cvename.cg
    i?name=CVE-2018-4200)
...
Additional fixes :
  ...
  - Update user agent quirks to fix Outlook.com and
    Chase.com.
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-6a9fea1b3a");
...
flag = 0;
if (rpm_check(release:"FC26", reference:"webkitgtk4-2.20.2-1.fc26")) flag++;
