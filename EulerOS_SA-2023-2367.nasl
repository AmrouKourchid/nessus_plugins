...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : screen (EulerOS-SA-2023-2367)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2367
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a358dd76");
...
var pkgs = [
  "screen-4.8.0-1.h2.eulerosv2r10"
];
