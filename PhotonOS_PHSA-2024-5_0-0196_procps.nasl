...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Procps PHSA-2024-5.0-0196");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'procps-ng-4.0.0-4.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'procps-ng-devel-4.0.0-4.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'procps-ng-lang-4.0.0-4.ph5')) flag++;
