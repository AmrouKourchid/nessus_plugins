...
# extracted from Gentoo Linux Security Advisory GLSA 201911-08.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201911-08");
  script_xref(name:"CEA-ID", value:"CEA-2021-0025");

  script_name(english:"GLSA-201911-08 : Expat: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-201911-08
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/201911-08");
...
if (qpkg_check(package:"dev-libs/expat", unaffected:make_list("ge 2.2.8"), vulnerable:make_list("lt 2.2.8"))) flag++;
