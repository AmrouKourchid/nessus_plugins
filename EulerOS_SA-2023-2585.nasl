...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : libcap (EulerOS-SA-2023-2585)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the libcap package installed, the EulerOS installation on the remote host is affected by
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2585
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f12f54ea");
