...
"The version of Google Chrome installed on the remote Windows host is prior to 127.0.6533.99. It is, therefore, affected
by multiple vulnerabilities as referenced in the 2024_08_stable-channel-update-for-desktop advisory.
...
google_chrome_check_version(installs:installs, fix:'127.0.6533.99', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
