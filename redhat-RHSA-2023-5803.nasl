...
# extracted from Red Hat Security Advisory RHSA-2023:5803. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_5803.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?14f5ed39");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:5803");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL nodejs:16 package based on the guidance in RHSA-2023:5803.");
  ...
  'nodejs:16': [
    {
      ...
      'pkgs': [
        {'reference':'nodejs-16.20.2-3.module+el8.6.0+20387+28a0198c', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-devel-16.20.2-3.module+el8.6.0+20387+28a0198c', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-docs-16.20.2-3.module+el8.6.0+20387+28a0198c', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-full-i18n-16.20.2-3.module+el8.6.0+20387+28a0198c', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        ...
        {'reference':'npm-8.19.4-1.16.20.2.3.module+el8.6.0+20387+28a0198c', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
      ]
    }
  ]
};
