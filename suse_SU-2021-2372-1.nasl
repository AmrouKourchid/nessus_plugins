...
# SUSE update advisory SUSE-SU-2021:2372-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2021-0512");
  script_xref(name:"SuSE", value:"SUSE-SU-2021:2372-1");

  script_name(english:"SUSE SLES15 Security Update : kernel (Live Patch 25 for SLE 15 SP1) (SUSE-SU-2021:2372-1)");
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2021-July/009146.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8d44685c");
...
"Update the affected kernel-livepatch-4_12_14-197_92-default package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-0512");
...
var pkgs = [
    {'reference':'kernel-livepatch-4_12_14-197_92-default-2-2.1', 'sp':'1', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.1']}
];
