...
# extracted from Oracle Linux Security Advisory ELSA-2022-5234.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : python-virtualenv (ELSA-2022-5234)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2022-5234.html");
...
var pkgs = [
    {'reference':'python-virtualenv-15.1.0-7.el7_9', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
];
