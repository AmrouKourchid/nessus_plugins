...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : nss / and / nspr (ELSA-2019-1951)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ELSA-2019-1951 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2019-1951.html");
...
var pkgs = [
    ...
    {'reference':'nspr-4.21.0-2.el8_0', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'nspr-devel-4.21.0-2.el8_0', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'nss-3.44.0-7.el8_0', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'nss-devel-3.44.0-7.el8_0', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'nss-softokn-3.44.0-7.el8_0', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'nss-softokn-devel-3.44.0-7.el8_0', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'nss-softokn-freebl-3.44.0-7.el8_0', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'nss-softokn-freebl-devel-3.44.0-7.el8_0', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'nss-sysinit-3.44.0-7.el8_0', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'nss-tools-3.44.0-7.el8_0', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'nss-util-3.44.0-7.el8_0', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'nss-util-devel-3.44.0-7.el8_0', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
