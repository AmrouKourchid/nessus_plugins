...
# extracted from VMware Security Advisory PHSA-2024-4.0-0660. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Python3 PHSA-2024-4.0-0660");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the python3 package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-660.md");
...
if (rpm_check(release:'PhotonOS-4.0', reference:'python3-setuptools-65.5.1-5.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', reference:'python3-setuptools-wheel-65.5.1-5.ph4')) flag++;
