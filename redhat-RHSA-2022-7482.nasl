...
# extracted from Red Hat Security Advisory RHSA-2022:7482. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:7482");

  script_name(english:"RHEL 8 : qt5 (RHSA-2022:7482)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2022:7482 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_7482.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?78354ed2");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/8.7_release_notes/index
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?790bc9ea");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:7482");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2055505");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2061377");
  script_set_attribute(attribute:"solution", value:
"Update the affected qt5-devel, qt5-rpm-macros and / or qt5-srpm-macros packages.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'qt5-devel-5.15.3-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'qt5-rpm-macros-5.15.3-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'qt5-srpm-macros-5.15.3-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'qt5-devel / qt5-rpm-macros / qt5-srpm-macros');
}
