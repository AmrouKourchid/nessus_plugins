...
# extracted from Amazon Linux 2 Security Advisory ALAS-2023-2023.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : screen (ALAS-2023-2023)");
...
by a vulnerability as referenced in the ALAS2-2023-2023 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2023-2023.html");
...
var pkgs = [
    {'reference':'screen-4.1.0-0.27.20120314git3c2946.amzn2.0.1', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'screen-4.1.0-0.27.20120314git3c2946.amzn2.0.1', 'cpu':'i686', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'screen-4.1.0-0.27.20120314git3c2946.amzn2.0.1', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'screen-debuginfo-4.1.0-0.27.20120314git3c2946.amzn2.0.1', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'screen-debuginfo-4.1.0-0.27.20120314git3c2946.amzn2.0.1', 'cpu':'i686', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'screen-debuginfo-4.1.0-0.27.20120314git3c2946.amzn2.0.1', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
