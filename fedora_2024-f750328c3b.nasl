...
# extracted from Fedora Security Advisory FEDORA-2024-f750328c3b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-f750328c3b");

  script_name(english:"Fedora 40 : python3.10 (2024-f750328c3b)");
...
FEDORA-2024-f750328c3b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-f750328c3b");
...
var pkgs = [
    {'reference':'python3.10-3.10.15-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
