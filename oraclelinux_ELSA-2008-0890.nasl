...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : wireshark (ELSA-2008-0890)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2008-0890.html");
...
"Update the affected wireshark and / or wireshark-gnome packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2008-3146");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2008-3932");
...
var pkgs = [
    {'reference':'wireshark-1.0.3-4.0.1.el5_2', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'wireshark-gnome-1.0.3-4.0.1.el5_2', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'wireshark-1.0.3-4.0.1.el5_2', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'wireshark-gnome-1.0.3-4.0.1.el5_2', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
