...
# extracted from Fedora Security Advisory FEDORA-2024-14db7b21a2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-14db7b21a2");
  script_xref(name:"IAVA", value:"2024-A-0328");

  script_name(english:"Fedora 40 : ruby (2024-14db7b21a2)");
...
FEDORA-2024-14db7b21a2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-14db7b21a2");
...
var pkgs = [
    {'reference':'ruby-3.3.1-7.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
