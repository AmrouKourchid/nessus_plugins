...
#
var os, processor, version, num, match, conf, matches, confidence, v;
...
if ( os )
{
 ...
 replace_kb_item(name:'Host/OS/NTP/Protocol', value:'udp');
 replace_kb_item(name:'Host/OS/NTP/Port', value:123); # ntp_open.nasl has this port hardcoded
