...
# extracted from Red Hat Security Advisory kibana. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2020-7733");

  script_name(english:"RHEL 7 : kibana (Unpatched Vulnerability) (deprecated)");
