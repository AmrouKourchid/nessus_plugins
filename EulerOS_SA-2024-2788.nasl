...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP12 : gtk3 (EulerOS-SA-2024-2788)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2788
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?929fc82e");
...
var pkgs = [
  "gtk3-3.24.30-6.h5.eulerosv2r12",
  "gtk3-devel-3.24.30-6.h5.eulerosv2r12",
  "gtk3-help-3.24.30-6.h5.eulerosv2r12"
];
