...
# extracted from VMware Security Advisory PHSA-2021-4.0-0121. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2021-3872", "CVE-2021-3875");

  script_name(english:"Photon OS 4.0: Vim PHSA-2021-4.0-0121");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the vim package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-121.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'vim-8.2.3428-2.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'vim-extra-8.2.3428-2.ph4')) flag++;
