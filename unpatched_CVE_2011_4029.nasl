...
if (description)
{
  ...
  script_cve_id("CVE-2011-4029");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2011-4029");
...
patch available.
  ...
  - The LockServer function in os/utils.c in X.Org xserver before 1.11.2 allows local users to change the
    permissions of arbitrary files to 444, read those files, and possibly cause a denial of service (removed
    execution permission) via a symlink attack on a temporary lock file. (CVE-2011-4029)
