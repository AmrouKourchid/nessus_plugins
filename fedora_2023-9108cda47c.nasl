...
# extracted from Fedora Security Advisory FEDORA-2023-9108cda47c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-9108cda47c");

  script_name(english:"Fedora 39 : libwebp (2023-9108cda47c)");
...
FEDORA-2023-9108cda47c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-9108cda47c");
...
var pkgs = [
    {'reference':'libwebp-1.3.2-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
