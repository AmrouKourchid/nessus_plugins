...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : libplist (EulerOS-SA-2019-2207)");
...
vulnerabilities :
  ...
  - The parse_string_node function in bplist.c in
    ...
    crafted plist file.(CVE-2017-6435)
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2207
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a0629fa3");
...
pkgs = ["libplist-1.12-3.h2.eulerosv2r7"];
