...
# extracted from Fedora Security Advisory FEDORA-2022-48bf3cb1c4
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-48bf3cb1c4");

  script_name(english:"Fedora 34 : vim (2022-48bf3cb1c4)");
...
FEDORA-2022-48bf3cb1c4 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-48bf3cb1c4");
...
var pkgs = [
    {'reference':'vim-8.2.4460-1.fc34', 'release':'FC34', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
