...
# extracted from Fedora Security Advisory FEDORA-2023-41a537a9e1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-41a537a9e1");

  script_name(english:"Fedora 37 : ImageMagick (2023-41a537a9e1)");
...
FEDORA-2023-41a537a9e1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-41a537a9e1");
...
var pkgs = [
    {'reference':'ImageMagick-6.9.12.82-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
