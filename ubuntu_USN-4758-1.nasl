...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 20.04 LTS : Go vulnerability (USN-4758-1)");
...
referenced in the USN-4758-1 advisory.

    It was discovered that Go applications incorrectly handled uploaded content. If a user were tricked into
    visiting a malicious page, a remote attacker could exploit this with a crafted file to conduct cross-site
