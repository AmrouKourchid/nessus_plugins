...
if (description)
{
  ...
  script_cve_id("CVE-2021-41805");

  script_name(english:"Photon OS 4.0: Consul PHSA-2022-4.0-0143");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-41805");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'consul-1.9.11-1.ph4')) flag++;
