...
# extracted from Fedora Security Advisory FEDORA-2023-c685251667
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-c685251667");

  script_name(english:"Fedora 37 : redis (2023-c685251667)");
...
FEDORA-2023-c685251667 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-c685251667");
...
var pkgs = [
    {'reference':'redis-7.0.9-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
