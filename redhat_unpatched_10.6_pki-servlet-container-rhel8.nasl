...
# extracted from Red Hat Security Advisory 10.6_pki-servlet-container. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 8 : 10.6_pki-servlet-container (Unpatched Vulnerability) (deprecated)");
