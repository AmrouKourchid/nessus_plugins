...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : golang (EulerOS-SA-2023-1385)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1385
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cb1352ee");
...
var pkgs = [
  "golang-1.15.7-15.h6.eulerosv2r10",
  "golang-devel-1.15.7-15.h6.eulerosv2r10",
  "golang-help-1.15.7-15.h6.eulerosv2r10"
];
