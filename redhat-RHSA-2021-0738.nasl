...
# extracted from Red Hat Security Advisory RHSA-2021:0738. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_0738.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a13ecaab");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:0738");
...
"Update the RHEL nodejs:10 package based on the guidance in RHSA-2021:0738.");
  ...
  'nodejs:10': [
    {
      ...
      'pkgs': [
        {'reference':'nodejs-10.24.0-1.module+el8.2.0+10165+019e8570', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-devel-10.24.0-1.module+el8.2.0+10165+019e8570', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-docs-10.24.0-1.module+el8.2.0+10165+019e8570', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-full-i18n-10.24.0-1.module+el8.2.0+10165+019e8570', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        ...
        {'reference':'npm-6.14.11-1.10.24.0.1.module+el8.2.0+10165+019e8570', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
      ]
    }
  ]
};
