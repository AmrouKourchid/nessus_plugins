...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : busybox (EulerOS-SA-2024-2358)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2358
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9379f762");
...
var pkgs = [
  "busybox-1.31.1-6.h3.r7.eulerosv2r9"
];
