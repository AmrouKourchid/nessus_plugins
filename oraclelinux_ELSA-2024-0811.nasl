...
# extracted from Oracle Linux Security Advisory ELSA-2024-0811.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 / 9 : sudo (ELSA-2024-0811)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-0811.html");
  script_set_attribute(attribute:"solution", value:
"Update the affected sudo and / or sudo-python-plugin packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:sudo-python-plugin");
...
var pkgs = [
    {'reference':'sudo-1.9.5p2-1.el8_9', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sudo-1.9.5p2-1.el8_9', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sudo-1.9.5p2-10.el9_3', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sudo-python-plugin-1.9.5p2-10.el9_3', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sudo-1.9.5p2-10.el9_3', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sudo-python-plugin-1.9.5p2-10.el9_3', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
