...
# extracted from Fedora Security Advisory FEDORA-2023-2cf9dd7d52
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-2cf9dd7d52");

  script_name(english:"Fedora 37 : vtk (2023-2cf9dd7d52)");
...
FEDORA-2023-2cf9dd7d52 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-2cf9dd7d52");
  script_set_attribute(attribute:"solution", value:
"Update the affected vtk package.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:N/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-42521");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:vtk");
...
var pkgs = [
    {'reference':'vtk-9.1.0-18.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'vtk');
}
