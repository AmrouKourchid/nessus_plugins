...
# extracted from Fedora Security Advisory FEDORA-2020-f11a905fc2.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-f11a905fc2");

  script_name(english:"Fedora 30 : webkit2gtk3 (2020-f11a905fc2)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-f11a905fc2");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"webkit2gtk3-2.26.3-1.fc30")) flag++;
