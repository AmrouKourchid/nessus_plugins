...
# extracted from Amazon Linux 2 Security Advisory ALASECS-2024-032.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : ecs-init (ALASECS-2024-032)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of ecs-init installed on the remote host is prior to 1.75.0-1. It is, therefore, affected by a vulnerability
as referenced in the ALAS2ECS-2024-032 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALASECS-2024-032.html");
...
var pkgs = [
    {'reference':'ecs-init-1.75.0-1.amzn2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ecs-init-1.75.0-1.amzn2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
