...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.3 : perl (EulerOS-SA-2019-1239)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1239
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a207985b");
...
pkgs = ["perl-5.16.3-292.h4",
        "perl-Pod-Escapes-1.04-292.h4",
        "perl-libs-5.16.3-292.h4",
        "perl-macros-5.16.3-292.h4"];
