...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : golang (EulerOS-SA-2019-1916)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1916
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2934cd07");
...
pkgs = ["golang-1.12-4.eulerosv2r7",
        "golang-bin-1.12-4.eulerosv2r7",
        "golang-src-1.12-4.eulerosv2r7"];
