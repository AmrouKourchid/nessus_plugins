...
# extracted from Fedora Security Advisory FEDORA-2022-ef11bad952
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-ef11bad952");

  script_name(english:"Fedora 38 : capnproto / fastnetmon / librime / rr / sonic-visualiser (2022-ef11bad952)");
...
FEDORA-2022-ef11bad952 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-ef11bad952");
...
var pkgs = [
    {'reference':'capnproto-0.10.3-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'fastnetmon-1.2.1-5.20220528git420e7b8.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'librime-1.7.3-5.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rr-5.6.0-3.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sonic-visualiser-4.5-4.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'capnproto / fastnetmon / librime / rr / sonic-visualiser');
}
