...
# extracted from Fedora Security Advisory FEDORA-2019-d11594bf0a.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-d11594bf0a");

  script_name(english:"Fedora 31 : python38 (2019-d11594bf0a)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-d11594bf0a");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"python38-3.8.0~b4-1.fc31")) flag++;
