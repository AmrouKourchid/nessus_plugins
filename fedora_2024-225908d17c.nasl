...
# extracted from Fedora Security Advisory FEDORA-2024-225908d17c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-225908d17c");

  script_name(english:"Fedora 41 : libarchive (2024-225908d17c)");
...
FEDORA-2024-225908d17c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-225908d17c");
...
var pkgs = [
    {'reference':'libarchive-3.7.4-2.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
