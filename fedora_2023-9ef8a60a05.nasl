...
# extracted from Fedora Security Advisory FEDORA-2023-9ef8a60a05
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-9ef8a60a05");

  script_name(english:"Fedora 38 : perl / perl-Devel-Cover / perl-PAR-Packer / polymake (2023-9ef8a60a05)");
...
FEDORA-2023-9ef8a60a05 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-9ef8a60a05");
...
var pkgs = [
    {'reference':'perl-5.36.3-498.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
    {'reference':'perl-Devel-Cover-1.36-11.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'perl-PAR-Packer-1.057-4.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'polymake-4.10-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
