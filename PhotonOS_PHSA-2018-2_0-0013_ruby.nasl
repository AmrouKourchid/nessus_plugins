...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Ruby PHSA-2018-2.0-0013");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'ruby-2.4.3-2.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'ruby-debuginfo-2.4.3-2.ph2')) flag++;
