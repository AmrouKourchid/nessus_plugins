...
# extracted from Red Hat Security Advisory RHSA-2017:2788. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : augeas (RHSA-2017:2788)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for augeas.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2017:2788 advisory.
    ...
    * A vulnerability was discovered in augeas affecting the handling of escaped strings. An attacker could
    send crafted strings that would cause the application using augeas to copy past the end of a buffer,
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2017/rhsa-2017_2788.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d452c9db");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2017:2788");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1478373");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL augeas package based on the guidance in RHSA-2017:2788.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'augeas-1.4.0-2.el7_4.1', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'augeas-1.4.0-2.el7_4.1', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'augeas-1.4.0-2.el7_4.1', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'augeas-1.4.0-2.el7_4.1', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'augeas-devel-1.4.0-2.el7_4.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'augeas-libs-1.4.0-2.el7_4.1', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'augeas-libs-1.4.0-2.el7_4.1', 'cpu':'ppc', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'augeas-libs-1.4.0-2.el7_4.1', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'augeas-libs-1.4.0-2.el7_4.1', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'augeas-libs-1.4.0-2.el7_4.1', 'cpu':'s390', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'augeas-libs-1.4.0-2.el7_4.1', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'augeas-libs-1.4.0-2.el7_4.1', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
