...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2019-A-0213-S");
...
attacker could exploit this, via sending a malicious URL to a victim to execute arbitrary commands.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a0003a57");
...
"Upgrade to Atlassian SourceTree 3.1.3 or later.");
  ...
  script_require_keys("installed_sw/SourceTree","Settings/ParanoidReport");
