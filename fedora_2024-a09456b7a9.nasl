...
# extracted from Fedora Security Advisory FEDORA-2024-a09456b7a9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-a09456b7a9");
  script_xref(name:"IAVA", value:"2024-A-0185-S");

  script_name(english:"Fedora 40 : curl (2024-a09456b7a9)");
...
FEDORA-2024-a09456b7a9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-a09456b7a9");
...
var pkgs = [
    {'reference':'curl-8.6.0-8.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
