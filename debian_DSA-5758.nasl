...
# extracted from Debian Security Advisory dsa-5758. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5758 : trafficserver - security update");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'trafficserver', 'reference': '9.2.5+ds-0+deb12u1'},
    {'release': '12.0', 'prefix': 'trafficserver-dev', 'reference': '9.2.5+ds-0+deb12u1'},
    {'release': '12.0', 'prefix': 'trafficserver-experimental-plugins', 'reference': '9.2.5+ds-0+deb12u1'}
];
