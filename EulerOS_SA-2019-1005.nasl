...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : gnutls (EulerOS-SA-2019-1005)");
...
vulnerability :
  ...
  - gnutls: HMAC-SHA-256 vulnerable to Lucky thirteen
    attack due to not enough dummy function calls
    (CVE-2018-10844)
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1005
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7cc5954d");
...
pkgs = ["gnutls-3.3.26-9.h2.eulerosv2r7",
        "gnutls-c++-3.3.26-9.h2.eulerosv2r7",
        "gnutls-dane-3.3.26-9.h2.eulerosv2r7",
        "gnutls-devel-3.3.26-9.h2.eulerosv2r7",
        "gnutls-utils-3.3.26-9.h2.eulerosv2r7"];
