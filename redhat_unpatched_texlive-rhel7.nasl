...
# extracted from Red Hat Security Advisory texlive. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2015-5700", "CVE-2015-5701", "CVE-2016-10243");

  script_name(english:"RHEL 7 : texlive (Unpatched Vulnerability) (deprecated)");
