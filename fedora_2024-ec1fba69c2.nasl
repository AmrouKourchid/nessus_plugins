...
# extracted from Fedora Security Advisory FEDORA-2024-ec1fba69c2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-ec1fba69c2");

  script_name(english:"Fedora 39 : tcpreplay (2024-ec1fba69c2)");
...
FEDORA-2024-ec1fba69c2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-ec1fba69c2");
...
"Update the affected tcpreplay package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-4256");
...
var pkgs = [
    {'reference':'tcpreplay-4.4.4-5.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
