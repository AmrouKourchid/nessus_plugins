...
# extracted from SUSE update advisory SUSE-SU-2021:0060-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES15 Security Update : nodejs10 (SUSE-SU-2021:0060-1)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?85e2c5de");
...
flag = 0;
if (rpm_check(release:"SLES15", sp:"1", reference:"nodejs10-10.23.1-1.30.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"nodejs10-debuginfo-10.23.1-1.30.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"nodejs10-debugsource-10.23.1-1.30.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"nodejs10-devel-10.23.1-1.30.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"npm10-10.23.1-1.30.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"nodejs10-10.23.1-1.30.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"nodejs10-debuginfo-10.23.1-1.30.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"nodejs10-debugsource-10.23.1-1.30.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"nodejs10-devel-10.23.1-1.30.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"npm10-10.23.1-1.30.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"nodejs10-10.23.1-1.30.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"nodejs10-debuginfo-10.23.1-1.30.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"nodejs10-debugsource-10.23.1-1.30.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"nodejs10-devel-10.23.1-1.30.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"npm10-10.23.1-1.30.1")) flag++;
