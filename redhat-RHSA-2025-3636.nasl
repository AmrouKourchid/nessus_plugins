...
# extracted from Red Hat Security Advisory RHSA-2025:3636. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:3636");

  script_name(english:"RHEL 8 / 9 : Red Hat Ansible Automation Platform 2.4 Product Security and Bug Fix Update (Important) (RHSA-2025:3636)");
...
in the RHSA-2025:3636 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_3636.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e44f551b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:3636");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ansible-rulebook-1.0.8-2.el8ap', 'release':'8', 'el_string':'el8ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.4'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'ansible-rulebook-1.0.8-2.el9ap', 'release':'9', 'el_string':'el9ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.4'}
    ]
  }
];
