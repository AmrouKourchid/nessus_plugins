...
# AlmaLinux Security Advisory ALSA-2024:3954.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:3954");
  script_xref(name:"IAVA", value:"2024-A-0335-S");

  script_name(english:"AlmaLinux 8 : firefox (ALSA-2024:3954)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2024-3954.html");
...
var pkgs = [
    {'reference':'firefox-115.12.0-1.el8_10.alma.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-115.12.0-1.el8_10.alma.1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
