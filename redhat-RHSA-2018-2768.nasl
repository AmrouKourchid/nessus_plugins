...
the RHSA-2018:2768 advisory.

  - nss: ServerHello.random is all zeros when handling a v2-compatible ClientHello (CVE-2018-12384)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_2768.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cf796250");
...
"Update the RHEL nss package based on the guidance in RHSA-2018:2768.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'nss-3.36.0-7.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nss-devel-3.36.0-7.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nss-pkcs11-devel-3.36.0-7.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nss-sysinit-3.36.0-7.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nss-tools-3.36.0-7.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
