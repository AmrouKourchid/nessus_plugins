...
# Oracle Linux Security Advisory ELSA-2016-0997 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : qemu-kvm (ELSA-2016-0997)");
...
ELSA-2016-0997 advisory.

    - kvm-vga-fix-banked-access-bounds-checking-CVE-2016-3710.patch [bz#1331407]
    - Resolves: bz#1331407
      (EMBARGOED CVE-2016-3710 qemu-kvm: qemu: incorrect banked access bounds checking in vga module
    [rhel-6.8.z])
    - Resolves: bz#1298046
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2016-0997.html");
...
var pkgs = [
    ...
    {'reference':'qemu-img-0.12.1.2-2.491.el6_8.1', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'qemu-kvm-0.12.1.2-2.491.el6_8.1', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'qemu-kvm-tools-0.12.1.2-2.491.el6_8.1', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
