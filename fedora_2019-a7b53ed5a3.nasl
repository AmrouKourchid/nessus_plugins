...
# extracted from Fedora Security Advisory FEDORA-2019-a7b53ed5a3.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-a7b53ed5a3");

  script_name(english:"Fedora 29 : python-django (2019-a7b53ed5a3)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-a7b53ed5a3");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"python-django-2.0.10-1.fc29")) flag++;
