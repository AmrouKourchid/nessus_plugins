...
if (description)
{
  ...
  script_cve_id("CVE-2021-47168");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2021-47168");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: NFS: fix an incorrect limit in
    ...
    corruption. It should be NFS_MAXFHSIZE because that's the size of the ->data[] buffer. I reversed the size
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-47168");
