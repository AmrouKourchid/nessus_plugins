...
if (description)
{
  ...
  script_cve_id("CVE-2022-36763", "CVE-2022-36764", "CVE-2022-36765");

  script_name(english:"EulerOS Virtualization 2.10.1 : edk2 (EulerOS-SA-2024-1560)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1560
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3e7c7845");
...
"Update the affected edk2 packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-36765");
...
var pkgs = [
  "edk2-aarch64-202011-2.10.0.5.21"
];
