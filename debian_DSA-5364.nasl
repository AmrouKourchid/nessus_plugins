...
# extracted from Debian Security Advisory dsa-5364. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-5364-1 : apr-util - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has packages installed that are affected by a vulnerability as referenced in the dsa-5364
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2023/dsa-5364");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-25147");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bullseye/apr-util");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'libaprutil1', 'reference': '1.6.1-5+deb11u1'},
    {'release': '11.0', 'prefix': 'libaprutil1-dbd-mysql', 'reference': '1.6.1-5+deb11u1'},
    {'release': '11.0', 'prefix': 'libaprutil1-dbd-odbc', 'reference': '1.6.1-5+deb11u1'},
    {'release': '11.0', 'prefix': 'libaprutil1-dbd-pgsql', 'reference': '1.6.1-5+deb11u1'},
    {'release': '11.0', 'prefix': 'libaprutil1-dbd-sqlite3', 'reference': '1.6.1-5+deb11u1'},
    {'release': '11.0', 'prefix': 'libaprutil1-dev', 'reference': '1.6.1-5+deb11u1'},
    {'release': '11.0', 'prefix': 'libaprutil1-ldap', 'reference': '1.6.1-5+deb11u1'}
];
