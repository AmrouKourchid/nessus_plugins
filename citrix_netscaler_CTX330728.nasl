...
12.1-63.22, 12.1-FIPS prior to 12.1-55.257, 13.0.x prior to 13.0-83.27, or 13.1.x prior to 13.1-4.43.
...
"For versions 11.1.x, 12.1.x, 12.1-FIPS, 13.0.x, and 13.1.x, upgrade to 11.1-65.23, 12.1-55.257-FIPS, 12.1-63.22, 13.0-83.27, and 13.1-4.43, or later, respectively.");
...
if (app_info['fips_status'] == 1)
{
  if (preg(pattern:"^12.1.*", string:app_info['version']))
    constraints = [ {'min_version': '12.1', 'fixed_version': '12.1.55.257', 'fixed_display': '12.1-55.257 and later releases of 12.1-FIPS.'} ];
}
else
{
  constraints = [
