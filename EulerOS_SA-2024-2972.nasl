...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : ruby (EulerOS-SA-2024-2972)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2972
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d9530226");
...
var pkgs = [
  "ruby-3.0.3-122.h14.eulerosv2r11",
  "ruby-help-3.0.3-122.h14.eulerosv2r11",
  "ruby-irb-3.0.3-122.h14.eulerosv2r11"
];
