...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Openvswitch PHSA-2023-5.0-0093");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'openvswitch-3.0.2-3.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'openvswitch-devel-3.0.2-3.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'openvswitch-devel-static-3.0.2-3.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'openvswitch-doc-3.0.2-3.ph5')) flag++;
