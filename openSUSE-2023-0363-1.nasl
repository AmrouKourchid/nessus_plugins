...
# openSUSE Security Update openSUSE-SU-2023:0363-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2023-31794");

  script_name(english:"openSUSE 15 Security Update : mupdf (openSUSE-SU-2023:0363-1)");
...
SU-2023:0363-1 advisory.

  - MuPDF v1.21.1 was discovered to contain an infinite recursion in the component pdf_mark_list_push. This
    vulnerability allows attackers to cause a Denial of Service (DoS) via a crafted PDF file. (CVE-2023-31794)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1216728");
  # https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/HH7LKRXVB7EGA3JI6NL5ZVYTPRFC3DKZ/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b3627617");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2023-31794");
...
"Update the affected mupdf and / or mupdf-devel-static packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-31794");
...
var pkgs = [
    {'reference':'mupdf-1.21.1-bp155.3.3.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'mupdf-devel-static-1.21.1-bp155.3.3.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE}
];
