...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS : Lasso vulnerability (USN-4974-1)");
...
in the USN-4974-1 advisory.

    It was discovered that Lasso did not properly verify that all assertions in a SAML response were properly
    signed. An attacker could possibly use this to impersonate users or otherwise bypass access controls.
