...
# extracted from SUSE update advisory SUSE-SU-2020:3373-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLED15 / SLES15 Security Update : ucode-intel (SUSE-SU-2020:3373-1)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ebf5d9b4");
...
flag = 0;
if (rpm_check(release:"SLES15", sp:"2", cpu:"x86_64", reference:"ucode-intel-20201110-2.10.1")) flag++;
if (rpm_check(release:"SLED15", sp:"2", cpu:"x86_64", reference:"ucode-intel-20201110-2.10.1")) flag++;
