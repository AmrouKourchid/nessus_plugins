...
if (description)
{
  ...
  script_name(english:"CentOS 9 : virt-v2v-2.2.0-5.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update for virt-v2v.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 9 host has packages installed that are affected by a vulnerability as referenced in the
virt-v2v-2.2.0-5.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=30033");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream virt-v2v package.");
...
var pkgs = [
    {'reference':'virt-v2v-2.2.0-5.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'virt-v2v-bash-completion-2.2.0-5.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'virt-v2v-man-pages-ja-2.2.0-5.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'virt-v2v-man-pages-uk-2.2.0-5.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
