...
# extracted from Fedora Security Advisory FEDORA-2025-3eb5235527
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-3eb5235527");

  script_name(english:"Fedora 40 : nodejs22 (2025-3eb5235527)");
...
FEDORA-2025-3eb5235527 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-3eb5235527");
  script_set_attribute(attribute:"solution", value:
"Update the affected 1:nodejs22 package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:nodejs22");
...
var pkgs = [
    {'reference':'nodejs22-22.15.0-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'nodejs22');
}
