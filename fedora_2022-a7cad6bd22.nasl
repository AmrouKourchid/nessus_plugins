...
# extracted from Fedora Security Advisory FEDORA-2022-a7cad6bd22
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-a7cad6bd22");

  script_name(english:"Fedora 37 : python3.10 (2022-a7cad6bd22)");
...
FEDORA-2022-a7cad6bd22 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-a7cad6bd22");
...
var pkgs = [
    {'reference':'python3.10-3.10.8-3.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
