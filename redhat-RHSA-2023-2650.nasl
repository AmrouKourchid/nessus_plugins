...
# extracted from Red Hat Security Advisory RHSA-2023:2650. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:2650");
  script_xref(name:"IAVA", value:"2023-A-0153-S");

  script_name(english:"RHEL 9 : curl (RHSA-2023:2650)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_2650.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?aa2b6dd0");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2179073");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:2650");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL curl package based on the guidance in RHSA-2023:2650.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'curl-7.76.1-23.el9_2.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'curl-minimal-7.76.1-23.el9_2.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libcurl-7.76.1-23.el9_2.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libcurl-devel-7.76.1-23.el9_2.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libcurl-minimal-7.76.1-23.el9_2.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'curl-7.76.1-23.el9_2.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'curl-minimal-7.76.1-23.el9_2.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libcurl-7.76.1-23.el9_2.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libcurl-devel-7.76.1-23.el9_2.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libcurl-minimal-7.76.1-23.el9_2.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
