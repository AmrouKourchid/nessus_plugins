...
# extracted from F5 Networks BIG-IP Solution K32380005.
#
# @NOAGENT@
##
...
if (description)
{
  ...
  script_cve_id("CVE-2019-18282");

  script_name(english:"F5 Networks BIG-IP : Linux kernel vulnerability (K32380005)");

  script_set_attribute(attribute:"synopsis", value:
"The remote device is missing a vendor-supplied security patch.");
  script_set_attribute(attribute:"description", value:
"The version of F5 Networks BIG-IP installed on the remote host is prior to tested version. It is, therefore, affected by
a vulnerability as referenced in the K32380005 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K32380005");
...
Refer to the vendor for remediation guidance.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-18282");
...
var vmatrix = {
  'AFM': {
    'affected': [
      '17.0.0-17.1.1','16.1.0-16.1.4','15.1.0-15.1.10','14.1.0-14.1.5','13.1.0-13.1.5','12.1.0-12.1.6','11.6.1-11.6.5'
    ],
  },
  'AM': {
    'affected': [
