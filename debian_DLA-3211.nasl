...
# extracted from Debian Security Advisory dla-3211. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3211 : frr - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3211
advisory.

    - -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3211-1                debian-lts@lists.debian.org
    https://www.debian.org/lts/security/                           Chris Lamb
    November 28, 2022                             https://wiki.debian.org/LTS
    - -------------------------------------------------------------------------

    Package        : frr
    Version        : 6.0.2-2+deb10u2
    CVE ID         : CVE-2022-37032
    Debian Bug     : 1021016

    It was discovered that there was a potential out-of-bounds read in
...
var pkgs = [
    {'release': '10.0', 'prefix': 'frr', 'reference': '6.0.2-2+deb10u2'},
    {'release': '10.0', 'prefix': 'frr-doc', 'reference': '6.0.2-2+deb10u2'},
    {'release': '10.0', 'prefix': 'frr-pythontools', 'reference': '6.0.2-2+deb10u2'},
    {'release': '10.0', 'prefix': 'frr-rpki-rtrlib', 'reference': '6.0.2-2+deb10u2'},
    {'release': '10.0', 'prefix': 'frr-snmp', 'reference': '6.0.2-2+deb10u2'}
];
