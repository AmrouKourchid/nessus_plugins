...
ELSA-2021-2235 advisory.
    ...
    [10.10.5-3]
    - Bug 1960146 - CVE-2021-3551 Dogtag installer 'pkispawn' logs admin credentials into a world-readable log
    file
...
var appstreams = {
    'pki-core:10.6': [
      ...
      {'reference':'pki-acme-10.10.5-3.0.1.module+el8.4.0+20181+8592f730', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pki-base-10.10.5-3.0.1.module+el8.4.0+20181+8592f730', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pki-base-java-10.10.5-3.0.1.module+el8.4.0+20181+8592f730', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pki-ca-10.10.5-3.0.1.module+el8.4.0+20181+8592f730', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pki-kra-10.10.5-3.0.1.module+el8.4.0+20181+8592f730', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pki-server-10.10.5-3.0.1.module+el8.4.0+20181+8592f730', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python3-pki-10.10.5-3.0.1.module+el8.4.0+20181+8592f730', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'pki-acme-10.10.5-3.0.1.module+el8.4.0+20181+8592f730', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pki-base-10.10.5-3.0.1.module+el8.4.0+20181+8592f730', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pki-base-java-10.10.5-3.0.1.module+el8.4.0+20181+8592f730', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pki-ca-10.10.5-3.0.1.module+el8.4.0+20181+8592f730', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pki-kra-10.10.5-3.0.1.module+el8.4.0+20181+8592f730', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pki-server-10.10.5-3.0.1.module+el8.4.0+20181+8592f730', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python3-pki-10.10.5-3.0.1.module+el8.4.0+20181+8592f730', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
