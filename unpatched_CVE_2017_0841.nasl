...
if (description)
{
  ...
  script_cve_id("CVE-2017-0841");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2017-0841");
...
patch available.
  ...
  - A remote code execution vulnerability in the Android system (libutils). Product: Android. Versions: 5.0.2,
    5.1.1, 6.0, 6.0.1, 7.0, 7.1.1, 7.1.2, 8.0. Android ID: A-37723026. (CVE-2017-0841)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-0841");
