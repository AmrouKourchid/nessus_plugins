...
# extracted from Fedora Security Advisory FEDORA-2023-cf4df6380b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-cf4df6380b");

  script_name(english:"Fedora 38 : rnp (2023-cf4df6380b)");
...
FEDORA-2023-cf4df6380b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-cf4df6380b");
...
var pkgs = [
    {'reference':'rnp-0.16.3-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
