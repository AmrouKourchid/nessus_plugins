...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS : Linux kernel (HWE) vulnerabilities (USN-3468-2)");
...
the USN-3468-2 advisory.

    USN-3468-1 fixed vulnerabilities in the Linux kernel for Ubuntu 17.04. This update provides the
    corresponding updates for the Linux Hardware Enablement (HWE) kernel from Ubuntu 17.04 for Ubuntu 16.04
    LTS.

    It was discovered that the KVM subsystem in the Linux kernel did not properly bound guest IRQs. A local
    attacker in a guest VM could use this to cause a denial of service (host system crash). (CVE-2017-1000252)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3468-2");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.10.0-38-generic");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.10.0-38-generic-lpae");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.10.0-38-lowlatency");
...
var kernel_mappings = {
  '16.04': {
    '4.10.0': {
      'generic': '4.10.0-38',
      'generic-lpae': '4.10.0-38',
      'lowlatency': '4.10.0-38'
    }
  }
};
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-3468-2');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2017-10663', 'CVE-2017-10911', 'CVE-2017-11176', 'CVE-2017-14340', 'CVE-2017-1000252');
