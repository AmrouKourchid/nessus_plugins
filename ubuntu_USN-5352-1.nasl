...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 ESM : Libtasn1 vulnerability (USN-5352-1)");
...
USN-5352-1 advisory.
    ...
    It was discovered that Libtasn1 incorrectly handled certain files. An attacker could possibly use this
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libtasn1-3-bin', 'pkgver': '4.7-3ubuntu0.16.04.3+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libtasn1-6', 'pkgver': '4.7-3ubuntu0.16.04.3+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libtasn1-6-dev', 'pkgver': '4.7-3ubuntu0.16.04.3+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libtasn1-bin', 'pkgver': '4.7-3ubuntu0.16.04.3+esm2', 'ubuntu_pro': TRUE}
];
