...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : poppler (EulerOS-SA-2019-1123)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1123
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a1143745");
...
pkgs = ["poppler-0.26.5-17.h14",
        "poppler-glib-0.26.5-17.h14",
        "poppler-qt-0.26.5-17.h14",
        "poppler-utils-0.26.5-17.h14"];
