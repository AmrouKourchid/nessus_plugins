...
# extracted from Red Hat Security Advisory RHSA-2024:10841. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:10841");

  script_name(english:"RHEL 9 : OpenShift Container Platform 4.15.41 (RHSA-2024:10841)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for OpenShift Container Platform 4.15.41.");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0becc36e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:10841");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.15.41 package based on the guidance in RHSA-2024:10841.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'microshift-4.15.41-202412091343.p0.gcf9680e.assembly.4.15.41.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'microshift-4.15.41-202412091343.p0.gcf9680e.assembly.4.15.41.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'microshift-greenboot-4.15.41-202412091343.p0.gcf9680e.assembly.4.15.41.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'microshift-networking-4.15.41-202412091343.p0.gcf9680e.assembly.4.15.41.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'microshift-networking-4.15.41-202412091343.p0.gcf9680e.assembly.4.15.41.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'microshift-olm-4.15.41-202412091343.p0.gcf9680e.assembly.4.15.41.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'microshift-olm-4.15.41-202412091343.p0.gcf9680e.assembly.4.15.41.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'microshift-olm-release-info-4.15.41-202412091343.p0.gcf9680e.assembly.4.15.41.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'microshift-release-info-4.15.41-202412091343.p0.gcf9680e.assembly.4.15.41.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'microshift-selinux-4.15.41-202412091343.p0.gcf9680e.assembly.4.15.41.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
