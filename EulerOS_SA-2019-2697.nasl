...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : libxslt (EulerOS-SA-2019-2697)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2697
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dd9cf814");
...
pkgs = ["libxslt-1.1.28-5.h7.eulerosv2r7",
        "libxslt-devel-1.1.28-5.h7.eulerosv2r7",
