...
# extracted from VMware Security Advisory PHSA-2021-1.0-0419. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Python PHSA-2021-1.0-0419");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the python package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-1.0-419.md");
...
if (rpm_check(release:'PhotonOS-1.0', reference:'python-py-1.4.33-2.ph1')) flag++;
