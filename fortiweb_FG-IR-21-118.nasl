...
if (description)
{
  ...
  script_cve_id("CVE-2021-36188");

  script_name(english:"Fortinet FortiWeb xss (FG-IR-21-118)");
...
vulnerability as referenced in the FG-IR-21-118 advisory.

  - A improper neutralization of input during web page generation ('cross-site scripting') in Fortinet
    FortiWeb version 6.4.1 and below, 6.3.15 and below allows attacker to execute unauthorized code or
    commands via crafted GET parameters in requests to login and error handlers (CVE-2021-36188)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.fortiguard.com/psirt/FG-IR-21-118");
...
"Please upgrade to FortiWeb version 6.3.16/6.4.2/7.0.0 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-36188");
