...
# extracted from Red Hat Security Advisory RHSA-2005:065. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2005:065");

  script_name(english:"RHEL 4 : kdelibs (RHSA-2005:065)");
...
referenced in the RHSA-2005:065 advisory.
...
number.");
  ...
  # https://access.redhat.com/security/data/csaf/v2/advisories/2005/rhsa-2005_065.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?08584a48");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=144211");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=145938");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2005:065");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL kdelibs package based on the guidance in RHSA-2005:065.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2004-1165");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'kdelibs-3.3.1-3.3', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'6'},
      {'reference':'kdelibs-3.3.1-3.3', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'6'},
      {'reference':'kdelibs-3.3.1-3.3', 'cpu':'ppc64', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'6'},
      {'reference':'kdelibs-3.3.1-3.3', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'6'},
      {'reference':'kdelibs-3.3.1-3.3', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'6'},
      {'reference':'kdelibs-3.3.1-3.3', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'6'},
      {'reference':'kdelibs-devel-3.3.1-3.3', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'6'},
      {'reference':'kdelibs-devel-3.3.1-3.3', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'6'},
      {'reference':'kdelibs-devel-3.3.1-3.3', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'6'},
      {'reference':'kdelibs-devel-3.3.1-3.3', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'6'},
      {'reference':'kdelibs-devel-3.3.1-3.3', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'6'}
    ]
  }
];
