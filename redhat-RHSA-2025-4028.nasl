...
# extracted from Red Hat Security Advisory RHSA-2025:4028. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:4028");

  script_name(english:"RHEL 9 : thunderbird (RHSA-2025:4028)");
...
referenced in the RHSA-2025:4028 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_4028.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e370a004");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:4028");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL thunderbird package based on the guidance in RHSA-2025:4028.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'thunderbird-128.9.0-2.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
