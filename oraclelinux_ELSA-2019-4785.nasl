...
# extracted from Oracle Linux Security Advisory ELSA-2019-4785.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : edk2 (ELSA-2019-4785)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2019-4785.html");
...
var pkgs = [
    {'reference':'OVMF-1.2-5.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
