...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : JasPer vulnerabilities (USN-2919-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 14.04 LTS host has packages installed that are affected by multiple vulnerabilities as referenced in
the USN-2919-1 advisory.

    Jacob Baines discovered that JasPer incorrectly handled ICC color profiles in JPEG-2000 image files. If a
    user were tricked into opening a specially crafted JPEG-2000 image file, a remote attacker could cause
    JasPer to crash or possibly execute arbitrary code with user privileges. (CVE-2016-1577)

    Tyler Hicks discovered that JasPer incorrectly handled memory when processing JPEG-2000 image files. If a
    user were tricked into opening a specially crafted JPEG-2000 image file, a remote attacker could cause
    JasPer to consume memory, resulting in a denial of service. (CVE-2016-2116)

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2919-1");
...
"Update the affected libjasper-dev, libjasper-runtime and / or libjasper1 packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-1577");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'libjasper-dev', 'pkgver': '1.900.1-14ubuntu3.3'},
    {'osver': '14.04', 'pkgname': 'libjasper-runtime', 'pkgver': '1.900.1-14ubuntu3.3'},
    {'osver': '14.04', 'pkgname': 'libjasper1', 'pkgver': '1.900.1-14ubuntu3.3'}
];
