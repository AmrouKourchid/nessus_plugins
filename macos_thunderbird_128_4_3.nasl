...
# extracted from Mozilla Foundation Security Advisory mfsa2024-61.
...
if (description)
{
  ...
  script_name(english:"Mozilla Thunderbird < 128.4.3");

  script_set_attribute(attribute:"synopsis", value:
"A mail client installed on the remote macOS or Mac OS X host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Thunderbird installed on the remote macOS or Mac OS X host is prior to 128.4.3. It is, therefore,
affected by a vulnerability as referenced in the mfsa2024-61 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2024-61/");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Mozilla Thunderbird version 128.4.3 or later.");
...
mozilla_check_version(version:version, path:path, product:'thunderbird', esr:FALSE, fix:'128.4.3', severity:SECURITY_WARNING);
