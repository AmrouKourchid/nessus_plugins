...
# extracted from Debian Security Advisory dla-3192. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3192 : lava - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3192
advisory.

    -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3192-1                debian-lts@lists.debian.org
    https://www.debian.org/lts/security/                       Dominik George
    November 17, 2022                             https://wiki.debian.org/LTS
    -------------------------------------------------------------------------

    Package        : lava
    Version        : 2019.01-5+deb10u1
    CVE ID         : CVE-2022-42902
    Debian Bug     : 1021737

    It was discovered that lava_server allowed remote code execution in the
    lavatable code.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-42902");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/lava");
...
"Upgrade the lava packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-42902");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'lava', 'reference': '2019.01-5+deb10u1'},
    {'release': '10.0', 'prefix': 'lava-common', 'reference': '2019.01-5+deb10u1'},
    {'release': '10.0', 'prefix': 'lava-dev', 'reference': '2019.01-5+deb10u1'},
    {'release': '10.0', 'prefix': 'lava-dispatcher', 'reference': '2019.01-5+deb10u1'},
    {'release': '10.0', 'prefix': 'lava-lxc-mocker', 'reference': '2019.01-5+deb10u1'},
    {'release': '10.0', 'prefix': 'lava-server', 'reference': '2019.01-5+deb10u1'},
    {'release': '10.0', 'prefix': 'lava-server-doc', 'reference': '2019.01-5+deb10u1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'lava / lava-common / lava-dev / lava-dispatcher / lava-lxc-mocker / etc');
}
