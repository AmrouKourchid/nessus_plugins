...
# extracted from Red Hat Security Advisory RHSA-2023:6578. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:6578");

  script_name(english:"RHEL 9 : libqb (RHSA-2023:6578)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6578.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c1756957");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2230708");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6578");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libqb package based on the guidance in RHSA-2023:6578.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libqb-2.0.6-4.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libqb-devel-2.0.6-4.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
