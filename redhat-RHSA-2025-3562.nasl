...
# extracted from Red Hat Security Advisory RHSA-2025:3562. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:3562");

  script_name(english:"RHEL 8 : python-jinja2 (RHSA-2025:3562)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_3562.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?00beb6b7");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:3562");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-jinja2 package based on the guidance in RHSA-2025:3562.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-jinja2-2.10.1-2.el8_4.2', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
