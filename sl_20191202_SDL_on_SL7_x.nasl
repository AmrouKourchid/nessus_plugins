...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : SDL on SL7.x x86_64 (20191202)");
...
"Security Fix(es) :
  ...
  - SDL: CVE-2019-13616 not fixed in Red Hat Enterprise
    Linux 7 erratum RHSA-2019:3950 (CVE-2019-14906)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1912&L=SCIENTIFIC-LINUX-ERRATA&P=6413
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?981b5437");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"SDL-1.2.15-15.el7_7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"SDL-debuginfo-1.2.15-15.el7_7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"SDL-devel-1.2.15-15.el7_7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"SDL-static-1.2.15-15.el7_7")) flag++;
