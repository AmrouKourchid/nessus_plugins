...
# extracted from Red Hat Security Advisory RHSA-2024:2625.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : rhc-worker-script (RHSA-2024:2625)");
...
var pkgs = [
    {'reference':'rhc-worker-script-0.8-1.el7_9', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE}
];
