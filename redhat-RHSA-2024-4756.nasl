...
# extracted from Red Hat Security Advisory RHSA-2024:4756. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:4756");

  script_name(english:"RHEL 9 : libuv (RHSA-2024:4756)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for libuv.");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_4756.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f095b2c4");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:4756");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libuv package based on the guidance in RHSA-2024:4756.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libuv-1.42.0-2.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'libuv-devel-1.42.0-2.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'libuv-1.42.0-2.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'libuv-devel-1.42.0-2.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libuv / libuv-devel');
}
