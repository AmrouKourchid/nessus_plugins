...
# Oracle Linux Security Advisory ELSA-2016-0491 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : foomatic (ELSA-2016-0491)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2016-0491.html");
...
"Update the affected foomatic package.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2010-5325");
...
var pkgs = [
    {'reference':'foomatic-4.0.4-5.el6_7', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'foomatic-4.0.4-5.el6_7', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
];
