...
# extracted from Gentoo Linux Security Advisory GLSA 202409-11.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202409-11 : Oracle VirtualBox: Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202409-11 (Oracle VirtualBox: Multiple
Vulnerabilities)

    Multiple vulnerabilities have been discovered in Oracle VirtualBox. Please review the CVE identifiers
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202409-11");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=918524");
...
var packages = [
  {
    ...
    'unaffected' : make_list("ge 7.0.12"),
    'vulnerable' : make_list("lt 7.0.12")
  }
];
