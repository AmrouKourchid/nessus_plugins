...
# extracted from openSUSE Security Update openSUSE-2018-315.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : dhcp (openSUSE-2018-315)");
...
project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1083302");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1083303");
...
if ( rpm_check(release:"SUSE42.3", reference:"dhcp-4.3.3-11.6.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"dhcp-client-4.3.3-11.6.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"dhcp-client-debuginfo-4.3.3-11.6.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"dhcp-debuginfo-4.3.3-11.6.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"dhcp-debugsource-4.3.3-11.6.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"dhcp-devel-4.3.3-11.6.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"dhcp-relay-4.3.3-11.6.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"dhcp-relay-debuginfo-4.3.3-11.6.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"dhcp-server-4.3.3-11.6.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"dhcp-server-debuginfo-4.3.3-11.6.1") ) flag++;
