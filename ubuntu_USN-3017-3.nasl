...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : Linux kernel (Wily HWE) vulnerabilities (USN-3017-3)");
...
the USN-3017-3 advisory.

    USN-3017-1 fixed vulnerabilities in the Linux kernel for Ubuntu 15.10. This update provides the
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3017-3");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.2.0-41-generic");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.2.0-41-generic-lpae");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.2.0-41-lowlatency");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.2.0-41-powerpc-e500mc");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.2.0-41-powerpc-smp");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.2.0-41-powerpc64-emb");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.2.0-41-powerpc64-smp");
...
var kernel_mappings = {
  '14.04': {
    '4.2.0': {
      'generic': '4.2.0-41',
      'generic-lpae': '4.2.0-41',
      'lowlatency': '4.2.0-41',
      'powerpc-e500mc': '4.2.0-41',
      'powerpc-smp': '4.2.0-41',
      'powerpc64-emb': '4.2.0-41',
      'powerpc64-smp': '4.2.0-41'
    }
  }
};
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-3017-3');
}
