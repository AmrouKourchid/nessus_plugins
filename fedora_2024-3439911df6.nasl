...
# extracted from Fedora Security Advisory FEDORA-2024-3439911df6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-3439911df6");
  script_xref(name:"IAVB", value:"2024-B-0008-S");

  script_name(english:"Fedora 39 : clamav (2024-3439911df6)");
...
FEDORA-2024-3439911df6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-3439911df6");
...
var pkgs = [
    {'reference':'clamav-1.0.5-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
