...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : python-pillow (EulerOS-SA-2021-2641)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2641
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8b61d869");
...
var pkgs = [
  "python2-pillow-5.3.0-1.h13.eulerosv2r8",
  "python3-pillow-5.3.0-1.h13.eulerosv2r8"
];
