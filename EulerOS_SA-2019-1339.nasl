...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : python-paramiko (EulerOS-SA-2019-1339)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1339
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ade631ea");
...
pkgs = ["python-paramiko-2.1.1-4.eulerosv2r7.h1"];
