...
# extracted from Fedora Security Advisory FEDORA-2022-07dd9375b2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-07dd9375b2");

  script_name(english:"Fedora 35 : scala (2022-07dd9375b2)");
...
FEDORA-2022-07dd9375b2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-07dd9375b2");
...
var pkgs = [
    {'reference':'scala-2.13.9-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
