...
if (description)
{
  ...
  script_cve_id("CVE-2024-31157");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-31157");
...
patch available.
  ...
  - Improper initialization in UEFI firmware OutOfBandXML module in some Intel(R) Processors may allow a
    privileged user to potentially enable information disclosure via local access. (CVE-2024-31157)
