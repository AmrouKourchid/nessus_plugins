...
if (description)
{
  ...
  script_cve_id("CVE-2024-43886");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-43886");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: drm/amd/display: Add null check in
    resource_log_pipe_topology_update [WHY] When switching from Extend to Second Display Only we sometimes
    call resource_get_otg_master_for_stream on a stream for the eDP, which is disconnected. This leads to a
    null pointer dereference. [HOW] Added a null check in dc_resource.c/resource_log_pipe_topology_update.
    (CVE-2024-43886)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-43886");
