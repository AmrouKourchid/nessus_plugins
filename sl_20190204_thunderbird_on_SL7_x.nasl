...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : thunderbird on SL7.x x86_64 (20190204)");
...
Security Fix(es) :
  ...
  - Mozilla: Memory safety bugs fixed in Firefox 65 and
    Firefox ESR 60.5 (CVE-2018-18501)

  - Mozilla: Privilege escalation through IPC channel
    messages (CVE-2018-18505)

  - libical: Multiple use-after-free vulnerabilities
    (CVE-2016-5824)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1902&L=SCIENTIFIC-LINUX-ERRATA&P=6070
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2315c882");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"thunderbird-60.5.0-1.el7_6", allowmaj:TRUE)) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"thunderbird-debuginfo-60.5.0-1.el7_6", allowmaj:TRUE)) flag++;
