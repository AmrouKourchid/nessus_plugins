...
# extracted from Fedora Security Advisory FEDORA-2024-dc7f1d57e4
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-dc7f1d57e4");

  script_name(english:"Fedora 39 : python3.9 (2024-dc7f1d57e4)");
...
FEDORA-2024-dc7f1d57e4 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-dc7f1d57e4");
...
var pkgs = [
    {'reference':'python3.9-3.9.19-6.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
