...
if (description)
{
  ...
  script_name(english:"SUSE SLES15 Security Update : hdf5 (SUSE-SU-2022:1912-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote SUSE Linux SLES15 host has packages installed that are affected by multiple vulnerabilities as referenced in
the SUSE-SU-2022:1912-1 advisory.
...
var pkgs = [
    {'reference':'hdf5-gnu-hpc-1.10.8-150300.4.3.1', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.3', 'sle-module-hpc-release-15.3']},
    {'reference':'hdf5-gnu-hpc-devel-1.10.8-150300.4.3.1', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.3', 'sle-module-hpc-release-15.3']},
    {'reference':'hdf5-gnu-mpich-hpc-1.10.8-150300.4.3.2', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.3', 'sle-module-hpc-release-15.3']},
    {'reference':'hdf5-gnu-mpich-hpc-devel-1.10.8-150300.4.3.2', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.3', 'sle-module-hpc-release-15.3']},
    {'reference':'hdf5-gnu-mvapich2-hpc-1.10.8-150300.4.3.1', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.3', 'sle-module-hpc-release-15.3']},
    {'reference':'hdf5-gnu-mvapich2-hpc-devel-1.10.8-150300.4.3.1', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.3', 'sle-module-hpc-release-15.3']},
    {'reference':'hdf5-gnu-openmpi3-hpc-1.10.8-150300.4.3.2', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.3', 'sle-module-hpc-release-15.3']},
    {'reference':'hdf5-gnu-openmpi3-hpc-devel-1.10.8-150300.4.3.2', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.3', 'sle-module-hpc-release-15.3']},
    {'reference':'hdf5-gnu-openmpi4-hpc-1.10.8-150300.4.3.2', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.3', 'sle-module-hpc-release-15.3']},
    {'reference':'hdf5-gnu-openmpi4-hpc-devel-1.10.8-150300.4.3.2', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.3', 'sle-module-hpc-release-15.3']},
    {'reference':'hdf5-hpc-examples-1.10.8-150300.4.3.1', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.3', 'sle-module-hpc-release-15.3']},
