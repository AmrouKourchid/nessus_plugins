...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : mod_wsgi vulnerability (USN-2431-1)");
...
USN-2431-1 advisory.
    ...
    It was discovered that mod_wsgi incorrectly handled errors when setting up the working directory and group
    access rights. A malicious application could possibly use this issue to cause a local privilege escalation
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2431-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'libapache2-mod-wsgi', 'pkgver': '3.4-4ubuntu2.1.14.04.2'},
    {'osver': '14.04', 'pkgname': 'libapache2-mod-wsgi-py3', 'pkgver': '3.4-4ubuntu2.1.14.04.2'}
];
