...
# extracted from Ubuntu Security Notice USN-3963-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"3963-1");

  script_name(english:"Ubuntu 18.04 LTS : Memcached vulnerability (USN-3963-1)");
...
USN-3963-1 advisory.
    ...
    It was discovered that Memcached incorrectly handled certain lru command messages. A remote attacker could
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3963-1");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'memcached', 'pkgver': '1.5.6-0ubuntu1.1'}
];
