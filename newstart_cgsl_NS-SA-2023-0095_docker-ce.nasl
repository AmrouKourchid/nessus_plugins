...
# extracted from ZTE advisory NS-SA-2023-0095. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2019-14809", "CVE-2019-16276");

  script_name(english:"NewStart CGSL MAIN 6.06 : docker-ce Multiple Vulnerabilities (NS-SA-2023-0095)");

  script_set_attribute(attribute:"synopsis", value:
"The remote NewStart CGSL host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 6.06, has docker-ce packages installed that are affected by multiple
vulnerabilities:
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/notice/NS-SA-2023-0095");
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/info/CVE-2019-14809");
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/info/CVE-2019-16276");
...
var pkgs = {
  'CGSL MAIN 6.06': [
    'docker-ce-17.03.3-1.zncgsl6.t5.0'
  ]
};
