...
# extracted from Amazon Linux 2 Security Advisory ALAS-2019-1262.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2019-1262");

  script_name(english:"Amazon Linux 2 : 389-ds-base (ALAS-2019-1262)");
...
service. (CVE-2019-3883)");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2019-1262.html");
...
flag = 0;
if (rpm_check(release:"AL2", reference:"389-ds-base-1.3.8.4-25.1.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"389-ds-base-debuginfo-1.3.8.4-25.1.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"389-ds-base-devel-1.3.8.4-25.1.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"389-ds-base-libs-1.3.8.4-25.1.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"389-ds-base-snmp-1.3.8.4-25.1.amzn2.0.1")) flag++;
