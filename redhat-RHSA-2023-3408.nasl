...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_3408.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f8a63a84");
...
"Update the RHEL openssl package based on the guidance in RHSA-2023:3408.");
  ...
  script_set_attribute(attribute:"cvss4_score_source", value:"CVE-2023-0215");
