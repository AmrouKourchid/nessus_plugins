...
# extracted from Oracle Linux Security Advisory ELSA-2024-9625.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : squid (ELSA-2024-9625)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-9625.html");
...
var pkgs = [
    {'reference':'squid-5.5-14.el9_5.3', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
    {'reference':'squid-5.5-14.el9_5.3', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
];
