...
# extracted from openSUSE Security Update openSUSE-2019-2555.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : haproxy (openSUSE-2019-2555)");
...
This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1142529");
...
"Update the affected haproxy packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-14241");
...
if ( rpm_check(release:"SUSE15.0", reference:"haproxy-2.0.5+git0.d905f49a-lp150.2.13.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"haproxy-debuginfo-2.0.5+git0.d905f49a-lp150.2.13.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"haproxy-debugsource-2.0.5+git0.d905f49a-lp150.2.13.1") ) flag++;
