...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : freerdp (EulerOS-SA-2019-1284)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1284
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9188563c");
...
pkgs = ["freerdp-1.0.2-6.1.h1",
        "freerdp-libs-1.0.2-6.1.h1",
        "freerdp-plugins-1.0.2-6.1.h1"];
