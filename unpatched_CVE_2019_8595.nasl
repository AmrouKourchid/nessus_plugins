...
if (description)
{
  ...
  script_cve_id("CVE-2019-8595");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2019-8595");
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"vuln_publication_date", value:"2019/05/18");
