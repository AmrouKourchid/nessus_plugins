...
# extracted from Fedora Security Advisory FEDORA-2024-247e9ba33a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-247e9ba33a");

  script_name(english:"Fedora 40 : python-setuptools (2024-247e9ba33a)");
...
FEDORA-2024-247e9ba33a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-247e9ba33a");
...
var pkgs = [
    {'reference':'python-setuptools-69.0.3-4.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
