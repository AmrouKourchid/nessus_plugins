...
# extracted from Red Hat Security Advisory RHSA-2019:0548. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:0548");

  script_name(english:"RHEL 7 : OpenShift Container Platform 3.10 haproxy (RHSA-2019:0548)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for OpenShift Container Platform 3.10 haproxy.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_0548.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d1de55cc");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:0548");
...
"Update the RHEL OpenShift Container Platform 3.10 haproxy package based on the guidance in RHSA-2019:0548.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'haproxy18-1.8.17-3.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-ansible'},
      {'reference':'haproxy18-1.8.17-3.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-ansible'}
    ]
  }
];
