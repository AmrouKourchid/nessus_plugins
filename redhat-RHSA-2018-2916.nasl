...
referenced in the RHSA-2018:2916 advisory.

    The SpamAssassin tool provides a way to reduce unsolicited commercial email (spam) from incoming email.

    Security Fix(es):

    * spamassassin: Certain unclosed tags in crafted emails allow for scan timeouts and result in denial of
    service (CVE-2017-15705)
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_2916.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a3f9531a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:2916");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1629521");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1629536");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL spamassassin package based on the guidance in RHSA-2018:2916.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'spamassassin-3.4.0-4.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
