...
# extracted from VMware Security Advisory PHSA-2022-4.0-0259. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Dhcp PHSA-2022-4.0-0259");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the dhcp package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-259.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'dhcp-client-4.4.2-6.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'dhcp-devel-4.4.2-6.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'dhcp-libs-4.4.2-6.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'dhcp-server-4.4.2-6.ph4')) flag++;
