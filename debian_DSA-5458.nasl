...
# extracted from Debian Security Advisory dsa-5458. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-5458-1 : openjdk-17 - security update");
...
dsa-5458 advisory.
    ...
    Several vulnerabilities have been discovered in the OpenJDK Java runtime, which may result in bypass of
    sandbox restrictions, information disclosure, reduced cryptographic strength of the AES implementation,
    directory traversal or denial of service. For the oldstable distribution (bullseye) additional build
    dependencies need to be backported, a fixed package will be provided when these are ready as
    17.0.8+7-1~deb11u1. For the stable distribution (bookworm), these problems have been fixed in version
    17.0.8+7-1~deb12u1. We recommend that you upgrade your openjdk-17 packages. For the detailed security
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2023/dsa-5458");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-22044");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'openjdk-17-dbg', 'reference': '17.0.8+7-1~deb12u1'},
    {'release': '12.0', 'prefix': 'openjdk-17-demo', 'reference': '17.0.8+7-1~deb12u1'},
    {'release': '12.0', 'prefix': 'openjdk-17-doc', 'reference': '17.0.8+7-1~deb12u1'},
    {'release': '12.0', 'prefix': 'openjdk-17-jdk', 'reference': '17.0.8+7-1~deb12u1'},
    {'release': '12.0', 'prefix': 'openjdk-17-jdk-headless', 'reference': '17.0.8+7-1~deb12u1'},
    {'release': '12.0', 'prefix': 'openjdk-17-jre', 'reference': '17.0.8+7-1~deb12u1'},
    {'release': '12.0', 'prefix': 'openjdk-17-jre-headless', 'reference': '17.0.8+7-1~deb12u1'},
    {'release': '12.0', 'prefix': 'openjdk-17-jre-zero', 'reference': '17.0.8+7-1~deb12u1'},
    {'release': '12.0', 'prefix': 'openjdk-17-source', 'reference': '17.0.8+7-1~deb12u1'}
];
