...
if (description)
{
  ...
  script_name(english:"RHEL 8 : RHV Manager (ovirt-engine) 4.4.z [ovirt-4.4.5] 0-day security,  enhance (Moderate) (RHSA-2021:1186)");
...
referenced in the RHSA-2021:1186 advisory.
    ...
    Bug Fix(es):
    * Previously, saving user preferences in the Red Hat Virtualization Manager required the MANIPULATE_USERS
    permission level. As a result, user preferences were not saved on the server.
    In this release, the required permission level for saving user preferences was changed to EDIT_PROFILE,
    which is the permission level assigned by default to all users. As a result, saving user preferences works
    as expected. (BZ#1920539)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_1186.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?47709fe9");
  # https://access.redhat.com/documentation/en-us/red_hat_virtualization/4.4/html-single/technical_notes
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1171924");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1750426");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1795457");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1920539");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ovirt-engine-ui-extensions-1.2.5-1.el8ev', 'release':'8', 'el_string':'el8ev', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'}
    ]
  }
];
