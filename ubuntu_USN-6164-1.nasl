...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS / 22.04 LTS / 23.04 : c-ares vulnerabilities (USN-6164-1)");
...
vulnerabilities as referenced in the USN-6164-1 advisory.

    Hannes Moesl discovered that c-ares incorrectly handled certain ipv6 addresses. An attacker could use this
    issue to cause c-ares to crash, resulting in a denial of service, or possibly execute arbitrary code.
    (CVE-2023-31130)

    Xiang Li discovered that c-ares incorrectly handled certain UDP packets. A remote attacker could possibly
    use this issue to cause c-res to crash, resulting in a denial of service. (CVE-2023-32067)
