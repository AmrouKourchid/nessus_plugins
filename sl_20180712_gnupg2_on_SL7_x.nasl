...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : gnupg2 on SL7.x x86_64 (20180712)");
...
"Security Fix(es) :
  ...
  - gnupg2: Improper sanitization of filenames allows for
    ...
    signature verification (CVE-2018-12020)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1807&L=scientific-linux-errata&F=&S=&P=6995
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a29cdd07");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"gnupg2-2.0.22-5.el7_5")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"gnupg2-debuginfo-2.0.22-5.el7_5")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"gnupg2-smime-2.0.22-5.el7_5")) flag++;
