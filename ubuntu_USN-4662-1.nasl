...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 20.04 LTS : OpenSSL vulnerability (USN-4662-1)");
...
referenced in the USN-4662-1 advisory.

    David Benjamin discovered that OpenSSL incorrectly handled comparing certificates containing a
    EDIPartyName name type. A remote attacker could possibly use this issue to cause OpenSSL to crash,
