...
# extracted from F5 Networks BIG-IP Solution K000151082.
#
# @NOAGENT@
##
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : PostgreSQL vulnerability (K000151082)");
...
vulnerability as referenced in the K000151082 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K000151082");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K000151082.");
