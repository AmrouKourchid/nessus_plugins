...
# extracted from Fedora Security Advisory FEDORA-2024-ca3f071aea
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-ca3f071aea");

  script_name(english:"Fedora 38 : webkitgtk (2024-ca3f071aea)");
...
FEDORA-2024-ca3f071aea advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-ca3f071aea");
...
var pkgs = [
    {'reference':'webkitgtk-2.42.5-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
