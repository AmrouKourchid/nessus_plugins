...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"RHSA-2022:2191");
  script_xref(name:"IAVA", value:"2024-A-0327");

  script_name(english:"Scientific Linux Security Update : gzip on SL7.x x86_64 (2022:2191)");
...
SLSA-2022:2191-1 advisory.

  - gzip: arbitrary-file-write vulnerability (CVE-2022-1271)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.scientificlinux.org/category/sl-errata/slsa-20222191-1");
  script_set_attribute(attribute:"solution", value:
"Update the affected gzip and / or gzip-debuginfo packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fermilab:scientific_linux:gzip");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fermilab:scientific_linux:gzip-debuginfo");
...
var pkgs = [
    {'reference':'gzip-1.5-11.el7_9', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'gzip-debuginfo-1.5-11.el7_9', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE}
];
