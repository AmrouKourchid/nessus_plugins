...
if (description)
{
  ...
  script_name(english:"Adobe Illustrator < 25.4.6 / 26.0.0 < 26.3.1 Multiple Vulnerabilities (APSB22-26) (macOS)");

  script_set_attribute(attribute:"synopsis", value:
"The Adobe Illustrator instance installed on the remote host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Illustrator installed on the remote macOS host is prior to 25.4.6, 26.3.1. It is, therefore,
affected by multiple vulnerabilities as referenced in the APSB22-26 advisory.
  ...
  - Adobe Illustrator versions 26.0.2 (and earlier) and 25.4.5 (and earlier) are affected by an out-of-bounds
    ...
    (CVE-2022-30637, CVE-2022-30638, CVE-2022-30639, CVE-2022-30640, CVE-2022-30641, CVE-2022-30642,
    CVE-2022-30643, CVE-2022-30645, CVE-2022-30646, CVE-2022-30649)
  ...
  - Adobe Illustrator versions 26.0.2 (and earlier) and 25.4.5 (and earlier) are affected by a Use-After-Free
    ...
    Exploitation of this issue requires user interaction in that a victim must open a malicious file.
    (CVE-2022-30644, CVE-2022-30647, CVE-2022-30648)
...
"Upgrade to Adobe Illustrator version 25.4.6, 26.3.1 or later.");
