...
# extracted from Ubuntu Security Notice USN-5614-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5614-2");

  script_name(english:"Ubuntu 16.04 ESM : Wayland vulnerability (USN-5614-2)");
...
USN-5614-2 advisory.
    ...
    USN-5614-1 fixed a vulnerability in Wayland. This update provides the corresponding update for Ubuntu
    16.04 ESM.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5614-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libwayland-bin', 'pkgver': '1.12.0-1~ubuntu16.04.3+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libwayland-client0', 'pkgver': '1.12.0-1~ubuntu16.04.3+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libwayland-cursor0', 'pkgver': '1.12.0-1~ubuntu16.04.3+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libwayland-dev', 'pkgver': '1.12.0-1~ubuntu16.04.3+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libwayland-server0', 'pkgver': '1.12.0-1~ubuntu16.04.3+esm1', 'ubuntu_pro': TRUE}
];
