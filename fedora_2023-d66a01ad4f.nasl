...
# extracted from Fedora Security Advisory FEDORA-2023-d66a01ad4f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-d66a01ad4f");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2023/10/23");

  script_name(english:"Fedora 38 : chromium (2023-d66a01ad4f)");
...
FEDORA-2023-d66a01ad4f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-d66a01ad4f");
...
var pkgs = [
    {'reference':'chromium-117.0.5938.132-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
