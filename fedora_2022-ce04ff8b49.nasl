...
# extracted from Fedora Security Advisory FEDORA-2022-ce04ff8b49
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-ce04ff8b49");

  script_name(english:"Fedora 36 : w3m (2022-ce04ff8b49)");
...
FEDORA-2022-ce04ff8b49 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-ce04ff8b49");
...
var pkgs = [
    {'reference':'w3m-0.5.3-58.git20220429.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
