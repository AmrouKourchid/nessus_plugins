...
# extracted from openSUSE Security Update openSUSE-2019-1604.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : dbus-1 (openSUSE-2019-1604)");
...
Security issue fixed :
  ...
  - CVE-2019-12749: Fixed an implementation flaw in
    ...
    attackers to bypass authentication (bsc#1137832). 
...
if ( rpm_check(release:"SUSE15.0", reference:"dbus-1-1.12.2-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"dbus-1-debuginfo-1.12.2-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"dbus-1-debugsource-1.12.2-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"dbus-1-devel-1.12.2-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"dbus-1-x11-1.12.2-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"dbus-1-x11-debuginfo-1.12.2-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"dbus-1-x11-debugsource-1.12.2-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libdbus-1-3-1.12.2-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libdbus-1-3-debuginfo-1.12.2-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"dbus-1-32bit-debuginfo-1.12.2-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"dbus-1-devel-32bit-1.12.2-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libdbus-1-3-32bit-1.12.2-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libdbus-1-3-32bit-debuginfo-1.12.2-lp150.2.3.1") ) flag++;
