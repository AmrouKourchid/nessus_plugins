...
# extracted from Fedora Security Advisory FEDORA-2024-f7ae5df88d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-f7ae5df88d");

  script_name(english:"Fedora 38 : glibc (2024-f7ae5df88d)");
...
FEDORA-2024-f7ae5df88d advisory.

    This update includes several bug fixes from the upstream glibc release branch, including a fix for
    CVE-2024-2961.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-f7ae5df88d");
...
var pkgs = [
    {'reference':'glibc-2.37-19.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
