...
# extracted from Fedora Security Advisory FEDORA-2023-2cf272ad72
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-2cf272ad72");

  script_name(english:"Fedora 37 : stellarium (2023-2cf272ad72)");
...
FEDORA-2023-2cf272ad72 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-2cf272ad72");
  script_set_attribute(attribute:"solution", value:
"Update the affected stellarium package.");
...
var pkgs = [
    {'reference':'stellarium-1.2-9.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
