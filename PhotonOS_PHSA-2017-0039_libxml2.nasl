...
if (description)
{
  ...
  script_cve_id("CVE-2017-5969");

  script_name(english:"Photon OS 1.0: Libxml2 PHSA-2017-0039");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-5969");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'libxml2-2.9.6-1.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'libxml2-debuginfo-2.9.6-1.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'libxml2-devel-2.9.6-1.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'libxml2-python-2.9.6-1.ph1')) flag++;
