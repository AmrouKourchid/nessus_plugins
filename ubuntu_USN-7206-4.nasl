...
# extracted from Ubuntu Security Notice USN-7206-4. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"7206-4");

  script_name(english:"Ubuntu 24.10 : rsync regression (USN-7206-4)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 24.10 host has a package installed that is affected by a vulnerability as referenced in the USN-7206-4
advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7206-4");
...
var pkgs = [
    {'osver': '24.10', 'pkgname': 'rsync', 'pkgver': '3.3.0-1ubuntu0.2'}
];
