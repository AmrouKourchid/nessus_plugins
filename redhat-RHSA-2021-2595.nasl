...
# extracted from Red Hat Security Advisory RHSA-2021:2595. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:2595");

  script_name(english:"RHEL 8 : 389-ds:1.4 (RHSA-2021:2595)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for 389-ds:1.4.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2021:2595 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_2595.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?955e0ae2");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:2595");
...
"Update the RHEL 389-ds:1.4 package based on the guidance in RHSA-2021:2595.");
  ...
  '389-ds:1.4': [
    {
      ...
      'pkgs': [
        {'reference':'389-ds-base-1.4.3.16-16.module+el8.4.0+11446+fc96bc48', 'sp':'4', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'389-ds-base-devel-1.4.3.16-16.module+el8.4.0+11446+fc96bc48', 'sp':'4', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'389-ds-base-legacy-tools-1.4.3.16-16.module+el8.4.0+11446+fc96bc48', 'sp':'4', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'389-ds-base-libs-1.4.3.16-16.module+el8.4.0+11446+fc96bc48', 'sp':'4', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'389-ds-base-snmp-1.4.3.16-16.module+el8.4.0+11446+fc96bc48', 'sp':'4', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-lib389-1.4.3.16-16.module+el8.4.0+11446+fc96bc48', 'sp':'4', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE}
      ]
    },
    {
      'repo_relative_urls': [
      ...
      'pkgs': [
        {'reference':'389-ds-base-1.4.3.16-16.module+el8.4.0+11446+fc96bc48', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'389-ds-base-devel-1.4.3.16-16.module+el8.4.0+11446+fc96bc48', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'389-ds-base-legacy-tools-1.4.3.16-16.module+el8.4.0+11446+fc96bc48', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'389-ds-base-libs-1.4.3.16-16.module+el8.4.0+11446+fc96bc48', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'389-ds-base-snmp-1.4.3.16-16.module+el8.4.0+11446+fc96bc48', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-lib389-1.4.3.16-16.module+el8.4.0+11446+fc96bc48', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
