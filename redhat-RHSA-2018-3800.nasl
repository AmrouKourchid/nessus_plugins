...
# extracted from Red Hat Security Advisory RHSA-2018:3800. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:3800");

  script_name(english:"RHEL 7 : rh-git218-git (RHSA-2018:3800)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for rh-git218-git.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2018:3800 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1653143");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_3800.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?61da9a09");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:3800");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rh-git218-git package based on the guidance in RHSA-2018:3800.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-git218-git-2.18.1-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git218-git-all-2.18.1-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git218-git-core-2.18.1-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git218-git-core-doc-2.18.1-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git218-git-cvs-2.18.1-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git218-git-daemon-2.18.1-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git218-git-email-2.18.1-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git218-git-gui-2.18.1-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git218-git-instaweb-2.18.1-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git218-git-p4-2.18.1-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git218-git-subtree-2.18.1-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git218-git-svn-2.18.1-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git218-gitk-2.18.1-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git218-gitweb-2.18.1-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git218-perl-Git-2.18.1-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git218-perl-Git-SVN-2.18.1-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
