...
# extracted from Fedora Security Advisory FEDORA-2023-dbba9e7218
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-dbba9e7218");

  script_name(english:"Fedora 38 : mingw-binutils (2023-dbba9e7218)");
...
FEDORA-2023-dbba9e7218 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-dbba9e7218");
...
"Update the affected mingw-binutils package.");
  ...
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:H/PR:N/UI:R/S:U/C:N/I:N/A:L");
...
var pkgs = [
    {'reference':'mingw-binutils-2.39-5.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
