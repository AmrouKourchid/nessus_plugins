...
# extracted from Debian Security Advisory dla-3732. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2023-7090", "CVE-2023-28486", "CVE-2023-28487");
  script_xref(name:"IAVA", value:"2023-A-0121-S");

  script_name(english:"Debian dla-3732 : sudo - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-28486");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-28487");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-7090");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/sudo");
...
"Upgrade the sudo packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-7090");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'sudo', 'reference': '1.8.27-1+deb10u6'},
    {'release': '10.0', 'prefix': 'sudo-ldap', 'reference': '1.8.27-1+deb10u6'}
];
