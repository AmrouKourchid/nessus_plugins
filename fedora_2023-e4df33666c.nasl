...
# extracted from Fedora Security Advisory FEDORA-2023-e4df33666c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-e4df33666c");

  script_name(english:"Fedora 38 : openvpn (2023-e4df33666c)");
...
FEDORA-2023-e4df33666c advisory.

    This is an extended update of the OpenVPN 2.6.7 release which contains security fixes for CVE-2023-46849
    and CVE-2023-46850.  That release had a regression causing the `openvpn` daemon to segfault frequently;
    which is why the 2.6.7 release was pulled.  This 2.6.8 release contains a fix for the regression issue as
    well.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-e4df33666c");
...
var pkgs = [
    {'reference':'openvpn-2.6.8-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
