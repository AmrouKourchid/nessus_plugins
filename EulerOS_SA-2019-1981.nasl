...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : openssl110h (EulerOS-SA-2019-1981)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the version of the openssl110h packages installed, the
...
vulnerability :
  ...
  - The OpenSSL ECDSA signature algorithm has been shown to
    ...
    to recover the private key.(CVE-2018-0735)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1981
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a4466dd9");
  script_set_attribute(attribute:"solution", value:
"Update the affected openssl110h package.");
...
pkgs = ["openssl110h-1.1.0h-3.h9.eulerosv2r7",
        "openssl110h-devel-1.1.0h-3.h9.eulerosv2r7",
        "openssl110h-libs-1.1.0h-3.h9.eulerosv2r7",
        "openssl110h-static-1.1.0h-3.h9.eulerosv2r7"];
