...
# extracted from Fedora Security Advisory FEDORA-2024-ab6348928b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-ab6348928b");
  script_xref(name:"IAVB", value:"2024-B-0154-S");

  script_name(english:"Fedora 39 : libarchive (2024-ab6348928b)");
...
FEDORA-2024-ab6348928b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-ab6348928b");
...
var pkgs = [
    {'reference':'libarchive-3.7.1-3.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
