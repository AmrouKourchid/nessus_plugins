...
# extracted from Amazon Linux 2 Security Advisory ALAS-2019-1187.
#
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : bind (ALAS-2019-1187)");
...
were.(CVE-2018-5741)");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2019-1187.html");
...
flag = 0;
if (rpm_check(release:"AL2", reference:"bind-9.9.4-73.amzn2.1.2")) flag++;
if (rpm_check(release:"AL2", reference:"bind-chroot-9.9.4-73.amzn2.1.2")) flag++;
if (rpm_check(release:"AL2", reference:"bind-debuginfo-9.9.4-73.amzn2.1.2")) flag++;
if (rpm_check(release:"AL2", reference:"bind-devel-9.9.4-73.amzn2.1.2")) flag++;
if (rpm_check(release:"AL2", reference:"bind-libs-9.9.4-73.amzn2.1.2")) flag++;
if (rpm_check(release:"AL2", reference:"bind-libs-lite-9.9.4-73.amzn2.1.2")) flag++;
if (rpm_check(release:"AL2", reference:"bind-license-9.9.4-73.amzn2.1.2")) flag++;
if (rpm_check(release:"AL2", reference:"bind-lite-devel-9.9.4-73.amzn2.1.2")) flag++;
if (rpm_check(release:"AL2", reference:"bind-pkcs11-9.9.4-73.amzn2.1.2")) flag++;
if (rpm_check(release:"AL2", reference:"bind-pkcs11-devel-9.9.4-73.amzn2.1.2")) flag++;
if (rpm_check(release:"AL2", reference:"bind-pkcs11-libs-9.9.4-73.amzn2.1.2")) flag++;
if (rpm_check(release:"AL2", reference:"bind-pkcs11-utils-9.9.4-73.amzn2.1.2")) flag++;
if (rpm_check(release:"AL2", reference:"bind-sdb-9.9.4-73.amzn2.1.2")) flag++;
if (rpm_check(release:"AL2", reference:"bind-sdb-chroot-9.9.4-73.amzn2.1.2")) flag++;
if (rpm_check(release:"AL2", reference:"bind-utils-9.9.4-73.amzn2.1.2")) flag++;
