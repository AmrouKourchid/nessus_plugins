...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : openssh (EulerOS-SA-2020-1719)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1719
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a9fabfab");
...
pkgs = ["openssh-7.4p1-16.h17.eulerosv2r7",
        "openssh-clients-7.4p1-16.h17.eulerosv2r7",
        "openssh-keycat-7.4p1-16.h17.eulerosv2r7",
        "openssh-server-7.4p1-16.h17.eulerosv2r7",
        "pam_ssh_agent_auth-0.10.3-2.16.eulerosv2r7"];
