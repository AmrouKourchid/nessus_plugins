...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.0 : python-cryptography (EulerOS-SA-2023-2531)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2531
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ea87b08e");
...
var pkgs = [
  "python-cryptography-help-2.9-1.h3.eulerosv2r9"
];
