...
# extracted from Red Hat Security Advisory RHSA-2023:0824. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:0824");
  script_xref(name:"IAVA", value:"2023-A-0106-S");

  script_name(english:"RHEL 9 : thunderbird (RHSA-2023:0824)");
...
referenced in the RHSA-2023:0824 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_0824.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8238da13");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:0824");
...
"Update the RHEL thunderbird package based on the guidance in RHSA-2023:0824.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'thunderbird-102.8.0-2.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
