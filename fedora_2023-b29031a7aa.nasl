...
# extracted from Fedora Security Advisory FEDORA-2023-b29031a7aa
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-b29031a7aa");

  script_name(english:"Fedora 40 : chisel (2023-b29031a7aa)");
...
FEDORA-2023-b29031a7aa advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-b29031a7aa");
...
var pkgs = [
    {'reference':'chisel-1.9.0-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
