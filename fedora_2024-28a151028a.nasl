...
# extracted from Fedora Security Advisory FEDORA-2024-28a151028a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-28a151028a");

  script_name(english:"Fedora 38 : rust-routinator (2024-28a151028a)");
...
FEDORA-2024-28a151028a advisory.

    from [changelog](https://github.com/NLnetLabs/routinator/commit/f1e85a7505201524bd68fb9296e7db0752907a6f):

    * Fix the RTR listener so that Routinator wont exit if an incoming RTR
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-28a151028a");
...
"Update the affected rust-routinator package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-1622");
...
var pkgs = [
    {'reference':'rust-routinator-0.13.2-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
