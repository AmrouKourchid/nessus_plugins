...
# extracted from Fedora Security Advisory FEDORA-2023-68df3f4b02
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-68df3f4b02");
  script_xref(name:"IAVB", value:"2023-B-0058-S");
  script_xref(name:"IAVB", value:"2023-B-0073-S");

  script_name(english:"Fedora 38 : qemu (2023-68df3f4b02)");
...
FEDORA-2023-68df3f4b02 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-68df3f4b02");
...
var pkgs = [
    {'reference':'qemu-7.2.5-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
