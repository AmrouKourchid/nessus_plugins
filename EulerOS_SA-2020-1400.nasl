...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : libgcrypt (EulerOS-SA-2020-1400)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1400
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d9033bac");
...
pkgs = ["libgcrypt-1.5.3-13.1.h3",
        "libgcrypt-devel-1.5.3-13.1.h3"];
