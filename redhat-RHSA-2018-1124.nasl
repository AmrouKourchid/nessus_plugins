...
# extracted from Red Hat Security Advisory RHSA-2018:1124. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 6 : python-paramiko (RHSA-2018:1124)");
...
listed in the References section.");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:1124");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/cve-2018-7750");
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", reference:"python-paramiko-1.7.5-4.el6_9")) flag++;
