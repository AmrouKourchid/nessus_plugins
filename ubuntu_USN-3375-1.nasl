...
# extracted from Ubuntu Security Notice USN-3375-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"3375-1");

  script_name(english:"Ubuntu 14.04 LTS : LXC vulnerability (USN-3375-1)");
...
USN-3375-1 advisory.
    ...
    It was discovered that LXC incorrectly handled the TIOCSTI ioctl. An attacker could possibly use this
    issue to escape LXC containers.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3375-1");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-10124");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'liblxc1', 'pkgver': '1.0.10-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'lxc', 'pkgver': '1.0.10-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'lxc-dev', 'pkgver': '1.0.10-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'lxc-templates', 'pkgver': '1.0.10-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'lxc-tests', 'pkgver': '1.0.10-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'python3-lxc', 'pkgver': '1.0.10-0ubuntu1.1'}
];
