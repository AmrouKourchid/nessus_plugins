...
# extracted from Ubuntu Security Notice USN-6566-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6566-2");
  script_xref(name:"IAVA", value:"2024-A-0003-S");

  script_name(english:"Ubuntu 18.04 LTS : SQLite vulnerability (USN-6566-2)");
...
USN-6566-2 advisory.
    ...
    USN-6566-1 fixed several vulnerabilities in SQLite. This update provides the corresponding fix for
    CVE-2023-7104 for Ubuntu 18.04 LTS.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6566-2");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'lemon', 'pkgver': '3.22.0-1ubuntu0.7+esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libsqlite3-0', 'pkgver': '3.22.0-1ubuntu0.7+esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libsqlite3-dev', 'pkgver': '3.22.0-1ubuntu0.7+esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libsqlite3-tcl', 'pkgver': '3.22.0-1ubuntu0.7+esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'sqlite3', 'pkgver': '3.22.0-1ubuntu0.7+esm1', 'ubuntu_pro': TRUE}
];
