...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.0 : syslinux (EulerOS-SA-2023-3081)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3081
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?129609af");
...
var pkgs = [
  "syslinux-6.04-9.h2.eulerosv2r11",
  "syslinux-nonlinux-6.04-9.h2.eulerosv2r11"
];
