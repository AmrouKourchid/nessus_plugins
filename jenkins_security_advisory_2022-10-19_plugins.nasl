...
var constraints = [
    {'max_version' : '1.7.2', 'fixed_display' : 'See vendor advisory', 'plugin' : '360 FireLine Plugin'},
    {'max_version' : '2.0.12', 'fixed_version' : '2.0.13', 'plugin' : 'Compuware Source Code Download for Endevor, PDS, and ISPW Plugin'},
    {'max_version' : '1.0.1', 'fixed_display' : 'See vendor advisory', 'plugin' : 'Compuware Strobe Measurement Plugin'},
    {'max_version' : '2.4.8', 'fixed_display' : 'See vendor advisory', 'plugin' : 'Compuware Topaz for Total Test Plugin'},
    {'max_version' : '1.0.8', 'fixed_version' : '1.0.9', 'plugin' : 'Compuware Topaz Utilities Plugin'},
    {'max_version' : '1.0.7', 'fixed_version' : '1.0.8', 'plugin' : 'Compuware Xpediter Code Coverage Plugin'},
    {'max_version' : '3.9', 'fixed_version' : '3.10', 'plugin' : 'Contrast Continuous Application Security Plugin'},
    {'max_version' : '1.4', 'fixed_display' : 'See vendor advisory', 'plugin' : 'Custom Checkbox Parameter Plugin'},
    {'max_version' : '1.84.1', 'fixed_version' : '1.84.2', 'plugin' : 'Generic Webhook Trigger Plugin'},
    {'max_version' : '1.5.35', 'fixed_version' : '1.5.36', 'plugin' : 'GitLab Plugin'},
    {'max_version' : '3.5', 'fixed_version' : '3.6', 'plugin' : 'Job Import Plugin'},
    {'min_version' : '1.0.33', 'fixed_version' : '1.0.34', 'plugin' : 'Katalon Plugin'},
    {'max_version' : '1251', 'fixed_version' : '1260', 'fixed_display' : '1260.vdfb_723cdcc81', 'plugin' : 'Mercurial Plugin'},
    {'max_version' : '1.20', 'fixed_display' : 'See vendor advisory', 'plugin' : 'NeuVector Vulnerability Scanner Plugin'},
    {'max_version' : '0.27', 'fixed_version' : '0.28', 'plugin' : 'NUnit Plugin'},
    {'max_version' : '583', 'fixed_version' : '588', 'fixed_display' : '588.v576c103a_ff86', 'plugin' : 'Pipeline: Deprecated Groovy Libraries Plugin'},
    {'max_version' : '612', 'fixed_version' : '612.614', 'fixed_display' : '613.v9c41a_160233f or 612.614.v48dcb_f62a_640', 'plugin' : 'Pipeline: Groovy Libraries Plugin'},
    {'max_version' : '2802', 'fixed_version' : '2803', 'fixed_display' : '2803.v1a_f77ffcc773', 'plugin' : 'Pipeline: Groovy Plugin'},
    {'max_version' : '451', 'fixed_version' : '456', 'fixed_display' : '456.vd8a_957db_5b_e9', 'plugin' : 'Pipeline: Input Step Plugin'},
    {'max_version' : '2.26', 'fixed_version' : '2.27', 'plugin' : 'Pipeline: Stage View Plugin'},
    {'max_version' : '838', 'fixed_version' : '839', 'fixed_display' : '839.v35e2736cfd5c', 'plugin' : 'Pipeline: Supporting APIs Plugin'},
    {'max_version' : '1.15.0', 'fixed_version' : '1.16.0', 'plugin' : 'REPO Plugin'},
    {'max_version' : '1.0.8', 'fixed_display' : 'See vendor advisory', 'plugin' : 'S3 Explorer Plugin'},
    {'max_version' : '0.7', 'fixed_display' : 'See vendor advisory', 'plugin' : 'ScreenRecorder Plugin'},
    {'max_version' : '1183', 'fixed_version' : '1184', 'fixed_display' : '1184.v85d16b_d851b_3', 'plugin' : 'Script Security Plugin'},
    {'max_version' : '3.2.4', 'fixed_version' : '3.2.5', 'plugin' : 'Tuleap Git Branch Source Plugin'},
    {'max_version' : '1.0.22', 'fixed_display' : 'See vendor advisory', 'plugin' : 'XFramium Builder Plugin'}
];
