...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : Critical: / tog-pegasus (ELSA-2008-0002)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2008-0002.html");
...
"Update the affected tog-pegasus and / or tog-pegasus-devel packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2008-0003");
...
var pkgs = [
    {'reference':'tog-pegasus-2.6.1-2.el5_1.1.0.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'tog-pegasus-devel-2.6.1-2.el5_1.1.0.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'tog-pegasus-2.6.1-2.el5_1.1.0.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'tog-pegasus-devel-2.6.1-2.el5_1.1.0.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
