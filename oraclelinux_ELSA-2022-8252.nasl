...
# extracted from Oracle Linux Security Advisory ELSA-2022-8252.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : yajl (ELSA-2022-8252)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2022-8252.html");
...
var pkgs = [
    {'reference':'yajl-2.1.0-21.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'yajl-devel-2.1.0-21.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'yajl-2.1.0-21.el9', 'cpu':'i686', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'yajl-devel-2.1.0-21.el9', 'cpu':'i686', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'yajl-2.1.0-21.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'yajl-devel-2.1.0-21.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
