...
# extracted from openSUSE Security Update openSUSE-2020-2348.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : flac (openSUSE-2020-2348)");
...
This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1180099");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1180112");
...
if ( rpm_check(release:"SUSE15.1", reference:"flac-1.3.2-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"flac-debuginfo-1.3.2-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"flac-debugsource-1.3.2-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"flac-devel-1.3.2-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libFLAC++6-1.3.2-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libFLAC++6-debuginfo-1.3.2-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libFLAC8-1.3.2-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libFLAC8-debuginfo-1.3.2-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"flac-devel-32bit-1.3.2-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libFLAC++6-32bit-1.3.2-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libFLAC++6-32bit-debuginfo-1.3.2-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libFLAC8-32bit-1.3.2-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libFLAC8-32bit-debuginfo-1.3.2-lp151.4.3.1") ) flag++;
