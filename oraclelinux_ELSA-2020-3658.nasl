...
# extracted from Oracle Linux Security Advisory ELSA-2020-3658.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : librepo (ELSA-2020-3658)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
ELSA-2020-3658 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2020-3658.html");
...
var pkgs = [
    ...
    {'reference':'librepo-1.11.0-3.el8_2', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-librepo-1.11.0-3.el8_2', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
