...
# extracted from Red Hat Security Advisory RHSA-2023:2444. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:2444");

  script_name(english:"RHEL 9 : net-snmp (RHSA-2023:2444)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for net-snmp.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2023:2444 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_2444.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9ba35568");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2151540");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:2444");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL net-snmp package based on the guidance in RHSA-2023:2444.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'net-snmp-5.9.1-9.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'net-snmp-agent-libs-5.9.1-9.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'net-snmp-devel-5.9.1-9.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'net-snmp-libs-5.9.1-9.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'net-snmp-perl-5.9.1-9.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'net-snmp-utils-5.9.1-9.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'python3-net-snmp-5.9.1-9.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
