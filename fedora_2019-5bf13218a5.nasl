...
# extracted from Fedora Security Advisory FEDORA-2019-5bf13218a5.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : ibus (2019-5bf13218a5)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-5bf13218a5");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"ibus-1.5.19-17.fc29")) flag++;
