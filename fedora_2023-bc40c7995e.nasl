...
# extracted from Fedora Security Advisory FEDORA-2023-bc40c7995e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-bc40c7995e");

  script_name(english:"Fedora 37 : firecracker / rust-aes-gcm (2023-bc40c7995e)");
...
FEDORA-2023-bc40c7995e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-bc40c7995e");
...
var pkgs = [
    {'reference':'firecracker-1.4.1-3.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-aes-gcm-0.10.3-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
