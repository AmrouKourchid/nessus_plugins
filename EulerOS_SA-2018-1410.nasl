...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.1 : kernel (EulerOS-SA-2018-1410)");
...
the following vulnerability :
  ...
  - An integer overflow flaw was found in the Linux
    ...
    their privileges on the system. Kernel versions 2.6.x,
    3.10.x and 4.14.x are believed to be
    vulnerable.(CVE-2018-14634)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1410
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e25baa43");
...
pkgs = ["kernel-3.10.0-514.44.5.10_76",
        "kernel-devel-3.10.0-514.44.5.10_76",
        "kernel-headers-3.10.0-514.44.5.10_76",
        "kernel-tools-3.10.0-514.44.5.10_76",
        "kernel-tools-libs-3.10.0-514.44.5.10_76",
        "kernel-tools-libs-devel-3.10.0-514.44.5.10_76"];
