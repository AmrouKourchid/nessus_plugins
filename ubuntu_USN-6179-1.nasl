...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 ESM / 18.04 ESM / 20.04 ESM / 22.04 ESM / 23.04 : Jettison vulnerability (USN-6179-1)");
...
a vulnerability as referenced in the USN-6179-1 advisory.

    It was discovered that Jettison incorrectly handled certain inputs. If a user or an automated system were
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libjettison-java', 'pkgver': '1.2-3ubuntu0.1~esm2', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libjettison-java', 'pkgver': '1.4.0-1ubuntu0.18.04.1~esm2', 'ubuntu_pro': TRUE},
    {'osver': '20.04', 'pkgname': 'libjettison-java', 'pkgver': '1.4.0-1ubuntu0.20.04.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '22.04', 'pkgname': 'libjettison-java', 'pkgver': '1.4.1-1ubuntu0.22.04.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '23.04', 'pkgname': 'libjettison-java', 'pkgver': '1.5.3-1ubuntu0.1', 'ubuntu_pro': FALSE}
];
