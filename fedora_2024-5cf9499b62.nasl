...
# extracted from Fedora Security Advisory FEDORA-2024-5cf9499b62
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-5cf9499b62");
  script_xref(name:"IAVA", value:"2024-A-0267-S");

  script_name(english:"Fedora 40 : chromium (2024-5cf9499b62)");
...
FEDORA-2024-5cf9499b62 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-5cf9499b62");
...
var pkgs = [
    {'reference':'chromium-124.0.6367.118-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
