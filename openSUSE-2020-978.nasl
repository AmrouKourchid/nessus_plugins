...
# extracted from openSUSE Security Update openSUSE-2020-978.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : LibVNCServer (openSUSE-2020-978)");
...
if ( rpm_check(release:"SUSE15.2", reference:"LibVNCServer-debugsource-0.9.10-lp152.9.4.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"LibVNCServer-devel-0.9.10-lp152.9.4.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libvncclient0-0.9.10-lp152.9.4.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libvncclient0-debuginfo-0.9.10-lp152.9.4.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libvncserver0-0.9.10-lp152.9.4.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libvncserver0-debuginfo-0.9.10-lp152.9.4.1") ) flag++;
