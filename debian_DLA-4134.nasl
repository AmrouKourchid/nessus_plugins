...
# extracted from Debian Security Advisory dla-4134. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-4134 : fig2dev - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2025-31162");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2025-31163");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2025-31164");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'fig2dev', 'reference': '1:3.2.8-3+deb11u2'}
];
