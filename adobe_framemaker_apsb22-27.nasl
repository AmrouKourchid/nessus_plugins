...
Adobe FrameMaker 2020 16.0.4. It is, therefore, affected by multiple vulnerabilities as referenced in the apsb22-27
advisory.

  - Adobe Framemaker versions 2029u8 (and earlier) and 2020u4 (and earlier) are affected by an out-of-bounds
  ...
  - Adobe Framemaker versions 2029u8 (and earlier) and 2020u4 (and earlier) are affected by a Use-after-free
    vulnerability that could result in arbitrary code execution in the context of the current user.
    Exploitation of this issue requires user interaction in that a victim must open a malicious file.
    (CVE-2022-28823, CVE-2022-28824)
  ...
  - Adobe Framemaker versions 2029u8 (and earlier) and 2020u4 (and earlier) are affected by an out-of-bounds
    ...
    that a victim must open a malicious file. (CVE-2022-28830)
...
"Upgrade to Adobe FrameMaker 2019 Update 8 (hotfix), 2020 Update 4 (hotfix) or later.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2022-28826");
