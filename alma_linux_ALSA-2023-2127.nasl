...
# AlmaLinux Security Advisory ALSA-2023:2127.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:2127");
  script_xref(name:"IAVA", value:"2023-A-0004-S");

  script_name(english:"AlmaLinux 9 : samba (ALSA-2023:2127)");
...
ALSA-2023:2127 advisory.

  - Netlogon RPC Elevation of Privilege Vulnerability (CVE-2022-38023)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2023-2127.html");
...
var pkgs = [
    {'reference':'ctdb-4.16.4-103.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'samba-winexe-4.16.4-103.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
