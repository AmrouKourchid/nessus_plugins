...
# extracted from Red Hat Security Advisory RHSA-2021:3820. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:3820");
  script_xref(name:"IAVA", value:"2021-A-0335-S");
  script_xref(name:"IAVB", value:"2021-B-0047-S");

  script_name(english:"RHEL 8 : OpenShift Container Platform 4.8.15 (RHSA-2021:3820)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for OpenShift Container Platform 4.8.15.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2021:3820 advisory.

    Red Hat OpenShift Container Platform is Red Hat's cloud computing
    Kubernetes application platform solution designed for on-premise or private
    cloud deployments.

    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.8.15. See the following
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_3820.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dc99e2e0");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:3820");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2007749");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2007750");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2013510");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.8.15 packages based on the guidance in RHSA-2021:3820.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'butane-0.12.1-2.rhaos4.8.el8', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2021-33195', 'CVE-2021-33197', 'CVE-2021-33198', 'CVE-2021-34558']},
      {'reference':'butane-0.12.1-2.rhaos4.8.el8', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2021-33195', 'CVE-2021-33197', 'CVE-2021-33198', 'CVE-2021-34558']},
      {'reference':'butane-0.12.1-2.rhaos4.8.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2021-33195', 'CVE-2021-33197', 'CVE-2021-33198', 'CVE-2021-34558']},
      {'reference':'jenkins-2.289.3.1633554819-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2021-21670', 'CVE-2021-21671']}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'butane / jenkins');
}
