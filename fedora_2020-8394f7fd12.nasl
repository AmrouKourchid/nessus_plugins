...
# extracted from Fedora Security Advisory FEDORA-2020-8394f7fd12.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : mingw-OpenEXR (2020-8394f7fd12)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-8394f7fd12");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"mingw-OpenEXR-2.3.0-4.fc31")) flag++;
