...
if (description)
{
  ...
  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-28870");
...
patch available.
  ...
  - Suricata is a network Intrusion Detection System, Intrusion Prevention System and Network Security
    ...
    records. This issue has been patched in versions 6.0.17 and 7.0.4. (CVE-2024-28870)
