...
# extracted from Oracle Linux Security Advisory ELSA-2025-0692.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : redis:7 (ELSA-2025-0692)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 9 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ELSA-2025-0692 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2025-0692.html");
...
var appstreams = {
    'redis:7': [
      {'reference':'redis-7.2.7-1.module+el9.5.0+90492+80cb7599', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'redis-devel-7.2.7-1.module+el9.5.0+90492+80cb7599', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'redis-doc-7.2.7-1.module+el9.5.0+90492+80cb7599', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'redis-7.2.7-1.module+el9.5.0+90492+80cb7599', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'redis-devel-7.2.7-1.module+el9.5.0+90492+80cb7599', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'redis-doc-7.2.7-1.module+el9.5.0+90492+80cb7599', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
};
