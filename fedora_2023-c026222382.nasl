...
# extracted from Fedora Security Advisory FEDORA-2023-c026222382
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-c026222382");

  script_name(english:"Fedora 37 : xrdp (2023-c026222382)");
...
FEDORA-2023-c026222382 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-c026222382");
...
var pkgs = [
    {'reference':'xrdp-0.9.23.1-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
