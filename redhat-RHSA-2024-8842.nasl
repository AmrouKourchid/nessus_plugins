...
# extracted from Red Hat Security Advisory RHSA-2024:8842. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:8842");

  script_name(english:"RHEL 8 : python3.12-urllib3 (RHSA-2024:8842)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_8842.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b44e14b5");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:8842");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python3.12-urllib3 package based on the guidance in RHSA-2024:8842.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3.12-urllib3-1.26.19-1.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
