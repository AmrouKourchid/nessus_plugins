...
# extracted from Fedora Security Advisory FEDORA-2023-78e350cb88
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-78e350cb88");

  script_name(english:"Fedora 36 : chromium (2023-78e350cb88)");
...
FEDORA-2023-78e350cb88 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-78e350cb88");
...
"Update the affected chromium package.");
  ...
  script_set_attribute(attribute:"patch_publication_date", value:"2023/04/08");
...
var pkgs = [
    {'reference':'chromium-112.0.5615.49-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
