...
vulnerability as referenced in the FG-IR-22-393 advisory.
  ...
  - A relative path traversal vulnerability [CWE-23] in Fortinet FortiOS version 7.2.0 through 7.2.3, version
    ...
    arbitrary directories from the filesystem through crafted HTTP requests. (CVE-2022-42474)
...
"Please upgrade to FortiOS version 6.4.13/7.0.10/7.2.4/7.4.0 or later.");
...
var constraints = [
  { 'min_version' : '6.2', 'max_version' : '6.2', 'fixed_version' : '6.4.13' },
