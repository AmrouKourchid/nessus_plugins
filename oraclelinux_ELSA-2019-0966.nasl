...
# extracted from Oracle Linux Security Advisory ELSA-2019-0966.
##
...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2019-A-0037-S");
  script_xref(name:"IAVA", value:"2019-A-0089-S");

  script_name(english:"Oracle Linux 8 : firefox (ELSA-2019-0966)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2019-0966.html");
...
var pkgs = [
    {'reference':'firefox-60.6.1-1.0.2.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-60.6.1-1.0.2.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
