...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2015-1460.html");
...
"Update the affected wireshark, wireshark-devel and / or wireshark-gnome packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-2191");
...
var pkgs = [
    {'reference':'wireshark-1.8.10-17.0.2.el6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'wireshark-devel-1.8.10-17.0.2.el6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'wireshark-gnome-1.8.10-17.0.2.el6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'wireshark-1.8.10-17.0.2.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'wireshark-devel-1.8.10-17.0.2.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'wireshark-gnome-1.8.10-17.0.2.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
];
