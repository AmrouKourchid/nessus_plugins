...
# extracted from Fedora Security Advisory FEDORA-2023-1536766e9f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-1536766e9f");

  script_name(english:"Fedora 37 : webkitgtk (2023-1536766e9f)");
...
FEDORA-2023-1536766e9f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-1536766e9f");
...
var pkgs = [
    {'reference':'webkitgtk-2.42.1-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
