...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Systemd PHSA-2019-1.0-0220");
...
if (rpm_check(release:"PhotonOS-1.0", reference:"systemd-228-52.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"systemd-debuginfo-228-52.ph1")) flag++;
