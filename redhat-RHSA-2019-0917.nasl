...
# extracted from Red Hat Security Advisory RHSA-2019:0917. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2017-15139");
  script_xref(name:"RHSA", value:"2019:0917");

  script_name(english:"RHEL 7 : openstack-cinder (RHSA-2019:0917)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for openstack-cinder.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2019:0917 advisory.

    OpenStack Block Storage (cinder) manages block storage mounting and the presentation of such mounted block
    storage to instances. The backend physical storage can consist of local disks, or Fibre Channel, iSCSI,
    ...
    * Previously, it was not possible to attach a volume on the host due to an issue with 3PAR driver and
    Fibre Channel World Wide Name.

    With this update, you can attach Fibre Channel volumes even with a wrong host configuration at the
    backend. (BZ#1667997)

    * Previously, only admin users could set the Volume Type in the glance image using cinder_img_vol_type
    custom property.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1476213");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1599899");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1655742");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1671260");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_0917.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d648c22f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:0917");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL openstack-cinder package based on the guidance in RHSA-2019:0917.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:N/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-15139");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:python-cinder-tests");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openstack-cinder-9.1.4-50.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'},
      {'reference':'python-cinder-9.1.4-50.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'},
      {'reference':'python-cinder-tests-9.1.4-50.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'openstack-cinder / python-cinder / python-cinder-tests');
}
