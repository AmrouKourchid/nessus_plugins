...
if (description)
{
  ...
  script_xref(name:"APPLE-SA", value:"HT214120");
  script_xref(name:"IAVA", value:"2024-A-0455-S");
  script_xref(name:"IAVA", value:"2024-A-0578-S");

  script_name(english:"macOS 13.x < 13.6.8 Multiple Vulnerabilities (HT214120)");
...
version number.");
  script_set_attribute(attribute:"see_also", value:"https://support.apple.com/en-us/HT214120");
