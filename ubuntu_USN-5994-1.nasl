...
if (description)
{
  ...
  script_name(english:"Ubuntu 22.04 LTS : HAProxy vulnerability (USN-5994-1)");
...
USN-5994-1 advisory.
    ...
    It was discovered that HAProxy incorrectly initialized certain connection buffers. A remote attacker could
