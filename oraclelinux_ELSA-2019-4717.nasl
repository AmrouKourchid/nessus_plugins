...
# extracted from Oracle Linux Security Advisory ELSA-2019-4717.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : kubeadm-ha-setup (ELSA-2019-4717)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2019-4717.html");
...
var pkgs = [
    {'reference':'kubeadm-ha-setup-0.0.2-1.0.52.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kubeadm-ha-setup');
}
