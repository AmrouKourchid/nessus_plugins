...
# extracted from Red Hat Security Advisory RHSA-2018:2818. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:2818");

  script_name(english:"RHEL 6 : chromium-browser (RHSA-2018:2818)");
...
referenced in the RHSA-2018:2818 advisory.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_2818.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0ccf7cc5");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:2818");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1628078");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1628080");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL chromium-browser package based on the guidance in RHSA-2018:2818.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'chromium-browser-69.0.3497.100-1.el6_10', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'chromium-browser-69.0.3497.100-1.el6_10', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
