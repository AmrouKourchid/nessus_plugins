...
# extracted from Amazon Linux 2 Security Advisory ALASECS-2023-028.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : docker (ALASECS-2023-028)");
...
vulnerabilities as referenced in the ALAS2ECS-2023-028 advisory.

    A file permissions vulnerability was found in Moby (Docker Engine). Copying files by using  into a
    specially-crafted container can result in Unix file permission changes for existing files in the host's
    filesystem, which might lead to permissions escalation and allow an attacker access to restricted data.
    (CVE-2021-41089)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALASECS-2023-028.html");
