...
# extracted from Fedora Security Advisory FEDORA-2024-fb32950d11
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-fb32950d11");

  script_name(english:"Fedora 39 : golang-x-mod (2024-fb32950d11)");
...
FEDORA-2024-fb32950d11 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-fb32950d11");
...
var pkgs = [
    {'reference':'golang-x-mod-0.14.0-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
