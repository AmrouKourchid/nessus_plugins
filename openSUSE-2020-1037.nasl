...
# extracted from openSUSE Security Update openSUSE-2020-1037.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : singularity (openSUSE-2020-1037)");
...
"This update for singularity fixes the following issues :
  ...
  - Removed --name flag for cache clean; replaced with
    --days.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1125369");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1128598");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1159550");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1174148");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1174150");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1174152");
  script_set_attribute(attribute:"see_also", value:"https://github.com/hpcng/singularity/blob/master/CHANGELOG.md");
...
"Update the affected singularity packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-11328");
...
if ( rpm_check(release:"SUSE15.1", reference:"singularity-3.6.0-lp151.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"singularity-debuginfo-3.6.0-lp151.2.6.1") ) flag++;
