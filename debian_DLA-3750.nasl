...
# extracted from Debian Security Advisory dla-3750. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2023-27560", "CVE-2024-27354", "CVE-2024-27355");

  script_name(english:"Debian dla-3750 : php-phpseclib - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bb7f1a05");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-27560");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-27354");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-27355");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/php-phpseclib");
...
"Upgrade the php-phpseclib packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-27560");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:php-phpseclib");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'php-phpseclib', 'reference': '2.0.30-2~deb10u3'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'php-phpseclib');
}
