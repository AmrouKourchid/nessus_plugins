...
# extracted from Debian Security Advisory dsa-5736. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5736 : openjdk-11-dbg - security update");
...
dsa-5736 advisory.
    ...
    - -------------------------------------------------------------------------
    Debian Security Advisory DSA-5736-1                   security@debian.org
    https://www.debian.org/security/                       Moritz Muehlenhoff
    August 05, 2024                       https://www.debian.org/security/faq
    - -------------------------------------------------------------------------

    Package        : openjdk-11
    CVE ID         : CVE-2024-21131 CVE-2024-21138 CVE-2024-21140 CVE-2024-21144
    ...
    in version 11.0.24+8-2~deb11u1.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-21144");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'openjdk-11-dbg', 'reference': '11.0.24+8-2~deb11u1'},
    {'release': '11.0', 'prefix': 'openjdk-11-demo', 'reference': '11.0.24+8-2~deb11u1'},
    {'release': '11.0', 'prefix': 'openjdk-11-doc', 'reference': '11.0.24+8-2~deb11u1'},
    {'release': '11.0', 'prefix': 'openjdk-11-jdk', 'reference': '11.0.24+8-2~deb11u1'},
    {'release': '11.0', 'prefix': 'openjdk-11-jdk-headless', 'reference': '11.0.24+8-2~deb11u1'},
    {'release': '11.0', 'prefix': 'openjdk-11-jre', 'reference': '11.0.24+8-2~deb11u1'},
    {'release': '11.0', 'prefix': 'openjdk-11-jre-headless', 'reference': '11.0.24+8-2~deb11u1'},
    {'release': '11.0', 'prefix': 'openjdk-11-jre-zero', 'reference': '11.0.24+8-2~deb11u1'},
    {'release': '11.0', 'prefix': 'openjdk-11-source', 'reference': '11.0.24+8-2~deb11u1'}
];
