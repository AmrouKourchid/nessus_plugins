...
# extracted from Fedora Security Advisory FEDORA-2018-59e4747e0f.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : kernel / kernel-headers / kernel-tools (2018-59e4747e0f)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-59e4747e0f");
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  cve_list = make_list("CVE-2018-16658");
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for FEDORA-2018-59e4747e0f");
  }
  else
  {
...
flag = 0;
if (rpm_check(release:"FC28", reference:"kernel-4.18.7-200.fc28")) flag++;
if (rpm_check(release:"FC28", reference:"kernel-headers-4.18.7-200.fc28")) flag++;
if (rpm_check(release:"FC28", reference:"kernel-tools-4.18.7-200.fc28")) flag++;
