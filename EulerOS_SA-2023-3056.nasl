...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.1 : libX11 (EulerOS-SA-2023-3056)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3056
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?36435288");
...
var pkgs = [
  "libX11-1.7.2-2.h5.eulerosv2r11"
];
