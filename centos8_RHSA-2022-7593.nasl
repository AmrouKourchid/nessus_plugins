...
# Red Hat Security Advisory RHSA-2022:7593. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:7593");

  script_name(english:"CentOS 8 : python27:2.7 (CESA-2022:7593)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
CESA-2022:7593 advisory.

  - python: mailcap: findmatch() function does not sanitize the second argument (CVE-2015-20107)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:7593");
...
var appstreams = {
    'python27:2.7': [
      ...
      {'reference':'python2-2.7.18-11.module_el8.7.0+1179+42dadd5f', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python2-2.7.18-11.module_el8.7.0+1179+42dadd5f', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python2-debug-2.7.18-11.module_el8.7.0+1179+42dadd5f', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python2-debug-2.7.18-11.module_el8.7.0+1179+42dadd5f', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python2-devel-2.7.18-11.module_el8.7.0+1179+42dadd5f', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python2-devel-2.7.18-11.module_el8.7.0+1179+42dadd5f', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python2-libs-2.7.18-11.module_el8.7.0+1179+42dadd5f', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python2-libs-2.7.18-11.module_el8.7.0+1179+42dadd5f', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python2-test-2.7.18-11.module_el8.7.0+1179+42dadd5f', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python2-test-2.7.18-11.module_el8.7.0+1179+42dadd5f', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python2-tkinter-2.7.18-11.module_el8.7.0+1179+42dadd5f', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python2-tkinter-2.7.18-11.module_el8.7.0+1179+42dadd5f', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python2-tools-2.7.18-11.module_el8.7.0+1179+42dadd5f', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python2-tools-2.7.18-11.module_el8.7.0+1179+42dadd5f', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python2-virtualenv-15.1.0-21.module_el8.5.0+894+1c54b371', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python2-virtualenv-15.1.0-21.module_el8.5.0+894+1c54b371', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
