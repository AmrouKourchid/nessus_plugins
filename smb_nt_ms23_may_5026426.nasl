...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5026413");
  script_xref(name:"MSKB", value:"5026426");
  script_xref(name:"MSFT", value:"MS23-5026413");
  script_xref(name:"MSFT", value:"MS23-5026426");
  ...
  script_name(english:"KB5026426: Windows Server 2008 R2 Security Update (May 2023)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5026413");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5026426");
...
if (("windows server 2008 r2" >< tolower(os_name)) && 
  smb_check_rollup(os:'6.1',
                   ...
                   rollup_date:'05_2023',
                   bulletin:bulletin,
                   rollup_kb_list:[5026426, 5026413])
)
{
