...
# extracted from Oracle Linux Security Advisory ELSA-2023-2784.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : grafana (ELSA-2023-2784)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-2784.html");
...
var pkgs = [
    {'reference':'grafana-7.5.15-4.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'grafana-7.5.15-4.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
