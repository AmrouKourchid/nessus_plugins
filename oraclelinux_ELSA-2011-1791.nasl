...
# Oracle Linux Security Advisory ELSA-2011-1791 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : squid (ELSA-2011-1791)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2011-1791.html");
...
var pkgs = [
    {'reference':'squid-3.1.10-1.el6_2.1', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
    {'reference':'squid-3.1.10-1.el6_2.1', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
];
