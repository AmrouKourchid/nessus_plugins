...
# SUSE update advisory SUSE-SU-2021:3352-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2021:3352-1");

  script_name(english:"SUSE SLES12 Security Update : apache2-mod_auth_openidc (SUSE-SU-2021:3352-1)");
...
referenced in the SUSE-SU-2021:3352-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2021-October/009576.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d4fd20c0");
...
var pkgs = [
    {'reference':'apache2-mod_auth_openidc-2.4.0-3.23.1', 'sp':'5', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5']},
    {'reference':'apache2-mod_auth_openidc-2.4.0-3.23.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.5']}
];
