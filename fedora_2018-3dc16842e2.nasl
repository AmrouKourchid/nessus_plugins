...
# extracted from Fedora Security Advisory FEDORA-2018-3dc16842e2.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : gnupg2 / libgpg-error (2018-3dc16842e2)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-3dc16842e2");
  script_set_attribute(attribute:"solution", value:
"Update the affected gnupg2 and / or libgpg-error packages.");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"gnupg2-2.2.8-1.fc28")) flag++;
if (rpm_check(release:"FC28", reference:"libgpg-error-1.31-1.fc28")) flag++;
