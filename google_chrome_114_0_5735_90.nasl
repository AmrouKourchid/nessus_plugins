...
"The version of Google Chrome installed on the remote Windows host is prior to 114.0.5735.90. It is, therefore, affected
...
google_chrome_check_version(installs:installs, fix:'114.0.5735.90', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
