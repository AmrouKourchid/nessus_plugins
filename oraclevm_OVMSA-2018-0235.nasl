...
# Security Advisory OVMSA-2018-0235.
#
...
if (description)
{
  ...
  script_name(english:"OracleVM 3.3 / 3.4 : glibc (OVMSA-2018-0235)");
...
critical security updates :
  ...
  - CVE-2017-15670: glob: Fix one-byte overflow with
    GLOB_TILDE (#1504810)

  - CVE-2017-15804: glob: Fix buffer overflow in GLOB_TILDE
    unescaping (#1504810)
  ...
  - Fix thread cancellation issues for setmntent and others
    (#1437147).");
  script_set_attribute(attribute:"see_also", value:"https://oss.oracle.com/pipermail/oraclevm-errata/2018-July/000870.html");
  script_set_attribute(attribute:"see_also", value:"https://oss.oracle.com/pipermail/oraclevm-errata/2018-July/000871.html");
...
flag = 0;
if (rpm_check(release:"OVS3.3", reference:"glibc-2.12-1.212.0.1.el6")) flag++;
if (rpm_check(release:"OVS3.3", reference:"glibc-common-2.12-1.212.0.1.el6")) flag++;
if (rpm_check(release:"OVS3.3", reference:"nscd-2.12-1.212.0.1.el6")) flag++;

if (rpm_check(release:"OVS3.4", reference:"glibc-2.12-1.212.0.1.el6")) flag++;
if (rpm_check(release:"OVS3.4", reference:"glibc-common-2.12-1.212.0.1.el6")) flag++;
if (rpm_check(release:"OVS3.4", reference:"glibc-devel-2.12-1.212.0.1.el6")) flag++;
if (rpm_check(release:"OVS3.4", reference:"glibc-headers-2.12-1.212.0.1.el6")) flag++;
if (rpm_check(release:"OVS3.4", reference:"nscd-2.12-1.212.0.1.el6")) flag++;
