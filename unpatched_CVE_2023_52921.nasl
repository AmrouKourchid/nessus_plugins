...
if (description)
{
  ...
  script_cve_id("CVE-2023-52921");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2023-52921");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: drm/amdgpu: fix possible UAF in
    amdgpu_cs_pass1() Since the gang_size check is outside of chunk parsing loop, we need to reset i before we
    free the chunk data. Suggested by Ye Zhang (@VAR10CK) of Baidu Security. (CVE-2023-52921)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-52921");
