...
# AlmaLinux Security Advisory ALSA-2024:0967.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:0967");

  script_name(english:"AlmaLinux 8 : opensc (ALSA-2024:0967)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2024-0967.html");
