...
# extracted from VMware Security Advisory PHSA-2023-3.0-0529. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Vim PHSA-2023-3.0-0529");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the vim package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-3.0-529.md");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'vim-8.2.5169-4.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'vim-extra-8.2.5169-4.ph3')) flag++;
