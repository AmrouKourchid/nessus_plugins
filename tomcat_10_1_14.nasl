...
if (description)
{
  ...
  script_name(english:"Apache Tomcat 10.1.0.M1 < 10.1.14 multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Apache Tomcat server is affected by multiple vulnerabilities");
  script_set_attribute(attribute:"description", value:
"The version of Tomcat installed on the remote host is prior to 10.1.14. It is, therefore, affected by multiple
vulnerabilities as referenced in the fixed_in_apache_tomcat_10.1.14_security-10 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0c3e169d");
  # https://github.com/apache/tomcat/commit/76bb4bfbfeae827dce896f650655bbf6e251ed49
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7607078c");
  # https://github.com/apache/tomcat/commit/9375d67106f8df9eb9d7b360b2bef052fe67d3d4
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7ca98929");
  # https://tomcat.apache.org/security-10.html#Fixed_in_Apache_Tomcat_10.1.14
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a0ff880f");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Apache Tomcat version 10.1.14 or later.");
...
var constraints = [
  { 'min_version' : '10.1.0.M1', 'max_version' : '10.1.13', 'fixed_version' : '10.1.14' }
];
