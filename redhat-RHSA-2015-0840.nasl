...
# extracted from Red Hat Security Advisory RHSA-2015:0840. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2015:0840");

  script_name(english:"RHEL 7 : redhat-access-plugin (RHSA-2015:0840)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for redhat-access-plugin.");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2015/rhsa-2015_0840.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dd65dcf2");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2015:0840");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL redhat-access-plugin package based on the guidance in RHSA-2015:0840.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'redhat-access-plugin-openstack-5.0.1-0.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
