...
# extracted from Oracle Linux Security Advisory ELSA-2022-1964.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : fetchmail (ELSA-2022-1964)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2022-1964.html");
