...
# SUSE update advisory SUSE-SU-2021:2237-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2021:2237-1");

  script_name(english:"SUSE SLES12 Security Update : python-rsa (SUSE-SU-2021:2237-1)");
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2021-July/009114.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7edf8693");
...
var pkgs = [
    {'reference':'python-rsa-3.1.4-12.16.1', 'sp':'0', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-public-cloud-release-12-0']},
    {'reference':'python-rsa-3.1.4-12.16.1', 'sp':'3', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-public-cloud-release-12-0']},
    {'reference':'python-rsa-3.1.4-12.16.1', 'sp':'4', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-public-cloud-release-12-0']},
    {'reference':'python-rsa-3.1.4-12.16.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-public-cloud-release-12-0']}
];
