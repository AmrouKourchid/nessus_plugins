...
# extracted from Red Hat Security Advisory RHSA-2017:0175. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2017:0175");

  script_name(english:"RHEL 7 : java-1.8.0-oracle (RHSA-2017:0175)");
...
referenced in the RHSA-2017:0175 advisory.
    ...
    * This update fixes multiple vulnerabilities in the Oracle Java Runtime Environment and the Oracle Java
    ...
    CVE-2016-5547, CVE-2016-5548, CVE-2016-5549, CVE-2016-5552, CVE-2016-8328, CVE-2017-3231, CVE-2017-3241,
    CVE-2017-3252, CVE-2017-3253, CVE-2017-3259, CVE-2017-3261, CVE-2017-3262, CVE-2017-3272, CVE-2017-3289)
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2017/rhsa-2017_0175.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?54d2dae7");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2017:0175");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1414162");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1414163");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1414164");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL java-1.8.0-oracle package based on the guidance in RHSA-2017:0175.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'java-1.8.0-oracle-1.8.0.121-1jpp.1.el7_3', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_3', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.8.0-oracle-devel-1.8.0.121-1jpp.1.el7_3', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_3', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.8.0-oracle-javafx-1.8.0.121-1jpp.1.el7_3', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_3', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.8.0-oracle-jdbc-1.8.0.121-1jpp.1.el7_3', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_3', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.8.0-oracle-plugin-1.8.0.121-1jpp.1.el7_3', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_3', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.8.0-oracle-src-1.8.0.121-1jpp.1.el7_3', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_3', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
