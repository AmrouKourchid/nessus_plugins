...
if (description)
{
  ...
  script_cve_id("CVE-2021-34479", "CVE-2021-34528");
  script_xref(name:"IAVA", value:"2021-A-0321-S");

  script_name(english:"Security Update for Microsoft Visual Studio Code (July 2021)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host has an application installed that is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of Microsoft Visual Studio Code installed on the remote host is prior to 1.58.1. It is, therefore, affected
by the following vulnerabilities:

  - A remote code execution vulnerability. (CVE-2021-34528)
  
  - A spoofing vulnerability. (CVE-2021-34479)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://code.visualstudio.com/updates/v1_58");
  script_set_attribute(attribute:"see_also", value:"https://github.com/microsoft/vscode/issues/128556");
  script_set_attribute(attribute:"see_also", value:"https://github.com/microsoft/vscode/issues/128557");
  script_set_attribute(attribute:"solution", value:
"Upgrade to  Microsoft Visual Studio Code 1.58.1 or later.");
  script_set_attribute(attribute:"agent", value:"all");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:F/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:N/UI:R/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:F/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-34528");
