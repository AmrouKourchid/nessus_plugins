...
if (description)
{
  ...
  script_cve_id("CVE-2024-45073");
  script_xref(name:"IAVA", value:"2024-A-0605-S");

  script_name(english:"IBM WebSphere Application Server 8.5.x < 8.5.5.27 / 9.x < 9.0.5.22 XSS (7171755)");
...
referenced in the 7171755 advisory.

  - IBM WebSphere Application Server 8.5 and 9.0 is vulnerable to stored cross-site scripting. This
    vulnerability allows a privileged user to embed arbitrary JavaScript code in the Web UI thus altering the
    intended functionality potentially leading to credentials disclosure within a trusted session.
    (CVE-2024-45073)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/node/7171755");
...
fix pack levels required by the interim fix and then apply Interim Fix PH62937.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-45073");
...
if ('PH62937' >< app_info['Fixes'])
  audit(AUDIT_INST_VER_NOT_VULN, app);

var constraints = [
  { 'min_version' : '8.5.0.0', 'fixed_version' : '8.5.5.27', 'fixed_display' : '8.5.5.27 or Interim Fix PH62937' },
  { 'min_version' : '9.0.0.0', 'fixed_version' : '9.0.5.22', 'fixed_display' : '9.0.5.22 or Interim Fix PH62937' }
];
