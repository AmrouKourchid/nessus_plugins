...
# extracted from Red Hat Security Advisory RHSA-2023:5209. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2022-21216", "CVE-2022-33196", "CVE-2023-0286");
  script_xref(name:"RHSA", value:"2023:5209");

  script_name(english:"RHEL 8 : Red Hat Virtualization Host 4.4.z SP 1 (RHSA-2023:5209)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for Red Hat Virtualization Host 4.4.z SP 1.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has a package installed that is affected by multiple vulnerabilities as
referenced in the RHSA-2023:5209 advisory.
    ...
    * kernel: Intel firmware update for insufficient granularity of access control in out-of-band management
    in some Intel Atom and Intel Xeon Scalable Processors (CVE-2022-21216)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_5209.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9b2c2769");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2164440");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2171227");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2171252");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:5209");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat Virtualization Host 4.4.z SP 1 package based on the guidance in RHSA-2023:5209.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'redhat-virtualization-host-image-update-4.5.3-202309130206_8.6', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'}
    ]
  }
];
