...
"The version of Thunderbird installed on the remote Windows host is prior to 128.9. It is, therefore, affected by
...
mozilla_check_version(installs:installs, product:'thunderbird', esr:FALSE, fix:'128.9', severity:SECURITY_WARNING);
