...
# extracted from Fedora Security Advisory FEDORA-2023-327768681a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-327768681a");

  script_name(english:"Fedora 36 : java-11-openjdk (2023-327768681a)");
...
FEDORA-2023-327768681a advisory.

    # New in release [OpenJDK 11.0.18](https://bit.ly/openjdk11018) (2023-01-17)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-327768681a");
...
var pkgs = [
    {'reference':'java-11-openjdk-11.0.18.0.10-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
