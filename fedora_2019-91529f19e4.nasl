...
# extracted from Fedora Security Advisory FEDORA-2019-91529f19e4.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-91529f19e4");

  script_name(english:"Fedora 31 : libssh2 (2019-91529f19e4)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"- fix integer overflow in SSH_MSG_DISCONNECT logic
    (CVE-2019-17498)
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-91529f19e4");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"libssh2-1.9.0-3.fc31")) flag++;
