...
# extracted from Fedora Security Advisory FEDORA-2023-1e24db98a6
#
...
if (description)
{
  ...
  script_cve_id("CVE-2022-3109", "CVE-2022-48434");
  script_xref(name:"FEDORA", value:"2023-1e24db98a6");

  script_name(english:"Fedora 36 : ffmpeg (2023-1e24db98a6)");
...
FEDORA-2023-1e24db98a6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-1e24db98a6");
...
var pkgs = [
    {'reference':'ffmpeg-5.0.3-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
