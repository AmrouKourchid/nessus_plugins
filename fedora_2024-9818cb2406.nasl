...
# extracted from Fedora Security Advisory FEDORA-2024-9818cb2406
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-9818cb2406");

  script_name(english:"Fedora 39 : pgadmin4 (2024-9818cb2406)");
...
FEDORA-2024-9818cb2406 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-9818cb2406");
...
var pkgs = [
    {'reference':'pgadmin4-7.8-3.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
