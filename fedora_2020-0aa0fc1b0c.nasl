...
# extracted from Fedora Security Advisory FEDORA-2020-0aa0fc1b0c.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : libexif (2020-0aa0fc1b0c)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-0aa0fc1b0c");
...
flag = 0;
if (rpm_check(release:"FC32", reference:"libexif-0.6.22-2.fc32")) flag++;
