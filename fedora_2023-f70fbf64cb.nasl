...
# extracted from Fedora Security Advisory FEDORA-2023-f70fbf64cb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-f70fbf64cb");

  script_name(english:"Fedora 38 : wireshark (2023-f70fbf64cb)");
...
FEDORA-2023-f70fbf64cb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-f70fbf64cb");
...
var pkgs = [
    {'reference':'wireshark-4.0.5-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
