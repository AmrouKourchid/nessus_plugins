...
# extracted from Fedora Security Advisory FEDORA-2024-c2e7b82022
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-c2e7b82022");

  script_name(english:"Fedora 39 : libvirt (2024-c2e7b82022)");
...
FEDORA-2024-c2e7b82022 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-c2e7b82022");
...
var pkgs = [
    {'reference':'libvirt-9.7.0-4.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
