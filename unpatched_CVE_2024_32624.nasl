...
if (description)
{
  ...
  script_cve_id("CVE-2024-32624");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-32624");
...
patch available.
  ...
  - HDF5 Library through 1.14.3 contains a heap-based buffer overflow in H5T__ref_mem_setnull in H5Tref.c
    (called from H5T__conv_ref in H5Tconv.c), resulting in the corruption of the instruction pointer.
    (CVE-2024-32624)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-32624");
