...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.2 : kernel (EulerOS-SA-2023-1262)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1262
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d9d23623");
...
var pkgs = [
  "kernel-3.10.0-862.14.1.6_78",
  "kernel-devel-3.10.0-862.14.1.6_78",
  "kernel-headers-3.10.0-862.14.1.6_78",
  "kernel-tools-3.10.0-862.14.1.6_78",
  "kernel-tools-libs-3.10.0-862.14.1.6_78",
  "kernel-tools-libs-devel-3.10.0-862.14.1.6_78"
];
