...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 6.06 : apr-util Vulnerability (NS-SA-2023-0131) (deprecated)");
...
"This plugin has been deprecated.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:apr-util-bdb");
