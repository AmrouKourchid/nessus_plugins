...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : libssh2 on SL7.x x86_64 (20190328)");
...
"Security Fix(es) :
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1903&L=SCIENTIFIC-LINUX-ERRATA&P=14869
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?704318ec");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"libssh2-1.4.3-12.el7_6.2")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"libssh2-debuginfo-1.4.3-12.el7_6.2")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"libssh2-devel-1.4.3-12.el7_6.2")) flag++;
if (rpm_check(release:"SL7", reference:"libssh2-docs-1.4.3-12.el7_6.2")) flag++;
