...
# extracted from Fedora Security Advisory FEDORA-2025-e9be11b9ba
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-e9be11b9ba");

  script_name(english:"Fedora 41 : ntpd-rs (2025-e9be11b9ba)");
...
FEDORA-2025-e9be11b9ba advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-e9be11b9ba");
...
var pkgs = [
    {'reference':'ntpd-rs-1.5.0-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
