...
# extracted from Fedora Security Advisory FEDORA-2023-27b41bb133
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-27b41bb133");

  script_name(english:"Fedora 38 : python-configobj (2023-27b41bb133)");
...
FEDORA-2023-27b41bb133 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-27b41bb133");
...
var pkgs = [
    {'reference':'python-configobj-5.0.8-6.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
