...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ff78b040");
...
"Update the RHEL ruby package based on the guidance in RHSA-2020:0591.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ruby-2.0.0.648-35.el7_4', 'sp':'4', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ruby-2.0.0.648-35.el7_4', 'sp':'4', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ruby-devel-2.0.0.648-35.el7_4', 'sp':'4', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'ruby-libs-2.0.0.648-35.el7_4', 'sp':'4', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ruby-libs-2.0.0.648-35.el7_4', 'sp':'4', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ruby-tcltk-2.0.0.648-35.el7_4', 'sp':'4', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ruby-tcltk-2.0.0.648-35.el7_4', 'sp':'4', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rubygem-bigdecimal-1.2.0-35.el7_4', 'sp':'4', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rubygem-bigdecimal-1.2.0-35.el7_4', 'sp':'4', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rubygem-io-console-0.4.2-35.el7_4', 'sp':'4', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rubygem-io-console-0.4.2-35.el7_4', 'sp':'4', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rubygem-json-1.7.7-35.el7_4', 'sp':'4', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'rubygem-psych-2.0.0-35.el7_4', 'sp':'4', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
