...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_0406.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?69cdf4f3");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:0406");
...
"Update the RHEL php package based on the guidance in RHSA-2018:0406.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'php-5.4.16-43.el7_4.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'php-bcmath-5.4.16-43.el7_4.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'php-cli-5.4.16-43.el7_4.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'php-common-5.4.16-43.el7_4.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'php-dba-5.4.16-43.el7_4.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'php-devel-5.4.16-43.el7_4.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'php-embedded-5.4.16-43.el7_4.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'php-enchant-5.4.16-43.el7_4.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'php-fpm-5.4.16-43.el7_4.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'php-gd-5.4.16-43.el7_4.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'php-intl-5.4.16-43.el7_4.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'php-ldap-5.4.16-43.el7_4.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'php-mbstring-5.4.16-43.el7_4.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'php-mysql-5.4.16-43.el7_4.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'php-mysqlnd-5.4.16-43.el7_4.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'php-odbc-5.4.16-43.el7_4.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'php-pdo-5.4.16-43.el7_4.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'php-pgsql-5.4.16-43.el7_4.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'php-process-5.4.16-43.el7_4.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'php-pspell-5.4.16-43.el7_4.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'php-recode-5.4.16-43.el7_4.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'php-snmp-5.4.16-43.el7_4.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'php-soap-5.4.16-43.el7_4.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'php-xml-5.4.16-43.el7_4.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'php-xmlrpc-5.4.16-43.el7_4.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
