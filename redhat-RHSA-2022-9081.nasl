...
# extracted from Red Hat Security Advisory RHSA-2022:9081. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:9081");
  ...
  script_name(english:"RHEL 9 : thunderbird (RHSA-2022:9081)");
...
referenced in the RHSA-2022:9081 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_9081.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0096c727");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:9081");
...
"Update the RHEL thunderbird package based on the guidance in RHSA-2022:9081.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'thunderbird-102.6.0-2.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
