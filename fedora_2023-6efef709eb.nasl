...
# extracted from Fedora Security Advisory FEDORA-2023-6efef709eb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-6efef709eb");

  script_name(english:"Fedora 37 : community-mysql (2023-6efef709eb)");
...
FEDORA-2023-6efef709eb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-6efef709eb");
...
var pkgs = [
    {'reference':'community-mysql-8.0.35-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
