...
# extracted from SUSE update advisory SUSE-SU-2018:1548-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : kernel (SUSE-SU-2018:1548-1)");
...
without introducing additional issues.");
  ...
  # https://www.suse.com/support/update/announcement/2018/suse-su-20181548-1/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dc052c44");
...
SUSE-SLE-SAP-12-SP2-2018-1061=1

SUSE Linux Enterprise Server 12-SP2-LTSS:zypper in -t patch
SUSE-SLE-SERVER-12-SP2-2018-1061=1");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"kgraft-patch-4_4_90-92_45-default-7-2.1")) flag++;
