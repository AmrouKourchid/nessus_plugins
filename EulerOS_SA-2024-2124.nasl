...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.0 : nghttp2 (EulerOS-SA-2024-2124)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2124
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8fd1bf7a");
...
var pkgs = [
  "libnghttp2-1.41.0-1.h4.eulerosv2r10"
];
