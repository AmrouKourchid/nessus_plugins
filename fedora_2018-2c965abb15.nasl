...
# extracted from Fedora Security Advisory FEDORA-2018-2c965abb15.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : 2:dpdk (2018-2c965abb15)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-2c965abb15");
  script_set_attribute(attribute:"solution", value:
"Update the affected 2:dpdk package.");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"dpdk-17.11.2-1.fc28", epoch:"2")) flag++;
