...
# AlmaLinux Security Advisory ALSA-2024:4779.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:4779");

  script_name(english:"AlmaLinux 9 : python3 (ALSA-2024:4779)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2024-4779.html");
...
var pkgs = [
    {'reference':'python-unversioned-command-3.9.18-3.el9_4.3', 'release':'9', 'el_string':'el9_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'python3-3.9.18-3.el9_4.3', 'release':'9', 'el_string':'el9_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'python3-debug-3.9.18-3.el9_4.3', 'release':'9', 'el_string':'el9_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'python3-devel-3.9.18-3.el9_4.3', 'release':'9', 'el_string':'el9_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'python3-idle-3.9.18-3.el9_4.3', 'release':'9', 'el_string':'el9_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'python3-libs-3.9.18-3.el9_4.3', 'release':'9', 'el_string':'el9_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'python3-test-3.9.18-3.el9_4.3', 'release':'9', 'el_string':'el9_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'python3-tkinter-3.9.18-3.el9_4.3', 'release':'9', 'el_string':'el9_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'}
];
