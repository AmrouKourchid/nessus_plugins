...
# extracted from Mozilla Foundation Security Advisory mfsa2020-21.
...
if (description)
{
  ...
  script_cve_id("CVE-2020-12399", "CVE-2020-12405");
  script_xref(name:"MFSA", value:"2020-21");
  script_xref(name:"IAVA", value:"2020-A-0238-S");

  script_name(english:"Mozilla Firefox ESR < 68.9");

  script_set_attribute(attribute:"synopsis", value:
"A web browser installed on the remote macOS or Mac OS X host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Firefox ESR installed on the remote macOS or Mac OS X host is prior to 68.9. It is, therefore, affected
by multiple vulnerabilities as referenced in the mfsa2020-21 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2020-21/");
...
"Upgrade to Mozilla Firefox ESR version 68.9 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-12399");
...
mozilla_check_version(version:version, path:path, product:'firefox', esr:TRUE, fix:'68.9', min:'68.0.0', severity:SECURITY_NOTE);
