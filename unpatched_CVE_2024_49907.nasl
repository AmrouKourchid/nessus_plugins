...
if (description)
{
  ...
  script_cve_id("CVE-2024-49907");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-49907");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: drm/amd/display: Check null pointers
    before using dc->clk_mgr [WHY & HOW] dc->clk_mgr is null checked previously in the same function,
    indicating it might be null. Passing dc to dc->hwss.apply_idle_power_optimizations, which dereferences
    null dc->clk_mgr. (The function pointer resolves to dcn35_apply_idle_power_optimizations.) This fixes
    1 FORWARD_NULL issue reported by Coverity. (CVE-2024-49907)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-49907");
