...
# extracted from Red Hat Security Advisory RHSA-2023:3426. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:3426");

  script_name(english:"RHEL 8 : cups-filters (RHSA-2023:3426)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for cups-filters.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2023:3426 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_3426.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a2f7e6e0");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2203051");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:3426");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL cups-filters package based on the guidance in RHSA-2023:3426.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cups-filters-1.20.0-27.el8_6.1', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'cups-filters-devel-1.20.0-27.el8_6.1', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'cups-filters-libs-1.20.0-27.el8_6.1', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
