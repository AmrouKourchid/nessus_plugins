...
# extracted from Fedora Security Advisory FEDORA-2022-462f39dd2f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-462f39dd2f");
  script_xref(name:"IAVA", value:"2023-A-0061-S");

  script_name(english:"Fedora 36 : python3.10 (2022-462f39dd2f)");
...
FEDORA-2022-462f39dd2f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-462f39dd2f");
...
var pkgs = [
    {'reference':'python3.10-3.10.8-3.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
