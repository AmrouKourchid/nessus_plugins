...
# extracted from Debian Security Advisory dla-3838. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3838 : composer - security update");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'composer', 'reference': '1.8.4-1+deb10u4'}
];
