...
# extracted from Fedora Security Advisory FEDORA-2023-d6b219d19a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-d6b219d19a");

  script_name(english:"Fedora 36 : ceph (2023-d6b219d19a)");
...
FEDORA-2023-d6b219d19a advisory.

    ceph 16.2.12 GA
    Security fix for CVE-2022-3650

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-d6b219d19a");
...
var pkgs = [
    {'reference':'ceph-16.2.12-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
