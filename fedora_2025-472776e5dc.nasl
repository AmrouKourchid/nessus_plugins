...
# extracted from Fedora Security Advisory FEDORA-2025-472776e5dc
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-472776e5dc");

  script_name(english:"Fedora 40 : rust-openssl / rust-openssl-sys (2025-472776e5dc)");
...
FEDORA-2025-472776e5dc advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-472776e5dc");
...
var pkgs = [
    {'reference':'rust-openssl-0.10.72-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-openssl-sys-0.9.107-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
