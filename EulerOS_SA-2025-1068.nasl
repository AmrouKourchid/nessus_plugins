...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : xorg-x11-server (EulerOS-SA-2025-1068)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1068
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a91728ee");
...
var pkgs = [
  "xorg-x11-server-help-1.20.6-5.h16.eulerosv2r9"
];
