...
# extracted from Fedora Security Advisory FEDORA-2023-88f7d670fe
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-88f7d670fe");

  script_name(english:"Fedora 37 : giflib (2023-88f7d670fe)");
...
FEDORA-2023-88f7d670fe advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-88f7d670fe");
...
var pkgs = [
    {'reference':'giflib-5.2.1-17.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
