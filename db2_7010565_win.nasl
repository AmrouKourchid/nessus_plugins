...
if (description)
{
  ...
  script_name(english:"IBM DB2 Buffer Overflow (7010565) (Windows)");
...
var constraints = [
  {'equal':'10.5.1100.2866', 'fixed_build':'41328', 'fixed_display':'Special Build 41328 for DB2 10.5 Fix Pack 11'},
  ...
  {'min_version':'10.5', 'fixed_version':'10.5.1100.2866', 'fixed_display':'Special Build 41328 for DB2 10.5 Fix Pack 11'},
  ...
  {'min_version':'11.5', 'fixed_version':'11.5.8000.317',  'fixed_display':'Special Build 31203 for DB2 11.5.8 Fix Pack 0'}
];
