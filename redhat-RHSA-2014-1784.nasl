...
# extracted from Red Hat Security Advisory RHSA-2014:1784. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2014-7144");
  script_xref(name:"RHSA", value:"2014:1784");

  script_name(english:"RHEL 7 : python-keystoneclient (RHSA-2014:1784)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for python-keystoneclient.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2014:1784 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://wiki.openstack.org/wiki/OSSN/OSSN-0024");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1106328");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1133431");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1143808");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2014/rhsa-2014_1784.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a1758172");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2014:1784");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-keystoneclient package based on the guidance in RHSA-2014:1784.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:N/I:P/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:R/S:U/C:N/I:L/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-7144");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python-keystoneclient-0.9.0-5.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'},
      {'reference':'python-keystoneclient-doc-0.9.0-5.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python-keystoneclient / python-keystoneclient-doc');
}
