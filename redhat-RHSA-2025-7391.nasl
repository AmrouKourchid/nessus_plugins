...
# extracted from Red Hat Security Advisory RHSA-2025:7391. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:7391");

  script_name(english:"RHEL 9 : podman (RHSA-2025:7391)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for podman.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2025:7391 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-79694");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-80259");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-82509");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-85116");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-85218");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-86092");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_7391.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7ada26ba");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:7391");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL podman package based on the guidance in RHSA-2025:7391.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2025-22869");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'podman-5.4.0-9.el9_6', 'sp':'6', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'5'},
      {'reference':'podman-docker-5.4.0-9.el9_6', 'sp':'6', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'5'},
      {'reference':'podman-plugins-5.4.0-9.el9_6', 'sp':'6', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'5'},
      {'reference':'podman-remote-5.4.0-9.el9_6', 'sp':'6', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'5'},
      {'reference':'podman-tests-5.4.0-9.el9_6', 'sp':'6', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'5'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'podman-5.4.0-9.el9_6', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'5'},
      {'reference':'podman-docker-5.4.0-9.el9_6', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'5'},
      {'reference':'podman-plugins-5.4.0-9.el9_6', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'5'},
      {'reference':'podman-remote-5.4.0-9.el9_6', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'5'},
      {'reference':'podman-tests-5.4.0-9.el9_6', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'5'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'podman / podman-docker / podman-plugins / podman-remote / etc');
}
