...
# extracted from Fedora Security Advisory FEDORA-2024-c8dda5112a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-c8dda5112a");

  script_name(english:"Fedora 40 : squid (2024-c8dda5112a)");
...
FEDORA-2024-c8dda5112a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-c8dda5112a");
...
var pkgs = [
    {'reference':'squid-6.12-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
];
