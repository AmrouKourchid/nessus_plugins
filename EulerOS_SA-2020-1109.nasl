...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : jakarta-commons-httpclient (EulerOS-SA-2020-1109)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1109
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dadf5096");
...
pkgs = ["jakarta-commons-httpclient-3.1-16.h1.eulerosv2r7"];
