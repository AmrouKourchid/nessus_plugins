...
# extracted from Red Hat Security Advisory RHSA-2020:5233. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_5233.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a8681ef1");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:5233");
...
"Update the RHEL firefox package based on the guidance in RHSA-2020:5233.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-78.5.0-1.el8_1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
