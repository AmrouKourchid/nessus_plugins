...
"The version of Google Chrome installed on the remote macOS host is prior to 124.0.6367.201. It is, therefore, affected
...
google_chrome_check_version(fix:'124.0.6367.201', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
