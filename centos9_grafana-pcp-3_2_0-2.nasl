...
if (description)
{
  ...
  script_name(english:"CentOS 9 : grafana-pcp-3.2.0-2.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing one or more security updates for grafana-pcp.");
...
grafana-pcp-3.2.0-2.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=24247");
...
var pkgs = [
    {'reference':'grafana-pcp-3.2.0-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
