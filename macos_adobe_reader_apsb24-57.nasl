...
if (description)
{
  ...
  script_name(english:"Adobe Reader < 20.005.30655 / 24.002.21005 Multiple Vulnerabilities (APSB24-57) (macOS)");

  script_set_attribute(attribute:"synopsis", value:
"The version of Adobe Reader installed on the remote macOS host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Reader installed on the remote macOS host is a version prior to 20.005.30655 or 24.002.21005. It
...
var constraints = [
  { 'min_version' : '20.1', 'max_version' : '20.005.30635', 'fixed_version' : '20.005.30655', 'track' : 'DC Classic' },
  { 'min_version' : '15.7', 'max_version' : '24.002.20964', 'fixed_version' : '24.002.21005', 'track' : 'DC Continuous' }
];
