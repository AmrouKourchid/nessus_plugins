...
# extracted from Fedora Security Advisory FEDORA-2024-4691d60717
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-4691d60717");

  script_name(english:"Fedora 38 : yyjson (2024-4691d60717)");
...
FEDORA-2024-4691d60717 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-4691d60717");
...
var pkgs = [
    {'reference':'yyjson-0.9.0-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
