...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Rpcbind PHSA-2017-0017");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the rpcbind package has been released.");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'rpcbind-0.2.3-8.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'rpcbind-debuginfo-0.2.3-8.ph1')) flag++;
