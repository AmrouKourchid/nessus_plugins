...
# extracted from openSUSE Security Update openSUSE-2021-473.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : hawk2 (openSUSE-2021-473)");
...
"This update for hawk2 fixes the following issues :
  ...
  - Sanitize filename to contains whitelist of alphanumeric
    (bsc#1182165)

This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1179999");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1182165");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1182166");
...
"Update the affected hawk2 packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-25314");
...
if ( rpm_check(release:"SUSE15.2", reference:"hawk2-2.6.3+git.1614684118.af555ad9-lp152.2.18.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"hawk2-debuginfo-2.6.3+git.1614684118.af555ad9-lp152.2.18.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"hawk2-debugsource-2.6.3+git.1614684118.af555ad9-lp152.2.18.1") ) flag++;
