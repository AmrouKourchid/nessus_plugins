...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : net-snmp (EulerOS-SA-2020-2056)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2056
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f2c552cd");
...
pkgs = ["net-snmp-5.7.2-24.1.h4",
        "net-snmp-agent-libs-5.7.2-24.1.h4",
        "net-snmp-devel-5.7.2-24.1.h4",
        "net-snmp-libs-5.7.2-24.1.h4",
        "net-snmp-utils-5.7.2-24.1.h4"];
