...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.0 : httpd (EulerOS-SA-2024-2119)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2119
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?93d24682");
...
var pkgs = [
  "httpd-2.4.43-4.h26.eulerosv2r10",
  "httpd-filesystem-2.4.43-4.h26.eulerosv2r10",
  "httpd-tools-2.4.43-4.h26.eulerosv2r10",
  "mod_ssl-2.4.43-4.h26.eulerosv2r10"
];
