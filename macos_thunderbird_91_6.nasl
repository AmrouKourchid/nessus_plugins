...
"The version of Thunderbird installed on the remote macOS or Mac OS X host is prior to 91.6. It is, therefore, affected
by multiple vulnerabilities as referenced in the mfsa2022-06 advisory.
...
mozilla_check_version(version:version, path:path, product:'thunderbird', esr:FALSE, fix:'91.6', severity:SECURITY_HOLE);
