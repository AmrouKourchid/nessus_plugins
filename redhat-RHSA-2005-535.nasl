...
if (description)
{
  ...
  script_name(english:"RHEL 4 : sudo (RHSA-2005:535)");
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2005/rhsa-2005_535.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?12dcbe6c");
  script_set_attribute(attribute:"see_also", value:"http://www.securityfocus.com/archive/1/402741/30/0/threaded");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=161116");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2005:535");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL sudo package based on the guidance in RHSA-2005:535.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:H/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:H/PR:L/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2005-1993");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'sudo-1.6.7p5-30.1.1', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sudo-1.6.7p5-30.1.1', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sudo-1.6.7p5-30.1.1', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sudo-1.6.7p5-30.1.1', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sudo-1.6.7p5-30.1.1', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
