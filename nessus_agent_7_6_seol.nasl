...
if (description)
{
  ...
  script_name(english:"Tenable Nessus Agent SEoL (7.6.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Tenable Nessus Agent is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Tenable Nessus Agent is 7.6.x. It is, therefore, no longer maintained by its vendor or
provider.
...
var constraints = [
  { max_branch : '7.6', min_branch : '7.6', seol : 20210930, eseol : 20220331 }
];
