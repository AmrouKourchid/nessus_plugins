...
# extracted from Amazon Linux 2 Security Advisory ALASNITRO-ENCLAVES-2024-040.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : amazon-ecr-credential-helper (ALASNITRO-ENCLAVES-2024-040)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of amazon-ecr-credential-helper installed on the remote host is prior to 0.7.1-4. It is, therefore, affected
by a vulnerability as referenced in the ALAS2NITRO-ENCLAVES-2024-040 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALASNITRO-ENCLAVES-2024-040.html");
...
var pkgs = [
    {'reference':'amazon-ecr-credential-helper-0.7.1-4.amzn2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'amazon-ecr-credential-helper-0.7.1-4.amzn2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'amazon-ecr-credential-helper-debuginfo-0.7.1-4.amzn2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'amazon-ecr-credential-helper-debuginfo-0.7.1-4.amzn2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
