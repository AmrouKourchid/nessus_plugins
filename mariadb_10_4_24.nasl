...
if (description)
{
  ...
  script_name(english:"MariaDB 10.4.0 < 10.4.24 Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote database server is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of MariaDB installed on the remote host is prior to 10.4.24. It is, therefore, affected by multiple
vulnerabilities as referenced in the mdb-10424-rn advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://mariadb.com/kb/en/mariadb-10-4-24-release-notes");
  script_set_attribute(attribute:"solution", value:
"Upgrade to MariaDB version 10.4.24 or later.");
...
var constraints = [
  { 'min_version' : '10.4', 'fixed_version' : '10.4.24' }
];
