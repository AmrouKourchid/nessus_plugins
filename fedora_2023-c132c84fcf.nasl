...
# extracted from Fedora Security Advisory FEDORA-2023-c132c84fcf
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-c132c84fcf");

  script_name(english:"Fedora 38 : dotnet7.0 (2023-c132c84fcf)");
...
FEDORA-2023-c132c84fcf advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-c132c84fcf");
...
var pkgs = [
    {'reference':'dotnet7.0-7.0.112-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
