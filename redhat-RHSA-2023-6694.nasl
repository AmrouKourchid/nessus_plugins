...
# extracted from Red Hat Security Advisory RHSA-2023:6694. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:6694");

  script_name(english:"RHEL 9 : python-pip (RHSA-2023:6694)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6694.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e96a4a1d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2207997");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=263261");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6694");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-pip package based on the guidance in RHSA-2023:6694.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-pip-21.2.3-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-pip-wheel-21.2.3-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
