...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : scipy (EulerOS-SA-2023-3511)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the scipy package installed, the EulerOS Virtualization installation on the remote host is
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3511
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e0db987b");
  script_set_attribute(attribute:"solution", value:
"Update the affected scipy packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:python3-scipy");
...
var pkgs = [
  "python3-scipy-1.2.2-3.h11.eulerosv2r10"
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "scipy");
}
