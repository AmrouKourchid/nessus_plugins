...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Mysql PHSA-2023-4.0-0518");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'mysql-8.0.35-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'mysql-devel-8.0.35-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'mysql-icu-data-files-8.0.35-1.ph4')) flag++;
