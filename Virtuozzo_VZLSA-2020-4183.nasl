...
if (description)
{
  ...
  script_name(english:"Virtuozzo 6 : bind / bind-chroot / bind-devel / bind-libs / etc (VZLSA-2020-4183)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Virtuozzo host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 6 host has packages installed that are affected by a vulnerability as referenced in the RHSA-2020:4183 advisory.
...
it as much as possible without introducing additional issues.");
  # http://repo.virtuozzo.com/vzlinux/announcements/json/VZLSA-2020-4183.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?44e0e8bf");
...
pkgs = ["bind-9.8.2-0.68.rc1.vl6.8",
        "bind-chroot-9.8.2-0.68.rc1.vl6.8",
        "bind-devel-9.8.2-0.68.rc1.vl6.8",
        "bind-libs-9.8.2-0.68.rc1.vl6.8",
        "bind-sdb-9.8.2-0.68.rc1.vl6.8",
        "bind-utils-9.8.2-0.68.rc1.vl6.8"];
