...
# extracted from Fedora Security Advisory FEDORA-2024-1f3759becc
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-1f3759becc");
  script_xref(name:"IAVA", value:"2024-A-0536-S");

  script_name(english:"Fedora 40 : vim (2024-1f3759becc)");
...
FEDORA-2024-1f3759becc advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-1f3759becc");
...
var pkgs = [
    {'reference':'vim-9.1.719-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
