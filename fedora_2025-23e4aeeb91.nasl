...
# extracted from Fedora Security Advisory FEDORA-2025-23e4aeeb91
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-23e4aeeb91");

  script_name(english:"Fedora 41 : libxmp (2025-23e4aeeb91)");
...
FEDORA-2025-23e4aeeb91 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-23e4aeeb91");
...
var pkgs = [
    {'reference':'libxmp-4.6.1-2.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
