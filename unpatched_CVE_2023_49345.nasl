...
if (description)
{
  ...
  script_cve_id("CVE-2023-49345");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2023-49345");
...
patch available.
  ...
  - Temporary data passed between application components by Budgie Extras Takeabreak applet could potentially
    ...
    or deny access to the application and panel. (CVE-2023-49345)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-49345");
