...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS / 22.04 LTS / 23.04 : CUPS vulnerability (USN-6184-1)");
...
referenced in the USN-6184-1 advisory.

    It was discovered that CUPS incorrectly handled certain memory operations. An attacker could possibly use
    this issue to cause CUPS to crash, resulting in a denial of service, or possibly obtain sensitive
    information.
