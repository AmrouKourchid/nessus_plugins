...
# extracted from Red Hat Security Advisory RHSA-2024:6357. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:6357");

  script_name(english:"RHEL 9 : bubblewrap and flatpak (RHSA-2024:6357)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_6357.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?84a061f6");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:6357");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL bubblewrap / flatpak packages based on the guidance in RHSA-2024:6357.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'flatpak-1.12.5-5.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'flatpak-libs-1.12.5-5.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'flatpak-selinux-1.12.5-5.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'flatpak-session-helper-1.12.5-5.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'bubblewrap-0.4.1-7.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
