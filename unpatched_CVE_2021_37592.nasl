...
if (description)
{
  ...
  script_cve_id("CVE-2021-37592");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2021-37592");
...
patch available.
  ...
  - Suricata before 5.0.8 and 6.x before 6.0.4 allows TCP evasion via a client with a crafted TCP/IP stack
    that can send a certain sequence of segments. (CVE-2021-37592)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-37592");
