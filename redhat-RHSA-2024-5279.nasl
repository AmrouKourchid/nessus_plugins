...
# extracted from Red Hat Security Advisory RHSA-2024:5279. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:5279");

  script_name(english:"RHEL 9 : python3.11-setuptools (RHSA-2024:5279)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for python3.11-setuptools.");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_5279.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?960c9200");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:5279");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python3.11-setuptools package based on the guidance in RHSA-2024:5279.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:python3.11-setuptools");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:python3.11-setuptools-wheel");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3.11-setuptools-65.5.1-2.el9_4.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.11-setuptools-wheel-65.5.1-2.el9_4.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'python3.11-setuptools-65.5.1-2.el9_4.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.11-setuptools-wheel-65.5.1-2.el9_4.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
