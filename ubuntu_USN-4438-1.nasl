...
# extracted from Ubuntu Security Notice USN-4438-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS : SQLite vulnerability (USN-4438-1)");
...
USN-4438-1 advisory.
    ...
    It was discovered that SQLite incorrectly handled query-flattener optimization. An attacker could use this
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4438-1");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'lemon', 'pkgver': '3.31.1-4ubuntu0.2'},
    {'osver': '20.04', 'pkgname': 'libsqlite3-0', 'pkgver': '3.31.1-4ubuntu0.2'},
    {'osver': '20.04', 'pkgname': 'libsqlite3-dev', 'pkgver': '3.31.1-4ubuntu0.2'},
    {'osver': '20.04', 'pkgname': 'libsqlite3-tcl', 'pkgver': '3.31.1-4ubuntu0.2'},
    {'osver': '20.04', 'pkgname': 'sqlite3', 'pkgver': '3.31.1-4ubuntu0.2'}
];
