...
# extracted from Gentoo Linux Security Advisory GLSA 202007-50.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202007-50");

  script_name(english:"GLSA-202007-50 : GLib Networking: Improper certificate validation");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202007-50
(GLib Networking: Improper certificate validation)

    GTlsClientConnection skips hostname verification of the server&rsquo;s TLS
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202007-50");
...
"All GLib Networking users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:glib-networking");
...
if (qpkg_check(package:"net-libs/glib-networking", unaffected:make_list("ge 2.62.4"), vulnerable:make_list("lt 2.62.4"))) flag++;
