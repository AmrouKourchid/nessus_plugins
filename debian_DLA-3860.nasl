...
# extracted from Debian Security Advisory dla-3860. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3860 : dovecot-auth-lua - security update");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'dovecot-auth-lua', 'reference': '1:2.3.13+dfsg1-2+deb11u2'},
    {'release': '11.0', 'prefix': 'dovecot-core', 'reference': '1:2.3.13+dfsg1-2+deb11u2'},
    {'release': '11.0', 'prefix': 'dovecot-dev', 'reference': '1:2.3.13+dfsg1-2+deb11u2'},
    {'release': '11.0', 'prefix': 'dovecot-gssapi', 'reference': '1:2.3.13+dfsg1-2+deb11u2'},
    {'release': '11.0', 'prefix': 'dovecot-imapd', 'reference': '1:2.3.13+dfsg1-2+deb11u2'},
    {'release': '11.0', 'prefix': 'dovecot-ldap', 'reference': '1:2.3.13+dfsg1-2+deb11u2'},
    {'release': '11.0', 'prefix': 'dovecot-lmtpd', 'reference': '1:2.3.13+dfsg1-2+deb11u2'},
    {'release': '11.0', 'prefix': 'dovecot-lucene', 'reference': '1:2.3.13+dfsg1-2+deb11u2'},
    {'release': '11.0', 'prefix': 'dovecot-managesieved', 'reference': '1:2.3.13+dfsg1-2+deb11u2'},
    {'release': '11.0', 'prefix': 'dovecot-mysql', 'reference': '1:2.3.13+dfsg1-2+deb11u2'},
    {'release': '11.0', 'prefix': 'dovecot-pgsql', 'reference': '1:2.3.13+dfsg1-2+deb11u2'},
    {'release': '11.0', 'prefix': 'dovecot-pop3d', 'reference': '1:2.3.13+dfsg1-2+deb11u2'},
    {'release': '11.0', 'prefix': 'dovecot-sieve', 'reference': '1:2.3.13+dfsg1-2+deb11u2'},
    {'release': '11.0', 'prefix': 'dovecot-solr', 'reference': '1:2.3.13+dfsg1-2+deb11u2'},
    {'release': '11.0', 'prefix': 'dovecot-sqlite', 'reference': '1:2.3.13+dfsg1-2+deb11u2'},
    {'release': '11.0', 'prefix': 'dovecot-submissiond', 'reference': '1:2.3.13+dfsg1-2+deb11u2'}
];
