...
# extracted from Fedora Security Advisory FEDORA-2024-3fd1bc9276
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-3fd1bc9276");

  script_name(english:"Fedora 38 : prometheus-podman-exporter (2024-3fd1bc9276)");
...
FEDORA-2024-3fd1bc9276 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-3fd1bc9276");
...
var pkgs = [
    {'reference':'prometheus-podman-exporter-1.7.0-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
