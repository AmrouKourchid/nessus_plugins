...
rdesktop was updated to 1.8.4 (fix for boo#1121448) :
  ...
  - Fix building against OpenSSL 1.1");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1121448");
  script_set_attribute(attribute:"see_also", value:"https://github.com/rdesktop/rdesktop/pull/334");
  script_set_attribute(attribute:"solution", value:
"Update the affected rdesktop packages.");
