...
# extracted from Fedora Security Advisory FEDORA-2024-4a05e3cd17
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-4a05e3cd17");

  script_name(english:"Fedora 41 : squid (2024-4a05e3cd17)");
...
FEDORA-2024-4a05e3cd17 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-4a05e3cd17");
...
var pkgs = [
    {'reference':'squid-6.12-2.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
];
