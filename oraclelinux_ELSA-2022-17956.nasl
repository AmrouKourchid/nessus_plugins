...
var appstreams = {
    'go-toolset:ol8addon': [
      ...
      {'reference':'golang-docs-1.18.3-1.0.1.module+el8.6.0+20704+139a7dad', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-misc-1.18.3-1.0.1.module+el8.6.0+20704+139a7dad', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-src-1.18.3-1.0.1.module+el8.6.0+20704+139a7dad', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-tests-1.18.3-1.0.1.module+el8.6.0+20704+139a7dad', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'golang-docs-1.18.3-1.0.1.module+el8.6.0+20704+139a7dad', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-misc-1.18.3-1.0.1.module+el8.6.0+20704+139a7dad', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-race-1.18.3-1.0.1.module+el8.6.0+20704+139a7dad', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-src-1.18.3-1.0.1.module+el8.6.0+20704+139a7dad', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-tests-1.18.3-1.0.1.module+el8.6.0+20704+139a7dad', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
};
