...
if (description)
{
  ...
  script_name(english:"MariaDB 10.4.0 < 10.4.23 Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote database server is affected by multiple vulnerabilities");
  script_set_attribute(attribute:"description", value:
"The version of MariaDB installed on the remote host is prior to 10.4.23. It is, therefore, affected by multiple
vulnerabilities as referenced in the mdb-10423-rn advisory.
...
"Upgrade to MariaDB version 10.4.23 or later.");
...
mysql_check_version(variant: 'MariaDB', min:'10.4.0-MariaDB', fixed:make_list('10.4.23-MariaDB'), severity:SECURITY_WARNING);