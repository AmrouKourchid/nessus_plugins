...
# extracted from Red Hat Security Advisory RHSA-2021:4903. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_4903.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4c9374c0");
...
"Update the RHEL nss package based on the guidance in RHSA-2021:4903.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'nss-3.67.0-7.el8_5', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nss-devel-3.67.0-7.el8_5', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nss-softokn-3.67.0-7.el8_5', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nss-softokn-devel-3.67.0-7.el8_5', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nss-softokn-freebl-3.67.0-7.el8_5', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nss-softokn-freebl-devel-3.67.0-7.el8_5', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nss-sysinit-3.67.0-7.el8_5', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nss-tools-3.67.0-7.el8_5', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nss-util-3.67.0-7.el8_5', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nss-util-devel-3.67.0-7.el8_5', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
