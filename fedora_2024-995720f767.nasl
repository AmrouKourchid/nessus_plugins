...
# extracted from Fedora Security Advisory FEDORA-2024-995720f767
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-995720f767");

  script_name(english:"Fedora 40 : matrix-synapse (2024-995720f767)");
...
FEDORA-2024-995720f767 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-995720f767");
...
"Update the affected matrix-synapse package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-52805");
...
var pkgs = [
    {'reference':'matrix-synapse-1.111.1-3.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
