...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.05 / MAIN 5.05 : python Vulnerability (NS-SA-2020-0002)");
...
pkgs = {
  "CGSL CORE 5.05": [
    "python-2.7.5-86.el7.cgslv5_5.0.2.gbddf16d.lite",
    "python-debug-2.7.5-86.el7.cgslv5_5.0.2.gbddf16d.lite",
    "python-debuginfo-2.7.5-86.el7.cgslv5_5.0.2.gbddf16d.lite",
    "python-devel-2.7.5-86.el7.cgslv5_5.0.2.gbddf16d.lite",
    "python-libs-2.7.5-86.el7.cgslv5_5.0.2.gbddf16d.lite",
    "python-test-2.7.5-86.el7.cgslv5_5.0.2.gbddf16d.lite",
    "python-tools-2.7.5-86.el7.cgslv5_5.0.2.gbddf16d.lite",
    "tkinter-2.7.5-86.el7.cgslv5_5.0.2.gbddf16d.lite"
  ],
  "CGSL MAIN 5.05": [
    "python-2.7.5-86.el7.cgslv5_5.0.2.gc315633",
    "python-debug-2.7.5-86.el7.cgslv5_5.0.2.gc315633",
    "python-debuginfo-2.7.5-86.el7.cgslv5_5.0.2.gc315633",
    "python-devel-2.7.5-86.el7.cgslv5_5.0.2.gc315633",
    "python-libs-2.7.5-86.el7.cgslv5_5.0.2.gc315633",
    "python-test-2.7.5-86.el7.cgslv5_5.0.2.gc315633",
    "python-tools-2.7.5-86.el7.cgslv5_5.0.2.gc315633",
    "tkinter-2.7.5-86.el7.cgslv5_5.0.2.gc315633"
  ]
};
