...
# extracted from Fedora Security Advisory FEDORA-2024-c7b547bec5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-c7b547bec5");

  script_name(english:"Fedora 40 : mingw-expat (2024-c7b547bec5)");
...
FEDORA-2024-c7b547bec5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-c7b547bec5");
...
var pkgs = [
    {'reference':'mingw-expat-2.6.3-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
