...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.12.1 : mod_http2 (EulerOS-SA-2024-2311)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2311
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8a132f29");
...
var pkgs = [
  "mod_http2-1.15.25-2.h1.eulerosv2r12"
];
