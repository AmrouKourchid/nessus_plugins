...
# extracted from Ubuntu Security Notice USN-7031-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"7031-1");

  script_name(english:"Ubuntu 24.04 LTS : Puma vulnerability (USN-7031-1)");
...
USN-7031-1 advisory.
    ...
    use this issue to overwrite header values set by intermediate proxies by providing duplicate headers
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7031-1");
...
var pkgs = [
    {'osver': '24.04', 'pkgname': 'puma', 'pkgver': '6.4.2-4ubuntu4.3'}
];
