...
# extracted from Red Hat Security Advisory RHSA-2025:0165. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:0165");

  script_name(english:"RHEL 9 : thunderbird (RHSA-2025:0165)");
...
referenced in the RHSA-2025:0165 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_0165.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?283470d7");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:0165");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL thunderbird package based on the guidance in RHSA-2025:0165.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'thunderbird-128.6.0-3.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
