...
# extracted from Fedora Security Advisory FEDORA-2025-9a271ccfb3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-9a271ccfb3");
  script_xref(name:"IAVA", value:"2025-A-0213-S");

  script_name(english:"Fedora 41 : thunderbird (2025-9a271ccfb3)");
...
FEDORA-2025-9a271ccfb3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-9a271ccfb3");
...
var pkgs = [
    {'reference':'thunderbird-128.9.0-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
