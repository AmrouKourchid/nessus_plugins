...
# extracted from Red Hat Security Advisory RHSA-2018:2712. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:2712");

  script_name(english:"RHEL 6 : java-1.7.1-ibm (RHSA-2018:2712)");
...
referenced in the RHSA-2018:2712 advisory.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_2712.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e2eb7627");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:2712");
...
"Update the RHEL java-1.7.1-ibm package based on the guidance in RHSA-2018:2712.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'java-1.7.1-ibm-1.7.1.4.30-1jpp.2.el6_10', 'cpu':'s390x', 'release':'6', 'el_string':'el6_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.7.1-ibm-1.7.1.4.30-1jpp.2.el6_10', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.7.1-ibm-devel-1.7.1.4.30-1jpp.2.el6_10', 'cpu':'s390x', 'release':'6', 'el_string':'el6_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.7.1-ibm-devel-1.7.1.4.30-1jpp.2.el6_10', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
