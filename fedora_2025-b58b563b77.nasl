...
# extracted from Fedora Security Advisory FEDORA-2025-b58b563b77
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-b58b563b77");

  script_name(english:"Fedora 40 : pam-u2f (2025-b58b563b77)");
...
FEDORA-2025-b58b563b77 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-b58b563b77");
  script_set_attribute(attribute:"solution", value:
"Update the affected pam-u2f package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:pam-u2f");
...
var pkgs = [
    {'reference':'pam-u2f-1.3.2-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'pam-u2f');
}
