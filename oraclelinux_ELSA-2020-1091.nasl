...
# extracted from Oracle Linux Security Advisory ELSA-2020-1091.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : python-twisted-web (ELSA-2020-1091)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2020-1091.html");
...
var pkgs = [
    {'reference':'python-twisted-web-12.1.0-6.el7', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
