...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : post (ELSA-2008-0839)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2008-0839.html");
...
"Update the affected postfix and / or postfix-pflogsumm packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2008-2936");
...
var pkgs = [
    {'reference':'postfix-2.3.3-2.1.el5_2', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'postfix-pflogsumm-2.3.3-2.1.el5_2', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'postfix-2.3.3-2.1.el5_2', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'postfix-pflogsumm-2.3.3-2.1.el5_2', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
