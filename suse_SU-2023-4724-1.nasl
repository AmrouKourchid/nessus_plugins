...
# SUSE update advisory SUSE-SU-2023:4724-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:4724-1");

  script_name(english:"SUSE SLES12 Security Update : squid (SUSE-SU-2023:4724-1)");
...
referenced in the SUSE-SU-2023:4724-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-December/017308.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f4627a46");
...
var pkgs = [
    {'reference':'squid-4.17-4.38.1', 'sp':'5', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5']},
    {'reference':'squid-4.17-4.38.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.5']}
];
