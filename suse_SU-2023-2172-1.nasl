...
# SUSE update advisory SUSE-SU-2023:2172-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:2172-1");

  script_name(english:"openSUSE 15 Security Update : golang-github-prometheus-prometheus (SUSE-SU-2023:2172-1)");
...
SU-2023:2172-1 advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1200441");
  script_set_attribute(attribute:"see_also", value:"https://lists.suse.com/pipermail/sle-updates/2023-May/029365.html");
...
var pkgs = [
    {'reference':'firewalld-prometheus-config-0.1-150100.4.14.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.4']},
    {'reference':'golang-github-prometheus-prometheus-2.32.1-150100.4.14.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.4']}
];
