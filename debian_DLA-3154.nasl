...
# extracted from Debian Security Advisory dla-3154. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3154 : node-xmldom - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has a package installed that is affected by a vulnerability as referenced in the dla-3154
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-37616");
...
"Upgrade the node-xmldom packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-37616");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'node-xmldom', 'reference': '0.1.27+ds-1+deb10u1'}
];
