...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5046612");
  script_xref(name:"MSFT", value:"MS24-5046612");
  ...
  script_name(english:"KB5046612: Windows 10 Version 1607 / Windows Server 2016 Security Update (November 2024)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5046612");
