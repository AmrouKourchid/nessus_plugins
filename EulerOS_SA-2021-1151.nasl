...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : libexif (EulerOS-SA-2021-1151)");
...
vulnerabilities :
  ...
  - In exif_data_load_data_content of exif-data.c, there is
    ...
    interaction is needed for exploitation.(CVE-2020-0198)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1151
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8ebe7d0e");
...
"Update the affected libexif packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-0198");
...
pkgs = ["libexif-0.6.21-17.h10.eulerosv2r8"];
