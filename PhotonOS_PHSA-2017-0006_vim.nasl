...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Vim PHSA-2017-0006");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'vim-7.4-7.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'vim-extra-7.4-7.ph1')) flag++;
