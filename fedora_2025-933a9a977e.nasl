...
# extracted from Fedora Security Advisory FEDORA-2025-933a9a977e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-933a9a977e");

  script_name(english:"Fedora 41 : xen (2025-933a9a977e)");
...
FEDORA-2025-933a9a977e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-933a9a977e");
...
var pkgs = [
    {'reference':'xen-4.19.1-3.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
