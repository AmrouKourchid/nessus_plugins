...
# extracted from Fedora Security Advisory FEDORA-2019-8966706e33.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : 2:samba / libldb (2019-8966706e33)");
...
Update to Samba 4.9.9 Security fixes for CVE-2019-12435

Note that Tenable Network Security has extracted the preceding
description block directly from the Fedora update system website.
Tenable has attempted to automatically clean and format it as much as
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-8966706e33");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"samba-4.9.11-0.fc29", epoch:"2")) flag++;
if (rpm_check(release:"FC29", reference:"libldb-1.4.7-1.fc29")) flag++;
