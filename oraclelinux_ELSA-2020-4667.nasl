...
# extracted from Oracle Linux Security Advisory ELSA-2020-4667.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : mailman:2.1 (ELSA-2020-4667)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2020-4667.html");
...
var appstreams = {
    'mailman:2.1': [
      {'reference':'mailman-2.1.29-10.module+el8.3.0+7679+d7dcf94b', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      {'reference':'mailman-2.1.29-10.module+el8.3.0+7679+d7dcf94b', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'}
    ]
};
