...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : xz (EulerOS-SA-2022-2597)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the xz packages installed, the EulerOS Virtualization installation on the remote host is
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2597
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f3d2f9e9");
...
"Update the affected xz packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:xz-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:xz-libs");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:xz-lzma-compat");
...
var pkgs = [
  "xz-5.2.4-3.h2.eulerosv2r8",
  "xz-devel-5.2.4-3.h2.eulerosv2r8",
  "xz-libs-5.2.4-3.h2.eulerosv2r8",
  "xz-lzma-compat-5.2.4-3.h2.eulerosv2r8"
];
