...
# extracted from Fedora Security Advisory FEDORA-2023-e2c2896d16
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-e2c2896d16");
  script_xref(name:"IAVA", value:"2023-A-0529-S");

  script_name(english:"Fedora 38 : webkitgtk (2023-e2c2896d16)");
...
FEDORA-2023-e2c2896d16 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-e2c2896d16");
...
var pkgs = [
    {'reference':'webkitgtk-2.42.1-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
