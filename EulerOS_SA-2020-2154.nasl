...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : libxml2 (EulerOS-SA-2020-2154)");
...
vulnerability :
  ...
  - GNOME project libxml2 v2.9.10 and earlier have a global
    buffer over-read vulnerability in
    xmlEncodeEntitiesInternal at libxml2/entities.c. The
    issue has been fixed in commit 8e7c20a1
    (20910-GITv2.9.10-103-g8e7c20a1).(CVE-2020-24977)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2154
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4c894f79");
...
pkgs = ["libxml2-2.9.8-4.h12.eulerosv2r8",
        "libxml2-devel-2.9.8-4.h12.eulerosv2r8",
        "python2-libxml2-2.9.8-4.h12.eulerosv2r8",
        "python3-libxml2-2.9.8-4.h12.eulerosv2r8"];
