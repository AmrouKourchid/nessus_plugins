...
# extracted from openSUSE Security Update openSUSE-2020-1049.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : cni-plugins (openSUSE-2020-1049)");
...
if ( rpm_check(release:"SUSE15.1", reference:"cni-plugins-0.8.6-lp151.2.6.1") ) flag++;
