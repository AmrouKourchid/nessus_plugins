...
referenced in the RHSA-2017:2638 advisory.
    ...
    Enterprise Application Platform 6.4.17.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2017/rhsa-2017_2638.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3a967b18");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2017:2638");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jboss-ec2-eap-7.5.17-1.Final_redhat_4.ep6.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap6'},
      {'reference':'jboss-ec2-eap-samples-7.5.17-1.Final_redhat_4.ep6.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap6'}
    ]
  }
];
