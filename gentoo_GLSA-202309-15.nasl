...
# extracted from Gentoo Linux Security Advisory GLSA 202309-15.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202309-15 : GNU Binutils: Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202309-15 (GNU Binutils: Multiple Vulnerabilities)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202309-15");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=866713");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=867937");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=903893");
...
var packages = [
  {
    ...
    'unaffected' : make_list("ge 2.40"),
    'vulnerable' : make_list("lt 2.40")
  }
];
