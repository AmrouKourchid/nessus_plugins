...
# extracted from Fedora Security Advisory FEDORA-2024-bb52629e6c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-bb52629e6c");
  script_xref(name:"IAVA", value:"2024-A-0324-S");

  script_name(english:"Fedora 40 : chromium (2024-bb52629e6c)");
...
FEDORA-2024-bb52629e6c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-bb52629e6c");
...
var pkgs = [
    {'reference':'chromium-125.0.6422.141-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
