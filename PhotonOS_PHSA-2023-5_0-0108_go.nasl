...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Go PHSA-2023-5.0-0108");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'go-1.20.8-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'go-md2man-2.0.2-6.ph5')) flag++;
