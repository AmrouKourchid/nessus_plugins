...
if (description)
{
  ...
  script_cve_id("CVE-2013-1479");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2013-1479");
...
patch available.
  ...
  - Unspecified vulnerability in the Java Runtime Environment (JRE) component in Oracle Java SE 7 through
    Update 11, 6 through Update 38, and JavaFX 2.2.4 and earlier allows remote attackers to affect
    confidentiality, integrity, and availability via unknown vectors. (CVE-2013-1479)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-1479");
