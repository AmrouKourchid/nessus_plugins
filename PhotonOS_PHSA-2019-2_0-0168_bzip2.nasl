...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Bzip2 PHSA-2019-2.0-0168");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'bzip2-1.0.6-9.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'bzip2-debuginfo-1.0.6-9.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'bzip2-devel-1.0.6-9.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'bzip2-libs-1.0.6-9.ph2')) flag++;
