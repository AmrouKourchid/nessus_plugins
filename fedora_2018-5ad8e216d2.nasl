...
# extracted from Fedora Security Advisory FEDORA-2018-5ad8e216d2.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-5ad8e216d2");

  script_name(english:"Fedora 29 : zsh (2018-5ad8e216d2)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"- fix two security issues in shebang line parsing
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-5ad8e216d2");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"zsh-5.6.2-1.fc29")) flag++;
