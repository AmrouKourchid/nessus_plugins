...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.0 : python-pillow (EulerOS-SA-2022-2037)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2037
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?eaf74bdb");
...
var pkgs = [
  "python3-pillow-8.1.1-2.h7.eulerosv2r10"
];
