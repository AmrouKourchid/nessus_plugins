...
if (description)
{
  ...
  script_name(english:"LibreOffice 24.8.x < 24.8.5 / 25.2.x < 25.2.1 (cve-2025-1080)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of LibreOffice installed on the remote host is prior to 24.8.5 or 25.2.1. It is, therefore, affected by a
vulnerability as referenced in the cve-2025-1080 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.libreoffice.org/about-us/security/advisories/cve-2025-1080");
  script_set_attribute(attribute:"solution", value:
"Upgrade to LibreOffice version 24.8.5 / 25.2.1 or later.");
...
var constraints = [
  { 'min_version' : '24.8.0', 'fixed_version' : '24.8.5' },
  { 'min_version' : '25.2.0', 'fixed_version' : '25.2.1' }
];
