...
if (description)
{
  ...
  script_name(english:"Atlassian JIRA SEoL (4.0.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Atlassian JIRA is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Atlassian JIRA is 4.0.x. It is, therefore, no longer maintained by its vendor or provider.

Lack of support implies that no new security patches for the product will be released by the vendor. As a result, it may
contain security vulnerabilities.");
  # https://confluence.atlassian.com/jirakb/blog/2012/02/jira-4-0-x-support-end-of-life
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?96f1962e");
...
"Upgrade to a version of Atlassian JIRA that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2012/02/26");
...
var constraints = [
  { max_branch : '4.0', min_branch : '4.0', seol : 20120226 }
];
