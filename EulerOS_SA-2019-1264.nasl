...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.3 : php (EulerOS-SA-2019-1264)");
...
following vulnerabilities :
  ...
  - An issue was discovered in PHP before 5.6.40, 7.x
    ...
    ext/xmlrpc/libxmlrpc/base64.c.i1/4^CVE-2019-9024i1/4%0

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1264
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9e6c394d");
