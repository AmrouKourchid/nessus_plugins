...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS : Linux kernel (Qualcomm Snapdragon) vulnerability (USN-3008-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3008-1");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.4.0-1015-snapdragon");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-3008-1');
}
