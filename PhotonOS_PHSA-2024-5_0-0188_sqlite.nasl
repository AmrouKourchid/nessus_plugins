...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Sqlite PHSA-2024-5.0-0188");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'sqlite-3.40.1-3.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'sqlite-devel-3.40.1-3.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'sqlite-libs-3.40.1-3.ph5')) flag++;
