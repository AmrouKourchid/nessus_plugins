...
# extracted from Ubuntu Security Notice USN-4038-3. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS : bzip2 regression (USN-4038-3)");
...
in the USN-4038-3 advisory.

    USN-4038-1 fixed a vulnerability in bzip2. The update introduced a regression causing bzip2 to incorrect
    raises CRC errors for some files.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4038-3");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'bzip2', 'pkgver': '1.0.6-8ubuntu0.2'},
    {'osver': '16.04', 'pkgname': 'libbz2-1.0', 'pkgver': '1.0.6-8ubuntu0.2'},
    {'osver': '16.04', 'pkgname': 'libbz2-dev', 'pkgver': '1.0.6-8ubuntu0.2'},
    {'osver': '18.04', 'pkgname': 'bzip2', 'pkgver': '1.0.6-8.1ubuntu0.2'},
    {'osver': '18.04', 'pkgname': 'libbz2-1.0', 'pkgver': '1.0.6-8.1ubuntu0.2'},
    {'osver': '18.04', 'pkgname': 'libbz2-dev', 'pkgver': '1.0.6-8.1ubuntu0.2'}
];
