...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : proftpd (EulerOS-SA-2024-1244)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1244
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?820b6154");
...
var pkgs = [
  "proftpd-1.3.7c-3.h7.eulerosv2r11"
];
