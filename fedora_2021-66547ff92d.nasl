...
# extracted from Fedora Security Advisory FEDORA-2021-66547ff92d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-66547ff92d");

  script_name(english:"Fedora 33 : python2.7 (2021-66547ff92d)");
...
FEDORA-2021-66547ff92d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-66547ff92d");
...
pkgs = [
    {'reference':'python2.7-2.7.18-8.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
