...
# extracted from Oracle Linux Security Advisory ELSA-2024-7346.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : cups-filters (ELSA-2024-7346)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 9 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ELSA-2024-7346 advisory.

    - CVE-2024-47175 cups-filters: remote command injection via attacker controlled data in PPD file
    - CVE-2024-47076 cups-filters: cfGetPrinterAttributes API does not perform sanitization on returned IPP
    attributes
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-7346.html");
...
var pkgs = [
    {'reference':'cups-filters-1.28.7-17.0.1.el9_4', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cups-filters-devel-1.28.7-17.0.1.el9_4', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cups-filters-libs-1.28.7-17.0.1.el9_4', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cups-filters-1.28.7-17.0.1.el9_4', 'cpu':'i686', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cups-filters-devel-1.28.7-17.0.1.el9_4', 'cpu':'i686', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cups-filters-libs-1.28.7-17.0.1.el9_4', 'cpu':'i686', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cups-filters-1.28.7-17.0.1.el9_4', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cups-filters-devel-1.28.7-17.0.1.el9_4', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cups-filters-libs-1.28.7-17.0.1.el9_4', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
