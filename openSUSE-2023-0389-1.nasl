...
# openSUSE Security Update openSUSE-SU-2023:0389-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : python-Django1 (openSUSE-SU-2023:0389-1)");
...
number.");
  ...
  # https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/ISYFTHNMH6NZ2MEVDMMO3ILOSLSDZXWX/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0ec280da");
...
var pkgs = [
    {'reference':'python3-Django1-1.11.29-bp154.2.9.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE}
];
