...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : libxml2 (EulerOS-SA-2020-1165)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1165
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d8bfa571");
...
pkgs = ["libxml2-2.9.8-4.h9.eulerosv2r8",
        "libxml2-devel-2.9.8-4.h9.eulerosv2r8",
        "python2-libxml2-2.9.8-4.h9.eulerosv2r8",
        "python3-libxml2-2.9.8-4.h9.eulerosv2r8"];
