...
# extracted from Red Hat Security Advisory RHSA-2017:3195. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2017:3195");

  script_name(english:"RHEL 6 : httpd (RHSA-2017:3195)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for httpd.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 6 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2017:3195 advisory.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2017/rhsa-2017_3195.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?94f1dc47");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2017:3195");
...
"Update the RHEL httpd package based on the guidance in RHSA-2017:3195.");
  ...
  script_cwe_id(125, 287, 416, 456, 476);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'httpd-2.2.15-47.el6_7.5', 'sp':'7', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'httpd-2.2.15-47.el6_7.5', 'sp':'7', 'cpu':'ppc64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'httpd-2.2.15-47.el6_7.5', 'sp':'7', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'httpd-2.2.15-47.el6_7.5', 'sp':'7', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'httpd-devel-2.2.15-47.el6_7.5', 'sp':'7', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'httpd-devel-2.2.15-47.el6_7.5', 'sp':'7', 'cpu':'ppc', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'httpd-devel-2.2.15-47.el6_7.5', 'sp':'7', 'cpu':'ppc64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'httpd-devel-2.2.15-47.el6_7.5', 'sp':'7', 'cpu':'s390', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'httpd-devel-2.2.15-47.el6_7.5', 'sp':'7', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'httpd-devel-2.2.15-47.el6_7.5', 'sp':'7', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'httpd-manual-2.2.15-47.el6_7.5', 'sp':'7', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'httpd-tools-2.2.15-47.el6_7.5', 'sp':'7', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'httpd-tools-2.2.15-47.el6_7.5', 'sp':'7', 'cpu':'ppc64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'httpd-tools-2.2.15-47.el6_7.5', 'sp':'7', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'httpd-tools-2.2.15-47.el6_7.5', 'sp':'7', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mod_ssl-2.2.15-47.el6_7.5', 'sp':'7', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'mod_ssl-2.2.15-47.el6_7.5', 'sp':'7', 'cpu':'ppc64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'mod_ssl-2.2.15-47.el6_7.5', 'sp':'7', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'mod_ssl-2.2.15-47.el6_7.5', 'sp':'7', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
