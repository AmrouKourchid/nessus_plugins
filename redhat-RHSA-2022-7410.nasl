...
# extracted from Red Hat Security Advisory RHSA-2022:7410. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:7410");

  script_name(english:"RHEL 8 : Red Hat Single Sign-On 7.6.1 security update on RHEL 8 (Moderate) (RHSA-2022:7410)");
...
referenced in the RHSA-2022:7410 advisory.
    ...
    This release of Red Hat Single Sign-On 7.6.1 on RHEL 8 serves as a replacement for Red Hat Single Sign-On
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_7410.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a44f7188");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:7410");
...
"Update the RHEL Red Hat Single Sign-On 7.6.1 package based on the guidance in RHSA-2022:7410.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-sso7-keycloak-18.0.3-1.redhat_00001.1.el8sso', 'release':'8', 'el_string':'el8sso', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-sso'},
      {'reference':'rh-sso7-keycloak-server-18.0.3-1.redhat_00001.1.el8sso', 'release':'8', 'el_string':'el8sso', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-sso'}
    ]
  }
];
