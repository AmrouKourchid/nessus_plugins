...
vulnerabilities as referenced in the USN-5569-1 advisory.
    ...
    Xiang Li discovered that Unbound incorrectly handled delegation caching. A remote attacker could use this
    issue to keep rogue domain names resolvable long after they have been revoked.
