...
if (description)
{
  ...
  script_cve_id("CVE-2022-0417");

  script_name(english:"Photon OS 3.0: Vim PHSA-2022-3.0-0376");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'vim-8.2.3408-25.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'vim-extra-8.2.3408-25.ph3')) flag++;
