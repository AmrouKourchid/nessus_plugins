...
# SUSE update advisory SUSE-SU-2022:0118-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:0118-1");

  script_name(english:"SUSE SLED12 / SLES12 Security Update : python-numpy (SUSE-SU-2022:0118-1)");
...
vulnerabilities as referenced in the SUSE-SU-2022:0118-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8e0523d7");
...
var pkgs = [
    {'reference':'python-numpy-1.8.0-5.11.1', 'sp':'5', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5']},
    {'reference':'python-numpy-devel-1.8.0-5.11.1', 'sp':'5', 'release':'SLED12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-sdk-release-12.5']},
    {'reference':'python-numpy-devel-1.8.0-5.11.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-sdk-release-12.5']},
    {'reference':'python-numpy-1.8.0-5.11.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.5']}
];
