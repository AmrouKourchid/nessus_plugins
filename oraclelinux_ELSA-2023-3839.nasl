...
# extracted from Oracle Linux Security Advisory ELSA-2023-3839.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : libssh (ELSA-2023-3839)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ELSA-2023-3839 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-3839.html");
...
var pkgs = [
    ...
    {'reference':'libssh-config-0.9.6-10.el8_8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'libssh-config-0.9.6-10.el8_8', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'libssh-config-0.9.6-10.el8_8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
