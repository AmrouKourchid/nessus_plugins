...
# extracted from Red Hat Security Advisory RHSA-2025:7546. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2022-41741", "CVE-2022-41742", "CVE-2024-7347");
  script_xref(name:"RHSA", value:"2025:7546");

  script_name(english:"RHEL 9 : nginx (RHSA-2025:7546)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for nginx.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2025:7546 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2141495");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2141496");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_7546.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6d57a47c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:7546");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL nginx package based on the guidance in RHSA-2025:7546.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'nginx-1.20.1-14.el9_2.3', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nginx-all-modules-1.20.1-14.el9_2.3', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nginx-core-1.20.1-14.el9_2.3', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nginx-filesystem-1.20.1-14.el9_2.3', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nginx-mod-devel-1.20.1-14.el9_2.3', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nginx-mod-http-image-filter-1.20.1-14.el9_2.3', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nginx-mod-http-perl-1.20.1-14.el9_2.3', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nginx-mod-http-xslt-filter-1.20.1-14.el9_2.3', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nginx-mod-mail-1.20.1-14.el9_2.3', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nginx-mod-stream-1.20.1-14.el9_2.3', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
