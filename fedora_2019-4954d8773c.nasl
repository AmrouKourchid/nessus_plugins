...
# extracted from Fedora Security Advisory FEDORA-2019-4954d8773c.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-4954d8773c");

  script_name(english:"Fedora 30 : python38 (2019-4954d8773c)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-4954d8773c");
  script_set_attribute(attribute:"see_also", value:"https://bugs.python.org");
  script_set_attribute(attribute:"see_also", value:"https://www.python.org/dev/peps/pep-0569/");
  script_set_attribute(attribute:"see_also", value:"https://www.python.org/dev/peps/pep-0570/");
  script_set_attribute(attribute:"see_also", value:"https://www.python.org/dev/peps/pep-0572/");
  script_set_attribute(attribute:"see_also", value:"https://www.python.org/dev/peps/pep-0574");
  script_set_attribute(attribute:"see_also", value:"https://www.python.org/dev/peps/pep-0578");
  script_set_attribute(attribute:"see_also", value:"https://www.python.org/dev/peps/pep-0586");
  script_set_attribute(attribute:"see_also", value:"https://www.python.org/dev/peps/pep-0587/");
  script_set_attribute(attribute:"see_also", value:"https://www.python.org/dev/peps/pep-0589");
  script_set_attribute(attribute:"see_also", value:"https://www.python.org/dev/peps/pep-0590/");
  script_set_attribute(attribute:"see_also", value:"https://www.python.org/dev/peps/pep-0591");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"python38-3.8.0~b4-1.fc30")) flag++;
