...
# extracted from Fedora Security Advisory FEDORA-2023-90ed807e04
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-90ed807e04");

  script_name(english:"Fedora 38 : libpano13 (2023-90ed807e04)");
...
FEDORA-2023-90ed807e04 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-90ed807e04");
...
var pkgs = [
    {'reference':'libpano13-2.9.22-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
