...
if (description)
{
  ...
  script_name(english:"Amazon Corretto Java 8.x < 8.292.10.1 Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"Amazon Corretto is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Amazon Corretto installed on the remote host is prior to 8 < 8.292.10.1. It is, therefore, affected by
multiple vulnerabilities as referenced in the corretto-8-2021-Apr-20 advisory.
...
number.");
  # https://github.com/corretto/corretto-8/blob/develop/CHANGELOG.md#corretto-version-8292101
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d3277bd2");
  script_set_attribute(attribute:"solution", value:
"Update to Amazon Corretto Java 8.292.10.1 or later");
...
var constraints = [
  { 'min_version' : '8.0', 'fixed_version' : '8.292.10.1' }
];
