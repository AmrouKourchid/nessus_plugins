...
# extracted from Fedora Security Advisory FEDORA-2024-0b2854c95b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-0b2854c95b");

  script_name(english:"Fedora 39 : php-tcpdf (2024-0b2854c95b)");
...
FEDORA-2024-0b2854c95b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-0b2854c95b");
...
var pkgs = [
    {'reference':'php-tcpdf-6.7.7-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
