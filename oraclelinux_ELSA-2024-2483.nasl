...
# extracted from Oracle Linux Security Advisory ELSA-2024-2483.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : traceroute (ELSA-2024-2483)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-2483.html");
...
"Update the affected traceroute package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:traceroute");
