...
# CentOS Errata and Security Advisory 2017:1480 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : glibc (CESA-2017:1480) (Stack Clash)");
...
issue.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0fb470ed");
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"glibc-2.12-1.209.el6_9.2")) flag++;
if (rpm_check(release:"CentOS-6", reference:"glibc-common-2.12-1.209.el6_9.2")) flag++;
if (rpm_check(release:"CentOS-6", reference:"glibc-devel-2.12-1.209.el6_9.2")) flag++;
if (rpm_check(release:"CentOS-6", reference:"glibc-headers-2.12-1.209.el6_9.2")) flag++;
if (rpm_check(release:"CentOS-6", reference:"glibc-static-2.12-1.209.el6_9.2")) flag++;
if (rpm_check(release:"CentOS-6", reference:"glibc-utils-2.12-1.209.el6_9.2")) flag++;
if (rpm_check(release:"CentOS-6", reference:"nscd-2.12-1.209.el6_9.2")) flag++;
