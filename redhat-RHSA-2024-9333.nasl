...
# extracted from Red Hat Security Advisory RHSA-2024:9333. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:9333");

  script_name(english:"RHEL 9 : openssl and openssl-fips-provider (RHSA-2024:9333)");
...
referenced in the RHSA-2024:9333 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2274020");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2281029");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2283757");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2294581");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-26271");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-32123");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-38514");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-40723");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-58662");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_9333.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?091d3027");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:9333");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL openssl / openssl-fips-provider packages based on the guidance in RHSA-2024:9333.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openssl-3.2.2-6.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'openssl-devel-3.2.2-6.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'openssl-libs-3.2.2-6.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'openssl-perl-3.2.2-6.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
