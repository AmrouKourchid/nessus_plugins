...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5027256");
  script_xref(name:"MSKB", value:"5027275");
  script_xref(name:"MSFT", value:"MS23-5027256");
  script_xref(name:"MSFT", value:"MS23-5027275");
  script_xref(name:"IAVA", value:"2023-A-0305-S");
  script_xref(name:"IAVA", value:"2023-A-0306-S");

  script_name(english:"KB5027256: Windows Server 2008 R2 Security Update (June 2023)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5027256");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5027275");
...
if (("windows server 2008 r2" >< tolower(os_name)) && 
  smb_check_rollup(os:'6.1',
                   ...
                   rollup_date:'06_2023',
                   bulletin:bulletin,
                   rollup_kb_list:[5027275, 5027256])
)
{
