...
# extracted from Fedora Security Advisory FEDORA-2023-9f948bec13
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-9f948bec13");
  script_xref(name:"IAVB", value:"2023-B-0062-S");

  script_name(english:"Fedora 37 : clamav (2023-9f948bec13)");
...
FEDORA-2023-9f948bec13 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-9f948bec13");
...
var pkgs = [
    {'reference':'clamav-0.103.9-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
