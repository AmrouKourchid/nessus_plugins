...
# extracted from Fedora Security Advisory FEDORA-2023-ae06b3704c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-ae06b3704c");

  script_name(english:"Fedora 36 : mingw-python-OWSLib (2023-ae06b3704c)");
...
FEDORA-2023-ae06b3704c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-ae06b3704c");
...
var pkgs = [
    {'reference':'mingw-python-OWSLib-0.28.1-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
