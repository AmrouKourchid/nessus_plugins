...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.2 : dbus (EulerOS-SA-2021-2133)");
...
following vulnerability :
  ...
  - An issue was discovered in dbus >= 1.3.0 before
    ...
    limit, denying service to subsequent D-Bus clients.
    (CVE-2020-12049)
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2133
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dd327c1f");
...
pkgs = ["dbus-1.10.24-7.h12.eulerosv2r7",
        "dbus-libs-1.10.24-7.h12.eulerosv2r7"];
