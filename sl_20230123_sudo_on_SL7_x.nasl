...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"RHSA-2023:0291");

  script_name(english:"Scientific Linux Security Update : sudo on SL7.x i686/x86_64 (2023:0291)");
...
SLSA-2023:0291-1 advisory.

  - sudo: arbitrary file write with privileges of the RunAs user (CVE-2023-22809)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.scientificlinux.org/category/sl-errata/slsa-20230291-1");
...
var pkgs = [
    {'reference':'sudo-1.8.23-10.el7_9.3', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sudo-debuginfo-1.8.23-10.el7_9.3', 'cpu':'i686', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sudo-debuginfo-1.8.23-10.el7_9.3', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sudo-devel-1.8.23-10.el7_9.3', 'cpu':'i686', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sudo-devel-1.8.23-10.el7_9.3', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE}
];
