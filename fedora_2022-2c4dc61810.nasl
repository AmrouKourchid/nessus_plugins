...
# extracted from Fedora Security Advisory FEDORA-2022-2c4dc61810
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-2c4dc61810");

  script_name(english:"Fedora 36 : firefox (2022-2c4dc61810)");
...
FEDORA-2022-2c4dc61810 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-2c4dc61810");
...
var pkgs = [
    {'reference':'firefox-103.0-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
