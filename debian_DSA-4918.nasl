...
# extracted from Debian Security Advisory DSA-4918. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"4918");

  script_name(english:"Debian DSA-4918-1 : ruby-rack-cors - security update");
...
resources."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=944849"
  );
  # https://security-tracker.debian.org/tracker/source-package/ruby-rack-cors
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2a87bed2"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/buster/ruby-rack-cors"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2021/dsa-4918"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
flag = 0;
if (deb_check(release:"10.0", prefix:"ruby-rack-cors", reference:"1.0.2-1+deb10u1")) flag++;
