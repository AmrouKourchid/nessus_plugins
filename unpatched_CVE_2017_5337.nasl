...
if (description)
{
  ...
  script_cve_id("CVE-2017-5337");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2017-5337");
...
patch available.
  ...
  - Multiple heap-based buffer overflows in the read_attribute function in GnuTLS before 3.3.26 and 3.5.x
    before 3.5.8 allow remote attackers to have unspecified impact via a crafted OpenPGP certificate.
    (CVE-2017-5337)
