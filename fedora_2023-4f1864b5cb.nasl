...
# extracted from Fedora Security Advisory FEDORA-2023-4f1864b5cb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-4f1864b5cb");

  script_name(english:"Fedora 39 : pypy (2023-4f1864b5cb)");
...
FEDORA-2023-4f1864b5cb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-4f1864b5cb");
...
var pkgs = [
    {'reference':'pypy-7.3.11-3.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
