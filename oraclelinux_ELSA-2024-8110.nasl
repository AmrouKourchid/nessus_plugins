...
# extracted from Oracle Linux Security Advisory ELSA-2024-8110.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : containernetworking-plugins (ELSA-2024-8110)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-8110.html");
...
var pkgs = [
    {'reference':'containernetworking-plugins-1.4.0-6.el9_4', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'containernetworking-plugins-1.4.0-6.el9_4', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
