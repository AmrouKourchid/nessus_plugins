...
# extracted from Red Hat Security Advisory RHSA-2025:1446. The text
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_1446.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bd176dc1");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:1446");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL nodejs:18 package based on the guidance in RHSA-2025:1446.");
  ...
  'nodejs:18': [
    {
      ...
      'pkgs': [
        {'reference':'nodejs-18.20.6-1.module+el9.5.0+22773+9a359385', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-devel-18.20.6-1.module+el9.5.0+22773+9a359385', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-docs-18.20.6-1.module+el9.5.0+22773+9a359385', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-full-i18n-18.20.6-1.module+el9.5.0+22773+9a359385', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-nodemon-3.0.1-1.module+el9.5.0+22773+9a359385', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'nodejs-packaging-2021.06-4.module+el9.5.0+22773+9a359385', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'nodejs-packaging-bundler-2021.06-4.module+el9.5.0+22773+9a359385', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'npm-10.8.2-1.18.20.6.1.module+el9.5.0+22773+9a359385', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
      ]
    }
  ]
};
