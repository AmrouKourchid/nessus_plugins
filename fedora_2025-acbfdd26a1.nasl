...
# extracted from Fedora Security Advisory FEDORA-2025-acbfdd26a1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-acbfdd26a1");

  script_name(english:"Fedora 41 : chromium (2025-acbfdd26a1)");
...
FEDORA-2025-acbfdd26a1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-acbfdd26a1");
...
var pkgs = [
    {'reference':'chromium-133.0.6943.126-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
