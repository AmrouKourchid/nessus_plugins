...
# extracted from Fedora Security Advisory FEDORA-2023-d79ff22c5b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-d79ff22c5b");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2024/02/27");

  script_name(english:"Fedora 39 : chromium (2023-d79ff22c5b)");
...
FEDORA-2023-d79ff22c5b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-d79ff22c5b");
...
var pkgs = [
    {'reference':'chromium-116.0.5845.179-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
