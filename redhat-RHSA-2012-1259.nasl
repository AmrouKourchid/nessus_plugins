...
referenced in the RHSA-2012:1259 advisory.
  ...
  - quagga (bgpd): Assertion failure by processing malformed AS4 capability in BGP OPEN message
    (CVE-2012-0255)

  - quagga (bgpd): Assertion failure by processing BGP OPEN message with malformed ORF capability TLV
    (VU#962587) (CVE-2012-1820)

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2012/rhsa-2012_1259.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ea45eca3");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2012:1259");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=802781");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=817580");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL quagga package based on the guidance in RHSA-2012:1259.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'quagga-0.99.15-7.el6_3.2', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'quagga-0.99.15-7.el6_3.2', 'cpu':'ppc64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'quagga-0.99.15-7.el6_3.2', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'quagga-0.99.15-7.el6_3.2', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'quagga-contrib-0.99.15-7.el6_3.2', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'quagga-contrib-0.99.15-7.el6_3.2', 'cpu':'ppc64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'quagga-contrib-0.99.15-7.el6_3.2', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'quagga-contrib-0.99.15-7.el6_3.2', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'quagga-devel-0.99.15-7.el6_3.2', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'quagga-devel-0.99.15-7.el6_3.2', 'cpu':'ppc', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'quagga-devel-0.99.15-7.el6_3.2', 'cpu':'ppc64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'quagga-devel-0.99.15-7.el6_3.2', 'cpu':'s390', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'quagga-devel-0.99.15-7.el6_3.2', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'quagga-devel-0.99.15-7.el6_3.2', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
