...
# extracted from Red Hat Security Advisory RHSA-2018:3052. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:3052");

  script_name(english:"RHEL 7 : wget (RHSA-2018:3052)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2018/rhsa-2018_3052.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b4d28006");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:3052");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1575634");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL wget package based on the guidance in RHSA-2018:3052.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'wget-1.14-18.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
