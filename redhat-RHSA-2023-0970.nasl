...
# extracted from Red Hat Security Advisory RHSA-2023:0970. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:0970");

  script_name(english:"RHEL 9 : httpd (RHSA-2023:0970)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for httpd.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2023:0970 advisory.
    ...
    * httpd-init fails to create localhost.crt, localhost.key due to sscg default now creates a
    /dhparams.pem and is not idempotent if the file /dhparams.pem already exists. (BZ#2165975)

Tenable has extracted the preceding description block directly from the Red Hat Enterprise Linux security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_0970.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5b3e343c");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:0970");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL httpd package based on the guidance in RHSA-2023:0970.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'httpd-2.4.53-7.el9_1.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'httpd-core-2.4.53-7.el9_1.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'httpd-devel-2.4.53-7.el9_1.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'httpd-tools-2.4.53-7.el9_1.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mod_ldap-2.4.53-7.el9_1.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mod_lua-2.4.53-7.el9_1.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mod_proxy_html-2.4.53-7.el9_1.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'mod_session-2.4.53-7.el9_1.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mod_ssl-2.4.53-7.el9_1.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
