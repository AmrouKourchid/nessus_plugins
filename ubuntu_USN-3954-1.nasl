...
# extracted from Ubuntu Security Notice USN-3954-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS : FreeRADIUS vulnerabilities (USN-3954-1)");
...
the USN-3954-1 advisory.

    It was discovered that FreeRADIUS incorrectly handled certain inputs. An attacker could possibly use this
    issue to bypass authentication. (CVE-2019-11234, CVE-2019-11235)

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3954-1");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'freeradius', 'pkgver': '3.0.16+dfsg-1ubuntu3.1'},
    {'osver': '18.04', 'pkgname': 'freeradius-common', 'pkgver': '3.0.16+dfsg-1ubuntu3.1'},
    {'osver': '18.04', 'pkgname': 'freeradius-config', 'pkgver': '3.0.16+dfsg-1ubuntu3.1'},
    {'osver': '18.04', 'pkgname': 'freeradius-dhcp', 'pkgver': '3.0.16+dfsg-1ubuntu3.1'},
    {'osver': '18.04', 'pkgname': 'freeradius-iodbc', 'pkgver': '3.0.16+dfsg-1ubuntu3.1'},
    {'osver': '18.04', 'pkgname': 'freeradius-krb5', 'pkgver': '3.0.16+dfsg-1ubuntu3.1'},
    {'osver': '18.04', 'pkgname': 'freeradius-ldap', 'pkgver': '3.0.16+dfsg-1ubuntu3.1'},
    {'osver': '18.04', 'pkgname': 'freeradius-memcached', 'pkgver': '3.0.16+dfsg-1ubuntu3.1'},
    {'osver': '18.04', 'pkgname': 'freeradius-mysql', 'pkgver': '3.0.16+dfsg-1ubuntu3.1'},
    {'osver': '18.04', 'pkgname': 'freeradius-postgresql', 'pkgver': '3.0.16+dfsg-1ubuntu3.1'},
    {'osver': '18.04', 'pkgname': 'freeradius-redis', 'pkgver': '3.0.16+dfsg-1ubuntu3.1'},
    {'osver': '18.04', 'pkgname': 'freeradius-rest', 'pkgver': '3.0.16+dfsg-1ubuntu3.1'},
    {'osver': '18.04', 'pkgname': 'freeradius-utils', 'pkgver': '3.0.16+dfsg-1ubuntu3.1'},
    {'osver': '18.04', 'pkgname': 'freeradius-yubikey', 'pkgver': '3.0.16+dfsg-1ubuntu3.1'},
    {'osver': '18.04', 'pkgname': 'libfreeradius-dev', 'pkgver': '3.0.16+dfsg-1ubuntu3.1'},
    {'osver': '18.04', 'pkgname': 'libfreeradius3', 'pkgver': '3.0.16+dfsg-1ubuntu3.1'}
];
