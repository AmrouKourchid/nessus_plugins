...
# extracted from F5 Networks BIG-IP Solution K000140745.
#
# @NOAGENT@
##
...
if (description)
{
  ...
  script_cve_id("CVE-2024-1975");

  script_name(english:"F5 Networks BIG-IP : BIND vulnerability (K000140745)");
...
by a vulnerability as referenced in the K000140745 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K000140745");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K000140745.");
