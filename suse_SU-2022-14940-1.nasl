...
# SUSE update advisory SUSE-SU-2022:14940-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:14940-1");

  script_name(english:"SUSE SLES11 Security Update : dnsmasq (SUSE-SU-2022:14940-1)");
...
the SUSE-SU-2022:14940-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1138743");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-April/010783.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2168da3c");
...
var pkgs = [
    {'reference':'dnsmasq-2.78-0.16.17.1', 'sp':'3', 'cpu':'i586', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-pos-release-11.3']}
];
