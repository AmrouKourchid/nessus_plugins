...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS : WebKitGTK+ vulnerabilities (USN-3551-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 16.04 LTS host has packages installed that are affected by multiple vulnerabilities as referenced in
the USN-3551-1 advisory.

    Multiple security issues were discovered in the WebKitGTK+ Web and JavaScript engines. If a user were
    tricked in to opening a specially crafted website, an attacker could potentially exploit these to cause a
    denial of service, spoof the user interface, or execute arbitrary code. (CVE-2018-4088, CVE-2018-4096,
    CVE-2017-7153, CVE-2017-7160, CVE-2017-7161, CVE-2017-7165, CVE-2017-13884, CVE-2017-13885)

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3551-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'gir1.2-javascriptcoregtk-4.0', 'pkgver': '2.18.6-0ubuntu0.16.04.1'},
    {'osver': '16.04', 'pkgname': 'gir1.2-webkit2-4.0', 'pkgver': '2.18.6-0ubuntu0.16.04.1'},
    {'osver': '16.04', 'pkgname': 'libjavascriptcoregtk-4.0-18', 'pkgver': '2.18.6-0ubuntu0.16.04.1'},
    {'osver': '16.04', 'pkgname': 'libjavascriptcoregtk-4.0-bin', 'pkgver': '2.18.6-0ubuntu0.16.04.1'},
    {'osver': '16.04', 'pkgname': 'libjavascriptcoregtk-4.0-dev', 'pkgver': '2.18.6-0ubuntu0.16.04.1'},
    {'osver': '16.04', 'pkgname': 'libwebkit2gtk-4.0-37', 'pkgver': '2.18.6-0ubuntu0.16.04.1'},
    {'osver': '16.04', 'pkgname': 'libwebkit2gtk-4.0-37-gtk2', 'pkgver': '2.18.6-0ubuntu0.16.04.1'},
    {'osver': '16.04', 'pkgname': 'libwebkit2gtk-4.0-dev', 'pkgver': '2.18.6-0ubuntu0.16.04.1'}
];
