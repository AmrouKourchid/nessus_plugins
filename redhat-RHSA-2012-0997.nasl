...
referenced in the RHSA-2012:0997 advisory.

  - rhds/389: plaintext password disclosure flaw (CVE-2012-2678)

  - rhds/389: plaintext password disclosure in audit log (CVE-2012-2746)

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2012/rhsa-2012_0997.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?080daa4f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2012:0997");
...
"Update the RHEL 389-ds-base package based on the guidance in RHSA-2012:0997.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'389-ds-base-1.2.10.2-18.el6_3', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'389-ds-base-1.2.10.2-18.el6_3', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'389-ds-base-devel-1.2.10.2-18.el6_3', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'389-ds-base-devel-1.2.10.2-18.el6_3', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'389-ds-base-libs-1.2.10.2-18.el6_3', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'389-ds-base-libs-1.2.10.2-18.el6_3', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
