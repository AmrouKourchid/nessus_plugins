...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : python-paramiko on SL6.x (noarch) (20181031)");
...
"Security Fix(es) :
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6265b3a1");
...
flag = 0;
if (rpm_check(release:"SL6", reference:"python-paramiko-1.7.5-5.el6_10")) flag++;
