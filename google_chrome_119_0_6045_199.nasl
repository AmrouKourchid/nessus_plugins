...
"The version of Google Chrome installed on the remote Windows host is prior to 119.0.6045.199. It is, therefore, affected
...
google_chrome_check_version(installs:installs, fix:'119.0.6045.199', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
