...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : OpenEXR (EulerOS-SA-2021-1335)");
...
vulnerabilities :
  ...
  - In OpenEXR 2.2.0, an invalid read of size 1 in the
    getBits function in ImfHuf.cpp could cause the
  ...
  - In OpenEXR 2.2.0, an invalid read of size 1 in the
    refill function in ImfFastHuf.cpp could cause the
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1335
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5fa48848");
