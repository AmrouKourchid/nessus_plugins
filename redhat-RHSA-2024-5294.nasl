...
# extracted from Red Hat Security Advisory RHSA-2024:5294. The text
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_5294.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fe71cb46");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:5294");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL jose package based on the guidance in RHSA-2024:5294.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jose-10-2.el8_10.3', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libjose-10-2.el8_10.3', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libjose-devel-10-2.el8_10.3', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
