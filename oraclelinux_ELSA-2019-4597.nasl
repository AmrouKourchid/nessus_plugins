...
# extracted from Oracle Linux Security Advisory ELSA-2019-4597.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : docker-engine (ELSA-2019-4597)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2019-4597.html");
...
var pkgs = [
    {'reference':'docker-engine-18.03.1.ol-0.0.14.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
];
