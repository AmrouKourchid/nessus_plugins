...
if (description)
{
  ...
  script_name(english:"Mozilla Firefox ESR 45.x < 45.9 Multiple Vulnerabilities (macOS)");
...
Mac OS X host is 45.x prior to 45.9. It is, therefore, affected by
...
mozilla_check_version(product:'firefox', version:version, path:path, esr:TRUE, fix:'45.9', min:'45.0', severity:SECURITY_HOLE);
