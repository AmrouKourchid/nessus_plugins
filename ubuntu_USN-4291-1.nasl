...
# extracted from Ubuntu Security Notice USN-4291-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"4291-1");

  script_name(english:"Ubuntu 18.04 LTS : mod-auth-mellon vulnerability (USN-4291-1)");
...
USN-4291-1 advisory.
    ...
    use this issue to redirect a user to a malicious URL.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4291-1");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'libapache2-mod-auth-mellon', 'pkgver': '0.13.1-1ubuntu0.2'}
];
