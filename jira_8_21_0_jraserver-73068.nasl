...
if (description)
{
  ...
  script_cve_id("CVE-2021-43942");

  script_name(english:"Atlassian Jira < 8.13.15 / 8.14.x < 8.20.3 / 8.21.0 XSS (JRASERVER-73068)");
...
therefore, affected by a vulnerability as referenced in the JRASERVER-73068 advisory.

  - Reflected XSS via /rest/collectors/1.0/template/custom - CVE-2021-43942 (CVE-2021-43942)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://jira.atlassian.com/browse/JRASERVER-73068");
...
"Upgrade to Atlassian Jira version 8.13.15, 8.20.3, 8.21.0 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-43942");
