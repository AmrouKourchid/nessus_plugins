...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2005/rhsa-2005_073.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f717b772");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2005:073");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=145725");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL cpio package based on the guidance in RHSA-2005:073.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:P/I:N/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:L/UI:N/S:U/C:H/I:H/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-1999-1572");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cpio-2.5-7.EL4.1', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'cpio-2.5-7.EL4.1', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'cpio-2.5-7.EL4.1', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'cpio-2.5-7.EL4.1', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'cpio-2.5-7.EL4.1', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
