...
# extracted from Fedora Security Advisory FEDORA-2023-f3824383be
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-f3824383be");

  script_name(english:"Fedora 38 : mingw-python-requests (2023-f3824383be)");
...
FEDORA-2023-f3824383be advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-f3824383be");
...
var pkgs = [
    {'reference':'mingw-python-requests-2.31.0-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
