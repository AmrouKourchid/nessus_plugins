...
if (description)
{
  ...
  script_cve_id("CVE-2025-1493");
  script_xref(name:"IAVB", value:"2025-B-0068");

  script_name(english:"IBM DB2 DoS (7232518) (Windows)");
...
"According to its self-reported version number, IBM Db2 on Windows may be affected by a vulnerability:
  ...
  - IBM Db2 for Linux, UNIX and Windows (includes Db2 Connect Server) could allow an authenticated user to 
    cause a denial of service due to concurrent execution of shared resources. (CVE-2025-1493)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/node/7232518");
...
"Apply the appropriate IBM DB2 Fix Pack or Special Build based on the most recent fix pack level for your branch.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-1493");
...
var constraints = [
  {'min_version':'12.1.0.0', 'fixed_version':'12.1.0.986', 'fixed_display':'12.1.0.986 Special Build 52131'},
  {'min_version':'12.1.1000.0', 'fixed_version':'12.1.1000.77', 'fixed_display':'12.1.1000.77 Special Build 54779'}
];
