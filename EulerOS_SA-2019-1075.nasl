...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : spice (EulerOS-SA-2019-1075)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1075
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e33266dd");
...
pkgs = ["spice-server-0.14.0-6.1.eulerosv2r7"];
