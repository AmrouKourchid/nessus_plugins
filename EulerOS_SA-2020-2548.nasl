...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : golang (EulerOS-SA-2020-2548)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2548
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8cb5f5a6");
...
pkgs = ["golang-1.13.3-9.eulerosv2r7",
        "golang-bin-1.13.3-9.eulerosv2r7",
        "golang-src-1.13.3-9.eulerosv2r7"];
