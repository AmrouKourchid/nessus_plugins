...
# extracted from Debian Security Advisory dla-2953. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2953-1 : openssl1.0 - LTS security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 9 host has packages installed that are affected by a vulnerability as referenced in the dla-2953
advisory.

    Tavis Ormandy discovered that the BN_mod_sqrt() function of OpenSSL could be tricked into an infinite
    loop. This could result in denial of service via malformed certificates. For Debian 9 stretch, this
    problem has been fixed in version 1.0.2u-1~deb9u7. We recommend that you upgrade your openssl1.0 packages.
    For the detailed security status of openssl1.0 please refer to its security tracker page at:
    https://security-tracker.debian.org/tracker/openssl1.0 Further information about Debian LTS security
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2022/dla-2953");
...
var pkgs = [
    {'release': '9.0', 'prefix': 'libssl1.0-dev', 'reference': '1.0.2u-1~deb9u7'},
    {'release': '9.0', 'prefix': 'libssl1.0.2', 'reference': '1.0.2u-1~deb9u7'}
];
