...
# extracted from Debian Security Advisory dla-3579. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3579 : elfutils - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3579
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2020-21047");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/elfutils");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'elfutils', 'reference': '0.176-1.1+deb10u1'},
    {'release': '10.0', 'prefix': 'libasm-dev', 'reference': '0.176-1.1+deb10u1'},
    {'release': '10.0', 'prefix': 'libasm1', 'reference': '0.176-1.1+deb10u1'},
    {'release': '10.0', 'prefix': 'libdw-dev', 'reference': '0.176-1.1+deb10u1'},
    {'release': '10.0', 'prefix': 'libdw1', 'reference': '0.176-1.1+deb10u1'},
    {'release': '10.0', 'prefix': 'libelf-dev', 'reference': '0.176-1.1+deb10u1'},
    {'release': '10.0', 'prefix': 'libelf1', 'reference': '0.176-1.1+deb10u1'}
];
