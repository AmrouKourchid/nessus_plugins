...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS : Waitress vulnerability (USN-5364-1)");
...
USN-5364-1 advisory.
    ...
    It was discovered that Waitress incorrectly handled certain requests. An attacker could possibly use this
