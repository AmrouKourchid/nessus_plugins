...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : ruby (EulerOS-SA-2024-2914)");
...
following vulnerabilities :
    ...
    REXML is an XML toolkit for Ruby.The REXML gem before 3.3.2 has some DoS vulnerabilities when it parses an
    XML that has many specific characters such as whitespace character, `]` and `]`.The REXML gem 3.3.3
    ...
    impacted to this vulnerability.The REXML gem 3.2.7 or later include the patch to fix this vulnerability.As
    a workaround, don't parse untrusted XMLs.(CVE-2024-35176)
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2914
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e77a3383");
...
var pkgs = [
  "ruby-2.5.8-112.h17.eulerosv2r10",
  "ruby-help-2.5.8-112.h17.eulerosv2r10",
  "ruby-irb-2.5.8-112.h17.eulerosv2r10"
];
