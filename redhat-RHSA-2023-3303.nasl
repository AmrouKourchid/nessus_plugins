...
# extracted from Red Hat Security Advisory RHSA-2023:3303. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2022-41724");
  script_xref(name:"RHSA", value:"2023:3303");

  script_name(english:"RHEL 8 / 9 : OpenShift Container Platform 4.13.1 (RHSA-2023:3303)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for OpenShift Container Platform 4.13.1.");
...
in the RHSA-2023:3303 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.13.1. See the following
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_3303.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2fa6bbf3");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:3303");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.13.1 packages based on the guidance in RHSA-2023:3303.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cri-o-1.26.3-6.rhaos4.13.gitb3475fb.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'cri-o-1.26.3-7.rhaos4.13.gitb3475fb.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
