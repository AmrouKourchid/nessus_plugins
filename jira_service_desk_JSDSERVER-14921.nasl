...
if (description)
{
  ...
  script_name(english:"Atlassian Jira Service Management Data Center and Server 4.20 < 4.20.28 / 5.4.x < 5.4.12 / 5.5.x < 5.11.3 / 5.12.0 (JSDSERVER-14921)");
...
host is affected by a vulnerability as referenced in the JSDSERVER-14921 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://jira.atlassian.com/browse/JSDSERVER-14921");
