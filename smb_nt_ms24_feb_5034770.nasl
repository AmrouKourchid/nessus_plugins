...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5034770");
  script_xref(name:"MSFT", value:"MS24-5034770");
  ...
  script_name(english:"KB5034770: Windows Server 2022 / Azure Stack HCI 22H2 Security Update (February 2024)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5034770");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5034860");
...
if (
  smb_check_rollup(os:'10',
                   ...
                   rollup_date:'02_2024',
                   bulletin:bulletin,
                   rollup_kb_list:[5034770, 5034860])
)
{
