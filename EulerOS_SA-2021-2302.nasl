...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : libtar (EulerOS-SA-2021-2302)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2302
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?46897469");
...
pkgs = ["libtar-1.2.20-15.h1.eulerosv2r8"];
