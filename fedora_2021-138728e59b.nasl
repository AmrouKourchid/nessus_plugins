...
# extracted from Fedora Security Advisory FEDORA-2021-138728e59b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-138728e59b");

  script_name(english:"Fedora 32 : dotnet5.0 (2021-138728e59b)");
...
FEDORA-2021-138728e59b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-138728e59b");
...
pkgs = [
    {'reference':'dotnet5.0-5.0.104-1.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE}
];
