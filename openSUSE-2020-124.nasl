...
"This update for apt-cacher-ng fixes the following issues :
  ...
  - CVE-2020-5202: Fixed an information leak if a local user
    ...
    (boo#1157706).");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1157703");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1157706");
  script_set_attribute(attribute:"solution", value:
"Update the affected apt-cacher-ng packages.");
