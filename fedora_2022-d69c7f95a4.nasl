...
# extracted from Fedora Security Advisory FEDORA-2022-d69c7f95a4
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-d69c7f95a4");

  script_name(english:"Fedora 37 : emacs (2022-d69c7f95a4)");
...
FEDORA-2022-d69c7f95a4 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-d69c7f95a4");
...
var pkgs = [
    {'reference':'emacs-28.2-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
