...
# extracted from Fedora Security Advisory FEDORA-2019-7b06f18a10.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : mod_auth_openidc (2019-7b06f18a10)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-7b06f18a10");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"mod_auth_openidc-2.4.0.3-1.fc30")) flag++;
