...
# extracted from Debian Security Advisory dsa-5778. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5778 : cups-browsed - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-47076");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-47176");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bookworm/cups-filters");
  script_set_attribute(attribute:"solution", value:
"Upgrade the cups-browsed packages.");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'cups-browsed', 'reference': '1.28.17-3+deb12u1'},
    {'release': '12.0', 'prefix': 'cups-filters', 'reference': '1.28.17-3+deb12u1'},
    {'release': '12.0', 'prefix': 'cups-filters-core-drivers', 'reference': '1.28.17-3+deb12u1'},
    {'release': '12.0', 'prefix': 'libcupsfilters-dev', 'reference': '1.28.17-3+deb12u1'},
    {'release': '12.0', 'prefix': 'libcupsfilters1', 'reference': '1.28.17-3+deb12u1'},
    {'release': '12.0', 'prefix': 'libfontembed-dev', 'reference': '1.28.17-3+deb12u1'},
    {'release': '12.0', 'prefix': 'libfontembed1', 'reference': '1.28.17-3+deb12u1'}
];
