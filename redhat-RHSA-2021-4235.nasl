...
# extracted from Red Hat Security Advisory RHSA-2021:4235. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:4235");

  script_name(english:"RHEL 8 : jasper (RHSA-2021:4235)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for jasper.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2021:4235 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_4235.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a7b96209");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:4235");
...
"Update the RHEL jasper package based on the guidance in RHSA-2021:4235.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jasper-devel-2.0.14-5.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'jasper-libs-2.0.14-5.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'jasper-devel / jasper-libs');
}
