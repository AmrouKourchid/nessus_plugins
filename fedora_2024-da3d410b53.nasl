...
# extracted from Fedora Security Advisory FEDORA-2024-da3d410b53
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-da3d410b53");

  script_name(english:"Fedora 39 : xorg-x11-server-Xwayland (2024-da3d410b53)");
...
FEDORA-2024-da3d410b53 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-da3d410b53");
...
var pkgs = [
    {'reference':'xorg-x11-server-Xwayland-23.2.4-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
