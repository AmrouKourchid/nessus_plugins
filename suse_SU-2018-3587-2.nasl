...
# extracted from SUSE update advisory SUSE-SU-2018:3587-2.
...
if (description)
{
  ...
  script_name(english:"SUSE SLED12 Security Update : ntfs-3g_ntfsprogs (SUSE-SU-2018:3587-2)");
...
without introducing additional issues.");
  ...
  # https://www.suse.com/support/update/announcement/2018/suse-su-20183587-2/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bcf23614");
...
SUSE-SLE-WE-12-SP4-2018-2543=1

SUSE Linux Enterprise Software Development Kit 12-SP4:zypper in -t
patch SUSE-SLE-SDK-12-SP4-2018-2543=1

SUSE Linux Enterprise Desktop 12-SP4:zypper in -t patch
SUSE-SLE-DESKTOP-12-SP4-2018-2543=1");
...
flag = 0;
if (rpm_check(release:"SLED12", sp:"4", cpu:"x86_64", reference:"libntfs-3g84-2013.1.13-5.3.1")) flag++;
if (rpm_check(release:"SLED12", sp:"4", cpu:"x86_64", reference:"libntfs-3g84-debuginfo-2013.1.13-5.3.1")) flag++;
if (rpm_check(release:"SLED12", sp:"4", cpu:"x86_64", reference:"ntfs-3g-2013.1.13-5.3.1")) flag++;
if (rpm_check(release:"SLED12", sp:"4", cpu:"x86_64", reference:"ntfs-3g-debuginfo-2013.1.13-5.3.1")) flag++;
if (rpm_check(release:"SLED12", sp:"4", cpu:"x86_64", reference:"ntfs-3g_ntfsprogs-debugsource-2013.1.13-5.3.1")) flag++;
if (rpm_check(release:"SLED12", sp:"4", cpu:"x86_64", reference:"ntfsprogs-2013.1.13-5.3.1")) flag++;
if (rpm_check(release:"SLED12", sp:"4", cpu:"x86_64", reference:"ntfsprogs-debuginfo-2013.1.13-5.3.1")) flag++;
