...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : python2 (EulerOS-SA-2019-1657)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1657
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c422b38f");
...
pkgs = ["python-unversioned-command-2.7.15-10.h5.eulerosv2r8",
        "python2-2.7.15-10.h5.eulerosv2r8",
        "python2-devel-2.7.15-10.h5.eulerosv2r8",
        "python2-libs-2.7.15-10.h5.eulerosv2r8"];
