...
# extracted from Fedora Security Advisory FEDORA-2023-78b4ce2f23
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-78b4ce2f23");
  script_xref(name:"IAVA", value:"2023-A-0061-S");

  script_name(english:"Fedora 36 : pypy3.8 (2023-78b4ce2f23)");
...
FEDORA-2023-78b4ce2f23 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-78b4ce2f23");
...
var pkgs = [
    {'reference':'pypy3.8-7.3.11-1.3.8.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
