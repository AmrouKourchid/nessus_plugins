...
if (description)
{
  ...
  script_cve_id("CVE-2021-47473");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2021-47473");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: scsi: qla2xxx: Fix a memory leak in an
    ...
    path of qla2x00_process_els()), intended to change: bsg_job->request->msgcode == FC_BSG_HST_ELS_NOLOGIN
    bsg_job->request->msgcode != FC_BSG_RPT_ELS but changed it to: bsg_job->request->msgcode == FC_BSG_RPT_ELS
    instead. Change the == to a != to avoid leaking the fcport structure or freeing unallocated memory.
    (CVE-2021-47473)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-47473");
