...
# extracted from Fedora Security Advisory FEDORA-2024-24e4bba70f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-24e4bba70f");

  script_name(english:"Fedora 38 : python-tqdm (2024-24e4bba70f)");
...
FEDORA-2024-24e4bba70f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-24e4bba70f");
...
var pkgs = [
    {'reference':'python-tqdm-4.66.4-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
