...
# extracted from Red Hat Security Advisory RHSA-2021:3947. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:3947");

  script_name(english:"RHEL 7 : rh-redis5-redis (RHSA-2021:3947)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for rh-redis5-redis.");
...
referenced in the RHSA-2021:3947 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_3947.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bfc6de48");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:3947");
...
"Update the RHEL rh-redis5-redis package based on the guidance in RHSA-2021:3947.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rh-redis5-redis");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-redis5-redis-5.0.5-3.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-redis5-redis-5.0.5-3.el7', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-redis5-redis-5.0.5-3.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'rh-redis5-redis');
}
