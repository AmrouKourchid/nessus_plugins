...
# extracted from Oracle Linux Security Advisory ELSA-2024-2550.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : buildah (ELSA-2024-2550)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-2550.html");
...
var pkgs = [
    {'reference':'buildah-1.33.7-1.0.1.el9_4', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'buildah-tests-1.33.7-1.0.1.el9_4', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'buildah-1.33.7-1.0.1.el9_4', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'buildah-tests-1.33.7-1.0.1.el9_4', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
