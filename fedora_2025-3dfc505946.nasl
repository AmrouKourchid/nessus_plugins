...
# extracted from Fedora Security Advisory FEDORA-2025-3dfc505946
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-3dfc505946");

  script_name(english:"Fedora 41 : rpm-ostree (2025-3dfc505946)");
...
FEDORA-2025-3dfc505946 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-3dfc505946");
...
var pkgs = [
    {'reference':'rpm-ostree-2025.5-2.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
