...
# extracted from Amazon Linux 2 Security Advisory ALAS-2020-1446.
#
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : python-urllib3 (ALAS-2020-1446)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of python-urllib3 installed on the remote host is prior to 1.25.7-1. It is, therefore, affected by a
vulnerability as referenced in the ALAS2-2020-1446 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2020-1446.html");
...
var pkgs = [
    {'reference':'python-urllib3-1.25.7-1.amzn2.0.1', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
