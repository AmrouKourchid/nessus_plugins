...
# extracted from Fedora Security Advisory FEDORA-2020-6f1209bb45.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-6f1209bb45");

  script_name(english:"Fedora 30 : libtiff (2020-6f1209bb45)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-6f1209bb45");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"libtiff-4.0.10-8.fc30")) flag++;
