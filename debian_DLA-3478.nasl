...
# extracted from Debian Security Advisory dla-3478. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3478 : libyajl-dev - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3478
advisory.

    -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3478-1                debian-lts@lists.debian.org
...
"Upgrade the libyajl-dev packages.");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libyajl-dev', 'reference': '2.1.0-2+deb10u1'},
    {'release': '10.0', 'prefix': 'libyajl-doc', 'reference': '2.1.0-2+deb10u1'},
    {'release': '10.0', 'prefix': 'libyajl2', 'reference': '2.1.0-2+deb10u1'},
    {'release': '10.0', 'prefix': 'yajl-tools', 'reference': '2.1.0-2+deb10u1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libyajl-dev / libyajl-doc / libyajl2 / yajl-tools');
}
