...
# Rocky Linux Security Advisory RLSA-2025:0845.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2025:0845");

  script_name(english:"RockyLinux 8 : git-lfs (RLSA-2025:0845)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2025:0845");
...
var pkgs = [
    {'reference':'git-lfs-3.4.1-4.el8_10', 'cpu':'aarch64', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'git-lfs-3.4.1-4.el8_10', 'cpu':'x86_64', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'git-lfs-debuginfo-3.4.1-4.el8_10', 'cpu':'aarch64', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'git-lfs-debuginfo-3.4.1-4.el8_10', 'cpu':'x86_64', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'git-lfs-debugsource-3.4.1-4.el8_10', 'cpu':'aarch64', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'git-lfs-debugsource-3.4.1-4.el8_10', 'cpu':'x86_64', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'}
];
