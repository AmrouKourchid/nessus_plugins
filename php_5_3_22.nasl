...
if (description)
{
  ...
  script_name(english:"PHP 5.3.x < 5.3.22 Multiple Vulnerabilities");
...
remote host is prior to 5.3.22.  It is, therefore, potentially 
...
but, instead relies only on PHP's self-reported version number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.php.net/ChangeLog-5.php#5.3.22");
...
if (version =~ "^5\.3\.([0-9]|1[0-9]|2[01])($|[^0-9])")
{
