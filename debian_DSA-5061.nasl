...
# extracted from Debian Security Advisory dsa-5061. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-5061-1 : wpewebkit - security update");
...
dsa-5061 advisory.
    ...
    The following vulnerabilities have been discovered in the wpewebkit web engine: CVE-2021-30934 Dani Biro
    discovered that processing maliciously crafted web content may lead to arbitrary code execution.
    CVE-2021-30936 Chijin Zhou discovered that processing maliciously crafted web content may lead to
    arbitrary code execution. CVE-2021-30951 Pangu discovered that processing maliciously crafted web content
    may lead to arbitrary code execution. CVE-2021-30952 WeBin discovered that processing maliciously crafted
    web content may lead to arbitrary code execution. CVE-2021-30953 VRIJ discovered that processing
    maliciously crafted web content may lead to arbitrary code execution. CVE-2021-30954 Kunlun Lab discovered
    that processing maliciously crafted web content may lead to arbitrary code execution. CVE-2021-30984
    Kunlun Lab discovered that processing maliciously crafted web content may lead to arbitrary code
    execution. For the stable distribution (bullseye), these problems have been fixed in version
    2.34.4-1~deb11u1. We recommend that you upgrade your wpewebkit packages. For the detailed security status
    of wpewebkit please refer to its security tracker page at: https://security-
    tracker.debian.org/tracker/wpewebkit
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2022/dsa-5061");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'libwpewebkit-1.0-3', 'reference': '2.34.4-1~deb11u1'},
    {'release': '11.0', 'prefix': 'libwpewebkit-1.0-dev', 'reference': '2.34.4-1~deb11u1'},
    {'release': '11.0', 'prefix': 'libwpewebkit-1.0-doc', 'reference': '2.34.4-1~deb11u1'},
    {'release': '11.0', 'prefix': 'wpewebkit-driver', 'reference': '2.34.4-1~deb11u1'}
];
