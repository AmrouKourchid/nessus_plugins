...
# extracted from Oracle Linux Security Advisory ELSA-2024-1644.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : grafana-pcp (ELSA-2024-1644)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-1644.html");
