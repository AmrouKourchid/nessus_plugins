...
# extracted from Ubuntu Security Notice USN-4655-1. The text
...
referenced in the USN-4655-1 advisory.
    ...
    It was discovered that Werkzeug has insufficient debugger PIN randomness. An attacker could use this issue
    to access sensitive information. This issue only affected Ubuntu 18.04 LTS. (CVE-2019-14806)

    It was discovered that Werkzeug incorrectly handled certain URLs. An attacker could possibly use this
    issue to cause pishing attacks. This issue only affected Ubuntu 16.04 LTS. (CVE-2020-28724)

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4655-1");
...
"Update the affected python-werkzeug and / or python3-werkzeug packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-28724");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2019-14806");
