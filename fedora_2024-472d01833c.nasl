...
# extracted from Fedora Security Advisory FEDORA-2024-472d01833c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-472d01833c");

  script_name(english:"Fedora 41 : webkitgtk (2024-472d01833c)");
...
FEDORA-2024-472d01833c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-472d01833c");
...
var pkgs = [
    {'reference':'webkitgtk-2.46.4-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
