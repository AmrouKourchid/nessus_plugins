...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : libarchive vulnerability (K50543013) (deprecated)");
...
no BIG-IP products are affected by this vulnerability in default, 
standard, or recommended configurations.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K50543013");
