...
# extracted from Red Hat Security Advisory RHSA-2025:3945. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:3945");

  script_name(english:"RHEL 9 : mod_auth_openidc (RHSA-2025:3945)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_3945.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7ebdab04");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:3945");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL mod_auth_openidc package based on the guidance in RHSA-2025:3945.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'mod_auth_openidc-2.4.9.4-1.el9_0.2', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
