...
# extracted from Red Hat Security Advisory rabbitmq-c_librabbitmq. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : rabbitmq-c_librabbitmq (Unpatched Vulnerability) (deprecated)");
