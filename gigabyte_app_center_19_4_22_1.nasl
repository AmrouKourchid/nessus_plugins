...
if (description)
{
  ...
  script_name(english:"GIGABYTE APP Center < 19.4.22.1 Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The GIGABYTE APP Center software installed on the remote host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of GIGABYTE APP Center installed on the remote host is prior to 19.4.22.1. It is, therefore, affected by
multiple vulnerabilities as referenced in GIGABYTE security advisory 1801:
    ...
    - An issue was discovered in gdrv.sys in Gigabyte APP Center before 19.0227.1. The vulnerable driver exposes a wrmsr
      instruction via IOCTL 0xC3502580 and does not properly filter the target Model Specific Register (MSR). Allowing
      arbitrary MSR writes can lead to Ring-0 code execution and escalation of privileges. (CVE-2019-7630)
...
"Upgrade to GIGABYTE APP Center B19.0422.1 or later.");
  script_set_attribute(attribute:"agent", value:"windows");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:S/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:H/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:H/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-7630");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2018-19323");
  ...
  script_set_attribute(attribute:"cpe", value:"cpe:/a:gigabyte:app_center");
  ...
  script_dependencies("gigabyte_app_center_win_installed.nbin");
...
var app = 'GIGABYTE APP CENTER';

var app_info = vcf::get_app_info(app:app, win_local:TRUE);

var constraints = [
  { 'fixed_version':'19.4.22.1' }
];
