...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : gtk2 (EulerOS-SA-2024-2438)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2438
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2da13010");
...
var pkgs = [
  "gtk2-2.24.32-8.h1.eulerosv2r10",
  "gtk2-devel-2.24.32-8.h1.eulerosv2r10",
  "gtk2-help-2.24.32-8.h1.eulerosv2r10"
];
