...
# extracted from openSUSE Security Update openSUSE-2020-870.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : mariadb (openSUSE-2020-870)");
...
mariadb was updated to version 10.2.32 (bsc#1171550)
  ...
  - CVE-2020-2752: Fixed an issue which could have resulted
    in unauthorized ability to cause denial of service.

  - CVE-2020-2812: Fixed an issue which could have resulted
    in unauthorized ability to cause denial of service. 

  - CVE-2020-2814: Fixed an issue which could have resulted
    in unauthorized ability to cause denial of service.

  - CVE-2020-2760: Fixed an issue which could have resulted
    in unauthorized ability to cause denial of service.

  - CVE-2020-13249: Fixed an improper validation of the
    content of an OK packet received from a server. 
...
This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1171550");
...
if ( rpm_check(release:"SUSE15.1", reference:"libmysqld-devel-10.2.32-lp151.2.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libmysqld19-10.2.32-lp151.2.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libmysqld19-debuginfo-10.2.32-lp151.2.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"mariadb-10.2.32-lp151.2.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"mariadb-bench-10.2.32-lp151.2.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"mariadb-bench-debuginfo-10.2.32-lp151.2.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"mariadb-client-10.2.32-lp151.2.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"mariadb-client-debuginfo-10.2.32-lp151.2.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"mariadb-debuginfo-10.2.32-lp151.2.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"mariadb-debugsource-10.2.32-lp151.2.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"mariadb-errormessages-10.2.32-lp151.2.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"mariadb-galera-10.2.32-lp151.2.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"mariadb-test-10.2.32-lp151.2.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"mariadb-test-debuginfo-10.2.32-lp151.2.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"mariadb-tools-10.2.32-lp151.2.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"mariadb-tools-debuginfo-10.2.32-lp151.2.15.1") ) flag++;
