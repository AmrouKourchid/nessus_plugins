...
# extracted from Fedora Security Advisory FEDORA-2024-9e85c72624
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-9e85c72624");

  script_name(english:"Fedora 41 : chromium (2024-9e85c72624)");
...
FEDORA-2024-9e85c72624 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-9e85c72624");
...
var pkgs = [
    {'reference':'chromium-128.0.6613.137-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
