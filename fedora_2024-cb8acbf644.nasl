...
# extracted from Fedora Security Advisory FEDORA-2024-cb8acbf644
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-cb8acbf644");

  script_name(english:"Fedora 40 : mod_http2 (2024-cb8acbf644)");
...
FEDORA-2024-cb8acbf644 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-cb8acbf644");
...
var pkgs = [
    {'reference':'mod_http2-2.0.29-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
