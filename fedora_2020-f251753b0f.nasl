...
# extracted from Fedora Security Advisory FEDORA-2020-f251753b0f.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : lynis (2020-f251753b0f)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-f251753b0f");
...
flag = 0;
if (rpm_check(release:"FC32", reference:"lynis-3.0.0-1.fc32")) flag++;
