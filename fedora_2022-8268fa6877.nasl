...
# extracted from Fedora Security Advisory FEDORA-2022-8268fa6877
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-8268fa6877");

  script_name(english:"Fedora 36 : snapd (2022-8268fa6877)");
...
FEDORA-2022-8268fa6877 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-8268fa6877");
  script_set_attribute(attribute:"solution", value:
"Update the affected snapd package.");
...
var pkgs = [
    {'reference':'snapd-2.57.6-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
