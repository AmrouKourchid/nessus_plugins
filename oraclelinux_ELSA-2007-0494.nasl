...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : Important: / kdebase (ELSA-2007-0494)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2007-0494.html");
...
"Update the affected kdebase and / or kdebase-devel packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2007-2022");
...
var pkgs = [
    {'reference':'kdebase-3.5.4-13.6.el5.0.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'6'},
    {'reference':'kdebase-devel-3.5.4-13.6.el5.0.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'6'},
    {'reference':'kdebase-3.5.4-13.6.el5.0.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'6'},
    {'reference':'kdebase-devel-3.5.4-13.6.el5.0.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'6'}
];
