...
# extracted from Fedora Security Advisory FEDORA-2024-94e0390e4e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-94e0390e4e");

  script_name(english:"Fedora 38 : mingw-python3 (2024-94e0390e4e)");
...
FEDORA-2024-94e0390e4e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-94e0390e4e");
...
var pkgs = [
    {'reference':'mingw-python3-3.11.8-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
