...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Ntp PHSA-2023-4.0-0417");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'ntp-4.2.8p16-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'ntp-perl-4.2.8p16-1.ph4')) flag++;
