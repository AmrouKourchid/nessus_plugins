...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : yajl (EulerOS-SA-2022-2812)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the yajl packages installed, the EulerOS installation on the remote host is affected by the
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2812
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5639fbb7");
...
"Update the affected yajl packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:yajl-devel");
...
var pkgs = [
  "yajl-2.1.0-11.h5.eulerosv2r8",
  "yajl-devel-2.1.0-11.h5.eulerosv2r8"
];
