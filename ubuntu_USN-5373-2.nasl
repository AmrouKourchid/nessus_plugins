...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 ESM : Django vulnerabilities (USN-5373-2)");
...
the USN-5373-2 advisory.

    USN-5373-1 fixed several vulnerabilities in Django. This update provides the corresponding update for
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'python-django', 'pkgver': '1.8.7-1ubuntu5.15+esm5', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'python-django-common', 'pkgver': '1.8.7-1ubuntu5.15+esm5', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'python3-django', 'pkgver': '1.8.7-1ubuntu5.15+esm5', 'ubuntu_pro': TRUE}
];
