...
# extracted from Fedora Security Advisory FEDORA-2024-12edb9dec8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-12edb9dec8");

  script_name(english:"Fedora 39 : chromium (2024-12edb9dec8)");
...
FEDORA-2024-12edb9dec8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-12edb9dec8");
...
var pkgs = [
    {'reference':'chromium-124.0.6367.60-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
