...
# extracted from Debian Security Advisory dsa-5672. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5672 : openjdk-17-dbg - security update");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'openjdk-17-dbg', 'reference': '17.0.11+9-1~deb11u1'},
    {'release': '11.0', 'prefix': 'openjdk-17-demo', 'reference': '17.0.11+9-1~deb11u1'},
    {'release': '11.0', 'prefix': 'openjdk-17-jdk', 'reference': '17.0.11+9-1~deb11u1'},
    {'release': '11.0', 'prefix': 'openjdk-17-jdk-headless', 'reference': '17.0.11+9-1~deb11u1'},
    {'release': '11.0', 'prefix': 'openjdk-17-jre', 'reference': '17.0.11+9-1~deb11u1'},
    {'release': '11.0', 'prefix': 'openjdk-17-jre-headless', 'reference': '17.0.11+9-1~deb11u1'},
    {'release': '11.0', 'prefix': 'openjdk-17-jre-zero', 'reference': '17.0.11+9-1~deb11u1'},
    {'release': '12.0', 'prefix': 'openjdk-17-dbg', 'reference': '17.0.11+9-1~deb12u1'},
    {'release': '12.0', 'prefix': 'openjdk-17-demo', 'reference': '17.0.11+9-1~deb12u1'},
    {'release': '12.0', 'prefix': 'openjdk-17-jdk', 'reference': '17.0.11+9-1~deb12u1'},
    {'release': '12.0', 'prefix': 'openjdk-17-jdk-headless', 'reference': '17.0.11+9-1~deb12u1'},
    {'release': '12.0', 'prefix': 'openjdk-17-jre', 'reference': '17.0.11+9-1~deb12u1'},
    {'release': '12.0', 'prefix': 'openjdk-17-jre-headless', 'reference': '17.0.11+9-1~deb12u1'},
    {'release': '12.0', 'prefix': 'openjdk-17-jre-zero', 'reference': '17.0.11+9-1~deb12u1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'openjdk-17-dbg / openjdk-17-demo / openjdk-17-jdk / etc');
}
