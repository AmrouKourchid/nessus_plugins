...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Nodejs PHSA-2020-1.0-0312");
...
if (rpm_check(release:"PhotonOS-1.0", cpu:"x86_64", reference:"nodejs-8.11.4-6.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", cpu:"x86_64", reference:"nodejs-devel-8.11.4-6.ph1")) flag++;
