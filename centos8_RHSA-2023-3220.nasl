...
# Red Hat Security Advisory RHSA-2023:3220. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : firefox (CESA-2023:3220)");
...
var pkgs = [
    {'reference':'firefox-102.11.0-2.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-102.11.0-2.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
