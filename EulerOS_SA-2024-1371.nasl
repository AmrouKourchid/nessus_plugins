...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : shim (EulerOS-SA-2024-1371)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1371
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f48af48e");
...
var pkgs = [
  "shim-15-20.h15.eulerosv2r10",
  "shim-aa64-storage-15-20.h15.eulerosv2r10"
];
