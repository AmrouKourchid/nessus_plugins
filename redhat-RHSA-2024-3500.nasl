...
# extracted from Red Hat Security Advisory RHSA-2024:3500. The text
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_3500.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5a145967");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:3500");
...
"Update the RHEL ruby:3.0 package based on the guidance in RHSA-2024:3500.");
  ...
  script_cwe_id(20, 94, 113, 125, 126);
  ...
  'ruby:3.0': [
    {
      ...
      'pkgs': [
        {'reference':'ruby-3.0.7-143.module+el8.10.0+21858+d19f3934', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ruby-default-gems-3.0.7-143.module+el8.10.0+21858+d19f3934', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ruby-devel-3.0.7-143.module+el8.10.0+21858+d19f3934', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ruby-doc-3.0.7-143.module+el8.10.0+21858+d19f3934', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ruby-libs-3.0.7-143.module+el8.10.0+21858+d19f3934', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-abrt-0.4.0-1.module+el8.10.0+21858+d19f3934', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-abrt-doc-0.4.0-1.module+el8.10.0+21858+d19f3934', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-bigdecimal-3.0.0-143.module+el8.10.0+21858+d19f3934', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-bundler-2.2.33-143.module+el8.10.0+21858+d19f3934', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-io-console-0.5.7-143.module+el8.10.0+21858+d19f3934', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-irb-1.3.5-143.module+el8.10.0+21858+d19f3934', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-json-2.5.1-143.module+el8.10.0+21858+d19f3934', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-minitest-5.14.2-143.module+el8.10.0+21858+d19f3934', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-mysql2-0.5.3-2.module+el8.10.0+21858+d19f3934', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-mysql2-doc-0.5.3-2.module+el8.10.0+21858+d19f3934', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-pg-1.2.3-1.module+el8.10.0+21858+d19f3934', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-pg-doc-1.2.3-1.module+el8.10.0+21858+d19f3934', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-power_assert-1.2.1-143.module+el8.10.0+21858+d19f3934', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-psych-3.3.2-143.module+el8.10.0+21858+d19f3934', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-rake-13.0.3-143.module+el8.10.0+21858+d19f3934', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-rbs-1.4.0-143.module+el8.10.0+21858+d19f3934', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-rdoc-6.3.4.1-143.module+el8.10.0+21858+d19f3934', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-rexml-3.2.5-143.module+el8.10.0+21858+d19f3934', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-rss-0.2.9-143.module+el8.10.0+21858+d19f3934', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-test-unit-3.3.7-143.module+el8.10.0+21858+d19f3934', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-typeprof-0.15.2-143.module+el8.10.0+21858+d19f3934', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygems-3.2.33-143.module+el8.10.0+21858+d19f3934', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygems-devel-3.2.33-143.module+el8.10.0+21858+d19f3934', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
