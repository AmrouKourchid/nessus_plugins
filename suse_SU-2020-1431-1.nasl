...
# extracted from SUSE update advisory SUSE-SU-2020:1431-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : mariadb-connector-c (SUSE-SU-2020:1431-1)");
...
without introducing additional issues.");
  ...
  # https://www.suse.com/support/update/announcement/2020/suse-su-20201431-1/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dba4bbbd");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"4", reference:"libmariadb3-3.1.8-2.15.1")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libmariadb3-debuginfo-3.1.8-2.15.1")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libmariadb_plugins-3.1.8-2.15.1")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libmariadb_plugins-debuginfo-3.1.8-2.15.1")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"mariadb-connector-c-debugsource-3.1.8-2.15.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libmariadb3-3.1.8-2.15.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libmariadb3-debuginfo-3.1.8-2.15.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libmariadb_plugins-3.1.8-2.15.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libmariadb_plugins-debuginfo-3.1.8-2.15.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"mariadb-connector-c-debugsource-3.1.8-2.15.1")) flag++;
