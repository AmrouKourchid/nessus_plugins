...
# extracted from Fedora Security Advisory FEDORA-2023-606f830772
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-606f830772");

  script_name(english:"Fedora 39 : httpd (2023-606f830772)");
...
FEDORA-2023-606f830772 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-606f830772");
...
var pkgs = [
    {'reference':'httpd-2.4.58-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
