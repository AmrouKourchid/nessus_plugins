...
# extracted from Red Hat Security Advisory RHSA-2023:3811. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:3811");
  script_xref(name:"IAVA", value:"2023-A-0118-S");
  script_xref(name:"IAVA", value:"2023-A-0283-S");

  script_name(english:"RHEL 8 : python39:3.9 and python39-devel:3.9 (RHSA-2023:3811)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_3811.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c0c0ef6e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2173917");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:3811");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python39:3.9 / python39-devel:3.9 packages based on the guidance in RHSA-2023:3811.");
  ...
  'python39:3.9': [
    {
      ...
      'pkgs': [
        {'reference':'python39-3.9.16-1.module+el8.8.0+18968+3d7b19f0.1', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'python39-devel-3.9.16-1.module+el8.8.0+18968+3d7b19f0.1', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python39-idle-3.9.16-1.module+el8.8.0+18968+3d7b19f0.1', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python39-idna-2.10-3.module+el8.4.0+9822+20bf1249', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python39-libs-3.9.16-1.module+el8.8.0+18968+3d7b19f0.1', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'python39-rpm-macros-3.9.16-1.module+el8.8.0+18968+3d7b19f0.1', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'python39-test-3.9.16-1.module+el8.8.0+18968+3d7b19f0.1', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python39-tkinter-3.9.16-1.module+el8.8.0+18968+3d7b19f0.1', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE},
    ...
    },
    {
      ...
      'pkgs': [
        {'reference':'python39-3.9.16-1.module+el8.8.0+18968+3d7b19f0.1', 'sp':'8', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'python39-devel-3.9.16-1.module+el8.8.0+18968+3d7b19f0.1', 'sp':'8', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python39-idle-3.9.16-1.module+el8.8.0+18968+3d7b19f0.1', 'sp':'8', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python39-idna-2.10-3.module+el8.4.0+9822+20bf1249', 'sp':'8', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python39-libs-3.9.16-1.module+el8.8.0+18968+3d7b19f0.1', 'sp':'8', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'python39-rpm-macros-3.9.16-1.module+el8.8.0+18968+3d7b19f0.1', 'sp':'8', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'python39-test-3.9.16-1.module+el8.8.0+18968+3d7b19f0.1', 'sp':'8', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python39-tkinter-3.9.16-1.module+el8.8.0+18968+3d7b19f0.1', 'sp':'8', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE},
  ...
  'python39-devel:3.9': [
    {
      ...
      'pkgs': [
        ...
        {'reference':'python39-debug-3.9.16-1.module+el8.8.0+18968+3d7b19f0.1', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE},
    ...
    },
    {
      ...
      'pkgs': [
        ...
        {'reference':'python39-debug-3.9.16-1.module+el8.8.0+18968+3d7b19f0.1', 'sp':'8', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE},
