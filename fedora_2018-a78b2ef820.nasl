...
# extracted from Fedora Security Advisory FEDORA-2018-a78b2ef820.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-a78b2ef820");

  script_name(english:"Fedora 29 : nss (2018-a78b2ef820)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"Updates the nss package to upstream NSS 3.40.1.

This is a point release after 3.40, with a security fix for
CVE-2018-12404.

For details about other new functionality and a list of bugs fixed in
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-a78b2ef820");
  # https://developer.mozilla.org/en-US/docs/Mozilla/Projects/NSS/NSS_3.40_release_notes
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?df399827");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"nss-3.40.1-1.0.fc29")) flag++;
