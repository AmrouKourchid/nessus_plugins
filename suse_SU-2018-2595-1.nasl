...
# extracted from SUSE update advisory SUSE-SU-2018:2595-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLED12 / SLES12 Security Update : spice (SUSE-SU-2018:2595-1)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f064c95b");
...
patch SUSE-SLE-SDK-12-SP3-2018-1825=1

SUSE Linux Enterprise Server 12-SP3:zypper in -t patch
SUSE-SLE-SERVER-12-SP3-2018-1825=1

SUSE Linux Enterprise Desktop 12-SP3:zypper in -t patch
SUSE-SLE-DESKTOP-12-SP3-2018-1825=1");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"3", reference:"libspice-server1-0.12.8-6.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"libspice-server1-debuginfo-0.12.8-6.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"spice-debugsource-0.12.8-6.1")) flag++;
if (rpm_check(release:"SLED12", sp:"3", cpu:"x86_64", reference:"libspice-server1-0.12.8-6.1")) flag++;
if (rpm_check(release:"SLED12", sp:"3", cpu:"x86_64", reference:"libspice-server1-debuginfo-0.12.8-6.1")) flag++;
if (rpm_check(release:"SLED12", sp:"3", cpu:"x86_64", reference:"spice-debugsource-0.12.8-6.1")) flag++;
