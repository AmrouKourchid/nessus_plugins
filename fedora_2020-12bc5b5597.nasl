...
# extracted from Fedora Security Advisory FEDORA-2020-12bc5b5597.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-12bc5b5597");

  script_name(english:"Fedora 31 : golang (2020-12bc5b5597)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-12bc5b5597");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"golang-1.13.9-1.fc31")) flag++;
