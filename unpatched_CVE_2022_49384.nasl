...
if (description)
{
  ...
  script_cve_id("CVE-2022-49384");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-49384");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: md: fix double free of io_acct_set
    bioset Now io_acct_set is alloc and free in personality. Remove the codes that free io_acct_set in md_free
    and md_stop. (CVE-2022-49384)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-49384");
