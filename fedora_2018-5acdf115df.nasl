...
# extracted from Fedora Security Advisory FEDORA-2018-5acdf115df.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : mosquitto (2018-5acdf115df)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-5acdf115df");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"mosquitto-1.5.5-1.fc28")) flag++;
