...
# extracted from Oracle Linux Security Advisory ELSA-2022-0441.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : aide (ELSA-2022-0441)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2022-0441.html");
