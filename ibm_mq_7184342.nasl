...
if (description)
{
  ...
  script_cve_id("CVE-2025-0975");
  script_xref(name:"IAVA", value:"2025-A-0144");

  script_name(english:"IBM MQ Command Injection (7184342)");

  script_set_attribute(attribute:"synopsis", value:
"The remote web server is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of IBM MQ Server running on the remote host is affected by a vulnerability as referenced in the 7184342
advisory.

  - IBM MQ 9.3 LTS, 9.3 CD, 9.4 LTS, and 9.4 CD console could allow an authenticated user to execute code due 
    to improper neutralization of escape characters. (CVE-2025-0975)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/node/7184342");
...
"Upgrade to IBM MQ 9.1.0.27 LTS, 9.2.0.31 LTS, 9.3.0.27 LTS, 9.4.0.10 LTS, 9.4.2 CD or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-0975");
