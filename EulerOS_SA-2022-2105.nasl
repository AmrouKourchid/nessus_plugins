...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.0 : zlib (EulerOS-SA-2022-2105)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the zlib packages installed, the EulerOS Virtualization installation on the remote host is
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2105
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6d959c1d");
...
"Update the affected zlib packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:zlib-help");
...
var pkgs = [
  "zlib-1.2.11-17.h2.eulerosv2r10",
  "zlib-devel-1.2.11-17.h2.eulerosv2r10",
  "zlib-help-1.2.11-17.h2.eulerosv2r10"
];
