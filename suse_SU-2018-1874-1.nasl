...
# extracted from SUSE update advisory SUSE-SU-2018:1874-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLED15 / SLES15 Security Update : zsh (SUSE-SU-2018:1874-1)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=1089030");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b9ebd4e0");
...
SUSE-SLE-Module-Basesystem-15-2018-1268=1");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:L/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-1100");
...
flag = 0;
if (rpm_check(release:"SLES15", sp:"0", reference:"zsh-5.5-3.3.15")) flag++;
if (rpm_check(release:"SLES15", sp:"0", reference:"zsh-debuginfo-5.5-3.3.15")) flag++;
if (rpm_check(release:"SLES15", sp:"0", reference:"zsh-debugsource-5.5-3.3.15")) flag++;
if (rpm_check(release:"SLED15", sp:"0", reference:"zsh-5.5-3.3.15")) flag++;
if (rpm_check(release:"SLED15", sp:"0", reference:"zsh-debuginfo-5.5-3.3.15")) flag++;
if (rpm_check(release:"SLED15", sp:"0", reference:"zsh-debugsource-5.5-3.3.15")) flag++;
