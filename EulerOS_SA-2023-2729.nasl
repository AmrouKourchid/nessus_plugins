...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.1 : libtiff (EulerOS-SA-2023-2729)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2729
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6d6e981e");
...
var pkgs = [
  "libtiff-4.3.0-9.h15.eulerosv2r11"
];
