...
# extracted from Amazon Linux AMI Security Advisory ALAS-2023-1866.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux AMI : amazon-ssm-agent (ALAS-2023-1866)");
...
multiple vulnerabilities as referenced in the ALAS-2023-1866 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/ALAS-2023-1866.html");
...
var pkgs = [
    {'reference':'amazon-ssm-agent-3.2.1705.0-1.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'amazon-ssm-agent-debuginfo-3.2.1705.0-1.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE}
];
