...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : wget (EulerOS-SA-2019-1691)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1691
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?78518d1a");
...
pkgs = ["wget-1.14-15.1.h6.eulerosv2r7"];
