...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.6.0 : compat-openssl10 (EulerOS-SA-2020-1333)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1333
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0f6568af");
...
pkgs = ["compat-openssl10-1.0.2o-3.h9.eulerosv2r8"];
