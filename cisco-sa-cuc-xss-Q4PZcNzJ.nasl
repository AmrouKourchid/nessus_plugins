...
if (description)
{
  ...
  script_cve_id("CVE-2021-1380", "CVE-2021-1409");
  ...
  script_name(english:"Cisco Unity Connection XSS (cisco-sa-cucm-xss-Q4PZcNzJ)");

  script_set_attribute(attribute:"synopsis", value:
"The remote device is missing a vendor-supplied security patch");
  script_set_attribute(attribute:"description", value:
"The Cisco Unity Connection installed on the remote host is prior to version 14. It is, therefore, affected by multiple
cross-site Scripting vulnerabilities.

Multiple vulnerabilities in the web-based management interface of Cisco Unity Connection could allow an 
unauthenticated, remote attacker to conduct an XSS attack against an interface user. An attacker could exploit this
vulnerability by persuading an interface user to click a crafted link. A successful exploit could allow the attacker
to execute arbitrary script code in the context of the affected interface or access sensitive browser-based
information.

Note that Nessus has not tested formthis issue but has instead relied only on the application's self-reported version
number.");
...
"Upgrade to the relevant fixed version referenced in Cisco bug IDs CSCvu52262, CSCvv35159, CSCvw71918, CSCvx14158,
CSCvx14178");
...
# https://software.cisco.com/download/home/286328409/type/286319533/release/14
var constraints = [{ 'fixed_version' : '14.0.1.10000.19'}];
