...
# extracted from Fedora Security Advisory FEDORA-2023-690e150a39
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-690e150a39");
  script_xref(name:"IAVA", value:"2023-A-0283-S");

  script_name(english:"Fedora 38 : pypy (2023-690e150a39)");
...
FEDORA-2023-690e150a39 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-690e150a39");
...
var pkgs = [
    {'reference':'pypy-7.3.11-3.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
