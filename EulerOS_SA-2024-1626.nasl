...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.0 : gnutls (EulerOS-SA-2024-1626)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1626
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?581ee0f1");
...
var pkgs = [
  "gnutls-3.7.2-2.h26.eulerosv2r11",
  "gnutls-utils-3.7.2-2.h26.eulerosv2r11"
];
