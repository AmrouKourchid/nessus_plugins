...
if (description)
{
  ...
  script_cve_id("CVE-2012-0815");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2012-0815");
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"vuln_publication_date", value:"2012/04/03");
