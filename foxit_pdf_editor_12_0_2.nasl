...
if (description)
{
  ...
  script_name(english:"Foxit PDF Editor < 12.0.2 Multiple Vulnerabilities");
...
"Upgrade to Foxit PDF Editor version 12.0.2 or later");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:N/UI:R/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-43641");
...
var constraints = [
  { 'max_version' : '10.1.9.37808', 'fixed_version' : '12.0.2' },
  { 'min_version' : '11.0', 'max_version' : '11.2.3.53593', 'fixed_version' : '12.0.2' },
  { 'min_version' : '12.0.0.12394', 'fixed_version' : '12.0.2' },
  { 'min_version' : '12.0.1.12430', 'fixed_version' : '12.0.2' }
];
