...
"The remote Red Hat host is missing a security update for scsi-target-utils.");
...
in the RHSA-2011:0332 advisory.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2011/rhsa-2011_0332.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?00aee12e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=667261");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2011:0332");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL scsi-target-utils package based on the guidance in RHSA-2011:0332.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2011-0001");
...
var constraints = [
  {
    'repo_relative_urls': [
      'content/dist/rhel/power/5/5Server/ppc/resilientstorage/debug',
      'content/dist/rhel/power/5/5Server/ppc/resilientstorage/os',
      'content/dist/rhel/power/5/5Server/ppc/resilientstorage/source/SRPMS',
    ...
    'pkgs': [
      {'reference':'scsi-target-utils-1.0.8-0.el5_6.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'scsi-target-utils-1.0.8-0.el5_6.1', 'cpu':'ppc', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'scsi-target-utils-1.0.8-0.el5_6.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'scsi-target-utils-1.0.4-3.el6_0.1', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'scsi-target-utils-1.0.4-3.el6_0.1', 'cpu':'ppc64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'scsi-target-utils-1.0.4-3.el6_0.1', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
