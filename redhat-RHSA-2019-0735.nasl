...
if (description)
{
  ...
  script_name(english:"RHEL 7 : katello-installer-base (RHSA-2019:0735)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_0735.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9169baba");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:0735");
...
"Update the RHEL katello-installer-base package based on the guidance in RHSA-2019:0735.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'katello-installer-base-3.7.0.19-1.el7sat', 'release':'7', 'el_string':'el7sat', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'satellite-6'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'katello-installer-base');
}
