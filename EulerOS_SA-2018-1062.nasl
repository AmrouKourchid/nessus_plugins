...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP1 : binutils (EulerOS-SA-2018-1062)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1062
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2a45e27e");
...
"Update the affected binutils packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-6323");
