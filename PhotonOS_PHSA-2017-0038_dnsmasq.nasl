...
if (description)
{
  ...
  script_cve_id("CVE-2017-13704");
  script_xref(name:"IAVA", value:"2017-A-0284-S");

  script_name(english:"Photon OS 1.0: Dnsmasq PHSA-2017-0038");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-13704");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'dnsmasq-2.76-3.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'dnsmasq-debuginfo-2.76-3.ph1')) flag++;
