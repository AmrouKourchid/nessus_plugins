...
if (description)
{
  ...
  script_name(english:"Adobe FrameMaker 2019 < 15.0.7 (2019.0.7) Arbitrary Code Execution (APSB20-54)");

  script_set_attribute(attribute:"synopsis", value:
"The remote install of Adobe FrameMaker has multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe FrameMaker installed on the remote Windows host is prior to Adobe FrameMaker 2019 15.0.7. It is,
therefore, affected by multiple vulnerabilities as referenced in the apsb20-54 advisory.

  - Adobe FrameMaker version 2019.0.6 (and earlier versions) lacks proper validation of the length of user-
    supplied data prior to copying it to a fixed-length stack-based buffer. This could be exploited to execute
    arbitrary code with the privileges of the current user. User interaction is required to exploit this
    vulnerability in that the target must open a malicious FrameMaker file. (CVE-2020-9725)

  - Adobe FrameMaker version 2019.0.6 (and earlier versions) has an out-of-bounds read vulnerability that
    ...
    this vulnerability in that the target must visit a malicious page or open a malicious FrameMaker file.
    (CVE-2020-9726)
...
"Upgrade to Adobe FrameMaker 2019.0.7 or later.");
...
var constraints = [
  { 'fixed_version' : '15.0.7', 'fixed_display' : '15.0.7 (aka 2019.0.7)' }
];
