...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : Linux kernel (Xenial HWE) vulnerabilities (USN-3099-2)");
...
the USN-3099-2 advisory.

    USN-3099-1 fixed vulnerabilities in the Linux kernel for Ubuntu 16.04 LTS. This update provides the
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3099-2");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-3099-2');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2016-6480', 'CVE-2016-6828', 'CVE-2016-7039');
