...
# extracted from Red Hat Security Advisory RHSA-2025:7043. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2024-28047", "CVE-2024-31157", "CVE-2024-39279");
  script_xref(name:"RHSA", value:"2025:7043");

  script_name(english:"RHEL 9 : microcode_ctl (RHSA-2025:7043)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for microcode_ctl.");
...
referenced in the RHSA-2025:7043 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2345363");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2345381");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2345421");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-67336");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_7043.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fe139c46");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:7043");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL microcode_ctl package based on the guidance in RHSA-2025:7043.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-31157");
  script_set_attribute(attribute:"cvss4_score_source", value:"CVE-2024-39279");

  script_set_attribute(attribute:"exploitability_ease", value:"No known exploits are available");
  script_set_attribute(attribute:"exploit_available", value:"false");
  script_cwe_id(20, 665, 1220);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'microcode_ctl-20250211-1.el9_6', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'}
    ]
  }
];
