...
# extracted from openSUSE Security Update openSUSE-2020-912.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : unbound (openSUSE-2020-912)");
...
project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1157268");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1171889");
...
if ( rpm_check(release:"SUSE15.1", reference:"libunbound-devel-mini-1.6.8-lp151.8.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libunbound-devel-mini-debuginfo-1.6.8-lp151.8.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libunbound-devel-mini-debugsource-1.6.8-lp151.8.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"unbound-munin-1.6.8-lp151.8.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libunbound2-1.6.8-lp151.8.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libunbound2-debuginfo-1.6.8-lp151.8.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"unbound-1.6.8-lp151.8.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"unbound-anchor-1.6.8-lp151.8.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"unbound-anchor-debuginfo-1.6.8-lp151.8.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"unbound-debuginfo-1.6.8-lp151.8.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"unbound-debugsource-1.6.8-lp151.8.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"unbound-devel-1.6.8-lp151.8.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"unbound-python-1.6.8-lp151.8.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"unbound-python-debuginfo-1.6.8-lp151.8.3.1") ) flag++;
