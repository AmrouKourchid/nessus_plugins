...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : busybox (EulerOS-SA-2022-1988)");
...
the following vulnerabilities :
  ...
  - BusyBox through 1.35.0 allows remote attackers to execute arbitrary code if netstat is used to print a DNS
    PTR record's value to a VT compatible terminal. Alternatively, the attacker could choose to change the
    terminal's colors. (CVE-2022-28391)

Note that Tenable Network Security has extracted the preceding description block directly from the EulerOS security
advisory. Tenable has attempted to automatically clean and format it as much as possible without introducing additional
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1988
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7100c2c6");
...
var pkgs = [
  "busybox-help-1.31.1-6.h3.r3.eulerosv2r9"
];
