...
if (description)
{
  ...
  script_cve_id("CVE-2021-47359");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2021-47359");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: cifs: Fix soft lockup during fsstress
    Below traces are observed during fsstress and system got hung. [ 130.698396] watchdog: BUG: soft lockup -
    CPU#6 stuck for 26s! (CVE-2021-47359)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-47359");
