...
"The version of Google Chrome installed on the remote Windows host is prior to 125.0.6422.60. It is, therefore, affected
by multiple vulnerabilities as referenced in the 2024_05_stable-channel-update-for-desktop_15 advisory.
...
google_chrome_check_version(installs:installs, fix:'125.0.6422.60', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
