...
# extracted from Red Hat Security Advisory RHSA-2020:0513. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 6 : flash-plugin (RHSA-2020:0513)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_0513.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2f33fd57");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#critical");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:0513");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1801792");
...
"Update the RHEL flash-plugin package based on the guidance in RHSA-2020:0513.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'flash-plugin-32.0.0.330-1.el6_10', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
