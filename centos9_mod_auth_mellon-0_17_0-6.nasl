...
if (description)
{
  ...
  script_name(english:"CentOS 9 : mod_auth_mellon-0.17.0-6.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update for mod_auth_mellon.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 9 host has packages installed that are affected by a vulnerability as referenced in the
mod_auth_mellon-0.17.0-6.el9 build changelog.

  - Open Redirect vulnerability in logout URLs (CVE-2021-3639)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=13882");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream mod_auth_mellon package.");
...
var pkgs = [
    {'reference':'mod_auth_mellon-0.17.0-6.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'mod_auth_mellon-diagnostics-0.17.0-6.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
