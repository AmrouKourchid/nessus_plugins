...
# extracted from Red Hat Security Advisory RHSA-2023:6492. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:6492");

  script_name(english:"RHEL 9 : tang (RHSA-2023:6492)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6492.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ac92a25b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2180999");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6492");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL tang package based on the guidance in RHSA-2023:6492.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'tang-14-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
