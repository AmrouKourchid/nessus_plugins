...
# SUSE update advisory SUSE-SU-2022:4560-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:4560-1");

  script_name(english:"SUSE SLES15 Security Update : kernel (Live Patch 4 for SLE 15 SP4) (SUSE-SU-2022:4560-1)");
...
referenced in the SUSE-SU-2022:4560-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://lists.suse.com/pipermail/sle-updates/2022-December/026940.html");
...
var kernel_live_checks = [
  {
    'kernels': {
      '5.14.21-150400.24.28-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_14_21-150400_24_28-default-3-150400.2.1', 'sp':'4', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.4']},
          {'reference':'kernel-livepatch-5_14_21-150400_24_28-default-3-150400.2.1', 'sp':'4', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.4', 'sle-module-live-patching-release-15.4', 'sles-release-15.4']}
        ]
      }
    }
  }
