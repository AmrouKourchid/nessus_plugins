...
# extracted from Ubuntu Security Notice USN-2838-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"2838-1");

  script_name(english:"Ubuntu 14.04 LTS : cups-filters vulnerability (USN-2838-1)");
...
USN-2838-1 advisory.
    ...
    Adam Chester discovered that the cups-filters foomatic-rip filter incorrectly stripped shell escape
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2838-1");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-8560");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'cups-browsed', 'pkgver': '1.0.52-0ubuntu1.7'},
    {'osver': '14.04', 'pkgname': 'cups-filters', 'pkgver': '1.0.52-0ubuntu1.7'},
    {'osver': '14.04', 'pkgname': 'cups-filters-core-drivers', 'pkgver': '1.0.52-0ubuntu1.7'},
    {'osver': '14.04', 'pkgname': 'libcupsfilters-dev', 'pkgver': '1.0.52-0ubuntu1.7'},
    {'osver': '14.04', 'pkgname': 'libcupsfilters1', 'pkgver': '1.0.52-0ubuntu1.7'},
    {'osver': '14.04', 'pkgname': 'libfontembed-dev', 'pkgver': '1.0.52-0ubuntu1.7'},
    {'osver': '14.04', 'pkgname': 'libfontembed1', 'pkgver': '1.0.52-0ubuntu1.7'}
];
