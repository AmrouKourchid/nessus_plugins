...
# extracted from Red Hat Security Advisory RHSA-2022:7594. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:7594");

  script_name(english:"RHEL 8 : poppler (RHSA-2022:7594)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for poppler.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2022:7594 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_7594.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fe252905");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:7594");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2087190");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2096452");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL poppler package based on the guidance in RHSA-2022:7594.");
