...
# extracted from Red Hat Security Advisory compat-libtiff3. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2016-5875");

  script_name(english:"RHEL 7 : compat-libtiff3 (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-5875");
