...
# extracted from Red Hat Security Advisory 8.2_libtpms. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2021-3569", "CVE-2021-3746");

  script_name(english:"RHEL 8 : 8.2_libtpms (Unpatched Vulnerability) (deprecated)");
