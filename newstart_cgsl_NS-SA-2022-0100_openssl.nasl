...
# extracted from ZTE advisory NS-SA-2022-0100. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 6.02 : openssl Vulnerability (NS-SA-2022-0100)");

  script_set_attribute(attribute:"synopsis", value:
"The remote NewStart CGSL host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 6.02, has openssl packages installed that are affected by a
vulnerability:
...
number.");
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/notice/NS-SA-2022-0100");
...
var pkgs = {
  'CGSL MAIN 6.02': [
    'openssl-1.1.1k-6.el8_5.cgslv6_2.3.g3d2861b',
    'openssl-devel-1.1.1k-6.el8_5.cgslv6_2.3.g3d2861b',
    'openssl-libs-1.1.1k-6.el8_5.cgslv6_2.3.g3d2861b',
    'openssl-static-1.1.1k-6.el8_5.cgslv6_2.3.g3d2861b'
  ]
};
