...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.0 : util-linux (EulerOS-SA-2021-2829)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2829
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?971010db");
...
var pkgs = [
  "libblkid-2.23.2-52.1.h12",
  "libmount-2.23.2-52.1.h12",
  "libuuid-2.23.2-52.1.h12",
  "util-linux-2.23.2-52.1.h12"
];
