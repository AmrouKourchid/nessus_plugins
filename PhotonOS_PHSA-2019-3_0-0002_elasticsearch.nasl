...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Elasticsearch PHSA-2019-3.0-0002");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'elasticsearch-6.4.3-1.ph3')) flag++;
