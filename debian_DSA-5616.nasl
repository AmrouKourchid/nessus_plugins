...
# extracted from Debian Security Advisory dsa-5616. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5616 : ruby-sanitize - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 / 12 host has a package installed that is affected by a vulnerability as referenced in the dsa-5616
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e8efe62e");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-36823");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bookworm/ruby-sanitize");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bullseye/ruby-sanitize");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'ruby-sanitize', 'reference': '5.2.1-2+deb11u1'},
    {'release': '12.0', 'prefix': 'ruby-sanitize', 'reference': '6.0.0-1.1+deb12u1'}
];
