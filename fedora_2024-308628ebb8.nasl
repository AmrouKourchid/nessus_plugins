...
# extracted from Fedora Security Advisory FEDORA-2024-308628ebb8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-308628ebb8");

  script_name(english:"Fedora 41 : python3.9 (2024-308628ebb8)");
...
FEDORA-2024-308628ebb8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-308628ebb8");
...
var pkgs = [
    {'reference':'python3.9-3.9.20-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
