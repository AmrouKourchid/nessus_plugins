...
if (description)
{
  ...
  script_cve_id("CVE-2022-43254");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-43254");
...
patch available.
  ...
  - GPAC v2.1-DEV-rev368-gfd054169b-master was discovered to contain a memory leak via the component
    gf_list_new at utils/list.c. (CVE-2022-43254)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-43254");
