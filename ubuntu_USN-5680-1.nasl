...
# extracted from Ubuntu Security Notice USN-5680-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5680-1");

  script_name(english:"Ubuntu 20.04 LTS : gThumb vulnerabilities (USN-5680-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 20.04 LTS host has packages installed that are affected by multiple vulnerabilities as referenced in
the USN-5680-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5680-1");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'gthumb', 'pkgver': '3:3.8.0-2.1ubuntu0.1'},
    {'osver': '20.04', 'pkgname': 'gthumb-data', 'pkgver': '3:3.8.0-2.1ubuntu0.1'},
    {'osver': '20.04', 'pkgname': 'gthumb-dev', 'pkgver': '3:3.8.0-2.1ubuntu0.1'}
];
