...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Ncurses PHSA-2020-3.0-0047");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the ncurses package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-3.0-47.md");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'ncurses-6.1-2.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'ncurses-compat-6.1-2.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'ncurses-devel-6.1-2.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'ncurses-libs-6.1-2.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'ncurses-terminfo-6.1-2.ph3')) flag++;
