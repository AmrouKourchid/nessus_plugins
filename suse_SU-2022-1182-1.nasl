...
# SUSE update advisory SUSE-SU-2022:1182-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:1182-1");

  script_name(english:"SUSE SLES12 Security Update : kernel (Live Patch 21 for SLE 12 SP4) (SUSE-SU-2022:1182-1)");
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-April/010702.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fa93b4b2");
...
var pkgs = [
    {'reference':'kgraft-patch-4_12_14-95_77-default-13-2.1', 'sp':'4', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.4']}
];
