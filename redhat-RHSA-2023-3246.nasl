...
# extracted from Red Hat Security Advisory RHSA-2023:3246. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:3246");

  script_name(english:"RHEL 8 : git (RHSA-2023:3246)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for git.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2023:3246 advisory.
    ...
    * git: by feeding specially crafted input to `git apply --reject`, a path outside the working tree can be
    overwritten with partially controlled contents (CVE-2023-25652)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_3246.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?27709250");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2168160");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2168161");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2188333");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2188337");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2188338");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:3246");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL git package based on the guidance in RHSA-2023:3246.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'git-2.39.3-1.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-all-2.39.3-1.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-core-2.39.3-1.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-core-doc-2.39.3-1.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-credential-libsecret-2.39.3-1.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-daemon-2.39.3-1.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-email-2.39.3-1.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-gui-2.39.3-1.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-instaweb-2.39.3-1.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-subtree-2.39.3-1.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-svn-2.39.3-1.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gitk-2.39.3-1.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gitweb-2.39.3-1.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'perl-Git-2.39.3-1.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'perl-Git-SVN-2.39.3-1.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'git-2.39.3-1.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-all-2.39.3-1.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-core-2.39.3-1.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-core-doc-2.39.3-1.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-credential-libsecret-2.39.3-1.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-daemon-2.39.3-1.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-email-2.39.3-1.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-gui-2.39.3-1.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-instaweb-2.39.3-1.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-subtree-2.39.3-1.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-svn-2.39.3-1.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gitk-2.39.3-1.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gitweb-2.39.3-1.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'perl-Git-2.39.3-1.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'perl-Git-SVN-2.39.3-1.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
