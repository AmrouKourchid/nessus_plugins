...
# extracted from Red Hat Security Advisory RHSA-2023:5313. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:5313");

  script_name(english:"RHEL 9 : open-vm-tools (RHSA-2023:5313)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for open-vm-tools.");
...
the RHSA-2023:5313 advisory.

    The Open Virtual Machine Tools are the open source implementation of the VMware Tools. They are a set of
    guest operating system virtualization components that enhance performance and user experience of virtual
    machines.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_5313.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ad000b60");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2236542");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:5313");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL open-vm-tools package based on the guidance in RHSA-2023:5313.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:open-vm-tools-salt-minion");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:open-vm-tools-sdmp");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:open-vm-tools-test");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'open-vm-tools-12.1.5-1.el9_2.3', 'sp':'2', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'open-vm-tools-12.1.5-1.el9_2.3', 'sp':'2', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'open-vm-tools-desktop-12.1.5-1.el9_2.3', 'sp':'2', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'open-vm-tools-desktop-12.1.5-1.el9_2.3', 'sp':'2', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'open-vm-tools-salt-minion-12.1.5-1.el9_2.3', 'sp':'2', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'open-vm-tools-sdmp-12.1.5-1.el9_2.3', 'sp':'2', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'open-vm-tools-test-12.1.5-1.el9_2.3', 'sp':'2', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'open-vm-tools-test-12.1.5-1.el9_2.3', 'sp':'2', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'open-vm-tools-12.1.5-1.el9_2.3', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'open-vm-tools-12.1.5-1.el9_2.3', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'open-vm-tools-desktop-12.1.5-1.el9_2.3', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'open-vm-tools-desktop-12.1.5-1.el9_2.3', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'open-vm-tools-salt-minion-12.1.5-1.el9_2.3', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'open-vm-tools-sdmp-12.1.5-1.el9_2.3', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'open-vm-tools-test-12.1.5-1.el9_2.3', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'open-vm-tools-test-12.1.5-1.el9_2.3', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'open-vm-tools / open-vm-tools-desktop / open-vm-tools-salt-minion / etc');
}
