...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : openssl (EulerOS-SA-2019-1326)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1326
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0aee0c35");
...
pkgs = ["openssl-1.0.2k-16.h6",
        "openssl-devel-1.0.2k-16.h6",
        "openssl-libs-1.0.2k-16.h6"];
