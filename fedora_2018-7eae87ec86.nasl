...
# extracted from Fedora Security Advisory FEDORA-2018-7eae87ec86.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-7eae87ec86");

  script_name(english:"Fedora 28 : python3 (2018-7eae87ec86)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-7eae87ec86");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"python3-3.6.5-1.fc28")) flag++;
