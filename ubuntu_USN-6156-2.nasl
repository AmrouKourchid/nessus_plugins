...
# extracted from Ubuntu Security Notice USN-6156-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6156-2");

  script_name(english:"Ubuntu 20.04 LTS : SSSD regression (USN-6156-2)");
...
USN-6156-2 advisory.
    ...
    USN-6156-1 fixed a vulnerability in SSSD. In certain environments, not all packages ended up being
    upgraded at the same time, resulting in authentication failures when the PAM module was being used.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6156-2");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'libipa-hbac-dev', 'pkgver': '2.2.3-3ubuntu0.12'},
    {'osver': '20.04', 'pkgname': 'libipa-hbac0', 'pkgver': '2.2.3-3ubuntu0.12'},
    {'osver': '20.04', 'pkgname': 'libnss-sss', 'pkgver': '2.2.3-3ubuntu0.12'},
    {'osver': '20.04', 'pkgname': 'libpam-sss', 'pkgver': '2.2.3-3ubuntu0.12'},
    {'osver': '20.04', 'pkgname': 'libsss-certmap-dev', 'pkgver': '2.2.3-3ubuntu0.12'},
    {'osver': '20.04', 'pkgname': 'libsss-certmap0', 'pkgver': '2.2.3-3ubuntu0.12'},
    {'osver': '20.04', 'pkgname': 'libsss-idmap-dev', 'pkgver': '2.2.3-3ubuntu0.12'},
    {'osver': '20.04', 'pkgname': 'libsss-idmap0', 'pkgver': '2.2.3-3ubuntu0.12'},
    {'osver': '20.04', 'pkgname': 'libsss-nss-idmap-dev', 'pkgver': '2.2.3-3ubuntu0.12'},
    {'osver': '20.04', 'pkgname': 'libsss-nss-idmap0', 'pkgver': '2.2.3-3ubuntu0.12'},
    {'osver': '20.04', 'pkgname': 'libsss-simpleifp-dev', 'pkgver': '2.2.3-3ubuntu0.12'},
    {'osver': '20.04', 'pkgname': 'libsss-simpleifp0', 'pkgver': '2.2.3-3ubuntu0.12'},
    {'osver': '20.04', 'pkgname': 'libsss-sudo', 'pkgver': '2.2.3-3ubuntu0.12'},
    {'osver': '20.04', 'pkgname': 'libwbclient-sssd', 'pkgver': '2.2.3-3ubuntu0.12'},
    {'osver': '20.04', 'pkgname': 'libwbclient-sssd-dev', 'pkgver': '2.2.3-3ubuntu0.12'},
    {'osver': '20.04', 'pkgname': 'python3-libipa-hbac', 'pkgver': '2.2.3-3ubuntu0.12'},
    {'osver': '20.04', 'pkgname': 'python3-libsss-nss-idmap', 'pkgver': '2.2.3-3ubuntu0.12'},
    {'osver': '20.04', 'pkgname': 'python3-sss', 'pkgver': '2.2.3-3ubuntu0.12'},
    {'osver': '20.04', 'pkgname': 'sssd', 'pkgver': '2.2.3-3ubuntu0.12'},
    {'osver': '20.04', 'pkgname': 'sssd-ad', 'pkgver': '2.2.3-3ubuntu0.12'},
    {'osver': '20.04', 'pkgname': 'sssd-ad-common', 'pkgver': '2.2.3-3ubuntu0.12'},
    {'osver': '20.04', 'pkgname': 'sssd-common', 'pkgver': '2.2.3-3ubuntu0.12'},
    {'osver': '20.04', 'pkgname': 'sssd-dbus', 'pkgver': '2.2.3-3ubuntu0.12'},
    {'osver': '20.04', 'pkgname': 'sssd-ipa', 'pkgver': '2.2.3-3ubuntu0.12'},
    {'osver': '20.04', 'pkgname': 'sssd-kcm', 'pkgver': '2.2.3-3ubuntu0.12'},
    {'osver': '20.04', 'pkgname': 'sssd-krb5', 'pkgver': '2.2.3-3ubuntu0.12'},
    {'osver': '20.04', 'pkgname': 'sssd-krb5-common', 'pkgver': '2.2.3-3ubuntu0.12'},
    {'osver': '20.04', 'pkgname': 'sssd-ldap', 'pkgver': '2.2.3-3ubuntu0.12'},
    {'osver': '20.04', 'pkgname': 'sssd-proxy', 'pkgver': '2.2.3-3ubuntu0.12'},
    {'osver': '20.04', 'pkgname': 'sssd-tools', 'pkgver': '2.2.3-3ubuntu0.12'}
];
