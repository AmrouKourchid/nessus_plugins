...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : freerdp (EulerOS-SA-2019-1285)");
...
vulnerabilities :
  ...
  - freerdp: Integer truncation leading to heap-based
    buffer overflow in Update_read_bitmap_update() function
    (CVE-2018-8786)
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1285
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?38a23660");
...
pkgs = ["freerdp-1.0.2-15.h1.eulerosv2r7",
        "freerdp-libs-1.0.2-15.h1.eulerosv2r7",
        "freerdp-plugins-1.0.2-15.h1.eulerosv2r7"];
