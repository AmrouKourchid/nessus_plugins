...
# extracted from Fedora Security Advisory FEDORA-2023-6000e06581
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-6000e06581");

  script_name(english:"Fedora 40 : pypy (2023-6000e06581)");
...
FEDORA-2023-6000e06581 advisory.

    Automatic update for pypy-7.3.12-3.fc40.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-6000e06581");
...
var pkgs = [
    {'reference':'pypy-7.3.12-3.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
