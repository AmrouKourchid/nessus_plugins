...
referenced in the RHSA-2021:2472 advisory.
    ...
    This release adds the new Apache HTTP Server 2.4.37 Service Pack 8 packages that are part of the JBoss
    ...
    Pack 7 and includes bug fixes and enhancements. Refer to the Release Notes for information on the most
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_2472.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7e85491c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:2472");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1847916");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1941965");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1963146");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1968013");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat JBoss Core Services Apache HTTP Server 2.4.37 SP8 package based on the guidance in
RHSA-2021:2472.");
  ...
  script_cwe_id(121, 200, 290, 295, 416);
