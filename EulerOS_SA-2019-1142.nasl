...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : libgxps (EulerOS-SA-2019-1142)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1142
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4324259d");
...
pkgs = ["libgxps-0.2.5-1.h1.eulerosv2r7"];
