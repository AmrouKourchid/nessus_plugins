...
# extracted from Fedora Security Advisory FEDORA-2024-ef8c8a8b37
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-ef8c8a8b37");

  script_name(english:"Fedora 38 : liblas (2024-ef8c8a8b37)");
...
FEDORA-2024-ef8c8a8b37 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-ef8c8a8b37");
...
var pkgs = [
    {'reference':'liblas-1.8.2-0.12.gitf1da555.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
