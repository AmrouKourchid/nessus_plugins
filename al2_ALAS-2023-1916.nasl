...
# extracted from Amazon Linux 2 Security Advisory ALAS-2023-1916.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : bcel (ALAS-2023-1916)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of bcel installed on the remote host is prior to 5.2-18. It is, therefore, affected by a vulnerability as
referenced in the ALAS2-2023-1916 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2023-1916.html");
...
var pkgs = [
    {'reference':'bcel-5.2-18.amzn2.0.1', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'bcel-javadoc-5.2-18.amzn2.0.1', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
