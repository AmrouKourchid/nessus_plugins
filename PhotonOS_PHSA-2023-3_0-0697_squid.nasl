...
if (description)
{
  ...
  script_cve_id("CVE-2023-46728", "CVE-2023-46846");

  script_name(english:"Photon OS 3.0: Squid PHSA-2023-3.0-0697");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'squid-5.9-1.ph3')) flag++;
