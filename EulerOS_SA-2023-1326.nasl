...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : libtiff (EulerOS-SA-2023-1326)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1326
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fc5941b8");
...
var pkgs = [
  "libtiff-4.0.9-11.h24.eulerosv2r8",
  "libtiff-devel-4.0.9-11.h24.eulerosv2r8"
];
