...
# extracted from Fedora Security Advisory FEDORA-2023-c3c8cc5f8b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-c3c8cc5f8b");

  script_name(english:"Fedora 38 : matrix-synapse (2023-c3c8cc5f8b)");
...
FEDORA-2023-c3c8cc5f8b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-c3c8cc5f8b");
...
"Update the affected matrix-synapse package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-45129");
...
var pkgs = [
    {'reference':'matrix-synapse-1.94.0-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
