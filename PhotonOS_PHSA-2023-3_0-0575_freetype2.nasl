...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Freetype2 PHSA-2023-3.0-0575");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'freetype2-2.9.1-5.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'freetype2-devel-2.9.1-5.ph3')) flag++;
