...
# extracted from Ubuntu Security Notice USN-3747-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"3747-1");

  script_name(english:"Ubuntu 18.04 LTS : OpenJDK 10 vulnerabilities (USN-3747-1)");
...
the USN-3747-1 advisory.

    It was discovered that OpenJDK did not properly validate types in some situations. An attacker could use
    this to construct a Java class that could possibly bypass sandbox restrictions. (CVE-2018-2825,
    CVE-2018-2826)
    ...
    Daniel Bleichenbacher discovered a vulnerability in the Galois/Counter Mode (GCM) mode of operation for
    symmetric block ciphers in OpenJDK. An attacker could use this to expose sensitive information.
    (CVE-2018-2972)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3747-1");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'openjdk-11-demo', 'pkgver': '10.0.2+13-1ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'openjdk-11-jdk', 'pkgver': '10.0.2+13-1ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'openjdk-11-jdk-headless', 'pkgver': '10.0.2+13-1ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'openjdk-11-jre', 'pkgver': '10.0.2+13-1ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'openjdk-11-jre-headless', 'pkgver': '10.0.2+13-1ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'openjdk-11-jre-zero', 'pkgver': '10.0.2+13-1ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'openjdk-11-source', 'pkgver': '10.0.2+13-1ubuntu0.18.04.1'}
];
