...
# extracted from Fedora Security Advisory FEDORA-2022-a35baa23e8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-a35baa23e8");

  script_name(english:"Fedora 37 : python3.8 (2022-a35baa23e8)");
...
FEDORA-2022-a35baa23e8 advisory.

    Automatic update for python3.8-3.8.13-3.fc37.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-a35baa23e8");
...
var pkgs = [
    {'reference':'python3.8-3.8.13-3.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
