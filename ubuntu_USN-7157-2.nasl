...
# extracted from Ubuntu Security Notice USN-7157-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"7157-2");

  script_name(english:"Ubuntu 20.04 LTS : PHP regression (USN-7157-2)");
...
USN-7157-2 advisory.
    ...
    USN-7157-1 fixed vulnerabilities in PHP. The patch for CVE-2024-8932 caused a regression in php7.4. This
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7157-2");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-8932");
