...
# extracted from Fedora Security Advisory FEDORA-2024-5d9dc19f2d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-5d9dc19f2d");

  script_name(english:"Fedora 40 : mysql8.0 (2024-5d9dc19f2d)");
...
FEDORA-2024-5d9dc19f2d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-5d9dc19f2d");
  script_set_attribute(attribute:"solution", value:
"Update the affected mysql8.0 package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:mysql8.0");
...
var pkgs = [
    {'reference':'mysql8.0-8.0.39-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'mysql8.0');
}
