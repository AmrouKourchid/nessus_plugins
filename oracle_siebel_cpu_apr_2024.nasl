...
if (description)
{
  ...
  script_name(english:"Oracle Siebel Server (April 2024 CPU)");
...
April 2024 CPU advisory.
  ...
  - Vulnerability in the Siebel Apps - Public Sector product of Oracle Siebel CRM (component: Other (Google
    Guava)). Supported versions that are affected are 24.2 and prior. Easily exploitable vulnerability allows
    low privileged attacker with logon to the infrastructure where Siebel Apps - Public Sector executes to
    compromise Siebel Apps - Public Sector. Successful attacks of this vulnerability can result in
    unauthorized creation, deletion or modification access to critical data or all Siebel Apps - Public Sector
    accessible data as well as unauthorized access to critical data or complete access to all Siebel Apps -
    Public Sector accessible data. (CVE-2023-2976)
...
var constraints = [
  { 'max_version' : '24.2.999', 'fixed_display' : 'See vendor advisory' }
];
