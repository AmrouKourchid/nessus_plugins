...
ELSA-2020-5676 advisory.
    ...
    - KVM: x86: Protect ioapic_read_indirect() from Spectre-v1/L1TF attacks (Marios Pomonis)  [Orabug:
    31191092]  {CVE-2013-1798}
    - HID: hiddev: do cleanup in failure of opening a device (Hillf Danton)  [Orabug: 31206359]
    {CVE-2019-19527}
    - HID: hiddev: avoid opening a disconnected device (Hillf Danton)  [Orabug: 31206359]  {CVE-2019-19527}
    - include/linux/relay.h: fix percpu annotation in struct rchan (Luc Van Oostenryck)  [Orabug: 31183399]
    {CVE-2019-19462}
    - HID: Fix assumption that devices have inputs (Alan Stern)  [Orabug: 30622561]  {CVE-2019-19532}
    - vgacon: Fix a UAF in vgacon_invert_region (Zhang Xiaoxu)  [Orabug: 31143946]  {CVE-2020-8649}
    {CVE-2020-8647} {CVE-2020-8647} {CVE-2020-8649} {CVE-2020-8647} {CVE-2020-8649}
    - blktrace: Protect q->blk_trace with RCU (Jan Kara)  [Orabug: 31123575]  {CVE-2019-19768}
    - blktrace: fix unlocked access to init/start-stop/teardown (Jens Axboe)  [Orabug: 31123575]
    {CVE-2019-19768}
    ...
    - slcan: Don't transmit uninitialized stack data in padding (Richard Palethorpe)  [Orabug: 31136752]
    {CVE-2020-11494}
    - crypto: user - fix leaking uninitialized memory to userspace (Eric Biggers)  [Orabug: 31081816]
    {CVE-2018-19854}
    - scsi: libsas: stop discovering if oob mode is disconnected (Jason Yan)  [Orabug: 30770911]
    {CVE-2019-19965}
    ...
    31104480]  {CVE-2019-14814} {CVE-2019-14815} {CVE-2019-14816} {CVE-2019-14814} {CVE-2019-14815}
    {CVE-2019-14816}
    - floppy: check FDC index for errors before assigning it (Linus Torvalds)  [Orabug: 31067513]
    {CVE-2020-9383}
...
var pkgs = [
    ...
    {'reference':'perf-4.14.35-1902.302.2.el7uek', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'perf-4.14.35'},
    {'reference':'python-perf-4.14.35-1902.302.2.el7uek', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'python-perf-4.14.35'},
    ...
    {'reference':'kernel-uek-doc-4.14.35-1902.302.2.el7uek', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-doc-4.14.35'},
    {'reference':'kernel-uek-headers-4.14.35-1902.302.2.el7uek', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-headers-4.14.35'},
    ...
    {'reference':'kernel-uek-tools-libs-4.14.35-1902.302.2.el7uek', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-tools-libs-4.14.35'},
    {'reference':'kernel-uek-tools-libs-devel-4.14.35-1902.302.2.el7uek', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-tools-libs-devel-4.14.35'},
    {'reference':'perf-4.14.35-1902.302.2.el7uek', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'perf-4.14.35'},
    {'reference':'python-perf-4.14.35-1902.302.2.el7uek', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'python-perf-4.14.35'}
];
