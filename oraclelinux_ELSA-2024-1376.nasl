...
# extracted from Oracle Linux Security Advisory ELSA-2024-1376.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : squid (ELSA-2024-1376)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-1376.html");
...
var pkgs = [
    {'reference':'squid-5.5-6.0.1.el9_3.8', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
    {'reference':'squid-5.5-6.0.1.el9_3.8', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
];
