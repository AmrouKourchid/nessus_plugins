...
# extracted from Red Hat Security Advisory RHSA-2017:0276. The text 
...
the RHSA-2017:0276 advisory.
    ...
    * A denial of service flaw was found in the way BIND handled query responses when both DNS64 and RPZ were
    used. A remote attacker could use this flaw to make named exit unexpectedly with an assertion failure or a
    null pointer dereference via a specially crafted DNS response. (CVE-2017-3135)

    Red Hat would like to thank ISC for reporting this issue. Upstream acknowledges Ramesh Damodaran
    (Infoblox) and Aliaksandr Shubnik (Infoblox) as the original reporter.

Tenable has extracted the preceding description block directly from the Red Hat Enterprise Linux security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2017/rhsa-2017_0276.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9b2b27fe");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2017:0276");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1420193");
  script_set_attribute(attribute:"see_also", value:"https://kb.isc.org/article/AA-01453");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL bind package based on the guidance in RHSA-2017:0276.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'bind-9.9.4-38.el7_3.2', 'release':'7', 'el_string':'el7_3', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-chroot-9.9.4-38.el7_3.2', 'release':'7', 'el_string':'el7_3', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-devel-9.9.4-38.el7_3.2', 'release':'7', 'el_string':'el7_3', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-libs-9.9.4-38.el7_3.2', 'release':'7', 'el_string':'el7_3', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-libs-lite-9.9.4-38.el7_3.2', 'release':'7', 'el_string':'el7_3', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-license-9.9.4-38.el7_3.2', 'release':'7', 'el_string':'el7_3', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-lite-devel-9.9.4-38.el7_3.2', 'release':'7', 'el_string':'el7_3', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-pkcs11-9.9.4-38.el7_3.2', 'release':'7', 'el_string':'el7_3', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-pkcs11-devel-9.9.4-38.el7_3.2', 'release':'7', 'el_string':'el7_3', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-pkcs11-libs-9.9.4-38.el7_3.2', 'release':'7', 'el_string':'el7_3', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-pkcs11-utils-9.9.4-38.el7_3.2', 'release':'7', 'el_string':'el7_3', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-sdb-9.9.4-38.el7_3.2', 'release':'7', 'el_string':'el7_3', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-sdb-chroot-9.9.4-38.el7_3.2', 'release':'7', 'el_string':'el7_3', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-utils-9.9.4-38.el7_3.2', 'release':'7', 'el_string':'el7_3', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'}
    ]
  }
];
