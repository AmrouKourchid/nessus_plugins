...
# extracted from Gentoo Linux Security Advisory GLSA 202003-53.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202003-53");

  script_name(english:"GLSA-202003-53 : Chromium, Google Chrome: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202003-53
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202003-53");
...
if (qpkg_check(package:"www-client/chromium", unaffected:make_list("ge 80.0.3987.149"), vulnerable:make_list("lt 80.0.3987.149"))) flag++;
if (qpkg_check(package:"www-client/google-chrome", unaffected:make_list("ge 80.0.3987.149"), vulnerable:make_list("lt 80.0.3987.149"))) flag++;
