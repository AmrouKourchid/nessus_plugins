...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Rubygem PHSA-2025-5.0-0485");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'rubygem-activesupport-7.0.8.5-1.ph5')) flag++;
