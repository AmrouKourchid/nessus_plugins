...
if (description)
{
  ...
  script_cve_id("CVE-2014-0222");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2014-0222");
...
patch available.
  ...
  - Integer overflow in the qcow_open function in block/qcow.c in QEMU before 1.7.2 allows remote attackers to
    cause a denial of service (crash) via a large L2 table in a QCOW version 1 image. (CVE-2014-0222)
