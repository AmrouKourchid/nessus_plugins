...
# extracted from Red Hat Security Advisory RHSA-2012:1555. The text 
...
if (description)
{
  ...
  script_cve_id("CVE-2012-5622");
  script_bugtraq_id(56889);
  script_xref(name:"RHSA", value:"2012:1555");

  script_name(english:"RHEL 6 : openshift-console (RHSA-2012:1555)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for openshift-console.");
...
the RHSA-2012:1555 advisory.

  - openshift-console: CSRF attack (CVE-2012-5622)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2012/rhsa-2012_1555.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?068ba4c2");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2012:1555");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=883227");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL openshift-console package based on the guidance in RHSA-2012:1555.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:R/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2012-5622");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openshift-console-0.0.5-3.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-ansible'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'openshift-console');
}
