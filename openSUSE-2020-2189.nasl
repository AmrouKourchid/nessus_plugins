...
# extracted from openSUSE Security Update openSUSE-2020-2189.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : python (openSUSE-2020-2189)");
...
if ( rpm_check(release:"SUSE15.1", reference:"libpython2_7-1_0-2.7.17-lp151.10.29.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libpython2_7-1_0-debuginfo-2.7.17-lp151.10.29.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"python-2.7.17-lp151.10.29.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"python-base-2.7.17-lp151.10.29.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"python-base-debuginfo-2.7.17-lp151.10.29.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"python-base-debugsource-2.7.17-lp151.10.29.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"python-curses-2.7.17-lp151.10.29.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"python-curses-debuginfo-2.7.17-lp151.10.29.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"python-debuginfo-2.7.17-lp151.10.29.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"python-debugsource-2.7.17-lp151.10.29.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"python-demo-2.7.17-lp151.10.29.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"python-devel-2.7.17-lp151.10.29.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"python-doc-pdf-2.7.17-lp151.10.29.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"python-gdbm-2.7.17-lp151.10.29.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"python-gdbm-debuginfo-2.7.17-lp151.10.29.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"python-idle-2.7.17-lp151.10.29.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"python-tk-2.7.17-lp151.10.29.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"python-tk-debuginfo-2.7.17-lp151.10.29.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"python-xml-2.7.17-lp151.10.29.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"python-xml-debuginfo-2.7.17-lp151.10.29.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libpython2_7-1_0-32bit-2.7.17-lp151.10.29.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libpython2_7-1_0-32bit-debuginfo-2.7.17-lp151.10.29.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"python-32bit-2.7.17-lp151.10.29.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"python-32bit-debuginfo-2.7.17-lp151.10.29.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"python-base-32bit-2.7.17-lp151.10.29.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"python-base-32bit-debuginfo-2.7.17-lp151.10.29.1") ) flag++;
