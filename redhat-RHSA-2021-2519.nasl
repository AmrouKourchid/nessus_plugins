...
# extracted from Red Hat Security Advisory RHSA-2021:2519. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2020-24489", "CVE-2021-25217", "CVE-2021-27219");
  script_xref(name:"RHSA", value:"2021:2519");
  script_xref(name:"IAVB", value:"2021-B-0032-S");

  script_name(english:"RHEL 7 : RHV-H security update (redhat-virtualization-host) 4.3.16 (Important) (RHSA-2021:2519)");
...
referenced in the RHSA-2021:2519 advisory.
    ...
    Enterprise Linux with only the packages required to host virtual machines. RHVH features a Cockpit user
    interface for monitoring the host's resources and
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_2519.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9edef1b5");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:2519");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1929858");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1948377");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1957238");
...
"Update the RHEL RHV-H package based on the guidance in RHSA-2021:2519.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'redhat-virtualization-host-image-update-4.3.16-20210615.0.el7_9', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'}
    ]
  }
];
