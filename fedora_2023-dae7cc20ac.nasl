...
# extracted from Fedora Security Advisory FEDORA-2023-dae7cc20ac
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-dae7cc20ac");

  script_name(english:"Fedora 37 : libxml2 (2023-dae7cc20ac)");
...
FEDORA-2023-dae7cc20ac advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-dae7cc20ac");
...
var pkgs = [
    {'reference':'libxml2-2.10.4-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
