...
# extracted from VMware Security Advisory PHSA-2023-3.0-0627. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Sudo PHSA-2023-3.0-0627");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the sudo package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-3.0-627.md");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'sudo-1.9.14p3-1.ph3')) flag++;
