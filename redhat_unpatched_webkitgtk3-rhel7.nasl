...
# extracted from Red Hat Security Advisory webkitgtk3. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2015-2330", "CVE-2021-30858");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2021/11/17");

  script_name(english:"RHEL 7 : webkitgtk3 (Unpatched Vulnerability) (deprecated)");
