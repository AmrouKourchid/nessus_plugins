...
# SUSE update advisory SUSE-SU-2021:4021-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2021-0935", "CVE-2021-0941", "CVE-2021-20322");
  script_xref(name:"SuSE", value:"SUSE-SU-2021:4021-1");

  script_name(english:"SUSE SLES12 Security Update : kernel (Live Patch 25 for SLE 12 SP5) (SUSE-SU-2021:4021-1)");
...
the SUSE-SU-2021:4021-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2021-December/009891.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0178db34");
  script_set_attribute(attribute:"solution", value:
"Update the affected kgraft-patch-4_12_14-122_98-default package.");
...
var pkgs = [
    {'reference':'kgraft-patch-4_12_14-122_98-default-2-2.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.5']}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kgraft-patch-4_12_14-122_98-default');
}
