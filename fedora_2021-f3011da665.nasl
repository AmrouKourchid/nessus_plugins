...
# extracted from Fedora Security Advisory FEDORA-2021-f3011da665
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-f3011da665");

  script_name(english:"Fedora 33 : 1:wireshark (2021-f3011da665)");
...
FEDORA-2021-f3011da665 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-f3011da665");
...
pkgs = [
    {'reference':'wireshark-3.4.2-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
