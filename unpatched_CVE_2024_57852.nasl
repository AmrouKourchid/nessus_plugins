...
if (description)
{
  ...
  script_cve_id("CVE-2024-57852");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-57852");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: firmware: qcom: scm: smc: Handle
    missing SCM device Commit ca61d6836e6f (firmware: qcom: scm: fix a NULL-pointer dereference) makes it
    explicit that qcom_scm_get_tzmem_pool() can return NULL, therefore its users should handle this.
    (CVE-2024-57852)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-57852");
