...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.6 : mariadb (EulerOS-SA-2021-1443)");
...
the following vulnerability :
  ...
  - Vulnerability in the MySQL Client product of Oracle
    ...
    (CVSS:3.0/AV:N/AC:H/PR:N/UI:N/S:U/C:N/I:N/A:H).(CVE-202
    0-2574)
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1443
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0081a634");
