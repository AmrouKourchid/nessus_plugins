...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.0 : python-pillow (EulerOS-SA-2022-1690)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1690
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?14fa1085");
...
var pkgs = [
  "python-pillow-2.0.0-19.h15.gitd1c6db8"
];
