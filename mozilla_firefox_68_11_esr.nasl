...
"The version of Firefox ESR installed on the remote Windows host is prior to 68.11. It is, therefore, affected by
multiple vulnerabilities as referenced in the mfsa2020-31 advisory.
...
mozilla_check_version(installs:installs, product:'firefox', esr:TRUE, fix:'68.11', min:'68.0.0', severity:SECURITY_HOLE);
