...
# extracted from Debian Security Advisory dla-4056. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-4056 : golang-glog-dev - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has a package installed that is affected by a vulnerability as referenced in the dla-4056
advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/golang-glog");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-45339");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bullseye/golang-glog");
  script_set_attribute(attribute:"solution", value:
"Upgrade the golang-glog-dev packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:golang-glog-dev");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'golang-glog-dev', 'reference': '0.0~git20160126.23def4e-3+deb11u1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'golang-glog-dev');
}
