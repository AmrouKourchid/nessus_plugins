...
# extracted from Fedora Security Advisory FEDORA-2023-862bb40df5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-862bb40df5");

  script_name(english:"Fedora 39 : mlpack (2023-862bb40df5)");
...
FEDORA-2023-862bb40df5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-862bb40df5");
...
var pkgs = [
    {'reference':'mlpack-4.2.1-5.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
