...
# extracted from Red Hat Security Advisory RHSA-2024:1486. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:1486");

  script_name(english:"RHEL 7 : firefox (RHSA-2024:1486)");
...
referenced in the RHSA-2024:1486 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_1486.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?17fc0672");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:1486");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL firefox package based on the guidance in RHSA-2024:1486.");
  ...
  script_cwe_id(79, 94, 120, 208, 252, 416, 449, 1262);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-115.9.1-1.el7_9', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-115.9.1-1.el7_9', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-115.9.1-1.el7_9', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-115.9.1-1.el7_9', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-115.9.1-1.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
