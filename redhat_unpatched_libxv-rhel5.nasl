...
# extracted from Red Hat Security Advisory libxv. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2013-1989", "CVE-2013-2066", "CVE-2016-5407");

  script_name(english:"RHEL 5 : libxv (Unpatched Vulnerability) (deprecated)");
