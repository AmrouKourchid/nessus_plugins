...
# extracted from Debian Security Advisory dla-3473. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3473 : docker-registry - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3473
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/docker-registry");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'docker-registry', 'reference': '2.6.2~ds1-2+deb10u1'},
    {'release': '10.0', 'prefix': 'golang-github-docker-distribution-dev', 'reference': '2.6.2~ds1-2+deb10u1'}
];
