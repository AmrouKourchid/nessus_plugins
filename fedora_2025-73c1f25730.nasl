...
# extracted from Fedora Security Advisory FEDORA-2025-73c1f25730
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-73c1f25730");

  script_name(english:"Fedora 40 : rsync (2025-73c1f25730)");
...
FEDORA-2025-73c1f25730 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-73c1f25730");
...
var pkgs = [
    {'reference':'rsync-3.4.0-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
