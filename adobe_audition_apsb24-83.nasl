...
if (description)
{
  ...
  script_name(english:"Adobe Audition < 24.6.3 Memory leak (APSB24-83)");

  script_set_attribute(attribute:"synopsis", value:
"The Adobe Audition instance installed on the remote host is affected by a memory leak vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Audition installed on the remote Windows host is prior to 24.6.3. It is, therefore,
affected by a vulnerability as referenced in the APSB24-83 advisory.
