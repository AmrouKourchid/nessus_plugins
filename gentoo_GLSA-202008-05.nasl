...
# extracted from Gentoo Linux Security Advisory GLSA 202008-05.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202008-05");

  script_name(english:"GLSA-202008-05 : gThumb: Arbitrary code execution");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202008-05
(gThumb: Arbitrary code execution)

    A heap-based buffer overflow in gThumb&rsquo;s
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202008-05");
...
"All gThumb users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:gthumb");
...
if (qpkg_check(package:"media-gfx/gthumb", unaffected:make_list("ge 3.10.0"), vulnerable:make_list("lt 3.10.0"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "gThumb");
}
