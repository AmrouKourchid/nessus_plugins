...
# SUSE update advisory SUSE-SU-2021:4099-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2021:4099-1");

  script_name(english:"SUSE SLES15 Security Update : kernel (Live Patch 0 for SLE 15 SP3) (SUSE-SU-2021:4099-1)");
...
referenced in the SUSE-SU-2021:4099-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2021-December/009913.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?63cb07c2");
...
var kernel_live_checks = [
  {
    'kernels': {
      '5.3.18-57-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_3_18-57-default-9-3.1', 'sp':'3', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.3']},
          {'reference':'kernel-livepatch-5_3_18-57-default-9-3.1', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.3', 'sle-module-live-patching-release-15.3', 'sles-release-15.3']}
        ]
      }
    }
  }
