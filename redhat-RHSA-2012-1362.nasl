...
if (description)
{
  ...
  script_name(english:"RHEL 6 : thunderbird (RHSA-2012:1362)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2012/rhsa-2012_1362.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1776892a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2012:1362");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#critical");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=865215");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL thunderbird package based on the guidance in RHSA-2012:1362.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'thunderbird-10.0.8-2.el6_3', 'cpu':'i686', 'release':'6', 'el_string':'el6_3', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'thunderbird-10.0.8-2.el6_3', 'cpu':'ppc64', 'release':'6', 'el_string':'el6_3', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'thunderbird-10.0.8-2.el6_3', 'cpu':'s390x', 'release':'6', 'el_string':'el6_3', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'thunderbird-10.0.8-2.el6_3', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_3', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
