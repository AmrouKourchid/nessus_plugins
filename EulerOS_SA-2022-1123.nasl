...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : hivex (EulerOS-SA-2022-1123)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the hivex packages installed, the EulerOS Virtualization installation on the remote host is
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1123
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?63cb05f8");
...
var pkgs = [
  "hivex-1.3.10-6.9.h3.eulerosv2r7",
  "perl-hivex-1.3.10-6.9.h3.eulerosv2r7"
];
