...
# extracted from Fedora Security Advisory FEDORA-2022-9ca9a94e28
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-9ca9a94e28");

  script_name(english:"Fedora 37 : dhcp (2022-9ca9a94e28)");
...
FEDORA-2022-9ca9a94e28 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-9ca9a94e28");
...
var pkgs = [
    {'reference':'dhcp-4.4.3-4.P1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'12'}
];
