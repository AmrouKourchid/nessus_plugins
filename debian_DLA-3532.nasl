...
# extracted from Debian Security Advisory dla-3532. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3532 : openssh-client - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3532
advisory.
    ...
    arbitrary libraries from the users system and execute arbitrary code.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-38408");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'openssh-client', 'reference': '1:7.9p1-10+deb10u3'},
    {'release': '10.0', 'prefix': 'openssh-server', 'reference': '1:7.9p1-10+deb10u3'},
    {'release': '10.0', 'prefix': 'openssh-sftp-server', 'reference': '1:7.9p1-10+deb10u3'},
    {'release': '10.0', 'prefix': 'openssh-tests', 'reference': '1:7.9p1-10+deb10u3'},
    {'release': '10.0', 'prefix': 'ssh', 'reference': '1:7.9p1-10+deb10u3'},
    {'release': '10.0', 'prefix': 'ssh-askpass-gnome', 'reference': '1:7.9p1-10+deb10u3'}
];
