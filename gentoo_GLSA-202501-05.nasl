...
# extracted from Gentoo Linux Security Advisory GLSA 202501-05.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202501-05 : libuv: Hostname Truncation");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202501-05 (libuv: Hostname Truncation)

    Multiple vulnerabilities have been discovered in libuv. Please review the CVE identifiers referenced below
    for details.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202501-05");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=924127");
...
var packages = [
  {
    'name' : 'dev-libs/libuv',
    'unaffected' : make_list("ge 1.48.0"),
    'vulnerable' : make_list("lt 1.48.0")
  }
];
