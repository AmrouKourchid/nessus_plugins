...
# extracted from Ubuntu Security Notice USN-5806-3. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5806-3");

  script_name(english:"Ubuntu 20.04 LTS : Ruby vulnerability (USN-5806-3)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5806-3");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'libruby2.7', 'pkgver': '2.7.0-5ubuntu1.8'},
    {'osver': '20.04', 'pkgname': 'ruby2.7', 'pkgver': '2.7.0-5ubuntu1.8'},
    {'osver': '20.04', 'pkgname': 'ruby2.7-dev', 'pkgver': '2.7.0-5ubuntu1.8'}
];
