...
# extracted from Fedora Security Advisory FEDORA-2024-f3e0255c75
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-f3e0255c75");

  script_name(english:"Fedora 40 : cyrus-imapd (2024-f3e0255c75)");
...
FEDORA-2024-f3e0255c75 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-f3e0255c75");
...
var pkgs = [
    {'reference':'cyrus-imapd-3.8.3-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
