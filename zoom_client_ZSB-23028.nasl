...
if (description)
{
  ...
  script_name(english:"Zoom Client for Meetings < 5.14.5 Vulnerability (ZSB-23028)");
...
vulnerability as referenced in the ZSB-23028 advisory.

  - Buffer overflow in Zoom Clients before 5.14.5 may allow an unauthenticated user to enable a denial of
    service via network access. (CVE-2023-36532)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://explore.zoom.us/en/trust/security/security-bulletin/?filter-cve=&filter=&keywords=ZSB-23028
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?51c87bcb");
...
"Upgrade to Zoom Client for Meetings 5.14.5 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-36532");
