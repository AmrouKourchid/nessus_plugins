...
# extracted from Red Hat Security Advisory RHSA-2023:0276. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:0276");

  script_name(english:"RHEL 9 : Red Hat OpenStack Platform 17.0 (python-scciclient) (RHSA-2023:0276)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for Red Hat OpenStack Platform 17.0 (python-scciclient).");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2115122");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_0276.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c3039db8");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:0276");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat OpenStack Platform 17.0 (python-scciclient) package based on the guidance in RHSA-2023:0276.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-scciclient-0.10.2-0.20220830130628.b8e6e34.el9ost', 'release':'9', 'el_string':'el9ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python3-scciclient');
}
