...
# extracted from Fedora Security Advisory FEDORA-2024-831bad8f8f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-831bad8f8f");

  script_name(english:"Fedora 40 : podman-tui (2024-831bad8f8f)");
...
FEDORA-2024-831bad8f8f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-831bad8f8f");
...
var pkgs = [
    {'reference':'podman-tui-1.0.0-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
