...
# extracted from Red Hat Security Advisory RHSA-2021:1509. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2021-28163", "CVE-2021-28164", "CVE-2021-28165");
  script_xref(name:"RHSA", value:"2021:1509");

  script_name(english:"RHEL 7 : rh-eclipse-jetty (RHSA-2021:1509)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for rh-eclipse-jetty.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2021:1509 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?41507801");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_1509.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a1b4b0f4");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:1509");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1945710");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1945712");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1945714");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rh-eclipse-jetty package based on the guidance in RHSA-2021:1509.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:F/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:L/I:N/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:F/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-28164");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rh-eclipse-jetty-util-ajax");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-eclipse-jetty-9.4.40-1.1.el7_9', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-eclipse-jetty-client-9.4.40-1.1.el7_9', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-eclipse-jetty-continuation-9.4.40-1.1.el7_9', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-eclipse-jetty-http-9.4.40-1.1.el7_9', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-eclipse-jetty-io-9.4.40-1.1.el7_9', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-eclipse-jetty-jaas-9.4.40-1.1.el7_9', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-eclipse-jetty-javadoc-9.4.40-1.1.el7_9', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-eclipse-jetty-jmx-9.4.40-1.1.el7_9', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-eclipse-jetty-security-9.4.40-1.1.el7_9', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-eclipse-jetty-server-9.4.40-1.1.el7_9', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-eclipse-jetty-servlet-9.4.40-1.1.el7_9', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-eclipse-jetty-util-9.4.40-1.1.el7_9', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-eclipse-jetty-util-ajax-9.4.40-1.1.el7_9', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-eclipse-jetty-webapp-9.4.40-1.1.el7_9', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-eclipse-jetty-xml-9.4.40-1.1.el7_9', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'rh-eclipse-jetty / rh-eclipse-jetty-client / etc');
}
