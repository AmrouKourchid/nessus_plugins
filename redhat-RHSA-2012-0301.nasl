...
the RHSA-2012:0301 advisory.

  - ImageMagick: configuration files read from $CWD may allow arbitrary code execution (CVE-2010-4167)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2012/rhsa-2012_0301.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?84e3a967");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2012:0301");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=580535");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=652860");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL ImageMagick package based on the guidance in RHSA-2012:0301.");
...
var constraints = [
  {
    ...
    'pkgs': [
      ...
      {'reference':'ImageMagick-6.2.8.0-12.el5', 'cpu':'ppc', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ImageMagick-6.2.8.0-12.el5', 'cpu':'ppc64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ImageMagick-6.2.8.0-12.el5', 'cpu':'s390', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ImageMagick-6.2.8.0-12.el5', 'cpu':'s390x', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'ImageMagick-c++-6.2.8.0-12.el5', 'cpu':'ppc', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ImageMagick-c++-6.2.8.0-12.el5', 'cpu':'ppc64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ImageMagick-c++-6.2.8.0-12.el5', 'cpu':'s390', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ImageMagick-c++-6.2.8.0-12.el5', 'cpu':'s390x', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'ImageMagick-c++-devel-6.2.8.0-12.el5', 'cpu':'ppc', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ImageMagick-c++-devel-6.2.8.0-12.el5', 'cpu':'ppc64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ImageMagick-c++-devel-6.2.8.0-12.el5', 'cpu':'s390', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ImageMagick-c++-devel-6.2.8.0-12.el5', 'cpu':'s390x', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'ImageMagick-devel-6.2.8.0-12.el5', 'cpu':'ppc', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ImageMagick-devel-6.2.8.0-12.el5', 'cpu':'ppc64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ImageMagick-devel-6.2.8.0-12.el5', 'cpu':'s390', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ImageMagick-devel-6.2.8.0-12.el5', 'cpu':'s390x', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'ImageMagick-perl-6.2.8.0-12.el5', 'cpu':'ppc', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ImageMagick-perl-6.2.8.0-12.el5', 'cpu':'s390x', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
