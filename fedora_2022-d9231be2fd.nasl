...
# extracted from Fedora Security Advisory FEDORA-2022-d9231be2fd
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-d9231be2fd");

  script_name(english:"Fedora 37 : thunderbird (2022-d9231be2fd)");
...
FEDORA-2022-d9231be2fd advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-d9231be2fd");
...
var pkgs = [
    {'reference':'thunderbird-102.6.0-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
