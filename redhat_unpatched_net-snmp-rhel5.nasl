...
# extracted from Red Hat Security Advisory net-snmp. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2014-3565", "CVE-2018-1000116");

  script_name(english:"RHEL 5 : net-snmp (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss4_score_source", value:"CVE-2014-3565");
