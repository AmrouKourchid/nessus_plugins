...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Glib PHSA-2020-3.0-0103");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'glib-networking-2.59.1-3.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'glib-networking-lang-2.59.1-3.ph3')) flag++;
