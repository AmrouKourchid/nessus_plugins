...
# extracted from Gentoo Linux Security Advisory GLSA 202008-17.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2017-15047", "CVE-2020-14147");
  script_xref(name:"GLSA", value:"202008-17");
  script_xref(name:"CEA-ID", value:"CEA-2021-0004");

  script_name(english:"GLSA-202008-17 : Redis: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202008-17
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202008-17");
...
if (qpkg_check(package:"dev-db/redis", unaffected:make_list("ge 5.0.9"), vulnerable:make_list("lt 5.0.9"))) flag++;
