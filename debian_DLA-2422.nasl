...
# extracted from Debian Security Advisory DLA-2422-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2422-1 : qtsvg-opensource-src security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"Malformed SVG images were able to cause a segmentation fault in
qtsvg-opensource-src, the QtSvg module for displaying the contents of
SVG files in Qt.
...
For the detailed security status of qtsvg-opensource-src please refer
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2020/10/msg00035.html");
...
flag = 0;
if (deb_check(release:"9.0", prefix:"libqt5svg5", reference:"5.7.1~20161021-2.1")) flag++;
if (deb_check(release:"9.0", prefix:"libqt5svg5-dev", reference:"5.7.1~20161021-2.1")) flag++;
if (deb_check(release:"9.0", prefix:"qtsvg5-dbg", reference:"5.7.1~20161021-2.1")) flag++;
if (deb_check(release:"9.0", prefix:"qtsvg5-doc", reference:"5.7.1~20161021-2.1")) flag++;
if (deb_check(release:"9.0", prefix:"qtsvg5-doc-html", reference:"5.7.1~20161021-2.1")) flag++;
if (deb_check(release:"9.0", prefix:"qtsvg5-examples", reference:"5.7.1~20161021-2.1")) flag++;
