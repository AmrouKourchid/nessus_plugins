...
# extracted from VMware Security Advisory PHSA-2023-5.0-0031. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Ntp PHSA-2023-5.0-0031");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the ntp package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-5.0-31.md");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'ntp-4.2.8p15-8.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'ntp-perl-4.2.8p15-8.ph5')) flag++;
