...
# extracted from Fedora Security Advisory FEDORA-2025-70af67b2fa
#
...
if (description)
{
  ...
  script_cve_id("CVE-2025-30093");
  script_xref(name:"FEDORA", value:"2025-70af67b2fa");

  script_name(english:"Fedora 41 : condor (2025-70af67b2fa)");
...
FEDORA-2025-70af67b2fa advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-70af67b2fa");
  script_set_attribute(attribute:"solution", value:
"Update the affected condor package.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:S/C:P/I:P/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:L/UI:N/S:U/C:H/I:H/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-30093");
...
var pkgs = [
    {'reference':'condor-23.9.6-3.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
