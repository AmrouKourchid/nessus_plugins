...
# extracted from Red Hat Security Advisory RHSA-2023:7477. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:7477");

  script_name(english:"RHEL 9 : OpenShift Container Platform 4.13.24 (RHSA-2023:7477)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for OpenShift Container Platform 4.13.24.");
...
the RHSA-2023:7477 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.13.24. See the
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_7477.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ec16da34");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:7477");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.13.24 packages based on the guidance in RHSA-2023:7477.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-werkzeug-2.0.3-5.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
