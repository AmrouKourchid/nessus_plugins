...
if (description)
{
  ...
  script_name(english:"RHEL 4 : ncompress (RHSA-2006:0663)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for ncompress.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2006/rhsa-2006_0663.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a4475ee4");
  script_set_attribute(attribute:"see_also", value:"http://www.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=189215");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=189216");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=201335");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2006:0663");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL ncompress package based on the guidance in RHSA-2006:0663.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ncompress-4.2.4-43.rhel4', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ncompress-4.2.4-43.rhel4', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ncompress-4.2.4-43.rhel4', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ncompress-4.2.4-43.rhel4', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ncompress-4.2.4-43.rhel4', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
