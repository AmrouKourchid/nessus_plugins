...
# extracted from Gentoo Linux Security Advisory GLSA 201804-03.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201804-03");

  script_name(english:"GLSA-201804-03 : Poppler: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-201804-03
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/201804-03");
...
if (qpkg_check(package:"app-text/poppler", unaffected:make_list("ge 0.61.1"), vulnerable:make_list("lt 0.61.1"))) flag++;
