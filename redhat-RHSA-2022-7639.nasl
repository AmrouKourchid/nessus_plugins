...
# extracted from Red Hat Security Advisory RHSA-2022:7639. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:7639");

  script_name(english:"RHEL 8 : openblas (RHSA-2022:7639)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for openblas.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2022:7639 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_7639.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?840ee71b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:7639");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2024358");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL openblas package based on the guidance in RHSA-2022:7639.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:openblas");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:openblas-Rblas");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:openblas-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:openblas-openmp");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:openblas-openmp64");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:openblas-openmp64_");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:openblas-serial64");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:openblas-serial64_");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:openblas-static");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:openblas-threads");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:openblas-threads64");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:openblas-threads64_");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openblas-0.3.15-4.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openblas-devel-0.3.15-4.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openblas-openmp-0.3.15-4.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openblas-openmp64-0.3.15-4.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openblas-openmp64_-0.3.15-4.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openblas-Rblas-0.3.15-4.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openblas-serial64-0.3.15-4.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openblas-serial64_-0.3.15-4.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openblas-static-0.3.15-4.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openblas-threads-0.3.15-4.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openblas-threads64-0.3.15-4.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openblas-threads64_-0.3.15-4.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'openblas / openblas-Rblas / openblas-devel / openblas-openmp / etc');
}
