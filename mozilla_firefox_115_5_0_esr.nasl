...
"The version of Firefox ESR installed on the remote Windows host is prior to 115.5.0. It is, therefore, affected by
...
mozilla_check_version(installs:installs, product:'firefox', esr:TRUE, fix:'115.5.0', min:'115.0.0', severity:SECURITY_HOLE);
