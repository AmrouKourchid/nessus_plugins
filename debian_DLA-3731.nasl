...
# extracted from Debian Security Advisory dla-3731. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3731 : man-db - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has a package installed that is affected by a vulnerability as referenced in the dla-3731
advisory.

    -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3731-1                debian-lts@lists.debian.org
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/man-db");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/man-db");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'man-db', 'reference': '2.8.5-2+deb10u1'}
];
