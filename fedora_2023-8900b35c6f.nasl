...
# extracted from Fedora Security Advisory FEDORA-2023-8900b35c6f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-8900b35c6f");

  script_name(english:"Fedora 36 : webkit2gtk3 (2023-8900b35c6f)");
...
FEDORA-2023-8900b35c6f advisory.

     * The Bubblewrap sandbox no longer requires setting an application identifier via GApplication to operate
    correctly. Using GApplication is still recommended, but optional.
     * Adjust the scrolling speed for mouse wheels to make it feel more natural.
     * Allow pasting content using the Asynchronous Clipboard API when the origin is the same as the clipboard
    contents.
     ...
     * Security fixes: CVE-2022-0108, CVE-2022-32885, CVE-2023-25358, CVE-2023-27932, CVE-2023-27954,
    CVE-2023-28205
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-8900b35c6f");
...
var pkgs = [
    {'reference':'webkit2gtk3-2.40.1-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
