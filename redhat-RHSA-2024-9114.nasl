...
# extracted from Red Hat Security Advisory RHSA-2024:9114. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:9114");

  script_name(english:"RHEL 9 : gnome-shell and gnome-shell-extensions (RHSA-2024:9114)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for gnome-shell / gnome-shell-extensions.");
...
the RHSA-2024:9114 advisory.

    GNOME Shell acts as a compositing manager for the desktop, and displays both application windows and other
    objects. It provides core interface functions like switching windows, launching applications, and
    notifications. It takes advantage of the capabilities of modern graphics hardware and introduces
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-2031");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-22713");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-24713");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-25016");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-26989");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-43545");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_9114.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fb5669d7");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:9114");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL gnome-shell / gnome-shell-extensions packages based on the guidance in RHSA-2024:9114.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gnome-shell-40.10-21.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
