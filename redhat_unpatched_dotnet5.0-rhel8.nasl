...
# extracted from Red Hat Security Advisory dotnet5.0. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2022-0613", "CVE-2022-24723");

  script_name(english:"RHEL 8 : dotnet5.0 (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-0613");
