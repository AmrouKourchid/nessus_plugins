...
# extracted from Fedora Security Advisory FEDORA-2023-17bdd59177
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-17bdd59177");

  script_name(english:"Fedora 39 : firecracker / rust-aes-gcm (2023-17bdd59177)");
...
FEDORA-2023-17bdd59177 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-17bdd59177");
...
var pkgs = [
    {'reference':'firecracker-1.4.1-3.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-aes-gcm-0.10.3-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
