...
if (description)
{
  ...
  script_cve_id("CVE-2013-1984");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2013-1984");
...
patch available.
  ...
  - Multiple integer overflows in X.org libXi 1.7.1 and earlier allow X servers to trigger allocation of
    ...
    XIGetSelectedEvents, (7) XGetDeviceProperties, and (8) XListInputDevices functions. (CVE-2013-1984)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-1984");
