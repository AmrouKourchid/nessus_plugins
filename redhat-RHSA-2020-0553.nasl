...
# extracted from Red Hat Security Advisory RHSA-2020:0553. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:0553");

  script_name(english:"RHEL 8 : rabbitmq-server (RHSA-2020:0553)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_0553.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a33e0bad");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:0553");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1783327");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1786326");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rabbitmq-server package based on the guidance in RHSA-2020:0553.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rabbitmq-server-3.7.23-2.el8ost', 'cpu':'ppc64le', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'rabbitmq-server-3.7.23-2.el8ost', 'cpu':'x86_64', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
