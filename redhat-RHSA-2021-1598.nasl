...
# extracted from Red Hat Security Advisory RHSA-2021:1598. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:1598");

  script_name(english:"RHEL 8 : bluez (RHSA-2021:1598)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for bluez.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2021:1598 advisory.
    ...
    * bluez: double free in gatttool client disconnect callback handler in src/shared/att.c could lead to DoS
    or RCE (CVE-2020-27153)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_1598.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?104a0fc2");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/8.4_release_notes/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?862005a9");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:1598");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1884817");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL bluez package based on the guidance in RHSA-2021:1598.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'bluez-5.52-4.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bluez-cups-5.52-4.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bluez-hid2hci-5.52-4.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bluez-libs-5.52-4.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bluez-libs-devel-5.52-4.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bluez-obexd-5.52-4.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
