...
# extracted from Fedora Security Advisory FEDORA-2024-bdda1791b5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-bdda1791b5");

  script_name(english:"Fedora 40 : moodle (2024-bdda1791b5)");
...
FEDORA-2024-bdda1791b5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-bdda1791b5");
...
"Update the affected moodle package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-55647");
...
var pkgs = [
    {'reference':'moodle-4.3.9-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
