...
# extracted from Gentoo Linux Security Advisory GLSA 200505-10.
#
...
if (description)
{
  ...
  script_bugtraq_id(13344);
  script_xref(name:"GLSA", value:"200505-10");

  script_name(english:"GLSA-200505-10 : phpBB: XSS Vulnerability");
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://securitytracker.com/id?1013918");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/200505-10");
...
if (qpkg_check(package:"www-apps/phpBB", unaffected:make_list("ge 2.0.15"), vulnerable:make_list("lt 2.0.15"))) flag++;
