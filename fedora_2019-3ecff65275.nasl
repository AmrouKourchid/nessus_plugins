...
# extracted from Fedora Security Advisory FEDORA-2019-3ecff65275.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-3ecff65275");

  script_name(english:"Fedora 29 : kubernetes (2019-3ecff65275)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-3ecff65275");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"kubernetes-1.12.5-2.fc29")) flag++;
