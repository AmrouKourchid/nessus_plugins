...
# extracted from Oracle Linux Security Advisory ELSA-2023-0842.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : tar (ELSA-2023-0842)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-0842.html");
