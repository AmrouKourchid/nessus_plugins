...
if (description)
{
  ...
  script_cve_id("CVE-2018-1099");

  script_name(english:"Photon OS 3.0: Etcd PHSA-2023-3.0-0603");
...
if (rpm_exists(rpm:'etcd-3.3', release:'PhotonOS-3.0') && rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'etcd-3.3.27-13.ph3')) flag++;
if (rpm_exists(rpm:'etcd-3.5', release:'PhotonOS-3.0') && rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'etcd-3.5.1-12.ph3')) flag++;
