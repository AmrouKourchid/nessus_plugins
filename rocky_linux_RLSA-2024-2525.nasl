...
# Rocky Linux Security Advisory RLSA-2024:2525.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2024:2525");

  script_name(english:"RockyLinux 9 : mingw-pixman (RLSA-2024:2525)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2024:2525");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2139988");
  script_set_attribute(attribute:"solution", value:
"Update the affected mingw32-pixman and / or mingw64-pixman packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:rocky:linux:mingw32-pixman");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:rocky:linux:mingw64-pixman");
...
var pkgs = [
    {'reference':'mingw32-pixman-0.42.2-3.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'mingw64-pixman-0.42.2-3.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'}
];
