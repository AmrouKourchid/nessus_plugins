...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : cups-filters (EulerOS-SA-2023-3120)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3120
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?41ceacc1");
...
var pkgs = [
  "cups-filters-1.20.3-9.h1.eulerosv2r8",
  "cups-filters-libs-1.20.3-9.h1.eulerosv2r8"
];
