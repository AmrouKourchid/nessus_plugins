...
# extracted from openSUSE Security Update openSUSE-2018-1417.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : LibreOffice and dependency libraries (openSUSE-2018-1417)");
...
This update was imported from the SUSE:SLE-15:Update update project.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1094779");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1096360");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1098891");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1104876");
  script_set_attribute(attribute:"see_also", value:"https://features.opensuse.org/");
  script_set_attribute(attribute:"see_also", value:"https://wiki.documentfoundation.org/ReleaseNotes/6.1");
  script_set_attribute(attribute:"solution", value:
"Update the affected LibreOffice and dependency libraries packages.");
