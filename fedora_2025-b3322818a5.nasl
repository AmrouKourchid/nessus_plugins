...
# extracted from Fedora Security Advisory FEDORA-2025-b3322818a5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-b3322818a5");

  script_name(english:"Fedora 41 : FlightGear / SimGear (2025-b3322818a5)");
...
FEDORA-2025-b3322818a5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-b3322818a5");
...
var pkgs = [
    {'reference':'FlightGear-2020.3.19-8.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'SimGear-2020.3.19-7.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
