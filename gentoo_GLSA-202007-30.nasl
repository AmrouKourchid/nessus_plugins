...
# extracted from Gentoo Linux Security Advisory GLSA 202007-30.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202007-30");

  script_name(english:"GLSA-202007-30 : spice: Arbitrary code execution");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202007-30
(spice: Arbitrary code execution)

    A flaw in spice&rsquo;s memory handling code has been discovered, allowing
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202007-30");
...
if (qpkg_check(package:"app-emulation/spice", unaffected:make_list("ge 0.14.2"), vulnerable:make_list("lt 0.14.2"))) flag++;
