...
if (description)
{
  ...
  script_name(english:"Java JRE Enabled (Google Chrome)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host has JRE enabled for Google Chrome.");
  script_set_attribute(attribute:"description", value:
"Java JRE is enabled in Google Chrome.");
...
"Disable Java unless it is needed.");
  ...
  script_require_keys("SMB/Java/JRE/chrome_enabled");
...
users = get_kb_item_or_exit("SMB/Java/JRE/chrome_enabled");
...
{
  report =
    '\nJava is enabled in Google Chrome for the following users :' +
    '\n' +
    '  ' + users + '\n';
