...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : libX11 on SL7.x x86_64 (20201104)");
...
"Security Fix(es) :
  ...
  - libX11: integer overflow leads to double free in locale
    handling (CVE-2020-14363)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind2011&L=SCIENTIFIC-LINUX-ERRATA&P=79
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e60f9556");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"libX11-1.6.7-3.el7_9")) flag++;
if (rpm_check(release:"SL7", reference:"libX11-common-1.6.7-3.el7_9")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"libX11-debuginfo-1.6.7-3.el7_9")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"libX11-devel-1.6.7-3.el7_9")) flag++;
