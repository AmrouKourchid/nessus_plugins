...
# Oracle Linux Security Advisory ELSA-2018-3107 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : wpa_supplicant (ELSA-2018-3107)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2018-3107.html");
...
var pkgs = [
    {'reference':'wpa_supplicant-2.6-12.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
