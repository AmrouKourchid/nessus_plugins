...
ELSA-2014-0981 advisory.
    ...
    {CVE-2014-4699}
    - [net] filter: prevent nla extensions to peek beyond the end of the message (Jiri Benc) [1096778 1096779]
    {CVE-2014-3144 CVE-2014-3145}
    - [net] rds: prevent dereference of a NULL device in rds_iw_laddr_check (Radomir Vrbovsky) [1083276
    1083277] {CVE-2014-2678}
    - [kernel] futex: Forbid uaddr == uaddr2 in futex_wait_requeue_pi() (Mateusz Guzik) [1097759 1097760]
    {CVE-2012-6647}
    - [net] mac80211: crash dues to AP powersave TX vs. wakeup race (Jacob Tanenbaum) [1083531 1083532]
    {CVE-2014-2706}
    - [netdrv] ath9k: tid->sched race in ath_tx_aggr_sleep() (Jacob Tanenbaum) [1083249 1083250]
    {CVE-2014-2672}
    ...
    - [kernel] futex: Always cleanup owner tid in unlock_pi (Jerome Marchand) [1104516 1104517]
    {CVE-2014-3153}
    - [kernel] futex: Validate atomic acquisition in futex_lock_pi_atomic() (Jerome Marchand) [1104516
    1104517] {CVE-2014-3153}
    - [kernel] futex: prevent requeue pi on same futex (Jerome Marchand) [1104516 1104517] {CVE-2014-3153}
    - [block] floppy: don't write kernel-only members to FDRAWCMD ioctl output (Denys Vlasenko) [1094308
    1094310] {CVE-2014-1738 CVE-2014-1737}
    - [block] floppy: ignore kernel-only members in FDRAWCMD ioctl input (Denys Vlasenko) [1094308 1094310]
    {CVE-2014-1738 CVE-2014-1737}
    - [fs] vfs: fix autofs/afs/etc magic mountpoint breakage (Frantisek Hrbata) [1094370 1079347]
    {CVE-2014-0203}
...
var pkgs = [
    ...
    {'reference':'kernel-abi-whitelists-2.6.32-431.23.3.el6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-abi-whitelists-2.6.32'},
    ...
    {'reference':'kernel-firmware-2.6.32-431.23.3.el6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-firmware-2.6.32'},
    ...
    {'reference':'kernel-abi-whitelists-2.6.32-431.23.3.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-abi-whitelists-2.6.32'},
    ...
    {'reference':'kernel-firmware-2.6.32-431.23.3.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-firmware-2.6.32'},
