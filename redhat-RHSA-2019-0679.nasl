...
# extracted from Red Hat Security Advisory RHSA-2019:0679. The text 
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_0679.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ae2d2d1b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:0679");
...
"Update the RHEL libssh2 package based on the guidance in RHSA-2019:0679.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libssh2-1.4.3-12.el7_6.2', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libssh2-devel-1.4.3-12.el7_6.2', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libssh2-docs-1.4.3-12.el7_6.2', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
