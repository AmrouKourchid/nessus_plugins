...
# extracted from Red Hat Security Advisory RHSA-2020:0850. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : python-pip (RHSA-2020:0850)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for python-pip.");
...
referenced in the RHSA-2020:0850 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_0850.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f713d428");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:0850");
...
"Update the RHEL python-pip package based on the guidance in RHSA-2020:0850.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-pip-9.0.3-7.el7_7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
