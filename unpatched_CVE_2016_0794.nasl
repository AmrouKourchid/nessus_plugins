...
if (description)
{
  ...
  script_cve_id("CVE-2016-0794");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2016-0794");
...
patch available.
  ...
  - The lwp filter in LibreOffice before 5.0.4 allows remote attackers to cause a denial of service (memory
    corruption) or possibly have unspecified other impact via a crafted LotusWordPro (lwp) document.
    (CVE-2016-0794)
