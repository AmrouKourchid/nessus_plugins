...
# Oracle Linux Security Advisory ELSA-2008-0818 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : hplip (ELSA-2008-0818)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2008-0818.html");
...
"Update the affected hpijs, hplip and / or libsane-hpaio packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2008-2940");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2008-2941");
...
var pkgs = [
    {'reference':'hpijs-1.6.7-4.1.el5_2.4', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'hplip-1.6.7-4.1.el5_2.4', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libsane-hpaio-1.6.7-4.1.el5_2.4', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'hpijs-1.6.7-4.1.el5_2.4', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'hplip-1.6.7-4.1.el5_2.4', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libsane-hpaio-1.6.7-4.1.el5_2.4', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
