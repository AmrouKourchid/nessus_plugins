...
if (description)
{
  ...
  script_xref(name:"APPLE-SA", value:"122374");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2025/02/19");
  script_xref(name:"IAVA", value:"2025-A-0222");

  script_name(english:"macOS 14.x < 14.7.5 Multiple Vulnerabilities (122374)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host is missing a macOS update that fixes multiple vulnerabilities");
  script_set_attribute(attribute:"description", value:
"The remote host is running a version of macOS / Mac OS X that is 14.x prior to 14.7.5. It is, therefore, affected by
...
version number.");
  script_set_attribute(attribute:"see_also", value:"https://support.apple.com/en-us/122374");
...
var constraints = [
  { 'fixed_version' : '14.7.5', 'min_version' : '14.0', 'fixed_display' : 'macOS Sonoma 14.7.5' }
];
