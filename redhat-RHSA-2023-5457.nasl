...
# extracted from Red Hat Security Advisory RHSA-2023:5457. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:5457");

  script_name(english:"RHEL 9 : frr (RHSA-2023:5457)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_5457.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6e8b40c8");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2230983");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:5457");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL frr package based on the guidance in RHSA-2023:5457.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'frr-8.0-5.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
