...
if (description)
{
  ...
  script_name(english:"RHEL 4 : lynx (RHSA-2005:803)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for lynx.");
...
the RHSA-2005:803 advisory.

  - CAN-2005-3120 lynx buffer overflow (CVE-2005-3120)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2005/rhsa-2005_803.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a486aa86");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#critical");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=170253");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2005:803");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL lynx package based on the guidance in RHSA-2005:803.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2005-3120");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'lynx-2.8.5-18.1', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'lynx-2.8.5-18.1', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'lynx-2.8.5-18.1', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'lynx-2.8.5-18.1', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'lynx-2.8.5-18.1', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
