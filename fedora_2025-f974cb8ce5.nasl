...
# extracted from Fedora Security Advisory FEDORA-2025-f974cb8ce5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-f974cb8ce5");
  script_xref(name:"IAVB", value:"2025-B-0048-S");

  script_name(english:"Fedora 40 : golang (2025-f974cb8ce5)");
...
FEDORA-2025-f974cb8ce5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-f974cb8ce5");
...
var pkgs = [
    {'reference':'golang-1.23.8-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
