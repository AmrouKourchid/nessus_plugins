...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS : libssh vulnerability (USN-5053-1)");
...
USN-5053-1 advisory.
    ...
    It was discovered that libssh incorrectly handled rekeying. A remote attacker could use this issue to
    cause libssh to crash, resulting in a denial of service, or possibly execute arbitrary code.
