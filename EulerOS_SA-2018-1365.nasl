...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : 389-ds-base (EulerOS-SA-2018-1365)");
...
vulnerabilities :
  ...
  - race condition on reference counter leads to DoS using
    persistent search (CVE-2018-10850)

  - ldapsearch with server side sort allows users to cause
    a crash (CVE-2018-10935)

  - Server crash through modify command with large DN
    (CVE-2018-14624)

  - Crash in delete_passwdPolicy when persistent search
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1365
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?07028945");
...
pkgs = ["389-ds-base-1.3.7.5-28",
        "389-ds-base-libs-1.3.7.5-28"];
