...
# extracted from Fedora Security Advisory FEDORA-2024-ccdbd92d7b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-ccdbd92d7b");

  script_name(english:"Fedora 40 : gimp (2024-ccdbd92d7b)");
...
FEDORA-2024-ccdbd92d7b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-ccdbd92d7b");
  script_set_attribute(attribute:"solution", value:
"Update the affected 2:gimp package.");
...
var pkgs = [
    {'reference':'gimp-2.10.38-12.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
