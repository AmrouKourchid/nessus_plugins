...
# extracted from Ubuntu Security Notice USN-3479-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS : PostgreSQL vulnerabilities (USN-3479-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 14.04 LTS / 16.04 LTS host has packages installed that are affected by multiple vulnerabilities as
referenced in the USN-3479-1 advisory.

    David Rowley discovered that PostgreSQL incorrectly handled memory when processing certain JSON functions.
    A remote attacker could possibly use this issue to obtain sensitive information. (CVE-2017-15098)

    Dean Rasheed discovered that PostgreSQL incorrectly enforced SELECT privileges when processing INSERT ...
    ON CONFLICT DO UPDATE commands. A remote attacker could possibly use this issue to obtain sensitive
    information. This issue only affected Ubuntu 16.04 LTS, Ubuntu 17.04 and Ubuntu 17.10.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3479-1");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-15098");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'libecpg-compat3', 'pkgver': '9.3.20-0ubuntu0.14.04'},
    {'osver': '14.04', 'pkgname': 'libecpg-dev', 'pkgver': '9.3.20-0ubuntu0.14.04'},
    {'osver': '14.04', 'pkgname': 'libecpg6', 'pkgver': '9.3.20-0ubuntu0.14.04'},
    {'osver': '14.04', 'pkgname': 'libpgtypes3', 'pkgver': '9.3.20-0ubuntu0.14.04'},
    {'osver': '14.04', 'pkgname': 'libpq-dev', 'pkgver': '9.3.20-0ubuntu0.14.04'},
    {'osver': '14.04', 'pkgname': 'libpq5', 'pkgver': '9.3.20-0ubuntu0.14.04'},
    {'osver': '14.04', 'pkgname': 'postgresql-9.3', 'pkgver': '9.3.20-0ubuntu0.14.04'},
    {'osver': '14.04', 'pkgname': 'postgresql-client-9.3', 'pkgver': '9.3.20-0ubuntu0.14.04'},
    {'osver': '14.04', 'pkgname': 'postgresql-contrib-9.3', 'pkgver': '9.3.20-0ubuntu0.14.04'},
    {'osver': '14.04', 'pkgname': 'postgresql-plperl-9.3', 'pkgver': '9.3.20-0ubuntu0.14.04'},
    {'osver': '14.04', 'pkgname': 'postgresql-plpython-9.3', 'pkgver': '9.3.20-0ubuntu0.14.04'},
    {'osver': '14.04', 'pkgname': 'postgresql-plpython3-9.3', 'pkgver': '9.3.20-0ubuntu0.14.04'},
    {'osver': '14.04', 'pkgname': 'postgresql-pltcl-9.3', 'pkgver': '9.3.20-0ubuntu0.14.04'},
    {'osver': '14.04', 'pkgname': 'postgresql-server-dev-9.3', 'pkgver': '9.3.20-0ubuntu0.14.04'},
    {'osver': '16.04', 'pkgname': 'libecpg-compat3', 'pkgver': '9.5.10-0ubuntu0.16.04'},
    {'osver': '16.04', 'pkgname': 'libecpg-dev', 'pkgver': '9.5.10-0ubuntu0.16.04'},
    {'osver': '16.04', 'pkgname': 'libecpg6', 'pkgver': '9.5.10-0ubuntu0.16.04'},
    {'osver': '16.04', 'pkgname': 'libpgtypes3', 'pkgver': '9.5.10-0ubuntu0.16.04'},
    {'osver': '16.04', 'pkgname': 'libpq-dev', 'pkgver': '9.5.10-0ubuntu0.16.04'},
    {'osver': '16.04', 'pkgname': 'libpq5', 'pkgver': '9.5.10-0ubuntu0.16.04'},
    {'osver': '16.04', 'pkgname': 'postgresql-9.5', 'pkgver': '9.5.10-0ubuntu0.16.04'},
    {'osver': '16.04', 'pkgname': 'postgresql-client-9.5', 'pkgver': '9.5.10-0ubuntu0.16.04'},
    {'osver': '16.04', 'pkgname': 'postgresql-contrib-9.5', 'pkgver': '9.5.10-0ubuntu0.16.04'},
    {'osver': '16.04', 'pkgname': 'postgresql-plperl-9.5', 'pkgver': '9.5.10-0ubuntu0.16.04'},
    {'osver': '16.04', 'pkgname': 'postgresql-plpython-9.5', 'pkgver': '9.5.10-0ubuntu0.16.04'},
    {'osver': '16.04', 'pkgname': 'postgresql-plpython3-9.5', 'pkgver': '9.5.10-0ubuntu0.16.04'},
    {'osver': '16.04', 'pkgname': 'postgresql-pltcl-9.5', 'pkgver': '9.5.10-0ubuntu0.16.04'},
    {'osver': '16.04', 'pkgname': 'postgresql-server-dev-9.5', 'pkgver': '9.5.10-0ubuntu0.16.04'}
];
