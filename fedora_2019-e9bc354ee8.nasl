...
# extracted from Fedora Security Advisory FEDORA-2019-e9bc354ee8.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : libwmf (2019-e9bc354ee8)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-e9bc354ee8");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"libwmf-0.2.12-1.fc28")) flag++;
