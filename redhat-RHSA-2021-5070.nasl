...
# extracted from Red Hat Security Advisory RHSA-2021:5070. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:5070");

  script_name(english:"RHEL 8 : Red Hat OpenStack Platform 16.1 (python-django20) (RHSA-2021:5070)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for Red Hat OpenStack Platform 16.1 (python-django20).");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2021:5070 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_5070.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9cd8bc8e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:5070");
...
"Update the RHEL Red Hat OpenStack Platform 16.1 (python-django20) package based on the guidance in RHSA-2021:5070.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python-django20-bash-completion-2.0.13-16.el8ost.1', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
