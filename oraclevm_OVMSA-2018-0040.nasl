...
# Security Advisory OVMSA-2018-0040.
#
...
if (description)
{
  ...
  script_name(english:"OracleVM 3.4 : Unbreakable / etc (OVMSA-2018-0040)");
...
critical security updates :
  ...
  - vhost/scsi: fix reuse of &vq->iov[out] in response
    (Benjamin Coddington) [Orabug: 27928330]

  - kernel.spec: add requires system-release for OL7 (Brian
    Maly) 

  - x86/kernel/traps.c: fix trace_die_notifier return value
    (Kris Van Hees) (CVE-2018-8897)
  ...
  script_set_attribute(attribute:"see_also", value:"https://oss.oracle.com/pipermail/oraclevm-errata/2018-May/000851.html");
...
flag = 0;
if (rpm_check(release:"OVS3.4", reference:"kernel-uek-4.1.12-124.14.5.el6uek")) flag++;
if (rpm_check(release:"OVS3.4", reference:"kernel-uek-firmware-4.1.12-124.14.5.el6uek")) flag++;
