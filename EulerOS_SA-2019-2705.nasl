...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : zsh (EulerOS-SA-2019-2705)");
...
vulnerability :
  ...
  - In zsh before 5.3, an off-by-one error resulted in
    undersized buffers that were intended to support
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2705
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e99c1279");
...
"Update the affected zsh package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-10714");
...
pkgs = ["zsh-5.0.2-28.h10.eulerosv2r7"];
