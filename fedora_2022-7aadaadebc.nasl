...
# extracted from Fedora Security Advisory FEDORA-2022-7aadaadebc
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-7aadaadebc");

  script_name(english:"Fedora 37 : kernel (2022-7aadaadebc)");
...
FEDORA-2022-7aadaadebc advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-7aadaadebc");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  var cve_list = make_list('CVE-2022-3640');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for FEDORA-2022-7aadaadebc');
  }
  else
  {
...
var pkgs = [
    {'reference':'kernel-6.0.8-300.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
