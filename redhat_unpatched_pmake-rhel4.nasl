...
# extracted from Red Hat Security Advisory pmake. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 4 : pmake (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:pmake");
