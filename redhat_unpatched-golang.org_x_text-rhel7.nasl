...
# extracted from Red Hat Security Advisory golang.org_x_text. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2020-14040", "CVE-2020-28851", "CVE-2020-28852");

  script_name(english:"RHEL 7 : golang.org_x_text (Unpatched Vulnerability) (deprecated)");
