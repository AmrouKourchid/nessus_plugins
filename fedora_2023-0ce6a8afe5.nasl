...
# extracted from Fedora Security Advisory FEDORA-2023-0ce6a8afe5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-0ce6a8afe5");

  script_name(english:"Fedora 38 : xrdp (2023-0ce6a8afe5)");
...
FEDORA-2023-0ce6a8afe5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-0ce6a8afe5");
...
var pkgs = [
    {'reference':'xrdp-0.9.23.1-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
