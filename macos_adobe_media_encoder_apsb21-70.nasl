...
if (description)
{
  ...
  script_name(english:"Adobe Media Encoder < 15.4.1 Multiple Arbitrary code execution (APSB21-70) (macOS)");

  script_set_attribute(attribute:"synopsis", value:
"The Adobe Media Encoder instance installed on the remote host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Media Encoder installed on the remote macOS host is prior to 15.4.1. It is, therefore, affected by
multiple vulnerabilities as referenced in the APSB21-70 advisory.
