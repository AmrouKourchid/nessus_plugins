...
# extracted from Fedora Security Advisory FEDORA-2023-8cc9731416
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-8cc9731416");
  script_xref(name:"IAVA", value:"2023-A-0203-S");

  script_name(english:"Fedora 37 : chromium (2023-8cc9731416)");
...
FEDORA-2023-8cc9731416 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-8cc9731416");
...
var pkgs = [
    {'reference':'chromium-112.0.5615.121-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
