...
# extracted from Fedora Security Advisory FEDORA-2023-0e9e7544df
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-0e9e7544df");

  script_name(english:"Fedora 37 : redis (2023-0e9e7544df)");
...
FEDORA-2023-0e9e7544df advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-0e9e7544df");
...
var pkgs = [
    {'reference':'redis-7.0.13-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
