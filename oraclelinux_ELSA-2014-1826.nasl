...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2014-1826.html");
...
"Update the affected libvncserver and / or libvncserver-devel packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2014-6054");
...
var pkgs = [
    {'reference':'libvncserver-0.9.7-7.el6_6.1', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libvncserver-devel-0.9.7-7.el6_6.1', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libvncserver-0.9.7-7.el6_6.1', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libvncserver-devel-0.9.7-7.el6_6.1', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libvncserver-0.9.9-9.el7_0.1', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libvncserver-devel-0.9.9-9.el7_0.1', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libvncserver-0.9.9-9.el7_0.1', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libvncserver-devel-0.9.9-9.el7_0.1', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libvncserver-0.9.9-9.el7_0.1', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libvncserver-devel-0.9.9-9.el7_0.1', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
];
