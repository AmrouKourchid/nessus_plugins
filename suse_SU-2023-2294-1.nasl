...
referenced in the SUSE-SU-2023:2294-1 advisory.
...
var pkgs = [
    {'reference':'rmt-server-2.13-150200.3.32.1', 'sp':'2', 'cpu':'x86_64', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.2']},
    {'reference':'rmt-server-config-2.13-150200.3.32.1', 'sp':'2', 'cpu':'x86_64', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.2']},
    {'reference':'rmt-server-pubcloud-2.13-150200.3.32.1', 'sp':'2', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.2']},
    ...
    {'reference':'rmt-server-pubcloud-2.13-150200.3.32.1', 'sp':'2', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.2', 'sle-module-public-cloud-release-15.2', 'sles-release-15.2']},
