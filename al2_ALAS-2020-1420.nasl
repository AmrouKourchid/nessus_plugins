...
"The version of ipmitool installed on the remote host is prior to 1.8.18-9. It is, therefore, affected by a vulnerability
as referenced in the ALAS2-2020-1420 advisory.
...
var pkgs = [
    {'reference':'bmc-snmp-proxy-1.8.18-9.amzn2', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'exchange-bmc-os-info-1.8.18-9.amzn2', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ipmitool-1.8.18-9.amzn2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ipmitool-1.8.18-9.amzn2', 'cpu':'i686', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ipmitool-1.8.18-9.amzn2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ipmitool-debuginfo-1.8.18-9.amzn2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ipmitool-debuginfo-1.8.18-9.amzn2', 'cpu':'i686', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ipmitool-debuginfo-1.8.18-9.amzn2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
