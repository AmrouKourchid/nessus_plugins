...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : libxml2 (EulerOS-SA-2024-2005)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2005
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b55e834b");
...
var pkgs = [
  "libxml2-2.9.10-11.h27.eulerosv2r10",
  "python3-libxml2-2.9.10-11.h27.eulerosv2r10"
];
