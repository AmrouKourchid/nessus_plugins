...
if (description)
{
  ...
  script_name(english:"CentOS 9 : qt5-qtbase-5.15.9-7.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update for qt5-qtbase.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 9 host has packages installed that are affected by a vulnerability as referenced in the
qt5-qtbase-5.15.9-7.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=35123");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream qt5-qtbase package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:qt5-qtbase-tests");
...
var pkgs = [
    {'reference':'qt5-qtbase-5.15.9-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'qt5-qtbase-common-5.15.9-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'qt5-qtbase-devel-5.15.9-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'qt5-qtbase-examples-5.15.9-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'qt5-qtbase-gui-5.15.9-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'qt5-qtbase-mysql-5.15.9-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'qt5-qtbase-odbc-5.15.9-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'qt5-qtbase-postgresql-5.15.9-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'qt5-qtbase-private-devel-5.15.9-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'qt5-qtbase-static-5.15.9-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'qt5-qtbase-tests-5.15.9-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
