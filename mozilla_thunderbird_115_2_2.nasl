...
"The version of Thunderbird installed on the remote Windows host is prior to 115.2.2. It is, therefore, affected by a
...
mozilla_check_version(installs:installs, product:'thunderbird', esr:FALSE, fix:'115.2.2', min:'115.0.0', severity:SECURITY_HOLE);
