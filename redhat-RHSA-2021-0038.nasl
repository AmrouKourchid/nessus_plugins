...
if (description)
{
  ...
  script_name(english:"RHEL 7 / 8 : OpenShift Container Platform 4.6.12 (RHSA-2021:0038)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for OpenShift Container Platform 4.6.12.");
...
referenced in the RHSA-2021:0038 advisory.
    ...
    * jenkins-2-plugins/kubernetes: Jenkins controller environment variables are accessible in Kubernetes
    Plugin (CVE-2020-2307)

    * jenkins-2-plugins/kubernetes: Missing permission check in Kubernetes Plugin allows listing pod templates
    (CVE-2020-2308)

    * jenkins-2-plugins/kubernetes: Missing permission check in Kubernetes Plugin allows enumerating
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_0038.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6914f7b2");
...
"Update the RHEL OpenShift Container Platform 4.6.12 packages based on the guidance in RHSA-2021:0038.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:S/C:P/I:N/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:L/UI:N/S:U/C:H/I:N/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-2309");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2020-2305");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cri-o-1.19.1-2.rhaos4.6.git2af9ecf.el8', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2020-28362']},
      {'reference':'cri-o-1.19.1-2.rhaos4.6.git2af9ecf.el8', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2020-28362']},
      {'reference':'cri-o-1.19.1-2.rhaos4.6.git2af9ecf.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2020-28362']},
      {'reference':'jenkins-2-plugins-4.6.1609853716-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2020-2304', 'CVE-2020-2305', 'CVE-2020-2306', 'CVE-2020-2307', 'CVE-2020-2308', 'CVE-2020-2309']},
      {'reference':'openshift-clients-4.6.0-202012172338.p0.git.3800.30af700.el8', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2020-28362']},
      {'reference':'openshift-clients-4.6.0-202012172338.p0.git.3800.30af700.el8', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2020-28362']},
      {'reference':'openshift-clients-4.6.0-202012172338.p0.git.3800.30af700.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2020-28362']},
      {'reference':'openshift-clients-redistributable-4.6.0-202012172338.p0.git.3800.30af700.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2020-28362']},
      {'reference':'openshift-hyperkube-4.6.0-202012190744.p0.git.94235.c62c6f7.el8', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2020-28362']},
      {'reference':'openshift-hyperkube-4.6.0-202012190744.p0.git.94235.c62c6f7.el8', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2020-28362']},
      {'reference':'openshift-hyperkube-4.6.0-202012190744.p0.git.94235.c62c6f7.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2020-28362']}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'jenkins-2-plugins-4.6.1608634578-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2020-2304', 'CVE-2020-2305', 'CVE-2020-2306', 'CVE-2020-2307', 'CVE-2020-2308', 'CVE-2020-2309']},
      {'reference':'openshift-clients-4.6.0-202012172338.p0.git.3800.30af700.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2020-28362']},
      {'reference':'openshift-clients-redistributable-4.6.0-202012172338.p0.git.3800.30af700.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2020-28362']},
      {'reference':'openshift-hyperkube-4.6.0-202012190744.p0.git.94235.c62c6f7.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2020-28362']}
    ]
  }
];
