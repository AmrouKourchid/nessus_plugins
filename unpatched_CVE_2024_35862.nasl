...
if (description)
{
  ...
  script_cve_id("CVE-2024-35862");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-35862");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: smb: client: fix potential UAF in
    smb2_is_network_name_deleted() Skip sessions that are being teared down (status == SES_EXITING) to avoid
    UAF. (CVE-2024-35862)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-35862");
