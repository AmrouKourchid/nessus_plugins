...
if (description)
{
  ...
  script_name(english:"Foxit PDF Editor < 12.0.1 Multiple Vulnerabilities");
...
"Upgrade to Foxit PDF Editor version 12.0.1 or later");
...
var constraints = [
  { 'max_version' : '10.1.8.37795', 'fixed_version' : '12.0.1' },
  { 'min_version' : '11.0', 'max_version' : '11.2.2.53575', 'fixed_version' : '12.0.1' },
  { 'min_version' : '12.0.0.12394', 'fixed_version' : '12.0.1' }
];
