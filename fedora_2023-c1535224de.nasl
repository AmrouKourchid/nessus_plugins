...
# extracted from Fedora Security Advisory FEDORA-2023-c1535224de
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-c1535224de");
  script_xref(name:"IAVA", value:"2023-A-0567-S");

  script_name(english:"Fedora 37 : wordpress (2023-c1535224de)");
...
FEDORA-2023-c1535224de advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-c1535224de");
...
var pkgs = [
    {'reference':'wordpress-6.2.3-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
