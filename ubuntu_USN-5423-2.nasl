...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 ESM : ClamAV vulnerabilities (USN-5423-2)");
...
the USN-5423-2 advisory.

    USN-5423-1 fixed several vulnerabilities in ClamAV. This update provides the corresponding update for
    Ubuntu 14.04 ESM and 16.04 ESM.
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'clamav', 'pkgver': '0.103.6+dfsg-0ubuntu0.16.04.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'clamav-base', 'pkgver': '0.103.6+dfsg-0ubuntu0.16.04.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'clamav-daemon', 'pkgver': '0.103.6+dfsg-0ubuntu0.16.04.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'clamav-freshclam', 'pkgver': '0.103.6+dfsg-0ubuntu0.16.04.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'clamav-milter', 'pkgver': '0.103.6+dfsg-0ubuntu0.16.04.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'clamav-testfiles', 'pkgver': '0.103.6+dfsg-0ubuntu0.16.04.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'clamdscan', 'pkgver': '0.103.6+dfsg-0ubuntu0.16.04.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libclamav-dev', 'pkgver': '0.103.6+dfsg-0ubuntu0.16.04.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libclamav9', 'pkgver': '0.103.6+dfsg-0ubuntu0.16.04.1+esm1', 'ubuntu_pro': TRUE}
];
