...
user via a specially crafted Zip archive.");
  script_set_attribute(attribute:"see_also", value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=900953");
  # https://security-tracker.debian.org/tracker/source-package/plexus-archiver
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e0f6b9d5");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/jessie/plexus-archiver");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/stretch/plexus-archiver");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2018/dsa-4227");
