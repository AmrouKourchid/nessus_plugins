...
if (description)
{
  ...
  script_cve_id("CVE-2022-49253");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-49253");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: media: usb: go7007: s2250-board: fix
    leak in probe() Call i2c_unregister_device(audio) on this error path. (CVE-2022-49253)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-49253");
