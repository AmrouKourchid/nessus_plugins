...
# extracted from Red Hat Security Advisory RHSA-2022:0440. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:0440");

  script_name(english:"RHEL 8 : aide (RHSA-2022:0440)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_0440.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f265e50e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:0440");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2041489");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL aide package based on the guidance in RHSA-2022:0440.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'aide-0.16-14.el8_4.1', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
