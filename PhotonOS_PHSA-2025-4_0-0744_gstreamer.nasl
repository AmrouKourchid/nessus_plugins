...
# extracted from VMware Security Advisory PHSA-2025-4.0-0744. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Gstreamer PHSA-2025-4.0-0744");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the gstreamer package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-744.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'gstreamer-1.25.1-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'gstreamer-devel-1.25.1-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'gstreamer-plugins-base-1.25.1-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'gstreamer-plugins-base-devel-1.25.1-1.ph4')) flag++;
