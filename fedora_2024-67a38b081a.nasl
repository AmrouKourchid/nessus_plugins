...
# extracted from Fedora Security Advisory FEDORA-2024-67a38b081a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-67a38b081a");

  script_name(english:"Fedora 41 : microcode_ctl (2024-67a38b081a)");
...
FEDORA-2024-67a38b081a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-67a38b081a");
...
var pkgs = [
    {'reference':'microcode_ctl-2.1-64.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
