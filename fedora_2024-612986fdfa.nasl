...
# extracted from Fedora Security Advisory FEDORA-2024-612986fdfa
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-612986fdfa");

  script_name(english:"Fedora 40 : pypy (2024-612986fdfa)");
...
FEDORA-2024-612986fdfa advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-612986fdfa");
...
var pkgs = [
    {'reference':'pypy-7.3.15-3.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
