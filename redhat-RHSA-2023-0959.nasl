...
# extracted from Red Hat Security Advisory RHSA-2023:0959. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:0959");

  script_name(english:"RHEL 9 : tar (RHSA-2023:0959)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_0959.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c984ed36");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2149722");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:0959");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL tar package based on the guidance in RHSA-2023:0959.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'tar-1.34-6.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
    ]
  }
];
