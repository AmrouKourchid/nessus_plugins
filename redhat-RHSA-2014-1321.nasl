...
if (description)
{
  ...
  script_name(english:"RHEL 5 / 6 : Red Hat JBoss Enterprise Application Platform 5.2.0 (RHSA-2014:1321)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for Red Hat JBoss Enterprise Application Platform 5.2.0.");
...
referenced in the RHSA-2014:1321 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2014/rhsa-2014_1321.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2ff0ecc9");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2014:1321");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat JBoss Enterprise Application Platform 5.2.0 package based on the guidance in RHSA-2014:1321.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jakarta-commons-httpclient-3.1-4_patch_02.ep5.el5', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'eap5'},
      {'reference':'jboss-seam2-2.2.6.EAP5-22_patch_01.ep5.el5', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap5'},
      {'reference':'jboss-seam2-docs-2.2.6.EAP5-22_patch_01.ep5.el5', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap5'},
      {'reference':'jboss-seam2-examples-2.2.6.EAP5-22_patch_01.ep5.el5', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap5'},
      {'reference':'jboss-seam2-runtime-2.2.6.EAP5-22_patch_01.ep5.el5', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap5'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'jakarta-commons-httpclient-3.1-4_patch_02.el6_5', 'release':'6', 'el_string':'el6_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'eap5'},
      {'reference':'jboss-seam2-2.2.6.EAP5-22_patch_01.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap5'},
      {'reference':'jboss-seam2-docs-2.2.6.EAP5-22_patch_01.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap5'},
      {'reference':'jboss-seam2-examples-2.2.6.EAP5-22_patch_01.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap5'},
      {'reference':'jboss-seam2-runtime-2.2.6.EAP5-22_patch_01.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap5'}
    ]
  }
];
