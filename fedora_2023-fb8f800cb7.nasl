...
# extracted from Fedora Security Advisory FEDORA-2023-fb8f800cb7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-fb8f800cb7");

  script_name(english:"Fedora 37 : LibRaw (2023-fb8f800cb7)");
...
FEDORA-2023-fb8f800cb7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-fb8f800cb7");
...
var pkgs = [
    {'reference':'LibRaw-0.20.2-8.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
