...
# extracted from Gentoo Linux Security Advisory GLSA 201810-03.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201810-03");

  script_name(english:"GLSA-201810-03 : OpenSSH: User enumeration vulnerability");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-201810-03
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/201810-03");
...
if (qpkg_check(package:"net-misc/openssh", unaffected:make_list("ge 7.7_p1-r8"), vulnerable:make_list("lt 7.7_p1-r8"))) flag++;
