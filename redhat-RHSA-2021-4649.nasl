...
# extracted from Red Hat Security Advisory RHSA-2021:4649. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 8 : gcc-toolset-10-binutils (RHSA-2021:4649)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_4649.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5e8b5ed2");
...
"Update the RHEL gcc-toolset-10-binutils package based on the guidance in RHSA-2021:4649.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gcc-toolset-10-binutils-2.35-8.el8_5.6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gcc-toolset-10-binutils-devel-2.35-8.el8_5.6', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
