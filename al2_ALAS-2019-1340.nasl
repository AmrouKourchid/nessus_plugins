...
# extracted from Amazon Linux 2 Security Advisory ALAS-2019-1340.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2019-1340");

  script_name(english:"Amazon Linux 2 : curl (ALAS-2019-1340)");
...
7.65.3.(CVE-2019-5482)");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2019-1340.html");
...
flag = 0;
if (rpm_check(release:"AL2", reference:"curl-7.61.1-12.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"curl-debuginfo-7.61.1-12.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"libcurl-7.61.1-12.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"libcurl-devel-7.61.1-12.amzn2.0.1")) flag++;
