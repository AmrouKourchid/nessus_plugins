...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : gnutls (EulerOS-SA-2024-2029)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2029
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?094b9dcd");
...
var pkgs = [
  "gnutls-3.6.7-1.h12.eulerosv2r8",
  "gnutls-c++-3.6.7-1.h12.eulerosv2r8",
  "gnutls-dane-3.6.7-1.h12.eulerosv2r8",
  "gnutls-devel-3.6.7-1.h12.eulerosv2r8",
  "gnutls-utils-3.6.7-1.h12.eulerosv2r8"
];
