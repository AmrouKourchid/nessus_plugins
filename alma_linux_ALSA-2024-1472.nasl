...
# AlmaLinux Security Advisory ALSA-2024:1472.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:1472");

  script_name(english:"AlmaLinux 8 : go-toolset:rhel8 (ALSA-2024:1472)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 8 host has packages installed that are affected by a vulnerability as referenced in the
ALSA-2024:1472 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2024-1472.html");
...
var appstreams = {
    'go-toolset:rhel8': [
      ...
      {'reference':'golang-1.20.12-3.module_el8.9.0+3750+10f4110d', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-1.20.12-3.module_el8.9.0+3750+10f4110d', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-1.20.12-3.module_el8.9.0+3750+10f4110d', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-1.20.12-3.module_el8.9.0+3750+10f4110d', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-bin-1.20.12-3.module_el8.9.0+3750+10f4110d', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-bin-1.20.12-3.module_el8.9.0+3750+10f4110d', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-bin-1.20.12-3.module_el8.9.0+3750+10f4110d', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-bin-1.20.12-3.module_el8.9.0+3750+10f4110d', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-docs-1.20.12-3.module_el8.9.0+3750+10f4110d', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-misc-1.20.12-3.module_el8.9.0+3750+10f4110d', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-src-1.20.12-3.module_el8.9.0+3750+10f4110d', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-tests-1.20.12-3.module_el8.9.0+3750+10f4110d', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
};
