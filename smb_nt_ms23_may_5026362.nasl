...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5026362");
  script_xref(name:"MSFT", value:"MS23-5026362");
  script_xref(name:"IAVA", value:"2023-A-0248-S");
  script_xref(name:"IAVA", value:"2023-A-0249-S");

  script_name(english:"KB5026362: Windows 10 version 1809 / Windows Server 2019 Security Update (May 2023)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5026362");
