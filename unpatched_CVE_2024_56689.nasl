...
if (description)
{
  ...
  script_cve_id("CVE-2024-56689");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-56689");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: PCI: endpoint: epf-mhi: Avoid NULL
    dereference if DT lacks 'mmio' If platform_get_resource_byname() fails and returns NULL because DT lacks
    an 'mmio' property for the MHI endpoint, dereferencing res->start will cause a NULL pointer access. Add a
    check to prevent it. [kwilczynski: error message update per the review feedback] [bhelgaas: commit log]
    (CVE-2024-56689)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-56689");
