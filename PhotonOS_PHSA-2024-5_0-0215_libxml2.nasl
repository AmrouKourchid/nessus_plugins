...
# extracted from VMware Security Advisory PHSA-2024-5.0-0215. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Libxml2 PHSA-2024-5.0-0215");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the libxml2 package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-5.0-215.md");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'libxml2-2.11.4-5.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'libxml2-devel-2.11.4-5.ph5')) flag++;
