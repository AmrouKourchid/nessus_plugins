...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c0a4f739");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"shim-15+git47-22.8.1", rpm_spec_vers_cmp:TRUE)) flag++;
