...
"Upgrade Jenkins to version 2.252 or later, Jenkins LTS to version 2.235.4 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-2231");
...
var constraints = [
  { 'fixed_version' : '2.252',    'fixed_display' : '2.235.4 LTS / 2.252',  'edition' : 'Open Source' },
  { 'fixed_version' : '2.235.4',  'fixed_display' : '2.235.4 LTS / 2.252',  'edition' : 'Open Source LTS' }
];

vcf::jenkins::check_version_and_report(app_info:app_info, constraints:constraints, severity:SECURITY_NOTE, flags:{xss:true});
