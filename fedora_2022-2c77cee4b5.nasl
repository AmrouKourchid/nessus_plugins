...
# extracted from Fedora Security Advisory FEDORA-2022-2c77cee4b5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-2c77cee4b5");

  script_name(english:"Fedora 37 : heimdal (2022-2c77cee4b5)");
...
FEDORA-2022-2c77cee4b5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-2c77cee4b5");
...
var pkgs = [
    {'reference':'heimdal-7.7.1-3.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
