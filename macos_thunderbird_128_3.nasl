...
"The version of Thunderbird installed on the remote macOS or Mac OS X host is prior to 128.3. It is, therefore, affected
by multiple vulnerabilities as referenced in the mfsa2024-49 advisory.
...
mozilla_check_version(version:version, path:path, product:'thunderbird', esr:FALSE, fix:'128.3', severity:SECURITY_HOLE);
