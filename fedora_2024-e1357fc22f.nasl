...
# extracted from Fedora Security Advisory FEDORA-2024-e1357fc22f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-e1357fc22f");

  script_name(english:"Fedora 39 : webkitgtk (2024-e1357fc22f)");
...
FEDORA-2024-e1357fc22f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-e1357fc22f");
...
var pkgs = [
    {'reference':'webkitgtk-2.46.1-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
