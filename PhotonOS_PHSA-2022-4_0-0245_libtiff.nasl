...
if (description)
{
  ...
  script_cve_id("CVE-2022-2953");

  script_name(english:"Photon OS 4.0: Libtiff PHSA-2022-4.0-0245");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libtiff-4.4.0-5.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libtiff-devel-4.4.0-5.ph4')) flag++;
