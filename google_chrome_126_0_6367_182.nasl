...
if (description)
{
  ...
  script_name(english:"Google Chrome < 126.0.6367.182 Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"A web browser installed on the remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Google Chrome installed on the remote Windows host is prior to 126.0.6367.182. It is, therefore, affected
...
"Upgrade to Google Chrome version 126.0.6367.182 or later.");
...
google_chrome_check_version(installs:installs, fix:'126.0.6367.182', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
