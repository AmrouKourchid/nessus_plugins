...
# extracted from Red Hat Security Advisory RHSA-2023:7276. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:7276");

  script_name(english:"RHEL 9 : open-vm-tools (RHSA-2023:7276)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for open-vm-tools.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2023:7276 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_7276.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9a7b137b");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:7276");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL open-vm-tools package based on the guidance in RHSA-2023:7276.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'open-vm-tools-12.1.5-1.el9_2.4', 'sp':'2', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'open-vm-tools-12.1.5-1.el9_2.4', 'sp':'2', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'open-vm-tools-desktop-12.1.5-1.el9_2.4', 'sp':'2', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'open-vm-tools-desktop-12.1.5-1.el9_2.4', 'sp':'2', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'open-vm-tools-salt-minion-12.1.5-1.el9_2.4', 'sp':'2', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'open-vm-tools-sdmp-12.1.5-1.el9_2.4', 'sp':'2', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'open-vm-tools-test-12.1.5-1.el9_2.4', 'sp':'2', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'open-vm-tools-test-12.1.5-1.el9_2.4', 'sp':'2', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
