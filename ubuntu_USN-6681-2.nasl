...
# extracted from Ubuntu Security Notice USN-6681-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6681-2");

  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS : Linux kernel vulnerabilities (USN-6681-2)");
...
referenced in the USN-6681-2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6681-2");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.4.0-1039-xilinx-zynqmp");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.4.0-1080-bluefield");
...
var kernel_mappings = {
  ...
  '20.04': {
    '5.4.0': {
      'xilinx-zynqmp': '5.4.0-1039',
      'bluefield': '5.4.0-1080'
    }
  }
};
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-6681-2');
}
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-6681-2');
  }
  else
  {
