...
# extracted from Red Hat Security Advisory RHSA-2024:3047. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:3047");

  script_name(english:"RHEL 8 : 389-ds:1.4 (RHSA-2024:3047)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for 389-ds:1.4.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:3047 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-14025");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-16338");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-19028");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-19240");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-5107");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-5135");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-5143");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_3047.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?53ef48bf");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:3047");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL 389-ds:1.4 package based on the guidance in RHSA-2024:3047.");
  ...
  '389-ds:1.4': [
    {
      ...
      'pkgs': [
        {'reference':'389-ds-base-1.4.3.39-3.module+el8.10.0+21535+f663b039', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'389-ds-base-devel-1.4.3.39-3.module+el8.10.0+21535+f663b039', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'389-ds-base-legacy-tools-1.4.3.39-3.module+el8.10.0+21535+f663b039', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'389-ds-base-libs-1.4.3.39-3.module+el8.10.0+21535+f663b039', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'389-ds-base-snmp-1.4.3.39-3.module+el8.10.0+21535+f663b039', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-lib389-1.4.3.39-3.module+el8.10.0+21535+f663b039', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
