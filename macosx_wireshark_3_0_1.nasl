...
"The version of Wireshark installed on the remote macOS / Mac OS X host is 3.0.x prior to 3.0.1. It is, therefore,
affected by multiple vulnerabilities as referenced in the wireshark-3.0.1 advisory:
