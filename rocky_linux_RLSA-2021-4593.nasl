...
# Rocky Linux Security Advisory RLSA-2021:4593.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2021:4593");

  script_name(english:"Rocky Linux 8 : annobin (RLSA-2021:4593)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Rocky Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Rocky Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
RLSA-2021:4593 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2021:4593");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:rocky:linux:annobin");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:rocky:linux:annobin-annocheck");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:rocky:linux:annobin-annocheck-debuginfo");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:rocky:linux:annobin-debuginfo");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:rocky:linux:annobin-debugsource");
...
var pkgs = [
    ...
    {'reference':'annobin-annocheck-debuginfo-9.72-1.el8_5.2', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'annobin-annocheck-debuginfo-9.72-1.el8_5.2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'annobin-debuginfo-9.72-1.el8_5.2', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'annobin-debuginfo-9.72-1.el8_5.2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'annobin-debugsource-9.72-1.el8_5.2', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'annobin-debugsource-9.72-1.el8_5.2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'annobin / annobin-annocheck / annobin-annocheck-debuginfo / etc');
}
