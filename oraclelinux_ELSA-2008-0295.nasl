...
# extracted from Oracle Linux Security Advisory ELSA-2008-0295.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : vsftpd (ELSA-2008-0295)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2008-0295.html");
...
"Update the affected vsftpd package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2007-5962");
...
var pkgs = [
    {'reference':'vsftpd-2.0.5-12.el5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'vsftpd-2.0.5-12.el5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
