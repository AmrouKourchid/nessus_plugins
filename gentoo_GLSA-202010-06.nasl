...
# extracted from Gentoo Linux Security Advisory GLSA 202010-06.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202010-06");

  script_name(english:"GLSA-202010-06 : Ark: Arbitrary code execution");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202010-06
(Ark: Arbitrary code execution)

    It was discovered that Ark incorrectly handled symbolic links in tar
      archive files.
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202010-06");
...
if (qpkg_check(package:"kde-apps/ark", unaffected:make_list("ge 20.04.3-r2"), vulnerable:make_list("lt 20.04.3-r2"))) flag++;
