...
# extracted from Fedora Security Advisory FEDORA-2025-25b16d6561
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-25b16d6561");

  script_name(english:"Fedora 41 : mediawiki (2025-25b16d6561)");
...
FEDORA-2025-25b16d6561 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-25b16d6561");
...
"Update the affected mediawiki package.");
  ...
  script_set_attribute(attribute:"cvss4_vector", value:"CVSS:4.0/AV:N/AC:L/AT:N/PR:N/UI:N/VC:L/VI:N/VA:N/SC:L/SI:N/SA:N");
  script_set_attribute(attribute:"cvss4_threat_vector", value:"CVSS:4.0/E:U");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-47848");
...
var pkgs = [
    {'reference':'mediawiki-1.41.5-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
