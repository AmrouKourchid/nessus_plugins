...
if (description)
{
  ...
  script_name(english:"Microsoft Windows 10 21H1 SEoL");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Microsoft Windows is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"Microsoft Windows 10 21H1 is no longer maintained by its vendor or provider.
...
"Upgrade to a version of Microsoft Windows that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2022/12/13");
...
var os = ucf::get_os_cpe(vendor:'microsoft', product:'windows_10_21h1', type:'local');
