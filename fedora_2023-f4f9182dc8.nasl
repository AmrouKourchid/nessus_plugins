...
# extracted from Fedora Security Advisory FEDORA-2023-f4f9182dc8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-f4f9182dc8");

  script_name(english:"Fedora 37 : kernel / kernel-headers / kernel-tools (2023-f4f9182dc8)");
...
FEDORA-2023-f4f9182dc8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-f4f9182dc8");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for FEDORA-2023-f4f9182dc8');
  }
  else
  {
...
var pkgs = [
    {'reference':'kernel-6.1.5-200.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kernel-headers-6.1.5-200.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kernel-tools-6.1.5-200.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
