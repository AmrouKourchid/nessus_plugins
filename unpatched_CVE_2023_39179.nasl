...
if (description)
{
  ...
  script_cve_id("CVE-2023-39179");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2023-39179");
...
patch available.
  ...
  - A flaw was found within the handling of SMB2 read requests in the kernel ksmbd module. The issue results
    from the lack of proper validation of user-supplied data, which can result in a read past the end of an
    allocated buffer. An attacker can leverage this to disclose sensitive information on affected
    installations of Linux. Only systems with ksmbd enabled are vulnerable to this CVE. (CVE-2023-39179)
...
"There is no known solution at this time.");
  ...
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:H/PR:N/UI:N/S:C/C:H/I:N/A:L");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-39179");
