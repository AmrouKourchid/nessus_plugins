...
# extracted from Fedora Security Advisory FEDORA-2024-ff743391c3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-ff743391c3");

  script_name(english:"Fedora 39 : chromium (2024-ff743391c3)");
...
FEDORA-2024-ff743391c3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-ff743391c3");
...
var pkgs = [
    {'reference':'chromium-127.0.6533.88-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
