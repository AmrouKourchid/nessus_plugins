...
# extracted from Gentoo Linux Security Advisory GLSA 202003-40.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202003-40");

  script_name(english:"GLSA-202003-40 : Cacti: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202003-40
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202003-40");
...
if (qpkg_check(package:"net-analyzer/cacti", unaffected:make_list("ge 1.2.9"), vulnerable:make_list("lt 1.2.9"))) flag++;
