...
# extracted from Debian Security Advisory dsa-5203. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-5203-1 : gnutls28 - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has packages installed that are affected by a vulnerability as referenced in the dsa-5203
advisory.

    Jaak Ristioja discovered a double-free vulnerability in GnuTLS, a library implementing the TLS and SSL
    protocols, during verification of pkcs7 signatures. A remote attacker can take advantage of this flaw to
    cause an application using the GnuTLS library to crash (denial of service), or potentially, to execute
    arbitrary code. For the stable distribution (bullseye), this problem has been fixed in version
    3.7.1-5+deb11u2. We recommend that you upgrade your gnutls28 packages. For the detailed security status of
    gnutls28 please refer to its security tracker page at: https://security-
    tracker.debian.org/tracker/gnutls28
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2022/dsa-5203");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'gnutls-bin', 'reference': '3.7.1-5+deb11u2'},
    {'release': '11.0', 'prefix': 'gnutls-doc', 'reference': '3.7.1-5+deb11u2'},
    {'release': '11.0', 'prefix': 'guile-gnutls', 'reference': '3.7.1-5+deb11u2'},
    {'release': '11.0', 'prefix': 'libgnutls-dane0', 'reference': '3.7.1-5+deb11u2'},
    {'release': '11.0', 'prefix': 'libgnutls-openssl27', 'reference': '3.7.1-5+deb11u2'},
    {'release': '11.0', 'prefix': 'libgnutls28-dev', 'reference': '3.7.1-5+deb11u2'},
    {'release': '11.0', 'prefix': 'libgnutls30', 'reference': '3.7.1-5+deb11u2'},
    {'release': '11.0', 'prefix': 'libgnutlsxx28', 'reference': '3.7.1-5+deb11u2'}
];
