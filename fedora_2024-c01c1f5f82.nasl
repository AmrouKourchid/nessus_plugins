...
# extracted from Fedora Security Advisory FEDORA-2024-c01c1f5f82
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-c01c1f5f82");
  ...
  script_name(english:"Fedora 40 : chromium (2024-c01c1f5f82)");
...
FEDORA-2024-c01c1f5f82 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-c01c1f5f82");
...
var pkgs = [
    {'reference':'chromium-125.0.6422.60-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
