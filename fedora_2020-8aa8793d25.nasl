...
# extracted from Fedora Security Advisory FEDORA-2020-8aa8793d25.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : hylafax+ (2020-8aa8793d25)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-8aa8793d25");
  script_set_attribute(attribute:"solution", value:
"Update the affected hylafax+ package.");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"hylafax+-7.0.3-1.fc31")) flag++;
