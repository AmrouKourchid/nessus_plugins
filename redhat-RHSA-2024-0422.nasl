...
# extracted from Red Hat Security Advisory RHSA-2024:0422. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:0422");

  script_name(english:"RHEL 8 : perl-HTTP-Tiny (RHSA-2024:0422)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0422.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?66213163");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2228392");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0422");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL perl-HTTP-Tiny package based on the guidance in RHSA-2024:0422.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'perl-HTTP-Tiny-0.074-1.el8_6.1', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
