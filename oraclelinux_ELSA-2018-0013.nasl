...
# extracted from Red Hat Security Advisory RHSA-2018:0013 and 
# Oracle Linux Security Advisory ELSA-2018-0013 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : microcode_ctl (ELSA-2018-0013)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"http://linux.oracle.com/errata/ELSA-2018-0013.html");
...
var pkgs = [
    {'reference':'microcode_ctl-1.17-25.2.el6_9', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
