...
"The remote Red Hat host is missing one or more security updates for Red Hat JBoss Enterprise Application Platform 6.4.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_0438.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0a30f40e");
...
"Update the RHEL Red Hat JBoss Enterprise Application Platform 6.4 package based on the guidance in RHSA-2022:0438.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'log4j-eap6-1.2.17-3.redhat_00008.1.ep6.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap6'},
      {'reference':'log4j-jboss-logmanager-1.1.4-3.Final_redhat_00002.1.ep6.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap6'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'log4j-eap6-1.2.17-3.redhat_00008.1.ep6.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap6'},
      {'reference':'log4j-jboss-logmanager-1.1.4-3.Final_redhat_00002.1.ep6.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap6'}
    ]
  }
];
