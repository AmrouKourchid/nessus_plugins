...
# extracted from Ubuntu Security Notice USN-5711-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5711-2");

  script_name(english:"Ubuntu 16.04 ESM : NTFS-3G vulnerability (USN-5711-2)");
...
USN-5711-2 advisory.
    ...
    USN-5711-1 fixed a vulnerability in NTFS-3G. This update provides the corresponding update for Ubuntu
    14.04 ESM Ubuntu 16.04 ESM.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5711-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'ntfs-3g', 'pkgver': '1:2015.3.14AR.1-1ubuntu0.3+esm4', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'ntfs-3g-dev', 'pkgver': '1:2015.3.14AR.1-1ubuntu0.3+esm4', 'ubuntu_pro': TRUE}
];
