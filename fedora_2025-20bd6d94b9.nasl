...
# extracted from Fedora Security Advisory FEDORA-2025-20bd6d94b9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-20bd6d94b9");

  script_name(english:"Fedora 40 : xen (2025-20bd6d94b9)");
...
FEDORA-2025-20bd6d94b9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-20bd6d94b9");
...
var pkgs = [
    {'reference':'xen-4.18.4-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
