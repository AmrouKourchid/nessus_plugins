...
if (description)
{
  ...
  script_cve_id("CVE-2019-6470", "CVE-2019-6477");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'bindutils-9.15.6-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'bindutils-debuginfo-9.15.6-1.ph3')) flag++;
