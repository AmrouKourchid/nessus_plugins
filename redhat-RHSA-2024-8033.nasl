...
# extracted from Red Hat Security Advisory RHSA-2024:8033. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:8033");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2024/11/05");

  script_name(english:"RHEL 8 : firefox (RHSA-2024:8033)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_8033.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?072bde79");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:8033");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL firefox package based on the guidance in RHSA-2024:8033.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-128.3.1-2.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
