...
# extracted from Fedora Security Advisory FEDORA-2024-e717420659
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-e717420659");

  script_name(english:"Fedora 41 : valkey (2024-e717420659)");
...
FEDORA-2024-e717420659 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-e717420659");
...
var pkgs = [
    {'reference':'valkey-8.0.1-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
