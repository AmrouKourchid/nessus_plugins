...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 20.04 LTS : X.Org X Server vulnerability (USN-4905-1)");
...
referenced in the USN-4905-1 advisory.

    Jan-Niklas Sohn discovered that the X.Org X Server incorrectly handled certain lengths of XInput extension
    ChangeFeedbackControl requests. An attacker could use this issue to cause the server to crash, resulting
