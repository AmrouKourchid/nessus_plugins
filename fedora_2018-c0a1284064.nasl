...
# extracted from Fedora Security Advisory FEDORA-2018-c0a1284064.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : kernel / kernel-headers / kernel-tools (2018-c0a1284064)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-c0a1284064");
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for FEDORA-2018-c0a1284064");
  }
  else
  {
...
flag = 0;
if (rpm_check(release:"FC27", reference:"kernel-4.18.10-100.fc27")) flag++;
if (rpm_check(release:"FC27", reference:"kernel-headers-4.18.10-100.fc27")) flag++;
if (rpm_check(release:"FC27", reference:"kernel-tools-4.18.10-100.fc27")) flag++;
