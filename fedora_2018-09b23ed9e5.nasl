...
# extracted from Fedora Security Advisory FEDORA-2018-09b23ed9e5.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : 1:cups (2018-09b23ed9e5)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-09b23ed9e5");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"cups-2.2.8-7.fc29", epoch:"1")) flag++;
