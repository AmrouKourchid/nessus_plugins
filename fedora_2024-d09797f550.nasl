...
# extracted from Fedora Security Advisory FEDORA-2024-d09797f550
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-d09797f550");

  script_name(english:"Fedora 39 : grub2 (2024-d09797f550)");
...
FEDORA-2024-d09797f550 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-d09797f550");
...
var pkgs = [
    {'reference':'grub2-2.06-120.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
