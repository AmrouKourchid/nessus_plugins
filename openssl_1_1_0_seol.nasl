...
if (description)
{
  ...
  script_name(english:"OpenSSL SEoL (1.1.0.x)");
...
contain security vulnerabilities.");
  script_set_attribute(attribute:"see_also", value:"https://www.openssl.org/news/vulnerabilities-1.1.0.html");
...
"Upgrade to a version of OpenSSL that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2019/09/12");
...
var constraints = [
  { max_branch : '1.1.0', min_branch : '1.1.0', seol : 20190912 }
];
