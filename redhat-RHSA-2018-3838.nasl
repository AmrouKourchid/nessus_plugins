...
# extracted from Red Hat Security Advisory RHSA-2018:3838. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:3838");

  script_name(english:"RHEL 7 : ansible (RHSA-2018:3838)");
...
the RHSA-2018:3838 advisory.
    ...
    * ansible: information disclosure in vvv+ mode with no_log on  (CVE-2018-16876)
    ...
    See https://github.com/ansible/ansible/blob/v2.7.5/changelogs/CHANGELOG-v2.7.rst for details on bug fixes
    in this release.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_3838.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?48a06361");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:3838");
...
"Update the RHEL ansible package based on the guidance in RHSA-2018:3838.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ansible-2.7.5-1.el7ae', 'release':'7', 'el_string':'el7ae', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2'}
    ]
  }
];
