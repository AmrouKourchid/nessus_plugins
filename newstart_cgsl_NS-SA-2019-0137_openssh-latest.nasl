...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 4.05 : openssh-latest Vulnerability (NS-SA-2019-0137)");
...
pkgs = {
  "CGSL MAIN 4.05": [
    "openssh-latest-7.6p1-1.el6.cgsl7723",
    "openssh-latest-clients-7.6p1-1.el6.cgsl7723",
    "openssh-latest-debuginfo-7.6p1-1.el6.cgsl7723",
    "openssh-latest-server-7.6p1-1.el6.cgsl7723"
  ]
};
