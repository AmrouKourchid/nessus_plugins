...
without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=1170826");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=1175132");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=1176031");
  script_set_attribute(attribute:"see_also", value:"https://github.com/golang/go/wiki/Go-Release-Cycle");
  script_set_attribute(attribute:"see_also", value:"https://golang.org/doc/go1.15.");
  script_set_attribute(attribute:"see_also", value:"https://proxy.golang.org,direct,");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2020-24553/");
  # https://www.suse.com/support/update/announcement/2020/suse-su-20202776-1
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d6691df4");
