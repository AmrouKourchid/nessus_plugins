...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'wget-1.18-1.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'wget-debuginfo-1.18-1.ph1')) flag++;
