...
# extracted from Red Hat Security Advisory RHSA-2020:4568. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:4568");

  script_name(english:"RHEL 8 : libldb (RHSA-2020:4568)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2020:4568 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_4568.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c2e0048e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:4568");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1817567");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ldb-tools-2.1.3-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libldb-2.1.3-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libldb-devel-2.1.3-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-ldb-2.1.3-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'ldb-tools / libldb / libldb-devel / python3-ldb');
}
