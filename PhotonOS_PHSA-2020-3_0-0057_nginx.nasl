...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Nginx PHSA-2020-3.0-0057");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'nginx-1.16.1-2.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'nginx-debuginfo-1.16.1-2.ph3')) flag++;
