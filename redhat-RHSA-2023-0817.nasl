...
# extracted from Red Hat Security Advisory RHSA-2023:0817. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:0817");
  script_xref(name:"IAVA", value:"2023-A-0106-S");

  script_name(english:"RHEL 7 : thunderbird (RHSA-2023:0817)");
...
referenced in the RHSA-2023:0817 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_0817.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?37342d51");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:0817");
...
"Update the RHEL thunderbird package based on the guidance in RHSA-2023:0817.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'thunderbird-102.8.0-2.el7_9', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'thunderbird-102.8.0-2.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
