...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : qt5-qtbase on SL7.x x86_64 (20201001)");
...
"Security Fix(es) :
  ...
  - qt: files placed by attacker can influence the working
    directory and lead to malicious code execution
    (CVE-2020-0569)

  - qt: files placed by attacker can influence the working
    directory and lead to malicious code execution
    (CVE-2020-0570)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind2010&L=SCIENTIFIC-LINUX-ERRATA&P=17963
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?592241bb");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"qt5-qtbase-5.9.7-4.el7")) flag++;
if (rpm_check(release:"SL7", reference:"qt5-qtbase-common-5.9.7-4.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"qt5-qtbase-common-5.9.7-4.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"qt5-qtbase-debuginfo-5.9.7-4.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"qt5-qtbase-devel-5.9.7-4.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"qt5-qtbase-doc-5.9.7-4.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"qt5-qtbase-examples-5.9.7-4.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"qt5-qtbase-gui-5.9.7-4.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"qt5-qtbase-mysql-5.9.7-4.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"qt5-qtbase-odbc-5.9.7-4.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"qt5-qtbase-postgresql-5.9.7-4.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"qt5-qtbase-static-5.9.7-4.el7")) flag++;
if (rpm_check(release:"SL7", reference:"qt5-rpm-macros-5.9.7-4.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"qt5-rpm-macros-5.9.7-4.el7")) flag++;
