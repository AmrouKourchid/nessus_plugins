...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : poppler (EulerOS-SA-2018-1226)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1226
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d0ee04c7");
...
pkgs = ["poppler-0.26.5-17.h11",
        "poppler-glib-0.26.5-17.h11",
        "poppler-qt-0.26.5-17.h11",
        "poppler-utils-0.26.5-17.h11"];
