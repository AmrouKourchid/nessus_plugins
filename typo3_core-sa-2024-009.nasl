...
if (description)
{
  ...
  script_cve_id("CVE-2024-34357");

  script_name(english:"TYPO3 9.0.0 < 9.5.48 ELTS / 10.0.0 < 10.4.45 ELTS / 11.0.0 < 11.5.37 / 12.0.0 < 12.4.15 / 13.0.0 < 13.1.1 XSS (TYPO3-CORE-SA-2024-009)");
...
TYPO3-CORE-SA-2024-009 advisory.

  - TYPO3 is an enterprise content management system. Starting in version 9.0.0 and prior to versions 9.5.48
    ELTS, 10.4.45 ELTS, 11.5.37 LTS, 12.4.15 LTS, and 13.1.1, failing to properly encode user-controlled
    values in file entities, the `ShowImageController` (`_eID tx_cms_showpic_`) is vulnerable to cross-site
    scripting. Exploiting this vulnerability requires a valid backend user account with access to file
    entities. TYPO3 versions 9.5.48 ELTS, 10.4.45 ELTS, 11.5.37 LTS, 12.4.15 LTS, 13.1.1 fix the problem
    described. (CVE-2024-34357)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://typo3.org/security/advisory/typo3-core-sa-2024-009");
...
"Upgrade to TYPO3 9.5.48 ELTS, 10.4.45 ELTS, 11.5.37, 12.4.15, 13.1.1 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-34357");
