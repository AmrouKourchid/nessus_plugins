...
if (description)
{
  ...
  script_cve_id("CVE-2017-0537");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2017-0537");
...
patch available.
  ...
  - An information disclosure vulnerability in the kernel USB gadget driver could enable a local malicious
    application to access data outside of its permission levels. This issue is rated as Moderate because it
    first requires compromising a privileged process. Product: Android. Versions: Kernel-3.18. Android ID:
    A-31614969. (CVE-2017-0537)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-0537");
