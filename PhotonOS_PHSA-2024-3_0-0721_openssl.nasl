...
# extracted from VMware Security Advisory PHSA-2024-3.0-0721. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Openssl PHSA-2024-3.0-0721");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the openssl package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-3.0-721.md");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'openssl-1.0.2zj-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'openssl-c_rehash-1.0.2zj-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'openssl-devel-1.0.2zj-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'openssl-perl-1.0.2zj-1.ph3')) flag++;
