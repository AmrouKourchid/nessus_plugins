...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.6.0 : libtirpc (EulerOS-SA-2020-2015)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2015
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?908f6799");
...
pkgs = ["libtirpc-1.1.4-0.h1.eulerosv2r8"];
