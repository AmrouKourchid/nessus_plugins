...
# extracted from Fedora Security Advisory FEDORA-2023-dcee14345b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-dcee14345b");

  script_name(english:"Fedora 38 : kernel (2023-dcee14345b)");
...
FEDORA-2023-dcee14345b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-dcee14345b");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-6622");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  var cve_list = make_list('CVE-2023-6622');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for FEDORA-2023-dcee14345b');
  }
  else
  {
...
var pkgs = [
    {'reference':'kernel-6.6.7-100.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
