...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Mysql PHSA-2020-2.0-0239");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'mysql-5.7.30-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'mysql-debuginfo-5.7.30-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'mysql-devel-5.7.30-1.ph2')) flag++;
