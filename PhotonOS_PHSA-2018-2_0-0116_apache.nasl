...
if (description)
{
  ...
  script_cve_id("CVE-2018-1336", "CVE-2018-8034", "CVE-2018-8037");

  script_name(english:"Photon OS 2.0: Apache PHSA-2018-2.0-0116");
...
if (rpm_check(release:'PhotonOS-2.0', reference:'apache-tomcat-8.5.35-1.ph2')) flag++;
