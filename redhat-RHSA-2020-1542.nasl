...
# extracted from Red Hat Security Advisory RHSA-2020:1542. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:1542");
  script_xref(name:"IAVB", value:"2020-B-0016-S");
  script_xref(name:"IAVB", value:"2019-B-0092-S");

  script_name(english:"RHEL 7 / 8 : Ansible security update (2.9.7) (Important) (RHSA-2020:1542)");
...
referenced in the RHSA-2020:1542 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_1542.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e6359369");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:1542");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1817161");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Ansible package based on the guidance in RHSA-2020:1542.");
  ...
  script_cwe_id(22, 200, 377, 459, 532, 862);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ansible-2.9.7-1.el8ae', 'release':'8', 'el_string':'el8ae', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2'},
      {'reference':'ansible-test-2.9.7-1.el8ae', 'release':'8', 'el_string':'el8ae', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'ansible-2.9.7-1.el7ae', 'release':'7', 'el_string':'el7ae', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2'},
      {'reference':'ansible-test-2.9.7-1.el7ae', 'release':'7', 'el_string':'el7ae', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2'}
    ]
  }
];
