...
# extracted from Fedora Security Advisory FEDORA-2024-111a8a624b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-111a8a624b");

  script_name(english:"Fedora 40 : trafficserver (2024-111a8a624b)");
...
FEDORA-2024-111a8a624b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-111a8a624b");
...
var pkgs = [
    {'reference':'trafficserver-9.2.4-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
