...
# extracted from Oracle Linux Security Advisory ELSA-2023-1068.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : libjpeg-turbo (ELSA-2023-1068)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-1068.html");
...
var pkgs = [
    ...
    {'reference':'libjpeg-turbo-utils-2.0.90-6.el9_1', 'cpu':'i686', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
