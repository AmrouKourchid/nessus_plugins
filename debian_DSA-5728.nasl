...
# extracted from Debian Security Advisory dsa-5728. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5728 : exim4 - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has packages installed that are affected by a vulnerability as referenced in the dsa-5728
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-39929");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'exim4', 'reference': '4.94.2-7+deb11u3'},
    {'release': '11.0', 'prefix': 'exim4-base', 'reference': '4.94.2-7+deb11u3'},
    {'release': '11.0', 'prefix': 'exim4-config', 'reference': '4.94.2-7+deb11u3'},
    {'release': '11.0', 'prefix': 'exim4-daemon-heavy', 'reference': '4.94.2-7+deb11u3'},
    {'release': '11.0', 'prefix': 'exim4-daemon-light', 'reference': '4.94.2-7+deb11u3'},
    {'release': '11.0', 'prefix': 'exim4-dev', 'reference': '4.94.2-7+deb11u3'},
    {'release': '11.0', 'prefix': 'eximon4', 'reference': '4.94.2-7+deb11u3'}
];
