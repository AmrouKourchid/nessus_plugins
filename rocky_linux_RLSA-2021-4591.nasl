...
# Rocky Linux Security Advisory RLSA-2021:4591.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2021:4591");

  script_name(english:"Rocky Linux 8 : gcc-toolset-11-annobin (RLSA-2021:4591)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Rocky Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Rocky Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
RLSA-2021:4591 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2021:4591");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:rocky:linux:gcc-toolset-11-annobin-annocheck");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:rocky:linux:gcc-toolset-11-annobin-annocheck-debuginfo");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:rocky:linux:gcc-toolset-11-annobin-debuginfo");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:rocky:linux:gcc-toolset-11-annobin-docs");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:rocky:linux:gcc-toolset-11-annobin-plugin-gcc");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:rocky:linux:gcc-toolset-11-annobin-plugin-gcc-debuginfo");
...
var pkgs = [
    ...
    {'reference':'gcc-toolset-11-annobin-annocheck-debuginfo-9.85-1.el8_5.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'gcc-toolset-11-annobin-annocheck-debuginfo-9.85-1.el8_5.1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'gcc-toolset-11-annobin-debuginfo-9.85-1.el8_5.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'gcc-toolset-11-annobin-debuginfo-9.85-1.el8_5.1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'gcc-toolset-11-annobin-plugin-gcc-debuginfo-9.85-1.el8_5.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'gcc-toolset-11-annobin-plugin-gcc-debuginfo-9.85-1.el8_5.1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'gcc-toolset-11-annobin-annocheck / etc');
}
