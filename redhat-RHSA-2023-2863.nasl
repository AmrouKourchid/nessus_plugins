...
# extracted from Red Hat Security Advisory RHSA-2023:2863. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:2863");

  script_name(english:"RHEL 8 : ctags (RHSA-2023:2863)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for ctags.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2023:2863 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_2863.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7b1d79eb");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/8.8_release_notes/index
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cfe2de5f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2153519");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:2863");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL ctags package based on the guidance in RHSA-2023:2863.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:ctags");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:ctags-etags");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ctags-5.8-23.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ctags-etags-5.8-23.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'ctags / ctags-etags');
}
