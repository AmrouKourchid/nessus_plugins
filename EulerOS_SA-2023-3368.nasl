...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.1 : shim (EulerOS-SA-2023-3368)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3368
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b37f5376");
...
var pkgs = [
  ...
  "shim-aa64-storage-15.4-2.h21.eulerosv2r11"
];
