...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : spice-gtk (EulerOS-SA-2020-1673)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1673
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b6b39e05");
...
pkgs = ["spice-glib-0.26-5.h3",
        "spice-gtk3-0.26-5.h3"];
