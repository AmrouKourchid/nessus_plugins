...
# extracted from Red Hat Security Advisory RHSA-2022:6169. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:6169");
  script_xref(name:"IAVA", value:"2022-A-0342-S");

  script_name(english:"RHEL 7 : thunderbird (RHSA-2022:6169)");
...
referenced in the RHSA-2022:6169 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_6169.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f5004dff");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:6169");
...
"Update the RHEL thunderbird package based on the guidance in RHSA-2022:6169.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'thunderbird-91.13.0-1.el7_9', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'thunderbird-91.13.0-1.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
