...
if (description)
{
  ...
  script_name(english:"Oracle Siebel Server <= 22.3 (July 2024 CPU)");
...
2024 CPU advisory.
  ...
  - Vulnerability in the Siebel CRM Deployment product of Oracle Siebel CRM (component: Installation (Apache
    Commons Compress)). Supported versions that are affected are 22.3 and prior. Easily exploitable
    vulnerability allows unauthenticated attacker with network access via HTTP to compromise Siebel CRM
    Deployment. Successful attacks of this vulnerability can result in unauthorized ability to cause a hang or
    frequently repeatable crash (complete DOS) of Siebel CRM Deployment. (CVE-2021-36090)
...
var constraints = [
  { 'max_version' : '22.3.999', 'fixed_version' : '24.7' }
];
