...
# extracted from Red Hat Security Advisory RHSA-2022:8291. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:8291");

  script_name(english:"RHEL 9 : rsync (RHSA-2022:8291)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for rsync.");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8291.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8346e001");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8291");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rsync package based on the guidance in RHSA-2022:8291.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rsync-3.2.3-18.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
