...
if (description)
{
  ...
  script_cve_id("CVE-2022-39951");

  script_name(english:"Fortinet FortiWeb Command injection in webserver (FG-IR-22-254)");
...
vulnerability as referenced in the FG-IR-22-254 advisory.

  - A improper neutralization of special elements used in an os command ('os command injection') in Fortinet
    FortiWeb version 7.0.0 through 7.0.2, FortiWeb version 6.3.6 through 6.3.20, FortiWeb 6.4 all versions
    allows attacker to execute unauthorized code or commands via specifically crafted HTTP requests.
    (CVE-2022-39951)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.fortiguard.com/psirt/FG-IR-22-254");
...
"Upgrade to FortiWeb version 6.3.21 / 6.4.999999 / 7.0.3 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-39951");
