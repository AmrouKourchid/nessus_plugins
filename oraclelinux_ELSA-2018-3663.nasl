...
# Oracle Linux Security Advisory ELSA-2018-3663 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : sos-collector (ELSA-2018-3663)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2018-3663.html");
...
"Update the affected sos-collector package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:sos-collector");
...
var pkgs = [
    {'reference':'sos-collector-1.5-3.0.1.el7_6', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
];
