...
# extracted from Fedora Security Advisory FEDORA-2024-5bae6c0ea7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-5bae6c0ea7");

  script_name(english:"Fedora 38 : kubernetes (2024-5bae6c0ea7)");
...
FEDORA-2024-5bae6c0ea7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-5bae6c0ea7");
...
var pkgs = [
    {'reference':'kubernetes-1.26.15-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
