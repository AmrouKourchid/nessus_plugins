...
# extracted from Fedora Security Advisory FEDORA-2022-6225445e2b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-6225445e2b");

  script_name(english:"Fedora 36 : advancecomp (2022-6225445e2b)");
...
FEDORA-2022-6225445e2b advisory.

    Security fix for CVE-2022-35014, CVE-2022-35015, CVE-2022-35016, CVE-2022-35017, CVE-2022-35018,
    CVE-2022-35019, CVE-2022-35020

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-6225445e2b");
...
var pkgs = [
    {'reference':'advancecomp-2.4-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
