...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.2 : python-jinja2 (EulerOS-SA-2023-1285)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1285
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b5649844");
