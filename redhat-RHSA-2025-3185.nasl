...
# extracted from Red Hat Security Advisory RHSA-2025:3185. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:3185");

  script_name(english:"RHEL 9 : gvisor-tap-vsock (RHSA-2025:3185)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2236e381");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:3185");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL gvisor-tap-vsock package based on the guidance in RHSA-2025:3185.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gvisor-tap-vsock-0.7.3-5.el9_4.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'6'}
    ]
  }
];
