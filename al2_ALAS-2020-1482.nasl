...
"The version of postgresql-jdbc installed on the remote host is prior to 9.2.1002-8. It is, therefore, affected by a
vulnerability as referenced in the ALAS2-2020-1482 advisory.

    PostgreSQL JDBC Driver (aka PgJDBC) before 42.2.13 allows XXE. A flaw was found in PostgreSQL JDBC in
    versions prior to 42.2.13. An XML External Entity (XXE) weakness was found in PostgreSQL JDBC. The highest
    threat from this vulnerability is to data confidentiality and system availability. (CVE-2020-13692)
...
var pkgs = [
    {'reference':'postgresql-jdbc-9.2.1002-8.amzn2', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'postgresql-jdbc-javadoc-9.2.1002-8.amzn2', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
