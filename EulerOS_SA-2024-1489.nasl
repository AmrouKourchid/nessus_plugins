...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : libxml2 (EulerOS-SA-2024-1489)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1489
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ea64888b");
...
var pkgs = [
  "libxml2-2.9.10-1.h34.eulerosv2r9",
  "python3-libxml2-2.9.10-1.h34.eulerosv2r9"
];
