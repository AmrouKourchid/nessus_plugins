...
# extracted from Fedora Security Advisory FEDORA-2020-c6fa12cfb1.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : LibRaw (2020-c6fa12cfb1)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-c6fa12cfb1");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"LibRaw-0.19.5-4.fc31")) flag++;
