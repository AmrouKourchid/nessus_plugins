...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : fetchmail (ELSA-2009-1427)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2009-1427.html");
...
"Update the affected fetchmail package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2009-2666");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2007-4565");
...
var pkgs = [
    {'reference':'fetchmail-6.3.6-1.1.el5_3.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'fetchmail-6.3.6-1.1.el5_3.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
