...
# extracted from Oracle Linux Security Advisory ELSA-2023-12578.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : buildah (ELSA-2023-12578)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ELSA-2023-12578 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-12578.html");
...
var appstreams = {
    'all': [
      {'reference':'runc-1.1.4-1.0.1.module+el8.8.0+21118+db7590d7', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'runc-1.1.4-1.0.1.module+el8.8.0+21118+db7590d7', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ],
    'container-tools:4.0': [
