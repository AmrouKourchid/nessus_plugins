...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.0 : httpd (EulerOS-SA-2022-2866)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2866
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?541c7478");
...
var pkgs = [
  "httpd-2.4.43-4.h15.eulerosv2r10",
  "httpd-filesystem-2.4.43-4.h15.eulerosv2r10",
  "httpd-tools-2.4.43-4.h15.eulerosv2r10",
  "mod_ssl-2.4.43-4.h15.eulerosv2r10"
];
