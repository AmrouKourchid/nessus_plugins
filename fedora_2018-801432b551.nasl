...
# extracted from Fedora Security Advisory FEDORA-2018-801432b551.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-801432b551");

  script_name(english:"Fedora 29 : LibRaw (2018-801432b551)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"Fixes for CVE-2018-20337, CVE-2018-20363, CVE-2018-20364,
CVE-2018-20365
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-801432b551");
  script_set_attribute(attribute:"see_also", value:"https://www.libraw.org/news/libraw-0-19-2-release");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"LibRaw-0.19.2-1.fc29")) flag++;
