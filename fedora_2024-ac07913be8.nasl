...
# extracted from Fedora Security Advisory FEDORA-2024-ac07913be8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-ac07913be8");

  script_name(english:"Fedora 40 : 389-ds-base (2024-ac07913be8)");
...
FEDORA-2024-ac07913be8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-ac07913be8");
...
var pkgs = [
    {'reference':'389-ds-base-3.0.4-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
