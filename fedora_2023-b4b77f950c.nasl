...
# extracted from Fedora Security Advisory FEDORA-2023-b4b77f950c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-b4b77f950c");

  script_name(english:"Fedora 37 : libeconf (2023-b4b77f950c)");
...
FEDORA-2023-b4b77f950c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-b4b77f950c");
...
var pkgs = [
    {'reference':'libeconf-0.5.2-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
