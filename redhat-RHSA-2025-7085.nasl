...
# extracted from Red Hat Security Advisory RHSA-2025:7085. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2025-25184");
  script_xref(name:"RHSA", value:"2025:7085");

  script_name(english:"RHEL 9 : pcs (RHSA-2025:7085)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2345301");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-16232");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-44420");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-55441");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-61738");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-61901");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-69040");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-78653");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-79055");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-79160");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_7085.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6df64223");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:7085");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL pcs package based on the guidance in RHSA-2025:7085.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:S/C:N/I:C/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:L/UI:N/S:U/C:N/I:H/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss4_vector", value:"CVSS:4.0/AV:N/AC:L/AT:N/PR:L/UI:N/VC:N/VI:H/VA:N/SC:N/SI:N/SA:N");
  script_set_attribute(attribute:"cvss4_threat_vector", value:"CVSS:4.0/E:U");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-25184");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'pcs-0.11.9-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcs-snmp-0.11.9-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
