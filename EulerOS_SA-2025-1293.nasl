...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP12 : dpdk (EulerOS-SA-2025-1293)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1293
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c4052725");
...
var pkgs = [
  "dpdk-21.11-27.h9.eulerosv2r12",
  "dpdk-devel-21.11-27.h9.eulerosv2r12",
  "dpdk-tools-21.11-27.h9.eulerosv2r12"
];
