...
# extracted from VMware Security Advisory PHSA-2025-4.0-0761. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Xerces PHSA-2025-4.0-0761");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the xerces package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-761.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'xerces-c-3.2.5-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'xerces-c-devel-3.2.5-1.ph4')) flag++;
