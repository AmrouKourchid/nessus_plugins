...
"Upgrade to IMP version 3.2.4 or later.");
  ...
  script_copyright(english:"This script is Copyright (C) 2004-2024 George A. Theall");
...
dbg::detailed_log(lvl:2, msg:"debug: searching for Content-Type XSS vulnerability in IMP on "+host+":"+port+".");
