...
ELSA-2022-1988 advisory.
    ...
    - netfilter: nf_tables_offload: incorrect flow offload action array size (Florian Westphal) [2056728]
    {CVE-2022-25636}
    - RDMA/cma: Do not change route.addr.src_addr.ss_family (Kamal Heib) [2032074] {CVE-2021-4028}
    - x86/speculation: Check CPU capability before applying IBRS spectre v2 mitigation (Waiman Long) [2062156
    2062166] {CVE-2022-0001 CVE-2022-0002 CVE-2021-26401}
    - x86/speculation: Warn about eIBRS + LFENCE + Unprivileged eBPF + SMT (Waiman Long) [2062156 2062166]
    {CVE-2022-0001 CVE-2022-0002 CVE-2021-26401}
    - x86/speculation: Warn about Spectre v2 LFENCE mitigation (Waiman Long) [2062156 2062166] {CVE-2022-0001
    CVE-2022-0002 CVE-2021-26401}
    ...
    - x86/speculation: Include unprivileged eBPF status in Spectre v2 mitigation reporting (Waiman Long)
    [2062156] {CVE-2022-0001 CVE-2022-0002}
    ...
    - x86/speculation: Rename RETPOLINE_AMD to RETPOLINE_LFENCE (Waiman Long) [2062156] {CVE-2022-0001
    CVE-2022-0002}
    - x86,bugs: Unconditionally allow spectre_v2=retpoline,amd (Waiman Long) [2062156] {CVE-2022-0001
    CVE-2022-0002}
...
var pkgs = [
    ...
    {'reference':'kernel-abi-stablelists-4.18.0-372.9.1.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-abi-stablelists-4.18.0'},
