...
# extracted from Fedora Security Advisory FEDORA-2024-31e83b461d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-31e83b461d");

  script_name(english:"Fedora 38 : cockpit (2024-31e83b461d)");
...
FEDORA-2024-31e83b461d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-31e83b461d");
...
"Update the affected cockpit package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:cockpit");
...
var pkgs = [
    {'reference':'cockpit-311.2-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
