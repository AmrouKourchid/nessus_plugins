...
# extracted from Fedora Security Advisory FEDORA-2024-01f4c93547
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-01f4c93547");

  script_name(english:"Fedora 38 : chromium (2024-01f4c93547)");
...
FEDORA-2024-01f4c93547 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-01f4c93547");
...
var pkgs = [
    {'reference':'chromium-123.0.6312.58-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
