...
# extracted from Red Hat Security Advisory RHSA-2023:6482. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:6482");

  script_name(english:"RHEL 9 : librabbitmq (RHSA-2023:6482)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6482.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b51b1154");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2215762");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6482");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL librabbitmq package based on the guidance in RHSA-2023:6482.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:S/C:C/I:N/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:L/UI:N/S:U/C:H/I:N/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-35789");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:librabbitmq-tools");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'librabbitmq-0.11.0-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'librabbitmq-devel-0.11.0-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'librabbitmq-tools-0.11.0-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'librabbitmq / librabbitmq-devel / librabbitmq-tools');
}
