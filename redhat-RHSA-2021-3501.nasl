...
# extracted from Red Hat Security Advisory RHSA-2021:3501. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:3501");
  script_xref(name:"IAVA", value:"2021-A-0405-S");

  script_name(english:"RHEL 8 : firefox (RHSA-2021:3501)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_3501.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bb38d537");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:3501");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2002119");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL firefox package based on the guidance in RHSA-2021:3501.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-78.14.0-1.el8_1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
