...
# extracted from Fedora Security Advisory FEDORA-2018-d1f6c8957f.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : cantata (2018-d1f6c8957f)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-d1f6c8957f");
  script_set_attribute(attribute:"solution", value:
"Update the affected cantata package.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-12562");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"cantata-2.3.1-1.fc28")) flag++;
