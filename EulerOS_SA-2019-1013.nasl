...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : spice-gtk (EulerOS-SA-2019-1013)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1013
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a7e7e526");
...
pkgs = ["spice-glib-0.34-3.2.eulerosv2r7",
        "spice-gtk3-0.34-3.2.eulerosv2r7"];
