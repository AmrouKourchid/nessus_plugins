...
if (description)
{
  ...
  script_name(english:"Microsoft Windows 10 20H2 Pro SEoL");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Microsoft Windows is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"Microsoft Windows 10 20H2 Pro is no longer maintained by its vendor or provider.
...
var constraints = [
  { seol : 20220510, cpe_attributes : [{'edition': 'pro*'}] }
];
