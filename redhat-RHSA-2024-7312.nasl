...
# extracted from Red Hat Security Advisory RHSA-2024:7312. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2024-21520", "CVE-2024-37891", "CVE-2024-41810");
  script_xref(name:"RHSA", value:"2024:7312");

  script_name(english:"RHEL 8 / 9 : Red Hat Ansible Automation Platform 2.4 Product Security and Bug Fix Update (Moderate) (RHSA-2024:7312)");
...
referenced in the RHSA-2024:7312 advisory.
    ...
    * automation-controller: djangorestframework: Cross-site Scripting (XSS) via break_long_headers
    (CVE-2024-21520)
    * automation-controller: twisted: Reflected XSS via HTML Injection in Redirect Response (CVE-2024-41810)
    * automation-controller: urllib3: proxy-authorization request header is not stripped during cross-origin
    ...
    * Fixed Galaxy credentials to be correctly ordered when assigning them using
    'ansible.controller.organization' (AAP-31398)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_7312.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?51428cc1");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2292788");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2294457");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2300497");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:7312");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'automation-controller-venv-tower-4.5.12-1.el8ap', 'release':'8', 'el_string':'el8ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.4'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'automation-controller-venv-tower-4.5.12-1.el9ap', 'release':'9', 'el_string':'el9ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.4'}
    ]
  }
];
