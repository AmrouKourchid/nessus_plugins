...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5023754");
  script_xref(name:"MSKB", value:"5023755");
  script_xref(name:"MSFT", value:"MS23-5023754");
  script_xref(name:"MSFT", value:"MS23-5023755");
  script_xref(name:"IAVA", value:"2023-A-0135-S");
  script_xref(name:"IAVA", value:"2023-A-0139-S");

  script_name(english:"KB5023754: Windows Server 2008 Security Update (March 2023)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5023754. It is, therefore, affected by multiple vulnerabilities
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5023754");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5023755");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5023754 or Cumulative Update 5023755");
...
if (
  smb_check_rollup(os:'6.0',
                   ...
                   rollup_date:'03_2023',
                   bulletin:bulletin,
                   rollup_kb_list:[5023755, 5023754])
)
{
