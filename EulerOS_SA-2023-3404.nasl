...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : libxml2 (EulerOS-SA-2023-3404)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3404
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8c56aa5e");
...
var pkgs = [
  "libxml2-2.9.1-6.3.h34.eulerosv2r7",
  "libxml2-devel-2.9.1-6.3.h34.eulerosv2r7",
  "libxml2-python-2.9.1-6.3.h34.eulerosv2r7"
];
