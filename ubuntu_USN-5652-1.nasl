...
# extracted from Ubuntu Security Notice USN-5652-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5652-1");

  script_name(english:"Ubuntu 16.04 ESM : Linux kernel (Azure) vulnerabilities (USN-5652-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5652-1");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-5652-1');
}
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-5652-1');
  }
  else
  {
