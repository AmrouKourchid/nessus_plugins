...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2024-A-0564-S");
  script_xref(name:"IAVA", value:"2024-A-0562-S");

  script_name(english:"Security Updates for Microsoft Office Products (September 2024) (macOS)");
...
september-10-2024 advisory.

  - Microsoft Excel Elevation of Privilege Vulnerability (CVE-2024-43465)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://learn.microsoft.com/en-us/officeupdates/release-notes-office-for-mac#september-10-2024
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?16f500c9");
  script_set_attribute(attribute:"solution", value:
"Update to Office for Mac version 16.89 or later.");
...
var constraints = [
  { 'fixed_version' : '16.89', 'fixed_display' : 'Version 16.89 (Build 24090815)' }
];
