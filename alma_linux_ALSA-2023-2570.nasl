...
# AlmaLinux Security Advisory ALSA-2023:2570.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:2570");

  script_name(english:"AlmaLinux 9 : krb5 (ALSA-2023:2570)");
...
ALSA-2023:2570 advisory.

  - Kerberos Security Feature Bypass Vulnerability (CVE-2020-17049)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2023-2570.html");
