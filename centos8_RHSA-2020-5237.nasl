...
# Red Hat Security Advisory RHSA-2020:5237. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : firefox (CESA-2020:5237)");
...
pkgs = [
    {'reference':'firefox-78.5.0-1.el8_3', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-78.5.0-1.el8_3', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
