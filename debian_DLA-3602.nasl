...
# extracted from Debian Security Advisory dla-3602. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3602 : libx11-6 - security update");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libx11-6', 'reference': '2:1.6.7-1+deb10u4'},
    {'release': '10.0', 'prefix': 'libx11-data', 'reference': '2:1.6.7-1+deb10u4'},
    {'release': '10.0', 'prefix': 'libx11-dev', 'reference': '2:1.6.7-1+deb10u4'},
    {'release': '10.0', 'prefix': 'libx11-doc', 'reference': '2:1.6.7-1+deb10u4'},
    {'release': '10.0', 'prefix': 'libx11-xcb-dev', 'reference': '2:1.6.7-1+deb10u4'},
    {'release': '10.0', 'prefix': 'libx11-xcb1', 'reference': '2:1.6.7-1+deb10u4'}
];
