...
# extracted from Red Hat Security Advisory RHSA-2020:5480. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:5480");

  script_name(english:"RHEL 8 : net-snmp (RHSA-2020:5480)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for net-snmp.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2020:5480 advisory.
    ...
    * In RHEL 8, snmpd using v3 is unable to send out default 60 maxGetbulkResponses when invalid PID
    specified. (BZ#1896760)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_5480.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2bd66456");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:5480");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1873038");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1896760");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL net-snmp package based on the guidance in RHSA-2020:5480.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'net-snmp-5.8-18.el8_3.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'net-snmp-agent-libs-5.8-18.el8_3.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'net-snmp-devel-5.8-18.el8_3.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'net-snmp-libs-5.8-18.el8_3.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'net-snmp-perl-5.8-18.el8_3.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'net-snmp-utils-5.8-18.el8_3.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
