...
# extracted from VMware Security Advisory PHSA-2022-4.0-0192. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Ncurses PHSA-2022-4.0-0192");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the ncurses package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-192.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'ncurses-6.2-6.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'ncurses-compat-6.2-6.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'ncurses-devel-6.2-6.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'ncurses-libs-6.2-6.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'ncurses-terminfo-6.2-6.ph4')) flag++;
