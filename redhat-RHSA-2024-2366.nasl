...
# extracted from Red Hat Security Advisory RHSA-2024:2366. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2366");

  script_name(english:"RHEL 9 : freeglut (RHSA-2024:2366)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for freeglut.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:2366 advisory.

    freeglut is a completely open source alternative to the OpenGL Utility Toolkit (GLUT) library with an OSI
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2366.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c0daef98");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2366");
...
"Update the RHEL freeglut package based on the guidance in RHSA-2024:2366.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'freeglut-3.2.1-10.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freeglut-devel-3.2.1-10.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'freeglut / freeglut-devel');
}
