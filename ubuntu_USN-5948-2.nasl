...
# extracted from Ubuntu Security Notice USN-5948-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5948-2");

  script_name(english:"Ubuntu 23.04 : Werkzeug vulnerabilities (USN-5948-2)");
...
USN-5948-2 advisory.
    ...
    USN-5948-1 fixed vulnerabilities in Werkzeug. This update provides the corresponding updates for Ubuntu
    23.04.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5948-2");
...
var pkgs = [
    {'osver': '23.04', 'pkgname': 'python3-werkzeug', 'pkgver': '2.2.2-2ubuntu0.1'}
];
