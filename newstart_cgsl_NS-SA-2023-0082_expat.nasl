...
# extracted from ZTE advisory NS-SA-2023-0082. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 6.06 : expat Multiple Vulnerabilities (NS-SA-2023-0082)");

  script_set_attribute(attribute:"synopsis", value:
"The remote NewStart CGSL host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 6.06, has expat packages installed that are affected by multiple
vulnerabilities:
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/notice/NS-SA-2023-0082");
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/info/CVE-2021-45960");
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/info/CVE-2021-46143");
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/info/CVE-2022-22822");
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/info/CVE-2022-22823");
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/info/CVE-2022-22824");
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/info/CVE-2022-22825");
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/info/CVE-2022-22826");
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/info/CVE-2022-22827");
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/info/CVE-2022-23852");
...
var pkgs = {
  'CGSL MAIN 6.06': [
    'expat-2.2.5-8.zncgsl6_6.3',
    'expat-devel-2.2.5-8.zncgsl6_6.3'
  ]
};
