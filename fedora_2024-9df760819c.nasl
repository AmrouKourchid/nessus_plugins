...
# extracted from Fedora Security Advisory FEDORA-2024-9df760819c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-9df760819c");

  script_name(english:"Fedora 39 : unbound (2024-9df760819c)");
...
FEDORA-2024-9df760819c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-9df760819c");
...
var pkgs = [
    {'reference':'unbound-1.20.0-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
