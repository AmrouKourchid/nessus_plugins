...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.6.0 : qemu-kvm (EulerOS-SA-2021-1994)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1994
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?92672e8f");
...
pkgs = ["qemu-img-2.8.1-30.468",
        "qemu-kvm-2.8.1-30.468",
        "qemu-kvm-common-2.8.1-30.468",
        "qemu-kvm-tools-2.8.1-30.468"];
