...
if (description)
{
  ...
  script_bugtraq_id(71326);

  script_name(english:"EulerOS 2.0 SP5 : libjpeg-turbo (EulerOS-SA-2020-1115)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1115
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?56319c89");
...
"Update the affected libjpeg-turbo package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-9092");
...
pkgs = ["libjpeg-turbo-1.2.90-6.h5.eulerosv2r7",
        "libjpeg-turbo-devel-1.2.90-6.h5.eulerosv2r7"];
