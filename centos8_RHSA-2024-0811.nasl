...
# Red Hat Security Advisory RHSA-2024:0811. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : sudo (CESA-2024:0811)");
...
var pkgs = [
    {'reference':'sudo-1.9.5p2-1.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sudo-1.9.5p2-1.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
