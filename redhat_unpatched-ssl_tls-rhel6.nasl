...
# extracted from Red Hat Security Advisory ssl_tls. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2016-2183", "CVE-2016-8610");

  script_name(english:"RHEL 6 : ssl_tls (Unpatched Vulnerability) (deprecated)");
