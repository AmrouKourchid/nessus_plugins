...
# extracted from Fedora Security Advisory FEDORA-2023-eb3c27ff25
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-eb3c27ff25");

  script_name(english:"Fedora 37 : xorg-x11-server-Xwayland (2023-eb3c27ff25)");
...
FEDORA-2023-eb3c27ff25 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-eb3c27ff25");
...
var pkgs = [
    {'reference':'xorg-x11-server-Xwayland-22.1.9-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
