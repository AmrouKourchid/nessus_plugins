...
# extracted from Fedora Security Advisory FEDORA-2022-d6c6782130
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-d6c6782130");

  script_name(english:"Fedora 37 : php-pear-CAS (2022-d6c6782130)");
...
FEDORA-2022-d6c6782130 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-d6c6782130");
...
var pkgs = [
    {'reference':'php-pear-CAS-1.6.0-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
