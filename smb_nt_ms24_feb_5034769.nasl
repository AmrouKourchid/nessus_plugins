...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5034769");
  script_xref(name:"MSFT", value:"MS24-5034769");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2024/03/25");
  ...
  script_name(english:"KB5034769: Windows 11 version 22H2 Security Update (February 2024)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5034769. It is, therefore, affected by multiple vulnerabilities
  ...
  - Windows Kernel Elevation of Privilege Vulnerability (CVE-2024-21338, CVE-2024-21345, CVE-2024-21371)

  - Windows Kernel Information Disclosure Vulnerability (CVE-2024-21340)

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5034769");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5034769");
