...
# extracted from VMware Security Advisory PHSA-2021-4.0-0046. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2020-14387");

  script_name(english:"Photon OS 4.0: Rsync PHSA-2021-4.0-0046");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the rsync package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-46.md");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-14387");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'rsync-3.2.3-2.ph4')) flag++;
