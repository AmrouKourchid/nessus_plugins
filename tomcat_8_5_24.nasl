...
if (description)
{
  ...
  script_name(english:"Apache Tomcat 8.5.16 < 8.5.24");

  script_set_attribute(attribute:"synopsis", value:
"The remote Apache Tomcat server is affected by a vulnerability");
  script_set_attribute(attribute:"description", value:
"The version of Tomcat installed on the remote host is prior to 8.5.24. It is, therefore, affected by a vulnerability as
referenced in the fixed_in_apache_tomcat_8.5.24_security-8 advisory.
...
number.");
  # https://tomcat.apache.org/security-8.html#Fixed_in_Apache_Tomcat_8.5.24
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8405238c");
  script_set_attribute(attribute:"see_also", value:"https://bz.apache.org/bugzilla/show_bug.cgi?id=61201");
  script_set_attribute(attribute:"see_also", value:"https://svn.apache.org/viewvc?view=rev&rev=1814826");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Apache Tomcat version 8.5.24 or later.");
...
var constraints = [
  { 'min_version' : '8.5.16', 'max_version' : '8.5.23', 'fixed_version' : '8.5.24' }
];
