...
# extracted from Oracle Linux Security Advisory ELSA-2020-2081.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : python-virtualenv (ELSA-2020-2081)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2020-2081.html");
...
var pkgs = [
    {'reference':'python-virtualenv-15.1.0-4.el7_8', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
];
