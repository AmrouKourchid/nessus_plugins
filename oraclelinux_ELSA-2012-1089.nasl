...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2012-1089.html");
...
"Update the affected thunderbird package.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2012-1957");
...
var pkgs = [
    {'reference':'thunderbird-10.0.6-1.0.1.el6_3', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'thunderbird-10.0.6-1.0.1.el6_3', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
