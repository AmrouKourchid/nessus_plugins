...
# extracted from Red Hat Security Advisory RHSA-2024:6239. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:6239");

  script_name(english:"RHEL 8 : resource-agents (RHSA-2024:6239)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for resource-agents.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:6239 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_6239.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f5d4064e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:6239");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL resource-agents package based on the guidance in RHSA-2024:6239.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'resource-agents-4.1.1-90.el8_4.17', 'sp':'4', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'resource-agents-4.1.1-90.el8_4.17', 'sp':'4', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'resource-agents-aliyun-4.1.1-90.el8_4.17', 'sp':'4', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'resource-agents-gcp-4.1.1-90.el8_4.17', 'sp':'4', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
