...
# extracted from Fedora Security Advisory FEDORA-2023-a2df0551fe
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-a2df0551fe");

  script_name(english:"Fedora 37 : rt (2023-a2df0551fe)");
...
FEDORA-2023-a2df0551fe advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-a2df0551fe");
...
var pkgs = [
    {'reference':'rt-5.0.5-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
