...
# extracted from Fedora Security Advisory FEDORA-2023-5f840297cb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-5f840297cb");

  script_name(english:"Fedora 38 : libopenmpt (2023-5f840297cb)");
...
FEDORA-2023-5f840297cb advisory.

    Update from 0.6.10 to 0.6.11:
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-5f840297cb");
...
var pkgs = [
    {'reference':'libopenmpt-0.6.11-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
