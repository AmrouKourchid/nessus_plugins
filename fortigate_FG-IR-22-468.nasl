...
if (description)
{
  ...
  script_name(english:"Fortinet Fortigate Lack of certificate verification when establishing secure connections (FG-IR-22-468)");
...
"Please upgrade to FortiOS version 7.0.11/7.2.1 or later.");
...
var constraints = [
  { 'min_version' : '6.2', 'max_version' : '6.4', 'fixed_version' : '7.0.11' },
