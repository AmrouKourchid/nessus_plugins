...
# extracted from Fedora Security Advisory FEDORA-2024-b69a4d75a1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-b69a4d75a1");

  script_name(english:"Fedora 39 : freeglut (2024-b69a4d75a1)");
...
FEDORA-2024-b69a4d75a1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-b69a4d75a1");
  script_set_attribute(attribute:"solution", value:
"Update the affected freeglut package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:freeglut");
...
var pkgs = [
    {'reference':'freeglut-3.4.0-7.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
