...
# extracted from Fedora Security Advisory FEDORA-2025-3aa9a75a72
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-3aa9a75a72");

  script_name(english:"Fedora 41 : lemonldap-ng (2025-3aa9a75a72)");
...
FEDORA-2025-3aa9a75a72 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-3aa9a75a72");
...
var pkgs = [
    {'reference':'lemonldap-ng-2.20.2-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
