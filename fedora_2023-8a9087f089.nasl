...
# extracted from Fedora Security Advisory FEDORA-2023-8a9087f089
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-8a9087f089");

  script_name(english:"Fedora 37 : redis (2023-8a9087f089)");
...
FEDORA-2023-8a9087f089 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-8a9087f089");
...
var pkgs = [
    {'reference':'redis-7.0.14-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
