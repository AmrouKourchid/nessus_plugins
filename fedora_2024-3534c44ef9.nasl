...
# extracted from Fedora Security Advisory FEDORA-2024-3534c44ef9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-3534c44ef9");

  script_name(english:"Fedora 41 : rust (2024-3534c44ef9)");
...
FEDORA-2024-3534c44ef9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-3534c44ef9");
...
"Update the affected rust package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-24576");
...
var pkgs = [
    {'reference':'rust-1.77.2-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
