...
# extracted from Oracle Linux Security Advisory ELSA-2020-1725.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : haproxy (ELSA-2020-1725)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2020-1725.html");
