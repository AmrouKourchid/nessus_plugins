...
# extracted from Gentoo Linux Security Advisory GLSA 202011-01.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202011-01");

  script_name(english:"GLSA-202011-01 : BlueZ: Arbitrary code execution");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202011-01
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202011-01");
...
if (qpkg_check(package:"net-wireless/bluez", unaffected:make_list("ge 5.55"), vulnerable:make_list("lt 5.55"))) flag++;
