...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Nodejs PHSA-2021-2.0-0313");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'nodejs-10.22.1-2.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'nodejs-devel-10.22.1-2.ph2')) flag++;
