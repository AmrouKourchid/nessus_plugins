...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.2.0 : samba (EulerOS-SA-2021-1380)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1380
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b616e47a");
...
pkgs = ["samba-client-libs-4.7.1-9.h23",
        "samba-common-4.7.1-9.h23",
        "samba-common-libs-4.7.1-9.h23",
        "samba-common-tools-4.7.1-9.h23",
        "samba-libs-4.7.1-9.h23"];
