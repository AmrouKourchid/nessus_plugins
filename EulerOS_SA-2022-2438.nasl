...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : gimp (EulerOS-SA-2022-2438)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the gimp packages installed, the EulerOS installation on the remote host is affected by the
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2438
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5aef5ee1");
...
var pkgs = [
  "gimp-2.8.22-1.h7.eulerosv2r7",
  "gimp-libs-2.8.22-1.h7.eulerosv2r7"
];
