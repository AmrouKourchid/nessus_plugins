...
# extracted from Ubuntu Security Notice USN-6293-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6293-1");

  script_name(english:"Ubuntu 22.04 LTS : OpenStack Heat vulnerability (USN-6293-1)");
...
USN-6293-1 advisory.
    ...
    It was discovered that OpenStack Heat incorrectly handled certain hidden parameter values. A remote
    authenticated user could possibly use this issue to obtain sensitive data.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6293-1");
...
var pkgs = [
    {'osver': '22.04', 'pkgname': 'heat-api', 'pkgver': '1:18.0.1-0ubuntu1.1'},
    {'osver': '22.04', 'pkgname': 'heat-api-cfn', 'pkgver': '1:18.0.1-0ubuntu1.1'},
    {'osver': '22.04', 'pkgname': 'heat-common', 'pkgver': '1:18.0.1-0ubuntu1.1'},
    {'osver': '22.04', 'pkgname': 'heat-engine', 'pkgver': '1:18.0.1-0ubuntu1.1'},
    {'osver': '22.04', 'pkgname': 'python3-heat', 'pkgver': '1:18.0.1-0ubuntu1.1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'heat-api / heat-api-cfn / heat-common / heat-engine / python3-heat');
}
