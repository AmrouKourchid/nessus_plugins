...
# extracted from Fedora Security Advisory FEDORA-2022-dbe48a4bc7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-dbe48a4bc7");

  script_name(english:"Fedora 36 : sysstat (2022-dbe48a4bc7)");
...
FEDORA-2022-dbe48a4bc7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-dbe48a4bc7");
...
var pkgs = [
    {'reference':'sysstat-12.5.6-2.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
