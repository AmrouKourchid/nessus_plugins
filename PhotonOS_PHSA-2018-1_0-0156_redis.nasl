...
# extracted from VMware Security Advisory PHSA-2018-1.0-0156. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Redis PHSA-2018-1.0-0156");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the redis package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-1.0-156.md");
...
if (rpm_check(release:"PhotonOS-1.0", reference:"redis-4.0.10-1.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"redis-4.0.10-1.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"redis-debuginfo-4.0.10-1.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"redis-debuginfo-4.0.10-1.ph1")) flag++;
