...
if (description)
{
  ...
  script_name(english:"PHP 7.1.x < 7.1.29 Heap-based Buffer Overflow Vulnerability.");

  script_set_attribute(attribute:"synopsis", value:
"An application installed on the remote host is affected by a heap-based buffer overflow vulnerability.");
  script_set_attribute(attribute:"description", value:
"According to its banner, the version of PHP running on the remote web server is 7.1.x prior to 7.1.29. It is, therefore,
...
arbitrary code.");
  script_set_attribute(attribute:"see_also", value:"http://php.net/ChangeLog-7.php#7.1.29");
  script_set_attribute(attribute:"solution", value:
"Upgrade to PHP version 7.1.29 or later.");
