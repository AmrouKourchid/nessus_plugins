...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.2.0 : tar (EulerOS-SA-2021-2114)");
...
by the following vulnerability :
  ...
  - A flaw was found in the src/list.c of tar 1.33 and
    earlier. This flaw allows an attacker who can submit a
    crafted input file to tar to cause uncontrolled
    consumption of memory. The highest threat from this
    vulnerability is to system
    availability.(CVE-2021-20193)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2114
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?90a82fe7");
