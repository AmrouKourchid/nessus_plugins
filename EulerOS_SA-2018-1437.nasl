...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : libxcursor (EulerOS-SA-2018-1437)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1437
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?add0bfdd");
...
pkgs = ["libXcursor-1.1.14-2.1.h2",
        "libXcursor-devel-1.1.14-2.1.h2"];
