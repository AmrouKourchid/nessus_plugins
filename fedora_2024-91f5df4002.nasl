...
# extracted from Fedora Security Advisory FEDORA-2024-91f5df4002
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-91f5df4002");

  script_name(english:"Fedora 39 : python-cryptography (2024-91f5df4002)");
...
FEDORA-2024-91f5df4002 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-91f5df4002");
...
var pkgs = [
    {'reference':'python-cryptography-41.0.7-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
