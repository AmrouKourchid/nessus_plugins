...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Docker PHSA-2019-2.0-0128");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'docker-18.06.2-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'docker-doc-18.06.2-1.ph2')) flag++;
