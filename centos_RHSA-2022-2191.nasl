...
# extracted from Red Hat Security Advisory RHSA-2022:2191 and
# CentOS Errata and Security Advisory 2022:2191 respectively.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : gzip (RHSA-2022:2191)");
...
var pkgs = [
    {'reference':'gzip-1.5-11.el7_9', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'gzip-1.5-11.el7_9', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE}
];
