...
# extracted from ZTE advisory NS-SA-2023-0098. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 6.06 : python-lxml Vulnerability (NS-SA-2023-0098)");

  script_set_attribute(attribute:"synopsis", value:
"The remote NewStart CGSL host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 6.06, has python-lxml packages installed that are affected by a
vulnerability:
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/notice/NS-SA-2023-0098");
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/info/CVE-2021-43818");
  script_set_attribute(attribute:"solution", value:
"Upgrade the vulnerable CGSL python-lxml packages. Note that updated packages may not be available yet. Please contact
