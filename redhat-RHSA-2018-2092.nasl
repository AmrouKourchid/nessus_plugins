...
# extracted from Red Hat Security Advisory RHSA-2018:2092. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:2092");

  script_name(english:"RHEL 7 : patch (RHSA-2018:2092)");
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_2092.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?05266b26");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:2092");
...
"Update the RHEL patch package based on the guidance in RHSA-2018:2092.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'patch-2.7.1-10.el7_3', 'sp':'3', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'patch-2.7.1-10.el7_3', 'sp':'3', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'patch-2.7.1-10.el7_3', 'sp':'3', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'patch-2.7.1-10.el7_3', 'sp':'3', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
