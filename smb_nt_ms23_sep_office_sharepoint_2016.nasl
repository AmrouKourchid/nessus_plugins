...
if (description)
{
  ...
  script_cve_id("CVE-2023-36762", "CVE-2023-36764");
  script_xref(name:"MSKB", value:"5002494");
  script_xref(name:"MSFT", value:"MS23-5002494");
  script_xref(name:"IAVA", value:"2023-A-0479-S");

  script_name(english:"Security Updates for Microsoft SharePoint Server 2016 (September 2023)");
...
affected by multiple vulnerabilities:
  ...
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002494");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released KB5002494 to address this issue.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:S/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:L/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-36764");
