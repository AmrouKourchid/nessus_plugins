...
# extracted from Fedora Security Advisory FEDORA-2024-4d80983af6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-4d80983af6");

  script_name(english:"Fedora 40 : chromium (2024-4d80983af6)");
...
FEDORA-2024-4d80983af6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-4d80983af6");
...
var pkgs = [
    {'reference':'chromium-130.0.6723.58-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
