...
# extracted from Red Hat Security Advisory RHSA-2023:5610. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:5610");

  script_name(english:"RHEL 8 : tar (RHSA-2023:5610)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for tar.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_5610.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?69e0d19e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2149722");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:5610");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL tar package based on the guidance in RHSA-2023:5610.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'tar-1.30-5.el8_6.1', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
    ]
  }
];
