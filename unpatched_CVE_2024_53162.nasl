...
if (description)
{
  ...
  script_cve_id("CVE-2024-53162");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-53162");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: crypto: qat/qat_4xxx - fix off by one
    in uof_get_name() The fw_objs[] array has num_objs elements so the > needs to be >= to prevent an out of
    bounds read. (CVE-2024-53162)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-53162");
