...
if (description)
{
  ...
  script_cve_id("CVE-2024-53154");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-53154");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: clk: clk-apple-nco: Add NULL check in
    applnco_probe Add NULL check in applnco_probe, to handle kernel NULL pointer dereference error.
    (CVE-2024-53154)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-53154");
