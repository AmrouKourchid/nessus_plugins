...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5036893");
  script_xref(name:"MSFT", value:"MS24-5036893");
  ...
  script_name(english:"KB5036893: Windows 11 version 22H2 / Windows 11 version 23H2 Security Update (April 2024)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5036893");
