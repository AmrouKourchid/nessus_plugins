...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Openldap PHSA-2023-5.0-0097");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'openldap-2.6.4-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'openldap-devel-2.6.4-1.ph5')) flag++;
