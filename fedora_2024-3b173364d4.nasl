...
# extracted from Fedora Security Advisory FEDORA-2024-3b173364d4
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-3b173364d4");

  script_name(english:"Fedora 39 : unbound (2024-3b173364d4)");
...
FEDORA-2024-3b173364d4 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-3b173364d4");
...
var pkgs = [
    {'reference':'unbound-1.19.3-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
