...
# extracted from Fedora Security Advisory FEDORA-2024-b85b97c0e9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-b85b97c0e9");

  script_name(english:"Fedora 39 : golang-x-text (2024-b85b97c0e9)");
...
FEDORA-2024-b85b97c0e9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-b85b97c0e9");
...
var pkgs = [
    {'reference':'golang-x-text-0.14.0-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
