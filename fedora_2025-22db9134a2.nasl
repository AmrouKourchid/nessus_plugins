...
# extracted from Fedora Security Advisory FEDORA-2025-22db9134a2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-22db9134a2");

  script_name(english:"Fedora 41 : java-17-openjdk (2025-22db9134a2)");
...
FEDORA-2025-22db9134a2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-22db9134a2");
...
var pkgs = [
    {'reference':'java-17-openjdk-17.0.14.0.7-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
