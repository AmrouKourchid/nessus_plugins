...
if (description)
{
  ...
  script_cve_id("CVE-2024-46727");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-46727");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: drm/amd/display: Add otg_master NULL
    check within resource_log_pipe_topology_update [Why] Coverity reports NULL_RETURN warning. [How] Add
    otg_master NULL check. (CVE-2024-46727)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-46727");
