...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.2.0 : pcre (EulerOS-SA-2019-1931)");
...
by the following vulnerability :
  ...
  - libpcre1 in PCRE 8.40 and libpcre2 in PCRE2 10.23 allow
    remote attackers to cause a denial of service
    (segmentation violation for read access, and
    application crash) by triggering an invalid Unicode
    property lookup.(CVE-2017-7186)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1931
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0fcbf21e");
...
pkgs = ["pcre-8.32-17.h9",
        "pcre-devel-8.32-17.h9"];
