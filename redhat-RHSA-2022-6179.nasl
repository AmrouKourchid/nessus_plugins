...
# extracted from Red Hat Security Advisory RHSA-2022:6179. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:6179");
  script_xref(name:"IAVA", value:"2022-A-0339-S");

  script_name(english:"RHEL 7 : firefox (RHSA-2022:6179)");
...
referenced in the RHSA-2022:6179 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_6179.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3eab495e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:6179");
...
"Update the RHEL firefox package based on the guidance in RHSA-2022:6179.");
  ...
  script_cwe_id(120, 356, 416, 1021);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-91.13.0-1.el7_9', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-91.13.0-1.el7_9', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-91.13.0-1.el7_9', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-91.13.0-1.el7_9', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-91.13.0-1.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
