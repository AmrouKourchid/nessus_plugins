...
# extracted from Fedora Security Advisory FEDORA-2023-93389b8a9e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-93389b8a9e");
  script_xref(name:"IAVB", value:"2023-B-0006-S");

  script_name(english:"Fedora 36 : ImageMagick (2023-93389b8a9e)");
...
FEDORA-2023-93389b8a9e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-93389b8a9e");
...
var pkgs = [
    {'reference':'ImageMagick-6.9.12.77-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
