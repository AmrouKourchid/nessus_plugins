...
# extracted from Fedora Security Advisory FEDORA-2023-8febb13d07
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-8febb13d07");

  script_name(english:"Fedora 36 : suricata (2023-8febb13d07)");
...
FEDORA-2023-8febb13d07 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-8febb13d07");
...
var pkgs = [
    {'reference':'suricata-6.0.11-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
