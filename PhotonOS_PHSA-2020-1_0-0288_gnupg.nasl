...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Gnupg PHSA-2020-1.0-0288");
...
if (rpm_exists(rpm:"gnupg-2.2", release:"PhotonOS-1.0") && rpm_check(release:"PhotonOS-1.0", cpu:"x86_64", reference:"gnupg-2.2.18-1.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", cpu:"x86_64", reference:"gnupg-debuginfo-2.2.18-1.ph1")) flag++;
