...
# extracted from Oracle Linux Security Advisory ELSA-2022-9416.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : pcs (ELSA-2022-9416)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
ELSA-2022-9416 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2022-9416.html");
...
var pkgs = [
    {'reference':'pcs-0.10.12-6.0.1.el8_6.1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pcs-snmp-0.10.12-6.0.1.el8_6.1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
