...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : Important: / perl (ELSA-2007-0966)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2007-0966.html");
...
"Update the affected perl and / or perl-suidperl packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2007-5116");
...
var pkgs = [
    {'reference':'perl-5.8.8-10.0.1.el5_0.2', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
    {'reference':'perl-suidperl-5.8.8-10.0.1.el5_0.2', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
    {'reference':'perl-5.8.8-10.0.1.el5_0.2', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
    {'reference':'perl-suidperl-5.8.8-10.0.1.el5_0.2', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'}
];
