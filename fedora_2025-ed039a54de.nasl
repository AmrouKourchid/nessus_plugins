...
# extracted from Fedora Security Advisory FEDORA-2025-ed039a54de
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-ed039a54de");
  script_xref(name:"IAVB", value:"2025-B-0002-S");

  script_name(english:"Fedora 40 : mingw-poppler (2025-ed039a54de)");
...
FEDORA-2025-ed039a54de advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-ed039a54de");
...
var pkgs = [
    {'reference':'mingw-poppler-24.02.0-4.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
