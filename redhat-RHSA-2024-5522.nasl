...
# extracted from Red Hat Security Advisory RHSA-2024:5522. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:5522");

  script_name(english:"RHEL 8 : kpatch-patch-4_18_0-553 (RHSA-2024:5522)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for kpatch-patch-4_18_0-553.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has a package installed that is affected by multiple vulnerabilities as
referenced in the RHSA-2024:5522 advisory.

    This is a kernel live patch module which can be loaded by the kpatch command line utility to modify the
    code of a running kernel.  This patch module is targeted for kernel-4.18.0-553.el8_10.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_5522.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f1629e96");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:5522");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL kpatch-patch-4_18_0-553 package based on the guidance in RHSA-2024:5522.");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for RHSA-2024:5522');
  }
  else
  {
...
var kernel_live_checks = [
  {
    ...
    'kernels': {
      '4.18.0-553.el8_10.ppc64le': {
        'pkgs': [
          {'reference':'kpatch-patch-4_18_0-553-1-1.el8_10', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ]
      },
      '4.18.0-553.el8_10.x86_64': {
        'pkgs': [
          {'reference':'kpatch-patch-4_18_0-553-1-1.el8_10', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kpatch-patch-4_18_0-553');
}
