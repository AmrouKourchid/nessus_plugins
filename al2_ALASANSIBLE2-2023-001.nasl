...
# extracted from Amazon Linux 2 Security Advisory ALASANSIBLE2-2023-001.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : ansible (ALASANSIBLE2-2023-001)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of ansible installed on the remote host is prior to 2.9.23-1. It is, therefore, affected by a vulnerability
as referenced in the ALAS2ANSIBLE2-2023-001 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALASANSIBLE2-2023-001.html");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/cve/html/CVE-2021-3583.html");
...
var pkgs = [
    {'reference':'ansible-2.9.23-1.amzn2', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible2'},
    {'reference':'ansible-doc-2.9.23-1.amzn2', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible2'}
];
