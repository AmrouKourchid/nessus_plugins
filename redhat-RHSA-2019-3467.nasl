...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_3467.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?549a6701");
...
"Update the RHEL dovecot package based on the guidance in RHSA-2019:3467.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'dovecot-2.2.36-10.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'dovecot-devel-2.2.36-10.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'dovecot-mysql-2.2.36-10.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'dovecot-pgsql-2.2.36-10.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'dovecot-pigeonhole-2.2.36-10.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
