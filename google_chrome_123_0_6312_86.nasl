...
if (description)
{
  ...
  script_name(english:"Google Chrome < 123.0.6312.86 Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"A web browser installed on the remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Google Chrome installed on the remote Windows host is prior to 123.0.6312.86. It is, therefore, affected
by multiple vulnerabilities as referenced in the 2024_03_stable-channel-update-for-desktop_26 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0b004e43");
  script_set_attribute(attribute:"see_also", value:"https://crbug.com/327807820");
  script_set_attribute(attribute:"see_also", value:"https://crbug.com/328958020");
  script_set_attribute(attribute:"see_also", value:"https://crbug.com/330575496");
  script_set_attribute(attribute:"see_also", value:"https://crbug.com/330588502");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Google Chrome version 123.0.6312.86 or later.");
...
google_chrome_check_version(installs:installs, fix:'123.0.6312.86', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
