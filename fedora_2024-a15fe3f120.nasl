...
# extracted from Fedora Security Advisory FEDORA-2024-a15fe3f120
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-a15fe3f120");

  script_name(english:"Fedora 38 : baresip (2024-a15fe3f120)");
...
FEDORA-2024-a15fe3f120 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-a15fe3f120");
...
var pkgs = [
    {'reference':'baresip-3.10.1-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
