...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : Important: / nfs-utils-lib (ELSA-2007-0951)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2007-0951.html");
...
var pkgs = [
    {'reference':'nfs-utils-lib-1.0.8-7.2.z2', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'nfs-utils-lib-devel-1.0.8-7.2.z2', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'nfs-utils-lib-1.0.8-7.2.z2', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'nfs-utils-lib-devel-1.0.8-7.2.z2', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
