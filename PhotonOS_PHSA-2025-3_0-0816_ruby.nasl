...
# extracted from VMware Security Advisory PHSA-2025-3.0-0816. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Ruby PHSA-2025-3.0-0816");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the ruby package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-3.0-816.md");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'ruby-2.5.8-9.ph3')) flag++;
