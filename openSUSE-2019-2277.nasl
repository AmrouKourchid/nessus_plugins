...
# extracted from openSUSE Security Update openSUSE-2019-2277.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : putty (openSUSE-2019-2277)");
...
"This update for putty to version 0.73 fixes the following issues :
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1152753");
...
"Update the affected putty packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-17068");
...
if ( rpm_check(release:"SUSE15.1", reference:"putty-0.73-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"putty-debuginfo-0.73-lp151.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"putty-debugsource-0.73-lp151.3.6.1") ) flag++;
