...
# extracted from SUSE update advisory SUSE-SU-2021:1174-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : clamav (SUSE-SU-2021:1174-1)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c66ba470");
...
zypper in -t patch SUSE-SLE-SERVER-12-SP5-2021-1174=1");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"5", reference:"clamav-0.103.2-3.6.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"clamav-debuginfo-0.103.2-3.6.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"clamav-debugsource-0.103.2-3.6.1")) flag++;
