...
# extracted from Red Hat Security Advisory RHSA-2019:1329. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:1329");

  script_name(english:"RHEL 6 / 7 : rh-python36-python-jinja2 (RHSA-2019:1329)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for rh-python36-python-jinja2.");
...
in the RHSA-2019:1329 advisory.

    The python-jinja2 package contains Jinja2, a template engine written in pure Python. Jinja2 provides a
    Django inspired non-XML syntax but supports inline expressions and an optional sandboxed environment.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1698839");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_1329.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f9c2c01d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:1329");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rh-python36-python-jinja2 package based on the guidance in RHSA-2019:1329.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rh-python36-python-jinja2");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-python36-python-jinja2-2.9.6-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'rh-python36-python-jinja2-2.9.6-3.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'rh-python36-python-jinja2');
}
