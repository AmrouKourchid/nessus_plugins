...
# extracted from Fedora Security Advisory FEDORA-2023-4ae90bc849
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-4ae90bc849");

  script_name(english:"Fedora 39 : rust-rustls-webpki (2023-4ae90bc849)");
...
FEDORA-2023-4ae90bc849 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-4ae90bc849");
  script_set_attribute(attribute:"solution", value:
"Update the affected rust-rustls-webpki package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:rust-rustls-webpki");
...
var pkgs = [
    {'reference':'rust-rustls-webpki-0.100.2-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'rust-rustls-webpki');
}
