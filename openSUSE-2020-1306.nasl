...
# extracted from openSUSE Security Update openSUSE-2020-1306.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : chromium (openSUSE-2020-1306)");
...
if ( rpm_check(release:"SUSE15.2", reference:"chromedriver-85.0.4183.69-lp152.2.20.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"chromedriver-debuginfo-85.0.4183.69-lp152.2.20.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"chromium-85.0.4183.69-lp152.2.20.1", allowmaj:TRUE) ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"chromium-debuginfo-85.0.4183.69-lp152.2.20.1", allowmaj:TRUE) ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"chromium-debugsource-85.0.4183.69-lp152.2.20.1", allowmaj:TRUE) ) flag++;
