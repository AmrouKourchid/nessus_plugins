...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : bind (EulerOS-SA-2023-2911)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2911
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0c72933f");
...
var pkgs = [
  ...
  "python3-bind-9.11.21-4.h22.eulerosv2r10"
];
