...
# extracted from Red Hat Security Advisory RHSA-2025:0204. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:0204");

  script_name(english:"RHEL 8 : Red Hat OpenStack Platform 16.2 (openstack-ironic) (RHSA-2025:0204)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for Red Hat OpenStack Platform 16.2 (openstack-ironic).");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2025:0204 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_0204.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f108d96f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:0204");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat OpenStack Platform 16.2 (openstack-ironic) package based on the guidance in RHSA-2025:0204.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openstack-ironic-api-13.0.8-2.20230713045150.d10fd5c.el8ost', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'},
      {'reference':'openstack-ironic-common-13.0.8-2.20230713045150.d10fd5c.el8ost', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'},
      {'reference':'openstack-ironic-conductor-13.0.8-2.20230713045150.d10fd5c.el8ost', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'}
    ]
  }
];
