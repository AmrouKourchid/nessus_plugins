...
# extracted from Ubuntu Security Notice USN-6397-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6397-1");

  script_name(english:"Ubuntu 20.04 LTS : Linux kernel (BlueField) vulnerabilities (USN-6397-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6397-1");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.4.0-1070-bluefield");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-6397-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2022-40982', 'CVE-2023-2002', 'CVE-2023-2163', 'CVE-2023-2269', 'CVE-2023-3268', 'CVE-2023-3609', 'CVE-2023-3611', 'CVE-2023-3776', 'CVE-2023-20593', 'CVE-2023-21255', 'CVE-2023-31084', 'CVE-2023-35823', 'CVE-2023-35824', 'CVE-2023-35828');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-6397-1');
  }
  else
  {
