...
# extracted from Amazon Linux 2023 Security Advisory ALAS2023-2024-631.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2023 : amazon-ecr-credential-helper (ALAS2023-2024-631)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2023 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"It is, therefore, affected by multiple vulnerabilities as referenced in the ALAS2023-2024-631 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2023/ALAS-2024-631.html");
...
"Run 'dnf update amazon-ecr-credential-helper --releasever 2023.4.20240528' to update your system.");
...
var pkgs = [
    {'reference':'amazon-ecr-credential-helper-0.7.1-4.amzn2023', 'cpu':'aarch64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'amazon-ecr-credential-helper-0.7.1-4.amzn2023', 'cpu':'x86_64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "amazon-ecr-credential-helper");
}
