...
# extracted from openSUSE Security Update openSUSE-2021-468.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : nghttp2 (openSUSE-2021-468)");
...
This update was imported from the SUSE:SLE-15:Update update project.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1181358");
...
if ( rpm_check(release:"SUSE15.2", reference:"libnghttp2-14-1.40.0-lp152.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libnghttp2-14-debuginfo-1.40.0-lp152.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libnghttp2-devel-1.40.0-lp152.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libnghttp2_asio-devel-1.40.0-lp152.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libnghttp2_asio1-1.40.0-lp152.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libnghttp2_asio1-debuginfo-1.40.0-lp152.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"nghttp2-1.40.0-lp152.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"nghttp2-debuginfo-1.40.0-lp152.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"nghttp2-debugsource-1.40.0-lp152.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"nghttp2-python-debugsource-1.40.0-lp152.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"python3-nghttp2-1.40.0-lp152.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"python3-nghttp2-debuginfo-1.40.0-lp152.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"libnghttp2-14-32bit-1.40.0-lp152.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"libnghttp2-14-32bit-debuginfo-1.40.0-lp152.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"libnghttp2_asio1-32bit-1.40.0-lp152.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"libnghttp2_asio1-32bit-debuginfo-1.40.0-lp152.2.6.1") ) flag++;
