...
# extracted from Fedora Security Advisory FEDORA-2018-2bfbd27a0b.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-2bfbd27a0b");

  script_name(english:"Fedora 28 : origin (2018-2bfbd27a0b)");
...
"- Rebase to 3.9
  ...
  - Security fix for CVE-2017-1002101 and CVE-2017-1002102

Note that Tenable Network Security has extracted the preceding
description block directly from the Fedora update system website.
Tenable has attempted to automatically clean and format it as much as
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-2bfbd27a0b");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"origin-3.9.0-1.fc28")) flag++;
