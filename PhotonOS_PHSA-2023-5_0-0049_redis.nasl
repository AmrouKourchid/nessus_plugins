...
if (description)
{
  ...
  script_cve_id("CVE-2022-24834", "CVE-2023-28425", "CVE-2023-36824");

  script_name(english:"Photon OS 5.0: Redis PHSA-2023-5.0-0049");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'redis-7.0.12-1.ph5')) flag++;
