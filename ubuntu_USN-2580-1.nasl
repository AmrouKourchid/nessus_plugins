...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : tcpdump vulnerabilities (USN-2580-1)");
...
the USN-2580-1 advisory.

    It was discovered that tcpdump incorrectly handled printing certain packets. A remote attacker could use
    this issue to cause tcpdump to crash, resulting in a denial of service, or possibly execute arbitrary
    code.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2580-1");
...
"Update the affected tcpdump package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-2155");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'tcpdump', 'pkgver': '4.5.1-2ubuntu1.2'}
];
