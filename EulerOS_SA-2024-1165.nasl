...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : shim-signed (EulerOS-SA-2024-1165)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the shim-signed package installed, the EulerOS installation on the remote host is affected
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1165
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9c078dc7");
