...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : NSPR vulnerability (USN-2790-1)");
...
USN-2790-1 advisory.
    ...
    Ryan Sleevi discovered that NSPR incorrectly handled memory allocation. A remote attacker could use this
    issue to cause NSPR to crash, resulting in a denial of service, or possibly execute arbitrary code.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2790-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'libnspr4', 'pkgver': '2:4.10.10-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'libnspr4-0d', 'pkgver': '2:4.10.10-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'libnspr4-dev', 'pkgver': '2:4.10.10-0ubuntu0.14.04.1'}
];
