...
referenced in the USN-6758-1 advisory.
    ...
    It was discovered that the JSON5 parse method incorrectly handled the parsing of keys named \_\_proto\_\_.
    An attacker could possibly use this issue to pollute the prototype of the returned object, setting
    arbitrary or unexpected keys, and cause a denial of service, allow unintended access to network services
    or have other unspecified impact, depending on the application's use of the module.
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'node-json5', 'pkgver': '0.5.1-1ubuntu0.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '20.04', 'pkgname': 'node-json5', 'pkgver': '0.5.1-3ubuntu0.1', 'ubuntu_pro': FALSE},
    {'osver': '22.04', 'pkgname': 'node-json5', 'pkgver': '2.2.0+dfsg-1ubuntu0.1~esm1', 'ubuntu_pro': TRUE}
];
