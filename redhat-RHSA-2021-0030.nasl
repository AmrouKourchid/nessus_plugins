...
if (description)
{
  ...
  script_name(english:"RHEL 7 / 8 : OpenShift Container Platform 4.4.32 (RHSA-2021:0030)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for OpenShift Container Platform 4.4.32.");
...
in the RHSA-2021:0030 advisory.
    ...
    * kubernetes: compromised node could escalate to cluster level privileges
    ...
    at
    https://docs.openshift.com/container-platform/4.4/updating/updating-cluster-between-
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_0030.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?34ba2fa7");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1913234");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.4.32 packages based on the guidance in RHSA-2021:0030.");
...
var constraints = [
  ...
  },
  {
    ...
    'pkgs': [
      {'reference':'openshift-hyperkube-4.4.0-202012052258.p0.git.0.0fd57a4.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
