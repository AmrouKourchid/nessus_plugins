...
"The remote Red Hat host is missing a security update for lasso.");
...
the RHSA-2021:2989 advisory.
    ...
    standards, including the SAML and SAML2 specifications. It allows handling of the whole life-cycle of
    SAML-based federations and provides bindings for multiple languages.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_2989.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7926831a");
...
"Update the RHEL lasso package based on the guidance in RHSA-2021:2989.");
...
var constraints = [
  {
    ...
    'pkgs': [
      ...
      {'reference':'lasso-2.5.1-8.el7_9', 'cpu':'ppc', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'lasso-2.5.1-8.el7_9', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'lasso-2.5.1-8.el7_9', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'lasso-2.5.1-8.el7_9', 'cpu':'s390', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'lasso-2.5.1-8.el7_9', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'lasso-devel-2.5.1-8.el7_9', 'cpu':'ppc', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'lasso-devel-2.5.1-8.el7_9', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'lasso-devel-2.5.1-8.el7_9', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'lasso-devel-2.5.1-8.el7_9', 'cpu':'s390', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'lasso-devel-2.5.1-8.el7_9', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'lasso-devel-2.5.1-8.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'lasso-python-2.5.1-8.el7_9', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'lasso-python-2.5.1-8.el7_9', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'lasso-python-2.5.1-8.el7_9', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
