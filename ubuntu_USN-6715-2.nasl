...
# extracted from Ubuntu Security Notice USN-6715-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6715-2");

  script_name(english:"Ubuntu 24.04 LTS : unixODBC vulnerability (USN-6715-2)");
...
USN-6715-2 advisory.
    ...
    USN-6715-1 fixed a vulnerability in unixODBC. This update provides the corresponding fix for Ubuntu 24.04
    LTS.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6715-2");
...
var pkgs = [
    {'osver': '24.04', 'pkgname': 'libodbc2', 'pkgver': '2.3.12-1ubuntu0.24.04.1'},
    {'osver': '24.04', 'pkgname': 'libodbccr2', 'pkgver': '2.3.12-1ubuntu0.24.04.1'},
    {'osver': '24.04', 'pkgname': 'libodbcinst2', 'pkgver': '2.3.12-1ubuntu0.24.04.1'},
    {'osver': '24.04', 'pkgname': 'odbcinst', 'pkgver': '2.3.12-1ubuntu0.24.04.1'},
    {'osver': '24.04', 'pkgname': 'unixodbc', 'pkgver': '2.3.12-1ubuntu0.24.04.1'},
    {'osver': '24.04', 'pkgname': 'unixodbc-common', 'pkgver': '2.3.12-1ubuntu0.24.04.1'},
    {'osver': '24.04', 'pkgname': 'unixodbc-dev', 'pkgver': '2.3.12-1ubuntu0.24.04.1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libodbc2 / libodbccr2 / libodbcinst2 / odbcinst / unixodbc / etc');
}
