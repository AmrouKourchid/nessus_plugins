...
# extracted from Oracle Linux Security Advisory ELSA-2024-2396.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : squashfs-tools (ELSA-2024-2396)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-2396.html");
...
"Update the affected squashfs-tools package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:squashfs-tools");
...
var pkgs = [
    {'reference':'squashfs-tools-4.4-10.git1.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'squashfs-tools-4.4-10.git1.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
