...
# extracted from Gentoo Linux Security Advisory GLSA 202409-08.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2022-0547", "CVE-2023-46849", "CVE-2023-46850");

  script_name(english:"GLSA-202409-08 : OpenVPN: Multiple Vulnerabilities");
...
"The remote host is affected by the vulnerability described in GLSA-202409-08 (OpenVPN: Multiple Vulnerabilities)
    ...
    Multiple vulnerabilities have been discovered in OpenVPN. Please review the CVE identifiers referenced
    below for details.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202409-08");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=835514");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=917272");
...
"All OpenVPN users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2023-46850");
...
var packages = [
  {
    ...
    'unaffected' : make_list("ge 2.6.7"),
    'vulnerable' : make_list("lt 2.6.7")
  }
];
