...
# AlmaLinux Security Advisory ALSA-2020:1653.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2020:1653");

  script_name(english:"AlmaLinux 8 : zziplib (ALSA-2020:1653)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2020-1653.html");
  script_set_attribute(attribute:"solution", value:
"Update the affected zziplib-devel package.");
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'zziplib-devel');
}
