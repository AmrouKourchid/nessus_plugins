...
# extracted from F5 Networks BIG-IP Solution K15412203.
#
# @NOAGENT@
##
...
if (description)
{
  ...
  script_cve_id("CVE-2017-1000365");

  script_name(english:"F5 Networks BIG-IP : Linux kernel vulnerability (K15412203)");

  script_set_attribute(attribute:"synopsis", value:
"The remote device is missing a vendor-supplied security patch.");
  script_set_attribute(attribute:"description", value:
"The version of F5 Networks BIG-IP installed on the remote host is prior to tested version. It is, therefore, affected by
a vulnerability as referenced in the K15412203 advisory.
    ...
    earlier. It appears that this feature was introduced in the Linux Kernel version 2.6.23.(CVE-2017-1000365)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K15412203");
...
Refer to the vendor for remediation guidance.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-1000365");
...
var vmatrix = {
  'AFM': {
    'affected': [
      '17.1.0-17.1.1','16.1.0-16.1.5','15.1.0-15.1.10','14.1.0-14.1.5','13.1.0-13.1.5','12.1.0-12.1.6','11.2.1-11.6.5'
    ],
  },
  'APM': {
    'affected': [
