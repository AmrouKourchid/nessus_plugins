...
if (description)
{
  ...
  script_name(english:"IBM Java 7.1 < 7.1.5.23 / 8.0 < 8.0.8.30 Multiple Vulnerabilities");
...
affected by multiple vulnerabilities as referenced in the Oracle July 16 2024 CPU advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"http://www.ibm.com/support/docview.wss?uid=swg1IJ51871");
  script_set_attribute(attribute:"see_also", value:"http://www.ibm.com/support/docview.wss?uid=swg1IJ51873");
  script_set_attribute(attribute:"see_also", value:"http://www.ibm.com/support/docview.wss?uid=swg1IJ51918");
  # https://www.ibm.com/support/pages/java-sdk-security-vulnerabilities#Oracle_July_16_2024_CPU
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a6b4578f");
  script_set_attribute(attribute:"solution", value:
"Apply the appropriate patch according to the Oracle July 16 2024 CPU advisory.");
