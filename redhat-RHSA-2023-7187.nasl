...
# extracted from Red Hat Security Advisory RHSA-2023:7187. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:7187");

  script_name(english:"RHEL 8 : procps-ng (RHSA-2023:7187)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for procps-ng.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2023:7187 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_7187.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4444723f");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:7187");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL procps-ng package based on the guidance in RHSA-2023:7187.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'procps-ng-3.3.15-14.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'procps-ng-devel-3.3.15-14.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
