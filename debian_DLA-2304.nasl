...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2020/08/msg00000.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/stretch/libpam-radius-auth");
  # https://security-tracker.debian.org/tracker/source-package/libpam-radius-auth
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ae15fc5f");
  script_set_attribute(attribute:"solution", value:
"Upgrade the affected libpam-radius-auth package.");
