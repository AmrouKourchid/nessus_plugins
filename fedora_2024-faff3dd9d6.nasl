...
# extracted from Fedora Security Advisory FEDORA-2024-faff3dd9d6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-faff3dd9d6");

  script_name(english:"Fedora 39 : vorbis-tools (2024-faff3dd9d6)");
...
FEDORA-2024-faff3dd9d6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-faff3dd9d6");
  script_set_attribute(attribute:"solution", value:
"Update the affected 1:vorbis-tools package.");
...
var pkgs = [
    {'reference':'vorbis-tools-1.4.2-10.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
