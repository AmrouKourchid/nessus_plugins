...
# extracted from Fedora Security Advisory FEDORA-2023-6edfbd5d17
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-6edfbd5d17");

  script_name(english:"Fedora 40 : iperf3 (2023-6edfbd5d17)");
...
FEDORA-2023-6edfbd5d17 advisory.

    Automatic update for iperf3-3.15-1.fc40.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-6edfbd5d17");
...
var pkgs = [
    {'reference':'iperf3-3.15-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
