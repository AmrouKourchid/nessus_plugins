...
# extracted from Red Hat Security Advisory RHSA-2024:1484. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_1484.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5f99028e");
...
"Update the RHEL firefox package based on the guidance in RHSA-2024:1484.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-115.9.1-1.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
