...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : qemu (EulerOS-SA-2023-2446)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2446
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cf167d2e");
...
var pkgs = [
  "qemu-gpu-specs-2.8.1-30.229",
  "qemu-guest-agent-2.8.1-30.229",
  "qemu-img-2.8.1-30.229",
  "qemu-kvm-2.8.1-30.229",
  "qemu-kvm-common-2.8.1-30.229",
  "qemu-kvm-tools-2.8.1-30.229",
  "qemu-seabios-2.8.1-30.229"
];
