...
# extracted from Fedora Security Advisory FEDORA-2022-d209710a36
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-d209710a36");

  script_name(english:"Fedora 36 : drupal7-link (2022-d209710a36)");
...
FEDORA-2022-d209710a36 advisory.

    - https://www.drupal.org/project/link/releases/7.x-1.11
        - [SA-CONTRIB-2022-034](https://www.drupal.org/sa-contrib-2022-034)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-d209710a36");
  script_set_attribute(attribute:"solution", value:
"Update the affected drupal7-link package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:drupal7-link");
...
var pkgs = [
    {'reference':'drupal7-link-1.11-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'drupal7-link');
}
