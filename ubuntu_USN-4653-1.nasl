...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 20.04 LTS : containerd vulnerability (USN-4653-1)");
...
referenced in the USN-4653-1 advisory.

    It was discovered that access controls for the shims API socket did not restrict access to the abstract
    unix domain socket in some cases. An attacker could use this vulnerability to run containers with elevated
    privileges.
