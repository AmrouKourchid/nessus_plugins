...
if (description)
{
  ...
  script_name(english:"Foxit PDF Editor < 12.1.5 Multiple Vulnerabilities");
...
Windows host is prior to 12.1.5. It is, therefore affected by multiple vulnerabilities:
...
var constraints = [
  { 'max_version' : '11.2.8.53842', 'fixed_version' : '12.1.5' },
  { 'min_version' : '12.0', 'max_version' : '12.1.4.15400', 'fixed_version' : '12.1.5' }
];
