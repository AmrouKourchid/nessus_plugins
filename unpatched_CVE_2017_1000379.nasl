...
if (description)
{
  ...
  script_cve_id("CVE-2017-1000379");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2017-1000379");
...
patch available.
  ...
  - The Linux Kernel running on AMD64 systems will sometimes map the contents of PIE executable, the heap or
    ld.so to where the stack is mapped allowing attackers to more easily manipulate the stack. Linux Kernel
    version 4.11.5 is affected. (CVE-2017-1000379)
