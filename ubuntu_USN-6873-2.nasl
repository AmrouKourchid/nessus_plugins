...
# extracted from Ubuntu Security Notice USN-6873-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6873-2");

  script_name(english:"Ubuntu 22.04 LTS : Linux kernel (StarFive) vulnerabilities (USN-6873-2)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6873-2");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-6873-2');
}
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-6873-2');
  }
  else
  {
