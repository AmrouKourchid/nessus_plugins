...
# extracted from Red Hat Security Advisory RHSA-2022:5234 and
# CentOS Errata and Security Advisory 2022:5234 respectively.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : python-virtualenv (RHSA-2022:5234)");
...
var pkgs = [
    {'reference':'python-virtualenv-15.1.0-7.el7_9', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE}
];
