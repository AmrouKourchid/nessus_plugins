...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP12 : docker-runc (EulerOS-SA-2024-2934)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2934
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0d4cf21e");
...
var pkgs = [
  "docker-runc-1.1.3-9.h29.eulerosv2r12"
];
