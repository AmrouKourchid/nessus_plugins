...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : python-cryptography (EulerOS-SA-2024-1700)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the python-cryptography packages installed, the EulerOS Virtualization installation on the
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1700
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5958b463");
...
var pkgs = [
  "python2-cryptography-2.3-2.h2.eulerosv2r8",
  "python3-cryptography-2.3-2.h2.eulerosv2r8"
];
