...
# extracted from Debian Security Advisory dsa-5601. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5601 : php-phpseclib3 - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 12 host has a package installed that is affected by a vulnerability as referenced in the dsa-5601
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7aa74368");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-48795");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bookworm/php-phpseclib3");
  script_set_attribute(attribute:"solution", value:
"Upgrade the php-phpseclib3 packages.");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'php-phpseclib3', 'reference': '3.0.19-1+deb12u2'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'php-phpseclib3');
}
