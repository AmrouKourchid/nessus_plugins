...
# extracted from Red Hat Security Advisory RHSA-2025:3772. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 8 : go-toolset:rhel8 (RHSA-2025:3772)");
...
referenced in the RHSA-2025:3772 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2341750");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2341751");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_3772.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?477ec5c7");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:3772");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL go-toolset:rhel8 package based on the guidance in RHSA-2025:3772.");
  ...
  'go-toolset:rhel8': [
    {
      ...
      'pkgs': [
        {'reference':'delve-1.24.1-1.module+el8.10.0+22945+b2c96a17', 'cpu':'aarch64', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'delve-1.24.1-1.module+el8.10.0+22945+b2c96a17', 'cpu':'ppc64le', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'delve-1.24.1-1.module+el8.10.0+22945+b2c96a17', 'cpu':'x86_64', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'go-toolset-1.23.6-1.module+el8.10.0+22945+b2c96a17', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'golang-1.23.6-1.module+el8.10.0+22945+b2c96a17', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'golang-bin-1.23.6-1.module+el8.10.0+22945+b2c96a17', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'golang-docs-1.23.6-1.module+el8.10.0+22945+b2c96a17', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'golang-misc-1.23.6-1.module+el8.10.0+22945+b2c96a17', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'golang-src-1.23.6-1.module+el8.10.0+22945+b2c96a17', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'golang-tests-1.23.6-1.module+el8.10.0+22945+b2c96a17', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
