...
if (description)
{
  ...
  script_name(english:"Apache Tomcat 9.0.0.M1 < 9.0.19 multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Apache Tomcat server is affected by multiple vulnerabilities");
  script_set_attribute(attribute:"description", value:
"The version of Tomcat installed on the remote host is prior to 9.0.19. It is, therefore, affected by multiple
vulnerabilities as referenced in the fixed_in_apache_tomcat_9.0.19_security-9 advisory.
...
number.");
  ...
  # https://github.com/apache/tomcat/commit/4b244d827ade2a36ef3b8734939541207b78f35c
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d445c2d1");
  # https://github.com/apache/tomcat/commit/15fcd166ea2c1bb79e8541b8e1a43da9c452ceea
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dcb8f0f4");
...
var constraints = [
  { 'min_version' : '9.0.0.M1', 'max_version' : '9.0.17', 'fixed_version' : '9.0.19' }
];
