...
referenced in the ALAS2-2022-1755 advisory.
    ...
    Due to the use of the system command in the Magick-Load op used by gegl an attacker is able to craft a
    command line path that is able to lead to the execution of arbitrary shell commands that impacts
    availability, confidentiality and integrity. (CVE-2021-45463)
