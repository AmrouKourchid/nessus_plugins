...
# extracted from Fedora Security Advisory FEDORA-2024-5f9b20882f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-5f9b20882f");

  script_name(english:"Fedora 40 : linux-firmware (2024-5f9b20882f)");
...
FEDORA-2024-5f9b20882f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-5f9b20882f");
...
var pkgs = [
    {'reference':'linux-firmware-20241210-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
