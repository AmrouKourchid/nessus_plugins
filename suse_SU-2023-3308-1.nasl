...
# SUSE update advisory SUSE-SU-2023:3308-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:3308-1");
  script_xref(name:"IAVA", value:"2023-A-0398-S");

  script_name(english:"SUSE SLES12 Security Update : openssl-1_0_0 (SUSE-SU-2023:3308-1)");
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-August/015897.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?339b72be");
...
var pkgs = [
    {'reference':'libopenssl-devel-1.0.2j-60.104.1', 'sp':'2', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-bcl-release-12.2']},
    {'reference':'libopenssl1_0_0-1.0.2j-60.104.1', 'sp':'2', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-bcl-release-12.2']},
    {'reference':'libopenssl1_0_0-32bit-1.0.2j-60.104.1', 'sp':'2', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-bcl-release-12.2']},
    {'reference':'libopenssl1_0_0-hmac-1.0.2j-60.104.1', 'sp':'2', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-bcl-release-12.2']},
    {'reference':'libopenssl1_0_0-hmac-32bit-1.0.2j-60.104.1', 'sp':'2', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-bcl-release-12.2']},
    {'reference':'openssl-1.0.2j-60.104.1', 'sp':'2', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-bcl-release-12.2']},
    {'reference':'openssl-doc-1.0.2j-60.104.1', 'sp':'2', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-bcl-release-12.2']}
];
