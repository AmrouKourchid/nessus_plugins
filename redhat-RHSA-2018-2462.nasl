...
referenced in the RHSA-2018:2462 advisory.
    ...
    * QEMU: i386: multiboot OOB access while loading kernel image (CVE-2018-7550)
    ...
    Red Hat would like to thank Jskz - Zero Day Initiative (trendmicro.com) for reporting CVE-2018-11806 and
    Cyrille Chatras (Orange.com) and CERT-CC (Orange.com) for reporting CVE-2018-7550.

    Bug Fix(es):

    * Previously, live migrating a Windows guest in some cases caused the guest to become unresponsive. This
    update ensures that Real-time Clock (RTC) interrupts are not missed, which prevents the problem from
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_2462.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d7e9ae40");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:2462");
...
"Update the RHEL qemu-kvm package based on the guidance in RHSA-2018:2462.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'qemu-img-1.5.3-156.el7_5.5', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10'},
      {'reference':'qemu-kvm-1.5.3-156.el7_5.5', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10'},
      {'reference':'qemu-kvm-common-1.5.3-156.el7_5.5', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10'},
      {'reference':'qemu-kvm-tools-1.5.3-156.el7_5.5', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10'}
    ]
  }
];
