...
# extracted from Oracle Linux Security Advisory ELSA-2024-1375.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : squid:4 (ELSA-2024-1375)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ELSA-2024-1375 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-1375.html");
...
var appstreams = {
    'squid:4': [
      {'reference':'libecap-1.0.1-2.module+el8.9.0+90083+f7556140', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libecap-devel-1.0.1-2.module+el8.9.0+90083+f7556140', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'squid-4.15-7.module+el8.9.0+90184+ff65e696.10', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'libecap-1.0.1-2.module+el8.9.0+90083+f7556140', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libecap-devel-1.0.1-2.module+el8.9.0+90083+f7556140', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'squid-4.15-7.module+el8.9.0+90184+ff65e696.10', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
    ]
};
