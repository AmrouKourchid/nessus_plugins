...
# extracted from Fedora Security Advisory FEDORA-2022-5a74a5eea7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-5a74a5eea7");

  script_name(english:"Fedora 37 : python-oauthlib (2022-5a74a5eea7)");
...
FEDORA-2022-5a74a5eea7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-5a74a5eea7");
...
var pkgs = [
    {'reference':'python-oauthlib-3.2.1-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
