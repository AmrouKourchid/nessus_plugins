...
# extracted from Red Hat Security Advisory RHSA-2024:2303. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2303");

  script_name(english:"RHEL 9 : gstreamer1-plugins-good (RHSA-2024:2303)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2303.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?300d741d");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2303");
...
"Update the RHEL gstreamer1-plugins-good package based on the guidance in RHSA-2024:2303.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gstreamer1-plugins-good-1.22.1-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gstreamer1-plugins-good-gtk-1.22.1-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
