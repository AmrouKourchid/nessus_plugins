...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.cve.org/CVERecord?id=CVE-2022-1343");
  script_set_attribute(attribute:"see_also", value:"https://www.cve.org/CVERecord?id=CVE-2022-1434");
  script_set_attribute(attribute:"see_also", value:"https://www.cve.org/CVERecord?id=CVE-2022-1473");
  # https://git.openssl.org/gitweb/?p=openssl.git;a=commitdiff;h=7d56a74a96828985db7354a55227a511615f732b
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a704d771");
  # https://git.openssl.org/gitweb/?p=openssl.git;a=commitdiff;h=1ad73b4d27bd8c1b369a3cd453681d3a4f1bb9b2
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ea9b1d96");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4e726fd8");
  # https://git.openssl.org/gitweb/?p=openssl.git;a=commitdiff;h=64c85430f95200b6b51fe9475bd5203f7c19daf1
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7cec6b9a");
...
var constraints = [
  { 'min_version' : '3.0.0', 'fixed_version' : '3.0.3' }
];
