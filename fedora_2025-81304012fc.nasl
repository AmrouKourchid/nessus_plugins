...
# extracted from Fedora Security Advisory FEDORA-2025-81304012fc
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-81304012fc");

  script_name(english:"Fedora 41 : python3.11 (2025-81304012fc)");
...
FEDORA-2025-81304012fc advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-81304012fc");
...
var pkgs = [
    {'reference':'python3.11-3.11.11-5.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
