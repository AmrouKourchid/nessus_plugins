...
# extracted from Red Hat Security Advisory RHSA-2025:1091. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:1091");

  script_name(english:"RHEL 9 : ovn22.09 (RHSA-2025:1091)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_1091.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3f384fdd");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:1091");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL ovn22.09 package based on the guidance in RHSA-2025:1091.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ovn22.09-22.09.2-86.el9fdp', 'release':'9', 'el_string':'el9fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openvswitch'},
      {'reference':'ovn22.09-central-22.09.2-86.el9fdp', 'release':'9', 'el_string':'el9fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openvswitch'},
      {'reference':'ovn22.09-host-22.09.2-86.el9fdp', 'release':'9', 'el_string':'el9fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openvswitch'},
      {'reference':'ovn22.09-vtep-22.09.2-86.el9fdp', 'release':'9', 'el_string':'el9fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openvswitch'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'ovn22.09 / ovn22.09-central / ovn22.09-host / ovn22.09-vtep');
}
