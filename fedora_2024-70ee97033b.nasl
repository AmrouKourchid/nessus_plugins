...
# extracted from Fedora Security Advisory FEDORA-2024-70ee97033b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-70ee97033b");

  script_name(english:"Fedora 38 : upx (2024-70ee97033b)");
...
FEDORA-2024-70ee97033b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-70ee97033b");
...
var pkgs = [
    {'reference':'upx-4.2.3-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
