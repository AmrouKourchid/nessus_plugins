...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Vim PHSA-2023-5.0-0070");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'vim-9.0.1664-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'vim-extra-9.0.1664-1.ph5')) flag++;
