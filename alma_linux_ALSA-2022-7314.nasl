...
# AlmaLinux Security Advisory ALSA-2022:7314.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2022:7314");

  script_name(english:"AlmaLinux 9 : zlib (ALSA-2022:7314)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2022-7314.html");
...
"Update the affected zlib, zlib-devel and / or zlib-static packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:zlib");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:zlib-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:zlib-static");
