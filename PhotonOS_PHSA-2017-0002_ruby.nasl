...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'ruby-2.4.0-1.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'ruby-debuginfo-2.4.0-1.ph1')) flag++;
