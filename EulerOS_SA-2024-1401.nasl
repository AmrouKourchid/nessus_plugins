...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.1 : libwebp (EulerOS-SA-2024-1401)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the libwebp packages installed, the EulerOS Virtualization installation on the remote host
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1401
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f7cfba5b");
...
"Update the affected libwebp packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:libXt");
...
var pkgs = [
  "libXt-1.2.1-1.h2.eulerosv2r11",
  "libwebp-1.2.1-1.h2.eulerosv2r11"
];
