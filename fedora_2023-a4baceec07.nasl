...
# extracted from Fedora Security Advisory FEDORA-2023-a4baceec07
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-a4baceec07");

  script_name(english:"Fedora 36 : manifest-tool (2023-a4baceec07)");
...
FEDORA-2023-a4baceec07 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-a4baceec07");
  script_set_attribute(attribute:"solution", value:
"Update the affected manifest-tool package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:manifest-tool");
...
var pkgs = [
    {'reference':'manifest-tool-2.0.8-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'manifest-tool');
}
