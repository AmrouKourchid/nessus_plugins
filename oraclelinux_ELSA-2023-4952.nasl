...
# extracted from Oracle Linux Security Advisory ELSA-2023-4952.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : firefox (ELSA-2023-4952)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-4952.html");
...
var pkgs = [
    {'reference':'firefox-102.15.0-1.0.1.el8_8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-102.15.0-1.0.1.el8_8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
