...
# extracted from Fedora Security Advisory FEDORA-2024-75e1256954
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-75e1256954");

  script_name(english:"Fedora 38 : libuev (2024-75e1256954)");
...
FEDORA-2024-75e1256954 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-75e1256954");
...
var pkgs = [
    {'reference':'libuev-2.4.1-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
