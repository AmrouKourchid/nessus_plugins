...
# extracted from Debian Security Advisory dla-3824. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3824 : gir1.2-gst-plugins-base-1.0 - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3824
advisory.

    - -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3824-1                debian-lts@lists.debian.org
    https://www.debian.org/lts/security/                          Adrian Bunk
    May 30, 2024                                  https://wiki.debian.org/LTS
    - -------------------------------------------------------------------------

    Package        : gst-plugins-base1.0
    Version        : 1.14.4-2+deb10u3
...
var pkgs = [
    {'release': '10.0', 'prefix': 'gir1.2-gst-plugins-base-1.0', 'reference': '1.14.4-2+deb10u3'},
    {'release': '10.0', 'prefix': 'gstreamer1.0-alsa', 'reference': '1.14.4-2+deb10u3'},
    {'release': '10.0', 'prefix': 'gstreamer1.0-gl', 'reference': '1.14.4-2+deb10u3'},
    {'release': '10.0', 'prefix': 'gstreamer1.0-plugins-base', 'reference': '1.14.4-2+deb10u3'},
    {'release': '10.0', 'prefix': 'gstreamer1.0-plugins-base-apps', 'reference': '1.14.4-2+deb10u3'},
    {'release': '10.0', 'prefix': 'gstreamer1.0-plugins-base-dbg', 'reference': '1.14.4-2+deb10u3'},
    {'release': '10.0', 'prefix': 'gstreamer1.0-plugins-base-doc', 'reference': '1.14.4-2+deb10u3'},
    {'release': '10.0', 'prefix': 'gstreamer1.0-x', 'reference': '1.14.4-2+deb10u3'},
    {'release': '10.0', 'prefix': 'libgstreamer-gl1.0-0', 'reference': '1.14.4-2+deb10u3'},
    {'release': '10.0', 'prefix': 'libgstreamer-plugins-base1.0-0', 'reference': '1.14.4-2+deb10u3'},
    {'release': '10.0', 'prefix': 'libgstreamer-plugins-base1.0-dev', 'reference': '1.14.4-2+deb10u3'}
];
