...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : wayland (EulerOS-SA-2023-1519)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1519
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?51d82e56");
...
var pkgs = [
  "libwayland-client-1.14.0-2.h1.eulerosv2r7",
  "libwayland-cursor-1.14.0-2.h1.eulerosv2r7",
  "libwayland-server-1.14.0-2.h1.eulerosv2r7",
  "wayland-devel-1.14.0-2.h1.eulerosv2r7"
];
