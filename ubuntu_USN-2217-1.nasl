...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : lxml vulnerability (USN-2217-1)");
...
USN-2217-1 advisory.
    ...
    It was discovered that the lxml.html.clean module incorrectly stripped control characters. An attacked
    could potentially exploit this to conduct cross-site scripting (XSS) attacks.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2217-1");
...
"Update the affected python-lxml and / or python3-lxml packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-3146");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'python-lxml', 'pkgver': '3.3.3-1ubuntu0.1'},
    {'osver': '14.04', 'pkgname': 'python3-lxml', 'pkgver': '3.3.3-1ubuntu0.1'}
];
