...
# extracted from Fedora Security Advisory FEDORA-2023-f8d216faed
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-f8d216faed");

  script_name(english:"Fedora 38 : matrix-synapse (2023-f8d216faed)");
...
FEDORA-2023-f8d216faed advisory.

    Update to 1.95.1 (CVE-2023-43796)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-f8d216faed");
...
var pkgs = [
    {'reference':'matrix-synapse-1.95.1-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
