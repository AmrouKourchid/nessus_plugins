...
# extracted from Amazon Linux 2 Security Advisory ALAS-2019-1327.
#
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : libtiff (ALAS-2019-1327)");
...
by tiff2ps.(CVE-2018-8905)");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2019-1327.html");
...
flag = 0;
if (rpm_check(release:"AL2", reference:"libtiff-4.0.3-32.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"libtiff-debuginfo-4.0.3-32.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"libtiff-devel-4.0.3-32.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"libtiff-static-4.0.3-32.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"libtiff-tools-4.0.3-32.amzn2")) flag++;
