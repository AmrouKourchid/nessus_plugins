...
# extracted from Red Hat Security Advisory RHSA-2017:2484. The text 
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2017/rhsa-2017_2484.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e7538666");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2017:2484");
...
"Update the RHEL git package based on the guidance in RHSA-2017:2484.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'emacs-git-1.8.3.1-12.el7_4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'emacs-git-el-1.8.3.1-12.el7_4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-1.8.3.1-12.el7_4', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-1.8.3.1-12.el7_4', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-1.8.3.1-12.el7_4', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-1.8.3.1-12.el7_4', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-all-1.8.3.1-12.el7_4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-bzr-1.8.3.1-12.el7_4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-cvs-1.8.3.1-12.el7_4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-daemon-1.8.3.1-12.el7_4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-email-1.8.3.1-12.el7_4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-gui-1.8.3.1-12.el7_4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-hg-1.8.3.1-12.el7_4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-p4-1.8.3.1-12.el7_4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-svn-1.8.3.1-12.el7_4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gitk-1.8.3.1-12.el7_4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gitweb-1.8.3.1-12.el7_4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'perl-Git-1.8.3.1-12.el7_4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'perl-Git-SVN-1.8.3.1-12.el7_4', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
