...
# extracted from Red Hat Security Advisory RHSA-2019:3755 and 
# Oracle Linux Security Advisory ELSA-2019-3755 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : sudo (ELSA-2019-3755)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2019-3755.html");
...
var pkgs = [
    {'reference':'sudo-1.8.6p3-29.0.1.el6_10.2', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sudo-devel-1.8.6p3-29.0.1.el6_10.2', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sudo-1.8.6p3-29.0.1.el6_10.2', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sudo-devel-1.8.6p3-29.0.1.el6_10.2', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
];
