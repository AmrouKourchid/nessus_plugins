...
# extracted from Fedora Security Advisory FEDORA-2023-0806784f24
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-0806784f24");

  script_name(english:"Fedora 37 : python-urllib3 (2023-0806784f24)");
...
FEDORA-2023-0806784f24 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-0806784f24");
...
var pkgs = [
    {'reference':'python-urllib3-1.26.17-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
