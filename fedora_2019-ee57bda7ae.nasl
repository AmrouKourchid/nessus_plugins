...
# extracted from Fedora Security Advisory FEDORA-2019-ee57bda7ae.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : lua (2019-ee57bda7ae)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-ee57bda7ae");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"lua-5.3.5-3.fc29")) flag++;
