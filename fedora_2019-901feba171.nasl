...
# extracted from Fedora Security Advisory FEDORA-2019-901feba171.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : 2:docker (2019-901feba171)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-901feba171");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"docker-1.13.1-63.git1185cfd.fc28", epoch:"2")) flag++;
