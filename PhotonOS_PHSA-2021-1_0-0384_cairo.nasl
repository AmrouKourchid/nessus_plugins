...
# extracted from VMware Security Advisory PHSA-2021-1.0-0384. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Cairo PHSA-2021-1.0-0384");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the cairo package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-1.0-384.md");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'cairo-1.16.0-2.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'cairo-devel-1.16.0-2.ph1')) flag++;
