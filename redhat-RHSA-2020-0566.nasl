...
referenced in the RHSA-2020:0566 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_0566.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d908eaf7");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1789535");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-pillow package based on the guidance in RHSA-2020:0566.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-pillow-5.1.1-10.el8_0', 'sp':'0', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-pillow-5.1.1-10.el8_0', 'sp':'0', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
