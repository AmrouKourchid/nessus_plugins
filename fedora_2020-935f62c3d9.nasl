...
# extracted from Fedora Security Advisory FEDORA-2020-935f62c3d9.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 33 : libxml2 (2020-935f62c3d9)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-935f62c3d9");
...
flag = 0;
if (rpm_check(release:"FC33", reference:"libxml2-2.9.10-8.fc33")) flag++;
