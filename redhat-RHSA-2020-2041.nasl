...
# extracted from Red Hat Security Advisory RHSA-2020:2041. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_2041.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d6815818");
...
"Update the RHEL squid:4 package based on the guidance in RHSA-2020:2041.");
  ...
  'squid:4': [
    {
      ...
      'pkgs': [
        ...
        {'reference':'squid-4.4-8.module+el8.2.0+6449+6ba3df3e.1', 'sp':'2', 'release':'8', 'el_string':'el8.2.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
      ]
    },
    {
      'repo_relative_urls': [
      ...
      'pkgs': [
        ...
        {'reference':'squid-4.4-8.module+el8.2.0+6449+6ba3df3e.1', 'release':'8', 'el_string':'el8.2.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
      ]
    }
  ]
};
