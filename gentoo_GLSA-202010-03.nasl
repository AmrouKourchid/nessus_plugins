...
# extracted from Gentoo Linux Security Advisory GLSA 202010-03.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202010-03");

  script_name(english:"GLSA-202010-03 : libjpeg-turbo: Information disclosure");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202010-03
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202010-03");
...
if (qpkg_check(package:"media-libs/libjpeg-turbo", unaffected:make_list("ge 1.5.3-r3", "ge 2.0.4-r1"), vulnerable:make_list("lt 2.0.4-r1"))) flag++;
