...
# extracted from Red Hat Security Advisory cifs-utils. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2020-14342", "CVE-2021-20208", "CVE-2022-27239");

  script_name(english:"RHEL 7 : cifs-utils (Unpatched Vulnerability) (deprecated)");
