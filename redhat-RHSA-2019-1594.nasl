...
# extracted from Red Hat Security Advisory RHSA-2019:1594. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:1594");
  script_xref(name:"CEA-ID", value:"CEA-2019-0456");

  script_name(english:"RHEL 7 : redhat-virtualization-host (RHSA-2019:1594)");
...
referenced in the RHSA-2019:1594 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_1594.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5de66bbf");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:1594");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1721369");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL redhat-virtualization-host package based on the guidance in RHSA-2019:1594.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'redhat-release-virtualization-host-4.2-11.1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'},
      {'reference':'redhat-release-virtualization-host-content-4.2-11.1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'},
      {'reference':'redhat-virtualization-host-image-update-4.2-20190618.0.el7_6', 'release':'7', 'el_string':'el7_6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'},
      {'reference':'redhat-virtualization-host-image-update-placeholder-4.2-11.1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'}
    ]
  }
];
