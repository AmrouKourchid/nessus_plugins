...
# extracted from Fedora Security Advisory FEDORA-2022-dc6d6d9d6c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-dc6d6d9d6c");

  script_name(english:"Fedora 37 : ghc-cmark-gfm (2022-dc6d6d9d6c)");
...
FEDORA-2022-dc6d6d9d6c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-dc6d6d9d6c");
  script_set_attribute(attribute:"solution", value:
"Update the affected ghc-cmark-gfm package.");
...
var pkgs = [
    {'reference':'ghc-cmark-gfm-0.2.5-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'ghc-cmark-gfm');
}
