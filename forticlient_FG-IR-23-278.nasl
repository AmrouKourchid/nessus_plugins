...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2024-A-0828");

  script_name(english:"Fortinet FortiClient Credentials can be dumped from memory (FG-IR-23-278)");
...
vulnerability as referenced in the FG-IR-23-278 advisory.

  - A Cleartext Storage of Sensitive Information vulnerability [CWE-312] in FortiClientWindows 7.4.0 through
    7.4.1, 7.2.0 through 7.2.6, 7.0.0 through 7.0.13 and FortiClientLinux 7.4.0 through 7.4.2, 7.2.0 through
    7.2.7, 7.0.0 through 7.0.13 may permit a local authenticated user to retrieve VPN password via memory
    dump, due to JavaScript's garbage collector (CVE-2024-50570)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.fortiguard.com/psirt/FG-IR-23-278");
  # https://docs.fortinet.com/document/forticlient/7.4.1/xml-reference-guide/56173
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9ac050b5");
  # https://docs.fortinet.com/document/forticlient/7.4.1/ems-administration-guide/682498/remote-access
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8e8e6594");
  script_set_attribute(attribute:"solution", value:
"For 7.0.x, upgrade to FortiClient version 7.0.14 or later. For 7.2.x, upgrade to FortiClient version 7.2.7 or later. For
7.4.x, upgrade to FortiClient version 7.4.2 or later.");
