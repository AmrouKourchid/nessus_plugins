...
# extracted from Red Hat Security Advisory RHSA-2025:1209. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:1209");
  script_xref(name:"CEA-ID", value:"CEA-2021-0025");

  script_name(english:"RHEL 9 : tbb (RHSA-2025:1209)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_1209.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b7be1a85");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:1209");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL tbb package based on the guidance in RHSA-2025:1209.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-tbb-2020.3-8.el9_2.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tbb-2020.3-8.el9_2.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tbb-devel-2020.3-8.el9_2.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tbb-doc-2020.3-8.el9_2.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
