...
# extracted from Gentoo Linux Security Advisory GLSA 202008-13.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202008-13");
  script_xref(name:"IAVB", value:"2020-B-0047-S");

  script_name(english:"GLSA-202008-13 : PostgreSQL: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202008-13
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202008-13");
...
if (qpkg_check(package:"dev-db/postgresql", unaffected:make_list("ge 9.5.23", "ge 9.6.19", "ge 10.14", "ge 11.9", "ge 12.4"), vulnerable:make_list("lt 9.5.23", "lt 9.6.19", "lt 10.14", "lt 11.9", "lt 12.4"))) flag++;
