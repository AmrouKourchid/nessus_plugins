...
if (description)
{
  ...
  script_name(english:"Wireshark 4.0.x < 4.0.3 Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"An application installed on the remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Wireshark installed on the remote Windows host is prior to 4.0.3. It is, therefore, affected by multiple
vulnerabilities as referenced in the wireshark-4.0.3 advisory.
