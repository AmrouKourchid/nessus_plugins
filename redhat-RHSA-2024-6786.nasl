...
# extracted from Red Hat Security Advisory RHSA-2024:6786. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:6786");

  script_name(english:"RHEL 9 : firefox  update (Important) (RHSA-2024:6786)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:6786 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_6786.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?46a2cd4b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:6786");
...
"Update the affected firefox and / or firefox-x11 packages.");
  ...
  script_cwe_id(120, 200, 358, 497, 704, 787, 843, 862);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-128.2.0-1.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-x11-128.2.0-1.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
