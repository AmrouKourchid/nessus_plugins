...
# extracted from Fedora Security Advisory FEDORA-2024-1cab90a9e7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-1cab90a9e7");

  script_name(english:"Fedora 41 : podman-tui (2024-1cab90a9e7)");
...
FEDORA-2024-1cab90a9e7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-1cab90a9e7");
...
var pkgs = [
    {'reference':'podman-tui-1.2.3-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
