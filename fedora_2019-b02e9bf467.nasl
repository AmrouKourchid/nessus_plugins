...
# extracted from Fedora Security Advisory FEDORA-2019-b02e9bf467.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-b02e9bf467");

  script_name(english:"Fedora 29 : php-erusev-parsedown (2019-b02e9bf467)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-b02e9bf467");
...
"Update the affected php-erusev-parsedown package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-1000162");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"php-erusev-parsedown-1.7.1-1.fc29")) flag++;
