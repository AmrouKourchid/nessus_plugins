...
# extracted from Fedora Security Advisory FEDORA-2024-6b85e8848f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-6b85e8848f");

  script_name(english:"Fedora 39 : coreutils (2024-6b85e8848f)");
...
FEDORA-2024-6b85e8848f advisory.

    Security fix for CVE-2024-0684

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-6b85e8848f");
...
var pkgs = [
    {'reference':'coreutils-9.3-5.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
