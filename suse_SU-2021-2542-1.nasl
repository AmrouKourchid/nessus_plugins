...
# SUSE update advisory SUSE-SU-2021:2542-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2021:2542-1");

  script_name(english:"SUSE SLES15 Security Update : kernel (Live Patch 21 for SLE 15 SP1) (SUSE-SU-2021:2542-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote SUSE Linux SLES15 host has packages installed that are affected by multiple vulnerabilities as referenced in
the SUSE-SU-2021:2542-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2021-July/009226.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e4891064");
  script_set_attribute(attribute:"solution", value:
"Update the affected kernel-livepatch-4_12_14-197_78-default and / or kernel-livepatch-5_3_18-24_43-default packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:suse_linux:kernel-livepatch-4_12_14-197_78-default");
...
var pkgs = [
    {'reference':'kernel-livepatch-4_12_14-197_78-default-9-2.2', 'sp':'1', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.1']},
    {'reference':'kernel-livepatch-5_3_18-24_43-default-9-2.2', 'sp':'2', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.2']}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kernel-livepatch-4_12_14-197_78-default / etc');
}
