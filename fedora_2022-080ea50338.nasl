...
# extracted from Fedora Security Advisory FEDORA-2022-080ea50338
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-080ea50338");

  script_name(english:"Fedora 36 : firefox (2022-080ea50338)");
...
FEDORA-2022-080ea50338 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-080ea50338");
...
var pkgs = [
    {'reference':'firefox-101.0-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
