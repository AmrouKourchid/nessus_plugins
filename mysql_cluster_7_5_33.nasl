...
if (description)
{
  ...
  script_name(english:"Oracle MySQL Cluster 7.5.x < 7.5.33 (January 2024 CPU)");
...
mysql_check_version(variant:'Cluster', fixed:'7.5.33', min:'7.5', severity:SECURITY_WARNING);
