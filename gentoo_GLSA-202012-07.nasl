...
# extracted from Gentoo Linux Security Advisory GLSA 202012-07.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202012-07");
  script_xref(name:"IAVB", value:"2020-B-0069-S");

  script_name(english:"GLSA-202012-07 : PostgreSQL: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202012-07
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202012-07");
...
if (qpkg_check(package:"dev-db/postgresql", unaffected:make_list("ge 9.5.24", "ge 9.6.20", "ge 10.15", "ge 11.10", "ge 12.5", "ge 13.1"), vulnerable:make_list("lt 13.1"))) flag++;
