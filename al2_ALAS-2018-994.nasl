...
# extracted from Amazon Linux 2 Security Advisory ALAS-2018-994.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2018-994");

  script_name(english:"Amazon Linux 2 : kernel (ALAS-2018-994)");
...
escalate their privileges.(CVE-2018-10901)");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2018-994.html");
  script_set_attribute(attribute:"solution", value:
"Run 'yum update kernel' to update the kernel and reboot your instance
to start the new kernel");
...
flag = 0;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"kernel-4.14.33-59.34.amzn2")) flag++;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"kernel-debuginfo-4.14.33-59.34.amzn2")) flag++;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"kernel-debuginfo-common-x86_64-4.14.33-59.34.amzn2")) flag++;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"kernel-devel-4.14.33-59.34.amzn2")) flag++;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"kernel-headers-4.14.33-59.34.amzn2")) flag++;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"kernel-tools-4.14.33-59.34.amzn2")) flag++;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"kernel-tools-debuginfo-4.14.33-59.34.amzn2")) flag++;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"kernel-tools-devel-4.14.33-59.34.amzn2")) flag++;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"perf-4.14.33-59.34.amzn2")) flag++;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"perf-debuginfo-4.14.33-59.34.amzn2")) flag++;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"python-perf-4.14.33-59.34.amzn2")) flag++;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"python-perf-debuginfo-4.14.33-59.34.amzn2")) flag++;
