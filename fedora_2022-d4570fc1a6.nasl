...
# extracted from Fedora Security Advisory FEDORA-2022-d4570fc1a6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-d4570fc1a6");

  script_name(english:"Fedora 36 : python3.6 (2022-d4570fc1a6)");
...
FEDORA-2022-d4570fc1a6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-d4570fc1a6");
...
var pkgs = [
    {'reference':'python3.6-3.6.15-12.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
