...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS : Libgcrypt vulnerability (USN-3065-1)");
...
in the USN-3065-1 advisory.

    Felix Drre and Vladimir Klebanov discovered that Libgcrypt incorrectly handled mixing functions in the
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3065-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'libgcrypt11', 'pkgver': '1.5.3-2ubuntu4.4'},
    {'osver': '14.04', 'pkgname': 'libgcrypt11-dev', 'pkgver': '1.5.3-2ubuntu4.4'},
    {'osver': '14.04', 'pkgname': 'libgcrypt11-udeb', 'pkgver': '1.5.3-2ubuntu4.4'},
    {'osver': '16.04', 'pkgname': 'libgcrypt11-dev', 'pkgver': '1.5.4-3+really1.6.5-2ubuntu0.2'},
    {'osver': '16.04', 'pkgname': 'libgcrypt20', 'pkgver': '1.6.5-2ubuntu0.2'},
    {'osver': '16.04', 'pkgname': 'libgcrypt20-dev', 'pkgver': '1.6.5-2ubuntu0.2'},
    {'osver': '16.04', 'pkgname': 'libgcrypt20-udeb', 'pkgver': '1.6.5-2ubuntu0.2'}
];
