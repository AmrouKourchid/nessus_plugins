...
# extracted from Fedora Security Advisory FEDORA-2023-6a3c2aeeee
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-6a3c2aeeee");

  script_name(english:"Fedora 39 : java-1.8.0-openjdk (2023-6a3c2aeeee)");
...
FEDORA-2023-6a3c2aeeee advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-6a3c2aeeee");
...
var pkgs = [
    {'reference':'java-1.8.0-openjdk-1.8.0.392.b08-4.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
