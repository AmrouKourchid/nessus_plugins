...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.0 : glibc (EulerOS-SA-2022-2198)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2198
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?61adade6");
...
var pkgs = [
  "glibc-2.28-61.h40.eulerosv2r9",
  "glibc-all-langpacks-2.28-61.h40.eulerosv2r9",
  "glibc-common-2.28-61.h40.eulerosv2r9",
  "glibc-debugutils-2.28-61.h40.eulerosv2r9",
  "glibc-locale-source-2.28-61.h40.eulerosv2r9",
  "libnsl-2.28-61.h40.eulerosv2r9",
  "nscd-2.28-61.h40.eulerosv2r9"
];
