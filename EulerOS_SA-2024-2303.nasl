...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.12.1 : emacs (EulerOS-SA-2024-2303)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2303
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8d3cbb22");
...
var pkgs = [
  "emacs-filesystem-27.2-8.h4.eulerosv2r12"
];
