...
# extracted from Fedora Security Advisory FEDORA-2025-f613fe78b6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-f613fe78b6");

  script_name(english:"Fedora 40 : python3.11 (2025-f613fe78b6)");
...
FEDORA-2025-f613fe78b6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-f613fe78b6");
...
var pkgs = [
    {'reference':'python3.11-3.11.11-5.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
