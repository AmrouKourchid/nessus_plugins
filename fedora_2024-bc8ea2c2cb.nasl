...
# extracted from Fedora Security Advisory FEDORA-2024-bc8ea2c2cb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-bc8ea2c2cb");
  script_xref(name:"IAVA", value:"2024-A-0108-S");

  script_name(english:"Fedora 39 : firefox (2024-bc8ea2c2cb)");
...
FEDORA-2024-bc8ea2c2cb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-bc8ea2c2cb");
...
var pkgs = [
    {'reference':'firefox-123.0-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
