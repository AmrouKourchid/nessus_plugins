...
# extracted from Debian Security Advisory dla-4147. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-4147 : fig2dev - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2025-46397");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2025-46398");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2025-46399");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2025-46400");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bullseye/fig2dev");
...
"Upgrade the fig2dev packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-46400");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'fig2dev', 'reference': '1:3.2.8-3+deb11u3'}
];
