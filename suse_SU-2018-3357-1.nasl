...
# extracted from SUSE update advisory SUSE-SU-2018:3357-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLED15 / SLES15 Security Update : rust (SUSE-SU-2018:3357-1)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6ef74462");
...
patch SUSE-SLE-Module-Development-Tools-15-2018-2403=1");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:N/UI:R/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-1000622");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:suse_linux:rust-std");
...
flag = 0;
if (rpm_check(release:"SLES15", sp:"0", reference:"rust-1.24.1-3.6.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", reference:"rust-debuginfo-1.24.1-3.6.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", reference:"rust-debugsource-1.24.1-3.6.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", reference:"rust-std-1.24.1-3.6.1")) flag++;
if (rpm_check(release:"SLED15", sp:"0", reference:"rust-1.24.1-3.6.1")) flag++;
if (rpm_check(release:"SLED15", sp:"0", reference:"rust-debuginfo-1.24.1-3.6.1")) flag++;
if (rpm_check(release:"SLED15", sp:"0", reference:"rust-debugsource-1.24.1-3.6.1")) flag++;
if (rpm_check(release:"SLED15", sp:"0", reference:"rust-std-1.24.1-3.6.1")) flag++;
