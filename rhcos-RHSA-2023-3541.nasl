...
if (description)
{
  ...
  script_name(english:"RHCOS 4 : OpenShift Container Platform 4.11.43 (RHSA-2023:3541)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat CoreOS host is missing one or more security updates for OpenShift Container Platform 4.11.43.");
...
as referenced in the RHSA-2023:3541 advisory.
...
"Update the RHCOS OpenShift Container Platform 4.11.43 packages based on the guidance in RHSA-2023:3541.");
...
var pkgs = [
    {'reference':'cri-o-1.24.5-5.rhaos4.11.git8bf967b.el8', 'release':'4', 'el_string':'el8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
];
