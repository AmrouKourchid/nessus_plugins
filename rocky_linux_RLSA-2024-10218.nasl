...
# Rocky Linux Security Advisory RLSA-2024:10218.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2024:10218");

  script_name(english:"RockyLinux 9 : perl-App-cpanminus (RLSA-2024:10218)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2024:10218");
...
var pkgs = [
    {'reference':'perl-App-cpanminus-1.7044-14.1.el9_5', 'release':'9', 'el_string':'el9_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'}
];
