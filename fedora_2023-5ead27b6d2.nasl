...
# extracted from Fedora Security Advisory FEDORA-2023-5ead27b6d2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-5ead27b6d2");

  script_name(english:"Fedora 38 : mingw-qt5-qtbase (2023-5ead27b6d2)");
...
FEDORA-2023-5ead27b6d2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-5ead27b6d2");
...
var pkgs = [
    {'reference':'mingw-qt5-qtbase-5.15.10-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
