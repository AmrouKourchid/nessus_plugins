...
# extracted from Fedora Security Advisory FEDORA-2020-6cd410d9e4.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-6cd410d9e4");

  script_name(english:"Fedora 30 : libvpx (2020-6cd410d9e4)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"Update to 1.8.2. Fixes several security vulnerabilities:
CVE-2019-9232, CVE 2019-9433, CVE-2019-9325, CVE-2019-9371,
CVE-2019-2126
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-6cd410d9e4");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"libvpx-1.8.2-1.fc30")) flag++;
