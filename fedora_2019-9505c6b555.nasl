...
# extracted from Fedora Security Advisory FEDORA-2019-9505c6b555.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-9505c6b555");

  script_name(english:"Fedora 30 : expat (2019-9505c6b555)");
...
"This update of `expat` fixes the following security issue :
  ...
  - **CVE-2019-15903** -- Fix heap overflow triggered by
    `XML_GetCurrentLineNumber` (or
    `XML_GetCurrentColumnNumber`), and deny internal
...
The following bug fixes are also included :
  ...
  - xmlwf: Fix exit code for operation without '`-d
    DIRECTORY`' previously, only '`-d DIRECTORY`' would give
    you a proper exit code

Note that Tenable Network Security has extracted the preceding
description block directly from the Fedora update system website.
Tenable has attempted to automatically clean and format it as much as
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-9505c6b555");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"expat-2.2.8-1.fc30")) flag++;
