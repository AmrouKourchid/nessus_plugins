...
if (description)
{
  ...
  script_cve_id("CVE-2021-4148");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2021-4148");
...
patch available.
  ...
  - A vulnerability was found in the Linux kernel's block_invalidatepage in fs/buffer.c in the filesystem. A
    missing sanity check may allow a local attacker with user privilege to cause a denial of service (DOS)
    problem. (CVE-2021-4148)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-4148");
