...
# Red Hat Security Advisory RHSA-2024:0967. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : opensc (CESA-2024:0967)");
...
var pkgs = [
    {'reference':'opensc-0.20.0-8.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'opensc-0.20.0-8.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
