...
# extracted from Ubuntu Security Notice USN-7420-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"7420-1");

  script_name(english:"Ubuntu 22.04 LTS : Linux kernel (Azure) vulnerabilities (USN-7420-1)");
...
the USN-7420-1 advisory.
    ...
    - Networking core; (CVE-2024-35864, CVE-2024-56658, CVE-2024-57798, CVE-2024-42069, CVE-2024-26928)

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7420-1");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-7420-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2024-26928', 'CVE-2024-35864', 'CVE-2024-42069', 'CVE-2024-56658', 'CVE-2024-57798');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-7420-1');
  }
  else
  {
