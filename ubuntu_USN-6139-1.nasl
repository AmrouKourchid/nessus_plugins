...
a vulnerability as referenced in the USN-6139-1 advisory.
    ...
    Yebo Cao discovered that Python incorrectly handled certain URLs. An attacker could use this issue to
    bypass blockinglisting methods. This issue was first addressed in USN-5960-1, but was incomplete. Here we
    address an additional fix to that issue. (CVE-2023-24329)
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'idle-python2.7', 'pkgver': '2.7.12-1ubuntu0~16.04.18+esm5', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'idle-python3.5', 'pkgver': '3.5.2-2ubuntu0~16.04.13+esm8', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libpython2.7', 'pkgver': '2.7.12-1ubuntu0~16.04.18+esm5', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libpython2.7-dev', 'pkgver': '2.7.12-1ubuntu0~16.04.18+esm5', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libpython2.7-minimal', 'pkgver': '2.7.12-1ubuntu0~16.04.18+esm5', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libpython2.7-stdlib', 'pkgver': '2.7.12-1ubuntu0~16.04.18+esm5', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libpython2.7-testsuite', 'pkgver': '2.7.12-1ubuntu0~16.04.18+esm5', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libpython3.5', 'pkgver': '3.5.2-2ubuntu0~16.04.13+esm8', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libpython3.5-dev', 'pkgver': '3.5.2-2ubuntu0~16.04.13+esm8', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libpython3.5-minimal', 'pkgver': '3.5.2-2ubuntu0~16.04.13+esm8', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libpython3.5-stdlib', 'pkgver': '3.5.2-2ubuntu0~16.04.13+esm8', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libpython3.5-testsuite', 'pkgver': '3.5.2-2ubuntu0~16.04.13+esm8', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'python2.7', 'pkgver': '2.7.12-1ubuntu0~16.04.18+esm5', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'python2.7-dev', 'pkgver': '2.7.12-1ubuntu0~16.04.18+esm5', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'python2.7-examples', 'pkgver': '2.7.12-1ubuntu0~16.04.18+esm5', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'python2.7-minimal', 'pkgver': '2.7.12-1ubuntu0~16.04.18+esm5', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'python3.5', 'pkgver': '3.5.2-2ubuntu0~16.04.13+esm8', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'python3.5-dev', 'pkgver': '3.5.2-2ubuntu0~16.04.13+esm8', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'python3.5-examples', 'pkgver': '3.5.2-2ubuntu0~16.04.13+esm8', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'python3.5-minimal', 'pkgver': '3.5.2-2ubuntu0~16.04.13+esm8', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'python3.5-venv', 'pkgver': '3.5.2-2ubuntu0~16.04.13+esm8', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'idle-python2.7', 'pkgver': '2.7.17-1~18.04ubuntu1.13', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'idle-python3.6', 'pkgver': '3.6.9-1~18.04ubuntu1.13', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libpython2.7', 'pkgver': '2.7.17-1~18.04ubuntu1.13', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libpython2.7-dev', 'pkgver': '2.7.17-1~18.04ubuntu1.13', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libpython2.7-minimal', 'pkgver': '2.7.17-1~18.04ubuntu1.13', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libpython2.7-stdlib', 'pkgver': '2.7.17-1~18.04ubuntu1.13', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libpython2.7-testsuite', 'pkgver': '2.7.17-1~18.04ubuntu1.13', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libpython3.6', 'pkgver': '3.6.9-1~18.04ubuntu1.13', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libpython3.6-dev', 'pkgver': '3.6.9-1~18.04ubuntu1.13', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libpython3.6-minimal', 'pkgver': '3.6.9-1~18.04ubuntu1.13', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libpython3.6-stdlib', 'pkgver': '3.6.9-1~18.04ubuntu1.13', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libpython3.6-testsuite', 'pkgver': '3.6.9-1~18.04ubuntu1.13', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'python2.7', 'pkgver': '2.7.17-1~18.04ubuntu1.13', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'python2.7-dev', 'pkgver': '2.7.17-1~18.04ubuntu1.13', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'python2.7-examples', 'pkgver': '2.7.17-1~18.04ubuntu1.13', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'python2.7-minimal', 'pkgver': '2.7.17-1~18.04ubuntu1.13', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'python3.6', 'pkgver': '3.6.9-1~18.04ubuntu1.13', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'python3.6-dev', 'pkgver': '3.6.9-1~18.04ubuntu1.13', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'python3.6-examples', 'pkgver': '3.6.9-1~18.04ubuntu1.13', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'python3.6-minimal', 'pkgver': '3.6.9-1~18.04ubuntu1.13', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'python3.6-venv', 'pkgver': '3.6.9-1~18.04ubuntu1.13', 'ubuntu_pro': TRUE},
    {'osver': '20.04', 'pkgname': 'idle-python3.8', 'pkgver': '3.8.10-0ubuntu1~20.04.8', 'ubuntu_pro': FALSE},
    {'osver': '20.04', 'pkgname': 'libpython3.8', 'pkgver': '3.8.10-0ubuntu1~20.04.8', 'ubuntu_pro': FALSE},
    {'osver': '20.04', 'pkgname': 'libpython3.8-dev', 'pkgver': '3.8.10-0ubuntu1~20.04.8', 'ubuntu_pro': FALSE},
    {'osver': '20.04', 'pkgname': 'libpython3.8-minimal', 'pkgver': '3.8.10-0ubuntu1~20.04.8', 'ubuntu_pro': FALSE},
    {'osver': '20.04', 'pkgname': 'libpython3.8-stdlib', 'pkgver': '3.8.10-0ubuntu1~20.04.8', 'ubuntu_pro': FALSE},
    {'osver': '20.04', 'pkgname': 'libpython3.8-testsuite', 'pkgver': '3.8.10-0ubuntu1~20.04.8', 'ubuntu_pro': FALSE},
    {'osver': '20.04', 'pkgname': 'python3.8', 'pkgver': '3.8.10-0ubuntu1~20.04.8', 'ubuntu_pro': FALSE},
    {'osver': '20.04', 'pkgname': 'python3.8-dev', 'pkgver': '3.8.10-0ubuntu1~20.04.8', 'ubuntu_pro': FALSE},
    {'osver': '20.04', 'pkgname': 'python3.8-examples', 'pkgver': '3.8.10-0ubuntu1~20.04.8', 'ubuntu_pro': FALSE},
    {'osver': '20.04', 'pkgname': 'python3.8-full', 'pkgver': '3.8.10-0ubuntu1~20.04.8', 'ubuntu_pro': FALSE},
    {'osver': '20.04', 'pkgname': 'python3.8-minimal', 'pkgver': '3.8.10-0ubuntu1~20.04.8', 'ubuntu_pro': FALSE},
    {'osver': '20.04', 'pkgname': 'python3.8-venv', 'pkgver': '3.8.10-0ubuntu1~20.04.8', 'ubuntu_pro': FALSE},
    {'osver': '22.04', 'pkgname': 'idle-python3.10', 'pkgver': '3.10.6-1~22.04.2ubuntu1.1', 'ubuntu_pro': FALSE},
    {'osver': '22.04', 'pkgname': 'libpython3.10', 'pkgver': '3.10.6-1~22.04.2ubuntu1.1', 'ubuntu_pro': FALSE},
    {'osver': '22.04', 'pkgname': 'libpython3.10-dev', 'pkgver': '3.10.6-1~22.04.2ubuntu1.1', 'ubuntu_pro': FALSE},
    {'osver': '22.04', 'pkgname': 'libpython3.10-minimal', 'pkgver': '3.10.6-1~22.04.2ubuntu1.1', 'ubuntu_pro': FALSE},
    {'osver': '22.04', 'pkgname': 'libpython3.10-stdlib', 'pkgver': '3.10.6-1~22.04.2ubuntu1.1', 'ubuntu_pro': FALSE},
    {'osver': '22.04', 'pkgname': 'libpython3.10-testsuite', 'pkgver': '3.10.6-1~22.04.2ubuntu1.1', 'ubuntu_pro': FALSE},
    {'osver': '22.04', 'pkgname': 'python3.10', 'pkgver': '3.10.6-1~22.04.2ubuntu1.1', 'ubuntu_pro': FALSE},
    {'osver': '22.04', 'pkgname': 'python3.10-dev', 'pkgver': '3.10.6-1~22.04.2ubuntu1.1', 'ubuntu_pro': FALSE},
    {'osver': '22.04', 'pkgname': 'python3.10-examples', 'pkgver': '3.10.6-1~22.04.2ubuntu1.1', 'ubuntu_pro': FALSE},
    {'osver': '22.04', 'pkgname': 'python3.10-full', 'pkgver': '3.10.6-1~22.04.2ubuntu1.1', 'ubuntu_pro': FALSE},
    {'osver': '22.04', 'pkgname': 'python3.10-minimal', 'pkgver': '3.10.6-1~22.04.2ubuntu1.1', 'ubuntu_pro': FALSE},
    {'osver': '22.04', 'pkgname': 'python3.10-nopie', 'pkgver': '3.10.6-1~22.04.2ubuntu1.1', 'ubuntu_pro': FALSE},
    {'osver': '22.04', 'pkgname': 'python3.10-venv', 'pkgver': '3.10.6-1~22.04.2ubuntu1.1', 'ubuntu_pro': FALSE},
    {'osver': '23.04', 'pkgname': 'idle-python3.11', 'pkgver': '3.11.2-6ubuntu0.1', 'ubuntu_pro': FALSE},
    {'osver': '23.04', 'pkgname': 'libpython3.11', 'pkgver': '3.11.2-6ubuntu0.1', 'ubuntu_pro': FALSE},
    {'osver': '23.04', 'pkgname': 'libpython3.11-dev', 'pkgver': '3.11.2-6ubuntu0.1', 'ubuntu_pro': FALSE},
    {'osver': '23.04', 'pkgname': 'libpython3.11-minimal', 'pkgver': '3.11.2-6ubuntu0.1', 'ubuntu_pro': FALSE},
    {'osver': '23.04', 'pkgname': 'libpython3.11-stdlib', 'pkgver': '3.11.2-6ubuntu0.1', 'ubuntu_pro': FALSE},
    {'osver': '23.04', 'pkgname': 'libpython3.11-testsuite', 'pkgver': '3.11.2-6ubuntu0.1', 'ubuntu_pro': FALSE},
    {'osver': '23.04', 'pkgname': 'python3.11', 'pkgver': '3.11.2-6ubuntu0.1', 'ubuntu_pro': FALSE},
    {'osver': '23.04', 'pkgname': 'python3.11-dev', 'pkgver': '3.11.2-6ubuntu0.1', 'ubuntu_pro': FALSE},
    {'osver': '23.04', 'pkgname': 'python3.11-examples', 'pkgver': '3.11.2-6ubuntu0.1', 'ubuntu_pro': FALSE},
    {'osver': '23.04', 'pkgname': 'python3.11-full', 'pkgver': '3.11.2-6ubuntu0.1', 'ubuntu_pro': FALSE},
    {'osver': '23.04', 'pkgname': 'python3.11-minimal', 'pkgver': '3.11.2-6ubuntu0.1', 'ubuntu_pro': FALSE},
    {'osver': '23.04', 'pkgname': 'python3.11-nopie', 'pkgver': '3.11.2-6ubuntu0.1', 'ubuntu_pro': FALSE},
    {'osver': '23.04', 'pkgname': 'python3.11-venv', 'pkgver': '3.11.2-6ubuntu0.1', 'ubuntu_pro': FALSE}
];
