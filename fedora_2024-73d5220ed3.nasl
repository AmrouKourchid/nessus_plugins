...
# extracted from Fedora Security Advisory FEDORA-2024-73d5220ed3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-73d5220ed3");

  script_name(english:"Fedora 39 : zbar (2024-73d5220ed3)");
...
FEDORA-2024-73d5220ed3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-73d5220ed3");
  script_set_attribute(attribute:"solution", value:
"Update the affected zbar package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:zbar");
...
var pkgs = [
    {'reference':'zbar-0.23.93-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'zbar');
}
