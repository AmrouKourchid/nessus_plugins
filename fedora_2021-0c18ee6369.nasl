...
# extracted from Fedora Security Advisory FEDORA-2021-0c18ee6369
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-0c18ee6369");

  script_name(english:"Fedora 33 : jasper (2021-0c18ee6369)");
...
FEDORA-2021-0c18ee6369 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-0c18ee6369");
...
pkgs = [
    {'reference':'jasper-2.0.25-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
