...
# extracted from Fedora Security Advisory FEDORA-2018-a54e46032f.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-a54e46032f");

  script_name(english:"Fedora 29 : 32:bind (2018-a54e46032f)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-a54e46032f");
  script_set_attribute(attribute:"solution", value:
"Update the affected 32:bind package.");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"bind-9.11.4-10.P2.fc29", epoch:"32")) flag++;
