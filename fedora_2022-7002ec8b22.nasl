...
# extracted from Fedora Security Advisory FEDORA-2022-7002ec8b22
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-7002ec8b22");

  script_name(english:"Fedora 37 : rust-capnp / rust-sequoia-octopus-librnp (2022-7002ec8b22)");
...
FEDORA-2022-7002ec8b22 advisory.

    Update the capnp crate to version 0.14.11 to address CVE-2022-46149 / RUSTSEC-2022-0068. This update also
    includes a rebuild of the only affected application (the Sequoia PGP plugin for Thunderbird).

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-7002ec8b22");
...
var pkgs = [
    {'reference':'rust-capnp-0.14.11-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-sequoia-octopus-librnp-1.4.1-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
