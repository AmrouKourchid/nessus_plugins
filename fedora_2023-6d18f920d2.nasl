...
# extracted from Fedora Security Advisory FEDORA-2023-6d18f920d2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-6d18f920d2");

  script_name(english:"Fedora 37 : opusfile (2023-6d18f920d2)");
...
FEDORA-2023-6d18f920d2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-6d18f920d2");
...
var pkgs = [
    {'reference':'opusfile-0.12-9.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
