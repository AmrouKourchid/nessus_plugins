...
# extracted from Red Hat Security Advisory RHSA-2025:1330. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:1330");
  script_xref(name:"IAVA", value:"2025-A-0127");

  script_name(english:"RHEL 9 : openssl (RHSA-2025:1330)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_1330.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d461abf1");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:1330");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL openssl package based on the guidance in RHSA-2025:1330.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openssl-3.2.2-6.el9_5.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'openssl-devel-3.2.2-6.el9_5.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'openssl-libs-3.2.2-6.el9_5.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'openssl-perl-3.2.2-6.el9_5.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
