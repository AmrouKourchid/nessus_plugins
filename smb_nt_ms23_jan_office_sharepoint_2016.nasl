...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5002338");
  script_xref(name:"MSFT", value:"MS23-5002338");
  script_xref(name:"IAVA", value:"2023-A-0022-S");

  script_name(english:"Security Updates for Microsoft SharePoint Server 2016 (January 2023)");
...
"The Microsoft SharePoint Server 2016 installation on the
  ...
  affected by multiple vulnerabilities:
    ...
    - A remote code execution vulnerability. An attacker can
      ...
      CVE-2023-21744)");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002338");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released KB5002338 to address this issue.");
