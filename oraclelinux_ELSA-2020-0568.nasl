...
# Oracle Linux Security Advisory ELSA-2020-0568 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : ksh (ELSA-2020-0568)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2020-0568.html");
...
var pkgs = [
    {'reference':'ksh-20120801-140.0.1.el7_7', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ksh-20120801-140.0.1.el7_7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
];
