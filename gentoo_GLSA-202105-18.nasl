...
# extracted from Gentoo Linux Security Advisory GLSA 202105-18.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202105-18");

  script_name(english:"GLSA-202105-18 : LittleCMS: User-assisted execution of arbitrary code");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202105-18
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202105-18"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"media-libs/lcms", unaffected:make_list("ge 2.10"), vulnerable:make_list("lt 2.10"))) flag++;
