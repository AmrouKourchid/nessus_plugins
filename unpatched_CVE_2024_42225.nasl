...
if (description)
{
  ...
  script_cve_id("CVE-2024-42225");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-42225");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: wifi: mt76: replace skb_put with
    skb_put_zero Avoid potentially reusing uninitialized data (CVE-2024-42225)
