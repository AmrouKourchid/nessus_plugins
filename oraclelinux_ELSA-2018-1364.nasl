...
# Oracle Linux Security Advisory ELSA-2018-1364 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : 389-ds-base (ELSA-2018-1364)");
...
ELSA-2018-1364 advisory.

    [1.2.11.15-95]
    - Bump version to 1.2.11-15-95
    - Resolves: Bug 1562152 - EMBARGOED CVE-2018-1089 389-ds-base: ns-slapd crash via large filter value in
    ldapsearch
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2018-1364.html");
