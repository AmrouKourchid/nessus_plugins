...
# extracted from Fedora Security Advisory FEDORA-2025-48305c69ad
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-48305c69ad");
  script_xref(name:"IAVA", value:"2025-A-0278");

  script_name(english:"Fedora 40 : vim (2025-48305c69ad)");
...
FEDORA-2025-48305c69ad advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-48305c69ad");
...
var pkgs = [
    {'reference':'vim-9.1.1202-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
