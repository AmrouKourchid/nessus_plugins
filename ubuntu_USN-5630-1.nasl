...
# extracted from Ubuntu Security Notice USN-5630-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5630-1");

  script_name(english:"Ubuntu 18.04 LTS : Linux kernel (Raspberry Pi) vulnerabilities (USN-5630-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5630-1");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-5630-1');
}
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-5630-1');
  }
  else
  {
