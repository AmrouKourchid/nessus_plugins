...
referenced in the RHSA-2017:2004 advisory.
    ...
    * It was found that the git-prompt.sh script shipped with git failed to correctly handle branch names
    containing special characters. A specially crafted git repository could use this flaw to execute arbitrary
    commands if a user working with the repository configured their shell to include repository information in
    the prompt. (CVE-2014-9938)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2017/rhsa-2017_2004.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?372ac0e1");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2017:2004");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1369173");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1434415");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1450407");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL git package based on the guidance in RHSA-2017:2004.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'emacs-git-1.8.3.1-11.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'emacs-git-el-1.8.3.1-11.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-1.8.3.1-11.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-all-1.8.3.1-11.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-bzr-1.8.3.1-11.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-cvs-1.8.3.1-11.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-daemon-1.8.3.1-11.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-email-1.8.3.1-11.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-gui-1.8.3.1-11.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-hg-1.8.3.1-11.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-p4-1.8.3.1-11.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-svn-1.8.3.1-11.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gitk-1.8.3.1-11.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gitweb-1.8.3.1-11.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'perl-Git-1.8.3.1-11.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'perl-Git-SVN-1.8.3.1-11.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
