...
which may result in privilege escalation.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K01512680");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K01512680.");
...
var vmatrix = {
  'AFM': {
    'affected': [
      '16.1.0','16.0.0-16.0.1','15.0.0-15.1.3','14.0.0-14.1.4','13.1.0-13.1.3'
    ],
    'unaffected': [
      '17.0.0','16.1.1','16.0.1.2','15.1.4','14.1.4.3'
    ],
  },
  'AM': {
    'affected': [
