...
# extracted from Fedora Security Advisory FEDORA-2020-2407cb0512.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : libproxy (2020-2407cb0512)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-2407cb0512");
...
flag = 0;
if (rpm_check(release:"FC32", reference:"libproxy-0.4.15-18.fc32")) flag++;
