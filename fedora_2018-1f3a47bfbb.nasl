...
# extracted from Fedora Security Advisory FEDORA-2018-1f3a47bfbb.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : sos-collector (2018-1f3a47bfbb)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-1f3a47bfbb");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"sos-collector-1.5-3.fc28")) flag++;
