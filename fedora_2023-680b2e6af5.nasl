...
# extracted from Fedora Security Advisory FEDORA-2023-680b2e6af5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-680b2e6af5");

  script_name(english:"Fedora 38 : pdns-recursor (2023-680b2e6af5)");
...
FEDORA-2023-680b2e6af5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-680b2e6af5");
...
"Update the affected pdns-recursor package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-26437");
...
var pkgs = [
    {'reference':'pdns-recursor-4.8.4-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
