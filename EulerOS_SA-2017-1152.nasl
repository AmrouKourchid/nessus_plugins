...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP1 : graphite2 (EulerOS-SA-2017-1152)");
...
vulnerabilities :
  ...
  - Various vulnerabilities have been discovered in
    ...
    to disclose potentially sensitive memory, cause an
    application crash, or, possibly, execute arbitrary
    code. (CVE-2017-7771, CVE-2017-7772, CVE-2017-7773,
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2017-1152
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?260f3a90");
