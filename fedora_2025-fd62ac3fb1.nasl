...
# extracted from Fedora Security Advisory FEDORA-2025-fd62ac3fb1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-fd62ac3fb1");

  script_name(english:"Fedora 41 : mingw-libxslt (2025-fd62ac3fb1)");
...
FEDORA-2025-fd62ac3fb1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-fd62ac3fb1");
  script_set_attribute(attribute:"solution", value:
"Update the affected mingw-libxslt package.");
...
var pkgs = [
    {'reference':'mingw-libxslt-1.1.43-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
