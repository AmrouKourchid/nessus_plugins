...
# extracted from Fedora Security Advisory FEDORA-2025-d191ee2f9a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-d191ee2f9a");

  script_name(english:"Fedora 41 : valkey (2025-d191ee2f9a)");
...
FEDORA-2025-d191ee2f9a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-d191ee2f9a");
...
var pkgs = [
    {'reference':'valkey-8.0.3-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
