...
# extracted from Red Hat Security Advisory RHSA-2022:0162 and
# CentOS Errata and Security Advisory 2022:0162 respectively.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : gegl (RHSA-2022:0162)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 7 host has packages installed that are affected by a vulnerability as referenced in the
RHSA-2022:0162 advisory.
...
var pkgs = [
    {'reference':'gegl-0.2.0-19.el7', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'gegl-0.2.0-19.el7', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'gegl-devel-0.2.0-19.el7', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'gegl-devel-0.2.0-19.el7', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE}
];
