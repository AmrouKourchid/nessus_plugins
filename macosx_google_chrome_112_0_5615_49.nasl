...
"The version of Google Chrome installed on the remote macOS host is prior to 112.0.5615.49. It is, therefore, affected by
multiple vulnerabilities as referenced in the 2023_04_stable-channel-update-for-desktop advisory.
...
google_chrome_check_version(fix:'112.0.5615.49', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
