...
# extracted from Debian Security Advisory DLA-2618-3. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2618-3 : smarty3 regression update");
  ...
  script_set_attribute(
    ...
    value:
"The security update of smarty3, the compiling PHP template engine,
issued as DLA 2618-1 introduced a regression in the smarty_security
class when secure directories are evaluated. Updated smarty3 packages
...
For the detailed security status of smarty3 please refer to its
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2021/10/msg00015.html"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-13982");
...
flag = 0;
if (deb_check(release:"9.0", prefix:"smarty3", reference:"3.1.31+20161214.1.c7d42e4+selfpack1-2+deb9u4")) flag++;
