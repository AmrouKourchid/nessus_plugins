...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS : LZ4 vulnerability (USN-4968-1)");
...
in the USN-4968-1 advisory.

    It was discovered that LZ4 incorrectly handled certain memory operations. If a user or automated system
    were tricked into uncompressing a specially- crafted LZ4 file, a remote attacker could use this issue to
    cause LZ4 to crash, resulting in a denial of service, or possibly execute arbitrary code.
