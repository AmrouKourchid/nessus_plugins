...
# extracted from Ubuntu Security Notice USN-6237-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6237-2");

  script_name(english:"Ubuntu 22.04 LTS : curl regression (USN-6237-2)");
...
USN-6237-2 advisory.
    ...
    USN-6237-1 fixed vulnerabilities in curl. The update caused a certificate wildcard handling regression on
    Ubuntu 22.04 LTS. This update fixes the problem.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6237-2");
...
var pkgs = [
    {'osver': '22.04', 'pkgname': 'curl', 'pkgver': '7.81.0-1ubuntu1.13'},
    {'osver': '22.04', 'pkgname': 'libcurl3-gnutls', 'pkgver': '7.81.0-1ubuntu1.13'},
    {'osver': '22.04', 'pkgname': 'libcurl3-nss', 'pkgver': '7.81.0-1ubuntu1.13'},
    {'osver': '22.04', 'pkgname': 'libcurl4', 'pkgver': '7.81.0-1ubuntu1.13'},
    {'osver': '22.04', 'pkgname': 'libcurl4-gnutls-dev', 'pkgver': '7.81.0-1ubuntu1.13'},
    {'osver': '22.04', 'pkgname': 'libcurl4-nss-dev', 'pkgver': '7.81.0-1ubuntu1.13'},
    {'osver': '22.04', 'pkgname': 'libcurl4-openssl-dev', 'pkgver': '7.81.0-1ubuntu1.13'}
];
