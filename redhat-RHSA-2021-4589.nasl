...
# extracted from Red Hat Security Advisory RHSA-2021:4589. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:4589");

  script_name(english:"RHEL 8 : gcc-toolset-10-annobin (RHSA-2021:4589)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for gcc-toolset-10-annobin.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_4589.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3b1fc4f1");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:4589");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2005819");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL gcc-toolset-10-annobin package based on the guidance in RHSA-2021:4589.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:gcc-toolset-10-annobin");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gcc-toolset-10-annobin-9.29-1.el8_4.1', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
