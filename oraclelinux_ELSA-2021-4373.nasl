...
# extracted from Oracle Linux Security Advisory ELSA-2021-4373.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : pcre (ELSA-2021-4373)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ELSA-2021-4373 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2021-4373.html");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:pcre-cpp");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:pcre-utf16");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:pcre-utf32");
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'pcre / pcre-cpp / pcre-devel / etc');
}
