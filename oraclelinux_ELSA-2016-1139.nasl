...
# Oracle Linux Security Advisory ELSA-2016-1139 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : squid (ELSA-2016-1139)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 7 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ELSA-2016-1139 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2016-1139.html");
  script_set_attribute(attribute:"solution", value:
"Update the affected squid and / or squid-sysvinit packages.");
...
var pkgs = [
    {'reference':'squid-3.3.8-26.el7_2.3', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
    {'reference':'squid-sysvinit-3.3.8-26.el7_2.3', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
];
