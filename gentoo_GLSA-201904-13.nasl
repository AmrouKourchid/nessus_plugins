...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/201904-13");
...
if (qpkg_check(package:"dev-vcs/git", unaffected:make_list("ge 2.20.1"), vulnerable:make_list("lt 2.20.1"))) flag++;
