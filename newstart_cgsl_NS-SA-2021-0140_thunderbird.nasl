...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.05 / MAIN 5.05 : thunderbird Multiple Vulnerabilities (NS-SA-2021-0140)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/info/CVE-2020-12398");
  ...
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/info/CVE-2020-15646");
...
ZTE for more information.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_core:thunderbird-debuginfo");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:thunderbird");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:thunderbird-debuginfo");
...
var pkgs = {
  'CGSL CORE 5.05': [
    ...
    'thunderbird-debuginfo-68.11.0-1.el7.centos'
  ],
  'CGSL MAIN 5.05': [
    'thunderbird-68.11.0-1.el7.centos',
    'thunderbird-debuginfo-68.11.0-1.el7.centos'
