...
if (description)
{
  ...
  script_cve_id("CVE-2024-35261");

  script_name(english:"Microsoft Azure Network Watcher VM Extension < 1.4.3320.1 Elevation of Privilege (CVE-2024-35261)");
...
"The version of Microsoft Azure Network Watcher VM Extension installed on the remote Windows host is prior to 1.4.3320.1. It is, therefore,
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?aff56dd0");
...
"Upgrade to Microsoft Azure Network Watcher version 1.4.3320.1 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-35261");
