...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Libtiff PHSA-2020-2.0-0227");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libtiff-4.1.0-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libtiff-debuginfo-4.1.0-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libtiff-devel-4.1.0-1.ph2')) flag++;
