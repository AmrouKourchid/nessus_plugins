...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Systemd PHSA-2017-0023");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'systemd-228-35.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'systemd-debuginfo-228-35.ph1')) flag++;
