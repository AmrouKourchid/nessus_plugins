...
# extracted from F5 Networks BIG-IP Solution K58003591.
#
# @NOAGENT@
##
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : Apache HTTP server vulnerability (K58003591)");
...
affected by a vulnerability as referenced in the K58003591 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K58003591");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K58003591.");
