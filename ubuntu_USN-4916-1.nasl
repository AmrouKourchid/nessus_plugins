...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.4.0-209-powerpc-e500mc");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.4.0-209-powerpc-smp");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.4.0-209-powerpc64-emb");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.4.0-209-powerpc64-smp");
...
var kernel_mappings = {
  '16.04': {
    '4.15.0': {
      'generic': '4.15.0-142',
      'generic-lpae': '4.15.0-142',
      'lowlatency': '4.15.0-142',
      'oracle': '4.15.0-1070',
      'gcp': '4.15.0-1098',
      'aws': '4.15.0-1099',
      'azure': '4.15.0-1113'
    ...
    '4.4.0': {
      'generic': '4.4.0-209',
      'generic-lpae': '4.4.0-209',
      'lowlatency': '4.4.0-209',
      'powerpc-e500mc': '4.4.0-209',
      'powerpc-smp': '4.4.0-209',
      'powerpc64-emb': '4.4.0-209',
      'powerpc64-smp': '4.4.0-209',
      'kvm': '4.4.0-1092',
      'aws': '4.4.0-1127',
      'raspi2': '4.4.0-1151',
      'snapdragon': '4.4.0-1155'
    }
  },
  '18.04': {
    '4.15.0': {
      ...
      'generic-lpae': '4.15.0-142',
      'lowlatency': '4.15.0-142',
      'dell300x': '4.15.0-1017',
      'oracle': '4.15.0-1070',
      'raspi2': '4.15.0-1084',
      'kvm': '4.15.0-1090',
      'gcp': '4.15.0-1098',
      'aws': '4.15.0-1099',
      'snapdragon': '4.15.0-1101',
      'azure': '4.15.0-1113'
    }
  }
};
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-4916-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2021-3493', 'CVE-2021-29154');
