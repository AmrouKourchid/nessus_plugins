...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Libxslt PHSA-2019-3.0-0010");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libxslt-1.1.32-2.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libxslt-debuginfo-1.1.32-2.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libxslt-devel-1.1.32-2.ph3')) flag++;
