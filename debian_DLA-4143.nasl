...
# extracted from Debian Security Advisory dla-4143. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-4143 : glibc-doc - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has packages installed that are affected by a vulnerability as referenced in the dla-4143
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2025-0395");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'glibc-doc', 'reference': '2.31-13+deb11u12'},
    {'release': '11.0', 'prefix': 'glibc-source', 'reference': '2.31-13+deb11u12'},
    {'release': '11.0', 'prefix': 'libc-bin', 'reference': '2.31-13+deb11u12'},
    {'release': '11.0', 'prefix': 'libc-dev-bin', 'reference': '2.31-13+deb11u12'},
    {'release': '11.0', 'prefix': 'libc-devtools', 'reference': '2.31-13+deb11u12'},
    {'release': '11.0', 'prefix': 'libc-l10n', 'reference': '2.31-13+deb11u12'},
    {'release': '11.0', 'prefix': 'libc6', 'reference': '2.31-13+deb11u12'},
    {'release': '11.0', 'prefix': 'libc6-amd64', 'reference': '2.31-13+deb11u12'},
    {'release': '11.0', 'prefix': 'libc6-dbg', 'reference': '2.31-13+deb11u12'},
    {'release': '11.0', 'prefix': 'libc6-dev', 'reference': '2.31-13+deb11u12'},
    {'release': '11.0', 'prefix': 'libc6-dev-amd64', 'reference': '2.31-13+deb11u12'},
    {'release': '11.0', 'prefix': 'libc6-dev-i386', 'reference': '2.31-13+deb11u12'},
    {'release': '11.0', 'prefix': 'libc6-dev-x32', 'reference': '2.31-13+deb11u12'},
    {'release': '11.0', 'prefix': 'libc6-i386', 'reference': '2.31-13+deb11u12'},
    {'release': '11.0', 'prefix': 'libc6-udeb', 'reference': '2.31-13+deb11u12'},
    {'release': '11.0', 'prefix': 'libc6-x32', 'reference': '2.31-13+deb11u12'},
    {'release': '11.0', 'prefix': 'libc6-xen', 'reference': '2.31-13+deb11u12'},
    {'release': '11.0', 'prefix': 'locales', 'reference': '2.31-13+deb11u12'},
    {'release': '11.0', 'prefix': 'locales-all', 'reference': '2.31-13+deb11u12'},
    {'release': '11.0', 'prefix': 'nscd', 'reference': '2.31-13+deb11u12'}
];
