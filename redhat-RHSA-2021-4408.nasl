...
# extracted from Red Hat Security Advisory RHSA-2021:4408. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:4408");

  script_name(english:"RHEL 8 : libsolv (RHSA-2021:4408)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for libsolv.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2021:4408 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_4408.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e9106e2e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:4408");
...
"Update the RHEL libsolv package based on the guidance in RHSA-2021:4408.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libsolv-0.7.19-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsolv-devel-0.7.19-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsolv-tools-0.7.19-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-solv-0.7.19-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
