...
# extracted from Red Hat Security Advisory RHSA-2023:3839. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:3839");
  script_xref(name:"IAVA", value:"2023-A-0517-S");

  script_name(english:"RHEL 8 : libssh (RHSA-2023:3839)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for libssh.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2023:3839 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_3839.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6b2157e6");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:3839");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libssh package based on the guidance in RHSA-2023:3839.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libssh-0.9.6-10.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libssh-config-0.9.6-10.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libssh-devel-0.9.6-10.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'libssh-0.9.6-10.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libssh-config-0.9.6-10.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libssh-devel-0.9.6-10.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
