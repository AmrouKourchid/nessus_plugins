...
# extracted from Red Hat Security Advisory RHSA-2024:3203. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:3203");

  script_name(english:"RHEL 8 : systemd (RHSA-2024:3203)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for systemd.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:3203 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_3203.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b449b859");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2222672");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-18302");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-22426");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-2857");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-5863");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-5991");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:3203");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL systemd package based on the guidance in RHSA-2024:3203.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'systemd-239-82.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-container-239-82.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-devel-239-82.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-journal-remote-239-82.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-libs-239-82.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-pam-239-82.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-tests-239-82.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-udev-239-82.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
