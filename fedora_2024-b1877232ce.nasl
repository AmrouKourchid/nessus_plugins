...
# extracted from Fedora Security Advisory FEDORA-2024-b1877232ce
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-b1877232ce");
  script_xref(name:"IAVB", value:"2024-B-0170-S");

  script_name(english:"Fedora 40 : ghostscript (2024-b1877232ce)");
...
FEDORA-2024-b1877232ce advisory.

    CVE-2024-46951 ghostscript: Arbitrary Code Execution in Artifex Ghostscript Pattern Color Space
    (fedora#2325237)

    2325240 - CVE-2024-46952 CVE-2024-46953 CVE-2024-46954 CVE-2024-46955 CVE-2024-46956 ghostscript: various
    flaws
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-b1877232ce");
...
var pkgs = [
    {'reference':'ghostscript-10.02.1-13.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
