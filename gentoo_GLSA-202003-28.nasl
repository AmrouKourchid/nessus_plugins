...
# extracted from Gentoo Linux Security Advisory GLSA 202003-28.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2019-18408", "CVE-2020-9308");
  script_xref(name:"GLSA", value:"202003-28");

  script_name(english:"GLSA-202003-28 : libarchive: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202003-28
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202003-28");
...
if (qpkg_check(package:"app-arch/libarchive", unaffected:make_list("ge 3.4.2"), vulnerable:make_list("lt 3.4.2"))) flag++;
