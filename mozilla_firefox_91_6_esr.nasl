...
"The version of Firefox ESR installed on the remote Windows host is prior to 91.6. It is, therefore, affected by multiple
vulnerabilities as referenced in the mfsa2022-05 advisory.
...
mozilla_check_version(installs:installs, product:'firefox', esr:TRUE, fix:'91.6', min:'91.0.0', severity:SECURITY_HOLE);
