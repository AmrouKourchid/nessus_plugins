...
# extracted from Red Hat Security Advisory RHSA-2022:5257. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:5257");

  script_name(english:"RHEL 9 : libinput (RHSA-2022:5257)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_5257.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7cbaeba4");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:5257");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2074952");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libinput package based on the guidance in RHSA-2022:5257.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libinput-1.19.3-2.el9_0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libinput-devel-1.19.3-2.el9_0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libinput-utils-1.19.3-2.el9_0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'libinput-1.19.3-2.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libinput-devel-1.19.3-2.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libinput-utils-1.19.3-2.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
