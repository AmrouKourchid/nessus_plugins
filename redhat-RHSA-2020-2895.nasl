...
# extracted from Red Hat Security Advisory RHSA-2020:2895. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:2895");
  script_xref(name:"CEA-ID", value:"CEA-2021-0004");

  script_name(english:"RHEL 7 : rh-nodejs12-nodejs (RHSA-2020:2895)");
...
referenced in the RHSA-2020:2895 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_2895.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?edeea500");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:2895");
...
"Update the RHEL rh-nodejs12-nodejs package based on the guidance in RHSA-2020:2895.");
  ...
  script_cwe_id(20, 119, 190, 285, 770);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-nodejs12-nodejs-12.18.2-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs12-nodejs-devel-12.18.2-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs12-nodejs-docs-12.18.2-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs12-npm-6.14.5-12.18.2.1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
