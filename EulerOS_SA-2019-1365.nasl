...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.3 : sqlite (EulerOS-SA-2019-1365)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1365
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9172b964");
...
pkgs = ["sqlite-3.7.17-8.h2",
        "sqlite-devel-3.7.17-8.h2"];
