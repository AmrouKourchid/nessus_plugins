...
# extracted from Ubuntu Security Notice USN-6494-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6494-1");

  script_name(english:"Ubuntu 16.04 ESM / 18.04 ESM : Linux kernel vulnerabilities (USN-6494-1)");
...
referenced in the USN-6494-1 advisory.
    ...
    It was discovered that the USB ENE card reader driver in the Linux kernel did not properly allocate enough
    memory when processing the storage device boot blocks. A local attacker could use this to cause a denial
    of service (system crash). (CVE-2023-45862)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6494-1");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.15.0-1126-oracle");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.15.0-1147-kvm");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.15.0-1163-aws");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.15.0-220-generic");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.15.0-220-lowlatency");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-6494-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2023-5717', 'CVE-2023-31085', 'CVE-2023-39189', 'CVE-2023-39192', 'CVE-2023-39193', 'CVE-2023-39194', 'CVE-2023-42754', 'CVE-2023-45862', 'CVE-2023-45871');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-6494-1');
  }
  else
  {
