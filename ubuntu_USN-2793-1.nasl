...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : LibreOffice vulnerabilities (USN-2793-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 14.04 LTS host has packages installed that are affected by multiple vulnerabilities as referenced in
the USN-2793-1 advisory.

    Federico Scrinzi discovered that LibreOffice incorrectly handled documents inserted into Writer or Calc
    via links. If a user were tricked into opening a specially crafted document, a remote attacker could
    possibly obtain the contents of arbitrary files. (CVE-2015-4551)

    It was discovered that LibreOffice incorrectly handled PrinterSetup data stored in ODF files. If a user
    were tricked into opening a specially crafted ODF document, a remote attacker could cause LibreOffice to
    crash, and possibly execute arbitrary code. (CVE-2015-5212)

    It was discovered that LibreOffice incorrectly handled the number of pieces in DOC files. If a user were
    tricked into opening a specially crafted DOC document, a remote attacker could cause LibreOffice to crash,
    and possibly execute arbitrary code. (CVE-2015-5213)

    It was discovered that LibreOffice incorrectly handled bookmarks in DOC files. If a user were tricked into
    opening a specially crafted DOC document, a remote attacker could cause LibreOffice to crash, and possibly
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2793-1");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2015-5212");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'browser-plugin-libreoffice', 'pkgver': '1:4.2.8-0ubuntu3'},
    {'osver': '14.04', 'pkgname': 'fonts-opensymbol', 'pkgver': '2:102.6+LibO4.2.8-0ubuntu3'},
    {'osver': '14.04', 'pkgname': 'libreoffice', 'pkgver': '1:4.2.8-0ubuntu3'},
    {'osver': '14.04', 'pkgname': 'libreoffice-avmedia-backend-gstreamer', 'pkgver': '1:4.2.8-0ubuntu3'},
    {'osver': '14.04', 'pkgname': 'libreoffice-base', 'pkgver': '1:4.2.8-0ubuntu3'},
    {'osver': '14.04', 'pkgname': 'libreoffice-base-core', 'pkgver': '1:4.2.8-0ubuntu3'},
    {'osver': '14.04', 'pkgname': 'libreoffice-base-drivers', 'pkgver': '1:4.2.8-0ubuntu3'},
    {'osver': '14.04', 'pkgname': 'libreoffice-calc', 'pkgver': '1:4.2.8-0ubuntu3'},
    {'osver': '14.04', 'pkgname': 'libreoffice-common', 'pkgver': '1:4.2.8-0ubuntu3'},
    {'osver': '14.04', 'pkgname': 'libreoffice-core', 'pkgver': '1:4.2.8-0ubuntu3'},
    {'osver': '14.04', 'pkgname': 'libreoffice-dev', 'pkgver': '1:4.2.8-0ubuntu3'},
    {'osver': '14.04', 'pkgname': 'libreoffice-draw', 'pkgver': '1:4.2.8-0ubuntu3'},
    {'osver': '14.04', 'pkgname': 'libreoffice-emailmerge', 'pkgver': '1:4.2.8-0ubuntu3'},
    {'osver': '14.04', 'pkgname': 'libreoffice-gnome', 'pkgver': '1:4.2.8-0ubuntu3'},
    {'osver': '14.04', 'pkgname': 'libreoffice-gtk', 'pkgver': '1:4.2.8-0ubuntu3'},
    {'osver': '14.04', 'pkgname': 'libreoffice-gtk3', 'pkgver': '1:4.2.8-0ubuntu3'},
    {'osver': '14.04', 'pkgname': 'libreoffice-impress', 'pkgver': '1:4.2.8-0ubuntu3'},
    {'osver': '14.04', 'pkgname': 'libreoffice-java-common', 'pkgver': '1:4.2.8-0ubuntu3'},
    {'osver': '14.04', 'pkgname': 'libreoffice-kde', 'pkgver': '1:4.2.8-0ubuntu3'},
    {'osver': '14.04', 'pkgname': 'libreoffice-l10n-in', 'pkgver': '1:4.2.8-0ubuntu3'},
    {'osver': '14.04', 'pkgname': 'libreoffice-l10n-ku', 'pkgver': '1:4.2.8-0ubuntu3'},
    {'osver': '14.04', 'pkgname': 'libreoffice-l10n-za', 'pkgver': '1:4.2.8-0ubuntu3'},
    {'osver': '14.04', 'pkgname': 'libreoffice-librelogo', 'pkgver': '1:4.2.8-0ubuntu3'},
    {'osver': '14.04', 'pkgname': 'libreoffice-math', 'pkgver': '1:4.2.8-0ubuntu3'},
    {'osver': '14.04', 'pkgname': 'libreoffice-mysql-connector', 'pkgver': '1.0.2+LibO4.2.8-0ubuntu3'},
    {'osver': '14.04', 'pkgname': 'libreoffice-officebean', 'pkgver': '1:4.2.8-0ubuntu3'},
    {'osver': '14.04', 'pkgname': 'libreoffice-ogltrans', 'pkgver': '1:4.2.8-0ubuntu3'},
    {'osver': '14.04', 'pkgname': 'libreoffice-pdfimport', 'pkgver': '1:4.2.8-0ubuntu3'},
    {'osver': '14.04', 'pkgname': 'libreoffice-presentation-minimizer', 'pkgver': '1:4.2.8-0ubuntu3'},
    {'osver': '14.04', 'pkgname': 'libreoffice-presenter-console', 'pkgver': '1:4.2.8-0ubuntu3'},
    {'osver': '14.04', 'pkgname': 'libreoffice-report-builder', 'pkgver': '1:4.2.8-0ubuntu3'},
    {'osver': '14.04', 'pkgname': 'libreoffice-report-builder-bin', 'pkgver': '1:4.2.8-0ubuntu3'},
    {'osver': '14.04', 'pkgname': 'libreoffice-script-provider-bsh', 'pkgver': '1:4.2.8-0ubuntu3'},
    {'osver': '14.04', 'pkgname': 'libreoffice-script-provider-js', 'pkgver': '1:4.2.8-0ubuntu3'},
    {'osver': '14.04', 'pkgname': 'libreoffice-script-provider-python', 'pkgver': '1:4.2.8-0ubuntu3'},
    {'osver': '14.04', 'pkgname': 'libreoffice-sdbc-firebird', 'pkgver': '1:4.2.8-0ubuntu3'},
    {'osver': '14.04', 'pkgname': 'libreoffice-sdbc-hsqldb', 'pkgver': '1:4.2.8-0ubuntu3'},
    {'osver': '14.04', 'pkgname': 'libreoffice-sdbc-postgresql', 'pkgver': '1:4.2.8-0ubuntu3'},
    {'osver': '14.04', 'pkgname': 'libreoffice-style-crystal', 'pkgver': '1:4.2.8-0ubuntu3'},
    {'osver': '14.04', 'pkgname': 'libreoffice-style-galaxy', 'pkgver': '1:4.2.8-0ubuntu3'},
    {'osver': '14.04', 'pkgname': 'libreoffice-style-hicontrast', 'pkgver': '1:4.2.8-0ubuntu3'},
    {'osver': '14.04', 'pkgname': 'libreoffice-style-human', 'pkgver': '1:4.2.8-0ubuntu3'},
    {'osver': '14.04', 'pkgname': 'libreoffice-style-oxygen', 'pkgver': '1:4.2.8-0ubuntu3'},
    {'osver': '14.04', 'pkgname': 'libreoffice-style-sifr', 'pkgver': '1:4.2.8-0ubuntu3'},
    {'osver': '14.04', 'pkgname': 'libreoffice-style-tango', 'pkgver': '1:4.2.8-0ubuntu3'},
    {'osver': '14.04', 'pkgname': 'libreoffice-subsequentcheckbase', 'pkgver': '1:4.2.8-0ubuntu3'},
    {'osver': '14.04', 'pkgname': 'libreoffice-wiki-publisher', 'pkgver': '1.1.2+LibO4.2.8-0ubuntu3'},
    {'osver': '14.04', 'pkgname': 'libreoffice-writer', 'pkgver': '1:4.2.8-0ubuntu3'},
    {'osver': '14.04', 'pkgname': 'openoffice.org-dtd-officedocument1.0', 'pkgver': '2:1.0+LibO4.2.8-0ubuntu3'},
    {'osver': '14.04', 'pkgname': 'python3-uno', 'pkgver': '1:4.2.8-0ubuntu3'},
    {'osver': '14.04', 'pkgname': 'uno-libs3', 'pkgver': '4.2.8-0ubuntu3'},
    {'osver': '14.04', 'pkgname': 'ure', 'pkgver': '4.2.8-0ubuntu3'}
];
