...
dla-2960 advisory.
    ...
    Several vulnerabilities have been discovered in the Apache HTTP server, which could result in denial of
    service, request smuggling or buffer overflows. For Debian 9 stretch, these problems have been fixed in
    version 2.4.25-3+deb9u13. We recommend that you upgrade your apache2 packages. For the detailed security
    status of apache2 please refer to its security tracker page at: https://security-
    tracker.debian.org/tracker/apache2 Further information about Debian LTS security advisories, how to apply
