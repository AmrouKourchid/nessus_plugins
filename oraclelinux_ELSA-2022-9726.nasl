...
ELSA-2022-9726 advisory.
    ...
    [5.15.0-1.43.4.2]
    - rds: copy_from_user only once per rds_sendmsg system call (Hans Westgaard Ry)  [Orabug: 33981854]
    {CVE-2022-21385}
...
var pkgs = [
    {'reference':'bpftool-5.15.0-1.43.4.2.el8uek', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'bpftool-5.15.0'},
    ...
    {'reference':'kernel-uek-doc-5.15.0-1.43.4.2.el8uek', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-doc-5.15.0'},
    ...
    {'reference':'bpftool-5.15.0-1.43.4.2.el8uek', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'bpftool-5.15.0'},
    ...
    {'reference':'kernel-uek-doc-5.15.0-1.43.4.2.el8uek', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-doc-5.15.0'},
    ...
    {'reference':'bpftool-5.15.0-1.43.4.2.el9uek', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'bpftool-5.15.0'},
    ...
    {'reference':'kernel-uek-doc-5.15.0-1.43.4.2.el9uek', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-doc-5.15.0'},
    ...
    {'reference':'bpftool-5.15.0-1.43.4.2.el9uek', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'bpftool-5.15.0'},
    ...
    {'reference':'kernel-uek-doc-5.15.0-1.43.4.2.el9uek', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-doc-5.15.0'},
