...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : curl (EulerOS-SA-2020-2456)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2456
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6b49fdf7");
...
pkgs = ["curl-7.29.0-46.h17.eulerosv2r7",
        "libcurl-7.29.0-46.h17.eulerosv2r7",
        "libcurl-devel-7.29.0-46.h17.eulerosv2r7"];
