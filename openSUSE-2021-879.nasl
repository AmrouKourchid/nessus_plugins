...
# openSUSE Security Update openSUSE-SU-2021:0879-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : squid (openSUSE-SU-2021:0879-1)");
...
the openSUSE-SU-2021:0879-1 advisory.
...
number.");
  ...
  # https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/E33JWP5CXQF3EVKKDRECX4457F2ILQP2/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?00d23cf1");
...
pkgs = [
    {'reference':'squid-4.15-lp152.2.9.1', 'cpu':'x86_64', 'release':'SUSE15.2', 'rpm_spec_vers_cmp':TRUE}
];
