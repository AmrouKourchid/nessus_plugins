...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : python (EulerOS-SA-2021-1835)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1835
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b8b8ad3a");
...
pkgs = ["python-2.7.5-58.h31",
        "python-devel-2.7.5-58.h31",
        "python-libs-2.7.5-58.h31",
        "tkinter-2.7.5-58.h31"];
