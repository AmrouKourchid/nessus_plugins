...
# extracted from Red Hat Security Advisory RHSA-2018:2943. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 6 : java-1.8.0-openjdk (RHSA-2018:2943)");
...
referenced in the RHSA-2018:2943 advisory.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_2943.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e0ac166e");
...
"Update the RHEL java-1.8.0-openjdk package based on the guidance in RHSA-2018:2943.");
...
var constraints = [
  {
    ...
    'pkgs': [
      ...
      {'reference':'java-1.8.0-openjdk-javadoc-1.8.0.191.b12-0.el6_10', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.8.0-openjdk-javadoc-debug-1.8.0.191.b12-0.el6_10', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
