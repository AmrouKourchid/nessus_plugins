...
# extracted from Fedora Security Advisory FEDORA-2022-2e93acb55d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-2e93acb55d");

  script_name(english:"Fedora 38 : python3.6 (2022-2e93acb55d)");
...
FEDORA-2022-2e93acb55d advisory.
    ...
    ```
    * Wed Sep 14 2022 Lumr Balhar <lbalhar@redhat.com> - 3.6.15-12
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-2e93acb55d");
...
var pkgs = [
    {'reference':'python3.6-3.6.15-12.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
