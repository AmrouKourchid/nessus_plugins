...
# extracted from Red Hat Security Advisory mcg. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 8 : mcg (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  # https://security.access.redhat.com/data/csaf/v2/vex/2024/cve-2024-6104.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8f106b63");
