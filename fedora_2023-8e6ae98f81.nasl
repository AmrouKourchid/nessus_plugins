...
# extracted from Fedora Security Advisory FEDORA-2023-8e6ae98f81
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-8e6ae98f81");

  script_name(english:"Fedora 39 : firecracker / virtiofsd (2023-8e6ae98f81)");
...
FEDORA-2023-8e6ae98f81 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-8e6ae98f81");
...
var pkgs = [
    {'reference':'firecracker-1.4.1-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'virtiofsd-1.7.0-4.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
