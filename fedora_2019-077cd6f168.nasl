...
# extracted from Fedora Security Advisory FEDORA-2019-077cd6f168.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : moodle (2019-077cd6f168)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-077cd6f168");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"moodle-3.4.7-1.fc28")) flag++;
