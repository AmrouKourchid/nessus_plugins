...
# extracted from Fedora Security Advisory FEDORA-2019-e45019c690.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-e45019c690");

  script_name(english:"Fedora 30 : libtiff (2019-e45019c690)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"Security fix for CVE-2019-14973.

Note that Tenable Network Security has extracted the preceding
description block directly from the Fedora update system website.
Tenable has attempted to automatically clean and format it as much as
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-e45019c690");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"libtiff-4.0.10-7.fc30")) flag++;
