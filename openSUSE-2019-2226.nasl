...
# extracted from openSUSE Security Update openSUSE-2019-2226.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : SDL2 (openSUSE-2019-2226)");
...
if ( rpm_check(release:"SUSE15.1", reference:"SDL2-debugsource-2.0.8-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libSDL2-2_0-0-2.0.8-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libSDL2-2_0-0-debuginfo-2.0.8-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libSDL2-devel-2.0.8-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libSDL2-2_0-0-32bit-2.0.8-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libSDL2-2_0-0-32bit-debuginfo-2.0.8-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libSDL2-devel-32bit-2.0.8-lp151.4.6.1") ) flag++;
