...
# extracted from Red Hat Security Advisory xsa229_xen. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2017-12134");

  script_name(english:"RHEL 5 : xsa229_xen (Unpatched Vulnerability) (deprecated)");
