...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 20.04 LTS : Bind vulnerability (USN-4737-1)");
...
referenced in the USN-4737-1 advisory.
    ...
    arbitrary code. In the default installation, attackers would be isolated by the Bind AppArmor profile.
