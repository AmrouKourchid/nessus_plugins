...
# extracted from Red Hat Security Advisory RHSA-2020:5112. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2020-1720", "CVE-2020-14349", "CVE-2020-14350");
  script_xref(name:"RHSA", value:"2020:5112");

  script_name(english:"RHEL 7 : rh-postgresql12-postgresql (RHSA-2020:5112)");
...
referenced in the RHSA-2020:5112 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_5112.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?38fa4483");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:5112");
...
"Update the RHEL rh-postgresql12-postgresql package based on the guidance in RHSA-2020:5112.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-postgresql12-postgresql-12.4-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql12-postgresql-contrib-12.4-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql12-postgresql-contrib-syspaths-12.4-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql12-postgresql-devel-12.4-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql12-postgresql-docs-12.4-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql12-postgresql-libs-12.4-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql12-postgresql-plperl-12.4-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql12-postgresql-plpython-12.4-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql12-postgresql-pltcl-12.4-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql12-postgresql-server-12.4-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql12-postgresql-server-syspaths-12.4-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql12-postgresql-static-12.4-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql12-postgresql-syspaths-12.4-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql12-postgresql-test-12.4-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
