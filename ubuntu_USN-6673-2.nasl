...
# extracted from Ubuntu Security Notice USN-6673-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6673-2");

  script_name(english:"Ubuntu 16.04 LTS : python-cryptography vulnerability (USN-6673-2)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6673-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'python-cryptography', 'pkgver': '1.2.3-1ubuntu0.3+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'python3-cryptography', 'pkgver': '1.2.3-1ubuntu0.3+esm1', 'ubuntu_pro': TRUE}
];
