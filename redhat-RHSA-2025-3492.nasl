...
# extracted from Red Hat Security Advisory RHSA-2025:3492. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:3492");
  script_xref(name:"IAVB", value:"2025-B-0065");

  script_name(english:"RHEL 8 : Satellite 6.14.4.5 Async Update (Important) (RHSA-2025:3492)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2025:3492 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_3492.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?036f3977");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:3492");
