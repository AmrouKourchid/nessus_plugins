...
# extracted from Fedora Security Advisory FEDORA-2022-1166a1df1e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-1166a1df1e");
  script_xref(name:"IAVA", value:"2023-A-0061-S");

  script_name(english:"Fedora 35 : python3.9 (2022-1166a1df1e)");
...
FEDORA-2022-1166a1df1e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-1166a1df1e");
...
var pkgs = [
    {'reference':'python3.9-3.9.15-2.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
