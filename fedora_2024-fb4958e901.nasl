...
# extracted from Fedora Security Advisory FEDORA-2024-fb4958e901
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-fb4958e901");

  script_name(english:"Fedora 38 : mongo-c-driver (2024-fb4958e901)");
...
FEDORA-2024-fb4958e901 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-fb4958e901");
  script_set_attribute(attribute:"solution", value:
"Update the affected mongo-c-driver package.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:N/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-0437");
...
var pkgs = [
    {'reference':'mongo-c-driver-1.24.3-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
