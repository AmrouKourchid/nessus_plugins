...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Ruby PHSA-2017-0021");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'ruby-2.4.0-3.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'ruby-debuginfo-2.4.0-3.ph1')) flag++;
