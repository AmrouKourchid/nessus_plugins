...
if (description)
{
  ...
  script_name(english:"CentOS 9 : fribidi-1.0.10-6.el9.2");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing one or more security updates for fribidi.");
...
fribidi-1.0.10-6.el9.2 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=18075");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream fribidi package.");
