...
# extracted from Debian Security Advisory dla-3852. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3852 : ovmf - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3852
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/edk2");
...
"Upgrade the ovmf packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-48733");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'ovmf', 'reference': '0~20181115.85588389-3+deb10u4'},
    {'release': '10.0', 'prefix': 'qemu-efi', 'reference': '0~20181115.85588389-3+deb10u4'},
    {'release': '10.0', 'prefix': 'qemu-efi-aarch64', 'reference': '0~20181115.85588389-3+deb10u4'},
    {'release': '10.0', 'prefix': 'qemu-efi-arm', 'reference': '0~20181115.85588389-3+deb10u4'}
];
