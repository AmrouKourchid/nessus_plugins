...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Libtiff PHSA-2023-5.0-0044");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'libtiff-4.5.1-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'libtiff-devel-4.5.1-1.ph5')) flag++;
