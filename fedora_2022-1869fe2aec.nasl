...
# extracted from Fedora Security Advisory FEDORA-2022-1869fe2aec
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-1869fe2aec");

  script_name(english:"Fedora 37 : usbguard (2022-1869fe2aec)");
...
FEDORA-2022-1869fe2aec advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-1869fe2aec");
  script_set_attribute(attribute:"solution", value:
"Update the affected usbguard package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:usbguard");
...
var pkgs = [
    {'reference':'usbguard-1.1.0-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'usbguard');
}
