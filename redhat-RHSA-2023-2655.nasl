...
referenced in the RHSA-2023:2655 advisory.
    ...
    The following packages have been upgraded to a later upstream version: nodejs (16.19.1), nodejs-nodemon
    (2.0.20).
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_2655.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9ce97e98");
...
"Update the affected packages.");
  ...
  script_cwe_id(400, 93, 119, 426, 863, 1333);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'nodejs-16.19.1-1.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'cves':['CVE-2021-35065', 'CVE-2022-4904', 'CVE-2022-25881', 'CVE-2023-23918', 'CVE-2023-23920', 'CVE-2023-23936', 'CVE-2023-24807']},
      {'reference':'nodejs-docs-16.19.1-1.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'cves':['CVE-2021-35065', 'CVE-2022-4904', 'CVE-2022-25881', 'CVE-2023-23918', 'CVE-2023-23920', 'CVE-2023-23936', 'CVE-2023-24807']},
      {'reference':'nodejs-full-i18n-16.19.1-1.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'cves':['CVE-2021-35065', 'CVE-2022-4904', 'CVE-2022-25881', 'CVE-2023-23918', 'CVE-2023-23920', 'CVE-2023-23936', 'CVE-2023-24807']},
      {'reference':'nodejs-libs-16.19.1-1.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'cves':['CVE-2021-35065', 'CVE-2022-4904', 'CVE-2022-25881', 'CVE-2023-23918', 'CVE-2023-23920', 'CVE-2023-23936', 'CVE-2023-24807']},
      {'reference':'nodejs-nodemon-2.0.20-3.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2021-35065']},
      {'reference':'npm-8.19.3-1.16.19.1.1.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'cves':['CVE-2021-35065', 'CVE-2022-4904', 'CVE-2022-25881', 'CVE-2023-23918', 'CVE-2023-23920', 'CVE-2023-23936', 'CVE-2023-24807']}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'nodejs-16.19.1-1.el9_2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'cves':['CVE-2021-35065', 'CVE-2022-4904', 'CVE-2022-25881', 'CVE-2023-23918', 'CVE-2023-23920', 'CVE-2023-23936', 'CVE-2023-24807']},
      {'reference':'nodejs-docs-16.19.1-1.el9_2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'cves':['CVE-2021-35065', 'CVE-2022-4904', 'CVE-2022-25881', 'CVE-2023-23918', 'CVE-2023-23920', 'CVE-2023-23936', 'CVE-2023-24807']},
      {'reference':'nodejs-full-i18n-16.19.1-1.el9_2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'cves':['CVE-2021-35065', 'CVE-2022-4904', 'CVE-2022-25881', 'CVE-2023-23918', 'CVE-2023-23920', 'CVE-2023-23936', 'CVE-2023-24807']},
      {'reference':'nodejs-libs-16.19.1-1.el9_2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'cves':['CVE-2021-35065', 'CVE-2022-4904', 'CVE-2022-25881', 'CVE-2023-23918', 'CVE-2023-23920', 'CVE-2023-23936', 'CVE-2023-24807']},
      {'reference':'nodejs-nodemon-2.0.20-3.el9_2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2021-35065']},
      {'reference':'npm-8.19.3-1.16.19.1.1.el9_2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'cves':['CVE-2021-35065', 'CVE-2022-4904', 'CVE-2022-25881', 'CVE-2023-23918', 'CVE-2023-23920', 'CVE-2023-23936', 'CVE-2023-24807']}
    ]
  }
];
