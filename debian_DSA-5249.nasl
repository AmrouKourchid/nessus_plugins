...
# extracted from Debian Security Advisory dsa-5249. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-5249-1 : strongswan - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has packages installed that are affected by a vulnerability as referenced in the dsa-5249
advisory.

    Lahav Schlesinger discovered a vulnerability in the revocation plugin of strongSwan, an IKE/IPsec suite.
    The revocation plugin uses OCSP URIs and CRL distribution points (CDP) which come from certificates
    provided by the remote endpoint. The plugin didn't check for the certificate chain of trust before using
    those URIs, so an attacker could provided a crafted certificate containing URIs pointing to servers under
    their control, potentially leading to denial-of-service attacks. For the stable distribution (bullseye),
    this problem has been fixed in version 5.9.1-1+deb11u3. We recommend that you upgrade your strongswan
    packages. For the detailed security status of strongswan please refer to its security tracker page at:
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=1021271");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/strongswan");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2022/dsa-5249");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-40617");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'charon-cmd', 'reference': '5.9.1-1+deb11u3'},
    {'release': '11.0', 'prefix': 'charon-systemd', 'reference': '5.9.1-1+deb11u3'},
    {'release': '11.0', 'prefix': 'libcharon-extauth-plugins', 'reference': '5.9.1-1+deb11u3'},
    {'release': '11.0', 'prefix': 'libcharon-extra-plugins', 'reference': '5.9.1-1+deb11u3'},
    {'release': '11.0', 'prefix': 'libstrongswan', 'reference': '5.9.1-1+deb11u3'},
    {'release': '11.0', 'prefix': 'libstrongswan-extra-plugins', 'reference': '5.9.1-1+deb11u3'},
    {'release': '11.0', 'prefix': 'libstrongswan-standard-plugins', 'reference': '5.9.1-1+deb11u3'},
    {'release': '11.0', 'prefix': 'strongswan', 'reference': '5.9.1-1+deb11u3'},
    {'release': '11.0', 'prefix': 'strongswan-charon', 'reference': '5.9.1-1+deb11u3'},
    {'release': '11.0', 'prefix': 'strongswan-libcharon', 'reference': '5.9.1-1+deb11u3'},
    {'release': '11.0', 'prefix': 'strongswan-nm', 'reference': '5.9.1-1+deb11u3'},
    {'release': '11.0', 'prefix': 'strongswan-pki', 'reference': '5.9.1-1+deb11u3'},
    {'release': '11.0', 'prefix': 'strongswan-scepclient', 'reference': '5.9.1-1+deb11u3'},
    {'release': '11.0', 'prefix': 'strongswan-starter', 'reference': '5.9.1-1+deb11u3'},
    {'release': '11.0', 'prefix': 'strongswan-swanctl', 'reference': '5.9.1-1+deb11u3'}
];
