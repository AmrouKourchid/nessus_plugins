...
# extracted from VMware Security Advisory PHSA-2019-2.0-0129. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Docker PHSA-2019-2.0-0129");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the docker package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-2-129.md");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'docker-17.06.0-9.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'docker-doc-17.06.0-9.ph2')) flag++;
