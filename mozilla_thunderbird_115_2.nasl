...
"The version of Thunderbird installed on the remote Windows host is prior to 115.2. It is, therefore, affected by
multiple vulnerabilities as referenced in the mfsa2023-38 advisory.
...
mozilla_check_version(installs:installs, product:'thunderbird', esr:FALSE, fix:'115.2', severity:SECURITY_HOLE);
