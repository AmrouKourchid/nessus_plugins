...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : grub2 (EulerOS-SA-2025-1518)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1518
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?161f368f");
...
var pkgs = [
  ...
  "grub2-efi-x64-2.04-16.h50.eulerosv2r10",
  "grub2-efi-x64-modules-2.04-16.h50.eulerosv2r10",
  "grub2-pc-2.04-16.h50.eulerosv2r10",
  "grub2-pc-modules-2.04-16.h50.eulerosv2r10",
  "grub2-tools-2.04-16.h50.eulerosv2r10",
  "grub2-tools-efi-2.04-16.h50.eulerosv2r10",
