...
# extracted from Red Hat Security Advisory RHSA-2018:2095. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:2095");

  script_name(english:"RHEL 6 : patch (RHSA-2018:2095)");
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_2095.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?49b078c4");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:2095");
...
"Update the RHEL patch package based on the guidance in RHSA-2018:2095.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'patch-2.6-8.el6_6', 'sp':'6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
