...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : Keystone vulnerabilities (USN-2705-1)");
...
the USN-2705-1 advisory.

    Qin Zhao discovered Keystone disabled certification verification when the insecure option is set in a
    paste configuration (paste.ini) file regardless of the value, which allows remote attackers to conduct
    machine-in-the-middle attacks via a crafted certificate. (CVE-2014-7144)

    Brant Knudson discovered Keystone disabled certification verification when the insecure option is set in
    a paste configuration (paste.ini) file regardless of the value, which allows remote attackers to conduct
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2705-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'python-keystoneclient', 'pkgver': '1:0.7.1-ubuntu1.2'}
];
