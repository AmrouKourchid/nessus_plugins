...
# extracted from Red Hat Security Advisory RHSA-2024:2729. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2729");

  script_name(english:"RHEL 9 : Red Hat OpenStack Platform 17.1 (etcd) (RHSA-2024:2729)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for Red Hat OpenStack Platform 17.1 (etcd).");
...
referenced in the RHSA-2024:2729 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2729.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9fdd13a4");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2729");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat OpenStack Platform 17.1 (etcd) package based on the guidance in RHSA-2024:2729.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'etcd-3.4.26-8.el9ost', 'cpu':'x86_64', 'release':'9', 'el_string':'el9ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
