...
# extracted from Fedora Security Advisory FEDORA-2023-51593ce398
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-51593ce398");

  script_name(english:"Fedora 37 : dbus (2023-51593ce398)");
...
FEDORA-2023-51593ce398 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-51593ce398");
...
var pkgs = [
    {'reference':'dbus-1.14.8-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
