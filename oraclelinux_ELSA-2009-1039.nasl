...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2009-1039.html");
...
"Update the affected ntp package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2009-1252");
...
var pkgs = [
    {'reference':'ntp-4.2.2p1-9.el5_3.2', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ntp-4.2.2p1-9.el5_3.2', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
