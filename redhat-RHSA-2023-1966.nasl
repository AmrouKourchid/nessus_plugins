...
# extracted from Red Hat Security Advisory RHSA-2023:1966. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:1966");

  script_name(english:"RHEL 8 : pki-core:10.6 (RHSA-2023:1966)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for pki-core:10.6.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2023:1966 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_1966.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4210e962");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2104676");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:1966");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL pki-core:10.6 package based on the guidance in RHSA-2023:1966.");
  ...
  'pki-core:10.6': [
    {
      ...
      'pkgs': [
        {'reference':'jss-4.8.1-2.module+el8.4.0+10451+3e5b5448', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'jss-javadoc-4.8.1-2.module+el8.4.0+10451+3e5b5448', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'pki-acme-10.10.5-6.module+el8.4.0+17580+3370c7a3', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'pki-base-10.10.5-6.module+el8.4.0+17580+3370c7a3', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'pki-base-java-10.10.5-6.module+el8.4.0+17580+3370c7a3', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'pki-ca-10.10.5-6.module+el8.4.0+17580+3370c7a3', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'pki-kra-10.10.5-6.module+el8.4.0+17580+3370c7a3', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'pki-server-10.10.5-6.module+el8.4.0+17580+3370c7a3', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'pki-symkey-10.10.5-6.module+el8.4.0+17580+3370c7a3', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'pki-tools-10.10.5-6.module+el8.4.0+17580+3370c7a3', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-pki-10.10.5-6.module+el8.4.0+17580+3370c7a3', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
