...
# extracted from Fedora Security Advisory FEDORA-2023-5f35718d4c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-5f35718d4c");

  script_name(english:"Fedora 38 : chromium (2023-5f35718d4c)");
...
FEDORA-2023-5f35718d4c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-5f35718d4c");
...
var pkgs = [
    {'reference':'chromium-114.0.5735.133-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
