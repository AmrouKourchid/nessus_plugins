...
if (description)
{
  ...
  script_name(english:"NuGet Package 'Microsoft.Extensions.ML' Detection");

  script_set_attribute(attribute:"synopsis", value:
"The remote host has a Verified NuGet package status and is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"The remote host has a 'Microsoft.Extensions.ML' with a Verified NuGet package status and is installed on the remote host.

Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.nuget.org/packages/Microsoft.Extensions.ML/");
  script_set_attribute(attribute:"solution", value:
"The Microsoft.Extensions.ML package is installed on the remote host.");
  ...
  script_set_attribute(attribute:"cpe", value:"cpe:/a:microsoft:microsoft.extensions.ml");
...
var app_info = vcf::nuget_package::get_app_info(pkg_name:"Microsoft.Extensions.ML");
app_info.vendor = "Microsoft";
app_info.cpe = "cpe:/a:microsoft:microsoft.extensions.ml";
