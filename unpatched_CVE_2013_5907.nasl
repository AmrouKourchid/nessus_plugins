...
if (description)
{
  ...
  script_cve_id("CVE-2013-5907");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2013-5907");
...
patch available.
  ...
  - Unspecified vulnerability in Oracle Java SE 5.0u55, 6u65, and 7u45; JRockit R27.7.7 and R28.2.9; Java SE
    ...
    or possibly execute arbitrary code via a crafted font file. (CVE-2013-5907)
