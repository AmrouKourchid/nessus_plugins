...
# extracted from Fedora Security Advisory FEDORA-2024-d946b9ad25
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-d946b9ad25");

  script_name(english:"Fedora 39 : putty (2024-d946b9ad25)");
...
FEDORA-2024-d946b9ad25 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-d946b9ad25");
...
var pkgs = [
    {'reference':'putty-0.80-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
