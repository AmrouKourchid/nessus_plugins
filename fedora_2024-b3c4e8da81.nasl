...
# extracted from Fedora Security Advisory FEDORA-2024-b3c4e8da81
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-b3c4e8da81");

  script_name(english:"Fedora 40 : trafficserver (2024-b3c4e8da81)");
...
FEDORA-2024-b3c4e8da81 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-b3c4e8da81");
...
var pkgs = [
    {'reference':'trafficserver-9.2.6-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
