...
# extracted from SUSE update advisory SUSE-SU-2021:0720-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : wpa_supplicant (SUSE-SU-2021:0720-1)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cefda5c7");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"5", reference:"wpa_supplicant-2.9-23.9.2")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"wpa_supplicant-debuginfo-2.9-23.9.2")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"wpa_supplicant-debugsource-2.9-23.9.2")) flag++;
