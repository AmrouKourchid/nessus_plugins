...
# extracted from Fedora Security Advisory FEDORA-2024-5762d637dd
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-5762d637dd");

  script_name(english:"Fedora 39 : tigervnc / xorg-x11-server (2024-5762d637dd)");
...
FEDORA-2024-5762d637dd advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-5762d637dd");
...
var pkgs = [
    {'reference':'tigervnc-1.13.1-11.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xorg-x11-server-1.20.14-29.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'tigervnc / xorg-x11-server');
}
