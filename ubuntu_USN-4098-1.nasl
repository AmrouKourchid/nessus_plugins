...
# extracted from Ubuntu Security Notice USN-4098-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS : wpa_supplicant and hostapd vulnerability (USN-4098-1)");
...
USN-4098-1 advisory.
    ...
    pwd. A remote attacker could possibly use this issue to recover certain passwords.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4098-1");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'hostapd', 'pkgver': '2:2.6-15ubuntu2.4'},
    {'osver': '18.04', 'pkgname': 'wpagui', 'pkgver': '2:2.6-15ubuntu2.4'},
    {'osver': '18.04', 'pkgname': 'wpasupplicant', 'pkgver': '2:2.6-15ubuntu2.4'},
    {'osver': '18.04', 'pkgname': 'wpasupplicant-udeb', 'pkgver': '2:2.6-15ubuntu2.4'}
];
