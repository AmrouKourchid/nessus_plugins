...
# extracted from Fedora Security Advisory FEDORA-2024-3bb23c77f3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-3bb23c77f3");

  script_name(english:"Fedora 39 : podman (2024-3bb23c77f3)");
...
FEDORA-2024-3bb23c77f3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-3bb23c77f3");
...
var pkgs = [
    {'reference':'podman-4.8.3-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'5'}
];
