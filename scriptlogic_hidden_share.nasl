...
script_set_attribute(attribute:"cpe", value:"cpe:/a:scriptlogic:scriptlogic");
...
var share_kb = 'SMB/share_permissions/' + share;
...
var info = get_kb_item(share_kb + '/EVERYONE/Allow/Report');

var report = 'The "' + share + '" share has allow permissions set for "Everyone"';
if (info) report += ' :\n' + info + '\n';
else report += '.\n';
