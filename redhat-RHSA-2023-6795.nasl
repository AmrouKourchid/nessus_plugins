...
# extracted from Red Hat Security Advisory RHSA-2023:6795. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:6795");

  script_name(english:"RHEL 7 : insights-client (RHSA-2023:6795)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6795.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?301e718a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2227027");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6795");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL insights-client package based on the guidance in RHSA-2023:6795.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'insights-client-3.1.9-1.el7_9', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
