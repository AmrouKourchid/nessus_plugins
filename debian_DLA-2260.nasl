...
# extracted from Debian Security Advisory DLA-2260-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2260-1 : mcabber security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2020/06/msg00031.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/jessie/mcabber");
  script_set_attribute(attribute:"solution", value:
"Upgrade the affected mcabber package.");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"mcabber", reference:"0.10.2-1+deb8u1")) flag++;
