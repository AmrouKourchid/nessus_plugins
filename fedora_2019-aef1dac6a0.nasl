...
# extracted from Fedora Security Advisory FEDORA-2019-aef1dac6a0.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-aef1dac6a0");

  script_name(english:"Fedora 30 : 1:wireshark (2019-aef1dac6a0)");
...
Security fix for CVE-2019-10894, CVE-2019-10895, CVE-2019-10896,
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-aef1dac6a0");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"wireshark-3.0.1-1.fc30", epoch:"1")) flag++;
