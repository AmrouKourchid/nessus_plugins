...
# extracted from Fedora Security Advisory FEDORA-2024-452b60addf
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-452b60addf");

  script_name(english:"Fedora 40 : chromium (2024-452b60addf)");
...
FEDORA-2024-452b60addf advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-452b60addf");
...
var pkgs = [
    {'reference':'chromium-129.0.6668.89-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
