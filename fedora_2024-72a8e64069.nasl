...
# extracted from Fedora Security Advisory FEDORA-2024-72a8e64069
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-72a8e64069");

  script_name(english:"Fedora 41 : dr_libs (2024-72a8e64069)");
...
FEDORA-2024-72a8e64069 advisory.
    ...
    - dr_wav 0.13.17: Fix a possible crash when reading from MS-ADPCM encoded files. Improve detection of
    ARM64EC.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-72a8e64069");
...
var pkgs = [
    {'reference':'dr_libs-0^20241216git660795b-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
