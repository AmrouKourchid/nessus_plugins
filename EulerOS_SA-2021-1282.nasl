...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : binutils (EulerOS-SA-2021-1282)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1282
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6d9ccd29");
...
pkgs = ["binutils-2.25.1-22.base.h54",
        "binutils-devel-2.25.1-22.base.h54"];
