...
# extracted from Fedora Security Advisory FEDORA-2018-f80b495582.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-f80b495582");

  script_name(english:"Fedora 29 : mosquitto (2018-f80b495582)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-f80b495582");
...
"Update the affected mosquitto package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-20145");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"mosquitto-1.5.5-1.fc29")) flag++;
