...
# extracted from Red Hat Security Advisory ipxe. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2022-4087");

  script_name(english:"RHEL 7 : ipxe (Unpatched Vulnerability) (deprecated)");
...
"This plugin has been deprecated as it does not adhere to established standards for this style of check.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-4087");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:ipxe");
