...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.2.0 : xorg-x11-server (EulerOS-SA-2021-1048)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1048
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?eb232afc");
...
pkgs = ["xorg-x11-server-Xorg-1.19.5-5.h11",
        "xorg-x11-server-common-1.19.5-5.h11"];
