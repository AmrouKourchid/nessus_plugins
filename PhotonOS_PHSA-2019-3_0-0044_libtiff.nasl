...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Libtiff PHSA-2019-3.0-0044");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libtiff-4.0.10-5.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libtiff-debuginfo-4.0.10-5.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libtiff-devel-4.0.10-5.ph3')) flag++;
