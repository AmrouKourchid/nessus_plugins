...
# extracted from Fedora Security Advisory FEDORA-2022-443c5ec2dd
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-443c5ec2dd");

  script_name(english:"Fedora 36 : fish (2022-443c5ec2dd)");
...
FEDORA-2022-443c5ec2dd advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-443c5ec2dd");
  script_set_attribute(attribute:"solution", value:
"Update the affected fish package.");
...
var pkgs = [
    {'reference':'fish-3.4.1-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
