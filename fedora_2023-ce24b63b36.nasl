...
# extracted from Fedora Security Advisory FEDORA-2023-ce24b63b36
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-ce24b63b36");

  script_name(english:"Fedora 37 : moodle (2023-ce24b63b36)");
...
FEDORA-2023-ce24b63b36 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-ce24b63b36");
...
var pkgs = [
    {'reference':'moodle-4.1.4-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
