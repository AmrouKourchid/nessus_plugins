...
if (description)
{
  ...
  script_name(english:"OpenSSL SEoL (1.0.0.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of OpenSSL is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, OpenSSL is 1.0.0.x. It is, therefore, no longer maintained by its vendor or provider.

Lack of support implies that no new security patches for the product will be released by the vendor. As a result, it may
contain security vulnerabilities.");
  script_set_attribute(attribute:"see_also", value:"https://www.openssl.org/news/vulnerabilities-1.0.0.html");
...
var constraints = [
  { max_branch : '1.0.0', min_branch : '1.0.0', seol : 20160101 }
];
