...
# extracted from Fedora Security Advisory FEDORA-2024-1eb20f8ec3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-1eb20f8ec3");

  script_name(english:"Fedora 38 : python-nikola (2024-1eb20f8ec3)");
...
FEDORA-2024-1eb20f8ec3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-1eb20f8ec3");
...
var pkgs = [
    {'reference':'python-nikola-8.3.0-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
