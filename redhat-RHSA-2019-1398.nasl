...
# extracted from Red Hat Security Advisory RHSA-2019:1398. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:1398");

  script_name(english:"RHEL 7 : qpid-proton (RHSA-2019:1398)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_1398.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?36099866");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1702439");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:1398");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL qpid-proton package based on the guidance in RHSA-2019:1398.");
...
var constraints = [
  {
    'repo_relative_urls': [
      'content/dist/rhel/server/7/7Server/x86_64/openstack-optools/14/debug',
      'content/dist/rhel/server/7/7Server/x86_64/openstack-optools/14/os',
      'content/dist/rhel/server/7/7Server/x86_64/openstack-optools/14/source/SRPMS'
    ],
    'pkgs': [
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'qpid-proton-c');
}
