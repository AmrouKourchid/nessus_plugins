...
# extracted from Red Hat Security Advisory RHSA-2023:4417. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:4417");

  script_name(english:"RHEL 9 : cjose (RHSA-2023:4417)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_4417.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5d542875");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2223295");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:4417");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL cjose package based on the guidance in RHSA-2023:4417.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cjose-0.6.1-13.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
