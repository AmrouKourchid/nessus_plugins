...
# extracted from Fedora Security Advisory FEDORA-2024-f69e3c5255
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-f69e3c5255");

  script_name(english:"Fedora 39 : python-zipp (2024-f69e3c5255)");
...
FEDORA-2024-f69e3c5255 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-f69e3c5255");
  script_set_attribute(attribute:"solution", value:
"Update the affected python-zipp package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:python-zipp");
...
var pkgs = [
    {'reference':'python-zipp-3.16.2-3.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
