...
# extracted from Fedora Security Advisory FEDORA-2023-b67c3bf65d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-b67c3bf65d");

  script_name(english:"Fedora 37 : kernel (2023-b67c3bf65d)");
...
FEDORA-2023-b67c3bf65d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-b67c3bf65d");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  var cve_list = make_list('FEDORA-2023-b67c3bf65d');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for FEDORA-2023-b67c3bf65d');
  }
  else
  {
...
var pkgs = [
    {'reference':'kernel-6.1.12-200.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
