...
# extracted from Red Hat Security Advisory RHSA-2024:4670. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:4670");

  script_name(english:"RHEL 9 : thunderbird (RHSA-2024:4670)");
...
referenced in the RHSA-2024:4670 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_4670.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0d95a06d");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:4670");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL thunderbird package based on the guidance in RHSA-2024:4670.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'thunderbird-115.13.0-3.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
