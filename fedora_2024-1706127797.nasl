...
# extracted from Fedora Security Advisory FEDORA-2024-1706127797
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-1706127797");

  script_name(english:"Fedora 38 : xorg-x11-server-Xwayland (2024-1706127797)");
...
FEDORA-2024-1706127797 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-1706127797");
...
var pkgs = [
    {'reference':'xorg-x11-server-Xwayland-22.1.9-7.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
