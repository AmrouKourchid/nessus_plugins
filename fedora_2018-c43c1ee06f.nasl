...
# extracted from Fedora Security Advisory FEDORA-2018-c43c1ee06f.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : 1:wpa_supplicant (2018-c43c1ee06f)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-c43c1ee06f");
...
flag = 0;
if (rpm_check(release:"FC27", reference:"wpa_supplicant-2.6-14.fc27", epoch:"1")) flag++;
