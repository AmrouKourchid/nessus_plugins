...
# extracted from Fedora Security Advisory FEDORA-2024-d0acf8d109
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-d0acf8d109");

  script_name(english:"Fedora 38 : trafficserver (2024-d0acf8d109)");
...
FEDORA-2024-d0acf8d109 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-d0acf8d109");
...
var pkgs = [
    {'reference':'trafficserver-9.2.4-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
