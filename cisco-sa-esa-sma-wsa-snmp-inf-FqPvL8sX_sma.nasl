...
if (description)
{
  ...
  script_xref(name:"CISCO-BUG-ID", value:"CSCwk56456");
  script_xref(name:"CISCO-SA", value:"cisco-sa-esa-sma-wsa-snmp-inf-FqPvL8sX");

  script_name(english:"Cisco Secure Email and Web Manager SNMP Polling Information Disclosure (cisco-sa-esa-sma-wsa-snmp-inf-FqPvL8sX)");
...
"Upgrade to the relevant fixed version referenced in Cisco bug ID CSCwk56456");
...
var vuln_ranges = [
  {'min_ver' : '0.0', 'fix_ver' : '15.5.2.005'}, 
