...
# extracted from Fedora Security Advisory FEDORA-2023-8282501ffb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-8282501ffb");

  script_name(english:"Fedora 39 : libcaca (2023-8282501ffb)");
...
FEDORA-2023-8282501ffb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-8282501ffb");
...
var pkgs = [
    {'reference':'libcaca-0.99-0.69.beta20.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
