...
# extracted from Debian Security Advisory DLA-2332-2. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2332-2 : sane-backends regression update");
...
For the detailed security status of sane-backends please refer to its
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2020/10/msg00010.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/stretch/sane-backends");
  # https://security-tracker.debian.org/tracker/source-package/sane-backends
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?91e9f264");
...
"Upgrade the affected packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-12865");
...
flag = 0;
if (deb_check(release:"9.0", prefix:"libsane", reference:"1.0.25-4.1+deb9u2")) flag++;
if (deb_check(release:"9.0", prefix:"libsane-common", reference:"1.0.25-4.1+deb9u2")) flag++;
if (deb_check(release:"9.0", prefix:"libsane-dbg", reference:"1.0.25-4.1+deb9u2")) flag++;
if (deb_check(release:"9.0", prefix:"libsane-dev", reference:"1.0.25-4.1+deb9u2")) flag++;
if (deb_check(release:"9.0", prefix:"sane-utils", reference:"1.0.25-4.1+deb9u2")) flag++;
