...
if (description)
{
  ...
  script_cve_id("CVE-2024-32620");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-32620");
...
patch available.
  ...
  - HDF5 Library through 1.14.3 contains a heap-based buffer over-read in H5F_addr_decode_len in H5Fint.c,
    resulting in the corruption of the instruction pointer. (CVE-2024-32620)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-32620");
