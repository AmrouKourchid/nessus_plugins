...
# extracted from Fedora Security Advisory FEDORA-2022-04bc7cd075
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-04bc7cd075");

  script_name(english:"Fedora 37 : kitty (2022-04bc7cd075)");
...
FEDORA-2022-04bc7cd075 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-04bc7cd075");
...
var pkgs = [
    {'reference':'kitty-0.26.3-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
