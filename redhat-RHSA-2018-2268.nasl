...
# extracted from Red Hat Security Advisory RHSA-2018:2268. The text 
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_2268.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4378f6fa");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:2268");
...
"Update the RHEL procps package based on the guidance in RHSA-2018:2268.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'procps-3.2.8-30.el6_6.1', 'sp':'6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'procps-3.2.8-30.el6_6.1', 'sp':'6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'procps-devel-3.2.8-30.el6_6.1', 'sp':'6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'procps-devel-3.2.8-30.el6_6.1', 'sp':'6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
