...
if (description)
{
  ...
  script_cve_id("CVE-2020-10690");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2020-10690 (deprecated)");
...
"n/a");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-10690");
