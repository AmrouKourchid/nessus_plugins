...
if (description)
{
  ...
  script_cve_id("CVE-2024-56596");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-56596");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: jfs: fix array-index-out-of-bounds in
    jfs_readdir The stbl might contain some invalid values. Added a check to return error code in that case.
    (CVE-2024-56596)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-56596");
