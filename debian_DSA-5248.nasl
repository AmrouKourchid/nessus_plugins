...
# extracted from Debian Security Advisory dsa-5248. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-5248-1 : php-twig - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has packages installed that are affected by a vulnerability as referenced in the dsa-5248
advisory.

    Marlon Starkloff discovered that twig, a template engine for PHP, did not correctly enforce sandboxing.
    This would allow a malicious user to execute arbitrary code. For the stable distribution (bullseye), this
    problem has been fixed in version 2.14.3-1+deb11u2. We recommend that you upgrade your php-twig packages.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=1020991");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/php-twig");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2022/dsa-5248");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-39261");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'php-twig', 'reference': '2.14.3-1+deb11u2'},
    {'release': '11.0', 'prefix': 'php-twig-cssinliner-extra', 'reference': '2.14.3-1+deb11u2'},
    {'release': '11.0', 'prefix': 'php-twig-doc', 'reference': '2.14.3-1+deb11u2'},
    {'release': '11.0', 'prefix': 'php-twig-extra-bundle', 'reference': '2.14.3-1+deb11u2'},
    {'release': '11.0', 'prefix': 'php-twig-html-extra', 'reference': '2.14.3-1+deb11u2'},
    {'release': '11.0', 'prefix': 'php-twig-inky-extra', 'reference': '2.14.3-1+deb11u2'},
    {'release': '11.0', 'prefix': 'php-twig-intl-extra', 'reference': '2.14.3-1+deb11u2'},
    {'release': '11.0', 'prefix': 'php-twig-markdown-extra', 'reference': '2.14.3-1+deb11u2'}
];
