...
if (description)
{
  ...
  script_cve_id("CVE-2014-9809");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2014-9809");
...
patch available.
  ...
  - ImageMagick allows remote attackers to cause a denial of service (segmentation fault and application
    crash) via a crafted xwd image. (CVE-2014-9809)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-9809");
