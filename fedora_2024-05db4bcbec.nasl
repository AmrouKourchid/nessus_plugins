...
# extracted from Fedora Security Advisory FEDORA-2024-05db4bcbec
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-05db4bcbec");

  script_name(english:"Fedora 38 : xorg-x11-server-Xwayland (2024-05db4bcbec)");
...
FEDORA-2024-05db4bcbec advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-05db4bcbec");
...
var pkgs = [
    {'reference':'xorg-x11-server-Xwayland-22.1.9-5.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
