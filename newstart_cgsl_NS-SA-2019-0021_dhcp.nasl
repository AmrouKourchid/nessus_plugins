...
# extracted from ZTE advisory NS-SA-2019-0021. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.04 / MAIN 5.04 : dhcp Multiple Vulnerabilities (NS-SA-2019-0021)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version CORE 5.04 / MAIN 5.04, has dhcp packages installed that are affected by
multiple vulnerabilities:
  ...
  - A command injection flaw was found in the NetworkManager
    ...
    in Red Hat Enterprise Linux. A malicious DHCP server, or
    an attacker on the local network able to spoof DHCP
...
number.");
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/notice/NS-SA-2019-0021");
...
pkgs = {
  "CGSL CORE 5.04": [
    ...
    "dhcp-debuginfo-4.2.5-68.el7.centos.1",
