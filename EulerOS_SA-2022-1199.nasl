...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : babel (EulerOS-SA-2022-1199)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the babel packages installed, the EulerOS installation on the remote host is affected by
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1199
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dfde86f9");
  script_set_attribute(attribute:"solution", value:
"Update the affected babel packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:babel-help");
...
var pkgs = [
  "babel-help-2.8.0-2.h3.eulerosv2r10",
  "python3-babel-2.8.0-2.h3.eulerosv2r10"
];
