...
# extracted from Fedora Security Advisory FEDORA-2023-8c02aee138
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-8c02aee138");

  script_name(english:"Fedora 38 : gmailctl (2023-8c02aee138)");
...
FEDORA-2023-8c02aee138 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-8c02aee138");
...
var pkgs = [
    {'reference':'gmailctl-0.10.6-3.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
