...
# extracted from Fedora Security Advisory FEDORA-2025-becf280371
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-becf280371");

  script_name(english:"Fedora 40 : openssl (2025-becf280371)");
...
FEDORA-2025-becf280371 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-becf280371");
...
var pkgs = [
    {'reference':'openssl-3.2.4-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
