...
referenced in the USN-4945-2 advisory.
    ...
    USN-4945-1 fixed vulnerabilities in the Linux kernel for Ubuntu 20.04 LTS and Ubuntu 18.04 LTS. This
    update provides the corresponding Linux kernel updates targeted specifically for Raspberry Pi devices in
    those same Ubuntu Releases.
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-4945-2');
}
