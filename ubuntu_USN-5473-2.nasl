...
# extracted from Ubuntu Security Notice USN-5473-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5473-2");

  script_name(english:"Ubuntu 16.04 ESM : ca-certificates update (USN-5473-2)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5473-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'ca-certificates', 'pkgver': '20211016~16.04.1~esm1', 'ubuntu_pro': TRUE}
];
