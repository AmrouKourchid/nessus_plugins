...
if (description)
{
  ...
  script_name(english:"AIX (IJ50601)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AIX host is missing a security patch.");
  script_set_attribute(attribute:"description", value:
"The version of AIX installed on the remote host is prior to APAR IJ50601. It is, therefore, affected by a vulnerability
as referenced in the IJ50601 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/apar/IJ50601");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/node/7150641");
  script_set_attribute(attribute:"solution", value:
"Please apply the appropriate interim fix per APAR IJ50601.");
...
var constraints = [
    {'release': '4.1', 'ml': '00', 'sp': '10', 'patch': 'IJ50601s1a', 'package': 'bos.rte.control', 'minfilesetver': '7.3.2.0', 'maxfilesetver': '7.3.2.0'},
    {'release': '7.3', 'ml': '02', 'sp': '01', 'patch': 'IJ50601s1a', 'package': 'bos.rte.control', 'minfilesetver': '7.3.2.0', 'maxfilesetver': '7.3.2.0'}
];
