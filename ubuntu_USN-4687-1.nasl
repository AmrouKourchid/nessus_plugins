...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 20.04 LTS : Firefox vulnerability (USN-4687-1)");
...
referenced in the USN-4687-1 advisory.

    A use-after-free was discovered in Firefox when handling SCTP packets. An attacker could potentially
