...
# extracted from Oracle Linux Security Advisory ELSA-2020-1636.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : libsndfile (ELSA-2020-1636)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2020-1636.html");
