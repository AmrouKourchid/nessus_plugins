...
# extracted from Fedora Security Advisory FEDORA-2022-7f9021ead1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-7f9021ead1");
  script_xref(name:"IAVA", value:"2023-A-0004-S");

  script_name(english:"Fedora 36 : samba (2022-7f9021ead1)");
...
FEDORA-2022-7f9021ead1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-7f9021ead1");
...
var pkgs = [
    {'reference':'samba-4.16.8-0.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
