...
# extracted from Oracle Linux Security Advisory ELSA-2024-5309.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : python-urllib3 (ELSA-2024-5309)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-5309.html");
...
var pkgs = [
    {'reference':'python3-urllib3-1.24.2-8.el8_10', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
