...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP12 : proftpd (EulerOS-SA-2024-1771)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1771
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5dcef164");
...
var pkgs = [
  "proftpd-1.3.7c-4.h7.eulerosv2r12"
];
