...
"The remote Red Hat host is missing one or more security updates for OpenShift Container Platform 4.1 openshift.");
...
referenced in the RHSA-2019:4087 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_4087.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?be050237");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:4087");
...
"Update the RHEL OpenShift Container Platform 4.1 openshift package based on the guidance in RHSA-2019:4087.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openshift-clients-4.1.27-201912021146.git.0.a40116f.el8_0', 'cpu':'x86_64', 'release':'8', 'el_string':'el8_0', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'openshift-clients-redistributable-4.1.27-201912021146.git.0.a40116f.el8_0', 'cpu':'x86_64', 'release':'8', 'el_string':'el8_0', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'openshift-hyperkube-4.1.27-201912021146.git.0.a40116f.el8_0', 'cpu':'x86_64', 'release':'8', 'el_string':'el8_0', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'openshift-clients-4.1.27-201912021146.git.0.a40116f.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'openshift-clients-redistributable-4.1.27-201912021146.git.0.a40116f.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'openshift-hyperkube-4.1.27-201912021146.git.0.a40116f.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
