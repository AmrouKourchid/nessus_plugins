...
if (description)
{
  ...
  script_name(english:"Foxit PhantomPDF < 10.0.1 Multiple Vulnerabilities");
...
host is prior to 10.0.1. It is, therefore affected by multiple vulnerabilities: Note that Nessus has not tested for
...
"Upgrade to Foxit PhantomPDF version 10.0.1 or later");
...
var constraints = [
  { 'max_version' : '9.7.2.29539', 'fixed_version' : '10.0.1' },
  { 'min_version' : '10.0.0.35798', 'fixed_version' : '10.0.1' }
];
