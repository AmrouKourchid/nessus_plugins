...
# extracted from Fedora Security Advisory FEDORA-2019-bab3944fee.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : php (2019-bab3944fee)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-bab3944fee");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"php-7.2.18-1.fc28")) flag++;
