...
# extracted from Fedora Security Advisory FEDORA-2023-bf72d8833e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-bf72d8833e");
  script_xref(name:"IAVB", value:"2023-B-0062-S");

  script_name(english:"Fedora 38 : clamav (2023-bf72d8833e)");
...
FEDORA-2023-bf72d8833e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-bf72d8833e");
...
var pkgs = [
    {'reference':'clamav-1.0.2-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
