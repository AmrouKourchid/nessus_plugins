...
if (description)
{
  ...
  script_cve_id("CVE-2012-5630");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2012-5630");
...
patch available.
  ...
  - libuser 0.56 and 0.57 has a TOCTOU (time-of-check time-of-use) race condition when copying and removing
    directory trees. (CVE-2012-5630)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2012-5630");
