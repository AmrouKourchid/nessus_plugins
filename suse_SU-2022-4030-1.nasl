...
vulnerabilities as referenced in the SUSE-SU-2022:4030-1 advisory.
...
"Update the affected kernel-livepatch-5_3_18-150200_24_126-default, kgraft-patch-4_12_14-122_130-default and / or kgraft-
patch-4_12_14-95_105-default packages.");
...
var kernel_live_checks = [
  {
    'kernels': {
      ...
      '5.3.18-150200.24.126-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_3_18-150200_24_126-default-5-150200.2.1', 'sp':'2', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.2']},
          {'reference':'kernel-livepatch-5_3_18-150200_24_126-default-5-150200.2.1', 'sp':'2', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.2', 'sle-module-live-patching-release-15.2', 'sles-release-15.2']}
        ]
      }
    }
  }
