...
# extracted from Fedora Security Advisory FEDORA-2023-8f84dc8e09
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-8f84dc8e09");
  script_xref(name:"IAVA", value:"2023-A-0645");

  script_name(english:"Fedora 39 : webkitgtk (2023-8f84dc8e09)");
...
FEDORA-2023-8f84dc8e09 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-8f84dc8e09");
...
var pkgs = [
    {'reference':'webkitgtk-2.42.2-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
