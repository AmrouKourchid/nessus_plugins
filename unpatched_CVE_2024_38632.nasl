...
if (description)
{
  ...
  script_cve_id("CVE-2024-38632");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-38632");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: vfio/pci: fix potential memory leak in
    vfio_intx_enable() If vfio_irq_ctx_alloc() failed will lead to 'name' memory leak. (CVE-2024-38632)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-38632");
