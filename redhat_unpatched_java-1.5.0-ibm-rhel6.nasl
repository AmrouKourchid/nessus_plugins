...
# extracted from Red Hat Security Advisory java-1.5.0-ibm. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 6 : java-1.5.0-ibm (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2015-4803");
