...
# extracted from Red Hat Security Advisory RHSA-2019:4096. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:4096");

  script_name(english:"RHEL 7 : OpenShift Container Platform 4.2 openshift-external-storage (RHSA-2019:4096)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for OpenShift Container Platform 4.2 openshift-external-storage.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2019:4096 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_4096.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8f2da4e0");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:4096");
...
"Update the RHEL OpenShift Container Platform 4.2 openshift-external-storage package based on the guidance in
RHSA-2019:4096.");
