...
# extracted from Fedora Security Advisory FEDORA-2022-1a5b125ac6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-1a5b125ac6");

  script_name(english:"Fedora 37 : kernel (2022-1a5b125ac6)");
...
FEDORA-2022-1a5b125ac6 advisory.

    The 101/201/301 builds of the 5.19.15 kernel contain fixes for some wireless network vulnerabilities and a
    couple of important arm bug fixes.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-1a5b125ac6");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for FEDORA-2022-1a5b125ac6');
  }
  else
  {
...
var pkgs = [
    {'reference':'kernel-5.19.15-301.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
