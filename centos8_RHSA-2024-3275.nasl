...
# Red Hat Security Advisory RHSA-2024:3275. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : python-dns (CESA-2024:3275)");
...
var pkgs = [
    {'reference':'python3-dns-1.15.0-12.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
