...
# extracted from Red Hat Security Advisory RHSA-2021:2740. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_2740.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f67a48c7");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:2740");
...
"Update the RHEL firefox package based on the guidance in RHSA-2021:2740.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-78.12.0-1.el8_1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
