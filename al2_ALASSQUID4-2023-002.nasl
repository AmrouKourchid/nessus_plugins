...
# extracted from Amazon Linux 2 Security Advisory ALASSQUID4-2023-002.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : squid (ALASSQUID4-2023-002)");
...
referenced in the ALAS2SQUID4-2023-002 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALASSQUID4-2023-002.html");
...
"Run 'yum update squid' to update your system.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-41317");
