...
# extracted from Red Hat Security Advisory RHSA-2024:0588. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:0588");

  script_name(english:"RHEL 8 : python-urllib3 (RHSA-2024:0588)");
...
referenced in the RHSA-2024:0588 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0588.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?297eaebb");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0588");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-urllib3 package based on the guidance in RHSA-2024:0588.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-urllib3-1.24.2-5.el8_8.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
