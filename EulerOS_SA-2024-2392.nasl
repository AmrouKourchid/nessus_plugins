...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : gtk2 (EulerOS-SA-2024-2392)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2392
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?68e27ece");
...
var pkgs = [
  "gtk2-2.24.32-7.h2.eulerosv2r9",
  "gtk2-devel-2.24.32-7.h2.eulerosv2r9",
  "gtk2-help-2.24.32-7.h2.eulerosv2r9"
];
