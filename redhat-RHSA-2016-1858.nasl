...
# extracted from Red Hat Security Advisory RHSA-2016:1858. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2016:1858");

  script_name(english:"RHEL 6 / 7 : ruby193-rubygem-actionpack (RHSA-2016:1858)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for ruby193-rubygem-actionpack.");
...
in the RHSA-2016:1858 advisory.

    Ruby on Rails is a model-view-controller (MVC) framework for web application development. Action Pack
    implements the controller and the view components.

    Security Fix(es):

    * It was discovered that Action View tag helpers did not escape quotes when using strings declared as HTML
    safe as attribute values. A remote attacker could use this flaw to conduct a cross-site scripting (XSS)
    attack. (CVE-2016-6316)
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1365008");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2016/rhsa-2016_1858.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cc84e50a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2016:1858");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL ruby193-rubygem-actionpack package based on the guidance in RHSA-2016:1858.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:N/I:P/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:R/S:C/C:L/I:L/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-6316");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ruby193-rubygem-actionpack-3.2.8-20.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'ruby193-rubygem-actionpack-doc-3.2.8-20.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'ruby193-rubygem-actionpack-3.2.8-20.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'ruby193-rubygem-actionpack-doc-3.2.8-20.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
