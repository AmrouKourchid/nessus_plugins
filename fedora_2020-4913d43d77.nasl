...
# extracted from Fedora Security Advisory FEDORA-2020-4913d43d77.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-4913d43d77");

  script_name(english:"Fedora 31 : jetty (2020-4913d43d77)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-4913d43d77");
...
"Update the affected jetty package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-17632");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"jetty-9.4.24-2.v20191120.fc31")) flag++;
