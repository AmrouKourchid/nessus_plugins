...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : expat (EulerOS-SA-2023-2422)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2422
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?eb8bcc66");
...
var pkgs = [
  "expat-2.1.0-10.h13.eulerosv2r7",
  "expat-devel-2.1.0-10.h13.eulerosv2r7",
  "expat-static-2.1.0-10.h13.eulerosv2r7"
];
