...
# Rocky Linux Security Advisory RLSA-2023:5997.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2023:5997");

  script_name(english:"Rocky Linux 8 : python3 (RLSA-2023:5997)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Rocky Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Rocky Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
RLSA-2023:5997 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2023:5997");
...
var pkgs = [
    {'reference':'platform-python-3.6.8-51.el8_8.2.rocky.0', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'platform-python-debug-3.6.8-51.el8_8.2.rocky.0', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'platform-python-devel-3.6.8-51.el8_8.2.rocky.0', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-debuginfo-3.6.8-51.el8_8.2.rocky.0', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-debugsource-3.6.8-51.el8_8.2.rocky.0', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-idle-3.6.8-51.el8_8.2.rocky.0', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-libs-3.6.8-51.el8_8.2.rocky.0', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-test-3.6.8-51.el8_8.2.rocky.0', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-tkinter-3.6.8-51.el8_8.2.rocky.0', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
