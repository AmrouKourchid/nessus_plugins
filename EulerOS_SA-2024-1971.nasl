...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : python-jinja2 (EulerOS-SA-2024-1971)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1971
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b6d80951");
...
var pkgs = [
  "python3-jinja2-2.10-10.h3.eulerosv2r9"
];
