...
# extracted from Fedora Security Advisory FEDORA-2024-fae88b73eb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-fae88b73eb");
  script_xref(name:"IAVA", value:"2024-A-0103-S");

  script_name(english:"Fedora 38 : bind / bind-dyndb-ldap (2024-fae88b73eb)");
...
FEDORA-2024-fae88b73eb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-fae88b73eb");
...
var pkgs = [
    {'reference':'bind-9.18.24-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
    {'reference':'bind-dyndb-ldap-11.10-23.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
