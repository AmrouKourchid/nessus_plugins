...
# extracted from Red Hat Security Advisory RHSA-2023:7714. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 8 : postgresql:12 (RHSA-2023:7714)");
...
referenced in the RHSA-2023:7714 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_7714.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8c5aec3f");
...
"Update the RHEL postgresql:12 package based on the guidance in RHSA-2023:7714.");
  ...
  'postgresql:12': [
    {
      ...
      'pkgs': [
        ...
        {'reference':'pgaudit-1.4.0-5.module+el8.9.0+19330+c97ddbdf', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgres-decoderbufs-0.10.0-2.module+el8.9.0+19330+c97ddbdf', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-12.17-1.module+el8.9.0+20789+410e66ce', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-contrib-12.17-1.module+el8.9.0+20789+410e66ce', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-docs-12.17-1.module+el8.9.0+20789+410e66ce', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plperl-12.17-1.module+el8.9.0+20789+410e66ce', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plpython3-12.17-1.module+el8.9.0+20789+410e66ce', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-pltcl-12.17-1.module+el8.9.0+20789+410e66ce', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-12.17-1.module+el8.9.0+20789+410e66ce', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-devel-12.17-1.module+el8.9.0+20789+410e66ce', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-static-12.17-1.module+el8.9.0+20789+410e66ce', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-12.17-1.module+el8.9.0+20789+410e66ce', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-rpm-macros-12.17-1.module+el8.9.0+20789+410e66ce', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-upgrade-12.17-1.module+el8.9.0+20789+410e66ce', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-upgrade-devel-12.17-1.module+el8.9.0+20789+410e66ce', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
