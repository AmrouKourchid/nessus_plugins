...
if (description)
{
  ...
  script_name(english:"CentOS 7 : ksh (RHSA-2020:0568)");
...
var pkgs = [
    {'reference':'ksh-20120801-140.el7_7', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ksh-20120801-140.el7_7', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE}
];
