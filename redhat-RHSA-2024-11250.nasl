...
# extracted from Red Hat Security Advisory RHSA-2024:11250. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:11250");

  script_name(english:"RHEL 9 : pam (RHSA-2024:11250)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_11250.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3a4c205b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:11250");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL pam package based on the guidance in RHSA-2024:11250.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'pam-1.5.1-21.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pam-devel-1.5.1-21.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pam-docs-1.5.1-21.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
