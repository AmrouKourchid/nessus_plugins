...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : avahi (EulerOS-SA-2023-2632)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2632
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7415c58c");
...
var pkgs = [
  "avahi-libs-0.8-12.h3.eulerosv2r11"
];
