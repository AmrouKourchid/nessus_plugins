...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"RHSA-2020:5239");

  script_name(english:"Scientific Linux Security Update : firefox on SL7.x x86_64 (2020:5239)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Scientific Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Scientific Linux 7 host has a package installed that is affected by multiple vulnerabilities as referenced in
the SLSA-2020:5239-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.scientificlinux.org/category/sl-errata/slsa-20205239-1");
...
pkgs = [
    {'reference':'firefox-78.5.0-1.el7_9', 'cpu':'x86_64', 'release':'SL7', 'allowmaj':TRUE}
];
