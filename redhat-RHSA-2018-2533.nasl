...
# extracted from Red Hat Security Advisory RHSA-2018:2533. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:2533");

  script_name(english:"RHEL 7 : openstack-keystone (RHSA-2018:2533)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for openstack-keystone.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2018:2533 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2018/rhsa-2018_2533.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2c0d94b6");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1606868");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:2533");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL openstack-keystone package based on the guidance in RHSA-2018:2533.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openstack-keystone-13.0.1-1.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'},
      {'reference':'python-keystone-13.0.1-1.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'}
    ]
  }
];
