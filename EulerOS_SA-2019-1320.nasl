...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : mod_auth_mellon (EulerOS-SA-2019-1320)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1320
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f80fd96a");
...
pkgs = ["mod_auth_mellon-0.11.0-1.h1"];
