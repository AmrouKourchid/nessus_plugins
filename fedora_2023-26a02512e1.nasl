...
# extracted from Fedora Security Advisory FEDORA-2023-26a02512e1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-26a02512e1");

  script_name(english:"Fedora 38 : bluez (2023-26a02512e1)");
...
FEDORA-2023-26a02512e1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-26a02512e1");
...
var pkgs = [
    {'reference':'bluez-5.70-5.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
