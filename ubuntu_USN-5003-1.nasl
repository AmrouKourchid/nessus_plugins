...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 ESM / 18.04 LTS : Linux kernel vulnerabilities (USN-5003-1)");
...
referenced in the USN-5003-1 advisory.
    ...
    It was discovered that the eBPF implementation in the Linux kernel did not properly track bounds
    information for 32 bit registers when performing div and mod operations. A local attacker could use this
    to possibly execute arbitrary code. (CVE-2021-3600)
...
var kernel_mappings = {
  ...
  '18.04': {
    '4.15.0': {
      'generic': '4.15.0-147',
      'generic-lpae': '4.15.0-147',
      'lowlatency': '4.15.0-147',
      'dell300x': '4.15.0-1022',
      'oracle': '4.15.0-1075',
      'raspi2': '4.15.0-1089',
      'gcp': '4.15.0-1103',
      'snapdragon': '4.15.0-1106',
      'azure': '4.15.0-1118'
    }
  }
};
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-5003-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2021-3600', 'CVE-2021-3609', 'CVE-2021-23133');
