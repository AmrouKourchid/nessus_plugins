...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Libevent PHSA-2023-3.0-0568");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libevent-2.1.12-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libevent-devel-2.1.12-1.ph3')) flag++;
