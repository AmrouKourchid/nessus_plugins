...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : java-1.8.0-openjdk (EulerOS-SA-2023-1319)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1319
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?449566cd");
...
var pkgs = [
  "java-1.8.0-openjdk-1.8.0.181.b15-5.h30.eulerosv2r8",
  "java-1.8.0-openjdk-devel-1.8.0.181.b15-5.h30.eulerosv2r8",
  "java-1.8.0-openjdk-headless-1.8.0.181.b15-5.h30.eulerosv2r8"
];
