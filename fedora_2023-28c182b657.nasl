...
# extracted from Fedora Security Advisory FEDORA-2023-28c182b657
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-28c182b657");

  script_name(english:"Fedora 37 : skopeo (2023-28c182b657)");
...
FEDORA-2023-28c182b657 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-28c182b657");
...
var pkgs = [
    {'reference':'skopeo-1.11.2-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
