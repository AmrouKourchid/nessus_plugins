...
# Security Advisory OVMSA-2018-0030.
#
...
if (description)
{
  ...
  script_name(english:"OracleVM 3.4 : libvorbis (OVMSA-2018-0030)");
...
critical security updates :
  ...
  # https://oss.oracle.com/pipermail/oraclevm-errata/2018-April/000840.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d2e442b4");
...
"Update the affected libvorbis package.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2018-5146");
...
flag = 0;
if (rpm_check(release:"OVS3.4", reference:"libvorbis-1.2.3-5.el6_9.1")) flag++;
