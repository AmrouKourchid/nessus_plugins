...
# extracted from Oracle Linux Security Advisory ELSA-2021-2658.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : linuxptp (ELSA-2021-2658)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2021-2658.html");
...
var pkgs = [
    {'reference':'linuxptp-2.0-2.el7_9.1', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
