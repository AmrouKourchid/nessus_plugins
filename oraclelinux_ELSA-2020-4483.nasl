...
# extracted from Oracle Linux Security Advisory ELSA-2020-4483.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : opensc (ELSA-2020-4483)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2020-4483.html");
...
var pkgs = [
    {'reference':'opensc-0.20.0-2.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
