...
# extracted from Red Hat Security Advisory RHSA-2020:2971. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:2971");

  script_name(english:"RHEL 8 : jbig2dec (RHSA-2020:2971)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_2971.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ad1193ec");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:2971");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1848518");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL jbig2dec package based on the guidance in RHSA-2020:2971.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jbig2dec-libs-0.14-4.el8_1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
