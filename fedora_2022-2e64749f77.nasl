...
# extracted from Fedora Security Advisory FEDORA-2022-2e64749f77
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-2e64749f77");

  script_name(english:"Fedora 37 : openscad (2022-2e64749f77)");
...
FEDORA-2022-2e64749f77 advisory.
    ...
    ```
    * Tue Apr  5 2022 Lumr Balhar <lbalhar@redhat.com> - 2021.01-8
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-2e64749f77");
...
"Update the affected openscad package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-0497");
...
var pkgs = [
    {'reference':'openscad-2021.01-8.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
