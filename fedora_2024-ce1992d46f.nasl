...
# extracted from Fedora Security Advisory FEDORA-2024-ce1992d46f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-ce1992d46f");

  script_name(english:"Fedora 39 : python3-docs / python3.12 (2024-ce1992d46f)");
...
FEDORA-2024-ce1992d46f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-ce1992d46f");
...
var pkgs = [
    {'reference':'python3-docs-3.12.5-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3.12-3.12.5-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
