...
# extracted from Red Hat Security Advisory RHSA-2018:2403. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:2403");

  script_name(english:"RHEL 7 : redhat-virtualization-host (RHSA-2018:2403)");
...
referenced in the RHSA-2018:2403 advisory.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_2403.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0a034ca4");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1614067");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:2403");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL redhat-virtualization-host package based on the guidance in RHSA-2018:2403.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'redhat-release-virtualization-host-4.2-5.2.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'},
      {'reference':'redhat-virtualization-host-image-update-4.2-20180813.0.el7_5', 'release':'7', 'el_string':'el7_5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'},
      {'reference':'redhat-virtualization-host-image-update-placeholder-4.2-5.2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'}
    ]
  }
];
