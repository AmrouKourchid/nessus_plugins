...
# extracted from VMware Security Advisory PHSA-2020-3.0-0051. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Dnsmasq PHSA-2020-3.0-0051");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the dnsmasq package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-3.0-51.md");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'dnsmasq-2.79-3.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'dnsmasq-utils-2.79-3.ph3')) flag++;
