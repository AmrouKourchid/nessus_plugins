...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Mercurial PHSA-2019-1.0-0235");
...
if (rpm_check(release:"PhotonOS-1.0", reference:"mercurial-4.5.3-3.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"mercurial-debuginfo-4.5.3-3.ph1")) flag++;
