...
if (description)
{
  ...
  script_name(english:"Chef Infra Client SEoL (17.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Chef Infra Client is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Chef Infra Client is 17.x. It is, therefore, no longer maintained by its
vendor or provider.
...
"Upgrade to a version of Chef Infra Client that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2024/11/30");
