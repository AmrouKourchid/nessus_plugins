...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : libidn (EulerOS-SA-2019-1851)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1851
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?45dc977f");
...
"Update the affected libidn package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-6261");
