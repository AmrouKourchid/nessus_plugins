...
ELSA-2014-0771 advisory.
    ...
    {CVE-2014-0203}
    - [char] n_tty: Fix n_tty_write crash when echoing in raw mode (Aristeu Rozanski) [1094236 1094237]
    {CVE-2014-0196}
    - [security] selinux: Fix kernel BUG on empty security contexts (Paul Moore) [1062502 1064545]
    {CVE-2014-1874}
    - [netdrv] libertas: potential oops in debugfs (Denys Vlasenko) [1034176 1034177] {CVE-2013-6378}
    - [s390] fix kernel crash due to linkage stack instructions (Hendrik Brueckner) [1067678 1067679]
    {CVE-2014-2039}
...
var pkgs = [
    ...
    {'reference':'kernel-abi-whitelists-2.6.32-431.20.3.el6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-abi-whitelists-2.6.32'},
    ...
    {'reference':'kernel-firmware-2.6.32-431.20.3.el6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-firmware-2.6.32'},
    ...
    {'reference':'kernel-abi-whitelists-2.6.32-431.20.3.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-abi-whitelists-2.6.32'},
    ...
    {'reference':'kernel-firmware-2.6.32-431.20.3.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-firmware-2.6.32'},
