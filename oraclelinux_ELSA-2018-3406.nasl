...
# extracted from Red Hat Security Advisory RHSA-2018:3406 and 
# Oracle Linux Security Advisory ELSA-2018-3406 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : python-paramiko (ELSA-2018-3406)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2018-3406.html");
...
var pkgs = [
    {'reference':'python-paramiko-1.7.5-5.el6_10', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
];
