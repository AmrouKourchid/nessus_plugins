...
if (description)
{
  ...
  script_cve_id("CVE-2018-12404", "CVE-2018-18508", "CVE-2020-12413");

  script_name(english:"RHEL 8 : nss (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2020-12413");
