...
if (description)
{
  ...
  script_cve_id("CVE-2023-50447", "CVE-2024-28219");

  script_name(english:"EulerOS 2.0 SP8 : python-pillow (EulerOS-SA-2024-2050)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2050
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c05e4931");
...
var pkgs = [
  "python2-pillow-5.3.0-1.h17.eulerosv2r8",
  "python3-pillow-5.3.0-1.h17.eulerosv2r8"
];
