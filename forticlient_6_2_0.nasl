...
if (description)
{
  ...
  script_name(english:"Fortinet FortiClient < 6.2.0 Information Disclosure MitM (FG-IR-18-100)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by an information disclosure vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote host is running a version of Fortinet FortiClient prior to 6.2.0. It is, therefore, affected by an
...
var constraints = [
  {'min_version' : '0.0', 'fixed_version' : '6.2.0'}
];
