...
# extracted from Red Hat Security Advisory RHSA-2021:3944. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:3944");

  script_name(english:"RHEL 8 : redis:5 (RHSA-2021:3944)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for redis:5.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2021:3944 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_3944.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2c0b08ca");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:3944");
...
"Update the RHEL redis:5 package based on the guidance in RHSA-2021:3944.");
  ...
  'redis:5': [
    {
      ...
      'pkgs': [
        {'reference':'redis-5.0.3-5.module+el8.2.0+12926+485b5fc9', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'redis-devel-5.0.3-5.module+el8.2.0+12926+485b5fc9', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'redis-doc-5.0.3-5.module+el8.2.0+12926+485b5fc9', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
