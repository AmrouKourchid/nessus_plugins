...
# extracted from Fedora Security Advisory FEDORA-2024-ae653fb07b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-ae653fb07b");

  script_name(english:"Fedora 38 : golang-x-mod (2024-ae653fb07b)");
...
FEDORA-2024-ae653fb07b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-ae653fb07b");
  script_set_attribute(attribute:"solution", value:
"Update the affected golang-x-mod package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:golang-x-mod");
...
var pkgs = [
    {'reference':'golang-x-mod-0.14.0-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'golang-x-mod');
}
