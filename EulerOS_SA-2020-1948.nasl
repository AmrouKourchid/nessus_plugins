...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.2.0 : PyYAML (EulerOS-SA-2020-1948)");
...
affected by the following vulnerabilities :
  ...
  - A vulnerability was discovered in the PyYAML library in
    versions before 5.3.1, where it is susceptible to
    ...
    An attacker could use this flaw to execute arbitrary
    code on the system by abusing the python/object/new
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1948
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c856b7cf");
