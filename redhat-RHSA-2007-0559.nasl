...
"The remote Red Hat host is missing a security update for cman.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2007/rhsa-2007_0559.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fd71b741");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=244891");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2007:0559");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL cman package based on the guidance in RHSA-2007:0559.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cman-2.0.64-1.0.1.el5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'cman-2.0.64-1.0.1.el5', 'cpu':'ppc', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'cman-2.0.64-1.0.1.el5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'cman-devel-2.0.64-1.0.1.el5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'cman-devel-2.0.64-1.0.1.el5', 'cpu':'ppc', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'cman-devel-2.0.64-1.0.1.el5', 'cpu':'ppc64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'cman-devel-2.0.64-1.0.1.el5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
