...
if (description)
{
  ...
  script_xref(name:"APPLE-SA", value:"121570");
  script_xref(name:"IAVA", value:"2024-A-0793-S");

  script_name(english:"macOS 14.x < 14.7.1 Multiple Vulnerabilities (121570)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host is missing a macOS update that fixes multiple vulnerabilities");
  script_set_attribute(attribute:"description", value:
"The remote host is running a version of macOS / Mac OS X that is 14.x prior to 14.7.1. It is, therefore, affected by
multiple vulnerabilities:
  ...
  - The issue was addressed with improved checks. This issue is fixed in macOS Ventura 13.7.1, macOS Sequoia
    15, macOS Sonoma 14.7.1. An attacker with physical access may be able to share items from the lock screen.
    (CVE-2024-44137)

Note that Nessus has not tested for these issues but has instead relied only on the operating system's self-reported
version number.");
  script_set_attribute(attribute:"see_also", value:"https://support.apple.com/en-us/121570");
  script_set_attribute(attribute:"solution", value:
"Upgrade to macOS 14.7.1 or later.");
...
var constraints = [
  { 'fixed_version' : '14.7.1', 'min_version' : '14.0', 'fixed_display' : 'macOS Sonoma 14.7.1' }
];
