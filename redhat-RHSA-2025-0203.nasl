...
# extracted from Red Hat Security Advisory RHSA-2025:0203. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:0203");

  script_name(english:"RHEL 8 : Red Hat OpenStack Platform 16.2 (etcd) (RHSA-2025:0203)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for Red Hat OpenStack Platform 16.2 (etcd).");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_0203.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d1120db6");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:0203");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat OpenStack Platform 16.2 (etcd) package based on the guidance in RHSA-2025:0203.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'etcd-3.3.23-17.el8ost', 'cpu':'ppc64le', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'etcd-3.3.23-17.el8ost', 'cpu':'x86_64', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
