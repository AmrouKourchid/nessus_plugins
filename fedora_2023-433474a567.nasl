...
# extracted from Fedora Security Advisory FEDORA-2023-433474a567
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-433474a567");

  script_name(english:"Fedora 38 : java-17-openjdk (2023-433474a567)");
...
FEDORA-2023-433474a567 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-433474a567");
...
var pkgs = [
    {'reference':'java-17-openjdk-17.0.9.0.9-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
