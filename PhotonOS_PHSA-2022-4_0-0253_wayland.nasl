...
# extracted from VMware Security Advisory PHSA-2022-4.0-0253. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Wayland PHSA-2022-4.0-0253");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the wayland package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-253.md");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:vmware:photonos:wayland");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'wayland-1.20.0-3.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'wayland-devel-1.20.0-3.ph4')) flag++;
