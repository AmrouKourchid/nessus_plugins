...
all clients of the virtual server.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K52035247");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K52035247.");
...
var vmatrix = {
  'DNS': {
    'affected': [
      '16.0.0','15.0.0-15.1.1','14.1.0-14.1.3','13.1.0-13.1.3','12.1.0-12.1.5','11.6.1-11.6.5'
    ],
    'unaffected': [
      '16.0.1','15.1.2','14.1.3.1','13.1.3.6','12.1.5.3','11.6.5.3'
    ],
  },
  'GTM': {
    'affected': [
