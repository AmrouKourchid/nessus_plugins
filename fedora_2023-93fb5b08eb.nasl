...
# extracted from Fedora Security Advisory FEDORA-2023-93fb5b08eb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-93fb5b08eb");
  script_xref(name:"IAVB", value:"2023-B-0016-S");
  script_xref(name:"IAVB", value:"2023-B-0018-S");

  script_name(english:"Fedora 36 : vim (2023-93fb5b08eb)");
...
FEDORA-2023-93fb5b08eb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-93fb5b08eb");
...
var pkgs = [
    {'reference':'vim-9.0.1307-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
