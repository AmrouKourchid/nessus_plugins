...
# extracted from Fedora Security Advisory FEDORA-2020-ef1870065a.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 33 : 1:openssl (2020-ef1870065a)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"New upstream release 1.1.1i with important security fix for possible
server DoS issue.
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-ef1870065a");
...
flag = 0;
if (rpm_check(release:"FC33", reference:"openssl-1.1.1i-1.fc33", epoch:"1")) flag++;
