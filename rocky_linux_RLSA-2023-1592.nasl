...
# Rocky Linux Security Advisory RLSA-2023:1592.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2023:1592");

  script_name(english:"Rocky Linux 9 : tigervnc (RLSA-2023:1592)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2023:1592");
...
var pkgs = [
    ...
    {'reference':'tigervnc-debuginfo-1.12.0-5.el9_1.2', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tigervnc-debugsource-1.12.0-5.el9_1.2', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tigervnc-icons-1.12.0-5.el9_1.2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tigervnc-license-1.12.0-5.el9_1.2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tigervnc-selinux-1.12.0-5.el9_1.2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tigervnc-server-1.12.0-5.el9_1.2', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tigervnc-server-debuginfo-1.12.0-5.el9_1.2', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tigervnc-server-minimal-1.12.0-5.el9_1.2', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tigervnc-server-minimal-debuginfo-1.12.0-5.el9_1.2', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tigervnc-server-module-1.12.0-5.el9_1.2', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tigervnc-server-module-debuginfo-1.12.0-5.el9_1.2', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
