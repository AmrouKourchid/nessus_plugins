...
# extracted from Fedora Security Advisory FEDORA-2024-7427eaacd8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-7427eaacd8");

  script_name(english:"Fedora 39 : mingw-expat (2024-7427eaacd8)");
...
FEDORA-2024-7427eaacd8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-7427eaacd8");
...
var pkgs = [
    {'reference':'mingw-expat-2.6.3-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
