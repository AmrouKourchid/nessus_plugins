...
# extracted from Red Hat Security Advisory RHSA-2025:1019. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:1019");

  script_name(english:"RHEL 8 / 9 : Satellite 6.16.2 Async Update (Moderate) (RHSA-2025:1019)");
...
in the RHSA-2025:1019 advisory.
    ...
    * python-grpcio: Denial of Service through Data corruption in gRPC-C++ (CVE-2024-11407)
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/SAT-30266");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/SAT-30284");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/SAT-30286");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/SAT-30287");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/SAT-30288");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/SAT-30291");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/SAT-30292");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/SAT-30295");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/SAT-30296");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/SAT-30297");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/SAT-30298");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_1019.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?efef92e2");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:1019");
  script_set_attribute(attribute:"solution", value:
"Update the affected python3.11-grpcio package.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3.11-grpcio-1.68.1-1.el8pc', 'cpu':'x86_64', 'release':'8', 'el_string':'el8pc', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'satellite-6'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'python3.11-grpcio-1.68.1-1.el9pc', 'cpu':'x86_64', 'release':'9', 'el_string':'el9pc', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'satellite-6'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python3.11-grpcio');
}
