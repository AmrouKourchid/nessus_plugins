...
if (description)
{
  ...
  script_cve_id("CVE-2024-27017");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-27017");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: netfilter: nft_set_pipapo: walk over
    ...
    Add notation to specify if user wants to read/update the set. Based on patch from Florian Westphal.
    (CVE-2024-27017)
