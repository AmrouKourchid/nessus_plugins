...
# extracted from Ubuntu Security Notice USN-2319-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : OpenJDK 7 vulnerabilities (USN-2319-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 14.04 LTS host has packages installed that are affected by multiple vulnerabilities as referenced in
the USN-2319-1 advisory.
    ...
    sensitive data over the network. (CVE-2014-2483, CVE-2014-2490, CVE-2014-4216, CVE-2014-4219,
    CVE-2014-4223, CVE-2014-4262)

    Several vulnerabilities were discovered in the OpenJDK JRE related to information disclosure and data
    integrity. An attacker could exploit these to expose sensitive data over the network. (CVE-2014-4209,
    CVE-2014-4244, CVE-2014-4263)

    Two vulnerabilities were discovered in the OpenJDK JRE related to data integrity. (CVE-2014-4218,
    CVE-2014-4266)

    A vulnerability was discovered in the OpenJDK JRE related to availability. An attacker could exploit this
    to cause a denial of service. (CVE-2014-4264)

    Several vulnerabilities were discovered in the OpenJDK JRE related to information disclosure. An attacker
    could exploit these to expose sensitive data over the network. (CVE-2014-4221, CVE-2014-4252,
    CVE-2014-4268)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2319-1");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2014-4268");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'icedtea-7-jre-jamvm', 'pkgver': '7u65-2.5.1-4ubuntu1~0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'openjdk-7-demo', 'pkgver': '7u65-2.5.1-4ubuntu1~0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'openjdk-7-jdk', 'pkgver': '7u65-2.5.1-4ubuntu1~0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'openjdk-7-jre', 'pkgver': '7u65-2.5.1-4ubuntu1~0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'openjdk-7-jre-headless', 'pkgver': '7u65-2.5.1-4ubuntu1~0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'openjdk-7-jre-lib', 'pkgver': '7u65-2.5.1-4ubuntu1~0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'openjdk-7-jre-zero', 'pkgver': '7u65-2.5.1-4ubuntu1~0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'openjdk-7-source', 'pkgver': '7u65-2.5.1-4ubuntu1~0.14.04.1'}
];
