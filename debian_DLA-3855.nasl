...
# extracted from Debian Security Advisory dla-3855. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3855 : pdns-recursor - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2020-14196");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2020-25829");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/pdns-recursor");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'pdns-recursor', 'reference': '4.1.11-1+deb10u2'}
];
