...
"The remote Red Hat host is missing a security update for jboss-seam2.");
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2013/rhsa-2013_1044.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?abc3ba4d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2013:1044");
...
"Update the RHEL jboss-seam2 package based on the guidance in RHSA-2013:1044.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jboss-seam2-2.0.2.FP_SEC1-1.ep2.6.el5', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap4'},
      {'reference':'jboss-seam2-docs-2.0.2.FP_SEC1-1.ep2.6.el5', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap4'}
    ]
  }
];
