...
# extracted from Debian Security Advisory dla-3957. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3957 : needrestart - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-11003");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-48990");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-48991");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-48992");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'needrestart', 'reference': '3.5-4+deb11u4'}
];
