...
# extracted from Fedora Security Advisory FEDORA-2022-df4ffc6551
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-df4ffc6551");

  script_name(english:"Fedora 36 : thunderbird (2022-df4ffc6551)");
...
FEDORA-2022-df4ffc6551 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-df4ffc6551");
...
var pkgs = [
    {'reference':'thunderbird-102.3.1-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
