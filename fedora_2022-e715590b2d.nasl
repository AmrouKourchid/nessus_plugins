...
# extracted from Fedora Security Advisory FEDORA-2022-e715590b2d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-e715590b2d");

  script_name(english:"Fedora 37 : graphviz (2022-e715590b2d)");
...
FEDORA-2022-e715590b2d advisory.
    ...
    ```
    * Tue Jul 12 2022 Jaroslav karvada <jskarvad@redhat.com> - 5.0.0-1
    - New version
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-e715590b2d");
...
var pkgs = [
    {'reference':'graphviz-5.0.0-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
