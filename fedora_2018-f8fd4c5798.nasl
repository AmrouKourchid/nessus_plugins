...
# extracted from Fedora Security Advisory FEDORA-2018-f8fd4c5798.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : 3:mailman (2018-f8fd4c5798)");
...
Add fix for CVE-2018-0618 (#1596460)

Note that Tenable Network Security has extracted the preceding
description block directly from the Fedora update system website.
Tenable has attempted to automatically clean and format it as much as
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-f8fd4c5798");
  script_set_attribute(attribute:"solution", value:
"Update the affected 3:mailman package.");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"mailman-2.1.26-4.fc28", epoch:"3")) flag++;
