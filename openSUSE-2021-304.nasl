...
# extracted from openSUSE Security Update openSUSE-2021-304.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : screen (openSUSE-2021-304)");
...
"This update for screen fixes the following issues :
  ...
  - CVE-2021-26937: Fixed double width combining char
    handling that could lead to a denial of service or code
    execution (bsc#1182092).

This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1182092");
...
if ( rpm_check(release:"SUSE15.2", reference:"screen-4.6.2-lp152.6.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"screen-debuginfo-4.6.2-lp152.6.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"screen-debugsource-4.6.2-lp152.6.3.1") ) flag++;
