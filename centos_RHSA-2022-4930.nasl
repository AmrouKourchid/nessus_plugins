...
# extracted from Red Hat Security Advisory RHSA-2022:4930 and
# CentOS Errata and Security Advisory 2022:4930 respectively.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : python-twisted-web (RHSA-2022:4930)");
...
var pkgs = [
    {'reference':'python-twisted-web-12.1.0-8.el7_9', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python-twisted-web-12.1.0-8.el7_9', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE}
];
