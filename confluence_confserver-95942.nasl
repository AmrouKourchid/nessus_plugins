...
if (description)
{
  ...
  script_cve_id("CVE-2024-22243");
  script_xref(name:"IAVA", value:"2024-A-0366");
  script_xref(name:"IAVA", value:"2024-A-0449-S");

  script_name(english:"Atlassian Confluence 1.0.1 < 7.19.23 / 7.20.x < 8.5.9 / 8.6.x < 8.9.1 (CONFSERVER-95942)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://jira.atlassian.com/browse/CONFSERVER-95942");
...
"Upgrade to Atlassian Confluence version 7.19.23, 8.5.9, 8.9.1 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-22243");
