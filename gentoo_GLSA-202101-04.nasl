...
# extracted from Gentoo Linux Security Advisory GLSA 202101-04.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202101-04");
  script_xref(name:"IAVA", value:"2021-A-0005-S");

  script_name(english:"GLSA-202101-04 : Mozilla Firefox: Remote code execution");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202101-04
(Mozilla Firefox: Remote code execution)

    A use-after-free bug was discovered in Mozilla Firefox&rsquo;s handling of
      SCTP.
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202101-04");
...
if (qpkg_check(package:"www-client/firefox", unaffected:make_list("ge 78.6.1", "ge 84.0.2"), vulnerable:make_list("lt 84.0.2"))) flag++;
if (qpkg_check(package:"www-client/firefox-bin", unaffected:make_list("ge 78.6.1", "ge 84.0.2"), vulnerable:make_list("lt 84.0.2"))) flag++;
