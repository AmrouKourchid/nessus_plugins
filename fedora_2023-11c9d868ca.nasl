...
# extracted from Fedora Security Advisory FEDORA-2023-11c9d868ca
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-11c9d868ca");
  script_xref(name:"IAVA", value:"2023-A-0121-S");

  script_name(english:"Fedora 38 : sudo (2023-11c9d868ca)");
...
FEDORA-2023-11c9d868ca advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-11c9d868ca");
...
var pkgs = [
    {'reference':'sudo-1.9.13-1.p2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
