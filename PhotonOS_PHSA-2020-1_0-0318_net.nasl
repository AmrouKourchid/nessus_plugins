...
# extracted from VMware Security Advisory PHSA-2020-1.0-0318. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Net PHSA-2020-1.0-0318");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the net package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-1.0-318.md");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'net-snmp-5.7.3-11.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'net-snmp-devel-5.7.3-11.ph1')) flag++;
