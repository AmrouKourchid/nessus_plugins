...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : freeradius (EulerOS-SA-2019-1574)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1574
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?64009503");
...
pkgs = ["freeradius-3.0.13-8.h1.eulerosv2r7"];
