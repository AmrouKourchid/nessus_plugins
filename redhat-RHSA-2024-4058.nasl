...
# extracted from Red Hat Security Advisory RHSA-2024:4058. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:4058");

  script_name(english:"RHEL 8 : python3.11 (RHSA-2024:4058)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for python3.11.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:4058 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_4058.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8d5221d8");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:4058");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python3.11 package based on the guidance in RHSA-2024:4058.");
