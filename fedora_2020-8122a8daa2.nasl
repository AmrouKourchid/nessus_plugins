...
# extracted from Fedora Security Advisory FEDORA-2020-8122a8daa2.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : mod_http2 (2020-8122a8daa2)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-8122a8daa2");
...
flag = 0;
if (rpm_check(release:"FC32", reference:"mod_http2-1.15.14-1.fc32")) flag++;
