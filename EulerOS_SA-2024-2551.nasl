...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : docker-engine (EulerOS-SA-2024-2551)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2551
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?655a17f3");
...
var pkgs = [
  "docker-engine-18.09.0-300.h56.47.43.eulerosv2r11",
  "docker-engine-selinux-18.09.0-300.h56.47.43.eulerosv2r11"
];
