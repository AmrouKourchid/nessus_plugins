...
# extracted from openSUSE Security Update openSUSE-2018-709.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : unzip (openSUSE-2018-709)");
...
total_disks field to 0 but per standard, valid values are 1 and
higher) (bnc#910683)

This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1080074");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=910683");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=914442");
...
if ( rpm_check(release:"SUSE15.0", reference:"unzip-6.00-lp150.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"unzip-debuginfo-6.00-lp150.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"unzip-debugsource-6.00-lp150.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"unzip-rcc-6.00-lp150.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"unzip-rcc-debuginfo-6.00-lp150.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"unzip-rcc-debugsource-6.00-lp150.3.3.1") ) flag++;
