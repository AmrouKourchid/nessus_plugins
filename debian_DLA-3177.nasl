...
dla-3177 advisory.
    ...
    It was discovered that there were multiple vulnerabilies in Django, a popular Python-based development
    framework: CVE-2022-28346: An issue was discovered in Django 2.2 before 2.2.28, 3.2 before 3.2.13, and 4.0
    before 4.0.4. QuerySet.annotate(), aggregate(), and extra() methods are subject to SQL injection in column
    aliases via a crafted dictionary (with dictionary expansion) as the passed **kwargs. CVE-2021-45115: An
    issue was discovered in Django 2.2 before 2.2.26, 3.2 before 3.2.11, and 4.0 before 4.0.1.
    ...
    was unrestricted, this provided a potential vector for a denial-of-service attack. CVE-2021-45116: An
    issue was discovered in Django 2.2 before 2.2.26, 3.2 before 3.2.11, and 4.0 before 4.0.1. Due to
    ...
    crafted key. For Debian 10 Buster, these problems have been fixed in version 1:1.11.29-1+deb10u3. We
