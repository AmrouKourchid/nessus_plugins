...
# extracted from Fedora Security Advisory FEDORA-2023-6ef5f2fbf3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-6ef5f2fbf3");

  script_name(english:"Fedora 37 : rust-rustls-webpki (2023-6ef5f2fbf3)");
...
FEDORA-2023-6ef5f2fbf3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-6ef5f2fbf3");
...
var pkgs = [
    {'reference':'rust-rustls-webpki-0.100.2-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
