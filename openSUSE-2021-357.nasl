...
# extracted from openSUSE Security Update openSUSE-2021-357.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : nodejs12 (openSUSE-2021-357)");
...
if ( rpm_check(release:"SUSE15.2", reference:"nodejs12-12.21.0-lp152.3.12.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"nodejs12-debuginfo-12.21.0-lp152.3.12.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"nodejs12-debugsource-12.21.0-lp152.3.12.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"nodejs12-devel-12.21.0-lp152.3.12.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"npm12-12.21.0-lp152.3.12.1") ) flag++;
