...
# extracted from Red Hat Security Advisory RHSA-2024:8721. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:8721");

  script_name(english:"RHEL 9 : firefox (RHSA-2024:8721)");
...
referenced in the RHSA-2024:8721 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6f80cab8");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:8721");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL firefox package based on the guidance in RHSA-2024:8721.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-128.4.0-1.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
