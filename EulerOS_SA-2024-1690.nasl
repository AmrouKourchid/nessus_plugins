...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : libX11 (EulerOS-SA-2024-1690)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1690
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dcdb743d");
...
var pkgs = [
  "libX11-1.6.6-1.h6.eulerosv2r8",
  "libX11-common-1.6.6-1.h6.eulerosv2r8",
  "libX11-devel-1.6.6-1.h6.eulerosv2r8",
  "libX11-xcb-1.6.6-1.h6.eulerosv2r8"
];
