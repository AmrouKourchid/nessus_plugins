...
# extracted from Red Hat Security Advisory RHSA-2024:4504. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:4504");

  script_name(english:"RHEL 9 : httpd (RHSA-2024:4504)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_4504.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2fb1612b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2176211");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:4504");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL httpd package based on the guidance in RHSA-2024:4504.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'httpd-2.4.53-11.el9_2.6', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'httpd-core-2.4.53-11.el9_2.6', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'httpd-devel-2.4.53-11.el9_2.6', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'httpd-filesystem-2.4.53-11.el9_2.6', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'httpd-manual-2.4.53-11.el9_2.6', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'httpd-tools-2.4.53-11.el9_2.6', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mod_ldap-2.4.53-11.el9_2.6', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mod_lua-2.4.53-11.el9_2.6', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mod_proxy_html-2.4.53-11.el9_2.6', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'mod_session-2.4.53-11.el9_2.6', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mod_ssl-2.4.53-11.el9_2.6', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
