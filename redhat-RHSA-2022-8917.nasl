...
# extracted from Red Hat Security Advisory RHSA-2022:8917. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:8917");

  script_name(english:"RHEL 7 / 8 / 9 : Red Hat JBoss Web Server 5.7.1 (RHSA-2022:8917)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for Red Hat JBoss Web Server 5.7.1.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 / 8 / 9 host has a package installed that is affected by multiple vulnerabilities
as referenced in the RHSA-2022:8917 advisory.
    ...
    This release of Red Hat JBoss Web Server 5.7.1 serves as a replacement for Red Hat JBoss Web Server 5.7.0.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8917.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ca7c608b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8917");
...
"Update the RHEL Red Hat JBoss Web Server 5.7.1 package based on the guidance in RHSA-2022:8917.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jws5-tomcat-native-1.2.31-11.redhat_11.el8jws', 'cpu':'x86_64', 'release':'8', 'el_string':'el8jws', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'jws5'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'jws5-tomcat-native-1.2.31-11.redhat_11.el9jws', 'cpu':'x86_64', 'release':'9', 'el_string':'el9jws', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'jws5'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'jws5-tomcat-native-1.2.31-11.redhat_11.el7jws', 'cpu':'x86_64', 'release':'7', 'el_string':'el7jws', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'jws5'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'jws5-tomcat-native');
}
