...
# extracted from Red Hat Security Advisory RHSA-2020:5435. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:5435");

  script_name(english:"RHEL 7 : python-rtslib (RHSA-2020:5435)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for python-rtslib.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2020:5435 advisory.

    The python-rtslib package provides a Python library to configure the kernel target subsystem, using the
    configfs file system.

    The following packages have been upgraded to a later upstream version: python-rtslib (2.1.74).
    (BZ#1855171)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_5435.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?93e8835f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:5435");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1854723");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-rtslib package based on the guidance in RHSA-2020:5435.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:python-rtslib");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:python-rtslib-doc");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python-rtslib-2.1.74-1.el7_9', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python-rtslib-doc-2.1.74-1.el7_9', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
