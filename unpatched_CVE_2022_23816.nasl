...
if (description)
{
  ...
  script_cve_id("CVE-2022-23816");
  script_xref(name:"CEA-ID", value:"CEA-2022-0026");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-23816 (deprecated)");
...
"Plugin has been deprecated due to the specified CVE being rejected by NVD.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-23816");
