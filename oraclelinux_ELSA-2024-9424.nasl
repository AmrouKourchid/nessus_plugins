...
# extracted from Oracle Linux Security Advisory ELSA-2024-9424.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : tpm2-tools (ELSA-2024-9424)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-9424.html");
...
var pkgs = [
    {'reference':'tpm2-tools-5.2-4.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tpm2-tools-5.2-4.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
