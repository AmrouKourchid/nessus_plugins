...
# extracted from Fedora Security Advisory FEDORA-2023-335e8b2908
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-335e8b2908");

  script_name(english:"Fedora 37 : libcaca (2023-335e8b2908)");
...
FEDORA-2023-335e8b2908 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-335e8b2908");
...
var pkgs = [
    {'reference':'libcaca-0.99-0.69.beta20.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
