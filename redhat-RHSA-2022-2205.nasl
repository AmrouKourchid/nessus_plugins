...
"The remote Red Hat host is missing one or more security updates for OpenShift Container Platform 4.9.33.");
...
referenced in the RHSA-2022:2205 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.9.33. See the following
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_2205.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?857fb923");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2074850");
...
"Update the RHEL OpenShift Container Platform 4.9.33 packages based on the guidance in RHSA-2022:2205.");
