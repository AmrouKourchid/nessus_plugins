...
# extracted from Fedora Security Advisory FEDORA-2024-0fa283c43a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-0fa283c43a");

  script_name(english:"Fedora 40 : iwd / libell (2024-0fa283c43a)");
...
FEDORA-2024-0fa283c43a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-0fa283c43a");
...
var pkgs = [
    {'reference':'iwd-3.3-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libell-0.71-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
