...
if (description)
{
  ...
  script_cve_id("CVE-2016-1000368", "CVE-2017-1000367", "CVE-2017-1000368");

  script_name(english:"Photon OS 1.0: Sudo PHSA-2017-0021");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'sudo-1.8.20p2-1.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'sudo-debuginfo-1.8.20p2-1.ph1')) flag++;
