...
if (description)
{
  ...
  script_cve_id("CVE-2019-11555", "CVE-2019-9494");

  script_name(english:"Photon OS 3.0: Wpa_Supplicant PHSA-2019-3.0-0023");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'wpa_supplicant-2.7-4.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'wpa_supplicant-debuginfo-2.7-4.ph3')) flag++;
