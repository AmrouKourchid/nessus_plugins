...
# extracted from VMware Security Advisory PHSA-2023-4.0-0414. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Openjdk11 PHSA-2023-4.0-0414");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the openjdk11 package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-414.md");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-14153");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'openjdk11-11.0.20-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'openjdk11-doc-11.0.20-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'openjdk11-src-11.0.20-1.ph4')) flag++;
