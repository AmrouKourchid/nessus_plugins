...
if (description)
{
  ...
  script_cve_id("CVE-2024-31919");
  script_xref(name:"IAVA", value:"2024-A-0418-S");

  script_name(english:"IBM MQ DoS (7157979)");

  script_set_attribute(attribute:"synopsis", value:
"The remote web server is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of IBM MQ Server running on the remote host is affected by a vulnerability as referenced in the 7157979
advisory.

  - IBM MQ, in certain configurations, is vulnerable to a denial of service attack caused by an error
    processing messages when an API Exit using MQBUFMH is used. (CVE-2024-31919)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/node/7157979");
...
appropriate.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-31919");
