...
if (description)
{
  ...
  script_cve_id("CVE-2024-21125", "CVE-2024-21177");
...
July 2024 CPU advisory.
  ...
  - Vulnerability in the MySQL Cluster product of Oracle MySQL (component: Cluster: General). Supported
    ...
    to cause a hang or frequently repeatable crash (complete DOS) of MySQL Cluster. (CVE-2024-21177)
  ...
  - Vulnerability in the MySQL Cluster product of Oracle MySQL (component: Cluster: General). Supported
    ...
    ability to cause a hang or frequently repeatable crash (complete DOS) of MySQL Cluster. (CVE-2024-21125)
...
"Apply the appropriate patch according to the July 2024 Oracle Critical Patch Update advisory.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-21177");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2024-21125");
...
mysql_check_version(variant:'Cluster', fixed:'7.5.35', min:'7.5', severity:SECURITY_WARNING);
