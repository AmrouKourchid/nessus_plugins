...
# extracted from openSUSE Security Update openSUSE-2020-996.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : google-compute-engine (openSUSE-2020-996)");
...
"This update for google-compute-engine fixes the following issues :
  ...
  + Do not add the created user to the adm (CVE-2020-8903),
    ...
    they exist (bsc#1173258) This update was imported from
...
if ( rpm_check(release:"SUSE15.1", reference:"google-compute-engine-debugsource-20190801-lp151.2.25.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"google-compute-engine-init-20190801-lp151.2.25.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"google-compute-engine-oslogin-20190801-lp151.2.25.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"google-compute-engine-oslogin-debuginfo-20190801-lp151.2.25.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"google-compute-engine-oslogin-32bit-20190801-lp151.2.25.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"google-compute-engine-oslogin-32bit-debuginfo-20190801-lp151.2.25.1") ) flag++;
