...
if (description)
{
  ...
  script_name(english:"Adobe Reader < 2015.006.30499 / 2017.011.30144 / 2019.012.20036 Multiple Vulnerabilities (APSB19-41) (macOS)");

  script_set_attribute(attribute:"synopsis", value:
"The version of Adobe Reader installed on the remote macOS host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Reader installed on the remote macOS host is a version prior to 2015.006.30499, 2017.011.30144, or
2019.012.20036. It is, therefore, affected by multiple vulnerabilities.
...
"Upgrade to Adobe Reader version 2015.006.30499 / 2017.011.30144 / 2019.012.20036 or later.");
...
var constraints = [
  { 'min_version' : '15.6', 'max_version' : '15.006.30497', 'fixed_version' : '15.006.30499', 'track' : 'DC Classic' },
  { 'min_version' : '17.8', 'max_version' : '17.011.30142', 'fixed_version' : '17.011.30144', 'track' : 'DC Classic' },
  { 'min_version' : '15.7', 'max_version' : '19.012.20034', 'fixed_version' : '19.012.20036', 'track' : 'DC Continuous' }
];
