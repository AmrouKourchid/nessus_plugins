...
# extracted from Debian Security Advisory dsa-5887. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5887 : exim4 - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 12 host has packages installed that are affected by a vulnerability as referenced in the dsa-5887
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2025-30232");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'exim4', 'reference': '4.96-15+deb12u7'},
    {'release': '12.0', 'prefix': 'exim4-base', 'reference': '4.96-15+deb12u7'},
    {'release': '12.0', 'prefix': 'exim4-config', 'reference': '4.96-15+deb12u7'},
    {'release': '12.0', 'prefix': 'exim4-daemon-heavy', 'reference': '4.96-15+deb12u7'},
    {'release': '12.0', 'prefix': 'exim4-daemon-light', 'reference': '4.96-15+deb12u7'},
    {'release': '12.0', 'prefix': 'exim4-dev', 'reference': '4.96-15+deb12u7'},
    {'release': '12.0', 'prefix': 'eximon4', 'reference': '4.96-15+deb12u7'}
];
