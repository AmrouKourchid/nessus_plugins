...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.0 : net-snmp (EulerOS-SA-2023-1708)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1708
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?523c1208");
...
var pkgs = [
  "net-snmp-5.7.2-33.2.h10",
  "net-snmp-agent-libs-5.7.2-33.2.h10",
  "net-snmp-libs-5.7.2-33.2.h10",
  "net-snmp-utils-5.7.2-33.2.h10"
];
