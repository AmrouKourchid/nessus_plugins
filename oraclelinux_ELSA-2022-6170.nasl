...
# extracted from Oracle Linux Security Advisory ELSA-2022-6170.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : rsync (ELSA-2022-6170)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2022-6170.html");
...
var pkgs = [
    {'reference':'rsync-3.1.2-11.el7_9', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
