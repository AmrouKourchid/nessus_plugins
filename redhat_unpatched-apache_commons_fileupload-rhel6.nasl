...
# extracted from Red Hat Security Advisory apache_commons_fileupload. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 6 : apache_commons_fileupload (Unpatched Vulnerability) (deprecated)");
