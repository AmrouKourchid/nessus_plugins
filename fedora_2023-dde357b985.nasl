...
# extracted from Fedora Security Advisory FEDORA-2023-dde357b985
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-dde357b985");

  script_name(english:"Fedora 37 : mlpack (2023-dde357b985)");
...
FEDORA-2023-dde357b985 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-dde357b985");
...
var pkgs = [
    {'reference':'mlpack-4.2.1-5.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
