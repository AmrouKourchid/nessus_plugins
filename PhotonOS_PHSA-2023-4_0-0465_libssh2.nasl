...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Libssh2 PHSA-2023-4.0-0465");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libssh2-1.11.0-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libssh2-devel-1.11.0-1.ph4')) flag++;
