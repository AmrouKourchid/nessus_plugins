...
if (description)
{
  ...
  script_cve_id("CVE-2022-3786", "CVE-2023-5678", "CVE-2023-46589");
  script_xref(name:"CEA-ID", value:"CEA-2022-0036");

  script_name(english:"Oracle Siebel Server <= 24.2 (July 2024 CPU)");
...
the July 2024 CPU advisory.
  ...
  - Vulnerability in the Siebel CRM End User product of Oracle Siebel CRM (component: EAI, UI (Apache
    Tomcat)). Supported versions that are affected are 24.2 and prior. Easily exploitable vulnerability allows
    unauthenticated attacker with network access via HTTP to compromise Siebel CRM End User. Successful
    attacks of this vulnerability can result in unauthorized creation, deletion or modification access to
    critical data or all Siebel CRM End User accessible data. (CVE-2023-46589)

  - Vulnerability in the Siebel CRM Deployment product of Oracle Siebel CRM (component: Server Infrastructure
    (OpenSSL)). Supported versions that are affected are 24.2 and prior. Easily exploitable vulnerability
    ...
    service (partial DOS) of Siebel CRM Deployment. (CVE-2022-3786, CVE-2023-5678)
...
var constraints = [
  { 'max_version' : '24.2.999', 'fixed_version' : '24.7' }
];
