...
if (description)
{
  ...
  script_name(english:"OpenJDK 8 <= 8u422 / 11.0.0 <= 11.0.24 / 17.0.0 <= 17.0.12 / 21.0.0 <= 21.0.4 / 23.0.0 <= 23.0.0 Multiple Vulnerabilities (2024-10-15)");

  script_set_attribute(attribute:"synopsis", value:
"OpenJDK is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of OpenJDK installed on the remote host is 8 prior to 8u422 / 11.0.0 prior to 11.0.24 / 17.0.0 prior to
17.0.12 / 21.0.0 prior to 21.0.4 / 23.0.0 prior to 23.0.0. It is, therefore, affected by multiple vulnerabilities as
referenced in the 2024-10-15 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://openjdk.java.net/groups/vulnerability/advisories/2024-10-15");
  script_set_attribute(attribute:"solution", value:
"Upgrade to an OpenJDK version greater than 8u422 / 11.0.24 / 17.0.12 / 21.0.4 / 23.0.0");
...
var constraints = [
  { 'min_version' : '8.0.0', 'max_version' : '8.0.422', 'fixed_display' : 'Upgrade to a version greater than 8u422' },
  { 'min_version' : '11.0.0', 'max_version' : '11.0.24', 'fixed_display' : 'Upgrade to a version greater than 11.0.24' },
  { 'min_version' : '17.0.0', 'max_version' : '17.0.12', 'fixed_display' : 'Upgrade to a version greater than 17.0.12' },
  { 'min_version' : '21.0.0', 'max_version' : '21.0.4', 'fixed_display' : 'Upgrade to a version greater than 21.0.4' },
  { 'min_version' : '23.0.0', 'max_version' : '23.0.0', 'fixed_display' : 'Upgrade to a version greater than 23.0.0' }
];
