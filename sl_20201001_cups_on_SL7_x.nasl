...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : cups on SL7.x x86_64 (20201001)");
...
"Security Fix(es) :
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind2010&L=SCIENTIFIC-LINUX-ERRATA&P=9705
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?37f62008");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"cups-1.6.3-51.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"cups-client-1.6.3-51.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"cups-debuginfo-1.6.3-51.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"cups-devel-1.6.3-51.el7")) flag++;
if (rpm_check(release:"SL7", reference:"cups-filesystem-1.6.3-51.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"cups-filesystem-1.6.3-51.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"cups-ipptool-1.6.3-51.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"cups-libs-1.6.3-51.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"cups-lpd-1.6.3-51.el7")) flag++;
