...
# extracted from Amazon Linux 2 Security Advisory ALASREDIS6-2023-005.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : redis (ALASREDIS6-2023-005)");
...
referenced in the ALAS2REDIS6-2023-005 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALASREDIS6-2023-005.html");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/cve/html/CVE-2021-32761.html");
...
var pkgs = [
    {'reference':'redis-6.2.5-1.amzn2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'redis6'},
    {'reference':'redis-6.2.5-1.amzn2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'redis6'},
    {'reference':'redis-debuginfo-6.2.5-1.amzn2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'redis6'},
    {'reference':'redis-debuginfo-6.2.5-1.amzn2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'redis6'},
    {'reference':'redis-devel-6.2.5-1.amzn2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'redis6'},
    {'reference':'redis-devel-6.2.5-1.amzn2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'redis6'},
    {'reference':'redis-doc-6.2.5-1.amzn2', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'redis6'}
];
