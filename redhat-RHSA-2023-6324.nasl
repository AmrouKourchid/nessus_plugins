...
# extracted from Red Hat Security Advisory RHSA-2023:6324. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:6324");

  script_name(english:"RHEL 9 : python3.11-pip (RHSA-2023:6324)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6324.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b4e10911");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2218247");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=263261");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6324");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python3.11-pip package based on the guidance in RHSA-2023:6324.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3.11-pip-22.3.1-4.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.11-pip-wheel-22.3.1-4.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
