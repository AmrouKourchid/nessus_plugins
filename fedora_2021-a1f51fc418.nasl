...
# extracted from Fedora Security Advisory FEDORA-2021-a1f51fc418
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-a1f51fc418");

  script_name(english:"Fedora 33 : glib2 (2021-a1f51fc418)");
...
FEDORA-2021-a1f51fc418 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-a1f51fc418");
...
pkgs = [
    {'reference':'glib2-2.66.8-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
