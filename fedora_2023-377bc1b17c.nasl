...
# extracted from Fedora Security Advisory FEDORA-2023-377bc1b17c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-377bc1b17c");

  script_name(english:"Fedora 40 : firecracker / rust-aes-gcm (2023-377bc1b17c)");
...
FEDORA-2023-377bc1b17c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-377bc1b17c");
  script_set_attribute(attribute:"solution", value:
"Update the affected firecracker and / or rust-aes-gcm packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:rust-aes-gcm");
...
var pkgs = [
    {'reference':'firecracker-1.4.1-3.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-aes-gcm-0.10.3-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'firecracker / rust-aes-gcm');
}
