...
if (description)
{
  ...
  script_cve_id("CVE-2014-1303");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2014-1303");
...
patch available.
  ...
  - Heap-based buffer overflow in Apple Safari 7.0.2 allows remote attackers to execute arbitrary code and
    bypass a sandbox protection mechanism via unspecified vectors, as demonstrated by Liang Chen during a
    Pwn2Own competition at CanSecWest 2014. (CVE-2014-1303)
