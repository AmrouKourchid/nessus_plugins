...
# extracted from Red Hat Security Advisory RHSA-2020:1852. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:1852");

  script_name(english:"RHEL 8 : patch (RHSA-2020:1852)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_1852.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2ed89e85");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/8.2_release_notes/index
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dd7b3f20");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:1852");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1732781");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL patch package based on the guidance in RHSA-2020:1852.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'patch-2.7.6-11.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
