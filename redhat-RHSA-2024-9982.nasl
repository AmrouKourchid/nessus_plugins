...
# extracted from Red Hat Security Advisory RHSA-2024:9982. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:9982");

  script_name(english:"RHEL 9 : RHOSP 17.1.4 (openstack-ironic) (RHSA-2024:9982)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for RHOSP 17.1.4 (openstack-ironic).");
...
the RHSA-2024:9982 advisory.

    Ironic

    Security Fix(es):

    * Specially crafted image may allow authenticated users to gain access to potentially sensitive data
    (CVE-2024-44082)
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_9982.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?da34d9db");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:9982");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL RHOSP 17.1.4 (openstack-ironic) package based on the guidance in RHSA-2024:9982.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openstack-ironic-api-17.1.1-17.1.20240917210749.c31db88.el9ost', 'release':'9', 'el_string':'el9ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'},
      {'reference':'openstack-ironic-common-17.1.1-17.1.20240917210749.c31db88.el9ost', 'release':'9', 'el_string':'el9ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'},
      {'reference':'openstack-ironic-conductor-17.1.1-17.1.20240917210749.c31db88.el9ost', 'release':'9', 'el_string':'el9ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'}
    ]
  }
];
