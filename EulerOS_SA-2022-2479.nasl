...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : rsync (EulerOS-SA-2022-2479)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the rsync packages installed, the EulerOS installation on the remote host is affected by
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2479
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f05bca11");
...
var pkgs = [
  "rsync-3.1.3-4.h6.eulerosv2r8",
  "rsync-daemon-3.1.3-4.h6.eulerosv2r8"
];
