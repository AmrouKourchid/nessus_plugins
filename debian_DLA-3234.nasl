...
# extracted from Debian Security Advisory dla-3234. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3234 : hsqldb-utils - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3234
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/hsqldb");
  script_set_attribute(attribute:"solution", value:
"Upgrade the hsqldb-utils packages.");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'hsqldb-utils', 'reference': '2.4.1-2+deb10u1'},
    {'release': '10.0', 'prefix': 'libhsqldb-java', 'reference': '2.4.1-2+deb10u1'},
    {'release': '10.0', 'prefix': 'libhsqldb-java-doc', 'reference': '2.4.1-2+deb10u1'}
];
