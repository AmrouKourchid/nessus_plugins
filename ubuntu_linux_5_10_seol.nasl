...
if (description)
{
  ...
  script_name(english:"Canonical Ubuntu Linux SEoL (5.10.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Canonical Ubuntu Linux is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Canonical Ubuntu Linux is 5.10.x. It is, therefore, no longer maintained by its vendor or
provider.

Lack of support implies that no new security patches for the product will be released by the vendor. As a result, it may
contain security vulnerabilities.");
  # https://ubuntu.com/blog/ubuntu-5-10-reaches-end-of-life-on-april-13th-2007
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e4157ddd");
...
"Upgrade to a version of Canonical Ubuntu Linux that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2007/04/13");
...
var constraints = [
  { max_branch : '5.10', min_branch : '5.10', seol : 20070413 }
];
