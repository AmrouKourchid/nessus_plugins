...
# extracted from F5 Networks BIG-IP Solution K000138219.
#
# @NOAGENT@
##
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : libssh2 vulnerability (K000138219)");
...
by a vulnerability as referenced in the K000138219 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K000138219");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K000138219.");
