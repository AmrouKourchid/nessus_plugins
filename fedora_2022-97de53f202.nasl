...
# extracted from Fedora Security Advisory FEDORA-2022-97de53f202
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-97de53f202");
  script_xref(name:"IAVA", value:"2022-A-0440-S");

  script_name(english:"Fedora 35 : nginx (2022-97de53f202)");
...
FEDORA-2022-97de53f202 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-97de53f202");
...
var pkgs = [
    {'reference':'nginx-1.22.1-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
