...
# extracted from SUSE update advisory SUSE-SU-2020:1285-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : python-PyYAML (SUSE-SU-2020:1285-1)");
...
without introducing additional issues.");
  ...
  # https://www.suse.com/support/update/announcement/2020/suse-su-20201285-1/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?338c4275");
...
zypper in -t patch
SUSE-SLE-Module-Adv-Systems-Management-12-2020-1285=1
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"4", reference:"python-PyYAML-5.1.2-26.12.1")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"python-PyYAML-debuginfo-5.1.2-26.12.1")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"python-PyYAML-debugsource-5.1.2-26.12.1")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"python3-PyYAML-5.1.2-26.12.1")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"python3-PyYAML-debuginfo-5.1.2-26.12.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"python-PyYAML-5.1.2-26.12.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"python-PyYAML-debuginfo-5.1.2-26.12.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"python-PyYAML-debugsource-5.1.2-26.12.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"python3-PyYAML-5.1.2-26.12.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"python-PyYAML-5.1.2-26.12.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"python-PyYAML-debuginfo-5.1.2-26.12.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"python-PyYAML-debugsource-5.1.2-26.12.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"python3-PyYAML-5.1.2-26.12.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"python3-PyYAML-debuginfo-5.1.2-26.12.1")) flag++;
