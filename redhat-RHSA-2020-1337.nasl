...
referenced in the RHSA-2020:1337 advisory.
    ...
    This release adds the new Apache HTTP Server 2.4.37 Service Pack 2 packages that are part of the JBoss
    ...
    Pack 1 and includes bug fixes and enhancements. Refer to the Release Notes for information on the most
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5b4f39c4");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_1337.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?72722ce4");
...
"Update the RHEL Red Hat JBoss Core Services Apache HTTP Server 2.4.37 SP2 package based on the guidance in
RHSA-2020:1337.");
  ...
  script_cwe_id(79, 200, 400, 416, 601, 602);
