...
# extracted from Fedora Security Advisory FEDORA-2023-b86fd9ad80
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-b86fd9ad80");

  script_name(english:"Fedora 38 : pcs (2023-b86fd9ad80)");
...
FEDORA-2023-b86fd9ad80 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-b86fd9ad80");
...
var pkgs = [
    {'reference':'pcs-0.11.6-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
