...
referenced in the RHSA-2017:2423 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2017/rhsa-2017_2423.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?47a0ebb3");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2017:2423");
...
"Update the RHEL log4j package based on the guidance in RHSA-2017:2423.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'log4j-1.2.17-16.el7_4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'log4j-javadoc-1.2.17-16.el7_4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'log4j-manual-1.2.17-16.el7_4', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
