...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5001975");
  script_xref(name:"MSFT", value:"MS21-5001975");
  script_xref(name:"IAVA", value:"2021-A-0317-S");

  script_name(english:"Security Updates for Microsoft SharePoint Server 2019 (July 2021)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5001975");
