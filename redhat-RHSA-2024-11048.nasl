...
# extracted from Red Hat Security Advisory RHSA-2024:11048. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:11048");

  script_name(english:"RHEL 7 : python-virtualenv (RHSA-2024:11048)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_11048.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?77dd08a9");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:11048");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-virtualenv package based on the guidance in RHSA-2024:11048.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python-virtualenv-15.1.0-7.el7_9.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
