...
# extracted from Fedora Security Advisory FEDORA-2024-05d7ee197e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-05d7ee197e");
  script_xref(name:"IAVB", value:"2024-B-0134");

  script_name(english:"Fedora 39 : clamav (2024-05d7ee197e)");
...
FEDORA-2024-05d7ee197e advisory.

    Update to 1.0.7

    * CVE-2024-20506: Changed the logging module to disable following symlinks on Linux and Unix systems so as
    to prevent an attacker with existing access to the 'clamd' or 'freshclam' services from using a symlink to
    corrupt system files.
    * CVE-2024-20505: Fixed a possible out-of-bounds read bug in the PDF file parser that could cause a
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-05d7ee197e");
...
var pkgs = [
    {'reference':'clamav-1.0.7-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
