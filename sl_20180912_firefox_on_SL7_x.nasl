...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : firefox on SL7.x x86_64 (20180912)");
...
Security Fix(es) :
  ...
  - Mozilla: Out-of-bounds write with malicious MAR file
    (CVE-2018-12379)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1809&L=scientific-linux-errata&F=&S=&P=80
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6cd00daa");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"firefox-60.2.0-1.el7_5", allowmaj:TRUE)) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"firefox-debuginfo-60.2.0-1.el7_5", allowmaj:TRUE)) flag++;
