...
# extracted from Red Hat Security Advisory RHSA-2024:4936. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:4936");

  script_name(english:"RHEL 8 : freeradius:3.0 (RHSA-2024:4936)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for freeradius:3.0.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:4936 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_4936.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fb2cc1d1");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:4936");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL freeradius:3.0 package based on the guidance in RHSA-2024:4936.");
  ...
  'freeradius:3.0': [
    {
      ...
      'pkgs': [
        {'reference':'freeradius-3.0.20-15.module+el8.10.0+22065+aa3d48ca', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'freeradius-devel-3.0.20-15.module+el8.10.0+22065+aa3d48ca', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'freeradius-doc-3.0.20-15.module+el8.10.0+22065+aa3d48ca', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'freeradius-krb5-3.0.20-15.module+el8.10.0+22065+aa3d48ca', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'freeradius-ldap-3.0.20-15.module+el8.10.0+22065+aa3d48ca', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'freeradius-mysql-3.0.20-15.module+el8.10.0+22065+aa3d48ca', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'freeradius-perl-3.0.20-15.module+el8.10.0+22065+aa3d48ca', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'freeradius-postgresql-3.0.20-15.module+el8.10.0+22065+aa3d48ca', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'freeradius-rest-3.0.20-15.module+el8.10.0+22065+aa3d48ca', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'freeradius-sqlite-3.0.20-15.module+el8.10.0+22065+aa3d48ca', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'freeradius-unixODBC-3.0.20-15.module+el8.10.0+22065+aa3d48ca', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'freeradius-utils-3.0.20-15.module+el8.10.0+22065+aa3d48ca', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-freeradius-3.0.20-15.module+el8.10.0+22065+aa3d48ca', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
