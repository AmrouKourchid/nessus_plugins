...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : e2fsprogs (EulerOS-SA-2021-1290)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1290
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8379703f");
...
pkgs = ["e2fsprogs-1.42.9-9.h2",
        "e2fsprogs-devel-1.42.9-9.h2",
        "e2fsprogs-libs-1.42.9-9.h2",
        "libcom_err-1.42.9-9.h2",
        "libcom_err-devel-1.42.9-9.h2",
        "libss-1.42.9-9.h2"];
