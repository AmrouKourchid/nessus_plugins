...
# extracted from Oracle Linux Security Advisory ELSA-2025-4169.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : thunderbird (ELSA-2025-4169)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2025-4169.html");
...
var pkgs = [
    {'reference':'thunderbird-128.9.0-2.0.1.el9_5', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'thunderbird-128.9.0-2.0.1.el9_5', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
