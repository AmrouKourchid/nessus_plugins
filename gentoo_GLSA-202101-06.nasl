...
# extracted from Gentoo Linux Security Advisory GLSA 202101-06.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202101-06");

  script_name(english:"GLSA-202101-06 : Ark: Symlink vulnerability");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202101-06
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202101-06");
