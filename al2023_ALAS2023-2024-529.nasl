...
# extracted from Amazon Linux 2023 Security Advisory ALAS2023-2024-529.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2023 : nerdctl (ALAS2023-2024-529)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2023 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"It is, therefore, affected by a vulnerability as referenced in the ALAS2023-2024-529 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2023/ALAS-2024-529.html");
...
var pkgs = [
    {'reference':'nerdctl-1.7.2-1.amzn2023.0.1', 'cpu':'aarch64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'nerdctl-1.7.2-1.amzn2023.0.1', 'cpu':'x86_64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE}
];
