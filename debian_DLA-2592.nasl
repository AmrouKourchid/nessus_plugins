...
# extracted from Debian Security Advisory DLA-2592-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2592-1 : golang-1.8 security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2021/03/msg00015.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"9.0", prefix:"golang-1.8", reference:"1.8.1-1+deb9u3")) flag++;
if (deb_check(release:"9.0", prefix:"golang-1.8-doc", reference:"1.8.1-1+deb9u3")) flag++;
if (deb_check(release:"9.0", prefix:"golang-1.8-go", reference:"1.8.1-1+deb9u3")) flag++;
if (deb_check(release:"9.0", prefix:"golang-1.8-src", reference:"1.8.1-1+deb9u3")) flag++;
