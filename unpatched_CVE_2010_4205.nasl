...
if (description)
{
  ...
  script_cve_id("CVE-2010-4205");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2010-4205");
...
patch available.
  ...
  - Google Chrome before 7.0.517.44 does not properly handle the data types of event objects, which allows
    remote attackers to cause a denial of service or possibly have unspecified other impact via unknown
    vectors. (CVE-2010-4205)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2010-4205");
