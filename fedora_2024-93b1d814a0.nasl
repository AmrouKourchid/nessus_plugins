...
# extracted from Fedora Security Advisory FEDORA-2024-93b1d814a0
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-93b1d814a0");

  script_name(english:"Fedora 40 : dotnet6.0 (2024-93b1d814a0)");
...
FEDORA-2024-93b1d814a0 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-93b1d814a0");
...
var pkgs = [
    {'reference':'dotnet6.0-6.0.132-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
