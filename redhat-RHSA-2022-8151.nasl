...
# extracted from Red Hat Security Advisory RHSA-2022:8151. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:8151");

  script_name(english:"RHEL 9 : poppler (RHSA-2022:8151)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8151.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?691620c3");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8151");
...
"Update the RHEL poppler package based on the guidance in RHSA-2022:8151.");
