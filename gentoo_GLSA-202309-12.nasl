...
# extracted from Gentoo Linux Security Advisory GLSA 202309-12.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202309-12 : sudo: Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202309-12 (sudo: Multiple Vulnerabilities)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202309-12");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=898510");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=905322");
...
var packages = [
  {
    'name' : 'app-admin/sudo',
    'unaffected' : make_list("ge 1.9.13_p2"),
    'vulnerable' : make_list("lt 1.9.13_p2")
  }
];
