...
ELSA-2011-1350 advisory.
    ...
    - Revert: [net] ipv6: make fragment identifications less predictable (Jiri Pirko) [723432 723433]
    {CVE-2011-2699}
    - [x86] perf, x86: Fix Intel fixed counters base initialization (Don Zickus) [719229 736284]
    {CVE-2011-2521}
    - [net] ipv6: make fragment identifications less predictable (Jiri Pirko) [723432 723433] {CVE-2011-2699}
    - [fs] Ecryptfs: Add mount option to check uid of device being mounted = expect uid (Eric Sandeen) [731175
    731176] {CVE-2011-1833}
    ...
    - [mm] avoid wrapping vm_pgoff in mremap() and stack expansion (Jerome Marchand) [716540 716541]
    {CVE-2011-2496}
    ...
    - [kernel] taskstats: don't allow duplicate entries in listener mode (Jerome Marchand) [715447 715448]
    {CVE-2011-2484}
...
var pkgs = [
    ...
    {'reference':'kernel-firmware-2.6.32-131.17.1.el6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-firmware-2.6.32'},
    ...
    {'reference':'kernel-firmware-2.6.32-131.17.1.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-firmware-2.6.32'},
