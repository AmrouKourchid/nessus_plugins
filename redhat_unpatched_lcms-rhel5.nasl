...
# extracted from Red Hat Security Advisory lcms. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2009-0793", "CVE-2013-4276");

  script_name(english:"RHEL 5 : lcms (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2009-0793");
