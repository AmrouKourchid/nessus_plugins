...
# extracted from Fedora Security Advisory FEDORA-2024-4fc7cdc194
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-4fc7cdc194");

  script_name(english:"Fedora 39 : syncthing (2024-4fc7cdc194)");
...
FEDORA-2024-4fc7cdc194 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-4fc7cdc194");
...
var pkgs = [
    {'reference':'syncthing-1.28.0-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
