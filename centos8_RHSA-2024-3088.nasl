...
# Red Hat Security Advisory RHSA-2024:3088. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:3088");

  script_name(english:"CentOS 8 : gstreamer1-plugins-base (CESA-2024:3088)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
CESA-2024:3088 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:3088");
  script_set_attribute(attribute:"solution", value:
"Update the affected gstreamer1-plugins-base and / or gstreamer1-plugins-base-devel packages.");
...
var pkgs = [
    {'reference':'gstreamer1-plugins-base-1.16.1-3.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'gstreamer1-plugins-base-1.16.1-3.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'gstreamer1-plugins-base-devel-1.16.1-3.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'gstreamer1-plugins-base-devel-1.16.1-3.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
