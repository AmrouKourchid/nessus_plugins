...
# extracted from VMware Security Advisory PHSA-2024-4.0-0671. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Unbound PHSA-2024-4.0-0671");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the unbound package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-671.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'unbound-1.16.3-3.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'unbound-devel-1.16.3-3.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'unbound-docs-1.16.3-3.ph4')) flag++;
