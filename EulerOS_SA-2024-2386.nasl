...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : elfutils (EulerOS-SA-2024-2386)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2386
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?94eec317");
...
var pkgs = [
  "elfutils-0.179-1.h5.eulerosv2r9"
];
