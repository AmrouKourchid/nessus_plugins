...
if (description)
{
  ...
  script_name(english:"CentOS 6 : ipmitool (RHSA-2020:1331)");
...
var pkgs = [
    {'reference':'ipmitool-1.8.15-3.el6_10', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE}
];
