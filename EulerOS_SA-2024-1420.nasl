...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.1 : python-pillow (EulerOS-SA-2024-1420)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1420
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e51e421b");
...
var pkgs = [
  "python3-pillow-9.0.1-1.h4.eulerosv2r11"
];
