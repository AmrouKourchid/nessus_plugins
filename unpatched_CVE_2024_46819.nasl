...
if (description)
{
  ...
  script_cve_id("CVE-2024-46819");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-46819");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: drm/amdgpu: the warning dereferencing
    obj for nbio_v7_4 if ras_manager obj null, don't print NBIO err data (CVE-2024-46819)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-46819");
