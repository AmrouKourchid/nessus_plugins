...
# extracted from Red Hat Security Advisory xsa240_xen. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2017-15595");

  script_name(english:"RHEL 5 : xsa240_xen (Unpatched Vulnerability) (deprecated)");
