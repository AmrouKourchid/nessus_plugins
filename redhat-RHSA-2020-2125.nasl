...
# extracted from Red Hat Security Advisory RHSA-2020:2125. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:2125");

  script_name(english:"RHEL 8 : kpatch-patch (RHSA-2020:2125)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_2125.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dda3787f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:2125");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1825116");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL kpatch-patch package based on the guidance in RHSA-2020:2125.");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for RHSA-2020:2125');
  }
  else
  {
...
var kernel_live_checks = [
  {
    ...
    'kernels': {
      '4.18.0-193.el8.ppc64le': {
        'pkgs': [
          {'reference':'kpatch-patch-4_18_0-193-1-2.el8', 'sp':'2', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ]
      },
      '4.18.0-193.el8.x86_64': {
        'pkgs': [
          {'reference':'kpatch-patch-4_18_0-193-1-2.el8', 'sp':'2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
        ]
      }
    }
  },
  {
    ...
    'kernels': {
      '4.18.0-193.el8.ppc64le': {
        'pkgs': [
          {'reference':'kpatch-patch-4_18_0-193-1-2.el8', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ]
      },
      '4.18.0-193.el8.x86_64': {
        'pkgs': [
          {'reference':'kpatch-patch-4_18_0-193-1-2.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kpatch-patch-4_18_0-193');
}
