...
# extracted from Oracle Linux Security Advisory ELSA-2021-9298.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : runc (ELSA-2021-9298)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2021-9298.html");
