...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : patch (EulerOS-SA-2019-1982)");
...
vulnerabilities :
  ...
  - A heap-based out-of-bounds read flaw was found in the
    way the patch utility parsed patch files. An attacker
    could potentially use this flaw to crash the patch
    utility by tricking it into processing crafted patch
    files.(CVE-2016-10713)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1982
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0de6912d");
...
"Update the affected patch packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-1196");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2016-10713");
...
pkgs = ["patch-2.7.1-10.h2.eulerosv2r7"];
