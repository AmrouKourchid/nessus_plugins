...
# extracted from Amazon Linux 2 Security Advisory ALAS-2023-2008.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : python-twisted-web (ALAS-2023-2008)");
...
vulnerability as referenced in the ALAS2-2023-2008 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2023-2008.html");
...
var pkgs = [
    {'reference':'python-twisted-web-12.1.0-8.amzn2.0.1', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python-twisted-web-12.1.0-8.amzn2.0.1', 'cpu':'i686', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python-twisted-web-12.1.0-8.amzn2.0.1', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
