...
# extracted from Red Hat Security Advisory RHSA-2024:2550. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2550");

  script_name(english:"RHEL 9 : buildah  update (Moderate) (RHSA-2024:2550)");
...
the RHSA-2024:2550 advisory.
    ...
    * TRIAGE CVE-2024-24786 buildah: golang-protobuf: encoding/protojson, internal/encoding/json: infinite
    loop in protojson.Unmarshal when unmarshaling certain forms of invalid JSON [rhel-9] RHEL9.4 0Day
    (JIRA:RHEL-28230)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2550.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fc4c0955");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2550");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'buildah-1.33.7-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'buildah-tests-1.33.7-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'buildah-1.33.7-1.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'buildah-tests-1.33.7-1.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
    ]
  }
];
