...
# extracted from Ubuntu Security Notice USN-3654-2. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : Linux kernel (Xenial HWE) vulnerabilities (USN-3654-2)");
...
the USN-3654-2 advisory.

    USN-3654-1 fixed vulnerabilities and added mitigations in the Linux kernel for Ubuntu 16.04 LTS. This
    update provides the corresponding updates for the Linux Hardware Enablement (HWE) kernel from Ubuntu 16.04
    LTS for Ubuntu 14.04 LTS.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3654-2");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-3654-2');
}
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-3654-2');
  }
  else
  {
