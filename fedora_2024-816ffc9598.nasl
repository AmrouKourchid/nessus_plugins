...
# extracted from Fedora Security Advisory FEDORA-2024-816ffc9598
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-816ffc9598");

  script_name(english:"Fedora 38 : csmock (2024-816ffc9598)");
...
FEDORA-2024-816ffc9598 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-816ffc9598");
...
var pkgs = [
    {'reference':'csmock-3.5.3-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
