...
if (description)
{
  ...
  script_cve_id("CVE-2024-50267");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-50267");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: USB: serial: io_edgeport: fix use
    after free in debug printk The dev_dbg(&urb->dev->dev, ... which happens after usb_free_urb(urb) is a
    use after free of the urb pointer. Store the dev pointer at the start of the function to avoid this
    issue. (CVE-2024-50267)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-50267");
