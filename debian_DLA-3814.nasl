...
# extracted from Debian Security Advisory dla-3814. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3814 : libglib2.0-0 - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3814
advisory.

    -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3814-1                debian-lts@lists.debian.org
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libglib2.0-0', 'reference': '2.58.3-2+deb10u6'},
    {'release': '10.0', 'prefix': 'libglib2.0-bin', 'reference': '2.58.3-2+deb10u6'},
    {'release': '10.0', 'prefix': 'libglib2.0-data', 'reference': '2.58.3-2+deb10u6'},
    {'release': '10.0', 'prefix': 'libglib2.0-dev', 'reference': '2.58.3-2+deb10u6'},
    {'release': '10.0', 'prefix': 'libglib2.0-dev-bin', 'reference': '2.58.3-2+deb10u6'},
    {'release': '10.0', 'prefix': 'libglib2.0-doc', 'reference': '2.58.3-2+deb10u6'},
    {'release': '10.0', 'prefix': 'libglib2.0-tests', 'reference': '2.58.3-2+deb10u6'}
];
