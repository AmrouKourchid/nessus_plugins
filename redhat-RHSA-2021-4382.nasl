...
# extracted from Red Hat Security Advisory RHSA-2021:4382. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:4382");

  script_name(english:"RHEL 8 : json-c (RHSA-2021:4382)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for json-c.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2021:4382 advisory.

    JSON-C implements a reference counting object model that allows users to easily construct JavaScript
    Object Notation (JSON) objects in C, output them as JSON formatted strings, and parse JSON formatted
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_4382.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?60dd1798");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:4382");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL json-c package based on the guidance in RHSA-2021:4382.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'json-c-0.13.1-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'json-c-devel-0.13.1-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
