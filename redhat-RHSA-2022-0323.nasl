...
# extracted from Red Hat Security Advisory RHSA-2022:0323. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:0323");

  script_name(english:"RHEL 8 : nginx:1.20 (RHSA-2022:0323)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for nginx:1.20.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2022:0323 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_0323.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?03bf0bb0");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:0323");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1963121");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL nginx:1.20 package based on the guidance in RHSA-2022:0323.");
  ...
  'nginx:1.20': [
    {
      ...
      'pkgs': [
        {'reference':'nginx-1.20.1-1.module+el8.5.0+13723+ab304644', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-all-modules-1.20.1-1.module+el8.5.0+13723+ab304644', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-filesystem-1.20.1-1.module+el8.5.0+13723+ab304644', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-mod-http-image-filter-1.20.1-1.module+el8.5.0+13723+ab304644', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-mod-http-perl-1.20.1-1.module+el8.5.0+13723+ab304644', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-mod-http-xslt-filter-1.20.1-1.module+el8.5.0+13723+ab304644', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-mod-mail-1.20.1-1.module+el8.5.0+13723+ab304644', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-mod-stream-1.20.1-1.module+el8.5.0+13723+ab304644', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
      ]
    }
  ]
};
