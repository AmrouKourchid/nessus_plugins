...
# extracted from Fedora Security Advisory FEDORA-2024-2fb8991c68
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-2fb8991c68");

  script_name(english:"Fedora 38 : sos (2024-2fb8991c68)");
...
FEDORA-2024-2fb8991c68 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-2fb8991c68");
...
var pkgs = [
    {'reference':'sos-4.6.1-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
