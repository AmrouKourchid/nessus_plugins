...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 ESM / 18.04 LTS / 20.04 LTS : oslo.utils vulnerability (USN-5369-1)");
...
referenced in the USN-5369-1 advisory.

    It was discovered that oslo.utils incorrectly handled certain inputs. An attacker could possibly use this
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'python-oslo.utils', 'pkgver': '3.8.0-2ubuntu0.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'python3-oslo.utils', 'pkgver': '3.8.0-2ubuntu0.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'python-oslo.utils', 'pkgver': '3.35.0-0ubuntu1.1', 'ubuntu_pro': FALSE},
    {'osver': '18.04', 'pkgname': 'python3-oslo.utils', 'pkgver': '3.35.0-0ubuntu1.1', 'ubuntu_pro': FALSE},
    {'osver': '20.04', 'pkgname': 'python3-oslo.utils', 'pkgver': '4.1.1-0ubuntu1.1', 'ubuntu_pro': FALSE}
];
