...
if (description)
{
  ...
  script_cve_id("CVE-2025-21763");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2025-21763");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: neighbour: use RCU protection in
    __neigh_notify() __neigh_notify() can be called without RTNL or RCU protection. Use RCU protection to
    avoid potential UAF. (CVE-2025-21763)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-21763");
