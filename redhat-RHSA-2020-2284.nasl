...
# extracted from Red Hat Security Advisory RHSA-2020:2284. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:2284");

  script_name(english:"RHEL 7 : ipmitool (RHSA-2020:2284)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for ipmitool.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2020:2284 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_2284.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2ea6d6dc");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:2284");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1798721");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL ipmitool package based on the guidance in RHSA-2020:2284.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'bmc-snmp-proxy-1.8.13-10.el7_2', 'sp':'2', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'exchange-bmc-os-info-1.8.13-10.el7_2', 'sp':'2', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipmitool-1.8.13-10.el7_2', 'sp':'2', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
