...
# extracted from Fedora Security Advisory FEDORA-2024-a23b5f0783
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-a23b5f0783");

  script_name(english:"Fedora 40 : mbedtls (2024-a23b5f0783)");
...
FEDORA-2024-a23b5f0783 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-a23b5f0783");
...
"Update the affected mbedtls package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-28960");
...
var pkgs = [
    {'reference':'mbedtls-2.28.8-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
