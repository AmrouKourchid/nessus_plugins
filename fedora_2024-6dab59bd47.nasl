...
# extracted from Fedora Security Advisory FEDORA-2024-6dab59bd47
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-6dab59bd47");
  script_xref(name:"IAVA", value:"2024-A-0185-S");

  script_name(english:"Fedora 39 : curl (2024-6dab59bd47)");
...
FEDORA-2024-6dab59bd47 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-6dab59bd47");
...
var pkgs = [
    {'reference':'curl-8.2.1-5.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
