...
# extracted from Debian Security Advisory dla-3645. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3645 : trafficserver - security update");
...
For Debian 10 buster, these problems have been fixed in version 8.1.7-0+deb10u3.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-41752");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'trafficserver', 'reference': '8.1.7-0+deb10u3'},
    {'release': '10.0', 'prefix': 'trafficserver-dev', 'reference': '8.1.7-0+deb10u3'},
    {'release': '10.0', 'prefix': 'trafficserver-experimental-plugins', 'reference': '8.1.7-0+deb10u3'}
];
