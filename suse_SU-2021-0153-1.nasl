...
# extracted from SUSE update advisory SUSE-SU-2021:0153-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLED15 / SLES15 Security Update : ImageMagick (SUSE-SU-2021:0153-1)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=1179221");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=1179276");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=1179753");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2020-27756/");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2020-27757/");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2020-27758/");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2020-29599/");
  # https://www.suse.com/support/update/announcement/2021/suse-su-20210153-1
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4ad7b6a1");
...
zypper in -t patch
SUSE-SLE-Module-Desktop-Applications-15-SP2-2021-153=1");
...
flag = 0;
if (rpm_check(release:"SLES15", sp:"2", reference:"ImageMagick-7.0.7.34-10.9.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"ImageMagick-config-7-SUSE-7.0.7.34-10.9.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"ImageMagick-config-7-upstream-7.0.7.34-10.9.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"ImageMagick-debuginfo-7.0.7.34-10.9.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"ImageMagick-debugsource-7.0.7.34-10.9.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"ImageMagick-devel-7.0.7.34-10.9.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"libMagick++-7_Q16HDRI4-7.0.7.34-10.9.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"libMagick++-7_Q16HDRI4-debuginfo-7.0.7.34-10.9.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"libMagick++-devel-7.0.7.34-10.9.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"libMagickCore-7_Q16HDRI6-7.0.7.34-10.9.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"libMagickCore-7_Q16HDRI6-debuginfo-7.0.7.34-10.9.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"libMagickWand-7_Q16HDRI6-7.0.7.34-10.9.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"libMagickWand-7_Q16HDRI6-debuginfo-7.0.7.34-10.9.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"perl-PerlMagick-7.0.7.34-10.9.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"perl-PerlMagick-debuginfo-7.0.7.34-10.9.1")) flag++;
if (rpm_check(release:"SLED15", sp:"2", reference:"ImageMagick-7.0.7.34-10.9.1")) flag++;
if (rpm_check(release:"SLED15", sp:"2", reference:"ImageMagick-config-7-SUSE-7.0.7.34-10.9.1")) flag++;
if (rpm_check(release:"SLED15", sp:"2", reference:"ImageMagick-config-7-upstream-7.0.7.34-10.9.1")) flag++;
if (rpm_check(release:"SLED15", sp:"2", reference:"ImageMagick-debuginfo-7.0.7.34-10.9.1")) flag++;
if (rpm_check(release:"SLED15", sp:"2", reference:"ImageMagick-debugsource-7.0.7.34-10.9.1")) flag++;
if (rpm_check(release:"SLED15", sp:"2", reference:"ImageMagick-devel-7.0.7.34-10.9.1")) flag++;
if (rpm_check(release:"SLED15", sp:"2", reference:"libMagick++-7_Q16HDRI4-7.0.7.34-10.9.1")) flag++;
if (rpm_check(release:"SLED15", sp:"2", reference:"libMagick++-7_Q16HDRI4-debuginfo-7.0.7.34-10.9.1")) flag++;
if (rpm_check(release:"SLED15", sp:"2", reference:"libMagick++-devel-7.0.7.34-10.9.1")) flag++;
if (rpm_check(release:"SLED15", sp:"2", reference:"libMagickCore-7_Q16HDRI6-7.0.7.34-10.9.1")) flag++;
if (rpm_check(release:"SLED15", sp:"2", reference:"libMagickCore-7_Q16HDRI6-debuginfo-7.0.7.34-10.9.1")) flag++;
if (rpm_check(release:"SLED15", sp:"2", reference:"libMagickWand-7_Q16HDRI6-7.0.7.34-10.9.1")) flag++;
if (rpm_check(release:"SLED15", sp:"2", reference:"libMagickWand-7_Q16HDRI6-debuginfo-7.0.7.34-10.9.1")) flag++;
if (rpm_check(release:"SLED15", sp:"2", reference:"perl-PerlMagick-7.0.7.34-10.9.1")) flag++;
if (rpm_check(release:"SLED15", sp:"2", reference:"perl-PerlMagick-debuginfo-7.0.7.34-10.9.1")) flag++;
