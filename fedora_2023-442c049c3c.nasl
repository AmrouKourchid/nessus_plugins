...
# extracted from Fedora Security Advisory FEDORA-2023-442c049c3c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-442c049c3c");

  script_name(english:"Fedora 37 : chromium (2023-442c049c3c)");
...
FEDORA-2023-442c049c3c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-442c049c3c");
...
var pkgs = [
    {'reference':'chromium-119.0.6045.159-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
