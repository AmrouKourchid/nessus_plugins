...
# openSUSE Security Update openSUSE-SU-2021:2975-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : haproxy (openSUSE-SU-2021:2975-1)");
...
openSUSE-SU-2021:2975-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e15d8912");
...
var pkgs = [
    {'reference':'haproxy-2.0.14-11.11.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE}
];
