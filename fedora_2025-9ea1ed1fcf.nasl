...
# extracted from Fedora Security Advisory FEDORA-2025-9ea1ed1fcf
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-9ea1ed1fcf");

  script_name(english:"Fedora 41 : chromium (2025-9ea1ed1fcf)");
...
FEDORA-2025-9ea1ed1fcf advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-9ea1ed1fcf");
...
var pkgs = [
    {'reference':'chromium-135.0.7049.114-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
