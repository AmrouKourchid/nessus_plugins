...
# extracted from Fedora Security Advisory FEDORA-2018-f47268acd5.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-f47268acd5");

  script_name(english:"Fedora 28 : setup (2018-f47268acd5)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-f47268acd5");
...
"Update the affected setup package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:setup");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"setup-2.11.4-1.fc28")) flag++;
