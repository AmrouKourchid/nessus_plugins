...
# extracted from Fedora Security Advisory FEDORA-2023-2c851f43ba
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-2c851f43ba");

  script_name(english:"Fedora 37 : git (2023-2c851f43ba)");
...
FEDORA-2023-2c851f43ba advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-2c851f43ba");
...
var pkgs = [
    {'reference':'git-2.42.0-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
