...
leak.
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2020-11884");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2020/dsa-4667");
...
in version 4.19.98-1+deb10u1.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2020-8428");
...
if (deb_check(release:"10.0", prefix:"linux-image-4.19.0-5-686-pae", reference:"4.19.98-1+deb10u1")) flag++;
if (deb_check(release:"10.0", prefix:"linux-image-4.19.0-5-686", reference:"4.19.98-1+deb10u1")) flag++;
if (deb_check(release:"10.0", prefix:"linux-image-4.19.0-5-amd64-dbg", reference:"4.19.98-1+deb10u1")) flag++;
if (deb_check(release:"10.0", prefix:"linux-image-4.19.0-5-amd64", reference:"4.19.98-1+deb10u1")) flag++;
if (deb_check(release:"10.0", prefix:"linux-image-4.19.0-5-arm64-dbg", reference:"4.19.98-1+deb10u1")) flag++;
if (deb_check(release:"10.0", prefix:"linux-image-4.19.0-5-arm64", reference:"4.19.98-1+deb10u1")) flag++;
...
if (deb_check(release:"10.0", prefix:"linux-image-4.19.0-5-cloud-amd64", reference:"4.19.98-1+deb10u1")) flag++;
...
if (deb_check(release:"10.0", prefix:"linux-image-4.19.0-5-rt-686-pae", reference:"4.19.98-1+deb10u1")) flag++;
if (deb_check(release:"10.0", prefix:"linux-image-4.19.0-5-rt-amd64-dbg", reference:"4.19.98-1+deb10u1")) flag++;
if (deb_check(release:"10.0", prefix:"linux-image-4.19.0-5-rt-amd64", reference:"4.19.98-1+deb10u1")) flag++;
if (deb_check(release:"10.0", prefix:"linux-image-4.19.0-5-rt-arm64-dbg", reference:"4.19.98-1+deb10u1")) flag++;
if (deb_check(release:"10.0", prefix:"linux-image-4.19.0-5-rt-arm64", reference:"4.19.98-1+deb10u1")) flag++;
