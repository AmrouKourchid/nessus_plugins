...
# extracted from Fedora Security Advisory FEDORA-2023-1242b3ada2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-1242b3ada2");

  script_name(english:"Fedora 38 : attract-mode (2023-1242b3ada2)");
...
FEDORA-2023-1242b3ada2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-1242b3ada2");
  script_set_attribute(attribute:"solution", value:
"Update the affected attract-mode package.");
...
var pkgs = [
    {'reference':'attract-mode-2.7.0-5.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'attract-mode');
}
