...
# extracted from Debian Security Advisory DLA-1960-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1960-1 : wordpress security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2019/10/msg00023.html");
...
"Upgrade the affected packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2019-16222");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"wordpress", reference:"4.1.27+dfsg-0+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"wordpress-l10n", reference:"4.1.27+dfsg-0+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"wordpress-theme-twentyfifteen", reference:"4.1.27+dfsg-0+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"wordpress-theme-twentyfourteen", reference:"4.1.27+dfsg-0+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"wordpress-theme-twentythirteen", reference:"4.1.27+dfsg-0+deb8u1")) flag++;
