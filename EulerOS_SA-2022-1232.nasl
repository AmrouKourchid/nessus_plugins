...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : poppler (EulerOS-SA-2022-1232)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the poppler packages installed, the EulerOS installation on the remote host is affected by
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1232
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2ce4514e");
...
"Update the affected poppler packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:poppler-cpp");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:poppler-help");
...
var pkgs = [
  "poppler-0.67.0-5.h4.eulerosv2r10",
  "poppler-cpp-0.67.0-5.h4.eulerosv2r10",
  "poppler-help-0.67.0-5.h4.eulerosv2r10"
];
