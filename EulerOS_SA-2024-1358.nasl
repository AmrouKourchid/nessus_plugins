...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : grub2 (EulerOS-SA-2024-1358)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1358
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?64953179");
...
var pkgs = [
  ...
  "grub2-efi-aa64-2.04-16.h47.eulerosv2r10",
  "grub2-efi-aa64-modules-2.04-16.h47.eulerosv2r10",
