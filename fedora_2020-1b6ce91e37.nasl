...
# extracted from Fedora Security Advisory FEDORA-2020-1b6ce91e37.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : ansible (2020-1b6ce91e37)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-1b6ce91e37");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"ansible-2.9.7-1.fc30")) flag++;
