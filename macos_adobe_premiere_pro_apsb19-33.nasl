...
if (description)
{
  ...
  script_name(english:"Adobe Premiere Pro < 13.1.3 Arbitrary code execution (APSB19-33) (macOS)");
...
"The version of Adobe Premiere Pro installed on the remote macOS host is prior to 13.1.3. It is, therefore, affected by a
vulnerability as referenced in the APSB19-33 advisory.

  - Adobe Premiere Pro CC versions 13.1.2 and earlier have an insecure library loading (dll hijacking)
    vulnerability. Successful exploitation could lead to arbitrary code execution. (CVE-2019-7931)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://helpx.adobe.com/security/products/premiere_pro/apsb19-33.html");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Adobe Premiere Pro version 13.1.3 or later.");
