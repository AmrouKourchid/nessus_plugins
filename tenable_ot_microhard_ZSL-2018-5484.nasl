...
if (description)
{
  ...
  script_xref(name:"ZSL", value:"2018-5484");

  script_name(english:"Microhard 3G/4G Cellular Ethernet and Serial Gateway External Control of File Name or Path (ZSL-2018-5484)");

  script_set_attribute(attribute:"synopsis", value:
"The remote OT asset is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The system backup configuration file 'IPn4G.config' in '/' directory
or its respective name based on the model name including the similar
files in '/www/cgi-bin/system.conf', '/tmp' and the cli.conf in
'/etc/m_cli/' can be downloaded by an authenticated attacker in
certain circumstances. This will enable the attacker to disclose
sensitive information and help her in authentication bypass,
privilege escalation and/or full system access. 

This plugin only works with Tenable.ot.
Please visit https://www.tenable.com/products/tenable-ot for more information.");
  script_set_attribute(attribute:"see_also", value:"https://www.exploit-db.com/exploits/45036");
  script_set_attribute(attribute:"see_also", value:"https://www.zeroscience.mk/en/vulnerabilities/ZSL-2018-5484.php");
