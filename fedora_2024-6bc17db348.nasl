...
# extracted from Fedora Security Advisory FEDORA-2024-6bc17db348
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-6bc17db348");

  script_name(english:"Fedora 39 : rust (2024-6bc17db348)");
...
FEDORA-2024-6bc17db348 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-6bc17db348");
...
var pkgs = [
    {'reference':'rust-1.77.2-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
