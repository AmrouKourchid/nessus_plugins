...
# extracted from F5 Networks BIG-IP Solution K24551552.
#
# @NOAGENT@
##
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : Apache Tomcat vulnerability (K24551552)");

  script_set_attribute(attribute:"synopsis", value:
"The remote device is missing a vendor-supplied security patch.");
  script_set_attribute(attribute:"description", value:
"The version of F5 Networks BIG-IP installed on the remote host is prior to tested version. It is, therefore, affected by
a vulnerability as referenced in the K24551552 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K24551552");
...
var vmatrix = {
  'AFM': {
    'affected': [
      '17.1.0-17.5.0','16.0.0-16.1.5','15.0.0-15.1.10','14.1.0-14.1.5','13.1.0-13.1.5','12.1.0-12.1.6','11.5.2-11.6.5'
    ],
  },
  'APM': {
    'affected': [
