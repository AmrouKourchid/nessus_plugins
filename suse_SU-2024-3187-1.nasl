...
# SUSE update advisory SUSE-SU-2024:3187-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2024:3187-1");

  script_name(english:"openSUSE 15 Security Update : python-Django (SUSE-SU-2024:3187-1)");
...
SU-2024:3187-1 advisory.

    There is an issue with the previous fix for CVE-2024-45230. Please consider the following vulnerability
    fixed only after the installation of this update.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f2111ffa");
...
"Update the affected python3-Django package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-45230");
...
var pkgs = [
    {'reference':'python3-Django-2.0.7-150000.1.36.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.5']}
];
