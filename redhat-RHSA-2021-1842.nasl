...
# extracted from Red Hat Security Advisory RHSA-2021:1842. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:1842");

  script_name(english:"RHEL 8 : raptor2 (RHSA-2021:1842)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for raptor2.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2021:1842 advisory.
    ...
    * raptor: heap-based buffer overflows due to an error in calculating the maximum nspace declarations for
    the XML writer (CVE-2017-18926)

    * raptor2: malformed input file can lead to a segfault due to an out of bounds array access in
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_1842.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e8063568");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:1842");
...
"Update the RHEL raptor2 package based on the guidance in RHSA-2021:1842.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'raptor2-2.0.15-16.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'raptor2-devel-2.0.15-16.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
