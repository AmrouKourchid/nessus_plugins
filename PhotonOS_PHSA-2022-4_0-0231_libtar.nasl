...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Libtar PHSA-2022-4.0-0231");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libtar-1.2.20-6.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libtar-devel-1.2.20-6.ph4')) flag++;
