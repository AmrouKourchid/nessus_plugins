...
"The remote Red Hat host is missing a security update for mod_auth_kerb.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2006/rhsa-2006_0746.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2573cddb");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=216482");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2006:0746");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL mod_auth_kerb package based on the guidance in RHSA-2006:0746.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2006-5989");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'mod_auth_kerb-5.0-1.3', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mod_auth_kerb-5.0-1.3', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mod_auth_kerb-5.0-1.3', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mod_auth_kerb-5.0-1.3', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mod_auth_kerb-5.0-1.3', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
