...
if (description)
{
  ...
  script_name(english:"Debian dla-3454 : ffmpeg - security update");
...
dla-3454 advisory.
    ...
    - -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3454-1                debian-lts@lists.debian.org
    https://www.debian.org/lts/security/                      Sylvain Beucler
    June 13, 2023                                 https://wiki.debian.org/LTS
    - -------------------------------------------------------------------------

    Package        : ffmpeg
    Version        : 7:4.1.11-0+deb10u1
    CVE ID         : CVE-2022-3109 CVE-2022-3341
