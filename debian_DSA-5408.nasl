...
# extracted from Debian Security Advisory dsa-5408. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-5408-1 : libwebp - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has packages installed that are affected by a vulnerability as referenced in the dsa-5408
advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=1035371");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/libwebp");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2023/dsa-5408");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-1999");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bullseye/libwebp");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'libwebp-dev', 'reference': '0.6.1-2.1+deb11u1'},
    {'release': '11.0', 'prefix': 'libwebp6', 'reference': '0.6.1-2.1+deb11u1'},
    {'release': '11.0', 'prefix': 'libwebpdemux2', 'reference': '0.6.1-2.1+deb11u1'},
    {'release': '11.0', 'prefix': 'libwebpmux3', 'reference': '0.6.1-2.1+deb11u1'},
    {'release': '11.0', 'prefix': 'webp', 'reference': '0.6.1-2.1+deb11u1'}
];
