...
# extracted from Gentoo Linux Security Advisory GLSA 202009-08.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202009-08");

  script_name(english:"GLSA-202009-08 : GNOME Shell: Information disclosure");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202009-08
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202009-08");
...
if (qpkg_check(package:"gnome-base/gnome-shell", unaffected:make_list("ge 3.34.5-r1"), vulnerable:make_list("lt 3.34.5-r1"))) flag++;
