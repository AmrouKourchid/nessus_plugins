...
if (description)
{
  ...
  script_cve_id("CVE-2024-24699");

  script_name(english:"Zoom VDI Meeting Client < 5.17.5 Vulnerability (ZSB-24006)");
...
vulnerability as referenced in the ZSB-24006 advisory.

  - Business logic error in some Zoom clients may allow an authenticated user to conduct information
    disclosure via network access. (CVE-2024-24699)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.zoom.com/en/trust/security-bulletin/ZSB-24006");
...
"Upgrade to Zoom VDI Meeting Client 5.17.5 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-24699");
