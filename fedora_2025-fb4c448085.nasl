...
# extracted from Fedora Security Advisory FEDORA-2025-fb4c448085
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-fb4c448085");

  script_name(english:"Fedora 41 : python3.10 (2025-fb4c448085)");
...
FEDORA-2025-fb4c448085 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-fb4c448085");
...
var pkgs = [
    {'reference':'python3.10-3.10.16-5.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
