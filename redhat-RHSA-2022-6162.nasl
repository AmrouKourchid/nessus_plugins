...
# extracted from Red Hat Security Advisory RHSA-2022:6162. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:6162");

  script_name(english:"RHEL 8 : systemd (RHSA-2022:6162)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for systemd.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2022:6162 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_6162.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9c2681c0");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:6162");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2109926");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL systemd package based on the guidance in RHSA-2022:6162.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'systemd-239-31.el8_2.9', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-container-239-31.el8_2.9', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-devel-239-31.el8_2.9', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-journal-remote-239-31.el8_2.9', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-libs-239-31.el8_2.9', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-pam-239-31.el8_2.9', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-tests-239-31.el8_2.9', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-udev-239-31.el8_2.9', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
