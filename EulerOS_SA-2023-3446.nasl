...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : procps-ng (EulerOS-SA-2023-3446)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3446
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?330bbec2");
...
var pkgs = [
  "procps-ng-3.3.15-4.h12.eulerosv2r8",
  "procps-ng-i18n-3.3.15-4.h12.eulerosv2r8"
];
