...
# extracted from Red Hat Security Advisory kdebase. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2007-3143", "CVE-2007-6591");

  script_name(english:"RHEL 5 : kdebase (Unpatched Vulnerability) (deprecated)");
