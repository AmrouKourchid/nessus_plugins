...
# extracted from Fedora Security Advisory FEDORA-2023-aaeb45fb73
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-aaeb45fb73");

  script_name(english:"Fedora 37 : netatalk (2023-aaeb45fb73)");
...
FEDORA-2023-aaeb45fb73 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-aaeb45fb73");
...
var pkgs = [
    {'reference':'netatalk-3.1.14-3.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'5'}
];
