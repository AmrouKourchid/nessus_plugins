...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : ruby (EulerOS-SA-2023-2392)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2392
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4538b5a7");
...
var pkgs = [
  "ruby-2.5.8-112.h11.eulerosv2r10",
  "ruby-help-2.5.8-112.h11.eulerosv2r10",
  "ruby-irb-2.5.8-112.h11.eulerosv2r10"
];
