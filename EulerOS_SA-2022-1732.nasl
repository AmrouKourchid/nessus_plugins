...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : java-1.7.0-openjdk (EulerOS-SA-2022-1732)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1732
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4ab3ce80");
...
var pkgs = [
  "java-1.7.0-openjdk-1.7.0.191-2.6.15.4.h12",
