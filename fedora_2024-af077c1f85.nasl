...
# extracted from Fedora Security Advisory FEDORA-2024-af077c1f85
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-af077c1f85");

  script_name(english:"Fedora 41 : mingw-libsoup (2024-af077c1f85)");
...
FEDORA-2024-af077c1f85 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-af077c1f85");
...
var pkgs = [
    {'reference':'mingw-libsoup-2.74.3-8.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
