...
# extracted from Ubuntu Security Notice USN-6909-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6909-2");
  script_xref(name:"IAVA", value:"2024-A-0442-S");

  script_name(english:"Ubuntu 18.04 LTS : Bind vulnerabilities (USN-6909-2)");
...
the USN-6909-2 advisory.

    USN-6909-1 fixed several vulnerabilities in Bind. This update provides the corresponding update for Ubuntu
    18.04 LTS.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6909-2");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'bind9', 'pkgver': '1:9.11.3+dfsg-1ubuntu1.19+esm4', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'bind9-host', 'pkgver': '1:9.11.3+dfsg-1ubuntu1.19+esm4', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'bind9utils', 'pkgver': '1:9.11.3+dfsg-1ubuntu1.19+esm4', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'dnsutils', 'pkgver': '1:9.11.3+dfsg-1ubuntu1.19+esm4', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libbind-dev', 'pkgver': '1:9.11.3+dfsg-1ubuntu1.19+esm4', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libbind-export-dev', 'pkgver': '1:9.11.3+dfsg-1ubuntu1.19+esm4', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libbind9-160', 'pkgver': '1:9.11.3+dfsg-1ubuntu1.19+esm4', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libdns-export1100', 'pkgver': '1:9.11.3+dfsg-1ubuntu1.19+esm4', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libdns1100', 'pkgver': '1:9.11.3+dfsg-1ubuntu1.19+esm4', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libirs-export160', 'pkgver': '1:9.11.3+dfsg-1ubuntu1.19+esm4', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libirs160', 'pkgver': '1:9.11.3+dfsg-1ubuntu1.19+esm4', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libisc-export169', 'pkgver': '1:9.11.3+dfsg-1ubuntu1.19+esm4', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libisc169', 'pkgver': '1:9.11.3+dfsg-1ubuntu1.19+esm4', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libisccc-export160', 'pkgver': '1:9.11.3+dfsg-1ubuntu1.19+esm4', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libisccc160', 'pkgver': '1:9.11.3+dfsg-1ubuntu1.19+esm4', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libisccfg-export160', 'pkgver': '1:9.11.3+dfsg-1ubuntu1.19+esm4', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libisccfg160', 'pkgver': '1:9.11.3+dfsg-1ubuntu1.19+esm4', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'liblwres160', 'pkgver': '1:9.11.3+dfsg-1ubuntu1.19+esm4', 'ubuntu_pro': TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'bind9 / bind9-host / bind9utils / dnsutils / libbind-dev / etc');
}
