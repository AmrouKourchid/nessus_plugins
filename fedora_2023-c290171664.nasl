...
# extracted from Fedora Security Advisory FEDORA-2023-c290171664
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-c290171664");

  script_name(english:"Fedora 37 : tor (2023-c290171664)");
...
FEDORA-2023-c290171664 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-c290171664");
...
var pkgs = [
    {'reference':'tor-0.4.7.13-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
