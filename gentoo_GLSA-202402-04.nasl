...
# extracted from Gentoo Linux Security Advisory GLSA 202402-04.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202402-04 : GNAT Ada Suite: Remote Code Execution");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202402-04 (GNAT Ada Suite: Remote Code Execution)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202402-04");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=787440");
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'GNAT Ada Suite');
}
