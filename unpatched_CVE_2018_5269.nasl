...
if (description)
{
  ...
  script_cve_id("CVE-2018-5269");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2018-5269");
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"vuln_publication_date", value:"2018/01/08");
