...
# extracted from Red Hat Security Advisory RHSA-2024:6356. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:6356");

  script_name(english:"RHEL 9 : bubblewrap and flatpak (RHSA-2024:6356)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for bubblewrap / flatpak.");
...
the RHSA-2024:6356 advisory.

    Bubblewrap (/usr/bin/bwrap) is a core execution engine for unprivileged containers that works as a setuid
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_6356.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5bf75b6d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:6356");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL bubblewrap / flatpak packages based on the guidance in RHSA-2024:6356.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:flatpak-selinux");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:flatpak-session-helper");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'flatpak-1.12.9-3.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'flatpak-devel-1.12.9-3.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'flatpak-libs-1.12.9-3.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'flatpak-selinux-1.12.9-3.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'flatpak-session-helper-1.12.9-3.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'bubblewrap-0.4.1-7.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'flatpak-1.12.9-3.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'flatpak-devel-1.12.9-3.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'flatpak-libs-1.12.9-3.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'flatpak-selinux-1.12.9-3.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'flatpak-session-helper-1.12.9-3.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'bubblewrap-0.4.1-7.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'bubblewrap / flatpak / flatpak-devel / flatpak-libs / etc');
}
