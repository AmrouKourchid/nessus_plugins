...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.0 : libssh (EulerOS-SA-2023-2561)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2561
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3d21a72a");
...
var pkgs = [
  "libssh-0.9.4-3.h12.eulerosv2r10"
];
