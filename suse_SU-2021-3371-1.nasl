...
if (description)
{
  ...
  script_name(english:"SUSE SLES15 Security Update : kernel (Live Patch 25 for SLE 15) (SUSE-SU-2021:3371-1)");
...
var pkgs = [
    {'reference':'kernel-livepatch-4_12_14-150_75-default-4-2.1', 'sp':'0', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15']}
];
