...
# extracted from Fedora Security Advisory FEDORA-2023-45b3c1d9ed
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-45b3c1d9ed");

  script_name(english:"Fedora 37 : firefox (2023-45b3c1d9ed)");
...
FEDORA-2023-45b3c1d9ed advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-45b3c1d9ed");
...
var pkgs = [
    {'reference':'firefox-113.0-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
