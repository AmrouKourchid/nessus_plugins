...
# extracted from Fedora Security Advisory FEDORA-2023-cdce244fb8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-cdce244fb8");

  script_name(english:"Fedora 37 : maradns (2023-cdce244fb8)");
...
FEDORA-2023-cdce244fb8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-cdce244fb8");
...
var pkgs = [
    {'reference':'maradns-3.5.0036-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
