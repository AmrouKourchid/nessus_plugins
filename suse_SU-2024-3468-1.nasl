...
# SUSE update advisory SUSE-SU-2024:3468-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2023-52846", "CVE-2024-40909");
  script_xref(name:"SuSE", value:"SUSE-SU-2024:3468-1");

  script_name(english:"SUSE SLES15 Security Update : kernel (Live Patch 1 for SLE 15 SP6) (SUSE-SU-2024:3468-1)");
...
the SUSE-SU-2024:3468-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2024-September/019531.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c4215ff0");
...
"Update the affected kernel-livepatch-6_4_0-150600_23_7-default package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-40909");
...
var kernel_live_checks = [
  {
    'kernels': {
      '6.4.0-150600.23.7-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-6_4_0-150600_23_7-default-2-150600.2.1', 'sp':'6', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.6']}
        ]
      }
    }
  }
