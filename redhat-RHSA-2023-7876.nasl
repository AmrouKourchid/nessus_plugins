...
# extracted from Red Hat Security Advisory RHSA-2023:7876. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:7876");

  script_name(english:"RHEL 8 : opensc (RHSA-2023:7876)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for opensc.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has a package installed that is affected by multiple vulnerabilities as
referenced in the RHSA-2023:7876 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_7876.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9e8f905c");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:7876");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL opensc package based on the guidance in RHSA-2023:7876.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'opensc-0.20.0-7.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
