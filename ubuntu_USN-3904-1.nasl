...
# extracted from Ubuntu Security Notice USN-3904-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS : NVIDIA graphics drivers vulnerability (USN-3904-1)");
...
USN-3904-1 advisory.
    ...
    It was discovered that the NVIDIA graphics drivers incorrectly handled the GPU performance counters. A
    local attacker could possibly use this issue to access the application data processed on the GPU.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3904-1");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'libcuda1-384', 'pkgver': '390.116-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'libnvidia-cfg1-390', 'pkgver': '390.116-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'libnvidia-common-390', 'pkgver': '390.116-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'libnvidia-compute-390', 'pkgver': '390.116-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'libnvidia-decode-390', 'pkgver': '390.116-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'libnvidia-encode-390', 'pkgver': '390.116-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'libnvidia-fbc1-390', 'pkgver': '390.116-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'libnvidia-gl-390', 'pkgver': '390.116-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'libnvidia-ifr1-390', 'pkgver': '390.116-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'nvidia-384', 'pkgver': '390.116-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'nvidia-384-dev', 'pkgver': '390.116-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'nvidia-compute-utils-390', 'pkgver': '390.116-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'nvidia-dkms-390', 'pkgver': '390.116-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'nvidia-driver-390', 'pkgver': '390.116-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'nvidia-headless-390', 'pkgver': '390.116-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'nvidia-headless-no-dkms-390', 'pkgver': '390.116-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'nvidia-kernel-common-390', 'pkgver': '390.116-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'nvidia-kernel-source-390', 'pkgver': '390.116-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'nvidia-libopencl1-384', 'pkgver': '390.116-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'nvidia-opencl-icd-384', 'pkgver': '390.116-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'nvidia-utils-390', 'pkgver': '390.116-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'xserver-xorg-video-nvidia-390', 'pkgver': '390.116-0ubuntu0.18.04.1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libcuda1-384 / libnvidia-cfg1-390 / libnvidia-common-390 / etc');
}
