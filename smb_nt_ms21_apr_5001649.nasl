...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5001649");
  script_xref(name:"MSFT", value:"MS21-5001649");

  script_name(english:"KB5001649: Windows 10 version 2004 / Windows 10 version 20H2 OOB Update (Mar 2021) (deprecated)");
...
Nessus has not tested for this issue but has instead relied only on the application's self-reported version number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5001649");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released KB5001649 to address this issue.");
