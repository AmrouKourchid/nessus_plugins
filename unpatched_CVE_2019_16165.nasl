...
if (description)
{
  ...
  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2019-16165");
...
patch available.
  ...
  - GNU cflow through 1.6 has a use-after-free in the reference function in parser.c. (CVE-2019-16165)
