...
# extracted from Debian Security Advisory DLA-1585-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1585-1 : ruby-rack security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2018/11/msg00022.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/jessie/ruby-rack");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"ruby-rack", reference:"1.5.2-3+deb8u2")) flag++;
