...
# extracted from Fedora Security Advisory FEDORA-2018-8d8f0e1643.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2017-13685", "CVE-2017-15286");
  script_xref(name:"FEDORA", value:"2018-8d8f0e1643");

  script_name(english:"Fedora 27 : sqlite (2018-8d8f0e1643)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"Security fix for CVE-2017-13685 CVE-2017-15286

Note that Tenable Network Security has extracted the preceding
description block directly from the Fedora update system website.
Tenable has attempted to automatically clean and format it as much as
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-8d8f0e1643");
...
"Update the affected sqlite package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-15286");
...
flag = 0;
if (rpm_check(release:"FC27", reference:"sqlite-3.20.1-3.fc27")) flag++;
