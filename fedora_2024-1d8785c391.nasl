...
# extracted from Fedora Security Advisory FEDORA-2024-1d8785c391
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-1d8785c391");

  script_name(english:"Fedora 41 : firefox (2024-1d8785c391)");
...
FEDORA-2024-1d8785c391 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-1d8785c391");
...
var pkgs = [
    {'reference':'firefox-131.0-2.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
