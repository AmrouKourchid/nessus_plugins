...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Bindutils PHSA-2020-2.0-0223");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'bindutils-9.15.6-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'bindutils-debuginfo-9.15.6-1.ph2')) flag++;
