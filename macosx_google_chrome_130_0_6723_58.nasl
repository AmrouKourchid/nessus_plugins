...
"The version of Google Chrome installed on the remote macOS host is prior to 130.0.6723.58. It is, therefore, affected by
multiple vulnerabilities as referenced in the 2024_10_stable-channel-update-for-desktop_15 advisory.
...
google_chrome_check_version(fix:'130.0.6723.58', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
