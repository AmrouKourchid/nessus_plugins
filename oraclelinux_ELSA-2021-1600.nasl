...
# extracted from Oracle Linux Security Advisory ELSA-2021-1600.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : opensc (ELSA-2021-1600)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2021-1600.html");
