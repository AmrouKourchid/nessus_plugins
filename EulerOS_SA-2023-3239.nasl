...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : curl (EulerOS-SA-2023-3239)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3239
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fc7a6fb1");
...
var pkgs = [
  "curl-7.79.1-2.h25.eulerosv2r11",
  "libcurl-7.79.1-2.h25.eulerosv2r11"
];
