...
# extracted from Ubuntu Security Notice USN-2532-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : cups-filters vulnerability (USN-2532-1)");
...
USN-2532-1 advisory.
    ...
    It was discovered that cups-browsed incorrectly filtered remote printer names and strings. A remote
    attacker could use this issue to possibly execute arbitrary commands.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2532-1");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-2265");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'cups-browsed', 'pkgver': '1.0.52-0ubuntu1.4'},
    {'osver': '14.04', 'pkgname': 'cups-filters', 'pkgver': '1.0.52-0ubuntu1.4'},
    {'osver': '14.04', 'pkgname': 'cups-filters-core-drivers', 'pkgver': '1.0.52-0ubuntu1.4'},
    {'osver': '14.04', 'pkgname': 'libcupsfilters-dev', 'pkgver': '1.0.52-0ubuntu1.4'},
    {'osver': '14.04', 'pkgname': 'libcupsfilters1', 'pkgver': '1.0.52-0ubuntu1.4'},
    {'osver': '14.04', 'pkgname': 'libfontembed-dev', 'pkgver': '1.0.52-0ubuntu1.4'},
    {'osver': '14.04', 'pkgname': 'libfontembed1', 'pkgver': '1.0.52-0ubuntu1.4'}
];
