...
# extracted from Fedora Security Advisory FEDORA-2022-6728f16289
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-6728f16289");

  script_name(english:"Fedora 38 : python3.9 (2022-6728f16289)");
...
FEDORA-2022-6728f16289 advisory.
    ...
    ```
    * Wed Nov  9 2022 Lumr Balhar <lbalhar@redhat.com> - 3.9.15-2
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-6728f16289");
...
var pkgs = [
    {'reference':'python3.9-3.9.15-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
