...
# extracted from Red Hat Security Advisory RHSA-2022:5326. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:5326");

  script_name(english:"RHEL 8 : compat-openssl10 (RHSA-2022:5326)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for compat-openssl10.");
...
the RHSA-2022:5326 advisory.

    OpenSSL is a toolkit that implements the Secure Sockets Layer (SSL) and Transport Layer Security (TLS)
    protocols, as well as a full-strength general-purpose cryptography library. compat-openssl10 provides the
    legacy 1.0 version of OpenSSL for use with older binaries.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_5326.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8e765039");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:5326");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2062202");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL compat-openssl10 package based on the guidance in RHSA-2022:5326.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'compat-openssl10-1.0.2o-4.el8_6', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'compat-openssl10-1.0.2o-4.el8_6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
