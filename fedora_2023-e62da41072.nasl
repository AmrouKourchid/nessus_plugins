...
# extracted from Fedora Security Advisory FEDORA-2023-e62da41072
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-e62da41072");
  script_xref(name:"IAVB", value:"2023-B-0090-S");

  script_name(english:"Fedora 37 : xen (2023-e62da41072)");
...
FEDORA-2023-e62da41072 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-e62da41072");
...
var pkgs = [
    {'reference':'xen-4.16.5-4.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
