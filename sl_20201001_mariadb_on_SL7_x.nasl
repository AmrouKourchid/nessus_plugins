...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : mariadb on SL7.x x86_64 (20201001)");
...
"Security Fix(es) :
  ...
  - mysql: Server: Optimizer unspecified vulnerability (CPU
    Oct 2019) (CVE-2019-2974)

  - mysql: C API unspecified vulnerability (CPU Apr 2020)
    (CVE-2020-2752)

  - mysql: Server: DML unspecified vulnerability (CPU Apr
    2020) (CVE-2020-2780)

  - mysql: Server: Stored Procedure unspecified
    vulnerability (CPU Apr 2020) (CVE-2020-2812)

  - mysql: C API: unspecified vulnerability (CPU Jan 2020)
    (CVE-2020-2574)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind2010&L=SCIENTIFIC-LINUX-ERRATA&P=19020
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?50bf91a9");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"mariadb-5.5.68-1.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"mariadb-bench-5.5.68-1.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"mariadb-debuginfo-5.5.68-1.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"mariadb-devel-5.5.68-1.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"mariadb-embedded-5.5.68-1.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"mariadb-embedded-devel-5.5.68-1.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"mariadb-libs-5.5.68-1.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"mariadb-server-5.5.68-1.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"mariadb-test-5.5.68-1.el7")) flag++;
