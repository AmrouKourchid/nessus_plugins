...
# extracted from Fedora Security Advisory FEDORA-2024-59a7d96d84
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-59a7d96d84");

  script_name(english:"Fedora 38 : atril (2024-59a7d96d84)");
...
FEDORA-2024-59a7d96d84 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-59a7d96d84");
  script_set_attribute(attribute:"solution", value:
"Update the affected atril package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:atril");
...
var pkgs = [
    {'reference':'atril-1.26.2-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'atril');
}
