...
if (description)
{
  ...
  script_cve_id("CVE-2024-32612");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-32612");
...
patch available.
  ...
  - HDF5 Library through 1.14.3 contains a heap-based buffer over-read in H5HL__fl_deserialize in H5HLcache.c,
    resulting in the corruption of the instruction pointer, a different vulnerability than CVE-2024-32613.
    (CVE-2024-32612)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-32612");
