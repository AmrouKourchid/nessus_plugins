...
# extracted from Fedora Security Advisory FEDORA-2019-1caffa01f2.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : openconnect (2019-1caffa01f2)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-1caffa01f2");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"openconnect-8.05-1.fc30")) flag++;
