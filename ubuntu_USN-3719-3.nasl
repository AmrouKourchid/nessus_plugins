...
the USN-3719-3 advisory.

    USN-3719-1 fixed vulnerabilities in Mutt. Unfortunately, the fixes were not correctly applied to the
    packaging for Mutt in Ubuntu 16.04 LTS. This update corrects the oversight.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3719-3");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'mutt', 'pkgver': '1.5.24-1ubuntu0.2'},
    {'osver': '16.04', 'pkgname': 'mutt-patched', 'pkgver': '1.5.24-1ubuntu0.2'}
];
