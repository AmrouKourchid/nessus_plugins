...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : newt (ELSA-2009-1463)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2009-1463.html");
...
"Update the affected newt and / or newt-devel packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2009-2905");
...
var pkgs = [
    {'reference':'newt-0.52.2-12.el5_4.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'newt-devel-0.52.2-12.el5_4.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'newt-0.52.2-12.el5_4.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'newt-devel-0.52.2-12.el5_4.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
