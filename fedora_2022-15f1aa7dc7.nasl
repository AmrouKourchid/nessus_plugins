...
# extracted from Fedora Security Advisory FEDORA-2022-15f1aa7dc7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-15f1aa7dc7");

  script_name(english:"Fedora 36 : pypy3.8 (2022-15f1aa7dc7)");
...
FEDORA-2022-15f1aa7dc7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-15f1aa7dc7");
...
var pkgs = [
    {'reference':'pypy3.8-7.3.9-5.3.8.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
