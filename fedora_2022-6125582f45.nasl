...
# extracted from Fedora Security Advisory FEDORA-2022-6125582f45
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-6125582f45");
  script_xref(name:"IAVA", value:"2022-A-0338-S");

  script_name(english:"Fedora 36 : exim (2022-6125582f45)");
...
FEDORA-2022-6125582f45 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-6125582f45");
...
var pkgs = [
    {'reference':'exim-4.96-4.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
