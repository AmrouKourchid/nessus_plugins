...
# extracted from Fedora Security Advisory FEDORA-2024-5dacab5f00
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-5dacab5f00");

  script_name(english:"Fedora 40 : chromium (2024-5dacab5f00)");
...
FEDORA-2024-5dacab5f00 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-5dacab5f00");
...
var pkgs = [
    {'reference':'chromium-122.0.6261.111-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
