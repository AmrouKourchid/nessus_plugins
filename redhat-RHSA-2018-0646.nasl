...
# extracted from Red Hat Security Advisory RHSA-2018:0646. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:0646");

  script_name(english:"RHEL 7 : python-paramiko (RHSA-2018:0646)");
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_0646.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?37bc376c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:0646");
...
"Update the RHEL python-paramiko package based on the guidance in RHSA-2018:0646.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python-paramiko-2.1.1-4.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2'}
    ]
  }
];
