...
# extracted from Fedora Security Advisory FEDORA-2023-d8a7c6928a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-d8a7c6928a");

  script_name(english:"Fedora 39 : dotnet6.0 (2023-d8a7c6928a)");
...
FEDORA-2023-d8a7c6928a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-d8a7c6928a");
...
var pkgs = [
    {'reference':'dotnet6.0-6.0.125-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
