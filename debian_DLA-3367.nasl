...
# extracted from Debian Security Advisory dla-3367. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3367 : libdatetime-timezone-perl - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has a package installed that is affected by a vulnerability as referenced in the dla-3367
advisory.
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libdatetime-timezone-perl', 'reference': '1:2.23-1+2023b'}
];
