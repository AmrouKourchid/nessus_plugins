...
# extracted from Fedora Security Advisory FEDORA-2024-2a466c6514
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-2a466c6514");

  script_name(english:"Fedora 40 : freeipa (2024-2a466c6514)");
...
FEDORA-2024-2a466c6514 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-2a466c6514");
...
var pkgs = [
    {'reference':'freeipa-4.12.1-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
