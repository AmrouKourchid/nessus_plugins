...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5002162");
  script_xref(name:"MSKB", value:"5002169");
  script_xref(name:"MSFT", value:"MS22-5002162");
  script_xref(name:"MSFT", value:"MS22-5002169");
  script_xref(name:"IAVA", value:"2022-A-0140-S");
  script_xref(name:"IAVA", value:"2022-A-0144-S");

  script_name(english:"Security Updates for Microsoft Office Web Apps (April 2022)");
...
arbitrary commands.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002162");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002169");
...
var kbs = make_list('5002162', '5002169');
...
if (owa_2013_path && (!isnull(owa_2013_sp) && owa_2013_sp == '1'))
{
  ...
  if (hotfix_check_fversion(file:'sword.dll', version:'15.0.5441.1000', min_version:'15.0.0.0', path:path, kb:'5002169', product:'Office Web Apps 2013') == HCF_OLDER)
    vuln = TRUE;
}
...
if (oos_path && (!isnull(oos_sp) && oos_sp == '0'))
{
  ...
  if (hotfix_check_fversion(file:'sword.dll', version:'16.0.10385.20001', min_version:'16.0.10000.0', path:path, kb:'5002162', product:'Office Online Server') == HCF_OLDER)
    vuln = TRUE;
}
