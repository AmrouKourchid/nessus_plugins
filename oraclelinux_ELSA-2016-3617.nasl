...
the ELSA-2016-3617 advisory.
    ...
    - Btrfs: fix truncation of compressed and inlined extents (Ashish Samant)  [Orabug: 22307285]
    {CVE-2015-8374}
    - Btrfs: fix file corruption and data loss after cloning inline extents (Divya Indi)  [Orabug: 22307285]
    {CVE-2015-8374}
    ...
    - netfilter: x_tables: validate e->target_offset early (Florian Westphal)  [Orabug: 24682074]
...
var pkgs = [
    ...
    {'reference':'kernel-uek-doc-3.8.13-118.11.2.el6uek', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-doc-3.8.13'},
    {'reference':'kernel-uek-firmware-3.8.13-118.11.2.el6uek', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-firmware-3.8.13'},
    ...
    {'reference':'kernel-uek-doc-3.8.13-118.11.2.el7uek', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-doc-3.8.13'},
    {'reference':'kernel-uek-firmware-3.8.13-118.11.2.el7uek', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-firmware-3.8.13'}
];
