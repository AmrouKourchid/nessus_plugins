...
# extracted from SUSE update advisory SUSE-SU-2018:0293-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : nodejs6 (SUSE-SU-2018:0293-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"This update for nodejs6 fixes the following issues: Security issues
fixed :
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://nodejs.org/en/blog/release/v6.11.2/");
  script_set_attribute(attribute:"see_also", value:"https://nodejs.org/en/blog/release/v6.11.3/");
  script_set_attribute(attribute:"see_also", value:"https://nodejs.org/en/blog/release/v6.11.4/");
  script_set_attribute(attribute:"see_also", value:"https://nodejs.org/en/blog/release/v6.11.5/");
  script_set_attribute(attribute:"see_also", value:"https://nodejs.org/en/blog/release/v6.12.0/");
  script_set_attribute(attribute:"see_also", value:"https://nodejs.org/en/blog/release/v6.12.1/");
  script_set_attribute(attribute:"see_also", value:"https://nodejs.org/en/blog/release/v6.12.2/");
  ...
  # https://www.suse.com/support/update/announcement/2018/suse-su-20180293-1/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0fe42fb7");
  script_set_attribute(attribute:"solution", value:
"To install this SUSE Security Update use YaST online_update.
Alternatively you can run the command listed for your product :

SUSE OpenStack Cloud 7:zypper in -t patch
SUSE-OpenStack-Cloud-7-2018-203=1

SUSE Linux Enterprise Module for Web Scripting 12:zypper in -t patch
SUSE-SLE-Module-Web-Scripting-12-2018-203=1

SUSE Enterprise Storage 4:zypper in -t patch SUSE-Storage-4-2018-203=1
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"0", reference:"nodejs6-6.12.2-11.8.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"nodejs6-debuginfo-6.12.2-11.8.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"nodejs6-debugsource-6.12.2-11.8.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"nodejs6-devel-6.12.2-11.8.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"npm6-6.12.2-11.8.1")) flag++;
