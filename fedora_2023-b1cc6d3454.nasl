...
# extracted from Fedora Security Advisory FEDORA-2023-b1cc6d3454
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-b1cc6d3454");

  script_name(english:"Fedora 36 : firefox (2023-b1cc6d3454)");
...
FEDORA-2023-b1cc6d3454 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-b1cc6d3454");
...
var pkgs = [
    {'reference':'firefox-109.0-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
