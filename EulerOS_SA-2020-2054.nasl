...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.6.0 : qemu-kvm (EulerOS-SA-2020-2054)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2054
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?803cad55");
...
"Update the affected qemu-kvm package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-16092");
...
pkgs = ["qemu-img-2.8.1-30.456",
        "qemu-kvm-2.8.1-30.456",
        "qemu-kvm-common-2.8.1-30.456",
        "qemu-kvm-tools-2.8.1-30.456"];
