...
# extracted from Red Hat Security Advisory RHSA-2016:0049 and 
# Oracle Linux Security Advisory ELSA-2016-0049 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : java-1.8.0-openjdk (ELSA-2016-0049)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 7 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ELSA-2016-0049 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2016-0049.html");
...
var pkgs = [
    ...
    {'reference':'java-1.8.0-openjdk-javadoc-1.8.0.71-2.b15.el7_2', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'java-1.8.0-openjdk-javadoc-debug-1.8.0.71-2.b15.el7_2', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
