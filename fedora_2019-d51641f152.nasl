...
# extracted from Fedora Security Advisory FEDORA-2019-d51641f152.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-d51641f152");

  script_name(english:"Fedora 29 : 1:openssl (2019-d51641f152)");
...
Fix for TLS non-compliance causing server interoperability problems
with golang TLS client.

Note that Tenable Network Security has extracted the preceding
description block directly from the Fedora update system website.
Tenable has attempted to automatically clean and format it as much as
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-d51641f152");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"openssl-1.1.1d-1.fc29", epoch:"1")) flag++;
