...
# extracted from Red Hat Security Advisory RHSA-2020:0487. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:0487");

  script_name(english:"RHEL 8 : sudo (RHSA-2020:0487)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_0487.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?11eecfd6");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:0487");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1796944");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL sudo package based on the guidance in RHSA-2020:0487.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'sudo-1.8.25p1-8.el8_1.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'sudo-1.8.25p1-8.el8_1.1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
