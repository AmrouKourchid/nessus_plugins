...
# extracted from Fedora Security Advisory FEDORA-2024-afa796a751
#
...
if (description)
{
  ...
  script_cve_id("CVE-2024-9675", "CVE-2024-9676", "CVE-2024-21626");
  script_xref(name:"FEDORA", value:"2024-afa796a751");

  script_name(english:"Fedora 40 : podman-tui (2024-afa796a751)");
...
FEDORA-2024-afa796a751 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-afa796a751");
...
var pkgs = [
    {'reference':'podman-tui-1.2.3-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
