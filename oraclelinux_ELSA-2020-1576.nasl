...
# extracted from Oracle Linux Security Advisory ELSA-2020-1576.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : memcached (ELSA-2020-1576)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2020-1576.html");
