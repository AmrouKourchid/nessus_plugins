...
ELSA-2018-0151 advisory.
    ...
    - [x86] spec_ctrl: don't call ptrace_has_cap in the IBPB ctx switch optimization (Andrea Arcangeli)
    [1519795 1519798] {CVE-2017-5715}
    - [x86] kaiser/efi: unbreak EFI old_memmap (Andrea Arcangeli) [1519795 1519798] {CVE-2017-5715}
    - [x86] cpuidle_idle_call: fix double local_irq_enable() (Andrea Arcangeli) [1519795 1519798]
    {CVE-2017-5715}
    - [x86] entry: Invoke TRACE_IRQS_IRETQ in paranoid_userspace_restore_all (Andrea Arcangeli) [1519795
    1519798] {CVE-2017-5715}
    - [x86] cpu: fix get_scattered_cpu_leaf sorting part #2 (Andrea Arcangeli) [1519795 1519798]
    {CVE-2017-5715}
    - [x86] spec_ctrl: show added cpuid flags in /proc/cpuinfo after late microcode update (Andrea Arcangeli)
    [1519795 1519798] {CVE-2017-5715}
...
var pkgs = [
    ...
    {'reference':'kernel-abi-whitelists-3.10.0-693.17.1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-abi-whitelists-3.10.0'},
