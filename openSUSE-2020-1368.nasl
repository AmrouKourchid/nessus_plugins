...
# extracted from openSUSE Security Update openSUSE-2020-1368.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libX11 (openSUSE-2020-1368)");
...
"This update for libX11 fixes the following issues :
  ...
  - CVE-2020-14363: Fix an integer overflow in init_om()
    (bsc#1175239).

This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1175239");
...
if ( rpm_check(release:"SUSE15.1", reference:"libX11-6-1.6.5-lp151.4.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libX11-6-debuginfo-1.6.5-lp151.4.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libX11-data-1.6.5-lp151.4.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libX11-debugsource-1.6.5-lp151.4.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libX11-devel-1.6.5-lp151.4.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libX11-xcb1-1.6.5-lp151.4.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libX11-xcb1-debuginfo-1.6.5-lp151.4.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libX11-6-32bit-1.6.5-lp151.4.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libX11-6-32bit-debuginfo-1.6.5-lp151.4.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libX11-devel-32bit-1.6.5-lp151.4.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libX11-xcb1-32bit-1.6.5-lp151.4.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libX11-xcb1-32bit-debuginfo-1.6.5-lp151.4.9.1") ) flag++;
