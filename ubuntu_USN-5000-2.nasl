...
the USN-5000-2 advisory.
    ...
    USN-5000-1 fixed vulnerabilities in the Linux kernel for Ubuntu 20.04 LTS and the Linux HWE kernel for
    Ubuntu 18.04 LTS. This update provides the corresponding updates for the Linux KVM kernel for Ubuntu 20.04
    LTS.
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-5000-2');
}
