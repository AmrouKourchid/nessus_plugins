...
# SUSE update advisory SUSE-SU-2025:0158-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2025:0158-1");

  script_name(english:"SUSE SLES15 Security Update : kernel (Live Patch 10 for SLE 15 SP5) (SUSE-SU-2025:0158-1)");
...
the SUSE-SU-2025:0158-1 advisory.
    ...
    - CVE-2023-52340: Fixed a denial of service related to ICMPv6 'Packet Too Big' packets ().
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2025-January/020154.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e803501a");
...
var kernel_live_checks = [
  {
    'kernels': {
      '5.14.21-150500.55.49-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_14_21-150500_55_49-default-12-150500.11.8.1', 'sp':'5', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.5']}
        ]
      }
    }
  }
