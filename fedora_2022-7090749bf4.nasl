...
# extracted from Fedora Security Advisory FEDORA-2022-7090749bf4
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-7090749bf4");

  script_name(english:"Fedora 37 : efl / enlightenment (2022-7090749bf4)");
...
FEDORA-2022-7090749bf4 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-7090749bf4");
  script_set_attribute(attribute:"solution", value:
"Update the affected efl and / or enlightenment packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:efl");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:enlightenment");
...
var pkgs = [
    {'reference':'efl-1.26.3-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'enlightenment-0.25.4-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'efl / enlightenment');
}
