...
# extracted from Fedora Security Advisory FEDORA-2025-4453f596a8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-4453f596a8");

  script_name(english:"Fedora 41 : varnish (2025-4453f596a8)");
...
FEDORA-2025-4453f596a8 advisory.

    Security: This update includes fix for VSV00015 aka CVE-2025-30346. Upstream considers this a low risk
    problem. For details, refer to https://varnish-cache.org/security/VSV00015.html
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-4453f596a8");
...
var pkgs = [
    {'reference':'varnish-7.5.0-3.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
