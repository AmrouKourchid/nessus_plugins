...
# extracted from Fedora Security Advisory FEDORA-2022-0e358addb8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-0e358addb8");

  script_name(english:"Fedora 36 : bcel (2022-0e358addb8)");
...
FEDORA-2022-0e358addb8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-0e358addb8");
...
"Update the affected bcel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:bcel");
...
var pkgs = [
    {'reference':'bcel-6.4.1-10.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
