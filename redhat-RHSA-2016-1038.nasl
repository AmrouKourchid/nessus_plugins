...
# extracted from Red Hat Security Advisory RHSA-2016:1038. The text 
...
if (description)
{
  ...
  script_cve_id("CVE-2016-2142");
  script_xref(name:"RHSA", value:"2016:1038");

  script_name(english:"RHEL 7 : openshift (RHSA-2016:1038)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for openshift.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2016:1038 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2016/rhsa-2016_1038.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f2415ff3");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2016:1038");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1311220");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1331038");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL openshift package based on the guidance in RHSA-2016:1038.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:P/I:N/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:L/UI:N/S:U/C:H/I:N/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-2142");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'atomic-openshift-3.1.1.6-6.git.43.f583589.el7aos', 'cpu':'x86_64', 'release':'7', 'el_string':'el7aos', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-ansible'},
      {'reference':'atomic-openshift-clients-3.1.1.6-6.git.43.f583589.el7aos', 'cpu':'x86_64', 'release':'7', 'el_string':'el7aos', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-ansible'},
      {'reference':'atomic-openshift-clients-redistributable-3.1.1.6-6.git.43.f583589.el7aos', 'cpu':'x86_64', 'release':'7', 'el_string':'el7aos', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-ansible'},
      {'reference':'atomic-openshift-dockerregistry-3.1.1.6-6.git.43.f583589.el7aos', 'cpu':'x86_64', 'release':'7', 'el_string':'el7aos', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-ansible'},
      {'reference':'atomic-openshift-master-3.1.1.6-6.git.43.f583589.el7aos', 'cpu':'x86_64', 'release':'7', 'el_string':'el7aos', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-ansible'},
      {'reference':'atomic-openshift-node-3.1.1.6-6.git.43.f583589.el7aos', 'cpu':'x86_64', 'release':'7', 'el_string':'el7aos', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-ansible'},
      {'reference':'atomic-openshift-pod-3.1.1.6-6.git.43.f583589.el7aos', 'cpu':'x86_64', 'release':'7', 'el_string':'el7aos', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-ansible'},
      {'reference':'atomic-openshift-recycle-3.1.1.6-6.git.43.f583589.el7aos', 'cpu':'x86_64', 'release':'7', 'el_string':'el7aos', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-ansible'},
      {'reference':'atomic-openshift-sdn-ovs-3.1.1.6-6.git.43.f583589.el7aos', 'cpu':'x86_64', 'release':'7', 'el_string':'el7aos', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-ansible'},
      {'reference':'tuned-profiles-atomic-openshift-node-3.1.1.6-6.git.43.f583589.el7aos', 'cpu':'x86_64', 'release':'7', 'el_string':'el7aos', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-ansible'}
    ]
  }
];
