...
if (description)
{
  ...
  script_cve_id("CVE-2016-5004");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2016-5004");
...
patch available.
  ...
  - The Content-Encoding HTTP header feature in ws-xmlrpc 3.1.3 as used in Apache Archiva allows remote
    attackers to cause a denial of service (resource consumption) by decompressing a large file containing
    zeroes. (CVE-2016-5004)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-5004");
