...
if (description)
{
  ...
  script_bugtraq_id(107260, 107967);

  script_name(english:"NewStart CGSL CORE 5.05 / MAIN 5.05 : nss Multiple Vulnerabilities (NS-SA-2019-0236)");
...
pkgs = {
  "CGSL CORE 5.05": [
    "nss-3.44.0-4.el7.cgslv5_5.0.1.g5e23389.lite",
    "nss-debuginfo-3.44.0-4.el7.cgslv5_5.0.1.g5e23389.lite",
    "nss-devel-3.44.0-4.el7.cgslv5_5.0.1.g5e23389.lite",
    "nss-pkcs11-devel-3.44.0-4.el7.cgslv5_5.0.1.g5e23389.lite",
    "nss-sysinit-3.44.0-4.el7.cgslv5_5.0.1.g5e23389.lite",
    "nss-tools-3.44.0-4.el7.cgslv5_5.0.1.g5e23389.lite"
  ],
  "CGSL MAIN 5.05": [
    "nss-3.44.0-4.el7.cgslv5_5",
    "nss-debuginfo-3.44.0-4.el7.cgslv5_5",
    "nss-devel-3.44.0-4.el7.cgslv5_5",
    "nss-pkcs11-devel-3.44.0-4.el7.cgslv5_5",
    "nss-sysinit-3.44.0-4.el7.cgslv5_5",
    "nss-tools-3.44.0-4.el7.cgslv5_5"
  ]
};
