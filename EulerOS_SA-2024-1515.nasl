...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : python-cryptography (EulerOS-SA-2024-1515)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1515
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1a028cf9");
...
var pkgs = [
  "python3-cryptography-2.9-1.h4.eulerosv2r9"
];
