...
"The version of Google Chrome installed on the remote Windows host is prior to 130.0.6723.116. It is, therefore, affected
...
google_chrome_check_version(installs:installs, fix:'130.0.6723.116', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
