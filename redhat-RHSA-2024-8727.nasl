...
# extracted from Red Hat Security Advisory RHSA-2024:8727. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:8727");

  script_name(english:"RHEL 7 : firefox (RHSA-2024:8727)");
...
referenced in the RHSA-2024:8727 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?18725e33");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:8727");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL firefox package based on the guidance in RHSA-2024:8727.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-128.4.0-1.el7_9', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-128.4.0-1.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
