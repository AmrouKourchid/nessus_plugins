...
# extracted from Red Hat Security Advisory RHSA-2022:7514. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:7514");

  script_name(english:"RHEL 8 : fribidi (RHSA-2022:7514)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for fribidi.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2022:7514 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_7514.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f0b95584");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:7514");
...
"Update the RHEL fribidi package based on the guidance in RHSA-2022:7514.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'fribidi-1.0.4-9.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fribidi-devel-1.0.4-9.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
