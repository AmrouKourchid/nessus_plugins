...
# extracted from Red Hat Security Advisory RHSA-2024:2988. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2988");

  script_name(english:"RHEL 8 : container-tools:rhel8 (RHSA-2024:2988)");
...
referenced in the RHSA-2024:2988 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2988.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3dbdbbb3");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2244340");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2262272");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-18150");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-2598");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-26594");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-3088");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-3093");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-3146");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-9836");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2988");
...
"Update the RHEL container-tools:rhel8 package based on the guidance in RHSA-2024:2988.");
  ...
  script_cwe_id(20, 79, 200, 208, 222, 400, 444, 754, 770);
  ...
  'container-tools:rhel8': [
    {
      ...
      'pkgs': [
        {'reference':'aardvark-dns-1.10.0-1.module+el8.10.0+21209+52deeb51', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'buildah-1.33.6-2.module+el8.10.0+21371+46937ece', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'buildah-tests-1.33.6-2.module+el8.10.0+21371+46937ece', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'cockpit-podman-84.1-1.module+el8.10.0+21373+0d273fdf', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
        {'reference':'conmon-2.1.10-1.module+el8.10.0+21077+98b84d8a', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
        {'reference':'container-selinux-2.229.0-2.module+el8.10.0+21196+3f0abbca', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'containernetworking-plugins-1.4.0-2.module+el8.10.0+21366+f9cb49f8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'containers-common-1-81.module+el8.10.0+21340+c6c7475a', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'allowmaj':TRUE},
        {'reference':'crit-3.18-4.module+el8.9.0+20326+387084d0', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'criu-3.18-4.module+el8.9.0+20326+387084d0', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'criu-devel-3.18-4.module+el8.9.0+20326+387084d0', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'criu-libs-3.18-4.module+el8.9.0+20326+387084d0', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'crun-1.14.3-2.module+el8.10.0+21340+c6c7475a', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'fuse-overlayfs-1.13-1.module+el8.10.0+20412+95ee28e2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'libslirp-4.4.0-1.module+el8.9.0+20326+387084d0', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'libslirp-devel-4.4.0-1.module+el8.9.0+20326+387084d0', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'netavark-1.10.3-1.module+el8.10.0+21306+6be40ce7', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'oci-seccomp-bpf-hook-1.2.10-1.module+el8.10.0+20565+a40ba0e5', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'podman-4.9.4-0.1.module+el8.10.0+21350+ea09fba1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
        {'reference':'podman-catatonit-4.9.4-0.1.module+el8.10.0+21350+ea09fba1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
        {'reference':'podman-docker-4.9.4-0.1.module+el8.10.0+21350+ea09fba1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
        {'reference':'podman-gvproxy-4.9.4-0.1.module+el8.10.0+21350+ea09fba1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
        {'reference':'podman-plugins-4.9.4-0.1.module+el8.10.0+21350+ea09fba1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
        {'reference':'podman-remote-4.9.4-0.1.module+el8.10.0+21350+ea09fba1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
        {'reference':'podman-tests-4.9.4-0.1.module+el8.10.0+21350+ea09fba1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
        {'reference':'python3-criu-3.18-4.module+el8.9.0+20326+387084d0', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-podman-4.9.0-1.module+el8.10.0+21196+3f0abbca', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'runc-1.1.12-1.module+el8.10.0+21251+62b7388c', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'skopeo-1.14.3-0.1.module+el8.10.0+21251+62b7388c', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'skopeo-tests-1.14.3-0.1.module+el8.10.0+21251+62b7388c', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'slirp4netns-1.2.3-1.module+el8.10.0+21306+6be40ce7', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'toolbox-0.0.99.5-2.module+el8.10.0+21341+ff0b5f89', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'toolbox-tests-0.0.99.5-2.module+el8.10.0+21341+ff0b5f89', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'udica-0.2.6-20.module+el8.9.0+20326+387084d0', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
