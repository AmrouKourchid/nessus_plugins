...
# extracted from Amazon Linux 2023 Security Advisory ALAS2023-2023-130.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2023 : python3-twisted, python3-twisted+tls (ALAS2023-2023-130)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2023 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"It is, therefore, affected by a vulnerability as referenced in the ALAS2023-2023-130 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2023/ALAS-2023-130.html");
...
"Run 'dnf update python-twisted --releasever=2023.0.20230315' to update your system.");
...
var pkgs = [
    {'reference':'python3-twisted+tls-22.4.0-125.amzn2023.0.2', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-twisted-22.4.0-125.amzn2023.0.2', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE}
];
