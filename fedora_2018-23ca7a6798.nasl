...
# extracted from Fedora Security Advisory FEDORA-2018-23ca7a6798.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : 12:dhcp (2018-23ca7a6798)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-23ca7a6798");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"dhcp-4.3.6-20.fc28", epoch:"12")) flag++;
