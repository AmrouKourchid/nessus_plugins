...
# extracted from Fedora Security Advisory FEDORA-2023-34411d8f77
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-34411d8f77");

  script_name(english:"Fedora 37 : borgbackup (2023-34411d8f77)");
...
FEDORA-2023-34411d8f77 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-34411d8f77");
...
var pkgs = [
    {'reference':'borgbackup-1.2.6-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
