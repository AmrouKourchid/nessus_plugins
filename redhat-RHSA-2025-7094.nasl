...
# extracted from Red Hat Security Advisory RHSA-2025:7094. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2024-8418");
  script_xref(name:"RHSA", value:"2025:7094");

  script_name(english:"RHEL 9 : aardvark-dns (RHSA-2025:7094)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for aardvark-dns.");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2309683");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-57695");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_7094.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5599bf5a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:7094");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL aardvark-dns package based on the guidance in RHSA-2025:7094.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-8418");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'aardvark-dns-1.14.0-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'aardvark-dns');
}
