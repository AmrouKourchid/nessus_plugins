...
# extracted from Red Hat Security Advisory RHSA-2020:4545. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:4545");

  script_name(english:"RHEL 8 : libssh (RHSA-2020:4545)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2020:4545 advisory.

    libssh is a library which implements the SSH protocol. It can be used to implement client and server
    applications.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_4545.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a70cabef");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/8.3_release_notes/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b7e37d18");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:4545");
...
"Update the affected libssh, libssh-config and / or libssh-devel packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:libssh-config");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libssh-0.9.4-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libssh-config-0.9.4-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libssh-devel-0.9.4-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
