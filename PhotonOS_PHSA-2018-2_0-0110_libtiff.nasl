...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-17101");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libtiff-4.0.9-7.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libtiff-debuginfo-4.0.9-7.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libtiff-devel-4.0.9-7.ph2')) flag++;
