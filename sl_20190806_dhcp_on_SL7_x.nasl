...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : dhcp on SL7.x x86_64 (20190806)");
...
"Security Fix(es) :
  ...
  - dhcp: double-deletion of the released addresses in the
    dhcpv6 code leading to crash and possible DoS
    (CVE-2019-6470)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1908&L=SCIENTIFIC-LINUX-ERRATA&P=30078
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ce18e917");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"dhclient-4.2.5-77.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"dhcp-4.2.5-77.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"dhcp-common-4.2.5-77.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"dhcp-debuginfo-4.2.5-77.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"dhcp-devel-4.2.5-77.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"dhcp-libs-4.2.5-77.el7")) flag++;
