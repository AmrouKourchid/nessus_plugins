...
if (description)
{
  ...
  script_name(english:"Tenable Nessus SEoL (6.4.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Tenable Nessus is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Tenable Nessus is 6.4.x. It is, therefore, no longer maintained by its vendor or provider.
...
var constraints = [
  { max_branch : '6.4', min_branch : '6.4', seol : 20161231, eseol : 20170630 }
];
