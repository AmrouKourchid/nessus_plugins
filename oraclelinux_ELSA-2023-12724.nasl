...
# extracted from Oracle Linux Security Advisory ELSA-2023-12724.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : microcode_ctl (ELSA-2023-12724)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-12724.html");
...
var pkgs = [
    {'reference':'microcode_ctl-20220809-2.20230214.1.0.3.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'}
];
