...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.5.0 : qemu-kvm (EulerOS-SA-2020-1091)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1091
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2f558384");
...
pkgs = ["qemu-img-2.8.1-30.325",
        "qemu-kvm-2.8.1-30.325",
        "qemu-kvm-common-2.8.1-30.325",
        "qemu-kvm-tools-2.8.1-30.325"];
