...
if (description)
{
  ...
  script_name(english:"Wireshark 4.2.x < 4.2.8 A Vulnerability (macOS)");

  script_set_attribute(attribute:"synopsis", value:
"An application installed on the remote macOS / Mac OS X host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Wireshark installed on the remote macOS / Mac OS X host is prior to 4.2.8. It is, therefore, affected by
a vulnerability as referenced in the wireshark-4.2.8 advisory.
