...
# extracted from Fedora Security Advisory FEDORA-2024-966e16bfa3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-966e16bfa3");
  script_xref(name:"IAVA", value:"2024-A-0245-S");

  script_name(english:"Fedora 38 : firefox (2024-966e16bfa3)");
...
FEDORA-2024-966e16bfa3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-966e16bfa3");
...
var pkgs = [
    {'reference':'firefox-125.0-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
