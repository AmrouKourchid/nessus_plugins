...
if (description)
{
  ...
  script_cve_id("CVE-2024-23665");

  script_name(english:"Fortinet FortiWeb Unauthorized ADOM operations (FG-IR-23-474)");
...
vulnerability as referenced in the FG-IR-23-474 advisory.

  - Multiple improper authorization vulnerabilities [CWE-285] in FortiWeb version 7.4.2 and below, version
    7.2.7 and below, version 7.0.10 and below, version 6.4.3 and below, version 6.3.23 and below may allow an
    authenticated attacker to perform unauthorized ADOM operations via crafted requests. (CVE-2024-23665)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.fortiguard.com/psirt/FG-IR-23-474");
  script_set_attribute(attribute:"solution", value:
"Upgrade to FortiWeb version 6.3.999999 / 6.4.999999 / 7.0.999999 / 7.2.8 / 7.4.3 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:S/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:L/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-23665");
