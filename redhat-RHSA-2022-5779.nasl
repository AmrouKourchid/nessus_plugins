...
# extracted from Red Hat Security Advisory RHSA-2022:5779. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_5779.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?32970370");
...
"Update the RHEL ruby:2.5 package based on the guidance in RHSA-2022:5779.");
  ...
  'ruby:2.5': [
    {
      ...
      'pkgs': [
        {'reference':'ruby-2.5.9-110.module+el8.6.0+15956+aa803fc1', 'sp':'6', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ruby-devel-2.5.9-110.module+el8.6.0+15956+aa803fc1', 'sp':'6', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ruby-doc-2.5.9-110.module+el8.6.0+15956+aa803fc1', 'sp':'6', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ruby-irb-2.5.9-110.module+el8.6.0+15956+aa803fc1', 'sp':'6', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ruby-libs-2.5.9-110.module+el8.6.0+15956+aa803fc1', 'sp':'6', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'rubygem-bigdecimal-1.3.4-110.module+el8.6.0+15956+aa803fc1', 'sp':'6', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'rubygem-bundler-1.16.1-4.module+el8.6.0+14229+2452087f', 'sp':'6', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-bundler-doc-1.16.1-4.module+el8.6.0+14229+2452087f', 'sp':'6', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-did_you_mean-1.2.0-110.module+el8.6.0+15956+aa803fc1', 'sp':'6', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-io-console-0.4.6-110.module+el8.6.0+15956+aa803fc1', 'sp':'6', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-json-2.1.0-110.module+el8.6.0+15956+aa803fc1', 'sp':'6', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-minitest-5.10.3-110.module+el8.6.0+15956+aa803fc1', 'sp':'6', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'rubygem-net-telnet-0.1.1-110.module+el8.6.0+15956+aa803fc1', 'sp':'6', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-openssl-2.1.2-110.module+el8.6.0+15956+aa803fc1', 'sp':'6', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'rubygem-power_assert-1.1.1-110.module+el8.6.0+15956+aa803fc1', 'sp':'6', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-psych-3.0.2-110.module+el8.6.0+15956+aa803fc1', 'sp':'6', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-rake-12.3.3-110.module+el8.6.0+15956+aa803fc1', 'sp':'6', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-rdoc-6.0.1.1-110.module+el8.6.0+15956+aa803fc1', 'sp':'6', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-test-unit-3.2.7-110.module+el8.6.0+15956+aa803fc1', 'sp':'6', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-xmlrpc-0.3.0-110.module+el8.6.0+15956+aa803fc1', 'sp':'6', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygems-2.7.6.3-110.module+el8.6.0+15956+aa803fc1', 'sp':'6', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygems-devel-2.7.6.3-110.module+el8.6.0+15956+aa803fc1', 'sp':'6', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE}
      ]
    },
    {
      'repo_relative_urls': [
      ...
      'pkgs': [
        {'reference':'ruby-2.5.9-110.module+el8.6.0+15956+aa803fc1', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ruby-devel-2.5.9-110.module+el8.6.0+15956+aa803fc1', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ruby-doc-2.5.9-110.module+el8.6.0+15956+aa803fc1', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ruby-irb-2.5.9-110.module+el8.6.0+15956+aa803fc1', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ruby-libs-2.5.9-110.module+el8.6.0+15956+aa803fc1', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'rubygem-bigdecimal-1.3.4-110.module+el8.6.0+15956+aa803fc1', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'rubygem-bundler-1.16.1-4.module+el8.6.0+14229+2452087f', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-bundler-doc-1.16.1-4.module+el8.6.0+14229+2452087f', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-did_you_mean-1.2.0-110.module+el8.6.0+15956+aa803fc1', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-io-console-0.4.6-110.module+el8.6.0+15956+aa803fc1', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-json-2.1.0-110.module+el8.6.0+15956+aa803fc1', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-minitest-5.10.3-110.module+el8.6.0+15956+aa803fc1', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'rubygem-net-telnet-0.1.1-110.module+el8.6.0+15956+aa803fc1', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-openssl-2.1.2-110.module+el8.6.0+15956+aa803fc1', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'rubygem-power_assert-1.1.1-110.module+el8.6.0+15956+aa803fc1', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-psych-3.0.2-110.module+el8.6.0+15956+aa803fc1', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-rake-12.3.3-110.module+el8.6.0+15956+aa803fc1', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-rdoc-6.0.1.1-110.module+el8.6.0+15956+aa803fc1', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-test-unit-3.2.7-110.module+el8.6.0+15956+aa803fc1', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-xmlrpc-0.3.0-110.module+el8.6.0+15956+aa803fc1', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygems-2.7.6.3-110.module+el8.6.0+15956+aa803fc1', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygems-devel-2.7.6.3-110.module+el8.6.0+15956+aa803fc1', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
