...
if (description)
{
  ...
  script_cve_id("CVE-2018-5381");
  script_xref(name:"CEA-ID", value:"CEA-2019-0227");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2018-5381");
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-5381");
