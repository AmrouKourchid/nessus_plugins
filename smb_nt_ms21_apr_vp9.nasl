...
if (description)
{
  ...
  script_cve_id("CVE-2021-28464");

  script_name(english:"Microsoft Windows VP9 Video Extensions Library RCE (April 2021)");
...
requires that a program process a specially crafted file.");
  # https://msrc.microsoft.com/update-guide/vulnerability/CVE-2021-28464
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4bb22046");
...
"Upgrade to app version 1.0.40631.0, or later via the Microsoft Store.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-28464");
