...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Mercurial PHSA-2019-2.0-0160");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'mercurial-4.5.3-3.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'mercurial-debuginfo-4.5.3-3.ph2')) flag++;
