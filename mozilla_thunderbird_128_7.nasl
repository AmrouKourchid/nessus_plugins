...
"The version of Thunderbird installed on the remote Windows host is prior to 128.7. It is, therefore, affected by
multiple vulnerabilities as referenced in the mfsa2025-10 advisory.
...
mozilla_check_version(installs:installs, product:'thunderbird', esr:FALSE, fix:'128.7', severity:SECURITY_HOLE);
