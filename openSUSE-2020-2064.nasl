...
# extracted from openSUSE Security Update openSUSE-2020-2064.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : perl-DBI (openSUSE-2020-2064)");
...
"This update for perl-DBI fixes the following issues :
  ...
  - DBD::File drivers can open files from folders other than
    those specifically passed via the f_dir attribute in the
    data source name (DSN). [bsc#1176492, CVE-2014-10401,
    CVE-2014-10402]

This update was imported from the SUSE:SLE-15-SP2:Update update
project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1176492");
...
if ( rpm_check(release:"SUSE15.2", reference:"perl-DBI-1.642-lp152.2.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"perl-DBI-debuginfo-1.642-lp152.2.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"perl-DBI-debugsource-1.642-lp152.2.9.1") ) flag++;
