...
# extracted from Gentoo Linux Security Advisory GLSA 202007-34.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202007-34");
  script_xref(name:"CEA-ID", value:"CEA-2021-0004");
  script_xref(name:"CEA-ID", value:"CEA-2021-0025");

  script_name(english:"GLSA-202007-34 : Apache Ant: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202007-34
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202007-34");
...
if (qpkg_check(package:"dev-java/ant", unaffected:make_list("ge 1.10.8"), vulnerable:make_list("lt 1.10.8"))) flag++;
