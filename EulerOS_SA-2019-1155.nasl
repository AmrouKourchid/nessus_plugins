...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : wget (EulerOS-SA-2019-1155)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1155
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a0db5b0e");
...
pkgs = ["wget-1.14-15.1.h5.eulerosv2r7"];
