...
# SUSE update advisory SUSE-SU-2023:0467-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:0467-1");

  script_name(english:"SUSE SLES12 Security Update : prometheus-ha_cluster_exporter (SUSE-SU-2023:0467-1)");
...
in the SUSE-SU-2023:0467-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-February/013852.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c12457ee");
...
var pkgs = [
    {'reference':'prometheus-ha_cluster_exporter-1.3.1+git.1676027782.ad3c0e9-4.26.1', 'sp':'4', 'cpu':'x86_64', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.4']},
    {'reference':'prometheus-ha_cluster_exporter-1.3.1+git.1676027782.ad3c0e9-4.26.1', 'sp':'5', 'cpu':'x86_64', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5']}
];
