...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP12 : python-setuptools (EulerOS-SA-2024-2791)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2791
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a005e5dc");
...
var pkgs = [
  "python-setuptools-59.4.0-4.h4.eulerosv2r12",
  "python3-setuptools-59.4.0-4.h4.eulerosv2r12"
];
