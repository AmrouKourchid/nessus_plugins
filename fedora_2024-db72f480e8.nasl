...
# extracted from Fedora Security Advisory FEDORA-2024-db72f480e8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-db72f480e8");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2024/11/05");
  script_xref(name:"IAVA", value:"2024-A-0641-S");

  script_name(english:"Fedora 40 : firefox (2024-db72f480e8)");
...
FEDORA-2024-db72f480e8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-db72f480e8");
...
var pkgs = [
    {'reference':'firefox-131.0.2-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
