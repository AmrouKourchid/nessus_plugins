...
# Oracle Linux Security Advisory ELSA-2015-1715 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : spice-server (ELSA-2015-1715)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2015-1715.html");
...
var pkgs = [
    {'reference':'spice-server-0.12.4-12.el6_7.1', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'spice-server-devel-0.12.4-12.el6_7.1', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
];
