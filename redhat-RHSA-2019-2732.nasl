...
if (description)
{
  ...
  script_name(english:"RHEL 7 : .NET Core on Red Hat Enterprise Linux (RHSA-2019:2732)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_2732.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b6fe37a1");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:2732");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1750793");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL .NET Core on Red Hat Enterprise Linux package based on the guidance in RHSA-2019:2732.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-dotnet21-2.1-12.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet21'},
      {'reference':'rh-dotnet21-dotnet-2.1.509-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet21'},
      {'reference':'rh-dotnet21-dotnet-host-2.1.13-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet21'},
      {'reference':'rh-dotnet21-dotnet-runtime-2.1-2.1.13-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet21'},
      {'reference':'rh-dotnet21-dotnet-sdk-2.1-2.1.509-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet21'},
      {'reference':'rh-dotnet21-dotnet-sdk-2.1.5xx-2.1.509-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet21'},
      {'reference':'rh-dotnet21-runtime-2.1-12.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet21'},
      {'reference':'rh-dotnet22-2.2-9.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet22'},
      {'reference':'rh-dotnet22-dotnet-2.2.109-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet22'},
      {'reference':'rh-dotnet22-dotnet-host-2.2.7-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet22'},
      {'reference':'rh-dotnet22-dotnet-host-fxr-2.2-2.2.7-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet22'},
      {'reference':'rh-dotnet22-dotnet-runtime-2.2-2.2.7-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet22'},
      {'reference':'rh-dotnet22-dotnet-sdk-2.2-2.2.109-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet22'},
      {'reference':'rh-dotnet22-dotnet-sdk-2.2.1xx-2.2.109-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet22'},
      {'reference':'rh-dotnet22-runtime-2.2-9.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet22'}
    ]
  }
];
