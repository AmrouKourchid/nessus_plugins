...
# extracted from Red Hat Security Advisory RHSA-2022:1819. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 8 : go-toolset:rhel8 (RHSA-2022:1819)");
...
referenced in the RHSA-2022:1819 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_1819.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5f4be28e");
...
"Update the RHEL go-toolset:rhel8 package based on the guidance in RHSA-2022:1819.");
  ...
  script_cwe_id(20, 119, 125, 190, 252, 400, 1220);
  ...
  'go-toolset:rhel8': [
    {
      ...
      'pkgs': [
        {'reference':'delve-1.7.2-1.module+el8.6.0+12972+ebab5911', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'go-toolset-1.17.7-1.module+el8.6.0+14297+32a15e19', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'golang-1.17.7-1.module+el8.6.0+14297+32a15e19', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'golang-bin-1.17.7-1.module+el8.6.0+14297+32a15e19', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'golang-docs-1.17.7-1.module+el8.6.0+14297+32a15e19', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'golang-misc-1.17.7-1.module+el8.6.0+14297+32a15e19', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'golang-race-1.17.7-1.module+el8.6.0+14297+32a15e19', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'golang-src-1.17.7-1.module+el8.6.0+14297+32a15e19', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'golang-tests-1.17.7-1.module+el8.6.0+14297+32a15e19', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
