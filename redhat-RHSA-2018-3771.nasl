...
# extracted from Red Hat Security Advisory RHSA-2018:3771. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:3771");

  script_name(english:"RHEL 7 : ansible (RHSA-2018:3771)");
...
the RHSA-2018:3771 advisory.
    ...
    * ansible: become password logged in plaintext when used with PowerShell on Windows (CVE-2018-16859)
    ...
    See https://github.com/ansible/ansible/blob/v2.6.10/changelogs/CHANGELOG-v2.6.rst for details on bug fixes
    in this release.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_3771.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?32886b15");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:3771");
...
"Update the RHEL ansible package based on the guidance in RHSA-2018:3771.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ansible-2.6.10-1.el7ae', 'release':'7', 'el_string':'el7ae', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2.6'}
    ]
  }
];
