...
# extracted from Red Hat Security Advisory RHSA-2021:1744. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 8 : sane-backends (RHSA-2021:1744)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for sane-backends.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2021:1744 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_1744.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8af281e7");
...
"Update the RHEL sane-backends package based on the guidance in RHSA-2021:1744.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'sane-backends-1.0.27-22.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sane-backends-daemon-1.0.27-22.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sane-backends-devel-1.0.27-22.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sane-backends-doc-1.0.27-22.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sane-backends-drivers-cameras-1.0.27-22.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sane-backends-drivers-scanners-1.0.27-22.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sane-backends-libs-1.0.27-22.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
