...
# extracted from Red Hat Security Advisory RHSA-2024:9472. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:9472");

  script_name(english:"RHEL 9 : grafana-pcp (RHSA-2024:9472)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_9472.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8a404850");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:9472");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL grafana-pcp package based on the guidance in RHSA-2024:9472.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'grafana-pcp-5.1.1-9.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
