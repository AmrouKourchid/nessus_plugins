...
# extracted from Red Hat Security Advisory RHSA-2024:6838. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:6838");

  script_name(english:"RHEL 7 : firefox  update (Important) (RHSA-2024:6838)");
...
referenced in the RHSA-2024:6838 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_6838.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ef6eadef");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:6838");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-128.2.0-1.el7_9', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-128.2.0-1.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
