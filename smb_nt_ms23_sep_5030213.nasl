...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5030213");
  script_xref(name:"MSFT", value:"MS23-5030213");
  script_xref(name:"IAVA", value:"2023-A-0472-S");
  script_xref(name:"IAVA", value:"2023-A-0471-S");

  script_name(english:"KB5030213: Windows 10 Version 1607 and Windows Server 2016 Security Update (September 2023)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5030213");
