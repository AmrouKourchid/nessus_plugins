...
# extracted from SUSE update advisory SUSE-SU-2020:1277-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : libvirt (SUSE-SU-2020:1277-1)");
...
without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=1157490");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=1161883");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=1162160");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=1167007");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=1168683");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=1170765");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2020-10703/");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2020-12430/");
  # https://www.suse.com/support/update/announcement/2020/suse-su-20201277-1/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2d5afa25");
...
zypper in -t patch SUSE-SLE-SDK-12-SP5-2020-1277=1

SUSE Linux Enterprise Server 12-SP5 :

zypper in -t patch SUSE-SLE-SERVER-12-SP5-2020-1277=1");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"5", cpu:"x86_64", reference:"libvirt-daemon-driver-libxl-5.1.0-13.6.2")) flag++;
if (rpm_check(release:"SLES12", sp:"5", cpu:"x86_64", reference:"libvirt-daemon-driver-libxl-debuginfo-5.1.0-13.6.2")) flag++;
if (rpm_check(release:"SLES12", sp:"5", cpu:"x86_64", reference:"libvirt-daemon-driver-storage-rbd-5.1.0-13.6.2")) flag++;
if (rpm_check(release:"SLES12", sp:"5", cpu:"x86_64", reference:"libvirt-daemon-driver-storage-rbd-debuginfo-5.1.0-13.6.2")) flag++;
if (rpm_check(release:"SLES12", sp:"5", cpu:"x86_64", reference:"libvirt-daemon-xen-5.1.0-13.6.2")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libvirt-5.1.0-13.6.2")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libvirt-admin-5.1.0-13.6.2")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libvirt-admin-debuginfo-5.1.0-13.6.2")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libvirt-client-5.1.0-13.6.2")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libvirt-client-debuginfo-5.1.0-13.6.2")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libvirt-daemon-5.1.0-13.6.2")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libvirt-daemon-config-network-5.1.0-13.6.2")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libvirt-daemon-config-nwfilter-5.1.0-13.6.2")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libvirt-daemon-debuginfo-5.1.0-13.6.2")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libvirt-daemon-driver-interface-5.1.0-13.6.2")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libvirt-daemon-driver-interface-debuginfo-5.1.0-13.6.2")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libvirt-daemon-driver-lxc-5.1.0-13.6.2")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libvirt-daemon-driver-lxc-debuginfo-5.1.0-13.6.2")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libvirt-daemon-driver-network-5.1.0-13.6.2")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libvirt-daemon-driver-network-debuginfo-5.1.0-13.6.2")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libvirt-daemon-driver-nodedev-5.1.0-13.6.2")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libvirt-daemon-driver-nodedev-debuginfo-5.1.0-13.6.2")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libvirt-daemon-driver-nwfilter-5.1.0-13.6.2")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libvirt-daemon-driver-nwfilter-debuginfo-5.1.0-13.6.2")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libvirt-daemon-driver-qemu-5.1.0-13.6.2")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libvirt-daemon-driver-qemu-debuginfo-5.1.0-13.6.2")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libvirt-daemon-driver-secret-5.1.0-13.6.2")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libvirt-daemon-driver-secret-debuginfo-5.1.0-13.6.2")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libvirt-daemon-driver-storage-5.1.0-13.6.2")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libvirt-daemon-driver-storage-core-5.1.0-13.6.2")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libvirt-daemon-driver-storage-core-debuginfo-5.1.0-13.6.2")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libvirt-daemon-driver-storage-disk-5.1.0-13.6.2")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libvirt-daemon-driver-storage-disk-debuginfo-5.1.0-13.6.2")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libvirt-daemon-driver-storage-iscsi-5.1.0-13.6.2")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libvirt-daemon-driver-storage-iscsi-debuginfo-5.1.0-13.6.2")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libvirt-daemon-driver-storage-logical-5.1.0-13.6.2")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libvirt-daemon-driver-storage-logical-debuginfo-5.1.0-13.6.2")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libvirt-daemon-driver-storage-mpath-5.1.0-13.6.2")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libvirt-daemon-driver-storage-mpath-debuginfo-5.1.0-13.6.2")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libvirt-daemon-driver-storage-scsi-5.1.0-13.6.2")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libvirt-daemon-driver-storage-scsi-debuginfo-5.1.0-13.6.2")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libvirt-daemon-hooks-5.1.0-13.6.2")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libvirt-daemon-lxc-5.1.0-13.6.2")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libvirt-daemon-qemu-5.1.0-13.6.2")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libvirt-debugsource-5.1.0-13.6.2")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libvirt-doc-5.1.0-13.6.2")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libvirt-libs-5.1.0-13.6.2")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libvirt-libs-debuginfo-5.1.0-13.6.2")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libvirt-lock-sanlock-5.1.0-13.6.2")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libvirt-lock-sanlock-debuginfo-5.1.0-13.6.2")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libvirt-nss-5.1.0-13.6.2")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libvirt-nss-debuginfo-5.1.0-13.6.2")) flag++;
