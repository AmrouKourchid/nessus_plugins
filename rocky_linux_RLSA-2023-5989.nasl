...
# Rocky Linux Security Advisory RLSA-2023:5989.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2023:5989");
  script_xref(name:"CEA-ID", value:"CEA-2024-0004");

  script_name(english:"Rocky Linux 8 : varnish (RLSA-2023:5989)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Rocky Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Rocky Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
RLSA-2023:5989 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2023:5989");
...
var pkgs = [
    {'reference':'varnish-6.0.8-3.module+el8.8.0+1552+3570c668.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'varnish-6.0.8-3.module+el8.8.0+1552+3570c668.1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'varnish-devel-6.0.8-3.module+el8.8.0+1552+3570c668.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'varnish-devel-6.0.8-3.module+el8.8.0+1552+3570c668.1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'varnish-docs-6.0.8-3.module+el8.8.0+1552+3570c668.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'varnish-docs-6.0.8-3.module+el8.8.0+1552+3570c668.1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
