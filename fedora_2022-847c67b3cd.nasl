...
# extracted from Fedora Security Advisory FEDORA-2022-847c67b3cd
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-847c67b3cd");

  script_name(english:"Fedora 35 : dotnet3.1 (2022-847c67b3cd)");
...
FEDORA-2022-847c67b3cd advisory.

    Update to the September 2022 update release of .NET Core 3.1
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-847c67b3cd");
...
var pkgs = [
    {'reference':'dotnet3.1-3.1.423-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
