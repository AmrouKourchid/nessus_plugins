...
# extracted from Fedora Security Advisory FEDORA-2023-ad5fee9a64
#
...
if (description)
{
  ...
  script_cve_id("CVE-2023-3430", "CVE-2023-36183");
  script_xref(name:"FEDORA", value:"2023-ad5fee9a64");

  script_name(english:"Fedora 38 : OpenImageIO (2023-ad5fee9a64)");
...
FEDORA-2023-ad5fee9a64 advisory.

    Changes since 2.4.12:
    https://github.com/OpenImageIO/oiio/releases/tag/v2.4.13.0
    https://github.com/OpenImageIO/oiio/releases/tag/v2.4.14.0
    Security fix for CVE-2023-36183, CVE-2023-3430
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-ad5fee9a64");
...
"Update the affected OpenImageIO package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-36183");
...
var pkgs = [
    {'reference':'OpenImageIO-2.4.14.0-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
