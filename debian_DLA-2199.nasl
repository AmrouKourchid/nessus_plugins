...
# extracted from Debian Security Advisory DLA-2199-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2199-1 : openldap security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2020/05/msg00001.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/jessie/openldap");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"ldap-utils", reference:"2.4.40+dfsg-1+deb8u6")) flag++;
if (deb_check(release:"8.0", prefix:"libldap-2.4-2", reference:"2.4.40+dfsg-1+deb8u6")) flag++;
if (deb_check(release:"8.0", prefix:"libldap-2.4-2-dbg", reference:"2.4.40+dfsg-1+deb8u6")) flag++;
if (deb_check(release:"8.0", prefix:"libldap2-dev", reference:"2.4.40+dfsg-1+deb8u6")) flag++;
if (deb_check(release:"8.0", prefix:"slapd", reference:"2.4.40+dfsg-1+deb8u6")) flag++;
if (deb_check(release:"8.0", prefix:"slapd-dbg", reference:"2.4.40+dfsg-1+deb8u6")) flag++;
if (deb_check(release:"8.0", prefix:"slapd-smbk5pwd", reference:"2.4.40+dfsg-1+deb8u6")) flag++;
