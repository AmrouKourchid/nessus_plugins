...
if (description)
{
  ...
  script_name(english:"PHP 5.4.x < 5.4.26 Multiple Vulnerabilities");
...
but instead relies only on PHP's self-reported version number.");
  script_set_attribute(attribute:"see_also", value:"http://www.php.net/ChangeLog-5.php#5.4.26");
...
if (version =~ "^5\.4\.([0-9]|1[0-9]|2[0-5])($|[^0-9])")
{
