...
if (description)
{
  ...
  script_cve_id("CVE-2025-25068");
  script_xref(name:"IAVA", value:"2025-A-0195-S");

  script_name(english:"Mattermost Server 9.11.x < 9.11.9 / 10.3.x < 10.3.4 / 10.4.x < 10.4.3 / 10.5 (MMSA-2025-00444)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of Mattermost Server installed on the remote host is prior to 9.11.9, 10.3.4, 10.4.3, or 10.5. It is,
therefore, affected by a vulnerability as referenced in the MMSA-2025-00444 advisory.

  - Mattermost versions 10.4.x <= 10.4.2, 10.3.x <= 10.3.3, 9.11.x <= 9.11.8, 10.5.x <= 10.5.0 fail to enforce
    MFA on plugin endpoints, which allows authenticated attackers to bypass MFA protections via API requests
    to plugin-specific routes. (CVE-2025-25068)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://mattermost.com/security-updates/");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Mattermost Server version 9.11.9 / 10.3.4 / 10.4.3 / 10.5.1 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:S/C:C/I:C/A:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:L/UI:N/S:U/C:H/I:H/A:H");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-25068");
...
var constraints = [
  ...
  { 'fixed_display' : '10.5.1', 'equal' : '10.5', 'fixed_display': '10.5.2 / 10.6.0' }
];
