...
# extracted from Ubuntu Security Notice USN-5069-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5069-1");

  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS : mod-auth-mellon vulnerability (USN-5069-1)");
...
in the USN-5069-1 advisory.

    It was discovered that mod-auth-mellon incorrectly filtered certain URLs. A remote attacker could possibly
    use this issue to perform an open redirect attack.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5069-1");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'libapache2-mod-auth-mellon', 'pkgver': '0.13.1-1ubuntu0.3'},
    {'osver': '20.04', 'pkgname': 'libapache2-mod-auth-mellon', 'pkgver': '0.16.0-1ubuntu0.1'}
];
