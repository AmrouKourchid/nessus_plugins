...
# extracted from Fedora Security Advisory FEDORA-2023-5763445abe
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-5763445abe");

  script_name(english:"Fedora 38 : emacs (2023-5763445abe)");
...
FEDORA-2023-5763445abe advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-5763445abe");
...
var pkgs = [
    {'reference':'emacs-28.3-0.rc1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
