...
system user or the execution of arbitrary code via a XMLRPC call.");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/lava-server");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/stretch/lava-server");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2018/dsa-4234");
...
in version 2016.12-3.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-12565");
