...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : libtiff (EulerOS-SA-2019-2288)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2288
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e676ccd6");
...
pkgs = ["libtiff-4.0.9-11.h8.eulerosv2r8",
        "libtiff-devel-4.0.9-11.h8.eulerosv2r8"];
