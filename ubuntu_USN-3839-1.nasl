...
# extracted from Ubuntu Security Notice USN-3839-1. The text
...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 18.04 LTS : WavPack vulnerabilities (USN-3839-1)");
...
vulnerabilities as referenced in the USN-3839-1 advisory.

    It was discovered that WavPack incorrectly handled certain WAV files. An attacker could possibly use this
    issue to cause a denial of service. (CVE-2018-19840, CVE-2018-19841)

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3839-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'libwavpack-dev', 'pkgver': '4.70.0-1ubuntu0.2'},
    {'osver': '14.04', 'pkgname': 'libwavpack1', 'pkgver': '4.70.0-1ubuntu0.2'},
    {'osver': '14.04', 'pkgname': 'wavpack', 'pkgver': '4.70.0-1ubuntu0.2'},
    {'osver': '16.04', 'pkgname': 'libwavpack-dev', 'pkgver': '4.75.2-2ubuntu0.2'},
    {'osver': '16.04', 'pkgname': 'libwavpack1', 'pkgver': '4.75.2-2ubuntu0.2'},
    {'osver': '16.04', 'pkgname': 'wavpack', 'pkgver': '4.75.2-2ubuntu0.2'},
    {'osver': '18.04', 'pkgname': 'libwavpack-dev', 'pkgver': '5.1.0-2ubuntu1.2'},
    {'osver': '18.04', 'pkgname': 'libwavpack1', 'pkgver': '5.1.0-2ubuntu1.2'},
    {'osver': '18.04', 'pkgname': 'wavpack', 'pkgver': '5.1.0-2ubuntu1.2'}
];
