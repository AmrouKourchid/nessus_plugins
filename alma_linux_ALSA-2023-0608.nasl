...
# AlmaLinux Security Advisory ALSA-2023:0608.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:0608");
  script_xref(name:"IAVA", value:"2023-A-0063-S");

  script_name(english:"AlmaLinux 9 : thunderbird (ALSA-2023:0608)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2023-0608.html");
...
var pkgs = [
    {'reference':'thunderbird-102.7.1-2.el9_1.alma.plus', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'thunderbird-102.7.1-2.el9_1.alma.plus', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
