...
if (description)
{
  ...
  script_name(english:"PHP 8.2.x < 8.2.1");

  script_set_attribute(attribute:"synopsis", value:
"The version PHP running on the remote web server is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of PHP installed on the remote host is prior to 8.2.1. It is, therefore, affected by a vulnerability as
referenced in the Version 8.2.1 advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"http://bugs.php.net/81740");
  script_set_attribute(attribute:"see_also", value:"http://php.net/ChangeLog-8.php#8.2.1");
  script_set_attribute(attribute:"solution", value:
"Upgrade to PHP version 8.2.1 or later.");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2022-31631");
...
var constraints = [
  { 'min_version' : '8.2.0alpha1', 'fixed_version' : '8.2.1' }
];
