...
if (description)
{
  ...
  script_cve_id("CVE-2024-3567");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-3567");
...
patch available.
  ...
  - A flaw was found in QEMU. An assertion failure was present in the update_sctp_checksum() function in
    ...
    allows a malicious guest to crash QEMU and cause a denial of service condition. (CVE-2024-3567)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-3567");
