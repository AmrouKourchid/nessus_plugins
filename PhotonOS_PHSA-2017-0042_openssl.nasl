...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Openssl PHSA-2017-0042");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'openssl-1.0.2m-1.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'openssl-c_rehash-1.0.2m-1.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'openssl-debuginfo-1.0.2m-1.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'openssl-devel-1.0.2m-1.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'openssl-perl-1.0.2m-1.ph1')) flag++;
