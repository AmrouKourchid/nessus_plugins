...
# extracted from Fedora Security Advisory FEDORA-2018-061bafe369.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : 1:libvorbis (2018-061bafe369)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-061bafe369");
...
flag = 0;
if (rpm_check(release:"FC27", reference:"libvorbis-1.3.6-1.fc27", epoch:"1")) flag++;
