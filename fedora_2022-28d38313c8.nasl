...
# extracted from Fedora Security Advisory FEDORA-2022-28d38313c8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-28d38313c8");

  script_name(english:"Fedora 38 : etcd (2022-28d38313c8)");
...
FEDORA-2022-28d38313c8 advisory.
    ...
    ```
    * Sun Nov  6 2022 Robert-Andr Mauchin <zebob.m@gmail.com> 3.5.5-1
    - Bootstrap
    ...
    * Sun Jun 19 2022 Robert-Andr Mauchin <zebob.m@gmail.com> 3.5.0-6
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-28d38313c8");
...
var pkgs = [
    {'reference':'etcd-3.5.5-1.fc38~bootstrap', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
