...
# extracted from Red Hat Security Advisory RHSA-2025:4793. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:4793");

  script_name(english:"RHEL 9 : emacs (RHSA-2025:4793)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_4793.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c125762d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:4793");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL emacs package based on the guidance in RHSA-2025:4793.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'emacs-27.2-10.el9_4.2', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'emacs-common-27.2-10.el9_4.2', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'emacs-filesystem-27.2-10.el9_4.2', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'emacs-lucid-27.2-10.el9_4.2', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'emacs-nox-27.2-10.el9_4.2', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
