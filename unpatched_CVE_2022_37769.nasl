...
if (description)
{
  ...
  script_cve_id("CVE-2022-37769");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-37769");
...
patch available.
  ...
  - libjpeg commit 281daa9 was discovered to contain a segmentation fault via HuffmanDecoder::Get at
    huffmandecoder.hpp. This vulnerability allows attackers to cause a Denial of Service (DoS) via a crafted
    file. (CVE-2022-37769)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-37769");
