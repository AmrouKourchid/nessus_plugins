...
# Red Hat Security Advisory RHSA-2023:5264. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : virt:rhel and virt-devel:rhel (CESA-2023:5264)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
CESA-2023:5264 advisory.
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'nbdkit / nbdkit-bash-completion / nbdkit-basic-filters / etc');
}
