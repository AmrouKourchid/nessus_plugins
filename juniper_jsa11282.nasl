...
number.");
  # https://supportportal.juniper.net/s/article/2022-01-Security-Bulletin-Junos-OS-In-a-scenario-with-dhcp-security-and-option-82-configured-jdhcpd-crashes-upon-receipt-of-a-malformed-DHCP-packet-CVE-2022-22176
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ff83da2e");
