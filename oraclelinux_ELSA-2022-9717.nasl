...
# extracted from Oracle Linux Security Advisory ELSA-2022-9717.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : cri-o (ELSA-2022-9717)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2022-9717.html");
...
var pkgs = [
    {'reference':'cri-o-1.21.7-2.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'cri-o-1.21.'}
];
