...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : kernel (EulerOS-SA-2025-1024)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1024
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d80ed291");
...
var pkgs = [
  "kernel-4.18.0-147.5.2.19.h1766.eulerosv2r10",
  "kernel-abi-stablelists-4.18.0-147.5.2.19.h1766.eulerosv2r10",
  "kernel-tools-4.18.0-147.5.2.19.h1766.eulerosv2r10",
  "kernel-tools-libs-4.18.0-147.5.2.19.h1766.eulerosv2r10",
  "python3-perf-4.18.0-147.5.2.19.h1766.eulerosv2r10"
];
