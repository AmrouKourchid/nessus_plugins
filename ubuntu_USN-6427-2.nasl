...
# extracted from Ubuntu Security Notice USN-6427-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6427-2");
  script_xref(name:"CEA-ID", value:"CEA-2024-0004");
  script_xref(name:"IAVB", value:"2023-B-0083-S");

  script_name(english:"Ubuntu 23.10 : .NET vulnerability (USN-6427-2)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 23.10 host has packages installed that are affected by a vulnerability as referenced in the USN-6427-2
advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6427-2");
...
var pkgs = [
    {'osver': '23.10', 'pkgname': 'aspnetcore-runtime-8.0', 'pkgver': '8.0.0~rc2-0ubuntu1'},
    {'osver': '23.10', 'pkgname': 'aspnetcore-targeting-pack-8.0', 'pkgver': '8.0.0~rc2-0ubuntu1'},
    {'osver': '23.10', 'pkgname': 'dotnet-apphost-pack-8.0', 'pkgver': '8.0.0~rc2-0ubuntu1'},
    {'osver': '23.10', 'pkgname': 'dotnet-host-8.0', 'pkgver': '8.0.0~rc2-0ubuntu1'},
    {'osver': '23.10', 'pkgname': 'dotnet-hostfxr-8.0', 'pkgver': '8.0.0~rc2-0ubuntu1'},
    {'osver': '23.10', 'pkgname': 'dotnet-runtime-8.0', 'pkgver': '8.0.0~rc2-0ubuntu1'},
    {'osver': '23.10', 'pkgname': 'dotnet-sdk-8.0', 'pkgver': '8.0.100~rc2-0ubuntu1'},
    {'osver': '23.10', 'pkgname': 'dotnet-sdk-8.0-source-built-artifacts', 'pkgver': '8.0.100~rc2-0ubuntu1'},
    {'osver': '23.10', 'pkgname': 'dotnet-targeting-pack-8.0', 'pkgver': '8.0.0~rc2-0ubuntu1'},
    {'osver': '23.10', 'pkgname': 'dotnet-templates-8.0', 'pkgver': '8.0.100~rc2-0ubuntu1'},
    {'osver': '23.10', 'pkgname': 'dotnet8', 'pkgver': '8.0.100-8.0.0~rc2-0ubuntu1'},
    {'osver': '23.10', 'pkgname': 'netstandard-targeting-pack-2.1-8.0', 'pkgver': '8.0.100~rc2-0ubuntu1'}
];
