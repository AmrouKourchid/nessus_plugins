...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.3 : perl (EulerOS-SA-2019-1158)");
...
following vulnerability :
  ...
  - It was found that the Archive::Tar module did not
    ...
    the Perl interpreter.i1/4^CVE-2018-12015i1/4%0

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1158
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9b3ea3f4");
