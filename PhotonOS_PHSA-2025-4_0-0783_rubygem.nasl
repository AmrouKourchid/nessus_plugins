...
# extracted from VMware Security Advisory PHSA-2025-4.0-0783. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Rubygem PHSA-2025-4.0-0783");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the rubygem package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-783.md");
...
if (rpm_check(release:'PhotonOS-4.0', reference:'rubygem-fluentd-1.15.3-1.ph4')) flag++;
