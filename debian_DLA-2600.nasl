...
# extracted from Debian Security Advisory DLA-2600-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2600-1 : pygments security update");
...
vulnerabilities in Pygments, a popular syntax highlighting library for
Python.
...
For the detailed security status of pygments please refer to its
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2021/03/msg00024.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/stretch/pygments"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:python-pygments-doc");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:python3-pygments");
...
flag = 0;
if (deb_check(release:"9.0", prefix:"python-pygments", reference:"2.2.0+dfsg-1+deb9u2")) flag++;
if (deb_check(release:"9.0", prefix:"python-pygments-doc", reference:"2.2.0+dfsg-1+deb9u2")) flag++;
if (deb_check(release:"9.0", prefix:"python3-pygments", reference:"2.2.0+dfsg-1+deb9u2")) flag++;
