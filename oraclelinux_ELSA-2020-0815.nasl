...
# Oracle Linux Security Advisory ELSA-2020-0815 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : firefox (ELSA-2020-0815)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2020-0815.html");
...
var pkgs = [
    {'reference':'firefox-68.6.0-1.0.1.el7_7', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-68.6.0-1.0.1.el7_7', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-68.6.0-1.0.1.el7_7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
