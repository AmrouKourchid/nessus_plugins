...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : libvirt on SL6.x i386/x86_64 (20180522) (Spectre)");
...
Note: This is the libvirt side of the CVE-2018-3639 mitigation.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?73006930");
...
flag = 0;
if (rpm_check(release:"SL6", reference:"libvirt-0.10.2-62.el6_9.2")) flag++;
if (rpm_check(release:"SL6", reference:"libvirt-client-0.10.2-62.el6_9.2")) flag++;
if (rpm_check(release:"SL6", reference:"libvirt-debuginfo-0.10.2-62.el6_9.2")) flag++;
if (rpm_check(release:"SL6", reference:"libvirt-devel-0.10.2-62.el6_9.2")) flag++;
if (rpm_check(release:"SL6", cpu:"x86_64", reference:"libvirt-lock-sanlock-0.10.2-62.el6_9.2")) flag++;
if (rpm_check(release:"SL6", reference:"libvirt-python-0.10.2-62.el6_9.2")) flag++;
