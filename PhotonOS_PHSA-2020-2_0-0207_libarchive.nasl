...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Libarchive PHSA-2020-2.0-0207");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libarchive-3.3.1-6.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libarchive-debuginfo-3.3.1-6.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libarchive-devel-3.3.1-6.ph2')) flag++;
