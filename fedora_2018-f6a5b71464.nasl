...
# extracted from Fedora Security Advisory FEDORA-2018-f6a5b71464.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-f6a5b71464");

  script_name(english:"Fedora 29 : mod_perl (2018-f6a5b71464)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-f6a5b71464");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"mod_perl-2.0.10-13.fc29")) flag++;
