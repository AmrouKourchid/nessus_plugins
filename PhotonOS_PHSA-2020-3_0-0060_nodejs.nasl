...
# extracted from VMware Security Advisory PHSA-2020-3.0-0060. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Nodejs PHSA-2020-3.0-0060");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the nodejs package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-3.0-60.md");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'nodejs-13.8.0-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'nodejs-debuginfo-13.8.0-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'nodejs-devel-13.8.0-1.ph3')) flag++;
