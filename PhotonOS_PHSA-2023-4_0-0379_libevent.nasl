...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Libevent PHSA-2023-4.0-0379");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the libevent package has been released.");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libevent-2.1.12-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libevent-devel-2.1.12-1.ph4')) flag++;
