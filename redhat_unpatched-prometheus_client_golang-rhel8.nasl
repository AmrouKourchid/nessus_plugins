...
# extracted from Red Hat Security Advisory prometheus_client_golang. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 8 : prometheus_client_golang (Unpatched Vulnerability) (deprecated)");
