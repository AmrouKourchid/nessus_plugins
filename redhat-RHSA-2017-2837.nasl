...
# extracted from Red Hat Security Advisory RHSA-2017:2837. The text 
...
referenced in the RHSA-2017:2837 advisory.
    ...
    * A heap buffer overflow was discovered in dnsmasq in the IPv6 router advertisement (RA) handling code. An
    attacker on the local network segment could send crafted RAs to dnsmasq which would cause it to crash or,
    potentially, execute arbitrary code. This issue only affected configurations using one of these options:
    enable-ra, ra-only, slaac, ra-names, ra-advrouter, or ra-stateless. (CVE-2017-14492)

    * A stack buffer overflow was found in dnsmasq in the DHCPv6 code. An attacker on the local network could
    send a crafted DHCPv6 request to dnsmasq which would cause it to a crash or, potentially, execute
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2017/rhsa-2017_2837.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b9d88e78");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1495410");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1495411");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1495412");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2017:2837");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'dnsmasq-2.66-14.el7_2.2', 'sp':'2', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dnsmasq-2.66-14.el7_2.2', 'sp':'2', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dnsmasq-2.66-14.el7_2.2', 'sp':'2', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dnsmasq-2.66-14.el7_2.2', 'sp':'2', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dnsmasq-utils-2.66-14.el7_2.2', 'sp':'2', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dnsmasq-utils-2.66-14.el7_2.2', 'sp':'2', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dnsmasq-utils-2.66-14.el7_2.2', 'sp':'2', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dnsmasq-utils-2.66-14.el7_2.2', 'sp':'2', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'dnsmasq-2.66-21.el7_3.2', 'sp':'3', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dnsmasq-2.66-21.el7_3.2', 'sp':'3', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dnsmasq-2.66-21.el7_3.2', 'sp':'3', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dnsmasq-2.66-21.el7_3.2', 'sp':'3', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dnsmasq-utils-2.66-21.el7_3.2', 'sp':'3', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dnsmasq-utils-2.66-21.el7_3.2', 'sp':'3', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dnsmasq-utils-2.66-21.el7_3.2', 'sp':'3', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dnsmasq-utils-2.66-21.el7_3.2', 'sp':'3', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
