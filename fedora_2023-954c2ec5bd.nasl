...
# extracted from Fedora Security Advisory FEDORA-2023-954c2ec5bd
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-954c2ec5bd");

  script_name(english:"Fedora 37 : matrix-synapse (2023-954c2ec5bd)");
...
FEDORA-2023-954c2ec5bd advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-954c2ec5bd");
...
var pkgs = [
    {'reference':'matrix-synapse-1.80.0-7.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
