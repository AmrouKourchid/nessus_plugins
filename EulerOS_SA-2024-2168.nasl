...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.1 : httpd (EulerOS-SA-2024-2168)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2168
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ad68a383");
...
var pkgs = [
  "httpd-2.4.51-5.h22.eulerosv2r11",
  "httpd-filesystem-2.4.51-5.h22.eulerosv2r11",
  "httpd-tools-2.4.51-5.h22.eulerosv2r11",
  "mod_ssl-2.4.51-5.h22.eulerosv2r11"
];
