...
# extracted from Fedora Security Advisory FEDORA-2023-bff42b29eb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-bff42b29eb");

  script_name(english:"Fedora 37 : galera / mariadb (2023-bff42b29eb)");
...
FEDORA-2023-bff42b29eb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-bff42b29eb");
...
var pkgs = [
    {'reference':'galera-26.4.16-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'mariadb-10.5.23-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'}
];
