...
# extracted from Red Hat Security Advisory RHSA-2024:1501. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:1501");

  script_name(english:"RHEL 9 : grafana (RHSA-2024:1501)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_1501.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?57aa9462");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:1501");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL grafana package based on the guidance in RHSA-2024:1501.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'grafana-9.2.10-8.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
