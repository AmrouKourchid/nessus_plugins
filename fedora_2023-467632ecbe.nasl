...
# extracted from Fedora Security Advisory FEDORA-2023-467632ecbe
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-467632ecbe");

  script_name(english:"Fedora 39 : borgbackup (2023-467632ecbe)");
...
FEDORA-2023-467632ecbe advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-467632ecbe");
...
var pkgs = [
    {'reference':'borgbackup-1.2.6-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
