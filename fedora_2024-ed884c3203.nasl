...
# extracted from Fedora Security Advisory FEDORA-2024-ed884c3203
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-ed884c3203");

  script_name(english:"Fedora 40 : postgresql-jdbc (2024-ed884c3203)");
...
FEDORA-2024-ed884c3203 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-ed884c3203");
...
var pkgs = [
    {'reference':'postgresql-jdbc-42.7.3-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
