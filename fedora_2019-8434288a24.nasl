...
# extracted from Fedora Security Advisory FEDORA-2019-8434288a24.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : systemd (2019-8434288a24)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-8434288a24");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"systemd-239-12.git8bca462.fc29")) flag++;
