...
# extracted from Fedora Security Advisory FEDORA-2020-8838d072d5.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-8838d072d5");
  script_xref(name:"IAVA", value:"2020-A-0221-S");

  script_name(english:"Fedora 31 : php (2020-8838d072d5)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-8838d072d5");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"php-7.3.18-1.fc31")) flag++;
