...
# extracted from Red Hat Security Advisory RHSA-2024:2980. The text
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2980.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ff16be1e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2980");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL harfbuzz package based on the guidance in RHSA-2024:2980.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'harfbuzz-1.7.5-4.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'harfbuzz-devel-1.7.5-4.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'harfbuzz-icu-1.7.5-4.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
