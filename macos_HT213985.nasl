...
if (description)
{
  ...
  script_xref(name:"APPLE-SA", value:"HT213985");
  ...
  script_name(english:"macOS 13.x < 13.6.1 Multiple Vulnerabilities (HT213985)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host is missing a macOS update that fixes multiple vulnerabilities");
  script_set_attribute(attribute:"description", value:
"The remote host is running a version of macOS / Mac OS X that is 13.x prior to 13.6.1. It is, therefore, affected by
multiple vulnerabilities:
  ...
  - The issue was addressed with improved checks. This issue is fixed in macOS Ventura 13.6.1. An app may be
    able to access protected user data. (CVE-2023-41077)
  ...
  - The issue was addressed with additional permissions checks. This issue is fixed in macOS Ventura 13.6.1.
    An attacker may be able to access passkeys without authentication. (CVE-2023-40401)
...
version number.");
  script_set_attribute(attribute:"see_also", value:"https://support.apple.com/en-us/HT213985");
  script_set_attribute(attribute:"solution", value:
"Upgrade to macOS 13.6.1 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:C/I:N/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:N/UI:R/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-42844");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2023-42942");
...
var constraints = [
  { 'fixed_version' : '13.6.1', 'min_version' : '13.0', 'fixed_display' : 'macOS Ventura 13.6.1' }
];
