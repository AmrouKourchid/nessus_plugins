...
# extracted from Red Hat Security Advisory RHSA-2022:5311. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:5311");

  script_name(english:"RHEL 8 : libgcrypt (RHSA-2022:5311)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for libgcrypt.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2022:5311 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_5311.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a2f90104");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:5311");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2002816");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libgcrypt package based on the guidance in RHSA-2022:5311.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libgcrypt-1.8.5-7.el8_6', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libgcrypt-devel-1.8.5-7.el8_6', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'libgcrypt-1.8.5-7.el8_6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libgcrypt-devel-1.8.5-7.el8_6', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
