...
referenced in the RHSA-2023:2705 advisory.
    ...
    This release of Red Hat Single Sign-On 7.6.3 on RHEL 7 serves as a replacement for Red Hat Single Sign-On
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_2705.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3e0a8cd2");
...
"Update the RHEL Red Hat Single Sign-On 7.6.3 package based on the guidance in RHSA-2023:2705.");
