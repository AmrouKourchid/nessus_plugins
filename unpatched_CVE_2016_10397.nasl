...
if (description)
{
  ...
  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2016-10397");
...
patch available.
  ...
  - In PHP before 5.6.28 and 7.x before 7.0.13, incorrect handling of various URI components in the URL parser
    ...
    evil.example.com:80#@good.example.com/ and evil.example.com:80?@good.example.com/ inputs to the parse_url
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-10397");
