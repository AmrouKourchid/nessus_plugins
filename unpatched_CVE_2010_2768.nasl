...
if (description)
{
  ...
  script_cve_id("CVE-2010-2768");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2010-2768");
...
patch available.
  ...
  - Mozilla Firefox before 3.5.12 and 3.6.x before 3.6.9, Thunderbird before 3.0.7 and 3.1.x before 3.1.3, and
    ...
    mechanisms via UTF-7 encoding. (CVE-2010-2768)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2010-2768");
