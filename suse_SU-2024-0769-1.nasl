...
# SUSE update advisory SUSE-SU-2024:0769-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2024:0769-1");

  script_name(english:"SUSE SLES15 Security Update : postgresql-jdbc (SUSE-SU-2024:0769-1)");
...
in the SUSE-SU-2024:0769-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2024-March/018098.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e658288c");
...
var pkgs = [
    {'reference':'postgresql-jdbc-42.2.25-150300.3.14.1', 'sp':'3', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.3']},
    {'reference':'postgresql-jdbc-42.2.25-150300.3.14.1', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-LTSS-release-15.3', 'sles-ltss-release-15.3']}
];
