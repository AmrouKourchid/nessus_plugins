...
# extracted from Gentoo Linux Security Advisory GLSA 201908-29.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2019-10691", "CVE-2019-11500");
  script_xref(name:"GLSA", value:"201908-29");

  script_name(english:"GLSA-201908-29 : Dovecot: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-201908-29
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/201908-29");
...
if (qpkg_check(package:"net-mail/dovecot", unaffected:make_list("ge 2.3.7.2"), vulnerable:make_list("lt 2.3.7.2"))) flag++;
