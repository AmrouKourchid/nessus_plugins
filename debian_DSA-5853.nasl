...
# extracted from Debian Security Advisory dsa-5853. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5853 : libpam-u2f - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 12 host has packages installed that are affected by a vulnerability as referenced in the dsa-5853
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bookworm/pam-u2f");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'libpam-u2f', 'reference': '1.1.0-1.1+deb12u1'},
    {'release': '12.0', 'prefix': 'pamu2fcfg', 'reference': '1.1.0-1.1+deb12u1'}
];
