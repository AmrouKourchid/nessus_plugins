...
# extracted from VMware Security Advisory PHSA-2023-4.0-0369. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Libmspack PHSA-2023-4.0-0369");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the libmspack package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-369.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libmspack-0.10.1alpha-3.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libmspack-devel-0.10.1alpha-3.ph4')) flag++;
