...
# extracted from Red Hat Security Advisory RHSA-2019:1436. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2018-11469", "CVE-2018-20102", "CVE-2018-20103");
  script_xref(name:"RHSA", value:"2019:1436");

  script_name(english:"RHEL 7 : rh-haproxy18-haproxy (RHSA-2019:1436)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2019:1436 advisory.

    HAProxy is a TCP/HTTP reverse proxy which is particularly suited for high availability environments.

    The following packages have been upgraded to a later upstream version: rh-haproxy18-haproxy (1.8.17).
    (BZ#1660514)
    ...
    * RFE : Haproxy does not resolve ipv6 resolvable hostnames in the backend section. (BZ#1575585)
    ...
    For detailed information on changes in this release, see the Red Hat Software Collections 3.3 Release
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f0625f4e");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1575585");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1582635");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1595865");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1649041");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1658874");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1658876");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_1436.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e5b4d0ab");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:1436");
  script_set_attribute(attribute:"solution", value:
"Update the affected rh-haproxy18-haproxy and / or rh-haproxy18-haproxy-syspaths packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rh-haproxy18-haproxy");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rh-haproxy18-haproxy-syspaths");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-haproxy18-haproxy-1.8.17-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-haproxy18-haproxy-syspaths-1.8.17-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'rh-haproxy18-haproxy / rh-haproxy18-haproxy-syspaths');
}
