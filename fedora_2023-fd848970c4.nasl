...
# extracted from Fedora Security Advisory FEDORA-2023-fd848970c4
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-fd848970c4");

  script_name(english:"Fedora 38 : libmemcached-awesome (2023-fd848970c4)");
...
FEDORA-2023-fd848970c4 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-fd848970c4");
...
var pkgs = [
    {'reference':'libmemcached-awesome-1.1.4-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
