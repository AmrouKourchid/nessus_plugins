...
# extracted from Gentoo Linux Security Advisory GLSA 202401-05.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202401-05 : RDoc: Command Injection");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202401-05 (RDoc: Command Injection)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202401-05");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=801301");
...
var packages = [
  {
    'name' : 'dev-ruby/rdoc',
    'unaffected' : make_list("ge 6.3.2"),
    'vulnerable' : make_list("lt 6.3.2")
  }
];
