...
# extracted from Red Hat Security Advisory RHSA-2024:3401. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:3401");

  script_name(english:"RHEL 9 : rpm-ostree (RHSA-2024:3401)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_3401.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f6ade6ca");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:3401");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rpm-ostree package based on the guidance in RHSA-2024:3401.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rpm-ostree-2023.3-2.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-ostree-libs-2023.3-2.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
