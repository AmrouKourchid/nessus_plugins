...
# extracted from Ubuntu Security Notice USN-6097-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6097-1");

  script_name(english:"Ubuntu 16.04 ESM / 18.04 LTS / 20.04 LTS : Linux PTP vulnerability (USN-6097-1)");
...
referenced in the USN-6097-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6097-1");
...
"Update the affected linuxptp package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linuxptp");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'linuxptp', 'pkgver': '1.6-1ubuntu0.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'linuxptp', 'pkgver': '1.8-1ubuntu0.1', 'ubuntu_pro': FALSE},
    {'osver': '20.04', 'pkgname': 'linuxptp', 'pkgver': '1.9.2-1ubuntu0.1', 'ubuntu_pro': FALSE}
];
