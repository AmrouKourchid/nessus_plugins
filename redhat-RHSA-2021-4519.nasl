...
# extracted from Red Hat Security Advisory RHSA-2021:4519. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:4519");

  script_name(english:"RHEL 8 : autotrace (RHSA-2021:4519)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for autotrace.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has a package installed that is affected by multiple vulnerabilities as
referenced in the RHSA-2021:4519 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_4519.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cca26f04");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:4519");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1945031");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1945033");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL autotrace package based on the guidance in RHSA-2021:4519.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'autotrace-0.31.1-53.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
