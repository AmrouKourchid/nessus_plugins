...
# extracted from Fedora Security Advisory FEDORA-2022-35ce8ecede
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-35ce8ecede");

  script_name(english:"Fedora 35 : wordpress (2022-35ce8ecede)");
...
FEDORA-2022-35ce8ecede advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-35ce8ecede");
...
var pkgs = [
    {'reference':'wordpress-5.9.5-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
