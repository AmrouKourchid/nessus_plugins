...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : poppler (EulerOS-SA-2020-1425)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1425
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f424c965");
...
"Update the affected poppler packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-9408");
...
pkgs = ["poppler-0.26.5-17.h19",
        "poppler-glib-0.26.5-17.h19",
        "poppler-qt-0.26.5-17.h19",
        "poppler-utils-0.26.5-17.h19"];
