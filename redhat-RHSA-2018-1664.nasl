...
# extracted from Red Hat Security Advisory RHSA-2018:1664. The text 
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_1664.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3770cd54");
...
"Update the RHEL libvirt package based on the guidance in RHSA-2018:1664.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libvirt-0.10.2-18.el6_4.17', 'sp':'4', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-client-0.10.2-18.el6_4.17', 'sp':'4', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-client-0.10.2-18.el6_4.17', 'sp':'4', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-devel-0.10.2-18.el6_4.17', 'sp':'4', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-devel-0.10.2-18.el6_4.17', 'sp':'4', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-lock-sanlock-0.10.2-18.el6_4.17', 'sp':'4', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-python-0.10.2-18.el6_4.17', 'sp':'4', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
