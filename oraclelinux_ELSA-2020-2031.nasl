...
# extracted from Oracle Linux Security Advisory ELSA-2020-2031.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : firefox (ELSA-2020-2031)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2020-2031.html");
...
var pkgs = [
    {'reference':'firefox-68.8.0-1.0.1.el8_2', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-68.8.0-1.0.1.el8_2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
