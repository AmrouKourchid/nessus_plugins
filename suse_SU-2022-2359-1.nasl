...
if (description)
{
  ...
  script_name(english:"SUSE SLES15 Security Update : squid (SUSE-SU-2022:2359-1)");
...
in the SUSE-SU-2022:2359-1 advisory.
...
var pkgs = [
    {'reference':'squid-5.6-150400.3.3.1', 'sp':'4', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.4']},
    {'reference':'squid-5.6-150400.3.3.1', 'sp':'4', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.4', 'sle-module-server-applications-release-15.4', 'sles-release-15.4']}
];
