...
# extracted from Debian Security Advisory dla-3603. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3603 : libxpm-dev - security update");
...
dla-3603 advisory.
    ...
    - -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3603-1                debian-lts@lists.debian.org
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libxpm-dev', 'reference': '1:3.5.12-1+deb10u2'},
    {'release': '10.0', 'prefix': 'libxpm4', 'reference': '1:3.5.12-1+deb10u2'},
    {'release': '10.0', 'prefix': 'xpmutils', 'reference': '1:3.5.12-1+deb10u2'}
];
