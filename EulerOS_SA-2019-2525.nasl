...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : file (EulerOS-SA-2019-2525)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2525
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ea0acee7");
...
pkgs = ["file-5.11-33.h1.eulerosv2r7",
        "file-libs-5.11-33.h1.eulerosv2r7",
        "python-magic-5.11-33.h1.eulerosv2r7"];
