...
# extracted from Fedora Security Advisory FEDORA-2024-1249d56928
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-1249d56928");

  script_name(english:"Fedora 38 : mbedtls (2024-1249d56928)");
...
FEDORA-2024-1249d56928 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-1249d56928");
...
var pkgs = [
    {'reference':'mbedtls-2.28.8-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
