...
"The remote Red Hat host is missing one or more security updates for grafana-pcp.");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8250.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7b344651");
...
"Update the RHEL grafana-pcp package based on the guidance in RHSA-2022:8250.");
