...
if (description)
{
  ...
  script_name(english:"CentOS 9 : krb5-1.19.1-22.el9");
...
krb5-1.19.1-22.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=23615");
...
var pkgs = [
    {'reference':'krb5-devel-1.19.1-22.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'krb5-libs-1.19.1-22.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'krb5-pkinit-1.19.1-22.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'krb5-server-1.19.1-22.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'krb5-server-ldap-1.19.1-22.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'krb5-workstation-1.19.1-22.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libkadm5-1.19.1-22.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
