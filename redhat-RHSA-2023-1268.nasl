...
# extracted from Red Hat Security Advisory RHSA-2023:1268. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2022-41717", "CVE-2023-25725");
  script_xref(name:"RHSA", value:"2023:1268");

  script_name(english:"RHEL 8 / 9 : OpenShift Container Platform 4.12.8 (RHSA-2023:1268)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for OpenShift Container Platform 4.12.8.");
...
referenced in the RHSA-2023:1268 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.12.8. See the following
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_1268.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9956f0d3");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2169089");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:1268");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.12.8 package based on the guidance in RHSA-2023:1268.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'haproxy22-2.2.24-3.rhaos4.12.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2023-25725']},
      {'reference':'openshift-hyperkube-4.12.0-202303132316.p0.geab9cc9.assembly.stream.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2022-41717']}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'openshift-hyperkube-4.12.0-202303132316.p0.geab9cc9.assembly.stream.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2022-41717']}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'haproxy22 / openshift-hyperkube');
}
