...
# extracted from Red Hat Security Advisory libnbd. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2021-20286", "CVE-2023-5215");

  script_name(english:"RHEL 8 : libnbd (Unpatched Vulnerability) (deprecated)");
...
"This plugin has been deprecated as it does not adhere to established standards for this style of check.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2023-5215");
