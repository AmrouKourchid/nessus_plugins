...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : device-mapper-multipath (EulerOS-SA-2023-2420)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the device-mapper-multipath packages installed, the EulerOS Virtualization installation on
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2420
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a1c3bd58");
...
"Update the affected device-mapper-multipath packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:device-mapper-multipath-sysvinit");
...
var pkgs = [
  "device-mapper-multipath-0.4.9-119.1.h17.eulerosv2r7",
  "device-mapper-multipath-libs-0.4.9-119.1.h17.eulerosv2r7",
  "device-mapper-multipath-sysvinit-0.4.9-119.1.h17.eulerosv2r7",
  "kpartx-0.4.9-119.1.h17.eulerosv2r7"
];
