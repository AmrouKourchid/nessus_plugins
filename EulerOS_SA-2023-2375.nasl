...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : cloud-init (EulerOS-SA-2023-2375)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2375
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c36fcb8b");
...
var pkgs = [
  "cloud-init-19.4-2.h10.eulerosv2r10"
];
