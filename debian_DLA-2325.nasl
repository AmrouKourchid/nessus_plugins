...
# extracted from Debian Security Advisory DLA-2325-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2325-1 : openjdk-8 security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2020/08/msg00021.html");
...
flag = 0;
if (deb_check(release:"9.0", prefix:"openjdk-8-dbg", reference:"8u265-b01-0+deb9u1")) flag++;
if (deb_check(release:"9.0", prefix:"openjdk-8-demo", reference:"8u265-b01-0+deb9u1")) flag++;
if (deb_check(release:"9.0", prefix:"openjdk-8-doc", reference:"8u265-b01-0+deb9u1")) flag++;
if (deb_check(release:"9.0", prefix:"openjdk-8-jdk", reference:"8u265-b01-0+deb9u1")) flag++;
if (deb_check(release:"9.0", prefix:"openjdk-8-jdk-headless", reference:"8u265-b01-0+deb9u1")) flag++;
if (deb_check(release:"9.0", prefix:"openjdk-8-jre", reference:"8u265-b01-0+deb9u1")) flag++;
if (deb_check(release:"9.0", prefix:"openjdk-8-jre-headless", reference:"8u265-b01-0+deb9u1")) flag++;
if (deb_check(release:"9.0", prefix:"openjdk-8-jre-zero", reference:"8u265-b01-0+deb9u1")) flag++;
if (deb_check(release:"9.0", prefix:"openjdk-8-source", reference:"8u265-b01-0+deb9u1")) flag++;
