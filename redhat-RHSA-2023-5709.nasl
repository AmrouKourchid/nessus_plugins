...
# extracted from Red Hat Security Advisory RHSA-2023:5709. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:5709");
  script_xref(name:"CEA-ID", value:"CEA-2024-0004");
  script_xref(name:"IAVB", value:"2023-B-0083-S");

  script_name(english:"RHEL 8 : dotnet7.0 (RHSA-2023:5709)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for dotnet7.0.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2023:5709 advisory.
    ...
    .NET 7.0 to SDK 7.0.112 and Runtime 7.0.12.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_5709.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3adf989e");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:5709");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL dotnet7.0 package based on the guidance in RHSA-2023:5709.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'aspnetcore-runtime-7.0-7.0.12-1.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'aspnetcore-targeting-pack-7.0-7.0.12-1.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-7.0.112-1.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-apphost-pack-7.0-7.0.12-1.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-host-7.0.12-1.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-hostfxr-7.0-7.0.12-1.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-runtime-7.0-7.0.12-1.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-sdk-7.0-7.0.112-1.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-sdk-7.0-source-built-artifacts-7.0.112-1.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-targeting-pack-7.0-7.0.12-1.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-templates-7.0-7.0.112-1.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'netstandard-targeting-pack-2.1-7.0.112-1.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'aspnetcore-runtime-7.0-7.0.12-1.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'aspnetcore-targeting-pack-7.0-7.0.12-1.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-7.0.112-1.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-apphost-pack-7.0-7.0.12-1.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-host-7.0.12-1.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-hostfxr-7.0-7.0.12-1.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-runtime-7.0-7.0.12-1.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-sdk-7.0-7.0.112-1.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-sdk-7.0-source-built-artifacts-7.0.112-1.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-targeting-pack-7.0-7.0.12-1.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-templates-7.0-7.0.112-1.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'netstandard-targeting-pack-2.1-7.0.112-1.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
