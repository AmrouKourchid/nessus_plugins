...
referenced in the SUSE-SU-2021:2846-1 advisory.
...
var pkgs = [
    {'reference':'kgraft-patch-4_4_180-94_147-default-2-2.1', 'sp':'3', 'cpu':'x86_64', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.3']},
