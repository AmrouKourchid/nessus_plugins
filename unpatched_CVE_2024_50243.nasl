...
if (description)
{
  ...
  script_cve_id("CVE-2024-50243");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-50243");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: fs/ntfs3: Fix general protection fault
    in run_is_mapped_full Fixed deleating of a non-resident attribute in ntfs_create_inode() rollback.
    (CVE-2024-50243)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-50243");
