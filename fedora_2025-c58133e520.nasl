...
# extracted from Fedora Security Advisory FEDORA-2025-c58133e520
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-c58133e520");

  script_name(english:"Fedora 40 : libxmp (2025-c58133e520)");
...
FEDORA-2025-c58133e520 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-c58133e520");
...
var pkgs = [
    {'reference':'libxmp-4.6.1-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
