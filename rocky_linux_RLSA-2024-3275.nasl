...
# Rocky Linux Security Advisory RLSA-2024:3275.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2024:3275");

  script_name(english:"Rocky Linux 8 : python-dns (RLSA-2024:3275)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2024:3275");
