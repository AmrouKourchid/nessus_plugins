...
# extracted from Fedora Security Advisory FEDORA-2022-86b0833619
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-86b0833619");

  script_name(english:"Fedora 35 : firefox (2022-86b0833619)");
...
FEDORA-2022-86b0833619 advisory.

    * Update to latest version (96.0)

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-86b0833619");
...
var pkgs = [
    {'reference':'firefox-96.0-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
