...
# extracted from Red Hat Security Advisory RHSA-2024:8708. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:8708");

  script_name(english:"RHEL 9 : buildah (RHSA-2024:8708)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a474480d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:8708");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL buildah package based on the guidance in RHSA-2024:8708.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'buildah-1.29.4-1.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'buildah-tests-1.29.4-1.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
