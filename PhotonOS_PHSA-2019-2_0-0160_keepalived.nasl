...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'keepalived-2.0.16-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'keepalived-debuginfo-2.0.16-1.ph2')) flag++;
