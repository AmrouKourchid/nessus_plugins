...
referenced in the USN-3295-1 advisory.

    It was discovered that JasPer incorrectly handled certain malformed JPEG-2000 image files. If a user or
    automated system using JasPer were tricked into opening a specially crafted image, an attacker could
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3295-1");
...
"Update the affected libjasper-dev, libjasper-runtime and / or libjasper1 packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-9560");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'libjasper-dev', 'pkgver': '1.900.1-14ubuntu3.4'},
    {'osver': '14.04', 'pkgname': 'libjasper-runtime', 'pkgver': '1.900.1-14ubuntu3.4'},
    {'osver': '14.04', 'pkgname': 'libjasper1', 'pkgver': '1.900.1-14ubuntu3.4'},
    {'osver': '16.04', 'pkgname': 'libjasper-dev', 'pkgver': '1.900.1-debian1-2.4ubuntu1.1'},
    {'osver': '16.04', 'pkgname': 'libjasper-runtime', 'pkgver': '1.900.1-debian1-2.4ubuntu1.1'},
    {'osver': '16.04', 'pkgname': 'libjasper1', 'pkgver': '1.900.1-debian1-2.4ubuntu1.1'}
];
