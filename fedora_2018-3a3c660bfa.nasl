...
# extracted from Fedora Security Advisory FEDORA-2018-3a3c660bfa.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : community-mysql (2018-3a3c660bfa)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-3a3c660bfa");
...
flag = 0;
if (rpm_check(release:"FC27", reference:"community-mysql-5.7.23-1.fc27")) flag++;
