...
# extracted from Gentoo Linux Security Advisory GLSA 202409-14.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202409-14 : Mbed TLS: Multiple Vulnerabilities");
...
"The remote host is affected by the vulnerability described in GLSA-202409-14 (Mbed TLS: Multiple Vulnerabilities)
    ...
    Multiple vulnerabilities have been discovered in Mbed TLS. Please review the CVE identifiers referenced
    below for details.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202409-14");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=886001");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=923279");
...
"All Mbed TLS users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-45199");
...
var packages = [
  {
    ...
    'unaffected' : make_list("ge 2.28.7"),
    'vulnerable' : make_list("lt 2.28.7")
  }
];
