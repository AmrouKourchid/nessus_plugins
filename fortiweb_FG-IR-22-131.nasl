...
if (description)
{
  ...
  script_cve_id("CVE-2023-23777");

  script_name(english:"Fortinet FortiWeb Command injection in CLI backup functionality (FG-IR-22-131)");
...
vulnerability as referenced in the FG-IR-22-131 advisory.

  - An improper neutralization of special elements used in an OS command ('OS Command Injection')
    vulnerability [CWE-78] in FortiWeb version 7.0.1 and below, 6.4 all versions, version 6.3.18 and below may
    allow a privileged attacker to execute arbitrary bash commands via crafted cli backup parameters.
    (CVE-2023-23777)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.fortiguard.com/psirt/FG-IR-22-131");
...
"Please upgrade to FortiWeb version 6.3.19/7.0.2 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-23777");
