...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5036909");
  script_xref(name:"MSFT", value:"MS24-5036909");
  ...
  script_name(english:"KB5036909: Windows Server 2022 / Azure Stack HCI 22H2 Security Update (April 2024)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5036909");
