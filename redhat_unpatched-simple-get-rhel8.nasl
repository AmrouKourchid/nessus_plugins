...
# extracted from Red Hat Security Advisory simple-get. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2022-0355");

  script_name(english:"RHEL 8 : simple-get (Unpatched Vulnerability) (deprecated)");
...
"This plugin has been deprecated as it does not adhere to established standards for this style of check.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-0355");
