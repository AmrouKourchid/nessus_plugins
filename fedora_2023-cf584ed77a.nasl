...
# extracted from Fedora Security Advisory FEDORA-2023-cf584ed77a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-cf584ed77a");
  script_xref(name:"IAVA", value:"2023-A-0667-S");

  script_name(english:"Fedora 39 : roundcubemail (2023-cf584ed77a)");
...
FEDORA-2023-cf584ed77a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-cf584ed77a");
...
var pkgs = [
    {'reference':'roundcubemail-1.6.5-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
