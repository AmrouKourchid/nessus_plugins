...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.0 : python-cryptography (EulerOS-SA-2023-2771)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the python-cryptography package installed, the EulerOS Virtualization installation on the
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2771
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e78d0901");
...
"Update the affected python-cryptography packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:python-cryptography-help");
...
var pkgs = [
  "python-cryptography-help-3.3.1-2.h6.eulerosv2r11"
];
