...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Libtiff PHSA-2022-3.0-0491");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libtiff-4.4.0-7.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libtiff-devel-4.4.0-7.ph3')) flag++;
