...
# extracted from Ubuntu Security Notice USN-6674-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6674-2");

  script_name(english:"Ubuntu 18.04 LTS : Django vulnerability (USN-6674-2)");
...
USN-6674-2 advisory.
    ...
    USN-6674-1 fixed a vulnerability in Django. This update provides the corresponding update for Ubuntu 18.04
    LTS.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6674-2");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'python-django', 'pkgver': '1:1.11.11-1ubuntu1.21+esm4', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'python-django-common', 'pkgver': '1:1.11.11-1ubuntu1.21+esm4', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'python3-django', 'pkgver': '1:1.11.11-1ubuntu1.21+esm4', 'ubuntu_pro': TRUE}
];
