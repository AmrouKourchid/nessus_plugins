...
# extracted from Red Hat Security Advisory RHSA-2019:3698. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:3698");

  script_name(english:"RHEL 8 : libarchive (RHSA-2019:3698)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for libarchive.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2019:3698 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_3698.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?da757927");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:3698");
...
"Update the RHEL libarchive package based on the guidance in RHSA-2019:3698.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'bsdtar-3.3.2-7.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libarchive-3.3.2-7.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libarchive-devel-3.3.2-7.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'bsdtar / libarchive / libarchive-devel');
}
