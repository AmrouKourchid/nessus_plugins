...
# AlmaLinux Security Advisory ALSA-2024:10779.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:10779");
  script_xref(name:"RHSA", value:"2024:10779");

  script_name(english:"AlmaLinux 8 : python3:3.6.8 (ALSA-2024:10779)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ALSA-2024:10779 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2024-10779.html");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:10779");
...
var pkgs = [
    {'reference':'platform-python-3.6.8-69.el8_10.alma.1', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'platform-python-debug-3.6.8-69.el8_10.alma.1', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'platform-python-devel-3.6.8-69.el8_10.alma.1', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'python3-idle-3.6.8-69.el8_10.alma.1', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'python3-libs-3.6.8-69.el8_10.alma.1', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'python3-test-3.6.8-69.el8_10.alma.1', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'python3-tkinter-3.6.8-69.el8_10.alma.1', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'}
];
