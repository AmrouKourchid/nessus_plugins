...
# extracted from Red Hat Security Advisory RHSA-2020:5571. The text
...
if (description)
{
  ...
  script_bugtraq_id(107375);
  script_xref(name:"RHSA", value:"2020:5571");

  script_name(english:"RHEL 7 : python-XStatic-Bootstrap-SCSS (RHSA-2020:5571)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for python-XStatic-Bootstrap-SCSS.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2020:5571 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_5571.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a8a60ab1");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:5571");
...
"Update the RHEL python-XStatic-Bootstrap-SCSS package based on the guidance in RHSA-2020:5571.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python-XStatic-Bootstrap-SCSS-3.4.1.0-1.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'xstatic-bootstrap-scss-common-3.4.1.0-1.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python-XStatic-Bootstrap-SCSS / xstatic-bootstrap-scss-common');
}
