...
# extracted from Fedora Security Advisory FEDORA-2024-b3d904cade
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-b3d904cade");

  script_name(english:"Fedora 39 : python3-docs / python3.12 (2024-b3d904cade)");
...
FEDORA-2024-b3d904cade advisory.

    Update to 3.12.44, fix CVE-2024-4032
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-b3d904cade");
...
var pkgs = [
    {'reference':'python3-docs-3.12.4-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3.12-3.12.4-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
