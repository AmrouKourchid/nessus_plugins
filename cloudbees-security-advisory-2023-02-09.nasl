...
if (description)
{
  ...
  script_name(english:"Jenkins Enterprise and Operations Center 2.346.x < 2.346.40.0.8 Multiple Vulnerabilities (CloudBees Security Advisory 2023-02-09)");
...
2.346.40.0.8. It is, therefore, affected by multiple vulnerabilities including the following:
  ...
  - Git releases with critical vulnerabilities on CloudBees CI Docker images (CVE-2022-23521, CVE-2022-41903)

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  # https://www.cloudbees.com/security-advisories/cloudbees-security-advisory-2023-02-09
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?81e4b734");
