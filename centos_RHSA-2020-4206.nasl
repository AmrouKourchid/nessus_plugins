...
# extracted from Red Hat Security Advisory RHSA-2020:4206.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : chromium-browser (RHSA-2020:4206)");
...
RHSA-2020:4206 advisory.

  - Heap buffer overflow in storage in Google Chrome prior to 85.0.4183.121 allowed a remote attacker to
    potentially perform out of bounds memory access via a crafted HTML page. (CVE-2020-15960)

  - Insufficient policy validation in extensions in Google Chrome prior to 85.0.4183.121 allowed an attacker
  ...
  - Insufficient policy validation in serial in Google Chrome prior to 85.0.4183.121 allowed a remote attacker
    to potentially perform out of bounds memory access via a crafted HTML page. (CVE-2020-15962)

  - Insufficient policy enforcement in extensions in Google Chrome prior to 85.0.4183.121 allowed an attacker
    who convinced a user to install a malicious extension to potentially perform a sandbox escape via a
    crafted Chrome Extension. (CVE-2020-15963)

  - Insufficient data validation in media in Google Chrome prior to 85.0.4183.121 allowed a remote attacker to
    potentially exploit heap corruption via a crafted HTML page. (CVE-2020-15964)

  - Type confusion in V8 in Google Chrome prior to 85.0.4183.121 allowed a remote attacker to potentially
...
var pkgs = [
    {'reference':'chromium-browser-85.0.4183.121-1.el6_10', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
