...
if (description)
{
  ...
  script_cve_id("CVE-2013-1686");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2013-1686");
...
patch available.
  ...
  - Use-after-free vulnerability in the mozilla::ResetDir function in Mozilla Firefox before 22.0, Firefox ESR
    17.x before 17.0.7, Thunderbird before 17.0.7, and Thunderbird ESR 17.x before 17.0.7 allows remote
    attackers to execute arbitrary code or cause a denial of service (heap memory corruption) via unspecified
    vectors. (CVE-2013-1686)
