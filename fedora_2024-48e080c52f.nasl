...
# extracted from Fedora Security Advisory FEDORA-2024-48e080c52f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-48e080c52f");

  script_name(english:"Fedora 41 : vim (2024-48e080c52f)");
...
FEDORA-2024-48e080c52f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-48e080c52f");
...
var pkgs = [
    {'reference':'vim-9.1.719-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
