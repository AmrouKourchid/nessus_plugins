...
# extracted from Fedora Security Advisory FEDORA-2019-547be4a683.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : pango (2019-547be4a683)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-547be4a683");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"pango-1.43.0-4.fc30")) flag++;
