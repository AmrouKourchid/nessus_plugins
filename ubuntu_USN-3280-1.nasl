...
# extracted from Ubuntu Security Notice USN-3280-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"3280-1");

  script_name(english:"Ubuntu 14.04 LTS : Apache Batik vulnerability (USN-3280-1)");
...
USN-3280-1 advisory.
    ...
    Lars Krapf and Pierre Ernst discovered that Apache Batik incorrectly handled XML external entities. A
    remote attacker could possibly use this issue to obtain sensitive files from the filesystem, or cause a
    denial of service.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3280-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'libbatik-java', 'pkgver': '1.7.ubuntu-8ubuntu2.14.04.2'}
];
