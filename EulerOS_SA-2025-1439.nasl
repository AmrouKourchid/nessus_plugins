...
if (description)
{
  ...
  script_cve_id("CVE-2025-0306");

  script_name(english:"EulerOS 2.0 SP12 : ruby (EulerOS-SA-2025-1439)");
...
following vulnerabilities :
    ...
    A vulnerability was found in Ruby. The Ruby interpreter is vulnerable to the Marvin Attack. This attack
    allows the attacker to decrypt previously encrypted messages or forge signatures by exchanging a large
    number of messages with the vulnerable service.(CVE-2025-0306)
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1439
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?42f13213");
...
"Update the affected ruby packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-0306");
...
var pkgs = [
  "ruby-3.0.3-128.h14.eulerosv2r12",
  "ruby-help-3.0.3-128.h14.eulerosv2r12",
  "ruby-irb-3.0.3-128.h14.eulerosv2r12"
];
