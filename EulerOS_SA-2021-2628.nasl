...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : exiv2 (EulerOS-SA-2021-2628)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the exiv2 packages installed, the EulerOS installation on the remote host is affected by
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2628
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a1b2c617");
...
var pkgs = [
  "exiv2-0.26-12.h18.eulerosv2r8",
  "exiv2-libs-0.26-12.h18.eulerosv2r8"
];
