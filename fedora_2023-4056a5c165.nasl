...
# extracted from Fedora Security Advisory FEDORA-2023-4056a5c165
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-4056a5c165");

  script_name(english:"Fedora 38 : linux-firmware (2023-4056a5c165)");
...
FEDORA-2023-4056a5c165 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-4056a5c165");
...
var pkgs = [
    {'reference':'linux-firmware-20230919-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
