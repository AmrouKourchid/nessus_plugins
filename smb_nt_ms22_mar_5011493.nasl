...
if (description)
{
  ...
  script_name(english:"KB5011493: Windows 11 Security Update (March 2022)");
...
only on the application's self-reported version number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5011493");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5011493.");
