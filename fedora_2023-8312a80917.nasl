...
# extracted from Fedora Security Advisory FEDORA-2023-8312a80917
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-8312a80917");

  script_name(english:"Fedora 37 : mingw-python-OWSLib (2023-8312a80917)");
...
FEDORA-2023-8312a80917 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-8312a80917");
...
var pkgs = [
    {'reference':'mingw-python-OWSLib-0.28.1-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
