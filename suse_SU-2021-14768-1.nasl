...
# SUSE update advisory SUSE-SU-2021:14768-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2021:14768-1");
  script_xref(name:"IAVA", value:"2021-A-0352-S");

  script_name(english:"SUSE SLES11 Security Update : curl (SUSE-SU-2021:14768-1)");
...
referenced in the SUSE-SU-2021:14768-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2021-July/009195.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8bd6bde5");
...
if (os_ver == "SLES_SAP11" && (! preg(pattern:"^(0)$", string:service_pack))) audit(AUDIT_OS_NOT, "SLES_SAP11 SP0", os_ver + " SP" + service_pack);

var pkgs = [
    {'reference':'curl-openssl1-7.37.0-70.71.1', 'sp':'0', 'release':'SLES_SAP11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-11.3-0']},
    {'reference':'libcurl4-openssl1-32bit-7.37.0-70.71.1', 'sp':'0', 'cpu':'s390x', 'release':'SLES_SAP11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-11.3-0']},
    {'reference':'libcurl4-openssl1-32bit-7.37.0-70.71.1', 'sp':'0', 'cpu':'x86_64', 'release':'SLES_SAP11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-11.3-0']},
    {'reference':'libcurl4-openssl1-7.37.0-70.71.1', 'sp':'0', 'release':'SLES_SAP11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-11.3-0']},
    {'reference':'curl-openssl1-7.37.0-70.71.1', 'sp':'0', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.3-0']},
    {'reference':'libcurl4-openssl1-32bit-7.37.0-70.71.1', 'sp':'0', 'cpu':'s390x', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.3-0']},
    {'reference':'libcurl4-openssl1-32bit-7.37.0-70.71.1', 'sp':'0', 'cpu':'x86_64', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.3-0']},
    {'reference':'libcurl4-openssl1-7.37.0-70.71.1', 'sp':'0', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.3-0']}
];
