...
# extracted from Debian Security Advisory DLA-1473-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1473-1 : otrs2 security update");
...
user may escalate their privileges by accessing a specially crafted
URL.
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2018/08/msg00021.html");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"otrs", reference:"3.3.18-1+deb8u5")) flag++;
if (deb_check(release:"8.0", prefix:"otrs2", reference:"3.3.18-1+deb8u5")) flag++;
