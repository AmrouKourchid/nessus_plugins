...
# extracted from Red Hat Security Advisory RHSA-2020:4846. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:4846");
  script_xref(name:"CEA-ID", value:"CEA-2021-0025");

  script_name(english:"RHEL 8 : mingw-expat (RHSA-2020:4846)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for mingw-expat.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2020:4846 advisory.

    Expat is a C library for parsing XML documents. The mingw-expat packages provide a port of the Expat
    library for MinGW.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_4846.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b9fb58fe");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:4846");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1723723");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL mingw-expat package based on the guidance in RHSA-2020:4846.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:mingw-expat");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:mingw32-expat");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:mingw64-expat");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'mingw32-expat-2.2.4-5.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mingw64-expat-2.2.4-5.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'mingw32-expat / mingw64-expat');
}
