...
# extracted from SUSE update advisory SUSE-SU-2021:0975-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : tar (SUSE-SU-2021:0975-1)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?278a556b");
...
zypper in -t patch SUSE-SLE-SERVER-12-SP5-2021-975=1");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"5", reference:"tar-1.27.1-15.9.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"tar-debuginfo-1.27.1-15.9.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"tar-debugsource-1.27.1-15.9.1")) flag++;
