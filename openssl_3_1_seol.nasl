...
if (description)
{
  ...
  script_name(english:"OpenSSL SEoL (3.1.x)");
...
contain security vulnerabilities.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.openssl.org/news/vulnerabilities-3.1.html");
...
"Upgrade to a version of OpenSSL that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2025/03/14");
...
var constraints = [
  { max_branch : '3.1', min_branch : '3.1', seol : 20250314 }
];
