...
# SUSE update advisory SUSE-SU-2022:4595-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:4595-1");

  script_name(english:"SUSE SLES12 Security Update : kernel (Live Patch 25 for SLE 12 SP4) (SUSE-SU-2022:4595-1)");
...
referenced in the SUSE-SU-2022:4595-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-December/013298.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a82d7f07");
  script_set_attribute(attribute:"solution", value:
"Update the affected kgraft-patch-4_12_14-95_93-default package.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-95.93-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_12_14-95_93-default-11-2.2', 'sp':'4', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.4']},
          {'reference':'kgraft-patch-4_12_14-95_93-default-11-2.2', 'sp':'4', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-12.4', 'sle-live-patching-release-12.4', 'sles-release-12.4']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kgraft-patch-4_12_14-95_93-default');
}
