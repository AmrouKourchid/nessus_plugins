...
# AlmaLinux Security Advisory ALSA-2024:3513.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:3513");

  script_name(english:"AlmaLinux 9 : less (ALSA-2024:3513)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2024-3513.html");
...
"Update the affected less package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:less");
