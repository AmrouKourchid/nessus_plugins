...
ELSA-2014-3014 advisory.
    ...
    - netfilter: nf_conntrack_dccp: fix skb_header_pointer API usages (Daniel Borkmann)  [Orabug: 18421673]
    {CVE-2014-2523}
    - cifs: ensure that uncached writes handle unmapped areas correctly (Jeff Layton)  [Orabug: 18461067]
    {CVE-2014-0069} {CVE-2014-0069}
    - net: sctp: fix sctp_sf_do_5_1D_ce to verify if we/peer is AUTH capable (Daniel Borkmann)  [Orabug:
    18461065]  {CVE-2014-0101}
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2014-0069");
...
var pkgs = [
    ...
    {'reference':'kernel-uek-doc-3.8.13-26.2.2.el6uek', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-doc-3.8.13'},
    {'reference':'kernel-uek-firmware-3.8.13-26.2.2.el6uek', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-firmware-3.8.13'},
