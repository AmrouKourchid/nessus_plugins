...
# extracted from Fedora Security Advisory FEDORA-2024-4e0ea1c22e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-4e0ea1c22e");
  script_xref(name:"IAVA", value:"2024-A-0324-S");

  script_name(english:"Fedora 39 : chromium (2024-4e0ea1c22e)");
...
FEDORA-2024-4e0ea1c22e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-4e0ea1c22e");
...
var pkgs = [
    {'reference':'chromium-125.0.6422.141-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
