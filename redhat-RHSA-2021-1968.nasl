...
if (description)
{
  ...
  script_name(english:"RHEL 8 : mingw (RHSA-2021:1968)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for mingw.");
...
referenced in the RHSA-2021:1968 advisory.
    ...
    The following packages have been upgraded to a later upstream version: mingw-sqlite (3.26.0.0).
    (BZ#1845475)
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_1968.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bd4143dd");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1918306");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL mingw packages based on the guidance in RHSA-2021:1968.");
  ...
  script_cwe_id(20, 121, 369, 416, 476);
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:mingw-bzip2");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:mingw-filesystem");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:mingw-filesystem-base");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:mingw-sqlite");
