...
if (description)
{
  ...
  script_cve_id("CVE-2023-0030");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2023-0030");
...
patch available.
  ...
  - A use-after-free flaw was found in the Linux kernel's nouveau driver in how a user triggers a memory
    overflow that causes the nvkm_vma_tail function to fail. This flaw allows a local user to crash or
    potentially escalate their privileges on the system. (CVE-2023-0030)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-0030");
