...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : xen on SL5.x i386/x86_64 (20150513) (Venom)");
...
guests must be restarted for this update to take effect.");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1505&L=scientific-linux-errata&T=0&P=876
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?23a1fd06");
