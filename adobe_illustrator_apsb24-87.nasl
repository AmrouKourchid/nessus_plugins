...
if (description)
{
  ...
  script_name(english:"Adobe Illustrator < 28.7.2 Multiple Vulnerabilities (APSB24-87)");

  script_set_attribute(attribute:"synopsis", value:
"The Adobe Illustrator instance installed on the remote host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Illustrator installed on the remote Windows host is prior to 28.7.2. It is, therefore, affected by
