...
# extracted from openSUSE Security Update openSUSE-2018-1395.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : icecast (openSUSE-2018-1395)");
...
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"icecast-2.4.3-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"icecast-debuginfo-2.4.3-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"icecast-debugsource-2.4.3-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"icecast-2.4.2-7.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"icecast-debuginfo-2.4.2-7.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"icecast-debugsource-2.4.2-7.3.1") ) flag++;
