...
# extracted from Oracle Linux Security Advisory ELSA-2024-0769.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : tcpdump (ELSA-2024-0769)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-0769.html");
