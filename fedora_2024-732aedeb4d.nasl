...
# extracted from Fedora Security Advisory FEDORA-2024-732aedeb4d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-732aedeb4d");

  script_name(english:"Fedora 40 : python3.6 (2024-732aedeb4d)");
...
FEDORA-2024-732aedeb4d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-732aedeb4d");
...
var pkgs = [
    {'reference':'python3.6-3.6.15-31.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
