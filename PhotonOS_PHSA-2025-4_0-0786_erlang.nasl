...
# extracted from VMware Security Advisory PHSA-2025-4.0-0786. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Erlang PHSA-2025-4.0-0786");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the erlang package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-786.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'erlang-26.2.5.11-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'erlang-sd_notify-1.1-5.ph4')) flag++;
