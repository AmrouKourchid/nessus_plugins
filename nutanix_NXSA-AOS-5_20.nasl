...
if (description)
{
  ...
  script_name(english:"Nutanix AOS : Multiple Vulnerabilities (NXSA-AOS-5.20)");

  script_set_attribute(attribute:"synopsis", value:
"The Nutanix AOS host is affected by multiple vulnerabilities .");
  script_set_attribute(attribute:"description", value:
"The version of AOS installed on the remote host is prior to 5.20. It is, therefore, affected by multiple vulnerabilities
as referenced in the NXSA-AOS-5.20 advisory.
...
number.");
  # https://portal.nutanix.com/page/documents/security-advisories/release-advisories/details?id=NXSA-AOS-5.20
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3aba379b");
...
var constraints = [
  { 'fixed_version' : '5.20', 'product' : 'AOS', 'fixed_display' : 'Upgrade the AOS install to 5.20 or higher.', 'lts' : TRUE },
  { 'fixed_version' : '5.20', 'product' : 'NDFS', 'fixed_display' : 'Upgrade the AOS install to 5.20 or higher.', 'lts' : TRUE }
];
