...
# extracted from VMware Security Advisory PHSA-2022-4.0-0159. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Containerd PHSA-2022-4.0-0159");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the containerd package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-159.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'containerd-1.4.12-3.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'containerd-doc-1.4.12-3.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'containerd-extras-1.4.12-3.ph4')) flag++;
