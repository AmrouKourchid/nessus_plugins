...
if (description)
{
  ...
  script_name(english:"Tenable Nessus Agent SEoL (8.2.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Tenable Nessus Agent is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Tenable Nessus Agent is 8.2.x. It is, therefore, no longer maintained by its vendor or
provider.
...
var constraints = [
  { max_branch : '8.2', min_branch : '8.2', seol : 20220430, eseol : 20221031 }
];
