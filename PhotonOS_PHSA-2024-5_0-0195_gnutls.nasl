...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Gnutls PHSA-2024-5.0-0195");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'gnutls-3.7.10-2.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'gnutls-devel-3.7.10-2.ph5')) flag++;
