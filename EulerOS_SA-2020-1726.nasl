...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : gcc (EulerOS-SA-2020-1726)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1726
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?27517401");
...
pkgs = ["cpp-4.8.5-28.1.h8",
        "gcc-4.8.5-28.1.h8",
        "gcc-c++-4.8.5-28.1.h8",
        "gcc-gfortran-4.8.5-28.1.h8",
        "libgcc-4.8.5-28.1.h8",
        "libgfortran-4.8.5-28.1.h8",
        "libgomp-4.8.5-28.1.h8",
        "libquadmath-4.8.5-28.1.h8",
        "libquadmath-devel-4.8.5-28.1.h8",
        "libstdc++-4.8.5-28.1.h8",
        "libstdc++-devel-4.8.5-28.1.h8"];
