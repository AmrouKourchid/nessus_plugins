...
"The version of Firefox ESR installed on the remote Windows host is prior to 102.15. It is, therefore, affected by
multiple vulnerabilities as referenced in the mfsa2023-35 advisory.
...
mozilla_check_version(installs:installs, product:'firefox', esr:TRUE, fix:'102.15', min:'102.0.0', severity:SECURITY_HOLE);
