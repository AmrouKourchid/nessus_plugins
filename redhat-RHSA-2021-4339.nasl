...
# extracted from Red Hat Security Advisory RHSA-2021:4339. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:4339");

  script_name(english:"RHEL 8 : grilo (RHSA-2021:4339)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for grilo.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2021:4339 advisory.

    Grilo is a framework that provides access to different sources of multimedia content, using a pluggable
    system. The grilo package contains the core library and elements.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_4339.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7ed8225d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:4339");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1997161");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL grilo package based on the guidance in RHSA-2021:4339.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'grilo-0.3.6-3.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'grilo-devel-0.3.6-3.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'grilo / grilo-devel');
}
