...
# extracted from Fedora Security Advisory FEDORA-2024-a84c59eedc
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-a84c59eedc");

  script_name(english:"Fedora 39 : lua-mpack (2024-a84c59eedc)");
...
FEDORA-2024-a84c59eedc advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-a84c59eedc");
...
var pkgs = [
    {'reference':'lua-mpack-1.0.12-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
