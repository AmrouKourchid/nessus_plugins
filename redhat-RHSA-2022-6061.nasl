...
# extracted from Red Hat Security Advisory RHSA-2022:6061. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2022-21698", "CVE-2022-30631");
  script_xref(name:"RHSA", value:"2022:6061");

  script_name(english:"RHEL 8 : Red Hat OpenStack Platform 16.2 (etcd) (RHSA-2022:6061)");
...
referenced in the RHSA-2022:6061 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_6061.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?de50a4fa");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:6061");
...
"Update the RHEL Red Hat OpenStack Platform 16.2 (etcd) package based on the guidance in RHSA-2022:6061.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-21698");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2022-30631");

  script_set_attribute(attribute:"exploitability_ease", value:"No known exploits are available");
  script_set_attribute(attribute:"exploit_available", value:"false");
  script_cwe_id(772, 1325);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'etcd-3.3.23-10.el8ost', 'cpu':'ppc64le', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'etcd-3.3.23-10.el8ost', 'cpu':'x86_64', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
