...
# extracted from Red Hat Security Advisory RHSA-2019:4191. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:4191");

  script_name(english:"RHEL 5 : sudo (RHSA-2019:4191)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_4191.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0ffb25fb");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1760531");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:4191");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL sudo package based on the guidance in RHSA-2019:4191.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'sudo-1.7.2p1-31.el5_11.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sudo-1.7.2p1-31.el5_11.1', 'cpu':'s390x', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sudo-1.7.2p1-31.el5_11.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
