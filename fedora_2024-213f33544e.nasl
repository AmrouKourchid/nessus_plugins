...
# extracted from Fedora Security Advisory FEDORA-2024-213f33544e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-213f33544e");

  script_name(english:"Fedora 39 : openssh (2024-213f33544e)");
...
FEDORA-2024-213f33544e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-213f33544e");
...
var pkgs = [
    {'reference':'openssh-9.3p1-11.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
