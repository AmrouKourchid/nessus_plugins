...
# extracted from Fedora Security Advisory FEDORA-2024-bc7d40eb2e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-bc7d40eb2e");

  script_name(english:"Fedora 40 : php-tcpdf (2024-bc7d40eb2e)");
...
FEDORA-2024-bc7d40eb2e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-bc7d40eb2e");
...
var pkgs = [
    {'reference':'php-tcpdf-6.7.4-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
