...
# extracted from Red Hat Security Advisory RHSA-2014:2024. The text 
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2014/rhsa-2014_2024.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?981fbd5d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2014:2024");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1176032");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1176035");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1176037");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1176040");
...
"Update the RHEL ntp package based on the guidance in RHSA-2014:2024.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2014-9293");

  script_set_attribute(attribute:"exploitability_ease", value:"No known exploits are available");
  script_set_attribute(attribute:"exploit_available", value:"false");
  script_cwe_id(119, 338, 390);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ntp-4.2.6p5-19.el7_0', 'cpu':'ppc64', 'release':'7', 'el_string':'el7_0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ntp-4.2.6p5-19.el7_0', 'cpu':'s390x', 'release':'7', 'el_string':'el7_0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ntp-4.2.6p5-19.el7_0', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ntp-doc-4.2.6p5-19.el7_0', 'release':'7', 'el_string':'el7_0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ntp-perl-4.2.6p5-19.el7_0', 'release':'7', 'el_string':'el7_0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ntpdate-4.2.6p5-19.el7_0', 'cpu':'ppc64', 'release':'7', 'el_string':'el7_0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ntpdate-4.2.6p5-19.el7_0', 'cpu':'s390x', 'release':'7', 'el_string':'el7_0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ntpdate-4.2.6p5-19.el7_0', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sntp-4.2.6p5-19.el7_0', 'cpu':'ppc64', 'release':'7', 'el_string':'el7_0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sntp-4.2.6p5-19.el7_0', 'cpu':'s390x', 'release':'7', 'el_string':'el7_0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sntp-4.2.6p5-19.el7_0', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_0', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'ntp-4.2.6p5-2.el6_6', 'cpu':'i686', 'release':'6', 'el_string':'el6_6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ntp-4.2.6p5-2.el6_6', 'cpu':'ppc64', 'release':'6', 'el_string':'el6_6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ntp-4.2.6p5-2.el6_6', 'cpu':'s390x', 'release':'6', 'el_string':'el6_6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ntp-4.2.6p5-2.el6_6', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ntp-doc-4.2.6p5-2.el6_6', 'release':'6', 'el_string':'el6_6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ntp-perl-4.2.6p5-2.el6_6', 'cpu':'i686', 'release':'6', 'el_string':'el6_6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ntp-perl-4.2.6p5-2.el6_6', 'cpu':'ppc64', 'release':'6', 'el_string':'el6_6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ntp-perl-4.2.6p5-2.el6_6', 'cpu':'s390x', 'release':'6', 'el_string':'el6_6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ntp-perl-4.2.6p5-2.el6_6', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ntpdate-4.2.6p5-2.el6_6', 'cpu':'i686', 'release':'6', 'el_string':'el6_6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ntpdate-4.2.6p5-2.el6_6', 'cpu':'ppc64', 'release':'6', 'el_string':'el6_6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ntpdate-4.2.6p5-2.el6_6', 'cpu':'s390x', 'release':'6', 'el_string':'el6_6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ntpdate-4.2.6p5-2.el6_6', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
