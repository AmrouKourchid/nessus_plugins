...
# extracted from Fedora Security Advisory FEDORA-2024-f1ae7b7ac5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-f1ae7b7ac5");

  script_name(english:"Fedora 38 : webkitgtk (2024-f1ae7b7ac5)");
...
FEDORA-2024-f1ae7b7ac5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-f1ae7b7ac5");
...
var pkgs = [
    {'reference':'webkitgtk-2.44.0-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
