...
# extracted from Ubuntu Security Notice USN-6930-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6930-1");

  script_name(english:"Ubuntu 20.04 LTS / 22.04 LTS / 24.04 LTS : OpenJDK 11 vulnerabilities (USN-6930-1)");
...
vulnerabilities as referenced in the USN-6930-1 advisory.

    It was discovered that the Hotspot component of OpenJDK 11 was not properly performing bounds when
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6930-1");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'openjdk-11-demo', 'pkgver': '11.0.24+8-1ubuntu3~20.04'},
    {'osver': '20.04', 'pkgname': 'openjdk-11-jdk', 'pkgver': '11.0.24+8-1ubuntu3~20.04'},
    {'osver': '20.04', 'pkgname': 'openjdk-11-jdk-headless', 'pkgver': '11.0.24+8-1ubuntu3~20.04'},
    {'osver': '20.04', 'pkgname': 'openjdk-11-jre', 'pkgver': '11.0.24+8-1ubuntu3~20.04'},
    {'osver': '20.04', 'pkgname': 'openjdk-11-jre-headless', 'pkgver': '11.0.24+8-1ubuntu3~20.04'},
    {'osver': '20.04', 'pkgname': 'openjdk-11-jre-zero', 'pkgver': '11.0.24+8-1ubuntu3~20.04'},
    {'osver': '20.04', 'pkgname': 'openjdk-11-source', 'pkgver': '11.0.24+8-1ubuntu3~20.04'},
    {'osver': '22.04', 'pkgname': 'openjdk-11-demo', 'pkgver': '11.0.24+8-1ubuntu3~22.04'},
    {'osver': '22.04', 'pkgname': 'openjdk-11-jdk', 'pkgver': '11.0.24+8-1ubuntu3~22.04'},
    {'osver': '22.04', 'pkgname': 'openjdk-11-jdk-headless', 'pkgver': '11.0.24+8-1ubuntu3~22.04'},
    {'osver': '22.04', 'pkgname': 'openjdk-11-jre', 'pkgver': '11.0.24+8-1ubuntu3~22.04'},
    {'osver': '22.04', 'pkgname': 'openjdk-11-jre-headless', 'pkgver': '11.0.24+8-1ubuntu3~22.04'},
    {'osver': '22.04', 'pkgname': 'openjdk-11-jre-zero', 'pkgver': '11.0.24+8-1ubuntu3~22.04'},
    {'osver': '22.04', 'pkgname': 'openjdk-11-source', 'pkgver': '11.0.24+8-1ubuntu3~22.04'},
    {'osver': '24.04', 'pkgname': 'openjdk-11-demo', 'pkgver': '11.0.24+8-1ubuntu3~24.04.1'},
    {'osver': '24.04', 'pkgname': 'openjdk-11-jdk', 'pkgver': '11.0.24+8-1ubuntu3~24.04.1'},
    {'osver': '24.04', 'pkgname': 'openjdk-11-jdk-headless', 'pkgver': '11.0.24+8-1ubuntu3~24.04.1'},
    {'osver': '24.04', 'pkgname': 'openjdk-11-jre', 'pkgver': '11.0.24+8-1ubuntu3~24.04.1'},
    {'osver': '24.04', 'pkgname': 'openjdk-11-jre-headless', 'pkgver': '11.0.24+8-1ubuntu3~24.04.1'},
    {'osver': '24.04', 'pkgname': 'openjdk-11-jre-zero', 'pkgver': '11.0.24+8-1ubuntu3~24.04.1'},
    {'osver': '24.04', 'pkgname': 'openjdk-11-source', 'pkgver': '11.0.24+8-1ubuntu3~24.04.1'}
];
