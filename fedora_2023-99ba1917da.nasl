...
# extracted from Fedora Security Advisory FEDORA-2023-99ba1917da
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-99ba1917da");

  script_name(english:"Fedora 36 : thunderbird (2023-99ba1917da)");
...
FEDORA-2023-99ba1917da advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-99ba1917da");
...
var pkgs = [
    {'reference':'thunderbird-102.7.1-2.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
