...
if (description)
{
  ...
  script_cve_id("CVE-2025-21784");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2025-21784");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: drm/amdgpu: bail out when failed to
    load fw in psp_init_cap_microcode() In function psp_init_cap_microcode(), it should bail out when failed
    to load firmware, otherwise it may cause invalid memory access. (CVE-2025-21784)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-21784");
