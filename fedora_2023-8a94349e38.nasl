...
# extracted from Fedora Security Advisory FEDORA-2023-8a94349e38
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-8a94349e38");
  script_xref(name:"IAVA", value:"2023-A-0387-S");

  script_name(english:"Fedora 37 : chromium (2023-8a94349e38)");
...
FEDORA-2023-8a94349e38 advisory.

    update to 115.0.5790.110. Fixes the following security issue:

      CVE-2022-4908 CVE-2022-4909 CVE-2022-4910 CVE-2022-4908 CVE-2022-4909  CVE-2022-4910 CVE-2022-4906
    CVE-2022-4907
      CVE-2022-4906 CVE-2022-4907 CVE-2023-2311 CVE-2023-2313 CVE-2023-2311 CVE-2023-2313 CVE-2023-2929
    CVE-2023-2929
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-8a94349e38");
...
"Update the affected chromium package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-3598");
...
var pkgs = [
    {'reference':'chromium-115.0.5790.110-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
