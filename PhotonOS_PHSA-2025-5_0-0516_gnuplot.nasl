...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Gnuplot PHSA-2025-5.0-0516");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-31181");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'gnuplot-5.4.5-5.ph5')) flag++;
