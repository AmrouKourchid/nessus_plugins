...
# extracted from Fedora Security Advisory FEDORA-2018-c73d257297.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : cabextract / libmspack (2018-c73d257297)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-c73d257297");
  script_set_attribute(attribute:"solution", value:
"Update the affected cabextract and / or libmspack packages.");
...
flag = 0;
if (rpm_check(release:"FC27", reference:"cabextract-1.9-1.fc27")) flag++;
if (rpm_check(release:"FC27", reference:"libmspack-0.9.1-0.1.alpha.fc27")) flag++;
