...
# extracted from Fedora Security Advisory FEDORA-2025-a62f1e771c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-a62f1e771c");

  script_name(english:"Fedora 41 : gnutls (2025-a62f1e771c)");
...
FEDORA-2025-a62f1e771c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-a62f1e771c");
...
var pkgs = [
    {'reference':'gnutls-3.8.9-2.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
