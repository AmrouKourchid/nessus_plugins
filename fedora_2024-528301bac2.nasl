...
# extracted from Fedora Security Advisory FEDORA-2024-528301bac2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-528301bac2");

  script_name(english:"Fedora 39 : mod_http2 (2024-528301bac2)");
...
FEDORA-2024-528301bac2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-528301bac2");
...
var pkgs = [
    {'reference':'mod_http2-2.0.27-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
