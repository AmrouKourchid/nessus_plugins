...
if (description)
{
  ...
  script_xref(name:"CISCO-BUG-ID", value:"CSCwf15468");
  script_xref(name:"CISCO-SA", value:"cisco-sa-pi-epnm-storedxss-tTjO62r");
  script_xref(name:"IAVA", value:"2023-A-0430-S");

  script_name(english:"Cisco Evolved Programmable Network Manager XSS (cisco-sa-pi-epnm-storedxss-tTjO62r)");

  script_set_attribute(attribute:"synopsis", value:
"The remote device is missing a vendor-supplied security patch.");
  script_set_attribute(attribute:"description", value:
"The version of Cisco Evolved Programmable Network Manager installed on the remote host is 7.0 or earlier. It is,
therefore, affected by a cross-site scripting (XSS) vulnerability. Due to insufficient validation of user input, an
unauthenticated, remote attacker can, inject malicious code into specific pages of the user interface of an affected
device. A successful exploit can allow the attacker to execute arbitrary code in the context of the affected interface
...
"Upgrade to the relevant fixed version referenced in Cisco bug ID CSCwf15468");
...
var constraints = [
  {'max_version': '7.0', 'fixed_display': 'See vendor advisory'}
];
