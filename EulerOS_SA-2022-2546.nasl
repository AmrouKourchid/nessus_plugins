...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : binutils (EulerOS-SA-2022-2546)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2546
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5238a85b");
...
var pkgs = [
  "binutils-2.31.1-13.h27.eulerosv2r8",
  "binutils-devel-2.31.1-13.h27.eulerosv2r8"
];
