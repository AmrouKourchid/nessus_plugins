...
# extracted from Oracle Linux Security Advisory ELSA-2023-2202.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : frr (ELSA-2023-2202)");
...
ELSA-2023-2202 advisory.
    ...
    [8.3.1-2]
    - Resolves: #2128738 - out-of-bounds read in the BGP daemon may lead to information disclosure or denial
    of service
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-2202.html");
...
var pkgs = [
    {'reference':'frr-8.3.1-5.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'frr-selinux-8.3.1-5.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'frr-8.3.1-5.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'frr-selinux-8.3.1-5.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
