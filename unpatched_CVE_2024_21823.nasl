...
if (description)
{
  ...
  script_cve_id("CVE-2024-21823");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-21823");
...
patch available.
  ...
  - Hardware logic with insecure de-synchronization in Intel(R) DSA and Intel(R) IAA for some Intel(R) 4th or
    5th generation Xeon(R) processors may allow an authorized user to potentially enable escalation of
    privilege local access (CVE-2024-21823)
