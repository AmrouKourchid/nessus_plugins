...
if (description)
{
  ...
  script_cve_id("CVE-2024-24940", "CVE-2024-24941");
  script_xref(name:"IAVA", value:"2024-A-0334");
  script_xref(name:"IAVA", value:"2024-A-0069-S");

  script_name(english:"JetBrains IntelliJ IDEA < 2023.3.3 Multiple Vulnerabilities (macOS)");

  script_set_attribute(attribute:"synopsis", value:
"The instance of JetBrains IntelliJ IDEA installed on the remote host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of JetBrains IntelliJ IDEA installed on the remote macOS host is prior to 2023.3.3 It is, 
therefore, affected by multiple vulnerabilities:

  - Path traversal was possible when unpacking archives (CVE-2024-24940)

  - A plugin for JetBrains Space was able to send an authentication token to an inappropriate URL (CVE-2024-24941)
...
"Upgrade to JetBrains IntelliJ IDEA version 2023.3.3 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:P/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:L/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-24941");
