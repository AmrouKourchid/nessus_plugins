...
if (description)
{
  ...
  script_cve_id("CVE-2016-7909");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2016-7909");
...
patch available.
  ...
  - The pcnet_rdra_addr function in hw/net/pcnet.c in QEMU (aka Quick Emulator) allows local guest OS
    administrators to cause a denial of service (infinite loop and QEMU process crash) by setting the (1)
    receive or (2) transmit descriptor ring length to 0. (CVE-2016-7909)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-7909");
