...
# extracted from Fedora Security Advisory FEDORA-2024-9c81ad492a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-9c81ad492a");

  script_name(english:"Fedora 39 : micropython (2024-9c81ad492a)");
...
FEDORA-2024-9c81ad492a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-9c81ad492a");
...
var pkgs = [
    {'reference':'micropython-1.23.0-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
