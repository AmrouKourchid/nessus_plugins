...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.1 : nghttp2 (EulerOS-SA-2023-3363)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3363
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?48242962");
...
var pkgs = [
  "libnghttp2-1.46.0-1.h3.eulerosv2r11"
];
