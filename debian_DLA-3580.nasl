...
# extracted from Debian Security Advisory dla-3580. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3580 : libapache-mod-jk-doc - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3580
advisory.

    -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3580-1                debian-lts@lists.debian.org
    https://www.debian.org/lts/security/                      Markus Koschany
    September 24, 2023                            https://wiki.debian.org/LTS
    -------------------------------------------------------------------------
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cf94d944");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-41081");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/libapache-mod-jk");
  script_set_attribute(attribute:"solution", value:
"Upgrade the libapache-mod-jk-doc packages.");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libapache-mod-jk-doc', 'reference': '1:1.2.46-1+deb10u2'},
    {'release': '10.0', 'prefix': 'libapache2-mod-jk', 'reference': '1:1.2.46-1+deb10u2'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libapache-mod-jk-doc / libapache2-mod-jk');
}
