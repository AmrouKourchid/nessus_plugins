...
"The remote Red Hat host is missing one or more security updates for groovy.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2017:2486 advisory.
    ...
    * It was found that a flaw in Apache groovy library allows remote code execution wherever deserialization
    occurs in the application. It is possible for an attacker to craft a special serialized object that will
    execute code directly when deserialized. All applications which rely on serialization and do not isolate
    the code which deserializes objects are subject to this vulnerability. (CVE-2016-6814)

Tenable has extracted the preceding description block directly from the Red Hat Enterprise Linux security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2017/rhsa-2017_2486.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?35fa91db");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2017:2486");
...
"Update the RHEL groovy package based on the guidance in RHSA-2017:2486.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'groovy-1.8.9-8.el7_4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'groovy-javadoc-1.8.9-8.el7_4', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
