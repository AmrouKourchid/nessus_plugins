...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : netpbm (ELSA-2009-0012)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2009-0012.html");
...
"Update the affected netpbm, netpbm-devel and / or netpbm-progs packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2008-3520");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2007-2721");
...
var pkgs = [
    {'reference':'netpbm-10.35-6.1.el5_3.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'netpbm-devel-10.35-6.1.el5_3.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'netpbm-progs-10.35-6.1.el5_3.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'netpbm-10.35-6.1.el5_3.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'netpbm-devel-10.35-6.1.el5_3.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'netpbm-progs-10.35-6.1.el5_3.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
