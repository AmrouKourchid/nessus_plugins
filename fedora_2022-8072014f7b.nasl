...
# extracted from Fedora Security Advisory FEDORA-2022-8072014f7b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-8072014f7b");

  script_name(english:"Fedora 38 : pypy3.8 (2022-8072014f7b)");
...
FEDORA-2022-8072014f7b advisory.
    ...
    ```
    * Mon Oct 10 2022 Lumr Balhar <lbalhar@redhat.com> - 7.3.9-5.3.8
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-8072014f7b");
  script_set_attribute(attribute:"solution", value:
"Update the affected pypy3.8 package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:pypy3.8");
...
var pkgs = [
    {'reference':'pypy3.8-7.3.9-5.3.8.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'pypy3.8');
}
