...
# extracted from Ubuntu Security Notice USN-5437-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5437-1");

  script_name(english:"Ubuntu 16.04 ESM : libXfixes vulnerability (USN-5437-1)");
...
USN-5437-1 advisory.
    ...
    Tobias Stoeckmann discovered that libXfixes incorrectly handled certain inputs. An attacker could possibly
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5437-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libxfixes-dev', 'pkgver': '1:5.0.1-2ubuntu0.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libxfixes3', 'pkgver': '1:5.0.1-2ubuntu0.1~esm1', 'ubuntu_pro': TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libxfixes-dev / libxfixes3');
}
