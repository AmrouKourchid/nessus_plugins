...
# extracted from Amazon Linux 2023 Security Advisory ALAS2023-2024-667.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2023 : java-22-amazon-corretto, java-22-amazon-corretto-devel, java-22-amazon-corretto-headless (ALAS2023-2024-667)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2023 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"It is, therefore, affected by multiple vulnerabilities as referenced in the ALAS2023-2024-667 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2023/ALAS-2024-667.html");
...
"Run 'dnf update java-22-amazon-corretto --releasever 2023.5.20240722' to update your system.");
...
var pkgs = [
    {'reference':'java-22-amazon-corretto-22.0.2+9-1.amzn2023.1', 'cpu':'aarch64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'java-22-amazon-corretto-22.0.2+9-1.amzn2023.1', 'cpu':'x86_64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'java-22-amazon-corretto-devel-22.0.2+9-1.amzn2023.1', 'cpu':'aarch64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'java-22-amazon-corretto-devel-22.0.2+9-1.amzn2023.1', 'cpu':'x86_64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'java-22-amazon-corretto-headless-22.0.2+9-1.amzn2023.1', 'cpu':'aarch64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'java-22-amazon-corretto-headless-22.0.2+9-1.amzn2023.1', 'cpu':'x86_64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'java-22-amazon-corretto-javadoc-22.0.2+9-1.amzn2023.1', 'cpu':'aarch64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'java-22-amazon-corretto-javadoc-22.0.2+9-1.amzn2023.1', 'cpu':'x86_64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'java-22-amazon-corretto-jmods-22.0.2+9-1.amzn2023.1', 'cpu':'aarch64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'java-22-amazon-corretto-jmods-22.0.2+9-1.amzn2023.1', 'cpu':'x86_64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE}
];
