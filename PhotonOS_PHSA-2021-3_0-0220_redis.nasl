...
# extracted from VMware Security Advisory PHSA-2021-3.0-0220. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Redis PHSA-2021-3.0-0220");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the redis package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-3.0-220.md");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-3470");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'redis-5.0.12-1.ph3')) flag++;
