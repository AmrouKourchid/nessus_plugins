...
if (description)
{
  ...
  script_cve_id("CVE-2022-49120");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-49120");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: scsi: pm8001: Fix task leak in
    pm8001_send_abort_all() In pm8001_send_abort_all(), make sure to free the allocated sas task if
    pm8001_tag_alloc() or pm8001_mpi_build_cmd() fail. (CVE-2022-49120)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-49120");
