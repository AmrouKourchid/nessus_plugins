...
# extracted from Debian Security Advisory dla-4101. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-4101 : libvarnishapi-dev - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has packages installed that are affected by a vulnerability as referenced in the dla-4101
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2025-30346");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'libvarnishapi-dev', 'reference': '6.5.1-1+deb11u4'},
    {'release': '11.0', 'prefix': 'libvarnishapi2', 'reference': '6.5.1-1+deb11u4'},
    {'release': '11.0', 'prefix': 'varnish', 'reference': '6.5.1-1+deb11u4'},
    {'release': '11.0', 'prefix': 'varnish-doc', 'reference': '6.5.1-1+deb11u4'}
];
