...
# extracted from Ubuntu Security Notice USN-5578-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5578-2");
  script_xref(name:"IAVB", value:"2022-B-0029-S");

  script_name(english:"Ubuntu 16.04 ESM : Open VM Tools vulnerability (USN-5578-2)");
...
USN-5578-2 advisory.
    ...
    USN-5578-1 fixed a vulnerability in Open VM Tools. This update provides the corresponding update for
    Ubuntu 16.04 ESM.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5578-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'open-vm-tools', 'pkgver': '2:10.2.0-3~ubuntu0.16.04.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'open-vm-tools-desktop', 'pkgver': '2:10.2.0-3~ubuntu0.16.04.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'open-vm-tools-dev', 'pkgver': '2:10.2.0-3~ubuntu0.16.04.1+esm1', 'ubuntu_pro': TRUE}
];
