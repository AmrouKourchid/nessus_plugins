...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.2.0 : file (EulerOS-SA-2020-1201)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1201
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e8a955dc");
...
pkgs = ["file-5.11-33.h1",
        "file-libs-5.11-33.h1"];
