...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : busybox (EulerOS-SA-2022-2151)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2151
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?73ec777d");
...
var pkgs = [
  "busybox-1.31.1-6.h8.eulerosv2r10"
];
