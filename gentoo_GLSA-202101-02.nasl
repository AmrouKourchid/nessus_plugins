...
# extracted from Gentoo Linux Security Advisory GLSA 202101-02.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202101-02");

  script_name(english:"GLSA-202101-02 : Firejail: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202101-02
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202101-02");
...
if (qpkg_check(package:"sys-apps/firejail", unaffected:make_list("ge 0.9.64"), vulnerable:make_list("lt 0.9.64"))) flag++;
