...
# extracted from Red Hat Security Advisory RHSA-2023:2193. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2022-27664", "CVE-2022-32189");
  script_xref(name:"RHSA", value:"2023:2193");

  script_name(english:"RHEL 9 : butane (RHSA-2023:2193)");
...
referenced in the RHSA-2023:2193 advisory.

    Butane translates human-readable Butane Configs into machine-readable Ignition configs for provisioning
    operating systems that use Ignition.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_2193.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?69f08759");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2135475");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:2193");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'butane-0.16.0-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'butane');
}
