...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.2.0 : netpbm (EulerOS-SA-2020-1255)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1255
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8daf4244");
...
pkgs = ["netpbm-10.79.00-7.h1",
        "netpbm-progs-10.79.00-7.h1"];
