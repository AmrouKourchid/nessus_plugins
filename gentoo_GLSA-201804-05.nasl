...
# extracted from Gentoo Linux Security Advisory GLSA 201804-05.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201804-05");
  script_xref(name:"IAVB", value:"2018-B-0034-S");

  script_name(english:"GLSA-201804-05 : ISC DHCP: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-201804-05
...
Workaround :
    ...
    In accordance with upstream documentation, the recommended workaround
      for CVE-2017-3144 is, &ldquo;to disallow access to the OMAPI control port
      from unauthorized clients (in accordance with best practices for server
      operation).&rdquo;");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/201804-05");
...
if (qpkg_check(package:"net-misc/dhcp", unaffected:make_list("ge 4.3.6_p1"), vulnerable:make_list("lt 4.3.6_p1"))) flag++;
