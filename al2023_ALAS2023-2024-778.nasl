...
# extracted from Amazon Linux 2023 Security Advisory ALAS2023-2024-778.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2024-41080", "CVE-2024-49996");

  script_name(english:"Amazon Linux 2023 : bpftool, kernel, kernel-devel (ALAS2023-2024-778)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2023 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"It is, therefore, affected by multiple vulnerabilities as referenced in the ALAS2023-2024-778 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2023/ALAS-2024-778.html");
...
"Run 'dnf update kernel --releasever 2023.6.20241209' to update your system.");
...
if (get_one_kb_item("Host/kpatch/kernel-cves"))
{
  ...
  var cve_list = make_list("CVE-2024-41080", "CVE-2024-49996");
  if (hotfix_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, "kpatch hotfix for ALAS2023-2024-778");
  }
  else
  {
