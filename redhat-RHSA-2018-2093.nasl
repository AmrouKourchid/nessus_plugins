...
# extracted from Red Hat Security Advisory RHSA-2018:2093. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:2093");

  script_name(english:"RHEL 7 : patch (RHSA-2018:2093)");
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_2093.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9b38584b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:2093");
...
"Update the RHEL patch package based on the guidance in RHSA-2018:2093.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'patch-2.7.1-10.el7_2', 'sp':'2', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
