...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : gzip (ELSA-2010-0061)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2010-0061.html");
...
"Update the affected gzip package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2010-0001");
...
var pkgs = [
    {'reference':'gzip-1.3.5-11.0.1.el5_4.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'gzip-1.3.5-11.0.1.el5_4.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
