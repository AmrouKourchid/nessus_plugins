...
the RHSA-2018:0158 advisory.
    ...
    * It was found that the DHCP daemon did not properly clean up closed OMAPI connections in certain cases. A
    remote attacker able to connect to the OMAPI port could use this flaw to exhaust file descriptors in the
    DHCP daemon, leading to a denial of service in the OMAPI functionality. (CVE-2017-3144)

Tenable has extracted the preceding description block directly from the Red Hat Enterprise Linux security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_0158.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?28bd3206");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:0158");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1522918");
  script_set_attribute(attribute:"see_also", value:"https://kb.isc.org/article/AA-01541");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL dhcp package based on the guidance in RHSA-2018:0158.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'dhclient-4.2.5-58.el7_4.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'12'},
      {'reference':'dhcp-4.2.5-58.el7_4.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'12'},
      {'reference':'dhcp-common-4.2.5-58.el7_4.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'12'},
      {'reference':'dhcp-devel-4.2.5-58.el7_4.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'12'},
      {'reference':'dhcp-libs-4.2.5-58.el7_4.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'12'}
    ]
  }
];
