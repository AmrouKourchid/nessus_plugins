...
"The version of python-virtualenv installed on the remote host is prior to 15.1.0-4. It is, therefore, affected by
multiple vulnerabilities as referenced in the ALAS2-2020-1413 advisory.
    ...
    A credentials-exposure flaw was found in python-requests, where if a request with authentication is
    redirected (302) from an HTTPS endpoint to an HTTP endpoint on the same host, the Authorization header is
    not stripped and the credentials can be read in plain text. A man-in-the-middle attacker could exploit
    this flaw to obtain a user's valid credentials. (CVE-2018-18074)
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2020-1413.html");
...
var pkgs = [
    {'reference':'python-virtualenv-15.1.0-4.amzn2', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
