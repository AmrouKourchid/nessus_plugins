...
# extracted from Ubuntu Security Notice USN-6736-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6736-2");

  script_name(english:"Ubuntu 24.04 LTS : klibc vulnerabilities (USN-6736-2)");
...
the USN-6736-2 advisory.

    USN-6736-1 fixed vulnerabilities in klibc. This update provides the corresponding updates for Ubuntu 24.04
    LTS.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6736-2");
...
var pkgs = [
    {'osver': '24.04', 'pkgname': 'klibc-utils', 'pkgver': '2.0.13-4ubuntu0.1'},
    {'osver': '24.04', 'pkgname': 'libklibc', 'pkgver': '2.0.13-4ubuntu0.1'},
    {'osver': '24.04', 'pkgname': 'libklibc-dev', 'pkgver': '2.0.13-4ubuntu0.1'}
];
