...
# extracted from Fedora Security Advisory FEDORA-2023-d6baa1d93e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-d6baa1d93e");

  script_name(english:"Fedora 38 : vim (2023-d6baa1d93e)");
...
FEDORA-2023-d6baa1d93e advisory.

    The newest upstream commit

    Security fix for CVE-2023-2426

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-d6baa1d93e");
...
var pkgs = [
    {'reference':'vim-9.0.1562-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
