...
if (description)
{
  ...
  script_name(english:"CentOS 9 : pesign-115-6.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update for pesign.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 9 host has a package installed that is affected by a vulnerability as referenced in the
pesign-115-6.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=29950");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream pesign package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:pesign");
...
if ('aarch64' >!< cpu && cpu !~ "^i[3-6]86$" && 'x86_64' >!< cpu) audit(AUDIT_LOCAL_CHECKS_NOT_IMPLEMENTED, 'CentOS', cpu);

var pkgs = [
    {'reference':'pesign-115-6.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
