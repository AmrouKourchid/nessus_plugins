...
# extracted from Fedora Security Advisory FEDORA-2023-19046bf703
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-19046bf703");

  script_name(english:"Fedora 38 : libreswan (2023-19046bf703)");
...
FEDORA-2023-19046bf703 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-19046bf703");
...
var pkgs = [
    {'reference':'libreswan-4.11-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
