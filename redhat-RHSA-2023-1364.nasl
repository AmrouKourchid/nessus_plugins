...
# extracted from Red Hat Security Advisory RHSA-2023:1364. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:1364");
  script_xref(name:"IAVA", value:"2023-A-0132-S");

  script_name(english:"RHEL 9 : firefox (RHSA-2023:1364)");
...
referenced in the RHSA-2023:1364 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_1364.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?19c2df05");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:1364");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL firefox package based on the guidance in RHSA-2023:1364.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-102.9.0-3.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
