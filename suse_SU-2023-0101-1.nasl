...
# SUSE update advisory SUSE-SU-2023:0101-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:0101-1");

  script_name(english:"SUSE SLES12 Security Update : sudo (SUSE-SU-2023:0101-1)");
...
in the SUSE-SU-2023:0101-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-January/013477.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?654ed035");
...
var pkgs = [
    {'reference':'sudo-1.8.20p2-3.36.1', 'sp':'4', 'cpu':'x86_64', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.4']},
    {'reference':'sudo-1.8.20p2-3.36.1', 'sp':'4', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.4']}
];
