...
if (description)
{
  ...
  script_name(english:"CentOS 9 : python3.9-3.9.17-2.el9");
...
python3.9-3.9.17-2.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=36202");
...
var pkgs = [
    {'reference':'python-unversioned-command-3.9.17-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-3.9.17-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-debug-3.9.17-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-devel-3.9.17-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-idle-3.9.17-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-libs-3.9.17-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-test-3.9.17-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-tkinter-3.9.17-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
