...
# extracted from Fedora Security Advisory FEDORA-2018-28447b6f2e.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : ghostscript (2018-28447b6f2e)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"Security fix for CVE-2018-10194, CVE-2018-15909, and additional CVEs.

Note that Tenable Network Security has extracted the preceding
description block directly from the Fedora update system website.
Tenable has attempted to automatically clean and format it as much as
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-28447b6f2e");
...
flag = 0;
if (rpm_check(release:"FC27", reference:"ghostscript-9.22-5.fc27")) flag++;
