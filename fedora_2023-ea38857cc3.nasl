...
# extracted from Fedora Security Advisory FEDORA-2023-ea38857cc3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-ea38857cc3");

  script_name(english:"Fedora 39 : python2.7 (2023-ea38857cc3)");
...
FEDORA-2023-ea38857cc3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-ea38857cc3");
...
var pkgs = [
    {'reference':'python2.7-2.7.18-35.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
