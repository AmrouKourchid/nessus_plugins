...
# extracted from Fedora Security Advisory FEDORA-2025-0c6c204dae
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-0c6c204dae");

  script_name(english:"Fedora 40 : webkitgtk (2025-0c6c204dae)");
...
FEDORA-2025-0c6c204dae advisory.
     ...
     * The MediaRecorder backend gained WebM support (requires at least GStreamer 1.24.9) and audio bitrate
     ...
     * The GPU process build is now enabled for WebGL, but the web process is still used by default. The
    runtime flag UseGPUProcessForWebGL can be used to use the GPU process for WebGL.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-0c6c204dae");
...
var pkgs = [
    {'reference':'webkitgtk-2.48.0-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
