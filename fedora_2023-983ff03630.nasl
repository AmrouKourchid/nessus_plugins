...
# extracted from Fedora Security Advisory FEDORA-2023-983ff03630
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-983ff03630");

  script_name(english:"Fedora 37 : ckeditor (2023-983ff03630)");
...
FEDORA-2023-983ff03630 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-983ff03630");
...
var pkgs = [
    {'reference':'ckeditor-4.22.1-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
