...
if (description)
{
  ...
  script_cve_id("CVE-2021-47144");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2021-47144");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: drm/amd/amdgpu: fix refcount leak
    ...
    according to num_planes [How] put rfb->base.obj[0] in amdgpu_fbdev_destroy according to num_planes
    (CVE-2021-47144)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-47144");
