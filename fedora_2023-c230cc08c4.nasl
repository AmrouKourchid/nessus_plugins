...
# extracted from Fedora Security Advisory FEDORA-2023-c230cc08c4
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-c230cc08c4");

  script_name(english:"Fedora 36 : perl-HTTP-Daemon (2023-c230cc08c4)");
...
FEDORA-2023-c230cc08c4 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-c230cc08c4");
...
var pkgs = [
    {'reference':'perl-HTTP-Daemon-6.16-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
