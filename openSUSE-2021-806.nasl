...
# extracted from openSUSE Security Update openSUSE-2021-806.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : hivex (openSUSE-2021-806)");
...
"This update for hivex fixes the following issues :
  ...
  - CVE-2021-3504: hivex: missing bounds check within
    hivex_open() (bsc#1185013)

This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1185013");
  script_set_attribute(attribute:"solution", value:
"Update the affected hivex packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:ocaml-hivex-debuginfo");
...
if ( rpm_check(release:"SUSE15.2", reference:"hivex-1.3.14-lp152.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"hivex-debuginfo-1.3.14-lp152.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"hivex-debugsource-1.3.14-lp152.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"hivex-devel-1.3.14-lp152.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"hivex-lang-1.3.14-lp152.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libhivex0-1.3.14-lp152.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libhivex0-debuginfo-1.3.14-lp152.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"ocaml-hivex-1.3.14-lp152.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"ocaml-hivex-debuginfo-1.3.14-lp152.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"ocaml-hivex-devel-1.3.14-lp152.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"perl-Win-Hivex-1.3.14-lp152.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"perl-Win-Hivex-debuginfo-1.3.14-lp152.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"python-hivex-1.3.14-lp152.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"python-hivex-debuginfo-1.3.14-lp152.4.3.1") ) flag++;
