...
the RHSA-2018:2284 advisory.

  - yum-utils: reposync: improper path validation may lead to directory traversal (CVE-2018-10897)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_2284.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?51ee6e75");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:2284");
...
"Update the RHEL yum-utils package based on the guidance in RHSA-2018:2284.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'yum-NetworkManager-dispatcher-1.1.30-42.el6_10', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'yum-plugin-aliases-1.1.30-42.el6_10', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'yum-plugin-auto-update-debug-info-1.1.30-42.el6_10', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'yum-plugin-changelog-1.1.30-42.el6_10', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'yum-plugin-fastestmirror-1.1.30-42.el6_10', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'yum-plugin-filter-data-1.1.30-42.el6_10', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'yum-plugin-fs-snapshot-1.1.30-42.el6_10', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'yum-plugin-keys-1.1.30-42.el6_10', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'yum-plugin-list-data-1.1.30-42.el6_10', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'yum-plugin-local-1.1.30-42.el6_10', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'yum-plugin-merge-conf-1.1.30-42.el6_10', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'yum-plugin-ovl-1.1.30-42.el6_10', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'yum-plugin-post-transaction-actions-1.1.30-42.el6_10', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'yum-plugin-priorities-1.1.30-42.el6_10', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'yum-plugin-protectbase-1.1.30-42.el6_10', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'yum-plugin-ps-1.1.30-42.el6_10', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'yum-plugin-remove-with-leaves-1.1.30-42.el6_10', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'yum-plugin-rpm-warm-cache-1.1.30-42.el6_10', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'yum-plugin-security-1.1.30-42.el6_10', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'yum-plugin-show-leaves-1.1.30-42.el6_10', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'yum-plugin-tmprepo-1.1.30-42.el6_10', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'yum-plugin-tsflags-1.1.30-42.el6_10', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'yum-plugin-upgrade-helper-1.1.30-42.el6_10', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'yum-plugin-verify-1.1.30-42.el6_10', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'yum-plugin-versionlock-1.1.30-42.el6_10', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'yum-updateonboot-1.1.30-42.el6_10', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'yum-utils-1.1.30-42.el6_10', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
