...
# extracted from Red Hat Security Advisory RHSA-2023:0382. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:0382");

  script_name(english:"RHEL 8 : libXpm (RHSA-2023:0382)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for libXpm.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2023:0382 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_0382.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?25d7fdc0");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:0382");
...
"Update the RHEL libXpm package based on the guidance in RHSA-2023:0382.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libXpm-3.5.12-9.el8_4', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libXpm-devel-3.5.12-9.el8_4', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
