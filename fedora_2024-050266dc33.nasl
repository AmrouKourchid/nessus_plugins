...
# extracted from Fedora Security Advisory FEDORA-2024-050266dc33
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-050266dc33");

  script_name(english:"Fedora 40 : freerdp (2024-050266dc33)");
...
FEDORA-2024-050266dc33 advisory.

    Update to 3.5.1 (CVE-2024-32039, CVE-2024-32040, CVE-2024-32041, CVE-2024-32458, CVE-2024-32459,
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-050266dc33");
...
var pkgs = [
    {'reference':'freerdp-3.5.1-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
