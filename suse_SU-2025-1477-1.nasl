...
# SUSE update advisory SUSE-SU-2025:1477-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2025:1477-1");

  script_name(english:"SUSE SLES12 Security Update : libva (SUSE-SU-2025:1477-1)");
...
SU-2025:1477-1 advisory.
    ...
    * uncontrolled search path may allow an authenticated user to
    ...
    Update to version 2.5.0:
      ...
      * Adjust VAEncMiscParameterQuantization structure to be align with VAEncMiscParameterBuffer(possible to
    impact BC)
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2025-May/020798.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?373060ca");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2023-39929");
  script_set_attribute(attribute:"solution", value:
"Update the affected libva-devel, libva-drm2, libva-x11-2 and / or libva2 packages.");
...
var pkgs = [
    {'reference':'libva-devel-2.20.0-3.3.4', 'sp':'5', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-ltss-extended-security-release-12.5']},
    {'reference':'libva-drm2-2.20.0-3.3.4', 'sp':'5', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-ltss-extended-security-release-12.5']},
    {'reference':'libva-x11-2-2.20.0-3.3.4', 'sp':'5', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-ltss-extended-security-release-12.5']},
    {'reference':'libva2-2.20.0-3.3.4', 'sp':'5', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-ltss-extended-security-release-12.5']},
    {'reference':'libva-devel-2.20.0-3.3.4', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.5']},
    {'reference':'libva-drm2-2.20.0-3.3.4', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.5']},
    {'reference':'libva-x11-2-2.20.0-3.3.4', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.5']},
    {'reference':'libva2-2.20.0-3.3.4', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.5']}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libva-devel / libva-drm2 / libva-x11-2 / libva2');
}
