...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5023697");
  script_xref(name:"MSFT", value:"MS23-5023697");
  ...
  script_name(english:"KB5023697: Windows 10 Version 1607 and Windows Server 2016 Security Update (March 2023)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5023697");
