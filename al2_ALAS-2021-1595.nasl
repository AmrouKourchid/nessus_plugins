...
# extracted from Amazon Linux 2 Security Advisory ALAS-2021-1595.
##
...
if (description)
{
  ...
  script_bugtraq_id(107352);
  script_xref(name:"ALAS", value:"2021-1595");

  script_name(english:"Amazon Linux 2 : cloud-init (ALAS-2021-1595)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of cloud-init installed on the remote host is prior to 19.3-2. It is, therefore, affected by a vulnerability
as referenced in the ALAS2-2021-1595 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2021-1595.html");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2019-0816");
...
var pkgs = [
    {'reference':'cloud-init-19.3-2.amzn2', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
