...
# extracted from Red Hat Security Advisory RHSA-2024:0436. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:0436");

  script_name(english:"RHEL 9 : libcap (RHSA-2024:0436)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0436.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fceca24b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2209113");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0436");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libcap package based on the guidance in RHSA-2024:0436.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libcap-2.48-8.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libcap-devel-2.48-8.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
