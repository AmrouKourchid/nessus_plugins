...
# extracted from Oracle Linux Security Advisory ELSA-2023-2378.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : postgresql-jdbc (ELSA-2023-2378)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-2378.html");
...
var pkgs = [
    {'reference':'postgresql-jdbc-42.2.27-1.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
