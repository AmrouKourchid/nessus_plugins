...
# extracted from Ubuntu Security Notice USN-5711-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5711-1");

  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS / 22.04 LTS : NTFS-3G vulnerability (USN-5711-1)");
...
referenced in the USN-5711-1 advisory.

    Yuchen Zeng and Eduardo Vela discovered that NTFS-3G incorrectly validated certain NTFS metadata. A local
    attacker could possibly use this issue to gain privileges.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5711-1");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'libntfs-3g88', 'pkgver': '1:2017.3.23-2ubuntu0.18.04.5'},
    {'osver': '18.04', 'pkgname': 'ntfs-3g', 'pkgver': '1:2017.3.23-2ubuntu0.18.04.5'},
    {'osver': '18.04', 'pkgname': 'ntfs-3g-dev', 'pkgver': '1:2017.3.23-2ubuntu0.18.04.5'},
    {'osver': '20.04', 'pkgname': 'libntfs-3g883', 'pkgver': '1:2017.3.23AR.3-3ubuntu1.3'},
    {'osver': '20.04', 'pkgname': 'ntfs-3g', 'pkgver': '1:2017.3.23AR.3-3ubuntu1.3'},
    {'osver': '20.04', 'pkgname': 'ntfs-3g-dev', 'pkgver': '1:2017.3.23AR.3-3ubuntu1.3'},
    {'osver': '22.04', 'pkgname': 'libntfs-3g89', 'pkgver': '1:2021.8.22-3ubuntu1.2'},
    {'osver': '22.04', 'pkgname': 'ntfs-3g', 'pkgver': '1:2021.8.22-3ubuntu1.2'},
    {'osver': '22.04', 'pkgname': 'ntfs-3g-dev', 'pkgver': '1:2021.8.22-3ubuntu1.2'}
];
