...
# extracted from Red Hat Security Advisory RHSA-2022:1074. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:1074");

  script_name(english:"RHEL 7 : screen (RHSA-2022:1074)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_1074.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5333a1dc");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:1074");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1927062");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL screen package based on the guidance in RHSA-2022:1074.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'screen-4.1.0-0.25.20120314git3c2946.el7_7.1', 'sp':'7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'screen-4.1.0-0.25.20120314git3c2946.el7_7.1', 'sp':'7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
