...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : rsync (EulerOS-SA-2019-1806)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1806
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1d7dc3fa");
...
pkgs = ["rsync-3.1.2-4.h3.eulerosv2r7"];
