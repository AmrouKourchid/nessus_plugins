...
if (description)
{
  ...
  script_cve_id("CVE-2024-50300");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-50300");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: regulator: rtq2208: Fix uninitialized
    use of regulator_config Fix rtq2208 driver uninitialized use to cause kernel error. (CVE-2024-50300)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-50300");
