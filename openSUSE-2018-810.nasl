...
# extracted from openSUSE Security Update openSUSE-2018-810.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : java-10-openjdk (openSUSE-2018-810)");
...
This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1096420");
...
"Update the affected java-10-openjdk packages.");
