...
# extracted from Fedora Security Advisory FEDORA-2023-748e811334
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-748e811334");

  script_name(english:"Fedora 38 : perl-HTTP-Daemon (2023-748e811334)");
...
FEDORA-2023-748e811334 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-748e811334");
...
var pkgs = [
    {'reference':'perl-HTTP-Daemon-6.16-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
