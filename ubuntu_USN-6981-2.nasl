...
# extracted from Ubuntu Security Notice USN-6981-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6981-2");

  script_name(english:"Ubuntu 14.04 LTS : Drupal vulnerabilities (USN-6981-2)");
...
the USN-6981-2 advisory.

    USN-6981-1 fixed vulnerabilities in Drupal. This update provides the corresponding updates for Ubuntu
    14.04 LTS.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6981-2");
...
"Update the affected drupal7 package.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2020-13671");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'drupal7', 'pkgver': '7.26-1ubuntu0.1+esm2', 'ubuntu_pro': TRUE}
];
