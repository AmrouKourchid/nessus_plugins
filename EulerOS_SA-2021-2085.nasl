...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.2.0 : xorg-x11-server (EulerOS-SA-2021-2085)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2085
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0ce1fc4c");
...
pkgs = ["xorg-x11-server-Xorg-1.19.5-5.h13",
        "xorg-x11-server-common-1.19.5-5.h13"];
