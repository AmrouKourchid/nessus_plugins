...
# extracted from Oracle Linux Security Advisory ELSA-2024-1436.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : postgresql-jdbc (ELSA-2024-1436)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-1436.html");
...
var pkgs = [
    {'reference':'postgresql-jdbc-42.2.28-1.el9_3', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
