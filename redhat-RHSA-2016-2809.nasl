...
"The remote Red Hat host is missing a security update for ipsilon.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2016:2809 advisory.

    The ipsilon packages provide the Ipsilon identity provider service for federated single sign-on (SSO).
    Ipsilon links authentication providers and applications or utilities to allow for SSO. It includes a
    server and utilities to configure Apache-based service providers.

    Security Fix(es):

    * A vulnerability was found in ipsilon in the SAML2 provider's handling of sessions. An attacker able to
    hit the logout URL could determine what service providers other users are logged in to and terminate their
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2016/rhsa-2016_2809.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7e75ca5c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2016:2809");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1392829");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL ipsilon package based on the guidance in RHSA-2016:2809.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ipsilon-1.0.0-13.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipsilon-authform-1.0.0-13.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipsilon-authgssapi-1.0.0-13.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipsilon-authldap-1.0.0-13.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipsilon-base-1.0.0-13.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipsilon-client-1.0.0-13.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipsilon-filesystem-1.0.0-13.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipsilon-infosssd-1.0.0-13.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipsilon-persona-1.0.0-13.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipsilon-saml2-1.0.0-13.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipsilon-saml2-base-1.0.0-13.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipsilon-tools-ipa-1.0.0-13.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
