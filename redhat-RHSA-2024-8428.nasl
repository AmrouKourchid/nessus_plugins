...
# extracted from Red Hat Security Advisory RHSA-2024:8428. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:8428");

  script_name(english:"RHEL 8 / 9 : OpenShift Container Platform 4.15.37 (RHSA-2024:8428)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for OpenShift Container Platform 4.15.37.");
...
referenced in the RHSA-2024:8428 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.15.37. See the
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5aaaf618");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:8428");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.15.37 packages based on the guidance in RHSA-2024:8428.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'containernetworking-plugins-1.4.0-4.rhaos4.15.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-34156']},
      {'reference':'cri-o-1.28.11-5.rhaos4.15.git35a2431.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-9341', 'CVE-2024-9676']},
      {'reference':'podman-4.4.1-31.rhaos4.15.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-34155', 'CVE-2024-34156', 'CVE-2024-34158']},
      {'reference':'podman-catatonit-4.4.1-31.rhaos4.15.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-34155', 'CVE-2024-34156', 'CVE-2024-34158']},
      {'reference':'podman-docker-4.4.1-31.rhaos4.15.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-34155', 'CVE-2024-34156', 'CVE-2024-34158']},
      {'reference':'podman-gvproxy-4.4.1-31.rhaos4.15.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-34155', 'CVE-2024-34156', 'CVE-2024-34158']},
      {'reference':'podman-plugins-4.4.1-31.rhaos4.15.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-34155', 'CVE-2024-34156', 'CVE-2024-34158']},
      {'reference':'podman-remote-4.4.1-31.rhaos4.15.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-34155', 'CVE-2024-34156', 'CVE-2024-34158']},
      {'reference':'podman-tests-4.4.1-31.rhaos4.15.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-34155', 'CVE-2024-34156', 'CVE-2024-34158']},
      {'reference':'skopeo-1.11.3-5.rhaos4.15.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-34156']},
      {'reference':'skopeo-tests-1.11.3-5.rhaos4.15.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-34156']}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'cri-o-1.28.11-5.rhaos4.15.git35a2431.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-9341', 'CVE-2024-9676']},
      {'reference':'podman-4.4.1-31.rhaos4.15.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-34155', 'CVE-2024-34156', 'CVE-2024-34158']},
      {'reference':'podman-docker-4.4.1-31.rhaos4.15.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-34155', 'CVE-2024-34156', 'CVE-2024-34158']},
      {'reference':'podman-gvproxy-4.4.1-31.rhaos4.15.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-34155', 'CVE-2024-34156', 'CVE-2024-34158']},
      {'reference':'podman-plugins-4.4.1-31.rhaos4.15.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-34155', 'CVE-2024-34156', 'CVE-2024-34158']},
      {'reference':'podman-remote-4.4.1-31.rhaos4.15.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-34155', 'CVE-2024-34156', 'CVE-2024-34158']},
      {'reference':'podman-tests-4.4.1-31.rhaos4.15.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-34155', 'CVE-2024-34156', 'CVE-2024-34158']},
      {'reference':'skopeo-1.11.3-6.rhaos4.15.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-34156']},
      {'reference':'skopeo-tests-1.11.3-6.rhaos4.15.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-34156']}
    ]
  }
];
