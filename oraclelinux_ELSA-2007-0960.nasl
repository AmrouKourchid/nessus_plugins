...
# Oracle Linux Security Advisory ELSA-2007-0960 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : Important: / hplip (ELSA-2007-0960)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2007-0960.html");
...
"Update the affected hpijs, hplip and / or libsane-hpaio packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2007-5208");
...
var pkgs = [
    {'reference':'hpijs-1.6.7-4.1.el5_0.3', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'hplip-1.6.7-4.1.el5_0.3', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libsane-hpaio-1.6.7-4.1.el5_0.3', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'hpijs-1.6.7-4.1.el5_0.3', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'hplip-1.6.7-4.1.el5_0.3', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libsane-hpaio-1.6.7-4.1.el5_0.3', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
