...
# extracted from Fedora Security Advisory FEDORA-2024-da1b7e1cc5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-da1b7e1cc5");

  script_name(english:"Fedora 41 : python3.6 (2024-da1b7e1cc5)");
...
FEDORA-2024-da1b7e1cc5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-da1b7e1cc5");
...
var pkgs = [
    {'reference':'python3.6-3.6.15-39.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
