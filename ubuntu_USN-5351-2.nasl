...
# extracted from Ubuntu Security Notice USN-5351-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5351-2");

  script_name(english:"Ubuntu 16.04 ESM : Paramiko vulnerability (USN-5351-2)");
...
USN-5351-2 advisory.
    ...
    USN-5351-1 fixed a vulnerability in Paramiko. This update provides the corresponding update for Ubuntu
    16.04 ESM.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5351-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'python-paramiko', 'pkgver': '1.16.0-1ubuntu0.2+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'python3-paramiko', 'pkgver': '1.16.0-1ubuntu0.2+esm2', 'ubuntu_pro': TRUE}
];
