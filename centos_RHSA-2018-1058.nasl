...
# CentOS Errata and Security Advisory 2018:1058 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : libvorbis (CESA-2018:1058)");
...
Initiative as the original reporter.");
  # https://lists.centos.org/pipermail/centos-announce/2018-May/022878.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c9fb506a");
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"libvorbis-1.3.3-8.el7.1")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"libvorbis-devel-1.3.3-8.el7.1")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"libvorbis-devel-docs-1.3.3-8.el7.1")) flag++;
