...
if (description)
{
  ...
  script_name(english:"Oracle MySQL NET Connector (Jan 2023 CPU)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host is affected by by a vulnerability");
  script_set_attribute(attribute:"description", value:
"The versions of MySQL NET Connector installed on the remote host are affected by a vulnerability as referenced in the
