...
# AlmaLinux Security Advisory ALSA-2020:1636.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2020:1636");

  script_name(english:"AlmaLinux 8 : libsndfile (ALSA-2020:1636)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2020-1636.html");
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libsndfile-devel');
}
