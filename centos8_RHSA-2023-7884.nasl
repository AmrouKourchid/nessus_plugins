...
# Red Hat Security Advisory RHSA-2023:7884. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : postgresql:15 (CESA-2023:7884)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
CESA-2023:7884 advisory.
...
var appstreams = {
    'postgresql:15': [
      {'reference':'pg_repack-1.4.8-1.module+el8.9.0+19797+c4ce5969', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pg_repack-1.4.8-1.module+el8.9.0+19797+c4ce5969', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pgaudit-1.7.0-1.module+el8.9.0+19797+c4ce5969', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pgaudit-1.7.0-1.module+el8.9.0+19797+c4ce5969', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgres-decoderbufs-1.9.7-1.Final.module+el8.9.0+19797+c4ce5969', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgres-decoderbufs-1.9.7-1.Final.module+el8.9.0+19797+c4ce5969', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
};
