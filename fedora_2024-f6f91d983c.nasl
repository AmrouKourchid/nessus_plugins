...
# extracted from Fedora Security Advisory FEDORA-2024-f6f91d983c
#
...
if (description)
{
  ...
  script_cve_id("CVE-2024-6104", "CVE-2024-28180");
  script_xref(name:"FEDORA", value:"2024-f6f91d983c");

  script_name(english:"Fedora 41 : golang-github-acme-lego (2024-f6f91d983c)");
...
FEDORA-2024-f6f91d983c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-f6f91d983c");
  script_set_attribute(attribute:"solution", value:
"Update the affected golang-github-acme-lego package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:golang-github-acme-lego");
...
var pkgs = [
    {'reference':'golang-github-acme-lego-4.17.4-4.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'golang-github-acme-lego');
}
