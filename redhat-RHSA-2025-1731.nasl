...
# extracted from Red Hat Security Advisory RHSA-2025:1731. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:1731");
  script_xref(name:"IAVB", value:"2025-B-0028");

  script_name(english:"RHEL 9 : postgresql:16 (RHSA-2025:1731)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_1731.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b5a9368a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:1731");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL postgresql:16 package based on the guidance in RHSA-2025:1731.");
  ...
  'postgresql:16': [
    {
      ...
      'pkgs': [
        ...
        {'reference':'postgresql-16.8-1.module+el9.4.0+22876+364471ad.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-contrib-16.8-1.module+el9.4.0+22876+364471ad.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-docs-16.8-1.module+el9.4.0+22876+364471ad.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plperl-16.8-1.module+el9.4.0+22876+364471ad.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plpython3-16.8-1.module+el9.4.0+22876+364471ad.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-pltcl-16.8-1.module+el9.4.0+22876+364471ad.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-private-devel-16.8-1.module+el9.4.0+22876+364471ad.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-private-libs-16.8-1.module+el9.4.0+22876+364471ad.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-16.8-1.module+el9.4.0+22876+364471ad.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-devel-16.8-1.module+el9.4.0+22876+364471ad.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-static-16.8-1.module+el9.4.0+22876+364471ad.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-16.8-1.module+el9.4.0+22876+364471ad.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-rpm-macros-16.8-1.module+el9.4.0+22876+364471ad.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-upgrade-16.8-1.module+el9.4.0+22876+364471ad.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-upgrade-devel-16.8-1.module+el9.4.0+22876+364471ad.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
