...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.6 : vim (EulerOS-SA-2021-1453)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1453
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2b30c592");
...
pkgs = ["vim-common-7.4.160-4.h11.eulerosv2r7",
