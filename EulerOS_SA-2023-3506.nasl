...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : nghttp2 (EulerOS-SA-2023-3506)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3506
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?580a9dd6");
...
var pkgs = [
  "libnghttp2-1.41.0-1.h2.eulerosv2r10"
];
