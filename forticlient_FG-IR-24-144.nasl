...
if (description)
{
  ...
  script_cve_id("CVE-2024-36513");
  script_xref(name:"IAVA", value:"2024-A-0742-S");

  script_name(english:"Fortinet FortiClient Privilege escalation via lua auto patch function (FG-IR-24-144)");
...
vulnerability as referenced in the FG-IR-24-144 advisory.

  - A privilege context switching error vulnerability [CWE-270] in FortiClient Windows version 7.2.4 and
    below, version 7.0.12 and below, 6.4 all versions may allow an authenticated user to escalate their
    privileges via lua auto patch scripts. (CVE-2024-36513)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.fortiguard.com/psirt/FG-IR-24-144");
  script_set_attribute(attribute:"solution", value:
"Upgrade to FortiClient version 6.4.999999 / 7.0.13 / 7.2.5 or later.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:S/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:L/UI:N/S:C/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-36513");
...
var constraints = [
  { 'min_version' : '6.4.0', 'max_version' : '6.4.10', 'fixed_version' : '6.4.999999', 'fixed_display' : 'See vendor advisory' },
