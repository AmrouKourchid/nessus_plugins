...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS : Linux kernel vulnerabilities (USN-5016-1)");
...
var kernel_mappings = {
  '20.04': {
    '5.8.0': {
      'generic': '5.8.0-63',
      'generic-64k': '5.8.0-63',
      'generic-lpae': '5.8.0-63',
      'lowlatency': '5.8.0-63',
      'oracle': '5.8.0-1037',
      'gcp': '5.8.0-1038',
      'azure': '5.8.0-1039',
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-5016-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2021-3506', 'CVE-2021-23134', 'CVE-2021-32399', 'CVE-2021-33034', 'CVE-2021-33909');
