...
# extracted from Debian Security Advisory dla-2737. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2737-1 : openjdk-8 - LTS security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2021/dla-2737");
...
pkgs = [
    {'release': '9.0', 'prefix': 'openjdk-8-dbg', 'reference': '8u302-b08-1~deb9u1'},
    {'release': '9.0', 'prefix': 'openjdk-8-demo', 'reference': '8u302-b08-1~deb9u1'},
    {'release': '9.0', 'prefix': 'openjdk-8-doc', 'reference': '8u302-b08-1~deb9u1'},
    {'release': '9.0', 'prefix': 'openjdk-8-jdk', 'reference': '8u302-b08-1~deb9u1'},
    {'release': '9.0', 'prefix': 'openjdk-8-jdk-headless', 'reference': '8u302-b08-1~deb9u1'},
    {'release': '9.0', 'prefix': 'openjdk-8-jre', 'reference': '8u302-b08-1~deb9u1'},
    {'release': '9.0', 'prefix': 'openjdk-8-jre-headless', 'reference': '8u302-b08-1~deb9u1'},
    {'release': '9.0', 'prefix': 'openjdk-8-jre-zero', 'reference': '8u302-b08-1~deb9u1'},
    {'release': '9.0', 'prefix': 'openjdk-8-source', 'reference': '8u302-b08-1~deb9u1'}
];
