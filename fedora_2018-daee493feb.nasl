...
# extracted from Fedora Security Advisory FEDORA-2018-daee493feb.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : php-PHPMailer (2018-daee493feb)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-daee493feb");
...
flag = 0;
if (rpm_check(release:"FC27", reference:"php-PHPMailer-5.2.27-1.fc27")) flag++;
