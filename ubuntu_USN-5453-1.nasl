...
# extracted from Ubuntu Security Notice USN-5453-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5453-1");

  script_name(english:"Ubuntu 16.04 ESM : FreeType vulnerability (USN-5453-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5453-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'freetype2-demos', 'pkgver': '2.6.1-0.1ubuntu2.5+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libfreetype6', 'pkgver': '2.6.1-0.1ubuntu2.5+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libfreetype6-dev', 'pkgver': '2.6.1-0.1ubuntu2.5+esm1', 'ubuntu_pro': TRUE}
];
