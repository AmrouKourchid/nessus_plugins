...
# extracted from Debian Security Advisory dla-3494. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3494 : ruby-doorkeeper - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has a package installed that is affected by a vulnerability as referenced in the dla-3494
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/ruby-doorkeeper");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'ruby-doorkeeper', 'reference': '4.4.2-1+deb10u1'}
];
