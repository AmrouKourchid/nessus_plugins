...
# extracted from openSUSE Security Update openSUSE-2021-91.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : vlc (openSUSE-2021-91)");
...
Update to 3.0.11.1 :
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1133290");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1172727");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1180755");
...
if ( rpm_check(release:"SUSE15.2", reference:"libvlc5-3.0.11.1-lp152.2.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libvlc5-debuginfo-3.0.11.1-lp152.2.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libvlccore9-3.0.11.1-lp152.2.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libvlccore9-debuginfo-3.0.11.1-lp152.2.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"vlc-3.0.11.1-lp152.2.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"vlc-codec-gstreamer-3.0.11.1-lp152.2.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"vlc-codec-gstreamer-debuginfo-3.0.11.1-lp152.2.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"vlc-debuginfo-3.0.11.1-lp152.2.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"vlc-debugsource-3.0.11.1-lp152.2.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"vlc-devel-3.0.11.1-lp152.2.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"vlc-jack-3.0.11.1-lp152.2.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"vlc-jack-debuginfo-3.0.11.1-lp152.2.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"vlc-lang-3.0.11.1-lp152.2.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"vlc-noX-3.0.11.1-lp152.2.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"vlc-noX-debuginfo-3.0.11.1-lp152.2.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"vlc-opencv-3.0.11.1-lp152.2.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"vlc-opencv-debuginfo-3.0.11.1-lp152.2.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"vlc-qt-3.0.11.1-lp152.2.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"vlc-qt-debuginfo-3.0.11.1-lp152.2.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"vlc-vdpau-3.0.11.1-lp152.2.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"vlc-vdpau-debuginfo-3.0.11.1-lp152.2.9.1") ) flag++;
