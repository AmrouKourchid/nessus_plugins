...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : exiv2 (EulerOS-SA-2021-1979)");
...
vulnerability :
  ...
  - Exiv2 is a command-line utility and C++ library for
    ...
    command-line argument such as `insert`. The bug is
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1979
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d2aa2c6d");
...
pkgs = ["exiv2-0.26-12.h13.eulerosv2r8",
        "exiv2-libs-0.26-12.h13.eulerosv2r8"];
