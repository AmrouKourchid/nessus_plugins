...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : Linux kernel vulnerabilities (USN-3018-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3018-1");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-3.13.0-91-generic");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-3.13.0-91-generic-lpae");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-3.13.0-91-lowlatency");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-3.13.0-91-powerpc-e500");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-3.13.0-91-powerpc-e500mc");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-3.13.0-91-powerpc-smp");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-3.13.0-91-powerpc64-emb");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-3.13.0-91-powerpc64-smp");
...
var kernel_mappings = {
  '14.04': {
    '3.13.0': {
      'generic': '3.13.0-91',
      'generic-lpae': '3.13.0-91',
      'lowlatency': '3.13.0-91',
      'powerpc-e500': '3.13.0-91',
      'powerpc-e500mc': '3.13.0-91',
      'powerpc-smp': '3.13.0-91',
      'powerpc64-emb': '3.13.0-91',
      'powerpc64-smp': '3.13.0-91'
    }
  }
};
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-3018-1');
}
