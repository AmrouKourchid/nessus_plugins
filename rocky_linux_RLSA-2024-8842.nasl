...
# Rocky Linux Security Advisory RLSA-2024:8842.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2024:8842");

  script_name(english:"RockyLinux 8 : python3.12-urllib3 (RLSA-2024:8842)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2024:8842");
...
"Update the affected python3.12-urllib3 package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:rocky:linux:python3.12-urllib3");
