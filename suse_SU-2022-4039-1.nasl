...
# SUSE update advisory SUSE-SU-2022:4039-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:4039-1");

  script_name(english:"SUSE SLES15 Security Update : kernel (Live Patch 2 for SLE 15 SP4) (SUSE-SU-2022:4039-1)");
...
referenced in the SUSE-SU-2022:4039-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-November/012951.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f9bf2363");
...
var kernel_live_checks = [
  {
    'kernels': {
      '5.14.21-150400.24.18-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_14_21-150400_24_18-default-5-150400.2.1', 'sp':'4', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.4']},
          {'reference':'kernel-livepatch-5_14_21-150400_24_18-default-5-150400.2.1', 'sp':'4', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.4', 'sle-module-live-patching-release-15.4', 'sles-release-15.4']}
        ]
      }
    }
  }
