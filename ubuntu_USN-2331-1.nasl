...
# extracted from Ubuntu Security Notice USN-2331-1. The text 
...
if (description)
{
  ...
  script_bugtraq_id(69351);
  script_xref(name:"USN", value:"2331-1");

  script_name(english:"Ubuntu 14.04 LTS : LibreOffice vulnerability (USN-2331-1)");
...
USN-2331-1 advisory.
    ...
    Rohan Durve and James Kettle discovered LibreOffice Calc sometimes allowed for command injection when
    opening spreadsheets. If a user were tricked into opening a crafted Calc spreadsheet, an attacker could
    exploit this to run programs as your login.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2331-1");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-3524");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'browser-plugin-libreoffice', 'pkgver': '1:4.2.6.3-0ubuntu1'},
    {'osver': '14.04', 'pkgname': 'fonts-opensymbol', 'pkgver': '2:102.6+LibO4.2.6.3-0ubuntu1'},
    {'osver': '14.04', 'pkgname': 'libreoffice', 'pkgver': '1:4.2.6.3-0ubuntu1'},
    {'osver': '14.04', 'pkgname': 'libreoffice-avmedia-backend-gstreamer', 'pkgver': '1:4.2.6.3-0ubuntu1'},
    {'osver': '14.04', 'pkgname': 'libreoffice-base', 'pkgver': '1:4.2.6.3-0ubuntu1'},
    {'osver': '14.04', 'pkgname': 'libreoffice-base-core', 'pkgver': '1:4.2.6.3-0ubuntu1'},
    {'osver': '14.04', 'pkgname': 'libreoffice-base-drivers', 'pkgver': '1:4.2.6.3-0ubuntu1'},
    {'osver': '14.04', 'pkgname': 'libreoffice-calc', 'pkgver': '1:4.2.6.3-0ubuntu1'},
    {'osver': '14.04', 'pkgname': 'libreoffice-common', 'pkgver': '1:4.2.6.3-0ubuntu1'},
    {'osver': '14.04', 'pkgname': 'libreoffice-core', 'pkgver': '1:4.2.6.3-0ubuntu1'},
    {'osver': '14.04', 'pkgname': 'libreoffice-dev', 'pkgver': '1:4.2.6.3-0ubuntu1'},
    {'osver': '14.04', 'pkgname': 'libreoffice-draw', 'pkgver': '1:4.2.6.3-0ubuntu1'},
    {'osver': '14.04', 'pkgname': 'libreoffice-emailmerge', 'pkgver': '1:4.2.6.3-0ubuntu1'},
    {'osver': '14.04', 'pkgname': 'libreoffice-gnome', 'pkgver': '1:4.2.6.3-0ubuntu1'},
    {'osver': '14.04', 'pkgname': 'libreoffice-gtk', 'pkgver': '1:4.2.6.3-0ubuntu1'},
    {'osver': '14.04', 'pkgname': 'libreoffice-gtk3', 'pkgver': '1:4.2.6.3-0ubuntu1'},
    {'osver': '14.04', 'pkgname': 'libreoffice-impress', 'pkgver': '1:4.2.6.3-0ubuntu1'},
    {'osver': '14.04', 'pkgname': 'libreoffice-java-common', 'pkgver': '1:4.2.6.3-0ubuntu1'},
    {'osver': '14.04', 'pkgname': 'libreoffice-kde', 'pkgver': '1:4.2.6.3-0ubuntu1'},
    {'osver': '14.04', 'pkgname': 'libreoffice-l10n-in', 'pkgver': '1:4.2.6.3-0ubuntu1'},
    {'osver': '14.04', 'pkgname': 'libreoffice-l10n-ku', 'pkgver': '1:4.2.6.3-0ubuntu1'},
    {'osver': '14.04', 'pkgname': 'libreoffice-l10n-za', 'pkgver': '1:4.2.6.3-0ubuntu1'},
    {'osver': '14.04', 'pkgname': 'libreoffice-librelogo', 'pkgver': '1:4.2.6.3-0ubuntu1'},
    {'osver': '14.04', 'pkgname': 'libreoffice-math', 'pkgver': '1:4.2.6.3-0ubuntu1'},
    {'osver': '14.04', 'pkgname': 'libreoffice-mysql-connector', 'pkgver': '1.0.2+LibO4.2.6.3-0ubuntu1'},
    {'osver': '14.04', 'pkgname': 'libreoffice-officebean', 'pkgver': '1:4.2.6.3-0ubuntu1'},
    {'osver': '14.04', 'pkgname': 'libreoffice-ogltrans', 'pkgver': '1:4.2.6.3-0ubuntu1'},
    {'osver': '14.04', 'pkgname': 'libreoffice-pdfimport', 'pkgver': '1:4.2.6.3-0ubuntu1'},
    {'osver': '14.04', 'pkgname': 'libreoffice-presentation-minimizer', 'pkgver': '1:4.2.6.3-0ubuntu1'},
    {'osver': '14.04', 'pkgname': 'libreoffice-presenter-console', 'pkgver': '1:4.2.6.3-0ubuntu1'},
    {'osver': '14.04', 'pkgname': 'libreoffice-report-builder', 'pkgver': '1:4.2.6.3-0ubuntu1'},
    {'osver': '14.04', 'pkgname': 'libreoffice-report-builder-bin', 'pkgver': '1:4.2.6.3-0ubuntu1'},
    {'osver': '14.04', 'pkgname': 'libreoffice-script-provider-bsh', 'pkgver': '1:4.2.6.3-0ubuntu1'},
    {'osver': '14.04', 'pkgname': 'libreoffice-script-provider-js', 'pkgver': '1:4.2.6.3-0ubuntu1'},
    {'osver': '14.04', 'pkgname': 'libreoffice-script-provider-python', 'pkgver': '1:4.2.6.3-0ubuntu1'},
    {'osver': '14.04', 'pkgname': 'libreoffice-sdbc-firebird', 'pkgver': '1:4.2.6.3-0ubuntu1'},
    {'osver': '14.04', 'pkgname': 'libreoffice-sdbc-hsqldb', 'pkgver': '1:4.2.6.3-0ubuntu1'},
    {'osver': '14.04', 'pkgname': 'libreoffice-sdbc-postgresql', 'pkgver': '1:4.2.6.3-0ubuntu1'},
    {'osver': '14.04', 'pkgname': 'libreoffice-style-crystal', 'pkgver': '1:4.2.6.3-0ubuntu1'},
    {'osver': '14.04', 'pkgname': 'libreoffice-style-galaxy', 'pkgver': '1:4.2.6.3-0ubuntu1'},
    {'osver': '14.04', 'pkgname': 'libreoffice-style-hicontrast', 'pkgver': '1:4.2.6.3-0ubuntu1'},
    {'osver': '14.04', 'pkgname': 'libreoffice-style-human', 'pkgver': '1:4.2.6.3-0ubuntu1'},
    {'osver': '14.04', 'pkgname': 'libreoffice-style-oxygen', 'pkgver': '1:4.2.6.3-0ubuntu1'},
    {'osver': '14.04', 'pkgname': 'libreoffice-style-sifr', 'pkgver': '1:4.2.6.3-0ubuntu1'},
    {'osver': '14.04', 'pkgname': 'libreoffice-style-tango', 'pkgver': '1:4.2.6.3-0ubuntu1'},
    {'osver': '14.04', 'pkgname': 'libreoffice-subsequentcheckbase', 'pkgver': '1:4.2.6.3-0ubuntu1'},
    {'osver': '14.04', 'pkgname': 'libreoffice-wiki-publisher', 'pkgver': '1.1.2+LibO4.2.6.3-0ubuntu1'},
    {'osver': '14.04', 'pkgname': 'libreoffice-writer', 'pkgver': '1:4.2.6.3-0ubuntu1'},
    {'osver': '14.04', 'pkgname': 'openoffice.org-dtd-officedocument1.0', 'pkgver': '2:1.0+LibO4.2.6.3-0ubuntu1'},
    {'osver': '14.04', 'pkgname': 'python3-uno', 'pkgver': '1:4.2.6.3-0ubuntu1'},
    {'osver': '14.04', 'pkgname': 'uno-libs3', 'pkgver': '4.2.6.3-0ubuntu1'},
    {'osver': '14.04', 'pkgname': 'ure', 'pkgver': '4.2.6.3-0ubuntu1'}
];
