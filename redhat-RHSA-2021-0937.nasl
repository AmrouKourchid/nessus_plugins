...
"The remote Red Hat host is missing a security update for rubygem-em-http-request.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_0937.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?77bff4b6");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:0937");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1911457");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rubygem-em-http-request package based on the guidance in RHSA-2021:0937.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rubygem-em-http-request-1.1.5-4.el7ost', 'cpu':'ppc64le', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
