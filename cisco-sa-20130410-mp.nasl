...
only that it might be affected.");
  # https://tools.cisco.com/security/center/content/CiscoSecurityAdvisory/cisco-sa-20130410-mp
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bec0e8b8");
