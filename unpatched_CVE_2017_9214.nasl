...
if (description)
{
  ...
  script_cve_id("CVE-2017-9214");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2017-9214");
...
patch available.
  ...
  - In Open vSwitch (OvS) 2.7.0, while parsing an OFPT_QUEUE_GET_CONFIG_REPLY type OFP 1.0 message, there is a
    buffer over-read that is caused by an unsigned integer underflow in the function
    `ofputil_pull_queue_get_config_reply10` in `lib/ofp-util.c`. (CVE-2017-9214)
