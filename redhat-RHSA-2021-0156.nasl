...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_0156.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4fea24ea");
...
"Update the RHEL dnsmasq package based on the guidance in RHSA-2021:0156.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'dnsmasq-2.76-2.el7_4.3', 'sp':'4', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dnsmasq-2.76-2.el7_4.3', 'sp':'4', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dnsmasq-utils-2.76-2.el7_4.3', 'sp':'4', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
