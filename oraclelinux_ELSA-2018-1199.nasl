...
# extracted from Red Hat Security Advisory RHSA-2018:1199 and 
# Oracle Linux Security Advisory ELSA-2018-1199 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : patch (ELSA-2018-1199)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2018-1199.html");
...
var pkgs = [
    {'reference':'patch-2.6-8.el6_9', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'patch-2.6-8.el6_9', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
];
