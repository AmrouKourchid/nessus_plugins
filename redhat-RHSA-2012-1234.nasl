...
the RHSA-2012:1234 advisory.

  - qemu: VT100 emulation vulnerability (CVE-2012-3515)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2012/rhsa-2012_1234.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e465d7ad");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2012:1234");
...
"Update the RHEL qemu-kvm package based on the guidance in RHSA-2012:1234.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'qemu-guest-agent-0.12.1.2-2.295.el6_3.2', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'qemu-img-0.12.1.2-2.295.el6_3.2', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'qemu-kvm-0.12.1.2-2.295.el6_3.2', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'qemu-kvm-tools-0.12.1.2-2.295.el6_3.2', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
    ]
  }
];
