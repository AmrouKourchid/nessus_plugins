...
if (description)
{
  ...
  script_name(english:"Adobe InDesign < 18.5.2 / 19.0 < 19.3.0 Memory leak (APSB24-20)");

  script_set_attribute(attribute:"synopsis", value:
"The Adobe InDesign instance installed on the remote host is affected by a memory leak vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe InDesign installed on the remote Windows host is prior to 18.5.2, 19.3.0. It is, therefore,
affected by a vulnerability as referenced in the APSB24-20 advisory.
