...
# extracted from Fedora Security Advisory FEDORA-2024-210776b8c7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-210776b8c7");
  script_xref(name:"IAVA", value:"2024-A-0004-S");

  script_name(english:"Fedora 39 : chromium (2024-210776b8c7)");
...
FEDORA-2024-210776b8c7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-210776b8c7");
...
"Update the affected chromium package.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2023-6879");
...
var pkgs = [
    {'reference':'chromium-120.0.6099.199-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
