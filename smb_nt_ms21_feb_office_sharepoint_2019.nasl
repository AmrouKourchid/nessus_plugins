...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"4493194");
  script_xref(name:"MSFT", value:"MS21-4493194");
  script_xref(name:"IAVA", value:"2021-A-0070-S");

  script_name(english:"Security Updates for Microsoft SharePoint Server 2019 (February 2021)");
...
affected by multiple vulnerabilities:
  ...
  - A remote code execution vulnerability. An attacker can
    ...
    CVE-2021-24072)");
  # https://support.microsoft.com/en-us/topic/description-of-the-security-update-for-sharepoint-server-2019-february-9-2021-kb4493194-c3347c2c-5ace-7079-54c9-15dd4980ade7
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?20fb3c26");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released KB4493194 to address this issue.");
