...
# extracted from Red Hat Security Advisory RHSA-2024:11121. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:11121");
  script_xref(name:"IAVA", value:"2024-A-0832-S");

  script_name(english:"RHEL 9 : gstreamer1-plugins-good (RHSA-2024:11121)");
...
referenced in the RHSA-2024:11121 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_11121.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c1f46dff");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:11121");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL gstreamer1-plugins-good package based on the guidance in RHSA-2024:11121.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gstreamer1-plugins-good-1.22.1-3.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gstreamer1-plugins-good-gtk-1.22.1-3.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
