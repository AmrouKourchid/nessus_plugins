...
# extracted from Red Hat Security Advisory RHSA-2024:4998. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:4998");

  script_name(english:"RHEL 8 : wget (RHSA-2024:4998)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_4998.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0b3cb460");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2292836");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:4998");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL wget package based on the guidance in RHSA-2024:4998.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'wget-1.19.5-10.el8_6.2', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'wget-1.19.5-10.el8_6.2', 'sp':'6', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
