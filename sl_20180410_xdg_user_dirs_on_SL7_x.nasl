...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : xdg-user-dirs on SL7.x x86_64 (20180410)");
...
Additional Changes :");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c10508ba");
...
packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fermilab:scientific_linux:xdg-user-dirs");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fermilab:scientific_linux:xdg-user-dirs-debuginfo");
