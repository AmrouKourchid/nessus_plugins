...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : Important: / krb5 (ELSA-2007-0858)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2007-0858.html");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2007-3999");
...
var pkgs = [
    {'reference':'krb5-devel-1.5-28', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'krb5-libs-1.5-28', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'krb5-server-1.5-28', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'krb5-workstation-1.5-28', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'krb5-devel-1.5-28', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'krb5-libs-1.5-28', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'krb5-server-1.5-28', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'krb5-workstation-1.5-28', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
