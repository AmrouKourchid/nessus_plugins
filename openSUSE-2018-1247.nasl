...
# extracted from openSUSE Security Update openSUSE-2018-1247.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : udisks2 (openSUSE-2018-1247)");
...
This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1091274");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1109406");
