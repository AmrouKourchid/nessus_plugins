...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : junit (EulerOS-SA-2021-1903)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1903
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e4693580");
...
pkgs = ["junit-4.11-8.h3.eulerosv2r7"];
