...
# extracted from Red Hat Security Advisory RHSA-2024:6837. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:6837");

  script_name(english:"RHEL 8 : pcp (RHSA-2024:6837)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for pcp.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:6837 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_6837.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?00b0a872");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-17081");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-29708");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-58002");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:6837");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL pcp package based on the guidance in RHSA-2024:6837.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'pcp-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-conf-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-devel-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-doc-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-export-pcp2elasticsearch-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-export-pcp2graphite-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-export-pcp2influxdb-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-export-pcp2json-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-export-pcp2spark-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-export-pcp2xml-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-export-pcp2zabbix-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-export-zabbix-agent-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-gui-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-import-collectl2pcp-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-import-ganglia2pcp-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-import-iostat2pcp-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-import-mrtg2pcp-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-import-sar2pcp-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-libs-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-libs-devel-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-activemq-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-apache-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-bash-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-bcc-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-bind2-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-bonding-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-bpftrace-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-cifs-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-cisco-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-dbping-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-denki-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-dm-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-docker-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-ds389-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-ds389log-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-elasticsearch-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-gfs2-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-gluster-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-gpfs-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-gpsd-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-hacluster-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-haproxy-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-infiniband-5.3.7-22.el8_10', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-infiniband-5.3.7-22.el8_10', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-infiniband-5.3.7-22.el8_10', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-json-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-libvirt-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-lio-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-lmsensors-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-logger-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-lustre-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-lustrecomm-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-mailq-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-memcache-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-mic-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-mongodb-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-mounts-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-mssql-5.3.7-22.el8_10', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-mysql-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-named-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-netcheck-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-netfilter-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-news-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-nfsclient-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-nginx-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-nvidia-gpu-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-openmetrics-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-openvswitch-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-oracle-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-pdns-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-perfevent-5.3.7-22.el8_10', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-perfevent-5.3.7-22.el8_10', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-perfevent-5.3.7-22.el8_10', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-podman-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-postfix-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-postgresql-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-rabbitmq-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-redis-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-roomtemp-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-rsyslog-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-samba-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-sendmail-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-shping-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-slurm-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-smart-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-snmp-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-sockets-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-statsd-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-summary-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-systemd-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-trace-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-unbound-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-weblog-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-zimbra-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-pmda-zswap-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-selinux-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-system-tools-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-testsuite-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcp-zeroconf-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'perl-PCP-LogImport-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'perl-PCP-LogSummary-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'perl-PCP-MMV-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'perl-PCP-PMDA-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-pcp-5.3.7-22.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
