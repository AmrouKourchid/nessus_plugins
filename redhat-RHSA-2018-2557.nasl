...
the RHSA-2018:2557 advisory.

  - postgresql: Certain host connection parameters defeat client-side security defenses (CVE-2018-10915)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_2557.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9a0b58af");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:2557");
...
"Update the RHEL postgresql package based on the guidance in RHSA-2018:2557.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'postgresql-9.2.24-1.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-contrib-9.2.24-1.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-devel-9.2.24-1.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-docs-9.2.24-1.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-libs-9.2.24-1.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-plperl-9.2.24-1.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-plpython-9.2.24-1.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-pltcl-9.2.24-1.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-server-9.2.24-1.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-static-9.2.24-1.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-test-9.2.24-1.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-upgrade-9.2.24-1.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
