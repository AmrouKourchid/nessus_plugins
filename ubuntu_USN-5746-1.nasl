...
# extracted from Ubuntu Security Notice USN-5746-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5746-1");

  script_name(english:"Ubuntu 16.04 ESM : HarfBuzz vulnerability (USN-5746-1)");
...
USN-5746-1 advisory.
    ...
    Behzad Najjarpour Jabbari discovered that HarfBuzz incorrectly handled certain inputs. A remote attacker
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5746-1");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-9274");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'gir1.2-harfbuzz-0.0', 'pkgver': '1.0.1-1ubuntu0.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libharfbuzz-bin', 'pkgver': '1.0.1-1ubuntu0.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libharfbuzz-dev', 'pkgver': '1.0.1-1ubuntu0.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libharfbuzz-gobject0', 'pkgver': '1.0.1-1ubuntu0.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libharfbuzz-icu0', 'pkgver': '1.0.1-1ubuntu0.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libharfbuzz0b', 'pkgver': '1.0.1-1ubuntu0.1+esm1', 'ubuntu_pro': TRUE}
];
