...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 6.06 : python-jinja2 Multiple Vulnerabilities (NS-SA-2023-0137) (deprecated)");
...
"This plugin has been deprecated.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:python3-jinja2");
