...
# extracted from Fedora Security Advisory FEDORA-2024-e887a10dee
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-e887a10dee");

  script_name(english:"Fedora 40 : python3.13 (2024-e887a10dee)");
...
FEDORA-2024-e887a10dee advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-e887a10dee");
...
var pkgs = [
    {'reference':'python3.13-3.13.0~rc2-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
