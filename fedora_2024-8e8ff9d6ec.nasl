...
# extracted from Fedora Security Advisory FEDORA-2024-8e8ff9d6ec
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-8e8ff9d6ec");

  script_name(english:"Fedora 40 : mingw-python-werkzeug (2024-8e8ff9d6ec)");
...
FEDORA-2024-8e8ff9d6ec advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-8e8ff9d6ec");
...
var pkgs = [
    {'reference':'mingw-python-werkzeug-3.0.3-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
