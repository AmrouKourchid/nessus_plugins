...
if (description)
{
  ...
  script_cve_id("CVE-2022-49514");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-49514");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: ASoC: mediatek: Fix error handling in
    mt8173_max98090_dev_probe Call of_node_put(platform_node) to avoid refcount leak in the error path.
    (CVE-2022-49514)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-49514");
