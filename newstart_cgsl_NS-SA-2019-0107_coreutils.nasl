...
# extracted from ZTE advisory NS-SA-2019-0107. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 4.05 : coreutils Vulnerability (NS-SA-2019-0107)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 4.05, has coreutils packages installed that are affected by a
vulnerability:
...
number.");
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/notice/NS-SA-2019-0107");
  script_set_attribute(attribute:"solution", value:
"Upgrade the vulnerable CGSL coreutils packages. Note that updated packages may not be available yet. Please contact ZTE
