...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 20.04 LTS : Open vSwitch vulnerabilities (USN-4691-1)");
...
vulnerabilities as referenced in the USN-4691-1 advisory.
    ...
    Jonas Rudloff discovered that Open vSwitch incorrectly handled certain malformed LLDP packets. A remote
