...
# extracted from Fedora Security Advisory FEDORA-2025-fba1b24e4b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-fba1b24e4b");

  script_name(english:"Fedora 41 : python-spotipy (2025-fba1b24e4b)");
...
FEDORA-2025-fba1b24e4b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-fba1b24e4b");
  script_set_attribute(attribute:"solution", value:
"Update the affected python-spotipy package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:python-spotipy");
...
var pkgs = [
    {'reference':'python-spotipy-2.25.1-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python-spotipy');
}
