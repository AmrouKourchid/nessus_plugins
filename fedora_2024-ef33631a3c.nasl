...
# extracted from Fedora Security Advisory FEDORA-2024-ef33631a3c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-ef33631a3c");

  script_name(english:"Fedora 41 : cjson (2024-ef33631a3c)");
...
FEDORA-2024-ef33631a3c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-ef33631a3c");
...
var pkgs = [
    {'reference':'cjson-1.7.17-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
