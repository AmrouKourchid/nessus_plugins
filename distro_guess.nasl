...
var i, j, sig, name, port, ports, banner, match, num_matches, report;
...
# Rocky Linux                                                  #
#-----------------------------------------------------------#
sig[i++]  = "Apache/2.4.37 (rocky)";
name[j++] = "Rocky Linux release 8.5 (Green Obsidian)";

#-----------------------------------------------------------#
# AlmaLinux                                                  #
#-----------------------------------------------------------#
sig[i++]  = "Apache/2.4.37 (AlmaLinux)";
name[j++] = "AlmaLinux release 8.4 (Electric Cheetah)";
...
foreach port ( ports )
{
 ...
 for ( i = 0 ; sig[i] ; i ++ )
 {
  ...
  if ( num_matches > 0  )
  {
    ...
    replace_kb_item(name:"Host/Linux/Distribution/Port", value:port);
