...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2012-0509.html");
...
"Update the affected wireshark, wireshark-devel and / or wireshark-gnome packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2012-1595");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2011-2597");
...
var pkgs = [
    {'reference':'wireshark-1.2.15-2.0.1.el6_2.1', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'wireshark-devel-1.2.15-2.0.1.el6_2.1', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'wireshark-gnome-1.2.15-2.0.1.el6_2.1', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'wireshark-1.2.15-2.0.1.el6_2.1', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'wireshark-devel-1.2.15-2.0.1.el6_2.1', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'wireshark-gnome-1.2.15-2.0.1.el6_2.1', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
];
