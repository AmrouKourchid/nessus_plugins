...
# extracted from Fedora Security Advisory FEDORA-2022-5cf67355ec
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-5cf67355ec");

  script_name(english:"Fedora 38 : bind / bind-dyndb-ldap (2022-5cf67355ec)");
...
FEDORA-2022-5cf67355ec advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-5cf67355ec");
...
var pkgs = [
    {'reference':'bind-9.18.7-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
    {'reference':'bind-dyndb-ldap-11.10-6.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
