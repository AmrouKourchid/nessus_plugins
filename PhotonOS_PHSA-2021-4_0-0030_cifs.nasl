...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Cifs PHSA-2021-4.0-0030");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'cifs-utils-6.13-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'cifs-utils-devel-6.13-1.ph4')) flag++;
