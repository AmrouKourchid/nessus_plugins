...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : kernel (EulerOS-SA-2020-1938)");
...
vulnerabilities :
  ...
  - A buffer over-read flaw was found in
    ...
    to cause a denial of service(CVE-2020-10769)
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1938
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ffe85afa");
...
pkgs = ["kernel-3.10.0-862.14.1.5.h460.eulerosv2r7",
        "kernel-devel-3.10.0-862.14.1.5.h460.eulerosv2r7",
        "kernel-headers-3.10.0-862.14.1.5.h460.eulerosv2r7",
        "kernel-tools-3.10.0-862.14.1.5.h460.eulerosv2r7",
        "kernel-tools-libs-3.10.0-862.14.1.5.h460.eulerosv2r7",
        "perf-3.10.0-862.14.1.5.h460.eulerosv2r7",
        "python-perf-3.10.0-862.14.1.5.h460.eulerosv2r7"];
