...
# extracted from Fedora Security Advisory FEDORA-2024-a3b517705e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-a3b517705e");

  script_name(english:"Fedora 40 : micropython (2024-a3b517705e)");
...
FEDORA-2024-a3b517705e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-a3b517705e");
...
var pkgs = [
    {'reference':'micropython-1.22.2-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
