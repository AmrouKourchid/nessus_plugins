...
if (description)
{
  ...
  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2013-4245");
...
patch available.
  ...
  - Orca has arbitrary code execution due to insecure Python module load (CVE-2013-4245)
