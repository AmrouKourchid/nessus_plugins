...
# extracted from Fedora Security Advisory FEDORA-2024-2cb3145f8d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-2cb3145f8d");

  script_name(english:"Fedora 41 : tomcat (2024-2cb3145f8d)");
...
FEDORA-2024-2cb3145f8d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-2cb3145f8d");
...
var pkgs = [
    {'reference':'tomcat-9.0.98-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
