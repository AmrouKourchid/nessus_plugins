...
# extracted from Fedora Security Advisory FEDORA-2024-f35f9525d6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-f35f9525d6");

  script_name(english:"Fedora 38 : kernel (2024-f35f9525d6)");
...
FEDORA-2024-f35f9525d6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-f35f9525d6");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for FEDORA-2024-f35f9525d6');
  }
  else
  {
...
var pkgs = [
    {'reference':'kernel-6.8.8-100.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
