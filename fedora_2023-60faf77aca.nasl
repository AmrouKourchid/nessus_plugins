...
# extracted from Fedora Security Advisory FEDORA-2023-60faf77aca
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-60faf77aca");

  script_name(english:"Fedora 37 : libreswan (2023-60faf77aca)");
...
FEDORA-2023-60faf77aca advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-60faf77aca");
...
var pkgs = [
    {'reference':'libreswan-4.11-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
