...
if (description)
{
  ...
  script_name(english:"RHEL 7 : java-1.6.0-sun (RHSA-2017:3047)");
...
referenced in the RHSA-2017:3047 advisory.
    ...
    * This update fixes multiple vulnerabilities in the Oracle Java Runtime Environment and the Oracle Java
    ...
    CVE-2016-9842, CVE-2016-9843, CVE-2017-10274, CVE-2017-10281, CVE-2017-10285, CVE-2017-10293,
    CVE-2017-10295, CVE-2017-10345, CVE-2017-10346, CVE-2017-10347, CVE-2017-10348, CVE-2017-10349,
    ...
    included with Oracle Java SE 6. Refer to the Releases Notes and the Oracle Java SE Support Roadmap pages
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7a8e0ab8");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2017/rhsa-2017_3047.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?89356c4f");
  script_set_attribute(attribute:"see_also", value:"http://www.oracle.com/technetwork/java/javase/eol-135779.html");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2017:3047");
...
"Update the RHEL java-1.6.0-sun package based on the guidance in RHSA-2017:3047.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'java-1.6.0-sun-1.6.0.171-1jpp.4.el7', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.6.0-sun-1.6.0.171-1jpp.4.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.6.0-sun-demo-1.6.0.171-1jpp.4.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.6.0-sun-devel-1.6.0.171-1jpp.4.el7', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.6.0-sun-devel-1.6.0.171-1jpp.4.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.6.0-sun-jdbc-1.6.0.171-1jpp.4.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.6.0-sun-plugin-1.6.0.171-1jpp.4.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.6.0-sun-src-1.6.0.171-1jpp.4.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
