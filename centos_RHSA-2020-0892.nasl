...
if (description)
{
  ...
  script_name(english:"CentOS 6 : zsh (RHSA-2020:0892)");
...
var pkgs = [
    {'reference':'zsh-4.3.11-11.el6_10', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'zsh-html-4.3.11-11.el6_10', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE}
];
