...
# extracted from Fedora Security Advisory FEDORA-2022-c68d90efc3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-c68d90efc3");

  script_name(english:"Fedora 35 : expat (2022-c68d90efc3)");
...
FEDORA-2022-c68d90efc3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-c68d90efc3");
...
var pkgs = [
    {'reference':'expat-2.4.9-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
