...
if (description)
{
  ...
  script_cve_id("CVE-2023-43582");

  script_name(english:"Zoom Client for Meetings < 5.16.0 Vulnerability (ZSB-23055)");
...
vulnerability as referenced in the ZSB-23055 advisory.

  - Improper authorization in some Zoom clients may allow an authorized user to conduct an escalation of
    privilege via network access. Users can help keep themselves secure by applying current updates or
...
number.");
  # https://explore.zoom.us/en/trust/security/security-bulletin/?filter-cve=&filter=&keywords=ZSB-23055
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0b59ee99");
...
"Upgrade to Zoom Client for Meetings 5.16.0 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-43582");
