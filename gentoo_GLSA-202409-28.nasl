...
# extracted from Gentoo Linux Security Advisory GLSA 202409-28.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202409-28 : HashiCorp Consul: Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202409-28 (HashiCorp Consul: Multiple
Vulnerabilities)

    Multiple vulnerabilities have been found in HashiCorp Consul. Please review the CVE identifiers referenced
    below for details.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202409-28");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=885997");
