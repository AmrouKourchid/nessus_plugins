...
# extracted from Ubuntu Security Notice USN-6132-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6132-1");

  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS : Linux kernel vulnerabilities (USN-6132-1)");
...
referenced in the USN-6132-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6132-1");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.4.0-1064-bluefield");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-6132-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2022-3707', 'CVE-2023-0459', 'CVE-2023-1075', 'CVE-2023-1078', 'CVE-2023-1118', 'CVE-2023-1380', 'CVE-2023-1513', 'CVE-2023-2162', 'CVE-2023-2612', 'CVE-2023-30456', 'CVE-2023-31436', 'CVE-2023-32233', 'CVE-2023-32269');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-6132-1');
  }
  else
  {
