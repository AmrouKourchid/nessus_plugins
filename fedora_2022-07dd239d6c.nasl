...
# extracted from Fedora Security Advisory FEDORA-2022-07dd239d6c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-07dd239d6c");

  script_name(english:"Fedora 35 : admesh (2022-07dd239d6c)");
...
FEDORA-2022-07dd239d6c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-07dd239d6c");
  script_set_attribute(attribute:"solution", value:
"Update the affected admesh package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:admesh");
...
var pkgs = [
    {'reference':'admesh-0.98.5-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'admesh');
}
