...
# extracted from VMware Security Advisory PHSA-2024-4.0-0710. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Docker PHSA-2024-4.0-0710");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the docker package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-710.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'docker-24.0.9-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'docker-cli-24.0.9-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'docker-doc-24.0.9-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'docker-engine-24.0.9-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'docker-rootless-24.0.9-1.ph4')) flag++;
