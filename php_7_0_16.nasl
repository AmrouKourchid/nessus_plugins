...
if (description)
{
  ...
  script_name(english:"PHP 7.0.x < 7.0.16 Multiple Vulnerabilities");
...
server is 7.0.x prior to 7.0.16. It is, therefore, affected by the
following vulnerabilities :
  ...
  script_set_attribute(attribute:"see_also", value:"http://php.net/ChangeLog-7.php#7.0.16");
  script_set_attribute(attribute:"solution", value:
"Upgrade to PHP version 7.0.16 or later.");
