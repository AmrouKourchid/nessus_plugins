...
# extracted from Gentoo Linux Security Advisory GLSA 201903-22.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201903-22");

  script_name(english:"GLSA-201903-22 : ZeroMQ: Code execution");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-201903-22
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/201903-22");
...
if (qpkg_check(package:"net-libs/zeromq", unaffected:make_list("ge 4.3.1"), vulnerable:make_list("lt 4.3.1"))) flag++;
