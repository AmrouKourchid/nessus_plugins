...
# extracted from Red Hat Security Advisory RHSA-2023:0859. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2022-4139", "CVE-2022-47629", "CVE-2023-22809");
  script_xref(name:"RHSA", value:"2023:0859");

  script_name(english:"RHEL 8 : Red Hat Virtualization Host 4.4.z SP 1 security update batch#4 (oVirt-4.5.3-4) (Important) (RHSA-2023:0859)");
...
referenced in the RHSA-2023:0859 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_0859.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?de3d1277");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:0859");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2169971");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat Virtualization Host 4.4.z SP 1 package based on the guidance in RHSA-2023:0859.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'redhat-virtualization-host-image-update-4.5.3-202302150956_8.6', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'}
    ]
  }
];
