...
# extracted from Fedora Security Advisory FEDORA-2024-cc3d21b83b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-cc3d21b83b");

  script_name(english:"Fedora 41 : dotnet8.0 (2024-cc3d21b83b)");
...
FEDORA-2024-cc3d21b83b advisory.

    This is the October 2024 security release of .NET 8. The SDK version is 8.0.110 and the Runtime version is
    8.0.10.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-cc3d21b83b");
...
var pkgs = [
    {'reference':'dotnet8.0-8.0.110-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
