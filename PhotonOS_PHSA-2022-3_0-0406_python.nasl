...
if (description)
{
  ...
  script_cve_id("CVE-2018-19787", "CVE-2021-28957");

  script_name(english:"Photon OS 3.0: Python PHSA-2022-3.0-0406");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'python-lxml-4.2.5-1.ph3')) flag++;
