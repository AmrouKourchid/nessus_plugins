...
# extracted from Amazon Linux 2 Security Advisory ALAS-2018-1048.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2018-1048");

  script_name(english:"Amazon Linux 2 : glibc (ALAS-2018-1048)");
...
sysdeps/i386/i686/multiarch/memcpy-sse2-unaligned.S in the GNU C
Library (aka glibc or libc6) 2.21 through 2.27 does not correctly
perform the overlapping memory check if the source memory range spans
the middle of the address space, resulting in corrupt data being
produced by the copy operation. This may disclose information to
context-dependent attackers, or result in a denial of service, or,
possibly, code execution.(CVE-2017-18269)");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2018-1048.html");
...
flag = 0;
if (rpm_check(release:"AL2", reference:"glibc-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-all-langpacks-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-benchtests-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-common-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-debuginfo-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-debuginfo-common-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-devel-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-headers-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-aa-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-af-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-ak-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-am-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-an-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-anp-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-ar-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-as-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-ast-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-ayc-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-az-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-be-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-bem-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-ber-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-bg-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-bhb-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-bho-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-bn-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-bo-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-br-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-brx-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-bs-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-byn-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-ca-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-ce-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-chr-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-cmn-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-crh-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-cs-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-csb-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-cv-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-cy-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-da-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-de-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-doi-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-dv-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-dz-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-el-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-en-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-eo-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-es-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-et-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-eu-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-fa-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-ff-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-fi-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-fil-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-fo-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-fr-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-fur-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-fy-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-ga-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-gd-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-gez-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-gl-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-gu-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-gv-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-ha-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-hak-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-he-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-hi-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-hne-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-hr-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-hsb-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-ht-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-hu-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-hy-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-ia-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-id-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-ig-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-ik-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-is-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-it-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-iu-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-ja-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-ka-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-kk-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-kl-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-km-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-kn-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-ko-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-kok-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-ks-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-ku-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-kw-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-ky-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-lb-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-lg-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-li-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-lij-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-ln-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-lo-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-lt-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-lv-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-lzh-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-mag-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-mai-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-mg-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-mhr-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-mi-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-mk-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-ml-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-mn-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-mni-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-mr-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-ms-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-mt-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-my-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-nan-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-nb-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-nds-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-ne-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-nhn-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-niu-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-nl-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-nn-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-nr-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-nso-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-oc-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-om-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-or-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-os-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-pa-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-pap-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-pl-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-ps-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-pt-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-quz-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-raj-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-ro-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-ru-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-rw-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-sa-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-sat-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-sc-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-sd-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-se-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-sgs-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-shs-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-si-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-sid-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-sk-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-sl-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-so-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-sq-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-sr-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-ss-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-st-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-sv-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-sw-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-szl-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-ta-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-tcy-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-te-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-tg-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-th-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-the-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-ti-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-tig-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-tk-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-tl-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-tn-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-tr-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-ts-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-tt-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-ug-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-uk-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-unm-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-ur-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-uz-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-ve-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-vi-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-wa-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-wae-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-wal-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-wo-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-xh-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-yi-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-yo-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-yue-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-zh-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-langpack-zu-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-locale-source-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-minimal-langpack-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-nss-devel-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-static-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"glibc-utils-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"libcrypt-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"libcrypt-nss-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"nscd-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"nss_db-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"nss_hesiod-2.26-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"nss_nis-2.26-28.amzn2.0.1")) flag++;
