...
# extracted from Fedora Security Advisory FEDORA-2023-ed327967b4
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-ed327967b4");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2024/01/23");

  script_name(english:"Fedora 38 : chromium (2023-ed327967b4)");
...
FEDORA-2023-ed327967b4 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-ed327967b4");
...
var pkgs = [
    {'reference':'chromium-120.0.6099.129-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
