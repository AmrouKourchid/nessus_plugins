...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : cups (EulerOS-SA-2020-2306)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2306
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a19d57c2");
...
pkgs = ["cups-2.2.8-5.h6.eulerosv2r8",
        "cups-client-2.2.8-5.h6.eulerosv2r8",
        "cups-devel-2.2.8-5.h6.eulerosv2r8",
        "cups-filesystem-2.2.8-5.h6.eulerosv2r8",
        "cups-libs-2.2.8-5.h6.eulerosv2r8",
        "cups-lpd-2.2.8-5.h6.eulerosv2r8"];
