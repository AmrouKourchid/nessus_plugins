...
# extracted from Fedora Security Advisory FEDORA-2024-d120dc28b8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-d120dc28b8");

  script_name(english:"Fedora 39 : plasma-workspace (2024-d120dc28b8)");
...
FEDORA-2024-d120dc28b8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-d120dc28b8");
  script_set_attribute(attribute:"solution", value:
"Update the affected plasma-workspace package.");
...
var pkgs = [
    {'reference':'plasma-workspace-5.27.11.1-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
