...
# extracted from Red Hat Security Advisory RHSA-2017:2702. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2017:2702");

  script_name(english:"RHEL 6 : flash-plugin (RHSA-2017:2702)");
...
referenced in the RHSA-2017:2702 advisory.
    ...
    * This update fixes multiple vulnerabilities in Adobe Flash Player. These vulnerabilities, detailed in the
    ...
    information when the victim loaded a page containing the malicious SWF content. (CVE-2017-11281,
    CVE-2017-11282)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2017/rhsa-2017_2702.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?08fa011d");
  script_set_attribute(attribute:"see_also", value:"https://helpx.adobe.com/security/products/flash-player/apsb17-28.html");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2017:2702");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#critical");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1491110");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL flash-plugin package based on the guidance in RHSA-2017:2702.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:H/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:H/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-11282");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'flash-plugin-27.0.0.130-1.el6_9', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
