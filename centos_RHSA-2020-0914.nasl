...
# extracted from Red Hat Security Advisory RHSA-2020:0914 and 
# CentOS Errata and Security Advisory 2020:0914 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : thunderbird (RHSA-2020:0914)");
...
var pkgs = [
    {'reference':'thunderbird-68.6.0-1.el7.centos', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
