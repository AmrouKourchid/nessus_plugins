...
# extracted from Red Hat Security Advisory RHSA-2025:4532. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:4532");

  script_name(english:"RHEL 8 : yelp (RHSA-2025:4532)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for yelp.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2025:4532 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_4532.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?79f9a2fc");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:4532");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL yelp package based on the guidance in RHSA-2025:4532.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'yelp-3.28.1-3.el8_8.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'yelp-devel-3.28.1-3.el8_8.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'yelp-libs-3.28.1-3.el8_8.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'yelp / yelp-devel / yelp-libs');
}
