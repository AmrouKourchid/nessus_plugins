...
if (description)
{
  ...
  script_cve_id("CVE-2010-3316", "CVE-2010-3435");

  script_name(english:"RHEL 3 : pam (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2010-3435");
