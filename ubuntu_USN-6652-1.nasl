...
# extracted from Ubuntu Security Notice USN-6652-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6652-1");

  script_name(english:"Ubuntu 23.10 : Linux kernel (Azure) vulnerabilities (USN-6652-1)");
...
USN-6652-1 advisory.
    ...
    It was discovered that the netfilter subsystem in the Linux kernel did not properly validate inner tunnel
    netlink attributes, leading to a null pointer dereference vulnerability. A local attacker could use this
    to cause a denial of service (system crash). (CVE-2023-5972)
    ...
    Jann Horn discovered that a race condition existed in the Linux kernel when handling io_uring over
    sockets, leading to a use-after-free vulnerability. A local attacker could use this to cause a denial of
    service (system crash) or possibly execute arbitrary code. (CVE-2023-6531)
    ...
    Jann Horn discovered that the io_uring subsystem in the Linux kernel did not properly handle the release
    of certain buffer rings. A local attacker could use this to cause a denial of service (system crash) or
    possibly execute arbitrary code. (CVE-2024-0582)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6652-1");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-6.5.0-1015-azure");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-6.5.0-1015-azure-fde");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-6652-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2023-5972', 'CVE-2023-6176', 'CVE-2023-6531', 'CVE-2023-6622', 'CVE-2023-6915', 'CVE-2023-34324', 'CVE-2023-35827', 'CVE-2023-46813', 'CVE-2023-46862', 'CVE-2023-51780', 'CVE-2023-51781', 'CVE-2024-0565', 'CVE-2024-0582', 'CVE-2024-0641', 'CVE-2024-0646');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-6652-1');
  }
  else
  {
