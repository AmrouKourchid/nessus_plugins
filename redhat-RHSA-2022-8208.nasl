...
# extracted from Red Hat Security Advisory RHSA-2022:8208. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:8208");

  script_name(english:"RHEL 9 : dovecot (RHSA-2022:8208)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8208.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6dea6c6b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8208");
...
"Update the RHEL dovecot package based on the guidance in RHSA-2022:8208.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'dovecot-2.3.16-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'dovecot-devel-2.3.16-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'dovecot-mysql-2.3.16-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'dovecot-pgsql-2.3.16-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'dovecot-pigeonhole-2.3.16-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
