...
if (description)
{
  ...
  script_name(english:"PHP 7.1.x < 7.1.26 Multiple vulnerabilities.");
...
server is 7.1.x prior to 7.1.26. It is, therefore, affected by
multiple vulnerabilities:
  ...
  - A heap-based buffer overflow condition exists in gdImageColorMatch
  due to improper calculation of the allocated buffer size. An
  unauthenticated, remote attacker can exploit this via calling the
  imagecolormatch function with crafted image data as parameters, to
  ...
  dns_get_record function due to improper parsing of DNS responses. An
  unauthenticated, remote attacker can exploit this, via a specially
  crafted DNS reply sent from a rogue DNS server to disclose
  potentially sensitive information. (CVE-2019-9022)
  ...
  areas. (CVE-2019-9024)");
  script_set_attribute(attribute:"see_also", value:"http://php.net/ChangeLog-7.php#7.1.26");
  script_set_attribute(attribute:"solution", value:
"Upgrade to PHP version 7.1.26 or later.");
