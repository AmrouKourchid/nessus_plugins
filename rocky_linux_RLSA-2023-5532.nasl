...
# Rocky Linux Security Advisory RLSA-2023:5532.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2023:5532");

  script_name(english:"Rocky Linux 9 : nodejs (RLSA-2023:5532)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2023:5532");
...
var pkgs = [
    ...
    {'reference':'nodejs-debuginfo-16.20.2-1.el9_2', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'nodejs-debugsource-16.20.2-1.el9_2', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    ...
    {'reference':'nodejs-libs-debuginfo-16.20.2-1.el9_2', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
