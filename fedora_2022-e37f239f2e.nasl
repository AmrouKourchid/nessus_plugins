...
# extracted from Fedora Security Advisory FEDORA-2022-e37f239f2e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-e37f239f2e");

  script_name(english:"Fedora 36 : emacs (2022-e37f239f2e)");
...
FEDORA-2022-e37f239f2e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-e37f239f2e");
...
var pkgs = [
    {'reference':'emacs-28.2-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
