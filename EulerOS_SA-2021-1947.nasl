...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : golang (EulerOS-SA-2021-1947)");
...
vulnerability :
  ...
  - In Go before 1.14.14 and 1.15.x before 1.15.7,
    crypto/elliptic/p224.go can generate incorrect outputs,
    related to an underflow of the lowest limb during the
    final complete reduction in the P-224
    field.(CVE-2021-3114)
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1947
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e3616463");
...
pkgs = ["golang-1.13.3-10.h6.eulerosv2r9",
        "golang-devel-1.13.3-10.h6.eulerosv2r9",
        "golang-help-1.13.3-10.h6.eulerosv2r9"];
