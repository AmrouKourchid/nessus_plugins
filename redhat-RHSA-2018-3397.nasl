...
# extracted from Red Hat Security Advisory RHSA-2018:3397. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:3397");

  script_name(english:"RHEL 6 : qemu-kvm (RHSA-2018:3397)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for qemu-kvm.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 6 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2018:3397 advisory.

  - hw: cpu: speculative store bypass (CVE-2018-3639)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_3397.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1af5bfca");
...
"Update the RHEL qemu-kvm package based on the guidance in RHSA-2018:3397.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'qemu-guest-agent-0.12.1.2-2.415.el6_5.19', 'sp':'5', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'qemu-img-0.12.1.2-2.415.el6_5.19', 'sp':'5', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'qemu-kvm-0.12.1.2-2.415.el6_5.19', 'sp':'5', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'qemu-kvm-tools-0.12.1.2-2.415.el6_5.19', 'sp':'5', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
    ]
  }
];
