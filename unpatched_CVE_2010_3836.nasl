...
if (description)
{
  ...
  script_cve_id("CVE-2010-3836");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2010-3836");
...
patch available.
  ...
  - MySQL 5.0 before 5.0.92, 5.1 before 5.1.51, and 5.5 before 5.5.6 allows remote authenticated users to
    ...
    pre-evaluation of LIKE predicates, and IN Optimizers. (CVE-2010-3836)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2010-3836");
