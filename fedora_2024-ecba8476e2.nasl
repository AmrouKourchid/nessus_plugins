...
# extracted from Fedora Security Advisory FEDORA-2024-ecba8476e2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-ecba8476e2");

  script_name(english:"Fedora 40 : git (2024-ecba8476e2)");
...
FEDORA-2024-ecba8476e2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-ecba8476e2");
...
var pkgs = [
    {'reference':'git-2.45.1-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
