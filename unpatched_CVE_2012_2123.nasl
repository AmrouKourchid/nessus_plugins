...
if (description)
{
  ...
  script_cve_id("CVE-2012-2123");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2012-2123");
...
patch available.
  ...
  - The cap_bprm_set_creds function in security/commoncap.c in the Linux kernel before 3.3.3 does not properly
    ...
    demonstrated by an attack that uses a parent process to disable ASLR. (CVE-2012-2123)
