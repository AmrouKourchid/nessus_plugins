...
# extracted from Red Hat Security Advisory RHSA-2019:2112. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:2112");

  script_name(english:"RHEL 7 : mod_auth_openidc (RHSA-2019:2112)");
...
referenced in the RHSA-2019:2112 advisory.

    mod_auth_openidc enables an Apache 2.x web server to operate as an OpenID Connect Relying Party and/or
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_2112.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c1085558");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/7/html/7.7_release_notes/index
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cc7115e8");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:2112");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1425350");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1428855");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL mod_auth_openidc package based on the guidance in RHSA-2019:2112.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'mod_auth_openidc-1.8.8-5.el7', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mod_auth_openidc-1.8.8-5.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mod_auth_openidc-1.8.8-5.el7', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mod_auth_openidc-1.8.8-5.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
