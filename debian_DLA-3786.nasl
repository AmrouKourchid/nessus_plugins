...
# extracted from Debian Security Advisory dla-3786. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3786 : python-pil - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3786
advisory.
...
var pkgs = [
    {'release': '10.0', 'prefix': 'python-pil', 'reference': '5.4.1-2+deb10u6'},
    {'release': '10.0', 'prefix': 'python-pil-dbg', 'reference': '5.4.1-2+deb10u6'},
    {'release': '10.0', 'prefix': 'python-pil-doc', 'reference': '5.4.1-2+deb10u6'},
    {'release': '10.0', 'prefix': 'python-pil.imagetk', 'reference': '5.4.1-2+deb10u6'},
    {'release': '10.0', 'prefix': 'python-pil.imagetk-dbg', 'reference': '5.4.1-2+deb10u6'},
    {'release': '10.0', 'prefix': 'python3-pil', 'reference': '5.4.1-2+deb10u6'},
    {'release': '10.0', 'prefix': 'python3-pil-dbg', 'reference': '5.4.1-2+deb10u6'},
    {'release': '10.0', 'prefix': 'python3-pil.imagetk', 'reference': '5.4.1-2+deb10u6'},
    {'release': '10.0', 'prefix': 'python3-pil.imagetk-dbg', 'reference': '5.4.1-2+deb10u6'}
];
