...
Security issues fixed (boo#1107235) :
  ...
  - CVE-2018-16088: User gesture requirement bypass The re2
    ...
    version 2018-09-01.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1106341");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1107235");
