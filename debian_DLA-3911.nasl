...
# extracted from Debian Security Advisory dla-3911. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3911 : gir1.2-gsf-1 - security update");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/libgsf");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-36474");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-42415");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bullseye/libgsf");
  script_set_attribute(attribute:"solution", value:
"Upgrade the gir1.2-gsf-1 packages.");
  ...
  script_set_attribute(attribute:"plugin_publication_date", value:"2024/10/06");

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:gir1.2-gsf-1");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'gir1.2-gsf-1', 'reference': '1.14.47-1+deb11u1'},
    {'release': '11.0', 'prefix': 'libgsf-1-114', 'reference': '1.14.47-1+deb11u1'},
    {'release': '11.0', 'prefix': 'libgsf-1-common', 'reference': '1.14.47-1+deb11u1'},
    {'release': '11.0', 'prefix': 'libgsf-1-dev', 'reference': '1.14.47-1+deb11u1'},
    {'release': '11.0', 'prefix': 'libgsf-bin', 'reference': '1.14.47-1+deb11u1'}
];
