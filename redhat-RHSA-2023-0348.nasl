...
# extracted from Red Hat Security Advisory RHSA-2023:0348. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:0348");

  script_name(english:"RHEL 9 : kpatch-patch (RHSA-2023:0348)");
...
referenced in the RHSA-2023:0348 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_0348.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?eb36c9c8");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:0348");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  var cve_list = make_list('CVE-2022-2959', 'CVE-2022-2964', 'CVE-2022-4139', 'CVE-2022-43945');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for RHSA-2023:0348');
  }
  else
  {
...
var kernel_live_checks = [
  {
    ...
    'kernels': {
      '5.14.0-162.6.1.el9_1.ppc64le': {
        'pkgs': [
          {'reference':'kpatch-patch-5_14_0-162_6_1-1-1.el9_1', 'cpu':'ppc64le', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        ]
      },
      '5.14.0-162.6.1.el9_1.x86_64': {
        'pkgs': [
          {'reference':'kpatch-patch-5_14_0-162_6_1-1-1.el9_1', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kpatch-patch-5_14_0-162_6_1');
}
