...
# extracted from Fedora Security Advisory FEDORA-2022-a648a9484f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-a648a9484f");

  script_name(english:"Fedora 36 : firefox (2022-a648a9484f)");
...
FEDORA-2022-a648a9484f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-a648a9484f");
...
var pkgs = [
    {'reference':'firefox-106.0.1-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
