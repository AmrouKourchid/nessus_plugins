...
if (description)
{
  ...
  script_name(english:"Virtuozzo 6 : parallels-server-bm-release / vzkernel / etc (VZA-2017-090)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://help.virtuozzo.com/customer/portal/articles/2882057");
...
pkgs = ["parallels-server-bm-release-6.0.12-3686",
        "vzkernel-2.6.32-042stab125.3",
        "vzkernel-devel-2.6.32-042stab125.3",
        "vzkernel-firmware-2.6.32-042stab125.3",
        "vzmodules-2.6.32-042stab125.3",
        "vzmodules-devel-2.6.32-042stab125.3"];
