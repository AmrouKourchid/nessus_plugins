...
# extracted from Fedora Security Advisory FEDORA-2024-791faa660a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-791faa660a");

  script_name(english:"Fedora 41 : chromium (2024-791faa660a)");
...
FEDORA-2024-791faa660a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-791faa660a");
...
var pkgs = [
    {'reference':'chromium-131.0.6778.108-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
