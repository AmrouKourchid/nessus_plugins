...
# extracted from Fedora Security Advisory FEDORA-2023-fff31650c8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-fff31650c8");

  script_name(english:"Fedora 38 : xen (2023-fff31650c8)");
...
FEDORA-2023-fff31650c8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-fff31650c8");
...
var pkgs = [
    {'reference':'xen-4.17.2-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
