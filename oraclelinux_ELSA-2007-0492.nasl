...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : Moderate: / spamassassin (ELSA-2007-0492)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2007-0492.html");
...
"Update the affected spamassassin package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2007-2873");
...
var pkgs = [
    {'reference':'spamassassin-3.1.9-1.el5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'spamassassin-3.1.9-1.el5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
