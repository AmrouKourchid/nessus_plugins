...
# extracted from Fedora Security Advisory FEDORA-2019-a171d0d192.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-a171d0d192");

  script_name(english:"Fedora 29 : irssi (2019-a171d0d192)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"This is an update fixing CVE-2019-5882.

Note that Tenable Network Security has extracted the preceding
description block directly from the Fedora update system website.
Tenable has attempted to automatically clean and format it as much as
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-a171d0d192");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"irssi-1.1.2-1.fc29")) flag++;
