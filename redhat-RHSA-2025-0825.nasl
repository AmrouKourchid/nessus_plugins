...
# extracted from Red Hat Security Advisory RHSA-2025:0825. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:0825");

  script_name(english:"RHEL 8 : git-lfs (RHSA-2025:0825)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for git-lfs.");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_0825.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d57838a0");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:0825");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL git-lfs package based on the guidance in RHSA-2025:0825.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'git-lfs-2.13.3-3.el8_4.1', 'sp':'4', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-lfs-2.13.3-3.el8_4.1', 'sp':'4', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
