...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"4577071");
  script_xref(name:"MSKB", value:"4577066");
  script_xref(name:"MSFT", value:"MS20-4577071");
  ...
  script_name(english:"KB4577071: Windows 8.1 and Windows Server 2012 R2 September 2020 Security Update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 4577071
or cumulative update 4577066. It is, therefore, affected by
multiple vulnerabilities :
  ...
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/4577071/windows-8-1-update");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/4577066/windows-8-1-update");
  script_set_attribute(attribute:"solution", value:
"Apply Security Only update KB4577071 or Cumulative Update KB4577066.");
...
if (
  smb_check_rollup(os:'6.3', 
                   ...
                   rollup_date:'09_2020',
                   bulletin:bulletin,
                   rollup_kb_list:[4577066, 4577071])
)
{
