...
if (description)
{
  ...
  script_name(english:"Security Updates for Microsoft SQL Server OLE DB Driver (April 2023)");
...
var constraints = [
  { 'min_version' : '18.0', 'fixed_version' : '18.6.5' },
  { 'min_version' : '19.0', 'fixed_version' : '19.3.0' }
];
