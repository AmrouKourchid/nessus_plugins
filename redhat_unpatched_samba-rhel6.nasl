...
if (description)
{
  ...
  script_cve_id("CVE-2014-2830", "CVE-2017-15275", "CVE-2019-3880");

  script_name(english:"RHEL 6 : samba (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2017-15275");
