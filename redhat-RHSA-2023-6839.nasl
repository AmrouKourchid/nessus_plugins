...
# extracted from Red Hat Security Advisory RHSA-2023:6839. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:6839");
  script_xref(name:"CEA-ID", value:"CEA-2024-0004");

  script_name(english:"RHEL 9 : OpenShift Container Platform 4.14.2 (RHSA-2023:6839)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for OpenShift Container Platform 4.14.2.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2023:6839 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6839.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0b103f35");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/OCPBUGS-20498");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/OCPBUGS-22684");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/OCPBUGS-22810");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6839");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.14.2 package based on the guidance in RHSA-2023:6839.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'microshift-4.14.2-202311091609.p0.gd80d6de.assembly.4.14.2.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'microshift-4.14.2-202311091609.p0.gd80d6de.assembly.4.14.2.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'microshift-greenboot-4.14.2-202311091609.p0.gd80d6de.assembly.4.14.2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'microshift-networking-4.14.2-202311091609.p0.gd80d6de.assembly.4.14.2.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'microshift-networking-4.14.2-202311091609.p0.gd80d6de.assembly.4.14.2.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'microshift-release-info-4.14.2-202311091609.p0.gd80d6de.assembly.4.14.2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'microshift-selinux-4.14.2-202311091609.p0.gd80d6de.assembly.4.14.2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
