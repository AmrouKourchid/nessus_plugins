...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP12 : dnsmasq (EulerOS-SA-2024-1865)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1865
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8fec68b5");
...
var pkgs = [
  "dnsmasq-2.86-3.h7.eulerosv2r12"
];
