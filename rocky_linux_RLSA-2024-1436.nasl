...
# Rocky Linux Security Advisory RLSA-2024:1436.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2024:1436");

  script_name(english:"Rocky Linux 9 : postgresql-jdbc (RLSA-2024:1436)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2024:1436");
