...
if (description)
{
  ...
  script_cve_id("CVE-2016-0704", "CVE-2018-2566", "CVE-2018-2568");
  script_bugtraq_id(83764, 102603, 102606);
...
"Upgrade to Oracle Integrated Lights Out Manager (ILOM) 4.0.2.1 or later.");
