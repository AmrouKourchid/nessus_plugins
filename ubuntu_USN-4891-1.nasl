...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS : OpenSSL vulnerability (USN-4891-1)");
...
in the USN-4891-1 advisory.

    It was discovered that OpenSSL incorrectly handled certain renegotiation ClientHello messages. A remote
    attacker could use this issue to cause OpenSSL to crash, resulting in a denial of service.
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libcrypto1.1-udeb / libssl-dev / libssl1.1 / libssl1.1-udeb / etc');
}
