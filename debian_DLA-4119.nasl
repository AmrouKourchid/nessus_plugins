...
# extracted from Debian Security Advisory dla-4119. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-4119 : lemonldap-ng - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has packages installed that are affected by a vulnerability as referenced in the dla-4119
advisory.
...
var pkgs = [
    {'release': '11.0', 'prefix': 'lemonldap-ng', 'reference': '2.0.11+ds-4+deb11u7'},
    {'release': '11.0', 'prefix': 'lemonldap-ng-doc', 'reference': '2.0.11+ds-4+deb11u7'},
    {'release': '11.0', 'prefix': 'lemonldap-ng-fastcgi-server', 'reference': '2.0.11+ds-4+deb11u7'},
    {'release': '11.0', 'prefix': 'lemonldap-ng-handler', 'reference': '2.0.11+ds-4+deb11u7'},
    {'release': '11.0', 'prefix': 'lemonldap-ng-uwsgi-app', 'reference': '2.0.11+ds-4+deb11u7'},
    {'release': '11.0', 'prefix': 'liblemonldap-ng-common-perl', 'reference': '2.0.11+ds-4+deb11u7'},
    {'release': '11.0', 'prefix': 'liblemonldap-ng-handler-perl', 'reference': '2.0.11+ds-4+deb11u7'},
    {'release': '11.0', 'prefix': 'liblemonldap-ng-manager-perl', 'reference': '2.0.11+ds-4+deb11u7'},
    {'release': '11.0', 'prefix': 'liblemonldap-ng-portal-perl', 'reference': '2.0.11+ds-4+deb11u7'}
];
