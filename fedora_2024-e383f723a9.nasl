...
# extracted from Fedora Security Advisory FEDORA-2024-e383f723a9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-e383f723a9");

  script_name(english:"Fedora 40 : podman-tui (2024-e383f723a9)");
...
FEDORA-2024-e383f723a9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-e383f723a9");
...
var pkgs = [
    {'reference':'podman-tui-1.1.0-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
