...
# extracted from Fedora Security Advisory FEDORA-2024-ab879eeed1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-ab879eeed1");

  script_name(english:"Fedora 39 : libebml (2024-ab879eeed1)");
...
FEDORA-2024-ab879eeed1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-ab879eeed1");
...
var pkgs = [
    {'reference':'libebml-1.4.5-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
