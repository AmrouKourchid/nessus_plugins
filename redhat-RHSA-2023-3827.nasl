...
# extracted from Red Hat Security Advisory RHSA-2023:3827. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:3827");

  script_name(english:"RHEL 8 : libtiff (RHSA-2023:3827)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for libtiff.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2023:3827 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_3827.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?de14f719");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2163606");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:3827");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libtiff package based on the guidance in RHSA-2023:3827.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libtiff-4.0.9-28.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libtiff-devel-4.0.9-28.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libtiff-tools-4.0.9-28.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'libtiff-4.0.9-28.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libtiff-devel-4.0.9-28.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libtiff-tools-4.0.9-28.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
