...
in the SUSE-SU-2022:0720-1 advisory.
...
var pkgs = [
    {'reference':'containerd-1.4.12-63.1', 'sp':'3', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.3']},
    {'reference':'containerd-1.4.12-63.1', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.3', 'SUSE-Manager-Proxy-release-4.2', 'SUSE-Manager-Server-release-4.2', 'sle-module-containers-release-15.3', 'sles-release-15.3']}
];
