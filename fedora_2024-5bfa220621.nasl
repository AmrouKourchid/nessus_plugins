...
# extracted from Fedora Security Advisory FEDORA-2024-5bfa220621
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-5bfa220621");

  script_name(english:"Fedora 38 : unbound (2024-5bfa220621)");
...
FEDORA-2024-5bfa220621 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-5bfa220621");
...
var pkgs = [
    {'reference':'unbound-1.19.3-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
