...
# extracted from Red Hat Security Advisory RHSA-2023:5019. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : firefox (RHSA-2023:5019)");
...
referenced in the RHSA-2023:5019 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_5019.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e65d1427");
...
"Update the RHEL firefox package based on the guidance in RHSA-2023:5019.");
  ...
  script_cwe_id(119, 120, 179, 200, 290, 400, 416, 1127);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-102.15.0-1.el7_9', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-102.15.0-1.el7_9', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-102.15.0-1.el7_9', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-102.15.0-1.el7_9', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-102.15.0-1.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
