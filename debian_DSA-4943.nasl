...
# extracted from Debian Security Advisory dsa-4943. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-4943-1 : lemonldap-ng - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dsa-4943
advisory.

    Several vulnerabilities were discovered in lemonldap-ng, a Web-SSO system. The flaws could result in
    information disclosure, authentication bypass, or could allow an attacker to increase its authentication
    level or impersonate another user, especially when lemonldap-ng is configured to increase authentication
    level for users authenticated via a second factor. For the stable distribution (buster), these problems
    have been fixed in version 2.0.2+ds-7+deb10u6. We recommend that you upgrade your lemonldap-ng packages.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2021/dsa-4943");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2021-35472");
...
For the stable distribution (buster), these problems have been fixed in version 2.0.2+ds-7+deb10u6.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-35472");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'lemonldap-ng', 'reference': '2.0.2+ds-7+deb10u6'},
    {'release': '10.0', 'prefix': 'lemonldap-ng-doc', 'reference': '2.0.2+ds-7+deb10u6'},
    {'release': '10.0', 'prefix': 'lemonldap-ng-fastcgi-server', 'reference': '2.0.2+ds-7+deb10u6'},
    {'release': '10.0', 'prefix': 'lemonldap-ng-handler', 'reference': '2.0.2+ds-7+deb10u6'},
    {'release': '10.0', 'prefix': 'lemonldap-ng-uwsgi-app', 'reference': '2.0.2+ds-7+deb10u6'},
    {'release': '10.0', 'prefix': 'liblemonldap-ng-common-perl', 'reference': '2.0.2+ds-7+deb10u6'},
    {'release': '10.0', 'prefix': 'liblemonldap-ng-handler-perl', 'reference': '2.0.2+ds-7+deb10u6'},
    {'release': '10.0', 'prefix': 'liblemonldap-ng-manager-perl', 'reference': '2.0.2+ds-7+deb10u6'},
    {'release': '10.0', 'prefix': 'liblemonldap-ng-portal-perl', 'reference': '2.0.2+ds-7+deb10u6'}
];
