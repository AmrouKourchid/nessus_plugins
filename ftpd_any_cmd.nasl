...
if (supplied_logins_only && (isnull(login) || isnull(pass)))
  exit(1, "The scan policy is missing part of the FTP login information and Nessus is currently configured to not log in with user accounts not specified in the scan policy.");
