...
# extracted from Red Hat Security Advisory RHSA-2018:2246. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:2246");

  script_name(english:"RHEL 6 / 7 : rhev-hypervisor7 (RHSA-2018:2246)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for rhev-hypervisor7.");
...
in the RHSA-2018:2246 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2018/rhsa-2018_2246.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4fe11e3b");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1600050");
...
"Update the RHEL rhev-hypervisor7 package based on the guidance in RHSA-2018:2246.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rhev-hypervisor7-7.3-20180710.1.el7ev', 'release':'7', 'el_string':'el7ev', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'rhev-hypervisor7-7.3-20180710.1.el6ev', 'release':'6', 'el_string':'el6ev', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'}
    ]
  }
];
