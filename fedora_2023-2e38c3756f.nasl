...
# extracted from Fedora Security Advisory FEDORA-2023-2e38c3756f
#
...
if (description)
{
  ...
  script_cve_id("CVE-2022-37603", "CVE-2022-38900");
  script_xref(name:"FEDORA", value:"2023-2e38c3756f");

  script_name(english:"Fedora 38 : yarnpkg (2023-2e38c3756f)");
...
FEDORA-2023-2e38c3756f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-2e38c3756f");
...
var pkgs = [
    {'reference':'yarnpkg-1.22.19-5.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
