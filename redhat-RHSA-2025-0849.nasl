...
# extracted from Red Hat Security Advisory RHSA-2025:0849. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:0849");

  script_name(english:"RHEL 6 : rsync (RHSA-2025:0849)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_0849.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4376cf10");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:0849");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rsync package based on the guidance in RHSA-2025:0849.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rsync-3.0.6-12.el6_10.1', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsync-3.0.6-12.el6_10.1', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsync-3.0.6-12.el6_10.1', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
