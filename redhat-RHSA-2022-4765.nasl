...
# extracted from Red Hat Security Advisory RHSA-2022:4765. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:4765");

  script_name(english:"RHEL 9 : firefox (RHSA-2022:4765)");
...
referenced in the RHSA-2022:4765 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_4765.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?aba12b45");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#critical");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:4765");
...
"Update the RHEL firefox package based on the guidance in RHSA-2022:4765.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-91.9.1-1.el9_0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'firefox-91.9.1-1.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
