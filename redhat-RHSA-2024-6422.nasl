...
# extracted from Red Hat Security Advisory RHSA-2024:6422. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:6422");

  script_name(english:"RHEL 8 : bubblewrap and flatpak (RHSA-2024:6422)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for bubblewrap / flatpak.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:6422 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_6422.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?911a1c2e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:6422");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL bubblewrap / flatpak packages based on the guidance in RHSA-2024:6422.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'flatpak-1.12.9-3.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'flatpak-devel-1.12.9-3.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'flatpak-libs-1.12.9-3.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'flatpak-selinux-1.12.9-3.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'flatpak-session-helper-1.12.9-3.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'bubblewrap-0.4.0-2.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
