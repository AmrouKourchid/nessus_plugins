...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.0 : libxml2 (EulerOS-SA-2022-2093)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2093
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4c16f7cb");
...
"Update the affected libxml2 packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:libxml2-help");
...
var pkgs = [
  "libxml2-2.9.10-11.h17.eulerosv2r10",
  "libxml2-devel-2.9.10-11.h17.eulerosv2r10",
  "libxml2-help-2.9.10-11.h17.eulerosv2r10",
  "python3-libxml2-2.9.10-11.h17.eulerosv2r10"
];
