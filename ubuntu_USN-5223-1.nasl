...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS : Apache Log4j 1.2 vulnerability (USN-5223-1)");
...
in the USN-5223-1 advisory.

    It was discovered that Apache Log4j 1.2 was vulnerable to deserialization of untrusted data if the
    configuration file was editable. An attacker could use this vulnerability to cause a DoS or possibly
