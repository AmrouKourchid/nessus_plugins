...
# extracted from Oracle Linux Security Advisory ELSA-2023-6365.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : mod_auth_openidc (ELSA-2023-6365)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-6365.html");
...
var pkgs = [
    {'reference':'mod_auth_openidc-2.4.9.4-4.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'mod_auth_openidc-2.4.9.4-4.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
