...
# extracted from Debian Security Advisory dsa-5357. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-5357-1 : git - security update");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=1031310");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/git");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2023/dsa-5357");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-22490");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-23946");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'git', 'reference': '1:2.30.2-1+deb11u2'},
    {'release': '11.0', 'prefix': 'git-all', 'reference': '1:2.30.2-1+deb11u2'},
    {'release': '11.0', 'prefix': 'git-cvs', 'reference': '1:2.30.2-1+deb11u2'},
    {'release': '11.0', 'prefix': 'git-daemon-run', 'reference': '1:2.30.2-1+deb11u2'},
    {'release': '11.0', 'prefix': 'git-daemon-sysvinit', 'reference': '1:2.30.2-1+deb11u2'},
    {'release': '11.0', 'prefix': 'git-doc', 'reference': '1:2.30.2-1+deb11u2'},
    {'release': '11.0', 'prefix': 'git-el', 'reference': '1:2.30.2-1+deb11u2'},
    {'release': '11.0', 'prefix': 'git-email', 'reference': '1:2.30.2-1+deb11u2'},
    {'release': '11.0', 'prefix': 'git-gui', 'reference': '1:2.30.2-1+deb11u2'},
    {'release': '11.0', 'prefix': 'git-man', 'reference': '1:2.30.2-1+deb11u2'},
    {'release': '11.0', 'prefix': 'git-mediawiki', 'reference': '1:2.30.2-1+deb11u2'},
    {'release': '11.0', 'prefix': 'git-svn', 'reference': '1:2.30.2-1+deb11u2'},
    {'release': '11.0', 'prefix': 'gitk', 'reference': '1:2.30.2-1+deb11u2'},
    {'release': '11.0', 'prefix': 'gitweb', 'reference': '1:2.30.2-1+deb11u2'}
];
