...
# extracted from Red Hat Security Advisory RHSA-2021:0160. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:0160");
  script_xref(name:"IAVA", value:"2021-A-0040-S");
  script_xref(name:"IAVA", value:"2021-A-0005-S");

  script_name(english:"RHEL 8 : thunderbird (RHSA-2021:0160)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_0160.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f689d3fa");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#critical");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:0160");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1913503");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL thunderbird package based on the guidance in RHSA-2021:0160.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'thunderbird-78.6.1-1.el8_1', 'sp':'1', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'thunderbird-78.6.1-1.el8_1', 'sp':'1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
