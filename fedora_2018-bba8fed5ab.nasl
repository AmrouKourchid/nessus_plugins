...
# extracted from Fedora Security Advisory FEDORA-2018-bba8fed5ab.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : procps-ng (2018-bba8fed5ab)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-bba8fed5ab");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"procps-ng-3.3.12-2.fc28")) flag++;
