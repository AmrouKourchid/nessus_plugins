...
# extracted from Ubuntu Security Notice USN-7377-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"7377-1");

  script_name(english:"Ubuntu 24.04 LTS / 24.10 : Smarty vulnerability (USN-7377-1)");
...
the USN-7377-1 advisory.

    It was discovered that Smarty did not properly sanitize template file names. An attacker could possibly
    use this issue to cause Smarty to crash, resulting in a denial of service, or possibly execute arbitrary
    code.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7377-1");
  script_set_attribute(attribute:"solution", value:
"Update the affected smarty4 package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:smarty4");
...
var pkgs = [
    {'osver': '24.04', 'pkgname': 'smarty4', 'pkgver': '4.3.1-1ubuntu0.24.04.1'},
    {'osver': '24.10', 'pkgname': 'smarty4', 'pkgver': '4.3.1-1ubuntu0.24.10.1'}
];
