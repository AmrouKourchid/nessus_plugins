...
# extracted from Red Hat Security Advisory RHSA-2021:3058. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:3058");

  script_name(english:"RHEL 8 : glib2 (RHSA-2021:3058)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for glib2.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2021:3058 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_3058.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?febcba00");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:3058");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1929847");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL glib2 package based on the guidance in RHSA-2021:3058.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'glib2-2.56.4-10.el8_4.1', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glib2-devel-2.56.4-10.el8_4.1', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glib2-doc-2.56.4-10.el8_4.1', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glib2-fam-2.56.4-10.el8_4.1', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glib2-static-2.56.4-10.el8_4.1', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glib2-tests-2.56.4-10.el8_4.1', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'glib2-2.56.4-10.el8_4.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glib2-devel-2.56.4-10.el8_4.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glib2-doc-2.56.4-10.el8_4.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glib2-fam-2.56.4-10.el8_4.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glib2-static-2.56.4-10.el8_4.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glib2-tests-2.56.4-10.el8_4.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
