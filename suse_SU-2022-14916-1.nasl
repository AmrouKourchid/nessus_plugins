...
# SUSE update advisory SUSE-SU-2022:14916-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:14916-1");
  script_xref(name:"IAVA", value:"2022-A-0121-S");

  script_name(english:"SUSE SLES11 Security Update : openssl1 (SUSE-SU-2022:14916-1)");
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-March/010447.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b62408ee");
...
var pkgs = [
    {'reference':'libopenssl1-devel-1.0.1g-0.58.42.1', 'sp':'0', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.3-0']},
    {'reference':'libopenssl1_0_0-1.0.1g-0.58.42.1', 'sp':'0', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.3-0']},
    {'reference':'libopenssl1_0_0-32bit-1.0.1g-0.58.42.1', 'sp':'0', 'cpu':'s390x', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.3-0']},
    {'reference':'libopenssl1_0_0-32bit-1.0.1g-0.58.42.1', 'sp':'0', 'cpu':'x86_64', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.3-0']},
    {'reference':'openssl1-1.0.1g-0.58.42.1', 'sp':'0', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.3-0']},
    {'reference':'openssl1-doc-1.0.1g-0.58.42.1', 'sp':'0', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.3-0']}
];
