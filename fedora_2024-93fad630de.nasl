...
# extracted from Fedora Security Advisory FEDORA-2024-93fad630de
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-93fad630de");

  script_name(english:"Fedora 40 : python2.7 (2024-93fad630de)");
...
FEDORA-2024-93fad630de advisory.

    Automatic update for python2.7-2.7.18-37.fc40.

    ##### **Changelog**

    ```
    * Fri Dec 22 2023 Lumr Balhar <lbalhar@redhat.com> - 2.7.18-37
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-93fad630de");
...
var pkgs = [
    {'reference':'python2.7-2.7.18-37.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
