...
# extracted from Ubuntu Security Notice USN-2625-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS : apache2 update (USN-2625-1)");
...
The SSLProtocol configuration directive now allows specifying the
TLSv1.1 and TLSv1.2 protocols.

Ephemeral key handling has been improved, including allowing DH
parameters to be loaded from the SSL certificate file specified in
SSLCertificateFile.
...
without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://usn.ubuntu.com/2625-1/");
...
if (ubuntu_check(osver:"12.04", pkgname:"apache2.2-bin", pkgver:"2.2.22-1ubuntu1.9")) flag++;
