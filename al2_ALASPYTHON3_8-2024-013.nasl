...
# extracted from Amazon Linux 2 Security Advisory ALASPYTHON3.8-2024-013.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : python38-pip (ALASPYTHON3.8-2024-013)");
...
vulnerability as referenced in the ALAS2PYTHON3.8-2024-013 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALASPYTHON3.8-2024-013.html");
...
var pkgs = [
    {'reference':'python38-pip-21.0.1-4.amzn2.0.2', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'python3.8'}
];
