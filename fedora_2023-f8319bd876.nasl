...
# extracted from Fedora Security Advisory FEDORA-2023-f8319bd876
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-f8319bd876");

  script_name(english:"Fedora 39 : libwebp (2023-f8319bd876)");
...
FEDORA-2023-f8319bd876 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-f8319bd876");
...
var pkgs = [
    {'reference':'libwebp-1.3.1-3.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
