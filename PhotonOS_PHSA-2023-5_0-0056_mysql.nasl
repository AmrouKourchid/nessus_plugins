...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Mysql PHSA-2023-5.0-0056");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'mysql-8.0.34-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'mysql-devel-8.0.34-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'mysql-icu-data-files-8.0.34-1.ph5')) flag++;
