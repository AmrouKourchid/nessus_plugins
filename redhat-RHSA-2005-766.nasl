...
if (description)
{
  ...
  script_name(english:"RHEL 4 : squid (RHSA-2005:766)");
...
referenced in the RHSA-2005:766 advisory.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2005/rhsa-2005_766.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e8b2135d");
  script_set_attribute(attribute:"see_also", value:"http://www.squid-cache.org/bugs/show_bug.cgi?id=1143");
  script_set_attribute(attribute:"see_also", value:"http://www.squid-cache.org/bugs/show_bug.cgi?id=1325");
  script_set_attribute(attribute:"see_also", value:"http://www.squid-cache.org/bugs/show_bug.cgi?id=1355");
  script_set_attribute(attribute:"see_also", value:"http://www.squid-cache.org/bugs/show_bug.cgi?id=1368");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=166520");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=167413");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2005:766");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL squid package based on the guidance in RHSA-2005:766.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2004-2479");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2005-2794");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'squid-2.5.STABLE6-3.4E.11', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'squid-2.5.STABLE6-3.4E.11', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'squid-2.5.STABLE6-3.4E.11', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'squid-2.5.STABLE6-3.4E.11', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'squid-2.5.STABLE6-3.4E.11', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
    ]
  }
];
