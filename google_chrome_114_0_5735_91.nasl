...
if (description)
{
  ...
  script_name(english:"Google Chrome < 114.0.5735.91 Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"A web browser installed on the remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Google Chrome installed on the remote Windows host is prior to 114.0.5735.91. It is, therefore, affected
by multiple vulnerabilities as referenced in the 2023_05_stable-channel-update-for-desktop_30 advisory.
...
"Upgrade to Google Chrome version 114.0.5735.91 or later.");
...
google_chrome_check_version(installs:installs, fix:'114.0.5735.91', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
