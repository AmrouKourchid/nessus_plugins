...
# extracted from Fedora Security Advisory FEDORA-2025-8352a35e30
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-8352a35e30");

  script_name(english:"Fedora 41 : mysql8.0 (2025-8352a35e30)");
...
FEDORA-2025-8352a35e30 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-8352a35e30");
...
var pkgs = [
    {'reference':'mysql8.0-8.0.41-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
