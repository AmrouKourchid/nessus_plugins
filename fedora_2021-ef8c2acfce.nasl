...
# extracted from Fedora Security Advisory FEDORA-2021-ef8c2acfce
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-ef8c2acfce");

  script_name(english:"Fedora 33 : isync (2021-ef8c2acfce)");
...
FEDORA-2021-ef8c2acfce advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-ef8c2acfce");
  script_set_attribute(attribute:"solution", value:
"Update the affected isync package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:isync");
...
pkgs = [
    {'reference':'isync-1.4.1-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
