...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.6.0 : PyYAML (EulerOS-SA-2021-1565)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1565
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?16cce30e");
...
pkgs = ["python2-pyyaml-4.2-0.1.b4.h5.eulerosv2r8"];
