...
# extracted from Fedora Security Advisory FEDORA-2024-c4a71dab58
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-c4a71dab58");

  script_name(english:"Fedora 41 : python-aiohttp (2024-c4a71dab58)");
...
FEDORA-2024-c4a71dab58 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-c4a71dab58");
...
var pkgs = [
    {'reference':'python-aiohttp-3.9.5-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
