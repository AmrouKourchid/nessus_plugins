...
# extracted from Fedora Security Advisory FEDORA-2024-748bedc96c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-748bedc96c");
  script_xref(name:"IAVA", value:"2024-A-0387-S");

  script_name(english:"Fedora 40 : thunderbird (2024-748bedc96c)");
...
FEDORA-2024-748bedc96c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-748bedc96c");
...
var pkgs = [
    {'reference':'thunderbird-115.12.0-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
