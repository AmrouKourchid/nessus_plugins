...
"The version of Firefox ESR installed on the remote macOS or Mac OS X host is prior to 91.4.0. It is, therefore, affected
by multiple vulnerabilities as referenced in the mfsa2021-53 advisory.
...
mozilla_check_version(version:version, path:path, product:'firefox', esr:TRUE, fix:'91.4.0', min:'91.0.0', severity:SECURITY_WARNING);
