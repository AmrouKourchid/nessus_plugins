...
# extracted from Fedora Security Advisory FEDORA-2024-1ecab28e50
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-1ecab28e50");

  script_name(english:"Fedora 40 : mingw-python3 (2024-1ecab28e50)");
...
FEDORA-2024-1ecab28e50 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-1ecab28e50");
...
var pkgs = [
    {'reference':'mingw-python3-3.11.8-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
