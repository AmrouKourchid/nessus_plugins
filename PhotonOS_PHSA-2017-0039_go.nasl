...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'go-1.8.1-2.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'go-debuginfo-1.8.1-2.ph1')) flag++;
