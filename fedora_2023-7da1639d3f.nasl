...
# extracted from Fedora Security Advisory FEDORA-2023-7da1639d3f
#
...
if (description)
{
  ...
  script_cve_id("CVE-2023-27478");
  script_xref(name:"FEDORA", value:"2023-7da1639d3f");

  script_name(english:"Fedora 36 : libmemcached-awesome (2023-7da1639d3f)");
...
FEDORA-2023-7da1639d3f advisory.
    ...
    * Fix  [CVE-2023-27478](https://github.com/awesomized/libmemcached/security/advisories/GHSA-wwmh-39wj-
    fx59)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-7da1639d3f");
...
"Update the affected libmemcached-awesome package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-27478");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:libmemcached-awesome");
...
var pkgs = [
    {'reference':'libmemcached-awesome-1.1.4-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libmemcached-awesome');
}
