...
# extracted from Debian Security Advisory dsa-5391. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-5391-1 : libxml2 - security update");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=1034436");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/libxml2");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2023/dsa-5391");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'libxml2', 'reference': '2.9.10+dfsg-6.7+deb11u4'},
    {'release': '11.0', 'prefix': 'libxml2-dev', 'reference': '2.9.10+dfsg-6.7+deb11u4'},
    {'release': '11.0', 'prefix': 'libxml2-doc', 'reference': '2.9.10+dfsg-6.7+deb11u4'},
    {'release': '11.0', 'prefix': 'libxml2-utils', 'reference': '2.9.10+dfsg-6.7+deb11u4'},
    {'release': '11.0', 'prefix': 'python3-libxml2', 'reference': '2.9.10+dfsg-6.7+deb11u4'},
    {'release': '11.0', 'prefix': 'python3-libxml2-dbg', 'reference': '2.9.10+dfsg-6.7+deb11u4'}
];
