...
if (description)
{
  ...
  script_name(english:"RHEL 5 / 6 : mod_cluster (RHSA-2012:1166)");
...
in the RHSA-2012:1166 advisory.

  - mod_cluster registers and exposes the root context of a server by default, despite ROOT being in the
    excluded-contexts list (CVE-2012-1154)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2012/rhsa-2012_1166.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?550a8e39");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2012:1166");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=802200");
  script_set_attribute(attribute:"see_also", value:"https://rhn.redhat.com/errata/RHSA-2012-0035.html");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL mod_cluster package based on the guidance in RHSA-2012:1166.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'mod_cluster-demo-1.0.10-4.1.GA_CP02_patch01.ep5.el5', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'tomcat'},
      {'reference':'mod_cluster-jbossas-1.0.10-4.1.GA_CP02_patch01.ep5.el5', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'tomcat'},
      {'reference':'mod_cluster-jbossweb2-1.0.10-4.1.GA_CP02_patch01.ep5.el5', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'tomcat'},
      {'reference':'mod_cluster-tomcat6-1.0.10-4.1.GA_CP02_patch01.ep5.el5', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'tomcat'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'mod_cluster-demo-1.0.10-4.1.GA_CP02_patch01.ep5.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'tomcat'},
      {'reference':'mod_cluster-jbossas-1.0.10-4.1.GA_CP02_patch01.ep5.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'tomcat'},
      {'reference':'mod_cluster-jbossweb2-1.0.10-4.1.GA_CP02_patch01.ep5.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'tomcat'},
      {'reference':'mod_cluster-tomcat6-1.0.10-4.1.GA_CP02_patch01.ep5.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'tomcat'}
    ]
  }
];
