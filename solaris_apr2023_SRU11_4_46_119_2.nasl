...
if (description)
{
  ...
  script_cve_id("CVE-2023-21896");
  script_xref(name:"IAVA", value:"2023-A-0215-S");

  script_name(english:"Oracle Solaris Critical Patch Update : apr2023_SRU11_4_46_119_2");
...
security update :
  ...
  - Vulnerability in the Oracle Solaris product of Oracle
    ...
    CVSS 3.1 Base Score 7.0 (Confidentiality, Integrity and
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-21896");
...
fix_release = "11.4-11.4.46.0.1.119.2";

flag = 0;

if (solaris_check_release(release:"11.4-11.4.46.0.1.119.2", sru:"11.4.46.119.2") > 0) flag++;
