...
# extracted from Fedora Security Advisory FEDORA-2022-ec7de69ceb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-ec7de69ceb");

  script_name(english:"Fedora 35 : java-latest-openjdk (2022-ec7de69ceb)");
...
FEDORA-2022-ec7de69ceb advisory.
    ...
    * This update depends on
    [FEDORA-2022-10bb6f119e](https://bodhi.fedoraproject.org/updates/FEDORA-2022-10bb6f119e)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-ec7de69ceb");
...
var pkgs = [
    {'reference':'java-latest-openjdk-19.0.1.0.10-2.rolling.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
