...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.0 : vim (EulerOS-SA-2022-2923)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2923
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f6da3aba");
...
var pkgs = [
  "vim-common-8.2-1.h53.eulerosv2r10",
  "vim-enhanced-8.2-1.h53.eulerosv2r10",
  "vim-filesystem-8.2-1.h53.eulerosv2r10",
  "vim-minimal-8.2-1.h53.eulerosv2r10"
];
