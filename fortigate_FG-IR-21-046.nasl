...
if (description)
{
  ...
  script_name(english:"Fortinet Fortigate Buffer Underwrite in firmware verification (FG-IR-21-046)");
...
var constraints = [
  { 'min_version' : '5.0', 'max_version' : '5.6', 'fixed_version' : '6.2.10' },
  { 'min_version' : '6.0.0', 'max_version' : '6.0.13', 'fixed_version' : '6.2.10' },
