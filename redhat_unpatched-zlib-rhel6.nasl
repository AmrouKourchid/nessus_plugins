...
# extracted from Red Hat Security Advisory zlib. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2022-37434", "CVE-2023-45853");

  script_name(english:"RHEL 6 : zlib (Unpatched Vulnerability) (deprecated)");
