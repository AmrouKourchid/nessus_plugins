...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Libtiff PHSA-2020-3.0-0078");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libtiff-4.1.0-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libtiff-debuginfo-4.1.0-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libtiff-devel-4.1.0-1.ph3')) flag++;
