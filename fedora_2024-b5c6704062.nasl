...
# extracted from Fedora Security Advisory FEDORA-2024-b5c6704062
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-b5c6704062");

  script_name(english:"Fedora 41 : python-requests (2024-b5c6704062)");
...
FEDORA-2024-b5c6704062 advisory.
    ...
    ```
    * Wed Jun 19 2024 Lumr Balhar <lbalhar@redhat.com> - 2.32.3-1
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-b5c6704062");
...
var pkgs = [
    {'reference':'python-requests-2.32.3-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
