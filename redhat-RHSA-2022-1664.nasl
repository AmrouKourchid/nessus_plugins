...
# extracted from Red Hat Security Advisory RHSA-2022:1664. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:1664");

  script_name(english:"RHEL 7 : Red Hat Software Collections (RHSA-2022:1664)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for Red Hat Software Collections.");
...
the RHSA-2022:1664 advisory.

    lxml is an XML processing library providing access to libxml2 and libxslt libraries using the Python
    ElementTree API.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_1664.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8631c375");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:1664");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2032569");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2064443");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2068592");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat Software Collections package based on the guidance in RHSA-2022:1664.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-python38-python-lxml-4.4.1-8.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-python38-python-lxml-4.4.1-8.el7', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-python38-python-lxml-4.4.1-8.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'rh-python38-python-lxml');
}
