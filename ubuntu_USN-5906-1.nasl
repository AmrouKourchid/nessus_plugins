...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS / 22.04 LTS : PostgreSQL vulnerability (USN-5906-1)");
...
in the USN-5906-1 advisory.
    ...
    Jacob Champion discovered that the PostgreSQL client incorrectly handled Kerberos authentication. If a
    user or automated system were tricked into connecting to a malicious server, a remote attacker could
