...
# extracted from Fedora Security Advisory FEDORA-2025-725bba93b2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-725bba93b2");

  script_name(english:"Fedora 40 : FlightGear / SimGear (2025-725bba93b2)");
...
FEDORA-2025-725bba93b2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-725bba93b2");
  script_set_attribute(attribute:"solution", value:
"Update the affected FlightGear and / or SimGear packages.");
...
var pkgs = [
    {'reference':'FlightGear-2020.3.19-8.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'SimGear-2020.3.19-7.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
