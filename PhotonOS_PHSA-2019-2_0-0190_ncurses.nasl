...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Ncurses PHSA-2019-2.0-0190");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'ncurses-6.1-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'ncurses-compat-6.1-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'ncurses-debuginfo-6.1-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'ncurses-devel-6.1-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'ncurses-libs-6.1-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'ncurses-terminfo-6.1-1.ph2')) flag++;
