...
# extracted from Gentoo Linux Security Advisory GLSA 202307-01.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2023-25136", "CVE-2023-28531", "CVE-2023-38408");
  script_xref(name:"IAVA", value:"2023-A-0377-S");

  script_name(english:"GLSA-202307-01 : OpenSSH: Remote Code Execution");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202307-01");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=892936");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=905299");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=910553");
...
var packages = [
  {
    ...
    'unaffected' : make_list("ge 9.3_p2"),
    'vulnerable' : make_list("lt 9.3_p2")
  }
];
