...
# extracted from Ubuntu Security Notice USN-4119-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"4119-1");

  script_name(english:"Ubuntu 19.04 : irssi vulnerability (USN-4119-1)");
...
without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://usn.ubuntu.com/4119-1/");
...
"Update the affected irssi package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-15717");
...
if (ubuntu_check(osver:"19.04", pkgname:"irssi", pkgver:"1.2.0-2ubuntu1.2")) flag++;
