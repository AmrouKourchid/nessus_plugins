...
# extracted from openSUSE Security Update openSUSE-2021-349.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : python-cryptography (openSUSE-2021-349)");
...
"This update for python-cryptography fixes the following issues :
  ...
  - CVE-2020-36242: Using the Fernet class to symmetrically
    encrypt multi gigabyte values could result in an integer
    overflow and buffer overflow (bsc#1182066).

This update was imported from the SUSE:SLE-15-SP2:Update update
project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1182066");
...
if ( rpm_check(release:"SUSE15.2", reference:"python-cryptography-debuginfo-2.8-lp152.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"python-cryptography-debugsource-2.8-lp152.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"python2-cryptography-2.8-lp152.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"python2-cryptography-debuginfo-2.8-lp152.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"python3-cryptography-2.8-lp152.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"python3-cryptography-debuginfo-2.8-lp152.2.6.1") ) flag++;
