...
if (description)
{
  ...
  script_cve_id("CVE-2023-23779");

  script_name(english:"Fortinet FortiWeb - Multiple OS command injection (FG-IR-22-133)");
...
vulnerability as referenced in the FG-IR-22-133 advisory.

  - Multiple improper neutralization of special elements used in an OS Command ('OS Command Injection')
    vulnerabilities [CWE-78] in FortiWeb version 7.0.1 and below, 6.4 all versions, version 6.3.19 and below
    may allow an authenticated attacker to execute unauthorized code or commands via crafted parameters of
    HTTP requests. (CVE-2023-23779)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.fortiguard.com/psirt/FG-IR-22-133");
...
"Please upgrade to FortiWeb version 6.3.20/7.0.2 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-23779");
