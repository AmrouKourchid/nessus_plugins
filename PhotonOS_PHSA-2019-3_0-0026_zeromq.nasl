...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Zeromq PHSA-2019-3.0-0026");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'zeromq-4.2.3-3.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'zeromq-debuginfo-4.2.3-3.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'zeromq-devel-4.2.3-3.ph3')) flag++;
