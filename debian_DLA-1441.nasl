...
# extracted from Debian Security Advisory DLA-1441-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1441-1 : sympa security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2018/07/msg00033.html");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"sympa", reference:"6.1.23~dfsg-2+deb8u2")) flag++;
