...
# extracted from VMware Security Advisory PHSA-2022-4.0-0156. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Freetype2 PHSA-2022-4.0-0156");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the freetype2 package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-156.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'freetype2-2.10.2-3.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'freetype2-devel-2.10.2-3.ph4')) flag++;
