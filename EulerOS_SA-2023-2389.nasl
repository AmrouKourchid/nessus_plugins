...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : ntp (EulerOS-SA-2023-2389)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the ntp package installed, the EulerOS installation on the remote host is affected by the
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2389
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?25449b0b");
...
var pkgs = [
  "ntp-4.2.8p14-3.h11.eulerosv2r10"
];
