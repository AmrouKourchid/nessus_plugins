...
# extracted from Red Hat Security Advisory RHSA-2020:5567. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:5567");
  script_xref(name:"IAVB", value:"2020-B-0069-S");

  script_name(english:"RHEL 8 : postgresql:10 (RHSA-2020:5567)");
...
referenced in the RHSA-2020:5567 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_5567.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9f9d57c4");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:5567");
...
"Update the RHEL postgresql:10 package based on the guidance in RHSA-2020:5567.");
  ...
  'postgresql:10': [
    {
      ...
      'pkgs': [
        {'reference':'postgresql-10.15-1.module+el8.3.0+8944+1ca16b1f', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-contrib-10.15-1.module+el8.3.0+8944+1ca16b1f', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-docs-10.15-1.module+el8.3.0+8944+1ca16b1f', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plperl-10.15-1.module+el8.3.0+8944+1ca16b1f', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plpython3-10.15-1.module+el8.3.0+8944+1ca16b1f', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-pltcl-10.15-1.module+el8.3.0+8944+1ca16b1f', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-10.15-1.module+el8.3.0+8944+1ca16b1f', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-devel-10.15-1.module+el8.3.0+8944+1ca16b1f', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-static-10.15-1.module+el8.3.0+8944+1ca16b1f', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-10.15-1.module+el8.3.0+8944+1ca16b1f', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-rpm-macros-10.15-1.module+el8.3.0+8944+1ca16b1f', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-upgrade-10.15-1.module+el8.3.0+8944+1ca16b1f', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-upgrade-devel-10.15-1.module+el8.3.0+8944+1ca16b1f', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
