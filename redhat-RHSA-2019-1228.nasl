...
# extracted from Red Hat Security Advisory RHSA-2019:1228. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:1228");

  script_name(english:"RHEL 7 : wget (RHSA-2019:1228)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_1228.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cb8182f2");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:1228");
...
"Update the RHEL wget package based on the guidance in RHSA-2019:1228.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'wget-1.14-18.el7_6.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
