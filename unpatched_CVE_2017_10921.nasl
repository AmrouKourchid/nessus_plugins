...
if (description)
{
  ...
  script_cve_id("CVE-2017-10921");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2017-10921");
...
patch available.
  ...
  - The grant-table feature in Xen through 4.8.x does not ensure sufficient type counts for a
