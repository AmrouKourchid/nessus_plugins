...
# extracted from Fedora Security Advisory FEDORA-2019-a9c08d4b40.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-a9c08d4b40");

  script_name(english:"Fedora 28 : tcpreplay (2019-a9c08d4b40)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-a9c08d4b40");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"tcpreplay-4.3.2-1.fc28")) flag++;
