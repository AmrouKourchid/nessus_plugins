...
# AlmaLinux Security Advisory ALSA-2024:4376.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:4376");
  script_xref(name:"IAVA", value:"2024-A-0255");

  script_name(english:"AlmaLinux 8 : libreswan (ALSA-2024:4376)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2024-4376.html");
...
var pkgs = [
    {'reference':'libreswan-4.12-2.el8_10.4', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libreswan-4.12-2.el8_10.4', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
