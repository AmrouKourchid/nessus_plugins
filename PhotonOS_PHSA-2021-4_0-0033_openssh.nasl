...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Openssh PHSA-2021-4.0-0033");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'openssh-8.5p1-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'openssh-clients-8.5p1-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'openssh-server-8.5p1-1.ph4')) flag++;
