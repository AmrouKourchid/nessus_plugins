...
# extracted from ZTE advisory NS-SA-2023-0103. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 5.04 : gzip Vulnerability (NS-SA-2023-0103)");

  script_set_attribute(attribute:"synopsis", value:
"The remote NewStart CGSL host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 5.04, has gzip packages installed that are affected by a
vulnerability:
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/notice/NS-SA-2023-0103");
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/info/CVE-2022-1271");
  script_set_attribute(attribute:"solution", value:
"Upgrade the vulnerable CGSL gzip packages. Note that updated packages may not be available yet. Please contact ZTE for
more information.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:gzip");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:gzip-debuginfo");
