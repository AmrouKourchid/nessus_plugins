...
# openSUSE Security Update openSUSE-SU-2023:0174-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : python-Django (openSUSE-SU-2023:0174-1)");
...
number.");
  ...
  # https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/CGRJARKS4352V5BRO6NUJYHVKDUI4VU4/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e4dff313");
...
var pkgs = [
    {'reference':'python3-Django-2.2.28-bp154.2.12.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE}
];
