...
# SUSE update advisory SUSE-SU-2022:1929-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:1929-1");

  script_name(english:"SUSE SLES15 Security Update : redis (SUSE-SU-2022:1929-1)");
...
referenced in the SUSE-SU-2022:1929-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-June/011230.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c5d7a673");
...
var pkgs = [
    {'reference':'redis-6.2.6-150400.3.3.7', 'sp':'4', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.4']},
    {'reference':'redis-6.2.6-150400.3.3.7', 'sp':'4', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.4', 'sle-module-server-applications-release-15.4', 'sles-release-15.4']}
];
