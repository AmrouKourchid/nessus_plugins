...
# openSUSE Security Update openSUSE-SU-2021:3584-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : transfig (openSUSE-SU-2021:3584-1)");
...
the openSUSE-SU-2021:3584-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2881a2c6");
...
var pkgs = [
    {'reference':'transfig-3.2.8b-4.15.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE}
];
