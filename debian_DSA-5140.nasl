...
# extracted from Debian Security Advisory dsa-5140. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-5140-1 : openldap - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 / 11 host has packages installed that are affected by a vulnerability as referenced in the dsa-5140
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2022/dsa-5140");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bullseye/openldap");
...
For the stable distribution (bullseye), this problem has been fixed in version 2.4.57+dfsg-3+deb11u1.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:slapd-contrib");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:slapd-smbk5pwd");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:slapi-dev");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'ldap-utils', 'reference': '2.4.47+dfsg-3+deb10u7'},
    {'release': '10.0', 'prefix': 'libldap-2.4-2', 'reference': '2.4.47+dfsg-3+deb10u7'},
    {'release': '10.0', 'prefix': 'libldap-common', 'reference': '2.4.47+dfsg-3+deb10u7'},
    {'release': '10.0', 'prefix': 'libldap2-dev', 'reference': '2.4.47+dfsg-3+deb10u7'},
    {'release': '10.0', 'prefix': 'slapd', 'reference': '2.4.47+dfsg-3+deb10u7'},
    {'release': '10.0', 'prefix': 'slapd-contrib', 'reference': '2.4.47+dfsg-3+deb10u7'},
    {'release': '10.0', 'prefix': 'slapd-smbk5pwd', 'reference': '2.4.47+dfsg-3+deb10u7'},
    {'release': '10.0', 'prefix': 'slapi-dev', 'reference': '2.4.47+dfsg-3+deb10u7'},
    {'release': '11.0', 'prefix': 'ldap-utils', 'reference': '2.4.57+dfsg-3+deb11u1'},
    {'release': '11.0', 'prefix': 'libldap-2.4-2', 'reference': '2.4.57+dfsg-3+deb11u1'},
    {'release': '11.0', 'prefix': 'libldap-common', 'reference': '2.4.57+dfsg-3+deb11u1'},
    {'release': '11.0', 'prefix': 'libldap2-dev', 'reference': '2.4.57+dfsg-3+deb11u1'},
    {'release': '11.0', 'prefix': 'slapd', 'reference': '2.4.57+dfsg-3+deb11u1'},
    {'release': '11.0', 'prefix': 'slapd-contrib', 'reference': '2.4.57+dfsg-3+deb11u1'},
    {'release': '11.0', 'prefix': 'slapd-smbk5pwd', 'reference': '2.4.57+dfsg-3+deb11u1'},
    {'release': '11.0', 'prefix': 'slapi-dev', 'reference': '2.4.57+dfsg-3+deb11u1'}
];
