...
# extracted from Red Hat Security Advisory RHSA-2023:0021. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:0021");

  script_name(english:"RHEL 9 : webkit2gtk3 (RHSA-2023:0021)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_0021.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a594f3de");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2153683");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:0021");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL webkit2gtk3 package based on the guidance in RHSA-2023:0021.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'webkit2gtk3-2.36.7-1.el9_1.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'webkit2gtk3-devel-2.36.7-1.el9_1.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'webkit2gtk3-jsc-2.36.7-1.el9_1.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'webkit2gtk3-jsc-devel-2.36.7-1.el9_1.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
