...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS / 22.04 LTS / 23.04 : Nova regression (USN-6073-8)");
...
referenced in the USN-6073-8 advisory.

    USN-6073-3 fixed a vulnerability in Nova. Unfortunately the update introduced a regression with detaching
    volumes. The security fix has been removed pending further investigation.
