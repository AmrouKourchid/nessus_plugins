...
# extracted from Red Hat Security Advisory RHSA-2023:3107. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:3107");

  script_name(english:"RHEL 8 : libreswan (RHSA-2023:3107)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_3107.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e9094518");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:3107");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2189777");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libreswan package based on the guidance in RHSA-2023:3107.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libreswan-4.9-3.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'libreswan-4.9-3.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
