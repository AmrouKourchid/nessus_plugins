...
# extracted from Fedora Security Advisory FEDORA-2023-4bb75fa8f2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-4bb75fa8f2");

  script_name(english:"Fedora 39 : tigervnc (2023-4bb75fa8f2)");
...
FEDORA-2023-4bb75fa8f2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-4bb75fa8f2");
...
var pkgs = [
    {'reference':'tigervnc-1.13.1-6.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
