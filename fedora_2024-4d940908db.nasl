...
# extracted from Fedora Security Advisory FEDORA-2024-4d940908db
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-4d940908db");

  script_name(english:"Fedora 40 : webkitgtk (2024-4d940908db)");
...
FEDORA-2024-4d940908db advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-4d940908db");
...
var pkgs = [
    {'reference':'webkitgtk-2.46.3-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
