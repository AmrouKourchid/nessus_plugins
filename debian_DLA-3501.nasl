...
# extracted from Debian Security Advisory dla-3501. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3501 : renderdoc - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/renderdoc");
  script_set_attribute(attribute:"solution", value:
"Upgrade the renderdoc packages.");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'renderdoc', 'reference': '1.2+dfsg-2+deb10u1'}
];
