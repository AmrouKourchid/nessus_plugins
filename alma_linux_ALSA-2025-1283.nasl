...
# AlmaLinux Security Advisory ALSA-2025:1283.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2025:1283");
  script_xref(name:"RHSA", value:"2025:1283");

  script_name(english:"AlmaLinux 8 : firefox (ALSA-2025:1283)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2025-1283.html");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:1283");
...
var pkgs = [
    ...
    {'reference':'firefox-128.7.0-1.el8_10', 'cpu':'ppc64le', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0', 'allowmaj':TRUE},
    {'reference':'firefox-128.7.0-1.el8_10', 'cpu':'s390x', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0', 'allowmaj':TRUE},
