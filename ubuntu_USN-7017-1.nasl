...
# extracted from Ubuntu Security Notice USN-7017-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"7017-1");

  script_name(english:"Ubuntu 20.04 LTS : Quagga vulnerability (USN-7017-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7017-1");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'quagga', 'pkgver': '1.2.4-4ubuntu0.5'},
    {'osver': '20.04', 'pkgname': 'quagga-bgpd', 'pkgver': '1.2.4-4ubuntu0.5'},
    {'osver': '20.04', 'pkgname': 'quagga-core', 'pkgver': '1.2.4-4ubuntu0.5'},
    {'osver': '20.04', 'pkgname': 'quagga-isisd', 'pkgver': '1.2.4-4ubuntu0.5'},
    {'osver': '20.04', 'pkgname': 'quagga-ospf6d', 'pkgver': '1.2.4-4ubuntu0.5'},
    {'osver': '20.04', 'pkgname': 'quagga-ospfd', 'pkgver': '1.2.4-4ubuntu0.5'},
    {'osver': '20.04', 'pkgname': 'quagga-pimd', 'pkgver': '1.2.4-4ubuntu0.5'},
    {'osver': '20.04', 'pkgname': 'quagga-ripd', 'pkgver': '1.2.4-4ubuntu0.5'},
    {'osver': '20.04', 'pkgname': 'quagga-ripngd', 'pkgver': '1.2.4-4ubuntu0.5'}
];
