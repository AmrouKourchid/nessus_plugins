...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Gnupg PHSA-2019-2.0-0128");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'gnupg-2.1.20-4.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'gnupg-debuginfo-2.1.20-4.ph2')) flag++;
