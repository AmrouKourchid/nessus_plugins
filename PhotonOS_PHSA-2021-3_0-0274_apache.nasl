...
# extracted from VMware Security Advisory PHSA-2021-3.0-0274. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Apache PHSA-2021-3.0-0274");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the apache package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-3.0-274.md");
...
if (rpm_check(release:'PhotonOS-3.0', reference:'apache-ant-1.10.8-3.ph3')) flag++;
