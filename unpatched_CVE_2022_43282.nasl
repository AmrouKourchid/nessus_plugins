...
if (description)
{
  ...
  script_cve_id("CVE-2022-43282");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-43282");
...
patch available.
  ...
  - wasm-interp v1.0.29 was discovered to contain an out-of-bounds read via the component
    OnReturnCallIndirectExpr->GetReturnCallDropKeepCount. (CVE-2022-43282)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-43282");
