...
# extracted from Amazon Linux 2023 Security Advisory ALAS2023-2024-625.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2023-45288", "CVE-2024-24786");
  script_xref(name:"IAVB", value:"2024-B-0032-S");

  script_name(english:"Amazon Linux 2023 : amazon-cloudwatch-agent (ALAS2023-2024-625)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2023 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"It is, therefore, affected by multiple vulnerabilities as referenced in the ALAS2023-2024-625 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2023/ALAS-2024-625.html");
...
"Run 'dnf update amazon-cloudwatch-agent --releasever 2023.4.20240528' to update your system.");
...
var pkgs = [
    {'reference':'amazon-cloudwatch-agent-1.300039.0-1.amzn2023', 'cpu':'aarch64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'amazon-cloudwatch-agent-1.300039.0-1.amzn2023', 'cpu':'x86_64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE}
];
