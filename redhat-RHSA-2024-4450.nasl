...
# extracted from Red Hat Security Advisory RHSA-2024:4450. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:4450");
  script_xref(name:"IAVA", value:"2024-A-0398-S");
  script_xref(name:"IAVA", value:"2024-A-0406-S");

  script_name(english:"RHEL 9 : dotnet8.0 (RHSA-2024:4450)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for dotnet8.0.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:4450 advisory.
    ...
    .NET SDK 8.0.107 and Runtime 8.0.7.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_4450.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3b366cb5");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:4450");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL dotnet8.0 package based on the guidance in RHSA-2024:4450.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'aspnetcore-runtime-8.0-8.0.7-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'aspnetcore-runtime-dbg-8.0-8.0.7-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'aspnetcore-targeting-pack-8.0-8.0.7-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-apphost-pack-8.0-8.0.7-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-host-8.0.7-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-hostfxr-8.0-8.0.7-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-runtime-8.0-8.0.7-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-runtime-dbg-8.0-8.0.7-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-sdk-8.0-8.0.107-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-sdk-8.0-source-built-artifacts-8.0.107-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-sdk-dbg-8.0-8.0.107-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-targeting-pack-8.0-8.0.7-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-templates-8.0-8.0.107-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'netstandard-targeting-pack-2.1-8.0.107-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'aspnetcore-runtime-8.0-8.0.7-1.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'aspnetcore-runtime-dbg-8.0-8.0.7-1.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'aspnetcore-targeting-pack-8.0-8.0.7-1.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-apphost-pack-8.0-8.0.7-1.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-host-8.0.7-1.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-hostfxr-8.0-8.0.7-1.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-runtime-8.0-8.0.7-1.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-runtime-dbg-8.0-8.0.7-1.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-sdk-8.0-8.0.107-1.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-sdk-8.0-source-built-artifacts-8.0.107-1.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-sdk-dbg-8.0-8.0.107-1.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-targeting-pack-8.0-8.0.7-1.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-templates-8.0-8.0.107-1.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'netstandard-targeting-pack-2.1-8.0.107-1.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
