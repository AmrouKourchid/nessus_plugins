...
if (description)
{
  ...
  script_name(english:"CentOS 9 : squashfs-tools-4.4-10.git1.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing one or more security updates for squashfs-tools.");
...
squashfs-tools-4.4-10.git1.el9 build changelog.

  - unvalidated filepaths allow writing outside of destination rhbz#2000638 (CVE-2021-40153)

  - additional write outside destination directory exploit fix rhbz#2007304 (CVE-2021-41072)

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=37168");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream squashfs-tools package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:squashfs-tools");
