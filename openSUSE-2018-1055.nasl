...
# extracted from openSUSE Security Update openSUSE-2018-1055.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : shadow (openSUSE-2018-1055)");
...
if ( rpm_check(release:"SUSE42.3", reference:"shadow-4.2.1-20.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"shadow-debuginfo-4.2.1-20.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"shadow-debugsource-4.2.1-20.1") ) flag++;
