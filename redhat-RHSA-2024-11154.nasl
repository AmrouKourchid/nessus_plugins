...
# extracted from Red Hat Security Advisory RHSA-2024:11154. The text
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_11154.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a93ff2a9");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:11154");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL bluez package based on the guidance in RHSA-2024:11154.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'bluez-5.63-3.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bluez-cups-5.63-3.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bluez-hid2hci-5.63-3.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bluez-libs-5.63-3.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bluez-libs-devel-5.63-3.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bluez-obexd-5.63-3.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
