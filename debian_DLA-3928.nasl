...
# extracted from Debian Security Advisory dla-3928. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2023-49502", "CVE-2024-7055", "CVE-2024-31578");
  script_xref(name:"IAVB", value:"2024-B-0110-S");

  script_name(english:"Debian dla-3928 : ffmpeg - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-49502");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-31578");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-7055");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'ffmpeg', 'reference': '7:4.3.8-0+deb11u1'},
    {'release': '11.0', 'prefix': 'ffmpeg-doc', 'reference': '7:4.3.8-0+deb11u1'},
    {'release': '11.0', 'prefix': 'libavcodec-dev', 'reference': '7:4.3.8-0+deb11u1'},
    {'release': '11.0', 'prefix': 'libavcodec-extra', 'reference': '7:4.3.8-0+deb11u1'},
    {'release': '11.0', 'prefix': 'libavcodec-extra58', 'reference': '7:4.3.8-0+deb11u1'},
    {'release': '11.0', 'prefix': 'libavcodec58', 'reference': '7:4.3.8-0+deb11u1'},
    {'release': '11.0', 'prefix': 'libavdevice-dev', 'reference': '7:4.3.8-0+deb11u1'},
    {'release': '11.0', 'prefix': 'libavdevice58', 'reference': '7:4.3.8-0+deb11u1'},
    {'release': '11.0', 'prefix': 'libavfilter-dev', 'reference': '7:4.3.8-0+deb11u1'},
    {'release': '11.0', 'prefix': 'libavfilter-extra', 'reference': '7:4.3.8-0+deb11u1'},
    {'release': '11.0', 'prefix': 'libavfilter-extra7', 'reference': '7:4.3.8-0+deb11u1'},
    {'release': '11.0', 'prefix': 'libavfilter7', 'reference': '7:4.3.8-0+deb11u1'},
    {'release': '11.0', 'prefix': 'libavformat-dev', 'reference': '7:4.3.8-0+deb11u1'},
    {'release': '11.0', 'prefix': 'libavformat58', 'reference': '7:4.3.8-0+deb11u1'},
    {'release': '11.0', 'prefix': 'libavresample-dev', 'reference': '7:4.3.8-0+deb11u1'},
    {'release': '11.0', 'prefix': 'libavresample4', 'reference': '7:4.3.8-0+deb11u1'},
    {'release': '11.0', 'prefix': 'libavutil-dev', 'reference': '7:4.3.8-0+deb11u1'},
    {'release': '11.0', 'prefix': 'libavutil56', 'reference': '7:4.3.8-0+deb11u1'},
    {'release': '11.0', 'prefix': 'libpostproc-dev', 'reference': '7:4.3.8-0+deb11u1'},
    {'release': '11.0', 'prefix': 'libpostproc55', 'reference': '7:4.3.8-0+deb11u1'},
    {'release': '11.0', 'prefix': 'libswresample-dev', 'reference': '7:4.3.8-0+deb11u1'},
    {'release': '11.0', 'prefix': 'libswresample3', 'reference': '7:4.3.8-0+deb11u1'},
    {'release': '11.0', 'prefix': 'libswscale-dev', 'reference': '7:4.3.8-0+deb11u1'},
    {'release': '11.0', 'prefix': 'libswscale5', 'reference': '7:4.3.8-0+deb11u1'}
];
