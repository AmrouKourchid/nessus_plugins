...
var withdrawl_announcements = make_array(
  #"^8\.3($|\.)"  , 'http://php.net/supported-versions.php',
  #"^8\.2($|\.)"  , 'http://php.net/supported-versions.php',
  #"^8\.1($|\.)"  , 'http://php.net/supported-versions.php',
  "^8\.0($|\.)"  , 'http://php.net/supported-versions.php',
...
var supported_versions = '8.1.x / 8.2.x / 8.3.x';

var backported = get_kb_item('www/php/'+port+'/'+version+'/backported');
