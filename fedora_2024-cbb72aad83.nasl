...
# extracted from Fedora Security Advisory FEDORA-2024-cbb72aad83
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-cbb72aad83");

  script_name(english:"Fedora 40 : libarchive (2024-cbb72aad83)");
...
FEDORA-2024-cbb72aad83 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-cbb72aad83");
...
var pkgs = [
    {'reference':'libarchive-3.7.2-4.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
