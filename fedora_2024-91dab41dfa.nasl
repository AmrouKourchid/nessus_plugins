...
# extracted from Fedora Security Advisory FEDORA-2024-91dab41dfa
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-91dab41dfa");

  script_name(english:"Fedora 38 : clojure (2024-91dab41dfa)");
...
FEDORA-2024-91dab41dfa advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-91dab41dfa");
  script_set_attribute(attribute:"solution", value:
"Update the affected 1:clojure package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:clojure");
...
var pkgs = [
    {'reference':'clojure-1.11.2-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'clojure');
}
