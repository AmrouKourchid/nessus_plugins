...
# extracted from Fedora Security Advisory FEDORA-2023-c6f82ee005
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-c6f82ee005");

  script_name(english:"Fedora 38 : podman (2023-c6f82ee005)");
...
FEDORA-2023-c6f82ee005 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-c6f82ee005");
...
var pkgs = [
    {'reference':'podman-4.4.4-3.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'5'}
];
