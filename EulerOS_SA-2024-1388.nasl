...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.0 : python-configobj (EulerOS-SA-2024-1388)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1388
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5b507a3a");
...
var pkgs = [
  "python3-configobj-5.0.6-15.h2.eulerosv2r10"
];
