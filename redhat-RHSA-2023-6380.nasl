...
# extracted from Red Hat Security Advisory RHSA-2023:6380. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:6380");

  script_name(english:"RHEL 9 : runc (RHSA-2023:6380)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for runc.");
...
referenced in the RHSA-2023:6380 advisory.
    ...
    * runc: integer overflow in netlink bytemsg length field allows attacker to override netlink-based
    container configuration (CVE-2021-43784)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6380.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5371f1df");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6380");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2029439");
...
"Update the RHEL runc package based on the guidance in RHSA-2023:6380.");
  ...
  script_cwe_id(41, 190, 276, 305, 400);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'runc-1.1.9-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'}
    ]
  }
];
