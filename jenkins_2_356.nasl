...
if (description)
{
  ...
  script_name(english:"Jenkins LTS < 2.332.4 / Jenkins weekly < 2.356 Multiple Vulnerabilities");
...
LTS prior to 2.332.4 or Jenkins weekly prior to 2.356. It is, therefore, affected by multiple vulnerabilities:
...
var constraints = [
  { 'max_version' : '2.355', 'fixed_version' : '2.356', 'edition' : 'Open Source' },
  { 'max_version' : '2.332.3', 'fixed_version' : '2.332.4', 'fixed_display' : '2.332.4 or 2.346.1', 'edition' : 'Open Source LTS' }
];
