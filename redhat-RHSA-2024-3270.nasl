...
# extracted from Red Hat Security Advisory RHSA-2024:3270. The text
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_3270.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b6ba5231");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:3270");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL sssd package based on the guidance in RHSA-2024:3270.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libipa_hbac-2.9.4-3.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsss_autofs-2.9.4-3.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsss_certmap-2.9.4-3.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsss_idmap-2.9.4-3.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsss_nss_idmap-2.9.4-3.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsss_nss_idmap-devel-2.9.4-3.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsss_simpleifp-2.9.4-3.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsss_sudo-2.9.4-3.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-libipa_hbac-2.9.4-3.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-libsss_nss_idmap-2.9.4-3.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-sss-2.9.4-3.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-sss-murmur-2.9.4-3.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-sssdconfig-2.9.4-3.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-2.9.4-3.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-ad-2.9.4-3.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-client-2.9.4-3.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-common-2.9.4-3.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-common-pac-2.9.4-3.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-dbus-2.9.4-3.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-idp-2.9.4-3.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-ipa-2.9.4-3.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-kcm-2.9.4-3.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-krb5-2.9.4-3.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-krb5-common-2.9.4-3.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-ldap-2.9.4-3.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-nfs-idmap-2.9.4-3.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-polkit-rules-2.9.4-3.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-proxy-2.9.4-3.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-tools-2.9.4-3.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-winbind-idmap-2.9.4-3.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
