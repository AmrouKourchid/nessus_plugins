...
# AlmaLinux Security Advisory ALSA-2025:0791.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2025:0791");
  script_xref(name:"RHSA", value:"2025:0791");

  script_name(english:"AlmaLinux 9 : libsoup (ALSA-2025:0791)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2025-0791.html");
...
var pkgs = [
    {'reference':'libsoup-2.72.0-8.el9_5.3', 'release':'9', 'el_string':'el9_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'libsoup-devel-2.72.0-8.el9_5.3', 'release':'9', 'el_string':'el9_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'}
];
