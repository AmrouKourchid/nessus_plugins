...
# extracted from Debian Security Advisory dla-2868. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2868-1 : advancecomp - LTS security update");
...
dla-2868 advisory.
  ...
  - An out-of-bounds heap buffer read flaw was found in the way advancecomp before 2.1-2018/02 handled
    processing of ZIP files. An attacker could potentially use this flaw to crash the advzip utility by
    tricking it into processing crafted ZIP files. (CVE-2018-1056)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=889270");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/advancecomp");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2021/dla-2868");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2018-1056");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2019-8379");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2019-8383");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2019-9210");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/stretch/advancecomp");
  script_set_attribute(attribute:"solution", value:
"Upgrade the advancecomp packages.
...
var pkgs = [
    {'release': '9.0', 'prefix': 'advancecomp', 'reference': '1.20-1+deb9u1'}
];
