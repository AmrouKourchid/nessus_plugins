...
# extracted from Fedora Security Advisory FEDORA-2024-7fecec055b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-7fecec055b");

  script_name(english:"Fedora 41 : golang-github-git-5 (2024-7fecec055b)");
...
FEDORA-2024-7fecec055b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-7fecec055b");
  script_set_attribute(attribute:"solution", value:
"Update the affected golang-github-git-5 package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:golang-github-git-5");
...
var pkgs = [
    {'reference':'golang-github-git-5-5.12.0-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'golang-github-git-5');
}
