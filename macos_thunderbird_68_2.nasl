...
"The version of Thunderbird installed on the remote macOS or Mac OS X host is prior to 68.2. It is, therefore, affected
by multiple vulnerabilities as referenced in the mfsa2019-35 advisory.
...
mozilla_check_version(version:version, path:path, product:'thunderbird', esr:FALSE, fix:'68.2', severity:SECURITY_WARNING);
