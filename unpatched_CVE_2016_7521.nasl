...
if (description)
{
  ...
  script_cve_id("CVE-2016-7521");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2016-7521");
...
patch available.
  ...
  - Heap-based buffer overflow in coders/psd.c in ImageMagick allows remote attackers to cause a denial of
    service (out-of-bounds read) via a crafted PSD file. (CVE-2016-7521)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-7521");
