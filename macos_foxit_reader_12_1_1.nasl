...
if (description)
{
  ...
  script_name(english:"Foxit PDF Reader for Mac < 12.1.1 Multiple Vulnerabilities");
...
the remote macOS host is prior to 12.1.1. It is, therefore affected by multiple vulnerabilities:
...
"Upgrade to Foxit PDF Reader for Mac version 12.1.1 or later");
...
var constraints = [
  { 'max_version' : '12.1.0.1229', 'fixed_version' : '12.1.1' }
];
