...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.1 : shim (EulerOS-SA-2023-3095)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3095
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?73879040");
...
var pkgs = [
  ...
  "shim-aa64-storage-15-19.h16.eulerosv2r9"
];
