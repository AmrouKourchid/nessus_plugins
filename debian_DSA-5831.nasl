...
# extracted from Debian Security Advisory dsa-5831. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5831 : gir1.2-gst-plugins-base-1.0 - security update");
...
dsa-5831 advisory.
    ...
    - -------------------------------------------------------------------------
    Debian Security Advisory DSA-5831-1                   security@debian.org
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-47538");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-47541");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-47600");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-47607");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-47615");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-47835");
...
"Upgrade the gir1.2-gst-plugins-base-1.0 packages.");
  ...
  script_set_attribute(attribute:"patch_publication_date", value:"2024/12/14");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'gir1.2-gst-plugins-base-1.0', 'reference': '1.22.0-3+deb12u3'},
    {'release': '12.0', 'prefix': 'gstreamer1.0-alsa', 'reference': '1.22.0-3+deb12u3'},
    {'release': '12.0', 'prefix': 'gstreamer1.0-gl', 'reference': '1.22.0-3+deb12u3'},
    {'release': '12.0', 'prefix': 'gstreamer1.0-plugins-base', 'reference': '1.22.0-3+deb12u3'},
    {'release': '12.0', 'prefix': 'gstreamer1.0-plugins-base-apps', 'reference': '1.22.0-3+deb12u3'},
    {'release': '12.0', 'prefix': 'gstreamer1.0-x', 'reference': '1.22.0-3+deb12u3'},
    {'release': '12.0', 'prefix': 'libgstreamer-gl1.0-0', 'reference': '1.22.0-3+deb12u3'},
    {'release': '12.0', 'prefix': 'libgstreamer-plugins-base1.0-0', 'reference': '1.22.0-3+deb12u3'},
    {'release': '12.0', 'prefix': 'libgstreamer-plugins-base1.0-dev', 'reference': '1.22.0-3+deb12u3'}
];
