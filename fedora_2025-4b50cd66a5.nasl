...
# extracted from Fedora Security Advisory FEDORA-2025-4b50cd66a5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-4b50cd66a5");
  script_xref(name:"IAVA", value:"2025-A-0146-S");

  script_name(english:"Fedora 40 : thunderbird (2025-4b50cd66a5)");
...
FEDORA-2025-4b50cd66a5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-4b50cd66a5");
...
var pkgs = [
    {'reference':'thunderbird-128.8.0-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
