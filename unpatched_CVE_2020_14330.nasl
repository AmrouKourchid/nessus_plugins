...
if (description)
{
  ...
  script_cve_id("CVE-2020-14330");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2020-14330");
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-14330");
