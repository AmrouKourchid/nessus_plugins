...
# extracted from Red Hat Security Advisory RHSA-2024:8130. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:8130");

  script_name(english:"RHEL 9 : python3.9 (RHSA-2024:8130)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5c319511");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:8130");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python3.9 package based on the guidance in RHSA-2024:8130.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python-unversioned-command-3.9.10-4.el9_0.6', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-3.9.10-4.el9_0.6', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-devel-3.9.10-4.el9_0.6', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-libs-3.9.10-4.el9_0.6', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-tkinter-3.9.10-4.el9_0.6', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python-unversioned-command / python3 / python3-devel / python3-libs / etc');
}
