...
# extracted from Fedora Security Advisory FEDORA-2023-f839113811
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-f839113811");

  script_name(english:"Fedora 37 : python-sentry-sdk (2023-f839113811)");
...
FEDORA-2023-f839113811 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-f839113811");
  script_set_attribute(attribute:"solution", value:
"Update the affected python-sentry-sdk package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:python-sentry-sdk");
...
var pkgs = [
    {'reference':'python-sentry-sdk-1.21.1-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python-sentry-sdk');
}
