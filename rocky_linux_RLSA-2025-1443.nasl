...
# Rocky Linux Security Advisory RLSA-2025:1443.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2025:1443");

  script_name(english:"RockyLinux 9 : nodejs:20 (RLSA-2025:1443)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2025:1443");
...
var appstreams = {
    'nodejs:20': [
      {'reference':'nodejs-nodemon-3.0.1-1.module+el9.4.0+25495+f51dca35', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
      {'reference':'nodejs-packaging-2021.06-4.module+el9.4.0+25495+f51dca35', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
      {'reference':'nodejs-packaging-bundler-2021.06-4.module+el9.4.0+25495+f51dca35', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'}
    ]
};
