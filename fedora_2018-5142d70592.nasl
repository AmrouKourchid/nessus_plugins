...
# extracted from Fedora Security Advisory FEDORA-2018-5142d70592.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : podman (2018-5142d70592)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-5142d70592");
...
flag = 0;
if (rpm_check(release:"FC27", reference:"podman-0.6.4-1.gitd5beb2f.fc27")) flag++;
