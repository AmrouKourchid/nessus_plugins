...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_4689.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4553283b");
...
"Update the RHEL openwsman package based on the guidance in RHSA-2020:4689.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libwsman-devel-2.6.5-7.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libwsman1-2.6.5-7.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openwsman-client-2.6.5-7.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openwsman-python3-2.6.5-7.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openwsman-server-2.6.5-7.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
