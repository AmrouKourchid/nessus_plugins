...
# extracted from Red Hat Security Advisory RHSA-2020:5055. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:5055");

  script_name(english:"RHEL 7 : buildah (RHSA-2020:5055)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_5055.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?445a87b0");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:5055");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1853652");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL buildah package based on the guidance in RHSA-2020:5055.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'buildah-1.11.6-12.el7_9', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'buildah-1.11.6-12.el7_9', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'buildah-1.11.6-12.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
