...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 20.04 LTS : OpenJDK vulnerability (USN-4892-1)");
...
referenced in the USN-4892-1 advisory.

    It was discovered that OpenJDK incorrectly verified Jar signatures. An attacker could possibly use this
    issue to bypass intended security restrictions when using Jar files signed with a disabled algorithm.
