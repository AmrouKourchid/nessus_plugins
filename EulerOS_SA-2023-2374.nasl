...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : c-ares (EulerOS-SA-2023-2374)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2374
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cbefdd62");
...
var pkgs = [
  "c-ares-1.16.1-1.h5.eulerosv2r10"
];
