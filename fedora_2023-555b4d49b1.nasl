...
# extracted from Fedora Security Advisory FEDORA-2023-555b4d49b1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-555b4d49b1");

  script_name(english:"Fedora 39 : python3.7 (2023-555b4d49b1)");
...
FEDORA-2023-555b4d49b1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-555b4d49b1");
...
var pkgs = [
    {'reference':'python3.7-3.7.17-4.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
