...
# extracted from Red Hat Security Advisory RHSA-2021:2365. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:2365");

  script_name(english:"RHEL 8 : libwebp (RHSA-2021:2365)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for libwebp.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2021:2365 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_2365.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?653b386b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:2365");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libwebp-1.0.0-4.el8_1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libwebp-devel-1.0.0-4.el8_1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
