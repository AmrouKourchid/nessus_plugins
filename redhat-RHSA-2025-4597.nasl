...
# extracted from Red Hat Security Advisory RHSA-2025:4597. The text
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2361633");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_4597.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?34a2f118");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:4597");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL mod_auth_openidc:2.3 package based on the guidance in RHSA-2025:4597.");
  ...
  'mod_auth_openidc:2.3': [
    {
      ...
      'pkgs': [
        ...
        {'reference':'mod_auth_openidc-2.4.9.4-8.module+el8.10.0+23056+decb09b1', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
