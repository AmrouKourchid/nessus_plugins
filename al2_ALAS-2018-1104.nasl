...
# extracted from Amazon Linux 2 Security Advisory ALAS-2018-1104.
#
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : mod_http2 (ALAS-2018-1104)");
...
connections. A possible mitigation is to not enable the h2
protocol.(CVE-2018-11763)");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2018-1104.html");
...
flag = 0;
if (rpm_check(release:"AL2", reference:"mod_http2-1.11.1-1.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"mod_http2-debuginfo-1.11.1-1.amzn2")) flag++;
