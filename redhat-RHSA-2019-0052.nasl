...
# extracted from Red Hat Security Advisory RHSA-2019:0052. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:0052");

  script_name(english:"RHEL 7 : redis (RHSA-2019:0052)");
...
referenced in the RHSA-2019:0052 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_0052.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a5490e1b");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:0052");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL redis package based on the guidance in RHSA-2019:0052.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'redis-3.0.6-4.el7ost', 'cpu':'x86_64', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
