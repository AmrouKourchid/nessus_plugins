...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : qt (EulerOS-SA-2020-1669)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1669
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?34007fa0");
...
"Update the affected qt package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-9541");
...
pkgs = ["qt-4.8.5-12.h7",
        "qt-devel-4.8.5-12.h7",
        "qt-mysql-4.8.5-12.h7",
        "qt-odbc-4.8.5-12.h7",
        "qt-postgresql-4.8.5-12.h7",
        "qt-x11-4.8.5-12.h7"];
