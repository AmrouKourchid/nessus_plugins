...
# extracted from Gentoo Linux Security Advisory GLSA 201811-11.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201811-11");

  script_name(english:"GLSA-201811-11 : Asterisk: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-201811-11
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/201811-11");
...
"All Asterisk users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-16671");
...
if (qpkg_check(package:"net-misc/asterisk", unaffected:make_list("ge 13.23.1"), vulnerable:make_list("lt 13.23.1"))) flag++;
