...
# extracted from Red Hat Security Advisory RHSA-2024:0764. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:0764");

  script_name(english:"RHEL 8 : container-tools:rhel8 (RHSA-2024:0764)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for container-tools:rhel8.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:0764 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ff4dbb5e");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0764");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL container-tools:rhel8 package based on the guidance in RHSA-2024:0764.");
  ...
  'container-tools:rhel8': [
    {
      ...
      'pkgs': [
        ...
        {'reference':'podman-4.2.0-1.module+el8.6.0+21266+3e24c7b3', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'podman-catatonit-4.2.0-1.module+el8.6.0+21266+3e24c7b3', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'podman-docker-4.2.0-1.module+el8.6.0+21266+3e24c7b3', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'podman-gvproxy-4.2.0-1.module+el8.6.0+21266+3e24c7b3', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'podman-plugins-4.2.0-1.module+el8.6.0+21266+3e24c7b3', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'podman-remote-4.2.0-1.module+el8.6.0+21266+3e24c7b3', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'podman-tests-4.2.0-1.module+el8.6.0+21266+3e24c7b3', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
