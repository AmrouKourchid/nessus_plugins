...
USN-4567-1 advisory.
    ...
    It was discovered that OpenDMARC is prone to a signature-bypass vulnerability with multiple From:
    addresses. An attacker could use it to bypass spam and abuse filters.
