...
# extracted from Red Hat Security Advisory RHSA-2019:1819. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:1819");

  script_name(english:"RHEL 7 : rh-redis5-redis (RHSA-2019:1819)");
...
referenced in the RHSA-2019:1819 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_1819.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?61b79bb4");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:1819");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rh-redis5-redis package based on the guidance in RHSA-2019:1819.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-redis5-redis-5.0.5-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
