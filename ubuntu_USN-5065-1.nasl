...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS : Open vSwitch vulnerability (USN-5065-1)");
...
USN-5065-1 advisory.
    ...
    It was discovered that Open vSwitch incorrectly handled decoding RAW_ENCAP actions. A remote attacker
