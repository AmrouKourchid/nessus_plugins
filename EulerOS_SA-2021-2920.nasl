...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : shim (EulerOS-SA-2021-2920)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2920
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5a858333");
...
var pkgs = [
  ...
  "shim-aa64-storage-15-19.h7.eulerosv2r9"
];
