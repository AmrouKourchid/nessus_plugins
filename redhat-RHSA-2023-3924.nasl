...
# extracted from Red Hat Security Advisory RHSA-2023:3924. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2023-3089");
  script_xref(name:"RHSA", value:"2023:3924");

  script_name(english:"RHEL 8 / 9 : OpenShift Container Platform 4.12.23 (RHSA-2023:3924)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for OpenShift Container Platform 4.12.23.");
...
in the RHSA-2023:3924 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.12.23. See the
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/OCPBUGS-15554");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_3924.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?eb8d9738");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:3924");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.12.23 package based on the guidance in RHSA-2023:3924.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:C/I:N/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:N/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-3089");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openshift-ansible-4.12.0-202306230041.p0.g74dc7b3.assembly.stream.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'openshift-ansible-test-4.12.0-202306230041.p0.g74dc7b3.assembly.stream.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'openshift-hyperkube-4.12.0-202306251254.p0.gc43ddea.assembly.stream.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'openshift-hyperkube-4.12.0-202306251254.p0.gc43ddea.assembly.stream.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'openshift-ansible / openshift-ansible-test / openshift-hyperkube');
}
