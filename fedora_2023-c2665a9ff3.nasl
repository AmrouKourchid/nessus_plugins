...
# extracted from Fedora Security Advisory FEDORA-2023-c2665a9ff3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-c2665a9ff3");
  script_xref(name:"IAVB", value:"2023-B-0070-S");

  script_name(english:"Fedora 39 : ghostscript (2023-c2665a9ff3)");
...
FEDORA-2023-c2665a9ff3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-c2665a9ff3");
...
var pkgs = [
    {'reference':'ghostscript-10.01.2-4.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
