...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Libssh2 PHSA-2019-2.0-0196");
...
if (rpm_exists(rpm:'libssh2-1.9', release:'PhotonOS-2.0') && rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libssh2-1.9.0-2.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libssh2-debuginfo-1.9.0-2.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libssh2-devel-1.9.0-2.ph2')) flag++;
