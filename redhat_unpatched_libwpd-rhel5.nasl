...
# extracted from Red Hat Security Advisory libwpd. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2017-14226", "CVE-2018-19208");

  script_name(english:"RHEL 5 : libwpd (Unpatched Vulnerability) (deprecated)");
