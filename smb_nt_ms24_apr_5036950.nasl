...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5036932");
  script_xref(name:"MSKB", value:"5036950");
  script_xref(name:"MSFT", value:"MS24-5036932");
  script_xref(name:"MSFT", value:"MS24-5036950");
  script_xref(name:"IAVA", value:"2024-A-0227-S");
  script_xref(name:"IAVA", value:"2024-A-0228-S");

  script_name(english:"KB5036950: Windows Server 2008 Security Update (April 2024)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5036950. It is, therefore, affected by multiple vulnerabilities
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5036932");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5036950");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5036950 or Cumulative Update 5036932");
...
if (
  smb_check_rollup(os:'6.0',
                   ...
                   rollup_date:'04_2024',
                   bulletin:bulletin,
                   rollup_kb_list:[5036950, 5036932])
)
{
