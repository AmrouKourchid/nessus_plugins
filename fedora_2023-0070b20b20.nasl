...
# extracted from Fedora Security Advisory FEDORA-2023-0070b20b20
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-0070b20b20");

  script_name(english:"Fedora 38 : cpp-httplib (2023-0070b20b20)");
...
FEDORA-2023-0070b20b20 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-0070b20b20");
...
var pkgs = [
    {'reference':'cpp-httplib-0.12.5-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
