...
# extracted from Fedora Security Advisory FEDORA-2023-e295804b3d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-e295804b3d");

  script_name(english:"Fedora 37 : amanda (2023-e295804b3d)");
...
FEDORA-2023-e295804b3d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-e295804b3d");
...
var pkgs = [
    {'reference':'amanda-3.5.3-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
