...
if (description)
{
  ...
  script_cve_id("CVE-2017-6440");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2017-6440");
...
patch available.
  ...
  - The parse_data_node function in bplist.c in libimobiledevice libplist 1.12 allows local users to cause a
    denial of service (memory allocation error) via a crafted plist file. (CVE-2017-6440)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-6440");
