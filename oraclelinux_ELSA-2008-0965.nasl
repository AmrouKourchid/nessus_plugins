...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : lynx (ELSA-2008-0965)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2008-0965.html");
...
"Update the affected lynx package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2008-4690");
...
var pkgs = [
    {'reference':'lynx-2.8.5-28.1.el5_2.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'lynx-2.8.5-28.1.el5_2.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
