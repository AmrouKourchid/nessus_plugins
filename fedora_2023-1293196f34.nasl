...
# extracted from Fedora Security Advisory FEDORA-2023-1293196f34
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-1293196f34");

  script_name(english:"Fedora 36 : amanda (2023-1293196f34)");
...
FEDORA-2023-1293196f34 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-1293196f34");
...
var pkgs = [
    {'reference':'amanda-3.5.3-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
