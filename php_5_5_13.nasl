...
if (description)
{
  ...
  script_name(english:"PHP 5.5.x < 5.5.13 'src/cdf.c' Multiple Vulnerabilities");
...
remote host is a version prior to 5.5.13. It is, therefore, affected
...
instead relied only on the application's self-reported version number.");
  script_set_attribute(attribute:"see_also", value:"http://www.php.net/ChangeLog-5.php#5.5.13");
