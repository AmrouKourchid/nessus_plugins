...
"The remote Red Hat host is missing a security update for PyXML.");
...
in the RHSA-2010:0002 advisory.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2010/rhsa-2010_0002.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dd06f114");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=531697");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2010:0002");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL PyXML package based on the guidance in RHSA-2010:0002.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'PyXML-0.8.3-6.el4_8.2', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'PyXML-0.8.3-6.el4_8.2', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'PyXML-0.8.3-6.el4_8.2', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'PyXML-0.8.3-6.el4_8.2', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'PyXML-0.8.3-6.el4_8.2', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'PyXML-0.8.4-4.el5_4.2', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'PyXML-0.8.4-4.el5_4.2', 'cpu':'ppc', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'PyXML-0.8.4-4.el5_4.2', 'cpu':'s390x', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'PyXML-0.8.4-4.el5_4.2', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
