...
# extracted from Red Hat Security Advisory RHSA-2024:6775. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:6775");

  script_name(english:"RHEL 9 : Red Hat OpenStack Platform 18.0 (python-webob) (RHSA-2024:6775)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for Red Hat OpenStack Platform 18.0 (python-webob).");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_6775.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a22082d5");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:6775");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat OpenStack Platform 18.0 (python-webob) package based on the guidance in RHSA-2024:6775.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-webob-1.8.7-3.el9ost', 'release':'9', 'el_string':'el9ost', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
