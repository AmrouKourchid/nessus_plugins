...
# extracted from Red Hat Security Advisory RHSA-2024:2568. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2568");

  script_name(english:"RHEL 9 : grafana (RHSA-2024:2568)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for grafana.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:2568 advisory.
    ...
    * grafana: golang-fips/openssl: Memory leaks in code encrypting and decrypting RSA payloads
    (CVE-2024-1394)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2568.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d2bc5906");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2568");
...
"Update the RHEL grafana package based on the guidance in RHSA-2024:2568.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'grafana-9.2.10-16.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'grafana-selinux-9.2.10-16.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'grafana-9.2.10-16.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'grafana-selinux-9.2.10-16.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
