...
# extracted from Fedora Security Advisory FEDORA-2023-ebbe7e9887
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-ebbe7e9887");

  script_name(english:"Fedora 37 : netconsd (2023-ebbe7e9887)");
...
FEDORA-2023-ebbe7e9887 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-ebbe7e9887");
...
var pkgs = [
    {'reference':'netconsd-0.4-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
