...
# extracted from Oracle Linux Security Advisory ELSA-2023-7500.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : thunderbird (ELSA-2023-7500)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-7500.html");
...
var pkgs = [
    {'reference':'thunderbird-115.5.0-1.0.1.el8_9', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'thunderbird-115.5.0-1.0.1.el8_9', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
