...
# SUSE update advisory SUSE-SU-2022:2870-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:2870-1");

  script_name(english:"SUSE SLES15 Security Update : rubygem-rails-html-sanitizer (SUSE-SU-2022:2870-1)");
...
in the SUSE-SU-2022:2870-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1201183");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2022-32209");
  # https://lists.suse.com/pipermail/sle-security-updates/2022-August/011964.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?17d44435");
  script_set_attribute(attribute:"solution", value:
"Update the affected ruby2.5-rubygem-rails-html-sanitizer package.");
...
var pkgs = [
    {'reference':'ruby2.5-rubygem-rails-html-sanitizer-1.0.4-150000.4.3.1', 'sp':'0', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15']},
    {'reference':'ruby2.5-rubygem-rails-html-sanitizer-1.0.4-150000.4.3.1', 'sp':'1', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.1']},
    {'reference':'ruby2.5-rubygem-rails-html-sanitizer-1.0.4-150000.4.3.1', 'sp':'2', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.2']},
    {'reference':'ruby2.5-rubygem-rails-html-sanitizer-1.0.4-150000.4.3.1', 'sp':'3', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.3']},
    {'reference':'ruby2.5-rubygem-rails-html-sanitizer-1.0.4-150000.4.3.1', 'sp':'4', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.4']},
    {'reference':'ruby2.5-rubygem-rails-html-sanitizer-1.0.4-150000.4.3.1', 'sp':'0', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15', 'sle-ha-release-15', 'sles-release-15']},
    {'reference':'ruby2.5-rubygem-rails-html-sanitizer-1.0.4-150000.4.3.1', 'sp':'1', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.1', 'sle-ha-release-15.1', 'sles-release-15.1']},
    {'reference':'ruby2.5-rubygem-rails-html-sanitizer-1.0.4-150000.4.3.1', 'sp':'2', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.2', 'sle-ha-release-15.2', 'sles-release-15.2']},
    {'reference':'ruby2.5-rubygem-rails-html-sanitizer-1.0.4-150000.4.3.1', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.3', 'sle-ha-release-15.3', 'sles-release-15.3']},
    {'reference':'ruby2.5-rubygem-rails-html-sanitizer-1.0.4-150000.4.3.1', 'sp':'4', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.4', 'sle-ha-release-15.4', 'sles-release-15.4']}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'ruby2.5-rubygem-rails-html-sanitizer');
}
