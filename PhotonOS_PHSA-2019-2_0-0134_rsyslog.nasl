...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'rsyslog-8.26.0-7.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'rsyslog-debuginfo-8.26.0-7.ph2')) flag++;
