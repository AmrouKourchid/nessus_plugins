...
# extracted from Red Hat Security Advisory RHSA-2024:10982. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:10982");

  script_name(english:"RHEL 9 : ruby:3.1 (RHSA-2024:10982)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_10982.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a32ec5df");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:10982");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL ruby:3.1 package based on the guidance in RHSA-2024:10982.");
  ...
  'ruby:3.1': [
    {
      ...
      'pkgs': [
        {'reference':'ruby-3.1.2-141.1.module+el9.2.0+22640+f1bd3602', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ruby-bundled-gems-3.1.2-141.1.module+el9.2.0+22640+f1bd3602', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ruby-default-gems-3.1.2-141.1.module+el9.2.0+22640+f1bd3602', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ruby-devel-3.1.2-141.1.module+el9.2.0+22640+f1bd3602', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ruby-doc-3.1.2-141.1.module+el9.2.0+22640+f1bd3602', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ruby-libs-3.1.2-141.1.module+el9.2.0+22640+f1bd3602', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-bigdecimal-3.1.1-141.1.module+el9.2.0+22640+f1bd3602', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-bundler-2.3.7-141.1.module+el9.2.0+22640+f1bd3602', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-io-console-0.5.11-141.1.module+el9.2.0+22640+f1bd3602', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-irb-1.4.1-141.1.module+el9.2.0+22640+f1bd3602', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-json-2.6.1-141.1.module+el9.2.0+22640+f1bd3602', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-minitest-5.15.0-141.1.module+el9.2.0+22640+f1bd3602', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-mysql2-0.5.4-1.module+el9.1.0+15737+76195479', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-mysql2-doc-0.5.4-1.module+el9.1.0+15737+76195479', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-pg-1.3.5-1.module+el9.1.0+15737+76195479', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-pg-doc-1.3.5-1.module+el9.1.0+15737+76195479', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-power_assert-2.0.1-141.1.module+el9.2.0+22640+f1bd3602', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-psych-4.0.3-141.1.module+el9.2.0+22640+f1bd3602', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-rake-13.0.6-141.1.module+el9.2.0+22640+f1bd3602', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-rbs-2.1.0-141.1.module+el9.2.0+22640+f1bd3602', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-rdoc-6.4.0-141.1.module+el9.2.0+22640+f1bd3602', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-rexml-3.2.5-141.1.module+el9.2.0+22640+f1bd3602', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-rss-0.2.9-141.1.module+el9.2.0+22640+f1bd3602', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-test-unit-3.5.3-141.1.module+el9.2.0+22640+f1bd3602', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-typeprof-0.21.2-141.1.module+el9.2.0+22640+f1bd3602', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygems-3.3.7-141.1.module+el9.2.0+22640+f1bd3602', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygems-devel-3.3.7-141.1.module+el9.2.0+22640+f1bd3602', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
