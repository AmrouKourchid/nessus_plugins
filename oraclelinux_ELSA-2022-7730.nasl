...
# extracted from Oracle Linux Security Advisory ELSA-2022-7730.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : libldb (ELSA-2022-7730)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
ELSA-2022-7730 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2022-7730.html");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:python-ldb-devel-common");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:python3-ldb");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:python3-ldb-devel");
