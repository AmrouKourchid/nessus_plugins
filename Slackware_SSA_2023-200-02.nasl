...
# extracted from Slackware Security Advisory SSA:2023-200-02. The text
...
if (description)
{
  ...
  script_name(english:"Slackware Linux 15.0 / current openssh  Vulnerability (SSA:2023-200-02)");
...
referenced in the SSA:2023-200-02 advisory.
...
number.");
  # http://www.slackware.com/security/viewer.php?l=slackware-security&y=2023&m=slackware-security.429408
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?65b1abcf");
...
var flag = 0;
var constraints = [
    { 'fixed_version' : '9.3p2', 'product' : 'openssh', 'os_name' : 'Slackware Linux', 'os_version' : '15.0', 'service_pack' : '1_slack15.0', 'arch' : 'i586' },
    { 'fixed_version' : '9.3p2', 'product' : 'openssh', 'os_name' : 'Slackware Linux', 'os_version' : '15.0', 'service_pack' : '1_slack15.0', 'arch' : 'x86_64' },
    { 'fixed_version' : '9.3p2', 'product' : 'openssh', 'os_name' : 'Slackware Linux', 'os_version' : 'current', 'service_pack' : '1', 'arch' : 'i586' },
    { 'fixed_version' : '9.3p2', 'product' : 'openssh', 'os_name' : 'Slackware Linux', 'os_version' : 'current', 'service_pack' : '1', 'arch' : 'x86_64' }
];
