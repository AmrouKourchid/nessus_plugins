...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Rpm PHSA-2018-2.0-0108");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'rpm-4.13.0.2-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'rpm-build-4.13.0.2-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'rpm-debuginfo-4.13.0.2-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'rpm-devel-4.13.0.2-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'rpm-lang-4.13.0.2-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'rpm-libs-4.13.0.2-1.ph2')) flag++;
