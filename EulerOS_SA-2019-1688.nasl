...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : qt (EulerOS-SA-2019-1688)");
...
vulnerability :
  ...
  - An issue was discovered in Qt before 5.11.3. A
    malformed SVG image causes a segmentation fault in
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1688
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?35f1d410");
...
pkgs = ["qt-4.8.7-2.h3.eulerosv2r7",
        "qt-devel-4.8.7-2.h3.eulerosv2r7",
        "qt-mysql-4.8.7-2.h3.eulerosv2r7",
        "qt-odbc-4.8.7-2.h3.eulerosv2r7",
        "qt-postgresql-4.8.7-2.h3.eulerosv2r7",
        "qt-x11-4.8.7-2.h3.eulerosv2r7"];
