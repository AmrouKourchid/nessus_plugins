...
# extracted from Red Hat Security Advisory RHSA-2024:9923. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:9923");

  script_name(english:"RHEL 9 : python3.12-urllib3 (RHSA-2024:9923)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for python3.12-urllib3.");
...
the RHSA-2024:9923 advisory.

    urllib3 is a powerful, user-friendly HTTP client for Python. urllib3 brings many critical features that
    are missing from the Python standard libraries:
       Thread safety.
       Connection pooling.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_9923.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?303cbe47");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:9923");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python3.12-urllib3 package based on the guidance in RHSA-2024:9923.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:python3.12-urllib3");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3.12-urllib3-1.26.18-2.el9_4.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python3.12-urllib3');
}
