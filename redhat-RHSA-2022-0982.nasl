...
"The remote Red Hat host is missing one or more security updates for Red Hat OpenStack Platform 16.1 (python-twisted).");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_0982.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?701963a3");
...
"Update the RHEL Red Hat OpenStack Platform 16.1 (python-twisted) package based on the guidance in RHSA-2022:0982.");
