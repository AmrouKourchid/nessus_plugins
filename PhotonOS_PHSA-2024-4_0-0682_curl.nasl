...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Curl PHSA-2024-4.0-0682");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'curl-8.7.1-3.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'curl-devel-8.7.1-3.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'curl-libs-8.7.1-3.ph4')) flag++;
