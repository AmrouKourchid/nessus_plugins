...
# extracted from Ubuntu Security Notice USN-2343-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : NSS vulnerability (USN-2343-1)");
...
USN-2343-1 advisory.
    ...
    Tyson Smith and Jesse Schwartzentruber discovered that NSS contained a race condition when performing
    certificate validation. An attacker could use this issue to cause NSS to crash, resulting in a denial of
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2343-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'libnss3', 'pkgver': '2:3.15.4-1ubuntu7.1'},
    {'osver': '14.04', 'pkgname': 'libnss3-1d', 'pkgver': '2:3.15.4-1ubuntu7.1'},
    {'osver': '14.04', 'pkgname': 'libnss3-dev', 'pkgver': '2:3.15.4-1ubuntu7.1'},
    {'osver': '14.04', 'pkgname': 'libnss3-nssdb', 'pkgver': '2:3.15.4-1ubuntu7.1'},
    {'osver': '14.04', 'pkgname': 'libnss3-tools', 'pkgver': '2:3.15.4-1ubuntu7.1'}
];
