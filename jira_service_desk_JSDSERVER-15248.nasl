...
if (description)
{
  ...
  script_name(english:"Atlassian Jira Service Management Data Center and Server < 5.4.19 / 5.11.x < 5.12.6 (JSDSERVER-15248)");
...
is affected by a vulnerability as referenced in the JSDSERVER-15248 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://jira.atlassian.com/browse/JSDSERVER-15248");
...
var constraints = [
  { 'fixed_version' : '5.4.19', 'fixed_display' : '5.4.19 / 5.12.6' },
  { 'min_version' : '5.11.0', 'fixed_version' : '5.12.6' }
];
