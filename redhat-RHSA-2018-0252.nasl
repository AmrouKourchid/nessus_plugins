...
# extracted from Red Hat Security Advisory RHSA-2018:0252. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:0252");

  script_name(english:"RHEL 7 : collectd (RHSA-2018:0252)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for collectd.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2018:0252 advisory.
    ...
    * The csnmp_read_table function in the SNMP plugin of collectd, before version 5.6.3, is susceptible to a
    double free in a certain error case. This could lead to a crash. (CVE-2017-16820)
...
number.");
  ...
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_0252.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d0ae38b8");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:0252");
...
var constraints = [
  {
    ...
    'pkgs': [
      ...
      {'reference':'collectd-hugepages-5.7.2-3.el7ost', 'cpu':'x86_64', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
