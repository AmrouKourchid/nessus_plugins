...
# extracted from Fedora Security Advisory FEDORA-2023-ae340c92ea
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-ae340c92ea");

  script_name(english:"Fedora 37 : libspf2 (2023-ae340c92ea)");
...
FEDORA-2023-ae340c92ea advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-ae340c92ea");
  script_set_attribute(attribute:"solution", value:
"Update the affected libspf2 package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:libspf2");
...
var pkgs = [
    {'reference':'libspf2-1.2.11-11.20210922git4915c308.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
