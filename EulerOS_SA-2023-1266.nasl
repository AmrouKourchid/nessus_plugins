...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.2 : libgcrypt (EulerOS-SA-2023-1266)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the libgcrypt package installed, the EulerOS Virtualization installation on the remote host
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1266
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d7dcf5ea");
...
var pkgs = [
  "libgcrypt-1.5.3-14.h6.eulerosv2r7"
];
