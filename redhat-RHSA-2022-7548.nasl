...
# extracted from Red Hat Security Advisory RHSA-2022:7548. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:7548");

  script_name(english:"RHEL 8 : Image Builder (RHSA-2022:7548)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_7548.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?668b450c");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:7548");
  script_set_attribute(attribute:"solution", value:
"Update the affected weldr-client package.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'weldr-client-35.5-4.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'weldr-client');
}
