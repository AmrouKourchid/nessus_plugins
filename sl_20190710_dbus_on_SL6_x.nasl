...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : dbus on SL6.x i386/x86_64 (20190710)");
...
"Security Fix(es) :
  ...
  - dbus: DBusServer DBUS_COOKIE_SHA1 authentication bypass
    (CVE-2019-12749)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1907&L=SCIENTIFIC-LINUX-ERRATA&P=3832
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?817b56cd");
...
flag = 0;
if (rpm_check(release:"SL6", reference:"dbus-1.2.24-11.el6_10")) flag++;
if (rpm_check(release:"SL6", reference:"dbus-debuginfo-1.2.24-11.el6_10")) flag++;
if (rpm_check(release:"SL6", reference:"dbus-devel-1.2.24-11.el6_10")) flag++;
if (rpm_check(release:"SL6", reference:"dbus-doc-1.2.24-11.el6_10")) flag++;
if (rpm_check(release:"SL6", reference:"dbus-libs-1.2.24-11.el6_10")) flag++;
if (rpm_check(release:"SL6", reference:"dbus-x11-1.2.24-11.el6_10")) flag++;
