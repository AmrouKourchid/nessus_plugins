...
if (description)
{
  ...
  script_cve_id("CVE-2024-49890");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-49890");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: drm/amd/pm: ensure the fw_info is not
    null before using it This resolves the dereference null return value warning reported by Coverity.
    (CVE-2024-49890)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-49890");
