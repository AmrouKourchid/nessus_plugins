...
# extracted from Fedora Security Advisory FEDORA-2023-d28433ead1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-d28433ead1");

  script_name(english:"Fedora 38 : xen (2023-d28433ead1)");
...
FEDORA-2023-d28433ead1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-d28433ead1");
...
var pkgs = [
    {'reference':'xen-4.17.0-9.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
