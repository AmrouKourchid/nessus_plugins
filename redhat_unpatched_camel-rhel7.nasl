...
# extracted from Red Hat Security Advisory camel. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2017-7536");

  script_name(english:"RHEL 7 : camel (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:hibernate-validator");
