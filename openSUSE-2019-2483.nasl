...
# extracted from openSUSE Security Update openSUSE-2019-2483.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libssh2_org (openSUSE-2019-2483)");
...
if ( rpm_check(release:"SUSE15.1", reference:"libssh2-1-1.8.0-lp151.6.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libssh2-1-debuginfo-1.8.0-lp151.6.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libssh2-devel-1.8.0-lp151.6.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libssh2_org-debugsource-1.8.0-lp151.6.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libssh2-1-32bit-1.8.0-lp151.6.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libssh2-1-32bit-debuginfo-1.8.0-lp151.6.3.1") ) flag++;
