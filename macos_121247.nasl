...
if (description)
{
  ...
  script_xref(name:"APPLE-SA", value:"121247");
  ...
  script_name(english:"macOS 14.x < 14.7 Multiple Vulnerabilities (121247)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host is missing a macOS update that fixes multiple vulnerabilities");
  script_set_attribute(attribute:"description", value:
"The remote host is running a version of macOS / Mac OS X that is 14.x prior to 14.7. It is, therefore, affected by
multiple vulnerabilities:
  ...
  - An out-of-bounds read issue was addressed with improved input validation. This issue is fixed in iOS 17.7
    and iPadOS 17.7, visionOS 2, watchOS 11, macOS Sequoia 15, iOS 18 and iPadOS 18, macOS Sonoma 14.7, tvOS
    18. Processing a maliciously crafted file may lead to unexpected app termination. (CVE-2024-27880)
...
version number.");
  script_set_attribute(attribute:"see_also", value:"https://support.apple.com/en-us/121247");
  script_set_attribute(attribute:"solution", value:
"Upgrade to macOS 14.7 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:C/I:N/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:N/UI:R/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-44165");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2024-44126");
...
var constraints = [
  { 'fixed_version' : '14.7.0', 'min_version' : '14.0', 'fixed_display' : 'macOS Sonoma 14.7' }
];
