...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : xorg-x11-server (EulerOS-SA-2021-1991)");
...
following vulnerability :
  ...
  - A flaw was found in xorg-x11-server in versions before
    1.20.11. An integer underflow can occur in xserver
    which can lead to a local privilege escalation. The
    highest threat from this vulnerability is to data
    confidentiality and integrity as well as system
    availability.(CVE-2021-3472)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1991
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?695e9b0c");
...
pkgs = ["xorg-x11-server-Xephyr-1.20.1-4.h9.eulerosv2r8",
        "xorg-x11-server-Xorg-1.20.1-4.h9.eulerosv2r8",
        "xorg-x11-server-Xvfb-1.20.1-4.h9.eulerosv2r8",
        "xorg-x11-server-Xwayland-1.20.1-4.h9.eulerosv2r8",
        "xorg-x11-server-common-1.20.1-4.h9.eulerosv2r8"];
