...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : ICU vulnerabilities (USN-2605-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 14.04 LTS host has packages installed that are affected by multiple vulnerabilities as referenced in
the USN-2605-1 advisory.

    Pedro Ribeiro discovered that ICU incorrectly handled certain memory operations when processing data. If
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2605-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'icu-devtools', 'pkgver': '52.1-3ubuntu0.3'},
    {'osver': '14.04', 'pkgname': 'libicu-dev', 'pkgver': '52.1-3ubuntu0.3'},
    {'osver': '14.04', 'pkgname': 'libicu52', 'pkgver': '52.1-3ubuntu0.3'}
];
