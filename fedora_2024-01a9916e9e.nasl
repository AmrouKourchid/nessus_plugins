...
# extracted from Fedora Security Advisory FEDORA-2024-01a9916e9e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-01a9916e9e");

  script_name(english:"Fedora 40 : xorg-x11-server-Xwayland (2024-01a9916e9e)");
...
FEDORA-2024-01a9916e9e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-01a9916e9e");
...
var pkgs = [
    {'reference':'xorg-x11-server-Xwayland-23.2.6-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
