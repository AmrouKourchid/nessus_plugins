...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_0220.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0368e99a");
...
"Update the RHEL sudo package based on the guidance in RHSA-2021:0220.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'sudo-1.8.25p1-8.el8_1.2', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
