...
# extracted from Fedora Security Advisory FEDORA-2023-c93631749b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-c93631749b");

  script_name(english:"Fedora 37 : chromium (2023-c93631749b)");
...
FEDORA-2023-c93631749b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-c93631749b");
...
var pkgs = [
    {'reference':'chromium-112.0.5615.49-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
