...
# extracted from Ubuntu Security Notice USN-5707-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5707-1");

  script_name(english:"Ubuntu 16.04 ESM : Libtasn1 vulnerability (USN-5707-1)");
...
USN-5707-1 advisory.
    ...
    It was discovered that Libtasn1 did not properly perform bounds checking. An attacker could possibly use
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5707-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libtasn1-3-bin', 'pkgver': '4.7-3ubuntu0.16.04.3+esm3', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libtasn1-6', 'pkgver': '4.7-3ubuntu0.16.04.3+esm3', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libtasn1-6-dev', 'pkgver': '4.7-3ubuntu0.16.04.3+esm3', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libtasn1-bin', 'pkgver': '4.7-3ubuntu0.16.04.3+esm3', 'ubuntu_pro': TRUE}
];
