...
# extracted from Fedora Security Advisory FEDORA-2021-cc3ff94cfc
#
...
if (description)
{
  ...
  script_name(english:"Fedora 33 : python3.8 (2021-cc3ff94cfc)");
...
FEDORA-2021-cc3ff94cfc advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-cc3ff94cfc");
...
pkgs = [
    {'reference':'python3.8-3.8.7-2.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
