...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5002029");
  script_xref(name:"MSFT", value:"MS21-5002029");
  script_xref(name:"IAVA", value:"2021-A-0469-S");

  script_name(english:"Security Updates for Microsoft Sharepoint Server 2016 (October 2021)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002029");
