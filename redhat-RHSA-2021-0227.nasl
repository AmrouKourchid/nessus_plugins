...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_0227.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c447c13e");
...
"Update the RHEL sudo package based on the guidance in RHSA-2021:0227.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'sudo-1.8.6p3-29.el6_10.4', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sudo-1.8.6p3-29.el6_10.4', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sudo-1.8.6p3-29.el6_10.4', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sudo-devel-1.8.6p3-29.el6_10.4', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sudo-devel-1.8.6p3-29.el6_10.4', 'cpu':'s390', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sudo-devel-1.8.6p3-29.el6_10.4', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sudo-devel-1.8.6p3-29.el6_10.4', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
