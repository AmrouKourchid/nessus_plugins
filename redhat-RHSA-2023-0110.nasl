...
# extracted from Red Hat Security Advisory RHSA-2023:0110. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:0110");

  script_name(english:"RHEL 8 : sqlite (RHSA-2023:0110)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for sqlite.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2023:0110 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_0110.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b452300d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2110291");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:0110");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL sqlite package based on the guidance in RHSA-2023:0110.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'lemon-3.26.0-17.el8_7', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sqlite-3.26.0-17.el8_7', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sqlite-devel-3.26.0-17.el8_7', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sqlite-doc-3.26.0-17.el8_7', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sqlite-libs-3.26.0-17.el8_7', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
