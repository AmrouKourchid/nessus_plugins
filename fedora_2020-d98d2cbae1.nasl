...
# extracted from Fedora Security Advisory FEDORA-2020-d98d2cbae1.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-d98d2cbae1");

  script_name(english:"Fedora 30 : clamav (2020-d98d2cbae1)");
...
"ClamAV 0.102.3 is a bug patch release to address the following issues.
  ...
  - CVE-2020-3327: Fix a vulnerability in the ARJ archive
    ...
    out-of-bounds read which causes a crash. Special thanks
    to Daehui Chang and Fady Othman for helping identify the
    ARJ parsing vulnerability.
...
----
  ...
  - Add upstream patch to fix 'Attempt to allocate 0 bytes'
    errors while scanning certain PDFs 

  - Do not log freshclam output to syslog by default -
    creates double entries in the journal (bz#1822012)

  - (#1820069) add try-restart clamav-freshclam.service on
    logrotate
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-d98d2cbae1");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"clamav-0.102.3-1.fc30")) flag++;
