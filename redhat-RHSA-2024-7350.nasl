...
# extracted from Red Hat Security Advisory RHSA-2024:7350. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:7350");

  script_name(english:"RHEL 9 : grafana-pcp (RHSA-2024:7350)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_7350.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d47fa8d1");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:7350");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL grafana-pcp package based on the guidance in RHSA-2024:7350.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'grafana-pcp-5.1.1-2.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
