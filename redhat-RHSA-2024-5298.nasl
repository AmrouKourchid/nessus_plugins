...
# extracted from Red Hat Security Advisory RHSA-2024:5298. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:5298");

  script_name(english:"RHEL 8 : gnome-shell (RHSA-2024:5298)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_5298.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c59cba9b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:5298");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL gnome-shell package based on the guidance in RHSA-2024:5298.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gnome-shell-3.32.2-56.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
