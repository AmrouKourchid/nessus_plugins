...
# SUSE update advisory SUSE-SU-2023:2123-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:2123-1");

  script_name(english:"SUSE SLES12 Security Update : dnsmasq (SUSE-SU-2023:2123-1)");
...
in the SUSE-SU-2023:2123-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-May/014781.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a4e99f30");
...
var pkgs = [
    {'reference':'dnsmasq-2.78-18.21.1', 'sp':'5', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5']},
    {'reference':'dnsmasq-2.78-18.21.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.5']}
];
