...
# AlmaLinux Security Advisory ALSA-2022:7548.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2022:7548");

  script_name(english:"AlmaLinux 8 : Image Builder (ALSA-2022:7548)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2022-7548.html");
