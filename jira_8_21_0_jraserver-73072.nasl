...
if (description)
{
  ...
  script_cve_id("CVE-2021-43944");

  script_name(english:"Atlassian Jira < 8.13.15 / 8.14.x < 8.20.3 / 8.21.0 (JRASERVER-73072)");
...
therefore, affected by a vulnerability as referenced in the JRASERVER-73072 advisory.

  - Template Injection in Email Templates leads to code execution on Jira Service Management Server -
    CVE-2021-43944 (CVE-2021-43944)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://jira.atlassian.com/browse/JRASERVER-73072");
...
"Upgrade to Atlassian Jira version 8.13.15, 8.20.3, 8.21.0 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-43944");
