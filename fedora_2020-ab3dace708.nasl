...
# extracted from Fedora Security Advisory FEDORA-2020-ab3dace708.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 33 : trousers (2020-ab3dace708)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-ab3dace708");
...
flag = 0;
if (rpm_check(release:"FC33", reference:"trousers-0.3.14-4.fc33")) flag++;
