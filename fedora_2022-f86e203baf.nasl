...
# extracted from Fedora Security Advisory FEDORA-2022-f86e203baf
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-f86e203baf");

  script_name(english:"Fedora 36 : grub2 (2022-f86e203baf)");
...
FEDORA-2022-f86e203baf advisory.

    - put the font back in /boot for now

    Yes, this bloats size by a couple meg.  Hopefully this won't cause problems for anyone and everyone can be
    okay with this CVE fix update.
    ...
    Two font-related CVE updates (CVE-2022-2601 and CVE-2022-3775).  For more information, see [upstream's
    disclosure](https://lists.gnu.org/archive/html/grub-devel/2022-11/msg00059.html) or the patches
    themselves.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-f86e203baf");
...
var pkgs = [
    {'reference':'grub2-2.06-57.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
