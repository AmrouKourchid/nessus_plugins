...
if (description)
{
  ...
  script_cve_id("CVE-2022-40681");
  script_xref(name:"IAVA", value:"2023-A-0643-S");

  script_name(english:"Fortinet FortiClient Arbitrary file deletion from unprivileged users (FG-IR-22-299)");
...
vulnerability as referenced in the FG-IR-22-299 advisory.

  - A incorrect authorization in Fortinet FortiClient (Windows) 7.0.0 - 7.0.7, 6.4.0 - 6.4.9, 6.2.0 - 6.2.9
    and 6.0.0 - 6.0.10 allows an attacker to cause denial of service via sending a crafted request to a
    specific named pipe. (CVE-2022-40681)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.fortiguard.com/psirt/FG-IR-22-299");
  script_set_attribute(attribute:"solution", value:
"Upgrade to FortiClient version 6.0.999999 / 6.2.999999 / 6.4.9 / 7.0.8 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-40681");
