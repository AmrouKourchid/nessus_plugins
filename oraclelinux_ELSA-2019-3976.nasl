...
# Oracle Linux Security Advisory ELSA-2019-3976 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : tcpdump (ELSA-2019-3976)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2019-3976.html");
...
var pkgs = [
    {'reference':'tcpdump-4.9.2-4.el7_7.1', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'14'},
