...
# extracted from VMware Security Advisory PHSA-2020-2.0-0279. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Net PHSA-2020-2.0-0279");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the net package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-2-279.md");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'net-snmp-5.7.3-15.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'net-snmp-devel-5.7.3-15.ph2')) flag++;
