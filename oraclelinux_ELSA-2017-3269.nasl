...
# extracted from Red Hat Security Advisory RHSA-2017:3269 and 
# Oracle Linux Security Advisory ELSA-2017-3269 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : procmail (ELSA-2017-3269)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2017-3269.html");
...
var pkgs = [
    {'reference':'procmail-3.22-36.el7_4.1', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'procmail-3.22-36.el7_4.1', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
];
