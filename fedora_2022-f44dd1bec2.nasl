...
# extracted from Fedora Security Advisory FEDORA-2022-f44dd1bec2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-f44dd1bec2");
  script_xref(name:"IAVA", value:"2023-A-0061-S");

  script_name(english:"Fedora 35 : python3.10 (2022-f44dd1bec2)");
...
FEDORA-2022-f44dd1bec2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-f44dd1bec2");
...
var pkgs = [
    {'reference':'python3.10-3.10.8-3.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
