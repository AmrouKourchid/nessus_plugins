...
# extracted from Fedora Security Advisory FEDORA-2025-82ba6b8dc5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-82ba6b8dc5");

  script_name(english:"Fedora 40 : chromium (2025-82ba6b8dc5)");
...
FEDORA-2025-82ba6b8dc5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-82ba6b8dc5");
...
var pkgs = [
    {'reference':'chromium-132.0.6834.159-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
