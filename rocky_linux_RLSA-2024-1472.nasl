...
# Rocky Linux Security Advisory RLSA-2024:1472.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2024:1472");

  script_name(english:"Rocky Linux 8 : go-toolset:rhel8 (RLSA-2024:1472)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Rocky Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Rocky Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
RLSA-2024:1472 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2024:1472");
...
var pkgs = [
    {'reference':'delve-1.20.2-1.module+el8.9.0+1392+c9f6376a', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'delve-debuginfo-1.20.2-1.module+el8.9.0+1392+c9f6376a', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'delve-debugsource-1.20.2-1.module+el8.9.0+1392+c9f6376a', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'go-toolset-1.20.12-1.module+el8.9.0+1725+0ed4fa7f', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'go-toolset-1.20.12-1.module+el8.9.0+1725+0ed4fa7f', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-1.20.12-3.module+el8.9.0+1764+12d15796', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-1.20.12-3.module+el8.9.0+1764+12d15796', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-bin-1.20.12-3.module+el8.9.0+1764+12d15796', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-bin-1.20.12-3.module+el8.9.0+1764+12d15796', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-docs-1.20.12-3.module+el8.9.0+1764+12d15796', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-misc-1.20.12-3.module+el8.9.0+1764+12d15796', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-src-1.20.12-3.module+el8.9.0+1764+12d15796', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-tests-1.20.12-3.module+el8.9.0+1764+12d15796', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
