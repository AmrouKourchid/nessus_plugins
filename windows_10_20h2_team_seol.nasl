...
if (description)
{
  ...
  script_name(english:"Microsoft Windows 10 20H2 Team SEoL");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Microsoft Windows is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"Microsoft Windows 10 20H2 Team is no longer maintained by its vendor or provider.

Lack of support implies that no new security patches for the product will be released by the vendor. As a result, it may
contain security vulnerabilities.");
  # https://learn.microsoft.com/en-us/lifecycle/announcements/windows-10-20h2-end-of-servicing
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d00dc6b9");
...
"Upgrade to a version of Microsoft Windows that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2022/05/10");
...
var os = ucf::get_os_cpe(vendor:'microsoft', product:'windows_10_20h2', type:'local');

var constraints = [
  { seol : 20220510, cpe_attributes : [{'edition': 'team*'}] }
];
