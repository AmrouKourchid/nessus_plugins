...
# extracted from Fedora Security Advisory FEDORA-2023-5225a85559
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-5225a85559");

  script_name(english:"Fedora 37 : godot (2023-5225a85559)");
...
FEDORA-2023-5225a85559 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-5225a85559");
...
var pkgs = [
    {'reference':'godot-4.1.2-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
