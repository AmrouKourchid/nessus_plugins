...
# extracted from Amazon Linux AMI Security Advisory ALAS-2023-1668.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux AMI : bcel (ALAS-2023-1668)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux AMI host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of bcel installed on the remote host is prior to 5.2-7.2.10. It is, therefore, affected by a vulnerability
as referenced in the ALAS-2023-1668 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/ALAS-2023-1668.html");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/cve/html/CVE-2022-42920.html");
  script_set_attribute(attribute:"solution", value:
"Run 'yum update bcel' to update your system.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:amazon:linux:bcel-manual");
...
var pkgs = [
    {'reference':'bcel-5.2-7.2.10.amzn1', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'bcel-javadoc-5.2-7.2.10.amzn1', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'bcel-manual-5.2-7.2.10.amzn1', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "bcel / bcel-javadoc / bcel-manual");
}
