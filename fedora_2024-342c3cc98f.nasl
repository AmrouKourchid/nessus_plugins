...
# extracted from Fedora Security Advisory FEDORA-2024-342c3cc98f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-342c3cc98f");

  script_name(english:"Fedora 41 : libreswan (2024-342c3cc98f)");
...
FEDORA-2024-342c3cc98f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-342c3cc98f");
...
var pkgs = [
    {'reference':'libreswan-4.15-2.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
