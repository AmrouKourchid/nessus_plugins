...
if (description)
{
  ...
  script_name(english:"CentOS 9 : libX11-1.7.0-9.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing one or more security updates for libX11.");
...
libX11-1.7.0-9.el9 build changelog.

  - out-of-bounds memory access in _XkbReadKeySyms() (CVE-2023-43785)

  - stack exhaustion from infinite recursion in PutSubImage() (CVE-2023-43786)

  - integer overflow in XCreateImage() leading to a heap overflow (CVE-2023-43787)

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=39543");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream libX11 package.");
