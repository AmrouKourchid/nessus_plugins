...
# extracted from Fedora Security Advisory FEDORA-2024-8c3476dd24
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-8c3476dd24");

  script_name(english:"Fedora 40 : mingw-libsoup (2024-8c3476dd24)");
...
FEDORA-2024-8c3476dd24 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-8c3476dd24");
...
var pkgs = [
    {'reference':'mingw-libsoup-2.74.3-8.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
