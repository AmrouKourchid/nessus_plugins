...
# extracted from VMware Security Advisory PHSA-2024-5.0-0422. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Glib PHSA-2024-5.0-0422");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the glib package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-5.0-422.md");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'glib-2.75.2-6.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'glib-devel-2.75.2-6.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'glib-schemas-2.75.2-6.ph5')) flag++;
