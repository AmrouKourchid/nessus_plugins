...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"RHSA-2020:5238");

  script_name(english:"Scientific Linux Security Update : thunderbird on SL6.x i686/x86_64 (2020:5238)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Scientific Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Scientific Linux 6 host has packages installed that are affected by multiple vulnerabilities as referenced in
the SLSA-2020:5238-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.scientificlinux.org/category/sl-errata/slsa-20205238-1");
...
pkgs = [
    {'reference':'thunderbird-78.5.0-1.el6_10', 'cpu':'i686', 'release':'SL6', 'allowmaj':TRUE},
    {'reference':'thunderbird-78.5.0-1.el6_10', 'cpu':'x86_64', 'release':'SL6', 'allowmaj':TRUE},
    {'reference':'thunderbird-debuginfo-78.5.0-1.el6_10', 'cpu':'x86_64', 'release':'SL6', 'allowmaj':TRUE}
];
