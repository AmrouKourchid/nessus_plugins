...
if (description)
{
  ...
  script_cve_id("CVE-2024-31882");
  script_xref(name:"IAVB", value:"2024-B-0119-S");

  script_name(english:"IBM DB2 DoS (7165338) (Unix)");

  script_set_attribute(attribute:"synopsis", value:
"The remote database server is affected by a denial of service vulnerability.");
  script_set_attribute(attribute:"description", value:
"According to its self-reported version number, IBM Db2 on Unix is vulnerable to a denial of service as the server may 
crash when using a specially crafted query on columnar tables in a database partitioned environment.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/node/7165338");
...
"Apply the appropriate IBM DB2 Fix Pack or Special Build based on the most recent fix pack level for your branch.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-31882");
...
var constraints = [
  {'equal':'11.1.4.7', 'fixed_build':'41497'},
  {'min_version':'11.1', 'fixed_version':'11.1.4.7', 'fixed_display':'11.1.4.7 + Special Build 41497'},
