...
# AlmaLinux Security Advisory ALSA-2024:8914.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:8914");
  script_xref(name:"RHSA", value:"2024:8914");

  script_name(english:"AlmaLinux 9 : libtiff (ALSA-2024:8914)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2024-8914.html");
...
var pkgs = [
    {'reference':'libtiff-4.4.0-12.el9_4.1', 'release':'9', 'el_string':'el9_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'libtiff-devel-4.4.0-12.el9_4.1', 'release':'9', 'el_string':'el9_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'libtiff-tools-4.4.0-12.el9_4.1', 'release':'9', 'el_string':'el9_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'}
];
