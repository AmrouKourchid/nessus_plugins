...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.2.0 : libvirt (EulerOS-SA-2020-1572)");
...
affected by the following vulnerability :
  ...
  - php_zip.c in the zip extension in PHP before 5.5.37,
    ...
    object.(CVE-2019-20485)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1572
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1b07d46b");
...
pkgs = ["libvirt-3.2.0-283",
        "libvirt-admin-3.2.0-283",
        "libvirt-client-3.2.0-283",
        "libvirt-daemon-3.2.0-283",
        "libvirt-daemon-config-network-3.2.0-283",
        "libvirt-daemon-config-nwfilter-3.2.0-283",
        "libvirt-daemon-driver-interface-3.2.0-283",
        "libvirt-daemon-driver-network-3.2.0-283",
        "libvirt-daemon-driver-nodedev-3.2.0-283",
        "libvirt-daemon-driver-nwfilter-3.2.0-283",
        "libvirt-daemon-driver-qemu-3.2.0-283",
        "libvirt-daemon-driver-secret-3.2.0-283",
        "libvirt-daemon-driver-storage-3.2.0-283",
        "libvirt-daemon-driver-storage-core-3.2.0-283",
        "libvirt-daemon-driver-storage-disk-3.2.0-283",
        "libvirt-daemon-driver-storage-iscsi-3.2.0-283",
        "libvirt-daemon-driver-storage-logical-3.2.0-283",
        "libvirt-daemon-driver-storage-mpath-3.2.0-283",
        "libvirt-daemon-driver-storage-scsi-3.2.0-283",
        "libvirt-daemon-kvm-3.2.0-283",
        "libvirt-devel-3.2.0-283",
        "libvirt-docs-3.2.0-283",
        "libvirt-libs-3.2.0-283"];
