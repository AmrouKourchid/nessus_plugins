...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Libtar PHSA-2024-5.0-0424");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'libtar-1.2.20-8.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'libtar-devel-1.2.20-8.ph5')) flag++;
