...
# extracted from ZTE advisory NS-SA-2020-0054. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 4.05 : python-twisted-web Vulnerability (NS-SA-2020-0054)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 4.05, has python-twisted-web packages installed that are affected by
a vulnerability:
...
number.");
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/notice/NS-SA-2020-0054");
...
pkgs = {
  'CGSL MAIN 4.05': [
    'python-twisted-web-8.2.0-6.el6_10'
  ]
};
