...
# extracted from Fedora Security Advisory FEDORA-2025-e694138ac5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-e694138ac5");
  script_xref(name:"IAVA", value:"2025-A-0206");

  script_name(english:"Fedora 40 : exim (2025-e694138ac5)");
...
FEDORA-2025-e694138ac5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-e694138ac5");
...
var pkgs = [
    {'reference':'exim-4.98.1-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
