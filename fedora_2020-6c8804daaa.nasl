...
# extracted from Fedora Security Advisory FEDORA-2020-6c8804daaa.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : mingw-openjpeg2 / openjpeg2 (2020-6c8804daaa)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-6c8804daaa");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"mingw-openjpeg2-2.3.1-5.fc30")) flag++;
if (rpm_check(release:"FC30", reference:"openjpeg2-2.3.1-4.fc30")) flag++;
