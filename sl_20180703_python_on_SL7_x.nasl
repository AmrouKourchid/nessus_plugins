...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : python on SL7.x x86_64 (20180703)");
...
cipher suites by default.");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1807&L=scientific-linux-errata&F=&S=&P=3097
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?907f7689");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"python-2.7.5-69.el7_5")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"python-debug-2.7.5-69.el7_5")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"python-debuginfo-2.7.5-69.el7_5")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"python-devel-2.7.5-69.el7_5")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"python-libs-2.7.5-69.el7_5")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"python-test-2.7.5-69.el7_5")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"python-tools-2.7.5-69.el7_5")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"tkinter-2.7.5-69.el7_5")) flag++;
