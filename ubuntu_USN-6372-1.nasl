...
# extracted from Ubuntu Security Notice USN-6372-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6372-1");

  script_name(english:"Ubuntu 16.04 ESM : DBus vulnerability (USN-6372-1)");
...
USN-6372-1 advisory.
    ...
    use this issue to cause DBus to crash, resulting in a denial of service.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6372-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'dbus', 'pkgver': '1.10.6-1ubuntu3.6+esm3', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'dbus-tests', 'pkgver': '1.10.6-1ubuntu3.6+esm3', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'dbus-user-session', 'pkgver': '1.10.6-1ubuntu3.6+esm3', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'dbus-x11', 'pkgver': '1.10.6-1ubuntu3.6+esm3', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libdbus-1-3', 'pkgver': '1.10.6-1ubuntu3.6+esm3', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libdbus-1-dev', 'pkgver': '1.10.6-1ubuntu3.6+esm3', 'ubuntu_pro': TRUE}
];
