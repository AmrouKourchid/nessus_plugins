...
if (description)
{
  ...
  script_name(english:"CentOS 9 : glib2-2.68.4-9.el9");
...
glib2-2.68.4-9.el9 build changelog.

  - Rejected reason: Rejected by upstream. (CVE-2023-24593, CVE-2023-25180)

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=33246");
...
var pkgs = [
    {'reference':'glib2-2.68.4-9.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'glib2-devel-2.68.4-9.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'glib2-doc-2.68.4-9.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'glib2-static-2.68.4-9.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'glib2-tests-2.68.4-9.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
