...
"The remote Red Hat host is missing one or more security updates for xpdf.");
...
referenced in the RHSA-2005:034 advisory.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2005/rhsa-2005_034.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?26794db6");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=135066");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=144197");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=145052");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=147498");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2005:034");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL xpdf package based on the guidance in RHSA-2005:034.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'xpdf-3.00-11.5', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'xpdf-3.00-11.5', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'xpdf-3.00-11.5', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'xpdf-3.00-11.5', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'xpdf-3.00-11.5', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
