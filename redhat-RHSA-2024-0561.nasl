...
# extracted from Red Hat Security Advisory RHSA-2024:0561. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2023-20569", "CVE-2023-20593");
  script_xref(name:"RHSA", value:"2024:0561");

  script_name(english:"RHEL 8 : linux-firmware (RHSA-2024:0561)");
...
referenced in the RHSA-2024:0561 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0561.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d028e883");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0561");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL linux-firmware package based on the guidance in RHSA-2024:0561.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'iwl100-firmware-39.31.5.1-105.el8_4.1', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2023-20569']},
      {'reference':'iwl1000-firmware-39.31.5.1-105.el8_4.1', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'cves':['CVE-2023-20569']},
      {'reference':'iwl105-firmware-18.168.6.1-105.el8_4.1', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2023-20569']},
      {'reference':'iwl135-firmware-18.168.6.1-105.el8_4.1', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2023-20569']},
      {'reference':'iwl2000-firmware-18.168.6.1-105.el8_4.1', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2023-20569']},
      {'reference':'iwl2030-firmware-18.168.6.1-105.el8_4.1', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2023-20569']},
      {'reference':'iwl3160-firmware-25.30.13.0-105.el8_4.1', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'cves':['CVE-2023-20569']},
      {'reference':'iwl3945-firmware-15.32.2.9-105.el8_4.1', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2023-20569']},
      {'reference':'iwl4965-firmware-228.61.2.24-105.el8_4.1', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2023-20569']},
      {'reference':'iwl5000-firmware-8.83.5.1_1-105.el8_4.1', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2023-20569']},
      {'reference':'iwl5150-firmware-8.24.2.2-105.el8_4.1', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2023-20569']},
      {'reference':'iwl6000-firmware-9.221.4.1-105.el8_4.1', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2023-20569']},
      {'reference':'iwl6000g2a-firmware-18.168.6.1-105.el8_4.1', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2023-20569']},
      {'reference':'iwl6000g2b-firmware-18.168.6.1-105.el8_4.1', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2023-20569']},
      {'reference':'iwl6050-firmware-41.28.5.1-105.el8_4.1', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2023-20569']},
      {'reference':'iwl7260-firmware-25.30.13.0-105.el8_4.1', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'cves':['CVE-2023-20569']},
      {'reference':'libertas-sd8686-firmware-20201218-105.git05789708.el8_4', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2023-20569']},
      {'reference':'libertas-sd8787-firmware-20201218-105.git05789708.el8_4', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2023-20569']},
      {'reference':'libertas-usb8388-firmware-20201218-105.git05789708.el8_4', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'cves':['CVE-2023-20569']},
      {'reference':'libertas-usb8388-olpc-firmware-20201218-105.git05789708.el8_4', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2023-20569']},
      {'reference':'linux-firmware-20201218-105.git05789708.el8_4', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2023-20569', 'CVE-2023-20593']}
    ]
  }
];
