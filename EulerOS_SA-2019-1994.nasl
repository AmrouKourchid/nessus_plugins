...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : util-linux (EulerOS-SA-2019-1994)");
...
vulnerability :
  ...
  - Buffer overflow in text-utils/colcrt.c in colcrt in
    util-linux before 2.27 allows local users to cause a
    denial of service (crash) via a crafted file, related
    to the page global variable.(CVE-2015-5218)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1994
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8b842811");
  script_set_attribute(attribute:"solution", value:
"Update the affected util-linux package.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:N/I:N/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-5218");
...
pkgs = ["libblkid-2.23.2-52.1.h7.eulerosv2r7",
        "libblkid-devel-2.23.2-52.1.h7.eulerosv2r7",
        "libmount-2.23.2-52.1.h7.eulerosv2r7",
        "libuuid-2.23.2-52.1.h7.eulerosv2r7",
        "libuuid-devel-2.23.2-52.1.h7.eulerosv2r7",
        "util-linux-2.23.2-52.1.h7.eulerosv2r7",
        "uuidd-2.23.2-52.1.h7.eulerosv2r7"];
