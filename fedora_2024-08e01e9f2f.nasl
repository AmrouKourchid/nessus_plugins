...
# extracted from Fedora Security Advisory FEDORA-2024-08e01e9f2f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-08e01e9f2f");
  script_xref(name:"IAVA", value:"2024-A-0067-S");

  script_name(english:"Fedora 40 : libxml2 (2024-08e01e9f2f)");
...
FEDORA-2024-08e01e9f2f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-08e01e9f2f");
...
var pkgs = [
    {'reference':'libxml2-2.12.7-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
