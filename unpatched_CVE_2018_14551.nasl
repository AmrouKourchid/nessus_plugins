...
if (description)
{
  ...
  script_cve_id("CVE-2018-14551");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2018-14551");
...
patch available.
  ...
  - The ReadMATImageV4 function in coders/mat.c in ImageMagick 7.0.8-7 uses an uninitialized variable, leading
    to memory corruption. (CVE-2018-14551)
