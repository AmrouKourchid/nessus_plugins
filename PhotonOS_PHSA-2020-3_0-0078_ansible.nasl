...
if (description)
{
  ...
  script_bugtraq_id(109361);
  script_xref(name:"IAVB", value:"2019-B-0092-S");
  script_xref(name:"IAVB", value:"2020-B-0016-S");

  script_name(english:"Photon OS 3.0: Ansible PHSA-2020-3.0-0078");
...
if (rpm_check(release:'PhotonOS-3.0', reference:'ansible-2.8.10-1.ph3')) flag++;
