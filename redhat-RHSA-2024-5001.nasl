...
# extracted from Red Hat Security Advisory RHSA-2024:5001. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2024-38473", "CVE-2024-39573");
  script_xref(name:"RHSA", value:"2024:5001");

  script_name(english:"RHEL 9 : httpd (RHSA-2024:5001)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for httpd.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:5001 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_5001.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2af5d4bb");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:5001");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL httpd package based on the guidance in RHSA-2024:5001.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2024-38473");

  script_set_attribute(attribute:"exploitability_ease", value:"Exploits are available");
  script_set_attribute(attribute:"exploit_available", value:"true");
  script_cwe_id(20, 116);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'httpd-2.4.53-11.el9_2.10', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'httpd-core-2.4.53-11.el9_2.10', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'httpd-devel-2.4.53-11.el9_2.10', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'httpd-filesystem-2.4.53-11.el9_2.10', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'httpd-manual-2.4.53-11.el9_2.10', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'httpd-tools-2.4.53-11.el9_2.10', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mod_ldap-2.4.53-11.el9_2.10', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mod_lua-2.4.53-11.el9_2.10', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mod_proxy_html-2.4.53-11.el9_2.10', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'mod_session-2.4.53-11.el9_2.10', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mod_ssl-2.4.53-11.el9_2.10', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
