...
# extracted from Red Hat Security Advisory RHSA-2024:4443. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:4443");

  script_name(english:"RHEL 9 : toolbox (RHSA-2024:4443)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for toolbox.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_4443.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2ff69220");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2163037");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:4443");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL toolbox package based on the guidance in RHSA-2024:4443.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'toolbox-0.0.99.4-1.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'toolbox-tests-0.0.99.4-1.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
