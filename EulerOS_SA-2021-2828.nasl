...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.0 : openssl (EulerOS-SA-2021-2828)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2828
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?aecf1d86");
...
var pkgs = [
  "openssl-1.0.2k-16.h14",
  "openssl-devel-1.0.2k-16.h14",
  "openssl-libs-1.0.2k-16.h14"
];
