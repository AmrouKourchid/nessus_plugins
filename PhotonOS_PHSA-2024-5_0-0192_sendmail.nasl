...
# extracted from VMware Security Advisory PHSA-2024-5.0-0192. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Sendmail PHSA-2024-5.0-0192");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the sendmail package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-5.0-192.md");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:vmware:photonos:sendmail");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'sendmail-8.18.0.2-1.ph5')) flag++;
