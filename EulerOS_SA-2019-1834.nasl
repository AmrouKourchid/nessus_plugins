...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : libtiff (EulerOS-SA-2019-1834)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1834
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a1e4a2ab");
...
"Update the affected libtiff package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-10779");
...
pkgs = ["libtiff-4.0.9-11.h6.eulerosv2r8",
        "libtiff-devel-4.0.9-11.h6.eulerosv2r8"];
