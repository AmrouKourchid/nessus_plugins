...
# extracted from Fedora Security Advisory FEDORA-2024-7ee01adadc
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-7ee01adadc");

  script_name(english:"Fedora 40 : koji (2024-7ee01adadc)");
...
FEDORA-2024-7ee01adadc advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-7ee01adadc");
...
"Update the affected koji package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-9427");
...
var pkgs = [
    {'reference':'koji-1.35.1-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
