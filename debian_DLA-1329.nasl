...
# extracted from Debian Security Advisory DLA-1329-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1329-1 : memcached security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2018/03/msg00031.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/wheezy/memcached");
...
flag = 0;
if (deb_check(release:"7.0", prefix:"memcached", reference:"1.4.13-0.2+deb7u4")) flag++;
