...
if (description)
{
  ...
  script_name(english:"CentOS 7 : cloud-init (RHSA-2020:3898)");
...
var pkgs = [
    {'reference':'cloud-init-19.4-7.el7.centos', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'cloud-init-19.4-7.el7.centos', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
