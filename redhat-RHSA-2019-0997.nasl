...
the RHSA-2019:0997 advisory.
    ...
    This package provides the python3 executable: the reference interpreter for the Python language, version
    3. The majority of its standard library is provided in the python3-libs package, which should be installed
    automatically along with python3. The remaining parts of the Python standard library are broken out into
    the python3-tkinter and python3-test packages.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_0997.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?60e4b7ec");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:0997");
...
"Update the RHEL python3 package based on the guidance in RHSA-2019:0997.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'platform-python-3.6.8-2.el8_0', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'platform-python-debug-3.6.8-2.el8_0', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'platform-python-devel-3.6.8-2.el8_0', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-idle-3.6.8-2.el8_0', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-libs-3.6.8-2.el8_0', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-test-3.6.8-2.el8_0', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-tkinter-3.6.8-2.el8_0', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
