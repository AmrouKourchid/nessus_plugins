...
# extracted from Fedora Security Advisory FEDORA-2022-78b18981a6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-78b18981a6");

  script_name(english:"Fedora 35 : kicad (2022-78b18981a6)");
...
FEDORA-2022-78b18981a6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-78b18981a6");
  script_set_attribute(attribute:"solution", value:
"Update the affected 1:kicad package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:kicad");
...
var pkgs = [
    {'reference':'kicad-6.0.2-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kicad');
}
