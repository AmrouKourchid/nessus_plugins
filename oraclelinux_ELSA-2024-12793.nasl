...
# extracted from Oracle Linux Security Advisory ELSA-2024-12793.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : edk2 (ELSA-2024-12793)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-12793.html");
...
var pkgs = [
    {'reference':'OVMF-1.7.1-3.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
