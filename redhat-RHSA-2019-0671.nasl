...
referenced in the RHSA-2019:0671 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_0671.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3d1d99d8");
  script_set_attribute(attribute:"see_also", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2019-10/");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:0671");
...
"Update the RHEL firefox package based on the guidance in RHSA-2019:0671.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-60.6.1-1.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
