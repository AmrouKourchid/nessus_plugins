...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : taglib (EulerOS-SA-2019-1662)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1662
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5286ae70");
...
pkgs = ["taglib-1.11.1-9.h1.eulerosv2r8"];
