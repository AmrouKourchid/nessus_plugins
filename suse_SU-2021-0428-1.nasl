...
# extracted from SUSE update advisory SUSE-SU-2021:0428-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : python36 (SUSE-SU-2021:0428-1)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?db50dfe7");
...
zypper in -t patch SUSE-SLE-SERVER-12-SP5-2021-428=1");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"5", reference:"libpython3_6m1_0-3.6.12-4.33.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libpython3_6m1_0-debuginfo-3.6.12-4.33.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"python36-3.6.12-4.33.3")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"python36-base-3.6.12-4.33.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"python36-base-debuginfo-3.6.12-4.33.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"python36-debuginfo-3.6.12-4.33.3")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"python36-debugsource-3.6.12-4.33.3")) flag++;
