...
# extracted from Red Hat Security Advisory RHSA-2020:4311. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:4311");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_4311.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a1e75450");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:4311");
...
"Update the RHEL firefox package based on the guidance in RHSA-2020:4311.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-78.4.0-1.el8_0', 'sp':'0', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-78.4.0-1.el8_0', 'sp':'0', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
