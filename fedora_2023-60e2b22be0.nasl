...
# extracted from Fedora Security Advisory FEDORA-2023-60e2b22be0
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-60e2b22be0");

  script_name(english:"Fedora 37 : python-setuptools (2023-60e2b22be0)");
...
FEDORA-2023-60e2b22be0 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-60e2b22be0");
...
var pkgs = [
    {'reference':'python-setuptools-62.6.0-3.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
