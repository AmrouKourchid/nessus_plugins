...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : ghostscript (EulerOS-SA-2025-1510)");
...
by the following vulnerabilities :
    ...
    An issue was discovered in Artifex Ghostscript before 10.05.0. A buffer overflow occurs when converting
    glyphs to Unicode in psi/zbfont.c.(CVE-2025-27835)

    An issue was discovered in Artifex Ghostscript before 10.05.0. The NPDL device has a Compression buffer
    overflow for contrib/japanese/gdevnpdl.c.(CVE-2025-27832)

    An issue was discovered in Artifex Ghostscript before 10.05.0. The BJ10V device has a Print buffer
    overflow in contrib/japanese/gdev10v.c.(CVE-2025-27836)
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1510
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dd64134f");
...
var pkgs = [
  "ghostscript-9.52-4.h15.eulerosv2r10",
  "ghostscript-help-9.52-4.h15.eulerosv2r10"
];
