...
# extracted from Fedora Security Advisory FEDORA-2023-0bd29e992b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-0bd29e992b");

  script_name(english:"Fedora 39 : python3.9 (2023-0bd29e992b)");
...
FEDORA-2023-0bd29e992b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-0bd29e992b");
...
var pkgs = [
    {'reference':'python3.9-3.9.18-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
