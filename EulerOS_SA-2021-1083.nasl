...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : libexif (EulerOS-SA-2021-1083)");
...
vulnerabilities :
  ...
  - In exif_data_save_data_entry of exif-data.c, there is a
    ...
    with no additional execution privileges needed. User
    interaction is needed for exploitation.(CVE-2020-0093)
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1083
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9be716d7");
