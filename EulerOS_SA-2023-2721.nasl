...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.1 : emacs (EulerOS-SA-2023-2721)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2721
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a2ce396f");
...
var pkgs = [
  "emacs-filesystem-27.2-3.h5.eulerosv2r11"
];
