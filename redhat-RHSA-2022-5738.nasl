...
# extracted from Red Hat Security Advisory RHSA-2022:5738. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:5738");

  script_name(english:"RHEL 8 : Django 3.2.14 Security Update (Important) (RHSA-2022:5738)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_5738.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5fa5fa16");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:5738");
  script_set_attribute(attribute:"solution", value:
"Update the affected python38-django package.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python38-django-3.2.14-3.el8ui', 'release':'8', 'el_string':'el8ui', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python38-django');
}
