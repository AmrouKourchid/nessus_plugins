...
# SUSE update advisory SUSE-SU-2025:1262-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2025:1262-1");

  script_name(english:"SUSE SLES15 Security Update : kernel (Live Patch 45 for SLE 15 SP3) (SUSE-SU-2025:1262-1)");
...
the SUSE-SU-2025:1262-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://lists.suse.com/pipermail/sle-updates/2025-April/039000.html");
...
"Update the affected kernel-livepatch-5_3_18-150300_59_164-default package.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '5.3.18-150300.59.164-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_3_18-150300_59_164-default-12-150300.2.1', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.3']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kernel-livepatch-5_3_18-150300_59_164-default');
}
