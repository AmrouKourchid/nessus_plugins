...
# extracted from Red Hat Security Advisory xfig. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 5 : xfig (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2010-4262");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2009-4228");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:transfig");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:xfig");
