...
if (description)
{
  ...
  script_cve_id("CVE-2022-49591");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-49591");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: net: dsa: microchip: ksz_common: Fix
    refcount leak bug In ksz_switch_register(), we should call of_node_put() for the reference returned by
    of_get_child_by_name() which has increased the refcount. (CVE-2022-49591)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-49591");
