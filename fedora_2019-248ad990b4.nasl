...
# extracted from Fedora Security Advisory FEDORA-2019-248ad990b4.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-248ad990b4");

  script_name(english:"Fedora 30 : aria2 (2019-248ad990b4)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"Fix Password leak for HTTP based authentication CVE-2019-3500 (rhbz
#1663991 #1663992 #1663993)

Note that Tenable Network Security has extracted the preceding
description block directly from the Fedora update system website.
Tenable has attempted to automatically clean and format it as much as
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-248ad990b4");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"aria2-1.34.0-4.fc30")) flag++;
