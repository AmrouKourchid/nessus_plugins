...
subject to the privileges of the web server user ID.");
  script_set_attribute(attribute:"see_also", value:"https://creative-solutions.net/joomla/creative-contact-form");
...
"Upgrade to Joomla! version 2.0.1 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-7969");
