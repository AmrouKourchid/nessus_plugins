...
# extracted from F5 Networks BIG-IP Solution K05112543.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2018-5542");

  script_name(english:"F5 Networks BIG-IP : HTTPS monitor vulnerability (K05112543)");

  script_set_attribute(attribute:"synopsis", value:
"The remote device is missing a vendor-supplied security patch.");
  script_set_attribute(attribute:"description", value:
"F5 BIG-IP 13.0.0-13.0.1, 12.1.0-12.1.3.6, or 11.2.1-11.6.3.2 HTTPS
...
are configured on the management interface (MGMT).");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K05112543");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K05112543.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:H/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-5542");
...
var vmatrix = {
  'AFM': {
    'affected': [
      '13.0.0-13.0.1','12.1.0-12.1.3','11.2.1-11.6.3'
    ],
    'unaffected': [
      '13.1.0'
    ],
