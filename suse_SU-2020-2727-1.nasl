...
# extracted from SUSE update advisory SUSE-SU-2020:2727-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : wavpack (SUSE-SU-2020:2727-1)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8683ddcb");
...
zypper in -t patch SUSE-SLE-SDK-12-SP5-2020-2727=1

SUSE Linux Enterprise Server 12-SP5 :

zypper in -t patch SUSE-SLE-SERVER-12-SP5-2020-2727=1");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"5", reference:"libwavpack1-4.60.99-5.6.3")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libwavpack1-debuginfo-4.60.99-5.6.3")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"wavpack-debuginfo-4.60.99-5.6.3")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"wavpack-debugsource-4.60.99-5.6.3")) flag++;
