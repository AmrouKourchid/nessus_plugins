...
if (description)
{
  ...
  script_cve_id("CVE-2024-49990");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-49990");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: drm/xe/hdcp: Check GSC structure
    validity Sometimes xe_gsc is not initialized when checked at HDCP capability check. Add gsc structure
    check to avoid null pointer error. (CVE-2024-49990)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-49990");
