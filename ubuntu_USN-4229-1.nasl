...
# extracted from Ubuntu Security Notice USN-4229-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"4229-1");

  script_name(english:"Ubuntu 16.04 LTS : NTP vulnerability (USN-4229-1)");
...
USN-4229-1 advisory.
    ...
    It was discovered that ntpq and ntpdc incorrectly handled some arguments. An attacker could possibly use
    this issue to cause ntpq or ntpdc to crash, execute arbitrary code, or escalate to higher privileges.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4229-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'ntp', 'pkgver': '1:4.2.8p4+dfsg-3ubuntu5.10'},
    {'osver': '16.04', 'pkgname': 'ntpdate', 'pkgver': '1:4.2.8p4+dfsg-3ubuntu5.10'}
];
