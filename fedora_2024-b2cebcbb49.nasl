...
# extracted from Fedora Security Advisory FEDORA-2024-b2cebcbb49
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-b2cebcbb49");

  script_name(english:"Fedora 40 : python3.14 (2024-b2cebcbb49)");
...
FEDORA-2024-b2cebcbb49 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-b2cebcbb49");
...
"Update the affected python3.14 package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:python3.14");
...
var pkgs = [
    {'reference':'python3.14-3.14.0~a2-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python3.14');
}
