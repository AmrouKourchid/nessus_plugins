...
# extracted from Fedora Security Advisory FEDORA-2019-17ed521527.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-17ed521527");

  script_name(english:"Fedora 30 : freeradius (2019-17ed521527)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-17ed521527");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"freeradius-3.0.20-1.fc30")) flag++;
