...
# extracted from Red Hat Security Advisory RHSA-2024:8081. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:8081");

  script_name(english:"RHEL 9 : OpenIPMI (RHSA-2024:8081)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_8081.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b59d6572");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:8081");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenIPMI package based on the guidance in RHSA-2024:8081.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'OpenIPMI-2.0.32-3.el9_2.3', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'OpenIPMI-devel-2.0.32-3.el9_2.3', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'OpenIPMI-lanserv-2.0.32-3.el9_2.3', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'OpenIPMI-libs-2.0.32-3.el9_2.3', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
