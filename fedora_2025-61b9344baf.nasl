...
# extracted from Fedora Security Advisory FEDORA-2025-61b9344baf
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-61b9344baf");

  script_name(english:"Fedora 40 : krb5 (2025-61b9344baf)");
...
FEDORA-2025-61b9344baf advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-61b9344baf");
...
var pkgs = [
    {'reference':'krb5-1.21.3-3.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
