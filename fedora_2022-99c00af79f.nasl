...
# extracted from Fedora Security Advisory FEDORA-2022-99c00af79f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-99c00af79f");

  script_name(english:"Fedora 35 : advancecomp (2022-99c00af79f)");
...
FEDORA-2022-99c00af79f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-99c00af79f");
...
var pkgs = [
    {'reference':'advancecomp-2.4-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
