...
# extracted from Ubuntu Security Notice USN-7043-3. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"7043-3");

  script_name(english:"Ubuntu 16.04 LTS : cups-filters vulnerability (USN-7043-3)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7043-3");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'cups-browsed', 'pkgver': '1.8.3-2ubuntu3.5+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'cups-filters', 'pkgver': '1.8.3-2ubuntu3.5+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'cups-filters-core-drivers', 'pkgver': '1.8.3-2ubuntu3.5+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libcupsfilters-dev', 'pkgver': '1.8.3-2ubuntu3.5+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libcupsfilters1', 'pkgver': '1.8.3-2ubuntu3.5+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libfontembed-dev', 'pkgver': '1.8.3-2ubuntu3.5+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libfontembed1', 'pkgver': '1.8.3-2ubuntu3.5+esm2', 'ubuntu_pro': TRUE}
];
