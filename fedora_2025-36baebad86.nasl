...
# extracted from Fedora Security Advisory FEDORA-2025-36baebad86
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-36baebad86");

  script_name(english:"Fedora 41 : python3.14 (2025-36baebad86)");
...
FEDORA-2025-36baebad86 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-36baebad86");
...
var pkgs = [
    {'reference':'python3.14-3.14.0~a4-2.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
