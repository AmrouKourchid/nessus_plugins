...
# extracted from Ubuntu Security Notice USN-6005-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6005-2");
  script_xref(name:"IAVA", value:"2023-A-0121-S");

  script_name(english:"Ubuntu 16.04 ESM : Sudo vulnerabilities (USN-6005-2)");
...
the USN-6005-2 advisory.

    USN-6005-1 fixed vulnerabilities in Sudo. This update provides the corresponding updates for Ubuntu 16.04
    LTS.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6005-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'sudo', 'pkgver': '1.8.16-0ubuntu1.10+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'sudo-ldap', 'pkgver': '1.8.16-0ubuntu1.10+esm2', 'ubuntu_pro': TRUE}
];
