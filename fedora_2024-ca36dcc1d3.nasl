...
# extracted from Fedora Security Advisory FEDORA-2024-ca36dcc1d3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-ca36dcc1d3");

  script_name(english:"Fedora 38 : chromium (2024-ca36dcc1d3)");
...
FEDORA-2024-ca36dcc1d3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-ca36dcc1d3");
...
var pkgs = [
    {'reference':'chromium-121.0.6167.139-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
