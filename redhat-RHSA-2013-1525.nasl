...
# extracted from Red Hat Security Advisory RHSA-2013:1525. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2013:1525");

  script_name(english:"RHEL 6 : openstack-glance (RHSA-2013:1525)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for openstack-glance.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 6 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2013:1525 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1019572");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2013/rhsa-2013_1525.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?23e500a5");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2013:1525");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL openstack-glance package based on the guidance in RHSA-2013:1525.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:S/C:P/I:N/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:L/UI:R/S:U/C:L/I:N/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-4428");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openstack-glance-2013.1.4-1.el6ost', 'release':'6', 'el_string':'el6ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'openstack-glance-doc-2013.1.4-1.el6ost', 'release':'6', 'el_string':'el6ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'python-glance-2013.1.4-1.el6ost', 'release':'6', 'el_string':'el6ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
