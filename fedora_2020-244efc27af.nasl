...
# extracted from Fedora Security Advisory FEDORA-2020-244efc27af.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-244efc27af");

  script_name(english:"Fedora 31 : glibc (2020-244efc27af)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"This update incorporates fixes from the upstream glibc 2.30 stable
release branch, including 3 fixes for medium severity security
vulnerabilities. (CVE-2020-10029, CVE-2020-1752, CVE-2020-1751)

Note that Tenable Network Security has extracted the preceding
description block directly from the Fedora update system website.
Tenable has attempted to automatically clean and format it as much as
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-244efc27af");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"glibc-2.30-11.fc31")) flag++;
