...
# extracted from Debian Security Advisory dla-3018. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-3018-1 : libpgjava - LTS security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 9 host has packages installed that are affected by a vulnerability as referenced in the dla-3018
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2022/dla-3018");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-21724");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/stretch/libpgjava");
...
var pkgs = [
    {'release': '9.0', 'prefix': 'libpostgresql-jdbc-java', 'reference': '9.4.1212-1+deb9u1'},
    {'release': '9.0', 'prefix': 'libpostgresql-jdbc-java-doc', 'reference': '9.4.1212-1+deb9u1'}
];
