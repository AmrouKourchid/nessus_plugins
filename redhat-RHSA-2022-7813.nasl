...
# extracted from Red Hat Security Advisory RHSA-2022:7813. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:7813");

  script_name(english:"RHEL 8 : mingw-zlib (RHSA-2022:7813)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for mingw-zlib.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2022:7813 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_7813.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?324f32b2");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:7813");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL mingw-zlib package based on the guidance in RHSA-2022:7813.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:mingw-zlib");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:mingw32-zlib");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:mingw32-zlib-static");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:mingw64-zlib");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:mingw64-zlib-static");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'mingw32-zlib-1.2.8-10.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mingw32-zlib-static-1.2.8-10.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mingw64-zlib-1.2.8-10.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mingw64-zlib-static-1.2.8-10.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'mingw32-zlib / mingw32-zlib-static / mingw64-zlib / etc');
}
