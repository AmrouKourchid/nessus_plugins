...
# extracted from Oracle Linux Security Advisory ELSA-2025-0845.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : git-lfs (ELSA-2025-0845)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2025-0845.html");
...
var pkgs = [
    {'reference':'git-lfs-3.4.1-4.el8_10', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'git-lfs-3.4.1-4.el8_10', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
