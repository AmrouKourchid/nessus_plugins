...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : haproxy (EulerOS-SA-2023-3031)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3031
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?db880da0");
...
var pkgs = [
  "haproxy-2.4.8-2.h6.eulerosv2r11"
];
