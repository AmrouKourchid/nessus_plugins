...
# AlmaLinux Security Advisory ALSA-2024:11232.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:11232");
  script_xref(name:"RHSA", value:"2024:11232");

  script_name(english:"AlmaLinux 9 : unbound:1.16.2 (ALSA-2024:11232)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2024-11232.html");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:11232");
...
var pkgs = [
    {'reference':'python3-unbound-1.16.2-8.el9_5.1', 'release':'9', 'el_string':'el9_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'unbound-1.16.2-8.el9_5.1', 'release':'9', 'el_string':'el9_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'unbound-devel-1.16.2-8.el9_5.1', 'release':'9', 'el_string':'el9_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'unbound-libs-1.16.2-8.el9_5.1', 'release':'9', 'el_string':'el9_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'}
];
