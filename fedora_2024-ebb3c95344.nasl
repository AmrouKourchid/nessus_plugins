...
# extracted from Fedora Security Advisory FEDORA-2024-ebb3c95344
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-ebb3c95344");

  script_name(english:"Fedora 38 : python3.6 (2024-ebb3c95344)");
...
FEDORA-2024-ebb3c95344 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-ebb3c95344");
...
var pkgs = [
    {'reference':'python3.6-3.6.15-27.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
