...
# extracted from Fedora Security Advisory FEDORA-2019-9c2ad3b018.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-9c2ad3b018");

  script_name(english:"Fedora 30 : php-symfony (2019-9c2ad3b018)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-9c2ad3b018");
...
"Update the affected php-symfony package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-18887");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"php-symfony-2.8.52-1.fc30")) flag++;
