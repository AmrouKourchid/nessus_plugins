...
# extracted from Fedora Security Advisory FEDORA-2023-31cf6a7a1e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-31cf6a7a1e");

  script_name(english:"Fedora 37 : cups-filters (2023-31cf6a7a1e)");
...
FEDORA-2023-31cf6a7a1e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-31cf6a7a1e");
...
var pkgs = [
    {'reference':'cups-filters-1.28.16-3.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
