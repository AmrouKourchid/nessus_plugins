...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Shadow PHSA-2018-2.0-0080");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the shadow package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-2-80.md");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'shadow-4.2.1-16.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'shadow-debuginfo-4.2.1-16.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'shadow-lang-4.2.1-16.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'shadow-tools-4.2.1-16.ph2')) flag++;
