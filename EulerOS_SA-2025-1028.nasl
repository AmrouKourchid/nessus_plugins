...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : python-dns (EulerOS-SA-2025-1028)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the python-dns package installed, the EulerOS installation on the remote host is affected
...
Tenable has extracted the preceding description block directly from the EulerOS python-dns security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1028
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?65763f88");
...
var pkgs = [
  "python3-dns-1.16.0-1.h2.eulerosv2r10"
];
