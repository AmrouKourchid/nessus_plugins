...
# extracted from Ubuntu Security Notice USN-7020-3. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"7020-3");

  script_name(english:"Ubuntu 24.04 LTS : Linux kernel vulnerabilities (USN-7020-3)");
...
the USN-7020-3 advisory.
    ...
    - IPv4 networking; (CVE-2024-42160, CVE-2024-42159, CVE-2024-42224, CVE-2024-41009, CVE-2024-42154,
    CVE-2024-42228)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7020-3");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-6.8.0-1012-raspi");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-7020-3');
}
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-7020-3');
  }
  else
  {
