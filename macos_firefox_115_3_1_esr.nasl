...
"The version of Firefox ESR installed on the remote macOS or Mac OS X host is prior to 115.3.1. It is, therefore,
...
mozilla_check_version(version:version, path:path, product:'firefox', esr:TRUE, fix:'115.3.1', min:'115.0.0', severity:SECURITY_HOLE);
