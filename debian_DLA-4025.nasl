...
# extracted from Debian Security Advisory dla-4025. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-4025 : redis - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has packages installed that are affected by a vulnerability as referenced in the dla-4025
advisory.
    ...
    garbage collector has been fixed in the keyvalue database Redis.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-46981");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'redis', 'reference': '5:6.0.16-1+deb11u5'},
    {'release': '11.0', 'prefix': 'redis-sentinel', 'reference': '5:6.0.16-1+deb11u5'},
    {'release': '11.0', 'prefix': 'redis-server', 'reference': '5:6.0.16-1+deb11u5'},
    {'release': '11.0', 'prefix': 'redis-tools', 'reference': '5:6.0.16-1+deb11u5'}
];
