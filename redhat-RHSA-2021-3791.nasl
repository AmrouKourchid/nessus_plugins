...
# extracted from Red Hat Security Advisory RHSA-2021:3791. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:3791");
  script_xref(name:"IAVA", value:"2021-A-0450-S");
  script_xref(name:"IAVA", value:"2021-A-0461-S");

  script_name(english:"RHEL 7 : firefox (RHSA-2021:3791)");
...
referenced in the RHSA-2021:3791 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_3791.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e81b125c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:3791");
...
"Update the RHEL firefox package based on the guidance in RHSA-2021:3791.");
  ...
  script_cwe_id(119, 120, 416, 1021);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-91.2.0-4.el7_9', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-91.2.0-4.el7_9', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-91.2.0-4.el7_9', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-91.2.0-4.el7_9', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-91.2.0-4.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
