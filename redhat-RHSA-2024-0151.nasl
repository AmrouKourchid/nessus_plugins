...
# extracted from Red Hat Security Advisory RHSA-2024:0151. The text
...
referenced in the RHSA-2024:0151 advisory.
    ...
    .NET SDK 7.0.115 and .NET Runtime 7.0.15.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0151.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1c5e3603");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0151");
...
"Update the RHEL .NET 7.0 package based on the guidance in RHSA-2024:0151.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'aspnetcore-runtime-7.0-7.0.15-1.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'aspnetcore-targeting-pack-7.0-7.0.15-1.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-apphost-pack-7.0-7.0.15-1.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-hostfxr-7.0-7.0.15-1.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-runtime-7.0-7.0.15-1.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-sdk-7.0-7.0.115-1.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-sdk-7.0-source-built-artifacts-7.0.115-1.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-targeting-pack-7.0-7.0.15-1.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-templates-7.0-7.0.115-1.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
