...
# SUSE update advisory SUSE-SU-2023:3981-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:3981-1");

  script_name(english:"SUSE SLES12 Security Update : poppler (SUSE-SU-2023:3981-1)");
...
referenced in the SUSE-SU-2023:3981-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-October/016549.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f6f081c1");
...
var pkgs = [
    {'reference':'libpoppler44-0.24.4-14.36.2', 'sp':'5', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5']},
    {'reference':'libpoppler44-0.24.4-14.36.2', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-sdk-release-12.5', 'sles-release-12.5']}
];
