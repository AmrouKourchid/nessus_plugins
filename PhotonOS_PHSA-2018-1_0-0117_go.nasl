...
# extracted from VMware Security Advisory PHSA-2018-1.0-0117. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Go PHSA-2018-1.0-0117");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the go package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-1.0-117.md");
...
if (rpm_check(release:"PhotonOS-1.0", reference:"go-1.9.4-1.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"go-debuginfo-1.9.4-1.ph1")) flag++;
