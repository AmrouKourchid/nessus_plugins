...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP12 : curl (EulerOS-SA-2024-2933)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2933
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c616a8f5");
...
var pkgs = [
  "curl-7.79.1-14.h30.eulerosv2r12",
  "libcurl-7.79.1-14.h30.eulerosv2r12"
];
