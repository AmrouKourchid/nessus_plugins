...
if (description)
{
  ...
  script_cve_id("CVE-2024-46835");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-46835");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: drm/amdgpu: Fix smatch static checker
    warning adev->gfx.imu.funcs could be NULL (CVE-2024-46835)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-46835");
