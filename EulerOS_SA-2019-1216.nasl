...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.4 : systemd (EulerOS-SA-2019-1216)");
...
the following vulnerability :
  ...
  - An out-of-bounds write flaw was found in the way
    systemd-resolved daemon handled processing of DNS
    responses. A remote attacker could potentially use this
    flaw to crash the daemon or execute arbitrary code in
    the context of the daemon process.i1/4^CVE-2017-9445i1/4%0

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1216
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?89365809");
...
pkgs = ["libgudev1-devel-219-57.h64",
        "systemd-219-57.h64",
