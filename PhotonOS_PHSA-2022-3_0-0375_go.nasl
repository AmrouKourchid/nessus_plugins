...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Go PHSA-2022-3.0-0375");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'go-1.17.2-5.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'go-md2man-2.0.0-12.ph3')) flag++;
