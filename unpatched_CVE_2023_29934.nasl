...
if (description)
{
  ...
  script_cve_id("CVE-2023-29934");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2023-29934");
...
patch available.
  ...
  - llvm-project commit 6c01b5c was discovered to contain a segmentation fault via the component
    mlir::Type::getDialect(). (CVE-2023-29934)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-29934");
