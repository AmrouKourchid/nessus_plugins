...
# extracted from Debian Security Advisory dla-3781. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3781 : libgd-dev - security update");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/libgd2");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2018-14553");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2021-38115");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2021-40812");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/libgd2");
...
"Upgrade the libgd-dev packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2018-14553");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libgd-dev', 'reference': '2.2.5-5.2+deb10u1'},
    {'release': '10.0', 'prefix': 'libgd-tools', 'reference': '2.2.5-5.2+deb10u1'},
    {'release': '10.0', 'prefix': 'libgd3', 'reference': '2.2.5-5.2+deb10u1'}
];
