...
# extracted from Fedora Security Advisory FEDORA-2022-71121c44a4
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-71121c44a4");

  script_name(english:"Fedora 36 : webkit2gtk3 (2022-71121c44a4)");
...
FEDORA-2022-71121c44a4 advisory.
     ...
     * Security fixes: CVE-2022-42852, CVE-2022-42856, CVE-2022-42867, CVE-2022-46692, CVE-2022-46698,
    CVE-2022-46699, CVE-2022-46700

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-71121c44a4");
...
var pkgs = [
    {'reference':'webkit2gtk3-2.38.3-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
