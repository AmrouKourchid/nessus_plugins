...
if (description)
{
  ...
  script_name(english:"Zoom Client for Meetings < 5.15.1 Vulnerability (ZSB-23025)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host has an application installed that is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Zoom Client for Meetings installed on the remote host is prior to 5.15.1. It is, therefore, affected by a
vulnerability as referenced in the ZSB-23025 advisory.

  - Exposure of information intended to be encrypted by some Zoom clients may lead to disclosure of sensitive
    information. (CVE-2023-36539)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://explore.zoom.us/en/trust/security/security-bulletin/?filter-cve=&filter=&keywords=ZSB-23025
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?46df297f");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Zoom Client for Meetings 5.15.1 or later.");
  script_set_attribute(attribute:"agent", value:"all");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:C/I:N/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:N/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-36539");
  ...
  script_dependencies("macosx_zoom_installed.nbin", "zoom_nix_installed.nbin");
...
var constraints = [
  { 'fixed_version' : '5.15.1', 'equal' : '5.15.0' }
];
