...
# extracted from Amazon Linux AMI Security Advisory ALAS-2023-1814.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux AMI : php71-pecl-imagick (ALAS-2023-1814)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux AMI host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of php71-pecl-imagick installed on the remote host is prior to 3.4.4-2.8. It is, therefore, affected by
multiple vulnerabilities as referenced in the ALAS-2023-1814 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/ALAS-2023-1814.html");
...
var pkgs = [
    {'reference':'php71-pecl-imagick-3.4.4-2.8.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'php71-pecl-imagick-3.4.4-2.8.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'php71-pecl-imagick-debuginfo-3.4.4-2.8.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'php71-pecl-imagick-debuginfo-3.4.4-2.8.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'php71-pecl-imagick-devel-3.4.4-2.8.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'php71-pecl-imagick-devel-3.4.4-2.8.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "php71-pecl-imagick / php71-pecl-imagick-debuginfo / php71-pecl-imagick-devel");
}
