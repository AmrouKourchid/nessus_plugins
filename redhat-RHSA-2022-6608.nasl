...
# extracted from Red Hat Security Advisory RHSA-2022:6608. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:6608");

  script_name(english:"RHEL 9 : dbus-broker (RHSA-2022:6608)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for dbus-broker.");
...
referenced in the RHSA-2022:6608 advisory.

    dbus-broker is an implementation of a message bus as defined by the D-Bus specification. Its aim is to
    provide high performance and reliability, while keeping compatibility to the D-Bus reference
    implementation. It is exclusively written for Linux systems, and makes use of many modern features
    provided by recent Linux kernel releases.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_6608.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7b417adf");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:6608");
...
"Update the RHEL dbus-broker package based on the guidance in RHSA-2022:6608.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:dbus-broker");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'dbus-broker-28-5.1.el9_0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'dbus-broker-28-5.1.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
