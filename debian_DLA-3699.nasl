...
# extracted from Debian Security Advisory dla-3699. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3699 : libde265-0 - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-49465");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-49467");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-49468");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libde265-0', 'reference': '1.0.11-0+deb10u6'},
    {'release': '10.0', 'prefix': 'libde265-dev', 'reference': '1.0.11-0+deb10u6'},
    {'release': '10.0', 'prefix': 'libde265-examples', 'reference': '1.0.11-0+deb10u6'}
];
