...
# extracted from Red Hat Security Advisory RHSA-2022:8869. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2022-0675");
  script_xref(name:"RHSA", value:"2022:8869");

  script_name(english:"RHEL 8 : Red Hat OpenStack Platform 16.1.9 (puppet-firewall) (RHSA-2022:8869)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for Red Hat OpenStack Platform 16.1.9 (puppet-firewall).");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8869.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?09585390");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8869");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2071567");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat OpenStack Platform 16.1.9 (puppet-firewall) package based on the guidance in RHSA-2022:8869.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-0675");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:puppet-firewall");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'puppet-firewall-3.4.0-1.94f707cgit.el8ost', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'puppet-firewall');
}
