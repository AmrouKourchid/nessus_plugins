...
# extracted from Red Hat Security Advisory RHSA-2023:5738. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:5738");
  script_xref(name:"IAVB", value:"2023-B-0080-S");
  script_xref(name:"CEA-ID", value:"CEA-2024-0004");
  script_xref(name:"IAVB", value:"2023-B-0083-S");

  script_name(english:"RHEL 9 : go-toolset and golang (RHSA-2023:5738)");
...
referenced in the RHSA-2023:5738 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_5738.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?74ae73be");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:5738");
...
"Update the RHEL go-toolset / golang packages based on the guidance in RHSA-2023:5738.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'golang-1.19.13-1.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-bin-1.19.13-1.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-docs-1.19.13-1.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-misc-1.19.13-1.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-race-1.19.13-1.el9_2', 'sp':'2', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-src-1.19.13-1.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-tests-1.19.13-1.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'golang-1.19.13-1.el9_2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-bin-1.19.13-1.el9_2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
