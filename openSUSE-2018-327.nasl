...
# extracted from openSUSE Security Update openSUSE-2018-327.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : memcached (openSUSE-2018-327)");
...
This update was imported from the SUSE:SLE-12:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1056865");
...
if ( rpm_check(release:"SUSE42.3", reference:"memcached-1.4.39-11.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"memcached-debuginfo-1.4.39-11.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"memcached-debugsource-1.4.39-11.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"memcached-devel-1.4.39-11.3.1") ) flag++;
