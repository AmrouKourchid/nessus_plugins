...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : syslinux (EulerOS-SA-2023-2826)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2826
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?655d475f");
...
var pkgs = [
  "syslinux-6.04-5.h4.eulerosv2r10",
  "syslinux-nonlinux-6.04-5.h4.eulerosv2r10"
];
