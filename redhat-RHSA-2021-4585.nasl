...
# extracted from Red Hat Security Advisory RHSA-2021:4585. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:4585");
  script_xref(name:"IAVA", value:"2021-A-0528");

  script_name(english:"RHEL 8 : gcc-toolset-10-gcc (RHSA-2021:4585)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for gcc-toolset-10-gcc.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2021:4585 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_4585.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?831d57dc");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:4585");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2005819");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL gcc-toolset-10-gcc package based on the guidance in RHSA-2021:4585.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:gcc-toolset-10-gcc");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:gcc-toolset-10-gcc-c++");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:gcc-toolset-10-gcc-gdb-plugin");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:gcc-toolset-10-gcc-gfortran");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:gcc-toolset-10-gcc-plugin-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:gcc-toolset-10-libasan-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:gcc-toolset-10-libatomic-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:gcc-toolset-10-libitm-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:gcc-toolset-10-liblsan-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:gcc-toolset-10-libquadmath-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:gcc-toolset-10-libstdc++-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:gcc-toolset-10-libstdc++-docs");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:gcc-toolset-10-libtsan-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:gcc-toolset-10-libubsan-devel");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gcc-toolset-10-gcc-10.3.1-1.2.el8_5', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gcc-toolset-10-gcc-c++-10.3.1-1.2.el8_5', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gcc-toolset-10-gcc-gdb-plugin-10.3.1-1.2.el8_5', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gcc-toolset-10-gcc-gfortran-10.3.1-1.2.el8_5', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gcc-toolset-10-gcc-plugin-devel-10.3.1-1.2.el8_5', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gcc-toolset-10-libasan-devel-10.3.1-1.2.el8_5', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gcc-toolset-10-libatomic-devel-10.3.1-1.2.el8_5', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gcc-toolset-10-libitm-devel-10.3.1-1.2.el8_5', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gcc-toolset-10-liblsan-devel-10.3.1-1.2.el8_5', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gcc-toolset-10-liblsan-devel-10.3.1-1.2.el8_5', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'gcc-toolset-10-libquadmath-devel-10.3.1-1.2.el8_5', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gcc-toolset-10-libquadmath-devel-10.3.1-1.2.el8_5', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gcc-toolset-10-libstdc++-devel-10.3.1-1.2.el8_5', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gcc-toolset-10-libstdc++-docs-10.3.1-1.2.el8_5', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gcc-toolset-10-libtsan-devel-10.3.1-1.2.el8_5', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gcc-toolset-10-libtsan-devel-10.3.1-1.2.el8_5', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gcc-toolset-10-libtsan-devel-10.3.1-1.2.el8_5', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gcc-toolset-10-libubsan-devel-10.3.1-1.2.el8_5', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libasan6-10.3.1-1.2.el8_5', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
