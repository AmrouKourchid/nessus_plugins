...
referenced in the RHSA-2005:788 advisory.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2005/rhsa-2005_788.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?32a8e894");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#critical");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=168078");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2005:788");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL HelixPlayer package based on the guidance in RHSA-2005:788.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2005-2922");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'HelixPlayer-1.0.6-0.EL4.1', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'HelixPlayer-1.0.6-0.EL4.1', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
