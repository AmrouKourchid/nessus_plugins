...
if (description)
{
  ...
  script_cve_id("CVE-2012-5639");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2012-5639");
...
patch available.
  ...
  - LibreOffice and OpenOffice automatically open embedded content (CVE-2012-5639)
