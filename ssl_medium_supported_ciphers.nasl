...
encryption if the attacker is on the same physical network.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?df5555f5");
...
var supported_ciphers = pp_info["ciphers"];
...
var report = cipher_report(supported_ciphers, eq:CIPHER_STRENGTH_MEDIUM);
if (isnull(report))
