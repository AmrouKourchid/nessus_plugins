...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.1 : python-paramiko (EulerOS-SA-2024-1616)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1616
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a1fda444");
...
var pkgs = [
  "python3-paramiko-2.8.1-2.h9.eulerosv2r11"
];
