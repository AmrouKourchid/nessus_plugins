...
# extracted from Fedora Security Advisory FEDORA-2024-992047a33f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-992047a33f");

  script_name(english:"Fedora 39 : python3.13 (2024-992047a33f)");
...
FEDORA-2024-992047a33f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-992047a33f");
...
var pkgs = [
    {'reference':'python3.13-3.13.0~rc1-3.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
