...
var appstreams = {
    'container-tools:4.0': [
      ...
      {'reference':'cockpit-podman-46-1.module+el8.7.0+20872+81cbf159', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'conmon-2.1.4-1.module+el8.7.0+20872+81cbf159', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'container-selinux-2.189.0-1.module+el8.7.0+20872+81cbf159', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      ...
      {'reference':'podman-docker-4.0.2-8.module+el8.7.0+20872+81cbf159', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      ...
      {'reference':'python3-podman-4.0.0-1.module+el8.7.0+20872+81cbf159', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'udica-0.2.6-3.module+el8.7.0+20872+81cbf159', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'cockpit-podman-46-1.module+el8.7.0+20872+81cbf159', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'conmon-2.1.4-1.module+el8.7.0+20872+81cbf159', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'container-selinux-2.189.0-1.module+el8.7.0+20872+81cbf159', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      ...
      {'reference':'podman-docker-4.0.2-8.module+el8.7.0+20872+81cbf159', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      ...
      {'reference':'python3-podman-4.0.0-1.module+el8.7.0+20872+81cbf159', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'udica-0.2.6-3.module+el8.7.0+20872+81cbf159', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
};
