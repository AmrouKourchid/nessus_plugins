...
if (description)
{
  ...
  script_name(english:"Foxit PDF Editor for Mac < 2024.1 Multiple Vulnerabilities");
...
on the remote macOS host is prior to 2024.1. It is, therefore affected by multiple vulnerabilities:
...
"Upgrade to Foxit PDF Editor for Mac version 2024.1 or later");
...
var constraints = [
  { 'max_version' : '11.1.6.0109', 'fixed_version' : '2024.1' },
  { 'min_version' : '12.0', 'max_version' : '12.1.2.55366', 'fixed_version' : '2024.1' },
  { 'min_version' : '13.0', 'max_version' : '13.0.1.61866', 'fixed_version' : '2024.1' },
  { 'min_version' : '2023.0', 'max_version' : '2023.3.0.63083', 'fixed_version' : '2024.1' }
];
