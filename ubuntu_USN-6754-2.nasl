...
# extracted from Ubuntu Security Notice USN-6754-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6754-2");

  script_name(english:"Ubuntu 24.04 LTS : nghttp2 vulnerability (USN-6754-2)");
...
USN-6754-2 advisory.
    ...
    USN-6754-1 fixed vulnerabilities in nghttp2. This update provides the corresponding update for Ubuntu
    24.04 LTS.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6754-2");
...
var pkgs = [
    {'osver': '24.04', 'pkgname': 'libnghttp2-14', 'pkgver': '1.59.0-1ubuntu0.1'},
    {'osver': '24.04', 'pkgname': 'libnghttp2-dev', 'pkgver': '1.59.0-1ubuntu0.1'},
    {'osver': '24.04', 'pkgname': 'nghttp2', 'pkgver': '1.59.0-1ubuntu0.1'},
    {'osver': '24.04', 'pkgname': 'nghttp2-client', 'pkgver': '1.59.0-1ubuntu0.1'},
    {'osver': '24.04', 'pkgname': 'nghttp2-proxy', 'pkgver': '1.59.0-1ubuntu0.1'},
    {'osver': '24.04', 'pkgname': 'nghttp2-server', 'pkgver': '1.59.0-1ubuntu0.1'}
];
