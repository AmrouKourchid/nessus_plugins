...
# SUSE update advisory SUSE-SU-2023:1680-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:1680-1");

  script_name(english:"SUSE SLES12 Security Update : xorg-x11-server (SUSE-SU-2023:1680-1)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://lists.suse.com/pipermail/sle-updates/2023-March/028469.html");
...
var pkgs = [
    {'reference':'xorg-x11-server-7.6_1.18.3-76.66.1', 'sp':'2', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-bcl-release-12.2']},
    {'reference':'xorg-x11-server-extra-7.6_1.18.3-76.66.1', 'sp':'2', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-bcl-release-12.2']}
];
