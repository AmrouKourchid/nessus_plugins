...
# extracted from Fedora Security Advisory FEDORA-2019-a25d5df3b4.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : mod_auth_openidc (2019-a25d5df3b4)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-a25d5df3b4");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"mod_auth_openidc-2.4.0.3-1.fc31")) flag++;
