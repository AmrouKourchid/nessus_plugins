...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : curl (EulerOS-SA-2022-1116)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1116
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ba1e6327");
...
var pkgs = [
  "curl-7.29.0-46.h21.eulerosv2r7",
  "libcurl-7.29.0-46.h21.eulerosv2r7",
  "libcurl-devel-7.29.0-46.h21.eulerosv2r7"
];
