...
# extracted from VMware Security Advisory PHSA-2024-4.0-0637. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Openssl PHSA-2024-4.0-0637");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the openssl package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-637.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'openssl-3.0.14-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'openssl-c_rehash-3.0.14-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'openssl-devel-3.0.14-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'openssl-docs-3.0.14-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'openssl-perl-3.0.14-1.ph4')) flag++;
