...
# extracted from VMware Security Advisory PHSA-2021-1.0-0378. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: C PHSA-2021-1.0-0378");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the c package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-1.0-378.md");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'c-ares-1.16.1-1.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'c-ares-devel-1.16.1-1.ph1')) flag++;
