...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-2c2dfc65d1");
  script_set_attribute(attribute:"solution", value:
"Update the affected distcc package.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:F/RL:OF/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2004-2687");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"distcc-3.2rc1-22.fc28")) flag++;
