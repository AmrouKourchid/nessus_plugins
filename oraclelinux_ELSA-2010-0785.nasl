...
# Oracle Linux Security Advisory ELSA-2010-0785 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : quagga (ELSA-2010-0785)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2010-0785.html");
...
"Update the affected quagga, quagga-contrib and / or quagga-devel packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2007-4826");
...
var pkgs = [
    {'reference':'quagga-0.98.6-5.el5_5.2', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'quagga-contrib-0.98.6-5.el5_5.2', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'quagga-devel-0.98.6-5.el5_5.2', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'quagga-0.98.6-5.el5_5.2', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'quagga-contrib-0.98.6-5.el5_5.2', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'quagga-devel-0.98.6-5.el5_5.2', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
