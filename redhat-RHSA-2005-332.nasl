...
# extracted from Red Hat Security Advisory RHSA-2005:332. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 4 : xloadimage (RHSA-2005:332)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for xloadimage.");
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2005/rhsa-2005_332.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?568ea235");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=150700");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=70867");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=78481");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2005:332");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL xloadimage package based on the guidance in RHSA-2005:332.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2005-0638");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'xloadimage-4.1-34.RHEL4', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xloadimage-4.1-34.RHEL4', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xloadimage-4.1-34.RHEL4', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xloadimage-4.1-34.RHEL4', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xloadimage-4.1-34.RHEL4', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
