...
if (description)
{
  ...
  script_cve_id("CVE-2022-44687");
  script_xref(name:"IAVA", value:"2022-A-0530-S");

  script_name(english:"Microsoft Windows Raw Image Extensions Library RCE (December 2022)");
...
vulnerability. An attacker can exploit this to bypass authentication and execute unauthorized arbitrary commands.");
  script_set_attribute(attribute:"see_also", value:"https://msrc.microsoft.com/update-guide/vulnerability/CVE-2022-44687");
...
"Upgrade to app version 2.0.32791.0, 2.1.32791.0 or later via the Microsoft Store.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-44687");
...
var constraints = [
  { 'fixed_version' : '2.0.32791.0' },
  { 'min_version' : '2.1', 'fixed_version' : '2.1.32791.0' }
];
