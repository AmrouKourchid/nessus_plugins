...
# extracted from Gentoo Linux Security Advisory GLSA 202003-54.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2020-9274", "CVE-2020-9365");
  script_xref(name:"GLSA", value:"202003-54");

  script_name(english:"GLSA-202003-54 : Pure-FTPd: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202003-54
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202003-54");
...
"All Pure-FTPd users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-9365");
...
if (qpkg_check(package:"net-ftp/pure-ftpd", unaffected:make_list("ge 1.0.49-r2"), vulnerable:make_list("lt 1.0.49-r2"))) flag++;
