...
# extracted from Red Hat Security Advisory RHSA-2018:1704. The text 
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2018/rhsa-2018_1704.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3979211a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:1704");
...
"Update the RHEL librelp package based on the guidance in RHSA-2018:1704.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'librelp-1.2.12-1.el7_4.1', 'sp':'4', 'cpu':'i686', 'release':'7', 'el_string':'el7_4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'librelp-1.2.12-1.el7_4.1', 'sp':'4', 'cpu':'ppc', 'release':'7', 'el_string':'el7_4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'librelp-1.2.12-1.el7_4.1', 'sp':'4', 'cpu':'ppc64', 'release':'7', 'el_string':'el7_4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'librelp-1.2.12-1.el7_4.1', 'sp':'4', 'cpu':'ppc64le', 'release':'7', 'el_string':'el7_4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'librelp-1.2.12-1.el7_4.1', 'sp':'4', 'cpu':'s390', 'release':'7', 'el_string':'el7_4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'librelp-1.2.12-1.el7_4.1', 'sp':'4', 'cpu':'s390x', 'release':'7', 'el_string':'el7_4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'librelp-1.2.12-1.el7_4.1', 'sp':'4', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'librelp-devel-1.2.12-1.el7_4.1', 'sp':'4', 'cpu':'i686', 'release':'7', 'el_string':'el7_4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'librelp-devel-1.2.12-1.el7_4.1', 'sp':'4', 'cpu':'ppc', 'release':'7', 'el_string':'el7_4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'librelp-devel-1.2.12-1.el7_4.1', 'sp':'4', 'cpu':'ppc64', 'release':'7', 'el_string':'el7_4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'librelp-devel-1.2.12-1.el7_4.1', 'sp':'4', 'cpu':'ppc64le', 'release':'7', 'el_string':'el7_4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'librelp-devel-1.2.12-1.el7_4.1', 'sp':'4', 'cpu':'s390', 'release':'7', 'el_string':'el7_4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'librelp-devel-1.2.12-1.el7_4.1', 'sp':'4', 'cpu':'s390x', 'release':'7', 'el_string':'el7_4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'librelp-devel-1.2.12-1.el7_4.1', 'sp':'4', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_4', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
