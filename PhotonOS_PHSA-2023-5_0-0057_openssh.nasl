...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Openssh PHSA-2023-5.0-0057");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'openssh-9.3p2-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'openssh-clients-9.3p2-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'openssh-server-9.3p2-1.ph5')) flag++;
