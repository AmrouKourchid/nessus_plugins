...
# extracted from Ubuntu Security Notice USN-5197-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5197-1");
  ...
  script_name(english:"Ubuntu 20.04 LTS : Apache Log4j 2 vulnerability (USN-5197-1)");
...
the USN-5197-1 advisory.

    It was found that the fix to address CVE-2021-44228 in Apache Log4j 2.15.0 was incomplete in certain non-
    default configurations. An attacker could use this vulnerability to cause a denial of service. Please see
    the following link for more information: https://wiki.ubuntu.com/SecurityTeam/KnowledgeBase/Log4Shell

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5197-1");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'liblog4j2-java', 'pkgver': '2.16.0-0.20.04.1'}
];
