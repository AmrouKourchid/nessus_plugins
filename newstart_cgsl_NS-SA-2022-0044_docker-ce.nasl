...
# extracted from ZTE advisory NS-SA-2022-0044. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.05 / MAIN 5.05 : docker-ce Multiple Vulnerabilities (NS-SA-2022-0044)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/notice/NS-SA-2022-0044");
...
var pkgs = {
  'CGSL CORE 5.05': [
    'docker-ce-17.03.3-1.el7.2110110757gita628d21',
    'docker-ce-debuginfo-17.03.3-1.el7.2110110757gita628d21'
  ],
  'CGSL MAIN 5.05': [
    'docker-ce-17.03.3-1.el7.2110110757gita628d21',
    'docker-ce-debuginfo-17.03.3-1.el7.2110110757gita628d21'
