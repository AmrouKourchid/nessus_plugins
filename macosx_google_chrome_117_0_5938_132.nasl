...
"The version of Google Chrome installed on the remote macOS host is prior to 117.0.5938.132. It is, therefore, affected
...
google_chrome_check_version(fix:'117.0.5938.132', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
