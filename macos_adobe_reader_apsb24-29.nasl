...
if (description)
{
  ...
  script_name(english:"Adobe Reader < 20.005.30635 / 24.002.20759 Multiple Vulnerabilities (APSB24-29) (macOS)");

  script_set_attribute(attribute:"synopsis", value:
"The version of Adobe Reader installed on the remote macOS host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Reader installed on the remote macOS host is a version prior to 20.005.30635 or 24.002.20759. It
...
"Upgrade to Adobe Reader version 20.005.30635 / 24.002.20759 or later.");
