...
# extracted from Amazon Linux AMI Security Advisory ALAS-2019-1224.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2019-1224");

  script_name(english:"Amazon Linux AMI : python-urllib3 (ALAS-2019-1224)");
...
transmitted in cleartext. (CVE-2018-20060)");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/ALAS-2019-1224.html");
...
"Run 'yum update python-urllib3' to update your system.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:amazon:linux:python26-urllib3");
...
flag = 0;
if (rpm_check(release:"ALA", reference:"python26-urllib3-1.24.1-1.6.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"python27-urllib3-1.24.1-1.6.amzn1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "python26-urllib3 / python27-urllib3");
}
