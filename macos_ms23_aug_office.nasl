...
if (description)
{
  ...
  script_cve_id("CVE-2023-35371", "CVE-2023-36895", "CVE-2023-36896");

  script_name(english:"Security Updates for Microsoft Office Products (Aug 2023) (macOS)");
...
referenced in the august-15-2023 advisory.

  - Microsoft Office Remote Code Execution Vulnerability (CVE-2023-35371)

  - Microsoft Excel Remote Code Execution Vulnerability (CVE-2023-36896)

  - Microsoft Outlook Remote Code Execution Vulnerability (CVE-2023-36895)

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  # https://learn.microsoft.com/en-us/officeupdates/release-notes-office-for-mac#august-15-2023
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7fd48798");
  script_set_attribute(attribute:"solution", value:
"Update to Office for Mac version 16.76 or later.");
...
var constraints = [
  { 'fixed_version' : '16.76', 'fixed_display' : 'Version 16.76 (Build 23081101)' }
];
