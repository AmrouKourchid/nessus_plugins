...
# extracted from Fedora Security Advisory FEDORA-2021-ab674d56bc
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-ab674d56bc");

  script_name(english:"Fedora 33 : webkit2gtk3 (2021-ab674d56bc)");
...
FEDORA-2021-ab674d56bc advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-ab674d56bc");
...
pkgs = [
    {'reference':'webkit2gtk3-2.30.5-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
