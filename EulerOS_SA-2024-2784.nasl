...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP12 : dnsmasq (EulerOS-SA-2024-2784)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2784
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c8f92db5");
...
var pkgs = [
  "dnsmasq-2.86-3.h9.eulerosv2r12"
];
