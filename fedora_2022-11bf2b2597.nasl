...
# extracted from Fedora Security Advisory FEDORA-2022-11bf2b2597
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-11bf2b2597");

  script_name(english:"Fedora 36 : strongswan (2022-11bf2b2597)");
...
FEDORA-2022-11bf2b2597 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-11bf2b2597");
...
var pkgs = [
    {'reference':'strongswan-5.9.8-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
