...
# extracted from Gentoo Linux Security Advisory GLSA 202405-26.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202405-26 : qtsvg: Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202405-26 (qtsvg: Multiple Vulnerabilities)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202405-26");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=830381");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=906465");
...
"All qtsvg users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:qtsvg");
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'qtsvg');
}
