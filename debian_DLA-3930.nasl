...
# extracted from Debian Security Advisory dla-3930. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3930 : libsepol1 - security update");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/libsepol");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2021-36084");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2021-36085");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2021-36086");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2021-36087");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bullseye/libsepol");
  script_set_attribute(attribute:"solution", value:
"Upgrade the libsepol1 packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:libsepol1");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:libsepol1-dev");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:sepol-utils");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'libsepol1', 'reference': '3.1-1+deb11u1'},
    {'release': '11.0', 'prefix': 'libsepol1-dev', 'reference': '3.1-1+deb11u1'},
    {'release': '11.0', 'prefix': 'sepol-utils', 'reference': '3.1-1+deb11u1'}
];
