...
# extracted from Fedora Security Advisory FEDORA-2023-8a1abb6750
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-8a1abb6750");

  script_name(english:"Fedora 38 : tor (2023-8a1abb6750)");
...
FEDORA-2023-8a1abb6750 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-8a1abb6750");
...
var pkgs = [
    {'reference':'tor-0.4.8.10-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
