...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : proftpd (EulerOS-SA-2025-1372)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1372
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7b1b721b");
...
var pkgs = [
  "proftpd-1.3.7c-3.h8.eulerosv2r11"
];
