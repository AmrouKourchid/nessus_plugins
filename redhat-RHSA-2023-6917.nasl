...
# extracted from Red Hat Security Advisory RHSA-2023:6917. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:6917");

  script_name(english:"RHEL 8 : xorg-x11-server-Xwayland (RHSA-2023:6917)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for xorg-x11-server-Xwayland.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6917.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1ba6d910");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2212831");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6917");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL xorg-x11-server-Xwayland packages based on the guidance in RHSA-2023:6917.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'xorg-x11-server-Xwayland-21.1.3-12.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
