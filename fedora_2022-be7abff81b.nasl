...
# extracted from Fedora Security Advisory FEDORA-2022-be7abff81b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-be7abff81b");

  script_name(english:"Fedora 37 : elixir (2022-be7abff81b)");
...
FEDORA-2022-be7abff81b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-be7abff81b");
  script_set_attribute(attribute:"solution", value:
"Update the affected elixir package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:elixir");
...
var pkgs = [
    {'reference':'elixir-1.14.2-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'elixir');
}
