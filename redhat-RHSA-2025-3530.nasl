...
# extracted from Red Hat Security Advisory RHSA-2025:3530. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:3530");

  script_name(english:"RHEL 9 : libgcrypt (RHSA-2025:3530)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2245218");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_3530.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a9a6e53d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:3530");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libgcrypt package based on the guidance in RHSA-2025:3530.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libgcrypt-1.10.0-10.el9_4.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libgcrypt-devel-1.10.0-10.el9_4.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
