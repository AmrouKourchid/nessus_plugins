...
# extracted from Fedora Security Advisory FEDORA-2022-8622ebdebb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-8622ebdebb");

  script_name(english:"Fedora 35 : vim (2022-8622ebdebb)");
...
FEDORA-2022-8622ebdebb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-8622ebdebb");
...
var pkgs = [
    {'reference':'vim-8.2.4428-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
