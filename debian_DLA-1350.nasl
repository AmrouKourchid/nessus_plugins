...
# extracted from Debian Security Advisory DLA-1350-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1350-1 : qemu-kvm security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2018/04/msg00015.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/wheezy/qemu-kvm");
...
flag = 0;
if (deb_check(release:"7.0", prefix:"kvm", reference:"1.1.2+dfsg-6+deb7u25")) flag++;
if (deb_check(release:"7.0", prefix:"qemu-kvm", reference:"1.1.2+dfsg-6+deb7u25")) flag++;
if (deb_check(release:"7.0", prefix:"qemu-kvm-dbg", reference:"1.1.2+dfsg-6+deb7u25")) flag++;
