...
# extracted from Fedora Security Advisory FEDORA-2024-763ac380b6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-763ac380b6");

  script_name(english:"Fedora 40 : tinyxml (2024-763ac380b6)");
...
FEDORA-2024-763ac380b6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-763ac380b6");
...
"Update the affected tinyxml package.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2023-40462");
...
var pkgs = [
    {'reference':'tinyxml-2.6.2-28.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
