...
# extracted from Fedora Security Advisory FEDORA-2023-bde7913e5a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-bde7913e5a");

  script_name(english:"Fedora 37 : python-django3 (2023-bde7913e5a)");
...
FEDORA-2023-bde7913e5a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-bde7913e5a");
...
var pkgs = [
    {'reference':'python-django3-3.2.18-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
