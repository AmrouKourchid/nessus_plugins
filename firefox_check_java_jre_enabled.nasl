...
if (description)
{
  ...
  script_name(english:"Java JRE Enabled (Mozilla Firefox)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host has Java JRE enabled for Mozilla Firefox.");
  script_set_attribute(attribute:"description", value:
"Java JRE is enabled in Mozilla Firefox.");
...
"Disable Java unless it is needed.");
  ...
  script_require_keys("SMB/Java/JRE/firefox_enabled");
...
users = get_kb_item_or_exit("SMB/Java/JRE/firefox_enabled");
