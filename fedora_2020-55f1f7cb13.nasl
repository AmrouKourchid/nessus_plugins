...
# extracted from Fedora Security Advisory FEDORA-2020-55f1f7cb13.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : curl (2020-55f1f7cb13)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-55f1f7cb13");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"curl-7.66.0-2.fc31")) flag++;
