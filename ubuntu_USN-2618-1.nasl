...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : python-dbusmock vulnerability (USN-2618-1)");
...
USN-2618-1 advisory.
    ...
    It was discovered that python-dbusmock incorrectly handled template loading from shared directories. A
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2618-1");
  script_set_attribute(attribute:"solution", value:
"Update the affected python-dbusmock and / or python3-dbusmock packages.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:R/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-1326");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'python-dbusmock', 'pkgver': '0.10.1-1ubuntu1'},
    {'osver': '14.04', 'pkgname': 'python3-dbusmock', 'pkgver': '0.10.1-1ubuntu1'}
];
