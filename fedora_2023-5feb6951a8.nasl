...
# extracted from Fedora Security Advisory FEDORA-2023-5feb6951a8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-5feb6951a8");

  script_name(english:"Fedora 37 : squid (2023-5feb6951a8)");
...
FEDORA-2023-5feb6951a8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-5feb6951a8");
...
var pkgs = [
    {'reference':'squid-6.4-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
];
