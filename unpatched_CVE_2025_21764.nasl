...
if (description)
{
  ...
  script_cve_id("CVE-2025-21764");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2025-21764");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: ndisc: use RCU protection in
    ndisc_alloc_skb() ndisc_alloc_skb() can be called without RTNL or RCU being held. Add RCU protection to
    avoid possible UAF. (CVE-2025-21764)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-21764");
