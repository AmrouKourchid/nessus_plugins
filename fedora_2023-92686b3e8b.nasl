...
# extracted from Fedora Security Advisory FEDORA-2023-92686b3e8b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-92686b3e8b");

  script_name(english:"Fedora 37 : trafficserver (2023-92686b3e8b)");
...
FEDORA-2023-92686b3e8b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-92686b3e8b");
...
var pkgs = [
    {'reference':'trafficserver-9.2.1-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
