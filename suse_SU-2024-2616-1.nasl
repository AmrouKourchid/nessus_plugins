...
# SUSE update advisory SUSE-SU-2024:2616-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2024:2616-1");

  script_name(english:"openSUSE 15 Security Update : python-Django (SUSE-SU-2024:2616-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://lists.suse.com/pipermail/sle-updates/2024-July/036129.html");
...
var pkgs = [
    {'reference':'python3-Django-2.0.7-150000.1.23.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.5']}
];
