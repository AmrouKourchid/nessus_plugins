...
# extracted from Red Hat Security Advisory RHSA-2022:1968. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:1968");

  script_name(english:"RHEL 8 : libsndfile (RHSA-2022:1968)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for libsndfile.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2022:1968 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_1968.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?78557ceb");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/8.6_release_notes/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9341665d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:1968");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2027690");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libsndfile package based on the guidance in RHSA-2022:1968.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libsndfile-1.0.28-12.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsndfile-devel-1.0.28-12.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
