...
# SUSE update advisory SUSE-SU-2024:2295-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2024:2295-1");

  script_name(english:"SUSE SLES12 Security Update : go1.22 (SUSE-SU-2024:2295-1)");
...
in the SUSE-SU-2024:2295-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2024-July/018863.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ca131f39");
...
var pkgs = [
    {'reference':'go1.22-1.22.5-1.15.1', 'sp':'5', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5']},
    {'reference':'go1.22-doc-1.22.5-1.15.1', 'sp':'5', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5']},
    {'reference':'go1.22-1.22.5-1.15.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-sdk-release-12.5', 'sles-release-12.5']},
    {'reference':'go1.22-doc-1.22.5-1.15.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-sdk-release-12.5', 'sles-release-12.5']}
];
