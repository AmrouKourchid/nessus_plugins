...
# extracted from Fedora Security Advisory FEDORA-2025-d611c8d114
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-d611c8d114");

  script_name(english:"Fedora 41 : workrave (2025-d611c8d114)");
...
FEDORA-2025-d611c8d114 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-d611c8d114");
...
var pkgs = [
    {'reference':'workrave-1.11.0~rc.1-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
