...
# extracted from Red Hat Security Advisory RHSA-2023:6402. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:6402");

  script_name(english:"RHEL 9 : containernetworking-plugins (RHSA-2023:6402)");
...
referenced in the RHSA-2023:6402 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6402.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?833180c7");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2212143");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2222167");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6402");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL containernetworking-plugins package based on the guidance in RHSA-2023:6402.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'containernetworking-plugins-1.3.0-4.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
