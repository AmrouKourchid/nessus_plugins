...
# extracted from Fedora Security Advisory FEDORA-2024-af0bf62ac6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-af0bf62ac6");

  script_name(english:"Fedora 40 : pdns-recursor (2024-af0bf62ac6)");
...
FEDORA-2024-af0bf62ac6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-af0bf62ac6");
...
var pkgs = [
    {'reference':'pdns-recursor-5.0.9-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
