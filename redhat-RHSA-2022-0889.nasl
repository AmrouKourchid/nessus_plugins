...
# extracted from Red Hat Security Advisory RHSA-2022:0889. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:0889");

  script_name(english:"RHEL 8 : 389-ds:1.4 (RHSA-2022:0889)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for 389-ds:1.4.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2022:0889 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_0889.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d020e74e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:0889");
...
"Update the RHEL 389-ds:1.4 package based on the guidance in RHSA-2022:0889.");
  ...
  '389-ds:1.4': [
    {
      ...
      'pkgs': [
        {'reference':'389-ds-base-1.4.3.23-14.module+el8.5.0+14377+c731dc97', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'389-ds-base-devel-1.4.3.23-14.module+el8.5.0+14377+c731dc97', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'389-ds-base-legacy-tools-1.4.3.23-14.module+el8.5.0+14377+c731dc97', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'389-ds-base-libs-1.4.3.23-14.module+el8.5.0+14377+c731dc97', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'389-ds-base-snmp-1.4.3.23-14.module+el8.5.0+14377+c731dc97', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-lib389-1.4.3.23-14.module+el8.5.0+14377+c731dc97', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
