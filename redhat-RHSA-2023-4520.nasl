...
# extracted from Red Hat Security Advisory RHSA-2023:4520. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:4520");

  script_name(english:"RHEL 8 : python-requests (RHSA-2023:4520)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_4520.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?32f6f429");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2209469");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:4520");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-requests package based on the guidance in RHSA-2023:4520.");
...
var constraints = [
  ...
  },
  {
    ...
    'pkgs': [
      {'reference':'python3-requests-2.20.0-3.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
