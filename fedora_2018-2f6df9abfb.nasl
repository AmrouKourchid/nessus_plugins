...
# extracted from Fedora Security Advisory FEDORA-2018-2f6df9abfb.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : kernel / kernel-headers / kernel-tools (2018-2f6df9abfb)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The 4.17.12 stable kernel update contains a number of important fixes
across the tree.
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-2f6df9abfb");
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  cve_list = make_list("CVE-2018-14734");
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for FEDORA-2018-2f6df9abfb");
  }
  else
  {
...
flag = 0;
if (rpm_check(release:"FC27", reference:"kernel-4.17.12-100.fc27")) flag++;
if (rpm_check(release:"FC27", reference:"kernel-headers-4.17.12-1.fc27")) flag++;
if (rpm_check(release:"FC27", reference:"kernel-tools-4.17.12-100.fc27")) flag++;
