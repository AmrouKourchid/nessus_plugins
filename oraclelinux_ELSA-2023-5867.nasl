...
# extracted from Oracle Linux Security Advisory ELSA-2023-5867.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : grafana (ELSA-2023-5867)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-5867.html");
...
var pkgs = [
    {'reference':'grafana-9.0.9-4.el9_2', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'grafana-9.0.9-4.el9_2', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
