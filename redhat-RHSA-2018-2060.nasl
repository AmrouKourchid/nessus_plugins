...
# extracted from Red Hat Security Advisory RHSA-2018:2060. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:2060");

  script_name(english:"RHEL 7 : qemu-kvm-rhev (RHSA-2018:2060)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for qemu-kvm-rhev.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2018:2060 advisory.
    ...
    * An industry-wide issue was found in the way many modern microprocessor designs have implemented
    ...
    Note: This is the qemu-kvm-rhev side of the CVE-2018-3639 mitigation that includes support for guests
    running on hosts with AMD processors.

    Bug Fix(es):

    * Previously, using device passthrough for a SCSI-2 device failed and returned an Illegal Request error.
    With this update, the QEMU emulator checks the SCSI version of the device when performing passthrough. As
    a result, the described problem no longer occurs. (BZ#1571370)

    * Under certain circumstances, resuming a paused guest generated redundant VIR_DOMAIN_PAUSED_UNKNOWN
    error messages in the libvirt log. This update corrects the event sending order when resuming guests,
    which prevents the errors being logged. (BZ#1582122)

    Enhancement(s):

    * With this update, Ceph storage is supported by KVM virtualization on all CPU architectures supported by
    Red Hat. (BZ#1588001)
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_2060.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e7373729");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1582122");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1588001");
...
"Update the RHEL qemu-kvm-rhev package based on the guidance in RHSA-2018:2060.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'qemu-img-rhev-2.10.0-21.el7_5.4', 'cpu':'ppc64le', 'release':'7', 'el_string':'el7_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10', 'exists_check':'ovirt-'},
      {'reference':'qemu-img-rhev-2.10.0-21.el7_5.4', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10', 'exists_check':'ovirt-'},
      {'reference':'qemu-kvm-common-rhev-2.10.0-21.el7_5.4', 'cpu':'ppc64le', 'release':'7', 'el_string':'el7_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10', 'exists_check':'ovirt-'},
      {'reference':'qemu-kvm-common-rhev-2.10.0-21.el7_5.4', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10', 'exists_check':'ovirt-'},
      {'reference':'qemu-kvm-rhev-2.10.0-21.el7_5.4', 'cpu':'ppc64le', 'release':'7', 'el_string':'el7_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10', 'exists_check':'ovirt-'},
      {'reference':'qemu-kvm-rhev-2.10.0-21.el7_5.4', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10', 'exists_check':'ovirt-'},
      {'reference':'qemu-kvm-tools-rhev-2.10.0-21.el7_5.4', 'cpu':'ppc64le', 'release':'7', 'el_string':'el7_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10', 'exists_check':'ovirt-'},
      {'reference':'qemu-kvm-tools-rhev-2.10.0-21.el7_5.4', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10', 'exists_check':'ovirt-'}
    ]
  }
];
