...
"The version of Firefox installed on the remote macOS or Mac OS X host is prior to 90.0. It is, therefore, affected by
multiple vulnerabilities as referenced in the mfsa2021-28 advisory.
...
"Upgrade to Mozilla Firefox version 90.0 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-29971");
...
mozilla_check_version(version:version, path:path, product:'firefox', esr:FALSE, fix:'90.0', severity:SECURITY_HOLE);
