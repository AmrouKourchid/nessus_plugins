...
# extracted from Red Hat Security Advisory RHSA-2025:0842. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:0842");

  script_name(english:"RHEL 9 : OpenShift Container Platform 4.14.46 (RHSA-2025:0842)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for OpenShift Container Platform 4.14.46.");
...
referenced in the RHSA-2025:0842 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.14.46. See the
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_0842.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f7fb4c2f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:0842");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.14.46 package based on the guidance in RHSA-2025:0842.");
