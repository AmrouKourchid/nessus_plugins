...
# extracted from Red Hat Security Advisory RHSA-2022:0635. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_0635.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d94631d7");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:0635");
...
"Update the RHEL curl package based on the guidance in RHSA-2022:0635.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'curl-7.61.1-12.el8_2.4', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libcurl-7.61.1-12.el8_2.4', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libcurl-devel-7.61.1-12.el8_2.4', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libcurl-minimal-7.61.1-12.el8_2.4', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
