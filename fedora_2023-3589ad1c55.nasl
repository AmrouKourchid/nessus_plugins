...
# extracted from Fedora Security Advisory FEDORA-2023-3589ad1c55
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-3589ad1c55");

  script_name(english:"Fedora 38 : bzip3 (2023-3589ad1c55)");
...
FEDORA-2023-3589ad1c55 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-3589ad1c55");
  script_set_attribute(attribute:"solution", value:
"Update the affected bzip3 package.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:R/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-29421");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:bzip3");
...
var pkgs = [
    {'reference':'bzip3-1.3.0-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'bzip3');
}
