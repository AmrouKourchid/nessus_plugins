...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Libxml2 PHSA-2025-5.0-0485");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'libxml2-2.12.10-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'libxml2-devel-2.12.10-1.ph5')) flag++;
