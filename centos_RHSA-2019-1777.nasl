...
# CentOS Errata and Security Advisory 2019:1777 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : thunderbird (CESA-2019:1777)");
...
the CVE page(s) listed in the References section.");
  # https://lists.centos.org/pipermail/centos-announce/2019-July/023366.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6c0804b4");
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"thunderbird-60.8.0-1.el6.centos", allowmaj:TRUE)) flag++;
