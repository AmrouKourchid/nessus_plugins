...
if (description)
{
  ...
  script_name(english:"Tenable Nessus SEoL (8.13.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Tenable Nessus is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Tenable Nessus is 8.13.x. It is, therefore, no longer maintained by its vendor or provider.
...
"Upgrade to a version of Tenable Nessus that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2022/06/30");
...
var constraints = [
  { max_branch : '8.13', min_branch : '8.13', seol : 20220630, eseol : 20221231 }
];
