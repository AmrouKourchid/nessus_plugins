...
if (description)
{
  ...
  script_cve_id("CVE-2017-11577");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2017-11577");
...
patch available.
  ...
  - FontForge 20161012 is vulnerable to a buffer over-read in getsid (parsettf.c) resulting in DoS or code
    execution via a crafted otf file. (CVE-2017-11577)
