...
# extracted from F5 Networks BIG-IP Solution K000140947.
#
# @NOAGENT@
##
...
if (description)
{
  ...
  script_cve_id("CVE-2025-20058");
  script_xref(name:"IAVA", value:"2025-A-0086");

  script_name(english:"F5 Networks BIG-IP : BIG-IP message routing vulnerability (K000140947)");
...
referenced in the K000140947 advisory.

    When a BIG-IP message routing profile is configured on a virtual server, undisclosed traffic can cause an
    increase in memory resource utilization.(CVE-2025-20058)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K000140947");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K000140947.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-20058");
