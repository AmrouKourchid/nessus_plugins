...
if (description)
{
  ...
  script_cve_id("CVE-2016-5556", "CVE-2016-5582");

  script_name(english:"Photon OS 1.0: Openjre PHSA-2016-0015");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'openjre-1.8.0.112-1.ph1')) flag++;
