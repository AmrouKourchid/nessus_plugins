...
# extracted from Gentoo Linux Security Advisory GLSA 202309-13.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202309-13 : GMP: Buffer Overflow Vulnerability");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202309-13 (GMP: Buffer Overflow Vulnerability)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202309-13");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=823804");
...
"All GMP users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:gmp");
...
var packages = [
  {
    'name' : 'dev-libs/gmp',
    'unaffected' : make_list("ge 6.2.1-r2"),
    'vulnerable' : make_list("lt 6.2.1-r2")
  }
];
