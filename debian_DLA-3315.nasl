...
# extracted from Debian Security Advisory dla-3315. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3315 : libsox-dev - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2017-11358");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2019-13590");
...
"Upgrade the libsox-dev packages.");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libsox-dev', 'reference': '14.4.2+git20190427-1+deb10u1'},
    {'release': '10.0', 'prefix': 'libsox-fmt-all', 'reference': '14.4.2+git20190427-1+deb10u1'},
    {'release': '10.0', 'prefix': 'libsox-fmt-alsa', 'reference': '14.4.2+git20190427-1+deb10u1'},
    {'release': '10.0', 'prefix': 'libsox-fmt-ao', 'reference': '14.4.2+git20190427-1+deb10u1'},
    {'release': '10.0', 'prefix': 'libsox-fmt-base', 'reference': '14.4.2+git20190427-1+deb10u1'},
    {'release': '10.0', 'prefix': 'libsox-fmt-mp3', 'reference': '14.4.2+git20190427-1+deb10u1'},
    {'release': '10.0', 'prefix': 'libsox-fmt-oss', 'reference': '14.4.2+git20190427-1+deb10u1'},
    {'release': '10.0', 'prefix': 'libsox-fmt-pulse', 'reference': '14.4.2+git20190427-1+deb10u1'},
    {'release': '10.0', 'prefix': 'libsox3', 'reference': '14.4.2+git20190427-1+deb10u1'},
    {'release': '10.0', 'prefix': 'sox', 'reference': '14.4.2+git20190427-1+deb10u1'}
];
