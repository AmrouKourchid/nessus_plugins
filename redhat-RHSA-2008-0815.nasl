...
"The remote Red Hat host is missing a security update for yum-rhn-plugin.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2008/rhsa-2008_0815.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fbd8112a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=457113");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2008:0815");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL yum-rhn-plugin package based on the guidance in RHSA-2008:0815.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:H/Au:N/C:N/I:P/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:N/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2008-3270");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'yum-rhn-plugin-0.5.3-12.el5_2.9', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
