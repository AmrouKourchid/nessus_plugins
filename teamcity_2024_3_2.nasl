...
if (description)
{
  ...
  script_name(english:"TeamCity Server < 2024.3.2 Multiple Vulnerabilities");
...
remote host is a version prior to 2024.3.2 It is, therefore, affected by multiple vulnerabilities:

  - Users can perform actions that should not be available 
    to them based on their permissions (CVE-2024-36376)
    
  - Several stored XSS in untrusted builds settings is possible 
    (CVE-2024-36373, CVE-2024-36374)

  - Technical information regarding TeamCity server could be exposed
    (CVE-2024-36375) 
...
"Upgrade to JetBrains TeamCity version 2024.3.2 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:S/C:C/I:C/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:L/UI:N/S:U/C:H/I:H/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-36377");
