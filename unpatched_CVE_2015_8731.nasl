...
if (description)
{
  ...
  script_cve_id("CVE-2015-8731");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2015-8731");
...
patch available.
  ...
  - The dissct_rsl_ipaccess_msg function in epan/dissectors/packet-rsl.c in the RSL dissector in Wireshark
    1.12.x before 1.12.9 and 2.0.x before 2.0.1 does not reject unknown TLV types, which allows remote
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-8731");
