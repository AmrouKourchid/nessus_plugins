...
# extracted from Fedora Security Advisory FEDORA-2019-07940971b2.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-07940971b2");

  script_name(english:"Fedora 30 : mbedtls (2019-07940971b2)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-07940971b2");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"mbedtls-2.16.3-1.fc30")) flag++;
