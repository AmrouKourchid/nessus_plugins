...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : cups (EulerOS-SA-2023-3424)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3424
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?eb21ef30");
...
var pkgs = [
  "cups-2.2.8-5.h10.eulerosv2r8",
  "cups-client-2.2.8-5.h10.eulerosv2r8",
  "cups-devel-2.2.8-5.h10.eulerosv2r8",
  "cups-filesystem-2.2.8-5.h10.eulerosv2r8",
  "cups-libs-2.2.8-5.h10.eulerosv2r8",
  "cups-lpd-2.2.8-5.h10.eulerosv2r8"
];
