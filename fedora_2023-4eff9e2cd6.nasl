...
# extracted from Fedora Security Advisory FEDORA-2023-4eff9e2cd6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-4eff9e2cd6");

  script_name(english:"Fedora 38 : mingw-poppler (2023-4eff9e2cd6)");
...
FEDORA-2023-4eff9e2cd6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-4eff9e2cd6");
...
var pkgs = [
    {'reference':'mingw-poppler-23.02.0-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
