...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : golang (EulerOS-SA-2025-1516)");
...
the following vulnerabilities :
    ...
    This can permit request smuggling if a net/http server is used in conjunction with a server that
    incorrectly accepts a bare LF as part of a chunk-ext.(CVE-2025-22871)
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1516
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?15d99c78");
...
var pkgs = [
  "golang-1.15.7-15.h26.r10.eulerosv2r10",
  "golang-devel-1.15.7-15.h26.r10.eulerosv2r10",
  "golang-help-1.15.7-15.h26.r10.eulerosv2r10"
];
