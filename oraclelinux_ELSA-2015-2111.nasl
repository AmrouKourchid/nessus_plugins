...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2015-2111.html");
...
"Update the affected grep package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-1345");
...
var pkgs = [
    {'reference':'grep-2.20-2.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
];
