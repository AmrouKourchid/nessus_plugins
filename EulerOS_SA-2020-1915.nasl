...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : ant (EulerOS-SA-2020-1915)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the version of the ant package installed, the EulerOS
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1915
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f0fdf52a");
...
pkgs = ["ant-1.9.2-9.h4.eulerosv2r7"];
