...
if (description)
{
  ...
  script_cve_id("CVE-2016-9428");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2016-9428");
...
patch available.
  ...
  - An issue was discovered in the Tatsuya Kinoshita w3m fork before 0.5.3-31. Heap-based buffer overflow in
    ...
    possibly execute arbitrary code via a crafted HTML page. (CVE-2016-9428)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-9428");
