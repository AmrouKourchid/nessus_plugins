...
if (description)
{
  ...
  script_cve_id("CVE-2017-12176");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2017-12176");
...
patch available.
  ...
  - xorg-x11-server before 1.19.5 was missing extra length validation in ProcEstablishConnection function
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-12176");
