...
# extracted from Fedora Security Advisory FEDORA-2024-194cb0840b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-194cb0840b");

  script_name(english:"Fedora 41 : thunderbird (2024-194cb0840b)");
...
FEDORA-2024-194cb0840b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-194cb0840b");
...
var pkgs = [
    {'reference':'thunderbird-128.2.0-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
