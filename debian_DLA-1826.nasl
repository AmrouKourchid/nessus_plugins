...
# extracted from Debian Security Advisory DLA-1826-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1826-1 : glib2.0 security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2019/06/msg00013.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/jessie/glib2.0");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"libglib2.0-0", reference:"2.42.1-1+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"libglib2.0-0-dbg", reference:"2.42.1-1+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"libglib2.0-0-refdbg", reference:"2.42.1-1+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"libglib2.0-bin", reference:"2.42.1-1+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"libglib2.0-data", reference:"2.42.1-1+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"libglib2.0-dev", reference:"2.42.1-1+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"libglib2.0-doc", reference:"2.42.1-1+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"libglib2.0-tests", reference:"2.42.1-1+deb8u1")) flag++;
