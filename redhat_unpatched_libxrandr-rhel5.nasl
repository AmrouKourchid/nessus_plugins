...
# extracted from Red Hat Security Advisory libxrandr. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2013-1986", "CVE-2016-7947", "CVE-2016-7948");

  script_name(english:"RHEL 5 : libxrandr (Unpatched Vulnerability) (deprecated)");
