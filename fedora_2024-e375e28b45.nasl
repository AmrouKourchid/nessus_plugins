...
# extracted from Fedora Security Advisory FEDORA-2024-e375e28b45
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-e375e28b45");

  script_name(english:"Fedora 40 : tcpdump (2024-e375e28b45)");
...
FEDORA-2024-e375e28b45 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-e375e28b45");
...
"Update the affected 14:tcpdump package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-2397");
...
var pkgs = [
    {'reference':'tcpdump-4.99.4-7.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'epoch':'14'}
];
