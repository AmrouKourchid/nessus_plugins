...
# extracted from Fedora Security Advisory FEDORA-2023-f9877b5292
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-f9877b5292");

  script_name(english:"Fedora 39 : php-phpmailer6 (2023-f9877b5292)");
...
FEDORA-2023-f9877b5292 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-f9877b5292");
...
var pkgs = [
    {'reference':'php-phpmailer6-6.8.1-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
