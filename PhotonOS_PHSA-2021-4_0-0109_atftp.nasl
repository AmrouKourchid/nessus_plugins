...
# extracted from VMware Security Advisory PHSA-2021-4.0-0109. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Atftp PHSA-2021-4.0-0109");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the atftp package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-109.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'atftp-0.7.5-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'atftp-client-0.7.5-1.ph4')) flag++;
