...
# extracted from Fedora Security Advisory FEDORA-2023-741d5f1fd3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-741d5f1fd3");
  script_xref(name:"IAVA", value:"2023-A-0517-S");

  script_name(english:"Fedora 38 : libssh (2023-741d5f1fd3)");
...
FEDORA-2023-741d5f1fd3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-741d5f1fd3");
...
var pkgs = [
    {'reference':'libssh-0.10.5-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
