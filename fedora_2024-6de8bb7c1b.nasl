...
# extracted from Fedora Security Advisory FEDORA-2024-6de8bb7c1b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-6de8bb7c1b");

  script_name(english:"Fedora 39 : thunderbird (2024-6de8bb7c1b)");
...
FEDORA-2024-6de8bb7c1b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-6de8bb7c1b");
...
var pkgs = [
    {'reference':'thunderbird-115.12.1-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
