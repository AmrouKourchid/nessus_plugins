...
# extracted from Red Hat Security Advisory RHSA-2023:3446. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:3446");

  script_name(english:"RHEL 8 : Red Hat OpenStack Platform 16.1 (python-flask) (RHSA-2023:3446)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for Red Hat OpenStack Platform 16.1 (python-flask).");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_3446.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5a56f56f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2196643");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:3446");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat OpenStack Platform 16.1 (python-flask) package based on the guidance in RHSA-2023:3446.");
