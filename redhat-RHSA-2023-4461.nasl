...
# extracted from Red Hat Security Advisory RHSA-2023:4461. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:4461");
  script_xref(name:"IAVA", value:"2023-A-0388-S");

  script_name(english:"RHEL 7 : firefox (RHSA-2023:4461)");
...
referenced in the RHSA-2023:4461 advisory.
    ...
    * Mozilla: Memory safety bugs fixed in Firefox 116, Firefox ESR 115.1, Firefox ESR 102.14, Thunderbird
    115.1, and Thunderbird 102.14 (CVE-2023-4056)

    * Mozilla: Memory safety bugs fixed in Firefox 116, Firefox ESR 115.1, and Thunderbird 115.1
    (CVE-2023-4057)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_4461.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?400ceda7");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:4461");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL firefox package based on the guidance in RHSA-2023:4461.");
  ...
  script_cwe_id(120, 125, 20, 280, 362, 784, 829);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-102.14.0-1.el7_9', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-102.14.0-1.el7_9', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-102.14.0-1.el7_9', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-102.14.0-1.el7_9', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-102.14.0-1.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
