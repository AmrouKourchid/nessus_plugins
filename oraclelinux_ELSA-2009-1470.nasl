...
# Oracle Linux Security Advisory ELSA-2009-1470 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : openssh (ELSA-2009-1470)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2009-1470.html");
