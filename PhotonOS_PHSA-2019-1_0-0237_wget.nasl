...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Wget PHSA-2019-1.0-0237");
...
if (rpm_check(release:"PhotonOS-1.0", reference:"wget-1.20.3-1.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"wget-debuginfo-1.20.3-1.ph1")) flag++;
