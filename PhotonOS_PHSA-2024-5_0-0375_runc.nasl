...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Runc PHSA-2024-5.0-0375");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'runc-1.1.14-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'runc-doc-1.1.14-1.ph5')) flag++;
