...
# extracted from Red Hat Security Advisory RHSA-2023:5865. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_5865.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ce1e1910");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:5865");
...
"Update the RHEL grafana package based on the guidance in RHSA-2023:5865.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'grafana-7.3.6-6.el8_4', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'grafana-7.3.6-6.el8_4', 'sp':'4', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
