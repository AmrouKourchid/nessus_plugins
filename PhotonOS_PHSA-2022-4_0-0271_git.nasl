...
if (description)
{
  ...
  script_cve_id("CVE-2022-24975", "CVE-2022-39253", "CVE-2022-39260");

  script_name(english:"Photon OS 4.0: Git PHSA-2022-4.0-0271");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-24975");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'git-2.35.5-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'git-lang-2.35.5-1.ph4')) flag++;
