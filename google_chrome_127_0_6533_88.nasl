...
"The version of Google Chrome installed on the remote Windows host is prior to 127.0.6533.88. It is, therefore, affected
by multiple vulnerabilities as referenced in the 2024_07_stable-channel-update-for-desktop_30 advisory.
...
google_chrome_check_version(installs:installs, fix:'127.0.6533.88', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
