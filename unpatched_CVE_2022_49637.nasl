...
if (description)
{
  ...
  script_cve_id("CVE-2022-49637");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-49637");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: ipv4: Fix a data-race around
    sysctl_fib_sync_mem. While reading sysctl_fib_sync_mem, it can be changed concurrently. So, we need to add
    READ_ONCE() to avoid a data-race. (CVE-2022-49637)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-49637");
