...
"The version of Google Chrome installed on the remote Windows host is prior to 80.0.3987.116. It is, therefore, affected
by multiple vulnerabilities as referenced in the 2020_02_stable-channel-update-for-desktop_18 advisory. Note that Nessus
...
google_chrome_check_version(installs:installs, fix:'80.0.3987.116', severity:SECURITY_WARNING, xss:FALSE, xsrf:FALSE);
