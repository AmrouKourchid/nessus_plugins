...
the USN-5795-2 advisory.
    ...
    USN-5795-1 and 5543-1 fixed several vulnerabilities in Net-SNMP. This update provides the corresponding
    update for Ubuntu 14.04 ESM and Ubuntu 16.04 ESM.
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libsnmp-base', 'pkgver': '5.7.3+dfsg-1ubuntu4.6+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libsnmp-dev', 'pkgver': '5.7.3+dfsg-1ubuntu4.6+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libsnmp-perl', 'pkgver': '5.7.3+dfsg-1ubuntu4.6+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libsnmp30', 'pkgver': '5.7.3+dfsg-1ubuntu4.6+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'python-netsnmp', 'pkgver': '5.7.3+dfsg-1ubuntu4.6+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'snmp', 'pkgver': '5.7.3+dfsg-1ubuntu4.6+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'snmpd', 'pkgver': '5.7.3+dfsg-1ubuntu4.6+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'snmptrapd', 'pkgver': '5.7.3+dfsg-1ubuntu4.6+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'tkmib', 'pkgver': '5.7.3+dfsg-1ubuntu4.6+esm1', 'ubuntu_pro': TRUE}
];
