...
# extracted from VMware Security Advisory PHSA-2024-4.0-0595. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Python3 PHSA-2024-4.0-0595");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the python3 package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-595.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'python3-pycryptodome-3.20.0-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'python3-pycryptodomex-3.20.0-1.ph4')) flag++;
