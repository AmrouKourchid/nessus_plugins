...
referenced in the RHSA-2012:1173 advisory.
...
number.");
  ...
  # https://access.redhat.com/security/data/csaf/v2/advisories/2012/rhsa-2012_1173.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0382bb46");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2012:1173");
...
"Update the RHEL flash-plugin package based on the guidance in RHSA-2012:1173.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'flash-plugin-11.2.202.238-1.el6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
