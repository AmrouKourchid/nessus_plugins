...
"The version of Firefox installed on the remote Windows host is prior to 107.0. It is, therefore, affected by multiple
vulnerabilities as referenced in the mfsa2022-47 advisory.
...
"Upgrade to Mozilla Firefox version 107.0 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-46883");
...
mozilla_check_version(installs:installs, product:'firefox', esr:FALSE, fix:'107.0', severity:SECURITY_HOLE);
