...
# extracted from Red Hat Security Advisory RHSA-2022:0949. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:0949");

  script_name(english:"RHEL 8 : virt:av and virt-devel:av (RHSA-2022:0949)");
...
referenced in the RHSA-2022:0949 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_0949.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2afe9b28");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:0949");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2043122");
...
"Update the RHEL virt:av / virt-devel:av packages based on the guidance in RHSA-2022:0949.");
  ...
  'virt:av': [
    {
      ...
      'pkgs': [
        ...
        {'reference':'libnbd-1.6.0-5.module+el8.5.0+14157+bc4e6fb1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'libnbd-bash-completion-1.6.0-5.module+el8.5.0+14157+bc4e6fb1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'libnbd-devel-1.6.0-5.module+el8.5.0+14157+bc4e6fb1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'nbdfuse-1.6.0-5.module+el8.5.0+14157+bc4e6fb1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'nbdkit-1.24.0-3.module+el8.5.0+13900+a08c0464', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'nbdkit-bash-completion-1.24.0-3.module+el8.5.0+13900+a08c0464', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'nbdkit-basic-filters-1.24.0-3.module+el8.5.0+13900+a08c0464', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'nbdkit-basic-plugins-1.24.0-3.module+el8.5.0+13900+a08c0464', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'nbdkit-curl-plugin-1.24.0-3.module+el8.5.0+13900+a08c0464', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'nbdkit-devel-1.24.0-3.module+el8.5.0+13900+a08c0464', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'nbdkit-example-plugins-1.24.0-3.module+el8.5.0+13900+a08c0464', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'nbdkit-gzip-filter-1.24.0-3.module+el8.5.0+13900+a08c0464', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'nbdkit-gzip-plugin-1.24.0-3.module+el8.5.0+13900+a08c0464', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'nbdkit-linuxdisk-plugin-1.24.0-3.module+el8.5.0+13900+a08c0464', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'nbdkit-nbd-plugin-1.24.0-3.module+el8.5.0+13900+a08c0464', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'nbdkit-python-plugin-1.24.0-3.module+el8.5.0+13900+a08c0464', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'nbdkit-server-1.24.0-3.module+el8.5.0+13900+a08c0464', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'nbdkit-ssh-plugin-1.24.0-3.module+el8.5.0+13900+a08c0464', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'nbdkit-tar-filter-1.24.0-3.module+el8.5.0+13900+a08c0464', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'nbdkit-tar-plugin-1.24.0-3.module+el8.5.0+13900+a08c0464', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'nbdkit-tmpdisk-plugin-1.24.0-3.module+el8.5.0+13900+a08c0464', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'nbdkit-vddk-plugin-1.24.0-3.module+el8.5.0+13900+a08c0464', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'nbdkit-xz-filter-1.24.0-3.module+el8.5.0+13900+a08c0464', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'python3-libnbd-1.6.0-5.module+el8.5.0+14157+bc4e6fb1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'qemu-guest-agent-6.0.0-33.module+el8.5.0+14188+8c5ecfdd.3', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-img-6.0.0-33.module+el8.5.0+14188+8c5ecfdd.3', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kiwi-6.0.0-33.module+el8.5.0+14188+8c5ecfdd.3', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-6.0.0-33.module+el8.5.0+14188+8c5ecfdd.3', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-block-curl-6.0.0-33.module+el8.5.0+14188+8c5ecfdd.3', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-block-gluster-6.0.0-33.module+el8.5.0+14188+8c5ecfdd.3', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-block-iscsi-6.0.0-33.module+el8.5.0+14188+8c5ecfdd.3', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-block-rbd-6.0.0-33.module+el8.5.0+14188+8c5ecfdd.3', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-block-ssh-6.0.0-33.module+el8.5.0+14188+8c5ecfdd.3', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-common-6.0.0-33.module+el8.5.0+14188+8c5ecfdd.3', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-core-6.0.0-33.module+el8.5.0+14188+8c5ecfdd.3', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-docs-6.0.0-33.module+el8.5.0+14188+8c5ecfdd.3', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-hw-usbredir-6.0.0-33.module+el8.5.0+14188+8c5ecfdd.3', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-ui-opengl-6.0.0-33.module+el8.5.0+14188+8c5ecfdd.3', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-ui-spice-6.0.0-33.module+el8.5.0+14188+8c5ecfdd.3', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        ...
        {'reference':'virt-v2v-1.42.0-16.module+el8.5.0+13900+a08c0464', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'virt-v2v-bash-completion-1.42.0-16.module+el8.5.0+13900+a08c0464', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'virt-v2v-man-pages-ja-1.42.0-16.module+el8.5.0+13900+a08c0464', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'virt-v2v-man-pages-uk-1.42.0-16.module+el8.5.0+13900+a08c0464', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
      ]
    }
  ],
  'virt-devel:av': [
    {
      ...
      'pkgs': [
        ...
        {'reference':'libnbd-1.6.0-5.module+el8.5.0+14157+bc4e6fb1', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'libnbd-devel-1.6.0-5.module+el8.5.0+14157+bc4e6fb1', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'nbdfuse-1.6.0-5.module+el8.5.0+14157+bc4e6fb1', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'ocaml-libnbd-1.6.0-5.module+el8.5.0+14157+bc4e6fb1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ocaml-libnbd-devel-1.6.0-5.module+el8.5.0+14157+bc4e6fb1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'python3-libnbd-1.6.0-5.module+el8.5.0+14157+bc4e6fb1', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-libvirt-7.6.0-1.module+el8.5.0+12098+85b3670b', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'qemu-kvm-tests-6.0.0-33.module+el8.5.0+14188+8c5ecfdd.3', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
