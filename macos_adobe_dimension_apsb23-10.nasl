...
if (description)
{
  ...
  script_name(english:"Adobe Dimension < 3.4.7 Multiple Memory leak (APSB23-10) (macOS)");

  script_set_attribute(attribute:"synopsis", value:
"The Adobe Dimension instance installed on the remote host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Dimension installed on the remote macOS host is prior to 3.4.7. It is, therefore, affected by
