...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2010-0825.html");
...
var pkgs = [
    {'reference':'mysql-5.0.77-4.el5_5.4', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'mysql-bench-5.0.77-4.el5_5.4', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'mysql-devel-5.0.77-4.el5_5.4', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'mysql-server-5.0.77-4.el5_5.4', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'mysql-test-5.0.77-4.el5_5.4', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'mysql-5.0.77-4.el5_5.4', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'mysql-bench-5.0.77-4.el5_5.4', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'mysql-devel-5.0.77-4.el5_5.4', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'mysql-server-5.0.77-4.el5_5.4', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'mysql-test-5.0.77-4.el5_5.4', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
