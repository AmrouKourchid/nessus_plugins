...
# extracted from Red Hat Security Advisory RHSA-2023:4838. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:4838");

  script_name(english:"RHEL 9 : cups (RHSA-2023:4838)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_4838.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?eaa5e097");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2230495");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:4838");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL cups package based on the guidance in RHSA-2023:4838.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:cups-printerapp");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cups-2.3.3op2-16.el9_2.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'cups-client-2.3.3op2-16.el9_2.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'cups-devel-2.3.3op2-16.el9_2.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'cups-filesystem-2.3.3op2-16.el9_2.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'cups-ipptool-2.3.3op2-16.el9_2.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'cups-libs-2.3.3op2-16.el9_2.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'cups-lpd-2.3.3op2-16.el9_2.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'cups-printerapp-2.3.3op2-16.el9_2.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'cups-2.3.3op2-16.el9_2.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'cups-client-2.3.3op2-16.el9_2.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'cups-devel-2.3.3op2-16.el9_2.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'cups-filesystem-2.3.3op2-16.el9_2.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'cups-ipptool-2.3.3op2-16.el9_2.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'cups-libs-2.3.3op2-16.el9_2.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'cups-lpd-2.3.3op2-16.el9_2.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'cups-printerapp-2.3.3op2-16.el9_2.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
