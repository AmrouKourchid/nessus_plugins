...
if (description)
{
  ...
  script_name(english:"AIX (IJ36805)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AIX host is missing a security patch.");
  script_set_attribute(attribute:"description", value:
"The version of AIX installed on the remote host is prior to APAR IJ36805. It is, therefore, affected by a vulnerability
as referenced in the IJ36805 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/apar/IJ36805");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/node/6538952");
  script_set_attribute(attribute:"solution", value:
"Please apply the appropriate interim fix per APAR IJ36805.");
...
var constraints = [
    {'release': '7.1', 'ml': '05', 'sp': '07', 'patch': 'IJ36805s9a', 'package': 'bos.rte.security', 'minfilesetver': '7.1.5.0', 'maxfilesetver': '7.1.5.37'},
    {'release': '7.1', 'ml': '05', 'sp': '08', 'patch': 'IJ36805s9a', 'package': 'bos.rte.security', 'minfilesetver': '7.1.5.0', 'maxfilesetver': '7.1.5.37'},
    {'release': '7.1', 'ml': '05', 'sp': '09', 'patch': 'IJ36805s9a', 'package': 'bos.rte.security', 'minfilesetver': '7.1.5.0', 'maxfilesetver': '7.1.5.37'}
];
