...
# extracted from Fedora Security Advisory FEDORA-2023-e714897e70
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-e714897e70");

  script_name(english:"Fedora 36 : netatalk (2023-e714897e70)");
...
FEDORA-2023-e714897e70 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-e714897e70");
...
var pkgs = [
    {'reference':'netatalk-3.1.14-3.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'epoch':'5'}
];
