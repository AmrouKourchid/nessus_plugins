...
if (description)
{
  ...
  script_name(english:"CentOS 9 : nodejs-nodemon-2.0.20-3.el9");
...
nodemon-2.0.20-3.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=31360");
...
var pkgs = [
    {'reference':'nodejs-nodemon-2.0.20-3.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
