...
# extracted from Fedora Security Advisory FEDORA-2023-04d519d0b3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-04d519d0b3");

  script_name(english:"Fedora 38 : qt5-qtbase (2023-04d519d0b3)");
...
FEDORA-2023-04d519d0b3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-04d519d0b3");
...
var pkgs = [
    {'reference':'qt5-qtbase-5.15.10-5.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
