...
# SUSE update advisory SUSE-SU-2023:0455-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:0455-1");

  script_name(english:"SUSE SLES12 Security Update : ucode-intel (SUSE-SU-2023:0455-1)");
...
referenced in the SUSE-SU-2023:0455-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-February/013844.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?683b6eec");
...
var pkgs = [
    {'reference':'ucode-intel-20230214-13.104.1', 'sp':'4', 'cpu':'x86_64', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.4']},
    {'reference':'ucode-intel-20230214-13.104.1', 'sp':'2', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-bcl-release-12.2']},
    {'reference':'ucode-intel-20230214-13.104.1', 'sp':'4', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.4']}
];
