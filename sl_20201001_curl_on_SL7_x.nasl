...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : curl on SL7.x x86_64 (20201001)");
...
"Security Fix(es) :
  ...
  - curl: heap buffer overflow in function
    tftp_receive_packet() (CVE-2019-5482)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind2010&L=SCIENTIFIC-LINUX-ERRATA&P=7114
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0c3a9e3c");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"curl-7.29.0-59.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"curl-debuginfo-7.29.0-59.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"libcurl-7.29.0-59.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"libcurl-devel-7.29.0-59.el7")) flag++;
