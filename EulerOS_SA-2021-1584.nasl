...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.6.0 : libssh (EulerOS-SA-2021-1584)");
...
by the following vulnerability :
  ...
  - libssh 0.9.4 has a NULL pointer dereference in
    tftpserver.c if ssh_buffer_new returns
    NULL.(CVE-2020-16135)
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1584
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?95dab34b");
...
pkgs = ["libssh-0.8.3-3.h5.eulerosv2r8"];
