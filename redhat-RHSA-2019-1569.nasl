...
# extracted from Red Hat Security Advisory RHSA-2019:1569. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:1569");

  script_name(english:"RHEL 7 : redhat-virtualization-host (RHSA-2019:1569)");
...
the RHSA-2019:1569 advisory.
    ...
    (4.3), redhat-virtualization-host (4.3).
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_1569.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?84b571dd");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:1569");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1663567");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1695560");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1710394");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL redhat-virtualization-host package based on the guidance in RHSA-2019:1569.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'redhat-release-virtualization-host-4.3-0.8.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'},
      {'reference':'redhat-virtualization-host-image-update-4.3-20190610.0.el7_6', 'release':'7', 'el_string':'el7_6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'},
      {'reference':'redhat-virtualization-host-image-update-placeholder-4.3-0.8.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'}
    ]
  }
];
