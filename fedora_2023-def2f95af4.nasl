...
# extracted from Fedora Security Advisory FEDORA-2023-def2f95af4
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-def2f95af4");

  script_name(english:"Fedora 39 : stb / usd (2023-def2f95af4)");
...
FEDORA-2023-def2f95af4 advisory.

    Security fix for CVE-2023-45661 CVE-2023-45662 CVE-2023-45663 CVE-2023-45664 CVE-2023-45666 CVE-2023-45667
    CVE-2023-45675 CVE-2023-43281

    ----

    A new parallel-installable stb_image_resize2 library is added (stb_image_resize2-devel). It should provide
    significantly better performance; the API is similar but not compatible. The original stb_image_resize
    library is deprecated by the author, but will continue to be packaged as stb_image_resize-devel for the
    foreseeable future.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-def2f95af4");
...
var pkgs = [
    {'reference':'stb-0^20231011gitbeebb24-12.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'usd-23.08-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
