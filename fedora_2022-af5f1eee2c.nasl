...
# extracted from Fedora Security Advisory FEDORA-2022-af5f1eee2c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-af5f1eee2c");

  script_name(english:"Fedora 37 : xterm (2022-af5f1eee2c)");
...
FEDORA-2022-af5f1eee2c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-af5f1eee2c");
...
var pkgs = [
    {'reference':'xterm-375-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
