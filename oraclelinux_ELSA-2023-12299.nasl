...
# extracted from Oracle Linux Security Advisory ELSA-2023-12299.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : cloud-init (ELSA-2023-12299)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-12299.html");
...
var pkgs = [
    {'reference':'cloud-init-22.1-7.0.3.el9_1', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
