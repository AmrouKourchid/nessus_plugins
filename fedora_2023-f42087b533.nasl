...
# extracted from Fedora Security Advisory FEDORA-2023-f42087b533
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-f42087b533");

  script_name(english:"Fedora 37 : qt5-qtbase (2023-f42087b533)");
...
FEDORA-2023-f42087b533 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-f42087b533");
...
var pkgs = [
    {'reference':'qt5-qtbase-5.15.9-3.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
