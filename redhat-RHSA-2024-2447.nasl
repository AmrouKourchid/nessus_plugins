...
# extracted from Red Hat Security Advisory RHSA-2024:2447. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2447");

  script_name(english:"RHEL 9 : openssl and openssl-fips-provider (RHSA-2024:2447)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for openssl / openssl-fips-provider.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:2447 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c2463fc0");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2447");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2223016");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2257571");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2258502");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2259944");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-14083");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-15990");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-17104");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-17193");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-1780");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-20249");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-5295");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-5304");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL openssl / openssl-fips-provider packages based on the guidance in RHSA-2024:2447.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openssl-3.0.7-27.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'openssl-devel-3.0.7-27.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'openssl-libs-3.0.7-27.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'openssl-perl-3.0.7-27.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
