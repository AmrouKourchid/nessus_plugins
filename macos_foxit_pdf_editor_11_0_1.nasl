...
if (description)
{
  ...
  script_name(english:"Foxit PDF Editor < 11.0.1 Multiple Vulnerabilities (macOS)");

  script_set_attribute(attribute:"synopsis", value:
"A PDF toolkit installed on the remote macOS host is affected by multiple vulnerabilities");
  script_set_attribute(attribute:"description", value:
"The version of Foxit PDF Editor for Mac (previously named Foxit PhantomPDF for Mac) installed on the remote macOS host is prior to 11.0.1. It is, therefore,
affected by multiple vulnerabilities:

  - Multiple remote code execution vulnerabilities exist in Foxit PDF Editor due to use-after-free errors when
  ...
  - A remote code execution vulnerability exists in Foxit PDF Editor due to a use-after-free error in handling
...
"Upgrade to Foxit PDF Editor for Mac version 11.0.1 or later");
