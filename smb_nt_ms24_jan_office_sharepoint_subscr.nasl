...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5002540");
  script_xref(name:"MSFT", value:"MS23-5002540");
  script_xref(name:"IAVA", value:"2024-A-0013-S");

  script_name(english:"Security Updates for Microsoft SharePoint Server Subscription Edition (January 2024)");
...
It is, therefore, affected by the following vulnerability:
  ...
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002540");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released KB5002540 to address this issue.");
