...
# extracted from Amazon Linux 2023 Security Advisory ALAS2023-2023-196.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2023 : cloud-init (ALAS2023-2023-196)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2023 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"It is, therefore, affected by a vulnerability as referenced in the ALAS2023-2023-196 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2023/ALAS-2023-196.html");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/cve/html/CVE-2023-1786.html");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/faqs.html");
  script_set_attribute(attribute:"solution", value:
"Run 'dnf update cloud-init --releasever 2023.0.20230607' to update your system.");
...
var pkgs = [
    {'reference':'cloud-init-22.2.2-1.amzn2023.1.8', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
