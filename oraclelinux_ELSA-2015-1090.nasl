...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2015-1090.html");
...
"Update the affected wpa_supplicant package.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2015-4142");
...
var pkgs = [
    {'reference':'wpa_supplicant-2.0-17.el7_1', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
