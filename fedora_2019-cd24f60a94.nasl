...
# extracted from Fedora Security Advisory FEDORA-2019-cd24f60a94.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : cobbler (2019-cd24f60a94)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-cd24f60a94");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"cobbler-2.8.5-0.1.fc29")) flag++;
