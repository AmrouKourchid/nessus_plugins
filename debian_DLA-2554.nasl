...
# extracted from Debian Security Advisory DLA-2554-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2554-1 : firejail security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2021/02/msg00015.html");
...
flag = 0;
if (deb_check(release:"9.0", prefix:"firejail", reference:"0.9.44.8-2+deb9u2")) flag++;
