...
# SUSE update advisory SUSE-SU-2023:1859-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:1859-1");

  script_name(english:"openSUSE 15 Security Update : golang-github-prometheus-prometheus (SUSE-SU-2023:1859-1)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9bd24611");
...
var pkgs = [
    {'reference':'firewalld-prometheus-config-0.1-150100.4.12.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.4']},
    {'reference':'golang-github-prometheus-prometheus-2.32.1-150100.4.12.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.4']}
];
