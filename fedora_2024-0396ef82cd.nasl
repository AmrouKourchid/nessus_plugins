...
# extracted from Fedora Security Advisory FEDORA-2024-0396ef82cd
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-0396ef82cd");

  script_name(english:"Fedora 40 : python-fastapi (2024-0396ef82cd)");
...
FEDORA-2024-0396ef82cd advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-0396ef82cd");
  script_set_attribute(attribute:"solution", value:
"Update the affected python-fastapi package.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:N/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-24762");
...
var pkgs = [
    {'reference':'python-fastapi-0.109.1-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python-fastapi');
}
