...
# extracted from Ubuntu Security Notice USN-5517-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5517-1");

  script_name(english:"Ubuntu 20.04 LTS : Linux kernel (OEM) vulnerabilities (USN-5517-1)");
...
the USN-5517-1 advisory.
    ...
    service (system crash). (CVE-2022-34494)

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5517-1");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.14.0-1045-oem");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-5517-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2022-1679', 'CVE-2022-34494');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-5517-1');
  }
  else
  {
