...
# extracted from Red Hat Security Advisory RHSA-2020:1686. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:1686");

  script_name(english:"RHEL 8 : libmspack (RHSA-2020:1686)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for libmspack.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2020:1686 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_1686.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?33e3b1c8");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/8.2_release_notes/index
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dd7b3f20");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:1686");
...
"Update the RHEL libmspack package based on the guidance in RHSA-2020:1686.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libmspack-0.7-0.3.alpha.el8.4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libmspack-devel-0.7-0.3.alpha.el8.4', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
