...
# extracted from Fedora Security Advisory FEDORA-2019-d645f4337d.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-d645f4337d");

  script_name(english:"Fedora 29 : webkit2gtk3 (2019-d645f4337d)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-d645f4337d");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"webkit2gtk3-2.22.6-1.fc29")) flag++;
