...
if (description)
{
  ...
  script_name(english:"Apache Tomcat 8.5.0 < 8.5.99 multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Apache Tomcat server is affected by multiple vulnerabilities");
  script_set_attribute(attribute:"description", value:
"The version of Tomcat installed on the remote host is prior to 8.5.99. It is, therefore, affected by multiple
vulnerabilities as referenced in the fixed_in_apache_tomcat_8.5.99_security-8 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?464cee83");
  # https://github.com/apache/tomcat/commit/0cac540a882220231ba7a82330483cbd5f6b1f96
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?30ae8c2d");
  # https://tomcat.apache.org/security-8.html#Fixed_in_Apache_Tomcat_8.5.99
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e43f5fcc");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Apache Tomcat version 8.5.99 or later.");
...
var constraints = [
  { 'min_version' : '8.5.0', 'max_version' : '8.5.98', 'fixed_version' : '8.5.99' }
];
