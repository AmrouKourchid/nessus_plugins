...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : python-paramiko (EulerOS-SA-2022-1947)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the python-paramiko packages installed, the EulerOS installation on the remote host is
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1947
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5f8dfb4b");
...
var pkgs = [
  "python2-paramiko-2.4.1-5.h2.eulerosv2r8",
  "python3-paramiko-2.4.1-5.h2.eulerosv2r8"
];
