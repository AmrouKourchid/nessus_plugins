...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.2 : sudo (EulerOS-SA-2023-1296)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1296
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3a37bae2");
...
var pkgs = [
  "sudo-1.8.19p2-14.h9.eulerosv2r7"
];
