...
# extracted from Red Hat Security Advisory RHSA-2024:0022. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:0022");
  script_xref(name:"IAVA", value:"2023-A-0702-S");

  script_name(english:"RHEL 9 : firefox (RHSA-2024:0022)");
...
referenced in the RHSA-2024:0022 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0022.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?982717ae");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0022");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL firefox package based on the guidance in RHSA-2024:0022.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-115.6.0-1.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
