...
# extracted from Fedora Security Advisory FEDORA-2023-eec2cdb7ed
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-eec2cdb7ed");
  script_xref(name:"IAVA", value:"2023-A-0650-S");

  script_name(english:"Fedora 38 : vim (2023-eec2cdb7ed)");
...
FEDORA-2023-eec2cdb7ed advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-eec2cdb7ed");
...
var pkgs = [
    {'reference':'vim-9.0.2120-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
