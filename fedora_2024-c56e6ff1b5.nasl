...
# extracted from Fedora Security Advisory FEDORA-2024-c56e6ff1b5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-c56e6ff1b5");

  script_name(english:"Fedora 39 : buildah (2024-c56e6ff1b5)");
...
FEDORA-2024-c56e6ff1b5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-c56e6ff1b5");
...
"Update the affected buildah package.");
  ...
  script_set_attribute(attribute:"plugin_publication_date", value:"2024/05/19");
...
var pkgs = [
    {'reference':'buildah-1.35.4-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
