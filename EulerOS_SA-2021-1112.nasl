...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : poppler (EulerOS-SA-2021-1112)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1112
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fbb258ce");
...
pkgs = ["poppler-0.26.5-17.h22",
        "poppler-glib-0.26.5-17.h22",
        "poppler-qt-0.26.5-17.h22",
        "poppler-utils-0.26.5-17.h22"];
