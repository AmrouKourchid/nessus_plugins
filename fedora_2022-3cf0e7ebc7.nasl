...
# extracted from Fedora Security Advisory FEDORA-2022-3cf0e7ebc7
#
...
if (description)
{
  ...
  script_cve_id("CVE-2022-43680", "CVE-2022-44638");
  script_xref(name:"FEDORA", value:"2022-3cf0e7ebc7");

  script_name(english:"Fedora 36 : mingw-pixman (2022-3cf0e7ebc7)");
...
FEDORA-2022-3cf0e7ebc7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-3cf0e7ebc7");
  script_set_attribute(attribute:"solution", value:
"Update the affected mingw-pixman package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:mingw-pixman");
...
var pkgs = [
    {'reference':'mingw-pixman-0.42.2-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'mingw-pixman');
}
