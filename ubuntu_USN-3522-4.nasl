...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : Linux kernel (Xenial HWE) regression (USN-3522-4)");
...
USN-3522-4 advisory.
    ...
    USN-3522-2 fixed a vulnerability in the Linux Hardware Enablement kernel for Ubuntu 14.04 LTS to address
    Meltdown (CVE-2017-5754). Unfortunately, that update introduced a regression where a few systems failed to
    boot successfully. This update fixes the problem.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3522-4");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-3522-4');
}
