...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS : libssh vulnerability (USN-4327-1)");
...
USN-4327-1 advisory.
    ...
    Yasheng Yang discovered that libssh incorrectly handled AES-CTR ciphers. A remote attacker could possibly
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4327-1");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'libssh-4', 'pkgver': '0.8.0~20170825.94fa1e38-1ubuntu0.6'},
    {'osver': '18.04', 'pkgname': 'libssh-dev', 'pkgver': '0.8.0~20170825.94fa1e38-1ubuntu0.6'},
    {'osver': '18.04', 'pkgname': 'libssh-gcrypt-4', 'pkgver': '0.8.0~20170825.94fa1e38-1ubuntu0.6'},
    {'osver': '18.04', 'pkgname': 'libssh-gcrypt-dev', 'pkgver': '0.8.0~20170825.94fa1e38-1ubuntu0.6'}
];
