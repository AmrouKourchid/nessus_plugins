...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : uboot-tools (EulerOS-SA-2022-2832)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2832
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f9dc4a09");
...
var pkgs = [
  "uboot-tools-2020.07-2.h5.eulerosv2r10",
  "uboot-tools-help-2020.07-2.h5.eulerosv2r10"
];
