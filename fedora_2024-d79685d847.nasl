...
# extracted from Fedora Security Advisory FEDORA-2024-d79685d847
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-d79685d847");

  script_name(english:"Fedora 39 : yarnpkg (2024-d79685d847)");
...
FEDORA-2024-d79685d847 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-d79685d847");
...
var pkgs = [
    {'reference':'yarnpkg-1.22.22-5.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
