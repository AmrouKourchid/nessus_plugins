...
# extracted from Fedora Security Advisory FEDORA-2024-d273b23c67
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-d273b23c67");
  script_xref(name:"IAVA", value:"2024-A-0581-S");

  script_name(english:"Fedora 40 : chromium (2024-d273b23c67)");
...
FEDORA-2024-d273b23c67 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-d273b23c67");
...
var pkgs = [
    {'reference':'chromium-129.0.6668.58-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
