...
# extracted from Red Hat Security Advisory RHSA-2025:1757. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:1757");

  script_name(english:"RHEL 8 : mysql:8.0 (RHSA-2025:1757)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for mysql:8.0.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2025:1757 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_1757.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2aa65ce9");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:1757");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL mysql:8.0 package based on the guidance in RHSA-2025:1757.");
  ...
  'mysql:8.0': [
    {
      ...
      'pkgs': [
        {'reference':'mecab-0.996-2.module+el8.8.0+18436+8918dd75', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mecab-devel-0.996-2.module+el8.8.0+18436+8918dd75', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mecab-ipadic-2.7.0.20070801-16.module+el8.0.0+3898+e09bb8de', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mecab-ipadic-EUCJP-2.7.0.20070801-16.module+el8.0.0+3898+e09bb8de', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mysql-8.0.40-1.module+el8.8.0+22863+a1071e1e', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mysql-common-8.0.40-1.module+el8.8.0+22863+a1071e1e', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mysql-devel-8.0.40-1.module+el8.8.0+22863+a1071e1e', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mysql-errmsg-8.0.40-1.module+el8.8.0+22863+a1071e1e', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mysql-libs-8.0.40-1.module+el8.8.0+22863+a1071e1e', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mysql-server-8.0.40-1.module+el8.8.0+22863+a1071e1e', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mysql-test-8.0.40-1.module+el8.8.0+22863+a1071e1e', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
