...
if (description)
{
  ...
  script_name(english:"CentOS 9 : openssl-3.2.2-4.el9");
...
openssl-3.2.2-4.el9 build changelog.

  - SSL_select_next_proto buffer overread (CVE-2024-5535)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=67704");
...
var pkgs = [
    {'reference':'openssl-3.2.2-4.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'openssl-devel-3.2.2-4.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'openssl-libs-3.2.2-4.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'openssl-perl-3.2.2-4.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
