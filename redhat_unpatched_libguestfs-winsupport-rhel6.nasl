...
# extracted from Red Hat Security Advisory libguestfs-winsupport. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 6 : libguestfs-winsupport (Unpatched Vulnerability) (deprecated)");
