...
# AlmaLinux Security Advisory ALSA-2024:7346.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:7346");

  script_name(english:"AlmaLinux 9 : cups-filters (ALSA-2024:7346)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 9 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ALSA-2024:7346 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2024-7346.html");
...
var pkgs = [
    {'reference':'cups-filters-1.28.7-17.el9_4', 'release':'9', 'el_string':'el9_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'cups-filters-devel-1.28.7-17.el9_4', 'release':'9', 'el_string':'el9_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'cups-filters-libs-1.28.7-17.el9_4', 'release':'9', 'el_string':'el9_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'}
];
