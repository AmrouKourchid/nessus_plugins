...
# extracted from Red Hat Security Advisory RHSA-2018:3249. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:3249");

  script_name(english:"RHEL 7 : setup (RHSA-2018:3249)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for setup.");
...
the RHSA-2018:3249 advisory.

    The setup package contains a set of important default system configuration and setup files. Examples
    include /etc/passwd, /etc/group, and /etc/profile. Other examples are the default lists of reserved user
    IDs, reserved ports, reserved protocols, allowed shells, allowed secure terminals.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2018/rhsa-2018_3249.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b2277eb3");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:3249");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1566469");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1571094");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL setup package based on the guidance in RHSA-2018:3249.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:setup");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'setup-2.8.71-10.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
