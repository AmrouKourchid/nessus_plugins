...
# extracted from SUSE update advisory SUSE-SU-2020:1523-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES15 Security Update : qemu (SUSE-SU-2020:1523-1)");
...
without introducing additional issues.");
  ...
  # https://www.suse.com/support/update/announcement/2020/suse-su-20201523-1/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9cc6798e");
...
flag = 0;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"qemu-2.11.2-9.36.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"qemu-block-curl-2.11.2-9.36.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"qemu-block-curl-debuginfo-2.11.2-9.36.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"qemu-block-iscsi-2.11.2-9.36.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"qemu-block-iscsi-debuginfo-2.11.2-9.36.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"qemu-block-rbd-2.11.2-9.36.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"qemu-block-rbd-debuginfo-2.11.2-9.36.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"qemu-block-ssh-2.11.2-9.36.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"qemu-block-ssh-debuginfo-2.11.2-9.36.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"qemu-debuginfo-2.11.2-9.36.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"qemu-debugsource-2.11.2-9.36.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"qemu-guest-agent-2.11.2-9.36.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"qemu-guest-agent-debuginfo-2.11.2-9.36.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"qemu-kvm-2.11.2-9.36.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"qemu-lang-2.11.2-9.36.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"qemu-s390-2.11.2-9.36.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"qemu-s390-debuginfo-2.11.2-9.36.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"qemu-tools-2.11.2-9.36.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"qemu-tools-debuginfo-2.11.2-9.36.1")) flag++;
