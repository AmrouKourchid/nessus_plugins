...
# extracted from Fedora Security Advisory FEDORA-2024-fd2569c4e9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-fd2569c4e9");

  script_name(english:"Fedora 39 : glib2 / gnome-shell (2024-fd2569c4e9)");
...
FEDORA-2024-fd2569c4e9 advisory.

    Resolve CVE-2024-34397 (GDBus signal subscriptions for well-known names are vulnerable to unicast
    spoofing), and also update gnome-shell to ensure this fix does not break the screencast feature.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-fd2569c4e9");
  script_set_attribute(attribute:"solution", value:
"Update the affected glib2 and / or gnome-shell packages.");
...
var pkgs = [
    {'reference':'glib2-2.78.6-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'gnome-shell-45.6-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'glib2 / gnome-shell');
}
