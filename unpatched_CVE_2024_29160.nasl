...
if (description)
{
  ...
  script_cve_id("CVE-2024-29160");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-29160");
...
patch available.
  ...
  - HDF5 through 1.14.3 contains a heap buffer overflow in H5HG__cache_heap_deserialize, resulting in the
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-29160");
