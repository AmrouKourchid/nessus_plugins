...
# extracted from Fedora Security Advisory FEDORA-2024-cdccda4f62
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-cdccda4f62");
  script_xref(name:"IAVA", value:"2024-A-0068");

  script_name(english:"Fedora 39 : sudo (2024-cdccda4f62)");
...
FEDORA-2024-cdccda4f62 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-cdccda4f62");
...
var pkgs = [
    {'reference':'sudo-1.9.15-1.p5.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
