...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS : Linux kernel regression (USN-4369-2)");
...
USN-4369-2 advisory.
    ...
    USN-4369-1 fixed vulnerabilities in the 5.3 Linux kernel. Unfortunately, that update introduced a
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4369-2");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-4369-2');
}
