...
# extracted from Red Hat Security Advisory RHSA-2018:1690. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:1690");
  script_xref(name:"IAVA", value:"2018-A-0170");

  script_name(english:"RHEL 7 : Virtualization (RHSA-2018:1690) (Spectre)");
...
else
{
  ...
  if (rpm_check(release:"RHEL7", reference:"vdsm-4.17.45-1.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-cli-4.17.45-1.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-debug-plugin-4.17.45-1.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-hook-ethtool-options-4.17.45-1.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-hook-fcoe-4.17.45-1.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-hook-macspoof-4.17.45-1.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-hook-openstacknet-4.17.45-1.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-hook-vhostmd-4.17.45-1.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-hook-vmfex-dev-4.17.45-1.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-infra-4.17.45-1.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-jsonrpc-4.17.45-1.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-python-4.17.45-1.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-xmlrpc-4.17.45-1.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-yajsonrpc-4.17.45-1.el7")) flag++;
