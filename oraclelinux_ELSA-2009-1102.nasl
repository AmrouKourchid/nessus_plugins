...
# Oracle Linux Security Advisory ELSA-2009-1102 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : cscope (ELSA-2009-1102)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2009-1102.html");
...
"Update the affected cscope package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2009-0148");
...
var pkgs = [
    {'reference':'cscope-15.5-15.1.el5_3.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cscope-15.5-15.1.el5_3.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
