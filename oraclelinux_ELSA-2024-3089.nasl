...
# extracted from Oracle Linux Security Advisory ELSA-2024-3089.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : gstreamer1-plugins-good (ELSA-2024-3089)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
ELSA-2024-3089 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-3089.html");
