...
# extracted from Red Hat Security Advisory nodejs-handlebars. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2021-23369", "CVE-2021-23383");

  script_name(english:"RHEL 7 : nodejs-handlebars (Unpatched Vulnerability) (deprecated)");
