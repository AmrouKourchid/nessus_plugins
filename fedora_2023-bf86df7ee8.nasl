...
# extracted from Fedora Security Advisory FEDORA-2023-bf86df7ee8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-bf86df7ee8");

  script_name(english:"Fedora 37 : syncthing (2023-bf86df7ee8)");
...
FEDORA-2023-bf86df7ee8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-bf86df7ee8");
...
var pkgs = [
    {'reference':'syncthing-1.23.5-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
