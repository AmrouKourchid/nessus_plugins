...
# Oracle Linux Security Advisory ELSA-2011-1851 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : krb5 (ELSA-2011-1851)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2011-1851.html");
