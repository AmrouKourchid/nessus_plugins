...
# extracted from Fedora Security Advisory FEDORA-2023-609db87741
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-609db87741");

  script_name(english:"Fedora 36 : rnp (2023-609db87741)");
...
FEDORA-2023-609db87741 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-609db87741");
  script_set_attribute(attribute:"solution", value:
"Update the affected rnp package.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:C/I:N/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:N/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-29480");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:rnp");
...
var pkgs = [
    {'reference':'rnp-0.16.3-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'rnp');
}
