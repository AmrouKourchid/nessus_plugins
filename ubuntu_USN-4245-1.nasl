...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS : PySAML2 vulnerability (USN-4245-1)");
...
in the USN-4245-1 advisory.

    It was discovered that PySAML2 incorrectly handled certain SAML files. An attacker could possibly use this
    issue to bypass signature verification with arbitrary data.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4245-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'python-pysaml2', 'pkgver': '3.0.0-3ubuntu1.16.04.4'},
    {'osver': '16.04', 'pkgname': 'python3-pysaml2', 'pkgver': '3.0.0-3ubuntu1.16.04.4'},
    {'osver': '18.04', 'pkgname': 'python-pysaml2', 'pkgver': '4.0.2-0ubuntu3.1'},
    {'osver': '18.04', 'pkgname': 'python3-pysaml2', 'pkgver': '4.0.2-0ubuntu3.1'}
];
