...
# extracted from Red Hat Security Advisory RHSA-2025:1075. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:1075");

  script_name(english:"RHEL 8 : libsoup (RHSA-2025:1075)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for libsoup.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2025:1075 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_1075.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d91d3eb0");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:1075");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libsoup package based on the guidance in RHSA-2025:1075.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libsoup-2.62.3-3.el8_8.2', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsoup-devel-2.62.3-3.el8_8.2', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
