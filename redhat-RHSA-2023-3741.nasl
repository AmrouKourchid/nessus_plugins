...
# extracted from Red Hat Security Advisory RHSA-2023:3741. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:3741");

  script_name(english:"RHEL 7 : c-ares (RHSA-2023:3741)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for c-ares.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2023:3741 advisory.

    The c-ares C library defines asynchronous DNS (Domain Name System) requests and provides name resolving
    API.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_3741.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7ad98592");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2209502");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:3741");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL c-ares package based on the guidance in RHSA-2023:3741.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:c-ares");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:c-ares-devel");
...
var constraints = [
  {
    ...
    'pkgs': [
      ...
      {'reference':'c-ares-1.10.0-3.el7_9.1', 'cpu':'ppc', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'c-ares-1.10.0-3.el7_9.1', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'c-ares-1.10.0-3.el7_9.1', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'c-ares-1.10.0-3.el7_9.1', 'cpu':'s390', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'c-ares-1.10.0-3.el7_9.1', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'c-ares-devel-1.10.0-3.el7_9.1', 'cpu':'ppc', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'c-ares-devel-1.10.0-3.el7_9.1', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'c-ares-devel-1.10.0-3.el7_9.1', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'c-ares-devel-1.10.0-3.el7_9.1', 'cpu':'s390', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'c-ares-devel-1.10.0-3.el7_9.1', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
