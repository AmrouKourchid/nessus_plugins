...
# extracted from Fedora Security Advisory FEDORA-2022-d680c70ebe
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-d680c70ebe");

  script_name(english:"Fedora 36 : samba (2022-d680c70ebe)");
...
FEDORA-2022-d680c70ebe advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-d680c70ebe");
...
var pkgs = [
    {'reference':'samba-4.16.7-0.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
