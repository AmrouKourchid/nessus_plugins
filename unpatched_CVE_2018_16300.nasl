...
if (description)
{
  ...
  script_cve_id("CVE-2018-16300");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2018-16300 (deprecated)");
...
"n/a");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-16300");
