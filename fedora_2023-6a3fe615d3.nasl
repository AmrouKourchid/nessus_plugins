...
# extracted from Fedora Security Advisory FEDORA-2023-6a3fe615d3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-6a3fe615d3");

  script_name(english:"Fedora 39 : bluez (2023-6a3fe615d3)");
...
FEDORA-2023-6a3fe615d3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-6a3fe615d3");
...
var pkgs = [
    {'reference':'bluez-5.70-5.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
