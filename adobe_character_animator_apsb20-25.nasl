...
if (description)
{
  ...
  script_name(english:"Adobe Character Animator 3.0 < 3.3 Arbitrary code execution (APSB20-25)");
...
"The version of Adobe Character Animator installed on the remote Windows host is prior to 3.3. It is, therefore, affected
