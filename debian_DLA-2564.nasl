...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2021/02/msg00028.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/stretch/php-horde-text-filter");
  # https://security-tracker.debian.org/tracker/source-package/php-horde-text-filter
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b9957030");
  script_set_attribute(attribute:"solution", value:
"Upgrade the affected php-horde-text-filter package.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:N/I:P/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:R/S:C/C:L/I:L/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-26929");
