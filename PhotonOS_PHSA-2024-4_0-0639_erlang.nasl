...
# extracted from VMware Security Advisory PHSA-2024-4.0-0639. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Erlang PHSA-2024-4.0-0639");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the erlang package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-639.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'erlang-26.2.5-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'erlang-sd_notify-1.1-3.ph4')) flag++;
