...
# SUSE update advisory SUSE-SU-2023:0220-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:0220-1");

  script_name(english:"openSUSE 15 Security Update : tmux (SUSE-SU-2023:0220-1)");
...
SU-2023:0220-1 advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1207393");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2022-47016");
  # https://lists.suse.com/pipermail/sle-security-updates/2023-February/013614.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4433c955");
...
var pkgs = [
    {'reference':'tmux-3.1c-150300.3.3.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.4']}
];
