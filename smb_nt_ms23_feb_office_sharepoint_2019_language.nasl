...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5002342");
  script_xref(name:"MSFT", value:"MS23-5002342");

  script_name(english:"Security Updates for Microsoft SharePoint Server 2019 (February 2023)");
...
"The Microsoft SharePoint Server 2019 installation on the remote host is missing security 
updates. It is, therefore, affected by multiple vulnerabilities:
  ...
  - An elevation of privilege vulnerability. An attacker can
    ...
    (CVE-2023-21717)");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002342");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released KB5002342 to address this issue.");
