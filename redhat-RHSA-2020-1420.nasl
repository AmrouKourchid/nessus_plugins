...
# extracted from Red Hat Security Advisory RHSA-2020:1420. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:1420");
  script_xref(name:"IAVA", value:"2020-A-0128-S");

  script_name(english:"RHEL 7 : firefox (RHSA-2020:1420)");
...
referenced in the RHSA-2020:1420 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_1420.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?71d952a8");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:1420");
...
"Update the RHEL firefox package based on the guidance in RHSA-2020:1420.");
  ...
  script_set_attribute(attribute:"plugin_publication_date", value:"2020/04/09");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-68.7.0-2.el7_8', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-68.7.0-2.el7_8', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-68.7.0-2.el7_8', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-68.7.0-2.el7_8', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-68.7.0-2.el7_8', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
