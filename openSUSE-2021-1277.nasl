...
# openSUSE Security Update openSUSE-SU-2021:1277-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : apache2-mod_auth_openidc (openSUSE-SU-2021:1277-1)");
...
the openSUSE-SU-2021:1277-1 advisory.
...
number.");
  ...
  # https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/4FGDDGUNYC724M4QGEPJORKASFRVKJ5V/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?58355c9b");
...
var pkgs = [
    {'reference':'apache2-mod_auth_openidc-2.3.8-lp152.5.6.1', 'cpu':'x86_64', 'release':'SUSE15.2', 'rpm_spec_vers_cmp':TRUE}
];
