...
# extracted from Fedora Security Advisory FEDORA-2024-b72131479b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-b72131479b");
  script_xref(name:"IAVB", value:"2024-B-0001-S");

  script_name(english:"Fedora 39 : wireshark (2024-b72131479b)");
...
FEDORA-2024-b72131479b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-b72131479b");
...
var pkgs = [
    {'reference':'wireshark-4.0.12-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
