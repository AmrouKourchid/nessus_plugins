...
# extracted from Red Hat Security Advisory RHSA-2024:8928. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:8928");

  script_name(english:"RHEL 9 : mod_jk (RHSA-2024:8928)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-65726");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_8928.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?30dee180");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:8928");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL mod_jk package based on the guidance in RHSA-2024:8928.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'mod_jk-1.2.50-1.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
