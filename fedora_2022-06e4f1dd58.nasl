...
# extracted from Fedora Security Advisory FEDORA-2022-06e4f1dd58
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-06e4f1dd58");

  script_name(english:"Fedora 36 : vim (2022-06e4f1dd58)");
...
FEDORA-2022-06e4f1dd58 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-06e4f1dd58");
...
var pkgs = [
    {'reference':'vim-9.0.828-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
