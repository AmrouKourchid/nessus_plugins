...
"The remote Red Hat host is missing a security update for .NET Core on Red Hat Enterprise Linux 8.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_2471.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?30970252");
...
"Update the RHEL .NET Core on Red Hat Enterprise Linux 8 package based on the guidance in RHSA-2020:2471.");
