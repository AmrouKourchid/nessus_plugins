...
# extracted from the Oracle CPU for apr2021.
#
include("compat.inc");
...
if (description)
{
  ...
  script_cve_id("CVE-2021-2192");
  script_xref(name:"IAVA", value:"2021-A-0190-S");
  script_xref(name:"CEA-ID", value:"CEA-2021-0025");

  script_name(english:"Oracle Solaris Critical Patch Update : apr2021_SRU11_4_30_88_3");
  script_summary(english:"Check for the apr2021 CPU");
...
security update :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.oracle.com/epmos/faces/DocumentDisplay?id=2765282.1"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.oracle.com/a/tech/docs/cpuapr2021cvrf.xml"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"solution",
    value:"Install the apr2021 CPU from the Oracle support website."
  );
...
fix_release = "11.4-11.4.30.0.1.88.3";

flag = 0;

if (solaris_check_release(release:"11.4-11.4.30.0.1.88.3", sru:"11.4.30.88.3") > 0) flag++;
