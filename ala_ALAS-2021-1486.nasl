...
"Run 'yum update cloud-init' to update your system.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2021-3429");
...
var pkgs = [
    {'reference':'cloud-init-0.7.6-43.23.amzn1', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
