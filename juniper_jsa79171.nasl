...
if (description)
{
  ...
  script_cve_id("CVE-2024-30380");
  script_xref(name:"JSA", value:"JSA79171");
  script_xref(name:"IAVA", value:"2024-A-0232");

  script_name(english:"Juniper Junos OS Vulnerability (JSA79171)");

  script_set_attribute(attribute:"synopsis", value:
"The remote device is missing a vendor-supplied security patch.");
  script_set_attribute(attribute:"description", value:
"The version of Junos OS installed on the remote host is affected by a vulnerability as referenced in the JSA79171
advisory.

  - An Improper Handling of Exceptional Conditions vulnerability in Juniper Networks Junos OS and Junos OS
    Evolved allows an adjacent unauthenticated attacker to cause a Denial of Service (DoS), which causes the
    l2cpd process to crash by sending a specific TLV. (CVE-2024-30380)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://supportportal.juniper.net/JSA79171");
  # https://supportportal.juniper.net/s/article/2024-04-Security-Bulletin-Junos-OS-and-Junos-OS-Evolved-l2cpd-crash-upon-receipt-of-a-specific-TLV-CVE-2024-30380
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a4c2a525");
  script_set_attribute(attribute:"solution", value:
"Apply the relevant Junos software release referenced in Juniper advisory JSA79171");
  script_set_cvss_base_vector("CVSS2#AV:A/AC:L/Au:N/C:N/I:N/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:A/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-30380");
...
var vuln_ranges = [
  ...
  {'min_ver':'22.4', 'fixed_ver':'22.4R2-S2-EVO'},
  {'min_ver':'22.4R3', 'fixed_ver':'22.4R3-EVO'},
  {'min_ver':'23.2', 'fixed_ver':'23.2R1-S1', 'fixed_display':'23.2R1-S1, 23.2R2'},
  {'min_ver':'23.2', 'fixed_ver':'23.2R1-S1-EVO', 'fixed_display':'23.2R1-S1-EVO, 23.2R2-EVO'}
];
