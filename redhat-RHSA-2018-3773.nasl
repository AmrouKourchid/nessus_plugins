...
# extracted from Red Hat Security Advisory RHSA-2018:3773. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:3773");

  script_name(english:"RHEL 7 : ansible (RHSA-2018:3773)");
...
the RHSA-2018:3773 advisory.
    ...
    * ansible: become password logged in plaintext when used with PowerShell on Windows (CVE-2018-16859)
    ...
    See https://github.com/ansible/ansible/blob/v2.7.4/changelogs/CHANGELOG-v2.7.rst for details on bug fixes
    in this release.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2018/rhsa-2018_3773.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?919c2cd3");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:3773");
...
"Update the RHEL ansible package based on the guidance in RHSA-2018:3773.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ansible-2.7.4-1.el7ae', 'release':'7', 'el_string':'el7ae', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2.7'}
    ]
  }
];
