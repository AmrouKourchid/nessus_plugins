...
# extracted from Oracle Linux Security Advisory ELSA-2023-7190.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : avahi (ELSA-2023-7190)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
ELSA-2023-7190 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-7190.html");
...
var pkgs = [
    ...
    {'reference':'avahi-autoipd-0.7-21.el8', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'avahi-tools-0.7-21.el8', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'python3-avahi-0.7-21.el8', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
