...
# extracted from Fedora Security Advisory FEDORA-2024-053b8330a1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-053b8330a1");
  script_xref(name:"IAVB", value:"2024-B-0074-S");

  script_name(english:"Fedora 40 : ghostscript (2024-053b8330a1)");
...
FEDORA-2024-053b8330a1 advisory.

    Security fix for CVE-2024-33869
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-053b8330a1");
...
var pkgs = [
    {'reference':'ghostscript-10.02.1-12.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
