...
# extracted from Fedora Security Advisory FEDORA-2022-61d8e8d880
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-61d8e8d880");

  script_name(english:"Fedora 35 : pypy3.9 (2022-61d8e8d880)");
...
FEDORA-2022-61d8e8d880 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-61d8e8d880");
...
var pkgs = [
    {'reference':'pypy3.9-7.3.9-4.3.9.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
