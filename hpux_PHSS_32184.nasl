...
# extracted from HP patch PHSS_32184. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_32184 : s700_800 11.04 Virtualvault 4.5 OWS update");
...
"Install patch PHSS_32184 or subsequent.");
...
{
  exit(0, "The host is not affected since PHSS_32184 applies to a different OS release.");
}

patches = make_list("PHSS_32184", "PHSS_33396", "PHSS_34119", "PHSS_35107", "PHSS_35461", "PHSS_35556");
