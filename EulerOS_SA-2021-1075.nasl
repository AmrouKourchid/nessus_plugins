...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : ipa (EulerOS-SA-2021-1075)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1075
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?857d324c");
...
"Update the affected ipa package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-12169");
...
pkgs = ["ipa-admintools-4.4.0-14.4.h7",
        "ipa-client-4.4.0-14.4.h7",
        "ipa-client-common-4.4.0-14.4.h7",
        "ipa-common-4.4.0-14.4.h7",
        "ipa-server-4.4.0-14.4.h7",
        "ipa-server-common-4.4.0-14.4.h7",
        "ipa-server-dns-4.4.0-14.4.h7",
        "ipa-server-trust-ad-4.4.0-14.4.h7",
        "python2-ipaclient-4.4.0-14.4.h7",
        "python2-ipalib-4.4.0-14.4.h7",
        "python2-ipaserver-4.4.0-14.4.h7"];
