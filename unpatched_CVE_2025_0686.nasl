...
if (description)
{
  ...
  script_cve_id("CVE-2025-0686");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2025-0686");
...
patch available.
  ...
  - A flaw was found in grub2. When performing a symlink lookup from a romfs filesystem, grub's romfs
    ...
    critical data and can result in arbitrary code execution by-passing secure boot protections.
    (CVE-2025-0686)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-0686");
