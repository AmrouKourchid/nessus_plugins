...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : curl (EulerOS-SA-2022-2238)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2238
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6199a179");
...
var pkgs = [
  "curl-7.71.1-4.h14.eulerosv2r10",
  "libcurl-7.71.1-4.h14.eulerosv2r10"
];
