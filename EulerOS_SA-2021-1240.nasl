...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : zziplib (EulerOS-SA-2021-1240)");
...
vulnerabilities :
  ...
  - The zzip_mem_entry_new function in memdisk.c in zziplib
    0.13.62 allows remote attackers to cause a denial of
    service (NULL pointer dereference and crash) via a
    crafted ZIP file.(CVE-2017-5980)
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1240
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ecf80d0f");
...
pkgs = ["zziplib-0.13.62-11.h2.eulerosv2r7"];
