...
# extracted from Red Hat Security Advisory RHSA-2022:0473. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:0473");

  script_name(english:"RHEL 7 : aide (RHSA-2022:0473)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for aide.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_0473.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9bd7c6b7");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:0473");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2041489");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL aide package based on the guidance in RHSA-2022:0473.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'aide-0.15.1-13.el7_9.1', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'aide-0.15.1-13.el7_9.1', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'aide-0.15.1-13.el7_9.1', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'aide-0.15.1-13.el7_9.1', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
