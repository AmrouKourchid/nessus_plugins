...
# extracted from Fedora Security Advisory FEDORA-2024-e4b1b4eab1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-e4b1b4eab1");

  script_name(english:"Fedora 39 : python-pillow (2024-e4b1b4eab1)");
...
FEDORA-2024-e4b1b4eab1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-e4b1b4eab1");
...
var pkgs = [
    {'reference':'python-pillow-10.3.0-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
