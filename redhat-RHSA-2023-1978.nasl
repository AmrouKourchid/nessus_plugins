...
# extracted from Red Hat Security Advisory RHSA-2023:1978. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:1978");

  script_name(english:"RHEL 9 : haproxy (RHSA-2023:1978)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for haproxy.");
...
referenced in the RHSA-2023:1978 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_1978.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d31b3429");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:1978");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL haproxy package based on the guidance in RHSA-2023:1978.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'haproxy-2.4.7-2.el9_0.2', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
