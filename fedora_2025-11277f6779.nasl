...
# extracted from Fedora Security Advisory FEDORA-2025-11277f6779
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-11277f6779");

  script_name(english:"Fedora 40 : mediawiki (2025-11277f6779)");
...
FEDORA-2025-11277f6779 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-11277f6779");
...
var pkgs = [
    {'reference':'mediawiki-1.41.5-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
