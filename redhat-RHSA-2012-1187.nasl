...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2012/rhsa-2012_1187.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?831cad6d");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?931a46b2");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2012:1187");
...
"Update the RHEL katello package based on the guidance in RHSA-2012:1187.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'katello-common-0.3.4-1.el6_2', 'release':'6', 'el_string':'el6_2', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'katello-glue-candlepin-0.3.4-1.el6_2', 'release':'6', 'el_string':'el6_2', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
