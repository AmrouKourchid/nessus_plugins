...
# extracted from Fedora Security Advisory FEDORA-2020-e45cf8ea43.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : tcpreplay (2020-e45cf8ea43)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-e45cf8ea43");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"tcpreplay-4.3.3-3.fc31")) flag++;
