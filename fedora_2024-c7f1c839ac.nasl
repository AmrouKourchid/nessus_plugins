...
# extracted from Fedora Security Advisory FEDORA-2024-c7f1c839ac
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-c7f1c839ac");

  script_name(english:"Fedora 38 : mbedtls (2024-c7f1c839ac)");
...
FEDORA-2024-c7f1c839ac advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-c7f1c839ac");
...
var pkgs = [
    {'reference':'mbedtls-2.28.7-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
