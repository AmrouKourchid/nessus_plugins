...
# extracted from Fedora Security Advisory FEDORA-2024-b266d38c44
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-b266d38c44");
  script_xref(name:"IAVA", value:"2024-A-0769-S");
  script_xref(name:"IAVA", value:"2025-A-0079-S");

  script_name(english:"Fedora 41 : firefox / nss (2024-b266d38c44)");
...
FEDORA-2024-b266d38c44 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-b266d38c44");
  script_set_attribute(attribute:"solution", value:
"Update the affected firefox and / or nss packages.");
...
var pkgs = [
    {'reference':'firefox-133.0-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'nss-3.106.0-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'firefox / nss');
}
