...
# extracted from Oracle Linux Security Advisory ELSA-2011-1615.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : virt-v2v (ELSA-2011-1615)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2011-1615.html");
