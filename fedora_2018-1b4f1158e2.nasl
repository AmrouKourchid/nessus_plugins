...
# extracted from Fedora Security Advisory FEDORA-2018-1b4f1158e2.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 26 : 1:compat-openssl10 (2018-1b4f1158e2)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-1b4f1158e2");
...
flag = 0;
if (rpm_check(release:"FC26", reference:"compat-openssl10-1.0.2o-1.fc26", epoch:"1")) flag++;
