...
# extracted from Fedora Security Advisory FEDORA-2022-50482009d5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-50482009d5");

  script_name(english:"Fedora 37 : drupal7-context (2022-50482009d5)");
...
FEDORA-2022-50482009d5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-50482009d5");
...
var pkgs = [
    {'reference':'drupal7-context-3.11-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
