...
# extracted from Fedora Security Advisory FEDORA-2022-b5d2f7f8f2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-b5d2f7f8f2");

  script_name(english:"Fedora 36 : zziplib (2022-b5d2f7f8f2)");
...
FEDORA-2022-b5d2f7f8f2 advisory.

    Automatic update for zziplib-0.13.72-1.fc36.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-b5d2f7f8f2");
...
var pkgs = [
    {'reference':'zziplib-0.13.72-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
