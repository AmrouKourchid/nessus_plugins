...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : vim on SL6.x i386/x86_64 (20190715)");
...
"Security Fix(es) :
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1907&L=SCIENTIFIC-LINUX-ERRATA&P=5054
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f461cec4");
...
flag = 0;
if (rpm_check(release:"SL6", reference:"vim-X11-7.4.629-5.el6_10.2")) flag++;
if (rpm_check(release:"SL6", reference:"vim-common-7.4.629-5.el6_10.2")) flag++;
if (rpm_check(release:"SL6", reference:"vim-debuginfo-7.4.629-5.el6_10.2")) flag++;
if (rpm_check(release:"SL6", reference:"vim-enhanced-7.4.629-5.el6_10.2")) flag++;
if (rpm_check(release:"SL6", reference:"vim-filesystem-7.4.629-5.el6_10.2")) flag++;
if (rpm_check(release:"SL6", reference:"vim-minimal-7.4.629-5.el6_10.2")) flag++;
