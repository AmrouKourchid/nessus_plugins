...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.6 : krb5 (EulerOS-SA-2021-1414)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the version of the krb5 package installed, the EulerOS
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1414
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?408d521d");
...
pkgs = ["krb5-libs-1.15.1-34.h6.eulerosv2r7"];
