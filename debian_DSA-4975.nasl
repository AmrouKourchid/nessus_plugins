...
advisory.
    ...
    The following vulnerabilities have been discovered in the webkit2gtk web engine: CVE-2021-30858 An
    ...
    distribution (buster), this problem has been fixed in version 2.32.4-1~deb10u1. For the stable
    distribution (bullseye), this problem has been fixed in version 2.32.4-1~deb11u1. We recommend that you
