...
# extracted from Red Hat Security Advisory cpio. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2014-9112", "CVE-2015-1197", "CVE-2016-2037");

  script_name(english:"RHEL 5 : cpio (Unpatched Vulnerability) (deprecated)");
