...
if (description)
{
  ...
  script_cve_id("CVE-2017-2839");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2017-2839");
...
patch available.
  ...
  - An exploitable denial of service vulnerability exists within the handling of challenge packets in FreeRDP
    ...
    this vulnerability. (CVE-2017-2839)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-2839");
