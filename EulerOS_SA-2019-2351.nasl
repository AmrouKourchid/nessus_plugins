...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.3.0 : libsndfile (EulerOS-SA-2019-2351)");
...
affected by the following vulnerabilities :
  ...
  - It was discovered the fix for CVE-2018-19758
    (libsndfile) was not complete and still allows a read
    beyond the limits of a buffer in wav_write_header()
    function in wav.c. A local attacker may use this flaw
    to make the application crash.(CVE-2019-3832)

  - An issue was discovered in libsndfile 1.0.28. There is
    a buffer over-read in the function i2alaw_array in
    alaw.c that will lead to a denial of
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2351
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b828dd56");
...
pkgs = ["libsndfile-1.0.28-9.h4.eulerosv2r8"];
