...
# extracted from Gentoo Linux Security Advisory GLSA 202311-07.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202311-07 : AIDE: Root Privilege Escalation");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202311-07 (AIDE: Root Privilege Escalation)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202311-07");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=831658");
...
"All AIDE users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:aide");
...
var packages = [
  {
    ...
    'unaffected' : make_list("ge 0.17.4"),
    'vulnerable' : make_list("lt 0.17.4")
  }
];
