...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : libwebp (EulerOS-SA-2024-1149)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1149
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c004f0c8");
...
var pkgs = [
  "libwebp-0.3.0-7.h5.eulerosv2r7"
];
