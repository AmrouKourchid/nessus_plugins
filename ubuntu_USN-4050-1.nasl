...
# extracted from Ubuntu Security Notice USN-4050-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"4050-1");

  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS : ZeroMQ vulnerability (USN-4050-1)");
...
in the USN-4050-1 advisory.

    It was discovered that ZeroMQ incorrectly handled certain application metadata. A remote attacker could
    use this issue to cause ZeroMQ to crash, or possibly execute arbitrary code.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4050-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libzmq3-dev', 'pkgver': '4.1.4-7ubuntu0.1'},
    {'osver': '16.04', 'pkgname': 'libzmq5', 'pkgver': '4.1.4-7ubuntu0.1'},
    {'osver': '18.04', 'pkgname': 'libzmq3-dev', 'pkgver': '4.2.5-1ubuntu0.2'},
    {'osver': '18.04', 'pkgname': 'libzmq5', 'pkgver': '4.2.5-1ubuntu0.2'}
];
