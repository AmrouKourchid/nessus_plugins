...
if (description)
{
  ...
  script_cve_id("CVE-2022-49544");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-49544");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: ipw2x00: Fix potential NULL
    dereference in libipw_xmit() crypt and crypt->ops could be null, so we need to checking null before
    dereference (CVE-2022-49544)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-49544");
