...
# extracted from F5 Networks BIG-IP Solution K20134942.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2018-5527");

  script_name(english:"F5 Networks BIG-IP : SSL Forward Proxy vulnerability (K20134942)");
...
This vulnerability allows a remote attacker to disrupt service.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K20134942");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K20134942.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:N/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-5527");
