...
# extracted from SUSE update advisory SUSE-SU-2018:2342-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : kernel (SUSE-SU-2018:2342-1) (Foreshadow)");
...
without introducing additional issues.");
  ...
  # https://www.suse.com/support/update/announcement/2018/suse-su-20182342-1/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b7f6aac0");
...
SUSE-SLE-SERVER-12-2018-1585=1");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"0", cpu:"x86_64", reference:"kgraft-patch-3_12_61-52_133-default-3-2.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", cpu:"x86_64", reference:"kgraft-patch-3_12_61-52_133-xen-3-2.1")) flag++;
