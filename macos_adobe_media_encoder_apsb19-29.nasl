...
if (description)
{
  ...
  script_name(english:"Adobe Media Encoder < 13.1.0 Multiple Vulnerabilities (APSB19-29) (macOS)");

  script_set_attribute(attribute:"synopsis", value:
"The Adobe Media Encoder instance installed on the remote host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Media Encoder installed on the remote macOS host is prior to 13.1.0. It is, therefore, affected by
multiple vulnerabilities as referenced in the APSB19-29 advisory.
