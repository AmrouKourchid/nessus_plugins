...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : libreoffice (EulerOS-SA-2020-2551)");
...
vulnerabilities :
  ...
  - The SwCTBWrapper::Read function in
    sw/source/filter/ww8/ww8toolbar.cxx in LibreOffice
    before 5.4.6.1 and 6.x before 6.0.2.1 does not validate
    a customizations index, which allows remote attackers
    to cause a denial of service (heap-based buffer
    overflow with write access) or possibly have
    unspecified other impact via a crafted document that
    contains a certain Microsoft Word
    record.(CVE-2018-10120)

  - An information disclosure vulnerability occurs when
    LibreOffice 6.0.3 and Apache OpenOffice Writer 4.1.5
    automatically process and initiate an SMB connection
    embedded in a malicious file, as demonstrated by
    xlink:href=file://192.168.0.2/test.jpg within an
    office:document-content element in a .odt XML
    document.(CVE-2018-10583)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2551
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f084f81c");
...
pkgs = ["autocorr-en-5.3.6.1-10.h4.eulerosv2r7",
        "libreoffice-calc-5.3.6.1-10.h4.eulerosv2r7",
        "libreoffice-core-5.3.6.1-10.h4.eulerosv2r7",
        "libreoffice-data-5.3.6.1-10.h4.eulerosv2r7",
        "libreoffice-draw-5.3.6.1-10.h4.eulerosv2r7",
        "libreoffice-filters-5.3.6.1-10.h4.eulerosv2r7",
        "libreoffice-graphicfilter-5.3.6.1-10.h4.eulerosv2r7",
        "libreoffice-gtk2-5.3.6.1-10.h4.eulerosv2r7",
        "libreoffice-gtk3-5.3.6.1-10.h4.eulerosv2r7",
        "libreoffice-impress-5.3.6.1-10.h4.eulerosv2r7",
        "libreoffice-langpack-en-5.3.6.1-10.h4.eulerosv2r7",
        "libreoffice-math-5.3.6.1-10.h4.eulerosv2r7",
        "libreoffice-opensymbol-fonts-5.3.6.1-10.h4.eulerosv2r7",
        "libreoffice-pdfimport-5.3.6.1-10.h4.eulerosv2r7",
        "libreoffice-pyuno-5.3.6.1-10.h4.eulerosv2r7",
        "libreoffice-ure-5.3.6.1-10.h4.eulerosv2r7",
        "libreoffice-ure-common-5.3.6.1-10.h4.eulerosv2r7",
        "libreoffice-writer-5.3.6.1-10.h4.eulerosv2r7",
        "libreoffice-x11-5.3.6.1-10.h4.eulerosv2r7",
        "libreoffice-xsltfilter-5.3.6.1-10.h4.eulerosv2r7",
        "libreofficekit-5.3.6.1-10.h4.eulerosv2r7"];
