...
# extracted from Fedora Security Advisory FEDORA-2019-72755db9c7.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : sudo (2019-72755db9c7)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-72755db9c7");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"sudo-1.8.28-1.fc29")) flag++;
