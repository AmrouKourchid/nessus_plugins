...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Libtiff PHSA-2019-2.0-0131");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libtiff-4.0.10-3.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libtiff-debuginfo-4.0.10-3.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libtiff-devel-4.0.10-3.ph2')) flag++;
