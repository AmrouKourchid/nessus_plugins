...
# extracted from Fedora Security Advisory FEDORA-2023-b3a0ad6718
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-b3a0ad6718");

  script_name(english:"Fedora 37 : python3.10 (2023-b3a0ad6718)");
...
FEDORA-2023-b3a0ad6718 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-b3a0ad6718");
...
var pkgs = [
    {'reference':'python3.10-3.10.13-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
