...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : python-pillow (EulerOS-SA-2020-1877)");
...
following vulnerabilities :
  ...
  - libImaging/SgiRleDecode.c in Pillow before 6.2.2 has an
    SGI buffer overflow.(CVE-2020-5311)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1877
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2ee21cc5");
...
"Update the affected python-pillow packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-5311");
...
pkgs = ["python2-pillow-5.3.0-1.h4.eulerosv2r8",
        "python3-pillow-5.3.0-1.h4.eulerosv2r8"];
