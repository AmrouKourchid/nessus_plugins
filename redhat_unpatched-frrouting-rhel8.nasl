...
# extracted from Red Hat Security Advisory frrouting. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2022-26125", "CVE-2022-26126");

  script_name(english:"RHEL 8 : frrouting (Unpatched Vulnerability) (deprecated)");
...
"This plugin has been deprecated as it does not adhere to established standards for this style of check.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-26126");
