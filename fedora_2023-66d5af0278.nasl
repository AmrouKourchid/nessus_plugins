...
# extracted from Fedora Security Advisory FEDORA-2023-66d5af0278
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-66d5af0278");

  script_name(english:"Fedora 37 : tigervnc (2023-66d5af0278)");
...
FEDORA-2023-66d5af0278 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-66d5af0278");
...
var pkgs = [
    {'reference':'tigervnc-1.13.1-3.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
