...
# extracted from Fedora Security Advisory FEDORA-2025-b332afed45
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-b332afed45");

  script_name(english:"Fedora 41 : valkey (2025-b332afed45)");
...
FEDORA-2025-b332afed45 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-b332afed45");
...
var pkgs = [
    {'reference':'valkey-8.0.2-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
