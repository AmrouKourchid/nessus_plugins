...
# extracted from Amazon Linux 2023 Security Advisory ALAS2023-2023-105.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2023 : bcel, bcel-javadoc (ALAS2023-2023-105)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2023 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"It is, therefore, affected by a vulnerability as referenced in the ALAS2023-2023-105 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2023/ALAS-2023-105.html");
...
"Run 'dnf update bcel --releasever=2023.0.20230222 ' to update your system.");
...
var pkgs = [
    {'reference':'bcel-6.5.0-3.amzn2023.0.2', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'bcel-javadoc-6.5.0-3.amzn2023.0.2', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE}
];
