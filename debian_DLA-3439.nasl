...
# extracted from Debian Security Advisory dla-3439. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3439 : libwebp-dev - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3439
advisory.
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libwebp-dev', 'reference': '0.6.1-2+deb10u2'},
    {'release': '10.0', 'prefix': 'libwebp6', 'reference': '0.6.1-2+deb10u2'},
    {'release': '10.0', 'prefix': 'libwebpdemux2', 'reference': '0.6.1-2+deb10u2'},
    {'release': '10.0', 'prefix': 'libwebpmux3', 'reference': '0.6.1-2+deb10u2'},
    {'release': '10.0', 'prefix': 'webp', 'reference': '0.6.1-2+deb10u2'}
];
