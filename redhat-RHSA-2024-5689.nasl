...
# extracted from Red Hat Security Advisory RHSA-2024:5689. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:5689");

  script_name(english:"RHEL 9 : python3.9 (RHSA-2024:5689)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8e17d9e6");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2276518");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:5689");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python3.9 package based on the guidance in RHSA-2024:5689.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python-unversioned-command-3.9.10-4.el9_0.4', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-3.9.10-4.el9_0.4', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-devel-3.9.10-4.el9_0.4', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-libs-3.9.10-4.el9_0.4', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-tkinter-3.9.10-4.el9_0.4', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
