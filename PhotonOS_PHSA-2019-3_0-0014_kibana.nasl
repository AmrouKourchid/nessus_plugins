...
if (description)
{
  ...
  script_cve_id("CVE-2019-7608", "CVE-2019-7610");

  script_name(english:"Photon OS 3.0: Kibana PHSA-2019-3.0-0014");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'kibana-6.7.0-1.ph3')) flag++;
