...
if (description)
{
  ...
  script_cve_id("CVE-2023-0045");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2023-0045 (deprecated)");
...
"n/a");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2023-0045");
