...
# extracted from Debian Security Advisory dla-2869. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2869-1 : xorg-server - LTS security update");
...
dla-2869 advisory.
    ...
    Jan-Niklas Sohn discovered that multiple input validation failures in X server extensions of the X.org X
    server may result in privilege escalation if the X server is running privileged. For Debian 9 stretch,
    these problems have been fixed in version 2:1.19.2-1+deb9u9. We recommend that you upgrade your xorg-
    server packages. For the detailed security status of xorg-server please refer to its security tracker page
    at: https://security-tracker.debian.org/tracker/xorg-server Further information about Debian LTS security
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2021/dla-2869");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/stretch/xorg-server");
...
var pkgs = [
    {'release': '9.0', 'prefix': 'xdmx', 'reference': '2:1.19.2-1+deb9u9'},
    {'release': '9.0', 'prefix': 'xdmx-tools', 'reference': '2:1.19.2-1+deb9u9'},
    {'release': '9.0', 'prefix': 'xnest', 'reference': '2:1.19.2-1+deb9u9'},
    {'release': '9.0', 'prefix': 'xorg-server-source', 'reference': '2:1.19.2-1+deb9u9'},
    {'release': '9.0', 'prefix': 'xserver-common', 'reference': '2:1.19.2-1+deb9u9'},
    {'release': '9.0', 'prefix': 'xserver-xephyr', 'reference': '2:1.19.2-1+deb9u9'},
    {'release': '9.0', 'prefix': 'xserver-xorg-core', 'reference': '2:1.19.2-1+deb9u9'},
    {'release': '9.0', 'prefix': 'xserver-xorg-dev', 'reference': '2:1.19.2-1+deb9u9'},
    {'release': '9.0', 'prefix': 'xserver-xorg-legacy', 'reference': '2:1.19.2-1+deb9u9'},
    {'release': '9.0', 'prefix': 'xvfb', 'reference': '2:1.19.2-1+deb9u9'},
    {'release': '9.0', 'prefix': 'xwayland', 'reference': '2:1.19.2-1+deb9u9'}
];
