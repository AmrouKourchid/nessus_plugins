...
if (description)
{
  ...
  script_cve_id("CVE-2021-36052");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2021-36052");
...
patch available.
  ...
  - XMP Toolkit version 2020.1 (and earlier) is affected by a memory corruption vulnerability, potentially
    ...
    exploit this vulnerability. (CVE-2021-36052)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-36052");
