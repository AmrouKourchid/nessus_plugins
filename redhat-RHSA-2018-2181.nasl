...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_2181.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?eeafbb3f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:2181");
...
"Update the RHEL gnupg2 package based on the guidance in RHSA-2018:2181.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gnupg2-2.0.22-5.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gnupg2-smime-2.0.22-5.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
