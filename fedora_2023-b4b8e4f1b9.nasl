...
# extracted from Fedora Security Advisory FEDORA-2023-b4b8e4f1b9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-b4b8e4f1b9");
  script_xref(name:"IAVA", value:"2023-A-0388-S");

  script_name(english:"Fedora 38 : firefox (2023-b4b8e4f1b9)");
...
FEDORA-2023-b4b8e4f1b9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-b4b8e4f1b9");
...
var pkgs = [
    {'reference':'firefox-116.0-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
