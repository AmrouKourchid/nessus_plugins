...
# extracted from Red Hat Security Advisory RHSA-2024:3030. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_3030.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?45cb8bfa");
...
"Update the RHEL libsndfile package based on the guidance in RHSA-2024:3030.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libsndfile-1.0.28-14.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsndfile-devel-1.0.28-14.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsndfile-utils-1.0.28-14.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
