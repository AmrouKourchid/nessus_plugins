...
# extracted from Fedora Security Advisory FEDORA-2025-212be26bd1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-212be26bd1");

  script_name(english:"Fedora 41 : python3.12 (2025-212be26bd1)");
...
FEDORA-2025-212be26bd1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-212be26bd1");
...
var pkgs = [
    {'reference':'python3.12-3.12.9-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python3.12');
}
