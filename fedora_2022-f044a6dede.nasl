...
# extracted from Fedora Security Advisory FEDORA-2022-f044a6dede
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-f044a6dede");

  script_name(english:"Fedora 35 : firefox (2022-f044a6dede)");
...
FEDORA-2022-f044a6dede advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-f044a6dede");
...
var pkgs = [
    {'reference':'firefox-97.0-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
