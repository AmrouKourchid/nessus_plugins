...
# extracted from openSUSE Security Update openSUSE-2020-734.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : jasper (openSUSE-2020-734)");
...
This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1092115");
...
if ( rpm_check(release:"SUSE15.1", reference:"jasper-2.0.14-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"jasper-debuginfo-2.0.14-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"jasper-debugsource-2.0.14-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libjasper-devel-2.0.14-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libjasper4-2.0.14-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libjasper4-debuginfo-2.0.14-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libjasper4-32bit-2.0.14-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libjasper4-32bit-debuginfo-2.0.14-lp151.4.6.1") ) flag++;
