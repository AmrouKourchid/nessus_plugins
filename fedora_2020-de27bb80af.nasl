...
# extracted from Fedora Security Advisory FEDORA-2020-de27bb80af.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : 1:xpdf (2020-de27bb80af)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-de27bb80af");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"xpdf-4.02-4.fc31", epoch:"1")) flag++;
