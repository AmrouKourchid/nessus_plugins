...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.3 : ntp (EulerOS-SA-2019-1207)");
...
following vulnerability :
  ...
  - The ntpq and ntpdc command-line utilities that are part
    ...
    application.i1/4^CVE-2018-12327i1/4%0

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1207
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?36811f7e");
...
pkgs = ["ntp-4.2.6p5-25.0.1.h17",
        "ntpdate-4.2.6p5-25.0.1.h17",
        "sntp-4.2.6p5-25.0.1.h17"];
