...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Zlib PHSA-2022-4.0-0171");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'zlib-1.2.11-3.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'zlib-devel-1.2.11-3.ph4')) flag++;
