...
# extracted from Red Hat Security Advisory butane. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2022-1705", "CVE-2022-30630");

  script_name(english:"RHEL 9 : butane (Unpatched Vulnerability) (deprecated)");
