...
if (description)
{
  ...
  script_name(english:"Microsoft Windows 10 1709 Home SEoL");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Microsoft Windows is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"Microsoft Windows 10 1709 Home is no longer maintained by its vendor or provider.
...
var constraints = [
  { seol : 20201013, cpe_attributes : [{'edition': 'home*'}] }
];
