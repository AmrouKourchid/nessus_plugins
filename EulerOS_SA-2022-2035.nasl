...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.0 : python3 (EulerOS-SA-2022-2035)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2035
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b73c691b");
...
var pkgs = [
  "python3-3.7.9-9.h20.eulerosv2r10",
  "python3-unversioned-command-3.7.9-9.h20.eulerosv2r10"
];
