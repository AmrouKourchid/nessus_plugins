...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 ESM / 18.04 LTS : Linux kernel vulnerability (USN-5014-1)");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-5014-1');
}
