...
# extracted from Fedora Security Advisory FEDORA-2024-9eb3674b7c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-9eb3674b7c");
  script_xref(name:"IAVA", value:"2024-A-0395");

  script_name(english:"Fedora 39 : cockpit (2024-9eb3674b7c)");
...
FEDORA-2024-9eb3674b7c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-9eb3674b7c");
...
var pkgs = [
    {'reference':'cockpit-320-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
