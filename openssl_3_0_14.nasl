...
if (description)
{
  ...
  script_name(english:"OpenSSL 3.0.0 < 3.0.14 Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote service is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of OpenSSL installed on the remote host is prior to 3.0.14. It is, therefore, affected by multiple
vulnerabilities as referenced in the 3.0.14 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?141a6242");
  # https://github.com/openssl/openssl/commit/b3f0eb0a295f58f16ba43ba99dad70d4ee5c437d
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2cbb1fb1");
  # https://github.com/openssl/openssl/commit/b52867a9f618bb955bed2a3ce3db4d4f97ed8e5d
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8409be15");
