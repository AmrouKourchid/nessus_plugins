...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Xerces PHSA-2025-5.0-0480");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'xerces-c-3.3.0-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'xerces-c-devel-3.3.0-1.ph5')) flag++;
