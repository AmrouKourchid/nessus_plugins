...
# extracted from Red Hat Security Advisory RHSA-2024:1880. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:1880");

  script_name(english:"RHEL 8 : nodejs:18 (RHSA-2024:1880)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for nodejs:18.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:1880 advisory.
    ...
    * nodejs:18/nodejs: reading unprocessed HTTP request with unbounded chunk extension allows DoS attacks
    (CVE-2024-22019)

    * nodejs:18/nodejs: vulnerable to timing variant of the Bleichenbacher attack against PKCS#1 v1.5 padding
    (Marvin) (CVE-2023-46809)
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_1880.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e34fd59e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:1880");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL nodejs:18 package based on the guidance in RHSA-2024:1880.");
  ...
  'nodejs:18': [
    {
      ...
      'pkgs': [
        {'reference':'nodejs-18.19.1-1.module+el8.8.0+21592+14a8b93e', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-devel-18.19.1-1.module+el8.8.0+21592+14a8b93e', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-docs-18.19.1-1.module+el8.8.0+21592+14a8b93e', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-full-i18n-18.19.1-1.module+el8.8.0+21592+14a8b93e', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-nodemon-3.0.1-1.module+el8.8.0+19757+8ca87034', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'nodejs-packaging-2021.06-4.module+el8.7.0+15582+19c314fa', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'nodejs-packaging-bundler-2021.06-4.module+el8.7.0+15582+19c314fa', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'npm-10.2.4-1.18.19.1.1.module+el8.8.0+21592+14a8b93e', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
      ]
    }
  ]
};
