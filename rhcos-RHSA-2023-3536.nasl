...
if (description)
{
  ...
  script_name(english:"RHCOS 4 : OpenShift Container Platform 4.13.3 (RHSA-2023:3536)");
...
as referenced in the RHSA-2023:3536 advisory.
...
var pkgs = [
    {'reference':'NetworkManager-1.42.2-2.el9_2', 'release':'4', 'el_string':'el9_2', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openshift-hyperkube'},
    {'reference':'NetworkManager-adsl-1.42.2-2.el9_2', 'release':'4', 'el_string':'el9_2', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openshift-hyperkube'},
    {'reference':'NetworkManager-bluetooth-1.42.2-2.el9_2', 'release':'4', 'el_string':'el9_2', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openshift-hyperkube'},
    {'reference':'NetworkManager-cloud-setup-1.42.2-2.el9_2', 'release':'4', 'el_string':'el9_2', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openshift-hyperkube'},
    {'reference':'NetworkManager-config-connectivity-redhat-1.42.2-2.el9_2', 'release':'4', 'el_string':'el9_2', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openshift-hyperkube'},
    {'reference':'NetworkManager-config-server-1.42.2-2.el9_2', 'release':'4', 'el_string':'el9_2', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openshift-hyperkube'},
    {'reference':'NetworkManager-dispatcher-routing-rules-1.42.2-2.el9_2', 'release':'4', 'el_string':'el9_2', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openshift-hyperkube'},
    {'reference':'NetworkManager-initscripts-updown-1.42.2-2.el9_2', 'release':'4', 'el_string':'el9_2', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openshift-hyperkube'},
    {'reference':'NetworkManager-libnm-1.42.2-2.el9_2', 'release':'4', 'el_string':'el9_2', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openshift-hyperkube'},
    {'reference':'NetworkManager-libnm-devel-1.42.2-2.el9_2', 'release':'4', 'el_string':'el9_2', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openshift-hyperkube'},
    {'reference':'NetworkManager-ovs-1.42.2-2.el9_2', 'release':'4', 'el_string':'el9_2', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openshift-hyperkube'},
    {'reference':'NetworkManager-ppp-1.42.2-2.el9_2', 'release':'4', 'el_string':'el9_2', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openshift-hyperkube'},
    {'reference':'NetworkManager-team-1.42.2-2.el9_2', 'release':'4', 'el_string':'el9_2', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openshift-hyperkube'},
    {'reference':'NetworkManager-tui-1.42.2-2.el9_2', 'release':'4', 'el_string':'el9_2', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openshift-hyperkube'},
    {'reference':'NetworkManager-wifi-1.42.2-2.el9_2', 'release':'4', 'el_string':'el9_2', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openshift-hyperkube'},
    {'reference':'NetworkManager-wwan-1.42.2-2.el9_2', 'release':'4', 'el_string':'el9_2', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openshift-hyperkube'},
    {'reference':'conmon-2.1.7-1.1.rhaos4.13.el9', 'release':'4', 'el_string':'el9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube'},
    {'reference':'cri-o-1.26.3-8.rhaos4.13.git9232b13.el8', 'release':'4', 'el_string':'el8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
    {'reference':'cri-o-1.26.3-9.rhaos4.13.git9232b13.el9', 'release':'4', 'el_string':'el9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
    {'reference':'openshift-ansible-4.13.0-202305301841.p0.g148be47.assembly.stream.el8', 'release':'4', 'el_string':'el8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
    {'reference':'openshift-ansible-4.13.0-202305301841.p0.g148be47.assembly.stream.el9', 'release':'4', 'el_string':'el9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
    {'reference':'openshift-ansible-test-4.13.0-202305301841.p0.g148be47.assembly.stream.el8', 'release':'4', 'el_string':'el8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
    {'reference':'openshift-ansible-test-4.13.0-202305301841.p0.g148be47.assembly.stream.el9', 'release':'4', 'el_string':'el9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
    {'reference':'openshift-clients-4.13.0-202305312300.p0.g05d83ef.assembly.stream.el8', 'release':'4', 'el_string':'el8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
    {'reference':'openshift-clients-4.13.0-202305312300.p0.g05d83ef.assembly.stream.el9', 'release':'4', 'el_string':'el9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
    {'reference':'openshift-clients-redistributable-4.13.0-202305312300.p0.g05d83ef.assembly.stream.el8', 'cpu':'x86_64', 'release':'4', 'el_string':'el8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
    {'reference':'openshift-clients-redistributable-4.13.0-202305312300.p0.g05d83ef.assembly.stream.el9', 'cpu':'x86_64', 'release':'4', 'el_string':'el9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
    {'reference':'openshift-hyperkube-4.13.0-202305312300.p0.g7a891f0.assembly.stream.el8', 'release':'4', 'el_string':'el8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
    {'reference':'openshift-hyperkube-4.13.0-202305312300.p0.g7a891f0.assembly.stream.el9', 'release':'4', 'el_string':'el9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
];
