...
# extracted from Red Hat Security Advisory ipsec-tools. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2015-4047", "CVE-2016-10396");

  script_name(english:"RHEL 5 : ipsec-tools (Unpatched Vulnerability) (deprecated)");
