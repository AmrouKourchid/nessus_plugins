...
# extracted from openSUSE Security Update openSUSE-2019-595.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : cgit (openSUSE-2019-595)");
...
if ( rpm_check(release:"SUSE15.0", reference:"cgit-1.2.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"cgit-debuginfo-1.2.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"cgit-debugsource-1.2.1-lp150.2.3.1") ) flag++;
