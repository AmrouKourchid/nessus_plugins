...
# extracted from Fedora Security Advisory FEDORA-2022-18b234c18b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-18b234c18b");

  script_name(english:"Fedora 37 : python3.8 (2022-18b234c18b)");
...
FEDORA-2022-18b234c18b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-18b234c18b");
...
var pkgs = [
    {'reference':'python3.8-3.8.16-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
