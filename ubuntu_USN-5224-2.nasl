...
# extracted from Ubuntu Security Notice USN-5224-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5224-2");

  script_name(english:"Ubuntu 16.04 ESM : Ghostscript vulnerabilities (USN-5224-2)");
...
the USN-5224-2 advisory.

    USN-5224-1 fixed several vulnerabilities in Ghostscript. This update provides the corresponding update for
    Ubuntu 16.04 ESM.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5224-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'ghostscript', 'pkgver': '9.26~dfsg+0-0ubuntu0.16.04.14+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'ghostscript-x', 'pkgver': '9.26~dfsg+0-0ubuntu0.16.04.14+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libgs-dev', 'pkgver': '9.26~dfsg+0-0ubuntu0.16.04.14+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libgs9', 'pkgver': '9.26~dfsg+0-0ubuntu0.16.04.14+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libgs9-common', 'pkgver': '9.26~dfsg+0-0ubuntu0.16.04.14+esm1', 'ubuntu_pro': TRUE}
];
