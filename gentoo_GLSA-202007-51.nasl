...
# extracted from Gentoo Linux Security Advisory GLSA 202007-51.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202007-51");
  script_xref(name:"TRA", value:"TRA-2019-14");

  script_name(english:"GLSA-202007-51 : FileZilla: Untrusted search path");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202007-51
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202007-51");
...
if (qpkg_check(package:"net-ftp/filezilla", unaffected:make_list("ge 3.47.2.1"), vulnerable:make_list("lt 3.47.2.1"))) flag++;
