...
# extracted from Fedora Security Advisory FEDORA-2018-5743ef02a1.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : 1:rubygem-rack (2018-5743ef02a1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"- Cross-site scripting (XSS) via `scheme` method on
    `Rack::Request` (CVE-2018-16471).

Note that Tenable Network Security has extracted the preceding
description block directly from the Fedora update system website.
Tenable has attempted to automatically clean and format it as much as
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-5743ef02a1");
  script_set_attribute(attribute:"solution", value:
"Update the affected 1:rubygem-rack package.");
...
flag = 0;
if (rpm_check(release:"FC27", reference:"rubygem-rack-2.0.3-4.fc27", epoch:"1")) flag++;
