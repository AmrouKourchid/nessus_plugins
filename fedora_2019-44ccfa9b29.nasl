...
# extracted from Fedora Security Advisory FEDORA-2019-44ccfa9b29.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : knot-resolver (2019-44ccfa9b29)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-44ccfa9b29");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"knot-resolver-4.3.0-1.fc30")) flag++;
