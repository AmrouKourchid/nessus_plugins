...
# extracted from ZTE advisory NS-SA-2020-0029. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.04 / MAIN 5.04 : http-parser Vulnerability (NS-SA-2020-0029)");
...
affected by a vulnerability:
  ...
  - HTTP request smuggling in Node.js 10, 12, and 13 causes
    malicious payload delivery when transfer-encoding is
    malformed (CVE-2019-15605)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/notice/NS-SA-2020-0029");
...
pkgs = {
  "CGSL CORE 5.04": [
    ...
    "http-parser-debuginfo-2.7.1-8.el7_7.2",
