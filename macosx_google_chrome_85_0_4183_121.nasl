...
"The version of Google Chrome installed on the remote macOS host is prior to 85.0.4183.121. It is, therefore, affected by
multiple vulnerabilities as referenced in the 2020_09_stable-channel-update-for-desktop_21 advisory. Note that Nessus
...
google_chrome_check_version(fix:'85.0.4183.121', severity:SECURITY_WARNING, xss:FALSE, xsrf:FALSE);
