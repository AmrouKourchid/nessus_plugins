...
# extracted from Fedora Security Advisory FEDORA-2018-e6df7fcf75.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2016-9387", "CVE-2016-9396");
  script_xref(name:"FEDORA", value:"2018-e6df7fcf75");

  script_name(english:"Fedora 27 : jasper (2018-e6df7fcf75)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-e6df7fcf75");
...
flag = 0;
if (rpm_check(release:"FC27", reference:"jasper-2.0.14-5.fc27")) flag++;
