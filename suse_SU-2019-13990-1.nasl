...
# extracted from SUSE update advisory SUSE-SU-2019:13990-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES11 Security Update : wavpack (SUSE-SU-2019:13990-1)");
...
without introducing additional issues.");
  ...
  # https://www.suse.com/support/update/announcement/2019/suse-su-201913990-1.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6ae3b1ee");
...
patch sdksp4-wavpack-13990=1

SUSE Linux Enterprise Server 11-SP4:zypper in -t patch
slessp4-wavpack-13990=1

SUSE Linux Enterprise Debuginfo 11-SP4:zypper in -t patch
dbgsp4-wavpack-13990=1");
...
flag = 0;
if (rpm_check(release:"SLES11", sp:"4", reference:"libwavpack1-4.50.1-1.30.1")) flag++;
