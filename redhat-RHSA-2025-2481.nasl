...
# extracted from Red Hat Security Advisory RHSA-2025:2481. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:2481");

  script_name(english:"RHEL 9 : firefox (RHSA-2025:2481)");
...
referenced in the RHSA-2025:2481 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_2481.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cf556efc");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:2481");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL firefox package based on the guidance in RHSA-2025:2481.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-128.8.0-1.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
