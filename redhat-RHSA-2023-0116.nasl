...
# extracted from Red Hat Security Advisory RHSA-2023:0116. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:0116");

  script_name(english:"RHEL 8 : libtasn1 (RHSA-2023:0116)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for libtasn1.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2023:0116 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_0116.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3a4fb12a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2140058");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:0116");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libtasn1 package based on the guidance in RHSA-2023:0116.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libtasn1-4.13-4.el8_7', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libtasn1-devel-4.13-4.el8_7', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libtasn1-tools-4.13-4.el8_7', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
