...
# extracted from Fedora Security Advisory FEDORA-2025-d37ad923f5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-d37ad923f5");

  script_name(english:"Fedora 40 : proftpd (2025-d37ad923f5)");
...
FEDORA-2025-d37ad923f5 advisory.

    This update addresses a null pointer dereferencing issue that could cause the session for a client that
    sent specially-crafted commands to the server to crash (not the sessions of other clients).

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-d37ad923f5");
...
var pkgs = [
    {'reference':'proftpd-1.3.8c-3.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
