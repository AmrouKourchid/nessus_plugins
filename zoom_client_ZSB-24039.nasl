...
if (description)
{
  ...
  script_cve_id("CVE-2024-45417");

  script_name(english:"Zoom Apps for macOS < 6.1.5 Informatioon Disclosure (ZSB-24039)");
...
affected by an informatioon disclosure vulnerability as referenced in the ZSB-24039 advisory:

  - Uncontrolled resource consumption in the installer for some Zoom apps for macOS before version 6.1.5 may 
    allow a privileged user to conduct a disclosure of information via local access. (CVE-2024-45417)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://www.zoom.com/en/trust/security-bulletin/ZSB-24039/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e1c8c1f5");
...
"Upgrade to Zoom Workplace Desktop App for macOS version 6.1.5 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-45417");
