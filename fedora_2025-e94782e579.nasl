...
# extracted from Fedora Security Advisory FEDORA-2025-e94782e579
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-e94782e579");

  script_name(english:"Fedora 41 : chromium (2025-e94782e579)");
...
FEDORA-2025-e94782e579 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-e94782e579");
...
var pkgs = [
    {'reference':'chromium-134.0.6998.35-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
