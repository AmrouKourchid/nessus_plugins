...
# SUSE update advisory SUSE-SU-2021:14761-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2021:14761-1");

  script_name(english:"SUSE SLES11 Security Update : djvulibre (SUSE-SU-2021:14761-1)");
...
in the SUSE-SU-2021:14761-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2021-July/009112.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2ce4c5fb");
  script_set_attribute(attribute:"solution", value:
"Update the affected libdjvulibre21 package.");
...
var pkgs = [
    {'reference':'libdjvulibre21-3.5.21-3.15.1', 'sp':'4', 'release':'SLES_SAP11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-11.4']},
    {'reference':'libdjvulibre21-3.5.21-3.15.1', 'sp':'4', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.4']}
];
