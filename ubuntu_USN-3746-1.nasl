...
# extracted from Ubuntu Security Notice USN-3746-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS : APT vulnerability (USN-3746-1)");
...
USN-3746-1 advisory.
    ...
    It was discovered that APT incorrectly handled the mirror method (mirror://). If a remote attacker were
    able to perform a machine-in-the-middle attack, this flaw could potentially be used to install altered
    packages in environments configured to use mirror:// entries.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3746-1");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-0501");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'apt', 'pkgver': '1.6.3ubuntu0.1'},
    {'osver': '18.04', 'pkgname': 'apt-transport-https', 'pkgver': '1.6.3ubuntu0.1'},
    {'osver': '18.04', 'pkgname': 'apt-utils', 'pkgver': '1.6.3ubuntu0.1'},
    {'osver': '18.04', 'pkgname': 'libapt-inst2.0', 'pkgver': '1.6.3ubuntu0.1'},
    {'osver': '18.04', 'pkgname': 'libapt-pkg-dev', 'pkgver': '1.6.3ubuntu0.1'},
    {'osver': '18.04', 'pkgname': 'libapt-pkg5.0', 'pkgver': '1.6.3ubuntu0.1'}
];
