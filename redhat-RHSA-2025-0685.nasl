...
# extracted from Red Hat Security Advisory RHSA-2025:0685. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:0685");

  script_name(english:"RHEL 8 : redis:6 (RHSA-2025:0685)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for redis:6.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2025:0685 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_0685.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1951141b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:0685");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL redis:6 package based on the guidance in RHSA-2025:0685.");
  ...
  'redis:6': [
    {
      ...
      'pkgs': [
        {'reference':'redis-6.0.9-5.module+el8.4.0+22739+cf3cc450.1', 'sp':'4', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'redis-6.0.9-5.module+el8.4.0+22739+cf3cc450.1', 'sp':'4', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'redis-devel-6.0.9-5.module+el8.4.0+22739+cf3cc450.1', 'sp':'4', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'redis-devel-6.0.9-5.module+el8.4.0+22739+cf3cc450.1', 'sp':'4', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'redis-doc-6.0.9-5.module+el8.4.0+22739+cf3cc450.1', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
