...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Libxi PHSA-2023-5.0-0036");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'libXi-1.7.10-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'libXi-devel-1.7.10-1.ph5')) flag++;
