...
# extracted from Oracle Linux Security Advisory ELSA-2024-3005.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : python-pillow (ELSA-2024-3005)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
ELSA-2024-3005 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-3005.html");
...
var pkgs = [
    ...
    {'reference':'python3-pillow-doc-5.1.1-20.el8', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-pillow-tk-5.1.1-20.el8', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
