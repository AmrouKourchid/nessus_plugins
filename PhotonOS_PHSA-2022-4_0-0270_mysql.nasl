...
# extracted from VMware Security Advisory PHSA-2022-4.0-0270. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Mysql PHSA-2022-4.0-0270");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the mysql package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-270.md");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-21635");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'mysql-8.0.31-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'mysql-devel-8.0.31-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'mysql-icu-data-files-8.0.31-1.ph4')) flag++;
