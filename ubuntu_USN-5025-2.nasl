...
# extracted from Ubuntu Security Notice USN-5025-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5025-2");

  script_name(english:"Ubuntu 16.04 ESM : libsndfile vulnerability (USN-5025-2)");
...
USN-5025-2 advisory.
    ...
    USN-5025-1 fixed a vulnerability in libsndfile. This update provides the corresponding update for Ubuntu
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5025-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libsndfile1', 'pkgver': '1.0.25-10ubuntu0.16.04.3+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libsndfile1-dev', 'pkgver': '1.0.25-10ubuntu0.16.04.3+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'sndfile-programs', 'pkgver': '1.0.25-10ubuntu0.16.04.3+esm1', 'ubuntu_pro': TRUE}
];
