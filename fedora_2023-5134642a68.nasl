...
# extracted from Fedora Security Advisory FEDORA-2023-5134642a68
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-5134642a68");

  script_name(english:"Fedora 39 : xrdp (2023-5134642a68)");
...
FEDORA-2023-5134642a68 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-5134642a68");
...
var pkgs = [
    {'reference':'xrdp-0.9.23-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
