...
# extracted from Red Hat Security Advisory RHSA-2019:0375. The text 
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_0375.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2a7e9c72");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:0375");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1675070");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL flatpak package based on the guidance in RHSA-2019:0375.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'flatpak-1.0.2-4.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'flatpak-builder-1.0.0-4.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'flatpak-devel-1.0.2-4.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'flatpak-libs-1.0.2-4.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
