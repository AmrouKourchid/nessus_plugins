...
potentially allowing a remote attacker to execute arbitrary code.");
  script_set_attribute(attribute:"see_also", value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=913912");
  # https://security-tracker.debian.org/tracker/source-package/libphp-phpmailer
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d0c8b2f0");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/stretch/libphp-phpmailer");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2018/dsa-4351");
