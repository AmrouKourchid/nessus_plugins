...
# openSUSE Security Update openSUSE-SU-2021:1329-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : haproxy (openSUSE-SU-2021:1329-1)");
...
openSUSE-SU-2021:1329-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9397895c");
...
var pkgs = [
    {'reference':'haproxy-2.0.14-lp152.2.6.1', 'cpu':'x86_64', 'release':'SUSE15.2', 'rpm_spec_vers_cmp':TRUE}
];
