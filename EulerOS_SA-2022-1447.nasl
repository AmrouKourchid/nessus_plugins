...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : ghostscript (EulerOS-SA-2022-1447)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1447
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ae438778");
...
var pkgs = [
  "ghostscript-9.52-1.h4.eulerosv2r9",
  "ghostscript-help-9.52-1.h4.eulerosv2r9"
];
