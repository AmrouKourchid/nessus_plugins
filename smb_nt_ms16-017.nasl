...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"3126446");
...
privilege.");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2016/ms16-017");
...
2012 R2, and 10.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-0036");
