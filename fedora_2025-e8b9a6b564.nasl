...
# extracted from Fedora Security Advisory FEDORA-2025-e8b9a6b564
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-e8b9a6b564");

  script_name(english:"Fedora 40 : golang (2025-e8b9a6b564)");
...
FEDORA-2025-e8b9a6b564 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-e8b9a6b564");
...
var pkgs = [
    {'reference':'golang-1.22.11-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
