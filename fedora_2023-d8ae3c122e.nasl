...
# extracted from Fedora Security Advisory FEDORA-2023-d8ae3c122e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-d8ae3c122e");

  script_name(english:"Fedora 37 : mediawiki (2023-d8ae3c122e)");
...
FEDORA-2023-d8ae3c122e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-d8ae3c122e");
...
var pkgs = [
    {'reference':'mediawiki-1.38.7-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
