...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5036969");
  script_xref(name:"MSFT", value:"MS24-5036969");
  script_xref(name:"IAVA", value:"2024-A-0227-S");
  script_xref(name:"IAVA", value:"2024-A-0228-S");

  script_name(english:"KB5036969: Windows Server 2012 Security Update (April 2024)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5036969. It is, therefore, affected by multiple vulnerabilities
  ...
  - Secure Boot Security Feature Bypass Vulnerability (CVE-2024-20669, CVE-2024-20688, CVE-2024-20689,
    CVE-2024-26171, CVE-2024-26175, CVE-2024-26180, CVE-2024-26189, CVE-2024-26194, CVE-2024-26240,
    CVE-2024-26250, CVE-2024-28896, CVE-2024-28897, CVE-2024-28898, CVE-2024-28903, CVE-2024-28919,
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5036969");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5036969");
