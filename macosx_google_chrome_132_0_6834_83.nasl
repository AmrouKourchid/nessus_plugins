...
"The version of Google Chrome installed on the remote macOS host is prior to 132.0.6834.83. It is, therefore, affected by
multiple vulnerabilities as referenced in the 2025_01_stable-channel-update-for-desktop_14 advisory.
...
google_chrome_check_version(fix:'132.0.6834.83', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
