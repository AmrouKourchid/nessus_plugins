...
if (description)
{
  ...
  script_cve_id("CVE-2012-2763", "CVE-2012-4245", "CVE-2016-4994");

  script_name(english:"RHEL 6 : gimp (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2016-4994");
