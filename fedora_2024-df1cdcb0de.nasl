...
# extracted from Fedora Security Advisory FEDORA-2024-df1cdcb0de
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-df1cdcb0de");

  script_name(english:"Fedora 38 : wordpress (2024-df1cdcb0de)");
...
FEDORA-2024-df1cdcb0de advisory.

    **WordPress 6.4.3  Maintenance and Security release**

    See upstream [announcement](https://wordpress.org/news/2024/01/wordpress-6-4-3-maintenance-and-security-
    release/)

    Security updates included in this release

    *    m4tuto for finding a PHP File Upload bypass via Plugin Installer (requiring admin privileges).
    *    @_s_n_t of @pentestltd working with Trend Micro Zero Day Initiative for finding an RCE POP Chains
    vulnerability.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-df1cdcb0de");
...
var pkgs = [
    {'reference':'wordpress-6.4.3-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
