...
if (description)
{
  ...
  script_cve_id("CVE-2017-0902");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2017-0902");
...
patch available.
  ...
  - RubyGems version 2.6.12 and earlier is vulnerable to a DNS hijacking vulnerability that allows a MITM
    attacker to force the RubyGems client to download and install gems from a server that the attacker
    controls. (CVE-2017-0902)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-0902");
