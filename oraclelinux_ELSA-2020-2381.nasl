...
# extracted from Red Hat Security Advisory RHSA-2020:2381 and 
# Oracle Linux Security Advisory ELSA-2020-2381 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : firefox (ELSA-2020-2381)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2020-2381.html");
...
var pkgs = [
    {'reference':'firefox-68.9.0-1.0.1.el7_8', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-68.9.0-1.0.1.el7_8', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-68.9.0-1.0.1.el7_8', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
