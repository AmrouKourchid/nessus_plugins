...
# extracted from Ubuntu Security Notice USN-6508-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6508-2");

  script_name(english:"Ubuntu 18.04 ESM : poppler regression (USN-6508-2)");
...
USN-6508-2 advisory.
    ...
    USN-6508-1 fixed vulnerabilities in poppler. The update introduced one minor regression in Ubuntu 18.04
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6508-2");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'gir1.2-poppler-0.18', 'pkgver': '0.62.0-2ubuntu2.14+esm3', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libpoppler-cpp-dev', 'pkgver': '0.62.0-2ubuntu2.14+esm3', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libpoppler-cpp0v5', 'pkgver': '0.62.0-2ubuntu2.14+esm3', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libpoppler-dev', 'pkgver': '0.62.0-2ubuntu2.14+esm3', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libpoppler-glib-dev', 'pkgver': '0.62.0-2ubuntu2.14+esm3', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libpoppler-glib8', 'pkgver': '0.62.0-2ubuntu2.14+esm3', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libpoppler-private-dev', 'pkgver': '0.62.0-2ubuntu2.14+esm3', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libpoppler-qt5-1', 'pkgver': '0.62.0-2ubuntu2.14+esm3', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libpoppler-qt5-dev', 'pkgver': '0.62.0-2ubuntu2.14+esm3', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libpoppler73', 'pkgver': '0.62.0-2ubuntu2.14+esm3', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'poppler-utils', 'pkgver': '0.62.0-2ubuntu2.14+esm3', 'ubuntu_pro': TRUE}
];
