...
# AlmaLinux Security Advisory ALSA-2025:3107.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2025:3107");
  script_xref(name:"RHSA", value:"2025:3107");

  script_name(english:"AlmaLinux 9 : libxslt (ALSA-2025:3107)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2025-3107.html");
...
var pkgs = [
    {'reference':'libxslt-1.1.34-9.el9_5.1', 'release':'9', 'el_string':'el9_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'libxslt-devel-1.1.34-9.el9_5.1', 'release':'9', 'el_string':'el9_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'}
];
