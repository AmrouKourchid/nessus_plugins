...
# extracted from Fedora Security Advisory FEDORA-2022-667ee398b1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-667ee398b1");

  script_name(english:"Fedora 37 : mingw-binutils (2022-667ee398b1)");
...
FEDORA-2022-667ee398b1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-667ee398b1");
...
var pkgs = [
    {'reference':'mingw-binutils-2.38-5.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
