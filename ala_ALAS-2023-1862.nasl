...
# extracted from Amazon Linux AMI Security Advisory ALAS-2023-1862.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2023-39362", "CVE-2023-39364");

  script_name(english:"Amazon Linux AMI : cacti (ALAS-2023-1862)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux AMI host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of cacti installed on the remote host is prior to 1.1.19-5.23. It is, therefore, affected by multiple
vulnerabilities as referenced in the ALAS-2023-1862 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/ALAS-2023-1862.html");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/cve/html/CVE-2023-39362.html");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/cve/html/CVE-2023-39364.html");
...
"Run 'yum update cacti' to update your system.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-39362");
...
var pkgs = [
    {'reference':'cacti-1.1.19-5.23.amzn1', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE}
];
