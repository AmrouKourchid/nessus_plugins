...
# extracted from Red Hat Security Advisory RHSA-2023:4569. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:4569");

  script_name(english:"RHEL 9 : dbus (RHSA-2023:4569)");
...
the RHSA-2023:4569 advisory.
    ...
    * dbus: dbus-daemon: assertion failure when a monitor is active and a message from the driver cannot be
    delivered (CVE-2023-34969)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_4569.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9cc14c56");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2213166");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:4569");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL dbus package based on the guidance in RHSA-2023:4569.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'dbus-1.12.20-7.el9_2.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'dbus-common-1.12.20-7.el9_2.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'dbus-daemon-1.12.20-7.el9_2.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'dbus-devel-1.12.20-7.el9_2.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'dbus-libs-1.12.20-7.el9_2.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'dbus-tools-1.12.20-7.el9_2.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'dbus-x11-1.12.20-7.el9_2.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'dbus-1.12.20-7.el9_2.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'dbus-common-1.12.20-7.el9_2.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'dbus-daemon-1.12.20-7.el9_2.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'dbus-devel-1.12.20-7.el9_2.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'dbus-libs-1.12.20-7.el9_2.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'dbus-tools-1.12.20-7.el9_2.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'dbus-x11-1.12.20-7.el9_2.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
