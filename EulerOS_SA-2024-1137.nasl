...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : gdb (EulerOS-SA-2024-1137)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the gdb packages installed, the EulerOS installation on the remote host is affected by the
following vulnerabilities :
  ...
  - GNU Binutils before 2.34 has an uninitialized-heap vulnerability in function tic4x_print_cond (file
    opcodes/tic4x-dis.c) which could allow attackers to make an information leak. (CVE-2020-35342)
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1137
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?351c1585");
...
"Update the affected gdb packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-35342");
...
var pkgs = [
  "gdb-7.6.1-110.h6.eulerosv2r7",
  "gdb-gdbserver-7.6.1-110.h6.eulerosv2r7"
];
