...
# extracted from Fedora Security Advisory FEDORA-2023-d4085a681f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-d4085a681f");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2023/03/09");

  script_name(english:"Fedora 36 : cacti / cacti-spine (2023-d4085a681f)");
...
FEDORA-2023-d4085a681f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-d4085a681f");
...
var pkgs = [
    {'reference':'cacti-1.2.23-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cacti-spine-1.2.23-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
