...
if (description)
{
  ...
  script_cve_id("CVE-2013-1991");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2013-1991");
...
patch available.
  ...
  - Multiple integer overflows in X.org libXxf86dga 1.1.3 and earlier allow X servers to trigger allocation of
    ...
    XDGASetMode functions. (CVE-2013-1991)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-1991");
