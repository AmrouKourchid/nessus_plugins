...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_2167.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?aaa1f5a4");
...
"Update the RHEL kpatch-patch package based on the guidance in RHSA-2021:2167.");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  var cve_list = make_list('CVE-2020-0466', 'CVE-2020-28374');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for RHSA-2021:2167');
  }
  else
  {
