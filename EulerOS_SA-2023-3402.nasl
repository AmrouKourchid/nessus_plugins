...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : libwebp (EulerOS-SA-2023-3402)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3402
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1c3ad681");
...
var pkgs = [
  "libwebp-0.3.0-7.h4.eulerosv2r7"
];
