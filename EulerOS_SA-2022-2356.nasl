...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.1 : ncurses (EulerOS-SA-2022-2356)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2356
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?77d20c82");
...
var pkgs = [
  "ncurses-6.2-1.h1.r3.eulerosv2r9",
  "ncurses-base-6.2-1.h1.r3.eulerosv2r9",
  "ncurses-libs-6.2-1.h1.r3.eulerosv2r9"
];
