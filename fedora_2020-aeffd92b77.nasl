...
# extracted from Fedora Security Advisory FEDORA-2020-aeffd92b77.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : roundcubemail (2020-aeffd92b77)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-aeffd92b77");
...
flag = 0;
if (rpm_check(release:"FC32", reference:"roundcubemail-1.4.6-1.fc32")) flag++;
