...
# extracted from Fedora Security Advisory FEDORA-2023-78fa2b72d7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-78fa2b72d7");

  script_name(english:"Fedora 36 : mingw-freetype (2023-78fa2b72d7)");
...
FEDORA-2023-78fa2b72d7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-78fa2b72d7");
...
var pkgs = [
    {'reference':'mingw-freetype-2.12.1-2.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
