...
# extracted from Ubuntu Security Notice USN-2831-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"2831-1");

  script_name(english:"Ubuntu 14.04 LTS : cups-filters vulnerability (USN-2831-1)");
...
USN-2831-1 advisory.
    ...
    Michal Kowalczyk discovered that the cups-filters foomatic-rip filter incorrectly stripped shell escape
    characters. A remote attacker could possibly use this issue to execute arbitrary code as the lp user.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2831-1");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-8327");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'cups-browsed', 'pkgver': '1.0.52-0ubuntu1.6'},
    {'osver': '14.04', 'pkgname': 'cups-filters', 'pkgver': '1.0.52-0ubuntu1.6'},
    {'osver': '14.04', 'pkgname': 'cups-filters-core-drivers', 'pkgver': '1.0.52-0ubuntu1.6'},
    {'osver': '14.04', 'pkgname': 'libcupsfilters-dev', 'pkgver': '1.0.52-0ubuntu1.6'},
    {'osver': '14.04', 'pkgname': 'libcupsfilters1', 'pkgver': '1.0.52-0ubuntu1.6'},
    {'osver': '14.04', 'pkgname': 'libfontembed-dev', 'pkgver': '1.0.52-0ubuntu1.6'},
    {'osver': '14.04', 'pkgname': 'libfontembed1', 'pkgver': '1.0.52-0ubuntu1.6'}
];
