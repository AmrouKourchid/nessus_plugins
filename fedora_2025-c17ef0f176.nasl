...
# extracted from Fedora Security Advisory FEDORA-2025-c17ef0f176
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-c17ef0f176");

  script_name(english:"Fedora 40 : phpMyAdmin (2025-c17ef0f176)");
...
FEDORA-2025-c17ef0f176 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-c17ef0f176");
...
var pkgs = [
    {'reference':'phpMyAdmin-5.2.2-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
