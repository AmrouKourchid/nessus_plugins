...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : krb5 (EulerOS-SA-2019-2600)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2600
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a4b9982f");
...
pkgs = ["krb5-devel-1.15.1-34.h2",
        ...
        "krb5-server-ldap-1.15.1-34.h2",
        "krb5-workstation-1.15.1-34.h2",
        "libkadm5-1.15.1-34.h2"];
