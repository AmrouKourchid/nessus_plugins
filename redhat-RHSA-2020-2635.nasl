...
"The remote Red Hat host is missing a security update for OpenShift Container Platform 4.3.26 python-psutil.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_2635.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0aeefe97");
...
"Update the RHEL OpenShift Container Platform 4.3.26 python-psutil package based on the guidance in RHSA-2020:2635.");
