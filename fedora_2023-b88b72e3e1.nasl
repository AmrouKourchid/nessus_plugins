...
# extracted from Fedora Security Advisory FEDORA-2023-b88b72e3e1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-b88b72e3e1");

  script_name(english:"Fedora 38 : mingw-python-certifi (2023-b88b72e3e1)");
...
FEDORA-2023-b88b72e3e1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-b88b72e3e1");
...
var pkgs = [
    {'reference':'mingw-python-certifi-2023.7.22-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
