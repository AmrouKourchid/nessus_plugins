...
# extracted from Amazon Linux 2 Security Advisory ALAS-2018-1111.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2018-1111");

  script_name(english:"Amazon Linux 2 : java-1.7.0-openjdk (ALAS-2018-1111)");
...
(CVSS:3.0/AV:N/AC:H/PR:N/UI:R/S:C/C:N/I:L/A:N).(CVE-2018-3136)");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2018-1111.html");
...
flag = 0;
if (rpm_check(release:"AL2", reference:"java-1.7.0-openjdk-1.7.0.201-2.6.16.1.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"java-1.7.0-openjdk-accessibility-1.7.0.201-2.6.16.1.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"java-1.7.0-openjdk-debuginfo-1.7.0.201-2.6.16.1.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"java-1.7.0-openjdk-demo-1.7.0.201-2.6.16.1.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"java-1.7.0-openjdk-devel-1.7.0.201-2.6.16.1.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"java-1.7.0-openjdk-headless-1.7.0.201-2.6.16.1.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"java-1.7.0-openjdk-javadoc-1.7.0.201-2.6.16.1.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"java-1.7.0-openjdk-src-1.7.0.201-2.6.16.1.amzn2.0.1")) flag++;
