...
if (description)
{
  ...
  script_name(english:"PHP 5.4.x < 5.4.13 Information Disclosure");
...
remote host is prior to 5.4.13.  It is, therefore, potentially
affected by an information disclosure vulnerability. The 5.4.12 fix
for CVE-2013-1635 / CVE-2013-1643 was incomplete and an error
still exists in the files 'ext/soap/php_xml.c' and
'ext/libxml/libxml.c' related to handling external entities.  This
error could cause PHP to parse remote XML documents defined by an
attacker and could allow access to arbitraryfiles.

Note that this plugin does not attempt to exploit the vulnerability,
but instead relies only on PHP's self-reported version number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.php.net/ChangeLog-5.php#5.4.13");
