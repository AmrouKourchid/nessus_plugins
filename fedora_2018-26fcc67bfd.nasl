...
# extracted from Fedora Security Advisory FEDORA-2018-26fcc67bfd.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-26fcc67bfd");

  script_name(english:"Fedora 27 : poppler (2018-26fcc67bfd)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-26fcc67bfd");
...
"Update the affected poppler package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-18267");
...
flag = 0;
if (rpm_check(release:"FC27", reference:"poppler-0.57.0-9.fc27")) flag++;
