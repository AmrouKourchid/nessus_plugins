...
"The remote Red Hat host is missing one or more security updates for lcms.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 5 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2009:0339 advisory.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2009/rhsa-2009_0339.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1bbe4408");
  script_set_attribute(attribute:"see_also", value:"http://www.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=487508");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=487509");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=487512");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2009:0339");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL lcms package based on the guidance in RHSA-2009:0339.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:R/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2009-0733");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2009-0581");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'lcms-1.18-0.1.beta1.el5_3.2', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'lcms-1.18-0.1.beta1.el5_3.2', 'cpu':'ppc', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'lcms-1.18-0.1.beta1.el5_3.2', 'cpu':'ppc64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'lcms-1.18-0.1.beta1.el5_3.2', 'cpu':'s390', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'lcms-1.18-0.1.beta1.el5_3.2', 'cpu':'s390x', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'lcms-1.18-0.1.beta1.el5_3.2', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'lcms-devel-1.18-0.1.beta1.el5_3.2', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'lcms-devel-1.18-0.1.beta1.el5_3.2', 'cpu':'ppc', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'lcms-devel-1.18-0.1.beta1.el5_3.2', 'cpu':'ppc64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'lcms-devel-1.18-0.1.beta1.el5_3.2', 'cpu':'s390', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'lcms-devel-1.18-0.1.beta1.el5_3.2', 'cpu':'s390x', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'lcms-devel-1.18-0.1.beta1.el5_3.2', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python-lcms-1.18-0.1.beta1.el5_3.2', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python-lcms-1.18-0.1.beta1.el5_3.2', 'cpu':'ppc', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python-lcms-1.18-0.1.beta1.el5_3.2', 'cpu':'s390x', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python-lcms-1.18-0.1.beta1.el5_3.2', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
