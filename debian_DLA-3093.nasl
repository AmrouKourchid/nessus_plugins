...
if (description)
{
  ...
  script_cve_id("CVE-2022-32224");

  script_name(english:"Debian dla-3093 : rails - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3093
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-32224");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'rails', 'reference': '2:5.2.2.1+dfsg-1+deb10u5'},
    {'release': '10.0', 'prefix': 'ruby-actioncable', 'reference': '2:5.2.2.1+dfsg-1+deb10u5'},
    {'release': '10.0', 'prefix': 'ruby-actionmailer', 'reference': '2:5.2.2.1+dfsg-1+deb10u5'},
    {'release': '10.0', 'prefix': 'ruby-actionpack', 'reference': '2:5.2.2.1+dfsg-1+deb10u5'},
    {'release': '10.0', 'prefix': 'ruby-actionview', 'reference': '2:5.2.2.1+dfsg-1+deb10u5'},
    {'release': '10.0', 'prefix': 'ruby-activejob', 'reference': '2:5.2.2.1+dfsg-1+deb10u5'},
    {'release': '10.0', 'prefix': 'ruby-activemodel', 'reference': '2:5.2.2.1+dfsg-1+deb10u5'},
    {'release': '10.0', 'prefix': 'ruby-activerecord', 'reference': '2:5.2.2.1+dfsg-1+deb10u5'},
    {'release': '10.0', 'prefix': 'ruby-activestorage', 'reference': '2:5.2.2.1+dfsg-1+deb10u5'},
    {'release': '10.0', 'prefix': 'ruby-activesupport', 'reference': '2:5.2.2.1+dfsg-1+deb10u5'},
    {'release': '10.0', 'prefix': 'ruby-rails', 'reference': '2:5.2.2.1+dfsg-1+deb10u5'},
    {'release': '10.0', 'prefix': 'ruby-railties', 'reference': '2:5.2.2.1+dfsg-1+deb10u5'}
];
