...
# extracted from Red Hat Security Advisory RHSA-2024:5810. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2023-45290", "CVE-2024-34064", "CVE-2024-34069");
  script_xref(name:"RHSA", value:"2024:5810");

  script_name(english:"RHEL 8 / 9 : OpenShift Container Platform 4.12.64 (RHSA-2024:5810)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for OpenShift Container Platform 4.12.64.");
...
referenced in the RHSA-2024:5810 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.12.64. See the
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6a84038b");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:5810");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.12.64 package based on the guidance in RHSA-2024:5810.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openshift-hyperkube-4.12.0-202408131833.p0.g1eb8682.assembly.stream.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2023-45290']}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      ...
      {'reference':'python3-werkzeug-2.0.3-6.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-34069']}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'openshift-hyperkube-4.12.0-202408131833.p0.g1eb8682.assembly.stream.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2023-45290']}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'openshift-hyperkube / python3-jinja2 / python3-werkzeug');
}
