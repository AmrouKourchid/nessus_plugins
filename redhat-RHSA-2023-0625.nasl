...
# extracted from Red Hat Security Advisory RHSA-2023:0625. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_0625.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9a4afa76");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2161571");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:0625");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libksba package based on the guidance in RHSA-2023:0625.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libksba-1.3.5-9.el8_7', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libksba-devel-1.3.5-9.el8_7', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
