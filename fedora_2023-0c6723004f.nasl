...
# extracted from Fedora Security Advisory FEDORA-2023-0c6723004f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-0c6723004f");

  script_name(english:"Fedora 39 : golang-github-prometheus-alertmanager (2023-0c6723004f)");
...
FEDORA-2023-0c6723004f advisory.
    ...
    ```
    * Sat Apr 29 2023 Srgio M. Basto <sergio@serjux.com> - 0.23.0-15
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-0c6723004f");
...
var pkgs = [
    {'reference':'golang-github-prometheus-alertmanager-0.23.0-15.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
