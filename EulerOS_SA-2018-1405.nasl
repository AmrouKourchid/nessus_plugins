...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : openssh (EulerOS-SA-2018-1405)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1405
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0acd443d");
...
pkgs = ["openssh-6.6.1p1-28.h17",
        "openssh-askpass-6.6.1p1-28.h17",
        "openssh-clients-6.6.1p1-28.h17",
        "openssh-keycat-6.6.1p1-28.h17",
        "openssh-server-6.6.1p1-28.h17"];
