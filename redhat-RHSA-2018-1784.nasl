...
# extracted from Red Hat Security Advisory RHSA-2018:1784. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:1784");

  script_name(english:"RHEL 6 / 7 : rh-java-common-xmlrpc (RHSA-2018:1784)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for rh-java-common-xmlrpc.");
...
in the RHSA-2018:1784 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1508123");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_1784.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1579ebdc");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:1784");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rh-java-common-xmlrpc package based on the guidance in RHSA-2018:1784.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rh-java-common-xmlrpc");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rh-java-common-xmlrpc-client");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rh-java-common-xmlrpc-common");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rh-java-common-xmlrpc-javadoc");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rh-java-common-xmlrpc-server");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-java-common-xmlrpc-client-3.1.3-8.16.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'rh-java-common-xmlrpc-common-3.1.3-8.16.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'rh-java-common-xmlrpc-javadoc-3.1.3-8.16.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'rh-java-common-xmlrpc-server-3.1.3-8.16.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'rh-java-common-xmlrpc-client-3.1.3-8.16.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'rh-java-common-xmlrpc-common-3.1.3-8.16.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'rh-java-common-xmlrpc-javadoc-3.1.3-8.16.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'rh-java-common-xmlrpc-server-3.1.3-8.16.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'rh-java-common-xmlrpc-client / rh-java-common-xmlrpc-common / etc');
}
