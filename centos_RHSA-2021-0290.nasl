...
# extracted from Red Hat Security Advisory RHSA-2021:0290.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : firefox (RHSA-2021:0290)");
...
var pkgs = [
    {'reference':'firefox-78.7.0-2.el7.centos', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-78.7.0-2.el7.centos', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
