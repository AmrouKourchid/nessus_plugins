...
if (description)
{
  ...
  script_cve_id("CVE-2013-1476");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2013-1476");
...
patch available.
  ...
  - Unspecified vulnerability in the Java Runtime Environment (JRE) component in Oracle Java SE 7 through
    ...
    CORBA, a different vulnerability than CVE-2013-0441 and CVE-2013-1475. NOTE: the previous information is
    from the February 2013 CPU. Oracle has not commented on claims from another vendor that this issue allows
    remote attackers to bypass Java sandbox restrictions via certain value handler constructors.
    (CVE-2013-1476)
