...
# extracted from SUSE update advisory SUSE-SU-2018:2338-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLED15 / SLES15 Security Update : Security update to ucode-intel (SUSE-SU-2018:2338-1) (Foreshadow) (Spectre)");
...
without introducing additional issues.");
  ...
  # https://www.suse.com/support/update/announcement/2018/suse-su-20182338-1/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3db2d634");
...
SUSE-SLE-Module-Basesystem-15-2018-1580=1");
...
flag = 0;
if (rpm_check(release:"SLES15", sp:"0", cpu:"x86_64", reference:"ucode-intel-20180807-3.6.1")) flag++;
if (rpm_check(release:"SLED15", sp:"0", cpu:"x86_64", reference:"ucode-intel-20180807-3.6.1")) flag++;
