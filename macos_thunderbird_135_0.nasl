...
"The version of Thunderbird installed on the remote macOS or Mac OS X host is prior to 135.0. It is, therefore, affected
by multiple vulnerabilities as referenced in the mfsa2025-11 advisory.
...
mozilla_check_version(version:version, path:path, product:'thunderbird', esr:FALSE, fix:'135.0', severity:SECURITY_HOLE);
