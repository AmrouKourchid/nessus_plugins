...
# extracted from Ubuntu Security Notice USN-6424-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6424-1");

  script_name(english:"Ubuntu 20.04 LTS : kramdown vulnerability (USN-6424-1)");
...
USN-6424-1 advisory.
    ...
    It was discovered that kramdown did not restrict Rouge formatters to the correct namespace. An attacker
    could use this issue to cause kramdown to execute arbitrary code.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6424-1");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'kramdown', 'pkgver': '1.17.0-4ubuntu0.2'},
    {'osver': '20.04', 'pkgname': 'ruby-kramdown', 'pkgver': '1.17.0-4ubuntu0.2'}
];
