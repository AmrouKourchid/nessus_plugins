...
# extracted from Fedora Security Advisory FEDORA-2024-3d2a146701
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-3d2a146701");

  script_name(english:"Fedora 41 : osc (2024-3d2a146701)");
...
FEDORA-2024-3d2a146701 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-3d2a146701");
...
var pkgs = [
    {'reference':'osc-1.9.1-420.1.1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
