...
# extracted from SUSE update advisory SUSE-SU-2020:2896-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : php74 (SUSE-SU-2020:2896-1)");
...
without introducing additional issues.");
  ...
  # https://www.suse.com/support/update/announcement/2020/suse-su-20202896-1
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6d508541");
...
zypper in -t patch SUSE-SLE-SDK-12-SP5-2020-2896=1

SUSE Linux Enterprise Module for Web Scripting 12 :

zypper in -t patch SUSE-SLE-Module-Web-Scripting-12-2020-2896=1");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"0", reference:"apache2-mod_php74-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"apache2-mod_php74-debuginfo-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-bcmath-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-bcmath-debuginfo-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-bz2-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-bz2-debuginfo-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-calendar-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-calendar-debuginfo-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-ctype-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-ctype-debuginfo-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-curl-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-curl-debuginfo-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-dba-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-dba-debuginfo-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-debuginfo-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-debugsource-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-dom-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-dom-debuginfo-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-enchant-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-enchant-debuginfo-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-exif-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-exif-debuginfo-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-fastcgi-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-fastcgi-debuginfo-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-fileinfo-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-fileinfo-debuginfo-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-fpm-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-fpm-debuginfo-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-ftp-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-ftp-debuginfo-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-gd-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-gd-debuginfo-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-gettext-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-gettext-debuginfo-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-gmp-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-gmp-debuginfo-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-iconv-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-iconv-debuginfo-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-intl-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-intl-debuginfo-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-json-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-json-debuginfo-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-ldap-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-ldap-debuginfo-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-mbstring-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-mbstring-debuginfo-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-mysql-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-mysql-debuginfo-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-odbc-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-odbc-debuginfo-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-opcache-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-opcache-debuginfo-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-openssl-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-openssl-debuginfo-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-pcntl-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-pcntl-debuginfo-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-pdo-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-pdo-debuginfo-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-pgsql-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-pgsql-debuginfo-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-phar-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-phar-debuginfo-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-posix-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-posix-debuginfo-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-readline-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-readline-debuginfo-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-shmop-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-shmop-debuginfo-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-snmp-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-snmp-debuginfo-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-soap-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-soap-debuginfo-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-sockets-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-sockets-debuginfo-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-sodium-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-sodium-debuginfo-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-sqlite-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-sqlite-debuginfo-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-sysvmsg-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-sysvmsg-debuginfo-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-sysvsem-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-sysvsem-debuginfo-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-sysvshm-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-sysvshm-debuginfo-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-tidy-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-tidy-debuginfo-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-tokenizer-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-tokenizer-debuginfo-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-xmlreader-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-xmlreader-debuginfo-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-xmlrpc-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-xmlrpc-debuginfo-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-xmlwriter-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-xmlwriter-debuginfo-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-xsl-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-xsl-debuginfo-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-zip-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-zip-debuginfo-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-zlib-7.4.6-1.13.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"php74-zlib-debuginfo-7.4.6-1.13.1")) flag++;
