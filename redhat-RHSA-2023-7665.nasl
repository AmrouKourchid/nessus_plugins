...
# extracted from Red Hat Security Advisory RHSA-2023:7665. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:7665");

  script_name(english:"RHEL 8 : linux-firmware (RHSA-2023:7665)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_7665.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6553c33b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2217845");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:7665");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL linux-firmware package based on the guidance in RHSA-2023:7665.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'linux-firmware-20190516-97.git711d3297.el8_1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
