...
# extracted from Red Hat Security Advisory mariadb,_mysql. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2016-5483", "CVE-2017-3600");

  script_name(english:"RHEL 6 : mariadb,_mysql (Unpatched Vulnerability) (deprecated)");
