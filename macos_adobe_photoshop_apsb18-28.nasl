...
if (description)
{
  ...
  script_name(english:"Adobe Photoshop CC 18.x < 18.1.6 / CC 19.x < 19.1.6 Multiple Vulnerabilities (macOS APSB18-28)");

  script_set_attribute(attribute:"synopsis", value:
"Adobe Photoshop installed on remote macOS or Mac OS X host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Photoshop CC installed on the remote macOS or Mac OS X host is prior to 18.1.6/19.1.6. It is,
therefore, affected by multiple vulnerabilities as referenced in the apsb18-28 advisory.

  - Adobe Photoshop CC 2018 before 19.1.6 and Photoshop CC 2017 before 18.1.6 have a memory corruption
    vulnerability. Successful exploitation could lead to remote code execution. (CVE-2018-12810,
    CVE-2018-12811)
...
"Upgrade to Adobe Photoshop version 18.1.6/19.1.6 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-12811");
...
var constraints = [
  { 'min_version' : '18.0.0', 'fixed_version' : '18.1.6' },
  { 'min_version' : '19.0.0', 'fixed_version' : '19.1.6' }
];
