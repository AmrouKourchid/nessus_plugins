...
if (description)
{
  ...
  script_bugtraq_id(104538, 106304);

  script_name(english:"NewStart CGSL CORE 5.05 / MAIN 5.05 : binutils Multiple Vulnerabilities (NS-SA-2019-0228)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version CORE 5.05 / MAIN 5.05, has binutils packages installed that are affected
by multiple vulnerabilities:

  - An issue was discovered in arm_pt in cplus-dem.c in GNU
    libiberty, as distributed in GNU Binutils 2.30. Stack
    Exhaustion occurs in the C++ demangling functions
    ...
    demangle_nested_args. This can occur during execution of
    nm-new. (CVE-2018-12641)

  - A NULL pointer dereference (aka SEGV on unknown address
    0x000000000000) was discovered in
    work_stuff_copy_to_from in cplus-dem.c in GNU libiberty,
    as distributed in GNU Binutils 2.30. This can occur
    during execution of objdump. (CVE-2018-12697)

  - binutils version 2.32 and earlier contains a Integer
    Overflow vulnerability in objdump, bfd_get_dynamic_reloc
    _upper_bound,bfd_canonicalize_dynamic_reloc that can
    result in Integer overflow trigger heap overflow.
...
pkgs = {
  "CGSL CORE 5.05": [
    "binutils-2.27-41.base.el7.cgslv5_5.0.1.g8a1145a",
    "binutils-debuginfo-2.27-41.base.el7.cgslv5_5.0.1.g8a1145a",
    "binutils-devel-2.27-41.base.el7.cgslv5_5.0.1.g8a1145a"
  ],
  "CGSL MAIN 5.05": [
    "binutils-2.27-41.base.el7.cgslv5_5.0.1.g8a1145a",
    "binutils-debuginfo-2.27-41.base.el7.cgslv5_5.0.1.g8a1145a",
