...
# extracted from Fedora Security Advisory FEDORA-2018-45183aab17.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2018-6869", "CVE-2018-7725");
  script_xref(name:"FEDORA", value:"2018-45183aab17");

  script_name(english:"Fedora 27 : zziplib (2018-45183aab17)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-45183aab17");
...
"Update the affected zziplib package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-7725");
...
flag = 0;
if (rpm_check(release:"FC27", reference:"zziplib-0.13.69-1.fc27")) flag++;
