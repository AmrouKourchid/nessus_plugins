...
# extracted from Fedora Security Advisory FEDORA-2024-825c52d96f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-825c52d96f");

  script_name(english:"Fedora 41 : koji (2024-825c52d96f)");
...
FEDORA-2024-825c52d96f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-825c52d96f");
...
var pkgs = [
    {'reference':'koji-1.35.1-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
