...
# extracted from SUSE update advisory SUSE-SU-2020:2445-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLED15 / SLES15 Security Update : curl (SUSE-SU-2020:2445-1)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9b1e5b5b");
...
zypper in -t patch SUSE-SLE-Module-Basesystem-15-SP2-2020-2445=1");
...
flag = 0;
if (rpm_check(release:"SLES15", sp:"2", cpu:"x86_64", reference:"libcurl4-32bit-7.66.0-4.6.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", cpu:"x86_64", reference:"libcurl4-32bit-debuginfo-7.66.0-4.6.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"curl-7.66.0-4.6.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"curl-debuginfo-7.66.0-4.6.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"curl-debugsource-7.66.0-4.6.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"libcurl-devel-7.66.0-4.6.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"libcurl4-7.66.0-4.6.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"libcurl4-debuginfo-7.66.0-4.6.1")) flag++;
if (rpm_check(release:"SLED15", sp:"2", cpu:"x86_64", reference:"libcurl4-32bit-7.66.0-4.6.1")) flag++;
if (rpm_check(release:"SLED15", sp:"2", cpu:"x86_64", reference:"libcurl4-32bit-debuginfo-7.66.0-4.6.1")) flag++;
if (rpm_check(release:"SLED15", sp:"2", reference:"curl-7.66.0-4.6.1")) flag++;
if (rpm_check(release:"SLED15", sp:"2", reference:"curl-debuginfo-7.66.0-4.6.1")) flag++;
if (rpm_check(release:"SLED15", sp:"2", reference:"curl-debugsource-7.66.0-4.6.1")) flag++;
if (rpm_check(release:"SLED15", sp:"2", reference:"libcurl-devel-7.66.0-4.6.1")) flag++;
if (rpm_check(release:"SLED15", sp:"2", reference:"libcurl4-7.66.0-4.6.1")) flag++;
if (rpm_check(release:"SLED15", sp:"2", reference:"libcurl4-debuginfo-7.66.0-4.6.1")) flag++;
