...
if (description)
{
  ...
  script_name(english:"Microsoft Edge (Chromium) < 116.0.1938.69 (CVE-2023-4572)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host has an web browser installed that is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Microsoft Edge installed on the remote Windows host is prior to 116.0.1938.69. It is, therefore, affected
by a vulnerability as referenced in the August 31, 2023 advisory.
...
number.");
  # https://docs.microsoft.com/en-us/DeployEdge/microsoft-edge-relnotes-security#august-31-2023
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3a086c3d");
  script_set_attribute(attribute:"see_also", value:"https://msrc.microsoft.com/update-guide/vulnerability/CVE-2023-4572");
