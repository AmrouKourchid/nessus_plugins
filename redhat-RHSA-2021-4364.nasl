...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_4364.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?efa7d434");
...
"Update the RHEL binutils package based on the guidance in RHSA-2021:4364.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'binutils-2.30-108.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'binutils-devel-2.30-108.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
