...
# extracted from Red Hat Security Advisory RHSA-2022:8559. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:8559");

  script_name(english:"RHEL 6 : hsqldb (RHSA-2022:8559)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for hsqldb.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 6 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2022:8559 advisory.

    The hsqldb packages provide a relational database management system written in Java. The Hyper Structured
    Query Language Database (HSQLDB) contains a JDBC driver to support a subset of ANSI-92 SQL.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8559.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7ac959fe");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8559");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2136141");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL hsqldb package based on the guidance in RHSA-2022:8559.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'hsqldb-1.8.0.10-13.el6_10', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'hsqldb-demo-1.8.0.10-13.el6_10', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'hsqldb-javadoc-1.8.0.10-13.el6_10', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'hsqldb-manual-1.8.0.10-13.el6_10', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'hsqldb / hsqldb-demo / hsqldb-javadoc / hsqldb-manual');
}
