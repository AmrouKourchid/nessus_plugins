...
if (description)
{
  ...
  script_name(english:"RHCOS 4 : OpenShift Container Platform 4.11.46 (RHSA-2023:4312)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat CoreOS host is missing a security update for OpenShift Container Platform 4.11.46.");
...
referenced in the RHSA-2023:4312 advisory.
...
"Update the RHCOS OpenShift Container Platform 4.11.46 package based on the guidance in RHSA-2023:4312.");
...
var pkgs = [
    {'reference':'openshift-hyperkube-4.11.0-202307200925.p0.ga9da4a8.assembly.stream.el8', 'release':'4', 'el_string':'el8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
];
