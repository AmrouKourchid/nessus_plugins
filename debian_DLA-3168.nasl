...
# extracted from Debian Security Advisory dla-3168. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3168 : openvswitch-common - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3168
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-32166");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'openvswitch-common', 'reference': '2.10.7+ds1-0+deb10u2'},
    {'release': '10.0', 'prefix': 'openvswitch-dbg', 'reference': '2.10.7+ds1-0+deb10u2'},
    {'release': '10.0', 'prefix': 'openvswitch-dev', 'reference': '2.10.7+ds1-0+deb10u2'},
    {'release': '10.0', 'prefix': 'openvswitch-pki', 'reference': '2.10.7+ds1-0+deb10u2'},
    {'release': '10.0', 'prefix': 'openvswitch-switch', 'reference': '2.10.7+ds1-0+deb10u2'},
    {'release': '10.0', 'prefix': 'openvswitch-testcontroller', 'reference': '2.10.7+ds1-0+deb10u2'},
    {'release': '10.0', 'prefix': 'openvswitch-vtep', 'reference': '2.10.7+ds1-0+deb10u2'},
    {'release': '10.0', 'prefix': 'ovn-central', 'reference': '2.10.7+ds1-0+deb10u2'},
    {'release': '10.0', 'prefix': 'ovn-controller-vtep', 'reference': '2.10.7+ds1-0+deb10u2'},
    {'release': '10.0', 'prefix': 'ovn-host', 'reference': '2.10.7+ds1-0+deb10u2'},
    {'release': '10.0', 'prefix': 'python-openvswitch', 'reference': '2.10.7+ds1-0+deb10u2'},
    {'release': '10.0', 'prefix': 'python3-openvswitch', 'reference': '2.10.7+ds1-0+deb10u2'}
];
