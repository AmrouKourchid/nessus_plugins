...
# extracted from Fedora Security Advisory FEDORA-2023-496439cbdd
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-496439cbdd");

  script_name(english:"Fedora 37 : pgadmin4 (2023-496439cbdd)");
...
FEDORA-2023-496439cbdd advisory.

    Update to 6.18. Backport fix for CVE-35065 of bundled glob-parent.

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-496439cbdd");
...
var pkgs = [
    {'reference':'pgadmin4-6.18-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
