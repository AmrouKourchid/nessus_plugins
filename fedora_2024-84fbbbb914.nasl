...
# extracted from Fedora Security Advisory FEDORA-2024-84fbbbb914
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-84fbbbb914");

  script_name(english:"Fedora 38 : python-django3 (2024-84fbbbb914)");
...
FEDORA-2024-84fbbbb914 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-84fbbbb914");
...
var pkgs = [
    {'reference':'python-django3-3.2.25-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
