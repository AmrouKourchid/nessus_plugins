...
# extracted from Fedora Security Advisory FEDORA-2024-6a879cfa63
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-6a879cfa63");
  script_xref(name:"IAVA", value:"2024-A-0118-S");

  script_name(english:"Fedora 38 : chromium (2024-6a879cfa63)");
...
FEDORA-2024-6a879cfa63 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-6a879cfa63");
...
var pkgs = [
    {'reference':'chromium-122.0.6261.57-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
