...
"The remote Red Hat host is missing one or more security updates for Red Hat OpenShift Container Platform 4.1
jenkins-2-plugins.");
...
referenced in the RHSA-2019:2662 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_2662.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?674c5912");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:2662");
...
"Update the RHEL Red Hat OpenShift Container Platform 4.1 jenkins-2-plugins package based on the guidance in
RHSA-2019:2662.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jenkins-2-plugins-4.1.1567707934-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
