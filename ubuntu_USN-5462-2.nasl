...
# extracted from Ubuntu Security Notice USN-5462-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5462-2");

  script_name(english:"Ubuntu 16.04 ESM : Ruby vulnerability (USN-5462-2)");
...
USN-5462-2 advisory.
    ...
    USN-5462-1 fixed several vulnerabilities in Ruby. This update provides the corresponding CVE-2022-28739
    update for ruby2.3 on Ubuntu 16.04 ESM.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5462-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libruby2.3', 'pkgver': '2.3.1-2~ubuntu16.04.16+esm3', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'ruby2.3', 'pkgver': '2.3.1-2~ubuntu16.04.16+esm3', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'ruby2.3-dev', 'pkgver': '2.3.1-2~ubuntu16.04.16+esm3', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'ruby2.3-tcltk', 'pkgver': '2.3.1-2~ubuntu16.04.16+esm3', 'ubuntu_pro': TRUE}
];
