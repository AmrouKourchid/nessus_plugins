...
# extracted from Fedora Security Advisory FEDORA-2024-2bb2bb2467
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-2bb2bb2467");

  script_name(english:"Fedora 38 : dhcpcd (2024-2bb2bb2467)");
...
FEDORA-2024-2bb2bb2467 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-2bb2bb2467");
...
var pkgs = [
    {'reference':'dhcpcd-10.0.6-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
