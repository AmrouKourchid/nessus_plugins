...
if (description)
{
  ...
  script_cve_id("CVE-2023-2861");

  script_name(english:"EulerOS Virtualization 3.0.6.6 : qemu (EulerOS-SA-2024-1671)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1671
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8d82301e");
