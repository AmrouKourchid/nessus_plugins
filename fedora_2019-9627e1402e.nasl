...
# extracted from Fedora Security Advisory FEDORA-2019-9627e1402e.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-9627e1402e");
  script_xref(name:"IAVB", value:"2019-B-0078-S");

  script_name(english:"Fedora 29 : 1:libreoffice (2019-9627e1402e)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"- CVE-2019-9854 Unsafe URL assembly flaw in allowed script
    location check
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-9627e1402e");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"libreoffice-6.1.6.3-4.fc29", epoch:"1")) flag++;
