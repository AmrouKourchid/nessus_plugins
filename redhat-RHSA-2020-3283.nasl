...
# extracted from Red Hat Security Advisory RHSA-2020:3283. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:3283");

  script_name(english:"RHEL 8 : postgresql-jdbc (RHSA-2020:3283)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for postgresql-jdbc.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2020:3283 advisory.
    ...
    * postgresql-jdbc: XML external entity (XXE) vulnerability in PgSQLXML (CVE-2020-13692)
    ...
    This update introduces a backwards incompatible change required to resolve this issue. Refer to the Red
    Hat Knowledgebase article 5266441 linked to in the References section for information on how to re-enable
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_3283.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6592e85d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/articles/5266441");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:3283");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1852985");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL postgresql-jdbc package based on the guidance in RHSA-2020:3283.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'postgresql-jdbc-42.2.3-3.el8_0', 'sp':'0', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-jdbc-javadoc-42.2.3-3.el8_0', 'sp':'0', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
