...
# SUSE update advisory SUSE-SU-2021:14707-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2021:14707-1");

  script_name(english:"SUSE SLES11 Security Update : curl (SUSE-SU-2021:14707-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1183933");
  # https://lists.suse.com/pipermail/sle-security-updates/2021-April/008684.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?88c7969e");
...
pkgs = [
    {'reference':'curl-openssl1-7.37.0-70.60', 'sp':'0', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'SLES_SAP-release-11.3-0'},
    {'reference':'libcurl4-openssl1-32bit-7.37.0-70.60', 'sp':'0', 'cpu':'s390x', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'SLES_SAP-release-11.3-0'},
    {'reference':'libcurl4-openssl1-32bit-7.37.0-70.60', 'sp':'0', 'cpu':'x86_64', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'SLES_SAP-release-11.3-0'},
    {'reference':'libcurl4-openssl1-7.37.0-70.60', 'sp':'0', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'SLES_SAP-release-11.3-0'},
    {'reference':'curl-openssl1-7.37.0-70.60', 'sp':'0', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'sles-release-11.3-0'},
    {'reference':'libcurl4-openssl1-32bit-7.37.0-70.60', 'sp':'0', 'cpu':'s390x', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'sles-release-11.3-0'},
    {'reference':'libcurl4-openssl1-32bit-7.37.0-70.60', 'sp':'0', 'cpu':'x86_64', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'sles-release-11.3-0'},
    {'reference':'libcurl4-openssl1-7.37.0-70.60', 'sp':'0', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'sles-release-11.3-0'}
];
