...
"The version of Google Chrome installed on the remote macOS host is prior to 125.0.6422.76. It is, therefore, affected by
multiple vulnerabilities as referenced in the 2024_05_stable-channel-update-for-desktop_21 advisory.
...
google_chrome_check_version(fix:'125.0.6422.76', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
