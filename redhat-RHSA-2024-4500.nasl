...
# extracted from Red Hat Security Advisory RHSA-2024:4500. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:4500");

  script_name(english:"RHEL 9 : firefox (RHSA-2024:4500)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for firefox.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:4500 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_4500.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5f13b2f6");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:4500");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL firefox package based on the guidance in RHSA-2024:4500.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-115.13.0-3.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-x11-115.13.0-3.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'firefox-115.13.0-3.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-x11-115.13.0-3.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
