...
if (description)
{
  ...
  script_name(english:"RHEL 6 / 7 : Red Hat JBoss Enterprise Application Platform 7.0 (RHSA-2016:1332)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for Red Hat JBoss Enterprise Application Platform 7.0.");
...
in the RHSA-2016:1332 advisory.
    ...
    Platform 7.0 More information about this vulnerability is available at:
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2016/rhsa-2016_1332.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7226321f");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2016:1332");
...
"Update the RHEL Red Hat JBoss Enterprise Application Platform 7.0 package based on the guidance in RHSA-2016:1332.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'eap7-jgroups-3.6.8-3.Final_redhat_3.1.ep7.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap7'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'eap7-jgroups-3.6.8-3.Final_redhat_3.1.ep7.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap7'}
    ]
  }
];
