...
# Rocky Linux Security Advisory RLSA-2024:3846.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2024:3846");

  script_name(english:"Rocky Linux 9 : python-idna (RLSA-2024:3846)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2024:3846");
