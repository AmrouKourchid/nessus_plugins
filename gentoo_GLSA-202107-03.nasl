...
# extracted from Gentoo Linux Security Advisory GLSA 202107-03.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202107-03");

  script_name(english:"GLSA-202107-03 : libqb: Insecure temporary file");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202107-03
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202107-03"
  );
  script_set_attribute(
    attribute:"solution",
    value:
"All libqb users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:libqb");
...
if (qpkg_check(package:"sys-cluster/libqb", unaffected:make_list("ge 1.0.5"), vulnerable:make_list("lt 1.0.5"))) flag++;
