...
# extracted from Debian Security Advisory dla-3846. The text
...
if (description)
{
  script_id(201167);
  script_version("1.1");
  script_set_attribute(attribute:"plugin_modification_date", value:"2024/06/30");

  script_cve_id("CVE-2020-36829");

  script_name(english:"Debian dla-3846 : libmojolicious-perl - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has a package installed that is affected by a vulnerability as referenced in the dla-3846
advisory.
...
number.");
  # https://security-tracker.debian.org/tracker/source-package/libmojolicious-perl
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e809a188");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2020-36829");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/libmojolicious-perl");
...
"Upgrade the libmojolicious-perl packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-36829");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libmojolicious-perl', 'reference': '8.12+dfsg-1.1~deb10u1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libmojolicious-perl');
}
