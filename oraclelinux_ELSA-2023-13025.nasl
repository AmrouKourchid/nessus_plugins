...
# extracted from Oracle Linux Security Advisory ELSA-2023-13025.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : edk2 (ELSA-2023-13025)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ELSA-2023-13025 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-13025.html");
...
var pkgs = [
    {'reference':'edk2-aarch64-20230821-1.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'edk2-ovmf-20230821-1.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
