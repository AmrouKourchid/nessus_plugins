...
# extracted from Fedora Security Advisory FEDORA-2024-a3d1f80409
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-a3d1f80409");

  script_name(english:"Fedora 40 : cups (2024-a3d1f80409)");
...
FEDORA-2024-a3d1f80409 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-a3d1f80409");
...
var pkgs = [
    {'reference':'cups-2.4.10-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
