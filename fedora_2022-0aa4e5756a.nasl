...
# extracted from Fedora Security Advisory FEDORA-2022-0aa4e5756a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-0aa4e5756a");

  script_name(english:"Fedora 36 : python3.8 (2022-0aa4e5756a)");
...
FEDORA-2022-0aa4e5756a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-0aa4e5756a");
...
var pkgs = [
    {'reference':'python3.8-3.8.15-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
