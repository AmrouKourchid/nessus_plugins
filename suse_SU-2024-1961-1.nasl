...
# SUSE update advisory SUSE-SU-2024:1961-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2024:1961-1");

  script_name(english:"SUSE SLES15 / openSUSE 15 Security Update : squid (SUSE-SU-2024:1961-1)");
...
as referenced in the SUSE-SU-2024:1961-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://lists.suse.com/pipermail/sle-updates/2024-June/035509.html");
...
var pkgs = [
    {'reference':'squid-6.9-150600.3.3.2', 'sp':'6', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.6']},
    {'reference':'squid-6.9-150600.3.3.2', 'sp':'6', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.6', 'sle-module-server-applications-release-15.6', 'sles-release-15.6']},
    {'reference':'squid-6.9-150600.3.3.2', 'release':'SUSE15.6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.6']}
];
