...
# extracted from Fedora Security Advisory FEDORA-2025-3a56fe6159
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-3a56fe6159");

  script_name(english:"Fedora 40 : exim (2025-3a56fe6159)");
...
FEDORA-2025-3a56fe6159 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-3a56fe6159");
...
var pkgs = [
    {'reference':'exim-4.98.2-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
