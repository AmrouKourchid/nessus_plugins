...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Fribidi PHSA-2023-4.0-0365");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the fribidi package has been released.");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:vmware:photonos:fribidi");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'fribidi-1.0.9-2.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'fribidi-devel-1.0.9-2.ph4')) flag++;
