...
referenced in the RHSA-2018:3041 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2018/rhsa-2018_3041.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?631338b2");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:3041");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1555314");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1557460");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1579432");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python package based on the guidance in RHSA-2018:3041.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python-2.7.5-76.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python-debug-2.7.5-76.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python-devel-2.7.5-76.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python-libs-2.7.5-76.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python-test-2.7.5-76.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python-tools-2.7.5-76.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tkinter-2.7.5-76.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
