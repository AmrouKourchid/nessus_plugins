...
if (description)
{
  ...
  script_cve_id("CVE-2025-26630");
  script_xref(name:"MSKB", value:"5002697");
  script_xref(name:"MSFT", value:"MS25-5002697");
  ...
  script_name(english:"Security Updates for Microsoft Access Products (March 2025)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002697");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released KB5002697 to address this issue.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:C/I:C/A:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:N/UI:R/S:U/C:H/I:H/A:H");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-26630");
...
var constraints = [
  { 'kb':'5002697', 'channel':'MSI', 'fixed_version': '16.0.5491.1001', 'sp' : 0}
];
