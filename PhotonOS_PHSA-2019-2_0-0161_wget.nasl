...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Wget PHSA-2019-2.0-0161");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'wget-1.20.3-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'wget-debuginfo-1.20.3-1.ph2')) flag++;
