...
# extracted from Fedora Security Advisory FEDORA-2022-13ad572b5a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-13ad572b5a");

  script_name(english:"Fedora 36 : golang-github-distribution-3 (2022-13ad572b5a)");
...
FEDORA-2022-13ad572b5a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-13ad572b5a");
...
var pkgs = [
    {'reference':'golang-github-distribution-3-3.0.0-0.1.pre1.20221009git0122d7d.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
