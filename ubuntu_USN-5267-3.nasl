...
referenced in the USN-5267-3 advisory.
    ...
    USN-5267-1 fixed vulnerabilities in the Linux kernel. This update provides the corresponding updates for
    the Linux kernel for Raspberry Pi devices.
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-5267-3');
}
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-5267-3');
  }
  else
  {
