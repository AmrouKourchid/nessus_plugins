...
# extracted from Debian Security Advisory dsa-5688. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5688 : atril - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bookworm/atril");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bullseye/atril");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'atril', 'reference': '1.24.0-1+deb11u1'},
    {'release': '11.0', 'prefix': 'atril-common', 'reference': '1.24.0-1+deb11u1'},
    {'release': '11.0', 'prefix': 'gir1.2-atril', 'reference': '1.24.0-1+deb11u1'},
    {'release': '11.0', 'prefix': 'gir1.2-atrildocument-1.5.0', 'reference': '1.24.0-1+deb11u1'},
    {'release': '11.0', 'prefix': 'gir1.2-atrilview-1.5.0', 'reference': '1.24.0-1+deb11u1'},
    {'release': '11.0', 'prefix': 'libatrildocument-dev', 'reference': '1.24.0-1+deb11u1'},
    {'release': '11.0', 'prefix': 'libatrildocument3', 'reference': '1.24.0-1+deb11u1'},
    {'release': '11.0', 'prefix': 'libatrilview-dev', 'reference': '1.24.0-1+deb11u1'},
    {'release': '11.0', 'prefix': 'libatrilview3', 'reference': '1.24.0-1+deb11u1'},
    {'release': '12.0', 'prefix': 'atril', 'reference': '1.26.0-2+deb12u3'},
    {'release': '12.0', 'prefix': 'atril-common', 'reference': '1.26.0-2+deb12u3'},
    {'release': '12.0', 'prefix': 'gir1.2-atrildocument-1.5.0', 'reference': '1.26.0-2+deb12u3'},
    {'release': '12.0', 'prefix': 'gir1.2-atrilview-1.5.0', 'reference': '1.26.0-2+deb12u3'},
    {'release': '12.0', 'prefix': 'libatrildocument-dev', 'reference': '1.26.0-2+deb12u3'},
    {'release': '12.0', 'prefix': 'libatrildocument3', 'reference': '1.26.0-2+deb12u3'},
    {'release': '12.0', 'prefix': 'libatrilview-dev', 'reference': '1.26.0-2+deb12u3'},
    {'release': '12.0', 'prefix': 'libatrilview3', 'reference': '1.26.0-2+deb12u3'}
];
