...
# extracted from Fedora Security Advisory FEDORA-2024-3ef0d3c37d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-3ef0d3c37d");

  script_name(english:"Fedora 41 : rclone (2024-3ef0d3c37d)");
...
FEDORA-2024-3ef0d3c37d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-3ef0d3c37d");
...
var pkgs = [
    {'reference':'rclone-1.67.0-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
