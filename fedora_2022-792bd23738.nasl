...
# extracted from Fedora Security Advisory FEDORA-2022-792bd23738
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-792bd23738");

  script_name(english:"Fedora 38 : python3.7 (2022-792bd23738)");
...
FEDORA-2022-792bd23738 advisory.
    ...
    ```
    * Mon Nov 14 2022 Miro Hronok <mhroncok@redhat.com> - 3.7.15-2
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-792bd23738");
...
var pkgs = [
    {'reference':'python3.7-3.7.15-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
