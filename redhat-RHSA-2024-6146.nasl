...
# extracted from Red Hat Security Advisory RHSA-2024:6146. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:6146");

  script_name(english:"RHEL 9 : python3.12 (RHSA-2024:6146)");
...
the RHSA-2024:6146 advisory.

    Python 3.12 is an accessible, high-level, dynamically typed, interpreted programming language, designed
    with an emphasis on code readability. It includes an extensive standard library, and has a vast ecosystem
    of third-party libraries.  The python3.12 package provides the python3.12 executable: the reference
    interpreter for the Python language, version 3. The majority of its standard library is provided in the
    python3.12-libs package, which should be installed automatically along with python3.12. The remaining
    parts of the Python standard library are broken out into the python3.12-tkinter and python3.12-test
    packages, which may need to be installed separately.  Documentation for Python is provided in the
    python3.12-docs package.  Packages containing additional libraries for Python are generally named with the
    python3.12- prefix.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_6146.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?303705c4");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2302255");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:6146");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3.12-3.12.1-4.el9_4.3', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.12-debug-3.12.1-4.el9_4.3', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.12-devel-3.12.1-4.el9_4.3', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.12-idle-3.12.1-4.el9_4.3', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.12-libs-3.12.1-4.el9_4.3', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.12-test-3.12.1-4.el9_4.3', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.12-tkinter-3.12.1-4.el9_4.3', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'python3.12-3.12.1-4.el9_4.3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.12-debug-3.12.1-4.el9_4.3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.12-devel-3.12.1-4.el9_4.3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.12-idle-3.12.1-4.el9_4.3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.12-libs-3.12.1-4.el9_4.3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.12-test-3.12.1-4.el9_4.3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.12-tkinter-3.12.1-4.el9_4.3', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python3.12 / python3.12-debug / python3.12-devel / python3.12-idle / etc');
}
