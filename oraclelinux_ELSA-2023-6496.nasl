...
# extracted from Oracle Linux Security Advisory ELSA-2023-6496.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : haproxy (ELSA-2023-6496)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-6496.html");
...
var pkgs = [
    {'reference':'haproxy-2.4.22-1.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'haproxy-2.4.22-1.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
