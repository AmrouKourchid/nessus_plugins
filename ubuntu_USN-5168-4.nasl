...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 ESM : NSS regression (USN-5168-4)");
...
USN-5168-4 advisory.
    ...
    USN-5168-3 fixed a vulnerability in NSS. Unfortunately that update introduced a regression that could
    break SSL connections. This update fixes the problem.
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libnss3', 'pkgver': '2:3.28.4-0ubuntu0.16.04.14+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libnss3-1d', 'pkgver': '2:3.28.4-0ubuntu0.16.04.14+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libnss3-dev', 'pkgver': '2:3.28.4-0ubuntu0.16.04.14+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libnss3-nssdb', 'pkgver': '2:3.28.4-0ubuntu0.16.04.14+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libnss3-tools', 'pkgver': '2:3.28.4-0ubuntu0.16.04.14+esm2', 'ubuntu_pro': TRUE}
];
