...
# extracted from Fedora Security Advisory FEDORA-2023-de87bd076b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-de87bd076b");

  script_name(english:"Fedora 37 : python-jupyter-core (2023-de87bd076b)");
...
FEDORA-2023-de87bd076b advisory.

    Fix for CVE-2022-39286

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-de87bd076b");
  script_set_attribute(attribute:"solution", value:
"Update the affected python-jupyter-core package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:python-jupyter-core");
...
var pkgs = [
    {'reference':'python-jupyter-core-4.10.0-4.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python-jupyter-core');
}
