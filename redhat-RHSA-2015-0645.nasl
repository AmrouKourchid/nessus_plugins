...
# extracted from Red Hat Security Advisory RHSA-2015:0645. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2015-0271");
  script_xref(name:"RHSA", value:"2015:0645");

  script_name(english:"RHEL 7 : redhat-access-plugin-openstack (RHSA-2015:0645)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for redhat-access-plugin-openstack.");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1193638");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2015/rhsa-2015_0645.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?268ddbbe");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2015:0645");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL redhat-access-plugin-openstack package based on the guidance in RHSA-2015:0645.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:S/C:P/I:N/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:N/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-0271");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:redhat-access-plugin-openstack");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'redhat-access-plugin-openstack-6.0.3-0.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'redhat-access-plugin-openstack');
}
