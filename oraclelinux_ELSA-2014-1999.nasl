...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2014-1999.html");
  script_set_attribute(attribute:"solution", value:
"Update the affected mailx package.");
