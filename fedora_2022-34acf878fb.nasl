...
# extracted from Fedora Security Advisory FEDORA-2022-34acf878fb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-34acf878fb");

  script_name(english:"Fedora 36 : scala (2022-34acf878fb)");
...
FEDORA-2022-34acf878fb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-34acf878fb");
  script_set_attribute(attribute:"solution", value:
"Update the affected scala package.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-36944");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:scala");
...
var pkgs = [
    {'reference':'scala-2.13.9-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
