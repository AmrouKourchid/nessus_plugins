...
# extracted from Fedora Security Advisory FEDORA-2025-f7671643c4
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-f7671643c4");

  script_name(english:"Fedora 40 : yarnpkg (2025-f7671643c4)");
...
FEDORA-2025-f7671643c4 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-f7671643c4");
...
"Update the affected yarnpkg package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-12905");
...
var pkgs = [
    {'reference':'yarnpkg-1.22.22-7.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
