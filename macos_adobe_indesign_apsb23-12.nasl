...
if (description)
{
  ...
  script_name(english:"Adobe InDesign < 17.4.1 / 18.0 < 18.2.0 Application denial-of-service (APSB23-12) (macOS)");
...
"The version of Adobe InDesign installed on the remote macOS host is prior to 17.4.1, 18.2.0. It is, therefore, affected
