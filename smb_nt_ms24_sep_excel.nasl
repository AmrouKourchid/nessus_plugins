...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5002605");
  script_xref(name:"MSFT", value:"MS24-5002605");
  script_xref(name:"IAVA", value:"2024-A-0564-S");
  script_xref(name:"IAVA", value:"2024-A-0562-S");

  script_name(english:"Security Updates for Microsoft Excel Products (September 2024)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002605");
...
var constraints = [
  { 'kb':'5002605', 'channel':'MSI', 'fixed_version': '16.0.5465.1000', 'sp' : 0}
];
