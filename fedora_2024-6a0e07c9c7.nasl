...
# extracted from Fedora Security Advisory FEDORA-2024-6a0e07c9c7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-6a0e07c9c7");

  script_name(english:"Fedora 39 : chromium (2024-6a0e07c9c7)");
...
FEDORA-2024-6a0e07c9c7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-6a0e07c9c7");
...
"Update the affected chromium package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-9955");
...
var pkgs = [
    {'reference':'chromium-130.0.6723.69-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
