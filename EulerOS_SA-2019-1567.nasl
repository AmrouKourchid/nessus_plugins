...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : cups (EulerOS-SA-2019-1567)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1567
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?55bbe1d7");
...
pkgs = ["cups-1.6.3-26.h2",
        "cups-client-1.6.3-26.h2",
        "cups-devel-1.6.3-26.h2",
        "cups-filesystem-1.6.3-26.h2",
        "cups-libs-1.6.3-26.h2",
        "cups-lpd-1.6.3-26.h2"];
