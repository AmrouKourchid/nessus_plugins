...
# extracted from Fedora Security Advisory FEDORA-2023-9ddb9b9757
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-9ddb9b9757");

  script_name(english:"Fedora 37 : wireshark (2023-9ddb9b9757)");
...
FEDORA-2023-9ddb9b9757 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-9ddb9b9757");
...
var pkgs = [
    {'reference':'wireshark-4.0.3-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
