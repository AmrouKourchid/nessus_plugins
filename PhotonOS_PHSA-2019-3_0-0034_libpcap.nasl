...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libpcap-1.9.1-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libpcap-debuginfo-1.9.1-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libpcap-devel-1.9.1-1.ph3')) flag++;
