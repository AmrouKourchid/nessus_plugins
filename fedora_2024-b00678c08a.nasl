...
# extracted from Fedora Security Advisory FEDORA-2024-b00678c08a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-b00678c08a");

  script_name(english:"Fedora 41 : php-tcpdf (2024-b00678c08a)");
...
FEDORA-2024-b00678c08a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-b00678c08a");
...
"Update the affected php-tcpdf package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-22641");
...
var pkgs = [
    {'reference':'php-tcpdf-6.7.7-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
