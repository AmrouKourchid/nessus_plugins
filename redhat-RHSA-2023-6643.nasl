...
# extracted from Red Hat Security Advisory RHSA-2023:6643. The text
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6643.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e04f7d10");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6643");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libssh package based on the guidance in RHSA-2023:6643.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libssh-0.10.4-11.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libssh-config-0.10.4-11.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libssh-devel-0.10.4-11.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
