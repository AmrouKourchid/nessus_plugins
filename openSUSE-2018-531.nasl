...
# extracted from openSUSE Security Update openSUSE-2018-531.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : jasper (openSUSE-2018-531)");
...
This update was imported from the SUSE:SLE-12:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1087020");
...
"Update the affected jasper packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-9055");
...
if ( rpm_check(release:"SUSE42.3", reference:"jasper-1.900.14-182.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"jasper-debuginfo-1.900.14-182.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"jasper-debugsource-1.900.14-182.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libjasper-devel-1.900.14-182.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libjasper1-1.900.14-182.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libjasper1-debuginfo-1.900.14-182.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", cpu:"x86_64", reference:"libjasper1-32bit-1.900.14-182.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", cpu:"x86_64", reference:"libjasper1-debuginfo-32bit-1.900.14-182.1") ) flag++;
