...
if (description)
{
  ...
  script_cve_id("CVE-2023-23395");
  script_xref(name:"MSKB", value:"5002358");
  script_xref(name:"MSFT", value:"MS23-5002358");
  script_xref(name:"IAVA", value:"2023-A-0133-S");

  script_name(english:"Security Updates for Microsoft SharePoint Server 2019 (March 2023)");
...
affected by a Sharepoint server spoofing vulnerability.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002358");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released KB5002358 to address this issue.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:H/Au:N/C:N/I:P/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:H/PR:N/UI:R/S:U/C:N/I:L/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-23395");
