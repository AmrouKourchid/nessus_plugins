...
# extracted from Ubuntu Security Notice USN-6686-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6686-2");

  script_name(english:"Ubuntu 22.04 LTS : Linux kernel vulnerabilities (USN-6686-2)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6686-2");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.15.0-1048-raspi");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-6686-2');
}
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-6686-2');
  }
  else
  {
