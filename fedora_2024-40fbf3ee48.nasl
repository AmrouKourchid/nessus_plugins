...
# extracted from Fedora Security Advisory FEDORA-2024-40fbf3ee48
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-40fbf3ee48");

  script_name(english:"Fedora 40 : libuev (2024-40fbf3ee48)");
...
FEDORA-2024-40fbf3ee48 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-40fbf3ee48");
...
var pkgs = [
    {'reference':'libuev-2.4.1-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
