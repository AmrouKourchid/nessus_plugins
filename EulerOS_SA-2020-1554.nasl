...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.2.0 : libxslt (EulerOS-SA-2020-1554)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1554
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dffb8b5b");
...
pkgs = ["libxslt-1.1.28-5.h7",
        "libxslt-python-1.1.28-5.h7"];
