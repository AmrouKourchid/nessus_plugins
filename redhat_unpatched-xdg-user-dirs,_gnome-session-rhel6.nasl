...
# extracted from Red Hat Security Advisory xdg-user-dirs,_gnome-session. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 6 : xdg-user-dirs,_gnome-session (Unpatched Vulnerability) (deprecated)");
