...
# extracted from Debian Security Advisory dsa-5558. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-5558-1 : netty - security update");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=1038947");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-34462");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bookworm/netty");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'libnetty-java', 'reference': '1:4.1.48-4+deb11u2'},
    {'release': '12.0', 'prefix': 'libnetty-java', 'reference': '1:4.1.48-7+deb12u1'}
];
