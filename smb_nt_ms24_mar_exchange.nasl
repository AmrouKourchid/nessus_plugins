...
if (description)
{
  ...
  script_cve_id("CVE-2024-26198");
  script_xref(name:"MSFT", value:"MS24-5036386");
  script_xref(name:"MSFT", value:"MS24-5036401");
  script_xref(name:"MSFT", value:"MS24-5036402");
  script_xref(name:"MSKB", value:"5036386");
  script_xref(name:"MSKB", value:"5036401");
  script_xref(name:"MSKB", value:"5036402");
  script_xref(name:"IAVA", value:"2024-A-0150-S");

  script_name(english:"Security Updates for Microsoft Exchange Server (March 2024)");
...
"Microsoft has released the following security updates to address this issue:
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-26198");
...
var constraints = [
  { 'fixed_version' : '15.1.2507.37', 'product' : '2016', 'cu' : 23, 'unsupported_cu' : 22, 'kb' : '5036386' },
  { 'fixed_version' : '15.2.1258.32', 'product' : '2019', 'cu' : 13, 'unsupported_cu' : 12, 'kb' : '5036402' },
  { 'fixed_version' : '15.2.1544.9', 'product' : '2019', 'cu' : 14, 'unsupported_cu' : 12, 'kb' : '5036401' }
];
