...
# extracted from F5 Networks BIG-IP Solution K24207649.
#
# @NOAGENT@
##
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : GNU C Library (glibc) vulnerability (K24207649)");
...
affected by a vulnerability as referenced in the K24207649 advisory.
    ...
    escalate their privileges on the system.(CVE-2021-3999)ImpactA flaw was found in glibc. An off-by-one
    buffer overflow and underflow in getcwd() may lead to memory corruption when the size of the buffer is
    exactly 1. A local attacker who can control the input buffer and size passed to getcwd() in a setuid
    program could use this flaw to potentially run arbitrary code and escalate their privileges on the system.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K24207649");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K24207649.");
