...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : fuse (EulerOS-SA-2019-1575)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1575
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5ff981b0");
...
pkgs = ["fuse-2.9.2-11.h1",
        "fuse-devel-2.9.2-11.h1",
        "fuse-libs-2.9.2-11.h1"];
