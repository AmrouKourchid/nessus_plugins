...
# extracted from Red Hat Security Advisory RHSA-2024:8083. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2024-21489");
  script_xref(name:"RHSA", value:"2024:8083");

  script_name(english:"RHEL 8 : grafana (RHSA-2024:8083)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2315838");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_8083.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?39f9e103");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:8083");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL grafana package based on the guidance in RHSA-2024:8083.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-21489");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'grafana-7.3.6-7.el8_4', 'sp':'4', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'grafana-7.3.6-7.el8_4', 'sp':'4', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
