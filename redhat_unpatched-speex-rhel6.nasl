...
# extracted from Red Hat Security Advisory speex. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2020-23903", "CVE-2020-23904");

  script_name(english:"RHEL 6 : speex (Unpatched Vulnerability) (deprecated)");
