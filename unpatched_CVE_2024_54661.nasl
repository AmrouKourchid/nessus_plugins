...
if (description)
{
  ...
  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-54661");
...
patch available.
  ...
  - readline.sh in socat before1.8.0.2 relies on the /tmp/$USER/stderr2 file. (CVE-2024-54661)
