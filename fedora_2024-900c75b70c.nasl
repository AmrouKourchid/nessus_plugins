...
# extracted from Fedora Security Advisory FEDORA-2024-900c75b70c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-900c75b70c");

  script_name(english:"Fedora 41 : iwd / libell / ofono (2024-900c75b70c)");
...
FEDORA-2024-900c75b70c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-900c75b70c");
  script_set_attribute(attribute:"solution", value:
"Update the affected iwd, libell and / or ofono packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:ofono");
...
var pkgs = [
    {'reference':'iwd-2.20-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libell-0.68-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ofono-2.10-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'iwd / libell / ofono');
}
