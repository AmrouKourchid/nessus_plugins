...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.04 / MAIN 5.04 : openjpeg2 Vulnerability (NS-SA-2020-0012)");
...
pkgs = {
  "CGSL CORE 5.04": [
    "openjpeg2-2.3.1-2.el7_7",
    "openjpeg2-debuginfo-2.3.1-2.el7_7",
    "openjpeg2-devel-2.3.1-2.el7_7",
    "openjpeg2-devel-docs-2.3.1-2.el7_7",
    "openjpeg2-tools-2.3.1-2.el7_7"
  ],
  "CGSL MAIN 5.04": [
    "openjpeg2-2.3.1-2.el7_7",
    "openjpeg2-debuginfo-2.3.1-2.el7_7",
