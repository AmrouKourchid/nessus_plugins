...
if (description)
{
  ...
  script_cve_id("CVE-2022-21917");
  script_xref(name:"IAVA", value:"2022-A-0012-S");
  script_xref(name:"IAVA", value:"2022-A-0016-S");

  script_name(english:"Microsoft Windows Codecs Library RCE (January 2022)");
...
"Upgrade to app version 1.0.43421.0, 1.0.43422.0, or later via the Microsoft Store.");
...
var constraints = [
    { 'fixed_version' : '1.0.43421.0', 'fixed_display' : '1.0.43421.0 / 1.0.43422.0'}
];
