...
# extracted from Fedora Security Advisory FEDORA-2023-30431913bc
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-30431913bc");

  script_name(english:"Fedora 39 : caddy (2023-30431913bc)");
...
FEDORA-2023-30431913bc advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-30431913bc");
...
var pkgs = [
    {'reference':'caddy-2.7.0~beta2-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
