...
# extracted from VMware Security Advisory PHSA-2021-4.0-0099. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Git PHSA-2021-4.0-0099");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the git package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-99.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'git-2.30.0-5.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'git-lang-2.30.0-5.ph4')) flag++;
