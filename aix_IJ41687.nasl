...
if (description)
{
  ...
  script_name(english:"AIX (IJ41687)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AIX host is missing a security patch.");
  script_set_attribute(attribute:"description", value:
"The version of AIX installed on the remote host is prior to APAR IJ41687. It is, therefore, affected by a vulnerability
as referenced in the IJ41687 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/apar/IJ41687");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/node/6619721");
  script_set_attribute(attribute:"solution", value:
"Please apply the appropriate interim fix per APAR IJ41687.");
...
var constraints = [
    {'release': '7.3', 'ml': '00', 'sp': '01', 'patch': 'IJ41687m1a', 'package': 'bos.mp64', 'minfilesetver': '7.3.0.0', 'maxfilesetver': '7.3.0.3'},
    {'release': '7.3', 'ml': '00', 'sp': '02', 'patch': 'IJ41687s2a', 'package': 'bos.mp64', 'minfilesetver': '7.3.0.0', 'maxfilesetver': '7.3.0.3'}
];
