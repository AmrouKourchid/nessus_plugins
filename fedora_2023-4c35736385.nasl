...
# extracted from Fedora Security Advisory FEDORA-2023-4c35736385
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-4c35736385");

  script_name(english:"Fedora 39 : golang (2023-4c35736385)");
...
FEDORA-2023-4c35736385 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-4c35736385");
...
var pkgs = [
    {'reference':'golang-1.21.1-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
