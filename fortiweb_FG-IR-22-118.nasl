...
if (description)
{
  ...
  script_cve_id("CVE-2023-23780");

  script_name(english:"Fortinet FortiWeb Multiple Stack based buffer overflow in web interface (FG-IR-22-118)");
...
vulnerability as referenced in the FG-IR-22-118 advisory.

  - A stack-based buffer overflow in Fortinet FortiWeb version 7.0.0 through 7.0.1, Fortinet FortiWeb version
    6.3.6 through 6.3.19, Fortinet FortiWeb 6.4 all versions allows attacker to escalation of privilege via
    specifically crafted HTTP requests. (CVE-2023-23780)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.fortiguard.com/psirt/FG-IR-22-118");
...
"Please upgrade to FortiWeb version 6.3.20/7.0.2 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-23780");
