...
if (description)
{
  ...
  script_name(english:"Google Chrome < 135.0.7049.84 Vulnerability");

  script_set_attribute(attribute:"synopsis", value:
"A web browser installed on the remote Windows host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Google Chrome installed on the remote Windows host is prior to 135.0.7049.84. It is, therefore, affected
by a vulnerability as referenced in the 2025_04_stable-channel-update-for-desktop_8 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0c689e70");
  script_set_attribute(attribute:"see_also", value:"https://crbug.com/405140652");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Google Chrome version 135.0.7049.84 or later.");
...
google_chrome_check_version(installs:installs, fix:'135.0.7049.84', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
