...
# extracted from VMware Security Advisory PHSA-2019-2.0-0150. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Haproxy PHSA-2019-2.0-0150");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the haproxy package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-2-150.md");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'haproxy-1.9.6-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'haproxy-debuginfo-1.9.6-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'haproxy-doc-1.9.6-1.ph2')) flag++;
