...
# extracted from Fedora Security Advisory FEDORA-2024-f0f2f19820
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-f0f2f19820");

  script_name(english:"Fedora 38 : ppp (2024-f0f2f19820)");
...
FEDORA-2024-f0f2f19820 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-f0f2f19820");
...
var pkgs = [
    {'reference':'ppp-2.4.9-10.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
