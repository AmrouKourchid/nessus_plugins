...
# extracted from Red Hat Security Advisory RHSA-2022:1053. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:1053");

  script_name(english:"RHEL 8 : Red Hat Virtualization Host security update [ovirt-4.4.10] Async #2 (Important) (RHSA-2022:1053)");
...
referenced in the RHSA-2022:1053 advisory.
    ...
    * Rebase package(s) to version: libvirt-7.6.0-6.1.module+el8.5.0+14474+b3410d40
    Highlights and important bug fixes: consume libvirt fix for failure to connect socket to
    '/run/libvirt/virtlogd-sock' - possibly caused by too many open files from libvirtd. (BZ#2057048)

Tenable has extracted the preceding description block directly from the Red Hat Enterprise Linux security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_1053.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cec76143");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:1053");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2034626");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2048407");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2057048");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat Virtualization Host package based on the guidance in RHSA-2022:1053.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'redhat-virtualization-host-image-update-4.4.10-202203211649_8.5', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'}
    ]
  }
];
