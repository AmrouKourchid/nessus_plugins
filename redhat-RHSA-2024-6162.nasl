...
# extracted from Red Hat Security Advisory RHSA-2024:6162. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:6162");

  script_name(english:"RHEL 9 : python-urllib3 (RHSA-2024:6162)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for python-urllib3.");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_6162.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4e6e5fca");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:6162");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-urllib3 package based on the guidance in RHSA-2024:6162.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-urllib3-1.26.5-5.el9_4.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'python3-urllib3-1.26.5-5.el9_4.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
