...
# extracted from Red Hat Security Advisory RHSA-2022:2081. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:2081");

  script_name(english:"RHEL 8 : bluez (RHSA-2022:2081)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for bluez.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2022:2081 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_2081.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6f1bf84a");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/8.6_release_notes/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9341665d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:2081");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2025034");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL bluez package based on the guidance in RHSA-2022:2081.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'bluez-5.56-3.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bluez-cups-5.56-3.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bluez-hid2hci-5.56-3.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bluez-libs-5.56-3.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bluez-libs-devel-5.56-3.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bluez-obexd-5.56-3.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
