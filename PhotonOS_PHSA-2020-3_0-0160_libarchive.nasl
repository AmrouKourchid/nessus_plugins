...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Libarchive PHSA-2020-3.0-0160");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libarchive-3.3.3-6.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libarchive-devel-3.3.3-6.ph3')) flag++;
