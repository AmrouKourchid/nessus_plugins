...
# extracted from Fedora Security Advisory FEDORA-2025-a265e06eb2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-a265e06eb2");

  script_name(english:"Fedora 41 : trunk (2025-a265e06eb2)");
...
FEDORA-2025-a265e06eb2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-a265e06eb2");
  script_set_attribute(attribute:"solution", value:
"Update the affected trunk package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:trunk");
...
var pkgs = [
    {'reference':'trunk-0.21.13-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'trunk');
}
