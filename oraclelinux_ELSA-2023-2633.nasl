...
# extracted from Oracle Linux Security Advisory ELSA-2023-2633.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : libreswan (ELSA-2023-2633)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-2633.html");
...
var pkgs = [
    {'reference':'libreswan-4.9-2.0.1.el9_2', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libreswan-4.9-2.0.1.el9_2', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
