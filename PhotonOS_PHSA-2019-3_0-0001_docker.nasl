...
# extracted from VMware Security Advisory PHSA-2019-3.0-0001. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Docker PHSA-2019-3.0-0001");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the docker package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-3.0-0001.md");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'docker-18.06.2-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'docker-doc-18.06.2-1.ph3')) flag++;
