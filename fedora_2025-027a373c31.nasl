...
# extracted from Fedora Security Advisory FEDORA-2025-027a373c31
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-027a373c31");

  script_name(english:"Fedora 41 : vim (2025-027a373c31)");
...
FEDORA-2025-027a373c31 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-027a373c31");
...
var pkgs = [
    {'reference':'vim-9.1.1169-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
