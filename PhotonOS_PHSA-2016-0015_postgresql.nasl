...
if (description)
{
  ...
  script_cve_id("CVE-2016-5423");

  script_name(english:"Photon OS 1.0: Postgresql PHSA-2016-0015");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'postgresql-9.5.3-4.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'postgresql-debuginfo-9.5.3-4.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'postgresql-libs-9.5.3-4.ph1')) flag++;
