...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.1 : python-urllib3 (EulerOS-SA-2024-1407)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1407
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?867b20e5");
...
var pkgs = [
  "python3-urllib3-1.26.7-2.h7.eulerosv2r11"
];
