...
# extracted from VMware Security Advisory PHSA-2022-3.0-0426. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Nodejs PHSA-2022-3.0-0426");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the nodejs package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-3.0-426.md");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'nodejs-16.16.0-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'nodejs-devel-16.16.0-1.ph3')) flag++;
