...
if (description)
{
  ...
  script_cve_id("CVE-2013-1998");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2013-1998");
...
patch available.
  ...
  - Multiple buffer overflows in X.org libXi 1.7.1 and earlier allow X servers to cause a denial of service
    ...
    XGetDeviceButtonMapping, (2) XIPassiveGrabDevice, and (3) XQueryDeviceState functions. (CVE-2013-1998)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-1998");
