...
"The version of Google Chrome installed on the remote macOS host is prior to 135.0.7049.41. It is, therefore, affected by
multiple vulnerabilities as referenced in the 2025_04_stable-channel-update-for-desktop advisory.
...
google_chrome_check_version(fix:'135.0.7049.41', severity:SECURITY_WARNING, xss:FALSE, xsrf:FALSE);
