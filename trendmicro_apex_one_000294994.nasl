...
if (description)
{
  ...
  script_name(english:"Trend Micro Apex One Command Execution (000294994)");
...
prior to SP1 (Server Build 12380 and Agent Build 12380). It is, therefore, affected by a vulnerability in the 3rd party
AV uninstaller module contained in Trend Micro Apex One, Worry-Free Business Security and Worry-Free Business
 Security Services could allow an attacker to manipulate the module to execute arbitrary commands on an 
 affected installation. 

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version   
number.");
  script_set_attribute(attribute:"see_also", value:"https://success.trendmicro.com/dcx/s/solution/000294994?language=en_US");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Apex One SP1 (b12380/12380) or later.");
...
var constraints = [{ 'fixed_version' : '14.0.0.12380' }];
