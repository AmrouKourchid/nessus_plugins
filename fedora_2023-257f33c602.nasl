...
# extracted from Fedora Security Advisory FEDORA-2023-257f33c602
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-257f33c602");

  script_name(english:"Fedora 38 : pack (2023-257f33c602)");
...
FEDORA-2023-257f33c602 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-257f33c602");
...
var pkgs = [
    {'reference':'pack-0.32.0-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
