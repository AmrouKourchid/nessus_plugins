...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.1 : python-requests (EulerOS-SA-2023-2741)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the python-requests package installed, the EulerOS Virtualization installation on the
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2741
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e80cc9ed");
...
"Update the affected python-requests packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:python-requests-help");
...
var pkgs = [
  "python-requests-help-2.26.0-5.h2.eulerosv2r11"
];
