...
# extracted from Debian Security Advisory dla-4161. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2025-27773");

  script_name(english:"Debian dla-4161 : simplesamlphp - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has a package installed that is affected by a vulnerability as referenced in the dla-4161
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2025-27773");
...
"Upgrade the simplesamlphp packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-27773");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'simplesamlphp', 'reference': '1.19.0-1+deb11u2'}
];
