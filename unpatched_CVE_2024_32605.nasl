...
if (description)
{
  ...
  script_cve_id("CVE-2024-32605");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-32605");
...
patch available.
  ...
  - HDF5 Library through 1.14.3 has a heap-based buffer over-read in H5VM_memcpyvv in H5VM.c (called from
    H5D__compact_readvv in H5Dcompact.c). (CVE-2024-32605)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-32605");
