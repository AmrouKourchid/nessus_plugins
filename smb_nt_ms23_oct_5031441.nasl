...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5031408");
  script_xref(name:"MSKB", value:"5031441");
  script_xref(name:"MSFT", value:"MS23-5031408");
  script_xref(name:"MSFT", value:"MS23-5031441");
  ...
  script_name(english:"KB5031441: Windows Server 2008 R2 Security Update (October 2023)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5031408");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5031441");
...
if (("windows server 2008 r2" >< tolower(os_name)) &&
  smb_check_rollup(os:'6.1',
                   ...
                   rollup_date:'10_2023',
                   bulletin:bulletin,
                   rollup_kb_list:[5031441, 5031408])
)
{
