...
if (description)
{
  ...
  script_name(english:"Google Chrome < 109.0.5414.74 Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"A web browser installed on the remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Google Chrome installed on the remote Windows host is prior to 109.0.5414.74. It is, therefore, affected
by multiple vulnerabilities as referenced in the 2023_01_stable-channel-update-for-desktop advisory.
...
"Upgrade to Google Chrome version 109.0.5414.74 or later.");
...
google_chrome_check_version(installs:installs, fix:'109.0.5414.74', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
