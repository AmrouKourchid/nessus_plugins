...
# extracted from VMware Security Advisory PHSA-2024-5.0-0352. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Unbound PHSA-2024-5.0-0352");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the unbound package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-5.0-352.md");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'unbound-1.17.0-5.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'unbound-devel-1.17.0-5.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'unbound-docs-1.17.0-5.ph5')) flag++;
