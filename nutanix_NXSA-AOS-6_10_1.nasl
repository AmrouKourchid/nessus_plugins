...
if (description)
{
  ...
  script_name(english:"Nutanix AOS : Multiple Vulnerabilities (NXSA-AOS-6.10.1)");

  script_set_attribute(attribute:"synopsis", value:
"The Nutanix AOS host is affected by multiple vulnerabilities .");
  script_set_attribute(attribute:"description", value:
"The version of AOS installed on the remote host is prior to 6.10.1. It is, therefore, affected by multiple
vulnerabilities as referenced in the NXSA-AOS-6.10.1 advisory.
...
number.");
  # https://portal.nutanix.com/page/documents/security-advisories/release-advisories/details?id=NXSA-AOS-6.10.1
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?98a94f55");
...
var constraints = [
  { 'fixed_version' : '6.10.1', 'product' : 'AOS', 'fixed_display' : 'Upgrade the AOS install to 6.10.1 or higher.', 'lts' : TRUE },
  { 'fixed_version' : '6.10.1', 'product' : 'NDFS', 'fixed_display' : 'Upgrade the AOS install to 6.10.1 or higher.', 'lts' : TRUE }
];
