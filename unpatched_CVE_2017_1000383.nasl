...
if (description)
{
  ...
  script_cve_id("CVE-2017-1000383");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2017-1000383");
...
patch available.
  ...
  - GNU Emacs version 25.3.1 (and other versions most likely) ignores umask when creating a backup save file
    ([ORIGINAL_FILENAME]~) resulting in files that may be world readable or otherwise accessible in ways not
    intended by the user running the emacs binary. (CVE-2017-1000383)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-1000383");
