...
if (description)
{
  ...
  script_name(english:"Red Hat Enterprise Linux SEoL (8.4.x, 8.5.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Red Hat Enterprise Linux is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Red Hat Enterprise Linux is 8.4.x or 8.5.x. It is, therefore, no longer maintained by its vendor or
provider.
...
"Upgrade to a version of Red Hat Enterprise Linux that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2023/05/31");
...
var constraints = [
  { min_branch : '8.4', max_branch : '8.5', seol : 20230531, eseol : 20250730 }
];
