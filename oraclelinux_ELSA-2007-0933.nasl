...
# Oracle Linux Security Advisory ELSA-2007-0933 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : Moderate: / elinks (ELSA-2007-0933)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2007-0933.html");
...
"Update the affected elinks package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2007-5034");
...
var pkgs = [
    {'reference':'elinks-0.11.1-5.1.0.1.el5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'elinks-0.11.1-5.1.0.1.el5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
