...
# extracted from Fedora Security Advisory FEDORA-2025-04475838f9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-04475838f9");

  script_name(english:"Fedora 40 : wireshark (2025-04475838f9)");
...
FEDORA-2025-04475838f9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-04475838f9");
...
var pkgs = [
    {'reference':'wireshark-4.2.11-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
