...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Pam_Tacplus PHSA-2020-2.0-0295");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'pam_tacplus-1.6.1-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'pam_tacplus-devel-1.6.1-1.ph2')) flag++;
