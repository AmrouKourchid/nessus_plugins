...
# extracted from Fedora Security Advisory FEDORA-2024-5f8da7c1f1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-5f8da7c1f1");

  script_name(english:"Fedora 38 : vorbis-tools (2024-5f8da7c1f1)");
...
FEDORA-2024-5f8da7c1f1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-5f8da7c1f1");
...
var pkgs = [
    {'reference':'vorbis-tools-1.4.2-9.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
