...
# AlmaLinux Security Advisory ALSA-2019:3703.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2019:3703");

  script_name(english:"AlmaLinux 8 : libvorbis (ALSA-2019:3703)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ALSA-2019:3703 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2019-3703.html");
...
"Update the affected libvorbis, libvorbis-devel and / or libvorbis-devel-docs packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:libvorbis");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:libvorbis-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:libvorbis-devel-docs");
