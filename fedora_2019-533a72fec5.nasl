...
# extracted from Fedora Security Advisory FEDORA-2019-533a72fec5.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-533a72fec5");

  script_name(english:"Fedora 30 : fribidi (2019-533a72fec5)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-533a72fec5");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"fribidi-1.0.5-5.fc30")) flag++;
