...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : OpenStack Nova vulnerabilities (USN-2407-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 14.04 LTS host has packages installed that are affected by multiple vulnerabilities as referenced in
the USN-2407-1 advisory.

    Garth Mollett discovered that OpenStack Nova did not properly clean up an instance when using rescue mode
    with the VMWare driver. A remove authenticated user could exploit this to bypass intended quota limits. By
    default, Ubuntu does not use the VMWare driver. (CVE-2014-3608)

    Amrith Kumar discovered that OpenStack Nova did not properly sanitize log message contents. Under certain
    circumstances, a local attacker with read access to Nova log files could obtain access to sensitive
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2407-1");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-7230");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'nova-ajax-console-proxy', 'pkgver': '1:2014.1.3-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'nova-api', 'pkgver': '1:2014.1.3-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'nova-api-ec2', 'pkgver': '1:2014.1.3-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'nova-api-metadata', 'pkgver': '1:2014.1.3-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'nova-api-os-compute', 'pkgver': '1:2014.1.3-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'nova-api-os-volume', 'pkgver': '1:2014.1.3-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'nova-baremetal', 'pkgver': '1:2014.1.3-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'nova-cells', 'pkgver': '1:2014.1.3-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'nova-cert', 'pkgver': '1:2014.1.3-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'nova-common', 'pkgver': '1:2014.1.3-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'nova-compute', 'pkgver': '1:2014.1.3-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'nova-compute-kvm', 'pkgver': '1:2014.1.3-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'nova-compute-libvirt', 'pkgver': '1:2014.1.3-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'nova-compute-lxc', 'pkgver': '1:2014.1.3-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'nova-compute-qemu', 'pkgver': '1:2014.1.3-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'nova-compute-vmware', 'pkgver': '1:2014.1.3-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'nova-compute-xen', 'pkgver': '1:2014.1.3-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'nova-conductor', 'pkgver': '1:2014.1.3-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'nova-console', 'pkgver': '1:2014.1.3-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'nova-consoleauth', 'pkgver': '1:2014.1.3-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'nova-network', 'pkgver': '1:2014.1.3-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'nova-novncproxy', 'pkgver': '1:2014.1.3-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'nova-objectstore', 'pkgver': '1:2014.1.3-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'nova-scheduler', 'pkgver': '1:2014.1.3-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'nova-spiceproxy', 'pkgver': '1:2014.1.3-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'nova-volume', 'pkgver': '1:2014.1.3-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'nova-xvpvncproxy', 'pkgver': '1:2014.1.3-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'python-nova', 'pkgver': '1:2014.1.3-0ubuntu1.1'}
];
