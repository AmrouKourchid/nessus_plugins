...
# extracted from Ubuntu Security Notice USN-3716-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS : Dnsmasq update (USN-3716-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3716-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'dnsmasq', 'pkgver': '2.75-1ubuntu0.16.04.5'},
    {'osver': '16.04', 'pkgname': 'dnsmasq-base', 'pkgver': '2.75-1ubuntu0.16.04.5'},
    {'osver': '16.04', 'pkgname': 'dnsmasq-utils', 'pkgver': '2.75-1ubuntu0.16.04.5'}
];
