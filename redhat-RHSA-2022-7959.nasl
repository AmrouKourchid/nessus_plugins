...
# extracted from Red Hat Security Advisory RHSA-2022:7959. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:7959");

  script_name(english:"RHEL 9 : guestfs-tools (RHSA-2022:7959)");
...
the RHSA-2022:7959 advisory.

    guestfs-tools is a set of tools that can be used to make batch configuration changes to guests, get disk
    used/free statistics, perform backups and guest clones, change registry/UUID/hostname info, build guests
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_7959.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?027d06ef");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/9/html/9.1_release_notes/index
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1f1eb6cc");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:7959");
...
"Update the affected guestfs-tools and / or virt-win-reg packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:guestfs-tools");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:virt-win-reg");
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'guestfs-tools / virt-win-reg');
}
