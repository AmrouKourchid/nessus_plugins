...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : subversion (EulerOS-SA-2022-2147)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2147
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4df6a248");
...
var pkgs = [
  "subversion-1.12.2-1.h4.eulerosv2r10",
  "subversion-help-1.12.2-1.h4.eulerosv2r10"
];
