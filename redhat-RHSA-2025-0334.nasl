...
# extracted from Red Hat Security Advisory RHSA-2025:0334. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 9 : ipa (RHSA-2025:0334)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2325557");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_0334.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b4ba045d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:0334");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL ipa package based on the guidance in RHSA-2025:0334.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:ipa-selinux-luna");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:ipa-selinux-nfast");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ipa-client-4.12.2-1.el9_5.3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-client-common-4.12.2-1.el9_5.3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-client-epn-4.12.2-1.el9_5.3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-client-samba-4.12.2-1.el9_5.3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-common-4.12.2-1.el9_5.3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-selinux-4.12.2-1.el9_5.3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-selinux-luna-4.12.2-1.el9_5.3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-selinux-nfast-4.12.2-1.el9_5.3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-server-4.12.2-1.el9_5.3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-server-common-4.12.2-1.el9_5.3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-server-dns-4.12.2-1.el9_5.3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-server-trust-ad-4.12.2-1.el9_5.3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-ipaclient-4.12.2-1.el9_5.3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-ipalib-4.12.2-1.el9_5.3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-ipaserver-4.12.2-1.el9_5.3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-ipatests-4.12.2-1.el9_5.3', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
