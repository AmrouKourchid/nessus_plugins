...
# extracted from Fedora Security Advisory FEDORA-2025-135cf1b7f3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-135cf1b7f3");

  script_name(english:"Fedora 41 : seamonkey (2025-135cf1b7f3)");
...
FEDORA-2025-135cf1b7f3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-135cf1b7f3");
...
var pkgs = [
    {'reference':'seamonkey-2.53.20-2.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
