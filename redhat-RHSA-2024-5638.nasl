...
# extracted from Red Hat Security Advisory RHSA-2024:5638. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:5638");

  script_name(english:"RHEL 9 : orc:0.4.31 (RHSA-2024:5638)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for orc:0.4.31.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_5638.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?768c97bf");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2300010");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:5638");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL orc:0.4.31 package based on the guidance in RHSA-2024:5638.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'orc-0.4.31-7.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'orc-compiler-0.4.31-7.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'orc-devel-0.4.31-7.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
