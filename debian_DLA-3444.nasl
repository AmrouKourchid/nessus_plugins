...
# extracted from Debian Security Advisory dla-3444. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3444 : libmariadb-dev - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3444
advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-47015");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libmariadb-dev', 'reference': '1:10.3.39-0+deb10u1'},
    {'release': '10.0', 'prefix': 'libmariadb-dev-compat', 'reference': '1:10.3.39-0+deb10u1'},
    {'release': '10.0', 'prefix': 'libmariadb3', 'reference': '1:10.3.39-0+deb10u1'},
    {'release': '10.0', 'prefix': 'libmariadbclient-dev', 'reference': '1:10.3.39-0+deb10u1'},
    {'release': '10.0', 'prefix': 'libmariadbd-dev', 'reference': '1:10.3.39-0+deb10u1'},
    {'release': '10.0', 'prefix': 'libmariadbd19', 'reference': '1:10.3.39-0+deb10u1'},
    {'release': '10.0', 'prefix': 'mariadb-backup', 'reference': '1:10.3.39-0+deb10u1'},
    {'release': '10.0', 'prefix': 'mariadb-client', 'reference': '1:10.3.39-0+deb10u1'},
    {'release': '10.0', 'prefix': 'mariadb-client-10.3', 'reference': '1:10.3.39-0+deb10u1'},
    {'release': '10.0', 'prefix': 'mariadb-client-core-10.3', 'reference': '1:10.3.39-0+deb10u1'},
    {'release': '10.0', 'prefix': 'mariadb-common', 'reference': '1:10.3.39-0+deb10u1'},
    {'release': '10.0', 'prefix': 'mariadb-plugin-connect', 'reference': '1:10.3.39-0+deb10u1'},
    {'release': '10.0', 'prefix': 'mariadb-plugin-cracklib-password-check', 'reference': '1:10.3.39-0+deb10u1'},
    {'release': '10.0', 'prefix': 'mariadb-plugin-gssapi-client', 'reference': '1:10.3.39-0+deb10u1'},
    {'release': '10.0', 'prefix': 'mariadb-plugin-gssapi-server', 'reference': '1:10.3.39-0+deb10u1'},
    {'release': '10.0', 'prefix': 'mariadb-plugin-mroonga', 'reference': '1:10.3.39-0+deb10u1'},
    {'release': '10.0', 'prefix': 'mariadb-plugin-oqgraph', 'reference': '1:10.3.39-0+deb10u1'},
    {'release': '10.0', 'prefix': 'mariadb-plugin-rocksdb', 'reference': '1:10.3.39-0+deb10u1'},
    {'release': '10.0', 'prefix': 'mariadb-plugin-spider', 'reference': '1:10.3.39-0+deb10u1'},
    {'release': '10.0', 'prefix': 'mariadb-plugin-tokudb', 'reference': '1:10.3.39-0+deb10u1'},
    {'release': '10.0', 'prefix': 'mariadb-server', 'reference': '1:10.3.39-0+deb10u1'},
    {'release': '10.0', 'prefix': 'mariadb-server-10.3', 'reference': '1:10.3.39-0+deb10u1'},
    {'release': '10.0', 'prefix': 'mariadb-server-core-10.3', 'reference': '1:10.3.39-0+deb10u1'},
    {'release': '10.0', 'prefix': 'mariadb-test', 'reference': '1:10.3.39-0+deb10u1'},
    {'release': '10.0', 'prefix': 'mariadb-test-data', 'reference': '1:10.3.39-0+deb10u1'}
];
