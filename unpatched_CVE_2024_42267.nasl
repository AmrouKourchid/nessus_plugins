...
if (description)
{
  ...
  script_cve_id("CVE-2024-42267");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-42267");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: riscv/mm: Add handling for
    VM_FAULT_SIGSEGV in mm_fault_error() Handle VM_FAULT_SIGSEGV in the page fault path so that we correctly
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-42267");
