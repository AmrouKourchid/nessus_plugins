...
# extracted from Red Hat Security Advisory RHSA-2019:1708. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:1708");

  script_name(english:"RHEL 7 / 8 : ansible (RHSA-2019:1708)");
...
in the RHSA-2019:1708 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_1708.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f5641eab");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:1708");
...
"Update the RHEL ansible package based on the guidance in RHSA-2019:1708.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ansible-2.8.2-1.el8ae', 'release':'8', 'el_string':'el8ae', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2.8'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'ansible-2.8.2-1.el7ae', 'release':'7', 'el_string':'el7ae', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2.8'}
    ]
  }
];
