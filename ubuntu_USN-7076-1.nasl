...
# extracted from Ubuntu Security Notice USN-7076-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"7076-1");

  script_name(english:"Ubuntu 20.04 LTS / 22.04 LTS : Linux kernel (Azure) vulnerabilities (USN-7076-1)");
...
referenced in the USN-7076-1 advisory.
    ...
    - Network traffic control; (CVE-2024-27397, CVE-2024-45016, CVE-2024-45001, CVE-2024-38630)

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7076-1");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.15.0-1074-azure");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-7076-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2024-27397', 'CVE-2024-38630', 'CVE-2024-45001', 'CVE-2024-45016');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-7076-1');
  }
  else
  {
