...
# extracted from Fedora Security Advisory FEDORA-2023-69d282009c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-69d282009c");

  script_name(english:"Fedora 38 : python3.10 (2023-69d282009c)");
...
FEDORA-2023-69d282009c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-69d282009c");
...
var pkgs = [
    {'reference':'python3.10-3.10.13-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
