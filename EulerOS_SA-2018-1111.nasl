...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : exempi (EulerOS-SA-2018-1111)");
...
vulnerabilities :
  ...
  - Exempi provides a library for easy parsing of XMP
    metadata. It is a port of Adobe XMP SDK to work on UNIX
    and to be build with GNU automake.It includes XMPCore
    and XMPFiles.
  ...
  - An issue was discovered in Exempi before 2.4.3. It
    ...
    and
    XMPFiles/source/FormatSupport/TIFF_Support.hpp.(CVE-201
    7-18234)
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1111
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9212187f");
