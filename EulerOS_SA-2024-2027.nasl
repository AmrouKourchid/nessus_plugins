...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : freerdp (EulerOS-SA-2024-2027)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2027
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4b541068");
...
var pkgs = [
  "freerdp-2.0.0-44.rc3.h17.eulerosv2r8",
  "freerdp-libs-2.0.0-44.rc3.h17.eulerosv2r8",
  "libwinpr-2.0.0-44.rc3.h17.eulerosv2r8"
];
