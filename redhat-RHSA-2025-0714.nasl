...
# extracted from Red Hat Security Advisory RHSA-2025:0714. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:0714");

  script_name(english:"RHEL 7 : rsync (RHSA-2025:0714)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_0714.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fdb46696");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:0714");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rsync package based on the guidance in RHSA-2025:0714.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rsync-3.1.2-12.el7_9.1', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsync-3.1.2-12.el7_9.1', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsync-3.1.2-12.el7_9.1', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsync-3.1.2-12.el7_9.1', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
