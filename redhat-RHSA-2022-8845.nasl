...
"The remote Red Hat host is missing a security update for Red Hat OpenStack Platform 16.2.4 (python-paramiko).");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8845.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a3c7883e");
...
"Update the RHEL Red Hat OpenStack Platform 16.2.4 (python-paramiko) package based on the guidance in RHSA-2022:8845.");
