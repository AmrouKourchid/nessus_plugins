...
# extracted from Debian Security Advisory dla-3954. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3954 : libecpg-compat3 - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has packages installed that are affected by a vulnerability as referenced in the dla-3954
advisory.
...
var pkgs = [
    {'release': '11.0', 'prefix': 'libecpg-compat3', 'reference': '13.18-0+deb11u1'},
    {'release': '11.0', 'prefix': 'libecpg-dev', 'reference': '13.18-0+deb11u1'},
    {'release': '11.0', 'prefix': 'libecpg6', 'reference': '13.18-0+deb11u1'},
    {'release': '11.0', 'prefix': 'libpgtypes3', 'reference': '13.18-0+deb11u1'},
    {'release': '11.0', 'prefix': 'libpq-dev', 'reference': '13.18-0+deb11u1'},
    {'release': '11.0', 'prefix': 'libpq5', 'reference': '13.18-0+deb11u1'},
    {'release': '11.0', 'prefix': 'postgresql-13', 'reference': '13.18-0+deb11u1'},
    {'release': '11.0', 'prefix': 'postgresql-client-13', 'reference': '13.18-0+deb11u1'},
    {'release': '11.0', 'prefix': 'postgresql-doc-13', 'reference': '13.18-0+deb11u1'},
    {'release': '11.0', 'prefix': 'postgresql-plperl-13', 'reference': '13.18-0+deb11u1'},
    {'release': '11.0', 'prefix': 'postgresql-plpython3-13', 'reference': '13.18-0+deb11u1'},
    {'release': '11.0', 'prefix': 'postgresql-pltcl-13', 'reference': '13.18-0+deb11u1'},
    {'release': '11.0', 'prefix': 'postgresql-server-dev-13', 'reference': '13.18-0+deb11u1'}
];
