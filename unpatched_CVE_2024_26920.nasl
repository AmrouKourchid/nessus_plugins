...
if (description)
{
  ...
  script_cve_id("CVE-2024-26920");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-26920");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: tracing/trigger: Fix to return error
    ...
    a snapshot instead of 0 (success). Unless that, it will register snapshot trigger without an error.
    (CVE-2024-26920)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-26920");
