...
# extracted from Fedora Security Advisory FEDORA-2023-e821b64a4c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-e821b64a4c");

  script_name(english:"Fedora 36 : edk2 (2023-e821b64a4c)");
...
FEDORA-2023-e821b64a4c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-e821b64a4c");
...
var pkgs = [
    {'reference':'edk2-20221117gitfff6d81270b5-14.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
