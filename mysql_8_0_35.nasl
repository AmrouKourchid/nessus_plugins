...
if (description)
{
  ...
  script_name(english:"Oracle MySQL Server 8.0.x < 8.0.34 (April 2023 CPU)");
...
April 2024 CPU advisory.
  ...
  - Vulnerability in the MySQL Server product of Oracle MySQL (component: Server: Compiling (curl)). Supported
    ...
    attacks of this vulnerability can result in takeover of MySQL Server. (CVE-2023-38545)
  ...
  - Vulnerability in the MySQL Server product of Oracle MySQL (component: InnoDB). Supported versions that are
    ...
    (complete DOS) of MySQL Server. (CVE-2023-22084)
