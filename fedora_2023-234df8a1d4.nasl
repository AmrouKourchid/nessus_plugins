...
# extracted from Fedora Security Advisory FEDORA-2023-234df8a1d4
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-234df8a1d4");

  script_name(english:"Fedora 38 : slurm (2023-234df8a1d4)");
...
FEDORA-2023-234df8a1d4 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-234df8a1d4");
...
var pkgs = [
    {'reference':'slurm-22.05.10-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
