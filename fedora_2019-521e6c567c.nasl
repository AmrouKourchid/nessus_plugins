...
# extracted from Fedora Security Advisory FEDORA-2019-521e6c567c.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-521e6c567c");

  script_name(english:"Fedora 30 : graphviz (2019-521e6c567c)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"This is an update fixing CVE-2019-11023.

----

Fixed NULL pointer dereference in function agroot(), CVE-2019-11023

Note that Tenable Network Security has extracted the preceding
description block directly from the Fedora update system website.
Tenable has attempted to automatically clean and format it as much as
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-521e6c567c");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"graphviz-2.40.1-46.fc30")) flag++;
