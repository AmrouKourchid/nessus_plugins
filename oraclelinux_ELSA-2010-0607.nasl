...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : freetype (ELSA-2010-0607)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2010-0607.html");
...
"Update the affected freetype, freetype-demos and / or freetype-devel packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2010-1797");
...
var pkgs = [
    {'reference':'freetype-2.2.1-26.el5_5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'freetype-demos-2.2.1-26.el5_5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'freetype-devel-2.2.1-26.el5_5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'freetype-2.2.1-26.el5_5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'freetype-demos-2.2.1-26.el5_5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'freetype-devel-2.2.1-26.el5_5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
