...
dla-2987 advisory.
    ...
    Three issues have been found in libarchive, a multi-format archive and compression library. CVE-2021-31566
    symbolic links incorrectly followed when changing modes, times, ACL and flags of a file while extracting
    an archive CVE-2021-23177 extracting a symlink with ACLs modifies ACLs of target CVE-2019-19221 out-of-
    bounds read because of an incorrect mbrtowc or mbtowc call For Debian 9 stretch, these problems have been
    fixed in version 3.2.2-2+deb9u3. We recommend that you upgrade your libarchive packages. For the detailed
    security status of libarchive please refer to its security tracker page at: https://security-
    tracker.debian.org/tracker/libarchive Further information about Debian LTS security advisories, how to
