...
if (description)
{
  ...
  script_cve_id("CVE-2022-49192");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-49192 (deprecated)");
...
"n/a");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-49192");
