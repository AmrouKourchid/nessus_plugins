...
"The version of Google Chrome installed on the remote Windows host is prior to 80.0.3987.162. It is, therefore, affected
by multiple vulnerabilities as referenced in the 2020_03_stable-channel-update-for-desktop_31 advisory. Note that Nessus
...
google_chrome_check_version(installs:installs, fix:'80.0.3987.162', severity:SECURITY_WARNING, xss:FALSE, xsrf:FALSE);
