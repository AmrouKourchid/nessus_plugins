...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : cifs-utils (EulerOS-SA-2021-2323)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2323
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e3666123");
...
pkgs = ["cifs-utils-6.2-10.h3.eulerosv2r7"];
