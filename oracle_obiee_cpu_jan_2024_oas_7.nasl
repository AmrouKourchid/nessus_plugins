...
if (description)
{
  ...
  script_name(english:"Oracle Business Intelligence Enterprise Edition (OAS 7.0) (January 2024 CPU)");
...
following:
  ...
  - Vulnerability in the Oracle Business Intelligence Enterprise Edition product of Oracle Analytics 
    (component: Installation (Google Gson)). Supported versions that are affected are 6.4.0.0.0 and 
    7.0.0.0.0. Easily exploitable vulnerability allows unauthenticated attacker with network access via 
    ...
    (complete DOS) of Oracle Business Intelligence Enterprise Edition. (CVE-2022-25647)

  - Vulnerability in the Oracle Business Intelligence Enterprise Edition product of Oracle Analytics 
    (component: Majel Mobile Service (JSON-java)). Supported versions that are affected are 6.4.0.0.0 and 
    ...
    Oracle Business Intelligence Enterprise Edition. (CVE-2023-5072)

  - Vulnerability in the Oracle Business Intelligence Enterprise Edition product of Oracle Analytics 
    (component: Visual Analyzer (Snappy)). The supported version that is affected is 7.0.0.0.0. Easily 
    exploitable vulnerability allows unauthenticated attacker with network access via HTTP to 
    compromise Oracle Business Intelligence Enterprise Edition. Successful attacks of this vulnerability 
    can result in unauthorized ability to cause a hang or frequently repeatable crash (complete DOS) of 
    Oracle Business Intelligence Enterprise Edition. (CVE-2023-43642)

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.oracle.com/docs/tech/security-alerts/cpuoct2024cvrf.xml");
...
"Apply the appropriate patch according to the January 2024 Oracle Critical Patch Update advisory.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2022-44729");
...
var constraints = [
  {'min_version': '7.0.0.0.0', 'fixed_version': '7.0.0.0.240110', 'fixed_display': '7.0.0.0.240110 patch: 36174464'}
];
