...
# SUSE update advisory SUSE-SU-2021:1870-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2020-36322", "CVE-2021-29154");
  script_xref(name:"SuSE", value:"SUSE-SU-2021:1870-1");

  script_name(english:"SUSE SLES12 Security Update : kernel (Live Patch 38 for SLE 12 SP3) (SUSE-SU-2021:1870-1)");
...
referenced in the SUSE-SU-2021:1870-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2021-June/008940.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2edfc089");
...
var pkgs = [
    {'reference':'kgraft-patch-4_4_180-94_141-default-4-2', 'sp':'3', 'cpu':'x86_64', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.3']},
    {'reference':'kgraft-patch-4_4_180-94_141-default-4-2', 'sp':'3', 'cpu':'x86_64', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.3']},
    {'reference':'kgraft-patch-4_4_180-94_141-default-4-2', 'sp':'3', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.3']}
];
