...
# extracted from Fedora Security Advisory FEDORA-2019-f528d75a69.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : python2-django1.11 (2019-f528d75a69)");
...
Fixes CVE-2019-6975: Memory exhaustion in
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-f528d75a69");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"python2-django1.11-1.11.20-1.fc29")) flag++;
