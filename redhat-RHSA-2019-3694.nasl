...
# extracted from Red Hat Security Advisory RHSA-2019:3694. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:3694");

  script_name(english:"RHEL 8 : sudo (RHSA-2019:3694)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_3694.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7c9a1a05");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:3694");
...
"Update the RHEL sudo package based on the guidance in RHSA-2019:3694.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'sudo-1.8.25p1-8.el8_1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'sudo-1.8.25p1-8.el8_1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
