...
# extracted from Debian Security Advisory dla-3326. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3326 : isc-dhcp-client - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3326
advisory.

    -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3326-1                debian-lts@lists.debian.org
    https://www.debian.org/lts/security/                        Bastian Blank
...
var pkgs = [
    {'release': '10.0', 'prefix': 'isc-dhcp-client', 'reference': '4.4.1-2+deb10u3'},
    {'release': '10.0', 'prefix': 'isc-dhcp-client-ddns', 'reference': '4.4.1-2+deb10u3'},
    {'release': '10.0', 'prefix': 'isc-dhcp-common', 'reference': '4.4.1-2+deb10u3'},
    {'release': '10.0', 'prefix': 'isc-dhcp-dev', 'reference': '4.4.1-2+deb10u3'},
    {'release': '10.0', 'prefix': 'isc-dhcp-relay', 'reference': '4.4.1-2+deb10u3'},
    {'release': '10.0', 'prefix': 'isc-dhcp-server', 'reference': '4.4.1-2+deb10u3'},
    {'release': '10.0', 'prefix': 'isc-dhcp-server-ldap', 'reference': '4.4.1-2+deb10u3'}
];
