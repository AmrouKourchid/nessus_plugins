...
if (description)
{
  ...
  script_cve_id("CVE-2024-43802", "CVE-2024-47814");

  script_name(english:"EulerOS 2.0 SP12 : vim (EulerOS-SA-2024-2960)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2960
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0be6dc89");
...
var pkgs = [
  "vim-common-9.0-5.h17.eulerosv2r12",
  "vim-enhanced-9.0-5.h17.eulerosv2r12",
  "vim-filesystem-9.0-5.h17.eulerosv2r12",
  "vim-minimal-9.0-5.h17.eulerosv2r12"
];
