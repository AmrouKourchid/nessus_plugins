...
# extracted from Oracle Linux Security Advisory ELSA-2022-9359.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : expat (ELSA-2022-9359)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 6 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ELSA-2022-9359 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2022-9359.html");
...
var pkgs = [
    {'reference':'expat-2.0.1-13.0.1.el6_8', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'expat-devel-2.0.1-13.0.1.el6_8', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'expat-2.0.1-13.0.1.el6_8', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'expat-devel-2.0.1-13.0.1.el6_8', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
];
