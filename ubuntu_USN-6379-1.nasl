...
# extracted from Ubuntu Security Notice USN-6379-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6379-1");

  script_name(english:"Ubuntu 20.04 LTS : vsftpd vulnerability (USN-6379-1)");
...
USN-6379-1 advisory.
    ...
    It was discovered that vsftpd was vulnerable to the ALPACA TLS protocol content confusion attack. A remote
    attacker could possibly use this issue to redirect traffic from one subdomain to another.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6379-1");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'vsftpd', 'pkgver': '3.0.5-0ubuntu0.20.04.1'}
];
