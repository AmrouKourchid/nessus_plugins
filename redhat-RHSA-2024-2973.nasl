...
# extracted from Red Hat Security Advisory RHSA-2024:2973. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2973");

  script_name(english:"RHEL 8 : libX11 (RHSA-2024:2973)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for libX11.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:2973 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2973.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1d704aee");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-23452");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2973");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libX11 package based on the guidance in RHSA-2024:2973.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libX11-1.6.8-8.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libX11-common-1.6.8-8.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libX11-devel-1.6.8-8.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libX11-xcb-1.6.8-8.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
