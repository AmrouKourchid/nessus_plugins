...
# extracted from Red Hat Security Advisory RHSA-2020:1265. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_1265.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bb8dfe44");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:1265");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1575466");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL procps-ng package based on the guidance in RHSA-2020:1265.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'procps-ng-3.3.10-17.el7_5.4', 'sp':'5', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'procps-ng-3.3.10-17.el7_5.4', 'sp':'5', 'cpu':'ppc', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'procps-ng-3.3.10-17.el7_5.4', 'sp':'5', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'procps-ng-3.3.10-17.el7_5.4', 'sp':'5', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'procps-ng-3.3.10-17.el7_5.4', 'sp':'5', 'cpu':'s390', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'procps-ng-3.3.10-17.el7_5.4', 'sp':'5', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'procps-ng-3.3.10-17.el7_5.4', 'sp':'5', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'procps-ng-devel-3.3.10-17.el7_5.4', 'sp':'5', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'procps-ng-devel-3.3.10-17.el7_5.4', 'sp':'5', 'cpu':'ppc', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'procps-ng-devel-3.3.10-17.el7_5.4', 'sp':'5', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'procps-ng-devel-3.3.10-17.el7_5.4', 'sp':'5', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'procps-ng-devel-3.3.10-17.el7_5.4', 'sp':'5', 'cpu':'s390', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'procps-ng-devel-3.3.10-17.el7_5.4', 'sp':'5', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'procps-ng-devel-3.3.10-17.el7_5.4', 'sp':'5', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'procps-ng-i18n-3.3.10-17.el7_5.4', 'sp':'5', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'procps-ng-i18n-3.3.10-17.el7_5.4', 'sp':'5', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'procps-ng-i18n-3.3.10-17.el7_5.4', 'sp':'5', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'procps-ng-i18n-3.3.10-17.el7_5.4', 'sp':'5', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
