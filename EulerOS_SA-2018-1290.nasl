...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : ImageMagick (EulerOS-SA-2018-1290)");
...
vulnerabilities :
  ...
  - In ImageMagick 7.0.8-3 Q16, ReadBMPImage and
    WriteBMPImage in coders/bmp.c allow attackers to cause
    an out of bounds write via a crafted
    file.(CVE-2018-12599)

  - In ImageMagick 7.0.8-3 Q16, ReadDIBImage and
    WriteDIBImage in coders/dib.c allow attackers to cause
    an out of bounds write via a crafted
    file.(CVE-2018-12600)
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1290
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?67f88d44");
...
pkgs = ["ImageMagick-6.7.8.9-15.h17",
        "ImageMagick-c++-6.7.8.9-15.h17",
        "ImageMagick-perl-6.7.8.9-15.h17"];
