...
# extracted from Red Hat Security Advisory RHSA-2020:1334. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:1334");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_1334.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f34ac715");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:1334");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1811673");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL telnet package based on the guidance in RHSA-2020:1334.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'telnet-server-0.17-65.el7_8', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'telnet-server-0.17-65.el7_8', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'telnet-server-0.17-65.el7_8', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'telnet-server-0.17-65.el7_8', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
