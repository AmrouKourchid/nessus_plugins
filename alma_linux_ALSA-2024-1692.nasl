...
# AlmaLinux Security Advisory ALSA-2024:1692.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:1692");

  script_name(english:"AlmaLinux 9 : less (ALSA-2024:1692)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2024-1692.html");
