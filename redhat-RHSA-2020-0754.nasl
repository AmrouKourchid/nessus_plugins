...
# extracted from Red Hat Security Advisory RHSA-2020:0754. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:0754");

  script_name(english:"RHEL 7 : novnc (RHSA-2020:0754)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for novnc.");
...
the RHSA-2020:0754 advisory.

    The novnc package provides a VNC client that uses HTML5 (Web Sockets, Canvas) and includes encryption
    support.

    An XSS vulnerability was discovered in noVNC in which arbitrary HTML could be injected into the noVNC web
    page. An attacker having access to a VNC server could use target host values in a crafted URL to gain
    access to secure information (such as VM tokens). (CVE-2017-18635)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_0754.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ad744109");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:0754");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1484711");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1765660");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL novnc package based on the guidance in RHSA-2020:0754.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'novnc-1.1.0-2.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'novnc');
}
