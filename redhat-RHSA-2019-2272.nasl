...
# extracted from Red Hat Security Advisory RHSA-2019:2272. The text 
...
if (description)
{
  ...
  script_cve_id("CVE-2018-20060", "CVE-2019-11236");
  script_xref(name:"RHSA", value:"2019:2272");

  script_name(english:"RHEL 7 : python-urllib3 (RHSA-2019:2272)");
...
referenced in the RHSA-2019:2272 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_2272.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?08afebd3");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/7/html/7.7_release_notes/index
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cc7115e8");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:2272");
...
"Update the RHEL python-urllib3 package based on the guidance in RHSA-2019:2272.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python-urllib3-1.10.2-7.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
