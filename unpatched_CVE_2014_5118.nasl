...
if (description)
{
  ...
  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2014-5118");
...
patch available.
  ...
  - Trusted Boot (tboot) before 1.8.2 has a 'loader.c' Security Bypass Vulnerability (CVE-2014-5118)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-5118");
