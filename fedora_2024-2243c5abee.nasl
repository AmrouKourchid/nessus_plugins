...
# extracted from Fedora Security Advisory FEDORA-2024-2243c5abee
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-2243c5abee");

  script_name(english:"Fedora 39 : trafficserver (2024-2243c5abee)");
...
FEDORA-2024-2243c5abee advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-2243c5abee");
...
var pkgs = [
    {'reference':'trafficserver-9.2.5-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
