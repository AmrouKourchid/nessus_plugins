...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : avahi (EulerOS-SA-2019-1734)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1734
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a7991302");
...
pkgs = ["avahi-0.6.31-15.1.h1",
        "avahi-autoipd-0.6.31-15.1.h1",
        "avahi-glib-0.6.31-15.1.h1",
        "avahi-gobject-0.6.31-15.1.h1",
        "avahi-libs-0.6.31-15.1.h1",
        "avahi-ui-gtk3-0.6.31-15.1.h1"];
