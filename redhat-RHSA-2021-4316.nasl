...
# extracted from Red Hat Security Advisory RHSA-2021:4316. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:4316");

  script_name(english:"RHEL 8 : zziplib (RHSA-2021:4316)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for zziplib.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2021:4316 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_4316.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f2fce414");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:4316");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1973826");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL zziplib package based on the guidance in RHSA-2021:4316.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'zziplib-0.13.68-9.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'zziplib-devel-0.13.68-9.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'zziplib-utils-0.13.68-9.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
