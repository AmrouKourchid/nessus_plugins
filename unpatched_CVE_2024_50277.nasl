...
if (description)
{
  ...
  script_cve_id("CVE-2024-50277");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-50277");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: dm: fix a crash if blk_alloc_disk
    fails If blk_alloc_disk fails, the variable md->disk is set to an error value. cleanup_mapped_device will
    see that md->disk is non-NULL and it will attempt to access it, causing a crash on this statement
    md->disk->private_data = NULL;. (CVE-2024-50277)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-50277");
