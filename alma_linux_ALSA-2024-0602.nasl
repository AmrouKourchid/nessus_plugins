...
# AlmaLinux Security Advisory ALSA-2024:0602.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:0602");
  script_xref(name:"IAVA", value:"2024-A-0053-S");

  script_name(english:"AlmaLinux 9 : thunderbird (ALSA-2024:0602)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2024-0602.html");
...
var pkgs = [
    {'reference':'thunderbird-115.7.0-1.el9_3.alma', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'thunderbird-115.7.0-1.el9_3.alma', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
