...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5041823");
  script_xref(name:"MSKB", value:"5041838");
  script_xref(name:"MSFT", value:"MS24-5041823");
  script_xref(name:"MSFT", value:"MS24-5041838");
  ...
  script_name(english:"KB5041823: Windows Server 2008 R2 Security Update (August 2024)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5041823");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5041838");
...
if (("windows server 2008 r2" >< tolower(os_name)) &&
  smb_check_rollup(os:'6.1',
                   ...
                   rollup_date:'08_2024',
                   bulletin:bulletin,
                   rollup_kb_list:[5041838, 5041823])
)
{
