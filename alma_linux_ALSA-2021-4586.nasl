...
# AlmaLinux Security Advisory ALSA-2021:4586.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2021:4586");
  script_xref(name:"IAVA", value:"2021-A-0528");

  script_name(english:"AlmaLinux 8 : gcc-toolset-11-gcc (ALSA-2021:4586)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 8 host has packages installed that are affected by a vulnerability as referenced in the
ALSA-2021:4586 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2021-4586.html");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:gcc-toolset-11-gcc");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:gcc-toolset-11-gcc-c++");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:gcc-toolset-11-gcc-gdb-plugin");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:gcc-toolset-11-gcc-gfortran");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:gcc-toolset-11-gcc-plugin-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:gcc-toolset-11-libasan-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:gcc-toolset-11-libatomic-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:gcc-toolset-11-libgccjit");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:gcc-toolset-11-libgccjit-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:gcc-toolset-11-libgccjit-docs");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:gcc-toolset-11-libitm-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:gcc-toolset-11-liblsan-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:gcc-toolset-11-libquadmath-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:gcc-toolset-11-libstdc++-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:gcc-toolset-11-libstdc++-docs");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:gcc-toolset-11-libtsan-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:gcc-toolset-11-libubsan-devel");
