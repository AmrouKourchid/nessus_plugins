...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : libyaml (EulerOS-SA-2024-2041)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the libyaml packages installed, the EulerOS installation on the remote host is affected by
...
Tenable has extracted the preceding description block directly from the EulerOS libyaml security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2041
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ac6431c5");
...
"Update the affected libyaml packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:libyaml-devel");
...
var pkgs = [
  "libyaml-0.2.1-2.h5.eulerosv2r8",
  "libyaml-devel-0.2.1-2.h5.eulerosv2r8"
];
