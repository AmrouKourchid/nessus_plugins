...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Libsepol PHSA-2021-1.0-0435");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'libsepol-2.5-3.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'libsepol-devel-2.5-3.ph1')) flag++;
