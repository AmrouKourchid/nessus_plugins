...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Runc PHSA-2022-4.0-0153");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'runc-1.0.3-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'runc-doc-1.0.3-1.ph4')) flag++;
