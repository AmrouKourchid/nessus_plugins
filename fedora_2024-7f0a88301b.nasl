...
# extracted from Fedora Security Advisory FEDORA-2024-7f0a88301b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-7f0a88301b");
  script_xref(name:"IAVA", value:"2024-A-0465-S");

  script_name(english:"Fedora 40 : firefox / nss (2024-7f0a88301b)");
...
FEDORA-2024-7f0a88301b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-7f0a88301b");
...
var pkgs = [
    {'reference':'firefox-129.0-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'nss-3.103.0-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
