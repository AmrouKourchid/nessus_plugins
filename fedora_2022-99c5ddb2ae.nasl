...
# extracted from Fedora Security Advisory FEDORA-2022-99c5ddb2ae
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-99c5ddb2ae");

  script_name(english:"Fedora 35 : varnish (2022-99c5ddb2ae)");
...
FEDORA-2022-99c5ddb2ae advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-99c5ddb2ae");
...
var pkgs = [
    {'reference':'varnish-6.6.2-3.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
