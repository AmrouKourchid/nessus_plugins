...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : dnsmasq (EulerOS-SA-2024-1954)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1954
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2d0f3a79");
...
var pkgs = [
  "dnsmasq-2.81-1.h14.eulerosv2r9"
];
