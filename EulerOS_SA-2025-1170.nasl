...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP12 : curl (EulerOS-SA-2025-1170)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1170
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2417c0ab");
...
var pkgs = [
  "curl-7.79.1-14.h31.eulerosv2r12",
  "libcurl-7.79.1-14.h31.eulerosv2r12"
];
