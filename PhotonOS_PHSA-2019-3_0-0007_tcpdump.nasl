...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Tcpdump PHSA-2019-3.0-0007");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'tcpdump-4.9.2-2.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'tcpdump-debuginfo-4.9.2-2.ph3')) flag++;
