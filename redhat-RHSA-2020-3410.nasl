...
# extracted from Red Hat Security Advisory RHSA-2020:3410. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:3410");

  script_name(english:"RHEL 8 : python-paunch and openstack-tripleo-heat-templates (RHSA-2020:3410)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_3410.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?577963db");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:3410");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1831544");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-paunch / openstack-tripleo-heat-templates packages based on the guidance in RHSA-2020:3410.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openstack-tripleo-heat-templates-10.6.3-0.20200113185561.cf467ea.el8ost', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'paunch-services-4.5.3-0.20200108190460.3c38fe6.el8ost', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'python3-paunch-4.5.3-0.20200108190460.3c38fe6.el8ost', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
