...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.6 : spice (EulerOS-SA-2021-1451)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the version of the spice packages installed, the EulerOS
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1451
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ecbe5aad");
...
pkgs = ["spice-glib-0.34-3.2.h3.eulerosv2r7",
        "spice-gtk3-0.34-3.2.h3.eulerosv2r7"];
