...
# extracted from Fedora Security Advisory FEDORA-2024-60809cb44e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-60809cb44e");
  script_xref(name:"IAVB", value:"2024-B-0095-S");

  script_name(english:"Fedora 41 : xen (2024-60809cb44e)");
...
FEDORA-2024-60809cb44e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-60809cb44e");
...
var pkgs = [
    {'reference':'xen-4.19.0-4.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
