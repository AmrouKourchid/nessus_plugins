...
# extracted from Red Hat Security Advisory chrony. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2016-1567", "CVE-2020-14367");

  script_name(english:"RHEL 6 : chrony (Unpatched Vulnerability) (deprecated)");
