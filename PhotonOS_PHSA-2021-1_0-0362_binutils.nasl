...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Binutils PHSA-2021-1.0-0362");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'binutils-2.32-3.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'binutils-devel-2.32-3.ph1')) flag++;
