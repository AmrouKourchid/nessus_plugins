...
# extracted from Red Hat Security Advisory RHSA-2018:0013. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:0013");
  script_xref(name:"IAVA", value:"2018-A-0020");
  script_xref(name:"IAVA", value:"2018-A-0017-S");

  script_name(english:"RHEL 6 : microcode_ctl (RHSA-2018:0013) (Spectre)");
...
issue.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:0013");
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"microcode_ctl-1.17-25.2.el6_9")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"microcode_ctl-1.17-25.2.el6_9")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"microcode_ctl-debuginfo-1.17-25.2.el6_9")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"microcode_ctl-debuginfo-1.17-25.2.el6_9")) flag++;
