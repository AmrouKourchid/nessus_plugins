...
# extracted from Debian Security Advisory dla-3272. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3272 : sudo - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3272
advisory.

    - -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3272-1                debian-lts@lists.debian.org
...
var pkgs = [
    {'release': '10.0', 'prefix': 'sudo', 'reference': '1.8.27-1+deb10u5'},
    {'release': '10.0', 'prefix': 'sudo-ldap', 'reference': '1.8.27-1+deb10u5'}
];
