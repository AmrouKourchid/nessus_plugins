...
# extracted from Amazon Linux 2 Security Advisory ALAS-2023-2002.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : xdg-utils (ALAS-2023-2002)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of xdg-utils installed on the remote host is prior to 1.1.0-0.17.20120809git. It is, therefore, affected by
multiple vulnerabilities as referenced in the ALAS2-2023-2002 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2023-2002.html");
...
"Run 'yum update xdg-utils' to update your system.");
...
var pkgs = [
    {'reference':'xdg-utils-1.1.0-0.17.20120809git.amzn2.0.1', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
