...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : libX11 (EulerOS-SA-2020-2365)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2365
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?82c4c4b8");
...
pkgs = ["libX11-1.6.3-2.h3",
        "libX11-common-1.6.3-2.h3",
        "libX11-devel-1.6.3-2.h3"];
