...
if (description)
{
  ...
  script_name(english:"Canonical Ubuntu Linux SEoL (24.04.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Canonical Ubuntu Linux is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Canonical Ubuntu Linux is 24.04.x. It is, therefore, no longer maintained by its vendor or
provider.
...
"Upgrade to a version of Canonical Ubuntu Linux that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2029/05/31");
...
var constraints = [
  { max_branch : '24.04', min_branch : '24.04', eseol : 20360425, seol : 20290531 }
];
