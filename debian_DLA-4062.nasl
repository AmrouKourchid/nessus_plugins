...
# extracted from Debian Security Advisory dla-4062. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-4062 : python-werkzeug-doc - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has packages installed that are affected by a vulnerability as referenced in the dla-4062
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-34069");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bullseye/python-werkzeug");
  script_set_attribute(attribute:"solution", value:
"Upgrade the python-werkzeug-doc packages.");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'python-werkzeug-doc', 'reference': '1.0.1+dfsg1-2+deb11u2'},
    {'release': '11.0', 'prefix': 'python3-werkzeug', 'reference': '1.0.1+dfsg1-2+deb11u2'}
];
