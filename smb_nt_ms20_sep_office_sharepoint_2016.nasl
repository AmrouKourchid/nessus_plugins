...
if (description)
{
  ...
  script_xref(name:"MSFT", value:"MS20-4484506");
  script_xref(name:"MSFT", value:"MS20-4484512");
  script_xref(name:"MSKB", value:"4484506");
  script_xref(name:"MSKB", value:"4484512");
  script_xref(name:"IAVA", value:"2020-A-0412-S");
  script_xref(name:"CEA-ID", value:"CEA-2020-0118");

  script_name(english:"Security Updates for Microsoft SharePoint Server 2016 (September 2020)");
...
by multiple vulnerabilities :
  ...
  # https://support.microsoft.com/en-us/help/4484512/security-update-for-sharepoint-server-2016-sept-8-2020
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?534aac23");
  # https://support.microsoft.com/en-us/help/4484506/security-update-for-sharepoint-server-2016-sept-8-2020
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a84b24eb");
