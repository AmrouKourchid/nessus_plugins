...
the USN-4837-1 advisory.
    ...
    It was discovered that LibSass incorrectly handled certain specially crafted sass file. An attacker could
    possibly use this issue to cause a denial of service or other unspecified impact.
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'libsass-dev', 'pkgver': '3.4.8-1ubuntu0.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libsass0', 'pkgver': '3.4.8-1ubuntu0.1~esm1', 'ubuntu_pro': TRUE}
];
