...
if (description)
{
  ...
  script_cve_id("CVE-2024-46811");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-46811");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: drm/amd/display: Fix index may exceed
    array range within fpu_update_bw_bounding_box [Why] Coverity reports OVERRUN warning. soc.num_states could
    be 40. But array range of bw_params->clk_table.entries is 8. [How] Assert if soc.num_states greater than
    8. (CVE-2024-46811)
