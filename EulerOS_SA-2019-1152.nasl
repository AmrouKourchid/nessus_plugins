...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : sqlite (EulerOS-SA-2019-1152)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1152
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?746c81e9");
...
pkgs = ["sqlite-3.7.17-8.h4.eulerosv2r7",
        "sqlite-devel-3.7.17-8.h4.eulerosv2r7"];
