...
if (description)
{
  ...
  script_name(english:"Debian dla-3458 : libapache2-mod-php7.3 - security update");
...
advisory.
    ...
    -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3458-1                debian-lts@lists.debian.org
    ...
    Niels Dossche and Tim Dsterhus discovered that PHP's implementation of
