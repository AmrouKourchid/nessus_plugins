...
# extracted from Oracle Linux Security Advisory ELSA-2020-5084.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : microcode_ctl (ELSA-2020-5084)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2020-5084.html");
...
var pkgs = [
    {'reference':'microcode_ctl-1.17-33.31.0.1.el6_10', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
    {'reference':'microcode_ctl-1.17-33.31.0.1.el6_10', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'}
];
