...
# extracted from Red Hat Security Advisory 8.3_libtpms. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2021-3446", "CVE-2021-3623", "CVE-2023-1018");

  script_name(english:"RHEL 8 : 8.3_libtpms (Unpatched Vulnerability) (deprecated)");
