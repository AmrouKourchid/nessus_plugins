...
# SUSE update advisory SUSE-SU-2021:2916-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2021:2916-1");

  script_name(english:"SUSE SLES12 Security Update : gstreamer-plugins-good (SUSE-SU-2021:2916-1)");
...
in the SUSE-SU-2021:2916-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2021-September/009383.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?89664825");
...
var pkgs = [
    {'reference':'gstreamer-plugins-good-1.8.3-16.3.1', 'sp':'5', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5']},
    {'reference':'gstreamer-plugins-good-lang-1.8.3-16.3.1', 'sp':'5', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5']},
    {'reference':'gstreamer-plugins-good-1.8.3-16.3.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.5']},
    {'reference':'gstreamer-plugins-good-lang-1.8.3-16.3.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.5']}
];
