...
# extracted from Gentoo Linux Security Advisory GLSA 202006-18.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202006-18");

  script_name(english:"GLSA-202006-18 : Bubblewrap: Arbitrary code execution");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202006-18
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202006-18");
...
"All Bubblewrap users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:bubblewrap");
...
if (qpkg_check(package:"sys-apps/bubblewrap", unaffected:make_list("ge 0.4.1"), vulnerable:make_list("lt 0.4.1"))) flag++;
