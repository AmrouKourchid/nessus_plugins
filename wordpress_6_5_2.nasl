...
# extracted from WordPress Security Advisory wordpress-6-5-2-maintenance-and-security-release.
...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2024-A-0320-S");

  script_name(english:"WordPress 6.0 < 6.5.2");

  script_set_attribute(attribute:"synopsis", value:
"A PHP application running on the remote web server is affected by one or more vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"WordPress versions 6.0 < 6.5.2 are affected by one or more vulnerabilities");
  script_set_attribute(attribute:"see_also", value:"https://wordpress.org/download/releases/");
  # https://wordpress.org/news/2024/04/wordpress-6-5-2-maintenance-and-security-release/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?03390d91");
  script_set_attribute(attribute:"solution", value:
"Upgrade to WordPress version 6.5.2 or later.");
...
var constraints = [
  { 'min_version' : '6.0', 'fixed_version' : '6.5.2' }
];
