...
"The remote Red Hat host is missing a security update for ipmitool.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2020:2286 advisory.

    The ipmitool packages contain a command-line utility for interfacing with devices that support the
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_2286.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5aa07c71");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:2286");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1798721");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL ipmitool package based on the guidance in RHSA-2020:2286.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'bmc-snmp-proxy-1.8.18-9.el7_6', 'sp':'6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'exchange-bmc-os-info-1.8.18-9.el7_6', 'sp':'6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipmitool-1.8.18-9.el7_6', 'sp':'6', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipmitool-1.8.18-9.el7_6', 'sp':'6', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipmitool-1.8.18-9.el7_6', 'sp':'6', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipmitool-1.8.18-9.el7_6', 'sp':'6', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'bmc-snmp-proxy-1.8.18-9.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'exchange-bmc-os-info-1.8.18-9.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipmitool-1.8.18-9.el7_6', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipmitool-1.8.18-9.el7_6', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipmitool-1.8.18-9.el7_6', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipmitool-1.8.18-9.el7_6', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
