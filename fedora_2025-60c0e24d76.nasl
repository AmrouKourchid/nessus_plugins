...
# extracted from Fedora Security Advisory FEDORA-2025-60c0e24d76
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-60c0e24d76");

  script_name(english:"Fedora 41 : firefox (2025-60c0e24d76)");
...
FEDORA-2025-60c0e24d76 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-60c0e24d76");
...
var pkgs = [
    {'reference':'firefox-136.0-2.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
