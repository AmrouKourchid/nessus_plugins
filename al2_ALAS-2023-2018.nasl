...
# extracted from Amazon Linux 2 Security Advisory ALAS-2023-2018.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : jasper (ALAS-2023-2018)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of jasper installed on the remote host is prior to 1.900.1-33. It is, therefore, affected by multiple
vulnerabilities as referenced in the ALAS2-2023-2018 advisory.

    A flaw was found in the Jasper tool's jpc encoder. This flaw allows an attacker to craft input provided to
    Jasper, causing an arbitrary out-of-bounds write.  The highest threat from this vulnerability is to
    confidentiality, integrity, as well as system availability. (CVE-2020-27828)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2023-2018.html");
...
var pkgs = [
    {'reference':'jasper-1.900.1-33.amzn2.0.1', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'jasper-1.900.1-33.amzn2.0.1', 'cpu':'i686', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'jasper-1.900.1-33.amzn2.0.1', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'jasper-debuginfo-1.900.1-33.amzn2.0.1', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'jasper-debuginfo-1.900.1-33.amzn2.0.1', 'cpu':'i686', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'jasper-debuginfo-1.900.1-33.amzn2.0.1', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'jasper-devel-1.900.1-33.amzn2.0.1', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'jasper-devel-1.900.1-33.amzn2.0.1', 'cpu':'i686', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'jasper-devel-1.900.1-33.amzn2.0.1', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'jasper-libs-1.900.1-33.amzn2.0.1', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'jasper-libs-1.900.1-33.amzn2.0.1', 'cpu':'i686', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'jasper-libs-1.900.1-33.amzn2.0.1', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'jasper-utils-1.900.1-33.amzn2.0.1', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'jasper-utils-1.900.1-33.amzn2.0.1', 'cpu':'i686', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'jasper-utils-1.900.1-33.amzn2.0.1', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
