...
# extracted from Red Hat Security Advisory RHSA-2020:2594. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:2594");

  script_name(english:"RHEL 7 / 8 : OpenShift Container Platform 4.2.36 openshift (RHSA-2020:2594)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for OpenShift Container Platform 4.2.36 openshift.");
...
in the RHSA-2020:2594 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_2594.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?420b7937");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:2594");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1821583");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.2.36 openshift package based on the guidance in RHSA-2020:2594.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openshift-hyperkube-4.2.36-202006211650.p0.git.0.1fe246f.el8', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'openshift-hyperkube-4.2.36-202006211650.p0.git.0.1fe246f.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'openshift-hyperkube-4.2.36-202006211650.p0.git.0.1fe246f.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
