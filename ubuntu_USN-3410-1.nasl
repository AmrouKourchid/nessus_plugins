...
# extracted from Ubuntu Security Notice USN-3410-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"3410-1");

  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS : GD library vulnerability (USN-3410-1)");
...
in the USN-3410-1 advisory.

    It was discovered that the GD Graphics Library (aka libgd) incorrectly handled certain malformed PNG
    images. A remote attacker could use this issue to cause the GD Graphics Library to crash, resulting in a
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3410-1");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-6362");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'libgd-dev', 'pkgver': '2.1.0-3ubuntu0.8'},
    {'osver': '14.04', 'pkgname': 'libgd-tools', 'pkgver': '2.1.0-3ubuntu0.8'},
    {'osver': '14.04', 'pkgname': 'libgd2-noxpm-dev', 'pkgver': '2.1.0-3ubuntu0.8'},
    {'osver': '14.04', 'pkgname': 'libgd2-xpm-dev', 'pkgver': '2.1.0-3ubuntu0.8'},
    {'osver': '14.04', 'pkgname': 'libgd3', 'pkgver': '2.1.0-3ubuntu0.8'},
    {'osver': '16.04', 'pkgname': 'libgd-dev', 'pkgver': '2.1.1-4ubuntu0.16.04.8'},
    {'osver': '16.04', 'pkgname': 'libgd-tools', 'pkgver': '2.1.1-4ubuntu0.16.04.8'},
    {'osver': '16.04', 'pkgname': 'libgd3', 'pkgver': '2.1.1-4ubuntu0.16.04.8'}
];
