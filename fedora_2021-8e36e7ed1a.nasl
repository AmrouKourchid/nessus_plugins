...
# extracted from Fedora Security Advisory FEDORA-2021-8e36e7ed1a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-8e36e7ed1a");

  script_name(english:"Fedora 33 : python-cryptography (2021-8e36e7ed1a)");
...
FEDORA-2021-8e36e7ed1a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-8e36e7ed1a");
...
pkgs = [
    {'reference':'python-cryptography-3.2.1-2.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
