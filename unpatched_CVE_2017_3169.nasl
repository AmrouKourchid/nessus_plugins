...
if (description)
{
  ...
  script_cve_id("CVE-2017-3169");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2017-3169");
...
patch available.
  ...
  - In Apache httpd 2.2.x before 2.2.33 and 2.4.x before 2.4.26, mod_ssl may dereference a NULL pointer when
