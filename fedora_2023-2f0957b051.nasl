...
# extracted from Fedora Security Advisory FEDORA-2023-2f0957b051
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-2f0957b051");

  script_name(english:"Fedora 39 : rclone (2023-2f0957b051)");
...
FEDORA-2023-2f0957b051 advisory.

    Automatic update for rclone-1.63.1-1.fc39.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-2f0957b051");
  script_set_attribute(attribute:"solution", value:
"Update the affected rclone package.");
...
var pkgs = [
    {'reference':'rclone-1.63.1-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'rclone');
}
