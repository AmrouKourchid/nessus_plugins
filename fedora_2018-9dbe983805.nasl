...
# extracted from Fedora Security Advisory FEDORA-2018-9dbe983805.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-9dbe983805");

  script_name(english:"Fedora 29 : 4:perl (2018-9dbe983805)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-9dbe983805");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"perl-5.28.1-425.fc29", epoch:"4")) flag++;
