...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-5302-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2021-43976', 'CVE-2021-44879', 'CVE-2022-0435', 'CVE-2022-0492', 'CVE-2022-24448', 'CVE-2022-24959');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-5302-1');
  }
  else
  {
