...
# extracted from VMware Security Advisory PHSA-2021-3.0-0228. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Docker PHSA-2021-3.0-0228");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the docker package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-3.0-228.md");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'docker-19.03.15-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'docker-cli-19.03.15-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'docker-doc-19.03.15-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'docker-engine-19.03.15-1.ph3')) flag++;
