...
if (description)
{
  ...
  script_name(english:"CentOS 9 : python-requests-2.25.1-7.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update for python3-requests.");
...
requests-2.25.1-7.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=33907");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream python3-requests package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:python3-requests");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:python3-requests+security");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:python3-requests+socks");
...
var pkgs = [
    {'reference':'python3-requests+security-2.25.1-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-requests+socks-2.25.1-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-requests-2.25.1-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
