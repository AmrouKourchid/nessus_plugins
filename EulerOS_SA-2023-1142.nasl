...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : binutils (EulerOS-SA-2023-1142)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1142
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fd2d932e");
...
var pkgs = [
  "binutils-2.34-4.h15.eulerosv2r10"
];
