...
if (description)
{
  ...
  script_name(english:"Wireshark SEoL (2.6.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Wireshark is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Wireshark is 2.6.x. It is, therefore, no longer maintained by its vendor or provider.
...
"Upgrade to a version of Wireshark that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2020/10/18");
...
var constraints = [
  { max_branch : '2.6', min_branch : '2.6', seol : 20201018 }
];
