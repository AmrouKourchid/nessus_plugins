...
# extracted from Red Hat Security Advisory RHSA-2022:0860. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:0860");
  script_xref(name:"CEA-ID", value:"CEA-2022-0010");

  script_name(english:"RHEL 7 / 8 : OpenShift Container Platform 4.9.25 (RHSA-2022:0860)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for OpenShift Container Platform 4.9.25.");
...
in the RHSA-2022:0860 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_0860.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6d8c8d2d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:0860");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2059475");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2063911");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.9.25 package based on the guidance in RHSA-2022:0860.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cri-o-1.22.2-3.rhaos4.9.gitb030be8.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'cri-o-1.22.2-3.rhaos4.9.gitb030be8.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
