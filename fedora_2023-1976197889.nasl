...
# extracted from Fedora Security Advisory FEDORA-2023-1976197889
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-1976197889");

  script_name(english:"Fedora 39 : vim (2023-1976197889)");
...
FEDORA-2023-1976197889 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-1976197889");
...
var pkgs = [
    {'reference':'vim-9.0.2048-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
