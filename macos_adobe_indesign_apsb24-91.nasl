...
if (description)
{
  ...
  script_cve_id("CVE-2024-49529");
  script_xref(name:"IAVA", value:"2024-A-0767-S");

  script_name(english:"Adobe InDesign < 19.5.1 / 20.0.0 < 20.0.1 Memory leak (APSB24-91) (macOS)");

  script_set_attribute(attribute:"synopsis", value:
"The Adobe InDesign instance installed on the remote host is affected by a memory leak vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe InDesign installed on the remote macOS host is prior to 19.5.1, 20.0.1. It is, therefore, affected
by a vulnerability as referenced in the APSB24-91 advisory.

  - Out-of-bounds Read (CWE-125) potentially leading to Memory leak (CVE-2024-49529)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://helpx.adobe.com/security/products/indesign/apsb24-91.html");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Adobe InDesign version 19.5.1, 20.0.1 or later.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:C/I:N/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:N/UI:R/S:U/C:H/I:N/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-49529");
...
var constraints = [
  { 'max_version' : '19.5.0', 'fixed_version' : '19.5.1', 'fixed_display' : 'ID19.5.1' },
  { 'min_version' : '20.0.0', 'max_version' : '20.0.0', 'fixed_version' : '20.0.1', 'fixed_display' : 'ID20.0.1' }
];
