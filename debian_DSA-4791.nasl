...
there is no additional exposure in such a setup.");
  script_set_attribute(attribute:"see_also", value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=973254");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/pacemaker");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/pacemaker");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2020/dsa-4791");
