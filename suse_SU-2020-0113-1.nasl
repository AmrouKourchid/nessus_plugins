...
# extracted from SUSE update advisory SUSE-SU-2020:0113-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLED15 / SLES15 Security Update : tigervnc (SUSE-SU-2020:0113-1)");
...
without introducing additional issues.");
  ...
  # https://www.suse.com/support/update/announcement/2020/suse-su-20200113-1/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e0468ee3");
...
zypper in -t patch
SUSE-SLE-Module-Development-Tools-OBS-15-SP1-2020-113=1

SUSE Linux Enterprise Module for Desktop Applications 15-SP1 :

zypper in -t patch
SUSE-SLE-Module-Desktop-Applications-15-SP1-2020-113=1

SUSE Linux Enterprise Module for Basesystem 15-SP1 :

zypper in -t patch SUSE-SLE-Module-Basesystem-15-SP1-2020-113=1");
...
flag = 0;
if (rpm_check(release:"SLES15", sp:"1", cpu:"x86_64", reference:"xorg-x11-Xvnc-module-1.9.0-19.3.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", cpu:"x86_64", reference:"xorg-x11-Xvnc-module-debuginfo-1.9.0-19.3.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"libXvnc-devel-1.9.0-19.3.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"libXvnc1-1.9.0-19.3.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"libXvnc1-debuginfo-1.9.0-19.3.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"tigervnc-1.9.0-19.3.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"tigervnc-debuginfo-1.9.0-19.3.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"tigervnc-debugsource-1.9.0-19.3.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"xorg-x11-Xvnc-1.9.0-19.3.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"xorg-x11-Xvnc-debuginfo-1.9.0-19.3.1")) flag++;
if (rpm_check(release:"SLED15", sp:"1", cpu:"x86_64", reference:"xorg-x11-Xvnc-module-1.9.0-19.3.1")) flag++;
if (rpm_check(release:"SLED15", sp:"1", cpu:"x86_64", reference:"xorg-x11-Xvnc-module-debuginfo-1.9.0-19.3.1")) flag++;
if (rpm_check(release:"SLED15", sp:"1", reference:"libXvnc-devel-1.9.0-19.3.1")) flag++;
if (rpm_check(release:"SLED15", sp:"1", reference:"libXvnc1-1.9.0-19.3.1")) flag++;
if (rpm_check(release:"SLED15", sp:"1", reference:"libXvnc1-debuginfo-1.9.0-19.3.1")) flag++;
if (rpm_check(release:"SLED15", sp:"1", reference:"tigervnc-1.9.0-19.3.1")) flag++;
if (rpm_check(release:"SLED15", sp:"1", reference:"tigervnc-debuginfo-1.9.0-19.3.1")) flag++;
if (rpm_check(release:"SLED15", sp:"1", reference:"tigervnc-debugsource-1.9.0-19.3.1")) flag++;
if (rpm_check(release:"SLED15", sp:"1", reference:"xorg-x11-Xvnc-1.9.0-19.3.1")) flag++;
if (rpm_check(release:"SLED15", sp:"1", reference:"xorg-x11-Xvnc-debuginfo-1.9.0-19.3.1")) flag++;
