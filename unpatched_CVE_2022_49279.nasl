...
if (description)
{
  ...
  script_cve_id("CVE-2022-49279");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-49279");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: NFSD: prevent integer overflow on 32
    bit systems On a 32 bit system, the len * sizeof(*p) operation can have an integer overflow.
    (CVE-2022-49279)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-49279");
