...
# extracted from Fedora Security Advisory FEDORA-2021-def0e32233
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-def0e32233");

  script_name(english:"Fedora 32 : 1:rubygem-activerecord (2021-def0e32233)");
...
FEDORA-2021-def0e32233 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-def0e32233");
  script_set_attribute(attribute:"solution", value:
"Update the affected 1:rubygem-activerecord package.");
...
pkgs = [
    {'reference':'rubygem-activerecord-5.2.3-5.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, '1:rubygem-activerecord');
}
