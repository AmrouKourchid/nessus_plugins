...
# extracted from F5 Networks BIG-IP Solution K20682450.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2017-6142");

  script_name(english:"F5 Networks BIG-IP : BIG-IP AFM vulnerability (K20682450)");

  script_set_attribute(attribute:"synopsis", value:
"The remote device is missing a vendor-supplied security patch.");
  script_set_attribute(attribute:"description", value:
"X509 certificate verification was not correctly implementedin the
...
proof of concept.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K20682450");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K20682450.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:P/I:P/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:H/PR:N/UI:N/S:U/C:L/I:L/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-6142");
...
var vmatrix = {
  'AFM': {
    'affected': [
      '13.0.0','12.1.0-12.1.2','11.6.1-11.6.2'
    ],
    'unaffected': [
      '13.1.0','13.0.0 HF1','12.1.2 HF1','12.1.0-12.1.3','11.6.3'
    ],
  }
};
