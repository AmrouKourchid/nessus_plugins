...
if (description)
{
  ...
  script_cve_id("CVE-2022-49432");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-49432");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: powerpc/xics: fix refcount leak in
    icp_opal_init() The of_find_compatible_node() function returns a node pointer with refcount incremented,
    use of_node_put() on it when done. (CVE-2022-49432)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-49432");
