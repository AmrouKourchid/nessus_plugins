...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : firefox on SL6.x i386/x86_64 (20180927)");
...
Security Fix(es) :
  ...
  - Mozilla: Setting a master password post-Firefox 58 does
    ...
    (CVE-2018-12383)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1809&L=scientific-linux-errata&F=&S=&P=3942
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?96ebc5c5");
...
flag = 0;
if (rpm_check(release:"SL6", reference:"firefox-60.2.1-1.el6", allowmaj:TRUE)) flag++;
if (rpm_check(release:"SL6", reference:"firefox-debuginfo-60.2.1-1.el6", allowmaj:TRUE)) flag++;
