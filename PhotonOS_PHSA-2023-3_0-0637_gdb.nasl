...
if (description)
{
  ...
  script_cve_id("CVE-2021-3549", "CVE-2022-38533", "CVE-2022-4285");

  script_name(english:"Photon OS 3.0: Gdb PHSA-2023-3.0-0637");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'gdb-10.1-4.ph3')) flag++;
