...
"The version of Thunderbird installed on the remote macOS or Mac OS X host is prior to 91.11. It is, therefore, affected
by multiple vulnerabilities as referenced in the mfsa2022-26 advisory.
...
mozilla_check_version(version:version, path:path, product:'thunderbird', esr:FALSE, fix:'91.11', min:'91.0.0', severity:SECURITY_HOLE);
