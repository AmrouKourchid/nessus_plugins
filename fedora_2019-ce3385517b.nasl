...
# extracted from Fedora Security Advisory FEDORA-2019-ce3385517b.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-ce3385517b");

  script_name(english:"Fedora 30 : mingw-OpenEXR (2019-ce3385517b)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-ce3385517b");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"mingw-OpenEXR-2.2.1-5.fc30")) flag++;
