...
# extracted from Oracle Linux Security Advisory ELSA-2024-2559.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : python-jwcrypto (ELSA-2024-2559)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-2559.html");
...
var pkgs = [
    {'reference':'python3-jwcrypto-0.8-5.el9_4', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
