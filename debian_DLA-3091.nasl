...
if (description)
{
  ...
  script_name(english:"Debian dla-3091 : libsofia-sip-ua-dev - security update");
...
dla-3091 advisory.
    ...
    - -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3091-1                debian-lts@lists.debian.org
    https://www.debian.org/lts/security/                          Abhijith PA
    September 02, 2022                            https://wiki.debian.org/LTS
    - -------------------------------------------------------------------------
