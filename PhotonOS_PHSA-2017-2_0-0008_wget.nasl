...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'wget-1.19.1-4.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'wget-debuginfo-1.19.1-4.ph2')) flag++;
