...
# extracted from Red Hat Security Advisory RHSA-2019:2798. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:2798");

  script_name(english:"RHEL 8 : patch (RHSA-2019:2798)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for patch.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has a package installed that is affected by multiple vulnerabilities as
referenced in the RHSA-2019:2798 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_2798.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3aa01e01");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:2798");
...
"Update the RHEL patch package based on the guidance in RHSA-2019:2798.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'patch-2.7.6-9.el8_0', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
