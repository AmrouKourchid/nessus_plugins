...
# extracted from Amazon Linux 2 Security Advisory ALASECS-2023-018.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2023-29409", "CVE-2023-39325");
  script_xref(name:"IAVB", value:"2023-B-0080-S");

  script_name(english:"Amazon Linux 2 : runc (ALASECS-2023-018)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of runc installed on the remote host is prior to 1.1.7-4. It is, therefore, affected by multiple
vulnerabilities as referenced in the ALAS2ECS-2023-018 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALASECS-2023-018.html");
...
var pkgs = [
    {'reference':'runc-1.1.7-4.amzn2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'runc-1.1.7-4.amzn2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'runc-debuginfo-1.1.7-4.amzn2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'runc-debuginfo-1.1.7-4.amzn2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
