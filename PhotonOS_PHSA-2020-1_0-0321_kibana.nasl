...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Kibana PHSA-2020-1.0-0321");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-7017");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'kibana-6.8.12-1.ph1')) flag++;
