...
# extracted from Fedora Security Advisory FEDORA-2024-9fe1974c0f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-9fe1974c0f");

  script_name(english:"Fedora 41 : python3.13 (2024-9fe1974c0f)");
...
FEDORA-2024-9fe1974c0f advisory.
    ...
    ```
    * Tue Aug  6 2024 Miro Hronok <mhroncok@redhat.com> - 3.13.0~rc1-2
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-9fe1974c0f");
...
var pkgs = [
    {'reference':'python3.13-3.13.0~rc1-2.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
