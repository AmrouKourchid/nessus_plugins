...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'curl-7.56.1-2.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'curl-debuginfo-7.56.1-2.ph1')) flag++;
