...
# extracted from Fedora Security Advisory FEDORA-2019-133a8a7cb5.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : mod_http2 (2019-133a8a7cb5)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-133a8a7cb5");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"mod_http2-1.14.1-1.fc28")) flag++;
