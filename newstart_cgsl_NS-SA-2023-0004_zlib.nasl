...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 6.02 : zlib Vulnerability (NS-SA-2023-0004)");

  script_set_attribute(attribute:"synopsis", value:
"The remote NewStart CGSL host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 6.02, has zlib packages installed that are affected by a
vulnerability:
