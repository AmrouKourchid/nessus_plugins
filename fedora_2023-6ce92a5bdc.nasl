...
# extracted from Fedora Security Advisory FEDORA-2023-6ce92a5bdc
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-6ce92a5bdc");

  script_name(english:"Fedora 39 : giflib (2023-6ce92a5bdc)");
...
FEDORA-2023-6ce92a5bdc advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-6ce92a5bdc");
...
var pkgs = [
    {'reference':'giflib-5.2.1-17.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
