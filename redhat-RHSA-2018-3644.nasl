...
# extracted from Red Hat Security Advisory RHSA-2018:3644. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:3644");

  script_name(english:"RHEL 6 : flash-plugin (RHSA-2018:3644)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2018/rhsa-2018_3644.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b426b42c");
  script_set_attribute(attribute:"see_also", value:"https://helpx.adobe.com/security/products/flash-player/apsb18-44.html");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:3644");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#critical");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1651640");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL flash-plugin package based on the guidance in RHSA-2018:3644.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'flash-plugin-31.0.0.153-1.el6_10', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
