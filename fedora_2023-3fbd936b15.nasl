...
# extracted from Fedora Security Advisory FEDORA-2023-3fbd936b15
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-3fbd936b15");
  script_xref(name:"IAVA", value:"2023-A-0650-S");

  script_name(english:"Fedora 39 : vim (2023-3fbd936b15)");
...
FEDORA-2023-3fbd936b15 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-3fbd936b15");
...
var pkgs = [
    {'reference':'vim-9.0.2167-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
