...
# extracted from Red Hat Security Advisory RHSA-2024:6963. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:6963");

  script_name(english:"RHEL 8 : gtk3 (RHSA-2024:6963)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for gtk3.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:6963 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_6963.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?47b17cab");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2297098");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:6963");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL gtk3 package based on the guidance in RHSA-2024:6963.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gtk-update-icon-cache-3.22.30-12.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gtk3-3.22.30-12.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gtk3-devel-3.22.30-12.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gtk3-devel-docs-3.22.30-12.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gtk3-immodule-xim-3.22.30-12.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
