...
# Rocky Linux Security Advisory RLSA-2023:5312.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2023:5312");
  script_xref(name:"IAVA", value:"2023-A-0450-S");

  script_name(english:"Rocky Linux 8 : open-vm-tools (RLSA-2023:5312)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Rocky Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Rocky Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
RLSA-2023:5312 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2023:5312");
...
var pkgs = [
    ...
    {'reference':'open-vm-tools-debuginfo-12.1.5-2.el8_8.3', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'open-vm-tools-debugsource-12.1.5-2.el8_8.3', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'open-vm-tools-desktop-12.1.5-2.el8_8.3', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'open-vm-tools-desktop-debuginfo-12.1.5-2.el8_8.3', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'open-vm-tools-sdmp-debuginfo-12.1.5-2.el8_8.3', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
