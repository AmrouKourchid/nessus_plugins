...
# SUSE update advisory SUSE-SU-2023:2243-2. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:2243-2");

  script_name(english:"openSUSE 15 Security Update : ucode-intel (SUSE-SU-2023:2243-2)");
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-July/015514.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?30736dce");
...
var pkgs = [
    {'reference':'ucode-intel-20230512-150200.24.1', 'cpu':'x86_64', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.5']}
];
