...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Runc PHSA-2023-3.0-0693");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'runc-1.1.4-9.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'runc-doc-1.1.4-9.ph3')) flag++;
