...
# extracted from Fedora Security Advisory FEDORA-2022-d6cd1e0cc1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-d6cd1e0cc1");

  script_name(english:"Fedora 37 : openssl1.1 (2022-d6cd1e0cc1)");
...
FEDORA-2022-d6cd1e0cc1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-d6cd1e0cc1");
  script_set_attribute(attribute:"solution", value:
"Update the affected 1:openssl1.1 package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:openssl1.1");
...
var pkgs = [
    {'reference':'openssl1.1-1.1.1n-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'openssl1.1');
}
