...
# extracted from Red Hat Security Advisory RHSA-2023:1931. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:1931");

  script_name(english:"RHEL 8 : emacs (RHSA-2023:1931)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for emacs.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2023:1931 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_1931.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?58b518fc");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2180544");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:1931");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL emacs package based on the guidance in RHSA-2023:1931.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'emacs-26.1-7.el8_6.1', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'emacs-common-26.1-7.el8_6.1', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'emacs-filesystem-26.1-7.el8_6.1', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'emacs-lucid-26.1-7.el8_6.1', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'emacs-nox-26.1-7.el8_6.1', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'emacs-terminal-26.1-7.el8_6.1', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
