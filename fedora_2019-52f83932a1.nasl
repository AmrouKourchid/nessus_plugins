...
# extracted from Fedora Security Advisory FEDORA-2019-52f83932a1.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : sleuthkit (2019-52f83932a1)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-52f83932a1");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"sleuthkit-4.6.7-1.fc29")) flag++;
