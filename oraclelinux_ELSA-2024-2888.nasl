...
# extracted from Oracle Linux Security Advisory ELSA-2024-2888.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : thunderbird (ELSA-2024-2888)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-2888.html");
...
var pkgs = [
    {'reference':'thunderbird-115.11.0-1.0.1.el9_4', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'thunderbird-115.11.0-1.0.1.el9_4', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
