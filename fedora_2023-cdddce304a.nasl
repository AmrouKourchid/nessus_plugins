...
# extracted from Fedora Security Advisory FEDORA-2023-cdddce304a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-cdddce304a");

  script_name(english:"Fedora 38 : nodejs18 (2023-cdddce304a)");
...
FEDORA-2023-cdddce304a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-cdddce304a");
...
var pkgs = [
    {'reference':'nodejs18-18.16.1-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
