...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : perl-Archive-Tar on SL7.x x86_64 (20190806)");
...
"Security Fix(es) :
  ...
  - perl: Directory traversal in Archive::Tar
    (CVE-2018-12015)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1908&L=SCIENTIFIC-LINUX-ERRATA&P=16810
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f0065b01");
...
flag = 0;
if (rpm_check(release:"SL7", reference:"perl-Archive-Tar-1.92-3.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"perl-Archive-Tar-1.92-3.el7")) flag++;
