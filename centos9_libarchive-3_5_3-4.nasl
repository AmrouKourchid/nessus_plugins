...
if (description)
{
  ...
  script_name(english:"CentOS 9 : libarchive-3.5.3-4.el9");
...
libarchive-3.5.3-4.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=27714");
...
"Update the CentOS 9 Stream bsdcat package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:bsdcat");
...
var pkgs = [
    {'reference':'bsdcat-3.5.3-4.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'bsdcpio-3.5.3-4.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'bsdcat / bsdcpio / bsdtar / libarchive / libarchive-devel');
}
