...
# extracted from Red Hat Security Advisory RHSA-2024:2569. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2569");

  script_name(english:"RHEL 9 : grafana-pcp (RHSA-2024:2569)");
...
the RHSA-2024:2569 advisory.

    grafana-pcp is an open source Grafana plugin for PCP.

    Security Fix(es):

    * grafana-pcp: golang-fips/openssl: Memory leaks in code encrypting and decrypting RSA payloads
    (CVE-2024-1394)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2569.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?58644f37");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2569");
...
"Update the RHEL grafana-pcp package based on the guidance in RHSA-2024:2569.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'grafana-pcp-5.1.1-2.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'grafana-pcp-5.1.1-2.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
