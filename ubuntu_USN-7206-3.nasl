...
# extracted from Ubuntu Security Notice USN-7206-3. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"7206-3");

  script_name(english:"Ubuntu 24.10 : rsync vulnerabilities (USN-7206-3)");
...
USN-7206-3 advisory.
    ...
    USN-7206-1 fixed vulnerabilities in Ubuntu 14.04 LTS to Ubuntu 24.04 LTS. This update provides the
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7206-3");
...
var pkgs = [
    {'osver': '24.10', 'pkgname': 'rsync', 'pkgver': '3.3.0-1ubuntu0.1'}
];
