...
# extracted from Fedora Security Advisory FEDORA-2024-13270a731d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-13270a731d");

  script_name(english:"Fedora 41 : oci-cli / python-oci (2024-13270a731d)");
...
FEDORA-2024-13270a731d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-13270a731d");
...
var pkgs = [
    {'reference':'oci-cli-3.43.2-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python-oci-2.128.2-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
