...
if (description)
{
  ...
  script_cve_id("CVE-2022-1292", "CVE-2022-22721");
  script_xref(name:"IAVA", value:"2022-A-0286");

  script_name(english:"Oracle Enterprise Manager Ops Center (Jul 2022 CPU)");
...
vulnerabilities as referenced in the July 2022 CPU advisory.
  ...
  - Vulnerability in the Enterprise Manager Ops Center product of Oracle Enterprise Manager (component:
    Networking (Apache HTTP Server)). The supported version that is affected is 12.4.0.0. Easily 
    exploitable vulnerability allows unauthenticated attacker with network access via HTTP to compromise
    Enterprise Manager Ops Center. Successful attacks of this vulnerability can result in takeover 
    of Enterprise Manager Ops Center. (CVE-2022-22721)
...
var constraints = [
  {'min_version': '12.4.0.0', 'max_version': '12.4.0.9999', 'uce_patch': '34332927'}
];
