...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2008-0907.html");
...
"Update the affected pam_krb5 package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2008-3825");
...
var pkgs = [
    {'reference':'pam_krb5-2.2.14-1.el5_2.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pam_krb5-2.2.14-1.el5_2.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
