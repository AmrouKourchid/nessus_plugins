...
# extracted from Red Hat Security Advisory RHSA-2014:0137. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2014:0137");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2024/10/08");

  script_name(english:"RHEL 5 / 6 : flash-plugin (RHSA-2014:0137)");
...
in the RHSA-2014:0137 advisory.
...
number.");
  ...
  # https://access.redhat.com/security/data/csaf/v2/advisories/2014/rhsa-2014_0137.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8d107c68");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2014:0137");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#critical");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1061469");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL flash-plugin package based on the guidance in RHSA-2014:0137.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'flash-plugin-11.2.202.336-1.el5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'flash-plugin-11.2.202.336-1.el6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
