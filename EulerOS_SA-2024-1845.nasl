...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : python-pillow (EulerOS-SA-2024-1845)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1845
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8c407b37");
...
var pkgs = [
  "python3-pillow-9.0.1-1.h6.eulerosv2r11"
];
