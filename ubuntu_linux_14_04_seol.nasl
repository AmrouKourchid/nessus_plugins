...
if (description)
{
  ...
  script_name(english:"Canonical Ubuntu Linux SEoL (14.04.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Canonical Ubuntu Linux is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Canonical Ubuntu Linux is 14.04.x. It is, therefore, no longer maintained by its vendor or
provider.

Lack of support implies that no new security patches for the product will be released by the vendor. As a result, it may
contain security vulnerabilities.");
  # https://wiki.ubuntu.com/Releases#:~:text=Ubuntu%2014.04%20ESM,April%202024
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5afc4199");
...
"Upgrade to a version of Canonical Ubuntu Linux that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2019/04/25");
...
var constraints = [
  { max_branch : '14.04', min_branch : '14.04', eseol : 20260425, seol : 20190425 }
];
