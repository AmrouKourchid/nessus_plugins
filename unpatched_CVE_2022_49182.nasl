...
if (description)
{
  ...
  script_cve_id("CVE-2022-49182");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-49182");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: net: hns3: add vlan list lock to
    protect vlan list When adding port base VLAN, vf VLAN need to remove from HW and modify the vlan state in
    vf VLAN list as false. If the periodicity task is freeing the same node, it may cause use after free
    error. This patch adds a vlan list lock to protect the vlan list. (CVE-2022-49182)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-49182");
