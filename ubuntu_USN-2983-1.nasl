...
# extracted from Ubuntu Security Notice USN-2983-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"2983-1");

  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS : Expat vulnerability (USN-2983-1)");
...
in the USN-2983-1 advisory.

    Gustavo Grieco discovered that Expat incorrectly handled malformed XML data. If a user or application
    linked against Expat were tricked into opening a crafted XML file, an attacker could cause a denial of
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2983-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'expat', 'pkgver': '2.1.0-4ubuntu1.2'},
    {'osver': '14.04', 'pkgname': 'lib64expat1', 'pkgver': '2.1.0-4ubuntu1.2'},
    {'osver': '14.04', 'pkgname': 'lib64expat1-dev', 'pkgver': '2.1.0-4ubuntu1.2'},
    {'osver': '14.04', 'pkgname': 'libexpat1', 'pkgver': '2.1.0-4ubuntu1.2'},
    {'osver': '14.04', 'pkgname': 'libexpat1-dev', 'pkgver': '2.1.0-4ubuntu1.2'},
    {'osver': '14.04', 'pkgname': 'libexpat1-udeb', 'pkgver': '2.1.0-4ubuntu1.2'},
    {'osver': '16.04', 'pkgname': 'expat', 'pkgver': '2.1.0-7ubuntu0.16.04.1'},
    {'osver': '16.04', 'pkgname': 'lib64expat1', 'pkgver': '2.1.0-7ubuntu0.16.04.1'},
    {'osver': '16.04', 'pkgname': 'lib64expat1-dev', 'pkgver': '2.1.0-7ubuntu0.16.04.1'},
    {'osver': '16.04', 'pkgname': 'libexpat1', 'pkgver': '2.1.0-7ubuntu0.16.04.1'},
    {'osver': '16.04', 'pkgname': 'libexpat1-dev', 'pkgver': '2.1.0-7ubuntu0.16.04.1'},
    {'osver': '16.04', 'pkgname': 'libexpat1-udeb', 'pkgver': '2.1.0-7ubuntu0.16.04.1'}
];
