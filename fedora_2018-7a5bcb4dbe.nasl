...
# extracted from Fedora Security Advisory FEDORA-2018-7a5bcb4dbe.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : 1:mysql-connector-java (2018-7a5bcb4dbe)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-7a5bcb4dbe");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"mysql-connector-java-8.0.13-1.fc28", epoch:"1")) flag++;
