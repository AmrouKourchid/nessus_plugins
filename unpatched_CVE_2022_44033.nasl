...
if (description)
{
  ...
  script_cve_id("CVE-2022-44033");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-44033");
...
patch available.
  ...
  - An issue was discovered in the Linux kernel through 6.0.6. drivers/char/pcmcia/cm4040_cs.c has a race
    condition and resultant use-after-free if a physically proximate attacker removes a PCMCIA device while
    calling open(), aka a race condition between cm4040_open() and reader_detach(). (CVE-2022-44033)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-44033");
