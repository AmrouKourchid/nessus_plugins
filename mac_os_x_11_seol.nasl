...
if (description)
{
  ...
  script_name(english:"Apple Mac OS X SEoL (11.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Apple Mac OS X is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Apple Mac OS X is 11.x. It is, therefore, no longer maintained by its vendor or provider.
...
var constraints = [
  { max_branch : '11', min_branch : '11', seol : 20230926 }
];
