...
# extracted from Ubuntu Security Notice USN-3306-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS : libsndfile vulnerabilities (USN-3306-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 14.04 LTS / 16.04 LTS host has packages installed that are affected by multiple vulnerabilities as
referenced in the USN-3306-1 advisory.

    Agostino Sarubbo and Jakub Jirasek discovered that libsndfile incorrectly handled certain malformed files.
    A remote attacker could use this issue to cause libsndfile to crash, resulting in a denial of service, or
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3306-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'libsndfile1', 'pkgver': '1.0.25-7ubuntu2.2'},
    {'osver': '14.04', 'pkgname': 'libsndfile1-dev', 'pkgver': '1.0.25-7ubuntu2.2'},
    {'osver': '14.04', 'pkgname': 'sndfile-programs', 'pkgver': '1.0.25-7ubuntu2.2'},
    {'osver': '16.04', 'pkgname': 'libsndfile1', 'pkgver': '1.0.25-10ubuntu0.16.04.1'},
    {'osver': '16.04', 'pkgname': 'libsndfile1-dev', 'pkgver': '1.0.25-10ubuntu0.16.04.1'},
    {'osver': '16.04', 'pkgname': 'sndfile-programs', 'pkgver': '1.0.25-10ubuntu0.16.04.1'}
];
