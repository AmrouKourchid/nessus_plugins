...
# Red Hat Security Advisory RHSA-2023:5721. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : go-toolset:rhel8 (CESA-2023:5721)");
...
CESA-2023:5721 advisory.
  ...
  - rapid stream resets can cause excessive work () (CVE-2023-44487)
...
var appstreams = {
    'go-toolset:rhel8': [
      {'reference':'delve-1.9.1-1.module_el8.8.0+1221+80a886ce', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
};
