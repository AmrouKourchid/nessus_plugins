...
# extracted from Red Hat Security Advisory RHSA-2018:1689. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:1689");
  script_xref(name:"IAVA", value:"2018-A-0170");

  script_name(english:"RHEL 6 : Virtualization (RHSA-2018:1689) (Spectre)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"An update for rhevm-setup-plugins is now available for RHEV Manager
version 3.6.
...
The rhevm-setup-plugins package adds functionality exclusive only to
...
Note: This is the rhevm-setup-plugins side of the CVE-2018-3639
mitigation.
...
"Update the affected rhevm-setup-plugins package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rhevm-setup-plugins");
...
else
{
  ...
  if (! (rpm_exists(release:"RHEL6", rpm:"rhvm-setup-plugins-3.6"))) audit(AUDIT_PACKAGE_NOT_INSTALLED, "Virtualization");

  if (rpm_exists(rpm:"rhevm-setup-plugins-3.6.", release:"RHEL6") && rpm_check(release:"RHEL6", reference:"rhevm-setup-plugins-3.6.7-1.el6ev")) flag++;
  ...
  else
  {
    ...
    else audit(AUDIT_PACKAGE_NOT_INSTALLED, "rhevm-setup-plugins");
  }
}
