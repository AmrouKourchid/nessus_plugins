...
# extracted from Red Hat Security Advisory libiberty. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2018-20657", "CVE-2018-20673", "CVE-2021-3826");

  script_name(english:"RHEL 7 : libiberty (Unpatched Vulnerability) (deprecated)");
