...
if (description)
{
  ...
  script_name(english:"Microsoft Windows 10 20H2 IoT Enterprise SEoL");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Microsoft Windows is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"Microsoft Windows 10 20H2 IoT Enterprise is no longer maintained by its vendor or provider.
...
"Upgrade to a version of Microsoft Windows that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2023/05/09");
...
var constraints = [
  { seol : 20230509, cpe_attributes : [{'edition': 'iot_enterprise'}] }
];
