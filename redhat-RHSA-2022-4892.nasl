...
# extracted from Red Hat Security Advisory RHSA-2022:4892. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:4892");
  script_xref(name:"IAVA", value:"2022-A-0226-S");

  script_name(english:"RHEL 9 : thunderbird (RHSA-2022:4892)");
...
referenced in the RHSA-2022:4892 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_4892.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2a051275");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:4892");
...
"Update the RHEL thunderbird package based on the guidance in RHSA-2022:4892.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'thunderbird-91.10.0-1.el9_0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'thunderbird-91.10.0-1.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
