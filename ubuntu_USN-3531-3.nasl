...
# extracted from Ubuntu Security Notice USN-3531-3. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS : intel-microcode update (USN-3531-3)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3531-3");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'intel-microcode', 'pkgver': '3.20180312.0~ubuntu14.04.1'},
    {'osver': '16.04', 'pkgname': 'intel-microcode', 'pkgver': '3.20180312.0~ubuntu16.04.1'}
];
