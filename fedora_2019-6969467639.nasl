...
# extracted from Fedora Security Advisory FEDORA-2019-6969467639.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-6969467639");

  script_name(english:"Fedora 31 : openconnect (2019-6969467639)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-6969467639");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"openconnect-8.05-1.fc31")) flag++;
