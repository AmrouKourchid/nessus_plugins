...
if (description)
{
  ...
  script_name(english:"MLRun Detection");

  script_set_attribute(attribute:"synopsis", value:
"A MLRun Python library is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"A MLRun Python library is installed on the remote host. 

Note that Nessus has relied upon on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://docs.mlrun.org/en/latest/index.html");
  ...
  script_set_attribute(attribute:"cpe", value:"cpe:/a:mlrun:mlrun");
