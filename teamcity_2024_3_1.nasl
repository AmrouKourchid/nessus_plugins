...
if (description)
{
  ...
  script_cve_id("CVE-2024-35300", "CVE-2024-35301");
  script_xref(name:"IAVA", value:"2024-A-0296-S");

  script_name(english:"TeamCity Server < 2024.3.1 Multiple Vulnerabilities");
...
remote host is a version prior to 2024.3.1. It is, therefore, affected by
multiple vulnerabilities:

  - several stored XSS in the available updates page are possible. (CVE-2024-35300)

  - Commit status publisher fails to check project scope of the GitHub App token. (CVE-2024-35301)
...
"Upgrade to JetBrains TeamCity version 2024.3.1 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:P/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:R/S:C/C:L/I:L/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-35300");
