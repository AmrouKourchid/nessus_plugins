...
# extracted from Fedora Security Advisory FEDORA-2023-acdfd145f2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-acdfd145f2");
  script_xref(name:"IAVA", value:"2023-A-0283-S");

  script_name(english:"Fedora 37 : pypy (2023-acdfd145f2)");
...
FEDORA-2023-acdfd145f2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-acdfd145f2");
...
var pkgs = [
    {'reference':'pypy-7.3.11-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
