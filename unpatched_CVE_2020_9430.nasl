...
if (description)
{
  ...
  script_cve_id("CVE-2020-9430");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2020-9430");
...
patch available.
  ...
  - In Wireshark 3.2.0 to 3.2.1, 3.0.0 to 3.0.8, and 2.6.0 to 2.6.14, the WiMax DLMAP dissector could crash.
    This was addressed in plugins/epan/wimax/msg_dlmap.c by validating a length field. (CVE-2020-9430)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-9430");
