...
# extracted from Red Hat Security Advisory lynx. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2016-9179", "CVE-2017-1000211");

  script_name(english:"RHEL 7 : lynx (Unpatched Vulnerability) (deprecated)");
