...
# extracted from Fedora Security Advisory FEDORA-2022-d0be6938e2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-d0be6938e2");

  script_name(english:"Fedora 38 : cloudcompare (2022-d0be6938e2)");
...
FEDORA-2022-d0be6938e2 advisory.
    ...
    ```
    * Thu Aug 25 2022 Miro Hronok <mhroncok@redhat.com> - 2.11.3-4
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-d0be6938e2");
  script_set_attribute(attribute:"solution", value:
"Update the affected cloudcompare package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:cloudcompare");
...
var pkgs = [
    {'reference':'cloudcompare-2.11.3-4.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'cloudcompare');
}
