...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 20.04 LTS : PulseAudio vulnerability (USN-4640-1)");
...
referenced in the USN-4640-1 advisory.

    James Henstridge discovered that an Ubuntu-specific patch caused PulseAudio to incorrectly handle snap
    client connections. An attacker could possibly use this to expose sensitive information.
