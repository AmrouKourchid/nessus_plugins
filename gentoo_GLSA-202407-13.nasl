...
# extracted from Gentoo Linux Security Advisory GLSA 202407-13.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202407-13 : WebKitGTK+: Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202407-13 (WebKitGTK+: Multiple Vulnerabilities)

    Multiple vulnerabilities have been discovered in WebKitGTK+. Please review the CVE identifiers referenced
    below for details.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202407-13");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=923851");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=930116");
...
var packages = [
  {
    ...
    'unaffected' : make_list("ge 2.44.0"),
    'vulnerable' : make_list("lt 2.44.0")
  }
];
