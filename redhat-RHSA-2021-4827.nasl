...
"The remote Red Hat host is missing one or more security updates for OpenShift Container Platform 3.11.569.");
...
referenced in the RHSA-2021:4827 advisory.
    ...
    * jenkins: Agent processes are able to completely bypass file path filtering by wrapping the file
    operation in an agent file path
    (CVE-2021-21690)
    ...
    * jenkins: FilePath#toURI, FilePath#hasSymlink, FilePath#absolutize, FilePath#isDescendant, and
    FilePath#get*DiskSpace do not check any
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_4827.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e2e739ab");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:4827");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1920894");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2002671");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2002909");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2003491");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2013496");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2016467");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2026193");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 3.11.569 package based on the guidance in RHSA-2021:4827.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jenkins-2-plugins-3.11.1637699107-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-ansible', 'cves':['CVE-2021-21698']},
      {'reference':'jenkins-2.303.3.1637698110-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-ansible', 'cves':['CVE-2021-21685', 'CVE-2021-21686', 'CVE-2021-21687', 'CVE-2021-21688', 'CVE-2021-21689', 'CVE-2021-21690', 'CVE-2021-21691', 'CVE-2021-21692', 'CVE-2021-21693', 'CVE-2021-21694', 'CVE-2021-21695', 'CVE-2021-21696', 'CVE-2021-21697']}
    ]
  }
];
