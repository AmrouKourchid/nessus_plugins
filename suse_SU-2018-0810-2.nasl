...
# extracted from SUSE update advisory SUSE-SU-2018:0810-2.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES11 Security Update : dhcp (SUSE-SU-2018:0810-2)");
...
without introducing additional issues.");
  ...
  # https://www.suse.com/support/update/announcement/2018/suse-su-20180810-2/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?32ec4107");
...
slessp3-dhcp-13533=1

SUSE Linux Enterprise Point of Sale 11-SP3:zypper in -t patch
sleposp3-dhcp-13533=1
...
flag = 0;
if (rpm_check(release:"SLES11", sp:"3", reference:"dhcp-4.2.4.P2-0.28.8.1")) flag++;
if (rpm_check(release:"SLES11", sp:"3", reference:"dhcp-client-4.2.4.P2-0.28.8.1")) flag++;
if (rpm_check(release:"SLES11", sp:"3", reference:"dhcp-relay-4.2.4.P2-0.28.8.1")) flag++;
if (rpm_check(release:"SLES11", sp:"3", reference:"dhcp-server-4.2.4.P2-0.28.8.1")) flag++;
