...
if (description)
{
  ...
  script_name(english:"PySpark Detection");

  script_set_attribute(attribute:"synopsis", value:
"A PySpark Python library is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"A PySpark Python library is installed on the remote host. 

Note that Nessus has relied upon on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://pypi.org/project/PySpark/");
