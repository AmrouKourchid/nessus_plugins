...
if (description)
{
  ...
  script_cve_id("CVE-2015-3143");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2015-3143");
...
patch available.
  ...
  - cURL and libcurl 7.10.6 through 7.41.0 does not properly re-use NTLM connections, which allows remote
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-3143");
