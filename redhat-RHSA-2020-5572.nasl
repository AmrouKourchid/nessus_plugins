...
# extracted from Red Hat Security Advisory RHSA-2020:5572. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:5572");

  script_name(english:"RHEL 7 : python-django-horizon (RHSA-2020:5572)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for python-django-horizon.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2020:5572 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_5572.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?daae7816");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:5572");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1811510");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-django-horizon package based on the guidance in RHSA-2020:5572.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openstack-dashboard-13.0.3-7.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'},
      {'reference':'python-django-horizon-13.0.3-7.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'openstack-dashboard / python-django-horizon');
}
