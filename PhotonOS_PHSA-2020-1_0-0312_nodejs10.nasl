...
# extracted from VMware Security Advisory PHSA-2020-1.0-0312. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Nodejs10 PHSA-2020-1.0-0312");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the nodejs10 package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-1.0-312.md");
...
if (rpm_check(release:"PhotonOS-1.0", cpu:"x86_64", reference:"nodejs10-10.19.0-3.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", cpu:"x86_64", reference:"nodejs10-devel-10.19.0-3.ph1")) flag++;
