...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : vim (EulerOS-SA-2019-1753)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1753
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3a4d2875");
...
pkgs = ["vim-X11-7.4.160-2.h5",
        "vim-common-7.4.160-2.h5",
        "vim-enhanced-7.4.160-2.h5",
        "vim-filesystem-7.4.160-2.h5",
        "vim-minimal-7.4.160-2.h5"];
