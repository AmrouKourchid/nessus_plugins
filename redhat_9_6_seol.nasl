...
if (description)
{
  ...
  script_name(english:"Red Hat Enterprise Linux SEoL (9.6.x, 9.7.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Red Hat Enterprise Linux is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Red Hat Enterprise Linux is 9.6.x or 9.7.x. It is, therefore, no longer maintained by its 
vendor or provider.
...
"Upgrade to a version of Red Hat Enterprise Linux that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2027/04/30");
...
var constraints = [
  { min_branch : '9.6', max_branch : '9.7', seol : 20270430, eseol : 20290430 }
];
