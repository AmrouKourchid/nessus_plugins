...
if (description)
{
  ...
  script_cve_id("CVE-2023-52642");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2023-52642");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: media: rc: bpf attach/detach requires
    write permission Note that bpf attach/detach also requires CAP_NET_ADMIN. (CVE-2023-52642)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-52642");
