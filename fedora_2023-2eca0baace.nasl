...
# extracted from Fedora Security Advisory FEDORA-2023-2eca0baace
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-2eca0baace");

  script_name(english:"Fedora 39 : galera / mariadb (2023-2eca0baace)");
...
FEDORA-2023-2eca0baace advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-2eca0baace");
...
var pkgs = [
    {'reference':'galera-26.4.16-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'mariadb-10.5.23-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'}
];
