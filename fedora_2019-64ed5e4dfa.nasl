...
# extracted from Fedora Security Advisory FEDORA-2019-64ed5e4dfa.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : znc (2019-64ed5e4dfa)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-64ed5e4dfa");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"znc-1.7.3-1.fc28")) flag++;
