...
# extracted from Oracle Linux Security Advisory ELSA-2024-6192.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : wget (ELSA-2024-6192)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-6192.html");
...
var pkgs = [
    {'reference':'wget-1.21.1-8.el9_4', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'wget-1.21.1-8.el9_4', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
