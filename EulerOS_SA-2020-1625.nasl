...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : openssl (EulerOS-SA-2020-1625)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1625
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b49d7f4f");
...
pkgs = ["openssl-1.0.2k-16.h9",
        "openssl-devel-1.0.2k-16.h9",
        "openssl-libs-1.0.2k-16.h9"];
