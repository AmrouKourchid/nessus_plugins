...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : openssh (EulerOS-SA-2023-2921)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2921
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?056ca3a1");
...
var pkgs = [
  "openssh-8.2p1-9.h52.eulerosv2r10",
  "openssh-clients-8.2p1-9.h52.eulerosv2r10",
  "openssh-server-8.2p1-9.h52.eulerosv2r10"
];
