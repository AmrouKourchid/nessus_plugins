...
# extracted from Red Hat Security Advisory RHSA-2023:6341. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:6341");

  script_name(english:"RHEL 9 : xorg-x11-server-Xwayland (RHSA-2023:6341)");
...
the RHSA-2023:6341 advisory.

    Xwayland is an X server for running X clients under Wayland.

    The following packages have been upgraded to a later upstream version: xorg-x11-server-Xwayland (22.1.9).
    (BZ#2158761)
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6341.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7ef5408a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2158761");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2180288");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6341");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'xorg-x11-server-Xwayland-22.1.9-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
