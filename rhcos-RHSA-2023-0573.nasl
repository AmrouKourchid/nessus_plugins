...
if (description)
{
  ...
  script_name(english:"RHCOS 4 : OpenShift Container Platform 4.9.55 (RHSA-2023:0573)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat CoreOS host is missing a security update for OpenShift Container Platform 4.9.55.");
...
referenced in the RHSA-2023:0573 advisory.
...
"Update the RHCOS OpenShift Container Platform 4.9.55 package based on the guidance in RHSA-2023:0573.");
...
var pkgs = [
    {'reference':'jenkins-2-plugins-4.9.1674644684-1.el8', 'release':'4', 'el_string':'el8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
];
