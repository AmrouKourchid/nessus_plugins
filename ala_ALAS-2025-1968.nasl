...
# extracted from Amazon Linux AMI Security Advisory ALAS-2025-1968.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux AMI : libxslt (ALAS-2025-1968)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux AMI host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of libxslt installed on the remote host is prior to 1.1.28-6.16. It is, therefore, affected by multiple
vulnerabilities as referenced in the ALAS-2025-1968 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/ALAS-2025-1968.html");
...
var pkgs = [
    {'reference':'libxslt-1.1.28-6.16.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libxslt-1.1.28-6.16.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libxslt-debuginfo-1.1.28-6.16.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libxslt-debuginfo-1.1.28-6.16.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libxslt-devel-1.1.28-6.16.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libxslt-devel-1.1.28-6.16.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libxslt-python26-1.1.28-6.16.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libxslt-python26-1.1.28-6.16.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libxslt-python27-1.1.28-6.16.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libxslt-python27-1.1.28-6.16.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE}
];
