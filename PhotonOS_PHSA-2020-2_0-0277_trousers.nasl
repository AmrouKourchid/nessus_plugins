...
# extracted from VMware Security Advisory PHSA-2020-2.0-0277. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Trousers PHSA-2020-2.0-0277");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the trousers package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-2-277.md");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'trousers-0.3.14-3.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'trousers-devel-0.3.14-3.ph2')) flag++;
