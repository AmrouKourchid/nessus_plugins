...
# extracted from Red Hat Security Advisory RHSA-2025:0201. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:0201");

  script_name(english:"RHEL 8 : Red Hat OpenStack Platform 16.2 (python-waitress) (RHSA-2025:0201)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for Red Hat OpenStack Platform 16.2 (python-waitress).");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has a package installed that is affected by multiple vulnerabilities as
referenced in the RHSA-2025:0201 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_0201.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a9a7a34e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:0201");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat OpenStack Platform 16.2 (python-waitress) package based on the guidance in RHSA-2025:0201.");
