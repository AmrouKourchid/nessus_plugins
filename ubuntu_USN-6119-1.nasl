...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS / 22.04 LTS / 23.04 : OpenSSL vulnerabilities (USN-6119-1)");
...
vulnerabilities as referenced in the USN-6119-1 advisory.
    ...
    service. (CVE-2023-2650)

    Anton Romanov discovered that OpenSSL incorrectly handled AES-XTS cipher decryption on 64-bit ARM
    platforms. An attacker could possibly use this issue to cause OpenSSL to crash, resulting in a denial of
    service. This issue only affected Ubuntu 22.04 LTS, Ubuntu 22.10, and Ubuntu 23.04. (CVE-2023-1255)
