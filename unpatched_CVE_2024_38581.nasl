...
if (description)
{
  ...
  script_cve_id("CVE-2024-38581");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-38581");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: drm/amdgpu/mes: fix use-after-free
    issue Delete fence fallback timer to fix the ramdom use-after-free issue. v2: move to amdgpu_mes.c
    (CVE-2024-38581)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-38581");
