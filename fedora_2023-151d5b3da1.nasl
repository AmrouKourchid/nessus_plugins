...
# extracted from Fedora Security Advisory FEDORA-2023-151d5b3da1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-151d5b3da1");

  script_name(english:"Fedora 38 : cjose (2023-151d5b3da1)");
...
FEDORA-2023-151d5b3da1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-151d5b3da1");
...
var pkgs = [
    {'reference':'cjose-0.6.2.2-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
