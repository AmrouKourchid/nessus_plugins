...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : openssl (EulerOS-SA-2019-1145)");
...
vulnerabilities :
  ...
  - If an application encounters a fatal protocol error and
    ...
    this but some do anyway).(CVE-2019-1559)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1145
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e8f72a35");
...
pkgs = ["openssl-1.0.2k-16.h5.eulerosv2r7",
        "openssl-devel-1.0.2k-16.h5.eulerosv2r7",
        "openssl-libs-1.0.2k-16.h5.eulerosv2r7"];
