...
# extracted from Fedora Security Advisory FEDORA-2024-1d0cb3b43f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-1d0cb3b43f");

  script_name(english:"Fedora 40 : python3-docs / python3.12 (2024-1d0cb3b43f)");
...
FEDORA-2024-1d0cb3b43f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-1d0cb3b43f");
...
var pkgs = [
    {'reference':'python3-docs-3.12.6-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3.12-3.12.6-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
