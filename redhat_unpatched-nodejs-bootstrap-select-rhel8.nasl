...
# extracted from Red Hat Security Advisory nodejs-bootstrap-select. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2019-20921");

  script_name(english:"RHEL 8 : nodejs-bootstrap-select (Unpatched Vulnerability) (deprecated)");
...
"This plugin has been deprecated as it does not adhere to established standards for this style of check.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-20921");
