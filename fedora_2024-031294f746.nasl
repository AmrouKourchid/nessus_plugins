...
# extracted from Fedora Security Advisory FEDORA-2024-031294f746
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-031294f746");

  script_name(english:"Fedora 38 : java-latest-openjdk (2024-031294f746)");
...
FEDORA-2024-031294f746 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-031294f746");
...
var pkgs = [
    {'reference':'java-latest-openjdk-21.0.2.0.13-1.rolling.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
