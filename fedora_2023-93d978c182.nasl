...
# extracted from Fedora Security Advisory FEDORA-2023-93d978c182
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-93d978c182");

  script_name(english:"Fedora 38 : libyang (2023-93d978c182)");
...
FEDORA-2023-93d978c182 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-93d978c182");
...
var pkgs = [
    {'reference':'libyang-2.1.55-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
