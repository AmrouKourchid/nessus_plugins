...
# extracted from VMware Security Advisory PHSA-2017-0007. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Vim PHSA-2017-0007");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the vim package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-27.md");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'vim-7.4-8.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'vim-extra-7.4-8.ph1')) flag++;
