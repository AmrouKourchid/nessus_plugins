...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : libxslt (EulerOS-SA-2019-1318)");
...
vulnerabilities :
  ...
  - In libxslt 1.1.29 and earlier, the EXSLT math.random
    ...
    produce predictable outputs.(CVE-2015-5019)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1318
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4888ea40");
...
pkgs = ["libxslt-1.1.28-5.h2.eulerosv2r7",
        "libxslt-devel-1.1.28-5.h2.eulerosv2r7",
        "libxslt-python-1.1.28-5.h2.eulerosv2r7"];
