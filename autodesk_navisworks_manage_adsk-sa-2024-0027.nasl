...
if (description)
{
  ...
  script_name(english:"Autodesk Navisworks Manage 25.0.x < 2025.4 Multiple Vulnerabilities (adsk-sa-2024-0027)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The version of Autodesk Navisworks Manage installed on the remote host is prior to 2025.4. It is,
...
"Upgrade to Autodesk Navisworks Manage version 2025.4 or later.");
