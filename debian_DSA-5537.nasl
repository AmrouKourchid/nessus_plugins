...
# extracted from Debian Security Advisory dsa-5537. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-5537-1 : openjdk-11 - security update");
...
dsa-5537 advisory.
    ...
    sandbox restrictions or denial of service. For the oldstable distribution (bullseye), these problems have
    been fixed in version 11.0.21+9-1~deb11u1. We recommend that you upgrade your openjdk-11 packages. For the
    detailed security status of openjdk-11 please refer to its security tracker page at: https://security-
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2023/dsa-5537");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-22067");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'openjdk-11-dbg', 'reference': '11.0.21+9-1~deb11u1'},
    {'release': '11.0', 'prefix': 'openjdk-11-demo', 'reference': '11.0.21+9-1~deb11u1'},
    {'release': '11.0', 'prefix': 'openjdk-11-doc', 'reference': '11.0.21+9-1~deb11u1'},
    {'release': '11.0', 'prefix': 'openjdk-11-jdk', 'reference': '11.0.21+9-1~deb11u1'},
    {'release': '11.0', 'prefix': 'openjdk-11-jdk-headless', 'reference': '11.0.21+9-1~deb11u1'},
    {'release': '11.0', 'prefix': 'openjdk-11-jre', 'reference': '11.0.21+9-1~deb11u1'},
    {'release': '11.0', 'prefix': 'openjdk-11-jre-headless', 'reference': '11.0.21+9-1~deb11u1'},
    {'release': '11.0', 'prefix': 'openjdk-11-jre-zero', 'reference': '11.0.21+9-1~deb11u1'},
    {'release': '11.0', 'prefix': 'openjdk-11-source', 'reference': '11.0.21+9-1~deb11u1'}
];
