...
# extracted from Fedora Security Advisory FEDORA-2025-016ed44ddc
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-016ed44ddc");

  script_name(english:"Fedora 40 : nginx / nginx-mod-fancyindex / nginx-mod-modsecurity / etc (2025-016ed44ddc)");
...
FEDORA-2025-016ed44ddc advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-016ed44ddc");
...
var pkgs = [
    {'reference':'nginx-1.26.3-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'nginx-mod-fancyindex-0.5.2-8.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'nginx-mod-modsecurity-1.0.3-16.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'nginx-mod-naxsi-1.6-9.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'nginx-mod-vts-0.2.3-3.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
