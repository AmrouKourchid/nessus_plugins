...
# extracted from ZTE advisory NS-SA-2019-0267. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.04 / MAIN 5.04 : ntp Vulnerability (NS-SA-2019-0267)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/notice/NS-SA-2019-0267");
...
pkgs = {
  "CGSL CORE 5.04": [
    "ntp-4.2.6p5-29.el7.centos.cgslv5.0.1.g9036406",
    "ntp-debuginfo-4.2.6p5-29.el7.centos.cgslv5.0.1.g9036406",
    "ntp-doc-4.2.6p5-29.el7.centos.cgslv5.0.1.g9036406",
    "ntp-perl-4.2.6p5-29.el7.centos.cgslv5.0.1.g9036406",
    "ntpdate-4.2.6p5-29.el7.centos.cgslv5.0.1.g9036406",
    "sntp-4.2.6p5-29.el7.centos.cgslv5.0.1.g9036406"
  ],
  "CGSL MAIN 5.04": [
    "ntp-4.2.6p5-29.el7.centos.cgslv5.0.1.g9036406",
    "ntp-debuginfo-4.2.6p5-29.el7.centos.cgslv5.0.1.g9036406",
