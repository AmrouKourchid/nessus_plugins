...
# extracted from Fedora Security Advisory FEDORA-2020-bdcc8ffc24.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : python-waitress (2020-bdcc8ffc24)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-bdcc8ffc24");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"python-waitress-1.4.3-1.fc30")) flag++;
