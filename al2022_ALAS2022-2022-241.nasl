...
# extracted from Amazon Linux 2022 Security Advisory ALAS2022-2022-241.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2022 : python-jwt (ALAS2022-2022-241)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2022/ALAS-2022-241.html");
...
var pkgs = [
    {'reference':'python3-jwt+crypto-2.4.0-1.amzn2022', 'release':'AL-2022', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-jwt-2.4.0-1.amzn2022', 'release':'AL-2022', 'rpm_spec_vers_cmp':TRUE}
];
