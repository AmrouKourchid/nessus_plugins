...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : Pidgin vulnerability (USN-3231-1)");
...
USN-3231-1 advisory.
    ...
    Joseph Bisch discovered that Pidgin incorrectly handled certain xml messages. A remote attacker could use
    this issue to cause Pidgin to crash, resulting in a denial of service, or possibly execute arbitrary code.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3231-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'finch', 'pkgver': '1:2.10.9-0ubuntu3.4'},
    {'osver': '14.04', 'pkgname': 'finch-dev', 'pkgver': '1:2.10.9-0ubuntu3.4'},
    {'osver': '14.04', 'pkgname': 'libpurple-bin', 'pkgver': '1:2.10.9-0ubuntu3.4'},
    {'osver': '14.04', 'pkgname': 'libpurple-dev', 'pkgver': '1:2.10.9-0ubuntu3.4'},
    {'osver': '14.04', 'pkgname': 'libpurple0', 'pkgver': '1:2.10.9-0ubuntu3.4'},
    {'osver': '14.04', 'pkgname': 'pidgin', 'pkgver': '1:2.10.9-0ubuntu3.4'},
    {'osver': '14.04', 'pkgname': 'pidgin-data', 'pkgver': '1:2.10.9-0ubuntu3.4'},
    {'osver': '14.04', 'pkgname': 'pidgin-dev', 'pkgver': '1:2.10.9-0ubuntu3.4'}
];
