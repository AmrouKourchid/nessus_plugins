...
# extracted from Fedora Security Advisory FEDORA-2024-1a59230214
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-1a59230214");
  script_xref(name:"IAVA", value:"2024-A-0184");

  script_name(english:"Fedora 38 : libvirt (2024-1a59230214)");
...
FEDORA-2024-1a59230214 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-1a59230214");
...
var pkgs = [
    {'reference':'libvirt-9.0.0-5.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
