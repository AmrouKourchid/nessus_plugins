...
if (description)
{
  ...
  script_name(english:"RHEL 7 : rhvm-appliance (RHSA-2018:1525)");
...
referenced in the RHSA-2018:1525 advisory.

    The RHV-M Virtual Appliance automates the process of installing and configuring the Red Hat Virtualization
    Manager. The appliance is available to download as an OVA file from the Customer Portal.

    The following packages have been upgraded to a later upstream version: rhvm-appliance (4.2). (BZ#1558801,
    BZ#1563545)
    ...
    * ovirt-engine: account enumeration through login to web console (CVE-2018-1073)
    ...
    Red Hat would like to thank Chris McCown for reporting CVE-2018-8088. The CVE-2017-12196 issue was
    discovered by Jan Stourac (Red Hat).

    Enhancement(s):

    * Previously, the default memory allotment for the RHV-M Virtual Appliance was always large enough to
    include support for user additions.

    In this release, the RHV-M Virtual Appliance includes a swap partition that enables the memory to be
    increased when required. (BZ#1422982)

    * Previously, the partitioning scheme for the RHV-M Virtual Appliance included two primary partitions, /
    and swap.

    In this release, the disk partitioning scheme has been modified to match the scheme specified by NIST. The
    updated disk partitions are as follows:
    ...
    * Previously, the version tag was used as part of the RPM's naming scheme, for example, 4.1.timestamp,
    which created differences between the upstream and downstream versioning schemes. In this release, the
    downstream versioning scheme is aligned with the upstream scheme and the timestamp has moved from the
    version tag to the release tag. (BZ#1464486)

Tenable has extracted the preceding description block directly from the Red Hat Enterprise Linux security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2018/rhsa-2018_1525.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bdf841af");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:1525");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1422982");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1463853");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1464486");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1467946");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1476755");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1553525");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1557130");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1561888");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1563737");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rhvm-appliance package based on the guidance in RHSA-2018:1525.");
  script_set_cvss_base_vector("CVSS2#AV:A/AC:M/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:F/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:F/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-1111");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2018-8088");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rhvm-appliance-4.2-20180504.0.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ovirt-'}
    ]
  }
];
