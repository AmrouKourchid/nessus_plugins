...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Libuv PHSA-2023-4.0-0399");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the libuv package has been released.");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:vmware:photonos:libuv");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libuv-1.45.0-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libuv-devel-1.45.0-1.ph4')) flag++;
