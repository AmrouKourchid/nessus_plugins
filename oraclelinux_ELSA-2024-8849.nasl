...
# extracted from Oracle Linux Security Advisory ELSA-2024-8849.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : haproxy (ELSA-2024-8849)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-8849.html");
...
var pkgs = [
    {'reference':'haproxy-1.8.27-5.el8_10.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'haproxy-1.8.27-5.el8_10.1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
