...
# extracted from openSUSE Security Update openSUSE-2019-2593.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : cpio (openSUSE-2019-2593)");
...
This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1155199");
...
if ( rpm_check(release:"SUSE15.0", reference:"cpio-2.12-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"cpio-debuginfo-2.12-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"cpio-debugsource-2.12-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"cpio-lang-2.12-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"cpio-mt-2.12-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"cpio-mt-debuginfo-2.12-lp150.2.3.1") ) flag++;
