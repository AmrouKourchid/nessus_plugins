...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5002542");
  script_xref(name:"MSFT", value:"MS24-5002542");
  script_xref(name:"IAVA", value:"2024-A-0094-S");
  script_xref(name:"IAVA", value:"2024-A-0097-S");

  script_name(english:"Security Updates for Microsoft Word Products (February 2024)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002542");
...
var constraints = [
  { 'kb':'5002542', 'channel':'MSI', 'fixed_version': '16.0.5435.1000', 'sp' : 0}
];
