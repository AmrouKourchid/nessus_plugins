...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : pcre (EulerOS-SA-2019-2646)");
...
vulnerabilities :
  ...
  - Stack-based buffer overflow in the
    pcre32_copy_substring function in pcre_get.c in
    libpcre1 in PCRE 8.40 allows remote attackers to cause
    a denial of service (WRITE of size 4) or possibly have
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2646
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e5eaf3a1");
...
"Update the affected pcre packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-7245");
...
pkgs = ["pcre-8.32-15.1.h10",
        "pcre-devel-8.32-15.1.h10"];
