...
# extracted from Gentoo Linux Security Advisory GLSA 202003-33.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202003-33");

  script_name(english:"GLSA-202003-33 : GStreamer Base Plugins: Heap-based buffer overflow");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202003-33
...
Impact :
    ...
    A remote attacker could entice a user to open a specially crafted RTSP
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202003-33");
...
if (qpkg_check(package:"media-libs/gst-plugins-base", unaffected:make_list("ge 1.14.5-r1"), vulnerable:make_list("lt 1.14.5-r1"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "GStreamer Base Plugins");
}
