...
# extracted from Red Hat Security Advisory RHSA-2022:9110. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2022-34177");
  script_xref(name:"RHSA", value:"2022:9110");

  script_name(english:"RHEL 8 : OpenShift Container Platform 4.9.54 (RHSA-2022:9110)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for OpenShift Container Platform 4.9.54.");
...
the RHSA-2022:9110 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.9.54. See the following
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2022_9110.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b0ca79da");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:9110");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.9.54 packages based on the guidance in RHSA-2022:9110.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jenkins-2-plugins-4.9.1669894222-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
