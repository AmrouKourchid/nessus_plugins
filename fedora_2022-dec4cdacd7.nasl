...
# extracted from Fedora Security Advisory FEDORA-2022-dec4cdacd7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-dec4cdacd7");

  script_name(english:"Fedora 37 : grub2 (2022-dec4cdacd7)");
...
FEDORA-2022-dec4cdacd7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-dec4cdacd7");
...
var pkgs = [
    {'reference':'grub2-2.06-63.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
