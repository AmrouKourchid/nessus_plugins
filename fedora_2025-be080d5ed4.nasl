...
# extracted from Fedora Security Advisory FEDORA-2025-be080d5ed4
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-be080d5ed4");

  script_name(english:"Fedora 41 : python3.9 (2025-be080d5ed4)");
...
FEDORA-2025-be080d5ed4 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-be080d5ed4");
...
var pkgs = [
    {'reference':'python3.9-3.9.21-4.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
