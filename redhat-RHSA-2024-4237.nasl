...
# extracted from Red Hat Security Advisory RHSA-2024:4237. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:4237");

  script_name(english:"RHEL 8 : go-toolset (RHSA-2024:4237)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for go-toolset.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:4237 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_4237.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6f234765");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-10069");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:4237");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL go-toolset package based on the guidance in RHSA-2024:4237.");
  ...
  'go-toolset:rhel8': [
    {
      ...
      'pkgs': [
        {'reference':'delve-1.21.2-3.module+el8.10.0+21244+5b2d9000', 'cpu':'aarch64', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'delve-1.21.2-3.module+el8.10.0+21244+5b2d9000', 'cpu':'ppc64le', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'delve-1.21.2-3.module+el8.10.0+21244+5b2d9000', 'cpu':'x86_64', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'go-toolset-1.21.11-1.module+el8.10.0+21986+2112108a', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'golang-1.21.11-1.module+el8.10.0+21986+2112108a', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'golang-bin-1.21.11-1.module+el8.10.0+21986+2112108a', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'golang-docs-1.21.11-1.module+el8.10.0+21986+2112108a', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'golang-misc-1.21.11-1.module+el8.10.0+21986+2112108a', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'golang-src-1.21.11-1.module+el8.10.0+21986+2112108a', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'golang-tests-1.21.11-1.module+el8.10.0+21986+2112108a', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
