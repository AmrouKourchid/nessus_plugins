...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : java-1.8.0-openjdk (EulerOS-SA-2021-2300)");
...
the following vulnerabilities :
  ...
  - Vulnerability in the Java SE, Java SE Embedded
    ...
    This vulnerability can also be exploited by using APIs
    in the specified Component, e.g., through a web service
    which supplies data to the APIs.(CVE-2019-2786)
  ...
  - Vulnerability in the Java SE component of Oracle Java
    ...
    result in unauthorized ability to cause a partial
    denial of service (partial DOS) of Java SE. Note: This
    ...
    This vulnerability can also be exploited by using APIs
    in the specified Component, e.g., through a web service
    which supplies data to the APIs.(CVE-2019-2842)
  ...
  - Vulnerability in the Java SE, Java SE Embedded product
    ...
    code installed by an administrator).(CVE-2019-2945)
  ...
  - Vulnerability in the Java SE, Java SE Embedded product
    ...
    This vulnerability can also be exploited by using APIs
    in the specified Component, e.g., through a web service
    which supplies data to the APIs.(CVE-2019-2949)
  ...
  - Vulnerability in the Java SE, Java SE Embedded product
    ...
    data to the APIs.(CVE-2019-2962)
  ...
  - Vulnerability in the Java SE, Java SE Embedded product
    ...
    Note: This vulnerability can only be exploited by
    supplying data to APIs in the specified Component
    without using Untrusted Java Web Start applications or
    Untrusted Java applets, such as through a web
  ...
  - Vulnerability in the Java SE, Java SE Embedded product
    ...
    can also be exploited by using APIs in the specified
    Component, e.g., through a web service which supplies
    data to the APIs.(CVE-2019-2973)
  ...
  - Vulnerability in the Java SE, Java SE Embedded product
    ...
    Java SE Embedded. Note: This vulnerability applies to
    ...
    can also be exploited by using APIs in the specified
    Component, e.g., through a web service which supplies
    data to the APIs.(CVE-2019-2975)
  ...
  - Vulnerability in the Java SE, Java SE Embedded product
    ...
    can also be exploited by using APIs in the specified
    Component, e.g., through a web service which supplies
    data to the APIs.(CVE-2019-2981)
  ...
  - Vulnerability in the Java SE product of Oracle Java SE
    ...
    This vulnerability can also be exploited by using APIs
    in the specified Component, e.g., through a web service
    which supplies data to the APIs.(CVE-2019-2987)
  ...
  - Vulnerability in the Java SE, Java SE Embedded product
    ...
    does not apply to Java deployments, typically in
    servers, that load and run only trusted code (e.g.,
    code installed by an administrator).(CVE-2019-2988)
  ...
  - Vulnerability in the Java SE, Java SE Embedded product
    ...
    can also be exploited by using APIs in the specified
    Component, e.g., through a web service which supplies
    data to the APIs.(CVE-2019-2989)
  ...
  - Vulnerability in the Java SE, Java SE Embedded product
    ...
    does not apply to Java deployments, typically in
    servers, that load and run only trusted code (e.g.,
    code installed by an administrator).(CVE-2019-2992)
  ...
  - Vulnerability in the Java SE product of Oracle Java SE
    ...
    does not apply to Java deployments, typically in
    servers, that load and run only trusted code (e.g.,
    code installed by an administrator).(CVE-2019-2999)
  ...
  - Vulnerability in the Java SE, Java SE Embedded product
    ...
    SE, Java SE Embedded accessible data. Note: Applies to
    client and server deployment of Java. This
    ...
    through a web service.(CVE-2020-14577)
  ...
  - Vulnerability in the Java SE, Java SE Embedded product
    ...
    vulnerability can result in unauthorized ability to
    cause a partial denial of service (partial DOS) of Java
    SE, Java SE Embedded. Note: Applies to client and
    ...
    sandboxed Java applets, such as through a web
    service.(CVE-2020-14579)
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2300
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8c4bb5a7");
...
pkgs = ["java-1.8.0-openjdk-1.8.0.181.b15-5.h22.eulerosv2r8",
        "java-1.8.0-openjdk-devel-1.8.0.181.b15-5.h22.eulerosv2r8",
        "java-1.8.0-openjdk-headless-1.8.0.181.b15-5.h22.eulerosv2r8"];
