...
# extracted from Mozilla Foundation Security Advisory mfsa2023-29.
...
if (description)
{
  ...
  script_name(english:"Mozilla Firefox < 116.0");

  script_set_attribute(attribute:"synopsis", value:
"A web browser installed on the remote macOS or Mac OS X host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Firefox installed on the remote macOS or Mac OS X host is prior to 116.0. It is, therefore, affected by
multiple vulnerabilities as referenced in the mfsa2023-29 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2023-29/");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Mozilla Firefox version 116.0 or later.");
...
mozilla_check_version(version:version, path:path, product:'firefox', esr:FALSE, fix:'116.0', severity:SECURITY_HOLE);
