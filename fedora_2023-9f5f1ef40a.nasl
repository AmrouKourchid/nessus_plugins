...
# extracted from Fedora Security Advisory FEDORA-2023-9f5f1ef40a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-9f5f1ef40a");

  script_name(english:"Fedora 38 : moby-engine (2023-9f5f1ef40a)");
...
FEDORA-2023-9f5f1ef40a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-9f5f1ef40a");
...
var pkgs = [
    {'reference':'moby-engine-24.0.5-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
