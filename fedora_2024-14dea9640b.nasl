...
# extracted from Fedora Security Advisory FEDORA-2024-14dea9640b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-14dea9640b");
  script_xref(name:"IAVA", value:"2024-A-0053-S");
  script_xref(name:"IAVA", value:"2024-A-0174-S");

  script_name(english:"Fedora 39 : firefox (2024-14dea9640b)");
...
FEDORA-2024-14dea9640b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-14dea9640b");
...
var pkgs = [
    {'reference':'firefox-122.0-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
