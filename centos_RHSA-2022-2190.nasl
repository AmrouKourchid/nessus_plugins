...
# extracted from Red Hat Security Advisory RHSA-2022:2190.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : podman (RHSA-2022:2190)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 7 host has packages installed that are affected by a vulnerability as referenced in the
RHSA-2022:2190 advisory.
...
var pkgs = [
    {'reference':'podman-1.6.4-32.el7_9', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'podman-1.6.4-32.el7_9', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'podman-docker-1.6.4-32.el7_9', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'podman-docker-1.6.4-32.el7_9', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE}
];
