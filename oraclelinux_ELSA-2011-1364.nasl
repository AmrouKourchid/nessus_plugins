...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2011-1364.html");
...
var pkgs = [
    {'reference':'kdelibs-4.3.4-11.el6_1.4', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'6'},
    {'reference':'kdelibs-apidocs-4.3.4-11.el6_1.4', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'6'},
    {'reference':'kdelibs-common-4.3.4-11.el6_1.4', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'6'},
    {'reference':'kdelibs-devel-4.3.4-11.el6_1.4', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'6'},
    {'reference':'kdelibs-4.3.4-11.el6_1.4', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'6'},
    {'reference':'kdelibs-apidocs-4.3.4-11.el6_1.4', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'6'},
    {'reference':'kdelibs-common-4.3.4-11.el6_1.4', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'6'},
    {'reference':'kdelibs-devel-4.3.4-11.el6_1.4', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'6'}
];
