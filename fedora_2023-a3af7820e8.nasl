...
# extracted from Fedora Security Advisory FEDORA-2023-a3af7820e8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-a3af7820e8");

  script_name(english:"Fedora 40 : python-asyncssh (2023-a3af7820e8)");
...
FEDORA-2023-a3af7820e8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-a3af7820e8");
  script_set_attribute(attribute:"solution", value:
"Update the affected python-asyncssh package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:python-asyncssh");
...
var pkgs = [
    {'reference':'python-asyncssh-2.14.2-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python-asyncssh');
}
