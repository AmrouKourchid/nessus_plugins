...
# SUSE update advisory SUSE-SU-2023:3623-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:3623-1");

  script_name(english:"SUSE SLES15 Security Update : kernel (Live Patch 28 for SLE 15 SP3) (SUSE-SU-2023:3623-1)");
...
the SUSE-SU-2023:3623-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-September/016162.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d799ee3d");
...
"Update the affected kernel-livepatch-5_3_18-150300_59_109-default package.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '5.3.18-150300.59.109-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_3_18-150300_59_109-default-8-150300.2.2', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.3']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kernel-livepatch-5_3_18-150300_59_109-default');
}
