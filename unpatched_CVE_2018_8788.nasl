...
if (description)
{
  ...
  script_cve_id("CVE-2018-8788");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2018-8788");
...
patch available.
  ...
  - FreeRDP prior to version 2.0.0-rc4 contains an Out-Of-Bounds Write of up to 4 bytes in function
    nsc_rle_decode() that results in a memory corruption and possibly even a remote code execution.
    (CVE-2018-8788)
