...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2015/rhsa-2015_2520.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0bfe1696");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2015:2520");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1271070");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL ntp package based on the guidance in RHSA-2015:2520.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-7704");
...
os_ver = os_ver[1];
if (!rhel_check_release_list(operator: 'ge', os_version: os_ver, rhel_versions: ['6.5','6.6'])) audit(AUDIT_OS_NOT, 'Red Hat 6.5 / 6.6', 'Red Hat ' + os_ver);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ntp-4.2.6p5-2.el6_5.1', 'sp':'5', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ntp-4.2.6p5-2.el6_5.1', 'sp':'5', 'cpu':'ppc64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ntp-4.2.6p5-2.el6_5.1', 'sp':'5', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ntp-4.2.6p5-2.el6_5.1', 'sp':'5', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ntp-doc-4.2.6p5-2.el6_5.1', 'sp':'5', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ntp-perl-4.2.6p5-2.el6_5.1', 'sp':'5', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ntp-perl-4.2.6p5-2.el6_5.1', 'sp':'5', 'cpu':'ppc64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ntp-perl-4.2.6p5-2.el6_5.1', 'sp':'5', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ntp-perl-4.2.6p5-2.el6_5.1', 'sp':'5', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ntpdate-4.2.6p5-2.el6_5.1', 'sp':'5', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ntpdate-4.2.6p5-2.el6_5.1', 'sp':'5', 'cpu':'ppc64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ntpdate-4.2.6p5-2.el6_5.1', 'sp':'5', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ntpdate-4.2.6p5-2.el6_5.1', 'sp':'5', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'ntp-4.2.6p5-3.el6_6.1', 'sp':'6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ntp-4.2.6p5-3.el6_6.1', 'sp':'6', 'cpu':'ppc64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ntp-4.2.6p5-3.el6_6.1', 'sp':'6', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ntp-4.2.6p5-3.el6_6.1', 'sp':'6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ntp-doc-4.2.6p5-3.el6_6.1', 'sp':'6', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ntp-perl-4.2.6p5-3.el6_6.1', 'sp':'6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ntp-perl-4.2.6p5-3.el6_6.1', 'sp':'6', 'cpu':'ppc64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ntp-perl-4.2.6p5-3.el6_6.1', 'sp':'6', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ntp-perl-4.2.6p5-3.el6_6.1', 'sp':'6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ntpdate-4.2.6p5-3.el6_6.1', 'sp':'6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ntpdate-4.2.6p5-3.el6_6.1', 'sp':'6', 'cpu':'ppc64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ntpdate-4.2.6p5-3.el6_6.1', 'sp':'6', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ntpdate-4.2.6p5-3.el6_6.1', 'sp':'6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
