...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 ESM : Rsyslog vulnerabilities (USN-5419-1)");
...
the USN-5419-1 advisory.
    ...
    It was discovered that Rsyslog improperly handled certain invalid input. An attacker could use this issue
    to cause Rsyslog to crash.
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'rsyslog', 'pkgver': '8.16.0-1ubuntu3.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'rsyslog-elasticsearch', 'pkgver': '8.16.0-1ubuntu3.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'rsyslog-gnutls', 'pkgver': '8.16.0-1ubuntu3.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'rsyslog-gssapi', 'pkgver': '8.16.0-1ubuntu3.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'rsyslog-mysql', 'pkgver': '8.16.0-1ubuntu3.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'rsyslog-pgsql', 'pkgver': '8.16.0-1ubuntu3.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'rsyslog-relp', 'pkgver': '8.16.0-1ubuntu3.1+esm1', 'ubuntu_pro': TRUE}
];
