...
# extracted from Oracle Linux Security Advisory ELSA-2024-3846.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : python-idna (ELSA-2024-3846)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-3846.html");
...
"Update the affected python3-idna package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:python3-idna");
...
var pkgs = [
    {'reference':'python3-idna-2.10-7.0.1.el9_4.1', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
