...
# extracted from Red Hat Security Advisory RHSA-2024:4430. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:4430");

  script_name(english:"RHEL 9 : perl-HTTP-Tiny (RHSA-2024:4430)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_4430.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?003895c6");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2228392");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:4430");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL perl-HTTP-Tiny package based on the guidance in RHSA-2024:4430.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'perl-HTTP-Tiny-0.076-461.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
