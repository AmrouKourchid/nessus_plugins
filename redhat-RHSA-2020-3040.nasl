...
# extracted from Red Hat Security Advisory RHSA-2020:3040. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:3040");

  script_name(english:"RHEL 8 : virt:rhel (RHSA-2020:3040)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for virt:rhel.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2020:3040 advisory.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2020/rhsa-2020_3040.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?72ceda4a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:3040");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1798453");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL virt:rhel package based on the guidance in RHSA-2020:3040.");
  ...
  'virt:rhel': [
    {
      ...
      'pkgs': [
        ...
        {'reference':'qemu-guest-agent-2.12.0-65.module+el8.0.0+6773+b9ea63f3.8', 'sp':'0', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-guest-agent-2.12.0-65.module+el8.0.0+6773+b9ea63f3.8', 'sp':'0', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-img-2.12.0-65.module+el8.0.0+6773+b9ea63f3.8', 'sp':'0', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-img-2.12.0-65.module+el8.0.0+6773+b9ea63f3.8', 'sp':'0', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-2.12.0-65.module+el8.0.0+6773+b9ea63f3.8', 'sp':'0', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-2.12.0-65.module+el8.0.0+6773+b9ea63f3.8', 'sp':'0', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-block-curl-2.12.0-65.module+el8.0.0+6773+b9ea63f3.8', 'sp':'0', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-block-curl-2.12.0-65.module+el8.0.0+6773+b9ea63f3.8', 'sp':'0', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-block-gluster-2.12.0-65.module+el8.0.0+6773+b9ea63f3.8', 'sp':'0', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-block-iscsi-2.12.0-65.module+el8.0.0+6773+b9ea63f3.8', 'sp':'0', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-block-iscsi-2.12.0-65.module+el8.0.0+6773+b9ea63f3.8', 'sp':'0', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-block-rbd-2.12.0-65.module+el8.0.0+6773+b9ea63f3.8', 'sp':'0', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-block-rbd-2.12.0-65.module+el8.0.0+6773+b9ea63f3.8', 'sp':'0', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-block-ssh-2.12.0-65.module+el8.0.0+6773+b9ea63f3.8', 'sp':'0', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-block-ssh-2.12.0-65.module+el8.0.0+6773+b9ea63f3.8', 'sp':'0', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-common-2.12.0-65.module+el8.0.0+6773+b9ea63f3.8', 'sp':'0', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-common-2.12.0-65.module+el8.0.0+6773+b9ea63f3.8', 'sp':'0', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-core-2.12.0-65.module+el8.0.0+6773+b9ea63f3.8', 'sp':'0', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-core-2.12.0-65.module+el8.0.0+6773+b9ea63f3.8', 'sp':'0', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
