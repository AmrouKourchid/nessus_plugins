...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.0 : gzip (EulerOS-SA-2022-2382)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the gzip package installed, the EulerOS Virtualization installation on the remote host is
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2382
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b28173eb");
