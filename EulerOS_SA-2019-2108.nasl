...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : libtiff (EulerOS-SA-2019-2108)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2108
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6bab1b22");
...
pkgs = ["libtiff-4.0.9-11.h7.eulerosv2r8",
        "libtiff-devel-4.0.9-11.h7.eulerosv2r8"];
