...
# extracted from Red Hat Security Advisory RHSA-2024:0452. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:0452");
  script_xref(name:"IAVA", value:"2023-A-0674-S");

  script_name(english:"RHEL 9 : curl (RHSA-2024:0452)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0452.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?218c8c5b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2252030");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-20618");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0452");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL curl package based on the guidance in RHSA-2024:0452.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'curl-7.76.1-23.el9_2.6', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'curl-minimal-7.76.1-23.el9_2.6', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libcurl-7.76.1-23.el9_2.6', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libcurl-devel-7.76.1-23.el9_2.6', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libcurl-minimal-7.76.1-23.el9_2.6', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
