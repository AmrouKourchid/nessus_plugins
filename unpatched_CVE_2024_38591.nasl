...
if (description)
{
  ...
  script_cve_id("CVE-2024-38591");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-38591");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: RDMA/hns: Fix deadlock on SRQ async
    events. xa_lock for SRQ table may be required in AEQ. Use xa_store_irq()/ xa_erase_irq() to avoid
    deadlock. (CVE-2024-38591)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-38591");
