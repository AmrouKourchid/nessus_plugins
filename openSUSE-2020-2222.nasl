...
Update to upstream release 4.1.22 :
  ...
  - Fix buffer size warnings from compiler on filename
    lengths.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1157331");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1179191");
  script_set_attribute(attribute:"see_also", value:"https://nlnetlabs.nl/people/");
  script_set_attribute(attribute:"solution", value:
"Update the affected nsd packages.");
