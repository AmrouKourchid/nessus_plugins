...
# extracted from Fedora Security Advisory FEDORA-2019-e08f78d4a6.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : SDL (2019-e08f78d4a6)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"This release fixes a heap buffer over-read in BlitNtoN() function when
processing an invalid BMP image. It also updates a URL in the RPM
metadata.
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-e08f78d4a6");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"SDL-1.2.15-40.fc29")) flag++;
