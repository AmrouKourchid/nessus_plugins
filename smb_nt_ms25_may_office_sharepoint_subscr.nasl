...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5002709");
  script_xref(name:"MSFT", value:"MS25-5002709");

  script_name(english:"Security Updates for Microsoft SharePoint Server Subscription Edition (May 2025)");
...
security updates. It is, therefore, affected by multiple vulnerabilities:
  ...
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002709");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released KB5002709 to address this issue.");
