...
# extracted from Fedora Security Advisory FEDORA-2024-091e2c7801
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-091e2c7801");

  script_name(english:"Fedora 41 : python3.6 (2024-091e2c7801)");
...
FEDORA-2024-091e2c7801 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-091e2c7801");
...
var pkgs = [
    {'reference':'python3.6-3.6.15-37.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
