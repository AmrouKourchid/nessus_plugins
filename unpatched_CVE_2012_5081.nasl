...
if (description)
{
  ...
  script_cve_id("CVE-2012-5081");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2012-5081");
...
patch available.
  ...
  - Unspecified vulnerability in the Java Runtime Environment (JRE) component in Oracle Java SE 7 Update 7 and
    ...
    attackers to affect availability, related to JSSE. (CVE-2012-5081)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2012-5081");
