...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : shim (EulerOS-SA-2024-2489)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2489
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cfb8c3af");
...
var pkgs = [
  "shim-aa64-15-7.h15.eulerosv2r8"
];
