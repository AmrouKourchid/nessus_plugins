...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.2.0 : vim (EulerOS-SA-2019-1699)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1699
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?13ab1d8e");
...
pkgs = ["vim-common-7.4.160-4.h5",
        "vim-enhanced-7.4.160-4.h5",
        "vim-filesystem-7.4.160-4.h5",
        "vim-minimal-7.4.160-4.h5"];
