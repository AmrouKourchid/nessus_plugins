...
# extracted from Red Hat Security Advisory RHSA-2024:8884. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:8884");

  script_name(english:"RHEL 8 : Red Hat Product OCP Tools 4.15 Openshift Jenkins (RHSA-2024:8884)");
...
referenced in the RHSA-2024:8884 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_8884.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?16d41acc");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:8884");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat Product OCP Tools 4.15 Openshift Jenkins package based on the guidance in RHSA-2024:8884.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jenkins-2-plugins-4.15.1729838165-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'jenkins-2.462.3.1729837947-3.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
