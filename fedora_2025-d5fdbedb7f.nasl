...
# extracted from Fedora Security Advisory FEDORA-2025-d5fdbedb7f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-d5fdbedb7f");

  script_name(english:"Fedora 40 : rpki-client (2025-d5fdbedb7f)");
...
FEDORA-2025-d5fdbedb7f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-d5fdbedb7f");
...
var pkgs = [
    {'reference':'rpki-client-9.5-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
