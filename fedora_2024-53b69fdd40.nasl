...
# extracted from Fedora Security Advisory FEDORA-2024-53b69fdd40
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-53b69fdd40");

  script_name(english:"Fedora 38 : emacs (2024-53b69fdd40)");
...
FEDORA-2024-53b69fdd40 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-53b69fdd40");
...
var pkgs = [
    {'reference':'emacs-29.3-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
