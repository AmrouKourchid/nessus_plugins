...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.1 : openssl (EulerOS-SA-2023-3364)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3364
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d094e540");
...
var pkgs = [
  "openssl-1.1.1m-2.h31.eulerosv2r11",
  "openssl-libs-1.1.1m-2.h31.eulerosv2r11",
  "openssl-perl-1.1.1m-2.h31.eulerosv2r11"
];
