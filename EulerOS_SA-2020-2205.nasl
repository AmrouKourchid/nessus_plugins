...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.2 : nss (EulerOS-SA-2020-2205)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2205
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9d57ab5d");
...
pkgs = ["nss-3.36.0-8.h4.eulerosv2r7",
        "nss-softokn-3.36.0-5.h8.eulerosv2r7",
        "nss-softokn-freebl-3.36.0-5.h8.eulerosv2r7",
        "nss-sysinit-3.36.0-8.h4.eulerosv2r7",
        "nss-tools-3.36.0-8.h4.eulerosv2r7",
        "nss-util-3.36.0-1.eulerosv2r7"];
