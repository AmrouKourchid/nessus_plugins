...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : e2fsprogs (EulerOS-SA-2020-1098)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1098
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5fb1ba9e");
...
pkgs = ["e2fsprogs-1.45.3-1.h2.eulerosv2r7",
        "e2fsprogs-devel-1.45.3-1.h2.eulerosv2r7",
        "e2fsprogs-libs-1.45.3-1.h2.eulerosv2r7",
        "libcom_err-1.45.3-1.h2.eulerosv2r7",
        "libcom_err-devel-1.45.3-1.h2.eulerosv2r7",
        "libss-1.45.3-1.h2.eulerosv2r7"];
