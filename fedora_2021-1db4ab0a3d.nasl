...
# extracted from Fedora Security Advisory FEDORA-2021-1db4ab0a3d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-1db4ab0a3d");

  script_name(english:"Fedora 32 : kernel / kernel-headers / kernel-tools (2021-1db4ab0a3d)");
...
FEDORA-2021-1db4ab0a3d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-1db4ab0a3d");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for FEDORA-2021-1db4ab0a3d');
  }
  else
  {
...
pkgs = [
    {'reference':'kernel-5.10.20-100.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kernel-headers-5.10.20-100.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kernel-tools-5.10.20-100.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE}
];
