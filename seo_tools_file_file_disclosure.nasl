...
privileges under which the web server operates.");
  # https://plugins.trac.wordpress.org/changeset/518509/seo-automatic-seo-tools
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8687c8cf");
  script_set_attribute(attribute:"see_also", value:"https://wordpress.org/plugins/seo-automatic-seo-tools/#changelog");
