...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP13 : openssl (EulerOS-SA-2025-1338)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1338
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fc70f793");
...
var pkgs = [
  "openssl-1.1.1wa-2.h24.eulerosv2r13",
  "openssl-libs-1.1.1wa-2.h24.eulerosv2r13",
  "openssl-perl-1.1.1wa-2.h24.eulerosv2r13"
];
