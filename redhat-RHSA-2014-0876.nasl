...
# extracted from Red Hat Security Advisory RHSA-2014:0876. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2014:0876");

  script_name(english:"RHEL 6 / 7 : ruby193-rubygem-activerecord (RHSA-2014:0876)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for ruby193-rubygem-activerecord.");
...
in the RHSA-2014:0876 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1114425");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2014/rhsa-2014_0876.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6068e641");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2014:0876");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL ruby193-rubygem-activerecord package based on the guidance in RHSA-2014:0876.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-3482");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ruby193-rubygem-activerecord-3.2.8-8.2.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'ruby193-rubygem-activerecord-doc-3.2.8-8.2.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'ruby193-rubygem-activerecord-3.2.8-8.2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'ruby193-rubygem-activerecord-doc-3.2.8-8.2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
