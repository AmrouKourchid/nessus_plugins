...
affected by a vulnerability as referenced in the K40582331 advisory.
    ...
    hypothetically be affected.(CVE-2022-28615)ImpactVery large input to theap_strcmp_matchfunction can lead
    to an integer overflow and result in an out-of-bounds read. Integer overflow or wraparound may lead to
