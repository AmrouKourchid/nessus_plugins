...
# Red Hat Security Advisory RHSA-2019:1764. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : firefox (CESA-2019:1764)");
...
pkgs = [
    {'reference':'firefox-60.8.0-1.el8_0', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-60.8.0-1.el8_0', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
