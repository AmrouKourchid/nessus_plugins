...
# extracted from Gentoo Linux Security Advisory GLSA 201903-09.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201903-09");

  script_name(english:"GLSA-201903-09 : GNU C Library: Arbitrary descriptor allocation");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-201903-09
...
Impact :
    ...
    A remote attacker, by sending a crafted UDP packet, could cause a Denial
      of Service condition.
  
Workaround :

    There is no known workaround at this time.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/201903-09");
...
if (qpkg_check(package:"sys-libs/glibc", unaffected:make_list("ge 2.26.0"), vulnerable:make_list("lt 2.26.0"))) flag++;
