...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.2 : libtasn1 (EulerOS-SA-2019-1017)");
...
the following vulnerability :
  ...
  - The _asn1_check_identifier function in GNU Libtasn1
    ...
    attack.i1/4^CVE-2017-10790i1/4%0

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1017
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?636f8e51");
