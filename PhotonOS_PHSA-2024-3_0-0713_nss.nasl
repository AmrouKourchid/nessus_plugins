...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Nss PHSA-2024-3.0-0713");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'nss-3.44-12.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'nss-devel-3.44-12.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'nss-libs-3.44-12.ph3')) flag++;
