...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : mailman on SL6.x i386/x86_64 (20180313)");
...
"Security Fix(es) :
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ef3cc4e0");
...
flag = 0;
if (rpm_check(release:"SL6", reference:"mailman-2.1.12-26.el6_9.3")) flag++;
if (rpm_check(release:"SL6", reference:"mailman-debuginfo-2.1.12-26.el6_9.3")) flag++;
