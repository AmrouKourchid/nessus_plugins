...
# extracted from Red Hat Security Advisory RHSA-2019:2746. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:2746");
  script_xref(name:"CEA-ID", value:"CEA-2019-0643");

  script_name(english:"RHEL 7 : rh-nginx112-nginx (RHSA-2019:2746)");
...
referenced in the RHSA-2019:2746 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_2746.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cfe0f9eb");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:2746");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rh-nginx112-nginx package based on the guidance in RHSA-2019:2746.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-nginx112-nginx-1.12.1-3.el7.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'rh-nginx112-nginx-mod-http-image-filter-1.12.1-3.el7.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'rh-nginx112-nginx-mod-http-perl-1.12.1-3.el7.1', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'rh-nginx112-nginx-mod-http-xslt-filter-1.12.1-3.el7.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'rh-nginx112-nginx-mod-mail-1.12.1-3.el7.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'rh-nginx112-nginx-mod-stream-1.12.1-3.el7.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
