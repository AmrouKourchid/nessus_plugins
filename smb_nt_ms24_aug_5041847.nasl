...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5041847");
  script_xref(name:"MSFT", value:"MS24-5041847");
  ...
  script_name(english:"KB5041847: Windows Server 2008 Security Update (August 2024)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5041847. It is, therefore, affected by multiple vulnerabilities
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5041847");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5041847");
