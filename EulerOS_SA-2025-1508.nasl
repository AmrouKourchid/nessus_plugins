...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : freetype (EulerOS-SA-2025-1508)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the freetype package installed, the EulerOS installation on the remote host is affected by
the following vulnerabilities :
    ...
    vulnerability may have been exploited in the wild.(CVE-2025-27363)

Tenable has extracted the preceding description block directly from the EulerOS freetype security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1508
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?270202ac");
...
var pkgs = [
  "freetype-2.10.2-2.h6.eulerosv2r10"
];
