...
# extracted from VMware Security Advisory PHSA-2021-1.0-0431. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Dnsmasq PHSA-2021-1.0-0431");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-1.0-431.md");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'dnsmasq-2.85-1.ph1')) flag++;
