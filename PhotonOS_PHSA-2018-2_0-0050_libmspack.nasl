...
if (description)
{
  ...
  script_cve_id("CVE-2017-6419");

  script_name(english:"Photon OS 2.0: Libmspack PHSA-2018-2.0-0050");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libmspack-0.5alpha-4.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libmspack-debuginfo-0.5alpha-4.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libmspack-devel-0.5alpha-4.ph2')) flag++;
