...
# extracted from Fedora Security Advisory FEDORA-2023-d577604e6a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-d577604e6a");

  script_name(english:"Fedora 39 : python3.12 (2023-d577604e6a)");
...
FEDORA-2023-d577604e6a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-d577604e6a");
...
var pkgs = [
    {'reference':'python3.12-3.12.1-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
