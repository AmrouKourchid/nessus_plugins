...
# extracted from Fedora Security Advisory FEDORA-2019-97e9040197.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-97e9040197");

  script_name(english:"Fedora 30 : hostapd (2019-97e9040197)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-97e9040197");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"hostapd-2.9-1.fc30")) flag++;
