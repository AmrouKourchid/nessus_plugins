...
if (description)
{
  ...
  script_cve_id("CVE-2022-40964");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-40964");
...
patch available.
  ...
  - Improper access control for some Intel(R) PROSet/Wireless WiFi and Killer(TM) WiFi software may allow a
    privileged user to potentially enable escalation of privilege via local access. (CVE-2022-40964)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-40964");
