...
# extracted from Debian Security Advisory dla-3218. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3218 : libpostgresql-jdbc-java - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3218
advisory.

    - -----------------------------------------------------------------------
    Debian LTS Advisory DLA-3218-1              debian-lts@lists.debian.org
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-41946");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/libpgjava");
  script_set_attribute(attribute:"solution", value:
"Upgrade the libpostgresql-jdbc-java packages.");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libpostgresql-jdbc-java', 'reference': '42.2.5-2+deb10u3'},
    {'release': '10.0', 'prefix': 'libpostgresql-jdbc-java-doc', 'reference': '42.2.5-2+deb10u3'}
];
