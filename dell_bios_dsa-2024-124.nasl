...
if (description)
{
  ...
  script_cve_id("CVE-2024-32858", "CVE-2024-32859");
  script_xref(name:"IAVA", value:"2024-A-0360");

  script_name(english:"Dell Client BIOS Multiple Vulnerabilities (DSA-2024-124)");

  script_set_attribute(attribute:"synopsis", value:
"The remote device is missing a vendor-supplied security patch");
  script_set_attribute(attribute:"description", value:
"Dell Client Platform BIOS contains multiple Improper Input Validation vulnerabilities in an externally developed
...
number.");
  # https://www.dell.com/support/kbdoc/en-us/000223439/dsa-2024-124-security-update-for-dell-client-platform-bios-for-multiple-improper-input-validation-vulnerabilities
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?457c955a");
...
"Apply the security patch in accordance with the vendor advisory.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-32859");
...
if (model)
{
  ...
  else if (model == 'Alienware Aurora R10') fix = '2.8.0';
