...
# extracted from Gentoo Linux Security Advisory GLSA 202101-35.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202101-35");

  script_name(english:"GLSA-202101-35 : phpMyAdmin: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202101-35
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202101-35");
...
if (qpkg_check(package:"dev-db/phpmyadmin", unaffected:make_list("ge 4.9.6"), vulnerable:make_list("lt 4.9.6"))) flag++;
