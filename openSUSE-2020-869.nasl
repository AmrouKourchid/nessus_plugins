...
# extracted from openSUSE Security Update openSUSE-2020-869.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : mercurial (openSUSE-2020-869)");
...
if ( rpm_check(release:"SUSE15.1", reference:"mercurial-4.5.2-lp151.6.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"mercurial-debuginfo-4.5.2-lp151.6.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"mercurial-debugsource-4.5.2-lp151.6.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"mercurial-lang-4.5.2-lp151.6.3.1") ) flag++;
