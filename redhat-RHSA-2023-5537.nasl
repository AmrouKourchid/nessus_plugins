...
# extracted from Red Hat Security Advisory RHSA-2023:5537. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:5537");

  script_name(english:"RHEL 8 : libvpx (RHSA-2023:5537)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for libvpx.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2023:5537 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_5537.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7bdb94a8");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:5537");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libvpx package based on the guidance in RHSA-2023:5537.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libvpx-1.7.0-10.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvpx-devel-1.7.0-10.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'libvpx-1.7.0-10.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvpx-devel-1.7.0-10.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
