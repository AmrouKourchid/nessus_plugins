...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Etcd PHSA-2019-3.0-0036");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'etcd-3.3.13-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'etcd-debuginfo-3.3.13-1.ph3')) flag++;
