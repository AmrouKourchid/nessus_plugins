...
# extracted from Debian Security Advisory dla-4002. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-4002 : intel-microcode - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-21820");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-21853");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-23918");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'intel-microcode', 'reference': '3.20241112.1~deb11u1'}
];
