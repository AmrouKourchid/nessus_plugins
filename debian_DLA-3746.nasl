...
# extracted from Debian Security Advisory dla-3746. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3746 : libwireshark-data - security update");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libwireshark-data', 'reference': '2.6.20-0+deb10u8'},
    {'release': '10.0', 'prefix': 'libwireshark-dev', 'reference': '2.6.20-0+deb10u8'},
    {'release': '10.0', 'prefix': 'libwireshark11', 'reference': '2.6.20-0+deb10u8'},
    {'release': '10.0', 'prefix': 'libwiretap-dev', 'reference': '2.6.20-0+deb10u8'},
    {'release': '10.0', 'prefix': 'libwiretap8', 'reference': '2.6.20-0+deb10u8'},
    {'release': '10.0', 'prefix': 'libwscodecs2', 'reference': '2.6.20-0+deb10u8'},
    {'release': '10.0', 'prefix': 'libwsutil-dev', 'reference': '2.6.20-0+deb10u8'},
    {'release': '10.0', 'prefix': 'libwsutil9', 'reference': '2.6.20-0+deb10u8'},
    {'release': '10.0', 'prefix': 'tshark', 'reference': '2.6.20-0+deb10u8'},
    {'release': '10.0', 'prefix': 'wireshark', 'reference': '2.6.20-0+deb10u8'},
    {'release': '10.0', 'prefix': 'wireshark-common', 'reference': '2.6.20-0+deb10u8'},
    {'release': '10.0', 'prefix': 'wireshark-dev', 'reference': '2.6.20-0+deb10u8'},
    {'release': '10.0', 'prefix': 'wireshark-doc', 'reference': '2.6.20-0+deb10u8'},
    {'release': '10.0', 'prefix': 'wireshark-gtk', 'reference': '2.6.20-0+deb10u8'},
    {'release': '10.0', 'prefix': 'wireshark-qt', 'reference': '2.6.20-0+deb10u8'}
];
