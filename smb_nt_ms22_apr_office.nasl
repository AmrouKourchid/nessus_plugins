...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5002143");
  script_xref(name:"MSKB", value:"5002148");
  script_xref(name:"MSFT", value:"MS22-5002143");
  script_xref(name:"MSFT", value:"MS22-5002148");
  script_xref(name:"IAVA", value:"2022-A-0144-S");

  script_name(english:"Security Updates for Microsoft Office Products (April 2022)");
...
It is, therefore, affected by the following vulnerability:
  ...
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002143");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002148");
...
if (office_vers['16.0'])
{
  ...
  if (!isnull(office_sp) && office_sp == 0)
  {
    ...
    # MSI graph.exe
    if (hotfix_check_fversion(file:'graph.exe', version:'16.0.5305.1000', channel:'MSI', channel_product:'Office', path:path, kb:'5002143', bulletin:bulletin, product:prod) == HCF_OLDER)
      vuln = TRUE;
  }
}
