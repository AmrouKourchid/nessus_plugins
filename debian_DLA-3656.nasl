...
# extracted from Debian Security Advisory dla-3656. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3656 : libnetty-java - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has a package installed that is affected by a vulnerability as referenced in the dla-3656
advisory.

    -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3656-1                debian-lts@lists.debian.org
    https://www.debian.org/lts/security/                      Markus Koschany
    November 19, 2023                             https://wiki.debian.org/LTS
    -------------------------------------------------------------------------

    Package        : netty
    Version        : 1:4.1.33-1+deb10u4
...
"Upgrade the libnetty-java packages.");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libnetty-java', 'reference': '1:4.1.33-1+deb10u4'}
];
