...
# extracted from Fedora Security Advisory FEDORA-2023-19b796e348
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-19b796e348");

  script_name(english:"Fedora 40 : libcaca (2023-19b796e348)");
...
FEDORA-2023-19b796e348 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-19b796e348");
...
"Update the affected libcaca package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:libcaca");
...
var pkgs = [
    {'reference':'libcaca-0.99-0.69.beta20.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
