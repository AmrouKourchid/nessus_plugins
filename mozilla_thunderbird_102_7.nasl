...
"The version of Thunderbird installed on the remote Windows host is prior to 102.7. It is, therefore, affected by
multiple vulnerabilities as referenced in the mfsa2023-03 advisory.
...
mozilla_check_version(installs:installs, product:'thunderbird', esr:FALSE, fix:'102.7', severity:SECURITY_HOLE);
