...
# extracted from Fedora Security Advisory FEDORA-2023-2df9d60e4c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-2df9d60e4c");

  script_name(english:"Fedora 37 : pack (2023-2df9d60e4c)");
...
FEDORA-2023-2df9d60e4c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-2df9d60e4c");
...
var pkgs = [
    {'reference':'pack-0.29.0~rc1-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
