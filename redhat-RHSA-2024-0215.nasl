...
# extracted from Red Hat Security Advisory RHSA-2024:0215. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:0215");

  script_name(english:"RHEL 9 : Red Hat OpenStack Platform 17.1 (GitPython) (RHSA-2024:0215)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0215.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?316c6139");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2247040");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0215");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat OpenStack Platform 17.1 (GitPython) package based on the guidance in RHSA-2024:0215.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-GitPython-3.1.14-2.el9ost', 'release':'9', 'el_string':'el9ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
