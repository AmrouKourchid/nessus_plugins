...
# Oracle Linux Security Advisory ELSA-2015-0642 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : thunderbird (ELSA-2015-0642)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2015-0642.html");
...
var pkgs = [
    {'reference':'thunderbird-31.5.0-2.el7_1', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
