...
if (description)
{
  ...
  script_name(english:"RHEL 4 : gtk2 (RHSA-2005:344)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for gtk2.");
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2005/rhsa-2005_344.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7780aa92");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=152317");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2005:344");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL gtk2 package based on the guidance in RHSA-2005:344.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gtk2-2.4.13-14', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gtk2-2.4.13-14', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gtk2-2.4.13-14', 'cpu':'ppc64', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gtk2-2.4.13-14', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gtk2-2.4.13-14', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gtk2-2.4.13-14', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gtk2-devel-2.4.13-14', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gtk2-devel-2.4.13-14', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gtk2-devel-2.4.13-14', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gtk2-devel-2.4.13-14', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gtk2-devel-2.4.13-14', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
