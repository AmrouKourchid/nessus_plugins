...
# extracted from Fedora Security Advisory FEDORA-2019-a268ba7b23.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-a268ba7b23");

  script_name(english:"Fedora 31 : python36 (2019-a268ba7b23)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-a268ba7b23");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"python36-3.6.10-1.fc31")) flag++;
