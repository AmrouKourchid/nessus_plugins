...
# extracted from Fedora Security Advisory FEDORA-2023-b645c7feda
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-b645c7feda");

  script_name(english:"Fedora 37 : awstats (2023-b645c7feda)");
...
FEDORA-2023-b645c7feda advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-b645c7feda");
...
var pkgs = [
    {'reference':'awstats-7.8-9.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
