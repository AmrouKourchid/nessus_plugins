...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'haproxy-1.6.10-1.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'haproxy-debuginfo-1.6.10-1.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'haproxy-doc-1.6.10-1.ph1')) flag++;
