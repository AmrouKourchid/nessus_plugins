...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : libpng (EulerOS-SA-2019-1912)");
...
vulnerability :
  ...
  - libpng before 1.6.32 does not properly check the length
    of chunks against the user limit.(CVE-2017-12652)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1912
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4eb71df7");
...
pkgs = ["libpng-1.5.13-7.1.h4.eulerosv2r7",
        "libpng-devel-1.5.13-7.1.h4.eulerosv2r7"];
