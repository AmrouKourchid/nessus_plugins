...
if (description)
{
  ...
  script_cve_id("CVE-2024-49041");
  script_xref(name:"IAVA", value:"2024-A-0805-S");

  script_name(english:"Microsoft Edge (Chromium) < 131.0.2903.86 (CVE-2024-49041)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host has an web browser installed that is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Microsoft Edge installed on the remote Windows host is prior to 131.0.2903.86. It is, therefore, affected
by a vulnerability as referenced in the December 5, 2024 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?34e2bd22");
  script_set_attribute(attribute:"see_also", value:"https://msrc.microsoft.com/update-guide/vulnerability/CVE-2024-49041");
...
"Upgrade to Microsoft Edge version 131.0.2903.86 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-49041");
