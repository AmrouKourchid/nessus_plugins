...
# extracted from Red Hat Security Advisory RHSA-2020:1544. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:1544");
  script_xref(name:"IAVB", value:"2020-B-0016-S");
  script_xref(name:"IAVB", value:"2019-B-0092-S");

  script_name(english:"RHEL 7 : Ansible security update (2.7.17) (Important) (RHSA-2020:1544)");
...
referenced in the RHSA-2020:1544 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_1544.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e3f60352");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:1544");
...
"Update the RHEL Ansible package based on the guidance in RHSA-2020:1544.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ansible-2.7.17-1.el7ae', 'release':'7', 'el_string':'el7ae', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2.7'}
    ]
  }
];
