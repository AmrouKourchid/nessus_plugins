...
# extracted from Red Hat Security Advisory RHSA-2020:0921. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_0921.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c3cc7e2e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:0921");
...
"Update the RHEL libvncserver package based on the guidance in RHSA-2020:0921.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libvncserver-0.9.11-9.el8_0.2', 'sp':'0', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvncserver-0.9.11-9.el8_0.2', 'sp':'0', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvncserver-0.9.11-9.el8_0.2', 'sp':'0', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
