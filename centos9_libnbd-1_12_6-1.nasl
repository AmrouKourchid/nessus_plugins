...
if (description)
{
  ...
  script_name(english:"CentOS 9 : libnbd-1.12.6-1.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update for libnbd.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 9 host has packages installed that are affected by a vulnerability as referenced in the
libnbd-1.12.6-1.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=23976");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream libnbd package.");
...
var pkgs = [
    {'reference':'libnbd-1.12.6-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libnbd-bash-completion-1.12.6-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libnbd-devel-1.12.6-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'nbdfuse-1.12.6-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ocaml-libnbd-1.12.6-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ocaml-libnbd-devel-1.12.6-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-libnbd-1.12.6-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
