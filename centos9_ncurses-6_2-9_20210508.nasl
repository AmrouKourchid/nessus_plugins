...
if (description)
{
  ...
  script_name(english:"CentOS 9 : ncurses-6.2-9.20210508.el9");
...
ncurses-6.2-9.20210508.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=36421");
...
var pkgs = [
    {'reference':'ncurses-6.2-9.20210508.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ncurses-base-6.2-9.20210508.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ncurses-c++-libs-6.2-9.20210508.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ncurses-compat-libs-6.2-9.20210508.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ncurses-devel-6.2-9.20210508.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ncurses-libs-6.2-9.20210508.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ncurses-static-6.2-9.20210508.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ncurses-term-6.2-9.20210508.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
