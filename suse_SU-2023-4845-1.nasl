...
# SUSE update advisory SUSE-SU-2023:4845-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:4845-1");

  script_name(english:"SUSE SLES12 / SLES15 Security Update : kernel (Live Patch 38 for SLE 15 SP3) (SUSE-SU-2023:4845-1)");
...
the SUSE-SU-2023:4845-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-December/017354.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?033d4d4c");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2023-1829");
  script_set_attribute(attribute:"solution", value:
"Update the affected kernel-livepatch-5_3_18-150300_59_141-default and / or kgraft-patch-4_12_14-122_183-default
packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:suse_linux:kgraft-patch-4_12_14-122_183-default");
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-122.183-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_12_14-122_183-default-2-2.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.5']}
        ]
      },
      '5.3.18-150300.59.141-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_3_18-150300_59_141-default-2-150300.2.1', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.3']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kernel-livepatch-5_3_18-150300_59_141-default / etc');
}
