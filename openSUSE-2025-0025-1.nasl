...
# openSUSE Security Update openSUSE-SU-2025:0025-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : cheat (openSUSE-SU-2025:0025-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1234584");
  # https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/V7MPKXR7TT2G72ERR2OMAC2SJ3BTV5F6/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1d27a426");
...
"Update the affected cheat package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:cheat");
...
var pkgs = [
    {'reference':'cheat-4.4.2-bp156.3.3.1', 'release':'SUSE15.6', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'cheat');
}
