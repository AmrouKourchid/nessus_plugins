...
# extracted from Ubuntu Security Notice USN-5964-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5964-2");
  script_xref(name:"IAVA", value:"2023-A-0153-S");

  script_name(english:"Ubuntu 16.04 ESM : curl vulnerabilities (USN-5964-2)");
...
the USN-5964-2 advisory.

    USN-5964-1 fixed several vulnerabilities in curl. This update provides the corresponding update for Ubuntu
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5964-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'curl', 'pkgver': '7.47.0-1ubuntu2.19+esm8', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libcurl3', 'pkgver': '7.47.0-1ubuntu2.19+esm8', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libcurl3-gnutls', 'pkgver': '7.47.0-1ubuntu2.19+esm8', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libcurl3-nss', 'pkgver': '7.47.0-1ubuntu2.19+esm8', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libcurl4-gnutls-dev', 'pkgver': '7.47.0-1ubuntu2.19+esm8', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libcurl4-nss-dev', 'pkgver': '7.47.0-1ubuntu2.19+esm8', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libcurl4-openssl-dev', 'pkgver': '7.47.0-1ubuntu2.19+esm8', 'ubuntu_pro': TRUE}
];
