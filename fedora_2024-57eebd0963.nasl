...
# extracted from Fedora Security Advisory FEDORA-2024-57eebd0963
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-57eebd0963");

  script_name(english:"Fedora 40 : sudo (2024-57eebd0963)");
...
FEDORA-2024-57eebd0963 advisory.

    Automatic update for sudo-1.9.15-1.p5.fc40.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-57eebd0963");
...
var pkgs = [
    {'reference':'sudo-1.9.15-1.p5.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
