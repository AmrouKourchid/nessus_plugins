...
# AlmaLinux Security Advisory ALSA-2023:5435.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:5435");
  ...
  script_name(english:"AlmaLinux 9 : thunderbird (ALSA-2023:5435)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2023-5435.html");
...
var pkgs = [
    {'reference':'thunderbird-115.3.1-1.el9_2.alma.plus', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'thunderbird-115.3.1-1.el9_2.alma.plus', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
