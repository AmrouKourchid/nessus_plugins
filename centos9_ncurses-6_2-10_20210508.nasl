...
if (description)
{
  ...
  script_name(english:"CentOS 9 : ncurses-6.2-10.20210508.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update for ncurses.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 9 host has packages installed that are affected by a vulnerability as referenced in the
ncurses-6.2-10.20210508.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=36560");
...
var pkgs = [
    ...
    {'reference':'ncurses-compat-libs-6.2-10.20210508.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'ncurses-static-6.2-10.20210508.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
