...
# extracted from Fedora Security Advisory FEDORA-2023-4576748282
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-4576748282");

  script_name(english:"Fedora 37 : clamav (2023-4576748282)");
...
FEDORA-2023-4576748282 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-4576748282");
...
var pkgs = [
    {'reference':'clamav-0.103.10-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
