...
# extracted from Fedora Security Advisory FEDORA-2025-34421311f4
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-34421311f4");

  script_name(english:"Fedora 40 : libxmp (2025-34421311f4)");
...
FEDORA-2025-34421311f4 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-34421311f4");
...
var pkgs = [
    {'reference':'libxmp-4.6.2-3.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
