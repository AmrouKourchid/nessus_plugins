...
# extracted from VMware Security Advisory PHSA-2024-4.0-0587. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Tcpdump PHSA-2024-4.0-0587");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the tcpdump package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-587.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'tcpdump-4.99.4-2.ph4')) flag++;
