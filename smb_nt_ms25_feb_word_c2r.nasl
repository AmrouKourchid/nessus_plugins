...
if (description)
{
  ...
  script_cve_id("CVE-2025-21363", "CVE-2025-21397");
  script_xref(name:"IAVA", value:"2025-A-0105");

  script_name(english:"Security Updates for Microsoft Word Products C2R (February 2025)");
...
manually perform an update.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-21397");
