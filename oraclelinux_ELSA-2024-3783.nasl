...
# extracted from Oracle Linux Security Advisory ELSA-2024-3783.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : firefox (ELSA-2024-3783)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-3783.html");
...
var pkgs = [
    {'reference':'firefox-115.11.0-1.0.1.el8_10', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-115.11.0-1.0.1.el8_10', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
