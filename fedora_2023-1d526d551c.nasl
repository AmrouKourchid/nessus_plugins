...
# extracted from Fedora Security Advisory FEDORA-2023-1d526d551c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-1d526d551c");
  script_xref(name:"IAVA", value:"2023-A-0320-S");

  script_name(english:"Fedora 37 : bind / bind-dyndb-ldap (2023-1d526d551c)");
...
FEDORA-2023-1d526d551c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-1d526d551c");
...
var pkgs = [
    {'reference':'bind-9.18.16-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
    {'reference':'bind-dyndb-ldap-11.10-15.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
