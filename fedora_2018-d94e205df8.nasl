...
# extracted from Fedora Security Advisory FEDORA-2018-d94e205df8.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 26 : wavpack (2018-d94e205df8)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-d94e205df8");
...
"Update the affected wavpack package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-7253");
...
flag = 0;
if (rpm_check(release:"FC26", reference:"wavpack-5.1.0-7.fc26")) flag++;
