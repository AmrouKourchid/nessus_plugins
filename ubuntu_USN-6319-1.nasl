...
# extracted from Ubuntu Security Notice USN-6319-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6319-1");

  script_name(english:"Ubuntu 16.04 ESM / 18.04 ESM / 20.04 LTS / 22.04 LTS / 23.04 : AMD Microcode vulnerability (USN-6319-1)");
...
a vulnerability as referenced in the USN-6319-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6319-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'amd64-microcode', 'pkgver': '3.20191021.1+really3.20180524.1~ubuntu0.16.04.2+esm2', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'amd64-microcode', 'pkgver': '3.20191021.1+really3.20181128.1~ubuntu0.18.04.1+esm2', 'ubuntu_pro': TRUE},
    {'osver': '20.04', 'pkgname': 'amd64-microcode', 'pkgver': '3.20191218.1ubuntu1.2', 'ubuntu_pro': FALSE},
    {'osver': '22.04', 'pkgname': 'amd64-microcode', 'pkgver': '3.20191218.1ubuntu2.2', 'ubuntu_pro': FALSE},
    {'osver': '23.04', 'pkgname': 'amd64-microcode', 'pkgver': '3.20220411.1ubuntu3.2', 'ubuntu_pro': FALSE}
];
