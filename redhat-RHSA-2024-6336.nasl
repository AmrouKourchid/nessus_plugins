...
# extracted from Red Hat Security Advisory RHSA-2024:6336. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:6336");
  script_xref(name:"IAVA", value:"2024-A-0546");

  script_name(english:"RHEL 8 : Satellite 6.14.4.2 Security Update (Important) (RHSA-2024:6336)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:6336 advisory.
...
number.");
  ...
  # https://docs.redhat.com/en/documentation/red_hat_satellite/6.14/html/updating_red_hat_satellite/index
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bf75e177");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_6336.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?715c7916");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:6336");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'foreman-installer-3.7.0.8-1.el8sat', 'release':'8', 'el_string':'el8sat', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'satellite-6'},
      {'reference':'foreman-installer-katello-3.7.0.8-1.el8sat', 'release':'8', 'el_string':'el8sat', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'satellite-6'}
    ]
  }
];
