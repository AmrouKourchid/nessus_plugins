...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : glib2 (EulerOS-SA-2023-1315)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the glib2 packages installed, the EulerOS installation on the remote host is affected by
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1315
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?573526eb");
...
var pkgs = [
  "glib2-2.58.1-1.h12.eulerosv2r8",
  "glib2-devel-2.58.1-1.h12.eulerosv2r8",
  "glib2-fam-2.58.1-1.h12.eulerosv2r8"
];
