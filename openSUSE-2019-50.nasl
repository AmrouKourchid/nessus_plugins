...
"This update for aria2 fixes the following security issue :
  ...
  - CVE-2019-3500: Metadata and potential password leaks via
    --log= (boo#1120488)");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1120488");
  script_set_attribute(attribute:"solution", value:
"Update the affected aria2 packages.");
...
if ( rpm_check(release:"SUSE15.0", reference:"aria2-1.33.1-lp150.5.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"aria2-debuginfo-1.33.1-lp150.5.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"aria2-debugsource-1.33.1-lp150.5.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"aria2-devel-1.33.1-lp150.5.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"aria2-lang-1.33.1-lp150.5.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libaria2-0-1.33.1-lp150.5.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libaria2-0-debuginfo-1.33.1-lp150.5.1") ) flag++;
