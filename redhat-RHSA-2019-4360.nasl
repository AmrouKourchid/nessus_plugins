...
"The remote Red Hat host is missing one or more security updates for libyang.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has a package installed that is affected by multiple vulnerabilities as
referenced in the RHSA-2019:4360 advisory.

    The libyang package provides a library for YANG data modeling language. libyang is a YANG data modelling
    language parser and toolkit written (and providing API) in C. The library is used e.g. in libnetconf2,
    ...
    * libyang: stack-based buffer overflow in make_canonical when identityref leaf type is used
    ...
    The libyang-devel sub-package has recently been removed from the AppStream repository. If you have
    previously installed libyang-devel, remove it prior to applying this advisory to make the update
    successful.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_4360.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?18b32df3");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:4360");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1779573");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1779576");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libyang package based on the guidance in RHSA-2019:4360.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-19334");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:libyang");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libyang-0.16.105-3.el8_1.2', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'libyang-0.16.105-3.el8_1.2', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libyang');
}
