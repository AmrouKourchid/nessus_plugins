...
# extracted from Fedora Security Advisory FEDORA-2021-de45e7bb88
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-de45e7bb88");

  script_name(english:"Fedora 32 : wavpack (2021-de45e7bb88)");
...
FEDORA-2021-de45e7bb88 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-de45e7bb88");
...
pkgs = [
    {'reference':'wavpack-5.4.0-1.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE}
];
