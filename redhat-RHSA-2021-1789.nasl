...
"The remote Red Hat host is missing a security update for gssdp / gupnp.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_1789.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3598fef3");
...
"Update the RHEL gssdp / gupnp packages based on the guidance in RHSA-2021:1789.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gssdp-1.0.5-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gssdp-devel-1.0.5-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gssdp-docs-1.0.5-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gupnp-1.0.6-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gupnp-devel-1.0.6-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
