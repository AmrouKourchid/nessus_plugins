...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 ESM / 18.04 LTS / 20.04 LTS / 22.04 LTS : Werkzeug vulnerabilities (USN-5948-1)");
...
multiple vulnerabilities as referenced in the USN-5948-1 advisory.
    ...
    It was discovered that Werkzeug did not properly handle the parsing of nameless cookies. A remote attacker
    could possibly use this issue to shadow other cookies. (CVE-2023-23934)

    It was discovered that Werkzeug could be made to process unlimited number of multipart form data parts. A
    remote attacker could possibly use this issue to cause Werkzeug to consume resources, leading to a denial
    of service. (CVE-2023-25577)
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'python-werkzeug', 'pkgver': '0.10.4+dfsg1-1ubuntu1.2+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'python3-werkzeug', 'pkgver': '0.10.4+dfsg1-1ubuntu1.2+esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'python-werkzeug', 'pkgver': '0.14.1+dfsg1-1ubuntu0.2', 'ubuntu_pro': FALSE},
    {'osver': '18.04', 'pkgname': 'python3-werkzeug', 'pkgver': '0.14.1+dfsg1-1ubuntu0.2', 'ubuntu_pro': FALSE},
    {'osver': '20.04', 'pkgname': 'python3-werkzeug', 'pkgver': '0.16.1+dfsg1-2ubuntu0.1', 'ubuntu_pro': FALSE},
    {'osver': '22.04', 'pkgname': 'python3-werkzeug', 'pkgver': '2.0.2+dfsg1-1ubuntu0.22.04.1', 'ubuntu_pro': FALSE}
];
