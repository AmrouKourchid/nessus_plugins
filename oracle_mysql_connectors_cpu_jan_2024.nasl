...
if (description)
{
  ...
  script_name(english:"Oracle MySQL Connectors C++ and ODBC (January 2024 CPU)");
...
referenced in the January 2024 CPU advisory.
  ...
  - Vulnerability in the MySQL Connectors product of Oracle MySQL (component: Connector/ODBC (OpenSSL)). 
    ...
    MySQL Connectors. Successful attacks of this vulnerability can result in unauthorized access to critical 
    data or complete access to all MySQL Connectors accessible data. (CVE-2023-5363)
...
if ('c++' >< product)
  constraints = [ { 'min_version' : '8.0', 'fixed_version' : '8.3.0' } ];

else if ('odbc' >< product)
  constraints = [ 
    { 'min_version' : '8.0', 'fixed_version' : '8.0.36' },
    { 'min_version' : '8.1', 'fixed_version' : '8.3.0' }
  ];
