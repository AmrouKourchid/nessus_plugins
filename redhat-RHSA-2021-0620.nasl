...
# extracted from Red Hat Security Advisory RHSA-2021:0620. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:0620");

  script_name(english:"RHEL 8 : stunnel (RHSA-2021:0620)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for stunnel.");
...
the RHSA-2021:0620 advisory.

    Stunnel is a wrapper for network connections. It can be used to tunnel an unencrypted network connection
    over an encrypted connection (encrypted using SSL or TLS) or to provide an encrypted means of connecting
    to services that do not natively support encryption.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_0620.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1ac2abf8");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:0620");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1925226");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL stunnel package based on the guidance in RHSA-2021:0620.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'stunnel-5.48-6.el8_1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
