...
if (description)
{
  ...
  script_name(english:"Wireshark 4.2.x < 4.2.11 A Vulnerability (macOS)");

  script_set_attribute(attribute:"synopsis", value:
"An application installed on the remote macOS / Mac OS X host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Wireshark installed on the remote macOS / Mac OS X host is prior to 4.2.11. It is, therefore, affected by
a vulnerability as referenced in the wireshark-4.2.11 advisory.
...
"Upgrade to Wireshark version 4.2.11 or later.");
...
var constraints = [
  { 'min_version' : '4.2.0', 'max_version' : '4.2.0', 'fixed_version' : '4.2.11' }
];
