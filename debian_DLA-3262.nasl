...
# extracted from Debian Security Advisory dla-3262. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3262 : smarty3 - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has a package installed that is affected by a vulnerability as referenced in the dla-3262
advisory.
...
"Upgrade the smarty3 packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-25047");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'smarty3', 'reference': '3.1.33+20180830.1.3a78a21f+selfpack1-1+deb10u2'}
];
