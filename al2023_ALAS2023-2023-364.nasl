...
# extracted from Amazon Linux 2023 Security Advisory ALAS2023-2023-364.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2023 : libtiff, libtiff-devel, libtiff-static (ALAS2023-2023-364)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2023 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"It is, therefore, affected by multiple vulnerabilities as referenced in the ALAS2023-2023-364 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2023/ALAS-2023-364.html");
...
"Run 'dnf update libtiff --releasever 2023.2.20231002' to update your system.");
