...
# extracted from Oracle Linux Security Advisory ELSA-2018-2693.
##
...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2018-A-0288-S");

  script_name(english:"Oracle Linux 6 : firefox (ELSA-2018-2693)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"http://linux.oracle.com/errata/ELSA-2018-2693.html");
...
var pkgs = [
    {'reference':'firefox-60.2.0-1.0.1.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
