...
# extracted from VMware Security Advisory PHSA-2023-4.0-0336. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Postgresql10 PHSA-2023-4.0-0336");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the postgresql10 package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-336.md");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:vmware:photonos:postgresql10");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'postgresql10-10.23-2.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'postgresql10-devel-10.23-2.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'postgresql10-libs-10.23-2.ph4')) flag++;
