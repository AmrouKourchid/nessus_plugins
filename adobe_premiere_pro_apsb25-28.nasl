...
if (description)
{
  ...
  script_name(english:"Adobe Premiere Pro < 24.6.5 / 25.0 < 25.2 Arbitrary code execution (APSB25-28)");
...
"The version of Adobe Premiere Pro installed on the remote Windows host is prior to 24.6.5, 25.2. It is, therefore,
