...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : kernel (EulerOS-SA-2024-1911)");
...
the following vulnerabilities :
    ...
    read data from the socket when the TCP stream is already out-of-sync or corrupted.(CVE-2022-48686)
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1911
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7b731af3");
