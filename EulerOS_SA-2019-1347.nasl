...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : tar (EulerOS-SA-2019-1347)");
...
vulnerability :
  ...
  - tar: null-pointer dereference in pax_decode_header in
    sparse.c.(CVE-2019-9923)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1347
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?85d2aa07");
...
pkgs = ["tar-1.26-34.h2.eulerosv2r7"];
