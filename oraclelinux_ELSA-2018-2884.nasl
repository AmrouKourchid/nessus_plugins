...
# Oracle Linux Security Advisory ELSA-2018-2884 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : firefox (ELSA-2018-2884)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2018-2884.html");
...
var pkgs = [
    {'reference':'firefox-60.2.2-1.0.1.el7_5', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-60.2.2-1.0.1.el7_5', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-60.2.2-1.0.1.el7_5', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
