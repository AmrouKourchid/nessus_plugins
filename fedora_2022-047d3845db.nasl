...
# extracted from Fedora Security Advisory FEDORA-2022-047d3845db
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-047d3845db");

  script_name(english:"Fedora 37 : grafana (2022-047d3845db)");
...
FEDORA-2022-047d3845db advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-047d3845db");
...
var pkgs = [
    {'reference':'grafana-9.0.5-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
