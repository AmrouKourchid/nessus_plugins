...
if (description)
{
  ...
  script_cve_id("CVE-2024-53163");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-53163");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: crypto: qat/qat_420xx - fix off by one
    in uof_get_name() This is called from uof_get_name_420xx() where num_objs is the ARRAY_SIZE() of
    fw_objs[]. The > needs to be >= to prevent an out of bounds access. (CVE-2024-53163)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-53163");
