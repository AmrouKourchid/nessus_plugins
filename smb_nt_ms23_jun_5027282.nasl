...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5027271");
  script_xref(name:"MSKB", value:"5027282");
  script_xref(name:"MSFT", value:"MS23-5027271");
  script_xref(name:"MSFT", value:"MS23-5027282");
  script_xref(name:"IAVA", value:"2023-A-0305-S");
  script_xref(name:"IAVA", value:"2023-A-0306-S");

  script_name(english:"KB5027282: Windows 8.1 Embedded and Windows Server 2012 R2 Security Update (June 2023)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5027271");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5027282");
...
if (
  smb_check_rollup(os:'6.3',
                   ...
                   rollup_date:'06_2023',
                   bulletin:bulletin,
                   rollup_kb_list:[5027282, 5027271])
)
{
