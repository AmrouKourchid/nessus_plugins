...
# SUSE update advisory SUSE-SU-2022:0429-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:0429-1");

  script_name(english:"SUSE SLES15 Security Update : kernel (Live Patch 12 for SLE 15 SP3) (SUSE-SU-2022:0429-1)");
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-February/010227.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?84d60111");
  script_set_attribute(attribute:"solution", value:
"Update the affected kernel-livepatch-5_3_18-150300_59_43-default and / or kernel-livepatch-5_3_18-24_99-default
packages.");
...
var pkgs = [
    {'reference':'kernel-livepatch-5_3_18-24_99-default-2-2.2', 'sp':'2', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.2']},
    {'reference':'kernel-livepatch-5_3_18-150300_59_43-default-2-150300.2.2', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.3']}
];
