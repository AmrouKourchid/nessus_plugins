...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : python3 (EulerOS-SA-2025-1143)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1143
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cda5ea03");
...
var pkgs = [
  "python3-3.9.9-7.h31.eulerosv2r11",
  "python3-unversioned-command-3.9.9-7.h31.eulerosv2r11"
];
