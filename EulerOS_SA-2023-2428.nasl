...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : libtasn1 (EulerOS-SA-2023-2428)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2428
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a97622ed");
...
var pkgs = [
  "libtasn1-4.10-1.h6.eulerosv2r7",
  "libtasn1-devel-4.10-1.h6.eulerosv2r7"
];
