...
# extracted from Fedora Security Advisory 2010-9062.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 11 : cacti-0.8.7f-1.fc11 (2010-9062)");
...
without introducing additional issues.");
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-May/041896.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a2f9e6e0");
...
flag = 0;
if (rpm_check(release:"FC11", reference:"cacti-0.8.7f-1.fc11")) flag++;
