...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.1 : mariadb-connector-c (EulerOS-SA-2023-1197)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1197
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9e890076");
...
var pkgs = [
  "mariadb-connector-c-3.0.6-6.h3.eulerosv2r9"
];
