...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 ESM : PolicyKit vulnerability (USN-5252-2)");
...
USN-5252-2 advisory.
    ...
    USN-5252-1 fixed a vulnerability in policykit-1. This update provides the corresponding update for Ubuntu
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'gir1.2-polkit-1.0', 'pkgver': '0.105-14.1ubuntu0.5+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libpolkit-agent-1-0', 'pkgver': '0.105-14.1ubuntu0.5+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libpolkit-agent-1-dev', 'pkgver': '0.105-14.1ubuntu0.5+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libpolkit-backend-1-0', 'pkgver': '0.105-14.1ubuntu0.5+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libpolkit-backend-1-dev', 'pkgver': '0.105-14.1ubuntu0.5+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libpolkit-gobject-1-0', 'pkgver': '0.105-14.1ubuntu0.5+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libpolkit-gobject-1-dev', 'pkgver': '0.105-14.1ubuntu0.5+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'policykit-1', 'pkgver': '0.105-14.1ubuntu0.5+esm1', 'ubuntu_pro': TRUE}
];
