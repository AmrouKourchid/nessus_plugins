...
# extracted from Red Hat Security Advisory fence-agents. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2019-10153", "CVE-2021-21240");

  script_name(english:"RHEL 8 : fence-agents (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-21240");
