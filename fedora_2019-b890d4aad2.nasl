...
# extracted from Fedora Security Advisory FEDORA-2019-b890d4aad2.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : 1:xpdf (2019-b890d4aad2)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-b890d4aad2");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"xpdf-4.02-2.fc30", epoch:"1")) flag++;
