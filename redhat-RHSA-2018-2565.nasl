...
# extracted from Red Hat Security Advisory RHSA-2018:2565. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2018-1115", "CVE-2018-10915", "CVE-2018-10925");
  script_xref(name:"RHSA", value:"2018:2565");

  script_name(english:"RHEL 7 : rh-postgresql10-postgresql (RHSA-2018:2565)");
...
referenced in the RHSA-2018:2565 advisory.

    PostgreSQL is an advanced object-relational database management system (DBMS).

    The following packages have been upgraded to a later upstream version: rh-postgresql10-postgresql (10.5).
    (BZ#1612673, BZ#1614337)
    ...
    * postgresql: Too-permissive access control list on function pg_logfile_rotate() (CVE-2018-1115)
    ...
    Andrew Krasichkov as the original reporter of CVE-2018-10915; and Stephen Frost as the original reporter
    of CVE-2018-1115.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2018/rhsa-2018_2565.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3f8f1c9c");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:2565");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rh-postgresql10-postgresql package based on the guidance in RHSA-2018:2565.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-postgresql10-postgresql-10.5-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql10-postgresql-contrib-10.5-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql10-postgresql-contrib-syspaths-10.5-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql10-postgresql-devel-10.5-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql10-postgresql-docs-10.5-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql10-postgresql-libs-10.5-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql10-postgresql-plperl-10.5-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql10-postgresql-plpython-10.5-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql10-postgresql-pltcl-10.5-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql10-postgresql-server-10.5-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql10-postgresql-server-syspaths-10.5-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql10-postgresql-static-10.5-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql10-postgresql-syspaths-10.5-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql10-postgresql-test-10.5-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
