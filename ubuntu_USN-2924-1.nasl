...
# extracted from Ubuntu Security Notice USN-2924-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"2924-1");

  script_name(english:"Ubuntu 14.04 LTS : NSS vulnerability (USN-2924-1)");
...
USN-2924-1 advisory.
    ...
    Francis Gabriel discovered that NSS incorrectly handled decoding certain ASN.1 data. An remote attacker
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2924-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'libnss3', 'pkgver': '2:3.21-0ubuntu0.14.04.2'},
    {'osver': '14.04', 'pkgname': 'libnss3-1d', 'pkgver': '2:3.21-0ubuntu0.14.04.2'},
    {'osver': '14.04', 'pkgname': 'libnss3-dev', 'pkgver': '2:3.21-0ubuntu0.14.04.2'},
    {'osver': '14.04', 'pkgname': 'libnss3-nssdb', 'pkgver': '2:3.21-0ubuntu0.14.04.2'},
    {'osver': '14.04', 'pkgname': 'libnss3-tools', 'pkgver': '2:3.21-0ubuntu0.14.04.2'}
];
