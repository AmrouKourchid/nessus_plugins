...
# extracted from Fedora Security Advisory FEDORA-2024-5f94556a31
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-5f94556a31");

  script_name(english:"Fedora 40 : libreoffice (2024-5f94556a31)");
...
FEDORA-2024-5f94556a31 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-5f94556a31");
...
var pkgs = [
    {'reference':'libreoffice-24.2.1.2-5.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
