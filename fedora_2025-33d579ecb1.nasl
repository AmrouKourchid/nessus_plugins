...
# extracted from Fedora Security Advisory FEDORA-2025-33d579ecb1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-33d579ecb1");

  script_name(english:"Fedora 41 : firefox (2025-33d579ecb1)");
...
FEDORA-2025-33d579ecb1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-33d579ecb1");
...
var pkgs = [
    {'reference':'firefox-138.0-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
