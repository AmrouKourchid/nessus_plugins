...
# AlmaLinux Security Advisory ALSA-2022:8263.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2022:8263");

  script_name(english:"AlmaLinux 9 : dpdk (ALSA-2022:8263)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 9 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ALSA-2022:8263 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2022-8263.html");
...
"Update the affected packages.");
  ...
  script_cwe_id(125, 183, 393, 641, 770, 787, 791);
