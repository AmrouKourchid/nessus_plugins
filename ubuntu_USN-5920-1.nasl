...
# extracted from Ubuntu Security Notice USN-5920-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5920-1");

  script_name(english:"Ubuntu 18.04 LTS : Linux kernel vulnerabilities (USN-5920-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5920-1");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.15.0-1061-dell300x");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.15.0-1115-oracle");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.15.0-1146-gcp");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.15.0-1151-aws");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.15.0-206-generic");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.15.0-206-generic-lpae");
...
var kernel_mappings = {
  '18.04': {
    '4.15.0': {
      'generic': '4.15.0-206',
      'generic-lpae': '4.15.0-206',
      'lowlatency': '4.15.0-206',
      'dell300x': '4.15.0-1061',
      'oracle': '4.15.0-1115',
      'gcp': '4.15.0-1146',
      'aws': '4.15.0-1151'
    }
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-5920-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2022-3521', 'CVE-2022-3545', 'CVE-2022-3628', 'CVE-2022-3640', 'CVE-2022-4378', 'CVE-2022-42328', 'CVE-2022-42329', 'CVE-2022-42895', 'CVE-2023-0461');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-5920-1');
  }
  else
  {
