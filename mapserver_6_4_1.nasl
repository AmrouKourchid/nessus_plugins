...
configured and PostGIS must be in use.");
  # https://www.mapserver.org/development/changelog/changelog-6-4.html#changelog-6-4-1
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?724bf1f1");
...
"Upgrade to MapServer 5.6.9 / 6.0.4 / 6.2.2 / 6.4.1 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-7262");
