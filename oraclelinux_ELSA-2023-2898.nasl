...
# extracted from Oracle Linux Security Advisory ELSA-2023-2898.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : libtar (ELSA-2023-2898)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-2898.html");
...
var pkgs = [
    {'reference':'libtar-1.2.20-17.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libtar-1.2.20-17.el8', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libtar-1.2.20-17.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
