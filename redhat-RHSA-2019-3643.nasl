...
# extracted from Red Hat Security Advisory RHSA-2019:3643. The text 
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_3643.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6b4e95cb");
...
"Update the RHEL gettext package based on the guidance in RHSA-2019:3643.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gettext-0.19.8.1-17.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gettext-common-devel-0.19.8.1-17.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gettext-devel-0.19.8.1-17.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gettext-libs-0.19.8.1-17.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
