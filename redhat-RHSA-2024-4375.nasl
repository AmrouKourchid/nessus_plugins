...
# extracted from Red Hat Security Advisory RHSA-2024:4375. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:4375");

  script_name(english:"RHEL 8 : postgresql-jdbc (RHSA-2024:4375)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for postgresql-jdbc.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:4375 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_4375.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b79940a5");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:4375");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL postgresql-jdbc package based on the guidance in RHSA-2024:4375.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'postgresql-jdbc-42.2.3-7.el8_4', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-jdbc-javadoc-42.2.3-7.el8_4', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
