...
# extracted from F5 Networks BIG-IP Solution K20336394.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : ImageMagick vulnerability (K20336394)");
...
PEM),BIG-IQ Centralized Management,Enterprise Manager, F5 iWorkflow,
and Traffix SDC

There is no impact; these F5 products are not affected by this
vulnerability.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K20336394");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K20336394.");
