...
# extracted from Fedora Security Advisory FEDORA-2024-dada06a500
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-dada06a500");

  script_name(english:"Fedora 39 : pypy (2024-dada06a500)");
...
FEDORA-2024-dada06a500 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-dada06a500");
...
var pkgs = [
    {'reference':'pypy-7.3.15-3.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
