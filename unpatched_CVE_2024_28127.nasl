...
if (description)
{
  ...
  script_cve_id("CVE-2024-28127");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-28127");
...
patch available.
  ...
  - Improper input validation in UEFI firmware for some Intel(R) Processors may allow a privileged user to
    potentially enable escalation of privilege via local access. (CVE-2024-28127)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-28127");
