...
# extracted from Red Hat Security Advisory RHSA-2018:1700. The text 
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_1700.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b442c221");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:1700");
...
"Update the RHEL procps-ng package based on the guidance in RHSA-2018:1700.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'procps-ng-3.3.10-17.el7_5.2', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'procps-ng-devel-3.3.10-17.el7_5.2', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'procps-ng-i18n-3.3.10-17.el7_5.2', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
