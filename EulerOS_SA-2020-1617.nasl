...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : telnet (EulerOS-SA-2020-1617)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1617
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?274e4557");
...
pkgs = ["telnet-0.17-64.h1.eulerosv2r7",
        "telnet-server-0.17-64.h1.eulerosv2r7"];
