...
# extracted from Red Hat Security Advisory RHSA-2024:8504. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:8504");

  script_name(english:"RHEL 8 : python39:3.9 (RHSA-2024:8504)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for python39:3.9.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:8504 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?842b6f9f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:8504");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python39:3.9 package based on the guidance in RHSA-2024:8504.");
  ...
  'python39:3.9': [
    {
      ...
      'pkgs': [
        {'reference':'python39-3.9.16-1.module+el8.8.0+22374+62aa8e74.4', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'python39-devel-3.9.16-1.module+el8.8.0+22374+62aa8e74.4', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python39-idle-3.9.16-1.module+el8.8.0+22374+62aa8e74.4', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python39-idna-2.10-3.module+el8.4.0+9822+20bf1249', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python39-libs-3.9.16-1.module+el8.8.0+22374+62aa8e74.4', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'python39-rpm-macros-3.9.16-1.module+el8.8.0+22374+62aa8e74.4', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'python39-test-3.9.16-1.module+el8.8.0+22374+62aa8e74.4', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python39-tkinter-3.9.16-1.module+el8.8.0+22374+62aa8e74.4', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
