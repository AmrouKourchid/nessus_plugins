...
# extracted from SUSE update advisory SUSE-SU-2020:1576-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES15 Security Update : nodejs8 (SUSE-SU-2020:1576-1)");
...
without introducing additional issues.");
  ...
  # https://www.suse.com/support/update/announcement/2020/suse-su-20201576-1/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e58109d5");
...
zypper in -t patch SUSE-SLE-Product-SLES_SAP-15-2020-1576=1

SUSE Linux Enterprise Server 15-LTSS :

zypper in -t patch SUSE-SLE-Product-SLES-15-2020-1576=1

SUSE Linux Enterprise Module for Web Scripting 15-SP2 :

zypper in -t patch SUSE-SLE-Module-Web-Scripting-15-SP2-2020-1576=1

SUSE Linux Enterprise Module for Web Scripting 15-SP1 :

zypper in -t patch SUSE-SLE-Module-Web-Scripting-15-SP1-2020-1576=1

SUSE Linux Enterprise High Performance Computing 15-LTSS :

zypper in -t patch SUSE-SLE-Product-HPC-15-2020-1576=1
...
flag = 0;
if (rpm_check(release:"SLES15", sp:"1", reference:"nodejs8-8.17.0-3.32.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"nodejs8-debuginfo-8.17.0-3.32.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"nodejs8-debugsource-8.17.0-3.32.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"nodejs8-devel-8.17.0-3.32.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"npm8-8.17.0-3.32.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"nodejs8-8.17.0-3.32.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"nodejs8-debuginfo-8.17.0-3.32.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"nodejs8-debugsource-8.17.0-3.32.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"nodejs8-devel-8.17.0-3.32.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"npm8-8.17.0-3.32.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"nodejs8-8.17.0-3.32.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"nodejs8-debuginfo-8.17.0-3.32.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"nodejs8-debugsource-8.17.0-3.32.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"nodejs8-devel-8.17.0-3.32.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"npm8-8.17.0-3.32.1")) flag++;
