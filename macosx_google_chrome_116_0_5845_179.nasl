...
"The version of Google Chrome installed on the remote macOS host is prior to 116.0.5845.179. It is, therefore, affected
...
google_chrome_check_version(fix:'116.0.5845.179', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
