...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : httpd (EulerOS-SA-2024-2035)");
...
the following vulnerabilities :
    ...
    to split HTTP responses.(CVE-2023-38709)
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2035
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1ae62114");
...
var pkgs = [
  "httpd-2.4.34-8.h29.eulerosv2r8",
  "httpd-devel-2.4.34-8.h29.eulerosv2r8",
  "httpd-filesystem-2.4.34-8.h29.eulerosv2r8",
  "httpd-manual-2.4.34-8.h29.eulerosv2r8",
  "httpd-tools-2.4.34-8.h29.eulerosv2r8",
  "mod_session-2.4.34-8.h29.eulerosv2r8",
  "mod_ssl-2.4.34-8.h29.eulerosv2r8"
];
