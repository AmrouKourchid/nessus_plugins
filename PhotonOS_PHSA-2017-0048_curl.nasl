...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Curl PHSA-2017-0048");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'curl-7.54.0-5.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'curl-debuginfo-7.54.0-5.ph1')) flag++;
