...
if (description)
{
  ...
  script_name(english:"Debian Linux SEoL (8.x)");
...
contain security vulnerabilities.");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/News/2018/20180601");
...
"Upgrade to a version of Debian Linux that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2018/06/17");
...
var constraints = [
  { max_branch : '8', min_branch : '8', seol : 20180617 }
];
