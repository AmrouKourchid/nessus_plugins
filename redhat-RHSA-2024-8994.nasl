...
# extracted from Red Hat Security Advisory RHSA-2024:8994. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:8994");

  script_name(english:"RHEL 8 / 9 : OpenShift Container Platform 4.15.38 (RHSA-2024:8994)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for OpenShift Container Platform 4.15.38.");
...
in the RHSA-2024:8994 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.15.38. See the
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c557bda3");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:8994");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.15.38 packages based on the guidance in RHSA-2024:8994.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'podman-4.4.1-32.rhaos4.15.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube'},
      {'reference':'podman-catatonit-4.4.1-32.rhaos4.15.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube'},
      {'reference':'podman-docker-4.4.1-32.rhaos4.15.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube'},
      {'reference':'podman-gvproxy-4.4.1-32.rhaos4.15.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube'},
      {'reference':'podman-plugins-4.4.1-32.rhaos4.15.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube'},
      {'reference':'podman-remote-4.4.1-32.rhaos4.15.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube'},
      {'reference':'podman-tests-4.4.1-32.rhaos4.15.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'podman-4.4.1-32.rhaos4.15.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube'},
      {'reference':'podman-docker-4.4.1-32.rhaos4.15.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube'},
      {'reference':'podman-gvproxy-4.4.1-32.rhaos4.15.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube'},
      {'reference':'podman-plugins-4.4.1-32.rhaos4.15.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube'},
      {'reference':'podman-remote-4.4.1-32.rhaos4.15.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube'},
      {'reference':'podman-tests-4.4.1-32.rhaos4.15.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube'}
    ]
  }
];
