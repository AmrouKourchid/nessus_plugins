...
# extracted from Mozilla Foundation Security Advisory mfsa2024-32.
...
if (description)
{
  ...
  script_name(english:"Mozilla Thunderbird < 128.0");

  script_set_attribute(attribute:"synopsis", value:
"A mail client installed on the remote macOS or Mac OS X host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Thunderbird installed on the remote macOS or Mac OS X host is prior to 128.0. It is, therefore, affected
by multiple vulnerabilities as referenced in the mfsa2024-32 advisory.
  ...
  - It was possible to move the cursor using pointerlock from an iframe. This allowed moving the cursor
    outside of the viewport and the application window. (CVE-2024-6608)
  ...
  - Memory safety bugs present in Firefox 127, Firefox ESR 115.12, Thunderbird 127, and Thunderbird 115.12.
    Some of these bugs showed evidence of memory corruption and we presume that with enough effort some of
    these could have been exploited to run arbitrary code. (CVE-2024-6604)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2024-32/");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Mozilla Thunderbird version 128.0 or later.");
...
mozilla_check_version(version:version, path:path, product:'thunderbird', esr:FALSE, fix:'128.0', severity:SECURITY_HOLE);
