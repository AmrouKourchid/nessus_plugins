...
# extracted from Red Hat Security Advisory RHSA-2024:8798. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 8 : xorg-x11-server and xorg-x11-server-Xwayland (RHSA-2024:8798)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for xorg-x11-server / xorg-x11-server-Xwayland.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:8798 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_8798.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?134814f4");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:8798");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL xorg-x11-server / xorg-x11-server-Xwayland packages based on the guidance in RHSA-2024:8798.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'xorg-x11-server-common-1.20.11-25.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xorg-x11-server-devel-1.20.11-25.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xorg-x11-server-source-1.20.11-25.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xorg-x11-server-Xdmx-1.20.11-25.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xorg-x11-server-Xephyr-1.20.11-25.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xorg-x11-server-Xnest-1.20.11-25.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xorg-x11-server-Xorg-1.20.11-25.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xorg-x11-server-Xvfb-1.20.11-25.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'xorg-x11-server-Xwayland-21.1.3-17.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
