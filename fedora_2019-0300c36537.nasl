...
# extracted from Fedora Security Advisory FEDORA-2019-0300c36537.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-0300c36537");

  script_name(english:"Fedora 29 : mod_http2 (2019-0300c36537)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"This release adds the `H2Padding` configuration directive and has
various bug fixes.
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-0300c36537");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"mod_http2-1.14.1-1.fc29")) flag++;
