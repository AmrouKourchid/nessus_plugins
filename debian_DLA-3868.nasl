...
# extracted from Debian Security Advisory dla-3868. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3868 : ruby-nokogiri - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has a package installed that is affected by a vulnerability as referenced in the dla-3868
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bullseye/ruby-nokogiri");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'ruby-nokogiri', 'reference': '1.11.1+dfsg-2+deb11u1'}
];
