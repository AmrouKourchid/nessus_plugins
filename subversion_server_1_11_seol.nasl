...
if (description)
{
  ...
  script_name(english:"Apache Subversion Server SEoL (1.11.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Apache Subversion Server is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Apache Subversion Server is 1.11.x. It is, therefore, no longer maintained by its vendor or
provider.
...
"Upgrade to a version of Apache Subversion Server that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2019/04/30");
...
var constraints = [
  { max_branch : '1.11', min_branch : '1.11', seol : 20190430 }
];
