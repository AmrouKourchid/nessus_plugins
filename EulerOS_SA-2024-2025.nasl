...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : expat (EulerOS-SA-2024-2025)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2025
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c9938f97");
...
var pkgs = [
  "expat-2.2.6-1.h9.eulerosv2r8",
  "expat-devel-2.2.6-1.h9.eulerosv2r8"
];
