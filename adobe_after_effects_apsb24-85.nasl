...
if (description)
{
  ...
  script_name(english:"Adobe After Effects < 24.6.3 Multiple Vulnerabilities (APSB24-85)");

  script_set_attribute(attribute:"synopsis", value:
"The Adobe After Effects instance installed on the remote host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe After Effects installed on the remote Windows host is prior to 24.6.3. It is, therefore,
