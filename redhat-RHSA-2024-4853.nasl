...
# extracted from Red Hat Security Advisory RHSA-2024:4853. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2023-45539", "CVE-2024-6104");
  script_xref(name:"RHSA", value:"2024:4853");

  script_name(english:"RHEL 8 / 9 : OpenShift Container Platform 4.15.24 (RHSA-2024:4853)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for OpenShift Container Platform 4.15.24.");
...
referenced in the RHSA-2024:4853 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.15.24. See the
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_4853.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?00f4d469");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:4853");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.15.24 packages based on the guidance in RHSA-2024:4853.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-45539");

  script_set_attribute(attribute:"exploitability_ease", value:"No known exploits are available");
  script_set_attribute(attribute:"exploit_available", value:"false");
  script_cwe_id(288, 532);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'haproxy26-2.6.13-4.rhaos4.15.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2023-45539']},
      {'reference':'podman-4.4.1-26.2.rhaos4.15.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-6104']},
      {'reference':'podman-catatonit-4.4.1-26.2.rhaos4.15.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-6104']},
      {'reference':'podman-docker-4.4.1-26.2.rhaos4.15.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-6104']},
      {'reference':'podman-gvproxy-4.4.1-26.2.rhaos4.15.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-6104']},
      {'reference':'podman-plugins-4.4.1-26.2.rhaos4.15.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-6104']},
      {'reference':'podman-remote-4.4.1-26.2.rhaos4.15.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-6104']},
      {'reference':'podman-tests-4.4.1-26.2.rhaos4.15.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-6104']}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'podman-4.4.1-26.2.rhaos4.15.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-6104']},
      {'reference':'podman-docker-4.4.1-26.2.rhaos4.15.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-6104']},
      {'reference':'podman-gvproxy-4.4.1-26.2.rhaos4.15.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-6104']},
      {'reference':'podman-plugins-4.4.1-26.2.rhaos4.15.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-6104']},
      {'reference':'podman-remote-4.4.1-26.2.rhaos4.15.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-6104']},
      {'reference':'podman-tests-4.4.1-26.2.rhaos4.15.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-6104']}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'haproxy26 / podman / podman-catatonit / podman-docker / etc');
}
