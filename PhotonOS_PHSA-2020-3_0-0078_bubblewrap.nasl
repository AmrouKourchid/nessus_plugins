...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Bubblewrap PHSA-2020-3.0-0078");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'bubblewrap-0.3.0-3.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'bubblewrap-debuginfo-0.3.0-3.ph3')) flag++;
