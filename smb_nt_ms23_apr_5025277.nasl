...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5025277");
  script_xref(name:"MSKB", value:"5025279");
  script_xref(name:"MSFT", value:"MS23-5025277");
  script_xref(name:"MSFT", value:"MS23-5025279");
  ...
  script_name(english:"KB5025277: Windows Server 2008 R2 Security Update (April 2023)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5025277");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5025279");
...
if (("windows server 2008 r2" >< tolower(os_name)) && 
    smb_check_rollup(os:'6.1',
                   ...
                   rollup_date:'04_2023',
                   bulletin:bulletin,
                   rollup_kb_list:[5025279, 5025277])
  )
{
