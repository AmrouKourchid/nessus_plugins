...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.0 : glibc (EulerOS-SA-2018-1239)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1239
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4aeb726b");
...
pkgs = ["glibc-2.17-111.h8",
        "glibc-common-2.17-111.h8",
        "glibc-devel-2.17-111.h8",
        "glibc-headers-2.17-111.h8"];
