...
# extracted from Fedora Security Advisory FEDORA-2024-ec79868e3b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-ec79868e3b");
  script_xref(name:"IAVA", value:"2024-A-0172-S");

  script_name(english:"Fedora 39 : chromium (2024-ec79868e3b)");
...
FEDORA-2024-ec79868e3b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-ec79868e3b");
...
var pkgs = [
    {'reference':'chromium-123.0.6312.58-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
