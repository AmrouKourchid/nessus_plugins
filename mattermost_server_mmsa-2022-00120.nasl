...
if (description)
{
  ...
  script_cve_id("CVE-2022-4044");
  script_xref(name:"IAVA", value:"2022-A-0499-S");

  script_name(english:"Mattermost Server < 7.1.4 / 7.2.x < 7.2.1 / 7.3.x < 7.3.1 DoS (MMSA-2022-00120)");
...
crash the server via multiple large out-of-office or autoresponder messages.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://mattermost.com/security-updates/");
  script_set_attribute(attribute:"see_also", value:"https://hackerone.com/reports/1680241");
...
"Upgrade to Mattermost Server version 7.1.4, 7.2.1, 7.3.1  or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-4044");
