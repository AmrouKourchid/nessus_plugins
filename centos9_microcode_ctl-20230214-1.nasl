...
if (description)
{
  ...
  script_name(english:"CentOS 9 : microcode_ctl-20230214-1.el9");
...
microcode_ctl-20230214-1.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=33050");
...
var pkgs = [
    {'reference':'microcode_ctl-20230214-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'}
];
