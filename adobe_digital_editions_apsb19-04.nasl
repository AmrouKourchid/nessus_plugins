...
if (description)
{
  ...
  script_name(english:"Adobe Digital Editions < 4.5.10 Information Disclosure (APSB19-04)");
...
"The version of Adobe Digital Editions installed on the remote Windows host is prior to 4.5.10. It is, therefore,
affected by a vulnerability as referenced in the APSB19-04 advisory.
