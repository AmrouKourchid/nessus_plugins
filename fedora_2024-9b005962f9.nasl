...
# extracted from Fedora Security Advisory FEDORA-2024-9b005962f9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-9b005962f9");

  script_name(english:"Fedora 39 : chisel (2024-9b005962f9)");
...
FEDORA-2024-9b005962f9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-9b005962f9");
...
var pkgs = [
    {'reference':'chisel-1.10.0-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
