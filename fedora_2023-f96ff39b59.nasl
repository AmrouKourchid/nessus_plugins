...
# extracted from Fedora Security Advisory FEDORA-2023-f96ff39b59
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-f96ff39b59");

  script_name(english:"Fedora 38 : python3.8 (2023-f96ff39b59)");
...
FEDORA-2023-f96ff39b59 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-f96ff39b59");
...
var pkgs = [
    {'reference':'python3.8-3.8.18-3.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
