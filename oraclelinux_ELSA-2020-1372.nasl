...
ELSA-2020-1372 advisory.
    ...
    - [hid] hiddev: do cleanup in failure of opening a device (Benjamin Tissoires) [1803458 1803460]
    {CVE-2019-19527}
    - [hid] hiddev: avoid opening a disconnected device (Benjamin Tissoires) [1803458 1803460]
    {CVE-2019-19527}
    - [powerpc] kvm: ppc: book3s hv: Flush link stack on guest exit to host kernel (Gustavo Duarte) [1794056
    1777686] {CVE-2019-18660}
    - [powerpc] book3s64: Fix link stack flush on context switch (Gustavo Duarte) [1794056 1777686]
    {CVE-2019-18660}
    ...
    - [powerpc] fsl: Add nospectre_v2 command line argument (Gustavo Duarte) [1794056 1777686]
    {CVE-2019-18660}
    - [powerpc] fsl: Fix spectre_v2 mitigations reporting (Gustavo Duarte) [1794056 1777686] {CVE-2019-18660}
    - [powerpc] 64: Make meltdown reporting Book3S 64 specific (Gustavo Duarte) [1794056 1777686]
    {CVE-2019-18660}
    - [powerpc] 64: Disable the speculation barrier from the command line (Gustavo Duarte) [1794056 1777686]
    {CVE-2019-18660}
    - [powerpc] powerpc/tm: Fix FP/VMX unavailable exceptions inside a transaction (Gustavo Duarte) [1788862
    1750653] {CVE-2019-15030}
    - [powerpc] powerpc/tm: Fix restoring FP/VMX facility incorrectly on interrupts (Gustavo Duarte) [1791630
    1750653] {CVE-2019-15031}
...
var pkgs = [
    ...
    {'reference':'kernel-abi-whitelists-4.18.0-147.8.1.el8_1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-abi-whitelists-4.18.0'},
