...
# extracted from Fedora Security Advisory FEDORA-2023-4bf641255e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-4bf641255e");
  script_xref(name:"IAVB", value:"2023-B-0080-S");
  script_xref(name:"CEA-ID", value:"CEA-2024-0004");

  script_name(english:"Fedora 37 : golang (2023-4bf641255e)");
...
FEDORA-2023-4bf641255e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-4bf641255e");
...
var pkgs = [
    {'reference':'golang-1.20.10-3.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
