...
# extracted from Debian Security Advisory dla-3581. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3581 : flac - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3581
advisory.

    -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3581-1                debian-lts@lists.debian.org
    https://www.debian.org/lts/security/                         Sean Whitton
    September 25, 2023                            https://wiki.debian.org/LTS
    -------------------------------------------------------------------------

    Package        : flac
    Version        : 1.3.2-3+deb10u3
    CVE ID         : CVE-2020-22219

    A buffer overflow vulnerability was found in FLAC, a free lossless audio
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/flac");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'flac', 'reference': '1.3.2-3+deb10u3'},
    {'release': '10.0', 'prefix': 'libflac++-dev', 'reference': '1.3.2-3+deb10u3'},
    {'release': '10.0', 'prefix': 'libflac++6v5', 'reference': '1.3.2-3+deb10u3'},
    {'release': '10.0', 'prefix': 'libflac-dev', 'reference': '1.3.2-3+deb10u3'},
    {'release': '10.0', 'prefix': 'libflac-doc', 'reference': '1.3.2-3+deb10u3'},
    {'release': '10.0', 'prefix': 'libflac8', 'reference': '1.3.2-3+deb10u3'}
];
