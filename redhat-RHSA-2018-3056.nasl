...
referenced in the RHSA-2018:3056 advisory.
    ...
    * samba: NULL pointer dereference in printer server process (CVE-2018-1050)
    ...
    Red Hat would like to thank the Samba project for reporting CVE-2018-1050. The CVE-2018-1139 issue was
    discovered by Vivek Das (Red Hat).
...
number.");
  ...
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_3056.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?acd47255");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:3056");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1525511");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1532618");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1538771");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1540457");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1558560");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1558943");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1570020");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1575205");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1581016");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1582541");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1614132");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ctdb-4.8.3-4.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ctdb-4.8.3-4.el7', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ctdb-4.8.3-4.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ctdb-tests-4.8.3-4.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ctdb-tests-4.8.3-4.el7', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ctdb-tests-4.8.3-4.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsmbclient-4.8.3-4.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsmbclient-devel-4.8.3-4.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libwbclient-4.8.3-4.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libwbclient-devel-4.8.3-4.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-4.8.3-4.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-client-4.8.3-4.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-client-libs-4.8.3-4.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-common-4.8.3-4.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-common-libs-4.8.3-4.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-common-tools-4.8.3-4.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-dc-4.8.3-4.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-dc-libs-4.8.3-4.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-devel-4.8.3-4.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-krb5-printing-4.8.3-4.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-libs-4.8.3-4.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-pidl-4.8.3-4.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-python-4.8.3-4.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-python-test-4.8.3-4.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-test-4.8.3-4.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-test-libs-4.8.3-4.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-vfs-glusterfs-4.8.3-4.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-winbind-4.8.3-4.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-winbind-clients-4.8.3-4.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-winbind-krb5-locator-4.8.3-4.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-winbind-modules-4.8.3-4.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
