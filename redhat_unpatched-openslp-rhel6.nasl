...
# extracted from Red Hat Security Advisory openslp. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2016-4912", "CVE-2016-7567", "CVE-2023-29552");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2023/11/29");

  script_name(english:"RHEL 6 : openslp (Unpatched Vulnerability) (deprecated)");
