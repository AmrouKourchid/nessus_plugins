...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 18.04 LTS : Intel Microcode update (USN-3977-1)");
...
vulnerabilities as referenced in the USN-3977-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3977-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'intel-microcode', 'pkgver': '3.20190514.0ubuntu0.14.04.1'},
    {'osver': '16.04', 'pkgname': 'intel-microcode', 'pkgver': '3.20190514.0ubuntu0.16.04.1'},
    {'osver': '18.04', 'pkgname': 'intel-microcode', 'pkgver': '3.20190514.0ubuntu0.18.04.2'}
];
