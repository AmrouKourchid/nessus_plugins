...
# extracted from Fedora Security Advisory FEDORA-2024-72fb215fcd
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-72fb215fcd");

  script_name(english:"Fedora 39 : yt-dlp (2024-72fb215fcd)");
...
FEDORA-2024-72fb215fcd advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-72fb215fcd");
...
var pkgs = [
    {'reference':'yt-dlp-2024.07.09-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
