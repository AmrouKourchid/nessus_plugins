...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 6.02 : python-pip Vulnerability (NS-SA-2021-0081)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 6.02, has python-pip packages installed that are affected by a
vulnerability:
