...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.1.0 : perl (EulerOS-SA-2019-1401)");
...
by the following vulnerability :
  ...
  - Perl before 5.26.3 and 5.28.x before 5.28.1 has a
    ...
    triggers invalid write operations.i1/4^CVE-2018-18311i1/4%0

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1401
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b5b0d58d");
...
pkgs = ["perl-5.16.3-292.h5",
        "perl-Pod-Escapes-1.04-292.h5",
        "perl-libs-5.16.3-292.h5",
        "perl-macros-5.16.3-292.h5"];
