...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Cmake PHSA-2023-5.0-0035");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2023-23914");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'cmake-3.25.2-4.ph5')) flag++;
