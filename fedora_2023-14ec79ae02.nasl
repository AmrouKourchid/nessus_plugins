...
# extracted from Fedora Security Advisory FEDORA-2023-14ec79ae02
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-14ec79ae02");

  script_name(english:"Fedora 36 : frr (2023-14ec79ae02)");
...
FEDORA-2023-14ec79ae02 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-14ec79ae02");
...
var pkgs = [
    {'reference':'frr-8.5-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
