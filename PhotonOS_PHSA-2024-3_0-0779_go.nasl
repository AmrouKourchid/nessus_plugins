...
# extracted from VMware Security Advisory PHSA-2024-3.0-0779. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2024-24790", "CVE-2024-24791");
  script_xref(name:"IAVB", value:"2024-B-0071-S");

  script_name(english:"Photon OS 3.0: Go PHSA-2024-3.0-0779");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the go package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-3.0-779.md");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'go-1.20.14-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'go-md2man-2.0.0-26.ph3')) flag++;
