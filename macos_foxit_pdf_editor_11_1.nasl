...
if (description)
{
  ...
  script_name(english:"Foxit PDF Editor for Mac < 11.1 Vulnerability");
...
on the remote macOS host is prior to 11.1. It is, therefore affected by vulnerability: Note that Nessus has not tested
...
"Upgrade to Foxit PDF Editor for Mac version 11.1 or later");
