...
# extracted from Fedora Security Advisory FEDORA-2020-7e9234058f.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : pdns (2020-7e9234058f)");
...
Security Advisory:
https://docs.powerdns.com/authoritative/security-advisories/powerdns-a
dvisory-2020-05.html

Note that Tenable Network Security has extracted the preceding
description block directly from the Fedora update system website.
Tenable has attempted to automatically clean and format it as much as
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-7e9234058f");
...
flag = 0;
if (rpm_check(release:"FC32", reference:"pdns-4.3.1-1.fc32")) flag++;
