...
if (description)
{
  ...
  script_cve_id("CVE-2023-32435");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2023/07/14");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2023-32435");
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-32435");
