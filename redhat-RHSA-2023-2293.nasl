...
# extracted from Red Hat Security Advisory RHSA-2023:2293. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:2293");

  script_name(english:"RHEL 9 : pki-core (RHSA-2023:2293)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_2293.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7706d733");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/9/html/9.2_release_notes/index
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ecefa061");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1849834");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1883477");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2017098");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2087105");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2091993");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2091999");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2101046");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2106452");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2122409");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2123379");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2149478");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2149485");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2149488");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2149489");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:2293");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:idm-pki-est");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:idm-pki-java");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'idm-pki-acme-11.3.0-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'idm-pki-base-11.3.0-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'idm-pki-ca-11.3.0-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'idm-pki-est-11.3.0-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'idm-pki-java-11.3.0-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'idm-pki-kra-11.3.0-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'idm-pki-server-11.3.0-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'idm-pki-tools-11.3.0-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-idm-pki-11.3.0-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'idm-pki-acme / idm-pki-base / idm-pki-ca / idm-pki-est / etc');
}
