...
# extracted from Red Hat Security Advisory RHSA-2023:7841. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:7841");

  script_name(english:"RHEL 8 : gstreamer1-plugins-bad-free (RHSA-2023:7841)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_7841.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e21d50ce");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2250249");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:7841");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL gstreamer1-plugins-bad-free package based on the guidance in RHSA-2023:7841.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gstreamer1-plugins-bad-free-1.16.1-2.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gstreamer1-plugins-bad-free-devel-1.16.1-2.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
