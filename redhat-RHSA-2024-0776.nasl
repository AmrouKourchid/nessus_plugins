...
# extracted from Red Hat Security Advisory RHSA-2024:0776. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:0776");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2024/09/09");

  script_name(english:"RHEL 8 : jenkins and jenkins-2-plugins (RHSA-2024:0776)");
...
referenced in the RHSA-2024:0776 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0776.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4ebb6337");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0776");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL jenkins / jenkins-2-plugins packages based on the guidance in RHSA-2024:0776.");
  ...
  script_cwe_id(20, 77, 79, 88, 200, 384, 400, 1188);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jenkins-2-plugins-4.13.1706516346-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2021-26291', 'CVE-2022-25857', 'CVE-2022-29599', 'CVE-2022-42889', 'CVE-2023-24422', 'CVE-2023-25761', 'CVE-2023-25762', 'CVE-2023-37946']},
      {'reference':'jenkins-2.426.3.1706516254-3.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2024-23897', 'CVE-2024-23898']}
    ]
  }
];
