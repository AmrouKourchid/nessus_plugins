...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : glusterfs (EulerOS-SA-2018-1441)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1441
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4f4cf3ff");
...
pkgs = ["glusterfs-3.7.1-16.0.1.h1",
        "glusterfs-api-3.7.1-16.0.1.h1",
        "glusterfs-client-xlators-3.7.1-16.0.1.h1",
        "glusterfs-fuse-3.7.1-16.0.1.h1",
        "glusterfs-libs-3.7.1-16.0.1.h1",
        "glusterfs-rdma-3.7.1-16.0.1.h1"];
