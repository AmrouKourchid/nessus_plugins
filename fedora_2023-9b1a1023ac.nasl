...
# extracted from Fedora Security Advisory FEDORA-2023-9b1a1023ac
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-9b1a1023ac");

  script_name(english:"Fedora 37 : open-vm-tools (2023-9b1a1023ac)");
...
FEDORA-2023-9b1a1023ac advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-9b1a1023ac");
...
var pkgs = [
    {'reference':'open-vm-tools-12.3.0-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
