...
# extracted from WordPress Security Advisory wordpress-6-4-2-maintenance-security-release.
...
if (description)
{
  ...
  script_name(english:"WordPress 6.0 < 6.4.2");

  script_set_attribute(attribute:"synopsis", value:
"A PHP application running on the remote web server is affected by one or more vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"WordPress versions 6.0 < 6.4.2 are affected by one or more vulnerabilities");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1e5927e2");
  script_set_attribute(attribute:"see_also", value:"https://wordpress.org/documentation/wordpress-version/version-6-4-2/");
  script_set_attribute(attribute:"solution", value:
"Upgrade to WordPress version 6.4.2 or later.");
...
var constraints = [
  { 'min_version' : '6.0', 'fixed_version' : '6.4.2' }
];
