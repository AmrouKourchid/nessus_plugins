...
# extracted from Fedora Security Advisory FEDORA-2018-04d49a1804.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : python35 (2018-04d49a1804)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"Security update to 3.5.6 with fix for [CVE-2018-1060: difflib and
poplib catastrophic
...
possible without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dc6c5614");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-04d49a1804");
...
flag = 0;
if (rpm_check(release:"FC27", reference:"python35-3.5.6-1.fc27")) flag++;
