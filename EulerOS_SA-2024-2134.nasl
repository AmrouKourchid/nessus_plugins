...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : curl (EulerOS-SA-2024-2134)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2134
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?67c31509");
...
var pkgs = [
  "curl-7.71.1-4.h31.r1.eulerosv2r10",
  "libcurl-7.71.1-4.h31.r1.eulerosv2r10"
];
