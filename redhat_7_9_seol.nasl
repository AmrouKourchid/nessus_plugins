...
if (description)
{
  ...
  script_name(english:"Red Hat Enterprise Linux SEoL (7.8.x <= x <= 7.9.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Red Hat Enterprise Linux is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Red Hat Enterprise Linux is between 7.8.x and 7.9.x. It is, therefore, no longer maintained by
...
var constraints = [
  { max_branch : '7.9', min_branch : '7.8', eseol : 20280630, seol : 20240630 }
];
