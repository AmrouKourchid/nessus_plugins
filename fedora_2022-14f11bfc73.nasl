...
# extracted from Fedora Security Advisory FEDORA-2022-14f11bfc73
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-14f11bfc73");

  script_name(english:"Fedora 35 : ntfs-3g (2022-14f11bfc73)");
...
FEDORA-2022-14f11bfc73 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-14f11bfc73");
...
var pkgs = [
    {'reference':'ntfs-3g-2022.10.3-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
