...
# extracted from Fedora Security Advisory FEDORA-2022-5adda2d05f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-5adda2d05f");

  script_name(english:"Fedora 35 : sysstat (2022-5adda2d05f)");
...
FEDORA-2022-5adda2d05f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-5adda2d05f");
...
var pkgs = [
    {'reference':'sysstat-12.5.6-2.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
