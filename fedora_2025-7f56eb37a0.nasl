...
# extracted from Fedora Security Advisory FEDORA-2025-7f56eb37a0
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-7f56eb37a0");

  script_name(english:"Fedora 41 : linux-firmware (2025-7f56eb37a0)");
...
FEDORA-2025-7f56eb37a0 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-7f56eb37a0");
...
var pkgs = [
    {'reference':'linux-firmware-20250311-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
