...
# extracted from Fedora Security Advisory FEDORA-2023-fe18ae3e85
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-fe18ae3e85");

  script_name(english:"Fedora 36 : xorg-x11-server (2023-fe18ae3e85)");
...
FEDORA-2023-fe18ae3e85 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-fe18ae3e85");
...
var pkgs = [
    {'reference':'xorg-x11-server-1.20.14-21.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
