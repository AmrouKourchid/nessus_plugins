...
# extracted from Red Hat Security Advisory RHSA-2017:1439. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2017:1439");

  script_name(english:"RHEL 6 : flash-plugin (RHSA-2017:1439)");
...
referenced in the RHSA-2017:1439 advisory.

    The flash-plugin package contains a Mozilla Firefox compatible Adobe Flash Player web browser plug-in.

    This update upgrades Flash Player to version 26.0.0.126.
    ...
    * This update fixes multiple vulnerabilities in Adobe Flash Player. These vulnerabilities, detailed in the
    ...
    information when the victim loaded a page containing the malicious SWF content. (CVE-2017-3075,
    CVE-2017-3076, CVE-2017-3077, CVE-2017-3078, CVE-2017-3079, CVE-2017-3081, CVE-2017-3082, CVE-2017-3083,
    CVE-2017-3084)
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2017/rhsa-2017_1439.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bb17e0ec");
  script_set_attribute(attribute:"see_also", value:"https://helpx.adobe.com/security/products/flash-player/apsb17-17.html");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2017:1439");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#critical");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1461146");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL flash-plugin package based on the guidance in RHSA-2017:1439.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'flash-plugin-26.0.0.126-1.el6_9', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
