...
# extracted from Red Hat Security Advisory RHSA-2019:1180. The text 
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_1180.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7cb9d6dd");
...
"Update the RHEL libvirt package based on the guidance in RHSA-2019:1180.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libvirt-0.10.2-64.el6_10.1', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-0.10.2-64.el6_10.1', 'cpu':'ppc64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-0.10.2-64.el6_10.1', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-0.10.2-64.el6_10.1', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-client-0.10.2-64.el6_10.1', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-client-0.10.2-64.el6_10.1', 'cpu':'ppc', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-client-0.10.2-64.el6_10.1', 'cpu':'ppc64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-client-0.10.2-64.el6_10.1', 'cpu':'s390', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-client-0.10.2-64.el6_10.1', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-client-0.10.2-64.el6_10.1', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-devel-0.10.2-64.el6_10.1', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-devel-0.10.2-64.el6_10.1', 'cpu':'ppc', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-devel-0.10.2-64.el6_10.1', 'cpu':'ppc64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-devel-0.10.2-64.el6_10.1', 'cpu':'s390', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-devel-0.10.2-64.el6_10.1', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-devel-0.10.2-64.el6_10.1', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-lock-sanlock-0.10.2-64.el6_10.1', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-python-0.10.2-64.el6_10.1', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-python-0.10.2-64.el6_10.1', 'cpu':'ppc64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-python-0.10.2-64.el6_10.1', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-python-0.10.2-64.el6_10.1', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
