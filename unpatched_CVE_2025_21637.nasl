...
if (description)
{
  ...
  script_cve_id("CVE-2025-21637");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2025-21637");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: sctp: sysctl: udp_port: avoid using
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-21637");
