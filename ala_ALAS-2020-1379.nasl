...
# extracted from Amazon Linux AMI Security Advisory ALAS-2020-1379.
#
...
if (description)
{
  ...
  script_name(english:"Amazon Linux AMI : bash (ALAS-2020-1379)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux AMI host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of bash installed on the remote host is prior to 4.2.46-34.43. It is, therefore, affected by a vulnerability
as referenced in the ALAS-2020-1379 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/ALAS-2020-1379.html");
...
var pkgs = [
    {'reference':'bash-4.2.46-34.43.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'bash-4.2.46-34.43.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'bash-debuginfo-4.2.46-34.43.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'bash-debuginfo-4.2.46-34.43.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'bash-doc-4.2.46-34.43.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'bash-doc-4.2.46-34.43.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE}
];
