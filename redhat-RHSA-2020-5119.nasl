...
# extracted from Red Hat Security Advisory RHSA-2020:5119. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:5119");
  script_xref(name:"IAVB", value:"2020-B-0060-S");

  script_name(english:"RHEL 7 / 8 : OpenShift Container Platform 4.5.20 packages and golang (RHSA-2020:5119)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for OpenShift Container Platform 4.5.20 packages /
golang.");
...
referenced in the RHSA-2020:5119 advisory.
    ...
    * golang: ReadUvarint and ReadVarint can read an unlimited number of bytes from invalid inputs
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.5.20. See the following
    ...
    https://docs.openshift.com/container-platform/4.[y]/updating/updating-cluster-between-
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_5119.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?298b7578");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:5119");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1897972");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.5.20 packages / golang packages based on the guidance in RHSA-2020:5119.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cri-o-1.18.4-4.rhaos4.5.git6dee389.el8', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'cri-o-1.18.4-4.rhaos4.5.git6dee389.el8', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'cri-o-1.18.4-4.rhaos4.5.git6dee389.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'cri-o-1.18.4-4.rhaos4.5.git6dee389.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'cri-o-1.18.4-4.rhaos4.5.git6dee389.el7', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'cri-o-1.18.4-4.rhaos4.5.git6dee389.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
