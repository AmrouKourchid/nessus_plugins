...
# extracted from Oracle Linux Security Advisory ELSA-2023-6615.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : python-cryptography (ELSA-2023-6615)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-6615.html");
...
var pkgs = [
    {'reference':'python3-cryptography-36.0.1-4.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-cryptography-36.0.1-4.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
