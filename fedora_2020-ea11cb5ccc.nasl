...
# extracted from Fedora Security Advisory FEDORA-2020-ea11cb5ccc.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : mingw-gnutls (2020-ea11cb5ccc)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-ea11cb5ccc");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"mingw-gnutls-3.6.14-1.fc31")) flag++;
