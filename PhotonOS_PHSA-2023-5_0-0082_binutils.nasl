...
# extracted from VMware Security Advisory PHSA-2023-5.0-0082. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Binutils PHSA-2023-5.0-0082");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the binutils package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-5.0-82.md");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'binutils-2.39-5.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'binutils-devel-2.39-5.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'binutils-libs-2.39-5.ph5')) flag++;
