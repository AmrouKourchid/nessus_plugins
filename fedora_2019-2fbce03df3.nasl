...
# extracted from Fedora Security Advisory FEDORA-2019-2fbce03df3.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : drupal7 (2019-2fbce03df3)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-2fbce03df3");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"drupal7-7.65-1.fc28")) flag++;
