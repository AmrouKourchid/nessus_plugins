...
# extracted from Fedora Security Advisory FEDORA-2023-692921aeb2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-692921aeb2");

  script_name(english:"Fedora 40 : libheif (2023-692921aeb2)");
...
FEDORA-2023-692921aeb2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-692921aeb2");
...
"Update the affected libheif package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-49464");
...
var pkgs = [
    {'reference':'libheif-1.17.5-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
