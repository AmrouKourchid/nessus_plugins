...
if (description)
{
  ...
  script_name(english:"CentOS 6 : kernel (RHSA-2020:2430)");
...
var pkgs = [
    {'reference':'kernel-bootwrapper-2.6.32-754.30.2.el6', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kernel-kdump-2.6.32-754.30.2.el6', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kernel-kdump-devel-2.6.32-754.30.2.el6', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE}
];
