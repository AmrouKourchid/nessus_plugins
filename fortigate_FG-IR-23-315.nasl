...
if (description)
{
  ...
  script_name(english:"Fortinet Fortigate Improper authorization for HA requests (FG-IR-23-315)");
...
vulnerability as referenced in the FG-IR-23-315 advisory.

  - An improper privilege management vulnerability [CWE-269] in a Fortinet FortiOS HA cluster version 7.4.0
    through 7.4.1 and 7.2.5 and in a FortiProxy HA cluster version 7.4.0 through 7.4.1 allows an authenticated
    attacker to perform elevated actions via crafted HTTP or HTTPS requests. (CVE-2023-44250)
...
var constraints = [
  { 'min_version' : '7.2.5', 'fixed_version' : '7.2.6' },
