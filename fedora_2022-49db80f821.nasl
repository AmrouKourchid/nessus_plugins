...
# extracted from Fedora Security Advisory FEDORA-2022-49db80f821
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-49db80f821");

  script_name(english:"Fedora 36 : mingw-expat (2022-49db80f821)");
...
FEDORA-2022-49db80f821 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-49db80f821");
...
var pkgs = [
    {'reference':'mingw-expat-2.5.0-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
