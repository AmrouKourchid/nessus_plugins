...
# extracted from Ubuntu Security Notice USN-6374-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6374-2");

  script_name(english:"Ubuntu 23.10 : Mutt vulnerabilities (USN-6374-2)");
...
USN-6374-2 advisory.
    ...
    USN-6374-1 fixed vulnerabilities in Mutt. This update provides the corresponding updates for Ubuntu 23.10.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6374-2");
...
var pkgs = [
    {'osver': '23.10', 'pkgname': 'mutt', 'pkgver': '2.2.9-1ubuntu0.23.10.1'}
];
