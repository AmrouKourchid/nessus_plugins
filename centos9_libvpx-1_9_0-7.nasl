...
if (description)
{
  ...
  script_name(english:"CentOS 9 : libvpx-1.9.0-7.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing one or more security updates for libvpx.");
...
libvpx-1.9.0-7.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=39485");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream libvpx package.");
...
var pkgs = [
    {'reference':'libvpx-1.9.0-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libvpx-devel-1.9.0-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libvpx-utils-1.9.0-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
