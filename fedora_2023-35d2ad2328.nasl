...
# extracted from Fedora Security Advisory FEDORA-2023-35d2ad2328
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-35d2ad2328");

  script_name(english:"Fedora 39 : xen (2023-35d2ad2328)");
...
FEDORA-2023-35d2ad2328 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-35d2ad2328");
...
var pkgs = [
    {'reference':'xen-4.17.2-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
