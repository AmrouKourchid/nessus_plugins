...
# extracted from Fedora Security Advisory FEDORA-2023-26cbce3854
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-26cbce3854");

  script_name(english:"Fedora 38 : ntpsec (2023-26cbce3854)");
...
FEDORA-2023-26cbce3854 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-26cbce3854");
  script_set_attribute(attribute:"solution", value:
"Update the affected ntpsec package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:ntpsec");
...
var pkgs = [
    {'reference':'ntpsec-1.2.2a-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'ntpsec');
}
