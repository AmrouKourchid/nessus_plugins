...
# extracted from Red Hat Security Advisory RHSA-2018:3403 and 
# CentOS Errata and Security Advisory 2018:3403 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : thunderbird (CESA-2018:3403)");
...
original reporters.");
  # https://lists.centos.org/pipermail/centos-announce/2018-November/023078.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?70bb2967");
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"thunderbird-60.2.1-5.el6.centos", allowmaj:TRUE)) flag++;
