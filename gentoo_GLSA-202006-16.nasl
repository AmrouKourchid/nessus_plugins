...
# extracted from Gentoo Linux Security Advisory GLSA 202006-16.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202006-16");

  script_name(english:"GLSA-202006-16 : PCRE2: Denial of service");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202006-16
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202006-16");
...
"All PCRE2 users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:pcre2");
...
if (qpkg_check(package:"net-libs/pcre2", unaffected:make_list("ge 10.34"), vulnerable:make_list("lt 10.34"))) flag++;
