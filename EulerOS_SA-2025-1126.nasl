...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : openssl (EulerOS-SA-2025-1126)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1126
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?971b02c0");
...
var pkgs = [
  "openssl-1.1.1-3.h34.eulerosv2r8",
  "openssl-devel-1.1.1-3.h34.eulerosv2r8",
  "openssl-libs-1.1.1-3.h34.eulerosv2r8",
  "openssl-perl-1.1.1-3.h34.eulerosv2r8"
];
