...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS / 22.04 LTS : GnuTLS vulnerability (USN-5901-1)");
...
in the USN-5901-1 advisory.
    ...
    Hubert Kario discovered that GnuTLS had a timing side-channel when handling certain RSA messages. A remote
