...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Docker PHSA-2020-2.0-0235");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'docker-18.06.2-7.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'docker-doc-18.06.2-7.ph2')) flag++;
