...
# AlmaLinux Security Advisory ALSA-2023:7734.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:7734");

  script_name(english:"AlmaLinux 9 : kpatch-patch (ALSA-2023:7734)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2023-7734.html");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for ALSA-2023:7734');
  }
  else
  {
...
var pkgs = [
    {'reference':'kernel-5.14.0-362.8.1.el9_3', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
