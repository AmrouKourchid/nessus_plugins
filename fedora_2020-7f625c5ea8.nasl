...
# extracted from Fedora Security Advisory FEDORA-2020-7f625c5ea8.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : glibc (2020-7f625c5ea8)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"This update incorporates fixes from the upstream glibc 2.29 stable
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-7f625c5ea8");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"glibc-2.29-29.fc30")) flag++;
