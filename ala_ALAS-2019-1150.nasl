...
# extracted from Amazon Linux AMI Security Advisory ALAS-2019-1150.
#
...
if (description)
{
  ...
  script_name(english:"Amazon Linux AMI : libXcursor (ALAS-2019-1150)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux AMI host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"_XcursorThemeInherits in library.c in libXcursor allows remote
attackers to cause denial of service or potentially code execution via
a one-byte heap overflow. (CVE-2015-9262)");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/ALAS-2019-1150.html");
...
flag = 0;
if (rpm_check(release:"ALA", reference:"libXcursor-1.1.14-2.1.10.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"libXcursor-debuginfo-1.1.14-2.1.10.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"libXcursor-devel-1.1.14-2.1.10.amzn1")) flag++;
