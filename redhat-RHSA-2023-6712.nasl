...
# extracted from Red Hat Security Advisory RHSA-2023:6712. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:6712");

  script_name(english:"RHEL 9 : python-wheel (RHSA-2023:6712)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for python-wheel.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6712.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?05fd2fea");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6712");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-wheel package based on the guidance in RHSA-2023:6712.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-wheel-0.36.2-8.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'python3-wheel-wheel-0.36.2-8.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
