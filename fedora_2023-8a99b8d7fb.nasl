...
# extracted from Fedora Security Advisory FEDORA-2023-8a99b8d7fb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-8a99b8d7fb");

  script_name(english:"Fedora 38 : java-17-openjdk (2023-8a99b8d7fb)");
...
FEDORA-2023-8a99b8d7fb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-8a99b8d7fb");
...
var pkgs = [
    {'reference':'java-17-openjdk-17.0.8.0.7-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
