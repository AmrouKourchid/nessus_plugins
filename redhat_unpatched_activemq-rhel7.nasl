...
# extracted from Red Hat Security Advisory activemq. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2013-6429");

  script_name(english:"RHEL 7 : activemq (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-6429");
