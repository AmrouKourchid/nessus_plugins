...
# extracted from Red Hat Security Advisory RHSA-2022:5479. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:5479");
  script_xref(name:"IAVA", value:"2022-A-0226-S");
  script_xref(name:"IAVA", value:"2022-A-0256-S");

  script_name(english:"RHEL 7 : firefox (RHSA-2022:5479)");
...
referenced in the RHSA-2022:5479 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_5479.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?70e28478");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:5479");
...
"Update the RHEL firefox package based on the guidance in RHSA-2022:5479.");
  ...
  script_cwe_id(79, 120, 190, 393, 416, 1021, 1321);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-91.11.0-2.el7_9', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-91.11.0-2.el7_9', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-91.11.0-2.el7_9', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-91.11.0-2.el7_9', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-91.11.0-2.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
