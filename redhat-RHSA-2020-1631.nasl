...
# extracted from Red Hat Security Advisory RHSA-2020:1631. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:1631");

  script_name(english:"RHEL 8 : GStreamer, libmad, and SDL (RHSA-2020:1631)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2020:1631 advisory.
    ...
    Simple DirectMedia Layer (SDL) is a cross-platform multimedia library designed to provide fast access to
    the graphics frame buffer and audio device.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_1631.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c4b5e011");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/8.2_release_notes/index
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dd7b3f20");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:1631");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:SDL2");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:SDL2-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:SDL2-static");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:gstreamer1-plugins-good-gtk");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:gstreamer1-plugins-ugly-free");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:libmad");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:libmad-devel");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gstreamer1-plugins-bad-free-1.16.1-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gstreamer1-plugins-bad-free-devel-1.16.1-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libmad-0.15.1b-25.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libmad-devel-0.15.1b-25.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'gstreamer1-1.16.1-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gstreamer1-devel-1.16.1-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gstreamer1-plugins-base-1.16.1-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gstreamer1-plugins-base-devel-1.16.1-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gstreamer1-plugins-good-1.16.1-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'gstreamer1-plugins-good-gtk-1.16.1-1.el8', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gstreamer1-plugins-good-gtk-1.16.1-1.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gstreamer1-plugins-ugly-free-1.16.1-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'orc-0.4.28-3.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'orc-compiler-0.4.28-3.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'orc-devel-0.4.28-3.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'SDL-1.2.15-37.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'SDL-devel-1.2.15-37.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'SDL2-2.0.10-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'SDL2-devel-2.0.10-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'SDL2-static-2.0.10-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'SDL / SDL-devel / SDL2 / SDL2-devel / SDL2-static / gstreamer1 / etc');
}
