...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5053598");
  script_xref(name:"MSFT", value:"MS25-5053598");
  ...
  script_name(english:"KB5053598: Windows 11 Version 24H2 / Windows Server 2025 Security Update (March 2025)");
...
"The remote Windows host is missing security update 5053598. It is, therefore, affected by multiple vulnerabilities
  ...
  - Sensitive data storage in improperly locked memory in Windows Remote Desktop Services allows an
    unauthorized attacker to execute code over a network. (CVE-2025-24035, CVE-2025-24045)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5053598");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5053636");
...
var wmi_patch_found = get_kb_item("WMI/Installed/Hotfix/KB5053636"); 
...
if (
  smb_check_rollup(os:'10',
                   ...
                   rollup_date:'03_2025',
                   bulletin:bulletin,
                   rollup_kb_list:[5053598, 5053636])
)
{
