...
# extracted from Fedora Security Advisory FEDORA-2023-c92eb29264
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-c92eb29264");
  script_xref(name:"IAVA", value:"2023-A-0585-S");

  script_name(english:"Fedora 39 : firefox (2023-c92eb29264)");
...
FEDORA-2023-c92eb29264 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-c92eb29264");
...
var pkgs = [
    {'reference':'firefox-117.0-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
