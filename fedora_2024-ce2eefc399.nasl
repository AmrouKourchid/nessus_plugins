...
# extracted from Fedora Security Advisory FEDORA-2024-ce2eefc399
#
...
if (description)
{
  ...
  script_cve_id("CVE-2023-45288", "CVE-2024-3177");
  script_xref(name:"IAVB", value:"2024-B-0042");
  script_xref(name:"FEDORA", value:"2024-ce2eefc399");

  script_name(english:"Fedora 40 : kubernetes (2024-ce2eefc399)");
...
FEDORA-2024-ce2eefc399 advisory.

    Update Kubernetes to v1.29.4 for Fedora 40. Resolves CVE-2024-3177: Bypassing mountable secrets policy
    imposed by the ServiceAccount admission plugin.

    Additional bug and regression fixes include a bump to Golang.org/x/net to v0.23.0 to address
    CVE-2023-45288 .
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-ce2eefc399");
...
var pkgs = [
    {'reference':'kubernetes-1.29.4-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
