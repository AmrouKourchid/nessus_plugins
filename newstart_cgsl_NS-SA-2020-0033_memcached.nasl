...
# extracted from ZTE advisory NS-SA-2020-0033. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 6.01 : memcached Vulnerability (NS-SA-2020-0033)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 6.01, has memcached packages installed that are affected by a
vulnerability:

  - In memcached before 1.5.14, a NULL pointer dereference
...
number.");
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/notice/NS-SA-2020-0033");
  script_set_attribute(attribute:"solution", value:
"Upgrade the vulnerable CGSL memcached packages. Note that updated packages may not be available yet. Please contact ZTE
...
pkgs = {
  "CGSL MAIN 6.01": [
    ...
    "memcached-debuginfo-1.5.9-3.el8",
    "memcached-debugsource-1.5.9-3.el8",
    "memcached-devel-1.5.9-3.el8"
  ]
};
