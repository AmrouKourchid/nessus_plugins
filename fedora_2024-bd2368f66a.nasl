...
# extracted from Fedora Security Advisory FEDORA-2024-bd2368f66a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-bd2368f66a");

  script_name(english:"Fedora 41 : haproxy (2024-bd2368f66a)");
...
FEDORA-2024-bd2368f66a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-bd2368f66a");
...
var pkgs = [
    {'reference':'haproxy-3.0.4-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
