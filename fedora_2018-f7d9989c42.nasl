...
# extracted from Fedora Security Advisory FEDORA-2018-f7d9989c42.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : nettle (2018-f7d9989c42)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"Security fix for CVE-2018-16869

Note that Tenable Network Security has extracted the preceding
description block directly from the Fedora update system website.
Tenable has attempted to automatically clean and format it as much as
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-f7d9989c42");
...
"Update the affected nettle package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:nettle");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"nettle-3.4.1-1.fc28")) flag++;
