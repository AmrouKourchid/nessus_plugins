...
"The version of Tomcat installed on the remote host is prior to 11.0.0.M3. It is, therefore, affected by multiple
vulnerabilities as referenced in the fixed_in_apache_tomcat_11.0.0-m3_security-11 advisory.
...
var constraints = [
  { 'min_version' : '11.0.0.M1', 'max_version' : '11.0.0.M2', 'fixed_version' : '11.0.0.M3' }
];
