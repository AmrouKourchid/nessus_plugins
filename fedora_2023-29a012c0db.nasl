...
# extracted from Fedora Security Advisory FEDORA-2023-29a012c0db
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-29a012c0db");

  script_name(english:"Fedora 38 : subscription-manager (2023-29a012c0db)");
...
FEDORA-2023-29a012c0db advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-29a012c0db");
...
var pkgs = [
    {'reference':'subscription-manager-1.29.37-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
