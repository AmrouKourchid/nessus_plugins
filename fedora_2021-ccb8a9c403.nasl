...
# extracted from Fedora Security Advisory FEDORA-2021-ccb8a9c403
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : golang-github-containernetworking-plugins (2021-ccb8a9c403)");
...
FEDORA-2021-ccb8a9c403 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-ccb8a9c403");
  script_set_attribute(attribute:"solution", value:
"Update the affected golang-github-containernetworking-plugins package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:golang-github-containernetworking-plugins");
...
pkgs = [
    {'reference':'golang-github-containernetworking-plugins-0.9.0-1.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'golang-github-containernetworking-plugins');
}
