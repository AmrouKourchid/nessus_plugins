...
if (description)
{
  ...
  script_cve_id("CVE-2021-30560", "CVE-2022-29824");

  script_name(english:"Photon OS 4.0: Libxslt PHSA-2022-4.0-0198");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libxslt-1.1.34-5.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libxslt-devel-1.1.34-5.ph4')) flag++;
