...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_4325.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?06cfde92");
...
"Update the RHEL lasso package based on the guidance in RHSA-2021:4325.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'lasso-2.6.0-12.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'lasso-devel-2.6.0-12.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
