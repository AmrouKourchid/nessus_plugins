...
"The remote Red Hat host is missing a security update for OpenShift Container Platform 4.1.17 cri-o.");
...
in the RHSA-2019:2825 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_2825.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?934b9bd3");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:2825");
...
"Update the RHEL OpenShift Container Platform 4.1.17 cri-o package based on the guidance in RHSA-2019:2825.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cri-o-1.13.11-0.7.dev.rhaos4.1.git9cb8f2f.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'cri-o-1.13.11-0.4.dev.rhaos4.1.git9cb8f2f.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
