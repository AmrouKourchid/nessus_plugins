...
if (description)
{
  ...
  script_cve_id("CVE-2021-30640", "CVE-2021-42340");
  script_xref(name:"IAVA", value:"2022-A-0168-S");

  script_name(english:"Photon OS 3.0: Apache PHSA-2021-3.0-0327");
...
if (rpm_check(release:'PhotonOS-3.0', reference:'apache-tomcat-8.5.72-1.ph3')) flag++;
