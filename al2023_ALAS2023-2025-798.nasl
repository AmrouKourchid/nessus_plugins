...
# extracted from Amazon Linux 2023 Security Advisory ALAS2023-2025-798.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2023 : jackson-databind (ALAS2023-2025-798)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2023 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"It is, therefore, affected by a vulnerability as referenced in the ALAS2023-2025-798 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2023/ALAS-2025-798.html");
...
var pkgs = [
    {'reference':'jackson-databind-2.11.4-6.amzn2023.0.3', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE}
];
