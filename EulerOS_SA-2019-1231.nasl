...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.4 : binutils (EulerOS-SA-2019-1231)");
...
the following vulnerability :
  ...
  - binutils version 2.32 and earlier contains a Integer
    ...
    3a551c7a1b80fca579461774860574eabfd7f18f.i1/4^CVE-2018-10
    00876i1/4%0
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1231
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?40e1369f");
...
pkgs = ["binutils-2.27-28.base.1.h12"];
