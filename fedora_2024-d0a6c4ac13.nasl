...
# extracted from Fedora Security Advisory FEDORA-2024-d0a6c4ac13
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-d0a6c4ac13");

  script_name(english:"Fedora 39 : lemonldap-ng (2024-d0a6c4ac13)");
...
FEDORA-2024-d0a6c4ac13 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-d0a6c4ac13");
...
var pkgs = [
    {'reference':'lemonldap-ng-2.20.1-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
