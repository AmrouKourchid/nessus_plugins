...
# extracted from Red Hat Security Advisory RHSA-2018:2892 and 
# Oracle Linux Security Advisory ELSA-2018-2892 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : glusterfs (ELSA-2018-2892)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2018-2892.html");
