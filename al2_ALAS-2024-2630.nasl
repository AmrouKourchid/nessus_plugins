...
# extracted from Amazon Linux 2 Security Advisory ALAS-2024-2630.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : amazon-cloudwatch-agent (ALAS-2024-2630)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of amazon-cloudwatch-agent installed on the remote host is prior to 1.300044.0-1. It is, therefore, affected
by multiple vulnerabilities as referenced in the ALAS2-2024-2630 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2024-2630.html");
...
var pkgs = [
    {'reference':'amazon-cloudwatch-agent-1.300044.0-1.amzn2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'amazon-cloudwatch-agent-1.300044.0-1.amzn2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
