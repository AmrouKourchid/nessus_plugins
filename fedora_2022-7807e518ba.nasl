...
# extracted from Fedora Security Advisory FEDORA-2022-7807e518ba
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-7807e518ba");

  script_name(english:"Fedora 37 : stb (2022-7807e518ba)");
...
FEDORA-2022-7807e518ba advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-7807e518ba");
...
"Update the affected stb package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-28041");
...
var pkgs = [
    {'reference':'stb-0^20210910gitaf1a5bc-0.2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
