...
# extracted from Amazon Linux 2 Security Advisory ALAS-2024-2514.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : tomcat (ALAS-2024-2514)");
...
as referenced in the ALAS2-2024-2514 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2024-2514.html");
...
var pkgs = [
    {'reference':'tomcat-7.0.76-10.amzn2.0.8', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tomcat-admin-webapps-7.0.76-10.amzn2.0.8', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tomcat-docs-webapp-7.0.76-10.amzn2.0.8', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tomcat-el-2.2-api-7.0.76-10.amzn2.0.8', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tomcat-javadoc-7.0.76-10.amzn2.0.8', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tomcat-jsp-2.2-api-7.0.76-10.amzn2.0.8', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tomcat-jsvc-7.0.76-10.amzn2.0.8', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tomcat-lib-7.0.76-10.amzn2.0.8', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tomcat-servlet-3.0-api-7.0.76-10.amzn2.0.8', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tomcat-webapps-7.0.76-10.amzn2.0.8', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
