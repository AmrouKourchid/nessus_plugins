...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Libgcrypt PHSA-2021-3.0-0327");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the libgcrypt package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-3.0-327.md");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libgcrypt-1.8.8-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libgcrypt-devel-1.8.8-1.ph3')) flag++;
