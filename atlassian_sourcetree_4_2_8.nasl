...
if (description)
{
  ...
  script_name(english:"Atlassian SourceTree 4.2.8 RCE");

  script_set_attribute(attribute:"synopsis", value:
"The version of Atlassian SourceTree installed on the remote MacOS host is affected by a remote code execution
vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Atlassian SourceTree installed on the remote MacOS host is version 4.2.8. It is, therefore, affected
...
"Upgrade to Atlassian SourceTree 4.2.9 or later.");
  ...
  script_require_keys("installed_sw/SourceTree", "Host/MacOSX/Version");
...
var constraints = [{ 'min_version' : '4.2.8', 'fixed_version' : '4.2.9' }];
