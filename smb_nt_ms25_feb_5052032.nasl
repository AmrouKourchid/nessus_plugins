...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5052016");
  script_xref(name:"MSKB", value:"5052032");
  script_xref(name:"MSFT", value:"MS25-5052016");
  script_xref(name:"MSFT", value:"MS25-5052032");
  ...
  script_name(english:"KB5052032: Windows Server 2008 R2 Security Update (February 2025)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5052016");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5052032");
...
if (("windows server 2008 r2" >< tolower(os_name)) &&
  smb_check_rollup(os:'6.1',
                   ...
                   rollup_date:'02_2025',
                   bulletin:bulletin,
                   rollup_kb_list:[5052032, 5052016])
)
{
