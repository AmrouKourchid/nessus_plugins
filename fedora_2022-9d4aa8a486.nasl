...
# extracted from Fedora Security Advisory FEDORA-2022-9d4aa8a486
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-9d4aa8a486");

  script_name(english:"Fedora 37 : wireshark (2022-9d4aa8a486)");
...
FEDORA-2022-9d4aa8a486 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-9d4aa8a486");
...
var pkgs = [
    {'reference':'wireshark-4.0.2-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
