...
# AlmaLinux Security Advisory ALSA-2025:1350.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2025:1350");
  script_xref(name:"RHSA", value:"2025:1350");

  script_name(english:"AlmaLinux 9 : libxml2 (ALSA-2025:1350)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2025-1350.html");
...
var pkgs = [
    {'reference':'libxml2-2.9.13-6.el9_5.1', 'release':'9', 'el_string':'el9_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'libxml2-devel-2.9.13-6.el9_5.1', 'release':'9', 'el_string':'el9_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'python3-libxml2-2.9.13-6.el9_5.1', 'release':'9', 'el_string':'el9_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'}
];
