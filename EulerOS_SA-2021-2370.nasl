...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : freerdp (EulerOS-SA-2021-2370)");
...
vulnerabilities :
  ...
  - Iibfreerdp/core/update.c in FreeRDP versions > 1.1
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2370
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1d955f18");
