...
# extracted from Red Hat Security Advisory RHSA-2024:9551. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:9551");

  script_name(english:"RHEL 9 : grafana-pcp (RHSA-2024:9551)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for grafana-pcp.");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_9551.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?16529401");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:9551");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL grafana-pcp package based on the guidance in RHSA-2024:9551.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'grafana-pcp-5.1.1-4.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
