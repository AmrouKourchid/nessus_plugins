...
# extracted from Red Hat Security Advisory RHSA-2023:5222. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:5222");

  script_name(english:"RHEL 8 : libwebp (RHSA-2023:5222)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for libwebp.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2023:5222 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_5222.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c5cc1e19");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2238431");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:5222");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libwebp package based on the guidance in RHSA-2023:5222.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libwebp-1.0.0-7.el8_4.1', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libwebp-1.0.0-7.el8_4.1', 'sp':'4', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libwebp-1.0.0-7.el8_4.1', 'sp':'4', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libwebp-devel-1.0.0-7.el8_4.1', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libwebp-devel-1.0.0-7.el8_4.1', 'sp':'4', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libwebp-devel-1.0.0-7.el8_4.1', 'sp':'4', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
