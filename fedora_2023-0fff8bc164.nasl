...
# extracted from Fedora Security Advisory FEDORA-2023-0fff8bc164
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-0fff8bc164");

  script_name(english:"Fedora 36 : caddy (2023-0fff8bc164)");
...
FEDORA-2023-0fff8bc164 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-0fff8bc164");
...
var pkgs = [
    {'reference':'caddy-2.4.6-5.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
