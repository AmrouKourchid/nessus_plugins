...
# extracted from Fedora Security Advisory FEDORA-2023-fde38dda12
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-fde38dda12");

  script_name(english:"Fedora 37 : moby-engine (2023-fde38dda12)");
...
FEDORA-2023-fde38dda12 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-fde38dda12");
...
var pkgs = [
    {'reference':'moby-engine-20.10.22-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
