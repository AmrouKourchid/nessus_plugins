...
# SUSE update advisory SUSE-SU-2022:3596-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:3596-1");

  script_name(english:"SUSE SLES15 Security Update : squid (SUSE-SU-2022:3596-1)");
...
referenced in the SUSE-SU-2022:3596-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-October/012545.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bdcd8870");
...
var pkgs = [
    {'reference':'squid-4.17-150000.5.35.1', 'sp':'2', 'cpu':'x86_64', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.2']},
    {'reference':'squid-4.17-150000.5.35.1', 'sp':'3', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.3']},
    {'reference':'squid-4.17-150000.5.35.1', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.3', 'sle-module-server-applications-release-15.3', 'sles-release-15.3']}
];
