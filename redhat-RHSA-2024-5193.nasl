...
# extracted from Red Hat Security Advisory RHSA-2024:5193. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:5193");

  script_name(english:"RHEL 8 : httpd:2.4 (RHSA-2024:5193)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for httpd:2.4.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:5193 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_5193.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d57ce3e7");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:5193");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL httpd:2.4 package based on the guidance in RHSA-2024:5193.");
  ...
  'httpd:2.4': [
    {
      ...
      'pkgs': [
        {'reference':'httpd-2.4.37-65.module+el8.10.0+22196+d82931da.2', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'httpd-devel-2.4.37-65.module+el8.10.0+22196+d82931da.2', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'httpd-filesystem-2.4.37-65.module+el8.10.0+22196+d82931da.2', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'httpd-manual-2.4.37-65.module+el8.10.0+22196+d82931da.2', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'httpd-tools-2.4.37-65.module+el8.10.0+22196+d82931da.2', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mod_http2-1.15.7-10.module+el8.10.0+21653+eaff63f0', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mod_ldap-2.4.37-65.module+el8.10.0+22196+d82931da.2', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mod_md-2.0.8-8.module+el8.9.0+19080+567b90f8', 'release':'8', 'el_string':'el8.9.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'mod_proxy_html-2.4.37-65.module+el8.10.0+22196+d82931da.2', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'mod_session-2.4.37-65.module+el8.10.0+22196+d82931da.2', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mod_ssl-2.4.37-65.module+el8.10.0+22196+d82931da.2', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
      ]
    }
  ]
};
