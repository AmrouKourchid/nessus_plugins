...
# extracted from Fedora Security Advisory FEDORA-2023-5993ffa09a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-5993ffa09a");

  script_name(english:"Fedora 36 : pcs (2023-5993ffa09a)");
...
FEDORA-2023-5993ffa09a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-5993ffa09a");
...
"Update the affected pcs package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:pcs");
...
var pkgs = [
    {'reference':'pcs-0.11.5-2.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
