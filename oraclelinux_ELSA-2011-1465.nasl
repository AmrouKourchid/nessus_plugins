...
ELSA-2011-1465 advisory.
    ...
    - [net] vlan: fix panic when handling priority tagged frames (Andy Gospodarek) [742849 714936]
    {CVE-2011-3593}
    ...
    - [fs] cifs: add fallback in is_path_accessible for old servers (Jeff Layton) [738301 692709]
    {CVE-2011-3363}
    - [fs] cifs: always do is_path_accessible check in cifs_mount (Jeff Layton) [738301 692709]
    {CVE-2011-3363}
    - [net] ipv6: make fragment identifications less predictable (Jiri Pirko) [723432 723433] {CVE-2011-2699}
    - [netdrv] b43: allocate receive buffers big enough for max frame len + offset (RuiRui Yang) [738204
    738205] {CVE-2011-3359}
    ...
    - [kernel] perf tools: do not look at ./config for configuration (Jiri Benc) [730203 730204]
    {CVE-2011-2905}
    - [fs] corrupted GUID partition tables can cause kernel oops (Jerome Marchand) [695981 695982]
    {CVE-2011-1577}
    - [net] Compute protocol sequence numbers and fragment IDs using MD5. (Jiri Pirko) [732664 732665]
    {CVE-2011-3188}
...
var pkgs = [
    ...
    {'reference':'kernel-firmware-2.6.32-131.21.1.el6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-firmware-2.6.32'},
    ...
    {'reference':'kernel-firmware-2.6.32-131.21.1.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-firmware-2.6.32'},
