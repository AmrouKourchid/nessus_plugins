...
# extracted from Oracle Linux Security Advisory ELSA-2023-13027.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : edk2 (ELSA-2023-13027)");
...
ELSA-2023-13027 advisory.

    - Create new 20230821 release for OL7 which includes the following fixed CVEs:
      CVE-2019-14560
    ...
    CVE-2021-4160 CVE-2021-3712 CVE-2021-3711 CVE-2021-3450 CVE-2021-3449 CVE-2021-23841 CVE-2021-23840
    CVE-2020-1971 CVE-2020-1967 CVE-2019-1551 CVE-2019-1563 CVE-2019-1549 CVE-2019-1547 CVE-2019-1552
    CVE-2019-1543 CVE-2018-0734 CVE-2018-0735

Tenable has extracted the preceding description block directly from the Oracle Linux security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-13027.html");
...
var pkgs = [
    {'reference':'AAVMF-1.6.6-1.el7', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
