...
# Oracle Linux Security Advisory ELSA-2010-0361 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : sudo (ELSA-2010-0361)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2010-0361.html");
...
"Update the affected sudo package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2010-1163");
...
var pkgs = [
    {'reference':'sudo-1.7.2p1-6.el5_5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sudo-1.7.2p1-6.el5_5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
