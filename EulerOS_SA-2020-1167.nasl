...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : nginx (EulerOS-SA-2020-1167)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the version of the nginx packages installed, the EulerOS
installation on the remote host is affected by the following
vulnerability :

  - NGINX before 1.17.7, with certain error_page
    configurations, allows HTTP request smuggling, as
    demonstrated by the ability of an attacker to read
    unauthorized web pages in environments where NGINX is
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1167
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e620b0f9");
...
pkgs = ["nginx-1.12.1-14.h2.eulerosv2r8",
        "nginx-all-modules-1.12.1-14.h2.eulerosv2r8",
        "nginx-filesystem-1.12.1-14.h2.eulerosv2r8",
        "nginx-mod-http-image-filter-1.12.1-14.h2.eulerosv2r8",
        "nginx-mod-http-perl-1.12.1-14.h2.eulerosv2r8",
        "nginx-mod-http-xslt-filter-1.12.1-14.h2.eulerosv2r8",
        "nginx-mod-mail-1.12.1-14.h2.eulerosv2r8",
        "nginx-mod-stream-1.12.1-14.h2.eulerosv2r8"];
