...
# extracted from Red Hat Security Advisory RHSA-2021:4916. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:4916");

  script_name(english:"RHEL 8 : mailman:2.1 (RHSA-2021:4916)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_4916.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d83cf225");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:4916");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2026862");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL mailman:2.1 package based on the guidance in RHSA-2021:4916.");
  ...
  'mailman:2.1': [
    {
      ...
      'pkgs': [
        {'reference':'mailman-2.1.29-12.module+el8.5.0+13466+327eb9f3.2', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'}
      ]
    }
  ]
};
