...
# extracted from Fedora Security Advisory FEDORA-2025-e717eae403
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-e717eae403");

  script_name(english:"Fedora 40 : stalld (2025-e717eae403)");
...
FEDORA-2025-e717eae403 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-e717eae403");
...
var pkgs = [
    {'reference':'stalld-1.19.8-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
