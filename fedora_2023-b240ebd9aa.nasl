...
# extracted from Fedora Security Advisory FEDORA-2023-b240ebd9aa
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-b240ebd9aa");

  script_name(english:"Fedora 39 : ghostscript (2023-b240ebd9aa)");
...
FEDORA-2023-b240ebd9aa advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-b240ebd9aa");
...
var pkgs = [
    {'reference':'ghostscript-10.01.2-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
