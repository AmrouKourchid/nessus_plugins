...
# Red Hat Security Advisory RHSA-2021:4139. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : resource-agents (CESA-2021:4139)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
CESA-2021:4139 advisory.
...
var pkgs = [
    ...
    {'reference':'resource-agents-aliyun-4.1.1-98.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'resource-agents-aliyun-4.1.1-98.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'resource-agents-gcp-4.1.1-98.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
