...
# extracted from openSUSE Security Update openSUSE-2020-1666.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : tigervnc (openSUSE-2020-1666)");
...
"This update for tigervnc fixes the following issues :
  ...
  - CVE-2020-26117: Server certificates were stored as
    certiticate authorities, allowing malicious owners of
    these certificates to impersonate any server after a
    client had added an exception (bsc#1176733)

This update was imported from the SUSE:SLE-15-SP1:Update update
project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1176733");
...
if ( rpm_check(release:"SUSE15.2", reference:"libXvnc-devel-1.9.0-lp152.7.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libXvnc1-1.9.0-lp152.7.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libXvnc1-debuginfo-1.9.0-lp152.7.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"tigervnc-1.9.0-lp152.7.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"tigervnc-debuginfo-1.9.0-lp152.7.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"tigervnc-debugsource-1.9.0-lp152.7.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"tigervnc-x11vnc-1.9.0-lp152.7.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"xorg-x11-Xvnc-1.9.0-lp152.7.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"xorg-x11-Xvnc-debuginfo-1.9.0-lp152.7.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"xorg-x11-Xvnc-java-1.9.0-lp152.7.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"xorg-x11-Xvnc-module-1.9.0-lp152.7.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"xorg-x11-Xvnc-module-debuginfo-1.9.0-lp152.7.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"xorg-x11-Xvnc-novnc-1.9.0-lp152.7.3.1") ) flag++;
