...
# extracted from Red Hat Security Advisory RHSA-2021:0656 and
# CentOS Errata and Security Advisory 2021:0656 respectively.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : firefox (RHSA-2021:0656)");
...
var pkgs = [
    {'reference':'firefox-78.8.0-1.el7.centos', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-78.8.0-1.el7.centos', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
