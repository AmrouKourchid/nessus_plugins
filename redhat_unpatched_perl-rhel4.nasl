...
# extracted from Red Hat Security Advisory perl. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2011-4116", "CVE-2012-5195", "CVE-2014-4330");

  script_name(english:"RHEL 4 : perl (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2011-4116");
