...
if (description)
{
  ...
  script_cve_id("CVE-2022-49280");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-49280");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: NFSD: prevent underflow in
    nfssvc_decode_writeargs() Smatch complains: fs/nfsd/nfsxdr.c:341 nfssvc_decode_writeargs() warn: no lower
    bound on 'args->len' Change the type to unsigned to prevent this issue. (CVE-2022-49280)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-49280");
