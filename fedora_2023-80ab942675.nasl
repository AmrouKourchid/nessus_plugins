...
# extracted from Fedora Security Advisory FEDORA-2023-80ab942675
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-80ab942675");

  script_name(english:"Fedora 37 : rust-ybaas / rust-yubibomb (2023-80ab942675)");
...
FEDORA-2023-80ab942675 advisory.

    - Update yubibomb to version 0.2.12.
    - Update ybaas to version 0.0.16.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-80ab942675");
  script_set_attribute(attribute:"solution", value:
"Update the affected rust-ybaas and / or rust-yubibomb packages.");
...
var pkgs = [
    {'reference':'rust-ybaas-0.0.16-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-yubibomb-0.2.12-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'rust-ybaas / rust-yubibomb');
}
