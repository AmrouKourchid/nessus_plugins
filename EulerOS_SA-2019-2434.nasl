...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : libXi (EulerOS-SA-2019-2434)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the libXi packages installed, the
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2434
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d65275e8");
...
"Update the affected libXi packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:libXi-devel");
...
pkgs = ["libXi-1.7.4-2.h1",
        "libXi-devel-1.7.4-2.h1"];
