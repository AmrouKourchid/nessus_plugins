...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2025-A-0252");

  script_name(english:"Joomla 4.0.x < 4.4.13 / 5.0.x < 5.2.6 Joomla 5.2.6 Security Release (5925-joomla-5-2-6-security-release)");
...
4.4.13 or 5.0.x prior to 5.2.6. It is, therefore, affected by a vulnerability.

  - Insufficient state checks lead to a vector that allows to bypass 2FA checks. (CVE-2025-25227)
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a1091557");
  # https://developer.joomla.org/security-centre/964-20250402-core-mfa-authentication-bypass.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?65247bfd");
  # https://www.joomla.org/announcements/release-news/5925-joomla-5-2-6-security-release.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?26a07d6d");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Joomla! version 4.4.13 / 5.2.6 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:P/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:H/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-25227");
...
var constraints = [
  { 'min_version' : '4.0.0', 'max_version' : '4.4.12', 'fixed_version' : '4.4.13' },
  { 'min_version' : '5.0.0', 'max_version' : '5.2.5', 'fixed_version' : '5.2.6' }
];
