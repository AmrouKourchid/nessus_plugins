...
vulnerability.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K12403422");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K12403422.");
...
var vmatrix = {
  'ASM': {
    'affected': [
      '13.0.0-13.1.0','12.1.0-12.1.3','11.6.1-11.6.3','11.5.1-11.5.5'
    ],
    'unaffected': [
      '13.1.0.2','12.1.3.6','11.6.3.2','11.5.6'
    ],
  }
};
