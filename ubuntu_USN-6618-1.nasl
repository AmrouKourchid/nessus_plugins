...
# extracted from Ubuntu Security Notice USN-6618-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6618-1");

  script_name(english:"Ubuntu 20.04 LTS / 22.04 LTS / 23.10 : Pillow vulnerabilities (USN-6618-1)");
...
vulnerabilities as referenced in the USN-6618-1 advisory.

    It was discovered that Pillow incorrectly handled certain long text arguments. An attacker could possibly
    use this issue to cause Pillow to consume resources, leading to a denial of service. This issue only
    affected Ubuntu 20.04 LTS, and Ubuntu 22.04 LTS. (CVE-2023-44271)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6618-1");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'python3-pil', 'pkgver': '7.0.0-4ubuntu0.8'},
    {'osver': '20.04', 'pkgname': 'python3-pil.imagetk', 'pkgver': '7.0.0-4ubuntu0.8'},
    {'osver': '22.04', 'pkgname': 'python3-pil', 'pkgver': '9.0.1-1ubuntu0.2'},
    {'osver': '22.04', 'pkgname': 'python3-pil.imagetk', 'pkgver': '9.0.1-1ubuntu0.2'},
    {'osver': '23.10', 'pkgname': 'python3-pil', 'pkgver': '10.0.0-1ubuntu0.1'},
    {'osver': '23.10', 'pkgname': 'python3-pil.imagetk', 'pkgver': '10.0.0-1ubuntu0.1'}
];
