...
if (description)
{
  ...
  script_name(english:"Mozilla Firefox < 64.0 Multiple Vulnerabilities");
...
mozilla_check_version(installs:installs, product:'firefox', esr:FALSE, fix:'64.0', severity:SECURITY_HOLE);
