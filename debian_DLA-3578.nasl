...
# extracted from Debian Security Advisory dla-3578. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3578 : liblldpctl-dev - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3578
advisory.

    -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3578-1                debian-lts@lists.debian.org
...
"Upgrade the liblldpctl-dev packages.");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'liblldpctl-dev', 'reference': '1.0.3-1+deb10u2'},
    {'release': '10.0', 'prefix': 'lldpd', 'reference': '1.0.3-1+deb10u2'}
];
