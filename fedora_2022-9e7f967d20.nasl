...
# extracted from Fedora Security Advisory FEDORA-2022-9e7f967d20
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-9e7f967d20");

  script_name(english:"Fedora 37 : llhttp (2022-9e7f967d20)");
...
FEDORA-2022-9e7f967d20 advisory.

    Update to v6.0.10

    - Disable chunked on obs (https://github.com/nodejs/llhttp/pull/196)

    https://github.com/nodejs/llhttp/compare/v6.0.9...v6.0.10
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-9e7f967d20");
  script_set_attribute(attribute:"solution", value:
"Update the affected llhttp package.");
...
var pkgs = [
    {'reference':'llhttp-6.0.10-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'llhttp');
}
