...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Wpa_Supplicant PHSA-2022-3.0-0358");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'wpa_supplicant-2.10-1.ph3')) flag++;
