...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : ppp (EulerOS-SA-2019-2298)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2298
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2f28a4a6");
...
pkgs = ["network-scripts-ppp-2.4.7-26.h1.eulerosv2r8",
        "ppp-2.4.7-26.h1.eulerosv2r8"];
