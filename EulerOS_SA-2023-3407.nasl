...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : openssh (EulerOS-SA-2023-3407)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3407
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b6c3a57d");
...
var pkgs = [
  "openssh-7.4p1-16.h27.eulerosv2r7",
  "openssh-askpass-7.4p1-16.h27.eulerosv2r7",
  "openssh-clients-7.4p1-16.h27.eulerosv2r7",
  "openssh-keycat-7.4p1-16.h27.eulerosv2r7",
  "openssh-server-7.4p1-16.h27.eulerosv2r7"
];
