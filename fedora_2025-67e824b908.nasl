...
# extracted from Fedora Security Advisory FEDORA-2025-67e824b908
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-67e824b908");

  script_name(english:"Fedora 40 : mingw-libsoup (2025-67e824b908)");
...
FEDORA-2025-67e824b908 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-67e824b908");
  script_set_attribute(attribute:"solution", value:
"Update the affected mingw-libsoup package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:mingw-libsoup");
...
var pkgs = [
    {'reference':'mingw-libsoup-2.74.3-11.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'mingw-libsoup');
}
