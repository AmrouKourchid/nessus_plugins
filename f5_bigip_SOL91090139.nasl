...
content has the unintended privilege to update other parts of a zone.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K91090139");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K91090139.");
...
var vmatrix = {
  'AFM': {
    'affected': [
      '16.0.0','15.0.0-15.1.0','14.1.0-14.1.2','13.1.2-13.1.3','12.1.4-12.1.5','11.6.4-11.6.5'
    ],
    'unaffected': [
