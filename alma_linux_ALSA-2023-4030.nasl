...
# AlmaLinux Security Advisory ALSA-2023:4030.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:4030");
  script_xref(name:"IAVB", value:"2023-B-0044-S");

  script_name(english:"AlmaLinux 9 : grafana (ALSA-2023:4030)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2023-4030.html");
...
var pkgs = [
    {'reference':'grafana-9.0.9-3.el9_2.alma', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'grafana-9.0.9-3.el9_2.alma', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
