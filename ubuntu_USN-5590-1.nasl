...
# extracted from Ubuntu Security Notice USN-5590-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5590-1");

  script_name(english:"Ubuntu 20.04 LTS : Linux kernel (OEM) vulnerability (USN-5590-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5590-1");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-36946");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.14.0-1050-oem");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-5590-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2022-36946');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-5590-1');
  }
  else
  {
