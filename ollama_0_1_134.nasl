...
if (description)
{
  ...
  script_cve_id("CVE-2024-39721");
  script_xref(name:"IAVB", value:"2024-B-0164-S");

  script_name(english:"Ollama < 0.1.34 DoS");

  script_set_attribute(attribute:"synopsis", value:
"The Ollama instance installed on the remote host is affected by a denial of service vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Ollama installed on the remote host is prior to 0.1.34. It is, therefore, affected by a 
denial-of-service vulnerability:

  - An issue was discovered in Ollama before 0.1.34. The CreateModelHandler function uses os.Open to read a file until 
    completion. The req.Path parameter is user-controlled and can be set to /dev/random, which is blocking, causing 
    the goroutine to run infinitely (even after the HTTP request is aborted by the client). 
...
"Upgrade to Ollama version 0.1.34 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-39721");
