...
# extracted from openSUSE Security Update openSUSE-2018-1487.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : nextcloud (openSUSE-2018-1487)");
...
Security issues fixed :
  ...
  - CVE-2018-3780: Stored XSS in autocomplete suggestions
    for file comments (boo#1114817)
...
version, including :
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1114817");
...
"Update the affected nextcloud package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-3780");
...
if ( rpm_check(release:"SUSE15.0", reference:"nextcloud-13.0.8-lp150.2.9.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"nextcloud-13.0.8-15.1") ) flag++;
