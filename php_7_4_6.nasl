...
if (description)
{
  ...
  script_name(english:"PHP 7.2.x < 7.2.31 / 7.3.x < 7.3.18, 7.4.x < 7.4.6 Denial of Service (DoS)");
...
7.2.31, 7.3.x prior to 7.3.18 or 7.4.x prior to 7.4.6. It is, therefore, affected by a denial of service (DoS) 
vulnerability in its HTTP file upload component due to a failure to clean up temporary files created during the file 
upload process. An unauthenticated, remote attacker can exploit this issue, by repeatedly submitting uploads with long 
file or field names, to exhaust disk space and cause a DoS condition.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a05c7b46");
  # https://bugs.php.net/bug.php?id=78876
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?504e39bf");
...
constraints = [
  {'min_version':'7.2.0alpha1', 'fixed_version':'7.2.31'},
  {'min_version':'7.3.0alpha1', 'fixed_version':'7.3.18'},
  {'min_version':'7.4.0alpha1', 'fixed_version':'7.4.6'}
];
