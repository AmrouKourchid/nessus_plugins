...
if (description)
{
  ...
  script_cve_id("CVE-2024-58051");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-58051");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: ipmi: ipmb: Add check devm_kasprintf()
    returned value devm_kasprintf() can return a NULL pointer on failure but this returned value is not
    checked. (CVE-2024-58051)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-58051");
