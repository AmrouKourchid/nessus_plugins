...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2005/rhsa-2005_671.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c77b41ca");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=163925");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2005:671");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL kdegraphics package based on the guidance in RHSA-2005:671.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'kdegraphics-3.3.1-3.4', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'kdegraphics-3.3.1-3.4', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'kdegraphics-3.3.1-3.4', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'kdegraphics-3.3.1-3.4', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'kdegraphics-3.3.1-3.4', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'kdegraphics-devel-3.3.1-3.4', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'kdegraphics-devel-3.3.1-3.4', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'kdegraphics-devel-3.3.1-3.4', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'kdegraphics-devel-3.3.1-3.4', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'kdegraphics-devel-3.3.1-3.4', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
    ]
  }
];
