...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5002690");
  script_xref(name:"MSFT", value:"MS25-5002690");
  script_xref(name:"IAVA", value:"2025-A-0174-S");
  script_xref(name:"IAVA", value:"2025-A-0176-S");

  script_name(english:"Security Updates for Microsoft Office Online Server  (March 2025)");
...
affected by multiple vulnerabilities:
  ...
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002690");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released KB5002690 to address this issue.");
...
if (oos_path && (!isnull(oos_sp) && oos_sp == '0'))
{
  ...
  if (hotfix_check_fversion(file:'xlsrv.dll', version:'16.0.10416.20073', min_version:'16.0.10000.0', path:path, kb:'5002690', product:'Office Online Server') == HCF_OLDER)
    vuln = TRUE;
}
