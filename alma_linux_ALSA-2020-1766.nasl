...
# AlmaLinux Security Advisory ALSA-2020:1766.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2020:1766");

  script_name(english:"AlmaLinux 8 : GNOME (ALSA-2020:1766)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ALSA-2020:1766 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2020-1766.html");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:baobab");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:clutter");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:clutter-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:clutter-doc");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:gjs-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:gnome-menus");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:gnome-menus-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:gnome-tweaks");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:mozjs52");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:mozjs52-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:mozjs60");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:mozjs60-devel");
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'accountsservice-devel / baobab / clutter / clutter-devel / clutter-doc / etc');
}
