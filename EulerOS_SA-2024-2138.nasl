...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : gnutls (EulerOS-SA-2024-2138)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2138
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4591f1ec");
...
var pkgs = [
  "gnutls-3.6.14-6.h16.eulerosv2r10",
  "gnutls-utils-3.6.14-6.h16.eulerosv2r10"
];
