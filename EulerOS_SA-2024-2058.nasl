...
if (description)
{
  ...
  script_cve_id("CVE-2021-40211", "CVE-2022-48541");

  script_name(english:"EulerOS 2.0 SP8 : ImageMagick (EulerOS-SA-2024-2058)");
...
Tenable has extracted the preceding description block directly from the EulerOS ImageMagick security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2058
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?79bbdb9c");
...
var pkgs = [
  "ImageMagick-6.9.9.38-3.h29.eulerosv2r8",
  "ImageMagick-c++-6.9.9.38-3.h29.eulerosv2r8",
  "ImageMagick-libs-6.9.9.38-3.h29.eulerosv2r8",
  "ImageMagick-perl-6.9.9.38-3.h29.eulerosv2r8"
];
