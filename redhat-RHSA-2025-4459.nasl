...
# extracted from Red Hat Security Advisory RHSA-2025:4459. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 8 : nodejs:22 (RHSA-2025:4459)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for nodejs:22.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2025:4459 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2359553");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-78761");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-88883");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_4459.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?551ae653");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:4459");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL nodejs:22 package based on the guidance in RHSA-2025:4459.");
  ...
  'nodejs:22': [
    {
      ...
      'pkgs': [
        {'reference':'nodejs-22.15.0-1.module+el8.10.0+23068+28ff2340', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-devel-22.15.0-1.module+el8.10.0+23068+28ff2340', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-docs-22.15.0-1.module+el8.10.0+23068+28ff2340', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-full-i18n-22.15.0-1.module+el8.10.0+23068+28ff2340', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-libs-22.15.0-1.module+el8.10.0+23068+28ff2340', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-nodemon-3.0.1-1.module+el8.10.0+23068+28ff2340', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'nodejs-packaging-2021.06-4.module+el8.10.0+23068+28ff2340', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'nodejs-packaging-bundler-2021.06-4.module+el8.10.0+23068+28ff2340', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'npm-10.9.2-1.22.15.0.1.module+el8.10.0+23068+28ff2340', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'v8-12.4-devel-12.4.254.21-1.22.15.0.1.module+el8.10.0+23068+28ff2340', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'}
      ]
    }
  ]
};
