...
# extracted from Red Hat Security Advisory RHSA-2020:2798. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:2798");

  script_name(english:"RHEL 8 : Red Hat OpenShift Service Mesh 1.1 servicemesh-proxy (RHSA-2020:2798)");
...
referenced in the RHSA-2020:2798 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_2798.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fa0fc7d1");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:2798");
...
"Update the RHEL Red Hat OpenShift Service Mesh 1.1 servicemesh-proxy package based on the guidance in RHSA-2020:2798.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'servicemesh-proxy-1.1.4-2.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'servicemesh-'}
    ]
  }
];
