...
if (description)
{
  ...
  script_cve_id("CVE-2019-8905", "CVE-2019-8906");

  script_name(english:"RHEL 8 : file (Unpatched Vulnerability) (deprecated)");
...
"This plugin has been deprecated as it does not adhere to established standards for this style of check.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-8906");
