...
# extracted from Fedora Security Advisory FEDORA-2020-43d5a372fc.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 33 : 1:nodejs (2020-43d5a372fc)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-43d5a372fc");
...
flag = 0;
if (rpm_check(release:"FC33", reference:"nodejs-14.15.1-1.fc33", epoch:"1")) flag++;
