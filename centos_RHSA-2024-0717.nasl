...
# extracted from Red Hat Security Advisory RHSA-2024:0717.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : runc (RHSA-2024:0717)");
...
var pkgs = [
    {'reference':'runc-1.0.0-70.rc10.el7_9', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'runc-1.0.0-70.rc10.el7_9', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE}
];
