...
# extracted from Red Hat Security Advisory RHSA-2018:0039. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:0039");
  script_xref(name:"IAVA", value:"2018-A-0020");
  script_xref(name:"IAVA", value:"2018-A-0017-S");

  script_name(english:"RHEL 6 : microcode_ctl (RHSA-2018:0039) (Spectre)");
...
issue.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:0039");
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", sp:"2", cpu:"x86_64", reference:"microcode_ctl-1.17-9.1.el6_2")) flag++;
  if (rpm_check(release:"RHEL6", sp:"2", cpu:"x86_64", reference:"microcode_ctl-debuginfo-1.17-9.1.el6_2")) flag++;
