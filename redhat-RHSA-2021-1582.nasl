...
# extracted from Red Hat Security Advisory RHSA-2021:1582. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:1582");

  script_name(english:"RHEL 8 : cpio (RHSA-2021:1582)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_1582.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5391cf24");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/8.4_release_notes/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?862005a9");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:1582");
...
"Update the RHEL cpio package based on the guidance in RHSA-2021:1582.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cpio-2.12-10.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
