...
# extracted from Red Hat Security Advisory RHSA-2025:3371. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:3371");

  script_name(english:"RHEL 9 : Red Hat OpenStack Platform 17.1 (openstack-ansible-core) (RHSA-2025:3371)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for Red Hat OpenStack Platform 17.1 (openstack-ansible-core).");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_3371.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7be15e41");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:3371");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat OpenStack Platform 17.1 (openstack-ansible-core) package based on the guidance in
RHSA-2025:3371.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openstack-ansible-core-2.14.2-4.7.el9ost', 'cpu':'x86_64', 'release':'9', 'el_string':'el9ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
