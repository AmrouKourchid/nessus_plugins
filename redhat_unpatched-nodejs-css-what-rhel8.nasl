...
# extracted from Red Hat Security Advisory nodejs-css-what. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2021-33587");

  script_name(english:"RHEL 8 : nodejs-css-what (Unpatched Vulnerability) (deprecated)");
