...
# extracted from Fedora Security Advisory FEDORA-2023-126cffa741
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-126cffa741");

  script_name(english:"Fedora 38 : thunderbird (2023-126cffa741)");
...
FEDORA-2023-126cffa741 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-126cffa741");
...
var pkgs = [
    {'reference':'thunderbird-115.4.1-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
