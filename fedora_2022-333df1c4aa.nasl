...
# extracted from Fedora Security Advisory FEDORA-2022-333df1c4aa
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-333df1c4aa");

  script_name(english:"Fedora 35 : galera / mariadb (2022-333df1c4aa)");
...
FEDORA-2022-333df1c4aa advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-333df1c4aa");
...
var pkgs = [
    {'reference':'galera-26.4.13-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'mariadb-10.5.18-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'}
];
