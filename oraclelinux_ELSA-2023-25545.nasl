...
# extracted from Oracle Linux Security Advisory ELSA-2023-25545.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : olcne (ELSA-2023-25545)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 7 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ELSA-2023-25545 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-25545.html");
...
"Update the affected olcne-extra-modules, olcne-kubevirt-chart and / or olcne-rook-chart packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"cpe:/a:oracle:linux:7::developer_olcne");
...
var pkgs = [
    {'reference':'olcne-extra-modules-1.6.2-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'olcne-kubevirt-chart-1.6.2-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'olcne-rook-chart-1.6.2-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
];
