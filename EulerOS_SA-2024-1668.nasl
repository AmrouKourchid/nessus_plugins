...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : util-linux (EulerOS-SA-2024-1668)");
...
host is affected by the following vulnerabilities :
  ...
  - An issue was discovered in hwclock.13-v2.27 allows attackers to gain escalated privlidges or execute
    arbitrary commands via the path parameter when setting the date. (CVE-2020-21583)

Note that Tenable Network Security has extracted the preceding description block directly from the EulerOS security
advisory. Tenable has attempted to automatically clean and format it as much as possible without introducing additional
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1668
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?25614902");
...
"Update the affected util-linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-21583");
...
var pkgs = [
  "libblkid-2.23.2-52.1.h16.eulerosv2r7",
  "libblkid-devel-2.23.2-52.1.h16.eulerosv2r7",
  "libmount-2.23.2-52.1.h16.eulerosv2r7",
  "libuuid-2.23.2-52.1.h16.eulerosv2r7",
  "libuuid-devel-2.23.2-52.1.h16.eulerosv2r7",
  "util-linux-2.23.2-52.1.h16.eulerosv2r7",
  "uuidd-2.23.2-52.1.h16.eulerosv2r7"
];
