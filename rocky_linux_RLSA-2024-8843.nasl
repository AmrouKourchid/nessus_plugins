...
# Rocky Linux Security Advisory RLSA-2024:8843.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2024:8843");

  script_name(english:"RockyLinux 8 : python3.11-urllib3 (RLSA-2024:8843)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2024:8843");
