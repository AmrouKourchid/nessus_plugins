...
if (description)
{
  ...
  script_name(english:"CentOS 9 : runc-1.1.7-1.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing one or more security updates for runc.");
...
runc-1.1.7-1.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=32408");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream runc package.");
...
var pkgs = [
    {'reference':'runc-1.1.7-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'}
];
