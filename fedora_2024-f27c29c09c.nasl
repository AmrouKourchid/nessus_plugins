...
# extracted from Fedora Security Advisory FEDORA-2024-f27c29c09c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-f27c29c09c");
  script_xref(name:"IAVA", value:"2024-A-0543-S");

  script_name(english:"Fedora 40 : expat (2024-f27c29c09c)");
...
FEDORA-2024-f27c29c09c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-f27c29c09c");
...
var pkgs = [
    {'reference':'expat-2.6.3-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
