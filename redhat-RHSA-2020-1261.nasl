...
# extracted from Red Hat Security Advisory RHSA-2020:1261. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:1261");

  script_name(english:"RHEL 8 : virt:8.1 (RHSA-2020:1261)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for virt:8.1.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2020:1261 advisory.
    ...
    * qemu-kvm: QEMU: slirp: OOB buffer access while emulating tcp protocols in tcp_emu() (CVE-2020-7039)

    * qemu-kvm: QEMU: Slirp: potential OOB access due to unsafe snprintf() usages (CVE-2020-8608)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_1261.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e94c4487");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:1261");
...
"Update the RHEL virt:8.1 package based on the guidance in RHSA-2020:1261.");
  ...
  'virt:8.1': [
    {
      ...
      'pkgs': [
        {'reference':'hivex-1.3.15-7.module+el8.1.1+5309+6d656f05', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'hivex-devel-1.3.15-7.module+el8.1.1+5309+6d656f05', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'libguestfs-winsupport-8.0-4.module+el8.1.1+5309+6d656f05', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'libguestfs-xfs-1.40.2-16.module+el8.1.1+5309+6d656f05', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'libiscsi-1.18.0-8.module+el8.1.1+5309+6d656f05', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'libiscsi-devel-1.18.0-8.module+el8.1.1+5309+6d656f05', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'libiscsi-utils-1.18.0-8.module+el8.1.1+5309+6d656f05', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'libnbd-1.0.3-1.module+el8.1.1+5659+15cacc69', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'libnbd-devel-1.0.3-1.module+el8.1.1+5659+15cacc69', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'libtpms-0.7.0-1.20191018gitdc116933b7.module+el8.1.1+5309+6d656f05', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'libtpms-devel-0.7.0-1.20191018gitdc116933b7.module+el8.1.1+5309+6d656f05', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'libvirt-5.6.0-10.module+el8.1.1+5309+6d656f05', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'libvirt-admin-5.6.0-10.module+el8.1.1+5309+6d656f05', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'libvirt-bash-completion-5.6.0-10.module+el8.1.1+5309+6d656f05', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'libvirt-client-5.6.0-10.module+el8.1.1+5309+6d656f05', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'libvirt-daemon-5.6.0-10.module+el8.1.1+5309+6d656f05', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'libvirt-daemon-config-network-5.6.0-10.module+el8.1.1+5309+6d656f05', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'libvirt-daemon-config-nwfilter-5.6.0-10.module+el8.1.1+5309+6d656f05', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'libvirt-daemon-driver-interface-5.6.0-10.module+el8.1.1+5309+6d656f05', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'libvirt-daemon-driver-network-5.6.0-10.module+el8.1.1+5309+6d656f05', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'libvirt-daemon-driver-nodedev-5.6.0-10.module+el8.1.1+5309+6d656f05', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'libvirt-daemon-driver-nwfilter-5.6.0-10.module+el8.1.1+5309+6d656f05', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'libvirt-daemon-driver-qemu-5.6.0-10.module+el8.1.1+5309+6d656f05', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'libvirt-daemon-driver-secret-5.6.0-10.module+el8.1.1+5309+6d656f05', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'libvirt-daemon-driver-storage-5.6.0-10.module+el8.1.1+5309+6d656f05', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'libvirt-daemon-driver-storage-core-5.6.0-10.module+el8.1.1+5309+6d656f05', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'libvirt-daemon-driver-storage-disk-5.6.0-10.module+el8.1.1+5309+6d656f05', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'libvirt-daemon-driver-storage-gluster-5.6.0-10.module+el8.1.1+5309+6d656f05', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'libvirt-daemon-driver-storage-iscsi-5.6.0-10.module+el8.1.1+5309+6d656f05', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'libvirt-daemon-driver-storage-iscsi-direct-5.6.0-10.module+el8.1.1+5309+6d656f05', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'libvirt-daemon-driver-storage-logical-5.6.0-10.module+el8.1.1+5309+6d656f05', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'libvirt-daemon-driver-storage-mpath-5.6.0-10.module+el8.1.1+5309+6d656f05', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'libvirt-daemon-driver-storage-rbd-5.6.0-10.module+el8.1.1+5309+6d656f05', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'libvirt-daemon-driver-storage-scsi-5.6.0-10.module+el8.1.1+5309+6d656f05', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'libvirt-daemon-kvm-5.6.0-10.module+el8.1.1+5309+6d656f05', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'libvirt-dbus-1.3.0-2.module+el8.1.1+5309+6d656f05', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'libvirt-devel-5.6.0-10.module+el8.1.1+5309+6d656f05', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'libvirt-docs-5.6.0-10.module+el8.1.1+5309+6d656f05', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'libvirt-libs-5.6.0-10.module+el8.1.1+5309+6d656f05', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'libvirt-lock-sanlock-5.6.0-10.module+el8.1.1+5309+6d656f05', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'libvirt-nss-5.6.0-10.module+el8.1.1+5309+6d656f05', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'netcf-0.2.8-12.module+el8.1.1+5309+6d656f05', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'netcf-devel-0.2.8-12.module+el8.1.1+5309+6d656f05', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'netcf-libs-0.2.8-12.module+el8.1.1+5309+6d656f05', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'perl-hivex-1.3.15-7.module+el8.1.1+5309+6d656f05', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'perl-Sys-Guestfs-1.40.2-16.module+el8.1.1+5309+6d656f05', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'perl-Sys-Virt-5.6.0-2.module+el8.1.1+5309+6d656f05', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-hivex-1.3.15-7.module+el8.1.1+5309+6d656f05', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-libguestfs-1.40.2-16.module+el8.1.1+5309+6d656f05', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'python3-libnbd-1.0.3-1.module+el8.1.1+5659+15cacc69', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-libvirt-5.6.0-3.module+el8.1.1+5309+6d656f05', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-pyvmomi-6.7.1-7.module+el8.1.1+5668+2d43f0bb', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'qemu-guest-agent-4.1.0-23.module+el8.1.1+5938+f5e53076.2', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-img-4.1.0-23.module+el8.1.1+5938+f5e53076.2', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-4.1.0-23.module+el8.1.1+5938+f5e53076.2', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-block-curl-4.1.0-23.module+el8.1.1+5938+f5e53076.2', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-block-gluster-4.1.0-23.module+el8.1.1+5938+f5e53076.2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-block-iscsi-4.1.0-23.module+el8.1.1+5938+f5e53076.2', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-block-rbd-4.1.0-23.module+el8.1.1+5938+f5e53076.2', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-block-ssh-4.1.0-23.module+el8.1.1+5938+f5e53076.2', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-common-4.1.0-23.module+el8.1.1+5938+f5e53076.2', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-core-4.1.0-23.module+el8.1.1+5938+f5e53076.2', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'ruby-hivex-1.3.15-7.module+el8.1.1+5309+6d656f05', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'sgabios-0.20170427git-3.module+el8.1.1+5309+6d656f05', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        ...
        {'reference':'swtpm-0.2.0-1.20191018git9227cf4.module+el8.1.1+5309+6d656f05', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'swtpm-devel-0.2.0-1.20191018git9227cf4.module+el8.1.1+5309+6d656f05', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'swtpm-libs-0.2.0-1.20191018git9227cf4.module+el8.1.1+5309+6d656f05', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'swtpm-tools-0.2.0-1.20191018git9227cf4.module+el8.1.1+5309+6d656f05', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'virglrenderer-0.6.0-5.20180814git491d3b705.module+el8.1.1+5309+6d656f05', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'virglrenderer-devel-0.6.0-5.20180814git491d3b705.module+el8.1.1+5309+6d656f05', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'virglrenderer-test-server-0.6.0-5.20180814git491d3b705.module+el8.1.1+5309+6d656f05', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
  ...
  'virt-devel:8.1': [
    {
      ...
      'pkgs': [
        ...
        {'reference':'ocaml-libnbd-1.0.3-1.module+el8.1.1+5659+15cacc69', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ocaml-libnbd-devel-1.0.3-1.module+el8.1.1+5659+15cacc69', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'qemu-kvm-tests-4.1.0-23.module+el8.1.1+5938+f5e53076.2', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
