...
if (description)
{
  ...
  script_cve_id("CVE-2023-28601");

  script_name(english:"Zoom Client for Meetings < 5.14.0 Vulnerability (ZSB-23009)");
...
vulnerability as referenced in the ZSB-23009 advisory.

  - Zoom for Windows clients prior to 5.14.0 contain an improper restriction of operations within the bounds
    of a memory buffer vulnerability. A malicious user may alter protected Zoom Client memory buffer
    potentially causing integrity issues within the Zoom Client. Users can help keep themselves secure by
    applying current updates or downloading the latest Zoom software with all current security updates from
    https://zoom.us/download . (CVE-2023-28601)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://explore.zoom.us/en/trust/security/security-bulletin/?filter-cve=&filter=&keywords=ZSB-23009
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?66b2c152");
...
"Upgrade to Zoom Client for Meetings 5.14.0 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-28601");
