...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : Moderate: / vixie-cron (ELSA-2007-0345)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2007-0345.html");
...
"Update the affected vixie-cron package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2007-1856");
...
var pkgs = [
    {'reference':'vixie-cron-4.1-70.el5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
    {'reference':'vixie-cron-4.1-70.el5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'}
];
