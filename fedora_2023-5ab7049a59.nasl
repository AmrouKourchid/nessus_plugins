...
# extracted from Fedora Security Advisory FEDORA-2023-5ab7049a59
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-5ab7049a59");

  script_name(english:"Fedora 38 : python-oauthlib (2023-5ab7049a59)");
...
FEDORA-2023-5ab7049a59 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-5ab7049a59");
...
var pkgs = [
    {'reference':'python-oauthlib-3.2.2-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
