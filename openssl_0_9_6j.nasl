...
if (description)
{
  ...
  script_name(english:"OpenSSL 0.9.6 < 0.9.6j Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote service is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of OpenSSL installed on the remote host is prior to 0.9.6j. It is, therefore, affected by multiple
vulnerabilities as referenced in the 0.9.6j advisory.
...
var constraints = [
  { 'min_version' : '0.9.6', 'fixed_version' : '0.9.6j' }
];
