...
# extracted from Red Hat Security Advisory RHSA-2018:0878. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : golang (RHSA-2018:0878)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2018:0878 advisory.

    The golang packages provide the Go programming language compiler.

    The following packages have been upgraded to a later upstream version: golang (1.9.4). (BZ#1479095,
    BZ#1499827)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2018/rhsa-2018_0878.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3a697399");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:0878");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'golang-1.9.4-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-bin-1.9.4-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-docs-1.9.4-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-misc-1.9.4-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-src-1.9.4-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-tests-1.9.4-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
