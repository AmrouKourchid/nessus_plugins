...
if (description)
{
  ...
  script_cve_id("CVE-2024-43813");
  script_xref(name:"IAVA", value:"2024-A-0677-S");

  script_name(english:"Mattermost Server 9.5.x < 9.5.8 / 9.10.x < 9.10.1 (MMSA-2024-00364)");
...
a vulnerability as referenced in the MMSA-2024-00364 advisory.

  - Mattermost versions 9.5.x <= 9.5.7, 9.10.x <= 9.10.0 fail to enforce proper access controls which allows
    any authenticated user, including guests, to mark any channel inside any team as read for any user.
    (CVE-2024-43813)
...
"Upgrade to Mattermost Server version 9.5.8 / 9.10.1 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-43813");
