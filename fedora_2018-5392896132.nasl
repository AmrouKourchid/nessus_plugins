...
# extracted from Fedora Security Advisory FEDORA-2018-5392896132.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-5392896132");
  script_xref(name:"IAVA", value:"2018-A-0162");

  script_name(english:"Fedora 26 : 12:dhcp (2018-5392896132)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-5392896132");
...
flag = 0;
if (rpm_check(release:"FC26", reference:"dhcp-4.3.5-11.fc26", epoch:"12")) flag++;
