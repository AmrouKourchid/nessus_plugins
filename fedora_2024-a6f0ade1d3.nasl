...
# extracted from Fedora Security Advisory FEDORA-2024-a6f0ade1d3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-a6f0ade1d3");

  script_name(english:"Fedora 39 : cobbler (2024-a6f0ade1d3)");
...
FEDORA-2024-a6f0ade1d3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-a6f0ade1d3");
...
var pkgs = [
    {'reference':'cobbler-3.3.7-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
