...
# extracted from Fedora Security Advisory FEDORA-2023-e7aa13efc5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-e7aa13efc5");

  script_name(english:"Fedora 39 : community-mysql (2023-e7aa13efc5)");
...
FEDORA-2023-e7aa13efc5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-e7aa13efc5");
...
var pkgs = [
    {'reference':'community-mysql-8.0.35-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
