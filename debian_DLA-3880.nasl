...
# extracted from Debian Security Advisory dla-3880. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3880 : amanda-client - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bullseye/amanda");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'amanda-client', 'reference': '1:3.5.1-7+deb11u1'},
    {'release': '11.0', 'prefix': 'amanda-common', 'reference': '1:3.5.1-7+deb11u1'},
    {'release': '11.0', 'prefix': 'amanda-server', 'reference': '1:3.5.1-7+deb11u1'}
];
