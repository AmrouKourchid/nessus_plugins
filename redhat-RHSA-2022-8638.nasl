...
# extracted from Red Hat Security Advisory RHSA-2022:8638. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:8638");

  script_name(english:"RHEL 8 : krb5 (RHSA-2022:8638)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for krb5.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2022:8638 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8638.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f2f04d55");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8638");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2140960");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL krb5 package based on the guidance in RHSA-2022:8638.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'krb5-devel-1.18.2-22.el8_7', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'krb5-libs-1.18.2-22.el8_7', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'krb5-pkinit-1.18.2-22.el8_7', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'krb5-server-1.18.2-22.el8_7', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'krb5-server-ldap-1.18.2-22.el8_7', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'krb5-workstation-1.18.2-22.el8_7', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libkadm5-1.18.2-22.el8_7', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
