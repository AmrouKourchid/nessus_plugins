...
# extracted from VMware Security Advisory PHSA-2020-3.0-0133. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Ntp PHSA-2020-3.0-0133");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the ntp package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-3.0-133.md");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'ntp-4.2.8p14-2.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'ntp-perl-4.2.8p14-2.ph3')) flag++;
