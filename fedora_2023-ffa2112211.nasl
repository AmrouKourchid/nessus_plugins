...
# extracted from Fedora Security Advisory FEDORA-2023-ffa2112211
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-ffa2112211");

  script_name(english:"Fedora 39 : google-guest-agent (2023-ffa2112211)");
...
FEDORA-2023-ffa2112211 advisory.

    Automatic update for google-guest-agent-20230221.00-2.fc39.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-ffa2112211");
...
var pkgs = [
    {'reference':'google-guest-agent-20230221.00-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
