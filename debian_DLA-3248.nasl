...
# extracted from Debian Security Advisory dla-3248. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3248 : libksba-dev - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3248
advisory.

    -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3248-1                debian-lts@lists.debian.org
    https://www.debian.org/lts/security/                      Markus Koschany
    December 24, 2022                             https://wiki.debian.org/LTS
    -------------------------------------------------------------------------
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libksba-dev', 'reference': '1.3.5-2+deb10u2'},
    {'release': '10.0', 'prefix': 'libksba-mingw-w64-dev', 'reference': '1.3.5-2+deb10u2'},
    {'release': '10.0', 'prefix': 'libksba8', 'reference': '1.3.5-2+deb10u2'}
];
