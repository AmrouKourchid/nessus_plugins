...
# extracted from Fedora Security Advisory FEDORA-2023-5911638116
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-5911638116");

  script_name(english:"Fedora 38 : libcap (2023-5911638116)");
...
FEDORA-2023-5911638116 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-5911638116");
...
var pkgs = [
    {'reference':'libcap-2.48-7.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
