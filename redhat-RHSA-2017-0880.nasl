...
# extracted from Red Hat Security Advisory RHSA-2017:0880. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2017:0880");

  script_name(english:"RHEL 7 : v8 (RHSA-2017:0880)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for v8.");
...
the RHSA-2017:0880 advisory.

    V8 is Google's open source JavaScript engine. V8 is written in C++ and is used in Google Chrome, the open
    source browser from Google. V8 implements ECMAScript as specified in ECMA-262, 3rd edition.

    Security Fix(es):

    * An integer-overflow flaw was found in V8's Zone class when allocating new memory (Zone::New() and
    Zone::NewExpand()). An attacker with the ability to manipulate a large zone could crash the application
    or, potentially, execute arbitrary code with the application privileges. (CVE-2016-1669)
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2017/rhsa-2017_0880.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fe429b96");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2017:0880");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL v8 package based on the guidance in RHSA-2017:0880.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'v8-3.14.5.10-19.el7ost', 'cpu':'x86_64', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'}
    ]
  }
];
