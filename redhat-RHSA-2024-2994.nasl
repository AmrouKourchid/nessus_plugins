...
# extracted from Red Hat Security Advisory RHSA-2024:2994. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2994");

  script_name(english:"RHEL 8 : LibRaw (RHSA-2024:2994)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for LibRaw.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:2994 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2994.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f10127f6");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2172004");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2994");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL LibRaw package based on the guidance in RHSA-2024:2994.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'LibRaw-0.19.5-4.el8', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'LibRaw-0.19.5-4.el8', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'LibRaw-0.19.5-4.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'LibRaw-devel-0.19.5-4.el8', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'LibRaw-devel-0.19.5-4.el8', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'LibRaw-devel-0.19.5-4.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'LibRaw / LibRaw-devel');
}
