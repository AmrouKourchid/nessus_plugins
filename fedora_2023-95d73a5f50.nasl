...
# extracted from Fedora Security Advisory FEDORA-2023-95d73a5f50
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-95d73a5f50");

  script_name(english:"Fedora 38 : chromium (2023-95d73a5f50)");
...
FEDORA-2023-95d73a5f50 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-95d73a5f50");
...
var pkgs = [
    {'reference':'chromium-115.0.5790.110-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
