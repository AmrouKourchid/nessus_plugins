...
affected by a vulnerability as referenced in the K12252011 advisory.
    ...
    refresh_progress_meter() in progressmeter.c.(CVE-2019-6109)ImpactMissing character encoding in the
    progress display allows for spoofing of OpenSSH SCP client output.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K12252011");
