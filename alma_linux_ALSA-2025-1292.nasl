...
# AlmaLinux Security Advisory ALSA-2025:1292.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2025:1292");
  script_xref(name:"RHSA", value:"2025:1292");

  script_name(english:"AlmaLinux 8 : thunderbird (ALSA-2025:1292)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2025-1292.html");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:1292");
...
"Update the affected thunderbird package.");
  ...
  script_cwe_id(119, 120, 1284, 362, 416, 451, 601);
...
var pkgs = [
    {'reference':'thunderbird-128.7.0-1.el8_10.alma.1', 'cpu':'aarch64', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0', 'allowmaj':TRUE},
    {'reference':'thunderbird-128.7.0-1.el8_10.alma.1', 'cpu':'ppc64le', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0', 'allowmaj':TRUE},
    {'reference':'thunderbird-128.7.0-1.el8_10.alma.1', 'cpu':'s390x', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0', 'allowmaj':TRUE},
    {'reference':'thunderbird-128.7.0-1.el8_10.alma.1', 'cpu':'x86_64', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0', 'allowmaj':TRUE}
];
