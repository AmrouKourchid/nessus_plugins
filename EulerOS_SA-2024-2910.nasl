...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : openjpeg2 (EulerOS-SA-2024-2910)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2910
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?05c8af72");
...
var pkgs = [
  "openjpeg2-2.3.1-5.h8.eulerosv2r10"
];
