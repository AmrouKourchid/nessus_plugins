...
# extracted from Red Hat Security Advisory RHSA-2020:0981. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:0981");

  script_name(english:"RHEL 8 : ipmitool (RHSA-2020:0981)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for ipmitool.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2020:0981 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_0981.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fb99f1f3");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:0981");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1798721");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL ipmitool package based on the guidance in RHSA-2020:0981.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:ipmievd");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'exchange-bmc-os-info-1.8.18-12.el8_1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipmievd-1.8.18-12.el8_1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipmitool-1.8.18-12.el8_1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'exchange-bmc-os-info-1.8.18-12.el8_1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipmievd-1.8.18-12.el8_1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipmitool-1.8.18-12.el8_1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'exchange-bmc-os-info / ipmievd / ipmitool');
}
