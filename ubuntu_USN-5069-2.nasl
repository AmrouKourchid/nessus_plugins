...
# extracted from Ubuntu Security Notice USN-5069-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5069-2");

  script_name(english:"Ubuntu 21.04 : mod-auth-mellon vulnerability (USN-5069-2)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 21.04 host has a package installed that is affected by a vulnerability as referenced in the USN-5069-2
advisory.

    USN-5069-1 fixed a vulnerability in mod-auth-mellon. This update provides the corresponding updates for
    Ubuntu 21.04.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5069-2");
...
var pkgs = [
    {'osver': '21.04', 'pkgname': 'libapache2-mod-auth-mellon', 'pkgver': '0.17.0-1ubuntu0.21.04.1'}
];
