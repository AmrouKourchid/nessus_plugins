...
# extracted from Red Hat Security Advisory RHSA-2022:5719. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:5719");

  script_name(english:"RHEL 8 : grafana (RHSA-2022:5719)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for grafana.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2022:5719 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_5719.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d7425053");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:5719");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2104367");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL grafana package based on the guidance in RHSA-2022:5719.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'grafana-6.3.6-5.el8_2', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'grafana-azure-monitor-6.3.6-5.el8_2', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'grafana-cloudwatch-6.3.6-5.el8_2', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'grafana-elasticsearch-6.3.6-5.el8_2', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'grafana-graphite-6.3.6-5.el8_2', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'grafana-influxdb-6.3.6-5.el8_2', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'grafana-loki-6.3.6-5.el8_2', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'grafana-mssql-6.3.6-5.el8_2', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'grafana-mysql-6.3.6-5.el8_2', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'grafana-opentsdb-6.3.6-5.el8_2', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'grafana-postgres-6.3.6-5.el8_2', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'grafana-prometheus-6.3.6-5.el8_2', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'grafana-stackdriver-6.3.6-5.el8_2', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
