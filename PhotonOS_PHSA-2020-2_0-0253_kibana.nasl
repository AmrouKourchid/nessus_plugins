...
if (description)
{
  ...
  script_cve_id("CVE-2019-7621", "CVE-2020-7012", "CVE-2020-7013");

  script_name(english:"Photon OS 2.0: Kibana PHSA-2020-2.0-0253");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'kibana-6.8.9-1.ph2')) flag++;
