...
# extracted from Fedora Security Advisory FEDORA-2024-987089eca2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-987089eca2");

  script_name(english:"Fedora 38 : kernel (2024-987089eca2)");
...
FEDORA-2024-987089eca2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-987089eca2");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for FEDORA-2024-987089eca2');
  }
  else
  {
...
var pkgs = [
    {'reference':'kernel-6.7.5-100.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
