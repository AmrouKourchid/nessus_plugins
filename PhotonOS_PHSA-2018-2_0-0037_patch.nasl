...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Patch PHSA-2018-2.0-0037");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'patch-2.7.5-5.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'patch-debuginfo-2.7.5-5.ph2')) flag++;
