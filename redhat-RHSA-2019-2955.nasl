...
# extracted from Red Hat Security Advisory RHSA-2019:2955. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:2955");
  script_xref(name:"CEA-ID", value:"CEA-2019-0643");

  script_name(english:"RHEL 7 : rh-nodejs8-nodejs (RHSA-2019:2955)");
...
referenced in the RHSA-2019:2955 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_2955.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3c9a260d");
...
"Update the RHEL rh-nodejs8-nodejs package based on the guidance in RHSA-2019:2955.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rh-nodejs8");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rh-nodejs8-runtime");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rh-nodejs8-scldevel");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-nodejs8-3.0-5.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs8-nodejs-8.16.1-2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs8-nodejs-devel-8.16.1-2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs8-nodejs-docs-8.16.1-2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs8-npm-6.4.1-8.16.1.2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs8-runtime-3.0-5.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs8-scldevel-3.0-5.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'rh-nodejs8 / rh-nodejs8-nodejs / rh-nodejs8-nodejs-devel / etc');
}
