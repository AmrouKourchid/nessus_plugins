...
# extracted from Fedora Security Advisory FEDORA-2024-37627e432e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-37627e432e");

  script_name(english:"Fedora 38 : openssh (2024-37627e432e)");
...
FEDORA-2024-37627e432e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-37627e432e");
...
var pkgs = [
    {'reference':'openssh-9.0p1-18.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
