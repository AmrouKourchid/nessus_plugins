...
# SUSE update advisory SUSE-SU-2022:4539-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:4539-1");

  script_name(english:"SUSE SLES12 / SLES15 Security Update : kernel (Live Patch 31 for SLE 12 SP4) (SUSE-SU-2022:4539-1)");
...
multiple vulnerabilities as referenced in the SUSE-SU-2022:4539-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-December/013263.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b3e7002f");
  script_set_attribute(attribute:"solution", value:
"Update the affected kernel-livepatch-4_12_14-150100_197_126-default and / or kgraft-patch-4_12_14-95_111-default
packages.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-150100.197.126-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-4_12_14-150100_197_126-default-2-150100.2.1', 'sp':'1', 'cpu':'x86_64', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.1']},
          {'reference':'kernel-livepatch-4_12_14-150100_197_126-default-2-150100.2.1', 'sp':'1', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.1', 'sle-module-live-patching-release-15.1', 'sles-release-15.1']}
        ]
      },
      '4.12.14-95.111-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_12_14-95_111-default-2-2.1', 'sp':'4', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.4']},
          {'reference':'kgraft-patch-4_12_14-95_111-default-2-2.1', 'sp':'4', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-12.4', 'sle-live-patching-release-12.4', 'sles-release-12.4']}
        ]
      }
    }
  }
