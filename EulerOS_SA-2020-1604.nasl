...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : java-1.8.0-openjdk (EulerOS-SA-2020-1604)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1604
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?808f5319");
...
"Update the affected java-1.8.0-openjdk packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-2805");
...
pkgs = ["java-1.8.0-openjdk-1.8.0.191.b12-0.h10.eulerosv2r7",
        "java-1.8.0-openjdk-devel-1.8.0.191.b12-0.h10.eulerosv2r7",
        "java-1.8.0-openjdk-headless-1.8.0.191.b12-0.h10.eulerosv2r7"];
