...
# extracted from Fedora Security Advisory FEDORA-2019-b6612c5fe5.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-b6612c5fe5");

  script_name(english:"Fedora 30 : snapd-glib (2019-b6612c5fe5)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-b6612c5fe5");
  script_set_attribute(attribute:"solution", value:
"Update the affected snapd-glib package.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:P/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:H/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-11503");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"snapd-glib-1.48-1.fc30")) flag++;
