...
# extracted from Red Hat Security Advisory RHSA-2022:6389. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:6389");
  script_xref(name:"IAVB", value:"2022-B-0036-S");

  script_name(english:"RHEL 7 : rh-nodejs14-nodejs and rh-nodejs14-nodejs-nodemon (RHSA-2022:6389)");
...
referenced in the RHSA-2022:6389 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_6389.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3b6c68bf");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:6389");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2106673");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rh-nodejs14-nodejs / rh-nodejs14-nodejs-nodemon packages based on the guidance in RHSA-2022:6389.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-nodejs14-nodejs-14.20.0-2.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2022-32212', 'CVE-2022-32213', 'CVE-2022-32214', 'CVE-2022-32215']},
      {'reference':'rh-nodejs14-nodejs-14.20.0-2.el7', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2022-32212', 'CVE-2022-32213', 'CVE-2022-32214', 'CVE-2022-32215']},
      {'reference':'rh-nodejs14-nodejs-14.20.0-2.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2022-32212', 'CVE-2022-32213', 'CVE-2022-32214', 'CVE-2022-32215']},
      {'reference':'rh-nodejs14-nodejs-devel-14.20.0-2.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2022-32212', 'CVE-2022-32213', 'CVE-2022-32214', 'CVE-2022-32215']},
      {'reference':'rh-nodejs14-nodejs-devel-14.20.0-2.el7', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2022-32212', 'CVE-2022-32213', 'CVE-2022-32214', 'CVE-2022-32215']},
      {'reference':'rh-nodejs14-nodejs-devel-14.20.0-2.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2022-32212', 'CVE-2022-32213', 'CVE-2022-32214', 'CVE-2022-32215']},
      {'reference':'rh-nodejs14-nodejs-docs-14.20.0-2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2022-32212', 'CVE-2022-32213', 'CVE-2022-32214', 'CVE-2022-32215']},
      {'reference':'rh-nodejs14-nodejs-nodemon-2.0.19-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2022-33987']},
      {'reference':'rh-nodejs14-npm-6.14.17-14.20.0.2.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2022-32212', 'CVE-2022-32213', 'CVE-2022-32214', 'CVE-2022-32215']},
      {'reference':'rh-nodejs14-npm-6.14.17-14.20.0.2.el7', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2022-32212', 'CVE-2022-32213', 'CVE-2022-32214', 'CVE-2022-32215']},
      {'reference':'rh-nodejs14-npm-6.14.17-14.20.0.2.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2022-32212', 'CVE-2022-32213', 'CVE-2022-32214', 'CVE-2022-32215']}
    ]
  }
];
