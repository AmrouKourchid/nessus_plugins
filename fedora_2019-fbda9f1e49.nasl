...
# extracted from Fedora Security Advisory FEDORA-2019-fbda9f1e49.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : python-urllib3 (2019-fbda9f1e49)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-fbda9f1e49");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"python-urllib3-1.24.3-1.fc29")) flag++;
