...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2011-1289.html");
  script_set_attribute(attribute:"solution", value:
"Update the affected librsvg2 and / or librsvg2-devel packages.");
