...
# extracted from Red Hat Security Advisory RHSA-2023:7531. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:7531");

  script_name(english:"RHEL 8 : pixman (RHSA-2023:7531)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for pixman.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2023:7531 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_7531.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5e9d407c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2139988");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:7531");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL pixman package based on the guidance in RHSA-2023:7531.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'pixman-0.38.4-3.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pixman-devel-0.38.4-3.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
