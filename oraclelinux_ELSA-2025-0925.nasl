...
# extracted from Oracle Linux Security Advisory ELSA-2025-0925.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : bzip2 (ELSA-2025-0925)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2025-0925.html");
...
var pkgs = [
    {'reference':'bzip2-1.0.8-10.el9_5', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'bzip2-devel-1.0.8-10.el9_5', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'bzip2-libs-1.0.8-10.el9_5', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'bzip2-devel-1.0.8-10.el9_5', 'cpu':'i686', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'bzip2-libs-1.0.8-10.el9_5', 'cpu':'i686', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'bzip2-1.0.8-10.el9_5', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'bzip2-devel-1.0.8-10.el9_5', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'bzip2-libs-1.0.8-10.el9_5', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
