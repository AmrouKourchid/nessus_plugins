...
if (description)
{
  ...
  script_cve_id("CVE-2011-4956", "CVE-2011-4957");
  script_bugtraq_id(73868, 78357);

  script_name(english:"WordPress < 3.1.1 Multiple Vulnerabilities");
...
application running on the remote web server is prior to 3.1.1.
It is, therefore, affected by multiple vulnerabilities, including
cross-site scripting (XSS) and cross-site request forgery (XSRF),
and a denial of service (DoS) vulnerability.

Note that Nessus has not tested for these issues but has instead
relied only on the application's self-reported version number.");
  script_set_attribute(attribute:"see_also", value:"https://wordpress.org/news/2011/04/wordpress-3-1-1/");
  script_set_attribute(attribute:"see_also", value:"https://codex.wordpress.org/Version_3.1.1");
  script_set_attribute(attribute:"solution", value:
"Upgrade to WordPress version 3.1.1 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:U/RC:ND");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:R/S:C/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2011-4957");
...
# Versions < 3.1.1 are affected.
if (
  ver[0] < 3 ||
  (ver[0] == 3 && ver[1] < 1) ||
  (ver[0] == 3 && ver[1] == 1 && ver[2] < 1)
)
{
  report =
  '\n  URL               : ' + install_url +
