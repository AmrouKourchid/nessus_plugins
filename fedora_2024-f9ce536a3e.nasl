...
# extracted from Fedora Security Advisory FEDORA-2024-f9ce536a3e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-f9ce536a3e");

  script_name(english:"Fedora 40 : emacs (2024-f9ce536a3e)");
...
FEDORA-2024-f9ce536a3e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-f9ce536a3e");
...
var pkgs = [
    {'reference':'emacs-29.3-5.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
