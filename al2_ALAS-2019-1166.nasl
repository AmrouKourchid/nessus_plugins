...
# extracted from Amazon Linux 2 Security Advisory ALAS-2019-1166.
#
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : perl (ALAS-2019-1166)");
...
triggers invalid write operations.(CVE-2018-18311)");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2019-1166.html");
...
flag = 0;
if (rpm_check(release:"AL2", reference:"perl-5.16.3-294.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"perl-CPAN-1.9800-294.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"perl-ExtUtils-CBuilder-0.28.2.6-294.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"perl-ExtUtils-Embed-1.30-294.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"perl-ExtUtils-Install-1.58-294.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"perl-IO-Zlib-1.10-294.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"perl-Locale-Maketext-Simple-0.21-294.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"perl-Module-CoreList-2.76.02-294.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"perl-Module-Loaded-0.08-294.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"perl-Object-Accessor-0.42-294.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"perl-Package-Constants-0.02-294.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"perl-Pod-Escapes-1.04-294.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"perl-Time-Piece-1.20.1-294.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"perl-core-5.16.3-294.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"perl-debuginfo-5.16.3-294.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"perl-devel-5.16.3-294.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"perl-libs-5.16.3-294.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"perl-macros-5.16.3-294.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"perl-tests-5.16.3-294.amzn2")) flag++;
