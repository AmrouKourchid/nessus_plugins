...
if (description)
{
  ...
  script_cve_id("CVE-2011-3326");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2011-3326");
...
patch available.
  ...
  - The ospf_flood function in ospf_flood.c in ospfd in Quagga before 0.99.19 allows remote attackers to cause
    ...
    State Update message. (CVE-2011-3326)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2011-3326");
