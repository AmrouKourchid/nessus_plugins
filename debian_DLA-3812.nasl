...
# extracted from Debian Security Advisory dla-3812. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3812 : libpostgresql-jdbc-java - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3812
advisory.
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libpostgresql-jdbc-java', 'reference': '42.2.5-2+deb10u4'},
    {'release': '10.0', 'prefix': 'libpostgresql-jdbc-java-doc', 'reference': '42.2.5-2+deb10u4'}
];
