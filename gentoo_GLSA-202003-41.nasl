...
# extracted from Gentoo Linux Security Advisory GLSA 202003-41.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202003-41");

  script_name(english:"GLSA-202003-41 : GNU FriBidi: Heap-based buffer overflow");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202003-41
...
Impact :
    ...
    A remote attacker could possibly cause a memory corruption, execute
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202003-41");
...
"All FriBidi users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:fribidi");
...
if (qpkg_check(package:"dev-libs/fribidi", unaffected:make_list("ge 1.0.8"), vulnerable:make_list("lt 1.0.8"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "GNU FriBidi");
}
