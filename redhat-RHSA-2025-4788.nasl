...
# extracted from Red Hat Security Advisory RHSA-2025:4788. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:4788");

  script_name(english:"RHEL 9 : redis (RHSA-2025:4788)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for redis.");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_4788.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?33904e22");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:4788");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL redis package based on the guidance in RHSA-2025:4788.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'redis-6.2.7-1.el9_4.2', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'redis-devel-6.2.7-1.el9_4.2', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'redis-doc-6.2.7-1.el9_4.2', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
