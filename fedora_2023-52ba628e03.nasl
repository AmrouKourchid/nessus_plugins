...
# extracted from Fedora Security Advisory FEDORA-2023-52ba628e03
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-52ba628e03");

  script_name(english:"Fedora 38 : xerces-c (2023-52ba628e03)");
...
FEDORA-2023-52ba628e03 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-52ba628e03");
...
var pkgs = [
    {'reference':'xerces-c-3.2.5-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
