...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : libsolv (EulerOS-SA-2021-2506)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2506
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7c1b8a20");
...
var pkgs = [
  "libsolv-0.6.26-2.h4.eulerosv2r7"
];
