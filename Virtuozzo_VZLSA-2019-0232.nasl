...
if (description)
{
  ...
  script_name(english:"Virtuozzo 6 : spice-server / spice-server-devel (VZLSA-2019-0232)");
...
it as much as possible without introducing additional issues.");
  # http://repo.virtuozzo.com/vzlinux/announcements/json/VZLSA-2019-0232.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9c7af36e");
...
pkgs = ["spice-server-0.12.4-16.vl6.3",
        "spice-server-devel-0.12.4-16.vl6.3"];
