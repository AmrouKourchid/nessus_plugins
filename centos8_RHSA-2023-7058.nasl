...
# Red Hat Security Advisory RHSA-2023:7058. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : rhc (CESA-2023:7058)");
...
var pkgs = [
    {'reference':'rhc-0.2.4-3.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'rhc-0.2.4-3.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
