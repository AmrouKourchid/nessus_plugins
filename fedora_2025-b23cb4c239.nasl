...
# extracted from Fedora Security Advisory FEDORA-2025-b23cb4c239
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-b23cb4c239");

  script_name(english:"Fedora 40 : moodle (2025-b23cb4c239)");
...
FEDORA-2025-b23cb4c239 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-b23cb4c239");
...
"Update the affected moodle package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-3643");
...
var pkgs = [
    {'reference':'moodle-4.3.12-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
