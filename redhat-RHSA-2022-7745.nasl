...
# extracted from Red Hat Security Advisory RHSA-2022:7745. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:7745");

  script_name(english:"RHEL 8 : freetype (RHSA-2022:7745)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for freetype.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2022:7745 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_7745.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d77ec3a4");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:7745");
...
"Update the RHEL freetype package based on the guidance in RHSA-2022:7745.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'freetype-2.9.1-9.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freetype-devel-2.9.1-9.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
