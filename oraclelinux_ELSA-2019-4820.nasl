...
ELSA-2019-4820 advisory.
    ...
    - xfrm: policy: Fix out-of-bound array accesses in __xfrm_policy_unlink (YueHaibing)  [Orabug: 30322228]
    {CVE-2019-15666}
    ...
    - KVM: coalesced_mmio: add bounds checking (Matt Delco)  [Orabug: 30328863]  {CVE-2019-14821}
    {CVE-2019-14821}
    - vhost: make sure log_num < in_num (yongduan)  [Orabug: 30313999]  {CVE-2019-14835}
    - vhost: block speculation of translated descriptors (Michael S. Tsirkin)  [Orabug: 30313999]
    {CVE-2019-14835}
    - Bluetooth: hci_uart: check for missing tty operations (Vladis Dronov)  [Orabug: 30244614]
    {CVE-2019-10207} {CVE-2019-10207}
...
var pkgs = [
    ...
    {'reference':'perf-4.14.35-1902.6.6.el7uek', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'perf-4.14.35'},
    {'reference':'python-perf-4.14.35-1902.6.6.el7uek', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'python-perf-4.14.35'},
    ...
    {'reference':'kernel-uek-doc-4.14.35-1902.6.6.el7uek', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-doc-4.14.35'},
    {'reference':'kernel-uek-headers-4.14.35-1902.6.6.el7uek', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-headers-4.14.35'},
    ...
    {'reference':'kernel-uek-tools-libs-4.14.35-1902.6.6.el7uek', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-tools-libs-4.14.35'},
    {'reference':'kernel-uek-tools-libs-devel-4.14.35-1902.6.6.el7uek', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-tools-libs-devel-4.14.35'},
    {'reference':'perf-4.14.35-1902.6.6.el7uek', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'perf-4.14.35'},
    {'reference':'python-perf-4.14.35-1902.6.6.el7uek', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'python-perf-4.14.35'}
];
