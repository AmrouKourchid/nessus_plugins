...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : firefox on SL7.x x86_64 (20181217)");
...
Security Fix(es) :
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bb1d2bde");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"firefox-60.4.0-1.el7", allowmaj:TRUE)) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"firefox-debuginfo-60.4.0-1.el7", allowmaj:TRUE)) flag++;
