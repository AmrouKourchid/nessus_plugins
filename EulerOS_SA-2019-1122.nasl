...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : polkit (EulerOS-SA-2019-1122)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1122
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e5ee62e0");
...
pkgs = ["polkit-0.112-7.h3",
        "polkit-devel-0.112-7.h3",
        "polkit-docs-0.112-7.h3"];
