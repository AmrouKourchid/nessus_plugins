...
# extracted from Fedora Security Advisory FEDORA-2023-f9e2ad8b73
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-f9e2ad8b73");

  script_name(english:"Fedora 36 : wireshark (2023-f9e2ad8b73)");
...
FEDORA-2023-f9e2ad8b73 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-f9e2ad8b73");
...
var pkgs = [
    {'reference':'wireshark-3.6.11-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
