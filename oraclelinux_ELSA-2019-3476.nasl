...
# extracted from Oracle Linux Security Advisory ELSA-2019-3476.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : squid:4 (ELSA-2019-3476)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
ELSA-2019-3476 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2019-3476.html");
...
var appstreams = {
    'squid:4': [
      ...
      {'reference':'squid-4.4-8.module+el8.1.0+5405+03b963f4', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      ...
      {'reference':'squid-4.4-8.module+el8.1.0+5405+03b963f4', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
    ]
};
