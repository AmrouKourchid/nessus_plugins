...
if (description)
{
  ...
  script_xref(name:"APPLE-SA", value:"122070");
  script_xref(name:"IAVA", value:"2025-A-0068-S");

  script_name(english:"macOS 13.x < 13.7.3 Multiple Vulnerabilities (122070)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host is missing a macOS update that fixes multiple vulnerabilities");
  script_set_attribute(attribute:"description", value:
"The remote host is running a version of macOS / Mac OS X that is 13.x prior to 13.7.3. It is, therefore, affected by
...
version number.");
  script_set_attribute(attribute:"see_also", value:"https://support.apple.com/en-us/122070");
  script_set_attribute(attribute:"solution", value:
"Upgrade to macOS 13.7.3 or later.");
...
var constraints = [
  { 'fixed_version' : '13.7.3', 'min_version' : '13.0', 'fixed_display' : 'macOS Ventura 13.7.3' }
];
