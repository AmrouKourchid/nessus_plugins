...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : libgcrypt (EulerOS-SA-2022-1173)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1173
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?790bbccb");
...
var pkgs = [
  "libgcrypt-1.5.3-13.1.h5",
  "libgcrypt-devel-1.5.3-13.1.h5"
];
