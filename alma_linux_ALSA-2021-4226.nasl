...
# AlmaLinux Security Advisory ALSA-2021:4226.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2021:4226");
  script_xref(name:"IAVB", value:"2021-B-0047-S");

  script_name(english:"AlmaLinux 8 : grafana (ALSA-2021:4226)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2021-4226.html");
