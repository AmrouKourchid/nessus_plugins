...
# extracted from Red Hat Security Advisory RHSA-2023:0005. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:0005");

  script_name(english:"RHEL 9 : bcel (RHSA-2023:0005)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_0005.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?26e0bf0e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2142707");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:0005");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL bcel package based on the guidance in RHSA-2023:0005.");
