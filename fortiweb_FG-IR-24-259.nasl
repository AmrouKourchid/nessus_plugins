...
if (description)
{
  ...
  script_name(english:"Fortinet FortiWeb Path traversal in csfd daemon (FG-IR-24-259)");
...
"For 6.4.x / 7.0.x / 7.2.x, see vendor advisory. For 7.4.x, upgrade to FortiWeb version 7.4.5 or later. For 7.6.x,
upgrade to FortiWeb version 7.6.1 or later.");
