...
# extracted from Fedora Security Advisory FEDORA-2024-06e6dcbb42
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-06e6dcbb42");

  script_name(english:"Fedora 40 : nginx (2024-06e6dcbb42)");
...
FEDORA-2024-06e6dcbb42 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-06e6dcbb42");
...
var pkgs = [
    {'reference':'nginx-1.26.1-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
