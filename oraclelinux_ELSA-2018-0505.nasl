...
# extracted from Red Hat Security Advisory RHSA-2018:0505 and 
# Oracle Linux Security Advisory ELSA-2018-0505 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : mailman (ELSA-2018-0505)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2018-0505.html");
...
var pkgs = [
    {'reference':'mailman-2.1.15-26.el7_4.1', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
    {'reference':'mailman-2.1.15-26.el7_4.1', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'}
];
