...
# extracted from Fedora Security Advisory FEDORA-2018-2062cd7548.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : libbson (2018-2062cd7548)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-2062cd7548");
  script_set_attribute(attribute:"solution", value:
"Update the affected libbson package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:libbson");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"libbson-1.9.5-3.fc28")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "libbson");
}
