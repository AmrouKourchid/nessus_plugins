...
# extracted from Fedora Security Advisory FEDORA-2023-6c3278c87b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-6c3278c87b");

  script_name(english:"Fedora 36 : thunderbird (2023-6c3278c87b)");
...
FEDORA-2023-6c3278c87b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-6c3278c87b");
...
var pkgs = [
    {'reference':'thunderbird-102.10.0-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
