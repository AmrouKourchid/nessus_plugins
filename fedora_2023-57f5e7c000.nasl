...
# extracted from Fedora Security Advisory FEDORA-2023-57f5e7c000
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-57f5e7c000");

  script_name(english:"Fedora 38 : stellarium (2023-57f5e7c000)");
...
FEDORA-2023-57f5e7c000 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-57f5e7c000");
...
var pkgs = [
    {'reference':'stellarium-1.2-9.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
