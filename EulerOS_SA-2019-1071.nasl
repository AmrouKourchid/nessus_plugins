...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : poppler (EulerOS-SA-2019-1071)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1071
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?67d66446");
...
pkgs = ["poppler-0.26.5-17.h15.eulerosv2r7",
        "poppler-glib-0.26.5-17.h15.eulerosv2r7",
        "poppler-qt-0.26.5-17.h15.eulerosv2r7",
        "poppler-utils-0.26.5-17.h15.eulerosv2r7"];
