...
# extracted from VMware Security Advisory PHSA-2021-3.0-0282. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: C PHSA-2021-3.0-0282");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the c package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-3.0-282.md");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'c-ares-1.16.1-2.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'c-ares-devel-1.16.1-2.ph3')) flag++;
