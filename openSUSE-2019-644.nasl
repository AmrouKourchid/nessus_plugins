...
# extracted from openSUSE Security Update openSUSE-2019-644.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libressl (openSUSE-2019-644)");
...
"Update the affected libressl packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-12434");
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "libcrypto43 / libcrypto43-32bit / libcrypto43-32bit-debuginfo / etc");
}
