...
# extracted from Debian Security Advisory DLA-2218-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2218-1 : transmission security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"Tom Richards reported that by using a crafted torrent file one could
cause a use-after-free, which might result in a denial of service
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2020/05/msg00022.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/jessie/transmission");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"transmission", reference:"2.84-0.2+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"transmission-cli", reference:"2.84-0.2+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"transmission-common", reference:"2.84-0.2+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"transmission-daemon", reference:"2.84-0.2+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"transmission-dbg", reference:"2.84-0.2+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"transmission-gtk", reference:"2.84-0.2+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"transmission-qt", reference:"2.84-0.2+deb8u2")) flag++;
