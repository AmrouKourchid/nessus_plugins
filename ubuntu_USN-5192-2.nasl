...
USN-5192-2 advisory.
    ...
    USN-5192-1 fixed a vulnerability in Apache Log4j 2. This update provides the corresponding update for
    Ubuntu 16.04 ESM.
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'liblog4j2-java', 'pkgver': '2.4-2ubuntu0.1~esm1', 'ubuntu_pro': TRUE}
];
