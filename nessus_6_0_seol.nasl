...
if (description)
{
  ...
  script_name(english:"Tenable Nessus SEoL (<= 6.0.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Tenable Nessus is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Tenable Nessus is less than or equal to 6.0.x. It is, therefore, no longer maintained by its
vendor or provider.
...
var constraints = [
  { max_branch : '6.0', seol : 20160430, eseol : 20161031 }
];
