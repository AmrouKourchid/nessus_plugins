...
# extracted from Oracle Linux Security Advisory ELSA-2023-6549.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : libreswan (ELSA-2023-6549)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-6549.html");
...
var pkgs = [
    {'reference':'libreswan-4.12-1.0.1.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libreswan-4.12-1.0.1.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
