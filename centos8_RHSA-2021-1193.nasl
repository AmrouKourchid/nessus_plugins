...
# Red Hat Security Advisory RHSA-2021:1193. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : thunderbird (CESA-2021:1193)");
...
CESA-2021:1193 advisory.
  ...
  - Mozilla: Thunderbird might execute an alternative OTR library (CVE-2021-29949)
