...
# extracted from Fedora Security Advisory FEDORA-2022-19056934a7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-19056934a7");

  script_name(english:"Fedora 37 : mingw-libtasn1 (2022-19056934a7)");
...
FEDORA-2022-19056934a7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-19056934a7");
...
var pkgs = [
    {'reference':'mingw-libtasn1-4.19.0-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
