...
# extracted from Red Hat Security Advisory RHSA-2025:3421. The text
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_3421.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f60a8ff9");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:3421");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL freetype package based on the guidance in RHSA-2025:3421.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'freetype-2.9.1-10.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freetype-devel-2.9.1-10.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
