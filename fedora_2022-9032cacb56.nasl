...
# extracted from Fedora Security Advisory FEDORA-2022-9032cacb56
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-9032cacb56");

  script_name(english:"Fedora 37 : advancecomp (2022-9032cacb56)");
...
FEDORA-2022-9032cacb56 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-9032cacb56");
...
var pkgs = [
    {'reference':'advancecomp-2.4-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
