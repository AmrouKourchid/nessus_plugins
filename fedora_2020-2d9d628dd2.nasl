...
# extracted from Fedora Security Advisory FEDORA-2020-2d9d628dd2.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 33 : LibRaw (2020-2d9d628dd2)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-2d9d628dd2");
...
"Update the affected LibRaw package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-24890");
...
flag = 0;
if (rpm_check(release:"FC33", reference:"LibRaw-0.20.0-3.fc33")) flag++;
