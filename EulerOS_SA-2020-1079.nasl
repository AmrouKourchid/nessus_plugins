...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.5.0 : sqlite (EulerOS-SA-2020-1079)");
...
affected by the following vulnerabilities :
  ...
  - In SQLite through 3.29.0, whereLoopAddBtreeIndex in
    ...
    because of missing validation of a sqlite_stat1 sz
    field, aka a 'severe division by zero in the query
    planner.'(CVE-2019-16168)

  - pragma.c in SQLite through 3.30.1 mishandles NOT NULL
    in an integrity_check PRAGMA command in certain cases
    of generated columns.(CVE-2019-19646)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1079
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f693eb9f");
...
pkgs = ["sqlite-3.24.0-2.h6.eulerosv2r8",
        "sqlite-libs-3.24.0-2.h6.eulerosv2r8"];
