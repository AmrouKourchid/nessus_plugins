...
# extracted from Fedora Security Advisory FEDORA-2023-4125279976
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-4125279976");
  script_xref(name:"IAVB", value:"2023-B-0067-S");

  script_name(english:"Fedora 38 : xen (2023-4125279976)");
...
FEDORA-2023-4125279976 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-4125279976");
...
var pkgs = [
    {'reference':'xen-4.17.2-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
