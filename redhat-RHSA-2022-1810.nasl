...
# extracted from Red Hat Security Advisory RHSA-2022:1810. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:1810");

  script_name(english:"RHEL 8 : libtiff (RHSA-2022:1810)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for libtiff.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2022:1810 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_1810.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cd7bf97f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:1810");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2004031");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libtiff package based on the guidance in RHSA-2022:1810.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libtiff-4.0.9-21.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libtiff-devel-4.0.9-21.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libtiff-tools-4.0.9-21.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
