...
# extracted from Fedora Security Advisory FEDORA-2025-69207650a4
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-69207650a4");

  script_name(english:"Fedora 40 : glibc (2025-69207650a4)");
...
FEDORA-2025-69207650a4 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-69207650a4");
...
var pkgs = [
    {'reference':'glibc-2.39-37.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
