...
# Rocky Linux Security Advisory RLSA-2024:0628.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2024:0628");

  script_name(english:"Rocky Linux 8 : libssh (RLSA-2024:0628)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Rocky Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Rocky Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
RLSA-2024:0628 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2024:0628");
...
var pkgs = [
    ...
    {'reference':'libssh-debuginfo-0.9.6-13.el8_9', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libssh-debugsource-0.9.6-13.el8_9', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
