...
USN-6083-2 advisory.
    ...
    USN-6083-1 fixed a vulnerability in cups-filters. This update provides the corresponding update for Ubuntu
    16.04 LTS.
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'cups-browsed', 'pkgver': '1.8.3-2ubuntu3.5+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'cups-filters', 'pkgver': '1.8.3-2ubuntu3.5+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'cups-filters-core-drivers', 'pkgver': '1.8.3-2ubuntu3.5+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libcupsfilters-dev', 'pkgver': '1.8.3-2ubuntu3.5+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libcupsfilters1', 'pkgver': '1.8.3-2ubuntu3.5+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libfontembed-dev', 'pkgver': '1.8.3-2ubuntu3.5+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libfontembed1', 'pkgver': '1.8.3-2ubuntu3.5+esm1', 'ubuntu_pro': TRUE}
];
