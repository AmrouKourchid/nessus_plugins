...
# extracted from Gentoo Linux Security Advisory GLSA 201903-19.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2017-10686", "CVE-2017-11111", "CVE-2017-14228");
  script_xref(name:"GLSA", value:"201903-19");

  script_name(english:"GLSA-201903-19 : NASM: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-201903-19
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/201903-19");
...
"All NASM users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-11111");
...
if (qpkg_check(package:"dev-lang/nasm", unaffected:make_list("ge 2.14.02"), vulnerable:make_list("lt 2.14.02"))) flag++;
