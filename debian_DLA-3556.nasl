...
# extracted from Debian Security Advisory dla-3556. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3556 : aom-tools - security update");
...
dla-3556 advisory.
    ...
    -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3556-1                debian-lts@lists.debian.org
    https://www.debian.org/lts/security/                      Markus Koschany
    September 06, 2023                            https://wiki.debian.org/LTS
    -------------------------------------------------------------------------
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/aom");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'aom-tools', 'reference': '1.0.0-3+deb10u1'},
    {'release': '10.0', 'prefix': 'libaom-dev', 'reference': '1.0.0-3+deb10u1'},
    {'release': '10.0', 'prefix': 'libaom-doc', 'reference': '1.0.0-3+deb10u1'},
    {'release': '10.0', 'prefix': 'libaom0', 'reference': '1.0.0-3+deb10u1'}
];
