...
if (description)
{
  ...
  script_name(english:"RHCOS 4 : OpenShift Container Platform 4.10.46 (RHSA-2022:9098)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat CoreOS host is missing a security update for OpenShift Container Platform 4.10.46.");
...
referenced in the RHSA-2022:9098 advisory.
...
"Update the RHCOS OpenShift Container Platform 4.10.46 packages based on the guidance in RHSA-2022:9098");
...
var pkgs = [
    {'reference':'jenkins-2-plugins-4.10.1670851835-1.el8', 'release':'4', 'el_string':'el8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
];
