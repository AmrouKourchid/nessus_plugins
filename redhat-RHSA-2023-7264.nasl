...
# extracted from Red Hat Security Advisory RHSA-2023:7264. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:7264");

  script_name(english:"RHEL 8 : open-vm-tools (RHSA-2023:7264)");
...
referenced in the RHSA-2023:7264 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_7264.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9791338c");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:7264");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL open-vm-tools package based on the guidance in RHSA-2023:7264.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'open-vm-tools-12.1.5-2.el8_8.4', 'sp':'8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'open-vm-tools-desktop-12.1.5-2.el8_8.4', 'sp':'8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'open-vm-tools-salt-minion-12.1.5-2.el8_8.4', 'sp':'8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'open-vm-tools-sdmp-12.1.5-2.el8_8.4', 'sp':'8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
