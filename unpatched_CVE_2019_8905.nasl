...
if (description)
{
  ...
  script_cve_id("CVE-2019-8905");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2019-8905");
...
patch available.
  ...
  - do_core_note in readelf.c in libmagic.a in file 5.35 has a stack-based buffer over-read, related to
    file_printable, a different vulnerability than CVE-2018-10360. (CVE-2019-8905)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-8905");
