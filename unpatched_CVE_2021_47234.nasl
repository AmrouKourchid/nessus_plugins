...
if (description)
{
  ...
  script_cve_id("CVE-2021-47234");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2021-47234");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: phy: phy-mtk-tphy: Fix some resource
    leaks in mtk_phy_init() Use clk_disable_unprepare() in the error path of mtk_phy_init() to fix some
    resource leaks. (CVE-2021-47234)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-47234");
