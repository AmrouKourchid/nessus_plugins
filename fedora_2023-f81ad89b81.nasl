...
# extracted from Fedora Security Advisory FEDORA-2023-f81ad89b81
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-f81ad89b81");

  script_name(english:"Fedora 36 : nautilus (2023-f81ad89b81)");
...
FEDORA-2023-f81ad89b81 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-f81ad89b81");
...
var pkgs = [
    {'reference':'nautilus-42.6-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
