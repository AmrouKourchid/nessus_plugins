...
# extracted from Red Hat Security Advisory RHSA-2022:0158. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:0158");
  script_xref(name:"CEA-ID", value:"CEA-2021-0025");

  script_name(english:"RHEL 7 : telnet (RHSA-2022:0158)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for telnet.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2022:0158 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_0158.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9aca450e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:0158");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1811673");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL telnet package based on the guidance in RHSA-2022:0158.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'telnet-0.17-65.el7_7', 'sp':'7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'telnet-0.17-65.el7_7', 'sp':'7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'telnet-server-0.17-65.el7_7', 'sp':'7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'telnet-server-0.17-65.el7_7', 'sp':'7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
