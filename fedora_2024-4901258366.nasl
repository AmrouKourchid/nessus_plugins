...
# extracted from Fedora Security Advisory FEDORA-2024-4901258366
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-4901258366");

  script_name(english:"Fedora 40 : gitleaks (2024-4901258366)");
...
FEDORA-2024-4901258366 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-4901258366");
  script_set_attribute(attribute:"solution", value:
"Update the affected gitleaks package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:gitleaks");
...
var pkgs = [
    {'reference':'gitleaks-8.18.2-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'gitleaks');
}
