...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS / 22.04 LTS : Net-SNMP vulnerabilities (USN-5795-1)");
...
vulnerabilities as referenced in the USN-5795-1 advisory.
    ...
    It was discovered that Net-SNMP incorrectly handled certain requests. A remote attacker could possibly use
    these issues to cause Net-SNMP to crash, resulting in a denial of service.
