...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : libtool (ELSA-2009-1646)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2009-1646.html");
  script_set_attribute(attribute:"solution", value:
"Update the affected libtool, libtool-ltdl and / or libtool-ltdl-devel packages.");
...
var pkgs = [
    {'reference':'libtool-1.5.22-7.el5_4', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libtool-ltdl-1.5.22-7.el5_4', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libtool-ltdl-devel-1.5.22-7.el5_4', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libtool-1.5.22-7.el5_4', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libtool-ltdl-1.5.22-7.el5_4', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libtool-ltdl-devel-1.5.22-7.el5_4', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libtool / libtool-ltdl / libtool-ltdl-devel');
}
