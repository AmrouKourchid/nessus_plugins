...
# extracted from Debian Security Advisory dla-3565. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3565 : ruby-loofah - security update");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'ruby-loofah', 'reference': '2.2.3-1+deb10u2'}
];
