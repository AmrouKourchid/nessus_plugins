...
# extracted from Fedora Security Advisory FEDORA-2023-a7b89262c6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-a7b89262c6");

  script_name(english:"Fedora 39 : kernel / kernel-headers / kernel-tools (2023-a7b89262c6)");
...
FEDORA-2023-a7b89262c6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-a7b89262c6");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for FEDORA-2023-a7b89262c6');
  }
  else
  {
...
var pkgs = [
    {'reference':'kernel-6.6.3-200.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kernel-headers-6.6.3-200.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kernel-tools-6.6.3-200.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
