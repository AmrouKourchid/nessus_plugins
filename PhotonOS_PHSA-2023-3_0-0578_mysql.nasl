...
if (description)
{
  ...
  script_cve_id("CVE-2023-21980");
  script_xref(name:"IAVA", value:"2023-A-0212-S");
  script_xref(name:"IAVA", value:"2023-A-0562");

  script_name(english:"Photon OS 3.0: Mysql PHSA-2023-3.0-0578");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'mysql-8.0.33-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'mysql-devel-8.0.33-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'mysql-icu-data-files-8.0.33-1.ph3')) flag++;
