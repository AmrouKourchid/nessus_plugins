...
# extracted from Red Hat Security Advisory RHSA-2023:6705. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:6705");

  script_name(english:"RHEL 9 : procps-ng (RHSA-2023:6705)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6705.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?59541aac");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2222056");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2228494");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6705");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL procps-ng package based on the guidance in RHSA-2023:6705.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'procps-ng-3.3.17-13.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'procps-ng-devel-3.3.17-13.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'procps-ng-i18n-3.3.17-13.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
