...
"The version of OpenSSL installed on the remote host is prior to 1.1.0d. It is, therefore, affected by multiple
vulnerabilities as referenced in the 1.1.0d advisory.
  ...
  - In OpenSSL 1.1.0 before 1.1.0d, if a malicious server supplies bad parameters for a DHE or ECDHE key
    exchange then this can result in the client attempting to dereference a NULL pointer leading to a client
    crash. This could be exploited in a Denial of Service attack. (CVE-2017-3730)

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  # https://git.openssl.org/gitweb/?p=openssl.git;a=commitdiff;h=00d965474b22b54e4275232bc71ee0c699c5cd21
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?19532289");
  # https://git.openssl.org/gitweb/?p=openssl.git;a=commitdiff;h=efbe126e3ebb9123ac9d058aa2bb044261342aaa
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8ee7e7fd");
  # https://git.openssl.org/gitweb/?p=openssl.git;a=commitdiff;h=a59b90bf491410f1f2bc4540cc21f1980fd14c5b
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c4271253");
  script_set_attribute(attribute:"see_also", value:"https://www.cve.org/CVERecord?id=CVE-2017-3730");
...
var constraints = [
  { 'min_version' : '1.1.0', 'fixed_version' : '1.1.0d' }
];
