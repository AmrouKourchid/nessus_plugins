...
# Rocky Linux Security Advisory RLSA-2021:1631.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2021:1631");

  script_name(english:"Rocky Linux 8 : python-urllib3 (RLSA-2021:1631)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2021:1631");
...
"Update the affected python3-urllib3 package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:rocky:linux:python3-urllib3");
