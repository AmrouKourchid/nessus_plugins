...
# extracted from Fedora Security Advisory FEDORA-2022-15c504b6eb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-15c504b6eb");

  script_name(english:"Fedora 38 : rust-capnp / rust-sequoia-octopus-librnp (2022-15c504b6eb)");
...
FEDORA-2022-15c504b6eb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-15c504b6eb");
...
var pkgs = [
    {'reference':'rust-capnp-0.14.11-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-sequoia-octopus-librnp-1.4.1-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
