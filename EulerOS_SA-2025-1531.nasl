...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : openssh (EulerOS-SA-2025-1531)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1531
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6386e2ec");
...
var pkgs = [
  "openssh-8.2p1-9.h57.eulerosv2r10",
  "openssh-clients-8.2p1-9.h57.eulerosv2r10",
  "openssh-server-8.2p1-9.h57.eulerosv2r10"
];
