...
# extracted from Amazon Linux AMI Security Advisory ALAS-2021-1466.
##
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2021-1466");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2022/09/15");

  script_name(english:"Amazon Linux AMI : php7-pear (ALAS-2021-1466)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux AMI host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of php7-pear installed on the remote host is prior to 1.10.12-4.30. It is, therefore, affected by multiple
vulnerabilities as referenced in the ALAS-2021-1466 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/ALAS-2021-1466.html");
...
var pkgs = [
    {'reference':'php7-pear-1.10.12-4.30.amzn1', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE}
];
