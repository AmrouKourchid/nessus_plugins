...
# extracted from Fedora Security Advisory FEDORA-2025-20e35f4f9f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-20e35f4f9f");

  script_name(english:"Fedora 41 : chromium (2025-20e35f4f9f)");
...
FEDORA-2025-20e35f4f9f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-20e35f4f9f");
...
var pkgs = [
    {'reference':'chromium-135.0.7049.84-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
