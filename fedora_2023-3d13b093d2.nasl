...
# extracted from Fedora Security Advisory FEDORA-2023-3d13b093d2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-3d13b093d2");

  script_name(english:"Fedora 38 : python3-docs / python3.11 (2023-3d13b093d2)");
...
FEDORA-2023-3d13b093d2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-3d13b093d2");
...
var pkgs = [
    {'reference':'python3-docs-3.11.5-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3.11-3.11.5-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
