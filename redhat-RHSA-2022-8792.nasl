...
# extracted from Red Hat Security Advisory RHSA-2022:8792. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:8792");

  script_name(english:"RHEL 9 : Red Hat JBoss Enterprise Application Platform 7.4.8 Security update (Low) (RHSA-2022:8792)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8792.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ec821331");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8792");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2117506");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/JBEAP-23835");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'eap7-undertow-2.2.20-1.SP1_redhat_00001.1.el9eap', 'release':'9', 'el_string':'el9eap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap7'}
    ]
  }
];
