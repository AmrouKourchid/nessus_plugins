...
# extracted from Red Hat Security Advisory RHSA-2019:2097. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:2097");

  script_name(english:"RHEL 7 : perl-Archive-Tar (RHSA-2019:2097)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for perl-Archive-Tar.");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_2097.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?84bd93bf");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:2097");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1588760");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL perl-Archive-Tar package based on the guidance in RHSA-2019:2097.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'perl-Archive-Tar-1.92-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
