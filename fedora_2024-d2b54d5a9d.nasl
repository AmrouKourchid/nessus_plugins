...
# extracted from Fedora Security Advisory FEDORA-2024-d2b54d5a9d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-d2b54d5a9d");

  script_name(english:"Fedora 40 : chromium (2024-d2b54d5a9d)");
...
FEDORA-2024-d2b54d5a9d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-d2b54d5a9d");
...
var pkgs = [
    {'reference':'chromium-126.0.6478.114-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
