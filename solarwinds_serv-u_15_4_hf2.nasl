...
if (description)
{
  ...
  script_cve_id("CVE-2023-40060");
  script_xref(name:"IAVA", value:"2023-A-0601-S");
  script_xref(name:"IAVA", value:"2023-A-0458-S");

  script_name(english:"SolarWinds Serv-U 15.4 < 15.4 HF2 Authentication Bypass");

  script_set_attribute(attribute:"synopsis", value:
"The remote FTP server is affected by an authentication bypass vulnerability");
  script_set_attribute(attribute:"description", value:
"The version of SolarWinds Serv-U installed on the remote host is prior to 15.4 HF2. It is, therefore, affected by a
vulnerability as referenced in the serv-u_15_4_hf2 advisory.
  ...
  - A vulnerability has been identified within Serv-U 15.4 that, if exploited, allows an actor to bypass
    ...
    perform this action. The previous vulnerability (CVE-2023-35179) was not completely resolved in 15.4
    Hotfix 1. (CVE-2023-40060)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://www.solarwinds.com/trust-center/security-advisories/cve-2023-40060
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9f56ff0e");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Serv-U version 15.4 HF2 or later.");
  script_set_attribute(attribute:"agent", value:"all");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:M/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:H/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-40060");
...
var constraints = [
  { 'min_version' : '15.4', 'fixed_version' : '15.4.1', 'fixed_display' : '15.4 HF2'}
];
