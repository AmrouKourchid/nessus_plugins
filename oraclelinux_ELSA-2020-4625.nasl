...
# extracted from Oracle Linux Security Advisory ELSA-2020-4625.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : spamassassin (ELSA-2020-4625)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2020-4625.html");
...
var pkgs = [
    {'reference':'spamassassin-3.4.2-10.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'spamassassin-3.4.2-10.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
