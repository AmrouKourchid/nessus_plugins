...
# extracted from Ubuntu Security Notice USN-5989-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5989-1");

  script_name(english:"Ubuntu 16.04 ESM : GlusterFS vulnerability (USN-5989-1)");
...
USN-5989-1 advisory.
    ...
    Tao Lyu discovered that GlusterFS did not properly handle certain event notifications. An attacker could
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5989-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'glusterfs-client', 'pkgver': '3.7.6-1ubuntu1+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'glusterfs-common', 'pkgver': '3.7.6-1ubuntu1+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'glusterfs-server', 'pkgver': '3.7.6-1ubuntu1+esm2', 'ubuntu_pro': TRUE}
];
