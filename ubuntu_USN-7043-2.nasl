...
# extracted from Ubuntu Security Notice USN-7043-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"7043-2");

  script_name(english:"Ubuntu 18.04 LTS : cups-filters vulnerability (USN-7043-2)");
...
USN-7043-2 advisory.
    ...
    USN-7043-1 fixed a vulnerability in cups-filters. This update provides the corresponding update for Ubuntu
    18.04 LTS.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7043-2");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'cups-browsed', 'pkgver': '1.20.2-0ubuntu3.3+esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'cups-filters', 'pkgver': '1.20.2-0ubuntu3.3+esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'cups-filters-core-drivers', 'pkgver': '1.20.2-0ubuntu3.3+esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libcupsfilters-dev', 'pkgver': '1.20.2-0ubuntu3.3+esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libcupsfilters1', 'pkgver': '1.20.2-0ubuntu3.3+esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libfontembed-dev', 'pkgver': '1.20.2-0ubuntu3.3+esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libfontembed1', 'pkgver': '1.20.2-0ubuntu3.3+esm1', 'ubuntu_pro': TRUE}
];
