...
# SUSE update advisory SUSE-SU-2023:0284-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:0284-1");

  script_name(english:"SUSE SLES12 Security Update : xorg-x11-server (SUSE-SU-2023:0284-1)");
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-February/013643.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?82801826");
...
var pkgs = [
    {'reference':'xorg-x11-server-7.6_1.18.3-76.60.1', 'sp':'2', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-bcl-release-12.2']},
    {'reference':'xorg-x11-server-extra-7.6_1.18.3-76.60.1', 'sp':'2', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-bcl-release-12.2']}
];
