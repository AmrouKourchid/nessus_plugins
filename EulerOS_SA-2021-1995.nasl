...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.6.0 : bind (EulerOS-SA-2021-1995)");
...
by the following vulnerability :
  ...
  - BIND servers are vulnerable if they are running an
    ...
    unproven, is theoretically possible.(CVE-2020-8625)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1995
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?264dd166");
...
pkgs = ["bind-9.11.4-10.P2.h26.eulerosv2r8",
        "bind-chroot-9.11.4-10.P2.h26.eulerosv2r8",
        "bind-export-devel-9.11.4-10.P2.h26.eulerosv2r8",
        "bind-export-libs-9.11.4-10.P2.h26.eulerosv2r8",
        "bind-libs-9.11.4-10.P2.h26.eulerosv2r8",
        "bind-libs-lite-9.11.4-10.P2.h26.eulerosv2r8",
        "bind-license-9.11.4-10.P2.h26.eulerosv2r8",
        "bind-pkcs11-9.11.4-10.P2.h26.eulerosv2r8",
        "bind-pkcs11-libs-9.11.4-10.P2.h26.eulerosv2r8",
        "bind-pkcs11-utils-9.11.4-10.P2.h26.eulerosv2r8",
        "bind-utils-9.11.4-10.P2.h26.eulerosv2r8",
        "python3-bind-9.11.4-10.P2.h26.eulerosv2r8"];
