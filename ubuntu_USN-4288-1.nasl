...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS : ppp vulnerability (USN-4288-1)");
...
in the USN-4288-1 advisory.

    It was discovered that ppp incorrectly handled certain rhostname values. A remote attacker could use this
    issue to cause ppp to crash, resulting in a denial of service, or possibly execute arbitrary code.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4288-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'ppp', 'pkgver': '2.4.7-1+2ubuntu1.16.04.2'},
    {'osver': '16.04', 'pkgname': 'ppp-dev', 'pkgver': '2.4.7-1+2ubuntu1.16.04.2'},
    {'osver': '16.04', 'pkgname': 'ppp-udeb', 'pkgver': '2.4.7-1+2ubuntu1.16.04.2'},
    {'osver': '18.04', 'pkgname': 'ppp', 'pkgver': '2.4.7-2+2ubuntu1.2'},
    {'osver': '18.04', 'pkgname': 'ppp-dev', 'pkgver': '2.4.7-2+2ubuntu1.2'},
    {'osver': '18.04', 'pkgname': 'ppp-udeb', 'pkgver': '2.4.7-2+2ubuntu1.2'}
];
