...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.1 : python3 (EulerOS-SA-2024-1406)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1406
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3674ae1c");
...
var pkgs = [
  "python3-3.9.9-7.h25.eulerosv2r11",
  "python3-unversioned-command-3.9.9-7.h25.eulerosv2r11"
];
