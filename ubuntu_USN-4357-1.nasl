...
# extracted from Ubuntu Security Notice USN-4357-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"4357-1");

  script_name(english:"Ubuntu 18.04 LTS : IPRoute vulnerability (USN-4357-1)");
...
USN-4357-1 advisory.
    ...
    It was discovered that IPRoute incorrectly handled certain inputs. An attacker could possibly use this
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4357-1");
  script_set_attribute(attribute:"solution", value:
"Update the affected iproute2 package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:iproute2");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'iproute2', 'pkgver': '4.15.0-2ubuntu1.1'}
];
