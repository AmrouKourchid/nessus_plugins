...
# extracted from Gentoo Linux Security Advisory GLSA 202209-26.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202209-26 : Go: Multiple Vulnerabilities");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202209-26");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=869002");
  script_set_attribute(attribute:"solution", value:
"All Go users should upgrade to the latest version:            # emerge --sync           # emerge --ask --oneshot
--verbose >=dev-lang/go-1.18.6          In addition, users using Portage 3.0.9 or later should ensure that packages with
...
var packages = [
  {
    'name' : "dev-lang/go",
    'unaffected' : make_list("ge 1.18.6", "lt 1.0.0"),
    'vulnerable' : make_list("lt 1.18.6")
  }
];
