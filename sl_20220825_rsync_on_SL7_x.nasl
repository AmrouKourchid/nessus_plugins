...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"RHSA-2022:6170");

  script_name(english:"Scientific Linux Security Update : rsync on SL7.x x86_64 (2022:6170)");
...
SLSA-2022:6170-1 advisory.

  - rsync: remote arbitrary files write inside the directories of connecting peers (CVE-2022-29154)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.scientificlinux.org/category/sl-errata/slsa-20226170-1");
...
"Update the affected rsync and / or rsync-debuginfo packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fermilab:scientific_linux:rsync");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fermilab:scientific_linux:rsync-debuginfo");
...
var pkgs = [
    {'reference':'rsync-3.1.2-11.el7_9', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rsync-debuginfo-3.1.2-11.el7_9', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE}
];
