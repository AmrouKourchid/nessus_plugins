...
# extracted from Fedora Security Advisory FEDORA-2023-0e1ae0d5f6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-0e1ae0d5f6");

  script_name(english:"Fedora 36 : thunderbird (2023-0e1ae0d5f6)");
...
FEDORA-2023-0e1ae0d5f6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-0e1ae0d5f6");
...
var pkgs = [
    {'reference':'thunderbird-102.9.1-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
