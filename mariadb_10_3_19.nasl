...
if (description)
{
  ...
  script_name(english:"MariaDB 10.3.x < 10.3.19 Multiple Denial of Service Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote database server is affected by multiple denial of service vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of MariaDB installed on the remote host is 10.3.x prior to 10.3.19. It is, therefore, affected by multiple
denial of service vulnerabilities:
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ecce2d06");
  script_set_attribute(attribute:"solution", value:
"Upgrade to MariaDB version 10.3.19 or later.");
...
mysql_check_version(variant: 'MariaDB', min:'10.3.0-MariaDB', fixed:make_list('10.3.19-MariaDB'), severity:SECURITY_WARNING);
