...
# extracted from Fedora Security Advisory FEDORA-2021-faf88b9499
#
...
if (description)
{
  ...
  script_name(english:"Fedora 33 : python3.9 (2021-faf88b9499)");
...
FEDORA-2021-faf88b9499 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-faf88b9499");
...
pkgs = [
    {'reference':'python3.9-3.9.1-2.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
