...
# extracted from Oracle Linux Security Advisory ELSA-2023-6587.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : opensc (ELSA-2023-6587)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-6587.html");
...
var pkgs = [
    {'reference':'opensc-0.23.0-2.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'opensc-0.23.0-2.el9', 'cpu':'i686', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'opensc-0.23.0-2.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
