...
"The version of Firefox installed on the remote Windows host is prior to 86.0. It is, therefore, affected by multiple
vulnerabilities as referenced in the mfsa2021-07 advisory.
...
mozilla_check_version(installs:installs, product:'firefox', esr:FALSE, fix:'86.0', xss:TRUE, severity:SECURITY_WARNING);
