...
# extracted from Red Hat Security Advisory RHSA-2024:6702. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:6702");

  script_name(english:"RHEL 8 : pcs (RHSA-2024:6702)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for pcs.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:6702 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_6702.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a7a9abd9");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:6702");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL pcs package based on the guidance in RHSA-2024:6702.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'pcs-0.10.12-6.el8_6.6', 'sp':'6', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcs-0.10.12-6.el8_6.6', 'sp':'6', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcs-snmp-0.10.12-6.el8_6.6', 'sp':'6', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcs-snmp-0.10.12-6.el8_6.6', 'sp':'6', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
