...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.2.0 : libxml2 (EulerOS-SA-2021-1047)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1047
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a451049f");
...
pkgs = ["libxml2-2.9.1-6.3.h25",
        "libxml2-devel-2.9.1-6.3.h25",
        "libxml2-python-2.9.1-6.3.h25"];
