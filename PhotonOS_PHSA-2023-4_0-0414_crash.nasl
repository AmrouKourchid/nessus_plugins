...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Crash PHSA-2023-4.0-0414");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'crash-8.0.2-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'crash-devel-8.0.2-1.ph4')) flag++;
