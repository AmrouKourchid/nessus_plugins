...
# extracted from Red Hat Security Advisory RHSA-2025:3698. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:3698");

  script_name(english:"RHEL 9 : opentelemetry-collector (RHSA-2025:3698)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for opentelemetry-collector.");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_3698.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dcb0d073");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:3698");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL opentelemetry-collector package based on the guidance in RHSA-2025:3698.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'opentelemetry-collector-0.107.0-8.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
