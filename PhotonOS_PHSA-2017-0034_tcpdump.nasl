...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-12902");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'tcpdump-4.9.2-1.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'tcpdump-debuginfo-4.9.2-1.ph1')) flag++;
