...
# extracted from Fedora Security Advisory FEDORA-2024-605004a28e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-605004a28e");

  script_name(english:"Fedora 39 : libgit2_1.6 (2024-605004a28e)");
...
FEDORA-2024-605004a28e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-605004a28e");
  script_set_attribute(attribute:"solution", value:
"Update the affected libgit2_1.6 package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:libgit2_1.6");
...
var pkgs = [
    {'reference':'libgit2_1.6-1.6.5-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libgit2_1.6');
}
