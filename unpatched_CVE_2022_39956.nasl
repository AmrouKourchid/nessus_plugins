...
if (description)
{
  ...
  script_cve_id("CVE-2022-39956");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-39956");
...
Note that Nessus relies on the presence of the package as reported by the vendor.");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/cve-2022-39956");
