...
# extracted from Red Hat Security Advisory RHSA-2024:2433. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2433");

  script_name(english:"RHEL 9 : avahi (RHSA-2024:2433)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for avahi.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:2433 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2433.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3ea30dab");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2433");
...
"Update the RHEL avahi package based on the guidance in RHSA-2024:2433.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'avahi-0.8-20.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'avahi-compat-howl-0.8-20.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'avahi-compat-howl-devel-0.8-20.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'avahi-compat-libdns_sd-0.8-20.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'avahi-compat-libdns_sd-devel-0.8-20.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'avahi-devel-0.8-20.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'avahi-glib-0.8-20.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'avahi-glib-devel-0.8-20.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'avahi-libs-0.8-20.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'avahi-tools-0.8-20.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
