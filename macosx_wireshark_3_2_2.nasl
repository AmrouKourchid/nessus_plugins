...
if (description)
{
  ...
  script_name(english:"Wireshark 3.2.x < 3.2.2 Multiple Vulnerabilities (macOS)");

  script_set_attribute(attribute:"synopsis", value:
"An application installed on the remote macOS / Mac OS X host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Wireshark installed on the remote macOS / Mac OS X host is prior to 3.2.2. It is, therefore, affected by
multiple vulnerabilities as referenced in the wireshark-3.2.2 advisory.
  ...
  - The WireGuard dissector could crash. It may be possible
    to make Wireshark crash by injecting a malformed packet
    onto the wire or by convincing someone to read a
    malformed packet trace file. (wireshark-bug-16394)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.wireshark.org/docs/relnotes/wireshark-3.2.2.html");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugs.wireshark.org/bugzilla/show_bug.cgi?id=16394");
  script_set_attribute(attribute:"see_also", value:"https://www.wireshark.org/security/wnpa-sec-2020-06");
...
"Upgrade to Wireshark version 3.2.2 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-9431");
...
constraints = [
  { 'min_version' : '3.2.0', 'max_version' : '3.2.1', 'fixed_version' : '3.2.2' }
];
