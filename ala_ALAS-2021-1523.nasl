...
vulnerability as referenced in the ALAS-2021-1523 advisory.
    ...
    A bug was discovered in containerd where pulling and extracting a specially-crafted container image can
    result in Unix file permission changes for existing files in the host's filesystem. Changes to file
    permissions can deny access to the expected owner of the file or widen access to others. (CVE-2021-32760)
