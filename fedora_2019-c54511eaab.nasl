...
# extracted from Fedora Security Advisory FEDORA-2019-c54511eaab.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : ansible (2019-c54511eaab)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"Update to bugfix release 2.7.8. Fixes also CVE-2019-3828

Note that Tenable Network Security has extracted the preceding
description block directly from the Fedora update system website.
Tenable has attempted to automatically clean and format it as much as
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-c54511eaab");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"ansible-2.7.8-1.fc28")) flag++;
