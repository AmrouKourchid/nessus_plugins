...
# extracted from Oracle Linux Security Advisory ELSA-2024-17931.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : runc (ELSA-2024-17931)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-17931.html");
...
var pkgs = [
    {'reference':'runc-1.1.12-1.el7', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
    {'reference':'runc-1.1.12-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'}
];
