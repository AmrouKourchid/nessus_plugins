...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : libvpx (EulerOS-SA-2020-1609)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1609
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ed33168b");
...
pkgs = ["libvpx-1.3.0-5.h1.eulerosv2r7"];
