...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.0 : uvplog (EulerOS-SA-2023-1690)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the uvplog package installed, the EulerOS Virtualization installation on the remote host is
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1690
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dd2b6c65");
  script_set_attribute(attribute:"solution", value:
"Update the affected uvplog packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:uvplog");
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "uvplog");
}
