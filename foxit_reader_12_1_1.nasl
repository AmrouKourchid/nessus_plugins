...
if (description)
{
  ...
  script_name(english:"Foxit PDF Reader < 12.1.1 Multiple Vulnerabilities");
...
"Upgrade to Foxit PDF Reader version 12.1.1 or later");
...
var constraints = [
  { 'max_version' : '12.1.0.15250', 'fixed_version' : '12.1.1' }
];
