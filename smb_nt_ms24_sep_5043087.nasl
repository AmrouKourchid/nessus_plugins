...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5043087");
  script_xref(name:"MSKB", value:"5043135");
  script_xref(name:"MSFT", value:"MS24-5043087");
  script_xref(name:"MSFT", value:"MS24-5043135");
  ...
  script_name(english:"KB5043087: Windows Server 2008 Security Update (September 2024)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5043087. It is, therefore, affected by multiple vulnerabilities
  ...
  - Windows Graphics Component Elevation of Privilege Vulnerability (CVE-2024-38249, CVE-2024-38250)

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5043087");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5043135");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5043087 or Cumulative Update 5043135");
...
if (
  smb_check_rollup(os:'6.0',
                   ...
                   rollup_date:'09_2024',
                   bulletin:bulletin,
                   rollup_kb_list:[5043135, 5043087])
)
{
