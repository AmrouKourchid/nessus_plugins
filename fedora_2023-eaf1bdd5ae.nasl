...
# extracted from Fedora Security Advisory FEDORA-2023-eaf1bdd5ae
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-eaf1bdd5ae");

  script_name(english:"Fedora 38 : git (2023-eaf1bdd5ae)");
...
FEDORA-2023-eaf1bdd5ae advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-eaf1bdd5ae");
...
var pkgs = [
    {'reference':'git-2.40.1-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
