...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : polkit (EulerOS-SA-2019-2042)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2042
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fc8f7fb4");
...
pkgs = ["polkit-0.112-12.h9",
        "polkit-devel-0.112-12.h9",
        "polkit-docs-0.112-12.h9"];
