...
# extracted from Red Hat Security Advisory libidn. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2016-6261", "CVE-2016-6262", "CVE-2016-6263");

  script_name(english:"RHEL 5 : libidn (Unpatched Vulnerability) (deprecated)");
...
"This plugin has been deprecated as it does not adhere to established standards for this style of check.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:libidn");
