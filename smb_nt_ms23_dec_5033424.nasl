...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5033424");
  script_xref(name:"MSKB", value:"5033433");
  script_xref(name:"MSFT", value:"MS23-5033424");
  script_xref(name:"MSFT", value:"MS23-5033433");
  script_xref(name:"IAVA", value:"2023-A-0689-S");
  script_xref(name:"IAVA", value:"2023-A-0690-S");

  script_name(english:"KB5033424: Windows Server 2008 R2 Security Update (December 2023)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5033424");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5033433");
...
if (("windows server 2008 r2" >< tolower(os_name)) &&
  smb_check_rollup(os:'6.1',
                   ...
                   rollup_date:'12_2023',
                   bulletin:bulletin,
                   rollup_kb_list:[5033433, 5033424])
)
{
