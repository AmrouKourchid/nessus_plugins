...
# extracted from Fedora Security Advisory FEDORA-2022-5f28fceec0
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-5f28fceec0");

  script_name(english:"Fedora 36 : dotnet6.0 (2022-5f28fceec0)");
...
FEDORA-2022-5f28fceec0 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-5f28fceec0");
...
var pkgs = [
    {'reference':'dotnet6.0-6.0.110-2.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
