...
# extracted from Fedora Security Advisory FEDORA-2023-4e69bf4c59
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-4e69bf4c59");

  script_name(english:"Fedora 39 : samba (2023-4e69bf4c59)");
...
FEDORA-2023-4e69bf4c59 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-4e69bf4c59");
...
var pkgs = [
    {'reference':'samba-4.19.3-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
