...
# extracted from Ubuntu Security Notice USN-7259-3. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"7259-3");

  script_name(english:"Ubuntu 14.04 LTS : GNU C Library vulnerability (USN-7259-3)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7259-3");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'eglibc-source', 'pkgver': '2.19-0ubuntu6.15+esm4', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'libc-bin', 'pkgver': '2.19-0ubuntu6.15+esm4', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'libc-dev-bin', 'pkgver': '2.19-0ubuntu6.15+esm4', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'libc6', 'pkgver': '2.19-0ubuntu6.15+esm4', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'libc6-amd64', 'pkgver': '2.19-0ubuntu6.15+esm4', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'libc6-armel', 'pkgver': '2.19-0ubuntu6.15+esm4', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'libc6-dev', 'pkgver': '2.19-0ubuntu6.15+esm4', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'libc6-dev-amd64', 'pkgver': '2.19-0ubuntu6.15+esm4', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'libc6-dev-armel', 'pkgver': '2.19-0ubuntu6.15+esm4', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'libc6-dev-i386', 'pkgver': '2.19-0ubuntu6.15+esm4', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'libc6-dev-x32', 'pkgver': '2.19-0ubuntu6.15+esm4', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'libc6-i386', 'pkgver': '2.19-0ubuntu6.15+esm4', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'libc6-pic', 'pkgver': '2.19-0ubuntu6.15+esm4', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'libc6-prof', 'pkgver': '2.19-0ubuntu6.15+esm4', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'libc6-x32', 'pkgver': '2.19-0ubuntu6.15+esm4', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'multiarch-support', 'pkgver': '2.19-0ubuntu6.15+esm4', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'nscd', 'pkgver': '2.19-0ubuntu6.15+esm4', 'ubuntu_pro': TRUE}
];
