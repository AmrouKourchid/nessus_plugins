...
# extracted from Ubuntu Security Notice USN-6438-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6438-1");
  script_xref(name:"CEA-ID", value:"CEA-2024-0004");
  script_xref(name:"IAVB", value:"2023-B-0083-S");

  script_name(english:"Ubuntu 23.10 : .NET vulnerabilities (USN-6438-1)");
...
USN-6438-1 advisory.
    ...
    possibly use this issue to cause a denial of service. (CVE-2023-36799)

    It was discovered that the .NET Kestrel web server did not properly handle HTTP/2 requests. A remote
    attacker could possibly use this issue to cause a denial of service. (CVE-2023-44487)

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6438-1");
...
var pkgs = [
    {'osver': '23.10', 'pkgname': 'aspnetcore-runtime-6.0', 'pkgver': '6.0.123-0ubuntu1'},
    {'osver': '23.10', 'pkgname': 'aspnetcore-runtime-7.0', 'pkgver': '7.0.112-0ubuntu1'},
    {'osver': '23.10', 'pkgname': 'aspnetcore-targeting-pack-6.0', 'pkgver': '6.0.123-0ubuntu1'},
    {'osver': '23.10', 'pkgname': 'aspnetcore-targeting-pack-7.0', 'pkgver': '7.0.112-0ubuntu1'},
    {'osver': '23.10', 'pkgname': 'dotnet-apphost-pack-6.0', 'pkgver': '6.0.123-0ubuntu1'},
    {'osver': '23.10', 'pkgname': 'dotnet-apphost-pack-7.0', 'pkgver': '7.0.112-0ubuntu1'},
    {'osver': '23.10', 'pkgname': 'dotnet-host', 'pkgver': '6.0.123-0ubuntu1'},
    {'osver': '23.10', 'pkgname': 'dotnet-host-7.0', 'pkgver': '7.0.112-0ubuntu1'},
    {'osver': '23.10', 'pkgname': 'dotnet-hostfxr-6.0', 'pkgver': '6.0.123-0ubuntu1'},
    {'osver': '23.10', 'pkgname': 'dotnet-hostfxr-7.0', 'pkgver': '7.0.112-0ubuntu1'},
    {'osver': '23.10', 'pkgname': 'dotnet-runtime-6.0', 'pkgver': '6.0.123-0ubuntu1'},
    {'osver': '23.10', 'pkgname': 'dotnet-runtime-7.0', 'pkgver': '7.0.112-0ubuntu1'},
    {'osver': '23.10', 'pkgname': 'dotnet-sdk-6.0', 'pkgver': '6.0.123-0ubuntu1'},
    {'osver': '23.10', 'pkgname': 'dotnet-sdk-6.0-source-built-artifacts', 'pkgver': '6.0.123-0ubuntu1'},
    {'osver': '23.10', 'pkgname': 'dotnet-sdk-7.0', 'pkgver': '7.0.112-0ubuntu1'},
    {'osver': '23.10', 'pkgname': 'dotnet-sdk-7.0-source-built-artifacts', 'pkgver': '7.0.112-0ubuntu1'},
    {'osver': '23.10', 'pkgname': 'dotnet-targeting-pack-6.0', 'pkgver': '6.0.123-0ubuntu1'},
    {'osver': '23.10', 'pkgname': 'dotnet-targeting-pack-7.0', 'pkgver': '7.0.112-0ubuntu1'},
    {'osver': '23.10', 'pkgname': 'dotnet-templates-6.0', 'pkgver': '6.0.123-0ubuntu1'},
    {'osver': '23.10', 'pkgname': 'dotnet-templates-7.0', 'pkgver': '7.0.112-0ubuntu1'},
    {'osver': '23.10', 'pkgname': 'dotnet6', 'pkgver': '6.0.123-0ubuntu1'},
    {'osver': '23.10', 'pkgname': 'dotnet7', 'pkgver': '7.0.112-0ubuntu1'},
    {'osver': '23.10', 'pkgname': 'netstandard-targeting-pack-2.1', 'pkgver': '6.0.123-0ubuntu1'},
    {'osver': '23.10', 'pkgname': 'netstandard-targeting-pack-2.1-7.0', 'pkgver': '7.0.112-0ubuntu1'}
];
