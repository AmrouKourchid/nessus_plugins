...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: C PHSA-2023-3.0-0649");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'c-ares-1.19.1-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'c-ares-devel-1.19.1-1.ph3')) flag++;
