...
# extracted from Fedora Security Advisory FEDORA-2023-a48406ecd2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-a48406ecd2");

  script_name(english:"Fedora 38 : cairo / freetype / harfbuzz / qt6-qtwebengine (2023-a48406ecd2)");
...
FEDORA-2023-a48406ecd2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-a48406ecd2");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:cairo");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:freetype");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:harfbuzz");
...
var pkgs = [
    {'reference':'cairo-1.17.8-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'freetype-2.13.0-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'harfbuzz-7.0.1-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'qt6-qtwebengine-6.4.2-3.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'cairo / freetype / harfbuzz / qt6-qtwebengine');
}
