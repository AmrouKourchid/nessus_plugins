...
# SUSE update advisory SUSE-SU-2024:3082-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2024:3082-1");

  script_name(english:"SUSE SLES15 / openSUSE 15 Security Update : 389-ds (SUSE-SU-2024:3082-1)");
...
vulnerabilities as referenced in the SUSE-SU-2024:3082-1 advisory.
    ...
    '/var/cache/dnf/metadata_lock.pid'`
      * Issue 6172 - RFE: improve the performance of evaluation of filter component when tested against a
    large valueset (like group members) (#6173)
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-updates/2024-September/036720.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3c4737e9");
...
var pkgs = [
    {'reference':'389-ds-2.2.10~git2.345056d3-150500.3.21.1', 'sp':'5', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.5']},
    {'reference':'389-ds-devel-2.2.10~git2.345056d3-150500.3.21.1', 'sp':'5', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.5']},
    {'reference':'lib389-2.2.10~git2.345056d3-150500.3.21.1', 'sp':'5', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.5']},
    {'reference':'libsvrcore0-2.2.10~git2.345056d3-150500.3.21.1', 'sp':'5', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.5']},
    {'reference':'389-ds-2.2.10~git2.345056d3-150500.3.21.1', 'sp':'5', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.5', 'sle-module-server-applications-release-15.5', 'sles-release-15.5']},
    {'reference':'389-ds-devel-2.2.10~git2.345056d3-150500.3.21.1', 'sp':'5', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.5', 'sle-module-server-applications-release-15.5', 'sles-release-15.5']},
    {'reference':'lib389-2.2.10~git2.345056d3-150500.3.21.1', 'sp':'5', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.5', 'sle-module-server-applications-release-15.5', 'sles-release-15.5']},
    {'reference':'libsvrcore0-2.2.10~git2.345056d3-150500.3.21.1', 'sp':'5', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.5', 'sle-module-server-applications-release-15.5', 'sles-release-15.5']},
    {'reference':'389-ds-2.2.10~git2.345056d3-150500.3.21.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.5']},
    {'reference':'389-ds-devel-2.2.10~git2.345056d3-150500.3.21.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.5']},
    {'reference':'389-ds-snmp-2.2.10~git2.345056d3-150500.3.21.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.5']},
    {'reference':'lib389-2.2.10~git2.345056d3-150500.3.21.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.5']},
    {'reference':'libsvrcore0-2.2.10~git2.345056d3-150500.3.21.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.5']}
];
