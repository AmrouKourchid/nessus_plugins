...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : sudo (EulerOS-SA-2023-1770)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1770
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7f741890");
...
var pkgs = [
  "sudo-1.9.8p2-2.h10.eulerosv2r11"
];
