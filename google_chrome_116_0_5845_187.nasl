...
if (description)
{
  ...
  script_name(english:"Google Chrome < 116.0.5845.187 Vulnerability");

  script_set_attribute(attribute:"synopsis", value:
"A web browser installed on the remote Windows host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Google Chrome installed on the remote Windows host is prior to 116.0.5845.187. It is, therefore, affected
by a vulnerability as referenced in the 2023_09_stable-channel-update-for-desktop_11 advisory.

  - Heap buffer overflow in WebP. (CVE-2023-4863)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://chromereleases.googleblog.com/2023/09/stable-channel-update-for-desktop_11.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ba12cabd");
  script_set_attribute(attribute:"see_also", value:"https://crbug.com/1479274");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Google Chrome version 116.0.5845.187 or later.");
...
google_chrome_check_version(installs:installs, fix:'116.0.5845.187', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
