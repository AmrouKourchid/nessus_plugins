...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.0 : qemu-kvm (EulerOS-SA-2018-1247)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1247
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6b84d50f");
...
pkgs = ["qemu-kvm-2.6.0-B037",
        "qemu-kvm-common-2.6.0-B037",
        "qemu-kvm-tools-2.6.0-B037"];
