...
# extracted from VMware Security Advisory PHSA-2024-5.0-0231. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Bluez PHSA-2024-5.0-0231");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the bluez package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-5.0-231.md");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'bluez-5.66-6.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'bluez-devel-5.66-6.ph5')) flag++;
