...
# extracted from F5 Networks BIG-IP Solution K11742512.
#
# @NOAGENT@
##
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : BIND vulnerability (K11742512)");

  script_set_attribute(attribute:"synopsis", value:
"The remote device is missing a vendor-supplied security patch.");
  script_set_attribute(attribute:"description", value:
"The version of F5 Networks BIG-IP installed on the remote host is prior to tested version. It is, therefore, affected by
a vulnerability as referenced in the K11742512 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.f5.com/csp/article/K11742512");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K11742512.");
...
# Vendor has cleared out the advisory such
# that no vulnerable versions are listed.
# Exit here. Do not fully deprecate b/c
# vendor might reverse decision or
# possibly made the change in error.
