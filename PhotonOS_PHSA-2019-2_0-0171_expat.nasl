...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Expat PHSA-2019-2.0-0171");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'expat-2.2.4-2.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'expat-debuginfo-2.2.4-2.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'expat-devel-2.2.4-2.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'expat-libs-2.2.4-2.ph2')) flag++;
