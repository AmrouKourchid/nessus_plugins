...
# extracted from Debian Security Advisory DLA-1925-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1925-1 : python2.7 security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2019/09/msg00019.html");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"idle-python2.7", reference:"2.7.9-2+deb8u5")) flag++;
if (deb_check(release:"8.0", prefix:"libpython2.7", reference:"2.7.9-2+deb8u5")) flag++;
if (deb_check(release:"8.0", prefix:"libpython2.7-dbg", reference:"2.7.9-2+deb8u5")) flag++;
if (deb_check(release:"8.0", prefix:"libpython2.7-dev", reference:"2.7.9-2+deb8u5")) flag++;
if (deb_check(release:"8.0", prefix:"libpython2.7-minimal", reference:"2.7.9-2+deb8u5")) flag++;
if (deb_check(release:"8.0", prefix:"libpython2.7-stdlib", reference:"2.7.9-2+deb8u5")) flag++;
if (deb_check(release:"8.0", prefix:"libpython2.7-testsuite", reference:"2.7.9-2+deb8u5")) flag++;
if (deb_check(release:"8.0", prefix:"python2.7", reference:"2.7.9-2+deb8u5")) flag++;
if (deb_check(release:"8.0", prefix:"python2.7-dbg", reference:"2.7.9-2+deb8u5")) flag++;
if (deb_check(release:"8.0", prefix:"python2.7-dev", reference:"2.7.9-2+deb8u5")) flag++;
if (deb_check(release:"8.0", prefix:"python2.7-doc", reference:"2.7.9-2+deb8u5")) flag++;
if (deb_check(release:"8.0", prefix:"python2.7-examples", reference:"2.7.9-2+deb8u5")) flag++;
if (deb_check(release:"8.0", prefix:"python2.7-minimal", reference:"2.7.9-2+deb8u5")) flag++;
