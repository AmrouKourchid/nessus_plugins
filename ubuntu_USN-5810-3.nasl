...
# extracted from Ubuntu Security Notice USN-5810-3. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5810-3");

  script_name(english:"Ubuntu 16.04 ESM : Git vulnerabilities (USN-5810-3)");
...
the USN-5810-3 advisory.

    USN-5810-1 fixed several vulnerabilities in Git. This update provides the corresponding update for Ubuntu
    16.04 ESM.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5810-3");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'git', 'pkgver': '1:2.7.4-0ubuntu1.10+esm4', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'git-all', 'pkgver': '1:2.7.4-0ubuntu1.10+esm4', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'git-arch', 'pkgver': '1:2.7.4-0ubuntu1.10+esm4', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'git-core', 'pkgver': '1:2.7.4-0ubuntu1.10+esm4', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'git-cvs', 'pkgver': '1:2.7.4-0ubuntu1.10+esm4', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'git-daemon-run', 'pkgver': '1:2.7.4-0ubuntu1.10+esm4', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'git-daemon-sysvinit', 'pkgver': '1:2.7.4-0ubuntu1.10+esm4', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'git-el', 'pkgver': '1:2.7.4-0ubuntu1.10+esm4', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'git-email', 'pkgver': '1:2.7.4-0ubuntu1.10+esm4', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'git-gui', 'pkgver': '1:2.7.4-0ubuntu1.10+esm4', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'git-man', 'pkgver': '1:2.7.4-0ubuntu1.10+esm4', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'git-mediawiki', 'pkgver': '1:2.7.4-0ubuntu1.10+esm4', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'git-svn', 'pkgver': '1:2.7.4-0ubuntu1.10+esm4', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'gitk', 'pkgver': '1:2.7.4-0ubuntu1.10+esm4', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'gitweb', 'pkgver': '1:2.7.4-0ubuntu1.10+esm4', 'ubuntu_pro': TRUE}
];
