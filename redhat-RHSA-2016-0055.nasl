...
# extracted from Red Hat Security Advisory RHSA-2016:0055. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2016:0055");

  script_name(english:"RHEL 7 : java-1.8.0-oracle (RHSA-2016:0055)");
...
referenced in the RHSA-2016:0055 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2016/rhsa-2016_0055.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f737813d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2016:0055");
...
"Update the RHEL java-1.8.0-oracle package based on the guidance in RHSA-2016:0055.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'java-1.8.0-oracle-1.8.0.71-1jpp.1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.8.0-oracle-devel-1.8.0.71-1jpp.1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.8.0-oracle-javafx-1.8.0.71-1jpp.1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.8.0-oracle-jdbc-1.8.0.71-1jpp.1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.8.0-oracle-plugin-1.8.0.71-1jpp.1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.8.0-oracle-src-1.8.0.71-1jpp.1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
