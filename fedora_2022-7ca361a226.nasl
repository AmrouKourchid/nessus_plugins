...
# extracted from Fedora Security Advisory FEDORA-2022-7ca361a226
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-7ca361a226");

  script_name(english:"Fedora 37 : pypy3.9 (2022-7ca361a226)");
...
FEDORA-2022-7ca361a226 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-7ca361a226");
...
var pkgs = [
    {'reference':'pypy3.9-7.3.9-4.3.9.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
