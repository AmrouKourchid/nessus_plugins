...
# extracted from Debian Security Advisory dla-3033. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-3033-1 : smarty3 - LTS security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 9 host has a package installed that is affected by a vulnerability as referenced in the dla-3033
advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=1011758");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/smarty3");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2022/dla-3033");
...
var pkgs = [
    {'release': '9.0', 'prefix': 'smarty3', 'reference': '3.1.31+20161214.1.c7d42e4+selfpack1-2+deb9u6'}
];
