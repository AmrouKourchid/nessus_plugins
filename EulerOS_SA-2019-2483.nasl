...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : openssh (EulerOS-SA-2019-2483)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2483
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8fb4be5d");
...
pkgs = ["openssh-6.6.1p1-28.h18",
        "openssh-askpass-6.6.1p1-28.h18",
        "openssh-clients-6.6.1p1-28.h18",
        "openssh-keycat-6.6.1p1-28.h18",
        "openssh-server-6.6.1p1-28.h18"];
