...
# extracted from Fedora Security Advisory FEDORA-2024-e6b1e638d1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-e6b1e638d1");

  script_name(english:"Fedora 41 : mingw-python3 (2024-e6b1e638d1)");
...
FEDORA-2024-e6b1e638d1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-e6b1e638d1");
...
var pkgs = [
    {'reference':'mingw-python3-3.11.10-2.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
