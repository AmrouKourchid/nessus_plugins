...
# extracted from Oracle Linux Security Advisory ELSA-2023-12143.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : sudo (ELSA-2023-12143)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-12143.html");
...
var pkgs = [
    {'reference':'sudo-1.8.6p3-29.0.4.el6_10.3', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sudo-devel-1.8.6p3-29.0.4.el6_10.3', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sudo-1.8.6p3-29.0.4.el6_10.3', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sudo-devel-1.8.6p3-29.0.4.el6_10.3', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
];
