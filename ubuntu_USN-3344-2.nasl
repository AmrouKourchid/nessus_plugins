...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : Linux kernel (Xenial HWE) vulnerabilities (USN-3344-2)");
...
the USN-3344-2 advisory.

    USN-3344-1 fixed vulnerabilities in the Linux kernel for Ubuntu 16.04 LTS. This update provides the
    corresponding updates for the Linux Hardware Enablement (HWE) kernel from Ubuntu 16.04 LTS for Ubuntu
    14.04 LTS.

    USN 3334-1 fixed a vulnerability in the Linux kernel. However, that fix introduced regressions for some
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3344-2");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-3344-2');
}
