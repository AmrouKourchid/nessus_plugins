...
if (description)
{
  ...
  script_name(english:"Mozilla Firefox < 62.0.3 Multiple Vulnerabilities");
...
host is prior to 62.0.3. It is, therefore, affected by multiple
...
mozilla_check_version(installs:installs, product:'firefox', esr:FALSE, fix:'62.0.3', severity:SECURITY_WARNING);
