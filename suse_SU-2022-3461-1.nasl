...
# SUSE update advisory SUSE-SU-2022:3461-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:3461-1");

  script_name(english:"SUSE SLES12 Security Update : python3-lxml (SUSE-SU-2022:3461-1)");
...
in the SUSE-SU-2022:3461-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-September/012446.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f53c871a");
...
var pkgs = [
    {'reference':'python3-lxml-3.6.1-3.3.1', 'sp':'5', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5']},
    {'reference':'python3-lxml-3.6.1-3.3.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.5']}
];
