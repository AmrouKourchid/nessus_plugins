...
# extracted from Fedora Security Advisory FEDORA-2024-a26a9c2150
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-a26a9c2150");

  script_name(english:"Fedora 40 : thunderbird (2024-a26a9c2150)");
...
FEDORA-2024-a26a9c2150 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-a26a9c2150");
...
var pkgs = [
    {'reference':'thunderbird-115.13.0-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
