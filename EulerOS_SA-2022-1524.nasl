...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : bluez (EulerOS-SA-2022-1524)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1524
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a7de6831");
...
var pkgs = [
  "bluez-5.44-4.h6.eulerosv2r7",
  "bluez-libs-5.44-4.h6.eulerosv2r7",
  "bluez-libs-devel-5.44-4.h6.eulerosv2r7"
];
