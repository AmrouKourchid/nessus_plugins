...
# extracted from Fedora Security Advisory FEDORA-2025-164c668d6a
#
...
if (description)
{
  ...
  script_cve_id("CVE-2025-3839");
  script_xref(name:"FEDORA", value:"2025-164c668d6a");

  script_name(english:"Fedora 41 : epiphany (2025-164c668d6a)");
...
FEDORA-2025-164c668d6a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-164c668d6a");
...
"Update the affected 1:epiphany package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-3839");

  script_set_attribute(attribute:"exploitability_ease", value:"No known exploits are available");
  script_set_attribute(attribute:"exploit_available", value:"false");

  script_set_attribute(attribute:"vuln_publication_date", value:"2025/04/21");
...
var pkgs = [
    {'reference':'epiphany-47.7-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
