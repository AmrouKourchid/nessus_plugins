...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : xorg-x11-server (EulerOS-SA-2020-2570)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2570
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c4af0d44");
...
pkgs = ["xorg-x11-server-Xephyr-1.19.5-5.h11.eulerosv2r7",
        "xorg-x11-server-Xorg-1.19.5-5.h11.eulerosv2r7",
        "xorg-x11-server-Xvfb-1.19.5-5.h11.eulerosv2r7",
        "xorg-x11-server-common-1.19.5-5.h11.eulerosv2r7"];
