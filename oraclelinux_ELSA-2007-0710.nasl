...
# extracted from Oracle Linux Security Advisory ELSA-2007-0710.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : wireshark (ELSA-2007-0710)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2007-0710.html");
...
"Update the affected wireshark and / or wireshark-gnome packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2007-3391");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2007-3393");
...
var pkgs = [
    {'reference':'wireshark-0.99.6-1.el5.0.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'wireshark-gnome-0.99.6-1.el5.0.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'wireshark-0.99.6-1.el5.0.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'wireshark-gnome-0.99.6-1.el5.0.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
