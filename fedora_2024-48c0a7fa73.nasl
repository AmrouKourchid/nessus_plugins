...
# extracted from Fedora Security Advisory FEDORA-2024-48c0a7fa73
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-48c0a7fa73");

  script_name(english:"Fedora 41 : 389-ds-base (2024-48c0a7fa73)");
...
FEDORA-2024-48c0a7fa73 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-48c0a7fa73");
...
var pkgs = [
    {'reference':'389-ds-base-3.1.1-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
