...
if (description)
{
  ...
  script_cve_id("CVE-2023-44487", "CVE-2024-20965");
  script_xref(name:"IAVA", value:"2024-A-0034-S");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2023/10/31");
  script_xref(name:"CEA-ID", value:"CEA-2024-0004");

  script_name(english:"Oracle MySQL Cluster 8.0.x < 8.0.36 (January 2024 CPU)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host is affected by multiple vulnerabilities");
  script_set_attribute(attribute:"description", value:
"The versions of MySQL Cluster installed on the remote host are affected by multiple vulnerabilities as 
referenced in the January and April 2024 CPU advisory.
...
mysql_check_version(variant:'Cluster', fixed:'8.0.36', min:'8.0', severity:SECURITY_HOLE);
