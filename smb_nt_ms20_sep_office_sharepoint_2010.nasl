...
if (description)
{
  ...
  script_xref(name:"MSFT", value:"MS20-3101523");
  script_xref(name:"MSFT", value:"MS20-4484528");
  script_xref(name:"MSFT", value:"MS20-4486664");
  script_xref(name:"MSFT", value:"MS20-4486667");
  script_xref(name:"MSKB", value:"3101523");
  script_xref(name:"MSKB", value:"4484528");
  script_xref(name:"MSKB", value:"4486664");
  script_xref(name:"MSKB", value:"4486667");
  script_xref(name:"IAVA", value:"2020-A-0412-S");
  script_xref(name:"CEA-ID", value:"CEA-2020-0118");

  script_name(english:"Security Updates for Microsoft SharePoint Server (September 2020)");
...
by multiple vulnerabilities :
  ...
  # https://support.microsoft.com/en-us/help/4484528/security-update-for-sharepoint-server-2010-sept-8-2020
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?307527fa");
  # https://support.microsoft.com/en-us/help/4486667/security-update-for-sharepoint-foundation-2010-sept-8-2020
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5500672f");
  # https://support.microsoft.com/en-us/help/4486664/security-update-for-sharepoint-server-2010-sep-8-2020
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?60f81a31");
  # https://support.microsoft.com/en-us/help/3101523/security-update-for-sharepoint-server-2010-september-8-2020
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5387acf4");
...
"Microsoft has released security updates for Microsoft SharePoint Server.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2020-1576");
