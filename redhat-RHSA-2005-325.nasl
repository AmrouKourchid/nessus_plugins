...
referenced in the RHSA-2005:325 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.kde.org/info/security/advisory-20050316-2.txt");
  script_set_attribute(attribute:"see_also", value:"http://www.kde.org/info/security/advisory-20050316-3.txt");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2005/rhsa-2005_325.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?93ada675");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=147405");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=148822");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=150090");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2005:325");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL kdelibs package based on the guidance in RHSA-2005:325.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:P/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:L/UI:N/S:U/C:N/I:H/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2005-0237");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2005-0365");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'kdelibs-3.3.1-3.6', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'6'},
      {'reference':'kdelibs-3.3.1-3.6', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'6'},
      {'reference':'kdelibs-3.3.1-3.6', 'cpu':'ppc64', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'6'},
      {'reference':'kdelibs-3.3.1-3.6', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'6'},
      {'reference':'kdelibs-3.3.1-3.6', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'6'},
      {'reference':'kdelibs-3.3.1-3.6', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'6'},
      {'reference':'kdelibs-devel-3.3.1-3.6', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'6'},
      {'reference':'kdelibs-devel-3.3.1-3.6', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'6'},
      {'reference':'kdelibs-devel-3.3.1-3.6', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'6'},
      {'reference':'kdelibs-devel-3.3.1-3.6', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'6'},
      {'reference':'kdelibs-devel-3.3.1-3.6', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'6'}
    ]
  }
];
