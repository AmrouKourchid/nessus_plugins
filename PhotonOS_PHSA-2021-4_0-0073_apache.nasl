...
# extracted from VMware Security Advisory PHSA-2021-4.0-0073. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Apache PHSA-2021-4.0-0073");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the apache package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-73.md");
...
if (rpm_check(release:'PhotonOS-4.0', reference:'apache-ant-1.10.10-2.ph4')) flag++;
