...
# extracted from Ubuntu Security Notice USN-6744-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6744-2");

  script_name(english:"Ubuntu 20.04 LTS : Pillow vulnerability (USN-6744-2)");
...
USN-6744-2 advisory.
    ...
    USN-6744-1 fixed a vulnerability in Pillow (Python 3). This update provides the corresponding updates for
    Pillow (Python 2) in
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6744-2");
  script_set_attribute(attribute:"solution", value:
"Update the affected python-pil and / or python-pil.imagetk packages.");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'python-pil', 'pkgver': '6.2.1-3ubuntu0.1~esm2', 'ubuntu_pro': TRUE},
    {'osver': '20.04', 'pkgname': 'python-pil.imagetk', 'pkgver': '6.2.1-3ubuntu0.1~esm2', 'ubuntu_pro': TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python-pil / python-pil.imagetk');
}
