...
ConfigSync high availability (HA) device group.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K32121038");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K32121038.");
...
var vmatrix = {
  'AFM': {
    ...
    'unaffected': [
      '15.1.0','14.1.2.5','13.1.3.4','12.1.5.1','11.6.5.2'
    ],
  },
  'AM': {
    'affected': [
