...
# extracted from Red Hat Security Advisory RHSA-2008:0197. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 5 : gnome-screensaver (RHSA-2008:0197)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for gnome-screensaver.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2008/rhsa-2008_0197.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?39a844db");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=435773");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2008:0197");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL gnome-screensaver package based on the guidance in RHSA-2008:0197.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:M/Au:N/C:N/I:N/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2008-0887");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gnome-screensaver-2.16.1-5.el5_1.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gnome-screensaver-2.16.1-5.el5_1.1', 'cpu':'ppc', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gnome-screensaver-2.16.1-5.el5_1.1', 'cpu':'s390x', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gnome-screensaver-2.16.1-5.el5_1.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
