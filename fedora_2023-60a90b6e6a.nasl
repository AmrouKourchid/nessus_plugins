...
# extracted from Fedora Security Advisory FEDORA-2023-60a90b6e6a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-60a90b6e6a");

  script_name(english:"Fedora 37 : moodle (2023-60a90b6e6a)");
...
FEDORA-2023-60a90b6e6a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-60a90b6e6a");
...
var pkgs = [
    {'reference':'moodle-4.1.3-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
