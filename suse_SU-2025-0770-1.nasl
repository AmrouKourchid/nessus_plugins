...
# SUSE update advisory SUSE-SU-2025:0770-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2024-45337", "CVE-2025-22868", "CVE-2025-22869");
  script_xref(name:"SuSE", value:"SUSE-SU-2025:0770-1");

  script_name(english:"SUSE SLES15 / openSUSE 15 Security Update : govulncheck-vulndb (SUSE-SU-2025:0770-1)");
...
referenced in the SUSE-SU-2025:0770-1 advisory.
...
number.");
  # https://lists.suse.com/pipermail/sle-security-updates/2025-March/020477.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7f8ad59f");
...
var pkgs = [
    {'reference':'govulncheck-vulndb-0.0.20250226T025151-150000.1.35.1', 'release':'SUSE15.6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.6']},
    {'reference':'govulncheck-vulndb-0.0.20250226T025151-150000.1.35.1', 'sp':'6', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-packagehub-subpackages-release-15.6']}
];
