...
if (description)
{
  ...
  script_cve_id("CVE-2016-1000031", "CVE-2019-10072");
  script_xref(name:"CEA-ID", value:"CEA-2021-0004");

  script_name(english:"Oracle Siebel Server <= 20.7 (October 2020 CPU)");
...
the October 2020 CPU advisory.
  ...
  - Vulnerability in the Siebel Apps - Marketing product of Oracle Siebel CRM (component: Mktg/Email Mktg
    Stand-Alone (Apache Commons File Upload)). The supported version that is affected is 20.7. Easily
    exploitable vulnerability allows unauthenticated attacker with network access via HTTP to compromise
    Siebel Apps - Marketing. Successful attacks of this vulnerability can result in takeover of Siebel Apps -
    Marketing. (CVE-2016-1000031)

  - Vulnerability in the Siebel Apps - Marketing product of Oracle Siebel CRM (component: Mktg/Campaign Mgmt
    (Apache Tomcat)). The supported version that is affected is 20.7. Easily exploitable vulnerability allows
    ...
    crash (complete DOS) of Siebel Apps - Marketing. (CVE-2019-10072)
...
var constraints = [
  { 'max_version' : '20.7.999', 'fixed_version' : '20.9' }
];
