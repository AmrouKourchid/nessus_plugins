...
# extracted from Fedora Security Advisory FEDORA-2024-aa3631a416
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-aa3631a416");

  script_name(english:"Fedora 40 : tinyproxy (2024-aa3631a416)");
...
FEDORA-2024-aa3631a416 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-aa3631a416");
...
var pkgs = [
    {'reference':'tinyproxy-1.11.2-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
