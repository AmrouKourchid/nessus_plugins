...
# extracted from Red Hat Security Advisory patch. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2010-4651", "CVE-2018-6952");

  script_name(english:"RHEL 6 : patch (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2018-6952");
