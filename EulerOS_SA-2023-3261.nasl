...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : zlib (EulerOS-SA-2023-3261)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3261
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4c6d235e");
...
var pkgs = [
  "zlib-1.2.11-19.h8.eulerosv2r11"
];
