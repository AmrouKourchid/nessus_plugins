...
# CentOS Errata and Security Advisory 2018:0816 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : qemu-kvm (CESA-2018:0816)");
...
CVE-2017-13672; Wjjzhang (Tencent.com) for reporting CVE-2017-13711;
and Jiang Xin and Lin ZheCheng for reporting CVE-2018-5683. The
...
Enterprise Linux 7.5 Release Notes linked from the References section.");
  # https://lists.centos.org/pipermail/centos-cr-announce/2018-April/005093.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0caf9de9");
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"qemu-img-1.5.3-156.el7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"qemu-kvm-1.5.3-156.el7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"qemu-kvm-common-1.5.3-156.el7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"qemu-kvm-tools-1.5.3-156.el7")) flag++;
