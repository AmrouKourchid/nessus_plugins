...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.2 : curl (EulerOS-SA-2021-2132)");
...
following vulnerabilities :
  ...
  - This candidate has been reserved by an organization or
    ...
    provided.(CVE-2020-8177)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2132
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6179e383");
...
pkgs = ["curl-7.29.0-46.h16",
        "libcurl-7.29.0-46.h16"];
