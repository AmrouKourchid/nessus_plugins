...
USN-5618-1 advisory.
    ...
    It was discovered the Ghostscript incorrectly handled memory when processing certain inputs. By tricking a
    user into opening a specially crafted PDF file, an attacker could cause the program to crash.
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'ghostscript', 'pkgver': '9.26~dfsg+0-0ubuntu0.16.04.14+esm4', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'ghostscript-x', 'pkgver': '9.26~dfsg+0-0ubuntu0.16.04.14+esm4', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libgs-dev', 'pkgver': '9.26~dfsg+0-0ubuntu0.16.04.14+esm4', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libgs9', 'pkgver': '9.26~dfsg+0-0ubuntu0.16.04.14+esm4', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libgs9-common', 'pkgver': '9.26~dfsg+0-0ubuntu0.16.04.14+esm4', 'ubuntu_pro': TRUE}
];
