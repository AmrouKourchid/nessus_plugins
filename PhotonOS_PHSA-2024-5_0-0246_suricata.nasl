...
if (description)
{
  ...
  script_xref(name:"IAVB", value:"2024-B-0034-S");

  script_name(english:"Photon OS 5.0: Suricata PHSA-2024-5.0-0246");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'suricata-7.0.4-1.ph5')) flag++;
