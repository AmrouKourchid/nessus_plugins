...
if (description)
{
  ...
  script_cve_id("CVE-2017-8386", "CVE-2017-14867", "CVE-2017-15298");

  script_name(english:"RHEL 6 : git (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  # https://security.access.redhat.com/data/csaf/v2/vex/2018/cve-2018-1000021.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?60398794");
