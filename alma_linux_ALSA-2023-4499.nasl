...
# AlmaLinux Security Advisory ALSA-2023:4499.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:4499");
  script_xref(name:"IAVA", value:"2023-A-0379-S");

  script_name(english:"AlmaLinux 9 : thunderbird (ALSA-2023:4499)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2023-4499.html");
...
var pkgs = [
    {'reference':'thunderbird-102.14.0-1.el9_2.alma', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'thunderbird-102.14.0-1.el9_2.alma', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
