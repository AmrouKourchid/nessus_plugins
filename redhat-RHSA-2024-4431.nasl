...
# extracted from Red Hat Security Advisory RHSA-2024:4431. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:4431");

  script_name(english:"RHEL 9 : libreswan (RHSA-2024:4431)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_4431.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?de93566a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:4431");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libreswan package based on the guidance in RHSA-2024:4431.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libreswan-4.9-5.el9_2.2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
