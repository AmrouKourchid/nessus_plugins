...
# extracted from Fedora Security Advisory FEDORA-2023-b659c62db9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-b659c62db9");

  script_name(english:"Fedora 39 : drupal7 (2023-b659c62db9)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-b659c62db9");
...
var pkgs = [
    {'reference':'drupal7-7.98-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
