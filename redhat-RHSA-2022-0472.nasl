...
# extracted from Red Hat Security Advisory RHSA-2022:0472. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:0472");

  script_name(english:"RHEL 6 : aide (RHSA-2022:0472)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_0472.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c6b707b0");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:0472");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2041489");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL aide package based on the guidance in RHSA-2022:0472.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'aide-0.14-11.el6_10.1', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'aide-0.14-11.el6_10.1', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'aide-0.14-11.el6_10.1', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
