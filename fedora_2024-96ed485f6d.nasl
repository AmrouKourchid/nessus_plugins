...
# extracted from Fedora Security Advisory FEDORA-2024-96ed485f6d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-96ed485f6d");

  script_name(english:"Fedora 41 : python3.6 (2024-96ed485f6d)");
...
FEDORA-2024-96ed485f6d advisory.
    ...
    ```
    * Fri Aug 16 2024 Tom Hrniar <thrnciar@redhat.com> - 3.6.15-35
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-96ed485f6d");
  script_set_attribute(attribute:"solution", value:
"Update the affected python3.6 package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:python3.6");
...
var pkgs = [
    {'reference':'python3.6-3.6.15-35.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python3.6');
}
