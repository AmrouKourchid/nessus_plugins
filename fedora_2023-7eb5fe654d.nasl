...
# extracted from Fedora Security Advisory FEDORA-2023-7eb5fe654d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-7eb5fe654d");

  script_name(english:"Fedora 38 : golang (2023-7eb5fe654d)");
...
FEDORA-2023-7eb5fe654d advisory.

    go1.20.4 (released 2023-05-02) includes three security fixes to the html/template package, as well as bug
    fixes to the compiler, the runtime, and the crypto/subtle, crypto/tls, net/http, and syscall packages.
    [See the milestone on the issue tracker for
    details](https://github.com/golang/go/issues?q=milestone%3AGo1.20.4+label%3ACherryPickApproved).
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-7eb5fe654d");
...
var pkgs = [
    {'reference':'golang-1.20.4-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
