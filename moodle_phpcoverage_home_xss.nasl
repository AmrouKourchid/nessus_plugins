...
of the affected site.");
  # https://packetstormsecurity.com/files/98053/Moodle-2.0.1-Cross-Site-Scripting.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6d7a5df4");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Moodle 2.0.2 or later.");
