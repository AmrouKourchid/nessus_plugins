...
# extracted from openSUSE Security Update openSUSE-2015-545.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : flash-player (openSUSE-2015-545)");
  script_summary(english:"Check for the openSUSE-2015-545 patch");
...
"Security update to 11.2.202.508 (bsc#941239) :
  ...
  - APSB15-19: CVE-2015-3107, CVE-2015-5124, CVE-2015-5125,
    CVE-2015-5127, CVE-2015-5129, CVE-2015-5130,
    CVE-2015-5131, CVE-2015-5132, CVE-2015-5133,
    CVE-2015-5134, CVE-2015-5539, CVE-2015-5540,
    CVE-2015-5541, CVE-2015-5544, CVE-2015-5545,
    CVE-2015-5546, CVE-2015-5547, CVE-2015-5548,
    CVE-2015-5549, CVE-2015-5550, CVE-2015-5551,
    CVE-2015-5552, CVE-2015-5553, CVE-2015-5554,
    CVE-2015-5555, CVE-2015-5556, CVE-2015-5557,
...
if ( rpm_check(release:"SUSE13.1", reference:"flash-player-11.2.202.508-132.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"flash-player-gnome-11.2.202.508-132.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"flash-player-kde4-11.2.202.508-132.1") ) flag++;
