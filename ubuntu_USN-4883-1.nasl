...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.4.0-1148-raspi2");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.4.0-206-powerpc-e500mc");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.4.0-206-powerpc-smp");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.4.0-206-powerpc64-emb");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.4.0-206-powerpc64-smp");
...
var kernel_mappings = {
  '16.04': {
    '4.15.0': {
      'generic': '4.15.0-139',
      'generic-lpae': '4.15.0-139',
      'lowlatency': '4.15.0-139',
      'oracle': '4.15.0-1067',
      'gcp': '4.15.0-1095',
      'aws': '4.15.0-1096',
      'azure': '4.15.0-1110'
    ...
    '4.4.0': {
      'generic': '4.4.0-206',
      'generic-lpae': '4.4.0-206',
      'lowlatency': '4.4.0-206',
      'powerpc-e500mc': '4.4.0-206',
      'powerpc-smp': '4.4.0-206',
      'powerpc64-emb': '4.4.0-206',
      'powerpc64-smp': '4.4.0-206',
      'kvm': '4.4.0-1090',
      'aws': '4.4.0-1124',
      'raspi2': '4.4.0-1148',
      'snapdragon': '4.4.0-1152'
    }
  },
  '18.04': {
    '4.15.0': {
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-4883-1');
}
