...
# extracted from Debian Security Advisory dsa-5896. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5896 : trafficserver - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-38311");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-38479");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-50305");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-50306");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-56195");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-56202");
...
"Upgrade the trafficserver packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-50305");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2024-50306");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'trafficserver', 'reference': '9.2.5+ds-0+deb12u2'},
    {'release': '12.0', 'prefix': 'trafficserver-dev', 'reference': '9.2.5+ds-0+deb12u2'},
    {'release': '12.0', 'prefix': 'trafficserver-experimental-plugins', 'reference': '9.2.5+ds-0+deb12u2'}
];
