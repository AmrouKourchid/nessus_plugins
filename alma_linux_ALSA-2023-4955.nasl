...
# AlmaLinux Security Advisory ALSA-2023:4955.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:4955");
  script_xref(name:"IAVA", value:"2023-A-0449-S");

  script_name(english:"AlmaLinux 9 : thunderbird (ALSA-2023:4955)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2023-4955.html");
...
var pkgs = [
    {'reference':'thunderbird-102.15.0-1.el9_2.alma.plus', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'thunderbird-102.15.0-1.el9_2.alma.plus', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
