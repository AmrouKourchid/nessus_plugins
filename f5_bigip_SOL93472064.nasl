...
on the affected system.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K93472064");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K93472064.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:N/I:N/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:L/UI:N/S:C/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-12190");
...
var vmatrix = {
  'AFM': {
    'affected': [
      '14.0.0-14.1.2','13.0.0-13.1.3','12.1.0-12.1.5','11.2.1-11.6.5'
    ],
    'unaffected': [
      '15.0.0','14.1.2.2','13.1.3.3','12.1.5.3'
    ],
  },
  'AM': {
    'affected': [
