...
# extracted from Fedora Security Advisory FEDORA-2022-e699dd5247
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-e699dd5247");
  script_xref(name:"IAVA", value:"2023-A-0061-S");

  script_name(english:"Fedora 36 : python3-docs / python3.10 (2022-e699dd5247)");
...
FEDORA-2022-e699dd5247 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-e699dd5247");
...
var pkgs = [
    {'reference':'python3-docs-3.10.9-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3.10-3.10.9-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
