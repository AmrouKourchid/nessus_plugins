...
if (description)
{
  ...
  script_name(english:"CentOS 9 : linuxptp-3.1.1-2.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing one or more security updates for linuxptp.");
...
linuxptp-3.1.1-2.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=11886");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream linuxptp package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:linuxptp");
...
var pkgs = [
    {'reference':'linuxptp-3.1.1-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
