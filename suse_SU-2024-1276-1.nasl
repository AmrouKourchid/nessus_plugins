...
# SUSE update advisory SUSE-SU-2024:1276-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2023-1829", "CVE-2023-6531");
  script_xref(name:"SuSE", value:"SUSE-SU-2024:1276-1");

  script_name(english:"SUSE SLES15 Security Update : kernel (Live Patch 42 for SLE 15 SP3) (SUSE-SU-2024:1276-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote SUSE Linux SLES15 host has packages installed that are affected by multiple vulnerabilities as referenced in
the SUSE-SU-2024:1276-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://lists.suse.com/pipermail/sle-updates/2024-April/034967.html");
...
"Update the affected kernel-livepatch-5_3_18-150200_24_183-default and / or kernel-livepatch-5_3_18-150300_59_153-default
packages.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '5.3.18-150200.24.183-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_3_18-150200_24_183-default-2-150200.5.6.1', 'sp':'2', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.2']}
        ]
      },
      '5.3.18-150300.59.153-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_3_18-150300_59_153-default-2-150300.7.6.1', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.3']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kernel-livepatch-5_3_18-150200_24_183-default / etc');
}
