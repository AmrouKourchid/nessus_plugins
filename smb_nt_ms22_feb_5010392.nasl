...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5010392");
  script_xref(name:"MSKB", value:"5010412");
  script_xref(name:"MSFT", value:"MS22-5010392");
  script_xref(name:"MSFT", value:"MS22-5010412");
  script_xref(name:"IAVA", value:"2022-A-0068-S");
  script_xref(name:"IAVA", value:"2022-A-0074-S");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2022/04/15");

  script_name(english:"KB5010392: Windows Server 2012 Security Update (February 2022)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5010412. It is, therefore, affected by multiple vulnerabilities
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5010412");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5010392");
  script_set_attribute(attribute:"solution", value:
"Apply Cumulative Update 5010412 or Security Update 5010392");
...
if (
  smb_check_rollup(os:'6.2',
                   ...
                   rollup_date:'02_2022',
                   bulletin:bulletin,
                   rollup_kb_list:[5010412, 5010392])
)
{
