...
if (description)
{
  ...
  script_cve_id("CVE-2024-35790");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-35790");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: usb: typec: altmodes/displayport:
    ...
    macro is not used here otherwise the path to the sysfs nodes is no longer compliant with the ABI.
    (CVE-2024-35790)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-35790");
