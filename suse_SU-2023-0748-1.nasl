...
affected by multiple vulnerabilities as referenced in the SUSE-SU-2023:0748-1 advisory.
...
var pkgs = [
    {'reference':'libpython3_10-1_0-3.10.10-150400.4.22.1', 'sp':'4', 'release':'SLED_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.4']},
    {'reference':'libpython3_10-1_0-3.10.10-150400.4.22.1', 'sp':'4', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.4']},
    {'reference':'python310-3.10.10-150400.4.22.1', 'sp':'4', 'release':'SLED_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.4']},
    {'reference':'python310-3.10.10-150400.4.22.1', 'sp':'4', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.4']},
    {'reference':'python310-base-3.10.10-150400.4.22.1', 'sp':'4', 'release':'SLED_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.4']},
    {'reference':'python310-base-3.10.10-150400.4.22.1', 'sp':'4', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.4']},
    {'reference':'python310-curses-3.10.10-150400.4.22.1', 'sp':'4', 'release':'SLED_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.4']},
    {'reference':'python310-curses-3.10.10-150400.4.22.1', 'sp':'4', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.4']},
    {'reference':'python310-dbm-3.10.10-150400.4.22.1', 'sp':'4', 'release':'SLED_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.4']},
    {'reference':'python310-dbm-3.10.10-150400.4.22.1', 'sp':'4', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.4']},
    {'reference':'python310-devel-3.10.10-150400.4.22.1', 'sp':'4', 'release':'SLED_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.4']},
    {'reference':'python310-devel-3.10.10-150400.4.22.1', 'sp':'4', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.4']},
    {'reference':'python310-idle-3.10.10-150400.4.22.1', 'sp':'4', 'release':'SLED_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.4']},
    {'reference':'python310-idle-3.10.10-150400.4.22.1', 'sp':'4', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.4']},
    {'reference':'python310-tk-3.10.10-150400.4.22.1', 'sp':'4', 'release':'SLED_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.4']},
    {'reference':'python310-tk-3.10.10-150400.4.22.1', 'sp':'4', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.4']},
    {'reference':'python310-tools-3.10.10-150400.4.22.1', 'sp':'4', 'release':'SLED_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.4']},
    {'reference':'python310-tools-3.10.10-150400.4.22.1', 'sp':'4', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.4']},
    {'reference':'libpython3_10-1_0-3.10.10-150400.4.22.1', 'sp':'4', 'release':'SLED15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.4', 'sle-module-python3-release-15.4', 'sled-release-15.4', 'sles-release-15.4']},
    {'reference':'libpython3_10-1_0-3.10.10-150400.4.22.1', 'sp':'4', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.4', 'sle-module-python3-release-15.4', 'sled-release-15.4', 'sles-release-15.4']},
    {'reference':'python310-3.10.10-150400.4.22.1', 'sp':'4', 'release':'SLED15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.4', 'sle-module-python3-release-15.4', 'sled-release-15.4', 'sles-release-15.4']},
    {'reference':'python310-3.10.10-150400.4.22.1', 'sp':'4', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.4', 'sle-module-python3-release-15.4', 'sled-release-15.4', 'sles-release-15.4']},
    {'reference':'python310-base-3.10.10-150400.4.22.1', 'sp':'4', 'release':'SLED15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.4', 'sle-module-python3-release-15.4', 'sled-release-15.4', 'sles-release-15.4']},
    {'reference':'python310-base-3.10.10-150400.4.22.1', 'sp':'4', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.4', 'sle-module-python3-release-15.4', 'sled-release-15.4', 'sles-release-15.4']},
    {'reference':'python310-curses-3.10.10-150400.4.22.1', 'sp':'4', 'release':'SLED15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.4', 'sle-module-python3-release-15.4', 'sled-release-15.4', 'sles-release-15.4']},
    {'reference':'python310-curses-3.10.10-150400.4.22.1', 'sp':'4', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.4', 'sle-module-python3-release-15.4', 'sled-release-15.4', 'sles-release-15.4']},
    {'reference':'python310-dbm-3.10.10-150400.4.22.1', 'sp':'4', 'release':'SLED15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.4', 'sle-module-python3-release-15.4', 'sled-release-15.4', 'sles-release-15.4']},
    {'reference':'python310-dbm-3.10.10-150400.4.22.1', 'sp':'4', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.4', 'sle-module-python3-release-15.4', 'sled-release-15.4', 'sles-release-15.4']},
    {'reference':'python310-devel-3.10.10-150400.4.22.1', 'sp':'4', 'release':'SLED15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.4', 'sle-module-python3-release-15.4', 'sled-release-15.4', 'sles-release-15.4']},
    {'reference':'python310-devel-3.10.10-150400.4.22.1', 'sp':'4', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.4', 'sle-module-python3-release-15.4', 'sled-release-15.4', 'sles-release-15.4']},
    {'reference':'python310-idle-3.10.10-150400.4.22.1', 'sp':'4', 'release':'SLED15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.4', 'sle-module-python3-release-15.4', 'sled-release-15.4', 'sles-release-15.4']},
    {'reference':'python310-idle-3.10.10-150400.4.22.1', 'sp':'4', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.4', 'sle-module-python3-release-15.4', 'sled-release-15.4', 'sles-release-15.4']},
    {'reference':'python310-tk-3.10.10-150400.4.22.1', 'sp':'4', 'release':'SLED15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.4', 'sle-module-python3-release-15.4', 'sled-release-15.4', 'sles-release-15.4']},
    {'reference':'python310-tk-3.10.10-150400.4.22.1', 'sp':'4', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.4', 'sle-module-python3-release-15.4', 'sled-release-15.4', 'sles-release-15.4']},
    {'reference':'python310-tools-3.10.10-150400.4.22.1', 'sp':'4', 'release':'SLED15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.4', 'sle-module-python3-release-15.4', 'sled-release-15.4', 'sles-release-15.4']},
    {'reference':'python310-tools-3.10.10-150400.4.22.1', 'sp':'4', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.4', 'sle-module-python3-release-15.4', 'sled-release-15.4', 'sles-release-15.4']},
