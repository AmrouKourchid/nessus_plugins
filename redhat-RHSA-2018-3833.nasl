...
# extracted from Red Hat Security Advisory RHSA-2018:3833. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : firefox (RHSA-2018:3833)");
...
referenced in the RHSA-2018:3833 advisory.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_3833.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1bcae388");
  script_set_attribute(attribute:"see_also", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2018-30/");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:3833");
...
"Update the RHEL firefox package based on the guidance in RHSA-2018:3833.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-60.4.0-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
