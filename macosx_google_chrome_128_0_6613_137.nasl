...
"The version of Google Chrome installed on the remote macOS host is prior to 128.0.6613.137. It is, therefore, affected
...
google_chrome_check_version(fix:'128.0.6613.137', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
