...
if (description)
{
  ...
  script_name(english:"Foxit PDF Editor < 13.1 Multiple Vulnerabilities");
...
Windows host is prior to 13.1. It is, therefore affected by multiple vulnerabilities:
...
"Upgrade to Foxit PDF Editor version 13.1 or later");
...
var constraints = [
  { 'max_version' : '11.2.8.53842', 'fixed_version' : '13.1' },
  { 'min_version' : '12.0', 'max_version' : '12.1.4.15400', 'fixed_version' : '13.1' },
  { 'min_version' : '13.0', 'max_version' : '13.0.1.21693', 'fixed_version' : '13.1' }
];
