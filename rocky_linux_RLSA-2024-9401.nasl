...
# Rocky Linux Security Advisory RLSA-2024:9401.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2024:9401");

  script_name(english:"RockyLinux 9 : microcode_ctl (RLSA-2024:9401)");

  script_set_attribute(attribute:"synopsis", value:
"The remote RockyLinux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote RockyLinux 9 host has a package installed that is affected by multiple vulnerabilities as referenced in the
RLSA-2024:9401 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2024:9401");
...
var pkgs = [
    {'reference':'microcode_ctl-20240910-1.el9_5', 'release':'9', 'el_string':'el9_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'}
];
