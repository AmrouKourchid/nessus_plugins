...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.0 : openssl (EulerOS-SA-2024-1989)");
...
is affected by the following vulnerabilities :
    ...
    is related to writing data we do not consider it security significant.(CVE-2024-0727)
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1989
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?eee95cfa");
