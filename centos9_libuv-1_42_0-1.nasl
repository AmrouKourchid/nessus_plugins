...
if (description)
{
  ...
  script_name(english:"CentOS 9 : libuv-1.42.0-1.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update for libuv.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 9 host has packages installed that are affected by a vulnerability as referenced in the
libuv-1.42.0-1.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=14321");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream libuv package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:libuv-static");
...
var pkgs = [
    {'reference':'libuv-1.42.0-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'libuv-devel-1.42.0-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'libuv-static-1.42.0-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libuv / libuv-devel / libuv-static');
}
