...
# extracted from Fedora Security Advisory FEDORA-2023-b5549f4bc8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-b5549f4bc8");

  script_name(english:"Fedora 39 : golang (2023-b5549f4bc8)");
...
FEDORA-2023-b5549f4bc8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-b5549f4bc8");
...
var pkgs = [
    {'reference':'golang-1.21.4-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
