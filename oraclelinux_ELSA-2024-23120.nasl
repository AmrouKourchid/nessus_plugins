...
# extracted from Oracle Linux Security Advisory ELSA-2024-23120.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : edk2 (ELSA-2024-23120)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-23120.html");
...
var pkgs = [
    {'reference':'edk2-tools-20240227-5.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'30'},
    {'reference':'edk2-tools-20240227-5.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'30'}
];
