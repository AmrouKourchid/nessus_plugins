...
# extracted from Red Hat Security Advisory io.vertx_vertx-core. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2024-1300");

  script_name(english:"RHEL 6 : io.vertx_vertx-core (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-1300");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:vertx-core");
