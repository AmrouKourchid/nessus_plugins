...
# extracted from Fedora Security Advisory FEDORA-2022-a04a020e48
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-a04a020e48");
  script_xref(name:"IAVA", value:"2023-A-0061-S");

  script_name(english:"Fedora 35 : python3.11 (2022-a04a020e48)");
...
FEDORA-2022-a04a020e48 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-a04a020e48");
...
var pkgs = [
    {'reference':'python3.11-3.11.0-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
