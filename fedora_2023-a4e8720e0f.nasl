...
# extracted from Fedora Security Advisory FEDORA-2023-a4e8720e0f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-a4e8720e0f");
  script_xref(name:"IAVA", value:"2023-A-0388-S");

  script_name(english:"Fedora 37 : firefox (2023-a4e8720e0f)");
...
FEDORA-2023-a4e8720e0f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-a4e8720e0f");
...
var pkgs = [
    {'reference':'firefox-116.0-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
