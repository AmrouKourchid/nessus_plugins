...
# extracted from Red Hat Security Advisory RHSA-2014:0382. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2014:0382");

  script_name(english:"RHEL 6 : python-keystoneclient (RHSA-2014:0382)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for python-keystoneclient.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 6 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2014:0382 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1082165");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2014/rhsa-2014_0382.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a2502a9c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2014:0382");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-keystoneclient package based on the guidance in RHSA-2014:0382.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:S/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:H/PR:L/UI:N/S:C/C:L/I:L/A:L");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss4_vector", value:"CVSS:4.0/AV:N/AC:L/AT:P/PR:L/UI:N/VC:N/VI:N/VA:N/SC:L/SI:L/SA:L");
  script_set_attribute(attribute:"cvss4_threat_vector", value:"CVSS:4.0/E:U");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-0105");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python-keystoneclient-0.7.1-2.el6ost', 'release':'6', 'el_string':'el6ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'},
      {'reference':'python-keystoneclient-doc-0.7.1-2.el6ost', 'release':'6', 'el_string':'el6ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'},
      {'reference':'python-six-1.5.2-1.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
