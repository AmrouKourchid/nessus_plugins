...
if (description)
{
  ...
  script_name(english:"CentOS 9 : file-5.39-16.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update for file.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 9 host has packages installed that are affected by a vulnerability as referenced in the
file-5.39-16.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=41497");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream file package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:python3-file-magic");
...
var pkgs = [
    ...
    {'reference':'file-static-5.39-16.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'file / file-devel / file-libs / file-static / python3-file-magic');
}
