...
# extracted from Red Hat Security Advisory RHSA-2025:0834. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:0834");

  script_name(english:"RHEL 9 : OpenShift Container Platform 4.12.72 (RHSA-2025:0834)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for OpenShift Container Platform 4.12.72.");
...
referenced in the RHSA-2025:0834 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.12.72. See the
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_0834.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?79485dea");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:0834");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.12.72 packages based on the guidance in RHSA-2025:0834.");
