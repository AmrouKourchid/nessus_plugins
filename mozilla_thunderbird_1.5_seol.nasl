...
if (description)
{
  ...
  script_name(english:"Mozilla Thunderbird SEoL (1.5.x)");
...
"Upgrade to a version of Mozilla Thunderbird that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2007/06/01");
...
var constraints = [
{ max_branch : '1.5', min_branch : '1.5', seol : 20070601 }
];
