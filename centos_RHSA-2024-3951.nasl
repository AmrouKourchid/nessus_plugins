...
# extracted from Red Hat Security Advisory RHSA-2024:3951.
##
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:3951");
  script_xref(name:"IAVA", value:"2024-A-0335-S");

  script_name(english:"CentOS 7 : firefox (RHSA-2024:3951)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:3951");
...
var pkgs = [
    {'reference':'firefox-115.12.0-1.el7.centos', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-115.12.0-1.el7.centos', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
