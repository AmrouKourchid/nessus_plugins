...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : libtiff (EulerOS-SA-2024-1655)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1655
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?89ef5716");
...
var pkgs = [
  "libtiff-4.0.3-27.h49.eulerosv2r7",
  "libtiff-devel-4.0.3-27.h49.eulerosv2r7"
];
