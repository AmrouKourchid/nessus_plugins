...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 20.04 LTS : Pillow vulnerabilities (USN-4697-1)");
...
vulnerabilities as referenced in the USN-4697-1 advisory.
    ...
    It was discovered that Pillow incorrectly handled certain PCX image files. If a user or automated system
    were tricked into opening a specially-crafted PCX file, a remote attacker could possibly cause Pillow to
    crash, resulting in a denial of service. (CVE-2020-35653)
    ...
    20.04 LTS and Ubuntu 20.10. (CVE-2020-35654)
