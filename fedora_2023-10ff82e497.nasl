...
# extracted from Fedora Security Advisory FEDORA-2023-10ff82e497
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-10ff82e497");

  script_name(english:"Fedora 39 : libvpx (2023-10ff82e497)");
...
FEDORA-2023-10ff82e497 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-10ff82e497");
...
var pkgs = [
    {'reference':'libvpx-1.13.0-5.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
