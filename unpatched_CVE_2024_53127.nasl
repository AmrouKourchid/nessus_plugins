...
if (description)
{
  ...
  script_cve_id("CVE-2024-53127");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-53127");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: Revert mmc: dw_mmc: Fix IDMAC
    operation with pages bigger than 4K The commit 8396c793ffdf (mmc: dw_mmc: Fix IDMAC operation with pages
    bigger than 4K) increased the max_req_size, even for 4K pages, causing various issues: - Panic booting
    the kernel/rootfs from an SD card on Rockchip RK3566 - Panic booting the kernel/rootfs from an SD card on
    StarFive JH7100 - swiotlb buffer is full and data corruption on StarFive JH7110 At this stage no fix
    have been found, so it's probably better to just revert the change. This reverts commit
    8396c793ffdf28bb8aee7cfe0891080f8cab7890. (CVE-2024-53127)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-53127");
