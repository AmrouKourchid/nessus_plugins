...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2012-1181.html");
...
"Update the affected gimp, gimp-devel and / or gimp-libs packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2012-3481");
...
var pkgs = [
    {'reference':'gimp-2.2.13-2.0.7.el5_8.5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'gimp-devel-2.2.13-2.0.7.el5_8.5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'gimp-libs-2.2.13-2.0.7.el5_8.5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'gimp-2.2.13-2.0.7.el5_8.5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'gimp-devel-2.2.13-2.0.7.el5_8.5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'gimp-libs-2.2.13-2.0.7.el5_8.5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
