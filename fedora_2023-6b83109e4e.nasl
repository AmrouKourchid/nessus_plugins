...
# extracted from Fedora Security Advisory FEDORA-2023-6b83109e4e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-6b83109e4e");

  script_name(english:"Fedora 36 : opusfile (2023-6b83109e4e)");
...
FEDORA-2023-6b83109e4e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-6b83109e4e");
  script_set_attribute(attribute:"solution", value:
"Update the affected opusfile package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:opusfile");
...
var pkgs = [
    {'reference':'opusfile-0.12-9.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'opusfile');
}
