...
# extracted from Red Hat Security Advisory RHSA-2020:5412. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:5412");
  script_xref(name:"IAVA", value:"2021-A-0194-S");
  script_xref(name:"CEA-ID", value:"CEA-2021-0025");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2025/02/13");

  script_name(english:"RHEL 8 : python-XStatic-jQuery224 (RHSA-2020:5412)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for python-XStatic-jQuery224.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_5412.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d87c767e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:5412");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1850004");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-XStatic-jQuery224 package based on the guidance in RHSA-2020:5412.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:python-XStatic-jQuery224");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:python3-XStatic-jQuery224");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-XStatic-jQuery224-2.2.4.1-3.el8ost', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python3-XStatic-jQuery224');
}
