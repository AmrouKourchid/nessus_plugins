...
# extracted from Ubuntu Security Notice USN-7091-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"7091-2");

  script_name(english:"Ubuntu 20.04 LTS : Ruby vulnerabilities (USN-7091-2)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 20.04 LTS host has packages installed that are affected by multiple vulnerabilities as referenced in
the USN-7091-2 advisory.

    USN-7091-1 fixed several vulnerabilities in Ruby. This update provides the corresponding update for
    ruby2.7 in Ubuntu 20.04 LTS.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7091-2");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'libruby2.7', 'pkgver': '2.7.0-5ubuntu1.15'},
    {'osver': '20.04', 'pkgname': 'ruby2.7', 'pkgver': '2.7.0-5ubuntu1.15'},
    {'osver': '20.04', 'pkgname': 'ruby2.7-dev', 'pkgver': '2.7.0-5ubuntu1.15'}
];
