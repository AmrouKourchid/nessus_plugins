...
# extracted from Fedora Security Advisory FEDORA-2021-1bb399a5af
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-1bb399a5af");

  script_name(english:"Fedora 33 : python-django (2021-1bb399a5af)");
...
FEDORA-2021-1bb399a5af advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-1bb399a5af");
...
pkgs = [
    {'reference':'python-django-3.0.13-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
