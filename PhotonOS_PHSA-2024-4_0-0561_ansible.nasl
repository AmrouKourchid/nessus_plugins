...
# extracted from VMware Security Advisory PHSA-2024-4.0-0561. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Ansible PHSA-2024-4.0-0561");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the ansible package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-561.md");
...
if (rpm_check(release:'PhotonOS-4.0', reference:'ansible-2.14.12-2.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', reference:'ansible-devel-2.14.12-2.ph4')) flag++;
