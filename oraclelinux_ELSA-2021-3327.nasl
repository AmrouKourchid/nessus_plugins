...
ELSA-2021-3327 advisory.
    ...
    - netfilter: x_tables: fix compat match/target pad out-of-bound write (Florian Westphal) [1980489]
    {CVE-2021-22555}
...
var pkgs = [
    ...
    {'reference':'kernel-abi-whitelists-3.10.0-1160.41.1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-abi-whitelists-3.10.0'},
