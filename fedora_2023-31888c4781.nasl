...
# extracted from Fedora Security Advisory FEDORA-2023-31888c4781
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-31888c4781");
  script_xref(name:"IAVA", value:"2023-A-0283-S");

  script_name(english:"Fedora 37 : python3.8 (2023-31888c4781)");
...
FEDORA-2023-31888c4781 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-31888c4781");
...
var pkgs = [
    {'reference':'python3.8-3.8.16-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
