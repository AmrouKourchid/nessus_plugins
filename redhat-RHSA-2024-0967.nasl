...
# extracted from Red Hat Security Advisory RHSA-2024:0967. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:0967");

  script_name(english:"RHEL 8 : opensc (RHSA-2024:0967)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0967.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?30d8131b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2248685");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0967");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL opensc package based on the guidance in RHSA-2024:0967.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'opensc-0.20.0-8.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
