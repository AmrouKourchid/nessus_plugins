...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_1864.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?33d339a9");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1480664");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1755523");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL gcc package based on the guidance in RHSA-2020:1864.");
