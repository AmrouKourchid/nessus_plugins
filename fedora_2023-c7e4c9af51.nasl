...
# extracted from Fedora Security Advisory FEDORA-2023-c7e4c9af51
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-c7e4c9af51");

  script_name(english:"Fedora 38 : opensc (2023-c7e4c9af51)");
...
FEDORA-2023-c7e4c9af51 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-c7e4c9af51");
...
var pkgs = [
    {'reference':'opensc-0.24.0-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
