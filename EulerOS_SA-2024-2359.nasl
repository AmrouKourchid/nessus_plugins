...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : cups (EulerOS-SA-2024-2359)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2359
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1f1c6f96");
...
var pkgs = [
  "cups-libs-2.2.13-3.h11.eulerosv2r9"
];
