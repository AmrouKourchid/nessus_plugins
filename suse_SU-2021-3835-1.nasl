...
# SUSE update advisory SUSE-SU-2021:3835-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2021:3835-1");
  script_xref(name:"IAVA", value:"2021-A-0487-S");

  script_name(english:"SUSE SLES15 Security Update : mariadb (SUSE-SU-2021:3835-1)");
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2021-December/009800.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ce546250");
...
var pkgs = [
    {'reference':'libmariadbd-devel-10.5.13-3.12.1', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-server-applications-release-15.3']},
    {'reference':'libmariadbd19-10.5.13-3.12.1', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-server-applications-release-15.3']},
    {'reference':'mariadb-10.5.13-3.12.1', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-server-applications-release-15.3']},
    {'reference':'mariadb-client-10.5.13-3.12.1', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-server-applications-release-15.3']},
    {'reference':'mariadb-errormessages-10.5.13-3.12.1', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-server-applications-release-15.3']},
    {'reference':'mariadb-tools-10.5.13-3.12.1', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-server-applications-release-15.3']}
];
