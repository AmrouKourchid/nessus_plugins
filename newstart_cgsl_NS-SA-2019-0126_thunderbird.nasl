...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 4.05 : thunderbird Multiple Vulnerabilities (NS-SA-2019-0126)");
...
pkgs = {
  "CGSL MAIN 4.05": [
    "thunderbird-52.7.0-1.el6.centos",
    "thunderbird-debuginfo-52.7.0-1.el6.centos"
  ]
};
