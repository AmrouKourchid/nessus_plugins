...
# extracted from Fedora Security Advisory FEDORA-2022-b9b710f199
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-b9b710f199");

  script_name(english:"Fedora 35 : ruby (2022-b9b710f199)");
...
FEDORA-2022-b9b710f199 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-b9b710f199");
...
var pkgs = [
    {'reference':'ruby-3.0.5-155.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
