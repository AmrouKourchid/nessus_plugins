...
if (description)
{
  ...
  script_cve_id("CVE-2022-34435");
  script_xref(name:"IAVA", value:"2023-A-0015-S");

  script_name(english:"Dell EMC iDRAC9 < 6.00.30.00 (DSA-2022-265)");

  script_set_attribute(attribute:"synopsis", value:
"Dell EMC iDRAC9 installed on the remote host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Dell EMC iDRAC9 installed on the remote host is prior to 6.00.30.00. It is, therefore, affected by a
vulnerability as referenced in the DSA-2022-265 advisory.

  - Dell iDRAC9 version 6.00.02.00 and prior contain an improper input validation vulnerability in Racadm when
...
"Upgrade to Dell EMC iDRAC9 version 6.00.30.00 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-34435");
...
var constraints = [
{ 'fixed_version' : '6.00.30.00', 'idrac' : '9' }
];
