...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : c-ares (EulerOS-SA-2022-1112)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the c-ares packages installed, the EulerOS Virtualization installation on the remote host
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1112
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?151d911a");
...
var pkgs = [
  "c-ares-1.10.0-3.h3.eulerosv2r7",
  "c-ares-devel-1.10.0-3.h3.eulerosv2r7"
];
