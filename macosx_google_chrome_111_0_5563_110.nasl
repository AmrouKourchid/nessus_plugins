...
"The version of Google Chrome installed on the remote macOS host is prior to 111.0.5563.110. It is, therefore, affected
...
google_chrome_check_version(fix:'111.0.5563.110', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
