...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2011-0919.html");
...
var pkgs = [
    {'reference':'qemu-img-0.12.1.2-2.160.el6_1.2', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'qemu-kvm-0.12.1.2-2.160.el6_1.2', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'qemu-kvm-tools-0.12.1.2-2.160.el6_1.2', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
