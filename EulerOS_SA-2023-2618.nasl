...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : libwebp (EulerOS-SA-2023-2618)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2618
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6476f984");
...
var pkgs = [
  "libwebp-1.1.0-1.h2.eulerosv2r9"
];
