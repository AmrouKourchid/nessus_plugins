...
# extracted from Debian Security Advisory dsa-5073. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-5073-1 : expat - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2022/dsa-5073");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'expat', 'reference': '2.2.6-2+deb10u2'},
    {'release': '10.0', 'prefix': 'libexpat1', 'reference': '2.2.6-2+deb10u2'},
    {'release': '10.0', 'prefix': 'libexpat1-dev', 'reference': '2.2.6-2+deb10u2'},
    {'release': '10.0', 'prefix': 'libexpat1-udeb', 'reference': '2.2.6-2+deb10u2'},
    {'release': '11.0', 'prefix': 'expat', 'reference': '2.2.10-2+deb11u1'},
    {'release': '11.0', 'prefix': 'libexpat1', 'reference': '2.2.10-2+deb11u1'},
    {'release': '11.0', 'prefix': 'libexpat1-dev', 'reference': '2.2.10-2+deb11u1'},
    {'release': '11.0', 'prefix': 'libexpat1-udeb', 'reference': '2.2.10-2+deb11u1'}
];
