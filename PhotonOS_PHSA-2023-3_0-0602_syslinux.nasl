...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Syslinux PHSA-2023-3.0-0602");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'syslinux-6.04-8.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'syslinux-devel-6.04-8.ph3')) flag++;
