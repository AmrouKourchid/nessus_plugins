...
# extracted from Fedora Security Advisory FEDORA-2023-2884ba1528
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-2884ba1528");

  script_name(english:"Fedora 37 : curl (2023-2884ba1528)");
...
FEDORA-2023-2884ba1528 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-2884ba1528");
...
var pkgs = [
    {'reference':'curl-7.85.0-8.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
