...
# extracted from Oracle Linux Security Advisory ELSA-2022-8263.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : dpdk (ELSA-2022-8263)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 9 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ELSA-2022-8263 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2022-8263.html");
...
var pkgs = [
    ...
    {'reference':'dpdk-doc-21.11.2-1.el9_1', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    ...
    {'reference':'dpdk-doc-21.11.2-1.el9_1', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
