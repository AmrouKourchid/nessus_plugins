...
referenced in the RHSA-2019:0980 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?38bc0ce2");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:0980");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1694980");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1695025");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL httpd:2.4 package based on the guidance in RHSA-2019:0980.");
  ...
  'httpd:2.4': [
    {
      ...
      'pkgs': [
        {'reference':'httpd-2.4.37-11.module+el8.0.0+2969+90015743', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'httpd-devel-2.4.37-11.module+el8.0.0+2969+90015743', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'httpd-filesystem-2.4.37-11.module+el8.0.0+2969+90015743', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'httpd-manual-2.4.37-11.module+el8.0.0+2969+90015743', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'httpd-tools-2.4.37-11.module+el8.0.0+2969+90015743', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mod_http2-1.11.3-2.module+el8.0.0+2969+90015743', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mod_ldap-2.4.37-11.module+el8.0.0+2969+90015743', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mod_md-2.4.37-11.module+el8.0.0+2969+90015743', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mod_proxy_html-2.4.37-11.module+el8.0.0+2969+90015743', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'mod_session-2.4.37-11.module+el8.0.0+2969+90015743', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mod_ssl-2.4.37-11.module+el8.0.0+2969+90015743', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
      ]
    }
  ]
};
