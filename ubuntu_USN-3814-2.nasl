...
the USN-3814-2 advisory.

    Updated: 2018-11-21: The embedded version of libmspack in ClamAV was found to not be affected by the
    listed vulnerabilities, therefore the following is not applicable.

    USN-3814-1 fixed several vulnerabilities in libmspack. In Ubuntu 14.04 libmspack is included into ClamAV.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3814-2");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'clamav', 'pkgver': '0.100.2+dfsg-1ubuntu0.14.04.2'},
    {'osver': '14.04', 'pkgname': 'clamav-base', 'pkgver': '0.100.2+dfsg-1ubuntu0.14.04.2'},
    {'osver': '14.04', 'pkgname': 'clamav-daemon', 'pkgver': '0.100.2+dfsg-1ubuntu0.14.04.2'},
    {'osver': '14.04', 'pkgname': 'clamav-freshclam', 'pkgver': '0.100.2+dfsg-1ubuntu0.14.04.2'},
    {'osver': '14.04', 'pkgname': 'clamav-milter', 'pkgver': '0.100.2+dfsg-1ubuntu0.14.04.2'},
    {'osver': '14.04', 'pkgname': 'clamav-testfiles', 'pkgver': '0.100.2+dfsg-1ubuntu0.14.04.2'},
    {'osver': '14.04', 'pkgname': 'libclamav-dev', 'pkgver': '0.100.2+dfsg-1ubuntu0.14.04.2'},
    {'osver': '14.04', 'pkgname': 'libclamav7', 'pkgver': '0.100.2+dfsg-1ubuntu0.14.04.2'}
];
