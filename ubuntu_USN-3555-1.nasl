...
# extracted from Ubuntu Security Notice USN-3555-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"3555-1");

  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS : w3m vulnerabilities (USN-3555-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 14.04 LTS / 16.04 LTS host has packages installed that are affected by multiple vulnerabilities as
referenced in the USN-3555-1 advisory.

    It was discovered that w3m incorrectly handled certain inputs. An attacker could possibly use this to
    cause a denial of service. (CVE-2018-6196, CVE-2018-6197)

    It was discovered that w3m incorrectly handled temporary files. An attacker could possibly use this to
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3555-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'w3m', 'pkgver': '0.5.3-15ubuntu0.2'},
    {'osver': '14.04', 'pkgname': 'w3m-img', 'pkgver': '0.5.3-15ubuntu0.2'},
    {'osver': '16.04', 'pkgname': 'w3m', 'pkgver': '0.5.3-26ubuntu0.2'},
    {'osver': '16.04', 'pkgname': 'w3m-img', 'pkgver': '0.5.3-26ubuntu0.2'}
];
