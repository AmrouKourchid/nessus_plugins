...
# extracted from Red Hat Security Advisory RHSA-2022:7129. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:7129");

  script_name(english:"RHEL 8 : git-lfs (RHSA-2022:7129)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for git-lfs.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has a package installed that is affected by multiple vulnerabilities as
referenced in the RHSA-2022:7129 advisory.

    Git Large File Storage (LFS) replaces large files such as audio samples, videos, datasets, and graphics
    with text pointers inside Git, while storing the file contents on a remote server.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_7129.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ef62f00f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:7129");
...
"Update the RHEL git-lfs package based on the guidance in RHSA-2022:7129.");
  ...
  script_cwe_id(129, 200, 400, 444, 1325);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'git-lfs-2.13.3-3.el8_6', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'git-lfs-2.13.3-3.el8_6', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
