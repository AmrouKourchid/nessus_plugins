...
if (description)
{
  ...
  script_name(english:"Zoom Client for Meetings < 2.5.146186.1130 Vulnerability (ZSB-18001)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host has an application installed that is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Zoom Client for Meetings installed on the remote host is prior to 2.5.146186.1130. It is, therefore,
...
"Upgrade to Zoom Client for Meetings 2.5.146186.1130 or later.");
