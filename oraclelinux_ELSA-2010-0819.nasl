...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2010-0819.html");
...
"Update the affected pam and / or pam-devel packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2010-3853");
...
var pkgs = [
    {'reference':'pam-0.99.6.2-6.el5_5.2', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pam-devel-0.99.6.2-6.el5_5.2', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pam-0.99.6.2-6.el5_5.2', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pam-devel-0.99.6.2-6.el5_5.2', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
