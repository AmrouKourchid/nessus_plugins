...
# extracted from Fedora Security Advisory FEDORA-2022-13046bb867
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-13046bb867");

  script_name(english:"Fedora 37 : dotnet6.0 (2022-13046bb867)");
...
FEDORA-2022-13046bb867 advisory.

    This is the monthly .NET 6 update for September 2022. It updates the .NET SDK to 6.0.109 and Runtime to
    6.0.9.
    ...
    This is the monthly update for .NET for August 2022. This updates the .NET SDK to 6.0.108 and .NET Runtime
    to 6.0.8.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-13046bb867");
...
var pkgs = [
    {'reference':'dotnet6.0-6.0.109-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
