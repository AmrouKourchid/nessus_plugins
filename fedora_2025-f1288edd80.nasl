...
# extracted from Fedora Security Advisory FEDORA-2025-f1288edd80
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-f1288edd80");

  script_name(english:"Fedora 40 : abseil-cpp (2025-f1288edd80)");
...
FEDORA-2025-f1288edd80 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-f1288edd80");
...
var pkgs = [
    {'reference':'abseil-cpp-20240116.3-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
