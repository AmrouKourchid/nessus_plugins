...
# Red Hat Security Advisory RHSA-2024:1610. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : less (CESA-2024:1610)");
...
var pkgs = [
    {'reference':'less-530-2.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'less-530-2.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
