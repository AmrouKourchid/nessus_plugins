...
if (description)
{
  ...
  script_cve_id("CVE-2022-37434", "CVE-2023-22081");

  script_name(english:"Oracle Siebel Server (July 2024 CPU)");
...
the July 2024 CPU advisory.
  ...
  - Vulnerability in the Siebel CRM Deployment product of Oracle Siebel CRM (component: Repository Utilities
    (zlib)). Supported versions that are affected are 24.6 and prior. Easily exploitable vulnerability allows
    unauthenticated attacker with network access via HTTP to compromise Siebel CRM Deployment. Successful
    attacks of this vulnerability can result in takeover of Siebel CRM Deployment. (CVE-2022-37434)

  - Vulnerability in the Siebel CRM Deployment product of Oracle Siebel CRM (component: Installation (Oracle
    Java SE)). Supported versions that are affected are 24.6 and prior. Easily exploitable vulnerability
    allows unauthenticated attacker with network access via HTTPS to compromise Siebel CRM Deployment.
    Successful attacks of this vulnerability can result in unauthorized ability to cause a partial denial of
    service (partial DOS) of Siebel CRM Deployment. (CVE-2023-22081)
