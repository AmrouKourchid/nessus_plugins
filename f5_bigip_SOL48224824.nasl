...
even though the authoritative nameserver removed the name.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K48224824");
...
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K48224824.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-5532");
...
var vmatrix = {
  'AFM': {
    'affected': [
      '13.0.0','12.1.0-12.1.2','11.6.1-11.6.3','11.2.1-11.5.6'
    ],
    'unaffected': [
      '13.1.0','13.0.0 HF1','12.1.3','11.6.3.2','11.5.7'
    ],
  },
  'AM': {
    'affected': [
