...
if (description)
{
  ...
  script_cve_id("CVE-2013-6399");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2013-6399");
...
patch available.
  ...
  - Array index error in the virtio_load function in hw/virtio/virtio.c in QEMU before 1.7.2 allows remote
    attackers to execute arbitrary code via a crafted savevm image. (CVE-2013-6399)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-6399");
