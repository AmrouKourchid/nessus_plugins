...
# extracted from Fedora Security Advisory FEDORA-2020-1106ece93a.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : mod_auth_openidc (2020-1106ece93a)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-1106ece93a");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"mod_auth_openidc-2.4.2.1-1.fc31")) flag++;
