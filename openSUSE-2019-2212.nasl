...
# extracted from openSUSE Security Update openSUSE-2019-2212.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libopenmpt (openSUSE-2019-2212)");
...
if ( rpm_check(release:"SUSE15.0", reference:"libmodplug-devel-0.3.17-lp150.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libmodplug1-0.3.17-lp150.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libmodplug1-debuginfo-0.3.17-lp150.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libopenmpt-debugsource-0.3.17-lp150.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libopenmpt-devel-0.3.17-lp150.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libopenmpt0-0.3.17-lp150.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libopenmpt0-debuginfo-0.3.17-lp150.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libopenmpt_modplug1-0.3.17-lp150.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libopenmpt_modplug1-debuginfo-0.3.17-lp150.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"openmpt123-0.3.17-lp150.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"openmpt123-debuginfo-0.3.17-lp150.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libmodplug1-32bit-0.3.17-lp150.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libmodplug1-32bit-debuginfo-0.3.17-lp150.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libopenmpt0-32bit-0.3.17-lp150.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libopenmpt0-32bit-debuginfo-0.3.17-lp150.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libopenmpt_modplug1-32bit-0.3.17-lp150.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libopenmpt_modplug1-32bit-debuginfo-0.3.17-lp150.7.1") ) flag++;
