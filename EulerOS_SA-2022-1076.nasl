...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : libsndfile (EulerOS-SA-2022-1076)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1076
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?da1b110f");
...
var pkgs = [
  "libsndfile-1.0.28-9.h6.eulerosv2r8",
  "libsndfile-devel-1.0.28-9.h6.eulerosv2r8"
];
