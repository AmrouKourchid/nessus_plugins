...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : ruby (EulerOS-SA-2021-1516)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing multiple security
updates.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the ruby package installed, the EulerOS
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1516
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3b7f9580");
...
pkgs = ["rubygems-2.0.14.1-33.h28.eulerosv2r7"];
