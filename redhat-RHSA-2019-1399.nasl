...
# extracted from Red Hat Security Advisory RHSA-2019:1399. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:1399");

  script_name(english:"RHEL 7 : qpid-proton (RHSA-2019:1399)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for qpid-proton.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2019:1399 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1707869");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_1399.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6626e34c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:1399");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL qpid-proton package based on the guidance in RHSA-2019:1399.");
