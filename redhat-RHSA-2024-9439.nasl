...
# extracted from Red Hat Security Advisory RHSA-2024:9439. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:9439");

  script_name(english:"RHEL 9 : fontforge (RHSA-2024:9439)");
...
referenced in the RHSA-2024:9439 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_9439.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f4f132fc");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:9439");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL fontforge package based on the guidance in RHSA-2024:9439.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'fontforge-20201107-6.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
