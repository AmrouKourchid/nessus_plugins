...
# openSUSE Security Update openSUSE-SU-2021:1513-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : tor (openSUSE-SU-2021:1513-1)");
...
openSUSE-SU-2021:1513-1 advisory.

  - An information disclosure exists in Brave Browser Desktop prior to version 1.28.62, where logged warning
    messages that included timestamps of connections to V2 onion domains in tor.log. (CVE-2021-22929)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1192658");
  # https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/ZELBVBNTOTNRG5IP3NQWA756AE37TH5Y/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?942e507c");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2021-22929");
...
"Update the affected tor package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-22929");
...
var pkgs = [
    {'reference':'tor-0.4.6.8-bp153.2.9.1', 'release':'SUSE15.2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tor-0.4.6.8-bp153.2.9.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE}
];
