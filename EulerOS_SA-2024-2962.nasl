...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP12 : xorg-x11-server (EulerOS-SA-2024-2962)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2962
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0e281946");
...
var pkgs = [
  "xorg-x11-server-help-1.20.11-13.h10.eulerosv2r12"
];
