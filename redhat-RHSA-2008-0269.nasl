...
# extracted from Red Hat Security Advisory RHSA-2008:0269. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2008-1677");
  script_xref(name:"RHSA", value:"2008:0269");

  script_name(english:"RHEL 5 : redhat-ds-base (RHSA-2008:0269)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=444712");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2008/rhsa-2008_0269.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7b3c2f2d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2008:0269");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL redhat-ds-base package based on the guidance in RHSA-2008:0269.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2008-1677");
  ...
  script_set_attribute(attribute:"vuln_publication_date", value:"2008/05/09");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'redhat-ds-base-8.0.3-16.el5dsrv', 'cpu':'i386', 'release':'5', 'el_string':'el5dsrv', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'redhat-ds-base-8.0.3-16.el5dsrv', 'cpu':'x86_64', 'release':'5', 'el_string':'el5dsrv', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'redhat-ds-base-devel-8.0.3-16.el5dsrv', 'cpu':'i386', 'release':'5', 'el_string':'el5dsrv', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'redhat-ds-base-devel-8.0.3-16.el5dsrv', 'cpu':'x86_64', 'release':'5', 'el_string':'el5dsrv', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
