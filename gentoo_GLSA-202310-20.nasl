...
# extracted from Gentoo Linux Security Advisory GLSA 202310-20.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202310-20 : rxvt-unicode: Arbitrary Code Execution");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202310-20");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=884787");
...
var packages = [
  {
    ...
    'unaffected' : make_list("ge 9.30"),
    'vulnerable' : make_list("lt 9.30")
  }
];
