...
# extracted from Debian Security Advisory DSA-4706. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"4706");
  script_xref(name:"IAVA", value:"2020-A-0272-S");

  script_name(english:"Debian DSA-4706-1 : drupal7 - security update");
...
https://www.drupal.org/sa-core-2020-004");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/drupal7");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/stretch/drupal7");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2020/dsa-4706");
...
flag = 0;
if (deb_check(release:"9.0", prefix:"drupal7", reference:"7.52-2+deb9u11")) flag++;
