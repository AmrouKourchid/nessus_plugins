...
# extracted from Red Hat Security Advisory cri-o. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2020-8945", "CVE-2021-41190");

  script_name(english:"RHEL 8 : cri-o (Unpatched Vulnerability) (deprecated)");
