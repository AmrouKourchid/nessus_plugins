...
# extracted from Oracle Linux Security Advisory ELSA-2024-3980.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : flatpak (ELSA-2024-3980)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 7 host has packages installed that are affected by a vulnerability as referenced in the
ELSA-2024-3980 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-3980.html");
...
var pkgs = [
    {'reference':'flatpak-1.0.9-13.el7_9', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'flatpak-builder-1.0.0-13.el7_9', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'flatpak-devel-1.0.9-13.el7_9', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'flatpak-libs-1.0.9-13.el7_9', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
