...
if (description)
{
  ...
  script_name(english:"RHCOS 4 : OpenShift Container Platform 4.10.60 (RHSA-2023:3216)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat CoreOS host is missing a security update for OpenShift Container Platform 4.10.60.");
...
referenced in the RHSA-2023:3216 advisory.
...
"Update the RHCOS OpenShift Container Platform 4.10.60 packages based on the guidance in RHSA-2023:3216.");
...
var pkgs = [
    {'reference':'cri-o-1.23.5-11.rhaos4.10.gitfc32aac.el7', 'cpu':'x86_64', 'release':'4', 'el_string':'el7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
    {'reference':'cri-o-1.23.5-11.rhaos4.10.gitfc32aac.el8', 'release':'4', 'el_string':'el8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
];
