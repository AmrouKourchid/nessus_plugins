...
# extracted from Fedora Security Advisory FEDORA-2023-5b6510a584
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-5b6510a584");

  script_name(english:"Fedora 37 : redis (2023-5b6510a584)");
...
FEDORA-2023-5b6510a584 advisory.
    ...
    * (**CVE-2023-28856**) Authenticated users can use the HINCRBYFLOAT command to create  an invalid hash
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-5b6510a584");
...
var pkgs = [
    {'reference':'redis-7.0.11-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
