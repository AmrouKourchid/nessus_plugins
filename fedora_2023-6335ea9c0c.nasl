...
# extracted from Fedora Security Advisory FEDORA-2023-6335ea9c0c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-6335ea9c0c");

  script_name(english:"Fedora 38 : cacti / cacti-spine (2023-6335ea9c0c)");
...
FEDORA-2023-6335ea9c0c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-6335ea9c0c");
...
var pkgs = [
    {'reference':'cacti-1.2.25-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cacti-spine-1.2.25-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
