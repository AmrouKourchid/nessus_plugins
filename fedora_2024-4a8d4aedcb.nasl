...
# extracted from Fedora Security Advisory FEDORA-2024-4a8d4aedcb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-4a8d4aedcb");

  script_name(english:"Fedora 40 : freeipa (2024-4a8d4aedcb)");
...
FEDORA-2024-4a8d4aedcb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-4a8d4aedcb");
...
var pkgs = [
    {'reference':'freeipa-4.11.1-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
