...
# extracted from Red Hat Security Advisory RHSA-2023:4523. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_4523.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?892e8529");
...
"Update the RHEL curl package based on the guidance in RHSA-2023:4523.");
...
var constraints = [
  ...
  },
  {
    ...
    'pkgs': [
      {'reference':'curl-7.61.1-30.el8_8.3', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libcurl-7.61.1-30.el8_8.3', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libcurl-devel-7.61.1-30.el8_8.3', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libcurl-minimal-7.61.1-30.el8_8.3', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
