...
# extracted from Oracle Linux Security Advisory ELSA-2019-2097.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : perl-Archive-Tar (ELSA-2019-2097)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2019-2097.html");
...
var pkgs = [
    {'reference':'perl-Archive-Tar-1.92-3.el7', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
];
