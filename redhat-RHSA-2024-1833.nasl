...
# extracted from Red Hat Security Advisory RHSA-2024:1833. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:1833");

  script_name(english:"RHEL 9 : squid (RHSA-2024:1833)");
...
referenced in the RHSA-2024:1833 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_1833.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?632a345f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:1833");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL squid package based on the guidance in RHSA-2024:1833.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'squid-5.2-1.el9_0.6', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
    ]
  }
];
