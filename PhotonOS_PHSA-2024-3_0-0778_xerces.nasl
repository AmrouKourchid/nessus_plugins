...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Xerces PHSA-2024-3.0-0778");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'xerces-c-3.2.5-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'xerces-c-devel-3.2.5-1.ph3')) flag++;
