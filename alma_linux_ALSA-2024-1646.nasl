...
# AlmaLinux Security Advisory ALSA-2024:1646.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:1646");

  script_name(english:"AlmaLinux 8 : grafana (ALSA-2024:1646)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2024-1646.html");
...
var pkgs = [
    {'reference':'grafana-9.2.10-8.el8_9.alma.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'grafana-9.2.10-8.el8_9.alma.1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
