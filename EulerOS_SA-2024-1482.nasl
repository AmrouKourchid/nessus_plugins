...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : binutils (EulerOS-SA-2024-1482)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1482
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a72d5693");
...
var pkgs = [
  "binutils-2.34-1.h39.eulerosv2r9"
];
