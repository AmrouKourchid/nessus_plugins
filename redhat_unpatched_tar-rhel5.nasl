...
if (description)
{
  ...
  script_cve_id("CVE-2016-6321", "CVE-2018-20482");

  script_name(english:"RHEL 5 : tar (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss4_score_source", value:"CVE-2018-20482");
