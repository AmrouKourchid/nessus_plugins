...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Openssl PHSA-2021-2.0-0383");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'openssl-1.0.2za-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'openssl-c_rehash-1.0.2za-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'openssl-devel-1.0.2za-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'openssl-perl-1.0.2za-1.ph2')) flag++;
