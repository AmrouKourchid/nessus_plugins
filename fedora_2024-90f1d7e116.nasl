...
# extracted from Fedora Security Advisory FEDORA-2024-90f1d7e116
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-90f1d7e116");

  script_name(english:"Fedora 41 : seamonkey (2024-90f1d7e116)");
...
FEDORA-2024-90f1d7e116 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-90f1d7e116");
...
var pkgs = [
    {'reference':'seamonkey-2.53.19-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
