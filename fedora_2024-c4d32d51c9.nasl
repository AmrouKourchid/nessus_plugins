...
# extracted from Fedora Security Advisory FEDORA-2024-c4d32d51c9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-c4d32d51c9");

  script_name(english:"Fedora 40 : freeimage / mingw-freeimage (2024-c4d32d51c9)");
...
FEDORA-2024-c4d32d51c9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-c4d32d51c9");
...
var pkgs = [
    {'reference':'freeimage-3.19.0-0.23.svn1909.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'mingw-freeimage-3.19.0-0.20.svn1909.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
