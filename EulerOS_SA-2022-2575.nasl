...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : numpy (EulerOS-SA-2022-2575)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2575
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d6be418b");
...
var pkgs = [
  "python2-numpy-1.15.1-1.h2.eulerosv2r8",
  "python2-numpy-f2py-1.15.1-1.h2.eulerosv2r8",
  "python3-numpy-1.15.1-1.h2.eulerosv2r8",
  "python3-numpy-f2py-1.15.1-1.h2.eulerosv2r8"
];
