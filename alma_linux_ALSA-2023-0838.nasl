...
# AlmaLinux Security Advisory ALSA-2023:0838.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:0838");
  script_xref(name:"IAVA", value:"2023-A-0004-S");

  script_name(english:"AlmaLinux 8 : samba (ALSA-2023:0838)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 8 host has packages installed that are affected by a vulnerability as referenced in the
ALSA-2023:0838 advisory.

  - Netlogon RPC Elevation of Privilege Vulnerability. (CVE-2022-38023)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2023-0838.html");
...
var pkgs = [
    ...
    {'reference':'samba-winexe-4.16.4-4.el8_7', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
