...
# extracted from openSUSE Security Update openSUSE-2018-1466.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : SDL2_image (openSUSE-2018-1466)");
...
Security issues fixed :
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1089087");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1114519");
...
"Update the affected SDL2_image packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-3977");
...
if ( rpm_check(release:"SUSE15.0", reference:"SDL2_image-debugsource-2.0.4-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libSDL2_image-2_0-0-2.0.4-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libSDL2_image-2_0-0-debuginfo-2.0.4-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libSDL2_image-devel-2.0.4-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libSDL2_image-2_0-0-32bit-2.0.4-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libSDL2_image-2_0-0-32bit-debuginfo-2.0.4-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libSDL2_image-devel-32bit-2.0.4-lp150.2.3.1") ) flag++;
