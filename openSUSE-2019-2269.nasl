...
# extracted from openSUSE Security Update openSUSE-2019-2269.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : openssl-1_0_0 (openSUSE-2019-2269)");
...
This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1131291");
...
if ( rpm_check(release:"SUSE15.1", reference:"libopenssl-1_0_0-devel-1.0.2p-lp151.5.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libopenssl1_0_0-1.0.2p-lp151.5.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libopenssl1_0_0-debuginfo-1.0.2p-lp151.5.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libopenssl1_0_0-hmac-1.0.2p-lp151.5.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libopenssl1_0_0-steam-1.0.2p-lp151.5.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libopenssl1_0_0-steam-debuginfo-1.0.2p-lp151.5.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"openssl-1_0_0-1.0.2p-lp151.5.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"openssl-1_0_0-cavs-1.0.2p-lp151.5.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"openssl-1_0_0-cavs-debuginfo-1.0.2p-lp151.5.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"openssl-1_0_0-debuginfo-1.0.2p-lp151.5.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"openssl-1_0_0-debugsource-1.0.2p-lp151.5.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libopenssl-1_0_0-devel-32bit-1.0.2p-lp151.5.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libopenssl1_0_0-32bit-1.0.2p-lp151.5.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libopenssl1_0_0-32bit-debuginfo-1.0.2p-lp151.5.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libopenssl1_0_0-hmac-32bit-1.0.2p-lp151.5.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libopenssl1_0_0-steam-32bit-1.0.2p-lp151.5.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libopenssl1_0_0-steam-32bit-debuginfo-1.0.2p-lp151.5.10.1") ) flag++;
