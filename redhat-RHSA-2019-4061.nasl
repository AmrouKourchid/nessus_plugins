...
# extracted from Red Hat Security Advisory RHSA-2019:4061. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:4061");

  script_name(english:"RHEL 7 : patch (RHSA-2019:4061)");
...
referenced in the RHSA-2019:4061 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_4061.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?13756035");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:4061");
...
"Update the RHEL patch package based on the guidance in RHSA-2019:4061.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'patch-2.7.1-11.el7_4', 'sp':'4', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'patch-2.7.1-11.el7_4', 'sp':'4', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
