...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5010358");
  script_xref(name:"MSFT", value:"MS22-5010358");
  script_xref(name:"IAVA", value:"2022-A-0074-S");
  script_xref(name:"IAVA", value:"2022-A-0068-S");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2022/04/15");

  script_name(english:"KB5010358: Windows 10 LTS 1507 Security Update (February 2022)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5010358. It is, therefore, affected by multiple vulnerabilities
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5010358");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5010358");
