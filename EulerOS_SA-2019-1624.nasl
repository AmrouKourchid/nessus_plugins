...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.2.0 : tar (EulerOS-SA-2019-1624)");
...
by the following vulnerability :
  ...
  - pax_decode_header in sparse.c in GNU Tar before 1.32
    had a NULL pointer dereference when parsing certain
    archives that have malformed extended
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1624
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?85975d17");
