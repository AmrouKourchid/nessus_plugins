...
# extracted from Ubuntu Security Notice USN-5394-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5394-1");

  script_name(english:"Ubuntu 20.04 LTS : WebKitGTK vulnerabilities (USN-5394-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 20.04 LTS host has packages installed that are affected by multiple vulnerabilities as referenced in
the USN-5394-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5394-1");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-22637");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'gir1.2-javascriptcoregtk-4.0', 'pkgver': '2.36.0-0ubuntu0.20.04.3'},
    {'osver': '20.04', 'pkgname': 'gir1.2-webkit2-4.0', 'pkgver': '2.36.0-0ubuntu0.20.04.3'},
    {'osver': '20.04', 'pkgname': 'libjavascriptcoregtk-4.0-18', 'pkgver': '2.36.0-0ubuntu0.20.04.3'},
    {'osver': '20.04', 'pkgname': 'libjavascriptcoregtk-4.0-bin', 'pkgver': '2.36.0-0ubuntu0.20.04.3'},
    {'osver': '20.04', 'pkgname': 'libjavascriptcoregtk-4.0-dev', 'pkgver': '2.36.0-0ubuntu0.20.04.3'},
    {'osver': '20.04', 'pkgname': 'libwebkit2gtk-4.0-37', 'pkgver': '2.36.0-0ubuntu0.20.04.3'},
    {'osver': '20.04', 'pkgname': 'libwebkit2gtk-4.0-37-gtk2', 'pkgver': '2.36.0-0ubuntu0.20.04.3'},
    {'osver': '20.04', 'pkgname': 'libwebkit2gtk-4.0-dev', 'pkgver': '2.36.0-0ubuntu0.20.04.3'},
    {'osver': '20.04', 'pkgname': 'webkit2gtk-driver', 'pkgver': '2.36.0-0ubuntu0.20.04.3'}
];
