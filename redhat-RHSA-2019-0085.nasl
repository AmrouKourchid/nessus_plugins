...
# extracted from Red Hat Security Advisory RHSA-2019:0085. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:0085");

  script_name(english:"RHEL 7 : pyOpenSSL (RHSA-2019:0085)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for pyOpenSSL.");
...
referenced in the RHSA-2019:0085 advisory.

    The pyOpenSSL packages provide a high-level wrapper around a subset of the OpenSSL library for the Python
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1640216");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1640217");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1642296");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_0085.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b0f1b73f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:0085");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL pyOpenSSL package based on the guidance in RHSA-2019:0085.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python2-pyOpenSSL-17.5.0-1.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python2-pyOpenSSL');
}
