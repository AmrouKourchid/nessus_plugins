...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5036899");
  script_xref(name:"MSFT", value:"MS24-5036899");
  script_xref(name:"IAVA", value:"2024-A-0227-S");
  script_xref(name:"IAVA", value:"2024-A-0228-S");

  script_name(english:"KB5036899: Windows 10 Version 1607 / Windows Server 2016 Security Update (April 2024)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5036899");
