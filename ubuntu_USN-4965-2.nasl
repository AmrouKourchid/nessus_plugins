...
# extracted from Ubuntu Security Notice USN-4965-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"4965-2");

  script_name(english:"Ubuntu 16.04 ESM : Apport vulnerabilities (USN-4965-2)");
...
the USN-4965-2 advisory.

    USN-4965-1 fixed several vulnerabilities in Apport. This update provides the corresponding update for
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4965-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'apport', 'pkgver': '2.20.1-0ubuntu2.30+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'apport-gtk', 'pkgver': '2.20.1-0ubuntu2.30+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'apport-kde', 'pkgver': '2.20.1-0ubuntu2.30+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'apport-noui', 'pkgver': '2.20.1-0ubuntu2.30+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'apport-retrace', 'pkgver': '2.20.1-0ubuntu2.30+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'apport-valgrind', 'pkgver': '2.20.1-0ubuntu2.30+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'dh-apport', 'pkgver': '2.20.1-0ubuntu2.30+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'python-apport', 'pkgver': '2.20.1-0ubuntu2.30+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'python-problem-report', 'pkgver': '2.20.1-0ubuntu2.30+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'python3-apport', 'pkgver': '2.20.1-0ubuntu2.30+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'python3-problem-report', 'pkgver': '2.20.1-0ubuntu2.30+esm1', 'ubuntu_pro': TRUE}
];
