...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 ESM : Subversion vulnerability (USN-5322-1)");
...
USN-5322-1 advisory.
    ...
    Thomas Akesson discovered that Subversion incorrectly handled certain inputs. An attacker could possibly
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libapache2-mod-svn', 'pkgver': '1.9.3-2ubuntu1.3+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libapache2-svn', 'pkgver': '1.9.3-2ubuntu1.3+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libsvn-dev', 'pkgver': '1.9.3-2ubuntu1.3+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libsvn-java', 'pkgver': '1.9.3-2ubuntu1.3+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libsvn-perl', 'pkgver': '1.9.3-2ubuntu1.3+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libsvn-ruby1.8', 'pkgver': '1.9.3-2ubuntu1.3+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libsvn1', 'pkgver': '1.9.3-2ubuntu1.3+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'python-subversion', 'pkgver': '1.9.3-2ubuntu1.3+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'ruby-svn', 'pkgver': '1.9.3-2ubuntu1.3+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'subversion', 'pkgver': '1.9.3-2ubuntu1.3+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'subversion-tools', 'pkgver': '1.9.3-2ubuntu1.3+esm1', 'ubuntu_pro': TRUE}
];
