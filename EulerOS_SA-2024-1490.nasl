...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : ncurses (EulerOS-SA-2024-1490)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1490
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0b85f65b");
...
var pkgs = [
  "ncurses-6.2-1.h1.r6.eulerosv2r9",
  "ncurses-base-6.2-1.h1.r6.eulerosv2r9",
  "ncurses-libs-6.2-1.h1.r6.eulerosv2r9"
];
