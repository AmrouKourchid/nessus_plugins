...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : unzip regression (USN-2788-2)");
...
USN-2788-2 advisory.
    ...
    USN-2788-1 fixed vulnerabilities in unzip. One of the security patches caused a regression when extracting
    0-byte files. This update fixes the problem.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2788-2");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'unzip', 'pkgver': '6.0-9ubuntu1.5'}
];
