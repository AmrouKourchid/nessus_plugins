...
# extracted from Fedora Security Advisory FEDORA-2022-96c31cc8f6
#
...
if (description)
{
  ...
  script_cve_id("CVE-2022-22846");
  script_xref(name:"FEDORA", value:"2022-96c31cc8f6");

  script_name(english:"Fedora 38 : python-dnslib (2022-96c31cc8f6)");
...
FEDORA-2022-96c31cc8f6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-96c31cc8f6");
  script_set_attribute(attribute:"solution", value:
"Update the affected python-dnslib package.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:P/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:L/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-22846");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:python-dnslib");
...
var pkgs = [
    {'reference':'python-dnslib-0.9.21-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python-dnslib');
}
