...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Python PHSA-2021-2.0-0347");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'python-cryptography-2.3.1-2.ph2')) flag++;
