...
# extracted from Red Hat Security Advisory RHSA-2022:8915. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:8915");

  script_name(english:"RHEL 7 : Red Hat Certificate System 9.7 (RHSA-2022:8915)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for Red Hat Certificate System 9.7.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2022:8915 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8915.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9e2e8bfb");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8915");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat Certificate System 9.7 package based on the guidance in RHSA-2022:8915.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'pki-ocsp-10.5.18-24.el7pki', 'release':'7', 'el_string':'el7pki', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pki-tks-10.5.18-24.el7pki', 'release':'7', 'el_string':'el7pki', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pki-tps-10.5.18-24.el7pki', 'cpu':'x86_64', 'release':'7', 'el_string':'el7pki', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
