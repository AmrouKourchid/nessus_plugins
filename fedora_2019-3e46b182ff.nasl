...
# extracted from Fedora Security Advisory FEDORA-2019-3e46b182ff.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-3e46b182ff");

  script_name(english:"Fedora 31 : chromium (2019-3e46b182ff)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-3e46b182ff");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"chromium-78.0.3904.108-1.fc31", allowmaj:TRUE)) flag++;
