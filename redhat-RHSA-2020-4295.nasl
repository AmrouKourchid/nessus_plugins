...
# extracted from Red Hat Security Advisory RHSA-2020:4295. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:4295");

  script_name(english:"RHEL 7 : rh-postgresql96-postgresql (RHSA-2020:4295)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_4295.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3dd04deb");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:4295");
...
"Update the RHEL rh-postgresql96-postgresql package based on the guidance in RHSA-2020:4295.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-postgresql96-postgresql-9.6.19-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql96-postgresql-contrib-9.6.19-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql96-postgresql-contrib-syspaths-9.6.19-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql96-postgresql-devel-9.6.19-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql96-postgresql-docs-9.6.19-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql96-postgresql-libs-9.6.19-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql96-postgresql-plperl-9.6.19-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql96-postgresql-plpython-9.6.19-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql96-postgresql-pltcl-9.6.19-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql96-postgresql-server-9.6.19-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql96-postgresql-server-syspaths-9.6.19-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql96-postgresql-static-9.6.19-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql96-postgresql-syspaths-9.6.19-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql96-postgresql-test-9.6.19-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
