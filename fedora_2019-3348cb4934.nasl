...
# extracted from Fedora Security Advisory FEDORA-2019-3348cb4934.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : libssh2 (2019-3348cb4934)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-3348cb4934");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"libssh2-1.8.1-1.fc28")) flag++;
