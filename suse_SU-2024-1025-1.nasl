...
# SUSE update advisory SUSE-SU-2024:1025-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2024:1025-1");

  script_name(english:"SUSE SLES12 Security Update : kernel (Live Patch 47 for SLE 12 SP5) (SUSE-SU-2024:1025-1)");
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2024-March/018231.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?aaf309ec");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2023-51779");
  script_set_attribute(attribute:"solution", value:
"Update the affected kgraft-patch-4_12_14-122_173-default package.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-122.173-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_12_14-122_173-default-7-2.2', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.5']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kgraft-patch-4_12_14-122_173-default');
}
