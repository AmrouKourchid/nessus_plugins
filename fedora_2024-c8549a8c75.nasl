...
# extracted from Fedora Security Advisory FEDORA-2024-c8549a8c75
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-c8549a8c75");
  script_xref(name:"IAVA", value:"2024-A-0174-S");

  script_name(english:"Fedora 39 : firefox (2024-c8549a8c75)");
...
FEDORA-2024-c8549a8c75 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-c8549a8c75");
...
var pkgs = [
    {'reference':'firefox-124.0.1-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
