...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Apache PHSA-2024-5.0-0422");
...
if (rpm_check(release:'PhotonOS-5.0', reference:'apache-tomcat10-10.1.34-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', reference:'apache-tomcat10-webapps-10.1.34-1.ph5')) flag++;
