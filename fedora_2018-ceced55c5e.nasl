...
# extracted from Fedora Security Advisory FEDORA-2018-ceced55c5e.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : bouncycastle (2018-ceced55c5e)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-ceced55c5e");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"bouncycastle-1.59-1.fc28")) flag++;
