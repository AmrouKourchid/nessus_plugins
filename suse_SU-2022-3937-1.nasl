...
# SUSE update advisory SUSE-SU-2022:3937-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:3937-1");

  script_name(english:"SUSE SLES12 Security Update : python3-lxml (SUSE-SU-2022:3937-1)");
...
in the SUSE-SU-2022:3937-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://lists.suse.com/pipermail/sle-updates/2022-November/026105.html");
...
var pkgs = [
    {'reference':'python3-lxml-3.6.1-3.6.1', 'sp':'5', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5']},
    {'reference':'python3-lxml-3.6.1-3.6.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.5']}
];
