...
if (description)
{
  ...
  script_name(english:"SUSE Linux Enterprise Server For SAP SEoL (12.0.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of SUSE Linux Enterprise Server For SAP is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, SUSE Linux Enterprise Server For SAP is 12.0.x. It is, therefore, no longer maintained by its
vendor or provider.
...
"Upgrade to a version of SUSE Linux Enterprise Server For SAP that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2016/08/31");
...
var constraints = [
  { max_branch : '12.0', min_branch : '12.0', eseol : 20190831, seol : 20160831 }
];
