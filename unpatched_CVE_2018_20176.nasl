...
if (description)
{
  ...
  script_cve_id("CVE-2018-20176");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2018-20176");
...
patch available.
  ...
  - rdesktop versions up to and including v1.8.3 contain several Out-Of- Bounds Reads in the file secure.c
    that result in a Denial of Service (segfault). (CVE-2018-20176)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-20176");
