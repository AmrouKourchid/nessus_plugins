...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : uboot-tools (EulerOS-SA-2024-2896)");
...
by the following vulnerabilities :
    ...
    `wLength` greater than 4096 bytes, they can write beyond the heap-allocated request buffer.(CVE-2022-2347)
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2896
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5c3fc706");
...
var pkgs = [
  "uboot-tools-2020.07-2.h6.eulerosv2r10",
  "uboot-tools-help-2020.07-2.h6.eulerosv2r10"
];
