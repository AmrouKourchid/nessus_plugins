...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Libtasn1 PHSA-2018-2.0-0017");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the libtasn1 package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-2-17.md");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libtasn1-4.13-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libtasn1-debuginfo-4.13-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libtasn1-devel-4.13-1.ph2')) flag++;
