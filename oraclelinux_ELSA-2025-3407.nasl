...
# extracted from Oracle Linux Security Advisory ELSA-2025-3407.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : freetype (ELSA-2025-3407)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2025-3407.html");
...
var pkgs = [
    {'reference':'freetype-2.10.4-10.el9_5', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'freetype-devel-2.10.4-10.el9_5', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'freetype-2.10.4-10.el9_5', 'cpu':'i686', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'freetype-devel-2.10.4-10.el9_5', 'cpu':'i686', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'freetype-2.10.4-10.el9_5', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'freetype-devel-2.10.4-10.el9_5', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
