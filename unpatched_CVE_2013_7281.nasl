...
if (description)
{
  ...
  script_cve_id("CVE-2013-7281");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2013-7281");
...
patch available.
  ...
  - The dgram_recvmsg function in net/ieee802154/dgram.c in the Linux kernel before 3.12.4 updates a certain
    ...
    recvmsg system call. (CVE-2013-7281)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-7281");
