...
# extracted from Oracle Linux Security Advisory ELSA-2023-2592.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : golang-github-cpuguy83-md2man (ELSA-2023-2592)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-2592.html");
...
"Update the affected golang-github-cpuguy83-md2man package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:golang-github-cpuguy83-md2man");
...
var pkgs = [
    {'reference':'golang-github-cpuguy83-md2man-2.0.2-4.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-github-cpuguy83-md2man-2.0.2-4.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
