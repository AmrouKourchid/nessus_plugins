...
# AlmaLinux Security Advisory ALSA-2024:0465.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:0465");
  script_xref(name:"IAVA", value:"2024-A-0003-S");

  script_name(english:"AlmaLinux 9 : sqlite (ALSA-2024:0465)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2024-0465.html");
