...
# extracted from Fedora Security Advisory FEDORA-2019-dd00364b71.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-dd00364b71");

  script_name(english:"Fedora 30 : fuse (2019-dd00364b71)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-dd00364b71");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"fuse-2.9.9-1.fc30")) flag++;
