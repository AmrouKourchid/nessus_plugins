...
if (description)
{
  ...
  script_cve_id("CVE-2010-2239");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2010-2239");
...
patch available.
  ...
  - Red Hat libvirt, possibly 0.6.0 through 0.8.2, creates new images without setting the user-defined
    backing-store format, which allows guest OS users to read arbitrary files on the host OS via unspecified
    vectors. (CVE-2010-2239)
