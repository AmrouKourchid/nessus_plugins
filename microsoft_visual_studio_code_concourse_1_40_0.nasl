...
if (description)
{
  ...
  script_name(english:"Security Update for Microsoft Visual Studio Code Concourse CI Pipeline Editor Extension (CVE-2022-31691)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host has an application installed that is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The Microsoft Visual Studio Code Concourse CI Pipeline Editor Extension is version 1.39.0 or below. It is, therefore, affected by a remote
...
"Update the Microsoft Visual Studio Code Concourse CI Pipeline Editor Extension to version 1.40.0 or later.");
...
var app_info = vcf::get_app_info(app:'vs-code::vscode-concourse', win_local:win_local);
