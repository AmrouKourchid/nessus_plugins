...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : gstreamer1-plugins-base (EulerOS-SA-2019-1678)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the version of the gstreamer1-plugins-base packages
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1678
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?082277b0");
...
pkgs = ["gstreamer1-plugins-base-1.10.4-1.h2.eulerosv2r7",
        "gstreamer1-plugins-base-devel-1.10.4-1.h2.eulerosv2r7"];
