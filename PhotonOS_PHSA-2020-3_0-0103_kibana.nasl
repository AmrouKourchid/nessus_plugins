...
if (description)
{
  ...
  script_cve_id("CVE-2020-7012", "CVE-2020-7013");

  script_name(english:"Photon OS 3.0: Kibana PHSA-2020-3.0-0103");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-7013");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2020-7012");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'kibana-6.8.9-1.ph3')) flag++;
