...
# extracted from Fedora Security Advisory FEDORA-2023-7df48f618b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-7df48f618b");
  script_xref(name:"IAVA", value:"2023-A-0124-S");

  script_name(english:"Fedora 36 : httpd (2023-7df48f618b)");
...
FEDORA-2023-7df48f618b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-7df48f618b");
...
var pkgs = [
    {'reference':'httpd-2.4.56-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
