...
# extracted from Red Hat Security Advisory RHSA-2024:0144. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:0144");

  script_name(english:"RHEL 8 : idm:DL1 (RHSA-2024:0144)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for idm:DL1.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:0144 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0144.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f94f6937");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2242828");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0144");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL idm:DL1 package based on the guidance in RHSA-2024:0144.");
  ...
  'idm:DL1': [
    {
      ...
      'pkgs': [
        {'reference':'bind-dyndb-ldap-11.2-3.module+el8.2.0+4921+923e30d5', 'sp':'2', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'bind-dyndb-ldap-11.2-3.module+el8.2.0+4921+923e30d5', 'sp':'2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'custodia-0.6.0-3.module+el8.1.0+4098+f286395e', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-client-4.8.4-14.module+el8.2.0+20745+1d1ce1ed', 'sp':'2', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-client-4.8.4-14.module+el8.2.0+20745+1d1ce1ed', 'sp':'2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-client-common-4.8.4-14.module+el8.2.0+20745+1d1ce1ed', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-client-samba-4.8.4-14.module+el8.2.0+20745+1d1ce1ed', 'sp':'2', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-client-samba-4.8.4-14.module+el8.2.0+20745+1d1ce1ed', 'sp':'2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-common-4.8.4-14.module+el8.2.0+20745+1d1ce1ed', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'ipa-idoverride-memberof-plugin-0.0.4-6.module+el8.1.0+4098+f286395e', 'sp':'2', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-idoverride-memberof-plugin-0.0.4-6.module+el8.1.0+4098+f286395e', 'sp':'2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-python-compat-4.8.4-14.module+el8.2.0+20745+1d1ce1ed', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-server-4.8.4-14.module+el8.2.0+20745+1d1ce1ed', 'sp':'2', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-server-4.8.4-14.module+el8.2.0+20745+1d1ce1ed', 'sp':'2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-server-common-4.8.4-14.module+el8.2.0+20745+1d1ce1ed', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-server-dns-4.8.4-14.module+el8.2.0+20745+1d1ce1ed', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-server-trust-ad-4.8.4-14.module+el8.2.0+20745+1d1ce1ed', 'sp':'2', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-server-trust-ad-4.8.4-14.module+el8.2.0+20745+1d1ce1ed', 'sp':'2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'opendnssec-1.4.14-1.module+el8.1.0+4098+f286395e', 'sp':'2', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'opendnssec-1.4.14-1.module+el8.1.0+4098+f286395e', 'sp':'2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-custodia-0.6.0-3.module+el8.1.0+4098+f286395e', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-ipaclient-4.8.4-14.module+el8.2.0+20745+1d1ce1ed', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-ipalib-4.8.4-14.module+el8.2.0+20745+1d1ce1ed', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-ipaserver-4.8.4-14.module+el8.2.0+20745+1d1ce1ed', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'slapi-nis-0.56.3-3.module+el8.2.0+10782+8facb0b2', 'sp':'2', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'slapi-nis-0.56.3-3.module+el8.2.0+10782+8facb0b2', 'sp':'2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'softhsm-2.4.0-4.module+el8.2.0+5779+a38c524f', 'sp':'2', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'softhsm-2.4.0-4.module+el8.2.0+5779+a38c524f', 'sp':'2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'softhsm-devel-2.4.0-4.module+el8.2.0+5779+a38c524f', 'sp':'2', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'softhsm-devel-2.4.0-4.module+el8.2.0+5779+a38c524f', 'sp':'2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
