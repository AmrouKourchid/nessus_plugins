...
# extracted from openSUSE Security Update openSUSE-2019-1394.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : freeradius-server (openSUSE-2019-1394)");
...
if ( rpm_check(release:"SUSE42.3", reference:"freeradius-server-3.0.15-9.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"freeradius-server-debuginfo-3.0.15-9.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"freeradius-server-debugsource-3.0.15-9.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"freeradius-server-devel-3.0.15-9.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"freeradius-server-krb5-3.0.15-9.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"freeradius-server-krb5-debuginfo-3.0.15-9.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"freeradius-server-ldap-3.0.15-9.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"freeradius-server-ldap-debuginfo-3.0.15-9.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"freeradius-server-libs-3.0.15-9.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"freeradius-server-libs-debuginfo-3.0.15-9.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"freeradius-server-mysql-3.0.15-9.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"freeradius-server-mysql-debuginfo-3.0.15-9.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"freeradius-server-perl-3.0.15-9.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"freeradius-server-perl-debuginfo-3.0.15-9.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"freeradius-server-postgresql-3.0.15-9.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"freeradius-server-postgresql-debuginfo-3.0.15-9.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"freeradius-server-python-3.0.15-9.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"freeradius-server-python-debuginfo-3.0.15-9.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"freeradius-server-sqlite-3.0.15-9.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"freeradius-server-sqlite-debuginfo-3.0.15-9.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"freeradius-server-utils-3.0.15-9.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"freeradius-server-utils-debuginfo-3.0.15-9.1") ) flag++;
