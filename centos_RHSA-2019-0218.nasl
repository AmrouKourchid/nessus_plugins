...
# extracted from Red Hat Security Advisory RHSA-2019:0218 and 
# CentOS Errata and Security Advisory 2019:0218 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : firefox (CESA-2019:0218)");
...
Holler, and Jed Davis as the original reporters.");
  # https://lists.centos.org/pipermail/centos-announce/2019-February/023187.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?806d6ad5");
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"firefox-60.5.0-2.el6.centos", allowmaj:TRUE)) flag++;
