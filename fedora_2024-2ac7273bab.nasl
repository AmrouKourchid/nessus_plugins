...
# extracted from Fedora Security Advisory FEDORA-2024-2ac7273bab
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-2ac7273bab");

  script_name(english:"Fedora 40 : libgsf (2024-2ac7273bab)");
...
FEDORA-2024-2ac7273bab advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-2ac7273bab");
...
var pkgs = [
    {'reference':'libgsf-1.14.53-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
