...
# extracted from Fedora Security Advisory FEDORA-2024-2ce1c754f7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-2ce1c754f7");

  script_name(english:"Fedora 40 : mingw-glib2 (2024-2ce1c754f7)");
...
FEDORA-2024-2ce1c754f7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-2ce1c754f7");
...
var pkgs = [
    {'reference':'mingw-glib2-2.80.1-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
