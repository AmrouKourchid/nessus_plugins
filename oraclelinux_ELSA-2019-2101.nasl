...
# extracted from Oracle Linux Security Advisory ELSA-2019-2101.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : exiv2 (ELSA-2019-2101)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 7 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ELSA-2019-2101 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2019-2101.html");
...
var pkgs = [
    {'reference':'exiv2-0.27.0-2.el7_6', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'exiv2-devel-0.27.0-2.el7_6', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'exiv2-doc-0.27.0-2.el7_6', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'exiv2-libs-0.27.0-2.el7_6', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'exiv2-devel-0.27.0-2.el7_6', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'exiv2-doc-0.27.0-2.el7_6', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'exiv2-doc-0.27.0-2.el7_6', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
