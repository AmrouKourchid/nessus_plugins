...
# SUSE update advisory SUSE-SU-2021:2453-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2021:2453-1");

  script_name(english:"SUSE SLES12 Security Update : kernel (Live Patch 13 for SLE 12 SP5) (SUSE-SU-2021:2453-1)");
...
the SUSE-SU-2021:2453-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2021-July/009202.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?77cad14e");
  script_set_attribute(attribute:"solution", value:
"Update the affected kgraft-patch-4_12_14-122_54-default package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:suse_linux:kgraft-patch-4_12_14-122_54-default");
...
var pkgs = [
    {'reference':'kgraft-patch-4_12_14-122_54-default-8-2.2', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.5']}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kgraft-patch-4_12_14-122_54-default');
}
