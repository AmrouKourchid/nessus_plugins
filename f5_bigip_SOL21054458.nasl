...
affected by a vulnerability as referenced in the K21054458 advisory.
    ...
    content in the response.(CVE-2017-7656)ImpactPrivilege escalation is possible, as the pipelined request
    would bypass the authorization.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K21054458");
