...
# SUSE update advisory SUSE-SU-2022:2620-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:2620-1");

  script_name(english:"SUSE SLED15 / SLES15 Security Update : gimp (SUSE-SU-2022:2620-1)");
...
vulnerability as referenced in the SUSE-SU-2022:2620-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-August/011735.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?abf3d7b3");
  script_set_attribute(attribute:"solution", value:
"Update the affected gimp-plugins-python package.");
...
var pkgs = [
    {'reference':'gimp-plugins-python-2.10.12-150200.3.9.1', 'sp':'3', 'cpu':'x86_64', 'release':'SLED_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.3']},
    {'reference':'gimp-plugins-python-2.10.12-150200.3.9.1', 'sp':'3', 'cpu':'x86_64', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.3']},
    {'reference':'gimp-plugins-python-2.10.12-150200.3.9.1', 'sp':'3', 'cpu':'x86_64', 'release':'SLED15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-we-release-15.3', 'sled-release-15.3', 'sles-release-15.3']},
    {'reference':'gimp-plugins-python-2.10.12-150200.3.9.1', 'sp':'3', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-we-release-15.3', 'sled-release-15.3', 'sles-release-15.3']}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'gimp-plugins-python');
}
