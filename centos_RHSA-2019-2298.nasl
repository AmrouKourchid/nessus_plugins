...
# extracted from Red Hat Security Advisory RHSA-2019:2298 and 
# CentOS Errata and Security Advisory 2019:2298 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : libarchive (CESA-2019:2298)");
...
Enterprise Linux 7.7 Release Notes linked from the References section.");
  # https://lists.centos.org/pipermail/centos-cr-announce/2019-August/005938.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3cc66594");
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"bsdcpio-3.1.2-12.el7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"bsdtar-3.1.2-12.el7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"libarchive-3.1.2-12.el7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"libarchive-devel-3.1.2-12.el7")) flag++;
