...
if (description)
{
  ...
  script_cve_id("CVE-2022-23303", "CVE-2023-52160");

  script_name(english:"RHEL 8 : wpa_supplicant (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-23303");
