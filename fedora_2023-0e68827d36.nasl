...
# extracted from Fedora Security Advisory FEDORA-2023-0e68827d36
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-0e68827d36");

  script_name(english:"Fedora 38 : mingw-qt5-qtbase (2023-0e68827d36)");
...
FEDORA-2023-0e68827d36 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-0e68827d36");
  script_set_attribute(attribute:"solution", value:
"Update the affected mingw-qt5-qtbase package.");
...
var pkgs = [
    {'reference':'mingw-qt5-qtbase-5.15.10-4.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
