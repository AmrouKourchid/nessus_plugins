...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Binutils PHSA-2019-2.0-0167");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'binutils-2.31-6.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'binutils-debuginfo-2.31-6.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'binutils-devel-2.31-6.ph2')) flag++;
