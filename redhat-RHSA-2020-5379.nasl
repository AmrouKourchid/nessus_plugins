...
# extracted from Red Hat Security Advisory RHSA-2020:5379. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:5379");

  script_name(english:"RHEL 7 : mariadb-galera (RHSA-2020:5379)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for mariadb-galera.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2020:5379 advisory.
    ...
    * mariadb-galera: mariadb: Insufficient SST method name check leading to code injection in mysql-wsrep
    (CVE-2020-15180)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_5379.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ad9a1abb");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:5379");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1894919");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL mariadb-galera package based on the guidance in RHSA-2020:5379.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'mariadb-galera-common-5.5.62-2.el7ost', 'cpu':'x86_64', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'},
      {'reference':'mariadb-galera-server-5.5.62-2.el7ost', 'cpu':'x86_64', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'}
    ]
  }
];
