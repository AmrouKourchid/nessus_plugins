...
if (description)
{
  ...
  script_name(english:"SUSE Enterprise Linux SEoL (12.0.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of SUSE Enterprise Linux is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, SUSE Enterprise Linux is 12.0.x. It is, therefore, no longer maintained by its vendor or
provider.
...
"Upgrade to a version of SUSE Enterprise Linux that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2016/06/30");
...
var constraints = [
  { max_branch : '12.0', min_branch : '12.0', seol : 20160630, eseol : 20190701 }
];
