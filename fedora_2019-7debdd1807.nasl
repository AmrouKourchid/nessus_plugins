...
# extracted from Fedora Security Advisory FEDORA-2019-7debdd1807.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : ghostscript (2019-7debdd1807)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-7debdd1807");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"ghostscript-9.27-2.fc29")) flag++;
