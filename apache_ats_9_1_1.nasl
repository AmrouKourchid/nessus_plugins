...
if (description)
{
  ...
  script_name(english:"Apache Traffic Server 8.x < 8.1.3 / 9.x < 9.1.1 Multiple Vulnerabilities");
...
"According to its self reported version, the remote Apache Traffic Server install is affected by multiple vulnerabilities.
  ...
  - Buffer Copy without Checking Size of Input ('Classic Buffer Overflow') vulnerability in the stats-over-http plugin
    of Apache Traffic Server allows an attacker to overwrite memory. This issue affects Apache Traffic Server 9.1.0.
    (CVE-2021-43082)

  - Improper Input Validation vulnerability in accepting socket connections in Apache Traffic Server allows an attacker
    to make the server stop accepting new connections. (CVE-2021-41585)
...
"Upgrade to Apache Traffic Server version 8.1.3, 9.1.1 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-43082");
...
var constraints = [
  ...
  { 'min_version':'9.0', 'fixed_version' : '9.1.1' }
];
