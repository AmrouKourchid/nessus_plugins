...
if (description)
{
  ...
  script_name(english:"Foxit PDF Editor < 13.1.2 Vulnerability");
...
Windows host is prior to 13.1.2. It is, therefore affected by vulnerability:
...
"Upgrade to Foxit PDF Editor version 13.1.2 or later");
...
var constraints = [
  { 'max_version' : '11.2.9.53938', 'fixed_version' : '13.1.2' },
  { 'min_version' : '12.0', 'max_version' : '12.1.6.15509', 'fixed_version' : '13.1.2' },
  { 'min_version' : '13.0', 'max_version' : '13.1.1.22432', 'fixed_version' : '13.1.2' }
];
