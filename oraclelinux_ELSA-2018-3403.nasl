...
# extracted from Oracle Linux Security Advisory ELSA-2018-3403.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : thunderbird (ELSA-2018-3403)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2018-3403.html");
...
var pkgs = [
    {'reference':'thunderbird-60.2.1-5.0.1.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
