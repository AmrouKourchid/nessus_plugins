...
# extracted from Fedora Security Advisory FEDORA-2024-fd57a07560
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-fd57a07560");

  script_name(english:"Fedora 41 : oath-toolkit (2024-fd57a07560)");
...
FEDORA-2024-fd57a07560 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-fd57a07560");
...
var pkgs = [
    {'reference':'oath-toolkit-2.6.12-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
