...
# extracted from Red Hat Security Advisory RHSA-2022:2190. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:2190");

  script_name(english:"RHEL 7 : podman (RHSA-2022:2190)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for podman.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2022:2190 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_2190.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e52defb3");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:2190");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2070368");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL podman package based on the guidance in RHSA-2022:2190.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'podman-1.6.4-32.el7_9', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'podman-1.6.4-32.el7_9', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'podman-1.6.4-32.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'podman-docker-1.6.4-32.el7_9', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
