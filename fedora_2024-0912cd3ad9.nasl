...
# extracted from Fedora Security Advisory FEDORA-2024-0912cd3ad9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-0912cd3ad9");

  script_name(english:"Fedora 41 : incus (2024-0912cd3ad9)");
...
FEDORA-2024-0912cd3ad9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-0912cd3ad9");
...
var pkgs = [
    {'reference':'incus-6.8-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
