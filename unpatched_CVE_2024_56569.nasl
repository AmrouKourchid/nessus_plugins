...
if (description)
{
  ...
  script_cve_id("CVE-2024-56569");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-56569");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: ftrace: Fix regression with module
    command in stack_trace_filter When executing the following command: # echo write*:mod:ext3 >
    /sys/kernel/tracing/stack_trace_filter The current mod command causes a null pointer dereference. While
    commit 0f17976568b3f (ftrace: Fix regression with module command in stack_trace_filter) has addressed
    part of the issue, it left a corner case unhandled, which still results in a kernel crash.
    (CVE-2024-56569)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-56569");
