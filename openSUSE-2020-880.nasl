...
# extracted from openSUSE Security Update openSUSE-2020-880.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : mercurial (openSUSE-2020-880)");
...
Security issue fixed :
  ...
  - CVE-2019-3902: Fixed incorrect patch-checking with
    symlinks and subrepos (bsc#1133035).

This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1133035");
...
if ( rpm_check(release:"SUSE15.2", reference:"mercurial-4.5.2-lp152.7.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"mercurial-debuginfo-4.5.2-lp152.7.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"mercurial-debugsource-4.5.2-lp152.7.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"mercurial-lang-4.5.2-lp152.7.3.1") ) flag++;
