...
# SUSE update advisory SUSE-SU-2021:14759-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2021:14759-1");

  script_name(english:"SUSE SLES11 Security Update : arpwatch (SUSE-SU-2021:14759-1)");
...
in the SUSE-SU-2021:14759-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2021-June/009093.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3edbdedd");
...
var pkgs = [
    {'reference':'arpwatch-2.1a15-131.23.2.6.1', 'sp':'4', 'release':'SLES_SAP11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-11.4']},
    {'reference':'arpwatch-2.1a15-131.23.2.6.1', 'sp':'4', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.4']}
];
