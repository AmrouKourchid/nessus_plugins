...
# extracted from Fedora Security Advisory FEDORA-2020-2e7d30f7aa.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : python-django (2020-2e7d30f7aa)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-2e7d30f7aa");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"python-django-2.2.13-1.fc31")) flag++;
