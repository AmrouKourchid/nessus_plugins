...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : Moderate: / libpng (ELSA-2007-0356)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2007-0356.html");
...
"Update the affected libpng and / or libpng-devel packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2007-2445");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2006-5793");
...
var pkgs = [
    {'reference':'libpng-1.2.10-7.0.2', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'libpng-devel-1.2.10-7.0.2', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'libpng-1.2.10-7.0.2', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'libpng-devel-1.2.10-7.0.2', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
