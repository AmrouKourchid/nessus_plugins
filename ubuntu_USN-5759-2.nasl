...
# extracted from Ubuntu Security Notice USN-5759-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5759-2");

  script_name(english:"Ubuntu 20.04 ESM : LibBPF vulnerabilities (USN-5759-2)");
...
the USN-5759-2 advisory.

    USN-5759-1 fixed vulnerabilities in LibBPF. This update provides the corresponding updates for Ubuntu
    20.04 ESM.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5759-2");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'libbpf-dev', 'pkgver': '1:0.5.0-1~ubuntu20.04.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '20.04', 'pkgname': 'libbpf0', 'pkgver': '1:0.5.0-1~ubuntu20.04.1+esm1', 'ubuntu_pro': TRUE}
];
