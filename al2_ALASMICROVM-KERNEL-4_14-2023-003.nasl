...
# extracted from Amazon Linux 2 Security Advisory ALASMICROVM-KERNEL-4.14-2023-003.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : microvm-kernel (ALASMICROVM-KERNEL-4.14-2023-003)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of microvm-kernel installed on the remote host is prior to 4.14.246-200.474. It is, therefore, affected by
multiple vulnerabilities as referenced in the ALAS2MICROVM-KERNEL-4.14-2023-003 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALASMICROVM-KERNEL-4.14-2023-003.html");
...
var pkgs = [
    {'reference':'microvm-kernel-4.14.246-200.474.amzn2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'microvm-kernel-4.14'},
    {'reference':'microvm-kernel-4.14.246-200.474.amzn2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'microvm-kernel-4.14'},
    {'reference':'microvm-kernel-debuginfo-4.14.246-200.474.amzn2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'microvm-kernel-4.14'},
    {'reference':'microvm-kernel-debuginfo-4.14.246-200.474.amzn2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'microvm-kernel-4.14'},
    {'reference':'microvm-kernel-debuginfo-common-aarch64-4.14.246-200.474.amzn2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'microvm-kernel-4.14'},
    {'reference':'microvm-kernel-debuginfo-common-x86_64-4.14.246-200.474.amzn2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'microvm-kernel-4.14'},
    {'reference':'microvm-kernel-devel-4.14.246-200.474.amzn2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'microvm-kernel-4.14'},
    {'reference':'microvm-kernel-devel-4.14.246-200.474.amzn2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'microvm-kernel-4.14'},
    {'reference':'microvm-kernel-headers-4.14.246-200.474.amzn2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'microvm-kernel-4.14'},
    {'reference':'microvm-kernel-headers-4.14.246-200.474.amzn2', 'cpu':'i686', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'microvm-kernel-4.14'},
    {'reference':'microvm-kernel-headers-4.14.246-200.474.amzn2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'microvm-kernel-4.14'}
];
