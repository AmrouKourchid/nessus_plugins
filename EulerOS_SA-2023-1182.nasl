...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.0 : qemu (EulerOS-SA-2023-1182)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1182
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?244ae00b");
...
var pkgs = [
  "qemu-4.1.0-2.10.0.5.508",
  "qemu-img-4.1.0-2.10.0.5.508"
];
