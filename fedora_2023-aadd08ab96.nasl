...
# extracted from Fedora Security Advisory FEDORA-2023-aadd08ab96
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-aadd08ab96");
  script_xref(name:"IAVA", value:"2023-A-0526-S");

  script_name(english:"Fedora 36 : containerd (2023-aadd08ab96)");
...
FEDORA-2023-aadd08ab96 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-aadd08ab96");
...
var pkgs = [
    {'reference':'containerd-1.6.19-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
