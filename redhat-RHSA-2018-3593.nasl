...
# extracted from Red Hat Security Advisory RHSA-2018:3593. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:3593");

  script_name(english:"RHEL 7 : Red Hat Single Sign-On 7.2.5 on RHEL 7 (RHSA-2018:3593)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for Red Hat Single Sign-On 7.2.5 on RHEL 7.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2018:3593 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2018/rhsa-2018_3593.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?28eb1491");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:3593");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/JBEAP-15588");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat Single Sign-On 7.2.5 on RHEL 7 package based on the guidance in RHSA-2018:3593.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-sso7-keycloak-3.4.14-1.Final_redhat_00001.1.jbcs.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-sso'},
      {'reference':'rh-sso7-keycloak-server-3.4.14-1.Final_redhat_00001.1.jbcs.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-sso'}
    ]
  }
];
