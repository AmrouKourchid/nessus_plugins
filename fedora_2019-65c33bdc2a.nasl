...
# extracted from Fedora Security Advisory FEDORA-2019-65c33bdc2a.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : radare2 (2019-65c33bdc2a)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"New build after fixing BuildRequires
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-65c33bdc2a");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"radare2-3.9.0-3.fc29.1")) flag++;
