...
# extracted from Fedora Security Advisory FEDORA-2019-befe3bd225.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-befe3bd225");

  script_name(english:"Fedora 30 : mupdf (2019-befe3bd225)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-befe3bd225");
...
"Update the affected mupdf package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-6131");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"mupdf-1.15.0-1.fc30")) flag++;
