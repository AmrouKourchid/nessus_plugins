...
# extracted from Fedora Security Advisory FEDORA-2023-e58495988e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-e58495988e");

  script_name(english:"Fedora 37 : attract-mode (2023-e58495988e)");
...
FEDORA-2023-e58495988e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-e58495988e");
...
var pkgs = [
    {'reference':'attract-mode-2.6.2-6.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
