...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Bluez PHSA-2024-4.0-0586");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'bluez-5.65-6.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'bluez-devel-5.65-6.ph4')) flag++;
