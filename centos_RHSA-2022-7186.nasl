...
# extracted from Red Hat Security Advisory RHSA-2022:7186 and
# CentOS Errata and Security Advisory 2022:7186 respectively.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : device-mapper-multipath (RHSA-2022:7186)");
...
var pkgs = [
    {'reference':'device-mapper-multipath-0.4.9-136.el7_9', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'device-mapper-multipath-0.4.9-136.el7_9', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE}
];
