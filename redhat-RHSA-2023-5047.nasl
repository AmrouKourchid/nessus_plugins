...
# extracted from Red Hat Security Advisory RHSA-2023:5047. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:5047");

  script_name(english:"RHEL 9 : flac (RHSA-2023:5047)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_5047.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5f085023");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2235489");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:5047");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL flac package based on the guidance in RHSA-2023:5047.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'flac-1.3.3-9.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'flac-devel-1.3.3-9.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'flac-libs-1.3.3-9.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
