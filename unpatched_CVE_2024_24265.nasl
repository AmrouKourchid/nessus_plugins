...
if (description)
{
  ...
  script_cve_id("CVE-2024-24265");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-24265");
...
patch available.
  ...
  - gpac v2.2.1 was discovered to contain a memory leak via the dst_props variable in the
    gf_filter_pid_merge_properties_internal function. (CVE-2024-24265)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-24265");
