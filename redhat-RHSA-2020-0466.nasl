...
# extracted from Red Hat Security Advisory RHSA-2020:0466. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_0466.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7b8e89ad");
...
"Update the RHEL nss-softokn package based on the guidance in RHSA-2020:0466.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'nss-softokn-3.14.3-23.el6_6', 'sp':'6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nss-softokn-3.14.3-23.el6_6', 'sp':'6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nss-softokn-devel-3.14.3-23.el6_6', 'sp':'6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nss-softokn-devel-3.14.3-23.el6_6', 'sp':'6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nss-softokn-freebl-3.14.3-23.el6_6', 'sp':'6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nss-softokn-freebl-3.14.3-23.el6_6', 'sp':'6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nss-softokn-freebl-devel-3.14.3-23.el6_6', 'sp':'6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nss-softokn-freebl-devel-3.14.3-23.el6_6', 'sp':'6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
