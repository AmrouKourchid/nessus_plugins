...
# extracted from Fedora Security Advisory FEDORA-2024-2e26eccfcb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-2e26eccfcb");

  script_name(english:"Fedora 39 : unbound (2024-2e26eccfcb)");
...
FEDORA-2024-2e26eccfcb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-2e26eccfcb");
...
var pkgs = [
    {'reference':'unbound-1.19.1-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
