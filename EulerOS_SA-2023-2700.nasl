...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : ntp (EulerOS-SA-2023-2700)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the ntp packages installed, the EulerOS installation on the remote host is affected by the
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2700
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7ab53d61");
