...
# extracted from Fedora Security Advisory FEDORA-2018-078b082cbe.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-078b082cbe");

  script_name(english:"Fedora 28 : libgxps (2018-078b082cbe)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-078b082cbe");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"libgxps-0.3.0-4.fc28")) flag++;
