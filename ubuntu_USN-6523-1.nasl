...
# extracted from Ubuntu Security Notice USN-6523-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6523-1");

  script_name(english:"Ubuntu 22.04 LTS / 23.04 : u-boot-nezha vulnerability (USN-6523-1)");
...
referenced in the USN-6523-1 advisory.
    ...
    possibly execute arbitrary code. (CVE-2022-30552, CVE-2022-30790)

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6523-1");
  script_set_attribute(attribute:"solution", value:
"Update the affected u-boot-nezha package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:u-boot-nezha");
...
var pkgs = [
    {'osver': '22.04', 'pkgname': 'u-boot-nezha', 'pkgver': '2022.04+git20220405.7446a472-0ubuntu0.4'},
    {'osver': '23.04', 'pkgname': 'u-boot-nezha', 'pkgver': '2022.10-1089-g528ae9bc6c-0ubuntu1.23.04.2'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'u-boot-nezha');
}
