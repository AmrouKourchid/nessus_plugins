...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Apache PHSA-2016-0011");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-6817");
...
if (rpm_check(release:'PhotonOS-1.0', reference:'apache-tomcat-8.5.8-1.ph1')) flag++;
