...
# extracted from Red Hat Security Advisory RHSA-2024:2727. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2727");

  script_name(english:"RHEL 9 : Red Hat OpenStack Platform 17.1 (python-gunicorn) (RHSA-2024:2727)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for Red Hat OpenStack Platform 17.1 (python-gunicorn).");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2727.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4853e31a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2275280");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2727");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat OpenStack Platform 17.1 (python-gunicorn) package based on the guidance in RHSA-2024:2727.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-gunicorn-20.0.4-7.el9ost', 'release':'9', 'el_string':'el9ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
