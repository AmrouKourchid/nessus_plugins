...
# extracted from Fedora Security Advisory FEDORA-2024-5d8f4f86b0
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-5d8f4f86b0");

  script_name(english:"Fedora 38 : chromium (2024-5d8f4f86b0)");
...
FEDORA-2024-5d8f4f86b0 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-5d8f4f86b0");
...
var pkgs = [
    {'reference':'chromium-124.0.6367.60-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
