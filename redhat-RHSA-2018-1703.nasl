...
# extracted from Red Hat Security Advisory RHSA-2018:1703. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:1703");
  script_xref(name:"IAVA", value:"2018-A-0202");

  script_name(english:"RHEL 7 : librelp (RHSA-2018:1703)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for librelp.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2018:1703 advisory.

  - librelp: Stack-based buffer overflow in relpTcpChkPeerName function in src/tcp.c (CVE-2018-1000140)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_1703.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2264b6bc");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:1703");
...
"Update the RHEL librelp package based on the guidance in RHSA-2018:1703.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'librelp-1.2.0-4.el7_2', 'sp':'2', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'librelp-1.2.0-4.el7_2', 'sp':'2', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'librelp-devel-1.2.0-4.el7_2', 'sp':'2', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'librelp-devel-1.2.0-4.el7_2', 'sp':'2', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
