...
# extracted from Red Hat Security Advisory RHSA-2022:1808. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:1808");

  script_name(english:"RHEL 8 : aspell (RHSA-2022:1808)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for aspell.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2022:1808 advisory.

    GNU Aspell is a spell checker designed to eventually replace Ispell. It can either be used as a library or
    as an independent spell checker.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_1808.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?79abbda7");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/8.6_release_notes/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9341665d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:1808");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1984066");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL aspell package based on the guidance in RHSA-2022:1808.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:aspell");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:aspell-devel");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'aspell-0.60.6.1-22.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'12'},
      {'reference':'aspell-devel-0.60.6.1-22.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'12'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'aspell / aspell-devel');
}
