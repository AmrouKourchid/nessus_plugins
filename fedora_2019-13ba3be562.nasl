...
# extracted from Fedora Security Advisory FEDORA-2019-13ba3be562.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : poppler (2019-13ba3be562)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-13ba3be562");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"poppler-0.62.0-20.fc28")) flag++;
