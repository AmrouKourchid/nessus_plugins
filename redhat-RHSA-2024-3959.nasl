...
# extracted from Red Hat Security Advisory RHSA-2024:3959. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:3959");

  script_name(english:"RHEL 9 : flatpak (RHSA-2024:3959)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_3959.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7e8d4ecd");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:3959");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL flatpak package based on the guidance in RHSA-2024:3959.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'flatpak-1.12.9-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'flatpak-devel-1.12.9-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'flatpak-libs-1.12.9-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'flatpak-selinux-1.12.9-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'flatpak-session-helper-1.12.9-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'flatpak-1.12.9-1.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'flatpak-devel-1.12.9-1.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'flatpak-libs-1.12.9-1.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'flatpak-selinux-1.12.9-1.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'flatpak-session-helper-1.12.9-1.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'flatpak / flatpak-devel / flatpak-libs / flatpak-selinux / etc');
}
