...
if (description)
{
  ...
  script_name(english:"AIX 7.2 TL 5 : lpd (IJ30447)");
  script_summary(english:"Check for APAR IJ30447");
...
if (aix_check_ifix(release:"7.2", ml:"05", sp:"00", patch:"IJ30447s1a", package:"bos.rte.printers", minfilesetver:"7.2.5.0", maxfilesetver:"7.2.5.0") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"05", sp:"01", patch:"IJ30447s1a", package:"bos.rte.printers", minfilesetver:"7.2.5.0", maxfilesetver:"7.2.5.0") < 0) flag++;
