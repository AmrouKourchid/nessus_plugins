...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : tar (EulerOS-SA-2019-1346)");
...
vulnerability :
  ...
  - tar: Infinite read loop in sparse_dump_region function
    in sparse.c.(CVE-2018-20482)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1346
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?42c7abe6");
