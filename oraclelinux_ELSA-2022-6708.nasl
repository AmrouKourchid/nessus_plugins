...
# extracted from Oracle Linux Security Advisory ELSA-2022-6708.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : thunderbird (ELSA-2022-6708)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2022-6708.html");
...
var pkgs = [
    {'reference':'thunderbird-102.3.0-3.0.1.el8_6', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'thunderbird-102.3.0-3.0.1.el8_6', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
