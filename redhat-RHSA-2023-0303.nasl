...
# extracted from Red Hat Security Advisory RHSA-2023:0303. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:0303");

  script_name(english:"RHEL 9 : usbguard (RHSA-2023:0303)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_0303.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?74fc80cb");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:0303");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2058465");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL usbguard package based on the guidance in RHSA-2023:0303.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'usbguard-1.0.0-10.el9_1.2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'usbguard-dbus-1.0.0-10.el9_1.2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'usbguard-notifier-1.0.0-10.el9_1.2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'usbguard-selinux-1.0.0-10.el9_1.2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'usbguard-tools-1.0.0-10.el9_1.2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
