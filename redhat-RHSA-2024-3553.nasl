...
# extracted from Red Hat Security Advisory RHSA-2024:3553. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:3553");

  script_name(english:"RHEL 8 : nodejs : (RHSA-2024:3553)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for nodejs :.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:3553 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_3553.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f3d33374");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:3553");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL nodejs : package based on the guidance in RHSA-2024:3553.");
  ...
  'nodejs:16': [
    {
      ...
      'pkgs': [
        {'reference':'nodejs-16.20.2-5.module+el8.6.0+21811+5a4561ff', 'sp':'6', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-16.20.2-5.module+el8.6.0+21811+5a4561ff', 'sp':'6', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-devel-16.20.2-5.module+el8.6.0+21811+5a4561ff', 'sp':'6', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-devel-16.20.2-5.module+el8.6.0+21811+5a4561ff', 'sp':'6', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-docs-16.20.2-5.module+el8.6.0+21811+5a4561ff', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-full-i18n-16.20.2-5.module+el8.6.0+21811+5a4561ff', 'sp':'6', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-full-i18n-16.20.2-5.module+el8.6.0+21811+5a4561ff', 'sp':'6', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        ...
        {'reference':'npm-8.19.4-1.16.20.2.5.module+el8.6.0+21811+5a4561ff', 'sp':'6', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'npm-8.19.4-1.16.20.2.5.module+el8.6.0+21811+5a4561ff', 'sp':'6', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
      ]
    }
  ]
};
