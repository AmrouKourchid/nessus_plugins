...
# extracted from SUSE update advisory SUSE-SU-2020:3842-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : spice (SUSE-SU-2020:3842-1)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e0094828");
...
zypper in -t patch SUSE-OpenStack-Cloud-7-2020-3842=1

SUSE Linux Enterprise Server for SAP 12-SP2 :

zypper in -t patch SUSE-SLE-SAP-12-SP2-2020-3842=1

SUSE Linux Enterprise Server 12-SP2-LTSS :

zypper in -t patch SUSE-SLE-SERVER-12-SP2-2020-3842=1

SUSE Linux Enterprise Server 12-SP2-BCL :

zypper in -t patch SUSE-SLE-SERVER-12-SP2-BCL-2020-3842=1");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"libspice-server1-0.12.7-10.9.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"libspice-server1-debuginfo-0.12.7-10.9.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"spice-debugsource-0.12.7-10.9.1")) flag++;
