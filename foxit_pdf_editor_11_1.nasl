...
if (description)
{
  ...
  script_name(english:"Foxit PDF Editor < 11.1 Multiple Vulnerabilities");
...
"Upgrade to Foxit PDF Editor version 11.1 or later");
...
var constraints = [
  { 'max_version' : '10.1.5.37672', 'fixed_version' : '11.1' },
  { 'min_version' : '11.0.0.49893', 'fixed_version' : '11.1' },
  { 'min_version' : '11.0.1.49938', 'fixed_version' : '11.1' }
];
