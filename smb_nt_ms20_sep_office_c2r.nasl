...
if (description)
{
  ...
  script_name(english:"Security Updates for Microsoft Office Products C2R (September 2020)");
...
var bulletin = 'MS20-09';

var app_info = vcf::microsoft::office::get_app_info(app:'Microsoft Office');

var constraints = [
  
    {'product':'Microsoft Office 2016','file':'graph.exe','fixed_version':'16.0.12527.21104','channel': 'Deferred','channel_version': '2002'},
    {'product':'Microsoft Office 2016','file':'graph.exe','fixed_version':'16.0.11929.20946','channel': 'Deferred'},
    {'product':'Microsoft Office 2016','file':'graph.exe','fixed_version':'16.0.13001.20648','channel': 'Enterprise Deferred'},
    {'product':'Microsoft Office 2016','file':'graph.exe','fixed_version':'16.0.13029.20534','channel': 'Enterprise Deferred','channel_version': '2007'},
    {'product':'Microsoft Office 2016','file':'graph.exe','fixed_version':'16.0.12527.21104','channel': 'Microsoft 365 Apps on Windows 7'},
    {'product':'Microsoft Office 2016','file':'graph.exe','fixed_version':'16.0.12527.21104','channel': 'First Release for Deferred'},
    {'product':'Microsoft Office 2016','file':'graph.exe','fixed_version':'16.0.13127.20408','channel': '2016 Retail'},
    {'product':'Microsoft Office 2016','file':'graph.exe','fixed_version':'16.0.13127.20408','channel': 'Current'},
    {'product':'Microsoft Office 2019','file':'graph.exe','fixed_version':'16.0.12527.21104','channel': '2019 Retail'},
    {'product':'Microsoft Office 2019','file':'graph.exe','fixed_version':'16.0.12527.21104','channel': '2019 Retail','channel_version': '2002'},
    {'product':'Microsoft Office 2019','file':'graph.exe','fixed_version':'16.0.13127.20408','channel': '2019 Retail','channel_version': '2004'},
    {'product':'Microsoft Office 2019','file':'graph.exe','fixed_version':'16.0.10366.20016','channel': '2019 Volume'}
];
