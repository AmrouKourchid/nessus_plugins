...
if (description)
{
  ...
  script_name(english:"AIX 7.3 TL 0 : zlib (IJ46030)");
  script_summary(english:"Check for APAR IJ46030");
...
if (aix_check_ifix(release:"7.3", ml:"00", patch:"IJ46030m3a", package:"zlibNX.rte", minfilesetver:"7.3.0.0", maxfilesetver:"7.3.0.2") < 0) flag++;
