...
if (description)
{
  ...
  script_cve_id("CVE-2022-49188");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-49188");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: remoteproc: qcom_q6v5_mss: Fix some
    leaks in q6v5_alloc_memory_region The device_node pointer is returned by of_parse_phandle() or
    of_get_child_by_name() with refcount incremented. We should use of_node_put() on it when done. This
    function only call of_node_put(node) when of_address_to_resource succeeds, missing error cases.
    (CVE-2022-49188)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-49188");
