...
if (description)
{
  ...
  script_name(english:"Apache Tomcat 7.0.0 < 7.0.47 multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Apache Tomcat server is affected by multiple vulnerabilities");
  script_set_attribute(attribute:"description", value:
"The version of Tomcat installed on the remote host is prior to 7.0.47. It is, therefore, affected by a vulnerability as
referenced in the fixed_in_apache_tomcat_7.0.47_security-7 advisory.
...
number.");
  # https://tomcat.apache.org/security-7.html#Fixed_in_Apache_Tomcat_7.0.47
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a7064582");
  script_set_attribute(attribute:"see_also", value:"https://svn.apache.org/viewvc?view=rev&rev=1521854");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Apache Tomcat version 7.0.47 or later.");
...
var constraints = [
  { 'min_version' : '7.0.0', 'max_version' : '7.0.42', 'fixed_version' : '7.0.47' }
];
