...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : python-jinja2 (EulerOS-SA-2024-2092)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2092
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7d7b9d4a");
...
var pkgs = [
  "python3-jinja2-3.0.3-1.h3.eulerosv2r11"
];
