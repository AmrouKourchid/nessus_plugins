...
if (description)
{
  ...
  script_cve_id("CVE-2019-15268", "CVE-2019-15269");
  script_xref(name:"CISCO-BUG-ID", value:"CSCvq53902");
  script_xref(name:"CISCO-BUG-ID", value:"CSCvq53915");
  script_xref(name:"CISCO-SA", value:"cisco-sa-20191016-firepwr-xss");

  script_name(english:"Cisco Firepower Management Center Multiple Cross-Site Scripting Vulnerabilities (cisco-sa-20191016-firepwr-xss)");

  script_set_attribute(attribute:"synopsis", value:
"The remote device is missing a vendor-supplied security patch");
  script_set_attribute(attribute:"description", value:
"According to its self-reported version, Cisco Firepower 
  Management Center is affected by multiple cross-site scripting (XSS) vulnerabilities due to improper validation of 
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c082a447");
  script_set_attribute(attribute:"see_also", value:"https://bst.cloudapps.cisco.com/bugsearch/bug/CSCvq53902");
  script_set_attribute(attribute:"see_also", value:"https://bst.cloudapps.cisco.com/bugsearch/bug/CSCvq53915");
  script_set_attribute(attribute:"solution", value:
"Upgrade to the relevant fixed version referenced in Cisco bug IDs 
  CSCvq53902, CSCvq53915");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:S/C:N/I:P/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:H/UI:R/S:C/C:L/I:L/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-15269");
