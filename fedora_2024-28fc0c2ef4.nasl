...
# extracted from Fedora Security Advisory FEDORA-2024-28fc0c2ef4
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-28fc0c2ef4");

  script_name(english:"Fedora 39 : yarnpkg (2024-28fc0c2ef4)");
...
FEDORA-2024-28fc0c2ef4 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-28fc0c2ef4");
...
var pkgs = [
    {'reference':'yarnpkg-1.22.21-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
