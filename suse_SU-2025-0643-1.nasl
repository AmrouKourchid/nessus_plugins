...
# SUSE update advisory SUSE-SU-2025:0643-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2024-35789", "CVE-2024-40956", "CVE-2024-53104");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2025/02/26");
  script_xref(name:"SuSE", value:"SUSE-SU-2025:0643-1");

  script_name(english:"SUSE SLES15 Security Update : kernel RT (Live Patch 0 for SLE 15 SP6) (SUSE-SU-2025:0643-1)");
...
the SUSE-SU-2025:0643-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a5ae7223");
...
var kernel_live_checks = [
  {
    'kernels': {
      '6.4.0-150600.8-rt-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-6_4_0-150600_8-rt-10-150600.3.1', 'sp':'6', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.6']}
        ]
      }
    }
  }
