...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Strongswan PHSA-2018-2.0-0086");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'strongswan-5.5.2-5.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'strongswan-debuginfo-5.5.2-5.ph2')) flag++;
