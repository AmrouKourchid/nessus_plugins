...
if (description)
{
  ...
  script_name(english:"Debian dla-3078 : kicad - security update");
...
dla-3078 advisory.
    ...
    -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3078-1                debian-lts@lists.debian.org
    https://www.debian.org/lts/security/                       Stefano Rivera
    August 20, 2022                               https://wiki.debian.org/LTS
    -------------------------------------------------------------------------

    Package        : kicad
    Version        : 5.0.2+dfsg1-1+deb10u1
