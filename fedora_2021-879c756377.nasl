...
# extracted from Fedora Security Advisory FEDORA-2021-879c756377
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-879c756377");

  script_name(english:"Fedora 33 : kernel (2021-879c756377)");
...
FEDORA-2021-879c756377 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-879c756377");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for FEDORA-2021-879c756377');
  }
  else
  {
...
pkgs = [
    {'reference':'kernel-5.10.12-200.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
