...
# extracted from Debian Security Advisory DLA-2220-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2220-1 : cracklib2 security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2020/05/msg00023.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/jessie/cracklib2");
...
"Upgrade the affected packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:libcrack2-udeb");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"cracklib-runtime", reference:"2.9.2-1+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"libcrack2", reference:"2.9.2-1+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"libcrack2-dev", reference:"2.9.2-1+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"libcrack2-udeb", reference:"2.9.2-1+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"python-cracklib", reference:"2.9.2-1+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"python3-cracklib", reference:"2.9.2-1+deb8u1")) flag++;
