...
# SUSE update advisory SUSE-SU-2019:14215-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2019:14215-1");

  script_name(english:"SUSE SLES11 Security Update : tar (SUSE-SU-2019:14215-1)");
...
the SUSE-SU-2019:14215-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1152736");
  # https://lists.suse.com/pipermail/sle-security-updates/2019-November/006107.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dc99053e");
...
pkgs = [
    {'reference':'tar-1.27.1-14.8', 'sp':'4', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'SLES_SAP-release-11.4'},
    {'reference':'tar-1.27.1-14.8', 'sp':'4', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'sles-release-11.4'}
];
