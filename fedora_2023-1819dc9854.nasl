...
# extracted from Fedora Security Advisory FEDORA-2023-1819dc9854
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-1819dc9854");
  script_xref(name:"IAVB", value:"2023-B-0080-S");

  script_name(english:"Fedora 37 : golang (2023-1819dc9854)");
...
FEDORA-2023-1819dc9854 advisory.

    This update includes a security fix to the crypto/tls package, as well as bug fixes to the assembler and
    the compiler.

    ----

    This update includes a security fix to the net/http package, as well as bug fixes to the compiler, cgo,
    the cover tool, the go command, the runtime, and the crypto/ecdsa, go/build, go/printer, net/mail, and
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-1819dc9854");
...
var pkgs = [
    {'reference':'golang-1.19.12-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
