...
# extracted from Fedora Security Advisory FEDORA-2018-d4349a7ba3.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : icecast (2018-d4349a7ba3)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-d4349a7ba3");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"icecast-2.4.4-1.fc28")) flag++;
