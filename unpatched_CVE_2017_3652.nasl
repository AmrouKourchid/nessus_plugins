...
if (description)
{
  ...
  script_cve_id("CVE-2017-3652");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2017-3652");
...
patch available.
  ...
  - Vulnerability in the MySQL Server component of Oracle MySQL (subcomponent: Server: DDL). Supported
    ...
    subset of MySQL Server accessible data. (CVE-2017-3652)
