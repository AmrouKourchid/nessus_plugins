...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5030278");
  script_xref(name:"MSKB", value:"5030279");
  script_xref(name:"MSFT", value:"MS23-5030278");
  script_xref(name:"MSFT", value:"MS23-5030279");
  script_xref(name:"IAVA", value:"2023-A-0472-S");
  script_xref(name:"IAVA", value:"2023-A-0471-S");

  script_name(english:"KB5030279: Windows Server 2012 Security Update (September 2023)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5030279. It is, therefore, affected by multiple vulnerabilities
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5030278");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5030279");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5030279 or Cumulative Update 5030278");
...
if (
  smb_check_rollup(os:'6.2',
                   ...
                   rollup_date:'09_2023',
                   bulletin:bulletin,
                   rollup_kb_list:[5030279, 5030278])
)
{
