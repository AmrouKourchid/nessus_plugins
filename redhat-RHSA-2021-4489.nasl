...
# extracted from Red Hat Security Advisory RHSA-2021:4489. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:4489");

  script_name(english:"RHEL 8 : rpm (RHSA-2021:4489)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2021:4489 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_4489.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5efc714d");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/8.5_release_notes/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7240878e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:4489");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-rpm-4.14.3-19.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-4.14.3-19.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-apidocs-4.14.3-19.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-build-4.14.3-19.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-build-libs-4.14.3-19.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-cron-4.14.3-19.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-devel-4.14.3-19.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-libs-4.14.3-19.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-plugin-fapolicyd-4.14.3-19.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-plugin-ima-4.14.3-19.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-plugin-prioreset-4.14.3-19.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-plugin-selinux-4.14.3-19.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-plugin-syslog-4.14.3-19.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-plugin-systemd-inhibit-4.14.3-19.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-sign-4.14.3-19.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
