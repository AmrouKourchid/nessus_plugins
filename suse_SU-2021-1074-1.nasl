...
# extracted from SUSE update advisory SUSE-SU-2021:1074-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : kernel (SUSE-SU-2021:1074-1)");
...
two Geneve endpoints to be unencrypted (bsc#1177513).
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bb40122f");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"3", cpu:"x86_64", reference:"kgraft-patch-4_4_180-94_141-default-2-2.2")) flag++;
if (rpm_check(release:"SLES12", sp:"3", cpu:"x86_64", reference:"kgraft-patch-4_4_180-94_141-default-debuginfo-2-2.2")) flag++;
