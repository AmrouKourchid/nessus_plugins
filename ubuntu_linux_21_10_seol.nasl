...
if (description)
{
  ...
  script_name(english:"Canonical Ubuntu Linux SEoL (21.10.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Canonical Ubuntu Linux is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Canonical Ubuntu Linux is 21.10.x. It is, therefore, no longer maintained by its vendor or
provider.
...
contain security vulnerabilities.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6d1e1410");
...
"Upgrade to a version of Canonical Ubuntu Linux that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2022/07/14");
...
var constraints = [
  { max_branch : '21.10', min_branch : '21.10', seol : 20220714 }
];
