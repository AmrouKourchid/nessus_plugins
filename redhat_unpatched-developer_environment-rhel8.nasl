...
# extracted from Red Hat Security Advisory developer_environment. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2021-42574", "CVE-2021-42694");

  script_name(english:"RHEL 8 : developer_environment (Unpatched Vulnerability) (deprecated)");
...
"This plugin has been deprecated as it does not adhere to established standards for this style of check.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-42694");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:gcc-toolset-9-annobin");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:gcc-toolset-9-binutils");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:gcc-toolset-9-gcc");
