...
# extracted from Fedora Security Advisory FEDORA-2024-7c36291390
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-7c36291390");

  script_name(english:"Fedora 39 : cups (2024-7c36291390)");
...
FEDORA-2024-7c36291390 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-7c36291390");
...
var pkgs = [
    {'reference':'cups-2.4.10-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
