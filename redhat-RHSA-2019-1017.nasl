...
# extracted from Red Hat Security Advisory RHSA-2019:1017. The text 
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_1017.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?efb0e39f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:1017");
...
"Update the RHEL ghostscript package based on the guidance in RHSA-2019:1017.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ghostscript-9.07-31.el7_6.11', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ghostscript-cups-9.07-31.el7_6.11', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ghostscript-devel-9.07-31.el7_6.11', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ghostscript-doc-9.07-31.el7_6.11', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ghostscript-gtk-9.07-31.el7_6.11', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
