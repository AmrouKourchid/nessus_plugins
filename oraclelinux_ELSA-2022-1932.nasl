...
# extracted from Oracle Linux Security Advisory ELSA-2022-1932.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : python-lxml (ELSA-2022-1932)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2022-1932.html");
