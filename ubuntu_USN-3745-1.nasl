...
# extracted from Ubuntu Security Notice USN-3745-1. The text
...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 18.04 LTS : wpa_supplicant and hostapd vulnerability (USN-3745-1)");
...
referenced in the USN-3745-1 advisory.

    It was discovered that wpa_supplicant and hostapd incorrectly handled certain messages. An attacker could
    possibly use this to access sensitive information.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3745-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'hostapd', 'pkgver': '1:2.1-0ubuntu1.6'},
    {'osver': '14.04', 'pkgname': 'wpagui', 'pkgver': '2.1-0ubuntu1.6'},
    {'osver': '14.04', 'pkgname': 'wpasupplicant', 'pkgver': '2.1-0ubuntu1.6'},
    {'osver': '14.04', 'pkgname': 'wpasupplicant-udeb', 'pkgver': '2.1-0ubuntu1.6'},
    {'osver': '16.04', 'pkgname': 'hostapd', 'pkgver': '1:2.4-0ubuntu6.3'},
    {'osver': '16.04', 'pkgname': 'wpagui', 'pkgver': '2.4-0ubuntu6.3'},
    {'osver': '16.04', 'pkgname': 'wpasupplicant', 'pkgver': '2.4-0ubuntu6.3'},
    {'osver': '16.04', 'pkgname': 'wpasupplicant-udeb', 'pkgver': '2.4-0ubuntu6.3'},
    {'osver': '18.04', 'pkgname': 'hostapd', 'pkgver': '2:2.6-15ubuntu2.1'},
    {'osver': '18.04', 'pkgname': 'wpagui', 'pkgver': '2:2.6-15ubuntu2.1'},
    {'osver': '18.04', 'pkgname': 'wpasupplicant', 'pkgver': '2:2.6-15ubuntu2.1'},
    {'osver': '18.04', 'pkgname': 'wpasupplicant-udeb', 'pkgver': '2:2.6-15ubuntu2.1'}
];
