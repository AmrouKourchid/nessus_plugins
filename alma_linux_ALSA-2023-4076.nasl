...
# AlmaLinux Security Advisory ALSA-2023:4076.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:4076");
  script_xref(name:"IAVA", value:"2023-A-0328-S");

  script_name(english:"AlmaLinux 8 : firefox (ALSA-2023:4076)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2023-4076.html");
...
var pkgs = [
    {'reference':'firefox-102.13.0-2.el8_8.alma', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-102.13.0-2.el8_8.alma', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
