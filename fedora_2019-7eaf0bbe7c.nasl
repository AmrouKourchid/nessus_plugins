...
# extracted from Fedora Security Advisory FEDORA-2019-7eaf0bbe7c.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : drupal8 (2019-7eaf0bbe7c)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-7eaf0bbe7c");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"drupal8-8.6.15-1.fc29")) flag++;
