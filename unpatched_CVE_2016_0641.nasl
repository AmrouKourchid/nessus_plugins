...
if (description)
{
  ...
  script_cve_id("CVE-2016-0641");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2016-0641");
...
patch available.
  ...
  - Unspecified vulnerability in Oracle MySQL 5.5.47 and earlier, 5.6.28 and earlier, and 5.7.10 and earlier
    ...
    confidentiality and availability via vectors related to MyISAM. (CVE-2016-0641)
