...
# AlmaLinux Security Advisory ALSA-2021:1608.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2021:1608");

  script_name(english:"AlmaLinux 8 : python-cryptography (ALSA-2021:1608)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2021-1608.html");
...
"Update the affected python3-cryptography package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:python3-cryptography");
