...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.2 : netpbm (EulerOS-SA-2020-1470)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1470
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?06c3b124");
...
pkgs = ["netpbm-10.79.00-7.h2.eulerosv2r7",
        "netpbm-progs-10.79.00-7.h2.eulerosv2r7"];
