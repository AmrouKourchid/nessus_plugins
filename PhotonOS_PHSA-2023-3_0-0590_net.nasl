...
# extracted from VMware Security Advisory PHSA-2023-3.0-0590. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Net PHSA-2023-3.0-0590");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the net package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-3.0-590.md");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'net-snmp-5.8-11.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'net-snmp-devel-5.8-11.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'net-snmp-perl-5.8-11.ph3')) flag++;
