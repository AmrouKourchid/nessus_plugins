...
# extracted from F5 Networks BIG-IP Solution K78131906.
#
# @NOAGENT@
##
...
if (description)
{
  ...
  script_cve_id("CVE-2018-1301");

  script_name(english:"F5 Networks BIG-IP : Apache HTTPD vulnerability (K78131906)");

  script_set_attribute(attribute:"synopsis", value:
"The remote device is missing a vendor-supplied security patch.");
  script_set_attribute(attribute:"description", value:
"The version of F5 Networks BIG-IP installed on the remote host is prior to tested version. It is, therefore, affected by
a vulnerability as referenced in the K78131906 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K78131906");
...
Refer to the vendor for remediation guidance.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-1301");
...
var vmatrix = {
  'AFM': {
    'affected': [
      '17.0.0-17.1.1','16.0.0-16.1.4','15.0.0-15.1.10','14.0.0-14.1.5','13.0.0-13.1.5','12.1.0-12.1.5','11.2.1-11.6.5'
    ],
  },
  'AM': {
    'affected': [
