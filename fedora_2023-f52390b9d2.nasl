...
# extracted from Fedora Security Advisory FEDORA-2023-f52390b9d2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-f52390b9d2");
  script_xref(name:"IAVA", value:"2023-A-0283-S");

  script_name(english:"Fedora 38 : python3.7 (2023-f52390b9d2)");
...
FEDORA-2023-f52390b9d2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-f52390b9d2");
...
var pkgs = [
    {'reference':'python3.7-3.7.16-4.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
