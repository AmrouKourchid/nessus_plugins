...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : zlib (EulerOS-SA-2022-2673)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2673
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4677526e");
...
var pkgs = [
  "zlib-1.2.11-19.h1.eulerosv2r10"
];
