...
# extracted from VMware Security Advisory PHSA-2025-5.0-0505. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Erlang PHSA-2025-5.0-0505");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the erlang package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-5.0-505.md");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'erlang-26.2.5.10-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'erlang-sd_notify-1.1-7.ph5')) flag++;
