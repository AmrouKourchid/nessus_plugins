...
# extracted from Fedora Security Advisory FEDORA-2023-948136565a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-948136565a");
  script_xref(name:"IAVB", value:"2023-B-0067-S");

  script_name(english:"Fedora 37 : xen (2023-948136565a)");
...
FEDORA-2023-948136565a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-948136565a");
...
var pkgs = [
    {'reference':'xen-4.16.5-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
