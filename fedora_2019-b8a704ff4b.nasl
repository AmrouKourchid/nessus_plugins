...
# extracted from Fedora Security Advisory FEDORA-2019-b8a704ff4b.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-b8a704ff4b");

  script_name(english:"Fedora 29 : wavpack (2019-b8a704ff4b)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-b8a704ff4b");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"wavpack-5.1.0-13.fc29")) flag++;
