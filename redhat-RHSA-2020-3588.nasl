...
# extracted from Red Hat Security Advisory RHSA-2020:3588. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:3588");

  script_name(english:"RHEL 8 : libvncserver (RHSA-2020:3588)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_3588.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a00f1f21");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:3588");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1852356");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libvncserver package based on the guidance in RHSA-2020:3588.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libvncserver-0.9.11-9.el8_0.3', 'sp':'0', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvncserver-0.9.11-9.el8_0.3', 'sp':'0', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvncserver-0.9.11-9.el8_0.3', 'sp':'0', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
