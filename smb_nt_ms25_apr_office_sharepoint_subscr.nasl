...
if (description)
{
  ...
  script_cve_id("CVE-2025-29793", "CVE-2025-29794");
  script_xref(name:"MSKB", value:"5002705");
  script_xref(name:"MSFT", value:"MS25-5002705");
  script_xref(name:"IAVA", value:"2025-A-0242");

  script_name(english:"Security Updates for Microsoft SharePoint Server Subscription Edition (April 2025)");
...
security updates. It is, therefore, affected by multiple Remote Code Execution vulnerabilities:
  ...
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002705");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released KB5002705 to address this issue.");
