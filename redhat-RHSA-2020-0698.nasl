...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_0698.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9c64abe6");
...
"Update the RHEL kpatch-patch package based on the guidance in RHSA-2020:0698.");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  var cve_list = make_list('CVE-2018-20856');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for RHSA-2020:0698');
  }
  else
  {
