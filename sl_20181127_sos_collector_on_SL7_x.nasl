...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : sos-collector on SL7.x (noarch) (20181127)");
...
Security Fix(es) :
  ...
  - sos-collector: incorrect permissions set on newly
    created files (CVE-2018-14650)

This issue was discovered by Riccardo Schirone (Red Hat Product
Security).");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1811&L=scientific-linux-errata&F=&S=&P=14419
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a9ca6645");
...
"Update the affected sos-collector package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fermilab:scientific_linux:sos-collector");
...
flag = 0;
if (rpm_check(release:"SL7", reference:"sos-collector-1.5-3.el7_6")) flag++;
