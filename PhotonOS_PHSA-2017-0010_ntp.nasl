...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Ntp PHSA-2017-0010");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'ntp-4.2.8p10-1.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'ntp-debuginfo-4.2.8p10-1.ph1')) flag++;
