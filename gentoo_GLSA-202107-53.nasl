...
# extracted from Gentoo Linux Security Advisory GLSA 202107-53.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202107-53");

  script_name(english:"GLSA-202107-53 : Leptonica: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202107-53
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202107-53"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"media-libs/leptonica", unaffected:make_list("ge 1.80.0"), vulnerable:make_list("lt 1.80.0"))) flag++;
