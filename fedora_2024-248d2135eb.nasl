...
# extracted from Fedora Security Advisory FEDORA-2024-248d2135eb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-248d2135eb");

  script_name(english:"Fedora 38 : dotnet7.0 (2024-248d2135eb)");
...
FEDORA-2024-248d2135eb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-248d2135eb");
...
var pkgs = [
    {'reference':'dotnet7.0-7.0.115-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
