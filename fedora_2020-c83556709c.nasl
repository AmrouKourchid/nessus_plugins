...
# extracted from Fedora Security Advisory FEDORA-2020-c83556709c.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : lua (2020-c83556709c)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-c83556709c");
...
"Update the affected lua package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:lua");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"lua-5.3.5-8.fc31")) flag++;
