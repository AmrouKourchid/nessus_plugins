...
# extracted from Oracle Linux Security Advisory ELSA-2023-2645.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : openssh (ELSA-2023-2645)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-2645.html");
