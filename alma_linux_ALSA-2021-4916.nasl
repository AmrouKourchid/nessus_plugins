...
# AlmaLinux Security Advisory ALSA-2021:4916.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2021:4916");

  script_name(english:"AlmaLinux 8 : mailman:2.1 (ALSA-2021:4916)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2021-4916.html");
...
var appstreams = {
    'mailman:2.1': [
      {'reference':'mailman-2.1.29-12.module_el8.5.0+2602+327eb9f3.2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'}
    ]
};
