...
# extracted from Red Hat Security Advisory RHSA-2025:0377. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 9 : Securityes for NetworkManager (Moderate) (RHSA-2025:0377)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_0377.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5ef771bd");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'NetworkManager-1.48.10-5.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'NetworkManager-adsl-1.48.10-5.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'NetworkManager-bluetooth-1.48.10-5.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'NetworkManager-cloud-setup-1.48.10-5.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'NetworkManager-config-connectivity-redhat-1.48.10-5.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'NetworkManager-config-server-1.48.10-5.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'NetworkManager-dispatcher-routing-rules-1.48.10-5.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'NetworkManager-initscripts-updown-1.48.10-5.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'NetworkManager-libnm-1.48.10-5.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'NetworkManager-libnm-devel-1.48.10-5.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'NetworkManager-ovs-1.48.10-5.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'NetworkManager-ppp-1.48.10-5.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'NetworkManager-team-1.48.10-5.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'NetworkManager-tui-1.48.10-5.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'NetworkManager-wifi-1.48.10-5.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'NetworkManager-wwan-1.48.10-5.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
