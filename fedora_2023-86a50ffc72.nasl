...
# extracted from Fedora Security Advisory FEDORA-2023-86a50ffc72
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-86a50ffc72");

  script_name(english:"Fedora 39 : open-vm-tools (2023-86a50ffc72)");
...
FEDORA-2023-86a50ffc72 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-86a50ffc72");
...
var pkgs = [
    {'reference':'open-vm-tools-12.3.0-3.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
