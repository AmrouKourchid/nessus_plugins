...
# extracted from Fedora Security Advisory FEDORA-2019-644ef7ebec.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : graphite2 (2019-644ef7ebec)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-644ef7ebec");
  script_set_attribute(attribute:"solution", value:
"Update the affected graphite2 package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:graphite2");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"graphite2-1.3.13-1.fc30")) flag++;
