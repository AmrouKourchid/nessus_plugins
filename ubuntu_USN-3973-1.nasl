...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS : DHCP vulnerability (USN-3973-1)");
...
USN-3973-1 advisory.
    ...
    It was discovered that DHCP, when built with a mismatched external BIND library, incorrectly handled
    certain memory operations. A remote attacker could possibly use this issue to cause DHCP to crash,
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3973-1");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'isc-dhcp-client', 'pkgver': '4.3.5-3ubuntu7.1'},
    {'osver': '18.04', 'pkgname': 'isc-dhcp-client-ddns', 'pkgver': '4.3.5-3ubuntu7.1'},
    {'osver': '18.04', 'pkgname': 'isc-dhcp-client-udeb', 'pkgver': '4.3.5-3ubuntu7.1'},
    {'osver': '18.04', 'pkgname': 'isc-dhcp-common', 'pkgver': '4.3.5-3ubuntu7.1'},
    {'osver': '18.04', 'pkgname': 'isc-dhcp-dev', 'pkgver': '4.3.5-3ubuntu7.1'},
    {'osver': '18.04', 'pkgname': 'isc-dhcp-relay', 'pkgver': '4.3.5-3ubuntu7.1'},
    {'osver': '18.04', 'pkgname': 'isc-dhcp-server', 'pkgver': '4.3.5-3ubuntu7.1'},
    {'osver': '18.04', 'pkgname': 'isc-dhcp-server-ldap', 'pkgver': '4.3.5-3ubuntu7.1'}
];
