...
if (description)
{
  ...
  script_cve_id("CVE-2023-22881");

  script_name(english:"Zoom Client for Meetings < 5.13.5 Vulnerability (ZSB-23002)");
...
vulnerability as referenced in the ZSB-23002 advisory.

  - Zoom clients before version 5.13.5 contain a STUN parsing vulnerability. A malicious actor could send
    specially crafted UDP traffic to a victim Zoom client to remotely cause the client to crash, causing a
    denial of service. (CVE-2023-22881)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://explore.zoom.us/en/trust/security/security-bulletin/?filter-cve=&filter=&keywords=ZSB-23002
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fca50b2a");
...
"Upgrade to Zoom Client for Meetings 5.13.5 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-22881");
