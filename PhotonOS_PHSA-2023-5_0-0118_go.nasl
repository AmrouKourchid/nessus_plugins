...
# extracted from VMware Security Advisory PHSA-2023-5.0-0118. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Go PHSA-2023-5.0-0118");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the go package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-5.0-118.md");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'go-1.20.10-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'go-md2man-2.0.2-7.ph5')) flag++;
