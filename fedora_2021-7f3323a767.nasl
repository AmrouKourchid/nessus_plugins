...
# extracted from Fedora Security Advisory FEDORA-2021-7f3323a767
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-7f3323a767");

  script_name(english:"Fedora 33 : mingw-jasper (2021-7f3323a767)");
...
FEDORA-2021-7f3323a767 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-7f3323a767");
...
pkgs = [
    {'reference':'mingw-jasper-2.0.26-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
