...
# extracted from Fedora Security Advisory FEDORA-2023-f3ced9cffd
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-f3ced9cffd");

  script_name(english:"Fedora 38 : ImageMagick (2023-f3ced9cffd)");
...
FEDORA-2023-f3ced9cffd advisory.

    This update drops ghostscript-x11 requirement for security reasons.

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-f3ced9cffd");
...
var pkgs = [
    {'reference':'ImageMagick-7.1.1.4-3.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
