...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : lldpad (EulerOS-SA-2021-1325)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1325
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b23e82d5");
...
pkgs = ["lldpad-1.0.1-2.git986eb2e.h1"];
