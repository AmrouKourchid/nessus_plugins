...
if (description)
{
  ...
  script_name(english:"Atlassian JIRA SEoL (4.1.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Atlassian JIRA is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Atlassian JIRA is 4.1.x. It is, therefore, no longer maintained by its vendor or provider.
...
contain security vulnerabilities.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bd6e33b6");
...
"Upgrade to a version of Atlassian JIRA that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2012/06/18");
...
var constraints = [
  { max_branch : '4.1', min_branch : '4.1', seol : 20120618 }
];
