...
# extracted from F5 Networks BIG-IP Solution K000141003.
#
# @NOAGENT@
##
...
if (description)
{
  ...
  script_cve_id("CVE-2025-23412");
  script_xref(name:"IAVA", value:"2025-A-0086");

  script_name(english:"F5 Networks BIG-IP : BIG-IP APM access profile vulnerability (K000141003)");
...
by a vulnerability as referenced in the K000141003 advisory.

    When a BIG-IP APM access profile is configured on a virtual server, undisclosed requests can cause the
    Traffic Management Microkernel (TMM) to terminate.(CVE-2025-23412)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K000141003");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K000141003.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-23412");
