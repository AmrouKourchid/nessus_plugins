...
# extracted from Fedora Security Advisory FEDORA-2024-4b0d95b102
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-4b0d95b102");

  script_name(english:"Fedora 40 : pypy (2024-4b0d95b102)");
...
FEDORA-2024-4b0d95b102 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-4b0d95b102");
...
var pkgs = [
    {'reference':'pypy-7.3.16-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
