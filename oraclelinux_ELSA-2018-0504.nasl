...
# Oracle Linux Security Advisory ELSA-2018-0504 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : mailman (ELSA-2018-0504)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2018-0504.html");
