...
# extracted from Fedora Security Advisory FEDORA-2023-2c75a3bd51
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-2c75a3bd51");

  script_name(english:"Fedora 37 : digikam (2023-2c75a3bd51)");
...
FEDORA-2023-2c75a3bd51 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-2c75a3bd51");
...
var pkgs = [
    {'reference':'digikam-8.0.0-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
