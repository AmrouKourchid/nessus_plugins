...
# extracted from Debian Security Advisory DLA-2341-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2341-1 : inetutils security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"In inetutils-telnetd, an implementation of a telnet daemon, arbitrary
remote code execution might have been possible via short writes or
urgent data.
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2020/08/msg00038.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/stretch/inetutils");
...
flag = 0;
if (deb_check(release:"9.0", prefix:"inetutils-ftp", reference:"2:1.9.4-2+deb9u1")) flag++;
if (deb_check(release:"9.0", prefix:"inetutils-ftpd", reference:"2:1.9.4-2+deb9u1")) flag++;
if (deb_check(release:"9.0", prefix:"inetutils-inetd", reference:"2:1.9.4-2+deb9u1")) flag++;
if (deb_check(release:"9.0", prefix:"inetutils-ping", reference:"2:1.9.4-2+deb9u1")) flag++;
if (deb_check(release:"9.0", prefix:"inetutils-syslogd", reference:"2:1.9.4-2+deb9u1")) flag++;
if (deb_check(release:"9.0", prefix:"inetutils-talk", reference:"2:1.9.4-2+deb9u1")) flag++;
if (deb_check(release:"9.0", prefix:"inetutils-talkd", reference:"2:1.9.4-2+deb9u1")) flag++;
if (deb_check(release:"9.0", prefix:"inetutils-telnet", reference:"2:1.9.4-2+deb9u1")) flag++;
if (deb_check(release:"9.0", prefix:"inetutils-telnetd", reference:"2:1.9.4-2+deb9u1")) flag++;
if (deb_check(release:"9.0", prefix:"inetutils-tools", reference:"2:1.9.4-2+deb9u1")) flag++;
if (deb_check(release:"9.0", prefix:"inetutils-traceroute", reference:"2:1.9.4-2+deb9u1")) flag++;
