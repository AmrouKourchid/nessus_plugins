...
# extracted from Fedora Security Advisory FEDORA-2019-387e017332.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-387e017332");

  script_name(english:"Fedora 29 : poppler (2019-387e017332)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-387e017332");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"poppler-0.67.0-12.fc29")) flag++;
