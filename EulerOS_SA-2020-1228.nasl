...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.2.0 : avahi (EulerOS-SA-2020-1228)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1228
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?98a7f77a");
...
pkgs = ["avahi-0.6.31-19.h1",
        "avahi-autoipd-0.6.31-19.h1",
        "avahi-glib-0.6.31-19.h1",
        "avahi-libs-0.6.31-19.h1"];
