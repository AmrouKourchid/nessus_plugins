...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5001566");
  script_xref(name:"MSFT", value:"MS21-5001566");

  script_name(english:"KB5001566: Windows 10 1909 OOB Update (Mar 2021) (deprecated)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host is missing one or more updates.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing updates. It is, therefore, affected by multiple vulnerabilities: Note that
Nessus has not tested for this issue but has instead relied only on the application's self-reported version number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5001566");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released KB5001566 to address this issue.");
