...
# extracted from Fedora Security Advisory FEDORA-2025-6e4727185c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-6e4727185c");

  script_name(english:"Fedora 41 : jpegxl (2025-6e4727185c)");
...
FEDORA-2025-6e4727185c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-6e4727185c");
...
var pkgs = [
    {'reference':'jpegxl-0.10.4-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
