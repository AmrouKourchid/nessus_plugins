...
# extracted from Red Hat Security Advisory RHSA-2024:6001. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:6001");

  script_name(english:"RHEL 8 : postgresql:15 (RHSA-2024:6001)");
...
referenced in the RHSA-2024:6001 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_6001.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2b2a3e5a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:6001");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL postgresql:15 package based on the guidance in RHSA-2024:6001.");
  ...
  'postgresql:15': [
    {
      ...
      'pkgs': [
        ...
        {'reference':'postgresql-15.8-1.module+el8.10.0+22212+a51fe170', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-contrib-15.8-1.module+el8.10.0+22212+a51fe170', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-docs-15.8-1.module+el8.10.0+22212+a51fe170', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plperl-15.8-1.module+el8.10.0+22212+a51fe170', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plpython3-15.8-1.module+el8.10.0+22212+a51fe170', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-pltcl-15.8-1.module+el8.10.0+22212+a51fe170', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-private-devel-15.8-1.module+el8.10.0+22212+a51fe170', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-private-libs-15.8-1.module+el8.10.0+22212+a51fe170', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-15.8-1.module+el8.10.0+22212+a51fe170', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-devel-15.8-1.module+el8.10.0+22212+a51fe170', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-static-15.8-1.module+el8.10.0+22212+a51fe170', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-15.8-1.module+el8.10.0+22212+a51fe170', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-rpm-macros-15.8-1.module+el8.10.0+22212+a51fe170', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-upgrade-15.8-1.module+el8.10.0+22212+a51fe170', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-upgrade-devel-15.8-1.module+el8.10.0+22212+a51fe170', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
