...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : busybox (EulerOS-SA-2024-2546)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2546
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6d9e83eb");
...
var pkgs = [
  "busybox-1.34.1-13.h13.eulerosv2r11"
];
