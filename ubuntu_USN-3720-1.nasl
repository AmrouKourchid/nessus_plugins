...
# extracted from Ubuntu Security Notice USN-3720-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"3720-1");

  script_name(english:"Ubuntu 18.04 LTS : python-cryptography vulnerability (USN-3720-1)");
...
USN-3720-1 advisory.
    ...
    It was discovered that python-cryptography incorrectly handled certain inputs. An attacker could possibly
    use this to get access to sensitive information.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3720-1");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'python-cryptography', 'pkgver': '2.1.4-1ubuntu1.2'},
    {'osver': '18.04', 'pkgname': 'python3-cryptography', 'pkgver': '2.1.4-1ubuntu1.2'}
];
