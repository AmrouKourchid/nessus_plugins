...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS : Memcached vulnerabilities (USN-3120-1)");
...
referenced in the USN-3120-1 advisory.

    Aleksandar Nikolic discovered that Memcached incorrectly handled certain malformed commands. A remote
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3120-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'memcached', 'pkgver': '1.4.14-0ubuntu9.1'},
    {'osver': '16.04', 'pkgname': 'memcached', 'pkgver': '1.4.25-2ubuntu1.2'}
];
