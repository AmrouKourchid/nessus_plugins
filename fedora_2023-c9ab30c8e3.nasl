...
# extracted from Fedora Security Advisory FEDORA-2023-c9ab30c8e3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-c9ab30c8e3");

  script_name(english:"Fedora 36 : kernel (2023-c9ab30c8e3)");
...
FEDORA-2023-c9ab30c8e3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-c9ab30c8e3");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  var cve_list = make_list('CVE-2023-0597');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for FEDORA-2023-c9ab30c8e3');
  }
  else
  {
...
var pkgs = [
    {'reference':'kernel-6.1.9-100.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
