...
# extracted from Red Hat Security Advisory RHSA-2023:2222. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:2222");

  script_name(english:"RHEL 9 : conmon (RHSA-2023:2222)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for conmon.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_2222.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?701f172e");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/9/html/9.2_release_notes/index
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ecefa061");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2129080");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2154417");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2161274");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2173697");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:2222");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL conmon package based on the guidance in RHSA-2023:2222.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'conmon-2.1.7-1.el9_2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
    ]
  }
];
