...
# extracted from Red Hat Security Advisory RHSA-2020:4115. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:4115");
  script_xref(name:"IAVB", value:"2020-B-0063-S");
  script_xref(name:"CEA-ID", value:"CEA-2020-0061");

  script_name(english:"RHEL 7 : redhat--virtualization-host and redhat-virtualization-host (RHSA-2020:4115)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for redhat--virtualization-host / redhat-virtualization-
host.");
...
referenced in the RHSA-2020:4115 advisory.
    ...
    (4.3.11), redhat-virtualization-host (4.3.11). (BZ#1868307, BZ#1878044)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_4115.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?80ed812d");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:4115");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1825243");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1845590");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1868307");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1869201");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL redhat--virtualization-host / redhat-virtualization-host packages based on the guidance in
RHSA-2020:4115.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'redhat-virtualization-host-image-update-4.3.11-20200922.0.el7_9', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'}
    ]
  }
];
