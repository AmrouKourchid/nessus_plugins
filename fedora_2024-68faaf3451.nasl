...
# extracted from Fedora Security Advisory FEDORA-2024-68faaf3451
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-68faaf3451");
  script_xref(name:"IAVB", value:"2024-B-0126-S");

  script_name(english:"Fedora 39 : wireshark (2024-68faaf3451)");
...
FEDORA-2024-68faaf3451 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-68faaf3451");
...
var pkgs = [
    {'reference':'wireshark-4.0.17-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
