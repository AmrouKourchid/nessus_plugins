...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : perl (EulerOS-SA-2023-2432)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2432
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?af1b955d");
...
var pkgs = [
  "perl-5.16.3-292.h15.eulerosv2r7",
  "perl-core-5.16.3-292.h15.eulerosv2r7",
  "perl-devel-5.16.3-292.h15.eulerosv2r7",
  "perl-libs-5.16.3-292.h15.eulerosv2r7",
  "perl-macros-5.16.3-292.h15.eulerosv2r7"
];
