...
# extracted from Red Hat Security Advisory RHSA-2024:9977. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:9977");

  script_name(english:"RHEL 9 : RHOSP 17.1.4 (python-zipp) (RHSA-2024:9977)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for RHOSP 17.1.4 (python-zipp).");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_9977.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d21ecaff");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:9977");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL RHOSP 17.1.4 (python-zipp) package based on the guidance in RHSA-2024:9977.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-zipp-3.4.0-3.el9ost', 'release':'9', 'el_string':'el9ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python3-zipp');
}
