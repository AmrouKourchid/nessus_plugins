...
# extracted from Fedora Security Advisory FEDORA-2024-5e87ad4678
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-5e87ad4678");
  script_xref(name:"IAVA", value:"2024-A-0461-S");

  script_name(english:"Fedora 39 : vim (2024-5e87ad4678)");
...
FEDORA-2024-5e87ad4678 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-5e87ad4678");
...
var pkgs = [
    {'reference':'vim-9.1.660-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
