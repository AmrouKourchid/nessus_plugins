...
if (description)
{
  ...
  script_cve_id("CVE-2024-53203");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-53203");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: usb: typec: fix potential array
    underflow in ucsi_ccg_sync_control() The command variable can be controlled by the user via debugfs. The
    worry is that if con_index is zero then &uc->ucsi->connector[con_index - 1] would be an array underflow.
    (CVE-2024-53203)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-53203");
