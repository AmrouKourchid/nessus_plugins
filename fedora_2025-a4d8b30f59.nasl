...
# extracted from Fedora Security Advisory FEDORA-2025-a4d8b30f59
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-a4d8b30f59");

  script_name(english:"Fedora 40 : condor (2025-a4d8b30f59)");
...
FEDORA-2025-a4d8b30f59 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-a4d8b30f59");
...
var pkgs = [
    {'reference':'condor-23.9.6-3.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
