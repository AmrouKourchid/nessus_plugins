...
# extracted from Ubuntu Security Notice USN-2753-2. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : LXC regression (USN-2753-2)");
...
USN-2753-2 advisory.
    ...
    USN-2753-1 fixed a vulnerability in LXC. The update caused a regression that prevented some containers
    from starting. This regression only affected containers that had an absolute path specified as a bind
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2753-2");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'liblxc1', 'pkgver': '1.0.7-0ubuntu0.6'},
    {'osver': '14.04', 'pkgname': 'lxc', 'pkgver': '1.0.7-0ubuntu0.6'},
    {'osver': '14.04', 'pkgname': 'lxc-dev', 'pkgver': '1.0.7-0ubuntu0.6'},
    {'osver': '14.04', 'pkgname': 'lxc-templates', 'pkgver': '1.0.7-0ubuntu0.6'},
    {'osver': '14.04', 'pkgname': 'lxc-tests', 'pkgver': '1.0.7-0ubuntu0.6'},
    {'osver': '14.04', 'pkgname': 'python3-lxc', 'pkgver': '1.0.7-0ubuntu0.6'}
];
