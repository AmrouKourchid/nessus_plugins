...
# Oracle Linux Security Advisory ELSA-2020-0913 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : libvncserver (ELSA-2020-0913)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 7 host has packages installed that are affected by a vulnerability as referenced in the
ELSA-2020-0913 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2020-0913.html");
...
var pkgs = [
    {'reference':'libvncserver-0.9.9-14.el7_7', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libvncserver-devel-0.9.9-14.el7_7', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
