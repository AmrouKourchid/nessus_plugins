...
if (description)
{
  ...
  script_name(english:"Apache Tomcat 8.0.0.RC1 < 8.0.47");

  script_set_attribute(attribute:"synopsis", value:
"The remote Apache Tomcat server is affected by a vulnerability");
  script_set_attribute(attribute:"description", value:
"The version of Tomcat installed on the remote host is prior to 8.0.47. It is, therefore, affected by a vulnerability as
referenced in the fixed_in_apache_tomcat_8.0.47_security-8 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?58d96e2d");
  script_set_attribute(attribute:"see_also", value:"https://svn.apache.org/viewvc?view=rev&rev=1809921");
...
var constraints = [
  { 'min_version' : '8.0.0.RC1', 'max_version' : '8.0.46', 'fixed_version' : '8.0.47' }
];
