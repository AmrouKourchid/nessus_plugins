...
if (description)
{
  ...
  script_name(english:"PHP 7.1.x < 7.1.3 Denial of Service Vulnerability");
...
server is 7.1.x prior to 7.1.3. It is, therefore, affected by a denial
...
relied only on the application's self-reported version number.");
  script_set_attribute(attribute:"see_also", value:"http://php.net/ChangeLog-7.php#7.1.3");
  script_set_attribute(attribute:"solution", value:
"Upgrade to PHP version 7.1.3 or later.");
...
constraints = [
  { "min_version" : "7.1.0alpha0", "fixed_version" : "7.1.3" }
];
