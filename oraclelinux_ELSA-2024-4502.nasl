...
# extracted from Oracle Linux Security Advisory ELSA-2024-4502.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : skopeo (ELSA-2024-4502)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-4502.html");
