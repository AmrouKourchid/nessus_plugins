...
if (description)
{
  ...
  script_name(english:"Virtuozzo 7 : patch (VZLSA-2019-2964)");
...
* patch: OS shell command injection when processing crafted patch
files (CVE-2019-13638)
...
it as much as possible without introducing additional issues.");
  # http://repo.virtuozzo.com/vzlinux/announcements/json/VZLSA-2019-2964.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a5145d4f");
...
"Update the affected patch package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:virtuozzo:virtuozzo:patch");
