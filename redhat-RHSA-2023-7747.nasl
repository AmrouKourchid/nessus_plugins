...
# extracted from Red Hat Security Advisory RHSA-2023:7747. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:7747");

  script_name(english:"RHEL 9 : libxml2 (RHSA-2023:7747)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_7747.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?386a9a85");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2235864");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:7747");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libxml2 package based on the guidance in RHSA-2023:7747.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libxml2-2.9.13-5.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libxml2-devel-2.9.13-5.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-libxml2-2.9.13-5.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
