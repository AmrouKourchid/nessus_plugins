...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : curl (EulerOS-SA-2023-2419)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2419
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?94da1de5");
...
var pkgs = [
  "curl-7.29.0-46.h24.eulerosv2r7",
  "libcurl-7.29.0-46.h24.eulerosv2r7",
  "libcurl-devel-7.29.0-46.h24.eulerosv2r7"
];
