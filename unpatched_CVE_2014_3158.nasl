...
if (description)
{
  ...
  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2014-3158");
...
patch available.
  ...
  - Integer overflow in the getword function in options.c in pppd in Paul's PPP Package (ppp) before 2.4.7
    allows attackers to access privileged options via a long word in an options file, which triggers a heap-
    based buffer overflow that [corrupts] security-relevant variables. (CVE-2014-3158)
