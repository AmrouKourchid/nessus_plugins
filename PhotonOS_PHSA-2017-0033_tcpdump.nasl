...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'tcpdump-4.9.1-2.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'tcpdump-debuginfo-4.9.1-2.ph1')) flag++;
