...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'unzip-6.0-7.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'unzip-debuginfo-6.0-7.ph1')) flag++;
