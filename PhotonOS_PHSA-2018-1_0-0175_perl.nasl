...
# extracted from VMware Security Advisory PHSA-2018-1.0-0175. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Perl PHSA-2018-1.0-0175");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the perl package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-1.0-175.md");
...
if (rpm_check(release:"PhotonOS-1.0", reference:"perl-5.24.1-2.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"perl-debuginfo-5.24.1-2.ph1")) flag++;
