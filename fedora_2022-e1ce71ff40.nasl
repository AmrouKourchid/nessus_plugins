...
# extracted from Fedora Security Advisory FEDORA-2022-e1ce71ff40
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-e1ce71ff40");
  script_xref(name:"IAVA", value:"2023-A-0061-S");

  script_name(english:"Fedora 35 : python3.8 (2022-e1ce71ff40)");
...
FEDORA-2022-e1ce71ff40 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-e1ce71ff40");
...
var pkgs = [
    {'reference':'python3.8-3.8.16-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
