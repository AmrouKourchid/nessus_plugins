...
# extracted from Fedora Security Advisory FEDORA-2022-ea9c1a9b20
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-ea9c1a9b20");

  script_name(english:"Fedora 38 : azure-cli (2022-ea9c1a9b20)");
...
FEDORA-2022-ea9c1a9b20 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-ea9c1a9b20");
  script_set_attribute(attribute:"solution", value:
"Update the affected azure-cli package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:azure-cli");
...
var pkgs = [
    {'reference':'azure-cli-2.41.0-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'azure-cli');
}
