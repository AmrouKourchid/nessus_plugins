...
# extracted from Debian Security Advisory dla-3690. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3690 : intel-microcode - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has a package installed that is affected by a vulnerability as referenced in the dla-3690
advisory.

    -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3690-1                debian-lts@lists.debian.org
...
var pkgs = [
    {'release': '10.0', 'prefix': 'intel-microcode', 'reference': '3.20231114.1~deb10u1'}
];
