...
# extracted from Fedora Security Advisory FEDORA-2022-385d2ea041
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-385d2ea041");

  script_name(english:"Fedora 36 : python3.7 (2022-385d2ea041)");
...
FEDORA-2022-385d2ea041 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-385d2ea041");
...
var pkgs = [
    {'reference':'python3.7-3.7.15-2.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
