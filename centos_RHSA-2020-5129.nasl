...
# extracted from Red Hat Security Advisory RHSA-2020:5129.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : net-snmp (RHSA-2020:5129)");
...
var pkgs = [
    {'reference':'net-snmp-5.5-60.el6_10.2', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'net-snmp-devel-5.5-60.el6_10.2', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'net-snmp-libs-5.5-60.el6_10.2', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'net-snmp-perl-5.5-60.el6_10.2', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'net-snmp-python-5.5-60.el6_10.2', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'net-snmp-utils-5.5-60.el6_10.2', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
