...
# extracted from Amazon Linux 2023 Security Advisory ALAS2023-2023-421.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2023 : plexus-archiver, plexus-archiver-javadoc (ALAS2023-2023-421)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2023/ALAS-2023-421.html");
...
"Run 'dnf update plexus-archiver --releasever 2023.2.20231030' to update your system.");
...
var pkgs = [
    {'reference':'plexus-archiver-4.2.7-4.amzn2023.0.1', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'plexus-archiver-javadoc-4.2.7-4.amzn2023.0.1', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE}
];
