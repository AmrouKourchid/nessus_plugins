...
# extracted from Fedora Security Advisory FEDORA-2024-7bc1df53fc
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-7bc1df53fc");

  script_name(english:"Fedora 41 : lemonldap-ng (2024-7bc1df53fc)");
...
FEDORA-2024-7bc1df53fc advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-7bc1df53fc");
  script_set_attribute(attribute:"solution", value:
"Update the affected lemonldap-ng package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:lemonldap-ng");
...
var pkgs = [
    {'reference':'lemonldap-ng-2.20.1-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'lemonldap-ng');
}
