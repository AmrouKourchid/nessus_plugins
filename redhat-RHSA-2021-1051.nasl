...
# extracted from Red Hat Security Advisory RHSA-2021:1051. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:1051");

  script_name(english:"RHEL 7 : RHV-H  and security update (redhat-virtualization-host) 4.3.14 (Moderate) (RHSA-2021:1051)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for RHV-H.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_1051.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3e27cd1d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:1051");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1921438");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1924062");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1932859");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1940841");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL RHV-H package based on the guidance in RHSA-2021:1051.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'redhat-virtualization-host-image-update-4.3.14-20210322.0.el7_9', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'}
    ]
  }
];
