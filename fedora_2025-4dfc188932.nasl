...
# extracted from Fedora Security Advisory FEDORA-2025-4dfc188932
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-4dfc188932");
  script_xref(name:"IAVA", value:"2025-A-0206");

  script_name(english:"Fedora 41 : exim (2025-4dfc188932)");
...
FEDORA-2025-4dfc188932 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-4dfc188932");
...
var pkgs = [
    {'reference':'exim-4.98.1-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
