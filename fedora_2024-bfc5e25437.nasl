...
# extracted from Fedora Security Advisory FEDORA-2024-bfc5e25437
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-bfc5e25437");

  script_name(english:"Fedora 40 : mupdf (2024-bfc5e25437)");
...
FEDORA-2024-bfc5e25437 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-bfc5e25437");
...
var pkgs = [
    {'reference':'mupdf-1.24.6-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
