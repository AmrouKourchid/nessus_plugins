...
# extracted from Red Hat Security Advisory RHSA-2020:1045. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:1045");

  script_name(english:"RHEL 7 : lftp (RHSA-2020:1045)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for lftp.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2020:1045 advisory.

    LFTP is a file transfer utility for File Transfer Protocol (FTP), Secure File Transfer Protocol (SFTP),
    Hypertext Transfer Protocol (HTTP), and other commonly used protocols. It uses the readline library for
    input, and provides support for bookmarks, built-in monitoring, job control, and parallel transfer of
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_1045.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f703a948");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:1045");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1610349");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL lftp package based on the guidance in RHSA-2020:1045.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:lftp-scripts");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'lftp-4.4.8-12.el7', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'lftp-4.4.8-12.el7', 'cpu':'ppc', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'lftp-4.4.8-12.el7', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'lftp-4.4.8-12.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'lftp-4.4.8-12.el7', 'cpu':'s390', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'lftp-4.4.8-12.el7', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'lftp-4.4.8-12.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'lftp-scripts-4.4.8-12.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'lftp / lftp-scripts');
}
