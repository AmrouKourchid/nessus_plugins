...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5002222");
  script_xref(name:"MSFT", value:"MS22-5002222");
  script_xref(name:"IAVA", value:"2022-A-0237-S");

  script_name(english:"Security Updates for Microsoft SharePoint Server 2016 (June 2022)");

  script_set_attribute(attribute:"synopsis", value:
"The Microsoft SharePoint Server 2016 installation on the remote host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The Microsoft SharePoint Server 2016 installation on the remote host on the remote host on the remote host is missing 
security updates. It is, therefore, affected by multiple vulnerabilities:
  ...
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002222");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released KB5002222 to address this issue.");
