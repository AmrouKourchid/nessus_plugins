...
# extracted from Fedora Security Advisory FEDORA-2023-2a0668fe43
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-2a0668fe43");

  script_name(english:"Fedora 38 : libwebp (2023-2a0668fe43)");
...
FEDORA-2023-2a0668fe43 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-2a0668fe43");
...
var pkgs = [
    {'reference':'libwebp-1.3.2-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
