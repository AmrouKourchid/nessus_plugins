...
# extracted from Amazon Linux AMI Security Advisory ALAS-2018-1129.
#
...
if (description)
{
  ...
  script_name(english:"Amazon Linux AMI : krb5 (ALAS-2018-1129)");
...
(CVE-2018-5729)");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/ALAS-2018-1129.html");
...
flag = 0;
if (rpm_check(release:"ALA", reference:"krb5-debuginfo-1.15.1-34.44.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"krb5-devel-1.15.1-34.44.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"krb5-libs-1.15.1-34.44.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"krb5-pkinit-openssl-1.15.1-34.44.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"krb5-server-1.15.1-34.44.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"krb5-server-ldap-1.15.1-34.44.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"krb5-workstation-1.15.1-34.44.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"libkadm5-1.15.1-34.44.amzn1")) flag++;
