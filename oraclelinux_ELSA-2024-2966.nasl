...
# extracted from Oracle Linux Security Advisory ELSA-2024-2966.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : ghostscript (ELSA-2024-2966)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
ELSA-2024-2966 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-2966.html");
...
var pkgs = [
    ...
    {'reference':'ghostscript-doc-9.27-12.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'ghostscript-doc-9.27-12.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
