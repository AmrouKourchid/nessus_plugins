...
# extracted from Red Hat Security Advisory ovirt-engine. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : ovirt-engine (Unpatched Vulnerability) (deprecated)");
...
"This plugin has been deprecated as it does not adhere to established standards for this style of check.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-6338");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2018-1074");
