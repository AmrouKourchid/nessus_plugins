...
# extracted from Ubuntu Security Notice USN-6237-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6237-1");
  script_xref(name:"IAVA", value:"2023-A-0259-S");

  script_name(english:"Ubuntu 20.04 LTS / 22.04 LTS / 22.10 / 23.04 : curl vulnerabilities (USN-6237-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 20.04 LTS / 22.04 LTS / 22.10 / 23.04 host has packages installed that are affected by multiple
vulnerabilities as referenced in the USN-6237-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6237-1");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'curl', 'pkgver': '7.68.0-1ubuntu2.19'},
    {'osver': '20.04', 'pkgname': 'libcurl3-gnutls', 'pkgver': '7.68.0-1ubuntu2.19'},
    {'osver': '20.04', 'pkgname': 'libcurl3-nss', 'pkgver': '7.68.0-1ubuntu2.19'},
    {'osver': '20.04', 'pkgname': 'libcurl4', 'pkgver': '7.68.0-1ubuntu2.19'},
    {'osver': '20.04', 'pkgname': 'libcurl4-gnutls-dev', 'pkgver': '7.68.0-1ubuntu2.19'},
    {'osver': '20.04', 'pkgname': 'libcurl4-nss-dev', 'pkgver': '7.68.0-1ubuntu2.19'},
    {'osver': '20.04', 'pkgname': 'libcurl4-openssl-dev', 'pkgver': '7.68.0-1ubuntu2.19'},
    {'osver': '22.04', 'pkgname': 'curl', 'pkgver': '7.81.0-1ubuntu1.11'},
    {'osver': '22.04', 'pkgname': 'libcurl3-gnutls', 'pkgver': '7.81.0-1ubuntu1.11'},
    {'osver': '22.04', 'pkgname': 'libcurl3-nss', 'pkgver': '7.81.0-1ubuntu1.11'},
    {'osver': '22.04', 'pkgname': 'libcurl4', 'pkgver': '7.81.0-1ubuntu1.11'},
    {'osver': '22.04', 'pkgname': 'libcurl4-gnutls-dev', 'pkgver': '7.81.0-1ubuntu1.11'},
    {'osver': '22.04', 'pkgname': 'libcurl4-nss-dev', 'pkgver': '7.81.0-1ubuntu1.11'},
    {'osver': '22.04', 'pkgname': 'libcurl4-openssl-dev', 'pkgver': '7.81.0-1ubuntu1.11'},
    {'osver': '22.10', 'pkgname': 'curl', 'pkgver': '7.85.0-1ubuntu0.6'},
    {'osver': '22.10', 'pkgname': 'libcurl3-gnutls', 'pkgver': '7.85.0-1ubuntu0.6'},
    {'osver': '22.10', 'pkgname': 'libcurl3-nss', 'pkgver': '7.85.0-1ubuntu0.6'},
    {'osver': '22.10', 'pkgname': 'libcurl4', 'pkgver': '7.85.0-1ubuntu0.6'},
    {'osver': '22.10', 'pkgname': 'libcurl4-gnutls-dev', 'pkgver': '7.85.0-1ubuntu0.6'},
    {'osver': '22.10', 'pkgname': 'libcurl4-nss-dev', 'pkgver': '7.85.0-1ubuntu0.6'},
    {'osver': '22.10', 'pkgname': 'libcurl4-openssl-dev', 'pkgver': '7.85.0-1ubuntu0.6'},
    {'osver': '23.04', 'pkgname': 'curl', 'pkgver': '7.88.1-8ubuntu2.1'},
    {'osver': '23.04', 'pkgname': 'libcurl3-gnutls', 'pkgver': '7.88.1-8ubuntu2.1'},
    {'osver': '23.04', 'pkgname': 'libcurl3-nss', 'pkgver': '7.88.1-8ubuntu2.1'},
    {'osver': '23.04', 'pkgname': 'libcurl4', 'pkgver': '7.88.1-8ubuntu2.1'},
    {'osver': '23.04', 'pkgname': 'libcurl4-gnutls-dev', 'pkgver': '7.88.1-8ubuntu2.1'},
    {'osver': '23.04', 'pkgname': 'libcurl4-nss-dev', 'pkgver': '7.88.1-8ubuntu2.1'},
    {'osver': '23.04', 'pkgname': 'libcurl4-openssl-dev', 'pkgver': '7.88.1-8ubuntu2.1'}
];
