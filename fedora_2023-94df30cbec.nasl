...
# extracted from Fedora Security Advisory FEDORA-2023-94df30cbec
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-94df30cbec");

  script_name(english:"Fedora 36 : curl (2023-94df30cbec)");
...
FEDORA-2023-94df30cbec advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-94df30cbec");
...
var pkgs = [
    {'reference':'curl-7.82.0-13.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
