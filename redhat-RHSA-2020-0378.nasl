...
referenced in the RHSA-2020:0378 advisory.
    ...
    * User incorrectly added to negative cache when backend is reconnecting to IPA service / timed out: error
    code 32 'No such object' (BZ#1773953)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_0378.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ae386a22");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:0378");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1726223");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1766920");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1770728");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1781153");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL ipa package based on the guidance in RHSA-2020:0378.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ipa-client-4.6.5-11.el7_7.4', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-client-4.6.5-11.el7_7.4', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-client-4.6.5-11.el7_7.4', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-client-4.6.5-11.el7_7.4', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-client-common-4.6.5-11.el7_7.4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-common-4.6.5-11.el7_7.4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-python-compat-4.6.5-11.el7_7.4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-server-4.6.5-11.el7_7.4', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-server-common-4.6.5-11.el7_7.4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-server-dns-4.6.5-11.el7_7.4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-server-trust-ad-4.6.5-11.el7_7.4', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python2-ipaclient-4.6.5-11.el7_7.4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python2-ipalib-4.6.5-11.el7_7.4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python2-ipaserver-4.6.5-11.el7_7.4', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
