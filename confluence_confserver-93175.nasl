...
if (description)
{
  ...
  script_cve_id("CVE-2022-42890");
  script_xref(name:"IAVA", value:"2024-A-0175-S");

  script_name(english:"Atlassian Confluence 7.13 / 7.19.x < 7.19.16 (CONFSERVER-93175)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://jira.atlassian.com/browse/CONFSERVER-93175");
...
var constraints = [
  { 'min_version' : '7.13', 'fixed_version' : '7.14', 'fixed_display' : '7.19.16' },
  { 'min_version' : '7.19', 'fixed_version' : '7.19.16' },
];
