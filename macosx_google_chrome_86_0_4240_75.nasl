...
"The version of Google Chrome installed on the remote macOS host is prior to 86.0.4240.75. It is, therefore, affected by
multiple vulnerabilities as referenced in the 2020_10_stable-channel-update-for-desktop advisory. Note that Nessus has
...
google_chrome_check_version(fix:'86.0.4240.75', severity:SECURITY_WARNING, xss:FALSE, xsrf:FALSE);
