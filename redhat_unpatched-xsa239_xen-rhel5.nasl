...
# extracted from Red Hat Security Advisory xsa239_xen. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2017-15589");

  script_name(english:"RHEL 5 : xsa239_xen (Unpatched Vulnerability) (deprecated)");
...
"This plugin has been deprecated as it does not adhere to established standards for this style of check.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-15589");
