...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.0 : libssh (EulerOS-SA-2023-2759)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2759
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e77a7fce");
...
var pkgs = [
  "libssh-0.9.6-2.h10.eulerosv2r11"
];
