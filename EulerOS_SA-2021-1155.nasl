...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : nss-softokn (EulerOS-SA-2021-1155)");
...
vulnerabilities :
  ...
  - During ECDSA signature generation, padding applied in
    ...
    execution dependent on secret data.(CVE-2020-12401)
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1155
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?391c4fc3");
...
pkgs = ["nss-softokn-3.39.0-2.h6.eulerosv2r8",
        "nss-softokn-devel-3.39.0-2.h6.eulerosv2r8",
        "nss-softokn-freebl-3.39.0-2.h6.eulerosv2r8",
        "nss-softokn-freebl-devel-3.39.0-2.h6.eulerosv2r8"];
