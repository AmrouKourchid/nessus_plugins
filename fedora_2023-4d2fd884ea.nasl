...
# extracted from Fedora Security Advisory FEDORA-2023-4d2fd884ea
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-4d2fd884ea");
  script_xref(name:"CEA-ID", value:"CEA-2024-0004");

  script_name(english:"Fedora 38 : nodejs20 (2023-4d2fd884ea)");
...
FEDORA-2023-4d2fd884ea advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-4d2fd884ea");
...
var pkgs = [
    {'reference':'nodejs20-20.8.1-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
