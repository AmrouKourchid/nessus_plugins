...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Envoy PHSA-2020-2.0-0229");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'envoy-1.13.1-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'envoy-debuginfo-1.13.1-1.ph2')) flag++;
