...
# extracted from Fedora Security Advisory FEDORA-2024-05a6ab143e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-05a6ab143e");

  script_name(english:"Fedora 40 : libreswan (2024-05a6ab143e)");
...
FEDORA-2024-05a6ab143e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-05a6ab143e");
...
var pkgs = [
    {'reference':'libreswan-4.15-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
