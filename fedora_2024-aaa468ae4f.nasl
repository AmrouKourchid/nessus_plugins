...
# extracted from Fedora Security Advisory FEDORA-2024-aaa468ae4f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-aaa468ae4f");

  script_name(english:"Fedora 40 : perl-App-cpanminus (2024-aaa468ae4f)");
...
FEDORA-2024-aaa468ae4f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-aaa468ae4f");
...
"Update the affected perl-App-cpanminus package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:perl-App-cpanminus");
...
var pkgs = [
    {'reference':'perl-App-cpanminus-1.7047-4.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
