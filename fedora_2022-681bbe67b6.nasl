...
# extracted from Fedora Security Advisory FEDORA-2022-681bbe67b6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-681bbe67b6");

  script_name(english:"Fedora 36 : xterm (2022-681bbe67b6)");
...
FEDORA-2022-681bbe67b6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-681bbe67b6");
...
var pkgs = [
    {'reference':'xterm-375-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
