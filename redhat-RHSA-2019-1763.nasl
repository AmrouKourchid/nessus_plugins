...
# extracted from Red Hat Security Advisory RHSA-2019:1763. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : firefox (RHSA-2019:1763)");
...
referenced in the RHSA-2019:1763 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_1763.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6bba647d");
...
"Update the RHEL firefox package based on the guidance in RHSA-2019:1763.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-60.8.0-1.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
