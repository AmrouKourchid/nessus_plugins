...
# extracted from Fedora Security Advisory FEDORA-2019-86f32cbab1.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-86f32cbab1");

  script_name(english:"Fedora 28 : python3 (2019-86f32cbab1)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-86f32cbab1");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"python3-3.6.8-3.fc28")) flag++;
