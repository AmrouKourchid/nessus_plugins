...
if (description)
{
  ...
  script_cve_id("CVE-2020-3518");
  script_xref(name:"CISCO-BUG-ID", value:"CSCvu12806");
  script_xref(name:"CISCO-SA", value:"cisco-sa-dcnm-xss-JnHSWG5C");
  script_xref(name:"IAVA", value:"2020-A-0279-S");

  script_name(english:"Cisco Data Center Network Manager XSS (cisco-sa-dcnm-xss-JnHSWG5C)");
...
web-based management interface due to a failure to properly validate user-supplied input. An authenticated, remote
attacker can exploit this, by persuading a user of the interface to click a crafted link, in order to execute
...
Please see the included Cisco BIDs and Cisco Security Advisory for more information.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?50960258");
  script_set_attribute(attribute:"see_also", value:"https://bst.cloudapps.cisco.com/bugsearch/bug/CSCvu12806");
  script_set_attribute(attribute:"solution", value:
"Upgrade to the relevant fixed version referenced in Cisco bug ID CSCvu12806");
  script_set_attribute(attribute:"agent", value:"all");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:S/C:N/I:P/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:L/UI:R/S:C/C:L/I:L/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-3518");
