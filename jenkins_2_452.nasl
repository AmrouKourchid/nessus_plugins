...
if (description)
{
  ...
  script_xref(name:"JENKINS", value:"2024-04-17");

  script_name(english:"Jenkins LTS < 2.440.3 / Jenkins weekly < 2.452");
...
LTS prior to 2.440.3 or Jenkins weekly prior to 2.452. It is, therefore, affected by a vulnerability:
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://jenkins.io/security/advisory/2024-04-17");
...
var constraints = [
  { 'max_version' : '2.451', 'fixed_version' : '2.452', 'edition' : 'Open Source' },
  { 'max_version' : '2.440.2', 'fixed_version' : '2.440.3', 'edition' : 'Open Source LTS' }
];
