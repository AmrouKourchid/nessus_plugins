...
# SUSE update advisory SUSE-SU-2025:1017-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2025:1017-1");

  script_name(english:"SUSE SLES15 Security Update : buildah (SUSE-SU-2025:1017-1)");
...
referenced in the SUSE-SU-2025:1017-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2025-March/020607.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?69bba6bb");
...
var pkgs = [
    {'reference':'buildah-1.35.5-150300.8.39.1', 'sp':'3', 'cpu':'x86_64', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.3']},
    {'reference':'buildah-1.35.5-150300.8.39.1', 'sp':'3', 'cpu':'aarch64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-LTSS-release-15.3']},
    {'reference':'buildah-1.35.5-150300.8.39.1', 'sp':'3', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-LTSS-release-15.3']},
    {'reference':'buildah-1.35.5-150300.8.39.1', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-ltss-release-15.3']}
];
