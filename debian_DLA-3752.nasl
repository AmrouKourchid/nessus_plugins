...
# extracted from Debian Security Advisory dla-3752. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3752 : libuv1 - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3752
advisory.
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libuv1', 'reference': '1.24.1-1+deb10u2'},
    {'release': '10.0', 'prefix': 'libuv1-dev', 'reference': '1.24.1-1+deb10u2'}
];
