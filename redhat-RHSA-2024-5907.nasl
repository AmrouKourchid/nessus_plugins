...
# extracted from Red Hat Security Advisory RHSA-2024:5907. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:5907");

  script_name(english:"RHEL 9 : bind and bind-dyndb-ldap (RHSA-2024:5907)");
...
referenced in the RHSA-2024:5907 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_5907.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?32e8e8b0");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:5907");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL bind / bind-dyndb-ldap packages based on the guidance in RHSA-2024:5907.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'bind-9.16.23-1.el9_0.7', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-chroot-9.16.23-1.el9_0.7', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-dnssec-doc-9.16.23-1.el9_0.7', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-dnssec-utils-9.16.23-1.el9_0.7', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-dyndb-ldap-11.9-7.el9_0.3', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bind-libs-9.16.23-1.el9_0.7', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-license-9.16.23-1.el9_0.7', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-utils-9.16.23-1.el9_0.7', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'python3-bind-9.16.23-1.el9_0.7', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'bind / bind-chroot / bind-dnssec-doc / bind-dnssec-utils / etc');
}
