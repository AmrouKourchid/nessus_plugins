...
# extracted from Fedora Security Advisory FEDORA-2025-2215919645
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-2215919645");

  script_name(english:"Fedora 40 : python-spotipy (2025-2215919645)");
...
FEDORA-2025-2215919645 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-2215919645");
...
var pkgs = [
    {'reference':'python-spotipy-2.25.1-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
