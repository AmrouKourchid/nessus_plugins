...
if (description)
{
  ...
  script_name(english:"Red Hat Enterprise Linux SEoL (9.10.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Red Hat Enterprise Linux is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Red Hat Enterprise Linux is 9.10.x. It is, therefore, no longer maintained by its vendor or
provider.
...
"Upgrade to a version of Red Hat Enterprise Linux that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2032/05/31");
...
var constraints = [
  { max_branch : '9.10', min_branch : '9.10', eseol : 20350531, seol : 20320531 }
];
