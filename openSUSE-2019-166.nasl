...
# extracted from openSUSE Security Update openSUSE-2019-166.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : haproxy (openSUSE-2019-166)");
...
Security issues fixed :
  ...
  - CVE-2018-20615: Fixed a denial of service, triggered by
    mishandling the priority flag on short HEADERS frame in
    the HTTP/2 decoder (bsc#1121283)

This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1121283");
...
if ( rpm_check(release:"SUSE15.0", reference:"haproxy-1.8.17~git0.e89d25b2-lp150.2.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"haproxy-debuginfo-1.8.17~git0.e89d25b2-lp150.2.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"haproxy-debugsource-1.8.17~git0.e89d25b2-lp150.2.9.1") ) flag++;
