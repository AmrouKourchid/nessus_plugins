...
if (description)
{
  ...
  script_bugtraq_id(106323);

  script_name(english:"Photon OS 1.0: Sqlite PHSA-2019-1.0-0209");
...
if (rpm_exists(rpm:"sqlite-autoconf-3.26", release:"PhotonOS-1.0") && rpm_check(release:"PhotonOS-1.0", cpu:"x86_64", reference:"sqlite-autoconf-3.26.0-1.ph1")) flag++;
if (rpm_exists(rpm:"sqlite-autoconf-3.26", release:"PhotonOS-1.0") && rpm_check(release:"PhotonOS-1.0", cpu:"src", reference:"sqlite-autoconf-3.26.0-1.ph1.src")) flag++;
if (rpm_check(release:"PhotonOS-1.0", cpu:"x86_64", reference:"sqlite-autoconf-debuginfo-3.26.0-1.ph1")) flag++;
