...
# extracted from Amazon Linux 2 Security Advisory ALAS-2019-1347.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2019-1347");

  script_name(english:"Amazon Linux 2 : dovecot (ALAS-2019-1347)");
...
out-of-bounds writes and remote code execution.(CVE-2019-11500)");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2019-1347.html");
...
flag = 0;
if (rpm_check(release:"AL2", reference:"dovecot-2.2.36-3.amzn2.1")) flag++;
if (rpm_check(release:"AL2", reference:"dovecot-debuginfo-2.2.36-3.amzn2.1")) flag++;
if (rpm_check(release:"AL2", reference:"dovecot-devel-2.2.36-3.amzn2.1")) flag++;
if (rpm_check(release:"AL2", reference:"dovecot-mysql-2.2.36-3.amzn2.1")) flag++;
if (rpm_check(release:"AL2", reference:"dovecot-pgsql-2.2.36-3.amzn2.1")) flag++;
if (rpm_check(release:"AL2", reference:"dovecot-pigeonhole-2.2.36-3.amzn2.1")) flag++;
