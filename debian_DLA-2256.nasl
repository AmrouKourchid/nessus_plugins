...
# extracted from Debian Security Advisory DLA-2256-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2256-1 : libtirpc security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"It was discovered that libtiprc, a transport-independent RPC library,
could be used for a denial of service or possibly unspecified other
impact by a stack-based buffer overflow due to a flood of crafted ICMP
and UDP packets.
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2020/06/msg00027.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/jessie/libtirpc");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"libtirpc-dev", reference:"0.2.5-1+deb8u3")) flag++;
if (deb_check(release:"8.0", prefix:"libtirpc1", reference:"0.2.5-1+deb8u3")) flag++;
