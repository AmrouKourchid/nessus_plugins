...
if (description)
{
  ...
  script_name(english:"VMware Carbon Black App Control SEoL (8.5.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of VMware Carbon Black App Control is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, VMware Carbon Black App Control is 8.5.x. It is, therefore, no longer maintained by its vendor
or provider.
...
"Upgrade to a version of VMware Carbon Black App Control that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2024/02/01");
...
var constraints = [
  { max_branch : '8.5', min_branch : '8.5', seol : 20240201 }
];
