...
# extracted from Fedora Security Advisory FEDORA-2022-39688a779d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-39688a779d");

  script_name(english:"Fedora 35 : curl (2022-39688a779d)");
...
FEDORA-2022-39688a779d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-39688a779d");
...
var pkgs = [
    {'reference':'curl-7.79.1-7.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
