...
# Rocky Linux Security Advisory RLSA-2021:3547.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2021:3547");

  script_name(english:"Rocky Linux 8 : kernel-rt (RLSA-2021:3547)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Rocky Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Rocky Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
RLSA-2021:3547 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2021:3547");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for RLSA-2021:3547');
  }
  else
  {
...
var pkgs = [
    ...
    {'reference':'kernel-rt-debug-debuginfo-4.18.0-305.19.1.rt7.91.el8_4', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'kernel-rt-debuginfo-4.18.0-305.19.1.rt7.91.el8_4', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kernel-rt-debuginfo-common-x86_64-4.18.0-305.19.1.rt7.91.el8_4', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
