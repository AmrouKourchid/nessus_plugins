...
# extracted from VMware Security Advisory PHSA-2025-5.0-0504. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2022-46175", "CVE-2024-45491");

  script_name(english:"Photon OS 5.0: Mozjs PHSA-2025-5.0-0504");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the mozjs package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-5.0-504.md");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'mozjs-102.12.0-6.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'mozjs-devel-102.12.0-6.ph5')) flag++;
