...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : libvncserver (EulerOS-SA-2020-2552)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2552
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fd2f5631");
...
pkgs = ["libvncserver-0.9.9-12.h13.eulerosv2r7"];
