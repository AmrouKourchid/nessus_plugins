...
# extracted from Fedora Security Advisory FEDORA-2023-030318ca00
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-030318ca00");

  script_name(english:"Fedora 36 : vim (2023-030318ca00)");
...
FEDORA-2023-030318ca00 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-030318ca00");
...
var pkgs = [
    {'reference':'vim-9.0.1407-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
