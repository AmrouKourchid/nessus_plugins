...
if (description)
{
  ...
  script_cve_id("CVE-2024-8194");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-8194");
...
patch available.
  ...
  - Type Confusion in V8 in Google Chrome prior to 128.0.6613.113 allowed a remote attacker to potentially
    exploit heap corruption via a crafted HTML page. (Chromium security severity: High) (CVE-2024-8194)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-8194");
