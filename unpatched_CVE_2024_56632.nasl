...
if (description)
{
  ...
  script_cve_id("CVE-2024-56632");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-56632");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: nvme-tcp: fix the memleak while create
    new ctrl failed Now while we create new ctrl failed, we have not free the tagset occupied by admin_q, here
    try to fix it. (CVE-2024-56632)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-56632");
