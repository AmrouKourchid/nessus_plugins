...
# extracted from Oracle Linux Security Advisory ELSA-2011-0028.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : kvm (ELSA-2011-0028)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2011-0028.html");
...
var pkgs = [
    {'reference':'kmod-kvm-83-224.0.1.el5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kmod-kvm-debug-83-224.0.1.el5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kvm-83-224.0.1.el5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kvm-qemu-img-83-224.0.1.el5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kvm-tools-83-224.0.1.el5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
