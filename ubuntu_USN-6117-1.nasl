...
multiple vulnerabilities as referenced in the USN-6117-1 advisory.
    ...
    It was discovered that Apache Batik incorrectly handled certain inputs. An attacker could possibly use
    this to perform a cross site request forgery attack. (CVE-2019-17566, CVE-2020-11987, CVE-2022-38398,
    CVE-2022-38648)

    It was discovered that Apache Batik incorrectly handled Jar URLs in some situations. A remote attacker
    could use this issue to access files on the server. (CVE-2022-40146)

    It was discovered that Apache Batik allowed running untrusted Java code from an SVG. An attacker could use
    this issue to cause a denial of service, or possibly execute arbitrary code. (CVE-2022-41704,
    CVE-2022-42890)
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libbatik-java', 'pkgver': '1.8-3ubuntu1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libbatik-java', 'pkgver': '1.10-2~18.04.1', 'ubuntu_pro': FALSE},
    {'osver': '20.04', 'pkgname': 'libbatik-java', 'pkgver': '1.12-1ubuntu0.1', 'ubuntu_pro': FALSE},
    {'osver': '22.04', 'pkgname': 'libbatik-java', 'pkgver': '1.14-1ubuntu0.2', 'ubuntu_pro': FALSE}
];
