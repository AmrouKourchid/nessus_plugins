...
# extracted from Debian Security Advisory dla-4039. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-4039 : ffmpeg - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-35367");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-35368");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-36618");
...
"Upgrade the ffmpeg packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-36618");
  ...
  script_set_attribute(attribute:"patch_publication_date", value:"2025/02/01");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'ffmpeg', 'reference': '7:4.3.8-0+deb11u2'},
    {'release': '11.0', 'prefix': 'ffmpeg-doc', 'reference': '7:4.3.8-0+deb11u2'},
    {'release': '11.0', 'prefix': 'libavcodec-dev', 'reference': '7:4.3.8-0+deb11u2'},
    {'release': '11.0', 'prefix': 'libavcodec-extra', 'reference': '7:4.3.8-0+deb11u2'},
    {'release': '11.0', 'prefix': 'libavcodec-extra58', 'reference': '7:4.3.8-0+deb11u2'},
    {'release': '11.0', 'prefix': 'libavcodec58', 'reference': '7:4.3.8-0+deb11u2'},
    {'release': '11.0', 'prefix': 'libavdevice-dev', 'reference': '7:4.3.8-0+deb11u2'},
    {'release': '11.0', 'prefix': 'libavdevice58', 'reference': '7:4.3.8-0+deb11u2'},
    {'release': '11.0', 'prefix': 'libavfilter-dev', 'reference': '7:4.3.8-0+deb11u2'},
    {'release': '11.0', 'prefix': 'libavfilter-extra', 'reference': '7:4.3.8-0+deb11u2'},
    {'release': '11.0', 'prefix': 'libavfilter-extra7', 'reference': '7:4.3.8-0+deb11u2'},
    {'release': '11.0', 'prefix': 'libavfilter7', 'reference': '7:4.3.8-0+deb11u2'},
    {'release': '11.0', 'prefix': 'libavformat-dev', 'reference': '7:4.3.8-0+deb11u2'},
    {'release': '11.0', 'prefix': 'libavformat58', 'reference': '7:4.3.8-0+deb11u2'},
    {'release': '11.0', 'prefix': 'libavresample-dev', 'reference': '7:4.3.8-0+deb11u2'},
    {'release': '11.0', 'prefix': 'libavresample4', 'reference': '7:4.3.8-0+deb11u2'},
    {'release': '11.0', 'prefix': 'libavutil-dev', 'reference': '7:4.3.8-0+deb11u2'},
    {'release': '11.0', 'prefix': 'libavutil56', 'reference': '7:4.3.8-0+deb11u2'},
    {'release': '11.0', 'prefix': 'libpostproc-dev', 'reference': '7:4.3.8-0+deb11u2'},
    {'release': '11.0', 'prefix': 'libpostproc55', 'reference': '7:4.3.8-0+deb11u2'},
    {'release': '11.0', 'prefix': 'libswresample-dev', 'reference': '7:4.3.8-0+deb11u2'},
    {'release': '11.0', 'prefix': 'libswresample3', 'reference': '7:4.3.8-0+deb11u2'},
    {'release': '11.0', 'prefix': 'libswscale-dev', 'reference': '7:4.3.8-0+deb11u2'},
    {'release': '11.0', 'prefix': 'libswscale5', 'reference': '7:4.3.8-0+deb11u2'}
];
