...
# extracted from Amazon Linux 2 Security Advisory ALAS-2019-1303.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2019-1303");

  script_name(english:"Amazon Linux 2 : libssh2 (ALAS-2019-1303)");
...
be able to cause a denial of service or read data in the client
memory. (CVE-2019-3862)");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2019-1303.html");
...
flag = 0;
if (rpm_check(release:"AL2", reference:"libssh2-1.4.3-12.amzn2.2.2")) flag++;
if (rpm_check(release:"AL2", reference:"libssh2-debuginfo-1.4.3-12.amzn2.2.2")) flag++;
if (rpm_check(release:"AL2", reference:"libssh2-devel-1.4.3-12.amzn2.2.2")) flag++;
if (rpm_check(release:"AL2", reference:"libssh2-docs-1.4.3-12.amzn2.2.2")) flag++;
