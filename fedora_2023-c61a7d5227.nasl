...
# extracted from Fedora Security Advisory FEDORA-2023-c61a7d5227
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-c61a7d5227");

  script_name(english:"Fedora 39 : python3.10 (2023-c61a7d5227)");
...
FEDORA-2023-c61a7d5227 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-c61a7d5227");
...
var pkgs = [
    {'reference':'python3.10-3.10.13-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
