...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP13 : binutils (EulerOS-SA-2025-1329)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1329
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6e2fa364");
...
var pkgs = [
  "binutils-2.37-24.h4.eulerosv2r13"
];
