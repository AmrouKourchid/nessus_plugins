...
# extracted from Fedora Security Advisory FEDORA-2024-600031d2e9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-600031d2e9");

  script_name(english:"Fedora 38 : python-pip (2024-600031d2e9)");
...
FEDORA-2024-600031d2e9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-600031d2e9");
...
var pkgs = [
    {'reference':'python-pip-22.3.1-4.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
