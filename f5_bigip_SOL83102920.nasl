...
# extracted from F5 Networks BIG-IP Solution K83102920.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : Linux kernel vulnerability (K83102920)");
...
vulnerability as referenced in the K83102920 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K83102920");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K83102920.");
