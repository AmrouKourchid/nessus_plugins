...
# extracted from openSUSE Security Update openSUSE-2020-1561.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : tiff (openSUSE-2020-1561)");
...
This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1146608");
...
if ( rpm_check(release:"SUSE15.2", reference:"libtiff-devel-4.0.9-lp152.11.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libtiff5-4.0.9-lp152.11.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libtiff5-debuginfo-4.0.9-lp152.11.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"tiff-4.0.9-lp152.11.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"tiff-debuginfo-4.0.9-lp152.11.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"tiff-debugsource-4.0.9-lp152.11.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"libtiff-devel-32bit-4.0.9-lp152.11.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"libtiff5-32bit-4.0.9-lp152.11.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"libtiff5-32bit-debuginfo-4.0.9-lp152.11.3.1") ) flag++;
