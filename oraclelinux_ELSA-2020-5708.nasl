...
the ELSA-2020-5708 advisory.
    ...
    - libertas: Fix two buffer overflows at parsing bss descriptor (Wen Huang)  [Orabug: 31351307]
    {CVE-2019-14896} {CVE-2019-14897} {CVE-2019-14897}
    - binfmt_elf: use ELF_ET_DYN_BASE only for PIE (Kees Cook)  [Orabug: 31352068]  {CVE-2017-1000370}
    {CVE-2017-1000371} {CVE-2017-1000370}
    ...
    - mremap: properly flush TLB before releasing the page (Linus Torvalds)  [Orabug: 31352011]
    {CVE-2018-18281}
    - Input: add safety guards to input_set_keycode() (Dmitry Torokhov)  [Orabug: 31200558]  {CVE-2019-20636}
    - media: stv06xx: add missing descriptor sanity checks (Johan Hovold)  [Orabug: 31200579]
    {CVE-2020-11609}
    - media: ov519: add missing endpoint sanity checks (Johan Hovold)  [Orabug: 31213758]  {CVE-2020-11608}
    - media: xirlink_cit: add missing descriptor sanity checks (Johan Hovold)  [Orabug: 31213767]
    {CVE-2020-11668}
    - mwifiex: pcie: Fix memory leak in mwifiex_pcie_init_evt_ring (Navid Emamdoost)  [Orabug: 31263147]
    {CVE-2019-19057}
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-14897");
...
var pkgs = [
    ...
    {'reference':'kernel-uek-doc-4.1.12-124.39.5.el6uek', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-doc-4.1.12'},
    {'reference':'kernel-uek-firmware-4.1.12-124.39.5.el6uek', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-firmware-4.1.12'},
    ...
    {'reference':'kernel-uek-doc-4.1.12-124.39.5.el7uek', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-doc-4.1.12'},
    {'reference':'kernel-uek-firmware-4.1.12-124.39.5.el7uek', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-firmware-4.1.12'}
];
