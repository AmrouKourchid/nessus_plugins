...
# extracted from Red Hat Security Advisory RHSA-2024:0893. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:0893");

  script_name(english:"RHEL 8 : python-pillow (RHSA-2024:0893)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for python-pillow.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:0893 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0893.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ba4d7d6b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2259479");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0893");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-pillow package based on the guidance in RHSA-2024:0893.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-pillow-5.1.1-18.el8_9.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-pillow-devel-5.1.1-18.el8_9.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-pillow-doc-5.1.1-18.el8_9.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-pillow-tk-5.1.1-18.el8_9.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
