...
# SUSE update advisory SUSE-SU-2021:14744-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2021:14744-1");

  script_name(english:"SUSE SLES11 Security Update : spice (SUSE-SU-2021:14744-1)");
...
referenced in the SUSE-SU-2021:14744-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/982386");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2016-2150");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2021-June/008966.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5e004960");
...
"Update the affected libspice-server1 package.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2016-2150");
...
var pkgs = [
    {'reference':'libspice-server1-0.12.4-21', 'sp':'4', 'cpu':'i586', 'release':'SLES_SAP11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-11.4']},
    {'reference':'libspice-server1-0.12.4-21', 'sp':'4', 'cpu':'x86_64', 'release':'SLES_SAP11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-11.4']},
    {'reference':'libspice-server1-0.12.4-21', 'sp':'4', 'cpu':'i586', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.4']},
    {'reference':'libspice-server1-0.12.4-21', 'sp':'4', 'cpu':'x86_64', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.4']}
];
