...
# extracted from VMware Security Advisory PHSA-2023-4.0-0326. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Tmux PHSA-2023-4.0-0326");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the tmux package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-326.md");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:vmware:photonos:tmux");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'tmux-3.1b-4.ph4')) flag++;
