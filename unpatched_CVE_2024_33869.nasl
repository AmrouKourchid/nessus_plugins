...
if (description)
{
  ...
  script_cve_id("CVE-2024-33869");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-33869");
...
patch available.
  ...
  - An issue was discovered in Artifex Ghostscript before 10.03.1. Path traversal and command execution can
    ...
    restrictions on use of %pipe% can be bypassed via the aa/../%pipe%command# output filename.
    (CVE-2024-33869)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-33869");
