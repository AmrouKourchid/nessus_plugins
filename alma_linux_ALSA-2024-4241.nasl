...
# AlmaLinux Security Advisory ALSA-2024:4241.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:4241");

  script_name(english:"AlmaLinux 8 : iperf3 (ALSA-2024:4241)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2024-4241.html");
