...
# extracted from Ubuntu Security Notice USN-7397-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"7397-1");

  script_name(english:"Ubuntu 20.04 LTS / 22.04 LTS : AOM vulnerability (USN-7397-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7397-1");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'aom-tools', 'pkgver': '1.0.0.errata1-3+deb11u1ubuntu0.1'},
    {'osver': '20.04', 'pkgname': 'libaom-dev', 'pkgver': '1.0.0.errata1-3+deb11u1ubuntu0.1'},
    {'osver': '20.04', 'pkgname': 'libaom0', 'pkgver': '1.0.0.errata1-3+deb11u1ubuntu0.1'},
    {'osver': '22.04', 'pkgname': 'aom-tools', 'pkgver': '3.3.0-1ubuntu0.1'},
    {'osver': '22.04', 'pkgname': 'libaom-dev', 'pkgver': '3.3.0-1ubuntu0.1'},
    {'osver': '22.04', 'pkgname': 'libaom3', 'pkgver': '3.3.0-1ubuntu0.1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'aom-tools / libaom-dev / libaom0 / libaom3');
}
