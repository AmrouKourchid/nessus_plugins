...
# extracted from Fedora Security Advisory FEDORA-2024-85531c965e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-85531c965e");

  script_name(english:"Fedora 40 : chromium (2024-85531c965e)");
...
FEDORA-2024-85531c965e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-85531c965e");
...
var pkgs = [
    {'reference':'chromium-123.0.6312.86-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
