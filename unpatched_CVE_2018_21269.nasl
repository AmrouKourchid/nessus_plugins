...
if (description)
{
  ...
  script_cve_id("CVE-2018-21269");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2018-21269");
...
patch available.
  ...
  - checkpath in OpenRC through 0.42.1 might allow local users to take ownership of arbitrary files because a
    non-terminal path component can be a symlink. (CVE-2018-21269)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-21269");
