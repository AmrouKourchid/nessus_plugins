...
"The version of Thunderbird installed on the remote Windows host is prior to 128.8. It is, therefore, affected by
multiple vulnerabilities as referenced in the mfsa2025-18 advisory.
...
mozilla_check_version(installs:installs, product:'thunderbird', esr:FALSE, fix:'128.8', severity:SECURITY_HOLE);
