...
# extracted from Fedora Security Advisory FEDORA-2025-d6c0319427
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-d6c0319427");

  script_name(english:"Fedora 41 : redict (2025-d6c0319427)");
...
FEDORA-2025-d6c0319427 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-d6c0319427");
  script_set_attribute(attribute:"solution", value:
"Update the affected redict package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:redict");
...
var pkgs = [
    {'reference':'redict-7.3.2-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'redict');
}
