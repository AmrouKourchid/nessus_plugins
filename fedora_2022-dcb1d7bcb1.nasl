...
# extracted from Fedora Security Advisory FEDORA-2022-dcb1d7bcb1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-dcb1d7bcb1");

  script_name(english:"Fedora 37 : mingw-expat (2022-dcb1d7bcb1)");
...
FEDORA-2022-dcb1d7bcb1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-dcb1d7bcb1");
...
var pkgs = [
    {'reference':'mingw-expat-2.4.9-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
