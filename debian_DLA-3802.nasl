...
# extracted from Debian Security Advisory dla-3802. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3802 : elpa-org - security update");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'elpa-org', 'reference': '9.1.14+dfsg-3+deb10u2'},
    {'release': '10.0', 'prefix': 'org-mode', 'reference': '9.1.14+dfsg-3+deb10u2'}
];
