...
if (description)
{
  ...
  script_cve_id("CVE-2018-10850");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2018-10850");
...
patch available.
  ...
  - 389-ds-base before versions 1.4.0.10, 1.3.8.3 is vulnerable to a race condition in the way 389-ds-base
