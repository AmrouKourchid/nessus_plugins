...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : apr-util (EulerOS-SA-2023-2418)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2418
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?61ff2d6f");
...
var pkgs = [
  "apr-util-1.5.2-6.h2.eulerosv2r7",
  "apr-util-devel-1.5.2-6.h2.eulerosv2r7"
];
