...
if (description)
{
  ...
  script_cve_id("CVE-2024-51471");
  script_xref(name:"IAVA", value:"2025-A-0001-S");

  script_name(english:"IBM MQ 9.3 < 9.3.0.26 LTS / 9.3 < 9.4 CD / 9.4 < 9.4.0.7 LTS  (7178243)");

  script_set_attribute(attribute:"synopsis", value:
"The remote web server is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of IBM MQ Server running on the remote host is affected by a vulnerability as referenced in the 7178243
advisory.

  - IBM MQ Appliance 9.3 LTS, 9.3 CD, and 9.4 LTS web console could allow an authenticated user to cause a 
    denial-of-service when trace is enabled due to information being written into memory outside of the 
    intended buffer size. (CVE-2024-51471)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/node/7178243");
  script_set_attribute(attribute:"solution", value:
"Upgrade to IBM MQ 9.3.0.26 LTS, 9.4.0.7 CD, 9.4.0.7 LTS or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-51471");
...
{
  constraints = [
    { 'min_version' : '9.3', 'fixed_version' : '9.4.0.7' }
  ];
}
else
{
