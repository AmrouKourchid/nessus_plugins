...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.3 : php (EulerOS-SA-2019-1247)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1247
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b772dff6");
...
pkgs = ["php-5.4.16-42.h35",
        "php-cli-5.4.16-42.h35",
        "php-common-5.4.16-42.h35"];
