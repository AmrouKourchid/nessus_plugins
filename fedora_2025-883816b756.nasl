...
# extracted from Fedora Security Advisory FEDORA-2025-883816b756
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-883816b756");

  script_name(english:"Fedora 41 : icecat (2025-883816b756)");
...
FEDORA-2025-883816b756 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-883816b756");
...
var pkgs = [
    {'reference':'icecat-115.22.0-2.rh1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
