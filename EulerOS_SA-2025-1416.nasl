...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP12 : git (EulerOS-SA-2025-1416)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1416
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d23df205");
...
var pkgs = [
  "git-2.33.0-5.h10.eulerosv2r12",
  "git-core-2.33.0-5.h10.eulerosv2r12",
  "git-help-2.33.0-5.h10.eulerosv2r12"
];
