...
if (description)
{
  ...
  script_cve_id("CVE-2021-47233");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2021-47233");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: regulator: rt4801: Fix NULL pointer
    dereference if priv->enable_gpios is NULL devm_gpiod_get_array_optional may return NULL if no GPIO was
    assigned. (CVE-2021-47233)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-47233");
