...
# extracted from Red Hat Security Advisory RHSA-2024:8418. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2024-5569", "CVE-2024-9676", "CVE-2024-24790");
  script_xref(name:"RHSA", value:"2024:8418");

  script_name(english:"RHEL 8 / 9 : OpenShift Container Platform 4.16.z (RHSA-2024:8418)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for OpenShift Container Platform 4.16.z.");
...
referenced in the RHSA-2024:8418 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.16.19. See the
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?eba5bdd2");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:8418");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.16.z package based on the guidance in RHSA-2024:8418.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cri-o-1.29.9-6.rhaos4.16.gite7bd45a.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-9676', 'CVE-2024-24790']}
    ]
  },
  {
    'repo_relative_urls': [
  ...
  },
  {
    ...
    'pkgs': [
      {'reference':'cri-o-1.29.9-6.rhaos4.16.gite7bd45a.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-9676', 'CVE-2024-24790']}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'cri-o / python3-zipp');
}
