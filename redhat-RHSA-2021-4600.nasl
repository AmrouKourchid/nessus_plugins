...
# extracted from Red Hat Security Advisory RHSA-2021:4600. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:4600");

  script_name(english:"RHEL 8 : annobin (RHSA-2021:4600)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_4600.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f3fa772b");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:4600");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2005819");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL annobin package based on the guidance in RHSA-2021:4600.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'annobin-8.90-1.el8_2.1', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'annobin');
}
