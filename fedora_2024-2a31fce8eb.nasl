...
# extracted from Fedora Security Advisory FEDORA-2024-2a31fce8eb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-2a31fce8eb");

  script_name(english:"Fedora 40 : tomcat (2024-2a31fce8eb)");
...
FEDORA-2024-2a31fce8eb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-2a31fce8eb");
...
var pkgs = [
    {'reference':'tomcat-9.0.98-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
