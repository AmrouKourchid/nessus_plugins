...
# extracted from VMware Security Advisory PHSA-2023-4.0-0381. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Net PHSA-2023-4.0-0381");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the net package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-381.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'net-snmp-5.8-10.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'net-snmp-devel-5.8-10.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'net-snmp-perl-5.8-10.ph4')) flag++;
