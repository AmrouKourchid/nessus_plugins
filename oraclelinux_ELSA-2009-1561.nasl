...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : libvorbis (ELSA-2009-1561)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2009-1561.html");
...
"Update the affected libvorbis and / or libvorbis-devel packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2009-3379");
...
var pkgs = [
    {'reference':'libvorbis-1.1.2-3.el5_4.4', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'libvorbis-devel-1.1.2-3.el5_4.4', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'libvorbis-1.1.2-3.el5_4.4', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'libvorbis-devel-1.1.2-3.el5_4.4', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
