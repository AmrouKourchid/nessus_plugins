...
# extracted from Red Hat Security Advisory RHSA-2024:1959. The text
...
referenced in the RHSA-2024:1959 advisory.
    ...
    * shim: out of bounds read when parsing MZ binaries (CVE-2023-40551)
    ...
    IMPORTANT: The new shim revokes ALL VERSIONS of GRUB2 before grub2-2.02-0.87.el7_9.14. Therefore GRUB2
    MUST be updated to the latest
    version: grub2-2.02-0.87.el7_9.14 BEFORE or SIMULTANEOUSLY with this shim in order for Secure Boot to
    continue to work. Failure to update GRUB2 will result in an UNBOOTABLE system.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1bf38d34");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-2155");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-4382");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-4390");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:1959");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL shim package based on the guidance in RHSA-2024:1959.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'mokutil-15.8-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'shim-ia32-15.8-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'shim-unsigned-ia32-15.8-3.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'shim-unsigned-x64-15.8-3.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'shim-x64-15.8-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
