...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : python (EulerOS-SA-2022-2529)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2529
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6b9f11c6");
...
var pkgs = [
  "python-2.7.5-69.h41.eulerosv2r7",
  "python-devel-2.7.5-69.h41.eulerosv2r7",
  "python-libs-2.7.5-69.h41.eulerosv2r7",
  "tkinter-2.7.5-69.h41.eulerosv2r7"
];
