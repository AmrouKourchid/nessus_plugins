...
if (description)
{
  ...
  script_cve_id("CVE-2024-46665");
  script_xref(name:"IAVA", value:"2025-A-0022");

  script_name(english:"Fortinet Fortigate Exposure of sensitive information in RADIUS Accounting-Request (FG-IR-24-326)");
...
vulnerability as referenced in the FG-IR-24-326 advisory.

  - An insertion of sensitive information into sent data vulnerability [CWE-201] in FortiOS 7.6.0, 7.4.0
    through 7.4.4 may allow an attacker in a man-in-the-middle position to retrieve the RADIUS accounting
    server shared secret via intercepting accounting-requests. (CVE-2024-46665)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.fortiguard.com/psirt/FG-IR-24-326");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Fortigate version 7.4.5 / 7.6.1 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:H/Au:N/C:P/I:N/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:H/PR:N/UI:N/S:U/C:L/I:N/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-46665");
