...
# extracted from Red Hat Security Advisory RHSA-2018:1647. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 6 : java-1.7.0-openjdk (RHSA-2018:1647)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for java-1.7.0-openjdk.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 6 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2018:1647 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2018/rhsa-2018_1647.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0d870068");
...
"Update the RHEL java-1.7.0-openjdk package based on the guidance in RHSA-2018:1647.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'java-1.7.0-openjdk-1.7.0.181-2.6.14.8.el6_9', 'cpu':'i686', 'release':'6', 'el_string':'el6_9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.7.0-openjdk-1.7.0.181-2.6.14.8.el6_9', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.7.0-openjdk-demo-1.7.0.181-2.6.14.8.el6_9', 'cpu':'i686', 'release':'6', 'el_string':'el6_9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.7.0-openjdk-demo-1.7.0.181-2.6.14.8.el6_9', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.7.0-openjdk-devel-1.7.0.181-2.6.14.8.el6_9', 'cpu':'i686', 'release':'6', 'el_string':'el6_9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.7.0-openjdk-devel-1.7.0.181-2.6.14.8.el6_9', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.7.0-openjdk-javadoc-1.7.0.181-2.6.14.8.el6_9', 'release':'6', 'el_string':'el6_9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.7.0-openjdk-src-1.7.0.181-2.6.14.8.el6_9', 'cpu':'i686', 'release':'6', 'el_string':'el6_9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.7.0-openjdk-src-1.7.0.181-2.6.14.8.el6_9', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
