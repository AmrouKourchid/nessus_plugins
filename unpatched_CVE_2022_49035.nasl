...
if (description)
{
  ...
  script_cve_id("CVE-2022-49035");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-49035");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: media: s5p_cec: limit msg.len to
    CEC_MAX_MSG_SIZE I expect that the hardware will have limited this to 16, but just in case it hasn't,
    check for this corner case. (CVE-2022-49035)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-49035");
