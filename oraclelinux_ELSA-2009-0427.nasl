...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2009-0427.html");
...
"Update the affected libvolume_id, libvolume_id-devel and / or udev packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2009-1185");
...
var pkgs = [
    {'reference':'libvolume_id-095-14.20.el5_3', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libvolume_id-devel-095-14.20.el5_3', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'udev-095-14.20.el5_3', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libvolume_id-095-14.20.el5_3', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libvolume_id-devel-095-14.20.el5_3', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'udev-095-14.20.el5_3', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
