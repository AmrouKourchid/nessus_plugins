...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : SDL (EulerOS-SA-2020-1740)");
...
following vulnerabilities :
  ...
  - SDL (Simple DirectMedia Layer) through 1.2.15 and 2.x
    through 2.0.9 has a buffer over-read in
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1740
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?25e2d5f3");
