...
# extracted from Red Hat Security Advisory RHSA-2023:6434. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:6434");

  script_name(english:"RHEL 9 : frr (RHSA-2023:6434)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for frr.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2023:6434 advisory.
    ...
    * frr: denial of service by crafting a BGP OPEN message with an option of type in bgp_open_option_parse in
    the bgp_open.c 0xff (CVE-2022-40318)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6434.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?14411fb2");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2168855");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2184468");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2196088");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2196090");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2196091");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2216912");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6434");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL frr package based on the guidance in RHSA-2023:6434.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'frr-8.3.1-11.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'frr-selinux-8.3.1-11.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
