...
# AlmaLinux Security Advisory ALSA-2023:5456.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:5456");

  script_name(english:"AlmaLinux 9 : python3.11 (ALSA-2023:5456)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2023-5456.html");
