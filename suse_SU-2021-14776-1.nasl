...
# SUSE update advisory SUSE-SU-2021:14776-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2021:14776-1");

  script_name(english:"SUSE SLES11 Security Update : libcares2 (SUSE-SU-2021:14776-1)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5b20a4fd");
  script_set_attribute(attribute:"solution", value:
"Update the affected libcares2 package.");
...
var pkgs = [
    {'reference':'libcares2-1.7.4-7.10.3.1', 'sp':'4', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.4']}
];
