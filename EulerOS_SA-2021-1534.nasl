...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.6.0 : systemd (EulerOS-SA-2021-1534)");
...
affected by the following vulnerability :
  ...
  - systemd through v245 mishandles numerical usernames
    such as ones composed of decimal digits or 0x followed
    by hex digits, as demonstrated by use of root
    privileges when privileges of the 0x0 user account were
    intended. NOTE: this issue exists because of an
    incomplete fix for CVE-2017-1000082.(CVE-2020-13776)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1534
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5aff3753");
...
pkgs = ["systemd-239-3.h108.eulerosv2r8",
        "systemd-container-239-3.h108.eulerosv2r8",
        "systemd-devel-239-3.h108.eulerosv2r8",
        "systemd-journal-remote-239-3.h108.eulerosv2r8",
        "systemd-libs-239-3.h108.eulerosv2r8",
        "systemd-pam-239-3.h108.eulerosv2r8",
        "systemd-udev-239-3.h108.eulerosv2r8",
        "systemd-udev-compat-239-3.h108.eulerosv2r8"];
