...
# extracted from Fedora Security Advisory FEDORA-2023-d6560c7198
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-d6560c7198");

  script_name(english:"Fedora 36 : mingw-binutils (2023-d6560c7198)");
...
FEDORA-2023-d6560c7198 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-d6560c7198");
...
var pkgs = [
    {'reference':'mingw-binutils-2.37-8.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
