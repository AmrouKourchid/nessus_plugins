...
# extracted from Ubuntu Security Notice USN-5447-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5447-1");

  script_name(english:"Ubuntu 22.04 LTS : logrotate vulnerability (USN-5447-1)");
...
USN-5447-1 advisory.
    ...
    It was discovered that logrotate incorrectly handled the state file. A local attacker could possibly use
    this issue to keep a lock on the state file and cause logrotate to stop working, leading to a denial of
    service.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5447-1");
...
var pkgs = [
    {'osver': '22.04', 'pkgname': 'logrotate', 'pkgver': '3.19.0-1ubuntu1.1'}
];
