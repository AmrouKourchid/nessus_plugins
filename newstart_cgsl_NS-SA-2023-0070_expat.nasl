...
# extracted from ZTE advisory NS-SA-2023-0070. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 5.04 : expat Vulnerability (NS-SA-2023-0070)");

  script_set_attribute(attribute:"synopsis", value:
"The remote NewStart CGSL host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 5.04, has expat packages installed that are affected by a
vulnerability:
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/notice/NS-SA-2023-0070");
...
var pkgs = {
  'CGSL MAIN 5.04': [
    ...
    'expat-debuginfo-2.1.0-15.el7_9',
    'expat-devel-2.1.0-15.el7_9',
    'expat-static-2.1.0-15.el7_9'
  ]
};
