...
# extracted from Red Hat Security Advisory samba4. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2017-9461", "CVE-2017-12151");

  script_name(english:"RHEL 6 : samba4 (Unpatched Vulnerability) (deprecated)");
