...
# extracted from Fedora Security Advisory FEDORA-2023-f73b2bc240
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-f73b2bc240");

  script_name(english:"Fedora 37 : tor (2023-f73b2bc240)");
...
FEDORA-2023-f73b2bc240 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-f73b2bc240");
...
var pkgs = [
    {'reference':'tor-0.4.8.9-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
