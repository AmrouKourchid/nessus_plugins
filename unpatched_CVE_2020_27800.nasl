...
if (description)
{
  ...
  script_cve_id("CVE-2020-27800");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2020-27800");
...
patch available.
  ...
  - A heap-based buffer over-read was discovered in the get_le32 function in bele.h in UPX 4.0.0 via a crafted
    Mach-O file. (CVE-2020-27800)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-27800");
