...
if (description)
{
  ...
  script_name(english:"AIX (IJ37507)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AIX host is missing a security patch.");
  script_set_attribute(attribute:"description", value:
"The version of AIX installed on the remote host is prior to APAR IJ37507. It is, therefore, affected by a vulnerability
as referenced in the IJ37507 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/apar/IJ37507");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/node/6561277");
  script_set_attribute(attribute:"solution", value:
"Please apply the appropriate interim fix per APAR IJ37507.");
...
var constraints = [
    {'release': '7.1', 'ml': '05', 'sp': '07', 'patch': 'IJ37507s7a', 'package': 'bos.pmapi.pmsvcs', 'minfilesetver': '7.1.5.0', 'maxfilesetver': '7.1.5.36'},
    {'release': '7.1', 'ml': '05', 'sp': '08', 'patch': 'IJ37507s9a', 'package': 'bos.pmapi.pmsvcs', 'minfilesetver': '7.1.5.0', 'maxfilesetver': '7.1.5.36'},
    {'release': '7.1', 'ml': '05', 'sp': '09', 'patch': 'IJ37507s9a', 'package': 'bos.pmapi.pmsvcs', 'minfilesetver': '7.1.5.0', 'maxfilesetver': '7.1.5.36'}
];
