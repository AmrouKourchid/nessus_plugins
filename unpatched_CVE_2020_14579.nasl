...
if (description)
{
  ...
  script_cve_id("CVE-2020-14579");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2020-14579");
...
patch available.
  ...
  - Vulnerability in the Java SE, Java SE Embedded product of Oracle Java SE (component: Libraries). Supported
    ...
    through a web service. (CVE-2020-14579)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-14579");
