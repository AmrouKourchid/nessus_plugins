...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : libvncserver (EulerOS-SA-2019-1033)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1033
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e8891a06");
...
pkgs = ["libvncserver-0.9.9-12.h9.eulerosv2r7"];
