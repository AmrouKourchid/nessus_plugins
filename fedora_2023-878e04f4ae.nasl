...
# extracted from Fedora Security Advisory FEDORA-2023-878e04f4ae
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-878e04f4ae");
  script_xref(name:"IAVA", value:"2023-A-0377-S");

  script_name(english:"Fedora 38 : openssh (2023-878e04f4ae)");
...
FEDORA-2023-878e04f4ae advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-878e04f4ae");
...
var pkgs = [
    {'reference':'openssh-9.0p1-16.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
