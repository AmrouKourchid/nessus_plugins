...
# extracted from Fedora Security Advisory FEDORA-2024-8409b5fa8e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-8409b5fa8e");

  script_name(english:"Fedora 38 : podman (2024-8409b5fa8e)");
...
FEDORA-2024-8409b5fa8e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-8409b5fa8e");
...
var pkgs = [
    {'reference':'podman-4.9.4-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'5'}
];
