...
if (description)
{
  ...
  script_xref(name:"MSFT", value:"MS17-4015217");
...
is, therefore, affected by multiple vulnerabilities :
  ...
  - A remote code execution vulnerability exists in 
    Microsoft Edge due to improper handling of objects 
    in memory. An unauthenticated, remote attacker
    could use this to execute arbitrary code in the
    context of the user. (CVE-2017-0200)
