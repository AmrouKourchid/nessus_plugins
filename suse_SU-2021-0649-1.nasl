...
# extracted from SUSE update advisory SUSE-SU-2021:0649-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : nodejs12 (SUSE-SU-2021:0649-1)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c6dd1b28");
...
zypper in -t patch SUSE-SLE-Module-Web-Scripting-12-2021-649=1");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"0", reference:"nodejs12-12.21.0-1.29.2")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"nodejs12-debuginfo-12.21.0-1.29.2")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"nodejs12-debugsource-12.21.0-1.29.2")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"nodejs12-devel-12.21.0-1.29.2")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"npm12-12.21.0-1.29.2")) flag++;
