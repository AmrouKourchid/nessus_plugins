...
if (description)
{
  ...
  script_name(english:"MariaDB 10.4.0 < 10.4.32");

  script_set_attribute(attribute:"synopsis", value:
"The remote database server is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of MariaDB installed on the remote host is prior to 10.4.32. It is, therefore, affected by a vulnerability
as referenced in the mdb-10432-rn advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://mariadb.com/kb/en/mdb-10432-rn");
  script_set_attribute(attribute:"solution", value:
"Upgrade to MariaDB version 10.4.32 or later.");
...
var constraints = [
  { 'min_version' : '10.4', 'fixed_version' : '10.4.32' }
];
