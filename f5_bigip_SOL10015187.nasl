...
Users accessing the local machine can get administrator privileges.");
  script_set_attribute(attribute:"see_also", value:"https://support.f5.com/csp/article/K10015187");
...
Solution K10015187.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-5547");
