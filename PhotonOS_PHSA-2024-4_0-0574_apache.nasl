...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Apache PHSA-2024-4.0-0574");
...
if (rpm_check(release:'PhotonOS-4.0', reference:'apache-tomcat-8.5.96-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', reference:'apache-tomcat-webapps-8.5.96-1.ph4')) flag++;
