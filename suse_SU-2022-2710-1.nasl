...
# SUSE update advisory SUSE-SU-2022:2710-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:2710-1");

  script_name(english:"SUSE SLES12 / SLES15 Security Update : kernel (Live Patch 26 for SLE 12 SP4) (SUSE-SU-2022:2710-1)");
...
vulnerabilities as referenced in the SUSE-SU-2022:2710-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://lists.suse.com/pipermail/sle-updates/2022-August/024349.html");
...
"Update the affected kernel-livepatch-4_12_14-150100_197_111-default and / or kgraft-patch-4_12_14-95_96-default
packages.");
...
var pkgs = [
    {'reference':'kernel-livepatch-4_12_14-150100_197_111-default-6-150100.2.2', 'sp':'1', 'cpu':'x86_64', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.1']},
    {'reference':'kernel-livepatch-4_12_14-150100_197_111-default-6-150100.2.2', 'sp':'1', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.1', 'sle-module-live-patching-release-15.1', 'sles-release-15.1']},
    {'reference':'kgraft-patch-4_12_14-95_96-default-6-2.2', 'sp':'4', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.4']}
];
