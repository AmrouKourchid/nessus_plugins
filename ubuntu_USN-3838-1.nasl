...
# extracted from Ubuntu Security Notice USN-3838-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"3838-1");

  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 18.04 LTS : LibRaw vulnerabilities (USN-3838-1)");
...
vulnerabilities as referenced in the USN-3838-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3838-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'libraw-bin', 'pkgver': '0.15.4-1ubuntu0.3'},
    {'osver': '14.04', 'pkgname': 'libraw-dev', 'pkgver': '0.15.4-1ubuntu0.3'},
    {'osver': '14.04', 'pkgname': 'libraw9', 'pkgver': '0.15.4-1ubuntu0.3'},
    {'osver': '16.04', 'pkgname': 'libraw-bin', 'pkgver': '0.17.1-1ubuntu0.4'},
    {'osver': '16.04', 'pkgname': 'libraw-dev', 'pkgver': '0.17.1-1ubuntu0.4'},
    {'osver': '16.04', 'pkgname': 'libraw15', 'pkgver': '0.17.1-1ubuntu0.4'},
    {'osver': '18.04', 'pkgname': 'libraw-bin', 'pkgver': '0.18.8-1ubuntu0.2'},
    {'osver': '18.04', 'pkgname': 'libraw-dev', 'pkgver': '0.18.8-1ubuntu0.2'},
    {'osver': '18.04', 'pkgname': 'libraw16', 'pkgver': '0.18.8-1ubuntu0.2'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libraw-bin / libraw-dev / libraw15 / libraw16 / libraw9');
}
