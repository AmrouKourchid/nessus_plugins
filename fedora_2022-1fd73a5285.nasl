...
# extracted from Fedora Security Advisory FEDORA-2022-1fd73a5285
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-1fd73a5285");

  script_name(english:"Fedora 37 : mod_security / mod_security_crs (2022-1fd73a5285)");
...
FEDORA-2022-1fd73a5285 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-1fd73a5285");
...
var pkgs = [
    {'reference':'mod_security-2.9.6-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'mod_security_crs-3.3.4-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
