...
# extracted from Red Hat Security Advisory RHSA-2023:2633. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:2633");

  script_name(english:"RHEL 9 : libreswan (RHSA-2023:2633)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_2633.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?820a5b6f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2173610");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:2633");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libreswan package based on the guidance in RHSA-2023:2633.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libreswan-4.9-2.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'libreswan-4.9-2.el9_2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
