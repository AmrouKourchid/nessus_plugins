...
# extracted from Red Hat Security Advisory RHSA-2018:0030. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 6 : libvirt (RHSA-2018:0030) (Spectre)");
...
issue.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:0030");
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"libvirt-0.10.2-62.el6_9.1")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"libvirt-0.10.2-62.el6_9.1")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"libvirt-0.10.2-62.el6_9.1")) flag++;
  if (rpm_check(release:"RHEL6", reference:"libvirt-client-0.10.2-62.el6_9.1")) flag++;
  if (rpm_check(release:"RHEL6", reference:"libvirt-debuginfo-0.10.2-62.el6_9.1")) flag++;
  if (rpm_check(release:"RHEL6", reference:"libvirt-devel-0.10.2-62.el6_9.1")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"libvirt-lock-sanlock-0.10.2-62.el6_9.1")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"libvirt-python-0.10.2-62.el6_9.1")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"libvirt-python-0.10.2-62.el6_9.1")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"libvirt-python-0.10.2-62.el6_9.1")) flag++;
