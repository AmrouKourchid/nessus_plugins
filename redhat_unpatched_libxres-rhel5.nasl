...
# extracted from Red Hat Security Advisory libxres. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 5 : libxres (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-1988");
