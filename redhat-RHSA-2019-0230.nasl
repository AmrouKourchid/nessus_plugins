...
# extracted from Red Hat Security Advisory RHSA-2019:0230. The text 
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_0230.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c3f4c52d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:0230");
...
"Update the RHEL polkit package based on the guidance in RHSA-2019:0230.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'polkit-0.112-18.el7_6.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-devel-0.112-18.el7_6.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-docs-0.112-18.el7_6.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
