...
# extracted from Fedora Security Advisory FEDORA-2018-9e0a37e7a2.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2017-11613");
  script_xref(name:"FEDORA", value:"2018-9e0a37e7a2");

  script_name(english:"Fedora 27 : libtiff (2018-9e0a37e7a2)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-9e0a37e7a2");
...
"Update the affected libtiff package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-11613");
...
flag = 0;
if (rpm_check(release:"FC27", reference:"libtiff-4.0.9-10.fc27")) flag++;
