...
# extracted from Fedora Security Advisory FEDORA-2023-06a49d4fb6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-06a49d4fb6");

  script_name(english:"Fedora 38 : community-mysql (2023-06a49d4fb6)");
...
FEDORA-2023-06a49d4fb6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-06a49d4fb6");
...
var pkgs = [
    {'reference':'community-mysql-8.0.33-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
