...
if (description)
{
  ...
  script_name(english:"Wireshark SEoL (1.3.x <= x <= 1.4.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Wireshark is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Wireshark is between 1.3.x and 1.4.x. It is, therefore, no longer maintained by its vendor or
provider.
...
"Upgrade to a version of Wireshark that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2012/08/30");
...
var constraints = [
  { max_branch : '1.4', min_branch : '1.3', seol : 20120830 }
];
