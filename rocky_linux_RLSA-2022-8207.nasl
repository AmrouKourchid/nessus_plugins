...
# Rocky Linux Security Advisory RLSA-2022:8207.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2022:8207");

  script_name(english:"Rocky Linux 9 : openjpeg2 (RLSA-2022:8207)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2022:8207");
...
var pkgs = [
    ...
    {'reference':'openjpeg2-2.4.0-7.el9', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'openjpeg2-2.4.0-7.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'openjpeg2-debuginfo-2.4.0-7.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'openjpeg2-debuginfo-2.4.0-7.el9', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'openjpeg2-debuginfo-2.4.0-7.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'openjpeg2-debugsource-2.4.0-7.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'openjpeg2-debugsource-2.4.0-7.el9', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'openjpeg2-debugsource-2.4.0-7.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'openjpeg2-devel-2.4.0-7.el9', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'openjpeg2-tools-2.4.0-7.el9', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'openjpeg2-tools-2.4.0-7.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'openjpeg2-tools-debuginfo-2.4.0-7.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'openjpeg2-tools-debuginfo-2.4.0-7.el9', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'openjpeg2-tools-debuginfo-2.4.0-7.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
