...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : curl (EulerOS-SA-2021-1774)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1774
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?910c8dd5");
...
"Update the affected curl package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-6422");
...
pkgs = ["curl-7.29.0-35.h33",
        "libcurl-7.29.0-35.h33",
        "libcurl-devel-7.29.0-35.h33"];
