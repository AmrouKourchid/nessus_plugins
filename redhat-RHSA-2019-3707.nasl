...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_3707.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?da97db88");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:3707");
...
"Update the RHEL dbus package based on the guidance in RHSA-2019:3707.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'dbus-1.12.8-9.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'dbus-common-1.12.8-9.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'dbus-daemon-1.12.8-9.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'dbus-devel-1.12.8-9.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'dbus-libs-1.12.8-9.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'dbus-tools-1.12.8-9.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'dbus-x11-1.12.8-9.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
