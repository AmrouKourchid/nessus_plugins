...
if (description)
{
  ...
  script_name(english:"Red Hat Enterprise Linux SEoL (9.8.x, 9.9.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Red Hat Enterprise Linux is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Red Hat Enterprise Linux is 9.8.x or 9.9.x. It is, therefore, no longer maintained by its 
vendor or provider.
...
"Upgrade to a version of Red Hat Enterprise Linux that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2028/04/30");
...
var constraints = [
  { min_branch : '9.8', max_branch : '9.9', seol : 20280430, eseol : 20300430 }
];
