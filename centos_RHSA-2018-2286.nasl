...
# CentOS Errata and Security Advisory 2018:2286 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : java-1.7.0-openjdk (CESA-2018:2286)");
...
listed in the References section.");
  # https://lists.centos.org/pipermail/centos-announce/2018-August/022980.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?eca82d3e");
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"java-1.7.0-openjdk-1.7.0.191-2.6.15.4.el7_5")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"java-1.7.0-openjdk-accessibility-1.7.0.191-2.6.15.4.el7_5")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"java-1.7.0-openjdk-demo-1.7.0.191-2.6.15.4.el7_5")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"java-1.7.0-openjdk-devel-1.7.0.191-2.6.15.4.el7_5")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"java-1.7.0-openjdk-headless-1.7.0.191-2.6.15.4.el7_5")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"java-1.7.0-openjdk-javadoc-1.7.0.191-2.6.15.4.el7_5")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"java-1.7.0-openjdk-src-1.7.0.191-2.6.15.4.el7_5")) flag++;
