...
# extracted from Fedora Security Advisory FEDORA-2024-07597a0fb3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-07597a0fb3");

  script_name(english:"Fedora 38 : glibc (2024-07597a0fb3)");
...
FEDORA-2024-07597a0fb3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-07597a0fb3");
...
var pkgs = [
    {'reference':'glibc-2.37-18.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
