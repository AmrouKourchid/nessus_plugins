...
# extracted from Oracle Linux Security Advisory ELSA-2023-7015.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : wireshark (ELSA-2023-7015)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ELSA-2023-7015 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-7015.html");
...
var pkgs = [
    ...
    {'reference':'wireshark-2.6.2-17.el8', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'wireshark-cli-2.6.2-17.el8', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'wireshark-devel-2.6.2-17.el8', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
