...
if (description)
{
  ...
  script_name(english:"Tenable Nessus SEoL (6.3.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Tenable Nessus is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Tenable Nessus is 6.3.x. It is, therefore, no longer maintained by its vendor or provider.
...
var constraints = [
  { max_branch : '6.3', min_branch : '6.3', seol : 20160930, eseol : 20170331 }
];
