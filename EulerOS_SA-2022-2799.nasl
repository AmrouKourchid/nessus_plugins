...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : libtiff (EulerOS-SA-2022-2799)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2799
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c9abacf3");
...
var pkgs = [
  "libtiff-4.0.9-11.h23.eulerosv2r8",
  "libtiff-devel-4.0.9-11.h23.eulerosv2r8"
];
