...
the RHSA-2019:1910 advisory.
    ...
    * slowness of system shutdown when containers are being stopped - dockerd is unable to communicate with
    rhel-push-plugin (BZ#1714032)

    * journald Log() in dockerd causes nil pointer dereference when PutMessage() is called before reading
    msg.Source (BZ#1720363)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_1910.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0c52239a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:1910");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1714722");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1723491");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL docker package based on the guidance in RHSA-2019:1910.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'docker-1.13.1-102.git7f2769b.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'docker-client-1.13.1-102.git7f2769b.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'docker-common-1.13.1-102.git7f2769b.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'docker-logrotate-1.13.1-102.git7f2769b.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'docker-lvm-plugin-1.13.1-102.git7f2769b.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'docker-novolume-plugin-1.13.1-102.git7f2769b.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'docker-rhel-push-plugin-1.13.1-102.git7f2769b.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'docker-v1.10-migrator-1.13.1-102.git7f2769b.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
    ]
  }
];
