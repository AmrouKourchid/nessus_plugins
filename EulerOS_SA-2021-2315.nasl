...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : samba (EulerOS-SA-2021-2315)");
...
vulnerability :
  ...
  - A flaw was found in samba. The Samba smbd file server
    must map Windows group identities (SIDs) into unix
    group ids (gids). The code that performs this had a
    flaw that could allow it to read data beyond the end of
    the array in the case where a negative cache entry had
    been added to the mapping cache. This could cause the
    calling code to return those values into the process
    token that stores the group membership for a user. The
    highest threat from this vulnerability is to data
    confidentiality and integrity.(CVE-2021-20254)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2315
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e3a31772");
...
pkgs = ["ctdb-4.9.1-2.h32.eulerosv2r8",
        "ctdb-tests-4.9.1-2.h32.eulerosv2r8",
        "libsmbclient-4.9.1-2.h32.eulerosv2r8",
        "libwbclient-4.9.1-2.h32.eulerosv2r8",
        "python2-samba-4.9.1-2.h32.eulerosv2r8",
        "python2-samba-test-4.9.1-2.h32.eulerosv2r8",
        "python3-samba-4.9.1-2.h32.eulerosv2r8",
        "python3-samba-test-4.9.1-2.h32.eulerosv2r8",
        "samba-4.9.1-2.h32.eulerosv2r8",
        "samba-client-4.9.1-2.h32.eulerosv2r8",
        "samba-client-libs-4.9.1-2.h32.eulerosv2r8",
        "samba-common-4.9.1-2.h32.eulerosv2r8",
        "samba-common-libs-4.9.1-2.h32.eulerosv2r8",
        "samba-common-tools-4.9.1-2.h32.eulerosv2r8",
        "samba-dc-libs-4.9.1-2.h32.eulerosv2r8",
        "samba-krb5-printing-4.9.1-2.h32.eulerosv2r8",
        "samba-libs-4.9.1-2.h32.eulerosv2r8",
        "samba-pidl-4.9.1-2.h32.eulerosv2r8",
        "samba-test-4.9.1-2.h32.eulerosv2r8",
        "samba-test-libs-4.9.1-2.h32.eulerosv2r8",
        "samba-winbind-4.9.1-2.h32.eulerosv2r8",
        "samba-winbind-clients-4.9.1-2.h32.eulerosv2r8",
        "samba-winbind-krb5-locator-4.9.1-2.h32.eulerosv2r8",
        "samba-winbind-modules-4.9.1-2.h32.eulerosv2r8"];
