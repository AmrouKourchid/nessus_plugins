...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : libkdcraw on SL7.x x86_64 (20181030)");
...
internal/dcraw_common.cpp (CVE-2018-5806)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1811&L=scientific-linux-errata&F=&S=&P=6180
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8b12d99a");
...
libkdcraw-devel packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fermilab:scientific_linux:libkdcraw");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fermilab:scientific_linux:libkdcraw-debuginfo");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fermilab:scientific_linux:libkdcraw-devel");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"libkdcraw-4.10.5-5.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"libkdcraw-debuginfo-4.10.5-5.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"libkdcraw-devel-4.10.5-5.el7")) flag++;
