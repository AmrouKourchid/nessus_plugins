...
if (description)
{
  ...
  script_name(english:"Adobe FrameMaker Publishing Server 2022 < 17.2.0 (2022.2.0) Security Feature Bypass (APSB24-10)");
...
Publishing Server 2022 17.2.0. It is, therefore, affected by a vulnerability as referenced in the apsb24-10 advisory.

  - Adobe FrameMaker Publishing Server versions 2022.1 and earlier are affected by an Improper Authentication
    vulnerability that could result in a Security feature bypass. An attacker could leverage this
    vulnerability to bypass authentication mechanisms and gain unauthorized access. Exploitation of this issue
    does not require user interaction. (CVE-2024-20738)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://helpx.adobe.com/security/products/framemaker/apsb24-10.html");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Adobe FrameMaker Publishing Server Version 2022.2 or later.");
...
var constraints = [
  { 'fixed_version' : '17.2.0', 'fixed_display' : '17.2.0 / 2022.2.0 / Version 2022.2' }
];
