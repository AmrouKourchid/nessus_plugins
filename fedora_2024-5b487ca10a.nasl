...
# extracted from Fedora Security Advisory FEDORA-2024-5b487ca10a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-5b487ca10a");

  script_name(english:"Fedora 38 : cjson (2024-5b487ca10a)");
...
FEDORA-2024-5b487ca10a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-5b487ca10a");
...
var pkgs = [
    {'reference':'cjson-1.7.17-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
