...
# SUSE update advisory SUSE-SU-2022:2861-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:2861-1");
  script_xref(name:"CEA-ID", value:"CEA-2020-0139");

  script_name(english:"SUSE SLES12 Security Update : open-iscsi (SUSE-SU-2022:2861-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1058463");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1109477");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-August/011958.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a92cc407");
  script_set_attribute(attribute:"solution", value:
"Update the affected iscsiuio, open-iscsi and / or open-isns packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:suse_linux:open-isns");
...
var pkgs = [
    {'reference':'iscsiuio-0.7.8.2-46.17.2', 'sp':'2', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.2']},
    {'reference':'open-iscsi-2.0.873-46.17.2', 'sp':'2', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.2']},
    {'reference':'open-isns-0.95-46.17.2', 'sp':'2', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.2']}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'iscsiuio / open-iscsi / open-isns');
}
