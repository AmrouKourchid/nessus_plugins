...
# extracted from Gentoo Linux Security Advisory GLSA 202009-10.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202009-10");

  script_name(english:"GLSA-202009-10 : PHP: Denial of service");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202009-10
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202009-10");
...
if (qpkg_check(package:"dev-lang/php", unaffected:make_list("ge 7.2.33", "ge 7.3.21", "ge 7.4.9"), vulnerable:make_list("lt 7.2.33", "lt 7.3.21", "lt 7.4.9"))) flag++;
