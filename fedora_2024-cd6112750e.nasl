...
# extracted from Fedora Security Advisory FEDORA-2024-cd6112750e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-cd6112750e");

  script_name(english:"Fedora 41 : golang-github-nvidia-container-toolkit (2024-cd6112750e)");
...
FEDORA-2024-cd6112750e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-cd6112750e");
...
var pkgs = [
    {'reference':'golang-github-nvidia-container-toolkit-1.16.2-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
