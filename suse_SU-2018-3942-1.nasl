...
# extracted from SUSE update advisory SUSE-SU-2018:3942-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLED15 / SLES15 Security Update : postgresql10 (SUSE-SU-2018:3942-1)");
...
without introducing additional issues.");
  ...
  # https://www.suse.com/support/update/announcement/2018/suse-su-20183942-1/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7762fee0");
...
patch SUSE-SLE-Module-Server-Applications-15-2018-2813=1

SUSE Linux Enterprise Module for Packagehub Subpackages 15:zypper in
-t patch SUSE-SLE-Module-Packagehub-Subpackages-15-2018-2813=1

SUSE Linux Enterprise Module for Open Buildservice Development Tools
15:zypper in -t patch
SUSE-SLE-Module-Development-Tools-OBS-15-2018-2813=1

SUSE Linux Enterprise Module for Basesystem 15:zypper in -t patch
SUSE-SLE-Module-Basesystem-15-2018-2813=1");
...
flag = 0;
if (rpm_check(release:"SLES15", sp:"0", reference:"libecpg6-10.6-4.8.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", reference:"libecpg6-debuginfo-10.6-4.8.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", reference:"libpq5-10.6-4.8.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", reference:"libpq5-debuginfo-10.6-4.8.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", reference:"postgresql10-10.6-4.8.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", reference:"postgresql10-contrib-10.6-4.8.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", reference:"postgresql10-contrib-debuginfo-10.6-4.8.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", reference:"postgresql10-debuginfo-10.6-4.8.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", reference:"postgresql10-debugsource-10.6-4.8.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", reference:"postgresql10-devel-10.6-4.8.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", reference:"postgresql10-devel-debuginfo-10.6-4.8.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", reference:"postgresql10-plperl-10.6-4.8.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", reference:"postgresql10-plperl-debuginfo-10.6-4.8.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", reference:"postgresql10-plpython-10.6-4.8.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", reference:"postgresql10-plpython-debuginfo-10.6-4.8.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", reference:"postgresql10-pltcl-10.6-4.8.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", reference:"postgresql10-pltcl-debuginfo-10.6-4.8.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", reference:"postgresql10-server-10.6-4.8.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", reference:"postgresql10-server-debuginfo-10.6-4.8.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", reference:"postgresql10-test-10.6-4.8.1")) flag++;
if (rpm_check(release:"SLED15", sp:"0", reference:"libpq5-10.6-4.8.1")) flag++;
if (rpm_check(release:"SLED15", sp:"0", reference:"libpq5-debuginfo-10.6-4.8.1")) flag++;
if (rpm_check(release:"SLED15", sp:"0", reference:"postgresql10-10.6-4.8.1")) flag++;
if (rpm_check(release:"SLED15", sp:"0", reference:"postgresql10-debuginfo-10.6-4.8.1")) flag++;
if (rpm_check(release:"SLED15", sp:"0", reference:"postgresql10-debugsource-10.6-4.8.1")) flag++;
if (rpm_check(release:"SLED15", sp:"0", reference:"postgresql10-test-10.6-4.8.1")) flag++;
