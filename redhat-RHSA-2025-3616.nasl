...
# extracted from Red Hat Security Advisory RHSA-2025:3616. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:3616");

  script_name(english:"RHEL 9 : grafana (RHSA-2025:3616)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_3616.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?01fea9ce");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:3616");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'grafana-9.0.9-6.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
