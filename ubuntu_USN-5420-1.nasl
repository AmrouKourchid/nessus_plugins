...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 ESM : Vorbis vulnerabilities (USN-5420-1)");
...
the USN-5420-1 advisory.
    ...
    It was discovered that Vorbis incorrectly handled certain files. An attacker could possibly use this issue
    to cause a denial of service, or possibly execute arbitrary code. (CVE-2017-14160, CVE-2018-10392,
    CVE-2018-10393)
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libvorbis-dev', 'pkgver': '1.3.5-3ubuntu0.2+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libvorbis0a', 'pkgver': '1.3.5-3ubuntu0.2+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libvorbisenc2', 'pkgver': '1.3.5-3ubuntu0.2+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libvorbisfile3', 'pkgver': '1.3.5-3ubuntu0.2+esm1', 'ubuntu_pro': TRUE}
];
