...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS : Linux kernel vulnerabilities (USN-4917-1)");
...
referenced in the USN-4917-1 advisory.
...
var kernel_mappings = {
  ...
  '20.04': {
    ...
    '5.8.0': {
      'generic': '5.8.0-50',
      'generic-64k': '5.8.0-50',
      'generic-lpae': '5.8.0-50',
      'lowlatency': '5.8.0-50'
    }
  }
};
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-4917-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2021-3492', 'CVE-2021-3493', 'CVE-2021-29154');
