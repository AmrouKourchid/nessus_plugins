...
# extracted from Red Hat Security Advisory RHSA-2013:0164. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2013:0164");

  script_name(english:"RHEL 5 / 6 : jbossweb (RHSA-2013:0164)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for jbossweb.");
...
in the RHSA-2013:0164 advisory.

  - Tomcat/JBoss Web: Bypass of security constraints (CVE-2012-3546)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"http://tomcat.apache.org/security-6.html");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2013/rhsa-2013_0164.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3fd51617");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2013:0164");
...
"Update the RHEL jbossweb package based on the guidance in RHSA-2013:0164.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jbossweb-7.0.17-3.Final_redhat_2.ep6.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap6'},
      {'reference':'jbossweb-lib-7.0.17-3.Final_redhat_2.ep6.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap6'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'jbossweb-7.0.17-3.Final_redhat_2.ep6.el5', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap6'},
      {'reference':'jbossweb-lib-7.0.17-3.Final_redhat_2.ep6.el5', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap6'}
    ]
  }
];
