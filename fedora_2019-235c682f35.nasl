...
# extracted from Fedora Security Advisory FEDORA-2019-235c682f35.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : wavpack (2019-235c682f35)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-235c682f35");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"wavpack-5.1.0-12.fc28")) flag++;
