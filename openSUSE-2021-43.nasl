...
# extracted from openSUSE Security Update openSUSE-2021-43.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : tomcat (openSUSE-2021-43)");
...
if ( rpm_check(release:"SUSE15.2", reference:"tomcat-9.0.36-lp152.2.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"tomcat-admin-webapps-9.0.36-lp152.2.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"tomcat-docs-webapp-9.0.36-lp152.2.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"tomcat-el-3_0-api-9.0.36-lp152.2.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"tomcat-embed-9.0.36-lp152.2.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"tomcat-javadoc-9.0.36-lp152.2.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"tomcat-jsp-2_3-api-9.0.36-lp152.2.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"tomcat-jsvc-9.0.36-lp152.2.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"tomcat-lib-9.0.36-lp152.2.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"tomcat-servlet-4_0-api-9.0.36-lp152.2.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"tomcat-webapps-9.0.36-lp152.2.16.1") ) flag++;
