...
# AlmaLinux Security Advisory ALSA-2024:4267.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:4267");

  script_name(english:"AlmaLinux 8 : fontforge (ALSA-2024:4267)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2024-4267.html");
...
"Update the affected fontforge package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:fontforge");
