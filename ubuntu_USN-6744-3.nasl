...
# extracted from Ubuntu Security Notice USN-6744-3. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6744-3");

  script_name(english:"Ubuntu 24.04 LTS. : Pillow vulnerability (USN-6744-3)");
...
USN-6744-3 advisory.
    ...
    USN-6744-1 fixed a vulnerability in Pillow. This update provides the corresponding updates for Ubuntu
    24.04 LTS.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6744-3");
...
var pkgs = [
    {'osver': '24.04', 'pkgname': 'python3-pil', 'pkgver': '10.2.0-1ubuntu1'},
    {'osver': '24.04', 'pkgname': 'python3-pil.imagetk', 'pkgver': '10.2.0-1ubuntu1'}
];
