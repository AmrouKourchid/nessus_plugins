...
# extracted from Ubuntu Security Notice USN-5057-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5057-1");

  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS : Squashfs-Tools vulnerability (USN-5057-1)");
...
in the USN-5057-1 advisory.

    Etienne Stalmans discovered that Squashfs-Tools mishandled certain malformed SQUASHFS files. An attacker
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5057-1");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'squashfs-tools', 'pkgver': '1:4.3-6ubuntu0.18.04.3'},
    {'osver': '20.04', 'pkgname': 'squashfs-tools', 'pkgver': '1:4.4-1ubuntu0.1'}
];
