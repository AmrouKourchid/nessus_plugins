...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Vim PHSA-2023-4.0-0492");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'vim-9.0.2010-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'vim-extra-9.0.2010-1.ph4')) flag++;
