...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : DHCP vulnerability (USN-2868-1)");
...
USN-2868-1 advisory.
    ...
    Sebastian Poehn discovered that the DHCP server, client, and relay incorrectly handled certain malformed
    UDP packets. A remote attacker could use this issue to cause the DHCP server, client, or relay to stop
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2868-1");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-8605");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'isc-dhcp-client', 'pkgver': '4.2.4-7ubuntu12.4'},
    {'osver': '14.04', 'pkgname': 'isc-dhcp-client-udeb', 'pkgver': '4.2.4-7ubuntu12.4'},
    {'osver': '14.04', 'pkgname': 'isc-dhcp-common', 'pkgver': '4.2.4-7ubuntu12.4'},
    {'osver': '14.04', 'pkgname': 'isc-dhcp-dev', 'pkgver': '4.2.4-7ubuntu12.4'},
    {'osver': '14.04', 'pkgname': 'isc-dhcp-relay', 'pkgver': '4.2.4-7ubuntu12.4'},
    {'osver': '14.04', 'pkgname': 'isc-dhcp-server', 'pkgver': '4.2.4-7ubuntu12.4'},
    {'osver': '14.04', 'pkgname': 'isc-dhcp-server-ldap', 'pkgver': '4.2.4-7ubuntu12.4'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'isc-dhcp-client / isc-dhcp-client-udeb / isc-dhcp-common / etc');
}
