...
# extracted from Fedora Security Advisory FEDORA-2024-157678aad0
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-157678aad0");

  script_name(english:"Fedora 41 : python-waitress (2024-157678aad0)");
...
FEDORA-2024-157678aad0 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-157678aad0");
...
var pkgs = [
    {'reference':'python-waitress-3.0.1-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
