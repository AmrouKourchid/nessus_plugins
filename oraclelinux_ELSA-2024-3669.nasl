...
# extracted from Oracle Linux Security Advisory ELSA-2024-3669.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : less (ELSA-2024-3669)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-3669.html");
...
"Update the affected less package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:less");
...
var pkgs = [
    {'reference':'less-458-10.el7_9', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
