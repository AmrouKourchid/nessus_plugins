...
# extracted from Fedora Security Advisory FEDORA-2024-93575091aa
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-93575091aa");

  script_name(english:"Fedora 40 : ruby (2024-93575091aa)");
...
FEDORA-2024-93575091aa advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-93575091aa");
...
var pkgs = [
    {'reference':'ruby-3.3.4-11.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
