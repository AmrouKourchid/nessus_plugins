...
# extracted from Oracle Linux Security Advisory ELSA-2023-6685.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : tpm2-tss (ELSA-2023-6685)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-6685.html");
...
var pkgs = [
    {'reference':'tpm2-tss-3.2.2-2.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tpm2-tss-devel-3.2.2-2.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tpm2-tss-3.2.2-2.el9', 'cpu':'i686', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tpm2-tss-devel-3.2.2-2.el9', 'cpu':'i686', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tpm2-tss-3.2.2-2.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tpm2-tss-devel-3.2.2-2.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
