...
# extracted from Amazon Linux AMI Security Advisory ALAS-2024-1910.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux AMI : apache-ivy (ALAS-2024-1910)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux AMI host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of apache-ivy installed on the remote host is prior to 2.2.0-5.3. It is, therefore, affected by a
vulnerability as referenced in the ALAS-2024-1910 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/ALAS-2024-1910.html");
...
var pkgs = [
    {'reference':'apache-ivy-2.2.0-5.3.amzn1', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'apache-ivy-javadoc-2.2.0-5.3.amzn1', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE}
];
