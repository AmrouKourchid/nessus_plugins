...
# extracted from Red Hat Security Advisory RHSA-2021:0735. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_0735.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7c7eb8fe");
...
"Update the RHEL nodejs:10 package based on the guidance in RHSA-2021:0735.");
  ...
  'nodejs:10': [
    {
      ...
      'pkgs': [
        {'reference':'nodejs-10.24.0-1.module+el8.3.0+10166+b07ac28e', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-devel-10.24.0-1.module+el8.3.0+10166+b07ac28e', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-docs-10.24.0-1.module+el8.3.0+10166+b07ac28e', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-full-i18n-10.24.0-1.module+el8.3.0+10166+b07ac28e', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        ...
        {'reference':'npm-6.14.11-1.10.24.0.1.module+el8.3.0+10166+b07ac28e', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
      ]
    }
  ]
};
