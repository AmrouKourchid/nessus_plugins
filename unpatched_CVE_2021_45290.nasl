...
if (description)
{
  ...
  script_cve_id("CVE-2021-45290");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2021-45290");
...
patch available.
  ...
  - A Denial of Service vulnerability exits in Binaryen 103 due to an assertion abort in
    wasm::handle_unreachable. (CVE-2021-45290)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-45290");
