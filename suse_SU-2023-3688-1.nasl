...
# SUSE update advisory SUSE-SU-2023:3688-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:3688-1");

  script_name(english:"SUSE SLES15 Security Update : gstreamer-plugins-good (SUSE-SU-2023:3688-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote SUSE Linux SLES15 / SLES_SAP15 host has packages installed that are affected by multiple vulnerabilities as
referenced in the SUSE-SU-2023:3688-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-September/016209.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2bdd8792");
...
"Update the affected gstreamer-plugins-good and / or gstreamer-plugins-good-lang packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2023-37327");
...
var pkgs = [
    {'reference':'gstreamer-plugins-good-1.12.5-150000.3.7.2', 'sp':'1', 'cpu':'x86_64', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.1']},
    {'reference':'gstreamer-plugins-good-lang-1.12.5-150000.3.7.2', 'sp':'1', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.1']},
    {'reference':'gstreamer-plugins-good-1.12.5-150000.3.7.2', 'sp':'1', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-ltss-release-15.1']},
    {'reference':'gstreamer-plugins-good-lang-1.12.5-150000.3.7.2', 'sp':'1', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-ltss-release-15.1']}
];
