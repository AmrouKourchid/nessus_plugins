...
# extracted from Red Hat Security Advisory RHSA-2024:4413. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:4413");

  script_name(english:"RHEL 9 : pki-core (RHSA-2024:4413)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_4413.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fd782e19");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:4413");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL pki-core package based on the guidance in RHSA-2024:4413.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'pki-acme-11.0.6-3.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pki-base-11.0.6-3.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pki-base-java-11.0.6-3.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pki-ca-11.0.6-3.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pki-kra-11.0.6-3.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pki-server-11.0.6-3.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pki-symkey-11.0.6-3.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pki-tools-11.0.6-3.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-pki-11.0.6-3.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
