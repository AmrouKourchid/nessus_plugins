...
# extracted from Oracle Linux Security Advisory ELSA-2022-7458.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : flatpak-builder (ELSA-2022-7458)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2022-7458.html");
  script_set_attribute(attribute:"solution", value:
"Update the affected flatpak-builder package.");
