...
# extracted from F5 Networks BIG-IP Solution K44945790.
#
# @NOAGENT@
##
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : glibc vulnerability (K44945790)");

  script_set_attribute(attribute:"synopsis", value:
"The remote device is missing a vendor-supplied security patch.");
  script_set_attribute(attribute:"description", value:
"The version of F5 Networks BIG-IP installed on the remote host is prior to tested version. It is, therefore, affected by
a vulnerability as referenced in the K44945790 advisory.
    ...
    potentially resulting in a denial of service.(CVE-2021-3326)ImpactAn attacker can exploit this
    vulnerability by crafting a sequence of characters to an application using the iconv function and cause
    the application to be terminated abnormally.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K44945790");
